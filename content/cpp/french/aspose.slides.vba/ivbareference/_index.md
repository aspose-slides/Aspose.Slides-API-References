...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Représente le nom de la référence du projet VBA. Lire [System::String](../../system/string/). |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Représente le nom de la référence du projet VBA. Écrire [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nième argument modèle comme un pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
