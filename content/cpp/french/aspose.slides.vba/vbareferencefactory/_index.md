...
| Méthode | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Crée une nouvelle référence de bibliothèque de type OLE Automation. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaReferenceFactory](./)\> [get_Instance](./get_instance/)() | Instance statique du fabriquant de références de projet VBA. Lecture seule [VbaReferenceFactory](./). |
