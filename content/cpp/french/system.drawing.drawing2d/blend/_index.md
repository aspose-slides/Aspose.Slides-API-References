...
| Méthode | Description |
| --- | --- |
|  [Blend](./blend/)() | Construit une nouvelle instance de la classe [Blend](./). |
|  [Blend](./blend/)(int) | Construit une nouvelle instance de la classe [Blend](./). |
...
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Factors](./get_factors/)() const | Renvoie le tableau des facteurs de mélange du dégradé. |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() const | Renvoie le tableau des positions de mélange du dégradé. |
...
| void [set_Factors](./set_factors/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Définit le tableau des facteurs de mélange du dégradé. |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Définit le tableau des positions de mélange du dégradé. |
