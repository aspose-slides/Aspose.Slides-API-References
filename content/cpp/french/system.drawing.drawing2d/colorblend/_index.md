...
| [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Colors](./get_colors/)() | Renvoie un tableau de couleurs à utiliser aux positions correspondantes le long d'un dégradé. |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() | Renvoie le tableau des positions de mélange le long d'un dégradé. |
...
| void [set_Colors](./set_colors/)(const [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\>\&) | Définit un tableau de couleurs à utiliser aux positions correspondantes le long d'un dégradé. |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Définit le tableau des positions de mélange le long d'un dégradé. |
