...
description: Arguments de l'événement du minuteur.
type: docs
weight: 1
url: /fr/system.timers/elapsedeventargs/
---
## ElapsedEventArgs classe


Arguments de l'événement du minuteur.
...
| Méthode | Description |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | Construit l'objet d'arguments avec les paramètres fournis. |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | Obtient le temps du signal. |
