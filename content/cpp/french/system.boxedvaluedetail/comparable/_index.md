...
description: Implémentation simple de IComparable<>
type: docs
weight: 1
url: /fr/system.boxedvaluedetail/comparable/
---
## Classe Comparable

Implémentation simple de IComparable<>
...
| Méthode | Description |
| --- | --- |
| int [CompareTo](./compareto/)(T) override | Compare l'objet actuel avec l'objet spécifié. |
