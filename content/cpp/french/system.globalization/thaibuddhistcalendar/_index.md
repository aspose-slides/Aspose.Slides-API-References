...
description: "Calendrier bouddhiste thaïlandais. Les objets de cette classe doivent être alloués uniquement à l'aide de la fonction System::MakeObject(). Ne jamais créer d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Toujours encapsuler cette classe dans un pointeur System::SmartPtr et utiliser ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 378
url: /fr/system.globalization/thaibuddhistcalendar/
---
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Crée une copie de l'objet actuel et renvoie un pointeur partagé vers celle-ci. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Compare les objets en utilisant la sémantique C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type référence dans le style C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type valeur dans le style C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de virgule flottante de style C# où deux NaN sont considérés égaux même si selon IEC 60559:1989 NaN n’est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de virgule flottante de style C# où deux NaN sont considérés égaux même si selon IEC 60559:1989 NaN n’est égal à aucune valeur, y compris NaN. |
...
| int [get_CurrentEra](../calendar/get_currentera/)() const | Obtient l’indice de l’ère courante. |
| int [get_CurrentEraValue](../calendar/get_currenteravalue/)() const | Obtient la valeur de l’ère courante. |
| [ArrayPtr](../../system/arrayptr/)\<int\> [get_Eras](./get_eras/)() const override | Obtient la liste des ères existant dans le calendrier. |
...
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | Obtient la dernière année qui peut être représentée par un chiffre à deux chiffres. |
...
| **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) const override | Vérifie si le mois est intercalaire. |
| virtual **bool** [IsLeapMonth](./isleapmonth/)(int, int) const | Vérifie si le mois est intercalaire. |
| virtual **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) const | Vérifie si le mois est intercalaire. |
...
| **bool** [IsValidDay](../calendar/isvalidday/)(int, int, int, int) const | Vérifie les valeurs d’année, mois, jour et ère. |
...
| virtual void [set_TwoDigitYearMax](../calendar/set_twodigityearmax/)(int) | Définit la dernière année qui peut être représentée par un chiffre à deux chiffres. |
