...
description: "Calendrier hébreu. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des fautes d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 144
url: /fr/system.globalization/hebrewcalendar/
---
...
| Méthode | Description |
| --- | --- |
| virtual [DateTime](../../system/datetime/) [AddDays](../calendar/adddays/)([DateTime](../../system/datetime/), int) const | Ajoute des jours au point de temps. |
| virtual [DateTime](../../system/datetime/) [AddHours](../calendar/addhours/)([DateTime](../../system/datetime/), int) const | Ajoute des heures au point de temps. |
| virtual [DateTime](../../system/datetime/) [AddMilliseconds](../calendar/addmilliseconds/)([DateTime](../../system/datetime/), **double**) const | Ajoute des millisecondes au point de temps. |
| virtual [DateTime](../../system/datetime/) [AddMinutes](../calendar/addminutes/)([DateTime](../../system/datetime/), int) const | Ajoute des minutes au point de temps. |
| virtual [DateTime](../../system/datetime/) [AddMonths](../calendar/addmonths/)([DateTime](../../system/datetime/), int) const | Ajoute des mois au point de temps. |
| virtual [DateTime](../../system/datetime/) [AddSeconds](../calendar/addseconds/)([DateTime](../../system/datetime/), int) const | Ajoute des secondes au point de temps. |
| virtual [DateTime](../../system/datetime/) [AddWeeks](../calendar/addweeks/)([DateTime](../../system/datetime/), int) const | Ajoute des semaines au point de temps. |
| virtual [DateTime](../../system/datetime/) [AddYears](../calendar/addyears/)([DateTime](../../system/datetime/), int) const | Ajoute des années au point de temps. |
|  [Calendar](../calendar/calendar/)(const [Calendar](../calendar/)\&) | Informations RTTI. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Crée une copie de l'objet actuel et retourne un pointeur partagé vers celui-ci. |
...
| [DateTime](../../system/datetime/) [get_MaxSupportedDateTime](./get_maxsupporteddatetime/)() const override | Point de temps maximal pris en charge par le calendrier. |
| [DateTime](../../system/datetime/) [get_MinSupportedDateTime](./get_minsupporteddatetime/)() const override | Point de temps minimal pris en charge par le calendrier. |
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | Obtient la dernière année pouvant être représentée par un format à deux chiffres. |
...
| [DayOfWeek](../../system/dayofweek/) [GetDayOfWeek](./getdayofweek/)([DateTime](../../system/datetime/)) const override | Obtient le jour de la semaine pour le point de temps spécifié. |
...
| int [GetLeapMonth](./getleapmonth/)(int, int) const override | Obtient le mois bisextile pour l'année spécifiée. |
...
| int [GetMonth](./getmonth/)([DateTime](../../system/datetime/)) const override | Obtient le mois pour le point de temps spécifié. |
...
| virtual int [GetYear](../calendar/getyear/)([DateTime](../../system/datetime/)) const | Obtient l'année pour le point de temps spécifié. |
|  [HebrewCalendar](./hebrewcalendar/)() | Constructeur. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Vérifie si l'objet représente une instance du type décrit par targetType. Analogue de l'opérateur C# 'is'. |
| **bool** [IsLeapDay](./isleapday/)(int, int, int, int) override | Vérifie si le jour est bissextile. |
...
| **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) override | Vérifie si le mois est bissextile. |
...
| **bool** [IsLeapYear](./isleapyear/)(int, int) override | Vérifie si l'année est bissextile. |
...
| void [set_TwoDigitYearMax](./set_twodigityearmax/)(int) override | Définit la dernière année pouvant être représentée par un format à deux chiffres. |
