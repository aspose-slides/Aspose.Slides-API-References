...
description: Vérifie si le jour est bissextile.
type: docs
weight: 131
url: /fr/system.globalization/chineselunisolarcalendar/isleapday/
---
## ChineseLunisolarCalendar::IsLeapDay(int, int, int, int) const méthode
...
## ChineseLunisolarCalendar::IsLeapDay(int, int, int) const méthode
