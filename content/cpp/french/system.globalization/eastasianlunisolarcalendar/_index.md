...
description: "Calendrier luni-solaire est-asiatique. Les objets de cette classe doivent être alloués uniquement en utilisant la fonction System::MakeObject() . Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en tant qu'argument."
type: docs
weight: 105
url: /fr/system.globalization/eastasianlunisolarcalendar/
---
...
| [CalendarAlgorithmType](../calendaralgorithmtype/) [get_AlgorithmType](./get_algorithmtype/)() const override | Informations RTTI. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<int\> [get_Eras](../calendar/get_eras/)() const | Obtient la liste des ères existantes dans le calendrier. |
| virtual [Details::CalendarId](../../system.globalization.details/calendarid/) [get_ID](../calendar/get_id/)() const | Obtient l'identifiant du calendrier. |
| **bool** [get_IsReadOnly](../calendar/get_isreadonly/)() const | Vérifie si le calendrier est en lecture seule. |
| virtual [DateTime](../../system/datetime/) [get_MaxSupportedDateTime](../calendar/get_maxsupporteddatetime/)() const | Point temporel maximal pris en charge par le calendrier. |
| virtual [DateTime](../../system/datetime/) [get_MinSupportedDateTime](../calendar/get_minsupporteddatetime/)() const | Point temporel minimal pris en charge par le calendrier. |
...
| int [GetCelestialStem](./getcelestialstem/)(int) const | Obtient le tige céleste. |
...
| virtual int [GetDaysInMonth](../calendar/getdaysinmonth/)(int, int) const | Obtient le nombre de jours dans un mois spécifique. |
| virtual int [GetDaysInMonth](../calendar/getdaysinmonth/)(int, int, int) const | Obtient le nombre de jours dans un mois spécifique. |
| virtual int [GetDaysInYear](../calendar/getdaysinyear/)(int) const | Obtient le nombre de jours dans une année spécifique. |
| virtual int [GetDaysInYear](../calendar/getdaysinyear/)(int, int) const | Obtient le nombre de jours dans une année spécifique. |
| virtual int [GetEra](../calendar/getera/)([DateTime](../../system/datetime/)) const | Obtient l'ère pour le point temporel spécifié. |
...
| virtual int [GetLeapMonth](../calendar/getleapmonth/)(int) const | Obtient le mois intercalaire pour l'année spécifiée. |
| virtual int [GetLeapMonth](../calendar/getleapmonth/)(int, int) const | Obtient le mois intercalaire pour l'année spécifiée. |
...
| virtual int [GetSexagenaryYear](./getsexagenaryyear/)([DateTime](../../system/datetime/)) const | Obtient l'année dans le cycle sexagésimal. |
| int [GetTerrestrialBranch](./getterrestrialbranch/)(int) const | Obtient la branche terrestre. |
...
| virtual **bool** [IsLeapDay](../calendar/isleapday/)(int, int, int) const | Vérifie si le jour est intercalaire. |
| virtual **bool** [IsLeapDay](../calendar/isleapday/)(int, int, int, int) const | Vérifie si le jour est intercalaire. |
...
| virtual **bool** [IsLeapYear](../calendar/isleapyear/)(int) const | Vérifie si l'année est intercalaire. |
| virtual **bool** [IsLeapYear](../calendar/isleapyear/)(int, int) const | Vérifie si l'année est intercalaire. |
