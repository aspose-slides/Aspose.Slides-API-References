...
description: "Fournit des informations sur la région. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 274
url: /fr/system.globalization/regioninfo/
---
## RegionInfo classe
...
| virtual [String](../../system/string/) [get_CurrencyEnglishName](./get_currencyenglishname/)() const | Obtient le nom anglais de la devise. |
| virtual [String](../../system/string/) [get_CurrencyNativeName](./get_currencynativename/)() const | Obtient le nom natif de la devise. |
| virtual [String](../../system/string/) [get_CurrencySymbol](./get_currencysymbol/)() const | Obtient le symbole de la devise. |
| static [RegionInfoPtr](../regioninfoptr/) [get_CurrentRegion](./get_currentregion/)() | Obtient la région définie dans le système. |
| virtual [String](../../system/string/) [get_DisplayName](./get_displayname/)() const | Obtient le nom complet de la région. |
| virtual [String](../../system/string/) [get_EnglishName](./get_englishname/)() const | Obtient le nom anglais de la région. |
| virtual int [get_GeoId](./get_geoid/)() const | Obtient l'identificateur unique d'une région. |
| virtual **bool** [get_IsMetric](./get_ismetric/)() const | Vérifie si la région utilise le système métrique. |
| virtual [String](../../system/string/) [get_ISOCurrencySymbol](./get_isocurrencysymbol/)() const | Obtient le symbole ISO de la devise. |
| virtual [String](../../system/string/) [get_Name](./get_name/)() const | Obtient le nom de la région. |
| virtual [String](../../system/string/) [get_NativeName](./get_nativename/)() const | Obtient le nom natif de la région. |
| virtual [String](../../system/string/) [get_ThreeLetterISORegionName](./get_threeletterisoregionname/)() const | Obtient le code ISO de région à 3 lettres. |
| virtual [String](../../system/string/) [get_ThreeLetterWindowsRegionName](./get_threeletterwindowsregionname/)() const | Obtient le code de région à 3 lettres [Windows](../../system.windows/). |
| virtual [String](../../system/string/) [get_TwoLetterISORegionName](./get_twoletterisoregionname/)() const | Obtient le code ISO de région à 2 lettres. |
...
|  [RegionInfo](./regioninfo/)(const [String](../../system/string/)\&) | Information RTTI. |
