...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | Renvoie les données de fichier d’un objet OLE intégré en lecture seule **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | Renvoie l’extension de fichier de l’objet OLE intégré actuel en lecture seule [System::String](../../system/string/). |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | Crée une nouvelle instance d’informations de données intégrées pour l’objet OLE. |
...
* Espace de noms [Aspose::Slides::DOM::Ole](../)
