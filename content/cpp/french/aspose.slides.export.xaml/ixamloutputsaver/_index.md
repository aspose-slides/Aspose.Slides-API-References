...
description: Représente une implémentation de sauvegarde de sortie permettant de transférer des données vers le stockage externe.
type: docs
weight: 14
url: /fr/aspose.slides.export.xaml/ixamloutputsaver/
---
## IXamlOutputSaver classe

Représente une implémentation de sauvegarde de sortie permettant de transférer des données vers le stockage externe.
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Enregistre un tableau d’octets à l’emplacement de destination. |
