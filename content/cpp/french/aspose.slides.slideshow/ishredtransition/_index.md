...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Direction de la transition. Lire [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | Spécifie la forme des visuels utilisés pendant la transition. Lire [TransitionShredPattern](../transitionshredpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Direction de la transition. Écrire [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | Spécifie la forme des visuels utilisés pendant la transition. Écrire [TransitionShredPattern](../transitionshredpattern/). |
