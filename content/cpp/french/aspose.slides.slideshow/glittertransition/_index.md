...
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | Spécifie la forme des éléments visuels utilisés pendant la transition. Lire [TransitionPattern](../transitionpattern/). |
...
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | Spécifie la forme des éléments visuels utilisés pendant la transition. Écrire [TransitionPattern](../transitionpattern/). |
...
* Classe [IGlitterTransition](../iglittertransition/)
