...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Cet attribut indique si la transition commencera depuis un écran noir (et ensuite fera la transition de la nouvelle diapositive sur le noir). Lecture **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien en réalité, se contente d'initialiser un nouvel objet et autorise la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien en réalité, se contente d'initialiser un nouvel objet et autorise la construction par copie des sous-classes. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Cet attribut indique si la transition commencera depuis un écran noir (et ensuite fera la transition de la nouvelle diapositive sur le noir). Écriture **bool**. |
