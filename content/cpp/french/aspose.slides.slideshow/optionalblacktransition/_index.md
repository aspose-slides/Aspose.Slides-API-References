...
description: Effet de transition de diapositive noire facultatif.
type: docs
weight: 326
...
| **bool** [get_FromBlack](./get_fromblack/)() override | Cet attribut spécifie si la transition commencera à partir d’un écran noir (et ensuite fera la transition de la nouvelle diapositive sur du noir). Lecture **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l’objet. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Fait office de fonction de hachage pour un type particulier, adaptée à une utilisation dans des algorithmes de hachage et des structures de données comme une table de hachage. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogue à la méthode C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permet de cloner des types personnalisés. |
...
| void [set_FromBlack](./set_fromblack/)(**bool**) override | Cet attribut spécifie si la transition commencera à partir d’un écran noir (et ensuite fera la transition de la nouvelle diapositive sur du noir). Écriture **bool**. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogue à la méthode C# [Object.ToString()](../../system/object/tostring/). Permet de convertir des objets personnalisés en chaîne. |
...
* Classe [IOptionalBlackTransition](../ioptionalblacktransition/)
