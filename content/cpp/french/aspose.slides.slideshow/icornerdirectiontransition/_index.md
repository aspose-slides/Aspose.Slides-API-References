...
description: Effet de transition de diapositive en direction du coin.
type: docs
weight: 66
...
Effet de transition de diapositive en direction du coin.
...
| virtual [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() | Direction de la transition. Lire [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) | Direction de la transition. Écrire [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
