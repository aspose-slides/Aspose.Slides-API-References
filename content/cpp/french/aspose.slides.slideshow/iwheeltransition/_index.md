...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | Nombre de rayons de la transition de roue. Lire **uint32_t**. |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | Nombre de rayons de la transition de roue. Écriture **uint32_t**. |
