...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Direction de la transition. Lire [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | Spécifie si la transition passe par un fondu noir. Lire **bool**. |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | Direction de la transition. Écrire [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | Spécifie si la transition passe par un fondu noir. Écrire **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nth argument de modèle comme un pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs vers le mode faible. |
