...
description: Effet de transition In-Out de diapositive.
type: docs
weight: 131
...
Effet de transition In-Out de diapositive.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Direction d'un effet de transition. Lire [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Direction d'un effet de transition. Écrire [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
