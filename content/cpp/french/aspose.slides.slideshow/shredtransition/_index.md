...
description: Effet de transition de diapositive découpée.
type: docs
weight: 378
...
Effet de transition de diapositive découpée.
...
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | Spécifie la forme des visuels utilisés pendant la transition. Lire [TransitionShredPattern](../transitionshredpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Sert de fonction de hachage pour un type particulier, adaptée à une utilisation dans les algorithmes de hachage et les structures de données comme une table de hachage. |
...
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | Spécifie la forme des visuels utilisés pendant la transition. Écrire [TransitionShredPattern](../transitionshredpattern/). |
