...
description: Effet de transition de glissement de la roue.
type: docs
weight: 443
...
Effet de transition de glissement de la roue.
...
| **uint32_t** [get_Spokes](./get_spokes/)() override | Nombre de rayons de la transition de la roue. Lire **uint32_t**. |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | Nombre de rayons de la transition de la roue. Écrire **uint32_t**. |
