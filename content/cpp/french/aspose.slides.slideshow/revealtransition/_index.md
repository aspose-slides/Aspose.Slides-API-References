...
| [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() override | Direction de la transition. Lire [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| **bool** [get_ThroughBlack](./get_throughblack/)() override | Spécifie si la transition s’estompe via le noir. Lire **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l’objet. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Servit de fonction de hachage pour un type particulier, adaptée à une utilisation dans les algorithmes de hachage et les structures de données comme une table de hachage. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, vraiment, il initialise seulement un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, vraiment, il initialise seulement un nouvel objet et permet la construction par copie des sous-classes. |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | Direction de la transition. Écrire [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | Spécifie si la transition s’estompe via le noir. Écrire **bool**. |
...
* Classe [IRevealTransition](../irevealtransition/)
