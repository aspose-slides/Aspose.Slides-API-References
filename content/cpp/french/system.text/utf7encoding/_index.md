...
description: "Codage UTF-7. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou avec l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en tant qu'argument."
type: docs
weight: 365
url: /fr/system.text/utf7encoding/
---
## UTF7Encoding classe

UTF-7 encoding. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instance de ce type sur la pile ou à l'aide de l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le transmettre aux fonctions en tant qu'argument.
...
| [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_DecoderFallback](../encoding/get_decoderfallback/)() const | Obtient la stratégie de secours du décodeur. |
| static [EncodingPtr](../../system/encodingptr/) [get_Default](../encoding/get_default/)() | Obtient l'encodage par défaut. |
| const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_EncoderFallback](../encoding/get_encoderfallback/)() const | Obtient la stratégie de secours de l'encodeur. |
...
| virtual **bool** [get_IsSingleByte](../encoding/get_issinglebyte/)() | Vérifie si l'encodage est sur un seul octet. |
...
| static [EncodingPtr](../../system/encodingptr/) [get_UTF8Unmarked](../encoding/get_utf8unmarked/)() | Interne uniquement, à utiliser par les bibliothèques de classes : non marqué et ne valide pas l'entrée. |
...
| int [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Obtient les octets résultant de l'encodage d'un tampon de caractères. |
...
| int [GetBytes](./getbytes/)(const [String](../../system/string/)\&, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Obtient les octets résultant de l'encodage d'un tampon de caractères. |
...
| int [GetCharCount](./getcharcount/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) override | Obtient le nombre de caractères nécessaires pour décoder un tampon d'octets. |
...
| int [GetChars](./getchars/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<char_t\>, int) override | Obtient les caractères résultant du décodage d'un tampon d'octets. |
...
| int [GetMaxByteCount](./getmaxbytecount/)(int) override | Obtient le nombre maximum d'octets nécessaires pour encoder un nombre spécifié de caractères. |
| int [GetMaxCharCount](./getmaxcharcount/)(int) override | Obtient le nombre maximum de caractères nécessaires pour décoder un nombre spécifié d'octets. |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetPreamble](../encoding/getpreamble/)() | Retourne une séquence d'octets qui indique l'encodage (p. ex. BOM). |
| [String](../../system/string/) [GetString](./getstring/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) override | Décode un tampon d'octets en une chaîne. |
...
| **bool** [operator==](./operator_equal_equal/)(const [UTF7Encoding](./)\&) const | Compare les paramètres d'encodage. |
...
| void [set_DecoderFallback](../encoding/set_decoderfallback/)(const [DecoderFallbackPtr](../../system/decoderfallbackptr/)\&) | Définit la stratégie de secours du décodeur. |
| void [set_EncoderFallback](../encoding/set_encoderfallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | Définit la stratégie de secours de l'encodeur. |
...
| static constexpr [UTF7_CODE_PAGE](./utf7_code_page/) | Nombre magique utilisé par [Windows](../../system.windows/) pour l'ID de page de code UTF-7. |
