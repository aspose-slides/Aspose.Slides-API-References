...
description: "Exception levée par DecoderExceptionFallback lorsque le décodage échoue. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe DecoderFallbackException. Ne jamais encapsuler les instances de la classe DecoderFallbackException dans System::SmartPtr."
type: docs
weight: 105
url: /fr/system.text/details_decoderfallbackexception/
---
## Détails_DecoderFallbackException class


Exception levée par [DecoderExceptionFallback](../decoderexceptionfallback/) lorsque le décodage échoue. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe DecoderFallbackException à la place. Ne jamais encapsuler les instances de la classe DecoderFallbackException dans [System::SmartPtr](../../system/smartptr/).
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Obtient le tableau d’octets qui a déclenché l’erreur. |
...
| int [get_Index](./get_index/)() | Obtient la position de l’octet qui a déclenché l’erreur dans le tableau d’entrée. |
