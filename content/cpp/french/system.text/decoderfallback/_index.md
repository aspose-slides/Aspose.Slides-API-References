...
| Méthode | Description |
| --- | --- |
| virtual [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() | Obtient le tampon associé à l'algorithme de repli. |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](./get_exceptionfallback/)() | Obtient l'implémentation de repli d'exception par défaut. |
| virtual int [get_MaxCharCount](./get_maxcharcount/)() const | Obtient le nombre maximal de caractères pouvant être renvoyés par le repli. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](./get_replacementfallback/)() | Obtient l'implémentation de repli de remplacement par défaut. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](./get_standardsafefallback/)() | Obtient l'implémentation de repli sûre standard par défaut. |
