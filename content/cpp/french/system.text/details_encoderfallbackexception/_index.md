...
description: "Exception lancée par EncoderExceptionFallback lorsque l'encodage échoue. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe EncoderFallbackException à la place. Ne jamais encapsuler les instances de la classe EncoderFallbackException dans System::SmartPtr."
type: docs
weight: 118
url: /fr/system.text/details_encoderfallbackexception/
---
## Details_EncoderFallbackException classe

Exception lancée par [EncoderExceptionFallback](../encoderexceptionfallback/) lorsque l’encodage échoue. Ne créez jamais d’instances de cette classe manuellement. Utilisez la classe EncoderFallbackException à la place. Ne jamais encapsuler les instances de la classe EncoderFallbackException dans [System::SmartPtr](../../system/smartptr/).
...
| char_t [get_CharUnknown](./get_charunknown/)() | Obtient le caractère qui a déclenché l’erreur. |
| char_t [get_CharUnknownHigh](./get_charunknownhigh/)() | Obtient le caractère haut de la paire qui a déclenché l’erreur. |
| char_t [get_CharUnknownLow](./get_charunknownlow/)() | Obtient le caractère bas de la paire qui a déclenché l’erreur. |
...
| int [get_Index](./get_index/)() | Obtient la position du caractère qui a déclenché l’erreur dans le tableau d’entrée. |
