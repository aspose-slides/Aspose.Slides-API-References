...
description: Obtient le nombre de caractères nécessaires pour décoder un tampon d'octets.
type: docs
weight: 261
url: /fr/system.text/encoding/getcharcount/
---
## Encoding::GetCharCount(ArrayPtr\<uint8_t\>, int, int) méthode
...
## Encoding::GetCharCount(ArrayPtr\<uint8_t\>) méthode
...
## Encoding::GetCharCount(const uint8_t *, int) méthode
