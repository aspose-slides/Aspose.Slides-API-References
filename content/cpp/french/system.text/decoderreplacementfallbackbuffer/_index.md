...
description: Tampon pour remplacer la stratégie de repli de décodage.
type: docs
weight: 92
url: /fr/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer classe


[Buffer](../../system/buffer/) pour remplacer la stratégie de repli de décodage.
...
| Méthode | Description |
| --- | --- |
|  [DecoderReplacementFallbackBuffer](./decoderreplacementfallbackbuffer/)(const [DecoderReplacementFallbackPtr](../../system/decoderreplacementfallbackptr/)\&) | Constructeur. |
...
| **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Gère l’échec de décodage. |
...
| char_t [GetNextChar](./getnextchar/)() override | Obtient le caractère suivant disponible. |
...
| **bool** [MovePrevious](./moveprevious/)() override | Se déplace au caractère précédent. |
