...
type: docs
weight: 79
url: /fr/system.text/encoder/convert/
---
## Encoder::Convert(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int, int, bool, int\&, int\&, bool\&) méthode
...
## Encoder::Convert(const char_t *, int, uint8_t *, int, bool, int\&, int\&, bool\&) méthode
