...
| Méthode | Description |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | Applique un schéma de couleurs supplémentaire à une diapositive. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | Renvoie l'objet thème. |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Détermine si [OverrideTheme](../overridetheme/) remplace le thème effectif hérité ou non. Pour activer [OverrideTheme](../overridetheme/) pour le remplacement, utilisez les méthodes OverrideTheme.Init*(). Pour désactiver [OverrideTheme](../overridetheme/) du remplacement, utilisez la méthode [get_OverrideTheme()](./get_overridetheme/)->Clear(). Lecture seule **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Renvoie l'objet de thème de remplacement. Lecture [IOverrideTheme](../ioverridetheme/). |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | Renvoie l'objet de thème de remplacement. Écriture [IOverrideTheme](../ioverridetheme/). |
...
* Classe [IThemeManager](../ithememanager/)
