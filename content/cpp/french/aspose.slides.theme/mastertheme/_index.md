...
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) override | Renvoie le schéma de couleurs supplémentaire à l'index spécifié. Ce schéma n'affecte pas l'apparence de la présentation, il peut être sélectionné comme schéma de couleurs principal pour une diapositive. Lecture seule [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() override | Renvoie la collection de schémas de couleurs supplémentaires. Ces schémas n'affectent pas l'apparence de la présentation, ils peuvent être sélectionnés comme schéma de couleurs principal pour une diapositive. Lecture seule [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
...
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Renvoie le nom d'un thème. Lecture [System::String](../../system/string/). |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Renvoie le nom d'un thème. Écriture [System::String](../../system/string/). |
