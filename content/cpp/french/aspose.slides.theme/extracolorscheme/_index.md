...
description: Représente un schéma de couleur supplémentaire qui peut être attribué à une diapositive.
type: docs
weight: 79
...
Représente un schéma de couleur supplémentaire qui peut être attribué à une diapositive.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | Retourne un schéma de couleur. Lecture seule [IColorScheme](../icolorscheme/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Retourne le nom de ce schéma. Lecture seule [System::String](../../system/string/). |
