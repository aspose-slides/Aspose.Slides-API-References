...
description: Représente les objets pouvant être thématisés avec ITheme.
type: docs
weight: 443
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() | Renvoie un thème effectif pour cet objet thématisable. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de modèle comme pointeur faible (plutôt que partagé). Permet le changement de pointeurs dans les conteneurs en mode faible. |
