...
description: Classe de base pour les classes qui fournissent l'accès à différents types de thèmes.
type: docs
weight: 14
...
Classe de base pour les classes qui fournissent l'accès à différents types de thèmes.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien réellement, il initialise simplement le nouvel objet et permet la construction de copies dans les sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien réellement, il initialise simplement le nouvel objet et permet la construction de copies dans les sous-classes. |
