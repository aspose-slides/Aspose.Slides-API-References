...
description: Fournit l'accès au thème de diapositive de mise en page remplacé.
type: docs
weight: 482
...
Fournit l'accès au thème de diapositive de mise en page remplacé.
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Détermine si [OverrideTheme](../overridetheme/) surcharge le thème effectif hérité ou non. Pour activer [OverrideTheme](../overridetheme/) pour la surcharge, utilisez les méthodes OverrideTheme.Init*(). Pour désactiver [OverrideTheme](../overridetheme/) de la surcharge, utilisez la méthode [OverrideTheme::Clear](../overridetheme/clear/). Lecture seule **bool**. |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Renvoie l'objet thème de remplacement. Écrivez [IOverrideTheme](../ioverridetheme/). |
