...
| Méthode | Description |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Applique un schéma de couleur supplémentaire à une diapositive. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../baseoverridethememanager/createthemeeffective/)() override | Renvoie l'objet thème. |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Détermine si [OverrideTheme](../overridetheme/) remplace le thème effectif hérité ou non. Pour activer [OverrideTheme](../overridetheme/) pour le remplacement, utilisez les méthodes OverrideTheme.Init*(). Pour désactiver [OverrideTheme](../overridetheme/) du remplacement, utilisez la méthode [OverrideTheme::Clear](../overridetheme/clear/). Lecture seule **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Renvoie l'objet thème de remplacement. Lire [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Renvoie l'objet thème de remplacement. Écriture [IOverrideTheme](../ioverridetheme/). |
