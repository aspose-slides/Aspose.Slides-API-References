...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() | Renvoie la collection de polices pour la partie "heading" de la diapositive. Lecture seule [IFonts](../../aspose.slides/ifonts/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() | Renvoie la collection de polices pour la partie "body" de la diapositive. Lecture seule [IFonts](../../aspose.slides/ifonts/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Renvoie le nom du schéma de polices. Lecture [System::String](../../system/string/). |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Renvoie le nom du schéma de polices. Écriture [System::String](../../system/string/). |
