...
description: Représente l'élément maxInclusive du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe peut être utilisée pour spécifier une restriction sur la valeur maximale d'un élément simpleType. La valeur de l'élément doit être inférieure ou égale à la valeur de l'élément maxInclusive.
type: docs
weight: 586
url: /fr/system.xml.schema/xmlschemamaxinclusivefacet/
---
## XmlSchemaMaxInclusiveFacet classe


Représente l'élément **maxInclusive** de XML [Schema](../) tel que spécifié par le Consortium World Wide [Web](../../system.web/) (W3C). Cette classe peut être utilisée pour spécifier une restriction sur la valeur maximale d'un élément **simpleType**. La valeur de l'élément doit être inférieure ou égale à la valeur de l'élément **maxInclusive**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\> [get_Annotation](../xmlschemaannotated/get_annotation/)() | Retourne la propriété **annotation**. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Retourne l'ID de chaîne. |
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Retourne les informations indiquant que cette facette est fixe. |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Retourne le numéro de ligne dans le fichier auquel l'élément **schema** fait référence. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Retourne la position de la ligne dans le fichier auquel l'élément **schema** fait référence. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Retourne le XmlSerializerNamespaces à utiliser avec cet objet de schéma. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Retourne le parent de ce [XmlSchemaObject](../xmlschemaobject/). |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Retourne l'emplacement source du fichier qui a chargé le schéma. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Retourne les attributs qualifiés qui n'appartiennent pas à l'espace de noms cible du schéma actuel. |
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Retourne l'attribut **value** de la facette. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Définit les informations indiquant que cette facette est fixe. |
...
|  [XmlSchemaMaxInclusiveFacet](./xmlschemamaxinclusivefacet/)() | Initialise une nouvelle instance de la classe [XmlSchemaMaxInclusiveFacet](./). |
