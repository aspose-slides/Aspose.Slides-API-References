...
description: Représente l'élément any du World Wide Web Consortium (W3C).
type: docs
weight: 131
url: /fr/system.xml.schema/xmlschemaany/
---
## XmlSchemaAny classe

Représente le consortium World Wide [Web](../../system.web/) (W3C) **any** élément.
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Renvoie le nombre maximal d'occurrences du particule. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Renvoie le nombre sous forme de chaîne. Nombre maximal d'occurrences du particule. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Renvoie le nombre minimal d'occurrences du particule. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Renvoie le nombre sous forme de chaîne. Le nombre minimal d'occurrences du particule. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Renvoie les espaces de noms contenant les éléments pouvant être utilisés. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Renvoie le parent de cet [XmlSchemaObject](../xmlschemaobject/). |
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Renvoie des informations sur la manière dont une application ou un processeur XML doit gérer la validation des documents XML pour les éléments spécifiés par l'élément **any**. |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Définit le nombre maximal d'occurrences du particule. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Définit le nombre sous forme de chaîne. Nombre maximal d'occurrences du particule. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Définit le nombre minimal d'occurrences du particule. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Définit le nombre sous forme de chaîne. Le nombre minimal d'occurrences du particule. |
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Définit les espaces de noms contenant les éléments pouvant être utilisés. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Définit les informations sur la façon dont une application ou un processeur XML doit gérer la validation des documents XML pour les éléments spécifiés par l'élément **any**. |
