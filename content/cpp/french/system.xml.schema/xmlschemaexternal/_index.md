...
description: Fournit des informations sur le schéma inclus.
type: docs
weight: 391
url: /fr/system.xml.schema/xmlschemaexternal/
---
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison à virgule flottante de style C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, un NaN n'est égal à aucune valeur, y compris NaN. |
...
| [String](../../system/string/) [get_Id](./get_id/)() | Renvoie l'identifiant de chaîne. |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Renvoie le numéro de ligne du fichier auquel l'élément **schema** fait référence. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Renvoie la position de ligne du fichier auquel l'élément **schema** fait référence. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](./get_schema/)() | Renvoie le [XmlSchema](../xmlschema/) du schéma référencé. |
| [String](../../system/string/) [get_SchemaLocation](./get_schemalocation/)() | Renvoie l'emplacement Uniform Resource Identifier (URI) du schéma, qui indique au processeur de schéma où le schéma réside physiquement. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Définit le numéro de ligne du fichier auquel l'élément **schema** fait référence. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Définit la position de ligne du fichier auquel l'élément **schema** fait référence. |
...
| void [set_Schema](./set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Définit le [XmlSchema](../xmlschema/) du schéma référencé. |
| void [set_SchemaLocation](./set_schemalocation/)(const [String](../../system/string/)\&) | Définit l'emplacement Uniform Resource Identifier (URI) du schéma, qui indique au processeur de schéma où le schéma réside physiquement. |
