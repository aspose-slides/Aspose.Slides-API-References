...
description: Représente l'élément d'extension du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe est destinée aux types complexes avec un modèle de contenu complexe dérivé par extension. Elle étend le type complexe en ajoutant des attributs ou des éléments.
type: docs
weight: 274
url: /fr/system.xml.schema/xmlschemacomplexcontentextension/
---
## XmlSchemaComplexContentExtension classe


Représente l'élément **extension** de XML [Schema](../) tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C). Cette classe est destinée aux types complexes avec un modèle de contenu complexe dérivé par extension. Elle étend le type complexe en ajoutant des attributs ou des éléments.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Returns the collection of attributes for the complex content. Contains [XmlSchemaAttribute](../xmlschemaattribute/) and [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) elements. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Returns the name of the complex type from which this type is derived by extension. |
...
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Sets the name of the complex type from which this type is derived by extension. |
