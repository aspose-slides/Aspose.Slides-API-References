...
description: Représente l'élément sélecteur du World Wide Web Consortium (W3C).
type: docs
weight: 963
url: /fr/system.xml.schema/xmlschemaxpath/
---
## XmlSchemaXPath classe

Représente l'élément **selector** du Consortium World Wide [Web](../../system.web/) (W3C).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison en virgule flottante de style C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, le NaN n'est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison en virgule flottante de style C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, le NaN n'est égal à aucune valeur, y compris NaN. |
...
| [String](../../system/string/) [get_XPath](./get_xpath/)() | Renvoie l'attribut pour l'expression [XPath](../../system.xml.xpath/). |
...
| void [set_XPath](./set_xpath/)(const [String](../../system/string/)\&) | Définit l'attribut pour l'expression [XPath](../../system.xml.xpath/). |
