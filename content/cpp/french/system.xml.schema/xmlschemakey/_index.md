...
description: Cette classe représente l'élément key du XMLSchema tel que spécifié par le World Wide Web Consortium (W3C).
type: docs
weight: 534
url: /fr/system.xml.schema/xmlschemakey/
---
## XmlSchemaKey classe

Cette classe représente l'élément **key** de XMLSchema tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C).
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](../xmlschemaidentityconstraint/get_fields/)() | Renvoie la collection de champs qui s'appliquent en tant qu'enfants pour le sélecteur d'expression du langage de chemin XML ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](../xmlschemaidentityconstraint/get_name/)() | Renvoie le nom de la contrainte d'identité. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](../xmlschemaidentityconstraint/get_qualifiedname/)() | Renvoie le nom qualifié de la contrainte d'identité, qui contient l'interprétation post-compilation de la valeur **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](../xmlschemaidentityconstraint/get_selector/)() | Renvoie l'élément **selector** de l'expression [XPath](../../system.xml.xpath/). |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Renvoie les attributs qualifiés qui ne font pas partie de l'espace de noms cible du schéma actuel. |
...
| void [set_Name](../xmlschemaidentityconstraint/set_name/)(const [String](../../system/string/)\&) | Définit le nom de la contrainte d'identité. |
...
| void [set_Selector](../xmlschemaidentityconstraint/set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Définit l'élément **selector** de l'expression [XPath](../../system.xml.xpath/). |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Définit les attributs qualifiés qui ne font pas partie de l'espace de noms cible du schéma actuel. |
...
|  [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/xmlschemaidentityconstraint/)() | Initialise une nouvelle instance de la classe [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/). |
