...
description: Renvoie des informations détaillées sur l'exception de schéma.
type: docs
weight: 1
url: /fr/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException classe

Renvoie des informations détaillées sur l'exception de schéma.
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Renvoie le numéro de ligne indiquant où l'erreur s'est produite. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Renvoie la position de ligne indiquant où l'erreur s'est produite. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Renvoie la description de la condition d'erreur de cette exception. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | Le **[XmlSchemaObject](../xmlschemaobject/)** qui a produit l'XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Renvoie l'emplacement Uniform Resource Identifier (URI) du schéma à l'origine de l'exception. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de template comme un pointeur faible (plutôt que partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
