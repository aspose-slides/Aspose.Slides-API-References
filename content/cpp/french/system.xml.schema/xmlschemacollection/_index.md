...
description: Contient un cache de schémas du langage de définition XML (XSD) et de schémas XML-Data Reduced (XDR).
type: docs
weight: 222
url: /fr/system.xml.schema/xmlschemacollection/
---
## XmlSchemaCollection classe

Contient un cache du langage de définition XML [Schema](../) (XSD) et des schémas XML-Data Reduced (XDR).
...
| Méthode | Description |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Ajoute le schéma situé à l'URL donnée à la collection de schémas. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Ajoute le schéma contenu dans le [XmlReader](../../system.xml/xmlreader/) à la collection de schémas. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Ajoute le schéma contenu dans le [XmlReader](../../system.xml/xmlreader/) à la collection de schémas. Le [XmlResolver](../../system.xml/xmlresolver/) spécifié est utilisé pour résoudre les ressources externes. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Ajoute le [XmlSchema](../xmlschema/) à la collection. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Ajoute le [XmlSchema](../xmlschema/) à la collection. Le [XmlResolver](../../system.xml/xmlresolver/) spécifié est utilisé pour résoudre les références externes. |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | Ajoute tous les espaces de noms définis dans la collection donnée (ainsi que leurs schémas associés) à cette collection. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtient un itérateur pointant vers le premier élément const-qualifié (le cas échéant) de la collection. |
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Renvoie une valeur indiquant si le **targetNamespace** du [XmlSchema](../xmlschema/) spécifié se trouve dans la collection. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | Renvoie une valeur indiquant si un schéma avec l’espace de noms spécifié se trouve dans la collection. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | Copie tous les objets [XmlSchema](../xmlschema/) de cette collection dans le tableau donné en commençant à l’indice indiqué. |
...
| **int32_t** [get_Count](./get_count/)() | Renvoie le nombre d’espaces de noms définis dans cette collection. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | Renvoie le [XmlNameTable](../../system.xml/xmlnametable/) par défaut utilisé par le [XmlSchemaCollection](./) lors du chargement de nouveaux schémas. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l’objet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | Fournit le support d’itération sur la collection de schémas. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../../system/object/gethashcode/). Permet le hachage d’objets personnalisés. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtient le type réel de l’objet. Analogue de l’appel C# [System.Object.GetType()](../../system/object/gettype/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Renvoie le [XmlSchema](../xmlschema/) associé à l’URI d’espace de noms fourni. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Renvoie l’élément à l’indice indiqué dans une séquence. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Renvoie l’élément à l’indice indiqué dans une séquence. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉᵗʰ argument de modèle comme pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
...
|  [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Initialise une nouvelle instance de la classe [XmlSchemaCollection](./) avec le [XmlNameTable](../../system.xml/xmlnametable/) spécifié. Le [XmlNameTable](../../system.xml/xmlnametable/) est utilisé lors du chargement des schémas. |
...
Obsolète
:   La classe [XmlSchemaCollection](./) est obsolète. Utilisez [XmlSchemaSet](../xmlschemaset/) à la place.
