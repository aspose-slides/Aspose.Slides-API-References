...
description: Spécifie une restriction sur le nombre de chiffres pouvant être saisis pour la valeur de fraction d'un élément simpleType. La valeur de fractionDigits doit être un entier positif. Représente le World Wide Web Consortium (W3C) fractionDigits facet.
type: docs
weight: 417
url: /fr/system.xml.schema/xmlschemafractiondigitsfacet/
---
## XmlSchemaFractionDigitsFacet classe


Spécifie une restriction sur le nombre de chiffres pouvant être saisis pour la valeur de fraction d'un élément simpleType. La valeur de fractionDigits doit être un entier positif. Représente le consortium World Wide [Web](../../system.web/) (W3C) **fractionDigits** facet.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Returns information that indicates that this facet is fixed. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Returns the **value** attribute of the facet. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Sets information that indicates that this facet is fixed. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Sets the **value** attribute of the facet. |
...
|  [XmlSchemaFacet](../xmlschemafacet/xmlschemafacet/)() | Initializes a new instance of the [XmlSchemaFacet](../xmlschemafacet/) class. |
...
Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction [System::MakeObject()](../../system/makeobject/).  
Ne créez jamais d'instances de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion.  
Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument.  
