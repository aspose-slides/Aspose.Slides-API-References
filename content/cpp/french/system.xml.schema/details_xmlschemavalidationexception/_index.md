...
description: Représente l'exception levée lorsque des erreurs et avertissements de validation de schéma XML Schema Definition Language (XSD) sont rencontrés dans un document XML en cours de validation.
type: docs
weight: 27
url: /fr/system.xml.schema/details_xmlschemavalidationexception/
---
## Details_XmlSchemaValidationException classe

Représente l'exception levée lorsque des erreurs et avertissements de validation de schéma XML [Schema](../) Definition Language (XSD) sont rencontrés dans un document XML en cours de validation.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Renvoie une valeur entière 32 bits qui est un code HRESULT associé à l'exception représentée par l'objet actuel. |
...
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | Renvoie la position dans la ligne indiquant où l'erreur s'est produite. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | Renvoie le nœud XML qui a déclenché cette XmlSchemaValidationException. |
...
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | Renvoie l'emplacement Uniform Resource Identifier (URI) du schéma qui a provoqué l'exception. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il ne fait qu'initialiser un nouvel objet et permet la construction copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il ne fait qu'initialiser un nouvel objet et permet la construction copie des sous-classes. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉ argument de modèle comme un pointeur faible (plutôt que partagé). Permet de passer les pointeurs des conteneurs en mode faible. |
