...
description: Représente l'élément pattern du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe peut être utilisée pour spécifier une restriction sur la valeur saisie pour un élément simpleType.
type: docs
weight: 742
url: /fr/system.xml.schema/xmlschemapatternfacet/
---
## XmlSchemaPatternFacet classe


Représente l'**pattern** élément de XML [Schema](../) tel que spécifié par le Consortium World Wide [Web](../../system.web/) (W3C). Cette classe peut être utilisée pour spécifier une restriction sur la valeur saisie pour un élément **simpleType**.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie en fait rien, il se contente d'initialiser un nouvel objet et permet de copier les sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie en fait rien, il se contente d'initialiser un nouvel objet et permet de copier les sous-classes. |
...
|  [XmlSchemaPatternFacet](./xmlschemapatternfacet/)() | Initialise une nouvelle instance de la classe [XmlSchemaPatternFacet](./). |
