...
description: Représente l'élément list du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe peut être utilisée pour définir un élément simpleType comme une liste de valeurs d'un type de données spécifié.
type: docs
weight: 859
url: /fr/system.xml.schema/xmlschemasimpletypelist/
---
## XmlSchemaSimpleTypeList classe


Représente l'élément **list** de XML [Schema](../) tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C). Cette classe peut être utilisée pour définir un élément **simpleType** comme une liste de valeurs d'un type de données spécifié.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseItemType](./get_baseitemtype/)() | Renvoie le [XmlSchemaSimpleType](../xmlschemasimpletype/) représentant le type de l'élément **simpleType** basé sur les valeurs [XmlSchemaSimpleTypeList::get_ItemType](./get_itemtype/) et [XmlSchemaSimpleTypeList::get_ItemTypeName](./get_itemtypename/) du type simple. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Renvoie l'identifiant de chaîne. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_ItemType](./get_itemtype/)() | Renvoie l'élément **simpleType** qui est dérivé du type spécifié par la valeur de base. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_ItemTypeName](./get_itemtypename/)() | Renvoie le nom d'un type de données intégré ou d'un élément **simpleType** défini dans ce schéma (ou un autre schéma indiqué par l'espace de noms spécifié). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie rien, en réalité, il initialise simplement le nouvel objet et permet la construction de copies des sous-classes. |
...
| void [set_BaseItemType](./set_baseitemtype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Définit le [XmlSchemaSimpleType](../xmlschemasimpletype/) représentant le type de l'élément **simpleType** basé sur les valeurs [XmlSchemaSimpleTypeList::get_ItemType](./get_itemtype/) et [XmlSchemaSimpleTypeList::get_ItemTypeName](./get_itemtypename/) du type simple. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Définit l'identifiant de chaîne. |
| void [set_ItemType](./set_itemtype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Définit l'élément **simpleType** qui est dérivé du type spécifié par la valeur de base. |
| void [set_ItemTypeName](./set_itemtypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Définit le nom d'un type de données intégré ou d'un élément **simpleType** défini dans ce schéma (ou un autre schéma indiqué par l'espace de noms spécifié). |
...
Les objets de cette classe doivent être alloués uniquement à l'aide de la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instances de ce type sur la pile ou avec l'opérateur new, car cela entraînerait des erreurs d’exécution et/ou des fautes d’assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le transmettre aux fonctions en tant qu'argument. 
