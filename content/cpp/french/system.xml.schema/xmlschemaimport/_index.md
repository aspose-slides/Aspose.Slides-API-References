...
description: Représente l'élément import du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe est utilisée pour importer des composants de schéma à partir d'autres schémas.
type: docs
weight: 482
url: /fr/system.xml.schema/xmlschemaimport/
---
## XmlSchemaImport classe


Représente l'élément **import** de XML [Schema](../) tel que spécifié par le Consortium [Web](../../system.web/) World Wide (W3C). Cette classe est utilisée pour importer des composants de schéma à partir d'autres schémas.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\> [get_Annotation](./get_annotation/)() | Renvoie la valeur **annotation**. |
| [String](../../system/string/) [get_Id](../xmlschemaexternal/get_id/)() | Renvoie l'identifiant de chaîne. |
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Renvoie l'espace de noms cible pour le schéma importé sous forme de référence d'Identificateur Uniforme de Ressource (URI). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](../xmlschemaexternal/get_schema/)() | Renvoie le [XmlSchema](../xmlschema/) pour le schéma référencé. |
| [String](../../system/string/) [get_SchemaLocation](../xmlschemaexternal/get_schemalocation/)() | Renvoie l'emplacement de l'Identificateur Uniforme de Ressource (URI) pour le schéma, qui indique au processeur de schéma où le schéma réside physiquement. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaexternal/get_unhandledattributes/)() | Renvoie les attributs qualifiés, qui n'appartiennent pas à l'espace de noms cible du schéma. |
...
| void [set_Annotation](./set_annotation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\>\&) | Définit la valeur **annotation**. |
| void [set_Id](../xmlschemaexternal/set_id/)(const [String](../../system/string/)\&) | Définit l'identifiant de chaîne. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Définit l'espace de noms cible pour le schéma importé sous forme de référence d'URI. |
...
| void [set_Schema](../xmlschemaexternal/set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Définit le [XmlSchema](../xmlschema/) pour le schéma référencé. |
| void [set_SchemaLocation](../xmlschemaexternal/set_schemalocation/)(const [String](../../system/string/)\&) | Définit l'emplacement de l'URI pour le schéma, qui indique au processeur de schéma où le schéma réside physiquement. |
...
| void [set_UnhandledAttributes](../xmlschemaexternal/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Définit les attributs qualifiés, qui n'appartiennent pas à l'espace de noms cible du schéma. |
...
|  [XmlSchemaExternal](../xmlschemaexternal/xmlschemaexternal/)() | Initialise une nouvelle instance de la classe [XmlSchemaExternal](../xmlschemaexternal/). |
