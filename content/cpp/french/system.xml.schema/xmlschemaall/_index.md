...
description: Représente l'élément all (compositeur) du World Wide Web Consortium (W3C).
type: docs
weight: 92
url: /fr/system.xml.schema/xmlschemaall/
---
## XmlSchemaAll classe


Représente le consortium World Wide [Web](../../system.web/) (W3C) **all** élément (compositeur).
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Renvoie la collection d'éléments [XmlSchemaElement](../xmlschemaelement/) contenus dans le compositeur **all**. |
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Renvoie le nombre maximum de fois que la particule peut apparaître. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Renvoie le nombre sous forme de chaîne. Nombre maximum de fois que la particule peut apparaître. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Renvoie le nombre minimum de fois que la particule peut apparaître. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Renvoie le nombre sous forme de chaîne. Le nombre minimum de fois que la particule peut apparaître. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Renvoie les attributs qualifiés qui n'appartiennent pas à l'espace de noms cible du schema actuel. |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Définit le nombre maximum de fois que la particule peut apparaître. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Définit le nombre sous forme de chaîne. Nombre maximum de fois que la particule peut apparaître. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Définit le nombre minimum de fois que la particule peut apparaître. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Définit le nombre sous forme de chaîne. Le nombre minimum de fois que la particule peut apparaître. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Définit les attributs qualifiés qui n'appartiennent pas à l'espace de noms cible du schema actuel. |
...
|  [XmlSchemaAll](./xmlschemaall/)() | Initialise une nouvelle instance de la classe [XmlSchemaAll](./). |
