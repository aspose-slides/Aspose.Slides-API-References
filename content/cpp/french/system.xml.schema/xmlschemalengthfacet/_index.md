...
description: Représente la facette de longueur du schéma XML telle que spécifiée par le World Wide Web Consortium (W3C). Cette classe peut être utilisée pour spécifier une restriction sur la longueur d'un élément simpleType du type de données.
type: docs
weight: 560
url: /fr/system.xml.schema/xmlschemalengthfacet/
---
## XmlSchemaLengthFacet classe

Représente la facette **length** provenant de XML [Schema](../) telle que spécifiée par le Consortium World Wide [Web](../../system.web/) (W3C). Cette classe peut être utilisée pour spécifier une restriction sur la longueur d'un élément **simpleType** du type de données.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Renvoie une information indiquant que cette facette est fixe. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Définit une information indiquant que cette facette est fixe. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument template comme pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs vers le mode faible. |
...
|  [XmlSchemaLengthFacet](./xmlschemalengthfacet/)() | Initialise une nouvelle instance de la classe [XmlSchemaLengthFacet](./). |
