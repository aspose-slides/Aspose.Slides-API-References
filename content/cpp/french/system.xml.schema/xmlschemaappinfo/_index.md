...
description: Représente l'élément appinfo du World Wide Web Consortium (W3C).
type: docs
weight: 157
url: /fr/system.xml.schema/xmlschemaappinfo/
---
## XmlSchemaAppInfo classe

Représente l'élément **appinfo** du Consortium World Wide [Web](../../system.web/) (W3C).
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Renvoie un tableau d'objets [XmlNode](../../system.xml/xmlnode/) qui représente les nœuds enfants **appinfo**. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Renvoie la source des informations d’application. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Définit un tableau d'objets [XmlNode](../../system.xml/xmlnode/) qui représente les nœuds enfants **appinfo**. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Définit la source des informations d’application. |
