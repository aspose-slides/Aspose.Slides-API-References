...
description: Une classe de base pour toutes les facettes utilisées lorsque des types simples sont dérivés par restriction.
type: docs
weight: 404
url: /fr/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet classe

Une classe de base pour toutes les facettes utilisées lorsque des types simples sont dérivés par restriction.
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | Renvoie des informations indiquant que cette facette est fixe. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | Renvoie l’attribut **value** de la facette. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | Définit les informations indiquant que cette facette est fixe. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Définit l’attribut **value** de la facette. |
