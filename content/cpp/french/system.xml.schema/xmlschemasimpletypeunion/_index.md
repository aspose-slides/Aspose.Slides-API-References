...
description: Représente l'élément union pour les types simples du XML Schema tel que spécifié par le World Wide Web Consortium (W3C). Un datatype union peut être utilisé pour spécifier le contenu d'un simpleType. La valeur de l'élément simpleType doit être l'une des datatypes alternatives spécifiées dans l'union. Les types union sont toujours des types dérivés et doivent comprendre au moins deux datatypes alternatives.
type: docs
weight: 885
url: /fr/system.xml.schema/xmlschemasimpletypeunion/
---
## XmlSchemaSimpleTypeUnion classe

Représente l'élément **union** pour les types simples du XML [Schema](../) tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C). Un datatype **union** peut être utilisé pour spécifier le contenu d'un **simpleType**. La valeur de l'élément **simpleType** doit être l'une des alternatives de datatype spécifiées dans l'union. Les types union sont toujours des types dérivés et doivent comprendre au moins deux datatypes alternatifs.
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\> [get_BaseMemberTypes](./get_basemembertypes/)() | Renvoie un tableau d'objets [XmlSchemaSimpleType](../xmlschemasimpletype/) représentant le type de l'élément **simpleType** selon les valeurs [XmlSchemaSimpleTypeUnion::get_BaseTypes](./get_basetypes/) et [XmlSchemaSimpleTypeUnion::get_MemberTypes](./get_membertypes/) du type simple. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_BaseTypes](./get_basetypes/)() | Renvoie la collection des types de base. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\> [get_MemberTypes](./get_membertypes/)() | Renvoie le tableau des noms de membres qualifiés des types de données intégrés ou des éléments **simpleType** définis dans ce schéma (ou un autre schéma indiqué par l'espace de noms spécifié). |
...
| void [set_MemberTypes](./set_membertypes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\&) | Définit le tableau des noms de membres qualifiés des types de données intégrés ou des éléments **simpleType** définis dans ce schéma (ou un autre schéma indiqué par l'espace de noms spécifié). |
