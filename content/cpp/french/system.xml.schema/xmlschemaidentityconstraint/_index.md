...
description: "Classe pour les contraintes d'identité : éléments key, keyref et unique."
type: docs
weight: 469
url: /fr/system.xml.schema/xmlschemaidentityconstraint/
---
## XmlSchemaIdentityConstraint classe
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type référence à la manière C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type valeur à la manière C#. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Renvoie la collection de champs qui s'appliquent comme enfants pour le sélecteur d'expression XML Path Language ([XPath](../../system.xml.xpath/)). |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Renvoie l'ID de chaîne. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Renvoie le nom de la contrainte d'identité. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Renvoie le nom qualifié de la contrainte d'identité, qui contient l'interprétation post-compilation de la valeur **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Renvoie l'élément **selector** de l'expression [XPath](../../system.xml.xpath/). |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Définit le nom de la contrainte d'identité. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Définit l'élément **selector** de l'expression [XPath](../../system.xml.xpath/). |
