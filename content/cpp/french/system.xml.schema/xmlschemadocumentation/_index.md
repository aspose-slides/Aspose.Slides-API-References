...
description: Représente l'élément de documentation du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe spécifie les informations à lire ou à utiliser par les humains au sein d'une annotation.
type: docs
weight: 352
url: /fr/system.xml.schema/xmlschemadocumentation/
---
## XmlSchemaDocumentation classe

Représente l'élément **documentation** provenant de XML [Schema](../) tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C). Cette classe spécifie les informations à lire ou à utiliser par les humains au sein d'une **annotation**.
...
| [String](../../system/string/) [get_Language](./get_language/)() | Renvoie l'attribut **xml:lang**. Cela sert d'indicateur de la langue utilisée dans le contenu. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Renvoie un tableau d'objets [XmlNode](../../system.xml/xmlnode/) qui représente les nœuds enfants de la documentation. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Renvoie la source de l'Uniform Resource Identifier (URI) de l'information. |
...
| void [set_Language](./set_language/)(const [String](../../system/string/)\&) | Définit l'attribut **xml:lang**. Cela sert d'indicateur de la langue utilisée dans le contenu. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Définit un tableau d'objets [XmlNode](../../system.xml/xmlnode/) qui représente les nœuds enfants de la documentation. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Définit la source de l'Uniform Resource Identifier (URI) de l'information. |
