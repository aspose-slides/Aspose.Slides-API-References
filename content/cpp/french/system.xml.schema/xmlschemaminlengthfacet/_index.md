...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Renvoie la chaîne id. |
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Renvoie l'information indiquant que cette facette est fixe. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Renvoie le XmlSerializerNamespaces à utiliser avec cet objet schema. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Renvoie les attributs qualifiés qui ne font pas partie de l'espace de noms cible du schema actuel. |
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Renvoie l'attribut **value** de la facette. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Définit la chaîne id. |
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Définit l'information indiquant que cette facette est fixe. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Définit le XmlSerializerNamespaces à utiliser avec cet objet schema. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Définit les attributs qualifiés qui ne font pas partie de l'espace de noms cible du schema actuel. |
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Définit l'attribut **value** de la facette. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ème argument de modèle comme pointeur faible (plutôt que partagé). Autorise le basculement des pointeurs dans les conteneurs vers le mode faible. |
...
|  [XmlSchemaMinLengthFacet](./xmlschemaminlengthfacet/)() | Initialise une nouvelle instance de la classe [XmlSchemaMinLengthFacet](./). |
...
Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instances de ce type sur la pile ou à l'aide de l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des assertions. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument. 
