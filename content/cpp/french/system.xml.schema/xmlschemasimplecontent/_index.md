...
description: Représente l'élément simpleContent du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe est destinée aux types simples et complexes avec un modèle de contenu simple.
type: docs
weight: 794
url: /fr/system.xml.schema/xmlschemasimplecontent/
---
## XmlSchemaSimpleContent classe


Représente l'élément **simpleContent** de XML [Schema](../) tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C). Cette classe est destinée aux types simples et complexes avec un modèle de contenu simple.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Renvoie l'un des [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) ou [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Renvoie l'un des [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) ou [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
