...
description: Représente l'élément attributeGroup du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). AttributesGroups fournit un mécanisme permettant de regrouper un ensemble de déclarations d'attributs afin de les incorporer comme groupe dans des définitions de types complexes.
type: docs
weight: 183
url: /fr/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup classe

Représente l'élément **attributeGroup** du XML [Schema](../) tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C). AttributesGroups fournit un mécanisme permettant de regrouper un ensemble de déclarations d'attributs afin qu'elles puissent être incorporées comme un groupe dans des définitions de types complexes.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Renvoie le composant [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) du groupe d'attributs. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Renvoie la collection d'attributs du groupe d'attributs. Contient les éléments [XmlSchemaAttribute](../xmlschemaattribute/) et [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Renvoie le nom du groupe d'attributs. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Renvoie le nom complet du groupe d'attributs. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | Renvoie la propriété du groupe d'attributs redéfinie depuis le XML [Schema](../). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Définit le composant [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) du groupe d'attributs. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Définit le nom du groupe d'attributs. |
