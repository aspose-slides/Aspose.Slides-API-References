...
description: Renvoie des informations sur les erreurs rencontrées par la classe XmlSchemaInference lors de l'inférence d'un schéma à partir d'un document XML.
type: docs
weight: 14
url: /fr/system.xml.schema/details_xmlschemainferenceexception/
---
## Details_XmlSchemaInferenceException classe


Renvoie des informations sur les erreurs rencontrées par la classe [XmlSchemaInference](../xmlschemainference/) lors de l’inférence d’un schéma à partir d’un document XML.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emule la comparaison en virgule flottante de style C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n’est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emule la comparaison en virgule flottante de style C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n’est égal à aucune valeur, y compris NaN. |
...
| **int32_t** [get_LineNumber](../details_xmlschemaexception/get_linenumber/)() | Renvoie le numéro de ligne indiquant où l’erreur s’est produite. |
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | Renvoie la position de la ligne indiquant où l’erreur s’est produite. |
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | Renvoie la description de la condition d’erreur de cette exception. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | Le **[XmlSchemaObject](../xmlschemaobject/)** qui a produit l’XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | Renvoie l’emplacement de l’Uniform Resource Identifier (URI) du schéma qui a causé l’exception. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Renvoie la chaîne contenant la trace de pile. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Obtient le type réel de l’objet. Analogue de l’appel [System.Object.GetType()](../../system/object/gettype/) de C#. |
