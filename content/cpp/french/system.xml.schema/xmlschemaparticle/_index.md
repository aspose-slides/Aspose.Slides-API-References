...
description: Une classe de base pour cela est la classe de base pour tous les types de particules (par ex. XmlSchemaAny).
type: docs
weight: 729
url: /fr/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle classe

Une classe de base pour cela est la classe de base pour tous les types de particules (par ex. [XmlSchemaAny](../xmlschemaany/)).
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Renvoie le nombre maximal d’occurrences de la particule. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Renvoie le nombre sous forme de chaîne. Nombre maximal d’occurrences de la particule. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Renvoie le nombre minimal d’occurrences de la particule. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Renvoie le nombre sous forme de chaîne. Nombre minimal d’occurrences de la particule. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, il initialise simplement un nouvel objet et permet aux sous-classes de se copier. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie réellement rien, il initialise simplement un nouvel objet et permet aux sous-classes de se copier. |
...
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Définit le nombre maximal d’occurrences de la particule. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Définit le nombre sous forme de chaîne. Nombre maximal d’occurrences de la particule. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Définit le nombre minimal d’occurrences de la particule. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Définit le nombre sous forme de chaîne. Nombre minimal d’occurrences de la particule. |
