...
description: Contient un cache de schémas du langage de définition XML Schema (XSD).
type: docs
weight: 781
url: /fr/system.xml.schema/xmlschemaset/
---
## XmlSchemaSet classe


Contient un cache de schémas de langage de définition XML [Schema](../) (XSD).
