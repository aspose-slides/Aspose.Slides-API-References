...
description: Représente l'élément sequence (composeur) du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). La séquence exige que les éléments du groupe apparaissent dans l'ordre spécifié à l'intérieur de l'élément contenant.
type: docs
weight: 768
url: /fr/system.xml.schema/xmlschemasequence/
---
## XmlSchemaSequence classe


Représente l'élément **sequence** (composeur) du XML [Schema](../) tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C). Le **sequence** exige que les éléments du groupe apparaissent dans l'ordre spécifié à l'intérieur de l'élément conteneur.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | The elements contained within the compositor. Collection of [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./), or [XmlSchemaAny](../xmlschemaany/). |
