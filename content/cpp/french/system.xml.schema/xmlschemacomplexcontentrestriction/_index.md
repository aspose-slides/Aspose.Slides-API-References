...
description: Représente l'élément restriction du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe est destinée aux types complexes avec un modèle de contenu complexe dérivé par restriction. Elle restreint le contenu du type complexe à un sous-ensemble du type complexe hérité.
type: docs
weight: 287
url: /fr/system.xml.schema/xmlschemacomplexcontentrestriction/
---
## XmlSchemaComplexContentRestriction classe

Représente l'élément **restriction** de XML [Schema](../) tel que spécifié par le consortium World Wide [Web](../../system.web/) (W3C). Cette classe est destinée aux types complexes avec un modèle de contenu complexe dérivé par restriction. Elle restreint le contenu du type complexe à un sous-ensemble du type complexe hérité.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Renvoie le composant [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) du modèle de contenu complexe. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Renvoie la collection d'attributs pour le type complexe. Contient les éléments [XmlSchemaAttribute](../xmlschemaattribute/) et [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Renvoie le nom d'un type complexe dont ce type est dérivé par restriction. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\> [get_Particle](./get_particle/)() | Renvoie l'une des classes [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) ou [XmlSchemaSequence](../xmlschemasequence/). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Définit le composant [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) du modèle de contenu complexe. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Définit le nom d'un type complexe dont ce type est dérivé par restriction. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\>\&) | Définit l'une des classes [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) ou [XmlSchemaSequence](../xmlschemasequence/). |
