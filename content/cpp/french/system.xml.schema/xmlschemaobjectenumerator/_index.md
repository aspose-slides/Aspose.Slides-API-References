...
description: Représente l'énumérateur pour la XmlSchemaObjectCollection.
type: docs
weight: 703
url: /fr/system.xml.schema/xmlschemaobjectenumerator/
---
## XmlSchemaObjectEnumerator classe
...
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaObject](../xmlschemaobject/)\>\> * [CloneIterator](./cloneiterator/)() const override | Clone l'itérateur actuel. |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\& [get_Current](./get_current/)() const override | Renvoie le [XmlSchemaObject](../xmlschemaobject/) actuel dans la collection. |
...
| **bool** [MoveNext](./movenext/)() override | Passe à l'élément suivant de la collection. |
...
| void [Reset](./reset/)() override | Réinitialise l'énumérateur au début de la collection. |
