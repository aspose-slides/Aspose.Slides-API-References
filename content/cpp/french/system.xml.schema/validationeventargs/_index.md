...
description: Renvoie des informations détaillées liées au ValidationEventHandler.
type: docs
weight: 53
url: /fr/system.xml.schema/validationeventargs/
---
## ValidationEventArgs classe

Renvoie des informations détaillées liées au ValidationEventHandler.
...
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | Renvoie l'XmlSchemaException associé à l'événement de validation. |
| [String](../../system/string/) [get_Message](./get_message/)() | Renvoie la description textuelle correspondant à l'événement de validation. |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | Renvoie la gravité de l'événement de validation. |
