...
description: Représente l'élément d'annotation du World Wide Web Consortium (W3C).
type: docs
weight: 118
url: /fr/system.xml.schema/xmlschemaannotation/
---
## XmlSchemaAnnotation classe

Représente le consortium mondial [Web](../../system.web/) (W3C) **annotation**.
...
| [String](../../system/string/) [get_Id](./get_id/)() | Retourne l'identifiant de chaîne. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Retourne la collection **Items** utilisée pour stocker les éléments enfants **appinfo** et **documentation**. |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Retourne la position de ligne dans le fichier auquel l'élément **schema** fait référence. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](./get_unhandledattributes/)() | Retourne les attributs qualifiés qui n'appartiennent pas à l'espace de noms cible du schéma. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie en réalité rien, se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie en réalité rien, se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
...
| void [set_Id](./set_id/)(const [String](../../system/string/)\&) | Définit l'identifiant de chaîne. |
