...
description: Représente l'element choice (compositeur) du schema XML tel que spécifié par le World Wide Web Consortium (W3C). Le choice ne permet qu'un seul de ses enfants d'apparaître dans une instance.
type: docs
weight: 209
url: /fr/system.xml.schema/xmlschemachoice/
---
## XmlSchemaChoice classe

Represente l'élément **choice** (compositeur) du XML [Schema](../) tel que spécifié par le Consortium [Web](../../system.web/) World Wide (W3C). Le **choice** ne permet qu'un seul de ses enfants d'apparaître dans une instance.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Renvoie la collection des éléments contenus avec le compositeur (**choice**) : [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](./), [XmlSchemaSequence](../xmlschemasequence/) ou [XmlSchemaAny](../xmlschemaany/). |
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Renvoie le nombre maximal d'occurrences du particle. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Renvoie le nombre sous forme de chaîne. Nombre maximal d'occurrences du particle. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Renvoie le nombre minimal d'occurrences du particle. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Renvoie le nombre sous forme de chaîne. Nombre minimal d'occurrences du particle. |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Définit le nombre maximal d'occurrences du particle. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Définit le nombre sous forme de chaîne. Nombre maximal d'occurrences du particle. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Définit le nombre minimal d'occurrences du particle. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Définit le nombre sous forme de chaîne. Nombre minimal d'occurrences du particle. |
...
| Typedef | Description |
| --- | --- |
| [Ptr](./ptr/) | Un alias pour le pointeur partagé d'une instance de cette classe. |
