...
description: Fournit des options de compilation de schéma pour la classe XmlSchemaSet. Cette classe ne peut pas être héritée.
type: docs
weight: 248
url: /fr/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings classe

Fournit des options de compilation de schéma pour la classe [XmlSchemaSet](../xmlschemaset/). Cette classe ne peut pas être héritée.
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Renvoie une valeur indiquant si le [XmlSchemaSet](../xmlschemaset/) doit vérifier les violations de l'attribution unique de particules (UPA). |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Définit une valeur indiquant si le [XmlSchemaSet](../xmlschemaset/) doit vérifier les violations de l'attribution unique de particules (UPA). |
...
| [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | Initialise une nouvelle instance de la classe [XmlSchemaCompilationSettings](./). |
