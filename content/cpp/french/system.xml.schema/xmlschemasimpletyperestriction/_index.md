...
description: Représente l'élément restriction pour les types simples du schéma XML tel que spécifié par le World Wide Web Consortium (W3C). Cette classe peut être utilisée pour restreindre l'élément simpleType.
type: docs
weight: 872
url: /fr/system.xml.schema/xmlschemasimpletyperestriction/
---
## XmlSchemaSimpleTypeRestriction classe


Représente l'élément **restriction** pour les types simples de XML [Schema](../) tel que spécifié par le Consortium World Wide [Web](../../system.web/) (W3C). Cette classe peut être utilisée pour restreindre l'élément **simpleType**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Renvoie les informations sur le type de base. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Renvoie le nom du type de base qualifié. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Renvoie une facette [Xml](../../system.xml/)[Schema](../). |
...
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Définit les informations sur le type de base. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Définit le nom du type de base qualifié. |
