...
description: Représente l'élément attributeGroup avec l'attribut ref du Schéma XML tel que spécifié par le . AttributesGroupRef est la référence pour un attributeGroup, la propriété name contient le groupe d'attributs référencé.
type: docs
weight: 196
url: /fr/system.xml.schema/xmlschemaattributegroupref/
---
## XmlSchemaAttributeGroupRef classe


Représente l'élément **attributeGroup** avec l'attribut **ref** du XML [Schema](../) tel que spécifié par le [World Wide Web Consortium (W3C)](https://go.microsoft.com/fwlink/?LinkId=49454). AttributesGroupRef est la référence pour un attributeGroup, la propriété name contient le groupe d'attributs référencé.
...
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Renvoie le numéro de ligne dans le fichier auquel fait référence l'élément **schema**. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Renvoie la position de ligne dans le fichier auquel fait référence l'élément **schema**. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Renvoie le nom de l'élément **attributeGroup** référencé. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il initialise seulement un nouvel objet et permet la construction de copies des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il initialise seulement un nouvel objet et permet la construction de copies des sous-classes. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Définit le numéro de ligne dans le fichier auquel fait référence l'élément **schema**. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Définit la position de ligne dans le fichier auquel fait référence l'élément **schema**. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Définit le nom de l'élément **attributeGroup** référencé. |
