...
description: Représente la facette totalDigits du schéma XML telle que spécifiée par le World Wide Web Consortium (W3C). Cette classe peut être utilisée pour spécifier une restriction sur le nombre de chiffres qui peuvent être saisis pour la valeur d'un élément simpleType. Cette valeur de totalDigits doit être un entier positif.
type: docs
weight: 898
url: /fr/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet classe


Représente la facette **totalDigits** de XML [Schema](../) telle que spécifiée par le consortium World Wide [Web](../../system.web/) (W3C). Cette classe peut être utilisée pour spécifier une restriction sur le nombre de chiffres pouvant être saisis pour la valeur d'un élément **simpleType**. Cette valeur de **totalDigits** doit être un entier positif.
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Renvoie l'identifiant de la chaîne. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Définit l'identifiant de la chaîne. |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | Initialise une nouvelle instance de la classe [XmlSchemaTotalDigitsFacet](./). |
