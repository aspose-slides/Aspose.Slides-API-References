...
description: Représente l'élément anyAttribute du World Wide Web Consortium (W3C).
type: docs
weight: 144
url: /fr/system.xml.schema/xmlschemaanyattribute/
---
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Renvoie les espaces de noms contenant les attributs qui peuvent être utilisés. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Renvoie des informations sur la façon dont une application ou un processeur XML doit gérer la validation des documents XML pour les attributs spécifiés par l'élément **anyAttribute**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie en fait rien, initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie en fait rien, initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Définit les espaces de noms contenant les attributs qui peuvent être utilisés. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Définit des informations sur la façon dont une application ou un processeur XML doit gérer la validation des documents XML pour les attributs spécifiés par l'élément **anyAttribute**. |
