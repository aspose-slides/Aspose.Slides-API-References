...
| **bool** [get_IsSynchronized](../../system.collections.generic/idictionary/get_issynchronized/)() const | Vérifie si le conteneur est sûr pour les threads. |
...
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey\&) const | Renvoie la valeur si trouvée ; ou **Value()** sinon. |
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey\&, const TValue\&) const | Renvoie la valeur si trouvée ; ou **defaultValue** sinon. |
| virtual TValue [GetValueOrNull](../../system.collections.generic/idictionary/getvalueornull/)(const TKey\&) const | Renvoie la valeur si trouvée ; ou **null** sinon, ne fait sens que pour les types référence. |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) const override | Obtient la valeur d'une clé spécifique. |
