...
description: "Spécifie l’en-tête SOAP que la méthode de service Web XML ou le client de service Web XML peut traiter. Les objets de cette classe doivent être alloués uniquement à l’aide de la fonction System::MakeObject() . Ne créez jamais d’instance de ce type sur la pile ou avec l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des défauts d’assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument."
type: docs
weight: 92
url: /fr/system.web.services.protocols/soapheaderattribute/
---
## SoapHeaderAttribute classe


Spécifie l’en-tête SOAP que la méthode de service XML [Web](../../system.web/) ou le client de service XML [Web](../../system.web/) peut traiter. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des défauts d’assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument.
...
| [SoapHeaderDirection](../soapheaderdirection/) [get_Direction](./get_direction/)() | Obtient la direction de l’en-tête SOAP. |
| [String](../../system/string/) [get_MemberName](./get_membername/)() | Obtient le nom d’une variable membre du service SOAP XML utilisé pour recevoir le contenu de l’en-tête SOAP. |
| **bool** [get_Required](./get_required/)() | Obtient une valeur indiquant si l’en-tête SOAP doit être compris et traité par le service XML [Web](../../system.web/) destinataire ou le client de service XML [Web](../../system.web/). |
...
| void [set_Direction](./set_direction/)([SoapHeaderDirection](../soapheaderdirection/)) | Définit la direction de l’en-tête SOAP. |
| void [set_MemberName](./set_membername/)([String](../../system/string/)) | Définit le nom d’une variable membre du service SOAP XML utilisé pour recevoir le contenu de l’en-tête SOAP. |
| void [set_Required](./set_required/)(**bool**) | Définit une valeur indiquant si l’en-tête SOAP doit être compris et traité par le service XML [Web](../../system.web/) destinataire ou le client de service XML [Web](../../system.web/). |
...
|  [SoapHeaderAttribute](./soapheaderattribute/)([String](../../system/string/)) | Construit une nouvelle instance. |
