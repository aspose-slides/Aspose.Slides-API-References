...
description: Contient une collection d'instances de la classe SoapHeader.
type: docs
weight: 105
url: /fr/system.web.services.protocols/soapheadercollection/
---
## SoapHeaderCollection classe

Contient une collection d'instances de la classe [SoapHeader](../soapheader/).
...
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Ajoute l'élément à la fin de la liste. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | Obtient un itérateur pour un élément const non existant après la fin de la collection. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Obtient un itérateur inverse vers le dernier élément const de la collection (premier en sens inverse). |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | Obtient un itérateur pour un élément non existant après la fin de la collection. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | Obtient un itérateur pour un élément non existant après la fin de la collection qualifiée const. |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Vérifie si un élément satisfaisant le prédicat spécifié existe dans la liste. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | À usage interne uniquement. |
| T [Find](../../system.collections.generic/list/find/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche un élément satisfaisant le prédicat spécifié. |
| [ListPtr](../../system.collections.generic/listptr/)\<T\> [FindAll](../../system.collections.generic/list/findall/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche des éléments satisfaisant le prédicat spécifié. |
| int [FindIndex](../../system.collections.generic/list/findindex/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche un élément satisfaisant le prédicat spécifié. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, [System::Predicate](../../system/predicate/)\<T\>) | Recherche un élément satisfaisant le prédicat spécifié. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, int, [System::Predicate](../../system/predicate/)\<T\>) | Recherche un élément satisfaisant le prédicat spécifié. |
| T [FindLast](../../system.collections.generic/list/findlast/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche le dernier élément satisfaisant le prédicat spécifié. |
...
| int [IndexOf](../../system.collections.generic/list/indexof/)(const T\&) const override | Obtient le premier indice de l'élément spécifié. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Recherche l'objet spécifié et renvoie l'indice basé sur zéro de la dernière occurrence dans toute la liste. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice basé sur zéro de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) qui s'étend du premier élément jusqu'à l'indice spécifié. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice basé sur zéro de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) qui contient le nombre d'éléments spécifié et se termine à l'indice donné. |
...
| **bool** [Remove](../../system.collections.generic/list/remove/)(const T\&) override | Supprime la première occurrence de l'élément spécifié de la liste. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | Obtient un itérateur inverse pour un élément non existant avant le début de la collection qualifiée const. |
...
| [SoapHeaderCollection](./soapheadercollection/)() | Initialise une nouvelle instance de la classe [SoapHeaderCollection](./). |
