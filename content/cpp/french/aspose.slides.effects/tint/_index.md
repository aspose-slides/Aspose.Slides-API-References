...
description: Représente un effet Tint. Décale les valeurs de couleur de l'effet vers/loin de la teinte selon la quantité spécifiée.
type: docs
weight: 1093
...
Représente un effet [Tint](./). Décale les valeurs de couleur de l'effet vers/loin de la teinte selon la quantité spécifiée.
...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si le [Tint](./) spécifié est égal au [Tint](./) actuel. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les données d'effet [Tint](./) effectives avec l'héritage appliqué. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Serves de fonction de hachage pour un type particulier. |
