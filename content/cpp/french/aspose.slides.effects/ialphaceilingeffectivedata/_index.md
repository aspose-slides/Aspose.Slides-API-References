...
description: Objet immutable qui représente un effet de plafond Alpha. Les valeurs Alpha (opacité) supérieures à zéro sont modifiées à 100 %. En d'autres termes, tout ce qui est partiellement opaque devient entièrement opaque.
type: docs
weight: 274
...
Objet immutable qui représente un effet de plafond Alpha. Les valeurs Alpha (opacité) supérieures à zéro sont modifiées à 100 %. En d'autres termes, tout ce qui est partiellement opaque devient entièrement opaque.
