...
| virtual **float** [get_Amount](./get_amount/)() | Renvoie une quantité d'effet en pourcentage. Lecture **float**. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Renvoie une quantité d'effet en pourcentage. Écriture **float**. |
