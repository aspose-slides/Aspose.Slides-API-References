...
description: Représente un effet Duotone. Pour chaque pixel, combine Color1 et Color2 à l'aide d'une interpolation linéaire afin de déterminer la nouvelle couleur de ce pixel.
type: docs
weight: 157
...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si le [Duotone](./) spécifié est égal au [Duotone](./) actuel. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color1](./get_color1/)() override | Renvoie le format de couleur cible pour les pixels sombres. Lecture seule [IColorFormat](../../aspose.slides/icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color2](./get_color2/)() override | Renvoie le format de couleur cible pour les pixels clairs. Lecture seule [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotoneEffectiveData](../iduotoneeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les données d'effet [Duotone](./) effectives avec l'héritage appliqué. |
