...
description: Représente un effet Alpha Ceiling. Les valeurs Alpha (opacité) supérieures à zéro sont modifiées à 100%. En d'autres termes, tout ce qui est partiellement opaque devient totalement opaque.
type: docs
weight: 14
...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si le [AlphaCeiling](./) spécifié est égal au [AlphaCeiling](./) actuel. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les données d'effet Alpha Ceiling effect effectives avec l'héritage appliqué. |
