...
description: Représente un effet Alpha Inverse. Les valeurs Alpha (opacité) sont inversées en les soustrayant de 100%.
type: docs
weight: 40
...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si le [AlphaInverse](./) spécifié est égal au [AlphaInverse](./) actuel. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverseEffectiveData](../ialphainverseeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les données effectives de l'effet Alpha Inverse avec l'héritage appliqué. |
