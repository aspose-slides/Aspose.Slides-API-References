...
description: Objet immuable qui représente un effet Alpha Floor. Les valeurs Alpha (opacité) inférieures à 100% sont réduites à zéro. En d’autres termes, tout ce qui est partiellement transparent devient totalement transparent.
type: docs
weight: 300
...
Objet immuable qui représente un effet Alpha Floor. Les valeurs Alpha (opacité) inférieures à 100 % sont réduites à zéro. En d’autres termes, tout ce qui est partiellement transparent devient totalement transparent.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, il initialise simplement le nouvel objet et permet la construction de copies de sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie réellement rien, il initialise simplement le nouvel objet et permet la construction de copies de sous-classes. |
