...
description: Représente un effet de lueur, dans lequel une bordure de couleur floue est ajoutée à l'extérieur des bords de l'objet.
type: docs
weight: 638
...
Représente un effet [Glow](../glow/), dans lequel une bordure de couleur floue est ajoutée à l'extérieur des bords de l'objet.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Format de couleur. Lecture seule [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Rayon. Lecture **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie en fait rien, se contente d'initialiser un nouvel objet et permet la copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie en fait rien, se contente d'initialiser un nouvel objet et permet la copie des sous-classes. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Rayon. Écriture **double**. |
