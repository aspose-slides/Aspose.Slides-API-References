...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie l'élément par indice. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Détermine si un quelconque élément d'une séquence existe ou satisfait une condition. |
...
Le nom IImageTransformOperationCollectionEffectiveData a été tronqué à [IImageTransformOCollectionEffectiveData](./) parce que la longueur des noms COM ne peut pas dépasser 39. 
