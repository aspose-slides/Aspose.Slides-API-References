...
description: Objet immuable qui représente un effet de teinte. Décale les valeurs de couleur de l'effet vers ou loin de la teinte selon la quantité spécifiée.
type: docs
weight: 1002
...
Objet immuable qui représente un effet [Tint](../tint/). Décale les valeurs de couleur de l'effet vers/loin de la teinte selon la quantité spécifiée.
...
| virtual **float** [get_Amount](./get_amount/)() | Renvoie la quantité d'effet. Lecture seule **float**. |
| virtual **float** [get_Hue](./get_hue/)() | Renvoie la teinte. Lecture seule **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, il initialise simplement le nouvel objet et permet de construire par copie les sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie réellement rien, il initialise simplement le nouvel objet et permet de construire par copie les sous-classes. |
