...
description: Représente un effet Alpha Bi-Level. Les valeurs Alpha (Opacité) inférieures au seuil sont changées à 0 (entièrement transparent) et les valeurs alpha supérieures ou égales au seuil sont changées à 100% (entièrement opaque).
type: docs
weight: 235
...
| virtual **float** [get_Threshold](./get_threshold/)() | Renvoie le seuil de l'effet. Lecture **float**. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Renvoie le seuil de l'effet. Écriture **float**. |
...
Utilisez [ImageTransformOperationFactory](../imagetransformoperationfactory/) pour créer des instances dans COM. 
