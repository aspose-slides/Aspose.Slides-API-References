...
description: Objet immuable qui représente un effet de superposition de remplissage. Une superposition de remplissage peut être utilisée pour spécifier un remplissage supplémentaire pour un objet et mélanger les deux remplissages ensemble.
type: docs
weight: 625
url: /fr/aspose.slides.effects/ifilloverlayeffectivedata/
---
## IFillOverlayEffectiveData classe


Objet immuable qui représente un effet de superposition de remplissage. Une superposition de remplissage peut être utilisée pour spécifier un remplissage supplémentaire pour un objet et mélanger les deux remplissages ensemble.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Lecture seule [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Format de remplissage. Lecture seule [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
