...
description: Représente un effet de luminance. La luminosité décale linéairement toutes les couleurs vers le blanc ou le noir. Le contraste met à l'échelle toutes les couleurs pour qu'elles soient plus proches ou plus éloignées les unes des autres.
type: docs
weight: 794
...
Représente un effet [Luminance](../luminance/). La luminosité décale linéairement toutes les couleurs vers le blanc ou le noir. Le contraste ajuste toutes les couleurs pour qu’elles soient plus proches ou plus éloignées les unes des autres.
