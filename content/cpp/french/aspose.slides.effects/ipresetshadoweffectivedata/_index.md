...
type: docs
weight: 924
url: /fr/aspose.slides.effects/ippresetshadoweffectivedata/
---
...
| virtual **float** [get_Direction](./get_direction/)() | Direction de l'ombre. **float** en lecture seule. |
| virtual **double** [get_Distance](./get_distance/)() | Distance de l'ombre. **double** en lecture seule. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Préréglage. [PresetShadowType](../../aspose.slides/presetshadowtype/) en lecture seule. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Couleur de l'ombre. [System::Drawing::Color](../../system.drawing/color/) en lecture seule. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n ième argument de modèle comme un pointeur faible (au lieu d'un partagé). Permet de passer les pointeurs des conteneurs en mode faible. |
