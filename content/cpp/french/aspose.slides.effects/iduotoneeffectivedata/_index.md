...
description: Objet immuable qui représente un effet Duotone. Pour chaque pixel, combine clr1 et clr2 grâce à une interpolation linéaire afin de déterminer la nouvelle couleur de ce pixel.
type: docs
weight: 573
...
Objet immuable qui représente un effet [Duotone](../duotone/). Pour chaque pixel, combine clr1 et clr2 à l'aide d'une interpolation linéaire afin de déterminer la nouvelle couleur de ce pixel.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color1](./get_color1/)() | Renvoie le format de couleur cible pour les pixels sombres. Lecture seule [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color2](./get_color2/)() | Renvoie le format de couleur cible pour les pixels clairs. Lecture seule [System::Drawing::Color](../../system.drawing/color/). |
