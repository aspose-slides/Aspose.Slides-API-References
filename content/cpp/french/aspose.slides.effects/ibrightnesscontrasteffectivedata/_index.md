...
---
## IBrightnessContrastEffectiveData classe

Objet immuable qui représente un effet [BrightnessContrast](../brightnesscontrast/). Ajuste la luminosité et le contraste
...
| virtual **float** [get_Brightness](./get_brightness/)() | Renvoie la luminosité. Lecture seule **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Renvoie le contraste. Lecture seule **float**. |
