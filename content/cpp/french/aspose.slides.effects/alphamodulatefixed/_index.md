...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si le [AlphaModulateFixed](./) spécifié est égal au [AlphaModulateFixed](./) actuel. |
...
| **float** [get_Amount](./get_amount/)() override | Renvoie une quantité d'effet en pourcentage. Lecture **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les données effectives de l'effet Alpha Modulate Fixed avec l'héritage appliqué. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Servit de fonction de hachage pour un type particulier. |
...
| void [set_Amount](./set_amount/)(**float**) override | Renvoie une quantité d'effet en pourcentage. Écriture **float**. |
