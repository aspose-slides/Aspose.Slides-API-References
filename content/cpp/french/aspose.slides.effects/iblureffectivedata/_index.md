...
Objet immuable qui représente un effet [Blur](../blur/) appliqué à l'ensemble de la forme, y compris son remplissage. Tous les canaux de couleur, y compris l'alpha, sont affectés.
...
| virtual **bool** [get_Grow](./get_grow/)() | Détermine si les limites de l'objet doivent être agrandies à la suite du floutage. true indique que les limites sont agrandies tandis que false indique le contraire. Lecture seule **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Renvoie le rayon du flou. Lecture seule **double**. |
