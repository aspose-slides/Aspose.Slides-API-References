...
type: docs
weight: 911
url: /fr/aspose.slides.effects/ippresetshadow/
---
## IPresetShadow classe
...
| virtual **float** [get_Direction](./get_direction/)() | Direction de l'ombre. Lecture **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distance de l'ombre. Lecture **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Préréglage. Lecture [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Couleur de l'ombre. Lecture seule [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Direction de l'ombre. Écriture **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Distance de l'ombre. Écriture **double**. |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | Préréglage. Écriture [PresetShadowType](../../aspose.slides/presetshadowtype/). |
