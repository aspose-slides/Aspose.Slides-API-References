...
description: Représente un effet Alpha Ceiling. Les valeurs Alpha (opacité) supérieures à zéro sont modifiées à 100 %. En d’autres termes, tout ce qui est partiellement opaque devient complètement opaque.
type: docs
weight: 261
url: /fr/aspose.slides.effects/ialphaceiling/
---
## IAlphaCeiling classe

Représente un effet Alpha Ceiling. Les valeurs Alpha (opacité) supérieures à zéro sont changées à 100 %. En d’autres termes, tout ce qui est partiellement opaque devient complètement opaque.
