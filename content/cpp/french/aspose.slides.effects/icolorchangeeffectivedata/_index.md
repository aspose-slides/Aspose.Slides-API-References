...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_FromColor](./get_fromcolor/)() | Couleur qui sera remplacée. Lecture seule [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ToColor](./get_tocolor/)() | Couleur qui remplacera. Lecture seule [System::Drawing::Color](../../system.drawing/color/). |
| virtual **bool** [get_UseAlpha](./get_usealpha/)() | Renvoie une valeur booléenne qui détermine si le composant alpha doit être utilisé. Lecture seule **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉᵉ argument modèle comme un pointeur faible (plutôt que partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
