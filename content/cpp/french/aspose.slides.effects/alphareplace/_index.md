...
description: Représente un effet Alpha Replace. Les valeurs d'alpha (opacité) de l'effet sont remplacées par un alpha fixe.
type: docs
weight: 79
...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si le [AlphaReplace](./) spécifié est égal au [AlphaReplace](./) actuel. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres à virgule flottante de style C# où deux NaN sont considérés comme égaux même si, selon la norme IEC 60559:1989, le NaN n’est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres à virgule flottante de style C# où deux NaN sont considérés comme égaux même si, selon la norme IEC 60559:1989, le NaN n’est égal à aucune valeur, y compris NaN. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplaceEffectiveData](../ialphareplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les données effectives de l'effet Alpha Replace avec l'héritage appliqué. |
...
* Classe [IAlphaReplace](../ialphareplace/)
