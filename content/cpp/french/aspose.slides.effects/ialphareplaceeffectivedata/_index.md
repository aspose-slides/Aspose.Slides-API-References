...
description: Objet immuable qui représente un effet Alpha Replace. Les valeurs d'alpha (opacité) de l'effet sont remplacées par un alpha fixe.
type: docs
weight: 404
...
| virtual **float** [get_Alpha](./get_alpha/)() | Renvoie la nouvelle valeur alpha dans l'intervalle [0..1] en lecture seule **float**. |
