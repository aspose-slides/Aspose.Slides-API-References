...
description: Représente un effet de luminance. La luminosité décale linéairement toutes les couleurs vers le blanc ou le noir. Le contraste ajuste toutes les couleurs pour qu'elles soient soit plus rapprochées, soit plus éloignées les unes des autres.
type: docs
weight: 807
url: /fr/aspose.slides.effects/iluminanceeffectivedata/
---
## classe ILuminanceEffectiveData

Représente un effet [Luminance](../luminance/). La luminosité décale linéairement toutes les couleurs vers le blanc ou le noir. Le contraste ajuste toutes les couleurs pour qu'elles soient soit plus rapprochées, soit plus éloignées.
...
| virtual **float** [get_Brightness](./get_brightness/)() | Luminosité. **float** en lecture seule. |
| virtual **float** [get_Contrast](./get_contrast/)() | Contraste. **float** en lecture seule. |
