...
description: Représente un effet de flou appliqué à toute la forme, y compris son remplissage. Tous les canaux de couleur, y compris l'alpha, sont affectés.
type: docs
weight: 456
...
Représente un effet [Blur](../blur/) qui s'applique à l'intégralité de la forme, y compris son remplissage. Tous les canaux de couleur, y compris l'alpha, sont affectés.
...
| virtual **bool** [get_Grow](./get_grow/)() | Détermine si les limites de l'objet doivent être agrandies à la suite du flou. True indique que les limites sont agrandies tandis que false indique le contraire. Lecture **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Renvoie le rayon du flou. Lecture **double**. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | Détermine si les limites de l'objet doivent être agrandies à la suite du flou. True indique que les limites sont agrandies tandis que false indique le contraire. Écriture **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | Définit le rayon du flou. Écriture **double**. |
