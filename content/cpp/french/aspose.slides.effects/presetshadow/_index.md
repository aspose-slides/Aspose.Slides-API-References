...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si le [PresetShadow](./) spécifié est égal au [PresetShadow](./) actuel. |
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type référence à la façon de C#. |
...
| **float** [get_Direction](./get_direction/)() override | Direction de l'ombre. Lecture **float**. |
| **double** [get_Distance](./get_distance/)() override | Distance de l'ombre. Lecture **double**. |
...
| [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() override | Préréglage. Lecture [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | Couleur de l'ombre. Lecture seule [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadowEffectiveData](../ipresetshadoweffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les données effectives de l'effet d'ombre prédéfini avec l'héritage appliqué. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogue de la méthode [Object.MemberwiseClone()](../../system/object/memberwiseclone/) en C#. Permet le clonage de types personnalisés. |
...
| void [set_Direction](./set_direction/)(**float**) override | Direction de l'ombre. Écriture **float**. |
| void [set_Distance](./set_distance/)(**double**) override | Distance de l'ombre. Écriture **double**. |
| void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) override | Préréglage. Écriture [PresetShadowType](../../aspose.slides/presetshadowtype/). |
