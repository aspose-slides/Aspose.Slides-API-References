...
description: Implémente l'interface IEnumerator pour une collection générique vide.
type: docs
weight: 27
url: /fr/system.linq.details/emptyenumerator/
---
## EmptyEnumerator classe


Implémente l'interface IEnumerator pour une collection générique vide.
...
| --- | --- |
| T | Le type de l'élément dans une collection. |
## Méthodes
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Obtient l'élément actuel. |
...
| **bool** [MoveNext](./movenext/)() override | Avance l'énumérateur vers l'élément suivant. Si aucun élément n'était référencé auparavant, définit la référence au premier élément disponible. Si la fin du conteneur est atteinte, ne fait rien. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la copie des sous-classes. |
