...
description: "Arguments de l'événement DoWork. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des violations d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en tant qu'argument."
type: docs
weight: 92
url: /fr/system.componentmodel/doworkeventargs/
---
...
| Méthode | Description |
| --- | --- |
|  [CancelEventArgs](../canceleventargs/canceleventargs/)(**bool**) | Constructeur. |
|  [CancelEventArgs](../canceleventargs/canceleventargs/)() | Constructeur ; définit la propriété Cancel sur false. |
|  [DoWorkEventArgs](./doworkeventargs/)(const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Construit une instance d'arguments. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Compare les objets en utilisant la sémantique C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type référence dans le style C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type valeur dans le style C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule une comparaison de nombres flottants à la C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule une comparaison de nombres flottants à la C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
|  [EventArgs](../../system/eventargs/eventargs/)() | Constructeur. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | À des fins internes uniquement. |
| [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Argument](./get_argument/)() | Obtient la propriété Argument ; non implémentée. |
| **bool** [get_Cancel](../canceleventargs/get_cancel/)() | Obtient la valeur indiquant si l'événement doit être annulé. |
| [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Result](./get_result/)() | Obtient la propriété Result ; non implémentée. |
...
| void [set_Cancel](../canceleventargs/set_cancel/)(**bool**) | Définit la valeur indiquant si l'événement doit être annulé. |
| void [set_Result](./set_result/)(const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Définit la propriété Result ; non implémentée. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉ argument de modèle comme pointeur faible (au lieu de partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
...
| Champ | Description |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Un membre static qui représente un pointeur partagé \"empty\" [EventArgs](../../system/eventargs/) (pointeur nul). |
