...
description: "Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des erreurs d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 14
url: /fr/system.componentmodel/backgroundworker/
---
...
|  [Component](../component/component/)() | Informations RTTI. |
| void [Dispose](../component/dispose/)(**bool**) | Prise en charge du modèle Disposable ; ne fait rien. |
...
| **bool** [get_DesignMode](../component/get_designmode/)() | Vérifie si le composant est en mode conception. |
| **bool** [get_WorkerReportsProgress](./get_workerreportsprogress/)() const | Renvoie une valeur indiquant si le [System::ComponentModel::BackgroundWorker](./) peut signaler des mises à jour de progression. |
...
| void [ReportProgress](./reportprogress/)(int) | Déclenche l’événement **System::ComponentModel::BackgroundWorker::ProgressChanged**. |
| void [ReportProgress](./reportprogress/)(int, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Déclenche l’événement **System::ComponentModel::BackgroundWorker::ProgressChanged** avec l’objet userState. |
| void [RunWorkerAsync](./runworkerasync/)() | Démarre l’exécution d’une opération en arrière-plan. |
| void [RunWorkerAsync](./runworkerasync/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Démarre l’exécution d’une opération en arrière-plan. |
| void [set_WorkerReportsProgress](./set_workerreportsprogress/)(**bool**) | Définit une valeur indiquant si le [System::ComponentModel::BackgroundWorker](./) peut signaler des mises à jour de progression. |
