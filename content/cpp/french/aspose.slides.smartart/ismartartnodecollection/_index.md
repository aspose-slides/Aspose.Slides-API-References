...
Représente une collection de nœuds [SmartArt](../smartart/).
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [AddNode](./addnode/)() | Ajoute un nouveau nœud ou sous-nœud. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [AddNodeByPosition](./addnodebyposition/)(**int32_t**) | Ajoute un nouveau nœud à la position sélectionnée de la collection de nœuds. |
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Retourne le nombre de comportements dans une collection. Lecture seule **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Retourne une valeur indiquant si l'accès à la collection est synchronisé (thread-safe). Lecture seule **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Retourne une racine de synchronisation. Lecture seule [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [idx_get](./idx_get/)(**int32_t**) | Retourne le nœud par indice. Lecture seule [ISmartArtNode](../ismartartnode/) |
...
| virtual void [RemoveNode](./removenode/)(**int32_t**) | Supprime le nœud ou sous-nœud par indice. |
| virtual void [RemoveNode](./removenode/)([System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\>) | Supprime le nœud ou sous-nœud. |
