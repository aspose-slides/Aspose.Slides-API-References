...
| virtual **int32_t** [get_Column](./get_column/)() | Obtient l'indice basé sur zéro de la colonne dans la feuille de calcul où la cellule est située. Lecture seule **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Obtient le nom de la cellule de données du graphique. Lecture seule [System::String](../../system/string/). |
| virtual **int32_t** [get_Row](./get_row/)() | Obtient l'indice basé sur zéro de la ligne dans la feuille de calcul où la cellule est située. Lecture seule **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | Obtient la valeur contenue dans la cellule [Excel](../). Lecture seule [System::Object](../../system/object/). |
