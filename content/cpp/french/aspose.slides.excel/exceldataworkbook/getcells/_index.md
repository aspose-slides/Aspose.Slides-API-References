...
type: docs
weight: 14
url: /fr/aspose.slides.excel/exceldataworkbook/getcells/
---
## ExcelDataWorkbook::GetCells(System::String, bool) méthode
...
| --- | --- | --- |
| formula | [System::String](../../../system/string/) | Une formule ou une expression de plage (p. ex., "Sheet1!A1:B3") utilisée pour identifier les cellules cibles. |
| skipHiddenCells | **bool** | Si **true**, les cellules masquées (p. ex., dans les lignes ou colonnes masquées) seront exclues du résultat. |

### Valeur de retour

Une liste en lecture seule des cellules correspondant à la formule spécifiée.
