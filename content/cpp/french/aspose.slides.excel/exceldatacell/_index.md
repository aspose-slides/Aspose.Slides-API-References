...
```cpp
class ExcelDataCell : public Aspose::Slides::Excel::IExcelDataCell
```
...
| **int32_t** [get_Column](./get_column/)() override | Obtient l'indice zéro-bas de la colonne dans la feuille de calcul où se trouve la cellule. Lecture seule **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Obtient le nom de la cellule de données du graphique. |
| **int32_t** [get_Row](./get_row/)() override | Obtient l'indice zéro-bas de la ligne dans la feuille de calcul où se trouve la cellule. Lecture seule **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Obtient la valeur contenue dans la cellule [Excel](../). |
