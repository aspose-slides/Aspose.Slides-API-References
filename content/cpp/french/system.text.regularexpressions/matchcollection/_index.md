...
| **bool** [IsReadOnly](./isreadonly/)() const | Marque la collection comme en lecture seule. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice basé sur zéro de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) qui contient le nombre spécifié d'éléments et se termine à l'indice spécifié. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien en réalité, se contente d'initialiser le nouvel objet et permet la copie lors de la construction de sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien en réalité, se contente d'initialiser le nouvel objet et permet la copie lors de la construction de sous-classes. |
...
| void [Reverse](../../system.collections.generic/list/reverse/)() | Inverse l'ordre des éléments de toute la liste. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de modèle en pointeur faible (plutôt qu partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
...
| virtual  [~Object](../../system/object/~object/)() | Démolit l'objet. Libère toutes les structures de données internes. |
