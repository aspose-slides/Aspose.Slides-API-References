...
description: "Liste des captures effectuées par un seul groupe de capture. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des fautes d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 14
url: /fr/system.text.regularexpressions/capturecollection/
---
## CaptureCollection classe

Liste des captures effectuées par un groupe de capture unique. Les objets de cette classe ne doivent être alloués qu'à l'aide de la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des fautes d'assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument.
...
| void [Add](./add/)(const [CapturePtr](../captureptr/)\&) override | Désactive la modification de la collection. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Ajoute un élément à la fin de la liste. |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Méthode de service pour ajouter une capture à la collection. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | Obtient un itérateur pour un élément const-qualifié inexistant après la fin de la collection. |
| void [Clear](./clear/)() override | Désactive le nettoyage de la collection. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Obtient un itérateur inverse vers le dernier élément const-qualifié de la collection (premier en reverse). |
...
| [vector_t](../../system.collections.generic/list/vector_t/)\& [data](../../system.collections.generic/list/data/)() | Fonction d'accès à la structure de données sous-jacente. |
| const [vector_t](../../system.collections.generic/list/vector_t/)\& [data](../../system.collections.generic/list/data/)() const | Fonction d'accès à la structure de données sous-jacente. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | Obtient un itérateur pour un élément inexistant après la fin de la collection. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | Obtient un itérateur pour un élément inexistant après la fin de la collection qualifiée const. |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Vérifie si un élément répondant à un prédicat spécifique existe dans la liste. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | À des fins internes uniquement. |
| T [Find](../../system.collections.generic/list/find/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche un élément répondant à un prédicat spécifique. |
| [ListPtr](../../system.collections.generic/listptr/)\<T\> [FindAll](../../system.collections.generic/list/findall/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche des éléments répondant à un prédicat spécifique. |
| int [FindIndex](../../system.collections.generic/list/findindex/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche un élément répondant à un prédicat spécifique. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, [System::Predicate](../../system/predicate/)\<T\>) | Recherche un élément répondant à un prédicat spécifique. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, int, [System::Predicate](../../system/predicate/)\<T\>) | Recherche un élément répondant à un prédicat spécifique. |
| T [FindLast](../../system.collections.generic/list/findlast/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche le dernier élément répondant à un prédicat spécifique. |
...
| int [get_Count](./get_count/)() const override | Obtient le nombre de captures. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Vérifie si la collection a une taille fixe. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Marque la collection comme lecture-seule. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Marque la collection comme non synchronisée. |
...
| void [InsertRange](../../system.collections.generic/list/insertrange/)(int, [IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | Insère une plage de données à la position spécifiée. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice basé sur zéro de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) qui s'étend du premier élément à l'indice spécifié. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice basé sur zéro de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) qui contient le nombre d'éléments spécifié et se termine à l'indice indiqué. |
...
|  [List](../../system.collections.generic/list/list/)(int) | Crée une liste avec une capacité pré-définie. |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() | Obtient un itérateur inverse vers le dernier élément de la collection (premier en reverse). |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | Obtient un itérateur inverse vers le dernier élément de la collection qualifiée const (premier en reverse). |
...
| **bool** [Remove](./remove/)(const [CapturePtr](../captureptr/)\&) override | Désactive la modification de la collection. |
| **bool** [Remove](../../system.collections.generic/list/remove/)(const T\&) override | Supprime la première instance d'un élément spécifique de la liste. |
| int [RemoveAll](../../system.collections.generic/list/removeall/)([Predicate](../../system/predicate/)\<T\>) | Supprime tous les éléments correspondant au prédicat spécifié. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | Obtient un itérateur inverse pour un élément inexistant avant le début de la collection qualifiée const. |
