...
description: "Liste des groupes de capture dans une correspondance unique. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject() . Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 40
url: /fr/system.text.regularexpressions/groupcollection/
---
...
| void [Add](./add/)(const [GroupPtr](../groupptr/)\&) override | Désactive l'ajout d'éléments dans la collection. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Ajoute un élément à la fin de la liste. |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | Ajoute un groupe à la collection. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/list/begin/)() const | Obtient un itérateur vers le premier élément de la collection qualifié const. |
...
| void [Clear](./clear/)() override | Désactive la suppression d'éléments de la collection. |
...
| int [FindIndex](../../system.collections.generic/list/findindex/)([System::Predicate](../../system/predicate/)\<T\>) | Recherche des éléments répondant à un prédicat spécifique. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, [System::Predicate](../../system/predicate/)\<T\>) | Recherche des éléments répondant à un prédicat spécifique. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, int, [System::Predicate](../../system/predicate/)\<T\>) | Recherche des éléments répondant à un prédicat spécifique. |
...
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Vérifie si la collection est de taille fixe. |
...
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(int) const | [Group](../group/) accesseur. |
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(const [String](../../system/string/)\&) const | [Group](../group/) accesseur. |
...
| [IEnumeratorPtr](../../system.collections.generic/list/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/list/getenumerator/)() override | Obtient un énumérateur pour itérer à travers les éléments de la liste. |
...
|  [GroupCollection](./groupcollection/)(const [WeakPtr](../../system/weakptr/)\<[Match](../match/)\>\&) | Constructeur. |
...
| virtual [GroupPtr](../groupptr/) [idx_get](./idx_get/)([String](../../system/string/)) const | [Group](../group/) accesseur. |
| [GroupPtr](../groupptr/) [idx_get](./idx_get/)(int) const override | [Group](../group/) accesseur. |
...
| void [Insert](../../system.collections.generic/list/insert/)(int, const T\&) override | Insère un élément à la position spécifiée. |
...
| **bool** [IsReadOnly](./isreadonly/)() const | Marque la collection comme lecture-seule. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Recherche l'objet spécifié et renvoie l'indice zéro-bas de la dernière occurrence dans l'ensemble de la liste. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice zéro-bas de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) s'étendant du premier élément à l'indice spécifié. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice zéro-bas de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) contenant le nombre d'éléments spécifié et se terminant à l'indice indiqué. |
...
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(const [String](../../system/string/)\&) const | [Group](../group/) accesseur. |
...
| **bool** [Remove](./remove/)(const [GroupPtr](../groupptr/)\&) override | Désactive la suppression d'élément de la collection. |
...
| int [RemoveAll](../../system.collections.generic/list/removeall/)([Predicate](../../system/predicate/)\<T\>) | Supprime tous les éléments correspondant à un prédicat spécifique. |
