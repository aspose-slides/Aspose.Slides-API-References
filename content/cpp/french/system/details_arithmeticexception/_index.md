...
description: "ArithmeticException est levée lorsqu'une erreur se produit lors de l'exécution d'opérations arithmétiques, de conversion ou de transtypage. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ArithmeticException à la place. Ne placez jamais les instances de la classe ArithmeticException dans System::SmartPtr."
type: docs
weight: 365
url: /fr/system/details_arithmeticexception/
---
## Détails_ArithmeticException classe


ArithmeticException est levée lorsqu'une erreur se produit pendant l'exécution d'opérations arithmétiques, de conversion ou de transtypage. Ne jamais créer d'instances de cette classe manuellement. Utilisez la classe ArithmeticException à la place. Ne jamais encapsuler les instances de la classe ArithmeticException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison à virgule flottante de type C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison à virgule flottante de type C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉ argument de modèle comme un pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
