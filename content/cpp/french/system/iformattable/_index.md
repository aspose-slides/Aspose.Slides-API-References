...
description: Définit une méthode qui formate la valeur de l'objet actuel en utilisant la chaîne de format spécifiée et le fournisseur de format.
type: docs
weight: 1002
url: /fr/system/iformattable/
---
## IFormattable classe

Définit une méthode qui formate la valeur de l'objet actuel en utilisant la chaîne de format spécifiée et le fournisseur de format.
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
