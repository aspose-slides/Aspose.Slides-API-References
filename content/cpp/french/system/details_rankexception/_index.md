...
description: "RankException est levée lorsqu'un argument de tableau dont le nombre de dimensions diffère de celui attendu est transmis à une méthode. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe RankException à la place. Ne encapsulez jamais les instances de la classe RankException dans System::SmartPtr."
type: docs
weight: 677
url: /fr/system/details_rankexception/
---
## Details_RankException classe

RankException est levée lorsqu'un argument de tableau dont le nombre de dimensions diffère de celui attendu est transmis à une méthode. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe RankException à la place. Ne encapsulez jamais les instances de la classe RankException dans [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il se contente d'initialiser le nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il se contente d'initialiser le nouvel objet et permet la construction par copie des sous-classes. |
