...
description: "PlatformNotSupportedException est levée lorsqu'une fonctionnalité ne fonctionne pas sur une plateforme particulière. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe PlatformNotSupportedException à la place. Ne placez jamais les instances de la classe PlatformNotSupportedException dans System::SmartPtr."
type: docs
weight: 664
url: /fr/system/details_platformnotsupportedexception/
---
## Details_PlatformNotSupportedException classe


PlatformNotSupportedException est déclenchée lorsqu'une fonctionnalité ne s'exécute pas sur une plateforme particulière. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe PlatformNotSupportedException. Ne placez jamais les instances de la classe PlatformNotSupportedException dans [System::SmartPtr](../smartptr/).
...
| static std::enable_if\<[IsSmartPtr](../issmartptr/)\<T1\>::value\&&[IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type référence en style C#. |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type valeur en style C#. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet de copier les sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet de copier les sous-classes. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉ paramètre de modèle comme un pointeur faible (plutôt que partagé). Permet de passer les pointeurs des conteneurs en mode faible. |
