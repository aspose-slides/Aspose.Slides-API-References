...
description: Représente une collecte de déchets émulée qui agit davantage comme un stub qui ne fait effectivement rien. Il s'agit d'un type statique sans services d'instance. Vous ne devez jamais créer d'instances de ce type, quels que soient les moyens.
type: docs
weight: 872
url: /fr/system/gc/
---
...
Représente une collecte de déchets émulée qui se comporte davantage comme un stub qui ne fait effectivement rien. Il s'agit d'un type statique sans services d'instance. Vous ne devez jamais créer d'instances de ce type, quels que soient les moyens.
...
| static **int64_t** [GetTotalAllocatedBytes](./gettotalallocatedbytes/)(**bool**) | Renvoie le nombre total d'octets alloués. |
| static **int64_t** [GetTotalMemory](./gettotalmemory/)(**bool**) | Renvoie le nombre d'octets de mémoire privée actuellement alloués par le processus en cours. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, vraiment, il se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, vraiment, il se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
