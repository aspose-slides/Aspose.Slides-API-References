...
description: "TimeoutException indique si le temps alloué à un processus ou à une opération est expiré. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe TimeoutException. Ne placez jamais les instances de la classe TimeoutException dans System::SmartPtr."
type: docs
weight: 716
url: /fr/system/details_timeoutexception/
---
## Details_TimeoutException classe

TimeoutException indique si le temps alloué à un processus ou une opération est expiré. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe TimeoutException à la place. Ne encapsulez jamais les instances de la classe TimeoutException dans [System::SmartPtr](../smartptr/).
...
| Method | Description |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | Compare des objets en utilisant la sémantique C# [Object.Equals](../object/equals/). |
...
| void [Lock](../object/lock/)() | Met en œuvre le verrouillage de l'instruction C# lock(). Appelez directement ou utilisez l'objet sentry [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie en fait rien, il se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie en fait rien, il se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
...
| void [Unlock](../object/unlock/)() | Met en œuvre le déverrouillage de l'instruction C# lock(). Appelez directement ou utilisez l'objet sentry [LockContext](../lockcontext/). |
