...
description: "ArgumentException est levée lorsqu'un argument passé à une méthode invoquée est invalide. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ArgumentException à la place. Ne placez jamais les instances de la classe ArgumentException dans System::SmartPtr."
type: docs
weight: 326
url: /fr/system/details_argumentexception/
---
## Details_ArgumentException classe


ArgumentException est levée lorsque un argument passé à une méthode invoquée est invalide. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ArgumentException à la place. Ne placez jamais les instances de la classe ArgumentException dans [System::SmartPtr](../smartptr/).
...
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Renvoie un dictionnaire avec les données d'exception personnalisées. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie en réalité rien, il initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operateur d'affectation. Ne copie en réalité rien, il initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de modèle comme un pointeur faible (au lieu de partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
...
ArgumentNullException est levée lorsqu'une méthode invoquée reçoit un argument nul alors que la méthode attend une valeur non nulle. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ArgumentNullException à la place. Ne placez jamais les instances de la classe ArgumentNullException dans [System::SmartPtr](../smartptr/). 
