...
description: "FormatException est levée lorsque le format de l'argument de la méthode n'est pas valide. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe FormatException à la place. Ne placez jamais les instances de la classe FormatException dans System::SmartPtr."
type: docs
weight: 469
url: /fr/system/details_formatexception/
---
## Details_FormatException classe

FormatException est levée lorsque le format de l'argument de la méthode n'est pas valide. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe FormatException à la place. N'enveloppez jamais les instances de la classe FormatException dans [System::SmartPtr](../smartptr/).
...
| [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, vraiment, se contente d'initialiser un nouvel objet et permet la construction de copies des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, vraiment, se contente d'initialiser un nouvel objet et permet la construction de copies des sous-classes. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Renvoie la représentation en chaîne de caractères de l'objet actuel. |
