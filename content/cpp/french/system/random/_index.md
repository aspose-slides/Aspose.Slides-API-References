...
description: "Représente un générateur de nombres pseudo-aléatoires. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction System::MakeObject(). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des échecs d’assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument."
type: docs
weight: 1171
url: /fr/system/random/
---
## Classe Random

Représente un générateur de nombres pseudo-aléatoires. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../makeobject/). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des échecs d’assertion. Encapsulez toujours cette classe dans un pointeur [System::SmartPtr](../smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument.
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Obtient la structure de données du compteur de référence associée à l’objet. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analogue de la méthode C# [Object.MemberwiseClone()](../object/memberwiseclone/). Permet de cloner des types personnalisés. |
| virtual **int32_t** [Next](./next/)() | Renvoie un nombre aléatoire non négatif inférieur à la valeur maximale int32. |
| virtual **int32_t** [Next](./next/)(**int32_t**) | Renvoie un nombre aléatoire non négatif inférieur au maximum spécifié. |
| virtual **int32_t** [Next](./next/)(**int32_t**, **int32_t**) | Renvoie un nombre aléatoire compris dans l’intervalle spécifié. |
| virtual void [NextBytes](./nextbytes/)(const [ArrayPtr](../arrayptr/)\<**uint8_t**\>\&) | Remplit les éléments du tableau de bytes spécifié avec des nombres aléatoires. |
| virtual **double** [NextDouble](./nextdouble/)() | Renvoie un nombre aléatoire compris entre 0.0 et 1.0. |
|  [Object](../object/object/)() | Crée l’objet. Initialise toutes les structures de données internes. |
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il se contente d’initialiser un nouvel objet et permet de construire par copie les sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d’affectation. Ne copie rien, en réalité, il se contente d’initialiser un nouvel objet et permet de construire par copie les sous-classes. |
...
int main()
{
  ...
  // Obtient un numéro de mois aléatoire et l'affiche.
