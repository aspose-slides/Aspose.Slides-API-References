...
description: "MemberAccessException est levée lorsqu'un accès à une méthode inexistante est tenté ou lorsqu'un accès à la méthode n'est pas autorisé. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe MethodAccessException à la place. Ne placez jamais les instances de la classe MethodAccessException dans System::SmartPtr."
type: docs
weight: 560
url: /fr/system/details_methodaccessexception/
---
## Details_MethodAccessException classe


MemberAccessException est levée lorsque l'accès à une méthode inexistante est tenté ou lorsque l'accès à la méthode n'est pas autorisé. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe MethodAccessException à la place. Ne placez jamais les instances de la classe MethodAccessException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres flottants à la C# où deux NaN sont considérés comme égaux bien que selon IEC 60559:1989 le NaN ne soit égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres flottants à la C# où deux NaN sont considérés comme égaux bien que selon IEC 60559:1989 le NaN ne soit égal à aucune valeur, y compris NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Renvoie une valeur entière sur 32 bits qui est le code HRESULT associé à l'exception représentée par l'objet courant. |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Renvoie une référence vers l'objet représentant l'exception interne. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | Spécialisation de [Object::ReferenceEquals](../object/referenceequals/) pour le cas chaîne et nullptr. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉᵉ argument de modèle comme pointeur faible (plutôt que partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
...
* Classe [Details_MemberAccessException](../details_memberaccessexception/)
