...
description: "L'exception qui est levée lorsque l'image du fichier d'une bibliothèque de liens dynamiques (DLL) ou d'un programme exécutable est invalide. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe BadImageFormatException à la place. Ne placez jamais les instances de la classe BadImageFormatException dans System::SmartPtr."
type: docs
weight: 378
url: /fr/system/details_badimageformatexception/
---
## Details_BadImageFormatException classe


L'exception qui est levée lorsque l'image du fichier d'une bibliothèque de liens dynamiques (DLL) ou d'un programme exécutable est invalide. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe BadImageFormatException à la place. N'enveloppez jamais les instances de la classe BadImageFormatException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres à virgule flottante de style C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres à virgule flottante de style C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | À des fins internes uniquement. |
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Retourne un dictionnaire avec les données d'exception personnalisées. |
| virtual [String](../string/) [get_FileName](../details_exceptionwithfilename/get_filename/)() const | Obtient le nom du fichier qui provoque cette exception. |
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Retourne une valeur entière 32 bits qui est un code HRESULT associé à l'exception représentée par l'objet actuel. |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Retourne une référence vers l'objet représentant l'exception interne. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](../details_systemexception/gettype/)() const override | Obtient le type réel de l'objet. Analogue de l'appel C# [System.Object.GetType()](../object/gettype/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
...
* Classe [Details_ExceptionWithFilename](../details_exceptionwithfilename/)
