...
description: "UriFormatException est levée lorsque le format de l'URI n'est pas valide. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe UriFormatException à la place. Ne placez jamais les instances de la classe UriFormatException dans System::SmartPtr."
type: docs
weight: 768
url: /fr/system/details_uriformatexception/
---
## Details_UriFormatException classe

UriFormatException est levée lorsque le format de l'URI n'est pas valide. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe UriFormatException à la place. Ne placez jamais les instances de la classe UriFormatException dans [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il initialise simplement le nouvel objet et permet la copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il initialise simplement le nouvel objet et permet la copie des sous-classes. |
