...
description: Indique qu'une énumération peut être traitée comme un champ de bits ; c'est-à-dire, un ensemble de.
type: docs
weight: 846
url: /fr/system/flagsattribute/
---
## FlagsAttribute classe

Indique qu'une énumération peut être traitée comme un champ de bits; c'est-à-dire, un ensemble de.
...
| static [Object::ptr](../object/ptr/) [GetCustomAttribute](../attribute/getcustomattribute/)(const [TypeInfo](../typeinfo/)\&, const [TypeInfo](../typeinfo/)\&) | Renvoie un attribut personnalisé d'un type spécifié appliqué au type spécifié. |
| static [ArrayPtr](../arrayptr/)\<[Object::ptr](../object/ptr/)\> [GetCustomAttributes](../attribute/getcustomattributes/)(const [TypeInfo](../typeinfo/)\&) | Renvoie tous les attributs personnalisés appliqués au type spécifié. |
