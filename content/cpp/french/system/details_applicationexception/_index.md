...
description: "Classe de base pour les classes qui représentent des exceptions d'application (plutôt que système). Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ApplicationException à la place. Ne jamais encapsuler les instances de la classe ApplicationException dans System::SmartPtr."
type: docs
weight: 313
url: /fr/system/details_applicationexception/
---
## Details_ApplicationException classe

Une classe de base pour les classes qui représentent des exceptions d'application (plutôt que du système). Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ApplicationException à la place. Ne jamais encapsuler les instances de la classe ApplicationException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison en virgule flottante à la C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison en virgule flottante à la C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la construction de copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la construction de copie des sous-classes. |
