...
description: "StackOverflowException est levée lorsque la pile d'exécution du thread déborde. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe StackOverflowException à la place. Ne placez jamais les instances de la classe StackOverflowException dans System::SmartPtr."
type: docs
weight: 690
url: /fr/system/details_stackoverflowexception/
---
## Details_StackOverflowException classe


StackOverflowException est levée lorsque la pile d'exécution du thread déborde. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe StackOverflowException à la place. Ne placez jamais les instances de la classe StackOverflowException dans [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la construction par copie de sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la construction par copie de sous-classes. |
