...
description: "L’exception qui est levée lorsqu’une méthode est invoquée sur un objet dont l’état est incohérent avec cet appel. Ne créez jamais d’instances de cette classe manuellement. Utilisez la classe InvalidOperationException à la place. Ne placez jamais les instances de la classe InvalidOperationException dans System::SmartPtr."
type: docs
weight: 508
url: /fr/system/details_invalidoperationexception/
---
## Details_InvalidOperationException classe


L’exception qui est levée lorsqu’une méthode est invoquée sur un objet dont l’état est incohérent avec cet appel. Ne créez jamais d’instances de cette classe manuellement. Utilisez la classe InvalidOperationException à la place. Ne placez jamais les instances de la classe InvalidOperationException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison en virgule flottante au style C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n’est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison en virgule flottante au style C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n’est égal à aucune valeur, y compris NaN. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie réellement rien, il initialise simplement le nouvel objet et permet de copier la construction des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie réellement rien, il initialise simplement le nouvel objet et permet de copier la construction des sous-classes. |
