...
description: "TimeZoneNotFoundException est levée lorsque les informations de fuseau horaire ne sont pas trouvées. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe TimeZoneNotFoundException à la place. Ne placez jamais les instances de la classe TimeZoneNotFoundException dans System::SmartPtr."
type: docs
weight: 729
url: /fr/system/details_timezonenotfoundexception/
---
## Details_TimeZoneNotFoundException classe


TimeZoneNotFoundException est levée lorsque les informations de fuseau horaire ne sont pas trouvées. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe TimeZoneNotFoundException à la place. Ne placez jamais les instances de la classe TimeZoneNotFoundException dans [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
