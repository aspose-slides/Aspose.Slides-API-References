...
type: docs
weight: 2107
url: /fr/system/operator_greater_equal/
---
...
| --- | --- | --- |
| some | const T1\& | Une référence constante à la valeur à utiliser comme premier comparand |
| other | const [Nullable](../nullable/)\<T2\>\& | Une référence constante à l'objet [Nullable](../nullable/) dont la valeur représentée doit être utilisée comme second comparand |

### Valeur de retour

Vrai si le premier comparand est supérieur ou égal au second comparand, sinon - false
