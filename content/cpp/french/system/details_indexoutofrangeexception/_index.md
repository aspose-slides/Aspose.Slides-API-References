...
description: "IndexOutOfRangeException est levée lorsqu'un accès à un élément d'une collection est tenté en utilisant un indice qui se trouve en dehors de ses limites. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe IndexOutOfRangeException. Ne placez jamais les instances de la classe IndexOutOfRangeException dans System::SmartPtr."
type: docs
weight: 482
url: /fr/system/details_indexoutofrangeexception/
---
## Details_IndexOutOfRangeException classe


IndexOutOfRangeException est levée lorsqu'un accès à un élément d'une collection est tenté en utilisant un indice qui se situe en dehors de ses limites. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe IndexOutOfRangeException. Ne enveloppez jamais les instances de la classe IndexOutOfRangeException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres à virgule flottante de type C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres à virgule flottante de type C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Renvoie une valeur entière 32 bits qui est un code HRESULT associé à l'exception représentée par l'objet courant. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la construction copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la construction copie des sous-classes. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Définit le HRESULT, une valeur numérique codée assignée à une exception spécifique. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Renvoie la représentation sous forme de chaîne de caractères de l'objet courant. |
