...
description: "NotImplementedException est levée lorsqu'une méthode n'est pas implémentée et sert de stub. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe NotImplementedException à la place. Ne placez jamais les instances de la classe NotImplementedException dans System::SmartPtr."
type: docs
weight: 573
url: /fr/system/details_notimplementedexception/
---
## Details_NotImplementedException classe


NotImplementedException est déclenchée lorsqu'une méthode n'est pas implémentée et sert de stub. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe NotImplementedException à la place. Ne placez jamais les instances de la classe NotImplementedException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison à virgule flottante de style C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison à virgule flottante de style C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../object/gethashcode/). Permet le hashage d'objets personnalisés. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la copie des sous-classes. |
