...
description: "MemberAccessException est levée lorsqu'un accès au membre d'une classe inexistante est tenté ou lorsque l'accès au membre n'est pas autorisé. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe MemberAccessException à la place. N'encapsulez jamais les instances de la classe MemberAccessException dans System::SmartPtr."
type: docs
weight: 547
url: /fr/system/details_memberaccessexception/
---
## Details_MemberAccessException classe


MemberAccessException est levée lorsque l'accès à un membre de classe inexistant est tenté ou lorsque l'accès au membre n'est pas autorisé. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe MemberAccessException à la place. N'encapsulez jamais les instances de la classe MemberAccessException dans [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il se contente d'initialiser un nouvel objet et permet la copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il se contente d'initialiser un nouvel objet et permet la copie des sous-classes. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉ argument de modèle comme pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
