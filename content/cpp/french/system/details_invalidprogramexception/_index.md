...
description: "InvalidProgramException est présent uniquement pour des raisons de compatibilité. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe InvalidProgramException à la place. Ne placez jamais les instances de la classe InvalidProgramException dans System::SmartPtr."
type: docs
weight: 521
url: /fr/system/details_invalidprogramexception/
---
## Details_InvalidProgramException classe


InvalidProgramException est présent uniquement pour des raisons de compatibilité. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe InvalidProgramException. Ne placez jamais les instances de la classe InvalidProgramException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres à virgule flottante à la C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n’est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres à virgule flottante à la C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n’est égal à aucune valeur, y compris NaN. |
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | À des fins internes seulement. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Renvoie la représentation chaîne de caractères de l’objet actuel. |
