...
description: "OverflowException est levée lorsqu'une opération entraîne un dépassement de capacité. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe OverflowException à la place. Ne encapsulez jamais les instances de la classe OverflowException dans System::SmartPtr."
type: docs
weight: 651
url: /fr/system/details_overflowexception/
---
## Details_OverflowException classe

OverflowException est levée lorsque une opération entraîne un dépassement de capacité. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe OverflowException à la place. Ne encapsulez jamais les instances de la classe OverflowException dans [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie réellement rien, il initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie réellement rien, il initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
