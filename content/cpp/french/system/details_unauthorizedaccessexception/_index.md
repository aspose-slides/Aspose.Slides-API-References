...
description: "UnauthorizedAccessException est levée lorsque l'accès est refusé par le système d'exploitation en raison d'une erreur d'E/S ou d'une erreur de sécurité. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe UnauthorizedAccessException à la place. Ne placez jamais les instances de la classe UnauthorizedAccessException dans System::SmartPtr."
type: docs
weight: 755
url: /fr/system/details_unauthorizedaccessexception/
---
## Details_UnauthorizedAccessException classe


UnauthorizedAccessException est levée lorsque l'accès est refusé par le système d'exploitation en raison d'une erreur d'E/S ou d'une erreur de sécurité. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe UnauthorizedAccessException à la place. Ne placez jamais les instances de la classe UnauthorizedAccessException dans [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison en virgule flottante de type C# où deux NaN sont considérés comme égaux bien que, selon IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison en virgule flottante de type C# où deux NaN sont considérés comme égaux bien que, selon IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Renvoie une copie de l'objet Exception représentant l'exception la plus profonde. |
...
|   [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie en réalité rien, il initialise simplement le nouvel objet et permet de copier les sous-classes. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie en réalité rien, il initialise simplement le nouvel objet et permet de copier les sous-classes. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de modèle comme pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
