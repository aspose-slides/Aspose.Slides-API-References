...
description: "DivideByZeroException est levée lorsqu'une division par 0 est tentée dans une opération arithmétique. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe DivideByZeroException à la place. Ne jamais encapsuler les instances de la classe DivideByZeroException dans System::SmartPtr."
type: docs
weight: 404
url: /fr/system/details_dividebyzeroexception/
---
## Details_DivideByZeroException classe

DivideByZeroException est levée lorsqu’une division par 0 est tentée dans une opération arithmétique. Ne créez jamais d’instances de cette classe manuellement. Utilisez la classe DivideByZeroException à la place. Ne jamais encapsuler les instances de la classe DivideByZeroException dans [System::SmartPtr](../smartptr/).
...
| Méthode | Description |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | Compare les objets en utilisant la sémantique [Object.Equals](../object/equals/) de C#. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Renvoie une copie de l’objet Exception représentant l’exception la plus interne. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analogue de la méthode [Object.GetHashCode()](../object/gethashcode/) de C#. Permet le hachage d’objets personnalisés. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Obtient le type réel de l’objet. Analogue de l’appel [System.Object.GetType()](../object/gettype/) de C#. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analogue de la méthode [Object.MemberwiseClone()](../object/memberwiseclone/) de C#. Permet le clonage de types personnalisés. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Définit le HRESULT, une valeur numérique codée qui est attribuée à une exception spécifique. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Définit le n-ème argument de modèle comme un pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
| int [SharedCount](../object/sharedcount/)() const | Obtient la valeur actuelle du compteur de références partagées. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Incrémente le compteur de références partagées. Ne doit pas être appelée directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Décrémente et renvoie le compteur de références partagées. Ne doit pas être appelée directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Incrémente le compteur de références faibles. Ne doit pas être appelée directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Décrémente le compteur de références faibles. Ne doit pas être appelée directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| virtual const char * [what](../details_exception/what/)() const | Implémente la méthode [what()](../details_exception/what/) qui est appelée par la classe [ExceptionWrapper](../exceptionwrapper/). Malgré le fait que cette classe n’hérite pas de std::exception, les classes dérivées peuvent utiliser les membres protégés/privés pour implémenter leur logique. Déplacer l’implémentation de cette méthode vers [ExceptionWrapper](../exceptionwrapper/) pourrait casser cette logique. |
| virtual  [~Object](../object/~object/)() | détruit l’objet. Libère toutes les structures de données internes. |

## Remarques

OutOfMemoryException est levée lorsqu’il n’y a plus de mémoire disponible pour l’application. Ne créez jamais d’instances de cette classe manuellement. Utilisez la classe OutOfMemoryException à la place. Ne jamais encapsuler les instances de la classe OutOfMemoryException dans [System::SmartPtr](../smartptr/).
