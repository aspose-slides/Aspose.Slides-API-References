...
description: "ArgumentOutOfRangeException est levée lorsqu'une méthode invoquée reçoit un argument qui sort de l'intervalle de valeurs attendu pour cet argument. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ArgumentOutOfRangeException à la place. Ne placez jamais les instances de la classe ArgumentOutOfRangeException dans System::SmartPtr."
type: docs
weight: 352
url: /fr/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException classe

ArgumentOutOfRangeException est levée lorsque la méthode invoquée reçoit un argument qui sort de l'intervalle de valeurs attendu pour cet argument. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ArgumentOutOfRangeException à la place. Ne placez jamais les instances de la classe ArgumentOutOfRangeException dans [System::SmartPtr](../smartptr/).
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type valeur selon le style C#. |
