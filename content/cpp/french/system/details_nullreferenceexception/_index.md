...
description: "NullReferenceException est levée lorsqu'on tente de déréférencer une référence nulle. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe NullReferenceException. Ne placez jamais les instances de la classe NullReferenceException dans System::SmartPtr."
type: docs
weight: 599
url: /fr/system/details_nullreferenceexception/
---
## Details_NullReferenceException classe

NullReferenceException est levée lorsque l'on tente de déréférencer une référence nulle. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe NullReferenceException. N'encapsulez jamais les instances de la classe NullReferenceException dans [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructeur de copie. Ne copie rien, vraiment, il initialise simplement le nouvel objet et permet aux sous-classes d'être copiées. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Opérateur d'affectation. Ne copie rien, vraiment, il initialise simplement le nouvel objet et permet aux sous-classes d'être copiées. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉᵉ argument de modèle comme pointeur faible (plutôt que partagé). Permet de passer les pointeurs des conteneurs en mode faible. |
