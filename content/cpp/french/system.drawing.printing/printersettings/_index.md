...
description: "Représente les paramètres d'une imprimante. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 79
url: /fr/system.drawing.printing/printersettings/
---
## PrinterSettings classe

Représente les paramètres d'une imprimante. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument.
...
| int [get_FromPage](./get_frompage/)() | NON IMPLEMENTÉ. |
| [PrintRange](../printrange/) [get_PrintRange](./get_printrange/)() | NON IMPLEMENTÉ. |
| int [get_ToPage](./get_topage/)() | NON IMPLEMENTÉ. |
...
| void [set_PrinterName](./set_printername/)(const [String](../../system/string/)\&) | NON IMPLEMENTÉ. |
