...
description: Représente un objet qui gère le travail de bas niveau consistant à mettre en file d'attente des tâches sur des threads.
type: docs
weight: 79
url: /fr/system.threading.tasks/taskscheduler/
---
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Crée un [TaskScheduler](./) associé au thread actuel. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Obtient le [TaskScheduler](./) associé à la tâche en cours d'exécution. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Obtient l'instance [TaskScheduler](./) par défaut fournie par le framework. |
| **int32_t** [get_Id](./get_id/)() const | Obtient l'ID unique pour ce [TaskScheduler](./). |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Indique le niveau maximal de concurrence que ce [TaskScheduler](./) peut supporter. |
