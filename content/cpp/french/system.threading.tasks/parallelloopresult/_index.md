...
description: "Fournit l'état d'achèvement d'une boucle parallèle."
type: docs
weight: 14
url: /fr/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult classe

Fournit l'état d'achèvement d'une boucle [Parallel](../parallel/).
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Obtient si la boucle s'est exécutée jusqu'à son terme. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Obtient l'index d'itération le plus bas où une interruption s'est produite. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Construit un [ParallelLoopResult](./). |
...
Représente le résultat d'une opération de boucle parallèle, incluant si elle s'est terminée et les informations sur les interruptions.
