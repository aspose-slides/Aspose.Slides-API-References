...
description: Classe de service améliorant l'expérience XmlReader.
type: docs
weight: 40
url: /fr/system.xml.serialization/xmlserializationreader/
---
## XmlSerializationReader classe


Classe de service améliorant [XmlReader](../../system.xml/xmlreader/) expérience.
...
| void [Initialize](./initialize/)([System::SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>, [System::SharedPtr](../../system/sharedptr/)\<[XmlSerializer](../xmlserializer/)\>) | Initialise la classe [XmlSerializationReader](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n'th argument du modèle comme un pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
