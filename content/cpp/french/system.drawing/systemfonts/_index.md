...
description: Fournit un ensemble d'objets Font pré-créés qui représentent les polices utilisées pour afficher du texte dans les éléments d'affichage Windows. Il s'agit d'un type statique sans services d'instance. Vous ne devez jamais créer d'instances de celui-ci par quelque moyen que ce soit.
type: docs
weight: 339
url: /fr/system.drawing/systemfonts/
---
## SystemFonts classe


Fournit un ensemble d'objets [Font](../font/) pré-créés qui représentent les polices utilisées pour afficher du texte dans les éléments d'affichage [Windows](../../system.windows/). Il s'agit d'un type statique sans services d'instance. Vous ne devez jamais créer d'instances de celui-ci par quelque moyen que ce soit.
...
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_CaptionFont](./get_captionfont/)() | NON IMPLEMENTÉ. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | Renvoie un objet [Font](../font/) qui représente la police par défaut que l'application peut utiliser pour les boîtes de dialogue et les formulaires. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_IconTitleFont](./get_icontitlefont/)() | NON IMPLEMENTÉ. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MenuFont](./get_menufont/)() | NON IMPLEMENTÉ. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MessageBoxFont](./get_messageboxfont/)() | NON IMPLEMENTÉ. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_SmallCaptionFont](./get_smallcaptionfont/)() | NON IMPLEMENTÉ. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_StatusFont](./get_statusfont/)() | NON IMPLEMENTÉ. |
