...
description: Interface de rappel utilisée par la routine d'importation HTML pour obtenir les objets référencés tels que les images.
type: docs
weight: 53
url: /fr/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver classe

Interface de rappel utilisée par la routine d'importation HTML pour obtenir les objets référencés tels que les images.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | Mappe un URI vers un objet contenant la ressource réelle. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Résout l'URI absolu à partir des URI de base et relatifs. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n'th argument du modèle comme un pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
...
Obsolète
:   Obsolète. Utilisez [IExternalResourceResolver](../iexternalresourceresolver/) à la place. Sera supprimé dans la version 17.12 release.
