...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Obtient la couleur du pinceau pour une ligne. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Obtient le type d'effet d'encre (p. ex., Galaxy, Gold, Silver) qui définit le style visuel du trait d'encre. La valeur est analysée à partir de la propriété du pinceau "inkEffects". Si aucun effet reconnu n'est spécifié, [InkEffectType::NotDefined](../inkeffecttype/) est renvoyé. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Obtient la taille du pinceau pour une ligne en points. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Définit la couleur du pinceau pour une ligne. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Définit la taille du pinceau pour une ligne en points. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉ argument de modèle comme un pointeur faible (au lieu de partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
