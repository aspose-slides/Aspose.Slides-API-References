...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Obtient la couleur du pinceau pour une ligne. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Obtient le type d'effet d'encre (p. ex., Galaxy, Gold, Silver) qui définit le style visuel du trait d'encre. La valeur est analysée à partir de la propriété du pinceau "inkEffects". Si aucun effet reconnu n'est spécifié, [InkEffectType::NotDefined](../inkeffecttype/) est renvoyé. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Obtient la taille du pinceau pour une ligne en points. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Définit la couleur du pinceau pour une ligne. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Définit la taille du pinceau pour une ligne en points. |
