...
description: Une source de jeton d'annulation pouvant être utilisée pour déclencher des notifications d'annulation.
type: docs
weight: 40
url: /fr/system.threading/cancellationtokensource/
---
## CancellationTokenSource classe


Une source de jeton d'annulation pouvant être utilisée pour déclencher des notifications d'annulation.
...
| Méthode | Description |
| --- | --- |
| void [Cancel](./cancel/)() | Communique une demande d'annulation. |
|  [CancellationTokenSource](./cancellationtokensource/)() | Construit un nouveau [CancellationTokenSource](./). |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Crée une source de jeton liée qui annule lorsque l'un des jetons fournis est annulé. |
| void [Dispose](./dispose/)() override | Libère toutes les ressources utilisées par le [CancellationTokenSource](./). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare des objets de type valeur au style C#. |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | Obtient si l'annulation a été demandée. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Obtient le jeton d'annulation associé à cette source. |
...
| void [Lock](../../system/object/lock/)() | Implemente le verrouillage de l'instruction C# lock(). Appelez directement ou utilisez l'objet sentry [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implemente le déverrouillage de l'instruction C# lock(). Appelez directement ou utilisez l'objet sentry [LockContext](../../system/lockcontext/). |
...
Fournit des mécanismes pour créer et contrôler des jetons d'annulation pour l'annulation coopérative d'opérations. 
