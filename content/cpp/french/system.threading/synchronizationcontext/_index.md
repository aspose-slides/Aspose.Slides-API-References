...
description: Fournit la fonctionnalité de base pour propager un contexte de synchronisation à travers diverses opérations de synchronisation.
type: docs
weight: 196
url: /fr/system.threading/synchronizationcontext/
---
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Obtient le contexte de synchronisation pour le thread actuel. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Exécute le rappel de façon asynchrone. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Exécute le rappel de façon synchrone. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Définit le contexte de synchronisation pour le thread actuel. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | Construit une nouvelle instance de [SynchronizationContext](./). |
...
Cette classe permet la propagation du contexte de synchronisation entre les threads et est utilisée pour transmettre les callbacks ou les invocations au thread ou au contexte de synchronisation approprié. Implémentation factice.
