...
| virtual **bool** [get_DrilldownLocked](./get_drilldownlocked/)() | Détermine si la sélection des sous-formes de cet objet est interdite. Lecture **bool**. |
...
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | Renvoie true si tous les indicateurs de verrouillage sont désactivés. Lecture uniquement **bool**. |
...
| virtual void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) | Détermine si la sélection des sous-formes de cet objet est interdite. Écriture **bool**. |
