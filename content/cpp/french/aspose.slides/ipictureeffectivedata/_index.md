...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | Renvoie l'image incorporée. Lecture seule [IPPImage](../ippimage/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/)\> [get_ImageTransform](./get_imagetransform/)() | Renvoie la collection des effets de transformation d'image. Lecture seule [Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IEffectEffectiveData](../../aspose.slides.effects/ieffecteffectivedata/)\> [get_ImageTransformEffect](./get_imagetransformeffect/)(**int32_t**) | Renvoie l'effet de transformation d'image spécifié à l'index. |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Renvoie l'URL de l'image liée. Lecture seule [System::String](../../system/string/). |
