...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() override | Renvoie l'objet [ColumnFormat](../columnformat/) qui contient les propriétés de formatage pour cette colonne. Lecture seule [IColumnFormat](../icolumnformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../cellcollection/get_presentation/)() override | Renvoie la présentation parent d'un [CellCollection](../cellcollection/). Lecture seule [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../cellcollection/get_slide/)() override | Renvoie la diapositive parent d'un [CellCollection](../cellcollection/). Lecture seule [IBaseSlide](../ibaseslide/). |
...
| **double** [get_Width](./get_width/)() override | Renvoie la largeur d'une colonne. Lecture **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../cellcollection/idx_get/)(**int32_t**) override | Renvoie une cellule selon sa position. Lecture seule [Cell](../cell/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en fait, initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
...
| void [set_Width](./set_width/)(**double**) override | Définit la largeur d'une colonne. Écriture **double**. |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Définit les propriétés de format de portion définies pour toutes les portions des cellules de colonne. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Définit les propriétés de format de paragraphe définies pour tous les paragraphes des cellules de colonne. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Définit les propriétés de format de cadre de texte définies pour tous les cadres de texte des cellules de colonne. |
