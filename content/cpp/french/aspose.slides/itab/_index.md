...
| Méthode | Description |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Compare l'objet actuel avec l'objet spécifié. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Retourne le style d'alignement d'une tabulation. Lire [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Retourne la position d'une tabulation. L'affectation de cette propriété peut modifier l'index de la tabulation dans la collection et invalider l'énumérateur. Lire **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Définit le style d'alignement d'une tabulation. Écrire [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Définit la position d'une tabulation. L'affectation de cette propriété peut modifier l'index de la tabulation dans la collection et invalider l'énumérateur. Écrire **double**. |
