...
description: Renvoie l'alignement du texte dans un paragraphe sans héritage. Lire TextAlignment.
type: docs
weight: 1
url: /fr/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() méthode


Renvoie l'alignement du texte dans un paragraphe sans héritage. Lire [TextAlignment](../../textalignment/).
