...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Renvoie les données binaires des sous-titres fermés. Lecture seule **uint8_t**[]. |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | Renvoie l'identifiant unique global (GUID) des sous-titres fermés. Lecture seule [System::Guid](../../system/guid/). |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | Renvoie les données des sous-titres fermés sous forme de chaîne encodée en UTF-8. Lecture seule [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | Renvoie l'étiquette des sous-titres fermés. Lecture [System::String](../../system/string/). |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | Définit l'étiquette des sous-titres fermés. Écriture [System::String](../../system/string/). |
