...
description: Représente un objet immutable qui contient les données effectives.
type: docs
weight: 2055
url: /fr/aspose.slides/ieffectivedata/
---
## IEffectiveData classe

Représente un objet immutable qui contient les données effectives.
