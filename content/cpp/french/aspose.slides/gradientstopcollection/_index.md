...
| Méthode | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) override | Crée le nouvel arrêt de dégradé et l’ajoute à la fin de la collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) override | Crée le nouvel arrêt de dégradé et l’ajoute à la fin de la collection. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) override | Crée le nouvel arrêt de dégradé et l’ajoute à la fin de la collection. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtient un itérateur pointant vers le premier élément (le cas échéant) de l'instance de la collection const-qualifiée. |
...
| void [Clear](./clear/)() override | Supprime tous les arrêts de dégradé d’une collection. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>, **int32_t**) override | Copie tous les éléments de la collection dans le tableau spécifié. |
...
| **int32_t** [get_Count](./get_count/)() override | Renvoie le nombre d'arrêts de dégradé dans une collection. Lecture-seule **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>\> [GetEnumerator](./getenumerator/)() override | Renvoie un énumérateur qui parcourt la collection. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | Renvoie le code de hachage. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtient le type réel de l'objet. Analogue de l'appel C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) override | Renvoie l'arrêt de dégradé à l'index. |
| void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) override | Crée le nouvel arrêt de dégradé et l’insère à l'index spécifié dans la collection. |
| void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) override | Crée le nouvel arrêt de dégradé et l’insère à l'index spécifié dans la collection. |
| void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) override | Crée le nouvel arrêt de dégradé et l’insère à l'index spécifié dans la collection. |
...
| **bool** [LINQ_All](../../system.collections.generic/ienumerable/linq_all/)(std::function\<**bool**(T)>) | Détermine si tous les éléments d’une séquence satisfaient une condition. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Supprime un arrêt de dégradé à l’index spécifié. |
