...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si deux instances [FontData](./) sont égales. |
...
| [FontData](./fontdata/)([System::String](../../system/string/)) | Crée un nouvel objet [FontData](./) avec le nom de police spécifié. |
| [System::String](../../system/string/) [get_FontName](./get_fontname/)() override | Renvoie le nom de la police. Lire [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) override | Renvoie le nom de la police, en remplaçant la référence de thème par la police réellement utilisée. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Servir de fonction de hachage pour un type particulier, adaptée à une utilisation dans les algorithmes de hachage et les structures de données comme une table de hachage. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, mais initialise simplement le nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, mais initialise simplement le nouvel objet et permet la construction par copie des sous-classes. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Renvoie la représentation sous forme de chaîne. |
