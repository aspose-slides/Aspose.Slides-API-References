...
description: Représente les propriétés d'affichage communes des diapositives.
type: docs
weight: 1834
url: /fr/aspose.slides/icommonslideviewproperties/
---
## ICommonSlideViewProperties classe

Représente les propriétés d’affichage communes des diapositives.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | Renvoie le guide de dessin à l’indice spécifié. Lecture seule [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Renvoie la collection des guides de dessin. Lecture seule [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | Spécifie le ratio de mise à l’échelle de la vue en pourcentage. Lecture **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | Spécifie que le contenu de la vue doit être mis à l’échelle automatiquement pour mieux s’adapter à la taille de la fenêtre actuelle. Lecture **bool**. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Spécifie le ratio de mise à l’échelle de la vue en pourcentage. Écriture **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Spécifie que le contenu de la vue doit être mis à l’échelle automatiquement pour mieux s’adapter à la taille de la fenêtre actuelle. Écriture **bool**. |
