...
type: docs
weight: 742
url: /fr/aspose.slides/details_pptxreadexception/
---
## Details_PptxReadException classe
...
| void [Lock](../../system/object/lock/)() | Met en œuvre le verrouillage de l'instruction lock() de C#. Appelez directement ou utilisez l'objet sentry [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie rien, en réalité, il se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
...
| void [Unlock](../../system/object/unlock/)() | Met en œuvre le déverrouillage de l'instruction lock() de C#. Appelez directement ou utilisez l'objet sentry [LockContext](../../system/lockcontext/). |
...
* Classe [Details_PptxException](../details_pptxexception/)
