...
| Méthode | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::String](../../system/string/)) override | Ajoute une nouvelle partie XML personnalisée. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Ajoute une nouvelle partie XML personnalisée. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Ajoute une nouvelle partie XML personnalisée. |
| [iterator](./iterator/) [begin](./begin/)() | Obtient un itérateur pointant vers le premier élément (s’il existe) de la collection. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtient un itérateur pointant vers le premier élément (s’il existe) de l’instance en lecture seule de la collection. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtient un itérateur pointant vers le premier élément en lecture seule (s’il existe) de la collection. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtient un itérateur pointant juste après le dernier élément en lecture seule (s’il existe) de la collection. |
| void [Clear](./clear/)() override | Supprime tous les éléments de la collection. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>\>, **int32_t**) override | Copie dans le tableau spécifié. |
...
| [iterator](./iterator/) [end](./end/)() | Obtient un itérateur pointant juste après le dernier élément (s’il existe) de la collection. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtient un itérateur pointant juste après le dernier élément (s’il existe) de l’instance en lecture seule de la collection. |
...
| **int32_t** [get_Count](./get_count/)() override | Renvoie le nombre de parties XML personnalisées dans la collection. **int32_t** en lecture seule. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Renvoie une valeur indiquant si l’accès à la collection est synchronisé (thread-safe). **bool** en lecture seule. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Renvoie une racine de synchronisation. [System::Object](../../system/object/) en lecture seule. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l’objet. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>\>\> [GetEnumerator](./getenumerator/)() override | Renvoie un énumérateur qui parcourt la collection. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../../system/object/gethashcode/). Permet le hachage d’objets personnalisés. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtient le type réel de l’objet. Analogue de l’appel C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [idx_get](./idx_get/)(**int32_t**) override | Renvoie l’élément à l’indice spécifié. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Renvoie l’élément à l’indice spécifié d’une séquence. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Renvoie l’élément à l’indice spécifié d’une séquence. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>) override | Supprime la première occurrence d’un objet spécifique de la collection. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Supprime la partie XML personnalisée à l’indice spécifié. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtient un itérateur pointant vers le premier élément (s’il existe) de l’instance en lecture seule de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtient un itérateur pointant vers le premier élément (s’il existe) de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtient un itérateur pointant juste après le dernier élément (s’il existe) de l’instance en lecture seule de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtient un itérateur pointant juste après le dernier élément (s’il existe) de la collection. |
...
* Classe [ICustomXmlPartCollection](../icustomxmlpartcollection/)
