...
description: Objet immuable qui contient les propriétés effectives de remplissage de dégradé.
type: docs
weight: 2393
url: /fr/aspose.slides/igradientformateffectivedata/
---
## IGradientFormatEffectiveData classe

Objet immuable qui contient les propriétés effectives de remplissage de dégradé.
...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | Renvoie le style d'un dégradé. Lecture seule [Slides::GradientDirection](../gradientdirection/). |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | Renvoie la forme d'un dégradé. Lecture seule [Slides::GradientShape](../gradientshape/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | Renvoie un arrêt de dégradé à l'index spécifié. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)\> [get_GradientStops](./get_gradientstops/)() | Renvoie la collection d'arrêts de dégradé. Lecture seule [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/). |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | Renvoie l'angle d'un dégradé. Lecture seule **float**. |
| virtual **bool** [get_LinearGradientScaled](./get_lineargradientscaled/)() | Détermine si un dégradé est mis à l'échelle. Lecture seule **bool**. |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | Renvoie le mode de retournement d'un dégradé. Lecture seule [Slides::TileFlip](../tileflip/). |
