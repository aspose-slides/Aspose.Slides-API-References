...
---
## IDigitalSignatureCollection classe
...
| Méthode | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>) | Ajoute la signature à la fin de la collection. |
...
| virtual void [Clear](./clear/)() | Supprime toutes les signatures de la collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie la signature par indice. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime la signature à l'indice spécifié. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de modèle comme pointeur faible (au lieu de partagé). Permet de passer les pointeurs des conteneurs en mode faible. |
