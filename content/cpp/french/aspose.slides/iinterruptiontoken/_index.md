...
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | Renvoie **bool**.true si une interruption a été demandée. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ieme argument de modèle comme pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
...
| virtual void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() | Lance une exception si une interruption a été demandée. |
