...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Renvoie une copie des données d'un audio. En cas de grande quantité de données, envisagez d'utiliser la méthode [IAudio::GetStream](./getstream/) pour éviter le chargement inutile des données audio en mémoire ou même une OutOfMemoryException. Lecture seule **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Renvoie le type MIME d'un audio, encodé en [IAudio::get_BinaryData](./get_binarydata/). Lecture seule [System::String](../../system/string/). |
