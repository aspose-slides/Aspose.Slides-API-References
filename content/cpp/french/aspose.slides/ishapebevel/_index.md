...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Type de chanfrein. Lecture [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Hauteur du chanfrein. Lecture **double**. |
| virtual **double** [get_Width](./get_width/)() | Largeur du chanfrein. Lecture **double**. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Type de chanfrein. Écriture [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Hauteur du chanfrein. Écriture **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Largeur du chanfrein. Écriture **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nème argument de modèle comme pointeur faible (plutôt que partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
