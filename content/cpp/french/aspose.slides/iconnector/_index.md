...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Ajoute un nouveau placeholder s'il n'en existe pas et définit les propriétés du placeholder à celui spécifié. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValueCollection](../iadjustvaluecollection/)\> [get_Adjustments](../igeometryshape/get_adjustments/)() | Renvoie une collection des valeurs d’ajustement de la forme. Lecture seule [IAdjustValueCollection](../iadjustvaluecollection/). |
...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | La propriété spécifie comment une forme sera affichée en mode noir et blanc. Lecture [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IConnectorLock](../iconnectorlock/)\> [get_ConnectorLock](./get_connectorlock/)() | Renvoie les verrous de [Connector](../connector/). Lecture seule [IConnectorLock](../iconnectorlock/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [get_EndShapeConnectedTo](./get_endshapeconnectedto/)() | Renvoie la forme à laquelle attacher l’extrémité du connecteur. Lecture [IShape](../ishape/). |
| virtual **uint32_t** [get_EndShapeConnectionSiteIndex](./get_endshapeconnectionsiteindex/)() | Renvoie l’index du point de connexion pour la forme finale. Lecture **uint32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](../ishape/get_fillformat/)() | Renvoie l’objet [FillFormat](../fillformat/) qui contient les propriétés de formatage de remplissage d’une forme. Lecture seule [IFillFormat](../ifillformat/). |
...
| virtual **bool** [get_Hidden](../ishape/get_hidden/)() | Détermine si la forme est cachée. Lecture **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_LineFormat](../ishape/get_lineformat/)() | Renvoie l’objet [LineFormat](../lineformat/) qui contient les propriétés de formatage de ligne d’une forme. Lecture seule [ILineFormat](../ilineformat/). |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Renvoie un identifiant unique limité à la diapositive qui demeure constant pendant la durée de vie de la forme et permet à PowerPoint ou au code d’interopérabilité de référencer de manière fiable la forme depuis n’importe où dans le document. Lecture seule **uint32_t**. Voir aussi [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [get_Placeholder](../ishape/get_placeholder/)() | Renvoie le placeholder pour une forme. Lecture seule [IPlaceholder](../iplaceholder/). |
...
| virtual **float** [get_Rotation](../ishape/get_rotation/)() | Renvoie le nombre de degrés dont la forme spécifiée est tournée autour de l’axe z. Une valeur positive indique une rotation horaire ; une valeur négative indique une rotation antihoraire. Lecture **float**. |
...
| virtual [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](../igeometryshape/get_shapetype/)() | Renvoie le type de géométrie prédéfini. Note : lors de la modification de la valeur, toutes les valeurs d’ajustement seront réinitialisées à leurs valeurs par défaut. Lecture [Slides::ShapeType](../shapetype/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [get_StartShapeConnectedTo](./get_startshapeconnectedto/)() | Renvoie la forme à laquelle attacher le début du connecteur. Lecture [IShape](../ishape/). |
| virtual **uint32_t** [get_StartShapeConnectionSiteIndex](./get_startshapeconnectionsiteindex/)() | Renvoie l’index du point de connexion pour la forme de départ. Lecture **uint32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../ithreedformat/)\> [get_ThreeDFormat](../ishape/get_threedformat/)() | Renvoie l’objet [ThreeDFormat](../threedformat/) qui contient les propriétés de formatage de ligne d’une forme. Lecture seule [IThreeDFormat](../ithreedformat/). |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Renvoie un identifiant interne limité à la présentation destiné à être utilisé par des add-ins ou autre code. Étant donné que cette valeur peut être réassignée par l’utilisateur ou programmatiquement, elle ne doit pas être considérée comme une clé unique persistante. Lecture seule **uint32_t**. Voir aussi [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Renvoie une forme placeholder de base (forme provenant de la diapositive layout et/ou maître dont la forme actuelle hérite). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>\> [GetGeometryPaths](../igeometryshape/getgeometrypaths/)() | Renvoie la copie du chemin de la forme géométrique. Les coordonnées sont relatives au coin supérieur gauche de la forme. |
...
| virtual void [RemovePlaceholder](../ishape/removeplaceholder/)() | Définit que cette forme n’est pas un placeholder. |
| virtual void [Reroute](./reroute/)() | Redirige le connecteur afin qu’il emprunte le chemin le plus court possible entre les formes qu’il connecte. |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | La propriété spécifie comment une forme sera affichée en mode noir et blanc. Écriture [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual void [set_EndShapeConnectedTo](./set_endshapeconnectedto/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>) | Définit la forme à laquelle attacher l’extrémité du connecteur. Écriture [IShape](../ishape/). |
| virtual void [set_EndShapeConnectionSiteIndex](./set_endshapeconnectionsiteindex/)(**uint32_t**) | Définit l’index du point de connexion pour la forme finale. Écriture **uint32_t**. |
...
| virtual void [set_Hidden](../ishape/set_hidden/)(**bool**) | Définit si la forme est cachée. Écriture **bool**. |
...
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | Définit le nombre de degrés dont la forme spécifiée est tournée autour de l’axe z. Une valeur positive indique une rotation horaire ; une valeur négative indique une rotation antihoraire. Écriture **float**. |
| virtual void [set_ShapeType](../igeometryshape/set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) | Définit le type de géométrie prédéfini. Note : lors de la modification de la valeur, toutes les valeurs d’ajustement seront réinitialisées à leurs valeurs par défaut. Écriture [Slides::ShapeType](../shapetype/). |
| virtual void [set_StartShapeConnectedTo](./set_startshapeconnectedto/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>) | Définit la forme à laquelle attacher le début du connecteur. Écriture [IShape](../ishape/). |
| virtual void [set_StartShapeConnectionSiteIndex](./set_startshapeconnectionsiteindex/)(**uint32_t**) | Définit l’index du point de connexion pour la forme de départ. Écriture **uint32_t**. |
