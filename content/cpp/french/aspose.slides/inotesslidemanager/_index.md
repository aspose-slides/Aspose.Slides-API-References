...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() | Renvoie la diapositive de notes pour la diapositive actuelle, en créant une si elle n'existe pas. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() | Renvoie la diapositive de notes pour la diapositive actuelle. Renvoie null si la diapositive n'a pas de diapositive de notes. Lecture seule [INotesSlide](../inotesslide/). |
...
| virtual void [RemoveNotesSlide](./removenotesslide/)() | Supprime la diapositive de notes de la diapositive actuelle. |
