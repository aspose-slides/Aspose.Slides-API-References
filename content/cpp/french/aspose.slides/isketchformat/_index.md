...
description: Représente les propriétés du format de croquis des lignes.
type: docs
weight: 3732
url: /fr/aspose.slides/isketchformat/
---
## ISketchFormat classe

Représente les propriétés du format de croquis des lignes.
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Renvoie le type de croquis. Lire [Slides::LineSketchType](../linesketchtype/). |
...
| virtual void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) | Définit le type de croquis. Écrire [Slides::LineSketchType](../linesketchtype/). |
