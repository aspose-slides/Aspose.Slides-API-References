...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Renvoie la couleur du guide de dessin. Lire [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Renvoie l'orientation du guide de dessin. Lire [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Renvoie la position du guide de dessin en points depuis le coin supérieur gauche de la diapositive. Lire **float**. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Définit la couleur du guide de dessin. Écrire [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Définit l'orientation du guide de dessin. Écrire [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Définit la position du guide de dessin en points depuis le coin supérieur gauche de la diapositive. Écrire **float**. |
