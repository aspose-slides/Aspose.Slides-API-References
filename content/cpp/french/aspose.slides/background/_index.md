...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() override | Renvoie un [EffectFormat](../effectformat/) pour le remplissage [BackgroundType::OwnBackground](../backgroundtype/). Lecture seule [IEffectFormat](../ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Renvoie un [FillFormat](../fillformat/) pour le remplissage [BackgroundType::OwnBackground](../backgroundtype/). Lecture seule [IFillFormat](../ifillformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() override | Renvoie un [ColorFormat](../colorformat/) pour un remplissage [BackgroundType::Themed](../backgroundtype/). Lecture seule [IColorFormat](../icolorformat/). |
| **uint16_t** [get_StyleIndex](./get_styleindex/)() override | Renvoie un indice du remplissage [BackgroundType::Themed](../backgroundtype/) dans la collection de thèmes d'arrière-plan. 0 signifie aucun remplissage. 1..999 - indice. Lecture **uint16_t**. |
| [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() override | Renvoie un type de remplissage d'arrière-plan. Lecture [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les données d'arrière-plan effectives avec l'héritage appliqué. |
...
| void [set_StyleIndex](./set_styleindex/)(**uint16_t**) override | Renvoie un indice du remplissage [BackgroundType::Themed](../backgroundtype/) dans la collection de thèmes d'arrière-plan. 0 signifie aucun remplissage. 1..999 - indice. Écriture **uint16_t**. |
| void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) override | Renvoie un type de remplissage d'arrière-plan. Écriture [BackgroundType](../backgroundtype/). |
