...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Retourne le nombre de comportements dans une collection. Lecture seule **int32_t**. |
| virtual **double** [get_Height](./get_height/)() | Retourne la hauteur d'une ligne. Lecture seule **double**. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Retourne une valeur indiquant si l'accès à la collection est synchronisé (thread-safe). Lecture seule **bool**. |
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Retourne la hauteur minimale possible d'une ligne. Lecture **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Retourne l'objet [RowFormat](../rowformat/) qui contient les propriétés de mise en forme pour cette ligne. Lecture seule [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Retourne une racine de synchronisation. Lecture seule [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Retourne une cellule par sa position. Lecture seule [ICell](../icell/). |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Invite une fonction de transformation sur chaque élément d'une séquence générique et retourne la valeur maximale résultante. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Invite une fonction de transformation sur chaque élément d'une séquence générique et retourne la valeur minimale résultante. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien vraiment, initialise simplement le nouvel objet et permet la copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie rien vraiment, initialise simplement le nouvel objet et permet la copie des sous-classes. |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Définit la hauteur minimale possible d'une ligne. Écrire **double**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Définit les propriétés de format de portion définies pour toutes les portions de l'élément. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Définit les propriétés de format de paragraphe définies pour tous les paragraphes de l'élément. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Définit les propriétés de format de cadre de texte définies pour tous les cadres de texte de l'élément. |
...
* Classe [ICellCollection](../icellcollection/)
