...
description: Gestionnaire de diapositives de notes maîtres.
type: docs
weight: 2913
url: /fr/aspose.slides/imasternotesslidemanager/
---
## IMasterNotesSlideManager classe


Gestionnaire de diapositives de notes maîtres.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [get_MasterNotesSlide](./get_masternotesslide/)() | Renvoie un maître pour toutes les diapositives de notes de cette présentation s'il en existe un, sinon renvoie null. Lecture seule [IMasterNotesSlide](../imasternotesslide/). |
...
| virtual void [RemoveMasterNotesSlide](./removemasternotesslide/)() | Supprime la diapositive de notes maîtres. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [SetDefaultMasterNotesSlide](./setdefaultmasternotesslide/)() | Définit la diapositive de notes maîtres par défaut pour la diapositive de notes associée. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ème argument de modèle comme un pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
