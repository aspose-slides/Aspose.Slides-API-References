...
description: Ajoute une nouvelle forme d'espace réservé à la diapositive de mise en page pour contenir un diagramme SmartArt.
type: docs
weight: 92
url: /fr/aspose.slides/layoutplaceholdermanager/addsmartartplaceholder/
---
## LayoutPlaceholderManager::AddSmartArtPlaceholder(float, float, float, float) méthode

Ajoute une nouvelle forme d'espace réservé à la diapositive de mise en page pour contenir un diagramme [SmartArt](../../../aspose.slides.smartart/).
...
L'exemple suivant montre comment ajouter la forme d'espace réservé [SmartArt](../../../aspose.slides.smartart/) à la diapositive de mise en page. 
```cpp
