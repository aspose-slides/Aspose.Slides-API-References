...
description: Représente la diapositive principale pour les documents d'accompagnement.
type: docs
weight: 4408
...
Représente la diapositive principale pour les documents d’accompagnement.
...
| **bool** [Equals](../baseslide/equals/)([System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\>) override | Détermine si les deux instances [IBaseSlide](../ibaseslide/) sont égales. La valeur retournée est calculée en fonction de la structure de la diapositive et du contenu statique. Deux diapositives sont égales si toutes les formes, styles, textes, animations et autres paramètres, etc., sont égaux. La comparaison ne prend pas en compte les valeurs d’identifiants uniques, par ex. SlideId et le contenu dynamique, par ex. la valeur de la date actuelle dans le [Placeholder](../placeholder/) Date. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IControlCollection](../icontrolcollection/)\> [get_Controls](../baseslide/get_controls/)() override | Renvoie la collection de contrôles ActiveX sur une diapositive. Lecture seule [IControlCollection](../icontrolcollection/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Renvoie une collection de guides de dessin pour la diapositive principale d’accompagnement. Lecture seule [IDrawingGuidesCollection](../idrawingguidescollection/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Renvoie le gestionnaire HeaderFooter de la diapositive principale d’accompagnement. Lecture seule [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/). |
...
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | Spécifie si les formes sur la diapositive principale doivent être affichées sur les diapositives ou non. Pour la diapositive principale elle-même, cette propriété renvoie toujours **false**. Lecture **bool**. |
...
| void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)() override | Fusionne les séquences avec le même formatage dans tous les paragraphes de toutes les formes acceptables. |
| virtual void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\>) | Fusionne les séquences avec le même formatage dans tous les paragraphes de toutes les formes acceptables. |
...
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | Spécifie si les formes sur la diapositive principale doivent être affichées sur les diapositives ou non. Pour la diapositive principale elle-même, cette propriété renvoie toujours **false**. Écriture **bool**. |
...
* Classe [IMasterHandoutSlide](../imasterhandoutslide/)
