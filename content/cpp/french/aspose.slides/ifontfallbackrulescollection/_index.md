...
| Méthode | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Ajoute une nouvelle règle FallBack à la fin de la collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) | Obtient la règle à l'index spécifié. Lecture seule [IFontFallBackRule](../ifontfallbackrule/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Supprime la première occurrence d'une règle FallBack spécifique de la collection. |
