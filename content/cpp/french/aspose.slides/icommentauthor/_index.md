...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | Renvoie le commentaire créé par cet auteur à l'index spécifié. Lecture seule [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | Renvoie la collection des commentaires créés par cet auteur. Lecture seule [ICommentCollection](../icommentcollection/). |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | Renvoie les initiales de l’auteur. Lecture [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Renvoie le nom de l’auteur. Lecture [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Supprime l’auteur de la collection parent. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées de la valeur spécifiée. |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | Définit les initiales de l’auteur. Écriture [System::String](../../system/string/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Définit le nom de l’auteur. Écriture [System::String](../../system/string/). |
