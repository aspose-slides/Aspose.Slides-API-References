...
| Méthode | Description |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Compare l'instance actuelle avec un autre objet du même type. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Renvoie le style d'alignement d'une tabulation. Lire [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Renvoie la position d'une tabulation. L'affectation de cette propriété peut modifier l'index de la tabulation dans la collection et invalider l'énumérateur. Lire **double**. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Définit le style d'alignement d'une tabulation. Écrire [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Définit la position d'une tabulation. L'affectation de cette propriété peut modifier l'index de la tabulation dans la collection et invalider l'énumérateur. Écrire **double**. |
...
| [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Crée un nouveau [Tab](./) |
