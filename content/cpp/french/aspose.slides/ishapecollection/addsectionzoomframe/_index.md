...
description: Crée un nouveau cadre Zoom de section et l'ajoute à la fin de la collection de formes.
type: docs
weight: 118
url: /fr/aspose.slides/ishapecollection/addsectionzoomframe/
---
## IShapeCollection::AddSectionZoomFrame(float, float, float, float, System::SharedPtr\<ISection\>) méthode
...
## IShapeCollection::AddSectionZoomFrame(float, float, float, float, System::SharedPtr\<ISection\>, System::SharedPtr\<IPPImage\>) méthode
