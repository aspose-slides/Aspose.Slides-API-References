...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison en virgule flottante de style C# où deux NaN sont considérés comme égaux même si, selon la IEC 60559 :1989, NaN n’est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison en virgule flottante de style C# où deux NaN sont considérés comme égaux même si, selon la IEC 60559 :1989, NaN n’est égal à aucune valeur, y compris NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | À usage interne uniquement. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetAnyHyperlinks](./getanyhyperlinks/)() override | Récupère tous les sous-objets [IHyperlinkContainer](../ihyperlinkcontainer/) qui contiennent un HyperlinkMouseOver non nul. Avec l’objet [IHyperlinkContainer](../ihyperlinkcontainer/) fourni, vous pouvez gérer son hyperlien (lecture, mise à jour ou suppression). Voir l’interface [IHyperlinkContainer](../ihyperlinkcontainer/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkClicks](./gethyperlinkclicks/)() override | Récupère tous les sous-objets [IHyperlinkContainer](../ihyperlinkcontainer/) qui contiennent un HyperlinkClick non nul. Avec l’objet [IHyperlinkContainer](../ihyperlinkcontainer/) fourni, vous pouvez gérer son hyperlien (lecture, mise à jour ou suppression). Voir l’interface [IHyperlinkContainer](../ihyperlinkcontainer/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkMouseOvers](./gethyperlinkmouseovers/)() override | Récupère tous les sous-objets [IHyperlinkContainer](../ihyperlinkcontainer/) qui contiennent un HyperlinkMouseOver non nul. Avec l’objet [IHyperlinkContainer](../ihyperlinkcontainer/) fourni, vous pouvez gérer son hyperlien (lecture, mise à jour ou suppression). Voir l’interface [IHyperlinkContainer](../ihyperlinkcontainer/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il ne fait qu’initialiser un nouvel objet et permet la construction de copies des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, en réalité, il ne fait qu’initialiser un nouvel objet et permet la construction de copies des sous-classes. |
...
| void [RemoveAllHyperlinks](./removeallhyperlinks/)() override | Supprime tous les hyperliens HyperlinkClick et HyperlinkMouseOver contenus (dans tous les sous-objets [IHyperlinkContainer](../ihyperlinkcontainer/)). |
...
* Classe [IHyperlinkQueries](../ihyperlinkqueries/)
