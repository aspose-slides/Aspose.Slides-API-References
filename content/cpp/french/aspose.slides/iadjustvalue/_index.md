...
description: Représente la valeur d’ajustement d’une forme géométrique. Ces valeurs affectent la forme de la forme.
type: docs
weight: 1288
...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Retourne la valeur, l’interprétant comme un angle en degrés. Lecture **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Retourne un nom de cette valeur d’ajustement. Lecture seule [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Retourne la valeur d’ajustement "tel quelle". Lecture **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Retourne le type de l’ajustement de la forme. Lecture seule [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Définit la valeur, l’interprétant comme un angle en degrés. Écriture **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Définit la valeur d’ajustement "tel quelle". Écriture **int64_t**. |
