...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Ajoute un nouveau espace réservé s'il n'existe pas et définit les propriétés de l'espace réservé sur celui spécifié. |
...
| virtual **bool** [get_Hidden](../ishape/get_hidden/)() | Détermine si la forme est cachée. Lire **bool**. |
...
| virtual [ZoomImageType](../zoomimagetype/) [get_ImageType](./get_imagetype/)() | Obtient le type d'image d'un objet Zoom. Lire [ZoomImageType](../zoomimagetype/). Valeur par défaut : Preview |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Renvoie un identifiant unique limité à la diapositive qui reste constant pendant toute la durée de vie de la forme et permet à PowerPoint ou au code d'interopérabilité de référencer la forme de manière fiable depuis n'importe où dans le document. Lecture seule **uint32_t**. Voir aussi [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual **bool** [get_ReturnToParent](./get_returntoparent/)() | Obtient le comportement de navigation dans le diaporama. Lire **bool**. Valeur par défaut : false |
...
| virtual **bool** [get_ShowBackground](./get_showbackground/)() | Obtient la valeur indiquant si le Zoom utilisera l'arrière-plan de la diapositive de destination. Lire **bool**. Valeur par défaut : true |
...
| virtual **float** [get_TransitionDuration](./get_transitionduration/)() | Obtient la durée de la transition entre le Zoom et la diapositive. Lire **float**. Valeur par défaut : 1.0f |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Renvoie un identifiant interne limité à la présentation destiné à être utilisé par des add-ins ou d'autres codes. Comme cette valeur peut être réaffectée par l'utilisateur ou programmatiquement, elle ne doit pas être traitée comme une clé unique persistante. Lecture seule **uint32_t**. Voir aussi [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](./get_zoomimage/)() | Obtient l'image pour l'objet Zoom. Lire [IPPImage](../ippimage/). |
...
| virtual void [RemovePlaceholder](../ishape/removeplaceholder/)() | Indique que cette forme n'est pas un espace réservé. |
...
| virtual void [set_Hidden](../ishape/set_hidden/)(**bool**) | Détermine si la forme est cachée. Écriture **bool**. |
...
| virtual void [set_ImageType](./set_imagetype/)([ZoomImageType](../zoomimagetype/)) | Définit le type d'image d'un objet Zoom. Écriture [ZoomImageType](../zoomimagetype/). Valeur par défaut : Preview |
...
| virtual void [set_ReturnToParent](./set_returntoparent/)(**bool**) | Définit le comportement de navigation dans le diaporama. Écriture **bool**. Valeur par défaut : false |
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | Définit le nombre de degrés de rotation de la forme spécifiée autour de l'axe z. Une valeur positive indique une rotation horaire ; une valeur négative indique une rotation anti-horaire. Écriture **float**. |
| virtual void [set_ShowBackground](./set_showbackground/)(**bool**) | Définit la valeur indiquant si le Zoom utilisera l'arrière-plan de la diapositive de destination. Écriture **bool**. Valeur par défaut : true |
| virtual void [set_TransitionDuration](./set_transitionduration/)(**float**) | Définit la durée de la transition entre le Zoom et la diapositive. Écriture **float**. Valeur par défaut : 1.0f |
...
| virtual void [set_ZoomImage](./set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Définit l'image pour l'objet Zoom. Écriture [IPPImage](../ippimage/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définissez le n-ième argument de modèle comme pointeur faible (plutôt que partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
