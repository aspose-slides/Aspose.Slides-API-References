...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) | Ajoute le guide de dessin à la fin de la collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie le guide de dessin par index. Lecture seule [IDrawingGuide](../idrawingguide/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime le guide de dessin à l'index spécifié. |
