...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Renvoie le commentaire fait par cet auteur à l'index spécifié. Lecture seule [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Renvoie la collection de commentaires faits par cet auteur. Lecture seule [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Renvoie les initiales de l'auteur. Lecture [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Renvoie le nom de l'auteur. Lecture [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Supprime l'auteur de la collection parente. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées de la valeur spécifiée. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Définit les initiales de l'auteur. Écriture [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Définit le nom de l'auteur. Écriture [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de modèle comme pointeur faible (au lieu d'un partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
