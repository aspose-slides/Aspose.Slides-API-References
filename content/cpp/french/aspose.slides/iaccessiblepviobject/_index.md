...
description: Représente un type qui peut renvoyer les données effectives correspondantes avec l'héritage appliqué.
type: docs
weight: 1275
url: /fr/aspose.slides/iaccessiblepviobject/
---
...
| virtual T [GetEffective](./geteffective/)() | Obtient les données effectives avec l'héritage appliqué. |
