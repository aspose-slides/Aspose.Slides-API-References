...
---
## IGradientStopCollectionEffectiveData classe
...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Renvoie le nombre de comportements dans une collection. **int32_t** en lecture seule. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Renvoie une valeur indiquant si l'accès à la collection est synchronisé (thread-safe). **bool** en lecture seule. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Renvoie une racine de synchronisation. [System::Object](../../system/object/) en lecture seule. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie l'arrêt de dégradé à l'index (**int32_t**). |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Applique une fonction d'accumulation sur une séquence. |
