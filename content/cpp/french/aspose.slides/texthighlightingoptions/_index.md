...
description: Représente les options pouvant être utilisées pour mettre en évidence le texte dans un cadre de texte.
type: docs
weight: 5474
...
Représente les options qui peuvent être utilisées pour mettre en évidence le texte dans le cadre de texte.
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Définit vrai pour utiliser la recherche sensible à la casse, sinon faux. Lecture **bool**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Définit vrai pour ne correspondre qu'aux mots entiers, sinon faux. Lecture **bool**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Définit vrai pour utiliser la recherche sensible à la casse, sinon faux. Écriture **bool**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Définit vrai pour ne correspondre qu'aux mots entiers, sinon faux. Écriture **bool**. |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | Crée de nouvelles options de mise en évidence du texte par défaut. |
...
Obsolète
:   L'interface [ITextHighlightingOptions](../itexthighlightingoptions/) sera supprimée après la sortie de la version 24.10.
