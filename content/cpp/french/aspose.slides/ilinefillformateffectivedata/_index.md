...
---
## classe ILineFillFormatEffectiveData
...
| virtual **bool** [get_RotateWithShape](./get_rotatewithshape/)() | Détermine si le remplissage doit être pivoté avec une forme. Lecture seule **bool**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_SolidFillColor](./get_solidfillcolor/)() | Renvoie la couleur d'un remplissage plein. Lecture seule [System::Drawing::Color](../../system.drawing/color/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument template comme un pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
