...
description: Gestionnaire de diapositive de support maître.
type: docs
weight: 2861
...
Gestionnaire de diapositive de support maître.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [get_MasterHandoutSlide](./get_masterhandoutslide/)() | Renvoie un maître pour toutes les diapositives de notes de cette présentation s’il en existe un, sinon renvoie null. Lecture seule [IMasterHandoutSlide](../imasterhandoutslide/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, vraiment, se contente d’initialiser le nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, vraiment, se contente d’initialiser le nouvel objet et permet la construction par copie des sous-classes. |
...
| virtual void [RemoveMasterHandoutSlide](./removemasterhandoutslide/)() | Supprime la diapositive de support maître. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [SetDefaultMasterHandoutSlide](./setdefaultmasterhandoutslide/)() | Définit la diapositive de support maître par défaut sur la diapositive de support associée. |
