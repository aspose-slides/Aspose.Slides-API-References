...
description: Représente une collection de toutes les diapositives de mise en page d'une diapositive maître définie. Étend l'interface ILayoutSlideCollection avec des méthodes pour ajouter/insérer/supprimer/dupliquer des diapositives de mise en page dans le contexte des collections individuelles des diapositives de mise en page du maître.
type: docs
weight: 2874
url: /fr/aspose.slides/imasterlayoutslidecollection/
---
## IMasterLayoutSlideCollection classe

Représente une collection de toutes les diapositives de mise en page d'une diapositive maître définie. Étend l'interface [ILayoutSlideCollection](../ilayoutslidecollection/) avec des méthodes pour ajouter/insérer/supprimer/dupliquer des diapositives de mise en page dans le contexte des collections individuelles des diapositives de mise en page du maître.
...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Ajoute une nouvelle diapositive de mise en page à la fin de la collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Ajoute une copie d'une diapositive de mise en page spécifiée à la fin de la collection. |
...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Renvoie le nombre de comportements dans une collection. Lecture seule **int32_t**. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Renvoie une valeur indiquant si l'accès à la collection est synchronisé (thread-safe). Lecture seule **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Renvoie une racine de synchronisation. Lecture seule [System::Object](../../system/object/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | Renvoie la première diapositive de mise en page du type spécifié. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | Renvoie la diapositive de mise en page à l'index indiqué. Lecture seule [ILayoutSlide](../ilayoutslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Insert](./insert/)(**int32_t**, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Insère une nouvelle diapositive de mise en page à la position spécifiée de la collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Insère une copie d'une diapositive de mise en page spécifiée à la position indiquée de la collection. |
...
| **bool** [LINQ_All](../../system.collections.generic/ienumerable/linq_all/)(std::function\<**bool**(T)>) | Détermine si tous les éléments d'une séquence remplissent une condition. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Renvoie le nombre d'éléments de la séquence qui remplissent la condition spécifiée. |
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Renvoie l'élément à l'index indiqué dans une séquence. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Renvoie l'élément à l'index indiqué dans une séquence. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Reverse](../../system.collections.generic/ienumerable/linq_reverse/)() | Inverser l'ordre des éléments d'une séquence. |
...
| virtual void [Remove](../ilayoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Supprime une mise en page de la collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime l'élément à l'index indiqué de la collection. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées du nombre spécifié. |
| virtual void [RemoveUnused](../ilayoutslidecollection/removeunused/)() | Supprime les diapositives de mise en page inutilisées (diapositives dont HasDependingSlides est faux). |
| virtual void [Reorder](./reorder/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Déplace la diapositive de mise en page de la collection vers la position indiquée. |
...
* Classe [ILayoutSlideCollection](../ilayoutslidecollection/)
