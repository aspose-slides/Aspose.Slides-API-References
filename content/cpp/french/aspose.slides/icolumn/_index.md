...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres flottants à la manière de C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() | Renvoie l'objet [ColumnFormat](../columnformat/) qui contient les propriétés de formatage pour cette colonne. Lecture seule [IColumnFormat](../icolumnformat/). |
...
| virtual **double** [get_Width](./get_width/)() | Renvoie la largeur d'une colonne. Lecture **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Renvoie une cellule à sa position. Lecture seule [ICell](../icell/). |
...
| virtual void [set_Width](./set_width/)(**double**) | Définit la largeur d'une colonne. Écriture **double**. |
