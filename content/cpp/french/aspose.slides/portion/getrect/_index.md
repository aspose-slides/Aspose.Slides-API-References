...
description: Obtenez les coordonnées du rectangle qui délimite la portion. Le rectangle comprend toutes les lignes de texte de la portion, y compris les lignes vides.
type: docs
weight: 92
url: /fr/aspose.slides/portion/getrect/
---
## Portion::GetRect() méthode

Obtenez les coordonnées du rectangle qui délimite la portion. Le rectangle comprend toutes les lignes de texte de la portion, y compris les lignes vides.
