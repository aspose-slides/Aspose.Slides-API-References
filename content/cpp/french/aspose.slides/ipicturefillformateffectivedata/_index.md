...
description: Objet immuable qui contient les propriétés du remplissage d'image.
type: docs
weight: 3238
url: /fr/aspose.slides/ipicturefillformateffectivedata/
---
## IPictureFillFormatEffectiveData classe


Objet immuable qui contient les propriétés du remplissage d'image.
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | Renvoie le pourcentage de la hauteur réelle de l'image qui est recadré en bas de l'image. Lecture seule **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | Renvoie le pourcentage de la largeur réelle de l'image qui est recadré à gauche de l'image. Lecture seule **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | Renvoie le pourcentage de la largeur réelle de l'image qui est recadré à droite de l'image. Lecture seule **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | Renvoie le pourcentage de la hauteur réelle de l'image qui est recadré en haut de l'image. Lecture seule **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | Renvoie le DPI utilisé pour remplir l'image. Lecture seule **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | Renvoie l'image. Lecture seule [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | Renvoie le mode de remplissage d'image. Lecture seule [Slides::PictureFillMode](../picturefillmode/). |
