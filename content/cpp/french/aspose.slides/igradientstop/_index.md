...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Renvoie la couleur d’un arrêt de dégradé. Lecture seule [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Renvoie la position (0..1) d’un arrêt de dégradé. Lecture **float**. |
...
| virtual void [set_Position](./set_position/)(**float**) | Définit la position (0..1) d’un arrêt de dégradé. Écriture **float**. |
