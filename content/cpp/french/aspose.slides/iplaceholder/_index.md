...
| virtual **uint32_t** [get_Index](./get_index/)() | Obtient l'index d'un espace réservé. Lecture seule **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Obtient l'orientation d'un espace réservé. Lecture seule [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | Obtient la taille d'un espace réservé. Lecture seule [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | Obtient le type d'un espace réservé. Lecture seule [PlaceholderType](../placeholdertype/). |
