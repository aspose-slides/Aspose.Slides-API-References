...
type: docs
weight: 14
url: /fr/aspose.slides/izoomframe/set_targetslide/
---
## IZoomFrame::set_TargetSlide(System::SharedPtr\<ISlide\>) méthode
...
L'exemple suivant montre la modification de la diapositive cible et crée une nouvelle image pour l'objet Zoom [Slide](../../slide/):
```cpp
