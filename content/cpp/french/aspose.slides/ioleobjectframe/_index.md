...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Ajoute un nouveau espace réservé s'il n'existe pas et définit les propriétés de l'espace réservé sur un spécifié. |
...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | La propriété indique comment une forme sera rendue en mode d'affichage noir et blanc. Lire [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\> [get_EmbeddedData](./get_embeddeddata/)() | Obtient les informations sur les données OLE intégrées. Lecture seule [IOleEmbeddedDataInfo](../ioleembeddeddatainfo/). |
| virtual [System::String](../../system/string/) [get_EmbeddedFileLabel](./get_embeddedfilelabel/)() | Renvoie le nom de fichier de l'objet OLE intégré |
| virtual [System::String](../../system/string/) [get_EmbeddedFileName](./get_embeddedfilename/)() | Renvoie le chemin de l'objet OLE intégré |
...
| virtual **bool** [get_IsObjectIcon](./get_isobjecticon/)() | Détermine si un objet est visible sous forme d'icône. Lecture **bool**. |
| virtual **bool** [get_IsObjectLink](./get_isobjectlink/)() | Détermine si un objet est lié à un fichier externe. Lecture seule **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkFileName](./get_linkfilename/)() | Renvoie le chemin complet d'un fichier lié. Le nom de fichier court sera utilisé. Lecture seule [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Renvoie le chemin complet d'un fichier lié. Le nom de fichier long sera utilisé. Lecture [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_LinkPathRelative](./get_linkpathrelative/)() | Renvoie le chemin relatif d'un fichier lié si présent, sinon renvoie une chaîne vide. Lecture seule [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](../ishape/get_name/)() | Renvoie le nom d'une forme. Lire [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_ObjectName](./get_objectname/)() | Renvoie le nom d'un objet. Lire [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_ObjectProgId](./get_objectprogid/)() | Renvoie le ProgID d'un objet. Lecture uniquement [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_RawFrame](../ishape/get_rawframe/)() | Renvoie les propriétés brutes du cadre de forme. Lire [IShapeFrame](../ishapeframe/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() | Renvoie l'objet des propriétés de remplissage d'image OleObject. Lecture seule [IPictureFillFormat](../ipicturefillformat/). |
| virtual [System::String](../../system/string/) [get_SubstitutePictureTitle](./get_substitutepicturetitle/)() | Renvoie le titre de l'icône OleObject. Lire [System::String](../../system/string/). |
...
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Renvoie un identifiant interne limité à la présentation destiné à être utilisé par des compléments ou d'autres code. Parce que cette valeur peut être réassignée par l'utilisateur ou programmatiquement, elle ne doit pas être considérée comme une clé unique persistante. Lecture seule **uint32_t**. Voir aussi [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
| virtual **bool** [get_UpdateAutomatic](./get_updateautomatic/)() | Détermine si l'objet intégré lié est automatiquement mis à jour lorsque la présentation est ouverte ou imprimée. Lecture **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Renvoie une forme d'espace réservé de base (forme provenant de la diapositive de mise en page et/ou maîtresse dont la forme actuelle hérite). |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | La propriété indique comment une forme sera rendue en mode d'affichage noir et blanc. Écriture [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual void [set_Hidden](../ishape/set_hidden/)(**bool**) | Définit si la forme est masquée. Écriture **bool**. |
| virtual void [set_HyperlinkClick](../ihyperlinkcontainer/set_hyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Définit le lien hypertexte pour le clic de souris. Écriture [IHyperlink](../ihyperlink/). |
| virtual void [set_HyperlinkMouseOver](../ihyperlinkcontainer/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Définit le lien hypertexte pour le survol de souris. Écriture [IHyperlink](../ihyperlink/). |
...
| virtual void [set_IsObjectIcon](./set_isobjecticon/)(**bool**) | Détermine si un objet est visible sous forme d'icône. Écriture **bool**. |
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Définit le chemin complet d'un fichier lié. Le nom de fichier long sera utilisé. Écriture [System::String](../../system/string/). |
...
| virtual void [set_ObjectName](./set_objectname/)([System::String](../../system/string/)) | Définit le nom d'un objet. Écriture [System::String](../../system/string/). |
| virtual void [set_ObjectProgId](./set_objectprogid/)([System::String](../../system/string/)) | Renvoie le ProgID d'un objet. Lecture uniquement [System::String](../../system/string/). |
...
| virtual void [set_SubstitutePictureTitle](./set_substitutepicturetitle/)([System::String](../../system/string/)) | Définit le titre de l'icône OleObject. Écriture [System::String](../../system/string/). |
| virtual void [set_UpdateAutomatic](./set_updateautomatic/)(**bool**) | Détermine si l'objet intégré lié est automatiquement mis à jour lorsque la présentation est ouverte ou imprimée. Écriture **bool**. |
...
| virtual void [SetEmbeddedData](./setembeddeddata/)([System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\>) | Définit les informations sur les données OLE intégrées. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définir le n-ième argument de modèle comme pointeur faible (au lieu de partagé). Permet de basculer les pointeurs dans les conteneurs vers le mode faible. |
