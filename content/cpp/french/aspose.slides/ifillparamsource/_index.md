...
description: Interface auxiliaire des paramètres de remplissage.
type: docs
weight: 2133
url: /fr/aspose.slides/ifillparamsource/
---
## IFillParamSource classe


Interface auxiliaire des paramètres de remplissage.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison à la C# de nombres à virgule flottante où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n’est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison à la C# de nombres à virgule flottante double où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n’est égal à aucune valeur, y compris NaN. |
