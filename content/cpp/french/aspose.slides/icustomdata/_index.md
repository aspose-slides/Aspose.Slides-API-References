...
description: Représente un conteneur pour les données personnalisées.
type: docs
weight: 1912
...
Représente un conteneur pour les données personnalisées.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) | Renvoie la partie XML personnalisée à l'index spécifié. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() | Renvoie la collection des parties XML personnalisées. Lecture seule [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| virtual [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) | Renvoie le Customer Data Tag spécifié à l'index. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() | Renvoie la collection des Customer Data Tags. Lecture seule [ITagCollection](../itagcollection/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, il se contente d'initialiser un nouvel objet et de permettre la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie réellement rien, il se contente d'initialiser un nouvel objet et de permettre la construction par copie des sous-classes. |
...
| virtual void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) | Définit le Customer Data Tag spécifié à l'index. |
