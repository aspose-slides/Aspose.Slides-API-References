...
---
## Presentation::Save(System::String, Export::SaveFormat) méthode


Enregistre toutes les diapositives d'une presentation dans un fichier avec le format spécifié.
...
## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) méthode


Enregistre toutes les diapositives d'une presentation dans un flux au format spécifié.
...
## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) méthode


Enregistre toutes les diapositives d'une presentation dans un fichier avec le format spécifié et avec des options supplémentaires.
...
L'exemple suivant montre comment convertir PowerPoint en HTML en utilisant C++.
```cpp
// Instancie un objet présentation qui représente un fichier de présentation, par exemple PPT, PPTX, ODP, etc.
...
// Enregistre la présentation en HTML
presentation->Save(u"ConvertWholePresentationToHTML_out.html", SaveFormat::Html, htmlOpt);
```
 L'exemple suivant montre comment convertir PowerPoint en HTML réactif en utilisant C++.
```cpp
...
```
 L'exemple suivant montre comment convertir PowerPoint en HTML avec des notes en utilisant C++.
```cpp
...
```
 L'exemple suivant montre comment convertir PowerPoint en HTML avec les polices originales en utilisant C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Exclut les polices par défaut de la présentation
...
```
 L'exemple suivant montre comment convertir PowerPoint en HTML avec des images de haute qualité à 150 DPI en utilisant C++.
```cpp
...
```
 L'exemple suivant montre comment convertir PowerPoint en HTML avec des images de pleine qualité en utilisant C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
 L'exemple suivant montre comment convertir [Slide](../../slide/) en HTML en utilisant C++.
```cpp
```
...
```
 L'exemple suivant montre comment exporter des fichiers multimédias en HTML en utilisant C++. 
```cpp
