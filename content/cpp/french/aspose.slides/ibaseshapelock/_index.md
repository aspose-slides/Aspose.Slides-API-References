...
Représente [Shape](../shape/) verrou (opération désactivée).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Renvoie vrai si tous les indicateurs de verrouillage sont désactivés. Lecture seule **bool**. |
