...
description: Représente une classe de base pour les verrous (opération désactivée).
type: docs
weight: 157
...
| **bool** [get_NoLocks](./get_nolocks/)() override | Renvoie true si tous les indicateurs de verrouillage sont désactivés. **bool** en lecture seule. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il se contente d'initialiser un nouvel objet et permet la construction de copies dans les sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, en fait, il se contente d'initialiser un nouvel objet et permet la construction de copies dans les sous-classes. |
