...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Renvoie une copie des données audio. En cas de grande quantité de données, envisagez d’utiliser la méthode [IVideo::GetStream](./getstream/) pour éviter le chargement inutile des données vidéo en mémoire ou même une OutOfMemoryException. Lecture-seule **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Renvoie le type MIME d’une vidéo, encodé en [IVideo::get_BinaryData](./get_binarydata/). Lecture-seule [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l’objet. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../../system/object/gethashcode/). Permet le hachage d’objets personnalisés. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Renvoie un flux Stream pour la lecture. Utilisez 'using' ou fermez le flux après utilisation. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, il se contente d’initialiser un nouvel objet et permet la construction de copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie réellement rien, il se contente d’initialiser un nouvel objet et permet la construction de copie des sous-classes. |
