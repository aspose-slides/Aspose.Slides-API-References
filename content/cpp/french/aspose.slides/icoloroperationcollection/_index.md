...
---
## IColorOperationCollection classe
...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Ajoute une nouvelle opération à la fin de la collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Ajoute une nouvelle opération à la fin de la collection. |
...
| virtual void [Clear](./clear/)() | Supprime toutes les opérations de couleur. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Retourne l'opération à l'index spécifié. Lecture [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Définit l'opération à l'index spécifié. Écriture [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Insère la nouvelle opération dans une collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Insère la nouvelle opération dans une collection. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtre une séquence sur le prédicat spécifié. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime l'opération de couleur d'une collection. |
