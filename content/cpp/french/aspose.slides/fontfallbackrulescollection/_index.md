...
description: Représente une collection de règles FontFallBack, définie par l'utilisateur
type: docs
weight: 950
...
| Méthode | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) override | Ajoute une règle FallBack spécifiée à la fin de la collection. |
| [iterator](./iterator/) [begin](./begin/)() | Obtient l'itérateur pointant sur le premier élément (le cas échéant) de la collection. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtient l'itérateur pointant sur le premier élément (le cas échéant) de l'instance de la collection qualifiée const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtient l'itérateur pointant sur le premier élément qualifié const (le cas échéant) de la collection. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>\>, **int32_t**) override | Copie tous les éléments de la collection dans le tableau spécifié. |
...
| **int32_t** [get_Count](./get_count/)() override | Obtient le nombre de règles réellement contenues dans la collection. Lecture seule **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>\>\> [GetEnumerator](./getenumerator/)() override | Renvoie un énumérateur qui parcourt la collection. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../../system/object/gethashcode/). Permet le hachage d'objets personnalisés. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtient le type réel de l'objet. Analogue de l'appel C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtient la règle à l'index spécifié. Lecture seule [IFontFallBackRule](../ifontfallbackrule/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) override | Supprime la première occurrence d'une règle FallBack spécifique de la collection. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtient l'itérateur pointant sur le premier élément (le cas échéant) de l'instance de la collection qualifiée const. |
