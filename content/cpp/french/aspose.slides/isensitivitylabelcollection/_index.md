...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Ajoute le label de sensibilité à la fin de la collection. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) | Ajoute un [SensitivityLabel](../sensitivitylabel/) à la collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtient le nombre de tous les éléments de la collection. Lecture seule **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie le label de sensibilité par index. Lecture seule [ISensitivityLabel](../isensitivitylabel/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime le label de sensibilité à l'index spécifié. |
