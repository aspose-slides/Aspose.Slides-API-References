...
description: Objet immuable qui contient les propriétés de relief de la face de la forme effective.
type: docs
weight: 3667
url: /fr/aspose.slides/ishapebeveleffectivedata/
---
## IShapeBevelEffectiveData classe
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Type de biseau. Lecture seule [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Hauteur du biseau. Lecture seule **double**. |
| virtual **double** [get_Width](./get_width/)() | Largeur du biseau. Lecture seule **double**. |
