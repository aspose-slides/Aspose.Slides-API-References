...
description: Représente la ligne de temps d'animation.
type: docs
weight: 1314
...
Représente la ligne de temps d'animation.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequence](../../aspose.slides.animation/isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) | Renvoie la séquence interactive à l'index spécifié. Cette séquence peut ne contenir que des effets de \"clic sur la forme\" avec la forme cible spécifiée. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequenceCollection](../../aspose.slides.animation/isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() | Renvoie la collection de séquences interactives. Ces séquences peuvent ne contenir que des effets de \"clic sur la forme\" avec la forme cible spécifiée. Lecture seule [Animation::ISequenceCollection](../../aspose.slides.animation/isequencecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequence](../../aspose.slides.animation/isequence/)\> [get_MainSequence](./get_mainsequence/)() | Renvoie la séquence principale qui ne peut contenir que la collection d'effets principaux. Lecture seule [Animation::ISequence](../../aspose.slides.animation/isequence/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::IEffect](../../aspose.slides.animation/ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) | Renvoie l'effet de la séquence principale à l'index spécifié. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ITextAnimation](../../aspose.slides.animation/itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) | Renvoie l'animation de texte à l'index spécifié. |
