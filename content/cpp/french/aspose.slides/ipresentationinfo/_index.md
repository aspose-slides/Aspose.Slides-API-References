...
| Méthode | Description |
| --- | --- |
| virtual **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) | Vérifie si un mot de passe est correct pour une présentation protégée par un mot de passe d'ouverture. |
| virtual **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) | Vérifie si un mot de passe de modification est correct pour une présentation protégée en écriture. |
...
| virtual **bool** [get_IsEncrypted](./get_isencrypted/)() | Renvoie True si la présentation liée est chiffrée, sinon False. Lecture seule **bool**. |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Renvoie une valeur indiquant si la présentation liée est protégée par un mot de passe d'ouverture. |
| virtual [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() | Renvoie une valeur indiquant si la présentation liée est protégée en écriture. |
| virtual [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() | Renvoie le format de la présentation liée. Lecture seule [Slides::LoadFormat](../loadformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() | Renvoie les propriétés du document de la présentation liée. |
...
| virtual void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) | Met à jour les propriétés de la présentation liée. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrémente le compteur de références faibles. Ne doit pas être appelé directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Décrémente le compteur de références faibles. Ne doit pas être appelé directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Écrit la présentation liée dans un flux. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) | Écrit la présentation liée dans un fichier. |
