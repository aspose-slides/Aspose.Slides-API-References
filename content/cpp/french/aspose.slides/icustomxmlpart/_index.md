...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Spécifie un identifiant globalement unique (GUID) qui identifie de manière unique une seule partie XML personnalisée au sein d’un document Office Open XML. Lecture seule [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | Renvoie la collection de schémas XML associés à la partie XML personnalisée. Lecture seule [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | Renvoie les données xml sous forme de chaîne UTF-8. Lecture [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | Renvoie les données xml. Lecture **uint8_t**[]. |
...
| virtual void [Remove](./remove/)() | Supprime la partie XML personnalisée de la présentation. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées de la valeur spécifiée. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Spécifie un identifiant globalement unique (GUID) qui identifie de manière unique une seule partie XML personnalisée au sein d’un document Office Open XML. Lecture seule [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | Définit les données xml sous forme de chaîne UTF-8. Écriture [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Définit les données xml. Écriture **uint8_t**[]. |
