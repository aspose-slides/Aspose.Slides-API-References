...
| virtual void [Clear](./clear/)() | Supprime toutes les propriétés. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Retourne un nombre de propriétés dans la collection. Lecture seule **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::String](../../system/string/)\>\> [get_NamesOfProperties](./get_namesofproperties/)() | Retourne un nombre de propriétés dans la collection. Lecture seule ICollection<string>. |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | Retourne la propriété. |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | Définit la propriété. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Retourne l'élément à un indice spécifié dans une séquence. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Retourne l'élément à un indice spécifié dans une séquence. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise simplement le nouvel objet et permet la construction de copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise simplement le nouvel objet et permet la construction de copie des sous-classes. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Supprime une propriété avec le nom spécifié. |
