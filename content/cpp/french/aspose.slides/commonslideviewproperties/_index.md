...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) override | Renvoie le guide de dessin à l'index spécifié. Lecture seule [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Renvoie la collection des guides de dessin. Lecture seule [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **int32_t** [get_Scale](./get_scale/)() override | Spécifie le ratio de mise à l'échelle de la vue en pourcentage. Lecture **int32_t**. |
| **bool** [get_VariableScale](./get_variablescale/)() override | Spécifie que le contenu de la vue doit être automatiquement mis à l'échelle pour s'adapter au mieux à la taille actuelle de la fenêtre. Lecture **bool**. |
...
| void [set_Scale](./set_scale/)(**int32_t**) override | Spécifie le ratio de mise à l'échelle de la vue en pourcentage. Écriture **int32_t**. |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | Spécifie que le contenu de la vue doit être automatiquement mis à l'échelle pour s'adapter au mieux à la taille actuelle de la fenêtre. Écriture **bool**. |
...
L'exemple suivant montre comment définir la valeur de zoom pour une diapositive PowerPoint [Presentation](../presentation/).
```cpp
...
// Valeur de zoom en pourcentage pour la vue des diapositives
presentation->get_ViewProperties()->get_NotesViewProperties()->set_Scale(100);
// Valeur de zoom en pourcentage pour la vue des notes
