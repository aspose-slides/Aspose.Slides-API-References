...
| virtual [System::String](../../system/string/) [get_OriginalUri](./get_originaluri/)() | URI original de la ressource tel que spécifié dans la présentation importée. |
| virtual [System::String](../../system/string/) [get_Uri](./get_uri/)() | URI de la ressource utilisée pour le téléchargement si [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) renvoie [ResourceLoadingAction::Default](../resourceloadingaction/). Initialement, il est défini sur l'URI original de la ressource, mais peut être redéfini à toute valeur. |
...
| virtual void [set_Uri](./set_uri/)([System::String](../../system/string/)) | URI de la ressource utilisée pour le téléchargement si [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) renvoie [ResourceLoadingAction::Default](../resourceloadingaction/). Initialement, il est défini sur l'URI original de la ressource, mais peut être redéfini à toute valeur. |
| virtual void [SetData](./setdata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Définit les données fournies par l'utilisateur de la ressource qui sont utilisées si [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) renvoie [ResourceLoadingAction::UserProvided](../resourceloadingaction/). |
