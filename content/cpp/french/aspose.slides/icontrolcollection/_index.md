...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [AddControl](./addcontrol/)([ControlType](../controltype/), **float**, **float**, **float**, **float**) | Crée et ajoute un nouveau contrôle à la collection. |
...
| virtual void [Clear](./clear/)() | Supprime tous les contrôles de la collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [idx_get](./idx_get/)(**int32_t**) | Retourne un contrôle à la position spécifiée. |
...
| void [Lock](../../system/object/lock/)() | Met en œuvre le verrouillage de l'instruction C# lock(). Appeler directement ou utiliser l'objet sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>) | Supprime un contrôle ActiveX de la collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime un contrôle ActiveX stocké à la position spécifiée de la collection. |
...
| void [Unlock](../../system/object/unlock/)() | Met en œuvre le déverrouillage de l'instruction C# lock(). Appeler directement ou utiliser l'objet sentry [LockContext](../../system/lockcontext/). |
