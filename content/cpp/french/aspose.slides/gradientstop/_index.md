...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Renvoie la couleur d'un arrêt de gradient. Lecture seule [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Renvoie la position (0..1) d'un arrêt de gradient. Lire **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Définit la position (0..1) d'un arrêt de gradient. Écrire **float**. |
