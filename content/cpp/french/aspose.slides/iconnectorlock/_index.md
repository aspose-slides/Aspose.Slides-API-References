...
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | Détermine si une forme doit conserver le rapport d'aspect lors du redimensionnement. Lecture **bool**. |
...
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | Renvoie vrai si tous les indicateurs de verrouillage sont désactivés. Lecture seule **bool**. |
| virtual **bool** [get_PositionMove](./get_positionmove/)() | Détermine si le déplacement de cette forme est interdit. Lecture **bool**. |
| virtual **bool** [get_RotateLocked](./get_rotatelocked/)() | Détermine si la modification de l'angle de rotation de cette forme est interdite. Lecture **bool**. |
...
| virtual void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) | Détermine si une forme doit conserver le rapport d'aspect lors du redimensionnement. Écriture **bool**. |
...
| virtual void [set_PositionMove](./set_positionmove/)(**bool**) | Détermine si le déplacement de cette forme est interdit. Écriture **bool**. |
| virtual void [set_RotateLocked](./set_rotatelocked/)(**bool**) | Détermine si la modification de l'angle de rotation de cette forme est interdite. Écriture **bool**. |
