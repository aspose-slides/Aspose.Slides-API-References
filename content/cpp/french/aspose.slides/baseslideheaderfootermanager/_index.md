...
description: Représente le gestionnaire qui conserve le comportement des espaces réservés du pied de page, de la date-heure et du numéro de page pour tous les types de diapositive.
type: docs
weight: 183
...
Représente le gestionnaire qui conserve le comportement des espaces réservés du pied de page, de la date-heure et du numéro de page pour tous les types de diapositive.
...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | Obtient la valeur indiquant qu’un espace réservé de date-heure est présent. Lecture **bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | Obtient la valeur indiquant qu’un espace réservé de pied de page est présent. Lecture **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | Obtient la valeur indiquant qu’un espace réservé de numéro de page est présent. Lecture **bool**. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | Définit le texte de l’espace réservé de date-heure de la diapositive. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | Modifie la visibilité de l’espace réservé de date-heure de la diapositive. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | Définit le texte de l’espace réservé du pied de page de la diapositive. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | Modifie la visibilité de l’espace réservé du pied de page de la diapositive. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | Modifie la visibilité de l’espace réservé du numéro de page de la diapositive. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Met en œuvre le constructeur C# typeof([System.Object](../../system/object/)). |
