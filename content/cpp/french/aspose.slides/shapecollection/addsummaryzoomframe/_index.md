...
---
## ShapeCollection::AddSummaryZoomFrame(float, float, float, float) méthode
...
Cette méthode crée un nouveau Summary Zoom et y insère une collection d’objets pour toutes les sections de cette présentation. 

Cet exemple montre comment ajouter un objet Summary Zoom à la fin d’une collection (en supposant qu’il y a au moins deux sections dans la présentation "Presentation.pptx") : 
```cpp
