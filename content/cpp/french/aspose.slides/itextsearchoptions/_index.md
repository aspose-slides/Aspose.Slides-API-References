...
Représente les options pouvant être utilisées pour rechercher du texte dans un [Presentation](../presentation/), [Slide](../slide/) ou [TextFrame](../textframe/).
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Définir true pour utiliser la recherche sensible à la casse, false sinon. Lire **bool**. |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | Définir **true** pour inclure le texte contenu dans les notes de diapositive lors de la recherche de texte, du remplacement ou des opérations de surlignage. La valeur par défaut est **false**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Définir true pour ne correspondre qu'aux mots entiers, false sinon. Lire **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Définir true pour utiliser la recherche sensible à la casse, false sinon. Écrire **bool**. |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | Définir **true** pour inclure le texte contenu dans les notes de diapositive lors de la recherche de texte, du remplacement ou des opérations de surlignage. La valeur par défaut est **false**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Définir true pour ne correspondre qu'aux mots entiers, false sinon. Écrire **bool**. |
