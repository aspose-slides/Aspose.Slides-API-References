...
| [PathCommandType](../pathcommandtype/) [get_PathCommand](./get_pathcommand/)() override | Type de chemin du segment |
| [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_SegmentData](./get_segmentdata/)() override | Données de chemin du segment |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de modèle en tant que pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
...
* Classe [IPathSegment](../ipathsegment/)
