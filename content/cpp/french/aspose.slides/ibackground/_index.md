...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Renvoie un [EffectFormat](../effectformat/) pour le remplissage [BackgroundType::OwnBackground](../backgroundtype/). Lecture seule [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Renvoie un [FillFormat](../fillformat/) pour le remplissage [BackgroundType::OwnBackground](../backgroundtype/). Lecture seule [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Renvoie un [ColorFormat](../colorformat/) pour un remplissage [BackgroundType::Themed](../backgroundtype/). Lecture seule [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Renvoie un index du remplissage [BackgroundType::Themed](../backgroundtype/) dans la collection de thèmes d'arrière-plan. 0 signifie aucun remplissage. 1..999 - index. Lecture **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Renvoie un type de remplissage d'arrière-plan. Lecture [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Obtient les données d'arrière-plan effectives avec l'héritage appliqué. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Renvoie un index du remplissage [BackgroundType::Themed](../backgroundtype/) dans la collection de thèmes d'arrière-plan. 0 signifie aucun remplissage. 1..999 - index. Écriture **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Renvoie un type de remplissage d'arrière-plan. Écriture [BackgroundType](../backgroundtype/). |
