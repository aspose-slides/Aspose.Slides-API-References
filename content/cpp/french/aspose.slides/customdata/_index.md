...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) override | Retourne la partie XML personnalisée à l’index spécifié. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() override | Retourne la collection des parties XML personnalisées. Lecture-seule [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) override | Retourne le tag de données client spécifié à l’index. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() override | Retourne la collection des tags de données client. Lecture-seule [ITagCollection](../itagcollection/). |
...
| void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Définit le tag de données client spécifié à l’index. |
