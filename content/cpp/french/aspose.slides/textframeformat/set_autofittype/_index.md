...
description: Définit le mode d'ajustement automatique du texte. Écrivez TextAutofitType.
type: docs
weight: 235
url: /fr/aspose.slides/textframeformat/set_autofittype/
---
## TextFrameFormat::set_AutofitType(TextAutofitType) méthode


Définit le mode d'ajustement automatique du texte. Écrivez [TextAutofitType](../../textautofittype/).
