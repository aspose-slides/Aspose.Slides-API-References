...
description: Représente un objet pouvant définir en bloc les formats des éléments texte enfants.
type: docs
weight: 1548
...
Représente un objet pouvant définir en bloc les formats des éléments texte enfants.
...
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Définit les propriétés de format de portion définies pour toutes les portions de l'élément. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Définit les propriétés de format de paragraphe définies pour tous les paragraphes de l'élément. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Définit les propriétés de format de cadre de texte définies pour tous les cadres de texte de l'élément. |
