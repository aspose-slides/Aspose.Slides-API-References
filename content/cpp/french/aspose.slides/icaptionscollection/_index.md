...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Ajoute des sous-titres fermés WebVTT à la fin de la collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Ajoute des sous-titres fermés WebVTT à la fin de la collection à partir d'un flux. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtient un itérateur pointant vers le premier élément (s'il existe) de l'instance qualifiée en const de la collection. |
...
| virtual void [Clear](./clear/)() | Supprime tous les sous-titres fermés de la collection. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtient un itérateur pointant juste après le dernier élément (s'il existe) de l'instance qualifiée en const de la collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Renvoie le nombre d'éléments dans la collection. Lecture seule **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie les sous-titres fermés à l'index spécifié. Lecture seule [ICaptions](../icaptions/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, vraiment, il initialise juste un nouvel objet et permet la copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, vraiment, il initialise juste un nouvel objet et permet la copie des sous-classes. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>) | Supprime les sous-titres fermés spécifiés de la collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime les sous-titres fermés à l'index spécifié. |
