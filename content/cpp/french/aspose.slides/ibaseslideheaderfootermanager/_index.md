...
---
## IBaseSlideHeaderFooterManager classe
...
| virtual **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() | Obtient la valeur indiquant qu'un espace réservé date-heure est présent. Lecture**bool**. |
| virtual **bool** [get_IsFooterVisible](./get_isfootervisible/)() | Obtient la valeur indiquant qu'un espace réservé pied de page est présent. Lecture **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() | Obtient la valeur indiquant qu'un espace réservé numéro de page est présent. Lecture**bool**. |
...
| virtual void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) | Définit le texte de l'espace réservé date-heure de la diapositive. |
| virtual void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) | Modifie la visibilité de l'espace réservé date-heure de la diapositive. |
| virtual void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) | Définit le texte de l'espace réservé pied de page de la diapositive. |
| virtual void [SetFooterVisibility](./setfootervisibility/)(**bool**) | Modifie la visibilité de l'espace réservé pied de page de la diapositive. |
| virtual void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) | Modifie la visibilité de l'espace réservé numéro de page de la diapositive. |
