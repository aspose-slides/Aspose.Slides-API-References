...
description: Représente les options pouvant être utilisées pour mettre en évidence du texte dans un cadre de texte.
type: docs
weight: 4109
url: /fr/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions classe


Représente les options qui peuvent être utilisées pour mettre en évidence du texte dans un cadre de texte.
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Définissez true pour utiliser une recherche sensible à la casse, false sinon. Lecture **bool**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Définissez true pour ne correspondre qu'aux mots entiers, false sinon. Lecture **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Définissez true pour utiliser une recherche sensible à la casse, false sinon. Écriture **bool**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Définissez true pour ne correspondre qu'aux mots entiers, false sinon. Écriture **bool**. |
...
Obsolète
:   L'interface [ITextHighlightingOptions](./) sera supprimée après la sortie de la version 24.10.
