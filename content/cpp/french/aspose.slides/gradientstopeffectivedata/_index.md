...
| Méthode | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Détermine si le [GradientStopEffectiveData](./) spécifié est égal au [GradientStopEffectiveData](./) actuel. |
...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Renvoie la couleur d’un arrêt de dégradé. Lecture seule [System::Drawing::Color](../../system.drawing/color/). |
| **float** [get_Position](./get_position/)() override | Renvoie la position (0..1) d’un arrêt de dégradé. Lecture seule **float**. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il ne fait qu’initialiser un nouvel objet et permet la construction par copie de sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, en fait, il ne fait qu’initialiser un nouvel objet et permet la construction par copie de sous-classes. |
...
* Classe [IGradientStopEffectiveData](../igradientstopeffectivedata/)
