...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Renvoie la couleur du guide de dessin. Lire [System::Drawing::Color](../../system.drawing/color/). |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Renvoie l’orientation du guide de dessin. Lire [Slides::Orientation](../orientation/). |
| **float** [get_Position](./get_position/)() override | Renvoie la position du guide de dessin en points depuis le coin supérieur gauche de la diapositive. Lire **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, initialise simplement un nouvel objet et permet de copier-construire les sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, initialise simplement un nouvel objet et permet de copier-construire les sous-classes. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Définit la couleur du guide de dessin. Écrire [System::Drawing::Color](../../system.drawing/color/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | Définit l’orientation du guide de dessin. Écrire [Slides::Orientation](../orientation/). |
| void [set_Position](./set_position/)(**float**) override | Définit la position du guide de dessin en points depuis le coin supérieur gauche de la diapositive. Écrire **float**. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Décrémente le compteur de références faibles. Ne doit pas être appelé directement ; utilisez plutôt les poinnaires intelligents ou ThisProtector. |
