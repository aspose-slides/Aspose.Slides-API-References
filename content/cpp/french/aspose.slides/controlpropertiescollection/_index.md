...
| Méthode | Description |
| --- | --- |
| void [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Ajoute une propriété à la collection. |
...
| void [Clear](./clear/)() override | Supprime toutes les propriétés. |
...
| **int32_t** [get_Count](./get_count/)() override | Renvoie le nombre de propriétés dans la collection. Lecture seule **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::String](../../system/string/)\>\> [get_NamesOfProperties](./get_namesofproperties/)() override | Renvoie la collection des noms de propriétés. Lecture seule ICollection<string>. |
...
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | Renvoie la propriété. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Définit la propriété. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Supprime une propriété avec le nom spécifié. |
