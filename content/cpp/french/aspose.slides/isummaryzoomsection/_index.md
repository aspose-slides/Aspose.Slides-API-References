...
---
## ISummaryZoomSection classe


Représente un objet Summary Zoom [Section](../section/) dans un cadre Summary Zoom.
...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Ajoute un nouveau espace réservé s'il n'existe pas et définit les propriétés de l'espace réservé à une valeur spécifiée. |
...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Renvoie la description texte de l'objet Summary Zoom [Section](../section/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](../ishape/get_effectformat/)() | Renvoie l'objet [EffectFormat](../effectformat/) qui contient les effets pixélisés appliqués à une forme. Lecture seule [IEffectFormat](../ieffectformat/). |
...
| virtual **bool** [get_IsDecorative](../ishape/get_isdecorative/)() | Obtient l'option « Mark as decorative » Lecture/écriture **bool**. |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Renvoie un identifiant unique au niveau de la diapositive qui reste constant pendant la durée de vie de la forme et permet à PowerPoint ou au code d'interop de référencer la forme de façon fiable depuis n'importe où dans le document. Lecture seule **uint32_t**. Voir aussi [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual **bool** [get_ReturnToParent](../izoomobject/get_returntoparent/)() | Obtient le comportement de navigation dans le diaporama. Lecture **bool**. Valeur par défaut : false |
...
| virtual **bool** [get_ShowBackground](../izoomobject/get_showbackground/)() | Obtient la valeur qui indique si le Zoom utilisera l'arrière-plan de la diapositive de destination. Lecture **bool**. Valeur par défaut : true |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../isectionzoomframe/get_targetsection/)() | Obtient l'objet section auquel l'objet Zoom [Section](../section/) est lié. Lire [ISection](../isection/). |
...
| virtual [System::String](../../system/string/) [get_Title](./get_title/)() | Renvoie le texte titre de l'objet Summary Zoom [Section](../section/). |
| virtual **float** [get_TransitionDuration](../izoomobject/get_transitionduration/)() | Obtient la durée de la transition entre le Zoom et la diapositive. Lecture **float**. Valeur par défaut : 1.0f |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Renvoie un identifiant interne, limité à la présentation, destiné à être utilisé par les add-ins ou autre code. Étant donné que cette valeur peut être réassignée par l'utilisateur ou programmatique, elle ne doit pas être considérée comme une clé unique persistante. Lecture seule **uint32_t**. Voir aussi [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Renvoie une forme d'espace réservé de base (forme provenant de la disposition et/ou de la diapositive maîtresse dont la forme actuelle hérite). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../../system/object/gethashcode/). Permet le hachage d'objets personnalisés. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../ishape/getimage/)() | Renvoie la miniature de la forme. Le type de limites de la miniature de forme [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) est utilisé par défaut. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, il initialise simplement le nouvel objet et autorise la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie réellement rien, il initialise simplement le nouvel objet et autorise la construction par copie des sous-classes. |
...
| virtual void [set_Description](./set_description/)([System::String](../../system/string/)) | Renvoie la description texte de l'objet Summary Zoom [Section](../section/). |
...
| virtual void [set_ImageType](../izoomobject/set_imagetype/)([ZoomImageType](../zoomimagetype/)) | Définit le type d'image d'un objet zoom. Écriture [ZoomImageType](../zoomimagetype/). Valeur par défaut : Preview |
| virtual void [set_IsDecorative](../ishape/set_isdecorative/)(**bool**) | Définit l'option « Mark as decorative » Lecture/écriture **bool**. |
...
| virtual void [set_ReturnToParent](../izoomobject/set_returntoparent/)(**bool**) | Définit le comportement de navigation dans le diaporama. Écriture **bool**. Valeur par défaut : false |
...
| virtual void [set_ShowBackground](../izoomobject/set_showbackground/)(**bool**) | Définit la valeur qui indique si le Zoom utilisera l'arrière-plan de la diapositive de destination. Écriture **bool**. Valeur par défaut : true |
| virtual void [set_TargetSection](../isectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Définit l'objet section auquel l'objet Zoom [Section](../section/) est lié. Écriture [ISection](../isection/). |
| virtual void [set_Title](./set_title/)([System::String](../../system/string/)) | Renvoie le titre texte de l'objet Summary Zoom [Section](../section/). |
| virtual void [set_TransitionDuration](../izoomobject/set_transitionduration/)(**float**) | Définit la durée de la transition entre le Zoom et la diapositive. Écriture **float**. Valeur par défaut : 1.0f |
...
| virtual void [set_ZoomImage](../izoomobject/set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Définit l'image pour l'objet zoom. Écriture [IPPImage](../ippimage/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définir le n-ième argument de modèle comme un pointeur faible (plutôt que partagé). Autorise le passage des pointeurs dans les conteneurs en mode faible. |
| int [SharedCount](../../system/object/sharedcount/)() const | Obtient la valeur actuelle du compteur de références partagées. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrémente le compteur de références partagées. Ne doit pas être appelé directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Décrémentе le compteur de références partagées et le renvoie. Ne doit pas être appelé directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
