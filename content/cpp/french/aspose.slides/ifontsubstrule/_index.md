...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_DestFont](./get_destfont/)() | Police à utiliser pour la substitution en lecture seule [IFontData](../ifontdata/). |
| virtual [FontSubstCondition](../fontsubstcondition/) [get_ReplaceFontCondition](./get_replacefontcondition/)() | Règle à appliquer pour la substitution en lecture seule [FontSubstCondition](../fontsubstcondition/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_SourceFont](./get_sourcefont/)() | Police à substituer en lecture seule [IFontData](../ifontdata/). |
