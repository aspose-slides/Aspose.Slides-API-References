...
description: Représente des options pouvant être utilisées pour spécifier un comportement supplémentaire des feuilles de calcul.
type: docs
weight: 3862
url: /fr/aspose.slides/ispreadsheetoptions/
---
## ISpreadsheetOptions classe
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | Obtient les informations de culture préférées pour calculer certaines fonctions destinées à une utilisation avec des langues qui utilisent le jeu de caractères double octet (DBCS). |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | Si la source de données pour le graphique provient d’un classeur externe et qu’elle n’est pas disponible, elle sera récupérée depuis le cache du graphique. |
...
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | Définit les informations de culture préférées pour calculer certaines fonctions destinées à une utilisation avec des langues qui utilisent le jeu de caractères double octet (DBCS). |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | Si la source de données pour le graphique provient d’un classeur externe et qu’elle n’est pas disponible, elle sera récupérée depuis le cache du graphique. |
