...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Renvoie la copie des données d'un audio. En cas de grande quantité de données, envisagez d'utiliser la méthode [Video::GetStream](./getstream/) pour éviter le chargement inutile des données vidéo en mémoire ou même une OutOfMemoryException. Lecture seule **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Renvoie le type MIME d'une vidéo, encodé en [Video::get_BinaryData](./get_binarydata/). Lecture seule [System::String](../../system/string/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie réellement rien, il initialise simplement un nouvel objet et permet la copie des sous-classes. |
