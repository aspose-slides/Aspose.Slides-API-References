...
| [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() override | Renvoie le type de remplissage. Lecture [Slides::FillType](../filltype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() override | Renvoie le format de remplissage en dégradé. Lecture seule [IGradientFormat](../igradientformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() override | Renvoie le format de remplissage de motif. Lecture seule [IPatternFormat](../ipatternformat/). |
| [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() override | Détermine si le remplissage doit être tourné avec une forme. Lecture [NullableBool](../nullablebool/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() override | Renvoie la couleur d'un remplissage plein. Lecture seule [IColorFormat](../icolorformat/). |
...
| void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) override | Définit le type de remplissage. Écriture [Slides::FillType](../filltype/). |
| void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) override | Détermine si le remplissage doit être tourné avec une forme. Écriture [NullableBool](../nullablebool/). |
