...
description: Retourne des objets Thumbnail Image pour toutes les diapositives d'une présentation.
type: docs
weight: 417
...
Retourne des objets Thumbnail Image pour toutes les diapositives d'une présentation.
...
Retourne des objets Thumbnail Bitmap pour les diapositives spécifiées d'une présentation.
...
Retourne des objets Thumbnail Image pour toutes les diapositives d'une présentation avec un redimensionnement personnalisé.
...
Retourne des objets Thumbnail Image pour les diapositives spécifiées d'une présentation avec un redimensionnement personnalisé.
...
Retourne des objets Thumbnail Image pour toutes les diapositives d'une présentation avec une taille spécifiée.
...
Retourne des objets Thumbnail Image pour les diapositives spécifiées d'une présentation avec une taille spécifiée.
