...
| Méthode | Description |
| --- | --- |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) | Crée une copie de la ligne modèle spécifiée et l'insère au bas d'un tableau. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtient l'itérateur pointant vers le premier élément (le cas échéant) de l'instance qualifiée const de la collection. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtient l'itérateur pointant juste après le dernier élément (le cas échéant) de l'instance qualifiée const de la collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Renvoie la racine de synchronisation. Lecture seule [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [idx_get](./idx_get/)(**int32_t**) | Obtient l'élément à l'index spécifié. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) | Crée une copie de la ligne modèle spécifiée et l'insère à la position spécifiée dans un tableau. |
...
| void [Lock](../../system/object/lock/)() | Implémente le verrouillage de l'instruction C# lock(). Appeler directement ou utiliser l'objet sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**, **bool**) | Supprime une ligne à la position spécifiée d'un tableau. |
...
| void [Unlock](../../system/object/unlock/)() | Implémente le déverrouillage de l'instruction C# lock(). Appeler directement ou utiliser l'objet sentry [LockContext](../../system/lockcontext/). |
