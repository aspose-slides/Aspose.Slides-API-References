...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) | Renvoie la première diapositive de mise en page du type spécifié. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie la diapositive de mise en page par indice. Lecture seule [ILayoutSlide](../ilayoutslide/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Supprime une mise en page de la collection. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées du nombre spécifié. |
| virtual void [RemoveUnused](./removeunused/)() | Supprime les diapositives de mise en page inutilisées (diapositives dont HasDependingSlides est false). |
