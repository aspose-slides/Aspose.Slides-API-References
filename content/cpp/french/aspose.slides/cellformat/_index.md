...
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderBottom](./get_borderbottom/)() override | Renvoie un objet de propriétés de ligne de bord inférieur. Lecture seule [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() override | Renvoie un objet de propriétés de ligne diagonale du coin supérieur gauche au coin inférieur droit. Lecture seule [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() override | Renvoie un objet de propriétés de ligne diagonale du coin inférieur gauche au coin supérieur droit. Lecture seule [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderLeft](./get_borderleft/)() override | Renvoie un objet de propriétés de ligne de bord gauche. Lecture seule [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderRight](./get_borderright/)() override | Renvoie un objet de propriétés de ligne de bord droit. Lecture seule [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderTop](./get_bordertop/)() override | Renvoie un objet de propriétés de ligne de bord supérieur. Lecture seule [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Renvoie un objet de propriétés de remplissage de cellule. Lecture seule [IFillFormat](../ifillformat/). |
...
| **float** [get_Transparency](./get_transparency/)() override | Obtient la transparence de la couleur de remplissage. Lecture **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICellFormatEffectiveData](../icellformateffectivedata/)\> [GetEffective](./geteffective/)() override | Obtient les propriétés de formatage effectif de la cellule de tableau avec héritage et styles de tableau appliqués. |
...
| void [set_Transparency](./set_transparency/)(**float**) override | Définit la transparence de la couleur de remplissage. Écriture **float**. |
