...
description: "TargetInvocationException est levée par des méthodes invoquées via la réflexion. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe TargetInvocationException à la place. Ne placez jamais les instances de la classe TargetInvocationException dans System::SmartPtr."
type: docs
weight: 79
url: /fr/system.reflection/details_targetinvocationexception/
---
## Details_TargetInvocationException classe


TargetInvocationException est levée par des méthodes invoquées via la réflexion. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe TargetInvocationException à la place. Ne placez jamais les instances de la classe TargetInvocationException dans [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_applicationexception/gettype/)() const override | Obtient le type réel de l'objet. Analogue de l'appel C# [System.Object.GetType()](../../system/object/gettype/). |
...
* Classe [Details_ApplicationException](../../system/details_applicationexception/)
