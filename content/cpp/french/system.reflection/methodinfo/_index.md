...
description: Représente les informations sur une méthode de classe.
type: docs
weight: 131
url: /fr/system.reflection/methodinfo/
---
## MethodInfo classe

Représente les informations sur une méthode de classe.
...
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | Obtient le nom complet du membre. Peut être différent dans les parties implémentées manuellement. |
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Obtient une valeur MemberTypes indiquant que ce membre est une méthode. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | Renvoie un tableau contenant les objets qui représentent toutes les attributs personnalisés appliqués au type représenté par l'objet actuel. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | Renvoie un tableau contenant les objets qui représentent toutes les attributs personnalisés appliqués au type représenté par l'objet actuel. |
...
|  [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | Initialise une nouvelle instance de la classe [MethodInfo](./). |
|  [Object](../../system/object/object/)() | Crée l'objet. Initialise toutes les structures de données internes. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, il se contente d'initialiser un nouvel objet et d'activer la copie lors de la construction des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie réellement rien, il se contente d'initialiser un nouvel objet et d'activer la copie lors de la construction des sous-classes. |
