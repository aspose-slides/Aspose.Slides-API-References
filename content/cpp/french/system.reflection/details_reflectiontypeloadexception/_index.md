...
description: "ReflectionTypeLoadException est levée par la méthode Module.GetTypes si l'une des classes d'un module ne peut pas être chargée. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe ReflectionTypeLoadException. Ne placez jamais les instances de la classe ReflectionTypeLoadException dans System::SmartPtr."
type: docs
weight: 66
url: /fr/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException classe


ReflectionTypeLoadException est levée par la méthode Module.GetTypes si l’une des classes d’un module ne peut pas être chargée. Ne créez jamais d’instances de cette classe manuellement. Utilisez plutôt la classe ReflectionTypeLoadException. N’enveloppez jamais les instances de la classe ReflectionTypeLoadException dans [System::SmartPtr](../../system/smartptr/).
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | Renvoie les exceptions à l’origine de cette exception. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | Renvoie les informations de type des causes de l’exception. |
