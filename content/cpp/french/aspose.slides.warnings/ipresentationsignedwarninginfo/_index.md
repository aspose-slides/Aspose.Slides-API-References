...
description: Cet avertissement indique que la présentation lue possède une signature et que cette signature sera supprimée lors du traitement.
type: docs
weight: 40
...
Cet avertissement indique que la présentation lue possède une signature et que cette signature sera supprimée lors du traitement.
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Si le récepteur n'est pas nul, termine l'avertissement à un récepteur spécifié et lance l'AbortRequestedException si le récepteur décide d'interrompre une opération. |
