...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Renvoie une description lisible de cet avertissement. Lecture seule [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Renvoie le type d'avertissement. Lecture seule [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Si le récepteur n'est pas nul, termine l'avertissement vers le récepteur spécifié et lève l'exception AbortRequestedException si le récepteur décide d'annuler une opération. |
