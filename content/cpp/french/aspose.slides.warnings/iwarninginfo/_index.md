...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Renvoie une description lisible par l’homme de cet avertissement. Lecture seule [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Renvoie un type d’avertissement. Lecture seule [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Si le récepteur n’est pas nul, termine l’avertissement pour un récepteur spécifié et lève l’exception AbortRequestedException si le récepteur décide d’annuler l’opération. |
