...
description: Vecteur 2D avec des composantes double
type: docs
weight: 66
url: /fr/aspose.slides.drawing/vector2d64d/
---
## Vector2d64d classe


Vecteur 2D avec des composantes **double** 
...
| Méthode | Description |
| --- | --- |
| **double** [Dot](./dot/)([Vector2d64d](./)) | Calcule le produit scalaire de deux vecteurs. |
...
| **double** [get_Length](./get_length/)() | Obtient la longueur scalaire du vecteur. Lecture seule **double**. |
| [Vector2d64d](./) [get_Norm](./get_norm/)() | Obtient le vecteur normal. Lecture seule [Vector2d64d](./). |
...
| [Vector2d64d](./) [Normalize](./normalize/)() | Crée un vecteur colinéaire de longueur = 1. Ce vecteur ne doit pas avoir une longueur nulle. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr\_t) | Compare par référence un objet de type valeur avec nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr\_t) | Spécialisation de [Object::ReferenceEquals](../../system/object/referenceequals/) pour le cas d’une chaîne et nullptr. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Analogue de la méthode C# [Object.ToString()](../../system/object/tostring/). Permet la conversion d’objets personnalisés en chaîne. |
| [Vector2d32f](../vector2d32f/) [ToVector2d32f](./tovector2d32f/)() | Vers [Vector2d32f](../vector2d32f/) |
...
|  [Vector2d64d](./vector2d64d/)(**double**, **double**) | Constructeur |
|  [Vector2d64d](./vector2d64d/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Constructeur |
