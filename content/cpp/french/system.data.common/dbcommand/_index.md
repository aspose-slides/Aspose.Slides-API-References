...
description: "Commande de base de données. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 1
url: /fr/system.data.common/dbcommand/
---
## DbCommand classe
...
| virtual int [ExecuteNonQuery](./executenonquery/)() | Exécute une commande qui ne renvoie pas de résultats. |
| virtual [SharedPtr](../../system/sharedptr/)\<[DbDataReader](../dbdatareader/)\> [ExecuteReader](./executereader/)() | Exécute une commande de requête. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | À usage interne uniquement. |
| virtual [String](../../system/string/) [get_CommandText](./get_commandtext/)() const | Informations RTTI. |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Data::Common::DbConnection](../dbconnection/)\> [get_Connection](./get_connection/)() const | Obtient la connexion à la base de données associée à la commande. |
...
| virtual void [set_CommandText](./set_commandtext/)([String](../../system/string/)) const | Définit le texte de la commande DB. |
| virtual void [set_Connection](./set_connection/)([SharedPtr](../../system/sharedptr/)\<[System::Data::Common::DbConnection](../dbconnection/)\>) | Obtient la connexion à la base de données associée à la commande. |
