...
description: "Connexion à la base de données. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 14
url: /fr/system.data.common/dbconnection/
---
## DbConnection classe
...
| virtual [String](../../system/string/) [get_ConnectionString](./get_connectionstring/)() const | Informations RTTI. |
...
| virtual void [Open](./open/)() | Ouvre la connexion à la base de données. |
...
| virtual void [set_ConnectionString](./set_connectionstring/)([String](../../system/string/)) const | Définit les informations de connexion (p. ex. serveur et port). |
