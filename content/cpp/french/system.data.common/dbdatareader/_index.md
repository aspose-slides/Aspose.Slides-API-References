...
description: "API pour recevoir des données depuis la base de données. Les objets de cette classe doivent être alloués uniquement en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des fautes d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en tant qu'argument."
type: docs
weight: 40
url: /fr/system.data.common/dbdatareader/
---
## DbDataReader classe
...
| Method | Description |
| --- | --- |
| virtual void [Close](./close/)() | Ferme le canal de récupération de données. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Obtient l'élément nommé. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(int) | Obtient l'élément par indice. |
...
| virtual **bool** [Read](./read/)() | Lit l'enregistrement suivant depuis la base de données. |
