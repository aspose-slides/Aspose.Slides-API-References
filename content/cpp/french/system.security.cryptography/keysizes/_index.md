...
| int [get_MaxSize](./get_maxsize/)() const | Obtient la taille maximale de clé valide. |
| int [get_MinSize](./get_minsize/)() const | Obtient la taille minimale de clé valide. |
| int [get_SkipSize](./get_skipsize/)() const | Obtient le pas de taille de clé valide. |
...
|  [KeySizes](./keysizes/)(int, int, int) | Informations RTTI. |
