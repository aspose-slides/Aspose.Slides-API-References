...
description: "Classe de base pour les déformateurs de signature asymétriques. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en tant qu'argument."
type: docs
weight: 27
url: /fr/system.security.cryptography/asymmetricsignaturedeformatter/
---
...
| virtual void [SetHashAlgorithm](./sethashalgorithm/)([System::String](../../system/string/)) | Définit l'algorithme de hachage associé au déformateur. |
| virtual void [SetKey](./setkey/)([System::SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](../asymmetricalgorithm/)\>) | Définit la clé à utiliser avec l'algorithme. |
...
| virtual **bool** [VerifySignature](./verifysignature/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Vérifie la signature sur les données. |
| virtual **bool** [VerifySignature](./verifysignature/)([System::SharedPtr](../../system/sharedptr/)\<[HashAlgorithm](../hashalgorithm/)\>, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Vérifie la signature sur les données. Non implémenté. |
