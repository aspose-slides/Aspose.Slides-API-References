...
| virtual void [GenerateIV](../symmetricalgorithm/generateiv/)() | Génère une valeur initiale aléatoire pour l'algorithme. Remplace celle existante (le cas échéant). |
| virtual void [GenerateKey](../symmetricalgorithm/generatekey/)() | Génère une clé aléatoire pour l'algorithme. Remplace celle existante (le cas échéant). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_IV](../symmetricalgorithm/get_iv/)() | Obtient la valeur initiale de l'opération cryptographique. En crée une nouvelle si elle n'a pas encore été créée. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Key](../symmetricalgorithm/get_key/)() | Obtient la clé de l'opération cryptographique. En crée une nouvelle si elle n'a pas encore été créée. |
...
| virtual void [set_Padding](../symmetricalgorithm/set_padding/)([PaddingMode](../paddingmode/)) | Définit le remplissage (padding) de l'opération cryptographique. |
