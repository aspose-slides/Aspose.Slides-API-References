...
description: "Structure de données des paramètres de l'algorithme RSA. Ce type doit être alloué sur la pile et passé aux fonctions par valeur ou par référence. N'utilisez jamais la classe System::SmartPtr pour gérer les objets de ce type."
type: docs
weight: 768
url: /fr/system.security.cryptography/rsaparameters/
---
## RSAParameters struct

[Data](../../system.data/) structure des paramètres d'algorithme [RSA](../rsa/). Ce type doit être alloué sur la pile et passé aux fonctions par valeur ou par référence. N'utilisez jamais la classe [System::SmartPtr](../../system/smartptr/) pour gérer les objets de ce type.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres à virgule flottante de style C# où deux NaN sont considérés égaux bien que, selon la IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres à virgule flottante de style C# où deux NaN sont considérés égaux bien que, selon la IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
...
|  [RSAParameters](./rsaparameters/)() | Constructeur. |
