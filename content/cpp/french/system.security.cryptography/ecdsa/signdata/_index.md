...
type: docs
weight: 79
url: /fr/system.security.cryptography/ecdsa/signdata/
---
## ECDsa::SignData(const ByteArrayPtr\&, const HashAlgorithmName\&) méthode
...
## ECDsa::SignData(const ByteArrayPtr\&, int32_t, int32_t, const HashAlgorithmName\&) méthode
...
## ECDsa::SignData(const StreamPtr\&, const HashAlgorithmName\&) méthode
