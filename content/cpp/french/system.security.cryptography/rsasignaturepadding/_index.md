...
description: Mode de remplissage et paramètres pour les opérations de création ou de vérification de signature RSA.
type: docs
weight: 521
url: /fr/system.security.cryptography/rsasignaturepadding/
---
## RSASignaturePadding classe


Mode de remplissage et paramètres pour les opérations de création ou de vérification de signature [RSA](../rsa/).
...
| [RSASignaturePaddingMode](../rsasignaturepaddingmode/) [get_Mode](./get_mode/)() const | Obtient le mode de remplissage. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pkcs1](./get_pkcs1/)() | Obtient le mode PKCS #1 v1.5. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pss](./get_pss/)() | Obtient le mode PSS. |
