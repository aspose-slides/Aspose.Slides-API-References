...
description: "Code d'authentification de message basé sur un hachage utilisant la fonction de hachage SHA1. Non implémenté. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne jamais créer d'instance de ce type sur la pile ou avec l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Toujours envelopper cette classe dans un pointeur System::SmartPtr et utiliser ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 248
url: /fr/system.security.cryptography/hmacsha1/
---
## Classe HMACSHA1

Code de message basé sur le hachage [Authentication](../../system.security.authentication/) qui utilise la fonction de hachage [SHA1](../sha1/). Non implémenté. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne jamais créer une instance de ce type sur la pile ou avec l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des échecs d’assertion. Enveloppez toujours cette classe dans le pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument.
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Hache une tranche de tampon. |
...
| static [SharedPtr](../../system/sharedptr/)\<[HashAlgorithm](../hashalgorithm/)\> [Create](../hashalgorithm/create/)(const [String](../../system/string/)\&) | Crée un algorithme de hachage basé sur le nom. |
...
|  [HMACSHA1](./hmacsha1/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Constructeur. |
