...
description: "Identifiant d'objet cryptographique. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 339
url: /fr/system.security.cryptography/oid/
---
## Classe Oid
...
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromFriendlyName](./fromfriendlyname/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Crée un objet OID à partir du nom convivial OID spécifié. |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromOidValue](./fromoidvalue/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Crée un objet OID à partir de la valeur OID spécifiée. |
| [String](../../system/string/) [get_FriendlyName](./get_friendlyname/)() const | Obtient le nom convivial de l'objet. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Obtient la chaîne d'identifiant de l'objet. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie en réalité rien, il initialise simplement un nouvel objet et permet la construction de copie des sous-classes. |
|  [Oid](./oid/)() | Constructeur par défaut. |
|  [Oid](./oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](./)\>\&) | Constructeur de copie. |
|  [Oid](./oid/)(const [String](../../system/string/)\&) | Constructeur. |
|  [Oid](./oid/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Constructeur. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie en réalité rien, il initialise simplement un nouvel objet et permet la construction de copie des sous-classes. |
...
| void [set_FriendlyName](./set_friendlyname/)(const [String](../../system/string/)\&) | Définit le nom convivial de l'objet. |
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Définit la chaîne d'identifiant de l'objet. |
