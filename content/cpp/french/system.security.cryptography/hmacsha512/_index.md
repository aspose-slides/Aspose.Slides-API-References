...
description: "Code d'authentification de message basé sur le hachage qui utilise la fonction de hachage SHA512. Partiellement implémenté. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en argument."
type: docs
weight: 261
url: /fr/system.security.cryptography/hmacsha512/
---
## HMACSHA512 classe
...
| Méthode | Description |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Calcule [HMAC](../hmac/). |
...
|  [HMACSHA512](./hmacsha512/)() | Constructeur. |
|  [HMACSHA512](./hmacsha512/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Constructeur. |
| virtual void [Initialize](../hashalgorithm/initialize/)() | Réinitialise le hacheur à l'état initial. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ème argument de modèle comme un pointeur faible (plutôt que partagé). Permet de passer les pointeurs des conteneurs en mode faible. |
