...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | Lit le flux jusqu'à la fin et calcule le hachage pour les données lues. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](./)\> [Create](./create/)() | Crée une instance d'algorithme de hachage. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Crée une instance d'algorithme de hachage. |
...
| virtual void [Initialize](../hashalgorithm/initialize/)() | Réinitialise le hachoir à son état initial. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie réellement rien, il initialise simplement le nouvel objet et permet la construction par copie des sous-classes. |
