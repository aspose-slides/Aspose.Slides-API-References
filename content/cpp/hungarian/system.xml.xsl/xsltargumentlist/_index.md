...
description: Változó számú argumentumot tartalmaz, amelyek XSLT paraméterek vagy kiterjesztési objektumok lehetnek.
type: docs
weight: 66
url: /hu/system.xml.xsl/xsltargumentlist/
---
## XsltArgumentList osztály

Tartalmaz változó számú argumentumot, amelyek XSLT paraméterek vagy kiterjesztési objektumok.
...
| Method | Leírás |
| --- | --- |
| void [AddExtensionObject](./addextensionobject/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Új objektumot ad a [XsltArgumentList](./)-hez, és társítja a névtér URI-hoz. |
| void [AddParam](./addparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Paramétert ad a [XsltArgumentList](./)-hoz, és társítja a névtér minősített nevéhez. |
| void [Clear](./clear/)() | Eltávolítja az összes paramétert és kiterjesztési objektumot a [XsltArgumentList](./)-ból. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetExtensionObject](./getextensionobject/)(const [String](../../system/string/)\&) | Visszaadja a megadott névtérhez társított objektumot. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) metódus analógja. Lehetővé teszi az egyedi objektumok hash-elését. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetParam](./getparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Visszaadja a névtér minősített nevéhez társított paramétert. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveExtensionObject](./removeextensionobject/)(const [String](../../system/string/)\&) | Eltávolítja a [XsltArgumentList](./)-ból a névtér URI-jával rendelkező objektumot. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveParam](./removeparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Eltávolítja a paramétert a [XsltArgumentList](./)-ból. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonparamétert gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók módosítását konténerekben gyenge módra. |
...
|  [XsltArgumentList](./xsltargumentlist/)() | Megvalósít egy új példányt a [XsltArgumentList](./)-ból. |
