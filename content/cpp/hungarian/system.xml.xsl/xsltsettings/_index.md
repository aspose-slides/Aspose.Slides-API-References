...
description: Megadja az XSLT stíluslap végrehajtása során támogatandó XSLT funkciókat.
type: docs
weight: 118
url: /hu/system.xml.xsl/xsltsettings/
---
## XsltSettings osztály

Megadja a XSLT futtatása során támogatandó XSLT funkciókat.
...
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_Default](./get_default/)() | Visszaad egy [XsltSettings](./) objektumot alapértelmezett beállításokkal. Az XSLT **document()** függvény és a beágyazott szkript blokkok támogatása le van tiltva. |
| **bool** [get_EnableDocumentFunction](./get_enabledocumentfunction/)() | Visszaad egy értéket, amely jelzi, hogy engedélyezve van-e az XSLT **document()** függvény támogatása. |
| **bool** [get_EnableScript](./get_enablescript/)() | Visszaad egy értéket, amely jelzi, hogy engedélyezve van-e a beágyazott szkript blokkok támogatása. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_TrustedXslt](./get_trustedxslt/)() | Visszaad egy [XsltSettings](./) objektumot, amely lehetővé teszi az XSLT **document()** függvény és a beágyazott szkript blokkok támogatását. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia szerinti összehasonlítás egy érték típusú objektummal és a nullptr értékkel. |
...
| void [set_EnableDocumentFunction](./set_enabledocumentfunction/)(**bool**) | Beállít egy értéket, amely jelzi, hogy engedélyezve van-e az XSLT **document()** függvény támogatása. |
| void [set_EnableScript](./set_enablescript/)(**bool**) | Beállít egy értéket, amely jelzi, hogy engedélyezve van-e a beágyazott szkript blokkok támogatása. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók konténerekben gyenge módra váltását. |
...
|  [XsltSettings](./xsltsettings/)() | Inicializál egy új példányt a [XsltSettings](./) osztályból alapértelmezett beállításokkal. |
|  [XsltSettings](./xsltsettings/)(**bool**, **bool**) | Inicializál egy új példányt a [XsltSettings](./) osztályból a megadott beállításokkal. |
...
Az osztály objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból veremben vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat okozhat. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és ezt a mutatót használja az objektum átvitelére függvények argumentumaként. 
