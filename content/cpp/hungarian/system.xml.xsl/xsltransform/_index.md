...
description: Átalakítja az XML adatokat egy Extensible Stylesheet Language for Transformations (XSLT) stíluslap használatával.
type: docs
weight: 105
url: /hu/system.xml.xsl/xsltransform/
---
## XslTransform osztály

Az XML adatokat egy Extensible Stylesheet Language for Transformations (XSLT) stíluslap segítségével alakítja át.
...
Az osztály példányait csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányokat a veremben vagy az new operátorral, mivel ez futásidejű hibákat és/vagy állítási hibákat okozhat. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az argumentumként történő függvényhívásokhoz. 
