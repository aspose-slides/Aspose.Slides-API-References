...
| Metódus | Leírás |
| --- | --- |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Hozzáad egy rögzítést az egyezéshez. |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | Hozzáad egy csoportot az egyezéshez. |
...
| [CaptureCollectionPtr](../capturecollectionptr/) [get_Captures](../group/get_captures/)() | Lekéri a rendelkezésre álló rögzítéseket. |
| static [MatchPtr](../matchptr/) [get_Empty](./get_empty/)() | Üres egyezés hozzáférő. |
| [GroupCollectionPtr](../groupcollectionptr/) [get_Groups](./get_groups/)() | Lekéri a csoportlista. |
...
| **bool** [get_Success](../group/get_success/)() | Ellenőrzi, hogy a rögzítés sikeres volt-e ehhez a csoporthoz. |
...
|  [Group](../group/group/)() | Üres csoport konstruktora. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum egy példány-e a targetType által leírt típusban. A C# 'is' operátor analógiája. |
...
| [MatchPtr](../matchptr/) [NextMatch](./nextmatch/)() | Iteráció az egyezéseken. |
...
| virtual [String](../../system/string/) [Result](./result/)(const [String](../../system/string/)\&) | Formázza a karakterláncot a rész-egyezés hivatkozások értékeivel való helyettesítéssel. |
| void [SetMappedIndexes](./setmappedindexes/)(const std::vector\<int\>\&) |  |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóvá (a shared helyett) állítja. Lehetővé teszi a mutatók átkapcsolását konténerekben gyenge módra. |
