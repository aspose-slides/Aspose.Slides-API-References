...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | Visszaad egy interaktív szekvenciát a megadott indexnél. Ez a szekvencia csak \"click on shape\" hatásokat tartalmazhat, meghatározott célalakzattal. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequenceCollection](../isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() override | Visszaad egy interaktív szekvenciák gyűjteményét. Ezek a szekvenciák csak \"click on shape\" hatásokat tartalmazhatnak, meghatározott célalakzattal. Írásvédett [ISequenceCollection](../isequencecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | Visszaadja a fő szekvenciát, amely csak a fő effektusok gyűjteményét tartalmazhatja. Írásvédett [ISequence](../isequence/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | Visszaad egy hatást a fő szekvenciából a megadott indexnél. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | Visszaad szöveganimációt a megadott indexnél. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | Visszaadja a szöveganimációk gyűjteményét. Írásvédett [ITextAnimationCollection](../itextanimationcollection/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot referenciával hasonlít a nullptr-hoz. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Speciális eset a [Object::ReferenceEquals](../../system/object/referenceequals/) számára string és nullptr esetén. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Speciális eset a [Object::ReferenceEquals](../../system/object/referenceequals/) számára stringek esetén. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók tartályokban való gyenge módban történő átkapcsolását. |
...
* Osztály [IAnimationTimeLine](../../aspose.slides/ianimationtimeline/)
