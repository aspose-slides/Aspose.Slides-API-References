...
description: Az effektus forgatási viselkedését ábrázolja.
type: docs
weight: 534
...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | Ábrázolja, hogy az animációs viselkedések felhalmozódnak-e. Olvasd [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | Ábrázolja, hogy a jelenlegi animációs viselkedés össze van-e kombinálva más futó animációkkal. Olvasd [BehaviorAdditiveType](../behavioradditivetype/). |
| **float** [get_By](./get_by/)() override | Leírja az animáció relatív eltolási értékét. Olvasd **float**. |
| **float** [get_From](./get_from/)() override | Leírja az animáció kezdeti értékét. Olvasd **float**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](../behavior/get_properties/)() override | Representálja a viselkedés tulajdonságait. Csak olvasható [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Ábrázolja a hatás viselkedés időzítési tulajdonságait. Olvasd [ITiming](../itiming/). |
| **float** [get_To](./get_to/)() override | Leírja az animáció befejezési értékét. Olvasd **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekérdezi az objektummal kapcsolatos referenciaszámláló adatstruktúrát. |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Ábrázolja, hogy az animációs viselkedések felhalmozódnak-e. Írd [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Ábrázolja, hogy a jelenlegi animációs viselkedés össze van-e kombinálva más futó animációkkal. Írd [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_By](./set_by/)(**float**) override | Leírja az animáció relatív eltolási értékét. Írd **float**. |
| void [set_From](./set_from/)(**float**) override | Leírja az animáció kezdeti értékét. Írd **float**. |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Ábrázolja a hatás viselkedés időzítési tulajdonságait. Írd [ITiming](../itiming/). |
| void [set_To](./set_to/)(**float**) override | Leírja az animáció befejezési értékét. Írd **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonparamétert gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását a tárolókban gyenge módra. |
...
* Osztály [IRotationEffect](../irotationeffect/)
