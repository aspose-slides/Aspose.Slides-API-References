...
| Módszer | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[TextAnimation](../textanimation/)\> [Add](./add/)() | Új szöveganimációt ad a gyűjteményhez. |
| [iterator](./iterator/) [begin](./begin/)() | Iterátort ad vissza, amely az első elemet (ha van) a gyűjteményben mutat. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Iterátort ad vissza, amely a gyűjtemény const-kvalifikált példányának első elemére (ha van) mutat. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Iterátort ad vissza, amely a gyűjtemény első const-kvalifikált elemére (ha van) mutat. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Iterátort ad vissza, amely a gyűjtemény utolsó const-kvalifikált elemét (ha van) követi. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\>\>, **int32_t**) override | A gyűjtemény összes elemét a megadott tömbbe másolja. |
| [iterator](./iterator/) [end](./end/)() | Iterátort ad vissza, amely a gyűjtemény utolsó elemét (ha van) követi. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Iterátort ad vissza, amely a const-kvalifikált gyűjtemény példányának utolsó elemét (ha van) követi. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Objketumokat a C# [Object.Equals](../../system/object/equals/) szintaxisával hasonlítja össze. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Az objektumhoz rendelt referenciaszámláló adatstruktúrát adja vissza. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végigiterál a gyűjteményen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [idx_get](./idx_get/)(**int32_t**) override | Az elemet index alapján adja vissza. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\>\> [idx_get](./idx_get/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | Az összes elemet visszaadja. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy olyan sorozat értékeinek átlagát, amelyeket a bemeneti sorozat minden elemére egy transzformáló függvény hívásával kapunk. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | A sorozat minden elemét új formába alakítja át az elem indexének figyelembevételével. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden sorozat elemet projekcióval egy másik sorozattá alakít, majd az eredményül kapott sorozatokat egy sorozatba egyesíti. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóra (nem megosztottra) állítja be. Lehetővé teszi a mutatók átkapcsolását konténerekben gyenge módra. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Iterátort ad vissza, amely a const-kvalifikált gyűjtemény példány első elemére (ha van) mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Iterátort ad vissza, amely a gyűjtemény első elemére (ha van) mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Iterátort ad vissza, amely a const-kvalifikált gyűjtemény példány utolsó elemét (ha van) követi. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Iterátort ad vissza, amely a gyűjtemény utolsó elemét (ha van) követi. |
...
* Osztály [ITextAnimationCollection](../itextanimationcollection/)
