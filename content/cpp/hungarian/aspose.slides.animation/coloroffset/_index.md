...
description: A színeltolást ábrázolja.
type: docs
weight: 92
...
| **float** [get_Value0](./get_value0/)() override | Meghatározza az eltolás első értékét. Olvassa **float**. |
| **float** [get_Value1](./get_value1/)() override | Meghatározza az eltolás második értékét. Olvassa **float**. |
| **float** [get_Value2](./get_value2/)() override | Meghatározza az eltolás harmadik értékét. Olvassa **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Meghatározza az eltolás első értékét. Írja **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Meghatározza az eltolás második értékét. Írja **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Meghatározza az eltolás harmadik értékét. Írja **float**. |
...
* Osztály [IColorOffset](../icoloroffset/)
