...
description: Az effektus alaposztály viselkedését képviseli.
type: docs
weight: 144
...
Az effektus alaposztály viselkedését képviseli.
...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() | Kijelöli, hogy az animáció viselkedések felhalmozottak-e. Olvassa [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() | Kijelöli, hogy a jelenlegi animáció viselkedés kombinálva van-e más futó animációkkal. Olvassa [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() | A viselkedés tulajdonságait képviseli. Csak olvasható [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() | Az effektus viselkedés időzítési tulajdonságait képviseli. Olvassa [ITiming](../itiming/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot nullptr-rel referenciaként hasonlít össze. |
...
| virtual void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Kijelöli, hogy az animáció viselkedések felhalmozottak-e. Írja [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Kijelöli, hogy a jelenlegi animáció viselkedés kombinálva van-e más futó animációkkal. Írja [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Az effektus viselkedés időzítési tulajdonságait képviseli. Írja [ITiming](../itiming/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását gyenge módba konténerekben. |
