...
| Módszer | Leírás |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Új viselkedést ad hozzá egy gyűjteményhez. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Visszaad egy iterátort, amely az utolsó const-kvalifikált elem utánra (ha van) mutat a gyűjteményben. |
| void [Clear](./clear/)() override | Eltávolítja az összes viselkedést egy gyűjteményből. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Megállapítja, hogy a [ICollection](../../system.collections.generic/icollection/) tartalmaz-e egy adott értéket. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>, **int32_t**) | Átmásolja a [ICollection](../../system.collections.generic/icollection/) elemeit egy [System::Array](../../system/array/)-ba, egy adott [System::Array](../../system/array/) indextől kezdve. |
| [iterator](./iterator/) [end](./end/)() | Visszaad egy iterátort, amely az utolsó elem utánra (ha van) mutat a gyűjteményben. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Visszaad egy iterátort, amely az utolsó elem utánra (ha van) mutat a gyűjtemény const-kvalifikált példányában. |
...
| **int32_t** [get_Count](./get_count/)() override | Visszaadja a gyűjteményben lévő viselkedések számát. Csak olvasható **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Visszaad egy értéket, amely jelzi, hogy a [ICollection](../../system.collections.generic/icollection/) csak olvasható-e. Csak olvasható **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végigiterál a gyűjteményen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) override | Visszaad egy viselkedést a megadott indexen. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Visszaad egy viselkedést a megadott indexen. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Megállapítja egy konkrét elem indexét a [IList](../../system.collections.generic/ilist/)-ben. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Új viselkedést szúr be a gyűjteménybe a megadott indexnél. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum a targetType által leírt típus példánya-e. A C# 'is' operátor analógiája. |
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Aggregátor függvényt alkalmaz egy sorozatra. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy sorozat átlagát, amely az bemeneti sorozat minden elemére alkalmazott transzformációs függvény eredménye. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Minden sorozatelemet egy új formába alakít át, a elem indexét felhasználva. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projekciókat végez minden elemre, és egyesíti a kapott sorozatokat egy sorozatban. |
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítást. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) őrszem objektumot. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában nem másol semmit, csak inicializálja az új objektumot és lehetővé teszi a származtatott osztályok másolását. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Eltávolítja a megadott viselkedést a gyűjteményből. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Eltávolít egy viselkedést a gyűjteményből a megadott indexnél. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a konténerekben lévő mutatók gyenge módra váltását. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Visszaad egy iterátort, amely az utolsó elem utánra (ha van) mutat a gyűjtemény const-kvalifikált példányában. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Visszaad egy iterátort, amely az utolsó elem utánra (ha van) mutat a gyűjteményben. |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Egy gyűjteménytípus, amelynek iterátortípusai a jelenlegi gyűjtemény iterátortípusaiként vannak használva. |
...
* Osztály [IBehaviorCollection](../ibehaviorcollection/)
