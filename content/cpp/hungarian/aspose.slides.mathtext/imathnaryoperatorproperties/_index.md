...
---
## IMathNaryOperatorProperties osztály


Meghatározza a(z) [IMathNaryOperator](../imathnaryoperator/) tulajdonságait
...
| virtual **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() | Az operátor karakter függőlegesen nő, hogy illeszkedjen az operandus magasságához |
| virtual **bool** [get_HideSubscript](./get_hidesubscript/)() | Alsó index elrejtése |
| virtual **bool** [get_HideSuperscript](./get_hidesuperscript/)() | Felső index elrejtése |
| virtual [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() | A határok helye (alsó index és felső index) |
| virtual char16_t [get_Operator](./get_operator/)() | N-ary Operátor Karakter Például: '\\u2211', '\\u222B' |
...
| virtual void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) | Az operátor karakter függőlegesen nő, hogy illeszkedjen az operandus magasságához |
| virtual void [set_HideSubscript](./set_hidesubscript/)(**bool**) | Alsó index elrejtése |
| virtual void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) | Felső index elrejtése |
| virtual void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) | A határok helye (alsó index és felső index) |
| virtual void [set_Operator](./set_operator/)(char16_t) | N-ary Operátor Karakter Például: '\\u2211', '\\u222B' |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóvá (a megosztott helyett) állítja. Lehetővé teszi a mutatók átkapcsolását konténerekben gyenge módra. |
