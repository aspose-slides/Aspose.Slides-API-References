...
| Metódus | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)() override | Üres matematikai szövegelem létrehozása |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)(char16_t) override | Matematikai szövegelem létrehozása a megadott értékkel |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/)) override | Üres matematikai szövegelem létrehozása a megadott értékkel |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) override | Üres matematikai szövegelem létrehozása a megadott értékkel és formázási tulajdonságokkal |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n'th sablonargumentumot gyenge mutatóvá állítja (nem megosztott). Lehetővé teszi a mutatók konténerben való átváltását gyenge módba. |
| int [SharedCount](../../system/object/sharedcount/)() const | A megosztott referenciacsökkentő aktuális értékét adja vissza. |
...
| virtual  [~Object](../../system/object/~object/)() | Megsemmisíti az objektumot. Minden belső adatstruktúrát felszabadít. |
...
* Osztály [IMathematicalTextFactory](../imathematicaltextfactory/)
