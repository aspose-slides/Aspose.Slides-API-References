...
description: Lehetővé teszi egy matematikai éke létrehozását
type: docs
weight: 625
...
| Módszer | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [CreateMathAccent](./createmathaccent/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Létrehozza a matematikai éket egy meghatározott matematikai elemre az alapértelmezett éke karakterértékkel |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [CreateMathAccent](./createmathaccent/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, char16_t) override | Létrehozza a matematikai éket egy meghatározott matematikai elemre |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Hozzárendelési operátor. Valójában semmit sem másol, csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másoló konstrukcióját. |
...
* Osztály [IMathAccentFactory](../imathaccentfactory/)
