...
description: Lehetővé teszi, hogy matematikai mátrixot hozzon létre
type: docs
weight: 963
...
Lehetővé teszi, hogy matematikai mátrixot hozzon létre
...
| Metódus | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathMatrix](../imathmatrix/)\> [CreateMathMatrix](./createmathmatrix/)(**int32_t**, **int32_t**) override | Létrehoz egy matematikai mátrixot |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Hivatkozás szerint hasonlítja össze az értéktípusú objektumot a nullptr-tél. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n'th sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben gyenge módra történő átkapcsolását. |
...
* Osztály [IMathMatrixFactory](../imathmatrixfactory/)
