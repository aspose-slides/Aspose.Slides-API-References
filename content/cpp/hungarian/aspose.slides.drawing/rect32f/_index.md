...
description: Rectangle struktúra
type: docs
weight: 27
url: /hu/aspose.slides.drawing/rect32f/
---
## Rect32f osztály
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekéri az objektumhoz kapcsolódó referenciacsont számláló adatstruktúrát. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Hozzárendelési operátor. Valójában nem másol semmit, csak új objektumot inicializál és lehetővé teszi az alosztályok másolási konstrukcióját. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonparamétert gyenge mutatóra (ahelyett, hogy megosztott lenne). Lehetővé teszi a mutatók konténerben való átváltását gyenge módra. |
