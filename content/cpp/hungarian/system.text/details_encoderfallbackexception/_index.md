...
description: "Kivétel, amelyet az EncoderExceptionFallback dob, amikor a kódolás sikertelen. Soha ne hozza létre ennek az osztálynak a példányait kézzel. Ehelyett használja az EncoderFallbackException osztályt. Soha ne csomagolja be az EncoderFallbackException osztály példányait a System::SmartPtr-be."
type: docs
weight: 118
url: /hu/system.text/details_encoderfallbackexception/
---
## Details_EncoderFallbackException osztály

Kivétel, amelyet a [EncoderExceptionFallback](../encoderexceptionfallback/) dob, amikor a kódolás sikertelen. Soha ne hozza létre ennek az osztálynak a példányait kézzel. Használja helyette az EncoderFallbackException osztályt. Soha ne csomagolja be az EncoderFallbackException osztály példányait [System::SmartPtr](../../system/smartptr/)-ba.
...
| char_t [get_CharUnknown](./get_charunknown/)() | Lekéri a hibát kiváltó karaktert. |
| char_t [get_CharUnknownHigh](./get_charunknownhigh/)() | Lekéri a hibát kiváltó pár magas karakterét. |
| char_t [get_CharUnknownLow](./get_charunknownlow/)() | Lekéri a hibát kiváltó pár alacsony karakterét. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 32 bites egész értéket ad vissza, amely a jelenlegi objektum által képviselt kivételhez tartozó HRESULT kód. |
| int [get_Index](./get_index/)() | Lekéri a hibát kiváltó karakter pozícióját a bemeneti tömbben. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Lekéri az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógiája. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | A megadott értékkel csökkenti a megosztott referenciaszámlálót. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók konténerben történő gyenge módra váltását. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Megvalósítja a [what()](../../system/details_exception/what/) metódust, amelyet a [ExceptionWrapper](../../system/exceptionwrapper/) osztály hív. Annak ellenére, hogy ez az osztály nem öröklődik a std::exception-ből, a leszármazott osztályok védett/privát tagokat használhatnak logikájuk implementálásához. Ennek a metódusnak a [ExceptionWrapper](../../system/exceptionwrapper/)-ba való áthelyezése megtörheti azt a logikát. |
