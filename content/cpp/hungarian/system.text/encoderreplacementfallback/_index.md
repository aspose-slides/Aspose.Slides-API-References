...
description: "Megvalósítja a hibás szimbólum helyettesítésének fallback stratégiáját egy átirattal. Ennek az osztálynak az objektumait csak a System::MakeObject() függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stacken vagy a new operátorral, mivel ez futásidejű hibákat és/vagy állítási hibákat okozhat. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót a függvények argumentumaként."
type: docs
weight: 196
url: /hu/system.text/encoderreplacementfallback/
---
## EncoderReplacementFallback osztály

Lehetővé teszi a hibás szimbólum helyettesítését egy átirattal. Ennek az osztálynak a példányeit csak a(z) [System::MakeObject()](../../system/makeobject/) függvény segítségével kell lefoglalni. Soha ne hozzon létre példányt ebből a típusból a veremben vagy a new operátorral, mivel futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót a függvények argumentumaként.
...
| Metódus | Leírás |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Létrehozza a helyettesítő puffert. |
| [EncoderReplacementFallback](./encoderreplacementfallback/)() | Konstruktor, amely az alapértelmezett \"?\" helyettesítő karakterláncot használ. |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Lekéri az alapértelmezett kivételhelyettesítő megvalósítást. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Lekéri a példány által visszaadható karakterek legnagyobb számát. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Lekéri az alapértelmezett helyettesítő fallback megvalósítást. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | Lekéri az alapértelmezett szabványos biztonságos fallback megvalósítást. |
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás zárását. Hívja közvetlenül vagy használja a(z) [LockContext](../../system/lockcontext/) őrzőobjektumot. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában semmit nem másol, csak új objektumot inicializál, és lehetővé teszi az alosztályok másoláskonstruálását. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában semmit nem másol, csak új objektumot inicializál, és lehetővé teszi az alosztályok másoláskonstruálását. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonparamétert gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók konténerekben való gyenge módra váltását. |
...
* Osztály [EncoderFallback](../encoderfallback/)
* Névtér [System::Text](../)
