...
description: XML séma definíciós nyelv (XSD) és XML-Data Reduced (XDR) sémák gyorsítótárát tartalmazza.
type: docs
weight: 222
url: /hu/system.xml.schema/xmlschemacollection/
---
## XmlSchemaCollection osztály


Gyorsítótárolót tartalmaz az XML [Schema](../) definíciós nyelv (XSD) és az XML-Data Reduced (XDR) sémákhoz.
...
| Módszer | Leírás |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Hozzáadja a megadott URL által jelölt sémát a séma gyűjteményhez. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Hozzáadja a [XmlReader](../../system.xml/xmlreader/)-ban lévő sémát a séma gyűjteményhez. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Hozzáadja a [XmlReader](../../system.xml/xmlreader/)-ban lévő sémát a séma gyűjteményhez. A megadott [XmlResolver](../../system.xml/xmlresolver/)-t használják külső erőforrások feloldásához. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Hozzáadja a [XmlSchema](../xmlschema/)-t a gyűjteményhez. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Hozzáadja a [XmlSchema](../xmlschema/)-t a gyűjteményhez. A megadott [XmlResolver](../../system.xml/xmlresolver/)-t használják külső hivatkozások feloldásához. |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | Hozzáadja az adott gyűjteményben definiált összes névteret (beleértve a kapcsolódó sémákat) ehhez a gyűjteményhez. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Lekéri azt az iterátort, amely az első (ha van) elemre mutat a gyűjteményben. Ez az iterátor nem használható a hivatkozott objektum módosítására, mivel a [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) egy T típusú másolat-objektust ad vissza. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Lekéri azt az iterátort, amely a gyűjtemény const-képes példányának első (ha van) elemére mutat. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Lekéri azt az iterátort, amely a gyűjtemény első const-képes elemére (ha van) mutat. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Lekéri azt az iterátort, amely a gyűjtemény utolsó const-képes elemét követően (ha van) mutat. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Visszaad egy értéket, amely jelzi, hogy a megadott [XmlSchema](../xmlschema/) **targetNamespace**-e szerepel-e a gyűjteményben. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | Visszaad egy értéket, amely jelzi, hogy a megadott névtérrel rendelkező séma szerepel-e a gyűjteményben. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | Átmásolja az összes [XmlSchema](../xmlschema/) objektumot ebből a gyűjteményből a megadott tömbbe, a megadott indextől kezdve. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Lekéri azt az iterátort, amely a gyűjtemény utolsó elemét (ha van) követően mutat. Ez az iterátor nem használható a hivatkozott objektum módosítására, mivel a [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) egy T típusú másolat-objektust ad vissza. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Lekéri azt az iterátort, amely a gyűjtemény const-képes példányának utolsó elemét (ha van) követően mutat. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Összehasonlítja az objektumokat C# [Object.Equals](../../system/object/equals/) szemantikai szabályai szerint. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, bár az IEC 60559:1989 szerint a NaN semmilyen értéknek, köztük NaN-nak sem egyenlő. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, bár az IEC 60559:1989 szerint a NaN semmilyen értéknek, köztük NaN-nak sem egyenlő. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső felhasználásra. |
| **int32_t** [get_Count](./get_count/)() | Visszaadja ebben a gyűjteményben definiált névterek számát. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | Visszaadja az alapértelmezett [XmlNameTable](../../system.xml/xmlnametable/)-t, amelyet a [XmlSchemaCollection](./) használ új sémák betöltésekor. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | Támogatást biztosít a sémagyűjtemény iterálásához. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) metódus analógja. Lehetővé teszi az egyedi objektumok hash-elését. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Lekéri az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógja. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Visszaadja a megadott névtér-URI-hez tartozó [XmlSchema](../xmlschema/)-t. |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Kiszámítja egy számértékekből álló sorozat átlagát. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy sorozat értékek átlagát, amelyeket egy transzformáló függvény hívásával kapunk a bemeneti sorozat minden elemére. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Minden egyes elemét egy sorozatnak új formába alakítja, a elem indexének felhasználásával. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolói konstruktorának használatát. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Átveszési operátor. Nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolói konstruktorának használatát. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Összehasonlítja a referencia típusú objektumot nullptr értékkel. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonparamétert gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását a konténerekben gyenge módra. |
...
|  [XmlSchemaCollection](./xmlschemacollection/)() | Inicializál egy új példányt a [XmlSchemaCollection](./) osztályból. |
|  [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inicializál egy új példányt a [XmlSchemaCollection](./) osztályból a megadott [XmlNameTable](../../system.xml/xmlnametable/)-val. A [XmlNameTable](../../system.xml/xmlnametable/)-t a sémák betöltésekor használják. |
...
Elavult
:   A [XmlSchemaCollection](./) osztály elavult. Használja helyette a [XmlSchemaSet](../xmlschemaset/)-t.
