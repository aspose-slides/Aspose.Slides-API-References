...
description: Az XML Schema felsorolási facet-jét (enumeration facet) képviseli a World Wide Web Consortium (W3C) által meghatározottak szerint. Ez az osztály egy egyszerű típusú elemhez (simpleType) megengedett értékek listáját határozza meg. A deklaráció egy korlátozó (restriction) deklarációban szerepel.
type: docs
weight: 378
url: /hu/system.xml.schema/xmlschemaenumerationfacet/
---
## XmlSchemaEnumerationFacet osztály


Represents the **enumeration** facet from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). This osztály specifies a list of valid values for a simpleType element. Declaration is contained within a **restriction** declaration.
...
| Módszer | Leírás |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Objektumokat hasonlít össze a C# [Object.Equals](../../system/object/equals/) szemantika segítségével. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Visszaadja a kvalifikált attribútumokat, amelyek nem tartoznak az aktuális séma cél névtéréhez. |
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Visszaadja a **value** attribútumot a facet-nek. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Beállítja a forrás helyét a séma betöltő fájlhoz. |
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Beállítja a kvalifikált attribútumokat, amelyek nem tartoznak az aktuális séma cél névtéréhez. |
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Beállítja a **value** attribútumot a facet-nek. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonparamétert gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók átváltását a tárolókban gyenge módra. |
...
|  [XmlSchemaEnumerationFacet](./xmlschemaenumerationfacet/)() | Inicializál egy új példányt a [XmlSchemaEnumerationFacet](./) osztályból. |
...
| --- | --- |
| [Ptr](./ptr/) | Egy alias a megosztott mutatóhoz, amely egy példányra mutat ebben az osztályban. |
