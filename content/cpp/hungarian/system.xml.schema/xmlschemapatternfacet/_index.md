...
description: A World Wide Web Consortium (W3C) által meghatározott XML Schema pattern elemet reprezentálja. Ez az osztály egy simpleType elem beírt értékére vonatkozó korlátozást adhat meg.
type: docs
weight: 742
url: /hu/system.xml.schema/xmlschemapatternfacet/
---
## XmlSchemaPatternFacet osztály
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Visszaadja a séma betöltéséért felelős fájl forráshelyét. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Beállítja az XmlSerializerNamespaces objektumot, amely ezzel a schema objektummal lesz használva. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Beállítja a betöltött séma fájl forráshelyét. |
...
|  [XmlSchemaPatternFacet](./xmlschemapatternfacet/)() | Inicializál egy új példányt a [XmlSchemaPatternFacet](./) osztályból. |
| virtual  [~Object](../../system/object/~object/)() | Megsemmisíti az objektumot. Felszabadítja az összes belső adatstruktúrát. |
## Typedefek

| Typedef | Description |
| --- | --- |
| [Ptr](./ptr/) | Egy alias a megosztott mutatóhoz, amely az osztály egy példányára hivatkozik. |
## Megjegyzések

Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányokat ebből a típusból a stacken vagy az operator new használatával, mivel futásidejű hibákat és/vagy állítási hibákat eredményezhet. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az argumentumként való átadásra a függvényeknek. 
