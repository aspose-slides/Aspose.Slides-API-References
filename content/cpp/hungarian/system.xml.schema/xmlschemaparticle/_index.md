...
description: Ez az alap osztály, amely az összes részecske típus (pl. XmlSchemaAny) alap osztálya.
type: docs
weight: 729
url: /hu/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle osztály


Ez az alap osztály, amely az összes részecske típus (pl. [XmlSchemaAny](../xmlschemaany/)) alap osztálya.
...
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Visszaadja a fájlban lévő sor számát, amelyhez a **schema** elem tartozik. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Visszaadja a fájlban lévő sorpozíciót, amelyhez a **schema** elem tartozik. |
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Visszaadja a részecske legnagyobb előfordulási számát. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Visszaadja a számot karakterlánc értékként. A részecske legnagyobb előfordulási száma. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Visszaadja a részecske legkisebb előfordulási számát. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Visszaadja a számot karakterlánc értékként. A részecske legkisebb előfordulási száma. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Visszaadja a XmlSerializerNamespaces-t, amelyet ezzel a sémával rendelkező objektummal használhat. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Visszaadja a forrás helyét az a fájlhoz, amely betöltötte a sémát. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Beállítja a fájlban lévő sor számát, amelyhez a **schema** elem tartozik. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Beállítja a fájlban lévő sorpozíciót, amelyhez a **schema** elem tartozik. |
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Beállítja a részecske legnagyobb előfordulási számát. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Beállítja a számot karakterlánc értékként. A részecske legnagyobb előfordulási száma. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Beállítja a részecske legkisebb előfordulási számát. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Beállítja a számot karakterlánc értékként. A részcske legkisebb előfordulási száma. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Beállítja a XmlSerializerNamespaces-t, amelyet ezzel a sémával rendelkező objektummal használhat. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Beállítja a forrás helyét ahhoz a fájlhoz, amely betöltötte a sémát. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók átváltását konténerekben gyenge módra. |
...
|  [XmlSchemaParticle](./xmlschemaparticle/)() | Inicializál egy új példányt a [XmlSchemaParticle](./) osztályból. |
