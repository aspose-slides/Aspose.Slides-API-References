...
description: Az XmlSchemaObjectCollection enumerátorát képviseli.
type: docs
weight: 703
url: /hu/system.xml.schema/xmlschemaobjectenumerator/
---
## XmlSchemaObjectEnumerator osztály
...
| Method | Description |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Előkészíti az iterátort, hogy a VirtualizedIterator osztály használhassa. |
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaObject](../xmlschemaobject/)\>\> * [CloneIterator](./cloneiterator/)() const override | Klónozza a jelenlegi iterátort. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekintett, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekintett, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső célokra. |
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\& [get_Current](./get_current/)() const override | Visszaadja a gyűjteményben lévő jelenlegi [XmlSchemaObject](../xmlschemaobject/)-t. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Előrelép egy lépéssel az iterátorban. |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Végrehajtja az első [MoveNext()](../../system.collections.generic/ienumerator/movenext/) hívást, és előkészíti a felsoroló objektumot a VirtualizedIterator használatához. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Megjelöli a virtualizált iterátorhoz tartozó enumerátort. |
...
| **bool** [MoveNext](./movenext/)() override | Átugrik a gyűjtemény következő elemére. |
|  [Object](../../system/object/object/)() | Létrehozza az objektumot. Inicializálja az összes belső adatstruktúrát. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másoltatását. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolását. |
...
| void [Reset](./reset/)() override | Visszaállítja az enumerátort a gyűjtemény elejére. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók váltását gyenge módra a tárolókban. |
