...
description: Az XmlSchemaObject-ek gyűjteménye.
type: docs
weight: 690
url: /hu/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection osztály

Az XmlSchemaObject-ek gyűjteménye.
...
| Method | Leírás |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Hozzáad egy [XmlSchemaObject](../xmlschemaobject/)-t a [XmlSchemaObjectCollection](./)-hez. |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | Eltávolítja az összes objektumot a gyűjtemény példányából. Ez a metódus nem felülírható. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Jelzi, hogy a megadott [XmlSchemaObject](../xmlschemaobject/) szerepel-e a [XmlSchemaObjectCollection](./)-ban. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Átmásolja az összes XmlSchemaObject-et a gyűjteményből a megadott tömbbe, a megadott indexnél kezdve. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Visszaad egy iterátort, amely a const-kvalifikált gyűjtemény példány utolsó eleme utánra mutat (ha van). |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Visszaadja a gyűjtemény által tartalmazható elemek számát. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Visszaadja a gyűjtemény példányában lévő elemek számát. Ez a metódus nem felülírható. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort az [XmlSchemaObjectCollection](./)-ben lévő XmlSchemaObject-ek bejárásához. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Visszaadja a megadott indexnél lévő [XmlSchemaObject](../xmlschemaobject/)-t. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Beállítja a megadott indexnél lévő [XmlSchemaObject](../xmlschemaobject/)-t. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Visszaadja a megadott [XmlSchemaObject](../xmlschemaobject/)-nek megfelelő gyűjteményindexet. |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Beszúr egy [XmlSchemaObject](../xmlschemaobject/)-t a [XmlSchemaObjectCollection](./)-ba. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyes generikus sorozat elemre meghív egy transzformációs függvényt, és visszaadja a legnagyobb eredményt. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyes generikus sorozat elemre meghív egy transzformációs függvényt, és visszaadja a legkisebb eredményt. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Minden egyes sorozat elemet egy új formába transzformál az elem indexének felhasználásával. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden egyes sorozat elemet projekcióval egy új sorozatba helyez, majd a kapott sorozatokat egyetlen sorozattá egyesíti. |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Eltávolít egy [XmlSchemaObject](../xmlschemaobject/)-t a [XmlSchemaObjectCollection](./)-ból. |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Eltávolítja a gyűjtemény példányában a megadott indexű elemet. Ez a metódus nem felülírható. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Beállítja a gyűjtemény által tárolható elemek számát. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Az n-edik sablonparamétert gyenge mutatóra (a megosztott helyett) állítja. Lehetővé teszi a tárolók mutatóinak gyenge módra váltását. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | A C# [Object.ToString()](../../system/object/tostring/) metódus analógiája. Engedélyezi egyedi objektumok karakterláncra konvertálását. |
...
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)() | Inicializál egy új példányt a [XmlSchemaObjectCollection](./) osztályból. |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Inicializál egy új példányt a [XmlSchemaObjectCollection](./) osztályból, amely egy [XmlSchemaObject](../xmlschemaobject/)-t vesz át. |
...
Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányokat a stack-en vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy assert hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót, hogy argumentumként átadja a függvényeknek.

## Lásd még

* Osztály [CollectionBase](../../system.collections/collectionbase/)
