...
description: Részletes információkat ad vissza a ValidationEventHandler-hez kapcsolódóan.
type: docs
weight: 53
url: /hu/system.xml.schema/validationeventargs/
---
## ValidationEventArgs osztály


Részletes információkat ad vissza a ValidationEventHandler-hez kapcsolódóan.
...
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | Visszaadja a validációs eseményhez kapcsolódó XmlSchemaException-t. |
| [String](../../system/string/) [get_Message](./get_message/)() | Visszaadja a validációs eseményhez tartozó szöveges leírást. |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | Visszaadja a validációs esemény súlyosságát. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóvá (a megosztott helyett) állítja be. Lehetővé teszi a mutatók konténerekben való gyenge módra való átváltását. |
...
Ezt az osztályt csak a [System::MakeObject()](../../system/makeobject/) függvénnyel szabad példányosítani. Soha ne hozzon létre példányokat a stacken vagy az operator new használatával, mert ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az argumentumként való átadásra függvényeknek. 
