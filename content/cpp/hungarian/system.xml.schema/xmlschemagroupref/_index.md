...
description: A World Wide Web Consortium (W3C) által meghatározott XML séma ref attribútummal rendelkező group elemet ábrázolja. Ez az osztály komplex típusokban használatos, amelyek a séma szintjén definiált groupra hivatkoznak.
type: docs
weight: 456
url: /hu/system.xml.schema/xmlschemagroupref/
---
## XmlSchemaGroupRef osztály


Az XML [Schema](../)-ban található **group** elem **ref** attribútummal ábrázolja, ahogy azt a World Wide [Web](../../system.web/) Consortium (W3C) meghatározza. Ezt az osztályt komplex típusokban használják, amelyek egy **group**-ra hivatkoznak, amely a **schema** szinten definiálva van.
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Visszaadja a string azonosítót. |
...
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Visszaadja a számot karakterlánc értékként. A részecske maximális előfordulási száma. |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Visszaadja a számot karakterlánc értékként. A részecske minimális előfordulási száma. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Visszaadja a [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) vagy [XmlSchemaSequence](../xmlschemasequence/) osztályok egyikét, amely a **Particle** érték utófordítási értelmezését tartalmazza. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Visszaadja egy csoport nevét, amely ebben a schema-ban van definiálva (vagy egy másik schema-ban, amelyet a megadott névtér jelöl). |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Visszaadja a forráshelyet a fájlhoz, amely betöltötte a schema-t. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Visszaadja a kvalifikált attribútumokat, amelyek nem tartoznak az aktuális schema cél névéhez. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum a targetType által leírt típust példányosítja-e. A C# 'is' operátor analógiája. |
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítást zárolásként. Hívd közvetlenül vagy használd a [LockContext](../../system/lockcontext/) sentinel objektumot. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Átadási operátor. Nem másol semmit, valójában csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másoló konstrukcióját. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | A value típusú objektumot nullptr-re referenciával hasonlítja össze. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Beállítja a string azonosítót. |
...
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Beállítja a számot karakterlánc értékként. A részecske maximális előfordulási száma. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Beállítja a számot karakterlánc értékként. A részecske minimális előfordulási száma. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Beállítja egy csoport nevét, amely ebben a schema-ban van definiálva (vagy egy másik schema-ban, amelyet a megadott névtér jelöl). |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Beállítja a forráshelyet a fájlhoz, amely betöltötte a schema-t. |
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Beállítja a kvalifikált attribútumokat, amelyek nem tartoznak az aktuális schema cél névéhez. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként állítja be (nem megosztottként). Lehetővé teszi a mutatók átkapcsolását konténerekben gyenge módra. |
...
|  [XmlSchemaGroupRef](./xmlschemagroupref/)() | Inicializál egy új példányt a [XmlSchemaGroupRef](./) osztályból. |
...
Ezt az osztályt csak a [System::MakeObject()](../../system/makeobject/) függvénnyel szabad példányosítani. Soha ne hozz létre példányt ezen típusból a stack-en vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy assert hibákat okozhat. Mindig csomagold be az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és ezt a mutatót használd argumentumként a függvényeknek átadva. 
