...
description: A World Wide Web Consortium (W3C) appinfo elemet képviseli.
type: docs
weight: 157
url: /hu/system.xml.schema/xmlschemaappinfo/
---
## XmlSchemaAppInfo osztály

A World Wide [Web](../../system.web/) Consortium (W3C) **appinfo** elemet képviseli.
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | [XmlNode](../../system.xml/xmlnode/) objektumok tömbjét adja vissza, amely a **appinfo** gyermekcsomópontokat képviseli. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Visszaadja az alkalmazásinformáció forrását. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia összehasonlítja értéktípusú objektumot a nullptr értékkel. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Beállítja a [XmlNode](../../system.xml/xmlnode/) objektumok tömbjét, amely a **appinfo** gyermekcsomópontokat képviseli. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Beállítja az alkalmazásinformáció forrását. |
...
Az osztály objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányokat ebben a típusban a stacken vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az objektum függvényeknek argumentumként történő átadásához.
