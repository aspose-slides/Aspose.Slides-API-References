...
description: A **choice** elemet (compositor) képviseli az XML Schema szerint, ahogyan a World Wide Web Consortium (W3C) meghatározta. A **choice** csak egy gyermekének megjelenését teszi lehetővé egy példányban.
type: docs
weight: 209
url: /hu/system.xml.schema/xmlschemachoice/
---
## XmlSchemaChoice osztály

Az XML [Schema](../)-ban szereplő **choice** elemet (összeállító) ábrázolja, ahogy a World Wide [Web](../../system.web/) Consortium (W3C) meghatározta. A **choice** csak egy gyermekének megjelenését teszi lehetővé egy példányban.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Visszaadja a komponens (**choice**) által tartalmazott elemek gyűjteményét: [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](./), [XmlSchemaSequence](../xmlschemasequence/), vagy [XmlSchemaAny](../xmlschemaany/). |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Visszaadja a **schema** elemhez tartozó sor számát a fájlban. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Visszaadja a **schema** elemhez tartozó sorpozíciót a fájlban. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Visszaadja a XmlSerializerNamespaces-t, amelyet ezzel a sémával rendelkező objektummal együtt használhat. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekérdezi az objektumhoz társított hivatkozásszámláló adatstruktúrát. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia összehasonlítja az értéktípusú objektumot a nullptr-val. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Beállítja a **schema** elemhez tartozó sor számát a fájlban. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Beállítja a **schema** elemhez tartozó sorpozíciót a fájlban. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Beállítja a XmlSerializerNamespaces-t, amelyet ezzel a sémával rendelkező objektummal együtt használ. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Beállítja a kvalifikált attribútumokat, amelyek nem tartoznak a jelenlegi séma cél névtéréhez. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Lekérdezi a megosztott hivatkozásszámláló jelenlegi értékét. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökken és visszaadja a megosztott hivatkozásszámlálót. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
...
|  [XmlSchemaChoice](./xmlschemachoice/)() | Inicializál egy új példányt a [XmlSchemaChoice](./) osztályból. |
...
| Typedef | Leírás |
| --- | --- |
| [Ptr](./ptr/) | Egy alias a megosztott mutatóhoz, amely ennek az osztálynak a példányára mutat. |

## Megjegyzések

Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény használatával szabad lefoglalni. Soha ne hozza létre ennek a típusnak a példányait stack-en vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja azt a mutatót az argumentumként függvényeknek történő átadásra. 
