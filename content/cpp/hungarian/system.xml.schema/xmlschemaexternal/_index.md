...
description: Információt nyújt a beillesztett sémáról.
type: docs
weight: 391
url: /hu/system.xml.schema/xmlschemaexternal/
---
## XmlSchemaExternal osztály


Információt nyújt a beillesztett sémáról.
...
| [String](../../system/string/) [get_Id](./get_id/)() | Visszaadja a string azonosítót. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Visszaadja a XmlSerializerNamespaces-t, amelyet a schema objektummal együtt használhat. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](./get_schema/)() | Visszaadja a [XmlSchema](../xmlschema/)-t a hivatkozott sémához. |
| [String](../../system/string/) [get_SchemaLocation](./get_schemalocation/)() | Visszaadja a Uniform Resource Identifier (URI) helyét a sémához, amely megmondja a sémaprocesszornak, hol található a séma fizikailag. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Visszaadja a forrás helyét a sémát betöltő fájlhoz. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](./get_unhandledattributes/)() | Visszaadja a kvalifikált attribútumokat, amelyek nem tartoznak a séma célnevezéktérhez. |
...
| void [set_Id](./set_id/)(const [String](../../system/string/)\&) | Beállítja a string azonosítót. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Beállítja a XmlSerializerNamespaces-t, amelyet a schema objektummal együtt használhat. |
...
| void [set_Schema](./set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Beállítja a [XmlSchema](../xmlschema/)-t a hivatkozott sémához. |
| void [set_SchemaLocation](./set_schemalocation/)(const [String](../../system/string/)\&) | Beállítja a Uniform Resource Identifier (URI) helyét a sémához, amely a sémaprocesszornak megmondja, hol található a séma fizikailag. |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Beállítja a forrás helyét a sémát betöltő fájlnál. |
| void [set_UnhandledAttributes](./set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Beállítja a kvalifikált attribútumokat, amelyek nem tartoznak a séma célnevezéktérhez. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonparamétert gyenge mutatóként állítja be (a megosztott helyett). Lehetővé teszi a mutatók átállítását gyenge módra a tárolókban. |
...
|  [XmlSchemaExternal](./xmlschemaexternal/)() | Inicializál egy új példányt a [XmlSchemaExternal](./) osztályból. |
...
| --- | --- |
| [Ptr](./ptr/) | Egy alias a megosztott mutató számára, amely ennek az osztálynak egy példányára mutat. |
## Megjegyzés
