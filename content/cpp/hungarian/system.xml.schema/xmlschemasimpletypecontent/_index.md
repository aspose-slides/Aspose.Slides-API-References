...
description: Alap osztály az egyszerű típusú tartalom osztályokhoz.
type: docs
weight: 846
url: /hu/system.xml.schema/xmlschemasimpletypecontent/
---
## XmlSchemaSimpleTypeContent osztály
...
Az osztály objektumait csak a [System::MakeObject()](../../system/makeobject/) funkcióval szabad lefoglalni. Soha ne hozzon létre példányokat ebből a típusból a veremben vagy az **operator new** használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót, amikor argumentumként átadja a függvényeknek. 
