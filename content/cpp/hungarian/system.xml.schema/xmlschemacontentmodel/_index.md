...
description: Meghatározza egy típus gyermekelemeinek sorrendjét és szerkezetét.
type: docs
weight: 326
url: /hu/system.xml.schema/xmlschemacontentmodel/
---
## XmlSchemaContentModel osztály

Meghatározza egy típus gyermekelemeinek sorrendjét és felépítését.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN érték egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN semelyik értékhez, beleértve a NaN-t, nem egyenlő. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN érték egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN semelyik értékhez, beleértve a NaN-t, nem egyenlő. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() | Visszaadja a típus tartalmát. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Visszaadja a karakterlánc azonosítót. |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Visszaadja a fájlban lévő sort számot, amelyre a **schema** elem hivatkozik. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Visszaadja a fájlban lévő sor pozícióját, amelyre a **schema** elem hivatkozik. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Visszaadja a forrás helyet a fájlhoz, amely betöltötte a sémát. |
...
| virtual void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) | Beállítja a típus tartalmát. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Beállítja a karakterlánc azonosítót. |
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Beállítja a fájlban lévő sort számot, amelyre a **schema** elem hivatkozik. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Beállítja a fájlban lévő sor pozícióját, amelyre a **schema** elem hivatkozik. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Beállítja a XmlSerializerNamespaces objektumot, amelyet ezzel a schema objektummal kell használni. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Beállítja a forrás helyet a fájlhoz, amely betöltötte a sémát. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablon argumentumot gyenge pointerre (a megosztott helyett) állítja be. Lehetővé teszi a pointerek átkapcsolását a tárolókban gyenge módra. |
