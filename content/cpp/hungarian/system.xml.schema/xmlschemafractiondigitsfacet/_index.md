...
description: Megad egy korlátozást a simpleType elem frakcióértékéhez megadható számjegyek számában. A fractionDigits értékének pozitív egésznek kell lennie. A World Wide Web Consortium (W3C) fractionDigits aspektust képviseli.
type: docs
weight: 417
url: /hu/system.xml.schema/xmlschemafractiondigitsfacet/
---
## XmlSchemaFractionDigitsFacet osztály

Meghatároz egy korlátozást a egyszerű típus (simpleType) elem törtrész értékéhez megadható számjegyek számában. A fractionDigits értékének pozitív egésznek kell lennie. A World Wide [Web](../../system.web/) Consortium (W3C) **fractionDigits** aspektust képviseli.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Visszaadja azt az információt, amely jelzi, hogy ez a facet rögzített. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Visszaadja a XmlSerializerNamespaces-t, amelyet ezt a sémaobjektummal kell használni. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Visszaadja a forrás helyét a séma betöltött fájlhoz. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Visszaadja a minősített attribútumokat, amelyek nem tartoznak a jelenlegi séma cél névtérébe. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában semmit nem másol, csak új objektumot inicializál és engedélyezi az alosztályok másoló konstruktorát. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában semmit nem másol, csak új objektumot inicializál és engedélyezi az alosztályok másoló konstruktorát. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Beállítja a forrás helyét a séma betöltött fájlhoz. |
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Beállítja a minősített attribútumokat, amelyek nem tartoznak a jelenlegi séma cél névtérébe. |
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Beállítja a facet **value** attribútumát. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók konténerben való gyenge módra váltását. |
...
|  [XmlSchemaFractionDigitsFacet](./xmlschemafractiondigitsfacet/)() | Inicializál egy új példányt a [XmlSchemaFractionDigitsFacet](./) osztályból. |
...
Ezt az osztályt csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével szabad példányosítani. Soha ne hozzon létre példányokat e típusból a stack-en vagy az new operátorral, mivel ez futásidejű hibákat és/vagy assert hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót a függvényeknek argumentumként történő átadásra. 

## Lásd még

* Osztály [XmlSchemaNumericFacet](../xmlschemanumericfacet/)
