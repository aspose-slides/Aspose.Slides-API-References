...
description: "XML aláíráshoz és ellenőrzéshez használatos. Ennek az osztálynak a példányait csak a System::MakeObject() függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányt a típusról a stacken vagy az operator new használatával, mivel ez futásidejű hibákhoz és/vagy állítási hibákhoz vezethet. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót az argumentumként való átadásra a függvényeknek."
type: docs
weight: 118
url: /hu/system.security.cryptography.xml/signedxml/
---
## SignedXml osztály
