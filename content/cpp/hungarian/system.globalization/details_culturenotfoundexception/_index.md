...
description: "A CultureNotFoundException kivétel akkor dobódik, amikor megpróbálunk egy nem elérhető kultúrát létrehozni. Soha ne hozzon létre példányokat ebből az osztályból kézzel. Használja helyette a CultureNotFoundException osztályt. Soha ne csomagolja a CultureNotFoundException osztály példányait a System::SmartPtr-be."
type: docs
weight: 92
url: /hu/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException osztály


CultureNotFoundException akkor dobódik, amikor megpróbálunk egy nem elérhető kultúrát létrehozni. Soha ne hozzon létre példányokat ebből az osztályból kézzel. Használja helyette a CultureNotFoundException osztályt. Soha ne csomagolja a CultureNotFoundException osztály példányait a [System::SmartPtr](../../system/smartptr/)-ba.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Szimulálja a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Szimulálja a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső felhasználásra. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Visszaad egy szótárt egyéni kivétel adatokkal. |
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Visszaadja a veremkiírást tartalmazó karakterláncot. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Beállítja a HRESULT-et, egy kódolt numerikus értéket, amely egy adott kivételnek van hozzárendelve. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Megvalósítja a [what()](../../system/details_exception/what/) metódust, amelyet a [ExceptionWrapper](../../system/exceptionwrapper/) osztály hív. Annak ellenére, hogy ez az osztály nem öröklődik a std::exception, a származtatott osztályok használhatják a védett/privát tagokat a logikájuk megvalósításához. Ennek a metódusimplementációnak a [ExceptionWrapper](../../system/exceptionwrapper/) helyre való áthelyezése eltörheti azt a logikát. |
