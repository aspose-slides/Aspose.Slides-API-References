...
description: "Calendar, amely meghatározza, hogyan kezelik, számolják, formázzák stb. a dátumokat. A beállító műveletek csak nem csak-olvasásra szánt objektumokon engedélyezettek. Ennek az osztálynak az objektumait csak a System::MakeObject() függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stack-en vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót a függvények argumentumaként."
type: docs
weight: 1
url: /hu/system.globalization/calendar/
---
## Calendar osztály


[Calendar](./) amely meghatározza, hogyan kezelik, számolják, formázzák stb. a dátumokat. A beállító műveletek csak nem csak-olvasásra szánt objektumokon engedélyezettek. Ennek az osztálynak a példányait kizárólag a [System::MakeObject()](../../system/makeobject/) függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stack-en vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót a függvények argumentumaként.
