...
description: "Információkat ad a karakterláncok összehasonlításához és rendezéséhez használt Unicode verzióról. Ennek az osztálynak az objektumait csak a System::MakeObject() függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányt a típusból a stacken vagy az new operátorral, mivel ez futási időbeli hibákat és/vagy állítási hibákat okozhat. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és ezt a mutatót használja az argumentumként való átadásra a függvényeknek."
type: docs
weight: 300
url: /hu/system.globalization/sortversion/
---
## SortVersion osztály

Információt szolgáltat a karakterláncok összehasonlításához és rendezéséhez használt Unicode verzióról. Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt a típusból a stack-ben vagy az new operátorral, mivel ez futási időbeli hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és ezt a mutatót használja az objektum függvényeknek argumentumként történő átadásához.
...
| Módszer | Leírás |
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[SortVersion](./)\>) override | Ellenőrzi, hogy a jelenlegi [SortVersion](./) példány egyenlő-e a megadott [SortVersion](./) objektummal. |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Ellenőrzi, hogy a jelenlegi [SortVersion](./) példány egyenlő-e a megadott [SortVersion](./) objektummal. |
...
| int [get_FullVersion](./get_fullversion/)() | Lekéri a teljes verziószámot. |
| [Guid](../../system/guid/) [get_SortId](./get_sortid/)() | Lekéri az objektum egyedi azonosítóját. |
...
| int [GetHashCode](./gethashcode/)() const override | Lekéri a jelenlegi objektum hash-kódját. |
...
| **bool** [operator!=](./operator_not_equal/)(const [SortVersion](./)\&) | Ellenőrzi, hogy a jelenlegi [SortVersion](./) példány nem egyenlő-e a megadott [SortVersion](./) objektummal. |
| [SortVersion](./)\& [operator=](./operator_equal/)(const [SortVersion](./)\&) |  |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában semmit nem másol, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolás-konstrukcióját. |
| **bool** [operator==](./operator_equal_equal/)(const [SortVersion](./)\&) | Ellenőrzi, hogy a jelenlegi [SortVersion](./) példány egyenlő-e a megadott [SortVersion](./) objektummal. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenciával összehasonlítja az értéktípusú objektumot a nullptr-el. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók konténerekben való gyenge módra váltását. |
...
|  [SortVersion](./sortversion/)(int, const [Guid](../../system/guid/)\&) | RTTI információ. |
