...
description: "Többszínű színátmenetben a színkeverés interpolálásához használt színek és pozíciók tömbjeit tartalmazza. Ennek az osztálynak a példányait csak a System::MakeObject() függvénnyel szabad lefoglalni. Soha ne hozzon létre példányt a veremben vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és ezt a mutatót használja az objektum függvényeknek argumentumként való átadásához."
type: docs
weight: 27
url: /hu/system.drawing.drawing2d/colorblend/
---
## ColorBlend osztály

Többszínű színátmenetben a színkeverés interpolálásához használt színek és pozíciók tömbjeit tartalmazza. Ennek az osztálynak a példányait csak a [System::MakeObject()](../../system/makeobject/) függvénnyel szabad lefoglalni. Soha ne hozzon létre példányt a veremben vagy az operator new használatával, mert futásidejű hibákat és/vagy állítási hibákat okozhat. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az objektum átadásához függvényeknek argumentumként.
...
| Metódus | Leírás |
| --- | --- |
| [ColorBlend](./colorblend/)() | Új példányt hoz létre a [ColorBlend](./) osztályból. |
| [ColorBlend](./colorblend/)(int) | Új példányt hoz létre a [Blend](../blend/) osztályból. |
...
| [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Colors](./get_colors/)() | Visszaad egy színtömböt, amelyet a színátmenet megfelelő pozícióiban kell használni. |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() | Visszaadja a színátmenethez tartozó keverési pozíciók tömbjét. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenciával hasonlít össze egy érték típusú objektumot a nullptr-al. |
...
| void [set_Colors](./set_colors/)(const [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\>\&) | Beállít egy színtömböt, amelyet a színátmenet megfelelő pozícióiban kell használni. |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Beállítja a színátmenet keverési pozícióinak tömbjét. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként állítja be (nem megosztottként). Lehetővé teszi a mutatók átváltását konténerekben gyenge módra. |
