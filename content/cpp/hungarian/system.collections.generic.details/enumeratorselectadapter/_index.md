...
description: Az IEnumerable.Select() kiterjesztő metódus által használt enumerátor.
type: docs
weight: 79
url: /hu/system.collections.generic.details/enumeratorselectadapter/
---
## EnumeratorSelectAdapter osztály

Az IEnumerable.Select() kiterjesztési metódus által használt enumerátor.
...
| Result | A gyűjtemény elemeinek eredmény típusa. |
## Metódusok
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | Lekéri az aktuális elemet. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Elvégzi az első [MoveNext()](../../system.collections.generic/ienumerator/movenext/) hívást, és előkészíti az enumerátor objektumot a VirtualizedIterator által használathoz. |
...
| **bool** [MoveNext](./movenext/)() override | Az enumerátort a következő elemre mozgatja. Ha korábban nem hivatkoztak elemre, a referenciát az első rendelkezésre álló elemre állítja. Ha a tároló vége elérve lett, nem csinál semmit. |
...
| void [Reset](./reset/)() override | Visszaállítja az enumerátort az első elem előtt álló pozícióba. |
