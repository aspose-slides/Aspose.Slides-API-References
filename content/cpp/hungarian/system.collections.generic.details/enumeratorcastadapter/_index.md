...
description: Az IEnumerable.Cast() kiterjesztő metódus által használt enumerátor.
type: docs
weight: 53
url: /hu/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter osztály
...
| Metódus | Leírás |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Felkészíti az iterátort a VirtualizedIterator osztály által való használatra. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Elvégzi az első [MoveNext()](../../system.collections.generic/ienumerator/movenext/) hívást, és előkészíti az enumerátor objektumot a VirtualizedIterator által való használatra. |
...
| **bool** [MoveNext](./movenext/)() override | Az enumerátort a következő elemre mozgatja. Ha korábban nem hivatkozott elem, a referencia az első elérhető elemre áll be. Ha a tároló vége érintkezik, nem csinál semmit. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a tárolókban lévő mutatók gyenge módra való átkapcsolását. |
