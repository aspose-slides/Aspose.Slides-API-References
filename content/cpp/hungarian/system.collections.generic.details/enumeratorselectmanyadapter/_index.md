...
type: docs
weight: 105
url: /hu/system.collections.generic.details/enumeratorselectmanyadapter/
---
## EnumeratorSelectManyAdapter osztály
...
| Metódus | Leírás |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Előkészíti az iterátort a VirtualizedIterator osztály által való használathoz. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | Lekéri a jelenlegi elemet. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Elvégzi az első [MoveNext()](../../system.collections.generic/ienumerator/movenext/) hívást, és előkészíti a enumerátor objektumot a VirtualizedIterator által való használathoz. |
...
| **bool** [MoveNext](./movenext/)() override | Az enumerátort a következő elemre mozgatja. Ha korábban nem hivatkozott elem, a hivatkozást az első rendelkezésre álló elemre állítja. Ha a konténer vége érintett, nem csinál semmit. |
...
| void [Reset](./reset/)() override | Visszaállítja az enumerátort az első elem előtti pozícióra. |
