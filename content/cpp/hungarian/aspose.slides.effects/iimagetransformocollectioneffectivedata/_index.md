...
description: Megváltoztathatatlan objektum, amely egy csak olvasható gyűjteményt képvisel a hatékony képarnyézeti transzformációs hatásokból.
type: docs
weight: 716
...
Megváltoztathatatlan objektum, amely egy csak olvasható gyűjteményt képvisel a hatékony képet átalakító hatásokból.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol a két NaN egyenlőnek tekintendő, még ha az IEC 60559:1989 szerint a NaN semmilyen értéknek, beleértve a NaN-t, nem egyenlő. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol a két NaN egyenlőnek tekintendő, még ha az IEC 60559:1989 szerint a NaN semmilyen értéknek, beleértve a NaN-t, nem egyenlő. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.generic/ienumerable/getenumerator/)() | Visszaad enumerátort. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Visszaad egy elemet index alapján. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy értéksorozat átlagát, amelyet úgy kapunk, hogy egy transzformációs függvényt hívunk meg minden bemeneti sorozat elemén. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyes generikus sorozat elemre meghív egy transzformációs függvényt, és visszaadja a kapott maximális értéket. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyes generikus sorozat elemre meghív egy transzformációs függvényt, és visszaadja a kapott minimális értéket. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | A sorozat minden elemét új formába alakítja át az elem indexének felhasználásával. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot hivatkozás alapján hasonlít össze a nullptr-kel. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóvá (nem megosztottá) állítja be. Lehetővé teszi a tárolókban lévő mutatók gyengé módra váltását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Visszaadja a megosztott referenciaszámláló aktuális értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott referenciaszámlálót. Nem szabad közvetlenül meghívni; helyette okos mutatókat vagy ThisProtector-t használj. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott referenciaszámlálót. Nem szabad közvetlenül meghívni; helyette okos mutatókat vagy ThisProtector-t használj. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Növeli a gyenge referenciaszámlálót. Nem szabad közvetlenül meghívni; helyette okos mutatókat vagy ThisProtector-t használj. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Csökkenti a gyenge referenciaszámlálót. Nem szabad közvetlenül meghívni; helyette okos mutatókat vagy ThisProtector-t használj. |
| virtual  [~Object](../../system/object/~object/)() | Megsemmisíti az objektumot. Felszabadítja az összes belső adatstruktúrát. |

## Megjegyzések

Az IImageTransformOperationCollectionEffectiveData nevet [IImageTransformOCollectionEffectiveData](./)-re rövidítették, mert a COM nevek hossza nem haladhatja meg a 39 karaktert. 
