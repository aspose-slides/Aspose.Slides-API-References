...
description: Alpha Modulate Fixed effektust reprezentál. Az effektus alfa (átlátszóság) értékeit egy fix százalékkal szorozzák.
type: docs
weight: 66
...
Az Alpha Modulate Fixed effektust reprezentálja. Az effektus alfa (átlátszóság) értékeit egy fix százalékkal szorozzák.
...
| Metódus | Leírás |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Megállapítja, hogy a megadott [AlphaModulateFixed](./) egyenlő-e a jelenlegi [AlphaModulateFixed](./)-vel. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekintendő, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semelyik értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekintendő, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semelyik értékkel, beleértve a NaN-t is. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső célokra. |
| **float** [get_Amount](./get_amount/)() override | Az effektus százalékos mennyiségét adja vissza. Olvasható **float**. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | Parent_Immediate objektumot ad vissza. Csak olvasható [IDOMObject](../../aspose.slides/idomobject/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | A szülő [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)-t adja vissza. Csak olvasható [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Az öröklődéssel alkalmazott hatékony Alpha Modulate Fixed effektus adatokat adja vissza. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Hash függvényként szolgál egy adott típushoz. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Lekérdezi az objektum valós típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógiája. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípust referencia alapján hasonlít össze a nullptr-tel. |
...
| void [set_Amount](./set_amount/)(**float**) override | Az effektus százalékos mennyiségét adja vissza. Írható **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként (ahelyett, hogy megosztott) állítja be. Lehetővé teszi a mutatók átváltását gyenge módba a konténerekben. |
...
* Osztály [IAlphaModulateFixed](../ialphamodulatefixed/)
