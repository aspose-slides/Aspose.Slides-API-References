...
description: Lágy él hatást képvisel. Az alakzat szélei elmosódnak, míg a kitöltés nem érintett.
type: docs
weight: 1080
...
Lágy él hatást képvisel. Az alakzat szélei elmosódnak, míg a kitöltés nem érintett.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Megállapítja, hogy a megadott [SoftEdge](./) egyenlő-e a jelenlegi [SoftEdge](./). |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) szemantikájával hasonlítja össze az objektumokat. |
...
| **double** [get_Radius](./get_radius/)() override | Meghatározza a szélekre alkalmazandó elmosás sugarát. Olvasható **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Lekéri a hatékony Soft Edge effektus adatokat az öröklődés alkalmazásával. |
...
| void [set_Radius](./set_radius/)(**double**) override | Meghatározza a szélekre alkalmazandó elmosás sugarát. Írható **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként (a megoszttal szemben) állítja be. Lehetővé teszi a mutatók átkapcsolását a tárolókban gyenge módra. |
