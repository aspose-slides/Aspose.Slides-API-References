...
description: Hue/Saturation/Luminance effektust reprezentálja. A színárnyalat, a telítettség és a fényerő mindegyike az aktuális értékhez képest állítható.
type: docs
weight: 222
...
A Hue/Saturation/Luminance hatást reprezentálja. A színárnyalat, telítettség és fényerő minden egyes értéke állítható az aktuális értékhez képest.
...
| Módszer | Leírás |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Megállapítja, hogy a megadott [HSL](./) megegyezik az aktuális [HSL](./)-val. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | Lekéri a hatékony Hue/Saturation/Luminance effektus adatokat az öröklődés alkalmazásával. |
