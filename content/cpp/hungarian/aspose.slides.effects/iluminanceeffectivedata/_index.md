...
description: Luminancia effektust reprezentál. A fényerő lineárisan eltolja az összes színt a fehér vagy fekete felé. A kontraszt méretezi az összes színt, hogy azok közelebb vagy távolabb legyenek egymástól.
type: docs
weight: 807
url: /hu/aspose.slides.effects/iluminanceeffectivedata/
---
## ILuminanceEffectiveData osztály

Egy [Luminance](../luminance/) hatást képvisel. A fényerő lineárisan eltolja az összes színt a fehér vagy fekete felé. A kontraszt méretezi az összes színt, hogy azok közelebb vagy távolabb legyenek egymástól.
...
| virtual **float** [get_Brightness](./get_brightness/)() | Fényerő. Csak olvasható **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Kontraszt. Csak olvasható **float**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n'th sablonargumentumot **uint32_t**-ként gyenge mutatóra (a megosztott helyett) állítja. Lehetővé teszi a mutatók konténerekben való gyenge móddá kapcsolását. |
