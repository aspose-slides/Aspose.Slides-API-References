...
description: Alpha Floor effektust képviseli. Az 100%-nál kisebb alfa (átlátszóság) értékek nullára lesznek módosítva. Más szóval, minden részben átlátszó teljesen átlátszóvá válik.
type: docs
weight: 27
...
Az Alpha Floor effektust képviseli. Az 100%-nál kisebb alfa (átlátszóság) értékek nullára lesznek módosítva. Más szóval, minden részben átlátszó teljesen átlátszóvá válik.
...
| Módszer | Leírás |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Megállapítja, hogy a megadott [AlphaFloor](./) egyenlő-e a jelenlegi [AlphaFloor](./)-val. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | Lekéri a hatékony Alpha Floor effekt adatot az öröklődés alkalmazásával. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Hash-függvényként szolgál egy adott típusra. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi a pointerek konténerekben való gyenge módba történő váltását. |
...
* Osztály [IAlphaFloor](../ialphafloor/)
