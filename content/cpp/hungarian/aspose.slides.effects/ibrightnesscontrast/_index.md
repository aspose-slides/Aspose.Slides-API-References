...
description: Egy BrightnessContrast hatást képvisel. Beállítja a fényerőt és a kontrasztot.
type: docs
weight: 482
url: /hu/aspose.slides.effects/ibrightnesscontrast/
---
## IBrightnessContrast osztály
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolás alapú konstrukcióját. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (ahelyett, hogy megosztott lenne). Lehetővé teszi a mutatók tárolókban való gyenge módra való átkapcsolását. |
