...
description: Absztrakt képarakítási effektust reprezentál.
type: docs
weight: 729
url: /hu/aspose.slides.effects/iimagetransformoperation/
---
## IImageTransformOperation osztály


Absztrakt képarakítási effektust reprezentál.
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum a céltypus által leírt példányt képviseli-e. A C# 'is' operátor analógja. |
