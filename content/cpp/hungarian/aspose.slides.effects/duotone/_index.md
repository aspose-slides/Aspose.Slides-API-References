...
description: Duotone effektust reprezentál. Minden képpontnál a Color1 és Color2 színeket lineáris interpolációval kombinálja, hogy meghatározza az új színt a képpontra.
type: docs
weight: 157
...
Representál egy [Duotone](./) hatást. Minden képpontnál a Color1 és Color2 színeket lineáris interpolációval kombinálja, hogy meghatározza az új színt a képpontra.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Megállapítja, hogy a megadott [Duotone](./) egyenlő-e a jelenlegi [Duotone](./)-val. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color1](./get_color1/)() override | Visszaadja a cél színformátumot a sötét képpontokhoz. Csak olvasható [IColorFormat](../../aspose.slides/icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color2](./get_color2/)() override | Visszaadja a cél színformátumot a világos képpontokhoz. Csak olvasható [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotoneEffectiveData](../iduotoneeffectivedata/)\> [GetEffective](./geteffective/)() override | Lekéri a hatékony [Duotone](./) effektus adatot az öröklődés alkalmazásával. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n. sablonargumentumot gyenge mutatóra (nem megosztottra). Lehetővé teszi a mutatók átkapcsolását a tárolókban gyenge módra. |
