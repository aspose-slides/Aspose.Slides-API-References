...
description: Megváltoztathatatlan objektum, amely egy külső árnyék hatást képvisel.
type: docs
weight: 898
url: /hu/aspose.slides.effects/ioutershadoweffectivedata/
---
## IOuterShadowEffectiveData osztály

Megváltoztathatatlan objektum, amely egy külső árnyék hatást képvisel.
...
| virtual **float** [get_Direction](./get_direction/)() | Az árnyék iránya. Csak olvasható **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Az árnyék távolsága. Csak olvasható **double**. |
...
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Megadja, hogy az árnyék a forma forgatásakor forogjon-e együtt a formával. Csak olvasható **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Megadja a vízszintes méretezési tényezőt, a negatív méretezés tükrözést okoz. Csak olvasható **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Megadja a függőleges méretezési tényezőt, a negatív méretezés tükrözést okoz. Csak olvasható **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Az árnyék színe. Csak olvasható [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Megadja a vízszintes ferdítési szöget (fokban). Csak olvasható **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Megadja a függőleges ferdítési szöget (fokban). Csak olvasható **double**. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia-összehasonlítja az értéktípusú objektumot a nullptr-vel. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (meg osztott helyett). Lehetővé teszi a mutatók konténerekben való weak módra való váltását. |
