...
description: Color Change effektust reprezentál. A FromColor példányai a ToColor példányaival vannak helyettesítve.
type: docs
weight: 508
url: /hu/aspose.slides.effects/icolorchange/
---
## IColorChange osztály

Color Change effektust reprezentál. A FromColor példányai a ToColor példányaival vannak helyettesítve.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_FromColor](./get_fromcolor/)() | A szín, amely helyettesítésre kerül. Csak olvasható [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ToColor](./get_tocolor/)() | A szín, amely helyettesíti. Csak olvasható [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóvá (a megosztott helyett) állítja. Lehetővé teszi a mutatók átváltását a tárolókban gyenge módra. |
