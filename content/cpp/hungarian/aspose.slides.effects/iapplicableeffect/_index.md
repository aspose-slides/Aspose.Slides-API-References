...
type: docs
weight: 417
url: /hu/aspose.slides.effects/iapplicableeffect/
---
## IApplicableEffect osztály
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekéri az objektummal társított referenciacs Counter adatstruktúrát. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók tárolókban való weak módra való átváltását. |
