...
| Metódus | Leírás |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGlow](../iglow/)\> [CreateGlow](./createglow/)() | Létrehozza a [Glow](../glow/) hatást. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadow](../iinnershadow/)\> [CreateInnerShadow](./createinnershadow/)() | Létrehozza a belső árnyék hatást. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOuterShadow](../ioutershadow/)\> [CreateOuterShadow](./createoutershadow/)() | Létrehozza a külső árnyék hatást. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadow](../ipresetshadow/)\> [CreatePresetShadow](./createpresetshadow/)() | Létrehozza az előre beállított árnyék hatást. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IReflection](../ireflection/)\> [CreateReflection](./createreflection/)() | Létrehozza a [Reflection](../reflection/) hatást. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdge](../isoftedge/)\> [CreateSoftEdge](./createsoftedge/)() | Létrehozza a Lágy él hatást. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperationFactory](../iimagetransformoperationfactory/)\> [get_ImageTransformOperationFactory](./get_imagetransformoperationfactory/)() | Visszaadja a [ImageTransformOperationFactory](../imagetransformoperationfactory/). Csak-olvasásra szánt [IImageTransformOperationFactory](../iimagetransformoperationfactory/). |
...
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Referenciával hasonlít össze objektumokat. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Referenciával hasonlít össze objektumokat. |
