...
description: Megváltoztathatatlan objektum, amely egy színcsere hatást képvisel. Az összes hatásszín rögzített színre változik. Az alfa értékek változatlanok.
type: docs
weight: 547
url: /hu/aspose.slides.effects/icolorreplaceeffectivedata/
---
## IColorReplaceEffectiveData osztály
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Visszaadja a színformátumot, amely minden pixel színét helyettesíti. Csak olvasható [System::Drawing::Color](../../system.drawing/color/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másolási konstruktorát. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában nem másol semmit, csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másolási konstruktorát. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Összehasonlítja az objektumokat referencián alapuló módon. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Összehasonlítja az objektumokat referencián alapuló módon. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencián keresztül hasonlítja össze az értéktípusú objektumot a nullptr értékkel. |
