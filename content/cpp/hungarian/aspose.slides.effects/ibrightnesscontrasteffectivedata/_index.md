...
description: Változtathatatlan objektum, amely egy BrightnessContrast hatást képvisel. Állítja a fényerőt és a kontrasztot
type: docs
weight: 495
url: /hu/aspose.slides.effects/ibrightnesscontrasteffectivedata/
---
## IBrightnessContrastEffectiveData osztály

Változtathatatlan objektum, amely egy [BrightnessContrast](../brightnesscontrast/) hatást képvisel. Állítja a fényerőt és a kontrasztot.
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Összehasonlít érték típusú objektumokat C# stílusban. |
...
| virtual **float** [get_Brightness](./get_brightness/)() | Visszaadja a fényerőt. Csak olvasható **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Visszaadja a kontrasztot. Csak olvasható **float**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók konténerben való weak módba váltását. |
