...
description: Ábrázol egy Alpha Ceiling hatást. Az alfa (átlátszóság) értékek, amelyek nagyobbak, mint nulla, 100%-ra változnak. Más szóval, minden részben átlátszó teljesen átlátszatlanná válik.
type: docs
weight: 261
url: /hu/aspose.slides.effects/ialphaceiling/
---
## IAlphaCeiling osztály
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol a két NaN egyenlőnek tekintendő, bár az IEC 60559:1989 szerint a NaN nem egyenlő semmivel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol a két NaN egyenlőnek tekintendő, bár az IEC 60559:1989 szerint a NaN nem egyenlő semmivel, beleértve a NaN-t is. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi a pointerek átváltását konténerekben gyenge módra. |
