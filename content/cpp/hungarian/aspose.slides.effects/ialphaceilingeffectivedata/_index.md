...
description: Változtathatatlan objektum, amely egy Alpha Ceiling hatást képvisel. Az Alpha (átlátszóság) értékei, amelyek nagyobbak, mint nulla, 100%-ra változnak. Más szóval, minden részben átlátszatlan teljesen átlátszatlanná válik.
type: docs
weight: 274
url: /hu/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData osztály

Változtathatatlan objektum, amely egy Alpha Ceiling hatást képvisel. Az Alpha (átlátszóság) értékei, amelyek nagyobbak, mint null, 100%-ra változnak. Más szóval, minden részben átlátszatlan teljesen átlátszatlanná válik.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átváltását konténerekben gyenge módba. |
