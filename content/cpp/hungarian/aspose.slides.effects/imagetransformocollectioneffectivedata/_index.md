...
description: Immutable objektum, amely egy csak olvasható hatékony képtranszformációs hatások gyűjteményét reprezentálja.
type: docs
weight: 820
...
Az immutable objektum egy csak olvasható hatékony képtranszformációs hatások gyűjteményét reprezentálja.
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Visszaad egy iterátort, amely a gyűjtemény utolsó const-kvalifikált (ha van) elemét követően helyezkedik el. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>, **int32_t**) override | Az összes elemet a gyűjteményből a megadott tömbbe másolja. |
| [iterator](./iterator/) [end](./end/)() | Visszaad egy iterátort, amely a gyűjtemény utolsó (ha van) elemét követően helyezkedik el. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Visszaad egy iterátort, amely a const-kvalifikált példány utolsó (ha van) elemét követően helyezkedik el. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Megállapítja, hogy a megadott objektum egyenlő-e a jelenlegi objektummal. |
...
| **int32_t** [get_Count](./get_count/)() override | Visszaadja a gyűjteményben lévő képeffektusok számát. Csak olvasható **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végig iterál a gyűjteményen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) override | Az index alapján visszaadja az elemet. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy értéksorozat átlagát, amelyet a bemeneti sorozat minden elemére alkalmazott transzformációs függvény ad. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | A sorozat minden elemét egy új formába alakítja át az elem indexének felhasználásával. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden elemre egy projekciót alkalmaz, és az eredményül kapott sorozatokat egyesíti egy sorozatba. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi, hogy a tárolók mutatóit gyenge módba állítsa. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Visszaad egy iterátort, amely a const-kvalifikált példány első (ha van) elemére mutat a gyűjteményben. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Visszaad egy iterátort, amely a const-kvalifikált példány utolsó (ha van) elemét követően helyezkedik el a gyűjteményben. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Visszaad egy iterátort, amely a gyűjtemény utolsó (ha van) elemét követően helyezkedik el. |
...
| Typedef | Leírás |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Olyan gyűjteménytípust, amelynek iterátor típusait a jelenlegi gyűjtemény iterátor típusaiként használja. |
...
Az IImageTransformOperationCollectionEffectiveData neve [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/)-ra van csonkítva, mivel a COM nevek hossza nem haladhatja meg a 39 karaktert.

## Lásd még

* Osztály [IEffectiveData](../../aspose.slides/ieffectivedata/)
* Osztály [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/)
