...
description: Alpha Floor hatást reprezentál. Az 100%-nál kisebb Alpha (átlátszóság) értékeket nullára állítja. Más szóval, minden részben átlátszó teljesen átlátszóvá válik.
type: docs
weight: 287
...
Alpha Floor hatást reprezentál. Az 100%-nál kisebb Alpha (átlátszóság) értékek nullára módosulnak. Más szóval, minden részben átlátszó teljesen átlátszóvá válik.
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenciaként hasonlítja össze az értéktípust a nullptr-tel. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Lekéri a megosztott referenciák számoló aktuális értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott referenciák számát. Nem szabad közvetlenül hívni; helyette használd az okos mutatókat vagy a ThisProtector-t. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott referenciák számát. Nem szabad közvetlenül hívni; helyette használd az okos mutatókat vagy a ThisProtector-t. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Növeli a gyenge referenciák számát. Nem szabad közvetlenül hívni; helyette használd az okos mutatókat vagy a ThisProtector-t. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Csökkenti a gyenge referenciák számát. Nem szabad közvetlenül hívni; helyette használd az okos mutatókat vagy a ThisProtector-t. |
