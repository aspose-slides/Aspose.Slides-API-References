...
description: Előre beállított árnyékhatást ábrázol.
type: docs
weight: 1054
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Meghatározza, hogy a megadott [PresetShadow](./) egyenlő-e a jelenlegi [PresetShadow](./)-val. |
...
| **float** [get_Direction](./get_direction/)() override | Az árnyék iránya. Olvasható **float**. |
| **double** [get_Distance](./get_distance/)() override | Az árnyék távolsága. Olvasható **double**. |
...
| [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() override | Preset. Olvasható [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | Az árnyék színe. Csak olvasható [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadowEffectiveData](../ipresetshadoweffectivedata/)\> [GetEffective](./geteffective/)() override | Lekéri a hatékony Preset Shadow effektus adatot az öröklődés alkalmazásával. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Egy adott típus hash függvényeként szolgál. |
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás zárását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) figyelő objektumot. |
...
| void [set_Direction](./set_direction/)(**float**) override | Az árnyék iránya. **float** írás. |
| void [set_Distance](./set_distance/)(**double**) override | Az árnyék távolsága. **double** írás. |
| void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) override | Preset. Írás [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-dik sablonargumentumot gyenge pointerre (a shared helyett). Lehetővé teszi a tárolókban a pointerek gyenge módra való átkapcsolását. |
...
* Osztály [IPresetShadow](../ipresetshadow/)
