...
description: Ábrázolja az Alpha kettős szintű effektust. Az Alpha (Átlátszóság) értékek, amelyek kisebbek a küszöbnél, 0-ra (teljesen átlátszó) változnak, míg a küszöbnél nagyobb vagy egyenlő Alpha értékek 100%-ra (teljesen átlátszatlan) változnak.
type: docs
weight: 235
url: /hu/aspose.slides.effects/ialphabilevel/
---
## IAlphaBiLevel osztály

Ábrázolja az Alpha kettős szintű effektust. Az Alpha (Átlátszóság) értékek, amelyek kisebbek a küszöbnél, 0-ra (teljesen átlátszó) változnak, míg a küszöhnél nagyobb vagy egyenlő Alpha értékek 100%-ra (teljesen átlátszatlan) változnak.
...
| virtual **float** [get_Threshold](./get_threshold/)() | Visszaadja a hatás küszöbét. Olvasás **float**. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Lekéri az objektum valós típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógiája. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum a targetType által leírt típus példánya-e. A C# 'is' operátor analógiája. |
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás zárolását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) jelzőobjektumot. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Visszaadja a hatás küszöbét. Írás **float**. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Lekéri a megosztott referenciacsounter aktuális értékét. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() utasítás feloldását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) jelzőobjektumot. |
...
Használja a [ImageTransformOperationFactory](../imagetransformoperationfactory/)-t COM-ban példányok létrehozásához. 
