...
description: Kétfokozatú (fekete/fehér) hatást reprezentál. A megadott küszöbértéknél alacsonyabb fényerősségű bemeneti színeket feketévé alakítja. A megadott értéknél egyenlő vagy nagyobb fényerősségű bemeneti színeket fehérre állítja. Az alfa hatás értékek erre a hatásra nincsenek hatással.
type: docs
weight: 92
...
| Metódus | Leírás |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Meghatározza, hogy a megadott [BiLevel](./) egyenlő-e az aktuális [BiLevel](./)-val. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevelEffectiveData](../ibileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Lekéri az alkalmazott öröklődéssel rendelkező effektív Bi-Level hatás adatokat. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Az adott típus hash függvényeként szolgál. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolati konstrukcióját. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n'th sablonargumentumot gyenge mutatóként állítja be (a megosztott helyett). Lehetővé teszi a tárolók mutatóinak gyenge módra váltását. |
