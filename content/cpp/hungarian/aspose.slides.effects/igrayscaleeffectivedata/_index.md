...
description: Változtathatatlan objektum, amely egy Gray Scale hatást reprezentál. Átalakítja az összes effektus színértéket egy szürke árnyalatba, amely megfelel a luminanciájuknak. Az effektus alfa (átlátszóság) értékek változatlanok.
type: docs
weight: 677
url: /hu/aspose.slides.effects/igrayscaleeffectivedata/
---
## IGrayScaleEffectiveData osztály

Elváltozhatatlan objektum, amely egy Gray Scale hatást reprezentál. Az összes effektus színértéket egy szürke árnyalatra alakítja, amely megfelel a luminanciájuknak. Az effekt alfa (átlátszóság) értékek változatlanok.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Az C#-stílusú lebegőpontos összehasonlítást emulálja, ahol két NaN egyenlőnek tekinthető még akkor is, ha az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Az C#-stílusú lebegőpontos összehasonlítást emulálja, ahol két NaN egyenlőnek tekinthető még akkor is, ha az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a mutatók konténerekben való gyenge módra történő átváltását. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | A C# [Object.ToString()](../../system/object/tostring/) metódus analógiája. Lehetővé teszi egyéni objektumok karakterláncra konvertálását. |
