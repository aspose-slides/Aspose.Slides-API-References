...
description: Egy Tint hatást reprezentál. A hatás színértékeit a megadott mennyiséggel a színárnyalat felé vagy ellenkező irányba tolja.
type: docs
weight: 989
...
Egy [Tint](../tint/) hatást reprezentál. Az effektus színértékeit a megadott mennyiségben a színárnyalás felé vagy ellenkező irányba tolja.
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Lekérdezi a hatékony adatot az öröklődés alkalmazásával. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók konténerekben való gyenge módra való átkapcsolását. |
