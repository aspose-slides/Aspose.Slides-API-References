...
description: Ábrázolja a belső árnyék hatást.
type: docs
weight: 768
url: /hu/aspose.slides.effects/iinnershadow/
---
## IInnerShadow osztály

Ábrázolja a belső árnyék hatást.
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) sugár. Olvassa **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Az árnyék iránya. Olvassa **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Az árnyék távolsága. Olvassa **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csak új objektumot inicializál, és lehetővé teszi a származtatott osztályok másoló konstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában nem másol semmit, csak új objektumot inicializál, és lehetővé teszi a származtatott osztályok másoló konstrukcióját. |
...
| virtual void [set_BlurRadius](./set_blurradius/)(**double**) | [Blur](../blur/) sugár. Írja **double**. |
| virtual void [set_Direction](./set_direction/)(**float**) | Az árnyék iránya. Írja **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Az árnyék távolsága. Írja **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módra való átváltását. |
