...
description: Ábrázolja egy Alpha Inverz hatást. Az Alpha (átlátszatlanság) értékek 100%-ról való kivonással invertálódnak.
type: docs
weight: 313
url: /hu/aspose.slides.effects/ialphainverse/
---
## IAlphaInverse osztály

Ábrázolja az Alfa Inverz hatást. Az Alfa (átlátszatlanság) értékek 100%-ról való kivonással invertálódnak.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában semmit sem másol, csak új objektumot inicializál, és lehetővé teszi alkönyvtárak másolókonstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában semmit sem másol, csak új objektumot inicializál, és lehetővé teszi alkönyvtárak másolókonstrukcióját. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a shared helyett). Lehetővé teszi a mutatók konténerben való gyenge módra váltását. |
