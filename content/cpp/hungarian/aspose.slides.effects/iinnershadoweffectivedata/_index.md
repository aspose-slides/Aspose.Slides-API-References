...
description: Megváltoztathatatlan objektum, amely egy belső árnyék hatást reprezentál.
type: docs
weight: 781
url: /hu/aspose.slides.effects/iinnershadoweffectivedata/
---
## IInnerShadowEffectiveData osztály

Megváltoztathatatlan objektum, amely egy belső árnyék hatást reprezentál.
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás zárolását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) szánházi objektumot. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi pointerek átváltását a tárolókban gyenge módra. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() utasítás feloldását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) szánházi objektumot. |
