...
description: Egy Tint effektust ábrázol. Az effektus színértékeit a megadott mennyiségben eltolja a színárnyalathoz közeledve vagy távolodva.
type: docs
weight: 1093
...
Represent a [Tint](./) effect. Shifts effect color values towards/away from hue by the specified amount.
...
| Method | Leírás |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Megállapítja, hogy a megadott [Tint](./) egyenlő-e a jelenlegi [Tint](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | Lekéri az alkalmazott öröklődéssel együtt a hatékony [Tint](./) effektus adatot. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablon argumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását gyenge módra a konténerekben. |
