...
A [IImageTransformOperation](../iimagetransformoperation/) interfészt reprezentálja.
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Visszaadja az objektumhoz tartozó referenciacs Counter adatstruktúrát. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóra (nem megosztottra) állítja be. Lehetővé teszi a konténerekben a mutatók gyenge módra való átállítását. |
