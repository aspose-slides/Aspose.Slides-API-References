...
description: Megváltoztathatatlan objektum, amely egy Glow effektust reprezentál, és amelynek színárnyékos körvonala az objektum széleihez kívül kerül.
type: docs
weight: 651
...
Megváltoztathatatlan objektum, amely egy [Glow](../glow/) hatást reprezentál, és amely egy színárnyékos körvonalat ad hozzá az objektum széleihez kívül.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Color. Csak olvasható [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_Radius](./get_radius/)() | Radius. Csak olvasható **double**. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadás operátor. Valójában semmit sem másol, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolókonstrukcióját. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a tárolókban a mutatók gyenge módra való átváltását. |
