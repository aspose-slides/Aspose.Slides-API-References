...
type: docs
weight: 911
url: /hu/aspose.slides.effects/ipresetshadow/
---
## IPresetShadow osztály
...
| virtual **float** [get_Direction](./get_direction/)() | Az árnyék iránya. Olvas **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Az árnyék távolsága. Olvas **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Előbeállítás. Olvas [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Az árnyék színe. Csak olvasható [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Az árnyék iránya. Ír **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Az árnyék távolsága. Ír **double**. |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | Előbeállítás. Ír [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását a konténerekben gyenge módra. |
