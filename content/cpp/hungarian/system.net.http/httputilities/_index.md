...
description: Tartalmazza a segédmetódusokat.
type: docs
weight: 131
url: /hu/system.net.http/httputilities/
---
## HttpUtilities osztály

Tartalmazza a segédmetódusokat.
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Ellenőrzi, hogy a megadott URI HTTP URI-e. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonparamétert gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók konténerben való átkapcsolását gyenge módba. |
...
| Field | Leírás |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | Az alapértelmezett HTTP verzió kérések küldéséhez. |
| static [DefaultResponseVersion](./defaultresponseversion/) | Az alapértelmezett HTTP verzió válaszok fogadásához. |
