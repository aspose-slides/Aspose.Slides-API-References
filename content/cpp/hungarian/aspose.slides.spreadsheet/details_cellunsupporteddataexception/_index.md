...
description: Az a kivétel, amely akkor dobódik, amikor egy nem támogatott adatot találnak egy táblázat cellájában.
type: docs
weight: 40
url: /hu/aspose.slides.spreadsheet/details_cellunsupporteddataexception/
---
## Details_CellUnsupportedDataException osztály

Az a kivétel, amely akkor dobódik, amikor egy nem támogatott adatot találnak egy táblázat cellájában.
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Visszaadja a stack trace-et tartalmazó karakterláncot. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum egy példányát képezi-e a targetType által leírt típusnak. A C# 'is' operátor analógja. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Beállítja a HRESULT-ot, egy kódolt numerikus értéket, amely egy adott kivételhez van rendelve. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Megvalósítja a [what()](../../system/details_exception/what/) metódust, amelyet a [ExceptionWrapper](../../system/exceptionwrapper/) osztály hív. Annak ellenére, hogy ez az osztály nem öröklődik a std::exception-ből, a leszármazott osztályok használhatják a protected/private tagokat a logika megvalósításához. Ennek a metódusnak a [ExceptionWrapper](../../system/exceptionwrapper/)-ba való áthelyezése megbontja azt a logikát. |
