...
| Method | Description |
| --- | --- |
| void [Dispose](./dispose/)() override | Felszabadítja a jelenlegi objektum által felvett operációs rendszer erőforrásait. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](./get_families/)() | Visszaad egy tömböt a [FontFamily](../../system.drawing/fontfamily/) objektumokból, amelyek a jelenlegi objektum által képviselt betűkészlethez kapcsolódnak. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablon argumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konvertálását tárolókban gyenge módra. |
