...
| Módszer | Leírás |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../../aspose.slides/iplaceholder/)\> [AddPlaceholder](../../aspose.slides/ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../../aspose.slides/iplaceholder/)\>) | Új helyőrzőt ad hozzá, ha nincs, és beállítja a helyőrző tulajdonságait egy megadottra. |
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső felhasználásra csak. |
...
| virtual [Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/) [get_BlackWhiteMode](../../aspose.slides/ishape/get_blackwhitemode/)() | A tulajdonság meghatározza, hogyan jelenik meg a forma fekete-fehér megjelenítési módban.. Read [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
...
| virtual **float** [get_Height](../../aspose.slides/ishape/get_height/)() | Lekéri a forma magasságát pontokban. Read **float**. |
| virtual **bool** [get_Hidden](../../aspose.slides/ishape/get_hidden/)() | Megállapítja, hogy a forma rejtett-e. Read **bool**. |
...
| virtual **bool** [get_IsDecorative](../../aspose.slides/ishape/get_isdecorative/)() | Lekéri a “Mark as decorative” opciót Reed/write **bool**. |
| virtual **bool** [get_IsGrouped](../../aspose.slides/ishape/get_isgrouped/)() | Megállapítja, hogy a forma csoportosított-e. Read-only **bool**. |
| virtual **bool** [get_IsTextHolder](../../aspose.slides/ishape/get_istextholder/)() | Megállapítja, hogy a forma TextHolder-e. Read-only **bool**. |
...
| virtual **float** [get_Width](../../aspose.slides/ishape/get_width/)() | Lekéri a forma szélességét pontokban. Read **float**. |
| virtual **float** [get_X](../../aspose.slides/ishape/get_x/)() | Lekéri a forma bal felső sarkának x-koordinátáját pontokban. Read **float**. |
| virtual **float** [get_Y](../../aspose.slides/ishape/get_y/)() | Lekéri a forma bal felső sarkának y-koordinátáját pontokban. Read **float**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a mutatók konténerben való gyenge módra váltását. |
