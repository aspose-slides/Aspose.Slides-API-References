...
description: "DSA aláírás létrehozására használható. Az osztály objektumait csak a System::MakeObject() függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stacken vagy az new operátorral, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót az objektum függvényeknek argumentumként történő átadásához."
type: docs
weight: 170
url: /hu/system.security.cryptography/dsasignatureformatter/
---
## DSASignatureFormatter osztály

Használatos egy [DSA](../dsa/) aláírás létrehozására. Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stacken vagy az new operátorral, mert ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót a függvények argumentumaként való átadásra.
...
| Metódus | Leírás |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [CreateSignature](./createsignature/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | NINCS MEGVALÓSÍTVA. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia-szerűen hasonlítja össze az értéktípusú objektumot a nullptr-el. |
...
| void [SetHashAlgorithm](./sethashalgorithm/)([String](../../system/string/)) override | NINCS MEGVALÓSÍTVA. |
| void [SetKey](./setkey/)([SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](../asymmetricalgorithm/)\>) override | NINCS MEGVALÓSÍTVA. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonparamétert gyenge mutatóvá (a megosztott helyett). Lehetővé teszi a mutatók konténerben történő átváltását gyenge módra. |
