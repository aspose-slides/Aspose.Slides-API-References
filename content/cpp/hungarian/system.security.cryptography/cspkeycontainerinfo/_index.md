...
description: További információ egy kriptográfiai kulcspárról.
type: docs
weight: 66
url: /hu/system.security.cryptography/cspkeycontainerinfo/
---
## CspKeyContainerInfo osztály

További információ egy kriptográfiai kulcspárról.
...
| **bool** [get_Accessible](./get_accessible/)() const | Visszaad egy jelzőt, amely jelzi, hogy a tárolóban lévő kulcs elérhető-e. |
| **bool** [get_Exportable](./get_exportable/)() const | Visszaad egy jelzőt, amely jelzi, hogy a kulcs exportálható-e a tárolóból. |
| **bool** [get_HardwareDevice](./get_hardwaredevice/)() const | Visszaad egy jelzőt, amely jelzi, hogy a kulcs hardveres kulcs-e. |
| [String](../../system/string/) [get_KeyContainerName](./get_keycontainername/)() const | Visszaad a kulcstároló nevét. |
| [SharedPtr](../../system/sharedptr/)\<[KeyNumber](../keynumber/)\> [get_KeyNumber](./get_keynumber/)() const | Visszaad egy KeyNumber objektumot. |
| **bool** [get_MachineKeyStore](./get_machinekeystore/)() const | Visszaad egy jelzőt, amely jelzi, hogy a kulcs betöltött-e a gép kulcstárból. |
| **bool** [get_Protected](./get_protected/)() const | Visszaad egy jelzőt, amely jelzi, hogy a kulcs védett-e a másolástól. |
| [String](../../system/string/) [get_ProviderName](./get_providername/)() const | Visszaad a szolgáltató nevét. |
| **int32_t** [get_ProviderType](./get_providertype/)() const | Visszaad a szolgáltató típusát. |
| **bool** [get_RandomlyGenerated](./get_randomlygenerated/)() const | Visszaad egy jelzőt, amely jelzi, hogy a kulcs véletlenszerűen lett-e generálva. |
| **bool** [get_Removable](./get_removable/)() const | Visszaad egy jelzőt, amely jelzi, hogy a kulcs eltávolítható-e a tárolóból. |
| [String](../../system/string/) [get_UniqueKeyContainerName](./get_uniquekeycontainername/)() const | Visszaad egy egyedi tárolónevet. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Visszaad az objektumhoz tartozó referenciaszámláló adatstruktúrát. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja sztring és nullptr esetén. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja sztringek esetén. |
