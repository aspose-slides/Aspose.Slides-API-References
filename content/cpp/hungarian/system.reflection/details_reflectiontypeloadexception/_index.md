...
description: "A ReflectionTypeLoadException-t a Module.GetTypes metódus dobja, ha egy modulban lévő osztályok betöltése meghiúsul. Soha ne hozzon létre példányt ebből az osztályból manuálisan. Használja helyette a ReflectionTypeLoadException osztályt. Soha ne csomagolja be a ReflectionTypeLoadException osztály példányait a System::SmartPtr-be."
type: docs
weight: 66
url: /hu/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException osztály


ReflectionTypeLoadException-t a Module.GetTypes metódus dobja, ha egy modulban lévő osztályok betöltése sikertelen. Soha ne hozzon létre példányt ebből az osztályból manuálisan. Használja helyette a ReflectionTypeLoadException osztályt. Soha ne csomagolja be a ReflectionTypeLoadException osztály példányait a [System::SmartPtr](../../system/smartptr/)-ba.
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | Visszaad egy referenciát az belső kivételt képviselő objektumra. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | Visszaadja azokat a kivételeket, amelyek ezt a kivételt okozzák. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | Visszaadja a kivétel okainak típusinformációit. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadás operátor. Valójában nem másol semmit, csak inicializál egy új objektumot és lehetővé teszi az alosztályok másolókonstrukcióját. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia-szerűen hasonlítja az érték típusú objektumot a nullptr-hez. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Megvalósítja a [what()](../../system/details_exception/what/) metódust, amelyet a [ExceptionWrapper](../../system/exceptionwrapper/) osztály hív. Annak ellenére, hogy ez az osztály nem származik a std::exception-ből, a származtatott osztályok védett / privát tagokat használhatnak a logika megvalósításához. Ennek a metódusnak a [ExceptionWrapper](../../system/exceptionwrapper/)-ba áthelyezése felboríthatja azt a logikát. |
