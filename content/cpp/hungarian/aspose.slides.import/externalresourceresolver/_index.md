...
description: Visszahívási (callback) osztály, amely a külső erőforrások feloldására szolgál HTML és SVG dokumentumok importálása során.
type: docs
weight: 14
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekinthető, bár az IEC 60559:1989 szerint a NaN nem egyenlő egyetlen értékkel sem, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekinthető, bár az IEC 60559:1989 szerint a NaN nem egyenlő egyetlen értékkel sem, beleértve a NaN-t is. |
|  [ExternalResourceResolver](./externalresourceresolver/)() |  |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső használatra. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekéri az objektumhoz tartozó referenciacsámláló adatstruktúrát. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) override | URI-t leképez egy objektumra, amely a tényleges erőforrást tartalmazza. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenciával hasonlít össze egy értéktípusú objektumot a nullptr-vel. |
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Feloldja az abszolút URI-t az alap és relatív URI-kból. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablon argumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerben való gyenge módra váltását. |
...
Ennek a feloldónak a használata sebezhetőséget eredményezhet, ha a kliens által biztosított HTML vagy SVG fájl arra készteti a szerver szoftvert, hogy helyi vagy hálózati fájlt szerezzen be. Óvatosan használja. Ajánlott, hogy egyáltalán ne adja meg a(z) [ExternalResourceResolver](./) értéket (csak a beágyazott objektumok lesznek olvasva), vagy hozzon létre egy alosztályt, amely ellenőrzi, hogy a megadott URI érvényes-e.

## Lásd még

* Osztály [IExternalResourceResolver](../iexternalresourceresolver/)
