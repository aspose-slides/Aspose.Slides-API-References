...
description: "A táblán működő nézet. Ennek az osztálynak az objektumait csak a System::MakeObject() függvénnyel szabad lefoglalni. Soha ne hozzon létre példányt ezen a típuson a stack-en vagy az operator new használatával, mivel ez futásidejű hibákhoz és/vagy állítási hibákhoz vezet. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót az argumentumként funkciókhoz való átadásra."
type: docs
weight: 131
url: /hu/system.data/dataview/
---
## DataView osztály
...
| **int32_t** [get_Count](./get_count/)() | RTTI információ. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataTable](../datatable/)\> [get_Table](./get_table/)() | Lekéri azt a táblát, amelyhez a nézet tartozik. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataRowView](../datarowview/)\> [idx_get](./idx_get/)(const **int32_t**) | Lekéri a sor nézeteket. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia-szerűen hasonlítja össze az érték típusú objektumot a nullptr-tel. |
