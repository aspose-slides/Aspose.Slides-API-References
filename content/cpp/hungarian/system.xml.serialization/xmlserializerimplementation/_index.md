...
description: Belső osztály az XmlSerializer használatához.
type: docs
weight: 79
url: /hu/system.xml.serialization/xmlserializerimplementation/
---
## XmlSerializerImplementation osztály

Belső osztály a [XmlSerializer](../xmlserializer/) használatához.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# stílusban összehasonlítja a referencia típusú objektumokat. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekéri az objektummal kapcsolódó referenciacsounter adatstruktúrát. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-dik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását a gyenge módra a tárolókban. |
