...
description: Az időzítő esemény argumentumai.
type: docs
weight: 1
url: /hu/system.timers/elapsedeventargs/
---
## ElapsedEventArgs osztály

Az időzítő esemény argumentumai.
...
| Metódus | Leírás |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | Létrehozza a paraméterekkel megadott argumentumobjektumot. |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | Lekéri a jel időpontját. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Nem másol semmit, csak inicializálja az új objektumot, és lehetővé teszi az alosztályok másolásos konstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Hozzárendelési operátor. Nem másol semmit, csak inicializálja az új objektumot, és lehetővé teszi az alosztályok másolásos konstrukcióját. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók konténerekben való átváltását gyenge módra. |
...
| Mező | Leírás |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Egy statikus tag, amely egy \"üres\" [EventArgs](../../system/eventargs/) megosztott mutatót (null-pointer) képviseli. |

## Lásd még

* Osztály [EventArgs](../../system/eventargs/)
* Névtér [System::Timers](../)
