...
description: Glitter diavetítés-átmeneti hatás.
type: docs
weight: 53
...
Glitter diavetítés-átmeneti hatás.
...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | Az átmenet iránya. Olvassa el [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | Megadja az átmenet során használt vizuális elemek alakját. Olvassa el [TransitionPattern](../transitionpattern/). |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Hash függvényként szolgál egy adott típushoz, amely alkalmas hash algoritmusokban és olyan adatstruktúrákban, mint a hash tábla, való használatra. |
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | Az átmenet iránya. Írja [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | Megadja az átmenet során használt vizuális elemek alakját. Írja [TransitionPattern](../transitionpattern/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonparamétert gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók átkapcsolását gyenge módba konténerekben. |
...
* Osztály [IGlitterTransition](../iglittertransition/)
