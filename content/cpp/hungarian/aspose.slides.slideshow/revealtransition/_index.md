...
description: Diavetítés felfedését végző átmeneti hatás.
type: docs
weight: 352
...
A diák felfedéséhez használt átmeneti hatás.
...
| [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() override | Átmenet iránya. Olvasd [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| **bool** [get_ThroughBlack](./get_throughblack/)() override | Megadja, hogy az átmenet feketén keresztül halványodjon-e. Olvasd **bool**. |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | A megadott típus hash-függvényeként szolgál, amely alkalmas hash-algoritmusokban és hash-táblához hasonló adatstruktúrákban való használatra. |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | Átmenet iránya. Írd [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | Megadja, hogy az átmenet feketén keresztül halványodjon-e. Írj **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-dik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi a konténerekben lévő pointerek gyenge módra történő váltását. |
...
* Osztály [IRevealTransition](../irevealtransition/)
