...
description: Ripple csúszási áttűnés effektus.
type: docs
weight: 222
url: /hu/aspose.slides.slideshow/irippletransition/
---
## IRippleTransition osztály

Ripple csúszási áttűnés effektus.
...
| virtual [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) [get_Direction](./get_direction/)() | Az áttűnés iránya. Olvassa el [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot nullptr-re referencia szerint hasonlít össze. |
...
| virtual void [set_Direction](./set_direction/)([TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)) | Az áttűnés iránya. Írja [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
