...
description: Hullámzó diaátmeneti hatás.
type: docs
weight: 313
...
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | Morph átmenet típusa. Olvassa el a [TransitionMorphType](../transitionmorphtype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktőr. Valójában semmit nem másol, csak új objektumot inicializál és lehetővé teszi alosztályok másoló konstrukcióját. |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | Morph átmenet típusa. Írja be a [TransitionMorphType](../transitionmorphtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonparamétert gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módban való átkapcsolását. |
...
* Osztály [IMorphTransition](../imorphtransition/)
