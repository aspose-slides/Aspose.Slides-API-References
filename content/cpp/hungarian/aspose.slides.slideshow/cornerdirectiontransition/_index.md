...
| [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() override | Az átmenet iránya. Olvassa [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
...
| void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) override | Az átmenet iránya. Írja [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók konténerben való gyenge üzemmódra váltását. |
...
* Osztály [ICornerDirectionTransition](../icornerdirectiontransition/)
