...
---
## ISideDirectionTransition osztály
...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Az átmenet iránya. Olvas [TransitionSideDirectionType](../transitionsidedirectiontype/). |
...
| void [Lock](../../system/object/lock/)() | A C# lock() utasítást valósítja meg zároláshoz. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) ellenőrző objektumot. |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Az átmenet iránya. Ír [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablon argumentumot gyenge mutatóvá (a megosztott helyett) állítja. Lehetővé teszi a mutatók átkapcsolását a konténerekben gyenge módba. |
...
| void [Unlock](../../system/object/unlock/)() | A C# lock() utasítás feloldását valósítja meg. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) ellenőrző objektumot. |
