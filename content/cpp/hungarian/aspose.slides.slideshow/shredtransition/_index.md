...
description: Shred diaátmenet-effektus.
type: docs
weight: 378
...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Az átmenet iránya. Olvasd el a [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | Megadja az átmenet során használt vizuális elemek alakját. Olvasd el a [TransitionShredPattern](../transitionshredpattern/). |
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás zárolását. Hívja közvetlenül vagy használja a(z) [LockContext](../../system/lockcontext/) felügyeleti objektumot. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Átadási operátor. Valójában nem másol semmit, csak új objektumot inicializál és lehetővé teszi az alosztályok másoló konstrukcióját. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Az értéktípusú objektumot nullptr-el referencia szerint hasonlítja össze. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Az átmenet iránya. Írd [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | Megadja az átmenet során használt vizuális elemek alakját. Írd [TransitionShredPattern](../transitionshredpattern/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók konténerekben weak módra váltását. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() utasítás feloldását. Hívja közvetlenül vagy használja a(z) [LockContext](../../system/lockcontext/) felügyeleti objektumot. |
...
* Osztály [IShredTransition](../ishredtransition/)
