...
description: Sarokirányú diaátmeneti hatás.
type: docs
weight: 66
url: /hu/aspose.slides.slideshow/icornerdirectiontransition/
---
## ICornerDirectionTransition osztály


Sarok irányú diaátmenet hatás.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN semelyik értékkel, köztük a NaN-nel sem egyenlő. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN semelyik értékkel, köztük a NaN-nel sem egyenlő. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső használatra. |
| virtual [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() | Az átmenet iránya. Olvasd [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) | Az átmenet iránya. Írd [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonparamétert egy gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módra váltását. |
