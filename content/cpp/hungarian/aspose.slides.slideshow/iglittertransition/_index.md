...
description: Glitter diaátmeneti hatás.
type: docs
weight: 118
url: /hu/aspose.slides.slideshow/iglittertransition/
---
## IGlitterTransition osztály

Glitter diaátmeneti hatás.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# stílusban hasonlítja össze a referenciatípusú objektumokat. |
...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Az átmenet iránya. Olvassa el a [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | Megadja az átmenet során használt vizuális elemek alakját. Olvassa el a [TransitionPattern](../transitionpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Az átmenet iránya. Írja a [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | Megadja az átmenet során használt vizuális elemek alakját. Írja a [TransitionPattern](../transitionpattern/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonparamétert gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerben való gyenge módra váltását. |
