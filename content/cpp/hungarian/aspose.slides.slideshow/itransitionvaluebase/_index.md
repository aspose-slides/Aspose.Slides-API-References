...
description: Az diavetítés átmeneti effektusainak alaposztályát képviseli.
type: docs
weight: 274
url: /hu/aspose.slides.slideshow/itransitionvaluebase/
---
## ITransitionValueBase osztály

Az alaposztályt képviseli a diavetítés átmeneti effektusaihoz.

```cpp
class ITransitionValueBase : public virtual System::Object
```
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Megkapja az objektummal társított hivatkozásszámláló adatstruktúrát. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenciával hasonlít egy értéktípusú objektumot a nullptr-val. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonparaméterhez gyenge mutatót (nem megosztott) állít be. Lehetővé teszi a mutatók átváltását a gyenge módra konténerekben. |
