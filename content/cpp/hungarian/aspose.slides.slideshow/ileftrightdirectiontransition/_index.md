...
description: Bal-jobbra irányú diaátmeneti hatás.
type: docs
weight: 144
url: /hu/aspose.slides.slideshow/ileftrightdirectiontransition/
---
## ILeftRightDirectionTransition osztály

Bal-jobbra irányú diaátmeneti hatás.
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Az átmenet iránya. Olvassa [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | Az átmenet iránya. Írja [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
