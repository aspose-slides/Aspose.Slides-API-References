...
description: Nyolc irányú diaátmeneti effektus.
type: docs
weight: 79
url: /hu/aspose.slides.slideshow/ieightdirectiontransition/
---
## IEightDirectionTransition osztály


Nyolc irányú diaátmeneti effektus.
...
| virtual [TransitionEightDirectionType](../transitioneightdirectiontype/) [get_Direction](./get_direction/)() | Az átmenet iránya. Olvassa el [TransitionEightDirectionType](../transitioneightdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionEightDirectionType](../transitioneightdirectiontype/)) | Az átmenet iránya. Írja [TransitionEightDirectionType](../transitioneightdirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-dik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módba váltását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Megkapja a megosztott referenciaszámláló jelenlegi értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; ehelyett okos mutatókat vagy ThisProtector-t használjon. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; ehelyett okos mutatókat vagy ThisProtector-t használjon. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Növeli a gyenge referenciaszámlálót. Nem szabad közvetlenül hívni; ehelyett okos mutatókat vagy ThisProtector-t használjon. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Csökkenti a gyenge referenciaszámlálót. Nem szabad közvetlenül hívni; ehelyett okos mutatókat vagy ThisProtector-t használjon. |
