...
---
## IOptionalBlackTransition osztály
...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Ez az attribútum megadja, hogy az átmenet fekete képernyőn kezdődik-e (és ezután a új dia fekete felett kerül átmenetre). Olvas **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolásos konstruktorát. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolásos konstruktorát. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Ez az attribútum megadja, hogy az átmenet fekete képernyőn kezdődik-e (és ezután a új dia fekete felett kerül átmenetre). Írja **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (nem megosztottként) állítja be. Lehetővé teszi a mutatók konténerekben való weak módra váltását. |
