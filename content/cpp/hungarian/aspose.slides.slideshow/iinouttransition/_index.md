...
description: Bemenet-kimenet diaátmeneti hatás.
type: docs
weight: 131
url: /hu/aspose.slides.slideshow/iinouttransition/
---
## IInOutTransition osztály

Bemenet-kimenet diaátmenet hatás.
...
| Módszer | Leírás |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Objektumokat hasonlít össze a C# [Object.Equals](../../system/object/equals/) szemantikája használatával. |
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | A transzíció hatás iránya. Olvasd el [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | A transzíció hatás iránya. Írd [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Állítsa be az n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását gyenge módra a konténerekben. |
