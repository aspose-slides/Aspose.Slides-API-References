...
description: Egy olyan figyelmeztetést ábrázol, amely egy ismert, a közeljövőben nem megvalósítandó funkcióról szól.
type: docs
weight: 14
url: /hu/aspose.slides.warnings/inotimplementedwarninginfo/
---
## INotImplementedWarningInfo osztály


Egy olyan figyelmeztetést ábrázol, amely egy ismert, a közeljövőben nem megvalósítandó funkcióról szól.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Visszaadja ennek a figyelmeztetésnek az ember által olvasható leírását. Csak olvasható [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Visszaadja a figyelmeztetés típusát. Csak olvasható [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában semmit nem másol, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolón keresztüli létrehozását. |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Ha a fogadó nem null, befejezi a figyelmeztetést a megadott fogadónál, és dobja az AbortRequestedException kivételt, ha a fogadó úgy dönt, hogy megszakít egy műveletet. |
