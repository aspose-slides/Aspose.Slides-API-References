---
title: Marker
second_title: Aspose.Slides a C++-hoz API hivatkozás
description: A chert markerét reprezentálja.
type: docs
weight: 1301
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Lekéri a marker kitöltését. Csak olvasható [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | A marker méretét reprezentálja vonaldiagramban, pontdiagramban vagy radar diagramban. Olvasható **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | A marker stílusát reprezentálja vonaldiagramban, pontdiagramban vagy radar diagramban. Olvasható [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | A marker méretét reprezentálja vonaldiagramban, pontdiagramban vagy radar diagramban. Ír **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | A marker stílusát reprezentálja vonaldiagramban, pontdiagramban vagy radar diagramban. Ír [MarkerStyleType](../markerstyletype/). |
...
| virtual  [~Object](../../system/object/~object/)() | Megsemmisíti az objektumot. Felszabadítja az összes belsztő adatstruktúrát. |

## Lásd még

* Osztály [IMarker](../imarker/)
