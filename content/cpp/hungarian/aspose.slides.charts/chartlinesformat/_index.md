...
description: A rácsvonalak formátum tulajdonságait képviseli.
type: docs
weight: 235
...
A rácsvonalak formátum tulajdonságait képviseli.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() override | Visszaadja a diagramvonalhoz használt effektusokat. Csak olvasható [IEffectFormat](../../aspose.slides/ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_Line](./get_line/)() override | Visszaadja egy diagramvonal vonalstílus tulajdonságait. Csak olvasható [ILineFormat](../../aspose.slides/ilineformat/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók konténerekben gyenge módra történő átváltását. |
