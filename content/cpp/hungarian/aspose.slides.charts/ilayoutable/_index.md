...
| virtual **float** [get_Bottom](./get_bottom/)() | A diagram elem felső részét adja vissza a diagram magasságának hányadosaként. Csak olvasható **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Megadja a diagram elem magasságát a diagram magasságának hányadosaként. Olvasható **float**. |
...
| virtual **float** [get_Right](./get_right/)() | A diagram elem jobb oldalát adja vissza a diagram szélességének hányadosaként. Csak olvasható **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Megadja a diagram elem szélességét a diagram szélességének hányadosaként. Olvasható **float**. |
| virtual **float** [get_X](./get_x/)() | Megadja a diagram elem x helyzetét (bal) a diagram szélességének hányadosaként. Olvasható **float**. |
| virtual **float** [get_Y](./get_y/)() | Megadja a diagram elem felső részét a diagram magasságának hányadosaként. Olvasható **float**. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Hivatkozás alapján hasonlít össze értéktípusú objektumot a nullptr-tel. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja string és nullptr esetére. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja stringek esetére. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| virtual void [set_Height](./set_height/)(**float**) | Megadja a diagram elem magasságát a diagram magasságának hányadosaként. Írható **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Megadja a diagram elem szélességét a diagram szélességének hányadosaként. Írható **float**. |
| virtual void [set_X](./set_x/)(**float**) | Megadja a diagram elem x helyzetét (bal) a diagram szélességének hányadosaként. Írható **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Megadja a diagram elem felső részét a diagram magasságának hányadosaként. Írható **float**. |
