...
description: A diagramadatok munkafüzetének munkalapjait tartalmazó gyűjteményt reprezentálja.
type: docs
weight: 222
...
| Metódus | Leírás |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() | Az iterátort adja vissza, amely a gyűjtemény első elemére (ha van) mutat. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Az iterátort adja vissza, amely a gyűjtemény const-kvalifikált példányának első elemére (ha van) mutat. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Az első const-kvalifikált elemre mutató iterátort adja vissza (ha van) a gyűjteményben. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Az iterátort adja vissza, amely a gyűjtemény utolsó const-kvalifikált eleme után (ha van) mutat. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\>\>, **int32_t**) override | Másolja a megadott tömbbe. |
| [iterator](./iterator/) [end](./end/)() | Az iterátort adja vissza, amely a gyűjtemény utolsó eleme után (ha van) mutat. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Az iterátort adja vissza, amely a gyűjtemény const-kvalifikált példányának utolsó eleme után (ha van) mutat. |
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const&, T2 const&) | Az objektumokat referencia szerint hasonlítja össze C#-stílusban. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const&, T2 const&) | Az objektumokat érték szerint hasonlítja össze C#-stílusban. |
...
| **int32_t** [get_Count](./get_count/)() override | Visszaadja a számlálót. Csak olvasható **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végig iterál a gyűjteményen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [idx_get](./idx_get/)(**int32_t**) override | Visszaadja a munkalapot index alapján. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum a targetType által leírt típust képviseli-e. A C# ‘is’ operátor analógja. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy értékek sorozat átlagát, amelyet egy transzformáló függvény hívásával kapunk a bemeneti sorozat minden elemére. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Az elemeket a megadott típusra alakítja. |
...
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Visszaadja egy sorozat első elemét, amely megfelel a megadott feltételnek. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Visszaadja egy sorozat utolsó elemét, vagy alapértelmezett értéket, ha a sorozat üres. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Rendez egy sorozat elemeit emelkedő sorrendbe a keySelector által kiválasztott kulcsértékek alapján. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Minden egyes sorozatelemet új formába alakít át az elem indexének felhasználásával. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | A sorozat elemeit a megadott feltétel (predikátum) alapján szűri. |
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás zárását. Hívd közvetlenül vagy használd a [LockContext](../../system/lockcontext/) biztosító objektumot. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const&, std::nullptr_t) | Referencia összehasonlítás érték típusú objektummal és nullptr. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók konténereken belüli weak módba váltását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Megkapja a megosztott hivatkozásszámláló aktuális értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott hivatkozásszámlálót. Nem szabad közvetlenül meghívni; helyette használj okos mutatókat vagy ThisProtector-t. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott hivatkozásszámlálót. Nem szabad közvetlenül meghívni; helyette használj okos mutatókat vagy ThisProtector-t. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() utasítás feloldását. Hívd közvetlenül vagy használd a [LockContext](../../system/lockcontext/) biztosító objektumot. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Az iterátort adja vissza, amely a gyűjtemény const-kvalifikált példányának első elemére (ha van) mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Az iterátort adja vissza, amely a gyűjtemény első elemére (ha van) mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Az iterátort adja vissza, amely a gyűjtemény const-kvalifikált példányának utolsó eleme után (ha van) mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Az iterátort adja vissza, amely a gyűjtemény utolsó eleme után (ha van) mutat. |
...
| Typedef | Leírás |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Olyan gyűjteménytípus, amelynek iterátortípusai a jelenlegi gyűjtemény iterátortípusaiként használatosak. |
