...
description: Meghatározza a hibasáv értékeket. Csak akkor használható, ha a hibasáv értéktípusa egyéni.
type: docs
weight: 1015
url: /hu/aspose.slides.charts/ierrorbarscustomvalues/
---
## IErrorBarsCustomValues osztály


Meghatározza a hibasáv értékeket. Csak akkor használható, ha a hibasáv értéktípusa egyéni.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() | Meghatározza a hibasáv értékét a negatív irányban. Elérhető, ha a hibasáv értéktípusa egyéni és az ErrorBarsXFormat engedélyezett. Más esetben ez a tulajdonság null értéket ad vissza. 

Csak olvasható [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() | Meghatározza a hibasáv értékét a pozitív irányban. Elérhető, ha a hibasáv értéktípusa egyéni és az ErrorBarsXFormat engedélyezett. Más esetben ez a tulajdonság null értéket ad vissza. Csak olvasható [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() | Meghatározza a hibasáv értékét a negatív irányban. Elérhető, ha a hibasáv értéktípusa egyéni és az ErrorBarsYFormat engedélyezett. Más esetben ez a tulajdonság null értéket ad vissza. Csak olvasható [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() | Meghatározza a hibasáv értékét a pozitív irányban. Elérhető, ha a hibasáv értéktípusa egyéni és az ErrorBarsYFormat engedélyezett. Más esetben ez a tulajdonság null értéket ad vissza. Csak olvasható [IDoubleChartValue](../idoublechartvalue/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Nem másol semmit valójában, csak új objektumot inicializál, és lehetővé teszi az alosztályok másoló konstrukcióját. |
