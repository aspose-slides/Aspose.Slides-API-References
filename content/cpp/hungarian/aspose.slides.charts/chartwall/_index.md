...
description: A 3D diagramok falait ábrázolja.
type: docs
weight: 352
...
A 3D diagramok falait ábrázolja.
...
| Módszer | Leírás |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Objektumokat hasonlít össze a C# [Object.Equals](../../system/object/equals/) szemantikája alapján. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Visszaadja a fal kitöltését, vonalát, effektjét, 3D stílusait. Csak olvasható [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | Visszaadja vagy beállítja a kép típusát. Olvasás [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | Visszaadja a falak vastagságát a diagram térfogatának legnagyobb dimenziójához viszonyított százalékban. Olvasás **int32_t**. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | Visszaadja vagy beállítja a kép típusát. Írás [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | Beállítja a falak vastagságát a diagram térfogatának legnagyobb dimenziójához viszonyított százalékban. Írás **int32_t**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való átváltását gyenge módra. |
