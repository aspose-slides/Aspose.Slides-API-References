...
description: A sorozat címkéit ábrázolja.
type: docs
weight: 950
url: /hu/aspose.slides.charts/idatalabelcollection/
---
## IDataLabelCollection osztály

A sorozat címkéit ábrázolja.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Visszaad egy iterátort, amely a gyűjtemény utolsó const-kvalifikált elemét követően (ha van) helyezkedik el. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Visszaad egy iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó elemét (ha van) követi. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Visszaadja a gyűjteményben lévő összes adatcímke számát. Csak olvasható **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Visszaadja a gyűjteményben látható adatcímkék számát. Csak olvasható **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Visszaadja a gyűjteményben lévő összes adatcímke alapértelmezett formátumát. Csak olvasható [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | A hamis azt jelenti, hogy az adatcímke alapértelmezésben nem látható (és így a DefaultDataLabelFormat tulajdonság összes Show*-jelzője (ShowValue, ...) hamis). Csak olvasható **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | Az adatcímkék vezetővonalak formátumát képviseli. Csak olvasható [IChartLinesFormat](../ichartlinesformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Visszaadja a szülő diagram sorozatot. Csak olvasható [IChartSeries](../ichartseries/). |
...
| virtual void [Hide](./hide/)() | Alapértelmezésben elrejti az adatcímkét az összes Show*-jelző (ShowValue, ...) a DefaultDataLabelFormat tulajdonságban hamis állapotra állításával. Az IsVisible ezután hamis lesz. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Visszaadja a megadott indexű adatpont adatcímkéjét. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Visszaadja a megadott [DataLabel](../datalabel/) indexét a gyűjteményben. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Meghatározza, hogy a sorozat bármely eleme létezik-e vagy teljesíti a feltételt. |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Kiszámítja a numerikus értékek sorozatának átlagát. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja a sorozat értékeinek átlagát, amelyeket a bemeneti sorozat minden elemére egy transzformáló függvény meghívásával kapunk. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Minden egyes elemet egy új formába alakít át a sorozatban, figyelembe véve az elem indexét. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projekciót végez a sorozat minden elemére, majd a kapott sorozatokat egy sorozatba egyesíti. |
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítást zárolásként. Hívd közvetlenül, vagy használj [LockContext](../../system/lockcontext/) sentinel objektumot. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában semmit nem másol, csak új objektumot inicializál, és lehetővé teszi alosztályok másolását. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában semmit nem másol, csak új objektumot inicializál, és lehetővé teszi alosztályok másolását. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Érték típusú objektumot hivatkozás alapján hasonlít össze a nullptr-al. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() utasítás feloldását. Hívd közvetlenül, vagy használj [LockContext](../../system/lockcontext/) sentinel objektumot. |
