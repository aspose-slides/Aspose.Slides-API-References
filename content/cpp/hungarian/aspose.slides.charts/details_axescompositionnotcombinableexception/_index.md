...
description: Kivétel, amely akkor kerül dobásra, amikor a sorozat tengelyösszetétele nem kombinálható a diagram jelenlegi tengelyösszetételével.
type: docs
weight: 430
url: /hu/aspose.slides.charts/details_axescompositionnotcombinableexception/
---
## Details_AxesCompositionNotCombinableException osztály


Kivétel, amely akkor kerül dobásra, amikor a sorozat tengelyösszetétele nem kombinálható a diagram jelenlegi tengelyösszetételével.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Visszaad egy 32 bites egész értéket, amely a jelenlegi objektum által képviselt kivételhez társított HRESULT kód. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | Megkapja az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógiája. |
