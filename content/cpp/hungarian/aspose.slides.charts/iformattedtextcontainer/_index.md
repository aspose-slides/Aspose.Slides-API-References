...
description: A diagram szövegformátumát reprezentálja.
type: docs
weight: 1054
url: /hu/aspose.slides.charts/iformattedtextcontainer/
---
## IFormattedTextContainer osztály

A diagram szövegformátumát reprezentálja.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextFormat](../icharttextformat/)\> [get_TextFormat](./get_textformat/)() | Visszaadja a diagram szövegformátumát. Csak olvasható [IChartTextFormat](../icharttextformat/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában semmit sem másol, csak inicializálja az új objektumot és lehetővé teszi alosztályok másolós konstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában semmit sem másol, csak inicializálja az új objektumot és lehetővé teszi alosztályok másolós konstrukcióját. |
