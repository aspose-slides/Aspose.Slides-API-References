...
description: Diagramcellák gyűjteményét képviseli.
type: docs
weight: 1132
url: /hu/aspose.slides.charts/imultiplecellchartvalue/
---
## IMultipleCellChartValue osztály

Egy diagramcella-gyűjteményt képvisel.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)(**int32_t**) | Visszaad egy diagramcellát a megadott indexnél. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](./get_ascells/)() | Visszaadja a diagramcellák gyűjteményét. Olvasd [IChartCellCollection](../ichartcellcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Megadja, hogy a AsCell, AsLiteralString vagy AsLiteralDouble tulajdonság aktuális-e. Más szóval a Data tulajdonság értékének típusát adja meg. Ez a tulajdonság csak olvasható. A tulajdonság értékének megváltoztatásához használhatja a ChartDataPointCollection.DataSourceTypeFor<...> egyik tulajdonságát. Olvasd [DataSourceType](../datasourcetype/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában nem másol semmit, csak egy új objektumot inicializál és lehetővé teszi az alosztályok másolás-konstrukcióját. |
...
| virtual void [set_AsCells](./set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) | Beállítja a diagramcellák gyűjteményét. Írja [IChartCellCollection](../ichartcellcollection/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Megadja, hogy a AsCell, AsLiteralString vagy AsLiteralDouble tulajdonság aktuális-e. Más szóval a Data tulajdonság értékének típusát adja meg. Ez a tulajdonság csak olvasható. A tulajdonság értékének megváltoztatásához használhatja a ChartDataPointCollection.DataSourceTypeFor<...> egyik tulajdonságát. Írja [DataSourceType](../datasourcetype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (ahelyett, hogy megosztott). Lehetővé teszi a mutatók átkapcsolását a konténerekben gyenge módra. |
