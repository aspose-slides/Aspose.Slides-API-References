...
description: Ábrázolja az adattábla tulajdonságait.
type: docs
weight: 417
...
Ábrázolja az adat tábla tulajdonságait.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Visszaadja az objektum vonal-, kitöltés- és hatásstílusait. Csak olvasható [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | Igaz, ha a diagram adat táblájának vízszintes cellahatárai vannak. Olvasás **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | Igaz, ha a diagram adat táblájának kerethatárai vannak. Olvasás **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | Igaz, ha a diagram adat táblájának függőleges cellahatárai vannak. Olvasás **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | Igaz, ha az adatcímke legenda kulcsa látható. Olvasás **bool**. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia szerint hasonlít egy érték típusú objektumot a nullptr-hoz. |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | Igaz, ha a diagram adat táblájának vízszintes cellahatárai vannak. Írás **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | Igaz, ha a diagram adat táblájának kerethatárai vannak. Írás **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | Igaz, ha a diagram adat táblájának függőleges cellahatárai vannak. Írás **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | Igaz, ha az adatcímke legenda kulcsa látható. Írás **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Beállítja az n. sablon argumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módra váltását. |
