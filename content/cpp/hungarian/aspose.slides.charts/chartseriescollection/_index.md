...
description: A ChartSeries gyűjteményét képviseli
type: docs
weight: 287
...
A(z) [ChartSeries](../chartseries/) gyűjteményt képviseli.
...
| Módszer | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Új diagram sorozatot hoz létre és hozzáadja a gyűjteményhez. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | Új diagram sorozatot hoz létre a(z) [ChartDataCell](../chartdatacell/) alapján, és hozzáadja a gyűjteményhez. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | Új diagram sorozatot hoz létre a(z) [ChartCellCollection](../chartcellcollection/) alapján, és hozzáadja a gyűjteményhez. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Új diagram sorozatot hoz létre egy értékből, és hozzáadja a gyűjteményhez. |
| [iterator](./iterator/) [begin](./begin/)() | Az iterátort adja vissza, amely az első elemre (ha van) mutat a gyűjteményben. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Az iterátort adja vissza, amely a const-kötött gyűjtemény példány első elemére (ha van) mutat. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Az iterátort adja vissza, amely az első const-kötött elemre (ha van) a gyűjteményben mutat. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Az iterátort adja vissza, amely a gyűjtemény utolsó const-kötött eleme utánra (ha van) mutat. |
| void [Clear](./clear/)() override | Eltávolítja az összes vezérlőt a gyűjteményből. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Az összes elemet átmásolja a gyűjteményből a megadott tömbbe. |
| [iterator](./iterator/) [end](./end/)() | Az iterátort adja vissza, amely a gyűjtemény utolsó eleme utánra (ha van) mutat. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Az iterátort adja vissza, amely a const-kötött gyűjtemény példány utolsó eleme utánra (ha van) mutat. |
...
| **int32_t** [get_Count](./get_count/)() override | Visszaadja a gyűjteményben lévő objektumok számát. Csak olvasható **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy felsorolót, amely végig iterál a gyűjteményen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [idx_get](./idx_get/)(**int32_t**) override | A megadott indexű elemet adja vissza. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Keres a megadott [ChartSeries](../chartseries/)-ban, és visszaadja a nullától induló indexet az első előfordulásra az egész gyűjteményben. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Új diagram sorozatot hoz létre és beszúrja a gyűjteménybe. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy értékek sorozatának átlagát, amelyeket egy transzformáló függvény hívásával kapunk az bemeneti sorozat minden elemére. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egy generikus sorozat elemére meghív egy transzformáló függvényt, és visszaadja a legnagyobb eredményt. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egy generikus sorozat elemére meghív egy transzformáló függvényt, és visszaadja a legkisebb eredményt. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | A sorozat minden elemét átalakítja új formára, a elem indexét felhasználva. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden egy sorozat elemét leképezi, és az eredményül kapott sorozatokat egyetlen sorozatba egyesíti. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const&) | Másoló konstruktor. Valójában nem másol semmit, csak inicializálja az új objektumot és lehetővé teszi az alosztályok másoláskonstruktorát. |
| [Object](../../system/object/)& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const&) | Értékadó operátor. Valójában nem másol semmit, csak inicializálja az új objektumot és lehetővé teszi az alosztályok másoláskonstruktorát. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Eltávolítja a megadott értéket. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Eltávolítja a megadott pozíción tárolt ActiveX vezérlőt a gyűjteményből. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Az n-edik sablonargumentumot gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a mutatók konténerben történő gyenge módra váltását. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Az iterátort adja vissza, amely a const-kötött gyűjtemény példány első elemére (ha van) mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Az iterátort adja vissza, amely az első elemre (ha van) a gyűjteményben mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Az iterátort adja vissza, amely a const-kötött gyűjtemény példány utolsó eleme utánra (ha van) mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Az iterátort adja vissza, amely a gyűjtemény utolsó eleme utánra (if any) mutat. |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Olyan gyűjteménytípus, amelynek az iterátortípusait a jelenlegi gyűjtemény iterátortípusaiként használja. |
...
* Osztály [IChartSeriesCollection](../ichartseriescollection/)
