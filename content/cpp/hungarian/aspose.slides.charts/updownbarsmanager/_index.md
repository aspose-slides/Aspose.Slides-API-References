...
description: Hozzáférést biztosít a vonal- vagy részvény-diagram fel-/leső sávjaihoz.
type: docs
weight: 1392
...
Hozzáférést biztosít a vonal- vagy részvény-diagram fel-/leső sávjaihoz.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | Visszaadja a DownBars formátumot. Csak olvasható [IFormat](../iformat/). |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth. Olvas **int32_t**. |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars. Olvas **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | Visszaadja az UpBars formátumot. Csak olvasható [IFormat](../iformat/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csupán inicializál egy új objektumot és lehetővé teszi az alosztályok másolókonstruktorát. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában nem másol semmit, csupán inicializál egy új objektumot és lehetővé teszi az alosztályok másolókonstruktorát. |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth. Írja **int32_t**. |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars. Írja **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Beállítja az n-edik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi a pointerek átkapcsolását konténerekben gyenge módra. |
...
* Osztály [IUpDownBarsManager](../iupdownbarsmanager/)
