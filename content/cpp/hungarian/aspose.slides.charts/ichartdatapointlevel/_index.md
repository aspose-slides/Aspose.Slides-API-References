...
description: Az adatpont szintjét képviseli. Treemap és Sunburst diagramokra alkalmazható.
type: docs
weight: 703
url: /hu/aspose.slides.charts/ichartdatapointlevel/
---
## IChartDataPointLevel osztály
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Az adatpont szint formázási tulajdonságait képviseli. Olvasd el a [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | Az adatpont szint adatcímkéjét képviseli. Treemap és Sunburst sorozattípusokra alkalmazható. Csak olvasható [IDataLabel](../idatalabel/). |
