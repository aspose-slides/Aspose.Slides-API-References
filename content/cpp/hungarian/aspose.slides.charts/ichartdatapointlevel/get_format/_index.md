...
description: Az adatpont szint formázási tulajdonságait képviseli. Olvasd IFormat.
type: docs
weight: 1
url: /hu/aspose.slides.charts/ichartdatapointlevel/get_format/
---
## IChartDataPointLevel::get_Format() metódus


Az adatpont szint formázási tulajdonságait képviseli. Olvasd [IFormat](../../iformat/).
