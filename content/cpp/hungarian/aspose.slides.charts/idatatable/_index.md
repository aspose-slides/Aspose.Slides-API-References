...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Utaként működteti a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, még akkor is, ha az IEC 60559:1989 szerint a NaN nem egyenlő egyetlen értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Utaként működteti a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, még akkor is, ha az IEC 60559:1989 szerint a NaN nem egyenlő egyetlen értékkel, beleértve a NaN-t is. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Visszaadja egy objektum vonal, kitöltés és effektus stílusait. Csak olvasható [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Igaz, ha a diagram adat tábla vízszintes cellaszegélyekkel rendelkezik. Olvas **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Igaz, ha a diagram adat tábla körvonalas szegélyekkel rendelkezik. Olvas **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Igaz, ha a diagram adat tábla függőleges cellaszegélyekkel rendelkezik. Olvas **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Igaz, ha az adatcímke jelmagyarázat kulcsa látható. Olvas **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextFormat](../icharttextformat/)\> [get_TextFormat](../iformattedtextcontainer/get_textformat/)() | Visszaadja a diagram szövegformátumot. Csak olvasható [IChartTextFormat](../icharttextformat/). |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Igaz, ha a diagram adat tábla vízszintes cellaszegélyekkel rendelkezik. Írja **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Igaz, ha a diagram adat tábla körvonalas szegélyekkel rendelkezik. Írja **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Igaz, ha a diagram adat tábla függőleges cellaszegélyekkel rendelkezik. Írja **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Igaz, ha az adatcímke jelmagyarázat kulcsa látható. Írja **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók módosítását a tárolókban gyenge módra. |
