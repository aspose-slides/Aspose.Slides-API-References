...
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | A jelenlegi példány által mért teljes eltelt időt adja vissza. |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | A jelenlegi példány által mért teljes eltelt időt adja vissza ezredmásodpercben. |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | A jelenlegi példány által mért teljes eltelt időt adja vissza órajelekben. |
| **bool** [get_IsRunning](./get_isrunning/)() const | Ellenőrzi, hogy a stopper fut-e. |
...
| void [Reset](./reset/)() | Leállítja az időmérést, a mért intervallumot nullára állítja. |
| void [Restart](./restart/)() | A mért intervallumot nullára állítja, majd elindítja az időmérést. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n'th sablonargumentumot gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a mutatók konténerben való weak módba kapcsolását. |
...
| void [Start](./start/)() | Elindítja az időmérést. |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | Új [Stopwatch](./) objektumot hoz létre és elindítja a mérést. |
| void [Stop](./stop/)() | Leállítja az időmérést. |
|  [Stopwatch](./stopwatch/)() | RTTI információ. |
...
| virtual  [~Stopwatch](./~stopwatch/)() | Megsemmisítő. |
