...
description: Felülbíráló téma kezelőt képvisel.
type: docs
weight: 404
url: /hu/aspose.slides.theme/ioverridethemeable/
---
## IOverrideThemeable osztály
...
| Metódus | Leírás |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithemeable/createthemeeffective/)() | Visszaad egy hatékony témát ehhez a témázható objektumhoz. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideThemeManager](../ioverridethememanager/)\> [get_ThemeManager](./get_thememanager/)() | Visszaadja a felülíró téma kezelőt. Csak olvasható [IOverrideThemeManager](../ioverridethememanager/). |
