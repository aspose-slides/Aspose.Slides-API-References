...
description: Alaposztály azokhoz az osztályokhoz, amelyek hozzáférést biztosítanak a felülírt témák különböző típusaihoz.
type: docs
weight: 1
...
Alaposztály azokhoz az osztályokhoz, amelyek hozzáférést biztosítanak a felülírt témák különböző típusaihoz.
...
| Method | Description |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | További színsémát alkalmaz egy diára. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csak új objektumot inicializál és engedélyezi az alosztályok másolókonstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában nem másol semmit, csak új objektumot inicializál és engedélyezi az alosztályok másolókonstrukcióját. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Objektumokat összehasonlít referencia szerint. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Objektumokat összehasonlít referencia szerint. |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Visszaadja a felülíró téma objektumot. Írás [IOverrideTheme](../ioverridetheme/). |
...
* Osztály [IOverrideThemeManager](../ioverridethememanager/)
