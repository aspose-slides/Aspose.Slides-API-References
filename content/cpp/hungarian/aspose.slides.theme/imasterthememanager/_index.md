...
description: Hozzáférést biztosít a prezentáció fő témájához.
type: docs
weight: 378
url: /hu/aspose.slides.theme/imasterthememanager/
---
## IMasterThemeManager osztály

Hozzáférést biztosít a prezentáció fő témájához.
...
| Módszer | Leírás |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | További színsémát alkalmaz egy diára. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol a két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN semelyik értékkel, beleértve a NaN-t sem egyenlő. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol a két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN semelyik értékkel, beleértve a NaN-t sem egyenlő. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső használatra. |
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Megállapítja, hogy a [OverrideTheme](../overridetheme/) felülírja-e az örökölt hatékony témát (Presentation.MasterTheme) vagy sem. Olvas **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Visszaadja a felülíró téma objektumot. Olvas [IMasterTheme](../imastertheme/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolásállapotú felépítését. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másolásállapotú felépítését. |
...
| virtual void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) | Megállapítja, hogy a [OverrideTheme](../overridetheme/) felülírja-e az örökölt hatékony témát (Presentation.MasterTheme) vagy sem. Ír **bool**. |
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) | Visszaadja a felülíró téma objektumot. Ír [IMasterTheme](../imastertheme/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett) állítja be. Lehetővé teszi a mutatók konténerekben való gyenge módra váltását. |
