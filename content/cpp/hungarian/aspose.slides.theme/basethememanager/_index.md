...
description: Alaposztály azoknak az osztályoknak, amelyek különböző típusú témákhoz biztosítanak hozzáférést.
type: docs
weight: 14
...
Alaposztály azoknak az osztályoknak, amelyek különböző típusú témákhoz biztosítanak hozzáférést.
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() állítás zárolását. Direkt hívással vagy a [LockContext](../../system/lockcontext/) őrzőobjektummal használható. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Nem másol semmit, csak inicializálja az új objektumot és lehetővé teszi az alosztályok másoló konstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Nem másol semmit, csak inicializálja az új objektumot és lehetővé teszi az alosztályok másoló konstrukcióját. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() állítás feloldását. Direkt hívással vagy a [LockContext](../../system/lockcontext/) őrzőobjektummal használható. |
