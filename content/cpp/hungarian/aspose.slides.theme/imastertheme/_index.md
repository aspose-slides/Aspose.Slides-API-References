...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | Visszaadja a megadott indexű további színsémát. Ez a séma nem befolyásolja a prezentáció megjelenését, kiválasztható egy dia fő színsémájaként. Írásvédett [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | Visszaadja a további színsémák gyűjteményét. Ezek a sémák nem befolyásolják a prezentáció megjelenését, kiválaszthatók egy dia fő színsémájaként. Írásvédett [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](../itheme/get_formatscheme/)() | Visszaadja az alakzat formátum sémát. Írásvédett [IFormatScheme](../iformatscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Visszaadja egy téma nevét. Olvasás [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../itheme/geteffective/)() | Lekéri a hatékony téma adatot az öröklődés alkalmazásával. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia alapján hasonlít össze értéktípusú objektumot nullptr értékkel. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Visszaadja egy téma nevét. Írás [System::String](../../system/string/). |
