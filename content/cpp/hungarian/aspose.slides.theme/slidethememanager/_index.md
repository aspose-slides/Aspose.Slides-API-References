...
description: Hozzáférést biztosít a diatéma felülírásához.
type: docs
weight: 560
...
Hozzáférést biztosít a diatéma felülírásához.
...
| Metódus | Leírás |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Alkalmaz egy extra színsémát a diára. |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Visszaadja a felülíró téma objektumot. Írj [IOverrideTheme](../ioverridetheme/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módba való átkapcsolását. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Lecsökkenti és visszaadja a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; helyette használjon intelligens mutatókat vagy ThisProtector-t. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Lecsökkenti a gyenge referenciaszámlálót. Nem szabad közvetlenül hívni; helyette használjon intelligens mutatókat vagy ThisProtector-t. |
