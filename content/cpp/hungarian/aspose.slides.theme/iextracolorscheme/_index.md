...
description: További színskémát képvisel, amely egy diára rendelhető.
type: docs
weight: 222
url: /hu/aspose.slides.theme/iextracolorscheme/
---
## IExtraColorScheme osztály

Egy további színskémát képvisel, amely egy diára rendelhető.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() | Visszaad egy színskémát. Csak olvasható [IColorScheme](../icolorscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Visszaad ennek a sémának a nevét. Csak olvasható [System::String](../../system/string/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Hozzárendelő operátor. Valójában semmit sem másol, csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másoló konstruktorát. |
