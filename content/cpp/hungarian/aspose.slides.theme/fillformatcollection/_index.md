...
| Módszer | Leírás |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() | Lekéri az iterátort, amely a gyűjtemény első (ha van) elemére mutat. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Lekéri az iterátort, amely a gyűjtemény első const-képzett elemére mutat (ha van). |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Lekéri az iterátort, amely a gyűjtemény utolsó const-képzett eleme utánra mutat (ha van). |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>, **int32_t**) override | Másolja a gyűjtemény összes elemét a megadott tömbbe. |
...
| [iterator](./iterator/) [end](./end/)() | Lekéri az iterátort, amely a gyűjtemény utolsó (ha van) elemére mutat. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Lekéri az iterátort, amely a gyűjtemény const-képzett példányának utolsó (ha van) elemére mutat. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végigiterál a gyűjteményen. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) metódus analógja. Lehetővé teszi az egyedi objektumok hash-elését. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Lekéri az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógja. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [idx_get](./idx_get/)(**int32_t**) override | Lekéri a megadott indexű elemet. Csak olvasható [IFillFormat](../../aspose.slides/ifillformat/). |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Kiszámítja egy számsorozat átlagát. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy értéksorozat átlagát, amelyet egy átalakító függvény hívásával nyernek ki a bemeneti sorozat minden eleméből. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Átalakítja az elemeket a megadott típusba. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden generikus sorozat elemére meghív egy átalakító függvényt, és visszaadja a legnagyobb eredményt. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden generikus sorozat elemére meghív egy átalakító függvényt, és visszaadja a legkisebb eredményt. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Átalakítja a sorozat minden elemét új formába, a elem indexét beépítve. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Átlépi a sorozat elejétől a megadott számú egymást követő elemet, és visszaadja a maradékot. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Visszaadja a sorozat elejétől a megadott számú egymást követő elemet. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia alapján összehasonlítja az érték típusú objektumot a nullptr-tel. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Beállítja az n. sablonparamétert gyenge mutatóra (nem megosztottra). Lehetővé teszi a mutatók konténerben való gyenge módba való átváltását. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökken és visszaadja a megosztott referenciák számát. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Lekéri az iterátort, amely a gyűjtemény const-képzett példányának első (ha van) elemére mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Lekéri az iterátort, amely a gyűjtemény első (ha van) elemére mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Lekéri az iterátort, amely a gyűjtemény const-képzett példányának utolsó (ha van) eleme utánra mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Lekéri az iterátort, amely a gyűjtemény utolsó (ha van) eleme utánra mutat. |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Gyűjteménytípus, amelynek iterátortípusait használja az aktuális gyűjtemény iterátortípusaiként. |
...
* Osztály [IFillFormatCollection](../ifillformatcollection/)
