...
description: Az IEnumerable az összes nem generikus, enumerálható gyűjtemény alapinterfésze.
type: docs
weight: 53
url: /hu/system.collections/ienumerable/
---
## IEnumerable osztály


[IEnumerable](./) az alap interfész minden nem generikus gyűjteményhez, amely enumerálható.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Visszaad egy enumerátort, amely végigjár egy gyűjteményt. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum egy példány-e a targetType által leírt típussal. A C# 'is' operátor analógiája. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztott). Lehetővé teszi a mutatók átállítását konténerekben gyenge módra. |
