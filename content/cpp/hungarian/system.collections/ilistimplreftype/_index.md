...
description: "A stub, amely a System::Collections::IList interfészt valósítja meg a System::Collections::Generic::List objektumon, referencia típusokhoz való megvalósítás."
type: docs
weight: 131
url: /hu/system.collections/ilistimplreftype/
---
## IListImplRefType osztály
...
| Metódus | Leírás |
| --- | --- |
| int [Add](./add/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Elem hozzáadása a lista végére. |
| static [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [BoxValue](./boxvalue/)([System::SharedPtr](../../system/sharedptr/)\<T\>) | Típusreferencia konvertálása objektumértékké. |
| void [Clear](./clear/)() override | Minden elem törlése. |
| **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const override | Ellenőrzi, hogy az elem szerepel-e a listában. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Ugyanazt a C#-stílusú lebegőpontos összehasonlítást emulálja, ahol két NaN egyenlőnek tekinthető, bár az IEC 60559:1989 szerint a NaN semelyik értéknek, köztük a NaN-nak sem egyenlő. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Ugyanazt a C#-stílusú lebegőpontos összehasonlítást emulálja, ahol két NaN egyenlőnek tekinthető, bár az IEC 60559:1989 szerint a NaN semelyik értéknek, köztük a NaN-nak sem egyenlő. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső célokra. |
| int [get_Count](./get_count/)() const override | [ICollection.get_Count()](../icollection/get_count/) metódusok megvalósítása A kollekció eleminek számát adja vissza. |
| virtual **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() const | Visszaad egy értéket, amely jelzi, hogy a lista rögzített méretű-e. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() override | [IEnumerable.GetEnumerator()](../ienumerable/getenumerator/) megvalósítás Visszaad egy enumerátort, amely végigiterál egy kollekción. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const override | Visszaadja a megadott indexű elemet. |
|  [IListImplRefType](./ilistimplreftype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::List](../../system.collections.generic/list/)\<[System::SharedPtr](../../system/sharedptr/)\<T\>\>\>) | Új objektumpéldány létrehozása. |
| int [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const override | Visszaadja az elem első előfordulásának indexét a tárolóban. |
| void [Insert](./insert/)(int, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Beszúrja az elemet a megadott pozícióba, eltolva a többi elemet. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzés, hogy az objektum a targetType által leírt típus példánya-e. A C# 'is' operátor analógiája. |
...
|  [Object](../../system/object/object/)() | Objektum létrehozása. Minden belső adatstruktúra inicializálása. |
...
| void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Eltávolítja a konkrét elem első példányát a listáról. |
| void [RemoveAt](./removeat/)(int) override | Eltávolítja az elemet a megadott pozícióban. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<T\> [UnboxValue](./unboxvalue/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Objektumérték konvertálása egy adott típusreferenciává. |
