...
description: Egy raszter vagy vektor képet képvisel.
type: docs
weight: 2575
...
Egy raszter vagy vektor képet képvisel.
...
| virtual **int32_t** [get_Height](./get_height/)() | Lekéri a kép magasságát pixelben. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_Size](./get_size/)() | Lekéri a kép méretét. |
| virtual **int32_t** [get_Width](./get_width/)() | Lekéri a kép szélességét pixelben. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csak inicializálja az új objektumot és lehetővé teszi a származtatott osztályok másoló konstruktorát. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Hozzárendelő operátor. Valójában nem másol semmit, csak inicializálja az új objektumot és lehetővé teszi a származtatott osztályok másoló konstruktorát. |
...
| virtual void [Save](./save/)([System::String](../../system/string/)) | Elmenti a képet egy fájlba. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/)) | Elmenti a képet egy fájlba a megadott formátumban. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/)) | Elmenti a képet egy streambe a megadott formátumban. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/), **int32_t**) | Elmenti a képet egy fájlba a megadott formátumban és minőségben. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/), **int32_t**) | Elmenti a képet egy streambe a megadott formátumban és minőségben. |
...
Ez az interfész közös absztrakciót biztosít a raszter és vektor képek kezeléséhez.  

A megvalósítások változhatnak az alapul szolgáló képtípustól függően.  
