...
description: Tartalmazza a forma fő felületének domborítási tulajdonságait.
type: docs
weight: 5097
...
Tartalmazza a forma fő felületének domborításának tulajdonságait.
...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | Bevel típus. Olvasás [BevelPresetType](../bevelpresettype/). |
| **double** [get_Height](./get_height/)() override | Bevel magasság. Olvasás **double**. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában nem másol semmit, csak új objektumot inicializál és lehetővé teszi az alosztályok másolt konstruktorát. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában nem másol semmit, csak új objektumot inicializál és lehetővé teszi az alosztályok másolt konstruktorát. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia-összehasonlít egy értéktípusú objektumot a nullptr értékkel. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | Bevel típus. Írás [BevelPresetType](../bevelpresettype/). |
| void [set_Height](./set_height/)(**double**) override | Bevel magasság. Írás **double**. |
| void [set_Width](./set_width/)(**double**) override | Bevel szélesség. Írás **double**. |
...
* Osztály [IShapeBevel](../ishapebevel/)
