...
description: Ábrák módosításainak gyűjteményét képviseli.
type: docs
weight: 1301
url: /hu/aspose.slides/iadjustvaluecollection/
---
## IAdjustValueCollection osztály

Ábrák módosításainak gyűjteményét képviseli.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [idx_get](./idx_get/)(**int32_t**) | Visszaadja a módosítást index szerint. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Átadás operátor. Valójában nem másol semmit, csak inicializál egy új objektumot és lehetővé teszi az alosztályok másolókonstrukcióját. |
