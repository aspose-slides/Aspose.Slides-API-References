...
description: Különböző színműveleteket reprezentál, amelyeket színtranszformációkhoz használnak. Immutable objektum.
type: docs
weight: 352
...
Különböző színműveleteket reprezentál, amelyeket színtranszformációkhoz használnak. Immutable objektum.
...
| Method | Description |
| --- | --- |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/)) | Új színtranszformációs műveletet hoz létre. |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/), **float**) | Új színtranszformációs műveletet hoz létre. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Megállapítja, hogy a két [ColorOperation](./) példány egyenlő-e. |
...
| [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const override | Visszaadja egy művelet típusát. Csak olvasható [ColorTransformOperation](../colortransformoperation/). |
| **float** [get_Parameter](./get_parameter/)() override | Visszaad egy művelet paraméterét. Csak olvasható **float**. |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Hash függvényként szolgál egy adott típushoz, amely alkalmas hash algoritmusokban és adatstruktúrákban, például hash táblában való használatra. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (nem megosztott). Lehetővé teszi a mutatók átkapcsolását a tárolókban gyenge módra. |
