...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek számít, bár az IEC 60559:1989 szerint a NaN nem egyenlő semmivel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek számít, bár az IEC 60559:1989 szerint a NaN nem egyenlő semmivel, beleértve a NaN-t is. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső felhasználásra. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Visszaadja egy audio adatmásolatát. Nagy mennyiségű adat esetén fontolja meg a [IAudio::GetStream](./getstream/) metódus használatát, hogy elkerülje az audio adatainak felesleges betöltését a memóriába vagy akár OutOfMemoryException kivételt. Csak-olvasású **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Visszaadja az audio MIME-típusát, amely [IAudio::get_BinaryData](./get_binarydata/) formátumban van kódolva. Csak-olvasású [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Visszaad egy Stream objektumot olvasásra. Használja a 'using' kulcsszót vagy zárja be a streamet a használat után. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonparamétert gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben gyenge módra váltását. |
