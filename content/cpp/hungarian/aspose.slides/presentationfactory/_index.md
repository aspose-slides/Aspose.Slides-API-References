...
| static [System::SharedPtr](../../system/sharedptr/)\<[PresentationFactory](./)\> [get_Instance](./get_instance/)() | [Presentation](../presentation/) factory static instance. Csak olvasható [PresentationFactory](./). |
...
Az alábbi példa azt mutatja, hogyan ellenőrizhető egy [Presentation](../presentation/) formátum. 
```cpp
...
```
 Az alábbi példa azt mutatja, hogyan lehet lekérni egy [Presentation](../presentation/) tulajdonságait. 
```cpp
System::SharedPtr<IPresentationInfo> info = PresentationFactory::get_Instance()->GetPresentationInfo(u"pres.pptx");
...
```
 Az alábbi példa azt mutatja, hogyan lehet frissíteni egy [Presentation](../presentation/) tulajdonságait. 
```cpp
System::SharedPtr<IPresentationInfo> info = PresentationFactory::get_Instance()->GetPresentationInfo(u"pres.pptx");
System::SharedPtr<IDocumentProperties> props = info->ReadDocumentProperties();
...
* Osztály [IPresentationFactory](../ipresentationfactory/)
