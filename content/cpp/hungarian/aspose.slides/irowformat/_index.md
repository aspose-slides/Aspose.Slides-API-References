...
description: A táblasor formátumát képviseli.
type: docs
weight: 3537
...
A táblasor formátumát képviseli.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormatEffectiveData](../irowformateffectivedata/)\> [GetEffective](./geteffective/)() | Lekéri a hatékony táblasor formázási tulajdonságokat öröklődéssel és táblastílusok alkalmazásával. |
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás lezárását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) őrzőobjektumot. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi a mutatók konténerekben történő gyenge módba váltását. |
