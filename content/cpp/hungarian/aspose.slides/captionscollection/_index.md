...
| Módszer | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | WebVTT zárt feliratokat ad a gyűjtemény végéhez. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | WebVTT zárt feliratokat ad a gyűjtemény végéhez egy adatfolyamból. |
| [iterator](./iterator/) [begin](./begin/)() | Az iterátort adja vissza, amely az első elemre (ha van) mutat a gyűjteményben. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Az iterátort adja vissza, amely az első elemre (ha van) mutat a gyűjtemény const-kvalifikált példányában. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Az iterátort adja vissza, amely az első const-kvalifikált elemre (ha van) mutat a gyűjteményben. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Az iterátort adja vissza, amely az utolsó const-kvalifikált elem utánra (ha van) mutat a gyűjteményben. |
| void [Clear](./clear/)() override | Eltávolítja az összes zárt feliratot a gyűjteményből. |
| [iterator](./iterator/) [end](./end/)() | Az iterátort adja vissza, amely az utolsó elem utánra (ha van) mutat a gyűjteményben. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Az iterátort adja vissza, amely az utolsó elem utánra (ha van) mutat a gyűjtemény const-kvalifikált példányában. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végigjárja a gyűjteményt. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | A objektum tényleges típusát adja vissza. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógiája. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [idx_get](./idx_get/)(**int32_t**) override | Visszaadja a megadott indexű zárt feliratot. Csak olvasható [ICaptions](../icaptions/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum a targetType által leírt típus példánya-e. A C# 'is' operátor analógiája. |
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Gyűjti a sorozat elemeit egy akumulátor függvény alkalmazásával. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy sorozat értékeinek átlagát, amelyeket egy transzformációs függvény hívásával kapunk meg a bemeneti sorozat minden elemére. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Visszaadja a sorozat első, a feltételt teljesítő elemét, vagy egy alapértelmezett értéket, ha nem található ilyen elem. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Minden sorozat elemet egy új formába alakít át úgy, hogy beépíti az elem indexét. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden sorozat elemet leképez és az így kapott sorozatokat egyetlen sorozatba egyesíti. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Visszaad egy megadott számú folytonos elemet a sorozat elejétől. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | A sorozat elemeit a megadott predikátum alapján szűri. |
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() állítás zárolását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) sentinell objektumot. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>) override | Eltávolítja a megadott zárt feliratokat a gyűjteményből. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Eltávolítja a megadott indexű zárt feliratot. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge pointerre (a megosztott helyett) állítja. Lehetővé teszi a konténerekben a pointerek gyenge módra váltását. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() állítás feloldását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) sentinell objektumot. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Az iterátort adja vissza, amely az első elemre (ha van) mutat a gyűjtemény const-kvalifikált példányában. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Az iterátort adja vissza, amely az első elemre (ha van) mutat a gyűjteményben. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Az iterátort adja vissza, amely az utolsó elem utánra (ha van) mutat a gyűjtemény const-kvalifikált példányában. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Az iterátort adja vissza, amely az utolsó elem utánra (ha van) mutat a gyűjteményben. |
