...
description: A táblázatsor-gyűjteményt képviseli.
type: docs
weight: 4980
...
| Metódus | Leírás |
| --- | --- |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Létrehoz egy másolatot a megadott sablon sorról, és a táblázat aljára szúrja be. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Visszaad egy iterátort, amely a gyűjtemény első (ha van) const-kvalifikált elemére mutat. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Visszaad egy iterátort, amely a gyűjtemény utolsó (ha van) const-kvalifikált elemét követően helyezkedik el. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>, **int32_t**) override | Átmásolja a gyűjtemény összes elemét a megadott tömbbe. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Visszaad egy iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó (ha van) elemét követően helyezkedik el. |
...
| **int32_t** [get_Count](./get_count/)() override | Visszaadja a gyűjteményben ténylegesen található sorok számát. Csak olvasható **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely a gyűjteményen iterál. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [idx_get](./idx_get/)(**int32_t**) override | Visszaadja a megadott indexű sort. Csak olvasható [Row](../row/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Létrehoz egy másolatot a megadott sablon sorról, és a táblázat megadott pozíciójába szúrja be. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy sorozat értékeinek átlagát, amelyeket a bemeneti sorozat minden elemére egy transzformáló függvény hívásával kapunk. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egy generikus sorozat elemére meghív egy transzformáló függvényt, és visszaadja a kapott értékek közül a legnagyobbat. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egy generikus sorozat elemére meghív egy transzformáló függvényt, és visszaadja a kapott értékek közül a legkisebbet. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Minden egy sorozat elemet egy új formává alakít át az elem indexét felhasználva. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden egy sorozat elemét leképezi, és az eredményül kapott sorozatokat egy sorozatba egyesíti. |
...
| void [RemoveAt](./removeat/)(**int32_t**, **bool**) override | Eltávolít egy sort a táblázat megadott pozíciójából. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Az n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett) állítja be. Lehetővé teszi, hogy a konténerekben a mutatókat gyenge módra állítsa. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Visszaad egy iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó (ha van) elemét követően helyezkedik el. |
...
| Typedef | Leírás |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Egy gyűjteménytípus, amelynek az iterátortípusai a jelenlegi gyűjtemény iterátortípusaként szolgálnak. |
...
* Osztály [IRowCollection](../irowcollection/)
