...
description: Kioszkban megtekintve (teljes képernyő)
type: docs
weight: 209
...
Kioszkban megtekintett (teljes képernyő)
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekéri az objektumhoz tartozó referenciakészítő adatstruktúrát. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia szerint hasonlít össze érték típusú objektumot a nullptr-tel. |
