...
A [PPImage](../ppimage/) gyűjteményét képviseli.
...
| Módszer | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [AddImage](./addimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Hozzáad egy kép másolatát egy másik prezentációból. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [AddImage](./addimage/)([System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\>) override | Képet ad hozzá egy prezentációhoz. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [AddImage](./addimage/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::MemoryStream](../../system.io/memorystream/)\>) override | Képet ad hozzá egy prezentációhoz egy folyamatról. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [AddImage](./addimage/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Képet ad hozzá egy prezentációhoz egy folyamatról. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [AddImage](./addimage/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [LoadingStreamBehavior](../loadingstreambehavior/)) override | Létrehozza és hozzáad egy képet egy prezentációhoz egy folyamatról. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [AddImage](./addimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Képet ad hozzá egy prezentációhoz a megadott pufferből. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [AddImage](./addimage/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\>) override | Képet ad hozzá egy prezentációhoz SVG objektumból. |
| [iterator](./iterator/) [begin](./begin/)() | Visszaad egy iterátort, amely az első elemre mutat (ha van) a gyűjteményben. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Visszaad egy iterátort, amely az első elemre mutat (ha van) a gyűjtemény konstans-példányában. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Visszaad egy iterátort, amely az első konstans-qualifikált elemre mutat (ha van) a gyűjteményben. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Visszaad egy iterátort, amely közvetlenül az utolsó konstans-qualifikált elem után mutat (ha van) a gyűjteményben. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>\>, **int32_t**) override | Az összes elemet a gyűjteményből a megadott tömbbe másolja. |
...
| [iterator](./iterator/) [end](./end/)() | Visszaad egy iterátort, amely közvetlenül az utolsó elem után mutat (ha van) a gyűjteményben. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Visszaad egy iterátort, amely közvetlenül az utolsó elem után mutat (ha van) a gyűjtemény konstans-példányában. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekinthető, annak ellenére, hogy az IEC 60559:1989 szerint a NaN semelyik értékkel, így a NaN-nal sem nem egyenlő. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekinthető, annak ellenére, hogy az IEC 60559:1989 szerint a NaN semelyik értékkel, így a NaN-nal sem nem egyenlő. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső célokra. |
| **int32_t** [get_Count](./get_count/)() override | A gyűjteményben lévő képek számát adja vissza. Csak olvasható **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végigiterál a gyűjteményen. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) metódus analógja. Lehetővé teszi egyedi objektumok hash-elését. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Lekéri az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógja. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [idx_get](./idx_get/)(**int32_t**) override | Lekéri a megadott indexű elemet. Csak olvasható [IPPImage](../ippimage/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Megállapítja, hogy létezik-e a sorozat bármely eleme, vagy megfelel-e egy feltételnek. |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Számolja egy numerikus értékek sorozatának átlagát. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Számolja egy értékek sorozatának átlagát, amelyeket egy transzformáló függvény meghívásával kapunk a bemeneti sorozat minden elemére. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyes generikus sorozat elemre meghív egy transzformáló függvényt, és visszaadja a legnagyobb eredményt. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyes generikus sorozat elemre meghív egy transzformáló függvényt, és visszaadja a legkisebb eredményt. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Minden egyes sorozat elemet új formává alakít át, beépítve az elem indexét. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projekcióval átalakítja a sorozat minden egyes elemét, és az eredményül kapott sorozatokat egy sorozatba egyesíti. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Az n-edik sablonparamétert gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a mutatók konténerekben gyenge módra váltását. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott referencia számláló értékét. Nem szabad közvetlenül hívni; helyette használjon okos pointereket vagy ThisProtector-t. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Visszaad egy iterátort, amely az első elemre mutat (ha van) a gyűjtemény konstans-példányában. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Visszaad egy iterátort, amely az első elemre mutat (ha van) a gyűjteményben. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Visszaad egy iterátort, amely közvetlenül az utolsó elem után mutat (ha van) a gyűjtemény konstans-példányában. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Visszaad egy iterátort, amely közvetlenül az utolsó elem után mutat (ha van) a gyűjteményben. |
