...
---
## IBulkTextFormattable osztály

Olyan objektumot képvisel, amely képes tömegesen beállítani a gyermek szövegelemek formátumait.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóval (nem megosztottal) állítja be. Lehetővé teszi a mutatók konténerekben való gyenge módra történő átváltását. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Beállítja a definiált részformátum tulajdonságait az összes elem részeire. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Beállítja a definiált bekezdésformátum tulajdonságait az összes elem bekezdéseire. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Beállítja a definiált szövegkeret-formátum tulajdonságait az összes elem szövegkereteire. |
