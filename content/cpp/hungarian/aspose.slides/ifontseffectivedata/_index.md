...
---
## IFontsEffectiveData osztály

Immutable objektum, amely a hatékony betűkészleteket tartalmaz.
...
| Method | Leírás |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Összehasonlítja az objektumokat a C# [Object.Equals](../../system/object/equals/) szemantikai szabályai szerint. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | Visszaadja a komplex írásrendszer betűtípusát. Csak olvasható [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | Visszaadja az Kelet-Ázsiai betűtípust. Csak olvasható [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | Visszaadja a latin betűtípust. Csak olvasható [IFontData](../ifontdata/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum a cél típusa által leírt példányt képviseli-e. A C# 'is' operátor analógja. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | A C# [Object.ToString()](../../system/object/tostring/) metódus analógja. Engedélyezi a saját objektumok stringgé alakítását. |
...
Ez a felület a [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/) és [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/) interfészek részeként használatos. 
