...
description: Visszaadja a szövegigazítást egy bekezdésben öröklődés nélkül. Olvassa el a TextAlignment-et.
type: docs
weight: 1
url: /hu/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() metódus


Visszaadja a szövegigazítást egy bekezdésben öröklődés nélkül. Olvassa el [TextAlignment](../../textalignment/).
...
A következő példakód bemutatja, hogyan kell a szöveg bekezdéseket igazítani a PowerPointban [Presentation](../../presentation/). 
```cpp
