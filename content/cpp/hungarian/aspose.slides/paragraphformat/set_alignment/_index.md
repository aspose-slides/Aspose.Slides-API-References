...
description: Beállítja a szövegigazítást egy bekezdésben öröklődés nélkül. Írja TextAlignment.
type: docs
weight: 14
url: /hu/aspose.slides/paragraphformat/set_alignment/
---
## ParagraphFormat::set_Alignment(TextAlignment) metódus


Beállítja a szövegigazítást egy bekezdésben öröklődés nélkül. Írja [TextAlignment](../../textalignment/).
...
A következő minta kód bemutatja, hogyan kell igazítani a szöveg bekezdéseket a PowerPointban [Presentation](../../presentation/).
```cpp
