...
description: A menedzser, amely a prezentáció összes lábléc, dátum-idő és oldalszám helyőrzőjének viselkedését tartalmazza.
type: docs
weight: 3407
url: /hu/aspose.slides/ipresentationheaderfootermanager/
---
## IPresentationHeaderFooterManager osztály
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Érték típusú objektumot referencia alapján hasonlít össze a nullptr értékkel. |
...
| virtual void [SetAllDateTimesText](./setalldatetimestext/)([System::String](../../system/string/)) | Beállítja a szöveget az összes dátum-idő helyőrzőre, beleértve a mester dia, layout dia és dia elemeket. |
| virtual void [SetAllDateTimesVisibility](./setalldatetimesvisibility/)(**bool**) | Megváltoztatja az összes dátum-idő helyőrző láthatóságát, beleértve a mester dia, layout dia és dia elemeket. |
| virtual void [SetAllFootersText](./setallfooterstext/)([System::String](../../system/string/)) | Beállítja a szöveget az összes lábléc helyőrzőre, beleértve a mester dia, layout dia és dia elemeket. |
| virtual void [SetAllFootersVisibility](./setallfootersvisibility/)(**bool**) | Megváltoztatja az összes lábléc helyőrző láthatóságát, beleértve a mester dia, layout dia és dia elemeket. |
| virtual void [SetAllHeadersText](./setallheaderstext/)([System::String](../../system/string/)) | Beállítja a szöveget az összes fejléc helyőrzőre, beleértve a jegyzet mester, jegyzet dia és a kiosztási mester elemeket. |
| virtual void [SetAllHeadersVisibility](./setallheadersvisibility/)(**bool**) | Megváltoztatja az összes fejléc helyőrző láthatóságát, beleértve a jegyzet mester, jegyzet dia és a kiosztási mester elemeket. |
| virtual void [SetAllSlideNumbersVisibility](./setallslidenumbersvisibility/)(**bool**) | Megváltoztatja az összes oldalszám helyőrző láthatóságát, beleértve a mester dia, layout dia és dia elemeket. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett) állítja be. Lehetővé teszi a mutatók konténerben történő gyenge módra való átkapcsolását. |
| virtual void [SetVisibilityOnAllTitleSlides](./setvisibilityonalltitleslides/)(**bool**) | Megváltoztatja a lábléc, dátum-idő és oldalszám helyőrzők láthatóságát az összes címdia és az első layout diában. Title slides \\u2013 slides based on first layout slide (regardless of type of this first layout). |
