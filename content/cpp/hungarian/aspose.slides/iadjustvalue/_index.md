...
description: Egy geometriai alakzat beállítási értékét képviseli. Ezek az értékek befolyásolják az alakzat formáját.
type: docs
weight: 1288
url: /hu/aspose.slides/iadjustvalue/
---
## IAdjustValue osztály
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást utánoz, ahol a két NaN egyenlőnek tekintett, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást utánoz, ahol a két NaN egyenlőnek tekintett, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső felhasználásra. |
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Visszaadja az értéket, fokban kifejezett szögeként értelmezve. Olvasás **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Visszaadja ennek a beállítási értéknek a nevét. Csak olvasható [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Visszaadja a beállítási értéket "ahogy van". Olvasás **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Visszaadja az alakzat beállításának típusát. Csak olvasható [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia-szerű összehasonlítás értéktípusú objektumot a nullptr-tel. |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Beállítja az értéket, fokban kifejezett szögeként értelmezve. Írás **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Beállítja a beállítási értéket "ahogy van". Írás **int64_t**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a mutatók átkapcsolását a tárolókban gyenge módba. |
