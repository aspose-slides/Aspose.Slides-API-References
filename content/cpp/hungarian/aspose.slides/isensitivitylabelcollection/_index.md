...
---
## ISensitivityLabelCollection osztály
...
| Módszer | Leírás |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Hozzáadja az érzékenységi címkét a gyűjtemény végéhez. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) | Hozzáad egy [SensitivityLabel](../sensitivitylabel/) elemet a gyűjteményhez. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Lekéri az iterátort, amely a gyűjtemény utolsó const-kvalifikált eleme után (ha van) helyezkedik el. |
| virtual void [Clear](./clear/)() | Eltávolítja a gyűjtemény összes elemét. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Lekéri az iterátort, amely a gyűjtemény utolsó eleme után (ha van) helyezkedik el. Ez az iterátor nem használható a hivatkozott objektum módosítására, mivel [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) egy másolat-objektumot ad vissza T-ből. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Lekéri az iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó eleme után (ha van) helyezkedik el. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Hasongatja a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekintendő, bár az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Hasongatja a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekintendő, bár az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) | Visszaadja az érzékenységi címkét index alapján. Csak olvasható [ISensitivityLabel](../isensitivitylabel/). |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja a sorozat értékeinek átlagát, amelyeket a bemeneti sorozat minden elemén egy transzformációs függvény meghívásával kapunk. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Átalakítja a sorozat minden egyes elemét egy új formába az elem indexének felhasználásával. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Átadás operátor. Valójában semmit nem másol, csak új objektumot inicializál és lehetővé teszi az alosztályok másolásos konstrukcióját. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja strings esetén. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Eltávolítja az érzékenységi címkét a megadott indexnél. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Lekéri a begin const iterátor implementációját az aktuális tárolóhoz. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Lekéri a begin iterátor implementációját az aktuális tárolóhoz. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Lekéri az end const iterátor implementációját az aktuális tárolóhoz. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Lekéri az end iterátor implementációját az aktuális tárolóhoz. |
