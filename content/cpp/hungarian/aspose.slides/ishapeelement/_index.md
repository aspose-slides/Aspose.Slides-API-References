...
description: A forma azon részét képviseli, amelynek ugyanazok a körvonal és kitöltés tulajdonságai vannak.
type: docs
weight: 3693
url: /hu/aspose.slides/ishapeelement/
---
## IShapeElement osztály
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot null_ptr-rel hasonlít referenciával. |
