...
description: Jegyzetdiák kezelő.
type: docs
weight: 3043
url: /hu/aspose.slides/inotesslidemanager/
---
## INotesSlideManager osztály
...
| Módszer | Leírás |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() | Visszaadja a jelenlegi diához tartozó jegyzetdiahát, és létrehozza, ha nincs. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() | Visszaadja a jelenlegi diához tartozó jegyzetdiahát. Null értéket ad vissza, ha a diához nem tartozik jegyzetdia. Csak olvasható [INotesSlide](../inotesslide/). |
...
| virtual void [RemoveNotesSlide](./removenotesslide/)() | Eltávolítja a jelenlegi diához tartozó jegyzetdiahát. |
