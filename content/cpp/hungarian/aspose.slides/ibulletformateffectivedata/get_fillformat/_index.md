...
description: Visszaadja a bekezdés bullet kitöltési formátumát. Csak olvasható IFillFormatEffectiveData.
type: docs
weight: 131
url: /hu/aspose.slides/ibulletformateffectivedata/get_fillformat/
---
## IBulletFormatEffectiveData::get_FillFormat() method

Visszaadja a bekezdés bullet kitöltési formátumát. Csak olvasható [IFillFormatEffectiveData](../../ifillformateffectivedata/).
...
Ez a példa bemutatja a bullet kitöltésének hatékony adatainak lekérdezését. ```cpp
using namespace System;
using namespace Aspose::Slides;

auto pres = MakeObject<Presentation>(u"SomePresentation.pptx");
// Tegyük fel, hogy az első dia első alakja AutoShape némi szöveggel rendelkezik...
// Kiírja a szöveges bekezdések bullet-jeinek információit
