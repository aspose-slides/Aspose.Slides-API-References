...
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | Fényirány. Olvasd [LightingDirection](../lightingdirection/). |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | Egy előre beállított fényirányt ábrázol, amely egy alakzatra alkalmazható. A fényrendszer egy csoport fényt jelent, amely meghatározott módon van orientálva egy 3D jelenethez képest. Olvasd [LightRigPresetType](../lightrigpresettype/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Egy forgást a szélességi koordináta, a hosszúsági koordináta és a tengely körüli fordulat használatával definiálnak, ahol a szélességi és hosszúsági koordináták határozzák. Az eredmény tömb első eleme – szélesség, a második – hosszúság, a harmadik – fordulat. |
...
| virtual void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) | Fényirány. Írd [LightingDirection](../lightingdirection/). |
| virtual void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) | Egy előre beállított fényirányt ábrázol, amely egy alakzatra alkalmazható. A fényrendszer egy csoport fényt jelent, amely meghatározott módon van orientálva egy 3D jelenethez képest. Írd [LightRigPresetType](../lightrigpresettype/). |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | Egy forgást a szélességi koordináta, a hosszúsági koordináta és a tengely körüli fordulat használatával definiálnak, ahol a szélességi és hosszúsági koordináták határozzák. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóval (a megosztott helyett) állítja be. Lehetővé teszi a mutatók átkapcsolását a tárolókban gyenge módra. |
