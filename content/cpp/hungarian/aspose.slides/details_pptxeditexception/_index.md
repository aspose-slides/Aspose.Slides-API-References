...
description: Képviseli azt a kivételt, amely akkor kerül dobásra, amikor szerkesztési prezentációs hiba észlelhető.
type: docs
weight: 716
url: /hu/aspose.slides/details_pptxeditexception/
---
## Details_PptxEditException osztály


Képviseli azt a kivételt, amely akkor kerül dobásra, amikor szerkesztési prezentációs hiba észlelhető.
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekéri a objektummal kapcsolt referenciakövető adatstruktúrát. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) metódus analógja. Lehetővé teszi egyedi objektumok hash-elését. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Lekéri az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógja. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrizze, hogy az objektum a targetType által leírt típus példányát képviseli-e. A C# 'is' operátorának analógja. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metódus C#-beli analógja. Lehetővé teszi egyedi típusok klónozását. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerben való gyenge móddá történő átkapcsolását. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementálja a [what()](../../system/details_exception/what/) metódust, amelyet a [ExceptionWrapper](../../system/exceptionwrapper/) osztály hív. Annak ellenére, hogy ez az osztály nem öröklődik a std::exception osztályból, a származtatott osztályok védett/privát tagokat használhatnak logikájuk implementálásához. Ennek a metódusnak az [ExceptionWrapper](../../system/exceptionwrapper/)-ba való áthelyezése megbontja ezt a logikát. |
| virtual  [~Object](../../system/object/~object/)() | Megsemmisíti az objektumot. Felszabadítja az összes belső adatstruktúrát. |
## Lásd még

* Osztály [Details_PptxException](../details_pptxexception/)
