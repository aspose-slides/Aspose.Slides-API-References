...
description: "Base slide show settings. Ancestors represent types of the slide show: PresentedBySpeaker Előadó által prezentált (teljes képernyő) BrowsedByIndividual Egyéni felhasználó által böngészve (ablak) BrowsedAtKiosk Kioszkban böngészve (teljes képernyő)"
type: docs
weight: 5227
...
Alapvető diavetítés beállítások. Az ősök a diavetítés típusait képviselik: [PresentedBySpeaker](../presentedbyspeaker/) Előadóra szabott (teljes képernyő) [BrowsedByIndividual](../browsedbyindividual/) Egyéni böngészés (ablak) [BrowsedAtKiosk](../browsedatkiosk/) Kioszkban történő böngészés (teljes képernyő)
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás zárolását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) vakoló objektumot. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámolót a megadott értékkel. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók konténerben való gyenge módra váltását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Lekéri a megosztott referenciacs számoló aktuális értékét. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() utasítás feloldását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) vakoló objektumot. |
