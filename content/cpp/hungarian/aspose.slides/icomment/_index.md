...
Egy megjegyzést képvisel egy dián.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [get_Author](./get_author/)() | Visszaadja a megjegyzés szerzőjét. Csak olvasható [ICommentAuthor](../icommentauthor/). |
| virtual [System::DateTime](../../system/datetime/) [get_CreatedTime](./get_createdtime/)() | Visszaadja a megjegyzés létrehozásának időpontját. Ennek a tulajdonságnak [DateTime::MinValue](../../system/datetime/minvalue/) értékre állítása azt jelenti, hogy nincs megjegyzés időpont beállítva. Olvasható [System::DateTime](../../system/datetime/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](./)\> [get_ParentComment](./get_parentcomment/)() | Lekéri a szülő megjegyzést. Olvasható [IComment](./). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_Position](./get_position/)() | Visszaadja a megjegyzés pozícióját a dián. Olvasható [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_Slide](./get_slide/)() | Visszaadja a megjegyzés szülődiáját. Csak olvasható [ISlide](../islide/). |
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Visszaadja a diamegjegyzés egyszerű szövegét. Olvasható [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Eltávolítja a megjegyzést és annak minden válaszát a szülő gyűjteményből. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referencia számlálót a megadott értékkel. |
| virtual void [set_CreatedTime](./set_createdtime/)([System::DateTime](../../system/datetime/)) | Beállítja a megjegyzés létrehozásának időpontját. Ennek a tulajdonságnak [DateTime::MinValue](../../system/datetime/minvalue/) értékre állítása azt jelenti, hogy nincs megjegyzés időpont beállítva. Írható [System::DateTime](../../system/datetime/). |
| virtual void [set_ParentComment](./set_parentcomment/)([System::SharedPtr](../../system/sharedptr/)\<[IComment](./)\>) | Beállítja a szülő megjegyzést. Írható [IComment](./). |
| virtual void [set_Position](./set_position/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Beállítja a megjegyzés pozícióját a dián. Írható [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Beállítja a diamegjegyzés egyszerű szövegét. Írható [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a tárolókban lévő mutatók gyenge módra váltását. |
