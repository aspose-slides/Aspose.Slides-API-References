...
description: Egy kollekciót képvisel, amely a prezentáció összes elrendezési diáját tartalmazza. Kiterjeszti a LayoutSlideCollection osztályt olyan módszerekkel, amelyek lehetővé teszik elrendezési diák hozzáadását/klónozását a mesterelrendezések egyedi gyűjteményeinek egyesítésének kontextusában.
type: docs
weight: 1093
...
Represents a collection of all layout slides in presentation. Extends [LayoutSlideCollection](../layoutslidecollection/) osztály with methods for adding/cloning layout slides in context of uniting of the individual collections of master's layout slides.
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | Új elrendezési diát ad a prezentációhoz. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | A megadott elrendezési dia másolatát adja hozzá a prezentációhoz. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | A megadott elrendezési dia másolatát adja hozzá a prezentációhoz. |
| [iterator](../layoutslidecollection/iterator/) [begin](../layoutslidecollection/begin/)() | Visszaad egy iterátort, amely az első elemre (ha van) mutat a gyűjteményben. |
| [const_iterator](../layoutslidecollection/const_iterator/) [begin](../layoutslidecollection/begin/)() const | Visszaad egy iterátort, amely a gyűjtemény const-kvalifikált példányának első elemére (ha van) mutat. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cbegin](../layoutslidecollection/cbegin/)() const | Visszaad egy iterátort, amely a gyűjtemény első const-kvalifikált elemére (ha van) mutat. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cend](../layoutslidecollection/cend/)() const | Visszaad egy iterátort, amely a gyűjtemény utolsó const-kvalifikált eleme után (ha van) mutat. |
| void [CopyTo](../layoutslidecollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>, **int32_t**) override | Az összes elemet átmásolja a gyűjteményből a megadott tömbbe. |
...
| [iterator](../layoutslidecollection/iterator/) [end](../layoutslidecollection/end/)() | Visszaad egy iterátort, amely a gyűjtemény utolsó elemére (ha van) mutat. |
| [const_iterator](../layoutslidecollection/const_iterator/) [end](../layoutslidecollection/end/)() const | Visszaad egy iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó elemére (ha van) mutat. |
...
| **int32_t** [get_Count](../layoutslidecollection/get_count/)() override | Visszaadja az elrendezési diák számát egy gyűjteményben. Írásvédett **int32_t**. |
| **bool** [get_IsSynchronized](../layoutslidecollection/get_issynchronized/)() override | Visszaad egy értéket, amely azt jelzi, hogy a gyűjteményhez való hozzáférés szinkronizált (szálbiztos). Írásvédett **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../layoutslidecollection/get_syncroot/)() override | Visszaad egy szinkronizációs gyökeret. Írásvédett [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../layoutslidecollection/idx_get/)(**int32_t**) override | Visszaadja az elrendezési diát index szerint. Írásvédett [LayoutSlide](../layoutslide/). |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy sorozat értékeinek átlagát, amelyeket a bemeneti sorozat minden elemére alkalmazott transzformáló függvény eredménye ad. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Visszaadja a sorozat első elemét, vagy egy alapértéket, ha a sorozat üres. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Visszaadja a sorozat első olyan elemét, amely a feltételt teljesíti, vagy egy alapértéket, ha nincs ilyen elem. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Visszaadja a sorozat utolsó elemét, vagy egy alapértéket, ha a sorozat üres. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Az egyes sorozat-elemeket új formába alakítja az elem indexének felhasználásával. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden elemre projekciót végez, és az eredményül kapott sorozatokat egyetlen sorozattá egyesíti. |
...
| void [RemoveUnused](../layoutslidecollection/removeunused/)() override | Eltávolítja a nem használt elrendezési diákat (azokat a diákat, amelyeknél a HasDependingSlides hamis). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonparamétert gyenge pointerré (nem megosztottá) állítja be. Lehetővé teszi a konténerekben lévő pointerek weak módra váltását. |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginConstIterator](../layoutslidecollection/virtualizebeginconstiterator/)() const override | Visszaad egy iterátort, amely a gyűjtemény const-kvalifikált példányának első elemére (ha van) mutat. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginIterator](../layoutslidecollection/virtualizebeginiterator/)() override | Visszaad egy iterátort, amely a gyűjtemény első elemére (ha van) mutat. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndConstIterator](../layoutslidecollection/virtualizeendconstiterator/)() const override | Visszaad egy iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó eleme után (ha van) mutat. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndIterator](../layoutslidecollection/virtualizeenditerator/)() override | Visszaad egy iterátort, amely a gyűjtemény utolsó eleme után (ha van) mutat. |
...
* Osztály [IGlobalLayoutSlideCollection](../igloballayoutslidecollection/)
