...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() override | Visszaad egy [EffectFormat](../effectformat/) a [BackgroundType::OwnBackground](../backgroundtype/) kitöltéshez. Csak olvasható [IEffectFormat](../ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Visszaad egy [FillFormat](../fillformat/) a [BackgroundType::OwnBackground](../backgroundtype/) kitöltéshez. Csak olvasható [IFillFormat](../ifillformat/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../ipviobject/get_parent_ipresentationcomponent/)() | Visszaad szülő [IPresentationComponent](../ipresentationcomponent/). Csak olvasható [IPresentationComponent](../ipresentationcomponent/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](./get_presentation/)() override | Visszaad a dia szülő prezentációját. Csak olvasható [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](./get_slide/)() override | Visszaad a forma szülő diáit. Csak olvasható [IBaseSlide](../ibaseslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() override | Visszaad egy [ColorFormat](../colorformat/) egy [BackgroundType::Themed](../backgroundtype/) kitöltéshez. Csak olvasható [IColorFormat](../icolorformat/). |
| **uint16_t** [get_StyleIndex](./get_styleindex/)() override | Visszaad a [BackgroundType::Themed](../backgroundtype/) kitöltés indexét a háttér téma gyűjteményben. 0 jelenti a kitöltés hiányát. 1..999 - index. Olvas **uint16_t**. |
| [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() override | Visszaad a háttér kitöltés típusát. Olvas [BackgroundType](../backgroundtype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() override | Lekéri a hatékony háttér adatot az öröklődés alkalmazásával. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | Visszaad a hash kódot. |
...
| void [set_StyleIndex](./set_styleindex/)(**uint16_t**) override | Visszaad a [BackgroundType::Themed](../backgroundtype/) kitöltés indexét a háttér téma gyűjteményben. 0 jelenti a kitöltés hiányát. 1..999 - index. Ír **uint16_t**. |
| void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) override | Visszaad a háttér kitöltés típusát. Ír [BackgroundType](../backgroundtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi a pointerek átkapcsolását gyenge módba a tárolókban. |
...
* Osztály [IBackground](../ibackground/)
