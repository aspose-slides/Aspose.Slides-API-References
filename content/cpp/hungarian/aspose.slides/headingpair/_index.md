...
A dokumentum 'Heading pair' tulajdonságát képviseli. Jelzi a dokumentum részeinek csoportnevét és a csoportba tartozó részek számát.
...
| **int32_t** [get_Count](./get_count/)() override | Visszaadja a csoportban lévő részek számát. Csak olvasható **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Visszaadja a dokumentum részeinek csoportnevét. Csak olvasható [System::String](../../system/string/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot hivatkozás alapján hasonlít össze nullptr-kal. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatónak (ahelyett, hogy megosztott lenne). Lehetővé teszi a mutatók átváltását gyenge módba konténerekben. |
...
* Osztály [IHeadingPair](../iheadingpair/)
