...
description: A dia háttérjét reprezentálja.
type: docs
weight: 1405
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Visszaad egy [EffectFormat](../effectformat/)-t a [BackgroundType::OwnBackground](../backgroundtype/) kitöltéshez. Csak olvasható [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Visszaad egy [FillFormat](../fillformat/)-t a [BackgroundType::OwnBackground](../backgroundtype/) kitöltéshez. Csak olvasható [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../islidecomponent/get_slide/)() | Visszaadja az alapdia. Csak olvasható [IBaseSlide](../ibaseslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Visszaad egy [ColorFormat](../colorformat/)-t egy [BackgroundType::Themed](../backgroundtype/) kitöltéshez. Csak olvasható [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Visszaad egy indexet a [BackgroundType::Themed](../backgroundtype/) kitöltéshez a háttértéma gyűjteményben. 0 = nincs kitöltés. 1..999 – index. Olvas **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Visszaadja a háttérkitöltés típusát. Olvas [BackgroundType](../backgroundtype/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Lekéri a hatékony háttéradatot az öröklődés alkalmazásával. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Visszaad egy indexet a [BackgroundType::Themed](../backgroundtype/) kitöltéshez a háttértéma gyűjteményben. 0 = nincs kitöltés. 1..999 – index. Ír **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Visszaadja a háttérkitöltés típusát. Ír [BackgroundType](../backgroundtype/). |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | A C# [Object.ToString()](../../system/object/tostring/) metódus analógiája. Engedélyezi az egyedi objektumok stringgé konvertálását. |
