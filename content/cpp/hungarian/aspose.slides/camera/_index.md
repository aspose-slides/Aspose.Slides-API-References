...
description: A Camera osztályt reprezentálja.
type: docs
weight: 261
...
| [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() override | [Camera](./) típus. Olvas [CameraPresetType](../camerapresettype/). |
| **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() override | [Camera](./) FOV (0-180 deg, field of View). Olvas **float**. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() override | A forgatás a szélességi koordináta, a hosszúsági koordináta, valamint a tengely körüli forogás használatával definiálható, mint a szélességi és hosszúsági koordináták. Az eredmény tömb első eleme – szélesség, a második – hosszúság, a harmadik – forogás. Null értéket ad vissza, ha nincs definiált forgatás. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Lekéri az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógiája. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum egy példányt képvisel-e a targetType által leírt típusból. A C# 'is' operátor analógiája. |
...
| void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) override | [Camera](./) típus. Ír [CameraPresetType](../camerapresettype/). |
| void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) override | [Camera](./) FOV (0-180 deg, field of View). Ír **float**. |
| void [set_Zoom](./set_zoom/)(**float**) override | [Camera](./) zoom (pozitív érték százalékban). Ír **float**. |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | A forgatás a szélességi koordináta, a hosszúsági koordináta, valamint a tengely körüli forogás használatával definiálható, mint a szélességi és hosszúsági koordináták. Ha bármely koordináta értéke std::numeric_limits<float>::quiet_NaN(), akkor a teljes forgatás nincs definiálva. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóvá (a shared helyett) állítja be. Lehetővé teszi a mutatók konténerekben való weak módba való átvitelét. |
