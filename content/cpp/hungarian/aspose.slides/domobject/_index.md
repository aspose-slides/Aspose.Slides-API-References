...
type: docs
weight: 807
url: /hu/aspose.slides/domobject/
---
## DomObject osztály

Alap [DOM](../../aspose.slides.dom/) objektum
...
| Paraméter | Leírás |
| --- | --- |
| TParent | A szülő [DOM](../../aspose.slides.dom/) objektum típusa |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Az n-edik sablonargumentumot gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a konténerekben lévő mutatók gyenge módba való átkapcsolását. |
