...
description: A további táblázatok viselkedésének meghatározásához használható beállításokat képviseli.
type: docs
weight: 3862
url: /hu/aspose.slides/ispreadsheetoptions/
---
## ISpreadsheetOptions osztály

A további táblázatok viselkedésének meghatározásához használható beállításokat képviseli.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | Megkapja a preferált kultúra információkat bizonyos függvények számításához, amelyek a dupla bájtos karakterkészletet (DBCS) használó nyelvekhez készülnek. |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | Ha a diagram adatforrása egy külső munkafüzet, és az nem érhető el, akkor a diagram gyorsítótárából állítják helyre. |
...
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | Megkapja a preferált kultúra információkat bizonyos függvények számításához, amelyek a dupla bájtos karakterkészletet (DBCS) használó nyelvekhez készülnek. |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | Ha a diagram adatforrása egy külső munkafüzet, és az nem érhető el, akkor a diagram gyorsítótárából állítják helyre. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett) állítja be. Lehetővé teszi a mutatók konténerben való gyenge módra való átkapcsolását. |
