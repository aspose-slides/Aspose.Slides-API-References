...
|  [FontSubstRule](./fontsubstrule/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) | Új példányt hoz létre. |
|  [FontSubstRule](./fontsubstrule/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>, [FontSubstCondition](../fontsubstcondition/)) | Új példányt hoz létre. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_DestFont](./get_destfont/)() override | A felülírásra szánt helyettesítéshez használt betűtípus. Csak olvasható [IFontData](../ifontdata/). |
| [FontSubstCondition](../fontsubstcondition/) [get_ReplaceFontCondition](./get_replacefontcondition/)() override | A felülírásra alkalmazandó szabály. Csak olvasható [FontSubstCondition](../fontsubstcondition/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_SourceFont](./get_sourcefont/)() override | A helyettesítendő betűtípus. Csak olvasható [IFontData](../ifontdata/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (nem megosztott). Lehetővé teszi a mutatók konténerekben történő gyenge módra váltását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Visszaadja a megosztott referenciarámláló aktuális értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott referenciarámláló értékét. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
...
* Osztály [IFontSubstRule](../ifontsubstrule/)
