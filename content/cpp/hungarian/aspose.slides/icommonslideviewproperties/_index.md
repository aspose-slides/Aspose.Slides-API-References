...
description: Közös diavetítés nézet tulajdonságokat képvisel.
type: docs
weight: 1834
url: /hu/aspose.slides/icommonslideviewproperties/
---
## ICommonSlideViewProperties osztály


Közös diavetítés nézet tulajdonságokat képvisel.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | Visszaadja a megadott indexű rajzolósegédet. Csak olvasható [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Visszaadja a rajzolósegédek gyűjteményét. Csak olvasható [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | Megadja a nézet skálázási arányát százalékban. Olvasás **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | Megadja, hogy a nézet tartalma automatikusan skálázódjon, hogy a legjobban illeszkedjen az aktuális ablakmérethez. Olvasás **bool**. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Megadja a nézet skálázási arányát százalékban. Írás **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Megadja, hogy a nézet tartalma automatikusan skálázódjon, hogy a legjobban illeszkedjen az aktuális ablakmérethez. Írás **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi a pointerek konténerekben való gyenge módba váltását. |
