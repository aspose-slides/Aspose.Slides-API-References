...
description: Mester jegyzetdiák kezelője.
type: docs
weight: 2913
url: /hu/aspose.slides/imasternotesslidemanager/
---
## IMasterNotesSlideManager osztály
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [get_MasterNotesSlide](./get_masternotesslide/)() | Visszaad egy master objektumot a prezentáció összes jegyzetdia számára, ha létezik, ellenkező esetben null értéket ad vissza. Csak olvasható [IMasterNotesSlide](../imasternotesslide/). |
...
| virtual void [RemoveMasterNotesSlide](./removemasternotesslide/)() | Eltávolítja a master jegyzetdiát. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [SetDefaultMasterNotesSlide](./setdefaultmasternotesslide/)() | Beállítja az alapértelmezett master jegyzetdiát a kapcsolódó jegyzetdia számára. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n. sablonargumentumot gyenge mutatóvá (a megosztott helyett) állítja. Lehetővé teszi a mutatók tárolókban való gyenge módra való átváltását. |
