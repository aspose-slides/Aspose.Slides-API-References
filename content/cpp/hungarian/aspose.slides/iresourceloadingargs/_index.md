...
description: Interfész a külső erőforrás betöltési argumentumok számára.
type: docs
weight: 3485
...
Interfész a külső erőforrás betöltési argumentumok számára.
...
| virtual [System::String](../../system/string/) [get_OriginalUri](./get_originaluri/)() | Az erőforrás eredeti URI-ja, ahogyan az importált bemutatóban meg van adva. |
| virtual [System::String](../../system/string/) [get_Uri](./get_uri/)() | Az URI, amelyet az erőforrás letöltésére használnak, ha [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::Default](../resourceloadingaction/) értéket ad vissza. Kezdetben az erőforrás eredeti URI-jára van beállítva, de bármilyen értékre felülírható. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum-e egy példány-e a targetType által leírt típusnak. A C# 'is' operátor analógja. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenciával hasonlítja össze az érték típusú objektumot a nullptr-el. |
...
| virtual void [set_Uri](./set_uri/)([System::String](../../system/string/)) | Az URI, amelyet az erőforrás letöltésére használnak, ha [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::Default](../resourceloadingaction/) értéket ad vissza. Kezdetben az erőforrás eredeti URI-jára van beállítva, de bármilyen értékre felülírható. |
| virtual void [SetData](./setdata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Beállítja a felhasználó által megadott adatot az erőforráshoz, amely akkor használatos, ha [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::UserProvided](../resourceloadingaction/) értéket ad vissza. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként (nem megosztottként) állítja be. Lehetővé teszi a mutatók konténerekben történő gyenge módra való átkapcsolását. |
