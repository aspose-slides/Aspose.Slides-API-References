...
description: A forma fő felületének kiemelési tulajdonságait képviseli.
type: docs
weight: 3654
...
A forma fő felületének kiemelési tulajdonságait képviseli.
...
| Módszer | Leírás |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Objektumok összehasonlítása C# [Object.Equals](../../system/object/equals/) szemantikai szabályok szerint. |
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Bevel típus. Olvas [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Bevel magasság. Olvas **double**. |
| virtual **double** [get_Width](./get_width/)() | Bevel szélesség. Olvas **double**. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | A C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metódus analógja. Egyedi típusok klónozását teszi lehetővé. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Bevel típus. Írás [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Bevel magasság. Írás **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Bevel szélesség. Írás **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóvá (a megosztott helyett). Lehetővé teszi a mutatók konténerben történő gyenge módra váltását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Lekéri a megosztott referenciaszámláló aktuális értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | A C# [Object.ToString()](../../system/object/tostring/) metódus analógja. Egyedi objektumok stringgé konvertálását teszi lehetővé. |
