...
| **uint32_t** [get_End](./get_end/)() const | Vég |
| **uint32_t** [get_Start](./get_start/)() const | Kezdet |
...
| void [set_End](./set_end/)(**uint32_t**) | Vég |
| void [set_Start](./set_start/)(**uint32_t**) | Kezdet |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók konténerekben való gyenge módra való átkapcsolását. |
