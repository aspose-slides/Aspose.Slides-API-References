...
description: Egy olyan típust reprezentál, amely a megfelelő hatékony adatot adja vissza az öröklődés alkalmazásával.
type: docs
weight: 1275
url: /hu/aspose.slides/iaccessiblepviobject/
---
## IAccessiblePVIObject osztály
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN nem egyenlő bármely értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN nem egyenlő bármely értékkel, beleértve a NaN-t is. |
...
| virtual T [GetEffective](./geteffective/)() | Lekéri a hatékony adatot az öröklődés alkalmazásával. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonparamétert gyenge mutatóként állítja be (nem megosztottként). Lehetővé teszi a tárolók mutatóinak gyenge módra váltását. |
