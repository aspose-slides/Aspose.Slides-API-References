...
type: docs
weight: 638
url: /hu/aspose.slides/details_ooxmlexception/
---
## Details_OOXMLException osztály


A standard belső kivételtípust képviseli, amely az Office Open XML fájlformátummal kapcsolatos.
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Visszaadja a veremkivonatot tartalmazó karakterláncot. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) metódus megfelelője. Engedélyezi egyedi objektumok hashelését. |
...
|  [Object](../../system/object/object/)() | Létrehozza az objektumot. Inicializál minden belső adatszerkezetet. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonparamétert gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a mutatók átváltását gyenge módra a tárolókban. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Megvalósítja a [what()](../../system/details_exception/what/) metódust, amelyet a [ExceptionWrapper](../../system/exceptionwrapper/) osztály hív. Annak ellenére, hogy ez az osztály nem öröklődik a std::exception-ből, a származtatott osztályok használhatják a védett/privát tagokat a logikájuk megvalósításához. Ennek a metódusnak a [ExceptionWrapper](../../system/exceptionwrapper/)-be való áthelyezése megtörheti ezt a logikát. |
