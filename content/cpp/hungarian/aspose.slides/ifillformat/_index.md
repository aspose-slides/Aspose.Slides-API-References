...
description: Képviseli a kitöltés formázási beállításait.
type: docs
weight: 2107
...
Képviseli a kitöltés formázási beállításait.
...
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | Visszaadja a kitöltés típusát. Olvassa [Slides::FillType](../filltype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() | Visszaadja a fokozatos kitöltés formátumát. Csak olvasható [IGradientFormat](../igradientformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() | Visszaadja a minta kitöltés formátumát. Csak olvasható [IPatternFormat](../ipatternformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFillFormat](./get_picturefillformat/)() | Visszaadja a képes kitöltés formátumát. Csak olvasható [IPictureFillFormat](../ipicturefillformat/). |
| virtual [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() | Megállapítja, hogy a kitöltést a formával együtt kell-e elforgatni. Olvassa [NullableBool](../nullablebool/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() | Visszaadja a kitöltés színét. Csak olvasható [IColorFormat](../icolorformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [GetEffective](./geteffective/)() | Lekéri a hatékony kitöltés formázási adatot az öröklődés alkalmazásával. |
...
| virtual void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) | Beállítja a kitöltés típusát. Írja [Slides::FillType](../filltype/). |
| virtual void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) | Megállapítja, hogy a kitöltést a formával együtt kell-e elforgatni. Írja [NullableBool](../nullablebool/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett) állítja be. Lehetővé teszi a mutatók konténerekben való gyenge módra váltását. |
