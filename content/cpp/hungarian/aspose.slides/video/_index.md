...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Visszaadja a hang adatainak másolatát. Nagy mennyiségű adat esetén fontolja meg a [Video::GetStream](./getstream/) metódus használatát a videó adatainak felesleges memóriába töltésének vagy akár OutOfMemoryException-nek elkerülése érdekében. Csak olvasható **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Visszaad egy videó MIME típusát, amely [Video::get_BinaryData](./get_binarydata/) formátumban van kódolva. Csak olvasható [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | Visszaad egy Stream-et olvasásra. Használja a 'using' kulcsszót vagy zárja be a streamet a használat után. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyengémódra váltását. |
