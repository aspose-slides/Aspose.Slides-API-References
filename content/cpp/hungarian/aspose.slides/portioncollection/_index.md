...
| Metódus | Leírás |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Hozzáad egy [Portion](../portion/) elemet a gyűjtemény végéhez. |
| [iterator](./iterator/) [begin](./begin/)() | Lekéri az iterátort, amely az első elemre (ha van) mutat a gyűjteményben. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Lekéri az iterátort, amely a gyűjtemény utolsó const-kvalifikált eleme utánra (ha van) mutat. |
| void [Clear](./clear/)() override | Eltávolítja az összes elemet a gyűjteményből. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Megállapítja, hogy a [ICollection](../../system.collections.generic/icollection/) tartalmaz-e egy adott értéket. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>\>, **int32_t**) | Átmásolja a [ICollection](../../system.collections.generic/icollection/) elemeit egy [System::Array](../../system/array/)-ba, egy adott [System::Array](../../system/array/) indexnél kezdve. |
| [iterator](./iterator/) [end](./end/)() | Lekéri az iterátort, amely a gyűjtemény utolsó elemét követően (ha van) mutat. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Lekéri az iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó elemét követően (ha van) mutat. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekinthető, még akkor is, ha az IEC 60559:1989 szerint a NaN nem egyenlő semelyik értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekinthető, még akkor is, ha az IEC 60559:1989 szerint a NaN nem egyenlő semelyik értékkel, beleértve a NaN-t is. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Lekéri azt az értéket, amely jelzi, hogy a [ICollection](../../system.collections.generic/icollection/) csak olvasható-e. Csak olvasható **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végigiterál a gyűjteményen. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) metódus analógja. Lehetővé teszi egyedi objektumok hash-elését. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Lekéri az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógja. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [idx_get](./idx_get/)(**int32_t**) override | Lekéri a megadott indexű elemet. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Lekéri a megadott indexű elemet. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Megállapítja egy adott elem indexét a [IList](../../system.collections.generic/ilist/)-ban. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Beszúr egy [Portion](../portion/) elemet a gyűjteménybe a megadott indexnél. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy sorozat értékeinek átlagát, amelyeket a bemeneti sorozat minden elemére meghívott transzformáló függvény eredményeként kapunk. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Meghív egy transzformáló függvényt egy generikus sorozat minden elemére, és visszaadja a legnagyobb eredményt. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Meghív egy transzformáló függvényt egy generikus sorozat minden elemére, és visszaadja a legkisebb eredményt. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot referenciával hasonlít össze nullptr-tal. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja string és nullptr esetére. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja stringek esetére. |
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Eltávolítja a [ICollection](../../system.collections.generic/icollection/) első előfordulását egy adott objektumból. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Eltávolítja a gyűjtemény megadott indexű elemét. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | A n-edik sablonargumentumot gyenge mutatóra (a megosztottra helyett) állítja. Lehetővé teszi a mutatók konténerekben való gyenge módra történő átváltását. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Lekéri az iterátort, amely a const-kvalifikált gyűjtemény példány első elemére (ha van) mutat. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Lekéri az iterátort, amely a const-kvalifikált gyűjtemény példány utolsó elemét követően (ha van) mutat. |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Olyan gyűjteménytípus, amelynek iterátortípusait a jelenlegi gyűjtemény iterátortípusaiként használja. |
...
* Osztály [IPortionCollection](../iportioncollection/)
