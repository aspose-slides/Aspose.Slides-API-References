...
description: Kezelőt képvisel, amely a lábléc, dátum-idő és oldalszám helyőrzők viselkedését tárolja minden diatípushoz.
type: docs
weight: 131
...
Azt a menedzsert képviseli, amely a lábléc, dátum-idő és oldalszámhelyettesítő elemek viselkedését tárolja minden diatípushoz.
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Átadás operátor. Valójában nem másol semmit, csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másoló konstrukcióját. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot nullptr-re referenciázzal hasonlít össze. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonparamétert egy gyenge pointerre (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását a konténerekben gyenge módra. |
...
* Osztály [IBaseHeaderFooterManager](../ibaseheaderfootermanager/)
