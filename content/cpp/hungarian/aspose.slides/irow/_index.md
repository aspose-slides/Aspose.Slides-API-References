...
description: Egy táblázat sorát képviseli.
type: docs
weight: 3511
...
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Átmásolja a gyűjtemény összes elemét a meghatározott tömbbe. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Lekéri az iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó eleme utánra (ha van) mutat. |
...
| virtual **double** [get_Height](./get_height/)() | Visszaadja a sor magasságát. Csak olvasható **double**. |
...
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Visszaadja a sor legkisebb lehetséges magasságát. Csak **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Visszaadja a [RowFormat](../rowformat/) objektumot, amely a sor formázási tulajdonságait tartalmazza. Csak olvasható [IRowFormat](../irowformat/). |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy sorozat értékeinek átlagát, amelyeket egy transzformáló függvény hívásával nyerünk ki az input sorozat minden eleméből. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyedi sorozat elemére meghív egy transzformáló függvényt, és visszaadja a kapott maximális értéket. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyedi sorozat elemére meghív egy transzformáló függvényt, és visszaadja a kapott minimális értéket. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | A sorozat minden elemét projektálja, és az eredményül kapott sorozatokat egyetlen sorozatba egyesíti. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában semmit nem másol, csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másolókonstruktorait. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában semmit nem másol, csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másolókonstruktorait. |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Beállítja a sor legkisebb lehetséges magasságát. Írás **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonparamétert gyenge mutatóként állítja be (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását a tárolókban gyenge módra. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Beállítja a meghatározott részformázási tulajdonságokat az összes elem részleteire. |
