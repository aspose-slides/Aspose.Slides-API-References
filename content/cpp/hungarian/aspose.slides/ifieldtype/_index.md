...
description: Egy mező típusát képviseli. Ez az érték határozza meg, hogy melyik szöveg kerül beállításra a mező részére, amikor frissítve lesz.
type: docs
weight: 2094
...
Egy mező típusát képviseli. Ez az érték határozza meg, hogy melyik szöveg kerül beállításra a mező részre, amikor frissítve lesz.
...
| virtual [System::String](../../system/string/) [get_InternalString](./get_internalstring/)() | Visszaadja ennek a FieldTypeEx objektumnak a belső nevét. Olvassa el [System::String](../../system/string/). |
...
| virtual void [set_InternalString](./set_internalstring/)([System::String](../../system/string/)) | Visszaadja ennek a FieldTypeEx objektumnak a belső nevét. Írja [System::String](../../system/string/). |
