...
| Módszer | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)() override | Létrehozza az üres szövegrészt. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::String](../../system/string/)) override | Létrehozza a szövegrészt a megadott karakterláncból. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Létrehozza a részt a megadott részadatok használatával. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekéri az objektumhoz kapcsolódó hivatkozás számláló adatstruktúrát. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott hivatkozási számlálót a megadott értéknek megfelelően. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonparamétert gyenge mutatóként (nem megosztott). Lehetővé teszi a mutatók konténerekben való gyenge módra váltását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Lekéri a megosztott hivatkozási számláló jelenlegi értékét. |
...
* Osztály [IPortionFactory](../iportionfactory/)
