...
description: Osztály egyedi, a felhasználó által definiált betűtípusok betöltésére. A prezentációs objektumok létrehozása előtt kell használni.
type: docs
weight: 2237
url: /hu/aspose.slides/ifontsloader/
---
## IFontsLoader osztály

Osztály egyedi betűtípusok betöltésére, amelyeket a felhasználó definiál. Használni kell a prezentációs objektumok létrehozása előtt.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Ugyanúgy viselkedik, mint a C#-stílusú lebegőpontos összehasonlítás, ahol két NaN értéket egyenlőnek tekint, még akkor is, ha az IEC 60559:1989 szerint a NaN nem egyenlő semelyik értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Ugyanúgy viselkedik, mint a C#-stílusú lebegőpontos összehasonlítás, ahol két NaN értéket egyenlőnek tekint, még akkor is, ha az IEC 60559:1989 szerint a NaN nem egyenlő semelyik értékkel, beleértve a NaN-t is. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók konténerekben való weak módba váltását. |
