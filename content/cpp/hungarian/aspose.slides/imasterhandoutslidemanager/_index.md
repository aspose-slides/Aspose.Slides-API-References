...
---
## IMasterHandoutSlideManager osztály
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást utánoz, ahol a két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semmivel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást utánoz, ahol a két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN nem egyenlő semmivel, beleértve a NaN-t is. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső célokra. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [get_MasterHandoutSlide](./get_masterhandoutslide/)() | Visszaad egy mester objektumot az összes jegyzet dia számára ebben a bemutatóban, ha van ilyen, ellenkező esetben null-t ad vissza. Csak olvasható [IMasterHandoutSlide](../imasterhandoutslide/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia alapján hasonlít össze értéktípusú objektumot a nullptr-tel. |
...
| virtual void [RemoveMasterHandoutSlide](./removemasterhandoutslide/)() | Eltávolítja a mester jegyzet diát. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [SetDefaultMasterHandoutSlide](./setdefaultmasterhandoutslide/)() | Beállítja az alapértelmezett mester jegyzet diát a kapcsolódó jegyzet diára. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge pointerre (a megosztott helyett). Lehetővé teszi a pointerek gyenge módba való átkapcsolását a konténerekben. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | A C# [Object.ToString()](../../system/object/tostring/) metódus analógja. Lehetővé teszi a saját objektumok karakterláncra konvertálását. |
