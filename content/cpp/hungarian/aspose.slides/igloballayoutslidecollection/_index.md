...
description: Egy gyűjteményt képvisel, amely tartalmazza a bemutató összes elrendezési diáját. Kiterjeszti az ILayoutSlideCollection interfészt olyan metódusokkal, amelyek lehetővé teszik az elrendezési diák hozzáadását/klónozását a mesterelrendezések egyedi gyűjteményeinek egyesítése kontextusában.
type: docs
weight: 2367
url: /hu/aspose.slides/igloballayoutslidecollection/
---
## IGlobalLayoutSlideCollection osztály

Egy gyűjteményt képvisel, amely tartalmazza a bemutató összes elrendezési diáját. Kiterjeszti a [ILayoutSlideCollection](../ilayoutslidecollection/) interfészt olyan metódusokkal, amelyek lehetővé teszik az elrendezési diák hozzáadását/klónozását a mesterelrendezési diák egyedi gyűjteményeinek egyesítése kontextusában.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Új elrendezési diát ad hozzá a bemutatóhoz. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Megadott elrendezési diából másolatot ad hozzá a bemutatóhoz. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Megadott elrendezési diából másolatot ad hozzá a bemutatóhoz. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Lekér egy iterátort, amely az első elemet (ha van) mutatja a gyűjteményben. Ez az iterátor nem használható a hivatkozott objektum módosítására, mivel [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) egy másolat-objektumot ad vissza T típusú. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Lekér egy iterátort, amely az első elemet (ha van) mutatja a gyűjtemény const-kvalifikált példányában. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Lekér egy iterátort, amely az első const-kvalifikált elemet (ha van) mutatja a gyűjteményben. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Lekér egy iterátort, amely a gyűjtemény utolsó const-kvalifikált eleme utánra mutat (ha van). |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Lekér egy iterátort, amely a gyűjtemény utolsó eleme utánra mutat (ha van). Ez az iterátor nem használható a hivatkozott objektum módosítására, mivel [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) egy másolat-objektumot ad vissza T típusú. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Lekér egy iterátort, amely a gyűjtemény const-kvalifikált példányának utolsó eleme utánra mutat (ha van). |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Visszaad egy értéket, amely jelzi, hogy a gyűjteményhez való hozzáférés szinkronizált (szálbiztos). Csak-olvasás **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Visszaad egy szinkronizációs gyökér objektumot. Csak-olvasás [System::Object](../../system/object/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | Visszaadja a megadott típusú első elrendezési diát. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | Visszaadja az elrendezési diát az index alapján. Csak-olvasás [ILayoutSlide](../ilayoutslide/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzés, hogy az objektum a targetType által leírt típusú példány-e. A C# 'is' operátor analógja. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Számítja egy sorozat értékeinek átlagát, amelyet az egyes bemeneti elemek transzformáló függvényének meghívásával kap. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | A sorozat minden elemét egy új formába alakítja, figyelembe véve az elem indexét. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden egyes elemre projekciót végez, és az eredményül kapott sorozatokat egy sorozatba egyesíti. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Sorozatot szűr a megadott feltétel alapján. |
...
| virtual void [Remove](../ilayoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Eltávolít egy elrendezést a gyűjteményből. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| virtual void [RemoveUnused](../ilayoutslidecollection/removeunused/)() | Eltávolítja a nem használt elrendezési diákat (olyan diákat, amelyeknél a HasDependingSlides hamis). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonparamétert gyenge mutatóra (a megosztott helyett) állítja. Lehetővé teszi a mutatók konténerben történő gyenge módra váltását. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Lekéri a begin const iterátor megvalósítását az aktuális tároló számára. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Lekéri a begin iterátor megvalósítását az aktuális tároló számára. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Lekéri az end const iterátor megvalósítását az aktuális tároló számára. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Lekéri az end iterátor megvalósítását az aktuális tároló számára. |
