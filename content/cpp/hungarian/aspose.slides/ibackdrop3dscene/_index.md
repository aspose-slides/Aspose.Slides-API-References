...
description: Meghatároz egy síkot, amelyben a hatások, például a ragyogás és az árnyék, az alakzathoz viszonyítva kerülnek alkalmazásra.
type: docs
weight: 1392
url: /hu/aspose.slides/ibackdrop3dscene/
---
## IBackdrop3DScene osztály
...
| Method | Description |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Objektumokat összehasonlít C# [Object.Equals](../../system/object/equals/) szemantika szerint. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_AnchorPoint](./get_anchorpoint/)() | Visszaad egy pontot a 3D térben. Ez a pont a háttérsíkot rögzítő pont a térben. A 3D pont 3 float értékből álló tömbként van ábrázolva, amely az X, Y és Z koordinátákat definiálja. Olvasás **float**[]. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_NormalVector](./get_normalvector/)() | Visszaad egy normálvektort. Pontosabban, ez az attribútum egy vektort definiál, amely a háttérsík felületére merőleges. A vektor 3 float értékből álló tömbként van ábrázolva, amely az X, Y és Z koordinátákat határozza meg. Olvasás **float**[]. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_UpVector](./get_upvector/)() | Visszaad egy felfelé mutató vektort. Pontosabban, ez az attribútum egy felfelé mutató vektort definiál a háttérsík felületéhez viszonyítva. A vektor 3 float értékből álló tömbként van ábrázolva, amely az X, Y és Z koordinátákat határozza meg. Olvasás **float**[]. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekérdezi az objektumhoz kapcsolódó referenciacsökkentő adatstruktúrát. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Hozzárendelési operátor. Valójában nem másol semmit, csak egy új objektumot inicializál és lehetővé teszi az alosztályok másoló konstruktorát. |
...
| virtual void [set_AnchorPoint](./set_anchorpoint/)([System::ArrayPtr](../../system/arrayptr/)\<**float**\>) | Beállít egy pontot a 3D térben. Ez a pont a háttérsíkot rögzítő pont a térben. A 3D pont 3 float értékből álló tömbként van ábrázolva, amely az X, Y és Z koordinátákat definiálja. Írás **float**[]. |
| virtual void [set_NormalVector](./set_normalvector/)([System::ArrayPtr](../../system/arrayptr/)\<**float**\>) | Beállít egy normálvektort. Pontosabban, ez az attribútum egy vektort definiál, amely a háttérsík felületére merőleges. A vektor 3 float értékből álló tömbként van ábrázolva, amely az X, Y és Z koordinátákat definiálja. Írás **float**[]. |
| virtual void [set_UpVector](./set_upvector/)([System::ArrayPtr](../../system/arrayptr/)\<**float**\>) | Beállít egy felfelé mutató vektort. Pontosabban, ez az attribútum egy felfelé mutató vektort definiál a háttérsík felületéhez viszonyítva. A vektor 3 float értékből álló tömbként van ábrázolva, amely az X, Y és Z koordinátákat definiálja. Írás **float**[]. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként állítja be (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módra való átkapcsolását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Lekérdezi a megosztott referenciacsökkentő aktuális értékét. |
