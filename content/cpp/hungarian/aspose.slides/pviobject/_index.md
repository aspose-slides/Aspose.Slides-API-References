...
description: Átfogja az alapvető szolgáltatási infrastruktúrát azon objektumok számára, amelyek a tulajdonságérték-öröklődés alanyai lehetnek.
type: docs
weight: 4928
...
Átfogja az objektumok számára a tulajdonságérték-öröklődés alanyává válhat alapvető szolgáltatási infrastruktúrát.
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Visszaadja a hashkódot. |
