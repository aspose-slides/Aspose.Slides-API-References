...
description: A Microsoft Purview Information Protection szolgáltatásból származó szenzitivitási címkét reprezentál.
type: docs
weight: 5058
...
A Microsoft Purview Information Protection szenzitivitási címkéjét jelenti.
...
| [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() override | Visszaadja a szenzitivitási címke hozzárendelési módszerét. Olvasd [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() override | Visszaadja a fájlra alkalmazandó tartalomjelölés típusainak listáját. |
| [System::String](../../system/string/) [get_Id](./get_id/)() override | Visszaadja a szenzitivitási címke azonosítóját. Olvasd [System::String](../../system/string/). |
| **bool** [get_IsEnabled](./get_isenabled/)() override | Jelzi, hogy a szenzitivitási címke engedélyezve van-e. |
| **bool** [get_IsRemoved](./get_isremoved/)() override | Jelzi, hogy a szenzitivitási címke el lett-e távolítva. |
| [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() override | Visszaadja a szenzitivitási címke szabályzatát leíró Azure Active Directory (Azure AD) webhelyazonosítót. Olvasd [System::Guid](../../system/guid/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum a cél típusa által leírt példány-e. A C# 'is' operátor analógja. |
...
| void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) override | Beállítja a szenzitivitási címke hozzárendelési módszerét. Írd [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | Beállítja a szenzitivitási címke azonosítóját. Írd [System::String](../../system/string/). |
| void [set_IsEnabled](./set_isenabled/)(**bool**) override | Jelzi, hogy a szenzitivitási címke engedélyezve van-e. |
| void [set_IsRemoved](./set_isremoved/)(**bool**) override | Jelzi, hogy a szenzitivitási címke el lett-e távolítva. |
| void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) override | Beállítja a szenzitivitási címkét leíró Azure Active Directory (Azure AD) webhelyazonosítót. Írd [System::Guid](../../system/guid/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóval (nem megosztottal) állítja be. Lehetővé teszi a mutatók konténerekben történő gyenge módra váltását. |
