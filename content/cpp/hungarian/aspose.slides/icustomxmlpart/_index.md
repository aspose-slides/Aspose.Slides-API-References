...
description: Egyéni XML részt képvisel.
type: docs
weight: 1925
url: /hu/aspose.slides/icustomxmlpart/
---
## ICustomXmlPart osztály
...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Megad egy globálisan egyedi azonosítót (GUID), amely egyedi módon egyetlen saját XML részt azonosít egy Office Open XML dokumentumban. Csak olvasásra [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | Visszaadja a gyűjtemény XML séma fájlokat, amelyek a saját XML részhez tartoznak. Csak olvasásra [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | Visszaadja az XML adatot UTF-8 karakterláncként. Olvasás [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | Visszaadja az XML adatot. Olvasás **uint8_t**[]. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában semmit nem másol, csak új objektumot inicializál és engedélyezi az alosztályok másolat alapú konstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában semmit nem másol, csak új objektumot inicializál és engedélyezi az alosztályok másolat alapú konstrukcióját. |
...
| virtual void [Remove](./remove/)() | Eltávolítja a saját XML részt a prezentációból. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Megad egy globálisan egyedi azonosítót (GUID), amely egyedi módon egyetlen saját XML részt azonosít egy Office Open XML dokumentumban. Csak olvasásra [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | Beállítja az XML adatot UTF-8 karakterláncként. Írás [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Beállítja az XML adatot. Írás **uint8_t**[]. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerben való gyenge módra váltását. |
