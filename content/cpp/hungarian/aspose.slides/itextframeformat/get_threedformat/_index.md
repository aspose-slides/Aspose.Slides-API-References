...
description: Visszaadja a ThreeDFormat objektumot, amely a szöveg 3d hatás tulajdonságait képviseli. Csak olvasható IThreeDFormat.
type: docs
weight: 300
url: /hu/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() metódus

Visszaadja a [ThreeDFormat](../../threedformat/) objektum, amely 3d hatás tulajdonságait képviseli egy szöveghez. Csak olvasható [IThreeDFormat](../../ithreedformat/).
