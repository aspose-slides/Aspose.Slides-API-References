...
description: Egy színátmenet formátumot képvisel.
type: docs
weight: 1119
...
Egy színátmenet formátumot képvisel.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Visszaadja a színátmenet állomás színét. Csak olvasható [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Visszaadja a színátmenet állomás pozícióját (0..1). Olvassa **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Beállítja a színátmenet állomás pozícióját (0..1). Írja **float**. |
...
* Osztály [IGradientStop](../igradientstop/)
