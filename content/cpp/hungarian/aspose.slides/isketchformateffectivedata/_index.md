...
description: Megváltoztathatatlan objektum, amely hatékony vonalvázlat tulajdonságokat tartalmaz.
type: docs
weight: 3745
url: /hu/aspose.slides/isketchformateffectivedata/
---
## ISketchFormatEffectiveData osztály
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Visszaadja a vázlat típusát. Csak olvasható [Slides::LineSketchType](../linesketchtype/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia-összehasonlítja az érték típusú objektumot a nullptr-vel. |
