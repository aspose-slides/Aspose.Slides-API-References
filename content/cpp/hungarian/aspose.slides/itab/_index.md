...
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Objektumokat hasonlít össze C# [Object.Equals](../../system/object/equals/) szemtan szerint. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Visszaadja a tabulátor igazítási stílusát. Olvassa [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Visszaadja egy tabulátor pozícióját. Ennek a tulajdonságnak a beállítása megváltoztathatja a tabulátor indexét a gyűjteményben, és érvénytelenítheti a felsorolót. Olvassa **double**. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában nem másol semmit, csak egy új objektumot inicializál és lehetővé teszi az alosztályok másolásos létrehozását. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Beállítja egy tabulátor igazítási stílusát. Írja [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Beállítja egy tabulátor pozícióját. Ennek a tulajdonságnak a beállítása megváltoztathatja a tabulátor indexét a gyűjteményben, és érvénytelenítheti a felsorolót. Írja **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként állítja be (nem megosztott). Lehetővé teszi a mutatók konténerekben gyenge módra váltását. |
