...
description: Egy kommentár-szerzők gyűjteményét képviseli.
type: docs
weight: 443
...
A kommentár-szerzők gyűjteményét képviseli.
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [AddAuthor](./addauthor/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Új szerzőt ad a gyűjtemény végéhez. |
...
| void [Clear](./clear/)() override | Eltávolítja az összes szerzőt a gyűjteményből. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\>, **int32_t**) override | Az összes elemet átmásolja a gyűjteményből a megadott tömbbe. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByName](./findbyname/)([System::String](../../system/string/)) override | Megkeresi a szerzőt a gyűjteményben név alapján. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByNameAndInitials](./findbynameandinitials/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Megkeresi a szerzőt a gyűjteményben név és kezdőbetűk alapján. |
| **int32_t** [get_Count](./get_count/)() override | Visszaadja a gyűjteményben ténylegesen található elemek számát. Csak olvasható **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végigiterál a gyűjteményen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [idx_get](./idx_get/)(**int32_t**) override | Visszaadja a megadott indexű elemet. Csak olvasható [ICommentAuthor](../icommentauthor/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Visszaadja a sorozat első, a feltételt teljesítő elemét, vagy egy alapértelmezett értéket, ha ilyen elem nem található. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>) override | Eltávolítja a megadott szerző első előfordulását a gyűjteményből. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Eltávolítja a megadott indexű szerzőt a gyűjteményből. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referencia számlálót a megadott értékkel. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | A n-edik sablonargumentumot gyenge mutatóra (nem megosztottra) állítja. Lehetővé teszi a konténerekben a mutatók gyenge módba váltását. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [ToArray](./toarray/)() override | Létrehoz és visszaad egy tömböt az összes szerzővel. |
...
| Typedef | Leírás |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Egy gyűjteménytípus, amelynek iterátor típusait a jelenlegi gyűjtemény iterátorként használja. |
...
* Osztály [ICommentAuthorCollection](../icommentauthorcollection/)
