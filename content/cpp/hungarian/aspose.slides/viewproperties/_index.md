...
description: A prezentációra kiterjedő nézet tulajdonságai.
type: docs
weight: 5565
...
| **float** [get_GridSpacing](./get_gridspacing/)() override | Visszaadja a rács szórását, amelyet a prezentációs dokumentum alatti rácshoz pontban kell használni. Olvasható **float**. |
| [ViewType](../viewtype/) [get_LastView](./get_lastview/)() override | Megadja a nézetmódot, amelyet a prezentációs dokumentum legutóbb mentésekor használtak. Olvasás [ViewType](../viewtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[INormalViewProperties](../inormalviewproperties/)\> [get_NormalViewProperties](./get_normalviewproperties/)() override | Normál nézet tulajdonságait képviseli. A normál nézet három tartalmi régióból áll: a diából, egy oldalsó tartalmi régióból és egy alsó tartalmi régióból. Írásvédett [INormalViewProperties](../inormalviewproperties/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_NotesViewProperties](./get_notesviewproperties/)() override | Megadja a jegyzetek nézetmódhoz kapcsolódó közös nézet tulajdonságokat. Írásvédett [ICommonSlideViewProperties](../icommonslideviewproperties/). |
| [NullableBool](../nullablebool/) [get_ShowComments](./get_showcomments/)() override | Megadja, hogy a dia megjegyzései megjelenjenek-e. Olvasás [NullableBool](../nullablebool/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_SlideViewProperties](./get_slideviewproperties/)() override | Megadja a dia nézetmódhoz kapcsolódó közös nézet tulajdonságokat. Írásvédett [ICommonSlideViewProperties](../icommonslideviewproperties/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot nullptr-tal referencia alapú összehasonlít. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja string és nullptr esetére. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja stringek esetére. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referencia számlálót a megadott értékkel. |
| void [set_GridSpacing](./set_gridspacing/)(**float**) override | Beállítja a rács szórását, amelyet a prezentációs dokumentum alatti rácshoz pontban kell használni. Írás **float**. |
| void [set_LastView](./set_lastview/)([ViewType](../viewtype/)) override | Megadja a nézetmódot, amelyet a prezentációs dokumentum legutóbb mentésekor használtak. Írás [ViewType](../viewtype/). |
| void [set_ShowComments](./set_showcomments/)([NullableBool](../nullablebool/)) override | Megadja, hogy a dia megjegyzései megjelenjenek-e. Írás [NullableBool](../nullablebool/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablon argumentumot gyenge mutatóvá (nem megosztottá) állítja. Lehetővé teszi a mutatók konténerben való gyenge módra váltását. |
...
* Osztály [IViewProperties](../iviewproperties/)
