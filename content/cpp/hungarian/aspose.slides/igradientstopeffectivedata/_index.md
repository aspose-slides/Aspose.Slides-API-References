...
description: változatlan objektum, amely egy színátmenet állomást képvisel.
type: docs
weight: 2445
url: /hu/aspose.slides/igradientstopeffectivedata/
---
## IGradientStopEffectiveData osztály

változatlan objektum, amely egy színátmenet állomást képvisel.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Visszaadja a színátmenet állomás színét. Csak olvasható [System::Drawing::Color](../../system.drawing/color/). |
| virtual **float** [get_Position](./get_position/)() | Visszaadja a színátmenet állomás pozícióját (0..1). Csak olvasható **float**. |
