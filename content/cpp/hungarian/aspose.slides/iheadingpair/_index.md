...
description: A dokumentum 'Heading pair' tulajdonságát reprezentálja. A dokumentum részeinek csoportnevét és a csoportban lévő részek számát jelzi.
type: docs
weight: 2510
url: /hu/aspose.slides/iheadingpair/
---
## IHeadingPair osztály


A dokumentum 'Heading pair' tulajdonságát reprezentálja. A dokumentum részeinek csoportnevére és a csoportban lévő részek számára hivatkozik.
...
| virtual **int32_t** [get_Count](./get_count/)() | Visszaadja a csoportban lévő részek számát. Csak olvasható **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Visszaadja a dokumentum részek csoportneve. Csak olvasható [System::String](../../system/string/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonparamétert gyenge mutatóval állítja be (a megosztott helyett). Lehetővé teszi a mutatók konténerben gyenge módra való átkapcsolását. |
