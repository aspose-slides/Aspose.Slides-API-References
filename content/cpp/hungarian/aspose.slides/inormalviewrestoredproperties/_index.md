...
description: Meghatározza a diavetítési régió méretét ((szélesség, ha a restoredTop gyermek, magasság, ha a restoredLeft gyermek) a normál nézetben, amikor a régió változó visszaállított méretű (sem minimalizált, sem maximalizált).
type: docs
weight: 2991
url: /hu/aspose.slides/inormalviewrestoredproperties/
---
## INormalViewRestoredProperties osztály

Meghatározza a diavetítési régió méretét ((szélesség, ha a restoredTop gyermek, magasság, ha a restoredLeft gyermek) a normál nézetben, amikor a régió változó visszaállított méretű (sem minimalizált, sem maximalizált).
...
| virtual **bool** [get_AutoAdjust](./get_autoadjust/)() | Megadja, hogy az oldal tartalom régió méretének kompenzálnia kell-e az új méretet az alkalmazáson belül a nézetet tartalmazó ablak átméretezésekor. Olvasható **bool**. |
| virtual **float** [get_DimensionSize](./get_dimensionsize/)() | Megadja a diavetítési régió méretét (szélesség, ha a RestoredTop gyermek, magasság, ha a RestoredLeft gyermek). Olvasható **float**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum az adott targetType által leírt típust reprezentál-e. A C# 'is' operátor analógja. |
...
| virtual void [set_AutoAdjust](./set_autoadjust/)(**bool**) | Megadja, hogy az oldal tartalom régió méretének kompenzálnia kell-e az új méretet az alkalmazáson belül a nézetet tartalmazó ablak átméretezésekor. Írható **bool**. |
| virtual void [set_DimensionSize](./set_dimensionsize/)(**float**) | Megadja a diavetítési régió méretét (szélesség, ha a RestoredTop gyermek, magasság, ha a RestoredLeft gyermek). Írható **float**. |
