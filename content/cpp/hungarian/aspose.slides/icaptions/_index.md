...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Visszaadja a zárt feliratok bináris adatait. Csak olvasható **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | Visszaadja a zárt feliratok globálisan egyedi azonosítóját (GUID). Csak olvasható [System::Guid](../../system/guid/). |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | Visszaadja a zárt feliratok adatait UTF-8 kódolású stringként. Csak olvasható [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | Visszaadja a zárt feliratok címkéjét. Olvasható [System::String](../../system/string/). |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | Beállítja a zárt feliratok címkéjét. Írás [System::String](../../system/string/). |
