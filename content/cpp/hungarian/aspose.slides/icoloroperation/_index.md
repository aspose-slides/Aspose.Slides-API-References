...
description: Különböző színműveleteket ábrázol, amelyeket színátalakításokhoz használnak.
type: docs
weight: 1704
url: /hu/aspose.slides/icoloroperation/
---
## IColorOperation osztály
...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | Visszaadja egy művelet típusát. Csak olvasható [ColorTransformOperation](../colortransformoperation/). |
| virtual **float** [get_Parameter](./get_parameter/)() | Visszaad egy paramétert a műveletből. Csak olvasható **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekéri az objektumhoz tartozó referencia számláló adatszerkezetet. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók átváltását a konténerekben gyenge módra. |
