...
description: Visszahívási interfész a keresési szövegeredmény lekéréséhez használt.
type: docs
weight: 2146
url: /hu/aspose.slides/ifindresultcallback/
---
## IFindResultCallback osztály
...
| virtual void [FoundResult](./foundresult/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\>, [System::String](../../system/string/), [System::String](../../system/string/), **int32_t**) | Visszahívási metódus, amely a megtalált szövegre vonatkozó adatokat kapja. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában semmit sem másol, csak új objektumot inicializál és lehetővé teszi az alosztályok másolós konstrukcióját. |
