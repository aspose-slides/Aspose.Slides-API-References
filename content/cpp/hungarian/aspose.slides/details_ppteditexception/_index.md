...
description: Kivétel, amelyet akkor dobnak, amikor a prezentáció szerkesztése során hibát észlelnek.
type: docs
weight: 664
url: /hu/aspose.slides/details_ppteditexception/
---
## Details_PptEditException osztály


Ábrázolja azt a kivételt, amely akkor kerül dobásra, amikor a prezentáció szerkesztési hibát észlelnek.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktort. Valójában semmit sem másol, csak új objektumot inicializál és lehetővé teszi a leszármazottak másolókonstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában semmit sem másol, csak új objektumot inicializál és lehetővé teszi a leszármazottak másolókonstrukcióját. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Megvalósítja a [what()](../../system/details_exception/what/) metódust, amelyet a [ExceptionWrapper](../../system/exceptionwrapper/) osztály hív. Annak ellenére, hogy ez az osztály nem örököl a std::exception-ből, a származtatott osztályok védett/privát tagokat használhatnak a logika megvalósításához. Ennek a metódusnak a [ExceptionWrapper](../../system/exceptionwrapper/)-ba való áthelyezése megzavarhatja a logikát. |
