...
description: Információ a prezentációs fájlról
type: docs
weight: 3420
...
Információ a prezentációs fájlról
...
| Method | Description |
| --- | --- |
| virtual **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) | Ellenőrzi, hogy a jelszó helyes-e egy nyitó jelszóval védett prezentáció esetén. |
| virtual **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) | Ellenőrzi, hogy a módosítási jelszó helyes-e egy írásvédett prezentáció esetén. |
...
| virtual **bool** [get_IsEncrypted](./get_isencrypted/)() | True-t ad vissza, ha a csatolt prezentáció titkosított, egyébként False. Csak olvasható **bool**. |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Értéket ad vissza, amely jelzi, hogy a csatolt prezentáció nyitáshoz jelszóval védett-e. |
| virtual [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() | Értéket ad vissza, amely jelzi, hogy a csatolt prezentáció írásvédett-e. |
| virtual [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() | A csatolt prezentáció formátumát adja vissza. Csak olvasható [Slides::LoadFormat](../loadformat/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktőr. Valójában semmit nem másol, csak új objektumot inicializál és engedélyezi az alosztályok másolókonstrukcióját. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() | A csatolt prezentáció dokumentum-tulajdonságait adja vissza. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Érték típusú objektumot nullptr-vel hasonlít referencia szerint. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja string és nullptr esetére. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | A [Object::ReferenceEquals](../../system/object/referenceequals/) specializációja stringek esetére. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referencia számlálót a megadott értékkel. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-dik sablonargumentumot gyenge mutatóvá állítja (a shared helyett). Lehetővé teszi a konténerekben lévő mutatók gyenge módra való átkapcsolását. |
...
| virtual void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) | Frissíti a csatolt prezentáció tulajdonságait. |
...
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | A csatolt prezentációt stream-be írja. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) | A csatolt prezentációt fájlba írja. |
