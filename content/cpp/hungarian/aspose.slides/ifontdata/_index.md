...
description: Betűkészlet-definíciót képvisel.
type: docs
weight: 2159
...
Betűkészlet-definíciót képvisel.
...
| virtual [System::String](../../system/string/) [get_FontName](./get_fontname/)() | Visszaadja a betűkészlet nevét. Csak olvasható [System::String](../../system/string/). |
...
| virtual [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) | Visszaadja a betűkészlet nevét, a téma hivatkozást egy ténylegesen használt betűkészlettel helyettesítve. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóvá (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását gyenge módra a tárolókban. |
