...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) típus Olvas [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 deg, field of View) Olvas **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (positive value in percentage) Olvas **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Az objektumhoz kapcsolódó referenciacsámláló adatstruktúrát ad vissza. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | A forgást egy szélességi koordináta, egy hosszúsági koordináta és az axiális forgás definiálja, ahol a szélességi és hosszúsági koordinátákra vonatkozik. Az visszatérő tömb első eleme – szélesség, a második – hosszúság, a harmadik – revolúció. Ha nincs definiált forgás, null értéket ad vissza. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Nem másol semmit, csak új objektumot inicializál, és lehetővé teszi az alosztályok másoló konstrukcióját. |
...
| virtual void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) | [Camera](../camera/) típus Írás [CameraPresetType](../camerapresettype/). |
| virtual void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) | [Camera](../camera/) FOV (0-180 deg, field of View) Írás **float**. |
| virtual void [set_Zoom](./set_zoom/)(**float**) | [Camera](../camera/) zoom (positive value in percentage) Írás **float**. |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | A forgást egy szélességi koordináta, egy hosszúsági koordináta és az axiális forgás definiálja, amely a szélességi és hosszúsági koordinátákat használja. Ha bármely koordináta értéke std::numeric_limits<float>::quiet_NaN(), a forgás nincs definiálva. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztott). Lehetővé teszi a mutatók konténerben való gyenge módba váltását. |
