...
description: Beállítja az oszlopok számát a szövegterületen. Ennek az értéknek pozitív számnak kell lennie. Ellenkező esetben az érték nulla lesz. A 0 érték meghatározatlan értéket jelent. Írja int32_t.
type: docs
weight: 261
url: /hu/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) metódus


Beállítja az oszlopok számát a szövegterületen. Ennek az értéknek pozitív számnak kell lennie. Ellenkező esetben az érték nulla lesz. A 0 érték meghatározatlan értéket jelent. Írja **int32_t**.
...
Az alábbi példakód bemutatja, hogyan adhatunk oszlopot a PowerPoint [Presentation](../../presentation/)-ban lévő szövegkerethez. 
```cpp
