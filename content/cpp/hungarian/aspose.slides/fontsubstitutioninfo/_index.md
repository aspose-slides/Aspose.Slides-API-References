...
description: Ez a szerkezet a betűtípuscsere információit képviseli, amikor megjelenik.
type: docs
weight: 1015
...
Ez a szerkezet a betűtípuscsere információit képviseli, amikor megjelenik.
...
|  [FontSubstitutionInfo](./fontsubstitutioninfo/)([System::String](../../system/string/), [System::String](../../system/string/)) | Létrehoz egy példányt a [FontSubstitutionInfo](./) osztályból. |
| [System::String](../../system/string/) [get_OriginalFontName](./get_originalfontname/)() | A prezentációban a forrás betűtípus nevét jelzi. Csak-olvasás [System::String](../../system/string/) |
| [System::String](../../system/string/) [get_SubstitutedFontName](./get_substitutedfontname/)() | A helyettesítő betűtípus nevét jelzi az eredeti betűtípushoz. Csak-olvasás [System::String](../../system/string/) |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia-hasonlítja az érték-típusú objektumot a nullptr-tal. |
