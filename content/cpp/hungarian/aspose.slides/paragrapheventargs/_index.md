...
description: Esemény argumentumok osztálya bekezdéshez kapcsolódó eseményekhez.
type: docs
weight: 4642
url: /hu/aspose.slides/paragrapheventargs/
---
## ParagraphEventArgs osztály

Bekezdéshez kapcsolódó események argumentum osztálya.
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum példány-e a targetType által leírt típusról. A C# 'is' operátor analógiája. |
...
| Mező | Leírás |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Egy statikus tag, amely egy "üres" [EventArgs](../../system/eventargs/) megosztott mutatót (null-pointer) jelképez. |
