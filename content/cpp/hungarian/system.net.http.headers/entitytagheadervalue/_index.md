...
description: "A 'Entity-Tag' fejléc egy értékét reprezentálja. Ennek az osztálynak az objektumait csak a System::MakeObject() függvény használatával szabad allokálni. Soha ne hozzon létre példányt ebből a típusból a stack-en vagy a new operátorral, mivel futási időbeli hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót az objektum függvényeknek argumentumként történő átadásához."
type: docs
weight: 53
url: /hu/system.net.http.headers/entitytagheadervalue/
---
## EntityTagHeaderValue osztály

Az 'Entity-Tag' fejléc egy értékét reprezentálja. Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvénnyel kell allokálni. Soha ne hozzon létre példányt ebből a típusból a stack-en vagy a new operátorral, mivel futási időbeli hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az argumentumként való átadásra a függvényeknek.
...
| Method | Description |
| --- | --- |
|  [EntityTagHeaderValue](./entitytagheadervalue/)([String](../../system/string/)) | Új példányt hoz létre. |
|  [EntityTagHeaderValue](./entitytagheadervalue/)([String](../../system/string/), **bool**) | Új példányt hoz létre. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\> [get_Any](./get_any/)() | Az 'ETag' fejléc értékét adja vissza. |
| **bool** [get_IsWeak](./get_isweak/)() | Egy értéket ad vissza, amely jelzi, hogy a jelenlegi példány gyenge érvényesítő-e. |
| [String](../../system/string/) [get_Tag](./get_tag/)() | Az EntityTagHeaderValue osztály egy példányának karakterlánc ábrázolását adja vissza. |
...
| static **int32_t** [GetEntityTagLength](./getentitytaglength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\>\&) | A megadott indexnél lévő stringet átalakítja a [EntityTagHeaderValue](./) osztály egy példányává. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Átalakít egy stringet a [EntityTagHeaderValue](./) osztály egy példányává. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n'th sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átváltását konténerekben gyenge módra. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\>\&) | Megpróbálja a megadott stringet a [EntityTagHeaderValue](./) osztály egy példányává konvertálni. |
