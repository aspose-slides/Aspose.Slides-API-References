...
description: "Enumerátor definíció STL-stílusú típusok C#-stílusú használatához. Nem tesz semmilyen feltételezést a tároló szerkezetéről, kivéve a szekvenciális iterátor létezését. A begin() és end() függvényeket használja. Ennek az osztálynak az objektumait csak a System::MakeObject() függvénnyel szabad lefoglalni. Soha ne hozzon létre példányt a típusból a stack-en vagy az operator new használatával, mert ez futásidejű hibákat és/vagy állítási hibákat okozhat. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót az argumentumként való átadásra a függvényekhez."
type: docs
weight: 66
url: /hu/system.collections.generic/baseenumerator/
---
## BaseEnumerator osztály
...
| Paraméter | Leírás |
| --- | --- |
| Container | STL-stílusú tárolótípus. |
| Element | Elem típus. |
## Módszerek

| Módszer | Leírás |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | Felkészíti az iterátort a VirtualizedIterator osztály általi használatra. |
|  [BaseEnumerator](./baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Inicializálja az iterátort. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](../ienumerator/cloneiterator/)() const override | Klónozza a jelenlegi iterátort. |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../ienumerator/current/)() const | Visszaadja a jelenlegi elemet. |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](../ienumerator/get_current/)() const | Visszaadja a jelenlegi elemet. |
...
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | Lépést előre tesz az iterátorban. |
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | Elvégzi az első [MoveNext()](../ienumerator/movenext/) hívást és felkészíti az enumerátor objektumot a VirtualizedIterator általi használatra. |
...
| **bool** [IsValid](./isvalid/)() const | Ellenőrzi, hogy a [MoveNext()](./movenext/) meghívásra került-e, és a vég még nem érkezett el. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadó operátor. Valójában semmit nem másol, csak egy új objektumot inicializál, és lehetővé teszi az alosztályok másolás-alapú konstrukcióját. |
...
| void [Reset](./reset/)() override | Újraindítja az enumerátort, hogy lehetővé tegye az elemek újraenumerálását. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett) állítja be. Lehetővé teszi a konténerekben lévő mutatók gyenge módra váltását. |
