...
description: Alap osztályt biztosít a System.Collections.Generic.IComparer generikus interfész implementációi számára.
type: docs
weight: 105
url: /hu/system.collections.generic/comparer/
---
## Comparer osztály

Alap osztályt biztosít a [System.Collections.Generic.IComparer](../icomparer/) generikus interfész implementációi számára.
...
| Metódus | Leírás |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) függvény. |
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# stílusú referencia típusú objektumokat hasonlít össze. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# stílusú értéktípusú objektumokat hasonlít össze. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Alapértelmezett rendezési sorrend összehasonlítót ad vissza a generikus argumentummal megadott típushoz. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Valójában semmit sem másol, csak új objektumot inicializál és engedélyezi az alosztályok másolókonstruktorát. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Valójában semmit sem másol, csak új objektumot inicializál és engedélyezi az alosztályok másolókonstruktorát. |
...
| Typedef | Leírás |
| --- | --- |
| [BaseType](./basetype/) | Megvalósított interfész. |
| [ThisType](./thistype/) | Aktuális típus. |
