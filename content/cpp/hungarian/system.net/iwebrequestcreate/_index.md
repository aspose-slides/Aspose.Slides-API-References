...
description: "Biztosítja a WebRequest osztálypéldányok létrehozásához szükséges metódusokat. Ennek az osztálynak az objektumait csak a System::MakeObject() függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ezen típusból a stack-en vagy a new operátorral, mivel ez futási időbeli hibákat és/vagy aszertálási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót az argumentumként történő függvényhíváshoz."
type: docs
weight: 378
url: /hu/system.net/iwebrequestcreate/
---
## IWebRequestCreate osztály

Biztosítja a [WebRequest](../webrequest/) osztály példányainak létrehozásához szükséges módszereket. Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányt ezen típusból a stacken vagy a new operátorral, mivel ez futási időbeli hibákat és/vagy aszertálási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az argumentumként történő függvényhíváshoz.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[WebRequest](../webrequest/)\> [Create](./create/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Létrehozza a WebRequest-osztály egy példányát a megadott erőforrás URI-jához. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók konténerekben történő weak módra váltását. |
