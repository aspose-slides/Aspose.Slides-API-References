...
description: "Átmeneti osztály, amely lehetővé teszi a lefordított kód összekapcsolását a FtpWebResponse hivatkozásokkal, de nem hajtja végre azt. Nem tartalmaz megfelelően megvalósított tagokat. Ennek az osztálynak a példányait csak a System::MakeObject() függvény használatával szabad lefoglalni. Soha ne hozza létre ennek a típusnak a példányt a stacken vagy az operator new segítségével, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót a függvények argumentumaként történő átadásra."
type: docs
weight: 183
url: /hu/system.net/ftpwebresponse/
---
## FtpWebResponse osztály

Átmeneti osztály, amely lehetővé teszi a lefordított kód összekapcsolását a [FtpWebResponse](./) hivatkozásokkal, de nem hajtja végre. Nem tartalmaz megfelelően megvalósított tagokat. Ennek az osztálynak a példányait csak a [System::MakeObject()](../../system/makeobject/) függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stacken vagy az operator new használatával, mivel futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az argumentumként való átadásra a függvényeknek.
...
| Metódus | Leírás |
| --- | --- |
| void [Close](./close/)() override | Nincs megvalósítva. |
...
| **int64_t** [get_ContentLength](./get_contentlength/)() override | RTTI információ. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Nincs megvalósítva. |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | Nincs megvalósítva. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | Nincs megvalósítva. |
| virtual **bool** [get_SupportsHeaders](../webresponse/get_supportsheaders/)() | Visszaad egy értéket, amely jelzi, hogy az aktuális válasz támogatja-e a fejléceket. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() override | Nincs megvalósítva. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átváltását kontejnerben gyenge módra. |
