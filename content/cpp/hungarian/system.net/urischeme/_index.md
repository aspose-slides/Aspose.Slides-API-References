...
description: "Ábrázolja az URI sémát. Az osztály objektumait csak a System::MakeObject() függvénnyel szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stack-en vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót az argumentumként való függvényhíváshoz."
type: docs
weight: 456
url: /hu/system.net/urischeme/
---
## UriScheme osztály
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n. sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben történő gyenge módra váltását. |
...
| Mező | Leírás |
| --- | --- |
| static [Http](./http/) | A HTTP karakterlánc ábrázolás. |
| static [Https](./https/) | A HTTPS karakterlánc ábrázolás. |
| static [SchemeDelimiter](./schemedelimiter/) | A séma elválasztót ábrázoló karakterlánc. |
| static [Ws](./ws/) | A WS karakterlánc ábrázolás. |
| static [Wss](./wss/) | A WSS karakterlánc ábrázolás. |
