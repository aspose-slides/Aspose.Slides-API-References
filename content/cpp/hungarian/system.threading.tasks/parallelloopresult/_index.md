...
description: Biztosítja a párhuzamos ciklus befejezési állapotát.
type: docs
weight: 14
url: /hu/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult osztály


Biztosítja egy [Parallel](../parallel/) ciklus befejezési állapotát.
...
| Metódus | Leírás |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Az objektumok összehasonlítása C# [Object.Equals](../../system/object/equals/) szemantika szerint. |
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Lekérdezi, hogy a ciklus befejeződött-e. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Lekérdezi a legalacsonyabb iterációs indexet, ahol megszakítás történt. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Létrehozza a [ParallelLoopResult](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóra (nem megosztottra) állítja. Lehetővé teszi a mutatók konténerekben történő gyenge módba történő átváltását. |
...
A párhuzamos ciklus művelet eredményét képviseli, beleértve, hogy befejeződött-e, valamint a megszakításokkal kapcsolatos információkat. 
