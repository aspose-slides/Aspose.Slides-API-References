...
description: Segít biztosítani egy másik XmlResolver megvalósítását az XmlResolver objektum becsomagolásával, és korlátozza az alapul szolgáló XmlResolver által elérhető erőforrásokat.
type: docs
weight: 469
url: /hu/system.xml/xmlsecureresolver/
---
## XmlSecureResolver osztály


Segít biztosítani a(z) [XmlResolver](../xmlresolver/) másik megvalósítását az [XmlResolver](../xmlresolver/) objektum becsomagolásával, és korlátozza a rendelkezésre álló erőforrásokat, amelyekhez az alapul szolgáló [XmlResolver](../xmlresolver/) hozzáfér.
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) override | Egy URI-t leképez egy objektumra, amely a tényleges erőforrást tartalmazza. |
...
| [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | Megoldja az abszolút URI-t az alap és a relatív URI-kból, a **ResolveUri** hívásával az alapul szolgáló [XmlResolver](../xmlresolver/) objektumon. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-ik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását a konténerekben gyenge módra. |
...
| virtual **bool** [SupportsType](../xmlresolver/supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Lehetővé teszi a resolver számára, hogy a Stream-en kívül más típusokat is visszaadjon. |
...
|  [XmlSecureResolver](./xmlsecureresolver/)(const [SharedPtr](../../system/sharedptr/)\<[XmlResolver](../xmlresolver/)\>\&, const [String](../../system/string/)\&) | Inicializál egy új példányt a [XmlSecureResolver](./) osztályból a megadott [XmlResolver](../xmlresolver/) és URL alapján. |
...
Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény használatával szabad lefoglalni. Soha ne hozzon létre példányokat ezen típusból a veremben vagy az operator new használatával, mert az futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az argumentumként való átadásra a függvényeknek. 
