...
description: Visszaadja a közvetlenül ezt a csomópontot megelőző vagy követő csomópontot.
type: docs
weight: 274
url: /hu/system.xml/xmllinkednode/
---
## XmlLinkedNode osztály

Visszaadja a közvetlenül ezen csomópont előtt vagy után álló csomópontot.
...
| Metódus | Leírás |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Hozzáadja a megadott csomópontot a gyermek csomópontok listájának végéhez ebben a csomópontban. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Visszaad egy iterátort, amely az összegyűjtés első (ha van) elemére mutat. Ez az iterátor nem használható egy hivatkozott objektum módosítására, mert a [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) egy T típusú másolat-objektumot ad vissza. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Visszaad egy iterátort, amely a const minősített példányban (ha van) az összegyűjtés első elemére mutat. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Visszaad egy iterátort, amely a const minősített első elemére (ha van) mutat az összegyűjtésben. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Visszaad egy iterátort, amely a const minősített utolsó elem utánra (ha van) mutat az összegyűjtésben. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Létrehoz egy példányt ebből a csomópontból. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Létrehoz egy példányt a csomópontról, amikor egy származtatott osztályban felül van írva. |
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | Létrehoz egy XPathNavigator objektumot ennek az objektumnak a bejárásához. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Visszaad egy iterátort, amely az összegyűjtés utolsó (ha van) elemét követően mutat. Ez az iterátor nem használható a hivatkozott objektum módosítására, mivel a [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) egy T típusú másolat-objektumot ad vissza. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Visszaad egy iterátort, amely a const minősített példányban az összegyűjtés utolsó (ha van) elemét követően mutat. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Objektumokat összehasonlít a C# [Object.Equals](../../system/object/equals/) szemantika használatával. |
...
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Visszaad a csomópont helyi nevét, ha egy származtatott osztályban felül van írva. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Visszaad a csomópont minősített nevét, ha egy származtatott osztályban felül van írva. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Visszaad az aktuális csomópont típusát, ha egy származtatott osztályban felül van írva. |
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Visszaad a jelölést, amely ezt a csomópontot és annak összes gyermekcsomópontját tartalmazza. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Visszaad a szövegcsomópontot, amely közvetlenül ezt a csomópontot megelőzi. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Visszaad a sémaellenőrzés után a csomópontra rendelt információkészletet, amely a sémaellenőrzés eredményeként jött létre. |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | Visszaad a csomópont értékét. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Lekérdezi a tárgyhoz kapcsolódó referenciaszámláló adatstruktúrát. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Megkeresi a legközelebbi **xmlns** deklarációt a megadott előtaghoz, amely az aktuális csomópont hatókörében van, és visszaadja a deklarációban szereplő névtér URI-ját. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Megállapítja, hogy a sorozat bármelyik eleme létezik-e vagy megfelel-e egy feltételnek. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy olyan sorozat értékek átlagát, amelyeket a bemeneti sorozat minden elemére alkalmazott átalakító függvény eredményez. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Meghívja az átalakító függvényt a generikus sorozat minden elemére, és visszaadja a legnagyobb eredményértéket. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Meghívja az átalakító függvényt a generikus sorozat minden elemére, és visszaadja a legkisebb eredményértéket. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Az összes [XmlText](../xmltext/) csomópontot a [XmlNode](../xmlnode/) alatti részfa teljes mélységében egy "normál" formába helyezi, ahol csak a jelölés (azaz címkék, megjegyzések, feldolgozási utasítások, CDATA szakaszok és entitás hivatkozások) választja el a [XmlText](../xmltext/) csomópontokat, azaz nincsenek szomszédos [XmlText](../xmltext/) csomópontok. |
|  [Object](../../system/object/object/)() | Létrehozza az objektumot. Inicializálja az összes belső adatstruktúrát. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másolókonstruktor. Valójában nem másol semmit, csak inicializálja az új objektumot, és lehetővé teszi az alosztályok másolókonstrukcióját. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Hozzárendelési operátor. Valójában nem másol semmit, csak inicializálja az új objektumot, és lehetővé teszi az alosztályok másolókonstrukcióját. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Hozzáadja a megadott csomópontot a gyermekcsomópontok listájának elejéhez ebben a csomópontban. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Objektumokat referenciával hasonlít össze. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Objektumokat referenciával hasonlít össze. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektum referenciás összehasonlítása nullptr-tal. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Beállítja a csomópont és összes gyermekcsomópontja összefűzött értékeit. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonparamétert gyenge mutatóra állítja (a megosztott helyett). Lehetővé teszi a mutatók konténerben való weak módra való átváltását. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | A C# [Object.ToString()](../../system/object/tostring/) metódus analógja. Engedélyezi a saját objektumok karakterlánccá konvertálását. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Lekérdezi a begin const iterátor implementációját az aktuális tárolóhoz. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Lekérdezi a begin iterátor implementációját az aktuális tárolóhoz. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Lekérdezi az end const iterátor implementációját az aktuális tárolóhoz. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Lekérdezi az end iterátor implementációját az aktuális tárolóhoz. |
...
| --- | --- |
| [Ptr](./ptr/) | Az adott osztály egy példányára mutató megosztott pointer aliása. |
