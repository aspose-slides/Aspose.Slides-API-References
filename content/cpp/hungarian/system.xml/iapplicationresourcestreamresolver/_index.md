...
description: Alkalmazás erőforrás adatfolyam feloldóját reprezentálja.
type: docs
weight: 14
url: /hu/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver osztály

Az alkalmazás erőforrás adatfolyam feloldóját reprezentálja.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Visszaad egy alkalmazás erőforrás adatfolyamot a megadott URI-ból. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referencia szerint hasonlít össze értéktípusú objektumot a nullptr-tel. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben történő gyenge módba váltását. |
