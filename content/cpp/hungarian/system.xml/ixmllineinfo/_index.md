...
description: Felületet biztosít egy osztály számára, amely sor- és pozícióinformációt ad vissza.
type: docs
weight: 40
url: /hu/system.xml/ixmllineinfo/
---
## IXmlLineInfo osztály

Felületet biztosít egy osztály számára, amely sor- és pozícióinformációt ad vissza.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Visszaadja a jelenlegi sor számát. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Visszaadja a jelenlegi sor pozícióját. |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | Visszaad egy értéket, amely jelzi, hogy az osztály képes-e sorinformációt visszaadni. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóvá (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módra való átváltását. |
