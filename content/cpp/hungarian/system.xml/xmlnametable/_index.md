...
description: Az atomizált karakterlánc objektumok táblája.
type: docs
weight: 313
url: /hu/system.xml/xmlnametable/
---
## XmlNameTable osztály


Az atomizált karakterlánc objektumok táblázata.
...
| Metódus | Leírás |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Amikor egy származtatott osztályban felül van definiálva, atomizálja a megadott karakterláncot, és hozzáadja a [XmlNameTable](./)-hez. |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | Amikor egy származtatott osztályban felül van definiálva, atomizálja a megadott karakterláncot, és hozzáadja a [XmlNameTable](./)-hez. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | A C#-stílusú lebegőpontos összehasonlítást utánzzák, ahol két NaN egyenlőnek tekinthető, annak ellenére, hogy az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | A C#-stílusú lebegőpontos összehasonlítást utánzzák, ahol két NaN egyenlőnek tekinthető, annak ellenére, hogy az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső célokra. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Amikor egy származtatott osztályban felül van definiálva, visszaadja az atomizált karakterláncot, amely ugyanazokat a karaktereket tartalmazza, mint a megadott karaktertartomány a megadott tömbben. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | Amikor egy származtatott osztályban felül van definiálva, visszaadja az atomizált karakterláncot, amely ugyanazt az értéket tartalmazza, mint a megadott karakterlánc. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge pointerre (nem megosztottra) állítja be. Lehetővé teszi a pointerek átváltását gyenge módra a tárolókban. |
