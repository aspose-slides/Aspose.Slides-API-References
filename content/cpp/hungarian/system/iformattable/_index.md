...
description: Definiál egy olyan metódust, amely a jelenlegi objektum értékét a megadott formátumkarakterlánc és formátumszolgáltató segítségével formázza.
type: docs
weight: 1002
url: /hu/system/iformattable/
---
## IFormattable osztály


Definiál egy olyan metódust, amely a jelenlegi objektum értékét formázza a megadott formátumkarakterlánc és formátumszolgáltató használatával.
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN egyik értékkel sem egyenlő, beleértve a NaN-t is. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | C#-stílusú lebegőpontos összehasonlítást emulál, ahol két NaN egyenlőnek tekinthető, még ha az IEC 60559:1989 szerint a NaN egyik értékkel sem egyenlő, beleértve a NaN-t is. |
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | Csak belső célokra. |
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | A objektummal társított referenciaszámláló adatstruktúrát adja vissza. |
...
| virtual **bool** [Is](../object/is/)(const [TypeInfo](../typeinfo/)\&) const | Ellenőrzi, hogy az objektum egy példány-e a cél típust leíró típusnak. A C# 'is' operátor analógja. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Másoló konstruktor. Valójában semmit nem másol, csak új objektumot inicializál és lehetővé teszi az alosztályok másolt konstruktorát. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Értékadási operátor. Valójában semmit nem másol, csak új objektumot inicializál és lehetővé teszi az alosztályok másolt konstruktorát. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Értéktípusú objektumot referencia alapján hasonlít össze a nullptr-tel. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (nem megosztottra). Lehetővé teszi a mutatók tárolókban való gyenge módra való átkapcsolását. |
...
| virtual [String](../string/) [ToString](../object/tostring/)() const | A C# [Object.ToString()](../object/tostring/) metódus analógja. Engedélyezi egyedi objektumok stringgé konvertálását. |
