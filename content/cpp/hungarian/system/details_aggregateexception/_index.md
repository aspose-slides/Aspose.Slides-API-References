...
description: Olyan kivételt képvisel, amely több belső kivételt tartalmaz.
type: docs
weight: 300
url: /hu/system/details_aggregateexception/
---
## Details_AggregateException osztály

Olyan kivételt képvisel, amely több belső kivételt tartalmaz.
...
Ez az osztály általában több, egyidejűleg előforduló kivétel csoportosítására szolgál, például párhuzamos feldolgozás vagy aszinkron feladat végrehajtási forgatókönyvek esetén. Lehetővé teszi a felhasználók számára, hogy megvizsgálják, laposítsák vagy szelektíven kezeljék a tartalmazott kivételeket.
