...
description: "Ennek az osztálynak az objektumait csak a System::MakeObject() függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a veremben vagy az operator new segítségével, mivel ez futásidejű hibákat és/vagy állítási hibákat okozhat. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót a függvények argumentumaként történő átadásához."
type: docs
weight: 14
url: /hu/system.componentmodel/backgroundworker/
---
## BackgroundWorker osztály


Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a veremben vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az objektum függvények argumentumaként történő átadásához.
...
| Metódus | Leírás |
| --- | --- |
|  [BackgroundWorker](./backgroundworker/)() | RTTI információ. |
|  [Component](../component/component/)() | RTTI információ. |
| void [Dispose](../component/dispose/)(**bool**) | Eldobható minta támogatás; nem csinál semmit. |
...
| **bool** [get_DesignMode](../component/get_designmode/)() | Ellenőrzi, hogy a komponens tervezői módban van-e. |
| **bool** [get_WorkerReportsProgress](./get_workerreportsprogress/)() const | Visszaad egy értéket, amely jelzi, hogy a [System::ComponentModel::BackgroundWorker](./) jelent-e előrehaladási frissítéseket. |
...
| void [ReportProgress](./reportprogress/)(int) | Elindítja a **System::ComponentModel::BackgroundWorker::ProgressChanged** eseményt. |
| void [ReportProgress](./reportprogress/)(int, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Elindítja a **System::ComponentModel::BackgroundWorker::ProgressChanged** eseményt a userState objektummal. |
| void [RunWorkerAsync](./runworkerasync/)() | Elindítja egy háttérművelet végrehajtását. |
| void [RunWorkerAsync](./runworkerasync/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Elindítja egy háttérművelet végrehajtását. |
| void [set_WorkerReportsProgress](./set_workerreportsprogress/)(**bool**) | Beállít egy értéket, amely jelzi, hogy a [System::ComponentModel::BackgroundWorker](./) jelent-e előrehaladási frissítéseket. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként (nem megosztottként) állítja be. Lehetővé teszi a mutatók konténerben való gyenge módra történő átváltását. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | A C# [Object.ToString()](../../system/object/tostring/) metódus analógja. Lehetővé teszi az egyedi objektumok sztringgé konvertálását. |
