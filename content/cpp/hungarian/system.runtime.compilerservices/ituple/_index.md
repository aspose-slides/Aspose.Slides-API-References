...
description: Általános célú Tuple megvalósítást definiál, amely lehetővé teszi a Tuple példánytagjainak elérését a mögöttes Tuple típus ismerete nélkül.
type: docs
weight: 53
url: /hu/system.runtime.compilerservices/ituple/
---
## ITuple osztály
...
| virtual **int32_t** [get_Length](./get_length/)() const | Visszaadja a pozíciók számát ebben az adatstruktúrában. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Visszaadja az adott indexű elemet. |
