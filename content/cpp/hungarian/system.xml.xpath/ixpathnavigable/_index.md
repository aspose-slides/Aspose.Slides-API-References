...
description: Hozzáférést biztosít az XPathNavigator osztályhoz.
type: docs
weight: 14
url: /hu/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable osztály


Hozzáférést biztosít a [XPathNavigator](../xpathnavigator/) osztályhoz.
...
| Metódus | Leírás |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | Új [XPathNavigator](../xpathnavigator/) objektumot ad vissza. |
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Referenciaszerű típusú objektumokat hasonlít össze C# stílusban. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum egy példány-e a cél típust leíró típussal. A C# 'is' operátor analógiája. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók átváltását gyenge módra konténerekben. |
