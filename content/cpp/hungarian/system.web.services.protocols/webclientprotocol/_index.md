...
description: "Ezt az alaposztályt minden XML webszolgáltatás kliens proxy használja, amelyet ASP.NET-el hoztak létre. Ennek az osztálynak az objektumait csak a System::MakeObject() függvény segítségével lehet lefoglalni. Soha ne hozzon létre példányt ebből a típusból a veremben vagy az new operátorral, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót a függvények argumentumaként."
type: docs
weight: 144
url: /hu/system.web.services.protocols/webclientprotocol/
---
## WebClientProtocol osztály

Ez az alap osztály minden XML [Web](../../system.web/) szolgáltatás kliens proxyban használatos, amelyet ASP.NET-el hoztak létre. Ennek az osztálynak az objektumai csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével foglalhatók le. Soha ne hozzon létre példányt ebből a típusból a veremben vagy az new operátorral, mivel ez futásidejű hibákat és/vagy állítási hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót az argumentumként történő függvényhívásokhoz.
