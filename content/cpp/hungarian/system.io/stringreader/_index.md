...
description: "A karaktereket egy stringből olvasó olvasót reprezentál. Az osztály objektumait csak a System::MakeObject() függvénnyel szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stack-en vagy az operator new használatával, mivel ez futásidejű hibákat és/vagy assertion hibákat eredményez. Mindig csomagolja be az osztályt egy System::SmartPtr mutatóba, és ezt a mutatót használja argumentumként a függvényeknek."
type: docs
weight: 404
url: /hu/system.io/stringreader/
---
...
| void [Dispose](./dispose/)(**bool**) override | Nem csinál semmit. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol a két NaN egyenlőnek tekintett, mégis az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Utánozza a C#-stílusú lebegőpontos összehasonlítást, ahol a két NaN egyenlőnek tekintett, mégis az IEC 60559:1989 szerint a NaN nem egyenlő semmilyen értékkel, beleértve a NaN-t is. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ellenőrzi, hogy az objektum példány-e a targetType által leírt típusból. A C# 'is' operátor analógiája. |
...
| int [Peek](./peek/)() override | Olvas egy karaktert az adatfolyamból anélkül, hogy megváltoztatná az adatfolyam pozícióját. |
| int [Read](./read/)() override | Olvas egy karaktert az adatfolyamból. |
| int [Read](./read/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) override | Olvasza a megadott számú karaktert az adatfolyamból a megadott karaktertömbbe, a megadott pozíciótól kezdve. |
| virtual int [ReadBlock](../textreader/readblock/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | Olvasza a megadott legnagyobb számú karaktert a jelenlegi szövegolvasóból, és az adatot a megadott indexnél kezdődő pufferbe írja. |
| [String](../../system/string/) [ReadLine](./readline/)() override | Olvas karaktereket az adatfolyamból a jelenlegi sor végéig. |
| [String](../../system/string/) [ReadToEnd](./readtoend/)() override | Olvas karaktereket az adatfolyamból amíg az adatfolyam vége el nem ér. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók konténerekben gyenge módra való váltását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Lekéri a megosztott referenciaszámláló aktuális értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
|  [StringReader](./stringreader/)(const [String](../../system/string/)\&) | Létrehoz egy új példányt a [StringReader](./) osztályból, amely a megadott stringből olvas karaktereket. |
