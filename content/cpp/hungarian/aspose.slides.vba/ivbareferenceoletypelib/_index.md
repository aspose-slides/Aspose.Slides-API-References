...
description: OLE Automation típuskönyvtár hivatkozást képviseli.
type: docs
weight: 105
url: /hu/aspose.slides.vba/ivbareferenceoletypelib/
---
## IVbaReferenceOleTypeLib osztály
...
| virtual [System::String](../../system/string/) [get_Libid](./get_libid/)() | Az Automation típuskönyvtár azonosítóját képviseli. Olvassa el [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | A VBA projektreferencia nevét képviseli. Olvassa el [System::String](../../system/string/). |
...
| virtual void [set_Libid](./set_libid/)([System::String](../../system/string/)) | Az Automation típuskönyvtár azonosítóját képviseli. Írja [System::String](../../system/string/). |
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | A VBA projektreferencia nevét képviseli. Írja [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonparamétert gyenge mutatóvá állítja (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módra történő átállítását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Lekéri a megosztott referenciaszámláló aktuális értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott referenciaszámlálót. Nem kell közvetlenül hívni; helyette használjon intelligens mutatókat vagy ThisProtector-t. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott referenciaszámlálót. Nem kell közvetlenül hívni; helyette használjon intelligens mutatókat vagy ThisProtector-t. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Növeli a gyenge referenciaszámlálót. Nem kell közvetlenül hívni; helyette használjon intelligens mutatókat vagy ThisProtector-t. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Csökkenti a gyenge referenciaszámlálót. Nem kell közvetlenül hívni; helyette használjon intelligens mutatókat vagy ThisProtector-t. |
| virtual  [~Object](../../system/object/~object/)() | Megsemmisíti az objektumot. Felszabadítja az összes belső adatstruktúrát. |

## Lásd még

* Osztály [IVbaReference](../ivbareference/)
