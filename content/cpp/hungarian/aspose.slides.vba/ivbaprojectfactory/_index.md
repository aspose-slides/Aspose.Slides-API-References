...
description: Lehetővé teszi VBA projekt létrehozását a COM interfészen keresztül
type: docs
weight: 40
url: /hu/aspose.slides.vba/ivbaprojectfactory/
---
## IVbaProjectFactory osztály

Lehetővé teszi VBA projekt létrehozását a COM interfészen keresztül
...
| Módszer | Leírás |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() | Új VBA projektet hoz létre. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Beolvassa a VBA projektet egy OLE tárolóból. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja a n-edik sablonargumentumot gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók konténerben weak módra való átkapcsolását. |
