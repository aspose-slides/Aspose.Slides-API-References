...
| Metódus | Leírás |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [AddEmptyModule](./addemptymodule/)([System::String](../../system/string/)) override | Új üres modult ad a VBA projekthez. |
| [iterator](./iterator/) [begin](./begin/)() | Iterátort ad, amely az első (ha van) elemre mutat a gyűjteményben. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Iterátort ad, amely az első (ha van) elemre mutat a gyűjteményben. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Iterátort ad, amely az első (ha van) elemre mutat a gyűjteményben. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Iterátort ad, amely a gyűjtemény utolsó, const minősítésű elemét követő pozícióra mutat (ha van). |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>\>, **int32_t**) override | Átmásolja a gyűjtemény összes elemét a megadott tömbbe. |
| [iterator](./iterator/) [end](./end/)() | Iterátort ad, amely a gyűjtemény utolsó elemét követő pozícióra mutat (ha van). |
| [const_iterator](./const_iterator/) [end](./end/)() const | Iterátort ad, amely a gyűjtemény utolsó elemét követő pozícióra mutat (ha van). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Szinkronizációs gyökérértéket ad vissza. Csak olvasható [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>\>\> [GetEnumerator](./getenumerator/)() override | Iterátort ad vissza, amely végigjárja a gyűjteményt. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Az objektum tényleges típusát adja. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógiája. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [idx_get](./idx_get/)(**int32_t**) override | A megadott indexű elemet adja vissza. |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Számértékek sorozatának átlagát számítja ki. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | A bemeneti sorozat minden elemén egy transzformációs függvény alkalmazásával kapott értékek sorozatának átlagát számítja ki. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyes elemre transzformációs függvényt hív meg egy általános sorozaton, és a legnagyobb kapott értéket adja vissza. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden egyes elemre transzformációs függvényt hív meg egy általános sorozaton, és a legkisebb kapott értéket adja vissza. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | A sorozat minden elemét az indexet is felhasználó új formába transzformálja. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Minden sorozat elemet projekcióval átalakít, és az így kapott sorozatokat egy sorozatba egyesíti. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | A sorozat elejéről a megadott számú egymást követő elemet adja vissza. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Hivatkozással hasonlít össze értéktípusú objektumot a nullptr-val. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>) override | Eltávolítja a megadott objektum első előfordulását a gyűjteményből. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referencia számlálót a megadott értékkel. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablonargumentumot gyenge mutatóként (nem megosztott) állítja be. Lehetővé teszi a tárolók mutatóiról gyenge módra váltást. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Iterátort ad, amely a gyűjtemény const minősítésű példányának első (ha van) elemére mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Iterátort ad, amely a gyűjtemény első (ha van) elemére mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Iterátort ad, amely a gyűjtemény const minősítésű példányának utolsó (ha van) elemét követő pozícióra mutat. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Iterátort ad, amely a gyűjtemény utolsó elemét követő pozícióra mutat (ha van). |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Egy gyűjteménytípus, amelynek iterátor típusait a jelenlegi gyűjtemény iterátortípként használja. |
...
* Osztály [IVbaModuleCollection](../ivbamodulecollection/)
