...
description: Módosított OLE Automation típuskönyvtárhivatkozást képvisel, amelyben minden vezérlő kiterjeszthetőként van jelölve.
type: docs
weight: 92
url: /hu/aspose.slides.vba/ivbareferenceoletwiddledtypelib/
---
## IVbaReferenceOleTwiddledTypeLib osztály


Módosított OLE Automation típuskönyvtárhivatkozást képvisel, amelyben minden vezérlő kiterjeszthetőként van jelölve.
...
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | A VBA projektreferencia nevét jelöli. Olvassa [System::String](../../system/string/). |
...
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | A VBA projektreferencia nevét jelöli. Írja [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként állítja be (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását konténerekben gyenge módra. |
