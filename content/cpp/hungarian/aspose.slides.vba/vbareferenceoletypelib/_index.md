...
description: OLE Automation típuskönyvtár hivatkozást képvisel.
type: docs
weight: 209
...
OLE Automation típuskönyvtár hivatkozást képvisel.
...
| [System::String](../../system/string/) [get_Libid](./get_libid/)() override | Az Automation típuskönyvtár azonosítóját képviseli. Olvassa el a [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | A VBA projekt hivatkozás nevét képviseli. Olvassa el a [System::String](../../system/string/). |
...
| void [set_Libid](./set_libid/)([System::String](../../system/string/)) override | Az Automation típuskönyvtár azonosítóját képviseli. Írja a [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | A VBA projekt hivatkozás nevét képviseli. Írja a [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge pointerre (nem megosztottra). Lehetővé teszi a konténerekben lévő pointerek gyenge módba történő átkapcsolását. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti a megosztott referenciaszámlálót és visszaadja értékét. Nem szabad közvetlenül meghívni; helyette használjon okos pointereket vagy ThisProtector-t. |
...
|  [VbaReferenceOleTypeLib](./vbareferenceoletypelib/)([System::String](../../system/string/), [System::String](../../system/string/)) | Ez a konstruktor új OLE Automation típuskönyvtár hivatkozást hoz létre. |
...
* Osztály [IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)
