...
| Módszer | Leírás |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>) override | Új hivatkozást ad a hivatkozások gyűjteményéhez |
| [iterator](./iterator/) [begin](./begin/)() | Visszaad egy iterátort, amely az első elemre (ha van) mutat a gyűjteményben |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Visszaad egy iterátort, amely az első elemre (ha van) mutat a gyűjtemény const-kvalifikált példányában |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Visszaad egy iterátort, amely az első const-kvalifikált elemre (ha van) mutat a gyűjteményben |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Visszaad egy iterátort, amely az utolsó const-kvalifikált elem (ha van) utánra mutat a gyűjteményben |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>\>, **int32_t**) override | Átmásolja a gyűjtemény összes elemét a megadott tömbbe |
| [iterator](./iterator/) [end](./end/)() | Visszaad egy iterátort, amely az utolsó elem (ha van) utánra mutat a gyűjteményben |
| [const_iterator](./const_iterator/) [end](./end/)() const | Visszaad egy iterátort, amely a const-kvalifikált példány utolsó eleme (ha van) utánra mutat |
...
| **int32_t** [get_Count](./get_count/)() override | Visszaadja a gyűjteményben ténylegesen lévő elemek számát. Csak olvasható **int32_t** |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Visszaadja a objektumhoz társított referencia számláló adatstruktúrát |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>\>\> [GetEnumerator](./getenumerator/)() override | Visszaad egy enumerátort, amely végig iterál a gyűjteményen |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) módszer analógja. Lehetővé teszi egyedi objektumok hash-elését |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [idx_get](./idx_get/)(**int32_t**) override | Visszaadja a megadott indexű elemet |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Megállapítja, hogy a sorozat létezik-e bármely eleme, vagy teljesíti-e a feltételt |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Kiszámítja egy numerikus értékek sorozatának átlagát |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Kiszámítja egy olyan értéksorozat átlagát, amely az bemeneti sorozat minden elemére alkalmazott transzformációs függvény által kapott értékekből áll |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Visszaadja a sorozat első olyan elemét, amely megfelel a feltételnek, vagy egy alapértelmezett értéket, ha ilyen elem nem található |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden elemre meghív egy transzformációs függvényt egy generikus sorozatban, és visszaadja a kapott értékek közül a legnagyobbat |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Minden elemre meghív egy transzformációs függvényt egy generikus sorozatban, és visszaadja a kapott értékek közül a legkisebbet |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Átalakítja egy sorozat minden elemét új formává, a elem indexét felhasználva |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Kivetíti egy sorozat minden elemét, és az eredményül kapott sorozatokat egyetlen sorozatba egyesíti |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Szűri egy sorozatot a megadott predikátum alapján |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Másoló konstruktor. Nem másol semmit, csak inicializálja az új objektumot, és lehetővé teszi az alosztályok másolási konstruktorát |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Értékadási operátor. Nem másol semmit, csak inicializálja az új objektumot, és lehetővé teszi az alosztályok másolási konstruktorát |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Visszaad egy iterátort, amely az első elemre (ha van) mutat a gyűjtemény const-kvalifikált példányában |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Visszaad egy iterátort, amely az első elemre (ha van) mutat a gyűjteményben |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Visszaad egy iterátort, amely az utolsó elem (ha van) utánra mutat a gyűjtemény const-kvalifikált példányában |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Visszaad egy iterátort, amely az utolsó elem (ha van) utánra mutat a gyűjteményben |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Csökkenti a gyenge referencia számlálót. Nem szakor közvetlenül meghívni; helyette használjon okos mutatókat vagy ThisProtector-t |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | A gyűjtemény típusa, amelynek iterátortípusait a jelenlegi gyűjtemény iterátortípusaiként használja |
| [iterator](./iterator/) | Iterátor típusa |
| [const_iterator](./const_iterator/) | Const iterátor típusa |
| [virtualized_iterator_element](./virtualized_iterator_element/) | Virtualizált elem típusa |
| [virtualized_iterator](./virtualized_iterator/) | Virtualizált típus |

## Lásd még

* Osztály [IVbaReferenceCollection](../ivbareferencecollection/)
