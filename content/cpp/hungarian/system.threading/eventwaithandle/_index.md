...
description: "Esemény, amely elküldhető egy várakozó szálnak. Ennek az osztálynak az objektumait csak a System::MakeObject() függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stack-en vagy az operator new segítségével, mivel futási hibákat és/vagy assertion hibákat okozhat. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót az argumentumként történő függvényhíváshoz."
type: docs
weight: 118
url: /hu/system.threading/eventwaithandle/
---
## EventWaitHandle osztály

Esemény, amely elküldhető egy várakozó szálnak. Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény használatával szabad lefoglalni. Soha ne hozza létre ennek a típusnak a példányát a stack-en vagy az operator new használatával, mivel ez futási hibákat és/vagy assertion hibákat eredményez. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót a függvények argumentumaként történő átadásra.
...
| Metódus | Leírás |
| --- | --- |
| virtual void [Close](../waithandle/close/)() | Felszabadít minden erőforrást, amely a handle-hez kapcsolódik. |
...
| [wait_handle_t](../wait_handle_t/) [get_Handle](../waithandle/get_handle/)() | Lekéri a handle-t. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | A C# [Object.GetHashCode()](../../system/object/gethashcode/) metódus analógja. Lehetővé teszi az egyedi objektumok hashelését. |
...
| virtual **bool** [Reset](./reset/)() | Az eseményt nem jelzési állapotba állítja. |
| virtual **bool** [Set](./set/)() | Az eseményt jelzési állapotba állítja. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonparamétert gyenge mutatóra (a megosztott helyett). Lehetővé teszi a mutatók konténerekben való gyenge módra váltását. |
...
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Várakozik, amíg az összes handle aktiválódik. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Várakozik, amíg az összes handle aktiválódik. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Várakozik, amíg az összes handle aktiválódik. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Várakozik, amíg valamelyik handle aktiválódik. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Várakozik, amíg valamelyik handle aktiválódik. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Várakozik, amíg valamelyik handle aktiválódik. |
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Várakozik, amíg a handle aktiválódik korlátlan ideig. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int) | Várakozik, amíg a handle aktiválódik. |
| virtual **bool** [WaitOne](../waithandle/waitone/)([TimeSpan](../../system/timespan/)) | Várakozik, amíg a handle aktiválódik. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int, **bool**) | Várakozik, amíg a handle aktiválódik. |
...
| Mező | Leírás |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Speciális érték, amelyet a függvény ad vissza, egyébként a jelzett objektum indexét adja vissza a tömbben, ha a timeout túllép és semmi sem jelez. |

## Lásd még

* Osztály [WaitHandle](../waithandle/)
