...
type: docs
weight: 53
url: /hu/system.threading/details_semaphorefullexception/
---
## Details_SemaphoreFullException osztály
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | A stack trace-et tartalmazó karakterláncot ad vissza. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](./gettype/)() const override | Megkapja az objektum tényleges típusát. A C# [System.Object.GetType()](../../system/object/gettype/) hívás analógja. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | A n-edik sablon argumentumot gyenge mutatóra (nem megosztott) állítja. Lehetővé teszi a mutatók átkapcsolását a konténerekben gyenge módba. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Visszaadja a jelenlegi objektum string reprezentációját. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Megvalósítja a [what()](../../system/details_exception/what/) metódust, amelyet a [ExceptionWrapper](../../system/exceptionwrapper/) osztály hív. Annak ellenére, hogy ez az osztály nem örököl a std::exception-ből, az ebből származó osztályok használhatják a védett/privát tagokat a logika megvalósításához. Ennek a metódusnak a [ExceptionWrapper](../../system/exceptionwrapper/)-ba történő áthelyezése megtörheti azt a logikát. |
