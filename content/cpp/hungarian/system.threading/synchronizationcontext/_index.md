...
description: Alapvető funkcionalitást biztosít a szinkronizációs kontextus különféle szinkronizációs műveletek során történő továbbításához.
type: docs
weight: 196
url: /hu/system.threading/synchronizationcontext/
---
## SynchronizationContext osztály

Alapvető funkcionalitást biztosít a szinkronizációs kontextus különféle szinkronizációs műveletek során történő továbbításához.
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Lekéri a szinkronizációs kontextust az aktuális szál számára. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Aszinkron módon futtatja a visszahívást. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Objektumokat referenciával hasonlít össze. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Objektumokat referenciával hasonlít össze. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenciával hasonlít értéktípusú objektumot a nullptr értékkel. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Szinkron módon futtatja a visszahívást. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Beállítja a szinkronizációs kontextust az aktuális szálra. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóként (a megosztott helyett). Lehetővé teszi a mutatók konténerben való gyenge módra való átkapcsolását. |
| int [SharedCount](../../system/object/sharedcount/)() const | Lekéri a megosztott referenciaszámláló aktuális értékét. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Növeli a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Csökkenti és visszaadja a megosztott referenciaszámlálót. Nem szabad közvetlenül hívni; helyette használjon okos mutatókat vagy ThisProtector-t. |
|  [SynchronizationContext](./synchronizationcontext/)() | Létrehoz egy új példányt a [SynchronizationContext](./)-ból. |
...
Ez az osztály lehetővé teszi a szinkronizációs kontextus szálak közötti továbbítását, és arra használható, hogy visszahívásokat vagy meghívásokat a megfelelő szálra vagy szinkronizációs kontextusba irányítsa.  
Üres implementáció.
