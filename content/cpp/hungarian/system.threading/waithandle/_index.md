...
description: "Várakozási primitív alaposztály. Ennek az osztálynak az objektumait csak a System::MakeObject() függvény használatával szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stacken vagy az operator new használatával, mivel ez futásidejű hibákhoz és/vagy állítási hibákhoz vezet. Mindig csomagolja be ezt az osztályt egy System::SmartPtr mutatóba, és használja ezt a mutatót, hogy argumentumként átadja a függvényeknek."
type: docs
weight: 274
url: /hu/system.threading/waithandle/
---
## WaitHandle osztály

Várakozási primitív alaposztály. Ennek az osztálynak az objektumait csak a [System::MakeObject()](../../system/makeobject/) függvény segítségével szabad lefoglalni. Soha ne hozzon létre példányt ebből a típusból a stackon vagy az operator new használatával, mivel ez futásidejű hibákhoz és/vagy állítási hibákhoz vezet. Mindig csomagolja be ezt az osztályt egy [System::SmartPtr](../../system/smartptr/) mutatóba, és használja ezt a mutatót, hogy argumentumként átadja a függvényeknek.
...
| Method | Description |
| --- | --- |
| virtual void [Close](./close/)() | Felszabadítja a fogantyúval kapcsolatos minden erőforrást. |
...
| [wait_handle_t](../wait_handle_t/) [get_Handle](./get_handle/)() | Lekéri a fogantyút. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóra (a megosztott helyett) állítja be. Lehetővé teszi a mutatók konténerekben weak módra váltását. |
...
| static **bool** [WaitAll](./waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&, int) | Várakozik, amíg az összes fogantyú aktiválódik. |
| static **bool** [WaitAll](./waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&, [TimeSpan](../../system/timespan/)) | Várakozik, amíg az összes fogantyú aktiválódik. |
| static **bool** [WaitAll](./waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&) | Várakozik, amíg az összes fogantyú aktiválódik. |
| static int [WaitAny](./waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&, int) | Várakozik, amíg valamelyik fogantyú aktiválódik. |
| static int [WaitAny](./waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&, [TimeSpan](../../system/timespan/)) | Várakozik, amíg valamelyik fogantyú aktiválódik. |
| static int [WaitAny](./waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&) | Várakozik, amíg valamelyik fogantyú aktiválódik. |
| virtual **bool** [WaitOne](./waitone/)() | Várakozik, amíg a fogantyú korlátlan időre aktiválódik. |
| virtual **bool** [WaitOne](./waitone/)(int) | Várakozik, amíg a fogantyú aktiválódik. |
| virtual **bool** [WaitOne](./waitone/)([TimeSpan](../../system/timespan/)) | Várakozik, amíg a fogantyú aktiválódik. |
| virtual **bool** [WaitOne](./waitone/)(int, **bool**) | Várakozik, amíg a fogantyú aktiválódik. |
...
| Field | Description |
| --- | --- |
| static [WaitTimeout](./waittimeout/) | Speciális érték, amelyet a függvény visszaad, ha egyébként a jelzett objektum indexét adná vissza a tömbben, ha a timeout lejár és semmi sem jelez. |
