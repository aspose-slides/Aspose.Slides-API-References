...
| Módszer | Leírás |
| --- | --- |
| virtual void [Close](../waithandle/close/)() | Felszabadít minden erőforrást, amely a kezelőhöz kapcsolódik. |
...
| virtual **bool** [Reset](../eventwaithandle/reset/)() | Az eseményt nem jelző állapotra állítja. |
| virtual **bool** [Set](../eventwaithandle/set/)() | Az eseményt jelző állapotra állítja. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonargumentumot gyenge mutatóra (nem megosztott). Lehetővé teszi a mutatók konténerben gyenge módra történő átváltását. |
...
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Várja, amíg minden kezelő aktiválódik. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Várja, amíg minden kezelő aktiválódik. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Várja, amíg minden kezelő aktiválódik. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Várja, amíg bármelyik kezelő aktiválódik. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Várja, amíg bármelyik kezelő aktiválódik. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Várja, amíg bármelyik kezelő aktiválódik. |
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Várja a kezelő aktiválódását korlátlan időre. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int) | Várja a kezelő aktiválódását. |
| virtual **bool** [WaitOne](../waithandle/waitone/)([TimeSpan](../../system/timespan/)) | Várja a kezelő aktiválódását. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int, **bool**) | Várja a kezelő aktiválódását. |
...
| Mező | Leírás |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Különleges érték, amelyet a függvény visszaad, ha egyébként a jelzett objektum indexét adná vissza a tömbben, ha a határidő lejár és semmi sem jelez. |
