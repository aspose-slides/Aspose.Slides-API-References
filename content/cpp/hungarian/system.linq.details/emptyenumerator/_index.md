...
description: Megvalósítja az IEnumerator interfészt egy üres generikus gyűjteményhez.
type: docs
weight: 27
url: /hu/system.linq.details/emptyenumerator/
---
## EmptyEnumerator osztály
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../../system.collections.generic/ienumerator/current/)() const | Lekéri az aktuális elemet. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Lekéri az aktuális elemet. |
...
| **bool** [MoveNext](./movenext/)() override | Az enumerátort a következő elemre mozgatja. Ha korábban nem volt hivatkozott elem, a legelső elérhető elemre állítja a hivatkozást. Ha a tároló vége elérve van, nem csinál semmit. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | A [Object::ReferenceEquals](../../system/object/referenceequals/) speciális változata sztring és nullptr esetén. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | A [Object::ReferenceEquals](../../system/object/referenceequals/) speciális változata sztringek esetén. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Csökkenti a megosztott referenciaszámlálót a megadott értékkel. |
| void [Reset](./reset/)() override | Az enumerátort az első elem előtti pozícióra állítja vissza. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Beállítja az n-edik sablonparamétert gyenge mutatóként (nem megosztottként). Lehetővé teszi a mutatók átkapcsolását a tárolókban gyenge módba. |
