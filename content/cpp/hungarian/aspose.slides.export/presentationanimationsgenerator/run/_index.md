...
description: Futtatja az animációs események generálását minden dián.
type: docs
weight: 92
url: /hu/aspose.slides.export/presentationanimationsgenerator/run/
---
## PresentationAnimationsGenerator::Run(System::SharedPtr\<System::Collections::Generic::IEnumerable\<System::SharedPtr\<ISlide\>\>\>) metódus

Futtassa az animációs események generálását minden dián.
...
{
    // új animációban a keretlépés kezelése
}));

animationsGenerator->Run(presentation->get_Slides());
```

## PresentationAnimationsGenerator::Run(System::SharedPtr\<System::Collections::Generic::IEnumerable\<System::SharedPtr\<ISlide\>\>\>, int32_t, PresentationPlayer::FrameTickHandler) metódus
...
* Osztály [ISlide](../../../aspose.slides/islide/)
