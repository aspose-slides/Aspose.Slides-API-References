...
| virtual void [WriteDocumentEnd](./writedocumentend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) | Az html dokumentum láblécének írásáért felel. Minden prezentációkonverziónál egyszer hívódik. |
| virtual void [WriteDocumentStart](./writedocumentstart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) | Az html dokumentum fejlécének írásáért felel. Minden prezentációkonverziónál egyszer hívódik. |
| virtual void [WriteShapeEnd](./writeshapeend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Az alakzat renderelése előtt hívódik. Az egyes alakzatoknál egyszer hívódik. Ha ez a függvény bármit ír a generátorba, az aktuális diakép generálása befejeződik, a hozzáadott html részlet beillesztésre kerül, és egy új kép indul a korábbi tetején. |
| virtual void [WriteShapeStart](./writeshapestart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Az alakzat renderelése előtt hívódik. Az egyes alakzatoknál egyszer hívódik. Ha ez a függvény bármit ír a generátorba, az aktuális diakép generálása befejeződik, a hozzáadott html részlet beillesztésre kerül, és egy új kép indul a korábbi tetején. |
| virtual void [WriteSlideEnd](./writeslideend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>) | Az html diák láblécének írásáért felel. Minden dián egyszer hívódik. |
| virtual void [WriteSlideStart](./writeslidestart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>) | Az html diák fejlécének írásáért felel. Minden dián egyszer hívódik. |
