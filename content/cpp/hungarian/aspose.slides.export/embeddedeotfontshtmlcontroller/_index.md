...
description: Az EOT formátumban a betűtípusok beágyazásához használandó formázási vezérlőosztály
type: docs
weight: 14
...
Az EOT formátumban a betűtípusok beágyazásához használandó formázási vezérlőosztály
...
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Új példányt hoz létre. |
...
* Osztály [IEmbeddedEotFontsHtmlController](../iembeddedeotfontshtmlcontroller/)
