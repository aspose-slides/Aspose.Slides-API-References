...
description: Beállításokat biztosít az Ink objektumok megjelenésének szabályozásához az exportált dokumentumban.
type: docs
weight: 235
...
Lehetővé teszi, hogy beállításokkal szabályozza a [Ink](../../aspose.slides.ink/) objektumok megjelenését az exportált dokumentumban.
...
| virtual **bool** [get_HideInk](./get_hideink/)() | Megjeleníti vagy elrejti a [Ink](../../aspose.slides.ink/) elemeket az exportált dokumentumban. |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | ROP műveletet vagy Átlátszóságot használ az ecset megjelenítéséhez. |
...
| void [Lock](../../system/object/lock/)() | Megvalósítja a C# lock() utasítás zárolását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) őroló objektumot. |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | Megjeleníti vagy elrejti a [Ink](../../aspose.slides.ink/) elemeket az exportált dokumentumban. |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | ROP műveletet vagy Átlátszóságot használ az ecset megjelenítéséhez. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonargumentumot gyenge mutatóként állítja be (a megosztott helyett). Lehetővé teszi, hogy a tárolókban lévő mutatókat weak módra állítsák át. |
...
| void [Unlock](../../system/object/unlock/)() | Megvalósítja a C# lock() utasítás feloldását. Hívja közvetlenül vagy használja a [LockContext](../../system/lockcontext/) őroló objektumot. |
