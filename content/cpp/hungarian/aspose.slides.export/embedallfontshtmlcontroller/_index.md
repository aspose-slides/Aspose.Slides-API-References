...
description: A formázó vezérlőosztály, amely a prezentáció összes betűtípusának WOFF formátumban történő beágyazására használható.
type: docs
weight: 1
...
A formázó vezérlőosztály, amely a prezentáció összes betűtípusának WOFF formátumban történő beágyazására használható.
...
|  [EmbedAllFontsHtmlController](./embedallfontshtmlcontroller/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Új példányt hoz létre |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Az n-edik sablonparamétert gyenge mutatóként állítja be (a megosztott helyett). Lehetővé teszi a mutatók átkapcsolását a gyenge módba a konténerekben. |
...
| virtual void [WriteAllFonts](./writeallfonts/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) | Kiírja az összes [Presentation](../../aspose.slides/presentation/)-ban lévő betűtípust. |
| void [WriteDocumentEnd](./writedocumentend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) override | HTML dokumentum láblécének írására hívják. Egy alkalommal kerül meghívásra prezentáció konverziónként. |
| void [WriteDocumentStart](./writedocumentstart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) override | HTML dokumentum fejlécre írására hívják. Egy alkalommal kerül meghívásra prezentáció konverziónként. |
| virtual void [WriteFont](./writefont/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../../aspose.slides/ifontdata/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../../aspose.slides/ifontdata/)\>, [System::String](../../system/string/), [System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Az adatot base64-ként írja be magába az HTML dokumentumba. |
| void [WriteShapeEnd](./writeshapeend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | A forma renderelése előtt hívják. Minden forma esetén egyszer kerül meghívásra. Ha ez a függvény bármit ír a generátorba, a jelenlegi diakép generálása befejeződik, a hozzáadott HTML fragmentum beillesztődik, és egy új kép kezdődik a korábbi tetején. |
| void [WriteShapeStart](./writeshapestart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | A forma renderelése előtt hívják. Minden forma esetén egyszer kerül meghívásra. Ha ez a függvény bármit ír a generátorba, a jelenlegi diakép generálása befejeződik, a hozzáadott HTML fragmentum beillesztődik, és egy új kép kezdődik a korábbi tetején. |
| void [WriteSlideEnd](./writeslideend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>) override | HTML diadoboz láblécének írására hívják. Minden dia esetén egyszer kerül meghívásra. |
| void [WriteSlideStart](./writeslidestart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>) override | HTML diadoboz fejlécre írására hívják. Minden dia esetén egyszer kerül meghívásra. |
