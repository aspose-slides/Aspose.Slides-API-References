...
description: "Interfaccia che confronta due oggetti in senso maggiore-uguale-minore. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarla alle funzioni come argomento."
type: docs
weight: 261
url: /it/system.collections.generic/icomparer/
---
## IComparer classe
...
| Metodo | Descrizione |
| --- | --- |
| virtual int [Compare](./compare/)([args_type](./args_type/), [args_type](./args_type/)) const | [Comparison](../../system/comparison/) funzione. |
...
| Typedef | Descrizione |
| --- | --- |
| [args_type](./args_type/) | tipo argomento [Comparison](../../system/comparison/). |
