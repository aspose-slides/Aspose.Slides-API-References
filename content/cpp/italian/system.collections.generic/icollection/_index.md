...
description: "Interfaccia di una collezione di elementi. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 248
url: /it/system.collections.generic/icollection/
---
## ICollection classe

Interfaccia di una collezione di elementi. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e utilizza questo puntatore per passarlo alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Add](./add/)(const T\&) | Aggiunge un elemento alla collezione. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Restituisce un iteratore che punta al primo elemento (se presente) della collezione. Questo iteratore non può essere usato per modificare l'oggetto referenziato perché [GetEnumerator()](../ienumerable/getenumerator/) restituisce un oggetto copia di T. |
...
| virtual void [Clear](./clear/)() | Elimina tutti gli elementi dalla collezione. |
| virtual **bool** [Contains](./contains/)(const T\&) const | Verifica se l'elemento è presente nella collezione. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia tutti gli elementi della collezione in elementi di un array esistente. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) della collezione. Questo iteratore non può essere usato per modificare l'oggetto referenziato perché [GetEnumerator()](../ienumerable/getenumerator/) restituisce un oggetto copia di T. |
...
| virtual int [get_Count](./get_count/)() const | Restituisce il numero di elementi nella collezione. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() const | Verifica se la collezione è di sola lettura. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Restituisce l'oggetto con cui la collezione è sincronizzata. |
...
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)() | Restituisce il primo elemento di una sequenza, oppure un valore predefinito se la sequenza è vuota. |
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione oppure un valore predefinito se non è stato trovato alcun elemento. |
...
| T [LINQ_LastOrDefault](../ienumerable/linq_lastordefault/)() | Restituisce l'ultimo elemento di una sequenza, oppure un valore predefinito se la sequenza è vuota. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Ordina gli elementi di una sequenza in ordine ascendente in base ai valori chiave selezionati da keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Ordina gli elementi di una sequenza in ordine discendente in base ai valori chiave selezionati da keySelector. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\>\>\&) | Proietta ogni elemento di una sequenza e combina le sequenze risultanti in un'unica sequenza. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita a inizializzare il nuovo oggetto e permette la copia di costruttori nelle sottoclassi. |
| [ICollection](./)\& [operator=](./operator_equal/)([ICollection](./)\&&) | Operatore di assegnazione per spostamento. |
| [ICollection](./)\& [operator=](./operator_equal/)(const [ICollection](./)\&) | Operatore di assegnazione per spostamento. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita a inizializzare il nuovo oggetto e permette la copia di costruttori nelle sottoclassi. |
...
| virtual **bool** [Remove](./remove/)(const T\&) | Elimina l'elemento dalla collezione. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco dell'istruzione lock() di C#. Chiamalo direttamente o usa l'oggetto sentry [LockContext](../../system/lockcontext/). |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../ienumerable/virtualizebeginconstiterator/)() const | Restituisce l'implementazione del iteratore begin const per il contenitore corrente. |
...
| Typedef | Descrizione |
| --- | --- |
| [ValueType](./valuetype/) | Nome del tipo valore. |
| [ThisType](./thistype/) | Nome del tipo collezione. |
