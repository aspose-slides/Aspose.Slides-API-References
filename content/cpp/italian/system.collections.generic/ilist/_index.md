...
description: "Interfaccia di contenitore indicizzato di elementi. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 339
url: /it/system.collections.generic/ilist/
---
## IList classe

Interfaccia di contenitore indicizzato di elementi. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarla alle funzioni come argomento.
...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Restituisce un iteratore che punta al primo elemento (se presente) della collezione. Questo iteratore non può essere usato per modificare l'oggetto riferito perché [GetEnumerator()](../ienumerable/getenumerator/) restituisce una copia dell'oggetto T. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza della collezione con qualificatore const. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Restituisce un iteratore che punta al primo elemento qualificato const (se presente) della collezione. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento qualificato const (se presente) della collezione. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) della collezione. Questo iteratore non può essere usato per modificare l'oggetto riferito perché [GetEnumerator()](../ienumerable/getenumerator/) restituisce una copia dell'oggetto T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della collezione con qualificatore const. |
...
| **bool** [get_IsFixedSize](./get_isfixedsize/)() | Verifica se la collezione ha dimensione fissa. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Verifica se la collezione è in sola lettura. |
...
| virtual T [idx_get](./idx_get/)(int) const | Restituisce l'elemento all'indice specificato. |
| virtual void [idx_set](./idx_set/)(int, T) | Imposta l'elemento all'indice specificato. |
| virtual int [IndexOf](./indexof/)(const T\&) const | Restituisce l'indice della prima occorrenza dell'elemento nel contenitore. |
| virtual void [Insert](./insert/)(int, const T\&) | Inserisce un elemento nella posizione specificata, spostando gli altri elementi. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se esiste almeno un elemento nella sequenza o se soddisfa una condizione. |
...
| virtual void [RemoveAt](./removeat/)(int) | Rimuove l'elemento all'indice specificato. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa il contatore di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; usare invece i puntatori intelligenti o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e restituisce il contatore di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; usare invece i puntatori intelligenti o ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il contatore di riferimenti deboli. Non dovrebbe essere chiamato direttamente; usare invece i puntatori intelligenti o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il contatore di riferimenti deboli. Non dovrebbe essere chiamato direttamente; usare invece i puntatori intelligenti o ThisProtector. |
