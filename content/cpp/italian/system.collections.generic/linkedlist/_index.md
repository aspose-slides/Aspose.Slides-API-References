...
description: Dichiarazione forward di LinkedList.
type: docs
weight: 404
url: /it/system.collections.generic/linkedlist/
---
## LinkedList classe
...
| Metodo | Descrizione |
| --- | --- |
| void [Add](./add/)(const T\&) override | Aggiunge **element** alla fine della lista. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\> [AddAfter](./addafter/)(const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&, const T\&) | Aggiunge **element** dopo **node** della lista. |
| void [AddAfter](./addafter/)(const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&, const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&) | Aggiunge **newNode** dopo **node** della lista. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\> [AddBefore](./addbefore/)(const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&, const T\&) | Aggiunge **element** prima di **node** della lista. |
| void [AddBefore](./addbefore/)(const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&, const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&) | Aggiunge **newNode** prima di **node** della lista. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\> [AddFirst](./addfirst/)(const T\&) | Aggiunge **element** all'inizio della lista. |
| void [AddFirst](./addfirst/)(const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&) | Aggiunge **newNode** all'inizio della lista. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\> [AddLast](./addlast/)(const T\&) | Aggiunge **element** alla fine della lista. |
| void [AddLast](./addlast/)(const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&) | Aggiunge **newNode** alla fine della lista. |
| [iterator](../ienumerable/iterator/) [begin](./begin/)() | Restituisce un iteratore al primo elemento della raccolta. |
| [const_iterator](../ienumerable/const_iterator/) [begin](./begin/)() const | Restituisce un iteratore al primo elemento della raccolta const-qualificata. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](./cbegin/)() const | Restituisce un iteratore al primo elemento const-qualificato della raccolta. |
| [const_iterator](../ienumerable/const_iterator/) [cend](./cend/)() const | Restituisce un iteratore per un elemento const-qualificato inesistente oltre la fine della raccolta. |
| void [Clear](./clear/)() override | Elimina tutti gli elementi nella lista. |
| **bool** [Contains](./contains/)(const T\&) const override | Verifica se **element** è presente nella lista. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia i dati del contenitore negli elementi di un array esistente. |
| [const_reverse_iterator](./const_reverse_iterator/) [crbegin](./crbegin/)() const | Restituisce un iteratore inverso all'ultimo elemento const-qualificato della raccolta (primo in ordine inverso). |
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | Restituisce un iteratore inverso per un elemento const-qualificato inesistente prima dell'inizio della raccolta. |
| [iterator](../ienumerable/iterator/) [end](./end/)() | Restituisce un iteratore per un elemento inesistente oltre la fine della raccolta. |
| [const_iterator](../ienumerable/const_iterator/) [end](./end/)() const | Restituisce un iteratore per un elemento inesistente oltre la fine della raccolta const-qualificata. |
...
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\> [Find](./find/)(const T\&) const | Esegue una ricerca in direzione avanti di un **element** nella lista. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\> [FindLast](./findlast/)(const T\&) const | Esegue una ricerca in direzione inversa di un **element** nella lista. |
| int [get_Count](./get_count/)() const override | Restituisce il numero di elementi nella lista. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\> [get_First](./get_first/)() const | Restituisce un puntatore al primo elemento della lista. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Verifica se la raccolta è di sola lettura. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\> [get_Last](./get_last/)() const | Restituisce un puntatore all'ultimo elemento della lista. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Restituisce l'oggetto attraverso il quale la raccolta è sincronizzata. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore per iterare attraverso il corrente [LinkedList](./). |
...
|  [LinkedList](./linkedlist/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | Costruttore di copia. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se esiste un elemento di una sequenza o se soddisfa una condizione. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e abilita la copia dei sottogruppi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e abilita la copia dei sottogruppi. |
...
| [reverse_iterator](./reverse_iterator/) [rbegin](./rbegin/)() | Restituisce un iteratore inverso all'ultimo elemento della raccolta (primo in ordine inverso). |
| [const_reverse_iterator](./const_reverse_iterator/) [rbegin](./rbegin/)() const | Restituisce un iteratore inverso all'ultimo elemento della raccolta const-qualificata (primo in ordine inverso). |
...
| **bool** [Remove](./remove/)(const T\&) override | Rimuove la prima occorrenza del **element** specificato dalla lista. |
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](../linkedlistnode/)\<T\>\>\&) | Rimuove il nodo dalla lista. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimento condiviso del valore specificato. |
| void [RemoveFirst](./removefirst/)() | Rimuove il primo nodo dalla lista. |
| void [RemoveLast](./removelast/)() | Rimuove l'ultimo nodo dalla lista. |
| [reverse_iterator](./reverse_iterator/) [rend](./rend/)() | Restituisce un iteratore inverso per un elemento inesistente prima dell'inizio della raccolta. |
| [const_reverse_iterator](./const_reverse_iterator/) [rend](./rend/)() const | Restituisce un iteratore inverso per un elemento inesistente prima dell'inizio della raccolta const-qualificata. |
...
Contenitore di lista collegata. Implementa un wrapper su std::list. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarlo alle funzioni come argomento.
