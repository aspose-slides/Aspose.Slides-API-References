...
description: Fornisce una classe base per le implementazioni dell'interfaccia generica System.Collections.Generic.IComparer.
type: docs
weight: 105
url: /it/system.collections.generic/comparer/
---
## Classe Comparer

Fornisce una classe base per le implementazioni dell'interfaccia generica [System.Collections.Generic.IComparer](../icomparer/).
...
| --- | --- |
| T | Il tipo di oggetti da confrontare. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) funzione. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Restituisce un comparatore di ordinamento predefinito per il tipo specificato dall'argomento generico. |
