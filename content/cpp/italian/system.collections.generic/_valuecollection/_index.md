...
description: "Raccolta dei valori del Dictionary. Fa riferimento alla collezione, non copia nulla. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo nello stack o usando l'operator new, poiché ciò comporterà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarla alle funzioni come argomento."
type: docs
weight: 27
url: /it/system.collections.generic/_valuecollection/
---
## _ValueCollection classe

Collezione dei valori di [Dictionary](../dictionary/). Riferisce la collezione, non copia nulla. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo nello stack o usando l'operatore new, poiché causerà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo alle funzioni come argomento.
...
| void [Clear](../ikvcollection/clear/)() override | Cancella tutti gli elementi dal contenitore. |
| **bool** [Contains](./contains/)(const [TValue](./tvalue/)\&) const override | Verifica se l'elemento è presente nel contenitore. |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Copia i dati negli elementi dell'array esistente. |
...
| int [get_Count](../basekvcollection/get_count/)() const override | Restituisce il numero di elementi. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TValue](./tvalue/)\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera sui valori. |
...
| [TValue](./tvalue/) [idx_get](./idx_get/)(int) const override | Implementa il metodo [IList](../ilist/). Non supportato. |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | Funzione impostatore. |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | Restituisce l'indice dell'elemento nel contenitore. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Cast](../ienumerable/linq_cast/)() | Trasforma gli elementi nel tipo specificato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la costruzione di copie per le subclassi. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la costruzione di copie per le subclassi. |
...
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Restituisce l'implementazione del begin const iterator per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Restituisce l'implementazione del begin iterator per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Restituisce l'implementazione del end const iterator per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Restituisce l'implementazione del end iterator per il contenitore corrente. |
