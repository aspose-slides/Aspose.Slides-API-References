...
description: "Interfaccia del contenitore che contiene chiavi o valori del contenitore simile a un dizionario. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 326
url: /it/system.collections.generic/ikvcollection/
---
## IKVCollection classe

Interfaccia del contenitore che contiene chiavi o valori del contenitore simile a un dizionario. Gli oggetti di questa classe dovrebbero essere allocati solo mediante la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e utilizzare questo puntatore per passarlo alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| void [Add](./add/)(const T\&) override | Aggiunge un elemento al contenitore. |
...
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Ottiene un iteratore che punta al primo elemento (se presente) dell'istanza qualificata come const della collezione. |
...
| void [Clear](./clear/)() override | Elimina tutti gli elementi dal contenitore. |
| **bool** [Contains](./contains/)(const T\&) const override | Verifica se l'elemento è presente nel contenitore. |
...
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza qualificata come const della collezione. |
...
| virtual int [get_Count](./get_count/)() const | Ottiene il numero di elementi nel contenitore. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Verifica se la collezione ha dimensione fissa. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Verifica se il contenitore è di sola lettura. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Ottiene l'oggetto mediante il quale la collezione è sincronizzata. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Ottiene l'enumeratore per il contenitore. |
...
| virtual T [idx_get](./idx_get/)(int) const | Funzione getter. |
| void [idx_set](./idx_set/)(int, T) override | Funzione setter. |
| int [IndexOf](./indexof/)(const T\&) const override | Ottiene l'indice dell'elemento nel contenitore. |
...
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se nessun elemento è trovato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e permette la costruzione di copie delle sottoclassi. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e permette la costruzione di copie delle sottoclassi. |
...
| **bool** [Remove](./remove/)(const T\&) override | Rimuove l'elemento dal contenitore. |
| void [RemoveAt](./removeat/)(int) override | Rimuove l'elemento alla posizione specificata. |
