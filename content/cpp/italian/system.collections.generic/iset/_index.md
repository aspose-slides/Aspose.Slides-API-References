...
description: "Interfaccia di una collezione contenente un insieme di elementi unici. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 352
url: /it/system.collections.generic/iset/
---
## ISet classe

Interfaccia di una collezione contenente un insieme di elementi unici. Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarla alle funzioni come argomento.
...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Restituisce un iteratore che punta al primo elemento (se presente) della collezione. Questo iteratore non può essere usato per modificare l'oggetto riferito perché [GetEnumerator()](../ienumerable/getenumerator/) restituisce una copia dell'oggetto di tipo T. |
...
| virtual void [ExceptWith](./exceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Rimuove un gruppo di elementi. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo per uso interno. |
| virtual int [get_Count](../icollection/get_count/)() const | Restituisce il numero di elementi nella collezione. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Verifica se la collezione è sola lettura. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](../ienumerable/getenumerator/)() | Restituisce un enumeratore. |
...
| virtual void [IntersectWith](./intersectwith/)([IEnumerablePtr](./ienumerableptr/)) | Rimuove gli elementi non presenti in un contenitore diverso. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se l'oggetto rappresenta un'istanza del tipo descritto da targetType. Analogo dell'operatore C# 'is'. |
| virtual **bool** [IsProperSubsetOf](./ispropersubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se l'insieme corrente è un sottoinsieme proprio di un altro contenitore. |
| virtual **bool** [IsProperSupersetOf](./ispropersupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se l'insieme corrente è un soprasottoinsieme proprio di un altro contenitore. |
| virtual **bool** [IsSubsetOf](./issubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se l'insieme corrente è un sottoinsieme di un altro contenitore. |
| virtual **bool** [IsSupersetOf](./issupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se l'insieme corrente è un soprasottoinsieme di un altro contenitore. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se esiste qualche elemento in una sequenza o ne soddisfa una condizione. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, inizializza solo il nuovo oggetto e consente la costruzione di copie delle subclassi. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, inizializza solo il nuovo oggetto e consente la costruzione di copie delle subclassi. |
| virtual **bool** [Overlaps](./overlaps/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se l'insieme si sovrappone a un altro contenitore. |
...
| virtual **bool** [SetEquals](./setequals/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se l'insieme e il contenitore contengono gli stessi elementi. |
...
| virtual void [SymmetricExceptWith](./symmetricexceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Calcola la differenza simmetrica di due contenitori. Rimuove tutti gli elementi presenti in entrambi i contenitori, ma allo stesso tempo aggiunge tutti gli elementi presenti in **other**, ma non nell'insieme corrente. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogo del metodo C# [Object.ToString()](../../system/object/tostring/). Abilita la conversione di oggetti personalizzati in stringa. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementa il costrutto C# typeof([System.Object](../../system/object/)). |
| virtual void [UnionWith](./unionwith/)([IEnumerablePtr](./ienumerableptr/)) | Aggiunge elementi dalla collezione specificata che non sono ancora presenti nell'insieme corrente. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il contatore di riferimenti debole. Non dovrebbe essere chiamato direttamente; usare i puntatori intelligenti o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il contatore di riferimenti debole. Non dovrebbe essere chiamato direttamente; usare i puntatori intelligenti o ThisProtector. |
...
| Typedef | Description |
| --- | --- |
| [IEnumerablePtr](./ienumerableptr/) | Tipo enumerabile per confrontare i contenuti dell'insieme corrente. |
