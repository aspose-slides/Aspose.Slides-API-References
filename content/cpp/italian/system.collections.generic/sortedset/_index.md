...
description: Dichiarazione anticipata della classe SortedSet.
type: docs
weight: 573
url: /it/system.collections.generic/sortedset/
---
## SortedSet classe

Dichiarazione anticipata della classe [SortedSet](./).
...
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza qualificata const della collezione. |
...
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Restituisce un iteratore che punta immediatamente dopo l'ultimo elemento qualificato const (se presente) della collezione. |
...
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia tutti gli elementi della collezione in elementi di array esistenti. |
...
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Restituisce un iteratore che punta immediatamente dopo l'ultimo elemento (se presente) dell'istanza qualificata const della collezione. |
...
| T [get_Max](./get_max/)() const | Restituisce il valore massimo in [SortedSet](./). |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)() | Determina se una sequenza contiene degli elementi. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo del metodo C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Abilita il clono di tipi personalizzati. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento template n-esimo come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
|  [SortedSet](./sortedset/)() | Crea un set vuoto. |
|  [SortedSet](./sortedset/)(int) | Crea un set vuoto con capacità specificata. |
|  [SortedSet](./sortedset/)(const [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\>\&) | Crea un set vuoto che utilizza il comparatore di uguaglianza specificato. |
|  [SortedSet](./sortedset/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | Crea [SortedSet](./) basato su valori enumerabili. |
