...
second_title: Aspose.Slides per l'API C++
description: "Nodo di una lista collegata. Implementa un wrapper su un iteratore di std::list che è avvolto in una lista collegata. Gli oggetti di questa classe devono essere allocati solo tramite la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o utilizzando l'operatore new, poiché ciò provocherà errori di runtime e/o violazioni di assert. Avvolgi sempre questa classe in un puntatore System::SmartPtr e utilizza tale puntatore per passarla alle funzioni come argomento."
type: docs
weight: 417
url: /it/system.collections.generic/linkedlistnode/
---
...
| [SharedPtr](../../system/sharedptr/)\<[LinkedList](../linkedlist/)\<T\>\> [get_List](./get_list/)() const | Restituisce la lista contenente. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Next](./get_next/)() const | Restituisce il nodo successivo. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Previous](./get_previous/)() const | Restituisce il nodo precedente. |
| T [get_Value](./get_value/)() const | Restituisce il valore memorizzato. |
...
| void [set_Value](./set_value/)(const T\&) | Imposta il valore memorizzato. |
