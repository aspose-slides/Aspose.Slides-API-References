...
description: "Definizione di enumeratore per avvolgere tipi in stile STL per utilizzo in stile C#. Non effettua affermazioni sulla struttura del contenitore eccetto l'esistenza di un iteratore sequenziale. Usa le funzioni begin() e end(). Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai istanze di questo tipo sullo stack o mediante operator new, poiché ciò provocherà errori di runtime e/o violazioni di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 66
url: /it/system.collections.generic/baseenumerator/
---
## BaseEnumerator classe
...
| Metodo | Descrizione |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | Prepara l'iteratore per essere usato dalla classe VirtualizedIterator. |
| [BaseEnumerator](./baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Inizializza l'iteratore. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](../ienumerator/cloneiterator/)() const override | Clona l'iteratore corrente. |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](../ienumerator/get_current/)() const | Ottiene l'elemento corrente. |
...
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | Sposta l'iteratore in avanti di un passo. |
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | Esegue la prima chiamata [MoveNext()](../ienumerator/movenext/) e prepara l'oggetto enumeratore per l'uso da parte di VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se l'oggetto rappresenta un'istanza del tipo descritto da targetType. Analogo dell'operatore C# 'is'. |
| **bool** [IsValid](./isvalid/)() const | Verifica se [MoveNext()](./movenext/) è stato chiamato e la fine non è stata raggiunta. |
...
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | Marca l'enumeratore posseduto dall'iteratore virtualizzato. |
...
| **bool** [MoveNext](./movenext/)() override | Incremento in stile enumeratore. |
...
| void [Reset](./reset/)() override | Reimposta l'enumeratore per consentire la rienumerazione degli elementi. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento del modello come puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
