...
description: Dichiarazione in avanti della classe Stack.
type: docs
weight: 599
url: /it/system.collections.generic/stack/
---
## Classe Stack


[Stack](./) dichiarazione in avanti della classe.
...
| Metodo | Descrizione |
| --- | --- |
| void [AddRange](./addrange/)([IEnumerablePtr](./ienumerableptr/)) | Inserisce elementi nello stack. |
...
| virtual void [Clear](./clear/)() | Elimina tutti gli elementi dallo stack. |
| virtual **bool** [Contains](./contains/)(const T\&) const | Verifica se un elemento specifico è presente nel contenitore; utilizza l'operatore == per il confronto. |
| [stack_t](./stack_t/)\& [data](./data/)() | Accessore della struttura dati interna. |
| const [stack_t](./stack_t/)\& [data](./data/)() const | Accessore della struttura dati interna. |
...
| virtual int [get_Count](./get_count/)() const | Restituisce il numero di elementi nello stack. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore per iterare attraverso lo stack corrente. |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Calcola la media di una sequenza di valori ottenuti invocando una funzione di trasformazione su ciascun elemento della sequenza di ingresso. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, inizializza soltanto il nuovo oggetto e consente la copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la copia delle sottoclassi. |
| T [Peek](./peek/)() | Ottiene l'elemento dalla cima dello stack, ma lo mantiene nello stack. |
| T [Pop](./pop/)() | Ottiene l'elemento dalla cima dello stack. |
| void [Push](./push/)(const T\&) | Inserisce un elemento nella cima dello stack. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue il contatore di riferimento condiviso del valore specificato. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template come puntatore debole (invece di condiviso). Consente di cambiare i puntatori nei contenitori a modalità debole. |
...
|  [Stack](./stack/)([IEnumerablePtr](./ienumerableptr/)) | Costruttore di copia. |
| virtual [ArrayPtr](../../system/arrayptr/)\<T\> [ToArray](./toarray/)() | Converte lo stack in un array. |
...
| [stack_t](./stack_t/) | Tipo di dati sottostante. |
...
[Stack](./) classe che incapsula std::list. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò genererebbe errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarlo alle funzioni come argomento.
...
int main()
{
  ...
  // Stampa l'ultimo elemento dello stack. Il metodo Peek non rimuove un elemento dallo stack.
