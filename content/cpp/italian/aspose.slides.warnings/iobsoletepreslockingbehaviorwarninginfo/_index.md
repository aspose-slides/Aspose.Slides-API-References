...
Questo avviso indica che è stato utilizzato un comportamento di blocco della presentazione obsoleto.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Restituisce una descrizione leggibile dall'uomo di questo avviso. Sola lettura [System::String](../../system/string/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Se il destinatario non è null termina l'avviso a un destinatario specificato e lancia l'AbortRequestedException se il destinatario decide di annullare un'operazione. |
