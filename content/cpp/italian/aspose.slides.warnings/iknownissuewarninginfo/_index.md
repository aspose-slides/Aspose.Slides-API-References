...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Restituisce una descrizione leggibile dall'uomo di questo avviso. Di sola lettura [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Restituisce un tipo di avviso. Di sola lettura [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza il nuovo oggetto e consente la copia di costruzione delle subclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza il nuovo oggetto e consente la copia di costruzione delle subclassi. |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Se il ricevitore non è nullo termina l'avviso a un ricevitore specificato e lancia l'AbortRequestedException se il ricevitore ha deciso di abortire un'operazione. |
