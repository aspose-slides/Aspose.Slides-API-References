...
description: Interfaccia per classi che ricevono avvisi
type: docs
weight: 53
...
Interfaccia per classi che ricevono avvisi
...
| virtual [ReturnAction](../returnaction/) [Warning](./warning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningInfo](../iwarninginfo/)\>) | Metodo di callback che riceve un avviso e decide se l'operazione deve essere annullata. |
