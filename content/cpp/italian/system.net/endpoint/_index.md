...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](./)\> [Create](./create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Crea una nuova istanza della classe [EndPoint](./) usando l'indirizzo socket specificato. |
...
| virtual [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_AddressFamily](./get_addressfamily/)() | Restituisce la famiglia di indirizzi a cui appartiene l'istanza corrente. |
...
| virtual [ImplPtr](./implptr/) [GetImpl](./getimpl/)() const | Restituisce un puntatore all'implementazione. |
