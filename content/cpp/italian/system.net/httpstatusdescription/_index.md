...
description: Contiene i metodi di utilità per ottenere la rappresentazione testuale dello stato HTTP.
type: docs
weight: 248
url: /it/system.net/httpstatusdescription/
---
## HttpStatusDescription classe

Contiene i metodi di utilità per ottenere la rappresentazione testuale dello stato HTTP.
...
| static [String](../../system/string/) [Get](./get/)([HttpStatusCode](../httpstatuscode/)) | Restituisce una descrizione testuale del codice di stato HTTP specificato. |
| static [String](../../system/string/) [Get](./get/)(**int32_t**) | Restituisce una descrizione testuale del codice di stato HTTP specificato. |
...
|  [HttpStatusDescription](./httpstatusdescription/)() | Il costruttore predefinito eliminato. |
