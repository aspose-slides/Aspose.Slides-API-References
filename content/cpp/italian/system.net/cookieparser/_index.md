...
description: "Utilizzato per analizzare un'intestazione cookie e creare un'istanza della classe Cookie. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare tale puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 53
url: /it/system.net/cookieparser/
---
## CookieParser classe

Usato per analizzare un'intestazione di cookie e creare un'istanza della classe [Cookie](../cookie/). Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché causerà errori di runtime e/o errori di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarla alle funzioni come argomento.
...
| Method | Description |
| --- | --- |
| static [String](../../system/string/) [CheckQuoted](./checkquoted/)([String](../../system/string/)) | Verifica se la stringa specificata è racchiusa tra virgolette. |
| [CookieParser](./cookieparser/)([String](../../system/string/)) | Costruisce una nuova istanza. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [Get](./get/)() | Restituisce un'istanza basata sulla stringa specificata. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Consente l'hashing di oggetti personalizzati. |
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [GetServer](./getserver/)() | Ottiene il cookie del server. |
| [String](../../system/string/) [GetString](./getstring/)() | Restituisce la rappresentazione stringa di un'intestazione cookie. |
