...
description: Rappresenta un'implementazione di salvataggio dell'output per trasferire i dati nello storage esterno.
type: docs
weight: 14
...
Rappresenta un'implementazione di salvataggio dell'output per trasferire i dati nello storage esterno.
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Salva un array di byte in una posizione di destinazione. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento del template a un puntatore debole (invece che condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
