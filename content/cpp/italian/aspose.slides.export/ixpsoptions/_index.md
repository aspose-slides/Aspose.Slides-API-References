...
| virtual **bool** [get_DrawSlidesFrame](./get_drawslidesframe/)() | Vero per disegnare un contorno nero attorno a ogni diapositiva. Leggi **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\> [get_ProgressCallback](../isaveoptions/get_progresscallback/)() | Rappresenta un oggetto callback per il salvataggio degli aggiornamenti di avanzamento in percentuale. Vedi [IProgressCallback](../../aspose.slides/iprogresscallback/). |
| virtual **bool** [get_SaveMetafilesAsPng](./get_savemetafilesaspng/)() | Vero per convertire tutti i metafile usati in una presentazione in immagini PNG. Leggi **bool**. |
| virtual **bool** [get_ShowHiddenSlides](./get_showhiddenslides/)() | Specifica se il documento generato deve includere le diapositive nascoste o no. Il valore predefinito è **false**. |
| virtual **bool** [get_SkipJavaScriptLinks](../isaveoptions/get_skipjavascriptlinks/)() | Specifica se saltare i collegamenti ipertestuali con chiamate JavaScript quando si salva la presentazione. Leggi **bool**. Il valore predefinito è **false**. |
...
| virtual void [set_DrawSlidesFrame](./set_drawslidesframe/)(**bool**) | Vero per disegnare un contorno nero attorno a ogni diapositiva. Scrivi **bool**. |
...
| virtual void [set_SaveMetafilesAsPng](./set_savemetafilesaspng/)(**bool**) | Vero per convertire tutti i metafile usati in una presentazione in immagini PNG. Scrivi **bool**. |
| virtual void [set_ShowHiddenSlides](./set_showhiddenslides/)(**bool**) | Specifica se il documento generato deve includere le diapositive nascoste o no. Il valore predefinito è **false**. |
| virtual void [set_SkipJavaScriptLinks](../isaveoptions/set_skipjavascriptlinks/)(**bool**) | Specifica se saltare i collegamenti ipertestuali con chiamate JavaScript quando si salva la presentazione. Scrivi **bool**. Il valore predefinito è **false**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa il blocco lock() di C# per lo sblocco. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
