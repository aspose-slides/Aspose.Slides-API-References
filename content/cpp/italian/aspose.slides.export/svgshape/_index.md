...
| [System::String](../../system/string/) [get_Id](./get_id/)() override | Ottiene l'id della forma |
...
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | Ottiene l'id della forma |
| void [SetEventHandler](./seteventhandler/)([SvgEvent](../svgevent/), [System::String](../../system/string/)) override | Imposta il gestore di eventi per la forma |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n'th argomento del template come puntatore debole (invece di condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
