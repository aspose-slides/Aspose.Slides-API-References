...
| Metodo | Descrizione |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateCustomFormatter](./createcustomformatter/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Crea e restituisce un formattatore HTML per la generazione personalizzata di HTML basata su callback. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateDocumentFormatter](./createdocumentformatter/)([System::String](../../system/string/), **bool**) | Crea e restituisce un formattatore HTML per una vista di documento semplice che consiste in sequenze di diapositive una sotto l'altra. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateSlideShowFormatter](./createslideshowformatter/)([System::String](../../system/string/), **bool**) | Crea e restituisce un formattatore HTML per una presentazione HTML semplice che mostra le diapositive una dopo l'altra. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e permette la copia dei sottotipi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e permette la copia dei sottotipi. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento template n-esimo come puntatore debole (più che condiviso). Consente di passare i puntatori nei contenitori in modalità debole. |
...
* Classe [IHtmlFormatter](../ihtmlformatter/)
