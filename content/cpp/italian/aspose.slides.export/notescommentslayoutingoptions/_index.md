...
| [System::Drawing::Color](../../system.drawing/color/) [get_CommentsAreaColor](./get_commentsareacolor/)() | Restituisce il colore dell'area dei commenti (Vale solo se i commenti sono visualizzati a destra). |
| **int32_t** [get_CommentsAreaWidth](./get_commentsareawidth/)() | Restituisce la larghezza dell'area di output dei commenti in pixel (Vale solo se i commenti sono visualizzati a destra). |
| [CommentsPositions](../commentspositions/) [get_CommentsPosition](./get_commentsposition/)() | Restituisce la posizione dei commenti nella pagina. |
| [NotesPositions](../notespositions/) [get_NotesPosition](./get_notesposition/)() | Restituisce la posizione delle note nella pagina. |
| **bool** [get_ShowCommentsByNoAuthor](./get_showcommentsbynoauthor/)() | Restituisce la visibilità dei commenti senza autore. Se true i commenti saranno visualizzati. (Vale solo se i commenti sono visualizzati). |
...
| void [set_CommentsAreaColor](./set_commentsareacolor/)([System::Drawing::Color](../../system.drawing/color/)) | Imposta il colore dell'area dei commenti (Vale solo se i commenti sono visualizzati a destra). |
| void [set_CommentsAreaWidth](./set_commentsareawidth/)(**int32_t**) | Imposta la larghezza dell'area di output dei commenti in pixel (Vale solo se i commenti sono visualizzati a destra). |
| void [set_CommentsPosition](./set_commentsposition/)([CommentsPositions](../commentspositions/)) | Imposta la posizione dei commenti nella pagina. |
| void [set_NotesPosition](./set_notesposition/)([NotesPositions](../notespositions/)) | Imposta la posizione delle note nella pagina. |
| void [set_ShowCommentsByNoAuthor](./set_showcommentsbynoauthor/)(**bool**) | Imposta la visibilità dei commenti senza autore. Se true i commenti saranno visualizzati. (Vale solo se i commenti sono visualizzati). |
