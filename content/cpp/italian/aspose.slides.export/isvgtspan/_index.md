...
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Ottiene l'id per l'elemento "tspan" |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza semplicemente il nuovo oggetto e consente la costruzione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza semplicemente il nuovo oggetto e consente la costruzione di copie di sottoclassi. |
...
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Imposta l'id per l'elemento "tspan" |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template come weak pointer (piuttosto che shared). Consente di passare i puntatori nei contenitori in modalità weak. |
