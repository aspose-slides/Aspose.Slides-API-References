...
description: La classe del controller di formattazione da utilizzare per l'incorporamento dei font in formato WOFF
type: docs
weight: 27
...
La classe del controller di formattazione da utilizzare per l'incorporamento dei font in formato WOFF
...
|  [EmbeddedWoffFontsHtmlController](./embeddedwofffontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Crea una nuova istanza. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione di copie per le classi derivate. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione di copie per le classi derivate. |
...
* Classe [IEmbeddedWoffFontsHtmlController](../iembeddedwofffontshtmlcontroller/)
