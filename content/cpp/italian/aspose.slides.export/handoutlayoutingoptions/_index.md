...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Specifica quanti diapositivi e in quale sequenza saranno posizionati nella pagina [HandoutType](../handouttype/). |
| **bool** [get_PrintComments](./get_printcomments/)() const | Specifica se visualizzare o meno i commenti sulle diapositive |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Specifica se disegnare o meno cornici attorno alle diapositive visualizzate. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Specifica se stampare o meno i numeri delle diapositive visualizzate. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, semplicemente inizializza un nuovo oggetto e abilita la costruzione di copie delle subclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, semplicemente inizializza un nuovo oggetto e abilita la costruzione di copie delle subclassi. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Specifica quanti diapositivi e in quale sequenza saranno posizionati nella pagina [HandoutType](../handouttype/). |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Specifica se visualizzare o meno i commenti sulle diapositive |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Specifica se disegnare o meno cornici attorno alle diapositive visualizzate. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Specifica se stampare o meno i numeri delle diapositive visualizzate. |
