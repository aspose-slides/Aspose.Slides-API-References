...
description: Rappresenta il lettore di animazioni associate alla Presentazione.
type: docs
weight: 625
...
Rappresenta il lettore di animazioni associate a [Presentation](../../aspose.slides/presentation/).
...
| Metodo | Descrizione |
| --- | --- |
| void [Dispose](./dispose/)() override | Rilascia l'istanza di [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Restituisce l'indice del fotogramma. |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Crea una nuova istanza di [PresentationPlayer](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (anziché condiviso). Consente di cambiare i puntatori nei container in modalità debole. |
...
| Typedef | Descrizione |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Rappresenta il gestore di tick del fotogramma dell'evento **PresentationPlayer::FrameTick**. |
