...
description: "Codifica Unicode. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo nello stack o utilizzando l'operatore new, poiché ciò proverà errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 339
url: /it/system.text/unicodeencoding/
---
...
| static [EncodingPtr](../../system/encodingptr/) [get_BigEndianUnicode](../encoding/get_bigendianunicode/)() | Restituisce l'oggetto di codifica Unicode standard big-endian. |
| static [EncodingPtr](../../system/encodingptr/) [get_BigEndianUTF32](../encoding/get_bigendianutf32/)() | Restituisce l'oggetto di codifica UTF-32 standard big-endian. |
...
| virtual int [get_CodePage](../encoding/get_codepage/)() | Restituisce l'ID della codepage [Windows](../../system.windows/). |
...
| const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_EncoderFallback](../encoding/get_encoderfallback/)() const | Restituisce il fallback dell'encoder. |
| virtual [String](../../system/string/) [get_EncodingName](../encoding/get_encodingname/)() | Restituisce il nome della codifica leggibile dall'uomo. |
...
| static [EncodingPtr](../../system/encodingptr/) [get_Latin1](../encoding/get_latin1/)() | Restituisce la codifica Latin1. FOR INTERNAL USE. |
| static [EncodingPtr](../../system/encodingptr/) [get_Unicode](../encoding/get_unicode/)() | Restituisce l'oggetto di codifica Unicode standard. |
| static [EncodingPtr](../../system/encodingptr/) [get_UTF32](../encoding/get_utf32/)() |  |
| static [EncodingPtr](../../system/encodingptr/) [get_UTF7](../encoding/get_utf7/)() | Restituisce l'oggetto di codifica UTF-7 standard. |
| static [EncodingPtr](../../system/encodingptr/) [get_UTF8](../encoding/get_utf8/)() | Restituisce l'oggetto di codifica UTF-8 standard. |
...
| virtual [String](../../system/string/) [get_WebName](../encoding/get_webname/)() | Restituisce il nome della codifica compatibile IANA. |
| virtual int [get_WindowsCodePage](../encoding/get_windowscodepage/)() | Restituisce l'ID della codepage [Windows](../../system.windows/). |
...
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(int) | Restituisce la codifica per codepage. |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(int, const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&, const [DecoderFallbackPtr](../../system/decoderfallbackptr/)\&) | Restituisce la codifica per codepage. |
...
| static [ArrayPtr](../../system/arrayptr/)\<[EncodingInfoPtr](../../system/encodinginfoptr/)\> [GetEncodings](../encoding/getencodings/)() | Restituisce l'elenco delle codifiche conosciute. |
| int [GetHashCode](./gethashcode/)() const override | Calcola l'hash della codifica. |
...
| **bool** [operator==](./operator_equal_equal/)(const [UnicodeEncoding](./)\&) const | Confronta le codifiche per codepage e flag. |
...
| Campo | Descrizione |
| --- | --- |
| static constexpr [BIG_UNICODE_CODE_PAGE](./big_unicode_code_page/) | Numero della codepage big endian. |
| static constexpr [DEFAULT_CODE_PAGE](../encoding/default_code_page/) | Valore predefinito della codepage. |
| static constexpr [UNICODE_CODE_PAGE](./unicode_code_page/) | Numero della codepage little endian. |
