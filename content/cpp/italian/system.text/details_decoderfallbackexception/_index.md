...
description: "Eccezione generata da DecoderExceptionFallback quando la decodifica fallisce. Non creare mai istanze di questa classe manualmente. Utilizzare invece la classe DecoderFallbackException. Non racchiudere mai le istanze della classe DecoderFallbackException in System::SmartPtr."
type: docs
weight: 105
url: /it/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException classe


Eccezione generata da [DecoderExceptionFallback](../decoderexceptionfallback/) quando la decodifica fallisce. Non creare mai istanze di questa classe manualmente. Usa invece la classe DecoderFallbackException. Non racchiudere mai le istanze della classe DecoderFallbackException in [System::SmartPtr](../../system/smartptr/).
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Ottiene l'array di byte che ha causato l'errore. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Restituisce un dizionario con dati dell'eccezione personalizzati. |
...
| int [get_Index](./get_index/)() | Ottiene la posizione del byte che ha causato l'errore nell'array di input. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Ottiene il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../../system/object/gettype/). |
