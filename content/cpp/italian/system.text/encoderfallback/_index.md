...
description: "Fornisce un'API di fallback per gestire gli errori di codifica. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare questo puntatore per passarla alle funzioni come argomento."
type: docs
weight: 170
url: /it/system.text/encoderfallback/
---
## EncoderFallback classe

Fornisce un'API di fallback per gestire gli errori di codifica. Gli oggetti di questa classe dovrebbero essere allocati solo utilizzando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarla alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| virtual [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() | Ottiene il buffer associato all'algoritmo di fallback. |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](./get_exceptionfallback/)() | Ottiene l'implementazione predefinita di fallback per eccezioni. |
| virtual int [get_MaxCharCount](./get_maxcharcount/)() const | Ottiene il numero massimo di caratteri che il fallback può restituire. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](./get_replacementfallback/)() | Ottiene l'implementazione predefinita di fallback di sostituzione. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](./get_standardsafefallback/)() | Ottiene l'implementazione predefinita di fallback standard sicuro. |
...
| void [Lock](../../system/object/lock/)() | Implementa il lock() statement di C# per il blocco. Chiamalo direttamente o usa l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco del lock() statement di C#. Chiamalo direttamente o usa l'oggetto sentry [LockContext](../../system/lockcontext/). |
