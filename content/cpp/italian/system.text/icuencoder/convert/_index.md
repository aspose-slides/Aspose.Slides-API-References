...
type: docs
weight: 66
url: /it/system.text/icuencoder/convert/
---
## ICUEncoder::Convert(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int, int, bool, int\&, int\&, bool\&) metodo
...
| completed | **bool**\& | Riferimento a una variabile da impostare su true se il buffer di input è stato esaurito e su false altrimenti. |

## ICUEncoder::Convert(const char_t *, int, uint8_t *, int, bool, int\&, int\&, bool\&) metodo
