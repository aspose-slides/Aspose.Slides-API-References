...
type: docs
weight: 40
url: /it/system.text/icudecoder/getcharcount/
---
## ICUDecoder::GetCharCount(ArrayPtr\<uint8_t\>, int, int) metodo
...
## ICUDecoder::GetCharCount(ArrayPtr\<uint8_t\>, int, int, bool) metodo
...
## ICUDecoder::GetCharCount(const uint8_t *, int, bool) metodo
