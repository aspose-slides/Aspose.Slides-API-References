...
description: Restituisce i caratteri risultanti dalla decodifica di un buffer di byte.
type: docs
weight: 66
url: /it/system.text/icuencoding/getchars/
---
## ICUEncoding::GetChars(const uint8_t *, int, char_t *, int) metodo

Restituisce i caratteri risultanti dalla decodifica di un buffer di byte.
...
## ICUEncoding::GetChars(ArrayPtr\<uint8_t\>, int, int, ArrayPtr\<char_t\>, int) metodo
...
## ICUEncoding::GetChars(ArrayPtr\<uint8_t\>, int, int) metodo
...
## ICUEncoding::GetChars(ArrayPtr\<uint8_t\>) metodo
