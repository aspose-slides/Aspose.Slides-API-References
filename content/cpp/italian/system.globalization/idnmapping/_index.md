...
type: docs
weight: 170
url: /it/system.globalization/idnmapping/
---
## IdnMapping classe

[IdnMapping](./) è usato per mappare i nomi in Punycode. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o errori di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Confronta due oggetti [IdnMapping](./). |
...
| **bool** [get_AllowUnassigned](./get_allowunassigned/)() const | Ottiene il flag che indica se punti di codice non assegnati sono usati nelle operazioni. |
| **bool** [get_UseStd3AsciiRules](./get_usestd3asciirules/)() const | Ottiene il flag che indica se le convenzioni di denominazione standard sono usate nelle operazioni. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&) const | [Convert](../../system/convert/) nome di dominio unicode in equivalente ascii. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&, int) const | [Convert](../../system/convert/) nome di dominio unicode in equivalente ascii. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&, int, int) const | [Convert](../../system/convert/) nome di dominio unicode in equivalente ascii. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| int [GetHashCode](./gethashcode/)() const override | Ottiene il codice hash per l'oggetto corrente [IdnMapping](./). |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ottiene il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../../system/object/gettype/). |
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&) const | [Convert](../../system/convert/) nome di dominio ascii nell'equivalente unicode. |
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&, int) const | [Convert](../../system/convert/) nome di dominio ascii nell'equivalente unicode. |
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&, int, int) const | [Convert](../../system/convert/) nome di dominio ascii nell'equivalente unicode. |
...
| void [set_AllowUnassigned](./set_allowunassigned/)(**bool**) | Imposta il flag che indica se punti di codice non assegnati sono usati nelle operazioni. |
| void [set_UseStd3AsciiRules](./set_usestd3asciirules/)(**bool**) | Imposta il flag che indica se le convenzioni di denominazione standard sono usate nelle operazioni. |
