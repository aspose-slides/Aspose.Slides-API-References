...
description: Restituisce il numero di mesi nell'anno specificato.
type: docs
weight: 66
url: /it/system.globalization/thaibuddhistcalendar/getmonthsinyear/
---
## ThaiBuddhistCalendar::GetMonthsInYear(int, int) const metodo
...
| --- | --- | --- |
| year | int | Anno per cui ottenere il numero di mesi. |
| era | int | Era. |
...
## ThaiBuddhistCalendar::GetMonthsInYear(int) const metodo
