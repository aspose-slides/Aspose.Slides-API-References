...
description: "Calendario lunisolare dell'Asia orientale. Gli oggetti di questa classe dovrebbero essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o violazioni di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 105
url: /it/system.globalization/eastasianlunisolarcalendar/
---
## EastAsianLunisolarCalendar classe

Calendario lunisolare dell'Asia orientale. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o violazioni di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarlo a funzioni come argomento.
...
| [CalendarAlgorithmType](../calendaralgorithmtype/) [get_AlgorithmType](./get_algorithmtype/)() const override | Informazioni RTTI. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<int\> [get_Eras](../calendar/get_eras/)() const | Restituisce l'elenco delle ere presenti nel calendario. |
| virtual [Details::CalendarId](../../system.globalization.details/calendarid/) [get_ID](../calendar/get_id/)() const | Restituisce l'identificatore del calendario. |
| **bool** [get_IsReadOnly](../calendar/get_isreadonly/)() const | Verifica se il calendario è di sola lettura. |
| virtual [DateTime](../../system/datetime/) [get_MaxSupportedDateTime](../calendar/get_maxsupporteddatetime/)() const | Punto temporale massimo supportato dal calendario. |
| virtual [DateTime](../../system/datetime/) [get_MinSupportedDateTime](../calendar/get_minsupporteddatetime/)() const | Punto temporale minimo supportato dal calendario. |
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | Restituisce l'ultimo anno rappresentabile con due cifre. |
| int [GetCelestialStem](./getcelestialstem/)(int) const | Restituisce il fusto celeste. |
...
| virtual int [GetDayOfMonth](../calendar/getdayofmonth/)([DateTime](../../system/datetime/)) const | Restituisce il giorno del mese per il punto temporale specificato. |
| virtual [DayOfWeek](../../system/dayofweek/) [GetDayOfWeek](../calendar/getdayofweek/)([DateTime](../../system/datetime/)) const | Restituisce il giorno della settimana per il punto temporale specificato. |
| virtual int [GetDayOfYear](../calendar/getdayofyear/)([DateTime](../../system/datetime/)) const | Restituisce il giorno dell'anno per il punto temporale specificato. |
| virtual int [GetDaysInMonth](../calendar/getdaysinmonth/)(int, int) const | Restituisce il numero di giorni in un mese specifico. |
| virtual int [GetDaysInMonth](../calendar/getdaysinmonth/)(int, int, int) const | Restituisce il numero di giorni in un mese specifico. |
| virtual int [GetDaysInYear](../calendar/getdaysinyear/)(int) const | Restituisce il numero di giorni in un anno specifico. |
| virtual int [GetDaysInYear](../calendar/getdaysinyear/)(int, int) const | Restituisce il numero di giorni in un anno specifico. |
| virtual int [GetEra](../calendar/getera/)([DateTime](../../system/datetime/)) const | Restituisce l'era per il punto temporale specificato. |
...
| virtual int [GetLeapMonth](../calendar/getleapmonth/)(int) const | Restituisce il mese bisestile per l'anno specificato. |
| virtual int [GetLeapMonth](../calendar/getleapmonth/)(int, int) const | Restituisce il mese bisestile per l'anno specificato. |
...
| virtual int [GetMonth](../calendar/getmonth/)([DateTime](../../system/datetime/)) const | Restituisce il mese per il punto temporale specificato. |
| virtual int [GetMonthsInYear](../calendar/getmonthsinyear/)(int) const | Restituisce il numero di mesi nell'anno specificato. |
| virtual int [GetMonthsInYear](../calendar/getmonthsinyear/)(int, int) const | Restituisce il numero di mesi nell'anno specificato. |
...
| virtual int [GetSexagenaryYear](./getsexagenaryyear/)([DateTime](../../system/datetime/)) const | Restituisce l'anno nel ciclo sessagenario. |
| int [GetTerrestrialBranch](./getterrestrialbranch/)(int) const | Restituisce il ramo terrestre. |
...
| virtual int [GetYear](../calendar/getyear/)([DateTime](../../system/datetime/)) const | Restituisce l'anno per il punto temporale specificato. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se l'oggetto rappresenta un'istanza del tipo descritto da targetType. Analogo dell'operatore C# 'is'. |
| virtual **bool** [IsLeapDay](../calendar/isleapday/)(int, int, int) const | Verifica se il giorno è bisestile. |
| virtual **bool** [IsLeapDay](../calendar/isleapday/)(int, int, int, int) const | Verifica se il giorno è bisestile. |
...
| virtual **bool** [IsLeapYear](../calendar/isleapyear/)(int) const | Verifica se l'anno è bisestile. |
| virtual **bool** [IsLeapYear](../calendar/isleapyear/)(int, int) const | Verifica se l'anno è bisestile. |
...
| virtual void [set_TwoDigitYearMax](../calendar/set_twodigityearmax/)(int) | Imposta l'ultimo anno rappresentabile con due cifre. |
...
| virtual int [ToFourDigitYear](../calendar/tofourdigityear/)(int) const | Converte l'anno in anno a 4 cifre usando la proprietà TwoDigitYearMax. |
