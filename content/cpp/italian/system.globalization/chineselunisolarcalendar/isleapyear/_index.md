...
description: Verifica se l'anno è bisestile.
type: docs
weight: 105
url: /it/system.globalization/chineselunisolarcalendar/isleapyear/
---
## ChineseLunisolarCalendar::IsLeapYear(int, int) const metodo
...
True se l'anno specificato è bisestile, false altrimenti.

## ChineseLunisolarCalendar::IsLeapYear(int) const metodo
