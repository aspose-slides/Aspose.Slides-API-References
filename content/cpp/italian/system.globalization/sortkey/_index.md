...
description: "Mappatura di una stringa alla sua chiave di ordinamento. Gli oggetti di questa classe dovrebbero essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai istanze di questo tipo nello stack o usando l'operatore new, poiché ciò può causare errori di runtime e/o violazioni di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e utilizza questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 287
url: /it/system.globalization/sortkey/
---
## SortKey classe

Mappatura di una stringa alla sua chiave di ordinamento. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo nello stack o utilizzando l'operatore new, poiché causerà errori di runtime e/o violazioni di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| static int [Compare](./compare/)(const [SortKeyPtr](../sortkeyptr/)\&, const [SortKeyPtr](../sortkeyptr/)\&) | Confronta due chiavi di ordinamento. |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Verifica se l'oggetto specificato è uguale all'oggetto [SortKey](./) corrente. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_KeyData](./get_keydata/)() | Restituisce l'array di byte che rappresenta l'oggetto corrente. |
| virtual [String](../../system/string/) [get_OriginalString](./get_originalstring/)() | Restituisce la stringa originale usata per creare questo oggetto. |
...
| int [GetHashCode](./gethashcode/)() const override | Restituisce il codice hash per l'oggetto [SortKey](./) corrente. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Converti l'oggetto corrente nella sua rappresentazione stringa. |
