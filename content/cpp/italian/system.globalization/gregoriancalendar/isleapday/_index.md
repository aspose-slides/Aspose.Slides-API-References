...
type: docs
weight: 248
url: /it/system.globalization/gregoriancalendar/isleapday/
---
## GregorianCalendar::IsLeapDay(int, int, int, int) const metodo
...
## GregorianCalendar::IsLeapDay(int, int, int) const metodo
