...
description: "Elenco dei gruppi di cattura in una singola corrispondenza. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo nello stack o usando l'operatore new, poiché causerà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 40
url: /it/system.text.regularexpressions/groupcollection/
---
## GroupCollection classe

Elenco dei gruppi di cattura in una singola corrispondenza. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo nello stack o usando l'operator new, poiché causerà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| void [_add_range](../../system.collections.generic/list/_add_range/)(std::initializer_list\<T\>) | Specifico per C++. |
| void [Add](./add/)(const [GroupPtr](../groupptr/)\&) override | Disabilita l'aggiunta di elementi alla collezione. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Aggiunge un elemento alla fine della lista. |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | Aggiunge un gruppo alla collezione. |
...
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&) const | Cerca un elemento in una lista ordinata. |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | Cerca un elemento in una lista ordinata. |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(int, int, const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | Cerca un elemento in una lista ordinata. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | Ottiene un iteratore per un elemento const non esistente oltre la fine della collezione. |
| void [Clear](./clear/)() override | Disabilita la rimozione di elementi dalla collezione. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Ottiene un iteratore inverso all'ultimo elemento della collezione qualificato come const (primo in ordine inverso). |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | Ottiene un iteratore per un elemento non esistente oltre la fine della collezione. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | Ottiene un iteratore per un elemento non esistente oltre la fine della collezione qualificata come const. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Confronta gli oggetti usando la semantica C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Confronta gli oggetti di tipo riferimento nello stile C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Confronta gli oggetti di tipo valore nello stile C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula il confronto in virgola mobile stile C# dove due NaN sono considerati uguali anche se secondo IEC 60559:1989 NaN non è uguale a nessun valore, incluso NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula il confronto in virgola mobile stile C# dove due NaN sono considerati uguali anche se secondo IEC 60559:1989 NaN non è uguale a nessun valore, incluso NaN. |
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Verifica se esiste nella lista un elemento che soddisfa un predicato specifico. |
...
| void [ForEach](../../system.collections.generic/list/foreach/)([System::Action](../../system/action/)\<T\>) | Applica un'azione a tutti gli elementi della lista. |
...
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Verifica se la collezione ha dimensione fissa. |
...
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(int) const | [Group](../group/) accessore. |
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(const [String](../../system/string/)\&) const | [Group](../group/) accessore. |
...
| **ThisPtr** [GetRange](../../system.collections.generic/list/getrange/)(int, int) | Crea una sezione della lista. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ottiene il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../../system/object/gettype/). |
|  [GroupCollection](./groupcollection/)(const [WeakPtr](../../system/weakptr/)\<[Match](../match/)\>\&) | Costruttore. |
...
| virtual [GroupPtr](../groupptr/) [idx_get](./idx_get/)([String](../../system/string/)) const | [Group](../group/) accessore. |
| [GroupPtr](../groupptr/) [idx_get](./idx_get/)(int) const override | [Group](../group/) accessore. |
...
| **bool** [IsReadOnly](./isreadonly/)() const | Marca la collezione come di sola lettura. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Cerca l'oggetto specificato e restituisce l'indice base zero dell'ultima occorrenza all'interno dell'intera lista. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Cerca l'oggetto specificato e restituisce l'indice base zero dell'ultima occorrenza nell'intervallo di elementi del [List](../../system.collections.generic/list/) che si estende dal primo elemento fino all'indice specificato. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Cerca l'oggetto specificato e restituisce l'indice base zero dell'ultima occorrenza nell'intervallo di elementi del [List](../../system.collections.generic/list/) che contiene il numero specificato di elementi e termina all'indice specificato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e permette la costruzione di copie delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e permette la costruzione di copie delle sottoclassi. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | Operatore di assegnazione per spostamento. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | Operatore di assegnazione per spostamento. |
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(const [String](../../system/string/)\&) const | [Group](../group/) accessore. |
...
| **bool** [Remove](./remove/)(const [GroupPtr](../groupptr/)\&) override | Disabilita la rimozione di elementi dalla collezione. |
...
| void [RemoveRange](../../system.collections.generic/list/removerange/)(int, int) | Rimuove una sezione della lista. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | Ottiene un iteratore inverso per un elemento non esistente prima dell'inizio della collezione qualificata come const. |
| void [Reverse](../../system.collections.generic/list/reverse/)() | Inverte l'ordine degli elementi dell'intera lista. |
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | Inverte l'ordine degli elementi della sezione della lista. |
| void [set_Capacity](../../system.collections.generic/list/set_capacity/)(int) | Imposta la capacità della lista. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un weak pointer (invece di shared). Consente di cambiare i puntatori nei contenitori in modalità weak. |
...
| [ArrayPtr](../../system/arrayptr/)\<T\> [ToArray](../../system.collections.generic/list/toarray/)() const | Converte la lista in un array. |
