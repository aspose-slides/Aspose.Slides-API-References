...
description: "Risultato della corrispondenza eseguita da un singolo gruppo di cattura. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocerebbe errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 27
url: /it/system.text.regularexpressions/group/
---
## classe Group
...
| Metodo | Descrizione |
| --- | --- |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Aggiunge la cattura al gruppo. |
|  [Capture](../capture/capture/)(const [UStringPtr](../ustringptr/)\&, int, int) | Costruttore. |
...
| [CaptureCollectionPtr](../capturecollectionptr/) [get_Captures](./get_captures/)() | Restituisce le catture disponibili. |
| int [get_Index](../capture/get_index/)() const | Restituisce l'indice della sottostringa catturata. |
| int [get_Length](../capture/get_length/)() const | Restituisce la lunghezza della sottostringa catturata. |
| **bool** [get_Success](./get_success/)() | Verifica se la cattura è avvenuta con successo per questo gruppo. |
| [String](../../system/string/) [get_Value](../capture/get_value/)() const | Restituisce la sottostringa catturata. |
...
|  [Group](./group/)(const [UStringPtr](../ustringptr/)\&, int, int) | Costruttore. |
...
| [String](../../system/string/) [ToString](../capture/tostring/)() const override | Restituisce la sottostringa catturata. |
