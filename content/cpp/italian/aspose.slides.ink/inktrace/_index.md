...
description: Rappresenta un oggetto Trace. Un elemento Trace è utilizzato per registrare i dati acquisiti dal digitalizzatore. Contiene una sequenza di punti codificati secondo la specifica fornita dall'oggetto InkTraceFormat.
type: docs
weight: 92
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() override | Ottiene Brush per l'IInkLine [IInkBrush](../iinkbrush/) Sola lettura. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | Ottiene i punti per l'IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) Sola lettura. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento del template a un puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
