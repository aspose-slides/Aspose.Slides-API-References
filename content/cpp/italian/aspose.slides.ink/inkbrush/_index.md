...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Ottiene il colore del pennello per una linea. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Ottiene il tipo di effetto inchiostro (ad es., Galaxy, Gold, Silver) che definisce lo stile visivo del tratto di inchiostro. Il valore è analizzato dalla proprietà del pennello "inkEffects". Se non è specificato alcun effetto riconosciuto, viene restituito [InkEffectType::NotDefined](../inkeffecttype/). |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Ottiene la dimensione del pennello per una linea in punti. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Imposta il colore del pennello per una linea. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Imposta la dimensione del pennello per una linea in punti. |
