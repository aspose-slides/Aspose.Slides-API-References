...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Restituisce il colore del pennello per una linea. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Restituisce il tipo di effetto inchiostro (ad es., Galaxy, Gold, Silver) che definisce lo stile visivo della traccia di inchiostro. Il valore è estratto dalla proprietà del pennello "inkEffects". Se non è specificato alcun effetto riconosciuto, viene restituito [InkEffectType::NotDefined](../inkeffecttype/). |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Restituisce la dimensione del pennello per una linea in punti. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Imposta il colore del pennello per una linea. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Imposta la dimensione del pennello per una linea in punti. |
