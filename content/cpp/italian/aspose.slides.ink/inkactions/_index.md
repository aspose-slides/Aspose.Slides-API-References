...
description: Rappresenta la radice delle azioni ink.
type: docs
weight: 66
...
Rappresenta la radice delle azioni ink.
...
| [Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/) [get_BlackWhiteMode](../../aspose.slides/shape/get_blackwhitemode/)() override | Proprietà specifica come una forma verrà visualizzata in modalità bianco-nero. Leggi [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
...
| **float** [get_Height](../../aspose.slides/shape/get_height/)() override | Restituisce l'altezza della forma, misurata in punti. Leggi **float**. |
...
| **bool** [get_IsDecorative](../../aspose.slides/shape/get_isdecorative/)() override | Ottiene l'opzione 'Mark as decorative'. Leggi/scrivi **bool**. |
...
| [System::String](../../system/string/) [get_Name](../../aspose.slides/shape/get_name/)() override | Restituisce il nome di una forma. Deve essere non nullo. Usa una stringa vuota se necessario. Leggi [System::String](../../system/string/). |
| **uint32_t** [get_OfficeInteropShapeId](../../aspose.slides/shape/get_officeinteropshapeid/)() override | Restituisce un identificatore unico a livello di diapositiva che rimane costante per la durata della forma e consente a PowerPoint o al codice interop di riferirsi in modo affidabile alla forma da qualsiasi punto del documento. Solo lettura **uint32_t**. Vedi anche [Shape::get_UniqueId](../../aspose.slides/shape/get_uniqueid/). |
...
| **float** [get_Width](../../aspose.slides/shape/get_width/)() override | Restituisce la larghezza della forma, misurata in punti. Leggi **float**. |
| **float** [get_X](../../aspose.slides/shape/get_x/)() override | Restituisce la coordinata x dell'angolo superiore sinistro della forma, misurata in punti. Leggi **float**. |
| **float** [get_Y](../../aspose.slides/shape/get_y/)() override | Restituisce la coordinata y dell'angolo superiore sinistro della forma, misurata in punti. Leggi **float**. |
| **int32_t** [get_ZOrderPosition](../../aspose.slides/shape/get_zorderposition/)() override | Restituisce la posizione di una forma nell'ordine Z. Shapes[0] restituisce la forma più arretrata nell'ordine Z, e Shapes[Shapes.Count - 1] restituisce la forma più in avanti nell'ordine Z. Solo lettura **int32_t**. |
...
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetVisualBounds](../../aspose.slides/shape/getvisualbounds/)() | Restituisce i limiti visivi della forma calcolati dal contenuto renderizzato. |
...
| void [set_BlackWhiteMode](../../aspose.slides/shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/)) override | Imposta la proprietà che specifica come una forma verrà visualizzata in modalità bianco-nero. Scrivi [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
...
| void [set_IsDecorative](../../aspose.slides/shape/set_isdecorative/)(**bool**) override | Imposta l'opzione 'Mark as decorative'. Leggi/scrivi **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template come un puntatore debole (invece di condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
