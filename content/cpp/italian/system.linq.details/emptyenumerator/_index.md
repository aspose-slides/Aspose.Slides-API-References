...
description: Implementa l'interfaccia IEnumerator per una raccolta generica vuota.
type: docs
weight: 27
url: /it/system.linq.details/emptyenumerator/
---
## EmptyEnumerator classe


Implementa l'interfaccia IEnumerator per una raccolta generica vuota.
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Ottiene l'elemento corrente. |
...
| **bool** [MoveNext](./movenext/)() override | Sposta l'enumeratore al prossimo elemento. Se nessun elemento era referenziato prima, imposta il riferimento al primo elemento disponibile. Se è stato raggiunto la fine del contenitore, non fa nulla. |
