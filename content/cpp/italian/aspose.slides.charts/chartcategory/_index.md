...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Restituisce l'oggetto [IChartDataCell](../ichartdatacell/). Se la categoria è a più livelli allora viene usato l'oggetto [IChartDataCell](../ichartdatacell/) per il livello \"0\". Leggi [IChartDataCell](../ichartdatacell/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_AsLiteral](./get_asliteral/)() override | Restituisce l'oggetto AsLiteral. Leggi [System::Object](../../system/object/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_GroupingLevel](./get_groupinglevel/)(**int32_t**) override | Restituisce un livello di raggruppamento della categoria del grafico all'indice specificato. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)\> [get_GroupingLevels](./get_groupinglevels/)() override | Contenitore gestito dei valori dei livelli di raggruppamento della categoria del grafico. Una categoria a più livelli contiene più di un livello di raggruppamento. L'indicizzazione dei livelli di raggruppamento è basata su zero. Solo lettura [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/). |
| **bool** [get_UseCell](./get_usecell/)() override | Se vero, la proprietà AsCell è attiva. In altre parole, il foglio di lavoro è usato per memorizzare la categoria (questo caso supporta una categoria a più livelli). Se falso, la proprietà AsLiteral è attiva. In altre parole, il foglio di lavoro NON è usato per memorizzare la categoria (e questo caso non supporta categorie a più livelli). Solo lettura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Se UseCell è vero allora questa proprietà rappresenta la proprietà [get_AsCell()](./get_ascell/)->get(set)_Value(). Se UseCell è falso allora questa proprietà rappresenta la proprietà AsLiteral. Leggi [System::Object](../../system/object/). |
...
| void [Remove](./remove/)() override | Rimuove la categoria dal grafico. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimenti condivisi del valore specificato. |
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Imposta l'oggetto [IChartDataCell](../ichartdatacell/). Se la categoria è a più livelli allora viene usato l'oggetto [IChartDataCell](../ichartdatacell/) per il livello \"0\". Scrivi [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteral](./set_asliteral/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Imposta l'oggetto AsLiteral. Scrivi [System::Object](../../system/object/). |
| void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Se UseCell è vero allora questa proprietà rappresenta la proprietà [get_AsCell()](./get_ascell/)->get(set)_Value(). Se UseCell è falso allora questa proprietà rappresenta la proprietà AsLiteral. Scrivi [System::Object](../../system/object/). |
