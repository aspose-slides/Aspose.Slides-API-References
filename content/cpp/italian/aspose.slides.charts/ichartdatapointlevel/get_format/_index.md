...
description: Rappresenta le proprietà di formattazione del livello del punto dati. Leggi IFormat.
type: docs
weight: 1
url: /it/aspose.slides.charts/ichartdatapointlevel/get_format/
---
## IChartDataPointLevel::get_Format() metodo

Rappresenta le proprietà di formattazione del livello del punto dati. Leggi [IFormat](../../iformat/).
