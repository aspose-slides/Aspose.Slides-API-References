...
description: Rappresenta l'etichetta dati del livello di punto dati. Applicato ai tipi di serie Treemap e Sunburst. Solo lettura IDataLabel.
type: docs
weight: 14
url: /it/aspose.slides.charts/ichartdatapointlevel/get_label/
---
## IChartDataPointLevel::get_Label() metodo


Rappresenta l'etichetta dati del livello di punto dati. Applicato ai tipi di serie Treemap e Sunburst. Solo lettura [IDataLabel](../../idatalabel/).
