...
description: Fornisce l'accesso alle barre su/giù dei grafici a linee o a barre (Stock).
type: docs
weight: 1249
...
Fornisce l'accesso alle barre su/giù dei grafici a linee o a barre (Stock).
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Restituisce il formato delle barre verso il basso. Solo lettura [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Restituisce la larghezza del gap. Leggi **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Determina se il grafico ha barre su/giù. Leggi **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Restituisce il formato delle barre verso l'alto. Solo lettura [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Imposta la larghezza del gap. Scrivi **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Determina se il grafico ha barre su/giù. Scrivi **bool**. |
