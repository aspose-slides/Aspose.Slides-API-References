...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Restituisce il riempimento del muro, la linea, l'effetto, gli stili 3d. Solo lettura [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Restituisce o imposta il tipo di immagine. Leggi [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Restituisce lo spessore dei muri come percentuale della dimensione più grande del volume del grafico. Leggi **int32_t**. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Restituisce o imposta il tipo di immagine. Scrivi [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Imposta lo spessore dei muri come percentuale della dimensione più grande del volume del grafico. Scrivi **int32_t**. |
