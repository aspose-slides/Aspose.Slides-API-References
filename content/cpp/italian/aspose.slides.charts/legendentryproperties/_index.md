...
| **bool** [get_Hide](./get_hide/)() override | Determina se la voce della legenda è nascosta. Leggi **bool**. |
...
| void [set_Hide](./set_hide/)(**bool**) override | Determina se la voce della legenda è nascosta. Scrivi **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
...
* Classe [ILegendEntryProperties](../ilegendentryproperties/)
