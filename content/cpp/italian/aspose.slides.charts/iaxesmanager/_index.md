...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_HorizontalAxis](./get_horizontalaxis/)() | Restituisce l'asse orizzontale del grafico. Solo lettura [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryHorizontalAxis](./get_secondaryhorizontalaxis/)() | Restituisce l'asse orizzontale secondario del grafico. Solo lettura [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryVerticalAxis](./get_secondaryverticalaxis/)() | Restituisce l'asse verticale secondario del grafico. Solo lettura [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SeriesAxis](./get_seriesaxis/)() | Restituisce l'asse delle serie del grafico. Solo lettura [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_VerticalAxis](./get_verticalaxis/)() | Restituisce l'asse verticale del grafico. Solo lettura [IAxis](../iaxis/). |
