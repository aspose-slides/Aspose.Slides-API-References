...
| virtual **float** [get_Bottom](./get_bottom/)() | Ottiene la parte superiore dell'elemento del grafico come frazione dell'altezza del grafico. Solo lettura **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Specifica l'altezza dell'elemento del grafico come frazione dell'altezza del grafico. Leggi **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Ottiene il lato destro dell'elemento del grafico come frazione della larghezza del grafico. Solo lettura **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Specifica la larghezza dell'elemento del grafico come frazione della larghezza del grafico. Leggi **float**. |
| virtual **float** [get_X](./get_x/)() | Specifica la posizione x (sinistra) dell'elemento del grafico come frazione della larghezza del grafico. Leggi **float**. |
| virtual **float** [get_Y](./get_y/)() | Specifica la parte superiore dell'elemento del grafico come frazione dell'altezza del grafico. Leggi **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la copia di costruzione delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la copia di costruzione delle sottoclassi. |
...
| virtual void [set_Height](./set_height/)(**float**) | Specifica l'altezza dell'elemento del grafico come frazione dell'altezza del grafico. Scrivi **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Specifica la larghezza dell'elemento del grafico come frazione della larghezza del grafico. Scrivi **float**. |
| virtual void [set_X](./set_x/)(**float**) | Specifica la posizione x (sinistra) dell'elemento del grafico come frazione della larghezza del grafico. Scrivi **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Specifica la parte superiore dell'elemento del grafico come frazione dell'altezza del grafico. Scrivi **float**. |
