...
description: Rappresenta l'etichetta dei dati del livello del punto dati. Applicato per i tipi di serie Treemap e Sunburst. Sola lettura IDataLabel.
type: docs
weight: 14
url: /it/aspose.slides.charts/chartdatapointlevel/get_label/
---
## ChartDataPointLevel::get_Label() metodo

Rappresenta l'etichetta dei dati del livello del punto dati. Applicato per i tipi di serie Treemap e Sunburst. Sola lettura [IDataLabel](../../idatalabel/).
