...
description: Rappresenta il marcatore di un ciottolo.
type: docs
weight: 1301
...
Rappresenta il marcatore di un ciottolo.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Ottiene il riempimento del marcatore. Solo lettura [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Rappresenta la dimensione del marcatore in un grafico a linee, a dispersione o radar. Leggi **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Rappresenta lo stile del marcatore in un grafico a linee, a dispersione o radar. Leggi [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Rappresenta la dimensione del marcatore in un grafico a linee, a dispersione o radar. Scrivi **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Rappresenta lo stile del marcatore in un grafico a linee, a dispersione o radar. Scrivi [MarkerStyleType](../markerstyletype/). |
