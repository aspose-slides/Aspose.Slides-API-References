...
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_HorizontalAxis](./get_horizontalaxis/)() override | Restituisce l'asse orizzontale del grafico. Solo lettura [IAxis](../iaxis/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryHorizontalAxis](./get_secondaryhorizontalaxis/)() override | Restituisce l'asse orizzontale secondario del grafico. Solo lettura [IAxis](../iaxis/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryVerticalAxis](./get_secondaryverticalaxis/)() override | Restituisce l'asse verticale secondario del grafico. Solo lettura [IAxis](../iaxis/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SeriesAxis](./get_seriesaxis/)() override | Restituisce l'asse delle serie del grafico. Solo lettura [IAxis](../iaxis/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_VerticalAxis](./get_verticalaxis/)() override | Restituisce l'asse verticale del grafico. Solo lettura [IAxis](../iaxis/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta l'n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementa la costruttiva C# typeof([System.Object](../../system/object/)). |
