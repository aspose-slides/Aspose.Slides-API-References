...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() | Restituisce gli effetti utilizzati per una linea del grafico. Solo lettura [IEffectFormat](../../aspose.slides/ieffectformat/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del modello a un puntatore debole (invece che condiviso). Consente il passaggio dei puntatori nei contenitori a modalità debole. |
