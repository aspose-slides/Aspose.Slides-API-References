...
| virtual **int32_t** [get_Count](./get_count/)() | Ottiene il numero di tutte le etichette dati nella collezione. Sola lettura **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Ottiene il numero di etichette dati visibili nella collezione. Sola lettura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Restituisce il formato predefinito di tutte le etichette dati nella collezione. Sola lettura [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | False indica che l'etichetta dati non è visibile per impostazione predefinita (e quindi tutti i flag Show* (ShowValue, ...) della proprietà DefaultDataLabelFormat sono falsi). Sola lettura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | Rappresenta il formato delle linee guida delle etichette dati. Sola lettura [IChartLinesFormat](../ichartlinesformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Restituisce la serie del grafico genitore. Sola lettura [IChartSeries](../ichartseries/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../../aspose.slides/ibaseslide/)\> [get_Slide](../../aspose.slides/islidecomponent/get_slide/)() | Restituisce la diapositiva base. Sola lettura [IBaseSlide](../../aspose.slides/ibaseslide/). |
...
| virtual void [Hide](./hide/)() | Nasconde l'etichetta dati per impostazione predefinita impostando tutti i flag Show* (ShowValue, ...) della proprietà DefaultDataLabelFormat allo stato false. IsVisible sarà false dopo questa operazione. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Ottiene l'etichetta dati per il punto dati con l'indice specificato. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Restituisce un indice del [DataLabel](../datalabel/) specificato nella collezione. |
