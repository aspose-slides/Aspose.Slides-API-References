...
description: Rappresenta la collezione di IChartCategory
type: docs
weight: 599
...
Rappresenta la collezione di [IChartCategory](../ichartcategory/)
...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Se la categoria esiste nella collezione, la restituisce. Altrimenti crea una nuova categoria di grafico da [IChartDataCell](../ichartdatacell/) e la aggiunge alla collezione. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Crea un nuovo [IChartCategory](../ichartcategory/) dal valore e lo aggiunge alla collezione. |
...
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | Restituisce il conteggio dei livelli di raggruppamento delle categorie usati. È maggiore di uno per categorie multilivello. Solo lettura **int32_t**. |
...
| virtual **bool** [get_UseCells](./get_usecells/)() | Se vero, il foglio di lavoro è usato per memorizzare le categorie (questo caso supporta categorie multilivello). Se falso, il foglio di lavoro NON è usato per memorizzare valori (e questo caso non supporta categorie multilivello). Leggi **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | Ottiene l'elemento all'indice specificato. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Cerca il [IChartCategory](../ichartcategory/) specificato e restituisce l'indice a base zero della prima occorrenza all'interno dell'intera collezione |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la copia dei costruttori delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la copia dei costruttori delle sottoclassi. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Rimuove il valore specificato. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove l'elemento all'indice indicato. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimento condiviso del valore specificato. |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | Se vero, il foglio di lavoro è usato per memorizzare le categorie (questo caso supporta categorie multilivello). Se falso, il foglio di lavoro NON è usato per memorizzare valori (e questo caso non supporta categorie multilivello). Scrivi **bool**. |
