...
description: Rappresenta una collezione di ChartSeries
type: docs
weight: 287
...
Rappresenta una collezione di [ChartSeries](../chartseries/)
...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Crea una nuova serie di grafico e la aggiunge alla collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | Crea una nuova serie di grafico da [ChartDataCell](../chartdatacell/) e la aggiunge alla collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | Crea una nuova serie di grafico da [ChartCellCollection](../chartcellcollection/) e la aggiunge alla collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Crea una nuova serie di grafico da valore e la aggiunge alla collezione. |
| [iterator](./iterator/) [begin](./begin/)() | Ottiene un iteratore che punta al primo elemento (se presente) della collezione. |
...
| void [Clear](./clear/)() override | Rimuove tutti i controlli dalla collezione. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Copia tutti gli elementi della collezione nell'array specificato. |
| [iterator](./iterator/) [end](./end/)() | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se presente) della collezione. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di oggetti nella collezione. **int32_t** di sola lettura. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Restituisce un valore che indica se l'accesso alla collezione è sincronizzato (thread-safe). **bool** di sola lettura. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Restituisce la radice di sincronizzazione. [System::Object](../../system/object/) di sola lettura. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Cerca il [ChartSeries](../chartseries/) specificato e restituisce l'indice basato su zero della prima occorrenza nell'intera collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Crea una nuova serie di grafico e la inserisce nella collezione. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Confronta un oggetto di tipo valore con `nullptr` per riferimento. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Specializzazione di [Object::ReferenceEquals](../../system/object/referenceequals/) per il caso di stringa e `nullptr`. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Specializzazione di [Object::ReferenceEquals](../../system/object/referenceequals/) per il caso di stringhe. |
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Rimuove il valore specificato. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Rimuove un controllo ActiveX memorizzato nella posizione specificata dalla collezione. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimento condiviso del valore specificato. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta l'n-esimo argomento template a un puntatore debole (invece che condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ottiene un iteratore che punta al primo elemento (se presente) dell'istanza const-qualified della collezione. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Ottiene un iteratore che punta al primo elemento (se presente) della collezione. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza const-qualified della collezione. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se presente) della collezione. |
