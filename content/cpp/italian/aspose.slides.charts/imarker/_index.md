...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Ottiene il riempimento del marcatore. Solo lettura [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Rappresenta la dimensione del marcatore in un grafico a linee, a dispersione o radar. Leggi **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Rappresenta lo stile del marcatore in un grafico a linee, a dispersione o radar. Leggi [MarkerStyleType](../markerstyletype/). |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Rappresenta la dimensione del marcatore in un grafico a linee, a dispersione o radar. Scrivi **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Rappresenta lo stile del marcatore in un grafico a linee, a dispersione o radar. Scrivi [MarkerStyleType](../markerstyletype/). |
