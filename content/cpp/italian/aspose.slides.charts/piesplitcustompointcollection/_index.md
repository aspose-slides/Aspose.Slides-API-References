...
description: Rappresenta una raccolta di punti per la suddivisione di un punto in un grafico a torta a barra interno o a torta di torta con una divisione personalizzata.
type: docs
weight: 1314
...
Rappresenta una raccolta di punti per la suddivisione di un punto in un diagramma a torta a cerchio interno o a torta di torta con una divisione personalizzata.
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const **int32_t**\&) override | Aggiunge il punto dati tramite il suo indice nella raccolta dei punti della serie padre. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Aggiunge il punto dati alla raccolta. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Restituisce un iteratore che punta al primo elemento qualificato const (se presente) della raccolta. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento qualificato const (se presente) della raccolta. |
| void [Clear](./clear/)() override | Rimuove tutti gli elementi da [ICollection](../../system.collections.generic/icollection/). |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) const override | Determina se [ICollection](../../system.collections.generic/icollection/) contiene un valore specifico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>, **int32_t**) override | Copia gli elementi di [ICollection](../../system.collections.generic/icollection/) in un [System::Array](../../system/array/), a partire da un indice [System::Array](../../system/array/) specifico. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia tutti gli elementi della raccolta in elementi di un array esistente. |
| [iterator](./iterator/) [end](./end/)() | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) della raccolta. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della raccolta qualificata come const. |
...
| **int32_t** [get_Count](./get_count/)() const override | Restituisce il conteggio dei punti dati del grafico. **int32_t** di sola lettura. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Restituisce un valore che indica se [ICollection](../../system.collections.generic/icollection/) è di sola lettura. **bool** di sola lettura. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() | Restituisce un valore che indica se l'accesso alla raccolta è sincronizzato (thread-safe). **bool** di sola lettura. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Restituisce una radice di sincronizzazione. [System::Object](../../system/object/) di sola lettura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la raccolta. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce il punto dati del grafico per l'indice specificato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, solo inizializza un nuovo oggetto e abilita la copia costruttiva delle sottoclassi. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, solo inizializza un nuovo oggetto e abilita la copia costruttiva delle sottoclassi. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Rimuove l'elemento dalla raccolta. |
| void [Remove](./remove/)(**int32_t**) override | Rimuove l'elemento dalla raccolta tramite il suo indice nella raccolta dei punti della serie padre. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della raccolta qualificata come const. |
