...
type: docs
weight: 443
url: /it/aspose.slides.charts/details_cannotcombine2dand3dchartsexception/
---
## Details_CannotCombine2DAnd3DChartsException classe


Eccezione lanciata quando si tenta di combinare tipi di grafico 2D e 3D.
...
| void [Unlock](../../system/object/unlock/)() | Implementa il lock() statement di C# sbloccando. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
