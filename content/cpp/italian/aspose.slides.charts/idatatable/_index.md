...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Restituisce gli stili di linea, riempimento ed effetto di un oggetto. Solo lettura [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | True se la tabella dati del grafico ha bordi cella orizzontali. Read **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | True se la tabella dati del grafico ha bordi di contorno. Read **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | True se la tabella dati del grafico ha bordi cella verticali. Read **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | True se la chiave della legenda dell'etichetta dati è visibile. Read **bool**. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza semplicemente il nuovo oggetto e consente la copia dei sottoclassi. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | True se la tabella dati del grafico ha bordi cella orizzontali. Write **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | True se la tabella dati del grafico ha bordi di contorno. Write **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | True se la tabella dati del grafico ha bordi cella verticali. Write **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | True se la chiave della legenda dell'etichetta dati è visibile. Write **bool**. |
