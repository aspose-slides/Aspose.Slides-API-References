...
description: Fornisce accesso alle barre su/giù di un grafico a linee o a grafico a titoli.
type: docs
weight: 1392
...
Fornisce accesso alle barre su/giù di un grafico a linee o a barre per titoli.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | Restituisce il formato DownBars. Sola lettura [IFormat](../iformat/). |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth. Leggi **int32_t**. |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars. Leggi **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | Restituisce il formato UpBars. Sola lettura [IFormat](../iformat/). |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth. Scrivi **int32_t**. |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars. Scrivi **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
* Classe [IUpDownBarsManager](../iupdownbarsmanager/)
