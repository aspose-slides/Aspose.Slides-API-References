...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Aggiunge una nuova cella alla collezione. |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Crea [IChartDataCell](../ichartdatacell/) dal valore specificato e lo aggiunge alla collezione. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di celle nella collezione. **int32_t** di sola lettura. |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | Restituisce l'indirizzo del set di celle nella cartella di lavoro. |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | Restituisce la stringa di concatenazione di tutti i valori stringa delle celle. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce una cella ([IChartDataCell](../ichartdatacell/)) per indice. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove una cella dalla collezione per indice. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento template come puntatore debole (anziché condiviso). Permette di passare i puntatori nei container a modalità debole. |
