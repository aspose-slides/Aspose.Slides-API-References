...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](../isinglecellchartvalue/get_ascell/)() | Restituisce la cella di dati del grafico. Leggi [IChartDataCell](../ichartdatacell/). |
| virtual **double** [get_AsLiteralDouble](./get_asliteraldouble/)() | Restituisce il valore double letterale se DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/). Leggi **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è quella attuale. In altre parole specifica il tipo di valore della proprietà Data. Questa proprietà è di sola lettura. Per modificare il valore di questa proprietà puoi usare una delle proprietà ChartDataPointCollection.DataSourceTypeFor<...>. Leggi [DataSourceType](../datasourcetype/). |
...
| void [Lock](../../system/object/lock/)() | Implementa l'istruzione C# lock() bloccante. Chiama direttamente o usa l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [set_AsCell](../isinglecellchartvalue/set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Imposta la cella di dati del grafico. Scrivi [IChartDataCell](../ichartdatacell/). |
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | Imposta il valore double letterale se DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/). Scrivi **double**. |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è quella attuale. In altre parole specifica il tipo di valore della proprietà Data. Questa proprietà è di sola lettura. Per modificare il valore di questa proprietà puoi usare una delle proprietà ChartDataPointCollection.DataSourceTypeFor<...>. Scrivi [DataSourceType](../datasourcetype/). |
...
| virtual **double** [ToDouble](./todouble/)() | Converte a double. |
