...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo per scopi interi. |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Indica se il VBAProject è protetto da una password per visualizzare le proprietà del progetto. Di sola lettura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | Restituisce il modulo contenuto nel progetto VBA all'indice specificato. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | Restituisce l'elenco di tutti i moduli contenuti nel progetto VBA. Di sola lettura [IVbaModuleCollection](../ivbamodulecollection/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Restituisce il nome del progetto VBA. Di sola lettura [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | Restituisce il riferimento contenuto nel progetto VBA all'indice specificato. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | Restituisce l'elenco di tutti i riferimenti contenuti nel progetto VBA. Di sola lettura [IVbaReferenceCollection](../ivbareferencecollection/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, davvero, ma inizializza un nuovo oggetto e consente la copia dei costruttori delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, davvero, ma inizializza un nuovo oggetto e consente la copia dei costruttori delle sottoclassi. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | Restituisce la rappresentazione binaria del progetto VBA come contenitore OLE. Di sola lettura **uint8_t**[]. |
