...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Nome del modulo. Sola lettura [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_SourceCode](./get_sourcecode/)() | Codice sorgente del modulo. Leggi [System::String](../../system/string/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, basta inizializzare un nuovo oggetto e consente la copia di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, basta inizializzare un nuovo oggetto e consente la copia di sottoclassi. |
...
| virtual void [set_SourceCode](./set_sourcecode/)([System::String](../../system/string/)) | Codice sorgente del modulo. Scrivi [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del template a un weak pointer (piuttosto che condiviso). Consente di passare i puntatori nei contenitori alla modalità weak. |
