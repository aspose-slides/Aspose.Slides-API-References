...
description: Enumeratore utilizzato dal metodo di estensione IEnumerable.Select().
type: docs
weight: 79
url: /it/system.collections.generic.details/enumeratorselectadapter/
---
## EnumeratorSelectAdapter classe

Enumeratore utilizzato dal metodo di estensione IEnumerable.Select().
...
| Result | Il tipo risultato degli elementi della collezione. |
