...
description: Enumeratore usato dal metodo di estensione IEnumerable.Cast().
type: docs
weight: 53
url: /it/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter classe

Enumeratore usato dal metodo di estensione IEnumerable.Cast().
...
| **bool** [MoveNext](./movenext/)() override | Sposta l'enumeratore al prossimo elemento. Se nessun elemento era stato referenziato prima, imposta il riferimento al primo elemento disponibile. Se è stato raggiunto la fine del contenitore, non fa nulla. |
...
| void [Reset](./reset/)() override | Reimposta l'enumeratore alla posizione prima del primo elemento. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del modello come puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
