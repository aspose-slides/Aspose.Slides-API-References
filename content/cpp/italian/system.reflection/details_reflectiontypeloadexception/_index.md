...
description: "ReflectionTypeLoadException viene lanciata dal metodo Module.GetTypes se una delle classi in un modulo non riesce a caricarsi. Non creare mai istanze di questa classe manualmente. Usa invece la classe ReflectionTypeLoadException. Non avvolgere mai le istanze della classe ReflectionTypeLoadException in System::SmartPtr."
type: docs
weight: 66
url: /it/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException classe


ReflectionTypeLoadException viene lanciata dal metodo Module.GetTypes se una delle classi in un modulo non riesce a caricarsi. Non creare mai istanze di questa classe manualmente. Usa invece la classe ReflectionTypeLoadException. Non avvolgere mai le istanze della classe ReflectionTypeLoadException in [System::SmartPtr](../../system/smartptr/).
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | Restituisce le eccezioni che causano questa eccezione. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | Restituisce le informazioni di tipo delle cause dell'eccezione. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Imposta l'HRESULT, un valore numerico codificato assegnato a un'eccezione specifica. |
