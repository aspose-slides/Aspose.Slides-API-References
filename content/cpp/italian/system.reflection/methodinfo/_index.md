...
description: Rappresenta le informazioni sul metodo della classe.
type: docs
weight: 131
url: /it/system.reflection/methodinfo/
---
## classe MethodInfo


Rappresenta le informazioni sul metodo della classe.
...
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | Ottiene il nome completo del membro. Può essere diverso nelle parti implementate manualmente. |
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Ottiene un valore MemberTypes che indica che questo membro è un metodo. |
...
|  [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | Inizializza una nuova istanza della classe [MethodInfo](./). |
