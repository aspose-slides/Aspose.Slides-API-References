...
description: Fornisce informazioni sui display. Solo Windows. Questo è un tipo singleton con gestione della memoria eseguita mediante funzione(i) di accesso. Non dovresti mai creare istanze direttamente.
type: docs
weight: 40
url: /it/system.windows.forms/screen/
---
## Classe Screen

Fornisce informazioni sui display. [Windows](../../system.windows/) solo. Questo è un tipo singleton con la gestione della memoria eseguita dalle funzioni di accesso. Non dovresti mai creare istanze direttamente.
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Restituisce i limiti dello schermo. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Restituisce informazioni sul display primario. |
