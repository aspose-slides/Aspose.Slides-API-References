...
description: Timer che chiama il delegato in un ciclo.
type: docs
weight: 14
url: /it/system.timers/timer/
---
## Classe Timer

[Timer](./) che chiama il delegato in un ciclo.
...
| Metodo | Descrizione |
| --- | --- |
| void [Close](./close/)() | Interrompe il timer, libera le risorse allocate. |
|  [Component](../../system.componentmodel/component/component/)() | Informazioni RTTI. |
| void [Dispose](./dispose/)() | Interrompe il timer, libera le risorse allocate. |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | Verifica se il timer è in modalità reset automatico. |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Verifica se il componente è in modalità design. |
| **bool** [get_Enabled](./get_enabled/)() const | Verifica se il timer è attivo. |
| **double** [get_Interval](./get_interval/)() const | Restituisce l'intervallo del timer. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Verifica se il timer è fermato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, inizializza semplicemente il nuovo oggetto e consente la costruzione di copie delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, inizializza semplicemente il nuovo oggetto e consente la costruzione di copie delle sottoclassi. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Imposta il timer in modalità reset automatico o lo rimuove da essa. |
| void [set_Enabled](./set_enabled/)(**bool**) | Avvia o interrompe il timer. L'avvio del timer non ricomincia il conteggio del tempo se il timer è già in esecuzione. |
| void [set_Interval](./set_interval/)(**double**) | Imposta l'intervallo del timer. |
...
| void [Start](./start/)() | Avvia il timer. Non riavvia il conteggio del tempo se il timer è già in esecuzione. |
| void [Stop](./stop/)() | Interrompe il timer. |
|  [Timer](./timer/)() | Informazioni RTTI. |
|  [Timer](./timer/)(**double**) | Crea un timer fermo con l'intervallo specificato. |
