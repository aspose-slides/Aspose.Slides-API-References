...
description: Argomenti dell'evento timer.
type: docs
weight: 1
url: /it/system.timers/elapsedeventargs/
---
## ElapsedEventArgs classe


Argomenti dell'evento timer.
...
| Metodo | Descrizione |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | Costruisce l'oggetto degli argomenti con i parametri forniti. |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | Recupera il tempo del segnale. |
