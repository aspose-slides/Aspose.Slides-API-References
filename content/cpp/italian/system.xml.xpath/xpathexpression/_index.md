...
description: Fornisce una classe tipizzata che rappresenta un'espressione XPath compilata.
type: docs
weight: 40
url: /it/system.xml.xpath/xpathexpression/
---
...
| Metodo | Descrizione |
| --- | --- |
| virtual void [AddSort](./addsort/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\>) | Quando sovrascritto in una classe derivata, ordina i nodi selezionati dall'espressione [XPath](../) secondo l'oggetto IComparer specificato. |
| virtual void [AddSort](./addsort/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [XmlSortOrder](../xmlsortorder/), [XmlCaseOrder](../xmlcaseorder/), [String](../../system/string/), [XmlDataType](../xmldatatype/)) | Quando sovrascritto in una classe derivata, ordina i nodi selezionati dall'espressione [XPath](../) secondo i parametri forniti. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathExpression](./)\> [Clone](./clone/)() | Quando sovrascritto in una classe derivata, restituisce un clone di questo [XPathExpression](./). |
| static [SharedPtr](../../system/sharedptr/)\<[XPathExpression](./)\> [Compile](./compile/)(const [String](../../system/string/)\&) | Compila l'espressione [XPath](../) specificata e restituisce un oggetto [XPathExpression](./) che rappresenta l'espressione [XPath](../). |
...
| virtual [String](../../system/string/) [get_Expression](./get_expression/)() | Quando sovrascritto in una classe derivata, ottiene una rappresentazione **string** del [XPathExpression](./). |
| virtual [XPathResultType](../xpathresulttype/) [get_ReturnType](./get_returntype/)() | Quando sovrascritto in una classe derivata, ottiene il tipo di risultato dell'espressione [XPath](../). |
...
| virtual void [SetContext](./setcontext/)([SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../../system.xml/xmlnamespacemanager/)\>) | Quando sovrascritto in una classe derivata, specifica l'oggetto [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) da usare per la risoluzione dei namespace. |
| virtual void [SetContext](./setcontext/)([SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | Quando sovrascritto in una classe derivata, specifica l'oggetto [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/) da usare per la risoluzione dei namespace. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogo del metodo [Object.ToString()](../../system/object/tostring/) di C#. Consente la conversione di oggetti personalizzati in string. |
