...
description: Fornisce un iteratore su un insieme selezionato di nodi.
type: docs
weight: 79
url: /it/system.xml.xpath/xpathnodeiterator/
---
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | Quando sovrascritto in una classe derivata, restituisce un clone di questo oggetto [XPathNodeIterator](./). |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce l'indice dell'ultimo nodo nell'insieme selezionato di nodi. |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | Quando sovrascritto in una classe derivata, ottiene l'oggetto [XPathNavigator](../xpathnavigator/) per questo [XPathNodeIterator](./), posizionato sul nodo di contesto corrente. |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | Quando sovrascritto in una classe derivata, ottiene l'indice della posizione corrente nell'insieme selezionato di nodi. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un oggetto IEnumerator per iterare attraverso l'insieme di nodi selezionato. |
...
| virtual **bool** [MoveNext](./movenext/)() | Quando sovrascritto in una classe derivata, sposta l'oggetto [XPathNavigator](../xpathnavigator/) restituito dal metodo [XPathNodeIterator::get_Current](./get_current/) al nodo successivo nell'insieme di nodi selezionato. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la copia dei sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del modello come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
