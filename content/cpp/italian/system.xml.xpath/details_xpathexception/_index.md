...
description: Fornisce l'eccezione lanciata quando si verifica un errore durante l'elaborazione di un'espressione XPath.
type: docs
weight: 1
url: /it/system.xml.xpath/details_xpathexception/
---
## Details_XPathException classe


Fornisce l'eccezione lanciata quando si verifica un errore durante l'elaborazione di un'espressione [XPath](../).
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | Restituisce la descrizione della condizione di errore per questa eccezione. |
