...
description: "Classe fittizia che rende possibile collegare il codice tradotto con i riferimenti DataGrid, ma non eseguirlo. Non contiene membri implementati correttamente. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o errori di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 1
url: /it/system.web.ui.webcontrols/datagrid/
---
## DataGrid classe


Dummy classe che rende possibile collegare il codice tradotto con i riferimenti [DataGrid](./), ma non eseguirlo. Contiene nessun membro correttamente implementato. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o errori di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarlo alle funzioni come argomento.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza semplicemente il nuovo oggetto e consente la costruzione di copie delle subclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza semplicemente il nuovo oggetto e consente la costruzione di copie delle subclassi. |
...
| virtual  [~Object](../../system/object/~object/)() | Distrugge l'oggetto. Rilascia tutte le strutture dati interne. |

## Typedef

| Typedef | Descrizione |
| --- | --- |
| [ptr](./ptr/) | Tipo di puntatore a se stesso. |
