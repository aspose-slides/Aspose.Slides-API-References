...
description: Definisce un'implementazione Tuple di uso generale che consente l'accesso ai membri dell'istanza Tuple senza conoscere il tipo Tuple sottostante.
type: docs
weight: 53
url: /it/system.runtime.compilerservices/ituple/
---
## Classe ITuple

Definisce un'implementazione [Tuple](../../system/tuple/) di uso generale che consente l'accesso ai membri dell'istanza [Tuple](../../system/tuple/) senza conoscere il tipo sottostante [Tuple](../../system/tuple/).
...
| virtual **int32_t** [get_Length](./get_length/)() const | Restituisce il numero di posizioni in questa struttura dati. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Restituisce l'elemento alla posizione indice. |
