...
description: Puntatore a BitArray. Questo tipo è un puntatore per gestire l'eliminazione di altri oggetti. Deve essere allocato nello stack e passato alle funzioni sia per valore che per riferimento const.
type: docs
weight: 14
url: /it/system.collections/bitarrayptr/
---
## BitArrayPtr classe

Puntatore a [BitArray](../bitarray/). Questo tipo è un puntatore per gestire l'eliminazione di altri oggetti. Dovrebbe essere allocato nello stack e passato alle funzioni sia per valore che per riferimento const.
...
|  [BitArrayPtr](./bitarrayptr/)() | Inizializza un puntatore nullo. |
|  [BitArrayPtr](./bitarrayptr/)(const [SharedPtr](../../system/sharedptr/)\<[BitArray](../bitarray/)\>\&) | Costruttore di conversione. |
...
| T * [GetObjectNotNull](../../system/smartptr/getobjectnotnull/)() const | Restituisce l'oggetto attualmente referenziato (se esiste) o genera un'eccezione. |
| [Object](../../system/object/) * [GetObjectOrNull](../../system/smartptr/getobjectornull/)() const | Restituisce l'oggetto puntato (se presente) o nullptr. Equivalente a [get()](../../system/smartptr/get/). |
| [Object](../../system/object/) * [GetObjectOwner](../../system/smartptr/getobjectowner/)() const | Restituisce l'oggetto referenziato. |
| [Pointee_](../../system/smartptr/pointee_/) * [GetPointer](../../system/smartptr/getpointer/)() const | Restituisce l'oggetto puntato (se presente) o nullptr. Equivalente a [get()](../../system/smartptr/get/). |
...
| **bool** [IsNull](./isnull/)() const | Verifica se il valore specificato è nullo. |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&) | Assegna in movimento l'oggetto [SmartPtr](../../system/smartptr/). x diventa inutilizzabile. |
...
| **BitArray::Reference** [operator[]](./operator[]/)(int) const | Accessor di bit. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)([Pointee_](../../system/smartptr/pointee_/) *, [SmartPtrMode](../../system/smartptrmode/)) | Crea un [SmartPtr](../../system/smartptr/) che punta all'oggetto specificato, oppure converte un puntatore grezzo in [SmartPtr](../../system/smartptr/). |
...
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | Costruisce per movimento l'oggetto [SmartPtr](../../system/smartptr/). In pratica, scambia due puntatori, se sono entrambi della stessa modalità. x può diventare inutilizzabile dopo la chiamata. |
...
| [SmartPtr](../../system/smartptr/)\<[Object](../../system/object/)\> [ToObjectPtr](../../system/smartptr/toobjectptr/)() const | Converte qualsiasi tipo di puntatore a un puntatore a [Object](../../system/object/). Non richiede che il tipo Pointee_ sia completo. |
