...
description: "Array di bit che può essere indicizzato. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare tale puntatore per passarla alle funzioni come argomento."
type: docs
weight: 1
url: /it/system.collections/bitarray/
---
## BitArray classe

[Array](../../system/array/) di bit che possono essere indirizzati per indice. Gli oggetti di questa classe dovrebbero essere allocati solo utilizzando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e utilizzare tale puntatore per passarla alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| void [Add](./add/)(const **bool**\&) override | Aggiunge il valore alla fine del contenitore. |
| [BitArrayPtr](../bitarrayptr/) [And](./and/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcola l'operazione bitwise 'and' tra due BitSet. |
...
|  [BitArray](./bitarray/)(const [bitset](./bitset/)\&) | Costruttore di copia. |
|  [BitArray](./bitarray/)(const [BitArray](./)\&) | Costruttore di copia. |
|  [BitArray](./bitarray/)(const [BitArrayPtr](../bitarrayptr/)\&) | Costruttore di copia. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**bool**\>\&) | Costruttore di copia. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Costruttore di copia. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<int\>\&) | Costruttore di copia. |
...
| **bool** [Contains](./contains/)(const **bool**\&) const override | Verifica se un valore specifico è presente nel contenitore. Non implementato. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<**bool**\>, int) override | Copia i dati negli elementi dell'array esistente. |
| [bitset](./bitset/)\& [data](./data/)() | Accesso alla struttura dati sottostante. |
| const [bitset](./bitset/)\& [data](./data/)() const | Accesso alla struttura dati sottostante. |
...
| **bool** [Get](./get/)(int) const | Ottiene l'elemento [BitArray](./). |
| int [get_Count](./get_count/)() const override | Ottiene la dimensione del contenitore. |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Verifica se la collezione è in sola lettura. |
| int [get_Length](./get_length/)() const | Ottiene la dimensione del contenitore. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<**bool**\>\> [GetEnumerator](./getenumerator/)() override | Crea un oggetto enumeratore. |
...
| **bool** [idx_get](./idx_get/)(int) const | Funzione getter. |
| void [idx_set](./idx_set/)(int, **bool**) | Funzione setter. |
...
| [BitArrayPtr](../bitarrayptr/) [Not](./not/)() | Negazione di BitSet. |
|  [Object](../../system/object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e permette la copia dei sottoclassi. |
| **bool** [operator!=](./operator_not_equal/)(const [BitArray](./)\&) const | Operatore di confronto bitwise. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e permette la copia dei sottoclassi. |
...
| **bool** [operator==](./operator_equal_equal/)(const [BitArray](./)\&) const | Operatore di confronto bitwise. |
| **Reference** [operator[]](./operator[]/)(int) | Funzione di accesso. |
| [BitArrayPtr](../bitarrayptr/) [Or](./or/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcola l'operazione bitwise 'or' tra due BitSet. |
...
| **bool** [Remove](./remove/)(const **bool**\&) override | Restituisce la prima occorrenza del valore specificato. Non implementato. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimento condiviso del valore specificato. |
| void [Set](./set/)(int, **bool**) | Imposta l'elemento [BitArray](./). |
| void [SetAll](./setall/)(**bool**) | Imposta tutti gli elementi a un valore specifico. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Implementazione formale del meccanismo di argomenti di template deboli; non applicabile a questa classe. |
...
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ottiene l'implementazione dell'iteratore begin const per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Ottiene l'implementazione dell'iteratore begin per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ottiene l'implementazione dell'iteratore end const per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Ottiene l'implementazione dell'iteratore end per il contenitore corrente. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il contatore di riferimento debole. Non dovrebbe essere chiamato direttamente; invece, usare smart pointer o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il contatore di riferimento debole. Non dovrebbe essere chiamato direttamente; invece, usare smart pointer o ThisProtector. |
| [BitArrayPtr](../bitarrayptr/) [Xor](./xor/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcola l'operazione bitwise 'xor' tra due BitSet. |
...
| Typedef | Descrizione |
| --- | --- |
| [bitset](./bitset/) | Tipo di dato sottostante. |
...
int main()
{
  // Costruisce una nuova istanza della classe BitArray.
