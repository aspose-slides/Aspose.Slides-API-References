...
description: Definisce un'interfaccia di collezione non generica.
type: docs
weight: 40
url: /it/system.collections/icollection/
---
## Classe ICollection

Definisce un'interfaccia di collezione non generica.
...
| virtual int [get_Count](./get_count/)() const | Ottiene il numero di elementi nella collezione. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | Restituisce un enumeratore che itera attraverso una collezione. |
