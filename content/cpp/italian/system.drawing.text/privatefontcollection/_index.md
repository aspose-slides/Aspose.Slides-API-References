...
description: "Rappresenta una collezione di famiglie di caratteri fornita dall'applicazione client. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o errori di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 27
url: /it/system.drawing.text/privatefontcollection/
---
## PrivateFontCollection classe

Rappresenta una collezione di famiglie di caratteri fornita dall'applicazione client. Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e utilizzare questo puntatore per passarlo alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| void [AddFont](./addfont/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int) | Aggiunge il carattere specificato alla collezione. |
| void [AddFontFile](./addfontfile/)(const [String](../../system/string/)\&) | Aggiunge un carattere dal file specificato alla collezione. |
| void [Dispose](../fontcollection/dispose/)() override | Rilascia le risorse del sistema operativo acquisite dall'oggetto corrente. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](./get_families/)() override | Restituisce un array di oggetti [FontFamily](../../system.drawing/fontfamily/) associati alla collezione di caratteri rappresentata dall'oggetto corrente. |
