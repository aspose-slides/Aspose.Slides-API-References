...
type: docs
weight: 326
url: /it/system.net.http.headers/viaheadervalue/
---
...
| [String](../../system/string/) [get_Comment](./get_comment/)() | Restituisce il commento dal valore dell'intestazione 'Via'. |
| [String](../../system/string/) [get_ProtocolName](./get_protocolname/)() | Restituisce il nome del protocollo dal valore dell'intestazione 'Via'. |
| [String](../../system/string/) [get_ProtocolVersion](./get_protocolversion/)() | Restituisce la versione del protocollo dal valore dell'intestazione 'Via'. |
| [String](../../system/string/) [get_ReceivedBy](./get_receivedby/)() | Restituisce l'host e la porta a cui è stata ricevuta la richiesta o la risposta. |
...
| static **int32_t** [GetViaLength](./getvialength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Converte una stringa fornita dall'indice specificato in un'istanza della classe [ViaHeaderValue](./). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita ad inizializzare un nuovo oggetto e consente la copia costruttiva delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita ad inizializzare un nuovo oggetto e consente la copia costruttiva delle sottoclassi. |
| static [System::SharedPtr](../../system/sharedptr/)\<[ViaHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Converte una stringa fornita in un'istanza della classe [ViaHeaderValue](./). |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ViaHeaderValue](./)\>\&) | Tenta di convertire una stringa fornita in un'istanza della classe [ViaHeaderValue](./). |
...
|  [ViaHeaderValue](./viaheadervalue/)([String](../../system/string/), [String](../../system/string/)) | Costruisce una nuova istanza. |
|  [ViaHeaderValue](./viaheadervalue/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Costruisce una nuova istanza. |
|  [ViaHeaderValue](./viaheadervalue/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Costruisce una nuova istanza. |
