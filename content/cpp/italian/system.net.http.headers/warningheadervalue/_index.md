...
description: "Rappresenta un valore dell'intestazione 'Warning'. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò può causare errori di runtime e/o fallimenti di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 339
url: /it/system.net.http.headers/warningheadervalue/
---
## WarningHeaderValue classe
...
| [String](../../system/string/) [get_Agent](./get_agent/)() | Restituisce l'host associato all'avviso. |
| **int32_t** [get_Code](./get_code/)() | Restituisce un codice di avviso. |
| [Nullable](../../system/nullable/)\<[DateTimeOffset](../../system/datetimeoffset/)\> [get_Date](./get_date/)() | Restituisce la data e ora dell'avviso. |
| [String](../../system/string/) [get_Text](./get_text/)() | Restituisce il testo dell'avviso. |
...
| static **int32_t** [GetWarningLength](./getwarninglength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Converti una stringa fornita dall'indice specificato in un'istanza della classe [WarningHeaderValue](./). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, davvero, ma inizializza un nuovo oggetto e abilita la costruzione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, davvero, ma inizializza un nuovo oggetto e abilita la costruzione di copie di sottoclassi. |
| static [System::SharedPtr](../../system/sharedptr/)\<[WarningHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Converti una stringa fornita in un'istanza della classe [WarningHeaderValue](./). |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[WarningHeaderValue](./)\>\&) | Prova a convertire una stringa fornita in un'istanza della classe [WarningHeaderValue](./). |
...
|  [WarningHeaderValue](./warningheadervalue/)(**int32_t**, [String](../../system/string/), [String](../../system/string/)) | Costruisce una nuova istanza. |
|  [WarningHeaderValue](./warningheadervalue/)(**int32_t**, [String](../../system/string/), [String](../../system/string/), [DateTimeOffset](../../system/datetimeoffset/)) | Costruisce una nuova istanza. |
