...
description: "RankException viene sollevata quando un argomento array con un numero di dimensioni diverso da quello previsto viene passato a un metodo. Non creare mai istanze di questa classe manualmente. Usa invece la classe RankException. Non avvolgere mai le istanze della classe RankException in System::SmartPtr."
type: docs
weight: 677
url: /it/system/details_rankexception/
---
## Details_RankException classe


RankException è sollevata quando un argomento array con un numero di dimensioni diverso da quello previsto viene passato a un metodo. Non creare mai istanze di questa classe manualmente. Usa invece la classe RankException. Non avvolgere mai le istanze della classe RankException in [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e consente la costruzione di copia delle sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e consente la costruzione di copia delle sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del template come puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
