...
type: docs
weight: 2120
url: /it/system/operator_greater/
---
...
| --- | --- |
| T1 | Il tipo del primo valore comparativo |
| T2 | Il tipo sottostante dell'oggetto [Nullable](../nullable/) che rappresenta il secondo valore comparativo |
...
True se il primo comparando è maggiore del secondo comparando, altrimenti - false
