...
description: "PlatformNotSupportedException viene lanciata quando una funzionalità non è disponibile su una piattaforma specifica. Non creare mai istanze di questa classe manualmente. Utilizzare invece la classe PlatformNotSupportedException. Non avvolgere mai le istanze della classe PlatformNotSupportedException in System::SmartPtr."
type: docs
weight: 664
url: /it/system/details_platformnotsupportedexception/
---
## Details_PlatformNotSupportedException classe

PlatformNotSupportedException viene lanciata quando una funzionalità non è disponibile su una piattaforma specifica. Non creare mai istanze di questa classe manualmente. Utilizzare invece la classe PlatformNotSupportedException. Non avvolgere mai le istanze della classe PlatformNotSupportedException in [System::SmartPtr](../smartptr/).
...
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Restituisce la stringa contenente il tracciamento dello stack. |
...
| void [Lock](../object/lock/)() | Implementa il blocco dell'istruzione C# lock(). Chiamare direttamente o utilizzare l'oggetto sentinella [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e consente la costruzione di copia di sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e consente la costruzione di copia di sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un weak pointer (anziché shared). Consente di cambiare i puntatori nei contenitori in modalità weak. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco dell'istruzione C# lock(). Chiamare direttamente o utilizzare l'oggetto sentinella [LockContext](../lockcontext/). |
...
* Classe [Details_NotSupportedException](../details_notsupportedexception/)
