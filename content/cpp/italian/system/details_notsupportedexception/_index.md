...
description: "NotSupportedException viene sollevata quando un metodo invocato non è supportato o quando un'operazione tentata su uno stream non è supportata. Non creare mai istanze di questa classe manualmente. Utilizza invece la classe NotSupportedException. Non avvolgere mai le istanze della classe NotSupportedException in System::SmartPtr."
type: docs
weight: 586
url: /it/system/details_notsupportedexception/
---
## Details_NotSupportedException classe


NotSupportedException è sollevata quando un metodo invocato non è supportato o quando un'operazione tentata su uno stream non è supportata. Non creare mai istanze di questa classe manualmente. Usa invece la classe NotSupportedException. Non avvolgere mai le istanze della classe NotSupportedException in [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementa l'istruzione lock() di C#. Chiamala direttamente o usa l'oggetto sentry [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione per copia delle sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione per copia delle sottoclassi. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco dell'istruzione lock() di C#. Chiamalo direttamente o usa l'oggetto sentry [LockContext](../lockcontext/). |
