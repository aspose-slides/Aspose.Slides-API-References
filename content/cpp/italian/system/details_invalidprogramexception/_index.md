...
description: "InvalidProgramException è presente solo per motivi di compatibilità. Non creare mai istanze di questa classe manualmente. Usa invece la classe InvalidProgramException. Non racchiudere mai le istanze della classe InvalidProgramException in System::SmartPtr."
type: docs
weight: 521
url: /it/system/details_invalidprogramexception/
---
## Details_InvalidProgramException classe

InvalidProgramException è presente solo per motivi di compatibilità. Non creare mai istanze di questa classe manualmente. Usa invece la classe InvalidProgramException. Non racchiudere mai le istanze della classe InvalidProgramException in [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la costruzione per copia delle sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la costruzione per copia delle sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un weak pointer (piuttosto che shared). Permette di cambiare i puntatori nei contenitori in modalità weak. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco dell'istruzione lock() di C#. Chiamare direttamente o utilizzare l'oggetto sentry [LockContext](../lockcontext/). |
