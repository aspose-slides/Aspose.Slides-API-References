...
description: "UnauthorizedAccessException viene lanciata quando l'accesso è negato dal sistema operativo a causa di un errore di I/O o di un errore di sicurezza. Non creare mai istanze di questa classe manualmente. Usa invece la classe UnauthorizedAccessException. Non inserire mai le istanze della classe UnauthorizedAccessException in System::SmartPtr."
type: docs
weight: 755
url: /it/system/details_unauthorizedaccessexception/
---
## Details_UnauthorizedAccessException classe


UnauthorizedAccessException viene lanciata quando l'accesso è negato dal sistema operativo a causa di un errore di I/O o di un errore di sicurezza. Non creare mai istanze di questa classe manualmente. Usa invece la classe UnauthorizedAccessException. Non inserire mai le istanze della classe UnauthorizedAccessException in [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementa il blocco lock() di C#. Chiamalo direttamente o usa l'oggetto sentry [LockContext](../lockcontext/). |
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analogo del metodo C# [Object.MemberwiseClone()](../object/memberwiseclone/). Consente il clonaggio di tipi personalizzati. |
|  [Object](../object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, realmente, inizializza solo un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, realmente, inizializza solo un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Decrementa il conteggio di riferimenti condivisi del valore specificato. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Incrementa il conteggio di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; invece, usa smart pointer o ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Decrementa e restituisce il conteggio di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; invece, usa smart pointer o ThisProtector. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco della dichiarazione lock() di C#. Chiamalo direttamente o usa l'oggetto sentry [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Incrementa il conteggio di riferimenti deboli. Non dovrebbe essere chiamato direttamente; invece, usa smart pointer o ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Decrementa il conteggio di riferimenti deboli. Non dovrebbe essere chiamato direttamente; invece, usa smart pointer o ThisProtector. |
