...
description: "InvalidCastException viene sollevata quando si tenta un'operazione di cast non valida di una conversione esplicita non valida. Non creare mai istanze di questa classe manualmente. Utilizza invece la classe InvalidCastException. Non avvolgere mai le istanze della classe InvalidCastException in System::SmartPtr."
type: docs
weight: 495
url: /it/system/details_invalidcastexception/
---
## Details_InvalidCastException classe


InvalidCastException viene sollevata quando si tenta un'operazione di cast non valida di una conversione esplicita non valida. Non creare mai istanze di questa classe manualmente. Usa invece la classe InvalidCastException. Non avvolgere mai le istanze della classe InvalidCastException in [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementa il blocco dell'istruzione C# lock(). Chiama direttamente o usa l'oggetto sentinella [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (invece di condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco dell'istruzione C# lock(). Chiama direttamente o usa l'oggetto sentinella [LockContext](../lockcontext/). |
