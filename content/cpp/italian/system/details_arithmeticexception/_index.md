...
description: "ArithmeticException è lanciata quando si verifica un errore durante l'esecuzione di operazioni aritmetiche, conversioni o operazioni di casting. Non creare mai istanze di questa classe manualmente. Usa invece la classe ArithmeticException. Non avvolgere mai le istanze della classe ArithmeticException in System::SmartPtr."
type: docs
weight: 365
url: /it/system/details_arithmeticexception/
---
## Details_ArithmeticException classe


ArithmeticException viene lanciata quando si verifica un errore durante l'esecuzione di operazioni aritmetiche, conversioni o operazioni di casting. Non creare mai istanze di questa classe manualmente. Usa invece la classe ArithmeticException. Non avvolgere mai le istanze della classe ArithmeticException in [System::SmartPtr](../smartptr/).
...
| Metodo | Descrizione |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | Confronta oggetti usando la semantica [Object.Equals](../object/equals/) di C#. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analogo del metodo [Object.GetHashCode()](../object/gethashcode/) di C#. Consente l'hashing di oggetti personalizzati. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Ottiene il tipo reale dell'oggetto. Analogo della chiamata [System.Object.GetType()](../object/gettype/) di C#. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analogo del metodo [Object.MemberwiseClone()](../object/memberwiseclone/) di C#. Consente il clonaggio di tipi personalizzati. |
|  [Object](../object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. In realtà non copia nulla, semplicemente inizializza un nuovo oggetto e consente la costruzione di copie delle subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, semplicemente inizializza un nuovo oggetto e consente la costruzione di copie delle subclass. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template come puntatore debole (anziché condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco dell'istruzione lock() di C#. Chiamare direttamente o usare l'oggetto sentry [LockContext](../lockcontext/). |
