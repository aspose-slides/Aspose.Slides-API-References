...
description: "IndexOutOfRangeException viene sollevata quando si tenta di accedere a un elemento di una collezione usando un indice che è fuori dai suoi limiti. Non creare mai istanze di questa classe manualmente. Utilizza invece la classe IndexOutOfRangeException. Non avvolgere mai le istanze della classe IndexOutOfRangeException in System::SmartPtr."
type: docs
weight: 482
url: /it/system/details_indexoutofrangeexception/
---
## Details_IndexOutOfRangeException classe


IndexOutOfRangeException viene sollevata quando si tenta di accedere a un elemento di una collezione usando un indice che è fuori dai suoi limiti. Non creare mai istanze di questa classe manualmente. Utilizza invece la classe IndexOutOfRangeException. Non avvolgere mai le istanze della classe IndexOutOfRangeException in [System::SmartPtr](../smartptr/).
