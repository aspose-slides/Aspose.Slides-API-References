...
description: "MemberAccessException viene sollevata quando si tenta di accedere a un metodo inesistente o quando l'accesso al metodo non è consentito. Non creare mai istanze di questa classe manualmente. Utilizzare invece la classe MethodAccessException. Non avvolgere mai le istanze della classe MethodAccessException in System::SmartPtr."
type: docs
weight: 560
url: /it/system/details_methodaccessexception/
---
## Details_MethodAccessException classe

MemberAccessException viene lanciata quando si tenta di accedere a un metodo inesistente o quando l'accesso al metodo non è consentito. Non creare mai istanze di questa classe manualmente. Usa invece la classe MethodAccessException. Non includere mai le istanze della classe MethodAccessException in [System::SmartPtr](../smartptr/).
...
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Restituisce un dizionario con i dati personalizzati dell'eccezione. |
...
| void [Lock](../object/lock/)() | Implementa l'istruzione lock() di C#. Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e a consentire la costruzione di copie di subclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnamento. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e a consentire la costruzione di copie di subclassi. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco dell'istruzione lock() di C#. Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../lockcontext/). |
