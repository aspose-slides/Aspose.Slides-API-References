...
description: "NotImplementedException viene lanciata quando un metodo non è implementato e funge da stub. Non creare mai istanze di questa classe manualmente. Usa invece la classe NotImplementedException. Non incapsulare mai le istanze della classe NotImplementedException in System::SmartPtr."
type: docs
weight: 573
url: /it/system/details_notimplementedexception/
---
## Details_NotImplementedException classe


NotImplementedException viene lanciata quando un metodo non è implementato e funge da stub. Non creare mai istanze di questa classe manualmente. Usa invece la classe NotImplementedException. Non incapsulare mai le istanze della classe NotImplementedException in [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza solo un nuovo oggetto e abilita la costruzione di copie di sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza solo un nuovo oggetto e abilita la costruzione di copie di sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un weak pointer (piuttosto che shared). Consente di passare i puntatori nei contenitori in modalità weak. |
