...
description: "NullReferenceException viene lanciata quando si tenta di dereferenziare un riferimento nullo. Non creare mai istanze di questa classe manualmente. Usa invece la classe NullReferenceException. Non avvolgere mai le istanze della classe NullReferenceException in System::SmartPtr."
type: docs
weight: 599
url: /it/system/details_nullreferenceexception/
---
## Details_NullReferenceException classe


NullReferenceException viene lanciata quando si tenta di dereferenziare un riferimento nullo. Non creare mai istanze di questa classe manualmente. Usa invece la classe NullReferenceException. Non avvolgere mai le istanze della classe NullReferenceException in [System::SmartPtr](../smartptr/).
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Restituisce la rappresentazione testuale dell'oggetto corrente. |
