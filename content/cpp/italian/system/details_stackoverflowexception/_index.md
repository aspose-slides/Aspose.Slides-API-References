...
description: "StackOverflowException viene lanciata quando lo stack di esecuzione del thread supera i limiti. Non creare mai istanze di questa classe manualmente. Utilizza invece la classe StackOverflowException. Non racchiudere mai le istanze della classe StackOverflowException in System::SmartPtr."
type: docs
weight: 690
url: /it/system/details_stackoverflowexception/
---
## Details_StackOverflowException classe

StackOverflowException viene sollevata quando lo stack di esecuzione del thread supera i limiti. Non creare mai istanze di questa classe manualmente. Usa la classe StackOverflowException invece. Non racchiudere mai le istanze della classe StackOverflowException dentro [System::SmartPtr](../smartptr/).
...
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Restituisce la stringa contenente la traccia dello stack. |
...
| void [Lock](../object/lock/)() | Implementa il blocco dell'istruzione C# lock(). Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e consente la costruzione di copie delle sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e consente la costruzione di copie delle sottoclassi. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Imposta HRESULT, un valore numerico codificato che viene assegnato a una specifica eccezione. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento modello come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco dell'istruzione C# lock(). Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../lockcontext/). |
