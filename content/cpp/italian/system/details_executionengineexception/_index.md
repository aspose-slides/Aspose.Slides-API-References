...
description: ExecutionEngineException è presente solo per motivi di compatibilità.
type: docs
weight: 456
url: /it/system/details_executionengineexception/
---
## Details_ExecutionEngineException classe

ExecutionEngineException è presente solo per motivi di compatibilità.
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Diminuisce il conteggio di riferimento condiviso del valore specificato. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Incrementa il conteggio di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; invece, usare smart pointer o ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Decrementa e restituisce il conteggio di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; invece, usare smart pointer o ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Incrementa il conteggio di riferimenti deboli. Non dovrebbe essere chiamato direttamente; invece, usare smart pointer o ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Decrementa il conteggio di riferimenti deboli. Non dovrebbe essere chiamato direttamente; invece, usare smart pointer o ThisProtector. |
