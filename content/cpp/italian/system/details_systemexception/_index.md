...
description: "Una classe base per le classi che rappresentano eccezioni di sistema (piuttosto che di applicazione). Non creare mai istanze di questa classe manualmente. Usa invece la classe SystemException. Non avvolgere mai le istanze della classe SystemException in System::SmartPtr."
type: docs
weight: 703
url: /it/system/details_systemexception/
---
## Details_SystemException classe

Una classe base per le classi che rappresentano eccezioni di sistema (piuttosto che di applicazione). Non creare mai istanze di questa classe manualmente. Utilizza invece la classe SystemException. Non avvolgere mai le istanze della classe SystemException in [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e a consentire la costruzione per copia delle sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e a consentire la costruzione per copia delle sottoclassi. |
| static **bool** [ReferenceEquals](../object/referenceequals/)([ptr](../object/ptr/) const\&, [ptr](../object/ptr/) const\&) | Confronta oggetti per riferimento. |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, T const\&) | Confronta oggetti per riferimento. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementa il metodo [what()](../details_exception/what/) chiamato dalla classe [ExceptionWrapper](../exceptionwrapper/). Nonostante il fatto che questa classe non sia ereditata da std::exception, le classi derivate possono utilizzare membri protetti/privacy per implementare la loro logica. Spostare l'implementazione di questo metodo nel [ExceptionWrapper](../exceptionwrapper/) potrebbe rompere tale logica. |
