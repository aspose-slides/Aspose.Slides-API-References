...
description: "L'eccezione che viene generata quando l'immagine file di una libreria di collegamento dinamico (DLL) o di un programma eseguibile è non valida. Non creare mai istanze di questa classe manualmente. Usa invece la classe BadImageFormatException. Non avvolgere mai le istanze della classe BadImageFormatException in System::SmartPtr."
type: docs
weight: 378
url: /it/system/details_badimageformatexception/
---
## Details_BadImageFormatException classe

L'eccezione che viene generata quando l'immagine file di una libreria di collegamento dinamico (DLL) o di un programma eseguibile è non valida. Non creare mai istanze di questa classe manualmente. Usa invece la classe BadImageFormatException. Non avvolgere mai le istanze della classe BadImageFormatException in [System::SmartPtr](../smartptr/).
...
| virtual [String](../string/) [get_FileName](../details_exceptionwithfilename/get_filename/)() const | Ottiene il nome del file che causa questa eccezione. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](../details_systemexception/gettype/)() const override | Ottiene il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../object/gettype/). |
| **bool** [Is](../details_systemexception/is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Implementa il lock() di C# bloccando. Chiamare direttamente o usare l'oggetto sentry [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza semplicemente un nuovo oggetto e consente la costruzione di copie nelle subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza semplicemente un nuovo oggetto e consente la costruzione di copie nelle subclass. |
