...
description: "ArgumentOutOfRangeException viene sollevata quando a un metodo invocato viene passato un argomento che esce dall'intervallo previsto di valori per quell'argomento. Non creare mai istanze di questa classe manualmente. Usa invece la classe ArgumentOutOfRangeException. Non avvolgere mai le istanze della classe ArgumentOutOfRangeException in System::SmartPtr."
type: docs
weight: 352
url: /it/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException classe


ArgumentOutOfRangeException viene sollevata quando a un metodo invocato viene passato un argomento che esce dall'intervallo previsto di valori per quell'argomento. Non creare mai istanze di questa classe manualmente. Usa la classe ArgumentOutOfRangeException invece. Non avvolgere mai le istanze della classe ArgumentOutOfRangeException in [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementa il blocco della dichiarazione C# lock(). Chiamalo direttamente o usa l'oggetto sentry [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione tramite copia delle sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione tramite copia delle sottoclassi. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco della dichiarazione C# lock(). Chiamalo direttamente o usa l'oggetto sentry [LockContext](../lockcontext/). |
