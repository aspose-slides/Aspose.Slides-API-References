...
description: "UriFormatException viene sollevata quando il formato dell'URI non è valido. Non creare mai istanze di questa classe manualmente. Usa invece la classe UriFormatException. Non avvolgere mai le istanze della classe UriFormatException in System::SmartPtr."
type: docs
weight: 768
url: /it/system/details_uriformatexception/
---
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Recupera la struttura dati del contatore di riferimenti associata all'oggetto. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Recupera il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../object/gettype/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e abilita la costruzione copia delle sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e abilita la costruzione copia delle sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento template a un puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
| int [SharedCount](../object/sharedcount/)() const | Recupera il valore corrente del contatore di riferimenti condivisi. |
