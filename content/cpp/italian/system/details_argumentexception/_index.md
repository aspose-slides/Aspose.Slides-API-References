...
description: "ArgumentException viene sollevata quando un argomento passato a un metodo invocato è invalido. Non creare mai istanze di questa classe manualmente. Usa invece la classe ArgumentException. Non avvolgere mai le istanze della classe ArgumentException in System::SmartPtr."
type: docs
weight: 326
url: /it/system/details_argumentexception/
---
## Details_ArgumentException classe


ArgumentException viene sollevata quando un argomento passato a un metodo invocato è invalido. Non creare mai istanze di questa classe manualmente. Usa invece la classe ArgumentException. Non avvolgere mai le istanze della classe ArgumentException in [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementa il blocco lock() di C#. Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, davvero, semplicemente inizializza un nuovo oggetto e abilita la costruzione di copie delle sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, davvero, semplicemente inizializza un nuovo oggetto e abilita la costruzione di copie delle sottoclassi. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco della dichiarazione lock() di C#. Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../lockcontext/). |
