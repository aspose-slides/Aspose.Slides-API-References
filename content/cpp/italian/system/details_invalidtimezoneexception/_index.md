...
description: "InvalidTimeZoneException viene lanciata quando le informazioni sul fuso orario sono non valide. Non creare mai istanze di questa classe manualmente. Usa invece la classe InvalidTimeZoneException. Non incapsulare mai le istanze della classe InvalidTimeZoneException in System::SmartPtr."
type: docs
weight: 534
url: /it/system/details_invalidtimezoneexception/
---
## Details_InvalidTimeZoneException classe

InvalidTimeZoneException viene lanciata quando le informazioni sul fuso orario sono non valide. Non creare mai istanze di questa classe manualmente. Usa invece la classe InvalidTimeZoneException. Non incapsulare mai le istanze della classe InvalidTimeZoneException in [System::SmartPtr](../smartptr/).
...
| Method | Description |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | Compara gli oggetti usando la semantica C# [Object.Equals](../object/equals/). |
...
| void [Lock](../object/lock/)() | Implementa il lock() di C# per il blocco. Chiamare direttamente o usare l'oggetto sentry [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza semplicemente un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza semplicemente un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Decrementa il contatore di riferimento condiviso di un valore specificato. |
...
| void [Unlock](../object/unlock/)() | Implementa lo sblocco del lock() di C#. Chiamare direttamente o usare l'oggetto sentry [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Incrementa il contatore di riferimento weak. Non dovrebbe essere chiamato direttamente; invece, usa smart pointer o ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Decrementa il contatore di riferimento weak. Non dovrebbe essere chiamato direttamente; invece, usa smart pointer o ThisProtector. |
| virtual const char * [what](../details_exception/what/)() const | Implementa il metodo [what()](../details_exception/what/) che è chiamato dalla classe [ExceptionWrapper](../exceptionwrapper/). Nonostante il fatto che questa classe non erediti da std::exception, le classi derivate possono usare membri protetti o privati per implementare la propria logica. Spostare l'implementazione di questo metodo nel [ExceptionWrapper](../exceptionwrapper/) potrebbe rompere tale logica. |
