...
type: docs
weight: 79
url: /it/system.threading/details_threadabortexception/
---
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del modello come puntatore debole (anziché condiviso). Permette di passare i puntatori nei contenitori alla modalità debole. |
