...
description: "Evento che può essere inviato a un thread in attesa. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject() . Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 118
url: /it/system.threading/eventwaithandle/
---
## classe EventWaitHandle

Evento che può essere inviato a un thread in attesa. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo a funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Close](../waithandle/close/)() | Rilascia tutte le risorse associate al handle. |
...
|  [EventWaitHandle](./eventwaithandle/)(**bool**, [EventResetMode](../eventresetmode/)) | Costruttore. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo per scopi interni. |
| [wait_handle_t](../wait_handle_t/) [get_Handle](../waithandle/get_handle/)() | Ottiene il handle. |
...
| virtual **bool** [Reset](./reset/)() | Imposta l'evento in stato non segnalante. |
| virtual **bool** [Set](./set/)() | Imposta l'evento in stato segnalante. |
...
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Attende che tutti i handle vengano attivati. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Attende che tutti i handle vengano attivati. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Attende che tutti i handle vengano attivati. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Attende che uno dei handle venga attivato. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Attende che uno dei handle venga attivato. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Attende che uno dei handle venga attivato. |
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Attende che il handle venga attivato per un periodo illimitato. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int) | Attende che il handle venga attivato. |
| virtual **bool** [WaitOne](../waithandle/waitone/)([TimeSpan](../../system/timespan/)) | Attende che il handle venga attivato. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int, **bool**) | Attende che il handle venga attivato. |
