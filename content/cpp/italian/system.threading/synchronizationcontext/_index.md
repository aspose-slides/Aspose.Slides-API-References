...
description: Fornisce le funzionalità di base per propagare un contesto di sincronizzazione attraverso varie operazioni di sincronizzazione.
type: docs
weight: 196
url: /it/system.threading/synchronizationcontext/
---
## classe SynchronizationContext


Fornisce le funzionalità di base per propagare un contesto di sincronizzazione attraverso varie operazioni di sincronizzazione.
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Ottiene il contesto di sincronizzazione per il thread corrente. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Esegue la callback in modo asincrono. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Esegue la callback in modo sincrono. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Imposta il contesto di sincronizzazione per il thread corrente. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | Costruisce una nuova istanza di [SynchronizationContext](./). |
