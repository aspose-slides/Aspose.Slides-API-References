...
description: Rappresenta un oggetto che gestisce il lavoro a basso livello di accodare attività sui thread.
type: docs
weight: 79
url: /it/system.threading.tasks/taskscheduler/
---
## TaskScheduler classe

Rappresenta un oggetto che gestisce il lavoro a basso livello di accodare attività sui thread.
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Crea un [TaskScheduler](./) associato al thread corrente. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Ottiene il [TaskScheduler](./) associato all'attività attualmente in esecuzione. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Ottiene l'istanza predefinita di [TaskScheduler](./) fornita dal framework. |
| **int32_t** [get_Id](./get_id/)() const | Ottiene l'ID unico per questo [TaskScheduler](./). |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Indica il livello massimo di concorrenza che questo [TaskScheduler](./) può supportare. |
