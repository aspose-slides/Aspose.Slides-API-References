...
| virtual [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() | Definisce la stringa di comando. Leggi [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() | Definisce l'obiettivo forma dell'effetto di comando. Leggi [IShape](../../aspose.slides/ishape/). |
...
| virtual [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() | Definisce il tipo di effetto di comando del comportamento. Leggi [CommandEffectType](../commandeffecttype/). |
...
| virtual void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) | Definisce la stringa di comando. Scrivi [System::String](../../system/string/). |
| virtual void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Definisce l'obiettivo forma dell'effetto di comando. Scrivi [IShape](../../aspose.slides/ishape/). |
...
| virtual void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) | Definisce il tipo di effetto di comando del comportamento. Scrivi [CommandEffectType](../commandeffecttype/). |
