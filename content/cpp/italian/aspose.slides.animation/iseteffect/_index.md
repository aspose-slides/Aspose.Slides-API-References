...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../ibehavior/get_accumulate/)() | Indica se i comportamenti di animazione sono accumulati. Leggi [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../ibehavior/get_additive/)() | Indica se il comportamento di animazione corrente è combinato con altre animazioni in esecuzione. Leggi [BehaviorAdditiveType](../behavioradditivetype/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Rappresenta le proprietà di temporizzazione per il comportamento dell'effetto. Leggi [ITiming](../itiming/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_To](./get_to/)() | Specifica un certo attributo di un effetto dopo un effetto di animazione. Rappresenta un valore puntuale. Solo: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Leggi [System::Object](../../system/object/). |
...
| virtual void [set_Accumulate](../ibehavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Indica se i comportamenti di animazione sono accumulati. Scrivi [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Indica se il comportamento di animazione corrente è combinato con altre animazioni in esecuzione. Scrivi [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_Timing](../ibehavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Rappresenta le proprietà di temporizzazione per il comportamento dell'effetto. Scrivi [ITiming](../itiming/). |
| virtual void [set_To](./set_to/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Specifica un certo attributo di un effetto dopo un effetto di animazione. Rappresenta un valore puntuale. Solo: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Scrivi [System::Object](../../system/object/). |
