...
| [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() override | Rappresenta che l'effetto con comportamento deve rivelare (in/out). Leggi [FilterEffectRevealType](../filtereffectrevealtype/). |
| [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() override | Rappresenta il sottotipo dell'effetto filtro. Leggi [FilterEffectSubtype](../filtereffectsubtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Rappresenta le proprietà temporali per il comportamento dell'effetto. Leggi [ITiming](../itiming/). |
| [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() override | Rappresenta il tipo di effetto filtro. Leggi [FilterEffectType](../filtereffecttype/). |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia effettivamente nulla, ma inizializza un nuovo oggetto e abilita la costruzione di copie delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia effettivamente nulla, ma inizializza un nuovo oggetto e abilita la costruzione di copie delle sottoclassi. |
...
| void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) override | Rappresenta che l'effetto con comportamento deve rivelare (in/out). Scrivi [FilterEffectRevealType](../filtereffectrevealtype/). |
| void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) override | Rappresenta il sottotipo dell'effetto filtro. Scrivi [FilterEffectSubtype](../filtereffectsubtype/). |
...
| void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) override | Rappresenta il tipo di effetto filtro. Scrivi [FilterEffectType](../filtereffecttype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (invece di shared). Consente di passare i puntatori nei contenitori a modalità debole. |
