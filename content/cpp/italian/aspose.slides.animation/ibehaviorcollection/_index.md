...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Aggiunge un nuovo comportamento a una collezione. |
...
| virtual void [Clear](./clear/)() | Rimuove tutti i comportamenti da una collezione. |
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Determina se [ICollection](../../system.collections.generic/icollection/) contiene un valore specifico. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di comportamenti in una collezione. Solo lettura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce un comportamento all'indice specificato. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Restituisce un comportamento all'indice specificato. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Determina l'indice di un elemento specifico nel [IList](../../system.collections.generic/ilist/). |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Inserisce un nuovo comportamento in una collezione all'indice specificato. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Trasforma gli elementi al tipo specificato. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se nessun elemento risponde. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia veramente nulla, si limita ad inizializzare un nuovo oggetto e consente la costruzione per copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia davvero nulla, si limita ad inizializzare un nuovo oggetto e consente la costruzione per copia delle sottoclassi. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Rimuove il comportamento specificato da una collezione. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove un comportamento da una collezione all'indice specificato. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa il lock() statement di C# per lo sblocco. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
