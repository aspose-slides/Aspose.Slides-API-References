...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | Aggiunge un nuovo effetto alla fine della sequenza corrente fino alla fine delle animazioni di testo di gruppo. Valido solo se il conteggio dei paragrafi di testo è uguale o superiore al conteggio degli effetti di questo gruppo! |
...
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | Elenco del tipo di build (per es. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, Tutto in una volta) dell'animazione di testo. Leggi [Animation::BuildType](../buildtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | Effetto forma collegato con gruppo o meno (null). Leggi [IEffect](../ieffect/). |
...
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | Elenco del tipo di build (per es. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, Tutto in una volta) dell'animazione di testo. Scrivi [Animation::BuildType](../buildtype/). |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | Effetto forma collegato con gruppo o meno (null). Scrivi [IEffect](../ieffect/). |
