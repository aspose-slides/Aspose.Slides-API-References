...
| **float** [get_By](./get_by/)() override | Descrive il valore di offset relativo per l'animazione. Leggi **float**. |
| **float** [get_From](./get_from/)() override | Descrive il valore iniziale per l'animazione. Leggi **float**. |
...
| **float** [get_To](./get_to/)() override | Descrive il valore finale per l'animazione. Leggi **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e abilita la copia dei sottotipi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e abilita la copia dei sottotipi. |
...
| void [set_By](./set_by/)(**float**) override | Descrive il valore di offset relativo per l'animazione. Scrivi **float**. |
| void [set_From](./set_from/)(**float**) override | Descrive il valore iniziale per l'animazione. Scrivi **float**. |
...
| void [set_To](./set_to/)(**float**) override | Descrive il valore finale per l'animazione. Scrivi **float**. |
