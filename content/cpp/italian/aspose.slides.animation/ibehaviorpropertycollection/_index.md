...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | Aggiunge una nuova proprietà alla raccolta. |
| virtual void [Add](../../system.collections.generic/icollection/add/)(const T\&) | Aggiunge un elemento alla raccolta. |
...
| virtual void [Clear](../../system.collections.generic/icollection/clear/)() | Elimina tutti gli elementi dalla raccolta. |
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Determina se il [ICollection](../../system.collections.generic/icollection/) contiene un valore specifico. |
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T\&) const | Verifica se l'elemento è presente nella raccolta. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Esegue il confronto in virgola mobile in stile C# dove due NaN sono considerati uguali, anche se secondo IEC 60559:1989 NaN non è uguale a nessun valore, compreso NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Esegue il confronto in virgola mobile in stile C# dove due NaN sono considerati uguali, anche se secondo IEC 60559:1989 NaN non è uguale a nessun valore, compreso NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo per uso interno. |
| virtual int [get_Count](../../system.collections.generic/icollection/get_count/)() const | Restituisce il numero di elementi nella raccolta. |
...
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Determina l'indice di un elemento specifico per valore di proprietà nella [IList](../../system.collections.generic/ilist/). |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | Restituisce l'indice della prima occorrenza dell'elemento nel contenitore. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Inserisce una nuova proprietà (con il valore di proprietà specificato) nella raccolta all'indice specificato. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Inserisce l'elemento nella posizione specificata, spostando gli altri elementi. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se nessun elemento così è trovato. |
...
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Invoca una funzione di trasformazione su ciascun elemento di una sequenza generica e restituisce il valore minimo risultato. |
...
| void [Lock](../../system/object/lock/)() | Implementa l'operazione di lock() di C#. Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Rimuove la proprietà specificata dalla raccolta. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Elimina l'elemento dalla raccolta. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (anziché condiviso). Permette di cambiare i puntatori nei contenitori in modalità debole. |
| int [SharedCount](../../system/object/sharedcount/)() const | Restituisce il valore corrente del contatore di riferimenti condivisi. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa il contatore di riferimenti condivisi. Non deve essere chiamato direttamente; usare invece smart pointer o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e restituisce il contatore di riferimenti condivisi. Non deve essere chiamato direttamente; usare invece smart pointer o ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il contatore di riferimenti deboli. Non deve essere chiamato direttamente; usare invece smart pointer o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il contatore di riferimenti deboli. Non deve essere chiamato direttamente; usare invece smart pointer o ThisProtector. |
