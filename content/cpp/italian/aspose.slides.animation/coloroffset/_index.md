...
description: Rappresenta lo spostamento di colore.
type: docs
weight: 92
...
Rappresenta lo spostamento di colore.
...
| **float** [get_Value0](./get_value0/)() override | Definisce il primo valore dell'offset. Leggi **float**. |
| **float** [get_Value1](./get_value1/)() override | Definisce il secondo valore dell'offset. Leggi **float**. |
| **float** [get_Value2](./get_value2/)() override | Definisce il terzo valore dell'offset. Leggi **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Definisce il primo valore dell'offset. Scrivi **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Definisce il secondo valore dell'offset. Scrivi **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Definisce il terzo valore dell'offset. Scrivi **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento di modello come puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
...
* Classe [IColorOffset](../icoloroffset/)
