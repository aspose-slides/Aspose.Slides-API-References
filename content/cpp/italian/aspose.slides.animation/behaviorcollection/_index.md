...
| Metodo | Descrizione |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Aggiunge un nuovo comportamento a una collezione. |
| [iterator](./iterator/) [begin](./begin/)() | Restituisce un iteratore che punta al primo elemento (se presente) della collezione. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza qualificata come const della collezione. |
...
| void [Clear](./clear/)() override | Rimuove tutti i comportamenti da una collezione. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Determina se il [ICollection](../../system.collections.generic/icollection/) contiene un valore specifico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>, **int32_t**) | Copia gli elementi del [ICollection](../../system.collections.generic/icollection/) in un [System::Array](../../system/array/), iniziando da un indice [System::Array](../../system/array/) particolare. |
| [iterator](./iterator/) [end](./end/)() | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) della collezione. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza qualificata come const della collezione. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di comportamenti in una collezione. **int32_t** di sola lettura. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Restituisce un valore che indica se il [ICollection](../../system.collections.generic/icollection/) è di sola lettura. **bool** di sola lettura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce un comportamento all'indice specificato. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Restituisce un comportamento all'indice specificato. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Determina l'indice di un elemento specifico nella [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Inserisce un nuovo comportamento nella collezione all'indice specificato. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se esiste almeno un elemento in una sequenza o se ne soddisfa una condizione. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Restituisce il primo elemento di una sequenza, oppure il valore predefinito se la sequenza è vuota. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Rimuove il comportamento specificato da una collezione. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Rimuove il comportamento da una collezione all'indice specificato. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa il contatore di riferimenti condivisi. Non deve essere chiamato direttamente; usare i puntatori intelligenti o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e restituisce il contatore di riferimenti condivisi. Non deve essere chiamato direttamente; usare i puntatori intelligenti o ThisProtector. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza qualificata come const della collezione. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza qualificata come const della collezione. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il contatore di riferimenti deboli. Non deve essere chiamato direttamente; usare i puntatori intelligenti o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il contatore di riferimenti deboli. Non deve essere chiamato direttamente; usare i puntatori intelligenti o ThisProtector. |
...
* Classe [IBehaviorCollection](../ibehaviorcollection/)
