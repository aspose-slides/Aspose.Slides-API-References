...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\> [Add](./add/)([MotionCommandPathType](../motioncommandpathtype/), [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>, [MotionPathPointsType](../motionpathpointstype/), **bool**) | Aggiunge un nuovo comando al percorso |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza costante qualificata della collezione. |
...
| virtual void [Clear](./clear/)() | Rimuove tutti i comandi dalla collezione. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza costante qualificata della collezione. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di percorsi nella collezione. **int32_t** di sola lettura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce un comando all'indice specificato. |
| virtual void [Insert](./insert/)(**int32_t**, [MotionCommandPathType](../motioncommandpathtype/), [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>, [MotionPathPointsType](../motionpathpointstype/), **bool**) | Inserisce un nuovo comando nel percorso. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e abilita la copia dei sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e abilita la copia dei sottoclassi. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\>) | Rimuove i comandi specificati dalla collezione. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove un comando all'indice specificato. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo parametro template a un puntatore debole (anziché condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
