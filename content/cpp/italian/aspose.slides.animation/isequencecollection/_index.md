...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Aggiunge una nuova sequenza interattiva. |
...
| virtual void [Clear](./clear/)() | Rimuove tutte le sequenze da una collezione. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di elementi in una collezione **int32_t** di sola lettura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce una sequenza all'indice specificato. |
...
| void [Lock](../../system/object/lock/)() | Implementa il lock() statement di C# per il blocco. Chiamalo direttamente o utilizza l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) | Rimuove la sequenza specificata da una collezione. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove la sequenza all'indice specificato. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del template come puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa il lock() statement di C# per lo sblocco. Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../../system/lockcontext/). |
