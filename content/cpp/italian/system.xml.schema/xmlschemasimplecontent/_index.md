...
description: Rappresenta l'elemento simpleContent dello Schema XML come specificato dal World Wide Web Consortium (W3C). Questa classe è per tipi semplici e complessi con modello di contenuto semplice.
type: docs
weight: 794
url: /it/system.xml.schema/xmlschemasimplecontent/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Restituisce uno dei [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) o [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Restituisce uno dei [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) o [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
