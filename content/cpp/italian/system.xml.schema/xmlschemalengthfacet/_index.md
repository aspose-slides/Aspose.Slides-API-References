...
description: Rappresenta la faccetta di lunghezza dallo Schema XML così come specificato dal World Wide Web Consortium (W3C). Questa classe può essere usata per specificare una restrizione sulla lunghezza di un elemento simpleType sul tipo di dato.
type: docs
weight: 560
url: /it/system.xml.schema/xmlschemalengthfacet/
---
## XmlSchemaLengthFacet classe


Rappresenta la faccetta **length** da XML [Schema](../) come specificato dal Consorzio World Wide [Web](../../system.web/) (W3C). Questa classe può essere usata per specificare una restrizione sulla lunghezza di un elemento **simpleType** sul tipo di dato.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, ma inizializza un nuovo oggetto e abilita la costruzione di copie per le classi derivate. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, ma inizializza un nuovo oggetto e abilita la costruzione di copie per le classi derivate. |
...
|  [XmlSchemaLengthFacet](./xmlschemalengthfacet/)() | Inizializza una nuova istanza della classe [XmlSchemaLengthFacet](./). |
