...
description: "Classe per i vincoli di identità: elementi key, keyref e unique."
type: docs
weight: 469
url: /it/system.xml.schema/xmlschemaidentityconstraint/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Restituisce la raccolta di campi che si applicano come figli per il selettore di espressioni XML Path Language ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Restituisce il nome del vincolo di identità. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Restituisce il nome qualificato del vincolo di identità, che contiene l'interpretazione post-compilazione del valore **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Restituisce l'elemento **selector** dell'espressione [XPath](../../system.xml.xpath/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, davvero, solo inizializza un nuovo oggetto e abilita la costruzione di copie delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, davvero, solo inizializza un nuovo oggetto e abilita la costruzione di copie delle sottoclassi. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Imposta il nome del vincolo di identità. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Imposta l'elemento **selector** dell'espressione [XPath](../../system.xml.xpath/). |
