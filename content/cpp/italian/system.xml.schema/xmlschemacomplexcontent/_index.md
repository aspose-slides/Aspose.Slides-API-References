...
description: Rappresenta l'elemento complexContent dello schema XML, come specificato dal World Wide Web Consortium (W3C). Questa classe rappresenta il modello di contenuto complesso per i tipi complessi. Contiene estensioni o restrizioni su un tipo complesso che contiene solo elementi o contenuto misto.
type: docs
weight: 261
url: /it/system.xml.schema/xmlschemacomplexcontent/
---
## XmlSchemaComplexContent classe

Rappresenta l'elemento **complexContent** di XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). Questa classe rappresenta il modello di contenuto complesso per tipi complessi. Contiene estensioni o restrizioni su un tipo complesso che ha solo elementi o contenuto misto.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Restituisce il contenuto. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Restituisce l'id della stringa. |
| **bool** [get_IsMixed](./get_ismixed/)() | Restituisce informazioni che determinano se il tipo ha un modello di contenuto misto. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Imposta il contenuto. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Imposta l'id della stringa. |
| void [set_IsMixed](./set_ismixed/)(**bool**) | Imposta informazioni che determinano se il tipo ha un modello di contenuto misto. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a weak pointer (invece di shared). Consente di passare i puntatori nei contenitori alla modalità debole. |
