...
description: Rappresenta l'elemento attributeGroup con l'attributo ref dello XML Schema come specificato da . AttributesGroupRef è il riferimento per un attributeGroup, la proprietà name contiene il gruppo di attributi a cui si fa riferimento.
type: docs
weight: 196
url: /it/system.xml.schema/xmlschemaattributegroupref/
---
## XmlSchemaAttributeGroupRef classe


Rappresenta l'elemento **attributeGroup** con l'attributo **ref** dell'XML [Schema](../) come specificato da [World Wide Web Consortium (W3C)](https://go.microsoft.com/fwlink/?LinkId=49454). AttributesGroupRef è il riferimento per un attributeGroup, la proprietà name contiene il gruppo di attributi a cui si fa riferimento.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Restituisce il nome dell'elemento **attributeGroup** di riferimento. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Imposta il nome dell'elemento **attributeGroup** di riferimento. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template come puntatore debole (invece di condiviso). Consente di passare i puntatori nei container alla modalità debole. |
