...
description: Una classe base per tutti i facet utilizzati quando i tipi semplici sono derivati mediante restrizione.
type: docs
weight: 404
url: /it/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet classe

Una classe base per tutti i facet che vengono utilizzati quando i tipi semplici sono derivati mediante restrizione.
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | Restituisce informazioni che indicano che questo facet è fissato. |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Restituisce la posizione nella riga del file a cui fa riferimento l'elemento **schema**. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | Restituisce l'attributo **value** del facet. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | Imposta informazioni che indicano che questo facet è fissato. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Imposta l'attributo **value** del facet. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template come puntatore weak (piuttosto che shared). Consente di passare i puntatori nei contenitori a modalità weak. |
...
Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo nello stack o usando l'operatore new, poiché causerebbe errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo alle funzioni come argomento. 
