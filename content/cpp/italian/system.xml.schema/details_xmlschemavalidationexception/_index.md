...
description: Rappresenta l'eccezione generata quando gli errori e gli avvisi di validazione dello schema XML Schema Definition Language (XSD) si verificano in un documento XML in fase di convalida.
type: docs
weight: 27
url: /it/system.xml.schema/details_xmlschemavalidationexception/
---
## Details_XmlSchemaValidationException classe


Rappresenta l'eccezione generata quando gli errori e gli avvisi di validazione dello schema XML [Schema](../) Definition Language (XSD) si verificano in un documento XML in fase di convalida.
...
| **int32_t** [get_LineNumber](../details_xmlschemaexception/get_linenumber/)() | Restituisce il numero di riga che indica dove si è verificato l'errore. |
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | Restituisce la posizione nella riga che indica dove si è verificato l'errore. |
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | Restituisce la descrizione della condizione di errore di questa eccezione. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | Restituisce il nodo XML che ha causato questa XmlSchemaValidationException. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | Il **[XmlSchemaObject](../xmlschemaobject/)** che ha prodotto l'XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | Restituisce l'Uniform Resource Identifier (URI) della posizione dello schema che ha causato l'eccezione. |
