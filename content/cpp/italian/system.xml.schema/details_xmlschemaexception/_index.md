...
description: Restituisce informazioni dettagliate sull'eccezione di schema.
type: docs
weight: 1
url: /it/system.xml.schema/details_xmlschemaexception/
---
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Restituisce il numero di riga che indica dove si è verificato l'errore. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Restituisce la posizione nella riga che indica dove si è verificato l'errore. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Restituisce la descrizione della condizione di errore di questa eccezione. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | Il **[XmlSchemaObject](../xmlschemaobject/)** che ha prodotto l'XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Restituisce l'Uniform Resource Identifier (URI) della posizione dello schema che ha causato l'eccezione. |
