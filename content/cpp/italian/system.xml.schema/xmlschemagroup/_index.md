...
description: Rappresenta l'elemento group dello Schema XML come specificato dal World Wide Web Consortium (W3C). Questa classe definisce gruppi a livello di schema a cui si fa riferimento dai tipi complessi. Raggruppa un insieme di dichiarazioni di elementi in modo che possano essere incorporate come gruppo nelle definizioni di tipi complessi.
type: docs
weight: 430
url: /it/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup classe


Rappresenta l'elemento **group** da XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). Questa classe definisce gruppi a livello di **schema** a cui si fa riferimento dai tipi complessi. Raggruppa un insieme di dichiarazioni di elemento così che possano essere incorporate come gruppo nelle definizioni dei tipi complessi.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Restituisce il nome del gruppo di schema. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Restituisce una delle classi [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) o [XmlSchemaSequence](../xmlschemasequence/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Restituisce il nome qualificato del gruppo di schema. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, inizializza solo un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, inizializza solo un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Imposta il nome del gruppo di schema. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\>\&) | Imposta una delle classi [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) o [XmlSchemaSequence](../xmlschemasequence/). |
...
Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare tale puntatore per passarla alle funzioni come argomento. 
