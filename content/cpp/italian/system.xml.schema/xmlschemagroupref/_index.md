...
description: Rappresenta l'elemento group con attributo ref dallo Schema XML come specificato dal World Wide Web Consortium (W3C). Questa classe è usata all'interno di tipi complessi che fanno riferimento a un group definito a livello di schema.
type: docs
weight: 456
url: /it/system.xml.schema/xmlschemagroupref/
---
## XmlSchemaGroupRef classe


Rappresenta l'elemento **group** con attributo **ref** dall'XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). Questa classe è usata all'interno di tipi complessi che fanno riferimento a un **group** definito a livello di **schema**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Restituisce una delle classi [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) o [XmlSchemaSequence](../xmlschemasequence/), che contiene l'interpretazione post-compilazione del valore **Particle**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Restituisce il nome di un gruppo definito in questo schema (o in un altro schema indicato dallo spazio dei nomi specificato). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia effettivamente nulla, ma inizializza un nuovo oggetto e consente la copia di costruzione delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia effettivamente nulla, ma inizializza un nuovo oggetto e consente la copia di costruzione delle sottoclassi. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Imposta il nome di un gruppo definito in questo schema (o in un altro schema indicato dallo spazio dei nomi specificato). |
...
Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherebbe errori di runtime e/o fallimenti di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa tale puntatore per passarla alle funzioni come argomento. 
