...
description: Rappresenta l'elemento maxExclusive dallo Schema XML come specificato dal World Wide Web Consortium (W3C). Questa classe può essere usata per specificare una restrizione sul valore massimo di un elemento simpleType. Il valore dell'elemento deve essere inferiore al valore dell'elemento maxExclusive.
type: docs
weight: 573
url: /it/system.xml.schema/xmlschemamaxexclusivefacet/
---
## XmlSchemaMaxExclusiveFacet classe

Rappresenta l'elemento **maxExclusive** di XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). Questa classe può essere usata per specificare una restrizione sul valore massimo di un elemento **simpleType**. Il valore dell'elemento deve essere inferiore al valore dell'elemento **maxExclusive**.
...
|  [XmlSchemaMaxExclusiveFacet](./xmlschemamaxexclusivefacet/)() | Inizializza una nuova istanza della classe [XmlSchemaMaxExclusiveFacet](./). |
