...
description: Rappresenta l'elemento notation di XML Schema come specificato dal World Wide Web Consortium (W3C). Una dichiarazione XML Schema notation è una ricostruzione delle dichiarazioni NOTATION di XML 1.0. Lo scopo delle notazioni è descrivere il formato dei dati non-XML all'interno di un documento XML.
type: docs
weight: 651
url: /it/system.xml.schema/xmlschemanotation/
---
## XmlSchemaNotation classe


Rappresenta l'elemento **notation** di XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). Una dichiarazione XML [Schema](../)**notation** è una ricostruzione delle dichiarazioni **XML** 1.0 NOTATION. Lo scopo delle notazioni è descrivere il formato dei dati non-XML all'interno di un documento XML.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Restituisce il nome della notazione. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | Restituisce l'identificatore **public**. |
...
| [String](../../system/string/) [get_System](./get_system/)() | Restituisce l'identificatore **system**. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Imposta il nome della notazione. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | Imposta l'identificatore **public**. |
...
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | Imposta l'identificatore **system**. |
