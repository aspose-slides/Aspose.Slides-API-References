...
description: Una classe base che è la classe base per tutti i tipi di particella (ad es. XmlSchemaAny).
type: docs
weight: 729
url: /it/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle classe


Una classe base per tutti i tipi di particella (ad es. [XmlSchemaAny](../xmlschemaany/)).
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Restituisce il numero massimo di volte in cui la particella può comparire. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Restituisce il numero come valore stringa. Numero massimo di volte in cui la particella può comparire. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Restituisce il numero minimo di volte in cui la particella può comparire. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Restituisce il numero come valore stringa. Il numero minimo di volte in cui la particella può comparire. |
...
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Imposta il numero massimo di volte in cui la particella può comparire. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Imposta il numero come valore stringa. Numero massimo di volte in cui la particella può comparire. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Imposta il numero minimo di volte in cui la particella può comparire. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Imposta il numero come valore stringa. Il numero minimo di volte in cui la particella può comparire. |
...
|  [XmlSchemaParticle](./xmlschemaparticle/)() | Inizializza una nuova istanza della classe [XmlSchemaParticle](./). |
