...
description: Una classe base per la definizione di faccette numeriche. Questa classe è la classe base per le classi di faccette numeriche come XmlSchemaMinLengthFacet.
type: docs
weight: 664
url: /it/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet classe


Una classe base per la definizione di faccette **numeriche**. Questa classe è la classe base per le classi di faccette numeriche come [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/).
...
| void [Lock](../../system/object/lock/)() | Implementa il lock() statement di C# per il lock. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del template come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
| int [SharedCount](../../system/object/sharedcount/)() const | Ottiene il valore corrente del contatore di riferimento condiviso. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa il contatore di riferimento condiviso. Non dovrebbe essere chiamato direttamente; al suo posto, usare smart pointers o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e restituisce il contatore di riferimento condiviso. Non dovrebbe essere chiamato direttamente; al suo posto, usare smart pointers o ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il contatore di riferimento debole. Non dovrebbe essere chiamato direttamente; al suo posto, usare smart pointers o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il contatore di riferimento debole. Non dovrebbe essere chiamato direttamente; al suo posto, usare smart pointers o ThisProtector. |
