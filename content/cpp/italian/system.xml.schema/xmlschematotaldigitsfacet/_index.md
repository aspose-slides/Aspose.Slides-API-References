...
description: Rappresenta il facet totalDigits da XML Schema come specificato dal World Wide Web Consortium (W3C). Questa classe può essere utilizzata per specificare una restrizione sul numero di cifre che possono essere inserite per il valore di un elemento simpleType. Il valore di totalDigits deve essere un intero positivo.
type: docs
weight: 898
url: /it/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet classe


Rappresenta il facet **totalDigits** da XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). Questa classe può essere utilizzata per specificare una restrizione sul numero di cifre che possono essere inserite per il valore di un elemento **simpleType**. Quel valore di **totalDigits** deve essere un intero positivo.
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Restituisce l'identificatore della stringa. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Restituisce le XmlSerializerNamespaces da usare con questo oggetto schema. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Imposta l'identificatore della stringa. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Imposta le XmlSerializerNamespaces da usare con questo oggetto schema. |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | Inizializza una nuova istanza della classe [XmlSchemaTotalDigitsFacet](./). |
