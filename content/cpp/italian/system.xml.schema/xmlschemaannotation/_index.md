...
description: Rappresenta l'elemento annotation del World Wide Web Consortium (W3C).
type: docs
weight: 118
url: /it/system.xml.schema/xmlschemaannotation/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Restituisce la collezione **Items** usata per memorizzare gli elementi figlio **appinfo** e **documentation**. |
...
Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o violazioni di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare tale puntatore per passarlo come argomento alle funzioni. 
