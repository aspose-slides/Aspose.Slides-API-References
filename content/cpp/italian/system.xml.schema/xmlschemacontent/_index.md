...
description: Una classe astratta per il contenuto dello schema.
type: docs
weight: 313
url: /it/system.xml.schema/xmlschemacontent/
---
## XmlSchemaContent classe
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n'th argomento template come weak pointer (piuttosto che shared). Consente di passare i puntatori nei contenitori in modalità weak. |
