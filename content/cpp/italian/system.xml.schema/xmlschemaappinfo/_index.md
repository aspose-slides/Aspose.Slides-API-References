...
description: Rappresenta l'elemento appinfo del World Wide Web Consortium (W3C).
type: docs
weight: 157
url: /it/system.xml.schema/xmlschemaappinfo/
---
## XmlSchemaAppInfo classe
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Restituisce la posizione di colonna nel file a cui fa riferimento l'elemento **schema**. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Restituisce un array di oggetti [XmlNode](../../system.xml/xmlnode/) che rappresenta i nodi figli **appinfo**. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Restituisce la sorgente delle informazioni dell'applicazione. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Imposta la posizione di colonna nel file a cui fa riferimento l'elemento **schema**. |
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Imposta un array di oggetti [XmlNode](../../system.xml/xmlnode/) che rappresenta i nodi figli **appinfo**. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Imposta la sorgente delle informazioni dell'applicazione. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa il conteggio di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; usare invece smart pointer o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e restituisce il conteggio di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; usare invece smart pointer o ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il conteggio di riferimenti deboli. Non dovrebbe essere chiamato direttamente; usare invece smart pointer o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il conteggio di riferimenti deboli. Non dovrebbe essere chiamato direttamente; usare invece smart pointer o ThisProtector. |
...
| Typedef | Descrizione |
| --- | --- |
| [Ptr](./ptr/) | Un alias per smart pointer condiviso a un'istanza di questa classe. |

## Osservazioni



Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di assert. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e utilizzare questo puntatore per passarlo alle funzioni come argomento. 
