...
description: Rappresenta l'elemento sequence (compositore) dello Schema XML come specificato dal World Wide Web Consortium (W3C). La sequence richiede che gli elementi nel gruppo compaiano nella sequenza specificata all'interno dell'elemento contenitore.
type: docs
weight: 768
url: /it/system.xml.schema/xmlschemasequence/
---
## XmlSchemaSequence classe


Rappresenta l'elemento **sequence** (compositore) dell'XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). L'**sequence** richiede che gli elementi nel gruppo compaiano nella sequenza specificata all'interno dell'elemento contenitore.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Gli elementi contenuti nel compositore. Collezione di [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./) o [XmlSchemaAny](../xmlschemaany/). |
