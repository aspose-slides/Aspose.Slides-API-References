...
description: Rappresenta l'elemento maxInclusive dallo Schema XML come specificato dal World Wide Web Consortium (W3C). Questa classe può essere usata per specificare una restrizione sul valore massimo di un elemento simpleType. Il valore dell'elemento deve essere minore o uguale al valore dell'elemento maxInclusive.
type: docs
weight: 586
url: /it/system.xml.schema/xmlschemamaxinclusivefacet/
---
## XmlSchemaMaxInclusiveFacet classe

Rappresenta l'elemento **maxInclusive** da XML [Schema](../) come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). Questa classe può essere usata per specificare una restrizione sul valore massimo di un elemento **simpleType**. Il valore dell'elemento deve essere minore o uguale al valore dell'elemento **maxInclusive**.
...
|  [XmlSchemaMaxInclusiveFacet](./xmlschemamaxinclusivefacet/)() | Inizializza una nuova istanza della classe [XmlSchemaMaxInclusiveFacet](./). |
