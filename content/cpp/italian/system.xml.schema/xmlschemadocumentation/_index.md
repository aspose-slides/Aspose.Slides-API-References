...
description: Rappresenta l'elemento documentation dello schema XML come specificato dal World Wide Web Consortium (W3C). Questa classe specifica le informazioni da leggere o utilizzare da parte degli esseri umani all'interno di un'annotazione.
type: docs
weight: 352
url: /it/system.xml.schema/xmlschemadocumentation/
---
## Classe XmlSchemaDocumentation


Rappresenta l'elemento **documentation** dell'XML [Schema](../) come specificato dal Consorzio World Wide [Web](../../system.web/) (W3C). Questa classe specifica le informazioni da leggere o utilizzare da parte degli esseri umani all'interno di una **annotation**.
...
| [String](../../system/string/) [get_Language](./get_language/)() | Restituisce l'attributo **xml:lang**. Questo serve come indicatore della lingua usata nei contenuti. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Restituisce un array di oggetti [XmlNode](../../system.xml/xmlnode/) che rappresentano i nodi figli della documentazione. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Restituisce l'Uniform Resource Identifier (URI) di origine delle informazioni. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e consente la creazione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e consente la creazione di copie di sottoclassi. |
...
| void [set_Language](./set_language/)(const [String](../../system/string/)\&) | Imposta l'attributo **xml:lang**. Questo serve come indicatore della lingua usata nei contenuti. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Imposta un array di oggetti [XmlNode](../../system.xml/xmlnode/) che rappresentano i nodi figli della documentazione. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Imposta l'Uniform Resource Identifier (URI) di origine delle informazioni. |
...
Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo nello stack o usando l'operatore new, poiché ciò causerebbe errori di runtime e/o fallimenti di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo alle funzioni come argomento. 
