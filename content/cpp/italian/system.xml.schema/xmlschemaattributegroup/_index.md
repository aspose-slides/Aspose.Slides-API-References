...
description: Rappresenta l'elemento attributeGroup dello Schema XML così come specificato dal World Wide Web Consortium (W3C). AttributesGroups fornisce un meccanismo per raggruppare un insieme di dichiarazioni di attributi in modo che possano essere incorporate come gruppo nelle definizioni di tipi complessi.
type: docs
weight: 183
url: /it/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup classe


Rappresenta l'elemento **attributeGroup** dell'XML [Schema](../) così come specificato dal World Wide [Web](../../system.web/) Consortium (W3C). AttributesGroups fornisce un meccanismo per raggruppare un insieme di dichiarazioni di attributi in modo che possano essere incorporate come gruppo nelle definizioni di tipi complessi.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Restituisce il componente [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) del gruppo di attributi. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Restituisce la collezione di attributi per il gruppo di attributi. Contiene gli elementi [XmlSchemaAttribute](../xmlschemaattribute/) e [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Restituisce il nome del gruppo di attributi. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Restituisce l'XmlSerializerNamespaces da usare con questo oggetto schema. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Restituisce il nome qualificato del gruppo di attributi. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | Restituisce la proprietà del gruppo di attributi ridefinita dall'XML [Schema](../). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Imposta il componente [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) del gruppo di attributi. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Imposta il nome del gruppo di attributi. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Imposta l'XmlSerializerNamespaces da usare con questo oggetto schema. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento di template come weak pointer (piuttosto che shared). Consente di passare i puntatori nei contenitori alla modalità weak. |
