...
---
## ISmartArtNodeCollection classe


Rappresenta una raccolta di nodi [SmartArt](../smartart/).
...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [AddNode](./addnode/)() | Aggiunge un nuovo nodo o sotto nodo. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [AddNodeByPosition](./addnodebyposition/)(**int32_t**) | Aggiunge un nuovo nodo nella posizione selezionata della raccolta di nodi. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza della raccolta con qualificatore const. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Restituisce un iteratore che punta al primo elemento con qualificatore const (se presente) della raccolta. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento con qualificatore const (se presente) della raccolta. |
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Copia tutti gli elementi della raccolta nell'array specificato. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della raccolta con qualificatore const. |
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Restituisce il numero di comportamenti nella raccolta. Solo lettura **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Restituisce un valore che indica se l'accesso alla raccolta è sincronizzato (thread-safe). Solo lettura **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce il nodo all'indice. Solo lettura [ISmartArtNode](../ismartartnode/). |
...
| virtual void [RemoveNode](./removenode/)(**int32_t**) | Rimuove un nodo o sotto-nodo per indice. |
| virtual void [RemoveNode](./removenode/)([System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\>) | Rimuove un nodo o sotto-nodo. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento template n-esimo a un puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori in modalità debole. |
