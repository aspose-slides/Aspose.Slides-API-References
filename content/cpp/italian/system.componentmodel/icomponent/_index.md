...
description: "Classe fittizia per il codice che utilizza IComponent da compilare dopo la traduzione. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject() . Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 118
url: /it/system.componentmodel/icomponent/
---
## IComponent classe


Classe fittizia per il codice che utilizza IComponent da compilare dopo la traduzione. Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarla alle funzioni come argomento.
