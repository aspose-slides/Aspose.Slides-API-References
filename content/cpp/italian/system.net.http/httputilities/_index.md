...
description: Contiene i metodi di utilità.
type: docs
weight: 131
url: /it/system.net.http/httputilities/
---
## HttpUtilities classe

Contiene i metodi di utilità.
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Verifica se l'URI specificato è l'URI HTTP. |
...
| Campo | Descrizione |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | La versione HTTP predefinita per l'invio delle richieste. |
| static [DefaultResponseVersion](./defaultresponseversion/) | La versione HTTP predefinita per la ricezione delle risposte. |
