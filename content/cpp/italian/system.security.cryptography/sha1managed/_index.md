...
description: "Hasher SHA1 gestito. Non implementato. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o violazioni di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 560
url: /it/system.security.cryptography/sha1managed/
---
## SHA1Managed classe
...
| static [SharedPtr](../../system/sharedptr/)\<[SHA1](../sha1/)\> [Create](../sha1/create/)() | Crea un'istanza dell'algoritmo di hash. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA1](../sha1/)\> [Create](../sha1/create/)(const [String](../../system/string/)\&) | Crea un'istanza dell'algoritmo di hash. |
...
|  [SHA1Managed](./sha1managed/)() | Costruttore. |
