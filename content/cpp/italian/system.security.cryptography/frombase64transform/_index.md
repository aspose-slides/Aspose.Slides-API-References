...
description: "Converte l'istanza della classe CryptoStream da base 64. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o errori di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare tale puntatore per passarla alle funzioni come argomento."
type: docs
weight: 209
url: /it/system.security.cryptography/frombase64transform/
---
## FromBase64Transform classe

Converte l'istanza della classe [CryptoStream](../cryptostream/) da base 64. Gli oggetti di questa classe dovrebbero essere allocati solo utilizzando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o errori di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare tale puntatore per passarla alle funzioni come argomento.
...
| void [Dispose](./dispose/)() | Rilascia le risorse del sistema operativo acquisite dall'oggetto corrente. |
...
|  [FromBase64Transform](./frombase64transform/)([FromBase64TransformMode](../frombase64transformmode/)) | Costruttore. |
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | Restituisce un valore che indica se la trasformazione corrente può essere riutilizzata. |
| **bool** [get_CanTransformMultipleBlocks](./get_cantransformmultipleblocks/)() | Restituisce un valore che indica se più blocchi possono essere trasformati. |
| virtual **int32_t** [get_InputBlockSize](./get_inputblocksize/)() | Dimensione del blocco di input. |
| virtual **int32_t** [get_OutputBlockSize](./get_outputblocksize/)() | Dimensione del blocco di output. |
...
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Elabora un blocco di dati e copia i dati nell'array di output. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](../icryptotransform/transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Elabora l'ultimo blocco di dati e calcola il valore di output. |
