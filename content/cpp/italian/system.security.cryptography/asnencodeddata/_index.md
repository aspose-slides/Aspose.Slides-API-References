...
description: "Dati codificati in ASN.1. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò comporterà errori di runtime e/o errori di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare tale puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 1
url: /it/system.security.cryptography/asnencodeddata/
---
...
| Metodo | Descrizione |
| --- | --- |
|  [AsnEncodedData](./asnencodeddata/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](./)\>\&) | Costruttore di copia. |
|  [AsnEncodedData](./asnencodeddata/)(const [ByteArrayPtr](../../system/bytearrayptr/)\&) | Costruttore. |
|  [AsnEncodedData](./asnencodeddata/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../oid/)\>\&, const [ByteArrayPtr](../../system/bytearrayptr/)\&) | Costruttore. |
|  [AsnEncodedData](./asnencodeddata/)(const [String](../../system/string/)\&, const [ByteArrayPtr](../../system/bytearrayptr/)\&) | Costruttore. |
| virtual void [CopyFrom](./copyfrom/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](./)\>\&) | Copia i dati da un oggetto diverso. |
...
| virtual [String](../../system/string/) [Format](./format/)(**bool**) const | Formatta i dati in forma leggibile dall'uomo. |
| [SharedPtr](../../system/sharedptr/)\<[Oid](../oid/)\> [get_Oid](./get_oid/)() const | Ottiene l'identificatore dell'oggetto dei dati codificati. |
| [ByteArrayPtr](../../system/bytearrayptr/) [get_RawData](./get_rawdata/)() const | Ottiene i dati codificati grezzi. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita ad inizializzare un nuovo oggetto e consente la costruzione per copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita ad inizializzare un nuovo oggetto e consente la costruzione per copia delle sottoclassi. |
...
| void [set_Oid](./set_oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../oid/)\>\&) | Imposta l'identificatore dell'oggetto dei dati codificati. |
| void [set_RawData](./set_rawdata/)(const [ByteArrayPtr](../../system/bytearrayptr/)\&) | Imposta i dati codificati grezzi. |
