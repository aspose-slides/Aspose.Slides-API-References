...
description: "Struttura dati dei parametri dell'algoritmo DSA. Questo tipo dovrebbe essere allocato sullo stack e passato alle funzioni per valore o per riferimento. Non utilizzare mai la classe System::SmartPtr per gestire oggetti di questo tipo."
type: docs
weight: 703
url: /it/system.security.cryptography/dsaparameters/
---
## DSAParameters struct


[Data](../../system.data/) struttura dei parametri dell'algoritmo [DSA](../dsa/). Questo tipo dovrebbe essere allocato sullo stack e passato alle funzioni per valore o per riferimento. Non utilizzare mai la classe [System::SmartPtr](../../system/smartptr/) per gestire oggetti di questo tipo.
...
| Metodo | Descrizione |
| --- | --- |
|  [DSAParameters](./dsaparameters/)() | Costruttore. |
