...
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromFriendlyName](./fromfriendlyname/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Crea un oggetto OID dal nome amichevole OID specificato. |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromOidValue](./fromoidvalue/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Crea un oggetto OID dal valore OID specificato. |
| [String](../../system/string/) [get_FriendlyName](./get_friendlyname/)() const | Restituisce il nome leggibile dall'utente dell'oggetto. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Restituisce la stringa di identificatore dell'oggetto. |
...
|  [Oid](./oid/)() | Costruttore predefinito. |
|  [Oid](./oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](./)\>\&) | Costruttore di copia. |
|  [Oid](./oid/)(const [String](../../system/string/)\&) | Costruttore. |
|  [Oid](./oid/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Costruttore. |
...
| void [set_FriendlyName](./set_friendlyname/)(const [String](../../system/string/)\&) | Imposta il nome leggibile dall'utente dell'oggetto. |
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Imposta la stringa di identificatore dell'oggetto. |
