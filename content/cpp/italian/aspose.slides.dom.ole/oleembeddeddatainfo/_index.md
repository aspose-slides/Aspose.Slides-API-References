...
description: Rappresenta le informazioni sui dati incorporati per un oggetto OLE.
type: docs
weight: 1
...
Rappresenta le informazioni sui dati incorporati per un oggetto OLE.
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | Restituisce i dati del file di un oggetto OLE incorporato Solo lettura **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | Restituisce l'estensione del file per l'attuale oggetto OLE incorporato Solo lettura [System::String](../../system/string/). |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | Crea nuove informazioni sui dati incorporati per un oggetto OLE. |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | Crea una nuova istanza di informazioni sui dati incorporati per un oggetto OLE. |
...
* Classe [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* Spazio dei nomi [Aspose::Slides::DOM::Ole](../)
