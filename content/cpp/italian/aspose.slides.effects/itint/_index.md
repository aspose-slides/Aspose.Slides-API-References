...
Rappresenta un effetto [Tint](../tint/). Sposta i valori di colore dell'effetto verso/lontano dalla tonalità di quanto specificato.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento modello come puntatore debole (invece di condiviso). Consente di passare i puntatori nei contenitori in modalità debole. |
