...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) raggio. Solo lettura **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Direzione dell'ombra. Solo lettura **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distanza dell'ombra. Solo lettura **double**. |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | Allineamento del rettangolo. Solo lettura [RectangleAlignment](../../aspose.slides/rectanglealignment/). |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Specifica se l'ombra deve ruotare con la forma quando la forma è ruotata. Solo lettura **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Specifica il fattore di scala orizzontale, una scala negativa provoca un ribaltamento. Solo lettura **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Specifica il fattore di scala verticale, una scala negativa provoca un ribaltamento. Solo lettura **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Colore dell'ombra. Solo lettura [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Specifica l'angolo di inclinazione orizzontale (in gradi). Solo lettura **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Specifica l'angolo di inclinazione verticale (in gradi). Solo lettura **double**. |
