...
description: Rappresenta un effetto di sostituzione colore. Tutti i colori dell'effetto sono cambiati in un colore fisso. I valori Alpha non sono influenzati.
type: docs
weight: 144
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [ColorReplace](./) specificato è uguale al [ColorReplace](./) corrente. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | Restituisce il formato colore che sostituirà il colore di ogni pixel. Solo lettura [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplaceEffectiveData](../icolorreplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene i dati effettivi dell'effetto Color Replacement con l'ereditarietà applicata. |
