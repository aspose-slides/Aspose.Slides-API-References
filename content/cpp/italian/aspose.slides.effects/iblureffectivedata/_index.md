...
description: Oggetto immutabile che rappresenta un effetto di sfocatura applicato all'intera forma, compreso il riempimento. Tutti i canali di colore, compreso l'alpha, sono interessati.
type: docs
weight: 469
url: /it/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData classe


Oggetto immutabile che rappresenta un [Blur](../blur/) effetto applicato all'intera forma, compreso il riempimento. Tutti i canali di colore, compreso l'alpha, sono interessati.
...
| virtual **bool** [get_Grow](./get_grow/)() | Determina se i limiti dell'oggetto devono essere ampliati a causa della sfocatura. True indica che i limiti sono ampliati, mentre false indica che non lo sono. **bool** in sola lettura. |
| virtual **double** [get_Radius](./get_radius/)() | Restituisce il raggio della sfocatura. **double** in sola lettura. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo al metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Consente l'hash di oggetti personalizzati. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e consente di copiare costruttori delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e consente di copiare costruttori delle sottoclassi. |
