...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) raggio. Lettura **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Direzione dell'ombra. Lettura **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distanza dell'ombra. Lettura **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e abilita la costruzione di copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e abilita la costruzione di copia delle sottoclassi. |
...
| virtual void [set_BlurRadius](./set_blurradius/)(**double**) | [Blur](../blur/) raggio. Scrittura **double**. |
| virtual void [set_Direction](./set_direction/)(**float**) | Direzione dell'ombra. Scrittura **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Distanza dell'ombra. Scrittura **double**. |
