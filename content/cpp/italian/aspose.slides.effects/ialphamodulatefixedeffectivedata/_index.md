...
description: Oggetto immutabile che rappresenta un effetto Alpha Modulate Fixed. I valori alpha (opacità) dell'effetto sono moltiplicati per una percentuale fissa.
type: docs
weight: 378
...
| virtual **float** [get_Amount](./get_amount/)() | Restituisce una quantità dell'effetto in percentuale. Solo lettura **float**. |
