...
description: Rappresenta un effetto Fill Overlay. Un fill overlay può essere usato per specificare un riempimento aggiuntivo per un oggetto e miscelare i due riempimenti insieme.
type: docs
weight: 612
...
Rappresenta un effetto Fill Overlay. Un fill overlay può essere usato per specificare un riempimento aggiuntivo per un oggetto e miscelare i due riempimenti insieme.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Leggi [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Formato riempimento. Solo lettura [IFillFormat](../../aspose.slides/ifillformat/). |
...
| virtual void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) | FillBlendMode. Scrivi [FillBlendMode](../../aspose.slides/fillblendmode/). |
