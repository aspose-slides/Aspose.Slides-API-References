...
description: Oggetto immutabile che rappresenta un effetto di sostituzione del colore. Tutti i colori dell'effetto sono cambiati in un colore fisso. I valori alfa non sono influenzati.
type: docs
weight: 547
...
Oggetto immutabile che rappresenta un effetto di sostituzione del colore. Tutti i colori dell'effetto vengono cambiati in un colore fisso. I valori di alfa non sono influenzati.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Restituisce il formato colore che sostituirà il colore di ogni pixel. Solo lettura [System::Drawing::Color](../../system.drawing/color/). |
