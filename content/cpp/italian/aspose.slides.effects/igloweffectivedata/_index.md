...
description: Oggetto immutabile che rappresenta un effetto Glow, in cui un contorno sfocato colorato è aggiunto al di fuori dei bordi dell'oggetto.
type: docs
weight: 651
...
Oggetto immutabile che rappresenta un effetto [Glow](../glow/), in cui un contorno sfocato colorato è aggiunto al di fuori dei bordi dell'oggetto.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Colore. Sola lettura [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_Radius](./get_radius/)() | Raggio. Sola lettura **double**. |
