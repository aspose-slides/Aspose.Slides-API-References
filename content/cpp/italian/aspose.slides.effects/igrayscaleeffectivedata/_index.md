...
description: Oggetto immutabile che rappresenta un effetto in scala di grigi. Converte tutti i valori di colore dell'effetto in una sfumatura di grigio, corrispondente alla loro luminanza. I valori alfa (opacità) dell'effetto non sono influenzati.
type: docs
weight: 677
...
Oggetto immutabile che rappresenta un effetto in scala di grigi. Converte tutti i valori di colore dell'effetto in una sfumatura di grigio, corrispondente alla loro luminanza. I valori alfa (opacità) dell'effetto non sono influenzati.
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia realmente nulla, ma inizializza un nuovo oggetto e consente la copia costruttiva delle sottoclassi. |
