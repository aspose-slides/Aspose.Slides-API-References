...
description: Rappresenta un effetto Hue/Saturation/Luminance. L'hue, la saturazione e la luminanza possono essere regolati ciascuno rispetto al proprio valore corrente.
type: docs
weight: 703
url: /it/aspose.slides.effects/ihsleffectivedata/
---
## IHSLEffectiveData classe

Rappresenta un effetto Hue/Saturation/Luminance. L'hue, la saturazione e la luminanza possono essere regolati ognuno rispetto al proprio valore corrente.
...
| virtual **float** [get_Hue](./get_hue/)() | Restituisce la percentuale di hue. Sola lettura **float**. |
| virtual **float** [get_Luminance](./get_luminance/)() | Restituisce la percentuale di luminanza. Sola lettura **float**. |
| virtual **float** [get_Saturation](./get_saturation/)() | Restituisce la percentuale di saturazione. Sola lettura **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma solo inizializza un nuovo oggetto e abilita la costruzione tramite copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma solo inizializza un nuovo oggetto e abilita la costruzione tramite copia delle sottoclassi. |
