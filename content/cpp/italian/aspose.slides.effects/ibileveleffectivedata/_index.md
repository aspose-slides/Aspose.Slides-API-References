...
description: Oggetto immutabile che rappresenta un effetto Bi-Level (nero/bianco). I colori di ingresso la cui luminanza è inferiore al valore soglia specificato vengono cambiati in nero. I colori di ingresso la cui luminanza è maggiore o uguale al valore specificato vengono impostati a bianco. I valori dell'effetto alfa non sono influenzati da questo effetto.
type: docs
weight: 443
...
Oggetto immutabile che rappresenta un effetto Bi-Level (nero/bianco). I colori di ingresso la cui luminanza è inferiore al valore soglia specificato vengono cambiati in nero. I colori di ingresso la cui luminanza è maggiore o uguale al valore specificato vengono impostati a bianco. I valori dell'effetto alfa non sono influenzati da questo effetto.
...
| virtual **float** [get_Threshold](./get_threshold/)() | Restituisce il valore soglia. Sola lettura **float**. |
