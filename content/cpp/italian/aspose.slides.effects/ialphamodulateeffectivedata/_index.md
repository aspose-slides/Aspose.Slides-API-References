...
description: Oggetto immutabile che rappresenta un effetto Alpha Modulate. I valori alfa (opacità) dell'effetto vengono moltiplicati per una percentuale fissa. Il contenitore dell'effetto specifica un effetto contenente valori alfa da modulare.
type: docs
weight: 352
...
Oggetto immutabile che rappresenta un effetto Alpha Modulate. I valori di alfa (opacità) dell'effetto vengono moltiplicati per una percentuale fissa. Il contenitore dell'effetto specifica un effetto contenente valori alfa da modulare.
