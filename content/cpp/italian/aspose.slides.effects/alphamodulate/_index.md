...
description: Rappresenta un effetto Alpha Modulate. I valori alfa (opacità) dell'effetto sono moltiplicati per una percentuale fissa. Il contenitore dell'effetto specifica un effetto contenente valori alfa da modulare.
type: docs
weight: 53
...
Rappresenta un effetto Alpha Modulate. I valori di alfa (opacità) dell'effetto sono moltiplicati per una percentuale fissa. Il contenitore dell'effetto specifica un effetto contenente valori alfa da modulare.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [AlphaModulate](./) specificato è uguale al [AlphaModulate](./) corrente. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateEffectiveData](../ialphamodulateeffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene i dati dell'effetto Alpha Modulate effettivo con l'ereditarietà applicata. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del template come puntatore debole (anziché condiviso). Consente di passare i puntatori nei container alla modalità debole. |
