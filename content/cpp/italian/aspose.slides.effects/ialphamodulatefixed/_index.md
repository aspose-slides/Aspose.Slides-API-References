...
description: Rappresenta un effetto Alpha Modulate Fixed. I valori alpha (opacità) dell'effetto sono moltiplicati per una percentuale fissa.
type: docs
weight: 365
url: /it/aspose.slides.effects/ialphamodulatefixed/
---
## IAlphaModulateFixed classe

Rappresenta un effetto Alpha Modulate Fixed. I valori alpha (opacità) dell’effetto sono moltiplicati per una percentuale fissa.
...
| virtual **float** [get_Amount](./get_amount/)() | Restituisce una quantità di effetto in percentuale. Lettura **float**. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Restituisce una quantità di effetto in percentuale. Scrittura **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Consente il passaggio dei puntatori nei contenitori alla modalità debole. |
