...
description: Rappresenta un effetto Alpha Bi-Level. I valori Alpha (Opacità) inferiori alla soglia sono cambiati a 0 (completamente trasparente) e i valori alpha maggiori o uguali alla soglia sono cambiati al 100% (completamente opaco).
type: docs
weight: 235
...
Rappresenta un effetto Alpha Bi-Level. I valori Alpha (Opacità) inferiori alla soglia sono impostati a 0 (completamente trasparente) e i valori alpha maggiori o uguali alla soglia sono impostati al 100 % (completamente opaco).
...
| virtual **float** [get_Threshold](./get_threshold/)() | Restituisce la soglia dell’effetto. Lettura **float**. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Restituisce la soglia dell’effetto. Scrivi **float**. |
...
Usa [ImageTransformOperationFactory](../imagetransformoperationfactory/) per creare istanze in COM. 
