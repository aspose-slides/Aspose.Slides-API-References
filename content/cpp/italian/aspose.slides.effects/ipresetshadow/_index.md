...
description: Rappresenta un effetto Ombra predefinita.
type: docs
weight: 911
url: /it/aspose.slides.effects/ippresetshadow/
---
## classe IPresetShadow

Rappresenta un effetto Ombra predefinita.
...
| virtual **float** [get_Direction](./get_direction/)() | Direzione dell'ombra. Leggi **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distanza dell'ombra. Leggi **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Preset. Leggi [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Colore dell'ombra. Solo lettura [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Direzione dell'ombra. Scrivi **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Distanza dell'ombra. Scrivi **double**. |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | Preset. Scrivi [PresetShadowType](../../aspose.slides/presetshadowtype/). |
