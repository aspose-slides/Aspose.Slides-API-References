...
description: Rappresenta un effetto Tint. Sposta i valori di colore dell'effetto verso/lontano dalla tonalità di un ammontare specificato.
type: docs
weight: 1093
...
Rappresenta un effetto [Tint](./). Sposta i valori di colore dell’effetto verso/lontano dalla tonalità di un ammontare specificato.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [Tint](./) specificato è uguale al [Tint](./) corrente. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene i dati dell'effetto [Tint](./) effettivi con l'ereditarietà applicata. |
