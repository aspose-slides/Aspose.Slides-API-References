...
description: Oggetto immutabile che rappresenta un effetto Alpha Replace. I valori alpha (opacità) dell'effetto sono sostituiti da un alpha fisso.
type: docs
weight: 404
url: /it/aspose.slides.effects/ialphareplaceeffectivedata/
---
## classe IAlphaReplaceEffectiveData

Oggetto immutabile che rappresenta un effetto Alpha Replace. I valori alpha (opacità) dell'effetto sono sostituiti da un alpha fisso.
...
| virtual **float** [get_Alpha](./get_alpha/)() | Restituisce il nuovo valore alpha nell'intervallo [0..1] **float** di sola lettura. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e a consentire la copia dei sottoclasse. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e a consentire la copia dei sottoclasse. |
