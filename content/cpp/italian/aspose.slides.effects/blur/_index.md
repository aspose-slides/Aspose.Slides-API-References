...
description: Rappresenta un effetto Blur che viene applicato all'intera forma, compreso il riempimento. Tutti i canali di colore, compreso l'alpha, sono influenzati.
type: docs
weight: 105
...
Rappresenta un effetto [Blur](./) che viene applicato all'intera forma, compreso il riempimento. Tutti i canali di colore, compreso l'alpha, sono influenzati.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [Blur](./) specificato è uguale al [Blur](./) corrente. |
...
| **bool** [get_Grow](./get_grow/)() override | Determina se i limiti dell'oggetto devono essere ampliati a causa della sfocatura. True indica che i limiti sono ampliati, mentre false indica che non lo sono. Lettura **bool**. |
...
| **double** [get_Radius](./get_radius/)() override | Restituisce il raggio della sfocatura. Lettura **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene i dati dell'effetto [Blur](./) effettivi con l'ereditarietà applicata. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia realmente nulla, inizializza solo un nuovo oggetto e consente la costruzione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia realmente nulla, inizializza solo un nuovo oggetto e consente la costruzione di copie di sottoclassi. |
...
| void [set_Grow](./set_grow/)(**bool**) override | Determina se i limiti dell'oggetto devono essere ampliati a causa della sfocatura. True indica che i limiti sono ampliati, mentre false indica che non lo sono. Scrittura **bool**. |
| void [set_Radius](./set_radius/)(**double**) override | Imposta il raggio della sfocatura. Scrittura **double**. |
