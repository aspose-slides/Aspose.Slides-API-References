...
Rappresenta un effetto di bordo morbido. I bordi della forma sono sfocati, mentre il riempimento non viene influenzato.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [SoftEdge](./) specificato è uguale al [SoftEdge](./) corrente. |
...
| **double** [get_Radius](./get_radius/)() override | Specifica il raggio della sfocatura da applicare ai bordi. Leggi **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene i dati effettivi dell'effetto Soft Edge con l'ereditarietà applicata. |
...
| void [set_Radius](./set_radius/)(**double**) override | Specifica il raggio della sfocatura da applicare ai bordi. Scrivi **double**. |
