...
description: Rappresenta un effetto Alpha Modulate. I valori alpha (opacità) dell'effetto sono moltiplicati per una percentuale fissa. Il contenitore dell'effetto specifica un effetto contenente valori alpha da modulare.
type: docs
weight: 339
url: /it/aspose.slides.effects/ialphamodulate/
---
## IAlphaModulate classe

Rappresenta un effetto Alpha Modulate. I valori alpha (opacità) dell'effetto sono moltiplicati per una percentuale fissa. Il contenitore dell'effetto specifica un effetto contenente valori alpha da modulare.
