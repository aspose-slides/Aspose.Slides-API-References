...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [Glow](./) specificato è uguale all’attuale [Glow](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | Formato colore. Sola lettura [IColorFormat](../../aspose.slides/icolorformat/). |
...
| **double** [get_Radius](./get_radius/)() override | Raggio. Leggi **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGlowEffectiveData](../igloweffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene i dati effettivi dell'effetto [Glow](./) con l'ereditarietà applicata. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Funge da funzione hash per un tipo specifico. |
...
| void [set_Radius](./set_radius/)(**double**) override | Raggio. Scrivi **double**. |
