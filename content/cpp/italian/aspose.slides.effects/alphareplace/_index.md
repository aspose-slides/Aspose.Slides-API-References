...
description: Rappresenta un effetto Alpha Replace. I valori alpha (opacità) dell'effetto vengono sostituiti da un alpha fisso.
type: docs
weight: 79
...
Rappresenta un effetto Alpha Replace. I valori alpha (opacità) dell'effetto vengono sostituiti da un alpha fisso.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [AlphaReplace](./) specificato è uguale al [AlphaReplace](./) corrente. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplaceEffectiveData](../ialphareplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene i dati effettivi dell'effetto Alpha Replace con l'ereditarietà applicata. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un weak pointer (invece di shared). Consente di passare i puntatori nei contenitori a modalità weak. |
