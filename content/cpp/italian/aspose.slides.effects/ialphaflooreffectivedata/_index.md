...
description: Oggetto immutabile che rappresenta un effetto Alpha Floor. I valori Alpha (opacità) inferiori al 100% vengono impostati a zero. In altre parole, qualsiasi elemento parzialmente trasparente diventa totalmente trasparente.
type: docs
weight: 300
url: /it/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData classe


Oggetto immutabile che rappresenta un effetto Alpha Floor. I valori Alpha (opacità) inferiori al 100% vengono impostati a zero. In altre parole, qualsiasi elemento parzialmente trasparente diventa totalmente trasparente.
