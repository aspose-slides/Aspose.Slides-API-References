...
Rappresenta un effetto [Glow](../glow/), in cui un contorno sfocato di colore è aggiunto al di fuori dei bordi dell'oggetto.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Formato colore. Solo lettura [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Raggio. Lettura **double**. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Raggio. Scrivi **double**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa il blocco lock() di C# per sblocco. Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
