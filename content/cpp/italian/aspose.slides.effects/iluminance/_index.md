...
description: Rappresenta un effetto Luminance. La luminosità sposta linearmente tutti i colori più vicino al bianco o al nero. Il contrasto scala tutti i colori per renderli più vicini o più distanti tra loro.
type: docs
weight: 794
...
Rappresenta un effetto [Luminance](../luminance/). La luminosità sposta linearmente tutti i colori più vicino al bianco o al nero. Il contrasto scala tutti i colori per essere più vicini o più distanti tra loro.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia realmente nulla, ma semplicemente inizializza un nuovo oggetto e consente la costruzione copiativa di subclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia realmente nulla, ma semplicemente inizializza un nuovo oggetto e consente la costruzione copiativa di subclassi. |
