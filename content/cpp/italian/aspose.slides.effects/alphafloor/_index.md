...
description: Rappresenta un effetto Alpha Floor. I valori Alpha (opacità) inferiori al 100% vengono impostati a zero. In altre parole, qualsiasi elemento parzialmente trasparente diventa completamente trasparente.
type: docs
weight: 27
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [AlphaFloor](./) specificato è uguale all'[AlphaFloor](./) corrente. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene i dati dell'effetto Alpha Floor effettivo con l'ereditarietà applicata. |
...
* Classe [IAlphaFloor](../ialphafloor/)
