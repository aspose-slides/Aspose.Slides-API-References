...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Racchiude questo elemento in caratteri specifici come parentesi o altri caratteri di inquadratura |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) | Restituisce l'elemento all'indice specificato dell'array. Sola lettura [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() | L'insieme degli elementi dell'array |
| virtual [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() | Specifica l'allineamento dell'array rispetto al testo circostante. Il testo fuori dall'array può essere allineato nella parte inferiore, superiore o al centro di un oggetto array. Valore predefinito: Center |
| virtual **bool** [get_MaximumDistribution](./get_maximumdistribution/)() | Distribuzione Massima Quando vero, l'array è spaziato alla larghezza massima dell'elemento contenitore (pagina, colonna, cella, ecc.). |
| virtual **bool** [get_ObjectDistribution](./get_objectdistribution/)() | Distribuzione degli Oggetti Quando vero, il contenuto dell'array è spaziato alla larghezza massima dell'oggetto array. |
| virtual **uint32_t** [get_RowSpacing](./get_rowspacing/)() | Spaziatura tra le righe di un array. È usata solo quando RowSpacingRule è impostato a 3, nel caso esatto l'unità di misura è punti o Multiple, nel caso l'unità è mezza linea. Valore predefinito: 0 |
| virtual [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() | Il tipo di spaziatura verticale tra gli elementi dell'array |
...
| void [Lock](../../system/object/lock/)() | Implementa l'istruzione C# lock() bloccando. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza un nuovo oggetto e consente la costruzione di copie nelle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza un nuovo oggetto e consente la costruzione di copie nelle sottoclassi. |
...
| virtual void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) | Specifica l'allineamento dell'array rispetto al testo circostante. Il testo fuori dall'array può essere allineato nella parte inferiore, superiore o al centro di un oggetto array. Valore predefinito: Center |
| virtual void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) | Distribuzione Massima Quando vero, l'array è spaziato alla larghezza massima dell'elemento contenitore (pagina, colonna, cella, ecc.). |
| virtual void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) | Distribuzione degli Oggetti Quando vero, il contenuto dell'array è spaziato alla larghezza massima dell'oggetto array. |
| virtual void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) | Spaziatura tra le righe di un array. È usata solo quando RowSpacingRule è impostato a 3, nel caso esatto l'unità di misura è punti o Multiple, nel caso l'unità è mezza linea. Valore predefinito: 0 |
| virtual void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) | Il tipo di spaziatura verticale tra gli elementi dell'array |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento template a un puntatore debole (anziché condiviso). Consente lo scambio di puntatori nei contenitori in modalità debole. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)() | Posiziona questo elemento in una cornice-bordo |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Posiziona questo elemento in una cornice-bordo |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Posiziona questo elemento in una casella non visuale (raggruppamento logico) che è usata per raggruppare componenti di un'equazione o altra istanza di testo matematico. Un oggetto incorniciato può (ad esempio) servire come emulatore di operatore con o senza punto di allineamento, servire come punto di interruzione di linea, o essere raggruppato in modo da non consentire interruzioni di linea all'interno. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](./)\> [ToMathArray](../imathelement/tomatharray/)() | Inserisce in un array verticale |
...
| void [Unlock](../../system/object/unlock/)() | Implementa l'istruzione C# lock() sbloccando. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
