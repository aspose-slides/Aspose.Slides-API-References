...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() override | Argomento grado |
| **bool** [get_HideDegree](./get_hidedegree/)() override | Nasconde il grado quando è true; il grado non è mostrato, come in \\u221A\\uD835\\uDC65 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | Posiziona questo elemento in un gruppo usando un carattere di raggruppamento, come parentesi graffa inferiore o altro |
...
| void [Lock](../../system/object/lock/)() | Implementa l'istruzione lock() di C# bloccando. Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
|  [MathRadical](./mathradical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inizializza una nuova istanza della classe [MathRadical](./). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e consente la costruzione di copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e consente la costruzione di copia delle sottoclassi. |
...
| void [set_HideDegree](./set_hidedegree/)(**bool**) override | Nasconde il grado quando è true; il grado non è mostrato, come in \\u221A\\uD835\\uDC65 |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco dell'istruzione lock() di C#. Sblocca. Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
