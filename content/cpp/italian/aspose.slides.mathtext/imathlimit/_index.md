...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Limit](./get_limit/)() | Argomento limite |
| virtual **bool** [get_UpperLimit](./get_upperlimit/)() | Specifica il limite superiore o inferiore |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Inserisce questo elemento in un gruppo usando un carattere di raggruppamento, come una parentesi graffa inferiore o un altro |
...
| virtual void [set_UpperLimit](./set_upperlimit/)(**bool**) | Specifica il limite superiore o inferiore |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Prende il limite inferiore |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::String](../../system/string/)) | Prende il limite inferiore |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Prende il limite superiore |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::String](../../system/string/)) | Prende il limite superiore |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)() | Inserisce questo elemento in una casella bordata |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Inserisce questo elemento in una casella bordata |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Inserisce questo elemento in una casella non visuale (raggruppamento logico) usata per raggruppare componenti di un'equazione o altra istanza di testo matematico. Un oggetto in una casella può (ad esempio) servire come emulatore di operatore con o senza punto di allineamento, servire come punto di interruzione di linea, o essere raggruppato in modo da non consentire interruzioni di linea all'interno. |
