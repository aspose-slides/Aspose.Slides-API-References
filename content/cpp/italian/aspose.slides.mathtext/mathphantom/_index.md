...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | Imposta un segno diacritico (un carattere sulla parte superiore di questo elemento) |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Esegue la funzione specificata usando questa istanza come argomento e un argomento aggiuntivo specificato |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | Esegue la funzione specificata usando questa istanza come argomento e un argomento aggiuntivo specificato |
...
| **bool** [get_Show](./get_show/)() override | Ottiene un valore che indica se l'elemento base è visualizzato. |
| **bool** [get_Transp](./get_transp/)() override | Ottiene un valore che indica se il phantom è trasparente per le regole di spaziatura basate su classi. |
| **bool** [get_ZeroAsc](./get_zeroasc/)() override | Ottiene un valore che indica se l'ascissa (altezza sopra la linea di base) dell'elemento base deve essere considerata zero. |
| **bool** [get_ZeroDesc](./get_zerodesc/)() override | Ottiene un valore che indica se la discendente (profondità sotto la linea di base) dell'elemento base deve essere considerata zero. |
| **bool** [get_ZeroWidth](./get_zerowidth/)() override | Ottiene un valore che indica se la larghezza dell'elemento base deve essere considerata zero. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)() override | Inserisce questo elemento in un gruppo usando una graffa inferiore |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | Inserisce questo elemento in un gruppo usando un carattere di raggruppamento come una graffa inferiore o altro |
...
|  [MathPhantom](./mathphantom/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inizializza una nuova istanza della classe [MathPhantom](./) usando l'elemento matematico base specificato. |
...
| void [set_Show](./set_show/)(**bool**) override | Imposta un valore che indica se l'elemento base è visualizzato. |
| void [set_Transp](./set_transp/)(**bool**) override | Imposta un valore che indica se il phantom è trasparente per le regole di spaziatura basate su classi. |
| void [set_ZeroAsc](./set_zeroasc/)(**bool**) override | Imposta un valore che indica se l'ascissa (altezza sopra la linea di base) dell'elemento base deve essere considerata zero. |
| void [set_ZeroDesc](./set_zerodesc/)(**bool**) override | Imposta un valore che indica se la discendente (profondità sotto la linea di base) dell'elemento base deve essere considerata zero. |
| void [set_ZeroWidth](./set_zerowidth/)(**bool**) override | Imposta un valore che indica se la larghezza dell'elemento base deve essere considerata zero. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento modello come puntatore debole (invece di condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)() override | Inserisce questo elemento in una cornice di contorno |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | Inserisce questo elemento in una cornice di contorno |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Inserisce questo elemento in una scatola non visiva (raggruppamento logico) che viene usata per raggruppare componenti di un'equazione o altra istanza di testo matematico. Un oggetto incorniciato può (ad esempio) servire da emulatore di operatore con o senza punto di allineamento, servire da punto di interruzione di linea, o essere raggruppato in modo da non consentire interruzioni di linea al suo interno. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](../imatharray/)\> [ToMathArray](../mathelementbase/tomatharray/)() override | Inserisce in una matrice verticale |
...
phantom->set_Show(false); // Nascondi il contenuto
phantom->set_ZeroWidth(false); // Mantieni la larghezza
```
