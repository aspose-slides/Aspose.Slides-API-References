...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](./)\> [Accent](../imathelement/accent/)(char16_t) | Imposta un segno di accento (un carattere nella parte superiore di questo elemento) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | L'argomento a cui è stato applicato l'accento |
| virtual char16_t [get_Character](./get_character/)() | Carattere di accento. Il valore deve trovarsi nell'intervallo (U+0300\\u2013U+036F) o (U+20D0\\u2013U+20EF). Valore predefinito: Accento circumflesso combinante (U+0302) |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\> [GetChildren](../imathelement/getchildren/)() | Ottiene gli elementi figlio |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. Non copia nulla, in realtà, inizializza un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
...
| virtual void [set_Character](./set_character/)(char16_t) | Carattere di accento. Il valore deve trovarsi nell'intervallo (U+0300\\u2013U+036F) o (U+20D0\\u2013U+20EF). Valore predefinito: Accento circumflesso combinante (U+0302) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)() | Inserisce questo elemento in una casella di contorno |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Inserisce questo elemento in una casella di contorno |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Inserisce questo elemento in una casella non visuale (raggruppamento logico) usata per raggruppare componenti di un'equazione o di un altro testo matematico. Un oggetto incapsulato può (ad esempio) fungere da emulatore di operatore con o senza punto di allineamento, fungere da punto di interruzione di linea, o essere raggruppato in modo da non permettere interruzioni di linea al suo interno. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](../imatharray/)\> [ToMathArray](../imathelement/tomatharray/)() | Inserisce in una matrice verticale |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../imathelement/underbar/)() | Imposta una barra sulla parte inferiore di questo elemento |
