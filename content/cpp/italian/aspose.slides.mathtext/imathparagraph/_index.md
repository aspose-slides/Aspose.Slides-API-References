...
---
## IMathParagraph classe

Paragrafo matematico che è un contenitore per blocchi matematici ([IMathBlock](../imathblock/))
...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Add](../imathblockcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Aggiunge [IMathBlock](../imathblock/) alla fine della collezione. |
...
| virtual void [Clear](../imathblockcollection/clear/)() | Rimuove tutti gli elementi dalla collezione. |
| virtual **bool** [Contains](../imathblockcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determina se la collezione contiene un valore specifico. |
...
| virtual **int32_t** [get_Count](../imathblockcollection/get_count/)() | Restituisce il numero di elementi effettivamente contenuti nella collezione. **int32_t** sola lettura. |
| virtual [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() | [Paragraph](../../aspose.slides/paragraph/) Giustificazione Valore predefinito: CenteredAsGroup |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](../imathblockcollection/idx_get/)(**int32_t**) | Restituisce l'elemento all'indice specificato. [IMathBlock](../imathblock/) sola lettura. |
| virtual void [idx_set](../imathblockcollection/idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Restituisce l'elemento all'indice specificato. [IMathBlock](../imathblock/) sola lettura. |
| virtual **int32_t** [IndexOf](../imathblockcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determina l'indice di uno specifico [IMathBlock](../imathblock/) nella collezione. |
| virtual void [Insert](../imathblockcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Inserisce [IMathBlock](../imathblock/) nella collezione all'indice specificato. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione oppure un valore predefinito se nessun elemento corrisponde. |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco C# lock(). Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo del metodo C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Abilita la clonazione di tipi personalizzati. |
| [Object](../../system/object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la costruzione copia delle subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e abilita la costruzione copia delle subclass. |
...
| virtual **bool** [Remove](../imathblockcollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Rimuove la prima occorrenza di un oggetto specifico dalla collezione/>. |
| virtual void [RemoveAt](../imathblockcollection/removeat/)(**int32_t**) | Rimuove un elemento all'indice specificato della collezione. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimenti condivisi del valore specificato. |
| virtual void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) | [Paragraph](../../aspose.slides/paragraph/) Giustificazione Valore predefinito: CenteredAsGroup |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un weak pointer (invece che shared). Consente di modificare i puntatori nei contenitori in modalità weak. |
...
| virtual [System::String](../../system/string/) [ToLatex](./tolatex/)() | Restituisce l'equazione matematica in formato LaTeX |
...
| virtual void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Salva il contenuto di questo [IMathParagraph](./) come MathML |
...
* classe [IMathBlockCollection](../imathblockcollection/)
