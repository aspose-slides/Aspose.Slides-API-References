...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathMatrix](../imathmatrix/)\> [CreateMathMatrix](./createmathmatrix/)(**int32_t**, **int32_t**) override | Crea una matrice matematica |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento n-esimo del template come puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei container in modalità debole. |
...
* Classe [IMathMatrixFactory](../imathmatrixfactory/)
