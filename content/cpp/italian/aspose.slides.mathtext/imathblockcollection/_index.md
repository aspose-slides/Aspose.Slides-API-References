...
---
## IMathBlockCollection classe

Raccolta di blocchi matematici ([IMathBlock](../imathblock/))
...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Aggiunge [IMathBlock](../imathblock/) alla fine della raccolta. |
...
| virtual void [Clear](./clear/)() | Rimuove tutti gli elementi dalla raccolta. |
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determina se la raccolta contiene un valore specifico. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di elementi effettivamente contenuti nella raccolta. Solo lettura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce l'elemento all'indice specificato. Solo lettura [IMathBlock](../imathblock/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Restituisce l'elemento all'indice specificato. Solo lettura [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determina l'indice di un [IMathBlock](../imathblock/) specifico nella raccolta. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Inserisce [IMathBlock](../imathblock/) nella raccolta all'indice specificato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia realmente nulla, ma semplicemente inizializza un nuovo oggetto e abilita la costruzione per copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia realmente nulla, ma semplicemente inizializza un nuovo oggetto e abilita la costruzione per copia delle sottoclassi. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Rimuove la prima occorrenza di uno specifico oggetto dalla raccolta/>. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove un elemento all'indice specificato della raccolta. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco del lock() di C#. Chiamalo direttamente o utilizza l'oggetto sentinella [LockContext](../../system/lockcontext/). |
