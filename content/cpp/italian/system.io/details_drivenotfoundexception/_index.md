...
type: docs
weight: 144
url: /it/system.io/details_drivenotfoundexception/
---
## Details_DriveNotFoundException classe
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco dell'istruzione C# lock(). Chiama direttamente o utilizza l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (anziché condiviso). Consente lo scambio dei puntatori nei contenitori in modalità debole. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco dell'istruzione C# lock(). Chiama direttamente o utilizza l'oggetto sentry [LockContext](../../system/lockcontext/). |
