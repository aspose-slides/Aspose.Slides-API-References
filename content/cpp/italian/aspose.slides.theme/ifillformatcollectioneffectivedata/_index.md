...
description: Oggetto immutabile che rappresenta una raccolta di sola lettura di formati di riempimento efficaci.
type: docs
weight: 261
url: /it/aspose.slides.theme/ifillformatcollectioneffectivedata/
---
## IFillFormatCollectionEffectiveData classe

Oggetto immutabile che rappresenta una raccolta di sola lettura di formati di riempimento efficaci.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza qualificata const della raccolta. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Ottiene l'iteratore che punta al primo elemento qualificato const (se presente) della raccolta. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento qualificato const (se presente) della raccolta. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza qualificata const della raccolta. |
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Restituisce il numero di comportamenti in una raccolta. **int32_t** di sola lettura. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Restituisce un valore che indica se l'accesso alla raccolta è sincronizzato (thread-safe). **bool** di sola lettura. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Restituisce una radice di sincronizzazione. [System::Object](../../system/object/) di sola lettura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Ottiene l'elemento all'indice specificato. [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/) di sola lettura. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, ma semplicemente inizializza un nuovo oggetto e consente la costruzione per copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, ma semplicemente inizializza un nuovo oggetto e consente la costruzione per copia delle sottoclassi. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Ottiene l'implementazione del begin iterator const per il contenitore corrente. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Ottiene l'implementazione del end iterator const per il contenitore corrente. |
