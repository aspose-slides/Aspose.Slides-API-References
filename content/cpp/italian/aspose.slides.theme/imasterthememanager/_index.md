...
description: Fornisce l'accesso al master theme della presentazione.
type: docs
weight: 378
url: /it/aspose.slides.theme/imasterthememanager/
---
## IMasterThemeManager classe

Fornisce l'accesso al master theme della presentazione.
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Determina se [OverrideTheme](../overridetheme/) sovrascrive il tema efficace ereditato (Presentation.MasterTheme) o meno. Leggi **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Restituisce l'oggetto tema sovrascritto. Leggi [IMasterTheme](../imastertheme/). |
...
| virtual void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) | Determina se [OverrideTheme](../overridetheme/) sovrascrive il tema efficace ereditato (Presentation.MasterTheme) o meno. Scrivi **bool**. |
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) | Restituisce l'oggetto tema sovrascritto. Scrivi [IMasterTheme](../imastertheme/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori in modalità debole. |
