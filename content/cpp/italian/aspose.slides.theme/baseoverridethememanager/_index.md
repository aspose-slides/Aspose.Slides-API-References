...
Classe base per le classi che forniscono accesso a diversi tipi di temi sovrascritti.
...
| Metodo | Descrizione |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Applica uno schema di colori aggiuntivo a una diapositiva. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Restituisce l'oggetto tema. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Determina se [OverrideTheme](../overridetheme/) sovrascrive il tema efficace ereditato o meno. Per abilitare [OverrideTheme](../overridetheme/) per la sovrascrittura usare i metodi OverrideTheme.Init*(). Per disabilitare [OverrideTheme](../overridetheme/) dalla sovrascrittura usare il metodo [OverrideTheme::Clear](../overridetheme/clear/). Solo lettura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Restituisce l'oggetto tema sovrascritto. Leggi [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Restituisce l'oggetto tema sovrascritto. Scrivi [IOverrideTheme](../ioverridetheme/). |
...
* Classe [IOverrideThemeManager](../ioverridethememanager/)
