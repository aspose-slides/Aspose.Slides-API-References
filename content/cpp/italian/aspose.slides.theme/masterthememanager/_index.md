...
| Metodo | Descrizione |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Applica uno schema di colori extra a una diapositiva. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Determina se [OverrideTheme](../overridetheme/) sovrascrive il tema efficace ereditato ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) o meno. Leggi **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Restituisce l'oggetto tema sovrascrivente. Leggi [IMasterTheme](../imastertheme/). |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | Determina se [OverrideTheme](../overridetheme/) sovrascrive il tema efficace ereditato ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) o meno. Scrivi **bool**. |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | Restituisce l'oggetto tema sovrascrivente. Scrivi [IMasterTheme](../imastertheme/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sbocco dell'istruzione C# lock(). Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
