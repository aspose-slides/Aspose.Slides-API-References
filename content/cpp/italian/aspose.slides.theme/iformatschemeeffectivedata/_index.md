...
description: Oggetto immutabile che contiene le proprietà del formato di schema effettivo.
type: docs
weight: 313
url: /it/aspose.slides.theme/iformatschemeeffectivedata/
---
## IFormatSchemeEffectiveData classe

Oggetto immutabile che contiene le proprietà del formato di schema effettivo.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollectionEffectiveData](../ifillformatcollectioneffectivedata/)\> [GetBackgroundFillStyles](./getbackgroundfillstyles/)([System::Drawing::Color](../../system.drawing/color/)) | Restituisce una raccolta di stili di riempimento di sfondo definiti dal tema. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleCollectionEffectiveData](../ieffectstylecollectioneffectivedata/)\> [GetEffectStyles](./geteffectstyles/)([System::Drawing::Color](../../system.drawing/color/)) | Restituisce una raccolta di stili di effetto definiti dal tema. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollectionEffectiveData](../ifillformatcollectioneffectivedata/)\> [GetFillStyles](./getfillstyles/)([System::Drawing::Color](../../system.drawing/color/)) | Restituisce una raccolta di stili di riempimento definiti dal tema. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Abilita l'hashing di oggetti personalizzati. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatCollectionEffectiveData](../ilineformatcollectioneffectivedata/)\> [GetLineStyles](./getlinestyles/)([System::Drawing::Color](../../system.drawing/color/)) | Restituisce una raccolta di stili di linea definiti dal tema. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la creazione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la creazione di copie di sottoclassi. |
