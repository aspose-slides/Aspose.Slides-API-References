...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza qualificata const della collezione. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento qualificato const (se presente) della collezione. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>, **int32_t**) override | Copia tutti gli elementi dalla collezione nell'array specificato. |
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Copia tutti gli elementi dalla collezione nell'array specificato. |
| [iterator](./iterator/) [end](./end/)() | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) della collezione. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza qualificata const della collezione. |
...
| **int32_t** [get_Count](./get_count/)() override | Ottiene il numero di elementi realmente contenuti nella collezione. Solo lettura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [idx_get](./idx_get/)(**int32_t**) override | Ottiene l'elemento all'indice specificato. Solo lettura [IFillFormat](../../aspose.slides/ifillformat/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento template come weak pointer (anziché shared). Consente di passare i puntatori nei contenitori in modalità weak. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza qualificata const della collezione. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza qualificata const della collezione. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il contatore di riferimento weak. Non dovrebbe essere chiamato direttamente; utilizzare smart pointer o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il contatore di riferimento weak. Non dovrebbe essere chiamato direttamente; utilizzare smart pointer o ThisProtector. |
...
* Classe [IFillFormatCollection](../ifillformatcollection/)
