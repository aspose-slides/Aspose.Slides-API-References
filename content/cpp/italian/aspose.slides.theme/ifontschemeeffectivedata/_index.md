...
description: Oggetto immutabile che contiene le proprietà effettive dello schema di font.
type: docs
weight: 287
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Major](./get_major/)() | Restituisce la collezione di font per la parte \"heading\" della diapositiva. Sola lettura [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Minor](./get_minor/)() | Restituisce la collezione di font per la parte \"body\" della diapositiva. Sola lettura [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Restituisce il nome dello schema di font. Sola lettura [System::String](../../system/string/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia realmente nulla, si limita a inizializzare un nuovo oggetto e a consentire la copia nella costruzione delle subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia realmente nulla, si limita a inizializzare un nuovo oggetto e a consentire la copia nella costruzione delle subclass. |
