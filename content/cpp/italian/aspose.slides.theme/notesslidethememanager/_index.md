...
description: Fornisce l'accesso al tema della diapositiva note sovrascritto.
type: docs
weight: 534
...
Fornisce l'accesso al tema della diapositiva note sovrascritto.
...
| Metodo | Descrizione |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Applica uno schema di colori extra a una diapositiva. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../baseoverridethememanager/createthemeeffective/)() override | Restituisce l'oggetto tema. |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Determina se [OverrideTheme](../overridetheme/) sovrascrive il tema efficace ereditato o meno. Per abilitare [OverrideTheme](../overridetheme/) per la sovrascrittura, utilizzare i metodi OverrideTheme.Init*(). Per disabilitare [OverrideTheme](../overridetheme/) dalla sovrascrittura, utilizzare il metodo [OverrideTheme::Clear](../overridetheme/clear/). Solo lettura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Restituisce l'oggetto tema sovrascritto. Leggi [IOverrideTheme](../ioverridetheme/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e abilita la costruzione di copie per le subclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e abilita la costruzione di copie per le subclassi. |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Restituisce l'oggetto tema sovrascritto. Scrivi [IOverrideTheme](../ioverridetheme/). |
