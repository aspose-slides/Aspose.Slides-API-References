...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | Restituisce uno schema di colore. Sola lettura [IColorScheme](../icolorscheme/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Restituisce il nome di questo schema. Sola lettura [System::String](../../system/string/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento template a un puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
* Classe [IExtraColorScheme](../iextracolorscheme/)
