...
description: Fornisce l'accesso al tema della diapositiva layout sovrascritto.
type: docs
weight: 482
...
Fornisce l'accesso al tema della diapositiva layout sovrascritto.
...
| Metodo | Descrizione |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Applica uno schema di colore aggiuntivo a una diapositiva. |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Determina se [OverrideTheme](../overridetheme/) sovrascrive il tema efficace ereditato o meno. Per abilitare [OverrideTheme](../overridetheme/) per la sovrascrittura, utilizza i metodi OverrideTheme.Init*(). Per disabilitare [OverrideTheme](../overridetheme/) dalla sovrascrittura, usa il metodo [OverrideTheme::Clear](../overridetheme/clear/). Solo lettura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Restituisce l'oggetto tema di sovrascrittura. Leggi [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Restituisce l'oggetto tema di sovrascrittura. Scrivi [IOverrideTheme](../ioverridetheme/). |
