...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | Restituisce lo schema di colore aggiuntivo all'indice specificato. Questo schema non influisce sull'aspetto della presentazione, può essere selezionato come schema di colore principale per una diapositiva. Solo lettura [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | Restituisce la collezione di schemi di colore aggiuntivi. Questi schemi non influiscono sull'aspetto della presentazione, possono essere selezionati come schema di colore principale per una diapositiva. Solo lettura [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Restituisce il nome di un tema. Leggi [System::String](../../system/string/). |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Restituisce il nome di un tema. Scrivi [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n'th argomento del modello a un puntatore debole (invece che condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
