...
description: Classe base per le classi che forniscono accesso a diversi tipi di temi.
type: docs
weight: 14
...
Classe base per le classi che forniscono accesso a diversi tipi di temi.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita ad inizializzare un nuovo oggetto e abilita la costruzione di copie per le sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita ad inizializzare un nuovo oggetto e abilita la costruzione di copie per le sottoclassi. |
