...
description: Risolve risorse XML esterne nominate da un Uniform Resource Identifier (URI).
type: docs
weight: 534
url: /it/system.xml/xmlurlresolver/
---
## XmlUrlResolver classe

Risolvi risorse XML esterne nominate da un Uniform Resource Identifier (URI).
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) override | Mappa un URI a un oggetto che contiene la risorsa effettiva. |
...
| [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | Risolvi l'URI assoluto dalla base e dagli URI relativi. |
| void [set_CachePolicy](./set_cachepolicy/)(const [SharedPtr](../../system/sharedptr/)\<[Net::Cache::RequestCachePolicy](../../system.net.cache/requestcachepolicy/)\>\&) | Imposta la politica di cache per l'oggetto WebRequest sottostante. |
| void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) override | Imposta le credenziali utilizzate per autenticare le richieste web. |
| void [set_Proxy](./set_proxy/)(const [SharedPtr](../../system/sharedptr/)\<[Net::IWebProxy](../../system.net/iwebproxy/)\>\&) | Imposta il proxy di rete per l'oggetto WebRequest sottostante. |
...
| virtual **bool** [SupportsType](../xmlresolver/supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Consente al risolutore di restituire tipi diversi da Stream. |
...
* Classe [XmlResolver](../xmlresolver/)
