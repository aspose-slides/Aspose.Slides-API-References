...
description: Fornisce metodi di manipolazione del testo utilizzati da diverse classi.
type: docs
weight: 118
url: /it/system.xml/xmlcharacterdata/
---
## XmlCharacterData classe

Fornisce metodi di manipolazione del testo che sono utilizzati da diverse classi.
...
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | Aggiunge la stringa specificata alla fine dei dati dei caratteri del nodo. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Crea un duplicato del nodo, quando sovrascritto in una classe derivata. |
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | Crea uno XPathNavigator per navigare questo oggetto. |
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | Rimuove un intervallo di caratteri dal nodo. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | Restituisce i dati del nodo. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Restituisce un valore che indica se questo nodo ha figli. |
...
| virtual **int32_t** [get_Length](./get_length/)() | Restituisce la lunghezza dei dati, in caratteri. |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Restituisce il nome locale del nodo, quando sovrascritto in una classe derivata. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Restituisce il nome qualificato del nodo, quando sovrascritto in una classe derivata. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Restituisce il tipo del nodo corrente, quando sovrascritto in una classe derivata. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce l'infoset di post-validazione dello schema assegnato a questo nodo come risultato della validazione dello schema. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Restituisce un enumeratore che itera attraverso i nodi figlio del nodo corrente. |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | Inserisce la stringa specificata all'offset di carattere specificato. |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Sostituisce il numero specificato di caratteri a partire dall'offset specificato con la stringa specificata. |
...
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | Imposta i dati del nodo. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n'th argomento template come un puntatore debole (invece di condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | Recupera una sottostringa della stringa completa nell'intervallo specificato. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Salva tutti i nodi figlio del nodo nel [XmlWriter](../xmlwriter/) specificato, quando sovrascritto in una classe derivata. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Salva il nodo corrente nel [XmlWriter](../xmlwriter/) specificato, quando sovrascritto in una classe derivata. |
