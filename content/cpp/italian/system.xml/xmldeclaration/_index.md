...
description: Rappresenta il nodo dichiarazione XML <?xml version='1.0'...?>.
type: docs
weight: 170
url: /it/system.xml/xmldeclaration/
---
## XmlDeclaration class


Rappresenta il nodo dichiarazione XML **<?xml version='1.0'...?>**.
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Restituisce il livello di codifica del documento XML. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/) override | Restituisce i valori concatenati del [XmlDeclaration](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce il infoset di post-validazione schema assegnato a questo nodo a seguito della validazione dello schema. |
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Restituisce il valore dell'attributo standalone. |
| [String](../../system/string/) [get_Value](./get_value/) override | Restituisce il valore del [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Restituisce la versione XML del documento. |
...
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per l'URI del namespace fornito che è in ambito per il nodo corrente e restituisce il prefisso definito nella dichiarazione. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Posiziona tutti i nodi [XmlText](../xmltext/) nella profondità completa del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma "normale" dove solo il markup (cioè tag, commenti, istruzioni di elaborazione, sezioni CDATA e riferimenti a entità) separa i nodi [XmlText](../xmltext/), cioè non ci sono nodi [XmlText](../xmltext/) adiacenti. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Aggiunge il nodo specificato all'inizio dell'elenco dei nodi figli di questo nodo. |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Imposta il livello di codifica del documento XML. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Imposta i valori concatenati del [XmlDeclaration](./). |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Imposta il valore dell'attributo standalone. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Imposta il valore del [XmlDeclaration](./). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa il conteggio di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; invece, usare smart pointers o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e restituisce il conteggio di riferimenti condivisi. Non dovrebbe essere chiamato direttamente; invece, usare smart pointers o ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco della istruzione C# lock(). Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il conteggio di riferimenti weak. Non dovrebbe essere chiamato direttamente; invece, usare smart pointers o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il conteggio di riferimenti weak. Non dovrebbe essere chiamato direttamente; invece, usare smart pointers o ThisProtector. |
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva i figli del nodo nel [XmlWriter](../xmlwriter/) specificato. Poiché i nodi [XmlDeclaration](./) non hanno figli, questo metodo non ha effetto. |
