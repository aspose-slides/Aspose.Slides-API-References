...
description: Rappresenta un oggetto leggero utile per le operazioni di inserimento di alberi.
type: docs
weight: 196
url: /it/system.xml/xmldocumentfragment/
---
## XmlDocumentFragment classe

Rappresenta un oggetto leggero utile per le operazioni di inserimento di alberi.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Ottiene un iteratore che punta al primo elemento (se presente) dell'istanza con qualificatore const della collezione. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Ottiene un iteratore che punta al primo elemento con qualificatore const (se presente) della collezione. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento con qualificatore const (se presente) della collezione. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza con qualificatore const della collezione. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Restituisce un valore che indica se questo nodo ha nodi figli. |
...
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Restituisce il markup che rappresenta i figli di questo nodo. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Restituisce il markup che contiene questo nodo e tutti i suoi nodi figli. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce l'infoset di post-validazione dello schema che è stato assegnato a questo nodo a seguito della validazione dello schema. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Restituisce un enumeratore che itera i nodi figli nel nodo corrente. |
...
| void [Lock](../../system/object/lock/)() | Implementa il lock() di C# per il bloccaggio. Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo del metodo C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Consente la clonazione di tipi personalizzati. |
| virtual void [Normalize](../xmlnode/normalize/)() | Inserisce tutti i nodi [XmlText](../xmltext/) nella profondità completa del sottoalbero sotto questo [XmlNode](../xmlnode/) in una forma "normale" dove solo il markup (cioè tag, commenti, istruzioni di elaborazione, sezioni CDATA e riferimenti di entità) separa i nodi [XmlText](../xmltext/), ovvero non ci sono nodi [XmlText](../xmltext/) adiacenti. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Imposta i valori concatenati del nodo e di tutti i suoi nodi figli. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Imposta il markup che rappresenta i figli di questo nodo. |
...
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Verifica se l'implementazione DOM implementa una caratteristica specifica. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva tutti i figli del nodo nello [XmlWriter](../xmlwriter/) specificato. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva il nodo nello [XmlWriter](../xmlwriter/) specificato. |
...
Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Mai creare istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare tale puntatore per passarlo alle funzioni come argomento.
