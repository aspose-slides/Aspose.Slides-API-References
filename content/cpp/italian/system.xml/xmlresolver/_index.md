...
description: Risolve le risorse XML esterne identificate da un Uniform Resource Identifier (URI).
type: docs
weight: 456
url: /it/system.xml/xmlresolver/
---
## XmlResolver classe

Risolvi le risorse XML esterne identificate da un Uniform Resource Identifier (URI).
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) | Quando sovrascritto in una classe derivata, associa un URI a un oggetto che contiene la risorsa reale. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | Quando sovrascritto in una classe derivata, risolve l'URI assoluto a partire dagli URI base e relativi. |
| virtual void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | Quando sovrascritto in una classe derivata, imposta le credenziali usate per autenticare le richieste web. |
...
| virtual **bool** [SupportsType](./supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Consente al risolutore di restituire tipi diversi da Stream. |
