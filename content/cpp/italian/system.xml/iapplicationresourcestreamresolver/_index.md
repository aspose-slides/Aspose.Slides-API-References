...
description: Rappresenta un risolutore di stream di risorse dell'applicazione.
type: docs
weight: 14
url: /it/system.xml/iapplicationresourcestreamresolver/
---
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Restituisce un flusso di risorse dell'applicazione dall'URI specificato. |
