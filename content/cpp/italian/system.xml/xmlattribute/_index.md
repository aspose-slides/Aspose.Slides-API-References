...
description: Rappresenta un attributo. I valori validi e predefiniti per l'attributo sono definiti in una definizione di tipo documento (DTD) o schema.
type: docs
weight: 79
url: /it/system.xml/xmlattribute/
---
## XmlAttribute classe
...
| Metodo | Descrizione |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](./appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Aggiunge il nodo specificato alla fine dell'elenco dei nodi figli di questo nodo. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Restituisce l'Uniform Resource Identifier (URI) di base del nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](../xmlnode/get_childnodes/)() | Restituisce tutti i nodi figli del nodo. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Restituisce un valore che indica se questo nodo ha dei nodi figli. |
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Restituisce i valori concatenati del nodo e di tutti i suoi nodi figli. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Restituisce il markup che rappresenta solo i nodi figli di questo nodo. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Restituisce il markup contenente questo nodo e tutti i suoi nodi figli. |
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() override | Restituisce il [XmlDocument](../xmldocument/) a cui appartiene questo nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [get_OwnerElement](./get_ownerelement/)() | Restituisce il [XmlElement](../xmlelement/) a cui appartiene l'attributo. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Restituisce il post-schema-validation-infoset che è stato assegnato a questo nodo a seguito della validazione dello schema. |
| virtual **bool** [get_Specified](./get_specified/)() | Restituisce un valore che indica se il valore dell'attributo è stato impostato esplicitamente. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Restituisce il valore del nodo. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Restituisce un enumeratore che itera attraverso i nodi figli nel nodo corrente. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Consente l'hashing di oggetti personalizzati. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per il prefisso fornito che è nel contesto del nodo corrente e restituisce l'URI dello spazio dei nomi nella dichiarazione. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per l'URI dello spazio dei nomi fornito che è nel contesto del nodo corrente e restituisce il prefisso definito in tale dichiarazione. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Restituisce il primo elemento figlio con i valori specificati [XmlNode::get_LocalName](../xmlnode/get_localname/) e [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Inserisce il nodo specificato immediatamente dopo il nodo di riferimento specificato. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Inserisce il nodo specificato immediatamente prima del nodo di riferimento specificato. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Sistema tutti i nodi [XmlText](../xmltext/) nella piena profondità del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma "normale" dove solo il markup (cioè, tag, commenti, istruzioni di elaborazione, sezioni CDATA e riferimenti a entità) separa i nodi [XmlText](../xmltext/), ovvero non ci sono nodi [XmlText](../xmltext/) adiacenti. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Aggiunge il nodo specificato all'inizio dell'elenco dei nodi figli per questo nodo. |
...
| virtual void [RemoveAll](../xmlnode/removeall/)() | Rimuove tutti i nodi figli e/o gli attributi del nodo corrente. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Rimuove il nodo figlio specificato. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Sostituisce il nodo figlio specificato con il nuovo nodo figlio specificato. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&) | Seleziona una lista di nodi che corrispondono all'espressione [XPath](../../system.xml.xpath/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Seleziona una lista di nodi che corrispondono all'espressione [XPath](../../system.xml.xpath/). Qualsiasi prefisso trovato nell'espressione [XPath](../../system.xml.xpath/) è risolto usando il [XmlNamespaceManager](../xmlnamespacemanager/) fornito. |
...
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Imposta il valore dell'attributo. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | Imposta il prefisso dello spazio dei nomi di questo nodo. |
...
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Verifica se l'implementazione DOM implementa una specifica funzionalità. |
...
Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò potrebbe causare errori di runtime e/o errori di assert. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarla alle funzioni come argomento. 
