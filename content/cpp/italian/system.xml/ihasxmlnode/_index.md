...
description: Consente a una classe di restituire un XmlNode dal contesto o dalla posizione corrente.
type: docs
weight: 27
url: /it/system.xml/ihasxmlnode/
---
## IHasXmlNode classe

Consente a una classe di restituire un [XmlNode](../xmlnode/) dal contesto o dalla posizione corrente.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | Restituisce il [XmlNode](../xmlnode/) per la posizione corrente. |
