...
description: Fornisce accesso in sola lettura a un insieme di mappature prefisso e namespace.
type: docs
weight: 53
url: /it/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver classe

Fornisce accesso in sola lettura a un insieme di mappature prefisso e namespace.
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Restituisce l'URI del namespace associato al prefisso specificato. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Restituisce il prefisso associato all'URI del namespace specificato. |
