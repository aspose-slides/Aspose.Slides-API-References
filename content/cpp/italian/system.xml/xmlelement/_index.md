...
description: Rappresenta un elemento.
type: docs
weight: 222
url: /it/system.xml/xmlelement/
---
## XmlElement classe
...
| virtual [String](../../system/string/) [get_BaseURI](../xmlnode/get_baseuri/)() | Restituisce l'URI base del nodo corrente. |
...
| virtual **bool** [get_HasAttributes](./get_hasattributes/)() | Restituisce un valore **bool** che indica se il nodo corrente ha attributi. |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Restituisce un valore che indica se questo nodo ha nodi figlio. |
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Restituisce i valori concatenati del nodo e di tutti i suoi figli. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Restituisce il markup che rappresenta solo i figli di questo nodo. |
| **bool** [get_IsEmpty](./get_isempty/)() | Restituisce il formato del tag dell'elemento. |
...
| [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() override | Restituisce l'URI dello spazio dei nomi di questo nodo. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Restituisce il markup contenente questo nodo e tutti i suoi nodi figlio. |
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() override | Restituisce il [XmlDocument](../xmldocument/) a cui questo nodo appartiene. |
...
| [String](../../system/string/) [get_Prefix](./get_prefix/)() override | Restituisce il prefisso dello spazio dei nomi di questo nodo. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Restituisce l'infoset post-validazione dello schema che è stato assegnato a questo nodo in seguito alla validazione dello schema. |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | Restituisce il valore del nodo. |
| virtual [String](../../system/string/) [GetAttribute](./getattribute/)([String](../../system/string/)) | Restituisce il valore dell'attributo con il nome specificato. |
| virtual [String](../../system/string/) [GetAttribute](./getattribute/)([String](../../system/string/), [String](../../system/string/)) | Restituisce il valore dell'attributo con il nome locale e l'URI dello spazio dei nomi specificati. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [GetAttributeNode](./getattributenode/)([String](../../system/string/)) | Restituisce il [XmlAttribute](../xmlattribute/) con il nome specificato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [GetAttributeNode](./getattributenode/)([String](../../system/string/), [String](../../system/string/)) | Restituisce il [XmlAttribute](../xmlattribute/) con il nome locale e l'URI dello spazio dei nomi specificati. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/)) | Restituisce un [XmlNodeList](../xmlnodelist/) contenente un elenco di tutti gli elementi discendenti che corrispondono al [XmlElement::get_Name](./get_name/) specificato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/), [String](../../system/string/)) | Restituisce un [XmlNodeList](../xmlnodelist/) contenente un elenco di tutti gli elementi discendenti che corrispondono ai valori [XmlElement::get_LocalName](./get_localname/) e [XmlElement::get_NamespaceURI](./get_namespaceuri/) specificati. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Restituisce un enumeratore che itera sui nodi figlio nel nodo corrente. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Consente l'hashing di oggetti personalizzati. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per il prefisso dato che è in ambito per il nodo corrente e restituisce l'URI dello spazio dei nomi nella dichiarazione. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per l'URI dello spazio dei nomi dato che è in ambito per il nodo corrente e restituisce il prefisso definito in quella dichiarazione. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ottiene il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [HasAttribute](./hasattribute/)([String](../../system/string/)) | Determina se il nodo corrente ha un attributo con il nome specificato. |
| virtual **bool** [HasAttribute](./hasattribute/)([String](../../system/string/), [String](../../system/string/)) | Determina se il nodo corrente ha un attributo con il nome locale e l'URI dello spazio dei nomi specificati. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](./)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Restituisce il primo elemento figlio con il [XmlNode::get_Name](../xmlnode/get_name/) specificato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](./)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Restituisce il primo elemento figlio con i valori [XmlNode::get_LocalName](../xmlnode/get_localname/) e [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) specificati. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Inserisce il nodo specificato subito dopo il nodo di riferimento specificato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Inserisce il nodo specificato subito prima del nodo di riferimento specificato. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione oppure un valore predefinito se nessun elemento viene trovato. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Posiziona tutti i nodi [XmlText](../xmltext/) a tutta profondità del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma \"normale\" in cui solo il markup (cioè tag, commenti, istruzioni di elaborazione, sezioni CDATA e riferimenti a entità) separa i nodi [XmlText](../xmltext/), ovvero non ci sono nodi [XmlText](../xmltext/) adiacenti. |
|  [Object](../../system/object/object/)() | Crea un oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare il nuovo oggetto e consente la costruzione di copie delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita a inizializzare il nuovo oggetto e consente la costruzione di copie delle sottoclassi. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Aggiunge il nodo specificato all'inizio dell'elenco di nodi figlio per questo nodo. |
...
| void [RemoveAll](./removeall/)() override | Rimuove tutti gli attributi e i figli specificati del nodo corrente. Gli attributi predefiniti non vengono rimossi. |
| virtual void [RemoveAllAttributes](./removeallattributes/)() | Rimuove tutti gli attributi specificati dall'elemento. Gli attributi predefiniti non vengono rimossi. |
| virtual void [RemoveAttribute](./removeattribute/)([String](../../system/string/)) | Rimuove un attributo per nome. |
| virtual void [RemoveAttribute](./removeattribute/)([String](../../system/string/), [String](../../system/string/)) | Rimuove un attributo con il nome locale e l'URI dello spazio dei nomi specificati. (Se l'attributo rimosso ha un valore predefinito, viene immediatamente sostituito). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveAttributeAt](./removeattributeat/)(**int32_t**) | Rimuove il nodo attributo con l'indice specificato dall'elemento. (Se l'attributo rimosso ha un valore predefinito, viene immediatamente sostituito). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAttributeNode](./removeattributenode/)([SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>) | Rimuove il [XmlAttribute](../xmlattribute/) specificato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAttributeNode](./removeattributenode/)([String](../../system/string/), [String](../../system/string/)) | Rimuove il [XmlAttribute](../xmlattribute/) specificato dal nome locale e dall'URI dello spazio dei nomi. (Se l'attributo rimosso ha un valore predefinito, viene immediatamente sostituito). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il conteggio di riferimento condiviso di un valore specificato. |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Imposta i valori concatenati del nodo e di tutti i suoi figli. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Imposta il markup che rappresenta solo i figli di questo nodo. |
| void [set_IsEmpty](./set_isempty/)(**bool**) | Imposta il formato del tag dell'elemento. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | Imposta il prefisso di spazio dei nomi di questo nodo. |
| virtual void [set_Value](../xmlnode/set_value/)([String](../../system/string/)) | Imposta il valore del nodo. |
| virtual void [SetAttribute](./setattribute/)([String](../../system/string/), [String](../../system/string/)) | Imposta il valore dell'attributo con il nome specificato. |
| virtual [String](../../system/string/) [SetAttribute](./setattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Imposta il valore dell'attributo con il nome locale e l'URI dello spazio dei nomi specificati. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [SetAttributeNode](./setattributenode/)([SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>) | Aggiunge il [XmlAttribute](../xmlattribute/) specificato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [SetAttributeNode](./setattributenode/)([String](../../system/string/), [String](../../system/string/)) | Aggiunge il [XmlAttribute](../xmlattribute/) specificato. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa il conteggio di riferimento condiviso. Non dovrebbe essere chiamato direttamente; invece, utilizzare i puntatori intelligenti o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e restituisce il conteggio di riferimento condiviso. Non dovrebbe essere chiamato direttamente; invece, utilizzare i puntatori intelligenti o ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il conteggio di riferimento debole. Non dovrebbe essere chiamato direttamente; invece, utilizzare i puntatori intelligenti o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il conteggio di riferimento debole. Non dovrebbe essere chiamato direttamente; invece, utilizzare i puntatori intelligenti o ThisProtector. |
...
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva il nodo corrente nel [XmlWriter](../xmlwriter/) specificato. |
