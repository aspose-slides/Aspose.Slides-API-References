...
description: Rappresenta un'istruzione di elaborazione, che XML definisce per mantenere informazioni specifiche del processore nel testo del documento.
type: docs
weight: 404
url: /it/system.xml/xmlprocessinginstruction/
---
...
| Metodo | Descrizione |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Aggiunge il nodo specificato alla fine dell'elenco dei nodi child di questo nodo. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula il confronto di numeri in virgola mobile in stile C# dove due NaN sono considerati uguali pur se, secondo IEC 60559:1989, NaN non è uguale a nessun valore, incluso NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula il confronto di numeri in virgola mobile in stile C# dove due NaN sono considerati uguali pur se, secondo IEC 60559:1989, NaN non è uguale a nessun valore, incluso NaN. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](../xmlnode/get_childnodes/)() | Restituisce tutti i nodi child del nodo. |
| [String](../../system/string/) [get_Data](./get_data/)() | Restituisce il contenuto dell'istruzione di elaborazione, escludendo il target. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Restituisce il primo nodo child del nodo. |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Restituisce un valore che indica se questo nodo ha dei nodi child. |
...
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Restituisce il markup che rappresenta solo i nodi child di questo nodo. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Restituisce un valore che indica se il nodo è di sola lettura. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Restituisce l'ultimo nodo child del nodo. |
...
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Restituisce l'URI del namespace di questo nodo. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Restituisce il markup contenente questo nodo e tutti i suoi nodi child. |
...
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Restituisce il prefisso del namespace di questo nodo. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce l'infoset post-validazione schema assegnato a questo nodo come risultato della validazione dello schema. |
| [String](../../system/string/) [get_Target](./get_target/)() | Restituisce il target dell'istruzione di elaborazione. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Restituisce un enumeratore che itera attraverso i nodi child del nodo corrente. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Consente l'hashing di oggetti personalizzati. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per il prefisso fornito, che è in ambito per il nodo corrente, e restituisce l'URI del namespace nella dichiarazione. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per l'URI del namespace fornito, che è in ambito per il nodo corrente, e restituisce il prefisso definito in tale dichiarazione. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Restituisce il primo elemento child con il [XmlNode::get_Name](../xmlnode/get_name/) specificato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Restituisce il primo elemento child con i valori [XmlNode::get_LocalName](../xmlnode/get_localname/) e [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) specificati. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se nessun elemento è trovato. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Trasforma tutti i nodi [XmlText](../xmltext/) nella profondità completa del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma "normale" dove solo il markup (ovvero tag, commenti, istruzioni di elaborazione, sezioni CDATA e riferimenti di entità) separa i nodi [XmlText](../xmltext/), cioè non ci sono nodi [XmlText](../xmltext/) adiacenti. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Aggiunge il nodo specificato all'inizio dell'elenco dei nodi child per questo nodo. |
...
| virtual void [RemoveAll](../xmlnode/removeall/)() | Rimuove tutti i nodi child e/o gli attributi del nodo corrente. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](../xmlnode/removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Rimuove il nodo child specificato. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimenti condiviso del valore specificato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](../xmlnode/replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Sostituisce il nodo child **oldChild** con il nodo **newChild**. |
...
| void [set_Data](./set_data/)(const [String](../../system/string/)\&) | Imposta il contenuto dell'istruzione di elaborazione, escludendo il target. |
...
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Imposta il markup che rappresenta solo i nodi child di questo nodo. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Imposta il prefisso del namespace di questo nodo. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Imposta il valore del nodo. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento modello come weak pointer (anziché shared). Consente di passare i puntatori nei contenitori alla modalità weak. |
| int [SharedCount](../../system/object/sharedcount/)() const | Restituisce il valore corrente del contatore di riferimenti condiviso. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa il contatore di riferimenti condiviso. Non dovrebbe essere chiamato direttamente; invece, usare smart pointer o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e restituisce il contatore di riferimenti condiviso. Non dovrebbe essere chiamato direttamente; invece, usare smart pointer o ThisProtector. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Verifica se l'implementazione DOM supporta una caratteristica specifica. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Restituisce l'implementazione dell'iteratore begin const per il contenitore corrente. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Restituisce l'implementazione dell'iteratore end const per il contenitore corrente. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva tutti i figli del nodo nel [XmlWriter](../xmlwriter/) specificato. Poiché i nodi ProcessingInstruction non hanno figli, questo metodo non ha effetto. |
