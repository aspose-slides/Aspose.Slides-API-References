...
description: Rappresenta un nodo di riferimento di entità.
type: docs
weight: 248
url: /it/system.xml/xmlentityreference/
---
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce il post-schema validation infoset assegnato a questo nodo in seguito alla validazione dello schema. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se non si trova alcun elemento. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Inserisce tutti i nodi [XmlText](../xmltext/) nella completa profondità del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma "normale" dove solo il markup (cioè tag, commenti, istruzioni di processamento, sezioni CDATA e riferimenti a entità) separa i nodi [XmlText](../xmltext/), ovvero non ci sono nodi [XmlText](../xmltext/) adiacenti. |
