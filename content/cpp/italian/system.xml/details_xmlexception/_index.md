...
description: Restituisce informazioni dettagliate sull'ultima eccezione.
type: docs
weight: 1
url: /it/system.xml/details_xmlexception/
---
## Details_XmlException classe
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Restituisce il numero di riga che indica dove si è verificato l'errore. I numeri di riga iniziano da 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Restituisce la posizione nella riga che indica dove si è verificato l'errore. La posizione nella riga inizia da 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Restituisce un messaggio che descrive l'eccezione corrente. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Restituisce la posizione del file XML. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia realmente nulla, inizializza semplicemente un nuovo oggetto e consente la copia di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. Non copia realmente nulla, inizializza semplicemente un nuovo oggetto e consente la copia di sottoclassi. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Imposta HRESULT, un valore numerico codificato assegnato a un'eccezione specifica. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (anziché condiviso). Consente di passare i puntatori nei container alla modalità debole. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementa il metodo [what()](../../system/details_exception/what/) che è chiamato dalla classe [ExceptionWrapper](../../system/exceptionwrapper/). Nonostante questa classe non erediti da std::exception, le classi derivate possono usare membri protetti/privacy per implementare la loro logica. Spostare l'implementazione di questo metodo nel [ExceptionWrapper](../../system/exceptionwrapper/) potrebbe rompere quella logica. |
