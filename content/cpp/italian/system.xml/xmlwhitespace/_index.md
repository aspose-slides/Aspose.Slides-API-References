...
description: Rappresenta gli spazi bianchi nel contenuto dell'elemento.
type: docs
weight: 560
url: /it/system.xml/xmlwhitespace/
---
## XmlWhitespace classe

Rappresenta gli spazi bianchi nel contenuto dell'elemento.
...
| Metodo | Descrizione |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Aggiunge il nodo specificato alla fine dell'elenco dei nodi figli di questo nodo. |
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Appende la stringa specificata alla fine dei dati di carattere del nodo. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Ottiene un iteratore che punta al primo elemento (se presente) dell'istanza const della collezione. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Ottiene un iteratore che punta al primo elemento const (se presente) della collezione. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento const (se presente) della collezione. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza const della collezione. |
...
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Restituisce un valore che indica se il nodo è in sola lettura. |
...
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Restituisce il tipo del nodo. |
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Restituisce il markup che contiene questo nodo e tutti i suoi figli. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce l'insieme di informazioni post-validazione schema assegnato a questo nodo a seguito della validazione dello schema. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Restituisce il valore del nodo. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Restituisce un enumeratore che itera sui nodi figli nel nodo corrente. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Restituisce il primo elemento figlio con lo [XmlNode::get_Name](../xmlnode/get_name/) specificato. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Inserisce la stringa specificata all'offset di carattere indicato. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Colloca tutti i nodi [XmlText](../xmltext/) nella profondità completa del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma \"normale\" dove solo il markup (cioè tag, commenti, istruzioni di processamento, sezioni CDATA e riferimenti a entità) separa i nodi [XmlText](../xmltext/), ovvero non ci sono nodi [XmlText](../xmltext/) adiacenti. |
|  [Object](../../system/object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza un nuovo oggetto e consente la copia dei sottotipi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza un nuovo oggetto e consente la copia dei sottotipi. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Aggiunge il nodo specificato all'inizio dell'elenco dei nodi figli per questo nodo. |
...
| virtual void [RemoveAll](../xmlnode/removeall/)() | Rimuove tutti i nodi e/o gli attributi figli del nodo corrente. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Sostituisce il numero specificato di caratteri a partire dall'offset indicato con la stringa specificata. |
...
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Imposta il markup che rappresenta solo i nodi figli di questo nodo. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Imposta il prefisso dello spazio dei nomi di questo nodo. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Imposta il valore del nodo. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei container in modalità debole. |
...
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Verifica se l'implementazione DOM implementa una funzionalità specifica. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva tutti i figli del nodo nell'[XmlWriter](../xmlwriter/) specificato. |
...
Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherebbe errori a runtime e/o violazioni di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarla alle funzioni come argomento.
