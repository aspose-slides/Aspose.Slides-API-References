...
description: Rappresenta la dichiarazione del tipo di documento.
type: docs
weight: 209
url: /it/system.xml/xmldocumenttype/
---
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula il confronto di virgolette in stile C# dove due NaN sono considerati uguali anche se, secondo IEC 60559:1989, NaN non è uguale a nessun valore, incluso NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula il confronto di virgolette in stile C# dove due NaN sono considerati uguali anche se, secondo IEC 60559:1989, NaN non è uguale a nessun valore, incluso NaN. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Entities](./get_entities/)() | Restituisce la collezione di nodi [XmlEntity](../xmlentity/) dichiarati nella dichiarazione del tipo di documento. |
...
| [String](../../system/string/) [get_InternalSubset](./get_internalsubset/)() | Restituisce il valore del sottoinsieme interno della definizione del tipo di documento (DTD) nella dichiarazione DOCTYPE. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | Restituisce un valore che indica se il nodo è di sola lettura. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Restituisce il nodo subito dopo questo nodo. |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Restituisce il tipo del nodo corrente. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Notations](./get_notations/)() | Restituisce la collezione di nodi [XmlNotation](../xmlnotation/) presenti nella dichiarazione del tipo di documento. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](../xmlnode/get_ownerdocument/)() | Restituisce il [XmlDocument](../xmldocument/) a cui questo nodo appartiene. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Restituisce il valore dell'identificatore pubblico nella dichiarazione DOCTYPE. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce il infoset post-validazione dello schema assegnato a questo nodo a seguito della validazione dello schema. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Restituisce il valore dell'identificatore di sistema nella dichiarazione DOCTYPE. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | Filtra gli elementi della sequenza basandosi sul tipo specificato. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtra una sequenza basandosi sul predicato specificato. |
| void [Lock](../../system/object/lock/)() | Implementa il lock() di C# bloccando. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo del metodo C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Consente la clonazione di tipi personalizzati. |
| virtual void [Normalize](../xmlnode/normalize/)() | Sposta tutti i nodi [XmlText](../xmltext/) nella profondità completa del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma "normale" dove solo il markup (cioè tag, commenti, istruzioni di processamento, sezioni CDATA e riferimenti di entità) separa i nodi [XmlText](../xmltext/), ovvero non ci sono nodi [XmlText](../xmltext/) adiacenti. |
|  [Object](../../system/object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la costruzione di copie nelle subclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la costruzione di copie nelle subclassi. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Imposta i valori concatenati del nodo e di tutti i suoi nodi figlio. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva tutti i figli del nodo nel [XmlWriter](../xmlwriter/) specificato. Per i nodi [XmlDocumentType](./), questo metodo non ha effetto. |
...
Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherebbe errori di runtime e/o violazioni di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarla alle funzioni come argomento. 
