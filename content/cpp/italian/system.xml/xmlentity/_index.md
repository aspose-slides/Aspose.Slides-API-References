...
description: Rappresenta una dichiarazione di entità, come <!ENTITY... >.
type: docs
weight: 235
url: /it/system.xml/xmlentity/
---
## XmlEntity classe
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Crea un duplicato di questo nodo. I nodi di tipo entity non possono essere clonati. Chiamare questo metodo su un oggetto [XmlEntity](./) genera un'eccezione. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula il confronto a punto flottante in stile C# in cui due NaN sono considerati uguali anche se secondo IEC 60559:1989 NaN non è uguale a nessun valore, incluso NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula il confronto a punto flottante in stile C# in cui due NaN sono considerati uguali anche se secondo IEC 60559:1989 NaN non è uguale a nessun valore, incluso NaN. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Restituisce l'Uniform Resource Identifier (URI) di base del nodo corrente. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Restituisce i valori concatenati del nodo entity e di tutti i suoi figli. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Restituisce il markup che rappresenta i figli di questo nodo. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | Restituisce un valore che indica se il nodo è in sola lettura. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Restituisce il nome del nodo senza il prefisso del namespace. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Restituisce il nome del nodo. |
...
| [String](../../system/string/) [get_NotationName](./get_notationname/)() | Restituisce il nome dell'attributo opzionale NDATA nella dichiarazione dell'entity. |
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | Restituisce il markup che rappresenta questo nodo e tutti i suoi figli. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Restituisce il valore dell'identificatore pubblico nella dichiarazione dell'entity. |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Restituisce il valore dell'identificatore di sistema nella dichiarazione dell'entity. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Restituisce il primo elemento figlio con la [XmlNode::get_Name](../xmlnode/get_name/) specificata. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Conversione dei elementi al tipo specificato. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se nessun elemento corrispondente viene trovato. |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco di lock() di C#. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Mette tutti i nodi [XmlText](../xmltext/) nella massima profondità del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma "normale" dove solo il markup (cioè tag, commenti, istruzioni di elaborazione, sezioni CDATA e riferimenti a entità) separa i nodi [XmlText](../xmltext/), cioè non ci sono nodi [XmlText](../xmltext/) adiacenti. |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Imposta i valori concatenati del nodo entity e di tutti i suoi figli. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva tutti i figli del nodo nel [XmlWriter](../xmlwriter/) specificato. Per i nodi [XmlEntity](./), questo metodo non ha effetto. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva il nodo nel [XmlWriter](../xmlwriter/) specificato. Per i nodi [XmlEntity](./), questo metodo non ha effetto. |
