...
description: Restituisce il nodo immediatamente precedente o successivo a questo nodo.
type: docs
weight: 274
url: /it/system.xml/xmllinkednode/
---
## XmlLinkedNode classe

Restituisce il nodo immediatamente precedente o successivo a questo nodo.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce l'infoset post-validazione dello schema assegnato a questo nodo come risultato della validazione dello schema. |
...
| void [Lock](../../system/object/lock/)() | Implementa il lock() di C#. Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo del metodo C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Consente la clonazione di tipi personalizzati. |
| virtual void [Normalize](../xmlnode/normalize/)() | Posiziona tutti i nodi [XmlText](../xmltext/) nella piena profondità del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma "normale" dove solo il markup (cioè tag, commenti, istruzioni di elaborazione, sezioni CDATA e riferimenti a entità) separa i nodi [XmlText](../xmltext/), cioè non ci sono nodi [XmlText](../xmltext/) adiacenti. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco del lock() di C#. Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Salva tutti i nodi figlio del nodo nello [XmlWriter](../xmlwriter/) specificato, quando sovrascritto in una classe derivata. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Salva il nodo corrente nello [XmlWriter](../xmlwriter/) specificato, quando sovrascritto in una classe derivata. |
