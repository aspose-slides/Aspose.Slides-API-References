...
description: Rappresenta il contenuto testuale di un elemento o di un attributo.
type: docs
weight: 495
url: /it/system.xml/xmltext/
---
## XmlText classe
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Restituisce un iteratore che punta immediatamente dopo l'ultimo elemento costante (se presente) della collezione. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Restituisce un iteratore che punta immediatamente dopo l'ultimo elemento (se presente) della collezione. Questo iteratore non può essere usato per modificare un oggetto referenziato perché [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) restituisce una copia-oggetto di T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Restituisce un iteratore che punta immediatamente dopo l'ultimo elemento (se presente) dell'istanza costante della collezione. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Restituisce il primo nodo figlio. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Restituisce l'ultimo nodo figlio. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Restituisce il markup contenente questo nodo e tutti i suoi figli. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Restituisce il genitore di questo nodo (per nodi che possono avere genitori). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Restituisce l'infoset post-validazione schema assegnato a questo nodo a seguito della validazione dello schema. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Restituisce il valore del nodo. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Restituisce un enumeratore che itera sui nodi figlio del nodo corrente. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Consente l'hashing di oggetti personalizzati. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per il prefisso dato che è in ambito per il nodo corrente e restituisce l'URI del namespace nella dichiarazione. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Cerca la dichiarazione **xmlns** più vicina per l'URI del namespace dato che è in ambito per il nodo corrente e restituisce il prefisso definito in quella dichiarazione. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Converte gli elementi nel tipo specificato. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Trasforma tutti i nodi [XmlText](./) nella profondità completa del sotto-albero sotto questo [XmlNode](../xmlnode/) in una forma “normale” dove solo il markup (tag, commenti, istruzioni di elaborazione, sezioni CDATA e riferimenti a entità) separa i nodi [XmlText](./), cioè non ci sono nodi [XmlText](./) adiacenti. |
|  [Object](../../system/object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione di copie per le classi derivate. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione di copie per le classi derivate. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Seleziona una lista di nodi che corrispondono all'espressione [XPath](../../system.xml.xpath/). Eventuali prefissi trovati nell'espressione [XPath](../../system.xml.xpath/) sono risolti usando il [XmlNamespaceManager](../xmlnamespacemanager/) fornito. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Seleziona il primo [XmlNode](../xmlnode/) che corrisponde all'espressione [XPath](../../system.xml.xpath/). Eventuali prefissi trovati nell'espressione [XPath](../../system.xml.xpath/) sono risolti usando il [XmlNamespaceManager](../xmlnamespacemanager/) fornito. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento modello a un puntatore debole (invece di condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlText](./)\> [SplitText](./splittext/)(**int32_t**) | Divide il nodo in due nodi all'offset specificato, mantenendo entrambi nell'albero come fratelli. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva tutti i figli del nodo nel [XmlWriter](../xmlwriter/) specificato. I nodi [XmlText](./) non hanno figli, quindi questo metodo non ha effetto. |
