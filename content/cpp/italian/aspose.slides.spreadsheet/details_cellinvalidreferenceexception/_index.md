...
description: L'eccezione che viene lanciata quando si incontra un riferimento di cella non valido.
type: docs
weight: 27
url: /it/aspose.slides.spreadsheet/details_cellinvalidreferenceexception/
---
## Details_CellInvalidReferenceException classe

L'eccezione che viene lanciata quando si incontra un riferimento di cella non valido.
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Ottiene un riferimento di cella non valido. |
