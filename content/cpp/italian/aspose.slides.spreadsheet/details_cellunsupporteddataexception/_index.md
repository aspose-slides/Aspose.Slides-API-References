...
description: L'eccezione che viene lanciata quando si incontra un dato non supportato in una cella di un foglio di calcolo.
type: docs
weight: 40
url: /it/aspose.slides.spreadsheet/details_cellunsupporteddataexception/
---
## Details_CellUnsupportedDataException classe


L'eccezione che viene lanciata quando si incontra un dato non supportato in una cella di un foglio di calcolo.
...
* Spazio dei nomi [Aspose::Slides::Spreadsheet](../)
