...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Direzione della transizione. Leggi [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | Specifica se la transizione sfuma verso il nero. Leggi **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia realmente nulla, si limita ad inizializzare un nuovo oggetto e consente la copia di costruttori nelle subclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia realmente nulla, si limita ad inizializzare un nuovo oggetto e consente la copia di costruttori nelle subclassi. |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | Direzione della transizione. Scrivi [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | Specifica se la transizione sfuma verso il nero. Scrivi **bool**. |
