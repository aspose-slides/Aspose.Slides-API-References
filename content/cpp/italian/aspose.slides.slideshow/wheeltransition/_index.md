...
description: Effetto di transizione a scorrimento della ruota.
type: docs
weight: 443
...
Effetto di transizione a scorrimento della ruota.
...
| **uint32_t** [get_Spokes](./get_spokes/)() override | Numero di raggi della transizione della ruota. Lettura **uint32_t**. |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | Numero di raggi della transizione della ruota. Scrittura **uint32_t**. |
