...
description: Effetto di transizione nera opzionale per le diapositive.
type: docs
weight: 183
url: /it/aspose.slides.slideshow/ioptionalblacktransition/
---
## IOptionalBlackTransition classe

Effetto di transizione nera opzionale per le diapositive.
...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Questo attributo specifica se la transizione inizierà da una schermata nera (e poi la nuova diapositiva transiterà su nero). Leggi **bool**. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Questo attributo specifica se la transizione inizierà da una schermata nera (e poi la nuova diapositiva transiterà su nero). Scrivi **bool**. |
