...
description: Classe base per gli effetti di transizione della diapositiva.
type: docs
weight: 430
...
Classe base per gli effetti di transizione della diapositiva.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se le due istanze [TransitionValueBase](./) sono uguali. |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Funge da funzione hash per un tipo particolare, idonea per l'uso in algoritmi di hashing e strutture dati come una tabella hash. |
