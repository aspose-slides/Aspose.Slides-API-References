...
description: Effetto di transizione della diapositiva fly-through.
type: docs
weight: 40
...
Effetto di transizione della diapositiva fly-through.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se le due istanze [TransitionValueBase](../transitionvaluebase/) sono uguali. |
...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Direzione della transizione. Leggi [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| **bool** [get_HasBounce](./get_hasbounce/)() override | Specifica che il movimento delle diapositive della presentazione durante la transizione include un rimbalzo. Leggi **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Funge da funzione hash per un tipo specifico, adatta all'uso in algoritmi di hashing e strutture dati come una tabella hash. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo al metodo C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Abilita il clonaggio di tipi personalizzati. |
|  [Object](../../system/object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza il nuovo oggetto e consente la copia dei sottotipi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza il nuovo oggetto e consente la copia dei sottotipi. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Direzione della transizione. Scrivi [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | Specifica che il movimento delle diapositive della presentazione durante la transizione include un rimbalzo. Scrivi **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco del blocco lock() di C#. Chiamalo direttamente o usa l'oggetto sentinella [LockContext](../../system/lockcontext/). |
