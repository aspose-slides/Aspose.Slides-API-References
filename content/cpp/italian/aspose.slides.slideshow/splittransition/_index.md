...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se le due [TransitionValueBase](../transitionvaluebase/) istanze sono uguali. |
...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Direzione della suddivisione della transizione. Leggi [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() override | Orientamento della suddivisione della transizione. Leggi [Slides::Orientation](../../aspose.slides/orientation/). |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Funge da funzione hash per un tipo particolare, adatta per l'uso in algoritmi di hash e strutture dati come una tabella hash. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la copia dei costruttori delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la copia dei costruttori delle sottoclassi. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Direzione della suddivisione della transizione. Scrivi [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) override | Orientamento della suddivisione della transizione. Scrivi [Slides::Orientation](../../aspose.slides/orientation/). |
...
* Classe [ISplitTransition](../isplittransition/)
