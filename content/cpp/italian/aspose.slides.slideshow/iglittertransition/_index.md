...
description: Effetto di transizione glitter per slide.
type: docs
weight: 118
url: /it/aspose.slides.slideshow/iglittertransition/
---
## IGlitterTransition classe
...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Direzione della transizione. Leggi [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | Specifica la forma degli elementi visivi usati durante la transizione. Leggi [TransitionPattern](../transitionpattern/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, solo inizializza un nuovo oggetto e consente la copia dei costruttori delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, solo inizializza un nuovo oggetto e consente la copia dei costruttori delle sottoclassi. |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Direzione della transizione. Scrivi [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | Specifica la forma degli elementi visivi usati durante la transizione. Scrivi [TransitionPattern](../transitionpattern/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del modello a un weak pointer (piuttosto che condiviso). Consente di passare i puntatori nei contenitori alla modalità weak. |
