...
description: Effetto di transizione della diapositiva in direzione angolo.
type: docs
weight: 1
...
Effetto di transizione della diapositiva in direzione angolo.
...
| [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() override | Direzione della transizione. Leggi [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Funge da funzione hash per un tipo particolare, adatta all'uso in algoritmi di hashing e strutture dati come una tabella hash. |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco di istruzione C# lock() per il locking. Chiama direttamente o utilizza l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza un nuovo oggetto e consente la costruzione di copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza un nuovo oggetto e consente la costruzione di copia delle sottoclassi. |
...
| void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) override | Direzione della transizione. Scrivi [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa il blocco di istruzione C# lock() per lo sblocco. Chiama direttamente o utilizza l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
* Classe [ICornerDirectionTransition](../icornerdirectiontransition/)
