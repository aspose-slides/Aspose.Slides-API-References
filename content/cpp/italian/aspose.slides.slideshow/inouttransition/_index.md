...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Direzione di un effetto di transizione. Leggi [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco lock() di C#. Chiamala direttamente o usa l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Direzione di un effetto di transizione. Scrivi [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n'th argomento del modello come puntatore debole (anziché condiviso). Consente di passare i puntatori nei container in modalità debole. |
...
* Classe [IInOutTransition](../iinouttransition/)
