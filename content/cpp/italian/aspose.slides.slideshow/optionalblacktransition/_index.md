...
description: Effetto di transizione della diapositiva opzionale nera.
type: docs
weight: 326
...
| **bool** [get_FromBlack](./get_fromblack/)() override | Questo attributo specifica se la transizione inizierà da una schermata nera (e poi la nuova diapositiva verrà mostrata sopra il nero). Leggi **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Funziona come funzione hash per un tipo particolare, adatta per l'uso in algoritmi di hashing e strutture dati come una tabella hash. |
...
| void [set_FromBlack](./set_fromblack/)(**bool**) override | Questo attributo specifica se la transizione inizierà da una schermata nera (e poi la nuova diapositiva verrà mostrata sopra il nero). Scrivi **bool**. |
