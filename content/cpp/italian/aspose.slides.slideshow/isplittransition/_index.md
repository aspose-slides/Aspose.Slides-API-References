...
description: Effetto di transizione di slide divisa.
type: docs
weight: 261
...
Effetto di transizione di slide divisa.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Direzione della divisione della transizione. Leggi [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() | Orientamento della divisione della transizione. Leggi [Slides::Orientation](../../aspose.slides/orientation/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, davvero, solo inizializza un nuovo oggetto e consente la costruzione di copie nelle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, davvero, solo inizializza un nuovo oggetto e consente la costruzione di copie nelle sottoclassi. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Direzione della divisione della transizione. Scrivi [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) | Orientamento della divisione della transizione. Scrivi [Slides::Orientation](../../aspose.slides/orientation/). |
