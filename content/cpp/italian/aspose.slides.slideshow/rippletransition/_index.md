...
description: Effetto di transizione slide a increspatura.
type: docs
weight: 365
...
Effetto di transizione slide a increspatura.
...
| [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) [get_Direction](./get_direction/)() override | Direzione della transizione. Leggi [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Funziona come funzione hash per un tipo particolare, idonea per l'uso in algoritmi di hashing e strutture dati come una tabella hash. |
...
| void [set_Direction](./set_direction/)([TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)) override | Direzione della transizione. Scrivi [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
