...
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | Tipo di transizione morph. Leggi [TransitionMorphType](../transitionmorphtype/). |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | Tipo di transizione morph. Scrivi [TransitionMorphType](../transitionmorphtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n'th argomento template a un puntatore debole (anziché condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
...
* Classe [IMorphTransition](../imorphtransition/)
