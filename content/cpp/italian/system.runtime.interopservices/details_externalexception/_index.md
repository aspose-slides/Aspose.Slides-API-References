...
description: "Il tipo di eccezione di base per tutte le eccezioni COM interop e le eccezioni di gestione strutturata delle eccezioni (SEH). Non creare mai istanze di questa classe manualmente. Usa invece la classe ExternalException. Non incapsulare mai le istanze della classe ExternalException in System::SmartPtr."
type: docs
weight: 1
url: /it/system.runtime.interopservices/details_externalexception/
---
## Details_ExternalException classe


Il tipo di eccezione di base per tutte le eccezioni COM interop e le eccezioni di gestione strutturata delle eccezioni (SEH). Non creare mai istanze di questa classe manualmente. Usa invece la classe ExternalException. Non incapsulare mai le istanze della classe ExternalException in [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Ottiene il tipo reale dell'oggetto. Analogo alla chiamata C# [System.Object.GetType()](../../system/object/gettype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e abilita la copia dei sottoclasse. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. In realtà non copia nulla, ma inizializza un nuovo oggetto e abilita la copia dei sottoclasse. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n'th argomento template a un weak pointer (piuttosto che shared). Consente di passare i puntatori nei contenitori in modalità weak. |
