...
type: docs
weight: 53
url: /it/system.runtime.interopservices/osplatform/
---
## OSPlatform classe
...
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | Determina se l'oggetto corrente e quello specificato sono uguali. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza il nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| **bool** [operator!=](./operator_not_equal/)(const [OSPlatform](./)\&) const |  |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza il nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo parametro template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
