...
description: "Politica comune di cache delle richieste usata per la memorizzazione di Http, FTP, ecc. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarla alle funzioni come argomento."
type: docs
weight: 14
url: /it/system.net.cache/requestcachepolicy/
---
## RequestCachePolicy classe

Politica comune di cache delle richieste utilizzata per la memorizzazione di [Http](../../system.net.http/), FTP, ecc. Oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarla alle funzioni come argomento.
...
| [RequestCacheLevel](../requestcachelevel/) [get_Level](./get_level/)() | Ottiene il valore RequestCacheLevel specificato. |
...
|  [RequestCachePolicy](./requestcachepolicy/)() | Costruisce una nuova istanza. |
|  [RequestCachePolicy](./requestcachepolicy/)([RequestCacheLevel](../requestcachelevel/)) | Costruisce una nuova istanza con il valore RequestCacheLevel specificato. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n'th argomento template come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
