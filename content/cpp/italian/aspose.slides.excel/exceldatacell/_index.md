...
| **int32_t** [get_Column](./get_column/)() override | Restituisce l'indice basato su zero della colonna nel foglio di lavoro in cui si trova la cella. **int32_t** di sola lettura. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Restituisce il nome della cella dati del grafico. |
| **int32_t** [get_Row](./get_row/)() override | Restituisce l'indice basato su zero della riga nel foglio di lavoro in cui si trova la cella. **int32_t** di sola lettura. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Restituisce il valore contenuto nella cella [Excel](../). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia realmente nulla, ma solo inizializza un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia realmente nulla, ma solo inizializza un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
