...
type: docs
weight: 1
url: /it/system.web/details_httpexception/
---
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento n-esimo del modello a un weak pointer (invece di shared). Consente di passare i puntatori nei contenitori a modalità weak. |
