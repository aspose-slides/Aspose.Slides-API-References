...
description: "Usato per dichiarare un binding che definisce uno o più metodi del servizio Web XML. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché provocherà errori di runtime e/o violazioni di asserzioni. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 40
url: /it/system.web.services/webservicebindingattribute/
---
## WebServiceBindingAttribute classe


Usato per dichiarare un binding che definisce uno o più metodi del servizio XML [Web](../../system.web/). Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché provocherà errori di runtime e/o violazioni di asserzioni. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarla alle funzioni come argomento.
...
| [System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\> [get_ConformsTo](./get_conformsto/)() | Ottiene la specifica WSI. |
| **bool** [get_EmitConformanceClaims](./get_emitconformanceclaims/)() | Restituisce un valore che indica se il binding emette dichiarazioni di conformità. |
| [String](../../system/string/) [get_Location](./get_location/)() | Ottiene la posizione in cui il binding è definito. |
| [String](../../system/string/) [get_Name](./get_name/)() | Ottiene il nome del binding. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Ottiene lo spazio dei nomi associato al binding. |
...
| void [set_ConformsTo](./set_conformsto/)([System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\>) | Imposta la specifica WSI. |
| void [set_EmitConformanceClaims](./set_emitconformanceclaims/)(**bool**) | Imposta un valore che indica se il binding emette dichiarazioni di conformità. |
| void [set_Location](./set_location/)([String](../../system/string/)) | Imposta la posizione in cui il binding è definito. |
| void [set_Name](./set_name/)([String](../../system/string/)) | Imposta il nome del binding. |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Imposta lo spazio dei nomi associato al binding. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (invece di condiviso). Consente di switchare i puntatori nei contenitori in modalità debole. |
...
|  [WebServiceBindingAttribute](./webservicebindingattribute/)() | Costruisce una nuova istanza. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/)) | Costruisce una nuova istanza. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/)) | Costruisce una nuova istanza. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Costruisce una nuova istanza. |
