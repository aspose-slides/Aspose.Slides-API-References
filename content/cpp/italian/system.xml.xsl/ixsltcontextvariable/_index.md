...
description: Fornisce un'interfaccia a una variabile definita nel foglio di stile durante l'esecuzione a runtime.
type: docs
weight: 40
url: /it/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable classe


Fornisce un'interfaccia a una variabile definita nel foglio di stile durante l'esecuzione a runtime.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | Valuta la variabile a runtime e restituisce un oggetto che rappresenta il valore della variabile. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo per scopi interni. |
| virtual **bool** [get_IsLocal](./get_islocal/)() | Restituisce un valore che indica se la variabile è locale. |
| virtual **bool** [get_IsParam](./get_isparam/)() | Restituisce un valore che indica se la variabile è un parametro Extensible Stylesheet Language Transformations (XSLT). Può essere un parametro per un foglio di stile o un modello. |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | Restituisce lo XPathResultType che rappresenta il tipo XML Path Language ([XPath](../../system.xml.xpath/)) della variabile. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, semplicemente inizializza un nuovo oggetto e consente la copia di costruttori delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, semplicemente inizializza un nuovo oggetto e consente la copia di costruttori delle sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del modello come puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori alla modalità debole. |
