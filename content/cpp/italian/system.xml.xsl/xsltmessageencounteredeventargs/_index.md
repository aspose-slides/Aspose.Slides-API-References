...
description: "Fornisce dati per l'evento XsltArgumentList::XsltMessageEncountered."
type: docs
weight: 92
url: /it/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs classe

Fornisce dati per l'evento **XsltArgumentList::XsltMessageEncountered**.
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | Restituisce il contenuto dell'elemento **xsl:message**. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e consente la costruzione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita a inizializzare un nuovo oggetto e consente la costruzione di copie di sottoclassi. |
