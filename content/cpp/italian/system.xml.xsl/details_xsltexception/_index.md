...
description: L'eccezione che viene generata quando si verifica un errore durante l'elaborazione di una trasformazione XSLT.
type: docs
weight: 14
url: /it/system.xml.xsl/details_xsltexception/
---
## Details_XsltException classe

L'eccezione che viene generata quando si verifica un errore durante l'elaborazione di una trasformazione XSLT.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Restituisce il numero di riga che indica dove si è verificato l'errore nel foglio di stile. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Restituisce la posizione nella riga che indica dove si è verificato l'errore nel foglio di stile. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Restituisce il messaggio di errore formattato che descrive l'eccezione corrente. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Restituisce il percorso di posizione del foglio di stile. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementa il metodo [what()](../../system/details_exception/what/) chiamato dalla classe [ExceptionWrapper](../../system/exceptionwrapper/). Nonostante il fatto che questa classe non erediti da std::exception, le classi derivate possono usare membri protetti/privati per implementare la loro logica. Spostare l'implementazione di questo metodo nel [ExceptionWrapper](../../system/exceptionwrapper/) potrebbe rompere tale logica. |
