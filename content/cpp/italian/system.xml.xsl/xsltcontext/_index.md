...
description: Incapsula il contesto di esecuzione corrente del processore Extensible Stylesheet Language for Transformations (XSLT) consentendo al linguaggio XML Path (XPath) di risolvere funzioni, parametri e namespace all'interno delle espressioni XPath.
type: docs
weight: 79
url: /it/system.xml.xsl/xsltcontext/
---
## XsltContext classe


Incapsula il contesto di esecuzione corrente del processore Extensible Stylesheet Language for Transformations (XSLT) consentendo a XML Path Language ([XPath](../../system.xml.xpath/)) di risolvere funzioni, parametri e namespace all'interno delle espressioni [XPath](../../system.xml.xpath/).
...
| Metodo | Descrizione |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Aggiunge lo spazio dei nomi fornito alla raccolta. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Restituisce un iteratore che punta al primo elemento (se presente) della raccolta. Questo iteratore non può essere usato per modificare l'oggetto di riferimento perché [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) restituisce una copia dell'oggetto di tipo T. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Restituisce un iteratore che punta immediatamente dopo l'ultimo elemento qualificato come const (se presente) della raccolta. |
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | Quando sovrascritto in una classe derivata, confronta gli Uniform Resource Identifier (URI) di base di due documenti in base all'ordine in cui i documenti sono stati caricati dal processore XSLT (cioè, la classe [XslTransform](../xsltransform/)). |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Restituisce un iteratore che punta immediatamente dopo l'ultimo elemento (se presente) della raccolta. Questo iteratore non può essere usato per modificare l'oggetto di riferimento perché [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) restituisce una copia dell'oggetto di tipo T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Restituisce un iteratore che punta immediatamente dopo l'ultimo elemento (se presente) dell'istanza della raccolta qualificata come const. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | Restituisce l'URI dello spazio dei nomi per lo spazio dei nomi predefinito. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | Restituisce il [XmlNameTable](../../system.xml/xmlnametable/) associato a questo oggetto. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | Quando sovrascritto in una classe derivata, ottiene un valore che indica se includere i nodi di spazi bianchi nell'output. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | Restituisce un enumeratore da usare per iterare attraverso gli spazi dei nomi in [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/). |
...
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | Restituisce un valore che indica se il prefisso fornito ha uno spazio dei nomi definito per l'ambito attualmente inserito. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | Restituisce l'URI dello spazio dei nomi per il prefisso specificato. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | Trova il prefisso dichiarato per il dato URI di spazio dei nomi. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la copia costruttiva delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la copia costruttiva delle sottoclassi. |
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | Rimuove un ambito di spazio dei nomi dallo stack. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Quando sovrascritto in una classe derivata, valuta se preservare i nodi di spazi bianchi o rimuoverli per il contesto dato. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | Aggiunge un ambito di spazio dei nomi allo stack. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Rimuove lo spazio dei nomi fornito per il prefisso dato. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | Quando sovrascritto in una classe derivata, risolve un riferimento a funzione e restituisce un [IXsltContextFunction](../ixsltcontextfunction/) che rappresenta la funzione. Il [IXsltContextFunction](../ixsltcontextfunction/) è usato al momento dell'esecuzione per ottenere il valore di ritorno della funzione. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | Quando sovrascritto in una classe derivata, risolve un riferimento a variabile e restituisce un [IXsltContextVariable](../ixsltcontextvariable/) che rappresenta la variabile. |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inizializza una nuova istanza della classe [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) con il [XmlNameTable](../../system.xml/xmlnametable/) specificato. |
