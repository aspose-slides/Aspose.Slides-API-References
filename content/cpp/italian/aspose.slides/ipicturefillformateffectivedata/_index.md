...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | Restituisce il numero di percentuali dell'altezza reale dell'immagine che viene ritagliata dalla parte inferiore dell'immagine. Solo lettura **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | Restituisce il numero di percentuali della larghezza reale dell'immagine che viene ritagliata dalla parte sinistra dell'immagine. Solo lettura **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | Restituisce il numero di percentuali della larghezza reale dell'immagine che viene ritagliata dalla parte destra dell'immagine. Solo lettura **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | Restituisce il numero di percentuali dell'altezza reale dell'immagine che viene ritagliata dalla parte superiore dell'immagine. Solo lettura **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | Restituisce i dpi usati per riempire un'immagine. Solo lettura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | Restituisce l'immagine. Solo lettura [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | Restituisce la modalità di riempimento dell'immagine. Solo lettura [Slides::PictureFillMode](../picturefillmode/). |
