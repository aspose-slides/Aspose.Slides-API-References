...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [AddComment](./addcomment/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Aggiunge un nuovo commento alla fine di una raccolta. |
| [System::SharedPtr](../../system/sharedptr/)\<[IModernComment](../imoderncomment/)\> [AddModernComment](./addmoderncomment/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Aggiunge un nuovo commento moderno alla fine di una raccolta. |
| [iterator](./iterator/) [begin](./begin/)() | Ottiene un iteratore che punta al primo elemento (se esiste) della raccolta. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Ottiene un iteratore che punta al primo elemento (se esiste) dell'istanza costante della raccolta. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Ottiene un iteratore che punta al primo elemento costante (se esiste) della raccolta. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento costante (se esiste) della raccolta. |
| void [Clear](./clear/)() override | Rimuove tutti i commenti da una raccolta. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\>, **int32_t**) override | Copia tutti gli elementi dalla raccolta nell'array specificato. |
...
| [iterator](./iterator/) [end](./end/)() | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se esiste) della raccolta. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se esiste) dell'istanza costante della raccolta. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [FindCommentByIdx](./findcommentbyidx/)(**int32_t**) | Trova un commento nella raccolta per indice. |
| **int32_t** [get_Count](./get_count/)() override | Ottiene il numero di elementi effettivamente contenuti nella raccolta. Solo lettura **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Restituisce un valore che indica se l'accesso alla raccolta è sincronizzato (thread-safe). Solo lettura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Restituisce la radice di sincronizzazione. Solo lettura [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la raccolta. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Abilita l'hashing di oggetti personalizzati. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ottiene il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [idx_get](./idx_get/)(**int32_t**) override | Ottiene l'elemento all'indice specificato. Solo lettura [Comment](../comment/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [InsertComment](./insertcomment/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Inserisce un nuovo commento in una raccolta all'indice specificato. |
| [System::SharedPtr](../../system/sharedptr/)\<[IModernComment](../imoderncomment/)\> [InsertModernComment](./insertmoderncomment/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Inserisce un nuovo commento moderno in una raccolta all'indice specificato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e abilita la creazione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e abilita la creazione di copie di sottoclassi. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>) override | Rimuove la prima occorrenza del commento specificato in una raccolta. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Rimuove l'elemento all'indice specificato in una raccolta. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento template come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\> [ToArray](./toarray/)() override | Crea e restituisce un array con tutti i commenti. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\> [ToArray](./toarray/)(**int32_t**, **int32_t**) override | Crea e restituisce un array con tutti i commenti dell'intervallo specificato. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ottiene un iteratore che punta al primo elemento (se esiste) dell'istanza costante della raccolta. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Ottiene un iteratore che punta al primo elemento (se esiste) della raccolta. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se esiste) dell'istanza costante della raccolta. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se esiste) della raccolta. |
...
* Classe [ICommentCollection](../icommentcollection/)
