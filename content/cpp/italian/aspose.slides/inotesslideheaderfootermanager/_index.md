...
description: Rappresenta il gestore che contiene il comportamento dei segnaposti della diapositiva delle note, incluso il segnaposto intestazione.
type: docs
weight: 3030
...
Rappresenta il gestore che contiene il comportamento dei segnaposti della diapositiva delle note, incluso il segnaposto intestazione.
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | Ottiene il valore che indica la presenza di un segnaposto data-ora. Lettura**bool**. |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | Ottiene il valore che indica la presenza di un segnaposto piè di pagina. Lettura **bool**. |
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | Ottiene il valore che indica la presenza di un segnaposto intestazione. Lettura **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | Ottiene il valore che indica la presenza di un segnaposto numero di pagina. Lettura**bool**. |
