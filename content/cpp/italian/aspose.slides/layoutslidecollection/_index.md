...
description: Rappresenta una classe base per la collezione di layout slide.
type: docs
weight: 4304
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>, **int32_t**) override | Copia tutti gli elementi della collezione nell'array specificato. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di layout slide nella collezione. **int32_t** sola lettura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Restituisce una radice di sincronizzazione. [System::Object](../../system/object/) sola lettura. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) override | Restituisce il primo layout slide del tipo specificato. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce il layout slide per indice. [LayoutSlide](../layoutslide/) sola lettura. |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco C# lock() per il lock. Chiama direttamente o usa l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Rimuove un layout dalla collezione. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decrementa il contatore di riferimento condiviso del valore specificato. |
| void [RemoveUnused](./removeunused/)() override | Rimuove i layout slide inutilizzati (layout slide il cui HasDependingSlides è false). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa il contatore di riferimento debole. Non dovrebbe essere chiamato direttamente; usare smart pointers o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa il contatore di riferimento debole. Non dovrebbe essere chiamato direttamente; usare smart pointers o ThisProtector. |
