...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() | Restituisce il formato del riempimento gradiente. Sola lettura [IGradientFormat](../igradientformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() | Restituisce il formato del riempimento modello. Sola lettura [IPatternFormat](../ipatternformat/). |
| virtual [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() | Determina se il riempimento deve essere ruotato con una forma. Leggi [NullableBool](../nullablebool/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() | Restituisce il colore di un riempimento solido. Sola lettura [IColorFormat](../icolorformat/). |
...
| virtual void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) | Determina se il riempimento deve essere ruotato con una forma. Scrivi [NullableBool](../nullablebool/). |
