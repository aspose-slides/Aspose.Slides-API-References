...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Restituisce il valore, interpretandolo come angolo in gradi. Leggi **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Restituisce un nome di questo valore di regolazione. Solo lettura [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Restituisce il valore di regolazione "così com'è". Leggi **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Restituisce il tipo della regolazione della forma. Solo lettura [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Imposta il valore, interpretandolo come angolo in gradi. Scrivi **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Imposta il valore di regolazione "così com'è". Scrivi **int64_t**. |
