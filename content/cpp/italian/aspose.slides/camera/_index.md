...
| [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() override | [Camera](./) tipo. Leggi [CameraPresetType](../camerapresettype/). |
| **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() override | [Camera](./) FOV (0-180 deg, campo visivo). Leggi **float**. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../idomobject/)\> [get_Parent_Immediate](../idomobject/get_parent_immediate/)() | Restituisce l'oggetto Parent_Immediate. [IDOMObject](../idomobject/) di sola lettura. |
...
| **float** [get_Zoom](./get_zoom/)() override | [Camera](./) zoom (valore positivo in percentuale). Leggi **float**. |
...
| void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) override | [Camera](./) tipo. Scrivi [CameraPresetType](../camerapresettype/). |
| void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) override | [Camera](./) FOV (0-180 deg, campo visivo). Scrivi **float**. |
| void [set_Zoom](./set_zoom/)(**float**) override | [Camera](./) zoom (valore positivo in percentuale). Scrivi **float**. |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | Una rotazione è definita tramite l'uso di una coordinata di latitudine, una coordinata di longitudine e una rivoluzione attorno all'asse come le coordinate di latitudine e longitudine. Se uno qualsiasi dei valori di coordinata è std::numeric_limits<float>::quiet_NaN(), tutta la rotazione è indefinita. |
