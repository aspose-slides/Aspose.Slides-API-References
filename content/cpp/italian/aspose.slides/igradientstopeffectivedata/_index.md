...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Restituisce il colore di una fermata di gradiente. Solo lettura [System::Drawing::Color](../../system.drawing/color/). |
| virtual **float** [get_Position](./get_position/)() | Restituisce la posizione (0..1) di una fermata di gradiente. Solo lettura **float**. |
