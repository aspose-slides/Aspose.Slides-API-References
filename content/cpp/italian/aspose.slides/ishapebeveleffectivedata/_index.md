...
description: Oggetto immutabile che contiene le proprietà di rilievo della faccia della forma effettiva.
type: docs
weight: 3667
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Tipo di smussatura. Solo lettura [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Altezza della smussatura. Solo lettura **double**. |
| virtual **double** [get_Width](./get_width/)() | Larghezza della smussatura. Solo lettura **double**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco del statement C# lock(). Chiamare direttamente o utilizzare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
