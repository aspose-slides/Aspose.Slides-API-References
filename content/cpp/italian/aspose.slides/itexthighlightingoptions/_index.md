...
description: Rappresenta le opzioni che possono essere usate per evidenziare il testo in un riquadro di testo.
type: docs
weight: 4109
url: /it/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions classe

Rappresenta le opzioni che possono essere usate per evidenziare il testo in un riquadro di testo.
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Imposta true per utilizzare la ricerca sensibile al maiuscolo/minuscolo, false altrimenti. Lettura **bool**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Imposta true per far coincidere solo parole intere, false altrimenti. Lettura **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e consente la costruzione di copie nelle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e consente la costruzione di copie nelle sottoclassi. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Imposta true per utilizzare la ricerca sensibile al maiuscolo/minuscolo, false altrimenti. Scrittura **bool**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Imposta true per far coincidere solo parole intere, false altrimenti. Scrittura **bool**. |
...
Deprecated
:   L'interfaccia [ITextHighlightingOptions](./) sarà rimossa dopo il rilascio della versione 24.10.
