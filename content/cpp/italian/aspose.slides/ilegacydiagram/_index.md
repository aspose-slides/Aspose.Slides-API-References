...
| Method | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Aggiunge un nuovo placeholder se non esiste e imposta le proprietà del placeholder su uno specificato. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGroupShape](../igroupshape/)\> [ConvertToGroupShape](./converttogroupshape/)() | Converte il diagramma legacy in una forma di gruppo modificabile. L'oggetto [GroupShape](../groupshape/) creato viene aggiunto alla forma di gruppo genitore nella stessa posizione. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[SmartArt::ISmartArt](../../aspose.slides.smartart/ismartart/)\> [ConvertToSmartArt](./converttosmartart/)() | Converte il diagramma legacy in un oggetto [SmartArt](../../aspose.slides.smartart/) modificabile. L'oggetto [SmartArt](../../aspose.slides.smartart/) creato viene aggiunto alla forma di gruppo genitore nella stessa posizione. |
...
| virtual **bool** [get_IsDecorative](../ishape/get_isdecorative/)() | Ottiene l'opzione 'Marca come decorativo' Lettura/scrittura **bool**. |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Restituisce un identificatore univoco a livello di diapositiva che rimane costante per tutta la vita della forma e consente a PowerPoint o al codice interop di riferirsi in modo affidabile alla forma da qualsiasi punto del documento. Solo lettura **uint32_t**. Vedi anche [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Restituisce la posizione di una forma nell'ordine z. Shapes[0] restituisce la forma più in fondo nell'ordine z, e Shapes[Shapes.Count - 1] restituisce la forma più in primo piano nell'ordine z. Solo lettura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Restituisce una forma placeholder di base (forma dal layout e/o dalla diapositiva master da cui la forma corrente è ereditata). |
...
| virtual void [set_IsDecorative](../ishape/set_isdecorative/)(**bool**) | Imposta l'opzione 'Marca come decorativo' Lettura/scrittura **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento n-esimo del modello come puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori a modalità debole. |
