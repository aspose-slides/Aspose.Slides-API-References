...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Restituisce un [EffectFormat](../effectformat/) per il riempimento [BackgroundType::OwnBackground](../backgroundtype/). Solo lettura [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Restituisce un [FillFormat](../fillformat/) per il riempimento [BackgroundType::OwnBackground](../backgroundtype/). Solo lettura [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Restituisce un [ColorFormat](../colorformat/) per un riempimento [BackgroundType::Themed](../backgroundtype/). Solo lettura [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Restituisce un indice del riempimento [BackgroundType::Themed](../backgroundtype/) nella collezione dei temi di sfondo. 0 significa nessun riempimento. 1..999 - indice. Lettura **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Restituisce un tipo di riempimento di sfondo. Lettura [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Ottiene i dati di sfondo effettivi con l'ereditarietà applicata. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la copia costruendo le sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la copia costruendo le sottoclassi. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Restituisce un indice del riempimento [BackgroundType::Themed](../backgroundtype/) nella collezione dei temi di sfondo. 0 significa nessun riempimento. 1..999 - indice. Scrittura **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Restituisce un tipo di riempimento di sfondo. Scrittura [BackgroundType](../backgroundtype/). |
