...
| Metodo | Descrizione |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Confronta l'oggetto corrente con l'oggetto specificato. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Restituisce lo stile di allineamento di una tabulazione. Leggi [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Restituisce la posizione di una tabulazione. Assegnare questa proprietà può cambiare l'indice della tabulazione nella collezione e invalidare l'Enumerator. Leggi **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Imposta lo stile di allineamento di una tabulazione. Scrivi [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Imposta la posizione di una tabulazione. Assegnare questa proprietà può cambiare l'indice della tabulazione nella collezione e invalidare l'Enumerator. Scrivi **double**. |
