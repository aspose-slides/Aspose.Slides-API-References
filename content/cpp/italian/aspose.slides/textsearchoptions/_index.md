...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Imposta true per usare una ricerca sensibile al maiuscolo/minuscolo, false altrimenti. Leggi **bool**. |
| **bool** [get_IncludeNotes](./get_includenotes/)() override | Imposta **true** per includere il testo contenuto nelle note della diapositiva ([NotesSlide](../notesslide/)) quando si esegue la ricerca di testo, la sostituzione o le operazioni di evidenziazione. Il valore predefinito è **false**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Imposta true per usare una ricerca sensibile al maiuscolo/minuscolo, false altrimenti. Scrivi **bool**. |
| void [set_IncludeNotes](./set_includenotes/)(**bool**) override | Imposta **true** per includere il testo contenuto nelle note della diapositiva ([NotesSlide](../notesslide/)) quando si esegue la ricerca di testo, la sostituzione o le operazioni di evidenziazione. Il valore predefinito è **false**. |
