...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Aggiunge un nuovo segnaposto se non esiste e imposta le proprietà del segnaposto su quelle specificate. |
...
| virtual [ZoomImageType](../zoomimagetype/) [get_ImageType](./get_imagetype/)() | Ottiene il tipo di immagine di un oggetto zoom. Leggi [ZoomImageType](../zoomimagetype/). Valore predefinito: Preview |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Restituisce un identificatore univoco a livello di diapositiva che rimane costante per la durata della forma e permette a PowerPoint o al codice interop di riferirsi in modo affidabile alla forma da qualsiasi punto del documento. Solo lettura **uint32_t**. Vedi anche [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual **bool** [get_ReturnToParent](./get_returntoparent/)() | Ottiene il comportamento di navigazione nella presentazione. Solo lettura **bool**. Valore predefinito: false |
...
| virtual **bool** [get_ShowBackground](./get_showbackground/)() | Ottiene il valore che specifica se lo Zoom utilizzerà lo sfondo della diapositiva di destinazione. Solo lettura **bool**. Valore predefinito: true |
...
| virtual **float** [get_TransitionDuration](./get_transitionduration/)() | Ottiene la durata della transizione tra Zoom e diapositiva. Solo lettura **float**. Valore predefinito: 1.0f |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](./get_zoomimage/)() | Ottiene l'immagine per l'oggetto zoom. Leggi [IPPImage](../ippimage/). |
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Restituisce la posizione di una forma nell'ordine Z. Shapes[0] restituisce la forma più in fondo nell'ordine Z, e Shapes[Shapes.Count - 1] restituisce la forma più in avanti nell'ordine Z. Solo lettura **int32_t**. |
...
| virtual void [set_ImageType](./set_imagetype/)([ZoomImageType](../zoomimagetype/)) | Imposta il tipo di immagine di un oggetto zoom. Scrivi [ZoomImageType](../zoomimagetype/). Valore predefinito: Preview |
...
| virtual void [set_ReturnToParent](./set_returntoparent/)(**bool**) | Imposta il comportamento di navigazione nella presentazione. Scrivi **bool**. Valore predefinito: false |
...
| virtual void [set_ShowBackground](./set_showbackground/)(**bool**) | Imposta il valore che specifica se lo Zoom utilizzerà lo sfondo della diapositiva di destinazione. Scrivi **bool**. Valore predefinito: true |
| virtual void [set_TransitionDuration](./set_transitionduration/)(**float**) | Imposta la durata della transizione tra Zoom e diapositiva. Scrivi **float**. Valore predefinito: 1.0f |
...
| virtual void [set_ZoomImage](./set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Imposta l'immagine per l'oggetto zoom. Scrivi [IPPImage](../ippimage/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento modello a un puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori a modalità debole. |
