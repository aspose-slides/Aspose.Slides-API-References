...
type: docs
weight: 53
url: /it/aspose.slides/layoutplaceholdermanager/addpictureplaceholder/
---
## LayoutPlaceholderManager::AddPicturePlaceholder(float, float, float, float) metodo
...
Il seguente esempio mostra come aggiungere la forma segnaposto [Picture](../../picture/) alla diapositiva di layout. 
```cpp
