...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Aggiunge una nuova operazione alla fine della collezione. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Aggiunge una nuova operazione alla fine della collezione. |
...
| virtual void [Clear](./clear/)() | Rimuove tutte le operazioni di colore. |
...
| virtual T [CloneT](../igenericcloneable/clonet/)() | Crea un nuovo oggetto che è una copia dell'istanza corrente. |
...
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Confronta gli oggetti usando le semantiche di C# [Object.Equals](../../system/object/equals/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce l'operazione all'indice specificato. Lettura [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Imposta l'operazione all'indice specificato. Scrittura [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Inserisce la nuova operazione in una collezione. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Inserisce la nuova operazione in una collezione. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. Non copia realmente nulla, ma inizializza un nuovo oggetto e abilita la costruzione di copie delle sottoclassi. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove l'operazione di colore da una collezione. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimenti condivisi del valore specificato. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento modello a un puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
