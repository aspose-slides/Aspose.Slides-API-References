...
description: Interfaccia di raccolta generica ausiliaria.
type: docs
weight: 2328
url: /it/aspose.slides/igenericcollection/
---
## IGenericCollection classe

Interfaccia di raccolta generica ausiliaria.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento qualificato come const (se presente) della raccolta. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Copia tutti gli elementi dalla raccolta nell'array specificato. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza qualificata come const della raccolta. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di comportamenti in una raccolta. Sola lettura **int32_t**. |
| virtual **bool** [get_IsSynchronized](./get_issynchronized/)() | Restituisce un valore che indica se l'accesso alla raccolta è sincronizzato (thread-safe). Sola lettura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() | Restituisce una radice di sincronizzazione. Sola lettura [System::Object](../../system/object/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se non esiste alcun elemento corrispondente. |
