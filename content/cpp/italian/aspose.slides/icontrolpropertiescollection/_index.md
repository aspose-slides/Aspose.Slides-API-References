...
---
## IControlPropertiesCollection classe
...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Aggiunge una proprietà alla raccolta. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza della raccolta costante. |
...
| virtual void [Clear](./clear/)() | Rimuove tutte le proprietà. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della raccolta costante. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di proprietà nella raccolta. Solo lettura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::String](../../system/string/)\>\> [get_NamesOfProperties](./get_namesofproperties/)() | Restituisce il numero di proprietà nella raccolta. Solo lettura ICollection<string>. |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | Restituisce la proprietà. |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | Imposta la proprietà. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Rimuove una proprietà con il nome specificato. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimento condiviso del valore specificato. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento template n-esimo come puntatore debole (anziché condiviso). Consente di cambiare i puntatori nei container in modalità debole. |
