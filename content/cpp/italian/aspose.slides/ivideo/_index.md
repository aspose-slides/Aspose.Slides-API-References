...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Restituisce una copia dei dati audio. In caso di grandi quantità di dati considerare l'uso del metodo [IVideo::GetStream](./getstream/) per evitare il caricamento non necessario dei dati video in memoria o anche l'OutOfMemoryException. Solo lettura **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Restituisce il tipo MIME di un video, codificato in [IVideo::get_BinaryData](./get_binarydata/). Solo lettura [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Consente l'hashing di oggetti personalizzati. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Restituisce uno stream Stream per la lettura. Usa 'using' o chiudi lo stream dopo l'uso. |
