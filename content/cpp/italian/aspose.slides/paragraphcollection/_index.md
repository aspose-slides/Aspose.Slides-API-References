...
| Metodo | Descrizione |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Aggiunge un [Paragraph](../paragraph/) alla fine della collezione. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Aggiunge il contenuto di [ParagraphCollection](./) alla fine della collezione. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | Aggiunge testo dalla stringa HTML specificata alla collezione. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | Aggiunge testo dalla stringa HTML specificata alla collezione. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Restituisce un iteratore che punta al primo elemento qualificato const (se presente) della collezione. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento qualificato const (se presente) della collezione. |
| void [Clear](./clear/)() override | Rimuove tutti gli elementi dalla collezione. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Determina se il [ICollection](../../system.collections.generic/icollection/) contiene un valore specifico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | Copia gli elementi del [ICollection](../../system.collections.generic/icollection/) in un [System::Array](../../system/array/), a partire da un indice [System::Array](../../system/array/) specifico. |
...
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | Converte i paragrafi specificati in HTML e lo restituisce come oggetto String. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo per uso interno. |
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di elementi effettivamente contenuti nella collezione. Sola lettura **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Restituisce un valore che indica se il [ICollection](../../system.collections.generic/icollection/) è di sola lettura. Sola lettura **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce l'elemento all'indice specificato. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Determina l'indice di un elemento specifico nel [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Inserisce un [Paragraph](../paragraph/) nella collezione all'indice specificato. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Inserisce il contenuto di [ParagraphCollection](./) nella collezione all'indice specificato. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se non è trovato alcun elemento. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Rimuove la prima occorrenza di un oggetto specifico dal [ICollection](../../system.collections.generic/icollection/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Permette di cambiare i puntatori nei contenitori in modalità debole. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza della collezione qualificata come const. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della collezione qualificata come const. |
...
| [virtualized_iterator_element](./virtualized_iterator_element/) | Tipo elemento virtualizzato. |
