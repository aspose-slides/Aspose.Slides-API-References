...
description: Rappresenta un'eccezione sollevata durante gli errori di lettura della presentazione.
type: docs
weight: 612
url: /it/aspose.slides/details_odpreadexception/
---
## Details_OdpReadException classe


Rappresenta un'eccezione sollevata durante errori di lettura della presentazione.
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco della dichiarazione lock() di C#. Chiamare direttamente o utilizzare l'oggetto sentry [LockContext](../../system/lockcontext/). |
