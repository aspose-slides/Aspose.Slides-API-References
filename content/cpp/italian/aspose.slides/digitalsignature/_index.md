...
| Method | Description |
| --- | --- |
|  [DigitalSignature](./digitalsignature/)([System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\>) | Crea un nuovo oggetto [DigitalSignature](./) con il certificato specificato. |
|  [DigitalSignature](./digitalsignature/)([System::String](../../system/string/), [System::String](../../system/string/)) | Crea un nuovo oggetto [DigitalSignature](./) con il percorso del file certificato e la password specificati. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() override | Oggetto certificato usato per firmare il documento. Sola lettura [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/). |
| [System::String](../../system/string/) [get_Comments](./get_comments/)() override | Scopo della firma. Leggi [System::String](../../system/string/). |
| **bool** [get_IsValid](./get_isvalid/)() override | Se questa firma digitale è valida e il documento non è stato manomesso, questo valore sarà true. Sola lettura **bool**. |
| [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() override | Il momento in cui il documento è stato firmato. Sola lettura [System::DateTime](../../system/datetime/). |
...
| void [set_Comments](./set_comments/)([System::String](../../system/string/)) override | Scopo della firma. Scrivi [System::String](../../system/string/). |
...
Il seguente esempio dimostra come aggiungere una firma digitale da un certificato PFX in PowerPoint [Presentation](../presentation/). 
```cpp
...
// Aggiungi commento alla nuova firma digitale
...
```
 Il seguente codice di esempio dimostra come convalidare la firma digitale di PowerPoint [Presentation](../presentation/). 
```cpp
// Inizializza istanza Presentation
