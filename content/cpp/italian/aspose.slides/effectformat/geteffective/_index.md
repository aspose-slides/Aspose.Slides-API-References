...
Ottiene i dati di formattazione degli effetti effettivi con l'ereditarietà applicata.
...
Questo esempio dimostra come ottenere alcune delle proprietà degli effetti effettivi di una forma. 
```cpp
