...
description: Fornisce file e sorgenti di memoria per font esterni.
type: docs
weight: 2263
...
Fornisce file e sorgenti di memoria per font esterni.
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_FontFolders](./get_fontfolders/)() | Cartelle contenenti file di font. Tutti i file di font presenti in queste cartelle sono inclusi nella collezione. Cartelle che vengono cercate ricorsivamente. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\> [get_MemoryFonts](./get_memoryfonts/)() | Una collezione di font rappresentati come array di byte. |
...
| virtual void [set_FontFolders](./set_fontfolders/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Cartelle contenenti file di font. Tutti i file di font presenti in queste cartelle sono inclusi nella collezione. Cartelle che vengono cercate ricorsivamente. |
| virtual void [set_MemoryFonts](./set_memoryfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\>) | Una collezione di font rappresentati come array di byte. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
