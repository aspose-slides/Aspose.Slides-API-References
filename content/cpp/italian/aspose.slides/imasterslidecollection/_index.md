...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Aggiunge una copia di una diapositiva master specificata alla fine della collezione. Le diapositive di layout collegate verranno copiate anch'esse. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) | Ottiene l'elemento all'indice specificato. [IMasterSlide](../imasterslide/) di sola lettura. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Inserisce una copia di una diapositiva master specificata nella posizione indicata della collezione. Le diapositive di layout collegate verranno copiate anch'esse. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Rimuove la prima occorrenza di uno specifico oggetto dalla collezione. |
...
| virtual void [RemoveUnused](./removeunused/)(**bool**) | Rimuove le diapositive master non utilizzate. |
