...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Restituisce il colore di una fermata di gradiente. Solo lettura [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Restituisce la posizione (0..1) di una fermata di gradiente. Leggi **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Imposta la posizione (0..1) di una fermata di gradiente. Scrivi **float**. |
