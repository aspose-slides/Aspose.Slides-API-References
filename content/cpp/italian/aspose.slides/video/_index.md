...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Restituisce una copia dei dati di un audio. In caso di grandi quantità di dati considerare l'uso del metodo [Video::GetStream](./getstream/) per evitare il caricamento non necessario dei dati del video in memoria o anche OutOfMemoryException. Solo lettura **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Restituisce un tipo MIME di un video, codificato in [Video::get_BinaryData](./get_binarydata/). Solo lettura [System::String](../../system/string/). |
