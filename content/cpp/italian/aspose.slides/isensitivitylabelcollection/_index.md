...
description: Rappresenta una collezione di etichette di sensibilità applicate al documento.
type: docs
weight: 3628
url: /it/aspose.slides/isensitivitylabelcollection/
---
## ISensitivityLabelCollection classe

Rappresenta una collezione di etichette di sensibilità applicate al documento.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Aggiunge l'etichetta di sensibilità alla fine della collezione. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) | Aggiunge un [SensitivityLabel](../sensitivitylabel/) alla collezione. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di tutti gli elementi nella collezione. **int32_t** di sola lettura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce l'etichetta di sensibilità per indice. [ISensitivityLabel](../isensitivitylabel/) di sola lettura. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore di default se non viene trovato alcun elemento. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, davvero, si limita ad inizializzare un nuovo oggetto e consente la costruzione di copie nelle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, davvero, si limita ad inizializzare un nuovo oggetto e consente la costruzione di copie nelle sottoclassi. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove l'etichetta di sensibilità all'indice specificato. |
