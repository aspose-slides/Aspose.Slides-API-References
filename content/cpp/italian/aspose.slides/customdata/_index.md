...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) override | Restituisce la parte XML personalizzata all'indice specificato. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() override | Restituisce la raccolta delle parti XML personalizzate. Solo lettura [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) override | Restituisce il Customer Data Tag specificato all'indice. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() override | Restituisce la raccolta dei Customer Data Tag. Solo lettura [ITagCollection](../itagcollection/). |
...
| void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Imposta il Customer Data Tag specificato all'indice. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del template a un puntatore debole (anziché condiviso). Consente di cambiare i puntatori nei contenitori a modalità debole. |
