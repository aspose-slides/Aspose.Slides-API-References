...
type: docs
weight: 625
url: /it/aspose.slides/details_ooxmlcorruptfileexception/
---
## Details_OOXMLCorruptFileException classe

Eccezione che viene lanciata quando il formato di file Office Open XML è corrotto.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento di modello come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori in modalità debole. |
