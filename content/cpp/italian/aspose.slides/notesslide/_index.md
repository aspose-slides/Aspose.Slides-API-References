...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Restituisce il gestore HeaderFooter della diapositiva delle note. Solo lettura [INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_NotesTextFrame](./get_notestextframe/)() override | Restituisce un [TextFrame](../textframe/) con il testo delle note se presente. Solo lettura [ITextFrame](../itextframe/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_ParentSlide](./get_parentslide/)() override | Restituisce la diapositiva padre. Solo lettura [ISlide](../islide/). |
...
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | Specifica se le forme sulla diapositiva master devono essere mostrate sulle diapositive o no. Lettura **bool**. |
...
| void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)() override | Unisce le esecuzioni con la stessa formattazione in tutti i paragrafi di tutte le forme accettabili. |
| virtual void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\>) | Unisce le esecuzioni con la stessa formattazione in tutti i paragrafi di tutte le forme accettabili. |
...
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | Specifica se le forme sulla diapositiva master devono essere mostrate sulle diapositive o no. Scrivi **bool**. |
