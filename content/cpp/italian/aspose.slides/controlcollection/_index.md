...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [AddControl](./addcontrol/)([ControlType](../controltype/), **float**, **float**, **float**, **float**) override | Crea e aggiunge un nuovo controllo alla raccolta. |
| [iterator](./iterator/) [begin](./begin/)() | Ottiene l'iteratore che punta al primo elemento (se presente) della raccolta. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza const-qualified della raccolta. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Ottiene l'iteratore che punta al primo elemento const-qualified (se presente) della raccolta. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento const-qualified (se presente) della raccolta. |
| void [Clear](./clear/)() override | Rimuove tutti i controlli dalla raccolta. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>\>, **int32_t**) override | Copia l'intera raccolta nell'array specificato. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza const-qualified della raccolta. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di oggetti nella raccolta. **int32_t** di sola lettura. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Restituisce un valore che indica se l'accesso alla raccolta è sincronizzato (thread-safe). **bool** di sola lettura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la raccolta. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Abilita l'hashing di oggetti personalizzati. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ottiene il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce un controllo nella posizione specificata. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, ma inizializza un nuovo oggetto e abilita la copia di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. Non copia nulla, ma inizializza un nuovo oggetto e abilita la copia di sottoclassi. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>) override | Rimuove un controllo ActiveX dalla raccolta. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Rimuove un controllo ActiveX memorizzato nella posizione specificata dalla raccolta. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimento condiviso del valore specificato. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento template n-esimo a un weak pointer (anziché shared). Consente di passare i puntatori nei contenitori alla modalità weak. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza const-qualified della raccolta. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza const-qualified della raccolta. |
...
* Classe [IControlCollection](../icontrolcollection/)
