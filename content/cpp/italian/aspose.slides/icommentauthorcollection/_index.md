...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [AddAuthor](./addauthor/)([System::String](../../system/string/), [System::String](../../system/string/)) | Aggiunge un nuovo autore alla fine di una raccolta. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza qualificata come const della raccolta. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Ottiene l'iteratore che punta al primo elemento qualificato come const (se presente) della raccolta. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Ottiene l'iteratore che punta immediatamente dopo l'ultimo elemento qualificato come const (se presente) della raccolta. |
| virtual void [Clear](./clear/)() | Rimuove tutti gli autori da una raccolta. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Ottiene l'iteratore che punta immediatamente dopo l'ultimo elemento (se presente) dell'istanza qualificata come const della raccolta. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByName](./findbyname/)([System::String](../../system/string/)) | Trova un autore in una raccolta per nome. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByNameAndInitials](./findbynameandinitials/)([System::String](../../system/string/), [System::String](../../system/string/)) | Trova un autore in una raccolta per nome e iniziali. |
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Restituisce il numero di comportamenti in una raccolta. **int32_t** di sola lettura. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Restituisce un valore che indica se l'accesso alla raccolta è sincronizzato (thread-safe). **bool** di sola lettura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [idx_get](./idx_get/)(**int32_t**) | Ottiene l'elemento all'indice specificato. [ICommentAuthor](../icommentauthor/) di sola lettura. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>) | Rimuove la prima occorrenza dell'autore specificato in una raccolta. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove l'autore all'indice specificato della raccolta. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [ToArray](./toarray/)() | Crea e restituisce un array con tutti gli autori. |
