...
description: Interfaccia ausiliaria per la sorgente delle proprietà 3D
type: docs
weight: 4187
url: /it/aspose.slides/ithreedparamsource/
---
## IThreeDParamSource classe

Interfaccia ausiliaria per la sorgente delle proprietà 3D
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo parametro template a un puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
