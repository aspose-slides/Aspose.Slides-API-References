...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | La proprietà specifica come una forma verrà mostrata in modalità bianco-nero. Leggi [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\> [get_Column](./get_column/)(**int32_t**) | Restituisce una colonna all'indice specificato. Solo lettura [Aspose::Slides::IColumn](../icolumn/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnCollection](../icolumncollection/)\> [get_Columns](./get_columns/)() | Restituisce la raccolta di colonne. Solo lettura [IColumnCollection](../icolumncollection/). |
...
| virtual **bool** [get_FirstCol](./get_firstcol/)() | Determina se la prima colonna di una tabella deve essere disegnata con una formattazione speciale. Leggi **bool**. |
| virtual **bool** [get_FirstRow](./get_firstrow/)() | Determina se la prima riga di una tabella deve essere disegnata con una formattazione speciale. Leggi **bool**. |
...
| virtual **bool** [get_HorizontalBanding](./get_horizontalbanding/)() | Determina se le righe pari devono essere disegnate con una formattazione diversa. Leggi **bool**. |
...
| virtual **bool** [get_LastCol](./get_lastcol/)() | Determina se l'ultima colonna di una tabella deve essere disegnata con una formattazione speciale. Leggi **bool**. |
| virtual **bool** [get_LastRow](./get_lastrow/)() | Determina se l'ultima riga di una tabella deve essere disegnata con una formattazione speciale. Leggi **bool**. |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Restituisce un identificatore univoco a livello di diapositiva che rimane costante per tutta la vita della forma e consente a PowerPoint o al codice di interop di fare riferimento alla forma in modo affidabile da qualsiasi punto del documento. Solo lettura **uint32_t**. Vedi anche [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual **bool** [get_RightToLeft](./get_righttoleft/)() | Determina se la tabella ha ordine di lettura da destra a sinistra. Leggi **bool**. |
| virtual **float** [get_Rotation](../ishape/get_rotation/)() | Restituisce il numero di gradi in cui la forma specificata è ruotata attorno all'asse z. Un valore positivo indica rotazione in senso orario; un valore negativo indica rotazione in senso antiorario. Leggi **float**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [get_Row](./get_row/)(**int32_t**) | Restituisce una riga all'indice specificato. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowCollection](../irowcollection/)\> [get_Rows](./get_rows/)() | Restituisce la raccolta di righe. Solo lettura [IRowCollection](../irowcollection/). |
...
| virtual [TableStylePreset](../tablestylepreset/) [get_StylePreset](./get_stylepreset/)() | Ottiene o imposta lo stile di tabella integrato. Leggi [TableStylePreset](../tablestylepreset/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITableFormat](../itableformat/)\> [get_TableFormat](./get_tableformat/)() | Restituisce l'oggetto [TableFormat](../tableformat/) che contiene le proprietà di formattazione per questa tabella. Solo lettura [ITableFormat](../itableformat/). |
...
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Restituisce un identificatore interno a livello di presentazione destinato a componenti aggiuntivi o altro codice. Poiché questo valore può essere riassegnato dall'utente o programmaticamente, non deve essere trattato come una chiave persistente. Solo lettura **uint32_t**. Vedi anche [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
| virtual **bool** [get_VerticalBanding](./get_verticalbanding/)() | Determina se le colonne pari devono essere disegnate con una formattazione diversa. Leggi **bool**. |
...
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Restituisce la posizione di una forma nell'ordine z. Shapes[0] restituisce la forma più indietro nell'ordine z, e Shapes[Shapes.Count - 1] restituisce la forma più avanti. Solo lettura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../ishape/getimage/)() | Restituisce la miniatura della forma. Il tipo di delimitazione della miniatura della forma [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) è usato per impostazione predefinita. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](./idx_get/)(**int32_t**, **int32_t**) | Restituisce la cella agli indici di colonna e riga specificati. Solo lettura [ICell](../icell/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [MergeCells](./mergecells/)([System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>, **bool**) | Unisce le celle vicine. |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | La proprietà specifica come una forma verrà mostrata in modalità bianco-nero. Scrivi [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual void [set_FirstCol](./set_firstcol/)(**bool**) | Determina se la prima colonna di una tabella deve essere disegnata con una formattazione speciale. Scrivi **bool**. |
| virtual void [set_FirstRow](./set_firstrow/)(**bool**) | Determina se la prima riga di una tabella deve essere disegnata con una formattazione speciale. Scrivi **bool**. |
...
| virtual void [set_HorizontalBanding](./set_horizontalbanding/)(**bool**) | Determina se le righe pari devono essere disegnate con una formattazione diversa. Scrivi **bool**. |
...
| virtual void [set_LastCol](./set_lastcol/)(**bool**) | Determina se l'ultima colonna di una tabella deve essere disegnata con una formattazione speciale. Scrivi **bool**. |
| virtual void [set_LastRow](./set_lastrow/)(**bool**) | Determina se l'ultima riga di una tabella deve essere disegnata con una formattazione speciale. Scrivi **bool**. |
...
| virtual void [set_RightToLeft](./set_righttoleft/)(**bool**) | Determina se la tabella ha ordine di lettura da destra a sinistra. Scrivi **bool**. |
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | Imposta il numero di gradi in cui la forma specificata è ruotata attorno all'asse z. Un valore positivo indica rotazione in senso orario; un valore negativo indica rotazione in senso antiorario. Scrivi **float**. |
| virtual void [set_StylePreset](./set_stylepreset/)([TableStylePreset](../tablestylepreset/)) | Ottiene o imposta lo stile di tabella integrato. Scrivi [TableStylePreset](../tablestylepreset/). |
| virtual void [set_VerticalBanding](./set_verticalbanding/)(**bool**) | Determina se le colonne pari devono essere disegnate con una formattazione diversa. Scrivi **bool**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Imposta le proprietà di formato della porzione definita a tutte le porzioni dell'elemento. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Imposta le proprietà di formato del paragrafo definito a tutti i paragrafi dell'elemento. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Imposta le proprietà di formato del riquadro di testo definito a tutti i riquadri di testo dell'elemento. |
