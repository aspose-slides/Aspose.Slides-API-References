...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Aggiunge un nuovo segnaposto se non ce n'è e imposta le proprietà del segnaposto su quello specificato. |
...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | La proprietà specifica come una forma verrà renderizzata in modalità bianco-nero. Leggi [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\> [get_EmbeddedData](./get_embeddeddata/)() | Ottiene informazioni sui dati OLE incorporati. Solo lettura [IOleEmbeddedDataInfo](../ioleembeddeddatainfo/). |
| virtual [System::String](../../system/string/) [get_EmbeddedFileLabel](./get_embeddedfilelabel/)() | Restituisce il nome file dell'oggetto OLE incorporato |
| virtual [System::String](../../system/string/) [get_EmbeddedFileName](./get_embeddedfilename/)() | Restituisce il percorso dell'oggetto OLE incorporato |
...
| virtual **bool** [get_IsObjectIcon](./get_isobjecticon/)() | Determina se un oggetto è visibile come icona. Solo lettura **bool**. |
| virtual **bool** [get_IsObjectLink](./get_isobjectlink/)() | Determina se un oggetto è collegato a un file esterno. Solo lettura **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkFileName](./get_linkfilename/)() | Restituisce il percorso completo a un file collegato. Verrà usato il nome file breve. Solo lettura [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Restituisce il percorso completo a un file collegato. Verrà usato il nome file lungo. Leggi [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_LinkPathRelative](./get_linkpathrelative/)() | Restituisce il percorso relativo a un file collegato se presente, altrimenti restituisce una stringa vuota. Solo lettura [System::String](../../system/string/). |
...
| virtual [System::String](../../system/string/) [get_ObjectName](./get_objectname/)() | Restituisce il nome di un oggetto. Leggi [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_ObjectProgId](./get_objectprogid/)() | Restituisce il ProgID di un oggetto. Solo lettura [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() | Restituisce l'oggetto delle proprietà di riempimento immagine OleObject. Solo lettura [IPictureFillFormat](../ipicturefillformat/). |
| virtual [System::String](../../system/string/) [get_SubstitutePictureTitle](./get_substitutepicturetitle/)() | Restituisce il titolo per l'icona OleObject. Leggi [System::String](../../system/string/). |
...
| virtual **bool** [get_UpdateAutomatic](./get_updateautomatic/)() | Determina se l'oggetto incorporato collegato è aggiornato automaticamente quando la presentazione viene aperta o stampata. Solo lettura **bool**. |
| virtual **float** [get_Width](../ishape/get_width/)() | Ottiene la larghezza della forma, misurata in punti. Solo lettura **float**. |
| virtual **float** [get_X](../ishape/get_x/)() | Ottiene la coordinata x dell'angolo in alto a sinistra della forma, misurata in punti. Solo lettura **float**. |
| virtual **float** [get_Y](../ishape/get_y/)() | Ottiene la coordinata y dell'angolo in alto a sinistra della forma, misurata in punti. Solo lettura **float**. |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | La proprietà specifica come una forma verrà renderizzata in modalità bianco-nero. Scrivi [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual void [set_IsObjectIcon](./set_isobjecticon/)(**bool**) | Determina se un oggetto è visibile come icona. Scrivi **bool**. |
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Restituisce il percorso completo a un file collegato. Verrà usato il nome file lungo. Scrivi [System::String](../../system/string/). |
...
| virtual void [set_ObjectName](./set_objectname/)([System::String](../../system/string/)) | Imposta il nome di un oggetto. Scrivi [System::String](../../system/string/). |
| virtual void [set_ObjectProgId](./set_objectprogid/)([System::String](../../system/string/)) | Restituisce il ProgID di un oggetto. Solo lettura [System::String](../../system/string/). |
...
| virtual void [set_SubstitutePictureTitle](./set_substitutepicturetitle/)([System::String](../../system/string/)) | Imposta il titolo per l'icona OleObject. Scrivi [System::String](../../system/string/). |
| virtual void [set_UpdateAutomatic](./set_updateautomatic/)(**bool**) | Determina se l'oggetto incorporato collegato è aggiornato automaticamente quando la presentazione viene aperta o stampata. Scrivi **bool**. |
...
| virtual void [SetEmbeddedData](./setembeddeddata/)([System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\>) | Imposta le informazioni sui dati OLE incorporati. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento modello a un puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
