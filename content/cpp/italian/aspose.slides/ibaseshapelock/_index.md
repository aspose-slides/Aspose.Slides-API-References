...
description: Rappresenta il blocco della forma (operazione disabilitata).
type: docs
weight: 1483
url: /it/aspose.slides/ibaseshapelock/
---
## IBaseShapeLock classe

Rappresenta [Shape](../shape/) blocco (operazione disabilitata).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Restituisce true se tutti i flag di blocco sono disabilitati. **bool** di sola lettura. |
