...
description: Rappresenta una classe base per i lock (operazione disabilitata).
type: docs
weight: 157
...
| **bool** [get_NoLocks](./get_nolocks/)() override | Restituisce true se tutti i flag di lock sono disabilitati. Sola lettura **bool**. |
