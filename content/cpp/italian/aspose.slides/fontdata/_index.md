...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se due istanze di [FontData](./) sono uguali. |
...
|  [FontData](./fontdata/)([System::String](../../system/string/)) | Crea un nuovo oggetto [FontData](./) con il nome del font specificato. |
| [System::String](../../system/string/) [get_FontName](./get_fontname/)() override | Restituisce il nome del font. Leggi [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) override | Restituisce il nome del font, sostituendo il riferimento al tema con un font effettivamente usato. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Funziona come funzione hash per un tipo specifico, adatta per l'uso in algoritmi di hashing e strutture dati come una tabella hash. |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco della dichiarazione lock() di C#. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento template n-esimo a un weak pointer (piuttosto che shared). Consente di cambiare i puntatori nei contenitori in modalità weak. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Restituisce la rappresentazione stringa. |
