...
```cpp
class InterruptionToken : public Aspose::Slides::IInterruptionToken
```
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Restituisce **bool**.true se è stata richiesta l'interruzione. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | Rappresenta un token di interruzione vuoto. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza semplicemente un nuovo oggetto e consente la costruzione di copie delle subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza semplicemente un nuovo oggetto e consente la costruzione di copie delle subclass. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | Lancia un'eccezione 
se è stata richiesta l'interruzione. |
