...
| **uint32_t** [get_Index](./get_index/)() override | Restituisce l'indice di un segnaposto. **uint32_t** di sola lettura. |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Restituisce l'orientamento di un segnaposto. [Slides::Orientation](../orientation/) di sola lettura. |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | Restituisce le dimensioni di un segnaposto. [PlaceholderSize](../placeholdersize/) di sola lettura. |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | Restituisce il tipo di un segnaposto. [PlaceholderType](../placeholdertype/) di sola lettura. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Restituisce il tipo reale dell'oggetto. Analogo alla chiamata [System.Object.GetType()](../../system/object/gettype/) di C#. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia realmente nulla, inizializza semplicemente un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia realmente nulla, inizializza semplicemente un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
