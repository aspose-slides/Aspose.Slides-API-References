...
description: Wrapper per l'interfaccia COM di Aspose.IO.Stream.
type: docs
weight: 5279
...
| Metodo | Descrizione |
| --- | --- |
| void [Close](./close/)() override | Chiude lo stream corrente e rilascia eventuali risorse. |
...
| void [Flush](./flush/)() override | Svuota tutti i buffer per questo stream e provoca la scrittura di tutti i dati bufferizzati sul dispositivo sottostante. |
| **bool** [get_CanRead](./get_canread/)() override | Restituisce un valore che indica se lo stream corrente supporta la lettura. Sola lettura **bool**. |
| **bool** [get_CanSeek](./get_canseek/)() override | Restituisce un valore che indica se lo stream corrente supporta il posizionamento. Sola lettura **bool**. |
| **bool** [get_CanWrite](./get_canwrite/)() override | Restituisce un valore che indica se lo stream corrente supporta la scrittura. Sola lettura **bool**. |
| **int64_t** [get_Length](./get_length/)() override | Restituisce la lunghezza in byte dello stream. Sola lettura **int64_t**. |
| **int64_t** [get_Position](./get_position/)() override | Restituisce la posizione all'interno dello stream corrente. Sola lettura **int64_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [get_Stream](./get_stream/)() override | Restituisce un stream. Sola lettura [System::IO::Stream](../../system.io/stream/). |
...
| void [Read](./read/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | Legge una sequenza di byte dallo stream corrente e avanza la posizione nello stream di un numero di byte pari a quelli letti. |
| **int32_t** [ReadByte](./readbyte/)() override | Legge un byte dallo stream e avanza la posizione nello stream di un byte, oppure restituisce -1 se si è alla fine dello stream. |
...
| **int64_t** [Seek](./seek/)(**int64_t**, [System::IO::SeekOrigin](../../system.io/seekorigin/)) override | Imposta la posizione all'interno dello stream corrente |
...
| void [Write](./write/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | scrive una sequenza di byte nello stream corrente e avanza la posizione corrente in questo stream di un numero di byte pari a quelli scritti. |
| void [WriteByte](./writebyte/)(**uint8_t**) override | Scrive un byte nella posizione corrente dello stream e avanza la posizione nello stream di un byte. |
