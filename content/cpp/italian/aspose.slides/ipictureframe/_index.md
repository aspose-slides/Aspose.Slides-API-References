...
Rappresenta un riquadro con un'immagine all'interno.
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IShapeElement](../ishapeelement/)\>\> [CreateShapeElements](../igeometryshape/createshapeelements/)() | Crea e restituisce un array di elementi della forma. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [get_Adjustment](../igeometryshape/get_adjustment/)(**int32_t**) | Restituisce il valore di regolazione di una forma all'indice specificato. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValueCollection](../iadjustvaluecollection/)\> [get_Adjustments](../igeometryshape/get_adjustments/)() | Restituisce una collezione di valori di aggiustamento della forma. Solo lettura [IAdjustValueCollection](../iadjustvaluecollection/). |
...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | La proprietà specifica come una forma verrà resa in modalità bianco e nero. Lettura [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_Frame](../ishape/get_frame/)() | Restituisce le proprietà del riquadro della forma. Lettura [IShapeFrame](../ishapeframe/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkClick](../ihyperlinkcontainer/get_hyperlinkclick/)() | Restituisce il collegamento ipertestuale definito per il clic del mouse. Lettura [IHyperlink](../ihyperlink/). |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Restituisce un identificatore unico a livello di diapositiva che rimane costante per la durata della forma e consente a PowerPoint o al codice interop di fare riferimento in modo affidabile alla forma da qualsiasi punto del documento. Solo lettura **uint32_t**. Vedi anche [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFormat](./get_pictureformat/)() | Restituisce l'oggetto [PictureFillFormat](../picturefillformat/) per un riquadro immagine. Solo lettura [IPictureFillFormat](../ipicturefillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFrameLock](../ipictureframelock/)\> [get_PictureFrameLock](./get_pictureframelock/)() | Restituisce i blocchi di [PictureFrame](../pictureframe/). Solo lettura [IPictureFrameLock](../ipictureframelock/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_RawFrame](../ishape/get_rawframe/)() | Restituisce le proprietà grezze del riquadro della forma. Lettura [IShapeFrame](../ishapeframe/). |
| virtual **float** [get_RelativeScaleHeight](./get_relativescaleheight/)() | Restituisce la scala dell'altezza (rispetto alla dimensione originale dell'immagine) del riquadro immagine. Il valore 1,0 corrisponde al 100%. Lettura **float**. |
| virtual **float** [get_RelativeScaleWidth](./get_relativescalewidth/)() | Restituisce la scala della larghezza (rispetto alla dimensione originale dell'immagine) del riquadro immagine. Il valore 1,0 corrisponde al 100%. Lettura **float**. |
...
| virtual [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](../igeometryshape/get_shapetype/)() | Restituisce il tipo di preset geometrico. Nota: al valore cambiamento tutti i valori di aggiustamento verranno ripristinati ai valori predefiniti. Lettura [Slides::ShapeType](../shapetype/). |
...
| virtual **float** [get_X](../ishape/get_x/)() | Ottiene la coordinata x dell'angolo superiore sinistro della forma, misurata in punti. Lettura **float**. |
| virtual **float** [get_Y](../ishape/get_y/)() | Ottiene la coordinata y dell'angolo superiore sinistro della forma, misurata in punti. Lettura **float**. |
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Restituisce la posizione di una forma nell'ordine Z. Shapes[0] restituisce la forma più indietro nell'ordine Z, e Shapes[Shapes.Count - 1] restituisce la forma più avanti nell'ordine Z. Solo lettura **int32_t**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>\> [GetGeometryPaths](../igeometryshape/getgeometrypaths/)() | Restituisce la copia del percorso della forma geometrica. Le coordinate sono relative all'angolo superiore sinistro della forma. |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco lock() di C#. Chiamare direttamente o usare l'oggetto guardiano [LockContext](../../system/lockcontext/). |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | La proprietà specifica come una forma verrà resa in modalità bianco e nero. Scrittura [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual void [set_Frame](../ishape/set_frame/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) | Imposta le proprietà del riquadro della forma. Scrittura [IShapeFrame](../ishapeframe/). |
...
| virtual void [set_HyperlinkClick](../ihyperlinkcontainer/set_hyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Imposta il collegamento ipertestuale definito per il clic del mouse. Scrittura [IHyperlink](../ihyperlink/). |
| virtual void [set_HyperlinkMouseOver](../ihyperlinkcontainer/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Imposta il collegamento ipertestuale definito per il passaggio del mouse. Scrittura [IHyperlink](../ihyperlink/). |
...
| virtual void [set_RawFrame](../ishape/set_rawframe/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) | Imposta le proprietà grezze del riquadro della forma. Scrittura [IShapeFrame](../ishapeframe/). |
| virtual void [set_RelativeScaleHeight](./set_relativescaleheight/)(**float**) | Imposta la scala dell'altezza (rispetto alla dimensione originale dell'immagine) del riquadro immagine. Il valore 1,0 corrisponde al 100%. Scrittura **float**. |
| virtual void [set_RelativeScaleWidth](./set_relativescalewidth/)(**float**) | Imposta la scala della larghezza (rispetto alla dimensione originale dell'immagine) del riquadro immagine. Il valore 1,0 corrisponde al 100%. Scrittura **float**. |
...
| virtual void [set_ShapeType](../igeometryshape/set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) | Imposta il tipo di preset geometrico. Nota: al cambiamento del valore tutti i valori di aggiustamento verranno ripristinati ai loro valori predefiniti. Scrittura [Slides::ShapeType](../shapetype/). |
| virtual void [set_Width](../ishape/set_width/)(**float**) | Imposta la larghezza della forma, misurata in punti. Scrittura **float**. |
| virtual void [set_X](../ishape/set_x/)(**float**) | Imposta la coordinata x dell'angolo superiore sinistro della forma, misurata in punti. Scrittura **float**. |
| virtual void [set_Y](../ishape/set_y/)(**float**) | Imposta la coordinata y dell'angolo superiore sinistro della forma, misurata in punti. Scrittura **float**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template come puntatore debole (anziché condiviso). Consente lo scambio dei puntatori nei contenitori verso la modalità debole. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco della dichiarazione C# lock(). Chiamare direttamente o usare l'oggetto guardiano [LockContext](../../system/lockcontext/). |
