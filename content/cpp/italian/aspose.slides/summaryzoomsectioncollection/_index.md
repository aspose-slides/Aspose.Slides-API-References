...
Rappresenta una collezione di oggetti Summary Zoom [Section](../section/).
...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [AddSummaryZoomSection](./addsummaryzoomsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Crea un nuovo oggetto Summary Zoom [Section](../section/) e lo aggiunge alla collezione |
| [iterator](./iterator/) [begin](./begin/)() | Restituisce un iteratore che punta al primo elemento (se presente) della collezione. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza della collezione con qualificazione const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Restituisce un iteratore che punta al primo elemento con qualificazione const (se presente) della collezione. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento con qualificazione const (se presente) della collezione. |
| void [Clear](./clear/)() override | Rimuove tutti gli oggetti [SummaryZoomSection](../summaryzoomsection/) dalla collezione. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>\>, **int32_t**) override | Copia l'intera collezione nell'array specificato. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della collezione con qualificazione const. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di elementi effettivamente contenuti nella collezione. Solo lettura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera sulla collezione. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Abilita l'hashing di oggetti personalizzati. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [GetSummarySection](./getsummarysection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Restituisce l'elemento Summary Zoom [Section](../section/) per la sezione specificata. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce l'elemento all'indice specificato. Solo lettura [ISummaryZoomSection](../isummaryzoomsection/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>) override | Restituisce l'indice dell'oggetto [SummaryZoomSection](../summaryzoomsection/) specificato. |
...
| void [RemoveSummaryZoomSection](./removesummaryzoomsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Rimuove l'oggetto Summary Zoom [Section](../section/) dalla collezione. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori in modalità debole. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza della collezione con qualificazione const. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della collezione con qualificazione const. |
