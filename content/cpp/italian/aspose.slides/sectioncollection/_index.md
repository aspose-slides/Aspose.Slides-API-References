...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AddEmptySection](./addemptysection/)([System::String](../../system/string/), **int32_t**) override | Aggiunge una sezione vuota nella posizione specificata della collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AddSection](./addsection/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | Aggiunge una sezione di diapositive che inizia da una diapositiva specifica. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AppendEmptySection](./appendemptysection/)([System::String](../../system/string/)) override | Aggiunge una sezione vuota alla fine della collezione. |
...
| void [Clear](./clear/)() override | Rimuove tutte le sezioni dalla collezione. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>\>, **int32_t**) override | Copia l'intera collezione nell'array specificato. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce l'elemento all'indice specificato. [ISection](../isection/) di sola lettura. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Restituisce l'indice della sezione specificata nella collezione. |
...
| void [RemoveSection](./removesection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Rimuove la sezione. [Slides](../) contenuto nella sezione verrà unito alla sezione precedente. |
| void [RemoveSectionWithSlides](./removesectionwithslides/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Rimuove la sezione e le diapositive contenute nella sezione. |
| void [ReorderSectionWithSlides](./reordersectionwithslides/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>, **int32_t**) override | Sposta la sezione e le sue diapositive dalla collezione alla posizione specificata. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento del template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori in modalità debole. |
