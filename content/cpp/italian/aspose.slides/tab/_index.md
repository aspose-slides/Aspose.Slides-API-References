...
| Method | Description |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Confronta l'istanza corrente con un altro oggetto dello stesso tipo. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Restituisce lo stile di allineamento di un tabulatore. Leggi [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Restituisce la posizione di un tabulatore. Assegnare questa proprietà può cambiare l'indice del tabulatore nella collezione e invalidare l'Enumerator. Leggi **double**. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Imposta lo stile di allineamento di un tabulatore. Scrivi [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Imposta la posizione di un tabulatore. Assegnare questa proprietà può cambiare l'indice del tabulatore nella collezione e invalidare l'Enumerator. Scrivi **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Crea un nuovo [Tab](./) |
