...
description: Classe per caricare caratteri personalizzati definiti dall'utente. Deve essere usata prima di creare qualsiasi oggetto di presentazione.
type: docs
weight: 976
...
| Method | Description |
| --- | --- |
| static void [ClearCache](./clearcache/)() | Rilascia tutti i caratteri personalizzati definiti dall'utente |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetFontFolders](./getfontfolders/)() | Ottiene le cartelle dei caratteri. Restituisce le cartelle aggiunte con il metodo LoadExternalFonts così come le cartelle dei caratteri di sistema |
...
| static void [LoadExternalFont](./loadexternalfont/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Aggiunge un carattere dai dati binari |
| static void [LoadExternalFonts](./loadexternalfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Aggiunge cartelle aggiuntive per cercare i caratteri. |
