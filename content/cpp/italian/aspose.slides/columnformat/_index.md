...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormatEffectiveData](../icolumnformateffectivedata/)\> [GetEffective](./geteffective/)() override | Ottiene le proprietà di formattazione effettive della colonna della tabella con ereditarietà e stili di tabella applicati. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e consente la costruzione di copie per le sottoclassi. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento template come puntatore debole (invece che condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
* Classe [IColumnFormat](../icolumnformat/)
