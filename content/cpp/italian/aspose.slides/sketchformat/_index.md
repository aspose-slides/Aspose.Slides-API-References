...
description: Rappresenta le proprietà per il formato sketch delle linee.
type: docs
weight: 5162
...
Rappresenta le proprietà per il formato sketch delle linee.
...
| [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() override | Restituisce il tipo di sketch. Lettura [Slides::LineSketchType](../linesketchtype/). |
...
| void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) override | Imposta il tipo di sketch. Scrittura [Slides::LineSketchType](../linesketchtype/). |
...
* Classe [ISketchFormat](../isketchformat/)
