...
description: Restituisce l'oggetto ThreeDFormat che rappresenta le proprietà dell'effetto 3d per un testo. Sola lettura IThreeDFormat.
type: docs
weight: 300
url: /it/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() metodo


Restituisce l'[ThreeDFormat](../../threedformat/) oggetto che rappresenta le proprietà dell'effetto 3d per un testo. Sola lettura [IThreeDFormat](../../ithreedformat/).
