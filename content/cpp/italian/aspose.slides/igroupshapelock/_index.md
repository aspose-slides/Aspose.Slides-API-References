...
description: Determina quali operazioni sono disabilitate sul GroupShape genitore.
type: docs
weight: 2497
...
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | Determina se la forma deve preservare il rapporto d'aspetto durante il ridimensionamento. Lettura **bool**. |
...
| virtual **bool** [get_RotationLocked](./get_rotationlocked/)() | Determina se cambiare l'angolo di rotazione di questa forma è proibito. Lettura **bool**. |
...
| virtual **bool** [get_UngroupingLocked](./get_ungroupinglocked/)() | Determina se la divisione di questa forma di gruppo è proibita. Lettura **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza il nuovo oggetto e abilita la copia dei sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza il nuovo oggetto e abilita la copia dei sottoclassi. |
...
| virtual void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) | Determina se la forma deve preservare il rapporto d'aspetto durante il ridimensionamento. Scrittura **bool**. |
...
| virtual void [set_RotationLocked](./set_rotationlocked/)(**bool**) | Determina se cambiare l'angolo di rotazione di questa forma è proibito. Scrittura **bool**. |
...
| virtual void [set_UngroupingLocked](./set_ungroupinglocked/)(**bool**) | Determina se la divisione di questa forma di gruppo è proibita. Scrittura **bool**. |
