...
| void [Lock](../../system/object/lock/)() | Implementa il blocco di istruzione C# lock(). Chiama direttamente o usa l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| virtual [ResourceLoadingAction](../resourceloadingaction/) [ResourceLoading](./resourceloading/)([System::SharedPtr](../../system/sharedptr/)\<[IResourceLoadingArgs](../iresourceloadingargs/)\>) | Metodo di callback che regola il caricamento di risorse esterne. |
