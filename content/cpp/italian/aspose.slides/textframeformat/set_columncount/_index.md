...
description: Imposta il numero di colonne nell'area di testo. Questo valore deve essere un numero positivo. Altrimenti, il valore sarà impostato a zero. Il valore 0 indica un valore non definito. Scrivi int32_t.
type: docs
weight: 261
url: /it/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) method


Imposta il numero di colonne nell'area di testo. Questo valore deve essere un numero positivo. Altrimenti, il valore sarà impostato a zero. Il valore 0 indica un valore non definito. Scrivi **int32_t**.
...
Il seguente codice di esempio mostra come aggiungere una colonna nel riquadro di testo all'interno di un PowerPoint [Presentation](../../presentation/). 
```cpp
