...
description: Restituisce l'oggetto ThreeDFormat che rappresenta le proprietà dell'effetto 3D per un testo. Solo lettura IThreeDFormat.
type: docs
weight: 1
url: /it/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() metodo

Restituisce il [ThreeDFormat](../../threedformat/) oggetto che rappresenta le proprietà dell'effetto 3D per un testo. Solo lettura [IThreeDFormat](../../ithreedformat/).
