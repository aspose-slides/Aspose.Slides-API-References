...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Aggiunge una copia di una diapositiva master specificata alla fine della collezione. Le diapositive di layout collegate verranno copiate anch'esse. |
| [iterator](./iterator/) [begin](./begin/)() | Ottiene un iteratore che punta al primo elemento (se presente) della collezione. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Ottiene un iteratore che punta al primo elemento (se presente) dell'istanza della collezione qualificata come const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Ottiene un iteratore che punta al primo elemento qualificato come const (se presente) della collezione. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento qualificato come const (se presente) della collezione. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>, **int32_t**) override | Copia tutti gli elementi della collezione nell'array specificato. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della collezione qualificata come const. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di elementi effettivamente contenuti nella collezione. **int32_t** di sola lettura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Restituisce una radice di sincronizzazione. [System::Object](../../system/object/) di sola lettura. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ottiene la struttura dati del contatore di riferimento associata all'oggetto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) override | Ottiene l'elemento all'indice specificato. [MasterSlide](../masterslide/) di sola lettura. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Inserisce una copia di una diapositiva master specificata nella posizione specificata della collezione. Le diapositive di layout collegate verranno copiate anch'esse. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Trasforma gli elementi nel tipo specificato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e consente la copia dei sottoclasse. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e consente la copia dei sottoclasse. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Rimuove la prima occorrenza di uno specifico oggetto dalla collezione. |
...
| void [RemoveUnused](./removeunused/)(**bool**) override | Rimuove le diapositive master inutilizzate. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento di template a un puntatore debole (piuttosto che condiviso). Consente di cambiare i puntatori nei contenitori in modalità debole. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ottiene un iteratore che punta al primo elemento (se presente) dell'istanza della collezione qualificata come const. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ottiene un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della collezione qualificata come const. |
