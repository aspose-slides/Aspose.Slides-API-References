...
type: docs
weight: 677
url: /it/aspose.slides/details_pptexception/
---
## Details_PptException classe
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a weak pointer (anziché shared). Consente di passare i puntatori nei contenitori a modalità weak. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementa il metodo [what()](../../system/details_exception/what/) che è chiamato dalla classe [ExceptionWrapper](../../system/exceptionwrapper/). Nonostante il fatto che questa classe non erediti da std::exception, le classi derivate possono usare membri protected/private per implementare la loro logica. Spostare l'implementazione di questo metodo su [ExceptionWrapper](../../system/exceptionwrapper/) potrebbe rompere tale logica. |
