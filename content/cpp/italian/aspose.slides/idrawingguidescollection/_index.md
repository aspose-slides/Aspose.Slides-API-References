...
description: Rappresenta una collezione delle guide di disegno regolabili.
type: docs
weight: 2016
...
Rappresenta una collezione delle guide di disegno regolabili.
...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) | Aggiunge la guida di disegno alla fine della collezione. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Ottiene il numero di tutti gli elementi nella collezione. Solo lettura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce la guida di disegno per indice. Solo lettura [IDrawingGuide](../idrawingguide/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove la guida di disegno all'indice specificato. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa il rilascio del lock() di C#. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
