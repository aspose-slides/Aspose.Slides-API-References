...
description: Eccezione lanciata quando il file di presentazione è probabilmente corrotto.
type: docs
weight: 651
url: /it/aspose.slides/details_pptcorruptfileexception/
---
## Details_PptCorruptFileException classe


Eccezione lanciata quando il file di presentazione è probabilmente corrotto.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita ad inizializzare un nuovo oggetto e consente la costruzione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita ad inizializzare un nuovo oggetto e consente la costruzione di copie di sottoclassi. |
