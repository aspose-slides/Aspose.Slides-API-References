...
| [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() override | Direzione della luce. Leggi [LightingDirection](../lightingdirection/). |
| [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() override | Rappresenta una luce preimpostata che può essere applicata a una forma. Il dispositivo di illuminazione rappresenta un gruppo di luci orientate in modo specifico rispetto a una scena 3D. Leggi [LightRigPresetType](../lightrigpresettype/). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() override | Una rotazione è definita tramite l'uso di una coordinata di latitudine, una coordinata di longitudine e una rivoluzione attorno all'asse come le coordinate di latitudine e longitudine. Primo elemento nell'array di ritorno - latitudine, secondo - longitudine, terzo - rivoluzione. Restituisce null se nessuna rotazione è definita. |
...
| void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) override | Direzione della luce. Scrivi [LightingDirection](../lightingdirection/). |
| void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) override | Rappresenta una luce preimpostata che può essere applicata a una forma. Il dispositivo di illuminazione rappresenta un gruppo di luci orientate in modo specifico rispetto a una scena 3D. Scrivi [LightRigPresetType](../lightrigpresettype/). |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | Una rotazione è definita tramite l'uso di una coordinata di latitudine, una coordinata di longitudine e una rivoluzione attorno all'asse come le coordinate di latitudine e longitudine. Se uno qualsiasi dei valori delle coordinate è std::numeric_limits<float>::quiet_NaN(), tutta la rotazione è indefinita. |
