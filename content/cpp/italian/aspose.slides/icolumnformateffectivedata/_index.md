...
description: Oggetto immutabile che contiene le proprietà di formattazione effettive della colonna di tabella.
type: docs
weight: 1769
...
Oggetto immutabile che contiene le proprietà di formattazione della colonna di tabella effettive.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalDown](../ibasetableformateffectivedata/get_borderdiagonaldown/)() | Restituisce il valore effettivo del formato della linea diagonale inferiore. Sola lettura [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalUp](../ibasetableformateffectivedata/get_borderdiagonalup/)() | Restituisce il valore effettivo del formato della linea diagonale superiore. Sola lettura [ILineFormatEffectiveData](../ilineformateffectivedata/). |
...
Questa interfaccia è usata insieme all'interfaccia [IColumnFormat](../icolumnformat/) per restituire i valori di formattazione effettivi con ereditarietà e stili di tabella applicati. 
