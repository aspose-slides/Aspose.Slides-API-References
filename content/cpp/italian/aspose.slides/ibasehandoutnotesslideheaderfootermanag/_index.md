...
description: Rappresenta un manager che gestisce il comportamento dei segnaposti, incluso il segnaposto intestazione per tutti i tipi di diapositive di dispense e di note.
type: docs
weight: 1431
...
Rappresenta il manager che contiene il comportamento dei segnaposti, incluso il segnaposto intestazione per tutti i tipi di diapositive di dispense e note.
...
| virtual **bool** [get_IsHeaderVisible](./get_isheadervisible/)() | Ottiene valore che indica che è presente un segnaposto intestazione. Leggi **bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementa il lock() statement C# per il blocco. Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| virtual void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) | Imposta il testo nel segnaposto intestazione della diapositiva. |
| virtual void [SetHeaderVisibility](./setheadervisibility/)(**bool**) | Modifica la visibilità del segnaposto intestazione della diapositiva. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa lo sblocco del lock() statement C#. Chiamare direttamente o usare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
Il nome originale dell'interfaccia "IBaseHandoutNotesSlideHeaderFooterManager" è stato troncato in "IBaseHandoutNotesSlideHeaderFooterManag" per compatibilità COM (la lunghezza del nome del tipo non deve superare i 39 caratteri).
