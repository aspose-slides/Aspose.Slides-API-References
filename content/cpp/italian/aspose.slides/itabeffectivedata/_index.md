...
description: Oggetto immutabile che contiene le proprietà di stop di tabulazione del testo effettivo.
type: docs
weight: 3992
...
Oggetto immutabile che contiene le proprietà di stop di tabulazione del testo effettivo.
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Restituisce lo stile di allineamento di una tabulazione. Solo lettura [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Restituisce la posizione di una tabulazione. Assegnare questa proprietà può modificare l'indice della tabulazione nella collezione e invalidare l'Enumerator. Solo lettura **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita ad inizializzare un nuovo oggetto e a consentire la costruzione di copie nelle classi derivate. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita ad inizializzare un nuovo oggetto e a consentire la costruzione di copie nelle classi derivate. |
