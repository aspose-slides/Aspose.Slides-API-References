...
description: Oggetto immutabile che contiene l'insieme di font effective.
type: docs
weight: 2224
url: /it/aspose.slides/ifontseffectivedata/
---
## IFontsEffectiveData classe


Oggetto immutabile che contiene l'insieme di font effective.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | Restituisce il font per script complessi. Solo lettura [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | Restituisce il font dell'Est asiatico. Solo lettura [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | Restituisce il font latino. Solo lettura [IFontData](../ifontdata/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento del template come puntatore debole (anziché condiviso). Consente di cambiare i puntatori nei contenitori alla modalità debole. |
...
Questa interfaccia è usata come parte delle interfacce [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/) e [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/).
