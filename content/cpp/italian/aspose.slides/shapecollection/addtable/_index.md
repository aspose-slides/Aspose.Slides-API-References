...
---
## ShapeCollection::AddTable(float, float, System::ArrayPtr\<double\>, System::ArrayPtr\<double\>) metodo
...
Il seguente esempio mostra come aggiungere una tabella in PowerPoint [Presentation](../../presentation/). 
```cpp
...
// Aggiungere la forma tabella alla diapositiva
System::SharedPtr<ITable> table = slide->get_Shapes()->AddTable(100.0f, 50.0f, dblCols, dblRows);
// Impostare il formato del bordo per ogni cella
