...
description: Gestore di diapositive delle note.
type: docs
weight: 3043
url: /it/aspose.slides/inotesslidemanager/
---
## INotesSlideManager classe

Gestore di diapositive delle note.
...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() | Restituisce la diapositiva delle note per la diapositiva corrente, creandone una se non esiste. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() | Restituisce la diapositiva delle note per la diapositiva corrente. Restituisce null se la diapositiva non ha una diapositiva delle note. Solo lettura [INotesSlide](../inotesslide/). |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco del statement C# lock(). Chiamare direttamente o utilizzare l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [RemoveNotesSlide](./removenotesslide/)() | Rimuove la diapositiva delle note della diapositiva corrente. |
