...
Rappresenta un segmento del percorso grafico di [GeometryShape](../geometryshape/)
...
| virtual [PathCommandType](../pathcommandtype/) [get_PathCommand](./get_pathcommand/)() | Tipo di percorso del segmento |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_SegmentData](./get_segmentdata/)() | Dati del percorso del segmento |
