...
Consente di creare istanze di [ITab](../itab/) ```cpp
...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\> [CreateTab](./createtab/)(**double**, [TabAlignment](../tabalignment/)) override | Crea una nuova istanza di [ITab](../itab/). |
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo a scopo interno. |
...
* Classe [ITabFactory](../itabfactory/)
