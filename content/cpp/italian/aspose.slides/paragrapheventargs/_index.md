...
description: Classe di argomenti evento per eventi relativi ai paragrafi.
type: docs
weight: 4642
url: /it/aspose.slides/paragrapheventargs/
---
## ParagraphEventArgs classe

Evento argomenti classe per eventi relativi ai paragrafi.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento template come puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori in modalità debole. |
