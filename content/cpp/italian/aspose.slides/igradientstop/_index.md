...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Restituisce il colore di un punto di arresto del gradiente. Solo lettura [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Restituisce la posizione (0..1) di un punto di arresto del gradiente. Leggi **float**. |
...
| virtual void [set_Position](./set_position/)(**float**) | Imposta la posizione (0..1) di un punto di arresto del gradiente. Scrivi **float**. |
