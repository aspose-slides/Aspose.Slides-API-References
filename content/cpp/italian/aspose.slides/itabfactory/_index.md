...
Consente di creare istanze di [ITab](../itab/)
...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\> [CreateTab](./createtab/)(**double**, [TabAlignment](../tabalignment/)) | Crea una nuova istanza di [ITab](../itab/). |
