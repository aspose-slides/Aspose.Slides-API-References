...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Ottiene l'iteratore che punta al primo elemento qualificato const (se presente) della collezione. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento qualificato const (se presente) della collezione. |
...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Restituisce il numero di comportamenti in una collezione. Solo lettura **int32_t**. |
| virtual **double** [get_Height](./get_height/)() | Restituisce l'altezza di una riga. Solo lettura **double**. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Restituisce un valore che indica se l'accesso alla collezione è sincronizzato (thread-safe). Solo lettura **bool**. |
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Restituisce l'altezza minima possibile di una riga. Leggi **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Restituisce l'oggetto [RowFormat](../rowformat/) che contiene le proprietà di formattazione per questa riga. Solo lettura [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Restituisce una radice di sincronizzazione. Solo lettura [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Restituisce una cella per la sua posizione. Solo lettura [ICell](../icell/). |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Imposta l'altezza minima possibile di una riga. Scrivi **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un weak pointer (invece che shared). Consente di passare i puntatori nei contenitori a modalità weak. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Imposta le proprietà di formattazione della porzione definita a tutte le porzioni dell'elemento. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Imposta le proprietà di formattazione del paragrafo definito a tutti i paragrafi dell'elemento. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Imposta le proprietà di formattazione del frame di testo definito a tutti i frame di testo dell'elemento. |
