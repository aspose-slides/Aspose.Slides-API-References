...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | Restituisce i dati del file dell'oggetto OLE incorporato. Solo lettura **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | Restituisce l'estensione del file per l'attuale oggetto OLE incorporato. Solo lettura [System::String](../../system/string/). |
