...
description: "Impostazioni di base della presentazione. Gli antenati rappresentano i tipi della presentazione: PresentedBySpeaker Presentata da un relatore (schermo intero) BrowsedByIndividual Navigata da un individuo (finestra) BrowsedAtKiosk Navigata su un chiosco (schermo intero)"
type: docs
weight: 5227
...
Impostazioni di base della presentazione. Gli antenati rappresentano i tipi della presentazione: [PresentedBySpeaker](../presentedbyspeaker/) Presentata da un relatore (schermo intero) [BrowsedByIndividual](../browsedbyindividual/) Navigata da un individuo (finestra) [BrowsedAtKiosk](../browsedatkiosk/) Navigata su un chiosco (schermo intero)
