...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza qualificata come const della collezione. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza qualificata come const della collezione. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() | Restituisce l'oggetto [ColumnFormat](../columnformat/) che contiene le proprietà di formattazione per questa colonna. Solo lettura [IColumnFormat](../icolumnformat/). |
...
| virtual **double** [get_Width](./get_width/)() | Restituisce la larghezza di una colonna. Solo lettura **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Restituisce una cella in base alla sua posizione. Solo lettura [ICell](../icell/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Restituisce il primo elemento della sequenza che soddisfa una condizione o un valore predefinito se non ne esiste alcuno. |
...
| virtual void [set_Width](./set_width/)(**double**) | Imposta la larghezza di una colonna. Scrivi **double**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Imposta le proprietà di formato del frame di testo definito a tutti i frame di testo dell'elemento. |
