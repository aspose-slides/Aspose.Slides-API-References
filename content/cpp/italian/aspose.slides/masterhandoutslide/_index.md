...
description: Rappresenta la diapositiva master per i fogli distribuzione.
type: docs
weight: 4408
...
Rappresenta la diapositiva master per i fogli distribuzione.
...
| **bool** [Equals](../baseslide/equals/)([System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\>) override | Determina se le due [IBaseSlide](../ibaseslide/) istanze sono uguali. Il valore restituito è calcolato in base alla struttura della diapositiva e al contenuto statico. Due diapositive sono uguali se tutte le forme, gli stili, i testi, le animazioni e altre impostazioni, ecc., sono uguali. Il confronto non considera i valori degli identificatori unici, ad es. SlideId, né i contenuti dinamici, ad es. il valore della data corrente in Date [Placeholder](../placeholder/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Restituisce una collezione di guide di disegno per la diapositiva master del foglio distribuzione. Solo lettura [IDrawingGuidesCollection](../idrawingguidescollection/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Restituisce il gestore HeaderFooter della diapositiva master del foglio distribuzione. Solo lettura [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/). |
...
| [System::String](../../system/string/) [get_Name](../baseslide/get_name/)() override | Restituisce il nome di una diapositiva. Leggi [System::String](../../system/string/). |
