...
description: Rappresenta una raccolta di aggiustamenti delle forme.
type: docs
weight: 14
...
Rappresenta una raccolta di aggiustamenti delle forme.
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce un numero di aggiustamenti. **int32_t** di sola lettura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce l'aggiustamento per indice. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento del modello come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
