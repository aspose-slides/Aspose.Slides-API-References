...
description: Determina quali operazioni sono disabilitate sul genitore GroupShape.
type: docs
weight: 1210
...
Determina quali operazioni sono disabilitate sul genitore [GroupShape](../groupshape/).
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | Determina se la forma deve preservare il rapporto d'aspetto durante il ridimensionamento. Lettura **bool**. |
| **bool** [get_GroupingLocked](./get_groupinglocked/)() override | Determina se aggiungere questa forma a un gruppo è vietato. Lettura **bool**. |
...
| **bool** [get_RotationLocked](./get_rotationlocked/)() override | Determina se modificare l'angolo di rotazione di questa forma è vietato. Lettura **bool**. |
...
| **bool** [get_UngroupingLocked](./get_ungroupinglocked/)() override | Determina se la divisione di questo groupshape è vietata. Lettura **bool**. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la copia dei sottoclassi. |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | Determina se la forma deve preservare il rapporto d'aspetto durante il ridimensionamento. Scrittura **bool**. |
| void [set_GroupingLocked](./set_groupinglocked/)(**bool**) override | Determina se aggiungere questa forma a un gruppo è vietato. Scrittura **bool**. |
...
| void [set_RotationLocked](./set_rotationlocked/)(**bool**) override | Determina se modificare l'angolo di rotazione di questa forma è vietato. Scrittura **bool**. |
...
| void [set_UngroupingLocked](./set_ungroupinglocked/)(**bool**) override | Determina se la divisione di questo groupshape è vietata. Scrittura **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template come puntatore debole (invece che condiviso). Consente di cambiare i puntatori nei contenitori a modalità debole. |
