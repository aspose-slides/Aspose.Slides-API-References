...
| [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() override | Restituisce l'orientamento della diapositiva. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Restituisce le dimensioni della diapositiva in punti. |
| [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() override | Restituisce il tipo di dimensione della diapositiva. |
...
| void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) override | Imposta l'orientamento della diapositiva. |
| void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) override | Imposta la dimensione della diapositiva per tipo e scala il contenuto esistente. |
| void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) override | Imposta esplicitamente le dimensioni della diapositiva e scala il contenuto esistente. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta l'n-esimo argomento template come puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori a modalità debole. |
