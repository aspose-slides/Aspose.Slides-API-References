...
| Metodo | Descrizione |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) override | Aggiunge una regola FallBack specificata alla fine della collezione. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>\>, **int32_t**) override | Copia tutti gli elementi dalla collezione nell'array specificato. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di regole effettivamente contenute nella collezione. Solo lettura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce la regola all'indice specificato. Solo lettura [IFontFallBackRule](../ifontfallbackrule/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e abilita la copia dei sottotipi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e abilita la copia dei sottotipi. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) override | Rimuove la prima occorrenza di una regola FallBack specifica dalla collezione. |
...
| Typedef | Descrizione |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Un tipo di collezione i cui tipi di iteratore sono utilizzati come tipi di iteratore nella collezione corrente. |
