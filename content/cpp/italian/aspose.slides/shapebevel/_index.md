...
description: Contiene le proprietà del rilievo della faccia principale della forma.
type: docs
weight: 5097
...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | Tipo di smussatura. Leggi [BevelPresetType](../bevelpresettype/). |
| **double** [get_Height](./get_height/)() override | Altezza della smussatura. Leggi **double**. |
...
| **double** [get_Width](./get_width/)() override | Larghezza della smussatura. Leggi **double**. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | Tipo di smussatura. Scrivi [BevelPresetType](../bevelpresettype/). |
| void [set_Height](./set_height/)(**double**) override | Altezza della smussatura. Scrivi **double**. |
| void [set_Width](./set_width/)(**double**) override | Larghezza della smussatura. Scrivi **double**. |
