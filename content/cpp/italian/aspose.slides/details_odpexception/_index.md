...
type: docs
weight: 599
url: /it/aspose.slides/details_odpexception/
---
## Details_OdpException classe
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (invece che condiviso). Consente di cambiare i puntatori nei contenitori alla modalità debole. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Restituisce la rappresentazione in stringa dell'oggetto corrente. |
