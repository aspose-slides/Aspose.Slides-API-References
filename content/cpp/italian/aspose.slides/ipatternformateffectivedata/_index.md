...
description: Oggetto immutabile che contiene le proprietà di riempimento pattern efficaci.
type: docs
weight: 3199
...
Oggetto immutabile che contiene le proprietà di riempimento pattern efficaci.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_BackColor](./get_backcolor/)() | Restituisce il colore di sfondo del pattern. Solo lettura [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ForeColor](./get_forecolor/)() | Restituisce il colore di primo piano del pattern. Solo lettura [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::PatternStyle](../patternstyle/) [get_PatternStyle](./get_patternstyle/)() | Restituisce lo stile del pattern. Solo lettura [Slides::PatternStyle](../patternstyle/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTileIImage](./gettileiimage/)([System::Drawing::Color](../../system.drawing/color/), [System::Drawing::Color](../../system.drawing/color/)) | Crea un'immagine tile per il riempimento pattern con i colori specificati. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo al metodo C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Abilita il clono di tipi personalizzati. |
