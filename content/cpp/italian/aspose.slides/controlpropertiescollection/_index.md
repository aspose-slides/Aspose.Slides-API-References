...
| Metodo | Descrizione |
| --- | --- |
| void [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Aggiunge una proprietà alla raccolta. |
...
| void [Clear](./clear/)() override | Rimuove tutte le proprietà. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di proprietà nella raccolta. **int32_t** di sola lettura. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::String](../../system/string/)\>\> [get_NamesOfProperties](./get_namesofproperties/)() override | Restituisce la raccolta dei nomi delle proprietà. ICollection<string> di sola lettura. |
...
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | Restituisce la proprietà. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Imposta la proprietà. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Rimuove una proprietà con il nome specificato. |
...
| Typedef | Descrizione |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Un tipo di raccolta i cui tipi di iteratore sono usati come tipi di iteratore nella raccolta corrente. |
