...
description: Rappresenta il gestore che contiene il comportamento dei segnaposto della diapositiva note, incluso il segnaposto dell'intestazione.
type: docs
weight: 4577
...
Rappresenta il gestore che contiene il comportamento dei segnaposto della diapositiva note, incluso il segnaposto dell'intestazione.
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Ottiene il valore che indica la presenza di un segnaposto data-ora. Leggi**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Ottiene il valore che indica la presenza di un segnaposto piè di pagina. Leggi **bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | Ottiene il valore che indica la presenza di un segnaposto intestazione. Leggi **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Ottiene il valore che indica la presenza di un segnaposto numero di pagina. Leggi**bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementa il lock() in stile C#. Chiama direttamente o utilizza l'oggetto sentinella [LockContext](../../system/lockcontext/). |
