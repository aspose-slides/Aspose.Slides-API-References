...
| Metodo | Descrizione |
| --- | --- |
| virtual **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) | Verifica se una password è corretta per una presentazione protetta con password di apertura. |
| virtual **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) | Verifica se una password di modifica è corretta per una presentazione protetta da scrittura. |
...
| virtual **bool** [get_IsEncrypted](./get_isencrypted/)() | Restituisce True se la presentazione collegata è crittografata, altrimenti False. **bool** solo lettura. |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Restituisce un valore che indica se la presentazione collegata è protetta da una password di apertura. |
| virtual [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() | Restituisce un valore che indica se la presentazione collegata è protetta da scrittura. |
| virtual [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() | Restituisce il formato della presentazione collegata. [Slides::LoadFormat](../loadformat/) solo lettura. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, semplicemente inizializza un nuovo oggetto e consente la costruzione di copia delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, ma inizializza un nuovo oggetto e consente la costruzione di copia delle sottoclassi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() | Restituisce le proprietà del documento della presentazione collegata. |
...
| virtual void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) | Aggiorna le proprietà della presentazione collegata. |
...
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Scrive la presentazione collegata su stream. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) | Scrive la presentazione collegata su file. |
