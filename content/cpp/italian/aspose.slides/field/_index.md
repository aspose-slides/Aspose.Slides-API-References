...
| [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() override | Restituisce il tipo del campo. Leggi [IFieldType](../ifieldtype/). |
...
| void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | Imposta il tipo del campo. Scrivi [IFieldType](../ifieldtype/). |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n'tesimo argomento del template a un puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
