...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\>, **int32_t**) override | Copia l'intera raccolta nell'array specificato. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Restituisce la radice di sincronizzazione. Sola lettura [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [idx_get](./idx_get/)(**int32_t**) override | Ottiene l'elemento all'indice specificato. Sola lettura [ISlide](../islide/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se esiste almeno un elemento nella sequenza oppure se soddisfa una condizione. |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco di lock() in stile C#. Chiamare direttamente o usare l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta il n-esimo argomento template a un weak pointer (anziché shared). Consente di passare i puntatori nei contenitori a modalità weak. |
