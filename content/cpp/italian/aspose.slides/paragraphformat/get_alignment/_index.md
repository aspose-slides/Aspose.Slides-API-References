...
description: Restituisce l'allineamento del testo in un paragrafo senza ereditarietà. Leggi TextAlignment.
type: docs
weight: 1
url: /it/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() metodo

Restituisce l'allineamento del testo in un paragrafo senza ereditarietà. Leggi [TextAlignment](../../textalignment/).
...
Il seguente codice di esempio mostra come allineare i paragrafi di testo in PowerPoint [Presentation](../../presentation/).
```cpp
