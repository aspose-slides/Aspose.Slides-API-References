...
type: docs
weight: 742
url: /it/aspose.slides/details_pptxreadexception/
---
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco di lock() di C#. Chiamare direttamente o utilizzare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Imposta HRESULT, valore numerico codificato assegnato a una specifica eccezione. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementa il metodo [what()](../../system/details_exception/what/) chiamato dalla classe [ExceptionWrapper](../../system/exceptionwrapper/). Nonostante questa classe non erediti da std::exception, le classi derivate possono utilizzare membri protetti/privati per implementare la loro logica. Spostare l'implementazione di questo metodo nel [ExceptionWrapper](../../system/exceptionwrapper/) potrebbe rompere tale logica. |
