...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) override | Crea la nuova fermata di gradiente e la aggiunge alla fine della collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) override | Crea la nuova fermata di gradiente e la aggiunge alla fine della collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) override | Crea la nuova fermata di gradiente e la aggiunge alla fine della collezione. |
...
| void [Clear](./clear/)() override | Rimuove tutte le fermate di gradiente da una collezione. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>, **int32_t**) override | Copia tutti gli elementi della collezione nell'array specificato. |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Copia tutti gli elementi della collezione nel array specificato. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di fermate di gradiente in una collezione. Sola lettura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | Restituisce il codice hash. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ottiene il tipo reale dell'oggetto. Analogo della chiamata C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce la fermata di gradiente per indice. |
| void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) override | Crea la nuova fermata di gradiente e la inserisce all'indice specificato nella collezione. |
| void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) override | Crea la nuova fermata di gradiente e la inserisce all'indice specificato nella collezione. |
| void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) override | Crea la nuova fermata di gradiente e la inserisce all'indice specificato nella collezione. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e consente la creazione di copie di subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnamento. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e consente la creazione di copie di subclass. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Rimuove una fermata di gradiente all'indice specificato. |
