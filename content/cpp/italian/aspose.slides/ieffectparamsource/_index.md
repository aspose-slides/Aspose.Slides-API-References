...
description: Interfaccia per i parametri di effetto ausiliari.
type: docs
weight: 2068
...
Interfaccia ausiliaria per i parametri di effetto.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la creazione di copie per le sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la creazione di copie per le sottoclassi. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento del template a un puntatore debole (anziché condiviso). Permette di passare i puntatori nei contenitori alla modalità debole. |
