...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Restituisce il commento effettuato da questo autore all'indice specificato. Solo lettura [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Restituisce la collezione dei commenti effettuati da questo autore. Solo lettura [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Restituisce le iniziali dell'autore. Lettura [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Restituisce il nome dell'autore. Lettura [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Rimuove l'autore dalla raccolta genitore. |
...
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Imposta le iniziali dell'autore. Scrittura [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Imposta il nome dell'autore. Scrittura [System::String](../../system/string/). |
