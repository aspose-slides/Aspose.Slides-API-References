...
| Metodo | Descrizione |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) | Crea un nuovo gradient stop e lo aggiunge alla fine della collezione. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) | Crea un nuovo gradient stop e lo aggiunge alla fine della collezione. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) | Crea un nuovo gradient stop e lo aggiunge alla fine della collezione. |
...
| virtual void [Clear](./clear/)() | Rimuove tutti i gradient stop da una collezione. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce il gradient stop per indice. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) | Crea un nuovo gradient stop e lo inserisce all'indice specificato nella collezione. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) | Crea un nuovo gradient stop e lo inserisce all'indice specificato nella collezione. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) | Crea un nuovo gradient stop e lo inserisce all'indice specificato nella collezione. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove un gradient stop all'indice specificato. |
