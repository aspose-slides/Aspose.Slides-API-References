...
| virtual **uint32_t** [get_Index](./get_index/)() | Ottiene l'indice di un segnaposto. Solo lettura **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Ottiene l'orientamento di un segnaposto. Solo lettura [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | Ottiene la dimensione di un segnaposto. Solo lettura [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | Ottiene il tipo di un segnaposto. Solo lettura [PlaceholderType](../placeholdertype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e consente la copia di costruttori delle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo un nuovo oggetto e consente la copia di costruttori delle sottoclassi. |
