...
description: Recupera i dati di formattazione del riempimento effettivi con l'ereditarietà applicata.
type: docs
weight: 105
...
Restituisce i dati di formattazione del riempimento effettivi con l'ereditarietà applicata.
...
Questo esempio dimostra come ottenere le proprietà di formattazione del riempimento effettive della forma.
```cpp
