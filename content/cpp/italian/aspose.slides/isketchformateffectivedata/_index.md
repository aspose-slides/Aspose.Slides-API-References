...
description: Oggetto immutabile che contiene le proprietà effettive del disegno della linea.
type: docs
weight: 3745
...
Oggetto immutabile che contiene le proprietà effettive del disegno della linea.
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Restituisce il tipo di schizzo. Solo lettura [Slides::LineSketchType](../linesketchtype/). |
