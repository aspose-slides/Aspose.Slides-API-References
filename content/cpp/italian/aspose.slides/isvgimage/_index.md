...
| virtual [System::String](../../system/string/) [get_BaseUri](./get_baseuri/)() | Restituisce l'URI base dell'SVG specificato. Usato per risolvere i collegamenti relativi. Solo lettura [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\> [get_ExternalResourceResolver](./get_externalresourceresolver/)() | Restituisce l'interfaccia di callback usata per risolvere le risorse esterne durante l'importazione dei documenti SVG. Solo lettura [Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/). |
| virtual [System::String](../../system/string/) [get_SvgContent](./get_svgcontent/)() | Restituisce il contenuto SVG. Solo lettura [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_SvgData](./get_svgdata/)() | Restituisce i dati SVG. Solo lettura **uint8_t**[]. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione di copie delle classi derivate. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza un nuovo oggetto e consente la costruzione di copie delle classi derivate. |
...
| virtual void [WriteAsEmf](./writeasemf/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Salva l'immagine SVG come file EMF. |
