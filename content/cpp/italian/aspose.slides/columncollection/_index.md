...
| Metodo | Descrizione |
| --- | --- |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>, **bool**) override | Crea una copia della riga modello specificata e la inserisce in fondo a una tabella. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Ottiene l'iteratore che punta al primo elemento qualificato const (se presente) della collezione. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Ottiene l'iteratore che punta immediatamente dopo l'ultimo elemento qualificato const (se presente) della collezione. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\>, **int32_t**) override | Copia tutti gli elementi della collezione nell'array specificato. |
...
| [iterator](./iterator/) [end](./end/)() | Ottiene l'iteratore che punta immediatamente dopo l'ultimo elemento (se presente) della collezione. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Ottiene l'iteratore che punta immediatamente dopo l'ultimo elemento (se presente) dell'istanza della collezione qualificata come const. |
...
| **int32_t** [get_Count](./get_count/)() override | Restituisce il numero di colonne in una collezione. **int32_t** di sola lettura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la collezione. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce la colonna all'indice specificato. [Column](../column/) di sola lettura. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>, **bool**) override | Crea una copia della colonna modello specificata e la inserisce nella posizione specificata in una tabella. |
...
| void [RemoveAt](./removeat/)(**int32_t**, **bool**) override | Rimuove una colonna nella posizione specificata da una tabella. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimenti condivisi del valore specificato. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Imposta l'n-esimo argomento modello come puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ottiene l'iteratore che punta immediatamente dopo l'ultimo elemento (se presente) dell'istanza della collezione qualificata come const. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Ottiene l'iteratore che punta immediatamente dopo l'ultimo elemento (se presente) della collezione. |
...
* Classe [IColumnCollection](../icolumncollection/)
