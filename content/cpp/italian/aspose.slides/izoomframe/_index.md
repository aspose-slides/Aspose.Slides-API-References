...
| virtual **bool** [get_ReturnToParent](../izoomobject/get_returntoparent/)() | Ottiene il comportamento di navigazione nella presentazione. Leggi **bool**. Valore predefinito: false |
...
| virtual **bool** [get_ShowBackground](../izoomobject/get_showbackground/)() | Ottiene il valore che specifica se lo Zoom utilizzerà lo sfondo della diapositiva di destinazione. Leggi **bool**. Valore predefinito: true |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_TargetSlide](./get_targetslide/)() | Ottiene l'oggetto diapositiva a cui il [Slide](../slide/) Zoom si collega. Leggi [ISlide](../islide/). |
...
| virtual **float** [get_TransitionDuration](../izoomobject/get_transitionduration/)() | Ottiene la durata della transizione tra Zoom e diapositiva. Leggi **float**. Valore predefinito: 1.0f |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../ishape/getimage/)() | Restituisce la miniatura della forma. [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) shape thumbnail bounds type è usato per impostazione predefinita. |
...
| virtual void [set_TargetSlide](./set_targetslide/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | Imposta l'oggetto diapositiva a cui il [Slide](../slide/) Zoom si collega. Scrivi [ISlide](../islide/). |
