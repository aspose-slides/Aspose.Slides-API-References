...
| Metodo | Descrizione |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>) | Aggiunge la firma alla fine della collezione. |
...
| virtual void [Clear](./clear/)() | Rimuove tutte le firme dalla collezione. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce la firma per indice. |
...
| void [Lock](../../system/object/lock/)() | Implementa il lock() di C# per il blocco. Chiama direttamente o usa l'oggetto sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove la firma all'indice specificato. |
