...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Aggiunge un [Paragraph](../paragraph/) alla fine della collezione. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | Aggiunge il contenuto di [ParagraphCollection](../paragraphcollection/) alla fine della collezione. |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) | Aggiunge testo da una stringa HTML specificata alla collezione. |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) | Aggiunge testo da una stringa HTML specificata alla collezione. |
...
| virtual [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) | Converte i paragrafi specificati in HTML e lo restituisce come oggetto String. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo per uso interno. |
| virtual **int32_t** [get_Count](./get_count/)() | Restituisce il numero di elementi realmente contenuti nella collezione. Solo lettura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) | Restituisce l'elemento all'indice specificato. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Inserisce un [Paragraph](../paragraph/) nella collezione all'indice specificato. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | Inserisce il contenuto di [ParagraphCollection](../paragraphcollection/) nella collezione all'indice specificato. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, ma inizializza il nuovo oggetto e consente la costruzione di copie di sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, ma inizializza il nuovo oggetto e consente la costruzione di copie di sottoclassi. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Rimuove la prima occorrenza di un paragrafo specifico. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Rimuove l'elemento all'indice specificato della collezione. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminuisce il contatore di riferimenti condivisi del valore specificato. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'n-esimo argomento template a un puntatore debole (piuttosto che condiviso). Consente di passare i puntatori nei container alla modalità debole. |
