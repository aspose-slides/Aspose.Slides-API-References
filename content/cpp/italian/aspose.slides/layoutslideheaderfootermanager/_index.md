...
description: Rappresenta il manager che contiene il comportamento dei segnaposto del piè di pagina della diapositiva layout, dei segnaposto data-ora, dei segnaposto numero di pagina e di tutti i segnaposto dei figli. I segnaposti dei figli sono i segnaposti contenuti nelle diapositive dipendenti. Le diapositive dipendenti usano e dipendono dalla diapositiva layout.
type: docs
weight: 4317
...
Rappresenta il manager che contiene il comportamento del segnaposto piè di pagina della diapositiva layout, dei segnaposto data-ora, dei segnaposto numero di pagina e di tutti i segnaposto dei figli. I segnaposti dei figli sono i segnaposti contenuti nelle diapositive dipendenti. Le diapositive dipendenti usano e dipendono dalla diapositiva layout.
...
| void [SetDateTimeAndChildDateTimesText](./setdatetimeandchilddatetimestext/)([System::String](../../system/string/)) override | Imposta il testo nel segnaposto data-ora della diapositiva layout e in tutti i segnaposto data-ora dei figli. I segnaposti figlio sono i segnaposti contenuti nelle diapositive dipendenti. Le diapositive dipendenti usano e dipendono dalla diapositiva layout. |
| void [SetDateTimeAndChildDateTimesVisibility](./setdatetimeandchilddatetimesvisibility/)(**bool**) override | Cambia la visibilità del segnaposto data-ora della diapositiva layout e di tutti i segnaposto data-ora dei figli. I segnaposti figlio sono i segnaposti contenuti nelle diapositive dipendenti. Le diapositive dipendenti usano e dipendono dalla diapositiva layout. |
...
| void [SetFooterAndChildFootersText](./setfooterandchildfooterstext/)([System::String](../../system/string/)) override | Imposta il testo nel segnaposto piè di pagina della diapositiva layout e in tutti i segnaposto piè di pagina dei figli. I segnaposti figlio sono i segnaposti contenuti nelle diapositive dipendenti. Le diapositive dipendenti usano e dipendono dalla diapositiva layout. |
| void [SetFooterAndChildFootersVisibility](./setfooterandchildfootersvisibility/)(**bool**) override | Cambia la visibilità del segnaposto piè di pagina della diapositiva layout e di tutti i segnaposto piè di pagina dei figli. I segnaposti figlio sono i segnaposti contenuti nelle diapositive dipendenti. Le diapositive dipendenti usano e dipendono dalla diapositiva master. |
...
| void [SetSlideNumberAndChildSlideNumbersVisibility](./setslidenumberandchildslidenumbersvisibility/)(**bool**) override | Cambia la visibilità del segnaposto numero di pagina della diapositiva layout e di tutti i segnaposto numero di pagina dei figli. I segnaposti figlio sono i segnaposti contenuti nelle diapositive dipendenti. Le diapositive dipendenti usano e dipendono dalla diapositiva layout. |
