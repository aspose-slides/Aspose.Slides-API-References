...
| Metodo | Descrizione |
| --- | --- |
| **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) override | Verifica se una password è corretta per una presentazione protetta con password di apertura. |
| **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) override | Verifica se una password di modifica è corretta per una presentazione protetta in scrittura. |
...
| **bool** [get_IsEncrypted](./get_isencrypted/)() override | Restituisce True se la presentazione collegata è crittografata, altrimenti False. Sola lettura **bool**. |
| **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() override | Restituisce un valore che indica se una presentazione collegata è protetta da una password di apertura. |
| [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() override | Restituisce un valore che indica se una presentazione collegata è protetta in scrittura. |
| [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() override | Restituisce il formato della presentazione collegata. Sola lettura [Slides::LoadFormat](../loadformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() override | Restituisce le proprietà del documento della presentazione collegata. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore debole (anziché condiviso). Consente di modificare i puntatori nei contenitori in modalità debole. |
...
| void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) override | Aggiorna le proprietà della presentazione collegata. |
...
| void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Scrive la presentazione collegata su stream. |
| void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) override | Scrive la presentazione collegata su file. |
