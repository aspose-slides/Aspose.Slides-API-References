...
description: Rappresenta un'eccezione lanciata quando viene rilevato un errore di modifica della presentazione.
type: docs
weight: 664
url: /it/aspose.slides/details_ppteditexception/
---
## Details_PptEditException classe


Rappresenta un'eccezione lanciata quando viene rilevato un errore di modifica della presentazione.
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Restituisce la stringa contenente il trace dello stack. |
