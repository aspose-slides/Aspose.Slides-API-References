...
description: Rappresenta il manager che mantiene il comportamento del piè di pagina della diapositiva, del segnaposto data/ora e del segnaposto numero di pagina.
type: docs
weight: 3797
url: /it/aspose.slides/islideheaderfootermanager/
---
## classe ISlideHeaderFooterManager

Rappresenta il manager che gestisce il comportamento del piè di pagina della diapositiva, del segnaposto data/ora e del segnaposto numero di pagina.
...
| virtual void [SetDateTimeText](../ibaseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) | Imposta il testo del segnaposto data/ora della diapositiva. |
...
| virtual void [SetFooterText](../ibaseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) | Imposta il testo del segnaposto piè di pagina della diapositiva. |
