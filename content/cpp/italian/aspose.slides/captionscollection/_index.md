...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Aggiunge i sottotitoli chiusi WebVTT alla fine della raccolta. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Aggiunge i sottotitoli chiusi WebVTT alla fine della raccolta da un flusso. |
| [iterator](./iterator/) [begin](./begin/)() | Ottiene l'iteratore che punta al primo elemento (se presente) della raccolta. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza const della raccolta. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Ottiene l'iteratore che punta al primo elemento const (se presente) della raccolta. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento const (se presente) della raccolta. |
| void [Clear](./clear/)() override | Rimuove tutti i sottotitoli chiusi dalla raccolta. |
| [iterator](./iterator/) [end](./end/)() | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) della raccolta. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza const della raccolta. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore che itera attraverso la raccolta. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [idx_get](./idx_get/)(**int32_t**) override | Restituisce i sottotitoli chiusi all'indice specificato. **[ICaptions](../icaptions/)** di sola lettura. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, ma inizializza un nuovo oggetto e abilita la copia di sottoclassi. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>) override | Rimuove i sottotitoli chiusi specificati dalla raccolta. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Rimuove i sottotitoli chiusi all'indice specificato. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decrementa il contatore di riferimento condiviso del valore specificato. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento di modello a un puntatore debole (anziché condiviso). Consente di convertire i puntatori nei contenitori in modalità debole. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ottiene l'iteratore che punta al primo elemento (se presente) dell'istanza const della raccolta. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ottiene l'iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza const della raccolta. |
