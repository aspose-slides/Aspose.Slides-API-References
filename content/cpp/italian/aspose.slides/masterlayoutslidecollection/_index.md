...
description: Rappresenta una collezione di tutte le diapositive layout della diapositiva master definita. Estende la classe LayoutSlideCollection con metodi per aggiungere/inserire/rimuovere/clonare/riordinare le diapositive layout nel contesto delle collezioni individuali delle diapositive layout del master.
type: docs
weight: 4434
...
Rappresenta una collezione di tutte le diapositive layout di una diapositiva master definita. Estende la classe [LayoutSlideCollection](../layoutslidecollection/) con metodi per aggiungere/inserire/rimuovere/clonare/riordinare le diapositive layout nel contesto delle collezioni individuali delle diapositive layout del master.
...
| Metodo | Descrizione |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | Aggiunge una nuova diapositiva layout alla fine della collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Aggiunge una copia di una diapositiva layout specificata alla fine della collezione. |
...
| [const_iterator](../layoutslidecollection/const_iterator/) [begin](../layoutslidecollection/begin/)() const | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza della collezione qualificata come const. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cbegin](../layoutslidecollection/cbegin/)() const | Restituisce un iteratore che punta al primo elemento qualificato come const (se presente) della collezione. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cend](../layoutslidecollection/cend/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento qualificato come const (se presente) della collezione. |
| void [CopyTo](../layoutslidecollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>, **int32_t**) override | Copia tutti gli elementi della collezione nell'array specificato. |
...
| [const_iterator](../layoutslidecollection/const_iterator/) [end](../layoutslidecollection/end/)() const | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della collezione qualificata come const. |
...
| **int32_t** [get_Count](../layoutslidecollection/get_count/)() override | Restituisce il numero di diapositive layout in una collezione. Solo lettura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../layoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) override | Restituisce la prima diapositiva layout del tipo specificato. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../layoutslidecollection/idx_get/)(**int32_t**) override | Restituisce la diapositiva layout per indice. Solo lettura [LayoutSlide](../layoutslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Insert](./insert/)(**int32_t**, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | Inserisce una nuova diapositiva layout nella posizione specificata della collezione. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Inserisce una copia di una diapositiva layout specificata nella posizione specificata della collezione. |
...
| void [RemoveUnused](../layoutslidecollection/removeunused/)() override | Rimuove le diapositive layout inutilizzate (diapositive layout il cui HasDependingSlides è false). |
| void [Reorder](./reorder/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Sposta la diapositiva layout dalla collezione alla posizione specificata. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta il n-esimo argomento template a un puntatore weak (piuttosto che shared). Consente di cambiare i puntatori nei contenitori a modalità weak. |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginConstIterator](../layoutslidecollection/virtualizebeginconstiterator/)() const override | Restituisce un iteratore che punta al primo elemento (se presente) dell'istanza della collezione qualificata come const. |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndConstIterator](../layoutslidecollection/virtualizeendconstiterator/)() const override | Restituisce un iteratore che punta subito dopo l'ultimo elemento (se presente) dell'istanza della collezione qualificata come const. |
