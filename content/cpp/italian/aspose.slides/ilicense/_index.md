...
| virtual **bool** [IsLicensed](./islicensed/)() | Verifica se la licenza è applicata al componente |
...
| virtual void [ResetLicense](./resetlicense/)() | Reimposta la licenza |
| virtual void [SetLicense](./setlicense/)([System::String](../../system/string/)) | Concede licenza al componente. |
| virtual void [SetLicense](./setlicense/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Concede licenza al componente. |
...
In questo esempio, si tenterà di trovare un file di licenza denominato MyLicense.lic nella cartella che contiene il componente, nella cartella che contiene l'assembly chiamante, nella cartella dell'assembly di ingresso e poi nelle risorse incorporate dell'assembly chiamante. 
```cpp
