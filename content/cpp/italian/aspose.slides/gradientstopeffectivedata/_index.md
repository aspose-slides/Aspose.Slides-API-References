...
description: Oggetto immutabile che rappresenta uno stop di gradiente.
type: docs
weight: 1158
...
Oggetto immutabile che rappresenta un gradiente stop.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se il [GradientStopEffectiveData](./) specificato è uguale al [GradientStopEffectiveData](./) corrente. |
...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Restituisce il colore di un gradiente stop. Solo lettura [System::Drawing::Color](../../system.drawing/color/). |
| **float** [get_Position](./get_position/)() override | Restituisce la posizione (0..1) di un gradiente stop. Solo lettura **float**. |
