...
| virtual **float** [get_CenterX](./get_centerx/)() | Restituisce la coordinata X del centro di un frame. Solo lettura **float**. |
| virtual **float** [get_CenterY](./get_centery/)() | Restituisce la coordinata Y del centro di un frame. Solo lettura **float**. |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | Determina se un frame è capovolto orizzontalmente. Solo lettura [NullableBool](../nullablebool/). |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | Determina se un frame è capovolto verticalmente. Solo lettura [NullableBool](../nullablebool/). |
| virtual **float** [get_Height](./get_height/)() | Restituisce l'altezza di un frame. Solo lettura **float**. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | Restituisce le coordinate di un frame. Solo lettura [System::Drawing::RectangleF](../../system.drawing/rectanglef/). |
| virtual **float** [get_Rotation](./get_rotation/)() | Restituisce il numero di gradi di rotazione di un frame attorno all'asse z. Un valore positivo indica rotazione in senso orario; un valore negativo indica rotazione in senso antiorario. Solo lettura **float**. |
| virtual **float** [get_Width](./get_width/)() | Restituisce la larghezza di un frame. Solo lettura **float**. |
| virtual **float** [get_X](./get_x/)() | Restituisce la coordinata X dell'angolo in alto a sinistra di un frame. Solo lettura **float**. |
| virtual **float** [get_Y](./get_y/)() | Restituisce la coordinata Y dell'angolo in alto a sinistra di un frame. Solo lettura **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e abilita la copia dei sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, si limita a inizializzare un nuovo oggetto e abilita la copia dei sottoclassi. |
