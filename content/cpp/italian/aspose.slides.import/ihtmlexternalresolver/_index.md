...
description: Interfaccia di callback utilizzata dalla routine di importazione HTML per ottenere oggetti referenziati come immagini.
type: docs
weight: 53
url: /it/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver classe


Interfaccia di callback utilizzata dalla routine di importazione HTML per ottenere oggetti referenziati come immagini.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | Mappa un URI a un oggetto contenente la risorsa reale. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. In realtà non copia nulla, si limita ad inizializzare un nuovo oggetto e a consentire la costruzione di copie nelle sottoclassi. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. In realtà non copia nulla, si limita ad inizializzare un nuovo oggetto e a consentire la costruzione di copie nelle sottoclassi. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Risolve l'URI assoluto a partire dagli URI base e relativi. |
...
Deprecata
:   Obsoleta. Usa [IExternalResourceResolver](../iexternalresourceresolver/) invece. Verrà rimossa nella versione 17.12.

## Vedi anche

* Classe [IExternalResourceResolver](../iexternalresourceresolver/)
