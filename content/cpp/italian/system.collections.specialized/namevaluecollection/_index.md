...
description: Raccolta di chiavi String associate e valori String che possono essere accessi sia tramite la chiave sia tramite l'indice.
type: docs
weight: 14
url: /it/system.collections.specialized/namevaluecollection/
---
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | Sovrascrive il metodo [ICollection](../../system.collections/icollection/) - non implementato. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Copia le voci nella [NameValueCollection](./) specificata nella corrente. |
| virtual void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Aggiunge una voce con il nome e il valore specificati. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Restituisce un iteratore che punta al primo elemento (se presente) della raccolta. Questo iteratore non può essere utilizzato per modificare un oggetto referenziato perché [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) restituisce un oggetto copia di T. |
...
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) const override | Verifica se l'elemento è presente nella raccolta. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>, **int32_t**) override | Copia gli elementi della raccolta negli elementi esistenti dell'array. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia tutti gli elementi della raccolta negli elementi esistenti dell'array. |
...
| virtual [String](../../system/string/) [Get](./get/)(const [String](../../system/string/)\&) | Restituisce i valori associati alla chiave specificata. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [get_AllKeys](./get_allkeys/)() | Restituisce tutte le chiavi. |
| int [get_Count](./get_count/)() const override | Restituisce il numero di coppie chiave/valore. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[String](../../system/string/)\>\> [get_Keys](./get_keys/)() | Restituisce tutte le chiavi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Restituisce un enumeratore per iterare attraverso la raccolta. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [GetValues](./getvalues/)(const [String](../../system/string/)\&) | Restituisce i valori associati alla chiave specificata. |
| **bool** [HasKeys](./haskeys/)() | Restituisce un valore che indica se [NameValueCollection](./) contiene chiavi non nulle. |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Restituisce il valore all'indice specificato. |
| void [idx_set](./idx_set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Imposta il valore di una voce. |
...
|  [NameValueCollection](./namevaluecollection/)() | Inizializza una nuova istanza della classe [NameValueCollection](./) vuota. |
|  [NameValueCollection](./namevaluecollection/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Copia le voci dal [NameValueCollection](./) specificato a un nuovo [NameValueCollection](./). |
|  [Object](../../system/object/object/)() | Crea l'oggetto. Inizializza tutte le strutture dati interne. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Costruttore di copia. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la copia costruttiva delle subclassi. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operatore di assegnazione. Non copia nulla, in realtà, inizializza solo il nuovo oggetto e consente la copia costruttiva delle subclassi. |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | Rimuove l'elemento specifico. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decrementa il contatore di riferimento condiviso del valore specificato. |
| virtual void [Set](./set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Imposta il valore di una voce. |
...
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Restituisce l'implementazione dell'iteratore const begin per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Restituisce l'implementazione dell'iteratore begin per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Restituisce l'implementazione dell'iteratore const end per il contenitore corrente. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Restituisce l'implementazione dell'iteratore end per il contenitore corrente. |
