...
description: Implementazione semplice di IComparable<>
type: docs
weight: 1
url: /it/system.boxedvaluedetail/comparable/
---
## Comparable classe

Implementazione semplice di IComparable<>
...
| Metodo | Descrizione |
| --- | --- |
| int [CompareTo](./compareto/)(T) override | Confronta l'oggetto corrente con l'oggetto specificato. |
