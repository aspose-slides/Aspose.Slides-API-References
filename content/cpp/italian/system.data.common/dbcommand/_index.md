...
description: "Comando del database. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o violazioni di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 1
url: /it/system.data.common/dbcommand/
---
## DbCommand classe

Comando del database. Gli oggetti di questa classe dovrebbero essere allocati solo utilizzando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò proverrà errori di runtime e/o violazioni di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarlo alle funzioni come argomento.
...
| virtual int [ExecuteNonQuery](./executenonquery/)() | Esegue un comando senza query. |
| virtual [SharedPtr](../../system/sharedptr/)\<[DbDataReader](../dbdatareader/)\> [ExecuteReader](./executereader/)() | Esegue un comando di query. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo per scopi interni. |
| virtual [String](../../system/string/) [get_CommandText](./get_commandtext/)() const | Informazioni RTTI. |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Data::Common::DbConnection](../dbconnection/)\> [get_Connection](./get_connection/)() const | Ottiene la connessione al database associata al comando. |
...
| virtual void [set_CommandText](./set_commandtext/)([String](../../system/string/)) const | Imposta il testo del comando DB. |
| virtual void [set_Connection](./set_connection/)([SharedPtr](../../system/sharedptr/)\<[System::Data::Common::DbConnection](../dbconnection/)\>) | Ottiene la connessione al database associata al comando. |
