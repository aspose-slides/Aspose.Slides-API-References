...
description: "API per costruire la stringa di connessione di campi denominati. Gli oggetti di questa classe devono essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò causerebbe errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare questo puntatore per passarlo alle funzioni come argomento."
type: docs
weight: 27
url: /it/system.data.common/dbconnectionstringbuilder/
---
## DbConnectionStringBuilder classe


API per costruire la stringa di connessione di campi denominati. Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarla alle funzioni come argomento.
...
| virtual [String](../../system/string/) [get_ConnectionString](./get_connectionstring/)() const | Restituisce l'intera stringa di connessione. |
...
| virtual [Object::ptr](../../system/object/ptr/) [idx_get](./idx_get/)([String](../../system/string/)) | Informazioni RTTI. |
| virtual [Object::ptr](../../system/object/ptr/) [idx_set](./idx_set/)([String](../../system/string/), [Object::ptr](../../system/object/ptr/)) | Imposta il valore denominato. |
...
| virtual void [set_ConnectionString](./set_connectionstring/)([String](../../system/string/)) | Imposta l'intera stringa di connessione. |
