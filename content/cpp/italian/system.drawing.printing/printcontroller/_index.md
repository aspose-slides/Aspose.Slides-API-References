...
description: "Gestisce come viene stampato un documento durante la stampa da un'applicazione Windows Forms. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai istanze di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o violazioni di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e usare tale puntatore per passarla alle funzioni come argomento."
type: docs
weight: 40
url: /it/system.drawing.printing/printcontroller/
---
## PrintController classe

Gestisce come viene stampato un documento quando si stampa da un'applicazione [Windows](../../system.windows/) Forms. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai istanze di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o violazioni di asserzione. Racchiudi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa tale puntatore per passarla alle funzioni come argomento.
