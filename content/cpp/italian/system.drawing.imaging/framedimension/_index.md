...
description: "Fornisce le proprietà che ottengono le dimensioni del frame di un'immagine. Gli oggetti di questa classe devono essere allocati solo utilizzando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò può provocare errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare tale puntatore per passarla alle funzioni come argomento."
type: docs
weight: 92
url: /it/system.drawing.imaging/framedimension/
---
## classe FrameDimension

Fornisce le proprietà che ottengono le dimensioni del frame di un'immagine. Gli oggetti di questa classe devono essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgere sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usare questo puntatore per passarla alle funzioni come argomento.
...
| Metodo | Descrizione |
| --- | --- |
| **bool** [Equals](./equals/)([FrameDimensionPtr](../framedimensionptr/)) | Determina se l'oggetto [FrameDimension](./) specificato è equivalente all'oggetto corrente. |
...
|  [FrameDimension](./framedimension/)(const [System::Guid](../../system/guid/)\&) | Costruisce un nuovo oggetto [FrameDimension](./) e lo inizializza con il GUID specificato. |
| [System::Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Restituisce il GUID associato all'oggetto corrente. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Page](./get_page/)() | Restituisce la dimensione della pagina. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Resolution](./get_resolution/)() | Restituisce la dimensione della risoluzione. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Time](./get_time/)() | Restituisce la dimensione del tempo. |
...
| void [Lock](../../system/object/lock/)() | Implementa il blocco della dichiarazione lock() di C#. Chiamare direttamente o utilizzare l'oggetto sentinella [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Imposta l'argomento n-esimo del template come puntatore debole (anziché condiviso). Consente di passare i puntatori nei contenitori alla modalità debole. |
