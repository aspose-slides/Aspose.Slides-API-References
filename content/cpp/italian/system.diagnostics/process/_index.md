...
description: "Incapsula le informazioni e la manipolazione del processo. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore System::SmartPtr e usa questo puntatore per passarla alle funzioni come argomento."
type: docs
weight: 27
url: /it/system.diagnostics/process/
---
## Process classe

Incapsula le informazioni e la manipolazione del processo. Gli oggetti di questa classe dovrebbero essere allocati solo usando la funzione [System::MakeObject()](../../system/makeobject/). Non creare mai un'istanza di questo tipo nello stack o usando l'operatore new, poiché ciò provocherà errori di runtime e/o fault di asserzione. Avvolgi sempre questa classe in un puntatore [System::SmartPtr](../../system/smartptr/) e usa questo puntatore per passarla alle funzioni come argomento.
...
| **bool** [get_EnableRaisingEvents](./get_enableraisingevents/)() const | Restituisce se l'evento Exited dovrebbe essere sollevato quando il processo termina. |
| int [get_ExitCode](./get_exitcode/)() const | Restituisce il codice di uscita del processo. |
| **int64_t** [get_PrivateMemorySize64](./get_privatememorysize64/)() const | Restituisce la dimensione dell'insieme di memoria privata del processo. |
| [String](../../system/string/) [get_ProcessName](./get_processname/)() const | Restituisce il nome del processo. |
| [SharedPtr](../../system/sharedptr/)\<[System::IO::StreamReader](../../system.io/streamreader/)\> [get_StandardError](./get_standarderror/)() const | Fornisce un lettore per leggere l'output di errore del processo. Non implementato. |
| [SharedPtr](../../system/sharedptr/)\<[System::IO::StreamReader](../../system.io/streamreader/)\> [get_StandardOutput](./get_standardoutput/)() const | Fornisce un lettore per leggere l'output standard del processo. Non implementato. |
| [SharedPtr](../../system/sharedptr/)\<[ProcessStartInfo](../processstartinfo/)\> [get_StartInfo](./get_startinfo/)() const | Restituisce le informazioni di avvio del processo. |
| **int64_t** [get_WorkingSet64](./get_workingset64/)() const | Restituisce la dimensione del working set di memoria del processo. |
...
| static [SharedPtr](../../system/sharedptr/)\<[Process](./)\> [GetCurrentProcess](./getcurrentprocess/)() | Restituisce le informazioni sul processo corrente. Solo [Windows](../../system.windows/). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo del metodo C# [Object.GetHashCode()](../../system/object/gethashcode/). Consente l'hashing di oggetti personalizzati. |
| [String](../../system/string/) [GetOutputText](./getoutputtext/)() const | Restituisce il testo di output del processo. |
...
| void [set_EnableRaisingEvents](./set_enableraisingevents/)(**bool**) | Imposta se l'evento Exited dovrebbe essere sollevato quando il processo termina. |
...
| **bool** [Start](./start/)() | Avvia il processo con parametri predefiniti. |
| static [SharedPtr](../../system/sharedptr/)\<[Process](./)\> [Start](./start/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Avvia il processo con percorso e argomenti specificati. |
| static [SharedPtr](../../system/sharedptr/)\<[Process](./)\> [Start](./start/)(const [SharedPtr](../../system/sharedptr/)\<[ProcessStartInfo](../processstartinfo/)\>\&) | Avvia il processo con percorso e argomenti specificati. |
...
| **bool** [WaitForExit](./waitforexit/)(int) | Attende che il processo termini. Non implementato. |
| void [WaitForExit](./waitforexit/)() | Attende che il processo termini, non ritorna finché non è finito. |
