...
description: "Interfaccia per reagire a informazioni di debug e trace. Gli oggetti di questa classe devono essere allocati solo tramite la funzione System::MakeObject(). Non creare mai un'istanza di questo tipo sullo stack o usando l'operatore new, poiché ciò può provocare errori di runtime e/o fallimenti di asserzione. Avvolgere sempre questa classe in un puntatore System::SmartPtr e utilizzare tale puntatore per passarla alle funzioni come argomento."
type: docs
weight: 92
url: /it/system.diagnostics/tracelistener/
---
...
| virtual void [Fail](./fail/)([System::String](../../system/string/)) | Scrive un messaggio di errore nel debugger. |
| virtual void [Fail](./fail/)([System::String](../../system/string/), [System::String](../../system/string/)) | Scrive un messaggio di errore nel debugger. |
...
| virtual void [Write](./write/)([System::String](../../system/string/)) | Informazioni RTTI. |
| virtual void [WriteLine](./writeline/)([System::String](../../system/string/)) | Scrive una riga nel debugger. |
