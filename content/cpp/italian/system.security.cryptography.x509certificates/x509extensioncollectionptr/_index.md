...
description: Puntatore alla raccolta di estensioni X509. Questo tipo è un puntatore per gestire l'eliminazione di altri oggetti. Dovrebbe essere allocato sullo stack e passato alle funzioni per valore o per riferimento costante.
type: docs
weight: 170
url: /it/system.security.cryptography.x509certificates/x509extensioncollectionptr/
---
## X509ExtensionCollectionPtr classe

Puntatore alla raccolta di estensioni X509. Questo tipo è un puntatore per gestire l'eliminazione di altri oggetti. Dovrebbe essere allocato sullo stack e passato alle funzioni per valore o per riferimento costante.
...
| Metodo | Descrizione |
| --- | --- |
| auto [begin](../../system/smartptr/begin/)() | Accessor per il metodo [begin()](../../system/smartptr/begin/) di una raccolta sottostante. Compila solo se SmartPtr_ è un tipo specializzazione con il metodo [begin()](../../system/smartptr/begin/). |
| auto [begin](../../system/smartptr/begin/)() const | Accessor per il metodo [begin()](../../system/smartptr/begin/) di una raccolta sottostante. Compila solo se SmartPtr_ è un tipo specializzazione con il metodo [begin()](../../system/smartptr/begin/). |
| std::enable_if_t\<std::is_same\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | Effettua il cast del puntatore al proprio tipo. |
...
| std::enable_if_t<\!Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | Effettua il cast del puntatore al tipo derivato usando dynamic_cast. |
| auto [cbegin](../../system/smartptr/cbegin/)() const | Accessor per il metodo [cbegin()](../../system/smartptr/cbegin/) di una raccolta sottostante. Compila solo se SmartPtr_ è un tipo specializzazione con il metodo [cbegin()](../../system/smartptr/cbegin/). |
| auto [cend](../../system/smartptr/cend/)() const | Accessor per il metodo [cend()](../../system/smartptr/cend/) di una raccolta sottostante. Compila solo se SmartPtr_ è un tipo specializzazione con il metodo [cend()](../../system/smartptr/cend/). |
...
| auto [end](../../system/smartptr/end/)() | Accessor per il metodo [end()](../../system/smartptr/end/) di una raccolta sottostante. Compila solo se SmartPtr_ è un tipo specializzazione con il metodo [end()](../../system/smartptr/end/). |
| auto [end](../../system/smartptr/end/)() const | Accessor per il metodo [end()](../../system/smartptr/end/) di una raccolta sottostante. Compila solo se SmartPtr_ è un tipo specializzazione con il metodo [end()](../../system/smartptr/end/). |
...
| int [get_shared_count](../../system/smartptr/get_shared_count/)() const | Restituisce il numero di puntatori condivisi esistenti sull'oggetto di riferimento, incluso quello corrente. Verifica che il puntatore corrente sia in modalità condivisa. |
...
| [Pointee_](../../system/smartptr/pointee_/) * [operator->](../../system/smartptr/operator_minus_greater/)() const | Permette di accedere ai membri dell'oggetto referenziato. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(std::nullptr_t, [SmartPtrMode](../../system/smartptrmode/)) | Crea un oggetto [SmartPtr](../../system/smartptr/) null-pointer della modalità richiesta. |
|  [SmartPtr](../../system/smartptr/smartptr/)([Pointee_](../../system/smartptr/pointee_/) *, [SmartPtrMode](../../system/smartptrmode/)) | Crea [SmartPtr](../../system/smartptr/) che punta all'oggetto specificato, o converte un puntatore grezzo in [SmartPtr](../../system/smartptr/). |
...
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | Costruisce per movimento l'oggetto [SmartPtr](../../system/smartptr/). In pratica, scambia due puntatori, se entrambi sono della stessa modalità. x potrebbe diventare inutilizzabile dopo la chiamata. |
...
|  [X509ExtensionCollectionPtr](./x509extensioncollectionptr/)() | Costruttore di puntatore null. |
|  [X509ExtensionCollectionPtr](./x509extensioncollectionptr/)(const [SharedPtr](../../system/sharedptr/)\<[X509ExtensionCollection](../x509extensioncollection/)\>\&) | Costruttore. |
|  [~SmartPtr](../../system/smartptr/~smartptr/)() | Distrugge l'oggetto [SmartPtr](../../system/smartptr/). Se necessario, diminuisce il contatore di riferimenti dell'oggetto puntato e lo elimina. |
