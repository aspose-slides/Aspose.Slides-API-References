...
description: "HttpClient 클래스에서 사용하는 기본 메시지 핸들러를 나타냅니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여만 할당해야 합니다. 스택에 인스턴스를 생성하거나 operator new를 사용하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 래핑하고 해당 포인터를 함수 인수로 전달하십시오."
type: docs
weight: 40
url: /ko/system.net.http/httpclienthandler/
---
## HttpClientHandler 클래스

기본 메시지 핸들러를 나타냅니다. [HttpClient](../httpclient/) 클래스에서 사용됩니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여만 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하여 인스턴스를 만들면 런타임 오류 또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고 해당 포인터를 함수 인수로 전달하십시오.
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Net::CookieContainer](../../system.net/cookiecontainer/)\> [get_CookieContainer](./get_cookiecontainer/)() | 서버 쿠키를 저장하는 데 사용되는 쿠키 컨테이너를 가져옵니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../../system.net/icredentials/)\> [get_Credentials](./get_credentials/)() | 인증 정보를 가져옵니다. |
...
|  [HttpClientHandler](./httpclienthandler/)() | 새 인스턴스를 생성합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[HttpResponseMessage](../httpresponsemessage/)\> [Send](./send/)([System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\>) override | 지정된 요청을 전송합니다. |
| void [set_CookieContainer](./set_cookiecontainer/)([System::SharedPtr](../../system/sharedptr/)\<[System::Net::CookieContainer](../../system.net/cookiecontainer/)\>) | 서버 쿠키를 저장하는 데 사용되는 쿠키 컨테이너를 설정합니다. |
| void [set_Credentials](./set_credentials/)([System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../../system.net/icredentials/)\>) | 인증 정보를 설정합니다. |
| void [set_Proxy](./set_proxy/)([System::SharedPtr](../../system/sharedptr/)\<[IWebProxy](../../system.net/iwebproxy/)\>) | 프록시 정보를 설정합니다. |
| void [set_Timeout](./set_timeout/)(**int32_t**) | 요청이 시간 초과되는 밀리초 단위 시간을 가져옵니다. |
| void [set_UseCookies](./set_usecookies/)(**bool**) | 현재 인스턴스가 서버 쿠키를 저장하기 위해 쿠키 컨테이너를 사용하는지, 그리고 요청 전송 시 서버 쿠키를 사용하는지를 나타내는 값을 설정합니다. |
| void [set_UseProxy](./set_useproxy/)(**bool**) | 현재 인스턴스가 요청 전송에 프록시를 사용하는지를 나타내는 값을 설정합니다. |
