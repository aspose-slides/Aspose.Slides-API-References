...
description: "기본 예외 클래스는 HttpClient와 HttpMessageHandler 클래스에 의해 발생됩니다. 이 클래스를 직접 인스턴스화하지 마십시오. 대신 HttpRequestException 클래스를 사용하십시오. HttpRequestException 클래스 인스턴스를 System::SmartPtr에 감싸지 마십시오."
type: docs
weight: 14
url: /ko/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException 클래스


기본 예외 클래스는 [HttpClient](../httpclient/) 및 [HttpMessageHandler](../httpmessagehandler/) 클래스에 의해 발생됩니다. 이 클래스를 수동으로 인스턴스화하지 마십시오. 대신 HttpRequestException 클래스를 사용하십시오. HttpRequestException 클래스 인스턴스를 [System::SmartPtr](../../system/smartptr/)에 감싸지 마십시오.
...
| 메서드 | 설명 |
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | 새 인스턴스를 생성합니다. |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | 새 인스턴스를 생성합니다. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | 새 인스턴스를 생성합니다. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | 새 인스턴스를 생성합니다. |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | 예외 래퍼에 의해 감싸진 예외 인스턴스를 throw 합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일의 부동소수점 비교를 에뮬레이트합니다. 두 NaN을 동일하게 간주합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음). |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일의 부동소수점 비교를 에뮬레이트합니다. 두 NaN을 동일하게 간주합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음). |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | 사용자 정의 예외 데이터를 포함하는 딕셔너리를 반환합니다. |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 현재 객체가 나타내는 예외와 연관된 HRESULT 코드를 나타내는 32비트 정수 값을 반환합니다. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 특정 예외에 할당되는 코딩된 숫자 값인 HRESULT를 설정합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 공유 포인터가 아닌 약한 포인터로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있게 합니다. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | 약한 참조 카운트를 증가시킵니다. 직접 호출해서는 안 되고, 스마트 포인터나 ThisProtector를 사용하십시오. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | 약한 참조 카운트를 감소시킵니다. 직접 호출해서는 안 되며, 스마트 포인터나 ThisProtector를 사용하십시오. |
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) 메서드를 구현합니다. 이 메서드는 [ExceptionWrapper](../../system/exceptionwrapper/) 클래스에 의해 호출됩니다. 이 클래스가 std::exception을 상속받지 않았음에도 파생 클래스는 protected/private 멤버를 사용해 로직을 구현할 수 있습니다. 이 메서드 구현을 [ExceptionWrapper](../../system/exceptionwrapper/)로 이동하면 그 로직이 손상될 수 있습니다. |
