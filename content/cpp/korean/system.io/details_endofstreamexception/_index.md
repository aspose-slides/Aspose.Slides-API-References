...
type: docs
weight: 157
url: /ko/system.io/details_endofstreamexception/
---
## Details_EndOfStreamException 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도(NaN 포함) 같지 않음에도 불구하고, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도(NaN 포함) 같지 않음에도 불구하고, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 현재 객체가 나타내는 예외와 관련된 HRESULT 코드인 32비트 정수 값을 반환합니다. |
...
| virtual  [~Object](../../system/object/~object/)() | 객체를 삭제합니다. 모든 내부 데이터 구조를 해제합니다. |
