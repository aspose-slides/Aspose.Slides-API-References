...
type: docs
weight: 40
url: /ko/system.io/directory/enumeratefiles/
---
## Directory::EnumerateFiles(const String\&, const String\&, SearchOption) 메서드
...
검색 패턴 **searchPattern**에 일치하는 찾은 파일들의 전체 경로를 포함하는 열거 가능한 컬렉션
