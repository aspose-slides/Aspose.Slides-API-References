...
description: "문자열에 정규식을 반복 적용하여 얻은 매치들의 컬렉션입니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 이 타입의 인스턴스를 생성하거나 operator new를 사용하지 마십시오. 이렇게 하면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, 해당 포인터를 함수 인수로 전달하세요."
type: docs
weight: 79
url: /ko/system.text.regularexpressions/matchcollection/
---
## MatchCollection 클래스

정규식을 문자열에 반복 적용하여 얻은 매치들의 컬렉션입니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수만을 사용하여 할당해야 합니다. 스택에 이 타입의 인스턴스를 생성하거나 operator new를 사용하지 마십시오. 이렇게 하면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 함수 인수로 전달하세요.
...
| void [AddInitializer](../../system.collections.generic/list/addinitializer/)(int, const T *) | 리스트에 요소들을 추가합니다; 초기화자를 변환할 때 사용됩니다. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | 컬렉션의 마지막 const 한정 요소(역순의 첫 번째)에 대한 역방향 반복자를 가져옵니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값(NaN 포함)과도 동등하지 않지만, 두 NaN을 동등하게 간주하는 C# 스타일 부동소수점 비교를 모방합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값(NaN 포함)과도 동등하지 않지만, 두 NaN을 동등하게 간주하는 C# 스타일 부동소수점 비교를 모방합니다. |
...
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | 컬렉션의 크기가 고정인지 확인합니다. |
...
| T [idx_get](../../system.collections.generic/list/idx_get/)(int) const override | 특정 위치에 있는 요소를 가져옵니다. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | 지정된 객체를 검색하고 [List](../../system.collections.generic/list/)에서 첫 번째 요소부터 지정된 인덱스까지의 범위 내 마지막 발생의 0 기반 인덱스를 반환합니다. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | 지정된 객체를 검색하고 [List](../../system.collections.generic/list/)에서 지정된 요소 수를 포함하고 지정된 인덱스에서 끝나는 범위 내 마지막 발생의 0 기반 인덱스를 반환합니다. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | 시퀀스에 요소가 하나라도 포함되는지 판단합니다. |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() | 컬렉션의 마지막 요소(역순의 첫 번째)에 대한 역방향 반복자를 가져옵니다. |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | const 한정 컬렉션의 마지막 요소(역순의 첫 번째)에 대한 역방향 반복자를 가져옵니다. |
...
| int [RemoveAll](../../system.collections.generic/list/removeall/)([Predicate](../../system/predicate/)\<T\>) | 특정 조건을 만족하는 모든 요소를 제거합니다. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 공유가 아니라 약한 포인터로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
...
| void [Sort](../../system.collections.generic/list/sort/)() | 기본 비교자를 사용하여 리스트의 요소들을 정렬합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문 선언 해제를 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
