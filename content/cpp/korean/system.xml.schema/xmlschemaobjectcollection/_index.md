...
description: XmlSchemaObjects의 컬렉션입니다.
type: docs
weight: 690
url: /ko/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection 클래스

XmlSchemaObjects의 컬렉션입니다.
...
| 메서드 | 설명 |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | [XmlSchemaObjectCollection](./)에 [XmlSchemaObject](../xmlschemaobject/)를 추가합니다. |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | 컬렉션 인스턴스의 모든 객체를 제거합니다. 이 메서드는 재정의할 수 없습니다. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | 지정된 [XmlSchemaObject](../xmlschemaobject/)가 [XmlSchemaObjectCollection](./)에 있는지 여부를 나타냅니다. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | 컬렉션의 모든 XmlSchemaObjects를 지정된 인덱스부터 주어진 배열에 복사합니다. |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | 컬렉션이 포함할 수 있는 요소 수를 반환합니다. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | 컬렉션 인스턴스에 포함된 요소 수를 반환합니다. 이 메서드는 재정의할 수 없습니다. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연관된 참조 카운터 데이터 구조를 가져옵니다. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | [XmlSchemaObjectCollection](./)에 포함된 XmlSchemaObjects를 반복하는 열거자를 반환합니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 객체의 실제 타입을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출과 유사합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | 지정된 인덱스의 [XmlSchemaObject](../xmlschemaobject/)를 반환합니다. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | 지정된 인덱스에 [XmlSchemaObject](../xmlschemaobject/)를 설정합니다. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | 지정된 [XmlSchemaObject](../xmlschemaobject/)에 대응하는 컬렉션 인덱스를 반환합니다. |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | [XmlSchemaObjectCollection](./)에 [XmlSchemaObject](../xmlschemaobject/)를 삽입합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector에 의해 선택된 키 값에 따라 시퀀스 요소를 오름차순으로 정렬합니다. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector에 의해 선택된 키 값에 따라 시퀀스 요소를 내림차순으로 정렬합니다. |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | [XmlSchemaObjectCollection](./)에서 [XmlSchemaObject](../xmlschemaobject/)를 제거합니다. |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | 컬렉션 인스턴스에서 지정된 인덱스의 요소를 제거합니다. 이 메서드는 재정의할 수 없습니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값만큼 공유 참조 카운트를 감소시킵니다. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | 컬렉션이 포함할 수 있는 요소 수를 설정합니다. |
...
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)() | [XmlSchemaObjectCollection](./) 클래스의 새 인스턴스를 초기화합니다. |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | [XmlSchemaObjectCollection](./) 클래스의 새 인스턴스를 초기화하며, [XmlSchemaObject](../xmlschemaobject/)를 받습니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 이 타입의 인스턴스를 생성하거나 operator new를 사용하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 함수에 인수로 전달하십시오.

## 참고

* 클래스 [CollectionBase](../../system.collections/collectionbase/)
