...
description: World Wide Web Consortium (W3C)에서 정의한 XML Schema의 maxInclusive 요소를 나타냅니다. 이 클래스는 simpleType 요소의 최대 값을 제한하는 제약을 지정하는 데 사용할 수 있습니다. 요소 값은 maxInclusive 요소의 값보다 작거나 같아야 합니다.
type: docs
weight: 586
url: /ko/system.xml.schema/xmlschemamaxinclusivefacet/
---
## XmlSchemaMaxInclusiveFacet class

XML [Schema](../)의 **maxInclusive** 요소를 World Wide [Web](../../system.web/) Consortium (W3C)에서 지정한 대로 나타냅니다. 이 클래스는 **simpleType** 요소의 최대 값을 제한하는 제약을 지정하는 데 사용할 수 있습니다. 요소 값은 **maxInclusive** 요소의 값보다 작거나 같아야 합니다.
...
|  [XmlSchemaMaxInclusiveFacet](./xmlschemamaxinclusivefacet/)() | [XmlSchemaMaxInclusiveFacet](./) 클래스의 새 인스턴스를 초기화합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용해 이 타입의 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 인수로 함수에 전달하십시오.
