...
description: 숫자 팩트를 정의하기 위한 기본 클래스입니다. 이 클래스는 XmlSchemaMinLengthFacet와 같은 숫자 팩트 클래스들의 기반 클래스입니다.
type: docs
weight: 664
url: /ko/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet 클래스


숫자 **numeric** 팩트를 정의하기 위한 베이스 클래스입니다. 이 클래스는 [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/)와 같은 숫자 팩트 클래스들의 기본 클래스입니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동등하게 간주하는 C#-style 부동소수점 비교를 에뮬레이션합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동등하게 간주하는 C#-style 부동소수점 비교를 에뮬레이션합니다. |
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | 이 팩트가 고정되었음을 나타내는 정보를 반환합니다. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | 이 팩트가 고정되었음을 나타내는 정보를 설정합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | 약한 레퍼런스 카운트를 감소시킵니다. 직접 호출하지 말고 스마트 포인터 또는 ThisProtetor를 사용하십시오. |
