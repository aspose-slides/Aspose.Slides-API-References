...
description: XML 스키마에서 표기법 요소를 나타내며, World Wide Web Consortium (W3C)에서 지정한 대로입니다. XML 스키마 표기법 선언은 XML 1.0 NOTATION 선언을 재구성한 것입니다. 표기법의 목적은 XML 문서 내에서 비 XML 데이터의 형식을 설명하는 것입니다.
type: docs
weight: 651
url: /ko/system.xml.schema/xmlschemanotation/
---
## XmlSchemaNotation 클래스

Represents the **표기법** element from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). An XML [Schema](../)**표기법** declaration is a reconstruction of **XML** 1.0 NOTATION declarations. The purpose of 표기법s is to describe the format of non-XML data within an XML document.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 같지 않음에도 불구하고, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 같지 않음에도 불구하고, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | **schema** 요소가 가리키는 파일의 행 위치를 반환합니다. |
| [String](../../system/string/) [get_Name](./get_name/)() | 표기법의 이름을 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | 이 스키마 개체와 함께 사용할 XmlSerializerNamespaces를 반환합니다. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | **public** 식별자를 반환합니다. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | 스키마를 로드한 파일의 원본 위치를 반환합니다. |
| [String](../../system/string/) [get_System](./get_system/)() | **system** 식별자를 반환합니다. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | 문자열에 대한 [Object::ReferenceEquals](../../system/object/referenceequals/) 특수화입니다. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | **schema** 요소가 가리키는 파일의 행 위치를 설정합니다. |
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 표기법의 이름을 설정합니다. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | 이 스키마 개체와 함께 사용할 XmlSerializerNamespaces를 설정합니다. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | **public** 식별자를 설정합니다. |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | 스키마를 로드한 파일의 원본 위치를 설정합니다. |
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | **system** 식별자를 설정합니다. |
...
|  [XmlSchemaNotation](./xmlschemanotation/)() | [XmlSchemaNotation](./) 클래스를 새 인스턴스로 초기화합니다. |
