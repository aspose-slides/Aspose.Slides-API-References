...
description: World Wide Web Consortium (W3C)에서 정의한 XML Schema의 minLength 요소를 나타냅니다. 이 클래스는 simpleType 요소의 데이터 값에 대한 최소 길이 제한을 지정하는 데 사용할 수 있습니다. 길이는 minLength 요소의 값보다 커야 합니다.
type: docs
weight: 638
url: /ko/system.xml.schema/xmlschemaminlengthfacet/
---
## XmlSchemaMinLengthFacet 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, C# 스타일 부동소수점 비교에서는 두 NaN을 동일하게 간주하도록 에뮬레이션합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, C# 스타일 부동소수점 비교에서는 두 NaN을 동일하게 간주하도록 에뮬레이션합니다. |
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | 이 facet이 고정됨을 나타내는 정보를 반환합니다. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | 현재 schema의 target namespace에 속하지 않는 한정된 attribute들을 반환합니다. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | 이 facet이 고정됨을 나타내는 정보를 설정합니다. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | 현재 schema의 target namespace에 속하지 않는 한정된 attribute들을 설정합니다. |
...
|  [XmlSchemaMinLengthFacet](./xmlschemaminlengthfacet/)() | [XmlSchemaMinLengthFacet](./) 클래스의 새 인스턴스를 초기화합니다. |
