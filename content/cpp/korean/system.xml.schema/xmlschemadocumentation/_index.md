...
description: World Wide Web Consortium (W3C)에서 지정한 XML 스키마의 documentation 요소를 나타냅니다. 이 클래스는 주석 내에서 사람이 읽거나 사용할 정보를 지정합니다.
type: docs
weight: 352
url: /ko/system.xml.schema/xmlschemadocumentation/
---
## XmlSchemaDocumentation 클래스
...
| [String](../../system/string/) [get_Language](./get_language/)() | **xml:lang** 속성을 반환합니다. 이는 내용에 사용된 언어를 나타내는 표시입니다. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | [XmlNode](../../system.xml/xmlnode/) 객체 배열을 반환합니다. 이 배열은 documentation 하위 노드를 나타냅니다. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | 정보의 Uniform Resource Identifier (URI) 소스를 반환합니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로는 아무것도 복사하지 않으며, 새 객체를 초기화하고 하위 클래스를 복사 생성할 수 있게 합니다. |
...
| void [set_Language](./set_language/)(const [String](../../system/string/)\&) | **xml:lang** 속성을 설정합니다. 이는 내용에 사용된 언어를 나타내는 표시입니다. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | [XmlNode](../../system.xml/xmlnode/) 객체 배열을 설정합니다. 이 배열은 documentation 하위 노드를 나타냅니다. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | 정보의 Uniform Resource Identifier (URI) 소스를 설정합니다. |
