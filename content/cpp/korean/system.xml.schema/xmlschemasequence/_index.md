...
description: XML 스키마에서 World Wide Web Consortium (W3C)이 지정한 시퀀스 요소(콤포지터)를 나타냅니다. 시퀀스는 그룹 내 요소들이 포함 요소 안에서 지정된 순서대로 나타나야 함을 요구합니다.
type: docs
weight: 768
url: /ko/system.xml.schema/xmlschemasequence/
---
## XmlSchemaSequence 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(물론 NaN 자체와도) 같지 않지만, C# 스타일의 부동소수점 비교를 모방하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(물론 NaN 자체와도) 같지 않지만, C# 스타일의 부동소수점 비교를 모방하여 두 NaN을 동일하게 간주합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | 조합기 내에 포함된 요소들입니다. [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./) 또는 [XmlSchemaAny](../xmlschemaany/) 컬렉션. |
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | 입자(particle)가 발생할 수 있는 최대 횟수를 반환합니다. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | 문자열 값으로 숫자를 반환합니다. 입자가 발생할 수 있는 최대 횟수입니다. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | 입자(particle)가 발생할 수 있는 최소 횟수를 반환합니다. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | 문자열 값으로 숫자를 반환합니다. 입자가 발생할 수 있는 최소 횟수입니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 구문을 구현하여 잠그기를 수행합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로는 아무것도 복사하지 않으며, 단지 새 객체를 초기화하고 서브클래스 복사를 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자입니다. 실제로는 아무것도 복사하지 않으며, 단지 새 객체를 초기화하고 서브클래스 복사를 가능하게 합니다. |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | 입자(particle)가 발생할 수 있는 최대 횟수를 설정합니다. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | 문자열 값으로 숫자를 설정합니다. 입자가 발생할 수 있는 최대 횟수입니다. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | 입자(particle)가 발생할 수 있는 최소 횟수를 설정합니다. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | 문자열 값으로 숫자를 설정합니다. 입자가 발생할 수 있는 최소 횟수입니다. |
...
|  [XmlSchemaParticle](../xmlschemaparticle/xmlschemaparticle/)() | [XmlSchemaParticle](../xmlschemaparticle/) 클래스를 새 인스턴스로 초기화합니다. |
|  [XmlSchemaSequence](./xmlschemasequence/)() | [XmlSchemaSequence](./) 클래스를 새 인스턴스로 초기화합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수로만 할당해야 합니다. 스택이나 operator new를 사용하여 이 타입의 인스턴스를 생성하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고 해당 포인터를 인수로 함수에 전달하십시오. 
