...
description: World Wide Web Consortium (W3C)의 all 요소(compositor)를 나타냅니다.
type: docs
weight: 92
url: /ko/system.xml.schema/xmlschemaall/
---
## XmlSchemaAll 클래스
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | **all** 컴포지터에 포함된 [XmlSchemaElement](../xmlschemaelement/) 요소의 컬렉션을 반환합니다. |
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | 입자가 발생할 수 있는 최대 횟수를 반환합니다. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | 입자가 발생할 수 있는 최대 횟수를 문자열 값으로 반환합니다. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | 입자가 발생할 수 있는 최소 횟수를 반환합니다. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | 입자가 발생할 수 있는 최소 횟수를 문자열 값으로 반환합니다. |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | 입자가 발생할 수 있는 최대 횟수를 설정합니다. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | 입자가 발생할 수 있는 최대 횟수를 문자열 값으로 설정합니다. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | 입자가 발생할 수 있는 최소 횟수를 설정합니다. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | 입자가 발생할 수 있는 최소 횟수를 문자열 값으로 설정합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 해제하도록 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하세요. |
...
|  [XmlSchemaAll](./xmlschemaall/)() | [XmlSchemaAll](./) 클래스의 새로운 인스턴스를 초기화합니다. |
|  [XmlSchemaObject](../xmlschemaobject/xmlschemaobject/)() | [XmlSchemaObject](../xmlschemaobject/) 클래스의 새로운 인스턴스를 초기화합니다. |
|  [XmlSchemaParticle](../xmlschemaparticle/xmlschemaparticle/)() | [XmlSchemaParticle](../xmlschemaparticle/) 클래스의 새로운 인스턴스를 초기화합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 생성하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고 해당 포인터를 함수 인수로 전달하세요. 
