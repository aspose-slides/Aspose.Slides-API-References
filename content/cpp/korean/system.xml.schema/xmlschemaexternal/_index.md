...
description: 포함된 스키마에 대한 정보를 제공합니다.
type: docs
weight: 391
url: /ko/system.xml.schema/xmlschemaexternal/
---
## XmlSchemaExternal 클래스
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](./get_schema/)() | 참조된 스키마에 대한 [XmlSchema](../xmlschema/)를 반환합니다. |
| [String](../../system/string/) [get_SchemaLocation](./get_schemalocation/)() | 스키마에 대한 Uniform Resource Identifier (URI) 위치를 반환합니다. 이는 스키마 프로세서에게 스키마가 물리적으로 존재하는 위치를 알려줍니다. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드의 유사 버전입니다. 사용자 정의 타입 복제를 지원합니다. |
...
| void [set_Schema](./set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | 참조된 스키마에 대한 [XmlSchema](../xmlschema/)를 설정합니다. |
| void [set_SchemaLocation](./set_schemalocation/)(const [String](../../system/string/)\&) | 스키마에 대한 Uniform Resource Identifier (URI) 위치를 설정합니다. 이는 스키마 프로세서에게 스키마가 물리적으로 존재하는 위치를 알려줍니다. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 메서드의 유사 버전입니다. 사용자 정의 객체를 문자열로 변환하는 것을 지원합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 생성하면 런타임 오류 및/또는 어설션 결함이 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 함수 인수로 전달하도록 사용하십시오. 
