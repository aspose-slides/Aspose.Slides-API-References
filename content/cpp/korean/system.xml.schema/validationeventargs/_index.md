...
description: ValidationEventHandler와 관련된 자세한 정보를 반환합니다.
type: docs
weight: 53
url: /ko/system.xml.schema/validationeventargs/
---
## ValidationEventArgs 클래스
...
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | 검증 이벤트와 연결된 XmlSchemaException을 반환합니다. |
| [String](../../system/string/) [get_Message](./get_message/)() | 검증 이벤트에 해당하는 텍스트 설명을 반환합니다. |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | 검증 이벤트의 심각도를 반환합니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문장 잠금을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자. 실제로는 아무것도 복사하지 않으며, 새 객체를 초기화하고 서브클래스의 복사 구성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로는 아무것도 복사하지 않으며, 새 객체를 초기화하고 서브클래스의 복사 구성을 가능하게 합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문장 잠금 해제를 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
...
| 필드 | 설명 |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | \"빈\" [EventArgs](../../system/eventargs/) 공유 포인터(null-pointer)를 나타내는 정적 멤버입니다. |
