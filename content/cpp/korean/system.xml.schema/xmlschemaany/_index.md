...
description: World Wide Web Consortium (W3C)의 any 요소를 나타냅니다.
type: docs
weight: 131
url: /ko/system.xml.schema/xmlschemaany/
---
## XmlSchemaAny 클래스


World Wide [Web](../../system.web/) Consortium (W3C) **any** 요소를 나타냅니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 여기서는 NaN도 포함됩니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 여기서는 NaN도 포함됩니다. |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | **schema** 요소가 참조하는 파일의 행 위치를 반환합니다. |
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | 입자가 나타날 수 있는 최대 횟수를 반환합니다. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | 숫자를 문자열 값으로 반환합니다. 입자가 나타날 수 있는 최대 횟수입니다. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | 입자가 나타날 수 있는 최소 횟수를 반환합니다. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | 숫자를 문자열 값으로 반환합니다. 입자가 나타날 수 있는 최소 횟수입니다. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | 사용 가능한 요소를 포함하는 네임스페이스를 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | [XmlSchemaObject](../xmlschemaobject/)의 상위 객체를 반환합니다. |
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | **any** 요소가 지정한 요소에 대한 XML 문서 검증을 애플리케이션이나 XML 프로세서가 어떻게 처리해야 하는지에 대한 정보를 반환합니다. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | **schema** 요소가 참조하는 파일의 행 위치를 설정합니다. |
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | 입자가 나타날 수 있는 최대 횟수를 설정합니다. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | 숫자를 문자열 값으로 설정합니다. 입자가 나타날 수 있는 최대 횟수입니다. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | 입자가 나타날 수 있는 최소 횟수를 설정합니다. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | 숫자를 문자열 값으로 설정합니다. 입자가 나타날 수 있는 최소 횟수입니다. |
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | 사용 가능한 요소를 포함하는 네임스페이스를 설정합니다. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | [XmlSchemaObject](../xmlschemaobject/)의 상위 객체를 설정합니다. |
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | **any** 요소가 지정한 요소에 대한 XML 문서 검증을 애플리케이션이나 XML 프로세서가 어떻게 처리해야 하는지에 대한 정보를 설정합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용해 이 타입의 인스턴스를 생성하면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 인수로 함수에 전달하십시오. 
