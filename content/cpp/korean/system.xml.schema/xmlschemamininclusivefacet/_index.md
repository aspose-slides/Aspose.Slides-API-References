...
description: World Wide Web Consortium (W3C)에서 지정한 XML Schema의 minInclusive 요소를 나타냅니다. 이 클래스는 simpleType 요소의 최소값에 대한 제한을 지정하는 데 사용할 수 있습니다. 요소 값은 minInclusive 요소의 값보다 크거나 같아야 합니다.
type: docs
weight: 625
url: /ko/system.xml.schema/xmlschemamininclusivefacet/
---
## XmlSchemaMinInclusiveFacet 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일 부동소수점 비교를 에뮬레이트합니다. 여기서 두 NaN은 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만 NaN 자체와는 같다고 간주됩니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일 부동소수점 비교를 에뮬레이트합니다. 여기서 두 NaN은 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만 NaN 자체와는 같다고 간주됩니다. |
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | 이 파싯이 고정됨을 나타내는 정보를 반환합니다. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | 파싯의 **value** 속성을 반환합니다. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 객체의 실제 형식을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출의 유사 구현입니다. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType으로 설명된 형식의 인스턴스를 나타내는지 확인합니다. C# 'is' 연산자의 유사 구현입니다. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로는 아무 것도 복사하지 않으며, 새로운 객체를 초기화하고 서브클래스 복사를 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자입니다. 실제로는 아무 것도 복사하지 않으며, 새로운 객체를 초기화하고 서브클래스 복사를 가능하게 합니다. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | 이 파싯이 고정됨을 나타내는 정보를 설정합니다. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | 파싯의 **value** 속성을 설정합니다. |
...
|  [XmlSchemaMinInclusiveFacet](./xmlschemamininclusivefacet/)() | [XmlSchemaMinInclusiveFacet](./) 클래스의 새 인스턴스를 초기화합니다. |
