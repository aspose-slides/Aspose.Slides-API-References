...
description: World Wide Web Consortium (W3C)에서 지정한 XML Schema의 extension 요소를 나타냅니다. 이 클래스는 확장에 의해 파생된 복합 콘텐츠 모델을 가진 복합 형식을 위한 것입니다. 속성이나 요소를 추가하여 복합 형식을 확장합니다.
type: docs
weight: 274
url: /ko/system.xml.schema/xmlschemacomplexcontentextension/
---
## XmlSchemaComplexContentExtension 클래스


다음은 XML [Schema](../)에서 **extension** 요소를 나타내며, World Wide [Web](../../system.web/) Consortium (W3C)에서 정의한 것입니다. 이 클래스는 확장에 의해 파생된 복합 콘텐츠 모델을 가진 복합 유형을 위해 사용됩니다. 속성이나 요소를 추가하여 복합 유형을 확장합니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일 부동소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도(특히 NaN과도) 같지 않지만, 여기서는 두 NaN을 동일하게 취급합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일 부동소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도(특히 NaN과도) 같지 않지만, 여기서는 두 NaN을 동일하게 취급합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | 복합 콘텐츠 모델의 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) 구성 요소를 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | 복합 콘텐츠의 속성 컬렉션을 반환합니다. [XmlSchemaAttribute](../xmlschemaattribute/)와 [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) 요소를 포함합니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | 확장에 의해 파생된 복합 타입의 이름을 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\> [get_Particle](./get_particle/)() | [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) 또는 [XmlSchemaSequence](../xmlschemasequence/) 클래스 중 하나를 반환합니다. |
...
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 확장에 의해 파생된 복합 타입의 이름을 설정합니다. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\>\&) | [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) 또는 [XmlSchemaSequence](../xmlschemasequence/) 클래스 중 하나를 설정합니다. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 공유 포인터 대신 약한 포인터로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용해 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고, 해당 포인터를 함수 인자로 전달하십시오.
