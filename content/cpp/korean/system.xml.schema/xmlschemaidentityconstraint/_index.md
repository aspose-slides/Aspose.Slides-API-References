...
description: "키, keyref 및 unique 요소에 대한 정체성 제약 클래스입니다."
type: docs
weight: 469
url: /ko/system.xml.schema/xmlschemaidentityconstraint/
---
## XmlSchemaIdentityConstraint 클래스
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | XML Path Language ([XPath](../../system.xml.xpath/)) 표현 선택기에 대한 자식으로 적용되는 필드 컬렉션을 반환합니다. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | 정체성 제약의 이름을 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | 정체성 제약의 정규화된 이름을 반환합니다. 이 이름은 **QualifiedName** 값의 컴파일 후 해석을 포함합니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | [XPath](../../system.xml.xpath/) 표현식 **selector** 요소를 반환합니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로는 아무 것도 복사하지 않고 새 객체를 초기화하며 서브클래스의 복사 구성을 가능하게 합니다. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 정체성 제약의 이름을 설정합니다. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | [XPath](../../system.xml.xpath/) 표현식 **selector** 요소를 설정합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 생성하지 마십시오. 그러면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고 해당 포인터를 함수 인수로 전달하십시오. 
