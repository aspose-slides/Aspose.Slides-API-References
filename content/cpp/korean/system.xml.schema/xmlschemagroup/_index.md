...
description: World Wide Web Consortium (W3C)에서 지정한 XML 스키마의 group 요소를 나타냅니다. 이 클래스는 복합 유형에서 참조되는 스키마 수준의 그룹을 정의합니다. 요소 선언 집합을 그룹화하여 복합 유형 정의에 그룹으로 포함할 수 있도록 합니다.
type: docs
weight: 430
url: /ko/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup 클래스

XML [Schema](../)에서 **group** 요소를 나타내며, World Wide [Web](../../system.web/) Consortium (W3C)에서 지정한 바와 같습니다. 이 클래스는 복합 유형에서 참조되는 **schema** 수준에서 그룹을 정의합니다. 요소 선언 집합을 그룹화하여 복합 유형 정의에 그룹으로 포함할 수 있도록 합니다.
...
| [String](../../system/string/) [get_Name](./get_name/)() | 스키마 그룹의 이름을 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/), [XmlSchemaSequence](../xmlschemasequence/) 클래스 중 하나를 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | 스키마 그룹의 정규화된 이름을 반환합니다. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 스키마 그룹의 이름을 설정합니다. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\>\&) | [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/), [XmlSchemaSequence](../xmlschemasequence/) 클래스 중 하나를 설정합니다. |
