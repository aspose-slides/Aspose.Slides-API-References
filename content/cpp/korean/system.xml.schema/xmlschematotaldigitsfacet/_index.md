...
description: World Wide Web Consortium (W3C)에서 지정한 XML 스키마의 totalDigits facet을 나타냅니다. 이 클래스는 simpleType 요소의 값에 입력될 수 있는 숫자 자릿수에 대한 제한을 지정하는 데 사용할 수 있습니다. totalDigits 값은 양의 정수여야 합니다.
type: docs
weight: 898
url: /ko/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet 클래스
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | 현재 schema의 대상 네임스페이스에 속하지 않는 정규화된 특성을 반환합니다. |
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | facet의 **value** 특성을 반환합니다. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | 현재 schema의 대상 네임스페이스에 속하지 않는 정규화된 특성을 설정합니다. |
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | facet의 **value** 특성을 설정합니다. |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | [XmlSchemaTotalDigitsFacet](./) 클래스의 새 인스턴스를 초기화합니다. |
