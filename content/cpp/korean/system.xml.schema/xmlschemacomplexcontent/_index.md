...
description: World Wide Web Consortium (W3C)에서 지정한 XML 스키마의 complexContent 요소를 나타냅니다. 이 클래스는 복합 유형에 대한 복합 콘텐츠 모델을 나타냅니다. 요소만 있거나 혼합 콘텐츠를 가진 복합 유형에 대한 확장 또는 제한을 포함합니다.
type: docs
weight: 261
url: /ko/system.xml.schema/xmlschemacomplexcontent/
---
## XmlSchemaComplexContent 클래스

XML [Schema](../)에서 World Wide [Web](../../system.web/) Consortium (W3C)에서 지정한 **complexContent** 요소를 나타냅니다. 이 클래스는 복합 유형에 대한 복합 콘텐츠 모델을 나타냅니다. 요소만 있거나 혼합 콘텐츠를 가진 복합 유형에 대한 확장 또는 제한을 포함합니다.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | 컨텐츠를 반환합니다. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | 문자열 ID를 반환합니다. |
| **bool** [get_IsMixed](./get_ismixed/)() | 유형에 혼합 컨텐츠 모델이 있는지 여부를 결정하는 정보를 반환합니다. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | 컨텐츠를 설정합니다. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | 문자열 ID를 설정합니다. |
| void [set_IsMixed](./set_ismixed/)(**bool**) | 유형에 혼합 컨텐츠 모델이 있는지 여부를 결정하는 정보를 설정합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수만을 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 타입의 인스턴스를 생성하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고 해당 포인터를 함수 인수로 전달하십시오.

## 참고

* 클래스 [XmlSchemaContentModel](../xmlschemacontentmodel/)
