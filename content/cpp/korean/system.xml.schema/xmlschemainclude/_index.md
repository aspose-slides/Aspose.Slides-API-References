...
description: World Wide Web Consortium (W3C)에서 지정한 XML 스키마의 include 요소를 나타냅니다. 이 클래스는 외부 스키마의 선언 및 정의를 포함하는 데 사용됩니다. 포함된 선언 및 정의는 포함하고 있는 스키마에서 처리할 수 있습니다.
type: docs
weight: 495
url: /ko/system.xml.schema/xmlschemainclude/
---
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동 소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않으며 NaN도 포함합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동 소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않으며 NaN도 포함합니다. |
...
| [String](../../system/string/) [get_SchemaLocation](../xmlschemaexternal/get_schemalocation/)() | 스키마에 대한 Uniform Resource Identifier (URI) 위치를 반환합니다. 이는 스키마 프로세서에 스키마가 물리적으로 위치한 곳을 알려줍니다. |
...
| void [set_Schema](../xmlschemaexternal/set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | 참조된 스키마에 대한 [XmlSchema](../xmlschema/)를 설정합니다. |
| void [set_SchemaLocation](../xmlschemaexternal/set_schemalocation/)(const [String](../../system/string/)\&) | 스키마에 대한 Uniform Resource Identifier (URI) 위치를 설정합니다. 이는 스키마 프로세서에 스키마가 물리적으로 위치한 곳을 알려줍니다. |
