...
description: 스키마 예외에 대한 자세한 정보를 반환합니다.
type: docs
weight: 1
url: /ko/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException 클래스
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | 사용자 정의 예외 데이터가 포함된 사전을 반환합니다. |
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | 오류가 발생한 위치의 행 번호를 반환합니다. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | 오류가 발생한 위치의 열 번호를 반환합니다. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 이 예외의 오류 상태에 대한 설명을 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | XmlSchemaException을 발생시킨 **[XmlSchemaObject](../xmlschemaobject/)**. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 예외를 일으킨 스키마의 Uniform Resource Identifier(URI) 위치를 반환합니다. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | 스택 추적을 포함하는 문자열을 반환합니다. |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | 최내부 예외를 나타내는 Exception 객체의 복사본을 반환합니다. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 특정 예외에 할당된 코드화된 숫자값인 HRESULT를 설정합니다. |
