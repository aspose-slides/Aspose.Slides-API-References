...
description: 제한에 의해 단순 형식이 파생될 때 사용되는 모든 페싯의 기본 클래스입니다.
type: docs
weight: 404
url: /ko/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet 클래스

단순 형식이 제한에 의해 파생될 때 사용되는 모든 페싯의 기본 클래스입니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. 이는 IEC 60559:1989에 따르면 NaN은 NaN을 포함한 어떤 값과도 같지 않음에도 불구하고 적용됩니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. 이는 IEC 60559:1989에 따르면 NaN은 NaN을 포함한 어떤 값과도 같지 않음에도 불구하고 적용됩니다. |
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | 이 페싯이 고정되어 있음을 나타내는 정보를 반환합니다. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | 페싯의 **value** 속성을 반환합니다. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | 이 페싯이 고정되어 있음을 나타내는 정보를 설정합니다. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | 페싯의 **value** 속성을 설정합니다. |
...
|  [XmlSchemaFacet](./xmlschemafacet/)() | [XmlSchemaFacet](./) 클래스의 새 인스턴스를 초기화합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 만들지 마십시오. 그렇지 않으면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고 해당 포인터를 함수 인자로 전달하십시오. 
