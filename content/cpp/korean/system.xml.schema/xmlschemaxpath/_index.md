...
description: World Wide Web Consortium (W3C) 선택자 요소를 나타냅니다.
type: docs
weight: 963
url: /ko/system.xml.schema/xmlschemaxpath/
---
## XmlSchemaXPath 클래스

World Wide [Web](../../system.web/) Consortium (W3C) **selector** 요소를 나타냅니다.
...
| [String](../../system/string/) [get_XPath](./get_xpath/)() | Returns the attribute for the [XPath](../../system.xml.xpath/) expression. |
...
| void [set_XPath](./set_xpath/)(const [String](../../system/string/)\&) | Sets the attribute for the [XPath](../../system.xml.xpath/) expression. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 직접 인스턴스를 만들거나 operator new를 사용하지 마십시오. 그렇지 않으면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 함수 인수로 전달하십시오. 
