...
description: 검증된 XML 노드의 스키마 검증 후 인포셋을 정의합니다.
type: docs
weight: 40
url: /ko/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo 클래스

검증된 XML 노드의 스키마 검증 후 인포셋을 정의합니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만, 두 NaN을 동일하게 간주하는 C#-style 부동 소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만, 두 NaN을 동일하게 간주하는 C#-style 부동 소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual **bool** [get_IsDefault](./get_isdefault/)() | 이 검증된 XML 노드가 XML [Schema](../) 정의 언어 (XSD) 스키마 검증 중 기본값이 적용된 결과로 설정되었는지 여부를 나타내는 값을 반환합니다. |
| virtual **bool** [get_IsNil](./get_isnil/)() | 이 검증된 XML 노드의 값이 **nil**인지 여부를 나타내는 값을 반환합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | 이 검증된 XML 노드에 대한 동적 스키마 유형을 반환합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | 이 검증된 XML 노드에 해당하는 컴파일된 [XmlSchemaAttribute](../xmlschemaattribute/)을 반환합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | 이 검증된 XML 노드에 해당하는 컴파일된 [XmlSchemaElement](../xmlschemaelement/)을 반환합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | 이 검증된 XML 노드의 정적 XML [Schema](../) 정의 언어 (XSD) 스키마 유형을 반환합니다. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | 이 검증된 XML 노드의 XmlSchemaValidity 값을 반환합니다. |
