...
description: World Wide Web Consortium (W3C)에서 지정한 XML Schema의 단순 유형에 대한 restriction 요소를 나타냅니다. 이 클래스는 simpleType 요소를 제한하는 데 사용할 수 있습니다.
type: docs
weight: 872
url: /ko/system.xml.schema/xmlschemasimpletyperestriction/
---
## XmlSchemaSimpleTypeRestriction 클래스
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | 기본 유형에 대한 정보를 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | 한정된 기본 유형의 이름을 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | [Xml](../../system.xml/)[Schema](../) facet을 반환합니다. |
...
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | 기본 유형에 대한 정보를 설정합니다. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 한정된 기본 유형의 이름을 설정합니다. |
