...
description: 현재 컨테이너에 대한 시작 반복자의 구현을 가져옵니다.
type: docs
weight: 300
url: /ko/system.collections/bitarray/virtualizebeginiterator/
---
## BitArray::virtualizeBeginIterator() 메서드


현재 컨테이너에 대한 시작 반복자의 구현을 가져옵니다.
