...
type: docs
weight: 105
url: /ko/system.collections/iequalitycomparer/
---
...
| 메서드 | 설명 |
| --- | --- |
| virtual **bool** [Equals](./equals/)(const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) const | 두 객체가 같은지 확인합니다. |
...
| virtual int [GetHashCode](./gethashcode/)(const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) const | 특정 객체에 대한 해시 코드를 가져옵니다. |
...
|  [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([System::Collections::IEqualityComparer](./), System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | RTTI 정보입니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인수를 강한 포인터가 아닌 약한 포인터로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있게 합니다. |
