...
description: 비 제네릭 컬렉션 인터페이스를 정의합니다.
type: docs
weight: 40
url: /ko/system.collections/icollection/
---
## ICollection 클래스

비 제네릭 컬렉션 인터페이스를 정의합니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않으며 NaN 자체도 포함하지만, C#-style 부동소수점 비교를 모방하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않으며 NaN 자체도 포함하지만, C#-style 부동소수점 비교를 모방하여 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual int [get_Count](./get_count/)() const | 컬렉션의 요소 수를 가져옵니다. |
