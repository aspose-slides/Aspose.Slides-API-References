...
description: 마지막 예외에 대한 자세한 정보를 반환합니다.
type: docs
weight: 1
url: /ko/system.xml/details_xmlexception/
---
## Details_XmlException 클래스
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | 오류가 발생한 위치를 나타내는 행 번호를 반환합니다. 행 번호는 1부터 시작합니다. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | 오류가 발생한 위치를 나타내는 열 위치를 반환합니다. 열 위치는 1부터 시작합니다. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 현재 예외를 설명하는 메시지를 반환합니다. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | XML 파일의 위치를 반환합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 해제하는 구현입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
