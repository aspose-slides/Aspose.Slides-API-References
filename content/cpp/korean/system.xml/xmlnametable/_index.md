...
description: 원자화된 문자열 객체의 테이블.
type: docs
weight: 313
url: /ko/system.xml/xmlnametable/
---
## XmlNameTable 클래스
...
| Method | Description |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | 파생 클래스에서 재정의될 경우, 지정된 문자열을 원자화하고 이를 [XmlNameTable](./)에 추가합니다. |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | 파생 클래스에서 재정의될 경우, 지정된 문자열을 원자화하고 이를 [XmlNameTable](./)에 추가합니다. |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | 파생 클래스에서 재정의될 경우, 지정된 배열에서 특정 문자 범위와 동일한 문자를 포함하는 원자화된 문자열을 가져옵니다. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | 파생 클래스에서 재정의될 경우, 지정된 문자열과 동일한 값을 포함하는 원자화된 문자열을 가져옵니다. |
