...
description: 이름이나 인덱스로 접근할 수 있는 속성들의 컬렉션을 나타냅니다.
type: docs
weight: 92
url: /ko/system.xml/xmlattributecollection/
---
...
Objects of this 클래스 should only be allocated using [System::MakeObject()](../../system/makeobject/) 함수. Never create instances of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this 클래스 into [System::SmartPtr](../../system/smartptr/) pointer and use this pointer to pass it to 함수 as argument. 

## 참고

* 클래스 [XmlNamedNodeMap](../xmlnamednodemap/)
* 네임스페이스 [System::Xml](../)
