...
description: XML 주석의 내용을 나타냅니다.
type: docs
weight: 144
url: /ko/system.xml/xmlcomment/
---
## XmlComment 클래스
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | const 한정 컬렉션 인스턴스의 마지막 요소(있는 경우) 바로 다음을 가리키는 반복자를 가져옵니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도 같지 않음에도 C# 스타일의 부동소수점 비교를 에뮬레이트합니다. 즉, 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도 같지 않음에도 C# 스타일의 부동소수점 비교를 에뮬레이트합니다. 즉, 두 NaN을 동일하게 간주합니다. |
...
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | 노드와 모든 자식 노드의 값을 연결하여 반환합니다. |
...
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | 데이터의 길이(문자 수)를 반환합니다. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | 이 노드 바로 다음에 있는 노드를 반환합니다. |
...
| [String](../../system/string/) [get_Value](../xmlcharacterdata/get_value/)() override | 노드의 값을 반환합니다. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 현재 노드 범위 내에서 주어진 접두사에 가장 가까운 **xmlns** 선언을 찾아 해당 선언에 있는 네임스페이스 URI를 반환합니다. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | 지정된 문자열을 지정된 문자 오프셋에 삽입합니다. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 일반 시퀀스의 각 요소에 변환 함수를 적용하고, 결과값 중 최대값을 반환합니다. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 일반 시퀀스의 각 요소에 변환 함수를 적용하고, 결과값 중 최소값을 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 키 선택자를 통해 선택된 키 값에 따라 시퀀스 요소를 오름차순으로 정렬합니다. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 키 선택자를 통해 선택된 키 값에 따라 시퀀스 요소를 내림차순으로 정렬합니다. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | 이 [XmlNode](../xmlnode/) 아래 하위 트리 전체 깊이의 모든 [XmlText](../xmltext/) 노드를 마크업(태그, 주석, 처리 지시문, CDATA 섹션, 엔터티 참조)만이 [XmlText](../xmltext/) 노드를 구분하도록 "정상" 형태로 변환합니다. 즉, 인접한 [XmlText](../xmltext/) 노드가 없습니다. |
...
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | 노드와 모든 자식 노드의 값을 연결하여 설정합니다. |
...
| void [set_Value](../xmlcharacterdata/set_value/)([String](../../system/string/)) override | 노드의 값을 설정합니다. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 노드의 모든 자식을 지정된 [XmlWriter](../xmlwriter/)에 저장합니다. 주석 노드는 자식이 없으므로 이 메서드는 아무 효과가 없습니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 생성하거나 operator new를 사용해 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 인수로 함수에 전달하십시오.
