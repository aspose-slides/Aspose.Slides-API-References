...
description: 컬렉션에 네임스페이스를 해결하고 추가 및 제거하며, 이러한 네임스페이스에 대한 범위 관리를 제공합니다.
type: docs
weight: 300
url: /ko/system.xml/xmlnamespacemanager/
---
## XmlNamespaceManager 클래스

컬렉션에 네임스페이스를 해결하고 추가 및 제거하며, 이러한 네임스페이스에 대한 범위 관리를 제공합니다.
...
| Method | Description |
| --- | --- |
| virtual void [AddNamespace](./addnamespace/)([String](../../system/string/), [String](../../system/string/)) | 주어진 네임스페이스를 컬렉션에 추가합니다. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 컬렉션에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/)가 T의 복사 객체를 반환하기 때문에 이 반복자는 참조된 객체를 변경하는 데 사용할 수 없습니다. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | const 한정 컬렉션 인스턴스에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](./get_defaultnamespace/)() | 기본 네임스페이스에 대한 네임스페이스 URI를 반환합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\> [get_NameTable](./get_nametable/)() | 이 객체와 연관된 [XmlNameTable](../xmlnametable/)를 반환합니다. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연관된 참조 카운터 데이터 구조를 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | [XmlNamespaceManager](./)에 있는 네임스페이스를 반복하기 위한 열거자를 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) override | 현재 범위에 있는 네임스페이스를 열거하는 데 사용할 수 있는, 접두사별로 키가 지정된 네임스페이스 이름 컬렉션을 반환합니다. |
...
| virtual **bool** [HasNamespace](./hasnamespace/)([String](../../system/string/)) | 제공된 접두사가 현재 푸시된 범위에 대해 네임스페이스가 정의되어 있는지 여부를 나타내는 값을 반환합니다. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 조건을 만족하는 시퀀스의 첫 번째 요소를 반환하며, 찾지 못하면 기본값을 반환합니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현한 잠금 기능을 제공합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하세요. |
| [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) override | 지정된 접두사에 대한 네임스페이스 URI를 반환합니다. |
| [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) override | 주어진 네임스페이스 URI에 선언된 접두사를 찾습니다. |
...
| virtual **bool** [PopScope](./popscope/)() | 스택에서 네임스페이스 범위를 팝합니다. |
| virtual void [PushScope](./pushscope/)() | 스택에 네임스페이스 범위를 푸시합니다. |
...
| virtual void [RemoveNamespace](./removenamespace/)([String](../../system/string/), [String](../../system/string/)) | 주어진 접두사에 대한 네임스페이스를 제거합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문의 언락을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하세요. |
...
|  [XmlNamespaceManager](./xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | [XmlNameTable](../xmlnametable/)를 지정하여 [XmlNamespaceManager](./) 클래스의 새 인스턴스를 초기화합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용해서만 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 인수로 함수에 전달하세요. 
