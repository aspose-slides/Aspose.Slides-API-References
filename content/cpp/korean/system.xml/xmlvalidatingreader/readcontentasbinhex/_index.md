...
description: 내용을 읽고 BinHex 디코딩된 바이너리 바이트를 반환합니다.
type: docs
weight: 599
url: /ko/system.xml/xmlvalidatingreader/readcontentasbinhex/
---
## XmlValidatingReader::ReadContentAsBinHex(ArrayPtr\<uint8_t\>, int32_t, int32_t) 메서드
...
| index | **int32_t** | 버퍼 내에서 결과 복사를 시작할 오프셋입니다. |
