...
type: docs
weight: 443
url: /ko/system.xml/xmlvalidatingreader/getattribute/
---
## XmlValidatingReader::GetAttribute(String) 메서드
...
## XmlValidatingReader::GetAttribute(String, String) 메서드
...
지정된 속성의 값입니다. 속성을 찾을 수 없는 경우 **nullptr** 가 반환됩니다. 이 메서드는 리더의 위치를 이동하지 않습니다.

## XmlValidatingReader::GetAttribute(int32_t) 메서드
