...
description: 속성을 나타냅니다. 속성의 유효하고 기본값은 문서 유형 정의(DTD) 또는 스키마에 정의되어 있습니다.
type: docs
weight: 79
url: /ko/system.xml/xmlattribute/
---
## XmlAttribute 클래스

속성을 나타냅니다. 속성의 유효하고 기본값은 문서 유형 정의(DTD) 또는 스키마에 정의되어 있습니다.
...
| 메서드 | 설명 |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](./appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | 지정된 노드를 이 노드의 자식 노드 목록 끝에 추가합니다. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 컬렉션에서 마지막 요소(있는 경우) 바로 다음을 가리키는 반복자를 가져옵니다. 이 반복자는 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/)가 T의 복사 객체를 반환하기 때문에 참조된 객체를 변경하는 데 사용할 수 없습니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(심지어 NaN과도) 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(심지어 NaN과도) 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | 노드의 기본 Uniform Resource Identifier(URI)를 반환합니다. |
...
| [String](../../system/string/) [get_Name](./get_name/)() override | 노드의 한정 이름을 반환합니다. |
| [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() override | 이 노드의 네임스페이스 URI를 반환합니다. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [get_OwnerElement](./get_ownerelement/)() | 속성이 속한 [XmlElement](../xmlelement/)를 반환합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | 이 노드의 부모를 반환합니다(부모를 가질 수 있는 노드의 경우). |
| [String](../../system/string/) [get_Prefix](./get_prefix/)() override | 이 노드의 네임스페이스 프리픽스를 반환합니다. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | 이 노드 바로 이전에 오는 텍스트 노드를 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | 스키마 유효성 검사 결과 이 노드에 할당된 post-schema-validation-infoset을 반환합니다. |
| virtual **bool** [get_Specified](./get_specified/)() | 속성 값이 명시적으로 설정되었는지 여부를 나타내는 값을 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | 지정된 노드를 지정된 기준 노드 바로 뒤에 삽입합니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | 지정된 노드를 지정된 기준 노드 바로 앞에 삽입합니다. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType에 의해 설명된 유형의 인스턴스인지 확인합니다. C# 'is' 연산자의 유사체입니다. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | 시퀀스의 어느 요소가 존재하거나 조건을 만족하는지 여부를 결정합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | 지정된 타입을 기준으로 시퀀스의 요소를 필터링합니다. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드의 유사체이며, 사용자 정의 타입 복제를 가능하게 합니다. |
| virtual void [Normalize](../xmlnode/normalize/)() | 현재 [XmlNode](../xmlnode/) 아래의 하위 트리 전체 깊이에 있는 모든 [XmlText](../xmltext/) 노드를 \"정상\" 형태로 변환합니다. 이 형태에서는 마크업(즉, 태그, 주석, 처리 지시문, CDATA 섹션 및 엔터티 참조)만이 [XmlText](../xmltext/) 노드들을 구분하며, 인접한 [XmlText](../xmltext/) 노드가 존재하지 않습니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | 지정된 노드를 이 노드의 자식 노드 목록 시작에 추가합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | 지정된 자식 노드를 제거합니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값만큼 공유 참조 카운트를 감소시킵니다. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | 지정된 자식 노드를 지정된 새 자식 노드로 교체합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&) | [XPath](../../system.xml.xpath/) 식과 일치하는 첫 번째 [XmlNode](../xmlnode/)을 선택합니다. |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | 노드와 모든 자식 노드의 연결된 값을 설정합니다. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | 속성의 값을 설정합니다. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | 이 노드의 네임스페이스 접두사를 설정합니다. |
...
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | DOM 구현이 특정 기능을 구현했는지 테스트합니다. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 메서드의 유사체이며, 사용자 정의 객체를 문자열로 변환할 수 있게 합니다. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) 구문을 구현합니다. |
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 해제하는 기능을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
...
[System::MakeObject()](../../system/makeobject/) 함수를 사용해 이 클래스 객체를 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고 해당 포인터를 인수로 함수에 전달하십시오.
