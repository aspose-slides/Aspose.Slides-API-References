...
description: XML 선언 노드 <?xml version='1.0'...?>를 나타냅니다.
type: docs
weight: 170
url: /ko/system.xml/xmldeclaration/
---
## XmlDeclaration 클래스
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 컬렉션에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. 이 반복자는 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/)가 T의 복사 객체를 반환하기 때문에 참조된 객체를 변경하는 데 사용할 수 없습니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 흉내냅니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 흉내냅니다. |
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | XML 문서의 인코딩 레벨을 반환합니다. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | [XmlDeclaration](./)의 연결된 값을 반환합니다. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | 이 노드 바로 앞 노드를 반환합니다. |
...
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | standalone 속성의 값을 반환합니다. |
| [String](../../system/string/) [get_Value](./get_value/)() override | [XmlDeclaration](./)의 값을 반환합니다. |
| [String](../../system/string/) [get_Version](./get_version/)() | 문서의 XML 버전을 반환합니다. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 현재 노드 범위 내에서 지정된 접두사에 가장 가까운 **xmlns** 선언을 찾아 해당 선언에 있는 네임스페이스 URI를 반환합니다. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | 현재 노드 범위 내에서 지정된 네임스페이스 URI에 가장 가까운 **xmlns** 선언을 찾아 해당 선언에 정의된 접두사를 반환합니다. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | 시퀀스의 요소 수를 반환합니다(직접 카운팅으로 계산). |
...
| virtual void [Normalize](../xmlnode/normalize/)() | [XmlNode](../xmlnode/) 아래의 하위 트리 전체 깊이에 있는 모든 [XmlText](../xmltext/) 노드를 마크업(태그, 주석, 처리 명령, CDATA 섹션, 엔터티 참조)만이 [XmlText](../xmltext/) 노드를 구분하도록 "정상" 형태로 변환합니다. 즉, 인접한 [XmlText](../xmltext/) 노드가 없게 됩니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 식과 일치하는 노드 목록을 선택합니다. [XPath](../../system.xml.xpath/) 식에서 찾은 모든 접두사는 제공된 [XmlNamespaceManager](../xmlnamespacemanager/)을 사용하여 해결됩니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 식과 일치하는 첫 번째 [XmlNode](../xmlnode/)을 선택합니다. [XPath](../../system.xml.xpath/) 식에서 찾은 모든 접두사는 제공된 [XmlNamespaceManager](../xmlnamespacemanager/)을 사용하여 해결됩니다. |
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | XML 문서의 인코딩 레벨을 설정합니다. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | [XmlDeclaration](./)의 연결된 값을 설정합니다. |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | standalone 속성의 값을 설정합니다. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | [XmlDeclaration](./)의 값을 설정합니다. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 노드의 자식을 지정된 [XmlWriter](../xmlwriter/)에 저장합니다. [XmlDeclaration](./) 노드는 자식이 없으므로 이 메서드는 아무 효과가 없습니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 타입의 인스턴스를 생성하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 함수 인수로 전달하세요.
