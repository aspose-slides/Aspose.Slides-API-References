...
description: 콘텐츠를 읽고 BinHex 디코딩된 이진 바이트를 반환합니다.
type: docs
weight: 664
url: /ko/system.xml/xmltextreader/readcontentasbinhex/
---
## XmlTextReader::ReadContentAsBinHex(ArrayPtr\<uint8_t\>, int32_t, int32_t) 메서드
