...
description: 여러 클래스에서 사용되는 텍스트 조작 메서드를 제공합니다.
type: docs
weight: 118
url: /ko/system.xml/xmlcharacterdata/
---
## XmlCharacterData 클래스

여러 클래스에서 사용되는 텍스트 조작 메서드를 제공합니다.
...
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | 지정된 문자열을 노드의 문자 데이터 끝에 추가합니다. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | 파생 클래스에서 오버라이드될 때 노드의 복제본을 생성합니다. |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | 노드에서 문자 범위를 제거합니다. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 컬렉션에서 마지막 요소 바로 뒤를 가리키는 반복자를 가져옵니다. 이 반복자는 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/)가 T의 복사 객체를 반환하기 때문에 참조된 객체를 변경할 수 없습니다. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 컬렉션의 const 한정 인스턴스에서 마지막 요소 바로 뒤를 가리키는 반복자를 가져옵니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 동일하지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 동일하지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | 노드의 데이터를 반환합니다. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | 노드와 모든 자식 노드의 연결된 값을 반환합니다. |
...
| virtual **int32_t** [get_Length](./get_length/)() | 데이터의 길이를 문자 수로 반환합니다. |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | 파생 클래스에서 오버라이드될 때 노드의 로컬 이름을 반환합니다. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | 파생 클래스에서 오버라이드될 때 노드의 정규화된 이름을 반환합니다. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | 파생 클래스에서 오버라이드될 때 현재 노드의 타입을 반환합니다. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | 스키마 검증 결과 이 노드에 할당된 사후 스키마 검증 인포셋을 반환합니다. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 현재 노드 범위에 있는 지정된 접두사에 가장 가까운 **xmlns** 선언을 찾아 해당 선언에 있는 네임스페이스 URI를 반환합니다. |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | 지정된 문자 오프셋에 지정된 문자열을 삽입합니다. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | 시퀀스에 요소가 존재하는지 판단합니다. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | [XmlText](../xmltext/) 노드를 이 [XmlNode](../xmlnode/) 아래 서브트리 전체 깊이에서 마크업(태그, 주석, 처리 지시문, CDATA 섹션 및 엔티티 참조)만이 [XmlText](../xmltext/) 노드를 구분하도록 "정상" 형태로 변환합니다. 즉, 인접한 [XmlText](../xmltext/) 노드가 없게 됩니다. |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | 지정된 오프셋에서 시작하는 지정된 수의 문자를 지정된 문자열로 교체합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 식과 일치하는 노드 목록을 선택합니다. [XPath](../../system.xml.xpath/) 식에서 발견된 모든 접두사는 제공된 [XmlNamespaceManager](../xmlnamespacemanager/)를 사용하여 해결됩니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 식과 일치하는 첫 번째 [XmlNode](../xmlnode/)를 선택합니다. [XPath](../../system.xml.xpath/) 식에서 발견된 모든 접두사는 제공된 [XmlNamespaceManager](../xmlnamespacemanager/)를 사용하여 해결됩니다. |
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | 노드의 데이터를 설정합니다. |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | 지정된 범위에서 전체 문자열의 부분 문자열을 가져옵니다. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 파생 클래스에서 오버라이드될 때 노드의 모든 자식 노드를 지정된 [XmlWriter](../xmlwriter/)에 저장합니다. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 파생 클래스에서 오버라이드될 때 현재 노드를 지정된 [XmlWriter](../xmlwriter/)에 저장합니다. |
