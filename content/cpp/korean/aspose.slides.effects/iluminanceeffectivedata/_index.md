...
description: Luminance 효과를 나타냅니다. 밝기는 모든 색상을 선형적으로 흰색 또는 검은색에 가깝게 이동시킵니다. 대비는 모든 색상의 거리를 더 가깝게 혹은 더 멀게 조정합니다.
type: docs
weight: 807
url: /ko/aspose.slides.effects/iluminanceeffectivedata/
---
## ILuminanceEffectiveData 클래스

[Luminance](../luminance/) 효과를 나타냅니다. 밝기는 모든 색상을 선형적으로 흰색 또는 검은색에 가깝게 이동시킵니다. 대비는 모든 색상의 거리를 더 가깝게 혹은 더 멀게 조정합니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도 같지 않지만, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도 같지 않지만, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual **float** [get_Brightness](./get_brightness/)() | 밝기. 읽기 전용 **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | 대비. 읽기 전용 **float**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th 템플릿 인수를 공유 대신 약한 포인터로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있습니다. |
