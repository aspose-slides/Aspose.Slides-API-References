...
description: 전체 도형(채우기 포함)에 적용되는 Blur 효과를 나타냅니다. 알파를 포함한 모든 색상 채널이 영향을 받습니다.
type: docs
weight: 105
...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 지정된 [Blur](./)이 현재 [Blur](./)와 동일한지 여부를 결정합니다. |
...
| **bool** [get_Grow](./get_grow/)() override | 블러 처리 결과 객체의 경계가 확장되어야 하는지 여부를 결정합니다. true이면 경계가 확장되고 false이면 확장되지 않음을 나타냅니다. 읽기 전용 **bool**. |
...
| **double** [get_Radius](./get_radius/)() override | 블러 반경을 반환합니다. **double** 읽기 전용. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연관된 참조 카운터 데이터 구조를 가져옵니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | 상속이 적용된 효과적인 [Blur](./) 효과 데이터를 가져옵니다. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 특정 유형의 해시 함수를 제공합니다. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType으로 설명된 유형의 인스턴스인지 확인합니다. C# ‘is’ 연산자의 유사 기능입니다. |
...
| void [set_Grow](./set_grow/)(**bool**) override | 블러 처리 결과 객체의 경계가 확장되어야 하는지 여부를 결정합니다. true이면 경계가 확장되고 false이면 확장되지 않음을 나타냅니다. **bool** 쓰기 전용. |
| void [set_Radius](./set_radius/)(**double**) override | 블러 반경을 설정합니다. **double** 쓰기 전용. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 메서드의 유사 기능입니다. 사용자 정의 객체를 문자열로 변환할 수 있습니다. |
