...
description: Alpha Ceiling 효과를 나타냅니다. 0보다 큰 Alpha(불투명도) 값은 100%로 변경됩니다. 즉, 부분적으로 투명한 모든 것이 완전히 불투명해집니다.
type: docs
weight: 261
...
Alpha Ceiling 효과를 나타냅니다. 0보다 큰 Alpha(불투명도) 값은 100%로 변경됩니다. 즉, 부분적으로 투명한 모든 것이 완전히 불투명해집니다.
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현한 잠금 기능을 제공합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
