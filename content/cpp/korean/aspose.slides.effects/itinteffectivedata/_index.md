...
description: Tint 효과를 나타내는 불변 객체입니다. 지정된 양만큼 색조를 기준으로 효과 색상 값을 증가/감소시킵니다.
type: docs
weight: 1002
url: /ko/aspose.slides.effects/itinteffectivedata/
---
## ITintEffectiveData 클래스


지정된 양만큼 색조를 기준으로 효과 색상 값을 증가/감소시키는 [Tint](../tint/) 효과를 나타내는 불변 객체입니다.
...
| virtual **float** [get_Amount](./get_amount/)() | 효과 양을 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_Hue](./get_hue/)() | 색조를 반환합니다. 읽기 전용 **float**. |
