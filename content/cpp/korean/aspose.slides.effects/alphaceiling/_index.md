...
description: Alpha Ceiling 효과를 나타냅니다. Alpha(불투명도) 값이 0보다 큰 경우 100%로 변경됩니다. 즉, 부분적으로 불투명한 모든 것이 완전히 불투명해집니다.
type: docs
weight: 14
...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 지정된 [AlphaCeiling](./)이 현재 [AlphaCeiling](./)와 같은지 판단합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따라 NaN은 어떤 값과도 같지 않지만, C# 스타일의 부동소수점 비교를 에뮬레이트하여 두 NaN을 같은 것으로 처리합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따라 NaN은 어떤 값과도 같지 않지만, C# 스타일의 부동소수점 비교를 에뮬레이트하여 두 NaN을 같은 것으로 처리합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | 상속이 적용된 실제 Alpha Ceiling 효과 데이터를 가져옵니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문 해제 구현입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용합니다. |
...
* 클래스 [IAlphaCeiling](../ialphaceiling/)
