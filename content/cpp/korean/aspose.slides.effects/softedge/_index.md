...
description: 소프트 엣지 효과를 나타냅니다. 도형의 가장자리는 흐려지지만, 채우기에는 영향을 주지 않습니다.
type: docs
weight: 1080
...
Shape의 가장자리를 흐리게 만들지만, 채우기에는 영향을 주지 않는 부드러운 가장자리 효과를 나타냅니다.
...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 지정된 [SoftEdge](./)가 현재 [SoftEdge](./)와 같은지 여부를 판단합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(또 NaN 포함) 같지 않지만, 두 NaN을 동일하게 간주하는 C#-style 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(또 NaN 포함) 같지 않지만, 두 NaN을 동일하게 간주하는 C#-style 부동소수점 비교를 에뮬레이트합니다. |
...
| **double** [get_Radius](./get_radius/)() override | 가장자리에 적용할 블러 반경을 지정합니다. 읽기 **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | 상속이 적용된 유효한 Soft Edge 효과 데이터를 가져옵니다. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 특정 타입에 대한 해시 함수를 제공합니다. |
...
| void [set_Radius](./set_radius/)(**double**) override | 가장자리에 적용할 블러 반경을 지정합니다. **double** 쓰기. |
