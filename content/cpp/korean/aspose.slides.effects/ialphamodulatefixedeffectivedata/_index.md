...
description: 불변 객체로 Alpha Modulate Fixed 효과를 나타냅니다. 효과 알파(불투명도) 값은 고정 비율로 곱해집니다.
type: docs
weight: 378
url: /ko/aspose.slides.effects/ialphamodulatefixedeffectivedata/
---
## IAlphaModulateFixedEffectiveData 클래스
...
| virtual **float** [get_Amount](./get_amount/)() | 효과 양을 퍼센트 단위로 반환합니다. 읽기 전용 **float**. |
