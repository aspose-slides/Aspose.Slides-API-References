...
description: 불변 객체이며 BrightnessContrast 효과를 나타냅니다. 밝기와 대비를 조정합니다.
type: docs
weight: 495
url: /ko/aspose.slides.effects/ibrightnesscontrasteffectivedata/
---
## IBrightnessContrastEffectiveData 클래스

불변 객체이며 [BrightnessContrast](../brightnesscontrast/) 효과를 나타냅니다. 밝기와 대비를 조정합니다.
...
| virtual **float** [get_Brightness](./get_brightness/)() | 밝기를 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | 대비를 반환합니다. 읽기 전용 **float**. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문과 같은 잠금 기능을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
