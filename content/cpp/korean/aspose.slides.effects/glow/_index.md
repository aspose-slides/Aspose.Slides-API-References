...
description: 객체의 가장자리 밖에 색상이 흐려진 윤곽선이 추가되는 Glow 효과를 나타냅니다.
type: docs
weight: 196
...
[Glow](./) 효과를 나타내며, 객체의 가장자리 밖에 색상이 흐려진 윤곽선이 추가됩니다.
...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 지정된 [Glow](./)가 현재 [Glow](./)과 같은지 확인합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | 색상 형식. 읽기 전용 [IColorFormat](../../aspose.slides/icolorformat/). |
...
| **double** [get_Radius](./get_radius/)() override | 반경. **double**를 읽습니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGlowEffectiveData](../igloweffectivedata/)\> [GetEffective](./geteffective/)() override | 상속이 적용된 효과적인 [Glow](./) 효과 데이터를 가져옵니다. |
...
| void [set_Radius](./set_radius/)(**double**) override | 반경. **double**를 씁니다. |
