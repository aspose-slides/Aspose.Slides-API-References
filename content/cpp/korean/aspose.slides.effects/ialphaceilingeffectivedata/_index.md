...
description: 알파 Ceiling 효과를 나타내는 불변 객체입니다. 알파(불투명도) 값이 0보다 크면 100%로 변경됩니다. 즉, 부분적으로 투명한 모든 것이 완전히 불투명해집니다.
type: docs
weight: 274
url: /ko/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData 클래스

불변 객체로 Alpha Ceiling 효과를 나타냅니다. 0보다 큰 Alpha(불투명도) 값은 100%로 변경됩니다. 즉, 부분적으로 투명한 항목은 완전히 불투명하게 됩니다.
