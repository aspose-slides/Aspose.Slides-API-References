...
description: 소프트 엣지 효과를 나타내는 불변 객체입니다. 도형의 가장자는 흐릿해지지만, 채우기는 영향을 받지 않습니다.
type: docs
weight: 976
url: /ko/aspose.slides.effects/isoftedgeeffectivedata/
---
## ISoftEdgeEffectiveData 클래스

소프트 엣지 효과를 나타내는 불변 객체입니다. 도형의 가장자리는 흐릿해지지만, 채우기는 영향을 받지 않습니다.
...
| virtual **double** [get_Radius](./get_radius/)() | 가장자리에 적용할 블러 반경을 지정합니다. 읽기 전용 **double**. |
