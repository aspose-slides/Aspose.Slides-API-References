...
description: Soft Edge 효과를 나타냅니다. 도형의 가장자리는 흐려지지만 채우기에는 영향을 주지 않습니다.
type: docs
weight: 963
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 서로 동일한 것으로 간주되는 C#-스타일의 부동소수점 비교를 에뮬레이트합니다(IEC 60559:1989에 따라 NaN은 어떤 값과도 같지 않음). |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 서로 동일한 것으로 간주되는 C#-스타일의 부동소수점 비교를 에뮬레이트합니다(IEC 60559:1989에 따라 NaN은 어떤 값과도 같지 않음). |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual **double** [get_Radius](./get_radius/)() | 가장자리에 적용할 블러 반경을 지정합니다. 읽기 **double**. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | 가장자리에 적용할 블러 반경을 지정합니다. 쓰기 **double**. |
