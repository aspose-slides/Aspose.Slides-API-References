...
description: Hue/Saturation/Luminance 효과를 나타냅니다. 색조, 채도 및 명도는 각각 현재 값에 대해 상대적으로 조정될 수 있습니다.
type: docs
weight: 222
...
Hue/Saturation/Luminance 효과를 나타냅니다. 색조, 채도 및 명도는 각각 현재 값에 대해 상대적으로 조정될 수 있습니다.
...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 지정된 [HSL](./)가 현재 [HSL](./)와 같은지 여부를 결정합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | 상속이 적용된 효과적인 Hue/Saturation/Luminance 효과 데이터를 가져옵니다. |
