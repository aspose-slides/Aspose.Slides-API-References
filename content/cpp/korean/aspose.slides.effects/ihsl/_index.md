...
description: 색조/채도/명도 효과를 나타냅니다. 색조, 채도 및 명도는 각각 현재 값에 대해 조정될 수 있습니다.
type: docs
weight: 690
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문에 대한 잠금 해제 구현입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
