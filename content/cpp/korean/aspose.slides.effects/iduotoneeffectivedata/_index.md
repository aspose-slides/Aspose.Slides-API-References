...
description: Duotone 효과를 나타내는 불변 객체입니다. 각 픽셀에 대해 clr1과 clr2를 선형 보간을 통해 결합하여 해당 픽셀의 새로운 색상을 결정합니다.
type: docs
weight: 573
url: /ko/aspose.slides.effects/iduotoneeffectivedata/
---
## IDuotoneEffectiveData 클래스

Immutable object which represents a [Duotone](../duotone/) effect. For each pixel, combines clr1 and clr2 through a linear interpolation to determine the new color for that pixel.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color1](./get_color1/)() | 다크 픽셀에 대한 목표 색상 포맷을 반환합니다. 읽기 전용 [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color2](./get_color2/)() | 라이트 픽셀에 대한 목표 색상 포맷을 반환합니다. 읽기 전용 [System::Drawing::Color](../../system.drawing/color/). |
