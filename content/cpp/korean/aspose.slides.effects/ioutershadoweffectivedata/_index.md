...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 레퍼런스 타입 객체를 C# 스타일로 비교합니다. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 값 타입 객체를 C# 스타일로 비교합니다. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음에도 불구하고, C#-style 부동소수점 비교를 에뮬레이션하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음에도 불구하고, C#-style 부동소수점 비교를 에뮬레이션하여 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용. |
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) 반경. 읽기 전용 **double**. |
| virtual **float** [get_Direction](./get_direction/)() | 그림자 방향. 읽기 전용 **float**. |
| virtual **double** [get_Distance](./get_distance/)() | 그림자 거리. 읽기 전용 **double**. |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | 사각형 정렬. 읽기 전용 [RectangleAlignment](../../aspose.slides/rectanglealignment/). |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | 도형이 회전된 경우 그림자가 도형과 함께 회전해야 하는지를 지정합니다. 읽기 전용 **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | 수평 스케일링 계수를 지정합니다. 음수 스케일링은 뒤집기를 일으킵니다. 읽기 전용 **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | 수직 스케일링 계수를 지정합니다. 음수 스케일링은 뒤집기를 일으킵니다. 읽기 전용 **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | 그림자 색상. 읽기 전용 [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | 수평 기울기 각도(도 단위)를 지정합니다. 읽기 전용 **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | 수직 기울기 각도(도 단위)를 지정합니다. 읽기 전용 **double**. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현한 락을 수행합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 구현한 락 해제를 수행합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
...
* 클래스 [IEffectEffectiveData](../ieffecteffectivedata/)
