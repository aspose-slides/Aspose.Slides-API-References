...
description: 채우기를 포함한 전체 도형에 적용되는 Blur 효과를 나타내는 불변 객체입니다. 알파를 포함한 모든 색상 채널이 영향을 받습니다.
type: docs
weight: 469
url: /ko/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData 클래스

전체 도형에 적용되는 [Blur](../blur/) 효과를 나타내는 불변 객체이며, 채우기를 포함합니다. 알파를 포함한 모든 색상 채널이 영향을 받습니다.
...
| virtual **bool** [get_Grow](./get_grow/)() | 블러링 결과 객체의 경계가 확대되어야 하는지 여부를 결정합니다. true이면 경계가 확대되고 false이면 확대되지 않습니다. 읽기 전용 **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | 블러 반경을 반환합니다. 읽기 전용 **double**. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문장 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
