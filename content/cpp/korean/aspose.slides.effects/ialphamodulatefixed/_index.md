...
| virtual **float** [get_Amount](./get_amount/)() | 효과의 양을 퍼센트로 반환합니다. 읽기 **float**. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | 효과의 양을 퍼센트로 반환합니다. 쓰기 **float**. |
