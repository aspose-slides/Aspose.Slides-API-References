...
description: Bi-Level(흑백) 효과를 나타냅니다. 지정된 임계값보다 밝기가 낮은 입력 색상은 검은색으로 변경됩니다. 밝기가 지정된 값보다 크거나 같으면 흰색으로 설정됩니다. 알파 효과 값은 이 효과에 영향을 받지 않습니다.
type: docs
weight: 92
...
Bi-Level (흑백) 효과를 나타냅니다. 지정된 임계값보다 밝기가 낮은 입력 색은 검은색으로 변경됩니다. 밝기가 지정된 값보다 크거나 같거나 같은 입력 색은 흰색으로 설정됩니다. 알파 효과 값은 이 효과에 영향을 받지 않습니다.
...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 지정된 [BiLevel](./)가 현재 [BiLevel](./)와 같은지 여부를 결정합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN을 포함해도 같지 않음). |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN을 포함해도 같지 않음). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevelEffectiveData](../ibileveleffectivedata/)\> [GetEffective](./geteffective/)() override | 상속이 적용된 실제 Bi-Level 효과 데이터를 가져옵니다. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType으로 설명된 유형의 인스턴스인지 확인합니다. C# 'is' 연산자의 유사 형태입니다. |
| void [Lock](../../system/object/lock/)() | C# lock() 구문의 잠금을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드의 유사 형태입니다. 사용자 정의 유형 복제를 가능하게 합니다. |
