...
type: docs
weight: 924
url: /ko/aspose.slides.effects/ipresetshadoweffectivedata/
---
## IPresetShadowEffectiveData 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 서로 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 NaN을 포함한 어떤 값과도 동일하지 않지만, 여기서는 그런 규칙을 무시합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 서로 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 NaN을 포함한 어떤 값과도 동일하지 않지만, 여기서는 그런 규칙을 무시합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용. |
| virtual **float** [get_Direction](./get_direction/)() | 그림자의 방향. 읽기 전용 **float**. |
| virtual **double** [get_Distance](./get_distance/)() | 그림자의 거리. 읽기 전용 **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | 프리셋. 읽기 전용 [PresetShadowType](../../aspose.slides/presetshadowtype/). |
