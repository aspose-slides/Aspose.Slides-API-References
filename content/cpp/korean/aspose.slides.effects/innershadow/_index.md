...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 지정된 [InnerShadow](./)가 현재 [InnerShadow](./)와 같은지 확인합니다. |
...
| **double** [get_BlurRadius](./get_blurradius/)() override | [Blur](../blur/) 반경. 읽기 **double**. |
| **float** [get_Direction](./get_direction/)() override | 그림자 방향. 읽기 **float**. |
| **double** [get_Distance](./get_distance/)() override | 그림자 거리. 읽기 **double**. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | 상위 [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)을 반환합니다. 읽기 전용 [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | 그림자 색상. 읽기 전용 [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadowEffectiveData](../iinnershadoweffectivedata/)\> [GetEffective](./geteffective/)() override | 상속이 적용된 효과적인 Inner Shadow 효과 데이터를 가져옵니다. |
...
| void [set_BlurRadius](./set_blurradius/)(**double**) override | [Blur](../blur/) 반경. 쓰기 **double**. |
| void [set_Direction](./set_direction/)(**float**) override | 그림자 방향. 쓰기 **float**. |
| void [set_Distance](./set_distance/)(**double**) override | 그림자 거리. 쓰기 **double**. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문문의 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
