...
description: 사용자 정의 분할이 적용된 바-파이 또는 파이-파이 차트에서 분할 지점을 위한 포인트 컬렉션을 나타냅니다.
type: docs
weight: 1314
...
사용자 정의 분할이 적용된 바-파이 또는 파이-파이 차트에서 분할 지점을 위한 포인트 컬렉션을 나타냅니다.
...
| 메서드 | 설명 |
| --- | --- |
| void [Add](./add/)(const **int32_t**\&) override | 부모 시리즈 포인트 컬렉션에서 인덱스로 데이터 포인트를 추가합니다. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | 컬렉션에 데이터 포인트를 추가합니다. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 컬렉션의 첫 번째 const 한정 요소(있는 경우)를 가리키는 이터레이터를 가져옵니다. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 컬렉션의 마지막 const 한정 요소(있는 경우) 바로 뒤를 가리키는 이터레이터를 가져옵니다. |
| void [Clear](./clear/)() override | [ICollection](../../system.collections.generic/icollection/)에서 모든 항목을 제거합니다. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) const override | [ICollection](../../system.collections.generic/icollection/)에 특정 값이 포함되어 있는지 확인합니다. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>, **int32_t**) override | [ICollection](../../system.collections.generic/icollection/)의 요소를 [System::Array](../../system/array/)에 복사합니다. 특정 [System::Array](../../system/array/) 인덱스에서 시작합니다. |
...
| [iterator](./iterator/) [end](./end/)() | 컬렉션의 마지막 요소(있는 경우) 바로 뒤를 가리키는 이터레이터를 가져옵니다. |
...
| **int32_t** [get_Count](./get_count/)() const override | 차트 데이터 포인트 수를 반환합니다. 읽기 전용 **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | [ICollection](../../system.collections.generic/icollection/)이 읽기 전용인지 여부를 나타내는 값을 가져옵니다. 읽기 전용 **bool**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() | 컬렉션에 대한 접근이 동기화(스레드 안전)되어 있는지 여부를 나타내는 값을 반환합니다. 읽기 전용 **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | 동기화 루트를 반환합니다. 읽기 전용 [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연관된 참조 카운터 데이터 구조를 가져옵니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>\> [GetEnumerator](./getenumerator/)() override | 컬렉션을 순회하는 열거자를 반환합니다. |
...
|  [ICollection](../../system.collections.generic/icollection/icollection/)() | 디폴트 생성자. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) override | 지정된 인덱스에 대한 차트 데이터 포인트를 반환합니다. |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | 시퀀스에 대한 누적 함수를 적용합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector에 의해 선택된 키 값을 기준으로 시퀀스 요소를 오름차순으로 정렬합니다. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector에 의해 선택된 키 값을 기준으로 시퀀스 요소를 내림차순으로 정렬합니다. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | 컬렉션에서 항목을 제거합니다. |
| void [Remove](./remove/)(**int32_t**) override | 부모 시리즈 포인트 컬렉션에서 인덱스로 컬렉션의 항목을 제거합니다. |
...
| 타입 별명 | 설명 |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 현재 컬렉션에서 이터레이터 타입으로 사용되는 컬렉션 타입입니다. |
...
* 클래스 [IPieSplitCustomPointCollection](../ipiesplitcustompointcollection/)
