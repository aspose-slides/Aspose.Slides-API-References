...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 데이터 포인트 레벨의 서식 속성을 나타냅니다. 읽기 [IFormat](../iformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | 데이터 포인트 레벨의 데이터 레이블을 나타냅니다. Treemap 및 Sunburst sereis 유형에 적용됩니다. 읽기 전용 [IDataLabel](../idatalabel/). |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문에 해당하는 잠금을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문에 해당하는 잠금 해제를 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
...
* 클래스 [IChartDataPointLevel](../ichartdatapointlevel/)
