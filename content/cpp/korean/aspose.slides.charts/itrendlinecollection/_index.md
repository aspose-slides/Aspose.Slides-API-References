...
description: TrendlineEx의 컬렉션을 나타냅니다
type: docs
weight: 1236
url: /ko/aspose.slides.charts/itrendlinecollection/
---
## ITrendlineCollection 클래스

TrendlineEx의 컬렉션을 나타냅니다.
...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [Add](./add/)([TrendlineType](../trendlinetype/)) | 새로운 [Trendline](../trendline/)를 컬렉션의 끝에 추가하고 반환합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [idx_get](./idx_get/)(**int32_t**) | 지정된 인덱스의 요소를 가져옵니다. 읽기 전용 [ITrendline](../itrendline/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | 시퀀스가 비어 있을 경우 기본값을 반환하며, 그렇지 않으면 첫 번째 요소를 반환합니다. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | 시퀀스가 비어 있을 경우 기본값을 반환하며, 그렇지 않으면 마지막 요소를 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | 지정된 프리디케이트를 기준으로 시퀀스를 필터링합니다. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>) | 지정된 값을 제거합니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값 만큼 공유 레퍼런스 카운트를 감소시킵니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 강한 포인터가 아니라 약한 포인터로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
