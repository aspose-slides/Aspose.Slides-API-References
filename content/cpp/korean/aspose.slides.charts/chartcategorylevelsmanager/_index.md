...
description: 차트 카테고리 레벨 값들을 관리하는 컨테이너입니다.
type: docs
weight: 92
...
| 메서드 | 설명 |
| --- | --- |
| void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) override | 정의된 레벨에 대한 그룹화 항목을 삭제합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) override | 정의된 레벨에 대한 [IChartDataCell](../ichartdatacell/) 객체를 반환합니다. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | nullptr와 값 형식 객체를 참조 비교합니다. |
...
| void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 정의된 레벨에 대한 그룹화 항목을 설정합니다. |
...
* 클래스 [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)
