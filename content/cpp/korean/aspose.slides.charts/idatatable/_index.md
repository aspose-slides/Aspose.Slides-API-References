...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동 소수점 비교를 모방합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 동등하지 않음). |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동 소수점 비교를 모방합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 동등하지 않음). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 객체의 선, 채우기 및 효과 스타일을 반환합니다. 읽기 전용 [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | 차트 데이터 테이블에 가로 셀 테두리가 있으면 true를 반환합니다. 읽기 전용 **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | 차트 데이터 테이블에 외곽 테두리가 있으면 true를 반환합니다. 읽기 전용 **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | 차트 데이터 테이블에 세로 셀 테두리가 있으면 true를 반환합니다. 읽기 전용 **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | 데이터 레이블 범례 키가 표시되면 true를 반환합니다. 읽기 전용 **bool**. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | 차트 데이터 테이블에 가로 셀 테두리가 있으면 true를 설정합니다. 쓰기 전용 **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | 차트 데이터 테이블에 외곽 테두리가 있으면 true를 설정합니다. 쓰기 전용 **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | 차트 데이터 테이블에 세로 셀 테두리가 있으면 true를 설정합니다. 쓰기 전용 **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | 데이터 레이블 범례 키가 표시되면 true를 설정합니다. 쓰기 전용 **bool**. |
