...
description: IChartDataCell과 연결된 워크시트를 나타냅니다.
type: docs
weight: 742
url: /ko/aspose.slides.charts/ichartdataworksheet/
---
## IChartDataWorksheet 클래스
...
| virtual **int32_t** [get_Index](./get_index/)() | 인덱스를 가져옵니다. 읽기 전용 **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 이름을 가져옵니다. 읽기 전용 [System::String](../../system/string/). |
