...
description: 데이터가 포함된 셀 컬렉션을 나타냅니다.
type: docs
weight: 625
url: /ko/aspose.slides.charts/ichartcellcollection/
---
## IChartCellCollection 클래스
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | 컬렉션에 새 셀을 추가합니다. |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 지정된 값으로 [IChartDataCell](../ichartdatacell/)을(를) 생성하고 컬렉션에 추가합니다. |
...
| virtual **int32_t** [get_Count](./get_count/)() | 컬렉션에 있는 셀 수를 가져옵니다. 읽기 전용 **int32_t**. |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | 워크북의 셀 집합 주소를 반환합니다. |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | 모든 셀 문자열 값들을 연결한 문자열을 반환합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | 인덱스로 셀([IChartDataCell](../ichartdatacell/))을 반환합니다. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드와 유사합니다. 사용자 정의 타입 복제를 가능하게 합니다. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 인덱스로 컬렉션에서 셀을 제거합니다. |
