...
description: "pptx 프레젠테이션 문서에 저장될 수 있는 double 값을 두 가지 방법으로 나타냅니다: 1) 차트와 연관된 워크북의 셀/셀에; 2) 리터럴 값으로."
type: docs
weight: 456
...
pptx 프레젠테이션 문서에 저장될 수 있는 double 값을 두 가지 방법으로 표현합니다: 1) 차트와 관련된 워크북의 셀/셀들에; 2) 리터럴 값으로.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | 차트 데이터 셀을 반환합니다. [IChartDataCell](../ichartdatacell/)을(를) 읽어보세요. |
| **double** [get_AsLiteralDouble](./get_asliteraldouble/)() override | 값을 리터럴 double로 반환합니다. **double**를 읽어보세요. |
...
| [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../basechartvalue/get_datasourcetype/)() override | 파생 클래스에서 AsCell, AsCells, AsLiteralString 또는 AsLiteralDouble 속성이 실제인지 지정합니다. 즉, Data 속성의 값 타입을 지정합니다. [Charts::DataSourceType](../datasourcetype/)을(를) 읽어보세요. |
...
| void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) override | 값을 리터럴 double로 설정합니다. **double**에 씁니다. |
...
| void [set_DataSourceType](../basechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | 파생 클래스에서 AsCell, AsCells, AsLiteralString 또는 AsLiteralDouble 속성이 실제인지 지정합니다. 즉, Data 속성의 값 타입을 지정합니다. [Charts::DataSourceType](../datasourcetype/)에 씁니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 템플릿 인수 n을 약한 포인터(공유가 아니라)로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있습니다. |
...
| **double** [ToDouble](./todouble/)() override | **double** 로 변환합니다. |
...
* 클래스 [IDoubleChartValue](../idoublechartvalue/)
