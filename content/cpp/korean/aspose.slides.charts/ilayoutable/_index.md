...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, 포함 NaN과도 동등하지 않지만, 두 NaN을 동등하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, 포함 NaN과도 동등하지 않지만, 두 NaN을 동등하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual **float** [get_Bottom](./get_bottom/)() | 차트 요소의 상단을 차트 높이의 비율로 가져옵니다. 읽기 전용 **float**. |
...
| virtual **float** [get_Height](./get_height/)() | 차트 요소의 높이를 차트 높이의 비율로 지정합니다. 읽기 **float**. |
...
| virtual **float** [get_Right](./get_right/)() | 차트 요소의 오른쪽을 차트 너비의 비율로 가져옵니다. 읽기 전용 **float**. |
...
| virtual **float** [get_Width](./get_width/)() | 차트 요소의 너비를 차트 너비의 비율로 지정합니다. 읽기 **float**. |
| virtual **float** [get_X](./get_x/)() | 차트 요소의 x 위치(왼쪽)를 차트 너비의 비율로 지정합니다. 읽기 **float**. |
| virtual **float** [get_Y](./get_y/)() | 차트 요소의 상단을 차트 높이의 비율로 지정합니다. 읽기 **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | 차트 요소의 높이를 차트 높이의 비율로 지정합니다. 쓰기 **float**. |
| virtual void [set_Width](./set_width/)(**float**) | 차트 요소의 너비를 차트 너비의 비율로 지정합니다. 쓰기 **float**. |
| virtual void [set_X](./set_x/)(**float**) | 차트 요소의 x 위치(왼쪽)를 차트 너비의 비율로 지정합니다. 쓰기 **float**. |
| virtual void [set_Y](./set_y/)(**float**) | 차트 요소의 상단을 차트 높이의 비율로 지정합니다. 쓰기 **float**. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 구현하여 잠금 해제를 제공합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
