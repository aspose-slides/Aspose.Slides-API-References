...
description: 시리즈의 축 조합이 차트에 현재 존재하는 축 조합과 결합될 수 없을 때 발생하는 예외입니다.
type: docs
weight: 430
url: /ko/aspose.slides.charts/details_axescompositionnotcombinableexception/
---
## Details_AxesCompositionNotCombinableException 클래스


시리즈의 축 조합이 차트에 현재 존재하는 축 조합과 결합될 수 없을 때 발생하는 예외입니다.
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | 객체의 실제 형식을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출과 유사합니다. |
