...
| virtual **float** [get_ActualHeight](../iactuallayout/get_actualheight/)() | 차트 요소의 실제 높이를 지정합니다. 실제 값을 얻으려면 먼저 메서드 [IChart::ValidateChartLayout](../ichart/validatechartlayout/)를 호출하십시오. 읽기 **float**. |
| virtual **float** [get_ActualWidth](../iactuallayout/get_actualwidth/)() | 차트 요소의 실제 너비를 지정합니다. 실제 값을 얻으려면 먼저 메서드 [IChart::ValidateChartLayout](../ichart/validatechartlayout/)를 호출하십시오. 읽기 **float**. |
| virtual **float** [get_ActualX](../iactuallayout/get_actualx/)() | 차트 요소의 실제 x 위치(왼쪽)를 차트의 왼쪽 상단 모서리를 기준으로 지정합니다. 실제 값을 얻으려면 먼저 메서드 [IChart::ValidateChartLayout](../ichart/validatechartlayout/)를 호출하십시오. 읽기 **float**. |
| virtual **float** [get_ActualY](../iactuallayout/get_actualy/)() | 차트 요소의 실제 상단을 차트의 왼쪽 상단 모서리를 기준으로 지정합니다. 실제 값을 얻으려면 먼저 메서드 [IChart::ValidateChartLayout](../ichart/validatechartlayout/)를 호출하십시오. 읽기 **float**. |
| virtual **float** [get_Bottom](../ilayoutable/get_bottom/)() | 차트 요소의 상단을 차트 높이에 대한 비율로 가져옵니다. 읽기 전용 **float**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 플롯 영역의 형식을 반환합니다. 읽기 전용 [IFormat](../iformat/). |
| virtual **float** [get_Height](../ilayoutable/get_height/)() | 차트 요소의 높이를 차트 높이에 대한 비율로 지정합니다. 읽기 **float**. |
| virtual [Aspose::Slides::Charts::LayoutTargetType](../layouttargettype/) [get_LayoutTargetType](./get_layouttargettype/)() | 플롯 영역의 레이아웃이 수동으로 정의된 경우, 이 속성은 플롯 영역을 내부(축 및 축 레이블 제외)로 레이아웃할지 외부(축 및 축 레이블 포함)로 레이아웃할지를 지정합니다. 읽기 [LayoutTargetType](../layouttargettype/). |
...
| virtual **float** [get_Right](../ilayoutable/get_right/)() | 차트 요소의 오른쪽을 차트 너비에 대한 비율로 가져옵니다. 읽기 전용 **float**. |
...
| virtual **float** [get_Width](../ilayoutable/get_width/)() | 차트 요소의 너비를 차트 너비에 대한 비율로 지정합니다. 읽기 **float**. |
| virtual **float** [get_X](../ilayoutable/get_x/)() | 차트 요소의 x 위치(왼쪽)를 차트 너비에 대한 비율로 지정합니다. 읽기 **float**. |
| virtual **float** [get_Y](../ilayoutable/get_y/)() | 차트 요소의 상단을 차트 높이에 대한 비율로 지정합니다. 읽기 **float**. |
...
| virtual void [set_Height](../ilayoutable/set_height/)(**float**) | 차트 요소의 높이를 차트 높이에 대한 비율로 지정합니다. 쓰기 **float**. |
| virtual void [set_LayoutTargetType](./set_layouttargettype/)([Aspose::Slides::Charts::LayoutTargetType](../layouttargettype/)) | 플롯 영역의 레이아웃이 수동으로 정의된 경우, 이 속성은 플롯 영역을 내부(축 및 축 레이블 제외)로 레이아웃할지 외부(축 및 축 레이블 포함)로 레이아웃할지를 지정합니다. 쓰기 [LayoutTargetType](../layouttargettype/). |
| virtual void [set_Width](../ilayoutable/set_width/)(**float**) | 차트 요소의 너비를 차트 너비에 대한 비율로 지정합니다. 쓰기 **float**. |
| virtual void [set_X](../ilayoutable/set_x/)(**float**) | 차트 요소의 x 위치(왼쪽)를 차트 너비에 대한 비율로 지정합니다. 쓰기 **float**. |
| virtual void [set_Y](../ilayoutable/set_y/)(**float**) | 차트 요소의 상단을 차트 높이에 대한 비율로 지정합니다. 쓰기 **float**. |
