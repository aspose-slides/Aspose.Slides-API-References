...
type: docs
weight: 924
url: /ko/aspose.slides.charts/ichartwall/
---
## IChartWall 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도, NaN 포함, 같지 않음에도 불구하고 두 NaN을 동일하게 간주하는 C#-style 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도, NaN 포함, 같지 않음에도 불구하고 두 NaN을 동일하게 간주하는 C#-style 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 벽 채우기, 선, 효과, 3D 스타일을 반환합니다. 읽기 전용 [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | 그림 유형을 반환하거나 설정합니다. 읽기 [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | 플롯 볼륨의 가장 큰 차원의 백분율로 벽 두께를 반환합니다. 읽기 **int32_t**. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | 그림 유형을 반환하거나 설정합니다. 쓰기 [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | 플롯 볼륨의 가장 큰 차원의 백분율로 벽 두께를 설정합니다. 쓰기 **int32_t**. |
