...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, C#-style 부동 소수점 비교를 에뮬레이션하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, C#-style 부동 소수점 비교를 에뮬레이션하여 두 NaN을 동일하게 간주합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 객체의 선, 채우기 및 효과 스타일을 반환합니다. 읽기 전용 [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | 차트 데이터 테이블에 수평 셀 테두리가 있으면 true입니다. 읽기 **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | 차트 데이터 테이블에 외곽선 테두리가 있으면 true입니다. 읽기 **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | 차트 데이터 테이블에 수직 셀 테두리가 있으면 true입니다. 읽기 **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | 데이터 레이블 범례 키가 표시되면 true입니다. 읽기 **bool**. |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | 차트 데이터 테이블에 수평 셀 테두리가 있으면 true입니다. 쓰기 **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | 차트 데이터 테이블에 외곽선 테두리가 있으면 true입니다. 쓰기 **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | 차트 데이터 테이블에 수직 셀 테두리가 있으면 true입니다. 쓰기 **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | 데이터 레이블 범례 키가 표시되면 true입니다. 쓰기 **bool**. |
