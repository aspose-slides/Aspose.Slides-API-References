...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 데이터 포인트 레벨의 서식 속성을 나타냅니다. 읽기 [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | 데이터 포인트 레벨의 데이터 레이블을 나타냅니다. Treemap 및 Sunburst 시리즈 유형에 적용됩니다. 읽기 전용 [IDataLabel](../idatalabel/). |
