...
내장된 [Excel](../../aspose.slides.excel/) 워크북에 대한 액세스를 제공합니다
...
| 메서드 | 설명 |
| --- | --- |
| void [CalculateFormulas](./calculateformulas/)() override | 워크북의 모든 수식을 계산하고 해당 셀 값을 업데이트합니다. |
| void [Clear](./clear/)(**int32_t**) override | 시트의 모든 셀 값을 지웁니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [get_Worksheet](./get_worksheet/)(**int32_t**) override | 지정된 인덱스에 있는 이 워크북의 워크시트를 반환합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheetCollection](../ichartdataworksheetcollection/)\> [get_Worksheets](./get_worksheets/)() override | 워크시트 컬렉션을 가져옵니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)([System::String](../../system/string/), **int32_t**, **int32_t**) override | 차트 시리즈 또는 카테고리에 사용할 수 있는 셀을 가져옵니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**) override | 차트 시리즈 또는 카테고리에 사용할 수 있는 셀을 가져옵니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/)) override | 차트 시리즈 또는 카테고리에 사용할 수 있는 셀을 가져옵니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 차트 시리즈 또는 카테고리에 사용할 수 있는 셀을 가져옵니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 차트 시리즈 또는 카테고리에 사용할 수 있는 셀을 가져옵니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [GetCellCollection](./getcellcollection/)([System::String](../../system/string/), **bool**) override | 셀 집합을 가져옵니다. |
...
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | 참조 기준으로 객체를 비교합니다. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | 참조 기준으로 객체를 비교합니다. |
...
* 클래스 [IChartDataWorkbook](../ichartdataworkbook/)
