...
description: 차트 카테고리 레벨 값들의 관리되는 컨테이너.
type: docs
weight: 612
url: /ko/aspose.slides.charts/ichartcategorylevelsmanager/
---
## IChartCategoryLevelsManager 클래스

차트 카테고리 레벨 값들의 관리되는 컨테이너.
...
| Method | Description |
| --- | --- |
| virtual void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) | 정의된 레벨에 대한 그룹화 항목을 삭제합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | 정의된 레벨에 대한 [IChartDataCell](../ichartdatacell/) 객체를 반환합니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로 아무 것도 복사하지 않으며, 새 객체를 초기화하고 하위 클래스 복사 구성을 가능하게 합니다. |
...
| virtual void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 정의된 레벨에 대한 그룹화 항목을 설정합니다. |
