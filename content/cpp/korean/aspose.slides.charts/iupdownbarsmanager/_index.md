...
description: Line- 또는 Stock 차트의 up/down 막대에 대한 액세스를 제공합니다.
type: docs
weight: 1249
url: /ko/aspose.slides.charts/iupdownbarsmanager/
---
## IUpDownBarsManager 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(포함 NaN) 같지 않지만, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(포함 NaN) 같지 않지만, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | 다운 바의 형식을 반환합니다. 읽기 전용 [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | 갭 너비를 반환합니다. 읽기 **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | 차트에 업/다운 바가 있는지 판단합니다. 읽기 **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | 업 바의 형식을 반환합니다. 읽기 전용 [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | 갭 너비를 설정합니다. **int32_t** 쓰기. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | 차트에 업/다운 바가 있는지 판단합니다. **bool** 쓰기. |
