...
description: 그리드 라인 형식 속성을 나타냅니다.
type: docs
weight: 768
url: /ko/aspose.slides.charts/ichartlinesformat/
---
## IChartLinesFormat 클래스
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() | 차트 라인에 사용되는 효과를 반환합니다. 읽기 전용 [IEffectFormat](../../aspose.slides/ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_Line](./get_line/)() | 차트 라인의 선 스타일 속성을 반환합니다. 읽기 전용 [ILineFormat](../../aspose.slides/ilineformat/). |
