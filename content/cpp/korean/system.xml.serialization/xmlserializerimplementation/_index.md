...
description: XmlSerializer와 함께 사용할 내부 클래스.
type: docs
weight: 79
url: /ko/system.xml.serialization/xmlserializerimplementation/
---
## XmlSerializerImplementation 클래스

Internal 클래스는 [XmlSerializer](../xmlserializer/)와 함께 사용합니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-스타일 부동 소수점 비교를 에뮬레이션합니다. 두 NaN은 IEC 60559:1989에 따라 NaN이 어떤 값과도(NaN 포함) 같지 않음에도 불구하고 동일하게 간주됩니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-스타일 부동 소수점 비교를 에뮬레이션합니다. 두 NaN은 IEC 60559:1989에 따라 NaN이 어떤 값과도(NaN 포함) 같지 않음에도 불구하고 동일하게 간주됩니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 해제하는 구현입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
