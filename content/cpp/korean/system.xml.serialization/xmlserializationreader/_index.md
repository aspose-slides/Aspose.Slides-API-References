...
description: XmlReader 경험을 향상시키는 서비스 클래스.
type: docs
weight: 40
url: /ko/system.xml.serialization/xmlserializationreader/
---
## XmlSerializationReader 클래스

서비스 클래스는 [XmlReader](../../system.xml/xmlreader/) 경험을 향상시킵니다.
...
| void [Initialize](./initialize/)([System::SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>, [System::SharedPtr](../../system/sharedptr/)\<[XmlSerializer](../xmlserializer/)\>) | [XmlSerializationReader](./) 클래스를 초기화합니다. |
