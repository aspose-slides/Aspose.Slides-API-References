...
description: 분자와 분모가 분수선으로 구분되는 분수 객체를 지정합니다. 분수선은 분수 속성에 따라 수평 또는 대각선이 될 수 있습니다. 또한 분수 객체는 분수선 없이 한 요소를 다른 요소 위에 배치하는 스택 함수를 나타내는 데에도 사용됩니다.
type: docs
weight: 274
...
분자와 분모가 분수선으로 구분되는 분수 객체를 지정합니다. 분수선은 분수 속성에 따라 가로나 대각선이 될 수 있습니다. 분수 객체는 또한 분수선 없이 한 요소를 다른 요소 위에 배치하는 스택 함수도 나타내는 데 사용됩니다.
...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | 이 요소 상단에 악센트 기호(문자)를 설정합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](./)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 이 분자와 지정된 분모를 사용하여 분수를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](./)\> [Divide](../imathelement/divide/)([System::String](../../system/string/)) | 이 분자와 지정된 분모를 사용하여 분수를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](./)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | 이 분자와 지정된 분모를 사용하여 지정된 유형의 분수를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](./)\> [Divide](../imathelement/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) | 이 분자와 지정된 분모를 사용하여 지정된 유형의 분수를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | 수학 요소를 괄호로 감쌉니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | 이 요소를 괄호 또는 다른 문자와 같은 지정된 문자로 감쌉니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Denominator](./get_denominator/)() | 분모 |
| virtual [MathFractionTypes](../mathfractiontypes/) [get_FractionType](./get_fractiontype/)() | 분수 유형 기본값: Bar |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Numerator](./get_numerator/)() | 분자 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | 하단 중괄호 또는 다른 구분 문자를 사용하여 이 요소를 그룹에 배치합니다. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드와 유사합니다. 사용자 정의 유형 클론을 활성화합니다. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자. 실제로 아무 것도 복사하지 않고 새 객체를 초기화하며 서브클래스 복사 구성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로 아무 것도 복사하지 않고 새 객체를 초기화하며 서브클래스 복사 구성을 가능하게 합니다. |
...
| virtual void [set_FractionType](./set_fractiontype/)([MathFractionTypes](../mathfractiontypes/)) | 분수 유형 기본값: Bar |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 이 요소를 비시각적 박스(논리적 그룹화)에 배치합니다. 이 박스는 방정식의 구성 요소나 다른 수학 텍스트 인스턴스를 그룹화하는 데 사용됩니다. 예를 들어, 박스 객체는 정렬점이 있거나 없는 연산자 에뮬레이터 역할을 하거나, 줄바꿈 지점으로 사용되거나, 내부에 줄바꿈이 허용되지 않도록 그룹화될 수 있습니다. |
