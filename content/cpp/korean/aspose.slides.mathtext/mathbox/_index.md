...
description: 수학 요소의 논리적 박싱(패키징)을 지정합니다. 예를 들어, 박스된 객체는 정렬 지점이 있거나 없을 수 있는 연산자 에뮬레이터 역할을 하거나, 줄 바꿈 지점으로 작동하거나, 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. 예를 들어, \"==\" 연산자는 줄 바꿈을 방지하기 위해 박스되어야 합니다.
type: docs
weight: 742
...
| 메서드 | 설명 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | 이 요소의 위에 있는 문자(액센트 표시)를 설정합니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 이 인스턴스를 인수로 사용하고 지정된 추가 인수를 함께 사용하여 지정된 함수를 호출합니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | 이 인스턴스를 인수로 사용하고 지정된 추가 인수를 함께 사용하여 지정된 함수를 호출합니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | 수학 요소를 괄호와 같은 지정된 문자 또는 다른 문자로 프레임화하여 감쌉니다 |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) 의미를 사용하여 객체를 비교합니다. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# 스타일로 참조 형식 객체를 비교합니다. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# 스타일로 값 형식 객체를 비교합니다. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, 포함 NaN과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, 포함 NaN과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다. |
...
| **bool** [get_AlignmentPoint](./get_alignmentpoint/)() override | true인 경우, 이 연산자 에뮬레이터는 정렬 지점으로 작동합니다. 즉, 다른 방정식에 지정된 정렬 지점과 정렬될 수 있습니다. 기본값: false |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() override | 기본 인수 |
| **bool** [get_Differential](./get_differential/)() override | true인 경우, 박스는 미분(예: 적분식에서 \uD835\uDC51\uD835\uDC65) 역할을 하며 수학적 미분에 적절한 수평 간격을 받습니다. 기본값: false |
| **uint8_t** [get_ExplicitBreak](./get_explicitbreak/)() override | 명시적 줄 바꿈은 Box 객체 시작 부분에 줄 바꿈이 있는지 지정합니다. 줄이 박스 객체 시작 부분에서 자동으로 넘겨집니다. 또한 이전 수식 텍스트 줄에 있는 연산자 번호를 현재 줄의 정렬 지점으로 사용할지 지정합니다. 가능한 값: 1..255 기본값: 0 (명시적 줄 바꿈 없음) |
| **bool** [get_NoBreak](./get_nobreak/)() override | No break는 객체 박스의 "깨지지 않음" 속성을 지정합니다. true인 경우 박스 내부에서 줄 바꿈이 발생하지 않습니다. 이는 둘 이상의 이진 연산자로 구성된 연산자 에뮬레이터에 중요할 수 있습니다. 이 요소가 지정되지 않으면 박스 내부에서 줄 바꿈이 발생할 수 있습니다. 기본값: true |
| **bool** [get_OperatorEmulator](./get_operatoremulator/)() override | Operator Emulator. true인 경우, 박스와 그 내용이 단일 연산자로 동작하며 연산자의 속성을 상속합니다. 즉, 예를 들어 이 문자를 줄 바꿈 지점으로 사용할 수 있고 다른 연산자와 정렬될 수 있습니다. Operator Emulator는 '=='와 같이 하나 이상의 글리프가 결합해 연산자를 형성할 때 자주 사용됩니다. 기본값: false |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../mathelementbase/integral/)([MathIntegralTypes](../mathintegraltypes/)) override | 적분을 수행합니다 (제한 없이) |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../mathelementbase/join/)([System::String](../../system/string/)) override | 수학 요소를 결합하여 수학 블록을 형성합니다 |
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현하여 잠금을 수행합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
|  [MathBox](./mathbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | [MathBox](./)를 지정된 요소를 인수로 하여 초기화합니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../mathelementbase/overbar/)() override | 이 요소의 위에 막대를 설정합니다 |
...
| void [set_AlignmentPoint](./set_alignmentpoint/)(**bool**) override | true인 경우, 이 연산자 에뮬레이터는 정렬 지점으로 작동합니다. 즉, 다른 방정식에 지정된 정렬 지점과 정렬될 수 있습니다. 기본값: false |
| void [set_Differential](./set_differential/)(**bool**) override | true인 경우, 박스는 미분(예: 적분식에서 \uD835\uDC51\uD835\uDC65) 역할을 하며 수학적 미분에 적절한 수평 간격을 받습니다. 기본값: false |
| void [set_ExplicitBreak](./set_explicitbreak/)(**uint8_t**) override | 명시적 줄 바꿈은 Box 객체 시작 부분에 줄 바꿈이 있는지 지정합니다. 줄이 박스 객체 시작 부분에서 자동으로 넘겨집니다. 또한 이전 수식 텍스트 줄에 있는 연산자 번호를 현재 줄의 정렬 지점으로 사용할지 지정합니다. 가능한 값: 1..255 기본값: 0 (명시적 줄 바꿈 없음) |
| void [set_NoBreak](./set_nobreak/)(**bool**) override | No break는 객체 박스의 "깨지지 않음" 속성을 지정합니다. true인 경우 박스 내부에서 줄 바꿈이 발생하지 않습니다. 이는 둘 이상의 이진 연산자로 구성된 연산자 에뮬레이터에 중요할 수 있습니다. 이 요소가 지정되지 않으면 박스 내부에서 줄 바꿈이 발생할 수 있습니다. 기본값: true |
| void [set_OperatorEmulator](./set_operatoremulator/)(**bool**) override | Operator Emulator. true인 경우, 박스와 그 내용이 단일 연산자로 동작하며 연산자의 속성을 상속합니다. 즉, 예를 들어 이 문자를 줄 바꿈 지점으로 사용할 수 있고 다른 연산자와 정렬될 수 있습니다. Operator Emulator는 '=='와 같이 하나 이상의 글리프가 결합해 연산자를 형성할 때 자주 사용됩니다. 기본값: false |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../mathelementbase/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 낮은 한계를 설정합니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../mathelementbase/setlowerlimit/)([System::String](../../system/string/)) override | 낮은 한계를 설정합니다 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th 템플릿 인수를 약한 포인터로 설정합니다(공유 대신). 컨테이너에서 포인터를 약한 모드로 전환할 수 있습니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | 이 요소를 시각적이지 않은 박스(논리적 그룹) 안에 배치합니다. 이는 방정식이나 기타 수식 텍스트의 구성 요소를 그룹화하는 데 사용됩니다. 박스된 객체는 (예를 들어) 정렬 지점이 있든 없든 연산자 에뮬레이터 역할을 할 수 있으며, 줄 바꿈 지점이 되거나 줄 바꿈을 허용하지 않는 방식으로 그룹화될 수 있습니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../mathelementbase/underbar/)() override | 이 요소의 아래에 막대를 설정합니다 |
