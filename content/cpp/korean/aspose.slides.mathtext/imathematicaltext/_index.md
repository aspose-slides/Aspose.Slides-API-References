...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | 이 요소의 상단에 있는 문자(억양 표시)를 설정합니다 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | 괄호와 같은 지정된 문자 또는 다른 문자로 이 요소를 둘러싸서 프레임을 만듭니다 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\> [get_Format](./get_format/)() | 텍스트 서식 속성 |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | 텍스트 값 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | 하단 중괄호와 같은 그룹화 문자 또는 다른 문자를 사용하여 이 요소를 그룹에 배치합니다 |
...
| virtual void [set_Value](./set_value/)([System::String](../../system/string/)) | 텍스트 값 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 이 요소를 비시각 박스(논리적 그룹) 안에 배치합니다. 이는 방정식이나 다른 수학 텍스트의 구성 요소를 그룹화하는 데 사용됩니다. 박스 객체는 (예를 들어) 정렬 지점이 있거나 없는 연산자 에뮬레이터, 줄 바꿈 지점 역할을 하거나, 내부 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다 |
