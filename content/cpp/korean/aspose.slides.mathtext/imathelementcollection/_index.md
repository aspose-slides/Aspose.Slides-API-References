...
description: 수학 요소 (MathElement)의 컬렉션을 나타냅니다.
type: docs
weight: 235
url: /ko/aspose.slides.mathtext/imathelementcollection/
---
## IMathElementCollection 클래스
...
| 메서드 | 설명 |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 수학 요소를 컬렉션의 끝에 추가합니다. |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 컬렉션에 특정 값이 포함되어 있는지 판단합니다. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>, **int32_t**) | 지정된 배열에 복사합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [idx_get](./idx_get/)(**int32_t**) | 지정된 인덱스의 요소를 가져옵니다. 읽기 전용 [IMathElement](../imathelement/). |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 컬렉션에서 특정 수학 요소의 인덱스를 결정합니다. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 지정된 인덱스에 수학 요소를 컬렉션에 삽입합니다. |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | 시퀀스에 대해 누산기 함수를 적용합니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 경비 객체를 사용하세요. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로는 아무것도 복사하지 않고, 새 객체를 초기화하고 하위 클래스 복사를 가능하게 합니다. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 컬렉션에서 특정 객체의 첫 번째 발생을 제거합니다. |
