...
| 메서드 | 설명 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | 이 요소의 위에 표시되는 억양 기호(문자)를 설정합니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) override | 이 분자와 지정된 분모를 사용해 지정된 유형의 분수를 생성합니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) override | 이 분자와 지정된 분모를 사용해 지정된 유형의 분수를 생성합니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)() override | 수학 요소를 괄호로 묶습니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | 수학 요소를 괄호와 같은 지정된 문자 또는 다른 문자로 프레임을 만들어 묶습니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) override | 배열의 지정된 인덱스에 있는 항목을 반환합니다. 읽기 전용 [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() override | 배열의 항목 집합 |
| [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() override | 배열을 주변 텍스트에 상대적으로 정렬을 지정합니다. 배열 외부의 텍스트는 배열 객체의 아래쪽, 위쪽 또는 중앙에 맞출 수 있습니다. 기본값: Center |
| **bool** [get_MaximumDistribution](./get_maximumdistribution/)() override | Maximum Distribution이 true이면, 배열이 포함 요소(페이지, 열, 셀 등)의 최대 너비에 맞게 배치됩니다. |
| **bool** [get_ObjectDistribution](./get_objectdistribution/)() override | Object Distribution이 true이면, 배열 내용이 배열 객체의 최대 너비에 맞게 배치됩니다. |
| **uint32_t** [get_RowSpacing](./get_rowspacing/)() override | 배열 행 사이의 간격입니다. RowSpacingRule이 3으로 설정된 경우에만 사용되며, 이 경우 측정 단위는 포인트이며, Multiple인 경우 측정 단위는 반줄입니다. 기본값: 0 |
| [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() override | 배열 요소 사이의 수직 간격 유형입니다. 기본값: SingleLineGap |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)() override | 이 요소를 아래 중괄호를 사용해 그룹에 배치합니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | 이 요소를 아래 중괄호와 같은 그룹 문자 또는 다른 문자로 그룹에 배치합니다 |
...
|  [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 수학 배열을 생성하고 지정된 요소를 그 안에 배치합니다 |
|  [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>\>) | 수학 배열을 생성하고 지정된 요소들을 그 안에 배치합니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 지정된 인수로부터 주어진 차수의 수학적 제곱근을 지정합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | 지정된 인수로부터 주어진 차수의 수학적 제곱근을 지정합니다. |
...
| void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) override | 배열을 주변 텍스트에 상대적으로 정렬을 지정합니다. 배열 외부의 텍스트는 배열 객체의 아래쪽, 위쪽 또는 중앙에 맞출 수 있습니다. 기본값: Center |
| void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) override | Maximum Distribution이 true이면, 배열이 포함 요소(페이지, 열, 셀 등)의 최대 너비에 맞게 배치됩니다. |
| void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) override | Object Distribution이 true이면, 배열 내용이 배열 객체의 최대 너비에 맞게 배치됩니다. |
| void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) override | 배열 행 사이의 간격입니다. RowSpacingRule이 3으로 설정된 경우에만 사용되며, 이 경우 측정 단위는 포인트이며, Multiple인 경우 측정 단위는 반줄입니다. 기본값: 0 |
| void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) override | 배열 요소 사이의 수직 간격 유형입니다. 기본값: SingleLineGap |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | 이 요소를 비시각적 박스(논리적 그룹화)에 배치합니다. 이 박스는 방정식이나 기타 수학 텍스트 구성요소를 그룹화하는 데 사용됩니다. 박스된 객체는 예를 들어 정렬 지점이 있든 없든 연산자 에뮬레이터로 사용할 수 있으며, 줄 바꿈 지점으로 사용하거나 내부 줄 바꿈을 허용하지 않도록 그룹화할 수 있습니다. |
