...
description: "베이스와 결합 부호를 포함하는 억음 기능을 지정합니다. 예: \\uD835\\uDC4E\\u0301"
type: docs
weight: 27
...
베이스와 결합 부호를 포함하는 억음 기능을 지정합니다. 예: \\uD835\\uDC4E\\u0301
...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](./)\> [Accent](../imathelement/accent/)(char16_t) | 이 요소 위에 억음 표시(문자)를 설정합니다 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | 괄호와 같은 지정된 문자 또는 다른 문자를 사용하여 이 요소를 둘러쌉니다 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | 억음이 적용된 인수입니다 |
| virtual char16_t [get_Character](./get_character/)() | 억음 문자. 값은 (U+0300\\u2013U+036F) 또는 (U+20D0\\u2013U+20EF) 범위에 있어야 합니다. 기본값: 결합형 서캐럼 억음 (U+0302) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | 아래 중괄호와 같은 그룹화 문자를 사용하거나 다른 문자를 사용하여 이 요소를 그룹에 배치합니다 |
...
| virtual void [set_Character](./set_character/)(char16_t) | 억음 문자. 값은 (U+0300\\u2013U+036F) 또는 (U+20D0\\u2013U+20EF) 범위에 있어야 합니다. 기본값: 결합형 서캐럼 억음 (U+0302) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 이 요소를 눈에 보이지 않는 박스(논리적 그룹화)에 배치합니다. 이는 방정식 구성 요소나 기타 수학 텍스트 인스턴스를 그룹화하는 데 사용됩니다. 박스 객체는 (예를 들어) 정렬점이 있거나 없을 수 있는 연산자 에뮬레이터 역할을 하거나, 줄 바꿈 지점으로 작동하거나, 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
