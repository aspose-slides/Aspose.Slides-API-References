...
| 메서드 | 설명 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathMatrix](../imathmatrix/)\> [CreateMathMatrix](./createmathmatrix/)(**int32_t**, **int32_t**) override | 수학 행렬을 생성합니다 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType이 지정한 타입의 인스턴스를 나타내는지 확인합니다. C# 'is' 연산자와 유사합니다. |
...
* 클래스 [IMathMatrixFactory](../imathmatrixfactory/)
