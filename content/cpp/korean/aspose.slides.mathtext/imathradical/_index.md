...
description: 기본과 선택적인 차수로 구성된 근함수를 지정합니다. 근 객체의 예는 \u221A\uD835\uDC65 입니다.
type: docs
weight: 508
...
기본과 선택적인 차수로 구성된 근함수를 지정합니다. 근 객체의 예는 \\u221A\\uD835\\uDC65 입니다.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | 이 요소 상단에 있는 문자(악센트 표시)를 설정합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 이 분자를 사용하고 지정된 분모로 분수를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::String](../../system/string/)) | 이 분자를 사용하고 지정된 분모로 분수를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | 이 분자를 사용하고 지정된 분모와 지정된 유형의 분수를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) | 이 분자를 사용하고 지정된 분모와 지정된 유형의 분수를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | 수학 요소를 괄호로 감쌉니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | 이 요소를 괄호와 같은 지정된 문자 또는 다른 문자로 둘러쌉니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() | 차수 인수 |
| virtual **bool** [get_HideDegree](./get_hidedegree/)() | true일 경우 차수를 숨깁니다. 차수가 표시되지 않으며, 예: \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../imathelement/overbar/)() | 이 요소 상단에 바를 설정합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 주어진 차수와 지정된 인수로 수학적인 루트를 지정합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | 주어진 차수와 지정된 인수로 수학적인 루트를 지정합니다. |
...
| virtual void [set_HideDegree](./set_hidedegree/)(**bool**) | true일 경우 차수를 숨깁니다. 차수가 표시되지 않으며, 예: \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)() | 이 요소를 테두리 상자에 배치합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | 이 요소를 테두리 상자에 배치합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 이 요소를 비시각적 박스(논리적 그룹)에 배치합니다. 이는 방정식 또는 다른 수학 텍스트 인스턴스의 구성 요소를 그룹화하는 데 사용됩니다. 박스 객체는 예를 들어 정렬점이 있거나 없거나 연산자 에뮬레이터, 줄 바꿈 지점, 혹은 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../imathelement/underbar/)() | 이 요소 하단에 바를 설정합니다. |
