...
description: "베이스와 결합 부호(다이아크리틱 마크)로 구성된 악센트 기능을 지정합니다. 예: \\uD835\\uDC4E\\u0301"
type: docs
weight: 612
...
베이스와 결합 부호(다이아크리틱) 마크로 구성된 악센트 기능을 지정합니다. 예: \\uD835\\uDC4E\\u0301
...
| 메서드 | 설명 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | 이 요소의 위에 있는 문자(액센트 마크)를 설정합니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | 수학 요소를 괄호나 다른 지정된 문자로 둘러싸서 프레임을 만듭니다 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 이 인스턴스를 함수 이름으로 사용하여 인수 함수를 취합니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::String](../../system/string/)) override | 이 인스턴스를 함수 이름으로 사용하여 인수 함수를 취합니다 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() override | 악센트가 적용된 인수 |
| char16_t [get_Character](./get_character/)() override | 악센트 문자 값은 (U+0300\\u2013U+036F) 또는 (U+20D0\\u2013U+20EF) 범위 내에 있어야 합니다. 기본값: 결합형 서키프 악센트 (U+0302) |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | 아래 중괄호나 다른 그룹화 문자를 사용하여 이 요소를 그룹에 배치합니다 |
...
|  [MathAccent](./mathaccent/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 기본 악센트 문자 값을 사용하여 지정된 수학 요소에 수학 악센트를 생성합니다 |
|  [MathAccent](./mathaccent/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, char16_t) | 지정된 수학 요소에 수학 악센트를 생성합니다 |
...
| void [set_Character](./set_character/)(char16_t) override | 악센트 문자 값은 (U+0300\\u2013U+036F) 또는 (U+20D0\\u2013U+20EF) 범위 내에 있어야 합니다. 기본값: 결합형 서키프 악센트 (U+0302) |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | 이 요소를 비시각적 상자(논리적 그룹) 안에 배치합니다. 이 상자는 방정식 구성 요소나 기타 수학 텍스트 인스턴스를 그룹화하는 데 사용됩니다. 예를 들어, 정렬점이 있거나 없는 연산자 에뮬레이터, 줄 바꿈 지점으로 작동하거나, 내부 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
