...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | 지정된 유형의 분자를 사용하고 지정된 분모와 함께 분수를 만듭니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) | 지정된 유형의 분자를 사용하고 지정된 분모와 함께 분수를 만듭니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | 수학 요소를 괄호로 감쌉니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | 이 요소를 괄호 또는 다른 문자와 같이 지정된 문자로 둘러쌉니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) | 배열의 지정된 인덱스에 있는 항목을 반환합니다. 읽기 전용 [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() | 배열의 항목 집합 |
| virtual [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() | 배열을 주변 텍스트와 정렬 방식을 지정합니다. 배열 외부 텍스트는 배열 객체의 하단, 상단 또는 중앙에 맞출 수 있습니다. 기본값: 중앙 |
| virtual **bool** [get_MaximumDistribution](./get_maximumdistribution/)() | Maximum Distribution이 true이면, 배열이 포함 요소(페이지, 열, 셀 등)의 최대 너비에 맞게 간격을 맞춥니다. |
| virtual **bool** [get_ObjectDistribution](./get_objectdistribution/)() | Object Distribution이 true이면, 배열 내용이 배열 객체의 최대 너비에 맞게 간격을 맞춥니다. |
| virtual **uint32_t** [get_RowSpacing](./get_rowspacing/)() | 배열 행 사이의 간격입니다. RowSpacingRule이 3으로 설정된 경우에만 사용되며, 이 경우 측정 단위는 포인트이며 Multiple인 경우 반줄입니다. 기본값: 0 |
| virtual [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() | 배열 요소 사이의 수직 간격 유형 |
...
| virtual void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) | 배열을 주변 텍스트와 정렬 방식을 지정합니다. 배열 외부 텍스트는 배열 객체의 하단, 상단 또는 중앙에 맞출 수 있습니다. 기본값: 중앙 |
| virtual void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) | Maximum Distribution이 true이면, 배열이 포함 요소(페이지, 열, 셀 등)의 최대 너비에 맞게 간격을 맞춥니다. |
| virtual void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) | Object Distribution이 true이면, 배열 내용이 배열 객체의 최대 너비에 맞게 간격을 맞춥니다. |
| virtual void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) | 배열 행 사이의 간격입니다. RowSpacingRule이 3으로 설정된 경우에만 사용되며, 이 경우 측정 단위는 포인트이며 Multiple인 경우 반줄입니다. 기본값: 0 |
| virtual void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) | 배열 요소 사이의 수직 간격 유형 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 하한값을 사용합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::String](../../system/string/)) | 하한값을 사용합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 상한값을 사용합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::String](../../system/string/)) | 상한값을 사용합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 이 요소를 비시각적 상자(논리적 그룹) 안에 배치합니다. 이는 방정식 또는 기타 수학 텍스트의 구성 요소를 그룹화하는 데 사용됩니다. 예를 들어, 상자 객체는 정렬점을 갖거나 갖지 않는 연산자 에뮬레이터, 줄 바꿈 지점으로 사용할 수 있거나, 내부 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](./)\> [ToMathArray](../imathelement/tomatharray/)() | 수직 배열에 넣습니다. |
