...
description: 저장 중 객체가 어떻게 처리되어야 하는지를 결정하기 위해 사용되는 콜백 인터페이스입니다.
type: docs
weight: 248
...
객체가 저장되는 동안 어떻게 처리되어야 하는지를 결정하기 위해 사용되는 콜백 인터페이스입니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 동일하게 간주되는 C#-style 부동 소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 NaN을 포함한 어떠한 값과도 같지 않지만, 여기서는 두 NaN을 같다고 취급합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 동일하게 간주되는 C#-style 부동 소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 NaN을 포함한 어떠한 값과도 같지 않지만, 여기서는 두 NaN을 같다고 취급합니다. |
...
| virtual [LinkEmbedDecision](../linkembeddecision/) [GetObjectStoringLocation](./getobjectstoringlocation/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | 객체가 저장되어야 할 위치를 결정합니다. 이 메서드는 각 객체 ID마다 한 번씩 호출됩니다. 동일한 data, semanticName 및 contentType을 가지고 다른 ID를 갖는 두 객체가 존재하지 않을 것이라는 보장은 없습니다. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 객체의 실제 타입을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출과 유사합니다. |
| virtual [System::String](../../system/string/) [GetUrl](./geturl/)(**int32_t**, **int32_t**) | 외부 객체에 대한 URL을 반환합니다. 이 메서드는 [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/)이 [LinkEmbedDecision::Link](../linkembeddecision/)를 반환했을 때 항상 호출되며, [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/)이 [LinkEmbedDecision::Embed](../linkembeddecision/)를 반환했지만 임베딩이 불가능한 경우에도 호출될 수 있습니다. 동일한 객체 ID에 대해 여러 번 호출될 수 있습니다. |
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 외부 객체를 저장합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 약한 포인터(공유 포인터 대신)로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있게 합니다. |
