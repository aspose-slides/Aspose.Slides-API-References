...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 IEC 60559:1989 표준에 따라 어떤 값(NaN 포함)과도 같지 않음에도 불구하고 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 IEC 60559:1989 표준에 따라 어떤 값(NaN 포함)과도 같지 않음에도 불구하고 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual **bool** [get_HideInk](./get_hideink/)() | [Ink](../../aspose.slides.ink/) 요소를 내보낸 문서에서 표시하거나 숨깁니다. |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | 브러시 렌더링에 ROP 연산 또는 불투명도를 사용합니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자입니다. 실제로 아무 것도 복사하지 않으며, 새로운 객체를 초기화하고 하위 클래스의 복사 생성을 가능하게 합니다. |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | [Ink](../../aspose.slides.ink/) 요소를 내보낸 문서에서 표시하거나 숨깁니다. |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | 브러시 렌더링에 ROP 연산 또는 불투명도를 사용합니다. |
