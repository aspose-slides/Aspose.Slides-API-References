...
description: 슬라이드 이미지가 비트톤 이미지로 변환되는 방식을 제어하는 옵션을 제공합니다.
type: docs
weight: 820
...
슬라이드 이미지가 비트톤 이미지로 변환되는 방식을 제어하는 옵션을 제공합니다.
...
| 이름 | 값 | 설명 |
| --- | --- | --- |
| Default | 0 | 변환 알고리즘을 지정하지 않습니다. TIFF 코덱에 구현된 알고리즘이 사용됩니다. (Default) |
