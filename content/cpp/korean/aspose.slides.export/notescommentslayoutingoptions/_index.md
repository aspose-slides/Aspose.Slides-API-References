...
| [System::Drawing::Color](../../system.drawing/color/) [get_CommentsAreaColor](./get_commentsareacolor/)() | 주석 영역의 색상을 가져옵니다 (주석이 오른쪽에 표시되는 경우에만 적용됩니다). |
| **int32_t** [get_CommentsAreaWidth](./get_commentsareawidth/)() | 주석 출력 영역의 너비를 픽셀 단위로 가져옵니다 (주석이 오른쪽에 표시되는 경우에만 적용됩니다). |
| [CommentsPositions](../commentspositions/) [get_CommentsPosition](./get_commentsposition/)() | 페이지에서 주석의 위치를 가져옵니다. |
| [NotesPositions](../notespositions/) [get_NotesPosition](./get_notesposition/)() | 페이지에서 노트의 위치를 가져옵니다. |
| **bool** [get_ShowCommentsByNoAuthor](./get_showcommentsbynoauthor/)() | 작성자가 없는 주석의 표시 여부를 가져옵니다. true이면 주석이 표시됩니다 (주석이 표시되는 경우에만 적용됩니다). |
...
| void [set_CommentsAreaColor](./set_commentsareacolor/)([System::Drawing::Color](../../system.drawing/color/)) | 주석 영역의 색상을 설정합니다 (주석이 오른쪽에 표시되는 경우에만 적용됩니다). |
| void [set_CommentsAreaWidth](./set_commentsareawidth/)(**int32_t**) | 주석 출력 영역의 너비를 픽셀 단위로 설정합니다 (주석이 오른쪽에 표시되는 경우에만 적용됩니다). |
| void [set_CommentsPosition](./set_commentsposition/)([CommentsPositions](../commentspositions/)) | 페이지에서 주석의 위치를 설정합니다. |
| void [set_NotesPosition](./set_notesposition/)([NotesPositions](../notespositions/)) | 페이지에서 노트의 위치를 설정합니다. |
| void [set_ShowCommentsByNoAuthor](./set_showcommentsbynoauthor/)(**bool**) | 작성자가 없는 주석의 표시 여부를 설정합니다. true이면 주석이 표시됩니다 (주석이 표시되는 경우에만 적용됩니다). |
