...
description: SVG 텍스트 부분(\"tspan\")에 대한 옵션을 나타냅니다.
type: docs
weight: 729
...
| [System::String](../../system/string/) [get_Id](./get_id/)() override | "tspan" 요소 id를 가져옵니다 |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현하여 잠그기를 수행합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
...
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | "tspan" 요소 id를 가져옵니다 |
