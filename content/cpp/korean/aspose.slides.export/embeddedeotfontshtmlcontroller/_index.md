...
description: EOT 형식으로 글꼴을 포함하기 위해 사용하는 서식 컨트롤러 클래스
type: docs
weight: 14
...
EOT 형식으로 글꼴을 포함하기 위해 사용할 수 있는 서식 컨트롤러 클래스
...
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | 새 인스턴스를 생성합니다. |
...
* 클래스 [IEmbeddedEotFontsHtmlController](../iembeddedeotfontshtmlcontroller/)
