...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만, 두 NaN이 동일하게 여겨지는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만, 두 NaN이 동일하게 여겨지는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
...
|  [ResponsiveHtmlController](./responsivehtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | 새 인스턴스를 생성합니다. |
...
* 클래스 [IResponsiveHtmlController](../iresponsivehtmlcontroller/)
