...
description: 애니메이션의 플레이어를 나타냅니다.
type: docs
weight: 313
url: /ko/aspose.slides.export/ipresentationanimationplayer/
---
## IPresentationAnimationPlayer 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual ASPOSE_SLIDES_LOCAL_API **double** [get_Duration](./get_duration/)() | 애니메이션 지속 시간을 [ms]로 가져옵니다 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연관된 참조 카운터 데이터 구조를 가져옵니다. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | [IPresentationAnimationPlayer::SetTimePosition](./settimeposition/) 메서드로 이전에 설정한 현재 시간 위치에 대한 프레임을 가져옵니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자. 실제로 아무 것도 복사하지 않고, 새로운 객체를 초기화하고 하위 클래스 복사를 가능하게 합니다. |
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | [IPresentationAnimationPlayer::get_Duration](./get_duration/) 내에서 애니메이션 시간 위치를 설정합니다. |
...
애니메이션은 [PresentationAnimationsGenerator](../presentationanimationsgenerator/)가 **PresentationAnimationsGenerator::NewAnimation** 이벤트를 통해 생성합니다.
