...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 IEC 60559:1989에 따라 어떤 값과도, 포함 NaN과도 같지 않음에도 불구하고 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 IEC 60559:1989에 따라 어떤 값과도, 포함 NaN과도 같지 않음에도 불구하고 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
