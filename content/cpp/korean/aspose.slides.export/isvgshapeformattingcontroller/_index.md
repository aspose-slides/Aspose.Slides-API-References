...
---
## ISvgShapeFormattingController 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일 부동소수점 비교를 모방합니다. 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 같은 것으로 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일 부동소수점 비교를 모방합니다. 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 같은 것으로 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용. |
| virtual void [FormatShape](./formatshape/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgShape](../isvgshape/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | 이 함수는 모양을 SVG로 렌더링하기 전에 호출되어 사용자가 결과 SVG를 제어할 수 있도록 합니다. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nth 템플릿 인수를 약한 포인터(공유가 아니라)로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
