...
description: 유효 채우기 형식의 읽기 전용 컬렉션을 나타내는 불변 객체입니다.
type: docs
weight: 261
url: /ko/aspose.slides.theme/ifillformatcollectioneffectivedata/
---
## IFillFormatCollectionEffectiveData 클래스

읽기 전용 유효 채우기 형식 컬렉션을 나타내는 불변 객체입니다.
...
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | 컬렉션 접근이 동기화(쓰레드 안전) 여부를 나타내는 값을 반환합니다. 읽기 전용 **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | 지정된 인덱스에 있는 요소를 가져옵니다. 읽기 전용 [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
