...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일 부동소수점 비교를 에뮬레이트합니다. 여기서는 IEC 60559:1989에 따라 NaN이 어떤 값과도(NAN 포함) 같지 않음에도 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일 부동소수점 비교를 에뮬레이트합니다. 여기서는 IEC 60559:1989에 따라 NaN이 어떤 값과도(NAN 포함) 같지 않음에도 두 NaN을 동일하게 간주합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\> [idx_get](./idx_get/)(**int32_t**) | 지정된 위치의 요소를 반환합니다. 읽기 전용 [IEffectStyle](../ieffectstyle/). |
...
| void [Lock](../../system/object/lock/)() | C# lock() 구문의 잠금 동작을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
