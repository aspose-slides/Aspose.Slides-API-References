...
description: 다양한 종류의 재정의된 테마에 대한 액세스를 제공합니다.
type: docs
weight: 417
url: /ko/aspose.slides.theme/ioverridethememanager/
---
## IOverrideThemeManager 클래스
...
| 메서드 | 설명 |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | 슬라이드에 추가 색상 스키마를 적용합니다. |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | [OverrideTheme](../overridetheme/)가 상속된 유효 테마를 재정의하는지 여부를 판단합니다. 재정의를 위해 [OverrideTheme](../overridetheme/)를 활성화하려면 OverrideTheme.Init*() 메서드를 사용하십시오. [OverrideTheme](../overridetheme/)의 재정의를 비활성화하려면 [get_OverrideTheme()](./get_overridetheme/)->Clear() 메서드를 사용하십시오. 읽기 전용 **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | 재정의된 테마 객체를 반환합니다. 읽기 [IOverrideTheme](../ioverridetheme/). |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | 재정의된 테마 객체를 반환합니다. 쓰기 [IOverrideTheme](../ioverridetheme/). |
