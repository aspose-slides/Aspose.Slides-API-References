...
description: 레이아웃 슬라이드 테마 재정의를 위한 접근을 제공합니다.
type: docs
weight: 482
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/)가 상속된 효과적인 테마를 덮어쓰는지 여부를 결정합니다. 덮어쓰기를 위해 [OverrideTheme](../overridetheme/)를 활성화하려면 OverrideTheme.Init*() 메서드를 사용하십시오. [OverrideTheme](../overridetheme/)의 덮어쓰기를 비활성화하려면 [OverrideTheme::Clear](../overridetheme/clear/) 메서드를 사용하십시오. 읽기 전용 **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | 덮어쓰기 테마 객체를 반환합니다. 읽기 [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | 덮어쓰기 테마 객체를 반환합니다. 쓰기 [IOverrideTheme](../ioverridetheme/). |
