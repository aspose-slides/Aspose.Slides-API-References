...
| 메서드 | 설명 |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | 슬라이드에 추가 색 구성표를 적용합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | 테마 객체를 반환합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 동일하지 않지만, 두 NaN을 동일하게 간주하는 C#-style 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 동일하지 않지만, 두 NaN을 동일하게 간주하는 C#-style 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | [OverrideTheme](../overridetheme/)가 상속된 효과적인 테마 (Presentation.MasterTheme)를 재정의하는지 여부를 결정합니다. 읽기 **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() | 재정의된 테마 객체를 반환합니다. 읽기 [IMasterTheme](../imastertheme/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로 아무 것도 복사하지 않고, 새로운 객체를 초기화하고 하위 클래스의 복사 생성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자입니다. 실제로 아무 것도 복사하지 않고, 새로운 객체를 초기화하고 하위 클래스의 복사 생성을 가능하게 합니다. |
...
| virtual void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) | [OverrideTheme](../overridetheme/)가 상속된 효과적인 테마 (Presentation.MasterTheme)를 재정의하는지 여부를 결정합니다. 쓰기 **bool**. |
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) | 재정의된 테마 객체를 반환합니다. 쓰기 [IMasterTheme](../imastertheme/). |
...
* 클래스 [IThemeManager](../ithememanager/)
