...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | 지정된 인덱스에 있는 추가 색 구성표를 반환합니다. 이 구성표는 프레젠테이션의 모양에 영향을 주지 않으며 슬라이드의 주요 색 구성표로 선택될 수 있습니다. 읽기 전용 [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | 추가 색 구성표 컬렉션을 반환합니다. 이 구성표들은 프레젠테이션의 모양에 영향을 주지 않으며 슬라이드의 주요 색 구성표로 선택될 수 있습니다. 읽기 전용 [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](../itheme/get_fontscheme/)() | 글꼴 구성표를 반환합니다. 읽기 전용 [IFontScheme](../ifontscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](../itheme/get_formatscheme/)() | 도형 형식 구성표를 반환합니다. 읽기 전용 [IFormatScheme](../iformatscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 테마의 이름을 반환합니다. 읽기 [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../itheme/geteffective/)() | 상속이 적용된 효과적인 테마 데이터를 가져옵니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로 아무것도 복사하지 않고 새 객체를 초기화하며 하위 클래스의 복사 생성을 가능하게 합니다. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | 테마의 이름을 반환합니다. 쓰기 [System::String](../../system/string/). |
