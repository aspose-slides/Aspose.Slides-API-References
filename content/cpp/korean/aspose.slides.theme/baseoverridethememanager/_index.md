...
description: 다양한 유형의 재정의된 테마에 접근할 수 있는 클래스를 위한 기본 클래스입니다.
type: docs
weight: 1
...
다양한 종류의 재정의된 테마에 접근할 수 있는 클래스를 위한 기본 클래스입니다.
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/)가 상속된 유효 테마를 재정의하는지 여부를 결정합니다. 재정의를 위해 [OverrideTheme](../overridetheme/)를 활성화하려면 OverrideTheme.Init*() 메서드를 사용하십시오. [OverrideTheme](../overridetheme/)의 재정의를 비활성화하려면 [OverrideTheme::Clear](../overridetheme/clear/) 메서드를 사용하십시오. 읽기 전용 **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | 재정의된 테마 객체를 반환합니다. 읽기 [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | 재정의된 테마 객체를 반환합니다. 쓰기 [IOverrideTheme](../ioverridetheme/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n't번째 템플릿 인수를 약한 포인터(공유 대신)로 설정합니다. 컨테이너에서 포인터를 약한 모드로 전환할 수 있습니다. |
...
* 클래스 [IOverrideThemeManager](../ioverridethememanager/)
