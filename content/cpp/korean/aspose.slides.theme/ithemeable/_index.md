...
description: ITheme으로 테마를 적용할 수 있는 객체를 나타냅니다.
type: docs
weight: 443
...
[ITheme](../itheme/) 로 테마를 적용할 수 있는 객체를 나타냅니다.
...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() | 이 테마 가능한 객체에 대한 유효한 테마를 반환합니다. |
