...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도(자신을 포함) 같지 않음에도 불구하고 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도(자신을 포함) 같지 않음에도 불구하고 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_BackgroundFillStyle](./get_backgroundfillstyle/)(**int32_t**) | 지정된 인덱스에 있는 테마 정의 배경 채우기 스타일을 반환합니다. 읽기 전용 [Aspose::Slides::IFillFormat](../../aspose.slides/ifillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollection](../ifillformatcollection/)\> [get_BackgroundFillStyles](./get_backgroundfillstyles/)() | 테마 정의 배경 채우기 스타일 컬렉션을 반환합니다. 읽기 전용 [IFillFormatCollection](../ifillformatcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\> [get_EffectStyle](./get_effectstyle/)(**int32_t**) | 지정된 인덱스에 있는 테마 정의 효과 스타일을 반환합니다. 읽기 전용 [Aspose::Slides::Theme::IEffectStyle](../ieffectstyle/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleCollection](../ieffectstylecollection/)\> [get_EffectStyles](./get_effectstyles/)() | 테마 정의 효과 스타일 컬렉션을 반환합니다. 읽기 전용 [IEffectStyleCollection](../ieffectstylecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillStyle](./get_fillstyle/)(**int32_t**) | 지정된 인덱스에 있는 테마 정의 채우기 스타일을 반환합니다. 읽기 전용 [Aspose::Slides::IFillFormat](../../aspose.slides/ifillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollection](../ifillformatcollection/)\> [get_FillStyles](./get_fillstyles/)() | 테마 정의 채우기 스타일 컬렉션을 반환합니다. 읽기 전용 [IFillFormatCollection](../ifillformatcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_LineStyle](./get_linestyle/)(**int32_t**) | 지정된 인덱스에 있는 테마 정의 선 스타일을 반환합니다. 읽기 전용 [Aspose::Slides::ILineFormat](../../aspose.slides/ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatCollection](../ilineformatcollection/)\> [get_LineStyles](./get_linestyles/)() | 테마 정의 선 스타일 컬렉션을 반환합니다. 읽기 전용 [ILineFormatCollection](../ilineformatcollection/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자입니다. 실제로는 아무것도 복사하지 않으며, 새 객체를 초기화하고 서브클래스 복사 생성을 가능하게 합니다. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 약한 포인터(공유 포인터 대신)로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있습니다. |
