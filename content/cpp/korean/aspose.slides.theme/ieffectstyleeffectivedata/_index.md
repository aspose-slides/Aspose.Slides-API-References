...
description: 효과적인 효과 스타일 속성을 포함하는 불변 객체.
type: docs
weight: 209
url: /ko/aspose.slides.theme/ieffectstyleeffectivedata/
---
## IEffectStyleEffectiveData 클래스

Immutable object which contains effective effect style properties.

```cpp
class IEffectStyleEffectiveData : public virtual System::Object
```
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 동일한 것으로 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만 그렇습니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 동일한 것으로 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만 그렇습니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/)\> [get_EffectFormat](./get_effectformat/)() | 효과 형식을 반환합니다. 읽기 전용 [IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/)\> [get_ThreeDFormat](./get_threedformat/)() | 3D 형식을 반환합니다. 읽기 전용 [IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/). |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현하여 잠금합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용합니다. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 문자열과 nullptr 사례에 대한 [Object::ReferenceEquals](../../system/object/referenceequals/) 특수화. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | 문자열 사례에 대한 [Object::ReferenceEquals](../../system/object/referenceequals/) 특수화. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 구현하여 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용합니다. |
