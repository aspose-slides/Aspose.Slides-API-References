...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/)가 상속된 효과적인 테마를 재정의하는지 여부를 결정합니다. 재정의를 위해 [OverrideTheme](../overridetheme/)를 활성화하려면 OverrideTheme.Init*() 메서드를 사용하십시오. [OverrideTheme](../overridetheme/)의 재정의를 비활성화하려면 [OverrideTheme::Clear](../overridetheme/clear/) 메서드를 사용하십시오. 읽기 전용 **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | 재정의된 테마 객체를 반환합니다. [IOverrideTheme](../ioverridetheme/)를 읽으십시오. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자. 실제로 아무 것도 복사하지 않고 새 객체를 초기화하며 하위 클래스 복사 구성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자. 실제로 아무 것도 복사하지 않고 새 객체를 초기화하며 하위 클래스 복사 구성을 가능하게 합니다. |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | 재정의된 테마 객체를 반환합니다. [IOverrideTheme](../ioverridetheme/)에 씁니다. |
