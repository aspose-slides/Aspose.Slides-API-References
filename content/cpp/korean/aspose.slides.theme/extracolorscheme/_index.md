...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | 컬러 스키마를 반환합니다. 읽기 전용 [IColorScheme](../icolorscheme/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 이 스키마의 이름을 반환합니다. 읽기 전용 [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문 해제 구현입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하세요. |
...
* 클래스 [IExtraColorScheme](../iextracolorscheme/)
