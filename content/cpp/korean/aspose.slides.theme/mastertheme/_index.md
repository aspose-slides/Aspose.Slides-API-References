...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | 색 구성표를 반환합니다. 읽기 전용 [IColorScheme](../icolorscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) override | 지정된 인덱스에 있는 추가 색 구성표를 반환합니다. 이 구성표는 프레젠테이션의 모양에 영향을 주지 않으며, 슬라이드의 기본 색 구성표로 선택될 수 있습니다. 읽기 전용 [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() override | 추가 색 구성표 컬렉션을 반환합니다. 이 구성표들은 프레젠테이션의 모양에 영향을 주지 않으며, 슬라이드의 기본 색 구성표로 선택될 수 있습니다. 읽기 전용 [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](./get_fontscheme/)() override | 폰트 구성표를 반환합니다. 읽기 전용 [IFontScheme](../ifontscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](./get_formatscheme/)() override | 도형 형식 구성표를 반환합니다. 읽기 전용 [IFormatScheme](../iformatscheme/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 테마의 이름을 반환합니다. 읽기 [System::String](../../system/string/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자. 실제로는 아무것도 복사하지 않고, 새 객체를 초기화하고 하위 클래스를 복사 생성할 수 있게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로는 아무것도 복사하지 않고, 새 객체를 초기화하고 하위 클래스를 복사 생성할 수 있게 합니다. |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | 테마의 이름을 반환합니다. 쓰기 [System::String](../../system/string/). |
