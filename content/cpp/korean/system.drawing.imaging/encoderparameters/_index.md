...
description: "EncoderParameter 객체들의 배열을 나타냅니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용해서는 안 되며, 그렇다면 런타임 오류 및/또는 어설션 오류가 발생합니다. 이 클래스를 항상 System::SmartPtr 포인터로 래핑하고, 해당 포인터를 인수로 함수에 전달하십시오."
type: docs
weight: 79
url: /ko/system.drawing.imaging/encoderparameters/
---
## EncoderParameters 클래스


[EncoderParameter](../encoderparameter/) 객체의 배열을 나타냅니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 이 유형의 인스턴스를 스택에 직접 생성하거나 operator new를 사용해서는 안 됩니다. 그런 경우 런타임 오류 및/또는 어설션 오류가 발생합니다. 이 클래스를 항상 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고, 해당 포인터를 인수로 함수에 전달하십시오.
...
| [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\> [get_Param](./get_param/)() const | 현재 [EncoderParameters](./) 객체가 나타내는 [EncoderParameter](../encoderparameter/) 객체 배열을 반환합니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 구문의 락을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
...
| void [set_Param](./set_param/)(const [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\>\&) | 현재 [EncoderParameters](./) 객체에 [EncoderParameter](../encoderparameter/) 객체 배열을 할당합니다. |
