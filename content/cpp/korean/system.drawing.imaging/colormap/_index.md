...
description: "색상을 변환하기 위한 맵을 나타냅니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여만 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하여 이 유형의 인스턴스를 만들지 마십시오. 이는 런타임 오류 및/또는 단언 오류를 초래할 수 있습니다. 항상 이 클래스를 System::SmartPtr 포인터로 래핑하고 이 포인터를 함수에 인수로 전달하여 사용하십시오."
type: docs
weight: 14
url: /ko/system.drawing.imaging/colormap/
---
## ColorMap 클래스

색상을 변환하기 위한 맵을 나타냅니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여만 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하여 이 유형의 인스턴스를 만들지 마십시오. 이는 런타임 오류 및/또는 단언 오류를 발생시킬 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고 이 포인터를 함수에 인수로 전달하여 사용하십시오.
...
| [Color](../../system.drawing/color/) [get_NewColor](./get_newcolor/)() const | 변환할 색상을 나타내는 새로운 [Color](../../system.drawing/color/) 객체를 반환합니다. |
| [Color](../../system.drawing/color/) [get_OldColor](./get_oldcolor/)() const | 변환될 색상을 나타내는 기존 [Color](../../system.drawing/color/) 객체를 반환합니다. |
...
| void [set_NewColor](./set_newcolor/)(const [Color](../../system.drawing/color/)\&) | 변환할 색상을 나타내는 새로운 [Color](../../system.drawing/color/) 객체를 설정합니다. |
| void [set_OldColor](./set_oldcolor/)(const [Color](../../system.drawing/color/)\&) | 변환될 색상을 나타내는 기존 [Color](../../system.drawing/color/) 객체를 설정합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인수를 공유가 아니라 약한 포인터로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있게 합니다. |
