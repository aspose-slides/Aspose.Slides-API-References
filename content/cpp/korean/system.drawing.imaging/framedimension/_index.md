...
description: "이미지의 프레임 차원을 가져오는 속성을 제공합니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 인스턴스를 생성하거나 operator new를 사용하면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, 해당 포인터를 인수로 함수에 전달하십시오."
type: docs
weight: 92
url: /ko/system.drawing.imaging/framedimension/
---
## FrameDimension 클래스

이미지의 프레임 차원을 가져오는 속성을 제공합니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 인스턴스를 생성하거나 operator new를 사용해서는 안 되며, 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 인수로 함수에 전달하십시오.
...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([FrameDimensionPtr](../framedimensionptr/)) | 지정된 [FrameDimension](./) 객체가 현재 객체와 동등한지 판단합니다. |
...
| [FrameDimension](./framedimension/)(const [System::Guid](../../system/guid/)\&) | 새로운 [FrameDimension](./) 객체를 생성하고 지정된 GUID로 초기화합니다. |
| [System::Guid](../../system/guid/) [get_Guid](./get_guid/)() const | 현재 객체와 연결된 GUID를 반환합니다. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Page](./get_page/)() | 페이지 차원을 반환합니다. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Resolution](./get_resolution/)() | 해상도 차원을 반환합니다. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Time](./get_time/)() | 시간 차원을 반환합니다. |
