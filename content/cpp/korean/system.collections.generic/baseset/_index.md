...
type: docs
weight: 92
url: /ko/system.collections.generic/baseset/
---
## BaseSet 클래스
...
| void [Add](./add/)(const T\&) override | 집합에 요소를 추가합니다. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 상수 한정 컬렉션의 첫 번째 요소에 대한 반복자를 가져옵니다. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 컬렉션의 첫 번째 상수 한정 요소에 대한 반복자를 가져옵니다. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 컬렉션 끝 뒤에 있는 존재하지 않는 상수 한정 요소에 대한 반복자를 가져옵니다. |
| void [Clear](./clear/)() override | 집합의 모든 요소를 삭제합니다. |
| **bool** [Contains](./contains/)(const T\&) const override | 요소가 집합에 존재하는지 확인합니다. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | 해시 내용을 기존 배열 요소에 복사합니다. |
| [set_t](./set_t/)\& [data](./data/)() | 기본 데이터 구조 접근자. |
| const [set_t](./set_t/)\& [data](./data/)() const | 기본 데이터 구조 접근자. |
| [const_iterator](./const_iterator/) [end](./end/)() const | 상수 한정 컬렉션 끝 뒤에 존재하지 않는 요소에 대한 반복자를 가져옵니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음에도 불구하고, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음에도 불구하고, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용. |
| int [get_Count](./get_count/)() const override | 집합의 요소 개수를 가져옵니다. |
| virtual int [get_Count](./get_count/)() const | [get_Count()](./get_count/)가 숨겨지는 것을 방지합니다. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | 열거자를 생성합니다. |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 입력 시퀀스 각각의 요소에 변환 함수를 적용해 얻은 값들의 시퀀스 평균을 계산합니다. |
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Cast](../ienumerable/linq_cast/)() | 요소들을 지정된 유형으로 형변환합니다. |
...
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 조건을 만족하는 시퀀스의 첫 번째 요소를 반환하고, 찾지 못하면 기본값을 반환합니다. |
...
| ResultType [LINQ_Max](../ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 범용 시퀀스의 각 요소에 변환 함수를 적용하고 최대값을 반환합니다. |
| ResultType [LINQ_Max](../ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 범용 시퀀스의 각 요소에 변환 함수를 적용하고 최소값을 반환합니다. |
| ResultType [LINQ_Min](../ienumerable/linq_min/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_OfType](../ienumerable/linq_oftype/)() | 지정된 유형을 기준으로 시퀀스 요소를 필터링합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | 시퀀스 시작부터 지정된 수만큼 연속 요소를 건너뛰고 나머지를 반환합니다. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Take](../ienumerable/linq_take/)(**int32_t**) | 시퀀스 시작부터 지정된 수만큼 연속 요소를 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Where](../ienumerable/linq_where/)(std::function\<**bool**(T)>) | 지정된 프레디케이트를 기준으로 시퀀스를 필터링합니다. |
...
| **bool** [Remove](./remove/)(const T\&) override | 집합에서 요소를 제거합니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값만큼 공유 참조 카운트를 감소시킵니다. |
| [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([ThisType](./thistype/), System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | RTTI 정보. |
...
| **bool** [TryAdd](./tryadd/)(const T\&) | 집합에 요소를 추가합니다. |
...
| [IEnumerablePtr](./ienumerableptr/) | 열거형 인터페이스 포인터. |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** 포인터. |
