...
description: "컨테이너를 역순으로 반복하는 열거자입니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 이 타입의 인스턴스를 만들거나 operator new를 사용하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, 해당 포인터를 함수 인자로 전달하십시오."
type: docs
weight: 495
url: /ko/system.collections.generic/reverseenumerator/
---
## ReverseEnumerator 클래스
...
| 메서드 | 설명 |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | VirtualizedIterator 클래스로 사용할 반복자를 준비합니다. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](../ienumerator/cloneiterator/)() const override | 현재 반복자를 복제합니다. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Element\> [get_Current](./get_current/)() const override | '현재' 요소를 가져옵니다. |
...
| **bool** [IsValid](./isvalid/)() const | [MoveNext()](./movenext/)가 호출되었으며 끝에 도달하지 않았는지 확인합니다. |
| void [Lock](../../system/object/lock/)() | C# lock() 문 잠금을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | 가상화된 반복자가 소유한 열거자를 표시합니다. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드와 유사합니다. 사용자 정의 타입 복제를 가능하게 합니다. |
| **bool** [MoveNext](./movenext/)() override | 열거자 스타일 증가. |
...
| void [Reset](./reset/)() override | 요소를 다시 열거할 수 있도록 열거자를 재설정합니다. |
|  [ReverseEnumerator](./reverseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | 반복자를 초기화합니다. |
