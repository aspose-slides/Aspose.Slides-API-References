...
description: Dictionary 클래스의 전방 선언.
type: docs
weight: 144
url: /ko/system.collections.generic/dictionary/
---
## Dictionary 클래스

[Dictionary](./) 클래스의 전방 선언.
...
[Dictionary](./)는 값들을 키에 매핑합니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 이 타입의 인스턴스를 만들거나 operator new를 사용하지 마세요. 그렇지 않으면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 이 포인터를 함수 인수로 전달하십시오.
