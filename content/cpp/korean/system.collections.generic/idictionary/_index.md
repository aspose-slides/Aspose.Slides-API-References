...
description: "사전과 같은 컨테이너용 인터페이스입니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용해서 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 래핑하고, 해당 포인터를 함수 인자로 전달하세요."
type: docs
weight: 274
url: /ko/system.collections.generic/idictionary/
---
## IDictionary 클래스
...
| 메서드 | 설명 |
| --- | --- |
| virtual void [Add](./add/)(const TKey\&, const TValue\&) | 컨테이너에 키-값 쌍을 추가합니다. |
...
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | 컬렉션에서 const 한정된 첫 번째 요소(있는 경우)를 가리키는 반복자를 반환합니다. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | 컬렉션에서 const 한정된 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. |
...
| virtual **bool** [ContainsKey](./containskey/)(const TKey\&) const | 컨테이너에 해당 키가 포함되어 있는지 확인합니다. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../keyvaluepair/)\<TKey, TValue\>\>, int) override | 사전 내용을 기존 배열 요소에 복사합니다. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | 컬렉션에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. 이 반복자는 [GetEnumerator()](../ienumerable/getenumerator/) 가 T의 복사 객체를 반환하기 때문에 참조된 객체를 변경할 수 없습니다. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | const 한정된 컬렉션 인스턴스에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. |
...
| **bool** [get_IsFixedSize](./get_isfixedsize/)() const | 컬렉션 크기가 고정되어 있는지 확인합니다. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | 컬렉션이 읽기 전용인지 확인합니다. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | 컨테이너가 스레드 안전인지 확인합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TKey\>\> [get_Keys](./get_keys/)() const | 키 컬렉션에 접근합니다. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | 컬렉션이 동기화되는 객체를 반환합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TValue\>\> [get_Values](./get_values/)() const | 값 컬렉션에 접근합니다. |
...
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&) const | 찾은 경우 값을 반환합니다; 그렇지 않으면 **Value()** 를 반환합니다. |
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&, const TValue\&) const | 찾은 경우 값을 반환합니다; 그렇지 않으면 **defaultValue** 를 반환합니다. |
| virtual TValue [GetValueOrNull](./getvalueornull/)(const TKey\&) const | 찾은 경우 값을 반환합니다; 그렇지 않으면 **null** 을 반환합니다(참조 형식에만 의미가 있습니다). |
...
| virtual TValue [idx_get](./idx_get/)(const TKey\&) const | getter 함수. |
| virtual void [idx_set](./idx_set/)(const TKey\&, TValue) | setter 함수. |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 입력 시퀀스 각 요소에 변환 함수를 적용하여 얻은 값들의 시퀀스 평균을 계산합니다. |
...
| int [LINQ_Count](../ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | 지정된 조건을 만족하는 시퀀스의 요소 개수를 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | 각 요소의 인덱스를 포함시켜 시퀀스의 각 요소를 새로운 형태로 변환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | 시퀀스 시작부터 지정된 개수의 연속 요소를 건너뛰고 나머지를 반환합니다. |
...
| virtual **bool** [Remove](./remove/)(const TKey\&) | 컨테이너에서 키를 제거합니다. |
...
| virtual **bool** [TryGetValue](./trygetvalue/)(const TKey\&, TValue\&) const | 값을 찾고, 찾은 경우 반환합니다. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) 구문을 구현합니다. |
| void [Unlock](../../system/object/unlock/)() | C# lock() 구문의 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
...
| Typedef | 설명 |
| --- | --- |
| [BaseType](./basetype/) | 기본 인터페이스 타입. |
| [KeyValuePairType](./keyvaluepairtype/) | 키-값 쌍 타입. |
