...
description: "Http, FTP 등에 대한 캐싱에 사용되는 일반 요청 캐시 정책입니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용하면 런타임 오류 및/또는 단언 오류가 발생하므로 절대 생성하지 마십시오. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, 해당 포인터를 함수 인수로 전달하여 사용하십시오."
type: docs
weight: 14
url: /ko/system.net.cache/requestcachepolicy/
---
...
| [RequestCacheLevel](../requestcachelevel/) [get_Level](./get_level/)() | 지정된 RequestCacheLevel 값을 가져옵니다. |
...
|  [RequestCachePolicy](./requestcachepolicy/)() | 새 인스턴스를 생성합니다. |
|  [RequestCachePolicy](./requestcachepolicy/)([RequestCacheLevel](../requestcachelevel/)) | 지정된 RequestCacheLevel 값으로 새 인스턴스를 생성합니다. |
