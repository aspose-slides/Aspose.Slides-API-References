...
description: 스레드에 작업을 큐에 넣는 저수준 작업을 처리하는 객체를 나타냅니다.
type: docs
weight: 79
url: /ko/system.threading.tasks/taskscheduler/
---
## TaskScheduler 클래스

스레드에 작업을 큐에 넣는 저수준 작업을 처리하는 객체를 나타냅니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 같다고 간주되는 C#-style 부동소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않으며 NaN 자체와도 같지 않지만, 이 비교에서는 다르게 취급합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 같다고 간주되는 C#-style 부동소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않으며 NaN 자체와도 같지 않지만, 이 비교에서는 다르게 취급합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | 현재 스레드와 연결된 [TaskScheduler](./)을 생성합니다. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | 현재 실행 중인 작업과 연결된 [TaskScheduler](./)을 가져옵니다. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | 프레임워크에서 제공하는 기본 [TaskScheduler](./) 인스턴스를 가져옵니다. |
| **int32_t** [get_Id](./get_id/)() const | 이 [TaskScheduler](./)의 고유 ID를 가져옵니다. |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | 이 [TaskScheduler](./)가 지원할 수 있는 최대 동시성 레벨을 나타냅니다. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 객체의 실제 형식을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출의 유사 버전입니다. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType으로 설명된 형식의 인스턴스를 나타내는지 확인합니다. C# 'is' 연산자의 유사 버전입니다. |
