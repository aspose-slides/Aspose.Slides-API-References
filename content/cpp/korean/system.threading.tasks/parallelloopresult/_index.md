...
description: Parallel 루프의 완료 상태를 제공합니다.
type: docs
weight: 14
url: /ko/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult 클래스

[Parallel](../parallel/) 루프의 완료 상태를 제공합니다.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | 루프가 완전히 실행되었는지 여부를 가져옵니다. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | break가 발생한 가장 낮은 반복 인덱스를 가져옵니다. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | [ParallelLoopResult](./) 를 생성합니다. |
...
병렬 루프 작업의 결과를 나타내며, 작업이 완료되었는지 여부와 break에 대한 정보를 포함합니다.
