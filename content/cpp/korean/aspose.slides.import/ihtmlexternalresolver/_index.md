...
description: 이미지와 같은 참조된 객체를 가져오기 위해 HTML 가져오기 루틴에서 사용되는 콜백 인터페이스입니다.
type: docs
weight: 53
url: /ko/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver 클래스

HTML 가져오기 루틴에서 이미지와 같은 참조된 객체를 가져오기 위해 사용되는 콜백 인터페이스입니다.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | URI를 실제 리소스를 포함하는 객체에 매핑합니다. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | 기본 URI와 상대 URI로부터 절대 URI를 해석합니다. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | 약한 참조 카운트를 감소시킵니다. 직접 호출하지 말고 스마트 포인터 또는 ThisProtetor를 사용하십시오. |
| virtual  [~Object](../../system/object/~object/)() | 객체를 파괴합니다. 모든 내부 데이터 구조를 해제합니다. |

사용 중단
:   구식입니다. 대신 [IExternalResourceResolver](../iexternalresourceresolver/)를 사용하십시오. 17.12 릴리스에서 제거될 예정입니다.
