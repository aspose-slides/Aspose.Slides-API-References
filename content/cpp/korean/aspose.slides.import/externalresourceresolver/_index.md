...
description: HTML, SVG 문서 가져오기 중 외부 리소스를 해결하는 데 사용되는 콜백 클래스.
type: docs
weight: 14
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 IEC 60559:1989에 따르면 어떤 값과도(또는 NaN 자체와도) 같지 않음에도 불구하고 C# 스타일 부동소수점 비교를 에뮬레이션합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 IEC 60559:1989에 따르면 어떤 값과도(또는 NaN 자체와도) 같지 않음에도 불구하고 C# 스타일 부동소수점 비교를 에뮬레이션합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) override | URI를 실제 리소스를 포함하는 객체에 매핑합니다. |
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 기본 URI와 상대 URI로부터 절대 URI를 해결합니다. |
...
이 해결자를 사용하면 클라이언트가 제공한 HTML 또는 SVG 파일이 서버 소프트웨어가 로컬 또는 네트워크 파일에 접근하게 만들어 취약점이 발생할 수 있습니다. 주의해서 사용하십시오. [ExternalResourceResolver](./)를 전혀 지정하지 않는 것이 권장됩니다(임베드된 객체만 읽힘) 또는 지정된 uri가 유효한지 확인하는 서브클래스를 생성하십시오.

## 참조

* 클래스 [IExternalResourceResolver](../iexternalresourceresolver/)
