...
| **bool** [get_DetectTables](./get_detecttables/)() const | PDF 파일을 가져올 때 표를 감지할지 여부를 결정합니다. |
...
| void [set_DetectTables](./set_detecttables/)(**bool**) | PDF 파일을 가져올 때 표를 감지할지 여부를 결정합니다. |
