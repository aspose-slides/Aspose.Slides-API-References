...
description: XSLT 변환을 처리하는 중 오류가 발생할 때 발생하는 예외입니다.
type: docs
weight: 14
url: /ko/system.xml.xsl/details_xsltexception/
---
## Details_XsltException 클래스

XSLT 변환을 처리하는 중 오류가 발생할 때 발생하는 예외입니다.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | 스타일 시트에서 오류가 발생한 행 번호를 반환합니다. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | 스타일 시트에서 오류가 발생한 열 위치를 반환합니다. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 현재 예외를 설명하는 형식화된 오류 메시지를 반환합니다. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 스타일 시트의 위치 경로를 반환합니다. |
