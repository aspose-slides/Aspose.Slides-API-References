...
description: 네임스페이스 한정 이름과 연결된 매개변수를 반환합니다.
type: docs
weight: 14
url: /ko/system.xml.xsl/xsltargumentlist/getparam/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| name | const [String](../../../system/string/)\& | 매개변수의 이름입니다. [XsltArgumentList](../)는 전달된 이름이 유효한 로컬 이름인지 확인하지 않지만, 이름은 **nullptr**일 수 없습니다. |
| namespaceUri | const [String](../../../system/string/)\& | 매개변수와 연결된 네임스페이스 URI. |
