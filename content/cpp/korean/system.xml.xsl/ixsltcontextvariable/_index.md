...
description: 런타임 실행 중 스타일 시트에 정의된 지정된 변수에 대한 인터페이스를 제공합니다.
type: docs
weight: 40
url: /ko/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable 클래스

런타임 실행 중 스타일 시트에 정의된 지정된 변수에 대한 인터페이스를 제공합니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 같지 않지만, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 같지 않지만, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | 런타임에 변수를 평가하고 변수의 값을 나타내는 객체를 반환합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual **bool** [get_IsLocal](./get_islocal/)() | 변수가 로컬인지 여부를 나타내는 값을 반환합니다. |
| virtual **bool** [get_IsParam](./get_isparam/)() | 변수가 Extensible Stylesheet Language Transformations (XSLT) 매개변수인지 여부를 나타내는 값을 반환합니다. 이는 스타일 시트 또는 템플릿에 대한 매개변수가 될 수 있습니다. |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | 변수의 XML Path Language ([XPath](../../system.xml.xpath/)) 유형을 나타내는 XPathResultType을 반환합니다. |
