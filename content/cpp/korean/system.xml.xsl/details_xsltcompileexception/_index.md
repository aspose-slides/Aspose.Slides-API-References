...
description: XSLT 스타일 시트에서 오류가 발견될 때 Load 메서드에 의해 발생하는 예외입니다.
type: docs
weight: 1
url: /ko/system.xml.xsl/details_xsltcompileexception/
---
## Details_XsltCompileException 클래스

XSLT 스타일 시트에서 오류가 발견될 때 **Load** 메서드에 의해 발생하는 예외입니다.
...
| virtual **int32_t** [get_LineNumber](../details_xsltexception/get_linenumber/)() | 스타일 시트에서 오류가 발생한 위치의 행 번호를 반환합니다. |
| virtual **int32_t** [get_LinePosition](../details_xsltexception/get_lineposition/)() | 스타일 시트에서 오류가 발생한 위치의 열(문자 위치) 번호를 반환합니다. |
| [String](../../system/string/) [get_Message](../details_xsltexception/get_message/)() const override | 현재 예외를 설명하는 서식화된 오류 메시지를 반환합니다. |
| virtual [String](../../system/string/) [get_SourceUri](../details_xsltexception/get_sourceuri/)() | 스타일 시트의 위치 경로를 반환합니다. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로는 아무 것도 복사하지 않고 새 객체를 초기화하며 서브클래스 복사 구성을 활성화합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자입니다. 실제로는 아무 것도 복사하지 않고 새 객체를 초기화하며 서브클래스 복사 구성을 활성화합니다. |
...
* 클래스 [Details_XsltException](../details_xsltexception/)
