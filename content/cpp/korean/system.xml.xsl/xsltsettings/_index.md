...
description: XSLT 스타일 시트를 실행하는 동안 지원할 XSLT 기능을 지정합니다.
type: docs
weight: 118
url: /ko/system.xml.xsl/xsltsettings/
---
## XsltSettings 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도 같지 않지만, C# 스타일 부동 소수점 비교를 에뮬레이트하여 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도 같지 않지만, C# 스타일 부동 소수점 비교를 에뮬레이트하여 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_Default](./get_default/)() | 기본 설정을 가진 [XsltSettings](./) 객체를 반환합니다. XSLT **document()** 함수 및 포함된 스크립트 블록에 대한 지원은 비활성화됩니다. |
| **bool** [get_EnableDocumentFunction](./get_enabledocumentfunction/)() | XSLT **document()** 함수에 대한 지원을 활성화할지 여부를 나타내는 값을 반환합니다. |
| **bool** [get_EnableScript](./get_enablescript/)() | 포함된 스크립트 블록에 대한 지원을 활성화할지 여부를 나타내는 값을 반환합니다. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_TrustedXslt](./get_trustedxslt/)() | XSLT **document()** 함수 및 포함된 스크립트 블록을 지원하는 [XsltSettings](./) 객체를 반환합니다. |
...
| void [set_EnableDocumentFunction](./set_enabledocumentfunction/)(**bool**) | XSLT **document()** 함수에 대한 지원을 활성화할지 여부를 나타내는 값을 설정합니다. |
| void [set_EnableScript](./set_enablescript/)(**bool**) | 포함된 스크립트 블록에 대한 지원을 활성화할지 여부를 나타내는 값을 설정합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인수를 약한 포인터(공유 포인터 대신)로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
...
|  [XsltSettings](./xsltsettings/)() | [XsltSettings](./) 클래스의 새 인스턴스를 기본 설정으로 초기화합니다. |
|  [XsltSettings](./xsltsettings/)(**bool**, **bool**) | [XsltSettings](./) 클래스의 새 인스턴스를 지정된 설정으로 초기화합니다. |
...
이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 절대 생성하지 마십시오. 그렇지 않으면 런타임 오류 또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 함수 인자로 전달하십시오. 
