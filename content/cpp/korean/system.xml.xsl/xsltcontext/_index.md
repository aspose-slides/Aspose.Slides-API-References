...
description: 확장 스타일시트 언어 변환(XSLT) 프로세서의 현재 실행 컨텍스트를 캡슐화하여 XML Path Language(XPath)가 XPath 식 내에서 함수, 매개변수 및 네임스페이스를 해석할 수 있도록 합니다.
type: docs
weight: 79
url: /ko/system.xml.xsl/xsltcontext/
---
## XsltContext 클래스

Extensible Stylesheet Language for Transformations (XSLT) 프로세서의 현재 실행 컨텍스트를 캡슐화하여 XML Path Language ([XPath](../../system.xml.xpath/))가 [XPath](../../system.xml.xpath/) 식 내에서 함수, 매개변수 및 네임스페이스를 해결할 수 있도록 합니다.
...
| 메서드 | 설명 |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | 지정된 네임스페이스를 컬렉션에 추가합니다. |
...
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | 파생 클래스에서 재정의될 경우, XSLT 프로세서에 의해 문서가 로드된 순서에 따라 두 문서의 기본 Uniform Resource Identifier (URI)를 비교합니다(즉, [XslTransform](../xsltransform/) 클래스). |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 컬렉션의 const 한정 인스턴스의 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 가져옵니다. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | 기본 네임스페이스에 대한 네임스페이스 URI를 반환합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | 이 객체와 연관된 [XmlNameTable](../../system.xml/xmlnametable/)를 반환합니다. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | 파생 클래스에서 재정의될 경우, 출력에 공백 노드를 포함할지 여부를 나타내는 값을 가져옵니다. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 레퍼런스 카운터 데이터 구조를 가져옵니다. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/)의 네임스페이스를 순회하는 데 사용할 열거자를 반환합니다. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | 시퀀스에 요소가 하나라도 포함되어 있는지 여부를 결정합니다. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | 지정된 조건을 만족하는 시퀀스의 요소 수를 반환합니다. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | 시퀀스의 첫 번째 요소를 반환하거나, 시퀀스가 비어 있을 경우 기본값을 반환합니다. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 조건을 만족하는 시퀀스의 첫 번째 요소를 반환하거나, 해당 요소가 없을 경우 기본값을 반환합니다. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | 시퀀스의 마지막 요소를 반환하거나, 시퀀스가 비어 있을 경우 기본값을 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector에 의해 선택된 키 값을 기준으로 시퀀스의 요소들을 오름차순으로 정렬합니다. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector에 의해 선택된 키 값을 기준으로 시퀀스의 요소들을 내림차순으로 정렬합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | 시퀀스의 각 요소를 해당 인덱스를 포함하여 새로운 형태로 변환합니다. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | 지정된 접두사에 대한 네임스페이스 URI를 반환합니다. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | 주어진 네임스페이스 URI에 선언된 접두사를 찾습니다. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드와 유사합니다. 사용자 정의 타입 복제를 가능하게 합니다. |
|  [Object](../../system/object/object/)() | 객체를 생성합니다. 모든 내부 데이터 구조를 초기화합니다. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const&) | 복사 생성자. 실제로는 아무것도 복사하지 않고, 새 객체를 초기화하고 파생 클래스의 복사 생성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const&) | 대입 연산자. 실제로는 아무것도 복사하지 않고, 새 객체를 초기화하고 파생 클래스의 복사 생성을 가능하게 합니다. |
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | 스택에서 네임스페이스 스코프를 팝합니다. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | 파생 클래스에서 재정의될 경우, 주어진 컨텍스트에 대해 공백 노드를 보존할지 제거할지 평가합니다. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | 스택에 네임스페이스 스코프를 푸시합니다. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | 주어진 접두사에 대한 지정된 네임스페이스를 제거합니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | 파생 클래스에서 재정의될 경우, 함수 레퍼런스를 해결하고 해당 함수를 나타내는 [IXsltContextFunction](../ixsltcontextfunction/)를 반환합니다. 실행 시 [IXsltContextFunction](../ixsltcontextfunction/)가 함수의 반환 값을 얻는 데 사용됩니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | 파생 클래스에서 재정의될 경우, 변수 레퍼런스를 해결하고 해당 변수를 나타내는 [IXsltContextVariable](../ixsltcontextvariable/)를 반환합니다. |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | 지정된 [XmlNameTable](../../system.xml/xmlnametable/)을 사용하여 [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) 클래스의 새 인스턴스를 초기화합니다. |
