...
description: 계산된 수식이 올바르지 않거나 파싱되지 않았을 때 발생하는 예외입니다.
type: docs
weight: 14
url: /ko/aspose.slides.spreadsheet/details_cellinvalidformulaexception/
---
## Details_CellInvalidFormulaException 클래스


계산된 수식이 올바르지 않거나 파싱되지 않았을 때 발생하는 예외입니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도, NaN 포함, 같지 않음에도 불구하고 두 NaN을 동일하게 간주하는 C#-스타일 부동소수점 비교를 모방합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도, NaN 포함, 같지 않음에도 불구하고 두 NaN을 동일하게 간주하는 C#-스타일 부동소수점 비교를 모방합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | 커스텀 예외 데이터를 포함하는 사전을 반환합니다. |
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | 잘못된 수식을 포함하는 셀 참조를 가져옵니다. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 커스텀 객체의 해싱을 활성화합니다. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드와 유사합니다. 커스텀 타입 복제를 활성화합니다. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) 메서드를 구현하며, 이는 [ExceptionWrapper](../../system/exceptionwrapper/) 클래스에서 호출됩니다. 이 클래스가 std::exception에서 상속되지 않았음에도 파생 클래스는 보호/비공개 멤버를 사용해 로직을 구현할 수 있습니다. 이 메서드 구현을 [ExceptionWrapper](../../system/exceptionwrapper/)으로 이동하면 해당 로직이 깨질 수 있습니다. |
