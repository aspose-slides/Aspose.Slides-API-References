...
description: 지정된 인덱스부터 전달된 문자열을 RetryConditionHeaderValue 클래스의 인스턴스로 변환합니다.
type: docs
weight: 105
url: /ko/system.net.http.headers/retryconditionheadervalue/getretryconditionlength/
---
## RetryConditionHeaderValue::GetRetryConditionLength(String, int32_t, System::SharedPtr\<Object\>\&) 메서드

지정된 인덱스부터 전달된 문자열을 [RetryConditionHeaderValue](../) 클래스의 인스턴스로 변환합니다.
...
구문 분석된 하위 문자열의 길이를 반환합니다. 그렇지 않으면 0을 반환합니다.
