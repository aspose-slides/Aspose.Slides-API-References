...
description: 지정된 인덱스부터 전달된 문자열을 RangeConditionHeaderValue 클래스의 인스턴스로 변환합니다.
type: docs
weight: 105
url: /ko/system.net.http.headers/rangeconditionheadervalue/getrangeconditionlength/
---
## RangeConditionHeaderValue::GetRangeConditionLength(String, int32_t, System::SharedPtr\<Object\>\&) 메서드

[RangeConditionHeaderValue](../) 클래스의 인스턴스로 지정된 인덱스부터 전달된 문자열을 변환합니다.
