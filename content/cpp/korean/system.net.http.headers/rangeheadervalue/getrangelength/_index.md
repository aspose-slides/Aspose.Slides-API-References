...
description: 지정된 인덱스부터 전달된 문자열을 RangeHeaderValue 클래스의 인스턴스로 변환합니다.
type: docs
weight: 118
url: /ko/system.net.http.headers/rangeheadervalue/getrangelength/
---
## RangeHeaderValue::GetRangeLength(String, int32_t, System::SharedPtr\<Object\>\&) 메서드

지정된 인덱스부터 전달된 문자열을 [RangeHeaderValue](../) 클래스의 인스턴스로 변환합니다.
