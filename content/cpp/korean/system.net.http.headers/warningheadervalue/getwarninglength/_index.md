...
description: 지정된 인덱스에서 전달된 문자열을 WarningHeaderValue 클래스의 인스턴스로 변환합니다.
type: docs
weight: 131
url: /ko/system.net.http.headers/warningheadervalue/getwarninglength/
---
## WarningHeaderValue::GetWarningLength(String, int32_t, System::SharedPtr\<Object\>\&) 메서드

지정된 인덱스에서 전달된 문자열을 [WarningHeaderValue](../) 클래스의 인스턴스로 변환합니다.
