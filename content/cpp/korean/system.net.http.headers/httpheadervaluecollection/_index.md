...
description: "헤더 값들의 컬렉션을 나타냅니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여만 할당해야 합니다. 스택이나 operator new를 사용하여 이 타입의 인스턴스를 생성하지 마십시오. 그렇지 않으면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, 해당 포인터를 함수 인자로 전달하도록 사용하십시오."
type: docs
weight: 92
url: /ko/system.net.http.headers/httpheadervaluecollection/
---
## HttpHeaderValueCollection 클래스

헤더 값들의 컬렉션을 나타냅니다. [System::MakeObject()](../../system/makeobject/) 함수를 사용하여만 이 클래스의 객체를 할당해야 합니다. 스택이나 operator new를 사용하여 이 타입의 인스턴스를 만들지 마세요. 그렇지 않으면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고, 해당 포인터를 인자로 함수에 전달하도록 사용하세요.
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const T\&) override | 컬렉션에 요소를 추가합니다. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 컬렉션의 첫 번째 요소(있는 경우)를 가리키는 반복자를 반환합니다. [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/)가 T의 복사 객체를 반환하므로 이 반복자를 사용해 참조된 객체를 변경할 수 없습니다. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | 컬렉션에서 마지막 const 한정 요소(있는 경우) 바로 다음을 가리키는 반복자를 반환합니다. |
| void [Clear](./clear/)() override | 컬렉션의 모든 요소를 삭제합니다. |
| **bool** [Contains](./contains/)(const T\&) const override | 요소가 컬렉션에 존재하는지 확인합니다. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | 컬렉션의 모든 요소를 기존 배열 요소에 복사합니다. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 컬렉션의 마지막 요소(있는 경우) 바로 다음을 가리키는 반복자를 반환합니다. [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/)가 T의 복사 객체를 반환하므로 이 반복자를 사용해 참조된 객체를 변경할 수 없습니다. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 컬렉션의 const 한정 인스턴스에서 마지막 요소(있는 경우) 바로 다음을 가리키는 반복자를 반환합니다. |
...
| **int32_t** [get_Count](./get_count/)() const override | 컬렉션의 요소 수를 가져옵니다. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | 현재 컬렉션이 읽기 전용인지 여부를 나타내는 값을 가져옵니다. |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | 컬렉션이 읽기 전용인지 확인합니다. |
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | 현재 컬렉션이 "특수 값"을 포함하는지 여부를 나타내는 값을 가져옵니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | 열거자를 가져옵니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | "특수 값" 없이 현재 컬렉션의 문자열 표현을 반환합니다. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 객체의 실제 유형을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출과 유사합니다. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | 새 인스턴스를 생성합니다. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | 새 인스턴스를 생성합니다. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | 새 인스턴스를 생성합니다. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | 새 인스턴스를 생성합니다. |
...
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | 헤더 문자열 표현을 파싱하여 현재 컬렉션에 추가합니다. |
...
| **bool** [Remove](./remove/)(const T\&) override | 컬렉션에서 요소를 삭제합니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값만큼 공유 레퍼런스 카운트를 감소시킵니다. |
| void [RemoveSpecialValue](./removespecialvalue/)() | "특수 값"을 제거합니다. |
| void [SetSpecialValue](./setspecialvalue/)() | "특수 값"을 설정합니다. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n번째 템플릿 인자를 약한 포인터(공유가 아닌)로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있게 합니다. |
...
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | 헤더 문자열 표현을 파싱해 현재 컬렉션에 추가하려 시도합니다. |
