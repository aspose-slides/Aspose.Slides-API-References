...
type: docs
weight: 261
url: /ko/system.net.http.headers/contentdispositionheadervalue/gethashcode/
---
## ContentDispositionHeaderValue::GetHashCode() const 메서드

C# [Object.GetHashCode()](../../../system/object/gethashcode/) 메서드의 유사체. 사용자 정의 객체의 해싱을 가능하게 합니다.
