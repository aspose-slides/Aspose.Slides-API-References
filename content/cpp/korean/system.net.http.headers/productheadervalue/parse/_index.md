...
description: 전달된 문자열을 ProductHeaderValue 클래스의 인스턴스로 변환합니다.
type: docs
weight: 79
url: /ko/system.net.http.headers/productheadervalue/parse/
---
## ProductHeaderValue::Parse(String) 메서드

전달된 문자열을 [ProductHeaderValue](../) 클래스의 인스턴스로 변환합니다.
