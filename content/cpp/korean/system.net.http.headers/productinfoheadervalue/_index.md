...
description: "'User-Agent' 헤더 값에서 제품 또는 주석을 나타냅니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new 를 사용해 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, 해당 포인터를 함수 인자로 전달하십시오."
type: docs
weight: 222
url: /ko/system.net.http.headers/productinfoheadervalue/
---
## ProductInfoHeaderValue 클래스
...
| [String](../../system/string/) [get_Comment](./get_comment/)() | 주석을 반환합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](../productheadervalue/)\> [get_Product](./get_product/)() | 제품을 반환합니다. |
...
| static **int32_t** [GetProductInfoLength](./getproductinfolength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ProductInfoHeaderValue](./)\>\&) | 지정된 인덱스부터 전달된 문자열을 [ProductInfoHeaderValue](./) 클래스의 인스턴스로 변환합니다. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ProductInfoHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | 전달된 문자열을 [ProductInfoHeaderValue](./) 클래스의 인스턴스로 변환합니다. |
| [ProductInfoHeaderValue](./productinfoheadervalue/)([String](../../system/string/), [String](../../system/string/)) | 새 인스턴스를 구성합니다. |
| [ProductInfoHeaderValue](./productinfoheadervalue/)([System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](../productheadervalue/)\>) | 새 인스턴스를 구성합니다. |
| [ProductInfoHeaderValue](./productinfoheadervalue/)([String](../../system/string/)) | 새 인스턴스를 구성합니다. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ProductInfoHeaderValue](./)\>\&) | [ProductInfoHeaderValue](./) 클래스로 전달된 문자열을 변환하려 시도합니다. |
