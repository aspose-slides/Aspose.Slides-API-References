...
description: 지정된 인덱스에서 전달된 문자열을 ProductInfoHeaderValue 클래스의 인스턴스로 변환합니다.
type: docs
weight: 105
url: /ko/system.net.http.headers/productinfoheadervalue/getproductinfolength/
---
## ProductInfoHeaderValue::GetProductInfoLength(String, int32_t, System::SharedPtr\<ProductInfoHeaderValue\>\&) 메서드

Converts a passed string from the specified index to an instance of the [ProductInfoHeaderValue](../) 클래스.
