...
description: 출력용 'not same' 단언 실패를 포맷합니다.
type: docs
weight: 66
url: /ko/system.testpredicates.details/notsamefailure/
---
## System::TestPredicates::Details::NotSameFailure(const char *, const char *, T1\&, T2\&) 함수

출력용 'not same' 단언 실패를 포맷합니다.
