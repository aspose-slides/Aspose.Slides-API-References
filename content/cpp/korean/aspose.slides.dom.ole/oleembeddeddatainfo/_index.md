...
description: OLE 개체에 대한 임베드된 데이터 정보를 나타냅니다.
type: docs
weight: 1
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 IEC 60559:1989에 따르면 NaN은 어떤 값과도( NaN 포함) 같지 않음에도 불구하고 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 IEC 60559:1989에 따르면 NaN은 어떤 값과도( NaN 포함) 같지 않음에도 불구하고 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부용도 전용입니다. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | 임베드된 OLE 개체의 파일 데이터를 반환합니다. 읽기 전용 **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | 현재 임베드된 OLE 개체의 파일 확장자를 반환합니다. 읽기 전용 [System::String](../../system/string/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 개체가 targetType으로 설명된 유형의 인스턴스를 나타내는지 확인합니다. C# 'is' 연산자와 유사합니다. |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | OLE 개체용 새로운 임베드 데이터 정보를 생성합니다. |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | OLE 개체용 임베드 데이터 정보의 새 인스턴스를 생성합니다. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | 값 형식 개체와 nullptr를 참조 비교합니다. |
...
* 클래스 [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* 네임스페이스 [Aspose::Slides::DOM::Ole](../)
* 라이브러리 [Aspose.Slides](../../)