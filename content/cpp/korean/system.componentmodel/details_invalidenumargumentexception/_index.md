...
type: docs
weight: 66
url: /ko/system.componentmodel/details_invalidenumargumentexception/
---
## Details_InvalidEnumArgumentException 클래스
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 현재 객체가 나타내는 예외와 연결된 HRESULT 코드를 나타내는 32비트 정수 값을 반환합니다. |
