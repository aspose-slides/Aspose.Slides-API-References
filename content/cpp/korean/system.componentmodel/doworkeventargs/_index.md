...
description: "DoWork 이벤트 인수. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 래핑하고 이 포인터를 인수로 함수에 전달하십시오."
type: docs
weight: 92
url: /ko/system.componentmodel/doworkeventargs/
---
## DoWorkEventArgs 클래스

DoWork 이벤트 인수. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 만들면 런타임 오류 및/또는 어설션 결함이 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고 이 포인터를 인수로 함수에 전달하십시오.
...
| 메서드 | 설명 |
| --- | --- |
|  [CancelEventArgs](../canceleventargs/canceleventargs/)(**bool**) | 생성자. |
|  [CancelEventArgs](../canceleventargs/canceleventargs/)() | 생성자; Cancel 속성을 false로 설정합니다. |
|  [DoWorkEventArgs](./doworkeventargs/)(const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 인수 인스턴스를 생성합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않음). |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않음). |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Argument](./get_argument/)() | Argument 속성을 가져옵니다; 구현되지 않음. |
| **bool** [get_Cancel](../canceleventargs/get_cancel/)() | 이벤트가 취소되어야 하는지를 나타내는 값을 가져옵니다. |
| [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Result](./get_result/)() | Result 속성을 가져옵니다; 구현되지 않음. |
...
| void [set_Cancel](../canceleventargs/set_cancel/)(**bool**) | 이벤트가 취소되어야 하는지를 나타내는 값을 설정합니다. |
| void [set_Result](./set_result/)(const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Result 속성을 설정합니다; 구현되지 않음. |
...
| 필드 | 설명 |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | \"empty\" [EventArgs](../../system/eventargs/) 공유 포인터(null 포인터)를 나타내는 정적 멤버입니다. |

## 참고

* 클래스 [CancelEventArgs](../canceleventargs/)
