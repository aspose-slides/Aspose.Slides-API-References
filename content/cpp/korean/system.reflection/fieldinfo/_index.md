...
description: 필드의 특성을 검색하고 필드 메타데이터에 대한 액세스를 제공합니다.
type: docs
weight: 92
url: /ko/system.reflection/fieldinfo/
---
## FieldInfo 클래스
...
| 메서드 | 설명 |
| --- | --- |
| void [AddAttribute](../memberinfo/addattribute/)(const [ObjectPtr](../memberinfo/objectptr/)\&) | 컬렉션에 특성을 추가합니다. |
...
| [TypeInfo](../../system/typeinfo/) [get_FieldType](./get_fieldtype/)() | 속성 타입을 가져옵니다. |
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | 멤버 전체 이름을 가져옵니다. 수동 구현 부분에서는 다를 수 있습니다. |
| **bool** [get_IsStatic](./get_isstatic/)() | 필드가 정적(static)인지 여부를 나타내는 값을 가져옵니다. |
| virtual [MemberTypes](../membertypes/) [get_MemberType](../memberinfo/get_membertype/)() const | [System::Reflection::MemberTypes](../membertypes/) 값을 가져와 멤버 유형(메서드, 생성자, 이벤트 등)을 나타냅니다. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | 현재 객체가 나타내는 타입에 적용된 모든 사용자 정의 특성을 나타내는 객체들을 포함하는 배열을 반환합니다. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | 현재 객체가 나타내는 타입에 적용된 모든 사용자 정의 특성을 나타내는 객체들을 포함하는 배열을 반환합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [GetValue](./getvalue/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 특정 객체로부터 속성 값을 가져옵니다. |
...
| void [SetValue](./setvalue/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 특정 객체에 속성 값을 설정합니다. |
