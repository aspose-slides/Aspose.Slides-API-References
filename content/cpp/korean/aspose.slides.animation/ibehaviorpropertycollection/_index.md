...
| 메서드 | 설명 |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | 컬렉션에 새 속성을 추가합니다. |
...
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | [ICollection](../../system.collections.generic/icollection/)에 특정 값이 포함되어 있는지 확인합니다. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 컬렉션의 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. 이 반복자는 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/)가 T의 복사 객체를 반환하므로 참조된 객체를 변경하는 데 사용할 수 없습니다. |
...
| virtual int [get_Count](../../system.collections.generic/icollection/get_count/)() const | 컬렉션의 요소 개수를 반환합니다. |
...
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | 지정된 인덱스의 요소를 반환합니다. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | 지정된 인덱스에 요소를 설정합니다. |
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | [IList](../../system.collections.generic/ilist/)에서 속성 값으로 특정 항목의 인덱스를 결정합니다. |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | 컨테이너에서 항목이 처음 나타나는 인덱스를 반환합니다. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | 지정된 인덱스에 새 속성(지정된 속성 값)을 컬렉션에 삽입합니다. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | 지정된 위치에 요소를 삽입하고 다른 요소들을 이동시킵니다. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로 아무것도 복사하지 않으며, 새 객체를 초기화하고 하위 클래스를 복사 구성하도록 허용합니다. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | 이동 할당 연산자입니다. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | 이동 할당 연산자입니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자입니다. 실제로 아무것도 복사하지 않으며, 새 객체를 초기화하고 하위 클래스를 복사 구성하도록 허용합니다. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | 컬렉션에서 지정된 속성을 제거합니다. |
...
| virtual  [~ICollection](../../system.collections.generic/icollection/~icollection/)() | 소멸자입니다. |
