...
type: docs
weight: 14
url: /ko/aspose.slides.animation/behavior/
---
## Behavior 클래스
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# 스타일에서 값형 객체를 비교합니다. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 IEC 60559:1989에 의하면 NaN은 어떤 값과도 같지 않으며 NaN 자체와도 같지 않지만, C# 스타일 부동소수점 비교를 모방하여 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 IEC 60559:1989에 의하면 NaN은 어떤 값과도 같지 않으며 NaN 자체와도 같지 않지만, C# 스타일 부동소수점 비교를 모방하여 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() override | 애니메이션 동작이 누적되는지 여부를 나타냅니다. [NullableBool](../../aspose.slides/nullablebool/)를 읽습니다. |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() override | 현재 애니메이션 동작이 다른 실행 중인 애니메이션과 결합되는지 여부를 나타냅니다. [BehaviorAdditiveType](../behavioradditivetype/)를 읽습니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() override | 동작의 속성을 나타냅니다. 읽기 전용 [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() override | 효과 동작의 타이밍 속성을 나타냅니다. [ITiming](../itiming/)를 읽습니다. |
...
| void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | 애니메이션 동작이 누적되는지 여부를 나타냅니다. [NullableBool](../../aspose.slides/nullablebool/)에 씁니다. |
| void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | 현재 애니메이션 동작이 다른 실행 중인 애니메이션과 결합되는지 여부를 나타냅니다. [BehaviorAdditiveType](../behavioradditivetype/)에 씁니다. |
| void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | 효과 동작의 타이밍 속성을 나타냅니다. [ITiming](../itiming/)에 씁니다. |
