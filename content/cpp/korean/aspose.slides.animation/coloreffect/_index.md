...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도 (NaN 포함) 같지 않음에도 불구하고 동일하게 간주되는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값과도 (NaN 포함) 같지 않음에도 불구하고 동일하게 간주되는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOffset](../icoloroffset/)\> [get_By](./get_by/)() override | 색상 애니메이션에 대한 상대 오프셋 값을 설명합니다. 읽기 [IColorOffset](../icoloroffset/). |
| [Aspose::Slides::Animation::ColorSpace](../colorspace/) [get_ColorSpace](./get_colorspace/)() override | 동작의 색 공간을 나타냅니다. 읽기 [Animation::ColorSpace](../colorspace/). |
| [ColorDirection](../colordirection/) [get_Direction](./get_direction/)() override | 색상 휠을 따라 색조를 순환하는 방향을 지정합니다. 읽기 [ColorDirection](../colordirection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_From](./get_from/)() override | 이 값은 동작의 시작 색상을 지정하는 데 사용됩니다. 읽기 [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_To](./get_to/)() override | 애니메이션 색상 변화에 대한 결과 색상을 설명합니다. 읽기 [IColorFormat](../../aspose.slides/icolorformat/). |
...
| void [set_By](./set_by/)([System::SharedPtr](../../system/sharedptr/)\<[IColorOffset](../icoloroffset/)\>) override | 색상 애니메이션에 대한 상대 오프셋 값을 설명합니다. 쓰기 [IColorOffset](../icoloroffset/). |
| void [set_ColorSpace](./set_colorspace/)([Aspose::Slides::Animation::ColorSpace](../colorspace/)) override | 동작의 색 공간을 나타냅니다. 쓰기 [Animation::ColorSpace](../colorspace/). |
| void [set_Direction](./set_direction/)([ColorDirection](../colordirection/)) override | 색상 휠을 따라 색조를 순환하는 방향을 지정합니다. 쓰기 [ColorDirection](../colordirection/). |
| void [set_From](./set_from/)([System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\>) override | 이 값은 동작의 시작 색상을 지정하는 데 사용됩니다. 쓰기 [IColorFormat](../../aspose.slides/icolorformat/). |
...
| void [set_To](./set_to/)([System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\>) override | 애니메이션 색상 변화에 대한 결과 색상을 설명합니다. 쓰기 [IColorFormat](../../aspose.slides/icolorformat/). |
