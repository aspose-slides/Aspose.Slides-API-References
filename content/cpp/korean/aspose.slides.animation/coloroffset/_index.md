...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 여기서는 그렇다고 가정합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 여기서는 그렇다고 가정합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| **float** [get_Value0](./get_value0/)() override | 오프셋의 첫 번째 값을 정의합니다. **float**을 읽습니다. |
| **float** [get_Value1](./get_value1/)() override | 오프셋의 두 번째 값을 정의합니다. **float**을 읽습니다. |
| **float** [get_Value2](./get_value2/)() override | 오프셋의 세 번째 값을 정의합니다. **float**을 읽습니다. |
...
| void [set_Value0](./set_value0/)(**float**) override | 오프셋의 첫 번째 값을 정의합니다. **float**을 씁니다. |
| void [set_Value1](./set_value1/)(**float**) override | 오프셋의 두 번째 값을 정의합니다. **float**을 씁니다. |
| void [set_Value2](./set_value2/)(**float**) override | 오프셋의 세 번째 값을 정의합니다. **float**을 씁니다. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 공유 참조 카운트를 증가시킵니다. 직접 호출하면 안 되며, 스마트 포인터나 ThisProtector를 사용하세요. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 공유 참조 카운트를 감소시키고 반환합니다. 직접 호출하면 안 되며, 스마트 포인터나 ThisProtector를 사용하세요. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | 약한 참조 카운트를 증가시킵니다. 직접 호출하면 안 되며, 스마트 포인터나 ThisProtector를 사용하세요. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | 약한 참조 카운트를 감소시킵니다. 직접 호출하면 안 되며, 스마트 포인터나 ThisProtector를 사용하세요. |
| virtual  [~Object](../../system/object/~object/)() | 객체를 파괴합니다. 모든 내부 데이터 구조를 해제합니다. |

## 참고

* 클래스 [IColorOffset](../icoloroffset/)
