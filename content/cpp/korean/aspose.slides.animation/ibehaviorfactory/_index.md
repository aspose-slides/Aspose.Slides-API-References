...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorEffect](../icoloreffect/)\> [CreateColorEffect](./createcoloreffect/)() | 컬러 효과를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommandEffect](../icommandeffect/)\> [CreateCommandEffect](./createcommandeffect/)() | 명령 효과를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFilterEffect](../ifiltereffect/)\> [CreateFilterEffect](./createfiltereffect/)() | 필터 효과를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMotionEffect](../imotioneffect/)\> [CreateMotionEffect](./createmotioneffect/)() | 모션 효과를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPropertyEffect](../ipropertyeffect/)\> [CreatePropertyEffect](./createpropertyeffect/)() | 속성 효과를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRotationEffect](../irotationeffect/)\> [CreateRotationEffect](./createrotationeffect/)() | 회전 효과를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IScaleEffect](../iscaleeffect/)\> [CreateScaleEffect](./createscaleeffect/)() | 스케일 효과를 생성합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISetEffect](../iseteffect/)\> [CreateSetEffect](./createseteffect/)() | 셋 효과를 생성합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, C# 스타일 부동소수점 비교를 흉내 내어 두 NaN이 동일하다고 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, C# 스타일 부동소수점 비교를 흉내 내어 두 NaN이 동일하다고 간주합니다. |
