...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만 이를 무시합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만 이를 무시합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | 애니메이션 동작이 누적되는지를 나타냅니다. [NullableBool](../../aspose.slides/nullablebool/)를 읽으십시오. |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | 현재 애니메이션 동작이 다른 실행 중인 애니메이션과 결합되는지를 나타냅니다. [BehaviorAdditiveType](../behavioradditivetype/)를 읽으십시오. |
| **float** [get_By](./get_by/)() override | **float** 애니메이션에 대한 상대 오프셋 값을 설명합니다. **float**를 읽으십시오. |
| **float** [get_From](./get_from/)() override | **float** 애니메이션의 시작 값을 설명합니다. **float**를 읽으십시오. |
...
| **float** [get_To](./get_to/)() override | **float** 애니메이션의 종료 값을 설명합니다. **float**를 읽으십시오. |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | 애니메이션 동작이 누적되는지를 나타냅니다. [NullableBool](../../aspose.slides/nullablebool/)에 씁니다. |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | 현재 애니메이션 동작이 다른 실행 중인 애니메이션과 결합되는지를 나타냅니다. [BehaviorAdditiveType](../behavioradditivetype/)에 씁니다. |
| void [set_By](./set_by/)(**float**) override | 애니메이션에 대한 상대 오프셋 값을 설명합니다. **float**에 씁니다. |
| void [set_From](./set_from/)(**float**) override | 애니메이션의 시작 값을 설명합니다. **float**에 씁니다. |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | 효과 동작의 타이밍 속성을 나타냅니다. [ITiming](../itiming/)에 씁니다. |
| void [set_To](./set_to/)(**float**) override | 애니메이션의 종료 값을 설명합니다. **float**에 씁니다. |
...
* 클래스 [IRotationEffect](../irotationeffect/)
