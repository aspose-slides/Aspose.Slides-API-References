...
description: 애니메이션 동작에 대한 속성 유형을 나타냅니다. 다음 속성 목록을 에서 따릅니다.
type: docs
weight: 183
url: /ko/aspose.slides.animation/ibehaviorproperty/
---
## IBehaviorProperty 클래스

애니메이션 동작에 대한 속성 유형을 나타냅니다. 다음 속성 목록을 [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) 및 [https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx)에서 따릅니다.
...
| virtual **bool** [get_IsCustom](./get_iscustom/)() | 이 속성이 사양의 사전 정의된 속성 목록 [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx)에 포함되지 않는지 표시합니다. |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | 속성값 |
