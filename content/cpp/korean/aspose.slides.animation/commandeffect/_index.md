...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
...
| [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() override | 명령 문자열을 정의합니다. 읽기 [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() override | 명령 효과의 대상 형태를 정의합니다. 읽기 [IShape](../../aspose.slides/ishape/). |
...
| [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() override | 동작의 명령 효과 유형을 정의합니다. 읽기 [CommandEffectType](../commandeffecttype/). |
...
| void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) override | 명령 문자열을 정의합니다. 쓰기 [System::String](../../system/string/). |
| void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | 명령 효과의 대상 형태를 정의합니다. 쓰기 [IShape](../../aspose.slides/ishape/). |
...
| void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) override | 동작의 명령 효과 유형을 정의합니다. 쓰기 [CommandEffectType](../commandeffecttype/). |
...
* 클래스 [ICommandEffect](../icommandeffect/)
