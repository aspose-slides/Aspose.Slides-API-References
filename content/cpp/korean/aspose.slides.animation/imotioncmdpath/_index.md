...
| virtual [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() | 명령 유형을 지정합니다. [MotionCommandPathType](../motioncommandpathtype/)를 읽으십시오. |
| virtual **bool** [get_IsRelative](./get_isrelative/)() | 명령 좌표가 상대적인지 여부를 결정합니다. **bool**를 읽으십시오. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | 명령의 점들을 지정합니다. [System::Drawing::PointF](../../system.drawing/pointf/)[]을(를) 읽으십시오. |
| virtual [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() | 명령 점 유형을 지정합니다. [MotionPathPointsType](../motionpathpointstype/)를 읽으십시오. |
...
| virtual void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) | 명령 유형을 지정합니다. [MotionCommandPathType](../motioncommandpathtype/)에 씁니다. |
| virtual void [set_IsRelative](./set_isrelative/)(**bool**) | 명령 좌표가 상대적인지 여부를 결정합니다. **bool**에 씁니다. |
| virtual void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) | 명령의 점들을 지정합니다. [System::Drawing::PointF](../../system.drawing/pointf/)[]에 씁니다. |
| virtual void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) | 명령 점 유형을 지정합니다. [MotionPathPointsType](../motionpathpointstype/)에 씁니다. |
