...
description: 지정된 부울 값을 동등한 32비트 부호 없는 정수로 변환합니다.
type: docs
weight: 170
url: /ko/system/convert/touint32/
---
## Convert::ToUInt32(bool) 메서드

지정된 bool 값을 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static constexpr uint32_t System::Convert::ToUInt32(bool value)
```
## Convert::ToUInt32(uint8_t) 메서드

지정된 8비트 부호 없는 정수를 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static constexpr uint32_t System::Convert::ToUInt32(uint8_t value)
```
## Convert::ToUInt32(int8_t) 메서드

지정된 8비트 부호 있는 정수를 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static uint32_t System::Convert::ToUInt32(int8_t value)
```
## Convert::ToUInt32(uint16_t) 메서드

지정된 16비트 부호 없는 정수를 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static constexpr uint32_t System::Convert::ToUInt32(uint16_t value)
```
## Convert::ToUInt32(int16_t) 메서드

지정된 16비트 부호 있는 정수를 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static uint32_t System::Convert::ToUInt32(int16_t value)
```
## Convert::ToUInt32(uint32_t) 메서드

지정된 32비트 부호 없는 정수를 반환합니다.

```cpp
static constexpr uint32_t System::Convert::ToUInt32(uint32_t value)
```
## Convert::ToUInt32(int32_t) 메서드

지정된 32비트 부호 있는 정수를 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static uint32_t System::Convert::ToUInt32(int32_t value)
```
## Convert::ToUInt32(uint64_t) 메서드

지정된 64비트 부호 없는 정수를 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static uint32_t System::Convert::ToUInt32(uint64_t value)
```
## Convert::ToUInt32(int64_t) 메서드

지정된 64비트 부호 있는 정수를 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static uint32_t System::Convert::ToUInt32(int64_t value)
```
## Convert::ToUInt32(float) 메서드

지정된 float 값을 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static uint32_t System::Convert::ToUInt32(float value)
```
## Convert::ToUInt32(double) 메서드

지정된 double 값을 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static uint32_t System::Convert::ToUInt32(double value)
```
## Convert::ToUInt32(const Decimal\&) 메서드

지정된 decimal 값을 동등한 32비트 부호 없는 정수로 변환합니다.

```cpp
static uint32_t System::Convert::ToUInt32(const Decimal &value)
```
## Convert::ToUInt32(char_t) 메서드

지정된 유니코드 문자를 동등한 32비트 부호 없는 정수로 변환합니다.
...
```
## Convert::ToUInt32(std::nullptr_t) 메서드

지정된 null 문자열을 동등한 부호 없는 32비트 정수 값으로 변환합니다.
...
## Convert::ToUInt32(const char_t *) 메서드

숫자 문자열 표현을 포함하는 c-문자열을 동등한 부호 없는 32비트 정수 값으로 변환합니다.
...
지정된 c-문자열이 나타내는 숫자와 동일한 부호 없는 32비트 정수 값

## Convert::ToUInt32(const String\&) 메서드

숫자 문자열 표현을 포함하는 문자열을 동등한 부호 없는 32비트 정수 값으로 변환합니다.
...
지정된 문자열이 나타내는 숫자와 동일한 부호 없는 32비트 정수 값

## Convert::ToUInt32(const String\&, int) 메서드

지정된 진법으로 숫자 문자열 표현을 포함하는 문자열을 동등한 부호 없는 32비트 정수 값으로 변환합니다.
...
## Convert::ToUInt32(const String\&, const SharedPtr\<IFormatProvider\>\&) 메서드

제공된 서식 정보를 사용하여 숫자 문자열 표현을 포함하는 문자열을 동등한 부호 없는 32비트 정수 값으로 변환합니다.
...
## Convert::ToUInt32(const String\&, const SharedPtr\<Globalization::CultureInfo\>\&) 메서드
...
## Convert::ToUInt32(const String\&, const SharedPtr\<Globalization::NumberFormatInfo\>\&) 메서드 
...
## Convert::ToUInt32(const String\&, std::nullptr_t) 메서드 
...
## Convert::ToUInt32(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&) 메서드

제공된 서식 정보와 숫자 스타일을 사용하여 숫자 문자열 표현을 포함하는 문자열을 동등한 부호 없는 32비트 정수 값으로 변환합니다.
...
| --- | --- | --- |
| value | const [String](../../string/)\& | 변환할 문자열 |
| styles | [Globalization::NumberStyles](../../../system.globalization/numberstyles/) | NumberStyles 열거형 값들의 비트 OR 조합으로, 허용되는 문자열 표현 스타일을 지정 |
| provider | const [SharedPtr](../../sharedptr/)\<[IFormatProvider](../../iformatprovider/)\>\& | 문자열 서식 정보를 포함하는 객체에 대한 포인터 |
...
## Convert::ToUInt32(const String\&, Globalization::NumberStyles, const SharedPtr\<Globalization::CultureInfo\>\&) 메서드 
...
## Convert::ToUInt32(const String\&, Globalization::NumberStyles, const SharedPtr\<Globalization::NumberFormatInfo\>\&) 메서드 
...
## Convert::ToUInt32(const String\&, Globalization::NumberStyles, std::nullptr_t) 메서드 
...
## Convert::ToUInt32(const SharedPtr\<Object\>\&, const SharedPtr\<IFormatProvider\>\&) 메서드

지정된 박싱 값을 동등한 부호 없는 32비트 정수 값으로 변환합니다.
