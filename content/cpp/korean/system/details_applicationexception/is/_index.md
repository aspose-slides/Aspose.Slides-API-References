...
type: docs
weight: 27
url: /ko/system/details_applicationexception/is/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| target | const [System::TypeInfo](../../typeinfo/)\& | [TypeInfo](../../typeinfo/) 구조는 현재 객체를 테스트할 유형을 설명합니다. |
...
* 클래스 [Details_ApplicationException](../)
* 네임스페이스 [System](../../)
* 라이브러리 [Aspose.Slides](../../../)