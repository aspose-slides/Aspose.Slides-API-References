...
description: 현재 객체가 나타내는 시간 간격이 지정된 객체가 나타내는 시간 간격보다 짧거나 같은지 판단합니다.
type: docs
weight: 391
url: /ko/system/timespan/operator_less_equal/
---
## TimeSpan::operator<=(TimeSpan) const method


현재 객체가 나타내는 시간 간격이 지정된 객체가 나타내는 시간 간격보다 짧거나 같은지 확인합니다.
...
현재 객체가 나타내는 시간 간격이 **value**가 나타내는 시간 간격보다 짧거나 같으면 True, 그렇지 않으면 - false
