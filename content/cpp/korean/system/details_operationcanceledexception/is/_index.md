...
type: docs
weight: 27
url: /ko/system/details_operationcanceledexception/is/
---
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| target | const [System::TypeInfo](../../typeinfo/)\& | [TypeInfo](../../typeinfo/) 현재 객체를 테스트할 타입을 설명하는 구조체. |
...
객체가 targetType으로 설명된 타입의 인스턴스인지 확인합니다. C# 'is' 연산자와 유사합니다. 
