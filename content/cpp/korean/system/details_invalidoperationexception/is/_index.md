...
type: docs
weight: 27
url: /ko/system/details_invalidoperationexception/is/
---
## Details_InvalidOperationException::Is(const System::TypeInfo\&) const 메서드
...
객체가 태그된 유형이거나 해당 하위 유형이면 True, 그렇지 않으면 false.
...
* 클래스 [Details_InvalidOperationException](../)
* 네임스페이스 [System](../../)
* 라이브러리 [Aspose.Slides](../../../)