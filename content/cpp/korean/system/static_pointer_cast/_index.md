...
description: static_cast를 사용하여 스마트 포인터를 캐스팅합니다.
type: docs
weight: 2913
url: /ko/system/static_pointer_cast/
---
## System::static_pointer_cast(SmartPtr\<X\> const\&) 함수

static_cast를 사용하여 스마트 포인터를 캐스팅합니다.
