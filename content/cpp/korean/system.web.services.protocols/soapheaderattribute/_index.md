...
description: "XML 웹 서비스 메서드 또는 XML 웹 서비스 클라이언트가 처리할 수 있는 SOAP 헤더를 지정합니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용해 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고 해당 포인터를 함수 인자로 전달하여 사용하십시오."
type: docs
weight: 92
url: /ko/system.web.services.protocols/soapheaderattribute/
---
...
| [SoapHeaderDirection](../soapheaderdirection/) [get_Direction](./get_direction/)() | SOAP 헤더 방향을 가져옵니다. |
| [String](../../system/string/) [get_MemberName](./get_membername/)() | SOAP 헤더 내용을 수신하는 데 사용되는 XML SOAP 서비스의 멤버 변수 이름을 가져옵니다. |
| **bool** [get_Required](./get_required/)() | 수신자 XML [Web](../../system.web/) 서비스 또는 XML [Web](../../system.web/) 서비스 클라이언트가 SOAP 헤더를 이해하고 처리해야 하는지를 나타내는 값을 가져옵니다. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 레퍼런스 카운터 데이터 구조를 가져옵니다. |
| static [Object::ptr](../../system/object/ptr/) [GetCustomAttribute](../../system/attribute/getcustomattribute/)(const [TypeInfo](../../system/typeinfo/)\&, const [TypeInfo](../../system/typeinfo/)\&) | 지정된 타입에 적용된 지정된 타입의 사용자 정의 특성을 반환합니다. |
| static [ArrayPtr](../../system/arrayptr/)\<[Object::ptr](../../system/object/ptr/)\> [GetCustomAttributes](../../system/attribute/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&) | 지정된 타입에 적용된 모든 사용자 정의 특성을 반환합니다. |
...
| void [set_Direction](./set_direction/)([SoapHeaderDirection](../soapheaderdirection/)) | SOAP 헤더 방향을 설정합니다. |
| void [set_MemberName](./set_membername/)([String](../../system/string/)) | SOAP 헤더 내용을 수신하는 데 사용되는 XML SOAP 서비스의 멤버 변수 이름을 설정합니다. |
| void [set_Required](./set_required/)(**bool**) | 수신자 XML [Web](../../system.web/) 서비스 또는 XML [Web](../../system.web/) 서비스 클라이언트가 SOAP 헤더를 이해하고 처리해야 하는지를 나타내는 값을 설정합니다. |
...
|  [SoapHeaderAttribute](./soapheaderattribute/)([String](../../system/string/)) | 새 인스턴스를 생성합니다. |
