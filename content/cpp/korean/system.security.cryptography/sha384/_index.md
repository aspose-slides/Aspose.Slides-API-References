...
description: "입력 데이터에 대해 SHA384 해시를 계산합니다. C++에서 SHA384는 추상 클래스가 아닙니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용해 이 유형의 인스턴스를 만들지 마세요. 그렇게 하면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 System::SmartPtr 포인터로 래핑하고 해당 포인터를 인수로 함수에 전달하십시오."
type: docs
weight: 599
url: /ko/system.security.cryptography/sha384/
---
## SHA384 클래스


입력 데이터에 대해 [SHA384](./) 해시를 계산합니다. C++에서는 [SHA384](./)가 추상 클래스가 아닙니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용해 이 유형의 인스턴스를 만들지 마세요. 그렇지 않으면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고 해당 포인터를 함수 인수로 전달하세요.
...
| static [SharedPtr](../../system/sharedptr/)\<[SHA384](./)\> [Create](./create/)() | 해시 알고리즘 인스턴스를 생성합니다. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA384](./)\> [Create](./create/)(const [String](../../system/string/)\&) | 해시 알고리즘 인스턴스를 생성합니다. |
