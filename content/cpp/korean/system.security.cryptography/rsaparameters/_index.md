...
description: "RSA 알고리즘 매개변수의 데이터 구조입니다. 이 유형은 스택에 할당하고 값 또는 참조로 함수를 호출할 때 전달해야 합니다. 이 유형의 객체를 관리하기 위해 System::SmartPtr 클래스를 사용하지 마십시오."
type: docs
weight: 768
url: /ko/system.security.cryptography/rsaparameters/
---
## RSAParameters 구조체

[Data](../../system.data/) 구조체는 [RSA](../rsa/) 알고리즘 매개변수입니다. 이 유형은 스택에 할당하고 값이나 참조에 의해 함수에 전달해야 합니다. [System::SmartPtr](../../system/smartptr/) 클래스를 사용하여 이 유형의 객체를 관리하지 마십시오.
...
|  [RSAParameters](./rsaparameters/)() | 생성자. |
