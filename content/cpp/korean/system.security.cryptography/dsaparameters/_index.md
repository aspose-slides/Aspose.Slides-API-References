...
description: "DSA 알고리즘 매개변수의 데이터 구조입니다. 이 유형은 스택에 할당하고 값 또는 참조에 의해 함수에 전달되어야 합니다. 이 유형의 객체를 관리하기 위해 System::SmartPtr 클래스를 절대로 사용하지 마십시오."
type: docs
weight: 703
url: /ko/system.security.cryptography/dsaparameters/
---
## DSAParameters struct


[Data](../../system.data/)는 [DSA](../dsa/) 알고리즘 매개변수의 구조입니다. 이 유형은 스택에 할당하고 값 또는 참조에 의해 함수에 전달되어야 합니다. 이 유형의 객체를 관리하기 위해 [System::SmartPtr](../../system/smartptr/) 클래스를 절대로 사용하지 마십시오.
...
| 메서드 | 설명 |
| --- | --- |
|  [DSAParameters](./dsaparameters/)() | 생성자. |
