...
description: "암호화 객체 식별자입니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 절대로 생성하면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 System::SmartPtr 포인터로 래핑하고, 이 포인터를 함수 인수로 전달하십시오."
type: docs
weight: 339
url: /ko/system.security.cryptography/oid/
---
## Oid 클래스

Cryptographic object identifier. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 또는 operator new를 사용하여 이 유형의 인스턴스를 절대로 생성하지 마십시오. 이렇게 하면 런타임 오류 및/또는 어설션 오류가 발생할 수 있습니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 래핑하고, 이 포인터를 인수로 함수에 전달하십시오.
...
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromFriendlyName](./fromfriendlyname/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | 지정된 OID 친숙한 이름에서 OID 객체를 생성합니다. |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromOidValue](./fromoidvalue/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | 지정된 OID 값에서 OID 객체를 생성합니다. |
| [String](../../system/string/) [get_FriendlyName](./get_friendlyname/)() const | 객체의 사용자 친화적 이름을 가져옵니다. |
| [String](../../system/string/) [get_Value](./get_value/)() const | 객체 식별자 문자열을 가져옵니다. |
...
|  [Oid](./oid/)() | 기본 생성자. |
|  [Oid](./oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](./)\>\&) | 복사 생성자. |
|  [Oid](./oid/)(const [String](../../system/string/)\&) | 생성자. |
|  [Oid](./oid/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | 생성자. |
...
| void [set_FriendlyName](./set_friendlyname/)(const [String](../../system/string/)\&) | 객체의 사용자 친화적 이름을 설정합니다. |
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | 객체 식별자 문자열을 설정합니다. |
