...
---
## IExcelDataWorkbook::GetCell(int32_t, int32_t, int32_t) 메서드
...
## IExcelDataWorkbook::GetCell(System::String, int32_t, int32_t) 메서드
...
## IExcelDataWorkbook::GetCell(int32_t, System::String) 메서드
...
| --- | --- | --- |
| worksheetIndex | **int32_t** | 워크시트의 0 기반 인덱스. |
| cellName | [System::String](../../../system/string/) | Excel 스타일 셀 참조(예: "A1", "C5"). |
...
## IExcelDataWorkbook::GetCell(System::String, System::String) 메서드

지정된 워크시트에서 Excel 스타일 셀 이름(예: "B2")을 사용하여 셀을 가져옵니다.
