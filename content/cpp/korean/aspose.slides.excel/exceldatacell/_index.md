...
| **int32_t** [get_Column](./get_column/)() override | 셀의 위치한 워크시트에서 열의 0부터 시작하는 인덱스를 가져옵니다. 읽기 전용 **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 차트 데이터 셀의 이름을 가져옵니다. |
| **int32_t** [get_Row](./get_row/)() override | 셀의 위치한 워크시트에서 행의 0부터 시작하는 인덱스를 가져옵니다. 읽기 전용 **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | [Excel](../) 셀에 포함된 값을 가져옵니다. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nth 템플릿 인자를 약한 포인터로 설정합니다(공유 대신). 컨테이너에 있는 포인터를 약한 모드로 전환할 수 있습니다. |
