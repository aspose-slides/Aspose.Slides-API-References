...
description: COM 인터페이스를 통해 VBA 프로젝트 참조를 생성합니다
type: docs
weight: 196
...
| 메서드 | 설명 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 새 OLE Automation 타입 라이브러리 참조를 생성합니다. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaReferenceFactory](./)\> [get_Instance](./get_instance/)() | VBA 프로젝트 참조 팩터리 정적 인스턴스. 읽기 전용 [VbaReferenceFactory](./). |
...
* 클래스 [IVbaReferenceFactory](../ivbareferencefactory/)
