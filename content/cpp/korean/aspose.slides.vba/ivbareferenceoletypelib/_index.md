...
| virtual [System::String](../../system/string/) [get_Libid](./get_libid/)() | Automation 형식 라이브러리의 식별자를 나타냅니다. [System::String](../../system/string/)을(를) 읽으십시오. |
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | VBA 프로젝트 참조의 이름을 나타냅니다. [System::String](../../system/string/)을(를) 읽으십시오. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType에 의해 설명된 형식의 인스턴스를 나타내는지 확인합니다. C# 'is' 연산자와 유사합니다. |
...
| virtual void [set_Libid](./set_libid/)([System::String](../../system/string/)) | Automation 형식 라이브러리의 식별자를 나타냅니다. [System::String](../../system/string/)에 씁니다. |
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | VBA 프로젝트 참조의 이름을 나타냅니다. [System::String](../../system/string/)에 씁니다. |
