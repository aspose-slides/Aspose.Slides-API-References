...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값(또는 NaN)과도 같지 않음에도 불구하고, C# 스타일 부동소수점 비교를 흉내내어 두 NaN을 동일하게 취급합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값(또는 NaN)과도 같지 않음에도 불구하고, C# 스타일 부동소수점 비교를 흉내내어 두 NaN을 동일하게 취급합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | VBA 프로젝트 참조의 이름을 나타냅니다. [System::String](../../system/string/)를 읽습니다. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로는 아무것도 복사하지 않고 새 객체를 초기화하고 서브클래스 복사를 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자입니다. 실제로는 아무것도 복사하지 않고 새 객체를 초기화하고 서브클래스 복사를 가능하게 합니다. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | VBA 프로젝트 참조의 이름을 나타냅니다. [System::String](../../system/string/)에 씁니다. |
