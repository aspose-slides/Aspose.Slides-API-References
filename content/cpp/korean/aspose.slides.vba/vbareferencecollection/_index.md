...
| 메서드 | 설명 |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>) override | 새 참조를 컬렉션에 추가합니다. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 컬렉션에서 마지막 const 한정 요소(있는 경우) 바로 다음을 가리키는 반복자를 반환합니다. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>\>, **int32_t**) override | 컬렉션의 모든 요소를 지정된 배열에 복사합니다. |
| [iterator](./iterator/) [end](./end/)() | 컬렉션에서 마지막 요소(있는 경우) 바로 다음을 가리키는 반복자를 반환합니다. |
| [const_iterator](./const_iterator/) [end](./end/)() const | 컬렉션의 const 한정 인스턴스에서 마지막 요소(있는 경우) 바로 다음을 가리키는 반복자를 반환합니다. |
...
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | 컬렉션에 대한 접근이 동기화(스레드 안전)되어 있는지를 나타내는 값을 반환합니다. 읽기 전용 **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>\>\> [GetEnumerator](./getenumerator/)() override | 컬렉션을 순회하는 열거자를 반환합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [idx_get](./idx_get/)(**int32_t**) override | 지정된 인덱스의 요소를 반환합니다. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | 시퀀스에서 지정된 조건을 만족하는 요소 개수를 반환합니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문문의 잠금을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문문의 잠금 해제를 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 컬렉션의 const 한정 인스턴스에서 마지막 요소(있는 경우) 바로 다음을 가리키는 반복자를 반환합니다. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 컬렉션에서 마지막 요소(있는 경우) 바로 다음을 가리키는 반복자를 반환합니다. |
...
* 클래스 [IVbaReferenceCollection](../ivbareferencecollection/)
