...
---
## ISmartArtNodeCollection 클래스

[SmartArt](../smartart/) 노드의 컬렉션을 나타냅니다.
...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [AddNode](./addnode/)() | 새 노드 또는 하위 노드를 추가합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [AddNodeByPosition](./addnodebyposition/)(**int32_t**) | 노드 컬렉션에서 선택된 위치에 새 노드를 추가합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어느 값과도(NaN 포함) 같지 않음에도 불구하고 C# 스타일의 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어느 값과도(NaN 포함) 같지 않음에도 불구하고 C# 스타일의 부동소수점 비교를 에뮬레이트합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [idx_get](./idx_get/)(**int32_t**) | 인덱스로 노드를 반환합니다. 읽기 전용 [ISmartArtNode](../ismartartnode/) |
...
| virtual void [RemoveNode](./removenode/)(**int32_t**) | 인덱스로 노드 또는 하위 노드를 제거합니다. |
| virtual void [RemoveNode](./removenode/)([System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\>) | 노드 또는 하위 노드를 제거합니다. |
