...
description: 부모 모양을 반환하고, 부모 객체가 IShape 인터페이스를 구현하지 않으면 null을 반환합니다. 읽기 전용 IShape.
type: docs
weight: 66
url: /ko/aspose.slides/itextframe/get_parentshape/
---
## ITextFrame::get_ParentShape() 메서드

부모 모양을 반환하고, 부모 객체가 [IShape](../../ishape/) 인터페이스를 구현하지 않으면 null을 반환합니다. 읽기 전용 [IShape](../../ishape/).
