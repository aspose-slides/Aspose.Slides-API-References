...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | 컬렉션의 끝에 [Portion](../portion/)를 추가합니다. |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | [ICollection](../../system.collections.generic/icollection/)에 특정 값이 포함되어 있는지 확인합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [idx_get](./idx_get/)(**int32_t**) | 지정된 인덱스에 있는 요소를 가져옵니다. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | 컬렉션에서 특정 부분의 인덱스를 결정합니다. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | 지정된 인덱스에 [Portion](../portion/)를 컬렉션에 삽입합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Reverse](../../system.collections.generic/ienumerable/linq_reverse/)() | 시퀀스의 요소 순서를 반대로 합니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현하여 잠금을 수행합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 경비 객체를 사용하십시오. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | 특정 객체의 첫 번째 발생을 [ICollection](../../system.collections.generic/icollection/)에서 제거합니다. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 컬렉션에서 지정된 인덱스에 있는 요소를 제거합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 구현하여 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 경비 객체를 사용하십시오. |
