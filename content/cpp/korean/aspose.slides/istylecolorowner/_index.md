...
type: docs
weight: 3901
url: /ko/aspose.slides/istylecolorowner/
---
## IStyleColorOwner 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음에도 불구하고 동일하게 간주되는 C#-style 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음에도 불구하고 동일하게 간주되는 C#-style 부동소수점 비교를 에뮬레이트합니다. |
