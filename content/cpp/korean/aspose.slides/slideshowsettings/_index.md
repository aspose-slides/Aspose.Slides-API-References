...
| 메서드 | 설명 |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) 시맨틱을 사용하여 개체를 비교합니다. |
...
| **bool** [get_Loop](./get_loop/)() | 루프 [Slide](../slide/) 표시 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_PenColor](./get_pencolor/)() | [Slide](../slide/) 쇼의 펜 색상 |
| **bool** [get_ShowAnimation](./get_showanimation/)() | [Slide](../slide/) 쇼에 [Animation](../../aspose.slides.animation/) 표시 |
| **bool** [get_ShowMediaControls](./get_showmediacontrols/)() const | 미디어 컨트롤 표시 |
| **bool** [get_ShowNarration](./get_shownarration/)() | [Slide](../slide/) 쇼에 내레이션 표시 |
| [System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\> [get_Slides](./get_slides/)() const | [Slides](../) 범위 |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\> [get_SlideShowType](./get_slideshowtype/)() | 슬라이드 쇼 유형을 가져옵니다. 다음 [SlideShowType](../slideshowtype/) 조상에 의해 표시됩니다: [BrowsedAtKiosk](../browsedatkiosk/), [PresentedBySpeaker](../presentedbyspeaker/) 및 [BrowsedByIndividual](../browsedbyindividual/) |
| **bool** [get_UseTimings](./get_usetimings/)() | [Slide](../slide/) 쇼에서 타이밍 사용 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자. 실제로는 아무 것도 복사하지 않고 새 객체를 초기화하고 하위 클래스 복사 생성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자. 실제로는 아무 것도 복사하지 않고 새 객체를 초기화하고 하위 클래스 복사 생성을 가능하게 합니다. |
...
| void [set_Loop](./set_loop/)(**bool**) | 루프 [Slide](../slide/) 표시 |
| void [set_ShowAnimation](./set_showanimation/)(**bool**) | [Slide](../slide/) 쇼에 [Animation](../../aspose.slides.animation/) 표시 |
| void [set_ShowMediaControls](./set_showmediacontrols/)(**bool**) | 미디어 컨트롤 표시 |
| void [set_ShowNarration](./set_shownarration/)(**bool**) | [Slide](../slide/) 쇼에 내레이션 표시 |
| void [set_Slides](./set_slides/)([System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\>) | [Slides](../) 범위 |
| void [set_SlideShowType](./set_slideshowtype/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\>) | 슬라이드 쇼 유형을 설정합니다. 다음 [SlideShowType](../slideshowtype/) 조상에 의해 표시됩니다: [BrowsedAtKiosk](../browsedatkiosk/), [PresentedBySpeaker](../presentedbyspeaker/) 및 [BrowsedByIndividual](../browsedbyindividual/) |
| void [set_UseTimings](./set_usetimings/)(**bool**) | [Slide](../slide/) 쇼에서 타이밍 사용 |
