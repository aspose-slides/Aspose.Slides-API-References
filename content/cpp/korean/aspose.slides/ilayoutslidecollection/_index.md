...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) | 지정된 유형의 첫 번째 레이아웃 슬라이드를 반환합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) | 인덱스로 레이아웃 슬라이드를 반환합니다. 읽기 전용 [ILayoutSlide](../ilayoutslide/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | 컬렉션에서 레이아웃을 제거합니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값만큼 공유 참조 카운트를 감소시킵니다. |
| virtual void [RemoveUnused](./removeunused/)() | 사용되지 않은 레이아웃 슬라이드(HasDependingSlides가 false인)를 제거합니다. |
