...
오디오 파일을 포함하는 임베드된 오디오 파일을 나타냅니다.
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | 오디오 데이터의 복사본을 반환합니다. 데이터 양이 많을 경우 [Audio::GetStream](./getstream/) 메서드를 사용하여 오디오 데이터를 메모리로 불필요하게 로드하거나 OutOfMemoryException이 발생하는 것을 방지하는 것을 고려하십시오. 읽기 전용 **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | 오디오의 MIME 타입을 [Audio::get_BinaryData](./get_binarydata/)로 인코딩하여 반환합니다. 읽기 전용 [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 레퍼런스 카운터 데이터 구조를 가져옵니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | 읽기를 위한 Stream 스트림을 반환합니다. 사용 후 'using'을 사용하거나 스트림을 닫으세요. |
...
| void [set_ContentType](./set_contenttype/)([System::String](../../system/string/)) | 오디오의 MIME 타입을 [Audio::get_BinaryData](./get_binarydata/)로 인코딩하여 반환합니다. 읽기 전용 [System::String](../../system/string/). |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n번째 템플릿 인자를 약한 포인터(공유가 아닌)로 설정합니다. 컨테이너에서 포인터를 약한 모드로 전환할 수 있습니다. |
