...
description: 하이퍼링크 관리(추가, 제거)를 제공합니다.
type: docs
weight: 2549
url: /ko/aspose.slides/ihyperlinkmanager/
---
## IHyperlinkManager 클래스
...
| virtual void [RemoveHyperlinkClick](./removehyperlinkclick/)() | 클릭 시 하이퍼링크를 제거합니다. |
| virtual void [RemoveHyperlinkMouseOver](./removehyperlinkmouseover/)() | 마우스 오버 시 하이퍼링크를 제거합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkClick](./setexternalhyperlinkclick/)([System::String](../../system/string/)) | 클릭 시 외부 하이퍼링크를 설정합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkMouseOver](./setexternalhyperlinkmouseover/)([System::String](../../system/string/)) | 마우스 오버 시 외부 하이퍼링크를 설정합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkClick](./setinternalhyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | 클릭 시 내부 하이퍼링크를 설정합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkMouseOver](./setinternalhyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | 마우스 오버 시 내부 하이퍼링크를 설정합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetMacroHyperlinkClick](./setmacrohyperlinkclick/)([System::String](../../system/string/)) | 클릭 시 매크로 하이퍼링크를 설정합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 공유 대신 약한 포인터로 설정합니다. 컨테이너 안의 포인터를 약한 모드로 전환할 수 있습니다. |
