...
description: 색상 변환에 사용되는 다양한 색상 연산을 나타냅니다. 불변 객체.
type: docs
weight: 352
...
다양한 색상 변환에 사용되는 색상 연산을 나타냅니다. 불변 객체.
...
| 메서드 | 설명 |
| --- | --- |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/)) | 새 색 변환 작업을 생성합니다. |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/), **float**) | 새 색 변환 작업을 생성합니다. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 두 [ColorOperation](./) 인스턴스가 동일한지 결정합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일 부동소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 여기서는 두 NaN이 동일하다고 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일 부동소수점 비교를 에뮬레이션합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 여기서는 두 NaN이 동일하다고 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const override | 작업의 유형을 반환합니다. 읽기 전용 [ColorTransformOperation](../colortransformoperation/). |
| **float** [get_Parameter](./get_parameter/)() override | 작업의 파라미터를 반환합니다. 읽기 전용 **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 레퍼런스 카운터 데이터 구조를 가져옵니다. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 특정 타입에 대한 해시 함수로 사용되며, 해시 테이블과 같은 해싱 알고리즘 및 데이터 구조에 적합합니다. |
