...
---
## ICommonSlideViewProperties 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일의 부동 소수점 비교를 에뮬레이트합니다. 두 NaN을 IEC 60559:1989에 따라 동일하지 않음에도 불구하고 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일의 부동 소수점 비교를 에뮬레이트합니다. 두 NaN을 IEC 60559:1989에 따라 동일하지 않음에도 불구하고 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | 지정된 인덱스에서 그리기 가이드를 반환합니다. 읽기 전용 [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | 그리기 가이드 컬렉션을 반환합니다. 읽기 전용 [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | 보기 확대 비율을 백분율로 지정합니다. 읽기 **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | 보기 콘텐츠가 현재 창 크기에 맞게 자동으로 확대/축소되도록 지정합니다. 읽기 **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자. 실제로는 아무것도 복사하지 않으며, 단지 새 객체를 초기화하고 하위 클래스의 복사 생성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자. 실제로는 아무것도 복사하지 않으며, 단지 새 객체를 초기화하고 하위 클래스의 복사 생성을 가능하게 합니다. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | 보기 확대 비율을 백분율로 지정합니다. 쓰기 **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | 보기 콘텐츠가 현재 창 크기에 맞게 자동으로 확대/축소되도록 지정합니다. 쓰기 **bool**. |
