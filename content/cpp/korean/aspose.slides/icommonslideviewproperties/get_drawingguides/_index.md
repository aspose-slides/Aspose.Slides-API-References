...
type: docs
weight: 53
url: /ko/aspose.slides/icommonslideviewproperties/get_drawingguides/
---
## ICommonSlideViewProperties::get_DrawingGuides() 메서드
...
다음 샘플 코드는 PowerPoint 프레젠테이션에 새로운 그리기 가이드를 추가하는 방법을 보여줍니다. 
```cpp
...
* 클래스 [ICommonSlideViewProperties](../)
