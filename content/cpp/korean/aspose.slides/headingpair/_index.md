...
description: 문서의 'Heading pair' 속성을 나타냅니다. 이는 문서 부분들의 그룹 이름과 그룹 내 부분 수를 나타냅니다.
type: docs
weight: 1223
...
문서의 ‘Heading pair’ 속성을 나타냅니다. 이는 문서 부분들의 그룹 이름 및 그룹 내 부분 수를 나타냅니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값이나 NaN 자체와도 같지 않음에도 불구하고, C# 스타일의 부동 소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값이나 NaN 자체와도 같지 않음에도 불구하고, C# 스타일의 부동 소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| **int32_t** [get_Count](./get_count/)() override | 그룹에 포함된 부품 수를 반환합니다. 읽기 전용 **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 문서 부품들의 그룹 이름을 반환합니다. 읽기 전용 [System::String](../../system/string/). |
