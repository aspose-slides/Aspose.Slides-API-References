...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-스타일 부동소수점 비교를 에뮬레이트합니다. 이때 두 NaN은 IEC 60559:1989에 따라 NaN이 어떤 값과도, 포함 NaN과도 같지 않음에도 불구하고 동일한 것으로 취급됩니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-스타일 부동소수점 비교를 에뮬레이트합니다. 이때 두 NaN은 IEC 60559:1989에 따라 NaN이 어떤 값과도, 포함 NaN과도 같지 않음에도 불구하고 동일한 것으로 취급됩니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | 그리기 가이드의 색상을 반환합니다. [System::Drawing::Color](../../system.drawing/color/)를 읽으십시오. |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | 그리기 가이드의 방향을 반환합니다. [Slides::Orientation](../orientation/)를 읽으십시오. |
| **float** [get_Position](./get_position/)() override | 그리기 가이드의 위치를 슬라이드의 왼쪽 위 모서리부터 포인트 단위로 반환합니다. **float**를 읽으십시오. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로 아무것도 복사하지 않고, 새 객체를 초기화하고 서브클래스의 복사 생성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자입니다. 실제로 아무것도 복사하지 않고, 새 객체를 초기화하고 서브클래스의 복사 생성을 가능하게 합니다. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | 그리기 가이드의 색상을 설정합니다. [System::Drawing::Color](../../system.drawing/color/)를 씁니다. |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | 그리기 가이드의 방향을 설정합니다. [Slides::Orientation](../orientation/)를 씁니다. |
| void [set_Position](./set_position/)(**float**) override | 그리기 가이드의 위치를 슬라이드의 왼쪽 위 모서리부터 포인트 단위로 설정합니다. **float**를 씁니다. |
...
* 클래스 [IDrawingGuide](../idrawingguide/)
