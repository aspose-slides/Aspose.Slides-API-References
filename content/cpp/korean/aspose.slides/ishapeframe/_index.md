...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](../../system/icloneable/clone/)() | 현재 객체의 복사본을 생성하고 이에 대한 공유 포인터를 반환합니다. |
...
| virtual **float** [get_CenterX](./get_centerx/)() | 프레임 중심의 X 좌표를 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_CenterY](./get_centery/)() | 프레임 중심의 Y 좌표를 반환합니다. 읽기 전용 **float**. |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | 프레임이 수평으로 뒤집혔는지 여부를 결정합니다. 읽기 전용 [NullableBool](../nullablebool/). |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | 프레임이 수직으로 뒤집혔는지 여부를 결정합니다. 읽기 전용 [NullableBool](../nullablebool/). |
| virtual **float** [get_Height](./get_height/)() | 프레임의 높이를 반환합니다. 읽기 전용 **float**. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | 프레임의 좌표를 반환합니다. 읽기 전용 [System::Drawing::RectangleF](../../system.drawing/rectanglef/). |
| virtual **float** [get_Rotation](./get_rotation/)() | 프레임이 z축을 중심으로 회전한 각도를 반환합니다. 양수값은 시계 방향 회전을, 음수값은 반시계 방향 회전을 나타냅니다. 읽기 전용 **float**. |
| virtual **float** [get_Width](./get_width/)() | 프레임의 너비를 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_X](./get_x/)() | 프레임의 좌상단 모서리 X 좌표를 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_Y](./get_y/)() | 프레임의 좌상단 모서리 Y 좌표를 반환합니다. 읽기 전용 **float**. |
