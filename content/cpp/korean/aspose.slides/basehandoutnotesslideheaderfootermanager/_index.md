...
description: 자리 표시자의 동작을 관리하는 매니저를 나타내며, 모든 유형의 핸드아웃 및 노트 슬라이드에 대한 헤더 자리 표시자를 포함합니다.
type: docs
weight: 118
...
핸드아웃 및 노트 슬라이드의 모든 유형에 대한 헤더 자리 표시자를 포함하여 자리 표시자의 동작을 관리하는 매니저를 나타냅니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 같지 않지만, C#-style 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 같지 않지만, C#-style 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
...
| **bool** [get_IsHeaderVisible](./get_isheadervisible/)() override | 헤더 자리 표시자가 존재함을 나타내는 값을 가져옵니다. Read **bool**. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해시화를 지원합니다. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자. 실제로는 아무 것도 복사하지 않으며, 새로운 객체를 초기화하고 하위 클래스를 복사 생성할 수 있게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자. 실제로는 아무 것도 복사하지 않으며, 새로운 객체를 초기화하고 하위 클래스를 복사 생성할 수 있게 합니다. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | 값형 객체와 nullptr을 참조 기준으로 비교합니다. |
...
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | 슬라이드 날짜-시간 자리 표시자 가시성을 변경합니다. |
...
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | 슬라이드 바닥글 자리 표시자 가시성을 변경합니다. |
| void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) override | 슬라이드 헤더 자리 표시자에 텍스트를 설정합니다. |
| void [SetHeaderVisibility](./setheadervisibility/)(**bool**) override | 슬라이드 헤더 자리 표시자 가시성을 변경합니다. |
| void [SetSlideNumberVisibility](../baseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) override | 슬라이드 페이지 번호 자리 표시자 가시성을 변경합니다. |
