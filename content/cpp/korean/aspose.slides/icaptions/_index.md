...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | 폐쇄 캡션의 이진 데이터를 반환합니다. 읽기 전용 **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | 폐쇄 캡션의 전역 고유 식별자(GUID)를 반환합니다. 읽기 전용 [System::Guid](../../system/guid/). |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | 폐쇄 캡션 데이터를 UTF-8 인코딩 문자열로 반환합니다. 읽기 전용 [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | 폐쇄 캡션의 레이블을 반환합니다. 읽기 [System::String](../../system/string/). |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | 폐쇄 캡션의 레이블을 설정합니다. 쓰기 [System::String](../../system/string/). |
