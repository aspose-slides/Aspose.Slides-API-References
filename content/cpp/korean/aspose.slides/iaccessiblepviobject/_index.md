...
description: 상속이 적용된 상태에서 해당 효과적인 데이터를 반환할 수 있는 유형을 나타냅니다.
type: docs
weight: 1275
url: /ko/aspose.slides/iaccessiblepviobject/
---
## IAccessiblePVIObject 클래스
...
| virtual T [GetEffective](./geteffective/)() | 상속이 적용된 효과적인 데이터를 가져옵니다. |
