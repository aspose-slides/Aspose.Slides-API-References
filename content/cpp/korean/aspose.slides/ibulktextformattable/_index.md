...
description: 자식 텍스트 요소의 형식을 일괄 설정할 수 있는 객체를 나타냅니다.
type: docs
weight: 1548
url: /ko/aspose.slides/ibulktextformattable/
---
## IBulkTextFormattable 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-style 부동 소수점 비교를 에뮬레이트합니다. 여기서는 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도(NaN 포함) 같지 않지만, 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-style 부동 소수점 비교를 에뮬레이트합니다. 여기서는 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도(NaN 포함) 같지 않지만, 두 NaN을 동일하게 간주합니다. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 약한 포인터(공유가 아니라)로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | 정의된 부분 포맷 속성을 모든 요소의 부분에 설정합니다. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | 정의된 단락 포맷 속성을 모든 요소의 단락에 설정합니다. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | 정의된 텍스트 프레임 포맷 속성을 모든 요소의 텍스트 프레임에 설정합니다. |
