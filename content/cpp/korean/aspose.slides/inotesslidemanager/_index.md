...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() | 현재 슬라이드의 노트 슬라이드를 반환하며, 없을 경우 새로 생성합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() | 현재 슬라이드의 노트 슬라이드를 반환합니다. 슬라이드에 노트 슬라이드가 없는 경우 null을 반환합니다. 읽기 전용 [INotesSlide](../inotesslide/). |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현한 잠금 기능을 제공합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
...
| virtual void [RemoveNotesSlide](./removenotesslide/)() | 현재 슬라이드의 노트 슬라이드를 제거합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 구현한 잠금 해제를 제공합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
