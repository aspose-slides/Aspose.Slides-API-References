...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따라 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 모방합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따라 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 모방합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| [ShapeElementFillSource](../shapeelementfillsource/) [get_FillSource](./get_fillsource/)() | 요소를 채우는 방법에 대한 정보를 반환합니다. 읽기 전용 [ShapeElementFillSource](../shapeelementfillsource/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Shape](../shape/)\> [get_ParentShape](./get_parentshape/)() | 요소가 생성된 Shape_PPT를 반환합니다. 읽기 전용 [Shape](../shape/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_PathPoints](./get_pathpoints/)() | 요소 경로의 기하학을 정의하는 점들의 배열을 가져옵니다. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_PathTypes](./get_pathtypes/)() | 요소 경로의 각 점 유형을 지정하는 바이트 값 배열을 가져옵니다. |
| [ShapeElementStrokeSource](../shapeelementstrokesource/) [get_StrokeSource](./get_strokesource/)() | 요소의 선 그리기 방법에 대한 정보를 반환합니다. 읽기 전용 [ShapeElementStrokeSource](../shapeelementstrokesource/). |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현하여 잠금합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) sentry 객체를 사용하세요. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 구현하여 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) sentry 객체를 사용하십시오. |
...
* 클래스 [IShapeElement](../ishapeelement/)
