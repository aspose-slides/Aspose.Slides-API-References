...
description: 문서의 'Heading pair' 속성을 나타냅니다. 문서 파트들의 그룹 이름과 그룹에 포함된 파트 수를 나타냅니다.
type: docs
weight: 2510
...
문서의 'Heading pair' 속성을 나타냅니다. 문서 파트들의 그룹 이름과 그룹에 포함된 파트 수를 나타냅니다.
...
| virtual **int32_t** [get_Count](./get_count/)() | 그룹의 파트 수를 반환합니다. 읽기 전용 **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 문서 파트의 그룹 이름을 반환합니다. 읽기 전용 [System::String](../../system/string/). |
