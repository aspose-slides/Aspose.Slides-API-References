...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) override | 컬렉션의 끝에 민감도 레이블을 추가합니다. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) override | 컬렉션에 [SensitivityLabel](../sensitivitylabel/)를 추가합니다. |
| [iterator](./iterator/) [begin](./begin/)() | 컬렉션의 첫 번째 요소(있는 경우)를 가리키는 iterator를 가져옵니다. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 컬렉션의 const 한정 인스턴스의 첫 번째 요소(있는 경우)를 가리키는 iterator를 가져옵니다. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 컬렉션의 const 한정된 첫 번째 요소(있는 경우)를 가리키는 iterator를 가져옵니다. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 컬렉션의 마지막 const 한정 요소(있는 경우) 바로 뒤를 가리키는 iterator를 가져옵니다. |
| void [Clear](./clear/)() override | 컬렉션의 모든 요소를 제거합니다. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>\>, **int32_t**) | 컬렉션의 모든 요소를 지정된 배열에 복사합니다. |
| [iterator](./iterator/) [end](./end/)() | 컬렉션의 마지막 요소(있는 경우) 바로 뒤를 가리키는 iterator를 가져옵니다. |
| [const_iterator](./const_iterator/) [end](./end/)() const | 컬렉션의 const 한정 인스턴스의 마지막 요소(있는 경우) 바로 뒤를 가리키는 iterator를 가져옵니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>\>\> [GetEnumerator](./getenumerator/)() override | 컬렉션을 순회하는 enumerator를 반환합니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 객체의 실제 타입을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출과 유사합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) override | 인덱스로 민감도 레이블을 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | 지정된 술어(predicates)를 기준으로 시퀀스를 필터링합니다. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | 지정된 인덱스에서 민감도 레이블을 제거합니다. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 컬렉션의 const 한정 인스턴스에서 첫 번째 요소(있는 경우)를 가리키는 iterator를 가져옵니다. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 컬렉션의 첫 번째 요소(있는 경우)를 가리키는 iterator를 가져옵니다. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 컬렉션의 const 한정 인스턴스에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 iterator를 가져옵니다. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 컬렉션의 마지막 요소(있는 경우) 바로 뒤를 가리키는 iterator를 가져옵니다. |
...
| Typedef | Description |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 현재 컬렉션에서 iterator 타입으로 사용되는 컬렉션 타입. |
