...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) 형식 읽기 [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV(0-180deg, field of View) 읽기 **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) 줌(백분율 양수 값) 읽기 **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | 위도 좌표, 경도 좌표 및 축을 중심으로 하는 회전을 사용하여 회전을 정의합니다. 반환 배열의 첫 번째 요소는 위도, 두 번째는 경도, 세 번째는 회전입니다. 회전이 정의되지 않은 경우 null을 반환합니다. |
...
| virtual void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) | [Camera](../camera/) 형식 쓰기 [CameraPresetType](../camerapresettype/). |
| virtual void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) | [Camera](../camera/) FOV(0-180deg, field of View) 쓰기 **float**. |
| virtual void [set_Zoom](./set_zoom/)(**float**) | [Camera](../camera/) 줌(백분율 양수 값) 쓰기 **float**. |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | 위도 좌표, 경도 좌표 및 축을 중심으로 하는 회전을 사용하여 회전을 정의합니다. 좌표 값 중 하나라도 std::numeric_limits<float>::quiet_NaN()이면 전체 회전이 정의되지 않습니다. |
