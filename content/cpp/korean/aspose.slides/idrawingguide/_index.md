...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 그리기 가이드의 색을 반환합니다. 읽기 [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | 그리기 가이드의 방향을 반환합니다. 읽기 [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | 슬라이드의 왼쪽 위 모서리에서 점 단위로 그리기 가이드의 위치를 반환합니다. 읽기 **float**. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | 그리기 가이드의 색을 설정합니다. 쓰기 [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | 그리기 가이드의 방향을 설정합니다. 쓰기 [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | 슬라이드의 왼쪽 위 모서리에서 점 단위로 그리기 가이드의 위치를 설정합니다. 쓰기 **float**. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 구문 잠금 해제를 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
