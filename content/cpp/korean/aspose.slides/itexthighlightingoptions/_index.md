...
type: docs
weight: 4109
url: /ko/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값(그리고 NaN)과도 동일하지 않음에도 불구하고, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어떤 값(그리고 NaN)과도 동일하지 않음에도 불구하고, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | 대소문자 구분 검색을 사용하려면 true, 그렇지 않으면 false를 설정합니다. 읽기 전용 **bool**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | 전체 단어만 일치시키려면 true, 그렇지 않으면 false를 설정합니다. 읽기 전용 **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자. 실제로 아무 것도 복사하지 않고 새 객체를 초기화하며 하위 클래스 복사 생성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자. 실제로 아무 것도 복사하지 않고 새 객체를 초기화하며 하위 클래스 복사 생성을 가능하게 합니다. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | 대소문자 구분 검색을 사용하려면 true, 그렇지 않으면 false를 설정합니다. 쓰기 전용 **bool**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | 전체 단어만 일치시키려면 true, 그렇지 않으면 false를 설정합니다. 쓰기 전용 **bool**. |
...
사용 중단
:   인터페이스 [ITextHighlightingOptions](./)는 버전 24.10 출시 이후 제거됩니다.
