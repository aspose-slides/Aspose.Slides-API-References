...
description: 백분율로 진행 상황 업데이트를 저장하기 위한 콜백 객체를 나타냅니다.
type: docs
weight: 3446
url: /ko/aspose.slides/iprogresscallback/
---
## IProgressCallback 클래스

퍼센트 단위로 진행 상황 업데이트를 저장하기 위한 콜백 객체를 나타냅니다.
...
| virtual void [Reporting](./reporting/)(**double**) | 진행 업데이트를 보고합니다. |
