...
| 메서드 | 설명 |
| --- | --- |
| virtual **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) | 열린 암호로 보호된 프레젠테이션에 대해 비밀번호가 올바른지 확인합니다. |
| virtual **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) | 쓰기 보호된 프레젠테이션에 대한 수정 비밀번호가 올바른지 확인합니다. |
...
| virtual **bool** [get_IsEncrypted](./get_isencrypted/)() | 바인드된 프레젠테이션이 암호화된 경우 True를 반환하고, 그렇지 않은 경우 False를 반환합니다. 읽기 전용 **bool**. |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | 바인드된 프레젠테이션이 열기 암호로 보호되는지를 나타내는 값을 반환합니다. |
| virtual [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() | 바인드된 프레젠테이션이 쓰기 보호되는지를 나타내는 값을 반환합니다. |
| virtual [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() | 바인드된 프레젠테이션의 형식을 반환합니다. 읽기 전용 [Slides::LoadFormat](../loadformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() | 바인드된 프레젠테이션의 문서 속성을 반환합니다. |
...
| virtual void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) | 바인드된 프레젠테이션의 속성을 업데이트합니다. |
...
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | 바인드된 프레젠테이션을 스트림에 씁니다. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) | 바인드된 프레젠테이션을 파일에 씁니다. |
