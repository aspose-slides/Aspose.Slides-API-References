...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | 복합 스크립트 폰트를 반환합니다. 읽어보세요 [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | 동아시아 폰트를 반환합니다. 읽어보세요 [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | 라틴 폰트를 반환합니다. 읽어보세요 [IFontData](../ifontdata/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연관된 레퍼런스 카운터 데이터 구조를 가져옵니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| virtual [System::String](../../system/string/) [GetScriptFont](./getscriptfont/)([System::String](../../system/string/)) | 프레젠테이션 테마에서 특정 스크립트 태그와 연관된 폰트 이름을 가져옵니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\> [GetScriptFontMap](./getscriptfontmap/)() | 프레젠테이션에 포함된 모든 스크립트 폰트 정의의 사전을 반환합니다. |
...
| virtual void [RemoveScriptFont](./removescriptfont/)([System::String](../../system/string/)) | 테마의 폰트 컬렉션에서 특정 스크립트 태그와 연관된 폰트 설정을 제거합니다. |
| virtual void [set_ComplexScriptFont](./set_complexscriptfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) | 복합 스크립트 폰트를 설정합니다. 작성 [IFontData](../ifontdata/). |
| virtual void [set_EastAsianFont](./set_eastasianfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) | 동아시아 폰트를 설정합니다. 작성 [IFontData](../ifontdata/). |
| virtual void [set_LatinFont](./set_latinfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) | 라틴 폰트를 설정합니다. 작성 [IFontData](../ifontdata/). |
| virtual void [SetScriptFont](./setscriptfont/)([System::String](../../system/string/), [System::String](../../system/string/)) | 특정 스크립트 태그에 폰트 이름을 할당합니다. 이 태그는 프레젠테이션에서 해당 스크립트 텍스트가 렌더링되는 방식을 정의합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nth 템플릿 인수를 약한 포인터(공유가 아닌)로 설정합니다. 컨테이너에서 포인터를 약한 모드로 전환할 수 있습니다. |
