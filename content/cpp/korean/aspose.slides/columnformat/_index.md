...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormatEffectiveData](../icolumnformateffectivedata/)\> [GetEffective](./geteffective/)() override | 상속 및 테이블 스타일이 적용된 실제 테이블 열 서식 속성을 가져옵니다. |
...
* 클래스 [IColumnFormat](../icolumnformat/)
