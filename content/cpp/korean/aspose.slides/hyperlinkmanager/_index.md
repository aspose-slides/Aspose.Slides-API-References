...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-style 부동 소수점 비교를 에뮬레이트합니다. 두 NaN은 IEC 60559:1989에 따르면 어떤 값과도 같지 않으며 NaN 자체도 포함하지 않지만, 여기서는 동일하게 간주됩니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-style 부동 소수점 비교를 에뮬레이트합니다. 두 NaN은 IEC 60559:1989에 따르면 어떤 값과도 같지 않으며 NaN 자체도 포함하지 않지만, 여기서는 동일하게 간주됩니다. |
...
| void [RemoveHyperlinkClick](./removehyperlinkclick/)() override | 클릭 시 하이퍼링크를 제거합니다. |
| void [RemoveHyperlinkMouseOver](./removehyperlinkmouseover/)() override | 마우스 오버 시 하이퍼링크를 제거합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkClick](./setexternalhyperlinkclick/)([System::String](../../system/string/)) override | 클릭 시 외부 하이퍼링크를 설정합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkMouseOver](./setexternalhyperlinkmouseover/)([System::String](../../system/string/)) override | 마우스 오버 시 외부 하이퍼링크를 설정합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkClick](./setinternalhyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | 클릭 시 내부 하이퍼링크를 설정합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkMouseOver](./setinternalhyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | 마우스 오버 시 내부 하이퍼링크를 설정합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetMacroHyperlinkClick](./setmacrohyperlinkclick/)([System::String](../../system/string/)) override | 클릭 시 매크로 하이퍼링크를 설정합니다. |
...
* 클래스 [IHyperlinkManager](../ihyperlinkmanager/)
