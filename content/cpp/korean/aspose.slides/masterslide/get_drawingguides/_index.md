...
type: docs
weight: 170
url: /ko/aspose.slides/masterslide/get_drawingguides/
---
## MasterSlide::get_DrawingGuides() 메서드


마스터 슬라이드에 대한 그리기 가이드의 컬렉션을 반환합니다. 읽기 전용 [IDrawingGuidesCollection](../../idrawingguidescollection/)
