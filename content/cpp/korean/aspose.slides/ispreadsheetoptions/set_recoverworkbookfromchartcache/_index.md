...
type: docs
weight: 40
url: /ko/aspose.slides/ispreadsheetoptions/set_recoverworkbookfromchartcache/
---
## ISpreadsheetOptions::set_RecoverWorkbookFromChartCache(bool) 메서드

차트의 데이터 원본이 외부 워크북이고 해당 워크북을 사용할 수 없는 경우, 차트 캐시에서 복구됩니다.
