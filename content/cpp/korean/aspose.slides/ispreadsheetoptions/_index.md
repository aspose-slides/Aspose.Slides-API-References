...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 동일하지 않지만, 두 NaN이 동일한 것으로 간주되는 C#-style 부동 소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 동일하지 않지만, 두 NaN이 동일한 것으로 간주되는 C#-style 부동 소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | 이중 바이트 문자 집합(DBCS)을 사용하는 언어에서 사용하도록 설계된 일부 함수 계산을 위한 선호 문화 정보를 가져옵니다. |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | 차트의 데이터 소스가 외부 워크북이고 사용할 수 없는 경우 차트 캐시에서 복구됩니다. |
...
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | 이중 바이트 문자 집합(DBCS)을 사용하는 언어에서 사용하도록 설계된 일부 함수 계산을 위한 선호 문화 정보를 가져옵니다. |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | 차트의 데이터 소스가 외부 워크북이고 사용할 수 없는 경우 차트 캐시에서 복구됩니다. |
