...
| static **bool** [Equals](../../system/object/equals/)(**float** const&, **float** const&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도, NaN을 포함해도 같지 않지만, C# 스타일의 부동소수점 비교를 에뮬레이션하여 두 NaN을 동일하게 취급합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const&, **double** const&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도, NaN을 포함해도 같지 않지만, C# 스타일의 부동소수점 비교를 에뮬레이션하여 두 NaN을 동일하게 취급합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase&, void **) const | 내부 용도로만 사용됩니다. |
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | 컬렉션에 있는 동작 수를 반환합니다. 읽기 전용 **int32_t**. |
| virtual **double** [get_Height](./get_height/)() | 행의 높이를 반환합니다. 읽기 전용 **double**. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | 컬렉션에 대한 접근이 동기화(쓰레드 안전)되는지 여부를 나타내는 값을 반환합니다. 읽기 전용 **bool**. |
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | 행의 가능한 최소 높이를 반환합니다. 읽기 **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | [RowFormat](../rowformat/) 객체를 반환합니다. 이 객체는 이 행의 서식 속성을 포함합니다. 읽기 전용 [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | 위치에 따라 셀을 반환합니다. 읽기 전용 [ICell](../icell/). |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Reverse](../../system.collections.generic/ienumerable/linq_reverse/)() | 시퀀스 요소들의 순서를 역전시킵니다. |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | 행의 가능한 최소 높이를 설정합니다. **double**를 기록합니다. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | 정의된 구간 포맷 속성을 모든 요소의 구간에 설정합니다. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | 정의된 단락 포맷 속성을 모든 요소의 단락에 설정합니다. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | 정의된 텍스트 프레임 포맷 속성을 모든 요소의 텍스트 프레임에 설정합니다. |
