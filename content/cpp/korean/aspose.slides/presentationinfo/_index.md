...
| 메서드 | 설명 |
| --- | --- |
| **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) override | 오픈 비밀번호로 보호된 프레젠테이션에 대한 비밀번호가 올바른지 확인합니다. |
| **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) override | 쓰기 보호된 프레젠테이션에 대해 수정 비밀번호가 올바른지 확인합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일의 부동소수점 비교를 구현합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도(아including NaN) 같지 않지만, 여기서는 두 NaN을 동일하게 취급합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일의 부동소수점 비교를 구현합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도(아including NaN) 같지 않지만, 여기서는 두 NaN을 동일하게 취급합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| **bool** [get_IsEncrypted](./get_isencrypted/)() override | 바인드된 프레젠테이션이 암호화된 경우 True를 반환하고, 그렇지 않으면 False를 반환합니다. 읽기 전용 **bool**. |
| **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() override | 바인드된 프레젠테이션이 열기 비밀번호로 보호되는지 여부를 나타내는 값을 반환합니다. |
| [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() override | 바인드된 프레젠테이션이 쓰기 보호되는지 여부를 나타내는 값을 반환합니다. |
| [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() override | 바인드된 프레젠테이션의 형식을 반환합니다. 읽기 전용 [Slides::LoadFormat](../loadformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() override | 바인드된 프레젠테이션의 문서 속성을 반환합니다. |
...
| void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) override | 바인드된 프레젠테이션의 속성을 업데이트합니다. |
...
| void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | 바인드된 프레젠테이션을 스트림에 씁니다. |
| void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) override | 바인드된 프레젠테이션을 파일에 씁니다. |
