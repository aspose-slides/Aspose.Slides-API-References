...
---
## IFontFallBackRulesCollection 클래스

사용자가 정의한 FontFallBack 규칙 컬렉션을 나타냅니다.
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | 컬렉션의 끝에 새로운 FallBack 규칙을 추가합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만, 두 NaN을 같다고 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만, 두 NaN을 같다고 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) | 지정된 인덱스에 있는 규칙을 가져옵니다. 읽기 전용 [IFontFallBackRule](../ifontfallbackrule/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | 시퀀스의 요소 중 하나라도 존재하거나 조건을 만족하는지 여부를 결정합니다. |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | 시퀀스가 지정된 값을 포함하는지 여부를 결정합니다. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | 컬렉션에서 특정 FallBack 규칙의 첫 번째 발생을 제거합니다. |
