...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 동일하게 간주되는 C#-style 부동 소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 NaN을 포함한 어떤 값과도 동일하지 않지만요. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 동일하게 간주되는 C#-style 부동 소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 NaN을 포함한 어떤 값과도 동일하지 않지만요. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() override | 이중 바이트 문자 집합(DBCS)을 사용하는 언어용 함수 계산에 필요한 기본 문화 정보를 가져옵니다. |
| **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() override | 차트의 데이터 소스가 외부 워크북이고 사용할 수 없을 경우 차트 캐시에서 복구됩니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로는 아무 것도 복사하지 않고 새 객체를 초기화하며 하위 클래스 복사를 가능하게 합니다. |
...
| void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) override | 이중 바이트 문자 집합(DBCS)을 사용하는 언어용 함수 계산에 필요한 기본 문화 정보를 설정합니다. |
| void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) override | 차트의 데이터 소스가 외부 워크북이고 사용할 수 없을 경우 차트 캐시에서 복구됩니다. |
...
|  [SpreadsheetOptions](./spreadsheetoptions/)() | [SpreadsheetOptions](./) 클래스를 새 인스턴스로 초기화합니다. |
...
* 클래스 [ISpreadsheetOptions](../ispreadsheetoptions/)
