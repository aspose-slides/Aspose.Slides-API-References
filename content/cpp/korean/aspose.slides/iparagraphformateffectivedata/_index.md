...
---
## IParagraphFormatEffectiveData 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(특히 NaN과도) 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(특히 NaN과도) 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual [TextAlignment](../textalignment/) [get_Alignment](./get_alignment/)() | 단락의 텍스트 정렬을 반환합니다. 읽기 전용 [TextAlignment](../textalignment/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBulletFormatEffectiveData](../ibulletformateffectivedata/)\> [get_Bullet](./get_bullet/)() | 단락의 글머리표 형식을 반환합니다. 읽기 전용 [IBulletFormatEffectiveData](../ibulletformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormatEffectiveData](../iportionformateffectivedata/)\> [get_DefaultPortionFormat](./get_defaultportionformat/)() | 단락의 기본 구획 형식을 반환합니다. 읽기 전용 [IPortionFormatEffectiveData](../iportionformateffectivedata/). |
| virtual **float** [get_DefaultTabSize](./get_defaulttabsize/)() | 기본 탭 크기를 반환합니다. 읽기 전용 **float**. |
| virtual **int16_t** [get_Depth](./get_depth/)() | 단락의 깊이를 반환합니다. 읽기 전용 **int16_t**. |
| virtual **bool** [get_EastAsianLineBreak](./get_eastasianlinebreak/)() | 단락에서 동아시아 줄 바꿈이 사용되는지 판단합니다. 읽기 전용 **bool**. |
| virtual [Aspose::Slides::FontAlignment](../fontalignment/) [get_FontAlignment](./get_fontalignment/)() | 단락의 글꼴 정렬을 반환합니다. 읽기 전용 [Slides::FontAlignment](../fontalignment/). |
| virtual **bool** [get_HangingPunctuation](./get_hangingpunctuation/)() | 단락에서 매달린 구두점이 사용되는지 판단합니다. 읽기 전용 **bool**. |
| virtual **float** [get_Indent](./get_indent/)() | 단락의 첫 줄 들여쓰기/매달린 들여쓰기를 반환합니다. 매달린 들여쓰기는 음수 값으로 정의될 수 있습니다. 읽기 전용 **float**. |
| virtual **bool** [get_LatinLineBreak](./get_latinlinebreak/)() | 단락에서 라틴 줄 바꿈이 사용되는지 판단합니다. 읽기 전용 **bool**. |
| virtual **float** [get_MarginLeft](./get_marginleft/)() | 단락의 왼쪽 여백을 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_MarginRight](./get_marginright/)() | 단락의 오른쪽 여백을 반환합니다. 읽기 전용 **float**. |
| virtual **bool** [get_RightToLeft](./get_righttoleft/)() | 단락에서 오른쪽에서 왼쪽으로 쓰기가 사용되는지 판단합니다. 읽기 전용 **bool**. |
| virtual **float** [get_SpaceAfter](./get_spaceafter/)() | 단락의 마지막 줄 뒤 공간량을 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_SpaceBefore](./get_spacebefore/)() | 단락의 첫 줄 앞 공간량을 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_SpaceWithin](./get_spacewithin/)() | 단락의 기준 줄 사이 공간량을 반환합니다. 읽기 전용 **float**. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ITabEffectiveData](../itabeffectivedata/)\>\> [get_Tabs](./get_tabs/)() | 단락의 탭을 반환합니다. 읽기 전용 [ITabEffectiveData](../itabeffectivedata/)[]. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 가져옵니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드의 유사 버전입니다. 사용자 정의 객체의 해시화를 가능하게 합니다. |
...
이 인터페이스는 [IParagraphFormat](../iparagraphformat/) 인터페이스와 함께 사용되어 상속이 적용된 효과적인 서식 값을 반환합니다. 
