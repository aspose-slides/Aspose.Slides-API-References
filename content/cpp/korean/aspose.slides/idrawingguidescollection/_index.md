...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) | 컬렉션의 끝에 그리기 가이드를 추가합니다. |
...
| virtual **int32_t** [get_Count](./get_count/)() | 컬렉션의 모든 요소 수를 가져옵니다. 읽기 전용 **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) | 인덱스로 그리기 가이드를 반환합니다. 읽기 전용 [IDrawingGuide](../idrawingguide/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | 값형 객체와 nullptr를 레퍼런스 비교합니다. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 지정된 인덱스의 그리기 가이드를 제거합니다. |
