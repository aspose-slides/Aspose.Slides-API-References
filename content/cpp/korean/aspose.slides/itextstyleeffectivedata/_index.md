...
description: 실제 텍스트 스타일 속성을 포함하는 불변 객체.
type: docs
weight: 4148
url: /ko/aspose.slides/itextstyleeffectivedata/
---
## ITextStyleEffectiveData 클래스

실제 텍스트 스타일 속성을 포함하는 불변 객체.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormatEffectiveData](../iparagraphformateffectivedata/)\> [get_DefaultParagraphFormat](./get_defaultparagraphformat/)() | 실제 기본 단락 속성을 반환합니다. 읽기 전용 [IParagraphFormatEffectiveData](../iparagraphformateffectivedata/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 자료구조를 가져옵니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormatEffectiveData](../iparagraphformateffectivedata/)\> [GetLevel](./getlevel/)(**int32_t**) | 실제 스타일 수준을 반환합니다. |
...
이 인터페이스는 [ITextStyle](../itextstyle/) 인터페이스와 함께 사용되어 상속이 적용된 실제 서식 값을 반환합니다.
