...
description: 색상 변환에 사용되는 다양한 색상 연산을 나타냅니다.
type: docs
weight: 1704
...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | 연산의 유형을 반환합니다. 읽기 전용 [ColorTransformOperation](../colortransformoperation/). |
| virtual **float** [get_Parameter](./get_parameter/)() | 연산의 매개변수를 반환합니다. 읽기 전용 **float**. |
