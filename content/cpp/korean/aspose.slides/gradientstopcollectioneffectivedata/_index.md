...
description: GradientStopData 객체들의 컬렉션을 나타냅니다.
type: docs
weight: 1145
...
컬렉션의 GradientStopData 객체 집합을 나타냅니다.
...
| Method | Description |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() | 컬렉션에 요소가 있는 경우 첫 번째 요소를 가리키는 반복자를 가져옵니다. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 컬렉션의 const 한정 인스턴스에 요소가 있는 경우 첫 번째 요소를 가리키는 반복자를 가져옵니다. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 컬렉션에 const 한정 요소가 있는 경우 첫 번째 const 한정 요소를 가리키는 반복자를 가져옵니다. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 컬렉션에 const 한정 요소가 있는 경우 마지막 const 한정 요소 바로 다음을 가리키는 반복자를 가져옵니다. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\>\>, **int32_t**) override | 컬렉션의 모든 요소를 지정된 배열로 복사합니다. |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 컬렉션의 모든 요소를 지정된 배열로 복사합니다. |
| [iterator](./iterator/) [end](./end/)() | 컬렉션에 요소가 있는 경우 마지막 요소 바로 다음을 가리키는 반복자를 가져옵니다. |
| [const_iterator](./const_iterator/) [end](./end/)() const | 컬렉션의 const 한정 인스턴스에 요소가 있는 경우 마지막 요소 바로 다음을 가리키는 반복자를 가져옵니다. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) 문법을 사용하여 객체를 비교합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, C# 스타일의 부동소수점 비교를 흉내 내어 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, C# 스타일의 부동소수점 비교를 흉내 내어 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| **int32_t** [get_Count](./get_count/)() override | 컬렉션의 그라디언트 스톱 수를 반환합니다. 읽기 전용 **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\>\>\> [GetEnumerator](./getenumerator/)() override | 컬렉션을 순회하는 열거자를 반환합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) override | 인덱스로 그라디언트 스톱을 반환합니다. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 입력 시퀀스의 각 요소에 변환 함수를 호출해 얻은 값들의 시퀀스 평균을 계산합니다. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | 컬렉션의 마지막 요소를 반환하며, 컬렉션이 비어 있을 경우 기본값을 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | 지정된 연속 요소 수만큼 건너뛰고 나머지를 반환합니다. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 컬렉션의 const 한정 인스턴스에 요소가 있는 경우 첫 번째 요소를 가리키는 반복자를 가져옵니다. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 컬렉션에 요소가 있는 경우 첫 번째 요소를 가리키는 반복자를 가져옵니다. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 컬렉션의 const 한정 인스턴스에 요소가 있는 경우 마지막 요소 바로 다음을 가리키는 반복자를 가져옵니다. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 컬렉션에 요소가 있는 경우 마지막 요소 바로 다음을 가리키는 반복자를 가져옵니다. |
...
* 클래스 [IEffectiveData](../ieffectivedata/)
* 클래스 [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)
