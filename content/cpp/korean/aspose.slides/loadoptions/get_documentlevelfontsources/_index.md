...
description: 프레젠테이션에서 사용할 외부 글꼴의 소스를 지정합니다. 이 글꼴은 프레젠테이션 전체 수명 동안 사용 가능하며 다른 프레젠테이션과 공유되지 않습니다.
type: docs
weight: 209
url: /ko/aspose.slides/loadoptions/get_documentlevelfontsources/
---
## LoadOptions::get_DocumentLevelFontSources() 메서드
