...
description: 기하학 도형의 조정 값을 나타냅니다. 이러한 값은 도형의 형태에 영향을 줍니다.
type: docs
weight: 1288
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 모든 값과 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 모든 값과 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual **float** [get_AngleValue](./get_anglevalue/)() | 값을 반환하며, 이를 각도(도)로 해석합니다. **float**을 읽습니다. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 이 조정 값의 이름을 반환합니다. 읽기 전용 [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | 조정 값을 "그대로" 반환합니다. **int64_t**을 읽습니다. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | 형상의 조정 유형을 반환합니다. 읽기 전용 [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | 값을 설정하며, 이를 각도(도)로 해석합니다. **float**을 씁니다. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | 조정 값을 "그대로" 설정합니다. **int64_t**을 씁니다. |
