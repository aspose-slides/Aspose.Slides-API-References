...
| 메서드 | 설명 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [AddAudio](./addaudio/)([System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\>) override | 다른 프레젠테이션에서 오디오 파일의 복사본을 추가합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [AddAudio](./addaudio/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | 스트림에서 프레젠테이션에 오디오를 생성하고 추가합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [AddAudio](./addaudio/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [LoadingStreamBehavior](../loadingstreambehavior/)) override | 스트림에서 프레젠테이션에 오디오를 생성하고 추가합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [AddAudio](./addaudio/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | 바이트 배열에서 프레젠테이션에 오디오를 생성하고 추가합니다. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 컬렉션에서 마지막 const 한정 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\>\>, **int32_t**) override | 지정된 인덱스부터 지정된 배열에 오디오를 복사합니다. |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 컬렉션의 모든 요소를 지정된 배열에 복사합니다. |
| [iterator](./iterator/) [end](./end/)() | 컬렉션에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. |
| [const_iterator](./const_iterator/) [end](./end/)() const | 컬렉션의 const 한정 인스턴스에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. |
...
| **int32_t** [get_Count](./get_count/)() override | 컬렉션에 있는 오디오 파일 수를 반환합니다. 읽기 전용 **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\>\>\> [GetEnumerator](./getenumerator/)() override | 컬렉션을 순회하는 열거자를 반환합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [idx_get](./idx_get/)(**int32_t**) override | 지정된 인덱스에 있는 요소를 반환합니다. 읽기 전용 [IAudio](../iaudio/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 템플릿의 n번째 인자를 공유 대신 약한 포인터로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있습니다. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 컬렉션에서 마지막 요소(있는 경우) 바로 뒤를 가리키는 반복자를 반환합니다. |
