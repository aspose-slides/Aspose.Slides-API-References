...
description: 정의된 마스터 슬라이드의 모든 레이아웃 슬라이드 컬렉션을 나타냅니다. LayoutSlideCollection 클래스를 확장하여 마스터 레이아웃 슬라이드의 개별 컬렉션 컨텍스트에서 레이아웃 슬라이드를 추가/삽입/삭제/복제/재정렬하는 메서드를 제공합니다.
type: docs
weight: 4434
...
정의된 마스터 슬라이드의 모든 레이아웃 슬라이드 컬렉션을 나타냅니다. [LayoutSlideCollection](../layoutslidecollection/) 클래스를 확장하여 마스터 레이아웃 슬라이드의 개별 컬렉션 컨텍스트에서 레이아웃 슬라이드를 추가/삽입/삭제/복제/재정렬하는 메서드를 제공합니다.
...
| 메서드 | 설명 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | 컬렉션의 끝에 새 레이아웃 슬라이드를 추가합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | 지정된 레이아웃 슬라이드의 복사본을 컬렉션의 끝에 추가합니다. |
| [iterator](../layoutslidecollection/iterator/) [begin](../layoutslidecollection/begin/)() | 컬렉션의 첫 번째 요소(있는 경우)를 가리키는 반복자를 반환합니다. |
| [const_iterator](../layoutslidecollection/const_iterator/) [begin](../layoutslidecollection/begin/)() const | 컬렉션의 const 한정 인스턴스에서 첫 번째 요소(있는 경우)를 가리키는 반복자를 반환합니다. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cbegin](../layoutslidecollection/cbegin/)() const | const 한정 컬렉션에서 첫 번째 const 요소(있는 경우)를 가리키는 반복자를 반환합니다. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cend](../layoutslidecollection/cend/)() const | const 한정 컬렉션에서 마지막 const 요소 바로 뒤를 가리키는 반복자를 반환합니다. |
| void [CopyTo](../layoutslidecollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>, **int32_t**) override | 컬렉션의 모든 요소를 지정된 배열로 복사합니다. |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 컬렉션의 모든 요소를 지정된 배열에 복사합니다. |
| [iterator](../layoutslidecollection/iterator/) [end](../layoutslidecollection/end/)() | 컬렉션의 마지막 요소 바로 뒤를 가리키는 반복자를 반환합니다. |
| [const_iterator](../layoutslidecollection/const_iterator/) [end](../layoutslidecollection/end/)() const | const 한정 컬렉션에서 마지막 요소 바로 뒤를 가리키는 반복자를 반환합니다. |
...
| **int32_t** [get_Count](../layoutslidecollection/get_count/)() override | 컬렉션에 포함된 레이아웃 슬라이드 수를 반환합니다. 읽기 전용 **int32_t**. |
| **bool** [get_IsSynchronized](../layoutslidecollection/get_issynchronized/)() override | 컬렉션에 대한 액세스가 동기화(스레드 안전)되어 있는지 여부를 나타내는 값을 반환합니다. 읽기 전용 **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../layoutslidecollection/get_syncroot/)() override | 동기화 루트를 반환합니다. 읽기 전용 [System::Object](../../system/object/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../layoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) override | 지정된 유형의 첫 번째 레이아웃 슬라이드를 반환합니다. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 가져옵니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>\> [GetEnumerator](../layoutslidecollection/getenumerator/)() override | 컬렉션을 순회하는 열거자를 반환합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../layoutslidecollection/idx_get/)(**int32_t**) override | 인덱스로 레이아웃 슬라이드를 반환합니다. 읽기 전용 [LayoutSlide](../layoutslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Insert](./insert/)(**int32_t**, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | 컬렉션의 지정된 위치에 새 레이아웃 슬라이드를 삽입합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | 컬렉션의 지정된 위치에 지정된 레이아웃 슬라이드의 복사본을 삽입합니다. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType으로 설명된 유형의 인스턴스인지 확인합니다. C# 'is' 연산자의 유사 구현. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | 시퀀스에 조건을 만족하는 요소가 하나라도 존재하는지 확인합니다. |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | 수치 값 시퀀스의 평균을 계산합니다. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 입력 시퀀스 각각에 변환 함수를 적용하여 얻은 값들의 평균을 계산합니다. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | 직접 카운팅을 통해 시퀀스의 요소 개수를 반환합니다. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | 시퀀스가 비어 있을 경우 기본값을 반환하면서 첫 번째 요소를 반환합니다. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | 시퀀스가 비어 있을 경우 기본값을 반환하면서 마지막 요소를 반환합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 각 시퀀스 요소를 투영하고, 결과 시퀀스를 하나의 시퀀스로 결합합니다. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | 지정된 조건식에 따라 시퀀스를 필터링합니다. |
| void [Lock](../../system/object/lock/)() | C# lock() 문과 동일한 잠금을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시자를 사용하십시오. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드의 C# 유사 구현. 사용자 정의 유형을 복제할 수 있게 합니다. |
...
| void [Remove](../layoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | 컬렉션에서 레이아웃을 제거합니다. |
| void [RemoveAt](./removeat/)(**int32_t**) override | 컬렉션에서 지정된 인덱스의 요소를 제거합니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값만큼 공유 참조 카운트를 감소시킵니다. |
| void [RemoveUnused](../layoutslidecollection/removeunused/)() override | 사용되지 않는 레이아웃 슬라이드(HasDependingSlides가 false인 슬라이드)를 제거합니다. |
| void [Reorder](./reorder/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | 컬렉션에서 레이아웃 슬라이드를 지정된 위치로 이동합니다. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | 현재 공유 참조 카운트 값을 반환합니다. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | [System.Object](../../system/object/)에 대한 C# typeof() 구문을 구현합니다. |
| void [Unlock](../../system/object/unlock/)() | C# lock() 문과 동일한 잠금 해제를 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시자를 사용하십시오. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginConstIterator](../layoutslidecollection/virtualizebeginconstiterator/)() const override | const 한정 컬렉션 인스턴스에서 첫 번째 요소(있는 경우)를 가리키는 반복자를 반환합니다. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginIterator](../layoutslidecollection/virtualizebeginiterator/)() override | 컬렉션에서 첫 번째 요소(있는 경우)를 가리키는 반복자를 반환합니다. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndConstIterator](../layoutslidecollection/virtualizeendconstiterator/)() const override | const 한정 컬렉션 인스턴스에서 마지막 요소 바로 뒤를 가리키는 반복자를 반환합니다. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndIterator](../layoutslidecollection/virtualizeenditerator/)() override | 컬렉션에서 마지막 요소 바로 뒤를 가리키는 반복자를 반환합니다. |
...
* 클래스 [IMasterLayoutSlideCollection](../imasterlayoutslidecollection/)
