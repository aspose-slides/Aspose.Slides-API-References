...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [CreateFontData](./createfontdata/)([System::String](../../system/string/)) override | 지정된 글꼴 이름으로 [FontData](../fontdata/)를 생성합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도( NaN 포함) 동등하지 않지만, C# 스타일 부동소수점 비교에서 동일하게 간주되는 것을 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 어떤 값과도( NaN 포함) 동등하지 않지만, C# 스타일 부동소수점 비교에서 동일하게 간주되는 것을 에뮬레이트합니다. |
...
* 클래스 [IFontDataFactory](../ifontdatafactory/)
