...
description: 부모 GraphicalObjectEx에서 비활성화된 작업이 무엇인지 결정합니다.
type: docs
weight: 2471
url: /ko/aspose.slides/igraphicalobjectlock/
---
## IGraphicalObjectLock 클래스

부모 GraphicalObjectEx에서 비활성화된 작업을 결정합니다.
...
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | 크기 조정 시 형태가 종횡비를 유지해야 하는지 결정합니다. 읽기 **bool**. |
| virtual **bool** [get_DrilldownLocked](./get_drilldownlocked/)() | 이 객체의 하위 도형 선택이 금지되는지 결정합니다. 읽기 **bool**. |
| virtual **bool** [get_GroupingLocked](./get_groupinglocked/)() | 이 도형을 그룹에 추가하는 것이 금지되는지 결정합니다. 읽기 **bool**. |
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | 모든 잠금 플래그가 비활성화된 경우 true를 반환합니다. 읽기 전용 **bool**. |
| virtual **bool** [get_PositionLocked](./get_positionlocked/)() | 이 도형 이동이 금지되는지 결정합니다. 읽기 **bool**. |
| virtual **bool** [get_SelectLocked](./get_selectlocked/)() | 이 도형 선택이 금지되는지 결정합니다. 읽기 **bool**. |
| virtual **bool** [get_SizeLocked](./get_sizelocked/)() | 이 도형 크기 조정이 금지되는지 결정합니다. 읽기 **bool**. |
...
| virtual void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) | 크기 조정 시 형태가 종횡비를 유지해야 하는지 결정합니다. 쓰기 **bool**. |
| virtual void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) | 이 객체의 하위 도형 선택이 금지되는지 결정합니다. 쓰기 **bool**. |
| virtual void [set_GroupingLocked](./set_groupinglocked/)(**bool**) | 이 도형을 그룹에 추가하는 것이 금지되는지 결정합니다. 쓰기 **bool**. |
| virtual void [set_PositionLocked](./set_positionlocked/)(**bool**) | 이 도형 이동이 금지되는지 결정합니다. 쓰기 **bool**. |
| virtual void [set_SelectLocked](./set_selectlocked/)(**bool**) | 이 도형 선택이 금지되는지 결정합니다. 쓰기 **bool**. |
| virtual void [set_SizeLocked](./set_sizelocked/)(**bool**) | 이 도형 크기 조정이 금지되는지 결정합니다. 쓰기 **bool**. |
