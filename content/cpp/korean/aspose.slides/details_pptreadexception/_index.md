...
type: docs
weight: 690
url: /ko/aspose.slides/details_pptreadexception/
---
## Details_PptReadException 클래스
...
| void [Lock](../../system/object/lock/)() | C# lock() 문의 잠금입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 특정 예외에 할당된 코딩된 숫자값인 HRESULT를 설정합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문의 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
