...
| Title | 0 | 제목 |
| Text | 1 | 텍스트 |
| TwoColumnText | 2 | 두 [Column](../column/) 텍스트 |
| Table | 3 | [Table](../table/) |
...
| TwoObjects | 28 | 두 객체 |
| ObjectAndTwoObject | 29 | 객체와 두 객체 |
| TwoObjectsAndObject | 30 | 두 객체와 객체 |
| SectionHeader | 31 | [Section](../section/) 헤더 |
| TwoTextAndTwoObjects | 32 | 두 텍스트 및 두 객체 |
| TitleObjectAndCaption | 33 | 제목, 객체 및 캡션 |
| PictureAndCaption | 34 | [Picture](../picture/) 및 캡션 |
