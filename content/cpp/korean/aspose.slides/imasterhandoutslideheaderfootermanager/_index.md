...
description: 마스터 핸드아웃 슬라이드 자리표시자(헤더 자리표시자 포함)의 동작을 보유하는 관리자를 나타냅니다.
type: docs
weight: 2848
url: /ko/aspose.slides/imasterhandoutslideheaderfootermanager/
---
## IMasterHandoutSlideHeaderFooterManager 클래스


마스터 핸드아웃 슬라이드 자리표시자(헤더 자리표시자 포함)의 동작을 보유하는 관리자를 나타냅니다.
...
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | 헤더 자리표시자가 존재함을 나타내는 값을 가져옵니다. 읽기 **bool**. |
...
| virtual void [SetDateTimeVisibility](../ibaseslideheaderfootermanager/setdatetimevisibility/)(**bool**) | 슬라이드 날짜-시간 자리표시자 가시성을 변경합니다. |
...
| virtual void [SetFooterVisibility](../ibaseslideheaderfootermanager/setfootervisibility/)(**bool**) | 슬라이드 푸터 자리표시자 가시성을 변경합니다. |
| virtual void [SetHeaderText](../ibasehandoutnotesslideheaderfootermanag/setheadertext/)([System::String](../../system/string/)) | 슬라이드 헤더 자리표시자에 텍스트를 설정합니다. |
| virtual void [SetHeaderVisibility](../ibasehandoutnotesslideheaderfootermanag/setheadervisibility/)(**bool**) | 슬라이드 헤더 자리표시자 가시성을 변경합니다. |
| virtual void [SetSlideNumberVisibility](../ibaseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) | 슬라이드 페이지 번호 자리표시자 가시성을 변경합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문 해제 구현입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
