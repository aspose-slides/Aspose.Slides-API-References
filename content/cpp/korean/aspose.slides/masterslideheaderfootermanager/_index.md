...
description: 마스터 슬라이드 바닥글, 날짜-시간, 페이지 번호 자리표시자 및 모든 하위 자리표시자의 동작을 보유하는 관리자를 나타냅니다. 하위 자리표시자는 종속 레이아웃 슬라이드 및 종속 슬라이드에 포함된 자리표시자를 의미합니다. 종속 레이아웃 슬라이드와 슬라이드는 마스터 슬라이드를 사용하고 의존합니다.
type: docs
weight: 4499
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-style 부동소수점 비교를 에뮬레이트합니다. 두 NaN을 동일하게 간주하지만 IEC 60559:1989에 따르면 NaN은 모든 값(NA 포함)과 동일하지 않습니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-style 부동소수점 비교를 에뮬레이트합니다. 두 NaN을 동일하게 간주하지만 IEC 60559:1989에 따르면 NaN은 모든 값(NA 포함)과 동일하지 않습니다. |
...
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | 바닥글 자리 표시자가 존재함을 나타내는 값을 가져옵니다. Read **bool**. |
...
| void [SetDateTimeAndChildDateTimesText](./setdatetimeandchilddatetimestext/)([System::String](../../system/string/)) override | 마스터 슬라이드 날짜-시간 자리 표시자와 모든 하위 날짜-시간 자리 표시자에 텍스트를 설정합니다. 하위 자리 표시자는 종속 레이아웃 슬라이드 및 종속 슬라이드에 포함된 자리 표시자를 의미합니다. 종속 레이아웃 슬라이드와 슬라이드는 마스터 슬라이드를 사용하고 의존합니다. |
| void [SetDateTimeAndChildDateTimesVisibility](./setdatetimeandchilddatetimesvisibility/)(**bool**) override | 마스터 슬라이드 날짜-시간 자리 표시자와 모든 하위 날짜-시간 자리 표시자의 가시성을 변경합니다. 하위 자리 표시자는 종속 레이아웃 슬라이드 및 종속 슬라이드에 포함된 자리 표시자를 의미합니다. 종속 레이아웃 슬라이드와 슬라이드는 마스터 슬라이드를 사용하고 의존합니다. |
...
| void [SetFooterAndChildFootersText](./setfooterandchildfooterstext/)([System::String](../../system/string/)) override | 마스터 슬라이드 바닥글 자리 표시자와 모든 하위 바닥글 자리 표시자에 텍스트를 설정합니다. 하위 자리 표시자는 종속 레이아웃 슬라이드 및 종속 슬라이드에 포함된 자리 표시자를 의미합니다. 종속 레이아웃 슬라이드와 슬라이드는 마스터 슬라이드를 사용하고 의존합니다. |
| void [SetFooterAndChildFootersVisibility](./setfooterandchildfootersvisibility/)(**bool**) override | 마스터 슬라이드 바닥글 자리 표시자와 모든 하위 바닥글 자리 표시자의 가시성을 변경합니다. 하위 자리 표시자는 종속 레이아웃 슬라이드 및 종속 슬라이드에 포함된 자리 표시자를 의미합니다. 종속 레이아웃 슬라이드와 슬라이드는 마스터 슬라이드를 사용하고 의존합니다. |
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | 슬라이드 바닥글 자리 표시자에 텍스트를 설정합니다. |
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | 슬라이드 바닥글 자리 표시자의 가시성을 변경합니다. |
| void [SetSlideNumberAndChildSlideNumbersVisibility](./setslidenumberandchildslidenumbersvisibility/)(**bool**) override | 마스터 슬라이드 페이지 번호 자리 표시자와 모든 하위 페이지 번호 자리 표시자의 가시성을 변경합니다. 하위 자리 표시자는 종속 레이아웃 슬라이드 및 종속 슬라이드에 포함된 자리 표시자를 의미합니다. 종속 레이아웃 슬라이드와 슬라이드는 마스터 슬라이드를 사용하고 의존합니다. |
...
* 클래스 [IMasterSlideHeaderFooterManager](../imasterslideheaderfootermanager/)
