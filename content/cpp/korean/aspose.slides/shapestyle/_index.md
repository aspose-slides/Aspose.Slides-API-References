...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_EffectColor](./get_effectcolor/)() override | 도형의 효과 색상을 반환합니다. 읽기 전용 [IColorFormat](../icolorformat/). |
| **uint32_t** [get_EffectStyleIndex](./get_effectstyleindex/)() override | 도형의 효과 열 인덱스를 스타일 매트릭스에서 반환합니다. 읽기 **uint32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_FillColor](./get_fillcolor/)() override | 도형의 채우기 색상을 반환합니다. 읽기 전용 [IColorFormat](../icolorformat/). |
| **int16_t** [get_FillStyleIndex](./get_fillstyleindex/)() override | 스타일 매트릭스에서 도형의 채우기 열 인덱스를 반환합니다. 0은 채우기 없음, 양수 값은 테마의 채우기 스타일 인덱스, 음수 값은 테마 배경 스타일 인덱스를 의미합니다. 읽기 **int16_t**. |
| [Aspose::Slides::FontCollectionIndex](../fontcollectionindex/) [get_FontCollectionIndex](./get_fontcollectionindex/)() override | 폰트 컬렉션에서 도형의 폰트 인덱스를 반환합니다. 읽기 [Slides::FontCollectionIndex](../fontcollectionindex/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_FontColor](./get_fontcolor/)() override | 도형의 폰트 색상을 반환합니다. 읽기 전용 [IColorFormat](../icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_LineColor](./get_linecolor/)() override | 도형의 외곽선 색상을 반환합니다. 읽기 전용 [IColorFormat](../icolorformat/). |
| **uint16_t** [get_LineStyleIndex](./get_linestyleindex/)() override | 스타일 매트릭스에서 선의 열 인덱스를 반환합니다. 읽기 **uint16_t**. |
...
| void [set_EffectStyleIndex](./set_effectstyleindex/)(**uint32_t**) override | 스타일 매트릭스에서 도형의 효과 열 인덱스를 설정합니다. 쓰기 **uint32_t**. |
| void [set_FillStyleIndex](./set_fillstyleindex/)(**int16_t**) override | 스타일 매트릭스에서 도형의 채우기 열 인덱스를 설정합니다. 0은 채우기 없음, 양수 값은 테마의 채우기 스타일 인덱스, 음수 값은 테마 배경 스타일 인덱스를 의미합니다. 쓰기 **int16_t**. |
| void [set_FontCollectionIndex](./set_fontcollectionindex/)([Aspose::Slides::FontCollectionIndex](../fontcollectionindex/)) override | 폰트 컬렉션에서 도형의 폰트 인덱스를 설정합니다. 쓰기 [Slides::FontCollectionIndex](../fontcollectionindex/). |
| void [set_LineStyleIndex](./set_linestyleindex/)(**uint16_t**) override | 스타일 매트릭스에서 선의 열 인덱스를 설정합니다. 쓰기 **uint16_t**. |
