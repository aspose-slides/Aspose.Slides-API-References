...
description: 커스텀 데이터용 컨테이너를 나타냅니다.
type: docs
weight: 1912
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-style 부동소수점 비교를 에뮬레이트합니다. 두 NaN은 IEC 60559:1989에 따라 어떤 값이나 NaN 자체와도 같지 않지만, 여기서는 동일하게 간주됩니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-style 부동소수점 비교를 에뮬레이트합니다. 두 NaN은 IEC 60559:1989에 따라 어떤 값이나 NaN 자체와도 같지 않지만, 여기서는 동일하게 간주됩니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) | 지정된 인덱스의 사용자 정의 XML 파트를 반환합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() | 사용자 정의 xml 파트 컬렉션을 반환합니다. 읽기 전용 [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| virtual [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) | 인덱스에 지정된 고객 데이터 태그를 반환합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() | 고객 데이터 태그 컬렉션을 반환합니다. 읽기 전용 [ITagCollection](../itagcollection/). |
...
| virtual void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) | 인덱스에 지정된 고객 데이터 태그를 설정합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 템플릿의 n번째 인수를 공유가 아닌 약한 포인터로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
