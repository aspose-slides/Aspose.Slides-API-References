...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도(자신을 포함) 같지 않지만, C# 스타일 부동 소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도(자신을 포함) 같지 않지만, C# 스타일 부동 소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
...
| [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() override | 스케치 유형을 반환합니다. 읽기 [Slides::LineSketchType](../linesketchtype/). |
...
| void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) override | 스케치 유형을 설정합니다. 쓰기 [Slides::LineSketchType](../linesketchtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인수를 약한 포인터(**uint32_t**)로 설정합니다(공유 대신). 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
...
* 클래스 [ISketchFormat](../isketchformat/)
