...
| 메서드 | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | 새로운 자리표시자가 없을 경우 새 자리표시자를 추가하고 지정된 자리표시자 속성을 설정합니다. |
...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | 속성은 도형이 흑백 표시 모드에서 어떻게 렌더링될지를 지정합니다. 읽기 [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual **int32_t** [get_ConnectionSiteCount](../ishape/get_connectionsitecount/)() | 도형의 연결 위치 개수를 반환합니다. 읽기 전용 **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [get_EmbeddedVideo](./get_embeddedvideo/)() | 임베드된 비디오 객체를 반환합니다. 읽기 [IVideo](../ivideo/). |
...
| virtual **bool** [get_FullScreenMode](./get_fullscreenmode/)() | 비디오가 전체 화면 모드로 표시되는지 여부를 결정합니다. 읽기 **bool**. |
...
| virtual **bool** [get_HideAtShowing](./get_hideatshowing/)() | [VideoFrame](../videoframe/)가 숨겨져 있는지 여부를 결정합니다. 읽기 **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | [VideoFrame](../videoframe/)에 연결된 비디오 파일 이름을 반환합니다. 읽기 [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](../ishape/get_name/)() | 도형의 이름을 반환합니다. 읽기 [System::String](../../system/string/). |
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | 도형의 수명 동안 일정하게 유지되는 슬라이드 범위 고유 식별자를 반환하며, PowerPoint 또는 interop 코드가 문서 어디에서든 도형을 안정적으로 참조할 수 있게 합니다. 읽기 전용 **uint32_t**. 참조 [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFrameLock](../ipictureframelock/)\> [get_PictureFrameLock](../ipictureframe/get_pictureframelock/)() | [PictureFrame](../pictureframe/)의 잠금을 반환합니다. 읽기 전용 [IPictureFrameLock](../ipictureframelock/). |
...
| virtual **bool** [get_PlayLoopMode](./get_playloopmode/)() | 비디오가 루프되는지 여부를 결정합니다. 읽기 **bool**. |
| virtual [VideoPlayModePreset](../videoplaymodepreset/) [get_PlayMode](./get_playmode/)() | 비디오 재생 모드를 반환합니다. 읽기 [VideoPlayModePreset](../videoplaymodepreset/). |
...
| virtual **float** [get_RelativeScaleHeight](../ipictureframe/get_relativescaleheight/)() | 그림 프레임의 높이 비율(원본 이미지 크기에 대한) 스케일을 반환합니다. 값 1.0은 100%에 해당합니다. 읽기 **float**. |
| virtual **float** [get_RelativeScaleWidth](../ipictureframe/get_relativescalewidth/)() | 그림 프레임의 너비 비율(원본 이미지 크기에 대한) 스케일을 반환합니다. 값 1.0은 100%에 해당합니다. 읽기 **float**. |
| virtual **bool** [get_RewindVideo](./get_rewindvideo/)() | 동영상 재생이 끝나면 비디오가 자동으로 시작 지점으로 되감기는지 여부를 결정합니다. 읽기 **bool**. |
| virtual **float** [get_Rotation](../ishape/get_rotation/)() | 지정된 도형이 z축을 기준으로 회전한 각도(도)를 반환합니다. 양수 값은 시계 방향 회전을, 음수 값은 반시계 방향 회전을 나타냅니다. 읽기 **float**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeStyle](../ishapestyle/)\> [get_ShapeStyle](../igeometryshape/get_shapestyle/)() | 도형 스타일 객체를 반환합니다. 읽기 전용 [IShapeStyle](../ishapestyle/). |
| virtual [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](../igeometryshape/get_shapetype/)() | 기하 학습 프리셋 유형을 반환합니다. 참고: 값을 변경하면 모든 조정값이 기본값으로 재설정됩니다. 읽기 [Slides::ShapeType](../shapetype/). |
...
| virtual **float** [get_TrimFromEnd](./get_trimfromend/)() | 끝 트림 [ms] |
| virtual **float** [get_TrimFromStart](./get_trimfromstart/)() | 시작 트림 [ms] |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | 애드인이나 다른 코드에서 사용하도록 의도된 내부 프레젠테이션 범위 식별자를 반환합니다. 이 값은 사용자나 프로그램에 의해 재할당될 수 있으므로 지속적인 고유 키로 간주해서는 안 됩니다. 읽기 전용 **uint32_t**. 참조 [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>\> [GetGeometryPaths](../igeometryshape/getgeometrypaths/)() | 기하 도형의 경로 복사본을 반환합니다. 좌표는 도형의 좌측 상단 모서리를 기준으로 합니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../ishape/getimage/)() | 도형 썸네일을 반환합니다. [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) 도형 썸네일 경계 유형이 기본적으로 사용됩니다. |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | 속성은 도형이 흑백 표시 모드에서 어떻게 렌더링될지를 지정합니다. 쓰기 [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual void [set_EmbeddedVideo](./set_embeddedvideo/)([System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>) | 임베드된 비디오 객체를 설정합니다. 쓰기 [IVideo](../ivideo/). |
...
| virtual void [set_FullScreenMode](./set_fullscreenmode/)(**bool**) | 비디오가 전체 화면 모드로 표시되는지 여부를 설정합니다. 쓰기 **bool**. |
...
| virtual void [set_HideAtShowing](./set_hideatshowing/)(**bool**) | [VideoFrame](../videoframe/)가 숨겨져 있는지 여부를 설정합니다. 쓰기 **bool**. |
...
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | [VideoFrame](../videoframe/)에 연결된 비디오 파일 이름을 설정합니다. 쓰기 [System::String](../../system/string/). |
| virtual void [set_Name](../ishape/set_name/)([System::String](../../system/string/)) | 도형의 이름을 설정합니다. 쓰기 [System::String](../../system/string/). |
| virtual void [set_PlayLoopMode](./set_playloopmode/)(**bool**) | 비디오가 루프되는지 여부를 설정합니다. 쓰기 **bool**. |
| virtual void [set_PlayMode](./set_playmode/)([VideoPlayModePreset](../videoplaymodepreset/)) | 비디오 재생 모드를 설정합니다. 쓰기 [VideoPlayModePreset](../videoplaymodepreset/). |
...
| virtual void [set_RelativeScaleHeight](../ipictureframe/set_relativescaleheight/)(**float**) | 그림 프레임의 높이 비율(원본 이미지 크기에 대한) 스케일을 설정합니다. 값 1.0은 100%에 해당합니다. 쓰기 **float**. |
| virtual void [set_RelativeScaleWidth](../ipictureframe/set_relativescalewidth/)(**float**) | 그림 프레임의 너비 비율(원본 이미지 크기에 대한) 스케일을 설정합니다. 값 1.0은 100%에 해당합니다. 쓰기 **float**. |
| virtual void [set_RewindVideo](./set_rewindvideo/)(**bool**) | 동영상 재생이 끝나면 비디오를 자동으로 시작 지점으로 되감는지 여부를 설정합니다. 쓰기 **bool**. |
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | 지정된 도형이 z축을 기준으로 회전한 각도(도)를 설정합니다. 양수 값은 시계 방향 회전을, 음수 값은 반시계 방향 회전을 나타냅니다. 쓰기 **float**. |
| virtual void [set_ShapeType](../igeometryshape/set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) | 기하학 프리셋 유형을 설정합니다. 참고: 값을 변경하면 모든 조정값이 기본값으로 재설정됩니다. 쓰기 [Slides::ShapeType](../shapetype/). |
| virtual void [set_TrimFromEnd](./set_trimfromend/)(**float**) | 끝 트림 [ms] |
| virtual void [set_TrimFromStart](./set_trimfromstart/)(**float**) | 시작 트림 [ms] |
...
| virtual void [SetGeometryPath](../igeometryshape/setgeometrypath/)([System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>) | [IGeometryPath](../igeometrypath/) 객체에서 도형 기하학을 업데이트합니다. 좌표는 도형의 좌측 상단 모서리를 기준으로 해야 합니다. 도형 유형을 ([ShapeType](../shapetype/))에서 [ShapeType::Custom](../shapetype/)로 변경합니다. |
| virtual void [SetGeometryPaths](../igeometryshape/setgeometrypaths/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>\>) | [IGeometryPath](../igeometrypath/) 배열에서 도형 기하학을 업데이트합니다. 좌표는 도형의 좌측 상단 모서리를 기준으로 해야 합니다. 도형 유형을 ([ShapeType](../shapetype/))에서 [ShapeType::Custom](../shapetype/)로 변경합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 템플릿 인수 n번째를 약한 포인터(공유 대신)로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있습니다. |
