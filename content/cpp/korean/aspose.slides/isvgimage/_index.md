...
| virtual [System::String](../../system/string/) [get_BaseUri](./get_baseuri/)() | 지정된 SVG의 기본 URI를 반환합니다. 상대 링크를 해석하는 데 사용됩니다. 읽기 전용 [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\> [get_ExternalResourceResolver](./get_externalresourceresolver/)() | SVG 문서 가져오기 중 외부 리소스를 해석하는 데 사용되는 콜백 인터페이스를 반환합니다. 읽기 전용 [Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/). |
| virtual [System::String](../../system/string/) [get_SvgContent](./get_svgcontent/)() | SVG 콘텐츠를 반환합니다. 읽기 전용 [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_SvgData](./get_svgdata/)() | SVG 데이터를 반환합니다. 읽기 전용 **uint8_t**[]. |
...
| virtual void [WriteAsEmf](./writeasemf/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | SVG 이미지를 EMF 파일로 저장합니다. |
