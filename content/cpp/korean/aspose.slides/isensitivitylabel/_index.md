...
---
## ISensitivityLabel 클래스

Microsoft Purview Information Protection의 민감도 레이블을 나타냅니다.
...
| virtual [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() | 민감도 레이블의 할당 방법을 반환합니다. 읽기 [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() | 파일에 적용되어야 하는 콘텐츠 마킹 유형 목록을 반환합니다. |
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | 민감도 레이블의 ID를 반환합니다. 읽기 [System::String](../../system/string/). |
| virtual **bool** [get_IsEnabled](./get_isenabled/)() | 민감도 레이블이 활성화되어 있는지 표시합니다. |
| virtual **bool** [get_IsRemoved](./get_isremoved/)() | 민감도 레이블이 제거되었는지 표시합니다. |
| virtual [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() | 민감도 레이블 정책을 설명하는 Azure Active Directory (Azure AD) 사이트 식별자를 반환합니다. 읽기 [System::Guid](../../system/guid/). |
...
| virtual void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | 민감도 레이블의 할당 방법을 설정합니다. 쓰기 [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | 민감도 레이블의 ID를 설정합니다. 쓰기 [System::String](../../system/string/). |
| virtual void [set_IsEnabled](./set_isenabled/)(**bool**) | 민감도 레이블이 활성화되어 있는지 지정합니다. |
| virtual void [set_IsRemoved](./set_isremoved/)(**bool**) | 민감도 레이블이 제거되었는지 지정합니다. |
| virtual void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) | 민감도 레이블을 설명하는 Azure Active Directory (Azure AD) 사이트 식별자를 설정합니다. 쓰기 [System::Guid](../../system/guid/). |
