...
description: 모든 슬라이드 유형에 대한 바닥글, 날짜-시간, 페이지 번호 자리표시자의 동작을 관리하는 매니저를 나타냅니다.
type: docs
weight: 1509
url: /ko/aspose.slides/ibaseslideheaderfootermanager/
---
## IBaseSlideHeaderFooterManager 클래스

모든 슬라이드 유형에 대한 바닥글, 날짜-시간, 페이지 번호 자리표시자의 동작을 관리하는 매니저를 나타냅니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도(NaN 포함) 같지 않음에도 불구하고 동일하게 간주되는 C#-스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도(NaN 포함) 같지 않음에도 불구하고 동일하게 간주되는 C#-스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() | 날짜-시간 자리표시자가 존재함을 나타내는 값을 가져옵니다. 읽기 **bool**. |
| virtual **bool** [get_IsFooterVisible](./get_isfootervisible/)() | 바닥글 자리표시자가 존재함을 나타내는 값을 가져옵니다. 읽기 **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() | 페이지 번호 자리표시자가 존재함을 나타내는 값을 가져옵니다. 읽기 **bool**. |
...
| virtual void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) | 슬라이드 날짜-시간 자리표시자에 텍스트를 설정합니다. |
| virtual void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) | 슬라이드 날짜-시간 자리표시자 가시성을 변경합니다. |
| virtual void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) | 슬라이드 바닥글 자리표시자에 텍스트를 설정합니다. |
| virtual void [SetFooterVisibility](./setfootervisibility/)(**bool**) | 슬라이드 바닥글 자리표시자 가시성을 변경합니다. |
| virtual void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) | 슬라이드 페이지 번호 자리표시자 가시성을 변경합니다. |
