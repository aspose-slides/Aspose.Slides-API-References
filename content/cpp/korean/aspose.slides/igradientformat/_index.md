...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | 그라디언트의 스타일을 반환합니다. [Slides::GradientDirection](../gradientdirection/)를 읽으세요. |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | 그라디언트의 형태를 반환합니다. [Slides::GradientShape](../gradientshape/)를 읽으세요. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | 지정된 인덱스의 그라디언트 스톱을 반환합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollection](../igradientstopcollection/)\> [get_GradientStops](./get_gradientstops/)() | 그라디언트 스톱 컬렉션을 반환합니다. 읽기 전용 [IGradientStopCollection](../igradientstopcollection/). |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | 그라디언트의 각도를 반환합니다. **float**를 읽으세요. |
| virtual [NullableBool](../nullablebool/) [get_LinearGradientScaled](./get_lineargradientscaled/)() | 그라디언트가 스케일링되는지 여부를 결정합니다. [NullableBool](../nullablebool/)를 읽으세요. |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | 그라디언트의 플리핑 모드를 반환합니다. [Slides::TileFlip](../tileflip/)를 읽으세요. |
...
| virtual void [set_GradientDirection](./set_gradientdirection/)([Aspose::Slides::GradientDirection](../gradientdirection/)) | 그라디언트의 스타일을 설정합니다. 쓰기 [Slides::GradientDirection](../gradientdirection/). |
| virtual void [set_GradientShape](./set_gradientshape/)([Aspose::Slides::GradientShape](../gradientshape/)) | 그라디언트의 형태를 설정합니다. 쓰기 [Slides::GradientShape](../gradientshape/). |
| virtual void [set_LinearGradientAngle](./set_lineargradientangle/)(**float**) | 그라디언트의 각도를 설정합니다. 쓰기 **float**. |
| virtual void [set_LinearGradientScaled](./set_lineargradientscaled/)([NullableBool](../nullablebool/)) | 그라디언트가 스케일링되는지 여부를 결정합니다. 쓰기 [NullableBool](../nullablebool/). |
| virtual void [set_TileFlip](./set_tileflip/)([Aspose::Slides::TileFlip](../tileflip/)) | 그라디언트의 플리핑 모드를 설정합니다. 쓰기 [Slides::TileFlip](../tileflip/). |
