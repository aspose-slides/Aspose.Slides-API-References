...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-style 부동소수점 비교를 에뮬레이트하며, IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-style 부동소수점 비교를 에뮬레이트하며, IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | 오디오 데이터의 복사본을 반환합니다. 데이터 양이 많을 경우 [IVideo::GetStream](./getstream/) 메서드를 사용하여 비디오 데이터가 메모리로 불필요하게 로드되거나 OutOfMemoryException이 발생하는 것을 방지하십시오. 읽기 전용 **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | 비디오의 MIME 유형을 [IVideo::get_BinaryData](./get_binarydata/)으로 인코딩하여 반환합니다. 읽기 전용 [System::String](../../system/string/). |
