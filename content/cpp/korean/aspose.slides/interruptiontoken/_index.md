...
This 클래스는 장기 실행 작업에 대한 중단 요청 여부를 알리기 위해 사용할 토큰을 나타냅니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일 부동 소수점 비교를 에뮬레이트하여, IEC 60559:1989에 따르면 NaN은 어떤 값과도(NAN 포함) 같지 않음에도 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일 부동 소수점 비교를 에뮬레이트하여, IEC 60559:1989에 따르면 NaN은 어떤 값과도(NaN 포함) 같지 않음에도 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | **bool**.true를 반환합니다. 중단이 요청된 경우. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | 빈 인터럽션 토큰을 나타냅니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자. 실제로는 아무 것도 복사하지 않고 새로운 객체를 초기화하며 서브클래스 복사 생성을 가능하게 합니다. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | 예외를 
중단이 요청된 경우 발생시킵니다. |
