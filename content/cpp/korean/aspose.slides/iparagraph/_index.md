...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_EndParagraphPortionFormat](./get_endparagraphportionformat/)() | 마지막 부분 뒤에 다른 부분이 삽입될 경우 사용할 부분 속성을 지정합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | 이 단락에 대한 서식 객체를 반환합니다. 읽기 전용 [IParagraphFormat](../iparagraphformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [get_Portion](./get_portion/)(**int32_t**) | 지정된 인덱스에 있는 텍스트 부분을 반환합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionCollection](../iportioncollection/)\> [get_Portions](./get_portions/)() | 텍스트 부분들의 컬렉션을 반환합니다. 읽기 전용 [IPortionCollection](../iportioncollection/). |
...
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | 단락의 일반 텍스트를 가져옵니다. 읽기 [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 가져옵니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| virtual **int32_t** [GetLinesCount](./getlinescount/)() | 단락의 줄 수를 가져옵니다. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | 단락을 둘러싸는 사각형의 좌표를 가져옵니다. 이 사각형은 빈 줄을 포함한 단락의 모든 텍스트 줄을 포함합니다. |
...
| virtual void [JoinPortionsWithSameFormatting](./joinportionswithsameformatting/)() | 동일한 서식을 가진 실행을 연결합니다. |
...
| virtual void [set_EndParagraphPortionFormat](./set_endparagraphportionformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | 마지막 부분 뒤에 다른 부분이 삽입될 경우 사용할 부분 속성을 지정합니다. |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | 단락의 일반 텍스트를 설정합니다. 쓰기 [System::String](../../system/string/). |
