...
description: 도형의 주요 면 양각에 대한 속성을 포함합니다.
type: docs
weight: 5097
...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | 베벨 유형. 읽기 [BevelPresetType](../bevelpresettype/). |
| **double** [get_Height](./get_height/)() override | 베벨 높이. 읽기 **double**. |
...
| **double** [get_Width](./get_width/)() override | 베벨 너비. 읽기 **double**. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | 베벨 유형. 쓰기 [BevelPresetType](../bevelpresettype/). |
| void [set_Height](./set_height/)(**double**) override | 베벨 높이. 쓰기 **double**. |
| void [set_Width](./set_width/)(**double**) override | 베벨 너비. 쓰기 **double**. |
