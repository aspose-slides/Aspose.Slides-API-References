...
description: 지정된 텍스트의 모든 항목을 다른 지정된 텍스트로 교체합니다.
type: docs
weight: 482
url: /ko/aspose.slides/ipresentation/replacetext/
---
## IPresentation::ReplaceText(System::String, System::String, System::SharedPtr\<ITextSearchOptions\>, System::SharedPtr\<IFindResultCallback\>) 메서드

지정된 텍스트의 모든 항목을 다른 지정된 텍스트로 교체합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| oldText | [System::String](../../../system/string/) | 교체될 문자열입니다. |
| newText | [System::String](../../../system/string/) | oldText의 모든 항목을 교체할 문자열입니다. |
