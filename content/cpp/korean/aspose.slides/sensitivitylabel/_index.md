...
type: docs
weight: 5058
url: /ko/aspose.slides/sensitivitylabel/
---
## SensitivityLabel 클래스
...
| [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() override | 민감도 레이블의 할당 방법을 반환합니다. 읽기 [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() override | 파일에 적용되어야 하는 콘텐츠 마킹 유형 목록을 반환합니다. |
| [System::String](../../system/string/) [get_Id](./get_id/)() override | 민감도 레이블의 ID를 반환합니다. 읽기 [System::String](../../system/string/). |
| **bool** [get_IsEnabled](./get_isenabled/)() override | 민감도 레이블이 활성화되어 있는지 여부를 나타냅니다. |
| **bool** [get_IsRemoved](./get_isremoved/)() override | 민감도 레이블이 제거되었는지 여부를 나타냅니다. |
| [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() override | 민감도 레이블을 설명하는 민감도 레이블 정책에 해당하는 Azure Active Directory(Azure AD) 사이트 식별자를 반환합니다. 읽기 [System::Guid](../../system/guid/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로는 아무것도 복사하지 않고 새 객체를 초기화하며 하위 클래스의 복사 생성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자입니다. 실제로는 아무것도 복사하지 않고 새 객체를 초기화하며 하위 클래스의 복사 생성을 가능하게 합니다. |
...
| void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) override | 민감도 레이블의 할당 방법을 설정합니다. 쓰기 [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | 민감도 레이블의 ID를 설정합니다. 쓰기 [System::String](../../system/string/). |
| void [set_IsEnabled](./set_isenabled/)(**bool**) override | 민감도 레이블이 활성화되어 있는지 여부를 나타냅니다. |
| void [set_IsRemoved](./set_isremoved/)(**bool**) override | 민감도 레이블이 제거되었는지 여부를 나타냅니다. |
| void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) override | 민감도 레이블을 설명하는 민감도 레이블 정책에 해당하는 Azure Active Directory(Azure AD) 사이트 식별자를 설정합니다. 쓰기 [System::Guid](../../system/guid/). |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 경비 객체를 사용하십시오. |
