...
모든 슬라이드 유형에 대해 푸터, 날짜-시간, 페이지 번호 자리 표시자의 동작을 관리하는 매니저를 나타냅니다.
...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | 날짜-시간 자리 표시자가 존재함을 나타내는 값을 가져옵니다. Read**bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | 푸터 자리 표시자가 존재함을 나타내는 값을 가져옵니다. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | 페이지 번호 자리 표시자가 존재함을 나타내는 값을 가져옵니다. Read**bool**. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현하여 잠금을 걸습니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드와 유사합니다. 사용자 정의 타입 클론을 지원합니다. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | 슬라이드 날짜-시간 자리 표시자에 텍스트를 설정합니다. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | 슬라이드 날짜-시간 자리 표시자 가시성을 변경합니다. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | 슬라이드 푸터 자리 표시자에 텍스트를 설정합니다. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | 슬라이드 푸터 자리 표시자 가시성을 변경합니다. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | 슬라이드 페이지 번호 자리 표시자 가시성을 변경합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 약한 포인터(공유가 아님)로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있습니다. |
