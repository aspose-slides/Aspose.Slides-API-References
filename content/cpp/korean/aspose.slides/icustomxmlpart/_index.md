...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Office Open XML 문서 내에서 단일 커스텀 XML 파트를 고유하게 식별하는 전역 고유 식별자(GUID)를 지정합니다. 읽기 전용 [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | 커스텀 XML 파트와 연결된 컬렉션 XML 스키마를 반환합니다. 읽기 전용 [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | XML 데이터를 UTF-8 문자열로 반환합니다. 읽기 [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | XML 데이터를 반환합니다. 읽기 **uint8_t**[]. |
...
| virtual void [Remove](./remove/)() | 프레젠테이션에서 커스텀 XML 파트를 제거합니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값만큼 공유 레퍼런스 카운트를 감소시킵니다. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Office Open XML 문서 내에서 단일 커스텀 XML 파트를 고유하게 식별하는 전역 고유 식별자(GUID)를 지정합니다. 읽기 전용 [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | XML 데이터를 UTF-8 문자열로 설정합니다. 쓰기 [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | XML 데이터를 설정합니다. 쓰기 **uint8_t**[]. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문 해제 구현을 수행합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하십시오. |
