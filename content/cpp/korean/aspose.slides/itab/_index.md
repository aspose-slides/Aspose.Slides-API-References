...
description: 텍스트에 대한 탭 정렬을 나타냅니다.
type: docs
weight: 3966
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않음). |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않음). |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | 탭의 정렬 스타일을 반환합니다. [TabAlignment](../tabalignment/)를 읽으십시오. |
| virtual **double** [get_Position](./get_position/)() | 탭의 위치를 반환합니다. 이 속성을 할당하면 컬렉션에서 탭의 인덱스가 변경되고 Enumerator가 무효화될 수 있습니다. **double**을 읽으십시오. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | 탭의 정렬 스타일을 설정합니다. [TabAlignment](../tabalignment/)에 씁니다. |
| virtual void [set_Position](./set_position/)(**double**) | 탭의 위치를 설정합니다. 이 속성을 할당하면 컬렉션에서 탭의 인덱스가 변경되고 Enumerator가 무효화될 수 있습니다. **double**에 씁니다. |
