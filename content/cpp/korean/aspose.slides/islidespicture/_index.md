...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | 임베디드 이미지를 반환합니다. 읽기 [IPPImage](../ippimage/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/)\> [get_ImageTransform](./get_imagetransform/)() | 이미지 변환 효과 컬렉션을 반환합니다. 읽기 전용 [IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperation](../../aspose.slides.effects/iimagetransformoperation/)\> [get_ImageTransformOperation](./get_imagetransformoperation/)(**int32_t**) | 지정된 인덱스의 이미지 변환 작업을 반환합니다. |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | 연결된 이미지의 URL을 반환합니다. 읽기 [System::String](../../system/string/). |
...
| virtual void [set_Image](./set_image/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | 임베디드 이미지를 설정합니다. 쓰기 [IPPImage](../ippimage/). |
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | 연결된 이미지의 URL을 반환합니다. 쓰기 [System::String](../../system/string/). |
