...
| Method | 설명 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) | 새 그라디언트 스톱을 만들고 컬렉션 끝에 추가합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) | 새 그라디언트 스톱을 만들고 컬렉션 끝에 추가합니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) | 새 그라디언트 스톱을 만들고 컬렉션 끝에 추가합니다. |
...
| virtual void [Clear](./clear/)() | 컬렉션에서 모든 그라디언트 스톱을 제거합니다. |
...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | 컬렉션에 있는 동작의 수를 반환합니다. 읽기 전용 **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) | 인덱스로 그라디언트 스톱을 반환합니다. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) | 새 그라디언트 스톱을 만들고 지정된 인덱스에 삽입합니다. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) | 새 그라디언트 스톱을 만들고 지정된 인덱스에 삽입합니다. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) | 새 그라디언트 스톱을 만들고 지정된 인덱스에 삽입합니다. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 지정된 인덱스에서 그라디언트 스톱을 제거합니다. |
