...
| 메서드 | 설명 |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | 현재 인스턴스를 동일한 유형의 다른 객체와 비교합니다. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | 탭의 정렬 스타일을 반환합니다. [TabAlignment](../tabalignment/)를 읽으세요. |
...
| **double** [get_Position](./get_position/)() override | 탭의 위치를 반환합니다. 이 속성을 할당하면 컬렉션에서 탭의 인덱스가 변경되고 열거자가 무효화될 수 있습니다. **double**를 읽으세요. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 가져옵니다. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | 해시 코드를 반환합니다. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 객체의 실제 타입을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출의 유사물입니다. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType으로 설명된 타입의 인스턴스를 나타내는지 확인합니다. C# 'is' 연산자의 유사물입니다. |
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현한 잠금입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드의 유사물입니다. 사용자 정의 타입 복제를 가능하게 합니다. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | 탭의 정렬 스타일을 설정합니다. [TabAlignment](../tabalignment/)에 씁니다. |
| void [set_Position](./set_position/)(**double**) override | 탭의 위치를 설정합니다. 이 속성을 할당하면 컬렉션에서 탭의 인덱스가 변경되고 열거자가 무효화될 수 있습니다. **double**에 씁니다. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | 새로운 [Tab](./)를 생성합니다. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 메서드의 유사물입니다. 사용자 정의 객체를 문자열로 변환할 수 있게 합니다. |
