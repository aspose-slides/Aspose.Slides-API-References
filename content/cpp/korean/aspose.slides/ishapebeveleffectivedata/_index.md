...
description: 효과적인 도형의 표면 릴리프 속성을 포함하는 불변 객체.
type: docs
weight: 3667
url: /ko/aspose.slides/ishapebeveleffectivedata/
---
## IShapeBevelEffectiveData 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(NaN 포함) 같지 않지만, C# 스타일 부동 소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도(NaN 포함) 같지 않지만, C# 스타일 부동 소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부용으로만 사용됩니다. |
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | 베벨 유형. 읽기 전용 [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | 베벨 높이. 읽기 전용 **double**. |
| virtual **double** [get_Width](./get_width/)() | 베벨 너비. 읽기 전용 **double**. |
