...
description: 선 스케치 형식에 대한 속성을 나타냅니다.
type: docs
weight: 3732
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | 스케치 타입을 반환합니다. 읽기 [Slides::LineSketchType](../linesketchtype/). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정값만큼 공유 레퍼런스 카운트를 감소시킵니다. |
| virtual void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) | 스케치 타입을 설정합니다. 쓰기 [Slides::LineSketchType](../linesketchtype/). |
