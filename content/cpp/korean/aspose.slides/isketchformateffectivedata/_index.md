...
description: 실제 라인 스케치 속성을 포함하는 불변 객체입니다.
type: docs
weight: 3745
url: /ko/aspose.slides/isketchformateffectivedata/
---
## ISketchFormatEffectiveData 클래스

실제 라인 스케치 속성을 포함하는 불변 객체입니다.
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | 스케치 유형을 반환합니다. 읽기 전용 [Slides::LineSketchType](../linesketchtype/). |
