...
description: 마스터 핸드아웃 슬라이드 자리표시자의 동작을 담당하는 관리자를 나타내며, 머리글 자리표시자를 포함합니다.
type: docs
weight: 4421
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만… |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 동일하게 간주하는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만… |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | 날짜-시간 자리표시자가 존재함을 나타내는 값을 가져옵니다. 읽기**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | 바닥글 자리표시자가 존재함을 나타내는 값을 가져옵니다. 읽기 **bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | 머리글 자리표시자가 존재함을 나타내는 값을 가져옵니다. 읽기 **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | 페이지 번호 자리표시자가 존재함을 나타내는 값을 가져옵니다. 읽기**bool**. |
...
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | 슬라이드 바닥글 자리표시자에 텍스트를 설정합니다. |
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | 슬라이드 바닥글 자리표시자의 가시성을 변경합니다. |
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | 슬라이드 머리글 자리표시자에 텍스트를 설정합니다. |
| void [SetHeaderVisibility](../basehandoutnotesslideheaderfootermanager/setheadervisibility/)(**bool**) override | 슬라이드 머리글 자리표시자의 가시성을 변경합니다. |
...
* 클래스 [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)
