...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 지정된 [GradientStopEffectiveData](./)가 현재 [GradientStopEffectiveData](./)와 같은지 확인합니다. |
...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | 그라디언트 스톱의 색상을 반환합니다. 읽기 전용 [System::Drawing::Color](../../system.drawing/color/). |
| **float** [get_Position](./get_position/)() override | 그라디언트 스톱의 위치(0..1)를 반환합니다. 읽기 전용 **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로 아무 것도 복사하지 않으며, 새로운 객체를 초기화하고 하위 클래스의 복사 생성을 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자입니다. 실제로 아무 것도 복사하지 않으며, 새로운 객체를 초기화하고 하위 클래스의 복사 생성을 가능하게 합니다. |
...
* 클래스 [IGradientStopEffectiveData](../igradientstopeffectivedata/)
