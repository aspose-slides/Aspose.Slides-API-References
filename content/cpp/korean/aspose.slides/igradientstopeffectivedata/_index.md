...
---
## IGradientStopEffectiveData 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도—NaN 자체를 포함—동등하지 않지만, 두 NaN을 동등하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도—NaN 자체를 포함—동등하지 않지만, 두 NaN을 동등하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 그라디언트 스톱의 색상을 반환합니다. 읽기 전용 [System::Drawing::Color](../../system.drawing/color/). |
| virtual **float** [get_Position](./get_position/)() | 그라디언트 스톱의 위치(0..1)를 반환합니다. 읽기 전용 **float**. |
