...
| 메서드 | 설명 |
| --- | --- |
|  [DigitalSignature](./digitalsignature/)([System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\>) | 지정된 인증서를 사용하여 새 [DigitalSignature](./) 객체를 생성합니다. |
|  [DigitalSignature](./digitalsignature/)([System::String](../../system/string/), [System::String](../../system/string/)) | 지정된 인증서 파일 경로와 비밀번호를 사용하여 새 [DigitalSignature](./) 객체를 생성합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만, C#-style 부동 소수점 비교를 흉내 내어 두 NaN을 동일하게 취급합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 같지 않지만, C#-style 부동 소수점 비교를 흉내 내어 두 NaN을 동일하게 취급합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() override | 문서를 서명하는 데 사용된 인증서 객체입니다. 읽기 전용 [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/). |
| [System::String](../../system/string/) [get_Comments](./get_comments/)() override | 서명의 목적입니다. 읽기 [System::String](../../system/string/). |
| **bool** [get_IsValid](./get_isvalid/)() override | 이 디지털 서명이 유효하고 문서가 변조되지 않은 경우 이 값은 true가 됩니다. 읽기 전용 **bool**. |
| [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() override | 문서가 서명된 시간입니다. 읽기 전용 [System::DateTime](../../system/datetime/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 복사 생성자입니다. 실제로는 아무것도 복사하지 않으며, 새 객체를 초기화하고 하위 클래스 복사를 가능하게 합니다. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자입니다. 실제로는 아무것도 복사하지 않으며, 새 객체를 초기화하고 하위 클래스 복사를 가능하게 합니다. |
...
| void [set_Comments](./set_comments/)([System::String](../../system/string/)) override | 서명의 목적입니다. 쓰기 [System::String](../../system/string/). |
...
다음 예제는 PowerPoint [Presentation](../presentation/)에서 PFX 인증서를 사용하여 디지털 서명을 추가하는 방법을 보여줍니다.  
```cpp
// 프레젠테이션 인스턴스를 초기화합니다
...
// 디지털 서명을 프레젠테이션에 추가합니다
pres->get_DigitalSignatures()->Add(signature);
// 프레젠테이션을 저장합니다
pres->Save(u"SomePresentationSigned.pptx", SaveFormat::Pptx);
```
다음 샘플 코드는 PowerPoint [Presentation](../presentation/)에서 디지털 서명을 검증하는 방법을 보여줍니다.  
```cpp
// 프레젠테이션 인스턴스를 초기화합니다
