...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 IEC 60559:1989에 따르면 NaN은 어느 값과도 같지 않음에도 불구하고 동등하게 간주하는 C#-스타일 부동소수점 비교를 흉내냅니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 IEC 60559:1989에 따르면 NaN은 어느 값과도 같지 않음에도 불구하고 동등하게 간주하는 C#-스타일 부동소수점 비교를 흉내냅니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문에 대한 잠금을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용하세요. |
