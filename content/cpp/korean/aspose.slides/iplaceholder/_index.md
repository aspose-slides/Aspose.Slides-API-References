...
| virtual **uint32_t** [get_Index](./get_index/)() | 플레이스홀더의 인덱스를 가져옵니다. 읽기 전용 **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | 플레이스홀더의 방향을 가져옵니다. 읽기 전용 [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | 플레이스홀더의 크기를 가져옵니다. 읽기 전용 [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | 플레이스홀더의 유형을 가져옵니다. 읽기 전용 [PlaceholderType](../placeholdertype/). |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시자 객체를 사용하세요. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문 해제를 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시자 객체를 사용하세요. |
