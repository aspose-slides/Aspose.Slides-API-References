...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) override | 지정된 인덱스의 그리기 가이드를 반환합니다. 읽기 전용 [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | 그리기 가이드 컬렉션을 반환합니다. 읽기 전용 [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **int32_t** [get_Scale](./get_scale/)() override | 뷰 스케일 비율을 백분율로 지정합니다. 읽기 **int32_t**. |
| **bool** [get_VariableScale](./get_variablescale/)() override | 뷰 내용이 현재 창 크기에 맞게 자동으로 스케일되도록 지정합니다. 읽기 **bool**. |
...
| void [set_Scale](./set_scale/)(**int32_t**) override | 뷰 스케일 비율을 백분율로 지정합니다. 쓰기 **int32_t**. |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | 뷰 내용이 현재 창 크기에 맞게 자동으로 스케일되도록 지정합니다. 쓰기 **bool**. |
...
다음 예제는 PowerPoint [Presentation](../presentation/) 슬라이드의 확대/축소 값을 설정하는 방법을 보여줍니다. 
```cpp
...
// 슬라이드 뷰에 대한 줌 값을 백분율로 설정
presentation->get_ViewProperties()->get_NotesViewProperties()->set_Scale(100);
// 노트 뷰에 대한 줌 값을 백분율로 설정
presentation->Save(u"Zoom_out.pptx", SaveFormat::Pptx);
```

## 참고

* 클래스 [ICommonSlideViewProperties](../icommonslideviewproperties/)
