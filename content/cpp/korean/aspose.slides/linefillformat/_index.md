...
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) 의미. |
...
| [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() override | 채우기 유형을 반환합니다. [Slides::FillType](../filltype/)을(를) 읽으세요. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() override | 그라디언트 채우기 형식을 반환합니다. 읽기 전용 [IGradientFormat](../igradientformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() override | 패턴 채우기 형식을 반환합니다. 읽기 전용 [IPatternFormat](../ipatternformat/). |
| [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() override | 채우기가 도형과 함께 회전해야 하는지 판단합니다. [NullableBool](../nullablebool/)을(를) 읽으세요. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() override | 단색 채우기의 색상을 반환합니다. 읽기 전용 [IColorFormat](../icolorformat/). |
...
| void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) override | 채우기 유형을 설정합니다. [Slides::FillType](../filltype/)에 씁니다. |
| void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) override | 채우기가 도형과 함께 회전해야 하는지 판단합니다. [NullableBool](../nullablebool/)에 씁니다. |
...
* 클래스 [ILineFillFormat](../ilinefillformat/)
