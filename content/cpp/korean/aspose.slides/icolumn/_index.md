...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 동등하지 않지만, 두 NaN을 동등하게 고려하는 C# 스타일의 부동소수점 비교를 에뮬레이션합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 동등하지 않지만, 두 NaN을 동등하게 고려하는 C# 스타일의 부동소수점 비교를 에뮬레이션합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() | [ColumnFormat](../columnformat/) 객체를 반환하며, 이 객체는 해당 열의 서식 속성을 포함합니다. 읽기 전용 [IColumnFormat](../icolumnformat/). |
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | 컬렉션에 있는 동작 수를 반환합니다. 읽기 전용 **int32_t**. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | 컬렉션 접근이 동기화(스레드 안전)되는지 여부를 나타내는 값을 반환합니다. 읽기 전용 **bool**. |
...
| virtual **double** [get_Width](./get_width/)() | 열의 너비를 반환합니다. 읽기 전용 **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | 위치를 기준으로 셀을 반환합니다. 읽기 전용 [ICell](../icell/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | 시퀀스가 비어 있는 경우 기본값을 반환하며, 시퀀스의 첫 번째 요소를 반환합니다. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | 시퀀스가 비어 있는 경우 기본값을 반환하며, 시퀀스의 마지막 요소를 반환합니다. |
...
| virtual void [set_Width](./set_width/)(**double**) | 열의 너비를 설정합니다. **double** 형식으로 기록합니다. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | 정의된 부분 형식 속성을 모든 요소의 부분에 설정합니다. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | 정의된 단락 형식 속성을 모든 요소의 단락에 설정합니다. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | 정의된 텍스트 프레임 형식 속성을 모든 요소의 텍스트 프레임에 설정합니다. |
