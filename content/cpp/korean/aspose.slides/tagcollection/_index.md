...
| 메서드 | 설명 |
| --- | --- |
| **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 컬렉션에 새 태그를 추가합니다. |
...
| void [Clear](./clear/)() override | 컬렉션의 모든 태그를 제거합니다. |
| **bool** [Contains](./contains/)([System::String](../../system/string/)) override | 컬렉션에 특정 이름이 포함되어 있는지 확인합니다. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>, **int32_t**) override | 컬렉션의 모든 요소를 지정된 배열에 복사합니다. |
...
| **int32_t** [get_Count](./get_count/)() override | 컬렉션에 있는 태그 수를 반환합니다. 읽기 전용 **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | 컬렉션에 대한 액세스가 동기화(스레드 안전)되어 있는지 나타내는 값을 반환합니다. 읽기 전용 **bool**. |
...
| [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) override | 지정된 인덱스에 있는 태그의 키를 반환합니다. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() override | 태그의 이름들을 반환합니다. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 객체의 실제 타입을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출과 유사합니다. |
| [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) override | 지정된 인덱스에 있는 태그의 값을 반환합니다. |
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | 태그의 키와 값 쌍을 반환합니다. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 태그의 키와 값 쌍을 설정합니다. |
| **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) override | 컬렉션에서 지정된 키의 0 기반 인덱스를 반환합니다. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 제네릭 시퀀스의 각 요소에 변환 함수를 적용하고 최대값을 반환합니다. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 제네릭 시퀀스의 각 요소에 변환 함수를 적용하고 최소값을 반환합니다. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | 지정된 이름을 가진 태그를 컬렉션에서 제거합니다. |
| void [RemoveAt](./removeat/)(**int32_t**) override | 지정된 인덱스에 있는 태그를 제거합니다. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 지정된 값만큼 공유 레퍼런스 카운트를 감소시킵니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 템플릿 인수 n을 공유가 아닌 약한 포인터로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있습니다. |
...
다음 예제는 PowerPoint [Presentation](../presentation/)에 태그를 추가하는 방법을 보여줍니다.
...
* 클래스 [ITagCollection](../itagcollection/)
