...
description: 프레젠테이션의 모든 바닥글, 날짜-시간 및 페이지 번호 자리표시자의 동작을 관리하는 매니저를 나타냅니다.
type: docs
weight: 3407
url: /ko/aspose.slides/ipresentationheaderfootermanager/
---
## IPresentationHeaderFooterManager 클래스


프레젠테이션의 모든 바닥글, 날짜-시간 및 페이지 번호 자리표시자의 동작을 관리하는 매니저를 나타냅니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음에도 불구하고, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않음에도 불구하고, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문장의 잠금 기능을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
...
| virtual void [SetAllDateTimesText](./setalldatetimestext/)([System::String](../../system/string/)) | 마스터 슬라이드, 레이아웃 슬라이드 및 슬라이드를 포함한 모든 날짜-시간 자리표시자에 텍스트를 설정합니다. |
| virtual void [SetAllDateTimesVisibility](./setalldatetimesvisibility/)(**bool**) | 마스터 슬라이드, 레이아웃 슬라이드 및 슬라이드를 포함한 모든 날짜-시간 자리표시자의 가시성을 변경합니다. |
| virtual void [SetAllFootersText](./setallfooterstext/)([System::String](../../system/string/)) | 마스터 슬라이드, 레이아웃 슬라이드 및 슬라이드를 포함한 모든 바닥글 자리표시자에 텍스트를 설정합니다. |
| virtual void [SetAllFootersVisibility](./setallfootersvisibility/)(**bool**) | 마스터 슬라이드, 레이아웃 슬라이드 및 슬라이드를 포함한 모든 바닥글 자리표시자의 가시성을 변경합니다. |
| virtual void [SetAllHeadersText](./setallheaderstext/)([System::String](../../system/string/)) | 노트 마스터, 노트 슬라이드 및 유인물 마스터를 포함한 모든 머리글 자리표시자에 텍스트를 설정합니다. |
| virtual void [SetAllHeadersVisibility](./setallheadersvisibility/)(**bool**) | 노트 마스터, 노트 슬라이드 및 유인물 마스터를 포함한 모든 머리글 자리표시자의 가시성을 변경합니다. |
| virtual void [SetAllSlideNumbersVisibility](./setallslidenumbersvisibility/)(**bool**) | 마스터 슬라이드, 레이아웃 슬라이드 및 슬라이드를 포함한 모든 페이지 번호 자리표시자의 가시성을 변경합니다. |
...
| virtual void [SetVisibilityOnAllTitleSlides](./setvisibilityonalltitleslides/)(**bool**) | 모든 제목 슬라이드 및 첫 번째 레이아웃 슬라이드에 대한 바닥글, 날짜-시간 및 페이지 번호 자리표시자의 가시성을 변경합니다. Title slides \\u2013 slides based on first layout slide (regardless of type of this first layout). |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문장의 잠금 해제 기능을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
...
* 클래스 [IBaseHeaderFooterManager](../ibaseheaderfootermanager/)
