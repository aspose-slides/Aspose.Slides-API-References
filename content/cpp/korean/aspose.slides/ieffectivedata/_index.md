...
description: 효과적인 데이터를 포함하는 불변 객체를 나타냅니다.
type: docs
weight: 2055
url: /ko/aspose.slides/ieffectivedata/
---
## IEffectiveData 클래스


Represents immutable object which contains effective data.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C#-style 부동 소수점 비교를 구현합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C#-style 부동 소수점 비교를 구현합니다. |
