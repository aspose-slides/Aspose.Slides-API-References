...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따라 어느 값과도(NaN 포함) 동일하지 않음에도 불구하고, C# 스타일 부동소수점 비교를 에뮬레이션하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따라 어느 값과도(NaN 포함) 동일하지 않음에도 불구하고, C# 스타일 부동소수점 비교를 에뮬레이션하여 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevel](../ishapebevel/)\> [get_BevelBottom](./get_bevelbottom/)() override | 하단 3D 베벨의 유형을 반환합니다. 읽기 전용 [IShapeBevel](../ishapebevel/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevel](../ishapebevel/)\> [get_BevelTop](./get_beveltop/)() override | 상단 3D 베벨의 유형을 반환합니다. 읽기 전용 [IShapeBevel](../ishapebevel/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICamera](../icamera/)\> [get_Camera](./get_camera/)() override | 카메라 설정을 반환합니다. 읽기 전용 [ICamera](../icamera/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ContourColor](./get_contourcolor/)() override | 윤곽선 색상을 반환합니다. 읽기 전용 [IColorFormat](../icolorformat/). |
| **double** [get_ContourWidth](./get_contourwidth/)() override | 3D 윤곽선의 너비를 반환합니다. 읽기 **double**. |
| **double** [get_Depth](./get_depth/)() override | 3D 형상의 깊이를 반환합니다. 읽기 **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ExtrusionColor](./get_extrusioncolor/)() override | 돌출물의 색상을 반환합니다. 읽기 전용 [IColorFormat](../icolorformat/). |
| **double** [get_ExtrusionHeight](./get_extrusionheight/)() override | 돌출 효과의 높이를 반환합니다. 읽기 **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILightRig](../ilightrig/)\> [get_LightRig](./get_lightrig/)() override | 조명의 유형을 반환합니다. 읽기 전용 [ILightRig](../ilightrig/). |
| [MaterialPresetType](../materialpresettype/) [get_Material](./get_material/)() override | 재료의 유형을 반환합니다. 읽기 [MaterialPresetType](../materialpresettype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../ithreedformateffectivedata/)\> [GetEffective](./geteffective/)() override | 상속이 적용된 효과적인 3D 서식 데이터를 가져옵니다. |
...
| void [set_ContourWidth](./set_contourwidth/)(**double**) override | 3D 윤곽선의 너비를 설정합니다. 쓰기 **double**. |
| void [set_Depth](./set_depth/)(**double**) override | 3D 형상의 깊이를 설정합니다. 쓰기 **double**. |
| void [set_ExtrusionHeight](./set_extrusionheight/)(**double**) override | 돌출 효과의 높이를 설정합니다. 쓰기 **double**. |
| void [set_Material](./set_material/)([MaterialPresetType](../materialpresettype/)) override | 재료의 유형을 설정합니다. 쓰기 [MaterialPresetType](../materialpresettype/). |
...
다음 예제는 PowerPoint [Presentation](../presentation/)에 3D 도형을 추가하는 방법을 보여줍니다.
```cpp
...
```
다음 예제는 PowerPoint [Presentation](../presentation/)에서 3D 도형에 그라디언트 효과를 적용하는 방법을 보여줍니다.
```cpp
// Presentation 클래스의 인스턴스를 생성합니다.
auto pres = System::MakeObject<Presentation>();
auto slide = pres->get_Slides()->idx_get(0);
