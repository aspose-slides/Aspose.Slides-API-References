...
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_EndParagraphPortionFormat](./get_endparagraphportionformat/)() override | 마지막 부분 뒤에 다른 부분이 삽입될 경우 사용할 부분 속성을 지정합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() override | 이 단락에 대한 서식 객체를 반환합니다. 읽기 전용 [IParagraphFormat](../iparagraphformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [get_Portion](./get_portion/)(**int32_t**) override | 지정된 인덱스의 텍스트 부분을 반환합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionCollection](../iportioncollection/)\> [get_Portions](./get_portions/)() override | 텍스트 부분들의 컬렉션을 반환합니다. 읽기 전용 [IPortionCollection](../iportioncollection/). |
| [System::String](../../system/string/) [get_Text](./get_text/)() override | 단락의 일반 텍스트를 가져옵니다. 읽기 [System::String](../../system/string/). |
...
| **int32_t** [GetLinesCount](./getlinescount/)() override | 단락의 줄 수를 가져옵니다. |
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() override | 단락을 둘러싼 사각형의 좌표를 가져옵니다. 이 사각형은 단락의 모든 텍스트 줄을 포함하며, 빈 줄도 포함합니다. |
...
| void [JoinPortionsWithSameFormatting](./joinportionswithsameformatting/)() override | 동일한 서식을 가진 실행들을 병합합니다. |
...
|  [Paragraph](./paragraph/)() | [Paragraph](./) 클래스의 새 인스턴스를 기본 속성으로 초기화합니다. |
|  [Paragraph](./paragraph/)([System::SharedPtr](../../system/sharedptr/)\<[Paragraph](./)\>) | [Paragraph](./) 클래스의 새 인스턴스를 초기화하는 복사 생성자입니다. |
...
| void [set_EndParagraphPortionFormat](./set_endparagraphportionformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | 마지막 부분 뒤에 다른 부분이 삽입될 경우 사용할 부분 속성을 지정합니다. |
| void [set_Text](./set_text/)([System::String](../../system/string/)) override | 단락의 일반 텍스트를 설정합니다. 쓰기 [System::String](../../system/string/). |
