...
description: 원시 shape 프레임의 속성을 반환합니다. IShapeFrame을 읽으세요.
type: docs
weight: 40
url: /ko/aspose.slides/shape/get_rawframe/
---
## Shape::get_RawFrame() 메서드
...
```cpp
SharedPtr<IShape> shape = ...; // shape은 placeholder에 연결되어 있습니다
shape->set_RawFrame(System::MakeObject<ShapeFrame>(std::numeric_limits<float>::quiet_NaN(), 
std::numeric_limits<float>::quiet_NaN(), 100.0f, std::numeric_limits<float>::quiet_NaN(), 
NullableBool::NotDefined, NullableBool::NotDefined, 0.0f)); // 이제 shape은 placeholder에서 x, y, height, flipH, flipV 값을 상속받고 width=100 및 rotationAngle=0을 재정의합니다.
```
