...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_ActiveXControlBinary](./get_activexcontrolbinary/)() override | PersistStream, PersistStreamInit 또는 PersistStorage 중 하나를 사용하여 지속성을 지정할 때 ActiveX 컨트롤의 지속성을 지정합니다. |
| [System::Guid](../../system/guid/) [get_ClassId](./get_classid/)() override | 이 컨트롤의 클래스 ID를 가져옵니다. 읽기 전용 [System::Guid](../../system/guid/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_Frame](./get_frame/)() override | 컨트롤의 프레임을 반환합니다. 읽기 [IShapeFrame](../ishapeframe/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 이 컨트롤의 이름을 가져옵니다. 읽기 [System::String](../../system/string/). |
| [PersistenceType](../persistencetype/) [get_Persistence](./get_persistence/)() override | ActiveX 컨트롤의 속성을 저장하는 데 사용되는 메서드를 가져옵니다. 읽기 전용 [PersistenceType](../persistencetype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IControlPropertiesCollection](../icontrolpropertiescollection/)\> [get_Properties](./get_properties/)() override | ActiveX 속성 컬렉션을 반환합니다. |
| [System::String](../../system/string/) [get_Property](./get_property/)([System::String](../../system/string/)) override | 지정된 인덱스의 ActiveX 속성을 반환합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() override | [Control](./) 이미지 채우기 속성 객체를 반환합니다. 읽기 전용 [IPictureFillFormat](../ipicturefillformat/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자. 실제로 아무 것도 복사하지 않고, 새 객체를 초기화하고 하위 클래스의 복사 생성을 가능하게 합니다. |
...
| void [set_ClassId](./set_classid/)([System::Guid](../../system/guid/)) | 이 컨트롤의 클래스 ID를 가져옵니다. 읽기 전용 [System::Guid](../../system/guid/). |
| void [set_Frame](./set_frame/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) override | 컨트롤의 프레임을 설정합니다. 쓰기 [IShapeFrame](../ishapeframe/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | 이 컨트롤의 이름을 설정합니다. 쓰기 [System::String](../../system/string/). |
| void [set_Property](./set_property/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 지정된 인덱스의 ActiveX 속성을 설정합니다. |
