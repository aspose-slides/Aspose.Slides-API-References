...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값(NaN 포함)과도 같지 않지만, 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값(NaN 포함)과도 같지 않지만, 두 NaN이 동일하게 간주되는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() override | 조명 방향. [LightingDirection](../lightingdirection/)를 읽습니다. |
| [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() override | 프리셋 라이트 오른쪽을 나타냅니다. 라이트 릭은 3D 씬에 대해 특정 방식으로 배치된 조명 그룹을 나타냅니다. [LightRigPresetType](../lightrigpresettype/)를 읽습니다. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() override | 위도 좌표, 경도 좌표 및 축을 중심으로 하는 회전을 사용하여 회전을 정의합니다. 반환 배열의 첫 번째 요소는 위도, 두 번째는 경도, 세 번째는 회전입니다. 회전이 정의되지 않은 경우 null을 반환합니다. |
...
| void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) override | 조명 방향. [LightingDirection](../lightingdirection/)에 씁니다. |
| void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) override | 프리셋 라이트 오른쪽을 나타냅니다. 라이트 릭은 3D 씬에 대해 특정 방식으로 배치된 조명 그룹을 나타냅니다. [LightRigPresetType](../lightrigpresettype/)에 씁니다. |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | 위도 좌표, 경도 좌표 및 축을 중심으로 하는 회전을 사용하여 회전을 정의합니다. 좌표 값 중 하나라도 std::numeric_limits<float>::quiet_NaN()이면 모든 회전이 정의되지 않습니다. |
