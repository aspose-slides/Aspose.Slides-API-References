...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | 그림 하단이 잘려 나간 실제 이미지 높이의 퍼센트 수를 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | 그림 왼쪽이 잘려 나간 실제 이미지 너비의 퍼센트 수를 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | 그림 오른쪽이 잘려 나간 실제 이미지 너비의 퍼센트 수를 반환합니다. 읽기 전용 **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | 그림 상단이 잘려 나간 실제 이미지 높이의 퍼센트 수를 반환합니다. 읽기 전용 **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | 그림을 채우는 데 사용되는 dpi를 반환합니다. 읽기 전용 **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | 그림을 반환합니다. 읽기 전용 [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | 그림 채우기 모드를 반환합니다. 읽기 전용 [Slides::PictureFillMode](../picturefillmode/). |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 공유 레퍼런스 카운트를 감소시키고 그 값을 반환합니다. 직접 호출해서는 안 되며, 스마트 포인터나 ThisProtector를 사용하십시오. |
