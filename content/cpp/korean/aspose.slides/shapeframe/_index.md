...
| 메서드 | 설명 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](./clone/)() override | 복제 |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [CloneT](./clonet/)() override | 복제합니다. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 이 인스턴스가 지정된 객체와 동일한지 여부를 나타내는 값을 반환합니다. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[ShapeFrame](./)\>) | 이 인스턴스가 지정된 객체와 동일한지 여부를 나타내는 값을 반환합니다. |
...
| **float** [get_CenterX](./get_centerx/)() override | 프레임 중심의 X 좌표를 반환합니다. 읽기 전용 **float**. |
| **float** [get_CenterY](./get_centery/)() override | 프레임 중심의 Y 좌표를 반환합니다. 읽기 전용 **float**. |
| [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() override | 프레임이 수평으로 뒤집혔는지 여부를 판단합니다. 읽기 전용 [NullableBool](../nullablebool/). |
| [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() override | 프레임이 수직으로 뒤집혔는지 여부를 판단합니다. 읽기 전용 [NullableBool](../nullablebool/). |
| **float** [get_Height](./get_height/)() override | 프레임의 높이를 반환합니다. 읽기 전용 **float**. |
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() override | 프레임의 좌표를 반환합니다. 읽기 전용 [System::Drawing::RectangleF](../../system.drawing/rectanglef/). |
| **float** [get_Rotation](./get_rotation/)() override | 프레임이 z축을 중심으로 회전한 각도를 반환합니다. 양수는 시계 방향 회전을, 음수는 반시계 방향 회전을 나타냅니다. 읽기 전용 **float**. |
| **float** [get_Width](./get_width/)() override | 프레임의 너비를 반환합니다. 읽기 전용 **float**. |
| **float** [get_X](./get_x/)() override | 프레임의 왼쪽 위 모서리 X 좌표를 반환합니다. 읽기 전용 **float**. |
| **float** [get_Y](./get_y/)() override | 프레임의 왼쪽 위 모서리 Y 좌표를 반환합니다. 읽기 전용 **float**. |
...
|  [ShapeFrame](./shapeframe/)(**float**, **float**, **float**, **float**, [NullableBool](../nullablebool/), [NullableBool](../nullablebool/), **float**) | 새로운 shape frame 속성을 생성합니다. |
