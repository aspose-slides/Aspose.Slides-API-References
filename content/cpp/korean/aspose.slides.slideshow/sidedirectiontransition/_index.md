...
type: docs
weight: 391
url: /ko/aspose.slides.slideshow/sidedirectiontransition/
---
## SideDirectionTransition 클래스
...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | 전환 방향. 읽기 [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연관된 참조 카운터 데이터 구조를 가져옵니다. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 특정 타입에 대한 해시 함수 역할을 하며, 해시 테이블과 같은 해싱 알고리즘 및 데이터 구조에 사용할 수 있습니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 대입 연산자. 실제로는 아무 것도 복사하지 않으며, 새로운 객체를 초기화하고 하위 클래스 복사 생성을 가능하게 합니다. |
...
* 클래스 [ISideDirectionTransition](../isidedirectiontransition/)
