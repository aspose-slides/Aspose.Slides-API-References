...
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | Morph 전환 유형입니다. [TransitionMorphType](../transitionmorphtype/)를 읽으세요. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 반환합니다. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 특정 유형에 대한 해시 함수 역할을 하며, 해시 알고리즘 및 해시 테이블과 같은 데이터 구조에 적합합니다. |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | Morph 전환 유형입니다. [TransitionMorphType](../transitionmorphtype/)에 씁니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 약한 포인터로 설정합니다(공유가 아니라). 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
...
* 클래스 [IMorphTransition](../imorphtransition/)
