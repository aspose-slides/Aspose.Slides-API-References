...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 전환 방향. [TransitionInOutDirectionType](../transitioninoutdirectiontype/)를 읽으세요. |
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | 전환 중에 사용되는 시각 효과의 형태를 지정합니다. [TransitionShredPattern](../transitionshredpattern/)를 읽으세요. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 가져옵니다. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 특정 유형에 대한 해시 함수 역할을 하며, 해시 알고리즘 및 해시 테이블과 같은 데이터 구조에 사용할 수 있습니다. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드의 유사체입니다. 사용자 정의 유형을 복제할 수 있게 합니다. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 전환 방향. [TransitionInOutDirectionType](../transitioninoutdirectiontype/)를 씁니다. |
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | 전환 중에 사용되는 시각 효과의 형태를 지정합니다. [TransitionShredPattern](../transitionshredpattern/)를 씁니다. |
...
* 클래스 [IShredTransition](../ishredtransition/)
