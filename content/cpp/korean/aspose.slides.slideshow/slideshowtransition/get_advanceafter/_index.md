...
type: docs
weight: 105
url: /ko/aspose.slides.slideshow/slideshowtransition/get_advanceafter/
---
## SlideShowTransition::get_AdvanceAfter() 메서드


이 속성은 슬라이드쇼가 일정 시간 후에 다음 슬라이드로 이동하는지 여부를 지정합니다. 읽기 **bool**.
