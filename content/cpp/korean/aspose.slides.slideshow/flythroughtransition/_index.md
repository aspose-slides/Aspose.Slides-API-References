...
description: 플라이트 스루 슬라이드 전환 효과.
type: docs
weight: 40
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 동일하게 간주하지만 IEC 60559:1989에 따르면 NaN은 어떤 값(NaN 포함)과도 같지 않다는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 동일하게 간주하지만 IEC 60559:1989에 따르면 NaN은 어떤 값(NaN 포함)과도 같지 않다는 C# 스타일 부동 소수점 비교를 에뮬레이트합니다. |
...
| **bool** [get_HasBounce](./get_hasbounce/)() override | 전환 중 프레젠테이션 슬라이드의 움직임에 바운스가 포함된다는 것을 지정합니다. **bool**를 읽으세요. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 가져옵니다. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 특정 유형에 대한 해시 함수 역할을 하며, 해시 테이블과 같은 해싱 알고리즘 및 데이터 구조에서 사용하기에 적합합니다. |
...
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | 전환 중 프레젠테이션 슬라이드의 움직임에 바운스가 포함된다는 것을 지정합니다. **bool**를 씁니다. |
...
* 클래스 [IFlyThroughTransition](../iflythroughtransition/)
