...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 전환 분할의 방향. [TransitionInOutDirectionType](../transitioninoutdirectiontype/)을(를) 읽으세요. |
| virtual [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() | 전환 분할의 방향성. [Slides::Orientation](../../aspose.slides/orientation/)을(를) 읽으세요. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문을 구현한 잠금입니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시자 객체를 사용하세요. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 전환 분할의 방향. [TransitionInOutDirectionType](../transitioninoutdirectiontype/)에 기록합니다. |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) | 전환 분할의 방향성. [Slides::Orientation](../../aspose.slides/orientation/)에 기록합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n'th' 템플릿 인자를 약한 포인터(공유가 아닌)로 설정합니다. 컨테이너의 포인터를 약한 모드로 전환할 수 있습니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문의 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시자 객체를 사용하세요. |
