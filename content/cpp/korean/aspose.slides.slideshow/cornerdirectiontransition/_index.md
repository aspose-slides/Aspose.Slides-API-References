...
| 메서드 | 설명 |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | [TransitionValueBase](../transitionvaluebase/) 두 인스턴스가 같은지 여부를 결정합니다. |
...
| [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() override | 전환 방향. 읽기 [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 가져옵니다. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 특정 유형에 대한 해시 함수로 작동하며, 해시 알고리즘 및 해시 테이블과 같은 데이터 구조에서 사용하기에 적합합니다. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 객체가 targetType으로 설명된 유형의 인스턴스를 나타내는지 확인합니다. C# 'is' 연산자와 동일합니다. |
...
| void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) override | 전환 방향. 쓰기 [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
...
* 클래스 [ICornerDirectionTransition](../icornerdirectiontransition/)
