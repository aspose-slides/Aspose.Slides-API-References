...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 동일하지 않음에도 불구하고, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN이 IEC 60559:1989에 따르면 NaN은 어떤 값과도 동일하지 않음에도 불구하고, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | 전환 방향. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)를 읽으십시오. |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | 전환이 검은색을 통해 페이드되는지 여부를 지정합니다. **bool**를 읽으십시오. |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | 전환 방향. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)를 씁니다. |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | 전환이 검은색을 통해 페이드되는지 여부를 지정합니다. **bool**를 씁니다. |
