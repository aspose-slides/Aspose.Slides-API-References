...
description: 슬라이드 전환 효과를 조각냅니다.
type: docs
weight: 235
url: /ko/aspose.slides.slideshow/ishredtransition/
---
## IShredTransition 클래스
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 전환 방향. [TransitionInOutDirectionType](../transitioninoutdirectiontype/)를 읽으세요. |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | 전환 중에 사용되는 시각 요소의 형태를 지정합니다. [TransitionShredPattern](../transitionshredpattern/)를 읽으세요. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 전환 방향. [TransitionInOutDirectionType](../transitioninoutdirectiontype/)에 씁니다. |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | 전환 중에 사용되는 시각 요소의 형태를 지정합니다. [TransitionShredPattern](../transitionshredpattern/)에 씁니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 구현하여 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시자를 사용하세요. |
