...
description: 문자열의 개수가 미리 알려지지 않았을 때 문자열을 연결합니다.
type: docs
weight: 1
url: /ko/system.xml.xsl.runtime/stringconcat/
---
## StringConcat 클래스

문자열의 개수가 미리 알려지지 않았을 때 문자열을 연결합니다.
...
| 메서드 | 설명 |
| --- | --- |
| void [Clear](./clear/)() | 결과 문자열을 지웁니다. |
| void [Concat](./concat/)(const [String](../../system/string/)\&) | 새 문자열을 결과에 연결합니다. |
...
| [String](../../system/string/) [get_Delimiter](./get_delimiter/)() | 연결된 문자열들을 구분하는 문자열을 반환합니다. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 객체와 연결된 참조 카운터 데이터 구조를 가져옵니다. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 메서드와 유사합니다. 사용자 정의 객체의 해싱을 가능하게 합니다. |
| [String](../../system/string/) [GetResult](./getresult/)() | 결과 문자열을 반환합니다. |
...
| void [set_Delimiter](./set_delimiter/)(const [String](../../system/string/)\&) | 연결된 문자열들을 구분하는 문자열을 설정합니다. |
...
|  [StringConcat](./stringconcat/)() | 기본 생성자. |
