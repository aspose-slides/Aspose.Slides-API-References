...
description: "중국 음양력 캘린더. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 인스턴스를 생성하거나 operator new를 사용하면 런타임 오류 및/또는 어설션 결함이 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고 이 포인터를 함수 인수로 전달하십시오."
type: docs
weight: 27
url: /ko/system.globalization/chineselunisolarcalendar/
---
## ChineseLunisolarCalendar 클래스


중국 음양력 캘린더. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 직접 인스턴스를 생성하거나 operator new를 사용하면 런타임 오류 및/또는 어설션 결함이 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고 이 포인터를 함수 인수로 전달하십시오.
...
| Field | Description |
| --- | --- |
| static constexpr [ChineseEra](./chineseera/) | 현재 중국 연대. |
## 참조
