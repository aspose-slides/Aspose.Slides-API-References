...
description: 연도가 윤년인지 확인합니다.
type: docs
weight: 183
url: /ko/system.globalization/japanesecalendar/isleapyear/
---
## JapaneseCalendar::IsLeapYear(int, int) const 메서드
...
## JapaneseCalendar::IsLeapYear(int) const 메서드
