...
description: 월이 윤달인지 확인합니다.
type: docs
weight: 196
url: /ko/system.globalization/japanesecalendar/isleapmonth/
---
## JapaneseCalendar::IsLeapMonth(int, int, int) const 메서드
...
## JapaneseCalendar::IsLeapMonth(int, int) const 메서드
