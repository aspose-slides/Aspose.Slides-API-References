...
description: 특정 월의 일 수를 반환합니다.
type: docs
weight: 92
url: /ko/system.globalization/japanesecalendar/getdaysinmonth/
---
## JapaneseCalendar::GetDaysInMonth(int, int, int) const 메서드
...
## JapaneseCalendar::GetDaysInMonth(int, int) const 메서드
