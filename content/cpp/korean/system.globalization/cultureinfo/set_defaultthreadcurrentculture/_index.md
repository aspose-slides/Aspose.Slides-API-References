...
description: 현재 애플리케이션 도메인에서 기본 문화권을 설정합니다.
type: docs
weight: 469
url: /ko/system.globalization/cultureinfo/set_defaultthreadcurrentculture/
---
## CultureInfo::set_DefaultThreadCurrentCulture(const CultureInfoPtr\&) method


현재 애플리케이션 도메인에서 기본 문화권을 설정합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | const [CultureInfoPtr](../../cultureinfoptr/)\& | 문화 객체. |
