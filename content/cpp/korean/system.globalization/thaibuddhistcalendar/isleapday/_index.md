...
type: docs
weight: 222
url: /ko/system.globalization/thaibuddhistcalendar/isleapday/
---
## ThaiBuddhistCalendar::IsLeapDay(int, int, int, int) const 메서드
...
## ThaiBuddhistCalendar::IsLeapDay(int, int, int) const 메서드
