...
description: 지정된 날짜가 윤일인지 확인합니다.
type: docs
weight: 378
url: /ko/system.globalization/calendar/isleapday/
---
## Calendar::IsLeapDay(int, int, int) const 메서드
...
## Calendar::IsLeapDay(int, int, int, int) const 메서드
