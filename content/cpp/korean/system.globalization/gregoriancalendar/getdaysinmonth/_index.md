...
description: 특정 월의 일 수를 가져옵니다.
type: docs
weight: 118
url: /ko/system.globalization/gregoriancalendar/getdaysinmonth/
---
## GregorianCalendar::GetDaysInMonth(int, int, int) const 메서드
...
| --- | --- | --- |
| year | int | 연도. |
| month | int | 일 수를 가져올 월. |
| era | int | 시대. |

### 반환값

지정된 연도와 지정된 시대의 지정된 월의 일 수.

## GregorianCalendar::GetDaysInMonth(int, int) const 메서드
