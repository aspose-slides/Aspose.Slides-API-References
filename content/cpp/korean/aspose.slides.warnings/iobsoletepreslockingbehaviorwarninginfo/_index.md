...
description: 이 경고는 더 이상 사용되지 않는 프레젠테이션 잠금 동작이 사용되고 있음을 나타냅니다.
type: docs
weight: 27
url: /ko/aspose.slides.warnings/iobsoletepreslockingbehaviorwarninginfo/
---
## IObsoletePresLockingBehaviorWarningInfo 클래스
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | receiver가 null이 아니면 지정된 receiver에게 경고를 종료하고, receiver가 작업 중단을 결정하면 AbortRequestedException을 발생시킵니다. |
