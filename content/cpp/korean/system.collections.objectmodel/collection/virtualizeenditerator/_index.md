...
description: 현재 컨테이너에 대한 끝 반복자 구현을 가져옵니다.
type: docs
weight: 274
url: /ko/system.collections.objectmodel/collection/virtualizeenditerator/
---
## Collection::virtualizeEndIterator() 메서드


현재 컨테이너에 대한 끝 반복자 구현을 가져옵니다.
