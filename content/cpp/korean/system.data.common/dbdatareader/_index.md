...
description: "데이터베이스에서 데이터를 수신하기 위한 API입니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용해 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고, 해당 포인터를 함수 인수로 전달하십시오."
type: docs
weight: 40
url: /ko/system.data.common/dbdatareader/
---
## DbDataReader 클래스
...
| 메서드 | 설명 |
| --- | --- |
| virtual void [Close](./close/)() | 데이터 검색 채널을 닫습니다. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)([String](../../system/string/)) | 이름이 지정된 항목을 가져옵니다. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(int) | 인덱스로 항목을 가져옵니다. |
...
| virtual **bool** [Read](./read/)() | 데이터베이스에서 다음 레코드를 읽습니다. |
