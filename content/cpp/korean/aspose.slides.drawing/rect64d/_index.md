...
description: Rectangle 구조체
type: docs
weight: 40
url: /ko/aspose.slides.drawing/rect64d/
---
## Rect64d 클래스
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-style 부동소수점 비교를 에뮬레이트합니다. 두 NaN이 동일하게 취급되며, IEC 60559:1989에 따르면 NaN은 어떤 값과도(또는 NaN 자체와도) 동일하지 않지만 여기서는 두 NaN을 같은 것으로 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-style 부동소수점 비교를 에뮬레이트합니다. 두 NaN이 동일하게 취급되며, IEC 60559:1989에 따르면 NaN은 어떤 값과도(또는 NaN 자체와도) 동일하지 않지만 여기서는 두 NaN을 같은 것으로 간주합니다. |
