...
description: XPath 식을 처리하는 중 오류가 발생했을 때 발생하는 예외를 제공합니다.
type: docs
weight: 1
url: /ko/system.xml.xpath/details_xpathexception/
---
## Details_XPathException 클래스

처리 중 오류가 발생하면 발생하는 예외를 제공합니다 [XPath](../) 식을 처리할 때.
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | 이 예외에 대한 오류 상태 설명을 반환합니다. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) 메서드를 구현하며 이는 [ExceptionWrapper](../../system/exceptionwrapper/) 클래스에 의해 호출됩니다. 이 클래스가 std::exception에서 상속되지 않았음에도 파생 클래스는 보호/비공개 멤버를 사용해 로직을 구현할 수 있습니다. 이 메서드 구현을 [ExceptionWrapper](../../system/exceptionwrapper/)로 이동하면 해당 로직이 깨질 수 있습니다. |
