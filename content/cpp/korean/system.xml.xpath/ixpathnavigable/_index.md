...
description: XPathNavigator 클래스에 대한 접근자를 제공합니다.
type: docs
weight: 14
url: /ko/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable 클래스

[XPathNavigator](../xpathnavigator/) 클래스를 액세스할 수 있습니다.
...
| 메서드 | 설명 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | 새로운 [XPathNavigator](../xpathnavigator/) 객체를 반환합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일의 부동소수점 비교를 에뮬레이트합니다. 두 NaN은 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일의 부동소수점 비교를 에뮬레이트합니다. 두 NaN은 IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 동일하게 간주합니다. |
