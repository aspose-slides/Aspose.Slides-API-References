...
description: XPath 데이터 모델을 사용하여 XML 문서의 빠르고 읽기 전용인 메모리 내 표현을 제공합니다.
type: docs
weight: 27
url: /ko/system.xml.xpath/xpathdocument/
---
## XPathDocument 클래스
...
| 메서드 | 설명 |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() override | 이 [XPathDocument](./)의 노드를 탐색하기 위한 읽기 전용 [XPathNavigator](../xpathnavigator/) 객체를 초기화합니다. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 할당 연산자입니다. 실제로는 아무 것도 복사하지 않고 새 객체를 초기화하며 서브클래스의 복사 생성을 가능하게 합니다. |
...
|  [XPathDocument](./xpathdocument/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | 지정된 [XmlReader](../../system.xml/xmlreader/) 객체에 포함된 XML 데이터에서 [XPathDocument](./) 클래스의 새 인스턴스를 초기화합니다. |
|  [XPathDocument](./xpathdocument/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, [XmlSpace](../../system.xml/xmlspace/)) | 지정된 [XmlReader](../../system.xml/xmlreader/) 객체에 포함된 XML 데이터와 지정된 공백 처리 옵션을 사용하여 [XPathDocument](./) 클래스의 새 인스턴스를 초기화합니다. |
|  [XPathDocument](./xpathdocument/)(const [SharedPtr](../../system/sharedptr/)\<[IO::TextReader](../../system.io/textreader/)\>\&) | 지정된 TextReader 객체에 포함된 XML 데이터에서 [XPathDocument](./) 클래스의 새 인스턴스를 초기화합니다. |
|  [XPathDocument](./xpathdocument/)(const [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\>\&) | 지정된 Stream 객체에 포함된 XML 데이터에서 [XPathDocument](./) 클래스의 새 인스턴스를 초기화합니다. |
|  [XPathDocument](./xpathdocument/)(const [String](../../system/string/)\&) | 지정된 파일에 포함된 XML 데이터에서 [XPathDocument](./) 클래스의 새 인스턴스를 초기화합니다. |
|  [XPathDocument](./xpathdocument/)(const [String](../../system/string/)\&, [XmlSpace](../../system.xml/xmlspace/)) | 지정된 공백 처리 옵션과 함께 지정된 파일에 포함된 XML 데이터에서 [XPathDocument](./) 클래스의 새 인스턴스를 초기화합니다. |
