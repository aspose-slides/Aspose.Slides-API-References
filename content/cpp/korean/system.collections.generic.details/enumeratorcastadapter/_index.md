...
description: IEnumerable.Cast() 확장 메서드에서 사용되는 열거자.
type: docs
weight: 53
url: /ko/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter 클래스
...
| Method | Description |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | VirtualizedIterator 클래스에서 사용될 반복자를 준비합니다. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 첫 번째 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 호출을 수행하고 Enumerator 객체를 VirtualizedIterator에서 사용하도록 준비합니다. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | virtualized iterator가 소유한 enumerator를 표시합니다. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드와 유사합니다. 사용자 정의 타입 복제를 가능하게 합니다. |
| **bool** [MoveNext](./movenext/)() override | enumerator를 다음 요소로 이동합니다. 이전에 요소가 참조되지 않았으면 첫 번째 사용 가능한 요소를 참조로 설정합니다. 컨테이너 끝에 도달하면 아무 작업도 하지 않습니다. |
...
| void [Reset](./reset/)() override | enumerator를 첫 번째 요소 이전 위치로 재설정합니다. |
