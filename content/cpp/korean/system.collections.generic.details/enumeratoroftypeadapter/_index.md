...
description: IEnumerable.OfType() 확장 메서드에서 사용되는 열거자.
type: docs
weight: 66
url: /ko/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter 클래스
...
| 메서드 | 설명 |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | VirtualizedIterator 클래스에서 사용될 이터레이터를 준비합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어느 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어느 값과도 같지 않지만, 두 NaN을 동일하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | 현재 요소를 가져옵니다. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | 이터레이터를 한 단계 앞으로 이동합니다. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | virtualized iterator가 소유하는 열거자를 표시합니다. |
...
| void [Reset](./reset/)() override | 열거자를 첫 번째 요소 이전 위치로 재설정합니다. |
