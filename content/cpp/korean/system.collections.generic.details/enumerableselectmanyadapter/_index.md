...
type: docs
weight: 40
url: /ko/system.collections.generic.details/enumerableselectmanyadapter/
---
## EnumerableSelectManyAdapter 클래스
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | 시퀀스에서 지정된 인덱스 위치의 요소를 반환합니다. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | 시퀀스에서 지정된 인덱스 위치의 요소를 반환합니다. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문을 구현하여 잠금을 해제합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 경비 객체를 사용하세요. |
