...
description: 현재 컨테이너에 대한 끝 반복자의 구현을 가져옵니다.
type: docs
weight: 222
url: /ko/system.collections.specialized/namevaluecollection/virtualizeenditerator/
---
## NameValueCollection::virtualizeEndIterator() 메서드

현재 컨테이너에 대한 끝 반복자의 구현을 가져옵니다.
