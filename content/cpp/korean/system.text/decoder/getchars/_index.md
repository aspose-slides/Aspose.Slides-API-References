...
description: 버퍼를 디코딩한 결과 얻어지는 문자를 가져옵니다.
type: docs
weight: 53
url: /ko/system.text/decoder/getchars/
---
## Decoder::GetChars(ArrayPtr\<uint8_t\>, int, int, ArrayPtr\<char_t\>, int) 메서드

버퍼를 디코딩한 결과의 문자를 가져옵니다.
...
## Decoder::GetChars(ArrayPtr\<uint8_t\>, int, int, ArrayPtr\<char_t\>, int, bool) 메서드
...
## Decoder::GetChars(const uint8_t *, int, char_t *, int, bool) 메서드
