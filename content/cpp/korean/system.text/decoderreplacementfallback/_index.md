...
description: "잘못된 기호를 스텁으로 교체하는 대체 전략을 제공합니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여만 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용해 인스턴스를 만들지 마십시오. 그렇지 않으면 런타임 오류 및/또는 단언 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고 해당 포인터를 함수 인수로 전달하십시오."
type: docs
weight: 79
url: /ko/system.text/decoderreplacementfallback/
---
## DecoderReplacementFallback 클래스

잘못된 기호를 스텁으로 교체하는 대체 전략을 제공합니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용해 인스턴스를 만들지 마십시오. 이렇게 하면 런타임 오류 및/또는 단언 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터로 감싸고 해당 포인터를 함수 인수로 전달하십시오.
...
| 메서드 | 설명 |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | 대체 버퍼를 생성합니다. |
| [DecoderReplacementFallback](./decoderreplacementfallback/)() | 기본 \"?\" 교체 문자열을 사용하는 생성자. |
| [DecoderReplacementFallback](./decoderreplacementfallback/)(const [String](../../system/string/)\&) | 생성자. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일 부동 소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일 부동 소수점 비교를 에뮬레이트하여 두 NaN을 동일하게 간주합니다. IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도로만 사용됩니다. |
| const [String](../../system/string/)\& [get_DefaultString](./get_defaultstring/)() const | 교체 문자열을 반환합니다. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](../decoderfallback/get_exceptionfallback/)() | 기본 예외 대체 구현을 반환합니다. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | 인스턴스가 반환할 수 있는 최대 문자 수를 반환합니다. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](../decoderfallback/get_replacementfallback/)() | 기본 교체 대체 구현을 반환합니다. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](../decoderfallback/get_standardsafefallback/)() | 기본 표준 안전 대체 구현을 반환합니다. |
...
* 클래스 [DecoderFallback](../decoderfallback/)
* 네임스페이스 [System::Text](../)
* 라이브러리 [Aspose.Slides](../../)