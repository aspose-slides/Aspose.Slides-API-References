...
description: 바이트 버퍼를 문자열로 디코딩합니다.
type: docs
weight: 170
url: /ko/system.text/utf7encoding/getstring/
---
## UTF7Encoding::GetString(ArrayPtr\<uint8_t\>, int, int) 메서드
...
## UTF7Encoding::GetString(uint8_t *, int) 메서드
...
## UTF7Encoding::GetString(const ReadOnlySpan\<uint8_t\>\&) 메서드
...
## UTF7Encoding::GetString(ArrayPtr\<uint8_t\>) 메서드
...
## UTF7Encoding::GetString(const System::Details::ArrayView\<uint8_t\>\&) 메서드
...
## UTF7Encoding::GetString(System::Details::StackArray\<uint8_t, N\>\&) 메서드
...
## UTF7Encoding::GetString(const System::Details::ArrayView\<uint8_t\>\&, int, int) 메서드
...
## UTF7Encoding::GetString(System::Details::StackArray\<uint8_t, N\>, int, int) 메서드
