...
type: docs
weight: 157
url: /ko/system.text/utf7encoding/getbytecount/
---
## UTF7Encoding::GetByteCount(const char_t *, int) 메서드
...
## UTF7Encoding::GetByteCount(ArrayPtr\<char_t\>, int, int) 메서드
...
## UTF7Encoding::GetByteCount(System::Details::ArrayView\<char_t\>, int, int) 메서드
...
## UTF7Encoding::GetByteCount(const System::Details::StackArray\<char_t, N\>\&, int, int) 메서드
...
## UTF7Encoding::GetByteCount(const String\&) 메서드
...
## UTF7Encoding::GetByteCount(ArrayPtr\<char_t\>) 메서드
