...
description: "ASCII 인코딩을 나타냅니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택이나 operator new를 사용하여 이 유형의 인스턴스를 생성하면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터에 래핑하고 해당 포인터를 함수 인수로 전달하십시오."
type: docs
weight: 1
url: /ko/system.text/asciiencoding/
---
## ASCIIEncoding 클래스

ASCII 인코딩을 나타냅니다. 이 클래스의 객체는 [System::MakeObject()](../../system/makeobject/) 함수만 사용하여 할당해야 합니다. 스택에 객체를 생성하거나 operator new를 사용하여 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 [System::SmartPtr](../../system/smartptr/) 포인터에 래핑하고 이 포인터를 함수 인수로 전달하십시오.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떠한 값과도 같지 않지만, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 같다고 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떠한 값과도 같지 않지만, C# 스타일 부동소수점 비교를 에뮬레이트하여 두 NaN을 같다고 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용. |
| static [EncodingPtr](../../system/encodingptr/) [get_ASCII](../encoding/get_ascii/)() | ASCII 인코딩을 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [get_BigEndianUnicode](../encoding/get_bigendianunicode/)() | 표준 빅엔디언 Unicode 인코딩 객체를 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [get_BigEndianUTF32](../encoding/get_bigendianutf32/)() | 표준 빅엔디언 UTF-32 인코딩 객체를 반환합니다. |
| virtual [String](../../system/string/) [get_BodyName](../encoding/get_bodyname/)() | 메일 에이전트 본문과 호환되는 인코딩 이름을 반환합니다. |
| virtual int [get_CodePage](../encoding/get_codepage/)() | [Windows](../../system.windows/) 코드 페이지 ID를 반환합니다. |
| [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_DecoderFallback](../encoding/get_decoderfallback/)() const | 디코더 폴백을 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [get_Default](../encoding/get_default/)() | 기본 인코딩을 반환합니다. |
| const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_EncoderFallback](../encoding/get_encoderfallback/)() const | 인코더 폴백을 반환합니다. |
| virtual [String](../../system/string/) [get_EncodingName](../encoding/get_encodingname/)() | 사람이 읽을 수 있는 인코딩 이름을 반환합니다. |
| virtual [String](../../system/string/) [get_HeaderName](../encoding/get_headername/)() | 메일 에이전트 헤더와 호환되는 인코딩 이름을 반환합니다. |
...
| virtual **bool** [get_IsSingleByte](../encoding/get_issinglebyte/)() | 인코딩이 한 바이트인지 확인합니다. |
| static [EncodingPtr](../../system/encodingptr/) [get_Latin1](../encoding/get_latin1/)() | Latin1 인코딩을 반환합니다. 내부 전용. |
| static [EncodingPtr](../../system/encodingptr/) [get_Unicode](../encoding/get_unicode/)() | 표준 Unicode 인코딩 객체를 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [get_UTF32](../encoding/get_utf32/)() |  |
| static [EncodingPtr](../../system/encodingptr/) [get_UTF7](../encoding/get_utf7/)() | 표준 UTF-7 인코딩 객체를 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [get_UTF8](../encoding/get_utf8/)() | 표준 UTF-8 인코딩 객체를 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [get_UTF8Unmarked](../encoding/get_utf8unmarked/)() | 클래스 라이브러리에서만 사용되는 내부 전용으로, 표시되지 않으며 입력 검증을 수행하지 않습니다. |
| virtual [String](../../system/string/) [get_WebName](../encoding/get_webname/)() | IANA와 호환되는 인코딩 이름을 반환합니다. |
| virtual int [get_WindowsCodePage](../encoding/get_windowscodepage/)() | [Windows](../../system.windows/) 코드 페이지 ID를 반환합니다. |
...
| [DecoderPtr](../../system/decoderptr/) [GetDecoder](../icuencoding/getdecoder/)() override | 이 객체에 요청을 전달하는 디코더를 반환합니다. |
| [EncoderPtr](../../system/encoderptr/) [GetEncoder](../icuencoding/getencoder/)() override | 이 객체에 요청을 전달하는 인코더를 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(const [String](../../system/string/)\&) | 이름으로 인코딩을 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(int) | 코드 페이지로 인코딩을 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(int, const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&, const [DecoderFallbackPtr](../../system/decoderfallbackptr/)\&) | 코드 페이지로 인코딩을 반환합니다. |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(const [String](../../system/string/)\&, const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&, const [DecoderFallbackPtr](../../system/decoderfallbackptr/)\&) | 이름으로 인코딩을 반환합니다. |
| static [ArrayPtr](../../system/arrayptr/)\<[EncodingInfoPtr](../../system/encodinginfoptr/)\> [GetEncodings](../encoding/getencodings/)() | 알려진 인코딩 목록을 반환합니다. |
| int [GetHashCode](../encoding/gethashcode/)() const override | 인코딩을 해시합니다. |
| int [GetMaxByteCount](./getmaxbytecount/)(int) override | 알려진 문자 수에 대한 최대 바이트 수를 반환합니다. |
| int [GetMaxCharCount](./getmaxcharcount/)(int) override | 지정된 바이트 수를 디코딩하는 데 필요한 최대 문자 수를 반환합니다. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetPreamble](../icuencoding/getpreamble/)() override | 인코딩을 나타내는 바이트 시퀀스(예: BOM)를 반환합니다. |
...
| **bool** [operator==](../icuencoding/operator_equal_equal/)(const [ICUEncoding](../icuencoding/)\&) const | 코드 페이지를 사용하여 인코딩을 비교합니다. |
