...
description: 취소 알림을 트리거하는 데 사용할 수 있는 취소 토큰 소스입니다.
type: docs
weight: 40
url: /ko/system.threading/cancellationtokensource/
---
...
| Method | Description |
| --- | --- |
| void [Cancel](./cancel/)() | 취소 요청을 전달합니다. |
|  [CancellationTokenSource](./cancellationtokensource/)() | 새로운 [CancellationTokenSource](./)을(를) 생성합니다. |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | 제공된 토큰 중 하나가 취소될 때 취소되는 연결된 토큰 소스를 생성합니다. |
| void [Dispose](./dispose/)() override | [CancellationTokenSource](./)가 사용하는 모든 리소스를 해제합니다. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 두 NaN을 동등하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 동등하지 않습니다). |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 두 NaN을 동등하게 간주하는 C# 스타일 부동소수점 비교를 에뮬레이션합니다(IEC 60559:1989에 따르면 NaN은 어떤 값과도, NaN 자체와도 동등하지 않습니다). |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | 취소가 요청되었는지 여부를 반환합니다. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | 이 소스와 연결된 취소 토큰을 반환합니다. |
