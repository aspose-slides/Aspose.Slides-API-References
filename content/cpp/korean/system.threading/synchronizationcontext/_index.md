...
description: 다양한 동기화 작업에서 동기화 컨텍스트를 전파하기 위한 기본 기능을 제공합니다.
type: docs
weight: 196
url: /ko/system.threading/synchronizationcontext/
---
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일 부동 소수점 비교를 에뮬레이트합니다. 이 비교에서는 IEC 60559:1989에 따라 NaN은 어떤 값과도 같지 않음에도 불구하고 두 NaN을 동일하게 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일 부동 소수점 비교를 에뮬레이트합니다. 이 비교에서는 IEC 60559:1989에 따라 NaN은 어떤 값과도 같지 않음에도 불구하고 두 NaN을 동일하게 간주합니다. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 내부 용도 전용입니다. |
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | 현재 스레드에 대한 동기화 컨텍스트를 가져옵니다. |
...
| void [Lock](../../system/object/lock/)() | C# lock() 문의 잠금을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 감시 객체를 사용합니다. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 메서드의 유사체입니다. 사용자 정의 유형의 복제를 가능하게 합니다. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 콜백을 비동기적으로 실행합니다. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 콜백을 동기식으로 실행합니다. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | 현재 스레드에 대한 동기화 컨텍스트를 설정합니다. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n번째 템플릿 인자를 약한 포인터(공유 포인터가 아닌)로 설정합니다. 컨테이너 내 포인터를 약한 모드로 전환할 수 있습니다. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | [SynchronizationContext](./)의 새 인스턴스를 생성합니다. |
...
이 클래스는 스레드 간에 동기화 컨텍스트를 전파할 수 있게 하며, 콜백이나 호출을 적절한 스레드 또는 동기화 컨텍스트로 마샬링하는 데 사용됩니다. 더미 구현입니다. 
