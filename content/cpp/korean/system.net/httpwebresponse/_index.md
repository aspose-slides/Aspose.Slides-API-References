...
description: "HTTP 웹 응답을 나타냅니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여만 할당해야 합니다. 스택에서 혹은 operator new를 사용하여 인스턴스를 생성하면 런타임 오류 및/또는 단언 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 래핑하고, 해당 포인터를 함수 인수로 전달하세요."
type: docs
weight: 287
url: /ko/system.net/httpwebresponse/
---
## HttpWebResponse 클래스
...
| [System::String](../../system/string/) [get_CharacterSet](./get_characterset/)() | 구현되지 않았습니다. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](../cookiecollection/)\> [get_Cookies](./get_cookies/)() | 웹 응답과 관련된 쿠키를 반환합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | 현재 응답과 관련된 헤더 컬렉션을 반환합니다. |
| virtual [String](../../system/string/) [get_Method](./get_method/)() | HTTP 메서드를 반환합니다. |
| [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | 리소스의 URI를 반환합니다. |
| virtual [HttpStatusCode](../httpstatuscode/) [get_StatusCode](./get_statuscode/)() | 웹 응답과 관련된 HTTP 상태 코드를 반환합니다. |
| virtual [String](../../system/string/) [get_StatusDescription](./get_statusdescription/)() | 상태 코드의 문자열 표현을 반환합니다. |
...
| [String](../../system/string/) [GetResponseHeader](./getresponseheader/)([String](../../system/string/)) | 지정된 헤더 이름에 해당하는 값을 반환합니다. |
...
|  [HttpWebResponse](./httpwebresponse/)([System::SharedPtr](../../system/sharedptr/)\<[Http::HttpResponseMessage](../../system.net.http/httpresponsemessage/)\>, [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [System::SharedPtr](../../system/sharedptr/)\<[CookieContainer](../cookiecontainer/)\>) | 새 인스턴스를 생성합니다. |
