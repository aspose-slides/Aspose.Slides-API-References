...
description: "오류가 발생했을 때 WebRequest에 의해 발생하는 예외를 나타냅니다. 이 클래스를 직접 인스턴스화하지 마십시오. 대신 WebException 클래스를 사용하십시오. WebException 클래스 인스턴스를 System::SmartPtr에 감싸지 마십시오."
type: docs
weight: 92
url: /ko/system.net/details_webexception/
---
## Details_WebException 클래스

오류가 발생했을 때 [WebRequest](../webrequest/)에 의해 발생되는 예외를 나타냅니다. 이 클래스를 수동으로 인스턴스화하지 마세요. 대신 WebException 클래스를 사용하십시오. WebException 클래스 인스턴스를 [System::SmartPtr](../../system/smartptr/)에 감싸지 마세요.
...
| 메서드 | 설명 |
| --- | --- |
| static [Exception](../../system/exception/) [CreateCompatibleException](./createcompatibleexception/)([Exception](../../system/exception/)) | 구현되지 않았습니다. |
|  [Details_WebException](./details_webexception/)() | 새 인스턴스를 생성합니다. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/)) | 새 인스턴스를 생성합니다. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [Exception](../../system/exception/)) | 새 인스턴스를 생성합니다. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [WebExceptionStatus](../webexceptionstatus/)) | 새 인스턴스를 생성합니다. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [Exception](../../system/exception/), [WebExceptionStatus](../webexceptionstatus/), [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\>) | 새 인스턴스를 생성합니다. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) 의미를 사용하여 객체를 비교합니다. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# 스타일로 참조 형식 객체를 비교합니다. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# 스타일로 값 형식 객체를 비교합니다. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 서로 같다고 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989에 따르면 NaN은 어떤 값과도 같지 않지만, 두 NaN을 서로 같다고 간주하는 C# 스타일 부동소수점 비교를 에뮬레이트합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\> [get_Response](./get_response/)() | 현재 예외와 연관된 웹 응답을 반환합니다. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | 스택 트레이스를 포함하는 문자열을 반환합니다. |
| [WebExceptionStatus](../webexceptionstatus/) [get_Status](./get_status/)() | 상태 코드를 반환합니다. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | 객체의 실제 유형을 가져옵니다. C# [System.Object.GetType()](../../system/object/gettype/) 호출과 유사합니다. |
| **bool** [Is](../../system/details_invalidoperationexception/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const override |  |
| void [Lock](../../system/object/lock/)() | C# lock() 문문의 락을 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 문문의 잠금 해제를 구현합니다. 직접 호출하거나 [LockContext](../../system/lockcontext/) 센트리 객체를 사용하십시오. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [ExceptionWrapper](../../system/exceptionwrapper/) 클래스에 의해 호출되는 [what()](../../system/details_exception/what/) 메서드를 구현합니다. 이 클래스가 std::exception에서 상속되지 않았음에도 파생 클래스가 보호/비공개 멤버를 사용해 로직을 구현할 수 있습니다. 이 메서드 구현을 [ExceptionWrapper](../../system/exceptionwrapper/)로 이동하면 해당 로직이 깨질 수 있습니다. |
| virtual  [~Details_WebException](./~details_webexception/)() | 현재 인스턴스를 파괴합니다. |
| virtual  [~Object](../../system/object/~object/)() | 객체를 소멸합니다. 모든 내부 데이터 구조를 해제합니다. |

## 참고

* 클래스 [Details_InvalidOperationException](../../system/details_invalidoperationexception/)
* 네임스페이스 [System::Net](../)
* 라이브러리 [Aspose.Slides](../../)