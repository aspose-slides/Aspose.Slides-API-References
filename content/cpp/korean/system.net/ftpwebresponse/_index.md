...
description: "번역된 코드와 FtpWebResponse 참조를 연결할 수 있게 해 주지만 실행되지 않는 더미 클래스입니다. 제대로 구현된 멤버가 없습니다. 이 클래스의 객체는 System::MakeObject() 함수를 사용하여 할당해야 합니다. 스택에 직접 생성하거나 operator new를 사용해 인스턴스를 만들면 런타임 오류 및/또는 어설션 오류가 발생합니다. 항상 이 클래스를 System::SmartPtr 포인터로 감싸고 해당 포인터를 함수 인수로 전달하십시오."
type: docs
weight: 183
url: /ko/system.net/ftpwebresponse/
---
## FtpWebResponse 클래스
...
| 메서드 | 설명 |
| --- | --- |
| void [Close](./close/)() override | 구현되지 않음. |
| void [Dispose](../webresponse/dispose/)() override | 아무 것도 하지 않음. |
...
| **int64_t** [get_ContentLength](./get_contentlength/)() override | RTTI 정보. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | 구현되지 않음. |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | 구현되지 않음. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | 구현되지 않음. |
| virtual **bool** [get_SupportsHeaders](../webresponse/get_supportsheaders/)() | 현재 응답이 헤더를 지원하는지 여부를 나타내는 값을 반환합니다. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() override | 구현되지 않음. |
