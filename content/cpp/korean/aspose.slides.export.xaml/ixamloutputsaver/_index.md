...
---
## IXamlOutputSaver 클래스

외부 저장소로 데이터를 전송하기 위한 출력 저장기 구현을 나타냅니다.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# 스타일의 부동소수점 비교를 에뮬레이트하며, IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 같지 않지만 두 NaN을 동일하다고 간주합니다. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# 스타일의 부동소수점 비교를 에뮬레이트하며, IEC 60559:1989에 따르면 NaN은 어떤 값과도 (NaN 포함) 같지 않지만 두 NaN을 동일하다고 간주합니다. |
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 바이트 배열을 대상 위치에 저장합니다. |
