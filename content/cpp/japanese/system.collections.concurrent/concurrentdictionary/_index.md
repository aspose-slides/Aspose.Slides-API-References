...
description: "スレッドセーフな辞書実装です。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。これにより実行時エラーやアサーション違反が発生する可能性があります。常にこのクラスを System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡してください。"
type: docs
weight: 1
url: /ja/system.collections.concurrent/concurrentdictionary/
---
## ConcurrentDictionary クラス
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const TKey\&, const TValue\&) override | 辞書に値を追加します。 |
| virtual void [Add](../../system.collections.generic/idictionary/add/)(const TKey\&, const TValue\&) | コンテナにキーと値のペアを追加します。 |
...
| void [Clear](./clear/)() override | コンテナ内のすべての要素を削除します。 |
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T\&) const | コレクションに要素が存在するかチェックします。 |
| virtual **bool** [ContainsKey](../../system.collections.generic/idictionary/containskey/)(const TKey\&) const | コンテナがキーを含むかチェックします。 |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<TKey, TValue\>\>, int) override | コンテナの要素を既存の配列要素にコピーします。 |
| void [CopyTo](../../system.collections.generic/idictionary/copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../../system.collections.generic/keyvaluepair/)\<TKey, TValue\>\>, int) override | 辞書の内容を既存の配列要素にコピーします。 |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)() | 空の辞書を作成します。 |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [map_t](../../system.collections.generic/dictionary/map_t/)\&) | マップからデータをコピーします。 |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int) | 事前に割り当てられた辞書を作成するオーバーロードです。実際には割り当てを行いません。 |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IDictionary](../../system.collections.generic/idictionary/)\<TKey, TValue\>\>\&) | コピーコンストラクタ。 |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IDictionary](../../system.collections.generic/idictionary/)\<TKey, TValue\>\>\&, const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\>\&) | コピーコンストラクタ。 |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\>\&) | 空の辞書を作成します。 |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int, const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\>\&) | 空の辞書を作成します。 |
...
| virtual int [get_Count](../../system.collections.generic/icollection/get_count/)() const | コレクションの要素数を取得します。 |
| **bool** [get_IsFixedSize](../../system.collections.generic/idictionary/get_isfixedsize/)() const | コレクションのサイズが固定かどうかをチェックします。 |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | コレクションが読み取り専用かどうかをチェックします。 |
| **bool** [get_IsSynchronized](../../system.collections.generic/idictionary/get_issynchronized/)() const | コンテナがスレッドセーフかどうかをチェックします。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../../system.collections.generic/icollection/)\<TKey\>\> [get_Keys](../../system.collections.generic/idictionary/get_keys/)() const | キーコレクションにアクセスします。 |
| [SharedPtr](../../system/sharedptr/)\<typename [ThisType::KeyCollection](../../system.collections.generic/dictionary/keycollection/)\> [get_KeysInternal](./get_keysinternal/)() const override | 辞書のキーにアクセスするためのラッパーコレクションを取得します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../../system.collections.generic/icollection/)\<TValue\>\> [get_Values](../../system.collections.generic/idictionary/get_values/)() const | 値コレクションにアクセスします。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| [IEnumeratorPtr](../../system.collections.generic/dictionary/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/dictionary/getenumerator/)() override | 列挙子オブジェクトを作成します。 |
...
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey\&) const | 見つかった場合は値を返します。見つからない場合は **Value()** を返します。 |
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey\&, const TValue\&) const | 見つかった場合は値を返します。見つからない場合は **defaultValue** を返します。 |
| virtual TValue [GetValueOrNull](../../system.collections.generic/idictionary/getvalueornull/)(const TKey\&) const | 見つかった場合は値を返します。見つからない場合は **null** を返します（参照型にのみ意味があります）。 |
...
| virtual TValue [idx_get](../../system.collections.generic/idictionary/idx_get/)(const TKey\&) const | ゲッタ関数。 |
| void [idx_set](./idx_set/)(const TKey\&, TValue) override | 特定の位置に要素を設定します。 |
| virtual void [idx_set](../../system.collections.generic/idictionary/idx_set/)(const TKey\&, TValue) | セッタ関数。 |
...
| **bool** [Remove](./remove/)(const TKey\&) override | コンテナから要素を削除します。 |
| virtual **bool** [Remove](../../system.collections.generic/idictionary/remove/)(const TKey\&) | コンテナからキーを削除します。 |
...
| **bool** [TryAdd](./tryadd/)(const TKey\&, const TValue\&) | 辞書にキー/値ペアの追加を試みます。 |
| virtual **bool** [TryGetValue](../../system.collections.generic/idictionary/trygetvalue/)(const TKey\&, TValue\&) const | 値を探し、見つかった場合は取得します。 |
...
* 名前空間 [System::Collections::Concurrent](../)
* ライブラリ [Aspose.Slides](../../)