...
description: Are-same は AreSame アサーションの引数を比較します。
type: docs
weight: 66
url: /ja/system.testpredicates/aresame/
---
## System::TestPredicates::AreSame(const char *, const char *, const T1\&, const T2\&) 関数

Are-sameはAreSameアサーションの引数を比較します。
