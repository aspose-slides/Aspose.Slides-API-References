...
description: 出力用に != アサーション失敗をフォーマットします。
type: docs
weight: 40
url: /ja/system.testpredicates.details/noteqfailure/
---
## System::TestPredicates::Details::NotEqFailure(const char *, const char *, T1\&, T2\&) 関数

出力用に != アサーション失敗をフォーマットします。
