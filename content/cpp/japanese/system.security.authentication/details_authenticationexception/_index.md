...
type: docs
weight: 1
url: /ja/system.security.authentication/details_authenticationexception/
---
## Details_AuthenticationException クラス
...
| void [Lock](../../system/object/lock/)() | C# lock() 文のロック処理を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) 監視オブジェクトを使用してください。 |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | HRESULT を設定します。これは特定の例外に割り当てられる符号化された数値です。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のアンロック処理を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) 監視オブジェクトを使用してください。 |
