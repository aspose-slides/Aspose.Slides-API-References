...
type: docs
weight: 92
url: /ja/system.collections.generic.details/enumeratorselectindexadapter/
---
## EnumeratorSelectIndexAdapter クラス
...
| メソッド | 説明 |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | イテレータを VirtualizedIterator クラスで使用できるように準備します。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN は任意の値（NaN を含む）と等しくないにもかかわらず、二つの NaN を等しいとみなす C# 形式の浮動小数点比較をエミュレートします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN は任意の値（NaN を含む）と等しくないにもかかわらず、二つの NaN を等しいとみなす C# 形式の浮動小数点比較をエミュレートします。 |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | イテレータを1ステップ前方に進めます。 |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | バーチャライズドイテレータが所有する列挙子をマークします。 |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) メソッドのアナログです。カスタム型のクローン作成を可能にします。 |
| **bool** [MoveNext](./movenext/)() override | 列挙子を次の要素に移動します。以前に要素が参照されていなければ、利用可能な最初の要素を参照として設定します。コンテナの末端に達した場合は何もしません。 |
