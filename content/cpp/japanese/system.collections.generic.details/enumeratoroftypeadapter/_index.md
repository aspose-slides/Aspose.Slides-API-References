...
description: IEnumerable.OfType() 拡張メソッドで使用される列挙子です。
type: docs
weight: 66
url: /ja/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter クラス
...
| メソッド | 説明 |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | VirtualizedIterator クラスで使用されるようにイテレータを準備します。 |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | イテレータを 1 ステップ前進させます。 |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 最初の [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼び出しを実行し、VirtualizedIterator で使用されるように列挙子オブジェクトを準備します。 |
...
| **bool** [MoveNext](./movenext/)() override | 列挙子を次の要素に移動させます。以前に要素が参照されていなければ、利用可能な最初の要素を参照として設定します。コンテナの末尾に達した場合は何もしません。 |
