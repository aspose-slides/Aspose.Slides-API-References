...
description: IEnumerable.Cast() 拡張メソッドで使用される列挙子です。
type: docs
weight: 53
url: /ja/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter クラス

IEnumerable.Cast() 拡張メソッドで使用される列挙子です。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくないにも関わらず、2つの NaN を等しいとみなす C# 形式の浮動小数点比較をエミュレートします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくないにも関わらず、2つの NaN を等しいとみなす C# 形式の浮動小数点比較をエミュレートします。 |
...
| **bool** [MoveNext](./movenext/)() override | 列挙子を次の要素に移動します。以前に参照された要素がない場合、利用可能な最初の要素への参照を設定します。コンテナの末端に達した場合は何もしません。 |
...
* ネームスペース [System::Collections::Generic::Details](../)
* ライブラリ [Aspose.Slides](../../)