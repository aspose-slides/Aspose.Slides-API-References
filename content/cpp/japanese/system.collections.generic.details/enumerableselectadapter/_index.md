...
description: IEnumerable.Select() 拡張メソッドで使用される Enumerable。
type: docs
weight: 14
url: /ja/system.collections.generic.details/enumerableselectadapter/
---
## EnumerableSelectAdapter クラス

IEnumerable.Select() 拡張メソッドで使用される Enumerable。
