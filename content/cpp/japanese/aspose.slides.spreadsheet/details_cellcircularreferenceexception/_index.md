...
description: 数式が自セルを直接または間接的に参照し、1つ以上の循環参照が検出されたときにスローされる例外です。
type: docs
weight: 1
url: /ja/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException クラス

数式が自分のセルを直接または間接的に参照することで、1つ以上の循環参照が検出されたときにスローされる例外です。
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | 循環セル参照を取得します。 |
