...
description: "CMS/PKCS #7 標準に従ってコンテンツに署名します。実装されていません。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション障害が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。"
type: docs
weight: 27
url: /ja/system.security.cryptography.pkcs/signedcms/
---
## SignedCms クラス
...
| メソッド | 説明 |
| --- | --- |
| void [ComputeSignature](./computesignature/)(const [SharedPtr](../../system/sharedptr/)\<[CmsSigner](../cmssigner/)\>\&, **bool**) | 署名を作成します。 |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [Encode](./encode/)() | CMS/PKCS #7 メッセージをエンコードします。 |
...
|  [SignedCms](./signedcms/)(const [SharedPtr](../../system/sharedptr/)\<[ContentInfo](../contentinfo/)\>\&, **bool**) | コンストラクタ。 |
