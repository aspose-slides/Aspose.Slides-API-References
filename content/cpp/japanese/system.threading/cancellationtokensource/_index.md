...
description: キャンセル通知をトリガーするために使用できるキャンセルトークン ソースです。
type: docs
weight: 40
url: /ja/system.threading/cancellationtokensource/
---
## CancellationTokenSource クラス

キャンセルトークンをトリガーするために使用できるキャンセルトークン ソースです。
...
| Method | Description |
| --- | --- |
| void [Cancel](./cancel/)() | キャンセル要求を通知します。 |
|  [CancellationTokenSource](./cancellationtokensource/)() | [CancellationTokenSource](./) の新しいインスタンスを構築します。 |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | 提供されたトークンのいずれかがキャンセルされるとキャンセルされるリンクされたトークン ソースを作成します。 |
| void [Dispose](./dispose/)() override | [CancellationTokenSource](./) が使用するすべてのリソースを解放します。 |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | キャンセルが要求されたかどうかを取得します。 |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | このソースに関連付けられたキャンセルトークンを取得します。 |
...
操作の協調的なキャンセルのために、キャンセルトークンを作成および制御する機構を提供します。
