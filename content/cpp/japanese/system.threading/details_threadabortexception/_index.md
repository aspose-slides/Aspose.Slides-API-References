...
type: docs
weight: 79
url: /ja/system.threading/details_threadabortexception/
---
## Details_ThreadAbortException クラス
...
| virtual [String](../../system/string/) [get_Message](../../system/details_exception/get_message/)() const | エラーの説明が含まれる文字列を返します。 |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | スタックトレースが含まれる文字列を返します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロック機構を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) ガードオブジェクトを使用してください。 |
