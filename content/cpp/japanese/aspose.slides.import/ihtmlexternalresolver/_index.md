...
description: HTML インポートルーチンが画像などの参照オブジェクトを取得するために使用するコールバックインターフェイス。
type: docs
weight: 53
url: /ja/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver クラス
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部目的のみ。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | URI を実際のリソースを含むオブジェクトにマッピングします。 |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | ベース URI と相対 URI から絶対 URI を解決します。 |
...
非推奨
:   廃止予定です。代わりに [IExternalResourceResolver](../iexternalresourceresolver/) を使用してください。17.12 リリースで削除される予定です。

## 参照

* クラス [IExternalResourceResolver](../iexternalresourceresolver/)
