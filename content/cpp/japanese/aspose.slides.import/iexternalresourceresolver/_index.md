...
description: Html および Svg ドキュメントのインポート時に外部リソースを解決するために使用されるコールバックインターフェイス。
type: docs
weight: 40
url: /ja/aspose.slides.import/iexternalresourceresolver/
---
## IExternalResourceResolver クラス

Html、Svg ドキュメントのインポート時に外部リソースを解決するために使用されるコールバックインターフェイス。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) | URI を実際のリソースを含むオブジェクトにマッピングします。 |
...
| virtual [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | ベース URI と相対 URI から絶対 URI を解決します。 |
