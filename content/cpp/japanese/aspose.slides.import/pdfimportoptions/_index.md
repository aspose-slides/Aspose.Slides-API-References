...
| **bool** [get_DetectTables](./get_detecttables/)() const | PDF ファイルをインポートするときにテーブルを検出するかどうかを決定します。 |
...
| void [set_DetectTables](./set_detecttables/)(**bool**) | PDF ファイルをインポートするときにテーブルを検出するかどうかを決定します。 |
