...
description: XmlWriter の体験を向上させるサービスクラス。
type: docs
weight: 53
url: /ja/system.xml.serialization/xmlserializationwriter/
---
## XmlSerializationWriter クラス

Service クラスは [XmlWriter](../../system.xml/xmlwriter/) の体験を向上させます。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくありません（NaN を含む）という事実があるにもかかわらず、2 つの NaN を等しいとみなす C#-style 浮動小数点比較をエミュレートします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくありません（NaN を含む）という事実があるにもかかわらず、2 つの NaN を等しいとみなす C#-style 浮動小数点比較をエミュレートします。 |
...
| void [Initialize](./initialize/)([System::SharedPtr](../../system/sharedptr/)\<[XmlWriter](../../system.xml/xmlwriter/)\>, [System::SharedPtr](../../system/sharedptr/)\<[XmlSerializerNamespaces](../xmlserializernamespaces/)\>) | [XmlSerializationReader](../xmlserializationreader/) クラスを初期化します。 |
