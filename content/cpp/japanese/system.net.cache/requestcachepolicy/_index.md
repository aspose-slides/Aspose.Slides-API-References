...
description: "HTTP、FTP などのキャッシュに使用される共通リクエストキャッシュポリシーです。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してインスタンスを作成しないでください。これにより実行時エラーやアサーション違反が発生する可能性があります。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡して使用してください。"
type: docs
weight: 14
url: /ja/system.net.cache/requestcachepolicy/
---
...
| [RequestCacheLevel](../requestcachelevel/) [get_Level](./get_level/)() | 指定された RequestCacheLevel 値を取得します。 |
...
|  [RequestCachePolicy](./requestcachepolicy/)() | 新しいインスタンスを構築します。 |
|  [RequestCachePolicy](./requestcachepolicy/)([RequestCacheLevel](../requestcachelevel/)) | 指定された RequestCacheLevel 値で新しいインスタンスを構築します。 |
