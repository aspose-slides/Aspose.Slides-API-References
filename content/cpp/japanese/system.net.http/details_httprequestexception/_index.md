...
description: "ベース例外クラスは HttpClient および HttpMessageHandler クラスによってスローされます。このクラスのインスタンスを手動で作成しないでください。代わりに HttpRequestException クラスを使用してください。HttpRequestException クラスのインスタンスを System::SmartPtr にラップしないでください。"
type: docs
weight: 14
url: /ja/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException クラス


ベース例外クラスは [HttpClient](../httpclient/) および [HttpMessageHandler](../httpmessagehandler/) クラスによってスローされます。このクラスのインスタンスを手動で作成しないでください。代わりに HttpRequestException クラスを使用してください。HttpRequestException クラスのインスタンスを [System::SmartPtr](../../system/smartptr/) にラップしないでください。
...
| メソッド | 説明 |
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | 新しいインスタンスを構築します。 |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | 新しいインスタンスを構築します。 |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | 新しいインスタンスを構築します。 |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | 新しいインスタンスを構築します。 |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | 例外ラッパーでラップされた例外インスタンスをスローします。 |
...
* クラス [Details_Exception](../../system/details_exception/)
