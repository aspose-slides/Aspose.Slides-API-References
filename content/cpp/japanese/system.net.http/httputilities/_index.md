...
description: ユーティリティ メソッドを含みます。
type: docs
weight: 131
url: /ja/system.net.http/httputilities/
---
## HttpUtilities クラス
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | 指定された URI が HTTP URI かどうかを確認します。 |
...
| フィールド | 説明 |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | リクエスト送信時のデフォルト HTTP バージョンです。 |
| static [DefaultResponseVersion](./defaultresponseversion/) | レスポンス受信時のデフォルト HTTP バージョンです。 |
