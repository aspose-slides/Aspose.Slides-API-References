...
description: ビヘイビアのフィルター効果を表します。
type: docs
weight: 131
...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | アニメーションビヘイビアが蓄積されるかどうかを表します。読み取り [NullableBool](../../aspose.slides/nullablebool/)。 |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | 現在のアニメーションビヘイビアが他の実行中のアニメーションと結合されるかどうかを表します。読み取り [BehaviorAdditiveType](../behavioradditivetype/)。 |
...
| [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() override | ビヘイビアを伴うエフェクトが（入出力）明らかにされる必要があることを表します。読み取り [FilterEffectRevealType](../filtereffectrevealtype/)。 |
| [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() override | フィルターエフェクトのサブタイプを表します。読み取り [FilterEffectSubtype](../filtereffectsubtype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | エフェクトビヘイビアのタイミングプロパティを表します。読み取り [ITiming](../itiming/)。 |
| [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() override | フィルターエフェクトのタイプを表します。読み取り [FilterEffectType](../filtereffecttype/)。 |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | アニメーションビヘイビアが蓄積されるかどうかを表します。書き込み [NullableBool](../../aspose.slides/nullablebool/)。 |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | 現在のアニメーションビヘイビアが他の実行中のアニメーションと結合されるかどうかを表します。書き込み [BehaviorAdditiveType](../behavioradditivetype/)。 |
| void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) override | ビヘイビアを伴うエフェクトが（入出力）明らかにされる必要があることを表します。書き込み [FilterEffectRevealType](../filtereffectrevealtype/)。 |
| void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) override | フィルターエフェクトのサブタイプを表します。書き込み [FilterEffectSubtype](../filtereffectsubtype/)。 |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | エフェクトビヘイビアのタイミングプロパティを表します。書き込み [ITiming](../itiming/)。 |
| void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) override | フィルターエフェクトのタイプを表します。書き込み [FilterEffectType](../filtereffecttype/)。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n 番目のテンプレート引数を共有ポインタではなく弱参照ポインタに設定します。コンテナ内のポインタを弱モードに切り替えることが可能です。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリーオブジェクトを使用してください。 |
...
* クラス [IFilterEffect](../ifiltereffect/)
