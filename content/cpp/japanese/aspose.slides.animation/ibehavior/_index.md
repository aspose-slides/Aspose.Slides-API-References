...
description: エフェクトの基底クラスの振る舞いを表します。
type: docs
weight: 144
...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() | アニメーションの振る舞いが累積されるかどうかを表します。[NullableBool](../../aspose.slides/nullablebool/) を読み取ります。 |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() | 現在のアニメーション振る舞いが他の実行中アニメーションと結合されるかどうかを表します。[BehaviorAdditiveType](../behavioradditivetype/) を読み取ります。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() | 振る舞いのプロパティを表します。読み取り専用 [IBehaviorPropertyCollection](../ibehaviorpropertycollection/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() | エフェクトの振る舞いのタイミングプロパティを表します。[ITiming](../itiming/) を読み取ります。 |
...
| virtual void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | アニメーションの振る舞いが累積されるかどうかを表します。[NullableBool](../../aspose.slides/nullablebool/) に書き込みます。 |
| virtual void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | 現在のアニメーション振る舞いが他の実行中アニメーションと結合されるかどうかを表します。[BehaviorAdditiveType](../behavioradditivetype/) に書き込みます。 |
| virtual void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | エフェクトの振る舞いのタイミングプロパティを表します。[ITiming](../itiming/) に書き込みます。 |
