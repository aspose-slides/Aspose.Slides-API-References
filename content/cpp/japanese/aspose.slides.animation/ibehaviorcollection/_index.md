...
| メソッド | 説明 |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | コレクションに新しいビヘイビアを追加します。 |
...
| virtual void [Clear](./clear/)() | コレクションからすべてのビヘイビアを削除します。 |
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | [ICollection](../../system.collections.generic/icollection/) が特定の値を含むかどうかを判断します。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | コレクション内のビヘイビア数を返します。読み取り専用の **int32_t**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスのビヘイビアを返します。 |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | 指定されたインデックスのビヘイビアを返します。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | [IList](../../system.collections.generic/ilist/) 内の特定のアイテムのインデックスを決定します。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | 指定されたインデックスに新しいビヘイビアをコレクションへ挿入します。 |
...
| **bool** [LINQ_All](../../system.collections.generic/ienumerable/linq_all/)(std::function\<**bool**(T)>) | シーケンスのすべての要素が条件を満たすかどうかを決定します。 |
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | シーケンスに要素が含まれているかどうかを決定します。 |
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンスの任意の要素が存在するか、条件を満たすかどうかを決定します。 |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | コレクションから指定されたビヘイビアを削除します。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 指定されたインデックスのビヘイビアをコレクションから削除します。 |
