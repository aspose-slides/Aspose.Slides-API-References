...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | 指定したインデックスのインタラクティブシーケンスを返します。このシーケンスは、\"click on shape\" による効果のみを含む可能性があり、対象シェイプが指定されます。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequenceCollection](../isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() override | インタラクティブシーケンスのコレクションを返します。このシーケンスは、\"click on shape\" による効果のみを含む可能性があり、対象シェイプが指定されます。読み取り専用 [ISequenceCollection](../isequencecollection/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | メインエフェクトのコレクションのみを含む可能性があるメインシーケンスを返します。読み取り専用 [ISequence](../isequence/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | 指定したインデックスのメインシーケンスからエフェクトを返します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | 指定したインデックスのテキストアニメーションを返します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | テキストアニメーションのコレクションを返します。読み取り専用 [ITextAnimationCollection](../itextanimationcollection/)。 |
...
* クラス [IAnimationTimeLine](../../aspose.slides/ianimationtimeline/)
