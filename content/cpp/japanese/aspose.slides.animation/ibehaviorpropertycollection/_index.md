...
description: エフェクトの挙動に対するタイミングプロパティを表します。
type: docs
weight: 196
url: /ja/aspose.slides.animation/ibehaviorpropertycollection/
---
## IBehaviorPropertyCollection クラス

エフェクトの挙動に対するタイミングプロパティを表します。
...
| メソッド | 説明 |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | コレクションに新しいプロパティを追加します。 |
...
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | [ICollection](../../system.collections.generic/icollection/) が特定の値を含むかどうかを判定します。 |
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T\&) const | 要素がコレクションに存在するかを確認します。 |
...
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | [Object.Equals](../../system/object/equals/) の C# セマンティクスを使用してオブジェクトを比較します。 |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# スタイルで参照型オブジェクトを比較します。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# スタイルで値型オブジェクトを比較します。 |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はいかなる値（NaN 含む）とも等しくありませんが、C# スタイルの浮動小数点比較をエミュレートし、2 つの NaN を等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はいかなる値（NaN 含む）とも等しくありませんが、C# スタイルの浮動小数点比較をエミュレートし、2 つの NaN を等しいとみなします。 |
...
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | [IList](../../system.collections.generic/ilist/) でプロパティ値により特定の項目のインデックスを決定します。 |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | コンテナ内で項目が最初に出現するインデックスを取得します。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | 指定されたインデックスに新しいプロパティ（指定されたプロパティ値）をコレクションに挿入します。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンスのいずれかの要素が存在するか、条件を満たすかを判定します。 |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | コレクションから指定されたプロパティを削除します。 |
