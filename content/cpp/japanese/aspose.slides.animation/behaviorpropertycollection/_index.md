...
| メソッド | 説明 |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | コレクションに新しいプロパティを追加します。 |
| void [Add](./add/)(const [System::String](../../system/string/)\&) override | コレクションに新しいプロパティを追加します。 |
...
| void [Clear](./clear/)() override | コレクションからすべてのプロパティを削除します。 |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | [ICollection](../../system.collections.generic/icollection/) が特定の値を含むかどうかを判定します。 |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const override | [ICollection](../../system.collections.generic/icollection/) が特定の値を含むかどうかを判定します。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>, **int32_t**) override | [ICollection](../../system.collections.generic/icollection/) の要素を [System::Array](../../system/array/) インデックスから開始して [System::Array](../../system/array/) にコピーします。 |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | コレクション内のすべての要素を既存の配列要素にコピーします。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はどの値にも等しくないにもかかわらず、2 つの NaN を等しいとみなす C# スタイルの浮動小数点比較をエミュレートします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はどの値にも等しくないにもかかわらず、2 つの NaN を等しいとみなす C# スタイルの浮動小数点比較をエミュレートします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| **int32_t** [get_Count](./get_count/)() const override | コレクションに格納されているプロパティの数を返します。読み取り専用 **int32_t**。 |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | コレクションが固定サイズかどうかをチェックします。 |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | [ICollection](../../system.collections.generic/icollection/) が読み取り専用かどうかを示す値を取得します。読み取り専用 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>\> [GetEnumerator](./getenumerator/)() override | コレクションを反復する列挙子を返します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\> [idx_get](./idx_get/)(**int32_t**) const override | 指定されたインデックスのプロパティを返します。 |
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | 指定されたインデックスの要素を取得します。 |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>) override | 指定されたインデックスのプロパティを返します。 |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | 指定されたインデックスに要素を設定します。 |
| **int32_t** [IndexOf](./indexof/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | [IList](../../system.collections.generic/ilist/) 内の特定の項目のインデックスを決定します。 |
| **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const override | [IList](../../system.collections.generic/ilist/) におけるプロパティ値で特定の項目のインデックスを決定します。 |
| void [Insert](./insert/)(**int32_t**, const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | 指定されたインデックスに新しいプロパティをコレクションに挿入します。 |
| void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) override | 指定されたインデックスに、指定されたプロパティ値を持つ新しいプロパティをコレクションに挿入します。 |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | 指定された位置に要素を挿入し、他の要素をシフトします。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンスに要素が存在するか、条件を満たす要素があるかどうかを判定します。 |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | コレクションから指定されたプロパティを削除します。 |
| **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) override | コレクションから指定されたプロパティを削除します。 |
| void [RemoveAt](./removeat/)(**int32_t**) override | 指定されたインデックスのプロパティを削除します。 |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | 指定されたインデックスの要素を削除します。 |
...
* クラス [IBehaviorPropertyCollection](../ibehaviorpropertycollection/)
