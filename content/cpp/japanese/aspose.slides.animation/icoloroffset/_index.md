...
| virtual **float** [get_Value0](./get_value0/)() | オフセットの最初の値を定義します。**float** を読み取ります。 |
| virtual **float** [get_Value1](./get_value1/)() | オフセットの2番目の値を定義します。**float** を読み取ります。 |
| virtual **float** [get_Value2](./get_value2/)() | オフセットの3番目の値を定義します。**float** を読み取ります。 |
...
| virtual void [set_Value0](./set_value0/)(**float**) | オフセットの最初の値を定義します。**float** に書き込みます。 |
| virtual void [set_Value1](./set_value1/)(**float**) | オフセットの2番目の値を定義します。**float** に書き込みます。 |
| virtual void [set_Value2](./set_value2/)(**float**) | オフセットの3番目の値を定義します。**float** に書き込みます。 |
