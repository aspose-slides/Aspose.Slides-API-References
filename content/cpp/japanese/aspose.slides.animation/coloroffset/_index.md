...
| **float** [get_Value0](./get_value0/)() override | オフセットの最初の値を定義します。**float** を読み取ります。 |
| **float** [get_Value1](./get_value1/)() override | オフセットの2番目の値を定義します。**float** を読み取ります。 |
| **float** [get_Value2](./get_value2/)() override | オフセットの3番目の値を定義します。**float** を読み取ります。 |
...
| void [set_Value0](./set_value0/)(**float**) override | オフセットの最初の値を定義します。**float** に書き込みます。 |
| void [set_Value1](./set_value1/)(**float**) override | オフセットの2番目の値を定義します。**float** に書き込みます。 |
| void [set_Value2](./set_value2/)(**float**) override | オフセットの3番目の値を定義します。**float** に書き込みます。 |
