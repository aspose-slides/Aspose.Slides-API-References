...
description: アニメーション 動作のプロパティタイプを表します。プロパティのリストは  とから取得します。
type: docs
weight: 183
url: /ja/aspose.slides.animation/ibehaviorproperty/
---
## IBehaviorProperty クラス

アニメーション動作のプロパティタイプを表します。[https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) と [https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx) のプロパティ一覧に従います。
...
| virtual **bool** [get_IsCustom](./get_iscustom/)() | このプロパティが仕様の事前定義されたプロパティ一覧 [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) に属さないかどうかを示します。 |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | プロパティの値 |
