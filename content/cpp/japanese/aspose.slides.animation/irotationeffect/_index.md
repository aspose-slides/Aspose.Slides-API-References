...
| virtual **float** [get_By](./get_by/)() | アニメーションの相対オフセット値を表します。読み取り **float**。 |
| virtual **float** [get_From](./get_from/)() | アニメーションの開始値を表します。読み取り **float**。 |
...
| virtual **float** [get_To](./get_to/)() | アニメーションの終了値を表します。読み取り **float**。 |
...
| virtual void [set_By](./set_by/)(**float**) | アニメーションの相対オフセット値を表します。書き込み **float**。 |
| virtual void [set_From](./set_from/)(**float**) | アニメーションの開始値を表します。書き込み **float**。 |
...
| virtual void [set_To](./set_to/)(**float**) | アニメーションの終了値を表します。書き込み **float**。 |
