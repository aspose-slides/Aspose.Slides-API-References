...
| Method | 説明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | 現在のシーケンスの末尾に新しいエフェクトを追加し、グループテキストアニメーションの末尾にします。テキスト段落の数がこのグループのエフェクト数以上である場合にのみ有効です！ |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | テキストアニメーションのビルドタイプのリスト（例: [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once）。読み取り [BuildType](../buildtype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | グループの有無にかかわらずリンクされたシェイプ効果（null の場合あり）。読み取り [IEffect](../ieffect/)。 |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | テキストアニメーションのビルドタイプのリスト（例: [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once）。書き込み [BuildType](../buildtype/)。 |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | グループの有無にかかわらずリンクされたシェイプ効果（null の場合あり）。書き込み [IEffect](../ieffect/)。 |
