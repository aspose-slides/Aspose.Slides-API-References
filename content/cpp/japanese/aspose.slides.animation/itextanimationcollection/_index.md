...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [idx_get](./idx_get/)(**int32_t**) | インデックスで要素を返します。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\>\> [idx_get](./idx_get/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | すべての要素を返します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のロック解除機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) ガードオブジェクトを使用してください。 |
