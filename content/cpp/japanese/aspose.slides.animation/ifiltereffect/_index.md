...
| virtual [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() | 動作を伴うエフェクトが (in/out) を公開しなければならないことを表します。読み取り [FilterEffectRevealType](../filtereffectrevealtype/)。 |
| virtual [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() | フィルターエフェクトのサブタイプを表します。読み取り [FilterEffectSubtype](../filtereffectsubtype/)。 |
...
| virtual [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() | フィルターエフェクトのタイプを表します。読み取り [FilterEffectType](../filtereffecttype/)。 |
...
| virtual void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) | 動作を伴うエフェクトが (in/out) を公開しなければならないことを表します。書き込み [FilterEffectRevealType](../filtereffectrevealtype/)。 |
| virtual void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) | フィルターエフェクトのサブタイプを表します。書き込み [FilterEffectSubtype](../filtereffectsubtype/)。 |
...
| virtual void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) | フィルターエフェクトのタイプを表します。書き込み [FilterEffectType](../filtereffecttype/)。 |
