...
description: データポイント レベルを表します。Treemap と Sunburst チャートに適用されます。
type: docs
weight: 703
url: /ja/aspose.slides.charts/ichartdatapointlevel/
---
## IChartDataPointLevel クラス

データポイント レベルを表します。Treemap と Sunburst チャートに適用されます。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | データポイント レベルの書式設定プロパティを表します。[IFormat](../iformat/) を読み取ります。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | データポイント レベルのデータラベルを表します。Treemap と Sunburst 系列タイプに適用されます。[IDataLabel](../idatalabel/) は読み取り専用です。 |
