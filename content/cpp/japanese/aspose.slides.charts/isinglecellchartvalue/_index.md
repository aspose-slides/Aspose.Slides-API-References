...
description: チャート データセルを表します。
type: docs
weight: 1184
url: /ja/aspose.slides.charts/isinglecellchartvalue/
---
## ISingleCellChartValue クラス
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() | チャート データ セルを返します。[IChartDataCell](../ichartdatacell/) を参照してください。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | AsCell、AsLiteralString、または AsLiteralDouble プロパティのいずれが実際であるかを指定します。言い換えれば、Data プロパティの値の型を指定します。このプロパティは読み取り専用です。このプロパティの値を変更するには、ChartDataPointCollection.DataSourceTypeFor<...> プロパティのいずれかを使用できます。[DataSourceType](../datasourcetype/) を参照してください。 |
...
| virtual void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | チャート データ セルを設定します。[IChartDataCell](../ichartdatacell/) に書き込みます。 |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | AsCell、AsLiteralString、または AsLiteralDouble プロパティのいずれが実際であるかを指定します。言い換えれば、Data プロパティの値の型を指定します。このプロパティは読み取り専用です。このプロパティの値を変更するには、ChartDataPointCollection.DataSourceTypeFor<...> プロパティのいずれかを使用できます。[DataSourceType](../datasourcetype/) に書き込みます。 |
