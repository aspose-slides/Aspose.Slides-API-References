...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | マーカーの塗りつぶしを取得します。読み取り専用 [IFormat](../iformat/)。 |
| virtual **int32_t** [get_Size](./get_size/)() | 折れ線グラフ、散布図、またはレーダー チャートにおけるマーカーのサイズを表します。**int32_t** を読み取ります。 |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | 折れ線グラフ、散布図、またはレーダー チャートにおけるマーカーのスタイルを表します。[MarkerStyleType](../markerstyletype/) を読み取ります。 |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | 折れ線グラフ、散布図、またはレーダー チャートにおけるマーカーのサイズを表します。**int32_t** に書き込みます。 |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | 折れ線グラフ、散布図、またはレーダー チャートにおけるマーカーのスタイルを表します。[MarkerStyleType](../markerstyletype/) に書き込みます。 |
