...
description: Line または Stock-chart の上下バーへのアクセスを提供します。
type: docs
weight: 1249
url: /ja/aspose.slides.charts/iupdownbarsmanager/
---
## IUpDownBarsManager クラス


Line- または Stock-chart の上下バーへのアクセスを提供します。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | 下向きバーのフォーマットを返します。読み取り専用 [IFormat](../iformat/)。 |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | ギャップ幅を返します。読み取り **int32_t**。 |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | チャートが上下バーを持つかどうかを判定します。読み取り **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | 上向きバーのフォーマットを返します。読み取り専用 [IFormat](../iformat/)。 |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | ギャップ幅を設定します。書き込み **int32_t**。 |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | チャートが上下バーを持つかどうかを設定します。書き込み **bool**。 |
