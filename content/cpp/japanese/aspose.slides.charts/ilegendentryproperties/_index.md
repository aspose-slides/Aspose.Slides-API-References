...
| virtual **bool** [get_Hide](./get_hide/)() | 凡例エントリの非表示フラグを返します。読み取り **bool**。 |
...
| virtual void [set_Hide](./set_hide/)(**bool**) | 凡例エントリの非表示フラグを設定します。書き込み **bool**。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) 監視オブジェクトを使用します。 |
