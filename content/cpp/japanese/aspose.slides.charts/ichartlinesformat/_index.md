...
description: グリッドラインのフォーマットプロパティを表します。
type: docs
weight: 768
url: /ja/aspose.slides.charts/ichartlinesformat/
---
## IChartLinesFormat クラス


グリッドラインのフォーマットプロパティを表します。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() | チャートラインで使用されるエフェクトを返します。読み取り専用 [IEffectFormat](../../aspose.slides/ieffectformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_Line](./get_line/)() | チャートラインのラインスタイルプロパティを返します。読み取り専用 [ILineFormat](../../aspose.slides/ilineformat/)。 |
