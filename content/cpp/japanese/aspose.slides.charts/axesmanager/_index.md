...
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_HorizontalAxis](./get_horizontalaxis/)() override | チャートの水平軸を取得します。読み取り専用 [IAxis](../iaxis/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryHorizontalAxis](./get_secondaryhorizontalaxis/)() override | チャートの副水平軸を取得します。読み取り専用 [IAxis](../iaxis/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryVerticalAxis](./get_secondaryverticalaxis/)() override | チャートの副垂直軸を取得します。読み取り専用 [IAxis](../iaxis/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SeriesAxis](./get_seriesaxis/)() override | チャートの系列軸を取得します。読み取り専用 [IAxis](../iaxis/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_VerticalAxis](./get_verticalaxis/)() override | チャートの垂直軸を取得します。読み取り専用 [IAxis](../iaxis/)。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) メソッドのアナログです。カスタムオブジェクトを文字列に変換可能にします。 |
