...
description: チャートカテゴリーレベルの値を管理するコンテナ。
type: docs
weight: 612
url: /ja/aspose.slides.charts/ichartcategorylevelsmanager/
---
## IChartCategoryLevelsManager クラス
...
| メソッド | 説明 |
| --- | --- |
| virtual void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) | 定義されたレベルのグルーピング項目を削除します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | 定義されたレベルに対する [IChartDataCell](../ichartdatacell/) オブジェクトを返します。 |
...
| virtual void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 定義されたレベルのグルーピング項目を設定します。 |
