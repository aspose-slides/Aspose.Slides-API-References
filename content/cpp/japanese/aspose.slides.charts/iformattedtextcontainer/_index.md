...
description: チャート テキスト フォーマットを表します。
type: docs
weight: 1054
url: /ja/aspose.slides.charts/iformattedtextcontainer/
---
## IFormattedTextContainer クラス

チャート テキスト フォーマットを表します。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../../aspose.slides/ibaseslide/)\> [get_Slide](../../aspose.slides/islidecomponent/get_slide/)() | ベース スライドを返します。読み取り専用 [IBaseSlide](../../aspose.slides/ibaseslide/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextFormat](../icharttextformat/)\> [get_TextFormat](./get_textformat/)() | チャート テキスト フォーマットを返します。読み取り専用 [IChartTextFormat](../icharttextformat/)。 |
