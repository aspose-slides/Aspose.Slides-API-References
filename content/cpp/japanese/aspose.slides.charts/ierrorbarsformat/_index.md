...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | エラーバーの形式を表します。読み取り [IFormat](../iformat/)。 |
| virtual **bool** [get_HasEndCap](./get_hasendcap/)() | エラーバーに端キャップが描画されないことを指定します。読み取り **bool**。 |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | エラーバーの表示可否を取得します。読み取り **bool**。 |
...
| virtual [ErrorBarType](../errorbartype/) [get_Type](./get_type/)() | エラーバーの種類を取得します。読み取り [ErrorBarType](../errorbartype/)。 |
| virtual **float** [get_Value](./get_value/)() | Fixed、Percentage、StandardDeviation の値タイプで使用され、エラーバーの長さを決定する値を取得します。読み取り **float**。 |
| virtual [ErrorBarValueType](../errorbarvaluetype/) [get_ValueType](./get_valuetype/)() | エラーバーの長さを決定する可能な方法を表します。カスタム値タイプの場合、シリーズの DataPoints コレクション内の特定データポイントの [IChartDataPoint::get_ErrorBarsCustomValues()](../ichartdatapoint/get_errorbarscustomvalues/) プロパティを使用して値を指定します。 読み取り [ErrorBarValueType](../errorbarvaluetype/)。 |
...
| virtual void [set_Format](./set_format/)([System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\>) | エラーバーの形式を表します。書き込み [IFormat](../iformat/)。 |
| virtual void [set_HasEndCap](./set_hasendcap/)(**bool**) | エラーバーに端キャップが描画されないことを指定します。書き込み **bool**。 |
| virtual void [set_IsVisible](./set_isvisible/)(**bool**) | エラーバーの表示可否を設定します。書き込み **bool**。 |
| virtual void [set_Type](./set_type/)([ErrorBarType](../errorbartype/)) | エラーバーの種類を設定します。書き込み [ErrorBarType](../errorbartype/)。 |
| virtual void [set_Value](./set_value/)(**float**) | Fixed、Percentage、StandardDeviation の値タイプで使用され、エラーバーの長さを決定する値を設定します。書き込み **float**。 |
| virtual void [set_ValueType](./set_valuetype/)([ErrorBarValueType](../errorbarvaluetype/)) | エラーバーの長さを決定する可能な方法を表します。カスタム値タイプの場合、シリーズの DataPoints コレクション内の特定データポイントの [IChartDataPoint::get_ErrorBarsCustomValues()](../ichartdatapoint/get_errorbarscustomvalues/) プロパティを使用して値を指定します。 書き込み [ErrorBarValueType](../errorbarvaluetype/)。 |
