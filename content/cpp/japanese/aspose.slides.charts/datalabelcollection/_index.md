...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | const 修飾されたコレクションの最後の要素（存在する場合）の直後を指すイテレータを取得します。 |
...
| **int32_t** [get_Count](./get_count/)() override | コレクション内のすべてのデータラベル数を取得します。読み取り専用 **int32_t**。 |
| **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() override | コレクション内の表示されているデータラベル数を取得します。読み取り専用 **int32_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() override | デフォルトのデータラベル形式を取得します。読み取り専用 [IDataLabelFormat](../idatalabelformat/)。 |
| **bool** [get_IsVisible](./get_isvisible/)() override | False はデフォルトでデータラベルが表示されないことを意味し（したがって DefaultDataLabelFormat プロパティのすべての Show* フラグ（ShowValue など）が false になります）。読み取り専用 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() override | データラベルのリーダーライン形式を表します。読み取り専用 [IChartLinesFormat](../ichartlinesformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() override | 親シリーズを取得します。読み取り専用 [IChartSeries](../ichartseries/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>\>\> [GetEnumerator](./getenumerator/)() override | コレクションを反復する列挙子を返します。 |
...
| void [Hide](./hide/)() override | DefaultDataLabelFormat プロパティのすべての Show* フラグ（ShowValue など）を false に設定し、データラベルをデフォルトで非表示にします。この後 IsVisible は false になります。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) override | 指定されたインデックスを持つデータポイントのデータラベルを取得します。 |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) override | コレクション内の指定された [DataLabel](../datalabel/) のインデックスを返します。 |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n 番目のテンプレート引数を弱参照ポインタ（shared ではなく）に設定します。コンテナ内のポインタを弱モードに切り替えることができます。 |
...
* クラス [IDataLabelCollection](../idatalabelcollection/)
