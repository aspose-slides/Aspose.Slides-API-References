...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | マーカーの塗りつぶしを取得します。読み取り専用 [IFormat](../iformat/)。 |
| **int32_t** [get_Size](./get_size/)() override | 折れ線グラフ、散布図、またはレーダー チャートにおけるマーカーのサイズを表します。**int32_t** を読み取ります。 |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | 折れ線グラフ、散布図、またはレーダー チャートにおけるマーカーのスタイルを表します。[MarkerStyleType](../markerstyletype/) を読み取ります。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリー オブジェクトを使用します。 |
...
| void [set_Size](./set_size/)(**int32_t**) override | 折れ線グラフ、散布図、またはレーダー チャートにおけるマーカーのサイズを表します。**int32_t** に書き込みます。 |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | 折れ線グラフ、散布図、またはレーダー チャートにおけるマーカーのスタイルを表します。[MarkerStyleType](../markerstyletype/) に書き込みます。 |
