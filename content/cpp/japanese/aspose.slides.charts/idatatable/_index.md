...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | オブジェクトの線、塗り、エフェクトスタイルを返します。読み取り専用 [IFormat](../iformat/)。 |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | チャート データテーブルに水平セル境界がある場合は true を返します。読み取り **bool**。 |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | チャート データテーブルにアウトライン境界がある場合は true を返します。読み取り **bool**。 |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | チャート データテーブルに垂直セル境界がある場合は true を返します。読み取り **bool**。 |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | データ ラベルの凡例キーが表示されている場合は true を返します。読み取り **bool**。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | オブジェクトが targetType によって記述された型のインスタンスを表すかどうかを確認します。C# の 'is' 演算子の類似です。 |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | チャート データテーブルに水平セル境界がある場合は true を設定します。書き込み **bool**。 |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | チャート データテーブルにアウトライン境界がある場合は true を設定します。書き込み **bool**。 |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | チャート データテーブルに垂直セル境界がある場合は true を設定します。書き込み **bool**。 |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | データ ラベルの凡例キーが表示されている場合は true を設定します。書き込み **bool**。 |
