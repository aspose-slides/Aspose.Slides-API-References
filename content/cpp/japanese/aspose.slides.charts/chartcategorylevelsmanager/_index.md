...
| メソッド | 説明 |
| --- | --- |
| void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) override | 定義されたレベルのグループ化項目を削除します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) override | 定義されたレベルに対して [IChartDataCell](../ichartdatacell/) オブジェクトを返します。 |
...
| void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 定義されたレベルのグループ化項目を設定します。 |
...
* クラス [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)
