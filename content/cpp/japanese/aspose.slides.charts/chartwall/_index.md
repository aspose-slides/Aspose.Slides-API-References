...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 壁の塗り、ライン、エフェクト、3D スタイルを返します。読み取り専用 [IFormat](../iformat/)。 |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | 画像タイプを取得または設定します。読み取り [Charts::PictureType](../picturetype/)。 |
| **int32_t** [get_Thickness](./get_thickness/)() override | プロット領域の最大寸法に対するパーセンテージとして壁の厚さを返します。読み取り **int32_t**。 |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | 画像タイプを取得または設定します。書き込み [Charts::PictureType](../picturetype/)。 |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | プロット領域の最大寸法に対するパーセンテージとして壁の厚さを設定します。書き込み **int32_t**。 |
