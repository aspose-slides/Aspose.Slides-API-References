...
| virtual **float** [get_Bottom](./get_bottom/)() | チャート要素の上端をチャートの高さの割合として取得します。読み取り専用 **float**。 |
...
| virtual **float** [get_Height](./get_height/)() | チャート要素の高さをチャートの高さの割合として指定します。読み取り **float**。 |
...
| virtual **float** [get_Right](./get_right/)() | チャート要素の右端をチャートの幅の割合として取得します。読み取り専用 **float**。 |
...
| virtual **float** [get_Width](./get_width/)() | チャート要素の幅をチャートの幅の割合として指定します。読み取り **float**。 |
| virtual **float** [get_X](./get_x/)() | チャート要素の x 位置（左）をチャートの幅の割合として指定します。読み取り **float**。 |
| virtual **float** [get_Y](./get_y/)() | チャート要素の上端をチャートの高さの割合として指定します。読み取り **float**。 |
...
| virtual void [set_Height](./set_height/)(**float**) | チャート要素の高さをチャートの高さの割合として指定します。書き込み **float**。 |
| virtual void [set_Width](./set_width/)(**float**) | チャート要素の幅をチャートの幅の割合として指定します。書き込み **float**。 |
| virtual void [set_X](./set_x/)(**float**) | チャート要素の x 位置（左）をチャートの幅の割合として指定します。書き込み **float**。 |
| virtual void [set_Y](./set_y/)(**float**) | チャート要素の上端をチャートの高さの割合として指定します。書き込み **float**。 |
