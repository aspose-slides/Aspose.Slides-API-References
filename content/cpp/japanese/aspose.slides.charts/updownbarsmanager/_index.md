...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# スタイルの浮動小数点比較をエミュレートします。2 つの NaN は IEC 60559:1989 において NaN が任意の値（NaN を含む）と等しくないと規定されているにもかかわらず、等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートします。2 つの NaN は IEC 60559:1989 において NaN が任意の値（NaN を含む）と等しくないと規定されているにもかかわらず、等しいとみなします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途のみです。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | DownBars のフォーマットを返します。読み取り専用 [IFormat](../iformat/)。 |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth。**int32_t** を読み取ります。 |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars。**bool** を読み取ります。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | UpBars のフォーマットを返します。読み取り専用 [IFormat](../iformat/)。 |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth。**int32_t** を書き込みます。 |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars。**bool** を書き込みます。 |
...
* クラス [IUpDownBarsManager](../iupdownbarsmanager/)
