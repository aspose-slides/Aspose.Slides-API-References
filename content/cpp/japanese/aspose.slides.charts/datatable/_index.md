...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | オブジェクトの線、塗り、エフェクトスタイルを返します。読み取り専用 [IFormat](../iformat/)。 |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | チャート データテーブルに水平セル境界がある場合は true を返します。読み取り **bool**。 |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | チャート データテーブルにアウトライン境界がある場合は true を返します。読み取り **bool**。 |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | チャート データテーブルに垂直セル境界がある場合は true を返します。読み取り **bool**。 |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | データラベルの凡例キーが表示されている場合は true を返します。読み取り **bool**。 |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | チャート データテーブルに水平セル境界がある場合は true を返します。書き込み **bool**。 |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | チャート データテーブルにアウトライン境界がある場合は true を返します。書き込み **bool**。 |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | チャート データテーブルに垂直セル境界がある場合は true を返します。書き込み **bool**。 |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | データラベルの凡例キーが表示されている場合は true を返します。書き込み **bool**。 |
