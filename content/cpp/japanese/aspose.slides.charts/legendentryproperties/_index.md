...
| **bool** [get_Hide](./get_hide/)() override | 凡例エントリが非表示かどうかを判定します。読み取り **bool**。 |
...
| void [set_Hide](./set_hide/)(**bool**) override | 凡例エントリが非表示かどうかを判定します。書き込み **bool**。 |
...
* クラス [ILegendEntryProperties](../ilegendentryproperties/)
