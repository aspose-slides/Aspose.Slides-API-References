...
| メソッド | 説明 |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | コレクションに新しいセルを追加します。 |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 指定された値から [IChartDataCell](../ichartdatacell/) を作成し、コレクションに追加します。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | コレクション内のセル数を取得します。読み取り専用 **int32_t**。 |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | ワークブック内のセル集合のアドレスを返します。 |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | すべてのセルの文字列値を連結した文字列を返します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | インデックスでセル ([IChartDataCell](../ichartdatacell/)) を返します。 |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | インデックスでコレクションからセルを削除します。 |
