...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 壁の塗りつぶし、線、効果、3d スタイルを返します。読み取り専用 [IFormat](../iformat/)。 |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | 画像タイプを取得または設定します。読み取り [PictureType](../picturetype/)。 |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | プロット領域の最大次元に対する壁の厚さをパーセンテージで返します。読み取り **int32_t**。 |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | 画像タイプを取得または設定します。書き込み [PictureType](../picturetype/)。 |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | プロット領域の最大次元に対する壁の厚さをパーセンテージで設定します。書き込み **int32_t**。 |
