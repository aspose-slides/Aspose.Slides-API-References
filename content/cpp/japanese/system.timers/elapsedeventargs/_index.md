...
description: タイマー イベントの引数。
type: docs
weight: 1
url: /ja/system.timers/elapsedeventargs/
---
...
| メソッド | 説明 |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | 指定されたパラメータで引数オブジェクトを構築します。 |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | シグナル時間を取得します。 |
...
| フィールド | 説明 |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | 空の "empty" [EventArgs](../../system/eventargs/) 共有ポインタ（null-pointer）を表す静的メンバーです。 |
