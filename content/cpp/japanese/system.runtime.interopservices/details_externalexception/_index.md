...
description: "すべての COM インターオップ例外および構造化例外処理 (SEH) 例外の基本例外型です。このクラスのインスタンスを手動で作成しないでください。その代わりに ExternalException クラスを使用してください。ExternalException クラスのインスタンスを System::SmartPtr にラップしないでください。"
type: docs
weight: 1
url: /ja/system.runtime.interopservices/details_externalexception/
---
## Details_ExternalException クラス


すべての COM インターオップ例外および構造化例外処理 (SEH) 例外の基本例外型です。このクラスのインスタンスを手動で作成しないでください。代わりに ExternalException クラスを使用してください。ExternalException クラスのインスタンスを [System::SmartPtr](../../system/smartptr/) にラップしないでください。
...
| virtual **int32_t** [get_ErrorCode](../../system/details_exceptionwitherrorcode/get_errorcode/)() const | エラーの HRESULT を取得します。 |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | HRESULT を設定します。特定の例外に割り当てられるコード化された数値です。 |
