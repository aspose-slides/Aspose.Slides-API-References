...
| メソッド | 説明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 新しい OLE Automation タイプ ライブラリ参照を作成します。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaReferenceFactory](./)\> [get_Instance](./get_instance/)() | VBA プロジェクト参照ファクトリの静的インスタンスです。読み取り専用 [VbaReferenceFactory](./)。 |
...
* クラス [IVbaReferenceFactory](../ivbareferencefactory/)
