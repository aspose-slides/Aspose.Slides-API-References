...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくない（NaN を含む）にもかかわらず、C# スタイルの浮動小数点比較をエミュレートし、2 つの NaN を等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくない（NaN を含む）にもかかわらず、C# スタイルの浮動小数点比較をエミュレートし、2 つの NaN を等しいとみなします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | モジュールの名前。読み取り専用 [System::String](../../system/string/)。 |
| virtual [System::String](../../system/string/) [get_SourceCode](./get_sourcecode/)() | モジュールのソースコード。読み取り [System::String](../../system/string/)。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) 番兵オブジェクトを使用してください。 |
...
| virtual void [set_SourceCode](./set_sourcecode/)([System::String](../../system/string/)) | モジュールのソースコード。書き込み [System::String](../../system/string/)。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) 番兵オブジェクトを使用してください。 |
