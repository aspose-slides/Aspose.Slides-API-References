...
| [System::String](../../system/string/) [get_Name](./get_name/)() override | モジュールの名前を取得します。読み取り専用 [System::String](../../system/string/)。 |
| [System::String](../../system/string/) [get_SourceCode](./get_sourcecode/)() override | モジュールのソースコードを返します。読み取り [System::String](../../system/string/)。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() ステートメントのロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティネル オブジェクトを使用します。 |
...
| void [set_SourceCode](./set_sourcecode/)([System::String](../../system/string/)) override | モジュールのソースコードを設定します。書き込み [System::String](../../system/string/)。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() ステートメントのロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティネル オブジェクトを使用します。 |
