...
| [System::String](../../system/string/) [get_Libid](./get_libid/)() override | Automation タイプ ライブラリの識別子を表します。[System::String](../../system/string/) を読み取ります。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | VBA プロジェクト参照の名前を表します。[System::String](../../system/string/) を読み取ります。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロック機構を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) の監視オブジェクトを使用します。 |
...
| void [set_Libid](./set_libid/)([System::String](../../system/string/)) override | Automation タイプ ライブラリの識別子を表します。[System::String](../../system/string/) に書き込みます。 |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | VBA プロジェクト参照の名前を表します。[System::String](../../system/string/) に書き込みます。 |
...
|  [VbaReferenceOleTypeLib](./vbareferenceoletypelib/)([System::String](../../system/string/), [System::String](../../system/string/)) | このコンストラクタは新しい OLE Automation タイプ ライブラリ参照を作成します。 |
...
* クラス [IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)
