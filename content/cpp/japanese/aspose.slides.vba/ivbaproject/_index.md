...
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | VBAProject がプロジェクトプロパティの表示にパスワードで保護されているかどうかを示します。読み取り専用 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | 指定されたインデックスに含まれる VBA プロジェクトのモジュールを返します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | VBA プロジェクトに含まれるすべてのモジュールの一覧を返します。読み取り専用 [IVbaModuleCollection](../ivbamodulecollection/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | VBA プロジェクトの名前を返します。読み取り専用 [System::String](../../system/string/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | 指定されたインデックスに含まれる VBA プロジェクトの参照を返します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | VBA プロジェクトに含まれるすべての参照の一覧を返します。読み取り専用 [IVbaReferenceCollection](../ivbareferencecollection/)。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | VBA プロジェクトのバイナリ表現を OLE コンテナとして返します。読み取り専用 **uint8_t**[]。 |
