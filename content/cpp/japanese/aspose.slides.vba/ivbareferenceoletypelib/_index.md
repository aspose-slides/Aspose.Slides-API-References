...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN は任意の値（NaN を含む）と等しくないとされますが、ここでは NaN 同士は等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN は任意の値（NaN を含む）と等しくないとされますが、ここでは NaN 同士は等しいとみなします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| virtual [System::String](../../system/string/) [get_Libid](./get_libid/)() | Automation タイプ ライブラリの識別子を表します。[System::String](../../system/string/) を参照してください。 |
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | VBA プロジェクト参照の名前を表します。[System::String](../../system/string/) を参照してください。 |
...
| virtual void [set_Libid](./set_libid/)([System::String](../../system/string/)) | Automation タイプ ライブラリの識別子を表します。[System::String](../../system/string/) に書き込みます。 |
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | VBA プロジェクト参照の名前を表します。[System::String](../../system/string/) に書き込みます。 |
...
* クラス [IVbaReference](../ivbareference/)
