...
description: すべてのコントロールが拡張可能としてマークされている、変更された OLE Automation タイプ ライブラリ参照を表します。
type: docs
weight: 92
url: /ja/aspose.slides.vba/ivbareferenceoletwiddledtypelib/
---
## IVbaReferenceOleTwiddledTypeLib クラス

修正された OLE Automation 型ライブラリ参照を表し、すべてのコントロールが拡張可能としてマークされています。
...
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | VBA プロジェクト参照の名前を表します。[System::String](../../system/string/) を読み取ります。 |
