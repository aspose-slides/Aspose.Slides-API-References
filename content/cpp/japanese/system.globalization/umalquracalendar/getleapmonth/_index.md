...
type: docs
weight: 79
url: /ja/system.globalization/umalquracalendar/getleapmonth/
---
## UmAlQuraCalendar::GetLeapMonth(int, int) const メソッド
...
指定された時代の指定された年のうるう月、うるう月がない年の場合は 0 を返します。

## UmAlQuraCalendar::GetLeapMonth(int) const メソッド
