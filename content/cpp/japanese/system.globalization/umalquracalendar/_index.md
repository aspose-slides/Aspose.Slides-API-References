...
description: "Um Al Qura カレンダーです。実装されていません。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーションエラーが発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数への引数として渡してください。"
type: docs
weight: 391
url: /ja/system.globalization/umalquracalendar/
---
## UmAlQuraCalendar クラス

Um Al Qura カレンダーです。実装されていません。  
...
| メソッド | 説明 |
| --- | --- |
| virtual [DateTime](../../system/datetime/) [AddDays](../calendar/adddays/)([DateTime](../../system/datetime/), int) const | 時間点に日を追加します。 |
| virtual [DateTime](../../system/datetime/) [AddHours](../calendar/addhours/)([DateTime](../../system/datetime/), int) const | 時間点に時間を追加します。 |
| virtual [DateTime](../../system/datetime/) [AddMilliseconds](../calendar/addmilliseconds/)([DateTime](../../system/datetime/), **double**) const | 時間点にミリ秒を追加します。 |
| virtual [DateTime](../../system/datetime/) [AddMinutes](../calendar/addminutes/)([DateTime](../../system/datetime/), int) const | 時間点に分を追加します。 |
| virtual [DateTime](../../system/datetime/) [AddMonths](../calendar/addmonths/)([DateTime](../../system/datetime/), int) const | 時間点に月を追加します。 |
| virtual [DateTime](../../system/datetime/) [AddSeconds](../calendar/addseconds/)([DateTime](../../system/datetime/), int) const | 時間点に秒を追加します。 |
| virtual [DateTime](../../system/datetime/) [AddWeeks](../calendar/addweeks/)([DateTime](../../system/datetime/), int) const | 時間点に週を追加します。 |
| virtual [DateTime](../../system/datetime/) [AddYears](../calendar/addyears/)([DateTime](../../system/datetime/), int) const | 時間点に年を追加します。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN は任意の値（NaN を含む）と等しくないにもかかわらず、ここでは 2 つの NaN が等しいとみなされます。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN は任意の値（NaN を含む）と等しくないにもかかわらず、ここでは 2 つの NaN が等しいとみなされます。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途のみです。 |
| [CalendarAlgorithmType](../calendaralgorithmtype/) [get_AlgorithmType](./get_algorithmtype/)() const override | アルゴリズムの種類を取得します。 |
...
| [DateTime](../../system/datetime/) [get_MaxSupportedDateTime](./get_maxsupporteddatetime/)() const override | カレンダーでサポートされる最大の時間点です。 |
| [DateTime](../../system/datetime/) [get_MinSupportedDateTime](./get_minsupporteddatetime/)() const override | カレンダーでサポートされる最小の時間点です。 |
...
| virtual int [GetWeekOfYear](../calendar/getweekofyear/)([DateTime](../../system/datetime/), [CalendarWeekRule](../calendarweekrule/), [DayOfWeek](../../system/dayofweek/)) const | 指定された時間点の年の週番号を取得します。 |
...
| **bool** [IsLeapDay](./isleapday/)(int, int, int, int) const override | その日がうるう日かどうかをチェックします。 |
| virtual **bool** [IsLeapDay](./isleapday/)(int, int, int) const | その日がうるう日かどうかをチェックします。 |
| virtual **bool** [IsLeapDay](./isleapday/)(int, int, int, int) const | その日がうるう日かどうかをチェックします。 |
| **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) const override | その月がうるう月かどうかをチェックします。 |
| virtual **bool** [IsLeapMonth](./isleapmonth/)(int, int) const | その月がうるう月かどうかをチェックします。 |
| virtual **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) const | その月がうるう月かどうかをチェックします。 |
| **bool** [IsLeapYear](./isleapyear/)(int, int) const override | その年がうるう年かどうかをチェックします。 |
| virtual **bool** [IsLeapYear](./isleapyear/)(int) const | その年がうるう年かどうかをチェックします。 |
| virtual **bool** [IsLeapYear](./isleapyear/)(int, int) const | その年がうるう年かどうかをチェックします。 |
...
| int [SharedCount](../../system/object/sharedcount/)() const | 現在の shared 参照カウンタの値を取得します。 |
...
|  [UmAlQuraCalendar](./umalquracalendar/)() | コンストラクタです。 |
...
| フィールド | 説明 |
| --- | --- |
| static constexpr [UmAlQuraEra](./umalquraera/) | 現在の UmAlQura 時代です。 |
