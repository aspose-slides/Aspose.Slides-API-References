...
description: "CultureNotFoundException は、利用できないカルチャーの構築を試みたときにスローされます。このクラスのインスタンスを手動で作成しないでください。代わりに CultureNotFoundException クラスを使用してください。CultureNotFoundException クラスのインスタンスを System::SmartPtr にラップしないでください。"
type: docs
weight: 92
url: /ja/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException クラス

CultureNotFoundException は、利用できないカルチャーの構築を試みたときにスローされます。このクラスのインスタンスを手動で作成しないでください。代わりに CultureNotFoundException クラスを使用してください。CultureNotFoundException クラスのインスタンスを [System::SmartPtr](../../system/smartptr/) にラップしないでください。
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに紐付けられた参照カウンターデータ構造体を取得します。 |
