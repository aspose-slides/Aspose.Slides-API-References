...
description: 月が閏月かどうかを確認します。
type: docs
weight: 209
url: /ja/system.globalization/koreancalendar/isleapmonth/
---
## KoreanCalendar::IsLeapMonth(int, int, int) const メソッド
...
指定された月が閏月である場合は true、そうでない場合は false。

## KoreanCalendar::IsLeapMonth(int, int) const メソッド
