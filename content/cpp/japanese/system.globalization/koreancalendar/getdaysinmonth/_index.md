...
type: docs
weight: 92
url: /ja/system.globalization/koreancalendar/getdaysinmonth/
---
## KoreanCalendar::GetDaysInMonth(int, int, int) const メソッド
...
指定された年代の指定された年の指定された月の日数。

## KoreanCalendar::GetDaysInMonth(int, int) const メソッド
