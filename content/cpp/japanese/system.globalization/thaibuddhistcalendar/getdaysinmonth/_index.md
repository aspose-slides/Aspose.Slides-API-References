...
description: 特定の月の日数を取得します。
type: docs
weight: 92
url: /ja/system.globalization/thaibuddhistcalendar/getdaysinmonth/
---
## ThaiBuddhistCalendar::GetDaysInMonth(int, int, int) const メソッド
...
指定された年の指定された時代の指定された月の日数。

## ThaiBuddhistCalendar::GetDaysInMonth(int, int) const メソッド
