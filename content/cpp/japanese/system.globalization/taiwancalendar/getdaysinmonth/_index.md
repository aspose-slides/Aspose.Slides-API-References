...
type: docs
weight: 92
url: /ja/system.globalization/taiwancalendar/getdaysinmonth/
---
## TaiwanCalendar::GetDaysInMonth(int, int, int) const メソッド
...
指定された年、指定された元号の指定された月の日数。

## TaiwanCalendar::GetDaysInMonth(int, int) const メソッド
