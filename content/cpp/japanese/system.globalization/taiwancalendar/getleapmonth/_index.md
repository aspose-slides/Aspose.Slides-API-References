...
type: docs
weight: 183
url: /ja/system.globalization/taiwancalendar/getleapmonth/
---
## TaiwanCalendar::GetLeapMonth(int, int) const メソッド
...
指定された時代の指定された年のうるう月、またはその年にうるう月がない場合は 0。

## TaiwanCalendar::GetLeapMonth(int) const メソッド
...
指定された年のうるう月、またはその年にうるう月がない場合は 0。
