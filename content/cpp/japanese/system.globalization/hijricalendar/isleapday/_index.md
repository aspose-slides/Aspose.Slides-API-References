...
description: その日が閏日かどうかを確認します。
type: docs
weight: 144
url: /ja/system.globalization/hijricalendar/isleapday/
---
## HijriCalendar::IsLeapDay(int, int, int, int) const メソッド
...
指定された日付が閏年であれば true、そうでなければ false。

## HijriCalendar::IsLeapDay(int, int, int) const メソッド
