...
description: "HTTP ヘッダーのコレクションです。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。常にこのクラスを System::SmartPtr ポインタでラップし、そのポインタを関数への引数として渡すようにしてください。"
type: docs
weight: 79
url: /ja/system.net.http.headers/httpheaders/
---
## HttpHeaders クラス

HTTP ヘッダーのコレクションです。このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。
...
| メソッド | 説明 |
| --- | --- |
| void [Add](./add/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>) | 新しい名前と値のペアを検証し、現在のコレクションに追加します。 |
| void [Add](./add/)([String](../../system/string/), [String](../../system/string/)) | 新しい名前と値のペアを検証し、現在のコレクションに追加します。 |
| virtual void [AddHeaders](./addheaders/)([System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](./)\>) | 指定された HttpHeaders クラスのインスタンスを現在のインスタンスに連結します。 |
| void [AddParsedValue](./addparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 指定された名前でヘッダーを取得し、解析された値をヘッダーに追加します。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | コレクションの最初の要素（存在する場合）を指すイテレータを取得します。このイテレータは参照オブジェクトを変更するために使用できません。なぜなら [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) は T のコピーオブジェクトを返すからです。 |
...
| void [Clear](./clear/)() | コレクションからすべての項目を削除します。 |
| **bool** [Contains](./contains/)([String](../../system/string/)) |  |
| **bool** [ContainsParsedValue](./containsparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | ヘッダーが指定された値を含むかどうかを確認します。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | コレクションの最後の要素（存在する場合）の直後を指すイテレータを取得します。このイテレータは参照オブジェクトを変更できません。なぜなら [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) は T のコピーオブジェクトを返すからです。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>\>\>\> [GetEnumerator](./getenumerator/)() override | 列挙子を取得します。 |
...
| [String](../../system/string/) [GetHeaderString](./getheaderstring/)([String](../../system/string/)) | 指定されたヘッダー名による値の文字列表現を返します。 |
| [String](../../system/string/) [GetHeaderString](./getheaderstring/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 指定されたヘッダー名による値の文字列表現を返します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[String](../../system/string/), [String](../../system/string/)\>\>\> [GetHeaderStrings](./getheaderstrings/)() | ヘッダー値の文字列表現を含むコレクションを返します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetParsedValues](./getparsedvalues/)([String](../../system/string/)) | 指定されたヘッダー名による解析済み値を返します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\> [GetValues](./getvalues/)([String](../../system/string/)) | 指定された名前に対応する値を返します。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::List](../../system.collections.generic/list/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\>\> [ParsedValuesAsList](./parsedvaluesaslist/)(const [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 解析済み値をリストに変換します。 |
...
| **bool** [Remove](./remove/)([String](../../system/string/)) | 指定された名前で項目の削除を試みます。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 共有参照カウントを指定された値だけ減少させます。 |
| **bool** [RemoveParsedValue](./removeparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 指定された名前でヘッダーを取得し、解析された値をヘッダーから削除します。 |
...
| void [SetOrRemoveParsedValue](./setorremoveparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 指定された名前でヘッダーを取得し、その値を設定または削除します。'value' パラメータが nullptr の場合はヘッダーの値が削除され、そうでなければ解析された値が設定されます。 |
| void [SetParsedValue](./setparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 指定された名前でヘッダーを取得し、解析された値をヘッダーに設定します。 |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | C# の [Object.ToString()](../../system/object/tostring/) メソッドの類似です。カスタムオブジェクトを文字列に変換できるようにします。 |
| **bool** [TryAddWithoutValidation](./tryaddwithoutvalidation/)([String](../../system/string/), [String](../../system/string/)) | 新しい名前と値のペアを現在のコレクションに追加しようとします。 |
| **bool** [TryAddWithoutValidation](./tryaddwithoutvalidation/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>) | 名前と値のペアのコレクションを現在のコレクションに追加します。 |
| **bool** [TryGetValues](./trygetvalues/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>\&) | 指定された名前で対応する値を取得しようとします。 |
| **bool** [TryParseAndAddValue](./tryparseandaddvalue/)([String](../../system/string/), [String](../../system/string/)) | 指定された値を解析し、ヘッダー値に追加しようとします。 |
