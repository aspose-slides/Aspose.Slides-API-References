...
description: XSLT変換の処理中にエラーが発生したときにスローされる例外です。
type: docs
weight: 14
url: /ja/system.xml.xsl/details_xsltexception/
---
## Details_XsltException クラス
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | カスタム例外データを含むディクショナリを返します。 |
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | スタイルシートでエラーが発生した行番号を返します。 |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | スタイルシートでエラーが発生した行位置を返します。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 現在の例外を説明する整形されたエラーメッセージを返します。 |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | スタイルシートのロケーションパスを返します。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | オブジェクトの実際の型を取得します。C# [System.Object.GetType()](../../system/object/gettype/) 呼び出しのアナログです。 |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 特定の例外に割り当てられる符号化された数値である HRESULT を設定します。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) メソッドを実装します。このメソッドは [ExceptionWrapper](../../system/exceptionwrapper/) クラスによって呼び出されます。このクラスは std::exception から継承されていないにも関わらず、派生クラスは protected / private メンバーを使用してロジックを実装できます。このメソッド実装を [ExceptionWrapper](../../system/exceptionwrapper/) に移動すると、そのロジックが壊れる可能性があります。 |
