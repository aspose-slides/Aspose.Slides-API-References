...
description: XSLTスタイルシートでエラーが見つかったときに Load メソッドがスローする例外です。
type: docs
weight: 1
url: /ja/system.xml.xsl/details_xsltcompileexception/
---
## Details_XsltCompileException クラス


XSLTスタイルシートでエラーが見つかったときに **Load** メソッドがスローする例外です。
...
| virtual **int32_t** [get_LineNumber](../details_xsltexception/get_linenumber/)() | スタイルシートでエラーが発生した行番号を返します。 |
| virtual **int32_t** [get_LinePosition](../details_xsltexception/get_lineposition/)() | スタイルシートでエラーが発生した行位置を返します。 |
| [String](../../system/string/) [get_Message](../details_xsltexception/get_message/)() const override | 現在の例外を説明する書式化されたエラーメッセージを返します。 |
| virtual [String](../../system/string/) [get_SourceUri](../details_xsltexception/get_sourceuri/)() | スタイルシートのロケーションパスを返します。 |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 特定の例外に割り当てられたコード化数値である HRESULT を設定します。 |
...
* クラス [Details_XsltException](../details_xsltexception/)
* 名前空間 [System::Xml::Xsl](../)
* ライブラリ [Aspose.Slides](../../)