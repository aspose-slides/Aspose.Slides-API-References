...
description: 実行時にスタイル シートで定義された変数へのインターフェイスを提供します。
type: docs
weight: 40
url: /ja/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable クラス

実行時にスタイル シートで定義された変数へのインターフェイスを提供します。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | 実行時に変数を評価し、変数の値を表すオブジェクトを返します。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部目的専用です。 |
| virtual **bool** [get_IsLocal](./get_islocal/)() | 変数がローカルかどうかを示す値を返します。 |
| virtual **bool** [get_IsParam](./get_isparam/)() | 変数が Extensible Stylesheet Language Transformations (XSLT) パラメータかどうかを示す値を返します。これはスタイルシートまたはテンプレートへのパラメータになる可能性があります。 |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | 変数の XML Path Language ([XPath](../../system.xml.xpath/)) 型を表す XPathResultType を返します。 |
