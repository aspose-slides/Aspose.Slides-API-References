...
description: "XsltArgumentList::XsltMessageEncountered イベントのデータを提供します。"
type: docs
weight: 92
url: /ja/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs クラス


**XsltArgumentList::XsltMessageEncountered** イベントのデータを提供します。
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | **xsl:message** 要素の内容を返します。 |
