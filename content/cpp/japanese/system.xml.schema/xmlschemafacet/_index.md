...
description: 制限によって単純型が派生される際に使用されるすべてのファセットの基底クラスです。
type: docs
weight: 404
url: /ja/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet クラス

単純型が制限によって派生される際に使用されるすべてのファセットの基底クラスです。
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | このファセットが固定であることを示す情報を返します。 |
...
| [String](../../system/string/) [get_Value](./get_value/)() | ファセットの **value** 属性を返します。 |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | このファセットが固定であることを示す情報を設定します。 |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | ファセットの **value** 属性を設定します。 |
...
|  [XmlSchemaFacet](./xmlschemafacet/)() | [XmlSchemaFacet](./) クラスの新しいインスタンスを初期化します。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション違反が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数への引数として使用してください。
