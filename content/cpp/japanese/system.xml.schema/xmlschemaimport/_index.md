...
description: World Wide Web Consortium (W3C) が指定する XML スキーマの import 要素を表します。このクラスは他のスキーマからスキーマコンポーネントをインポートするために使用されます。
type: docs
weight: 482
url: /ja/system.xml.schema/xmlschemaimport/
---
## XmlSchemaImport クラス
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | インポートされたスキーマのターゲット名前空間を Uniform Resource Identifier (URI) 参照として返します。 |
...
| [String](../../system/string/) [get_SchemaLocation](../xmlschemaexternal/get_schemalocation/)() | スキーマの Uniform Resource Identifier (URI) の位置を返します。これはスキーマプロセッサにスキーマが物理的に存在する場所を示します。 |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | スキーマを読み込んだファイルのソース位置を返します。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaexternal/get_unhandledattributes/)() | スキーマのターゲット名前空間に属さない限定属性を返します。 |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | インポートされたスキーマのターゲット名前空間を Uniform Resource Identifier (URI) 参照として設定します。 |
...
| void [set_SchemaLocation](../xmlschemaexternal/set_schemalocation/)(const [String](../../system/string/)\&) | スキーマの Uniform Resource Identifier (URI) の位置を設定します。これはスキーマプロセッサにスキーマが物理的に存在する場所を示します。 |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | スキーマを読み込んだファイルのソース位置を設定します。 |
| void [set_UnhandledAttributes](../xmlschemaexternal/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | スキーマのターゲット名前空間に属さない限定属性を設定します。 |
