...
description: 検証対象の XML ドキュメントで XML スキーマ定義言語 (XSD) スキーマの検証エラーおよび警告が検出されたときにスローされる例外を表します。
type: docs
weight: 27
url: /ja/system.xml.schema/details_xmlschemavalidationexception/
---
## Details_XmlSchemaValidationException クラス


検証中の XML ドキュメントで XML [Schema](../) 定義言語 (XSD) スキーマの検証エラーおよび警告が検出されたときにスローされる例外を表します。
...
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | エラーが発生した行位置を返します。 |
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | この例外のエラー状態の説明を返します。 |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | この XmlSchemaValidationException を引き起こした XML ノードを返します。 |
...
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | 例外を引き起こしたスキーマの Uniform Resource Identifier (URI) の場所を返します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文に相当するロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) ガードオブジェクトを使用してください。 |
