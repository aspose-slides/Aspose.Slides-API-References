...
description: World Wide Web Consortium (W3C) が定義した XML Schema の group 要素を表します。このクラスは、複合型から参照されるスキーマレベルでのグループを定義します。要素宣言の集合をグループ化し、複合型定義にグループとして組み込むことができます。
type: docs
weight: 430
url: /ja/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup クラス


XML [Schema](../) の **group** 要素を、World Wide [Web](../../system.web/) Consortium (W3C) が定義した通りに表します。このクラスは **schema** レベルでグループを定義し、複合型から参照されます。要素宣言の集合をグループ化し、複合型定義にグループとして組み込むことができます。
