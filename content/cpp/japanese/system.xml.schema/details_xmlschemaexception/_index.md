...
description: スキーマ例外に関する詳細情報を返します。
type: docs
weight: 1
url: /ja/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException クラス
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | エラーが発生した行番号を返します。 |
| **int32_t** [get_LinePosition](./get_lineposition/)() | エラーが発生した位置（行内の文字位置）を返します。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | この例外のエラー状態の説明を返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | XmlSchemaException を生成した **[XmlSchemaObject](../xmlschemaobject/)** を返します。 |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 例外の原因となったスキーマの統一リソース識別子（URI）位置を返します。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | オブジェクトの実際の型を取得します。C# の [System.Object.GetType()](../../system/object/gettype/) 呼び出しの類似です。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) メソッドを実装します。このメソッドは [ExceptionWrapper](../../system/exceptionwrapper/) クラスから呼び出されます。このクラスは std::exception から継承されていないにもかかわらず、派生クラスは保護/プライベートメンバーを使用してロジックを実装できます。このメソッド実装を [ExceptionWrapper](../../system/exceptionwrapper/) に移すと、そのロジックが壊れる可能性があります。 |
