...
description: XmlSchemaObjectCollection の列挙子を表します。
type: docs
weight: 703
url: /ja/system.xml.schema/xmlschemaobjectenumerator/
---
...
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaObject](../xmlschemaobject/)\>\> * [CloneIterator](./cloneiterator/)() const override | 現在のイテレータをクローンします。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくないが、C# スタイルで NaN 同士を等しいとみなす浮動小数点比較をエミュレートします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくないが、C# スタイルで NaN 同士を等しいとみなす浮動小数点比較をエミュレートします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部使用のみです。 |
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\& [get_Current](./get_current/)() const override | コレクション内の現在の [XmlSchemaObject](../xmlschemaobject/) を返します。 |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 最初の [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼び出しを行い、VirtualizedIterator で使用できるよう列挙子オブジェクトを準備します。 |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | VirtualizedIterator が所有する列挙子にマークを付けます。 |
...
| **bool** [MoveNext](./movenext/)() override | コレクション内の次の項目へ移動します。 |
...
| void [Reset](./reset/)() override | 列挙子をコレクションの先頭にリセットします。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション違反が発生する可能性があります。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数への引数として渡すようにしてください。
