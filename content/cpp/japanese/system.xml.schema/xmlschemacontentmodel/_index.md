...
description: 型の子要素の順序と構造を指定します。
type: docs
weight: 326
url: /ja/system.xml.schema/xmlschemacontentmodel/
---
## XmlSchemaContentModel クラス
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によると NaN は任意の値（NaN 自身を含む）と等しくないにもかかわらず、2 つの NaN が等しいとみなされる C# スタイルの浮動小数点比較をエミュレートします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によると NaN は任意の値（NaN 自身を含む）と等しくないにもかかわらず、2 つの NaN が等しいとみなされる C# スタイルの浮動小数点比較をエミュレートします。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() | 型の内容を返します。 |
...
| virtual void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) | 型のコンテンツを設定します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のロック解除機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティリーオブジェクトを使用してください。 |
