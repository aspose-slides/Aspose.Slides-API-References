...
description: World Wide Web Consortium (W3C) が指定する XML スキーマの complexContent 要素を表します。このクラスは複合型の複合コンテンツモデルを表します。要素のみ、または混在コンテンツを持つ複合型に対する拡張または制限を含みます。
type: docs
weight: 261
url: /ja/system.xml.schema/xmlschemacomplexcontent/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | コンテンツを返します。 |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | 文字列 ID を返します。 |
| **bool** [get_IsMixed](./get_ismixed/)() | 型が混合コンテンツモデルを持つかどうかを示す情報を返します。 |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | コンテンツを設定します。 |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | 文字列 ID を設定します。 |
| void [set_IsMixed](./set_ismixed/)(**bool**) | 型が混合コンテンツモデルを持つかどうかを示す情報を設定します。 |
...
* クラス [XmlSchemaContentModel](../xmlschemacontentmodel/)
