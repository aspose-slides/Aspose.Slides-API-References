...
description: XML スキーマで定義された単純コンテンツの restriction 要素を表します (World Wide Web Consortium (W3C) によって指定)。このクラスは restriction によって単純型を派生させるために使用できます。そのような派生は、要素の値の範囲を継承された単純型で指定された値のサブセットに制限するために使用できます。
type: docs
weight: 820
url: /ja/system.xml.schema/xmlschemasimplecontentrestriction/
---
## XmlSchemaSimpleContentRestriction クラス

XML [Schema](../) からの単純コンテンツ用 **制限** 要素を、World Wide [Web](../../system.web/) Consortium (W3C) の仕様に従って表します。このクラスは制限によって単純型を派生させるために使用できます。そのような派生は、要素の値の範囲を継承された単純型で指定された値のサブセットに制限するために使用できます。
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) を属性値に使用できる形で返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | [XmlSchemaAttribute](../xmlschemaattribute/) と [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) の属性コレクションを返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | 単純型の基本値を返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | この型が派生した組み込みデータ型または単純型の名前を返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | [Xml](../../system.xml/)[Schema](../) ファセットを返します。 |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | 属性値に使用する [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) を設定します。 |
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | 単純型の基本値を設定します。 |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | この型が派生した組み込みデータ型または単純型の名前を設定します。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうしないと実行時エラーやアサーション障害が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数への引数として使用してください。
