...
description: XmlSchema クラスに含まれる要素のコレクションを提供します（例: Attributes、AttributeGroups、Elements など）。
type: docs
weight: 716
url: /ja/system.xml.schema/xmlschemaobjecttable/
---
## XmlSchemaObjectTable クラス


[XmlSchema](../xmlschema/) クラスに含まれる要素のコレクションを提供します（例: Attributes、AttributeGroups、Elements など）。
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 指定された修飾名がコレクションに存在するかどうかを判定します。 |
...
| **int32_t** [get_Count](./get_count/)() | [XmlSchemaObjectTable](./) に含まれる項目数を返します。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\> [get_Names](./get_names/)() | [XmlSchemaObjectTable](./) のすべての名前付き要素のコレクションを返します。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [get_Values](./get_values/)() | [XmlSchemaObjectTable](./) のすべての要素のすべての値のコレクションを返します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\>\> [GetEnumerator](./getenumerator/)() override | [XmlSchemaObjectTable](./) を反復できる列挙子を返します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 修飾名で指定された [XmlSchemaObjectTable](./) の要素を返します。 |
...
[System::MakeObject()](../../system/makeobject/) 関数を使用してのみこのクラスのオブジェクトを割り当てるべきです。スタック上や operator new を用いてこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数の引数として渡してください。 
