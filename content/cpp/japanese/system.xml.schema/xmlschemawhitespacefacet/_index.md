...
description: World Wide Web Consortium (W3C) の whiteSpace ファセットを表します。
type: docs
weight: 950
url: /ja/system.xml.schema/xmlschemawhitespacefacet/
---
## XmlSchemaWhiteSpaceFacet クラス

World Wide [Web](../../system.web/) コンソーシアム (W3C) の **whiteSpace** ファセットを表します。
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | このファセットが固定であることを示す情報を返します。 |
...
| void [Lock](../../system/object/lock/)() | C# lock() 文のロック機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティリオブジェクトを使用してください。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のロック解除機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティリオブジェクトを使用してください。 |
...
|  [XmlSchemaWhiteSpaceFacet](./xmlschemawhitespacefacet/)() | [XmlSchemaWhiteSpaceFacet](./) クラスの新しいインスタンスを初期化します。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成してはいけません。そうすると実行時エラーやアサーション障害が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数への引数として使用してください。 
