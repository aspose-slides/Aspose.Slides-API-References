...
description: XML スキーマからの minInclusive 要素を、World Wide Web Consortium (W3C) が指定する通りに表します。このクラスは simpleType 要素の最小値に対する制限を指定するために使用できます。要素の値は minInclusive 要素の値以上でなければなりません。
type: docs
weight: 625
url: /ja/system.xml.schema/xmlschemamininclusivefacet/
---
## XmlSchemaMinInclusiveFacet クラス
...
|  [XmlSchemaMinInclusiveFacet](./xmlschemamininclusivefacet/)() | [XmlSchemaMinInclusiveFacet](./) クラスの新しいインスタンスを初期化します。 |
