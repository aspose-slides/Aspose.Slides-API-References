...
description: Excel ワークブック内の単一のセルを表します。
type: docs
weight: 1
...
| **int32_t** [get_Column](./get_column/)() override | セルが配置されているワークシートの列のゼロベースインデックスを取得します。読み取り専用 **int32_t**。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | チャートデータセルの名前を取得します。 |
| **int32_t** [get_Row](./get_row/)() override | セルが配置されているワークシートの行のゼロベースインデックスを取得します。読み取り専用 **int32_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | [Excel](../) セルに含まれる値を取得します。 |
