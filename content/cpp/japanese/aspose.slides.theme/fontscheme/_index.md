...
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() override | スライドの「heading」部分のフォントコレクションを返します。読み取り専用 [IFonts](../../aspose.slides/ifonts/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() override | スライドの「body」部分のフォントコレクションを返します。読み取り専用 [IFonts](../../aspose.slides/ifonts/)。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | フォントスキーム名を返します。読み取り [System::String](../../system/string/)。 |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | フォントスキーム名を返します。書き込み [System::String](../../system/string/)。 |
