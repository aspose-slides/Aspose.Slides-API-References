...
description: 効果的な塗りつぶし形式の読み取り専用コレクションを表す不変オブジェクトです。
type: docs
weight: 261
url: /ja/aspose.slides.theme/ifillformatcollectioneffectivedata/
---
## IFillFormatCollectionEffectiveData クラス

効果的な塗りつぶし形式の読み取り専用コレクションを表す不変オブジェクトです。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスの要素を取得します。読み取り専用 [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)。 |
