...
description: ノートスライドテーマへのアクセスを提供します。
type: docs
weight: 534
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/) が継承された有効なテーマをオーバーライドしているかどうかを判断します。オーバーライドを有効にするには OverrideTheme.Init*() メソッドを使用して [OverrideTheme](../overridetheme/) を有効にします。オーバーライドを無効にするには [OverrideTheme::Clear](../overridetheme/clear/) メソッドを使用して [OverrideTheme](../overridetheme/) を無効にします。読み取り専用の **bool**。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() ステートメントのロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリー オブジェクトを使用します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() ステートメントのロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリー オブジェクトを使用します。 |
