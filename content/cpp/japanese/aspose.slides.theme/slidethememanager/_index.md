...
description: スライドテーマの上書きへのアクセスを提供します。
type: docs
weight: 560
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/) が継承された有効なテーマを上書きするかどうかを判断します。上書きを有効にするには [OverrideTheme](../overridetheme/) を使用し、OverrideTheme.Init*() メソッドを使用してください。上書きを無効にするには [OverrideTheme](../overridetheme/) を使用し、[OverrideTheme::Clear](../overridetheme/clear/) メソッドを使用してください。読み取り専用 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | 上書きされたテーマオブジェクトを返します。[IOverrideTheme](../ioverridetheme/) を参照してください。 |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | 上書きされたテーマオブジェクトを返します。[IOverrideTheme](../ioverridetheme/) に書き込みます。 |
