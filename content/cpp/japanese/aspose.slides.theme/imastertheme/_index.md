...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | 指定されたインデックスの追加カラースキームを返します。このスキームはプレゼンテーションの外観に影響せず、スライドのメインカラースキームとして選択できます。読み取り専用 [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | 追加カラースキームのコレクションを返します。これらのスキームはプレゼンテーションの外観に影響せず、スライドのメインカラースキームとして選択できます。読み取り専用 [IExtraColorSchemeCollection](../iextracolorschemecollection/)。 |
...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | テーマの名前を返します。読み取り [System::String](../../system/string/)。 |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | テーマの名前を取得します。書き込み [System::String](../../system/string/)。 |
