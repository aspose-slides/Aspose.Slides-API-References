...
description: 有効なフォントスキームプロパティを含む不変オブジェクトです。
type: docs
weight: 287
url: /ja/aspose.slides.theme/ifontschemeeffectivedata/
---
## IFontSchemeEffectiveData クラス

有効なフォントスキームプロパティを含む不変オブジェクトです。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Major](./get_major/)() | スライドの「heading」部分のフォントコレクションを返します。読み取り専用 [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Minor](./get_minor/)() | スライドの「body」部分のフォントコレクションを返します。読み取り専用 [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | フォントスキームの名前を返します。読み取り専用 [System::String](../../system/string/)。 |
