...
description: 有効な効果スタイルの読み取り専用コレクションを表す不変オブジェクトです。
type: docs
weight: 196
url: /ja/aspose.slides.theme/ieffectstylecollectioneffectivedata/
---
## IEffectStyleCollectionEffectiveData クラス

有効な効果スタイルの読み取り専用コレクションを表す不変オブジェクトです。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleEffectiveData](../ieffectstyleeffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスの要素を取得します。読み取り専用 [IEffectStyleEffectiveData](../ieffectstyleeffectivedata/)。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンス内に要素が存在するか、条件を満たす要素があるかどうかを判定します。 |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | シーケンスが指定された値を含んでいるかどうかを判定します。 |
