...
description: 有効なテーマプロパティを含む不変オブジェクトです。
type: docs
weight: 456
url: /ja/aspose.slides.theme/ithemeeffectivedata/
---
## IThemeEffectiveData クラス

有効なテーマプロパティを含む不変オブジェクトです。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSchemeEffectiveData](../ifontschemeeffectivedata/)\> [get_FontScheme](./get_fontscheme/)() | フォントスキームを返します。読み取り専用 [IFontSchemeEffectiveData](../ifontschemeeffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatSchemeEffectiveData](../iformatschemeeffectivedata/)\> [get_FormatScheme](./get_formatscheme/)() | シェイプフォーマットスキームを返します。読み取り専用 [IFormatSchemeEffectiveData](../iformatschemeeffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorSchemeEffectiveData](../icolorschemeeffectivedata/)\> [GetColorScheme](./getcolorscheme/)([System::Drawing::Color](../../system.drawing/color/)) | カラースキームを返します。 |
...
このインターフェイスは、[ITheme](../itheme/) インターフェイスと組み合わせて使用され、継承が適用された有効なフォーマット値を返します。
