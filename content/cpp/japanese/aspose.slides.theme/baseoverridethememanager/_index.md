...
| Method | Description |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | スライドに追加のカラースキームを適用します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | テーマオブジェクトを返します。 |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/) が継承された有効なテーマをオーバーライドするかどうかを判定します。オーバーライド用に [OverrideTheme](../overridetheme/) を有効にするには OverrideTheme.Init*() メソッドを使用します。[OverrideTheme](../overridetheme/) のオーバーライドを無効にするには [OverrideTheme::Clear](../overridetheme/clear/) メソッドを使用します。読み取り専用 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | オーバーライドされたテーマオブジェクトを返します。[IOverrideTheme](../ioverridetheme/) を読み取ります。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文によるロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティリオブジェクトを使用してください。 |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | オーバーライドされたテーマオブジェクトを返します。[IOverrideTheme](../ioverridetheme/) に書き込みます。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文によるロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティリオブジェクトを使用してください。 |
...
* クラス [IOverrideThemeManager](../ioverridethememanager/)
