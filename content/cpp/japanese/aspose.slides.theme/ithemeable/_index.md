...
description: ITheme でテーマ付けできるオブジェクトを表します。
type: docs
weight: 443
...
[ITheme](../itheme/)でテーマ付けできるオブジェクトを表します。
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() | このテーマ対応オブジェクトの有効なテーマを返します。 |
