...
description: 有効なエフェクトスタイルプロパティを含む不変オブジェクトです。
type: docs
weight: 209
url: /ja/aspose.slides.theme/ieffectstyleeffectivedata/
---
## IEffectStyleEffectiveData クラス
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/)\> [get_EffectFormat](./get_effectformat/)() | エフェクトフォーマットを返します。読み取り専用 [IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/)\> [get_ThreeDFormat](./get_threedformat/)() | 3D フォーマットを返します。読み取り専用 [IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/)。 |
