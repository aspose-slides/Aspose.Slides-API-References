...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() | スライドの「heading」部分のフォントコレクションを返します。読み取り専用 [IFonts](../../aspose.slides/ifonts/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() | スライドの「body」部分のフォントコレクションを返します。読み取り専用 [IFonts](../../aspose.slides/ifonts/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | フォントスキーム名を返します。読み取り [System::String](../../system/string/)。 |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | フォントスキーム名を返します。書き込み [System::String](../../system/string/)。 |
