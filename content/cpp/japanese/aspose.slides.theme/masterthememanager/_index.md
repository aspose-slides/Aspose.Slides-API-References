...
| メソッド | 説明 |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | スライドに余分なカラースキームを適用します。 |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/) が継承された有効なテーマ ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) をオーバーライドするかどうかを判定します。**bool** を読み取ります。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | オーバーライドされたテーマオブジェクトを返します。[IMasterTheme](../imastertheme/) を読み取ります。 |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | [OverrideTheme](../overridetheme/) が継承された有効なテーマ ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) をオーバーライドするかどうかを判定します。**bool** を書き込みます。 |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | オーバーライドされたテーマオブジェクトを返します。[IMasterTheme](../imastertheme/) に書き込みます。 |
...
* クラス [IMasterThemeManager](../imasterthememanager/)
