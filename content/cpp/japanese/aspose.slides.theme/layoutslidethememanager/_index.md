...
| Method | Description |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | スライドに追加のカラースキームを適用します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../baseoverridethememanager/createthemeeffective/)() override | テーマオブジェクトを返します。 |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/) が継承された有効なテーマをオーバーライドするかどうかを判定します。オーバーライドを有効にするには [OverrideTheme](../overridetheme/) を使用し、OverrideTheme.Init*() メソッドを使用してください。オーバーライドを無効にするには [OverrideTheme](../overridetheme/) からのオーバーライドを [OverrideTheme::Clear](../overridetheme/clear/) メソッドで無効にします。読み取り専用 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | オーバーライドされたテーマオブジェクトを返します。[IOverrideTheme](../ioverridetheme/) を参照してください。 |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | オーバーライドされたテーマオブジェクトを返します。[IOverrideTheme](../ioverridetheme/) に書き込みます。 |
