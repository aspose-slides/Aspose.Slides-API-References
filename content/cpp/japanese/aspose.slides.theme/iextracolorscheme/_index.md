...
---
## IExtraColorScheme クラス

スライドに割り当てることができる追加のカラースキームを表します。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 において NaN は任意の値（NaN を含む）と等しくないと規定されているにもかかわらず、2 つの NaN を等しいとみなす C# スタイルの浮動小数点比較をエミュレートします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 において NaN は任意の値（NaN を含む）と等しくないと規定されているにもかかわらず、2 つの NaN を等しいとみなす C# スタイルの浮動小数点比較をエミュレートします。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() | カラースキームを返します。読み取り専用 [IColorScheme](../icolorscheme/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | このスキームの名前を返します。読み取り専用 [System::String](../../system/string/)。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | デクリメントし、共有参照カウントを返します。直接呼び出さず、スマートポインタまたは ThisProtector を使用してください。 |
