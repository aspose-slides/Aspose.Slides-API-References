...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | [TransitionValueBase](../transitionvaluebase/) の 2 つのインスタンスが等しいかどうかを判定します。 |
...
| **uint32_t** [get_Spokes](./get_spokes/)() override | ホイールトランジションのスポーク数です。**uint32_t** を読み取ります。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 特定の型のハッシュ関数として機能し、ハッシュアルゴリズムやハッシュテーブルなどのデータ構造での使用に適しています。 |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | ホイールトランジションのスポーク数です。**uint32_t** に書き込みます。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のロック解除機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティネルオブジェクトを使用します。 |
...
* クラス [IWheelTransition](../iwheeltransition/)
