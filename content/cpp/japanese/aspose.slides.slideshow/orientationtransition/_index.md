...
description: オリエンテーション スライド遷移効果です。
type: docs
weight: 339
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 2つの[TransitionValueBase](../transitionvaluebase/)インスタンスが等しいかどうかを判断します。 |
...
| [Orientation](../../aspose.slides/orientation/) [get_Direction](./get_direction/)() override | 遷移の方向。[Orientation](../../aspose.slides/orientation/) を読み取ります。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタ データ構造を取得します。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 特定の型に対するハッシュ関数として機能し、ハッシュテーブルなどのハッシュアルゴリズムやデータ構造での使用に適しています。 |
...
| void [set_Direction](./set_direction/)([Orientation](../../aspose.slides/orientation/)) override | 遷移の方向。[Orientation](../../aspose.slides/orientation/) に書き込みます。 |
...
* クラス [IOrientationTransition](../iorientationtransition/)
