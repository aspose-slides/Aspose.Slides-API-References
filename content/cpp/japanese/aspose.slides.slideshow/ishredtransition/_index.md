...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 遷移の方向。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) を参照してください。 |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | 遷移中に使用されるビジュアルの形状を指定します。[TransitionShredPattern](../transitionshredpattern/) を参照してください。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 遷移の方向。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) に書き込みます。 |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | 遷移中に使用されるビジュアルの形状を指定します。[TransitionShredPattern](../transitionshredpattern/) に書き込みます。 |
