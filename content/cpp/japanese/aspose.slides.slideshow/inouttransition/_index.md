...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 遷移効果の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) を読み取ります。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | オブジェクトが targetType に記述された型のインスタンスであるかどうかを確認します。C# の 'is' 演算子に相当します。 |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 遷移効果の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) に書き込みます。 |
...
* クラス [IInOutTransition](../iinouttransition/)
