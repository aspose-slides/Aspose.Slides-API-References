...
| **bool** [get_ThroughBlack](./get_throughblack/)() override | 遷移が黒を通してフェードするかどうかを指定します。**bool** を読み取ります。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 特定の型に対するハッシュ関数として機能し、ハッシュアルゴリズムやハッシュテーブルなどのデータ構造で使用できます。 |
...
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | 遷移が黒を通してフェードするかどうかを指定します。**bool** に書き込みます。 |
...
* クラス [IRevealTransition](../irevealtransition/)
