...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 2 つの [TransitionValueBase](../transitionvaluebase/) インスタンスが等しいかどうかを判断します。 |
...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | 遷移の方向。[TransitionSideDirectionType](../transitionsidedirectiontype/) を参照してください。 |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | 遷移中に使用されるビジュアルの形状を指定します。[TransitionPattern](../transitionpattern/) を参照してください。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 特定の型に対するハッシュ関数として機能し、ハッシュアルゴリズムやハッシュテーブルのようなデータ構造で使用できます。 |
...
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | 遷移中に使用されるビジュアルの形状を指定します。[TransitionPattern](../transitionpattern/) に書き込みます。 |
...
* クラス [IGlitterTransition](../iglittertransition/)
