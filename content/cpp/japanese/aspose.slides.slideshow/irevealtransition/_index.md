...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | 遷移の方向。[TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) を参照してください。 |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | 遷移が黒を通ってフェードするかどうかを指定します。**bool** を参照してください。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | 遷移の方向。[TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) に書き込みます。 |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | 遷移が黒を通ってフェードするかどうかを指定します。**bool** に書き込みます。 |
