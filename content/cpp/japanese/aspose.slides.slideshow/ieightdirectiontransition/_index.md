...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN は任意の値（NaN を含む）と等しくないが、2 つの NaN は等しいとみなされます。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部目的専用です。 |
| virtual [TransitionEightDirectionType](../transitioneightdirectiontype/) [get_Direction](./get_direction/)() | 遷移の方向です。[TransitionEightDirectionType](../transitioneightdirectiontype/) を参照してください。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionEightDirectionType](../transitioneightdirectiontype/)) | 遷移の方向です。[TransitionEightDirectionType](../transitioneightdirectiontype/) に書き込みます。 |
