...
description: リップル スライド トランジション効果。
type: docs
weight: 222
url: /ja/aspose.slides.slideshow/irippletransition/
---
## IRippleTransition クラス
...
| virtual [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) [get_Direction](./get_direction/)() | トランジションの方向です。[TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) を読み取ります。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)) | トランジションの方向です。[TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) に書き込みます。 |
