...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | 遷移の方向です。[TransitionSideDirectionType](../transitionsidedirectiontype/) を参照してください。 |
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | 遷移中に使用されるビジュアルの形状を指定します。[TransitionPattern](../transitionpattern/) を参照してください。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | 遷移の方向です。[TransitionSideDirectionType](../transitionsidedirectiontype/) に書き込みます。 |
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | 遷移中に使用されるビジュアルの形状を指定します。[TransitionPattern](../transitionpattern/) に書き込みます。 |
