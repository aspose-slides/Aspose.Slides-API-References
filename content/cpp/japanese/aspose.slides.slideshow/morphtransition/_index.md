...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 2つの [TransitionValueBase](../transitionvaluebase/) インスタンスが等しいかどうかを判定します。 |
...
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | モーフ遷移の型です。[TransitionMorphType](../transitionmorphtype/) を読み取ります。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 特定の型に対するハッシュ関数として機能し、ハッシュアルゴリズムやハッシュテーブルなどのデータ構造での使用に適しています。 |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | モーフ遷移の型です。[TransitionMorphType](../transitionmorphtype/) に書き込みます。 |
...
* クラス [IMorphTransition](../imorphtransition/)
