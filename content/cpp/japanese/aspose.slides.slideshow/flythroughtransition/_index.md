...
| Method | Description |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | [TransitionValueBase](../transitionvaluebase/) の2つのインスタンスが等しいかどうかを判定します。 |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | [Object.Equals](../../system/object/equals/) セマンティクスを使用してオブジェクトを比較します。 |
...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 遷移の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) を読み取ります。 |
| **bool** [get_HasBounce](./get_hasbounce/)() override | 遷移中のスライドの動きにバウンドが含まれることを指定します。**bool** を読み取ります。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタ データ構造を取得します。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 特定の型のハッシュ関数として機能し、ハッシュテーブルなどのハッシュアルゴリズムやデータ構造で使用できます。 |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 遷移の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) に書き込みます。 |
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | 遷移中のスライドの動きにバウンドが含まれることを指定します。**bool** に書き込みます。 |
...
* クラス [IFlyThroughTransition](../iflythroughtransition/)
