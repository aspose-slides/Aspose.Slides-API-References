...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 二つの[TransitionValueBase](../transitionvaluebase/)インスタンスが等しいかどうかを判断します。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 2 つの NaN を等しいとみなす C#-style の浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN はあらゆる値（NaN を含む）と等しくないためです。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 2 つの NaN を等しいとみなす C#-style の浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN はあらゆる値（NaN を含む）と等しくないためです。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部目的専用です。 |
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 遷移分割の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) を参照してください。 |
| [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() override | 遷移分割の向きです。[Slides::Orientation](../../aspose.slides/orientation/) を参照してください。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタデータ構造を取得します。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 特定の型に対するハッシュ関数として機能し、ハッシュテーブルなどのハッシュアルゴリズムやデータ構造で使用できるようにします。 |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 遷移分割の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) に書き込みます。 |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) override | 遷移分割の向きです。[Slides::Orientation](../../aspose.slides/orientation/) に書き込みます。 |
...
* クラス [ISplitTransition](../isplittransition/)
