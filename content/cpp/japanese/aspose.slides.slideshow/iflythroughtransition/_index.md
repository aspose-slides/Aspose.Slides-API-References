...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 遷移の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) を参照してください。 |
| virtual **bool** [get_HasBounce](./get_hasbounce/)() | 遷移中のプレゼンテーションスライドの移動にバウンスが含まれることを指定します。**bool** を参照してください。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 遷移の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) に書き込みます。 |
| virtual void [set_HasBounce](./set_hasbounce/)(**bool**) | 遷移中のプレゼンテーションスライドの移動にバウンスが含まれることを指定します。**bool** に書き込みます。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 共有参照カウンタをデクリメントし、その値を返します。直接呼び出さないでください。代わりにスマートポインタまたは ThisProtector を使用してください。 |
