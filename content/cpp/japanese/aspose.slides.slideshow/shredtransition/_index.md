...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 遷移の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) を参照してください。 |
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | 遷移中に使用されるビジュアルの形状を指定します。[TransitionShredPattern](../transitionshredpattern/) を参照してください。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 特定の型のハッシュ関数として機能し、ハッシュテーブルのようなハッシュアルゴリズムやデータ構造での使用に適しています。 |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 遷移の方向です。[TransitionInOutDirectionType](../transitioninoutdirectiontype/) を書き込みます。 |
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | 遷移中に使用されるビジュアルの形状を指定します。[TransitionShredPattern](../transitionshredpattern/) を書き込みます。 |
...
* クラス [IShredTransition](../ishredtransition/)
