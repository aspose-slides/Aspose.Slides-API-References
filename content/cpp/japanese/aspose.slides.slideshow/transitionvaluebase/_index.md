...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | [TransitionValueBase](./) の2つのインスタンスが等しいかどうかを判断します。 |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | 特定の型に対するハッシュ関数として機能し、ハッシュテーブルなどのハッシュアルゴリズムやデータ構造で使用できるようにします。 |
