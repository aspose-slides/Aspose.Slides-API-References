...
description: 非ジェネリックコレクションインターフェイスを定義します。
type: docs
weight: 40
url: /ja/system.collections/icollection/
---
## ICollection クラス

非ジェネリックコレクションインターフェイスを定義します。
...
| virtual int [get_Count](./get_count/)() const | コレクション内の要素数を取得します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタデータ構造を取得します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | コレクションを反復処理する列挙子を返します。 |
