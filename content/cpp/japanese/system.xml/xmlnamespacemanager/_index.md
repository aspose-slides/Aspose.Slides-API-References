...
description: コレクションに名前空間を解決、追加、削除し、これらの名前空間のスコープ管理を提供します。
type: docs
weight: 300
url: /ja/system.xml/xmlnamespacemanager/
---
...
| メソッド | 説明 |
| --- | --- |
| virtual void [AddNamespace](./addnamespace/)([String](../../system/string/), [String](../../system/string/)) | 指定された名前空間をコレクションに追加します。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくないですが、C# スタイルの浮動小数点比較をエミュレートし、2つの NaN を等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくないですが、C# スタイルの浮動小数点比較をエミュレートし、2つの NaN を等しいとみなします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部目的のみに使用されます。 |
| virtual [String](../../system/string/) [get_DefaultNamespace](./get_defaultnamespace/)() | デフォルト名前空間の名前空間 URI を返します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\> [get_NameTable](./get_nametable/)() | このオブジェクトに関連付けられた [XmlNameTable](../xmlnametable/) を返します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | [XmlNamespaceManager](./) 内の名前空間を反復処理するための列挙子を返します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) override | プレフィックスでキー付けされた名前空間名のコレクションを返し、現在スコープ内の名前空間を列挙するために使用できます。 |
...
| virtual **bool** [HasNamespace](./hasnamespace/)([String](../../system/string/)) | 指定されたプレフィックスに対し、現在のプッシュされたスコープで名前空間が定義されているかどうかを示す値を返します。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンスに要素が存在するか、または条件を満たす要素があるかを判定します。 |
...
| [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) override | 指定されたプレフィックスの名前空間 URI を返します。 |
| [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) override | 指定された名前空間 URI に対して宣言されたプレフィックスを検索します。 |
...
| virtual **bool** [PopScope](./popscope/)() | スタックから名前空間スコープをポップします。 |
| virtual void [PushScope](./pushscope/)() | スタックに名前空間スコープをプッシュします。 |
...
| virtual void [RemoveNamespace](./removenamespace/)([String](../../system/string/), [String](../../system/string/)) | 指定されたプレフィックスに対する名前空間を削除します。 |
...
|  [XmlNamespaceManager](./xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | [XmlNamespaceManager](./) クラスの新しいインスタンスを、指定された [XmlNameTable](../xmlnametable/) で初期化します。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使ってこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション障害が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数への引数として使用してください。
