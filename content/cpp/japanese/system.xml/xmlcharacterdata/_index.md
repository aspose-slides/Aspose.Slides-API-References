...
description: 複数のクラスで使用されるテキスト操作メソッドを提供します。
type: docs
weight: 118
url: /ja/system.xml/xmlcharacterdata/
---
## XmlCharacterData クラス
...
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | 指定された文字列をノードの文字データの末尾に追加します。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | コレクションの最初の要素（存在する場合）を指すイテレータを取得します。このイテレータは [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) が T のコピーオブジェクトを返すため、参照されたオブジェクトを変更するためには使用できません。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | 派生クラスでオーバーライドされた場合にノードの複製を作成します。 |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | ノードから文字の範囲を削除します。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | コレクションの最後の要素（存在する場合）の直後を指すイテレータを取得します。このイテレータは [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) が T のコピーオブジェクトを返すため、参照されたオブジェクトを変更するためには使用できません。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | const 修飾インスタンスのコレクションにおける最後の要素（存在する場合）の直後を指すイテレータを取得します。 |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | ノードのデータを返します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | ノードの最初の子ノードを返します。 |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | このノードに子ノードが存在するかどうかを示す値を返します。 |
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | ノードとそのすべての子ノードの連結された値を返します。 |
...
| virtual **int32_t** [get_Length](./get_length/)() | データの長さ（文字数）を返します。 |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | 派生クラスでオーバーライドされた場合に、ノードのローカル名を返します。 |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | 派生クラスでオーバーライドされた場合に、ノードの完全修飾名を返します。 |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | 派生クラスでオーバーライドされた場合に、現在のノードのタイプを返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | このノードの直前のテキストノードを返します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | スキーマ検証の結果としてこのノードに割り当てられた、スキーマ検証後の情報セットを返します。 |
| [String](../../system/string/) [get_Value](./get_value/)() override | ノードの値を返します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | 現在のノードの子ノードを列挙するイテレータを返します。 |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | 指定された文字オフセット位置に指定された文字列を挿入します。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンスに要素が存在するか、または条件を満たす要素があるかどうかを判定します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロック機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチリーオブジェクトを使用してください。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | この [XmlNode](../xmlnode/) の下位ツリー全深度にあるすべての [XmlText](../xmltext/) ノードを、マークアップ（タグ、コメント、処理指示、CDATA セクション、エンティティ参照）のみが [XmlText](../xmltext/) ノードを分離し、隣接する [XmlText](../xmltext/) ノードがない「通常」形にします。 |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | 指定されたオフセットから指定された文字数を、指定された文字列で置き換えます。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 式に一致する最初の [XmlNode](../xmlnode/) を選択します。[XPath](../../system.xml.xpath/) 式で見つかったすべてのプレフィックスは、提供された [XmlNamespaceManager](../xmlnamespacemanager/) を使用して解決されます。 |
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | ノードのデータを設定します。 |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | ノードとそのすべての子ノードの連結された値を設定します。 |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | 指定された範囲から完全な文字列のサブストリングを取得します。 |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 派生クラスでオーバーライドされた場合に、ノードのすべての子ノードを指定された [XmlWriter](../xmlwriter/) に保存します。 |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 派生クラスでオーバーライドされた場合に、現在のノードを指定された [XmlWriter](../xmlwriter/) に保存します。 |
