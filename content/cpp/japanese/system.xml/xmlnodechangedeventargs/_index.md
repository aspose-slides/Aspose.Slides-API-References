...
description: "XmlDocument::NodeChanged、XmlDocument::NodeChanging、XmlDocument::NodeInserted、XmlDocument::NodeInserting、XmlDocument::NodeRemoved、XmlDocument::NodeRemoving イベントのデータを提供します。"
type: docs
weight: 339
url: /ja/system.xml/xmlnodechangedeventargs/
---
## XmlNodeChangedEventArgs クラス

次のイベント **XmlDocument::NodeChanged**、**XmlDocument::NodeChanging**、**XmlDocument::NodeInserted**、**XmlDocument::NodeInserting**、**XmlDocument::NodeRemoved** および **XmlDocument::NodeRemoving** に関するデータを提供します。
...
| [XmlNodeChangedAction](../xmlnodechangedaction/) [get_Action](./get_action/)() | ノード変更イベントの種類を示す値を返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NewParent](./get_newparent/)() | 操作完了後の [XmlNode::get_ParentNode](../xmlnode/get_parentnode/) の値を返します。 |
| [String](../../system/string/) [get_NewValue](./get_newvalue/)() | ノードの新しい値を返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_Node](./get_node/)() | 追加、削除、または変更される [XmlNode](../xmlnode/) を返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_OldParent](./get_oldparent/)() | 操作開始前の [XmlNode::get_ParentNode](../xmlnode/get_parentnode/) の値を返します。 |
| [String](../../system/string/) [get_OldValue](./get_oldvalue/)() | ノードの元の値を返します。 |
...
このクラスのオブジェクトは、[System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。実行時エラーやアサーション違反が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを引数として関数に渡してください。 
