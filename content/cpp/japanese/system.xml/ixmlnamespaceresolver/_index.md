...
description: プレフィックスと名前空間のマッピングのセットへの読み取り専用アクセスを提供します。
type: docs
weight: 53
url: /ja/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver クラス
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) | 現在のスコープにある定義済みのプレフィックス-名前空間マッピングのコレクションを返します。 |
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | 指定されたプレフィックスにマップされた名前空間 URI を返します。 |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | 指定された名前空間 URI にマップされたプレフィックスを返します。 |
