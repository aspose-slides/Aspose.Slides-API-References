...
description: ツリー挿入操作に便利な軽量オブジェクトを表します。
type: docs
weight: 196
url: /ja/system.xml/xmldocumentfragment/
---
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 に従うと NaN は任意の値（NaN を含む）と等しくありませんが、ここでは 2 つの NaN を等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 に従うと NaN は任意の値（NaN を含む）と等しくありませんが、ここでは 2 つの NaN を等しいとみなします。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | このノードに続くノードを返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | スキーマ検証の結果、このノードに割り当てられたスキーマ検証後の情報セットを返します。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | [XmlNode](../xmlnode/) の下位サブツリー全深さにあるすべての [XmlText](../xmltext/) ノードを、マークアップ（タグ、コメント、処理命令、CDATA セクション、エンティティ参照）のみで [XmlText](../xmltext/) ノードを区切る「通常」形に変換します。つまり、隣接する [XmlText](../xmltext/) ノードは存在しません。 |
