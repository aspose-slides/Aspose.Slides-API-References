...
description: XML 宣言ノード <?xml version='1.0'...?> を表します。
type: docs
weight: 170
url: /ja/system.xml/xmldeclaration/
---
## XmlDeclaration クラス
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | このノードのコピーを作成します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | このノードのコピーを作成します。 |
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | XML ドキュメントのエンコーディングレベルを返します。 |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | [XmlDeclaration](./) の連結された値を返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | スキーマ検証の結果としてこのノードに割り当てられた、検証後の情報セットを返します。 |
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | standalone 属性の値を返します。 |
| [String](../../system/string/) [get_Value](./get_value/)() override | [XmlDeclaration](./) の値を返します。 |
| [String](../../system/string/) [get_Version](./get_version/)() | ドキュメントの XML バージョンを返します。 |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 現在のノードのスコープ内で指定されたプレフィックスに最も近い **xmlns** 宣言を探し、宣言に含まれる名前空間 URI を返します。 |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | 現在のノードのスコープ内で指定された名前空間 URI に最も近い **xmlns** 宣言を探し、その宣言で定義されたプレフィックスを返します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector で選択されたキー値に基づき、シーケンスの要素を昇順に並べ替えます。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector で選択されたキー値に基づき、シーケンスの要素を降順に並べ替えます。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Reverse](../../system.collections.generic/ienumerable/linq_reverse/)() | シーケンスの要素順序を逆にします。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | この [XmlNode](../xmlnode/) の下位ツリー全深度にあるすべての [XmlText](../xmltext/) ノードを、マークアップ（タグ、コメント、処理命令、CDATA セクション、エンティティ参照）のみで [XmlText](../xmltext/) ノードを区切る「通常」形に変換し、隣接する [XmlText](../xmltext/) ノードが存在しないようにします。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 式に一致する最初の [XmlNode](../xmlnode/) を選択します。[XPath](../../system.xml.xpath/) 式で見つかった任意のプレフィックスは、提供された [XmlNamespaceManager](../xmlnamespacemanager/) を使用して解決されます。 |
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | XML ドキュメントのエンコーディングレベルを設定します。 |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | [XmlDeclaration](./) の連結された値を設定します。 |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | standalone 属性の値を設定します。 |
| void [set_Value](./set_value/)([String](../../system/string/)) override | [XmlDeclaration](./) の値を設定します。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | ノードの子ノードを指定された [XmlWriter](../xmlwriter/) に保存します。[XmlDeclaration](./) ノードは子ノードを持たないため、このメソッドは何も行いません。 |
