...
description: 最後の例外に関する詳細情報を返します。
type: docs
weight: 1
url: /ja/system.xml/details_xmlexception/
---
## Details_XmlException クラス
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | エラーが発生した位置を示す行番号を返します。行番号は 1 から始まります。 |
| **int32_t** [get_LinePosition](./get_lineposition/)() | エラーが発生した位置を示す列位置を返します。列位置は 1 から始まります。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 現在の例外を説明するメッセージを返します。 |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | XML ファイルの場所を返します。 |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | スタックトレースを含む文字列を返します。 |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | 最内層の例外を表す Exception オブジェクトのコピーを返します。 |
...
| void [Lock](../../system/object/lock/)() | C# lock() ステートメントのロック機構を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリーオブジェクトを使用してください。 |
