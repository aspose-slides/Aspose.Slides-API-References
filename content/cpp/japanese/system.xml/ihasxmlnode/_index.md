...
description: クラスが現在のコンテキストまたは位置から XmlNode を返すことを可能にします。
type: docs
weight: 27
url: /ja/system.xml/ihasxmlnode/
---
## IHasXmlNode クラス


クラスが現在のコンテキストまたは位置から [XmlNode](../xmlnode/) を返すことを可能にします。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | 現在の位置に対する [XmlNode](../xmlnode/) を返します。 |
