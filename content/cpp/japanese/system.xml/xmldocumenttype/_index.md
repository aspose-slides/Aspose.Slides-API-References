...
description: 文書型宣言を表します。
type: docs
weight: 209
url: /ja/system.xml/xmldocumenttype/
---
## XmlDocumentType クラス
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Entities](./get_entities/)() | [XmlEntity](../xmlentity/) ノードのコレクション（文書型宣言で宣言された）を返します。 |
...
| [String](../../system/string/) [get_InternalSubset](./get_internalsubset/)() | DOCTYPE 宣言上の文書型定義（DTD）内部サブセットの値を返します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Notations](./get_notations/)() | 文書型宣言に存在する [XmlNotation](../xmlnotation/) ノードのコレクションを返します。 |
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | このノードとすべての子ノードを含むマークアップを返します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](../xmlnode/get_ownerdocument/)() | このノードが所属する [XmlDocument](../xmldocument/) を返します。 |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | DOCTYPE 宣言上のパブリック識別子の値を返します。 |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | DOCTYPE 宣言上のシステム識別子の値を返します。 |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 現在のノードのスコープにある、指定されたプレフィックスに最も近い **xmlns** 宣言を検索し、その宣言にある名前空間 URI を返します。 |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | 現在のノードのスコープにある、指定された名前空間 URI に最も近い **xmlns** 宣言を検索し、その宣言で定義されたプレフィックスを返します。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | この [XmlNode](../xmlnode/) の下位サブツリー全体の深さにあるすべての [XmlText](../xmltext/) ノードを、マークアップ（タグ、コメント、処理命令、CDATA セクション、エンティティ参照）のみで [XmlText](../xmltext/) ノードを区切る「通常」な形に変換します。つまり、隣接する [XmlText](../xmltext/) ノードは存在しません。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | ノードのすべての子を指定された [XmlWriter](../xmlwriter/) に保存します。[XmlDocumentType](./) ノードの場合、このメソッドは効果がありません。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数への引数として渡すようにしてください。
