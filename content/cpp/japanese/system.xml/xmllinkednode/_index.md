...
description: このノードの直前または直後のノードを返します。
type: docs
weight: 274
url: /ja/system.xml/xmllinkednode/
---
## XmlLinkedNode クラス


このノードの直前または直後のノードを返します。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | 派生クラスでオーバーライドされた場合に、ノードの複製を作成します。 |
...
| virtual [String](../../system/string/) [get_BaseURI](../xmlnode/get_baseuri/)() | 現在のノードの基本 URI を返します。 |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | このノードが子ノードを持つかどうかを示す値を返します。 |
...
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | 派生クラスでオーバーライドされた場合、ノードのローカル名を返します。 |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | 派生クラスでオーバーライドされた場合、ノードの修飾名を返します。 |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | 派生クラスでオーバーライドされた場合、現在のノードのタイプを返します。 |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 現在のノードのスコープ内で、指定されたプレフィックスに最も近い **xmlns** 宣言を検索し、その宣言に含まれる名前空間 URI を返します。 |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | 現在のノードのスコープ内で、指定された名前空間 URI に最も近い **xmlns** 宣言を検索し、その宣言で定義されたプレフィックスを返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | 指定された [XmlNode::get_LocalName](../xmlnode/get_localname/) および [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) の値を持つ最初の子要素を返します。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンス内の任意の要素が存在するか、条件を満たすかどうかを判定します。 |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 汎用シーケンスの各要素に変換関数を適用し、得られた最大値を返します。 |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 汎用シーケンスの各要素に変換関数を適用し、得られた最小値を返します。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | この [XmlNode](../xmlnode/) の下位ツリー全体の [XmlText](../xmltext/) ノードを、[XmlText](../xmltext/) ノード間にタグ、コメント、処理指示、CDATA セクション、エンティティ参照だけが存在する「通常」形式に変換します。つまり、隣接する [XmlText](../xmltext/) ノードはなくなります。 |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | ノードとすべての子ノードの連結された値を設定します。 |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | このノードの子ノードだけを表すマークアップを設定します。 |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 派生クラスでオーバーライドされた場合、ノードのすべての子ノードを指定された [XmlWriter](../xmlwriter/) に保存します。 |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 派生クラスでオーバーライドされた場合、現在のノードを指定された [XmlWriter](../xmlwriter/) に保存します。 |
