...
description: ノードの順序付きコレクションを表します。
type: docs
weight: 352
url: /ja/system.xml/xmlnodelist/
---
## XmlNodeList クラス
...
| virtual **int32_t** [get_Count](./get_count/)() | [XmlNodeList](./) のノード数を返します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](./getenumerator/)() | [XmlNodeList](./) のノードコレクションのイテレーションをサポートします。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスのノードを返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](./item/)(**int32_t**) | 指定されたインデックスのノードを取得します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | 各要素のインデックスを組み込んで、シーケンスの各要素を新しい形に変換します。 |
