...
description: 要素または属性のテキストコンテンツを表します。
type: docs
weight: 495
url: /ja/system.xml/xmltext/
---
## XmlText クラス
...
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | このノードの子ノードだけを表すマークアップを返します。 |
...
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | データの文字数長さを返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | このノードに直後のノードを返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | このノードに直前のノードを返します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](./get_previoustext/)() override | このノードに直前のテキストノードを返します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | 現在のノードの子ノードを反復する列挙子を返します。 |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | 指定された文字オフセットに指定された文字列を挿入します。 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | オブジェクトが targetType で記述された型のインスタンスであるかどうかを確認します。C# の 'is' 演算子と同等です。 |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | シーケンスの要素数を直接カウントして返します。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | この [XmlNode](../xmlnode/) の下位ツリー全体の深さにあるすべての [XmlText](./) ノードを、マークアップ（タグ、コメント、処理命令、CDATA セクション、エンティティ参照）のみが [XmlText](./) ノードを区切る「標準」形式に変換します。つまり、隣接する [XmlText](./) ノードは存在しません。 |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | 指定されたオフセットから指定された文字数を、指定された文字列で置き換えます。 |
...
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | ノードとすべての子ノードの連結された値を設定します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlText](./)\> [SplitText](./splittext/)(**int32_t**) | 指定されたオフセットでノードを2つに分割し、両方をツリー上の兄弟ノードとして保持します。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | ノードのすべての子を指定された [XmlWriter](../xmlwriter/) に保存します。[XmlText](./) ノードは子を持たないため、このメソッドは効果がありません。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してインスタンスを作成しないでください。そうするとランタイムエラーやアサーション失敗が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを引数として関数に渡すようにしてください。 
