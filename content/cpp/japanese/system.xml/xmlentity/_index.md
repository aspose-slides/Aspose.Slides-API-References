...
description: エンティティ宣言（例: <!ENTITY... >）を表します。
type: docs
weight: 235
url: /ja/system.xml/xmlentity/
---
## XmlEntity クラス
...
| メソッド | 説明 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | 指定されたノードをこのノードの子ノードリストの末尾に追加します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | このノードの複製を作成します。エンティティノードはクローンできません。[XmlEntity](./) オブジェクトでこのメソッドを呼び出すと例外がスローされます。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | const 修飾インスタンスのコレクションの最後の要素（存在する場合）の直後を指すイテレータを取得します。 |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | 現在のノードの基本統一リソース識別子（URI）を返します。 |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | エンティティノードとそのすべての子の連結された値を返します。 |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | このノードの子を表すマークアップを返します。 |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | ノードが読み取り専用かどうかを示す値を返します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | ノードの最後の子ノードを返します。 |
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | 名前空間プレフィックスなしでノードの名前を返します。 |
| [String](../../system/string/) [get_Name](./get_name/)() override | ノードの名前を返します。 |
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | このノードの名前空間 URI を返します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | このノードの直後のノードを返します。 |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | ノードの種類を返します。 |
| [String](../../system/string/) [get_NotationName](./get_notationname/)() | エンティティ宣言のオプション NDATA 属性の名前を返します。 |
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | このノードとすべての子を表すマークアップを返します。 |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | エンティティ宣言の公開識別子の値を返します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | スキーマ検証の結果としてこのノードに割り当てられた、検証後スキーマ情報セットを返します。 |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | エンティティ宣言のシステム識別子の値を返します。 |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | ノードの値を返します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられたリファレンスカウンタデータ構造を取得します。 |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 現在のノードのスコープ内で指定されたプレフィックスに最も近い **xmlns** 宣言を検索し、宣言に含まれる名前空間 URI を返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | 指定されたノードを指定された参照ノードの直後に挿入します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | 指定されたノードを指定された参照ノードの直前に挿入します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector によって選択されたキー値に従ってシーケンスの要素を昇順にソートします。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector によって選択されたキー値に従ってシーケンスの要素を降順にソートします。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロック機構を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティナオブジェクトを使用してください。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | この [XmlNode](../xmlnode/) の下位ツリー全体の [XmlText](../xmltext/) ノードを、マークアップ（タグ、コメント、処理命令、CDATA セクション、エンティティ参照）のみで [XmlText](../xmltext/) ノードが分離される「通常」形式に変換します。つまり、隣接する [XmlText](../xmltext/) ノードは存在しません。 |
...
| virtual void [RemoveAll](../xmlnode/removeall/)() | 現在のノードのすべての子ノードおよび属性を削除します。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 共有リファレンスカウントを指定された値だけ減少させます。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&) | [XPath](../../system.xml.xpath/) 式にマッチするノードのリストを選択します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 式にマッチするノードのリストを選択します。[XPath](../../system.xml.xpath/) 式で見つかったプレフィックスは、提供された [XmlNamespaceManager](../xmlnamespacemanager/) を使用して解決されます。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&) | [XPath](../../system.xml.xpath/) 式にマッチする最初の [XmlNode](../xmlnode/) を選択します。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 式にマッチする最初の [XmlNode](../xmlnode/) を選択します。[XPath](../../system.xml.xpath/) 式で見つかったプレフィックスは、提供された [XmlNamespaceManager](../xmlnamespacemanager/) を使用して解決されます。 |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | エンティティノードとすべての子の連結された値を設定します。 |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | このノードの子を表すマークアップを設定します。 |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 共有リファレンスカウントをインクリメントします。直接呼び出さず、スマートポインタや ThisProtector を使用してください。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 共有リファレンスカウントをデクリメントし、その値を返します。直接呼び出さず、スマートポインタや ThisProtector を使用してください。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティナオブジェクトを使用してください。 |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | 弱参照カウントをインクリメントします。直接呼び出さず、スマートポインタや ThisProtector を使用してください。 |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | 弱参照カウントをデクリメントします。直接呼び出さず、スマートポインタや ThisProtector を使用してください。 |
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | ノードのすべての子を指定された [XmlWriter](../xmlwriter/) に保存します。[XmlEntity](./) ノードに対してはこのメソッドは効果がありません。 |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | ノードを指定された [XmlWriter](../xmlwriter/) に保存します。[XmlEntity](./) ノードに対してはこのメソッドは効果がありません。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタックや operator new を使用してこの型のインスタンスを作成しないでください。そうするとランタイムエラーやアサーション違反が発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。
