...
description: XML が文書のテキスト内にプロセッサ固有の情報を保持するために定義した処理指示を表します。
type: docs
weight: 404
url: /ja/system.xml/xmlprocessinginstruction/
---
## XmlProcessingInstruction クラス

処理指示を表します。XML では、ドキュメントのテキスト内にプロセッサ固有の情報を保持するために定義されています。
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | コレクションの最後の要素（存在する場合）の直後を指すイテレータを取得します。このイテレータは [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) が T のコピーオブジェクトを返すため、参照先オブジェクトを変更するために使用できません。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はどの値（NaN を含む）とも等しくないにもかかわらず、C# スタイルの浮動小数点比較をエミュレートし、2 つの NaN を等しいと見なします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はどの値（NaN を含む）とも等しくないにもかかわらず、C# スタイルの浮動小数点比較をエミュレートし、2 つの NaN を等しいと見なします。 |
...
| [String](../../system/string/) [get_Data](./get_data/)() | ターゲットを除いた処理指示の内容を返します。 |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | ノードとそのすべての子ノードの結合された値を返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | スキーマ検証の結果、このノードに割り当てられたスキーマ検証後のインフォセットを返します。 |
| [String](../../system/string/) [get_Target](./get_target/)() | 処理指示のターゲットを返します。 |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | シーケンスに対してアクセムレータ関数を適用します。 |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | シーケンスの要素数を返します（直接カウントによって計算）。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | この [XmlNode](../xmlnode/) の下位ツリー全体の深さにあるすべての [XmlText](../xmltext/) ノードを、マークアップ（タグ、コメント、処理指示、CDATA セクション、エンティティ参照）のみで [XmlText](../xmltext/) ノードを区切る「正常」な形に変換します。すなわち、隣接する [XmlText](../xmltext/) ノードは存在しません。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) 式に一致する最初の [XmlNode](../xmlnode/) を選択します。[XPath](../../system.xml.xpath/) 式で見つかったプレフィックスは提供された [XmlNamespaceManager](../xmlnamespacemanager/) を使用して解決されます。 |
| void [set_Data](./set_data/)(const [String](../../system/string/)\&) | ターゲットを除いた処理指示の内容を設定します。 |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | ノードとすべての子ノードの結合された値を設定します。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | ノードのすべての子を指定された [XmlWriter](../xmlwriter/) に保存します。ProcessingInstruction ノードは子を持たないため、このメソッドは何も影響しません。 |
