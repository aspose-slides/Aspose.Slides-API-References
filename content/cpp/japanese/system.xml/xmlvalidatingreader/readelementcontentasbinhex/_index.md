...
type: docs
weight: 612
url: /ja/system.xml/xmlvalidatingreader/readelementcontentasbinhex/
---
## XmlValidatingReader::ReadElementContentAsBinHex(ArrayPtr\<uint8_t\>, int32_t, int32_t) メソッド
...
| count | **int32_t** | バッファにコピーする最大バイト数。実際にコピーされたバイト数はこのメソッドの戻り値として返されます。 |
