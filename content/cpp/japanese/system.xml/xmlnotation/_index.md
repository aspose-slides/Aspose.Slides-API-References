...
description: <!NOTATION... > のような表記宣言を表します。
type: docs
weight: 378
url: /ja/system.xml/xmlnotation/
---
## XmlNotation クラス
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | このノードの複製を作成します。表記ノードはクローンできません。[XmlNotation](./) オブジェクトでこのメソッドを呼び出すと例外がスローされます。 |
...
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | このノードの子ノードを表すマークアップを返します。 |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | 名前空間プレフィックスなしで現在のノードの名前を返します。 |
| [String](../../system/string/) [get_Name](./get_name/)() override | 現在のノードの名前を返します。 |
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | このノードの名前空間 URI を返します。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | このノードの直後に続くノードを返します。 |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | 現在のノードのタイプを返します。 |
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | このノードとすべての子ノードを表すマークアップを返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | このノードの親ノードを返します（親を持てるノードに対して）。 |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | 表記宣言の公開識別子の値を返します。 |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | 表記宣言のシステム識別子の値を返します。 |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | 数値シーケンスの平均値を計算します。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | この [XmlNode](../xmlnode/) の下位サブツリー全深さにあるすべての [XmlText](../xmltext/) ノードを、マークアップ（タグ、コメント、処理命令、CDATA セクション、エンティティ参照）のみで [XmlText](../xmltext/) ノードを分離する「通常」形に変換します。すなわち、隣接する [XmlText](../xmltext/) ノードは存在しません。 |
...
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | このノードの子ノードを表すマークアップを設定します。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | ノードの子ノードを指定された [XmlWriter](../xmlwriter/) に保存します。このメソッドは [XmlNotation](./) ノードには影響しません。 |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | ノードを指定された [XmlWriter](../xmlwriter/) に保存します。このメソッドは [XmlNotation](./) ノードには影響しません。 |
...
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。このクラスは常に [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数への引数として渡すようにしてください。
