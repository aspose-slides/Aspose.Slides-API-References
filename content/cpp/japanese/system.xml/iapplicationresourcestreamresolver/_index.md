...
description: アプリケーションリソースストリームリゾルバを表します。
type: docs
weight: 14
url: /ja/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver クラス

アプリケーションリソースストリームリゾルバを表します。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | 指定された URI からアプリケーションリソースストリームを返します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() ステートメントのロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) 番兵オブジェクトを使用してください。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() ステートメントのロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) 番兵オブジェクトを使用してください。 |
