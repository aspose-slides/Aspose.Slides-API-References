...
description: Uniform Resource Identifier (URI) で名前付けされた外部 XML リソースを解決します。
type: docs
weight: 456
url: /ja/system.xml/xmlresolver/
---
## XmlResolver クラス
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) | 派生クラスでオーバーライドされた場合、URI を実際のリソースを含むオブジェクトにマップします。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | 派生クラスでオーバーライドされた場合、基本 URI と相対 URI から絶対 URI を解決します。 |
| virtual void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | 派生クラスでオーバーライドされた場合、Web リクエストの認証に使用される資格情報を設定します。 |
...
| virtual **bool** [SupportsType](./supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | リゾルバが Stream 以外の型を返すことを可能にします。 |
