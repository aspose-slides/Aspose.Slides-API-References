...
description: 指定されたブール値を同等の 64 ビット符号付き整数に変換します。
type: docs
weight: 183
url: /ja/system/convert/toint64/
---
## Convert::ToInt64(bool) メソッド

指定されたブール値を同等の 64 ビット符号付き整数に変換します。

```cpp
static constexpr int64_t System::Convert::ToInt64(bool value)
```

## Convert::ToInt64(uint8_t) メソッド

指定された 8 ビット符号なし整数を同等の 64 ビット符号付き整数に変換します。

```cpp
static constexpr int64_t System::Convert::ToInt64(uint8_t value)
```

## Convert::ToInt64(int8_t) メソッド

指定された 8 ビット符号付き整数を同等の 64 ビット符号付き整数に変換します。

```cpp
static constexpr int64_t System::Convert::ToInt64(int8_t value)
```

## Convert::ToInt64(uint16_t) メソッド

指定された 16 ビット符号なし整数を同等の 64 ビット符号付き整数に変換します。

```cpp
static constexpr int64_t System::Convert::ToInt64(uint16_t value)
```

## Convert::ToInt64(int16_t) メソッド

指定された 16 ビット符号付き整数を同等の 64 ビット符号付き整数に変換します。

```cpp
static constexpr int64_t System::Convert::ToInt64(int16_t value)
```

## Convert::ToInt64(uint32_t) メソッド

指定された 32 ビット符号なし整数を同等の 64 ビット符号付き整数に変換します。

```cpp
static constexpr int64_t System::Convert::ToInt64(uint32_t value)
```

## Convert::ToInt64(int32_t) メソッド

指定された 32 ビット符号付き整数を同等の 64 ビット符号付き整数に変換します。

```cpp
static constexpr int64_t System::Convert::ToInt64(int32_t value)
```

## Convert::ToInt64(uint64_t) メソッド

指定された 64 ビット符号なし整数を同等の 64 ビット符号付き整数に変換します。

```cpp
static int64_t System::Convert::ToInt64(uint64_t value)
```

## Convert::ToInt64(int64_t) メソッド

指定された 64 ビット符号付き整数を返します。

```cpp
static constexpr int64_t System::Convert::ToInt64(int64_t value)
```

## Convert::ToInt64(float) メソッド

指定された float 数を同等の 64 ビット符号付き整数に変換します。

```cpp
static int64_t System::Convert::ToInt64(float value)
```

## Convert::ToInt64(double) メソッド

指定された double 数を同等の 64 ビット符号付き整数に変換します。

```cpp
static int64_t System::Convert::ToInt64(double value)
```

## Convert::ToInt64(const Decimal\&) メソッド

指定された decimal 数を同等の 64 ビット符号付き整数に変換します。

```cpp
static int64_t System::Convert::ToInt64(const Decimal &value)
```

## Convert::ToInt64(char_t) メソッド

指定された unicode 文字を同等の 64 ビット符号付き整数に変換します。

```cpp
static constexpr int64_t System::Convert::ToInt64(char_t value)
```

## Convert::ToInt64(DateTime) メソッド
...
## Convert::ToInt64(std::nullptr_t) メソッド

指定された null 文字列を同等の int 64 ビット整数値に変換します。
...
## Convert::ToInt64(const char_t *) メソッド

数値の文字列表現を含む指定された c 文字列を同等の 64 ビット整数値に変換します。
...
指定された c 文字列が表す数値に等しい 64 ビット整数値

## Convert::ToInt64(const String\&) メソッド

数値の文字列表現を含む指定された文字列を同等の 64 ビット整数値に変換します。
...
指定された文字列が表す数値に等しい 64 ビット整数値

## Convert::ToInt64(const String\&, int) メソッド

指定された基数で数値の文字列表現を含む文字列を同等の 64 ビット整数値に変換します。
...
## Convert::ToInt64(const String\&, const SharedPtr\<IFormatProvider\>\&) メソッド

提供された書式情報を使用して、数値の文字列表現を含む指定された文字列を同等の 64 ビット整数値に変換します。
...
## Convert::ToInt64(const String\&, const SharedPtr\<Globalization::CultureInfo\>\&) メソッド
...
## Convert::ToInt64(const String\&, const SharedPtr\<Globalization::NumberFormatInfo\>\&) メソッド
...
## Convert::ToInt64(const String\&, std::nullptr_t) メソッド
...
## Convert::ToInt64(const String\&, Globalization::NumberStyles, const SharedPtr\<IFormatProvider\>\&) メソッド

提供された書式情報と数値スタイルを使用して、数値の文字列表現を含む指定された文字列を同等の 64 ビット整数値に変換します。
...
| --- | --- | --- |
| value | const [String](../../string/)\& | 変換する文字列 |
| styles | [Globalization::NumberStyles](../../../system.globalization/numberstyles/) | NumberStyles 列挙体の値のビット単位の組み合わせで、文字列の数値表現に許可されるスタイルを指定します |
| provider | const [SharedPtr](../../sharedptr/)\<[IFormatProvider](../../iformatprovider/)\>\& | 文字列の書式情報を含むオブジェクトへのポインタ |
...
## Convert::ToInt64(const String\&, Globalization::NumberStyles, const SharedPtr\<Globalization::CultureInfo\>\&) メソッド
...
## Convert::ToInt64(const String\&, Globalization::NumberStyles, const SharedPtr\<Globalization::NumberFormatInfo\>\&) メソッド
...
## Convert::ToInt64(const String\&, Globalization::NumberStyles, std::nullptr_t) メソッド
...
## Convert::ToInt64(const SharedPtr\<Object\>\&, const SharedPtr\<IFormatProvider\>\&) メソッド

指定されたボックス化された値を同等の 64 ビット整数値に変換します。
