...
type: docs
weight: 2133
url: /ja/system/operator_greater_equal/
---
...
指定された [Nullable](../nullable/) オブジェクトが表す値に対して [operator>=()](./) を適用し、指定された値がそれ以上かどうかを判定します。
...
| --- | --- |
| T1 | 最初の比較対象の型 |
| T2 | 2番目の比較対象を表す [Nullable](../nullable/) オブジェクトの基になる型 |
...
| other | const [Nullable](../nullable/)\<T2\>\& | 2番目の比較対象として使用される値を表す [Nullable](../nullable/) オブジェクトへの定数参照 |

### 戻り値

最初の比較対象が2番目の比較対象以上であれば true、そうでなければ false
