...
description: SoapHeader クラスのインスタンスのコレクションを含みます。
type: docs
weight: 105
url: /ja/system.web.services.protocols/soapheadercollection/
---
## SoapHeaderCollection クラス

[SoapHeader](../soapheader/) クラスのインスタンスのコレクションを含みます。
...
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&) const | ソート済みリストで項目を検索します。 |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | ソート済みリストで項目を検索します。 |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(int, int, const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | ソート済みリストで項目を検索します。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | コレクションの末尾の後ろにある存在しない const 修飾要素へのイテレータを取得します。 |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | コレクションの最後の const 修飾要素（逆順で最初）の逆イテレータを取得します。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crend](../../system.collections.generic/list/crend/)() const | コレクションの先頭の前にある存在しない const 修飾要素の逆イテレータを取得します。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | コレクションの末尾の後ろにある存在しない要素へのイテレータを取得します。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | const 修飾されたコレクションの末尾の後ろにある存在しない要素へのイテレータを取得します。 |
...
| void [ForEach](../../system.collections.generic/list/foreach/)([System::Action](../../system/action/)\<T\>) | リスト内のすべての要素に対して操作を適用します。 |
...
| T [idx_get](../../system.collections.generic/list/idx_get/)(int) const override | 特定の位置の要素を取得します。 |
...
| int [IndexOf](../../system.collections.generic/list/indexof/)(const T\&, int) const | リスト内の特定の項目を検索します。 |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | 指定されたオブジェクトを検索し、[List](../../system.collections.generic/list/) の指定された要素数を含み、指定インデックスで終わる範囲内で最後に出現した位置のゼロベースインデックスを返します。 |
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | シーケンスに対して蓄積関数を適用します。 |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | シーケンスのうち、指定された条件を満たす要素数を返します。 |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | シーケンスの最初の要素、もしくはシーケンスが空の場合はデフォルト値を返します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Reverse](../../system.collections.generic/ienumerable/linq_reverse/)() | シーケンスの要素の順序を逆にします。 |
...
| vector_t::reference [operator[]](../../system.collections.generic/list/operator[]/)(int) | アクセサ関数です。 |
| vector_t::const_reference [operator[]](../../system.collections.generic/list/operator[]/)(int) const | アクセサ関数です。 |
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() | コレクションの最後の要素（逆順で最初）の逆イテレータを取得します。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | const 修飾されたコレクションの最後の要素（逆順で最初）の逆イテレータを取得します。 |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() | コレクションの開始前にある存在しない要素の逆イテレータを取得します。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | const 修飾されたコレクションの開始前にある存在しない要素の逆イテレータを取得します。 |
| void [Reverse](../../system.collections.generic/list/reverse/)() | リスト全体の要素順序を逆にします。 |
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | リストスライスの要素順序を逆にします。 |
| void [set_Capacity](../../system.collections.generic/list/set_capacity/)(int) | リストの容量を設定します。 |
...
| [SoapHeaderCollection](./soapheadercollection/)() | [SoapHeaderCollection](./) クラスの新しいインスタンスを初期化します。 |
...
| void [Sort](../../system.collections.generic/list/sort/)(int, int, [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>) | リストスライス内の要素をソートします。 |
...
| **bool** [TrueForAll](../../system.collections.generic/list/trueforall/)([System::Predicate](../../system/predicate/)\<T\>) | コレクション内のすべての要素が指定された述語で定義された条件に一致するかどうかを判定します。 |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) 構文を実装します。 |
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティリーオブジェクトを使用してください。 |
