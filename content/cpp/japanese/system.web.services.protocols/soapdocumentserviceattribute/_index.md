...
description: "SOAP のリクエストとレスポンスのデフォルト形式を設定します。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション障害が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡してください。"
type: docs
weight: 66
url: /ja/system.web.services.protocols/soapdocumentserviceattribute/
---
...
| [SoapParameterStyle](../soapparameterstyle/) [get_ParameterStyle](./get_parameterstyle/)() | パラメーターが 'Body' 要素の下にある単一の XML 要素にカプセル化されているかどうかを示す値を取得します。 |
| [SoapServiceRoutingStyle](../soapserviceroutingstyle/) [get_RoutingStyle](./get_routingstyle/)() | SOAP メッセージがサービスにルーティングされる方法を示す値を取得します。 |
| [Description::SoapBindingUse](../../system.web.services.description/soapbindinguse/) [get_Use](./get_use/)() | パラメーターの書式設定を取得します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタ データ構造を取得します。 |
| static [Object::ptr](../../system/object/ptr/) [GetCustomAttribute](../../system/attribute/getcustomattribute/)(const [TypeInfo](../../system/typeinfo/)\&, const [TypeInfo](../../system/typeinfo/)\&) | 指定された型に適用されたカスタム属性を返します。 |
...
| void [set_ParameterStyle](./set_parameterstyle/)([SoapParameterStyle](../soapparameterstyle/)) | 'Body' 要素の下にある単一の XML 要素にパラメーターがカプセル化されているかどうかを示す値を設定します。 |
| void [set_RoutingStyle](./set_routingstyle/)([SoapServiceRoutingStyle](../soapserviceroutingstyle/)) | SOAP メッセージがサービスにどのようにルーティングされるかを示す値を設定します。 |
| void [set_Use](./set_use/)([Description::SoapBindingUse](../../system.web.services.description/soapbindinguse/)) | パラメーターの書式設定を設定します。 |
...
|  [SoapDocumentServiceAttribute](./soapdocumentserviceattribute/)([Description::SoapBindingUse](../../system.web.services.description/soapbindinguse/)) | 新しいインスタンスを構築します。 |
|  [SoapDocumentServiceAttribute](./soapdocumentserviceattribute/)([Description::SoapBindingUse](../../system.web.services.description/soapbindinguse/), [SoapParameterStyle](../soapparameterstyle/)) | 新しいインスタンスを構築します。 |
