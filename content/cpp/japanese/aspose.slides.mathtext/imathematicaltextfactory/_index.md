...
description: 数式テキスト要素の作成を可能にします
type: docs
weight: 261
url: /ja/aspose.slides.mathtext/imathematicaltextfactory/
---
## IMathematicalTextFactory クラス


[MathematicalText](../mathematicaltext/) 要素の作成を許可します
...
| メソッド | 説明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)() | 空の数式テキスト要素を作成します |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)(char16_t) | 指定された値で数式テキスト要素を作成します |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/)) | 指定された値で空の数式テキスト要素を作成します |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) | 指定された値と書式プロパティで空の数式テキスト要素を作成します |
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用としてのみ使用できます。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) の文字列および nullptr のケースに対する特殊化です。 |
