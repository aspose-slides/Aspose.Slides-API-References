...
description: 数式ブロックのコレクション (IMathBlock)
type: docs
weight: 118
url: /ja/aspose.slides.mathtext/imathblockcollection/
---
## IMathBlockCollection クラス


数式ブロックのコレクション（[IMathBlock](../imathblock/)）
...
| メソッド | 説明 |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | [IMathBlock](../imathblock/) をコレクションの末尾に追加します。 |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | コレクションが特定の値を含むかどうかを判定します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスの項目を取得します。読み取り専用 [IMathBlock](../imathblock/)。 |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 指定されたインデックスの項目を取得します。読み取り専用 [IMathBlock](../imathblock/)。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | コレクション内の特定の [IMathBlock](../imathblock/) のインデックスを決定します。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 指定されたインデックスに [IMathBlock](../imathblock/) をコレクションに挿入します。 |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 条件を満たすシーケンスの最初の要素を返します。条件に合致する要素が見つからない場合はデフォルト値を返します。 |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | コレクションから特定のオブジェクトの最初の出現を削除します/>。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | コレクションの指定インデックスの項目を削除します。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 共有参照カウントを指定された値だけ減少させます。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n番目のテンプレート引数を弱ポインタ（共有ではなく）に設定します。コンテナ内のポインタを弱モードに切り替えることが可能です。 |
