...
description: 内部に数式コンテキストを持つ部分を表します。
type: docs
weight: 495
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathParagraph](../imathparagraph/)\> [get_MathParagraph](./get_mathparagraph/)() | 数式段落 |
