...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)() | 数式ブロックを作成します |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 数式ブロックを作成し、要素をその中に配置します |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\>) | 数式ブロックを作成し、要素をその中に配置します |
