...
| メソッド | 説明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | この要素の上にある文字としてアクセントマークを設定します |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | このインスタンスを引数として、指定された関数と追加の引数を受け取ります |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | このインスタンスを引数として、指定された関数と追加の引数を受け取ります |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | 数式要素を、丸括弧やその他の指定文字で枠付けします |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\> [get_Format](./get_format/)() override | テキスト書式設定プロパティ |
| [System::String](../../system/string/) [get_Value](./get_value/)() override | テキスト値 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)() override | 下括弧（波かっこ）を使用してこの要素をグループに配置します |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | 下括弧やその他のグループ化文字を使用してこの要素をグループに配置します |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../mathelementbase/integral/)([MathIntegralTypes](../mathintegraltypes/)) override | 限界なしで積分を取得します |
...
|  [MathematicalText](./mathematicaltext/)() | デフォルトコンストラクタ（String::Empty 値を作成） |
|  [MathematicalText](./mathematicaltext/)(char16_t) | 単一シンボルで [MathText](../) を作成します |
|  [MathematicalText](./mathematicaltext/)([System::String](../../system/string/)) | テキストから [MathematicalText](./) を作成します |
|  [MathematicalText](./mathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) | テキストと書式設定から [MathematicalText](./) を作成します |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../mathelementbase/overbar/)() override | この要素の上にバーを設定します |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 指定された引数から、指定された次数の数学的ルートを指定します |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | 指定された引数から、指定された次数の数学的ルートを指定します |
...
| void [set_Value](./set_value/)([System::String](../../system/string/)) override | テキスト値 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)() override | この要素を枠ボックスに配置します |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | この要素を枠ボックスに配置します |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | この要素を非表示のボックス（論理的グルーピング）に配置します。これは、方程式や他の数式テキストの構成要素をグループ化するために使用されます。ボックス化されたオブジェクトは、（例）整列点の有無にかかわらず演算子エミュレータとして、改行ポイントとして、または内部で改行を許可しないようにグループ化することができます |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../mathelementbase/underbar/)() override | この要素の下にバーを設定します |
