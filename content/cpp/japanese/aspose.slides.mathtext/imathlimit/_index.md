...
| メソッド | 説明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | この要素の上部にある文字（アクセント マーク）を設定します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | この分子と指定された分母を使用して、指定されたタイプの分数を作成します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) | この分子と指定された分母を使用して、指定されたタイプの分数を作成します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | 数式要素を括弧で囲みます。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | この要素を、括弧などの指定された文字で枠囲みします。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Limit](./get_limit/)() | Limit 引数 |
| virtual **bool** [get_UpperLimit](./get_upperlimit/)() | 上限または下限を指定します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)() | この要素を下部の波かっこでグループ化します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | この要素を下部の波かっこや他の文字などのグループ化文字でグループ化します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/)) | 上下限なしで積分を受け取ります。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() ステートメントのロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティン オブジェクトを使用してください。 |
...
| virtual void [set_UpperLimit](./set_upperlimit/)(**bool**) | 上限または下限を指定します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 下限を受け取ります。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::String](../../system/string/)) | 下限を受け取ります。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 上限を受け取ります。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::String](../../system/string/)) | 上限を受け取ります。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | この要素を非表示ボックス（論理的グルーピング）に配置します。これは方程式や他の数式テキストの構成要素をグループ化するために使用されます。例えば、ボックス化されたオブジェクトは整列点の有無にかかわらず演算子エミュレータとして機能したり、改行点として機能したり、内部で改行を許可しないようにグループ化したりできます。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() ステートメントのロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティン オブジェクトを使用してください。 |
