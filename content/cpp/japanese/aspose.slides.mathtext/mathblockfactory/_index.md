...
| メソッド | 説明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)() override | 数式ブロックを作成します |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 数式ブロックを作成し、要素をその中に配置します |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\>) override | 数式ブロックを作成し、要素をその中に配置します |
...
* クラス [IMathBlockFactory](../imathblockfactory/)
