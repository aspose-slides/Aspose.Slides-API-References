...
---
## IMathNaryOperatorProperties クラス

[IMathNaryOperator](../imathnaryoperator/) のプロパティを指定します。
...
| virtual **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() | 演算子文字がオペランドの高さに合わせて垂直に拡大します。 |
| virtual **bool** [get_HideSubscript](./get_hidesubscript/)() | 下付き文字を非表示にします。 |
| virtual **bool** [get_HideSuperscript](./get_hidesuperscript/)() | 上付き文字を非表示にします。 |
| virtual [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() | リミット（下付き文字と上付き文字）の位置を示します。 |
| virtual char16_t [get_Operator](./get_operator/)() | Nary 演算子文字。例: '\\u2211', '\\u222B' |
...
| virtual void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) | 演算子文字がオペランドの高さに合わせて垂直に拡大します。 |
| virtual void [set_HideSubscript](./set_hidesubscript/)(**bool**) | 下付き文字を非表示にします。 |
| virtual void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) | 上付き文字を非表示にします。 |
| virtual void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) | リミット（下付き文字と上付き文字）の位置を示します。 |
| virtual void [set_Operator](./set_operator/)(char16_t) | Nary 演算子文字。例: '\\u2211', '\\u222B' |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のロック解除機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリーオブジェクトを使用してください。 |
