...
description: "ソケットエラーが発生したときにスローされる例外を表します。このクラスのインスタンスは手動で作成しないでください。代わりに SocketException クラスを使用してください。SocketException クラスのインスタンスを System::SmartPtr にラップしないでください。"
type: docs
weight: 1
url: /ja/system.net.sockets/details_socketexception/
---
## Details_SocketException クラス


ソケットエラーが発生したときにスローされる例外を表します。このクラスのインスタンスは手動で作成しないでください。代わりに SocketException クラスを使用してください。SocketException クラスのインスタンスを [System::SmartPtr](../../system/smartptr/) にラップしないでください。
...
| **int32_t** [get_ErrorCode](./get_errorcode/)() | エラーコードを取得します。 |
...
| [SocketError](../socketerror/) [get_SocketErrorCode](./get_socketerrorcode/)() | ソケットエラーコードを取得します。 |
...
| void [set_ErrorCode](./set_errorcode/)(**int32_t**) | エラーコードを設定します。 |
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 特定の例外に割り当てられるコード化された数値である HRESULT を設定します。 |
| void [set_SocketErrorCode](./set_socketerrorcode/)([SocketError](../socketerror/)) | ソケットエラーコードを設定します。 |
