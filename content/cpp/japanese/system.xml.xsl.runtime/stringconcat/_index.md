...
description: 文字列の数が事前に分からない場合に文字列を連結します。
type: docs
weight: 1
url: /ja/system.xml.xsl.runtime/stringconcat/
---
## StringConcat クラス

文字列の数が事前に分からない場合に文字列を連結します。
...
| Method | Description |
| --- | --- |
| void [Clear](./clear/)() | 結果文字列をクリアします。 |
| void [Concat](./concat/)(const [String](../../system/string/)\&) | 新しい文字列を結果に連結します。 |
...
| [String](../../system/string/) [get_Delimiter](./get_delimiter/)() | 連結された文字列を区切る文字列を返します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) メソッドのアナログです。カスタムオブジェクトのハッシュ化を可能にします。 |
| [String](../../system/string/) [GetResult](./getresult/)() | 結果文字列を返します。 |
...
| void [set_Delimiter](./set_delimiter/)(const [String](../../system/string/)\&) | 連結された文字列を区切る文字列を設定します。 |
...
|  [StringConcat](./stringconcat/)() | デフォルトコンストラクタです。 |
