...
description: "デコードに失敗したときに DecoderExceptionFallback がスローする例外です。このクラスのインスタンスを手動で作成しないでください。代わりに DecoderFallbackException クラスを使用してください。DecoderFallbackException クラスのインスタンスを System::SmartPtr にラップしないでください。"
type: docs
weight: 105
url: /ja/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException クラス

[DecoderExceptionFallback](../decoderexceptionfallback/) によってデコードに失敗したときにスローされる例外です。 このクラスのインスタンスは手動で作成しないでください。 代わりに DecoderFallbackException クラスを使用してください。 DecoderFallbackException クラスのインスタンスを [System::SmartPtr](../../system/smartptr/) にラップしないでください。
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | エラーを引き起こしたバイト配列を取得します。 |
...
| int [get_Index](./get_index/)() | 入力配列でエラーを引き起こしたバイトの位置を取得します。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | オブジェクトの実際の型を取得します。C# [System.Object.GetType()](../../system/object/gettype/) 呼び出しの類似です。 |
