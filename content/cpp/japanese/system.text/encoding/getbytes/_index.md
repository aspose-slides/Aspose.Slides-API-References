...
type: docs
weight: 248
url: /ja/system.text/encoding/getbytes/
---
## Encoding::GetBytes(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int) メソッド

文字バッファをエンコードした結果のバイトを取得します。
...
## Encoding::GetBytes(System::Details::ArrayView\<char_t\>, int, int, System::Details::ArrayView\<uint8_t\>, int) メソッド
...
## Encoding::GetBytes(System::Details::StackArray\<char_t, SC\>\&, int, int, System::Details::StackArray\<uint8_t, SB\>\&, int) メソッド
...
## Encoding::GetBytes(const String\&, int, int, ArrayPtr\<uint8_t\>, int) メソッド
...
## Encoding::GetBytes(const String\&) メソッド
...
## Encoding::GetBytes(ArrayPtr\<char_t\>, int, int) メソッド
...
## Encoding::GetBytes(const System::Details::ArrayView\<char_t\>\&, int, int) メソッド
...
## Encoding::GetBytes(const System::Details::StackArray\<char_t, N\>\&, int, int) メソッド
...
## Encoding::GetBytes(ArrayPtr\<char_t\>) メソッド
...
## Encoding::GetBytes(const char_t *, int, uint8_t *, int) メソッド
