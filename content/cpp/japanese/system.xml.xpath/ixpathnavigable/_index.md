...
description: XPathNavigator クラスへのアクセサーを提供します。
type: docs
weight: 14
url: /ja/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable クラス
...
| メソッド | 説明 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | [XPathNavigator](../xpathnavigator/) オブジェクトを新しく返します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) ガードオブジェクトを使用してください。 |
