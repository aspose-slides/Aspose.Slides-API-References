...
description: 選択されたノード集合に対するイテレータを提供します。
type: docs
weight: 79
url: /ja/system.xml.xpath/xpathnodeiterator/
---
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | 派生クラスでオーバーライドされた場合、この [XPathNodeIterator](./) オブジェクトのクローンを返します。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | 選択されたノード集合における最後のノードのインデックスを返します。 |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | 派生クラスでオーバーライドされた場合、現在のコンテキストノード上に位置するこの [XPathNodeIterator](./) の [XPathNavigator](../xpathnavigator/) オブジェクトを取得します。 |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | 派生クラスでオーバーライドされた場合、選択されたノード集合における現在の位置のインデックスを取得します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタデータ構造を取得します。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | 選択されたノード集合を反復する IEnumerator オブジェクトを返します。 |
...
| virtual **bool** [MoveNext](./movenext/)() | 派生クラスでオーバーライドされた場合、[XPathNodeIterator::get_Current](./get_current/) メソッドが返す [XPathNavigator](../xpathnavigator/) オブジェクトを選択されたノード集合の次のノードに移動させます。 |
