...
description: "アセンブリ名を定義します。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうしないと実行時エラーやアサーション障害が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数への引数として使用してください。"
type: docs
weight: 14
url: /ja/system.reflection/assemblyname/
---
## AssemblyName クラス

アセンブリ名を定義します。このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうしないと実行時エラーやアサーション障害が発生します。このクラスは常に [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数への引数として使用してください。
...
| メソッド | 説明 |
| --- | --- |
|  [AssemblyName](./assemblyname/)() | コンストラクタ。 |
|  [AssemblyName](./assemblyname/)(const [String](../../system/string/)\&) | コンストラクタ。 |
|  [AssemblyName](./assemblyname/)(const [String](../../system/string/)\&, const [Version](../../system/version/)\&) | コンストラクタ。 |
...
| [String](../../system/string/) [get_Name](./get_name/)() | アセンブリ名を取得します。 |
| [Version](../../system/version/) [get_Version](./get_version/)() | アセンブリ バージョンを取得します。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) メソッドの類似です。カスタム 型のクローン作成を可能にします。 |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | アセンブリ名を設定します。 |
| void [set_Version](./set_version/)(const [Version](../../system/version/)\&) | アセンブリ バージョンを設定します。 |
