...
description: フィールドの属性を検出し、フィールドメタデータへのアクセスを提供します。
type: docs
weight: 92
url: /ja/system.reflection/fieldinfo/
---
## FieldInfo クラス


フィールドの属性を検出し、フィールドメタデータへのアクセスを提供します。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によると NaN はどの値とも等しくないにもかかわらず、C# スタイルの浮動小数点比較をエミュレートし、2つの NaN を等しいと見なします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によると NaN はどの値とも等しくないにもかかわらず、C# スタイルの浮動小数点比較をエミュレートし、2つの NaN を等しいと見なします。 |
...
| [TypeInfo](../../system/typeinfo/) [get_FieldType](./get_fieldtype/)() | プロパティの型を取得します。 |
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | メンバーの完全名を取得します。手動で実装された部分では異なる場合があります。 |
| **bool** [get_IsStatic](./get_isstatic/)() | フィールドが静的かどうかを示す値を取得します。 |
| virtual [MemberTypes](../membertypes/) [get_MemberType](../memberinfo/get_membertype/)() const | メンバーのタイプ（メソッド、コンストラクタ、イベントなど）を示す [System::Reflection::MemberTypes](../membertypes/) 値を取得します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [GetValue](./getvalue/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 特定のオブジェクトからプロパティ値を取得します。 |
...
| void [SetValue](./setvalue/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 特定のオブジェクトにプロパティ値を設定します。 |
