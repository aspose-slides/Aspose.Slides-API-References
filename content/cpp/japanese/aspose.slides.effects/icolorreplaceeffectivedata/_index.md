...
カラー置換効果を表す不変オブジェクトです。すべての効果色は固定色に変更されます。アルファ値は影響を受けません。
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 各ピクセルの色を置換する色フォーマットを返します。読み取り専用 [System::Drawing::Color](../../system.drawing/color/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | オブジェクトが targetType で記述された型のインスタンスを表すかを確認します。C# の 'is' 演算子と同等です。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# の [Object.ToString()](../../system/object/tostring/) メソッドと同等です。カスタムオブジェクトを文字列に変換することが可能です。 |
