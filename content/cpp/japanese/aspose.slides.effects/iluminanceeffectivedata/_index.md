...
description: Luminance効果を表します。Brightnessはすべての色を白または黒に線形にシフトします。Contrastはすべての色をより近く、または遠くなるようにスケーリングします。
type: docs
weight: 807
url: /ja/aspose.slides.effects/iluminanceeffectivedata/
---
## ILuminanceEffectiveData クラス

[Luminance](../luminance/) 効果を表します。Brightness はすべての色を白または黒に線形にシフトします。Contrast はすべての色をより近く、または遠くなるようにスケーリングします。
...
| virtual **float** [get_Brightness](./get_brightness/)() | Brightness。読み取り専用 **float**。 |
| virtual **float** [get_Contrast](./get_contrast/)() | Contrast。読み取り専用 **float**。 |
