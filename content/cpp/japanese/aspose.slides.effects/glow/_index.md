...
description: Glow エフェクトを表します。このエフェクトでは、オブジェクトのエッジの外側に色がぼやけた輪郭が追加されます。
type: docs
weight: 196
...
[Glow](./) エフェクトを表します。このエフェクトでは、オブジェクトのエッジの外側に色がぼやけた輪郭が追加されます。
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [Glow](./) が現在の [Glow](./) と等しいかどうかを判断します。 |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN はどの値（NaN を含む）とも等しくないが、2 つの NaN が等しいとみなされます。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | カラー形式。読み取り専用 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| **double** [get_Radius](./get_radius/)() override | 半径。**double** を読み取ります。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGlowEffectiveData](../igloweffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された効果的な [Glow](./) エフェクトデータを取得します。 |
...
| void [set_Radius](./set_radius/)(**double**) override | 半径。**double** を書き込みます。 |
