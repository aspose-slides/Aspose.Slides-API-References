...
[IImageTransformOperation](../iimagetransformoperation/) インターフェイスを表します。
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 対象の targetType で記述された型のインスタンスであるかをチェックします。C# の 'is' 演算子のアナログです。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n 番目のテンプレート引数に弱いポインタを設定します（共有ポインタではなく）。コンテナ内のポインタを弱参照モードに切り替えることができます。 |
