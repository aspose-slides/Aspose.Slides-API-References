...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された[AlphaModulateFixed](./)が現在の[AlphaModulateFixed](./)と等しいかどうかを判定します。 |
...
| **float** [get_Amount](./get_amount/)() override | エフェクトの量をパーセンテージで返します。読み取り **float**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Alpha Modulate Fixed エフェクトデータを取得します。 |
...
| void [set_Amount](./set_amount/)(**float**) override | エフェクトの量をパーセンテージで返します。書き込み **float**。 |
...
* クラス [IAlphaModulateFixed](../ialphamodulatefixed/)
