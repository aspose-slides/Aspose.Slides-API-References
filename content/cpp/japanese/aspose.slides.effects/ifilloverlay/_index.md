...
description: Fill Overlay 効果を表します。Fill Overlay は、オブジェクトに対して追加の塗りを指定し、2 つの塗りをブレンドするために使用できます。
type: docs
weight: 612
...
Fill Overlay 効果を表します。Fill Overlay は、オブジェクトに対して追加の塗りを指定し、2 つの塗りをブレンドするために使用できます。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によると NaN はどの値とも等しくないにもかかわらず、2 つの NaN を等しいとみなす C#-style 浮動小数点比較をエミュレートします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によると NaN はどの値とも等しくないにもかかわらず、2 つの NaN を等しいとみなす C#-style 浮動小数点比較をエミュレートします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode。取得 [FillBlendMode](../../aspose.slides/fillblendmode/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Fill フォーマット。読み取り専用 [IFillFormat](../../aspose.slides/ifillformat/)。 |
...
| virtual void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) | FillBlendMode。書き込み [FillBlendMode](../../aspose.slides/fillblendmode/)。 |
