...
オブジェクトに追加の塗りつぶしを指定し、2 つの塗りつぶしをブレンドするために使用できる Fill Overlay エフェクトを表します。
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された[FillOverlay](./)が現在の[FillOverlay](./)と等しいかどうかを判断します。 |
...
| [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() override | FillBlendMode。[FillBlendMode](../../aspose.slides/fillblendmode/) を読み取ります。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | 塗りつぶし形式。読み取り専用 [IFillFormat](../../aspose.slides/ifillformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlayEffectiveData](../ifilloverlayeffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Fill Overlay 効果データを取得します。 |
...
| void [Lock](../../system/object/lock/)() | C# lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチネルオブジェクトを使用してください。 |
...
| void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) override | FillBlendMode。[FillBlendMode](../../aspose.slides/fillblendmode/)を書き込みます。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチネルオブジェクトを使用してください。 |
