...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) の半径です。読み取り専用の **double**。 |
| virtual **float** [get_Direction](./get_direction/)() | シャドウの方向です。読み取り専用の **float**。 |
| virtual **double** [get_Distance](./get_distance/)() | シャドウの距離です。読み取り専用の **double**。 |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | 矩形の配置です。読み取り専用の [RectangleAlignment](../../aspose.slides/rectanglealignment/)。 |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | シェイプが回転した場合に、シャドウもシェイプとともに回転すべきかどうかを指定します。読み取り専用の **bool**。 |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | 水平スケーリング係数を指定します。負のスケーリングは反転を引き起こします。読み取り専用の **double**。 |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | 垂直スケーリング係数を指定します。負のスケーリングは反転を引き起こします。読み取り専用の **double**。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | シャドウの色です。読み取り専用の [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | 水平の斜め角度（度単位）を指定します。読み取り専用の **double**。 |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | 垂直の斜め角度（度単位）を指定します。読み取り専用の **double**。 |
