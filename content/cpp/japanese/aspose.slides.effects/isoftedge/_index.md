...
description: ソフトエッジ効果を表します。シェイプのエッジはぼやけますが、塗りは影響を受けません。
type: docs
weight: 963
...
ソフトエッジ効果を表します。シェイプのエッジはぼやけますが、塗りは影響を受けません。
...
| virtual **double** [get_Radius](./get_radius/)() | エッジに適用するぼかしの半径を指定します。読み取りは **double**。 |
...
| virtual void [set_Radius](./set_radius/)(**double**) | エッジに適用するぼかしの半径を指定します。書き込みは **double**。 |
