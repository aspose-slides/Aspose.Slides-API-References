...
description: Alpha Modulate 効果を表す不変オブジェクトです。効果のアルファ（不透明度）値は固定のパーセンテージで乗算されます。効果コンテナは、アルファ値を変調する効果を指定します。
type: docs
weight: 352
url: /ja/aspose.slides.effects/ialphamodulateeffectivedata/
---
## IAlphaModulateEffectiveData クラス
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のアンロック機構を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリーオブジェクトを使用してください。 |
