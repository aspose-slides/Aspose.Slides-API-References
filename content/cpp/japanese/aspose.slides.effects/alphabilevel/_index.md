...
description: Alpha Bi-Level エフェクトを表します。しきい値未満のアルファ (不透明度) の値は 0（完全に透明）に変更され、しきい値以上のアルファの値は 100%（完全に不透明）に変更されます。
type: docs
weight: 1
...
Alpha Bi-Level エフェクトを表します。しきい値未満の Alpha (Opacity) 値は 0（完全に透明）に変更され、しきい値以上の Alpha 値は 100%（完全に不透明）に変更されます。
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [AlphaBiLevel](./) が現在の [AlphaBiLevel](./) と等しいかどうかを判断します。 |
...
| **float** [get_Threshold](./get_threshold/)() override | エフェクトの閾値を返します。**float** を読み取ります。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタ データ構造を取得します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevelEffectiveData](../ialphabileveleffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Alpha Bi-Level エフェクト データを取得します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() ステートメントによるロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリー オブジェクトを使用します。 |
...
| void [set_Threshold](./set_threshold/)(**float**) override | エフェクトの閾値を返します。**float** に書き込みます。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() ステートメントのアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリー オブジェクトを使用します。 |
...
* クラス [IAlphaBiLevel](../ialphabilevel/)
