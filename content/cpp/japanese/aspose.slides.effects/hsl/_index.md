...
description: Hue/Saturation/Luminance 効果を表します。hue、saturation、luminance はそれぞれ現在の値に対して調整可能です。
type: docs
weight: 222
...
Hue/Saturation/Luminance 効果を表します。hue、saturation、luminance はそれぞれ現在の値に対して調整可能です。
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [HSL](./) が現在の [HSL](./) と等しいかどうかを判断します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Hue/Saturation/Luminance 効果データを取得します。 |
