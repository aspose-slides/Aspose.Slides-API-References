...
description: Alpha Floor エフェクトを表します。アルファ（不透明度）100% 未満の値は 0 に変更されます。つまり、部分的に透明なものはすべて完全に透明になります。
type: docs
weight: 27
...
Alpha Floor エフェクトを表します。アルファ (不透明度) が 100% 未満の値は 0 に変換されます。つまり、部分的に透明なものはすべて完全に透明になります。
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [AlphaFloor](./) が現在の [AlphaFloor](./) と等しいかどうかを判定します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Alpha Floor エフェクト データを取得します。 |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 特定型のハッシュ関数として機能します。 |
