...
description: Luminance エフェクトを表します。明るさはすべての色を白または黒に線形にシフトさせます。コントラストはすべての色を互いに近づけたり離したりするようにスケールします。
type: docs
weight: 1028
...
[Luminance](./) エフェクトを表します。明るさはすべての色を白または黒に線形にシフトさせます。コントラストはすべての色を互いに近づけたり離したりするようにスケーリングします。
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [Luminance](./) が現在の [Luminance](./) と等しいかどうかを判断します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された効果的な [Luminance](./) エフェクトデータを取得します。 |
