...
description: オブジェクトのエッジの外側に、色のぼやけた輪郭を追加する Glow 効果を表します。
type: docs
weight: 638
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | カラー形式。読み取り専用 [IColorFormat](../../aspose.slides/icolorformat/)。 |
| virtual **double** [get_Radius](./get_radius/)() | 半径。**double** を読み取ります。 |
...
| virtual void [set_Radius](./set_radius/)(**double**) | 半径。**double** を書き込みます。 |
