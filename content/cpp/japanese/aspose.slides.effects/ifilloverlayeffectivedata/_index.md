...
description: Fill Overlay 効果を表す不変オブジェクトです。Fill Overlay はオブジェクトに追加の塗りを指定し、2 つの塗りをブレンドするために使用できます。
type: docs
weight: 625
url: /ja/aspose.slides.effects/ifilloverlayeffectivedata/
---
## IFillOverlayEffectiveData クラス

Fill Overlay 効果を表す不変オブジェクトです。Fill Overlay はオブジェクトに追加の塗りを指定し、2 つの塗りをブレンドするために使用できます。
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode。読み取り専用 [FillBlendMode](../../aspose.slides/fillblendmode/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Fill フォーマット。読み取り専用 [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)。 |
