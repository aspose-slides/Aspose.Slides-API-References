...
description: カラー置換エフェクトを表します。すべてのエフェクトカラーは固定色に変更されます。アルファ値は影響を受けません。
type: docs
weight: 144
...
Color Replacement 効果を表します。すべての効果カラーは固定色に変更されます。アルファ値は影響を受けません。
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された[ColorReplace](./)が現在の[ColorReplace](./)と等しいかどうかを判定します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | すべてのピクセルの色を置き換えるカラー形式を返します。読み取り専用 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplaceEffectiveData](../icolorreplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効なカラー置換エフェクトデータを取得します。 |
...
* クラス [IColorReplace](../icolorreplace/)
