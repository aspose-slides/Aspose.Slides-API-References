...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された[InnerShadow](./)が現在の[InnerShadow](./)と等しいかどうかを判断します。 |
...
| **double** [get_BlurRadius](./get_blurradius/)() override | [Blur](../blur/) 半径。 読み取り **double**。 |
| **float** [get_Direction](./get_direction/)() override | 影の方向。 読み取り **float**。 |
| **double** [get_Distance](./get_distance/)() override | 影の距離。 読み取り **double**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | 影の色。 読み取り専用 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadowEffectiveData](../iinnershadoweffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Inner Shadow エフェクトデータを取得します。 |
...
| void [set_BlurRadius](./set_blurradius/)(**double**) override | [Blur](../blur/) 半径。 書き込み **double**。 |
| void [set_Direction](./set_direction/)(**float**) override | 影の方向。 書き込み **float**。 |
| void [set_Distance](./set_distance/)(**double**) override | 影の距離。 書き込み **double**。 |
