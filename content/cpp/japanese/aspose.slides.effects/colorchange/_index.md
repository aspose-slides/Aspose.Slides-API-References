...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [ColorChange](./) が現在の [ColorChange](./) と等しいかどうかを判断します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_FromColor](./get_fromcolor/)() override | 置き換えられるカラーです。[IColorFormat](../../aspose.slides/icolorformat/) は読み取り専用です。 |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | Parent_Immediate オブジェクトを返します。[IDOMObject](../../aspose.slides/idomobject/) は読み取り専用です。 |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | [IPresentationComponent](../../aspose.slides/ipresentationcomponent/) の親オブジェクトを返します。[IPresentationComponent](../../aspose.slides/ipresentationcomponent/) は読み取り専用です。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ToColor](./get_tocolor/)() override | 置き換えるカラーです。[IColorFormat](../../aspose.slides/icolorformat/) は読み取り専用です。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorChangeEffectiveData](../icolorchangeeffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Color Change エフェクトデータを取得します。 |
