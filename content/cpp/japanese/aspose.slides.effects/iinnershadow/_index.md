...
| virtual **float** [get_Direction](./get_direction/)() | 影の方向です。**float** を読み取ります。 |
| virtual **double** [get_Distance](./get_distance/)() | 影の距離です。**double** を読み取ります。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | 影の色です。読み取り専用 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| virtual void [set_Direction](./set_direction/)(**float**) | 影の方向です。**float** を書き込みます。 |
| virtual void [set_Distance](./set_distance/)(**double**) | 影の距離です。**double** を書き込みます。 |
