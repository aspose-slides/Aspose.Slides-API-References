...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された[PresetShadow](./)が現在の[PresetShadow](./)と等しいかどうかを判断します。 |
...
| **float** [get_Direction](./get_direction/)() override | シャドウの方向。読み取り **float**。 |
| **double** [get_Distance](./get_distance/)() override | シャドウの距離。読み取り **double**。 |
...
| [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() override | プリセット。読み取り [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | シャドウの色。読み取り専用 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadowEffectiveData](../ipresetshadoweffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効なプリセットシャドウ効果データを取得します。 |
...
| void [set_Direction](./set_direction/)(**float**) override | シャドウの方向。書き込み **float**。 |
| void [set_Distance](./set_distance/)(**double**) override | シャドウの距離。書き込み **double**。 |
| void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) override | プリセット。書き込み [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 共有参照カウントを減少させて返します。直接呼び出さないでください。代わりにスマートポインタまたは ThisProtector を使用してください。 |
...
* クラス [IPresetShadow](../ipresetshadow/)
