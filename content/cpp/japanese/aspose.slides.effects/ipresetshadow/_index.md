...
| virtual **float** [get_Direction](./get_direction/)() | 影の方向。**float** を読み取ります。 |
| virtual **double** [get_Distance](./get_distance/)() | 影の距離。**double** を読み取ります。 |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | プリセット。[PresetShadowType](../../aspose.slides/presetshadowtype/) を読み取ります。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | 影の色。読み取り専用 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| virtual void [set_Direction](./set_direction/)(**float**) | 影の方向。**float** を書き込みます。 |
| virtual void [set_Distance](./set_distance/)(**double**) | 影の距離。**double** を書き込みます。 |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | プリセット。[PresetShadowType](../../aspose.slides/presetshadowtype/) を書き込みます。 |
