...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [BrightnessContrast](./) が現在の [BrightnessContrast](./) と等しいかどうかを判断します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrastEffectiveData](../ibrightnesscontrasteffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された効果的な [BrightnessContrast](./) エフェクトデータを取得します。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | オブジェクトが targetType によって記述された型のインスタンスであるかどうかを確認します。 C# の 'is' 演算子の類似です。 |
...
* クラス [IBrightnessContrast](../ibrightnesscontrast/)
