...
description: シェイプ全体（塗りつぶしを含む）に適用されるぼかし効果を表します。アルファを含むすべてのカラーチャネルが影響を受けます。
type: docs
weight: 456
...
シェイプ全体（塗りつぶしを含む）に適用される [Blur](../blur/) エフェクトを表します。アルファを含むすべてのカラーチャネルが影響を受けます。
...
| virtual **bool** [get_Grow](./get_grow/)() | ぼかしの結果としてオブジェクトの境界を拡張すべきかを判定します。true は境界が拡張されることを示し、false は拡張されないことを示します。読み取り **bool**。 |
| virtual **double** [get_Radius](./get_radius/)() | ぼかし半径を返します。読み取り **double**。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロック機構を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティン オブジェクトを使用してください。 |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | ぼかしの結果としてオブジェクトの境界を拡張すべきかを判定します。true は境界が拡張されることを示し、false は拡張されないことを示します。書き込み **bool**。 |
| virtual void [set_Radius](./set_radius/)(**double**) | ぼかし半径を設定します。書き込み **double**。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のアンロック機構を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティン オブジェクトを使用してください。 |
