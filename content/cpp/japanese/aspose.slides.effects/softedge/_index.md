...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された[SoftEdge](./)が現在の[SoftEdge](./)と等しいかどうかを判断します。 |
...
| **double** [get_Radius](./get_radius/)() override | エッジに適用するぼかしの半径を指定します。読み取り **double**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された実効ソフトエッジ効果データを取得します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチュリーオブジェクトを使用してください。 |
...
| void [set_Radius](./set_radius/)(**double**) override | エッジに適用するぼかしの半径を指定します。書き込み **double**。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチュリーオブジェクトを使用してください。 |
