...
| virtual **float** [get_Direction](./get_direction/)() | シャドウの方向。読み取り専用 **float**。 |
| virtual **double** [get_Distance](./get_distance/)() | シャドウの距離。読み取り専用 **double**。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | シャドウの色。読み取り専用 [System::Drawing::Color](../../system.drawing/color/)。 |
