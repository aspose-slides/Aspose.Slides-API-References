...
description: Alpha Ceiling エフェクトを表します。Alpha（不透明度）の値が 0 より大きい場合は 100% に変更されます。言い換えれば、部分的に不透明なものはすべて完全に不透明になります。
type: docs
weight: 14
...
Alpha Ceiling エフェクトを表します。Alpha（opacity）の値が 0 より大きい場合は 100% に変更されます。言い換えれば、部分的に不透明なものはすべて完全に不透明になります。
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [AlphaCeiling](./) が現在の [AlphaCeiling](./) と等しいかどうかを判断します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Alpha Ceiling エフェクトデータを取得します。 |
...
* クラス [IAlphaCeiling](../ialphaceiling/)
