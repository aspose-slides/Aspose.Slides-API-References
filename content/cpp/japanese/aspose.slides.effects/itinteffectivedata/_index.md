...
description: Tint 効果を表す不変オブジェクトです。指定された量だけ色相に向けてまたは離して、効果の色値をシフトします。
type: docs
weight: 1002
url: /ja/aspose.slides.effects/itinteffectivedata/
---
## ITintEffectiveData クラス

不変オブジェクトで、[Tint](../tint/) エフェクトを表します。指定された量だけ色相に向けて/離してエフェクトの色値をシフトします。
...
| virtual **float** [get_Amount](./get_amount/)() | 効果量を返します。読み取り専用 **float**。 |
| virtual **float** [get_Hue](./get_hue/)() | 色相を返します。読み取り専用 **float**。 |
