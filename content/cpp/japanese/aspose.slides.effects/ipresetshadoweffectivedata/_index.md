...
| virtual **float** [get_Direction](./get_direction/)() | 影の方向。読み取り専用 **float**。 |
| virtual **double** [get_Distance](./get_distance/)() | 影の距離。読み取り専用 **double**。 |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | プリセット。読み取り専用 [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | 影の色。読み取り専用 [System::Drawing::Color](../../system.drawing/color/)。 |
