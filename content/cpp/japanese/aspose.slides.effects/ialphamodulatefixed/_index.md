...
description: アルファ・モジュレート・フィックス効果を表します。効果のアルファ（不透明度）値は固定パーセンテージで乗算されます。
type: docs
weight: 365
url: /ja/aspose.slides.effects/ialphamodulatefixed/
---
## IAlphaModulateFixed クラス
...
| virtual **float** [get_Amount](./get_amount/)() | 効果量をパーセントで返します。読み取りは **float**。 |
...
| virtual void [set_Amount](./set_amount/)(**float**) | 効果量をパーセントで返します。**float** に書き込みます。 |
