...
description: Alpha Inverse エフェクトを表します。Alpha（不透明度）値は 100% から減算することで反転します。
type: docs
weight: 40
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [AlphaInverse](./) が現在の [AlphaInverse](./) と等しいかどうかを判断します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverseEffectiveData](../ialphainverseeffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な Alpha Inverse エフェクトデータを取得します。 |
