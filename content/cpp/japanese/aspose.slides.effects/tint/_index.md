...
description: Tint エフェクトを表します。指定された量だけ色相に向かって/遠ざけてエフェクトのカラー値をシフトします。
type: docs
weight: 1093
...
[Tint](./) エフェクトを表します。指定された量だけ色相に向かって/遠ざけてエフェクトのカラー値をシフトします。
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された[Tint](./)が現在の[Tint](./)と等しいかどうかを判定します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | 継承が適用された有効な [Tint](./) エフェクトデータを取得します。 |
