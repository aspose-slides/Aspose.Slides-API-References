...
description: 色相/彩度/輝度エフェクトを表します。色相、彩度、輝度はそれぞれ現在の値に対して相対的に調整できます。
type: docs
weight: 703
url: /ja/aspose.slides.effects/ihsleffectivedata/
---
## IHSLEffectiveData クラス

色相/彩度/輝度エフェクトを表します。色相、彩度、輝度はそれぞれ現在の値に対して相対的に調整できます。
...
| virtual **float** [get_Hue](./get_hue/)() | 色相のパーセンテージを返します。読み取り専用 **float**。 |
| virtual **float** [get_Luminance](./get_luminance/)() | 輝度のパーセンテージを返します。読み取り専用 **float**。 |
| virtual **float** [get_Saturation](./get_saturation/)() | 彩度のパーセンテージを返します。読み取り専用 **float**。 |
