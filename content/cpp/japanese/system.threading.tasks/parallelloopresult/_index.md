...
description: Parallel ループの完了ステータスを提供します。
type: docs
weight: 14
url: /ja/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult クラス
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | ループが完了したかどうかを取得します。 |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | ブレークが発生した最小の反復インデックスを取得します。 |
...
| [ParallelLoopResult](./parallelloopresult/)() | [ParallelLoopResult](./) を構築します。 |
