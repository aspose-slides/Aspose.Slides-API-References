...
description: スレッドへのタスクキューイングの低レベル作業を処理するオブジェクトを表します。
type: docs
weight: 79
url: /ja/system.threading.tasks/taskscheduler/
---
## TaskScheduler クラス


スレッドへのタスクキューイングの低レベル作業を処理するオブジェクトを表します。
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | 現在のスレッドに関連付けられた [TaskScheduler](./) を作成します。 |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | 現在実行中のタスクに関連付けられた [TaskScheduler](./) を取得します。 |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | フレームワークが提供するデフォルトの [TaskScheduler](./) インスタンスを取得します。 |
| **int32_t** [get_Id](./get_id/)() const | この [TaskScheduler](./) の固有 ID を取得します。 |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | この [TaskScheduler](./) がサポートできる最大同時実行レベルを示します。 |
