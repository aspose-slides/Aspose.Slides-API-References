...
description: 基になる Tuple 型を知らなくても Tuple インスタンス メンバーにアクセスできる、汎用的な Tuple 実装を定義します。
type: docs
weight: 53
url: /ja/system.runtime.compilerservices/ituple/
---
## ITuple クラス

一般的な目的の[Tuple](../../system/tuple/)実装を定義し、基になる[Tuple](../../system/tuple/)型を知らなくても[Tuple](../../system/tuple/)インスタンス メンバーにアクセスできるようにします。
...
| virtual **int32_t** [get_Length](./get_length/)() const | このデータ構造の位置数を返します。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | インデックス位置の要素を返します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロック機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティリー オブジェクトを使用してください。 |
