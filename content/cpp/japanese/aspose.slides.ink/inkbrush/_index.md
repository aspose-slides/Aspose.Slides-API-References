...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | ラインのブラシ色を取得します。 |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | インクストロークの視覚スタイルを定義するインク効果タイプ（例: Galaxy、Gold、Silver）を取得します。値はブラシプロパティ "inkEffects" から解析されます。認識できる効果が指定されていない場合、[InkEffectType::NotDefined](../inkeffecttype/) が返されます。 |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | ラインのブラシサイズ（ポイント単位）を取得します。 |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | ラインのブラシ色を設定します。 |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | ポイント単位でラインのブラシサイズを設定します。 |
