...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 線のブラシ色を取得します。 |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | インクストロークの視覚スタイルを定義するインク効果タイプ（例: Galaxy、Gold、Silver）を取得します。値はブラシプロパティ "inkEffects" から解析されます。認識可能な効果が指定されていない場合、[InkEffectType::NotDefined](../inkeffecttype/) が返されます。 |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | 線のブラシサイズをポイント単位で取得します。 |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | 線のブラシ色を設定します。 |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | 線のブラシサイズをポイント単位で設定します。 |
