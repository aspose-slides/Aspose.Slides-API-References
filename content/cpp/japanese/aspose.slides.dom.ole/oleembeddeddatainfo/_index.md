...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | 埋め込み OLE オブジェクトのファイルデータを返します。読み取り専用 **uint8_t**[]。 |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | 現在の埋め込み OLE オブジェクトのファイル拡張子を返します。読み取り専用 [System::String](../../system/string/)。 |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | OLE オブジェクト用の新しい埋め込みデータ情報を作成します。 |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | OLE オブジェクト用の埋め込みデータ情報の新しいインスタンスを作成します。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th テンプレート引数を弱いポインタ（共有ではなく）に設定します。コンテナ内のポインタを弱いモードに切り替えることができます。 |
...
* クラス [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* 名前空間 [Aspose::Slides::DOM::Ole](../)
* ライブラリ [Aspose.Slides](../../)