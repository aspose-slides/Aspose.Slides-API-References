...
description: 外部ストレージへのデータ転送のための出力セーバー実装を表します。
type: docs
weight: 14
url: /ja/aspose.slides.export.xaml/ixamloutputsaver/
---
## IXamlOutputSaver クラス
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | バイト配列を目的地の場所に保存します。 |
