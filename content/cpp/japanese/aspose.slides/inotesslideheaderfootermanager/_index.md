...
description: ノートスライドのプレースホルダー（ヘッダープレースホルダーを含む）の動作を保持するマネージャーを表します。
type: docs
weight: 3030
url: /ja/aspose.slides/inotesslideheaderfootermanager/
---
## INotesSlideHeaderFooterManager クラス


ノートスライドのプレースホルダー（ヘッダー プレースホルダーを含む）の動作を保持するマネージャーを表します。
