...
description: この構造体は、フォントがレンダリングされる際の置換に関する情報を表します。
type: docs
weight: 1015
...
|  [FontSubstitutionInfo](./fontsubstitutioninfo/)([System::String](../../system/string/), [System::String](../../system/string/)) | [FontSubstitutionInfo](./) クラスのインスタンスを作成します。 |
| [System::String](../../system/string/) [get_OriginalFontName](./get_originalfontname/)() | プレゼンテーション内の元フォント名を示します。読み取り専用 [System::String](../../system/string/) |
| [System::String](../../system/string/) [get_SubstitutedFontName](./get_substitutedfontname/)() | 元フォントの置換フォント名を示します。読み取り専用 [System::String](../../system/string/) |
