...
[GeometryShape](../geometryshape/) のグラフィック パスのセグメントを表します。
...
| virtual [PathCommandType](../pathcommandtype/) [get_PathCommand](./get_pathcommand/)() | セグメントのパス型です。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_SegmentData](./get_segmentdata/)() | セグメントのパスデータです。 |
