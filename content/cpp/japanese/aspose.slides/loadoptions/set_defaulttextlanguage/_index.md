...
type: docs
weight: 326
url: /ja/aspose.slides/loadoptions/set_defaulttextlanguage/
---
## LoadOptions::set_DefaultTextLanguage(System::String) メソッド


プレゼンテーションのテキストのデフォルト言語を設定します。[System::String](../../../system/string/)を書き込みます。
