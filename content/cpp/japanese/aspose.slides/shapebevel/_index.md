...
description: シェイプの主要な面の凹凸に関するプロパティを含みます。
type: docs
weight: 5097
...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | ベベルの種類。[BevelPresetType](../bevelpresettype/) を読み取ります。 |
| **double** [get_Height](./get_height/)() override | ベベルの高さ。**double** を読み取ります。 |
...
| **double** [get_Width](./get_width/)() override | ベベルの幅。**double** を読み取ります。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリ オブジェクトを使用してください。 |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | ベベルの種類。[BevelPresetType](../bevelpresettype/) に書き込みます。 |
| void [set_Height](./set_height/)(**double**) override | ベベルの高さ。**double** に書き込みます。 |
| void [set_Width](./set_width/)(**double**) override | ベベルの幅。**double** に書き込みます。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリ オブジェクトを使用してください。 |
