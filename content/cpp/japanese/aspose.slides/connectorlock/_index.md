...
親 [Connector](../connector/) で無効になっている操作を決定します。
...
| **bool** [get_PositionMove](./get_positionmove/)() override | この形状の移動が禁止されているかどうかを判定します。読み取り **bool**。 |
| **bool** [get_RotateLocked](./get_rotatelocked/)() override | この形状の回転角の変更が禁止されているかどうかを判定します。読み取り **bool**。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() ステートメントのロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) sentinel オブジェクトを使用します。 |
...
| void [set_PositionMove](./set_positionmove/)(**bool**) override | この形状の移動が禁止されているかどうかを判定します。書き込み **bool**。 |
| void [set_RotateLocked](./set_rotatelocked/)(**bool**) override | この形状の回転角の変更が禁止されているかどうかを判定します。書き込み **bool**。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() ステートメントのロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) sentinel オブジェクトを使用します。 |
...
* クラス [IConnectorLock](../iconnectorlock/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)