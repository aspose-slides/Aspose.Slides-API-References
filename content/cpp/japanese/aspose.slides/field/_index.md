...
| [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() override | フィールドの型を返します。[IFieldType](../ifieldtype/) を参照してください。 |
...
| void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | フィールドの型を設定します。[IFieldType](../ifieldtype/) に書き込んでください。 |
