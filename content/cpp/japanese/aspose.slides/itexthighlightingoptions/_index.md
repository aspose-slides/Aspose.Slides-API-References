...
description: テキストフレーム内のテキストをハイライトするために使用できるオプションを表します。
type: docs
weight: 4109
url: /ja/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions クラス

テキストフレーム内のテキストをハイライトするために使用できるオプションを表します。
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | true に設定すると大文字小文字を区別した検索を使用し、false に設定すると区別しません。読み取り **bool**。 |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | true に設定すると単語全体に一致させ、false に設定するとそれ以外です。読み取り **bool**。 |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | true に設定すると大文字小文字を区別した検索を使用し、false に設定すると区別しません。書き込み **bool**。 |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | true に設定すると単語全体に一致させ、false に設定するとそれ以外です。書き込み **bool**。 |
...
非推奨
:   インターフェイス [ITextHighlightingOptions](./) はバージョン 24.10 のリリース後に削除されます。
