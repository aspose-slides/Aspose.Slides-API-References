...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 2つの NaN が等しいとみなされる C# スタイルの浮動小数点比較をエミュレートします (IEC 60559:1989 によると NaN は任意の値、NaN 自身を含めて等しくありません)。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 2つの NaN が等しいとみなされる C# スタイルの浮動小数点比較をエミュレートします (IEC 60559:1989 によると NaN は任意の値、NaN 自身を含めて等しくありません)。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部使用のみです。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() | ドキュメントに署名するために使用された証明書オブジェクト。読み取り専用 [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)。 |
| virtual [System::String](../../system/string/) [get_Comments](./get_comments/)() | 署名の目的。読み取り [System::String](../../system/string/)。 |
| virtual **bool** [get_IsValid](./get_isvalid/)() | このデジタル署名が有効で、ドキュメントが改ざんされていない場合、true が返されます。読み取り専用 **bool**。 |
| virtual [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() | ドキュメントが署名された時刻。読み取り専用 [System::DateTime](../../system/datetime/)。 |
...
| virtual void [set_Comments](./set_comments/)([System::String](../../system/string/)) | 署名の目的。書き込み [System::String](../../system/string/)。 |
