...
description: 線スケッチ形式のプロパティを表します。
type: docs
weight: 5162
...
| [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() override | スケッチタイプを返します。読み取り [Slides::LineSketchType](../linesketchtype/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | オブジェクトが targetType が記述する型のインスタンスであるかをチェックします。C# の 'is' 演算子の類似です。 |
...
| void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) override | スケッチタイプを設定します。書き込み [Slides::LineSketchType](../linesketchtype/)。 |
...
* クラス [ISketchFormat](../isketchformat/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)