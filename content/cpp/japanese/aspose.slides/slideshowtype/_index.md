...
description: "基本的なスライドショー設定です。先祖はスライドショーのタイプを表します: PresentedBySpeaker スピーカーによる提示（全画面） BrowsedByIndividual 個人が閲覧（ウィンドウ） BrowsedAtKiosk キオスクで閲覧（全画面）"
type: docs
weight: 5227
...
基本的なスライドショー設定です。スライドショーの種類は次の先祖が表します： [PresentedBySpeaker](../presentedbyspeaker/) スピーカーによる提示 (全画面) [BrowsedByIndividual](../browsedbyindividual/) 個人が閲覧 (ウィンドウ) [BrowsedAtKiosk](../browsedatkiosk/) キオスクで閲覧 (全画面)
