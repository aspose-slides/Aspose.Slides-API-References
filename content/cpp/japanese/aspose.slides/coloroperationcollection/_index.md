...
| メソッド | 説明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) override | コレクションの末尾に新しい操作を追加します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) override | コレクションの末尾に新しい操作を追加します。 |
| [iterator](./iterator/) [begin](./begin/)() | コレクションの最初の要素（存在する場合）のイテレータを取得します。 |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | const 修飾されたコレクションインスタンスの最初の要素（存在する場合）のイテレータを取得します。 |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | コレクションの最初の const 修飾要素（存在する場合）のイテレータを取得します。 |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | コレクションの最後の const 修飾要素（存在する場合）の直後を指すイテレータを取得します。 |
| void [Clear](./clear/)() override | すべてのカラー操作を削除します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](./clone/)() override | [ColorOperationCollection](./) コレクションのコピーを作成します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperationCollection](../icoloroperationcollection/)\> [CloneT](./clonet/)() override | 現在のオブジェクトをクローンします。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>\>, **int32_t**) override | コレクションのすべての要素を指定された配列にコピーします。 |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | const 修飾されたコレクションインスタンスの最後の要素（存在する場合）の直後を指すイテレータを取得します。 |
...
| **int32_t** [get_Count](./get_count/)() override | コレクション内の操作数を返します。読み取り専用 **int32_t**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>\>\> [GetEnumerator](./getenumerator/)() override | コレクションを列挙するイテレータを返します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) override | 指定されたインデックスの操作を返します。読み取り [ColorOperation](../coloroperation/)。 |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) override | 指定されたインデックスの操作を設定します。書き込み [ColorOperation](../coloroperation/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) override | 新しい操作をコレクションに挿入します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) override | 新しい操作をコレクションに挿入します。 |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | コレクションからカラー操作を削除します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のロック解除機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチリーオブジェクトを使用してください。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | const 修飾されたコレクションインスタンスの最初の要素（存在する場合）のイテレータを取得します。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | コレクションの最初の要素（存在する場合）のイテレータを取得します。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | const 修飾されたコレクションインスタンスの最後の要素（存在する場合）の直後を指すイテレータを取得します。 |
...
| 型定義 | 説明 |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 現在のコレクションでイテレータ型として使用されるコレクションタイプです。 |
...
* クラス [IColorOperationCollection](../icoloroperationcollection/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)