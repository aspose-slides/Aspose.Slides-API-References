...
| メソッド | 説明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [CreateFontData](./createfontdata/)([System::String](../../system/string/)) override | 指定されたフォント名で [FontData](../fontdata/) を作成します。 |
...
* クラス [IFontDataFactory](../ifontdatafactory/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)