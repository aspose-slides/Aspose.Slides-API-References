...
---
## IControlPropertiesCollection クラス
...
| メソッド | 説明 |
| --- | --- |
| virtual void [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | コレクションにプロパティを追加します。 |
...
| virtual void [Clear](./clear/)() | すべてのプロパティを削除します。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | コレクション内のプロパティ数を返します。読み取り専用 **int32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::String](../../system/string/)\>\> [get_NamesOfProperties](./get_namesofproperties/)() | コレクション内のプロパティ数を返します。読み取り専用 ICollection<string>。 |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | プロパティを返します。 |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | プロパティを設定します。 |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | 指定された名前のプロパティを削除します。 |
