...
---
## IPictureFillFormatEffectiveData クラス
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部目的のためだけです。 |
| virtual **float** [get_CropBottom](./get_cropbottom/)() | 画像の下部が切り取られた実画像高さのパーセンテージを返します。読み取り専用 **float**。 |
| virtual **float** [get_CropLeft](./get_cropleft/)() | 画像の左側が切り取られた実画像幅のパーセンテージを返します。読み取り専用 **float**。 |
| virtual **float** [get_CropRight](./get_cropright/)() | 画像の右側が切り取られた実画像幅のパーセンテージを返します。読み取り専用 **float**。 |
| virtual **float** [get_CropTop](./get_croptop/)() | 画像の上部が切り取られた実画像高さのパーセンテージを返します。読み取り専用 **float**。 |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | 画像の塗りつぶしに使用される DPI を返します。読み取り専用 **int32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | 画像を返します。読み取り専用 [IPictureEffectiveData](../ipictureeffectivedata/)。 |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | 画像塗りつぶしモードを返します。読み取り専用 [Slides::PictureFillMode](../picturefillmode/)。 |
