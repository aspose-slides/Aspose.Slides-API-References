...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() | フィールドの型を返します。読み取り [IFieldType](../ifieldtype/)。 |
...
| virtual void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | フィールドの型を設定します。書き込み [IFieldType](../ifieldtype/)。 |
