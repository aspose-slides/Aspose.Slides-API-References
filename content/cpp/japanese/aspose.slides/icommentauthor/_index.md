...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | 指定されたインデックスのこの作成者によるコメントを返します。 読み取り専用 [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | この作成者によるコメントのコレクションを返します。 読み取り専用 [ICommentCollection](../icommentcollection/)。 |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | 作成者のイニシャルを返します。 読み取り [System::String](../../system/string/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 作成者の名前を返します。 読み取り [System::String](../../system/string/)。 |
...
| void [Lock](../../system/object/lock/)() | C# lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチリーオブジェクトを使用します。 |
...
| virtual void [Remove](./remove/)() | 親コレクションから作者を削除します。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 指定された値だけ共有参照カウントを減少させます。 |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | 作者のイニシャルを設定します。書き込み [System::String](../../system/string/)。 |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | 作者の名前を設定します。書き込み [System::String](../../system/string/)。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチリーオブジェクトを使用します。 |
