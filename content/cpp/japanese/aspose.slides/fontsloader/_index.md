...
description: ユーザーが定義したカスタムフォонтを読み込むためのクラスです。プレゼンテーションオブジェクトを作成する前に使用する必要があります。
type: docs
weight: 976
...
| メソッド | 説明 |
| --- | --- |
| static void [ClearCache](./clearcache/)() | ユーザーが定義したすべてのカスタムフォントを解放します |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetFontFolders](./getfontfolders/)() | フォントフォルダーを取得します。LoadExternalFonts メソッドで追加されたフォルダーとシステムフォルダーの両方を返します |
...
| static void [LoadExternalFont](./loadexternalfont/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | バイナリデータからフォントを追加します |
| static void [LoadExternalFonts](./loadexternalfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | フォント検索のための追加フォルダーを追加します。 |
