...
description: このクラスは、長時間実行されるタスクに対して中断が要求されたかどうかを通知するために使用するトークンを表します。
type: docs
weight: 3056
...
このクラスは、長時間実行されるタスクに対し、中断が要求されたかどうかを通知するために使用するトークンを表します。
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | 中断が要求された場合、**bool**.true を返します。 |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | 空の中断トークンを表します。 |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | 中断が要求された場合、例外をスローします。 |
