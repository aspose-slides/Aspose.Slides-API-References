...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | 新しい操作をコレクションの末尾に追加します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | 新しい操作をコレクションの末尾に追加します。 |
...
| virtual void [Clear](./clear/)() | すべてのカラー操作を削除します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](../../system/icloneable/clone/)() | 現在のオブジェクトのコピーを作成し、shared ポインタとして返します。 |
| virtual T [CloneT](../igenericcloneable/clonet/)() | 現在のインスタンスのコピーである新しいオブジェクトを作成します。 |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | コレクションへのアクセスが同期（スレッドセーフ）されているかを示す値を返します。 読み取り専用 **bool**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスの操作を返します。 読み取り [IColorOperation](../icoloroperation/)。 |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | 指定されたインデックスの操作を設定します。 書き込み [IColorOperation](../icoloroperation/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | 新しい操作をコレクションに挿入します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | 新しい操作をコレクションに挿入します。 |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | コレクションからカラー操作を削除します。 |
