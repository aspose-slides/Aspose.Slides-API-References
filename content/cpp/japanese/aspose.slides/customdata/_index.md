...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) override | 指定されたインデックスのカスタム XML パートを返します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() override | カスタム XML パーツ コレクションを返します。 読み取り専用 [ICustomXmlPartCollection](../icustomxmlpartcollection/)。 |
| [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) override | 指定されたインデックスの Customer Data Tag を返します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() override | Customer Data Tags コレクションを返します。 読み取り専用 [ITagCollection](../itagcollection/)。 |
...
| void [Lock](../../system/object/lock/)() | C# lock() ステートメントのロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリー オブジェクトを使用します。 |
...
| void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) override | インデックスで指定された Customer Data Tag を設定します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ステートメントのロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリー オブジェクトを使用します。 |
