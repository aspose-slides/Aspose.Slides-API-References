...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | 指定したインデックスのこの作者によるコメントを返します。読み取り専用 [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | この作者が作成したコメントのコレクションを返します。読み取り専用 [ICommentCollection](../icommentcollection/)。 |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | 作者のイニシャルを返します。読み取り [System::String](../../system/string/)。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 作者の名前を返します。読み取り [System::String](../../system/string/)。 |
...
| void [Remove](./remove/)() override | 作者を親コレクションから削除します。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 指定された値だけ共有参照カウントを減少させます。 |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | 作者のイニシャルを設定します。書き込み [System::String](../../system/string/)。 |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | 作者の名前を設定します。書き込み [System::String](../../system/string/)。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n't番目のテンプレート引数を弱参照ポインタに設定します（共有ではなく）。コンテナ内のポインタを弱モードに切り替えることができます。 |
