...
description: ヘッダープレースホルダーを含む、ノートスライドのプレースホルダーの動作を保持するマネージャーを表します。
type: docs
weight: 4577
...
| void [SetHeaderVisibility](../basehandoutnotesslideheaderfootermanager/setheadervisibility/)(**bool**) override | スライドのヘッダープレースホルダーの可視性を変更します。 |
...
* クラス [INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)