...
ジオメトリシェイプの調整値を表します。これらの値はシェイプの形状に影響します。
...
| **float** [get_AngleValue](./get_anglevalue/)() override | 値を返し、角度（度）として解釈します。**float** を読み取ります。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | この調整値の名前を返します。読み取り専用 [System::String](../../system/string/)。 |
| **int64_t** [get_RawValue](./get_rawvalue/)() override | 調整値を「そのまま」返します。**int64_t** を読み取ります。 |
| [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() override | シェイプ調整の型を返します。読み取り専用 [ShapeAdjustmentType](../shapeadjustmenttype/)。 |
...
| void [set_AngleValue](./set_anglevalue/)(**float**) override | 値を設定し、角度（度）として解釈します。**float** に書き込みます。 |
| void [set_RawValue](./set_rawvalue/)(**int64_t**) override | 調整値を「そのまま」設定します。**int64_t** に書き込みます。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) 監視オブジェクトを使用してください。 |
