...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | 値を返します。角度（度）として解釈します。**float** を読み取ります。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | この調整値の名前を返します。読み取り専用 [System::String](../../system/string/)。 |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | 調整値を「そのまま」返します。**int64_t** を読み取ります。 |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | 形状調整の型を返します。読み取り専用 [ShapeAdjustmentType](../shapeadjustmenttype/)。 |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | 値を設定します。角度（度）として解釈します。**float** に書き込みます。 |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | 調整値を「そのまま」設定します。**int64_t** に書き込みます。 |
