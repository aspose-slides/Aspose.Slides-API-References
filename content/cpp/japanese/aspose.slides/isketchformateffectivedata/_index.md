...
description: 有効なラインスケッチプロパティを含む不変オブジェクトです。
type: docs
weight: 3745
url: /ja/aspose.slides/isketchformateffectivedata/
---
## ISketchFormatEffectiveData クラス


有効なラインスケッチプロパティを含む不変オブジェクトです。
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | スケッチタイプを返します。読み取り専用 [Slides::LineSketchType](../linesketchtype/)。 |
