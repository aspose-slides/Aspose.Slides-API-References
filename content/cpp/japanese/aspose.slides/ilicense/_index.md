...
| virtual **bool** [IsLicensed](./islicensed/)() | ライセンスがコンポーネントに適用されているか確認します。 |
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティネル オブジェクトを使用します。 |
...
| virtual void [ResetLicense](./resetlicense/)() | ライセンスをリセットします。 |
| virtual void [SetLicense](./setlicense/)([System::String](../../system/string/)) | コンポーネントにライセンスを付与します。 |
| virtual void [SetLicense](./setlicense/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | コンポーネントにライセンスを付与します。 |
...
この例では、コンポーネントが含まれるフォルダー、呼び出し元アセンブリが含まれるフォルダー、エントリ アセンブリのフォルダー、そして呼び出し元アセンブリの埋め込みリソース内で、MyLicense.lic という名前のライセンス ファイルを探します。 
```cpp
