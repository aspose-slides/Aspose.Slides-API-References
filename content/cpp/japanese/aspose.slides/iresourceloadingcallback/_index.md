...
---
## IResourceLoadingCallback クラス

外部リソースの読み込みを管理するために使用されるコールバックインターフェイスです。
...
| virtual [ResourceLoadingAction](../resourceloadingaction/) [ResourceLoading](./resourceloading/)([System::SharedPtr](../../system/sharedptr/)\<[IResourceLoadingArgs](../iresourceloadingargs/)\>) | 外部リソースの読み込みを調整するコールバックメソッドです。 |
