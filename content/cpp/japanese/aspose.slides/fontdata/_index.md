...
description: フォント定義を表します。イミュータブルです。
type: docs
weight: 911
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | [FontData](./) の 2 つのインスタンスが等しいかどうかを判断します。 |
...
|  [FontData](./fontdata/)([System::String](../../system/string/)) | 指定されたフォント名で新しい [FontData](./) オブジェクトを作成します。 |
| [System::String](../../system/string/) [get_FontName](./get_fontname/)() override | フォント名を返します。読み取り[System::String](../../system/string/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) override | テーマ参照を実際に使用されるフォントに置き換えて、フォント名を返します。 |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 特定の型に対するハッシュ関数として機能し、ハッシュアルゴリズムやハッシュテーブルのようなデータ構造での使用に適しています。 |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | 文字列表現を返します。 |
