...
| メソッド | 説明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AddEmptySection](./addemptysection/)([System::String](../../system/string/), **int32_t**) override | コレクション内の指定された位置に空のセクションを追加します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AddSection](./addsection/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | 特定のスライドから開始するスライド セクションを追加します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AppendEmptySection](./appendemptysection/)([System::String](../../system/string/)) override | コレクションの末尾に空のセクションを追加します。 |
...
| void [Clear](./clear/)() override | コレクションからすべてのセクションを削除します。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>\>, **int32_t**) override | コレクション全体を指定された配列にコピーします。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>\>\> [GetEnumerator](./getenumerator/)() override | コレクションを反復する列挙子を返します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [idx_get](./idx_get/)(**int32_t**) override | 指定されたインデックスの要素を取得します。読み取り専用 [ISection](../isection/)。 |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | コレクション内の指定されたセクションのインデックスを返します。 |
...
| void [RemoveSection](./removesection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | セクションを削除します。セクションに含まれる [Slides](../) は前のセクションにマージされます。 |
| void [RemoveSectionWithSlides](./removesectionwithslides/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | セクションとその中に含まれるスライドを削除します。 |
| void [ReorderSectionWithSlides](./reordersectionwithslides/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>, **int32_t**) override | コレクションからセクションとそのスライドを指定された位置に移動します。 |
...
| 型エイリアス | 説明 |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 現在のコレクションのイテレータ型として使用されるコレクション型です。 |
...
* クラス [ISectionCollection](../isectioncollection/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)