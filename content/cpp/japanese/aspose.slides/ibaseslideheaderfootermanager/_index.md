...
---
## IBaseSlideHeaderFooterManager クラス


フッター、日付時刻、ページ番号プレースホルダーの動作をすべてのスライドタイプで保持するマネージャーを表します。
...
| virtual **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() | 日付時刻プレースホルダーが存在することを示す値を取得します。Read**bool**。 |
| virtual **bool** [get_IsFooterVisible](./get_isfootervisible/)() | フッタープレースホルダーが存在することを示す値を取得します。Read **bool**。 |
| virtual **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() | ページ番号プレースホルダーが存在することを示す値を取得します。Read**bool**。 |
...
| virtual void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) | スライドの日時プレースホルダーにテキストを設定します。 |
| virtual void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) | スライドの日時プレースホルダーの可視性を変更します。 |
| virtual void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) | スライドのフッタープレースホルダーにテキストを設定します。 |
| virtual void [SetFooterVisibility](./setfootervisibility/)(**bool**) | スライドのフッタープレースホルダーの可視性を変更します。 |
| virtual void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) | スライドのページ番号プレースホルダーの可視性を変更します。 |
...
* クラス [IBaseHeaderFooterManager](../ibaseheaderfootermanager/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)