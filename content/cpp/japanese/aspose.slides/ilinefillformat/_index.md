...
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | 塗りつぶしタイプを返します。取得 [Slides::FillType](../filltype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() | グラデーション塗りつぶし形式を返します。読み取り専用 [IGradientFormat](../igradientformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() | パターン塗りつぶし形式を返します。読み取り専用 [IPatternFormat](../ipatternformat/)。 |
| virtual [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() | 形状と共に塗りつぶしを回転させるかどうかを決定します。取得 [NullableBool](../nullablebool/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() | 単色塗りつぶしの色を返します。読み取り専用 [IColorFormat](../icolorformat/)。 |
...
| virtual void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) | 塗りつぶしタイプを設定します。設定 [Slides::FillType](../filltype/)。 |
| virtual void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) | 形状と共に塗りつぶしを回転させるかどうかを決定します。設定 [NullableBool](../nullablebool/)。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th テンプレート引数を弱いポインタに設定します（共有ではなく）。コンテナ内のポインタを弱参照モードに切り替えることができます。 |
