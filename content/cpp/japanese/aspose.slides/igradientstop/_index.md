...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | グラデーションストップの色を返します。読み取り専用 [IColorFormat](../icolorformat/)。 |
| virtual **float** [get_Position](./get_position/)() | グラデーションストップの位置 (0..1) を返します。float を読み取ります。 |
...
| virtual void [set_Position](./set_position/)(**float**) | グラデーションストップの位置 (0..1) を設定します。float に書き込みます。 |
