...
description: テキストの 3d エフェクトプロパティを表す ThreeDFormat オブジェクトを返します。読み取り専用 IThreeDFormat。
type: docs
weight: 1
url: /ja/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() メソッド


[ThreeDFormat](../../threedformat/) オブジェクトを返します。このオブジェクトはテキストの 3d エフェクトプロパティを表します。読み取り専用 [IThreeDFormat](../../ithreedformat/)。
