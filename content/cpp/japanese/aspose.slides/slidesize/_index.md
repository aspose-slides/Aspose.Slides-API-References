...
| [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() override | スライドの向きを取得します。 |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | ポイント単位でスライドの寸法を取得します。 |
| [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() override | スライドサイズの種類を取得します。 |
...
| void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) override | スライドの向きを設定します。 |
| void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) override | タイプでスライドサイズを設定し、既存のコンテンツをスケーリングします。 |
| void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) override | スライドの寸法を明示的に設定し、既存のコンテンツをスケーリングします。 |
