...
| メソッド | 説明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)() override | 空のテキスト部分を作成します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::String](../../system/string/)) override | 指定された文字列からテキスト部分を作成します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | 指定された部分データを使用して部分を作成します。 |
...
* クラス [IPortionFactory](../iportionfactory/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)