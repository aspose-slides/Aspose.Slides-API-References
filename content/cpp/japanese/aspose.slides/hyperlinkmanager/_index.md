...
description: ハイパーリンク管理（追加、削除）を提供します。
type: docs
weight: 1249
...
| void [RemoveHyperlinkClick](./removehyperlinkclick/)() override | クリック時にハイパーリンクを削除します。 |
| void [RemoveHyperlinkMouseOver](./removehyperlinkmouseover/)() override | マウスオーバー時にハイパーリンクを削除します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkClick](./setexternalhyperlinkclick/)([System::String](../../system/string/)) override | クリック時に外部ハイパーリンクを設定します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkMouseOver](./setexternalhyperlinkmouseover/)([System::String](../../system/string/)) override | マウスオーバー時に外部ハイパーリンクを設定します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkClick](./setinternalhyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | クリック時に内部ハイパーリンクを設定します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkMouseOver](./setinternalhyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | マウスオーバー時に内部ハイパーリンクを設定します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetMacroHyperlinkClick](./setmacrohyperlinkclick/)([System::String](../../system/string/)) override | クリック時にマクロハイパーリンクを設定します。 |
...
* クラス [IHyperlinkManager](../ihyperlinkmanager/)
