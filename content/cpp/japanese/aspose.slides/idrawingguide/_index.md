...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# スタイルの浮動小数点比較をエミュレートし、IEC 60559:1989 によれば NaN はどの値とも等しくないが、2つの NaN を等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートし、IEC 60559:1989 によれば NaN はどの値とも等しくないが、2つの NaN を等しいとみなします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 描画ガイドの色を返します。[System::Drawing::Color](../../system.drawing/color/) を読み取ります。 |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | 描画ガイドの向きを返します。[Slides::Orientation](../orientation/) を読み取ります。 |
| virtual **float** [get_Position](./get_position/)() | スライドの左上隅からのポイント単位で描画ガイドの位置を返します。**float** を読み取ります。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | targetType で記述された型のインスタンスかどうかを確認します。C# の 'is' 演算子のアナログです。 |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | 描画ガイドの色を設定します。[System::Drawing::Color](../../system.drawing/color/) に書き込みます。 |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | 描画ガイドの向きを設定します。[Slides::Orientation](../orientation/) に書き込みます。 |
| virtual void [set_Position](./set_position/)(**float**) | スライドの左上隅からのポイント単位で描画ガイドの位置を設定します。**float** に書き込みます。 |
