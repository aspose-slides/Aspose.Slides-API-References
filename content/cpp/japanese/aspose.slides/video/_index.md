...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | 音声データのコピーを返します。大量のデータの場合は、[Video::GetStream](./getstream/) メソッドの使用を検討し、ビデオデータをメモリに不要にロードしたり、OutOfMemoryException が発生するのを防止してください。読み取り専用 **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | ビデオの MIME タイプを [Video::get_BinaryData](./get_binarydata/) でエンコードしたものを返します。読み取り専用 [System::String](../../system/string/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) メソッドの類似です。カスタムオブジェクトのハッシュ化を可能にします。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | 読み取り用の Stream を返します。使用後は 'using' を使用するか、ストリームを閉じてください。 |
