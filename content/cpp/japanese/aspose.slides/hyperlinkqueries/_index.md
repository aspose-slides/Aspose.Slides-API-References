...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetAnyHyperlinks](./getanyhyperlinks/)() override | null でない HyperlinkMouseOver を含むすべての [IHyperlinkContainer](../ihyperlinkcontainer/) サブオブジェクトを取得します。指定された [IHyperlinkContainer](../ihyperlinkcontainer/) オブジェクトを使用して、そのハイパーリンク（読み取り、更新、または削除）を管理できます。[IHyperlinkContainer](../ihyperlinkcontainer/) インターフェイスを参照してください。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) メソッドの類似です。カスタムオブジェクトのハッシュ化を可能にします。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkClicks](./gethyperlinkclicks/)() override | null でない HyperlinkClick を含むすべての [IHyperlinkContainer](../ihyperlinkcontainer/) サブオブジェクトを取得します。指定された [IHyperlinkContainer](../ihyperlinkcontainer/) オブジェクトを使用して、そのハイパーリンク（読み取り、更新、または削除）を管理できます。[IHyperlinkContainer](../ihyperlinkcontainer/) インターフェイスを参照してください。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkMouseOvers](./gethyperlinkmouseovers/)() override | null でない HyperlinkMouseOver を含むすべての [IHyperlinkContainer](../ihyperlinkcontainer/) サブオブジェクトを取得します。指定された [IHyperlinkContainer](../ihyperlinkcontainer/) オブジェクトを使用して、そのハイパーリンク（読み取り、更新、または削除）を管理できます。[IHyperlinkContainer](../ihyperlinkcontainer/) インターフェイスを参照してください。 |
...
| void [RemoveAllHyperlinks](./removeallhyperlinks/)() override | すべての含まれる HyperlinkClick と HyperlinkMouseOver ハイパーリンクを（すべての [IHyperlinkContainer](../ihyperlinkcontainer/) サブオブジェクト内で）削除します。 |
...
* クラス [IHyperlinkQueries](../ihyperlinkqueries/)
