...
description: グラデーション ストップを表す不変オブジェクト。
type: docs
weight: 2445
url: /ja/aspose.slides/igradientstopeffectivedata/
---
## IGradientStopEffectiveData クラス
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | グラデーション ストップの色を返します。読み取り専用 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual **float** [get_Position](./get_position/)() | グラデーション ストップの位置 (0..1) を返します。読み取り専用 **float**。 |
