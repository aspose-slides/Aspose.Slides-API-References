...
| virtual **float** [get_CenterX](./get_centerx/)() | フレームの中心の X 座標を返します。読み取り専用 **float**。 |
| virtual **float** [get_CenterY](./get_centery/)() | フレームの中心の Y 座標を返します。読み取り専用 **float**。 |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | フレームが水平に反転しているかどうかを判断します。読み取り専用 [NullableBool](../nullablebool/)。 |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | フレームが垂直に反転しているかどうかを判断します。読み取り専用 [NullableBool](../nullablebool/)。 |
| virtual **float** [get_Height](./get_height/)() | フレームの高さを返します。読み取り専用 **float**。 |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | フレームの座標を返します。読み取り専用 [System::Drawing::RectangleF](../../system.drawing/rectanglef/)。 |
| virtual **float** [get_Rotation](./get_rotation/)() | フレームが z 軸周りに回転した角度（度）を返します。正の値は時計回りの回転、負の値は反時計回りの回転を示します。読み取り専用 **float**。 |
| virtual **float** [get_Width](./get_width/)() | フレームの幅を返します。読み取り専用 **float**。 |
| virtual **float** [get_X](./get_x/)() | フレームの左上隅の X 座標を返します。読み取り専用 **float**。 |
| virtual **float** [get_Y](./get_y/)() | フレームの左上隅の Y 座標を返します。読み取り専用 **float**。 |
