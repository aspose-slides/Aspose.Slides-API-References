...
| Method | 説明 |
| --- | --- |
| **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 新しいタグをコレクションに追加します。 |
...
| void [Clear](./clear/)() override | コレクションからすべてのタグを削除します。 |
| **bool** [Contains](./contains/)([System::String](../../system/string/)) override | コレクションが特定の名前を含むかどうかを判定します。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>, **int32_t**) override | コレクションのすべての要素を指定された配列にコピーします。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | コレクションの最後の要素の直後を指すイテレータを取得します（存在する場合）。このイテレータは、[GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) が T のコピーオブジェクトを返すため、参照されたオブジェクトを変更するために使用できません。 |
...
| **int32_t** [get_Count](./get_count/)() override | コレクション内のタグ数を返します。読み取り専用 **int32_t**。 |
...
| [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) override | 指定されたインデックスのタグのキーを返します。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() override | タグの名前を返します。 |
...
| [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) override | 指定されたインデックスのタグの値を返します。 |
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | タグのキーと値のペアを返します。 |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | タグのキーと値のペアを設定します。 |
| **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) override | コレクション内の指定されたキーのゼロベースインデックスを返します。 |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | コレクションから指定された名前のタグを削除します。 |
| void [RemoveAt](./removeat/)(**int32_t**) override | 指定されたインデックスのタグを削除します。 |
...
以下の例はPowerPoint [Presentation](../presentation/) にタグを追加する方法を示しています。
```cpp
...
* クラス [ITagCollection](../itagcollection/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)