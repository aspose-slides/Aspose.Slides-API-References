...
| メソッド | 説明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) override | 新しいグラデーション ストップを作成し、コレクションの末尾に追加します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) override | 新しいグラデーション ストップを作成し、コレクションの末尾に追加します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) override | 新しいグラデーション ストップを作成し、コレクションの末尾に追加します。 |
...
| void [Clear](./clear/)() override | コレクションからすべてのグラデーション ストップを削除します。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>, **int32_t**) override | コレクションのすべての要素を指定された配列にコピーします。 |
...
| **int32_t** [get_Count](./get_count/)() override | コレクション内のグラデーション ストップの数を返します。読み取り専用 **int32_t**。 |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | コレクションへのアクセスが同期されているか（スレッドセーフ）を示す値を返します。読み取り専用 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>\> [GetEnumerator](./getenumerator/)() override | コレクションを反復する列挙子を返します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) override | インデックスでグラデーション ストップを返します。 |
| void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) override | 新しいグラデーション ストップを作成し、指定されたインデックスに挿入します。 |
| void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) override | 新しいグラデーション ストップを作成し、指定されたインデックスに挿入します。 |
| void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) override | 新しいグラデーション ストップを作成し、指定されたインデックスに挿入します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector で選択されたキー値に従って、シーケンスの要素を昇順に並べ替えます。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector で選択されたキー値に従って、シーケンスの要素を降順に並べ替えます。 |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | 指定されたインデックスのグラデーション ストップを削除します。 |
...
* クラス [IGradientStopCollection](../igradientstopcollection/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)