...
---
## IBaseHandoutNotesSlideHeaderFooterManag クラス
...
| virtual **bool** [get_IsHeaderVisible](./get_isheadervisible/)() | ヘッダープレースホルダーが存在することを示す値を取得します。Read **bool**。 |
...
| virtual void [SetDateTimeVisibility](../ibaseslideheaderfootermanager/setdatetimevisibility/)(**bool**) | スライドの日付時刻プレースホルダーの可視性を変更します。 |
...
| virtual void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) | スライドのヘッダープレースホルダーにテキストを設定します。 |
| virtual void [SetHeaderVisibility](./setheadervisibility/)(**bool**) | スライドのヘッダープレースホルダーの可視性を変更します。 |
...
元のインターフェイス名 "IBaseHandoutNotesSlideHeaderFooterManager" は、COM 互換性のために "IBaseHandoutNotesSlideHeaderFooterManag" に省略されています（型名の長さは 39 文字以下でなければなりません）。
