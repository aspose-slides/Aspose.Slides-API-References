...
description: グラデーションストップを表す不変オブジェクト。
type: docs
weight: 1158
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 指定された [GradientStopEffectiveData](./) が現在の [GradientStopEffectiveData](./) と等しいかどうかを判断します。 |
...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | グラデーションストップの色を返します。読み取り専用 [System::Drawing::Color](../../system.drawing/color/)。 |
| **float** [get_Position](./get_position/)() override | グラデーションストップの位置 (0..1) を返します。読み取り専用 **float**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタデータ構造を取得します。 |
| **int32_t** [GetHashCode](./gethashcode/)() const override | C# の Object.GetHashCode() メソッドに相当します。カスタムオブジェクトのハッシュ化を可能にします。 |
...
* クラス [IGradientStopEffectiveData](../igradientstopeffectivedata/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)