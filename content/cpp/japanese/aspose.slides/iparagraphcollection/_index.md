...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | コレクションの末尾に[Paragraph](../paragraph/)を追加します。 |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | [ParagraphCollection](../paragraphcollection/)の内容をコレクションの末尾に追加します。 |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) | 指定された HTML 文字列からテキストをコレクションに追加します。 |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) | 指定された HTML 文字列からテキストをコレクションに追加します。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | コレクションの最初の要素（存在する場合）を指すイテレータを取得します。[GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) が T のコピーオブジェクトを返すため、このイテレータでは参照対象オブジェクトを変更できません。 |
...
| virtual void [Clear](./clear/)() | コレクションからすべての要素を削除します。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | コレクションの最後の要素（存在する場合）の直後を指すイテレータを取得します。[GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) が T のコピーオブジェクトを返すため、このイテレータでは参照対象オブジェクトを変更できません。 |
...
| virtual [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) | 指定された段落を HTML に変換し、String オブジェクトとして返します。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| virtual **int32_t** [get_Count](./get_count/)() | コレクションに実際に含まれる要素数を取得します。読み取り専用 **int32_t**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスの要素を取得します。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | 指定されたインデックスに [Paragraph](../paragraph/) をコレクションに挿入します。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | 指定されたインデックスに [ParagraphCollection](../paragraphcollection/) の内容をコレクションに挿入します。 |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | シーケンスが特定の値を含むかどうかを判定します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティナオブジェクトを使用してください。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | コピーコンストラクトです。実際には何もコピーせず、新しいオブジェクトを初期化し、サブクラスのコピー構築を可能にします。 |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | 特定の段落の最初の出現を削除します。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# の [Object.ToString()](../../system/object/tostring/) メソッドのアナログです。カスタムオブジェクトを文字列に変換できます。 |
