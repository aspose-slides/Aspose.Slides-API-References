...
---
## IOleEmbeddedDataInfo クラス


埋め込みOLEオブジェクトのデータ情報を表します。
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | 埋め込みOLEオブジェクトのファイルデータを返します（読み取り専用 **uint8_t**[]）。 |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | 現在の埋め込みOLEオブジェクトのファイル拡張子を返します（読み取り専用 [System::String](../../system/string/)）。 |
