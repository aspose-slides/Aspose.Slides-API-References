...
description: プレゼンテーション内のすべてのレイアウトスライドのコレクションを表します。個々のマスターのレイアウトスライドのコレクションを統合するコンテキストで、レイアウトスライドを追加/クローンするメソッドを備えた LayoutSlideCollection クラスを拡張します。
type: docs
weight: 1093
...
プレゼンテーション内のすべてのレイアウトスライドのコレクションを表します。[LayoutSlideCollection](../layoutslidecollection/) クラスを拡張し、マスターのレイアウトスライドの個々のコレクションを統合するコンテキストでレイアウトスライドを追加/クローンするメソッドを提供します。
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | プレゼンテーションに新しいレイアウトスライドを追加します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | 指定されたレイアウトスライドのコピーをプレゼンテーションに追加します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | 指定されたレイアウトスライドのコピーをプレゼンテーションに追加します。 |
| [iterator](../layoutslidecollection/iterator/) [begin](../layoutslidecollection/begin/)() | コレクションの最初の要素（存在する場合）を指すイテレータを取得します。 |
| [const_iterator](../layoutslidecollection/const_iterator/) [begin](../layoutslidecollection/begin/)() const | コレクションの const 修飾インスタンスの最初の要素（存在する場合）を指すイテレータを取得します。 |
...
| [const_iterator](../layoutslidecollection/const_iterator/) [cend](../layoutslidecollection/cend/)() const | コレクションの最後の const 修飾要素の直後（存在する場合）を指すイテレータを取得します。 |
...
| [iterator](../layoutslidecollection/iterator/) [end](../layoutslidecollection/end/)() | コレクションの最後の要素の直後（存在する場合）を指すイテレータを取得します。 |
| [const_iterator](../layoutslidecollection/const_iterator/) [end](../layoutslidecollection/end/)() const | コレクションの const 修飾インスタンスの最後の要素の直後（存在する場合）を指すイテレータを取得します。 |
...
| **int32_t** [get_Count](../layoutslidecollection/get_count/)() override | コレクション内のレイアウトスライドの数を返します。読み取り専用 **int32_t**。 |
| **bool** [get_IsSynchronized](../layoutslidecollection/get_issynchronized/)() override | コレクションへのアクセスが同期（スレッド安全）されているかどうかを示す値を返します。読み取り専用 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../layoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) override | 指定された型の最初のレイアウトスライドを返します。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | シーケンスが要素を含むかどうかを判断します。 |
...
| void [RemoveUnused](../layoutslidecollection/removeunused/)() override | 未使用のレイアウトスライドを削除します（HasDependingSlides が false のレイアウトスライド）。 |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndConstIterator](../layoutslidecollection/virtualizeendconstiterator/)() const override | コレクションの const 修飾インスタンスの最後の要素の直後（存在する場合）を指すイテレータを取得します。 |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndIterator](../layoutslidecollection/virtualizeenditerator/)() override | コレクションの最後の要素の直後（存在する場合）を指すイテレータを取得します。 |
...
* クラス [IGlobalLayoutSlideCollection](../igloballayoutslidecollection/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)