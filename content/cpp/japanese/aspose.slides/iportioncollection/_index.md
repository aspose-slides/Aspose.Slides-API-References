...
| メソッド | 説明 |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | コレクションの末尾に[Portion](../portion/)を追加します。 |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | [ICollection](../../system.collections.generic/icollection/)が特定の値を含むかどうかを判定します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [idx_get](./idx_get/)(**int32_t**) | 指定したインデックスの要素を取得します。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | コレクション内の特定のポーションのインデックスを決定します。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | 指定したインデックスに[Portion](../portion/)をコレクションへ挿入します。 |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | 数値系列の平均を計算します。 |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 入力シーケンスの各要素に変換関数を適用して得られる値の系列の平均を計算します。 |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | 特定のオブジェクトを [ICollection](../../system.collections.generic/icollection/) から最初に見つかったものを削除します。 |
