...
| Method | Description |
| --- | --- |
| virtual void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | この部分を自動的に更新されるフィールドに変換します。 |
| virtual void [AddField](./addfield/)([System::String](../../system/string/)) | この部分を自動的に更新されるフィールドに変換します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() | この部分のフィールドを返します。読み取り専用 [IField](../ifield/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() | テキスト部分の明示的に設定された書式プロパティを含む書式オブジェクトを返します（継承は適用されません）。読み取り専用 [IPortionFormat](../iportionformat/)。 |
...
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | 部分のプレーンテキストを取得します。取得 [System::String](../../system/string/)。 |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() | 部分の開始位置の座標を取得します。ポイントの X 座標は、左側ベアリングを含む最初の文字からの部分の開始を表します。Y 座標は上側ベアリングを含みます。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) メソッドのアナログです。カスタムオブジェクトのハッシュ化を可能にします。 |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | 部分を囲む矩形の座標を取得します。矩形は、空行を含む部分内のすべてのテキスト行を含みます。 |
...
| virtual void [RemoveField](./removefield/)() | このフィールド部分をシンプルな部分に変換します。 |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | 部分のプレーンテキストを設定します。[System::String](../../system/string/) に書き込みます。 |
