...
| メソッド | 説明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [AddAuthor](./addauthor/)([System::String](../../system/string/), [System::String](../../system/string/)) | コレクションの末尾に新しい作成者を追加します。 |
...
| virtual void [Clear](./clear/)() | コレクションからすべての作成者を削除します。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByName](./findbyname/)([System::String](../../system/string/)) | 名前でコレクション内の作成者を検索します。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByNameAndInitials](./findbynameandinitials/)([System::String](../../system/string/), [System::String](../../system/string/)) | 名前とイニシャルでコレクション内の作成者を検索します。 |
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | コレクション内の動作数を返します。読み取り専用 **int32_t**。 |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | コレクションへのアクセスが同期化（スレッドセーフ）されているかどうかを示す値を返します。読み取り専用 **bool**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスの要素を取得します。読み取り専用 [ICommentAuthor](../icommentauthor/)。 |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>) | コレクション内で指定された作成者の最初の出現を削除します。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | コレクションの指定インデックスにある作成者を削除します。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [ToArray](./toarray/)() | すべての作成者を含む配列を作成して返します。 |
