...
description: 有効なシェイプの面リリーフプロパティを含むイミュータブルオブジェクトです。
type: docs
weight: 3667
url: /ja/aspose.slides/ishapebeveleffectivedata/
---
## IShapeBevelEffectiveData クラス


有効なシェイプの面リリーフプロパティを含むイミュータブルオブジェクトです。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN はどの値とも等しくありませんが、2つの NaN を等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートします。IEC 60559:1989 によれば NaN はどの値とも等しくありませんが、2つの NaN を等しいとみなします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途のみです。 |
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | ベベルタイプ。読み取り専用 [BevelPresetType](../bevelpresettype/)。 |
| virtual **double** [get_Height](./get_height/)() | ベベルの高さ。読み取り専用 **double**。 |
| virtual **double** [get_Width](./get_width/)() | ベベルの幅。読み取り専用 **double**。 |
