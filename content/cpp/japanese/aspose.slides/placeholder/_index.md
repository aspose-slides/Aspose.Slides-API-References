...
| **uint32_t** [get_Index](./get_index/)() override | プレースホルダーのインデックスを取得します。読み取り専用 **uint32_t**。 |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | プレースホルダーの向きを取得します。読み取り専用 [Slides::Orientation](../orientation/)。 |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | プレースホルダーのサイズを取得します。読み取り専用 [PlaceholderSize](../placeholdersize/)。 |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | プレースホルダーのタイプを取得します。読み取り専用 [PlaceholderType](../placeholdertype/)。 |
