...
description: プレゼンテーションで定義されているすべてのスライド セクションのリストを返します。読み取り専用 ISectionCollection.
type: docs
weight: 66
url: /ja/aspose.slides/presentation/get_sections/
---
...
次の例は PowerPoint [Presentation](../) でセクションを作成する方法を示しています。 
```cpp
