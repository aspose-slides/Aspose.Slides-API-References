...
---
## Presentation::Save(System::String, Export::SaveFormat) メソッド
...
| --- | --- | --- |
| fname | [System::String](../../../system/string/) | 作成されたファイルへのパス。 |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | エクスポートされるデータの形式。 |

## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) メソッド
...
| Parameter | Type | Description |
| --- | --- | --- |
| stream | [System::SharedPtr](../../../system/sharedptr/)\<[System::IO::Stream](../../../system.io/stream/)\> | 出力ストリーム。 |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | エクスポートされるデータの形式。 |

## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) メソッド
...
| fname | [System::String](../../../system/string/) | 作成されたファイルへのパス。 |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | エクスポートされるデータの形式。 |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Export::ISaveOptions](../../../aspose.slides.export/isaveoptions/)\> | 追加の形式オプション。 |

## 備考

次の例は、C++ を使用して PowerPoint を HTML に変換する方法を示します。  
```cpp
// プレゼンテーションファイル（例：PPT、PPTX、ODPなど）を表すプレゼンテーションオブジェクトをインスタンス化します。
...
```  
次の例は、C++ を使用して PowerPoint をノート付き HTML に変換する方法を示します。  
```cpp
...
```  
次の例は、C++ を使用して PowerPoint を元のフォントを保持した HTML に変換する方法を示します。  
```cpp
...
```  
次の例は、C++ を使用して PowerPoint を 150 DPI の高品質画像付き HTML に変換する方法を示します。  
```cpp
...
```  
次の例は、C++ を使用して PowerPoint をフルクオリティ画像付き HTML に変換する方法を示します。  
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```  
次の例は、C++ を使用して [Slide](../../slide/) を HTML に変換する方法を示します。  
```cpp
```
...
* 列挙体 [SaveFormat](../../../aspose.slides.export/saveformat/)
