...
description: 外部フォント用のファイルおよびメモリソースを提供します。
type: docs
weight: 1002
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_FontFolders](./get_fontfolders/)() override | フォントファイルを含むフォルダー。これらのフォルダー内のすべてのフォントファイルがコレクションに含まれ、再帰的に検索されます。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\> [get_MemoryFonts](./get_memoryfonts/)() override | バイト配列として表現されたフォントのコレクションです。 |
...
| void [set_FontFolders](./set_fontfolders/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) override | フォントファイルを含むフォルダー。これらのフォルダー内のすべてのフォントファイルがコレクションに含まれ、再帰的に検索されます。 |
| void [set_MemoryFonts](./set_memoryfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\>) override | バイト配列として表現されたフォントのコレクションです。 |
