...
description: カラー変換に使用されるさまざまな色操作を表します。
type: docs
weight: 1704
...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | 操作のタイプを返します。読み取り専用 [ColorTransformOperation](../colortransformoperation/)。 |
| virtual **float** [get_Parameter](./get_parameter/)() | 操作のパラメータを返します。読み取り専用 **float**。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 共有参照カウントをデクリメントし、値を返します。直接呼び出すべきではありません。スマートポインタまたは ThisProtector を使用してください。 |
