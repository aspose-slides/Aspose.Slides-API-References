...
---
## ICommonSlideViewProperties クラス
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | 指定されたインデックスの描画ガイドを返します。読み取り専用 [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | 描画ガイドのコレクションを返します。読み取り専用 [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | ビューの拡大縮小率をパーセンテージで指定します。読み取り **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | ビュー コンテンツが現在のウィンドウサイズに最適に自動的に拡大縮小されるよう指定します。読み取り **bool**. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | ビューの拡大縮小率をパーセンテージで指定します。書き込み **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | ビュー コンテンツが現在のウィンドウサイズに最適に自動的に拡大縮小されるよう指定します。書き込み **bool**. |
