...
type: docs
weight: 2315
url: /ja/aspose.slides/igenericcloneable/
---
## IGenericCloneable クラス
...
| メソッド | 説明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](../../system/icloneable/clone/)() | 現在のオブジェクトのコピーを作成し、その共有ポインタを返します。 |
| virtual T [CloneT](./clonet/)() | 現在のインスタンスのコピーである新しいオブジェクトを作成します。 |
