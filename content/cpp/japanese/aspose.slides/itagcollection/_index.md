...
| メソッド | 説明 |
| --- | --- |
| virtual **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | コレクションに新しいタグを追加します。 |
...
| virtual void [Clear](./clear/)() | コレクションからすべてのタグを削除します。 |
| virtual **bool** [Contains](./contains/)([System::String](../../system/string/)) | コレクションが特定の名前を含むかどうかを判定します。 |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | コレクションへのアクセスが同期化（スレッドセーフ）されているかを示す値を返します。読み取り専用 **bool**。 |
...
| virtual [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) | 指定されたインデックスのタグのキーを返します。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() | タグの名前を返します。 |
...
| virtual [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) | 指定されたインデックスのタグの値を返します。 |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | タグのキーと値のペアを返します。 |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | タグのキーと値のペアを設定します。 |
| virtual **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) | コレクション内の指定されたキーのゼロベースインデックスを返します。 |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | コレクションから指定された名前のタグを削除します。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 指定されたインデックスのタグを削除します。 |
