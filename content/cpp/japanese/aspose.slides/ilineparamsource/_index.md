...
description: 補助ラインパラメータ インターフェイス。
type: docs
weight: 2783
url: /ja/aspose.slides/ilineparamsource/
---
## ILineParamSource クラス
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | オブジェクトが targetType で記述された型のインスタンスかどうかを確認します。C# 'is' 演算子の類似です。 |
