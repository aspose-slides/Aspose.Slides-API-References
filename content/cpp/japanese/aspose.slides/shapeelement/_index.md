...
| [ShapeElementFillSource](../shapeelementfillsource/) [get_FillSource](./get_fillsource/)() | 要素の塗りつぶし方法に関する情報を返します。読み取り専用 [ShapeElementFillSource](../shapeelementfillsource/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[Shape](../shape/)\> [get_ParentShape](./get_parentshape/)() | 要素が作成された Shape_PPT を返します。読み取り専用 [Shape](../shape/)。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_PathPoints](./get_pathpoints/)() | 要素のパスのジオメトリを定義する点の配列を取得します。 |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_PathTypes](./get_pathtypes/)() | 要素のパス内の各点のタイプを指定するバイト値の配列を取得します。 |
| [ShapeElementStrokeSource](../shapeelementstrokesource/) [get_StrokeSource](./get_strokesource/)() | 要素のストローク方法に関する情報を返します。読み取り専用 [ShapeElementStrokeSource](../shapeelementstrokesource/)。 |
...
* クラス [IShapeElement](../ishapeelement/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)