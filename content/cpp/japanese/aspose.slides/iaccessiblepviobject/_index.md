...
description: 継承が適用された状態で対応する有効データを返すことができる型を表します。
type: docs
weight: 1275
url: /ja/aspose.slides/iaccessiblepviobject/
---
## IAccessiblePVIObject クラス


継承が適用された状態で対応する有効データを返すことができる型を表します。
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部向けのみです。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| virtual T [GetEffective](./geteffective/)() | 継承が適用された有効データを取得します。 |
