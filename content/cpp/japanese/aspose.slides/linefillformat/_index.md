...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくありませんが、C# スタイルの浮動小数点比較をエミュレートし、NaN 同士を等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN はどの値とも等しくありませんが、C# スタイルの浮動小数点比較をエミュレートし、NaN 同士を等しいとみなします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() override | 塗りつぶしタイプを返します。読み取り [Slides::FillType](../filltype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() override | グラデーション塗りつぶし形式を返します。読み取り専用 [IGradientFormat](../igradientformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() override | パターン塗りつぶし形式を返します。読み取り専用 [IPatternFormat](../ipatternformat/)。 |
| [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() override | 塗りつぶしがシェイプとともに回転すべきかを判断します。読み取り [NullableBool](../nullablebool/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() override | 単色塗りつぶしの色を返します。読み取り専用 [IColorFormat](../icolorformat/)。 |
...
| void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) override | 塗りつぶしタイプを設定します。書き込み [Slides::FillType](../filltype/)。 |
| void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) override | 塗りつぶしがシェイプとともに回転すべきかを判断します。書き込み [NullableBool](../nullablebool/)。 |
...
* クラス [ILineFillFormat](../ilinefillformat/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)