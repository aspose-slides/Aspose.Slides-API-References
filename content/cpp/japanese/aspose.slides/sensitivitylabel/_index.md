...
| [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() override | 感度ラベルの割り当て方法を返します。参照 [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() override | ファイルに適用すべきコンテンツマーキングのタイプの一覧を返します。 |
| [System::String](../../system/string/) [get_Id](./get_id/)() override | 感度ラベルの ID を返します。参照 [System::String](../../system/string/)。 |
| **bool** [get_IsEnabled](./get_isenabled/)() override | 感度ラベルが有効かどうかを示します。 |
| **bool** [get_IsRemoved](./get_isremoved/)() override | 感度ラベルが削除されたかどうかを示します。 |
| [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() override | 感度ラベルを記述する感度ラベル ポリシーに対応する Azure Active Directory (Azure AD) サイト識別子を返します。参照 [System::Guid](../../system/guid/)。 |
...
| void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) override | 感度ラベルの割り当て方法を設定します。書き込み [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)。 |
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | 感度ラベルの ID を設定します。書き込み [System::String](../../system/string/)。 |
| void [set_IsEnabled](./set_isenabled/)(**bool**) override | 感度ラベルが有効かどうかを示します。 |
| void [set_IsRemoved](./set_isremoved/)(**bool**) override | 感度ラベルが削除されたかどうかを示します。 |
| void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) override | 感度ラベルを記述する感度ラベル ポリシーに対応する Azure Active Directory (Azure AD) サイト識別子を設定します。書き込み [System::Guid](../../system/guid/)。 |
