...
description: テキスト フレーム内のテキストをハイライトするために使用できるオプションを表します。
type: docs
weight: 5474
url: /ja/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions クラス

テキスト フレーム内のテキストをハイライトするために使用できるオプションを表します。
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | 大文字小文字を区別する検索を使用する場合は true、そうでない場合は false を設定します。**bool** を読み取ります。 |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | 全単語にマッチさせる場合は true、そうでない場合は false を設定します。**bool** を読み取ります。 |
...
| void [Lock](../../system/object/lock/)() | C# lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティリオブジェクトを使用します。 |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | 大文字小文字を区別する検索を使用する場合は true、そうでない場合は false を設定します。**bool** に書き込みます。 |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | 全単語にマッチさせる場合は true、そうでない場合は false を設定します。**bool** に書き込みます。 |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | 新しいデフォルトのテキストハイライトオプションを作成します。 |
...
非推奨
:   インターフェイス [ITextHighlightingOptions](../itexthighlightingoptions/) はバージョン 24.10 のリリース後に削除されます。
