...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) | 指定された型の最初のレイアウトスライドを返します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) | インデックスでレイアウトスライドを返します。読み取り専用 [ILayoutSlide](../ilayoutslide/)。 |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | コレクションからレイアウトを削除します。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 指定された値だけ共有参照カウントを減少させます。 |
| virtual void [RemoveUnused](./removeunused/)() | 未使用のレイアウトスライド（HasDependingSlides が false のもの）を削除します。 |
