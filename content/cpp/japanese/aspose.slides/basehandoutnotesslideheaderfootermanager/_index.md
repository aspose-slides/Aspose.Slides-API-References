...
description: すべての種類の配布資料およびノートスライドのヘッダープレースホルダーを含む、プレースホルダーの動作を保持するマネージャーを表します。
type: docs
weight: 118
...
プレースホルダーの動作を保持するマネージャーを表します。すべての種類の配布資料およびノートスライドのヘッダープレースホルダーを含みます。
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | 日時プレースホルダーが存在するかを示す値を取得します。Read**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | フッタープレースホルダーが存在するかを示す値を取得します。Read **bool**. |
| **bool** [get_IsHeaderVisible](./get_isheadervisible/)() override | ヘッダープレースホルダーが存在するかを示す値を取得します。Read **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | ページ番号プレースホルダーが存在するかを示す値を取得します。Read**bool**. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | スライドの日時プレースホルダーにテキストを設定します。 |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | スライドの日時プレースホルダーの表示状態を変更します。 |
...
| void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) override | スライドのヘッダープレースホルダーにテキストを設定します。 |
| void [SetHeaderVisibility](./setheadervisibility/)(**bool**) override | スライドのヘッダープレースホルダーの表示状態を変更します。 |
