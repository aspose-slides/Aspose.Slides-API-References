...
| void [CopyTo](../cellcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>, **int32_t**) override | コレクションのすべての要素を指定された配列にコピーします。 |
...
| **double** [get_Height](./get_height/)() override | 行の高さを返します。読み取り専用 **double**。 |
| **bool** [get_IsSynchronized](../cellcollection/get_issynchronized/)() override | コレクションへのアクセスが同期化されているか（スレッドセーフ）を示す値を返します。読み取り専用 **bool**。 |
| **double** [get_MinimalHeight](./get_minimalheight/)() override | 行の最小可能高さを返します。読み取り **double**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() override | この行の書式設定プロパティを含む [RowFormat](../rowformat/) オブジェクトを返します。読み取り専用 [IRowFormat](../irowformat/)。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | シーケンスの各要素をインデックスを組み込んだ新しい形に変換します。 |
...
| void [set_MinimalHeight](./set_minimalheight/)(**double**) override | 行の最小可能高さを設定します。**double** を書き込みます。 |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | すべての行セルの部分に定義された部分書式プロパティを設定します。 |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | すべての行セルの段落に定義された段落書式プロパティを設定します。 |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | すべての行セルのテキストフレームに定義されたテキストフレーム書式プロパティを設定します。 |
