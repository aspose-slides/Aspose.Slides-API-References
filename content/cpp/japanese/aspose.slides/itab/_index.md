...
| メソッド | 説明 |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | 現在のオブジェクトを指定されたオブジェクトと比較します。 |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | タブの揃えスタイルを返します。[TabAlignment](../tabalignment/) を参照してください。 |
| virtual **double** [get_Position](./get_position/)() | タブの位置を返します。このプロパティに代入するとコレクション内のタブのインデックスが変更され、Enumerator が無効になる可能性があります。**double** を参照してください。 |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | タブの揃えスタイルを設定します。[TabAlignment](../tabalignment/) に書き込みます。 |
| virtual void [set_Position](./set_position/)(**double**) | タブの位置を設定します。このプロパティに代入するとコレクション内のタブのインデックスが変更され、Enumerator が無効になる可能性があります。**double** に書き込みます。 |
