...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | [BackgroundType::OwnBackground](../backgroundtype/) 塗りつぶし用の [EffectFormat](../effectformat/) を返します。読み取り専用 [IEffectFormat](../ieffectformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | [BackgroundType::OwnBackground](../backgroundtype/) 塗りつぶし用の [FillFormat](../fillformat/) を返します。読み取り専用 [IFillFormat](../ifillformat/)。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | [BackgroundType::Themed](../backgroundtype/) 塗りつぶし用の [ColorFormat](../colorformat/) を返します。読み取り専用 [IColorFormat](../icolorformat/)。 |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | 背景テーマコレクション内の [BackgroundType::Themed](../backgroundtype/) 塗りつぶしのインデックスを返します。0 は塗りつぶしなしを意味します。1..999 はインデックスです。読み取り **uint16_t**。 |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | 背景塗りつぶしのタイプを返します。読み取り [BackgroundType](../backgroundtype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | 継承が適用された有効な背景データを取得します。 |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | 背景テーマコレクション内の [BackgroundType::Themed](../backgroundtype/) 塗りつぶしのインデックスを返します。0 は塗りつぶしなしを意味します。1..999 はインデックスです。書き込み **uint16_t**。 |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | 背景塗りつぶしのタイプを返します。書き込み [BackgroundType](../backgroundtype/)。 |
