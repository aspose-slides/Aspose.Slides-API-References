...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | クローズドキャプションのバイナリデータを返します。読み取り専用 **uint8_t**[]. |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | クローズドキャプションのグローバル一意識別子 (GUID) を返します。読み取り専用 [System::Guid](../../system/guid/)。 |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | クローズドキャプションのデータを UTF-8 エンコードされた文字列として返します。読み取り専用 [System::String](../../system/string/)。 |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | クローズドキャプションのラベルを返します。読み取り [System::String](../../system/string/)。 |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | クローズドキャプションのラベルを設定します。書き込み [System::String](../../system/string/)。 |
