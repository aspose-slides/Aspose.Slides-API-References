...
| virtual [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() | 感度ラベルの割り当て方法を返します。[SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) を参照してください。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() | ファイルに適用すべきコンテンツマークのタイプのリストを返します。 |
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | 感度ラベルの ID を返します。[System::String](../../system/string/) を参照してください。 |
| virtual **bool** [get_IsEnabled](./get_isenabled/)() | 感度ラベルが有効かどうかを示します。 |
| virtual **bool** [get_IsRemoved](./get_isremoved/)() | 感度ラベルが削除されたかどうかを示します。 |
| virtual [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() | 感度ラベルを記述する感度ラベル ポリシーに対応する Azure Active Directory (Azure AD) サイト識別子を返します。[System::Guid](../../system/guid/) を参照してください。 |
...
| virtual void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | 感度ラベルの割り当て方法を設定します。[SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) に書き込みます。 |
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | 感度ラベルの ID を設定します。[System::String](../../system/string/) に書き込みます。 |
| virtual void [set_IsEnabled](./set_isenabled/)(**bool**) | 感度ラベルが有効かどうかを示します。 |
| virtual void [set_IsRemoved](./set_isremoved/)(**bool**) | 感度ラベルが削除されたかどうかを示します。 |
| virtual void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) | 感度ラベルを記述する感度ラベル ポリシーに対応する Azure Active Directory (Azure AD) サイト識別子を設定します。[System::Guid](../../system/guid/) に書き込みます。 |
