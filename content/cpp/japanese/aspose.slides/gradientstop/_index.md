...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | グラデーション ストップの色を返します。読み取り専用 [IColorFormat](../icolorformat/)。 |
...
| **float** [get_Position](./get_position/)() override | グラデーション ストップの位置 (0..1) を返します。**float** を読み取ります。 |
...
| void [set_Position](./set_position/)(**float**) override | グラデーション ストップの位置 (0..1) を設定します。**float** を書き込みます。 |
