...
description: 継承なしで段落のテキスト配置を設定します。TextAlignment を記述します。
type: docs
weight: 14
url: /ja/aspose.slides/paragraphformat/set_alignment/
---
## ParagraphFormat::set_Alignment(TextAlignment) メソッド


段落内のテキスト配置を継承せずに設定します。[TextAlignment](../../textalignment/) を書きます。
...
次のサンプルコードは、PowerPoint [Presentation](../../presentation/) でテキスト段落を整列する方法を示しています。
```cpp
...
* 列挙体 [TextAlignment](../../textalignment/)
* クラス [ParagraphFormat](../)
* 名前空間 [Aspose::Slides](../../)
* ライブラリ [Aspose.Slides](../../../)