...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\> [get_Column](./get_column/)(**int32_t**) override | 指定されたインデックスの列を返します。読み取り専用 [Aspose::Slides::IColumn](../icolumn/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnCollection](../icolumncollection/)\> [get_Columns](./get_columns/)() override | 列のコレクションを返します。読み取り専用 [IColumnCollection](../icolumncollection/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](../shape/get_effectformat/)() override | [EffectFormat](../effectformat/) オブジェクトを返します。このオブジェクトはシェイプに適用されたピクセル効果を含みます。注: 効果プロパティを持たない特定のシェイプタイプでは null を返す可能性があります。読み取り専用 [IEffectFormat](../ieffectformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | [Table](./) の塗りつぶし書式を含む [TableFormat::get_FillFormat](../tableformat/get_fillformat/) オブジェクトを返します。読み取り専用 [IFillFormat](../ifillformat/)。 |
| **bool** [get_FirstCol](./get_firstcol/)() override | テーブルの最初の列が特別な書式で描画されるかどうかを判定します。読み取り **bool**。 |
| **bool** [get_FirstRow](./get_firstrow/)() override | テーブルの最初の行が特別な書式で描画されるかどうかを判定します。読み取り **bool**。 |
...
| **bool** [get_HorizontalBanding](./get_horizontalbanding/)() override | 偶数行が異なる書式で描画されるかどうかを判定します。読み取り **bool**。 |
...
| **bool** [get_LastCol](./get_lastcol/)() override | テーブルの最後の列が特別な書式で描画されるかどうかを判定します。読み取り **bool**。 |
| **bool** [get_LastRow](./get_lastrow/)() override | テーブルの最後の行が特別な書式で描画されるかどうかを判定します。読み取り **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_LineFormat](../shape/get_lineformat/)() override | [LineFormat](../lineformat/) オブジェクトを返します。このオブジェクトはシェイプの線書式プロパティを含みます。注: 線プロパティを持たない特定のシェイプタイプでは null を返す可能性があります。読み取り専用 [ILineFormat](../ilineformat/)。 |
...
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | シェイプの生存期間中に一定であり、PowerPoint や相互運用コードがドキュメント内の任意の場所からシェイプを確実に参照できるスライドスコープの一意識別子を返します。読み取り専用 **uint32_t**。参照 [Shape::get_UniqueId](../shape/get_uniqueid/)。 |
...
| **bool** [get_RightToLeft](./get_righttoleft/)() override | テーブルが右から左への読み順かどうかを判定します。読み取り **bool**。 |
| **float** [get_Rotation](../shape/get_rotation/)() override | 指定されたシェイプが Z 軸周りに回転した度数を返します。正の値は時計回り、負の値は反時計回りを示します。読み取り **float**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [get_Row](./get_row/)(**int32_t**) override | 指定されたインデックスの行を返します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IRowCollection](../irowcollection/)\> [get_Rows](./get_rows/)() override | 行のコレクションを返します。読み取り専用 [IRowCollection](../irowcollection/)。 |
...
| [TableStylePreset](../tablestylepreset/) [get_StylePreset](./get_stylepreset/)() override | 組み込みテーブルスタイルを取得します。参照 [TableStylePreset](../tablestylepreset/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormat](../itableformat/)\> [get_TableFormat](./get_tableformat/)() override | [TableFormat](../tableformat/) オブジェクトを返します。このオブジェクトはこのテーブルの書式プロパティを含みます。読み取り専用 [ITableFormat](../itableformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../ithreedformat/)\> [get_ThreeDFormat](../shape/get_threedformat/)() override | [ThreeDFormat](../threedformat/) オブジェクトを返します。このオブジェクトはシェイプの 3D 効果プロパティを含みます。注: 3D プロパティを持たない特定のシェイプタイプでは null を返す可能性があります。読み取り専用 [IThreeDFormat](../ithreedformat/)。 |
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | アドインやその他のコードで使用されることを意図した、内部のプレゼンテーションスコープ識別子を返します。この値はユーザーやプログラムによって再割り当て可能なため、永続的な一意キーとして扱ってはいけません。読み取り専用 **uint32_t**。参照 [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)。 |
| **bool** [get_VerticalBanding](./get_verticalbanding/)() override | 偶数列が異なる書式で描画されるかどうかを判定します。読み取り **bool**。 |
...
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | シェイプの Z 順序での位置を返します。Shapes[0] は Z 順序の背面にあるシェイプを返し、Shapes[Shapes.Count - 1] は最前面のシェイプを返します。読み取り専用 **int32_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../shape/getbaseplaceholder/)() override | 基本的なプレースホルダーシェイプを返します（現在のシェイプが継承しているレイアウトやマスタースライドからのシェイプ）。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンターデータ構造を取得します。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) メソッドのアナログです。カスタムオブジェクトのハッシュ化を可能にします。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../shape/getimage/)() override | シェイプのサムネイルを返します。[ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) シェイプのサムネイル境界タイプがデフォルトで使用されます。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](./idx_get/)(**int32_t**, **int32_t**) override | 指定された列と行インデックスのセルを返します。読み取り専用 [Cell](../cell/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [MergeCells](./mergecells/)([System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>, **bool**) override | 隣接セルを結合します。 |
...
| void [set_FirstCol](./set_firstcol/)(**bool**) override | テーブルの最初の列が特別な書式で描画されるかどうかを設定します。書き込み **bool**。 |
| void [set_FirstRow](./set_firstrow/)(**bool**) override | テーブルの最初の行が特別な書式で描画されるかどうかを設定します。書き込み **bool**。 |
...
| void [set_HorizontalBanding](./set_horizontalbanding/)(**bool**) override | 偶数行が異なる書式で描画されるかどうかを設定します。書き込み **bool**。 |
...
| void [set_LastCol](./set_lastcol/)(**bool**) override | テーブルの最後の列が特別な書式で描画されるかどうかを設定します。書き込み **bool**。 |
| void [set_LastRow](./set_lastrow/)(**bool**) override | テーブルの最後の行が特別な書式で描画されるかどうかを設定します。書き込み **bool**。 |
...
| void [set_RightToLeft](./set_righttoleft/)(**bool**) override | テーブルが右から左への読み順かどうかを設定します。書き込み **bool**。 |
| void [set_Rotation](../shape/set_rotation/)(**float**) override | 指定されたシェイプが Z 軸周りに回転した度数を設定します。正の値は時計回り、負の値は反時計回りを示します。書き込み **float**。 |
| void [set_StylePreset](./set_stylepreset/)([TableStylePreset](../tablestylepreset/)) override | 組み込みテーブルスタイルを設定します。書き込み [TableStylePreset](../tablestylepreset/)。 |
| void [set_VerticalBanding](./set_verticalbanding/)(**bool**) override | 偶数列が異なる書式で描画されるかどうかを設定します。書き込み **bool**。 |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | 定義された部分書式プロパティをすべてのテーブルセルの部分に設定します。 |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | 定義された段落書式プロパティをすべてのテーブルセルの段落に設定します。 |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | 定義されたテキストフレーム書式プロパティをすべてのテーブルセルのテキストフレームに設定します。 |
