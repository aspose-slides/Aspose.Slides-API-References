...
description: 補助エフェクトパラメータインターフェース。
type: docs
weight: 2068
url: /ja/aspose.slides/ieffectparamsource/
---
## IEffectParamSource クラス

補助エフェクトパラメータインターフェース。
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 文字列と nullptr のケース用に [Object::ReferenceEquals](../../system/object/referenceequals/) を特殊化します。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | 文字列のケース用に [Object::ReferenceEquals](../../system/object/referenceequals/) を特殊化します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリオブジェクトを使用してください。 |
