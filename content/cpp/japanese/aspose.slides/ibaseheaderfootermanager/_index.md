...
---
## IBaseHeaderFooterManager クラス

フッター、日付時刻、ページ番号のプレースホルダーの動作をすべてのスライドタイプで保持するマネージャーを表します。
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 共有参照カウントを減少させて返します。直接呼び出すべきではなく、スマートポインタや ThisProtector を使用してください。 |
