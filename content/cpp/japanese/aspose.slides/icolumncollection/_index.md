...
| メソッド | 説明 |
| --- | --- |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>, **bool**) | 指定されたテンプレート行のコピーを作成し、テーブルの下部に挿入します。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\> [idx_get](./idx_get/)(**int32_t**) | 指定されたインデックスの列を返します。読み取り専用 [IColumn](../icolumn/)。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>, **bool**) | 指定されたテンプレート列のコピーを作成し、テーブルの指定位置に挿入します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() ステートメントのロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センティネイルオブジェクトを使用してください。 |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**, **bool**) | テーブルから指定された位置の列を削除します。 |
