...
| virtual **uint32_t** [get_Index](./get_index/)() | プレースホルダーのインデックスを取得します。読み取り専用 **uint32_t**。 |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | プレースホルダーの向きを取得します。読み取り専用 [Slides::Orientation](../orientation/)。 |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | プレースホルダーのサイズを取得します。読み取り専用 [PlaceholderSize](../placeholdersize/)。 |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | プレースホルダーのタイプを取得します。読み取り専用 [PlaceholderType](../placeholdertype/)。 |
