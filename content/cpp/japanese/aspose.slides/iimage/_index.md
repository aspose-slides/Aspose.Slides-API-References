...
description: ラスタ画像またはベクタ画像を表します。
type: docs
weight: 2575
...
| virtual **int32_t** [get_Height](./get_height/)() | 画像の高さ（ピクセル単位）を取得します。 |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_Size](./get_size/)() | 画像のサイズを取得します。 |
| virtual **int32_t** [get_Width](./get_width/)() | 画像の幅（ピクセル単位）を取得します。 |
...
| virtual void [Save](./save/)([System::String](../../system/string/)) | 画像をファイルに保存します。 |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/)) | 指定された形式で画像をファイルに保存します。 |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/)) | 指定された形式で画像をストリームに保存します。 |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/), **int32_t**) | 指定された形式と品質で画像をファイルに保存します。 |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/), **int32_t**) | 指定された形式と品質で画像をストリームに保存します。 |
...
このインターフェイスは、ラスタ画像とベクタ画像の両方を扱うための共通抽象化を提供します。

実装は基になる画像タイプに応じて異なる場合があります。
