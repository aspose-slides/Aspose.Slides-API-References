...
---
## ILayoutPlaceholderManager::AddSmartArtPlaceholder(float, float, float, float) メソッド

レイアウト スライドに新しいプレースホルダー シェイプを追加し、[SmartArt](../../../aspose.slides.smartart/) 図を保持します。
...
[IAutoShape](../../iautoshape/) が [SmartArt](../../../aspose.slides.smartart/) プレースホルダーで作成されました。

## 備考

以下の例は、レイアウト スライドに [SmartArt](../../../aspose.slides.smartart/) プレースホルダー シェイプを追加する方法を示しています。 
```cpp
