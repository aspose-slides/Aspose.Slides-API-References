...
| Method | Description |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | 現在のインスタンスを同じ型の別のオブジェクトと比較します。 |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | タブの配置スタイルを返します。読み取り [TabAlignment](../tabalignment/)。 |
...
| **double** [get_Position](./get_position/)() override | タブの位置を返します。このプロパティに代入するとコレクション内のタブのインデックスが変更され、Enumerator が無効になる可能性があります。読み取り **double**。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロック機構を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチュリーオブジェクトを使用します。 |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | タブの配置スタイルを設定します。書き込み [TabAlignment](../tabalignment/)。 |
| void [set_Position](./set_position/)(**double**) override | タブの位置を設定します。このプロパティに代入するとコレクション内のタブのインデックスが変更され、Enumerator が無効になる可能性があります。書き込み **double**。 |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | 新しい [Tab](./) を作成します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のロック解除を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) センチュリーオブジェクトを使用します。 |
