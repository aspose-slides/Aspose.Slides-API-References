...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | 埋め込み画像を返します。読み取り専用 [IPPImage](../ippimage/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/)\> [get_ImageTransform](./get_imagetransform/)() | 画像変換エフェクトのコレクションを返します。読み取り専用 [Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IEffectEffectiveData](../../aspose.slides.effects/ieffecteffectivedata/)\> [get_ImageTransformEffect](./get_imagetransformeffect/)(**int32_t**) | 指定されたインデックスの画像変換エフェクトを返します。 |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | リンクされた画像の URL を返します。読み取り専用 [System::String](../../system/string/)。 |
