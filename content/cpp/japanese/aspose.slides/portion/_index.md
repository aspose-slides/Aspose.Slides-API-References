...
| メソッド | 説明 |
| --- | --- |
| void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | この部分を自動的に更新されるフィールドに変換します。 |
| void [AddField](./addfield/)([System::String](../../system/string/)) override | この部分を自動的に更新されるフィールドに変換します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() override | この部分のフィールドを返します。読み取り専用 [IField](../ifield/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() override | 継承が適用されていない、テキスト部分の明示的に設定された書式プロパティを含む書式オブジェクトを返します。読み取り専用 [IPortionFormat](../iportionformat/)。 |
| [System::String](../../system/string/) [get_Text](./get_text/)() override | 部分のプレーンテキストを取得します。読み取り [System::String](../../system/string/)。 |
| [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() override | 部分の開始位置の座標を取得します。ポイントの X 座標は左サイドベアリングを含む最初の文字からの部分開始を表し、Y 座標はトップサイドベアリングを含みます。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタデータ構造を取得します。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) メソッドのアナログです。カスタムオブジェクトのハッシュ化を可能にします。 |
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() override | 部分を囲む矩形の座標を取得します。矩形は部分内のすべてのテキスト行（空行を含む）を含みます。 |
...
|  [Portion](./portion/)([System::String](../../system/string/)) | [Portion](./) クラスの新しいインスタンスを初期化します。 |
|  [Portion](./portion/)([System::SharedPtr](../../system/sharedptr/)\<[Portion](./)\>) | [Portion](./) クラスの新しいインスタンスを初期化します。 |
...
| void [RemoveField](./removefield/)() override | このフィールド部分を単純な部分に変換します。 |
| void [set_Text](./set_text/)([System::String](../../system/string/)) override | 部分のプレーンテキストを設定します。書き込み [System::String](../../system/string/)。 |
