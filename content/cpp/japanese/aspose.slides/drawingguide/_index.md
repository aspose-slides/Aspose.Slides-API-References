...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | 描画ガイドの色を返します。Read [System::Drawing::Color](../../system.drawing/color/)。 |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | 描画ガイドの向きを返します。Read [Slides::Orientation](../orientation/)。 |
| **float** [get_Position](./get_position/)() override | スライドの左上隅からポイント単位で描画ガイドの位置を返します。Read **float**。 |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | 描画ガイドの色を設定します。Write [System::Drawing::Color](../../system.drawing/color/)。 |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | 描画ガイドの向きを設定します。Write [Slides::Orientation](../orientation/)。 |
| void [set_Position](./set_position/)(**float**) override | スライドの左上隅からポイント単位で描画ガイドの位置を設定します。Write **float**。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 共有参照カウントを減少させ、その値を返します。直接呼び出すべきではありません。代わりにスマートポインタまたは ThisProtector を使用してください。 |
...
* クラス [IDrawingGuide](../idrawingguide/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)