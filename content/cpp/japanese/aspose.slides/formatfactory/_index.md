...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [CreateParagraphFormat](./createparagraphformat/)() override | 新しい [IParagraphFormat](../iparagraphformat/) を作成します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [CreatePortionFormat](./createportionformat/)() override | 新しい [IPortionFormat](../iportionformat/) を作成します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\> [CreateTextFrameFormat](./createtextframeformat/)() override | 新しい [ITextFrameFormat](../itextframeformat/) を作成します。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[FormatFactory](./)\> [get_Instance](./get_instance/)() | フォーマットファクトリの静的インスタンス。読み取り専用 [FormatFactory](./)。 |
...
* クラス [IFormatFactory](../iformatfactory/)
* 名前空間 [Aspose::Slides](../)
* ライブラリ [Aspose.Slides](../../)