...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | 埋め込み画像を返します。読み取り [IPPImage](../ippimage/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/)\> [get_ImageTransform](./get_imagetransform/)() | 画像変換効果のコレクションを返します。読み取り専用 [IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperation](../../aspose.slides.effects/iimagetransformoperation/)\> [get_ImageTransformOperation](./get_imagetransformoperation/)(**int32_t**) | 指定されたインデックスの画像変換操作を返します。 |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | リンクされた画像の URL を取得または設定します。読み取り [System::String](../../system/string/)。 |
...
| virtual void [set_Image](./set_image/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | 埋め込み画像を設定します。書き込み [IPPImage](../ippimage/)。 |
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | リンクされた画像の URL を取得または設定します。書き込み [System::String](../../system/string/)。 |
