...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_DestFont](./get_destfont/)() | 置換に使用するフォント 読み取り専用 [IFontData](../ifontdata/)。 |
| virtual [FontSubstCondition](../fontsubstcondition/) [get_ReplaceFontCondition](./get_replacefontcondition/)() | 置換に適用するルール 読み取り専用 [FontSubstCondition](../fontsubstcondition/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_SourceFont](./get_sourcefont/)() | 置換対象のフォント 読み取り専用 [IFontData](../ifontdata/)。 |
