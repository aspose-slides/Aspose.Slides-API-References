...
description: "画像のフレーム寸法を取得するプロパティを提供します。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してインスタンスを作成すると、実行時エラーやアサーション失敗が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡してください。"
type: docs
weight: 92
url: /ja/system.drawing.imaging/framedimension/
---
## FrameDimension クラス
...
| メソッド | 説明 |
| --- | --- |
| **bool** [Equals](./equals/)([FrameDimensionPtr](../framedimensionptr/)) | 指定された [FrameDimension](./) オブジェクトが現在のオブジェクトと等価かどうかを判定します。 |
...
| [FrameDimension](./framedimension/)(const [System::Guid](../../system/guid/)\&) | 指定された GUID で新しい [FrameDimension](./) オブジェクトを構築し、初期化します。 |
| [System::Guid](../../system/guid/) [get_Guid](./get_guid/)() const | 現在のオブジェクトに関連付けられた GUID を返します。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Page](./get_page/)() | ページの寸法を返します。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Resolution](./get_resolution/)() | 解像度の寸法を返します。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Time](./get_time/)() | 時間の寸法を返します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリオブジェクトを使用します。 |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) の構文を実装します。 |
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のアンロックを実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリオブジェクトを使用します。 |
