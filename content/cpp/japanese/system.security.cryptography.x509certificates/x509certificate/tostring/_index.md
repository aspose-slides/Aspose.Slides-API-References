...
description: 証明書情報をテキスト形式で返します。
type: docs
weight: 339
url: /ja/system.security.cryptography.x509certificates/x509certificate/tostring/
---
## X509Certificate::ToString(bool) const メソッド
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| verbose | **bool** | 追加の証明書情報を表示する場合は true。 |

### 戻り値

証明書情報。

## X509Certificate::ToString() const メソッド
