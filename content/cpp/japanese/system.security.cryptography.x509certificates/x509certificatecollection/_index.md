...
description: "X509 証明書オブジェクトのコレクションです。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション違反が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。"
type: docs
weight: 79
url: /ja/system.security.cryptography.x509certificates/x509certificatecollection/
---
...
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&) const | ソート済みリスト内の項目を検索します。 |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | ソート済みリスト内の項目を検索します。 |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(int, int, const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | ソート済みリスト内の項目を検索します。 |
...
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | 指定されたインデックスから始めて要素を既存の配列要素にコピーします。 |
...
| [vector_t](../../system.collections.generic/list/vector_t/)\& [data](../../system.collections.generic/list/data/)() | 基底データ構造へのアクセス関数です。 |
| const [vector_t](../../system.collections.generic/list/vector_t/)\& [data](../../system.collections.generic/list/data/)() const | 基底データ構造へのアクセス関数です。 |
...
| [IEnumeratorPtr](../../system.collections.generic/list/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/list/getenumerator/)() override | リスト要素を反復処理する列挙子を取得します。 |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | 指定されたオブジェクトを検索し、リスト全体での最後の出現位置のゼロベースインデックスを返します。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | 指定されたオブジェクトを検索し、最初の要素から指定されたインデックスまでの [List](../../system.collections.generic/list/) の要素範囲内での最後の出現位置のゼロベースインデックスを返します。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | 指定されたオブジェクトを検索し、指定された要素数を含み、指定されたインデックスで終わる [List](../../system.collections.generic/list/) の要素範囲内での最後の出現位置のゼロベースインデックスを返します。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンスのいずれかの要素が存在するか、条件を満たすかどうかを判定します。 |
...
| void [Lock](../../system/object/lock/)() | C# の lock() 文のロック機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) ガードオブジェクトを使用してください。 |
...
| vector_t::reference [operator[]](../../system.collections.generic/list/operator[]/)(int) | アクセッサ関数です。 |
| vector_t::const_reference [operator[]](../../system.collections.generic/list/operator[]/)(int) const | アクセッサ関数です。 |
...
| void [Sort](../../system.collections.generic/list/sort/)() | デフォルトの比較子を使用してリストの要素をソートします。 |
...
| **bool** [TrueForAll](../../system.collections.generic/list/trueforall/)([System::Predicate](../../system/predicate/)\<T\>) | コレクションのすべての要素が指定された述語で定義された条件に一致するかどうかを判定します。 |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# の typeof([System.Object](../../system/object/)) 構文を実装します。 |
| void [Unlock](../../system/object/unlock/)() | C# の lock() 文のアンロック機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) ガードオブジェクトを使用してください。 |
