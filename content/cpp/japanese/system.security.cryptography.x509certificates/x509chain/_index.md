...
description: "X509 証明書チェーンを表します。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡します。"
type: docs
weight: 105
url: /ja/system.security.cryptography.x509certificates/x509chain/
---
## X509Chain クラス
...
| Method | Description |
| --- | --- |
| **bool** [Build](./build/)([SharedPtr](../../system/sharedptr/)\<[X509Certificate2](../x509certificate2/)\>) | 未実装です。 |
...
| [SharedPtr](../../system/sharedptr/)\<[X509ChainPolicy](../x509chainpolicy/)\> [get_ChainPolicy](./get_chainpolicy/)() | 未実装です。 |
| [ArrayPtr](../../system/arrayptr/)\<[X509ChainStatus](../x509chainstatus/)\> [get_ChainStatus](./get_chainstatus/)() | 未実装です。 |
