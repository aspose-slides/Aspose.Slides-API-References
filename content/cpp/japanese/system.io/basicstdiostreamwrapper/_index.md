...
description: "System.IO.Stream に似たラッパーで、std::basic_iostream とその派生オブジェクトを対象とします。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new でインスタンスを作成しないでください。実行時エラーやアサーション違反の原因になります。常にこのクラスを System::SmartPtr ポインタでラップし、そのポインタを関数の引数として使用してください。"
type: docs
weight: 1
url: /ja/system.io/basicstdiostreamwrapper/
---
## BasicSTDIOStreamWrapper クラス

[System.IO.Stream](../stream/) に似たラッパーで、std::basic_iostream とその派生オブジェクトを対象とします。このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new でインスタンスを作成しないでください。実行時エラーやアサーション違反の原因になります。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数の引数として使用してください。
...
| メソッド | 説明 |
| --- | --- |
|  [BasicSTDIOStreamWrapper](./basicstdiostreamwrapper/)(std::basic_iostream\<[char_type](../stdiostreamwrapperbase/char_type/), [traits_type](../stdiostreamwrapperbase/traits_type/)\>\&, [STDIOStreamWrappingMode](../stdiostreamwrappingmode/), [STDIOStreamPositionPreference](../stdiostreampositionpreference/)) | [BasicSTDIOStreamWrapper](./) の新しいインスタンスを構築します。 |
|  [BasicSTDIOStreamWrapper](./basicstdiostreamwrapper/)(const [BasicSTDIOStreamWrapper](./)\&) | コピーコンストラクタ。削除済み。 |
|  [BasicSTDIStreamWrapper](../basicstdistreamwrapper/basicstdistreamwrapper/)(std::basic_istream\<[char_type](../stdiostreamwrapperbase/char_type/), [traits_type](../stdiostreamwrapperbase/traits_type/)\>\&, [STDIOStreamWrappingMode](../stdiostreamwrappingmode/)) | [BasicSTDIStreamWrapper](../basicstdistreamwrapper/) の新しいインスタンスを構築します。 |
|  [BasicSTDIStreamWrapper](../basicstdistreamwrapper/basicstdistreamwrapper/)(const [BasicSTDIStreamWrapper](../basicstdistreamwrapper/)\&) | コピーコンストラクタ。削除済み。 |
|  [BasicSTDOStreamWrapper](../basicstdostreamwrapper/basicstdostreamwrapper/)(std::basic_ostream\<[char_type](../stdiostreamwrapperbase/char_type/), [traits_type](../stdiostreamwrapperbase/traits_type/)\>\&, [STDIOStreamWrappingMode](../stdiostreamwrappingmode/)) | [BasicSTDOStreamWrapper](../basicstdostreamwrapper/) の新しいインスタンスを構築します。 |
|  [BasicSTDOStreamWrapper](../basicstdostreamwrapper/basicstdostreamwrapper/)(const [BasicSTDOStreamWrapper](../basicstdostreamwrapper/)\&) | コピーコンストラクタ。削除済み。 |
...
| void [Flush](./flush/)() override | このストリームのバッファをクリアし、すべてのバッファされたデータを基礎となるストレージに書き込みます。 |
| virtual [TaskPtr](../../system/taskptr/) [FlushAsync](../stream/flushasync/)(const [Threading::CancellationToken](../../system.threading/cancellationtoken/)\&) | このストリームのすべてのバッファを非同期でクリアし、バッファされたデータを書き込み、キャンセル要求を監視します。 |
| [TaskPtr](../../system/taskptr/) [FlushAsync](../stream/flushasync/)() | このストリームのすべてのバッファを非同期でクリアし、バッファされたデータを書き込み、キャンセル要求を監視します。 |
...
| **bool** [get_CanWrite](../stdiostreamwrapperbase/get_canwrite/)() const override | ストリームが書き込みをサポートしているかどうかを判定します。 |
| **int64_t** [get_Length](../stdiostreamwrapperbase/get_length/)() const override | ストリームの長さを返します。 |
| **int64_t** [get_Position](../stdiostreamwrapperbase/get_position/)() const override | ストリームの現在位置を返します。 |
...
| [BasicSTDIOStreamWrapper](./)\& [operator=](./operator_equal/)(const [BasicSTDIOStreamWrapper](./)\&) | コピー代入演算子。削除済み。 |
| [BasicSTDIStreamWrapper](../basicstdistreamwrapper/)\& [operator=](../basicstdistreamwrapper/operator_equal/)(const [BasicSTDIStreamWrapper](../basicstdistreamwrapper/)\&) | コピー代入演算子。削除済み。 |
| [STDIOStreamWrapperBase](../stdiostreamwrapperbase/)\& [operator=](../stdiostreamwrapperbase/operator_equal/)(const [STDIOStreamWrapperBase](../stdiostreamwrapperbase/)\&) | コピー代入演算子。削除済み。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 代入演算子。実際には何もコピーせず、新しいオブジェクトを初期化し、サブクラスのコピー構築を可能にします。 |
| [BasicSTDOStreamWrapper](../basicstdostreamwrapper/)\& [operator=](../basicstdostreamwrapper/operator_equal/)(const [BasicSTDOStreamWrapper](../basicstdostreamwrapper/)\&) | コピー代入演算子。削除済み。 |
| **int32_t** [Read](./read/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | ラッピングモードがバイナリの場合、ストリームから指定されたバイト数を読み取り、そうでない場合は指定された文字数を読み取り **uint8_t** 型に変換します。読み取った結果を指定されたバイト配列に書き込みます。 |
...
| int [ReadByte](./readbyte/)() override | ラッピングモードがバイナリの場合、最後にデコードされた文字ストレージから 1 バイト読み取り、そうでない場合はストリームから 1 文字を読み取り **uint8_t** 型に変換します。 |
...
|  [STDIOStreamWrapperBase](../stdiostreamwrapperbase/stdiostreamwrapperbase/)(const [STDIOStreamWrapperBase](../stdiostreamwrapperbase/)\&) | コピーコンストラクタ。削除済み。 |
...
| void [Write](./write/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | ラッピングモードがバイナリの場合、指定されたバイト配列の指定されたサブレンジのバイトを書き込みます。そうでない場合は、指定されたバイト配列のサブレンジを char_type 型に変換し、結果を書き込みます。 |
| void [Write](./write/)(const System::Details::ArrayView\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | 指定されたバイト配列の指定されたサブレンジのバイトを書き込みます。 |
| void [Write](../stream/write/)(const System::Details::StackArray\<**uint8_t**, N\>\&, **int32_t**, **int32_t**) | 指定されたバイト配列の指定されたサブレンジのバイトを書き込みます。 |
| virtual void [Write](../stream/write/)(const [System::ReadOnlySpan](../../system/readonlyspan/)\<**uint8_t**\>\&) | 指定されたバイトスパンの指定されたサブレンジのバイトを書き込みます。 |
| virtual [TaskPtr](../../system/taskptr/) [WriteAsync](../stream/writeasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**, const [Threading::CancellationToken](../../system.threading/cancellationtoken/)\&) | 現在のストリームへバイト列を書き込み、書き込んだバイト数だけストリーム内の位置を進め、キャンセル要求を監視します。 |
| [TaskPtr](../../system/taskptr/) [WriteAsync](../stream/writeasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) | 現在のストリームへバイト列を書き込み、書き込んだバイト数だけストリーム内の位置を進め、キャンセル要求を監視します。 |
| void [WriteByte](./writebyte/)(**uint8_t**) override | ラッピングモードがバイナリの場合、指定された符号なし 8 ビット整数値を書き込みます。そうでない場合は char_type 型に変換し、結果を書き込みます。 |
...
* クラス [BasicSTDIStreamWrapper](../basicstdistreamwrapper/)
* クラス [BasicSTDOStreamWrapper](../basicstdostreamwrapper/)
* 名前空間 [System::IO](../)
* ライブラリ [Aspose.Slides](../../)