...
description: SVGテキスト部分（\"tspan\"）のオプションを表します。
type: docs
weight: 729
...
| [System::String](../../system/string/) [get_Id](./get_id/)() override | \"tspan\" 要素の ID を取得します |
...
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | \"tspan\" 要素の ID を取得します |
