...
エクスポート用の配布資料プレゼンテーションレイアウトモードを表します。
...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | [HandoutType](../handouttype/) に配置されるスライド数とその順序を指定します。 |
| **bool** [get_PrintComments](./get_printcomments/)() const | スライド上のコメントを表示するかどうかを指定します。 |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | 表示されたスライドの周囲にフレームを描画するかどうかを指定します。 |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | 表示されたスライド番号を印刷するかどうかを指定します。 |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | [HandoutType](../handouttype/) に配置されるスライド数と順序を指定します。 |
| void [set_PrintComments](./set_printcomments/)(**bool**) | スライド上のコメントを表示するかどうかを指定します。 |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | 表示されたスライドの周囲にフレームを描画するかどうかを指定します。 |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | 表示されたスライド番号を印刷するかどうかを指定します。 |
