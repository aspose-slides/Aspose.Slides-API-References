...
エクスポートされたドキュメントで [Ink](../../aspose.slides.ink/) オブジェクトの外観を制御するオプションを提供します。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# スタイルの浮動小数点比較をエミュレートします。2 つの NaN は等しいとみなされますが、IEC 60559:1989 によれば NaN はどの値とも等しくありません（NaN を含む）。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートします。2 つの NaN は等しいとみなされますが、IEC 60559:1989 によれば NaN はどの値とも等しくありません（NaN を含む）。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部用途専用です。 |
| **bool** [get_HideInk](./get_hideink/)() override | エクスポートされたドキュメントで [Ink](../../aspose.slides.ink/) 要素を表示または非表示にします。 |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | ブラシのレンダリングに ROP 操作または不透明度を使用します。 |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | エクスポートされたドキュメントで [Ink](../../aspose.slides.ink/) 要素を表示または非表示にします。 |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | ブラシのレンダリングに ROP 操作または不透明度を使用します。 |
