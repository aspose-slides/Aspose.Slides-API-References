...
エクスポートされたドキュメント内の [Ink](../../aspose.slides.ink/) オブジェクトの外観を制御するオプションを提供します。
...
| virtual **bool** [get_HideInk](./get_hideink/)() | [Ink](../../aspose.slides.ink/) 要素をエクスポートされたドキュメントで表示または非表示にします。 |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | ブラシのレンダリングに ROP 操作または不透明度を使用します。 |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | [Ink](../../aspose.slides.ink/) 要素をエクスポートされたドキュメントで表示または非表示にします。 |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | ブラシのレンダリングに ROP 操作または不透明度を使用します。 |
