...
description: WOFF 形式でフォントを埋め込むために使用するフォーマットコントローラのクラス
type: docs
weight: 27
...
WOFF 形式でフォントを埋め込むために使用するフォーマットコントローラのクラスです。
...
|  [EmbeddedWoffFontsHtmlController](./embeddedwofffontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | 新しいインスタンスを作成します。 |
...
* クラス [IEmbeddedWoffFontsHtmlController](../iembeddedwofffontshtmlcontroller/)
