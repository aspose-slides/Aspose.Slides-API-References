...
description: プレゼンテーションに関連付けられたアニメーションのプレーヤーを表します。
type: docs
weight: 625
...
| メソッド | 説明 |
| --- | --- |
| void [Dispose](./dispose/)() override | [PresentationPlayer](./) のインスタンスを破棄します。 |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | フレームインデックスを取得します。 |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | [PresentationPlayer](./) の新しいインスタンスを作成します。 |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() 文のアンロック機能を実装します。直接呼び出すか、[LockContext](../../system/lockcontext/) セントリーオブジェクトを使用してください。 |
...
| 型エイリアス | 説明 |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | **PresentationPlayer::FrameTick** イベントのフレームティックハンドラを表します。 |
