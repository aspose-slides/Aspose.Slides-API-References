...
description: "連結リストのノードです。連結リストでラップされた std::list のイテレータに対するラッパーを実装します。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new でインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。"
type: docs
weight: 417
url: /ja/system.collections.generic/linkedlistnode/
---
## LinkedListNode クラス


連結リストのノード。std::list のイテレータをラップしたラッパーを実装します。Objects of this class should only be allocated using [System::MakeObject()](../../system/makeobject/) function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into [System::SmartPtr](../../system/smartptr/) pointer and use this pointer to pass it to functions as argument.
...
| [SharedPtr](../../system/sharedptr/)\<[LinkedList](../linkedlist/)\<T\>\> [get_List](./get_list/)() const | 包含リストを取得します。 |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Next](./get_next/)() const | 次のノードを取得します。 |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Previous](./get_previous/)() const | 前のノードを取得します。 |
| T [get_Value](./get_value/)() const | 格納された値を取得します。 |
...
| void [set_Value](./set_value/)(const T\&) | 格納された値を設定します。 |
