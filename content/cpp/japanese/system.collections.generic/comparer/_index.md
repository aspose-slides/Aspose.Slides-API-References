...
description: System.Collections.Generic.IComparer 汎用インターフェイスの実装のための基本クラスを提供します。
type: docs
weight: 105
url: /ja/system.collections.generic/comparer/
---
## Comparer クラス

[System.Collections.Generic.IComparer](../icomparer/) 汎用インターフェイスの実装のための基本クラスを提供します。
...
| メソッド | 説明 |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) 関数。 |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | ジェネリック引数で指定された型のデフォルトのソート順比較子を返します。 |
...
| 型定義 | 説明 |
| --- | --- |
| [BaseType](./basetype/) | 実装されているインターフェイス。 |
