...
description: "単一のマッチにおけるキャプチャ グループのリストです。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。この型のインスタンスをスタック上で、または operator new を使用して作成しないでください。そうするとランタイム エラーやアサーション フォルトが発生します。常にこのクラスを System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。"
type: docs
weight: 40
url: /ja/system.text.regularexpressions/groupcollection/
---
## GroupCollection クラス

単一のマッチにおけるキャプチャ グループのリストです。このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。この型のインスタンスをスタック上で、または operator new を使用して作成しないでください。そうするとランタイム エラーやアサーション フォルトが発生します。常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。
...
| void [Add](./add/)(const [GroupPtr](../groupptr/)\&) override | コレクションへの要素追加を無効にします。 |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | リストの末尾に要素を追加します。 |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | コレクションにグループを追加します。 |
| void [AddInitializer](../../system.collections.generic/list/addinitializer/)(int, const T *) | リストに要素を追加します。初期化子の変換時に使用されます。 |
...
| void [Clear](./clear/)() override | コレクションから要素を削除することを無効にします。 |
...
| void [CopyTo](../../system.collections.generic/list/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) override | リスト要素を既存の配列要素へコピーします。 |
| void [CopyTo](../../system.collections.generic/list/copyto/)(const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&) | すべての要素を既存の配列要素へコピーします。 |
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | 指定されたインデックスから始まる要素を既存の配列要素へコピーします。 |
...
| [vector_t](../../system.collections.generic/list/vector_t/)\& [data](../../system.collections.generic/list/data/)() | 基底データ構造へのアクセス関数。 |
| const [vector_t](../../system.collections.generic/list/vector_t/)\& [data](../../system.collections.generic/list/data/)() const | 基底データ構造へのアクセス関数。 |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | 特定の述語を満たす要素がリストに存在するかチェックします。 |
...
| T [FindLast](../../system.collections.generic/list/findlast/)([System::Predicate](../../system/predicate/)\<T\>) | 特定の述語を満たす要素を検索します。 |
| void [ForEach](../../system.collections.generic/list/foreach/)([System::Action](../../system/action/)\<T\>) | リスト内のすべての要素にアクションを適用します。 |
...
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | コレクションが固定サイズであるかチェックします。 |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | コレクションが読み取り専用かチェックします。 |
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(int) const | [Group](../group/) アクセサ。 |
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(const [String](../../system/string/)\&) const | [Group](../group/) アクセサ。 |
...
| [IEnumeratorPtr](../../system.collections.generic/list/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/list/getenumerator/)() override | リスト要素を反復処理するイテレータを取得します。 |
...
|  [GroupCollection](./groupcollection/)(const [WeakPtr](../../system/weakptr/)\<[Match](../match/)\>\&) | コンストラクタ。 |
...
| virtual [GroupPtr](../groupptr/) [idx_get](./idx_get/)([String](../../system/string/)) const | [Group](../group/) アクセサ。 |
| [GroupPtr](../groupptr/) [idx_get](./idx_get/)(int) const override | [Group](../group/) アクセサ。 |
...
| void [Insert](../../system.collections.generic/list/insert/)(int, const T\&) override | 指定された位置に項目を挿入します。 |
| void [InsertRange](../../system.collections.generic/list/insertrange/)(int, [IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | 特定の位置にデータ範囲を挿入します。 |
...
| **bool** [IsReadOnly](./isreadonly/)() const | コレクションを読み取り専用としてマークします。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | 指定されたオブジェクトを検索し、リスト全体で最後に出現した位置のゼロベースインデックスを返します。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | 指定されたオブジェクトを検索し、[List](../../system.collections.generic/list/) の最初の要素から指定インデックスまでの範囲内で最後に出現した位置のゼロベースインデックスを返します。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | 指定されたオブジェクトを検索し、[List](../../system.collections.generic/list/) の指定された要素数を含み、指定インデックスで終了する範囲内で最後に出現した位置のゼロベースインデックスを返します。 |
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | シーケンスに集積関数を適用します。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | シーケンスに要素が存在するか、条件を満たすか判定します。 |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | 数値シーケンスの平均を計算します。 |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 入力シーケンスの各要素に変換関数を適用して得られる値シーケンスの平均を計算します。 |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | シーケンスに指定された値が含まれるか判定します。 |
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | シーケンスの要素数を返します（直接カウントによる）。 |
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | シーケンスで指定された条件を満たす要素数を返します。 |
...
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)(const [Func](../../system/func/)\<T, **bool**\>\&) | シーケンスで指定された条件を満たす最初の要素を返します。 |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 汎用シーケンスの各要素に変換関数を適用し、結果の最大値を返します。 |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 汎用シーケンスの各要素に変換関数を適用し、結果の最小値を返します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | シーケンスの各要素を新しい形に変換します。 |
...
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(const [String](../../system/string/)\&) const | [Group](../group/) アクセサ。 |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | const 修飾コレクションの最後の要素（逆順の最初）への逆イテレータを取得します。 |
...
| **bool** [Remove](./remove/)(const [GroupPtr](../groupptr/)\&) override | コレクションから要素を削除することを無効にします。 |
...
| void [RemoveAt](../../system.collections.generic/list/removeat/)(int) override | 指定された位置の項目を削除します。 |
...
| void [Sort](../../system.collections.generic/list/sort/)() | デフォルトコンパレータを使用してリストの要素をソートします。 |
...
| **bool** [TrueForAll](../../system.collections.generic/list/trueforall/)([System::Predicate](../../system/predicate/)\<T\>) | コレクションのすべての要素が指定された述語で定義された条件に一致するか判定します。 |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../../system.collections.generic/list/virtualizebeginconstiterator/)() const override | 現在のコンテナの const begin イテレータの実装を取得します。 |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.generic/list/virtualizeendconstiterator/)() const override | 現在のコンテナの const end イテレータの実装を取得します。 |
