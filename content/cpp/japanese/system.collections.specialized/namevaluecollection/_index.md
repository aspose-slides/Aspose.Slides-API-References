...
description: キーと値が String で関連付けられたコレクションで、キーまたはインデックスでアクセスできます。
type: docs
weight: 14
url: /ja/system.collections.specialized/namevaluecollection/
---
## NameValueCollection クラス

キー [String](../../system/string/) と値 [String](../../system/string/) の関連コレクションで、キーまたはインデックスでアクセスできます。
...
| メソッド | 説明 |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | [ICollection](../../system.collections/icollection/) メソッドをオーバーライドします - 未実装です。 |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | 指定された [NameValueCollection](./) のエントリを現在のコレクションにコピーします。 |
| virtual void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | 指定された名前と値でエントリを追加します。 |
...
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) const override | コレクションにアイテムが存在するかチェックします。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>, **int32_t**) override | コレクションの要素を既存の配列要素にコピーします。 |
...
| virtual [String](../../system/string/) [Get](./get/)(const [String](../../system/string/)\&) | 指定されたキーに関連付けられた値を取得します。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [get_AllKeys](./get_allkeys/)() | すべてのキーを取得します。 |
| int [get_Count](./get_count/)() const override | キー/値ペアの数を取得します。 |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | コレクションが読み取り専用かどうかをチェックします。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[String](../../system/string/)\>\> [get_Keys](./get_keys/)() | すべてのキーを取得します。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | コレクションを反復する列挙子を取得します。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [GetValues](./getvalues/)(const [String](../../system/string/)\&) | 指定されたキーに関連付けられた値を取得します。 |
| **bool** [HasKeys](./haskeys/)() | [NameValueCollection](./) が null でないキーを含むかどうかを示す値を取得します。 |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) | 指定されたインデックスの値を取得します。 |
| void [idx_set](./idx_set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | エントリの値を設定します。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | シーケンスの各要素をそのインデックスを組み込んで新しい形に変換します。 |
...
|  [NameValueCollection](./namevaluecollection/)() | [NameValueCollection](./) クラスの空の新しいインスタンスを初期化します。 |
|  [NameValueCollection](./namevaluecollection/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | 指定された [NameValueCollection](./) から新しい [NameValueCollection](./) にエントリをコピーします。 |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | 特定のアイテムを削除します。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 指定された値だけ共有参照カウントを減少させます。 |
| virtual void [Set](./set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | エントリの値を設定します。 |
...
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 現在のコンテナの begin const イテレータの実装を取得します。 |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 現在のコンテナの begin イテレータの実装を取得します。 |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 現在のコンテナの end const イテレータの実装を取得します。 |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | 現在のコンテナの end イテレータの実装を取得します。 |
