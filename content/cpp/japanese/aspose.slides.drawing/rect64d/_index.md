...
description: Rectangle 構造体
type: docs
weight: 40
url: /ja/aspose.slides.drawing/rect64d/
---
## Rect64d クラス
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# スタイルの浮動小数点比較をエミュレートし、IEC 60559:1989 では NaN は任意の値（NaN を含む）と等しくないとされているにもかかわらず、2 つの NaN を等しいと見なします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# スタイルの浮動小数点比較をエミュレートし、IEC 60559:1989 では NaN は任意の値（NaN を含む）と等しくないとされているにもかかわらず、2 つの NaN を等しいと見なします。 |
