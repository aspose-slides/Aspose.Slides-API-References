...
type: docs
weight: 14
url: /ja/aspose.slides.drawing/margin64d/
---
## Margin64d クラス
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 共有参照カウントを減少させ、結果を返します。直接呼び出すべきではなく、スマートポインタまたは ThisProtector を使用してください。 |
| [Margin32f](../margin32f/) [ToMargin32F](./tomargin32f/)() |  |
| [System::String](../../system/string/) [ToString](./tostring/)() const override | C# Object.ToString() メソッドの類似です。カスタムオブジェクトを文字列に変換できます。 |
