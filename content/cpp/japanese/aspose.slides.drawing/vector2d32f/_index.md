...
description: float コンポーネントを持つ 2D ベクトル
type: docs
weight: 53
url: /ja/aspose.slides.drawing/vector2d32f/
---
## Vector2d32f クラス

**float** コンポーネントを持つ 2D ベクトル
...
| **double** [GetLength](./getlength/)() | 長さを取得 |
...
| [Vector2d32f](./) [Scale](./scale/)(**float**, **float**) | ベクトルをスケール |
| [Vector2d32f](./) [Scale](./scale/)([Vector2d32f](./)) | ベクトルをスケール |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | C# Object.ToString() メソッドのアナログです。カスタムオブジェクトを文字列に変換可能にします。 |
| [Vector2d64d](../vector2d64d/) [ToVector2d64d](./tovector2d64d/)() | [Vector2d64d](../vector2d64d/) に変換 |
...
|  [Vector2d32f](./vector2d32f/)(**float**, **float**) | コンストラクタ |
