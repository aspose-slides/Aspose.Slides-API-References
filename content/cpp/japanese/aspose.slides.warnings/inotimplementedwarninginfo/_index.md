...
description: 近い将来実装されないことが判明している未実装機能に関する警告を表します。
type: docs
weight: 14
url: /ja/aspose.slides.warnings/inotimplementedwarninginfo/
---
## INotImplementedWarningInfo クラス

近い将来実装されないことが判明している未実装機能に関する警告を表します。
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | この警告の人間が読める説明を返します。読み取り専用 [System::String](../../system/string/)。 |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 受信側が null でない場合、指定された受信側へ警告を終了し、受信側が操作の中止を決定した場合は AbortRequestedException をスローします。 |
