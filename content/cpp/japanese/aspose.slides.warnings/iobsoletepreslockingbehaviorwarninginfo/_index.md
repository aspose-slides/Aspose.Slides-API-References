...
---
## IObsoletePresLockingBehaviorWarningInfo クラス


この警告は、廃止されたプレゼンテーションロック動作が使用されていることを示します。
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | この警告の人間が読みやすい説明を返します。読み取り専用 [System::String](../../system/string/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | オブジェクトが targetType が記述する型のインスタンスであるかを確認します。C# の 'is' 演算子のアナログです。 |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | レシーバが null でない場合、警告を指定されたレシーバへ送信し、レシーバが操作の中止を決定した場合は AbortRequestedException をスローします。 |
