...
description: 警告を受け取るクラスのためのインターフェイス
type: docs
weight: 53
url: /ja/aspose.slides.warnings/iwarningcallback/
---
## IWarningCallback クラス

警告を受け取るクラスのためのインターフェイス
...
| virtual [ReturnAction](../returnaction/) [Warning](./warning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningInfo](../iwarninginfo/)\>) | 警告を受け取り、操作を中止すべきかどうかを決定するコールバックメソッドです。 |
