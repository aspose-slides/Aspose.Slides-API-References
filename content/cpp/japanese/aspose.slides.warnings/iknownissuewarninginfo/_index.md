...
---
## IKnownIssueWarningInfo クラス


近い将来に修正されない既知の問題に関する警告を表します。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 によれば NaN は任意の値、NaN を含めて等しくないとされますが、C# スタイルの浮動小数点比較をエミュレートし、2 つの NaN を等しいとみなします。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 によれば NaN は任意の値、NaN を含めて等しくないとされますが、C# スタイルの浮動小数点比較をエミュレートし、2 つの NaN を等しいとみなします。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 内部使用のみです。 |
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | この警告の人が読める説明を返します。読み取り専用 [System::String](../../system/string/)。 |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | 警告の種類を返します。読み取り専用 [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/)。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 指定された値分だけ共有参照カウントを減少させます。 |
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 受信側が null でない場合、警告を指定された受信側に送信し、受信側が操作の中止を決定した場合は AbortRequestedException をスローします。 |
