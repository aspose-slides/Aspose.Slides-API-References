...
description: この警告は、読み込んでいるプレゼンテーションに署名が含まれており、処理中にその署名が削除されることを示します。
type: docs
weight: 40
url: /ja/aspose.slides.warnings/ipresentationsignedwarninginfo/
---
## IPresentationSignedWarningInfo クラス


この警告は、読み込み中のプレゼンテーションに署名が含まれており、処理中にその署名が削除されることを示します。
...
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | 警告のタイプを返します。読み取り専用 [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/)。 |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | レシーバが null でない場合、指定されたレシーバに警告を終了し、レシーバが操作の中止を決定した場合は AbortRequestedException をスローします。 |
