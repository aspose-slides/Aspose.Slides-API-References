...
description: RSA 署名の作成または検証操作のためのパディングモードとパラメータ。
type: docs
weight: 521
url: /ja/system.security.cryptography/rsasignaturepadding/
---
...
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | 現在のオブジェクトと指定されたオブジェクトが等しいかどうかを決定します。 |
...
| [RSASignaturePaddingMode](../rsasignaturepaddingmode/) [get_Mode](./get_mode/)() const | パディングモードを取得します。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pkcs1](./get_pkcs1/)() | PKCS #1 v1.5 モードを取得します。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pss](./get_pss/)() | PSS モードを取得します。 |
