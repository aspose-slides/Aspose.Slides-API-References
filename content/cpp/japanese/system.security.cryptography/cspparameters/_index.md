...
description: "Cryptographic Service Provider のパラメーター。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してインスタンスを作成しないでください。そうしないと実行時エラーやアサーション障害が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを引数として関数に渡して使用してください。"
type: docs
weight: 79
url: /ja/system.security.cryptography/cspparameters/
---
## CspParameters クラス

Cryptographic Service Provider のパラメーター。 このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。 スタック上や operator new を使ってインスタンスを作成しないでください。 そうしないと実行時エラーやアサーション障害が発生します。 常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを引数として関数に渡すようにしてください。
...
| メソッド | 説明 |
| --- | --- |
|  [CspParameters](./cspparameters/)() | コンストラクタ。 |
|  [CspParameters](./cspparameters/)(int) | コンストラクタ。 |
|  [CspParameters](./cspparameters/)(int, const [System::String](../../system/string/)\&) | コンストラクタ。 |
|  [CspParameters](./cspparameters/)(int, const [System::String](../../system/string/)\&, const [System::String](../../system/string/)\&) | コンストラクタ。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) メソッドに相当します。 カスタムオブジェクトを文字列に変換する機能を提供します。 |
