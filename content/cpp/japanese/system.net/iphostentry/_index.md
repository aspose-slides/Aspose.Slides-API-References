...
description: "インターネットホストアドレスに関する情報を表します。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使ってインスタンスを作成しないでください。そうすると実行時エラーやアサーション障害が発生します。このクラスは常に System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。"
type: docs
weight: 352
url: /ja/system.net/iphostentry/
---
## IPHostEntry クラス

インターネットホストアドレスに関する情報を表します。このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してインスタンスを作成しないでください。そうしないと実行時エラーやアサーション障害が発生します。このクラスは常に [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを関数の引数として渡すようにしてください。
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../ipaddress/)\>\> [get_AddressList](./get_addresslist/)() | ホストの IP アドレスコレクションを取得します。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [get_Aliases](./get_aliases/)() | ホストのエイリアスコレクションを取得します。 |
| [String](../../system/string/) [get_HostName](./get_hostname/)() const | ホスト名を取得します。 |
...
| void [set_AddressList](./set_addresslist/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../ipaddress/)\>\>) | ホストの IP アドレスコレクションを設定します。 |
| void [set_Aliases](./set_aliases/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>) | ホストのエイリアスコレクションを設定します。 |
| void [set_HostName](./set_hostname/)([String](../../system/string/)) | ホスト名を設定します。 |
