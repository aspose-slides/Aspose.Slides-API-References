...
description: "パスワードベースの認証方式に対する資格情報を提供します。このクラスのオブジェクトは System::MakeObject() 関数を使用してのみ割り当てるべきです。スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。常にこのクラスを System::SmartPtr ポインタでラップし、そのポインタを関数の引数として渡してください。"
type: docs
weight: 391
url: /ja/system.net/networkcredential/
---
## NetworkCredential クラス

パスワードベースの認証方式に対する資格情報を提供します。  
このクラスのオブジェクトは [System::MakeObject()](../../system/makeobject/) 関数を使用してのみ割り当てるべきです。  
スタック上や operator new を使用してこの型のインスタンスを作成しないでください。そうすると実行時エラーやアサーション失敗が発生します。  
常にこのクラスを [System::SmartPtr](../../system/smartptr/) ポインタでラップし、そのポインタを引数として関数に渡してください。
...
| [String](../../system/string/) [get_Domain](./get_domain/)() | 資格情報を検証するドメインを取得します。 |
| [String](../../system/string/) [get_Password](./get_password/)() | パスワードを取得します。 |
| [String](../../system/string/) [get_UserName](./get_username/)() | ユーザー名を取得します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | オブジェクトに関連付けられた参照カウンタのデータ構造を取得します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](./)\> [GetCredential](./getcredential/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | 指定された URI と認証タイプに対する資格情報を返します。 |
| [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](./)\> [GetCredential](./getcredential/)([String](../../system/string/), **int32_t**, [String](../../system/string/)) override | 指定されたホスト名、ポート、および認証タイプに対する資格情報を返します。 |
...
|  [NetworkCredential](./networkcredential/)([String](../../system/string/), [String](../../system/string/)) | 新しいインスタンスを構築します。 |
|  [NetworkCredential](./networkcredential/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | 新しいインスタンスを構築します。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 指定された値だけ共有参照カウントを減少させます。 |
| void [set_Domain](./set_domain/)([String](../../system/string/)) | 資格情報を検証するドメインを設定します。 |
| void [set_Password](./set_password/)([String](../../system/string/)) | パスワードを設定します。 |
| void [set_UserName](./set_username/)([String](../../system/string/)) | ユーザー名を設定します。 |
