...
description: HttpResponseHeader 列挙値を操作するユーティリティ メソッドを含みます。
type: docs
weight: 235
url: /ja/system.net/httpresponseheaderextensions/
---
## HttpResponseHeaderExtensions クラス

HttpResponseHeader 列挙値を操作するユーティリティ メソッドを含みます。
...
| static [String](../../system/string/) [GetName](./getname/)([HttpResponseHeader](../httpresponseheader/)) | 指定されたヘッダーの名前を返します。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | オブジェクトの実際の型を取得します。C# [System.Object.GetType()](../../system/object/gettype/) 呼び出しのアナログです。 |
|  [HttpResponseHeaderExtensions](./httpresponseheaderextensions/)() | 削除されたデフォルト コンストラクタです。 |
