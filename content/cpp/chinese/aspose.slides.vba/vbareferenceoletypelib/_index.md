...
| [System::String](../../system/string/) [get_Libid](./get_libid/)() override | 表示 Automation 类型库的标识符。阅读 [System::String](../../system/string/)。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 表示 VBA 项目引用的名称。阅读 [System::String](../../system/string/)。 |
...
| void [set_Libid](./set_libid/)([System::String](../../system/string/)) override | 表示 Automation 类型库的标识符。写入 [System::String](../../system/string/)。 |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | 表示 VBA 项目引用的名称。写入 [System::String](../../system/string/)。 |
...
|  [VbaReferenceOleTypeLib](./vbareferenceoletypelib/)([System::String](../../system/string/), [System::String](../../system/string/)) | 此构造函数创建新的 OLE Automation 类型库引用。 |
...
* 类 [IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)
