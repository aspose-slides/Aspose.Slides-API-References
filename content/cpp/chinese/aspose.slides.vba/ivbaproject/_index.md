...
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | 指示 VBAProject 是否受密码保护以查看项目属性。只读 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | 返回 VBA 项目中指定索引处的模块。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | 返回 VBA 项目中包含的所有模块的列表。只读 [IVbaModuleCollection](../ivbamodulecollection/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 返回 VBA 项目的名称。只读 [System::String](../../system/string/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | 返回 VBA 项目中指定索引处的引用。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | 返回 VBA 项目中包含的所有引用的列表。只读 [IVbaReferenceCollection](../ivbareferencecollection/)。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | 返回 VBA 项目作为 OLE 容器的二进制表示。只读 **uint8_t**[]。 |
