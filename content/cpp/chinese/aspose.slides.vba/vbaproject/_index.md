...
| **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() override | 指示 VBAProject 是否受密码保护以查看项目属性。只读 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) override | 返回 VBA 项目中指定索引的模块。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() override | 返回 VBA 项目中包含的所有模块的列表。只读 [IVbaModuleCollection](../ivbamodulecollection/)。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 返回 VBA 项目的名称。只读 [System::String](../../system/string/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) override | 返回 VBA 项目中指定索引的引用。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() override | 返回 VBA 项目中包含的所有引用的列表。只读 [IVbaReferenceCollection](../ivbareferencecollection/)。 |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() override | 返回 VBA 项目的二进制表示，作为 OLE 容器 |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | 相当于 C# [Object.ToString()](../../system/object/tostring/) 方法。启用将自定义对象转换为字符串。 |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | 实现 C# typeof([System.Object](../../system/object/)) 构造。 |
| void [Unlock](../../system/object/unlock/)() | 实现 C# lock() 语句的解锁。直接调用或使用 [LockContext](../../system/lockcontext/) 哨兵对象。 |
|  [VbaProject](./vbaproject/)() | 此构造函数从头创建新的 VBA 项目。项目将使用 1252 Windows Latin 1 (ANSI) 代码页创建 |
|  [VbaProject](./vbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 此构造函数从 OLE 容器的二进制表示加载 VBA 项目。 |
