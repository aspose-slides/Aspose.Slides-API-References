...
description: "用于保存与 X.509 证书关联的额外信息的扩展对象。此类的对象只能使用 System::MakeObject() 函数分配。绝不能在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类封装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 144
url: /zh/system.security.cryptography.x509certificates/x509extension/
---
## X509Extension 类

扩展对象，用于保存与 X.509 证书关联的额外信息。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。绝对不要在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| void [CopyFrom](./copyfrom/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\>\&) override | 从另一个对象复制扩展数据。 |
...
| **bool** [get_Critical](./get_critical/)() const | 检查扩展是否关键。 |
...
| void [set_Critical](./set_critical/)(**bool**) | 定义扩展是否关键。 |
...
|  [X509Extension](./x509extension/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\>\&, **bool**) | 构造函数。 |
|  [X509Extension](./x509extension/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\>\&, const [ByteArrayPtr](../../system/bytearrayptr/)\&, **bool**) | 构造函数。 |
|  [X509Extension](./x509extension/)(const [String](../../system/string/)\&, const [ByteArrayPtr](../../system/bytearrayptr/)\&, **bool**) | 构造函数。 |
