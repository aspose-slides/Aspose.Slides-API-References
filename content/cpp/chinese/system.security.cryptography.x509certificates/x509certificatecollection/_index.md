...
type: docs
weight: 79
url: /zh/system.security.cryptography.x509certificates/x509certificatecollection/
---
## X509CertificateCollection 类
...
| 方法 | 描述 |
| --- | --- |
| void [_add_range](../../system.collections.generic/list/_add_range/)(std::initializer_list\<T\>) | C++ 特有。 |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | 将元素添加到列表末尾。 |
| void [AddInitializer](../../system.collections.generic/list/addinitializer/)(int, const T *) | 向列表添加元素；用于翻译初始化器时使用。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/list/begin/)() const | 获取常量限定集合中第一个元素的迭代器。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/list/cbegin/)() const | 获取集合中第一个常量限定元素的迭代器。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | 获取集合末尾之后不存在的常量限定元素的迭代器。 |
...
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | 从指定索引开始，将元素复制到现有数组元素中。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | 获取集合中最后一个常量限定元素的反向迭代器（逆序中的第一个）。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crend](../../system.collections.generic/list/crend/)() const | 获取集合开始之前不存在的常量限定元素的反向迭代器。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | 获取集合末尾之后不存在的元素的迭代器。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | 获取常量限定集合末尾之后不存在的元素的迭代器。 |
...
| [ListPtr](../../system.collections.generic/listptr/)\<T\> [FindAll](../../system.collections.generic/list/findall/)([System::Predicate](../../system/predicate/)\<T\>) | 查找满足特定谓词的元素集合。 |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | 在 [List](../../system.collections.generic/list/) 中包含指定数量的元素并以指定索引结束的范围内搜索指定对象，并返回其最后一次出现的零基索引。 |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 对通用序列的每个元素调用变换函数并返回最大的结果值。 |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 对通用序列的每个元素调用变换函数并返回最小的结果值。 |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | 获取常量限定集合中最后一个元素的反向迭代器（逆序中的第一个）。 |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() | 获取集合开始之前不存在的元素的反向迭代器。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | 获取常量限定集合开始之前不存在的元素的反向迭代器。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设为弱指针（而非共享）。允许将容器中的指针切换为弱模式。 |
...
| void [TrimExcess](../../system.collections.generic/list/trimexcess/)() | 将列表容量调整至恰好容纳其大小。 |
