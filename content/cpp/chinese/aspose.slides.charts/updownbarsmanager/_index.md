...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | 返回 DownBars 格式。只读 [IFormat](../iformat/)。 |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth。读取 **int32_t**。 |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars。读取 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | 返回 UpBars 格式。只读 [IFormat](../iformat/)。 |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth。写入 **int32_t**。 |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars。写入 **bool**。 |
...
* 类 [IUpDownBarsManager](../iupdownbarsmanager/)
