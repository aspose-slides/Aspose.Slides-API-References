...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_HorizontalAxis](./get_horizontalaxis/)() | 获取图表的水平坐标轴。只读 [IAxis](../iaxis/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryHorizontalAxis](./get_secondaryhorizontalaxis/)() | 获取图表的次要水平坐标轴。只读 [IAxis](../iaxis/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryVerticalAxis](./get_secondaryverticalaxis/)() | 获取图表的次要垂直坐标轴。只读 [IAxis](../iaxis/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SeriesAxis](./get_seriesaxis/)() | 获取图表的系列坐标轴。只读 [IAxis](../iaxis/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_VerticalAxis](./get_verticalaxis/)() | 获取图表的垂直坐标轴。只读 [IAxis](../iaxis/)。 |
