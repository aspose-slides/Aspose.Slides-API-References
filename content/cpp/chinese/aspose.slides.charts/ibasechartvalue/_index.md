...
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](./get_datasourcetype/)() | 指定 AsCell、AsLiteralString 或 AsLiteralDouble 属性是否为实际属性。换句话说，它指定 Data 属性的值的类型。此属性为只读。要更改此属性的值，可使用 ChartDataPointCollection.DataSourceTypeFor<...> 属性之一。阅读 [DataSourceType](../datasourcetype/)。 |
...
| virtual void [set_DataSourceType](./set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | 指定 AsCell、AsLiteralString 或 AsLiteralDouble 属性是否为实际属性。换句话说，它指定 Data 属性的值的类型。此属性为只读。要更改此属性的值，可使用 ChartDataPointCollection.DataSourceTypeFor<...> 属性之一。写入 [DataSourceType](../datasourcetype/)。 |
