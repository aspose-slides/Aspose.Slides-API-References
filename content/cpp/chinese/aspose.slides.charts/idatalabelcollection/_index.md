...
| virtual **int32_t** [get_Count](./get_count/)() | 获取集合中所有数据标签的数量。只读 **int32_t**。 |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | 获取集合中可见数据标签的数量。只读 **int32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | 返回集合中所有数据标签的默认格式。只读 [IDataLabelFormat](../idatalabelformat/)。 |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | False 表示数据标签默认不可见（因此 DefaultDataLabelFormat 属性的所有 Show* 标志（ShowValue 等）均为 false）。只读 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | 表示数据标签引导线格式。只读 [IChartLinesFormat](../ichartlinesformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | 返回父图表序列。只读 [IChartSeries](../ichartseries/)。 |
...
| virtual void [Hide](./hide/)() | 通过将 DefaultDataLabelFormat 属性的所有 Show* 标志（ShowValue 等）设置为 false，使数据标签默认隐藏。此后 IsVisible 为 false。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | 获取具有指定索引的数据点的数据标签。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | 返回集合中指定 [DataLabel](../datalabel/) 的索引。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法的类比。支持自定义类型的克隆。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 方法的类比。支持将自定义对象转换为字符串。 |
