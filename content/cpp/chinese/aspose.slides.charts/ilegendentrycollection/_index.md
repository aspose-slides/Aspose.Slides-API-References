...
| virtual **int32_t** [get_Count](./get_count/)() | 获取集合中实际包含的元素数量。只读 **int32_t**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) | 获取图例条目的属性，对应于 Chart.ChartData.Series[0].DataPoints[index]（当图表类型属于以下列表时：[ChartType::BarOfPie](../charttype/)、[ChartType::ExplodedPie](../charttype/)、[ChartType::ExplodedPie3D](../charttype/)、[ChartType::Pie](../charttype/)、[ChartType::Pie3D](../charttype/)、[ChartType::PieOfPie](../charttype/)）；或对应于其他图表类型的 Chart.ChartData.Series[index]。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 针对 string 和 nullptr 情形的 [Object::ReferenceEquals](../../system/object/referenceequals/) 专化。 |
