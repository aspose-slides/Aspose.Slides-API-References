...
description: 表示 IChartCategory 的集合
type: docs
weight: 599
...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | 如果集合中存在该类别，则返回它。否则从 [IChartDataCell](../ichartdatacell/) 创建新的图表类别并将其添加到集合中。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 从值创建新的 [IChartCategory](../ichartcategory/) 并将其添加到集合中。 |
...
| virtual void [Clear](./clear/)() | 从集合中移除所有元素。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 两个 NaN 不等于任何值，包括 NaN，也将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 两个 NaN 不等于任何值，包括 NaN，也将两个 NaN 视为相等。 |
...
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | 返回使用的类别分组级别的计数。对于多层类别，大于 1。只读 **int32_t**。 |
...
| virtual **bool** [get_UseCells](./get_usecells/)() | 如果为 true，则工作表用于存储类别（此情况支持多层类别）。如果为 false，则工作表不用于存储值（此情况不支持多层类别）。读取 **bool**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | 获取指定索引处的元素。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | 搜索指定的 [IChartCategory](../ichartcategory/)，并返回整个 Collection 中首次出现的零基索引。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | 通过加入元素的索引，将序列的每个元素转换为新的形式。 |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | 移除指定的值。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除给定索引处的元素。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定值。 |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | 如果为 true，则工作表用于存储类别（此情况支持多层类别）。如果为 false，则工作表不用于存储值（此情况不支持多层类别）。写入 **bool**。 |
