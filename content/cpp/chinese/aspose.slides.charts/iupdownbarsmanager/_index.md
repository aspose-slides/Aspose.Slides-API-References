...
description: 提供对折线或股票图的上/下柱的访问。
type: docs
weight: 1249
url: /zh/aspose.slides.charts/iupdownbarsmanager/
---
## IUpDownBarsManager 类
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 按引用比较对象，采用 C# 风格。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 按值比较对象，采用 C# 风格。 |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点数比较，即使根据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），这里两个 NaN 仍被视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点数比较，即使根据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），这里两个 NaN 仍被视为相等。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | 返回下柱的格式。只读 [IFormat](../iformat/)。 |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | 返回间隙宽度。读取 **int32_t**。 |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | 确定图表是否具有上/下柱。读取 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | 返回上柱的格式。只读 [IFormat](../iformat/)。 |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | 设置间隙宽度。写入 **int32_t**。 |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | 确定图表是否具有上/下柱。写入 **bool**。 |
