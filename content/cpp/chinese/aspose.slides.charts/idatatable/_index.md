...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 返回对象的线条、填充和效果样式。只读 [IFormat](../iformat/)。 |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | 如果图表数据表具有水平单元格边框，则为 True。读取 **bool**。 |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | 如果图表数据表具有轮廓边框，则为 True。读取 **bool**。 |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | 如果图表数据表具有垂直单元格边框，则为 True。读取 **bool**。 |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | 如果数据标签图例键可见，则为 True。读取 **bool**。 |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | 如果图表数据表具有水平单元格边框，则为 True。写入 **bool**。 |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | 如果图表数据表具有轮廓边框，则为 True。写入 **bool**。 |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | 如果图表数据表具有垂直单元格边框，则为 True。写入 **bool**。 |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | 如果数据标签图例键可见，则为 True。写入 **bool**。 |
