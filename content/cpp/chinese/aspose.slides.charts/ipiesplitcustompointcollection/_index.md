...
description: 表示将在带有自定义拆分的条形饼图或饼形条形图的第二个饼或条形中绘制的点集合。
type: docs
weight: 1158
url: /zh/aspose.slides.charts/ipiesplitcustompointcollection/
---
## IPieSplitCustomPointCollection 类
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | 通过在父系列点集合中的索引添加数据点。 |
...
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | 将集合中所有元素复制到现有数组元素。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置的迭代器（如果有）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，此迭代器不能用于更改所引用的对象。 |
...
|  [ICollection](../../system.collections.generic/icollection/icollection/)(const [ICollection](../../system.collections.generic/icollection/)\&) | 复制构造函数。 |
|  [ICollection](../../system.collections.generic/icollection/icollection/)([ICollection](../../system.collections.generic/icollection/)\&&) | 移动构造函数。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | 按索引返回图表数据点。 |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 返回满足条件的序列中第一个元素；如果未找到，则返回默认值。 |
...
| virtual void [Remove](./remove/)(**int32_t**) | 通过在父系列点集合中的索引从集合中移除项。 |
