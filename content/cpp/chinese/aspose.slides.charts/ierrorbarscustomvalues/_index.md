...
description: 指定误差线的数值。仅在错误线值类型为 Custom 时使用。
type: docs
weight: 1015
url: /zh/aspose.slides.charts/ierrorbarscustomvalues/
---
## IErrorBarsCustomValues 类


指定误差线的数值。仅在错误线值类型为 Custom 时使用。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() | 指定负方向的误差线数值。如果错误线值类型为 Custom 且允许 ErrorBarsXFormat，则可用。否则此属性返回 null。只读 [IDoubleChartValue](../idoublechartvalue/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() | 指定正方向的误差线数值。如果错误线值类型为 Custom 且允许 ErrorBarsXFormat，则可用。否则此属性返回 null。只读 [IDoubleChartValue](../idoublechartvalue/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() | 指定负方向的误差线数值。如果错误线值类型为 Custom 且允许 ErrorBarsYFormat，则可用。否则此属性返回 null。只读 [IDoubleChartValue](../idoublechartvalue/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() | 指定正方向的误差线数值。如果错误线值类型为 Custom 且允许 ErrorBarsYFormat，则可用。否则此属性返回 null。只读 [IDoubleChartValue](../idoublechartvalue/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法的对应实现。启用自定义对象的散列。 |
