...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 获取标记填充。只读 [IFormat](../iformat/)。 |
| **int32_t** [get_Size](./get_size/)() override | 表示折线图、散点图或雷达图中的标记大小。读取 **int32_t**。 |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | 表示折线图、散点图或雷达图中的标记样式。读取 [MarkerStyleType](../markerstyletype/)。 |
...
| void [set_Size](./set_size/)(**int32_t**) override | 表示折线图、散点图或雷达图中的标记大小。写入 **int32_t**。 |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | 表示折线图、散点图或雷达图中的标记样式。写入 [MarkerStyleType](../markerstyletype/)。 |
