...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 仿真 C# 风格的浮点比较，其中两个 NaN 被视为相等，即使根据 IEC 60559:1989，NaN 不等于任何值，包括 NaN。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 仿真 C# 风格的浮点比较，其中两个 NaN 被视为相等，即使根据 IEC 60559:1989，NaN 不等于任何值，包括 NaN。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 返回墙壁填充、线条、效果、3D 样式。只读 [IFormat](../iformat/)。 |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | 返回或设置图片类型。读取 [Charts::PictureType](../picturetype/)。 |
| **int32_t** [get_Thickness](./get_thickness/)() override | 返回墙壁厚度，以绘图体积最大尺寸的百分比表示。读取 **int32_t**。 |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | 返回或设置图片类型。写入 [Charts::PictureType](../picturetype/)。 |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | 将墙壁厚度设置为绘图体积最大尺寸的百分比。写入 **int32_t**。 |
