...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() | 返回图表数据单元格。读取 [IChartDataCell](../ichartdatacell/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | 指定 AsCell、AsLiteralString 或 AsLiteralDouble 属性是否实际。换言之，它指定 Data 属性的值类型。此属性为只读。若要更改此属性的值，可以使用 ChartDataPointCollection.DataSourceTypeFor<...> 属性之一。读取 [DataSourceType](../datasourcetype/)。 |
...
| virtual void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | 设置图表数据单元格。写入 [IChartDataCell](../ichartdatacell/)。 |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | 指定 AsCell、AsLiteralString 或 AsLiteralDouble 属性是否实际。换言之，它指定 Data 属性的值类型。此属性为只读。若要更改此属性的值，可以使用 ChartDataPointCollection.DataSourceTypeFor<...> 属性之一。写入 [DataSourceType](../datasourcetype/)。 |
