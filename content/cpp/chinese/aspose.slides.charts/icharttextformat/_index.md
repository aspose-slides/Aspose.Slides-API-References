...
description: 图表使用受限的文本格式属性集合。IChartTextFormat、IChartTextBlockFormat、IChartParagraphFormat、IChartPortionFormat 接口描述了此受限集合。
type: docs
weight: 898
...
[Chart](../chart/) 操作受限的文本格式属性集合。[IChartTextFormat](./)、[IChartTextBlockFormat](../icharttextblockformat/)、[IChartParagraphFormat](../ichartparagraphformat/)、[IChartPortionFormat](../ichartportionformat/) 接口描述此受限集合。
...
| 方法 | 描述 |
| --- | --- |
| virtual void [CopyFrom](./copyfrom/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | 从指定的文本框复制文本格式。 |
| virtual void [CopyTo](./copyto/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | 将文本格式复制到指定的文本框。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartParagraphFormat](../ichartparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | 返回段落格式。只读 [IChartParagraphFormat](../ichartparagraphformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartPortionFormat](../ichartportionformat/)\> [get_PortionFormat](./get_portionformat/)() | 返回部分格式。只读 [IChartPortionFormat](../ichartportionformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextBlockFormat](../icharttextblockformat/)\> [get_TextBlockFormat](./get_textblockformat/)() | 返回图表文本元素的格式。只读 [IChartTextBlockFormat](../icharttextblockformat/)。 |
