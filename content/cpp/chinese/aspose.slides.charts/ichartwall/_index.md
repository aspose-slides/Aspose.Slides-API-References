...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 返回墙壁的填充、线条、效果、3d 样式。只读 [IFormat](../iformat/)。 |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | 返回或设置图片类型。读取 [PictureType](../picturetype/)。 |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | 返回墙壁厚度，作为绘图体积最大维度的百分比。读取 **int32_t**。 |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | 返回或设置图片类型。写入 [PictureType](../picturetype/)。 |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | 设置墙壁厚度，作为绘图体积最大维度的百分比。写入 **int32_t**。 |
