...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) | 创建新的图表系列并将其添加到集合中。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) | 从 [IChartDataCell](../ichartdatacell/) 创建新的图表系列并将其添加到集合中。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) | 从 [IChartCellCollection](../ichartcellcollection/) 创建新的图表系列并将其添加到集合中。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) | 从值创建新的图表系列并将其添加到集合中。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果存在）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，因此该迭代器不能用于更改引用的对象。 |
...
| virtual void [Clear](./clear/)() | 从集合中移除所有元素（包括图表样式）。 |
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 将集合中的所有元素复制到指定的数组中。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置的迭代器（如果存在）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，该迭代器不能用于更改引用的对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 获取指向 const 限定的集合实例中最后一个元素之后的位置的迭代器（如果存在）。 |
...
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | 在整个集合中搜索指定的 [IChartSeries](../ichartseries/)，并返回首次出现的零基索引。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) | 创建新的图表系列并将其插入集合中。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 按 keySelector 选择的键值对序列的元素进行升序排序。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 按 keySelector 选择的键值对序列的元素进行降序排序。 |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除指定索引处的元素。 |
