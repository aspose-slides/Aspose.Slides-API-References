...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() override | 返回图表使用的效果。只读 [IEffectFormat](../../aspose.slides/ieffectformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../../aspose.slides/ithreedformat/)\> [get_Effect3D](./get_effect3d/)() override | 返回图表的 3D 格式。只读 [IThreeDFormat](../../aspose.slides/ithreedformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_Fill](./get_fill/)() override | 返回图表的填充样式属性。只读 [IFillFormat](../../aspose.slides/ifillformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_Line](./get_line/)() override | 返回图表的线条样式属性。只读 [ILineFormat](../../aspose.slides/ilineformat/)。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 通过指定值减少共享引用计数。 |
