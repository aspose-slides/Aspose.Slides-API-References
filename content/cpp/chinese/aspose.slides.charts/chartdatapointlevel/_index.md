...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 表示数据点级别的格式属性。阅读 [IFormat](../iformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | 表示数据点级别的数据标签。适用于 Treemap 和 Sunburst 系列类型。只读 [IDataLabel](../idatalabel/)。 |
...
* 类 [IChartDataPointLevel](../ichartdatapointlevel/)
