...
| virtual **float** [get_Bottom](./get_bottom/)() | 获取图表元素的顶部，以图表高度的比例表示。只读 **float**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](../ichartcomponent/get_chart/)() | 返回图表。只读 [IChart](../ichart/)。 |
| virtual **float** [get_Height](./get_height/)() | 指定图表元素的高度，以图表高度的比例表示。读取 **float**。 |
...
| virtual **float** [get_Right](./get_right/)() | 获取图表元素的右侧，以图表宽度的比例表示。只读 **float**。 |
...
| virtual **float** [get_Width](./get_width/)() | 指定图表元素的宽度，以图表宽度的比例表示。读取 **float**。 |
| virtual **float** [get_X](./get_x/)() | 指定图表元素的 x 位置（左），以图表宽度的比例表示。读取 **float**。 |
| virtual **float** [get_Y](./get_y/)() | 指定图表元素的顶部，以图表高度的比例表示。读取 **float**。 |
...
| virtual void [set_Height](./set_height/)(**float**) | 指定图表元素的高度，以图表高度的比例表示。写入 **float**。 |
| virtual void [set_Width](./set_width/)(**float**) | 指定图表元素的宽度，以图表宽度的比例表示。写入 **float**。 |
| virtual void [set_X](./set_x/)(**float**) | 指定图表元素的 x 位置（左），以图表宽度的比例表示。写入 **float**。 |
| virtual void [set_Y](./set_y/)(**float**) | 指定图表元素的顶部，以图表高度的比例表示。写入 **float**。 |
