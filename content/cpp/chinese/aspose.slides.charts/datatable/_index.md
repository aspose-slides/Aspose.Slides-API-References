...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 返回对象的线条、填充和效果样式。只读 [IFormat](../iformat/)。 |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | 如果图表数据表具有水平单元格边框则返回 true。读取 **bool**。 |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | 如果图表数据表具有轮廓边框则返回 true。读取 **bool**。 |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | 如果图表数据表具有垂直单元格边框则返回 true。读取 **bool**。 |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | 如果数据标签图例键可见则返回 true。读取 **bool**。 |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | 如果图表数据表具有水平单元格边框则返回 true。写入 **bool**。 |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | 如果图表数据表具有轮廓边框则返回 true。写入 **bool**。 |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | 如果图表数据表具有垂直单元格边框则返回 true。写入 **bool**。 |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | 如果数据标签图例键可见则返回 true。写入 **bool**。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 设置第 n 个模板参数为弱指针（而不是共享指针）。允许在容器中将指针切换为弱模式。 |
