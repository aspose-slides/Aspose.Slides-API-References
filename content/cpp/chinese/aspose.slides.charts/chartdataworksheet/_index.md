...
| **int32_t** [get_Index](./get_index/)() override | 获取工作表的索引。只读 **int32_t**。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 返回工作表的名称。只读 [System::String](../../system/string/)。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上什么也不复制，只是初始化新对象并允许复制构造子类。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上什么也不复制，只是初始化新对象并允许复制构造子类。 |
...
* 类 [IChartDataWorksheet](../ichartdataworksheet/)
