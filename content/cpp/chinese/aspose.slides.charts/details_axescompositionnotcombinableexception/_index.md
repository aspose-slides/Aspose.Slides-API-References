...
description: 当系列的坐标轴组合与图表中当前的坐标轴组合不可兼容时抛出的异常。
type: docs
weight: 430
url: /zh/aspose.slides.charts/details_axescompositionnotcombinableexception/
---
## Details_AxesCompositionNotCombinableException 类

当系列的坐标轴组合与图表中当前的坐标轴组合不可兼容时抛出的异常。
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | 返回包含堆栈追踪的字符串。 |
