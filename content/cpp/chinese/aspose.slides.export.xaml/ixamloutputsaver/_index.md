...
description: 表示用于将数据传输到外部存储的输出保存器实现。
type: docs
weight: 14
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 将字节数组保存到目标位置。 |
