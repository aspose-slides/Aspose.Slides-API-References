...
| **int32_t** [get_Column](./get_column/)() override | 获取单元格所在工作表中列的零基索引。只读 **int32_t**。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 获取图表数据单元格的名称。 |
| **int32_t** [get_Row](./get_row/)() override | 获取单元格所在工作表中行的零基索引。只读 **int32_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | 获取 [Excel](../) 单元格中包含的值。 |
