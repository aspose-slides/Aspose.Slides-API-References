...
description: 表示一个实体引用节点。
type: docs
weight: 248
url: /zh/system.xml/xmlentityreference/
---
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。此迭代器不能用于更改被引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的迭代器（如果有）。此迭代器不能用于更改被引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象。 |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | 返回当前节点的基础统一资源标识符（URI）。 |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | 返回一个值，指示此节点是否具有任何子节点。 |
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | 返回节点及其所有子节点的连接值。 |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | 返回仅表示此节点子节点的标记。 |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | 返回一个值，指示节点是否只读。 |
...
| [String](../../system/string/) [get_Name](./get_name/)() override | 返回节点的名称。 |
...
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | 返回节点的类型。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | 返回紧接在此节点之前的节点。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | 返回紧接在此节点之前的文本节点。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | 返回一个枚举器，用于遍历当前节点中的子节点。 |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 查找在当前节点范围内与给定前缀最近的 **xmlns** 声明，并返回该声明中的命名空间 URI。 |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | 查找在当前节点范围内与给定命名空间 URI 最近的 **xmlns** 声明，并返回该声明中定义的前缀。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 按 keySelector 选取的键值，以升序对序列的元素进行排序。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 按 keySelector 选取的键值，以降序对序列的元素进行排序。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 对每个元素进行投影，并将结果序列合并为一个序列。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | 将此 [XmlNode](../xmlnode/) 下的子树中所有 [XmlText](../xmltext/) 节点转换为“正常”形式，使只有标记（即标签、注释、处理指令、CDATA 部分和实体引用）分隔 [XmlText](../xmltext/) 节点，即没有相邻的 [XmlText](../xmltext/) 节点。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | 选择匹配 [XPath](../../system.xml.xpath/) 表达式的节点列表。[XPath](../../system.xml.xpath/) 表达式中出现的任何前缀使用提供的 [XmlNamespaceManager](../xmlnamespacemanager/) 解析。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&) | 选择第一个匹配 [XPath](../../system.xml.xpath/) 表达式的 [XmlNode](../xmlnode/)。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | 选择第一个匹配 [XPath](../../system.xml.xpath/) 表达式的 [XmlNode](../xmlnode/)。[XPath](../../system.xml.xpath/) 表达式中出现的任何前缀使用提供的 [XmlNamespaceManager](../xmlnamespacemanager/) 解析。 |
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | 设置节点及其所有子节点的连接值。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 将节点的所有子节点保存到指定的 [XmlWriter](../xmlwriter/)。 |
...
此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数进行分配。不要在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言错误。始终将此类包装到 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
