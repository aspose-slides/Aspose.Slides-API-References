...
description: 定义一组 XmlDocument 对象的上下文。
type: docs
weight: 261
url: /zh/system.xml/xmlimplementation/
---
## XmlImplementation 类
...
| 方法 | 描述 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [CreateDocument](./createdocument/)() | 创建一个新的 [XmlDocument](../xmldocument/)。 |
...
| **bool** [HasFeature](./hasfeature/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | 测试 Document [Object](../../system/object/) Model (DOM) 实现是否实现特定功能。 |
...
|  [XmlImplementation](./xmlimplementation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | 使用指定的 [XmlNameTable](../xmlnametable/) 初始化 [XmlImplementation](./) 类的新实例。 |
