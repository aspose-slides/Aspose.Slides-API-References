...
description: 原子化字符串对象表。
type: docs
weight: 313
url: /zh/system.xml/xmlnametable/
---
## XmlNameTable 类
...
| 方法 | 描述 |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | 当在派生类中被重写时，对指定的字符串进行原子化并将其添加到 [XmlNameTable](./)。 |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | 当在派生类中被重写时，对指定的字符串进行原子化并将其添加到 [XmlNameTable](./)。 |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | 当在派生类中被重写时，获取包含给定数组中指定字符范围的相同字符的原子化字符串。 |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | 当在派生类中被重写时，获取包含与指定字符串相同值的原子化字符串。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否表示由 targetType 描述的类型的实例。C# 'is' 运算符的类比。 |
