...
description: 实现单线程的 XmlNameTable。
type: docs
weight: 66
url: /zh/system.xml/nametable/
---
## NameTable 类
...
| 方法 | 描述 |
| --- | --- |
| const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) override | 将指定的字符串原子化并将其添加到 [NameTable](./)。 |
| const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | 将指定的字符串原子化并将其添加到 [NameTable](./)。 |
...
| const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) override | 返回具有指定值的原子化字符串。 |
| const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | 返回包含与给定数组中指定字符范围相同字符的原子化字符串。 |
...
|  [NameTable](./nametable/)() | 初始化 [NameTable](./) 类的新实例。 |
