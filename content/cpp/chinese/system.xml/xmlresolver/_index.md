...
description: 解析由统一资源标识符（URI）命名的外部 XML 资源。
type: docs
weight: 456
url: /zh/system.xml/xmlresolver/
---
## XmlResolver 类
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) | 在派生类中被重写时，将 URI 映射到包含实际资源的对象。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | 在派生类中被重写时，从基准 URI 和相对 URI 解析出绝对 URI。 |
| virtual void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | 在派生类中被重写时，设置用于身份验证网络请求的凭据。 |
...
| virtual **bool** [SupportsType](./supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | 允许解析器返回除 Stream 之外的类型。 |
