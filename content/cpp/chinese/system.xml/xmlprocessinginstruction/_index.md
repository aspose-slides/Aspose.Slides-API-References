...
description: 表示处理指令，XML 定义此指令以在文档文本中保留特定处理器的信息。
type: docs
weight: 404
url: /zh/system.xml/xmlprocessinginstruction/
---
...
| Method | Description |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | 将指定节点添加到该节点的子节点列表的末尾。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（若存在）的迭代器。此迭代器无法用于更改引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | 获取指向集合中最后一个 const 限定元素之后的位置（若存在）的迭代器。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置（若存在）的迭代器。此迭代器无法用于更改引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 获取指向 const 限定实例中最后一个元素之后的位置（若存在）的迭代器。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](../xmlnode/get_attributes/)() | 返回一个 [XmlAttributeCollection](../xmlattributecollection/)，其中包含此节点的属性。 |
| virtual [String](../../system/string/) [get_BaseURI](../xmlnode/get_baseuri/)() | 返回当前节点的基础 URI。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](../xmlnode/get_childnodes/)() | 返回该节点的所有子节点。 |
| [String](../../system/string/) [get_Data](./get_data/)() | 返回处理指令的内容，不包括目标。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | 返回节点的第一个子节点。 |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | 返回一个值，指示此节点是否具有子节点。 |
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | 返回节点及其所有子节点的连接值。 |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | 返回仅表示此节点子节点的标记。 |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | 返回一个值，指示该节点是否为只读。 |
...
| [String](../../system/string/) [get_Target](./get_target/)() | 返回处理指令的目标。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 将每个元素投影并将产生的序列合并为一个序列。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | 将此 [XmlNode](../xmlnode/) 下子树全部深度的所有 [XmlText](../xmltext/) 节点转换为 \"normal\" 形式，即仅有标记（标签、注释、处理指令、CDATA 区段和实体引用）分隔 [XmlText](../xmltext/) 节点，且不存在相邻的 [XmlText](../xmltext/) 节点。 |
...
| void [set_Data](./set_data/)(const [String](../../system/string/)\&) | 设置处理指令的内容，不包括目标。 |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | 设置节点及其所有子节点的连接值。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 将节点的所有子节点保存到指定的 [XmlWriter](../xmlwriter/)。由于 ProcessingInstruction 节点没有子节点，此方法无效。 |
