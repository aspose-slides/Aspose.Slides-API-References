...
description: 表示文档类型声明。
type: docs
weight: 209
url: /zh/system.xml/xmldocumenttype/
---
## XmlDocumentType 类
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。该迭代器不能用于更改引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | 创建用于导航此对象的 XPathNavigator。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。该迭代器不能用于更改引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Entities](./get_entities/)() | 返回文档类型声明中声明的 [XmlEntity](../xmlentity/) 节点集合。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | 返回节点的第一个子节点。 |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | 返回指示此节点是否具有任何子节点的值。 |
...
| [String](../../system/string/) [get_InternalSubset](./get_internalsubset/)() | 返回 DOCTYPE 声明上文档类型定义（DTD）内部子集的值。 |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | 返回指示节点是否为只读的值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Notations](./get_notations/)() | 返回文档类型声明中出现的 [XmlNotation](../xmlnotation/) 节点集合。 |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | 返回 DOCTYPE 声明上公共标识符的值。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | 返回已分配给此节点的后模式验证信息集（因模式验证而产生）。 |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | 返回 DOCTYPE 声明上系统标识符的值。 |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 对泛型序列的每个元素调用转换函数，并返回最大结果值。 |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 对泛型序列的每个元素调用转换函数，并返回最小结果值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 按照 keySelector 选择的键值，以升序对序列的元素进行排序。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 按照 keySelector 选择的键值，以降序对序列的元素进行排序。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 对序列的元素进行转换。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | 将此 [XmlNode](../xmlnode/) 下子树的全部深度中的所有 [XmlText](../xmltext/) 节点转换为“正常”形式，即只有标记（标签、注释、处理指令、CDATA 区段和实体引用）分隔 [XmlText](../xmltext/) 节点，确保不存在相邻的 [XmlText](../xmltext/) 节点。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 对于字符串和 nullptr 的 [Object::ReferenceEquals](../../system/object/referenceequals/) 特化。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | 对于字符串的 [Object::ReferenceEquals](../../system/object/referenceequals/) 特化。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 将节点的所有子节点保存到指定的 [XmlWriter](../xmlwriter/)。对于 [XmlDocumentType](./) 节点，此方法无效。 |
...
此类的对象应该仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 操作符创建此类型的实例，因为这会导致运行时错误和/或断言失败。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
