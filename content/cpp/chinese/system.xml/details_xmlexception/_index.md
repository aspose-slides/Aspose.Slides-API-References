...
description: 返回有关最近一次异常的详细信息。
type: docs
weight: 1
url: /zh/system.xml/details_xmlexception/
---
## Details_XmlException 类
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | 返回指示错误发生位置的行号。行号从 1 开始。 |
| **int32_t** [get_LinePosition](./get_lineposition/)() | 返回指示错误发生位置的行位置。行位置从 1 开始。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 返回描述当前异常的消息。 |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 返回 XML 文件的位置。 |
