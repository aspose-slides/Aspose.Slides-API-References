...
description: 表示一种在树插入操作中有用的轻量级对象。
type: docs
weight: 196
url: /zh/system.xml/xmldocumentfragment/
---
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，此迭代器无法用于更改引用的对象。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | 创建一个用于遍历此对象的 XPathNavigator。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的迭代器（如果有）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，此迭代器无法用于更改引用的对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 获取指向 const 限定实例中最后一个元素之后的迭代器（如果有）。 |
...
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | 返回表示此节点子节点的标记。 |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | 返回一个值，指示节点是否只读。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | 返回紧跟在此节点之后的节点。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() override | 返回此节点所属的 [XmlDocument](../xmldocument/)。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | 返回此节点的父节点（适用于能够有父节点的节点）。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | 返回紧跟在此节点之前的文本节点。 |
...
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | 返回节点的值。 |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法的类似实现。使自定义对象能够进行哈希。 |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 查找当前节点作用域内给定前缀的最近的 **xmlns** 声明，并返回声明中的命名空间 URI。 |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | 查找当前节点作用域内给定命名空间 URI 的最近的 **xmlns** 声明，并返回该声明中定义的前缀。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | 确定序列中是否存在任意元素或满足条件。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 将序列的每个元素投影并将所得序列合并为一个序列。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法的类似实现。使自定义类型能够克隆。 |
| virtual void [Normalize](../xmlnode/normalize/)() | 将此 [XmlNode](../xmlnode/) 下子树的全部深度中的所有 [XmlText](../xmltext/) 节点转换为“普通”形式，仅有标记（即标签、注释、处理指令、CDATA 区段和实体引用）分隔 [XmlText](../xmltext/) 节点，即不存在相邻的 [XmlText](../xmltext/) 节点。 |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | 通过引用将值类型对象与 nullptr 进行比较。 |
...
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | 设置表示此节点子节点的标记。 |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | 设置此节点的命名空间前缀。 |
| virtual void [set_Value](../xmlnode/set_value/)([String](../../system/string/)) | 设置节点的值。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 方法的类似实现。使自定义对象能够转换为字符串。 |
...
此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
