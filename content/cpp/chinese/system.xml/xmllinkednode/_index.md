...
description: 返回紧邻此节点之前或之后的节点。
type: docs
weight: 274
url: /zh/system.xml/xmllinkednode/
---
## XmlLinkedNode 类
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | 在派生类中覆盖时，创建节点的副本。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果存在）之后的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，此迭代器不能用于更改引用的对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 获取指向 const 限定实例的集合中最后一个元素（如果存在）之后的迭代器。 |
...
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | 在派生类中覆盖时，返回节点的本地名称。 |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | 在派生类中覆盖时，返回节点的限定名称。 |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | 在派生类中覆盖时，返回当前节点的类型。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 对序列的每个元素进行投影并将结果序列合并为一个序列。 |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<Source, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\>\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | 返回从序列开头开始的指定数量的连续元素。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | 将此 [XmlNode](../xmlnode/) 以下子树中全部 [XmlText](../xmltext/) 节点的完整深度转换为“普通”形式，即仅有标记（标签、注释、处理指令、CDATA 部分以及实体引用）分隔 [XmlText](../xmltext/) 节点，确保没有相邻的 [XmlText](../xmltext/) 节点。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | 选择第一个匹配 [XPath](../../system.xml.xpath/) 表达式的 [XmlNode](../xmlnode/)。[XPath](../../system.xml.xpath/) 表达式中出现的任何前缀均使用提供的 [XmlNamespaceManager](../xmlnamespacemanager/) 解析。 |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 在派生类中覆盖时，将节点的所有子节点保存到指定的 [XmlWriter](../xmlwriter/)。 |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 在派生类中覆盖时，将当前节点保存到指定的 [XmlWriter](../xmlwriter/)。 |
