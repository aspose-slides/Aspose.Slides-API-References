...
type: docs
weight: 560
url: /zh/system.xml/xmltextreader/readattributevalue/
---
...
**true** 如果有节点可返回。**false** 如果在首次调用时读取器未定位在属性节点上，或所有属性值已被读取。空属性，例如 **misc=\"\"**，返回 **true** 并包含一个值为 [String::Empty](../../../system/string/empty/) 的单节点。
