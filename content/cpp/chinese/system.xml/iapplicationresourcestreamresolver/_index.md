...
description: 表示一个应用程序资源流解析器。
type: docs
weight: 14
url: /zh/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver 类
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | 从指定的 URI 返回一个应用程序资源流。 |
