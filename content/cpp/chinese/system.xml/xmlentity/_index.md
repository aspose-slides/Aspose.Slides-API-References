...
description: 表示实体声明，例如 <!ENTITY... >.
type: docs
weight: 235
url: /zh/system.xml/xmlentity/
---
## XmlEntity 类
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，不能使用此迭代器更改所引用的对象。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | 创建此节点的副本。实体节点不能被克隆。在 [XmlEntity](./) 对象上调用此方法会抛出异常。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置的迭代器（如果有）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，不能使用此迭代器更改所引用的对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 获取指向集合的 const 限定实例中最后一个元素之后的位置的迭代器（如果有）。 |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | 使用 C# [Object.Equals](../../system/object/equals/) 语义比较对象。 |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较引用类型对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较值类型对象。 |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 样式的浮点比较，其中两个 NaN 被视为相等，尽管根据 IEC 60559:1989，NaN 与任何值（包括 NaN）都不相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 样式的浮点比较，其中两个 NaN 被视为相等，尽管根据 IEC 60559:1989，NaN 与任何值（包括 NaN）都不相等。 |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | 返回实体节点及其所有子节点的连接值。 |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | 返回表示此节点子节点的标记。 |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | 返回一个值，指示节点是否为只读。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | 返回节点的最后一个子节点。 |
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | 返回不带命名空间前缀的节点名称。 |
...
| [String](../../system/string/) [get_NotationName](./get_notationname/)() | 返回实体声明上可选 NDATA 属性的名称。 |
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | 返回表示此节点及其所有子节点的标记。 |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | 返回实体声明上公共标识符的值。 |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | 返回实体声明上系统标识符的值。 |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 查找当前节点范围内给定前缀的最近 **xmlns** 声明，并返回该声明中的命名空间 URI。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | 将此 [XmlNode](../xmlnode/) 下子树全部深度的 [XmlText](../xmltext/) 节点转换为“正常”形式，使得仅有标记（即标签、注释、处理指令、CDATA 节、实体引用）分隔 [XmlText](../xmltext/) 节点，即不存在相邻的 [XmlText](../xmltext/) 节点。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 将节点的所有子节点保存到指定的 [XmlWriter](../xmlwriter/)。对于 [XmlEntity](./) 节点，此方法无效。 |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 将节点保存到指定的 [XmlWriter](../xmlwriter/)。对于 [XmlEntity](./) 节点，此方法无效。 |
...
此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 操作符创建此类型的实例，因为会导致运行时错误和/或断言错误。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
