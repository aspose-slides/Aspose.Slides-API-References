...
description: 表示符号声明，例如 <!NOTATION... >。
type: docs
weight: 378
url: /zh/system.xml/xmlnotation/
---
## XmlNotation 类
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，无法使用此迭代器更改引用的对象。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | 创建此节点的副本。符号节点不能被克隆。在 [XmlNotation](./) 对象上调用此方法会抛出异常。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，无法使用此迭代器更改引用的对象。 |
...
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | 返回节点及其所有子节点的串联值。 |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | 返回当前节点不带命名空间前缀的名称。 |
| [String](../../system/string/) [get_Name](./get_name/)() override | 返回当前节点的名称。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | 返回紧随此节点之前的文本节点。 |
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | 返回符号声明上公共标识符的值。 |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | 返回符号声明上系统标识符的值。 |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 查找当前节点作用域内给定前缀的最近 **xmlns** 声明，并返回声明中的命名空间 URI。 |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | 查找当前节点作用域内给定命名空间 URI 的最近 **xmlns** 声明，并返回该声明中定义的前缀。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 按 keySelector 选取的键值对序列的元素进行升序排序。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 按 keySelector 选取的键值对序列的元素进行降序排序。 |
...
| [System::ArrayPtr](../../system/arrayptr/)\<T\> [LINQ_ToArray](../../system.collections.generic/ienumerable/linq_toarray/)() | 从序列创建一个数组。 |
| [SharedPtr](../../system/sharedptr/)\<[List](../../system.collections.generic/list/)\<T\>\> [LINQ_ToList](../../system.collections.generic/ienumerable/linq_tolist/)() | 从序列创建一个 List<T>。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | 将此 [XmlNode](../xmlnode/) 下子树完整深度中的所有 [XmlText](../xmltext/) 节点转换为“正常”形式，仅有标记（即标签、注释、处理指令、CDATA 区段和实体引用）分隔 [XmlText](../xmltext/) 节点，即不存在相邻的 [XmlText](../xmltext/) 节点。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | 将指定节点添加到该节点的子节点列表的开头。 |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | 设置节点及其所有子节点的串联值。 |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 将节点的子节点保存到指定的 [XmlWriter](../xmlwriter/)。此方法对 [XmlNotation](./) 节点无效。 |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | 将节点保存到指定的 [XmlWriter](../xmlwriter/)。此方法对 [XmlNotation](./) 节点无效。 |
...
此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 操作符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
