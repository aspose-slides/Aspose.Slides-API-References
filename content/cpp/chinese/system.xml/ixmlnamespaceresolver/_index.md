...
description: 提供对一组前缀和命名空间映射的只读访问。
type: docs
weight: 53
url: /zh/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver 类
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) | 返回当前作用域内已定义的前缀-命名空间映射集合。 |
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | 返回映射到指定前缀的命名空间 URI。 |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | 返回映射到指定命名空间 URI 的前缀。 |
