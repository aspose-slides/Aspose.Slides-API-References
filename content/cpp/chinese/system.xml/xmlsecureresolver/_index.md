...
description: 通过包装 XmlResolver 对象并限制底层 XmlResolver 可访问的资源，帮助保护 XmlResolver 的另一实现。
type: docs
weight: 469
url: /zh/system.xml/xmlsecureresolver/
---
## XmlSecureResolver 类

通过包装 [XmlResolver](../xmlresolver/) 对象并限制底层 [XmlResolver](../xmlresolver/) 可访问的资源，帮助保护 [XmlResolver](../xmlresolver/) 的另一实现。
...
| [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | 通过调用底层 [XmlResolver](../xmlresolver/) 的 **ResolveUri**，从基 URI 和相对 URI 解析出绝对 URI。 |
| void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) override | 设置用于对网络请求进行身份验证的凭据。 |
...
| virtual **bool** [SupportsType](../xmlresolver/supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | 允许解析器返回除 Stream 之外的类型。 |
...
|  [XmlSecureResolver](./xmlsecureresolver/)(const [SharedPtr](../../system/sharedptr/)\<[XmlResolver](../xmlresolver/)\>\&, const [String](../../system/string/)\&) | 使用提供的 [XmlResolver](../xmlresolver/) 和 URL 初始化 [XmlSecureResolver](./) 类的新实例。 |
...
此类对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。永不要在栈上或使用 new 操作符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
