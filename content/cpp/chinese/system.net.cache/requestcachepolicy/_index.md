...
description: "常用的请求缓存策略，用于缓存 Http、FTP 等。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型实例，因为会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针作为参数传递给函数。"
type: docs
weight: 14
url: /zh/system.net.cache/requestcachepolicy/
---
## RequestCachePolicy 类

常用的请求缓存策略，用于缓存 [Http](../../system.net.http/)、FTP 等。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型实例，因为会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针作为参数传递给函数。
...
| [RequestCacheLevel](../requestcachelevel/) [get_Level](./get_level/)() | 获取指定的 RequestCacheLevel 值。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化版本，适用于字符串。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 按指定值减少共享引用计数。 |
|  [RequestCachePolicy](./requestcachepolicy/)() | 构造一个新实例。 |
|  [RequestCachePolicy](./requestcachepolicy/)([RequestCacheLevel](../requestcachelevel/)) | 使用指定的 RequestCacheLevel 值构造新实例。 |
