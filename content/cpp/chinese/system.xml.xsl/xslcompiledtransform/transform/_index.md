...
description: 使用 IXPathNavigable 对象指定的输入文档执行转换，并将结果输出到 XmlWriter。
type: docs
weight: 40
url: /zh/system.xml.xsl/xslcompiledtransform/transform/
---
...
使用 IXPathNavigable 对象指定的输入文档执行转换，并将结果输出到 [XmlWriter](../../../system.xml/xmlwriter/)。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数。
...
使用 IXPathNavigable 对象指定的输入文档执行转换，并将结果输出到 TextWriter。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数。
...
使用 IXPathNavigable 对象指定的输入文档执行转换，并将结果输出到流。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数。
...
使用 [XmlReader](../../../system.xml/xmlreader/) 对象指定的输入文档执行转换，并将结果输出到 [XmlWriter](../../../system.xml/xmlwriter/)。
...
使用 [XmlReader](../../../system.xml/xmlreader/) 对象指定的输入文档执行转换，并将结果输出到 [XmlWriter](../../../system.xml/xmlwriter/)。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数。
...
使用 [XmlReader](../../../system.xml/xmlreader/) 对象指定的输入文档执行转换，并将结果输出到 TextWriter。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数。
...
使用 [XmlReader](../../../system.xml/xmlreader/) 对象指定的输入文档执行转换，并将结果输出到流。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数。
...
使用指定为 URI 的输入文档执行转换，并将结果输出到 [XmlWriter](../../../system.xml/xmlwriter/)。
...
使用指定为 URI 的输入文档执行转换，并将结果输出到 [XmlWriter](../../../system.xml/xmlwriter/)。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数。
...
使用指定为 URI 的输入文档执行转换，并将结果输出到 TextWriter。
...
使用指定为 URI 的输入文档执行转换，并将结果输出到流。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数。
...
使用 [XmlReader](../../../system.xml/xmlreader/) 对象指定的输入文档执行转换，并将结果输出到 [XmlWriter](../../../system.xml/xmlwriter/)。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数，[XmlResolver](../../../system.xml/xmlresolver/) 负责解析 XSLT **document()** 函数。
...
使用 IXPathNavigable 对象指定的输入文档执行转换，并将结果输出到 [XmlWriter](../../../system.xml/xmlwriter/)。[XsltArgumentList](../../xsltargumentlist/) 提供了额外的运行时参数，[XmlResolver](../../../system.xml/xmlresolver/) 负责解析 XSLT **document()** 函数。
