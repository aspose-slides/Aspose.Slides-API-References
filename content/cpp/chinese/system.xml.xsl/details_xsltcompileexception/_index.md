...
description: 当在 XSLT 样式表中发现错误时，由 Load 方法抛出的异常。
type: docs
weight: 1
url: /zh/system.xml.xsl/details_xsltcompileexception/
---
## Details_XsltCompileException 类

当在 XSLT 样式表中发现错误时，由 **Load** 方法抛出的异常。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点数比较，其中两个 NaN 被视为相等，尽管依据 IEC 60559:1989，NaN 与任何值（包括 NaN）都不相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点数比较，其中两个 NaN 被视为相等，尽管依据 IEC 60559:1989，NaN 与任何值（包括 NaN）都不相等。 |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 返回一个 32 位整数值，它是与当前对象表示的异常关联的 HRESULT 代码。 |
...
| virtual **int32_t** [get_LineNumber](../details_xsltexception/get_linenumber/)() | 返回指示错误在样式表中出现位置的行号。 |
| virtual **int32_t** [get_LinePosition](../details_xsltexception/get_lineposition/)() | 返回指示错误在样式表中出现位置的列号。 |
| [String](../../system/string/) [get_Message](../details_xsltexception/get_message/)() const override | 返回描述当前异常的格式化错误信息。 |
| virtual [String](../../system/string/) [get_SourceUri](../details_xsltexception/get_sourceuri/)() | 返回样式表的位置路径。 |
...
* 类 [Details_XsltException](../details_xsltexception/)
* 命名空间 [System::Xml::Xsl](../)
* 库 [Aspose.Slides](../../)