...
description: 提供一个接口，以访问在运行时执行期间在样式表中定义的给定变量。
type: docs
weight: 40
url: /zh/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable 类

提供一个接口，以访问在运行时执行期间在样式表中定义的给定变量。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | 在运行时评估变量并返回表示该变量值的对象。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual **bool** [get_IsLocal](./get_islocal/)() | 返回一个值，指示变量是否本地。 |
| virtual **bool** [get_IsParam](./get_isparam/)() | 返回一个值，指示变量是否为可扩展样式表语言转换（XSLT）参数。这可以是样式表或模板的参数。 |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | 返回表示 XML 路径语言（[XPath](../../system.xml.xpath/)）类型的 XPathResultType。 |
