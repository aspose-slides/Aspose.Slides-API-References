...
description: 在处理 XSLT 转换时发生错误时抛出的异常。
type: docs
weight: 14
url: /zh/system.xml.xsl/details_xsltexception/
---
## Details_XsltException 类

在处理 XSLT 转换时出现错误时抛出的异常。
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | 返回指示错误发生位置的样式表行号。 |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | 返回指示错误发生位置的样式表列号。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 返回描述当前异常的格式化错误信息。 |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 返回样式表的位置路径。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类未从 std::exception 继承，但派生类可以使用受保护/私有成员来实现其逻辑。将此方法的实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
