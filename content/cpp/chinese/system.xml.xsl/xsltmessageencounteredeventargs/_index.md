...
description: "提供 XsltArgumentList::XsltMessageEncountered 事件的数据。"
type: docs
weight: 92
url: /zh/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs 类

提供 **XsltArgumentList::XsltMessageEncountered** 事件的数据。
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | 返回 **xsl:message** 元素的内容。 |
