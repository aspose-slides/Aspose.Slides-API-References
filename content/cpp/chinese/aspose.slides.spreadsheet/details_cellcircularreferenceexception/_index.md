...
description: 当检测到一个或多个循环引用时抛出的异常，其中公式直接或间接引用了它自己的单元格。
type: docs
weight: 1
url: /zh/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException 类

当检测到一个或多个循环引用时抛出的异常，其中公式直接或间接引用了它自己的单元格。
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | 获取一个循环单元格引用。 |
...
* 类 [Details_PptxEditException](../../aspose.slides/details_pptxeditexception/)
