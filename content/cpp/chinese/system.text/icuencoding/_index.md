...
description: "基于 ICU 的编码实现。仅限内部使用。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 操作符创建此类型的实例，因为会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 300
url: /zh/system.text/icuencoding/
---
## ICUEncoding 类
...
| 方法 | 描述 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](../encoding/clone/)() | 克隆编码对象。 |
...
| **bool** [Equals](../encoding/equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | 比较编码。 |
...
| virtual [String](../../system/string/) [get_BodyName](../encoding/get_bodyname/)() | 获取邮件代理主体兼容的编码名称。 |
...
| **bool** [get_IsReadOnly](../encoding/get_isreadonly/)() | 检查编码是否只读。 |
...
| static [EncodingPtr](../../system/encodingptr/) [get_UTF8Unmarked](../encoding/get_utf8unmarked/)() | 仅内部使用，由类库使用：未标记且不进行输入验证。 |
...
| virtual int [GetByteCount](./getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | 运行时类型信息。 |
| virtual int [GetByteCount](./getbytecount/)(System::Details::ArrayView\<char_t\>, int, int) | 运行时类型信息。 |
| int [GetByteCount](./getbytecount/)(const System::Details::StackArray\<char_t, N\>\&, int, int) | 运行时类型信息。 |
| virtual int [GetByteCount](./getbytecount/)(const [String](../../system/string/)\&) | 运行时类型信息。 |
| virtual int [GetByteCount](./getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>) | 运行时类型信息。 |
| virtual int [GetByteCount](./getbytecount/)(const char_t *, int) | 运行时类型信息。 |
| int [GetBytes](./getbytes/)(const char_t *, int, **uint8_t** *, int) override | 获取对字符缓冲区进行编码后产生的字节。 |
| virtual int [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | 获取对字符缓冲区进行编码后产生的字节。 |
| virtual int [GetBytes](./getbytes/)(System::Details::ArrayView\<char_t\>, int, int, System::Details::ArrayView\<**uint8_t**\>, int) | 获取对字符缓冲区进行编码后产生的字节。 |
| int [GetBytes](./getbytes/)(System::Details::StackArray\<char_t, SC\>\&, int, int, System::Details::StackArray\<**uint8_t**, SB\>\&, int) | 获取对字符缓冲区进行编码后产生的字节。 |
| virtual int [GetBytes](./getbytes/)(const [String](../../system/string/)\&, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | 获取对字符缓冲区进行编码后产生的字节。 |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetBytes](./getbytes/)(const [String](../../system/string/)\&) | 获取对字符缓冲区进行编码后产生的字节。 |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | 获取对字符缓冲区进行编码后产生的字节。 |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetBytes](./getbytes/)(const System::Details::ArrayView\<char_t\>\&, int, int) | 获取对字符缓冲区进行编码后产生的字节。 |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetBytes](./getbytes/)(const System::Details::StackArray\<char_t, N\>\&, int, int) | 获取对字符缓冲区进行编码后产生的字节。 |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>) | 获取对字符缓冲区进行编码后产生的字节。 |
| virtual int [GetBytes](./getbytes/)(const char_t *, int, **uint8_t** *, int) | 获取对字符缓冲区进行编码后产生的字节。 |
| int [GetCharCount](./getcharcount/)(const **uint8_t** *, int) override | 获取对字节缓冲区进行解码所需的字符数。 |
| virtual int [GetCharCount](./getcharcount/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | 获取对字节缓冲区进行解码所需的字符数。 |
| virtual int [GetCharCount](./getcharcount/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 获取对字节缓冲区进行解码所需的字符数。 |
| virtual int [GetCharCount](./getcharcount/)(const **uint8_t** *, int) | 获取对字节缓冲区进行解码所需的字符数。 |
| int [GetChars](./getchars/)(const **uint8_t** *, int, char_t *, int) override | 获取对字节缓冲区进行解码后产生的字符。 |
| virtual int [GetChars](./getchars/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<char_t\>, int) | 获取对字节缓冲区进行解码后产生的字符。 |
| virtual [ArrayPtr](../../system/arrayptr/)\<char_t\> [GetChars](./getchars/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | 获取对字节缓冲区进行解码后产生的字符。 |
| virtual [ArrayPtr](../../system/arrayptr/)\<char_t\> [GetChars](./getchars/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 获取对字节缓冲区进行解码后产生的字符。 |
| virtual int [GetChars](./getchars/)(const **uint8_t** *, int, char_t *, int) | 获取对字节缓冲区进行解码后产生的字符。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [DecoderPtr](../../system/decoderptr/) [GetDecoder](./getdecoder/)() override | 获取一个将请求转发给此对象的解码器。 |
| [EncoderPtr](../../system/encoderptr/) [GetEncoder](./getencoder/)() override | 获取一个将请求转发给此对象的编码器。 |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(const [String](../../system/string/)\&) | 按名称获取编码。 |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(int) | 按代码页获取编码。 |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(int, const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&, const [DecoderFallbackPtr](../../system/decoderfallbackptr/)\&) | 按代码页获取编码。 |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(const [String](../../system/string/)\&, const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&, const [DecoderFallbackPtr](../../system/decoderfallbackptr/)\&) | 按名称获取编码。 |
| static [ArrayPtr](../../system/arrayptr/)\<[EncodingInfoPtr](../../system/encodinginfoptr/)\> [GetEncodings](../encoding/getencodings/)() | 获取已知编码的列表。 |
| int [GetHashCode](../encoding/gethashcode/)() const override | 对编码进行哈希。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，只是初始化新对象并允许构造子类的拷贝。 |
...
| **bool** [operator==](./operator_equal_equal/)(const [ICUEncoding](./)\&) const | 使用代码页比较编码。 |
