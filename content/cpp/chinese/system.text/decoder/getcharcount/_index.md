...
type: docs
weight: 40
url: /zh/system.text/decoder/getcharcount/
---
## Decoder::GetCharCount(ArrayPtr\<uint8_t\>, int, int) 方法
...
## Decoder::GetCharCount(ArrayPtr\<uint8_t\>, int, int, bool) 方法
...
## Decoder::GetCharCount(const uint8_t *, int, bool) 方法
