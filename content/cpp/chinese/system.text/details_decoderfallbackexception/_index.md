...
description: "在解码失败时，由 DecoderExceptionFallback 抛出的异常。不要手动创建此类的实例。请改用 DecoderFallbackException 类。不要将 DecoderFallbackException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 105
url: /zh/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException 类
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | 获取触发错误的字节数组。 |
...
| int [get_Index](./get_index/)() | 获取在输入数组中触发错误的字节位置。 |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | 返回当前对象的字符串表示形式。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用的 [what()](../../system/details_exception/what/) 方法。尽管此类未从 std::exception 继承，派生类仍可使用受保护/私有成员来实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
