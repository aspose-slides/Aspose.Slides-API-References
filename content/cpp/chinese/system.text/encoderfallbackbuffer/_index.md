...
description: "提供用于回退实现的缓冲区。此类的对象应仅使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 183
url: /zh/system.text/encoderfallbackbuffer/
---
## EncoderFallbackBuffer 类


提供用于回退实现的缓冲区。此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| virtual **bool** [Fallback](./fallback/)(char_t, int) | 实现实际的回退过程。 |
| virtual **bool** [Fallback](./fallback/)(char_t, char_t, int) | 实现实际的回退过程。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual int [get_Remaining](./get_remaining/)() const | 获取剩余待处理字符的计数。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。启用自定义对象的哈希。 |
| virtual char_t [GetNextChar](./getnextchar/)() | 提取回退缓冲区中的下一个字符。 |
...
| virtual **bool** [MovePrevious](./moveprevious/)() | 如果可能，将缓冲区位置向后移动一步。 |
...
| virtual void [Reset](./reset/)() | 将缓冲区重置为初始状态。 |
