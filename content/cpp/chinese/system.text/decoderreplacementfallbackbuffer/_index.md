...
description: 用于替换解码回退策略的缓冲区。
type: docs
weight: 92
url: /zh/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer 类

[Buffer](../../system/buffer/) 用于替换解码回退策略。
...
| Method | Description |
| --- | --- |
|  [DecoderReplacementFallbackBuffer](./decoderreplacementfallbackbuffer/)(const [DecoderReplacementFallbackPtr](../../system/decoderreplacementfallbackptr/)\&) | 构造函数。 |
...
* 类 [DecoderFallbackBuffer](../decoderfallbackbuffer/)
* 命名空间 [System::Text](../)
* 库 [Aspose.Slides](../../)