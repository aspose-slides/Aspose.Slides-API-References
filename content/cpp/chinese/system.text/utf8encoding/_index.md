...
description: "UTF-8 编码。此类的对象应仅使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 378
url: /zh/system.text/utf8encoding/
---
## UTF8Encoding 类

UTF-8 编码。此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），这里两个 NaN 仍被视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），这里两个 NaN 仍被视为相等。 |
...
| virtual **bool** [get_IsBrowserDisplay](../encoding/get_isbrowserdisplay/)() | 检查该编码是否可在浏览器中用于显示内容。 |
| virtual **bool** [get_IsBrowserSave](../encoding/get_isbrowsersave/)() | 检查该编码是否可在浏览器中用于保存内容。 |
| virtual **bool** [get_IsMailNewsDisplay](../encoding/get_ismailnewsdisplay/)() | 检查该编码是否可在邮件客户端中用于显示内容。 |
| virtual **bool** [get_IsMailNewsSave](../encoding/get_ismailnewssave/)() | 检查该编码是否可在邮件客户端中用于保存内容。 |
| **bool** [get_IsReadOnly](../encoding/get_isreadonly/)() | 检查该编码是否为只读。 |
| virtual **bool** [get_IsSingleByte](../encoding/get_issinglebyte/)() | 检查该编码是否为单字节。 |
...
| [DecoderPtr](../../system/decoderptr/) [GetDecoder](../icuencoding/getdecoder/)() override | 获取将请求转发到此对象的解码器。 |
| [EncoderPtr](../../system/encoderptr/) [GetEncoder](../icuencoding/getencoder/)() override | 获取将请求转发到此对象的编码器。 |
...
| **bool** [operator==](./operator_equal_equal/)(const [UTF8Encoding](./)\&) const | 比较编码参数。 |
