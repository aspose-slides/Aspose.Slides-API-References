...
| 方法 | 描述 |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | 将额外的配色方案应用到幻灯片。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | 返回主题对象。 |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | 确定 [OverrideTheme](../overridetheme/) 是否覆盖继承的有效主题 (Presentation.MasterTheme) 或不覆盖。读取 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() | 返回覆盖的主题对象。读取 [IMasterTheme](../imastertheme/)。 |
...
| virtual void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) | 确定 [OverrideTheme](../overridetheme/) 是否覆盖继承的有效主题 (Presentation.MasterTheme)。写入 **bool**。 |
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) | 返回覆盖的主题对象。写入 [IMasterTheme](../imastertheme/)。 |
