...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | 确定 [OverrideTheme](../overridetheme/) 是否覆盖继承的有效主题 ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/))。读取 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | 返回覆盖的主题对象。读取 [IMasterTheme](../imastertheme/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否代表 targetType 所描述的类型实例。相当于 C# 的 'is' 操作符。 |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | 确定 [OverrideTheme](../overridetheme/) 是否覆盖继承的有效主题 ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/))。写入 **bool**。 |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | 返回覆盖的主题对象。写入 [IMasterTheme](../imastertheme/)。 |
...
* 类 [IMasterThemeManager](../imasterthememanager/)
