...
description: 提供对不同类型的已覆盖主题的访问。
type: docs
weight: 417
url: /zh/aspose.slides.theme/ioverridethememanager/
---
## IOverrideThemeManager 类
...
| 方法 | 描述 |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | 对幻灯片应用额外的配色方案。 |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | 确定 [OverrideTheme](../overridetheme/) 是否覆盖继承的有效主题。要启用 [OverrideTheme](../overridetheme/) 进行覆盖，请使用 OverrideTheme.Init*() 方法。要禁用 [OverrideTheme](../overridetheme/) 的覆盖，请使用 [get_OverrideTheme()](./get_overridetheme/)->Clear() 方法。只读 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | 返回覆盖主题对象。读取 [IOverrideTheme](../ioverridetheme/)。 |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | 返回覆盖主题对象。写入 [IOverrideTheme](../ioverridetheme/)。 |
