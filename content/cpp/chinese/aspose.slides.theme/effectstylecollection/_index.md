...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\>\>, **int32_t**) override | 将集合中的所有元素复制到指定的数组中。 |
...
| **int32_t** [get_Count](./get_count/)() override | 返回集合中的元素数量。只读 **int32_t**，只读 **int32_t**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回遍历集合的枚举器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\> [idx_get](./idx_get/)(**int32_t**) override | 返回指定位置的元素。只读 [EffectStyle](../effectstyle/)。 |
...
| 类型别名 | 描述 |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 一种集合类型，其迭代器类型被用作当前集合的迭代器类型。 |
...
* 类 [IEffectStyleCollection](../ieffectstylecollection/)
