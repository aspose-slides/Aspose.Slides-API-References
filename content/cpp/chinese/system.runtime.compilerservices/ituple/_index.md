...
description: 定义一个通用的 Tuple 实现，允许在未知底层 Tuple 类型的情况下访问 Tuple 实例成员。
type: docs
weight: 53
url: /zh/system.runtime.compilerservices/ituple/
---
## ITuple 类

定义一个通用的 [Tuple](../../system/tuple/) 实现，允许在未知底层 [Tuple](../../system/tuple/) 类型的情况下访问 [Tuple](../../system/tuple/) 实例成员。
...
| virtual **int32_t** [get_Length](./get_length/)() const | 返回此数据结构中的位置数。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。启用自定义对象的哈希。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 获取对象的实际类型。相当于 C# [System.Object.GetType()](../../system/object/gettype/) 调用。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | 返回索引位置的元素。 |
