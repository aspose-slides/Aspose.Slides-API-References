...
description: "单个捕获组完成的捕获列表。此类的对象只能使用 System::MakeObject() 函数分配。不要在栈上或使用 operator new 创建此类型的实例，因为会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 14
url: /zh/system.text.regularexpressions/capturecollection/
---
## CaptureCollection 类

单个捕获组完成的捕获列表。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。不要在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
...
| void [Add](./add/)(const [CapturePtr](../captureptr/)\&) override | 禁用集合的修改。 |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | 向列表的末尾添加元素。 |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | 向集合中添加捕获的服务方法。 |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Collections::ObjectModel::ReadOnlyCollection](../../system.collections.objectmodel/readonlycollection/)\<T\>\> [AsReadOnly](../../system.collections.generic/list/asreadonly/)() | 获取此集合的只读引用。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | 获取集合末尾之后的不存在的 const 限定元素的迭代器。 |
| void [Clear](./clear/)() override | 禁用清理集合。 |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | 获取集合中最后一个 const 限定元素的反向迭代器（逆序中的第一个）。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crend](../../system.collections.generic/list/crend/)() const | 获取集合开始之前的不存在的 const 限定元素的反向迭代器。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | 获取集合末尾之后的不存在的元素的迭代器。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | 获取 const 限定集合末尾之后的不存在的元素的迭代器。 |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | 检查列表中是否存在满足特定谓词的元素。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| T [Find](../../system.collections.generic/list/find/)([System::Predicate](../../system/predicate/)\<T\>) | 查找满足特定谓词的元素。 |
| [ListPtr](../../system.collections.generic/listptr/)\<T\> [FindAll](../../system.collections.generic/list/findall/)([System::Predicate](../../system/predicate/)\<T\>) | 查找满足特定谓词的元素。 |
| int [FindIndex](../../system.collections.generic/list/findindex/)([System::Predicate](../../system/predicate/)\<T\>) | 查找满足特定谓词的元素。 |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, [System::Predicate](../../system/predicate/)\<T\>) | 查找满足特定谓词的元素。 |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, int, [System::Predicate](../../system/predicate/)\<T\>) | 查找满足特定谓词的元素。 |
| T [FindLast](../../system.collections.generic/list/findlast/)([System::Predicate](../../system/predicate/)\<T\>) | 查找满足特定谓词的最后一个元素。 |
| void [ForEach](../../system.collections.generic/list/foreach/)([System::Action](../../system/action/)\<T\>) | 对列表中的所有元素执行操作。 |
| int [get_Capacity](../../system.collections.generic/list/get_capacity/)() const | 获取当前列表的容量。 |
| int [get_Count](./get_count/)() const override | 获取捕获的数量。 |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | 检查集合是否固定大小。 |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | 将集合标记为只读。 |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | 将集合标记为未同步。 |
...
| T [idx_get](../../system.collections.generic/list/idx_get/)(int) const override | 获取指定位置的元素。 |
| void [idx_set](../../system.collections.generic/list/idx_set/)(int, T) override | 设置指定位置的元素。 |
...
| void [InsertRange](../../system.collections.generic/list/insertrange/)(int, [IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | 在指定位置插入数据范围。 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否表示由 targetType 描述的类型实例。相当于 C# 'is' 运算符。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | 在整个列表中搜索指定对象并返回其最后一次出现的零基索引。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | 在 [List](../../system.collections.generic/list/) 中从第一个元素到指定索引的范围内搜索指定对象，并返回其最后一次出现的零基索引。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | 在 [List](../../system.collections.generic/list/) 中包含指定数量元素并以指定索引结束的范围内搜索指定对象，并返回其最后一次出现的零基索引。 |
...
| vector_t::reference [operator[]](../../system.collections.generic/list/operator[]/)(int) | 访问器函数。 |
| vector_t::const_reference [operator[]](../../system.collections.generic/list/operator[]/)(int) const | 访问器函数。 |
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() | 获取集合中最后一个元素的反向迭代器（逆序中的第一个）。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | 获取 const 限定集合中最后一个元素的反向迭代器（逆序中的第一个）。 |
...
| **bool** [Remove](./remove/)(const [CapturePtr](../captureptr/)\&) override | 禁用集合的修改。 |
| **bool** [Remove](../../system.collections.generic/list/remove/)(const T\&) override | 从列表中移除首次出现的特定项目。 |
| int [RemoveAll](../../system.collections.generic/list/removeall/)([Predicate](../../system/predicate/)\<T\>) | 移除所有匹配特定谓词的元素。 |
| void [RemoveAt](../../system.collections.generic/list/removeat/)(int) override | 移除指定位置的项目。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定值。 |
| void [RemoveRange](../../system.collections.generic/list/removerange/)(int, int) | 移除列表的切片。 |
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() | 获取集合开始之前的不存在的元素的反向迭代器。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | 获取 const 限定集合开始之前的不存在的元素的反向迭代器。 |
...
| **bool** [TrueForAll](../../system.collections.generic/list/trueforall/)([System::Predicate](../../system/predicate/)\<T\>) | 确定集合中的每个元素是否满足指定谓词定义的条件。 |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | 实现 C# typeof([System.Object](../../system/object/)) 构造。 |
| void [Unlock](../../system/object/unlock/)() | 实现 C# lock() 语句的解锁。直接调用或使用 [LockContext](../../system/lockcontext/) 哨兵对象。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../../system.collections.generic/list/virtualizebeginconstiterator/)() const override | 获取当前容器的 const begin 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../../system.collections.generic/list/virtualizebeginiterator/)() override | 获取当前容器的 begin 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.generic/list/virtualizeendconstiterator/)() const override | 获取当前容器的 const end 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../../system.collections.generic/list/virtualizeenditerator/)() override | 获取当前容器的 end 迭代器实现。 |
