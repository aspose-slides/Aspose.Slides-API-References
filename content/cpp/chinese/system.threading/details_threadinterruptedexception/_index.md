...
type: docs
weight: 92
url: /zh/system.threading/details_threadinterruptedexception/
---
## Details_ThreadInterruptedException 类
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | 返回代表内部异常的对象的引用。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类未从 std::exception 继承，但派生类可以使用受保护/私有成员来实现其逻辑。将此方法实现移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
