...
description: 一个可用于触发取消通知的取消令牌源。
type: docs
weight: 40
url: /zh/system.threading/cancellationtokensource/
---
...
| 方法 | 描述 |
| --- | --- |
| void [Cancel](./cancel/)() | 传达取消请求。 |
|  [CancellationTokenSource](./cancellationtokensource/)() | 构造一个新的[CancellationTokenSource](./)。 |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | 创建一个链接的令牌源，当任何提供的令牌被取消时即取消。 |
| void [Dispose](./dispose/)() override | 释放 [CancellationTokenSource](./) 使用的所有资源。 |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | 获取是否已请求取消。 |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | 获取与此源关联的取消令牌。 |
