...
description: 线程池 API，允许将作业推送到队列，由工作线程池读取。这是一个没有实例服务的静态类型。绝不应以任何方式创建其实例。
type: docs
weight: 222
url: /zh/system.threading/threadpool/
---
## ThreadPool 类

[Thread](../thread/) pool API 允许将作业推送到队列，由工作线程池读取。这是一个没有实例服务的静态类型。绝对不要以任何方式创建其实例。
...
| static void [GetAvailableThreads](./getavailablethreads/)(int\&, int\&) | 获取可用线程数。 |
...
| static [ThreadPoolImpl](../threadpoolimpl/)\& [GetInstance](./getinstance/)() | 实现实例，保存作业列表和其他参数。 |
| static void [GetMaxThreads](./getmaxthreads/)(int\&, int\&) | 获取最大并发线程数。 |
| static void [GetMinThreads](./getminthreads/)(int\&, int\&) | 获取池创建的最小线程数。 |
...
| static void [JoinAllThreads](./joinallthreads/)() | 加入所有拥有的线程。无限等待。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何东西，只是初始化新对象并支持子类的拷贝构造。 |
| void [operator=](./operator_equal/)(const [ThreadPool](./)\&) | 不进行复制。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不复制任何东西，只是初始化新对象并支持子类的拷贝构造。 |
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/)) | 将工作项放入队列，使用不带参数的回调。 |
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/), const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 将工作项放入队列，使用不带参数的回调。 |
...
| static **bool** [SetMaxThreads](./setmaxthreads/)(int, int) | 设置池拥有的线程数量。 |
| static **bool** [SetMinThreads](./setminthreads/)(int, int) | 设置池拥有的最小线程数。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而非共享指针）。允许在容器中将指针切换为弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 获取共享引用计数器的当前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 递增共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 递减并返回共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
|  [ThreadPool](./threadpool/)(const [ThreadPool](./)\&) | 不进行复制。 |
...
/*
此代码示例产生以下输出：
后台: True, 线程池: True, 线程 ID: 1
后台: True, 线程池: True, 线程 ID: 3
后台: True, 线程池: True, 线程 ID: 5
后台: True, 线程池: True, 线程 ID: 6
后台: True, 线程池: True, 线程 ID: 9
后台: True, 线程池: True, 线程 ID: 1
后台: True, 线程池: True, 线程 ID: 7
后台: True, 线程池: True, 线程 ID: 2
后台: True, 线程池: True, 线程 ID: 4
后台: True, 线程池: True, 线程 ID: 3
后台: True, 线程池: True, 线程 ID: 12
后台: True, 线程池: True, 线程 ID: 8
后台: True, 线程池: True, 线程 ID: 5
后台: True, 线程池: True, 线程 ID: 6
后台: True, 线程池: True, 线程 ID: 16
后台: True, 线程池: True, 线程 ID: 11
*/
```
