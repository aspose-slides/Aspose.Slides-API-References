...
description: "允许时间测量。此类的对象应仅使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 操作符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 79
url: /zh/system.diagnostics/stopwatch/
---
## Stopwatch 类
...
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | 获取当前实例测量的总耗时。 |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | 获取当前实例测量的总耗时（以毫秒为单位）。 |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | 获取当前实例测量的总耗时（以计时器滴答为单位）。 |
| **bool** [get_IsRunning](./get_isrunning/)() const | 检查秒表是否正在运行。 |
...
| void [Reset](./reset/)() | 停止时间测量，并将测量区间设为零。 |
| void [Restart](./restart/)() | 将测量区间设为零，然后开始时间测量。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设为弱指针（而非共享指针）。允许在容器中切换指针至弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 获取共享引用计数器的当前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 递增共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 递减并返回共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| void [Start](./start/)() | 开始时间测量。 |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | 创建新的 [Stopwatch](./) 对象并开始测量。 |
| void [Stop](./stop/)() | 停止时间测量。 |
