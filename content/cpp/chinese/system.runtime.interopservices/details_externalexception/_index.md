...
description: "所有 COM 互操作异常和结构化异常处理 (SEH) 异常的基础异常类型。切勿手动创建此类实例。请改用 ExternalException 类。切勿将 ExternalException 类实例包装到 System::SmartPtr 中。"
type: docs
weight: 1
url: /zh/system.runtime.interopservices/details_externalexception/
---
## Details_ExternalException 类

所有 COM 互操作异常和结构化异常处理 (SEH) 异常的基础异常类型。切勿手动创建此类的实例。请改用 ExternalException 类。切勿将 ExternalException 类实例包装到 [System::SmartPtr](../../system/smartptr/) 中。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 两个 NaN 不相等，两个 NaN 也被视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 两个 NaN 不相等，两个 NaN 也被视为相等。 |
...
| virtual **int32_t** [get_ErrorCode](../../system/details_exceptionwitherrorcode/get_errorcode/)() const | 获取错误的 HRESULT。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管该类未从 std::exception 继承，但派生类可以使用受保护/私有成员来实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
| virtual  [~Object](../../system/object/~object/)() | 销毁对象。释放所有内部数据结构。 |

## 另请参阅

* 类 [Details_ExceptionWithErrorCode](../../system/details_exceptionwitherrorcode/)
