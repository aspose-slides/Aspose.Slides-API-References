...
description: "提供获取图像帧尺寸的属性。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 92
url: /zh/system.drawing.imaging/framedimension/
---
## FrameDimension 类

提供获取图像帧尺寸的属性。此类的对象只能通过 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([FrameDimensionPtr](../framedimensionptr/)) | 确定指定的 [FrameDimension](./) 对象是否等价于当前对象。 |
...
|  [FrameDimension](./framedimension/)(const [System::Guid](../../system/guid/)\&) | 构造一个新的 [FrameDimension](./) 对象并使用指定的 GUID 进行初始化。 |
| [System::Guid](../../system/guid/) [get_Guid](./get_guid/)() const | 返回与当前对象关联的 GUID。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Page](./get_page/)() | 返回页面维度。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Resolution](./get_resolution/)() | 返回分辨率维度。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Time](./get_time/)() | 返回时间维度。 |
