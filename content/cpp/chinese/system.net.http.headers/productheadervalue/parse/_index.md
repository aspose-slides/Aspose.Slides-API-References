...
description: 将传入的字符串转换为 ProductHeaderValue 类的实例。
type: docs
weight: 79
url: /zh/system.net.http.headers/productheadervalue/parse/
---
## ProductHeaderValue::Parse(String) 方法

将传入的字符串转换为 [ProductHeaderValue](../) 类的实例。
