...
description: "表示 'Entity-Tag' 头的值。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，否则会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针作为参数传递给函数。"
type: docs
weight: 53
url: /zh/system.net.http.headers/entitytagheadervalue/
---
## EntityTagHeaderValue 类

表示 ‘Entity-Tag’ 头的值。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，否则会导致运行时错误和/或断言故障。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针作为参数传递给函数。
...
| Method | Description |
| --- | --- |
|  [EntityTagHeaderValue](./entitytagheadervalue/)([String](../../system/string/)) | 构造一个新实例。 |
|  [EntityTagHeaderValue](./entitytagheadervalue/)([String](../../system/string/), **bool**) | 构造一个新实例。 |
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅用于内部实现。 |
| static [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\> [get_Any](./get_any/)() | 获取 'ETag' 头的值。 |
| **bool** [get_IsWeak](./get_isweak/)() | 获取一个值，指示当前实例是否为弱验证器。 |
| [String](../../system/string/) [get_Tag](./get_tag/)() | 获取 EntityTagHeaderValue 类实例的字符串表示。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| static **int32_t** [GetEntityTagLength](./getentitytaglength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\>\&) | 将传入的字符串从指定索引转换为 [EntityTagHeaderValue](./) 类的实例。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否是目标类型 (targetType) 描述的实例。相当于 C# 的 'is' 运算符。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | 将传入的字符串转换为 [EntityTagHeaderValue](./) 类的实例。 |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\>\&) | 尝试将传入的字符串转换为 [EntityTagHeaderValue](./) 类的实例。 |
