...
description: 将传入的字符串转换为 ContentRangeHeaderValue 类的实例。
type: docs
weight: 144
url: /zh/system.net.http.headers/contentrangeheadervalue/parse/
---
## ContentRangeHeaderValue::Parse(String) 方法

将传入的字符串转换为 [ContentRangeHeaderValue](../) 类的实例。
