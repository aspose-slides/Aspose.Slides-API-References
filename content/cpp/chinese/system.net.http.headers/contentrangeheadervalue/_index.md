...
description: "表示 'Content-Range' 标头的值。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，否则会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 40
url: /zh/system.net.http.headers/contentrangeheadervalue/
---
## ContentRangeHeaderValue 类

表示 “Content-Range” 标头的值。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，否则会导致运行时错误和/或断言故障。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
...
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_From](./get_from/)() | 获取必须开始发送数据的位置。 |
| **bool** [get_HasLength](./get_haslength/)() const | 获取指示当前标头是否指定长度的值。 |
| **bool** [get_HasRange](./get_hasrange/)() const | 获取指示当前标头是否指定范围的值。 |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_Length](./get_length/)() | 获取实体正文的长度。 |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_To](./get_to/)() | 获取必须停止发送数据的位置。 |
| [String](../../system/string/) [get_Unit](./get_unit/)() | 获取范围中使用的单位。 |
| static **int32_t** [GetContentRangeLength](./getcontentrangelength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | 将传入的字符串从指定位置转换为 [ContentRangeHeaderValue](./) 类的实例。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ContentRangeHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | 将传入的字符串转换为 [ContentRangeHeaderValue](./) 类的实例。 |
...
| void [set_Unit](./set_unit/)([String](../../system/string/)) | 设置范围中使用的单位。 |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ContentRangeHeaderValue](./)\>\&) | 尝试将传入的字符串转换为 [ContentRangeHeaderValue](./) 类的实例。 |
