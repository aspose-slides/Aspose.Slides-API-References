...
description: 从已类型化的 span 起始位置修剪指定元素。
type: docs
weight: 391
url: /zh/system.memoryextensions/trimstart/
---
## System::MemoryExtensions::TrimStart(const ReadOnlySpan\<T\>\&, const T\&) 函数

从已类型化的 span 起始位置修剪指定元素。
...
一个新的 span，其中已从起始位置修剪指定元素。

## System::MemoryExtensions::TrimStart(Span\<T\>\&, const T\&) 函数

从可变的已类型化 span 起始位置修剪指定元素。
...
## System::MemoryExtensions::TrimStart(const ReadOnlySpan\<T\>\&, const ReadOnlySpan\<T\>\&) 函数
...
## System::MemoryExtensions::TrimStart(Span\<T\>\&, const ReadOnlySpan\<T\>\&) 函数
...
## System::MemoryExtensions::TrimStart(const ReadOnlySpan\<char16_t\>\&) 函数
...
一个新的 span，其中已从起始位置修剪空白字符。

## System::MemoryExtensions::TrimStart(Span\<char16_t\>\&) 函数

从可变的字符 span 起始位置修剪空白字符。
...
## System::MemoryExtensions::TrimStart(const ReadOnlySpan\<char16_t\>\&, char16_t) 函数
...
一个新的 span，其中已从起始位置修剪指定字符。

## System::MemoryExtensions::TrimStart(Span\<char16_t\>\&, char16_t) 函数

从可变的字符 span 起始位置修剪指定字符。
...
## System::MemoryExtensions::TrimStart(const ReadOnlySpan\<char16_t\>\&, const ReadOnlySpan\<char16_t\>\&) 函数
...
## System::MemoryExtensions::TrimStart(Span\<char16_t\>\&, const ReadOnlySpan\<char16_t\>\&) 函数
