...
description: 表示来自 XML Schema 的 choice 元素（组合器），其规范由万维网联盟（W3C）指定。choice 仅允许其子元素中的一个出现在实例中。
type: docs
weight: 209
url: /zh/system.xml.schema/xmlschemachoice/
---
## XmlSchemaChoice 类


表示来自 XML [Schema](../) 的 **choice** 元素（组合器），其规范由万维网 [Web](../../system.web/) 联盟（W3C）指定。**choice** 仅允许其子元素中的一个出现在实例中。
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | 返回包含在组合器 (**choice**) 中的元素集合：[XmlSchemaElement](../xmlschemaelement/)、[XmlSchemaGroupRef](../xmlschemagroupref/)、[XmlSchemaChoice](./)、[XmlSchemaSequence](../xmlschemasequence/) 或 [XmlSchemaAny](../xmlschemaany/)。 |
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | 返回粒子可能出现的最大次数。 |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | 以字符串形式返回数值。粒子可能出现的最大次数。 |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | 返回粒子可能出现的最小次数。 |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | 以字符串形式返回数值。粒子可能出现的最小次数。 |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | 设置粒子可能出现的最大次数。 |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | 以字符串形式设置数值。粒子可能出现的最大次数。 |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | 设置粒子可能出现的最小次数。 |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | 以字符串形式设置数值。粒子可能出现的最小次数。 |
...
此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言失败。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。 

## 另请参阅

* 类 [XmlSchemaGroupBase](../xmlschemagroupbase/)
