...
description: 表示符合万维网联盟（W3C）规定的 XML Schema 中具有 ref 属性的 group 元素。此类在引用在 schema 级别定义的 group 的复合类型中使用。
type: docs
weight: 456
url: /zh/system.xml.schema/xmlschemagroupref/
---
## XmlSchemaGroupRef 类


表示 XML [Schema](../) 中的 **group** 元素及其 **ref** 属性，遵循万维网 [Web](../../system.web/) 联盟（W3C）的规范。此类在引用在 **schema** 级别定义的 **group** 的复合类型中使用。
...
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | 以字符串形式返回该数值。粒子可以出现的最大次数。 |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | 返回粒子可以出现的最小次数。 |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | 以字符串形式返回该数值。粒子可以出现的最小次数。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | 返回 [XmlSchemaChoice](../xmlschemachoice/)、[XmlSchemaAll](../xmlschemaall/) 或 [XmlSchemaSequence](../xmlschemasequence/) 类之一，该类保存 **Particle** 值的编译后解释。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | 返回在此 schema（或由指定命名空间指示的其他 schema）中定义的组名。 |
...
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | 以字符串形式设置该数值。粒子可以出现的最大次数。 |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | 设置粒子可以出现的最小次数。 |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | 以字符串形式设置该数值。粒子可以出现的最小次数。 |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 设置在此 schema（或由指定命名空间指示的其他 schema）中定义的组名。 |
...
此类的对象应仅通过 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，否则会导致运行时错误和/或断言失败。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。 
