...
description: 表示符合万维网联盟（W3C）规范的 XML Schema 中的枚举 facet。此类为 simpleType 元素指定了一组有效值。声明位于 restriction 声明内部。
type: docs
weight: 378
url: /zh/system.xml.schema/xmlschemaenumerationfacet/
---
## XmlSchemaEnumerationFacet 类

表示来自 XML [Schema](../) 的 **enumeration** facet，符合万维网 [Web](../../system.web/) 联盟（W3C）的规范。此类指定了 simpleType 元素的有效值列表。声明包含在 **restriction** 声明中。
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | 返回指示此 facet 为固定的信息。 |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | 返回不属于当前 schema 的目标命名空间的限定属性。 |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | 设置指示此 facet 为固定的信息。 |
...
|  [XmlSchemaEnumerationFacet](./xmlschemaenumerationfacet/)() | 初始化 [XmlSchemaEnumerationFacet](./) 类的新实例。 |
