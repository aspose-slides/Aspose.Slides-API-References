...
description: 包含 XML 架构定义语言 (XSD) 和 XML-Data Reduced (XDR) 模式的缓存。
type: docs
weight: 222
url: /zh/system.xml.schema/xmlschemacollection/
---
...
| 方法 | 描述 |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | 将给定 URL 所在的模式添加到模式集合中。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | 将包含在 [XmlReader](../../system.xml/xmlreader/) 中的模式添加到模式集合中。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | 将包含在 [XmlReader](../../system.xml/xmlreader/) 中的模式添加到模式集合中。指定的 [XmlResolver](../../system.xml/xmlresolver/) 用于解析任何外部资源。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | 将 [XmlSchema](../xmlschema/) 添加到集合中。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | 将 [XmlSchema](../xmlschema/) 添加到集合中。指定的 [XmlResolver](../../system.xml/xmlresolver/) 用于解析任何外部引用。 |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | 将给定集合中定义的所有命名空间（包括其关联的模式）添加到此集合中。 |
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | 返回一个值，指示指定的 [XmlSchema](../xmlschema/) 的 **targetNamespace** 是否在集合中。 |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | 返回一个值，指示具有指定命名空间的模式是否在集合中。 |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | 将此集合中的所有 [XmlSchema](../xmlschema/) 对象复制到给定数组中，从给定索引开始。 |
...
| **int32_t** [get_Count](./get_count/)() | 返回此集合中定义的命名空间数量。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | 返回在加载新模式时 [XmlSchemaCollection](./) 使用的默认 [XmlNameTable](../../system.xml/xmlnametable/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | 提供对模式集合进行迭代的支持。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | 返回与给定命名空间 URI 关联的 [XmlSchema](../xmlschema/)。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | 通过结合元素索引，将序列的每个元素转换为新形式。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 相当于 C# 的 [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。启用克隆自定义类型。 |
...
|  [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | 使用指定的 [XmlNameTable](../../system.xml/xmlnametable/) 初始化 [XmlSchemaCollection](./) 类的新实例。[XmlNameTable](../../system.xml/xmlnametable/) 在加载模式时使用。 |
...
已弃用
:   [XmlSchemaCollection](./) 类已过时。请改用 [XmlSchemaSet](../xmlschemaset/)。

此类的对象应仅通过 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
