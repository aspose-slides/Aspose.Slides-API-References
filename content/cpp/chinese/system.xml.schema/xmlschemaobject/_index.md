...
description: 表示 Xml 架构对象模型层次结构的根类，并作为如 XmlSchema 类等类的基类。
type: docs
weight: 677
url: /zh/system.xml.schema/xmlschemaobject/
---
## XmlSchemaObject 类

表示 [Xml](../../system.xml/) 模式对象模型层次结构的根类，并作为如 [XmlSchema](../xmlschema/) 类等类的基类。
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | 返回 **schema** 元素引用的文件中的行号。 |
| **int32_t** [get_LinePosition](./get_lineposition/)() | 返回 **schema** 元素引用的文件中的列位置。 |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](./get_namespaces/)() | 返回用于此 schema 对象的 XmlSerializerNamespaces。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\> [get_Parent](./get_parent/)() | 返回此 [XmlSchemaObject](./) 的父对象。 |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 返回加载 schema 的文件的源位置。 |
...
| void [set_LineNumber](./set_linenumber/)(**int32_t**) | 设置 **schema** 元素引用的文件中的行号。 |
| void [set_LinePosition](./set_lineposition/)(**int32_t**) | 设置 **schema** 元素引用的文件中的列位置。 |
| void [set_Namespaces](./set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | 设置用于此 schema 对象的 XmlSerializerNamespaces。 |
| void [set_Parent](./set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\>\&) | 设置此 [XmlSchemaObject](./) 的父对象。 |
| void [set_SourceUri](./set_sourceuri/)(const [String](../../system/string/)\&) | 设置加载 schema 的文件的源位置。 |
...
此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。永不在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
