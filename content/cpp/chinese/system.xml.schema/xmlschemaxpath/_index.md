...
description: 表示万维网联盟（W3C）selector 元素。
type: docs
weight: 963
url: /zh/system.xml.schema/xmlschemaxpath/
---
## XmlSchemaXPath 类

Represents the World Wide [Web](../../system.web/) Consortium (W3C) **选择器** element.
...
| [String](../../system/string/) [get_XPath](./get_xpath/)() | 返回 [XPath](../../system.xml.xpath/) 表达式的属性。 |
...
| void [set_XPath](./set_xpath/)(const [String](../../system/string/)\&) | 设置 [XPath](../../system.xml.xpath/) 表达式的属性。 |
