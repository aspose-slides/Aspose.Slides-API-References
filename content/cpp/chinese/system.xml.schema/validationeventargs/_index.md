...
description: 返回与 ValidationEventHandler 相关的详细信息。
type: docs
weight: 53
url: /zh/system.xml.schema/validationeventargs/
---
...
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | 返回与验证事件关联的 XmlSchemaException。 |
| [String](../../system/string/) [get_Message](./get_message/)() | 返回对应于验证事件的文本描述。 |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | 返回验证事件的严重程度。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，仅初始化新对象并允许在子类中进行复制构造。 |
