...
description: 表示由万维网联盟 (W3C) 规定的 XML Schema 中的 minLength 元素。此类可用于对 simpleType 元素的数据值的最小长度进行限制。长度必须大于 minLength 元素的值。
type: docs
weight: 638
url: /zh/system.xml.schema/xmlschemaminlengthfacet/
---
## XmlSchemaMinLengthFacet 类

表示 XML [Schema](../) 中的 **minLength** 元素，由万维网 [Web](../../system.web/) 联盟（W3C）指定。此类可用于对 **simpleType** 元素的数据值的最小长度进行限制。长度必须大于 **minLength** 元素的值。
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | 返回指示此 facet 为固定的 信息。 |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | 设置指示此 facet 为固定的 信息。 |
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 设置 **schema** 元素所引用文件的行号。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 设置 **schema** 元素所引用文件的列位置。 |
...
|  [XmlSchemaMinLengthFacet](./xmlschemaminlengthfacet/)() | 初始化 [XmlSchemaMinLengthFacet](./) 类的新实例。 |
