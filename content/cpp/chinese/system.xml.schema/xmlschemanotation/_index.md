...
description: 表示符合万维网联盟（W3C）规范的 XML Schema 中的 notation 元素。XML Schema notation 声明是对 XML 1.0 NOTATION 声明的重建。notation 的目的是描述 XML 文档中非 XML 数据的格式。
type: docs
weight: 651
url: /zh/system.xml.schema/xmlschemanotation/
---
## XmlSchemaNotation 类

表示来自 XML [Schema](../) 的 **标记** 元素，符合万维网 [Web](../../system.web/) 联盟（W3C）的规范。XML [Schema](../)**标记** 声明是对 **XML** 1.0 NOTATION 声明的重建。标记的目的是描述 XML 文档中非 XML 数据的格式。
...
| [String](../../system/string/) [get_Name](./get_name/)() | 返回标记的名称。 |
...
| [String](../../system/string/) [get_Public](./get_public/)() | 返回 **public** 标识符。 |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | 返回加载 schema 的文件的源位置。 |
| [String](../../system/string/) [get_System](./get_system/)() | 返回 **system** 标识符。 |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 设置标记的名称。 |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | 设置 **public** 标识符。 |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | 设置加载 schema 的文件的源位置。 |
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | 设置 **system** 标识符。 |
...
此类的对象只能通过 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。 
