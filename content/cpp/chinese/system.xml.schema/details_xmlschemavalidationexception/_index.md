...
description: 表示在对 XML 文档进行验证时遇到 XML 模式定义语言 (XSD) 模式验证错误和警告时抛出的异常。
type: docs
weight: 27
url: /zh/system.xml.schema/details_xmlschemavalidationexception/
---
## Details_XmlSchemaValidationException 类

表示在对 XML 文档进行验证时遇到 XML [Schema](../) 定义语言 (XSD) 模式验证错误和警告时抛出的异常。
...
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | 返回此异常的错误描述。 |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | 返回导致此 XmlSchemaValidationException 的 XML 节点。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | 导致 XmlSchemaException 的 **[XmlSchemaObject](../xmlschemaobject/)**。 |
