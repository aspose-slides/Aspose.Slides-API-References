...
description: 表示来自 XML Schema（由万维网联盟（W3C）指定）的 attributeGroup 元素。AttributesGroups 提供了一种机制来对一组属性声明进行分组，以便它们可以作为整体合并到复杂类型定义中。
type: docs
weight: 183
url: /zh/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup 类


表示来自 XML [Schema](../) 的 **attributeGroup** 元素，符合万维网 [Web](../../system.web/) 联盟（W3C）的规范。AttributesGroups 提供了一种机制，将一组属性声明进行分组，以便可以作为整体合并到复杂类型定义中。
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | 返回属性组的 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) 组件。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | 返回属性组的属性集合。包含 [XmlSchemaAttribute](../xmlschemaattribute/) 和 [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) 元素。 |
...
| [String](../../system/string/) [get_Name](./get_name/)() | 返回属性组的名称。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | 返回属性组的限定名称。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | 返回来自 XML [Schema](../) 的重新定义的属性组属性。 |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | 设置属性组的 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) 组件。 |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 设置属性组的名称。 |
...
此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。不要在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针作为参数传递给函数。 
