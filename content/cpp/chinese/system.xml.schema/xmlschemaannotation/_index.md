...
description: 表示万维网联盟（W3C）注释元素。
type: docs
weight: 118
url: /zh/system.xml.schema/xmlschemaannotation/
---
## XmlSchemaAnnotation 类

表示 World Wide [Web](../../system.web/) Consortium (W3C) **annotation** 元素。
...
| [String](../../system/string/) [get_Id](./get_id/)() | 返回字符串标识。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | 返回用于存储 **appinfo** 和 **documentation** 子元素的 **Items** 集合。 |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 返回 **schema** 元素所在文件的行号。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 返回 **schema** 元素所在文件的列位置（行内位置）。 |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | 返回加载该模式的文件的源位置。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 针对 string 与 nullptr 的特化。 |
...
| void [set_Id](./set_id/)(const [String](../../system/string/)\&) | 设置字符串标识。 |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | 设置加载该模式的文件的源位置。 |
...
此类的对象只能通过 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为会导致运行时错误和/或断言故障。请始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
