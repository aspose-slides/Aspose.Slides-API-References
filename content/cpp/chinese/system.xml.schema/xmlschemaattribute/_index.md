...
description: 表示根据万维网联盟（W3C）规范的 XML Schema 中的 attribute 元素。属性为其他文档元素提供额外信息。属性标签嵌套在文档元素的标签之间，以定义模式。XML 文档在元素的起始标签中将属性显示为具名项。
type: docs
weight: 170
url: /zh/system.xml.schema/xmlschemaattribute/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_AttributeSchemaType](./get_attributeschematype/)() | 返回一个 [XmlSchemaSimpleType](../xmlschemasimpletype/) 对象，表示基于属性的 [XmlSchemaAttribute::get_SchemaType](./get_schematype/) 或 [XmlSchemaAttribute::get_SchemaTypeName](./get_schematypename/) 值的属性类型。 |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_AttributeType](./get_attributetype/)() | 返回基于属性的 [XmlSchemaAttribute::get_SchemaType](./get_schematype/) 或 [XmlSchemaAttribute::get_SchemaTypeName](./get_schematypename/) 值的对象，该值包含 **AttributeType** 值的后期编译解释。 |
| [String](../../system/string/) [get_DefaultValue](./get_defaultvalue/)() | 返回属性的默认值。 |
| [String](../../system/string/) [get_FixedValue](./get_fixedvalue/)() | 返回属性的固定值。 |
| [XmlSchemaForm](../xmlschemaform/) [get_Form](./get_form/)() | 返回属性的形式。 |
...
| [String](../../system/string/) [get_Name](./get_name/)() | 返回属性的名称。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | 返回属性的限定名称。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | 返回在此 schema（或指定命名空间指示的另一个 schema）中声明的属性名称。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_SchemaType](./get_schematype/)() | 将属性类型返回为简单类型。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_SchemaTypeName](./get_schematypename/)() | 返回在此 schema（或指定命名空间指示的另一个 schema）中定义的简单类型名称。 |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | 返回加载该 schema 文件的源位置。 |
...
| [XmlSchemaUse](../xmlschemause/) [get_Use](./get_use/)() | 返回关于属性使用方式的信息。 |
...
| void [set_DefaultValue](./set_defaultvalue/)(const [String](../../system/string/)\&) | 设置属性的默认值。 |
| void [set_FixedValue](./set_fixedvalue/)(const [String](../../system/string/)\&) | 设置属性的固定值。 |
| void [set_Form](./set_form/)([XmlSchemaForm](../xmlschemaform/)) | 设置属性的形式。 |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 设置 **schema** 元素所在文件的行内位置。 |
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 设置属性的名称。 |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 设置在此 schema（或指定命名空间指示的另一个 schema）中声明的属性名称。 |
| void [set_SchemaType](./set_schematype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | 将属性类型设置为简单类型。 |
| void [set_SchemaTypeName](./set_schematypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 设置在此 schema（或指定命名空间指示的另一个 schema）中定义的简单类型名称。 |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | 设置加载该 schema 文件的源位置。 |
...
| void [set_Use](./set_use/)([XmlSchemaUse](../xmlschemause/)) | 设置信息，说明属性的使用方式。 |
