...
description: 表示 W3C（万维网联盟）在 XML Schema 中指定的 maxInclusive 元素。此类可用于对 simpleType 元素的最大值进行限制。元素值必须小于或等于 maxInclusive 元素的值。
type: docs
weight: 586
url: /zh/system.xml.schema/xmlschemamaxinclusivefacet/
---
## XmlSchemaMaxInclusiveFacet 类

表示来自 XML [Schema](../) 的 **maxInclusive** 元素，该元素由万维网 [Web](../../system.web/) 联盟（W3C）指定。此类可用于对 **simpleType** 元素的最大值进行限制。元素值必须小于或等于 **maxInclusive** 元素的值。
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | 设置信息以指示此 facet 已固定。 |
