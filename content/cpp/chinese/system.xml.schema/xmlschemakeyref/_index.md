...
description: 此类表示由万维网联盟（W3C）指定的 XMLSchema 中的 keyref 元素。
type: docs
weight: 547
url: /zh/system.xml.schema/xmlschemakeyref/
---
## XmlSchemaKeyref 类


此类表示由全球 [Web](../../system.web/) 联盟（W3C）指定的 XMLSchema 中的 **keyref** 元素。
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](../xmlschemaidentityconstraint/get_fields/)() | 返回适用于 XML 路径语言 ([XPath](../../system.xml.xpath/)) 表达式选择器的字段集合。 |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 返回 **schema** 元素所在文件中的列位置。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](../xmlschemaidentityconstraint/get_qualifiedname/)() | 返回标识约束的限定名称，该名称保存 **QualifiedName** 值的编译后解释。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_Refer](./get_refer/)() | 返回此约束在另一个简单或复杂类型中引用的键的名称。 |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 设置 **schema** 元素所指文件中的行号。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 设置 **schema** 元素所在文件中的列位置。 |
...
| void [set_Refer](./set_refer/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 设置此约束在另一个简单或复杂类型中引用的键的名称。 |
