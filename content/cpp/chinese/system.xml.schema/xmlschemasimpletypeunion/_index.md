...
description: 表示符合万维网联盟（W3C）规定的 XML Schema 中用于简单类型的 union 元素。union 数据类型可用于指定 simpleType 的内容。simpleType 元素的值必须是 union 中指定的一组备选数据类型中的任意一个。union 类型始终为派生类型，且必须包含至少两个备选数据类型。
type: docs
weight: 885
url: /zh/system.xml.schema/xmlschemasimpletypeunion/
---
## XmlSchemaSimpleTypeUnion 类

表示来自 XML [Schema](../) 的 **union** 元素，符合万维网 [Web](../../system.web/) 联盟（W3C）的规定。**union** 数据类型可用于指定 **simpleType** 的内容。**simpleType** 元素的值必须是联合中指定的一组备选数据类型中的任意一个。Union 类型始终是派生类型，且必须包含至少两个备选数据类型。
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\> [get_BaseMemberTypes](./get_basemembertypes/)() | 返回一个 [XmlSchemaSimpleType](../xmlschemasimpletype/) 对象数组，表示基于 [XmlSchemaSimpleTypeUnion::get_BaseTypes](./get_basetypes/) 和 [XmlSchemaSimpleTypeUnion::get_MemberTypes](./get_membertypes/) 值的 **simpleType** 元素的类型。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_BaseTypes](./get_basetypes/)() | 返回基类型的集合。 |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | 返回字符串标识。 |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\> [get_MemberTypes](./get_membertypes/)() | 返回此模式（或指定命名空间指示的另一个模式）中定义的内置数据类型或 **simpleType** 元素的限定成员名称数组。 |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | 返回与此 schema 对象一起使用的 XmlSerializerNamespaces。 |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | 返回加载该 schema 的文件的来源位置。 |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | 设置字符串标识。 |
...
| void [set_MemberTypes](./set_membertypes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\&) | 设置此模式（或指定命名空间指示的另一个模式）中定义的内置数据类型或 **simpleType** 元素的限定成员名称数组。 |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | 设置与此 schema 对象一起使用的 XmlSerializerNamespaces。 |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | 设置加载该 schema 的文件的来源位置。 |
...
此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为会导致运行时错误和/或断言失败。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
