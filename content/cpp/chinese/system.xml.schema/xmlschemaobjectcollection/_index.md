...
description: XmlSchemaObjects 的集合。
type: docs
weight: 690
url: /zh/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection 类
...
| 方法 | 描述 |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | 向 [XmlSchemaObjectCollection](./) 添加一个 [XmlSchemaObject](../xmlschemaobject/)。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中首个元素（如果有）的迭代器。此迭代器不能用于更改被引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | 获取指向集合的 const 限定实例中首个元素（如果有）的迭代器。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | 获取指向集合中首个 const 限定元素（如果有）的迭代器。 |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | 从集合实例中移除所有对象。此方法不可被覆盖。 |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | 指示指定的 [XmlSchemaObject](../xmlschemaobject/) 是否在 [XmlSchemaObjectCollection](./) 中。 |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | 将集合中的所有 XmlSchemaObjects 复制到给定数组中，起始于给定索引。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。此迭代器不能用于更改被引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象。 |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | 返回集合能够容纳的元素数量。 |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | 返回集合实例中包含的元素数量。此方法不可被覆盖。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回一个枚举器，用于遍历 [XmlSchemaObjectCollection](./) 中包含的 XmlSchemaObjects。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | 返回指定索引处的 [XmlSchemaObject](../xmlschemaobject/)。 |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | 设置指定索引处的 [XmlSchemaObject](../xmlschemaobject/)。 |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | 返回与指定的 [XmlSchemaObject](../xmlschemaobject/) 对应的集合索引。 |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | 在 [XmlSchemaObjectCollection](./) 中插入一个 [XmlSchemaObject](../xmlschemaobject/)。 |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | 从 [XmlSchemaObjectCollection](./) 中移除一个 [XmlSchemaObject](../xmlschemaobject/)。 |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | 移除集合实例中指定索引处的元素。此方法不可被覆盖。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 按指定值减少共享引用计数。 |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | 设置集合能够容纳的元素数量。 |
...
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | 初始化接受 [XmlSchemaObject](../xmlschemaobject/) 参数的 [XmlSchemaObjectCollection](./) 类的新实例。 |
...
此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 操作符创建此类型的实例，因为这会导致运行时错误和/或断言失败。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将对象作为参数传递给函数。

## 另请参阅

* 类 [CollectionBase](../../system.collections/collectionbase/)
