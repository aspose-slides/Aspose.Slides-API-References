...
description: 表示由万维网联盟 (W3C) 规定的 XML Schema 中的 list 元素。此类可用于将 simpleType 元素定义为指定数据类型的值列表。
type: docs
weight: 859
url: /zh/system.xml.schema/xmlschemasimpletypelist/
---
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，在此比较中两个 NaN 被视为相等，尽管根据 IEC 60559:1989 标准，NaN 不等于任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，在此比较中两个 NaN 被视为相等，尽管根据 IEC 60559:1989 标准，NaN 不等于任何值，包括 NaN 本身。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseItemType](./get_baseitemtype/)() | 返回 [XmlSchemaSimpleType](../xmlschemasimpletype/)，它表示基于 simple type 的 [XmlSchemaSimpleTypeList::get_ItemType](./get_itemtype/) 和 [XmlSchemaSimpleTypeList::get_ItemTypeName](./get_itemtypename/) 值的 **simpleType** 元素的类型。 |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | 返回字符串 ID。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_ItemType](./get_itemtype/)() | 返回基于基值指定的类型派生出的 **simpleType** 元素。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_ItemTypeName](./get_itemtypename/)() | 返回在此模式（或指定命名空间指示的另一个模式）中定义的内建数据类型或 **simpleType** 元素的名称。 |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 返回 **schema** 元素所指文件中的行号。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 返回 **schema** 元素所指文件中的行内位置。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | 返回此 [XmlSchemaObject](../xmlschemaobject/) 的父级对象。 |
...
| void [set_BaseItemType](./set_baseitemtype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | 设置 [XmlSchemaSimpleType](../xmlschemasimpletype/)，它根据 simple type 的 [XmlSchemaSimpleTypeList::get_ItemType](./get_itemtype/) 和 [XmlSchemaSimpleTypeList::get_ItemTypeName](./get_itemtypename/) 值表示 **simpleType** 元素的类型。 |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | 设置字符串 ID。 |
| void [set_ItemType](./set_itemtype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | 设置基值指定类型派生出的 **simpleType** 元素。 |
| void [set_ItemTypeName](./set_itemtypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 设置此模式（或指定命名空间指示的另一个模式）中定义的内建数据类型或 **simpleType** 元素的名称。 |
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 设置 **schema** 元素所指文件的行号。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 设置 **schema** 元素所指文件的行内位置。 |
...
此类的对象只能通过 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
