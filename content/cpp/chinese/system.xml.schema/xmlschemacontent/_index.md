...
description: 用于模式内容的抽象类。
type: docs
weight: 313
url: /zh/system.xml.schema/xmlschemacontent/
---
## XmlSchemaContent 类
...
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 返回指向 **schema** 元素的文件中的行号。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 返回指向 **schema** 元素的文件中的行位置。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上并不复制任何内容，只是初始化新对象并允许拷贝构造子类。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上并不复制任何内容，只是初始化新对象并允许拷贝构造子类。 |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 设置指向 **schema** 元素的文件中的行号。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 设置指向 **schema** 元素的文件中的行位置。 |
