...
description: 返回关于模式异常的详细信息。
type: docs
weight: 1
url: /zh/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException 类
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 返回一个 32 位整数值，它是与当前对象所表示的异常关联的 HRESULT 代码。 |
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | 返回指示错误发生位置的行号。 |
| **int32_t** [get_LinePosition](./get_lineposition/)() | 返回指示错误发生位置的行位置。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 返回此异常的错误条件描述。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | 产生 XmlSchemaException 的 **[XmlSchemaObject](../xmlschemaobject/)**。 |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 返回导致异常的模式的统一资源标识符 (URI) 位置。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类并未从 std::exception 继承，派生类仍可使用受保护/私有成员来实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
