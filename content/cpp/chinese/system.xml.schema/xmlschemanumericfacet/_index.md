...
description: 用于定义数值约束的基类。此类是数值约束类的基类，例如 XmlSchemaMinLengthFacet。
type: docs
weight: 664
url: /zh/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet 类

一个用于定义 **numeric** 约束的基类。此类是 numeric 约束类的基类，例如 [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/)。
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | 返回指示该约束固定的信息。 |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | 返回约束的 **value** 属性。 |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | 设置信息以指示该约束已固定。 |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | 设置约束的 **value** 属性。 |
...
此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装到 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
