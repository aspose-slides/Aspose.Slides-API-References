...
description: 表示由万维网联盟 (W3C) 指定的 XML Schema 中用于简单内容的 extension 元素。此类可用于通过扩展方式派生简单类型。这种派生用于通过添加属性来扩展元素的简单类型内容。
type: docs
weight: 807
url: /zh/system.xml.schema/xmlschemasimplecontentextension/
---
## XmlSchemaSimpleContentExtension 类
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 样式的浮点比较，其中两个 NaN 被视为相等，即使根据 IEC 60559:1989 标准，NaN 与任何值都不相等，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 样式的浮点比较，其中两个 NaN 被视为相等，即使根据 IEC 60559:1989 标准，NaN 与任何值都不相等，包括 NaN 本身。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | 返回 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) 用于属性值。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | 返回 [XmlSchemaAttribute](../xmlschemaattribute/) 和 [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) 的集合。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | 返回此类型所扩展的内置数据类型或简易类型的名称。 |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | 设置用于属性值的 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/)。 |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 设置此类型所扩展的内置数据类型或简易类型的名称。 |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | 设置与此 schema 对象的 XmlSerializerNamespaces。 |
