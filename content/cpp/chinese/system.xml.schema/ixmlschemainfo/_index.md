...
description: 定义已验证 XML 节点的后模式验证信息集。
type: docs
weight: 40
url: /zh/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo 类

定义已验证 XML 节点的后模式验证信息集。
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | 返回一个值，指示在 XML [Schema](../) 定义语言 (XSD) 模式验证期间，是否因为应用默认而将此已验证的 XML 节点设置为结果。 |
| virtual **bool** [get_IsNil](./get_isnil/)() | 返回一个值，指示此已验证的 XML 节点的值是否为 **nil**。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | 返回此已验证的 XML 节点的动态模式类型。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | 返回对应于此已验证的 XML 节点的已编译 [XmlSchemaAttribute](../xmlschemaattribute/)。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | 返回对应于此已验证的 XML 节点的已编译 [XmlSchemaElement](../xmlschemaelement/)。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | 返回此已验证的 XML 节点的静态 XML [Schema](../) 定义语言 (XSD) 模式类型。 |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | 返回此已验证的 XML 节点的 XmlSchemaValidity 值。 |
