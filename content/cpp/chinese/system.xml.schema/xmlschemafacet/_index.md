...
description: 在通过限制派生简单类型时使用的所有 facet 的基类。
type: docs
weight: 404
url: /zh/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet 类

一个基类，用于所有在通过限制派生简单类型时使用的 facet。
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | 返回指示此 facet 已固定的信息。 |
...
| [String](../../system/string/) [get_Value](./get_value/)() | 返回 facet 的 **value** 属性。 |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | 设置信息以指示此 facet 已固定。 |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | 设置 facet 的 **value** 属性。 |
...
此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类实例，因为这会导致运行时错误和/或断言故障。始终将此类包装到 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
