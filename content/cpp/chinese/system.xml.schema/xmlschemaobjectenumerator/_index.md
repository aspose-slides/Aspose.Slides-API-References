...
description: 表示 XmlSchemaObjectCollection 的枚举器。
type: docs
weight: 703
url: /zh/system.xml.schema/xmlschemaobjectenumerator/
---
## XmlSchemaObjectEnumerator 类
...
| 方法 | 描述 |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | 准备迭代器以供 VirtualizedIterator 类使用。 |
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaObject](../xmlschemaobject/)\>\> * [CloneIterator](./cloneiterator/)() const override | 克隆当前迭代器。 |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\& [get_Current](./get_current/)() const override | 返回集合中当前的 [XmlSchemaObject](../xmlschemaobject/)。 |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | 将迭代器向前移动一步。 |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 执行第一次 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 调用并准备枚举器对象以供 VirtualizedIterator 使用。 |
...
| **bool** [MoveNext](./movenext/)() override | 移动到集合中的下一个项。 |
...
| void [Reset](./reset/)() override | 将枚举器重置到集合的起始位置。 |
