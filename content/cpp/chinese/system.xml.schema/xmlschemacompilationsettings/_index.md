...
description: 为 XmlSchemaSet 类提供模式编译选项。此类不可被继承。
type: docs
weight: 248
url: /zh/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings 类

为 [XmlSchemaSet](../xmlschemaset/) 类提供模式编译选项。此类不可被继承。
```cpp
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | 返回一个值，指示 [XmlSchemaSet](../xmlschemaset/) 是否应检查唯一粒子归属 (UPA) 违规。 |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | 设置一个值，指示 [XmlSchemaSet](../xmlschemaset/) 是否应检查唯一粒子归属 (UPA) 违规。 |
