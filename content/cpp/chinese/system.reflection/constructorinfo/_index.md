...
description: 提供对构造函数元数据的访问。
type: docs
weight: 53
url: /zh/system.reflection/constructorinfo/
---
## ConstructorInfo 类
...
| 方法 | 描述 |
| --- | --- |
| void [AddAttribute](../memberinfo/addattribute/)(const [ObjectPtr](../memberinfo/objectptr/)\&) | 将属性添加到集合。 |
|  [ConstructorInfo](./constructorinfo/)(const [String](../../system/string/)\&, std::function\<[System::Object::ptr](../../system/object/ptr/)()>) | 为无参数构造函数初始化 [ConstructorInfo](./) 类的新实例。 |
...
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](./get_declaringtype/)() | 获取声明此成员的类。未实现。 |
...
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | 获取指示此成员是构造函数的 MemberTypes 值。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[MemberInfo](../memberinfo/)\> [GetCurrentMethod](../methodbase/getcurrentmethod/)(const [String](../../system/string/)\&) | 此方法允许获取当前方法名称。翻译器会自动将 ASPOSE_CURRENT_FUNCTION 作为参数替代。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | 返回包含表示当前对象所表示类型上所有自定义属性的对象数组。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | 返回包含表示当前对象所表示类型上所有自定义属性的对象数组。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Invoke](./invoke/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\>\&) | 使用指定参数调用当前实例表示的方法或构造函数。 |
...
|  [MethodBase](../methodbase/methodbase/)() | 初始化 [MethodBase](../methodbase/) 类的新实例。 |
