...
description: 发现字段的属性并提供对字段元数据的访问。
type: docs
weight: 92
url: /zh/system.reflection/fieldinfo/
---
## FieldInfo 类
...
| [TypeInfo](../../system/typeinfo/) [get_FieldType](./get_fieldtype/)() | 获取属性类型。 |
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | 获取成员完整名称。可能在手动实现的部分中不同。 |
| **bool** [get_IsStatic](./get_isstatic/)() | 获取指示字段是否为静态的值。 |
| virtual [MemberTypes](../membertypes/) [get_MemberType](../memberinfo/get_membertype/)() const | 获取一个 [System::Reflection::MemberTypes](../membertypes/) 值，指示成员的类型——方法、构造函数、事件等。 |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | 返回一个数组，包含表示当前对象所代表类型上所有自定义属性的对象。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | 返回一个数组，包含表示当前对象所代表类型上所有自定义属性的对象。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [GetValue](./getvalue/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 从特定对象获取属性值。 |
...
| void [SetValue](./setvalue/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 将属性值设置为特定对象。 |
