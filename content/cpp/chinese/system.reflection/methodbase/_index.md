...
description: "关于方法的基本信息。此类的对象只能使用 System::MakeObject() 函数进行分配。切勿在栈上或使用 new 操作符创建此类型的实例，否则会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 118
url: /zh/system.reflection/methodbase/
---
## MethodBase 类
...
| 方法 | 描述 |
| --- | --- |
| void [AddAttribute](../memberinfo/addattribute/)(const [ObjectPtr](../memberinfo/objectptr/)\&) | 向集合添加属性。 |
...
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | 获取成员的完整名称。手动实现的部分可能不同。 |
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | 指示成员的类型——方法、构造函数、事件等。 |
| const [String](../../system/string/)\& [get_Name](../memberinfo/get_name/)() const | 获取成员名称。 |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](../memberinfo/get_reflectedtype/)() const | 获取反射的类型。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| static [System::SharedPtr](../../system/sharedptr/)\<[MemberInfo](../memberinfo/)\> [GetCurrentMethod](./getcurrentmethod/)(const [String](../../system/string/)\&) | 此方法允许获取当前方法名称。翻译器会自动将 ASPOSE_CURRENT_FUNCTION 作为参数替换。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | 返回一个数组，其中包含表示当前对象所代表类型上应用的所有自定义属性的对象。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | 返回一个数组，其中包含表示当前对象所代表类型上应用的所有自定义属性的对象。 |
