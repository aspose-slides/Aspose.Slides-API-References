...
description: "提供成员的反射信息。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 105
url: /zh/system.reflection/memberinfo/
---
## MemberInfo 类

提供成员的反射信息。此类的对象应只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| 方法 | 描述 |
| --- | --- |
| void [AddAttribute](./addattribute/)(const [ObjectPtr](./objectptr/)\&) | 向集合中添加属性。 |
...
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](./get_declaringtype/)() const | 获取声明类型。 |
| const [String](../../system/string/)\& [get_FullName](./get_fullname/)() const | 获取成员完整名称。可在手动实现的部分中不同。 |
| virtual [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const | 获取指示成员类型（方法、构造函数、事件等）的 [System::Reflection::MemberTypes](../membertypes/) 值。 |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | 获取成员名称。 |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](./get_reflectedtype/)() const | 获取反射的类型。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | 返回一个数组，包含表示当前对象所表示类型上应用的所有自定义属性的对象。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(**bool**) const | 返回一个数组，包含表示当前对象所表示类型上应用的所有自定义属性的对象。 |
