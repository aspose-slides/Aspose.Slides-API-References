...
description: 表示一个处理将任务排入线程队列的底层工作对象。
type: docs
weight: 79
url: /zh/system.threading.tasks/taskscheduler/
---
## TaskScheduler 类
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | 创建一个与当前线程关联的 [TaskScheduler](./)。 |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | 获取与当前执行任务关联的 [TaskScheduler](./)。 |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | 获取框架提供的默认 [TaskScheduler](./) 实例。 |
| **int32_t** [get_Id](./get_id/)() const | 获取此 [TaskScheduler](./) 的唯一 ID。 |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | 指示此 [TaskScheduler](./) 能够支持的最大并发级别。 |
