...
description: 提供并行循环的完成状态。
type: docs
weight: 14
url: /zh/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult 类

提供 [Parallel](../parallel/) 循环的完成状态。
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | 获取循环是否已完整运行。 |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | 获取发生 break 的最低迭代索引。 |
...
|  [ParallelLoopResult](./parallelloopresult/)() | 构造一个 [ParallelLoopResult](./)。 |
