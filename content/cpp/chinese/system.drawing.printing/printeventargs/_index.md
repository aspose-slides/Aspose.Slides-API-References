...
description: "提供 BeginPrint 和 EndPrint 事件的数据。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 92
url: /zh/system.drawing.printing/printeventargs/
---
## PrintEventArgs 类

提供 BeginPrint 和 EndPrint 事件的数据。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| 方法 | 描述 |
| --- | --- |
|  [CancelEventArgs](../../system.componentmodel/canceleventargs/canceleventargs/)(**bool**) | 构造函数。 |
|  [CancelEventArgs](../../system.componentmodel/canceleventargs/canceleventargs/)() | 构造函数；将 Cancel 属性设置为 false。 |
...
| **bool** [get_Cancel](../../system.componentmodel/canceleventargs/get_cancel/)() | 获取指示是否应取消事件的值。 |
| [PrintAction](../printaction/) [get_PrintAction](./get_printaction/)() | 返回指定当前对象所代表的打印操作的值。 |
...
| void [set_Cancel](../../system.componentmodel/canceleventargs/set_cancel/)(**bool**) | 设置指示是否应取消事件的值。 |
...
* 类 [CancelEventArgs](../../system.componentmodel/canceleventargs/)
