...
description: "表示打印页面的设置。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 14
url: /zh/system.drawing.printing/pagesettings/
---
## PageSettings 类

表示打印页面的设置。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() | 未实现。 |
| **float** [get_HardMarginX](./get_hardmarginx/)() | 未实现。 |
| **float** [get_HardMarginY](./get_hardmarginy/)() | 未实现。 |
| [SharedPtr](../../system/sharedptr/)\<[PrinterResolution](../printerresolution/)\> [get_PrinterResolution](./get_printerresolution/)() | 未实现。 |
...
|  [PageSettings](./pagesettings/)() | 构造 [PageSettings](./) 类的新实例。 |
|  [PageSettings](./pagesettings/)(const [SharedPtr](../../system/sharedptr/)\<[PrinterSettings](../printersettings/)\>\&) | 构造 [PageSettings](./) 类的新实例。 |
