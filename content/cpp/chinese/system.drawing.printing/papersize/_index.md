...
type: docs
weight: 27
url: /zh/system.drawing.printing/papersize/
---
## PaperSize 类
...
| **int32_t** [get_Height](./get_height/)() const | 获取纸张的高度，单位为百分之一英寸。 |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | 获取纸张类型。 |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | 获取纸张类型的名称。 |
| **int32_t** [get_RawKind](./get_rawkind/)() const | 获取一个整数，表示 [System::Drawing::Printing::PaperSize](./) 值之一或自定义值。 |
| **int32_t** [get_Width](./get_width/)() const | 获取纸张的宽度，单位为百分之一英寸。 |
...
|  [PaperSize](./papersize/)() | 初始化 [System::Drawing::Printing::PaperSize](./) 类的新实例。 |
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | 初始化 [System::Drawing::Printing::PaperSize](./) 类的新实例。 |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | 初始化 [System::Drawing::Printing::PaperSize](./) 类的新实例。 |
...
| void [set_Height](./set_height/)(**int32_t**) | 设置纸张的高度，单位为百分之一英寸。 |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | 设置纸张类型的名称。 |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | 设置一个整数，表示 [System::Drawing::Printing::PaperSize](./) 值之一或自定义值。 |
| void [set_Width](./set_width/)(**int32_t**) | 设置纸张的宽度，单位为百分之一英寸。 |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | 以字符串形式提供关于 [System::Drawing::Printing::PaperSize](./) 的信息。 |
