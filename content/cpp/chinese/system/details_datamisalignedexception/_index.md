...
type: docs
weight: 391
url: /zh/system/details_datamisalignedexception/
---
## Details_DataMisalignedException 类
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | 返回表示最深层内部异常的 Exception 对象的副本。 |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | 通过引用将值类型对象与 nullptr 进行比较。 |
