...
description: "当 URI 的格式无效时会抛出 UriFormatException。切勿手动创建此类实例。请改用 UriFormatException 类。切勿将 UriFormatException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 768
url: /zh/system/details_uriformatexception/
---
## Details_UriFormatException 类

UriFormatException 在 URI 的格式无效时抛出。切勿手动创建此类的实例。请改用 UriFormatException 类。切勿将 UriFormatException 类的实例包装到 [System::SmartPtr](../smartptr/) 中。
...
|  [Object](../object/object/)([Object](../object/) const\&) | 拷贝构造函数。实际上不拷贝任何内容，只是初始化新对象并允许子类的拷贝构造。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 赋值运算符。实际上不拷贝任何内容，只是初始化新对象并允许子类的拷贝构造。 |
...
* 类 [Details_FormatException](../details_formatexception/)
* 命名空间 [System](../)
* 库 [Aspose.Slides](../../)