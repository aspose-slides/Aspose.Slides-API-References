...
description: "ArithmeticException 在算术执行、转换或强制转换操作期间出现错误时抛出。切勿手动创建此类的实例。请改用 ArithmeticException 类。切勿将 ArithmeticException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 365
url: /zh/system/details_arithmeticexception/
---
## Details_ArithmeticException 类


ArithmeticException 在算术执行、转换或强制转换操作期间出现错误时抛出。切勿手动创建此类的实例。请改用 ArithmeticException 类。切勿将 ArithmeticException 类的实例包装到 [System::SmartPtr](../smartptr/) 中。
