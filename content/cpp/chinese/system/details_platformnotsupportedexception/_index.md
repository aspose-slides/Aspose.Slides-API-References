...
description: "PlatformNotSupportedException 在特定平台上功能无法运行时抛出。切勿手动创建此类的实例。请改用 PlatformNotSupportedException 类。切勿将 PlatformNotSupportedException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 664
url: /zh/system/details_platformnotsupportedexception/
---
## Details_PlatformNotSupportedException 类

PlatformNotSupportedException 在特定平台上功能无法运行时抛出。切勿手动创建此类的实例。请改用 PlatformNotSupportedException 类。切勿将 PlatformNotSupportedException 类的实例包装到 [System::SmartPtr](../smartptr/) 中。
...
| virtual const char * [what](../details_exception/what/)() const | 实现 [what()](../details_exception/what/) 方法，该方法由 [ExceptionWrapper](../exceptionwrapper/) 类调用。尽管此类未从 std::exception 继承，但派生类可以使用受保护/私有成员来实现其逻辑。将此方法实现移至 [ExceptionWrapper](../exceptionwrapper/) 可能会破坏该逻辑。 |
| virtual  [~Object](../object/~object/)() | 销毁对象。释放所有内部数据结构。 |

## 另请参见

* 类 [Details_NotSupportedException](../details_notsupportedexception/)
* 命名空间 [System](../)
* 库 [Aspose.Slides](../../)