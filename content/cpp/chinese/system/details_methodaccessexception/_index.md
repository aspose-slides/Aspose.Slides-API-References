...
description: "当尝试访问不存在的方法或访问方法不被允许时，会抛出 MemberAccessException。请勿手动创建此类的实例。请改用 MethodAccessException 类。请勿将 MethodAccessException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 560
url: /zh/system/details_methodaccessexception/
---
## Details_MethodAccessException 类

MemberAccessException 在尝试访问不存在的方法或访问方法不被允许时抛出。请勿手动创建此类的实例。请使用 MethodAccessException 类。请勿将 MethodAccessException 类的实例包装到 [System::SmartPtr](../smartptr/) 中。
...
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅用于内部。 |
...
|  [Object](../object/object/)([Object](../object/) const\&) | 拷贝构造函数。实际上并不复制任何内容，仅初始化新对象并启用子类的拷贝构造。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 赋值运算符。实际上并不复制任何内容，仅初始化新对象并启用子类的拷贝构造。 |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | 将共享引用计数按指定值递减。 |
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | 设置 HRESULT，即分配给特定异常的编码数值。 |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而不是共享）。允许在容器中将指针切换为弱模式。 |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | 返回当前对象的字符串表示形式。 |
...
| virtual const char * [what](../details_exception/what/)() const | 实现 [what()](../details_exception/what/) 方法，该方法由 [ExceptionWrapper](../exceptionwrapper/) 类调用。尽管此类未继承自 std::exception，派生类仍可使用受保护/私有成员来实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../exceptionwrapper/) 可能会破坏该逻辑。 |
| virtual  [~Object](../object/~object/)() | 销毁对象。释放所有内部数据结构。 |

## 另请参见

* 类 [Details_MemberAccessException](../details_memberaccessexception/)
* 命名空间 [System](../)
* 库 [Aspose.Slides](../../)