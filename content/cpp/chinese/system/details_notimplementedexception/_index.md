...
description: "当一个方法未实现且作为存根时会抛出 NotImplementedException。切勿手动创建此类的实例。请改用 NotImplementedException 类。切勿将 NotImplementedException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 573
url: /zh/system/details_notimplementedexception/
---
## Details_NotImplementedException 类


NotImplementedException 在方法未实现且作为存根时抛出。切勿手动创建此类的实例。请改用 NotImplementedException 类。切勿将 NotImplementedException 类的实例包装到 [System::SmartPtr](../smartptr/) 中。
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，其中即使依据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），两个 NaN 仍被视为相等。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，其中即使依据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），两个 NaN 仍被视为相等。 |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | 针对 string 和 nullptr 情况的 [Object::ReferenceEquals](../object/referenceequals/) 特化。 |
