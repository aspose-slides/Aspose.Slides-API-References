...
description: 确定委托集合是否不为空。
type: docs
weight: 131
url: /zh/system/multicastdelegate_tmpl_returntype_lbrace_argumenttypes_dots_rbrace__end_tmpl/operator_not_equal/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| other | const [MulticastDelegate](../multicastdelegate/)\& | 用于比较的 MulticastDelegate 对象 |

### 返回值

如果两个对象表示相同的委托集合则返回 true，否则返回 false。
