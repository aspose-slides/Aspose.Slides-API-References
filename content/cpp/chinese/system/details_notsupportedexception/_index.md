...
description: "当调用的方法不受支持或对流的操作不受支持时，会抛出 NotSupportedException。切勿手动创建此类的实例。请改用 NotSupportedException 类。切勿将 NotSupportedException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 586
url: /zh/system/details_notsupportedexception/
---
## Details_NotSupportedException 类


当调用的方法不受支持或对流的操作不受支持时，会抛出 NotSupportedException。切勿手动创建此类的实例。请改用 NotSupportedException 类。切勿将 NotSupportedException 类的实例包装到 [System::SmartPtr](../smartptr/) 中。
