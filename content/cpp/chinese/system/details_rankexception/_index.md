...
description: "当向方法传递维度数不同于预期的数组参数时，会抛出 RankException。不要手动创建此类的实例。应使用 RankException 类。不要将 RankException 类实例包装进 System::SmartPtr。"
type: docs
weight: 677
url: /zh/system/details_rankexception/
---
## Details_RankException 类


RankException 在将维度数与预期不同的数组参数传递给方法时被抛出。不要手动创建此类的实例。应使用 RankException 类。不要将 RankException 类实例包装进 [System::SmartPtr](../smartptr/)。
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，其中两个 NaN 被视为相等，尽管依据 IEC 60559:1989，NaN 不等于任何值，包括 NaN 本身。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，其中两个 NaN 被视为相等，尽管依据 IEC 60559:1989，NaN 不等于任何值，包括 NaN 本身。 |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../object/memberwiseclone/) 方法的类似实现。启用自定义类型的克隆。 |
|  [Object](../object/object/)() | 创建对象。初始化所有内部数据结构。 |
|  [Object](../object/object/)([Object](../object/) const\&) | 拷贝构造函数。实际上并不复制任何内容，只是初始化新对象并允许子类的拷贝构造。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 赋值运算符。实际上并不复制任何内容，只是初始化新对象并允许子类的拷贝构造。 |
