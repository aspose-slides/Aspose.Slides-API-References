...
description: "ArgumentOutOfRangeException 在调用的方法传入超出该参数预期取值范围的参数时抛出。切勿手动创建此类实例。请改用 ArgumentOutOfRangeException 类。切勿将 ArgumentOutOfRangeException 类实例包装到 System::SmartPtr 中。"
type: docs
weight: 352
url: /zh/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException 类

ArgumentOutOfRangeException 在调用的方法传入超出该参数预期取值范围的参数时抛出。切勿手动创建此类的实例。请改用 ArgumentOutOfRangeException 类。切勿将 ArgumentOutOfRangeException 类的实例包装到 [System::SmartPtr](../smartptr/) 中。
...
* 类 [Details_ArgumentException](../details_argumentexception/)
* 命名空间 [System](../)
* 库 [Aspose.Slides](../../)