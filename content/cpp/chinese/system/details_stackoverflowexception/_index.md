...
description: "当线程的执行堆栈溢出时会抛出 StackOverflowException。切勿手动创建此类的实例。请使用 StackOverflowException 类。切勿将 StackOverflowException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 690
url: /zh/system/details_stackoverflowexception/
---
## Details_StackOverflowException 类


当线程的执行堆栈溢出时会抛出 StackOverflowException。切勿手动创建此类的实例。请使用 StackOverflowException 类。切勿将 StackOverflowException 类的实例包装到 [System::SmartPtr](../smartptr/) 中。
