...
description: IEnumerable.Cast() 扩展方法使用的枚举器。
type: docs
weight: 53
url: /zh/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter 类

用于 IEnumerable.Cast() 扩展方法的枚举器。
...
| 方法 | 描述 |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | 准备迭代器，以供 VirtualizedIterator 类使用。 |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 执行第一次 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 调用，并准备枚举器对象以供 VirtualizedIterator 使用。 |
...
| **bool** [MoveNext](./movenext/)() override | 将枚举器移动到下一个元素。如果之前未引用任何元素，则引用第一个可用元素。如果已到达容器末尾，则不执行任何操作。 |
