...
type: docs
weight: 92
url: /zh/system.collections.generic.details/enumeratorselectindexadapter/
---
## EnumeratorSelectIndexAdapter 类
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | 获取当前元素。 |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 执行首次 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 调用并准备枚举器对象供 VirtualizedIterator 使用。 |
...
| **bool** [MoveNext](./movenext/)() override | 将枚举器移动到下一个元素。如果之前没有引用任何元素，则将引用设置为第一个可用元素。如果到达容器末端，则不执行任何操作。 |
