...
type: docs
weight: 105
url: /zh/system.collections.generic.details/enumeratorselectmanyadapter/
---
## EnumeratorSelectManyAdapter 类
...
| **bool** [MoveNext](./movenext/)() override | 将枚举器移动到下一个元素。如果之前未引用任何元素，则设置引用到第一个可用元素。如果已到达容器末尾，则不执行任何操作。 |
