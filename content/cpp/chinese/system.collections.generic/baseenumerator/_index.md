...
description: "枚举器定义用于将 STL 风格的类型包装为 C# 风格的使用。除存在顺序迭代器外，不对容器结构做任何断言。使用 begin() 和 end() 函数。该类的对象只能通过 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，否则会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针作为参数传递给函数。"
type: docs
weight: 66
url: /zh/system.collections.generic/baseenumerator/
---
## BaseEnumerator 类
...
| 参数 | 描述 |
| --- | --- |
| Container | STL 风格的容器类型。 |
| Element | 元素类型。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | 准备迭代器供 VirtualizedIterator 类使用。 |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](../ienumerator/get_current/)() const | 获取当前元素。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。启用自定义对象的哈希。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 获取对象的实际类型。相当于 C# [System.Object.GetType()](../../system/object/gettype/) 调用。 |
|  [IEnumerator](../ienumerator/ienumerator/)() |  |
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | 将迭代器向前移动一步。 |
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | 执行第一次 [MoveNext()](../ienumerator/movenext/) 调用，并准备枚举器对象供 VirtualizedIterator 使用。 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否表示由 targetType 描述的类型实例。相当于 C# 'is' 运算符。 |
| **bool** [IsValid](./isvalid/)() const | 检查是否已调用 [MoveNext()](./movenext/) 且未到达结束。 |
| void [Lock](../../system/object/lock/)() | 实现 C# lock() 语句的锁定。直接调用或使用 [LockContext](../../system/lockcontext/) 哨兵对象。 |
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | 标记由 virtualized iterator 拥有的枚举器。 |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 相当于 C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。启用自定义类型的克隆。 |
| **bool** [MoveNext](./movenext/)() override | 枚举器式递增。 |
...
| void [Reset](./reset/)() override | 重置枚举器以允许重新枚举元素。 |
