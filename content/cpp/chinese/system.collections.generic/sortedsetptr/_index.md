...
description: 用于保持 SortedSet 引用的指针。此类型是用于管理其他对象删除的指针。它应分配在栈上，并通过值或 const 引用传递给函数。
type: docs
weight: 586
url: /zh/system.collections.generic/sortedsetptr/
---
## SortedSetPtr 类

用于保持 [SortedSet](../sortedset/) 引用的指针。此类型是用于管理其他对象删除的指针。它应分配在栈上，并通过值或 const 引用传递给函数。
...
| 方法 | 描述 |
| --- | --- |
| auto [begin](../../system/smartptr/begin/)() | 底层集合的 [begin()](../../system/smartptr/begin/) 方法的访问器。仅当 SmartPtr_ 为具有 [begin()](../../system/smartptr/begin/) 方法的特化类型时编译通过。 |
| auto [begin](../../system/smartptr/begin/)() const | 底层集合的 [begin()](../../system/smartptr/begin/) 方法的访问器。仅当 SmartPtr_ 为具有 [begin()](../../system/smartptr/begin/) 方法的特化类型时编译通过。 |
...
| std::enable_if_t<\!Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | 使用 dynamic_cast 将指针转换为派生类型。 |
| auto [cbegin](../../system/smartptr/cbegin/)() const | 底层集合的 [cbegin()](../../system/smartptr/cbegin/) 方法的访问器。仅当 SmartPtr_ 为具有 [cbegin()](../../system/smartptr/cbegin/) 方法的特化类型时编译通过。 |
| auto [cend](../../system/smartptr/cend/)() const | 底层集合的 [cend()](../../system/smartptr/cend/) 方法的访问器。仅当 SmartPtr_ 为具有 [cend()](../../system/smartptr/cend/) 方法的特化类型时编译通过。 |
...
| auto [end](../../system/smartptr/end/)() | 底层集合的 [end()](../../system/smartptr/end/) 方法的访问器。仅当 SmartPtr_ 为具有 [end()](../../system/smartptr/end/) 方法的特化类型时编译通过。 |
| auto [end](../../system/smartptr/end/)() const | 底层集合的 [end()](../../system/smartptr/end/) 方法的访问器。仅当 SmartPtr_ 为具有 [end()](../../system/smartptr/end/) 方法的特化类型时编译通过。 |
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | 检查指针是否指向了除拥有对象之外的其他对象（由别名构造函数创建）。 |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&) | 将 [SmartPtr](../../system/smartptr/) 对象进行移动赋值。x 变为不可用。 |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&) | 将 [SmartPtr](../../system/smartptr/) 对象进行拷贝赋值。 |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&) | 将 [SmartPtr](../../system/smartptr/) 对象进行拷贝赋值。执行必要的类型转换。 |
...
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | 从指针中移除别名（由别名构造函数创建），确保它管理（若为共享）或跟踪（若为弱）它指向的相同对象。 |
| void [reset](../../system/smartptr/reset/)([Pointee_](../../system/smartptr/pointee_/) *) | 设置指向的对象。 |
| void [reset](../../system/smartptr/reset/)() | 使指针指向 nullptr。 |
| void [set_Mode](../../system/smartptr/set_mode/)([SmartPtrMode](../../system/smartptrmode/)) | 设置指针模式。可能改变引用对象的引用计数。 |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | 拷贝构造 [SmartPtr](../../system/smartptr/) 对象。两指针随后指向同一对象。如允许则执行类型转换。 |
...
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | 通过创建不同类型的新数组来转换引用数组的类型。如果 C# 中存在 C++ 不支持的数组类型转换，此方法很有用。 |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const Y\&) | 初始化空数组。用于翻译某些 C# 代码构造。 |
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<P\>\&, [Pointee_](../../system/smartptr/pointee_/) *, [SmartPtrMode](../../system/smartptrmode/)) | 构造一个 [SmartPtr](../../system/smartptr/)，其共享指针的所有权信息与初始 ptr 值相同，但持有一个不相关且未管理的指针 p。 |
|  [SortedSetPtr](./sortedsetptr/)() | 空指针构造函数。 |
|  [SortedSetPtr](./sortedsetptr/)(const [SharedPtr](../../system/sharedptr/)\<[SortedSet](../sortedset/)\<T\>\>\&) | 拷贝构造函数。 |
