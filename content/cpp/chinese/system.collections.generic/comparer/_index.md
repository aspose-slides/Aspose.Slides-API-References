...
description: 提供一个基类，用于实现 System.Collections.Generic.IComparer 泛型接口。
type: docs
weight: 105
url: /zh/system.collections.generic/comparer/
---
## Comparer 类
...
| 方法 | 描述 |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) 函数。 |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | 返回由泛型参数指定的类型的默认排序比较器。 |
