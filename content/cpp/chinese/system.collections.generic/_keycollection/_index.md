...
description: "Dictionary 键的集合。引用集合，不复制任何内容。此类的对象应仅使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 1
url: /zh/system.collections.generic/_keycollection/
---
## _KeyCollection 类

[Dictionary](../dictionary/) 的键集合。引用集合，不复制任何内容。此类的对象应仅通过 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| void [Add](../ikvcollection/add/)(const T\&) override | 向容器添加项目。 |
|  [BaseKVCollection](../basekvcollection/basekvcollection/)(const typename Dict::Ptr\&) | 创建集合。 |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../ienumerable/getenumerator/) 返回 T 的拷贝对象，此迭代器不能用于更改被引用的对象。 |
...
| **bool** [Contains](./contains/)(const [TKey](./tkey/)\&) const override | 检查容器中是否存在该项目。 |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | 将数据复制到现有数组元素中。 |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置的迭代器（如果有）。由于 [GetEnumerator()](../ienumerable/getenumerator/) 返回 T 的拷贝对象，此迭代器不能用于更改被引用的对象。 |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | 获取指向集合的 const 限定实例中最后一个元素之后的位置的迭代器（如果有）。 |
...
| **bool** [get_IsReadOnly](../ikvcollection/get_isreadonly/)() const override | 检查容器是否只读。 |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | 获取集合用于同步的对象。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TKey](./tkey/)\>\> [GetEnumerator](./getenumerator/)() override | 获取遍历键的枚举器。 |
...
| [TKey](./tkey/) [idx_get](./idx_get/)(int) const override | 实现 [IList](../ilist/) 方法。不支持。 |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | 设置函数。 |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | 获取容器中项目的索引。 |
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | 在指定位置插入项目。 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否是 targetType 描述的类型的实例。相当于 C# 的 'is' 运算符。 |
| T [LINQ_Aggregate](../ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | 在序列上应用累加函数。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 按照 keySelector 选择的键值对序列元素进行升序排序。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 按照 keySelector 选择的键值对序列元素进行降序排序。 |
...
| **bool** [Remove](../ikvcollection/remove/)(const T\&) override | 从容器中移除项目。 |
| void [RemoveAt](../ikvcollection/removeat/)(int) override | 移除指定位置的项目。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定值。 |
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | 仅用于编译通过，但实际上不执行任何操作，因为此结构不拥有数据。 |
...
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 获取当前容器的 const begin 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 获取当前容器的 begin 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 获取当前容器的 const end 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | 获取当前容器的 end 迭代器实现。 |
...
* 类 [BaseKVCollection](../basekvcollection/)
