...
description: Stack 类前向声明。
type: docs
weight: 599
url: /zh/system.collections.generic/stack/
---
## Stack 类
...
| 方法 | 描述 |
| --- | --- |
| void [AddRange](./addrange/)([IEnumerablePtr](./ienumerableptr/)) | 将元素放入堆栈。 |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../ienumerable/getenumerator/) 返回 T 的副本对象，无法使用此迭代器更改被引用的对象。 |
...
| virtual void [Clear](./clear/)() | 删除堆栈中的所有元素。 |
| virtual **bool** [Contains](./contains/)(const T\&) const | 检查容器中是否存在特定项；比较时使用 operator ==。 |
| [stack_t](./stack_t/)\& [data](./data/)() | 内部数据结构访问器。 |
| const [stack_t](./stack_t/)\& [data](./data/)() const | 内部数据结构访问器。 |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。由于 [GetEnumerator()](../ienumerable/getenumerator/) 返回 T 的副本对象，无法使用此迭代器更改被引用的对象。 |
...
| virtual int [get_Count](./get_count/)() const | 获取堆栈中元素的数量。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | 获取枚举器以遍历当前堆栈。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | 通过包含元素索引，将序列的每个元素转换为新形式。 |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<Result\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<Result\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\>\>\&) | 投射序列的每个元素并将产生的序列合并为一个序列。 |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<Result\>\> [LINQ_SelectMany](../ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<Source, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<Result\>\>\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Take](../ienumerable/linq_take/)(**int32_t**) | 返回序列起始处指定数量的连续元素。 |
...
| T [Peek](./peek/)() | 获取堆栈顶部的元素，但保留在堆栈中。 |
| T [Pop](./pop/)() | 获取堆栈顶部的元素。 |
| void [Push](./push/)(const T\&) | 将元素放入堆栈顶部。 |
...
|  [Stack](./stack/)() | 构造空堆栈。 |
|  [Stack](./stack/)(int) | 构造空堆栈。 |
|  [Stack](./stack/)([IEnumerablePtr](./ienumerableptr/)) | 拷贝构造函数。 |
| virtual [ArrayPtr](../../system/arrayptr/)\<T\> [ToArray](./toarray/)() | 将堆栈转换为数组。 |
...
| [stack_t](./stack_t/) | 基础数据类型。 |
| [IEnumerablePtr](./ienumerableptr/) | 包含同类型元素的集合。 |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** 类型。 |
## 备注

[Stack](./) 类包装 std::list。此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为会导致运行时错误和/或断言故障。始终将此类包装到 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
...
int main()
{
  ...
  // 打印堆栈的最后一个项。Peek 方法不会从堆栈中移除项。
  std::cout << stack->Peek() << std::endl;
  PrintItems(stack);

  // 打印堆栈的最后一个项。Pop 方法会从堆栈中移除项。
