...
description: "ECDsa 算法实现的基类。此类的对象只能使用 System::MakeObject() 函数分配。绝不要在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 183
url: /zh/system.security.cryptography/ecdsa/
---
## ECDsa 类
...
| static [SharedPtr](../../system/sharedptr/)\<[ECDsa](./)\> [Create](./create/)() | Creates default ECDSA algorithm implementation. |
| static [SharedPtr](../../system/sharedptr/)\<[ECDsa](./)\> [Create](./create/)(const [ECCurve](../eccurve/)\&) | Creates default ECDSA algorithm implementation, using a newly created key over the specified curve. |
| static [SharedPtr](../../system/sharedptr/)\<[ECDsa](./)\> [Create](./create/)(const [ECParameters](../ecparameters/)\&) | Creates default ECDSA algorithm implementation using the specified parameters. |
| static [SharedPtr](../../system/sharedptr/)\<[ECDsa](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Creates specified ECDSA algorithm implementation. |
| void [Dispose](../asymmetricalgorithm/dispose/)() override | Releases resources owned by the current object. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Uses C# [Object.Equals](../../system/object/equals/) semantics to compare objects. |
