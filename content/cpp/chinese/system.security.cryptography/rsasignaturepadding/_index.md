...
description: 用于 RSA 签名创建或验证操作的填充模式和参数。
type: docs
weight: 521
url: /zh/system.security.cryptography/rsasignaturepadding/
---
## RSASignaturePadding 类


用于[RSA](../rsa/)签名创建或验证操作的填充模式和参数。
...
| [RSASignaturePaddingMode](../rsasignaturepaddingmode/) [get_Mode](./get_mode/)() const | 获取填充模式。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pkcs1](./get_pkcs1/)() | 获取 PKCS #1 v1.5 模式。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pss](./get_pss/)() | 获取 PSS 模式。 |
