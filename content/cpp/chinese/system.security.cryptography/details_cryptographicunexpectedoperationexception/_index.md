...
type: docs
weight: 118
url: /zh/system.security.cryptography/details_cryptographicunexpectedoperationexception/
---
## Details_CryptographicUnexpectedOperationException 类
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而不是共享指针）。允许在容器中切换指针到弱模式。 |
...
* 类 [Details_CryptographicException](../details_cryptographicexception/)
