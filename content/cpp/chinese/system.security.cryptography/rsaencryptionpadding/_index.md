...
description: RSA 加密或解密操作的填充模式和参数。
type: docs
weight: 482
url: /zh/system.security.cryptography/rsaencryptionpadding/
---
...
| 方法 | 描述 |
| --- | --- |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [CreateOaep](./createoaep/)(const [HashAlgorithmName](../hashalgorithmname/)\&) | 使用 OAEP 模式和指定的哈希算法创建 [RSAEncryptionPadding](./)。 |
...
| [RSAEncryptionPaddingMode](../rsaencryptionpaddingmode/) [get_Mode](./get_mode/)() const | 获取填充模式。 |
| const [HashAlgorithmName](../hashalgorithmname/)\& [get_OaepHashAlgorithm](./get_oaephashalgorithm/)() const | 获取 OAEP 使用的哈希算法。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_OaepSHA1](./get_oaepsha1/)() | 获取使用 [SHA1](../sha1/) 哈希算法的 OAEP 模式。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_OaepSHA256](./get_oaepsha256/)() | 获取使用 [SHA256](../sha256/) 哈希算法的 OAEP 模式。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_OaepSHA384](./get_oaepsha384/)() | 获取使用 [SHA384](../sha384/) 哈希算法的 OAEP 模式。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_OaepSHA512](./get_oaepsha512/)() | 获取使用 [SHA512](../sha512/) 哈希算法的 OAEP 模式。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_Pkcs1](./get_pkcs1/)() | 获取 PKCS #1 v1.5 模式。 |
