...
description: "加密对象标识符。此类的对象只能使用 System::MakeObject() 函数分配。绝不要在栈上或使用 new 操作符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 339
url: /zh/system.security.cryptography/oid/
---
## Oid 类
...
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromFriendlyName](./fromfriendlyname/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | 根据指定的 OID 可读名称创建 OID 对象。 |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromOidValue](./fromoidvalue/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | 根据指定的 OID 值创建 OID 对象。 |
| [String](../../system/string/) [get_FriendlyName](./get_friendlyname/)() const | 获取对象的用户友好名称。 |
| [String](../../system/string/) [get_Value](./get_value/)() const | 获取对象标识符字符串。 |
...
|  [Oid](./oid/)() | 默认构造函数。 |
|  [Oid](./oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](./)\>\&) | 拷贝构造函数。 |
|  [Oid](./oid/)(const [String](../../system/string/)\&) | 构造函数。 |
|  [Oid](./oid/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | 构造函数。 |
...
| void [set_FriendlyName](./set_friendlyname/)(const [String](../../system/string/)\&) | 设置对象的用户友好名称。 |
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | 设置对象标识符字符串。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而非共享指针）。允许在容器中将指针切换为弱引用模式。 |
