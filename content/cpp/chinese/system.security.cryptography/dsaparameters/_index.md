...
description: "DSA 算法参数的数据结构。此类型应在栈上分配，并通过值或引用传递给函数。切勿使用 System::SmartPtr 类来管理此类型的对象。"
type: docs
weight: 703
url: /zh/system.security.cryptography/dsaparameters/
---
## DSAParameters 结构体

[Data](../../system.data/) [DSA](../dsa/) 算法参数的结构体。此类型应在栈上分配，并通过值或引用传递给函数。切勿使用 [System::SmartPtr](../../system/smartptr/) 类来管理此类型的对象。
...
| 方法 | 说明 |
| --- | --- |
|  [DSAParameters](./dsaparameters/)() | 构造函数。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 仿照 C# 风格的浮点比较，两个 NaN 被视为相等，即使根据 IEC 60559:1989 NaN 不等于任何值，包括 NaN。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 仿照 C# 风格的浮点比较，两个 NaN 被视为相等，即使根据 IEC 60559:1989 NaN 不等于任何值，包括 NaN。 |
