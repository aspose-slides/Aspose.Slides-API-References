...
description: "用于非对称加密算法的抽象基类。此类的对象只能使用 System::MakeObject() 函数分配。不要在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 14
url: /zh/system.security.cryptography/asymmetricalgorithm/
---
## AsymmetricAlgorithm 类

抽象基类，用于非对称加密算法。此类的对象只能通过 [System::MakeObject()](../../system/makeobject/) 函数分配。不要在栈上或使用 new 操作符创建此类型的实例，因为这会导致运行时错误和/或断言失败。始终将此类包装在 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
...
| static [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](./)\> [Create](./create/)() | 创建默认算法。未实现。 |
| static [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](./)\> [Create](./create/)(const [String](../../system/string/)\&) | 按名称创建算法。未实现。 |
| void [Dispose](./dispose/)() override | 释放当前对象拥有的资源。 |
...
| virtual void [FromXmlString](./fromxmlstring/)([String](../../system/string/)) | 从 XML 字符串读取算法参数。 |
| virtual [String](../../system/string/) [get_KeyExchangeAlgorithm](./get_keyexchangealgorithm/)() | 获取要使用的密钥交换算法。 |
| virtual **int32_t** [get_KeySize](./get_keysize/)() | 获取密钥大小。 |
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[KeySizes](../keysizes/)\>\> [get_LegalKeySizes](./get_legalkeysizes/)() | 获取允许的密钥大小数组。 |
| virtual [String](../../system/string/) [get_SignatureAlgorithm](./get_signaturealgorithm/)() | 获取要使用的签名算法。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否是 targetType 描述的实例。相当于 C# 的 `is` 运算符。 |
...
| virtual void [set_KeySize](./set_keysize/)(**int32_t**) | 设置密钥大小。 |
...
| virtual [String](../../system/string/) [ToXmlString](./toxmlstring/)(**bool**) | 将算法参数写入 XML 字符串。 |
