...
description: "RSA 算法参数的数据结构。此类型应在栈上分配，并通过值或引用传递给函数。切勿使用 System::SmartPtr 类来管理此类型的对象。"
type: docs
weight: 768
url: /zh/system.security.cryptography/rsaparameters/
---
## RSAParameters 结构体


[Data](../../system.data/) 结构体用于 [RSA](../rsa/) 算法参数。此类型应在栈上分配，并通过值或引用传递给函数。切勿使用 [System::SmartPtr](../../system/smartptr/) 类来管理此类型的对象。
...
|  [RSAParameters](./rsaparameters/)() | 构造函数。 |
