...
description: 带访问运算符的字符串集合指针。
type: docs
weight: 40
url: /zh/system.collections.specialized/stringcollectionptr/
---
## StringCollectionPtr 类
...
| 方法 | 描述 |
| --- | --- |
| auto [begin](../../system/smartptr/begin/)() | 底层集合的[begin()](../../system/smartptr/begin/)方法的访问器。仅当 SmartPtr_ 是具有 [begin()](../../system/smartptr/begin/) 方法的特化类型时才编译。 |
| auto [begin](../../system/smartptr/begin/)() const | 底层集合的[begin()](../../system/smartptr/begin/)方法的访问器。仅当 SmartPtr_ 是具有 [begin()](../../system/smartptr/begin/) 方法的特化类型时才编译。 |
...
| std::enable_if_t<\!Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | 使用 dynamic_cast 将指针转换为派生类型。 |
| auto [cbegin](../../system/smartptr/cbegin/)() const | 底层集合的[cbegin()](../../system/smartptr/cbegin/)方法的访问器。仅当 SmartPtr_ 是具有 [cbegin()](../../system/smartptr/cbegin/) 方法的特化类型时才编译。 |
| auto [cend](../../system/smartptr/cend/)() const | 底层集合的[cend()](../../system/smartptr/cend/)方法的访问器。仅当 SmartPtr_ 是具有 [cend()](../../system/smartptr/cend/) 方法的特化类型时才编译。 |
...
| auto [end](../../system/smartptr/end/)() | 底层集合的[end()](../../system/smartptr/end/)方法的访问器。仅当 SmartPtr_ 是具有 [end()](../../system/smartptr/end/) 方法的特化类型时才编译。 |
| auto [end](../../system/smartptr/end/)() const | 底层集合的[end()](../../system/smartptr/end/)方法的访问器。仅当 SmartPtr_ 是具有 [end()](../../system/smartptr/end/) 方法的特化类型时才编译。 |
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | 检查指针是否指向除自身拥有对象之外的其他对象（由别名构造函数创建）。 |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&) | 对[SmartPtr](../../system/smartptr/)对象进行移动赋值，x 将不可再用。 |
...
| [System::String](../../system/string/)\& [operator[]](./operator[]/)(int) const | 访问函数。 |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | 移除指针的别名（由别名构造函数创建），并确保它在共享模式下管理或在弱模式下跟踪相同的指向对象。 |
| void [reset](../../system/smartptr/reset/)([Pointee_](../../system/smartptr/pointee_/) *) | 设置指向的对象。 |
| void [reset](../../system/smartptr/reset/)() | 将指针指向 nullptr。 |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | 拷贝构造[SmartPtr](../../system/smartptr/)对象，两个指针随后指向相同的对象。如允许，则执行类型转换。 |
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | 移动构造[SmartPtr](../../system/smartptr/)对象。如果两者模式相同，则实际交换两个指针，调用后 x 可能不可再用。 |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | 通过创建不同类型的新数组来转换引用数组的类型。如果在 C# 中有不受 C++ 支持的数组类型强制转换，则此方式有用。 |
...
|  [StringCollectionPtr](./stringcollectionptr/)() | 构造空指针。 |
|  [StringCollectionPtr](./stringcollectionptr/)(const [SharedPtr](../../system/sharedptr/)\<[StringCollection](../stringcollection/)\>\&) | 构造指向特定集合的指针。 |
