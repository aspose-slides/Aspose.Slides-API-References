...
description: "提供用于基于密码的身份验证方案的凭据。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装到 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 391
url: /zh/system.net/networkcredential/
---
## NetworkCredential 类

提供用于基于密码的身份验证方案的凭据。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装到 [System::SmartPtr](../../system/smartptr/) 指针中，并使用该指针将其作为参数传递给函数。
...
| [String](../../system/string/) [get_Domain](./get_domain/)() | 获取验证凭据的域。 |
| [String](../../system/string/) [get_Password](./get_password/)() | 获取密码。 |
| [String](../../system/string/) [get_UserName](./get_username/)() | 获取用户名。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](./)\> [GetCredential](./getcredential/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | 返回指定 URI 和身份验证类型的凭据。 |
| [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](./)\> [GetCredential](./getcredential/)([String](../../system/string/), **int32_t**, [String](../../system/string/)) override | 返回指定主机名、端口和身份验证类型的凭据。 |
...
|  [NetworkCredential](./networkcredential/)([String](../../system/string/), [String](../../system/string/)) | 构造一个新实例。 |
|  [NetworkCredential](./networkcredential/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | 构造一个新实例。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 按指定值减少共享引用计数。 |
| void [set_Domain](./set_domain/)([String](../../system/string/)) | 设置验证凭据的域。 |
| void [set_Password](./set_password/)([String](../../system/string/)) | 设置密码。 |
| void [set_UserName](./set_username/)([String](../../system/string/)) | 设置用户名。 |
...
* 类 [ICredentials](../icredentials/)
* 类 [ICredentialsByHost](../icredentialsbyhost/)
