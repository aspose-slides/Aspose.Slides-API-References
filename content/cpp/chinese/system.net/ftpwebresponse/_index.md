...
description: "虚拟类，使得可以将已翻译的代码与 FtpWebResponse 引用链接，但不执行它。该类不包含任何正确实现的成员。此类的对象应仅使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 183
url: /zh/system.net/ftpwebresponse/
---
## FtpWebResponse 类

虚拟类，使得可以将已翻译的代码与 [FtpWebResponse](./) 引用链接，但不执行它。  
不包含任何正确实现的成员。  
此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。  
切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。  
...
| **int64_t** [get_ContentLength](./get_contentlength/)() override | RTTI 信息。 |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | 未实现。 |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | 未实现。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | 未实现。 |
| virtual **bool** [get_SupportsHeaders](../webresponse/get_supportsheaders/)() | 返回一个值，指示当前响应是否支持标头。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。启用自定义对象的哈希。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() override | 未实现。 |
