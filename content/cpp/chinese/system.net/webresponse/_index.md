...
description: "表示一个 Web 响应。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 534
url: /zh/system.net/webresponse/
---
## WebResponse 类
...
| 方法 | 描述 |
| --- | --- |
| virtual void [Close](./close/)() | 关闭响应流。 |
| void [Dispose](./dispose/)() override | 什么也不做。 |
...
| virtual **int64_t** [get_ContentLength](./get_contentlength/)() | 返回资源的字节数。 |
| virtual [String](../../system/string/) [get_ContentType](./get_contenttype/)() | 返回资源的 MIME 类型。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() | 返回与当前响应关联的标头集合。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() | 返回资源的 URI。 |
| virtual **bool** [get_SupportsHeaders](./get_supportsheaders/)() | 返回指示当前响应是否支持标头的值。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() | 返回响应流。 |
