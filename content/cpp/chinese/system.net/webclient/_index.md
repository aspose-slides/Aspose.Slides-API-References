...
description: "WebClient 提供用于发送和接收数据的通用方法。该类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 469
url: /zh/system.net/webclient/
---
## WebClient 类
...
| 方法 | 描述 |
| --- | --- |
|  [Component](../../system.componentmodel/component/component/)() | RTTI 信息。 |
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | 可释放模式支持；不执行任何操作。 |
| [ByteArrayPtr](../../system/bytearrayptr/) [DownloadData](./downloaddata/)(const [String](../../system/string/)\&) const | 将指定资源下载为字节数组。 |
| [ByteArrayPtr](../../system/bytearrayptr/) [DownloadData](./downloaddata/)(const [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>\&) const | 将指定资源下载为字节数组。 |
| [String](../../system/string/) [DownloadString](./downloadstring/)(const [String](../../system/string/)\&) const | 将指定资源下载为字符串。 |
| [String](../../system/string/) [DownloadString](./downloadstring/)(const [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>\&) const | 将指定资源下载为字符串。 |
...
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | 检查组件是否处于设计模式。 |
| [SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\> [get_Encoding](./get_encoding/)() const | 获取用于下载或上传字符串的编码。 |
...
| void [set_Encoding](./set_encoding/)(const [SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>\&) | 设置用于下载或上传字符串的编码。 |
| void [set_UseDefaultCredentials](./set_usedefaultcredentials/)(**bool**) | 未实现。 |
...
|  [WebClient](./webclient/)() | 构造一个新实例。 |
| virtual  [~Object](../../system/object/~object/)() | 销毁对象。释放所有内部数据结构。 |
|  [~WebClient](./~webclient/)() | 析构当前实例。 |

## 另见

* 类 [Component](../../system.componentmodel/component/)
* 命名空间 [System::Net](../)
* 库 [Aspose.Slides](../../)