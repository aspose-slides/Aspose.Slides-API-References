...
description: "表示当 CookieContainer 的大小大于 MaxCookieSize 属性值时抛出的异常。切勿手动创建此类实例。请改用 CookieException 类。切勿将 CookieException 类实例包装到 System::SmartPtr 中。"
type: docs
weight: 79
url: /zh/system.net/details_cookieexception/
---
## Details_CookieException 类


表示在 [CookieContainer](../cookiecontainer/) 的大小大于 MaxCookieSize 属性值时抛出的异常。切勿手动创建此类的实例。请改用 CookieException 类。切勿将 CookieException 类的实例包装到 [System::SmartPtr](../../system/smartptr/) 中。
...
| Method | Description |
| --- | --- |
|  [Details_CookieException](./details_cookieexception/)() | 构造一个新实例。 |
|  [Details_CookieException](./details_cookieexception/)(std::nullptr_t) | 构造一个新实例。 |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/)) | 构造一个新实例。 |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/), [Exception](../../system/exception/)) | 构造一个新实例。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_formatexception/gettype/)() const override | 获取对象的实际类型。相当于 C# [System.Object.GetType()](../../system/object/gettype/) 调用。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类未从 std::exception 继承，但派生类可以使用受保护/私有成员来实现它们的逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
| virtual  [~Details_CookieException](./~details_cookieexception/)() | 析构当前实例。 |
| virtual  [~Object](../../system/object/~object/)() | 销毁对象。释放所有内部数据结构。 |

## 另请参见

* 类 [Details_FormatException](../../system/details_formatexception/)
* 命名空间 [System::Net](../)
* 库 [Aspose.Slides](../../)