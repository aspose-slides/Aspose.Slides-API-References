...
description: "带有嵌入键的元素的抽象集合。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 14
url: /zh/system.collections.objectmodel/keyedcollection/
---
## KeyedCollection 类

带有嵌入键的元素的抽象集合。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| 方法 | 描述 |
| --- | --- |
| void [Add](./add/)(const TItem\&) override | 将项目添加到容器末尾。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，无法使用此迭代器更改被引用的对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | 获取指向集合 const 限定实例中第一个元素（如果有）的迭代器。 |
...
| void [Clear](../collection/clear/)() override | 删除所有元素。 |
|  [Collection](../collection/collection/)() | 创建空集合。 |
|  [Collection](../collection/collection/)([SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) |  |
| **bool** [Contains](./contains/)(TKey) | 检查容器中是否存在指定键。 |
| **bool** [Contains](../collection/contains/)(const T\&) const override | 检查集合中是否存在指定项目。 |
| void [CopyTo](../collection/copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | 将集合元素复制到已有数组元素中。 |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crbegin](../collection/crbegin/)() const | 获取指向集合中最后一个 const 限定元素（逆序中的第一个）的反向迭代器。 |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crend](../collection/crend/)() const | 获取指向集合开始之前的非存在的 const 限定元素的反向迭代器。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，无法使用此迭代器更改被引用的对象。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 标准 NaN 与任何值（包括 NaN）都不相等，此比较仍将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 标准 NaN 与任何值（包括 NaN）都不相等，此比较仍将两个 NaN 视为相等。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\> [get_Comparer](./get_comparer/)() | 获取比较器。 |
| int [get_Count](../collection/get_count/)() const override | 获取元素数量。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](../collection/get_items/)() | 内部数据结构访问器。 |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](../collection/get_items/)() const | 内部数据结构访问器。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../collection/getenumerator/)() override | 获取用于遍历集合的枚举器。 |
...
| TItem [idx_get](./idx_get/)(TKey) | 获取特定索引处的项目。 |
| T [idx_get](../collection/idx_get/)(int) const override | 获取指定索引处的值。 |
| void [idx_set](../collection/idx_set/)(int, T) override | 设置指定索引处的值。 |
| int [IndexOf](../collection/indexof/)(const T\&) const override | 在集合中查找元素。 |
| void [Insert](../collection/insert/)(int, const T\&) override | 在指定位置插入项目。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | 判断序列是否包含任意元素。 |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 对通用序列的每个元素调用转换函数并返回得到的最大值。 |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 对通用序列的每个元素调用转换函数并返回得到的最小值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 按照 keySelector 选择的键值升序排序序列的元素。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 按照 keySelector 选择的键值降序排序序列的元素。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 投影序列的每个元素并将得到的序列组合成一个序列。 |
...
| T\& [operator[]](../collection/operator[]/)(int) | 获取指定索引处的值。 |
| const T\& [operator[]](../collection/operator[]/)(int) const | 获取指定索引处的值。 |
| [reverse_iterator](../collection/reverse_iterator/) [rbegin](../collection/rbegin/)() | 获取集合中最后一个元素的反向迭代器（逆序中的第一个）。 |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rbegin](../collection/rbegin/)() const | 获取 const 限定集合中最后一个元素的反向迭代器（逆序中的第一个）。 |
...
| **bool** [Remove](./remove/)(TKey) | 从容器中移除键。 |
| **bool** [Remove](../collection/remove/)(const T\&) override | 移除特定项目。 |
| void [RemoveAt](../collection/removeat/)(int) override | 移除指定位置的项目。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定值。 |
| [reverse_iterator](../collection/reverse_iterator/) [rend](../collection/rend/)() | 获取集合起始之前的非存在元素的反向迭代器。 |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rend](../collection/rend/)() const | 获取 const 限定集合起始之前的非存在元素的反向迭代器。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 将特定模板参数视为弱指针而非共享指针（如适用）。 |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../collection/virtualizebeginconstiterator/)() const override | 获取当前容器的 const begin 迭代器的实现。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../collection/virtualizebeginiterator/)() override | 获取当前容器的 begin 迭代器的实现。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../collection/virtualizeendconstiterator/)() const override | 获取当前容器的 const end 迭代器的实现。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../collection/virtualizeenditerator/)() override | 获取当前容器的 end 迭代器的实现。 |
