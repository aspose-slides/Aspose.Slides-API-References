...
description: "通用集合的基类型。此类的对象应仅使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为会导致运行时错误和/或断言故障。始终将此类包装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 1
url: /zh/system.collections.objectmodel/collection/
---
## 集合类

通用集合的基类型。此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 操作符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| 方法 | 描述 |
| --- | --- |
| void [Add](./add/)(const T\&) override | 向容器添加值。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。此迭代器不能用于更改引用对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的副本对象。 |
...
| **bool** [Contains](./contains/)(const T\&) const override | 检查集合中是否存在该项。 |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | 将集合元素复制到现有数组元素中。 |
| [const_reverse_iterator](./const_reverse_iterator/) [crbegin](./crbegin/)() const | 获取指向集合中最后一个 const 限定元素的反向迭代器（逆序中的第一个）。 |
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | 获取指向集合开始之前的非存在 const 限定元素的反向迭代器。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置的迭代器（如果有）。此迭代器不能用于更改引用对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的副本对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 获取指向 const 限定的集合实例中最后一个元素之后的位置的迭代器（如果有）。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | 内部数据结构访问器。 |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | 内部数据结构访问器。 |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | 获取集合通过其同步的对象。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | 获取用于遍历集合的枚举器。 |
...
| T [idx_get](./idx_get/)(int) const override | 获取指定索引处的值。 |
| void [idx_set](./idx_set/)(int, T) override | 设置指定索引处的值。 |
| int [IndexOf](./indexof/)(const T\&) const override | 在集合中查找元素。 |
| void [Insert](./insert/)(int, const T\&) override | 在指定位置插入项。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 对序列的每个元素进行投影并将生成的序列合并为一个序列。 |
...
| T\& [operator[]](./operator[]/)(int) | 获取指定索引处的值。 |
| const T\& [operator[]](./operator[]/)(int) const | 获取指定索引处的值。 |
| [reverse_iterator](./reverse_iterator/) [rbegin](./rbegin/)() | 获取指向集合中最后一个元素的反向迭代器（逆序中的第一个）。 |
| [const_reverse_iterator](./const_reverse_iterator/) [rbegin](./rbegin/)() const | 获取指向 const 限定集合中最后一个元素的反向迭代器（逆序中的第一个）。 |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | 通过引用比较对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | 通过引用比较对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | 将值类型对象与 nullptr 进行引用比较。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 在字符串和 nullptr 情形的专门化。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 在字符串情形的专门化。 |
| **bool** [Remove](./remove/)(const T\&) override | 移除特定项。 |
| void [RemoveAt](./removeat/)(int) override | 移除特定位置的项。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 按指定值减少共享引用计数。 |
| [reverse_iterator](./reverse_iterator/) [rend](./rend/)() | 获取指向集合开始之前的非存在元素的反向迭代器。 |
| [const_reverse_iterator](./const_reverse_iterator/) [rend](./rend/)() const | 获取指向 const 限定集合开始之前的非存在元素的反向迭代器。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 使存储的指针变为弱引用（如果适用）。 |
