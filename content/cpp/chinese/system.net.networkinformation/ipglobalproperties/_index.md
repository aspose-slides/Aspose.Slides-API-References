...
description: "表示本地计算机的网络连接信息。此类的对象只能使用 System::MakeObject() 函数进行分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 14
url: /zh/system.net.networkinformation/ipglobalproperties/
---
## IPGlobalProperties 类

表示本地计算机的网络连接信息。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数进行分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装为 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| virtual [String](../../system/string/) [get_DomainName](./get_domainname/)() | 返回本地计算机注册的域。 |
| virtual [String](../../system/string/) [get_HostName](./get_hostname/)() | 返回本地计算机的主机名。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[IPGlobalProperties](./)\> [GetIPGlobalProperties](./getipglobalproperties/)() | 构造一个新实例。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，仅初始化新对象并支持对派生类进行拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不复制任何内容，仅初始化新对象并支持对派生类进行拷贝构造。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 针对 string 与 nullptr 情形的 [Object::ReferenceEquals](../../system/object/referenceequals/) 专化。 |
