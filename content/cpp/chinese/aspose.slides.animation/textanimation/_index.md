...
| 方法 | 描述 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | 在当前序列的末尾向组文本动画的末尾添加新效果。仅当文本段落的计数大于或等于该组效果的计数时有效！ |
...
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | 文本动画的构建类型列表（例如 [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once）。读取 [Animation::BuildType](../buildtype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | 带或不带组的链接形状效果（null）。读取 [IEffect](../ieffect/)。 |
...
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | 文本动画的构建类型列表（例如 [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once）。写入 [Animation::BuildType](../buildtype/)。 |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | 带或不带组的链接形状效果（null）。写入 [IEffect](../ieffect/)。 |
...
* 类 [ITextAnimation](../itextanimation/)
