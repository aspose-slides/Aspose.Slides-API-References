...
| **float** [get_Value0](./get_value0/)() override | 定义偏移的第一个值。读取 **float**。 |
| **float** [get_Value1](./get_value1/)() override | 定义偏移的第二个值。读取 **float**。 |
| **float** [get_Value2](./get_value2/)() override | 定义偏移的第三个值。读取 **float**。 |
...
| void [set_Value0](./set_value0/)(**float**) override | 定义偏移的第一个值。写入 **float**。 |
| void [set_Value1](./set_value1/)(**float**) override | 定义偏移的第二个值。写入 **float**。 |
| void [set_Value2](./set_value2/)(**float**) override | 定义偏移的第三个值。写入 **float**。 |
