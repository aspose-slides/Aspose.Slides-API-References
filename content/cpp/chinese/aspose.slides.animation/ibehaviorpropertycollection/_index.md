...
| 方法 | 描述 |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | 向集合添加新属性。 |
| virtual void [Add](../../system.collections.generic/icollection/add/)(const T\&) | 向集合中添加元素。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，此迭代器不能用于更改所引用的对象。 |
...
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | 确定 [ICollection](../../system.collections.generic/icollection/) 是否包含特定值。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的迭代器（如果有）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，此迭代器不能用于更改所引用的对象。 |
...
| virtual int [get_Count](../../system.collections.generic/icollection/get_count/)() const | 获取集合中的元素数目。 |
...
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | 通过属性值在 [IList](../../system.collections.generic/ilist/) 中确定特定项的索引。 |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | 获取项目在容器中首次出现的索引。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | 在指定索引处向集合插入具有指定属性值的新属性。 |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | 在指定位置插入元素，后面的元素向后移动。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | 根据指定的谓词筛选序列。 |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | 从集合中移除指定属性。 |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | 从集合中删除元素。 |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | 移除指定索引处的元素。 |
