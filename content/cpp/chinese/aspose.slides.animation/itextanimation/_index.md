...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | 将新效果添加到当前序列的末尾，以结束组文本动画。仅当文本段落的计数大于或等于该组效果的计数时有效！ |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | 文本动画的构建类型列表（例如 [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once）。读取 [BuildType](../buildtype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | 带或不带组的链接形状效果（null）。读取 [IEffect](../ieffect/)。 |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | 文本动画的构建类型列表（例如 [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once）。写入 [BuildType](../buildtype/)。 |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | 带或不带组的链接形状效果（null）。写入 [IEffect](../ieffect/)。 |
