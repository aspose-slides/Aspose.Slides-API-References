...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | 返回指定索引处的交互序列。此序列可能仅包含通过 \"click on shape\" 指定目标形状的效果。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequenceCollection](../isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() override | 返回交互序列的集合。此序列可能仅包含通过 \"click on shape\" 指定目标形状的效果。只读 [ISequenceCollection](../isequencecollection/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | 返回主序列，该序列可能仅包含主效果集合。只读 [ISequence](../isequence/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | 返回主序列中指定索引处的效果。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | 返回指定索引处的文本动画。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | 返回文本动画的集合。只读 [ITextAnimationCollection](../itextanimationcollection/)。 |
...
* 类 [IAnimationTimeLine](../../aspose.slides/ianimationtimeline/)
