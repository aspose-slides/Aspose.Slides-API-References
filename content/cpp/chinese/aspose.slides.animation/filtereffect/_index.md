...
| [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() override | 表示带有行为的效果必须呈现（in/out）。读取 [FilterEffectRevealType](../filtereffectrevealtype/)。 |
| [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() override | 表示过滤效果的子类型。读取 [FilterEffectSubtype](../filtereffectsubtype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | 表示效果行为的计时属性。读取 [ITiming](../itiming/)。 |
| [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() override | 表示过滤效果的类型。读取 [FilterEffectType](../filtereffecttype/)。 |
...
| void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) override | 表示带有行为的效果必须呈现（in/out）。写入 [FilterEffectRevealType](../filtereffectrevealtype/)。 |
| void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) override | 表示过滤效果的子类型。写入 [FilterEffectSubtype](../filtereffectsubtype/)。 |
...
| void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) override | 表示过滤效果的类型。写入 [FilterEffectType](../filtereffecttype/)。 |
