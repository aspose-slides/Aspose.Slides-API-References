...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | 添加新的交互式序列。 |
...
| virtual void [Clear](./clear/)() | 从集合中移除所有序列。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，此迭代器不能用于更改被引用的对象。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | 返回集合中元素的数量，只读 **int32_t**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) | 返回指定索引处的序列。 |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) | 从集合中移除指定的序列。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除指定索引处的序列。 |
