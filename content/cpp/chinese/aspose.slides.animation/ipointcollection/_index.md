...
| 方法 | 描述 |
| --- | --- |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，所以该迭代器不能用于修改引用的对象。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置（如果有）的迭代器。因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，所以该迭代器不能用于修改引用的对象。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | 返回集合中点的数量。只读 **int32_t**。 |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# 的 [Object.GetHashCode()](../../system/object/gethashcode/) 方法。用于对自定义对象进行哈希。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPoint](../ipoint/)\> [idx_get](./idx_get/)(**int32_t**) | 返回指定索引处的点。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而非共享）。允许将容器中的指针切换为弱模式。 |
