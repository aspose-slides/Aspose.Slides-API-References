...
description: 检查指定的代码是否等于 'VersionMismatch' SOAP 故障代码。
type: docs
weight: 144
url: /zh/system.web.services.protocols/details_soapexception/isversionmismatchfaultcode/
---
## 详细信息_SoapException::IsVersionMismatchFaultCode(System::SharedPtr\<Xml::XmlQualifiedName\>) 方法

检查指定的代码是否等于 'VersionMismatch' SOAP 故障代码。
...
当指定的代码等于 'VersionMismatch' SOAP 故障代码时返回 True，否则返回 false。
