...
description: 检查指定的代码是否等于 'Client' SOAP 故障代码。
type: docs
weight: 105
url: /zh/system.web.services.protocols/details_soapexception/isclientfaultcode/
---
## 详细信息_SoapException::IsClientFaultCode(System::SharedPtr<Xml::XmlQualifiedName>) 方法

检查指定的代码是否等于 'Client' SOAP 故障代码。
...
当指定的代码等于 'Client' SOAP 故障代码时返回 true，否则返回 false。
