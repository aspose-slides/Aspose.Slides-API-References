...
description: 检查指定的代码是否等于 'MustUnderstand' SOAP 故障代码。
type: docs
weight: 118
url: /zh/system.web.services.protocols/details_soapexception/ismustunderstandfaultcode/
---
## Details_SoapException::IsMustUnderstandFaultCode(System::SharedPtr\<Xml::XmlQualifiedName\>) 方法

检查指定的代码是否等于 'MustUnderstand' SOAP 故障代码。
...
当指定的代码等于 'MustUnderstand' SOAP 故障代码时返回 True，否则返回 false。
