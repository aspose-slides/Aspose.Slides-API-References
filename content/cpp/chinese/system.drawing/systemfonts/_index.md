...
description: 提供一组预先创建的 Font 对象，这些对象表示用于在 Windows 显示元素中显示文本的字体。这是一个静态类型，没有实例服务。绝不应以任何方式创建其实例。
type: docs
weight: 339
url: /zh/system.drawing/systemfonts/
---
## SystemFonts 类

提供一组预先创建的 [Font](../font/) 对象，这些对象表示用于在 [Windows](../../system.windows/) 显示元素中显示文本的字体。这是一个静态类型，没有实例服务。绝不应以任何方式创建其实例。
...
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_CaptionFont](./get_captionfont/)() | 未实现。 |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | 返回一个 [Font](../font/) 对象，表示应用程序可用于对话框和表单的默认字体。 |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_IconTitleFont](./get_icontitlefont/)() | 未实现。 |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MenuFont](./get_menufont/)() | 未实现。 |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MessageBoxFont](./get_messageboxfont/)() | 未实现。 |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_SmallCaptionFont](./get_smallcaptionfont/)() | 未实现。 |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_StatusFont](./get_statusfont/)() | 未实现。 |
