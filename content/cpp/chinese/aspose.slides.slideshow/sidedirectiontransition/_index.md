...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | 过渡方向。读取 [TransitionSideDirectionType](../transitionsidedirectiontype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 充当特定类型的散列函数，可用于散列算法和诸如散列表的数据结构。 |
...
* 类 [ISideDirectionTransition](../isidedirectiontransition/)
