...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | 过渡方向。请参阅 [TransitionSideDirectionType](../transitionsidedirectiontype/)。 |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | 指定过渡期间使用的视觉形状。请参阅 [TransitionPattern](../transitionpattern/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 充当特定类型的哈希函数，可用于哈希算法和哈希表等数据结构。 |
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | 过渡方向。写入 [TransitionSideDirectionType](../transitionsidedirectiontype/)。 |
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | 指定过渡期间使用的视觉形状。写入 [TransitionPattern](../transitionpattern/)。 |
...
* 类 [IGlitterTransition](../iglittertransition/)
