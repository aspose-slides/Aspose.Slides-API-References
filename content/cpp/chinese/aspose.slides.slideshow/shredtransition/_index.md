...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 过渡方向。读取 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | 指定过渡期间使用的视觉形状。读取 [TransitionShredPattern](../transitionshredpattern/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作为特定类型的哈希函数，适用于哈希算法和哈希表等数据结构。 |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 过渡方向。写入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | 指定过渡期间使用的视觉形状。写入 [TransitionShredPattern](../transitionshredpattern/)。 |
...
* 类 [IShredTransition](../ishredtransition/)
