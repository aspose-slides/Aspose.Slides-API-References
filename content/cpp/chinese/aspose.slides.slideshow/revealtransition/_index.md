...
| [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() override | 转换方向。读取 [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)。 |
| **bool** [get_ThroughBlack](./get_throughblack/)() override | 指定转换是否淡入淡出黑色。读取 **bool**。 |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | 转换方向。写入 [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)。 |
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | 指定转换是否淡入淡出黑色。写入 **bool**。 |
...
* 类 [IRevealTransition](../irevealtransition/)
