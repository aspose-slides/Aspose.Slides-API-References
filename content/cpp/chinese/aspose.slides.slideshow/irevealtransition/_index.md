...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | 转换方向。读取 [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)。 |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | 指定转换是否淡入淡出至黑色。读取 **bool**。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | 转换方向。写入 [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)。 |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | 指定转换是否淡入淡出至黑色。写入 **bool**。 |
