...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 过渡效果的方向。读取 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作为特定类型的哈希函数，适用于哈希算法和诸如哈希表的数据结构。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上什么也不复制，仅初始化新对象并支持子类的拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上什么也不复制，仅初始化新对象并支持子类的拷贝构造。 |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 过渡效果的方向。写入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
...
* 类 [IInOutTransition](../iinouttransition/)
