...
---
## ILeftRightDirectionTransition 类
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | 过渡方向。阅读 [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上不复制任何内容，只是初始化新对象，并支持子类的复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不复制任何内容，只是初始化新对象，并支持子类的复制构造。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | 过渡方向。写入 [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)。 |
