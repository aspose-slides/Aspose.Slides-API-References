...
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | 指定过渡期间使用的视觉形状。读取 [TransitionPattern](../transitionpattern/)。 |
...
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | 指定过渡期间使用的视觉形状。写入 [TransitionPattern](../transitionpattern/)。 |
