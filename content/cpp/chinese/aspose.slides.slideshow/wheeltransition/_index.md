...
| **uint32_t** [get_Spokes](./get_spokes/)() override | 轮转过渡的辐条数量。读取 **uint32_t**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作为特定类型的哈希函数，适用于哈希算法和类似哈希表的数据结构。 |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | 轮转过渡的辐条数量。写入 **uint32_t**。 |
...
* 类 [IWheelTransition](../iwheeltransition/)
