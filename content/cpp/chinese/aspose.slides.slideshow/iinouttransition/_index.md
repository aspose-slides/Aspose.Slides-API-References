...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 过渡效果的方向。阅读 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减指定的值。 |
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 过渡效果的方向。写入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
