...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | 此属性指定过渡是否从黑屏开始（随后在黑屏上过渡到新幻灯片）。读取 **bool**。 |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | 此属性指定过渡是否从黑屏开始（随后在黑屏上过渡到新幻灯片）。写入 **bool**。 |
