...
| [Orientation](../../aspose.slides/orientation/) [get_Direction](./get_direction/)() override | 过渡方向。读取 [Orientation](../../aspose.slides/orientation/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否表示目标类型描述的实例。相当于 C# 的 'is' 操作符。 |
...
| void [set_Direction](./set_direction/)([Orientation](../../aspose.slides/orientation/)) override | 过渡方向。写入 [Orientation](../../aspose.slides/orientation/)。 |
...
* 类 [IOrientationTransition](../iorientationtransition/)
