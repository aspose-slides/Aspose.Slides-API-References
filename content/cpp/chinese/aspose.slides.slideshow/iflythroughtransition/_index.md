...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 过渡的方向。阅读 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| virtual **bool** [get_HasBounce](./get_hasbounce/)() | 指定在过渡期间演示幻灯片的移动包含弹跳。读取 **bool**。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 过渡的方向。写入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| virtual void [set_HasBounce](./set_hasbounce/)(**bool**) | 指定在过渡期间演示幻灯片的移动包含弹跳。写入 **bool**。 |
