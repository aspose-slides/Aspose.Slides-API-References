...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定这两个 [TransitionValueBase](../transitionvaluebase/) 实例是否相等。 |
...
| **bool** [get_FromBlack](./get_fromblack/)() override | 此属性指定过渡是否从黑屏开始（随后在黑屏上过渡到新幻灯片）。读取 **bool**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作为特定类型的哈希函数，可用于哈希算法和散列表等数据结构。 |
...
| void [set_FromBlack](./set_fromblack/)(**bool**) override | 此属性指定过渡是否从黑屏开始（随后在黑屏上过渡到新幻灯片）。写入 **bool**。 |
...
* 类 [IOptionalBlackTransition](../ioptionalblacktransition/)
