...
description: Fly-through 幻灯片过渡效果。
type: docs
weight: 40
...
| **bool** [get_HasBounce](./get_hasbounce/)() override | 指定在过渡期间演示文稿幻灯片的移动包含弹跳。读取 **bool**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 充当特定类型的哈希函数，适用于哈希算法和诸如哈希表的数据结构。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，仅初始化新对象并允许子类的复制构造。 |
...
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | 指定在过渡期间演示文稿幻灯片的移动包含弹跳。写入 **bool**。 |
...
* 类 [IFlyThroughTransition](../iflythroughtransition/)
