...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 过渡拆分的方向。阅读 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| virtual [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() | 过渡拆分的方向。阅读 [Slides::Orientation](../../aspose.slides/orientation/)。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 过渡拆分的方向。写入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) | 过渡拆分的方向。写入 [Slides::Orientation](../../aspose.slides/orientation/)。 |
