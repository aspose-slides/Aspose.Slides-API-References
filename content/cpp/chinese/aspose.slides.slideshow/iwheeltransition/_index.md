...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | 轮转的辐条数量。读取 **uint32_t**。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上什么也不复制，只是初始化新对象并允许复制构造子类。 |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | 轮转的辐条数量。写入 **uint32_t**。 |
