...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 过渡方向。阅读 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | 指定过渡期间使用的视觉形状。阅读 [TransitionShredPattern](../transitionshredpattern/)。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 过渡方向。写入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | 指定过渡期间使用的视觉形状。写入 [TransitionShredPattern](../transitionshredpattern/)。 |
