...
description: 定时器事件的参数。
type: docs
weight: 1
url: /zh/system.timers/elapsedeventargs/
---
## ElapsedEventArgs 类
...
| 方法 | 描述 |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | 使用给定参数构造参数对象。 |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | 获取信号时间。 |
