...
description: 在循环中调用委托的计时器。
type: docs
weight: 14
url: /zh/system.timers/timer/
---
## Timer 类
...
| Method | 描述 |
| --- | --- |
| void [Close](./close/)() | 停止计时器，释放已分配的资源。 |
|  [Component](../../system.componentmodel/component/component/)() | RTTI 信息。 |
| void [Dispose](./dispose/)() | 停止计时器，释放已分配的资源。 |
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | 支持可释放模式；什么也不做。 |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | 检查计时器是否处于自动重置模式。 |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | 检查组件是否处于设计模式。 |
| **bool** [get_Enabled](./get_enabled/)() const | 检查计时器是否处于活动状态。 |
| **double** [get_Interval](./get_interval/)() const | 获取计时器间隔。 |
| **bool** [get_IsStopped](./get_isstopped/)() const | 检查计时器是否已停止。 |
...
| void [Lock](../../system/object/lock/)() | 实现 C# lock() 语句锁定。直接调用或使用 [LockContext](../../system/lockcontext/) 监视对象。 |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | 将计时器设置为自动重置模式或取消该模式。 |
| void [set_Enabled](./set_enabled/)(**bool**) | 启动或停止计时器。如果计时器已经在执行，启动计时器不会重新计时。 |
| void [set_Interval](./set_interval/)(**double**) | 设置计时器间隔。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而非共享指针）。允许在容器中将指针切换为弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 获取共享引用计数器的当前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 递增共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 递减并返回共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| void [Start](./start/)() | 启动计时器。如果计时器已经在执行，则不会重新计时。 |
| void [Stop](./stop/)() | 停止计时器。 |
|  [Timer](./timer/)() | RTTI 信息。 |
|  [Timer](./timer/)(**double**) | 使用指定间隔构造已停止的计时器。 |
