...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 获取线条的刷子颜色。 |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | 获取墨水效果类型（例如，Galaxy、Gold、Silver），该类型定义墨迹的视觉样式。该值从刷子属性 "inkEffects" 解析。如果未指定已识别的效果，则返回 [InkEffectType::NotDefined](../inkeffecttype/)。 |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | 获取线条的刷子大小（单位为点）。 |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | 设置线条的刷子颜色。 |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | 设置线条的刷子大小（单位为点）。 |
