...
type: docs
weight: 131
url: /zh/system.io/details_directorynotfoundexception/
---
## Details_DirectoryNotFoundException 类
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法被 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类未从 std::exception 派生，派生类仍可使用受保护/私有成员实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
