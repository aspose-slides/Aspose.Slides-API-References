...
description: "表示一个幻影数学对象 (<m:phant>)，它会影响子元素的布局，但不一定显示。幻影可以隐藏其基表达式，同时保留其宽度、高度或深度，以对齐公式或保留空间。可见性和几何行为由诸如 Show、ZeroWid、ZeroAsc、ZeroDesc 和 Transp 等属性控制。"
type: docs
weight: 1028
...
表示一个幻影数学对象 (<m:phant>)，它会影响子元素的布局，但不一定显示出来。幻影可以隐藏其基表达式，同时保留其宽度、高度或深度，以对齐公式或保留空间。可见性和几何行为由诸如 Show、ZeroWid、ZeroAsc、ZeroDesc 和 Transp 等属性控制。
...
| **bool** [get_Show](./get_show/)() override | 获取一个值，指示基元素是否显示 |
| **bool** [get_Transp](./get_transp/)() override | 获取一个值，指示幻影在基于类的间距规则下是否透明 |
| **bool** [get_ZeroAsc](./get_zeroasc/)() override | 获取一个值，指示是否应将基元素的上升（基线以上的高度）视为零 |
| **bool** [get_ZeroDesc](./get_zerodesc/)() override | 获取一个值，指示是否应将基元素的下降（基线以下的深度）视为零 |
| **bool** [get_ZeroWidth](./get_zerowidth/)() override | 获取一个值，指示是否应将基元素的宽度视为零 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)() override | 使用底部大括号将此元素放入分组 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | 使用分组字符（如底部大括号或其他）将此元素放入分组 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../mathelementbase/integral/)([MathIntegralTypes](../mathintegraltypes/)) override | 获取积分 |
...
|  [MathPhantom](./mathphantom/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 使用指定的基础数学元素初始化 [MathPhantom](./) 类的新实例 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 指定给定次数的数学根号，取自指定参数 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | 指定给定次数的数学根号，取自指定参数 |
...
| void [set_Show](./set_show/)(**bool**) override | 设置一个值，指示基元素是否显示 |
| void [set_Transp](./set_transp/)(**bool**) override | 设置一个值，指示幻影在基于类的间距规则下是否透明 |
| void [set_ZeroAsc](./set_zeroasc/)(**bool**) override | 设置一个值，指示是否应将基元素的上升（基线以上的高度）视为零 |
| void [set_ZeroDesc](./set_zerodesc/)(**bool**) override | 设置一个值，指示是否应将基元素的下降（基线以下的深度）视为零 |
| void [set_ZeroWidth](./set_zerowidth/)(**bool**) override | 设置一个值，指示是否应将基元素的宽度视为零 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)() override | 将此元素放入边框盒 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | 将此元素放入边框盒 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | 将此元素放入非可视盒（逻辑分组），用于对方程或其他数学文本实例的组件进行分组。例如，盒装对象可以作为带或不带对齐点的运算符仿真器，作为换行点，或进行分组以防止内部换行 |
...
phantom->set_ZeroWidth(false); // 保留宽度
```

## 另请参阅

* 类 [MathElementBase](../mathelementbase/)
* 类 [IMathPhantom](../imathphantom/)
