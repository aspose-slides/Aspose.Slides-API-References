...
| 方法 | 描述 |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 将 [IMathBlock](../imathblock/) 添加到集合的末尾。 |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 确定集合是否包含特定值。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，无法使用此迭代器更改被引用的对象。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) | 获取指定索引处的项。只读 [IMathBlock](../imathblock/)。 |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 获取指定索引处的项。只读 [IMathBlock](../imathblock/)。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 确定集合中特定 [IMathBlock](../imathblock/) 的索引。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 在指定索引处向集合插入 [IMathBlock](../imathblock/)。 |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 从集合中移除特定对象的第一次出现/>. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除集合中指定索引处的项目。 |
