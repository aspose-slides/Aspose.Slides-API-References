...
| 方法 | 描述 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [CreateMathBar](./createmathbar/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 通过将其应用于元素来创建数学栏 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [CreateMathBar](./createmathbar/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathTopBotPositions](../mathtopbotpositions/)) override | 通过将其应用于元素来创建数学栏 |
...
| void [Lock](../../system/object/lock/)() | 实现 C# lock() 语句的锁定。可直接调用，也可使用 [LockContext](../../system/lockcontext/) 监视对象。 |
...
| void [Unlock](../../system/object/unlock/)() | 实现 C# lock() 语句的解锁。可直接调用，也可使用 [LockContext](../../system/lockcontext/) 监视对象。 |
...
* 类 [IMathBarFactory](../imathbarfactory/)
