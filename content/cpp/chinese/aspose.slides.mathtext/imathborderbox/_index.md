...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | 设置重音符号（此元素顶部的字符） |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | 用括号将数学元素括起来 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点数比较，即使根据 IEC 60559:1989，NaN 与任何值（包括 NaN）均不相等，也将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点数比较，即使根据 IEC 60559:1989，NaN 与任何值（包括 NaN）均不相等，也将两个 NaN 视为相等。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 使用此实例作为函数名，接受参数的函数 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | 使用此实例作为函数名，接受参数的函数 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | 基础参数 |
| virtual **bool** [get_HideBottom](./get_hidebottom/)() | 隐藏底部边缘（默认 false）- 指定边框盒底部边缘的隐藏或显示状态。 |
| virtual **bool** [get_HideLeft](./get_hideleft/)() | 隐藏左部边缘（默认 false）- 指定边框盒左部边缘的隐藏或显示状态。 |
| virtual **bool** [get_HideRight](./get_hideright/)() | 隐藏右部边缘（默认 false）- 指定边框盒右部边缘的隐藏或显示状态。 |
| virtual **bool** [get_HideTop](./get_hidetop/)() | 隐藏顶部边缘（默认 false）- 指定边框盒顶部边缘的隐藏或显示状态。 |
| virtual **bool** [get_StrikethroughBottomLeftToTopRight](./get_strikethroughbottomlefttotopright/)() | 从左下到右上加删除线（默认 false）。指定边框盒左下角到右上角对角线删除线的隐藏或显示状态。 |
| virtual **bool** [get_StrikethroughHorizontal](./get_strikethroughhorizontal/)() | 水平删除线（默认 false）- 指定水平删除线的隐藏或显示状态。 |
| virtual **bool** [get_StrikethroughTopLeftToBottomRight](./get_strikethroughtoplefttobottomright/)() | 从左上到右下加删除线（默认 false）。指定边框盒左上角到右下角对角线删除线的隐藏或显示状态。 |
| virtual **bool** [get_StrikethroughVertical](./get_strikethroughvertical/)() | 垂直删除线（默认 false）- 指定垂直删除线的隐藏或显示状态。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 获取积分 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/)) | 获取积分 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/), [System::String](../../system/string/), [System::String](../../system/string/), [MathLimitLocations](../mathlimitlocations/)) | 获取积分 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/), [System::String](../../system/string/), [System::String](../../system/string/)) | 获取积分 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 指定给定次数的数学根号，基于指定参数。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | 指定给定次数的数学根号，基于指定参数。 |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | 按引用比较对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | 按引用比较对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | 将值类型对象与 nullptr 进行引用比较。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化，适用于字符串和 nullptr 的情况。 |
...
| virtual void [set_HideBottom](./set_hidebottom/)(**bool**) | 隐藏底部边缘（默认 false）- 指定边框盒底部边缘的隐藏或显示状态。 |
| virtual void [set_HideLeft](./set_hideleft/)(**bool**) | 隐藏左部边缘（默认 false）- 指定边框盒左部边缘的隐藏或显示状态。 |
| virtual void [set_HideRight](./set_hideright/)(**bool**) | 隐藏右部边缘（默认 false）- 指定边框盒右部边缘的隐藏或显示状态。 |
| virtual void [set_HideTop](./set_hidetop/)(**bool**) | 隐藏顶部边缘（默认 false）- 指定边框盒顶部边缘的隐藏或显示状态。 |
| virtual void [set_StrikethroughBottomLeftToTopRight](./set_strikethroughbottomlefttotopright/)(**bool**) | 从左下到右上加删除线（默认 false）。指定边框盒左下角到右上角对角线删除线的隐藏或显示状态。 |
| virtual void [set_StrikethroughHorizontal](./set_strikethroughhorizontal/)(**bool**) | 水平删除线（默认 false）- 指定水平删除线的隐藏或显示状态。 |
| virtual void [set_StrikethroughTopLeftToBottomRight](./set_strikethroughtoplefttobottomright/)(**bool**) | 从左上到右下加删除线（默认 false）。指定边框盒左上角到右下角对角线删除线的隐藏或显示状态。 |
| virtual void [set_StrikethroughVertical](./set_strikethroughvertical/)(**bool**) | 垂直删除线（默认 false）- 指定垂直删除线的隐藏或显示状态。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](./)\> [ToBorderBox](../imathelement/toborderbox/)() | 将此元素放入边框盒中 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](./)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | 将此元素放入边框盒中 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 将此元素放入非可视盒（逻辑分组）中，用于对方程或其他数学文本的组件进行分组。盒装对象可以（例如）充当带或不带对齐点的运算符仿真，充当换行点，或分组以防止在内部换行。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](../imatharray/)\> [ToMathArray](../imathelement/tomatharray/)() | 放入垂直阵列 |
