...
| 方法 | 描述 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [CreateMathRadical](./createmathradical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 创建数学根式 |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。使自定义对象能够进行哈希。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 设置第 n 个模板参数为弱指针（而非共享指针）。允许在容器中将指针切换为弱模式。 |
...
* 类 [IMathRadicalFactory](../imathradicalfactory/)
