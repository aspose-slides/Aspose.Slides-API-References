...
description: 指定根号函数，由基数和可选的指数构成。根号对象的示例为 \\u221A\\uD835\\uDC65。
type: docs
weight: 508
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 使用此实例作为函数名，获取一个以该实例为参数的函数 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | 使用此实例作为函数名，获取一个以该实例为参数的函数 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | 基数参数 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() | 指数参数 |
| virtual **bool** [get_HideDegree](./get_hidedegree/)() | 隐藏指数；当为 true 时，不显示指数，例如 \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 指定给定指数的数学根，来源于指定的参数。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | 指定给定指数的数学根，来源于指定的参数。 |
...
| virtual void [set_HideDegree](./set_hidedegree/)(**bool**) | 隐藏指数；当为 true 时，不显示指数，例如 \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 将此元素放入非可视盒（逻辑分组），用于对方程或其他数学文本的组件进行分组。该盒对象可（例如）用作带或不带对齐点的运算符模拟器，作为换行点，或进行分组以防止在内部换行。 |
