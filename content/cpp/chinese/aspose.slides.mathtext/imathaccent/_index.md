...
description: "指定重音函数，由基础字符和组合变音符号组成 示例： \\uD835\\uDC4E\\u0301"
type: docs
weight: 27
...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](./)\> [Accent](../imathelement/accent/)(char16_t) | 设置重音标记（此元素顶部的字符） |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 使用此实例作为函数名称获取参数的函数 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | 使用此实例作为函数名称获取参数的函数 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | 重音应用的参数 |
| virtual char16_t [get_Character](./get_character/)() | 重音字符 该值应在 (U+0300\\u2013U+036F) 或 (U+20D0\\u2013U+20EF) 范围内 默认值：结合抑扬音 (U+0302) |
...
| virtual void [set_Character](./set_character/)(char16_t) | 重音字符 该值应在 (U+0300\\u2013U+036F) 或 (U+20D0\\u2013U+20EF) 范围内 默认值：结合抑扬音 (U+0302) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 将此元素放入非可视盒（逻辑分组），用于对方程或其他数学文本实例的组件进行分组。盒装对象可（例如）作为带或不带对齐点的运算符仿真器，作为换行点，或被分组以防止内部换行。 |
