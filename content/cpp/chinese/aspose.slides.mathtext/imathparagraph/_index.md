...
表示数学块容器的数学段落（[IMathBlock](../imathblock/)）
...
| 方法 | 描述 |
| --- | --- |
| virtual void [Add](../imathblockcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 将 [IMathBlock](../imathblock/) 添加到集合的末尾。 |
...
| virtual void [Clear](../imathblockcollection/clear/)() | 从集合中移除所有元素。 |
| virtual **bool** [Contains](../imathblockcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 确定集合是否包含特定值。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的迭代器（如果有）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，无法使用此迭代器更改所引用的对象。 |
...
| virtual **int32_t** [get_Count](../imathblockcollection/get_count/)() | 获取集合实际包含的元素数量。只读 **int32_t**。 |
| virtual [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() | [Paragraph](../../aspose.slides/paragraph/) 对齐 默认值：CenteredAsGroup |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# 的 [Object.GetHashCode()](../../system/object/gethashcode/) 方法。支持自定义对象的散列。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](../imathblockcollection/idx_get/)(**int32_t**) | 获取指定索引处的项。只读 [IMathBlock](../imathblock/)。 |
| virtual void [idx_set](../imathblockcollection/idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 获取指定索引处的项。只读 [IMathBlock](../imathblock/)。 |
| virtual **int32_t** [IndexOf](../imathblockcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 确定集合中特定 [IMathBlock](../imathblock/) 的索引。 |
| virtual void [Insert](../imathblockcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 在指定索引处向集合中插入 [IMathBlock](../imathblock/)。 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否代表 targetType 描述的类型实例。相当于 C# 的 'is' 运算符。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，仅初始化新对象并允许在子类中进行拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不复制任何内容，仅初始化新对象并允许在子类中进行拷贝构造。 |
...
| virtual **bool** [Remove](../imathblockcollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | 从集合中移除特定对象的首次出现/>。 |
| virtual void [RemoveAt](../imathblockcollection/removeat/)(**int32_t**) | 移除集合中指定索引处的项。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定值。 |
| virtual void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) | [Paragraph](../../aspose.slides/paragraph/) 对齐 默认值：CenteredAsGroup |
...
| virtual [System::String](../../system/string/) [ToLatex](./tolatex/)() | 获取 LaTeX 格式的数学方程式 |
...
| virtual void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | 将此 [IMathParagraph](./) 的内容保存为 MathML。 |
...
* 类 [IMathBlockCollection](../imathblockcollection/)
