...
description: 用于在导入 Html、Svg 文档期间解析外部资源的回调类。
type: docs
weight: 14
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) override | 将 URI 映射到包含实际资源的对象。 |
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 解析基 URI 和相对 URI 合成的绝对 URI。 |
...
使用此解析器可能会导致漏洞，因为客户端提供的 HTML 或 SVG 文件可能使服务器软件获取本地或网络文件。请谨慎使用。建议完全不指定 [ExternalResourceResolver](./)（仅读取嵌入的对象），或创建一个子类来检查指定的 uri 是否有效。

## 另请参见

* 类 [IExternalResourceResolver](../iexternalresourceresolver/)
