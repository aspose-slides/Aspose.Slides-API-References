...
description: 用于 HTML 导入例程获取图像等引用对象的回调接口。
type: docs
weight: 53
url: /zh/aspose.slides.import/ihtmlexternalresolver/
---

## IHtmlExternalResolver 类

Callback 接口用于 HTML 导入例程获取如图像等引用对象。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | 将 URI 映射到包含实际资源的对象。 |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | 从基 URI 和相对 URI 解析出绝对 URI。 |
...
已弃用
:   已过时。使用 [IExternalResourceResolver](../iexternalresourceresolver/) 替代。将在 17.12 发行版中移除。
