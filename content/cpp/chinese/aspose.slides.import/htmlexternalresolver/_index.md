...
description: HTML 导入例程使用的回调对象，用于获取诸如图像之类的引用对象。
type: docs
weight: 27
url: /zh/aspose.slides.import/htmlexternalresolver/
---
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 从基准和相对 URI 解析出绝对 URI。 |
...
已弃用
:   已过时。使用 [ExternalResourceResolver](../externalresourceresolver/) 替代。将在 17.12 版中移除。

使用此解析器可能会在客户端提供的 HTML 文件导致服务器软件获取本地或网络文件时产生漏洞。请谨慎使用。建议完全不指定 [HtmlExternalResolver](./)（仅读取嵌入的对象），或创建检查指定 URI 是否有效的子类。

## 另请参见

* 类 [IHtmlExternalResolver](../ihtmlexternalresolver/)
