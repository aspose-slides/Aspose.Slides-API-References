...
description: 提供对选定节点集合的迭代器。
type: docs
weight: 79
url: /zh/system.xml.xpath/xpathnodeiterator/
---
## XPathNodeIterator 类
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | 当在派生类中被覆盖时，返回此 [XPathNodeIterator](./) 对象的克隆。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，不能使用此迭代器更改被引用的对象。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | 返回选定节点集合中最后一个节点的索引。 |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | 当在派生类中被覆盖时，获取此 [XPathNodeIterator](./) 当前上下文节点上对应的 [XPathNavigator](../xpathnavigator/) 对象。 |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | 当在派生类中被覆盖时，获取选定节点集合中当前位置的索引。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回一个 IEnumerator 对象以遍历选定的节点集合。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法的类似实现。允许对自定义对象进行散列。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法的类似实现。允许克隆自定义类型。 |
| virtual **bool** [MoveNext](./movenext/)() | 当在派生类中被覆盖时，将 [XPathNodeIterator::get_Current](./get_current/) 方法返回的 [XPathNavigator](../xpathnavigator/) 对象移动到选定节点集合中的下一个节点。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 方法的类似实现。允许将自定义对象转换为字符串。 |
