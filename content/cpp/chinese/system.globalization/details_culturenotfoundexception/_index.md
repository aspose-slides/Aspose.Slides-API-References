...
description: "CultureNotFoundException 在尝试构造不可用的区域性时抛出。永远不要手动创建此类的实例。请使用 CultureNotFoundException 类。永远不要将 CultureNotFoundException 类的实例包装到 System::SmartPtr 中。"
type: docs
weight: 92
url: /zh/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException 类
...
| virtual [String](../../system/string/) [get_Message](../../system/details_exception/get_message/)() const | 返回包含错误描述的 string。 |
| [String](../../system/string/) [get_ParamName](../../system/details_argumentexception/get_paramname/)() |  |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | 返回包含堆栈跟踪的 string。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | 获取对象的实际类型。相当于 C# [System.Object.GetType()](../../system/object/gettype/) 调用。 |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | 返回当前对象的 string 表示。 |
...
* 类 [Details_ArgumentException](../../system/details_argumentexception/)
