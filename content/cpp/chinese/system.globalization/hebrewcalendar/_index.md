...
description: "希伯来历。本类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为会导致运行时错误和/或断言故障。始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 144
url: /zh/system.globalization/hebrewcalendar/
---
## HebrewCalendar 类
...
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | 获取可以用两位数字表示的最后一年。 |
...
| **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) const override | 检查该月份是否为闰月。 |
| virtual **bool** [IsLeapMonth](./isleapmonth/)(int, int) const | 检查该月份是否为闰月。 |
| virtual **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) const | 检查该月份是否为闰月。 |
| **bool** [IsLeapYear](./isleapyear/)(int, int) const override | 检查该年份是否为闰年。 |
| virtual **bool** [IsLeapYear](./isleapyear/)(int) const | 检查该年份是否为闰年。 |
| virtual **bool** [IsLeapYear](./isleapyear/)(int, int) const | 检查该年份是否为闰年。 |
...
| void [set_TwoDigitYearMax](./set_twodigityearmax/)(int) override | 设置可以用两位数字表示的最后一年。 |
...
| 字段 | 描述 |
| --- | --- |
| static constexpr [HebrewEra](./hebrewera/) | 当前希伯来时代。 |
