...
type: docs
weight: 183
url: /zh/system.globalization/koreancalendar/getleapmonth/
---
## KoreanCalendar::GetLeapMonth(int, int) const 方法
...
指定时代的指定年份的闰月，如果该年份没有闰月，则返回 0。

## KoreanCalendar::GetLeapMonth(int) const 方法
