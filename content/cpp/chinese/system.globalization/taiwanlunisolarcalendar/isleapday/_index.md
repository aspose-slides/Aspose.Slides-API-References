...
description: 检查该日是否为闰日。
type: docs
weight: 118
url: /zh/system.globalization/taiwanlunisolarcalendar/isleapday/
---
## TaiwanLunisolarCalendar::IsLeapDay(int, int, int, int) const 方法
...
如果指定的日期是闰日则返回 true，false 否则。

## TaiwanLunisolarCalendar::IsLeapDay(int, int, int) const 方法
