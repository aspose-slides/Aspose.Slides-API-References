...
description: 获取指定年份的月份数。
type: docs
weight: 66
url: /zh/system.globalization/thaibuddhistcalendar/getmonthsinyear/
---
## ThaiBuddhistCalendar::GetMonthsInYear(int, int) const 方法
...
## ThaiBuddhistCalendar::GetMonthsInYear(int) const 方法
