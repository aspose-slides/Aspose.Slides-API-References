...
description: "Hijri 日历。此类的对象应仅使用 System::MakeObject() 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类封装在 System::SmartPtr 指针中，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 157
url: /zh/system.globalization/hijricalendar/
---
## HijriCalendar 类

Hijri 日历。此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| int [get_HijriAdjustment](./get_hijriadjustment/)() const | 获取 Hijri 调整值。 |
...
| virtual int [GetDayOfYear](../calendar/getdayofyear/)([DateTime](../../system/datetime/)) const | 获取指定时间点的年度天数。 |
...
| virtual int [GetEra](../calendar/getera/)([DateTime](../../system/datetime/)) const | 获取指定时间点的时代。 |
...
| virtual int [GetLeapMonth](./getleapmonth/)(int) const | RTTI 信息。 |
| virtual int [GetLeapMonth](./getleapmonth/)(int, int) const | RTTI 信息。 |
...
| virtual int [GetWeekOfYear](../calendar/getweekofyear/)([DateTime](../../system/datetime/), [CalendarWeekRule](../calendarweekrule/), [DayOfWeek](../../system/dayofweek/)) const | 获取指定时间点的年度第几周。 |
...
| void [set_HijriAdjustment](./set_hijriadjustment/)(int) | 设置 Hijri 调整值。 |
...
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int) const | 从各组件构造 [DateTime](../../system/datetime/) 对象。 |
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int, int) const | 从各组件构造 [DateTime](../../system/datetime/) 对象。 |
...
| 字段 | 描述 |
| --- | --- |
| static constexpr [HijriEra](./hijriera/) | 当前 Hijri 时代。 |
