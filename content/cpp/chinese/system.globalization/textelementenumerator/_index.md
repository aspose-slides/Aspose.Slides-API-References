...
description: "用于遍历字符串元素（字符）的枚举器。此类的对象只能使用 System::MakeObject() 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 352
url: /zh/system.globalization/textelementenumerator/
---
## TextElementEnumerator 类


用于遍历字符串元素（字符）的枚举器。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_Current](./get_current/)() const | 获取当前文本元素。 |
| int [get_ElementIndex](./get_elementindex/)() const | 获取当前文本元素的索引。 |
...
| [String](../../system/string/) [GetTextElement](./gettextelement/)() const | 获取当前元素。 |
...
| **bool** [MoveNext](./movenext/)() | 移动到下一个元素。 |
|  [Object](../../system/object/object/)() | 创建对象。初始化所有内部数据结构。 |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上什么也不复制，只是初始化新对象并允许子类的拷贝构造。 |
| [TextElementEnumerator](./)\& [operator=](./operator_equal/)(const [TextElementEnumerator](./)\&) |  |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上什么也不复制，只是初始化新对象并允许子类的拷贝构造。 |
