...
description: 检查该月份是否为闰月。
type: docs
weight: 235
url: /zh/system.globalization/gregoriancalendar/isleapmonth/
---
## GregorianCalendar::IsLeapMonth(int, int, int) const 方法
...
如果指定的月份是闰月则返回 True，否则返回 false。

## GregorianCalendar::IsLeapMonth(int, int) const 方法
