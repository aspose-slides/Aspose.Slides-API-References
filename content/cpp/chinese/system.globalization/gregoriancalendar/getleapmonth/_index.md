...
type: docs
weight: 209
url: /zh/system.globalization/gregoriancalendar/getleapmonth/
---
## GregorianCalendar::GetLeapMonth(int, int) const 方法
...
指定纪元中指定年份的闰月；如果该年份没有闰月，则返回 0。

## GregorianCalendar::GetLeapMonth(int) const 方法
