...
description: 从组件构造 DateTime 对象。
type: docs
weight: 235
url: /zh/system.globalization/taiwancalendar/todatetime/
---
## TaiwanCalendar::ToDateTime(int, int, int, int, int, int, int, int) const 方法

从组件构造 [DateTime](../../../system/datetime/) 对象。
...
[DateTime](../../../system/datetime/) 对象，具有指定的组件。

## TaiwanCalendar::ToDateTime(int, int, int, int, int, int, int) const 方法
