...
type: docs
weight: 209
url: /zh/system.globalization/taiwancalendar/isleapmonth/
---
## TaiwanCalendar::IsLeapMonth(int, int, int) const 方法
...
如果指定的月份是闰月，则返回 true；否则返回 false。

## TaiwanCalendar::IsLeapMonth(int, int) const 方法
