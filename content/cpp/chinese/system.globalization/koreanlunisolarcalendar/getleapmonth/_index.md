...
type: docs
weight: 53
url: /zh/system.globalization/koreanlunisolarcalendar/getleapmonth/
---
## KoreanLunisolarCalendar::GetLeapMonth(int, int) const 方法
...
指定纪元中指定年份的闰月，如果该年没有闰月则返回零。

## KoreanLunisolarCalendar::GetLeapMonth(int) const 方法
