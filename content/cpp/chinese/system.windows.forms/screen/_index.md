...
description: 提供显示器的信息。仅限 Windows。这是一个单例类型，内存管理通过访问函数完成。您不应直接创建其实例。
type: docs
weight: 40
url: /zh/system.windows.forms/screen/
---
## Screen 类

提供显示器的信息。仅[Windows](../../system.windows/)。这是一个单例类型，内存管理由访问函数完成。您不应直接创建其实例。
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | 获取屏幕边界。 |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | 获取主显示器的信息。 |
