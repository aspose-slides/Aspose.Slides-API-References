...
description: "基本异常类由 HttpClient 和 HttpMessageHandler 类抛出。切勿手动创建此类的实例。请改用 HttpRequestException 类。切勿将 HttpRequestException 类实例包装到 System::SmartPtr 中。"
type: docs
weight: 14
url: /zh/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException 类
...
| 方法 | 描述 |
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | 构造一个新实例。 |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | 构造一个新实例。 |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | 构造一个新实例。 |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | 构造一个新实例。 |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | 抛出由异常包装器包装的异常实例。 |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | 使用 C# [Object.Equals](../../system/object/equals/) 语义比较对象。 |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较引用类型对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较值类型对象。 |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点数比较，即使根据 IEC 60559:1989 两个 NaN 不相等，也将它们视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点数比较，即使根据 IEC 60559:1989 两个 NaN 不相等，也将它们视为相等。 |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 返回一个 32 位整数值，该值是当前对象表示的异常关联的 HRESULT 代码。 |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 设置 HRESULT，这是分配给特定异常的编码数值。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类未从 std::exception 继承，派生类仍可使用受保护/私有成员实现其逻辑。将此方法实现移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
