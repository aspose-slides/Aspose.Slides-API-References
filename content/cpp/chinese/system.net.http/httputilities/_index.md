...
type: docs
weight: 131
url: /zh/system.net.http/httputilities/
---
## HttpUtilities 类
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | 检查指定的 URI 是否为 HTTP URI。 |
...
| 字段 | 描述 |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | 发送请求时的默认 HTTP 版本。 |
| static [DefaultResponseVersion](./defaultresponseversion/) | 接收响应时的默认 HTTP 版本。 |
