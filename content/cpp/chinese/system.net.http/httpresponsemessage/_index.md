...
description: "表示一个 HTTP 响应消息。此类的对象只能使用 System::MakeObject() 函数分配。绝不要在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 118
url: /zh/system.net.http/httpresponsemessage/
---
## HttpResponseMessage 类

表示一个 HTTP 响应消息。此类的对象只能使用 [System::MakeObject()](../../system/makeobject/) 函数分配。绝不要在栈上或使用 new 运算符创建此类型的实例，因为这会导致运行时错误和/或断言故障。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| Method | Description |
| --- | --- |
| void [Dispose](./dispose/)() override | 释放当前实例。此方法还会释放 HTTP 响应的内容。 |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpResponseMessage](./)\> [EnsureSuccessStatusCode](./ensuresuccessstatuscode/)() | 检查状态码。当状态码不属于 2xx 时，将抛出 HttpRequestException。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\> [get_Content](./get_content/)() const | 获取 HTTP 响应的内容。 |
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpResponseHeaders](../../system.net.http.headers/httpresponseheaders/)\> [get_Headers](./get_headers/)() const | 返回 HTTP 内容头。 |
| **bool** [get_IsSuccessStatusCode](./get_issuccessstatuscode/)() const | 检查状态码是否表明服务器已接收、理解并接受客户端请求的操作。 |
| [String](../../system/string/) [get_ReasonPhrase](./get_reasonphrase/)() const | 获取服务器随状态码一起发送的原因短语。 |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\> [get_RequestMessage](./get_requestmessage/)() const | 获取 HTTP 请求消息。 |
| [HttpStatusCode](../../system.net/httpstatuscode/) [get_StatusCode](./get_statuscode/)() const | 获取 HTTP 状态码。 |
| [System::Version](../../system/version/) [get_Version](./get_version/)() const | 获取 HTTP 版本。 |
...
|  [HttpResponseMessage](./httpresponsemessage/)([HttpStatusCode](../../system.net/httpstatuscode/)) | 构造一个新实例。 |
...
| void [set_Content](./set_content/)([System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\>) | 设置 HTTP 响应的内容。 |
| void [set_ReasonPhrase](./set_reasonphrase/)([String](../../system/string/)) | 设置服务器随状态码一起发送的原因短语。 |
| void [set_RequestMessage](./set_requestmessage/)([System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\>) | 设置 HTTP 请求消息。 |
| void [set_StatusCode](./set_statuscode/)([HttpStatusCode](../../system.net/httpstatuscode/)) | 设置 HTTP 状态码。 |
