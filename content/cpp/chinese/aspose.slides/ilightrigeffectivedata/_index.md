...
description: 不可变对象，包含有效灯光装置属性。
type: docs
weight: 2718
url: /zh/aspose.slides/ilightrigeffectivedata/
---
## ILightRigEffectiveData 类
...
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | 光照方向。只读 [LightingDirection](../lightingdirection/)。 |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | 表示可以应用于形状的预设灯光方向。灯光装置表示相对于 3D 场景以特定方式定向的一组灯光。只读 [LightRigPresetType](../lightrigpresettype/)。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | 旋转通过使用纬度坐标、经度坐标以及围绕轴的旋转来定义，纬度和经度坐标即为此。返回数组的第一个元素是纬度，第二个是经度，第三个是旋转。 |
