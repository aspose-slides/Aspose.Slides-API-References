...
description: 表示管理器，负责控制备注幻灯片占位符的行为，包括页眉占位符。
type: docs
weight: 4577
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | 获取指示日期时间占位符存在的值。读取**bool**。 |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | 获取指示页脚占位符存在的值。读取 **bool**。 |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | 获取指示页眉占位符存在的值。读取 **bool**。 |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | 获取指示页码占位符存在的值。读取**bool**。 |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | 为幻灯片日期时间占位符设置文本。 |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | 更改幻灯片日期时间占位符的可见性。 |
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | 为幻灯片页脚占位符设置文本。 |
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | 更改幻灯片页脚占位符的可见性。 |
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | 为幻灯片页眉占位符设置文本。 |
...
* 类 [INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)