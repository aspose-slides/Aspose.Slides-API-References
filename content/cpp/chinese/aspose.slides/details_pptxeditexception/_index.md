...
description: 在检测到编辑演示文稿错误时抛出的异常。
type: docs
weight: 716
url: /zh/aspose.slides/details_pptxeditexception/
---
## Details_PptxEditException 类

表示在检测到编辑演示文稿错误时抛出的异常。

```cpp
class Details_PptxEditException : public Aspose::Slides::Details_PpptxException
```
