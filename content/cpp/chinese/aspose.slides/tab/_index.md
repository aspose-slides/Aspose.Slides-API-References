...
| 方法 | 描述 |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | 将当前实例与同类型的另一个对象进行比较。 |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | 返回制表符的对齐样式。读取 [TabAlignment](../tabalignment/)。 |
...
| **double** [get_Position](./get_position/)() override | 返回制表符的位置。对该属性赋值可能会更改集合中制表符的索引并使枚举器失效。读取 **double**。 |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | 设置制表符的对齐样式。写入 [TabAlignment](../tabalignment/)。 |
| void [set_Position](./set_position/)(**double**) override | 设置制表符的位置。对该属性赋值可能会更改集合中制表符的索引并使枚举器失效。写入 **double**。 |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | 创建新的 [Tab](./) |
