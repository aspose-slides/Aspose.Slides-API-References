...
| Method | 描述 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateFileStreamWrapper](./createfilestreamwrapper/)([System::String](../../system/string/), [System::IO::FileMode](../../system.io/filemode/)) override | 使用指定的路径和创建模式创建 FileStream。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateFileStreamWrapper](./createfilestreamwrapper/)([System::String](../../system/string/), [System::IO::FileMode](../../system.io/filemode/), [System::IO::FileAccess](../../system.io/fileaccess/)) override | 使用指定的路径、创建模式和读/写权限创建 FileStream。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateMemoryStreamWrapper](./creatememorystreamwrapper/)() override | 创建 MemoryStream 包装器。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateMemoryStreamWrapper](./creatememorystreamwrapper/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | 基于指定的字节数组创建 MemoryStream 包装器。 |
...
* 类 [IStreamWrapperFactory](../istreamwrapperfactory/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)