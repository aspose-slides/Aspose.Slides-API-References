...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\> [Add](./add/)(**double**, [TabAlignment](../tabalignment/)) | 向集合中添加 [Tab](../tab/)。 |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) | 向集合中添加 [Tab](../tab/)。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。此迭代器不能用于修改所引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置（如果有）的迭代器。此迭代器不能用于修改所引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\> [idx_get](./idx_get/)(**int32_t**) | 获取指定索引处的元素。只读 [ITab](../itab/)。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 针对 string 与 nullptr 情形的特化。 |
