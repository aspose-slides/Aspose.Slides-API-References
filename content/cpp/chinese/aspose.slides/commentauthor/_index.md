...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | 返回此作者在指定索引处的评论。只读 [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | 返回此作者的评论集合。只读 [ICommentCollection](../icommentcollection/)。 |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | 返回作者的首字母。只读 [System::String](../../system/string/)。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 返回作者的姓名。只读 [System::String](../../system/string/)。 |
...
| void [Remove](./remove/)() override | 从父集合中移除作者。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定的值。 |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | 设置作者的首字母。写入 [System::String](../../system/string/)。 |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | 设置作者的姓名。写入 [System::String](../../system/string/)。 |
