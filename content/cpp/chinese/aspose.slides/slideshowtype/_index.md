...
description: "基本幻灯片播放设置。祖先表示幻灯片的类型： PresentedBySpeaker 演讲者呈现（全屏） BrowsedByIndividual 个人浏览（窗口） BrowsedAtKiosk 站点浏览（全屏）"
type: docs
weight: 5227
...
基本幻灯片播放设置。祖先表示幻灯片的类型：[PresentedBySpeaker](../presentedbyspeaker/) 演讲者呈现（全屏） [BrowsedByIndividual](../browsedbyindividual/) 个人浏览（窗口） [BrowsedAtKiosk](../browsedatkiosk/) 站点浏览（全屏）
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，仅初始化新对象并允许运行时子类的拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不复制任何内容，仅初始化新对象并允许运行时子类的拷贝构造。 |
