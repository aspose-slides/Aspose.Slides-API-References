...
type: docs
weight: 4109
url: /zh/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions 类
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | 设为 true 以使用区分大小写的搜索，false 则相反。读取 **bool**。 |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | 设为 true 以仅匹配完整单词，false 则相反。读取 **bool**。 |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | 设为 true 以使用区分大小写的搜索，false 则相反。写入 **bool**。 |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | 设为 true 以仅匹配完整单词，false 则相反。写入 **bool**。 |
...
已弃用
:   接口 [ITextHighlightingOptions](./) 将在 24.10 版发布后被移除。
