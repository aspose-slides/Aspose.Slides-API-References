...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | 返回操作的类型。只读 [ColorTransformOperation](../colortransformoperation/)。 |
| virtual **float** [get_Parameter](./get_parameter/)() | 返回操作的参数。只读 **float**。 |
