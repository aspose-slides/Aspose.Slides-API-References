...
| virtual **uint32_t** [get_Index](./get_index/)() | 获取占位符的索引。只读 **uint32_t**。 |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | 获取占位符的方向。只读 [Slides::Orientation](../orientation/)。 |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | 获取占位符的大小。只读 [PlaceholderSize](../placeholdersize/)。 |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | 获取占位符的类型。只读 [PlaceholderType](../placeholdertype/)。 |
