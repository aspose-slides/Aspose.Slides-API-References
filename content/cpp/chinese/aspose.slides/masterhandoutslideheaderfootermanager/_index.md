...
description: 表示管理器，负责主讲义幻灯片占位符的行为，包括页眉占位符。
type: docs
weight: 4421
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | 获取指示日期时间占位符存在的值。Read**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | 获取指示页脚占位符存在的值。Read **bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | 获取指示页眉占位符存在的值。Read **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | 获取指示页码占位符存在的值。Read**bool**. |
...
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | 使用引用比较对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | 使用引用比较对象。 |
...
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | 设置幻灯片页眉占位符的文本。 |
...
* 类 [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)