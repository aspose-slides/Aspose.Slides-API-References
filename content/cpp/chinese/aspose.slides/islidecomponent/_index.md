...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](./get_slide/)() | 返回基础幻灯片。只读 [IBaseSlide](../ibaseslide/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否是目标类型描述的实例。等价于 C# `is` 运算符。 |
