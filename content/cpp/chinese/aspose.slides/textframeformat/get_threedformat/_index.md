...
description: 返回表示文本的 3d 效果属性的 ThreeDFormat 对象。只读 IThreeDFormat。
type: docs
weight: 1
url: /zh/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() 方法

返回 [ThreeDFormat](../../threedformat/) 对象，该对象表示文本的 3d 效果属性。只读 [IThreeDFormat](../../ithreedformat/)。
