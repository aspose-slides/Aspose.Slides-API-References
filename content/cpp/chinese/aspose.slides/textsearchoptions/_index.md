...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | 将 true 设置为使用区分大小写的搜索，false 则不使用。读取 **bool**。 |
| **bool** [get_IncludeNotes](./get_includenotes/)() override | 在执行文本搜索、替换或高亮操作时，将 **true** 设置为包含幻灯片备注 ([NotesSlide](../notesslide/)) 中的文本。默认值为 **false**。 |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | 将 true 设置为仅匹配完整单词，false 则不匹配。读取 **bool**。 |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | 将 true 设置为使用区分大小写的搜索，false 则不使用。写入 **bool**。 |
| void [set_IncludeNotes](./set_includenotes/)(**bool**) override | 在执行文本搜索、替换或高亮操作时，将 **true** 设置为包含幻灯片备注 ([NotesSlide](../notesslide/)) 中的文本。默认值为 **false**。 |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | 将 true 设置为仅匹配完整单词，false 则不匹配。写入 **bool**。 |
