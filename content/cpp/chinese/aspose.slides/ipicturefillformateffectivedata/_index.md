...
---
## IPictureFillFormatEffectiveData 类
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | 返回图片底部被裁剪的实际图像高度的百分比。只读 **float**。 |
| virtual **float** [get_CropLeft](./get_cropleft/)() | 返回图片左侧被裁剪的实际图像宽度的百分比。只读 **float**。 |
| virtual **float** [get_CropRight](./get_cropright/)() | 返回图片右侧被裁剪的实际图像宽度的百分比。只读 **float**。 |
| virtual **float** [get_CropTop](./get_croptop/)() | 返回图片顶部被裁剪的实际图像高度的百分比。只读 **float**。 |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | 返回用于填充图片的 DPI。只读 **int32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | 返回图片。只读 [IPictureEffectiveData](../ipictureeffectivedata/)。 |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | 返回图片填充模式。只读 [Slides::PictureFillMode](../picturefillmode/)。 |
...
此接口用作 [IFillFormatEffectiveData](../ifillformateffectivedata/) 的一部分。
