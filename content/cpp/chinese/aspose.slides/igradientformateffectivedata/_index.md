...
---
## IGradientFormatEffectiveData 类
...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | 返回渐变的样式。只读 [Slides::GradientDirection](../gradientdirection/)。 |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | 返回渐变的形状。只读 [Slides::GradientShape](../gradientshape/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | 返回指定索引处的渐变停止点。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)\> [get_GradientStops](./get_gradientstops/)() | 返回渐变停止点的集合。只读 [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)。 |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | 返回渐变的角度。只读 **float**。 |
| virtual **bool** [get_LinearGradientScaled](./get_lineargradientscaled/)() | 确定渐变是否被缩放。只读 **bool**。 |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | 返回渐变的翻转模式。只读 [Slides::TileFlip](../tileflip/)。 |
