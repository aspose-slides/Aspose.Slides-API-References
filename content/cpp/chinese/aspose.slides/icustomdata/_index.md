...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) | 返回指定索引处的自定义 XML 部分。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() | 返回自定义 xml 部分集合。只读 [ICustomXmlPartCollection](../icustomxmlpartcollection/)。 |
| virtual [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) | 返回在索引处指定的 Customer Data Tag。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() | 返回 Customer Data Tags 集合。只读 [ITagCollection](../itagcollection/)。 |
...
| virtual void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) | 设置在索引处指定的 Customer Data Tag。 |
