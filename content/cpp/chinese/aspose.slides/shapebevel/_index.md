...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | 斜面类型。读取 [BevelPresetType](../bevelpresettype/)。 |
| **double** [get_Height](./get_height/)() override | 斜面高度。读取 **double**。 |
...
| **double** [get_Width](./get_width/)() override | 斜面宽度。读取 **double**。 |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | 斜面类型。写入 [BevelPresetType](../bevelpresettype/)。 |
| void [set_Height](./set_height/)(**double**) override | 斜面高度。写入 **double**。 |
| void [set_Width](./set_width/)(**double**) override | 斜面宽度。写入 **double**。 |
