...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | 返回表填充属性对象。只读 [IFillFormat](../ifillformat/)。 |
...
| **float** [get_Transparency](./get_transparency/)() override | 获取填充颜色的透明度。只读 **float**。 |
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../ipviobject/get_version/)() | 版本。只读 **uint32_t**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() override | 获取在继承和表样式应用后的有效表格格式属性。 |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 将第 n 个模板参数设为弱指针（而不是共享指针）。允许在容器中将指针切换为弱模式。 |
...
* 类 [ITableFormat](../itableformat/)
* 类 [IPVIObject](../ipviobject/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)