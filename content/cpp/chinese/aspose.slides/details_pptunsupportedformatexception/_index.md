...
type: docs
weight: 703
url: /zh/aspose.slides/details_pptunsupportedformatexception/
---
## Details_PptUnsupportedFormatException 类
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类未从 std::exception 继承，派生类仍可使用受保护/私有成员实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
| virtual  [~Object](../../system/object/~object/)() | 销毁对象。释放所有内部数据结构。 |

## 另请参见

* 类 [Details_PptReadException](../details_pptreadexception/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)