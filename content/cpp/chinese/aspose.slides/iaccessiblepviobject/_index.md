...
description: 表示一种可以在应用继承后返回相应有效数据的类型。
type: docs
weight: 1275
url: /zh/aspose.slides/iaccessiblepviobject/
---
## IAccessiblePVIObject 类

表示一种可以返回相应有效数据（已应用继承）的类型。
...
| virtual T [GetEffective](./geteffective/)() | 获取已应用继承的有效数据。 |
