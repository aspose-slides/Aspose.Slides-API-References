...
description: 表示 InterruptionToken 的来源。
type: docs
weight: 3069
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | 如果已请求中断则返回 true，否则返回 false。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() override | 返回绑定到此 [InterruptionTokenSource](./) 的新 token。 |
...
| void [Interrupt](./interrupt/)() override | 初始化中断请求。 |
|  [InterruptionTokenSource](./interruptiontokensource/)() | 创建一个新的 [InterruptionTokenSource](./)。 |
...
* 类 [IInterruptionTokenSource](../iinterruptiontokensource/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)