...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](../../system/icloneable/clone/)() | 创建当前对象的副本并返回指向该副本的共享指针。 |
...
| virtual **float** [get_CenterX](./get_centerx/)() | 返回框中心的 X 坐标。只读 **float**。 |
| virtual **float** [get_CenterY](./get_centery/)() | 返回框中心的 Y 坐标。只读 **float**。 |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | 确定框是否水平翻转。只读 [NullableBool](../nullablebool/)。 |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | 确定框是否垂直翻转。只读 [NullableBool](../nullablebool/)。 |
| virtual **float** [get_Height](./get_height/)() | 返回框的高度。只读 **float**。 |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | 返回框的坐标。只读 [System::Drawing::RectangleF](../../system.drawing/rectanglef/)。 |
| virtual **float** [get_Rotation](./get_rotation/)() | 返回框围绕 z 轴旋转的角度（度数）。正值表示顺时针旋转，负值表示逆时针旋转。只读 **float**。 |
| virtual **float** [get_Width](./get_width/)() | 返回框的宽度。只读 **float**。 |
| virtual **float** [get_X](./get_x/)() | 返回框左上角的 X 坐标。只读 **float**。 |
| virtual **float** [get_Y](./get_y/)() | 返回框左上角的 Y 坐标。只读 **float**。 |
