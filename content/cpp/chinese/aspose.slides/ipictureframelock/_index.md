...
| virtual **bool** [get_AdjustHandlesLocked](./get_adjusthandleslocked/)() | 确定是否禁止更改调整值。读取 **bool**。 |
| virtual **bool** [get_ArrowheadsLocked](./get_arrowheadslocked/)() | 确定是否禁止更改箭头。读取 **bool**。 |
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | 确定在调整大小时形状是否必须保持宽高比。读取 **bool**。 |
| virtual **bool** [get_CropLocked](./get_croplocked/)() | 确定是否禁止对图像进行裁剪。读取 **bool**。 |
...
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | 如果所有锁定标志均已禁用则返回 true。只读 **bool**。 |
| virtual **bool** [get_PositionLocked](./get_positionlocked/)() | 确定是否禁止移动此形状。读取 **bool**。 |
| virtual **bool** [get_RotationLocked](./get_rotationlocked/)() | 确定是否禁止更改此形状的旋转角度。读取 **bool**。 |
...
| virtual void [set_CropLocked](./set_croplocked/)(**bool**) | 确定是否禁止对图像进行裁剪。写入 **bool**。 |
...
| virtual void [set_RotationLocked](./set_rotationlocked/)(**bool**) | 确定是否禁止更改此形状的旋转角度。写入 **bool**。 |
