...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | 返回嵌入式 OLE 对象的文件数据，只读 **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | 返回当前嵌入式 OLE 对象的文件扩展名，只读 [System::String](../../system/string/)。 |
