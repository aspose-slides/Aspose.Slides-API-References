...
| [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../shape/get_blackwhitemode/)() override | 属性指定形状在黑白显示模式下的呈现方式。读取 [Slides::BlackWhiteMode](../blackwhitemode/)。 |
...
| [ZoomImageType](../zoomimagetype/) [get_ImageType](../zoomobject/get_imagetype/)() override | 获取缩放对象的图像类型。读取 [ZoomImageType](../zoomimagetype/)。默认值: Preview |
...
| [System::String](../../system/string/) [get_Name](../shape/get_name/)() override | 返回形状的名称。不能为空。如果需要，可使用空字符串。读取 [System::String](../../system/string/)。 |
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | 返回在幻灯片范围内唯一的标识符，该标识符在形状的整个生命周期内保持不变，并允许 PowerPoint 或互操作代码在文档中的任何位置可靠地引用该形状。只读 **uint32_t**。另见 [Shape::get_UniqueId](../shape/get_uniqueid/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_TargetSlide](./get_targetslide/)() override | 获取 [Slide](../slide/) Zoom 对象链接到的幻灯片对象。读取 [ISlide](../islide/)。 |
...
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | 返回内部的、演示范围的标识符，供加载项或其他代码使用。因为此值可能被用户或程序重新分配，所以不能视为持久的唯一键。只读 **uint32_t**。另见 [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](../zoomobject/get_zoomimage/)() override | 获取缩放对象的图像。读取 [IPPImage](../ippimage/)。 |
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | 返回形状在 Z 顺序中的位置。Shapes[0] 返回 Z 顺序后部的形状，Shapes[Shapes.Count - 1] 返回 Z 顺序前部的形状。只读 **int32_t**。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否表示 targetType 描述的类型实例。类似 C# 'is' 操作符。 |
...
| void [set_BlackWhiteMode](../shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) override | 属性指定形状在黑白显示模式下的呈现方式。写入 [Slides::BlackWhiteMode](../blackwhitemode/)。 |
...
| void [set_Name](../shape/set_name/)([System::String](../../system/string/)) override | 设置形状的名称。不能为空。如有需要，使用空字符串。写入 [System::String](../../system/string/)。 |
...
| void [set_TargetSlide](./set_targetslide/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | 设置 [Slide](../slide/) Zoom 对象链接到的幻灯片对象。写入 [ISlide](../islide/)。 |
