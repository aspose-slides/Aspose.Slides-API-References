...
| virtual [System::String](../../system/string/) [get_ActualBulletValue](./get_actualbulletvalue/)() | 返回父段落的实际项目符号值。只读 [System::String](../../system/string/)。 |
| virtual char16_t [get_Char](./get_char/)() | 返回段落的项目符号字符。只读 **wchar_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | 返回段落的项目符号填充格式。只读 [IFillFormatEffectiveData](../ifillformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_Font](./get_font/)() | 返回段落的项目符号字体。只读 [IFontData](../ifontdata/)。 |
| virtual **float** [get_Height](./get_height/)() | 返回段落的项目符号高度。只读 **float**。 |
| virtual **bool** [get_IsBulletHardColor](./get_isbullethardcolor/)() | 确定项目符号是否拥有自定义颜色或从段落的第一段落块继承颜色。如果项目符号拥有自定义颜色则返回 **true**，如果继承颜色则返回 **false**。只读 **bool**。 |
| virtual **bool** [get_IsBulletHardFont](./get_isbullethardfont/)() | 确定项目符号是否拥有自定义字体或从段落的第一段落块继承字体。如果项目符号拥有自定义字体则返回 **true**，如果继承字体则返回 **true**。只读 **bool**。 |
| virtual **int16_t** [get_NumberedBulletStartWith](./get_numberedbulletstartwith/)() | 返回用于编号项目符号组的第一个数字。只读 **int16_t**。 |
| virtual [Aspose::Slides::NumberedBulletStyle](../numberedbulletstyle/) [get_NumberedBulletStyle](./get_numberedbulletstyle/)() | 返回编号项目符号的样式。只读 [Slides::NumberedBulletStyle](../numberedbulletstyle/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | 返回段落中用作项目符号的图片。只读 [IPictureEffectiveData](../ipictureeffectivedata/)。 |
| virtual [BulletType](../bullettype/) [get_Type](./get_type/)() | 返回段落的项目符号类型。只读 [BulletType](../bullettype/)。 |
