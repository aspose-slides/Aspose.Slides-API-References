...
表示文档的“Heading pair”属性。它指示文档部分的组名以及组中部分的数量。
...
| virtual **int32_t** [get_Count](./get_count/)() | 返回组中部分的数量。只读 **int32_t**。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 返回文档部分的组名。只读 [System::String](../../system/string/)。 |
