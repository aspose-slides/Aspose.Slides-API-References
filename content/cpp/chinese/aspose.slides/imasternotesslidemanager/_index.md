...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [get_MasterNotesSlide](./get_masternotesslide/)() | 如果存在，则返回此演示文稿所有备注幻灯片的主对象，否则返回 null。只读 [IMasterNotesSlide](../imasternotesslide/)。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化，用于 string 与 nullptr 情况。 |
...
| virtual void [RemoveMasterNotesSlide](./removemasternotesslide/)() | 移除主备注幻灯片。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [SetDefaultMasterNotesSlide](./setdefaultmasternotesslide/)() | 为相关备注幻灯片设置默认主备注幻灯片。 |
