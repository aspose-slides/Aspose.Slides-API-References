...
| 方法 | 描述 |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | 比较当前对象与指定对象。 |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | 使用 C# [Object.Equals](../../system/object/equals/) 语义比较对象。 |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较引用类型对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较值类型对象。 |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 两个 NaN 并不等于任何值（包括 NaN），仍将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 两个 NaN 并不等于任何值（包括 NaN），仍将两个 NaN 视为相等。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | 返回标签的对齐样式。阅读 [TabAlignment](../tabalignment/)。 |
| virtual **double** [get_Position](./get_position/)() | 返回标签的位置。对该属性赋值可能导致标签在集合中的索引改变并使枚举器失效。读取 **double**。 |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | 设置标签的对齐样式。写入 [TabAlignment](../tabalignment/)。 |
| virtual void [set_Position](./set_position/)(**double**) | 设置标签的位置。对该属性赋值可能导致标签在集合中的索引改变并使枚举器失效。写入 **double**。 |
