...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | 返回此作者在指定索引处的评论。只读 [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | 返回此作者所做评论的集合。只读 [ICommentCollection](../icommentcollection/)。 |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | 返回作者的首字母。读取 [System::String](../../system/string/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 返回作者的名称。读取 [System::String](../../system/string/)。 |
...
| virtual void [Remove](./remove/)() | 从父集合中移除作者。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 按指定值减少共享引用计数。 |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | 设置作者的首字母。写入 [System::String](../../system/string/)。 |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | 设置作者的名称。写入 [System::String](../../system/string/)。 |
