...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | 获取指示日期时间占位符是否存在的值。读取**bool**。 |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | 获取指示页脚占位符是否存在的值。读取 **bool**。 |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | 获取指示页码占位符是否存在的值。读取**bool**。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否是 targetType 描述的类型实例。C# 'is' 运算符的类似实现。 |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | 设置幻灯片日期时间占位符的文本。 |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | 更改幻灯片日期时间占位符的可见性。 |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | 设置幻灯片页脚占位符的文本。 |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | 更改幻灯片页脚占位符的可见性。 |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | 更改幻灯片页码占位符的可见性。 |
