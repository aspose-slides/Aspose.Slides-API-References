...
description: 表示一个已关闭字幕的集合。
type: docs
weight: 1626
url: /zh/aspose.slides/icaptionscollection/
---
## ICaptionsCollection 类
...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | 向集合的末尾添加 WebVTT 闭合字幕。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | 从流中向集合的末尾添加 WebVTT 闭合字幕。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，不能使用此迭代器更改引用的对象。 |
...
| virtual void [Clear](./clear/)() | 从集合中移除所有闭合字幕。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的迭代器（如果有）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，不能使用此迭代器更改引用的对象。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | 返回集合中的元素数量。只读 **int32_t**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [idx_get](./idx_get/)(**int32_t**) | 返回指定索引处的闭合字幕。只读 [ICaptions](../icaptions/)。 |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>) | 从集合中移除指定的闭合字幕。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除指定索引处的闭合字幕。 |
