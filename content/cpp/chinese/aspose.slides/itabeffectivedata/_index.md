...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | 返回制表符的对齐样式。只读 [TabAlignment](../tabalignment/)。 |
| virtual **double** [get_Position](./get_position/)() | 返回制表符的位置。对该属性赋值可能会更改集合中制表符的索引并使枚举器失效。只读 **double**。 |
