...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 样式的浮点数比较，在该比较中，即使根据 IEC 60559:1989 标准 NaN 不等于任何值，包括 NaN，两个 NaN 仍被视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 样式的浮点数比较，在该比较中，即使根据 IEC 60559:1989 标准 NaN 不等于任何值，包括 NaN，两个 NaN 仍被视为相等。 |
