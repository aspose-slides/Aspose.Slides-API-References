...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 样式的浮点比较，即使根据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），仍将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 样式的浮点比较，即使根据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），仍将两个 NaN 视为相等。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](../ishape/get_effectformat/)() | 返回包含施加于形状的像素效果的 [EffectFormat](../effectformat/) 对象。只读 [IEffectFormat](../ieffectformat/)。 |
...
| virtual [ZoomImageType](../zoomimagetype/) [get_ImageType](./get_imagetype/)() | 获取 Zoom 对象的图像类型。阅读 [ZoomImageType](../zoomimagetype/)。默认值: Preview |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | 返回在幻灯片范围内唯一的标识符，该标识符在形状的生命周期内保持不变，使 PowerPoint 或互操作代码能够从文档的任何位置可靠地引用该形状。只读 **uint32_t**。另见 [IShape::get_UniqueId](../ishape/get_uniqueid/)。 |
...
| virtual **bool** [get_ReturnToParent](./get_returntoparent/)() | 获取幻灯片放映中的导航行为。只读 **bool**。默认值: false |
...
| virtual **bool** [get_ShowBackground](./get_showbackground/)() | 获取指定 Zoom 是否使用目标幻灯片背景的值。只读 **bool**。默认值: true |
...
| virtual **float** [get_TransitionDuration](./get_transitionduration/)() | 获取 Zoom 与幻灯片之间过渡的持续时间。只读 **float**。默认值: 1.0f |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | 返回内部的、面向演示文稿的标识符，供插件或其他代码使用。由于此值可能被用户或程序重新分配，不能将其视为持久的唯一键。只读 **uint32_t**。另见 [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](./get_zoomimage/)() | 获取 Zoom 对象的图像。阅读 [IPPImage](../ippimage/)。 |
...
| virtual void [set_ImageType](./set_imagetype/)([ZoomImageType](../zoomimagetype/)) | 设置 Zoom 对象的图像类型。写入 [ZoomImageType](../zoomimagetype/)。默认值: Preview |
...
| virtual void [set_ReturnToParent](./set_returntoparent/)(**bool**) | 设置幻灯片放映中的导航行为。写入 **bool**。默认值: false |
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | 设置指定形状绕 z 轴旋转的角度（度）。正值表示顺时针旋转，负值表示逆时针旋转。写入 **float**。 |
| virtual void [set_ShowBackground](./set_showbackground/)(**bool**) | 设置指定 Zoom 是否使用目标幻灯片背景的值。写入 **bool**。默认值: true |
| virtual void [set_TransitionDuration](./set_transitionduration/)(**float**) | 设置 Zoom 与幻灯片之间过渡的持续时间。写入 **float**。默认值: 1.0f |
...
| virtual void [set_ZoomImage](./set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | 设置 Zoom 对象的图像。写入 [IPPImage](../ippimage/)。 |
...
| virtual void [WriteAsSvg](../ishape/writeassvg/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | 将 [Shape](../shape/) 的内容另存为 SVG 文件。 |
| virtual void [WriteAsSvg](../ishape/writeassvg/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [System::SharedPtr](../../system/sharedptr/)\<[Export::ISVGOptions](../../aspose.slides.export/isvgoptions/)\>) | 将 [Shape](../shape/) 的内容另存为 SVG 文件。 |
