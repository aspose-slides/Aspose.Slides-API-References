...
| 方法 | 描述 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [CreateFontData](./createfontdata/)([System::String](../../system/string/)) override | 使用指定的字体名称创建 [FontData](../fontdata/)。 |
...
* 类 [IFontDataFactory](../ifontdatafactory/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)