...
description: 表示管理器，保存占位符的行为，包括所有类型讲义和备注幻灯片的页眉占位符。
type: docs
weight: 118
...
表示管理器，保存占位符的行为，包括所有类型讲义和备注幻灯片的页眉占位符。
...
| **bool** [get_IsHeaderVisible](./get_isheadervisible/)() override | 获取指示存在页眉占位符的值。读取 **bool**。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上并不复制任何内容，仅初始化新对象并支持子类的复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上并不复制任何内容，仅初始化新对象并支持子类的复制构造。 |
...
| void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) override | 设置幻灯片页眉占位符的文本。 |
| void [SetHeaderVisibility](./setheadervisibility/)(**bool**) override | 更改幻灯片页眉占位符的可见性。 |
