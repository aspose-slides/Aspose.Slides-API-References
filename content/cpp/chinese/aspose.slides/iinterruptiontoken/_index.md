...
description: 此类表示用于向长时间运行的任务发出是否请求中断的令牌。
type: docs
weight: 2601
url: /zh/aspose.slides/iinterruptiontoken/
---
## IInterruptionToken 类

此类表示用于向长时间运行的任务发出是否请求中断的令牌。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，两个 NaN 被视为相等，尽管根据 IEC 60559:1989，NaN 不等于任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，两个 NaN 被视为相等，尽管根据 IEC 60559:1989，NaN 不等于任何值，包括 NaN 本身。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | 如果请求了中断，则返回 **bool**.true。 |
...
| virtual void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() | 如果请求了中断，则抛出异常。 |
