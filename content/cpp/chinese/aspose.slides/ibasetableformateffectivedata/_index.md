...
description: 用于包含有效表格格式属性的不可变对象的基接口。
type: docs
weight: 1522
url: /zh/aspose.slides/ibasetableformateffectivedata/
---
## IBaseTableFormatEffectiveData 类


不可变对象的基接口，这些对象包含有效的表格格式属性。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderBottom](./get_borderbottom/)() | 返回底部边框线格式的有效值。只读 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() | 返回下对角线格式的有效值。只读 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() | 返回上对角线格式的有效值。只读 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderLeft](./get_borderleft/)() | 返回左边框线格式的有效值。只读 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderRight](./get_borderright/)() | 返回右边框线格式的有效值。只读 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderTop](./get_bordertop/)() | 返回顶部边框线格式的有效值。只读 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | 返回填充格式的有效值。只读 [IFillFormatEffectiveData](../ifillformateffectivedata/)。 |
