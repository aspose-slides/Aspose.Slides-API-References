...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | 返回一个 [EffectFormat](../effectformat/) 用于 [BackgroundType::OwnBackground](../backgroundtype/) 填充。只读 [IEffectFormat](../ieffectformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | 返回一个 [FillFormat](../fillformat/) 用于 [BackgroundType::OwnBackground](../backgroundtype/) 填充。只读 [IFillFormat](../ifillformat/)。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | 返回一个 [ColorFormat](../colorformat/) 用于 [BackgroundType::Themed](../backgroundtype/) 填充。只读 [IColorFormat](../icolorformat/)。 |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | 返回背景主题集合中 [BackgroundType::Themed](../backgroundtype/) 填充的索引。0 表示无填充。1..999 - 索引。读取 **uint16_t**。 |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | 返回背景填充的类型。读取 [BackgroundType](../backgroundtype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | 获取应用继承后的有效背景数据。 |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | 返回背景主题集合中 [BackgroundType::Themed](../backgroundtype/) 填充的索引。0 表示无填充。1..999 - 索引。写入 **uint16_t**。 |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | 返回背景填充的类型。写入 [BackgroundType](../backgroundtype/)。 |
