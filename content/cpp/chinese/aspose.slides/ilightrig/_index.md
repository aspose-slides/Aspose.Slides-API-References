...
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | 光照方向。读取 [LightingDirection](../lightingdirection/)。 |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | 表示可应用于形状的预设灯光右侧。光线装置表示相对于 3D 场景以特定方式定位的一组灯光。读取 [LightRigPresetType](../lightrigpresettype/)。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | 旋转通过使用纬度坐标、经度坐标以及围绕轴的旋转来定义，纬度和经度坐标作为旋转。返回数组的第一个元素是纬度，第二个是经度，第三个是旋转。 |
...
| virtual void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) | 光照方向。写入 [LightingDirection](../lightingdirection/)。 |
| virtual void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) | 表示可应用于形状的预设灯光右侧。光线装置表示相对于 3D 场景以特定方式定位的一组灯光。写入 [LightRigPresetType](../lightrigpresettype/)。 |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | 旋转通过使用纬度坐标、经度坐标以及围绕轴的旋转来定义，纬度和经度坐标作为旋转。 |
