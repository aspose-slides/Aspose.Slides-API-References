...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 获取指向 const 限定实例的集合中最后一个元素之后的迭代器（如果有）。 |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | 返回指示对集合的访问是否同步（线程安全）的值。只读 **bool**。 |
