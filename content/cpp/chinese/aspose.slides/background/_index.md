...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() override | 返回用于 [BackgroundType::OwnBackground](../backgroundtype/) 填充的 [EffectFormat](../effectformat/)。只读 [IEffectFormat](../ieffectformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | 返回用于 [BackgroundType::OwnBackground](../backgroundtype/) 填充的 [FillFormat](../fillformat/)。只读 [IFillFormat](../ifillformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() override | 返回用于 [BackgroundType::Themed](../backgroundtype/) 填充的 [ColorFormat](../colorformat/)。只读 [IColorFormat](../icolorformat/)。 |
| **uint16_t** [get_StyleIndex](./get_styleindex/)() override | 返回背景主题集合中 [BackgroundType::Themed](../backgroundtype/) 填充的索引。0 表示无填充。1..999 为索引。只读 **uint16_t**。 |
| [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() override | 返回背景填充的类型。只读 [BackgroundType](../backgroundtype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取已应用继承的有效背景数据。 |
...
| void [set_StyleIndex](./set_styleindex/)(**uint16_t**) override | 返回背景主题集合中 [BackgroundType::Themed](../backgroundtype/) 填充的索引。0 表示无填充。1..999 为索引。写入 **uint16_t**。 |
| void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) override | 返回背景填充的类型。写入 [BackgroundType](../backgroundtype/)。 |
