...
description: 表示管理笔记幻灯片占位符（包括标题占位符）行为的管理器。
type: docs
weight: 3030
url: /zh/aspose.slides/inotesslideheaderfootermanager/
---
## INotesSlideHeaderFooterManager 类

表示管理笔记幻灯片占位符（包括标题占位符）行为的管理器。
...
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | 获取指示标题占位符是否存在的值。读取 **bool**。 |
...
| virtual void [SetHeaderText](../ibasehandoutnotesslideheaderfootermanag/setheadertext/)([System::String](../../system/string/)) | 设置幻灯片标题占位符的文本。 |
