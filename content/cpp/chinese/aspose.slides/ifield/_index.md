...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() | 返回字段的类型。读取 [IFieldType](../ifieldtype/)。 |
...
| virtual void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | 设置字段的类型。写入 [IFieldType](../ifieldtype/)。 |
