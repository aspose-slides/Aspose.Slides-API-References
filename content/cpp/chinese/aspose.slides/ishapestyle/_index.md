...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_EffectColor](./get_effectcolor/)() | 返回形状的效果颜色。只读 [IColorFormat](../icolorformat/)。 |
| virtual **uint32_t** [get_EffectStyleIndex](./get_effectstyleindex/)() | 返回样式矩阵中形状的效果列索引。读取 **uint32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_FillColor](./get_fillcolor/)() | 返回形状的填充颜色。只读 [IColorFormat](../icolorformat/)。 |
| virtual **int16_t** [get_FillStyleIndex](./get_fillstyleindex/)() | 返回样式矩阵中形状的填充列索引。0 表示无填充，正值为主题填充样式的索引，负值为主题背景样式的索引。读取 **int16_t**。 |
| virtual [Aspose::Slides::FontCollectionIndex](../fontcollectionindex/) [get_FontCollectionIndex](./get_fontcollectionindex/)() | 返回字体集合中形状的字体索引。读取 [Slides::FontCollectionIndex](../fontcollectionindex/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_FontColor](./get_fontcolor/)() | 返回形状的字体颜色。只读 [IColorFormat](../icolorformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_LineColor](./get_linecolor/)() | 返回形状的轮廓颜色。只读 [IColorFormat](../icolorformat/)。 |
| virtual **uint16_t** [get_LineStyleIndex](./get_linestyleindex/)() | 返回样式矩阵中线条的列索引。读取 **uint16_t**。 |
...
| virtual void [set_EffectStyleIndex](./set_effectstyleindex/)(**uint32_t**) | 设置样式矩阵中形状的效果列索引。写入 **uint32_t**。 |
| virtual void [set_FillStyleIndex](./set_fillstyleindex/)(**int16_t**) | 设置样式矩阵中形状的填充列索引。0 表示无填充，正值为主题填充样式的索引，负值为主题背景样式的索引。写入 **int16_t**。 |
| virtual void [set_FontCollectionIndex](./set_fontcollectionindex/)([Aspose::Slides::FontCollectionIndex](../fontcollectionindex/)) | 设置字体集合中形状的字体索引。写入 [Slides::FontCollectionIndex](../fontcollectionindex/)。 |
| virtual void [set_LineStyleIndex](./set_linestyleindex/)(**uint16_t**) | 设置样式矩阵中线条的列索引。写入 **uint16_t**。 |
