...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_FontFolders](./get_fontfolders/)() | 包含字体文件的文件夹。这些文件夹中的所有字体文件都会被包含在集合中。递归搜索的文件夹。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\> [get_MemoryFonts](./get_memoryfonts/)() | 以字节数组形式表示的字体集合。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不进行拷贝，仅初始化新对象并允许子类的拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不进行拷贝，仅初始化新对象并允许子类的拷贝构造。 |
...
| virtual void [set_FontFolders](./set_fontfolders/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | 包含字体文件的文件夹。这些文件夹中的所有字体文件都会被包含在集合中。递归搜索的文件夹。 |
| virtual void [set_MemoryFonts](./set_memoryfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\>) | 以字节数组形式表示的字体集合。 |
