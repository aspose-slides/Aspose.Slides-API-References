...
| 方法 | 描述 |
| --- | --- |
| virtual void [Dispose](../../system/idisposable/dispose/)() | 什么也不做。 |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | 使用 C# [Object.Equals](../../system/object/equals/) 语义比较对象。 |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较引用类型对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较值类型对象。 |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 样式的浮点比较，两个 NaN 被视为相等，尽管根据 IEC 60559:1989，NaN 不等于任何值，包括 NaN。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 样式的浮点比较，两个 NaN 被视为相等，尽管根据 IEC 60559:1989，NaN 不等于任何值，包括 NaN。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual **int32_t** [get_Height](./get_height/)() | 获取图像的像素高度。 |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_Size](./get_size/)() | 获取图像的大小。 |
| virtual **int32_t** [get_Width](./get_width/)() | 获取图像的像素宽度。 |
...
| virtual void [Save](./save/)([System::String](../../system/string/)) | 将图像保存到文件。 |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/)) | 按指定格式将图像保存到文件。 |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/)) | 按指定格式将图像保存到流。 |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/), **int32_t**) | 按指定格式和质量将图像保存到文件。 |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/), **int32_t**) | 按指定格式和质量将图像保存到流。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 减少共享引用计数并返回。不应直接调用；请使用智能指针或 ThisProtector。 |
