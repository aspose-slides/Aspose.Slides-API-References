...
| **float** [get_AngleValue](./get_anglevalue/)() override | 返回值，将其解释为角度（度）。读取 **float**。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 返回此调整值的名称。只读 [System::String](../../system/string/)。 |
| **int64_t** [get_RawValue](./get_rawvalue/)() override | 原样返回调整值。读取 **int64_t**。 |
| [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() override | 返回形状调整的类型。只读 [ShapeAdjustmentType](../shapeadjustmenttype/)。 |
...
| void [set_AngleValue](./set_anglevalue/)(**float**) override | 设置值，将其解释为角度（度）。写入 **float**。 |
| void [set_RawValue](./set_rawvalue/)(**int64_t**) override | 原样设置调整值。写入 **int64_t**。 |
