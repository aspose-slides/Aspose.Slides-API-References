...
description: 表示管理器，持有占位符的行为，包括所有类型的讲义和备注幻灯片的页眉占位符。
type: docs
weight: 1431
url: /zh/aspose.slides/ibasehandoutnotesslideheaderfootermanag/
---
## IBaseHandoutNotesSlideHeaderFooterManag 类

表示管理器，持有占位符的行为，包括所有类型的讲义和备注幻灯片的页眉占位符。
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | 获取指示存在日期时间占位符的值。Read**bool**。 |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | 获取指示存在页脚占位符的值。Read **bool**。 |
| virtual **bool** [get_IsHeaderVisible](./get_isheadervisible/)() | 获取指示存在页眉占位符的值。Read **bool**。 |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | 获取指示存在页码占位符的值。Read**bool**。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化用于字符串和 nullptr。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化用于字符串。 |
...
| virtual void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) | 设置幻灯片页眉占位符的文本。 |
| virtual void [SetHeaderVisibility](./setheadervisibility/)(**bool**) | 更改幻灯片页眉占位符的可见性。 |
...
原始接口名称 "IBaseHandoutNotesSlideHeaderFooterManager" 为了 COM 兼容性被截断为 "IBaseHandoutNotesSlideHeaderFooterManag"（类型名称长度必须不超过 39）。
