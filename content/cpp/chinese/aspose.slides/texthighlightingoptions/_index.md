...
description: 表示可用于在文本框中高亮显示文本的选项。
type: docs
weight: 5474
url: /zh/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions 类
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | 设置为 true 以使用区分大小写的搜索，false 则不使用。读取 **bool**。 |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | 设置为 true 仅匹配完整单词，false 则不使用。读取 **bool**。 |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | 设置为 true 以使用区分大小写的搜索，false 则不使用。写入 **bool**。 |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | 设置为 true 仅匹配完整单词，false 则不使用。写入 **bool**。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而非共享指针）。允许在容器中将指针切换为弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 获取共享引用计数器的当前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 递增共享引用计数。不应直接调用；请改用智能指针或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 递减并返回共享引用计数。不应直接调用；请改用智能指针或 ThisProtector。 |
|  [TextHighlightingOptions](./texthighlightingoptions/)() | 创建新的默认文本高亮选项。 |
...
已弃用
:   接口 [ITextHighlightingOptions](../itexthighlightingoptions/) 将在版本 24.10 发布后被移除。
