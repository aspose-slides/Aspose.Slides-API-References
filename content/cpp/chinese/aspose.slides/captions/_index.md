...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | 返回闭合字幕的二进制数据。只读 **uint8_t**[]。 |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | 返回闭合字幕的全局唯一标识符 (GUID)。只读 [System::Guid](../../system/guid/)。 |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | 返回闭合字幕数据，作为 UTF-8 编码的字符串。只读 [System::String](../../system/string/)。 |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | 返回闭合字幕的标签。只读 [System::String](../../system/string/)。 |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | 设置闭合字幕的标签。写入 [System::String](../../system/string/)。 |
