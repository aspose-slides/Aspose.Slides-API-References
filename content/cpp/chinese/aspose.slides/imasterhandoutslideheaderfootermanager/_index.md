...
---
## IMasterHandoutSlideHeaderFooterManager 类
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，即使依据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），这里仍将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，即使依据 IEC 60559:1989，NaN 不等于任何值（包括 NaN），这里仍将两个 NaN 视为相等。 |
...
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | 获取指示页眉占位符是否存在的值。读取 **bool**。 |
...
| virtual void [SetHeaderText](../ibasehandoutnotesslideheaderfootermanag/setheadertext/)([System::String](../../system/string/)) | 设置幻灯片页眉占位符的文本。 |
| virtual void [SetHeaderVisibility](../ibasehandoutnotesslideheaderfootermanag/setheadervisibility/)(**bool**) | 更改幻灯片页眉占位符的可见性。 |
