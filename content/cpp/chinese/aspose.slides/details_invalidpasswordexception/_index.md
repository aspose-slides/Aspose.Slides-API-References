...
type: docs
weight: 586
url: /zh/aspose.slides/details_invalidpasswordexception/
---
## Details_InvalidPasswordException 类
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现由 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用的 [what()](../../system/details_exception/what/) 方法。尽管此类未继承自 std::exception，派生类仍可使用受保护/私有成员实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
