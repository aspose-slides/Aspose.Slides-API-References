...
description: 表示梯度停止点的集合。
type: docs
weight: 2419
url: /zh/aspose.slides/igradientstopcollection/
---
## IGradientStopCollection 类
...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) | 创建新的梯度停止点并将其添加到集合的末尾。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) | 创建新的梯度停止点并将其添加到集合的末尾。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) | 创建新的梯度停止点并将其添加到集合的末尾。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，无法使用此迭代器修改所引用的对象。 |
...
| virtual void [Clear](./clear/)() | 从集合中移除所有梯度停止点。 |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 将集合中的所有元素复制到指定的数组中。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置的迭代器（如果有）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的复制对象，无法使用此迭代器修改所引用的对象。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) | 按索引返回梯度停止点。 |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) | 创建新的梯度停止点并将其插入到集合中指定的索引位置。 |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) | 创建新的梯度停止点并将其插入到集合中指定的索引位置。 |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) | 创建新的梯度停止点并将其插入到集合中指定的索引位置。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | 从序列的起始返回指定数量的连续元素。 |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 删除指定索引处的梯度停止点。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 按指定值减少共享引用计数。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设为弱指针（而非共享指针）。允许在容器中将指针切换为弱引用模式。 |
