...
description: 用于段落相关事件的事件参数类。
type: docs
weight: 4642
url: /zh/aspose.slides/paragrapheventargs/
---
## ParagraphEventArgs 类
...
| 字段 | 描述 |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | 表示一个 \"empty\" [EventArgs](../../system/eventargs/) 共享指针（null-pointer）的静态成员。 |
