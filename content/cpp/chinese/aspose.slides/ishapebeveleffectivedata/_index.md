...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | 斜角类型。只读 [BevelPresetType](../bevelpresettype/)。 |
| virtual **double** [get_Height](./get_height/)() | 斜角高度。只读 **double**。 |
| virtual **double** [get_Width](./get_width/)() | 斜角宽度。只读 **double**。 |
