...
| 方法 | 描述 |
| --- | --- |
|  [DigitalSignature](./digitalsignature/)([System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\>) | 创建一个使用指定证书的 [DigitalSignature](./) 对象。 |
|  [DigitalSignature](./digitalsignature/)([System::String](../../system/string/), [System::String](../../system/string/)) | 使用指定的证书文件路径和密码创建一个新的 [DigitalSignature](./) 对象。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() override | 用于签署文档的证书对象。只读 [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)。 |
| [System::String](../../system/string/) [get_Comments](./get_comments/)() override | 签名的目的。只读 [System::String](../../system/string/)。 |
| **bool** [get_IsValid](./get_isvalid/)() override | 如果此数字签名有效且文档未被篡改，则此值为 true。只读 **bool**。 |
| [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() override | 文档签署的时间。只读 [System::DateTime](../../system/datetime/)。 |
...
| void [set_Comments](./set_comments/)([System::String](../../system/string/)) override | 签名的目的。写入 [System::String](../../system/string/)。 |
...
以下示例演示如何在 PowerPoint [Presentation](../presentation/) 中使用 PFX 证书添加数字签名。
```cpp
// 初始化 Presentation 实例
...
```
以下示例代码演示如何验证 PowerPoint [Presentation](../presentation/) 的数字签名。
```cpp
// 初始化 Presentation 实例
