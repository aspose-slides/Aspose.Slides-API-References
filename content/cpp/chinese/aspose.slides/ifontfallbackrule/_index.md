...
| Method | Description |
| --- | --- |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) | 将新字体添加到回退字体列表中。 |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | 将新字体添加到回退字体列表中。 |
| virtual void [Clear](./clear/)() | 从列表中移除所有字体。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | 获取在该范围内实际定义的字体数量。 |
| virtual **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() | 获取连续 Unicode 范围的最后索引。 |
| virtual **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() | 获取连续 Unicode 范围的第一个索引。 |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) | 获取指定索引处的字体名称。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) | 返回集合中指定规则的索引。 |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | 从列表中移除特定回退字体的第一次出现。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除列表中指定索引处的回退字体。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() | 创建并返回包含此规则所有回退字体的数组。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) | 创建并返回列表中指定范围内所有回退字体的数组。 |
