...
| [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() override | 指定全局唯一标识符 (GUID)，在 Office Open XML 文档中唯一标识单个自定义 XML 部分。只读 [System::Guid](../../system/guid/)。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() override | 返回与自定义 XML 部分关联的集合 XML 架构。只读 [System::String](../../system/string/)[]。 |
| [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() override | 返回 XML 数据作为 UTF-8 字符串。读取 [System::String](../../system/string/)。 |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() override | 返回 XML 数据。读取 **uint8_t**[]。 |
...
| void [Remove](./remove/)() override | 从演示文稿中删除自定义 XML 部分。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 按指定值减少共享引用计数。 |
| void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) override | 指定全局唯一标识符 (GUID)，在 Office Open XML 文档中唯一标识单个自定义 XML 部分。只读 [System::Guid](../../system/guid/)。 |
| void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) override | 设置 XML 数据为 UTF-8 字符串。写入 [System::String](../../system/string/)。 |
| void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | 设置 XML 数据。写入 **uint8_t**[]。 |
