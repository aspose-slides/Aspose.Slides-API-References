...
description: 表示摘要缩放框架中的摘要缩放节对象。
type: docs
weight: 3927
url: /zh/aspose.slides/isummaryzoomsection/
---
## ISummaryZoomSection 类


表示位于 摘要缩放 框架中的 摘要缩放 [Section](../section/) 对象。
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | 如果不存在则添加一个新的占位符，并将占位符属性设置为指定的属性。 |
...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | 属性指定形状在黑白显示模式下的呈现方式。阅读 [Slides::BlackWhiteMode](../blackwhitemode/)。 |
...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | 返回 Summary Zoom [Section](../section/) 对象的文本描述。 |
...
| virtual **float** [get_Height](../ishape/get_height/)() | 获取形状的高度，单位为点。只读 **float**。 |
| virtual **bool** [get_Hidden](../ishape/get_hidden/)() | 确定形状是否隐藏。只读 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkClick](../ihyperlinkcontainer/get_hyperlinkclick/)() | 返回为鼠标单击定义的超链接。只读 [IHyperlink](../ihyperlink/)。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkMouseOver](../ihyperlinkcontainer/get_hyperlinkmouseover/)() | 返回为鼠标悬停定义的超链接。只读 [IHyperlink](../ihyperlink/)。 |
| virtual [ZoomImageType](../zoomimagetype/) [get_ImageType](../izoomobject/get_imagetype/)() | 获取 zoom 对象的图像类型。只读 [ZoomImageType](../zoomimagetype/)。默认值：Preview |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | 返回在幻灯片范围内唯一的标识符，该标识符在形状生命周期内保持不变，允许 PowerPoint 或互操作代码在文档的任何位置可靠地引用该形状。只读 **uint32_t**。另请参阅 [IShape::get_UniqueId](../ishape/get_uniqueid/)。 |
...
| virtual **bool** [get_ReturnToParent](../izoomobject/get_returntoparent/)() | 获取幻灯片放映中的导航行为。只读 **bool**。默认值：false |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../isectionzoomframe/get_targetsection/)() | 获取 [Section](../section/) Zoom 对象链接的节对象。阅读 [ISection](../isection/)。 |
...
| virtual [System::String](../../system/string/) [get_Title](./get_title/)() | 返回 Summary Zoom [Section](../section/) 对象的文本标题。 |
| virtual **float** [get_TransitionDuration](../izoomobject/get_transitionduration/)() | 获取 Zoom 与幻灯片之间过渡的持续时间。只读 **float**。默认值：1.0f |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | 返回内部的、针对演示文稿范围的标识符，供插件或其他代码使用。由于该值可能被用户或程序重新分配，不能将其视为持久的唯一键。只读 **uint32_t**。另请参阅 [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)。 |
| virtual **float** [get_Width](../ishape/get_width/)() | 获取形状的宽度，单位为点。只读 **float**。 |
| virtual **float** [get_X](../ishape/get_x/)() | 获取形状左上角的 X 坐标，单位为点。只读 **float**。 |
| virtual **float** [get_Y](../ishape/get_y/)() | 获取形状左上角的 Y 坐标，单位为点。只读 **float**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](../izoomobject/get_zoomimage/)() | 获取 zoom 对象的图像。只读 [IPPImage](../ippimage/)。 |
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | 返回形状在 Z 顺序中的位置。Shapes[0] 返回 Z 顺序最背后的形状，Shapes[Shapes.Count - 1] 返回最前面的形状。只读 **int32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | 返回一个基本占位符形状（来自布局和/或母版幻灯片的形状，当前形状继承自该形状）。 |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | 属性指定形状在黑白显示模式下的呈现方式。写入 [Slides::BlackWhiteMode](../blackwhitemode/)。 |
| virtual void [set_Description](./set_description/)([System::String](../../system/string/)) | 返回 Summary Zoom [Section](../section/) 对象的文本描述。 |
...
| virtual void [set_HyperlinkClick](../ihyperlinkcontainer/set_hyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | 设置为鼠标单击定义的超链接。写入 [IHyperlink](../ihyperlink/)。 |
...
| virtual void [set_TargetSection](../isectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | 设置 [Section](../section/) Zoom 对象链接的节对象。写入 [ISection](../isection/)。 |
| virtual void [set_Title](./set_title/)([System::String](../../system/string/)) | 返回 Summary Zoom [Section](../section/) 对象的文本标题。 |
