...
| [ZoomImageType](../zoomimagetype/) [get_ImageType](./get_imagetype/)() override | 获取 Zoom 对象的图像类型。读取 [ZoomImageType](../zoomimagetype/)。默认值：Preview |
...
| **bool** [get_IsTextHolder](../shape/get_istextholder/)() override | 确定形状是否是 TextHolder_PPT。只读 **bool**。 |
...
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | 返回在幻灯片范围内唯一的标识符，在形状的整个生命周期保持不变，并且允许 PowerPoint 或互操作代码在文档的任何位置可靠地引用该形状。只读 **uint32_t**。另请参见 [Shape::get_UniqueId](../shape/get_uniqueid/)。 |
...
| **bool** [get_ReturnToParent](./get_returntoparent/)() override | 获取幻灯片放映中的导航行为。读取 **bool**。默认值：false |
...
| **bool** [get_ShowBackground](./get_showbackground/)() override | 获取指定 Zoom 是否使用目标幻灯片背景的值。读取 **bool**。默认值：true |
...
| **float** [get_TransitionDuration](./get_transitionduration/)() override | 获取 Zoom 与幻灯片之间过渡的持续时间。读取 **float**。默认值：1.0f |
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | 返回内部的、面向演示文稿的标识符，供插件或其他代码使用。由于此值可能被用户或程序重新分配，不能视为持久唯一键。只读 **uint32_t**。另请参见 [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](./get_zoomimage/)() override | 获取 Zoom 对象的图像。读取 [IPPImage](../ippimage/)。 |
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | 返回形状在 Z 顺序中的位置。Shapes[0] 返回 Z 顺序最底部的形状，Shapes[Shapes.Count - 1] 返回 Z 顺序最前面的形状。只读 **int32_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../shape/getbaseplaceholder/)() override | 返回基本占位符形状（来自布局和/或母版幻灯片的形状，当前形状继承自该形状）。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。实现自定义对象的哈希功能。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上并不拷贝任何内容，仅初始化新对象并允许子类的拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上并不拷贝任何内容，仅初始化新对象并允许子类的拷贝构造。 |
...
| void [set_ImageType](./set_imagetype/)([ZoomImageType](../zoomimagetype/)) override | 设置 Zoom 对象的图像类型。写入 [ZoomImageType](../zoomimagetype/)。默认值：Preview |
...
| void [set_ReturnToParent](./set_returntoparent/)(**bool**) override | 设置幻灯片放映中的导航行为。写入 **bool**。默认值：false |
| void [set_Rotation](../shape/set_rotation/)(**float**) override | 设置指定形状绕 z 轴旋转的角度（度）。正值表示顺时针旋转；负值表示逆时针旋转。写入 **float**。 |
| void [set_ShowBackground](./set_showbackground/)(**bool**) override | 设置指定 Zoom 是否使用目标幻灯片背景的值。写入 **bool**。默认值：true |
| void [set_TransitionDuration](./set_transitionduration/)(**float**) override | 设置 Zoom 与幻灯片之间过渡的持续时间。写入 **float**。默认值：1.0f |
...
| void [set_ZoomImage](./set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | 设置 Zoom 对象的图像。写入 [IPPImage](../ippimage/)。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而非共享指针）。允许在容器中将指针切换为弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 获取共享引用计数器的当前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 递增共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 递减并返回共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | 相当于 C# [Object.ToString()](../../system/object/tostring/) 方法。实现自定义对象的字符串转换。 |
