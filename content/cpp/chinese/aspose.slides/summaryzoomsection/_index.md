...
description: 表示在 Summary Zoom 框架中的 Summary Zoom Section 对象。
type: docs
weight: 5331
...
表示在 Summary Zoom 框架中的 Summary Zoom [Section](../section/) 对象。
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../shape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) override | 如果不存在，则添加一个新的占位符，并将占位符属性设置为指定的占位符。 |
...
| [System::String](../../system/string/) [get_Description](./get_description/)() override | 返回 Summary Zoom [Section](../section/) 对象的文本描述。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](../shape/get_effectformat/)() override | 返回包含像素效果的 [EffectFormat](../effectformat/) 对象。注意：对于某些没有效果属性的形状类型，可能返回 null。只读 [IEffectFormat](../ieffectformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](../shape/get_fillformat/)() override | 返回包含填充格式属性的 [FillFormat](../fillformat/) 对象。注意：对于某些没有填充属性的形状类型，可能返回 null。只读 [IFillFormat](../ifillformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGraphicalObjectLock](../igraphicalobjectlock/)\> [get_GraphicalObjectLock](../graphicalobject/get_graphicalobjectlock/)() override | 返回形状的锁定。只读 [IGraphicalObjectLock](../igraphicalobjectlock/)。 |
...
| [ZoomImageType](../zoomimagetype/) [get_ImageType](../zoomobject/get_imagetype/)() override | 获取缩放对象的图像类型。只读 [ZoomImageType](../zoomimagetype/)。默认值：Preview |
...
| [System::String](../../system/string/) [get_Name](../shape/get_name/)() override | 返回形状的名称。不能为空。如有需要，请使用空字符串。只读 [System::String](../../system/string/)。 |
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | 返回在幻灯片范围内唯一的标识符，该标识符在形状的生命周期内保持不变，并让 PowerPoint 或互操作代码能够在文档任何位置可靠地引用此形状。只读 **uint32_t**。另请参见 [Shape::get_UniqueId](../shape/get_uniqueid/)。 |
...
| **bool** [get_ReturnToParent](../zoomobject/get_returntoparent/)() override | 获取幻灯片放映中的导航行为。只读 **bool**。默认值：false |
...
| **bool** [get_ShowBackground](../zoomobject/get_showbackground/)() override | 获取指定 Zoom 是否使用目标幻灯片背景的值。只读 **bool**。默认值：true |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../sectionzoomframe/get_targetsection/)() override | 获取 [Section](../section/) Zoom 对象链接的章节对象。阅读 [ISection](../isection/)。 |
...
| [System::String](../../system/string/) [get_Title](./get_title/)() override | 返回 Summary Zoom [Section](../section/) 对象的文本标题。 |
| **float** [get_TransitionDuration](../zoomobject/get_transitionduration/)() override | 获取 Zoom 与幻灯片之间过渡的持续时间。只读 **float**。默认值：1.0f |
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | 返回内部的、演示文稿范围的标识符，供插件或其他代码使用。由于此值可能被用户或程序重新分配，不能视为持久唯一键。只读 **uint32_t**。另请参见 [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](../zoomobject/get_zoomimage/)() override | 获取缩放对象的图像。只读 [IPPImage](../ippimage/)。 |
...
| void [set_Description](./set_description/)([System::String](../../system/string/)) override | 返回 Summary Zoom [Section](../section/) 对象的文本描述。 |
...
| void [set_ShowBackground](../zoomobject/set_showbackground/)(**bool**) override | 设置指定 Zoom 是否使用目标幻灯片背景的值。写入 **bool**。默认值：true |
| void [set_TargetSection](../sectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | 设置 [Section](../section/) Zoom 对象链接的章节对象。写入 [ISection](../isection/)。 |
| void [set_Title](./set_title/)([System::String](../../system/string/)) override | 返回 Summary Zoom [Section](../section/) 对象的文本标题。 |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 增量共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 递减并返回共享引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | 相当于 C# [Object.ToString()](../../system/object/tostring/) 方法。启用将自定义对象转换为字符串。 |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | 实现 C# typeof([System.Object](../../system/object/)) 构造。 |
| void [Unlock](../../system/object/unlock/)() | 实现 C# lock() 语句的解锁。直接调用或使用 [LockContext](../../system/lockcontext/) 哨兵对象。 |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | 增量弱引用计数。不应直接调用；请使用智能指针或 ThisProtector。 |
