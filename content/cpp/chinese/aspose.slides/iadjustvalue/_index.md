...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | 返回值，将其解释为以度为单位的角度。读取 **float**。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 返回此调整值的名称。只读 [System::String](../../system/string/)。 |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | 返回“原样”调整值。读取 **int64_t**。 |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | 返回形状调整的类型。只读 [ShapeAdjustmentType](../shapeadjustmenttype/)。 |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | 设置值，将其解释为以度为单位的角度。写入 **float**。 |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | 设置“原样”调整值。写入 **int64_t**。 |
