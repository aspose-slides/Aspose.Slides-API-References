...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 获取指向 const 限定的集合实例中第一个元素（如果存在）的迭代器。 |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 获取指向集合中第一个 const 限定元素（如果存在）的迭代器。 |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 获取指向集合中最后一个 const 限定元素（如果存在）之后的迭代器。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>, **int32_t**) override | 将集合中的所有元素复制到指定的数组。 |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 将集合中的所有元素复制到指定的数组中。 |
| [iterator](./iterator/) [end](./end/)() | 获取指向集合中最后一个元素（如果存在）之后的迭代器。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 获取指向 const 限定的集合实例中最后一个元素（如果存在）之后的迭代器。 |
...
| **int32_t** [get_Count](./get_count/)() override | 返回集合中布局幻灯片的数量。只读 **int32_t**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) override | 返回指定类型的第一个布局幻灯片。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回遍历集合的枚举器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) override | 按索引返回布局幻灯片。只读 [LayoutSlide](../layoutslide/)。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不进行拷贝，只是初始化新对象并支持子类的拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不进行拷贝，只是初始化新对象并支持子类的拷贝构造。 |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | 从集合中移除布局。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定的值。 |
| void [RemoveUnused](./removeunused/)() override | 移除未使用的布局幻灯片（HasDependingSlides 为 false 的布局幻灯片）。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 获取指向 const 限定的集合实例中第一个元素（如果存在）的迭代器。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 获取指向 const 限定的集合实例中最后一个元素（如果存在）之后的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 获取指向集合中最后一个元素（如果存在）之后的迭代器。 |
