...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() override | 返回当前幻灯片的备注幻灯片，如果不存在则创建一个。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() override | 返回当前幻灯片的备注幻灯片。如果幻灯片没有备注幻灯片，则返回 null。只读 [INotesSlide](../inotesslide/)。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。其实不复制任何内容，只是初始化新对象并允许子类的拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。其实不复制任何内容，只是初始化新对象并允许子类的拷贝构造。 |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | 通过引用比较对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | 通过引用比较对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | 将值类型对象与 nullptr 进行引用比较。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化，用于字符串与 nullptr 情形。 |
...
| void [RemoveNotesSlide](./removenotesslide/)() override | 移除当前幻灯片的备注幻灯片。 |
...
下面的示例展示了如何向特定的 PowerPoint [Presentation](../presentation/) 幻灯片添加备注。 
```cpp
...
```
下面的示例展示了如何从 PowerPoint [Presentation](../presentation/) 的特定幻灯片中删除备注。 
```cpp
// 实例化一个表示演示文稿文件的 Presentation 对象
auto presentation = System::MakeObject<Presentation>(dataDir + u"AccessSlides.pptx");
// 删除第一张幻灯片的备注
...
* 类 [INotesSlideManager](../inotesslidemanager/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)