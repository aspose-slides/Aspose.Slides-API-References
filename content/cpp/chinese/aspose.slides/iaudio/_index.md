...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | 返回音频数据的副本。对于大量数据，请考虑使用 [IAudio::GetStream](./getstream/) 方法，以防止不必要地将音频数据加载到内存或导致 OutOfMemoryException。只读 **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | 返回音频的 MIME 类型，使用 [IAudio::get_BinaryData](./get_binarydata/) 编码。只读 [System::String](../../system/string/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。启用自定义对象的哈希。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | 返回用于读取的 Stream 流。使用 'using' 或在使用后关闭流。 |
