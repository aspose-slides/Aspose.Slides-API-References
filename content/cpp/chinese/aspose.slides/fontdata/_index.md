...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定两个 [FontData](./) 实例是否相等。 |
...
|  [FontData](./fontdata/)([System::String](../../system/string/)) | 使用指定的字体名称创建新的 [FontData](./) 对象。 |
| [System::String](../../system/string/) [get_FontName](./get_fontname/)() override | 返回字体名称。读取 [System::String](../../system/string/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) override | 返回字体名称，用实际使用的字体替换主题引用。 |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 作为特定类型的哈希函数，可用于哈希算法和像哈希表这样的数据结构。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，只是初始化新对象并启用子类的复制构造。 |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | 返回字符串表示。 |
