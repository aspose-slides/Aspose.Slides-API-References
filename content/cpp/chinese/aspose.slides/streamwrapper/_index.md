...
description: Aspose.IO.Stream 包装器，用于 COM 接口。
type: docs
weight: 5279
...
Aspose.IO.Stream 包装器，用于 COM 接口。
...
| 方法 | 描述 |
| --- | --- |
| void [Close](./close/)() override | 关闭当前流并释放任何资源。 |
...
| void [Flush](./flush/)() override | 清除此流的所有缓冲区并将任何缓冲数据写入底层设备。 |
| **bool** [get_CanRead](./get_canread/)() override | 获取一个值，指示当前流是否支持读取。只读 **bool**。 |
| **bool** [get_CanSeek](./get_canseek/)() override | 获取一个值，指示当前流是否支持定位。只读 **bool**。 |
| **bool** [get_CanWrite](./get_canwrite/)() override | 获取一个值，指示当前流是否支持写入。只读 **bool**。 |
| **int64_t** [get_Length](./get_length/)() override | 获取流的字节长度。只读 **int64_t**。 |
| **int64_t** [get_Position](./get_position/)() override | 获取当前流中的位置。只读 **int64_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [get_Stream](./get_stream/)() override | 获取一个流。只读 [System::IO::Stream](../../system.io/stream/)。 |
...
| void [Read](./read/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | 从当前流读取一系列字节，并将流中的位置前移已读取的字节数。 |
| **int32_t** [ReadByte](./readbyte/)() override | 从流中读取一个字节并将流中的位置前移一个字节；如果已到达流的末尾则返回 -1。 |
...
| **int64_t** [Seek](./seek/)(**int64_t**, [System::IO::SeekOrigin](../../system.io/seekorigin/)) override | 设置当前流中的位置 |
...
| void [Write](./write/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | 将一系列字节写入当前流，并将此流中的当前位置前移写入的字节数。 |
| void [WriteByte](./writebyte/)(**uint8_t**) override | 在流的当前位置写入一个字节，并将流中的位置前移一个字节。 |
