...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | 返回渐变停止点的颜色。只读 [IColorFormat](../icolorformat/)。 |
...
| **float** [get_Position](./get_position/)() override | 返回渐变停止点的位置 (0..1)。读取 **float**。 |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上不复制任何内容，只是初始化新对象并支持对子类的复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不复制任何内容，只是初始化新对象并支持对子类的复制构造。 |
...
| void [set_Position](./set_position/)(**float**) override | 设置渐变停止点的位置 (0..1)。写入 **float**。 |
