...
| virtual [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() | 返回敏感度标签的分配方法。阅读 [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() | 返回应应用于文件的内容标记类型列表。 |
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | 返回敏感度标签的 ID。阅读 [System::String](../../system/string/)。 |
| virtual **bool** [get_IsEnabled](./get_isenabled/)() | 指示敏感度标签是否已启用。 |
| virtual **bool** [get_IsRemoved](./get_isremoved/)() | 指示敏感度标签是否已被移除。 |
| virtual [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() | 返回与描述敏感度标签的敏感度标签策略对应的 Azure Active Directory (Azure AD) 站点标识符。阅读 [System::Guid](../../system/guid/)。 |
...
| virtual void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | 设置敏感度标签的分配方法。写入 [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)。 |
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | 设置敏感度标签的 ID。写入 [System::String](../../system/string/)。 |
| virtual void [set_IsEnabled](./set_isenabled/)(**bool**) | 指示敏感度标签是否已启用。 |
| virtual void [set_IsRemoved](./set_isremoved/)(**bool**) | 指示敏感度标签是否已被移除。 |
| virtual void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) | 设置与描述敏感度标签的敏感度标签策略对应的 Azure Active Directory (Azure AD) 站点标识符。写入 [System::Guid](../../system/guid/)。 |
