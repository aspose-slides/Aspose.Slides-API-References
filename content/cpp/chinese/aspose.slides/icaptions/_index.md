...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | 返回闭合字幕的二进制数据。只读 **uint8_t**[]。 |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | 返回闭合字幕的全局唯一标识符 (GUID)。只读 [System::Guid](../../system/guid/)。 |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | 以 UTF-8 编码的字符串返回闭合字幕数据。只读 [System::String](../../system/string/)。 |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | 返回闭合字幕的标签。只读 [System::String](../../system/string/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否为 targetType 所描述类型的实例。相当于 C# 的 'is' 操作符。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 针对 string 与 nullptr 的 [Object::ReferenceEquals](../../system/object/referenceequals/) 特化版本。 |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | 设置闭合字幕的标签。写入 [System::String](../../system/string/)。 |
