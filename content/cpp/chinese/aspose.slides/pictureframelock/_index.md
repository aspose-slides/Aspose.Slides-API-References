...
description: 确定在父 PictureFrame 上禁用的操作。
type: docs
weight: 4746
...
确定在父 [PictureFrame](../pictureframe/) 上被禁用的操作。
...
| **bool** [get_AdjustHandlesLocked](./get_adjusthandleslocked/)() override | 确定是否禁止更改调整值。读取 **bool**。 |
| **bool** [get_ArrowheadsLocked](./get_arrowheadslocked/)() override | 确定是否禁止更改箭头。读取 **bool**。 |
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | 确定在大小调整时形状是否必须保持纵横比。读取 **bool**。 |
| **bool** [get_CropLocked](./get_croplocked/)() override | 确定是否禁止对图像进行裁剪。读取 **bool**。 |
...
| **bool** [get_RotationLocked](./get_rotationlocked/)() override | 确定是否禁止更改此形状的旋转角度。读取 **bool**。 |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | 确定在大小调整时形状是否必须保持纵横比。写入 **bool**。 |
| void [set_CropLocked](./set_croplocked/)(**bool**) override | 确定是否禁止对图像进行裁剪。写入 **bool**。 |
...
| void [set_RotationLocked](./set_rotationlocked/)(**bool**) override | 确定是否禁止更改此形状的旋转角度。写入 **bool**。 |
...
* 类 [IPictureFrameLock](../ipictureframelock/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)