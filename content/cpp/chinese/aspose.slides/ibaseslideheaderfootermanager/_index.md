...
---
## IBaseSlideHeaderFooterManager 类
...
| virtual **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() | 获取指示日期时间占位符是否存在的值。读取**bool**。 |
| virtual **bool** [get_IsFooterVisible](./get_isfootervisible/)() | 获取指示页脚占位符是否存在的值。读取 **bool**。 |
| virtual **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() | 获取指示页码占位符是否存在的值。读取**bool**。 |
...
| virtual void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) | 设置幻灯片日期时间占位符的文本。 |
| virtual void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) | 更改幻灯片日期时间占位符的可见性。 |
| virtual void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) | 设置幻灯片页脚占位符的文本。 |
| virtual void [SetFooterVisibility](./setfootervisibility/)(**bool**) | 更改幻灯片页脚占位符的可见性。 |
| virtual void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) | 更改幻灯片页码占位符的可见性。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n'th 个模板参数设为弱指针（而非共享指针）。允许在容器中将指针切换为弱模式。 |
