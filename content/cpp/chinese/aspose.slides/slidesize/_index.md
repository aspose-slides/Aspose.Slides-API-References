...
| [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() override | 获取幻灯片方向。 |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | 获取以点为单位的幻灯片尺寸。 |
| [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() override | 获取幻灯片大小类型。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际并不复制任何内容，仅初始化新对象并启用子类的复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际并不复制任何内容，仅初始化新对象并启用子类的复制构造。 |
...
| void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) override | 设置幻灯片方向。 |
| void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) override | 按类型设置幻灯片大小并缩放已有内容。 |
| void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) override | 显式设置幻灯片尺寸并缩放已有内容。 |
