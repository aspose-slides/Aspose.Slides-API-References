...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | 返回指定索引处的绘图指南。只读 [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | 返回绘图指南的集合。只读 [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | 指定视图缩放比例（百分比）。读取 **int32_t**。 |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | 指定视图内容应自动缩放以最佳适应当前窗口大小。读取 **bool**。 |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | 指定视图缩放比例（百分比）。写入 **int32_t**。 |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | 指定视图内容应自动缩放以最佳适应当前窗口大小。写入 **bool**。 |
