...
| **uint32_t** [get_Index](./get_index/)() override | 获取占位符的索引。只读 **uint32_t**。 |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | 获取占位符的方向。只读 [Slides::Orientation](../orientation/)。 |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | 获取占位符的大小。只读 [PlaceholderSize](../placeholdersize/)。 |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | 获取占位符的类型。只读 [PlaceholderType](../placeholdertype/)。 |
...
| void [Lock](../../system/object/lock/)() | 实现 C# lock() 语句的锁定。可直接调用或使用 [LockContext](../../system/lockcontext/) 保护对象。 |
