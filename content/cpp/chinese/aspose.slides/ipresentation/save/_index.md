...
description: 将演示文稿的所有幻灯片保存为指定格式的文件。
type: docs
weight: 404
...
将演示文稿中指定的幻灯片保存为指定格式的文件，并使用附加选项。
...
将演示文稿中指定的幻灯片以指定格式保存到流中，并使用附加选项。
