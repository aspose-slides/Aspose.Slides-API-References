...
| section | [System::SharedPtr](../../../system/sharedptr/)\<[ISection](../../isection/)\> | [ISection](../../isection/) 所引用的 [Section](../../section/) Zoom 框；必须属于此演示文稿且至少包含一张幻灯片。 |
...
此示例演示了将 [Section](../../section/) Zoom 对象添加到集合的末尾（假设在 "Presentation.pptx" 演示文稿中至少有两个节）：
```cpp
...
创建一个带有预定义图像的新[Section](../../section/) Zoom 框并将其添加到形状集合的末尾。
...
| height | **float** | 新[Section](../../section/) Zoom 框的高度，单位为点。 |
| section | [System::SharedPtr](../../../system/sharedptr/)\<[ISection](../../isection/)\> | [ISection](../../isection/) 所引用的 [Section](../../section/) Zoom 框；必须属于此演示文稿且至少包含一张幻灯片。 |
| image | [System::SharedPtr](../../../system/sharedptr/)\<[IPPImage](../../ippimage/)\> | 在 [Section](../../section/) Zoom 框中显示的 [IPPImage](../../ippimage/)。 |
