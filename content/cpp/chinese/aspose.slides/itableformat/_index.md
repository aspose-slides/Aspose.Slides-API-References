...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | 返回表填充属性对象。只读 [IFillFormat](../ifillformat/)。 |
| virtual **float** [get_Transparency](./get_transparency/)() | 获取填充颜色的透明度。读取 **float**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() | 获取在继承和表样式应用后的有效表格格式属性。 |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | 设置填充颜色的透明度。写入 **float**。 |
