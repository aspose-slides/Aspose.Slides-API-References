...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，其中两个 NaN 被视为相等，尽管依据 IEC 60559:1989 标准，NaN 与任何值（包括 NaN）都不相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，其中两个 NaN 被视为相等，尽管依据 IEC 60559:1989 标准，NaN 与任何值（包括 NaN）都不相等。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | 返回绘图指南的颜色。读取 [System::Drawing::Color](../../system.drawing/color/)。 |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | 返回绘图指南的方向。读取 [Slides::Orientation](../orientation/)。 |
| **float** [get_Position](./get_position/)() override | 返回绘图指南在幻灯片左上角起点的以点为单位的位置。读取 **float**。 |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | 设置绘图指南的颜色。写入 [System::Drawing::Color](../../system.drawing/color/)。 |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | 设置绘图指南的方向。写入 [Slides::Orientation](../orientation/)。 |
| void [set_Position](./set_position/)(**float**) override | 设置绘图指南在幻灯片左上角起点的以点为单位的位置。写入 **float**。 |
