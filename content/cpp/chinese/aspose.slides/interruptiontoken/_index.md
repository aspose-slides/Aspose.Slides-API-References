...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | 如果请求了中断，则返回 **bool**.true。 |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | 表示一个空的中断令牌。 |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | 如果请求了中断，则抛出一个异常。 |
