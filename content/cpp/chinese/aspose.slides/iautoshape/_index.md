...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [AddTextFrame](./addtextframe/)([System::String](../../system/string/)) | 向形状添加一个新的 [TextFrame](../textframe/)。如果形状已经拥有 [TextFrame](../textframe/)，则仅更改其文本。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShapeLock](../iautoshapelock/)\> [get_AutoShapeLock](./get_autoshapelock/)() | 返回 [AutoShape](../autoshape/) 的锁定。只读 [IAutoShapeLock](../iautoshapelock/)。 |
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | 属性指定形状在黑白显示模式下的渲染方式。只读 [Slides::BlackWhiteMode](../blackwhitemode/)。 |
...
| virtual **bool** [get_IsTextBox](./get_istextbox/)() | 指定形状是否为文本框。 |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | 返回在幻灯片范围内唯一的标识符，该标识符在形状生命周期内保持不变，允许 PowerPoint 或互操作代码在文档任何位置可靠地引用该形状。只读 **uint32_t**。另请参阅 [IShape::get_UniqueId](../ishape/get_uniqueid/)。 |
...
| virtual [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](../igeometryshape/get_shapetype/)() | 返回几何预设类型。注意：值更改时，所有调整值将重置为默认值。只读 [Slides::ShapeType](../shapetype/)。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_TextFrame](./get_textframe/)() | 返回 [TextFrame](../textframe/) 对象用于 [AutoShape](../autoshape/)。只读 [ITextFrame](../itextframe/)。 |
...
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | 返回内部的、面向演示文稿的标识符，供插件或其他代码使用。由于此值可能被用户或程序重新分配，不能视为持久唯一键。只读 **uint32_t**。另请参阅 [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)。 |
| virtual **bool** [get_UseBackgroundFill](./get_usebackgroundfill/)() | 确定此自动形状是否应使用幻灯片的背景填充，而不是由样式或填充格式指定。读取 **bool**。 |
...
| virtual void [set_UseBackgroundFill](./set_usebackgroundfill/)(**bool**) | 确定此自动形状是否应使用幻灯片的背景填充，而不是由样式或填充格式指定。写入 **bool**。 |
...
| virtual void [SetGeometryPath](../igeometryshape/setgeometrypath/)([System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>) | 从 [IGeometryPath](../igeometrypath/) 对象更新形状几何。坐标必须相对于形状的左上角。将形状的类型 ([ShapeType](../shapetype/)) 更改为 [ShapeType::Custom](../shapetype/)。 |
| virtual void [SetGeometryPaths](../igeometryshape/setgeometrypaths/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>\>) | 从 [IGeometryPath](../igeometrypath/) 数组更新形状几何。坐标必须相对于形状的左上角。将形状的类型 ([ShapeType](../shapetype/)) 更改为 [ShapeType::Custom](../shapetype/)。 |
