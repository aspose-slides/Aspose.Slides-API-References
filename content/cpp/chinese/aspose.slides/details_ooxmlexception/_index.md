...
type: docs
weight: 638
url: /zh/aspose.slides/details_ooxmlexception/
---
## Details_OOXMLException 类
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 返回与当前对象表示的异常关联的 32 位 HRESULT 代码。 |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 设置 HRESULT，即分配给特定异常的数值代码。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法被 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类未从 std::exception 派生，但派生类可以使用受保护/私有成员实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
