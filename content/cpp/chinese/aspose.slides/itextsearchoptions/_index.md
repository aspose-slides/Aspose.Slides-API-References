...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | 设置为 true 以使用区分大小写的搜索，false 则不使用。读取 **bool**。 |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | 设置 **true** 以在执行文本搜索、替换或高亮操作时包括幻灯片备注中的文本。默认值为 **false**。 |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | 设置为 true 仅匹配完整词，false 则不匹配。读取 **bool**。 |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | 设置为 true 以使用区分大小写的搜索，false 则不使用。写入 **bool**。 |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | 设置 **true** 以在执行文本搜索、替换或高亮操作时包括幻灯片备注中的文本。默认值为 **false**。 |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | 设置为 true 仅匹配完整词，false 则不匹配。写入 **bool**。 |
