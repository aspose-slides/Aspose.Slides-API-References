...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) 类型。只读 [CameraPresetType](../camerapresettype/)。 |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV（0-180 度，视野）。只读 **float**。 |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) 缩放（以百分比表示的正值）。只读 **float**。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | 旋转通过纬度坐标、经度坐标以及关于该轴的旋转来定义。返回数组的第一个元素是纬度，第二个是经度，第三个是旋转。如果未定义旋转则返回 null。 |
