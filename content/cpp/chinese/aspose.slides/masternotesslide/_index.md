...
| **bool** [Equals](../baseslide/equals/)([System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\>) override | 确定两个 [IBaseSlide](../ibaseslide/) 实例是否相等。返回值基于幻灯片的结构和静态内容计算。如果所有形状、样式、文本、动画以及其他设置等均相等，则两个幻灯片相等。比较不考虑唯一标识符值，例如 SlideId，以及动态内容，例如 Date [Placeholder](../placeholder/) 中的当前日期值。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | 返回主注释幻灯片的绘图指南集合。只读 [IDrawingGuidesCollection](../idrawingguidescollection/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlideHeaderFooterManager](../imasternotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | 返回主注释幻灯片的 HeaderFooter 管理器。只读 [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_NotesStyle](./get_notesstyle/)() override | 返回注释文本的样式。只读 [ITextStyle](../itextstyle/)。 |
...
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | 指定主幻灯片上的形状是否应在幻灯片中显示。对于主幻灯片本身，此属性始终返回 **false**。读取 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISlideShowTransition](../islideshowtransition/)\> [get_SlideShowTransition](../baseslide/get_slideshowtransition/)() override | 返回 Transition 对象，其中包含关于指定幻灯片在放映期间如何前进的信息。只读 [ISlideShowTransition](../islideshowtransition/)。 |
...
| void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)() override | 在所有段落中以及所有可接受的形状中，将具有相同格式的运行合并。 |
| virtual void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\>) | 在所有段落和所有可接受的形状中，将具有相同格式的运行合并。 |
...
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | 指定主幻灯片上的形状是否应在幻灯片中显示。对于主幻灯片本身，此属性始终返回 **false**。写入 **bool**。 |
...
* 类 [IMasterNotesSlide](../imasternotesslide/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)