...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [AddAuthor](./addauthor/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 在集合的末尾添加新作者。 |
| [iterator](./iterator/) [begin](./begin/)() | 获取指向集合中第一个元素（如果存在）的迭代器。 |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 获取指向集合的 const 限定实例中第一个元素（如果存在）的迭代器。 |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 获取指向集合中第一个 const 限定元素（如果存在）的迭代器。 |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 获取指向集合中最后一个 const 限定元素之后的位置的迭代器（如果存在）。 |
| void [Clear](./clear/)() override | 从集合中移除所有作者。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\>, **int32_t**) override | 将集合中的所有元素复制到指定的数组。 |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 将集合中的所有元素复制到指定的数组中。 |
| [iterator](./iterator/) [end](./end/)() | 获取指向集合中最后一个元素之后的位置的迭代器（如果存在）。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 获取指向集合的 const 限定实例中最后一个元素之后的位置的迭代器（如果存在）。 |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | 使用 C# [Object.Equals](../../system/object/equals/) 语义比较对象。 |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较引用类型对象。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 风格比较值类型对象。 |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 样式的浮点比较，即使根据 IEC 60559:1989，两 NaN 也不等于任何值，包括 NaN，但此比较将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 样式的浮点比较，即使根据 IEC 60559:1989，两 NaN 也不等于任何值，包括 NaN，但此比较将两个 NaN 视为相等。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByName](./findbyname/)([System::String](../../system/string/)) override | 根据名称在集合中查找作者。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByNameAndInitials](./findbynameandinitials/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 根据名称和首字母在集合中查找作者。 |
| **int32_t** [get_Count](./get_count/)() override | 获取集合实际包含的元素数目。只读 **int32_t**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回一个遍历集合的枚举器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [idx_get](./idx_get/)(**int32_t**) override | 获取指定索引处的元素。只读 [ICommentAuthor](../icommentauthor/)。 |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>) override | 移除集合中指定作者的首次出现。 |
| void [RemoveAt](./removeat/)(**int32_t**) override | 移除集合中指定索引处的作者。 |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [ToArray](./toarray/)() override | 创建并返回包含所有作者的数组。 |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | 相当于 C# [Object.ToString()](../../system/object/tostring/) 方法。启用将自定义对象转换为字符串。 |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | 实现 C# typeof([System.Object](../../system/object/)) 构造。 |
| void [Unlock](../../system/object/unlock/)() | 实现 C# lock() 语句的解锁。直接调用或使用 [LockContext](../../system/lockcontext/) 哨兵对象。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 获取指向集合的 const 限定实例中第一个元素（如果存在）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 获取指向集合中第一个元素（如果存在）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 获取指向集合的 const 限定实例中最后一个元素之后的位置的迭代器（如果存在）。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 获取指向集合中最后一个元素之后的位置的迭代器（如果存在）。 |
...
| Typedef | Description |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 在当前集合中用作迭代器类型的集合类型。 |
...
* 类 [ICommentAuthorCollection](../icommentauthorcollection/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)