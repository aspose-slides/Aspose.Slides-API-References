...
type: docs
weight: 677
url: /zh/aspose.slides/details_pptexception/
---
## Details_PptException 类
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法被 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管该类未从 std::exception 继承，但派生类可以使用受保护/私有成员实现其逻辑。将此方法实现移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
