...
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() override | 返回复合脚本字体。阅读 [IFontData](../ifontdata/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() override | 返回东亚字体。阅读 [IFontData](../ifontdata/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() override | 返回拉丁字体。阅读 [IFontData](../ifontdata/)。 |
...
| [System::String](../../system/string/) [GetScriptFont](./getscriptfont/)([System::String](../../system/string/)) override | 从演示文稿主题获取与特定脚本标签关联的字体名称。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\> [GetScriptFontMap](./getscriptfontmap/)() override | 返回演示文稿中所有脚本字体定义的字典。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否是 targetType 描述的类型的实例。类似于 C# 的 'is' 运算符。 |
...
| void [RemoveScriptFont](./removescriptfont/)([System::String](../../system/string/)) override | 从主题的字体集合中移除与特定脚本标签关联的字体设置。 |
| void [set_ComplexScriptFont](./set_complexscriptfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | 设置复合脚本字体。写入 [IFontData](../ifontdata/)。 |
| void [set_EastAsianFont](./set_eastasianfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | 设置东亚字体。写入 [IFontData](../ifontdata/)。 |
| void [set_LatinFont](./set_latinfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | 设置拉丁字体。写入 [IFontData](../ifontdata/)。 |
| void [SetScriptFont](./setscriptfont/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 为特定脚本标签分配字体名称，该标签定义了演示文稿中该脚本文本的渲染方式。 |
