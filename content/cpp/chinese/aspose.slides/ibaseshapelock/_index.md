...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | 如果所有锁标志均已禁用则返回 true。只读 **bool**。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n'th 模板参数设为弱指针（而非共享）。允许在容器中将指针切换为弱模式。 |
