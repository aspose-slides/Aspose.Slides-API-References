...
description: 为特定脚本标签分配字体名称，该标签定义了该脚本文本在演示文稿中的呈现方式。
type: docs
weight: 105
url: /zh/aspose.slides/ifonts/setscriptfont/
---
## IFonts::SetScriptFont(System::String, System::String) 方法

为特定的脚本标签分配字体名称，该标签定义了该脚本文本在演示文稿中的呈现方式。
