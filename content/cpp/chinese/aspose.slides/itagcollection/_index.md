...
description: 表示标签的集合（用户自定义的字符串对）
type: docs
weight: 4057
...
| 方法 | 描述 |
| --- | --- |
| virtual **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | 将新标签添加到集合中。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。此迭代器不能用于更改引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的副本对象。 |
...
| virtual void [Clear](./clear/)() | 从集合中移除所有标签。 |
| virtual **bool** [Contains](./contains/)([System::String](../../system/string/)) | 确定集合是否包含特定名称。 |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)<T>, **int32_t**) | 将集合中的所有元素复制到指定的数组中。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的迭代器（如果有）。此迭代器不能用于更改引用的对象，因为 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的副本对象。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const&, **float** const&) | 模拟 C# 样式的浮点比较，即使根据 IEC 60559:1989，NaN 与任何值（包括 NaN）都不相等，也会将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const&, **double** const&) | 模拟 C# 样式的浮点比较，即使根据 IEC 60559:1989，NaN 与任何值（包括 NaN）都不相等，也会将两个 NaN 视为相等。 |
...
| virtual [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) | 返回指定索引处标签的键。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)<[System::String](../../system/string/)> [GetNamesOfTags](./getnamesoftags/)() | 返回标签的名称。 |
| virtual const [TypeInfo](../../system/typeinfo/)& [GetType](../../system/object/gettype/)() const | 获取对象的实际类型。相当于 C# [System.Object.GetType()](../../system/object/gettype/) 调用。 |
| virtual [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) | 返回指定索引处标签的值。 |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | 返回标签的键值对。 |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | 设置标签的键和值对。 |
| virtual **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) | 返回集合中指定键的零基索引。 |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | 从集合中移除具有指定名称的标签。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除指定索引处的标签。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定值。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而非共享）。允许在容器中将指针切换至弱模式。 |
