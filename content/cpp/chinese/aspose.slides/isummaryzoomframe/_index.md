...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989，NaN 与任何值（包括 NaN）都不相等，但此比较认为两个 NaN 相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989，NaN 与任何值（包括 NaN）都不相等，但此比较认为两个 NaN 相等。 |
...
| virtual [System::String](../../system/string/) [get_AlternativeTextTitle](../ishape/get_alternativetexttitle/)() | 返回与形状关联的替代文本的标题。阅读 [System::String](../../system/string/)。 |
...
| virtual **bool** [get_IsGrouped](../ishape/get_isgrouped/)() | 确定形状是否被分组。只读 **bool**。 |
| virtual **bool** [get_IsTextHolder](../ishape/get_istextholder/)() | 确定形状是否为 TextHolder。只读 **bool**。 |
| virtual [ZoomLayout](../zoomlayout/) [get_Layout](./get_layout/)() | 获取帧中 Summary Zoom 部分的布局。默认值为 GridLayout。 |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | 返回在幻灯片范围内的唯一标识符，在形状的生命周期内保持不变，使 PowerPoint 或互操作代码能够可靠地从文档中的任何位置引用该形状。只读 **uint32_t**。另请参阅 [IShape::get_UniqueId](../ishape/get_uniqueid/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGroupShape](../igroupshape/)\> [get_ParentGroup](../ishape/get_parentgroup/)() | 如果形状被分组，则返回父 [GroupShape](../groupshape/) 对象。否则返回 null。只读 [IGroupShape](../igroupshape/)。 |
...
| virtual **float** [get_Rotation](../ishape/get_rotation/)() | 返回指定形状围绕 z 轴旋转的角度（度）。正值表示顺时针旋转；负值表示逆时针旋转。只读 **float**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSectionCollection](../isummaryzoomsectioncollection/)\> [get_SummaryZoomCollection](./get_summaryzoomcollection/)() | 获取 Summary Zoom 框对象的 [ISummaryZoomSectionCollection](../isummaryzoomsectioncollection/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [get_SummaryZoomSection](./get_summaryzoomsection/)(**int32_t**) | 返回幻灯片中指定索引的 Summary Zoom [Section](../section/) 对象。只读 [Aspose::Slides::ISummaryZoomSection](../isummaryzoomsection/)。 |
...
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | 返回内部的、面向演示文稿的标识符，供插件或其他代码使用。由于此值可能被用户或程序重新分配，不能视为持久的唯一键。只读 **uint32_t**。另请参阅 [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)。 |
...
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | 返回形状在 Z 顺序中的位置。Shapes[0] 返回位于 Z 顺序最后面的形状，Shapes[Shapes.Count - 1] 返回位于最前面的形状。只读 **int32_t**。 |
...
| virtual void [set_AlternativeTextTitle](../ishape/set_alternativetexttitle/)([System::String](../../system/string/)) | 设置与形状关联的替代文本的标题。写入 [System::String](../../system/string/)。 |
