...
type: docs
weight: 742
url: /zh/aspose.slides/details_pptxreadexception/
---
## Details_PptxReadException 类


表示在读取演示文稿时出现错误时抛出的异常。
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 返回一个 32 位整数值，即与当前对象所代表的异常关联的 HRESULT 代码。 |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | 返回一个引用，指向表示内部异常的对象。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 对 [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化，用于 string 与 nullptr 的情况。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | 对 [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化，用于字符串的情况。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 实现 [what()](../../system/details_exception/what/) 方法，该方法被 [ExceptionWrapper](../../system/exceptionwrapper/) 类调用。尽管此类未从 std::exception 继承，但派生类可以使用受保护/私有成员实现其逻辑。将此方法实现移动到 [ExceptionWrapper](../../system/exceptionwrapper/) 可能会破坏该逻辑。 |
| virtual  [~Object](../../system/object/~object/)() | 销毁对象。释放所有内部数据结构。 |

## 另见

* 类 [Details_PptxException](../details_pptxexception/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)