...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，两个 NaN 被视为相等，即使 IEC 60559:1989 将 NaN 视为不等于任何值（包括 NaN）。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，两个 NaN 被视为相等，即使 IEC 60559:1989 将 NaN 视为不等于任何值（包括 NaN）。 |
...
| virtual [ResourceLoadingAction](../resourceloadingaction/) [ResourceLoading](./resourceloading/)([System::SharedPtr](../../system/sharedptr/)\<[IResourceLoadingArgs](../iresourceloadingargs/)\>) | 用于调节外部资源加载的回调方法。 |
