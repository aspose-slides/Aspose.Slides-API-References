...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() | 用于签署文档的证书对象。只读 [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)。 |
| virtual [System::String](../../system/string/) [get_Comments](./get_comments/)() | 签名的目的。读取 [System::String](../../system/string/)。 |
| virtual **bool** [get_IsValid](./get_isvalid/)() | 如果此数字签名有效且文档未被篡改，则此值为 true。只读 **bool**。 |
| virtual [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() | 文档签署的时间。只读 [System::DateTime](../../system/datetime/)。 |
...
| virtual void [set_Comments](./set_comments/)([System::String](../../system/string/)) | 签名的目的。写 [System::String](../../system/string/)。 |
