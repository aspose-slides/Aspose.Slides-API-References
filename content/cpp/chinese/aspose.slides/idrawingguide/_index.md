...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 返回绘图指南的颜色。读取 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | 返回绘图指南的方向。读取 [Slides::Orientation](../orientation/)。 |
| virtual **float** [get_Position](./get_position/)() | 返回绘图指南相对于幻灯片左上角的点位置。读取 **float**。 |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | 设置绘图指南的颜色。写入 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | 设置绘图指南的方向。写入 [Slides::Orientation](../orientation/)。 |
| virtual void [set_Position](./set_position/)(**float**) | 设置绘图指南相对于幻灯片左上角的点位置。写入 **float**。 |
