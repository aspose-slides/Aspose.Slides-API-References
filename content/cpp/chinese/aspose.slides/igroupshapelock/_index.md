...
确定在父 [GroupShape](../groupshape/) 上禁用的操作。
...
| virtual **bool** [get_UngroupingLocked](./get_ungroupinglocked/)() | 确定是否禁止拆分此组形状。读取 **bool**。 |
...
| virtual void [set_UngroupingLocked](./set_ungroupinglocked/)(**bool**) | 确定是否禁止拆分此组形状。写入 **bool**。 |
