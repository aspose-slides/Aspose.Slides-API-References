...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | 返回渐变停止点的颜色。只读 [IColorFormat](../icolorformat/)。 |
| virtual **float** [get_Position](./get_position/)() | 返回渐变停止点的位置 (0..1)。读取 **float**。 |
...
| virtual void [set_Position](./set_position/)(**float**) | 设置渐变停止点的位置 (0..1)。写入 **float**。 |
