...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | 返回图像数据的副本。只读 **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | 返回图像的 MIME 类型，使用 [IPPImage::get_BinaryData](./get_binarydata/) 编码。只读 [System::String](../../system/string/)。 |
| virtual **int32_t** [get_Height](./get_height/)() | 返回图像的高度。只读 **int32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [get_Image](./get_image/)() | 返回图像的副本。只读 [System::Drawing::Image](../../system.drawing/image/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\> [get_SvgImage](./get_svgimage/)() const | 返回 [ISvgImage](../isvgimage/) 对象 [ISvgImage](../isvgimage/) |
| virtual **int32_t** [get_Width](./get_width/)() | 返回图像的宽度。只读 **int32_t**。 |
| virtual **int32_t** [get_X](./get_x/)() | 返回图像的 X 偏移。只读 **int32_t**。 |
| virtual **int32_t** [get_Y](./get_y/)() | 返回图像的 Y 偏移。只读 **int32_t**。 |
...
| virtual void [ReplaceImage](./replaceimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 替换图像数据。 |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\>) | 替换图像。 |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](./)\>) | 替换图像。 |
| virtual void [set_SvgImage](./set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\>) | 设置 [ISvgImage](../isvgimage/) 对象 [ISvgImage](../isvgimage/) |
