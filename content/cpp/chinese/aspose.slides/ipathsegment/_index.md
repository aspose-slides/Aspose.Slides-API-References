...
表示 [GeometryShape](../geometryshape/) 的图形路径段
...
| virtual [PathCommandType](../pathcommandtype/) [get_PathCommand](./get_pathcommand/)() | 段的路径类型 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_SegmentData](./get_segmentdata/)() | 段的路径数据 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否为目标类型描述的实例。相当于 C# 'is' 运算符。 |
