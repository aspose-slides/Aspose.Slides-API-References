...
| virtual void [RemoveHyperlinkClick](./removehyperlinkclick/)() | 点击时移除超链接。 |
| virtual void [RemoveHyperlinkMouseOver](./removehyperlinkmouseover/)() | 鼠标悬停时移除超链接。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkClick](./setexternalhyperlinkclick/)([System::String](../../system/string/)) | 点击时设置外部超链接。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkMouseOver](./setexternalhyperlinkmouseover/)([System::String](../../system/string/)) | 鼠标悬停时设置外部超链接。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkClick](./setinternalhyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | 点击时设置内部超链接。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkMouseOver](./setinternalhyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | 鼠标悬停时设置内部超链接。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetMacroHyperlinkClick](./setmacrohyperlinkclick/)([System::String](../../system/string/)) | 点击时设置宏超链接。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设为弱指针（而非共享指针）。允许运行时将容器中的指针切换为弱模式。 |
