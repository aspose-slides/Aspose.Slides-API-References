...
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderBottom](./get_borderbottom/)() override | 返回底部边框线属性对象。只读 [ILineFormat](../ilineformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() override | 返回左上到右下对角线属性对象。只读 [ILineFormat](../ilineformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() override | 返回左下到右上对角线属性对象。只读 [ILineFormat](../ilineformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderLeft](./get_borderleft/)() override | 返回左侧边框线属性对象。只读 [ILineFormat](../ilineformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderRight](./get_borderright/)() override | 返回右侧边框线属性对象。只读 [ILineFormat](../ilineformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderTop](./get_bordertop/)() override | 返回顶部边框线属性对象。只读 [ILineFormat](../ilineformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | 返回单元格填充属性对象。只读 [IFillFormat](../ifillformat/)。 |
...
| **float** [get_Transparency](./get_transparency/)() override | 获取填充颜色的透明度。读取 **float**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ICellFormatEffectiveData](../icellformateffectivedata/)\> [GetEffective](./geteffective/)() override | 获取带有继承和表格样式的有效表格单元格格式属性。 |
...
| void [set_Transparency](./set_transparency/)(**float**) override | 设置填充颜色的透明度。写入 **float**。 |
