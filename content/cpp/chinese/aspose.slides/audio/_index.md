...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | 返回音频数据的副本。如果数据量较大，建议使用 [Audio::GetStream](./getstream/) 方法，以防止不必要地将音频数据加载到内存中或导致 OutOfMemoryException。只读 **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | 返回音频的 MIME 类型，使用 [Audio::get_BinaryData](./get_binarydata/) 编码。只读 [System::String](../../system/string/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | 返回用于读取的 Stream 流。使用 'using' 或在使用完后关闭流。 |
...
| void [set_ContentType](./set_contenttype/)([System::String](../../system/string/)) | 返回音频的 MIME 类型，使用 [Audio::get_BinaryData](./get_binarydata/) 编码。只读 [System::String](../../system/string/)。 |
