...
description: 封装了对象可以成为属性值继承主体的基础服务基础设施。
type: docs
weight: 4928
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，两个 NaN 被视为相等，即使 IEC 60559:1989 规定 NaN 与任何值（包括 NaN）都不相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，两个 NaN 被视为相等，即使 IEC 60559:1989 规定 NaN 与任何值（包括 NaN）都不相等。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。不实际复制任何内容，只是初始化新对象并允许子类的复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。不实际复制任何内容，只是初始化新对象并允许子类的复制构造。 |
