...
| 方法 | 描述 |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | 将 [Paragraph](../paragraph/) 添加到集合的末尾。 |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | 将 [ParagraphCollection](./) 的内容添加到集合的末尾。 |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | 将指定 HTML 字符串中的文本添加到集合中。 |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | 将指定 HTML 字符串中的文本添加到集合中。 |
...
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | 确定 [ICollection](../../system.collections.generic/icollection/) 是否包含特定值。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | 将 [ICollection](../../system.collections.generic/icollection/) 的元素复制到 [System::Array](../../system/array/)，从特定的 [System::Array](../../system/array/) 索引开始。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 两个 NaN 不相等，仍将两个 NaN 视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，即使根据 IEC 60559:1989 两个 NaN 不相等，仍将两个 NaN 视为相等。 |
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | 将指定段落转换为 HTML 并作为 String 对象返回。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| **int32_t** [get_Count](./get_count/)() override | 获取集合实际包含的元素数量。只读 **int32_t**。 |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | 获取指示 [ICollection](../../system.collections.generic/icollection/) 是否只读的值。只读 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回一个遍历集合的枚举器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | 获取指定索引处的元素。 |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | 确定 [IList](../../system.collections.generic/ilist/) 中特定项的索引。 |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | 在指定索引处向集合插入一个 [Paragraph](../paragraph/)。 |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | 在指定索引处向集合插入 [ParagraphCollection](./) 的内容。 |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | 从 [ICollection](../../system.collections.generic/icollection/) 中删除特定对象的第一次出现。 |
...
| 类型定义 | 描述 |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 用于当前集合的迭代器类型的集合类型。 |
...
* 类 [IParagraphCollection](../iparagraphcollection/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)