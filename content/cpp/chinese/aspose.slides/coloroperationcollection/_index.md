...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) override | 将新操作添加到集合的末尾。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) override | 将新操作添加到集合的末尾。 |
...
| void [Clear](./clear/)() override | 移除所有颜色操作。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](./clone/)() override | 创建一个 [ColorOperationCollection](./) 集合的副本。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperationCollection](../icoloroperationcollection/)\> [CloneT](./clonet/)() override | 克隆当前对象 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>\>, **int32_t**) override | 将集合中的所有元素复制到指定的数组。 |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | 获取指向 const 限定实例中最后一个元素（如果有）之后的迭代器。 |
...
| **int32_t** [get_Count](./get_count/)() override | 返回集合中操作的数量。只读 **int32_t**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回一个遍历集合的枚举器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) override | 返回指定索引处的操作。只读 [ColorOperation](../coloroperation/)。 |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) override | 设置指定索引处的操作。写入 [ColorOperation](../coloroperation/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) override | 向集合中插入新操作。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) override | 向集合中插入新操作。 |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | 从集合中移除颜色操作。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 获取指向 const 限定实例中最后一个元素（如果有）之后的迭代器。 |
...
* 类 [IColorOperationCollection](../icoloroperationcollection/)
* 命名空间 [Aspose::Slides](../)
* 库 [Aspose.Slides](../../)