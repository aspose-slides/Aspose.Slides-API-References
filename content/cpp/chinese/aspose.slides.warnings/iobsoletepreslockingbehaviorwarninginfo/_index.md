...
description: 此警告表示使用了已过时的呈现锁定行为。
type: docs
weight: 27
url: /zh/aspose.slides.warnings/iobsoletepreslockingbehaviorwarninginfo/
---
## IObsoletePresLockingBehaviorWarningInfo 类
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 如果 receiver 不为 null，则将警告发送给指定的接收者，并在接收者决定中止操作时抛出 AbortRequestedException。 |
