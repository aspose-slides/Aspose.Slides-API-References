...
description: 表示一个关于已知问题的警告，该问题在近期内不会被修复。
type: docs
weight: 1
url: /zh/aspose.slides.warnings/iknownissuewarninginfo/
---
## IKnownIssueWarningInfo 类

表示一个关于已知问题的警告，该问题在近期内不会被修复。
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 如果接收器不为 null，则将警告发送给指定接收器，并在接收器决定中止操作时抛出 AbortRequestedException。 |
