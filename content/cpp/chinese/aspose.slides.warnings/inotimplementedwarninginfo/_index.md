...
description: 表示已知未实现特性的警告，该特性在近期不会实现。
type: docs
weight: 14
url: /zh/aspose.slides.warnings/inotimplementedwarninginfo/
---
## INotImplementedWarningInfo 类

表示已知未实现特性的警告，该特性在近期不会实现。
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | 返回此警告的可读描述。只读 [System::String](../../system/string/)。 |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 如果接收器不为 null，则向指定的接收器发送警告，并在接收器决定中止操作时抛出 AbortRequestedException。 |
