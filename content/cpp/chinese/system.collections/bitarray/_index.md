...
description: "可以通过索引访问的位数组。此类的对象应仅使用 System::MakeObject() 函数进行分配。不要在栈上或使用 operator new 创建此类型的实例，因为这会导致运行时错误和/或断言故障。请始终将此类包装为 System::SmartPtr 指针，并使用该指针将其作为参数传递给函数。"
type: docs
weight: 1
url: /zh/system.collections/bitarray/
---
## BitArray 类

[Array](../../system/array/) 位的集合，可通过索引访问。此类的对象应仅使用 [System::MakeObject()](../../system/makeobject/) 函数分配。切勿在栈上或使用 operator new 创建此类型的实例，因为会导致运行时错误和/或断言错误。始终将此类包装成 [System::SmartPtr](../../system/smartptr/) 指针，并使用该指针将其作为参数传递给函数。
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const **bool**\&) override | 将值添加到容器末尾。 |
| [BitArrayPtr](../bitarrayptr/) [And](./and/)(const [BitArrayPtr](../bitarrayptr/)\&) | 计算两个 BitSet 之间的按位 'and'。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果存在）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，无法使用此迭代器修改引用的对象。 |
...
|  [BitArray](./bitarray/)(const [bitset](./bitset/)\&) | 拷贝构造函数。 |
|  [BitArray](./bitarray/)(const [BitArray](./)\&) | 拷贝构造函数。 |
|  [BitArray](./bitarray/)(const [BitArrayPtr](../bitarrayptr/)\&) | 拷贝构造函数。 |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**bool**\>\&) | 拷贝构造函数。 |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | 拷贝构造函数。 |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<int\>\&) | 拷贝构造函数。 |
...
| **bool** [Contains](./contains/)(const **bool**\&) const override | 检查容器中是否存在特定值。未实现。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<**bool**\>, int) override | 将数据复制到已有的数组元素。 |
| [bitset](./bitset/)\& [data](./data/)() | 底层数据结构访问。 |
| const [bitset](./bitset/)\& [data](./data/)() const | 底层数据结构访问。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素之后的位置的迭代器（如果存在）。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，无法使用此迭代器修改引用的对象。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 获取指向 const 限定实例中最后一个元素之后的位置的迭代器（如果存在）。 |
...
| **bool** [Get](./get/)(int) const | 获取 [BitArray](./) 元素。 |
| int [get_Count](./get_count/)() const override | 获取容器大小。 |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | 检查集合是否为只读。 |
| int [get_Length](./get_length/)() const | 获取容器大小。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<**bool**\>\> [GetEnumerator](./getenumerator/)() override | 创建枚举器对象。 |
...
| **bool** [idx_get](./idx_get/)(int) const | 获取函数。 |
| void [idx_set](./idx_set/)(int, **bool**) | 设置函数。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | 返回从序列起始的指定数量的连续元素。 |
...
| [BitArrayPtr](../bitarrayptr/) [Not](./not/)() | 对 BitSet 取反。 |
|  [Object](../../system/object/object/)() | 创建对象。初始化所有内部数据结构。 |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，仅初始化新对象并允许子类的拷贝构造。 |
| **bool** [operator!=](./operator_not_equal/)(const [BitArray](./)\&) const | 按位比较运算符。 |
...
| **bool** [operator==](./operator_equal_equal/)(const [BitArray](./)\&) const | 按位比较运算符。 |
| **Reference** [operator[]](./operator[]/)(int) | 访问函数。 |
| [BitArrayPtr](../bitarrayptr/) [Or](./or/)(const [BitArrayPtr](../bitarrayptr/)\&) | 计算两个 BitSet 之间的按位 'or'。 |
...
| **bool** [Remove](./remove/)(const **bool**\&) override | 返回指定值的第一次出现。未实现。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定值。 |
| void [Set](./set/)(int, **bool**) | 设置 [BitArray](./) 元素。 |
| void [SetAll](./setall/)(**bool**) | 将所有元素设置为特定值。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 弱模板参数机制的正式实现；此类不适用。 |
...
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 获取当前容器的 const begin 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 获取当前容器的 begin 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 获取当前容器的 const end 迭代器实现。 |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | 获取当前容器的 end 迭代器实现。 |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | 增加弱引用计数。不应直接调用；请改用智能指针或 ThisProtector。 |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | 递减弱引用计数。不应直接调用；请改用智能指针或 ThisProtector。 |
| [BitArrayPtr](../bitarrayptr/) [Xor](./xor/)(const [BitArrayPtr](../bitarrayptr/)\&) | 计算两个 BitSet 之间的按位 'xor'。 |
