...
description: IEnumerable 是所有可枚举的非泛型集合的基础接口。
type: docs
weight: 53
url: /zh/system.collections/ienumerable/
---
## IEnumerable 类

[IEnumerable](./) 是所有可枚举的非泛型集合的基础接口。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | 返回遍历集合的枚举器。 |
