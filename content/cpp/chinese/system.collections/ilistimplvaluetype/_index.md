...
description: "在 System::Collections::Generic::List 对象上实现 System::Collections::IList 接口的存根，针对值类型的实现。"
type: docs
weight: 144
url: /zh/system.collections/ilistimplvaluetype/
---
## IListImplValueType 类


存根，实现 [System::Collections::IList](../ilist/) 接口于 [System::Collections::Generic::List](../../system.collections.generic/list/) 对象，针对值类型的实现。
...
| virtual **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() const | 获取一个值，指示列表是否具有固定大小。 |
...
|  [IListImplValueType](./ilistimplvaluetype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) | 创建新对象实例。 |
| int [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const override | 获取项目在容器中首次出现的索引。 |
| void [Insert](./insert/)(int, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 在指定位置插入元素，后面的元素向后移动。 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否是 targetType 描述的类型的实例。C# 'is' 操作符的类比。 |
...
| void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 从列表中移除特定项的第一次出现。 |
