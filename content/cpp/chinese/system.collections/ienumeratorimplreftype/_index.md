...
description: 在通用迭代器 IEnumeratorImplRefType 之上创建非泛型 IEnumerator 实现的包装器——用于引用类型的包装器。
type: docs
weight: 79
url: /zh/system.collections/ienumeratorimplreftype/
---
## IEnumeratorImplRefType 类
...
|  [IEnumeratorImplRefType](./ienumeratorimplreftype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<T\>\>\>) | 包装构造函数 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否是 targetType 描述的类型实例。类似于 C# 'is' 运算符。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定的值。 |
| virtual void [Reset](../ienumerator/reset/)() | 将枚举器重置到第一个元素之前的位置。 |
