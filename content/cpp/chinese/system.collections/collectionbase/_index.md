...
description: 提供一个用于强类型集合的抽象基类。
type: docs
weight: 27
url: /zh/system.collections/collectionbase/
---
## CollectionBase 类
...
| 方法 | 描述 |
| --- | --- |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 获取指向集合中第一个元素（如果有）的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，不能使用该迭代器修改所引用的对象。 |
...
| void [Clear](./clear/)() | 从集合实例中移除所有对象。此方法不可被覆盖。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 获取指向集合中最后一个元素（如果有）之后的迭代器。由于 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 返回 T 的拷贝对象，不能使用该迭代器修改所引用的对象。 |
...
| **int32_t** [get_Capacity](./get_capacity/)() | 返回集合能够容纳的元素数量。 |
| **int32_t** [get_Count](./get_count/)() | 返回集合实例中包含的元素数量。此方法不可被覆盖。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | 返回一个用于遍历集合实例的枚举器。 |
...
| void [RemoveAt](./removeat/)(**int32_t**) | 移除集合实例中指定索引处的元素。此方法不可被覆盖。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 按指定值减少共享引用计数。 |
| void [set_Capacity](./set_capacity/)(**int32_t**) | 设置集合能够容纳的元素数量。 |
...
| 类型别名 | 描述 |
| --- | --- |
| [Ptr](./ptr/) | 此类实例的 shared pointer 的别名。 |
## 另请参见
