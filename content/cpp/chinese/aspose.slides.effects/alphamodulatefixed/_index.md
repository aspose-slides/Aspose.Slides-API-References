...
description: 表示 Alpha Modulate Fixed 效果。效果的 alpha（不透明度）值乘以固定的百分比。
type: docs
weight: 66
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [AlphaModulateFixed](./) 是否等于当前的 [AlphaModulateFixed](./)。 |
...
| **float** [get_Amount](./get_amount/)() override | 返回效果的百分比数值。读取 **float**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 Alpha Modulate Fixed 效果数据。 |
...
| void [set_Amount](./set_amount/)(**float**) override | 返回效果的百分比量。写入 **float**。 |
...
* 类 [IAlphaModulateFixed](../ialphamodulatefixed/)
