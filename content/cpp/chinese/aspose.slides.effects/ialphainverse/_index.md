...
description: 表示 Alpha 逆向效果。Alpha（不透明度）值通过从 100% 中减去来进行反转。
type: docs
weight: 313
...
表示 Alpha 逆向效果。Alpha（不透明度）值通过从 100% 中减去来进行反转。
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上什么也不复制，只是初始化新对象并允许子类的复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上什么也不复制，只是初始化新对象并允许子类的复制构造。 |
