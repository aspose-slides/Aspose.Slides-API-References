...
description: 表示软边缘效果。形状的边缘被模糊，而填充不受影响。
type: docs
weight: 1080
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [SoftEdge](./) 是否等于当前的 [SoftEdge](./)。 |
...
| **double** [get_Radius](./get_radius/)() override | 指定要应用于边缘的模糊半径。读取 **double**。 |
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../../aspose.slides/ipviobject/get_version/)() | 版本。只读 **uint32_t**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 Soft Edge 效果数据。 |
...
| void [set_Radius](./set_radius/)(**double**) override | 指定要应用于边缘的模糊半径。写入 **double**。 |
