...
---
## ITintEffectiveData 类


不可变对象，表示一个 [Tint](../tint/) 效果。按指定量将效果颜色值向/远离色相移动。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 样式的浮点比较，即使根据 IEC 60559:1989 两个 NaN 不相等，也将其视为相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 样式的浮点比较，即使根据 IEC 60559:1989 两个 NaN 不相等，也将其视为相等。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual **float** [get_Amount](./get_amount/)() | 返回效果量。只读 **float**。 |
| virtual **float** [get_Hue](./get_hue/)() | 返回色相。只读 **float**。 |
