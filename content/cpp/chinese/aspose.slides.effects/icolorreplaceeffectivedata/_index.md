...
description: 不可变对象，表示颜色替换效果。所有效果颜色均被更改为固定颜色。Alpha 值不受影响。
type: docs
weight: 547
url: /zh/aspose.slides.effects/icolorreplaceeffectivedata/
---
## IColorReplaceEffectiveData 类

不可变对象，表示颜色替换效果。所有效果颜色均被更改为固定颜色。Alpha 值不受影响。
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 返回将替换每个像素颜色的颜色格式。只读 [System::Drawing::Color](../../system.drawing/color/)。 |
