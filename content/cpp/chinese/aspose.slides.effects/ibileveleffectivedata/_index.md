...
description: 不可变对象，表示二值（黑/白）效果。亮度低于指定阈值的输入颜色将被更改为黑色。亮度大于或等于指定阈值的输入颜色将被设置为白色。Alpha 效果值不受此效果影响。
type: docs
weight: 443
url: /zh/aspose.slides.effects/ibileveleffectivedata/
---
## IBiLevelEffectiveData 类

不可变对象，表示二值（黑/白）效果。亮度低于指定阈值的输入颜色将被更改为黑色。亮度大于或等于指定值的输入颜色将被设置为白色。Alpha 效果值不受此效果影响。
...
| virtual **float** [get_Threshold](./get_threshold/)() | 返回阈值。只读 **float**。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 在 strings 情形下的特化。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 将共享引用计数减少指定的值。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设为弱指针（而非共享）。允许在容器中切换指针至弱模式。 |
