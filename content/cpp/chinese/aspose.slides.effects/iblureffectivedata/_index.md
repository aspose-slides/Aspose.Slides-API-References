...
description: 不可变对象，表示应用于整个形状（包括其填充）的模糊效果。所有颜色通道，包括 alpha，均受到影响。
type: docs
weight: 469
url: /zh/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData 类

不可变对象，表示应用于整个形状（包括其填充）的 [Blur](../blur/) 效果。所有颜色通道，包括 alpha，都受到影响。
...
| virtual **bool** [get_Grow](./get_grow/)() | 确定对象的边界是否应因模糊而扩大。True 表示边界被扩大，false 表示未扩大。只读 **bool**。 |
