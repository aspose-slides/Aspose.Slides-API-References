...
| virtual **float** [get_Hue](./get_hue/)() | 返回色相百分比。只读 **float**。 |
| virtual **float** [get_Luminance](./get_luminance/)() | 返回亮度百分比。只读 **float**。 |
| virtual **float** [get_Saturation](./get_saturation/)() | 返回饱和度百分比。只读 **float**。 |
