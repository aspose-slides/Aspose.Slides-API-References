...
description: 表示 Alpha Ceiling 效果。Alpha（不透明度）值大于零的将被更改为 100%。换句话说，任何部分不透明的对象都会变为完全不透明。
type: docs
weight: 14
...
表示 Alpha Ceiling 效果。大于零的 Alpha（不透明度）值将被更改为 100%。换句话说，任何部分不透明的对象将变为完全不透明。
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [AlphaCeiling](./) 是否等于当前的 [AlphaCeiling](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取在应用继承后的有效 Alpha Ceiling 效果数据。 |
