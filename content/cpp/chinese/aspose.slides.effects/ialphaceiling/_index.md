...
description: 表示 Alpha Ceiling 效果。Alpha（不透明度）大于零的值将被更改为 100%。换句话说，任何部分不透明的对象都会变为完全不透明。
type: docs
weight: 261
...
表示 Alpha Ceiling 效果。Alpha（不透明度）值大于零的会被更改为 100%。换句话说，任何部分透明的对象都会变为完全不透明。
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上并不复制任何内容，只是初始化新对象并允许对子类进行复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上并不复制任何内容，只是初始化新对象并允许对子类进行复制构造。 |
