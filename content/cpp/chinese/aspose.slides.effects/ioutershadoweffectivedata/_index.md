...
| virtual **float** [get_Direction](./get_direction/)() | 阴影方向。只读 **float**。 |
| virtual **double** [get_Distance](./get_distance/)() | 阴影距离。只读 **double**。 |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | 矩形对齐。只读 [RectangleAlignment](../../aspose.slides/rectanglealignment/)。 |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | 指定阴影是否应随形状旋转（如果形状已旋转）。只读 **bool**。 |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | 指定水平缩放因子，负值缩放会导致翻转。只读 **double**。 |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | 指定垂直缩放因子，负值缩放会导致翻转。只读 **double**。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | 阴影颜色。只读 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | 指定水平倾斜角度（以度为单位）。只读 **double**。 |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | 指定垂直倾斜角度（以度为单位）。只读 **double**。 |
