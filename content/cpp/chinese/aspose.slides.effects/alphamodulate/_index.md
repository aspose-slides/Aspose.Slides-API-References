...
description: 表示 Alpha Modulate 效果。效果的 alpha（不透明度）值将乘以固定的百分比。效果容器指定包含要调制的 alpha 值的效果。
type: docs
weight: 53
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [AlphaModulate](./) 是否等于当前的 [AlphaModulate](./)。 |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | 返回父对象 [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)。只读 [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateEffectiveData](../ialphamodulateeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 Alpha Modulate 效果数据。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设置为弱指针（而不是共享指针）。允许在容器中将指针切换到弱模式。 |
...
* 类 [IAlphaModulate](../ialphamodulate/)
