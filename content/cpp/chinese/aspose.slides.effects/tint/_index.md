...
description: 表示一种 Tint 效果。按指定的量将效果颜色值向/远离色相移动。
type: docs
weight: 1093
...
表示一种 [Tint](./) 效果。按指定量将效果颜色值向/远离色相移动。
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [Tint](./) 是否等于当前的 [Tint](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 [Tint](./) 效果数据。 |
