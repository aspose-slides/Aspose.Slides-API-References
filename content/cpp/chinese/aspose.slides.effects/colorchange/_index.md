...
description: 表示一种颜色更改效果。FromColor 的实例将被 ToColor 的实例替换。
type: docs
weight: 131
...
表示一种颜色更改效果。FromColor 的实例将被 ToColor 的实例替换。
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [ColorChange](./) 是否等于当前的 [ColorChange](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_FromColor](./get_fromcolor/)() override | 将被替换的颜色。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ToColor](./get_tocolor/)() override | 将替换的颜色。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorChangeEffectiveData](../icolorchangeeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 Color Change 效果数据。 |
