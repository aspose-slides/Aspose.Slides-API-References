...
description: 表示 Alpha Inverse 效果。Alpha（不透明度）值通过从 100% 中减去来进行反转。
type: docs
weight: 40
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [AlphaInverse](./) 是否等于当前的 [AlphaInverse](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverseEffectiveData](../ialphainverseeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 Alpha Inverse 效果数据。 |
