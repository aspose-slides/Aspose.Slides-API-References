...
type: docs
weight: 911
url: /zh/aspose.slides.effects/ippresetshadow/
---
## IPresetShadow 类
...
| virtual **float** [get_Direction](./get_direction/)() | 阴影方向。读取 **float**。 |
| virtual **double** [get_Distance](./get_distance/)() | 阴影距离。读取 **double**。 |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | 预设。读取 [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | 阴影颜色。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| virtual void [set_Direction](./set_direction/)(**float**) | 阴影方向。写入 **float**。 |
| virtual void [set_Distance](./set_distance/)(**double**) | 阴影距离。写入 **double**。 |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | 预设。写入 [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
