...
description: 表示一个亮度效果。亮度线性地将所有颜色向白色或黑色移动。对比度将所有颜色缩放，使它们更接近或更远离。
type: docs
weight: 794
...
表示一个 [Luminance](../luminance/) 效果。亮度线性地将所有颜色向白色或黑色移动。对比度将所有颜色缩放，使它们更接近或更远离。
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上不复制任何内容，只是初始化新对象并启用子类的拷贝构造。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 个模板参数设为弱指针（而不是共享）。允许在容器中切换指针到弱模式。 |
