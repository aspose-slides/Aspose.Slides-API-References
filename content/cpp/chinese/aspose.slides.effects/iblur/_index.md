...
description: 表示一个应用于整个形状（包括填充）的模糊效果。所有颜色通道，包括 alpha，均受到影响。
type: docs
weight: 456
...
表示一个应用于整个形状（包括填充）的 [Blur](../blur/) 效果。所有颜色通道，包括 alpha，均受到影响。
...
| virtual **bool** [get_Grow](./get_grow/)() | 确定由于模糊效果对象的边界是否应扩大。True 表示边界被扩大，false 表示未扩大。只读 **bool**。 |
| virtual **double** [get_Radius](./get_radius/)() | 返回模糊半径。只读 **double**。 |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | 确定由于模糊效果对象的边界是否应扩大。True 表示边界被扩大，false 表示未扩大。写入 **bool**。 |
| virtual void [set_Radius](./set_radius/)(**double**) | 设置模糊半径。写入 **double**。 |
