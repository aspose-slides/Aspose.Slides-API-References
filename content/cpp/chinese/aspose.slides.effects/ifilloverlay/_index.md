...
description: 表示填充覆盖效果。填充覆盖可用于为对象指定额外的填充并将两种填充混合在一起。
type: docs
weight: 612
...
表示填充覆盖效果。填充覆盖可用于为对象指定额外的填充并将两种填充混合在一起。
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode。读取 [FillBlendMode](../../aspose.slides/fillblendmode/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() | 填充格式。只读 [IFillFormat](../../aspose.slides/ifillformat/)。 |
...
| virtual void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) | FillBlendMode。写入 [FillBlendMode](../../aspose.slides/fillblendmode/)。 |
