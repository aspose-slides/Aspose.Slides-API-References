...
description: 不可变对象，表示一种 Glow 效果，在对象的边缘之外添加颜色模糊轮廓。
type: docs
weight: 651
url: /zh/aspose.slides.effects/igloweffectivedata/
---
## IGlowEffectiveData 类

不可变对象，表示一种 [Glow](../glow/) 效果，在对象边缘之外添加颜色模糊轮廓。
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 颜色。只读 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual **double** [get_Radius](./get_radius/)() | 半径。只读 **double**。 |
...
| void [Lock](../../system/object/lock/)() | 实现 C# lock() 语句的锁定。可直接调用，也可使用 [LockContext](../../system/lockcontext/) 哨兵对象。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上不复制任何内容，仅初始化新对象并允许在子类中进行复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不复制任何内容，仅初始化新对象并允许在子类中进行复制构造。 |
