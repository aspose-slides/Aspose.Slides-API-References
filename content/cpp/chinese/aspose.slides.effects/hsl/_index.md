...
description: 表示一种 Hue/Saturation/Luminance（色相/饱和度/亮度）效果。色相、饱和度和亮度都可以相对于当前值进行调整。
type: docs
weight: 222
...
表示一种 Hue/Saturation/Luminance 效果。色相、饱和度和亮度都可以相对于当前值进行调整。
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [HSL](./) 是否等于当前的 [HSL](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 Hue/Saturation/Luminance 效果数据。 |
