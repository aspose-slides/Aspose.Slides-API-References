...
description: 不可变对象，表示颜色更改效果。FromColor 的实例会被 ToColor 的实例替换。
type: docs
weight: 521
url: /zh/aspose.slides.effects/icolorchangeeffectivedata/
---
## IColorChangeEffectiveData 类

不可变对象，表示颜色更改效果。FromColor 的实例会被 ToColor 的实例替换。
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_FromColor](./get_fromcolor/)() | 将被替换的颜色。只读 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ToColor](./get_tocolor/)() | 替换的颜色。只读 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual **bool** [get_UseAlpha](./get_usealpha/)() | 返回一个布尔值，决定是否使用 alpha 分量。只读 **bool**。 |
