...
description: 表示颜色更改效果。FromColor 的实例将被 ToColor 的实例替换。
type: docs
weight: 508
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_FromColor](./get_fromcolor/)() | 将被替换的颜色。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ToColor](./get_tocolor/)() | 将用于替换的颜色。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | 获取在继承应用后的有效数据。 |
