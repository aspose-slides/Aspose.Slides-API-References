...
description: 表示一种 Duotone 效果。对于每个像素，通过线性插值将 Color1 和 Color2 组合，以确定该像素的新颜色。
type: docs
weight: 157
...
表示一个 [Duotone](./) 效果。对于每个像素，通过线性插值将 Color1 和 Color2 组合，以确定该像素的新颜色。
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [Duotone](./) 是否等于当前的 [Duotone](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color1](./get_color1/)() override | 返回暗像素的目标颜色格式。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color2](./get_color2/)() override | 返回亮像素的目标颜色格式。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotoneEffectiveData](../iduotoneeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 [Duotone](./) 效果数据。 |
