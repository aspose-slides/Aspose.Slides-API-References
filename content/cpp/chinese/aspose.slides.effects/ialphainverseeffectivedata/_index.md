...
description: 不可变对象，表示 Alpha 反向效果。Alpha（不透明度）值通过从 100% 中减去来反转。
type: docs
weight: 326
url: /zh/aspose.slides.effects/ialphainverseeffectivedata/
---
## IAlphaInverseEffectiveData 类

不可变对象，表示 Alpha 反向效果。Alpha（不透明度）值通过从 100% 中减去来反转。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 风格的浮点比较，在该比较中，两个 NaN 被视为相等，尽管根据 IEC 60559:1989，NaN 不等于任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 风格的浮点比较，在该比较中，两个 NaN 被视为相等，尽管根据 IEC 60559:1989，NaN 不等于任何值，包括 NaN 本身。 |
