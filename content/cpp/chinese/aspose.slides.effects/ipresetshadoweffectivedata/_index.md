...
type: docs
weight: 924
url: /zh/aspose.slides.effects/ippresetshadoweffectivedata/
---
## IPresetShadowEffectiveData 类
...
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | 预设。只读 [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将 n'th 模板参数设为弱指针（而非共享）。允许在容器中将指针切换为弱模式。 |
