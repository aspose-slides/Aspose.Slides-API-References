...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [PresetShadow](./) 是否等于当前的 [PresetShadow](./)。 |
...
| **float** [get_Direction](./get_direction/)() override | 阴影方向。读取 **float**。 |
| **double** [get_Distance](./get_distance/)() override | 阴影距离。读取 **double**。 |
...
| [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() override | 预设。读取 [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | 阴影颜色。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../../aspose.slides/ipviobject/get_version/)() | 版本。只读 **uint32_t**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadowEffectiveData](../ipresetshadoweffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效预设阴影效果数据。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷贝构造函数。实际上不复制任何内容，而是初始化新对象并启用对子类的拷贝构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上不复制任何内容，而是初始化新对象并启用对子类的拷贝构造。 |
...
| void [set_Direction](./set_direction/)(**float**) override | 阴影方向。写入 **float**。 |
| void [set_Distance](./set_distance/)(**double**) override | 阴影距离。写入 **double**。 |
| void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) override | 预设。写入 [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
