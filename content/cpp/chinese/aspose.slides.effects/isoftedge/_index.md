...
description: 表示 Soft Edge 效果。形状的边缘被模糊化，而填充不受影响。
type: docs
weight: 963
...
表示 Soft Edge 效果。形状的边缘被模糊化，而填充不受影响。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模拟 C# 样式的浮点比较，其中两个 NaN 被视为相等，即使依据 IEC 60559:1989，NaN 不等于任何值，包括 NaN。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模拟 C# 样式的浮点比较，其中两个 NaN 被视为相等，即使依据 IEC 60559:1989，NaN 不等于任何值，包括 NaN。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 仅供内部使用。 |
| virtual **double** [get_Radius](./get_radius/)() | 指定要应用于边缘的模糊半径。读取 **double**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | 获取已应用继承的有效数据。 |
...
| virtual void [set_Radius](./set_radius/)(**double**) | 指定要应用于边缘的模糊半径。写入 **double**。 |
