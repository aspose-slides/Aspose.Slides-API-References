...
description: 表示一个 Luminance 效果。亮度线性地将所有颜色向白色或黑色移动。对比度将所有颜色缩放，使它们更接近或更远离。
type: docs
weight: 1028
...
表示一个 [Luminance](./) 效果。亮度线性地将所有颜色向白色或黑色移动。对比度将所有颜色缩放，使它们更接近或更远离。
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [Luminance](./) 是否等于当前的 [Luminance](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 [Luminance](./) 效果数据。 |
