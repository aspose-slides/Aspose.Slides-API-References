...
description: 表示一种亮度效果。亮度线性地将所有颜色向白色或黑色移动。对比度按比例缩放所有颜色，使其彼此更接近或更远离。
type: docs
weight: 807
url: /zh/aspose.slides.effects/iluminanceeffectivedata/
---
## ILuminanceEffectiveData 类

表示一个 [Luminance](../luminance/) 效果。亮度线性地将所有颜色向白色或黑色移动。对比度按比例缩放所有颜色，使其彼此更接近或更远离。
...
| virtual **float** [get_Brightness](./get_brightness/)() | 亮度。只读 **float**。 |
| virtual **float** [get_Contrast](./get_contrast/)() | 对比度。只读 **float**。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 复制构造函数。实际上什么也不复制，只是初始化新对象并允许子类进行复制构造。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 赋值运算符。实际上什么也不复制，只是初始化新对象并允许子类进行复制构造。 |
