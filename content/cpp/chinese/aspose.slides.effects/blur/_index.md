...
description: 表示一种应用于整个形状（包括填充）的模糊效果。所有颜色通道（包括 alpha）都会受到影响。
type: docs
weight: 105
...
表示一种应用于整个形状（包括填充）的 [Blur](./) 效果。所有颜色通道（包括 alpha）都受到影响。
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [Blur](./) 是否等于当前的 [Blur](./)。 |
...
| **bool** [get_Grow](./get_grow/)() override | 确定对象的边界是否因模糊而扩大。True 表示边界将扩大，false 表示不扩大。读取 **bool**。 |
...
| **double** [get_Radius](./get_radius/)() override | 返回模糊半径。读取 **double**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数器数据结构。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效 [Blur](./) 效果数据。 |
...
| void [set_Grow](./set_grow/)(**bool**) override | 确定对象的边界是否因模糊而扩大。True 表示边界将扩大，false 表示不扩大。写入 **bool**。 |
| void [set_Radius](./set_radius/)(**double**) override | 设置模糊半径。写入 **double**。 |
