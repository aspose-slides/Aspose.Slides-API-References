...
description: 表示一种颜色替换效果。所有效果颜色都会更改为固定颜色。Alpha 值不受影响。
type: docs
weight: 144
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 确定指定的 [ColorReplace](./) 是否等于当前的 [ColorReplace](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | 返回将替换每个像素颜色的颜色格式。只读 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplaceEffectiveData](../icolorreplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | 获取应用继承后的有效颜色替换效果数据。 |
