...
提供用于控制导出文档中 [Ink](../../aspose.slides.ink/) 对象外观的选项。
...
| **bool** [get_HideInk](./get_hideink/)() override | 在导出文档中显示或隐藏 [Ink](../../aspose.slides.ink/) 元素。 |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | 在渲染画笔时使用 ROP 操作或不透明度。 |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | 在导出文档中显示或隐藏 [Ink](../../aspose.slides.ink/) 元素。 |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | 在渲染画笔时使用 ROP 操作或不透明度。 |
