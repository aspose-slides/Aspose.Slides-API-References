...
---
## IPresentationAnimationPlayer 类
...
| virtual ASPOSE_SLIDES_LOCAL_API **double** [get_Duration](./get_duration/)() | 获取动画持续时间 [ms] |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | 获取先前使用 [IPresentationAnimationPlayer::SetTimePosition](./settimeposition/) 方法设置的当前时间位置的帧。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 类似于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。启用自定义对象的哈希。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否表示由 targetType 描述的类型实例。类似于 C# 'is' 运算符。 |
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | 在 [IPresentationAnimationPlayer::get_Duration](./get_duration/) 中设置动画时间位置。 |
...
动画由 [PresentationAnimationsGenerator](../presentationanimationsgenerator/) 通过其 **PresentationAnimationsGenerator::NewAnimation** 事件生成。
