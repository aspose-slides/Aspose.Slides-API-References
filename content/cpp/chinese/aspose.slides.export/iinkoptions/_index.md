...
| virtual **bool** [get_HideInk](./get_hideink/)() | 在导出文档中显示或隐藏 [Ink](../../aspose.slides.ink/) 元素。 |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | 使用 ROP 操作或不透明度渲染画笔。 |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | 在导出文档中显示或隐藏 [Ink](../../aspose.slides.ink/) 元素。 |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | 使用 ROP 操作或不透明度渲染画笔。 |
