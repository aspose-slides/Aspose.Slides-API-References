...
---
## ITextToHtmlConversionOptions 类
...
| virtual **bool** [get_AddClipboardFragmentHeader](./get_addclipboardfragmentheader/)() | 返回值，指示是否应添加剪贴板标题。读取 **bool**。 |
| virtual [System::String](../../system/string/) [get_EncodingName](./get_encodingname/)() | 返回 HTML 编码名称。此值将保存到生成的 HTML 文件中，但由调用方确保文件以此编码保存。读取 [System::String](../../system/string/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\> [get_LinkEmbedController](./get_linkembedcontroller/)() | 返回一个回调对象，用于控制外部对象的存储方式。读取 [Export::ILinkEmbedController](../ilinkembedcontroller/)。 |
| virtual [Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/) [get_TextInheritanceLimit](./get_textinheritancelimit/)() | 返回文本属性的继承深度。读取 [TextInheritanceLimit](../textinheritancelimit/)。 |
...
| virtual void [set_AddClipboardFragmentHeader](./set_addclipboardfragmentheader/)(**bool**) | 设置值，指示是否应添加剪贴板标题。写入 **bool**。 |
| virtual void [set_EncodingName](./set_encodingname/)([System::String](../../system/string/)) | 设置 HTML 编码名称。此值将保存到生成的 HTML 文件中，但由调用方确保文件以此编码保存。写入 [System::String](../../system/string/)。 |
| virtual void [set_LinkEmbedController](./set_linkembedcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\>) | 设置一个回调对象，用于控制外部对象的存储方式。写入 [Export::ILinkEmbedController](../ilinkembedcontroller/)。 |
| virtual void [set_TextInheritanceLimit](./set_textinheritancelimit/)([Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/)) | 设置文本属性的继承深度。写入 [TextInheritanceLimit](../textinheritancelimit/)。 |
