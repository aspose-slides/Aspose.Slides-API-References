...
| virtual **bool** [get_DrawSlidesFrame](./get_drawslidesframe/)() | 若为真则在每张幻灯片周围绘制黑色框架。读取 **bool**。 |
...
| virtual **bool** [get_SaveMetafilesAsPng](./get_savemetafilesaspng/)() | 若为真则将演示文稿中使用的所有元文件转换为 PNG 图像。读取 **bool**。 |
| virtual **bool** [get_ShowHiddenSlides](./get_showhiddenslides/)() | 指定生成的文档是否应包括隐藏幻灯片。默认值为 **false**。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法的等价。支持自定义类型的克隆。 |
...
| virtual void [set_DrawSlidesFrame](./set_drawslidesframe/)(**bool**) | 若为真则在每张幻灯片周围绘制黑色框架。写入 **bool**。 |
...
| virtual void [set_SaveMetafilesAsPng](./set_savemetafilesaspng/)(**bool**) | 若为真则将演示文稿中使用的所有元文件转换为 PNG 图像。写入 **bool**。 |
| virtual void [set_ShowHiddenSlides](./set_showhiddenslides/)(**bool**) | 指定生成的文档是否应包括隐藏幻灯片。默认值为 **false**。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 方法的等价。支持将自定义对象转换为字符串。 |
