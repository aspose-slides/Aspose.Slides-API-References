...
description: 确定在将演示文稿导出为 HTML 时，幻灯片图像的保存格式。
type: docs
weight: 690
...
| Method | Description |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[SlideImageFormat](./)\> [Bitmap](./bitmap/)(**float**, [Aspose::Slides::ImageFormat](../../aspose.slides/imageformat/)) | [Slides](../../aspose.slides/) 应该转换为光栅图像。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[SlideImageFormat](./)\> [Svg](./svg/)([System::SharedPtr](../../system/sharedptr/)\<[SVGOptions](../svgoptions/)\>) | [Slides](../../aspose.slides/) 应该转换为 SVG 格式。 |
...
| virtual  [~Object](../../system/object/~object/)() | 销毁对象。释放所有 |

## 另请参阅

* 类 [ISlideImageFormat](../islideimageformat/)
