...
description: 用于从 Pptx 文本提取 HTML 的选项。
type: docs
weight: 755
...
| **bool** [get_AddClipboardFragmentHeader](./get_addclipboardfragmentheader/)() override | 返回值，指示是否应添加剪贴板标头。读取 **bool**。 |
| [System::String](../../system/string/) [get_EncodingName](./get_encodingname/)() override | 返回 HTML 编码名称。此值将保存到生成的 HTML 文件中，但由调用者确保文件以此编码保存。读取 [System::String](../../system/string/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\> [get_LinkEmbedController](./get_linkembedcontroller/)() override | 返回一个回调对象，用于控制外部对象的存储方式。读取 [Export::ILinkEmbedController](../ilinkembedcontroller/)。 |
| [Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/) [get_TextInheritanceLimit](./get_textinheritancelimit/)() override | 返回文本属性的固有深度。读取 [Export::TextInheritanceLimit](../textinheritancelimit/)。 |
...
| void [set_AddClipboardFragmentHeader](./set_addclipboardfragmentheader/)(**bool**) override | 设置值，指示是否应添加剪贴板标头。写入 **bool**。 |
| void [set_EncodingName](./set_encodingname/)([System::String](../../system/string/)) override | 设置 HTML 编码名称。此值将保存到生成的 HTML 文件中，但由调用者确保文件以此编码保存。写入 [System::String](../../system/string/)。 |
| void [set_LinkEmbedController](./set_linkembedcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\>) override | 设置一个回调对象，用于控制外部对象的存储方式。写入 [Export::ILinkEmbedController](../ilinkembedcontroller/)。 |
| void [set_TextInheritanceLimit](./set_textinheritancelimit/)([Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/)) override | 设置文本属性的固有深度。写入 [Export::TextInheritanceLimit](../textinheritancelimit/)。 |
...
* 类 [ITextToHtmlConversionOptions](../itexttohtmlconversionoptions/)
