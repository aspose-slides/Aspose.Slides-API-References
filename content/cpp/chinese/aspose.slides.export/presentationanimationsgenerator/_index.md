...
表示 [Presentation](../../aspose.slides/presentation/) 中动画的生成器。
...
| 方法 | 描述 |
| --- | --- |
| void [Dispose](./dispose/)() override | 释放 [PresentationAnimationsGenerator](./) 的实例。 |
...
| **int32_t** [get_DefaultDelay](./get_defaultdelay/)() const | 获取默认延迟时间 [毫秒]。 |
| **int32_t** [get_ExportedSlides](./get_exportedslides/)() const | 获取已导出幻灯片的数量。 |
| **bool** [get_IncludeHiddenSlides](./get_includehiddenslides/)() const | 获取或设置是否应包含隐藏的幻灯片。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 获取与对象关联的引用计数数据结构。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相当于 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。启用自定义对象的哈希。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 获取对象的实际类型。相当于 C# [System.Object.GetType()](../../system/object/gettype/) 调用。 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 检查对象是否代表目标类型 targetType 描述的实例。相当于 C# 的 'is' 运算符。 |
...
|  [PresentationAnimationsGenerator](./presentationanimationsgenerator/)([System::SharedPtr](../../system/sharedptr/)\<[Presentation](../../aspose.slides/presentation/)\>) | 创建 [PresentationAnimationsGenerator](./) 的新实例。 |
|  [PresentationAnimationsGenerator](./presentationanimationsgenerator/)([System::Drawing::Size](../../system.drawing/size/)) | 创建 [PresentationAnimationsGenerator](./) 的新实例。 |
...
| void [Run](./run/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>\>\>) | 为每张幻灯片运行动画事件生成。 |
| void [Run](./run/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>\>\>, **int32_t**, [PresentationPlayer::FrameTickHandler](../presentationplayer/frametickhandler/)) | 为每张幻灯片运行动画事件生成。 |
| void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | 设置默认延迟时间 [毫秒]。 |
| void [set_IncludeHiddenSlides](./set_includehiddenslides/)(**bool**) | 获取或设置是否应包含隐藏的幻灯片。 |
