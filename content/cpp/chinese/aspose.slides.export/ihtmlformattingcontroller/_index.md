...
| virtual void [WriteDocumentEnd](./writedocumentend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) | 用于写入 HTML 文档页脚。每次演示转换调用一次。 |
| virtual void [WriteDocumentStart](./writedocumentstart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) | 用于写入 HTML 文档页眉。每次演示转换调用一次。 |
| virtual void [WriteShapeEnd](./writeshapeend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | 在形状渲染之前调用。对每个形状调用一次。如果此函数向生成器写入任何内容，当前幻灯片图像的生成将结束，插入添加的 HTML 片段，并在前一个图像之上开始生成新图像。 |
| virtual void [WriteShapeStart](./writeshapestart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | 在形状渲染之前调用。对每个形状调用一次。如果此函数向生成器写入任何内容，当前幻灯片图像的生成将结束，插入添加的 HTML 片段，并在前一个图像之上开始生成新图像。 |
| virtual void [WriteSlideEnd](./writeslideend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>) | 用于写入 HTML 幻灯片页脚。对每张幻灯片调用一次。 |
| virtual void [WriteSlideStart](./writeslidestart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>) | 用于写入 HTML 幻灯片页眉。对每张幻灯片调用一次。 |
