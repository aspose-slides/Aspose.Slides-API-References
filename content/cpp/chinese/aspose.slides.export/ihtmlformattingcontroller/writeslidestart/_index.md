...
description: 用于写入 html 幻灯片标题。每个幻灯片调用一次。
type: docs
weight: 27
url: /zh/aspose.slides.export/ihtmlformattingcontroller/writeslidestart/
---
## IHtmlFormattingController::WriteSlideStart(System::SharedPtr\<IHtmlGenerator\>, System::SharedPtr\<ISlide\>) 方法

用于写入 html 幻灯片标题。每个幻灯片调用一次。
...
| slide | [System::SharedPtr](../../../system/sharedptr/)\<[ISlide](../../../aspose.slides/islide/)\> | [Slide](../../../aspose.slides/slide/) 正在当前渲染。 |
