...
description: "Představuje transformaci kanonizace XML C14N pro digitální podpis bez komentářů. Objektů této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám při běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel při předávání do funkcí jako argument."
type: docs
weight: 170
url: /cs/system.security.cryptography.xml/xmldsigc14ntransform/
---
## XmlDsigC14NTransform třída

Představuje transformaci kanonizace XML C14N pro digitální podpis bez komentářů. Objektů této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to způsobí chyby za běhu a/nebo selhání aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
