...
description: Poskytuje základní funkčnost pro propagaci synchronizačního kontextu napříč různými operacemi synchronizace.
type: docs
weight: 196
url: /cs/system.threading/synchronizationcontext/
---
## SynchronizationContext třída


Poskytuje základní funkčnost pro propagaci synchronizačního kontextu napříč různými operacemi synchronizace.
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Získá synchronizační kontext pro aktuální vlákno. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# statementu lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Spustí zpětné volání asynchronně. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Spustí zpětné volání synchronně. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Nastaví synchronizační kontext pro aktuální vlákno. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | Vytvoří novou instanci [SynchronizationContext](./). |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje převod vlastních objektů na řetězec. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukci C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# statementu lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
Tato třída umožňuje propagaci synchronizačního kontextu mezi vlákny a používá se k přesměrování zpětných volání nebo volání na vhodné vlákno nebo synchronizační kontext. Fiktivní implementace.
