...
description: "Událost, kterou lze odeslat čekajícímu vláknu. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání funkcím jako argument."
type: docs
weight: 118
url: /cs/system.threading/eventwaithandle/
---
## EventWaitHandle třída

Událost, kterou lze odeslat čekajícímu vláknu. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkci jako argumentu.
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# výrazu lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [Reset](./reset/)() | Nastaví událost do neoznamovacího stavu. |
| virtual **bool** [Set](./set/)() | Nastaví událost do oznamovacího stavu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# výrazu lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Čeká, až se všechny handle spustí. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Čeká, až se všechny handle spustí. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Čeká, až se všechny handle spustí. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Čeká, až se některý z handle spustí. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Čeká, až se některý z handle spustí. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Čeká, až se některý z handle spustí. |
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Čeká, až se handle spustí po neomezenou dobu. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int) | Čeká, až se handle spustí. |
| virtual **bool** [WaitOne](../waithandle/waitone/)([TimeSpan](../../system/timespan/)) | Čeká, až se handle spustí. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int, **bool**) | Čeká, až se handle spustí. |
...
| Pole | Popis |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Speciální hodnota, která má být vrácena funkcí, jinak vrátí index signalizovaného objektu v poli, pokud časový limit vyprší a nic neoznáme. |
