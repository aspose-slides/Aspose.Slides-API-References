...
description: API vláken umožňující vkládání úloh do fronty, která je čtena poolem pracovních vláken. Jedná se o statický typ bez instančních služeb. Nikdy byste jej neměli vytvářet jako instanci žádným způsobem.
type: docs
weight: 222
url: /cs/system.threading/threadpool/
---
## ThreadPool třída


[Thread](../thread/) pool API umožňující vkládat úlohy do fronty, která je čtena poolem pracovních vláken. Jedná se o statický typ bez instančních služeb. Nikdy byste neměli vytvářet jeho instance jakýmkoli způsobem.
...
| static void [GetAvailableThreads](./getavailablethreads/)(int\&, int\&) | Získá počet dostupných vláken. |
...
| static [ThreadPoolImpl](../threadpoolimpl/)\& [GetInstance](./getinstance/)() | Instance implementace, která obsahuje seznam úloh a další parametry. |
| static void [GetMaxThreads](./getmaxthreads/)(int\&, int\&) | Získá maximální počet souběžných vláken. |
| static void [GetMinThreads](./getminthreads/)(int\&, int\&) | Získá minimální počet vláken vytvořených poolem. |
...
| static void [JoinAllThreads](./joinallthreads/)() | Počká na všechny vlastněné vlákna. Čeká nekonečně. |
...
| void [operator=](./operator_equal/)(const [ThreadPool](./)\&) | Bez kopírování. |
...
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/)) | Vloží pracovní položku do fronty, která je přítomna s voláním zpět bez parametrů. |
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/), const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Vloží pracovní položku do fronty, která je přítomna s voláním zpět bez parametrů. |
...
| static **bool** [SetMaxThreads](./setmaxthreads/)(int, int) | Nastaví počet vláken vlastněných poolem. |
| static **bool** [SetMinThreads](./setminthreads/)(int, int) | Nastaví minimální počet vláken vlastněných poolem. |
...
|  [ThreadPool](./threadpool/)(const [ThreadPool](./)\&) | Bez kopírování. |
