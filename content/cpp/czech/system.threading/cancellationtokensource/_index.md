...
description: Zdroj tokenu pro zrušení, který lze použít k vyvolání oznámení o zrušení.
type: docs
weight: 40
url: /cs/system.threading/cancellationtokensource/
---
## CancellationTokenSource třída


Zdroj tokenu pro zrušení, který lze použít k vyvolání oznámení o zrušení.
...
| Metoda | Popis |
| --- | --- |
| void [Cancel](./cancel/)() | Komunikuje žádost o zrušení. |
|  [CancellationTokenSource](./cancellationtokensource/)() | Vytvoří nový [CancellationTokenSource](./). |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Vytvoří propojený zdroj tokenu, který se zruší, když se zruší kterýkoli z poskytnutých tokenů. |
| void [Dispose](./dispose/)() override | Uvolní všechny prostředky používané [CancellationTokenSource](./). |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | Získá, zda byla žádost o zrušení podána. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Získá token pro zrušení přiřazený k tomuto zdroji. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí přiřazenou k objektu. |
...
Poskytuje mechanismy pro vytvoření a řízení tokenů pro zrušení pro kooperativní zrušení operací. 
