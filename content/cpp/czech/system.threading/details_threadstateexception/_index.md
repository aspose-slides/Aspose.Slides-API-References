...
type: docs
weight: 105
url: /cs/system.threading/details_threadstateexception/
---
## Details_ThreadStateException třída
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Nastavuje HRESULT, kódující číselnou hodnotu přiřazenou konkrétní výjimce. |
...
| virtual  [~Object](../../system/object/~object/)() | Zničí objekt. Uvolňuje veškeré vnitřní datové struktury. |
## Viz také
