...
description: Reprezentuje přehrávač animací spojených s prezentací.
type: docs
weight: 625
...
| Metoda | Popis |
| --- | --- |
| void [Dispose](./dispose/)() override | Uvolní instanci [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Získá index snímku. |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Vytvoří novou instanci [PresentationPlayer](./). |
...
| Typedef | Popis |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Reprezentuje obslužnou funkci tikání rámce události **PresentationPlayer::FrameTick**. |
