...
Poskytuje možnosti, které řídí vzhled objektů [Ink](../../aspose.slides.ink/) v exportovaném dokumentu.
...
| **bool** [get_HideInk](./get_hideink/)() override | Zobrazuje nebo skrývá prvky [Ink](../../aspose.slides.ink/) v exportovaném dokumentu. |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | Používá operaci ROP nebo opacity pro vykreslení štětce. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí asociovanou s objektem. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného cílovým typem. Analógie operátoru C# 'is'. |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | Zobrazuje nebo skrývá prvky [Ink](../../aspose.slides.ink/) v exportovaném dokumentu. |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | Používá operaci ROP nebo opacity pro vykreslení štětce. |
