...
description: Reprezentuje režim rozvržení prezentace pro tisk handout při exportu.
type: docs
weight: 66
...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Určuje, kolik snímků a v jakém pořadí bude umístěno na stránku [HandoutType](../handouttype/). |
| **bool** [get_PrintComments](./get_printcomments/)() const | Určuje, zda se mají zobrazovat komentáře na snímcích. |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Určuje, zda se mají kolem zobrazených snímků kreslit rámečky, nebo ne. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Určuje, zda se mají tisknout čísla zobrazených snímků. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Určuje, kolik snímků a v jakém pořadí bude umístěno na stránku [HandoutType](../handouttype/). |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Určuje, zda se mají zobrazovat komentáře na snímcích. |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Určuje, zda se mají kolem zobrazených snímků kreslit rámečky, nebo ne. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Určuje, zda se mají tisknout čísla zobrazených snímků. |
