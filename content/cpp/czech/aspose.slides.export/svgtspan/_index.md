...
description: Reprezentuje možnosti pro část SVG textu (\"tspan\").
type: docs
weight: 729
...
Reprezentuje možnosti pro část SVG textu („tspan“).
...
| [System::String](../../system/string/) [get_Id](./get_id/)() override | Získá ID elementu „tspan“ |
...
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | Získá ID elementu „tspan“ |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Sníží slabý referenční čítač. Nemělo by se volat příně; místo toho použijte chytré ukazatele nebo ThisProtector. |
