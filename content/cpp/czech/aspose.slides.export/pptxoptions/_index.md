...
description: Představuje možnosti pro ukládání prezentací OpenXml (PPTX, PPSX, POTX, PPTM, PPSM, POTM).
type: docs
weight: 599
...
| [Aspose::Slides::Export::CompressionLevel](../compressionlevel/) [get_CompressionLevel](./get_compressionlevel/)() override | Určuje úroveň komprese používanou při ukládání dokumentu prezentace. Výchozí hodnota je [CompressionLevel::Level6](../compressionlevel/). |
| [Aspose::Slides::Export::Conformance](../conformance/) [get_Conformance](./get_conformance/)() override | Určuje třídu kompatibility, ke které dokument [Presentation](../../aspose.slides/presentation/) odpovídá. Výchozí hodnota je [Aspose::Slides::Export::Conformance::Ecma376_2006](../conformance/). |
...
| **bool** [get_RefreshThumbnail](./get_refreshthumbnail/)() override | Určuje, zda bude náhled prezentace obnoven. Čte **bool**. Výchozí hodnota je **true**. |
| **bool** [get_SkipJavaScriptLinks](../saveoptions/get_skipjavascriptlinks/)() override | Určuje, zda při ukládání prezentace přeskočit hypertextové odkazy s JavaScriptovými voláními. Čte **bool**. Výchozí hodnota je **false**. |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)\> [get_WarningCallback](../saveoptions/get_warningcallback/)() override | Vrací nebo nastavuje objekt, který přijímá varování a rozhoduje, zda proces načítání bude pokračovat nebo bude ukončen. Čte [Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/). |
| [Aspose::Slides::Export::Zip64Mode](../zip64mode/) [get_Zip64Mode](./get_zip64mode/)() override | Určuje, zda je pro dokument [Presentation](../../aspose.slides/presentation/) použit formát ZIP64. Výchozí hodnota je [Zip64Mode::IfNecessary](../zip64mode/). |
...
| void [set_CompressionLevel](./set_compressionlevel/)([Aspose::Slides::Export::CompressionLevel](../compressionlevel/)) override | Určuje úroveň komprese používanou při ukládání dokumentu prezentace. Výchozí hodnota je [CompressionLevel::Level6](../compressionlevel/). |
| void [set_Conformance](./set_conformance/)([Aspose::Slides::Export::Conformance](../conformance/)) override | Určuje třídu kompatibility, ke které dokument [Presentation](../../aspose.slides/presentation/) odpovídá. Výchozí hodnota je [Aspose::Slides::Export::Conformance::Ecma376_2006](../conformance/). |
...
| void [set_RefreshThumbnail](./set_refreshthumbnail/)(**bool**) override | Určuje, zda bude náhled prezentace obnoven. Zapíše **bool**. Výchozí hodnota je **true**. |
| void [set_SkipJavaScriptLinks](../saveoptions/set_skipjavascriptlinks/)(**bool**) override | Určuje, zda při ukládání prezentace přeskočit hypertextové odkazy s JavaScriptovými voláními. Zapíše **bool**. Výchozí hodnota je **false**. |
| void [set_WarningCallback](../saveoptions/set_warningcallback/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)\>) override | Vrací nebo nastavuje objekt, který přijímá varování a rozhoduje, zda proces načítání bude pokračovat nebo bude ukončen. Zapíše [Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/). |
| void [set_Zip64Mode](./set_zip64mode/)([Aspose::Slides::Export::Zip64Mode](../zip64mode/)) override | Určuje, zda je pro dokument [Presentation](../../aspose.slides/presentation/) použit formát ZIP64. Výchozí hodnota je [Zip64Mode::IfNecessary](../zip64mode/). |
...
* Třída [IPptxOptions](../ipptxoptions/)
