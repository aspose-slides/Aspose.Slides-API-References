...
description: Rozhraní zpětného volání používané k určení, jak by měl být objekt během ukládání zpracován.
type: docs
weight: 248
...
Rozhraní zpětného volání používané k určení, jak by měl být objekt během ukládání zpracován.
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Ukládá externí objekt. |
