...
| [System::Drawing::Color](../../system.drawing/color/) [get_CommentsAreaColor](./get_commentsareacolor/)() | Vrací barvu oblasti komentářů (Platí pouze pokud jsou komentáře zobrazeny vpravo). |
| **int32_t** [get_CommentsAreaWidth](./get_commentsareawidth/)() | Vrací šířku oblasti výstupu komentářů v pixelech (Platí pouze pokud jsou komentáře zobrazeny vpravo). |
| [CommentsPositions](../commentspositions/) [get_CommentsPosition](./get_commentsposition/)() | Vrací pozici komentářů na stránce. |
| [NotesPositions](../notespositions/) [get_NotesPosition](./get_notesposition/)() | Vrací pozici poznámek na stránce. |
| **bool** [get_ShowCommentsByNoAuthor](./get_showcommentsbynoauthor/)() | Vrací viditelnost komentářů, které nemají autora. Pokud je true, komentáře budou zobrazeny. (Platí pouze pokud jsou komentáře zobrazeny). |
...
| void [set_CommentsAreaColor](./set_commentsareacolor/)([System::Drawing::Color](../../system.drawing/color/)) | Nastavuje barvu oblasti komentářů (Platí pouze pokud jsou komentáře zobrazeny vpravo). |
| void [set_CommentsAreaWidth](./set_commentsareawidth/)(**int32_t**) | Nastavuje šířku oblasti výstupu komentářů v pixelech (Platí pouze pokud jsou komentáře zobrazeny vpravo). |
| void [set_CommentsPosition](./set_commentsposition/)([CommentsPositions](../commentspositions/)) | Nastavuje pozici komentářů na stránce. |
| void [set_NotesPosition](./set_notesposition/)([NotesPositions](../notespositions/)) | Nastavuje pozici poznámek na stránce. |
| void [set_ShowCommentsByNoAuthor](./set_showcommentsbynoauthor/)(**bool**) | Nastavuje viditelnost komentářů, které nemají autora. Pokud je true, komentáře budou zobrazeny. (Platí pouze pokud jsou komentáře zobrazeny). |
