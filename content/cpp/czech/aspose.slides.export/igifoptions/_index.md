...
| virtual **int32_t** [get_DefaultDelay](./get_defaultdelay/)() | Získá výchozí zpoždění v [ms]. Tato hodnota bude použita, pokud nebyla zavolána metoda [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/). Výchozí hodnota je 1000. |
| virtual [System::String](../../system/string/) [get_DefaultRegularFont](../isaveoptions/get_defaultregularfont/)() | Vrací písmo, které se použije, pokud není nalezeno zdrojové písmo. Čte [System::String](../../system/string/). |
| virtual **bool** [get_ExportHiddenSlides](./get_exporthiddenslides/)() | Určuje, zda budou exportovány skryté snímky. Výchozí hodnota je false. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_FrameSize](./get_framesize/)() | Získá velikost rámce. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\> [get_ProgressCallback](../isaveoptions/get_progresscallback/)() | Representuje objekt zpětného volání pro ukládání aktualizací postupu v procentech. Viz [IProgressCallback](../../aspose.slides/iprogresscallback/). |
...
| virtual **int32_t** [get_TransitionFps](./get_transitionfps/)() | Získá FPS přechodu [snímků/s]. Výchozí hodnota je 25. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógie C# metody [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného pomocí targetType. Analógie operátoru C# 'is'. |
...
| virtual void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | Nastaví výchozí zpoždění v [ms]. Tato hodnota bude použita, pokud nebyla zavolána metoda [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/). Výchozí hodnota je 1000. |
| virtual void [set_DefaultRegularFont](../isaveoptions/set_defaultregularfont/)([System::String](../../system/string/)) | Nastaví písmo, které se použije, pokud není nalezeno zdrojové písmo. Zapíše [System::String](../../system/string/). |
| virtual void [set_ExportHiddenSlides](./set_exporthiddenslides/)(**bool**) | Určuje, zda budou exportovány skryté snímky. Výchozí hodnota je false. |
| virtual void [set_FrameSize](./set_framesize/)([System::Drawing::Size](../../system.drawing/size/)) | Nastaví velikost rámce. |
...
| virtual void [set_ProgressCallback](../isaveoptions/set_progresscallback/)([System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\>) | Representuje objekt zpětného volání pro ukládání aktualizací postupu v procentech. Viz [IProgressCallback](../../aspose.slides/iprogresscallback/). |
...
| virtual void [set_TransitionFps](./set_transitionfps/)(**int32_t**) | Nastaví FPS přechodu [snímků/s]. Výchozí hodnota je 25. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# výrazu lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
