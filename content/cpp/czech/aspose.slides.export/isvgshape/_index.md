...
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Nastavuje nebo získává id pro tvar |
...
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Nastavuje nebo získává id pro tvar |
| virtual void [SetEventHandler](./seteventhandler/)([SvgEvent](../svgevent/), [System::String](../../system/string/)) | Nastavuje obslužnou rutinu události pro tvar |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock() výrazu. Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
