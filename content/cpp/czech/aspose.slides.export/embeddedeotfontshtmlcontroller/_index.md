...
description: Formátovací řadič třída určená k vkládání fontů ve formátu EOT
type: docs
weight: 14
...
Formátovací řadič třída určená k vkládání fontů ve formátu EOT
...
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Vytvoří novou instanci. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() výrazu. Volat přímo nebo použít objekt ochrany [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock() výrazu. Volat přímo nebo použít objekt ochrany [LockContext](../../system/lockcontext/). |
...
* Třída [IEmbeddedEotFontsHtmlController](../iembeddedeotfontshtmlcontroller/)
