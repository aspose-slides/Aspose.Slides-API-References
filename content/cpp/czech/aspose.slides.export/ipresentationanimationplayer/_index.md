...
---
## IPresentationAnimationPlayer třída


Representuje přehrávač animace.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání s plovoucí dvojkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s plovoucí dvojkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní použití. |
| virtual ASPOSE_SLIDES_LOCAL_API **double** [get_Duration](./get_duration/)() | Získá dobu trvání animace [ms] |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | Získá rámec pro aktuální časovou pozici dříve nastavenou metodou [IPresentationAnimationPlayer::SetTimePosition](./settimeposition/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiovací konstruktor. Skutečně nic nekopíruje, jen inicializuje nový objekt a umožňuje kopírování konstruktorů podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Skutečně nic nekopíruje, jen inicializuje nový objekt a umožňuje kopírování konstruktorů podtříd. |
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | Nastaví časovou pozici animace v rámci [IPresentationAnimationPlayer::get_Duration](./get_duration/). |
...
Animace generované pomocí [PresentationAnimationsGenerator](../presentationanimationsgenerator/) přes její událost **PresentationAnimationsGenerator::NewAnimation**. 
