...
---
## ISvgShapeFormattingController třída
...
| virtual void [FormatShape](./formatshape/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgShape](../isvgshape/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Tato funkce je volána před vykreslením tvaru do SVG, aby uživatel mohl řídit výsledné SVG. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování dle C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
