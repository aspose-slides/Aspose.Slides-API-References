...
description: Určuje formát, ve kterém bude snímek uložen pro prezentaci při exportu do HTML.
type: docs
weight: 690
...
Určuje formát, ve kterém bude snímek uložen pro prezentaci při exportu do HTML.
...
| Metoda | Popis |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[SlideImageFormat](./)\> [Bitmap](./bitmap/)(**float**, [Aspose::Slides::ImageFormat](../../aspose.slides/imageformat/)) | [Slides](../../aspose.slides/) by měl být převeden do rastrového obrázku. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() příkazu. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) strážný objekt. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[SlideImageFormat](./)\> [Svg](./svg/)([System::SharedPtr](../../system/sharedptr/)\<[SVGOptions](../svgoptions/)\>) | [Slides](../../aspose.slides/) by měl být převeden do formátu SVG. |
...
* Třída [ISlideImageFormat](../islideimageformat/)
