...
description: Umožňuje vytvořit instance možností ukládání
type: docs
weight: 677
...
Umožňuje vytvořit instance možností ukládání
...
| Metoda | Popis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPptxOptions](../ipptxoptions/)\> [CreatePptxOptions](./createpptxoptions/)() override | Vytváří možnosti ukládání PPTX. |
...
* Třída [ISaveOptionsFactory](../isaveoptionsfactory/)
