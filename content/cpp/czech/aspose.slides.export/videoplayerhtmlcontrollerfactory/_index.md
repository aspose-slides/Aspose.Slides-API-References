...
Umožňuje vytvořit [VideoPlayerHtmlController](../videoplayerhtmlcontroller/).
...
| Metoda | Popis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideoPlayerHtmlController](../ivideoplayerhtmlcontroller/)\> [CreateVideoPlayerHtmlController](./createvideoplayerhtmlcontroller/)([System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) override | Vytváří nový **[VideoPlayerHtmlController](../videoplayerhtmlcontroller/)**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazu C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání příkazu C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
...
* Třída [IVideoPlayerHtmlControllerFactory](../ivideoplayerhtmlcontrollerfactory/)
