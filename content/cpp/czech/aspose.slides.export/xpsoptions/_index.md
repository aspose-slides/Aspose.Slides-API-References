...
| **bool** [get_DrawSlidesFrame](./get_drawslidesframe/)() override | True k vykreslení černého rámu kolem každého snímku. Čte **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\> [get_ProgressCallback](../saveoptions/get_progresscallback/)() override | Reprezentuje objekt zpětného volání pro ukládání průběžných aktualizací v procentech. Viz [IProgressCallback](../../aspose.slides/iprogresscallback/). |
| **bool** [get_SaveMetafilesAsPng](./get_savemetafilesaspng/)() override | True k převodu všech metafile souborů použité v prezentaci na obrázky PNG. Čte **bool**. |
| **bool** [get_ShowHiddenSlides](./get_showhiddenslides/)() override | Určuje, zda vygenerovaný dokument má zahrnovat skryté snímky či ne. Výchozí hodnota je **false**. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získává datovou strukturu referenčního počítadla asociovanou s objektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógie metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získává skutečný typ objektu. Analógie volání C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontroluje, zda objekt představuje instanci typu popsaného v targetType. Analógie operátoru C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání dle C# lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analógie metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umožňuje klonování vlastních typů. |
...
| void [set_DrawSlidesFrame](./set_drawslidesframe/)(**bool**) override | True k vykreslení černého rámu kolem každého snímku. Zapíše **bool**. |
...
| void [set_ProgressCallback](../saveoptions/set_progresscallback/)([System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\>) override | Reprezentuje objekt zpětného volání pro ukládání průběžných aktualizací v procentech. Viz [IProgressCallback](../../aspose.slides/iprogresscallback/). |
| void [set_SaveMetafilesAsPng](./set_savemetafilesaspng/)(**bool**) override | True k převodu všech metafile souborů použité v prezentaci na obrázky PNG. Zapíše **bool**. |
| void [set_ShowHiddenSlides](./set_showhiddenslides/)(**bool**) override | Určuje, zda vygenerovaný dokument má zahrnovat skryté snímky či ne. Výchozí hodnota je **false**. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analógie metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje převod vlastních objektů na řetězec. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukci C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí dle C# lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
...
```
Následující příklad ukazuje, jak převádět prezentace do XPS s vlastními nastaveními. 
```cpp
// Vytvořte objekt Presentation, který představuje soubor prezentace
