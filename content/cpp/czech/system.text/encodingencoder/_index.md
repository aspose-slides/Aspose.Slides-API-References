...
| [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_Fallback](../encoder/get_fallback/)() const | Získává náhradní mechanismus zpracování chyb. |
| const [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [get_FallbackBuffer](../encoder/get_fallbackbuffer/)() const | Získává náhradní buffer. |
| virtual int [GetByteCount](../encoder/getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | Získává počet bajtů potřebných k zakódování bufferu. |
| virtual int [GetByteCount](../encoder/getbytecount/)(const char_t *, int, **bool**) | Získává počet bajtů potřebných k zakódování bufferu. |
| virtual int [GetBytes](../encoder/getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | Získá bajty, které vzniknou kódováním bufferu. |
| virtual int [GetBytes](../encoder/getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | Získá bajty, které vzniknou kódováním bufferu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazu C# lock(). Volání přímo nebo použijte [LockContext](../../system/lockcontext/) hlídkový objekt. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenčně porovnává objekt hodnotového typu s nullptr. |
...
| virtual void [Reset](../encoder/reset/)() | Čistí vnitřní stav enkodéru. |
| void [set_Fallback](../encoder/set_fallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | Nastavuje náhradní mechanismus zpracování chyb. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazu C# lock(). Volání přímo nebo použijte hlídkový objekt [LockContext](../../system/lockcontext/). |
