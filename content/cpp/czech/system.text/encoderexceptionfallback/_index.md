...
description: "Poskytuje strategii záložního řešení vyhazující výjimku. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 144
url: /cs/system.text/encoderexceptionfallback/
---
## EncoderExceptionFallback třída

Poskytuje strategii záložního řešení vyhazující výjimku. Instance této třídy by měly být alokovány jen pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| Metoda | Popis |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Vytvoří záložní buffer. |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Získá výchozí implementaci výjimečného záložního řešení. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Získá maximální počet znaků, které instance může vrátit. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Získá výchozí implementaci náhradního záložního řešení. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | Získá výchozí standardní bezpečnou implementaci záložního řešení. |
...
* Třída [EncoderFallback](../encoderfallback/)
