...
description: "Vyrovnávací paměť pro strategii záložního kódování házející výjimky. Ve skutečnosti nic neukládá, ale místo toho hází výjimku. Objektům této třídy by se mělo alokovat pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo poruše aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel při předávání jako argument funkcím."
type: docs
weight: 157
url: /cs/system.text/encoderexceptionfallbackbuffer/
---
## EncoderExceptionFallbackBuffer třída


[Buffer](../../system/buffer/) pro strategii náhradního kódování házející výjimky. Ve skutečnosti nic neukládá, ale hází výjimku. Objektů této třídy by se mělo alokovat pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani přes operátor new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkcím jako argument.
...
| **bool** [Fallback](./fallback/)(char_t, int) override | Zpracovává selhání kódování. |
| **bool** [Fallback](./fallback/)(char_t, char_t, int) override | Zpracovává selhání kódování. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| int [get_Remaining](./get_remaining/)() const override | Získá počet zbývajících znaků. |
...
| char_t [GetNextChar](./getnextchar/)() override | Získá další dostupný znak. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analog operátoru C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umožňuje klonování vlastních typů. |
| **bool** [MovePrevious](./moveprevious/)() override | Přesune na předchozí znak. |
...
| virtual void [Reset](../encoderfallbackbuffer/reset/)() | Resetuje buffer do počátečního stavu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
...
* Třída [EncoderFallbackBuffer](../encoderfallbackbuffer/)
