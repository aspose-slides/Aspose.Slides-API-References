...
| virtual **bool** [Fallback](./fallback/)(char_t, int) | Implementuje skutečný fallback postup. |
| virtual **bool** [Fallback](./fallback/)(char_t, char_t, int) | Implementuje skutečný fallback postup. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| virtual int [get_Remaining](./get_remaining/)() const | Získá zbývající počet znaků k zpracování. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
| virtual char_t [GetNextChar](./getnextchar/)() | Extrahuje další znak ve fallback vyrovnávací paměti. |
...
| virtual **bool** [MovePrevious](./moveprevious/)() | Posune pozici vyrovnávací paměti o jeden krok zpět, pokud je to možné. |
...
| virtual void [Reset](./reset/)() | Resetuje vyrovnávací paměť do počátečního stavu. |
