...
description: "Výjimka vyvolaná třídou DecoderExceptionFallback, když selže dekódování. Nikdy nevytvářejte instance této třídy ručně. Místo toho použijte třídu DecoderFallbackException. Nikdy neobalujte instance třídy DecoderFallbackException do System::SmartPtr."
type: docs
weight: 105
url: /cs/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException třída
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Získá pole bajtů, které vyvolalo chybu. |
...
| int [get_Index](./get_index/)() | Získá pozici bajtu, který vyvolal chybu ve vstupním poli. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Získá skutečný typ objektu. Analogie volání C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodu [what()](../../system/details_exception/what/), která je volána třídou [ExceptionWrapper](../../system/exceptionwrapper/). Navzdory tomu, že tato třída nezdědí z std::exception, mohou odvozené třídy používat chráněné/soukromé členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../../system/exceptionwrapper/) může tuto logiku narušit. |
