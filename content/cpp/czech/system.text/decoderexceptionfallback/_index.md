...
| Metoda | Popis |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Vytvoří záložní buffer. |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](../decoderfallback/get_exceptionfallback/)() | Získá výchozí implementaci náhradního řešení výjimky. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Získá maximální počet znaků, které instance může vrátit. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](../decoderfallback/get_replacementfallback/)() | Získá výchozí implementaci náhradního nahrazení. |
