...
description: Buffer pro nahrazení strategie záložního dekódování.
type: docs
weight: 92
url: /cs/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer třída


[Buffer](../../system/buffer/) pro nahrazení strategie záložního dekódování.
...
| **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Zpracovává selhání dekódování. |
...
| void [Reset](./reset/)() override | Resetuje buffer do výchozího stavu (před voláním [Fallback()](./fallback/)). |
...
* Třída [DecoderFallbackBuffer](../decoderfallbackbuffer/)
