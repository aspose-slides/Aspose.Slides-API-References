...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Porovnává objekty value type ve stylu C#. |
...
| int [get_Remaining](./get_remaining/)() const override | Získá počet zbývajících znaků v bufferu. |
...
| char_t [GetNextChar](./getnextchar/)() override | Získá následující dostupný znak. |
...
| **bool** [MovePrevious](./moveprevious/)() override | Přesune se na předchozí znak. |
...
| void [Reset](./reset/)() override | Resetuje buffer do počátečního stavu (před voláním [Fallback()](./fallback/)). |
