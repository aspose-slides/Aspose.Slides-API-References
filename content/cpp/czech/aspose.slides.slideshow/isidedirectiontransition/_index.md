...
description: Efekt přechodu snímku ve směru strany.
type: docs
weight: 248
url: /cs/aspose.slides.slideshow/isidedirectiontransition/
---
## ISideDirectionTransition třída

Efekt přechodu snímku ve směru strany.
...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Směr přechodu. Číst [TransitionSideDirectionType](../transitionsidedirectiontype/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() statement. Volat přímo nebo použít [LockContext](../../system/lockcontext/) objekt strážce. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Nekopíruje nic, opravdu, pouze inicializuje nový objekt a umožňuje konstrukci kopií podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Nekopíruje nic, opravdu, pouze inicializuje nový objekt a umožňuje konstrukci kopií podtříd. |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Směr přechodu. Zapsat [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n'th šablonový argument na slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do režimu slabých. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock() statement. Volat přímo nebo použít [LockContext](../../system/lockcontext/) objekt strážce. |
