...
description: Efekt posuvného přechodu kola.
type: docs
weight: 287
url: /cs/aspose.slides.slideshow/iwheeltransition/
---
## IWheelTransition třída

Efekt posuvného přechodu kola.
...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | Počet paprsků přechodu kola. Čte **uint32_t**. |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | Počet paprsků přechodu kola. Zápis **uint32_t**. |
