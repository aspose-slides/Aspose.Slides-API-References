...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Směr přechodu. Přečtěte si [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| **bool** [get_HasBounce](./get_hasbounce/)() override | Určuje, že během přechodu se snímky prezentace pohybují s odražením. Přečtěte si **bool**. |
...
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | Určuje, že během přechodu se snímky prezentace pohybují s odražením. Zapište **bool**. |
...
* Třída [IFlyThroughTransition](../iflythroughtransition/)
