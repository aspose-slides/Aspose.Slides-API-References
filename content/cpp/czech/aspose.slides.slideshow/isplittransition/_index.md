...
description: Efekt rozdělení přechodu snímku.
type: docs
weight: 261
url: /cs/aspose.slides.slideshow/isplittransition/
---
## ISplitTransition třída
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Napodobuje porovnání s dvojitou plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro vnitřní použití. |
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Směr rozdělení přechodu. Číst [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() | Orientace rozdělení přechodu. Číst [Slides::Orientation](../../aspose.slides/orientation/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Směr rozdělení přechodu. Zapsat [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) | Orientace rozdělení přechodu. Zapsat [Slides::Orientation](../../aspose.slides/orientation/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock() příkazu. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) objekt strážce. |
