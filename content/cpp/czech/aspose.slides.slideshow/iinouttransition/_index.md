...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Směr efektu přechodu. Číst [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# příkazu lock(). Zavolejte přímo nebo použijte objekt střežce [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Směr efektu přechodu. Zapsat [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování C# příkazu lock(). Zavolejte přímo nebo použijte objekt střežce [LockContext](../../system/lockcontext/). |
