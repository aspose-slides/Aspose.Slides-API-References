...
description: Efekt přechodu snímku ve směru vlevo-vpravo.
type: docs
weight: 144
url: /cs/aspose.slides.slideshow/ileftrightdirectiontransition/
---
## ILeftRightDirectionTransition třída

Efekt přechodu snímku ve směru vlevo-vpravo.
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Směr přechodu. Přečtěte si [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený počet referencí o uvedenou hodnotu. |
