...
description: Efekt přechodu snímku ve směru osmi směrů.
type: docs
weight: 14
...
| [TransitionEightDirectionType](../transitioneightdirectiontype/) [get_Direction](./get_direction/)() override | Směr přechodu. Čtěte [TransitionEightDirectionType](../transitioneightdirectiontype/). |
...
| void [set_Direction](./set_direction/)([TransitionEightDirectionType](../transitioneightdirectiontype/)) override | Směr přechodu. Zapište [TransitionEightDirectionType](../transitioneightdirectiontype/). |
...
* Třída [IEightDirectionTransition](../ieightdirectiontransition/)
