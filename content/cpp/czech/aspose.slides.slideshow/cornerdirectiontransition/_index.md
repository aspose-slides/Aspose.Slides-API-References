...
| [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() override | Směr přechodu. Číst [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu čítače referencí spojenou s objektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Slouží jako hašovací funkce pro konkrétní typ, vhodná pro použití v hašovacích algoritmech a datových strukturách jako hašovací tabulka. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) strážce objekt. |
...
| void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) override | Směr přechodu. Zapsat [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) strážce objekt. |
...
* Třída [ICornerDirectionTransition](../icornerdirectiontransition/)
