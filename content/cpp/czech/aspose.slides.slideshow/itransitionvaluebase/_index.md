...
description: Zastupuje základní třídu pro efekty přechodu snímků.
type: docs
weight: 274
url: /cs/aspose.slides.slideshow/itransitionvaluebase/
---
## ITransitionValueBase třída
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání výrokem C# lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílené počítadlo reference o zadanou hodnotu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování výrokem C# lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
