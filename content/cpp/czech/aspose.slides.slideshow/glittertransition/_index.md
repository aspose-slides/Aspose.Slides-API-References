...
description: Efekt přechodu snímku s třpytem.
type: docs
weight: 53
url: /cs/aspose.slides.slideshow/glittertransition/
---
## třída GlitterTransition
...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | Směr přechodu. Přečtěte si [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | Specifikuje tvar vizuálů používaných během přechodu. Přečtěte si [TransitionPattern](../transitionpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získává datovou strukturu referenčního počítadla spojenou s objektem. |
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | Směr přechodu. Zapište [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | Specifikuje tvar vizuálů používaných během přechodu. Zapište [TransitionPattern](../transitionpattern/). |
...
* třída [IGlitterTransition](../iglittertransition/)
