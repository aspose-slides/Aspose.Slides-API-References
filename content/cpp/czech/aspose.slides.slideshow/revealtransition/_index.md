...
| [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() override | Směr přechodu. Číst [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| **bool** [get_ThroughBlack](./get_throughblack/)() override | Určuje, zda přechod zeslábne do černé. Číst **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Slouží jako hash funkce pro konkrétní typ, vhodná pro použití v hashovacích algoritmech a datových strukturách jako hash tabulka. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenčně porovnává hodnotový typ objektu s nullptr. |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | Směr přechodu. Zapsat [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | Určuje, zda přechod zeslábne do černé. Zapsat **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonový argument na slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do režimu slabého. |
...
* Třída [IRevealTransition](../irevealtransition/)
