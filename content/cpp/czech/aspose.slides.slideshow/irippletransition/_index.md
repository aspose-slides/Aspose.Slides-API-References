...
description: Ripple efekt přechodu snímku.
type: docs
weight: 222
url: /cs/aspose.slides.slideshow/irippletransition/
---
## IRippleTransition třída

Ripple efekt přechodu snímku.
...
| virtual [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) [get_Direction](./get_direction/)() | Směr přechodu. Přečtěte si [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)) | Směr přechodu. Zapište [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# příkazu lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
