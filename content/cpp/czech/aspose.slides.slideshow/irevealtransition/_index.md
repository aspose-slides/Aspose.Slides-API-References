...
description: Odhaluje efekt přechodu snímku.
type: docs
weight: 209
url: /cs/aspose.slides.slideshow/irevealtransition/
---
## IRevealTransition třída

Odhaluje efekt přechodu snímku.
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Směr přechodu. Čtěte [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | Určuje, zda přechod zeslabuje přes černou. Čtěte **bool**. |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | Směr přechodu. Zapište [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | Určuje, zda přechod zeslabuje přes černou. Zapište **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonový argument jako weak-ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do režimu weak. |
