...
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | Typ morph přechodu. Číst [TransitionMorphType](../transitionmorphtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla odkazů spojenou s objektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Slouží jako hashovací funkce pro konkrétní typ, vhodná k použití v hashovacích algoritmech a datových strukturách, jako je hashovací tabulka. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Volat přímo nebo použít strážní objekt [LockContext](../../system/lockcontext/). |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | Typ morph přechodu. Zapište [TransitionMorphType](../transitionmorphtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí příkazu C# lock(). Volat přímo nebo použít strážní objekt [LockContext](../../system/lockcontext/). |
...
* Třída [IMorphTransition](../imorphtransition/)
