...
description: Efekt přechodu slidu s průletem.
type: docs
weight: 105
url: /cs/aspose.slides.slideshow/iflythroughtransition/
---
## IFlyThroughTransition třída

Efekt přechodu slidu s průletem.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Směr přechodu. Přečtěte si [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual **bool** [get_HasBounce](./get_hasbounce/)() | Určuje, že pohyb prezentačních slidů během přechodu zahrnuje odraz. Přečtěte **bool**. |
...
| virtual void [set_HasBounce](./set_hasbounce/)(**bool**) | Určuje, že pohyb prezentačních slidů během přechodu zahrnuje odraz. Zapište **bool**. |
