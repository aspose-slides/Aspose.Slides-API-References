...
description: Efekt přechodu snímku do strany.
type: docs
weight: 391
...
Efekt přechodu snímku do strany.
...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | Směr přechodu. Číst [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu čítače referencí spojenou s objektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Slouží jako hashovací funkce pro konkrétní typ, vhodná pro použití v hashovacích algoritmech a datových strukturách jako hashovací tabulka. |
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | Směr přechodu. Zapsat [TransitionSideDirectionType](../transitionsidedirectiontype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání příkazem C# lock(). Zavolejte přímo nebo použijte objekt střežce [LockContext](../../system/lockcontext/). |
...
* Třída [ISideDirectionTransition](../isidedirectiontransition/)
