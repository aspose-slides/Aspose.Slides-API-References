...
description: "ReflectionTypeLoadException je vyvolána metodou Module.GetTypes, pokud se některé třídy v modulu nepodaří načíst. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu ReflectionTypeLoadException. Nikdy neobalujte instance třídy ReflectionTypeLoadException do System::SmartPtr."
type: docs
weight: 66
url: /cs/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException třída


ReflectionTypeLoadException je vyvolána metodou Module.GetTypes, pokud se některé třídy v modulu nepodaří načíst. Nikdy ručně nevytvářejte instance této třídy. Použijte místo toho třídu ReflectionTypeLoadException. Nikdy neobalujte instance třídy ReflectionTypeLoadException do [System::SmartPtr](../../system/smartptr/).
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | Vrací výjimky, které způsobily tuto výjimku. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | Vrací informace o typu příčin výjimky. |
