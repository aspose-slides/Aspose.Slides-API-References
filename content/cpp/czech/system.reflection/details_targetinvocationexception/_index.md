...
description: "TargetInvocationException je vyvolána metodami volanými pomocí reflexe. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu TargetInvocationException. Nikdy neobalujte instance třídy TargetInvocationException do System::SmartPtr."
type: docs
weight: 79
url: /cs/system.reflection/details_targetinvocationexception/
---
## Details_TargetInvocationException třída


TargetInvocationException je vyvolána metodami volanými přes reflexi. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu TargetInvocationException. Nikdy neobalujte instance třídy TargetInvocationException do [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_applicationexception/gettype/)() const override | Získá skutečný typ objektu. Analogie volání C# [System.Object.GetType()](../../system/object/gettype/). |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Nastaví HRESULT, kódovanou číselnou hodnotu přiřazenou konkrétní výjimce. |
...
* Třída [Details_ApplicationException](../../system/details_applicationexception/)
