...
description: "Poskytuje informace o reflexi členů. Objektům této třídy by měla být alokována pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a používejte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 105
url: /cs/system.reflection/memberinfo/
---
## třída MemberInfo


Poskytuje informace o reflexi členů. Objektům této třídy by měla být alokována pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| Metoda | Popis |
| --- | --- |
| void [AddAttribute](./addattribute/)(const [ObjectPtr](./objectptr/)\&) | Přidá atribut do sbírky. |
...
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](./get_declaringtype/)() const | Získá deklarující typ. |
| const [String](../../system/string/)\& [get_FullName](./get_fullname/)() const | Získá úplný název členu. Může se lišit v ručně implementovaných částech. |
| virtual [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const | Získá hodnotu [System::Reflection::MemberTypes](../membertypes/) udávající typ členu – metoda, konstruktor, událost atd. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Získá název členu. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](./get_reflectedtype/)() const | Získá typ reflektovaného typu. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | Vrátí pole obsahující objekty, které představují všechny vlastní atributy aplikované na typ reprezentovaný aktuálním objektem. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(**bool**) const | Vrátí pole obsahující objekty, které představují všechny vlastní atributy aplikované na typ reprezentovaný aktuálním objektem. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Nevykonává žádné kopírování, jen inicializuje nový objekt a umožňuje konstrukci kopií podtříd. |
...
| Typedef | Popis |
| --- | --- |
| [ObjectPtr](./objectptr/) | Alias pro sdílený ukazatel na [Object](../../system/object/). |
