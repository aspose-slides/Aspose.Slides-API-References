...
description: "Obsahuje informace používané aplikací k připojení ke službě. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo k chybám tvrzení. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel pro předání jako argument funkcím."
type: docs
weight: 118
url: /cs/system.net/dnsendpoint/
---
## DnsEndPoint třída

Obsahuje informace používané aplikací pro připojení ke službě. Instance této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevyvíjejte instanci tohoto typu na zásobníku ani nepoužívejte operátor new, protože to povede k chybám za běhu a/nebo k chybám tvrzení. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](../endpoint/)\> [Create](../endpoint/create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Vytvoří novou instanci třídy [EndPoint](../endpoint/) pomocí zadané socketové adresy. |
| [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**) | Vytvoří novou instanci. |
| [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**, [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/)) | Vytvoří novou instanci. |
...
| [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_AddressFamily](./get_addressfamily/)() override | Vrací rodinu adres, ke které aktuální instance patří. |
| [String](../../system/string/) [get_Host](./get_host/)() | Vrací název hostitele. |
| **int32_t** [get_Port](./get_port/)() | Vrací číslo portu. |
...
| virtual [ImplPtr](../endpoint/implptr/) [GetImpl](../endpoint/getimpl/)() const | Vrací ukazatel na implementaci. |
