...
description: "Fiktivní třída umožňující propojení přeloženého kódu s referencemi FtpWebResponse, ale neprovádí jej. Neobsahuje žádné řádně implementované členy. Objektů této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k runtime chybám a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání funkcím jako argument."
type: docs
weight: 183
url: /cs/system.net/ftpwebresponse/
---
## Třída FtpWebResponse

Fiktivní třída umožňující propojení přeloženého kódu s referencemi [FtpWebResponse](./), ale neprovádí jej. Neobsahuje žádné řádně implementované členy. Instance této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním assercí. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
...
| Metoda | Popis |
| --- | --- |
| void [Close](./close/)() override | Není implementováno. |
...
| **int64_t** [get_ContentLength](./get_contentlength/)() override | Informace RTTI. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Není implementováno. |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | Není implementováno. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | Není implementováno. |
| virtual **bool** [get_SupportsHeaders](../webresponse/get_supportsheaders/)() | Vrací hodnotu, která naznačuje, zda aktuální odpověď podporuje hlavičky. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() override | Není implementováno. |
