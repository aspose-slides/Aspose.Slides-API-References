...
description: Obsahuje pomocné metody pro práci s hodnotami výčtu HttpResponseHeader.
type: docs
weight: 235
url: /cs/system.net/httpresponseheaderextensions/
---
## HttpResponseHeaderExtensions třída

Obsahuje pomocné metody pro práci s hodnotami výčtu HttpResponseHeader.
...
| static [String](../../system/string/) [GetName](./getname/)([HttpResponseHeader](../httpresponseheader/)) | Vrací název zadaného záhlaví. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
|  [HttpResponseHeaderExtensions](./httpresponseheaderextensions/)() | Odstraněný výchozí konstruktor. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonové argumenty jako slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí příkazu C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
