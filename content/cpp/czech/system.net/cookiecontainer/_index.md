...
| Metoda | Popis |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>) | Přidá cookie do kolekce. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>, **bool**) | Přidá cookie do kolekce. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](../cookiecollection/)\>) | Zkopíruje cookie ze zadané kolekce do aktuální. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>) | Přidá cookie pro zadané URI. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](../cookiecollection/)\>) | Zkopíruje cookie ze zadané kolekce pro zadané URI do aktuální kolekce. |
|  [CookieContainer](./cookiecontainer/)() | Vytvoří novou instanci. |
|  [CookieContainer](./cookiecontainer/)(**int32_t**) | Vytvoří novou instanci. |
|  [CookieContainer](./cookiecontainer/)(**int32_t**, **int32_t**, **int32_t**) | Vytvoří novou instanci. |
| [System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](../cookiecollection/)\> [CookieCutter](./cookiecutter/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), [String](../../system/string/), **bool**) | Zkopíruje cookie ze specifikované HTTP hlavičky pro zadané URI. |
...
| **int32_t** [get_Capacity](./get_capacity/)() | Získá kapacitu kolekce. |
| **int32_t** [get_Count](./get_count/)() | Vrací počet položek v kolekci. |
| **int32_t** [get_MaxCookieSize](./get_maxcookiesize/)() | Získá maximální velikost cookie. |
| **int32_t** [get_PerDomainCapacity](./get_perdomaincapacity/)() | Získá kapacitu kolekce na doménu. |
| [String](../../system/string/) [GetCookieHeader](./getcookieheader/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Vrátí HTTP hlavičku, která obsahuje cookie spojené se zadaným URI. |
| [String](../../system/string/) [GetCookieHeader](./getcookieheader/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)\&) | Vrátí HTTP hlavičku, která obsahuje cookie spojené se zadaným URI. |
| [System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](../cookiecollection/)\> [GetCookies](./getcookies/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Vrací kolekci cookie, které jsou spojené se zadaným URI. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](../cookiecollection/)\> [InternalGetCookies](./internalgetcookies/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Vrací kolekci cookie, které jsou spojené se zadaným URI. |
...
| **bool** [IsLocalDomain](./islocaldomain/)([String](../../system/string/)) | Kontroluje, zda je zadaná doména localhost. |
...
| void [set_Capacity](./set_capacity/)(**int32_t**) | Nastaví kapacitu kolekce. |
| void [set_MaxCookieSize](./set_maxcookiesize/)(**int32_t**) | Nastaví maximální velikost cookie. |
| void [set_PerDomainCapacity](./set_perdomaincapacity/)(**int32_t**) | Nastaví kapacitu kolekce na doménu. |
| void [SetCookies](./setcookies/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | Zkopíruje cookie ze zadané hlavičky do kolekce a spojí je se zadaným URI. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonový argument jako slabý ukazatel (namísto sdíleného). Umožní přepnutí ukazatelů v kontejnerech na slabý režim. |
...
| Pole | Popis |
| --- | --- |
| static [DefaultCookieLengthLimit](./defaultcookielengthlimit/) | Maximální velikost cookie. |
| static [DefaultCookieLimit](./defaultcookielimit/) | Maximální počet položek v kolekci. |
| static [DefaultPerDomainCookieLimit](./defaultperdomaincookielimit/) | Maximální počet položek v kolekci na doménu. |
