...
| void [Lock](../../system/object/lock/)() | Implementuje uzamykání pomocí C# lock() příkazu. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje uvolnění pomocí C# lock() příkazu. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| Pole | Popis |
| --- | --- |
| static [Http](./http/) | Řetězcová reprezentace HTTP. |
| static [Https](./https/) | Řetězcová reprezentace HTTPS. |
| static [SchemeDelimiter](./schemedelimiter/) | Řetězec, který představuje oddělovač schématu. |
| static [Ws](./ws/) | Řetězcová reprezentace WS. |
| static [Wss](./wss/) | Řetězcová reprezentace WSS. |
