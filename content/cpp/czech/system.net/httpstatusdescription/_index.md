...
description: Obsahuje pomocné metody pro získání řetězcové reprezentace HTTP statusu.
type: docs
weight: 248
url: /cs/system.net/httpstatusdescription/
---
## HttpStatusDescription třída

Obsahuje pomocné metody pro získání řetězcové reprezentace HTTP statusu.
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Porovnává objektové typy hodnot ve stylu C#. |
...
| static [String](../../system/string/) [Get](./get/)([HttpStatusCode](../httpstatuscode/)) | Vrací řetězcový popis zadaného HTTP status kódu. |
| static [String](../../system/string/) [Get](./get/)(**int32_t**) | Vrací řetězcový popis zadaného HTTP status kódu. |
...
|  [HttpStatusDescription](./httpstatusdescription/)() | Odstraněný výchozí konstruktor. |
