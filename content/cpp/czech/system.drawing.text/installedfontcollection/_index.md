...
description: "Representuje kolekci fontů nainstalovaných v systému. NENÍ IMPLEMENTOVÁNO. Objekt této třídy by měl být alokován pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 14
url: /cs/system.drawing.text/installedfontcollection/
---
...
| Metoda | Popis |
| --- | --- |
| void [Dispose](../fontcollection/dispose/)() override | Uvolňuje prostředky operačního systému získané aktuálním objektem. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](../fontcollection/get_families/)() | Vrací pole objektů [FontFamily](../../system.drawing/fontfamily/) spojených s kolekcí písem reprezentovanou aktuálním objektem. |
...
|  [InstalledFontCollection](./installedfontcollection/)() | Vytváří novou instanci třídy [InstalledFontCollection](./). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontroluje, zda objekt představuje instanci typu popsaného pomocí targetType. Analogie k operátoru C# 'is'. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí výrazu C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
