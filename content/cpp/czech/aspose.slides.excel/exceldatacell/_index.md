...
| **int32_t** [get_Column](./get_column/)() override | Získává index sloupce počínaje nulou v listu, kde se buňka nachází. Pouze pro čtení **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Získává název buňky dat grafu. |
| **int32_t** [get_Row](./get_row/)() override | Získává index řádku počínaje nulou v listu, kde se buňka nachází. Pouze pro čtení **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Získává hodnotu obsaženou v buňce [Excel](../). |
