...
description: Representuje sešit, který poskytuje přístup k Excel datům pro obecné použití.
type: docs
weight: 14
...
Representuje sešit, který poskytuje přístup k [Excel](../) datům pro obecné použití.
...
|  [ExcelDataWorkbook](./exceldataworkbook/)([System::String](../../system/string/)) | Inicializuje novou instanci pomocí zadané cesty k souboru. |
|  [ExcelDataWorkbook](./exceldataworkbook/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Inicializuje novou instanci třídy pomocí poskytnutého proudu. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| [System::SharedPtr](../../system/sharedptr/)\<[IExcelDataCell](../iexceldatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**) override | Získá buňku ze specifikovaného listu pomocí jejího indexu a souřadnic buňky. |
| [System::SharedPtr](../../system/sharedptr/)\<[IExcelDataCell](../iexceldatacell/)\> [GetCell](./getcell/)([System::String](../../system/string/), **int32_t**, **int32_t**) override | Získá buňku ze specifikovaného listu pomocí jejího názvu a souřadnic buňky. |
| [System::SharedPtr](../../system/sharedptr/)\<[IExcelDataCell](../iexceldatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/)) override | Získá buňku ze specifikovaného listu pomocí jejího indexu a názvu buňky ve stylu Excel (např. "B2"). |
| [System::SharedPtr](../../system/sharedptr/)\<[IExcelDataCell](../iexceldatacell/)\> [GetCell](./getcell/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Získá buňku ze specifikovaného listu pomocí názvu buňky ve stylu Excel (např. "B2"). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::ObjectModel::ReadOnlyCollection](../../system.collections.objectmodel/readonlycollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExcelDataCell](../iexceldatacell/)\>\>\> [GetCells](./getcells/)([System::String](../../system/string/), **bool**) override | Získá kolekci buněk ze sešitu, které odpovídají zadanému vzorci. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<**int32_t**, [System::String](../../system/string/)\>\> [GetChartsFromWorksheet](./getchartsfromworksheet/)([System::String](../../system/string/)) override | Získá slovník obsahující indexy a názvy všech grafů ve specifikovaném listu [Excel](../) sešitu. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::String](../../system/string/)\>\> [GetWorksheetNames](./getworksheetnames/)() override | Získá názvy všech listů obsažených v [Excel](../) sešitu. |
...
* Třída [IExcelDataWorkbook](../iexceldataworkbook/)
