...
---
## IExcelDataWorkbook::GetCells(System::String, bool) metoda


Načte kolekci buněk z sešitu, které odpovídají zadanému vzorci.
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| formula | [System::String](../../../system/string/) | Vzorec nebo rozsah (např. "Sheet1!A1:B3") použité k určení cílových buněk. |
