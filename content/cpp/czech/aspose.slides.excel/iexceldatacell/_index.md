...
description: Representuje jednu buňku v Excel sešitu.
type: docs
weight: 27
url: /cs/aspose.slides.excel/iexceldatacell/
---
## IExcelDataCell třída
...
| virtual **int32_t** [get_Column](./get_column/)() | Získá nulový index sloupce v listu, kde se buňka nachází. Pouze ke čtení **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Získá název buňky dat grafu. Pouze ke čtení [System::String](../../system/string/). |
| virtual **int32_t** [get_Row](./get_row/)() | Získá nulový index řádku v listu, kde se buňka nachází. Pouze ke čtení **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | Získá hodnotu obsaženou v buňce [Excel](../). Pouze ke čtení [System::Object](../../system/object/). |
