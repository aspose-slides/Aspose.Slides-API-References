...
description: "Representuje jednofarebný štětec. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to může vést k runtime chybám a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 300
url: /cs/system.drawing/solidbrush/
---
## SolidBrush třída

Representuje jednofarebný štětec. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to způsobí běhové chyby a/nebo poruchy aserce. Vždy obalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| [Color](../color/) [get_Color](./get_color/)() const | Vrací barvu tohoto štětce. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# příkazem lock(). Vyvolejte přímo nebo použijte objekt sentinel [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Skutečně nic nepřekopíruje, jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Skutečně nic nepřekopíruje, jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
...
| void [set_Color](./set_color/)([Color](../color/)) | Nastaví barvu tohoto štětce. |
...
|  [SolidBrush](./solidbrush/)(const [Color](../color/)\&) | Vytvoří nový objekt [SolidBrush](./) a inicializuje jej zadanou barvou. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování C# příkazem lock(). Vyvolejte přímo nebo použijte sentinel objekt [LockContext](../../system/lockcontext/). |
