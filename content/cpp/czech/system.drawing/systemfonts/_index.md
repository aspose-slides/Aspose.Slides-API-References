...
description: Poskytuje sadu předpřipravených objektů Font, které představují písma používaná k zobrazování textu v ovládacích prvcích Windows. Jedná se o statický typ bez instančních služeb. Nikdy byste neměli vytvářet jeho instance jakýmkoli způsobem.
type: docs
weight: 339
url: /cs/system.drawing/systemfonts/
---
## SystemFonts třída

Poskytuje sadu předpřipravených [Font](../font/) objektů, které představují písma používaná k zobrazování textu v [Windows](../../system.windows/) zobrazovacích prvcích. Jedná se o statický typ bez instančních služeb. Nikdy byste neměli vytvářet jeho instance jakýmkoli způsobem.
...
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_CaptionFont](./get_captionfont/)() | NEIMPLEMENTOVÁNO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | Vrací objekt [Font](../font/), který představuje výchozí písmo, které může aplikace použít pro dialogová okna a formuláře. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_IconTitleFont](./get_icontitlefont/)() | NEIMPLEMENTOVÁNO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MenuFont](./get_menufont/)() | NEIMPLEMENTOVÁNO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MessageBoxFont](./get_messageboxfont/)() | NEIMPLEMENTOVÁNO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_SmallCaptionFont](./get_smallcaptionfont/)() | NEIMPLEMENTOVÁNO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_StatusFont](./get_statusfont/)() | NEIMPLEMENTOVÁNO. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zámek C# lock() pro zamykání. Zavolejte přímo nebo použijte strážní objekt [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení C# lock() pro odemčení. Zavolejte přímo nebo použijte strážní objekt [LockContext](../../system/lockcontext/). |
