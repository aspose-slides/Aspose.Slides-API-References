...
description: Struktura Rectangle
type: docs
weight: 27
url: /cs/aspose.slides.drawing/rect32f/
---
## Rect32f třída
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Volá se přímo nebo používá objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock(). Volá se přímo nebo používá objekt strážce [LockContext](../../system/lockcontext/). |
