...
description: Umožňuje vytvořit VBA projekt přes rozhraní COM
type: docs
weight: 170
...
| Metoda | Popis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() override | Vytvoří nový VBA projekt. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaProjectFactory](./)\> [get_Instance](./get_instance/)() | Statická instance továrny na VBA projekty. Pouze pro čtení [VbaProjectFactory](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Načte VBA projekt z OLE kontejneru. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídání [LockContext](../../system/lockcontext/). |
...
* Třída [IVbaProjectFactory](../ivbaprojectfactory/)
