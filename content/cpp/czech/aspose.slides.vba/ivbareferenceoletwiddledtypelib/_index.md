...
description: "Reprezentuje upravený odkaz na knihovnu typů OLE Automation, ve které jsou všechna ovládací prvky označena jako rozšiřitelná."
type: docs
weight: 92
url: /cs/aspose.slides.vba/ivbareferenceoletwiddledtypelib/
---
## IVbaReferenceOleTwiddledTypeLib třída
...
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | Představuje název odkazu na VBA projekt. Číst [System::String](../../system/string/). |
...
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | Představuje název odkazu na VBA projekt. Zápis [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí příkazu C# lock(). Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
