...
description: Representuje modul, který je obsažen ve VBA projektu.
type: docs
weight: 1
...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Název modulu. Pouze pro čtení [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_SourceCode](./get_sourcecode/)() | Zdrojový kód modulu. Číst [System::String](../../system/string/). |
...
| virtual void [set_SourceCode](./set_sourcecode/)([System::String](../../system/string/)) | Zdrojový kód modulu. Zápis [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení příkazu C# lock(). Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
