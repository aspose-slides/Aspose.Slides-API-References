...
description: Representuje VBA projekt s makry prezentace.
type: docs
weight: 27
...
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Určuje, zda je VBAProject chráněn heslem pro zobrazení vlastností projektu. Pouze pro čtení **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | Vrací modul obsažený v projektu VBA na zadaném indexu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | Vrací seznam všech modulů, které jsou obsaženy v projektu VBA. Pouze pro čtení [IVbaModuleCollection](../ivbamodulecollection/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Vrací název projektu VBA. Pouze pro čtení [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | Vrací referenci obsaženou v projektu VBA na zadaném indexu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | Vrací seznam všech referencí, které jsou obsaženy v projektu VBA. Pouze pro čtení [IVbaReferenceCollection](../ivbareferencecollection/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | Vrací binární reprezentaci projektu VBA jako OLE kontejner. Pouze pro čtení **uint8_t**[]. |
