...
description: Implementuje rozhraní IEnumerator pro prázdnou generickou kolekci.
type: docs
weight: 27
url: /cs/system.linq.details/emptyenumerator/
---
## EmptyEnumerator třída

Implementuje rozhraní IEnumerator pro prázdnou generickou kolekci.
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Získá aktuální prvek. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Označuje enumerátor vlastněný virtualizovaným iterátorem. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umožňuje klonování vlastních typů. |
| **bool** [MoveNext](./movenext/)() override | Posune enumerátor na další prvek. Pokud předtím nebyl žádný prvek odkazován, nastaví odkaz na první dostupný prvek. Pokud byl dosažen konec kontejneru, nedělá nic. |
...
| void [Reset](./reset/)() override | Obnoví enumerátor do pozice před prvním prvkem. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock() příkazu. Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
