...
| Metoda | Popis |
| --- | --- |
| void [Dispose](./dispose/)() override | Uvolní aktuální instanci. Tato metoda také uvolňuje obsah HTTP odpovědi. |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpResponseMessage](./)\> [EnsureSuccessStatusCode](./ensuresuccessstatuscode/)() | Kontroluje stavový kód. HttpRequestException bude vyvolána, když stavový kód nepatří do 2xx. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\> [get_Content](./get_content/)() const | Získá obsah HTTP odpovědi. |
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpResponseHeaders](../../system.net.http.headers/httpresponseheaders/)\> [get_Headers](./get_headers/)() const | Vrací hlavičky obsahu HTTP. |
| **bool** [get_IsSuccessStatusCode](./get_issuccessstatuscode/)() const | Kontroluje, zda stavový kód naznačuje, že požadavek klienta byl přijmut, pochopen a přijat. |
| [String](../../system/string/) [get_ReasonPhrase](./get_reasonphrase/)() const | Získá Reason-Phrase, který servery posílají spolu se stavovým kódem. |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\> [get_RequestMessage](./get_requestmessage/)() const | Získá HTTP zprávu požadavku. |
| [HttpStatusCode](../../system.net/httpstatuscode/) [get_StatusCode](./get_statuscode/)() const | Získá HTTP stavový kód. |
| [System::Version](../../system/version/) [get_Version](./get_version/)() const | Získá verzi HTTP. |
...
|  [HttpResponseMessage](./httpresponsemessage/)() | Vytvoří novou instanci. |
|  [HttpResponseMessage](./httpresponsemessage/)([HttpStatusCode](../../system.net/httpstatuscode/)) | Vytvoří novou instanci. |
...
| void [set_Content](./set_content/)([System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\>) | Nastaví obsah HTTP odpovědi. |
| void [set_ReasonPhrase](./set_reasonphrase/)([String](../../system/string/)) | Nastaví Reason-Phrase, který servery posílají spolu se stavovým kódem. |
| void [set_RequestMessage](./set_requestmessage/)([System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\>) | Nastaví HTTP zprávu požadavku. |
| void [set_StatusCode](./set_statuscode/)([HttpStatusCode](../../system.net/httpstatuscode/)) | Nastaví HTTP stavový kód. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock() příkazu. Volá se přímo nebo se použije objekt hlídky [LockContext](../../system/lockcontext/). |
