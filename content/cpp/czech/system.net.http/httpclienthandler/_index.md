...
description: "Reprezentuje výchozí zpracovatel zpráv používaný třídou HttpClient. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože by to vedlo k chybám runtime a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání funkci jako argument."
type: docs
weight: 40
url: /cs/system.net.http/httpclienthandler/
---
## HttpClientHandler třída

Reprezentuje výchozí zpracovatel zpráv používaný třídou [HttpClient](../httpclient/). Instance této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám runtime a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání ji funkcím jako argument.
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Net::CookieContainer](../../system.net/cookiecontainer/)\> [get_CookieContainer](./get_cookiecontainer/)() | Získá kontejner cookie, který se používá k uložení cookies serveru. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../../system.net/icredentials/)\> [get_Credentials](./get_credentials/)() | Získá autentizační informace. |
...
|  [HttpClientHandler](./httpclienthandler/)() | Vytvoří novou instanci. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# lock() příkazu. Volá se přímo nebo pomocí [LockContext](../../system/lockcontext/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[HttpResponseMessage](../httpresponsemessage/)\> [Send](./send/)([System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\>) override | Odesílá specifikovaný požadavek. |
| void [set_CookieContainer](./set_cookiecontainer/)([System::SharedPtr](../../system/sharedptr/)\<[System::Net::CookieContainer](../../system.net/cookiecontainer/)\>) | Nastaví kontejner cookie, který se používá k uložení cookies serveru. |
| void [set_Credentials](./set_credentials/)([System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../../system.net/icredentials/)\>) | Nastaví autentizační informace. |
| void [set_Proxy](./set_proxy/)([System::SharedPtr](../../system/sharedptr/)\<[IWebProxy](../../system.net/iwebproxy/)\>) | Nastaví informace o proxy. |
| void [set_Timeout](./set_timeout/)(**int32_t**) | Získá čas v milisekundách, po kterém požadavek vyprší. |
| void [set_UseCookies](./set_usecookies/)(**bool**) | Nastaví hodnotu, která určuje, zda aktuální instance používá kontejner cookie k uložení cookies serveru a zda instance používá serverové cookies při odesílání požadavků. |
| void [set_UseProxy](./set_useproxy/)(**bool**) | Nastaví hodnotu, která určuje, zda aktuální instance používá proxy pro odesílání požadavků. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování C# lock() příkazu. Volá se přímo nebo pomocí [LockContext](../../system/lockcontext/). |
