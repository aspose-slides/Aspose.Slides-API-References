...
description: Obsahuje pomocné metody.
type: docs
weight: 131
url: /cs/system.net.http/httputilities/
---
## HttpUtilities třída
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Kontroluje, zda je zadané URI HTTP URI. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí C# příkazu lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| Pole | Popis |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | Výchozí verze HTTP pro odesílání požadavků. |
| static [DefaultResponseVersion](./defaultresponseversion/) | Výchozí verze HTTP pro přijímání odpovědí. |
