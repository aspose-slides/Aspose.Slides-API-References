...
description: "Reprezentuje HTTP metodu. Objektům této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k běhovým chybám a/nebo selháním aserčních podmínek. Vždy obalte tuto třídu ukazatelem System::SmartPtr a použijte tento ukazatel k předání do funkcí jako argument."
type: docs
weight: 92
url: /cs/system.net.http/httpmethod/
---
## HttpMethod třída

Representuje HTTP metodu. Objektům této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k běhovým chybám a/nebo selháním aserčních podmínek. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](./)\>) override | Určuje, zda jsou aktuální a zadané objekty rovny. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](./)\> [get_Delete](./get_delete/)() | Vrací HTTP metodu 'DELETE'. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](./)\> [get_Get](./get_get/)() | Vrací HTTP metodu 'GET'. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](./)\> [get_Head](./get_head/)() | Vrací HTTP metodu 'HEAD'. |
| [String](../../system/string/) [get_Method](./get_method/)() | Vrací řetězcovou reprezentaci HTTP metody. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](./)\> [get_Options](./get_options/)() | Vrací HTTP metodu 'OPTIONS'. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](./)\> [get_Post](./get_post/)() | Vrací HTTP metodu 'POST'. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](./)\> [get_Put](./get_put/)() | Vrací HTTP metodu 'PUT'. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](./)\> [get_Trace](./get_trace/)() | Vrací HTTP metodu 'TRACE'. |
...
|  [HttpMethod](./httpmethod/)([String](../../system/string/)) | Vytvoří novou instanci. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje konverzi vlastních objektů na řetězec. |
