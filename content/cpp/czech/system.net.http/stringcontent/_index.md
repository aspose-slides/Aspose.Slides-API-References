...
description: "Zastupuje HTTP obsah jako řetězec. Objektům této třídy by mělo být alokováno pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 144
url: /cs/system.net.http/stringcontent/
---
## StringContent třída

Reprezentuje HTTP obsah jako řetězec. Objektů této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| Metoda | Popis |
| --- | --- |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Vytvoří novou instanci. |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Vytvoří novou instanci. |
| void [Dispose](../httpcontent/dispose/)() override | Uvolní aktuální instanci. Tato metoda také uvolní proud vrácený funkcí 'ReadAsStream' a paměťový buffer, pokud byl vytvořen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](../httpcontent/get_headers/)() | Vrací hlavičky HTTP obsahu. |
...
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)() | Serializuje obsah do paměťového bufferu. |
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)(**int64_t**) | Serializuje obsah do paměťového bufferu. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ReadAsByteArray](../httpcontent/readasbytearray/)() | Serializuje obsah a vrátí pole bajtů. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [ReadAsStream](../httpcontent/readasstream/)() | Serializuje obsah a vrátí proud. |
| [String](../../system/string/) [ReadAsString](../httpcontent/readasstring/)() | Serializuje obsah a vrátí řetězec. |
...
|  [StringContent](./stringcontent/)([String](../../system/string/)) | Vytvoří novou instanci. |
|  [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>) | Vytvoří novou instanci. |
|  [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>, [String](../../system/string/)) | Vytvoří novou instanci. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje převod vlastních objektů na řetězec. |
| **bool** [TryComputeLength](../bytearraycontent/trycomputelength/)(**int64_t**\&) override | Pokouší se vypočítat délku pole bajtů. |
...
| Pole | Popis |
| --- | --- |
| static [DefaultStringEncoding](../httpcontent/defaultstringencoding/) | Výchozí kódování. |
| static [MaxBufferSize](../httpcontent/maxbuffersize/) | Maximální počet bajtů. |

## Viz také

* Třída [ByteArrayContent](../bytearraycontent/)
