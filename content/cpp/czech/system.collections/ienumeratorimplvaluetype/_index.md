...
description: Obal, který vytváří neobecnou implementaci IEnumerator nad obecnou iterátorem IEnumeratorImplRefType - obálka pro typy hodnot.
type: docs
weight: 92
url: /cs/system.collections/ienumeratorimplvaluetype/
---
## IEnumeratorImplValueType třída

Obal, který vytváří neobecnou [IEnumerator](../ienumerator/) implementaci nad obecnou iterátorem [IEnumeratorImplRefType](../ienumeratorimplreftype/) - obal pro typy hodnot.
...
| Metoda | Popis |
| --- | --- |
| virtual const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\& [Current](../ienumerator/current/)() const | Získá aktuální prvek. |
...
| const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\& [get_Current](./get_current/)() const override | Získá aktuální prvek. |
...
|  [IEnumeratorImplValueType](./ienumeratorimplvaluetype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\>) | konstruktor obalu |
...
| **bool** [MoveNext](./movenext/)() override | Přesune enumerátor na další prvek. Pokud předtím nebyl žádný prvek odkazován, nastaví odkaz na první dostupný prvek. Pokud byl dosažen konec kontejneru, nedělá nic. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| virtual void [Reset](../ienumerator/reset/)() | Resetuje enumerátor na pozici před první prvkem. |
