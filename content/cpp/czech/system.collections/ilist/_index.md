...
description: IList představuje neobecnou kolekci objektů, ke kterým lze individuálně přistupovat pomocí indexu.
type: docs
weight: 118
url: /cs/system.collections/ilist/
---
## IList třída


[IList](./) představuje neobecnou kolekci objektů, ke kterým lze individuálně přistupovat pomocí indexu.
...
| Method | Description |
| --- | --- |
| virtual int [Add](./add/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Přidá položku na konec seznamu. |
| virtual void [Clear](./clear/)() | Odstraní všechny položky ze seznamu. |
| virtual **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Zkontroluje, zda je položka v seznamu. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnávání floating-point podle stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnávání floating-point podle stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní použití. |
| virtual int [get_Count](../icollection/get_count/)() const | Získá počet prvků ve sbírce. |
| virtual **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Získá hodnotu, která určuje, zda má seznam pevnou velikost. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | Vrátí enumerátor, který prochází sbírku. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const | Získá položku na zadaném indexu. |
| virtual int [IndexOf](./indexof/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Získá první index zadané položky. |
| virtual void [Insert](./insert/)(int, [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Vloží položku do seznamu na zadaném indexu. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nekopíruje nic, pouze inicializuje nový objekt a umožňuje kopírování konstruktorů podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nekopíruje nic, pouze inicializuje nový objekt a umožňuje kopírování konstruktorů podtříd. |
...
| virtual void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Odstraní první výskyt zadané položky ze seznamu. |
| virtual void [RemoveAt](./removeat/)(int) | Odstraní položku ze seznamu na zadaném indexu. |
