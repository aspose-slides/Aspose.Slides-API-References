...
description: Poskytuje abstraktní základní třídu pro silně typovanou kolekci.
type: docs
weight: 27
url: /cs/system.collections/collectionbase/
---
...
| void [Clear](./clear/)() | Odstraní všechny objekty z instance kolekce. Tato metoda nemůže být přepsána. |
...
| **int32_t** [get_Capacity](./get_capacity/)() | Vrací počet prvků, které může kolekce obsahovat. |
| **int32_t** [get_Count](./get_count/)() | Vrací počet prvků obsažených v instanci kolekce. Tato metoda nemůže být přepsána. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který prochází instanci kolekce. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformovací funkci na každý prvek obecné sekvence a vrací maximální výslednou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformovací funkci na každý prvek obecné sekvence a vrací minimální výslednou hodnotu. |
...
| void [RemoveAt](./removeat/)(**int32_t**) | Odstraní prvek na zadaném indexu instance kolekce. Tato metoda není přepisovatelná. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený referenční čítač o zadanou hodnotu. |
| void [set_Capacity](./set_capacity/)(**int32_t**) | Nastaví počet prvků, které může kolekce obsahovat. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje převádění vlastních objektů na řetězec. |
...
| Typedef | Popis |
| --- | --- |
| [Ptr](./ptr/) | Alias na sdílený ukazatel na instanci této třídy. |
## Viz také
