...
description: IEnumerable je základní rozhraní pro všechny neobecné kolekce, které lze enumerovat.
type: docs
weight: 53
url: /cs/system.collections/ienumerable/
---
## IEnumerable třída

[IEnumerable](./) je základní rozhraní pro všechny neobecné kolekce, které lze enumerovat.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Vrátí enumerátor, který prochází kolekcí. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n'tý argument šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepnutí ukazatelů v kontejnerech na slabý režim. |
