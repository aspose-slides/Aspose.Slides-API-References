...
description: Definuje obecné provedení Tuple, které umožňuje přístup k členům instance Tuple bez znalosti podkladového typu Tuple.
type: docs
weight: 53
url: /cs/system.runtime.compilerservices/ituple/
---
## ITuple třída


Definuje obecné [Tuple](../../system/tuple/) provedení, které umožňuje přístup k členům instance [Tuple](../../system/tuple/) bez znalosti podkladového typu [Tuple](../../system/tuple/).
...
| virtual **int32_t** [get_Length](./get_length/)() const | Vrací počet pozic v této datové struktuře. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Vrací prvek na pozici index. |
