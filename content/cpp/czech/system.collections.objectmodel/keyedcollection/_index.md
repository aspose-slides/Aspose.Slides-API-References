...
description: "Abstraktní kolekce prvků s vloženými klíči. Objektům této třídy by mělo být alokováno pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předávání jako argument funkcím."
type: docs
weight: 14
url: /cs/system.collections.objectmodel/keyedcollection/
---
## Třída KeyedCollection

Abstraktní kolekce prvků s vloženými klíči. Objektů této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel k předávání jako argument funkcím.
...
| Metoda | Popis |
| --- | --- |
| void [Add](./add/)(const TItem\&) override | Přidá položku na konec kontejneru. |
...
| void [Clear](../collection/clear/)() override | Odstraní všechny prvky. |
| [Collection](../collection/collection/)() | Vytvoří prázdnou kolekci. |
| [Collection](../collection/collection/)([SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) |  |
| **bool** [Contains](./contains/)(TKey) | Kontroluje, zda je klíč přítomen v kontejneru. |
| **bool** [Contains](../collection/contains/)(const T\&) const override | Kontroluje, zda je položka přítomna v kolekci. |
| void [CopyTo](../collection/copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Zkopíruje prvky kolekce do existujících prvků pole. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crbegin](../collection/crbegin/)() const | Získá reverzní iterátor na poslední konstantní prvek kolekce (první v opačném pořadí). |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crend](../collection/crend/)() const | Získá reverzní iterátor na neexistující konstantní prvek před začátkem kolekce. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\> [get_Comparer](./get_comparer/)() | Získá komparátor. |
| int [get_Count](../collection/get_count/)() const override | Získá počet prvků. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](../collection/get_items/)() | Přístup k interní datové struktuře. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](../collection/get_items/)() const | Přístup k interní datové struktuře. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../collection/getenumerator/)() override | Získá enumerátor pro iteraci přes kolekci. |
...
| TItem [idx_get](./idx_get/)(TKey) | Získá položku na konkrétním indexu. |
| T [idx_get](../collection/idx_get/)(int) const override | Získá hodnotu na zadaném indexu. |
| void [idx_set](../collection/idx_set/)(int, T) override | Nastaví hodnotu na zadaném indexu. |
| int [IndexOf](../collection/indexof/)(const T\&) const override | Vyhledá prvek v kolekci. |
| void [Insert](../collection/insert/)(int, const T\&) override | Vloží položku na zadanou pozici. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje copy konstrukci podtříd. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | Operátor přiřazení přesunutí. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | Operátor přiřazení přesunutí. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje copy konstrukci podtříd. |
| T\& [operator[]](../collection/operator[]/)(int) | Získá hodnotu na zadaném indexu. |
| const T\& [operator[]](../collection/operator[]/)(int) const | Získá hodnotu na zadaném indexu. |
| [reverse_iterator](../collection/reverse_iterator/) [rbegin](../collection/rbegin/)() | Získá reverzní iterátor na poslední prvek kolekce (první v opačném pořadí). |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rbegin](../collection/rbegin/)() const | Získá reverzní iterátor na poslední prvek konstantní kolekce (první v opačném pořadí). |
...
| **bool** [Remove](./remove/)(TKey) | Odstraňuje klíč z kontejneru. |
| **bool** [Remove](../collection/remove/)(const T\&) override | Odstraňuje konkrétní položku. |
| void [RemoveAt](../collection/removeat/)(int) override | Odstraňuje položku na konkrétní pozici. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| [reverse_iterator](../collection/reverse_iterator/) [rend](../collection/rend/)() | Získá reverzní iterátor na neexistující prvek před začátkem kolekce. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rend](../collection/rend/)() const | Získá reverzní iterátor na neexistující prvek před začátkem konstantní kolekce. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Upraví konkrétní šablonový argument tak, aby byl považován za slabý ukazatel místo sdíleného ukazatele (pokud je to použitelné). |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../collection/virtualizebeginconstiterator/)() const override | Získá implementaci začátku konstantního iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../collection/virtualizebeginiterator/)() override | Získá implementaci začátku iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../collection/virtualizeendconstiterator/)() const override | Získá implementaci konce konstantního iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../collection/virtualizeenditerator/)() override | Získá implementaci konce iterátoru pro aktuální kontejner. |
...
| Pole | Popis |
| --- | --- |
| static [defaultThreshold](./defaultthreshold/) | Prahová hodnota vytvoření vyhledávacího slovníku, výchozí. |

## Viz také

* Třída [Collection](../collection/)
