...
description: Kontroluje, zda je rok přestupný.
type: docs
weight: 92
url: /cs/system.globalization/japaneselunisolarcalendar/isleapyear/
---
## JapaneseLunisolarCalendar::IsLeapYear(int, int) const metoda
...
True pokud je zadaný rok přestupný, false jinak.

## JapaneseLunisolarCalendar::IsLeapYear(int) const metoda
