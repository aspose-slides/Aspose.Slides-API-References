...
description: Kontroluje, zda je měsíc přestupný.
type: docs
weight: 118
url: /cs/system.globalization/chineselunisolarcalendar/isleapmonth/
---
## ChineseLunisolarCalendar::IsLeapMonth(int, int, int) const metoda

Kontroluje, zda je měsíc přestupný.
...
True pokud je zadaný měsíc přestupný, jinak false.
