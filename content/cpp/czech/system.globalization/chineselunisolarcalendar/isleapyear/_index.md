...
type: docs
weight: 105
url: /cs/system.globalization/chineselunisolarcalendar/isleapyear/
---
## ChineseLunisolarCalendar::IsLeapYear(int, int) const metoda
...
## ChineseLunisolarCalendar::IsLeapYear(int) const metoda
