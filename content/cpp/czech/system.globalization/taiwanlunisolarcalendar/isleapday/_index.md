...
description: Kontroluje, zda je den přestupný.
type: docs
weight: 118
url: /cs/system.globalization/taiwanlunisolarcalendar/isleapday/
---
## TaiwanLunisolarCalendar::IsLeapDay(int, int, int, int) const metoda

Kontroluje, zda je den přestupný.
...
True pokud je zadané datum přestupné, false jinak.

## TaiwanLunisolarCalendar::IsLeapDay(int, int, int) const metoda
