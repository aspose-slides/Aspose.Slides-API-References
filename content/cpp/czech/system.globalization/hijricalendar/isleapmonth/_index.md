...
type: docs
weight: 131
url: /cs/system.globalization/hijricalendar/isleapmonth/
---
## HijriCalendar::IsLeapMonth(int, int, int) const metoda
...
True, pokud je zadaný měsíc přestupný, false jinak.

## HijriCalendar::IsLeapMonth(int, int) const metoda
