...
description: Reprezentuje fasetu enumerace ze schématu XML Schema podle specifikace World Wide Web Consortium (W3C). Tato třída určuje seznam platných hodnot pro prvek simpleType. Deklarace je obsažena v deklaraci restriction.
type: docs
weight: 378
url: /cs/system.xml.schema/xmlschemaenumerationfacet/
---
## XmlSchemaEnumerationFacet třída

Representuje **enumeration** fasetu z XML [Schema](../) podle specifikace World Wide [Web](../../system.web/) Consortium (W3C). Tato třída určuje seznam platných hodnot pro prvek simpleType. Deklarace je obsažena v deklaraci **restriction**.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Vrací informaci, která naznačuje, že tato faseta je pevná. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Nastavuje informaci, která naznačuje, že tato faseta je pevná. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tou šablonovou argument jako slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
| int [SharedCount](../../system/object/sharedcount/)() const | Získává aktuální hodnotu sdíleného počítadla odkazů. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvětšuje sdílený počet odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvětšuje slabý počet odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje slabý počet odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
|  [XmlSchemaEnumerationFacet](./xmlschemaenumerationfacet/)() | Inicializuje novou instanci třídy [XmlSchemaEnumerationFacet](./). |
...
* Třída [XmlSchemaFacet](../xmlschemafacet/)
