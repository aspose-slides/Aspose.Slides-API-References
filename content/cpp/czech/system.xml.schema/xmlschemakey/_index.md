...
description: Tato třída představuje prvek key ze XMLSchema podle specifikace World Wide Web Consortium (W3C).
type: docs
weight: 534
url: /cs/system.xml.schema/xmlschemakey/
---
## XmlSchemaKey třída


Tato třída představuje **key** element ze XMLSchema podle specifikace World Wide [Web](../../system.web/) Consortium (W3C).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje C#-style porovnání s plovoucí desetinnou čárkou, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje C#-style porovnání s plovoucí desetinnou čárkou, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](../xmlschemaidentityconstraint/get_fields/)() | Vrací sbírku polí, která se používají jako potomci pro selektor výrazu XML Path Language ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](../xmlschemaidentityconstraint/get_name/)() | Vrací název identitního omezení. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](../xmlschemaidentityconstraint/get_qualifiedname/)() | Vrací kvalifikovaný název identitního omezení, který obsahuje po-kompilaci interpretaci hodnoty **QualifiedName**. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógie k metodě C# [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ověří, zda objekt představuje instanci typu popsaného targetType. Analógie k operátoru C# 'is'. |
...
| void [set_Name](../xmlschemaidentityconstraint/set_name/)(const [String](../../system/string/)\&) | Nastaví název identitního omezení. |
...
| void [set_Selector](../xmlschemaidentityconstraint/set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Nastaví element **selector** výrazu [XPath](../../system.xml.xpath/). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asertací. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel při předávání do funkcí jako argument. 
