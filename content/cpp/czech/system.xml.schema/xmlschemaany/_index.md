...
description: Representuje libovolný prvek World Wide Web Consortium (W3C).
type: docs
weight: 131
url: /cs/system.xml.schema/xmlschemaany/
---
## XmlSchemaAny třída
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje srovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Vrací jmenné prostory obsahující prvky, které lze použít. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Vrací informace o tom, jak má aplikace nebo XML procesor zpracovávat validaci XML dokumentů pro prvky určené elementem **any**. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Nastavuje jmenné prostory obsahující použitelné prvky. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Nastavuje XmlSerializerNamespaces k použití s tímto schématem. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Nastavuje informace o tom, jak má aplikace nebo XML procesor zpracovávat validaci XML dokumentů pro prvky určené elementem **any**. |
...
|  [XmlSchemaAny](./xmlschemaany/)() | Inicializuje novou instanci třídy [XmlSchemaAny](./). |
