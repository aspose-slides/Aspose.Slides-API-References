...
description: Třída pro definování číselných faset. Tato třída je základní třídou pro číselné fasetové třídy, jako je XmlSchemaMinLengthFacet.
type: docs
weight: 664
url: /cs/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet třída

Vazová třída pro definování **číselných** faset. Tato třída je základní třída pro **číselné** fasetové třídy, jako je [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/).
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Vrací řetězcový identifikátor. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získává datovou strukturu referenčního čítače spojeného s objektem. |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevyvíjejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel pro předání jako argument funkcím. 
