...
description: Obsahuje mezipaměť schémat XML Schema definition language (XSD) a XML-Data Reduced (XDR).
type: docs
weight: 222
url: /cs/system.xml.schema/xmlschemacollection/
---
## XmlSchemaCollection třída

Obsahuje cache schémat XML [Schema](../) definition language (XSD) a XML-Data Reduced (XDR) schemas.
...
| Metoda | Popis |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Přidá schéma umístěné na zadané URL do kolekce schémat. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Přidá schéma obsažené v [XmlReader](../../system.xml/xmlreader/) do kolekce schémat. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Přidá schéma obsažené v [XmlReader](../../system.xml/xmlreader/) do kolekce schémat. Specifikovaný [XmlResolver](../../system.xml/xmlresolver/) se používá k vyřešení jakýchkoli externích zdrojů. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Přidá [XmlSchema](../xmlschema/) do kolekce. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Přidá [XmlSchema](../xmlschema/) do kolekce. Specifikovaný [XmlResolver](../../system.xml/xmlresolver/) se používá k vyřešení jakýchkoli externích odkazů. |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | Přidá všechny jmenné prostory definované v dané kolekci (včetně jejich souvisejících schémat) do této kolekce. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Získá iterátor umístěný hned za posledním konstantně kvalifikovaným prvkem (pokud existuje) kolekce. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Vrací hodnotu indikující, zda **targetNamespace** specifikovaného [XmlSchema](../xmlschema/) je v kolekci. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | Vrací hodnotu indikující, zda schéma se specifikovaným jmenným prostorem je v kolekci. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | Zkopíruje všechny objekty [XmlSchema](../xmlschema/) z této kolekce do zadaného pole počínaje zadaným indexem. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Získá iterátor umístěný hned za posledním prvkem (pokud existuje) kolekce. Tento iterátor nelze použít ke změně odkazovaného objektu, protože [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) vrací kopii objektu T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Získá iterátor umístěný hned za posledním prvkem (pokud existuje) konstantně kvalifikované instance kolekce. |
...
| **int32_t** [get_Count](./get_count/)() | Vrací počet jmenných prostorů definovaných v této kolekci. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | Vrací výchozí [XmlNameTable](../../system.xml/xmlnametable/) používaný [XmlSchemaCollection](./) při načítání nových schémat. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | Poskytuje podporu pro iteraci přes kolekci schémat. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Vrací [XmlSchema](../xmlschema/) spojený se zadaným URI jmenného prostoru. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Seřadí prvky sekvence ve vzestupném pořadí podle hodnot klíče vybraných keySelectorem. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Seřadí prvky sekvence v sestupném pořadí podle hodnot klíče vybraných keySelectorem. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projektuje každý prvek sekvence a kombinuje získané sekvence do jedné sekvence. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtruje sekvenci podle specifikované podmínky. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Sníží slabý čítač referencí. Nemělo by se volat příně; místo toho použijte chytré ukazatele nebo ThisProtector. |
| [XmlSchemaCollection](./xmlschemacollection/)() | Inicializuje novou instanci třídy [XmlSchemaCollection](./). |
| [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inicializuje novou instanci třídy [XmlSchemaCollection](./) s určeným [XmlNameTable](../../system.xml/xmlnametable/). [XmlNameTable](../../system.xml/xmlnametable/) se používá při načítání schémat. |
...
| Definice typu | Popis |
| --- | --- |
| [Ptr](./ptr/) | Zkratka pro sdílený ukazatel na instanci této třídy. |

## Poznámky

Zastaralé
:   Třída [XmlSchemaCollection](./) je zastaralá. Použijte [XmlSchemaSet](../xmlschemaset/) místo toho.

Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo porušením aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkci jako argument.
