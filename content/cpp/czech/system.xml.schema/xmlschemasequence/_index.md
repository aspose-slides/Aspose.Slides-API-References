...
description: Zastupuje prvek sequence (kompozitor) ze schématu XML podle specifikace World Wide Web Consortium (W3C). Prvek sequence vyžaduje, aby se prvky ve skupině objevily v určeném pořadí uvnitř nadřazeného prvku.
type: docs
weight: 768
url: /cs/system.xml.schema/xmlschemasequence/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Prvky obsažené v kompozitoru. Kolekce [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./) nebo [XmlSchemaAny](../xmlschemaany/). |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Nastaví maximální počet výskytů částice. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Nastaví číslo jako řetězcovou hodnotu. Maximální počet výskytů částice. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Nastaví minimální počet výskytů částice. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Nastaví číslo jako řetězcovou hodnotu. Minimální počet výskytů částice. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Nastaví rodiče tohoto [XmlSchemaObject](../xmlschemaobject/). |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Nastaví zdrojovou lokaci souboru, který načetl schéma. |
...
| [XmlSchemaSequence](./xmlschemasequence/)() | Inicializuje novou instanci třídy [XmlSchemaSequence](./). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel pro předání funkcím jako argument. 
