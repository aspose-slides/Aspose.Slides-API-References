...
description: Reprezentuje prvek minLength ze schématu XML, jak je specifikován Konsorciem World Wide Web (W3C). Tato třída může být použita k určení omezení minimální délky hodnoty dat prvku simpleType. Délka musí být větší než hodnota prvku minLength.
type: docs
weight: 638
url: /cs/system.xml.schema/xmlschemaminlengthfacet/
---
## XmlSchemaMinLengthFacet třída

Represents the **minLength** element from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). This třída can be used to specify a restriction on the minimum length of the data value of a **simpleType** element. The length must be greater than the value of the **minLength** element.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Vrací informaci, která naznačuje, že tento facet je pevně daný. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogie C# [Object.GetHashCode()](../../system/object/gethashcode/) method. Enables hashing of custom objects. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontroluje, zda objekt představuje instanci typu popsaného targetType. Analogie C# 'is' operator. |
| void [Lock](../../system/object/lock/)() | Implementuje C# lock() statement locking. Call directly or use [LockContext](../../system/lockcontext/) sentry object. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje copy constructing subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje copy constructing subclasses. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Nastavuje informaci, která naznačuje, že tento facet je pevně daný. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Nastavuje atribut **value** facetu. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje C# typeof([System.Object](../../system/object/)) construct. |
| void [Unlock](../../system/object/unlock/)() | Implementuje C# lock() statement unlocking. Call directly or use [LockContext](../../system/lockcontext/) sentry object. |
...
|  [XmlSchemaMinLengthFacet](./xmlschemaminlengthfacet/)() | Inicializuje novou instanci třídy [XmlSchemaMinLengthFacet](./). |
