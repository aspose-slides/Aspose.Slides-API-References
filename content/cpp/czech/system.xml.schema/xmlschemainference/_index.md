...
description: Odvozuje schéma XML Schema Definition Language (XSD) z XML dokumentu. Třída XmlSchemaInference nemůže být děděna.
type: docs
weight: 508
url: /cs/system.xml.schema/xmlschemainference/
---
## XmlSchemaInference třída


Odvozuje XML [Schema](../) Definition Language (XSD) schéma z XML dokumentu. Třída [XmlSchemaInference](./) nelze dědit.
...
| [XmlSchemaInference::InferenceOption](./inferenceoption/) [get_Occurrence](./get_occurrence/)() | Vrací hodnotu [XmlSchemaInference::InferenceOption](./inferenceoption/), která ovlivňuje deklarace výskytu schématu odvozené z XML dokumentu. |
| [XmlSchemaInference::InferenceOption](./inferenceoption/) [get_TypeInference](./get_typeinference/)() | Vrací hodnotu [XmlSchemaInference::InferenceOption](./inferenceoption/), která ovlivňuje typy odvozené z XML dokumentu. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\> [InferSchema](./inferschema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Odvozuje XML [Schema](../) Definition Language (XSD) schéma z XML dokumentu obsaženého ve specifikovaném objektu [XmlReader](../../system.xml/xmlreader/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\> [InferSchema](./inferschema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\>) | Odvozuje XML [Schema](../) Definition Language (XSD) schéma z XML dokumentu obsaženého ve specifikovaném objektu [XmlReader](../../system.xml/xmlreader/), a upřesňuje odvozené schéma pomocí existujícího schématu v objektu [XmlSchemaSet](../xmlschemaset/) se stejným cílovým jmenným prostorem. |
...
| void [set_Occurrence](./set_occurrence/)([XmlSchemaInference::InferenceOption](./inferenceoption/)) | Nastaví hodnotu [XmlSchemaInference::InferenceOption](./inferenceoption/), která ovlivňuje deklarace výskytu schématu odvozené z XML dokumentu. |
| void [set_TypeInference](./set_typeinference/)([XmlSchemaInference::InferenceOption](./inferenceoption/)) | Nastaví hodnotu [XmlSchemaInference::InferenceOption](./inferenceoption/), která ovlivňuje typy odvozené z XML dokumentu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení podle C# lock() výrazu. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaInference](./xmlschemainference/)() | Inicializuje novou instanci třídy [XmlSchemaInference](./). |
...
| Výčet | Popis |
| --- | --- |
| [InferenceOption](./inferenceoption/) | Ovlivňuje informace o výskytu a typech odvozených třídou [XmlSchemaInference](./) pro elementy a atributy v XML dokumentu. |
