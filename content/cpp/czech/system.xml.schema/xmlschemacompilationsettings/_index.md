...
second_title: Aspose.Slides pro C++ API příručka
description: Poskytuje možnosti kompilace schématu pro třídu XmlSchemaSet. Tato třída nemůže být děděna.
type: docs
weight: 248
url: /cs/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings třída

Poskytuje možnosti kompilace schématu pro třídu [XmlSchemaSet](../xmlschemaset/). Tato třída nemůže být děděna.
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Vrací hodnotu indikující, zda by [XmlSchemaSet](../xmlschemaset/) měl kontrolovat porušení Unique Particle Attribution (UPA). |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Nastaví hodnotu indikující, zda [XmlSchemaSet](../xmlschemaset/) má kontrolovat porušení Unique Particle Attribution (UPA). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvětší sdílený počítadlo referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Sníží a vrátí sdílený počítadlo referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvětší slabý počítadlo referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Sníží slabý počítadlo referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
|  [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | Inicializuje novou instanci třídy [XmlSchemaCompilationSettings](./). |
