...
description: Vrací podrobné informace související s ValidationEventHandler.
type: docs
weight: 53
url: /cs/system.xml.schema/validationeventargs/
---
## ValidationEventArgs třída

Vrací podrobné informace související s ValidationEventHandler.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, ačkoliv podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, ačkoliv podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
|  [EventArgs](../../system/eventargs/eventargs/)() | Konstruktor. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | Vrací XmlSchemaException spojenou s validační událostí. |
| [String](../../system/string/) [get_Message](./get_message/)() | Vrací textový popis odpovídající validační události. |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | Vrací závažnost validační události. |
...
| Pole | Popis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statický člen, který představuje „empty“ [EventArgs](../../system/eventargs/) sdílený ukazatel (null-pointer). |
