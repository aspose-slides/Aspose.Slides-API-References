...
description: Podporuje jednoduchou iteraci přes kolekci. Tato třída nemůže být děděna.
type: docs
weight: 235
url: /cs/system.xml.schema/xmlschemacollectionenumerator/
---
## XmlSchemaCollectionEnumerator třída

Supports a simple iteration over a collection. This třída cannot be inherited.
...
| Method | Description |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Připraví iterátor k použití třídou VirtualizedIterator třída. |
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../xmlschema/)\>\> * [CloneIterator](./cloneiterator/)() const override | Klonuje aktuální iterátor. |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\& [get_Current](./get_current/)() const override | Vrací aktuální [XmlSchema](../xmlschema/) v kolekci. |
...
| **bool** [MoveNext](./movenext/)() override | Posouvá enumerátor na další schéma v kolekci. |
...
Objects of this třídy should only be allocated using [System::MakeObject()](../../system/makeobject/) function. Never create instances of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this třída into [System::SmartPtr](../../system/smartptr/) pointer and use this pointer to pass it to functions as argument. 
