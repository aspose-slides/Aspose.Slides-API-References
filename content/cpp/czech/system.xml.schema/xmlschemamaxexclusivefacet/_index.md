...
description: Reprezentuje prvek maxExclusive ze schématu XML podle specifikace World Wide Web Consortium (W3C). Tato třída může být použita k určení omezení maximální hodnoty prvku simpleType. Hodnota prvku musí být menší než hodnota prvku maxExclusive.
type: docs
weight: 573
url: /cs/system.xml.schema/xmlschemamaxexclusivefacet/
---
## XmlSchemaMaxExclusiveFacet třída


Representuje prvek **maxExclusive** z XML [Schema](../) podle specifikace World Wide [Web](../../system.web/) Consortium (W3C). Tato třída může být použita k určení omezení maximální hodnoty prvku **simpleType**. Hodnota prvku musí být menší než hodnota prvku **maxExclusive**.
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Nastavuje informaci, která naznačuje, že tento facet je pevný. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock() výrazu. Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaMaxExclusiveFacet](./xmlschemamaxexclusivefacet/)() | Inicializuje novou instanci třídy [XmlSchemaMaxExclusiveFacet](./). |
