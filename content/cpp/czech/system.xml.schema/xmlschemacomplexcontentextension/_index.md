...
description: Reprezentuje element rozšíření ze schématu XML podle specifikace World Wide Web Consortium (W3C). Tato třída slouží pro komplexní typy s modelem komplexního obsahu odvozeným rozšířením. Rozšiřuje komplexní typ přidáním atributů nebo elementů.
type: docs
weight: 274
url: /cs/system.xml.schema/xmlschemacomplexcontentextension/
---
## XmlSchemaComplexContentExtension třída

Represents the **rozšíření** element from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). This class is for complex types with complex content model derived by extension. It extends the complex type by adding attributes or elements.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Vrací komponentu [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) modelu komplexního obsahu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Vrací kolekci atributů pro komplexní obsah. Obsahuje elementy [XmlSchemaAttribute](../xmlschemaattribute/) a [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Vrací název komplexního typu, ze kterého je tento typ odvozen rozšířením. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\> [get_Particle](./get_particle/)() | Vrací jednu ze tříd [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) nebo [XmlSchemaSequence](../xmlschemasequence/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Volá se přímo nebo se používá objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Nastavuje komponentu [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) modelu komplexního obsahu. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Nastavuje název komplexního typu, ze kterého je tento typ odvozen rozšířením. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\>\&) | Nastavuje jednu ze tříd [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) nebo [XmlSchemaSequence](../xmlschemasequence/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock(). Volá se přímo nebo se používá objekt strážce [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaComplexContentExtension](./xmlschemacomplexcontentextension/)() | Inicializuje novou instanci třídy [XmlSchemaComplexContentExtension](./). |
...
| Typedef | Popis |
| --- | --- |
| [Ptr](./ptr/) | Alias pro sdílený ukazatel na instance této třídy. |

## Poznámky

Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím. 
