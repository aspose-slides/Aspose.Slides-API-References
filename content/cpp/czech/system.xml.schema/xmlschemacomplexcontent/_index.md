...
description: Reprezentuje element complexContent ze schématu XML podle specifikace World Wide Web Consortium (W3C). Tato třída představuje model složitého obsahu pro složité typy. Obsahuje rozšíření nebo omezení složitého typu, který má buď pouze elementy, nebo smíšený obsah.
type: docs
weight: 261
url: /cs/system.xml.schema/xmlschemacomplexcontent/
---
## XmlSchemaComplexContent třída


Reprezentuje element **complexContent** z XML [Schema](../) podle specifikace konsorcia World Wide [Web](../../system.web/) (W3C). Tato třída představuje model složitého obsahu pro složité typy. Obsahuje rozšíření nebo omezení na složitý typ, který má buď jen elementy, nebo smíšený obsah.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Vrací obsah. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Vrací řetězcové id. |
| **bool** [get_IsMixed](./get_ismixed/)() | Vrací informaci, která určuje, zda typ má model smíšeného obsahu. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Vrací zdrojovou polohu souboru, který načetl schéma. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Nastavuje obsah. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Nastavuje řetězcové id. |
| void [set_IsMixed](./set_ismixed/)(**bool**) | Nastavuje informaci, která určuje, zda typ má model smíšeného obsahu. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Nastavuje nadřazený objekt tohoto [XmlSchemaObject](../xmlschemaobject/). |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Nastavuje zdrojovou polohu souboru, který načetl schéma. |
...
|  [XmlSchemaComplexContent](./xmlschemacomplexcontent/)() | Inicializuje novou instanci třídy [XmlSchemaComplexContent](./). |
