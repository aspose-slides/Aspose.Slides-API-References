...
description: Representuje prvek restriction pro jednoduché typy ze schématu XML, jak je specifikováno konsorciem World Wide Web Consortium (W3C). Tato třída může být použita k omezení prvku simpleType.
type: docs
weight: 872
url: /cs/system.xml.schema/xmlschemasimpletyperestriction/
---
## XmlSchemaSimpleTypeRestriction třída


Representuje element **restriction** pro jednoduché typy z XML [Schema](../) podle specifikace World Wide [Web](../../system.web/) Consortium (W3C). Tato třída může být použita k omezení elementu **simpleType**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Vrací informace o základním typu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Vrací název kvalifikovaného základního typu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Vrací [Xml](../../system.xml/)[Schema](../) fasetu. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Vrací nadřazený objekt tohoto [XmlSchemaObject](../xmlschemaobject/). |
...
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Nastaví informace o základním typu. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Nastaví název kvalifikovaného základního typu. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Nastaví řetězcové ID. |
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Nastaví číslo řádku v souboru, na který se odkazuje element **schema**. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Nastaví pozici řádku v souboru, na který se odkazuje element **schema**. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Nastaví XmlSerializerNamespaces, které se mají použít s tímto objektem schématu. |
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Nastaví nadřazený objekt tohoto [XmlSchemaObject](../xmlschemaobject/). |
...
|  [XmlSchemaSimpleTypeRestriction](./xmlschemasimpletyperestriction/)() | Inicializuje novou instanci třídy [XmlSchemaSimpleTypeRestriction](./). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asertů. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předávání jako argument funkcím. 
