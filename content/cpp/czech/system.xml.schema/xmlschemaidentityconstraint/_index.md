...
description: "Třída pro identitní omezení: key, keyref a unique elementy."
type: docs
weight: 469
url: /cs/system.xml.schema/xmlschemaidentityconstraint/
---
## XmlSchemaIdentityConstraint třída

Třída pro identitní omezení: **key**, **keyref** a **unique** elementy.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Vrací kolekci polí, která se aplikují jako potomci pro selektor výrazu jazyka XML Path Language ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Vrací název identitního omezení. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Vrací kvalifikovaný název identitního omezení, který obsahuje po-kompilaci interpretaci hodnoty **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Vrací element **selector** výrazu [XPath](../../system.xml.xpath/). |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Nastavuje název identitního omezení. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Nastavuje element **selector** výrazu [XPath](../../system.xml.xpath/). |
...
|  [XmlSchemaIdentityConstraint](./xmlschemaidentityconstraint/)() | Inicializuje novou instanci třídy [XmlSchemaIdentityConstraint](./). |
