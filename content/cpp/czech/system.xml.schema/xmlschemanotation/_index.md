...
description: Reprezentuje prvek notation ze schématu XML podle specifikace World Wide Web Consortium (W3C). Deklarace XML Schemanotation je rekonstrukcí deklarací XML 1.0 NOTATION. Účelem notací je popsat formát ne-XML dat v XML dokumentu.
type: docs
weight: 651
url: /cs/system.xml.schema/xmlschemanotation/
---
## XmlSchemaNotation třída
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Simuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, ačkoliv podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Simuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, ačkoliv podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Vrací název notace. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | Vrací **public** identifikátor. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Vrací umístění zdroje pro soubor, který načetl schéma. |
| [String](../../system/string/) [get_System](./get_system/)() | Vrací **system** identifikátor. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Nastavuje název notace. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | Nastavuje **public** identifikátor. |
...
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | Nastavuje **system** identifikátor. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony jako weak pointer (namísto shared). Umožní přepnutí ukazatelů v kontejnerech do weak režimu. |
...
|  [XmlSchemaNotation](./xmlschemanotation/)() | Inicializuje novou instanci třídy [XmlSchemaNotation](./). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel k předávání jako argument funkcí. 
