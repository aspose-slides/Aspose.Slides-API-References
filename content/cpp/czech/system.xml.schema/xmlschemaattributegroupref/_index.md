...
description: Reprezentuje element attributeGroup s atributem ref ze schématu XML podle . AttributesGroupRef je odkaz na attributeGroup, vlastnost name obsahuje referencovanou skupinu atributů.
type: docs
weight: 196
url: /cs/system.xml.schema/xmlschemaattributegroupref/
---
## XmlSchemaAttributeGroupRef třída

Reprezentuje element **attributeGroup** s atributem **ref** z XML [Schema](../) podle [World Wide Web Consortium (W3C)](https://go.microsoft.com/fwlink/?LinkId=49454). AttributesGroupRef je odkaz na attributeGroup, vlastnost name obsahuje referencovanou skupinu atributů.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Vrací název referencovaného elementu **attributeGroup**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokování příkazu C# lock(). Volá se přímo nebo pomocí objektu [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Nic nekopíruje, jen inicializuje nový objekt a umožňuje konstrukci kopií podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Nic nekopíruje, jen inicializuje nový objekt a umožňuje konstrukci kopií podtříd. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Nastavuje název referencovaného elementu **attributeGroup**. |
...
|  [XmlSchemaAttributeGroupRef](./xmlschemaattributegroupref/)() | Inicializuje novou instanci třídy [XmlSchemaAttributeGroupRef](./). |
