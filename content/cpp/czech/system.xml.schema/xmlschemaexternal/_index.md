...
description: Poskytuje informace o zahrnutém schématu.
type: docs
weight: 391
url: /cs/system.xml.schema/xmlschemaexternal/
---
## XmlSchemaExternal třída

Poskytuje informace o zahrnutém schématu.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](./get_schema/)() | Vrací [XmlSchema](../xmlschema/) pro odkazované schéma. |
| [String](../../system/string/) [get_SchemaLocation](./get_schemalocation/)() | Vrací umístění Uniform Resource Identifier (URI) pro schéma, které říká zpracovateli schématu, kde se schéma fyzicky nachází. |
...
| void [set_Schema](./set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Nastavuje [XmlSchema](../xmlschema/) pro odkazované schéma. |
| void [set_SchemaLocation](./set_schemalocation/)(const [String](../../system/string/)\&) | Nastavuje umístění Uniform Resource Identifier (URI) pro schéma, které říká zpracovateli schématu, kde se schéma fyzicky nachází. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonový argument na weak pointer (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do režimu weak. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje počet weak odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje počet weak odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
|  [XmlSchemaExternal](./xmlschemaexternal/)() | Inicializuje novou instanci třídy [XmlSchemaExternal](./). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy obalte tuto třídu ukazatelem [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím. 
