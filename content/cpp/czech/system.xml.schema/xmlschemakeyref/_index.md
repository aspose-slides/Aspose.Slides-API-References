...
description: Tato třída představuje prvek keyref ze XMLSchema podle specifikace World Wide Web Consortium (W3C).
type: docs
weight: 547
url: /cs/system.xml.schema/xmlschemakeyref/
---
## XmlSchemaKeyref třída


Tato třída představuje element **keyref** ze schématu XMLSchema, jak je specifikováno konsorciem World Wide [Web](../../system.web/) (W3C).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání čísel s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za stejné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání čísel s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za stejné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](../xmlschemaidentityconstraint/get_fields/)() | Vrací kolekci polí, která se používají jako potomci pro selektor výrazů XML Path Language ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](../xmlschemaidentityconstraint/get_name/)() | Vrací název omezení identity. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](../xmlschemaidentityconstraint/get_qualifiedname/)() | Vrací kvalifikovaný název omezení identity, který obsahuje post-kompilační interpretaci hodnoty **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_Refer](./get_refer/)() | Vrací název klíče, na který toto omezení odkazuje v jiném jednoduchém nebo složeném typu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](../xmlschemaidentityconstraint/get_selector/)() | Vrací element **selector** výrazu [XPath](../../system.xml.xpath/). |
...
| void [set_Name](../xmlschemaidentityconstraint/set_name/)(const [String](../../system/string/)\&) | Nastavuje název omezení identity. |
...
| void [set_Refer](./set_refer/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Nastavuje název klíče, na který toto omezení odkazuje v jiném jednoduchém nebo složeném typu. |
| void [set_Selector](../xmlschemaidentityconstraint/set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Nastavuje element **selector** výrazu [XPath](../../system.xml.xpath/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/xmlschemaidentityconstraint/)() | Inicializuje novou instanci třídy [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/). |
| [XmlSchemaKeyref](./xmlschemakeyref/)() | Inicializuje novou instanci třídy [XmlSchemaKeyref](./). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asertací. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předávání jako argument funkcím. 

## Viz také

* Třída [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/)
