...
description: Representuje element pattern ze schématu XML podle specifikace World Wide Web Consortium (W3C). Tuto třídu lze použít k určení omezení hodnoty zadané pro element simpleType.
type: docs
weight: 742
url: /cs/system.xml.schema/xmlschemapatternfacet/
---
## XmlSchemaPatternFacet třída


Representuje element **pattern** z XML [Schema](../) podle specifikace World Wide [Web](../../system.web/) Consortium (W3C). Tato třída může být použita k určení omezení hodnoty zadané pro element **simpleType**.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Vrací informaci, která indikuje, že tento facet je pevně daný. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Nastavuje informaci, která indikuje, že tento facet je pevně daný. |
...
|  [XmlSchemaPatternFacet](./xmlschemapatternfacet/)() | Inicializuje novou instanci třídy [XmlSchemaPatternFacet](./). |
