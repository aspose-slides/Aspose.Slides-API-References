...
description: Abstraktní třída pro obsah schématu.
type: docs
weight: 313
url: /cs/system.xml.schema/xmlschemacontent/
---
## XmlSchemaContent třída
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastavuje n-tý šablonový argument na weak pointer (namísto shared). Umožňuje přepínání ukazatelů v kontejnerech do weak režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
