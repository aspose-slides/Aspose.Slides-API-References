...
description: Vrací informace o chybách, které zaznamenala třída XmlSchemaInference při odvozování schématu z XML dokumentu.
type: docs
weight: 14
url: /cs/system.xml.schema/details_xmlschemainferenceexception/
---
## Details_XmlSchemaInferenceException třída


Vrací informace o chybách, které zaznamenala třída [XmlSchemaInference](../xmlschemainference/) při odvozování schématu z XML dokumentu.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání plovoucí čárky ve stylu C#, kde jsou dva NaN považovány za rovny, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání plovoucí čárky ve stylu C#, kde jsou dva NaN považovány za rovny, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| **int32_t** [get_LineNumber](../details_xmlschemaexception/get_linenumber/)() | Vrací číslo řádku, které udává, kde k chybě došlo. |
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | Vrací pozici v řádku, která udává, kde k chybě došlo. |
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | Vrací popis chybového stavu této výjimky. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | **[XmlSchemaObject](../xmlschemaobject/)**, která vytvořila XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | Vrací umístění Uniform Resource Identifier (URI) schématu, které způsobilo výjimku. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastavuje n-tý šablonový argument jako slabý ukazatel (na rozdíl od sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí příkazu C# lock(). Zavolejte přímo nebo použijte sentinel objekt [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje slabý čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodu [what()](../../system/details_exception/what/), která je volána třídou [ExceptionWrapper](../../system/exceptionwrapper/). Navzdory faktu, že tato třída nedědí od std::exception, odvozené třídy mohou použít chráněné/privátní členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../../system/exceptionwrapper/) může tuto logiku rozbít. |
...
* Třída [Details_XmlSchemaException](../details_xmlschemaexception/)
