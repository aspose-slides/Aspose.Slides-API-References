...
description: Reprezentuje fasetu totalDigits ze schématu XML podle specifikace World Wide Web Consortium (W3C). Tato třída může být použita k určení omezení počtu číslic, které mohou být zadány pro hodnotu elementu simpleType. Hodnota totalDigits musí být kladné celé číslo.
type: docs
weight: 898
url: /cs/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet třída


Reprezentuje fasetu **totalDigits** z XML [Schema](../) podle specifikace World Wide [Web](../../system.web/) Consortium (W3C). Tato třída může být použita k určení omezení počtu číslic, které mohou být zadány pro hodnotu elementu **simpleType**. Hodnota **totalDigits** musí být kladné celé číslo.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Vrací informaci, že tato faseta je pevně daná. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazem C# lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Nastavuje informaci, že tato faseta je pevně daná. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazem C# lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | Inicializuje novou instanci třídy [XmlSchemaTotalDigitsFacet](./). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo k selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel k předávání funkcím jako argument.
