...
description: Kolekce XmlSchemaObjects.
type: docs
weight: 690
url: /cs/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection třída
...
| Metoda | Popis |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Přidá [XmlSchemaObject](../xmlschemaobject/) do [XmlSchemaObjectCollection](./). |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Získá iterátor ukazující na první prvek (pokud existuje) const-qualified instance kolekce. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Získá iterátor ukazující na první const-qualified prvek (pokud existuje) kolekce. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Získá iterátor ukazující těsně za posledním const-qualified prvkem (pokud existuje) kolekce. |
| void [Clear](../../system.collections/collectionbase/clear/)() | Odstraní všechny objekty z instance kolekce. Tato metoda nemůže být přepsána. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Určuje, zda je specifikovaný [XmlSchemaObject](../xmlschemaobject/) v [XmlSchemaObjectCollection](./). |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Zkopíruje všechny XmlSchemaObjects z kolekce do zadaného pole, počínaje daným indexem. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) const-qualified instance kolekce. |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Vrací počet prvků, které může kolekce obsahovat. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Vrací počet prvků obsažených v instanci kolekce. Tato metoda nemůže být přepsána. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor pro iteraci přes XmlSchemaObjects obsažené v [XmlSchemaObjectCollection](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Vrací [XmlSchemaObject](../xmlschemaobject/) na zadaném indexu. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Nastavuje [XmlSchemaObject](../xmlschemaobject/) na zadaném indexu. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Vrací index kolekce odpovídající specifikovanému [XmlSchemaObject](../xmlschemaobject/). |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Vloží [XmlSchemaObject](../xmlschemaobject/) do [XmlSchemaObjectCollection](./). |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Odstraní [XmlSchemaObject](../xmlschemaobject/) z [XmlSchemaObjectCollection](./). |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Odstraní prvek na zadaném indexu instance kolekce. Tato metoda není přepsatelná. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Nastaví počet prvků, které může kolekce obsahovat. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý typový argument jako weak pointer (namísto shared). Umožňuje přepnutí ukazatelů v kontejnerech do režimu weak. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje weak čítač referencí. Nemělo by se volat přímo; místo toho použijte smart pointery nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje weak čítač referencí. Nemělo by se volat přímo; místo toho použijte smart pointery nebo ThisProtector. |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)() | Inicializuje novou instanci třídy [XmlSchemaObjectCollection](./). |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Inicializuje novou instanci třídy [XmlSchemaObjectCollection](./), která přijímá [XmlSchemaObject](../xmlschemaobject/). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel k předávání funkcím jako argument. 

## Viz také

* Třída [CollectionBase](../../system.collections/collectionbase/)
