...
description: Reprezentuje prvek maxInclusive ze schématu XML podle specifikace World Wide Web Consortium (W3C). Třída může být použita k určení omezení maximální hodnoty prvku simpleType. Hodnota prvku musí být menší nebo rovna hodnotě prvku maxInclusive.
type: docs
weight: 586
url: /cs/system.xml.schema/xmlschemamaxinclusivefacet/
---
## XmlSchemaMaxInclusiveFacet třída
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Porovnává objekty typových hodnot ve stylu C#. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() příkazu. Volá se přímo nebo se použije objekt hlídky [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock() příkazu. Volá se přímo nebo se použije objekt hlídky [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaMaxInclusiveFacet](./xmlschemamaxinclusivefacet/)() | Inicializuje novou instanci třídy [XmlSchemaMaxInclusiveFacet](./). |
