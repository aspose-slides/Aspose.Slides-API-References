...
description: Určuje pořadí a strukturu podřízených prvků typu.
type: docs
weight: 326
url: /cs/system.xml.schema/xmlschemacontentmodel/
---
## XmlSchemaContentModel třída
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() | Vrací obsah typu. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Přiřazovací operátor. Ve skutečnosti nic nekopíruje, jen inicializuje nový objekt a umožňuje kopírování konstruktorů podtříd. |
...
| virtual void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) | Nastavuje obsah typu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
