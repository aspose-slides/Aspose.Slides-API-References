...
description: Reprezentuje element attributeGroup ze schématu XML podle specifikace World Wide Web Consortium (W3C). AttributesGroups poskytuje mechanismus pro seskupení sady deklarací atributů, aby mohly být začleněny jako skupina do definic komplexních typů.
type: docs
weight: 183
url: /cs/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup třída


Representuje element **attributeGroup** z XML [Schema](../) podle specifikace World Wide [Web](../../system.web/) Consortium (W3C). AttributesGroups poskytuje mechanismus pro seskupení sady deklarací atributů, aby mohly být začleněny jako skupina do definic komplexních typů.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Vrací komponentu [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) skupiny atributů. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Vrací kolekci atributů pro skupinu atributů. Obsahuje elementy [XmlSchemaAttribute](../xmlschemaattribute/) a [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Vrací název skupiny atributů. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Vrací kvalifikovaný název skupiny atributů. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | Vrací redefinovanou vlastnost skupiny atributů z XML [Schema](../). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analóg metoda C# [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() statement. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analóg metoda C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umožňuje klonování vlastních typů. |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Nastavuje komponentu [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) skupiny atributů. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Nastavuje název skupiny atributů. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analóg metoda C# [Object.ToString()](../../system/object/tostring/). Umožňuje převod vlastních objektů na řetězec. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukci C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() statement. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje slabý čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
|  [XmlSchemaAttributeGroup](./xmlschemaattributegroup/)() | Inicializuje novou instanci třídy [XmlSchemaAttributeGroup](./). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asertací. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím. 
