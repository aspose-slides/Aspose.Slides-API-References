...
description: Vrací podrobné informace o výjimce schématu.
type: docs
weight: 1
url: /cs/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException třída

Vrací podrobné informace o výjimce schématu.
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Vrací číslo řádku, které udává, kde k chybě došlo. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Vrací pozici řádku, která udává, kde k chybě došlo. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Vrací popis chybového stavu této výjimky. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | **[XmlSchemaObject](../xmlschemaobject/)**, která vytvořila XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Vrací umístění Uniform Resource Identifier (URI) schématu, které způsobilo výjimku. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastavuje n-tý šablonový argument na slabý ukazatel (namísto sdíleného). Umožňuje přepnout ukazatele v kontejnerech do slabého režimu. |
