...
description: Reprezentuje prvek simpleContent ze schématu XML podle specifikace World Wide Web Consortium (W3C). Tato třída slouží pro jednoduché i složené typy s modelem jednoduchého obsahu.
type: docs
weight: 794
url: /cs/system.xml.schema/xmlschemasimplecontent/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Vrací jeden z [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) nebo [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nepřekopíruje, jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nepřekopíruje, jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Vrací jeden z [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) nebo [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
