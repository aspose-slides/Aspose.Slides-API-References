...
description: Základní třída pro všechny fasety, které jsou používány, když jsou jednoduché typy odvozeny omezením.
type: docs
weight: 404
url: /cs/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet třída


Základní třída pro všechny fasety, které se používají, když jsou jednoduché typy odvozeny omezením.
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s dvojitou plovoucí čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | Vrací informaci, která označuje, že tento facet je pevný. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | Vrací atribut **value** fasety. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | Nastavuje informaci, která označuje, že tento facet je pevný. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Nastavuje atribut **value** fasety. |
...
|  [XmlSchemaFacet](./xmlschemafacet/)() | Inicializuje novou instanci třídy [XmlSchemaFacet](./). |
