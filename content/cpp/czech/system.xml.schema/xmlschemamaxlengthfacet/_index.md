...
description: Reprezentuje element maxLength ze schématu XML podle specifikace World Wide Web Consortium (W3C). Tuto třídu lze použít k určení omezení maximální délky datové hodnoty elementu simpleType. Délka musí být menší než hodnota elementu maxLength.
type: docs
weight: 599
url: /cs/system.xml.schema/xmlschemamaxlengthfacet/
---
## XmlSchemaMaxLengthFacet třída
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Vrací informaci, že tato faceta je pevná. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Vrací atribut **value** facety. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Nastavuje informaci, že tato faceta je pevná. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Nastavuje atribut **value** facety. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastavuje n-tý šablonový argument jako slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech na slabý režim. |
...
|  [XmlSchemaMaxLengthFacet](./xmlschemamaxlengthfacet/)() | Inicializuje novou instanci třídy [XmlSchemaMaxLengthFacet](./). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkcím jako argument.
