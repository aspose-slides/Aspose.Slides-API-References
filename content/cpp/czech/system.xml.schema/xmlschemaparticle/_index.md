...
description: Základní třída, která je zároveň základní třídou pro všechny typy částic (např. XmlSchemaAny).
type: docs
weight: 729
url: /cs/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle třída
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Vrací maximální počet výskytů částice. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Vrací číslo jako řetězcovou hodnotu. Maximální počet výskytů částice. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Vrací minimální počet výskytů částice. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Vrací číslo jako řetězcovou hodnotu. Minimální počet výskytů částice. |
...
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Nastavuje maximální počet výskytů částice. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Nastavuje číslo jako řetězcovou hodnotu. Maximální počet výskytů částice. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Nastavuje minimální počet výskytů částice. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Nastavuje číslo jako řetězcovou hodnotu. Minimální počet výskytů částice. |
...
|  [XmlSchemaParticle](./xmlschemaparticle/)() | Inicializuje novou instanci třídy [XmlSchemaParticle](./). |
