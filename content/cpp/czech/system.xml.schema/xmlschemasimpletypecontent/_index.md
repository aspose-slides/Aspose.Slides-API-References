...
description: Základní třída pro třídy obsahu jednoduchých typů.
type: docs
weight: 846
url: /cs/system.xml.schema/xmlschemasimpletypecontent/
---
## XmlSchemaSimpleTypeContent třída

Základní třída pro třídy obsahu jednoduchých typů.
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo závadám asertací. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel při předávání jako argument funkcím. 
