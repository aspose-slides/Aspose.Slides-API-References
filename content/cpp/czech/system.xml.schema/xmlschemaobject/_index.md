...
description: Reprezentuje kořenovou třídu hierarchie modelu objektů schématu Xml a slouží jako základní třída pro třídy, jako je třída XmlSchema.
type: docs
weight: 677
url: /cs/system.xml.schema/xmlschemaobject/
---
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Vrací číslo řádku v souboru, na který odkazuje prvek **schema**. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Vrací pozici řádku v souboru, na který odkazuje prvek **schema**. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](./get_namespaces/)() | Vrací XmlSerializerNamespaces, které mají být použity s tímto objektem schématu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\> [get_Parent](./get_parent/)() | Vrací nadřazený prvek tohoto [XmlSchemaObject](./). |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Vrací umístění zdroje souboru, který načetl schéma. |
...
| void [set_LineNumber](./set_linenumber/)(**int32_t**) | Nastavuje číslo řádku v souboru, na který odkazuje prvek **schema**. |
| void [set_LinePosition](./set_lineposition/)(**int32_t**) | Nastavuje pozici řádku v souboru, na který odkazuje prvek **schema**. |
| void [set_Namespaces](./set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Nastavuje XmlSerializerNamespaces, které mají být použity s tímto objektem schématu. |
| void [set_Parent](./set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\>\&) | Nastavuje nadřazený prvek tohoto [XmlSchemaObject](./). |
| void [set_SourceUri](./set_sourceuri/)(const [String](../../system/string/)\&) | Nastavuje umístění zdroje souboru, který načetl schéma. |
...
|  [XmlSchemaObject](./xmlschemaobject/)() | Inicializuje novou instanci třídy [XmlSchemaObject](./). |
