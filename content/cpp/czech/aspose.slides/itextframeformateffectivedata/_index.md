...
---
## ITextFrameFormatEffectiveData třída
...
| virtual [TextAnchorType](../textanchortype/) [get_AnchoringType](./get_anchoringtype/)() | Vrací vertikální kotvící text v [TextFrame](../textframe/). Pouze pro čtení [TextAnchorType](../textanchortype/). |
| virtual [TextAutofitType](../textautofittype/) [get_AutofitType](./get_autofittype/)() | Vrací režim automatického přizpůsobení textu. Pouze pro čtení [TextAutofitType](../textautofittype/). |
| virtual **bool** [get_CenterText](./get_centertext/)() | Vrací, zda by měl být text vodorovně vycentrován v rámečku. Pouze pro čtení **bool**. |
| virtual **int32_t** [get_ColumnCount](./get_columncount/)() | Určuje počet sloupců textu v ohraničujícím obdélníku. Pouze pro čtení **int32_t**. |
| virtual **float** [get_ColumnSpacing](./get_columnspacing/)() | Určuje mezery mezi sloupci textu v textové oblasti (v bodech). Pouze pro čtení **float**. |
| virtual **double** [get_MarginBottom](./get_marginbottom/)() | Vrací spodní okraj (v bodech) v [TextFrame](../textframe/). Pouze pro čtení **double**. |
| virtual **double** [get_MarginLeft](./get_marginleft/)() | Vrací levý okraj (v bodech) v [TextFrame](../textframe/). Pouze pro čtení **double**. |
| virtual **double** [get_MarginRight](./get_marginright/)() | Vrací pravý okraj (v bodech) v [TextFrame](../textframe/). Pouze pro čtení **double**. |
| virtual **double** [get_MarginTop](./get_margintop/)() | Vrací horní okraj (v bodech) v [TextFrame](../textframe/). Pouze pro čtení **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextStyleEffectiveData](../itextstyleeffectivedata/)\> [get_TextStyle](./get_textstyle/)() | Vrací styl efektivního textu. Pouze pro čtení [ITextStyleEffectiveData](../itextstyleeffectivedata/). |
| virtual [Aspose::Slides::TextVerticalType](../textverticaltype/) [get_TextVerticalType](./get_textverticaltype/)() | Vrací orientaci textu. Pouze pro čtení [Slides::TextVerticalType](../textverticaltype/). |
| virtual **bool** [get_WrapText](./get_wraptext/)() | Vrací, zda je text zalamován na okrajích [TextFrame](../textframe/). Pouze pro čtení **bool**. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Získává aktuální hodnotu čítače sdílených referencí. |
...
Toto rozhraní se používá spolu s rozhraním [ITextFrameFormat](../itextframeformat/) k vracení efektivních hodnot formátování s aplikovaným děděním.
