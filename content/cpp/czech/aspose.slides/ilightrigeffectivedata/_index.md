...
description: Neměnný objekt, který obsahuje efektivní vlastnosti světelného nastavení.
type: docs
weight: 2718
url: /cs/aspose.slides/ilightrigeffectivedata/
---
## ILightRigEffectiveData třída


Neměnný objekt, který obsahuje efektivní vlastnosti světelného nastavení.
...
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | Směr světla. Pouze pro čtení [LightingDirection](../lightingdirection/). |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | Zastupuje přednastavené světlo, které může být použito na tvar. Světelný rig představuje skupinu světel orientovaných určitým způsobem vzhledem k 3D scéně. Pouze pro čtení [LightRigPresetType](../lightrigpresettype/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Rotace je definována pomocí souřadnice šířky, souřadnice délky a otáčení kolem osy jako souřadnice šířky a délky. První prvek vráceného pole – šířka, druhý – délka, třetí – otáčení. |
