...
description: Reprezentuje správce, který uchovává chování všech zástupců zápatí, data-času a číslování stránek prezentace.
type: docs
weight: 3407
url: /cs/aspose.slides/ipresentationheaderfootermanager/
---
## IPresentationHeaderFooterManager třída

Reprezentuje správce, který obsahuje chování všech zástupců zápatí, data-času a číslování stránek prezentace.
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamykání pomocí C# lock() příkazu. Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| virtual void [SetAllDateTimesText](./setalldatetimestext/)([System::String](../../system/string/)) | Nastaví text do všech zástupců data-času, včetně hlavních snímků, rozložení snímků a snímků. |
| virtual void [SetAllDateTimesVisibility](./setalldatetimesvisibility/)(**bool**) | Mění viditelnost všech zástupců data-času, včetně hlavních snímků, rozložení snímků a snímků. |
| virtual void [SetAllFootersText](./setallfooterstext/)([System::String](../../system/string/)) | Nastaví text do všech zástupců zápatí, včetně hlavních snímků, rozložení snímků a snímků. |
| virtual void [SetAllFootersVisibility](./setallfootersvisibility/)(**bool**) | Mění viditelnost všech zástupců zápatí, včetně hlavních snímků, rozložení snímků a snímků. |
| virtual void [SetAllHeadersText](./setallheaderstext/)([System::String](../../system/string/)) | Nastaví text do všech zástupců záhlaví, včetně hlavního poznámky, snímků s poznámkami a hlavního výtisku. |
| virtual void [SetAllHeadersVisibility](./setallheadersvisibility/)(**bool**) | Mění viditelnost všech zástupců záhlaví, včetně hlavního poznámky, snímků s poznámkami a hlavního výtisku. |
| virtual void [SetAllSlideNumbersVisibility](./setallslidenumbersvisibility/)(**bool**) | Mění viditelnost všech zástupců číslování stránek, včetně hlavních snímků, rozložení snímků a snímků. |
...
| virtual void [SetVisibilityOnAllTitleSlides](./setvisibilityonalltitleslides/)(**bool**) | Mění viditelnost zástupců zápatí, data-času a číslování stránek pro všechny titulní snímky a první snímek rozložení. Title slides \\u2013 slides based on first layout slide (regardless of type of this first layout). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() příkazu. Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
* třída [IBaseHeaderFooterManager](../ibaseheaderfootermanager/)
