...
description: Představuje kolekci všech snímků rozvržení v prezentaci. Rozšiřuje třídu LayoutSlideCollection metodami pro přidávání/klonování snímků rozvržení v kontextu sjednocování jednotlivých kolekcí hlavních snímků rozvržení.
type: docs
weight: 1093
...
Represents a collection of all layout slides in presentation. Extends [LayoutSlideCollection](../layoutslidecollection/) třída with methods for adding/cloning layout slides in context of uniting of the individual collections of master's layout slides.
...
| Metoda | Popis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | Přidá nový snímek rozvržení do prezentace. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Přidá kopii určeného snímku rozvržení do prezentace. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Přidá kopii určeného snímku rozvržení do prezentace. |
| [iterator](../layoutslidecollection/iterator/) [begin](../layoutslidecollection/begin/)() | Získá iterátor ukazující na první prvek (pokud existuje) kolekce. |
| [const_iterator](../layoutslidecollection/const_iterator/) [begin](../layoutslidecollection/begin/)() const | Získá iterátor ukazující na první prvek (pokud existuje) konstantně kvalifikované instance kolekce. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cbegin](../layoutslidecollection/cbegin/)() const | Získá iterátor ukazující na první konstantně kvalifikovaný prvek (pokud existuje) kolekce. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cend](../layoutslidecollection/cend/)() const | Získá iterátor ukazující hned za posledním konstantně kvalifikovaným prvkem (pokud existuje) kolekce. |
| void [CopyTo](../layoutslidecollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>, **int32_t**) override | Zkopíruje všechny prvky z kolekce do zadaného pole. |
...
| [iterator](../layoutslidecollection/iterator/) [end](../layoutslidecollection/end/)() | Získá iterátor ukazující hned za posledním prvkem (pokud existuje) kolekce. |
| [const_iterator](../layoutslidecollection/const_iterator/) [end](../layoutslidecollection/end/)() const | Získá iterátor ukazující hned za posledním prvkem (pokud existuje) konstantně kvalifikované instance kolekce. |
...
| **int32_t** [get_Count](../layoutslidecollection/get_count/)() override | Vrací počet snímků rozvržení v kolekci. Pouze pro čtení **int32_t**. |
| **bool** [get_IsSynchronized](../layoutslidecollection/get_issynchronized/)() override | Vrací hodnotu indikující, zda je přístup ke kolekci synchronizován (vláknově bezpečný). Pouze pro čtení **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../layoutslidecollection/get_syncroot/)() override | Vrací synchronizační kořen. Pouze pro čtení [System::Object](../../system/object/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../layoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) override | Vrací první snímek rozvržení zadaného typu. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../layoutslidecollection/idx_get/)(**int32_t**) override | Vrací snímek rozvržení podle indexu. Pouze pro čtení [LayoutSlide](../layoutslide/). |
...
| void [Remove](../layoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Odstraňuje rozvržení z kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený počítadlo odkazů o zadanou hodnotu. |
| void [RemoveUnused](../layoutslidecollection/removeunused/)() override | Odstraňuje nepoužívané snímky rozvržení (snímek rozvržení, jehož HasDependingSlides je false). |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Snižuje a vrací sdílený počítadlo odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginConstIterator](../layoutslidecollection/virtualizebeginconstiterator/)() const override | Získá iterátor ukazující na první prvek (pokud existuje) konstantně kvalifikované instance kolekce. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginIterator](../layoutslidecollection/virtualizebeginiterator/)() override | Získá iterátor ukazující na první prvek (pokud existuje) kolekce. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndConstIterator](../layoutslidecollection/virtualizeendconstiterator/)() const override | Získá iterátor ukazující hned za posledním prvkem (pokud existuje) konstantně kvalifikované instance kolekce. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndIterator](../layoutslidecollection/virtualizeenditerator/)() override | Získá iterátor ukazující hned za posledním prvkem (pokud existuje) kolekce. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý počítadlo odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje slabý počítadlo odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| virtual  [~Object](../../system/object/~object/)() | Zničí objekt. Uvolní všechny vnitřní datové struktury. |

## Viz také

* Třída [LayoutSlideCollection](../layoutslidecollection/)
* Třída [IGlobalLayoutSlideCollection](../igloballayoutslidecollection/)
