...
description: Zastupuje komponentu snímku.
type: docs
weight: 3784
url: /cs/aspose.slides/islidecomponent/
---
## ISlideComponent třída

Zastupuje komponentu snímku.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](./get_slide/)() | Vrací základní snímek. Pouze pro čtení [IBaseSlide](../ibaseslide/). |
