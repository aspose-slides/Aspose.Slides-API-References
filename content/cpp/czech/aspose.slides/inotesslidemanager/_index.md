...
| Metoda | Popis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() | Vrací poznámkový snímek pro aktuální snímek, vytvoří jej, pokud neexistuje. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() | Vrací poznámkový snímek pro aktuální snímek. Vrátí null, pokud snímek nemá poznámkový snímek. Pouze ke čtení [INotesSlide](../inotesslide/). |
...
| virtual void [RemoveNotesSlide](./removenotesslide/)() | Odstraní poznámkový snímek aktuálního snímku. |
