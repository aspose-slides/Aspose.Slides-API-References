...
description: Neměnný objekt, který obsahuje efektivní vlastnosti reliéfu povrchu tvaru.
type: docs
weight: 3667
url: /cs/aspose.slides/ishapebeveleffectivedata/
---
## IShapeBevelEffectiveData třída
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Typ zkosení. Pouze pro čtení [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Výška zkosení. Pouze pro čtení **double**. |
| virtual **double** [get_Width](./get_width/)() | Šířka zkosení. Pouze pro čtení **double**. |
