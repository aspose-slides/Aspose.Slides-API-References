...
Určuje, které operace jsou na nadřazeném [GraphicalObject](../graphicalobject/) zakázány.
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | Určuje, zda má tvar při změně velikosti zachovat poměr stran. Čte **bool**. |
| **bool** [get_DrilldownLocked](./get_drilldownlocked/)() override | Určuje, zda je výběr podtvarů tohoto objektu zakázán. Čte **bool**. |
| **bool** [get_GroupingLocked](./get_groupinglocked/)() override | Určuje, zda je přidání tohoto tvaru do skupiny zakázáno. Čte **bool**. |
| **bool** [get_NoLocks](../baseshapelock/get_nolocks/)() override | Vrátí true, pokud jsou všechny zamykací příznaky zakázány. Pouze-ke-čtení **bool**. |
| **bool** [get_PositionLocked](./get_positionlocked/)() override | Určuje, zda je přesun tohoto tvaru zakázán. Čte **bool**. |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | Určuje, zda má tvar při změně velikosti zachovat poměr stran. Zapíše **bool**. |
| void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) override | Určuje, zda je výběr podtvarů tohoto objektu zakázán. Zapíše **bool**. |
...
| void [set_PositionLocked](./set_positionlocked/)(**bool**) override | Určuje, zda je přesun tohoto tvaru zakázán. Zapíše **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony jako slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do režimu slabých. |
...
* Třída [IGraphicalObjectLock](../igraphicalobjectlock/)
