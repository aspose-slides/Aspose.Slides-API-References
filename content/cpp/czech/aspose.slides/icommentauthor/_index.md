...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | Vrací komentář vytvořený tímto autorem na zadaném indexu. Jen pro čtení [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | Vrací kolekci komentářů vytvořených tímto autorem. Jen pro čtení [ICommentCollection](../icommentcollection/). |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | Vrací iniciály autora. Read [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Vrací jméno autora. Read [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Odstraní autora z nadřazené kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | Nastaví iniciály autora. Write [System::String](../../system/string/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Nastaví jméno autora. Write [System::String](../../system/string/). |
