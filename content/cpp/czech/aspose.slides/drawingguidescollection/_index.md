...
| Metoda | Popis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) override | Přidá kreslicí vodítko na konec kolekce. |
| [iterator](./iterator/) [begin](./begin/)() | Získá iterátor ukazující na první prvek (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Získá iterátor ukazující na první prvek (pokud existuje) instance kolekce, která je označena jako const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Získá iterátor ukazující na první prvek kolekce, který je označen jako const (pokud existuje). |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Získá iterátor ukazující těsně za posledním const-prvkem (pokud existuje) kolekce. |
| void [Clear](./clear/)() override | Odstraní všechny prvky z kolekce. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\>\>, **int32_t**) | Zkopíruje všechny prvky z kolekce do zadaného pole. |
| [iterator](./iterator/) [end](./end/)() | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) const-instance kolekce. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který prochází kolekcí. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) override | Vrací kreslicí vodítko podle indexu. Pouze pro čtení [IDrawingGuide](../idrawingguide/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Určuje, zda existuje jakýkoli prvek sekvence, který splňuje podmínku. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Přeskočí zadaný počet po sobě jdoucích prvků od začátku sekvence a vrací zbytek. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Odstraní kreslicí vodítko na zadaném indexu. |
