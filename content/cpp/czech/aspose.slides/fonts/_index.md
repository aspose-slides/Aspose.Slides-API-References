...
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() override | Vrací písmo pro komplexní skript. Přečtěte si [IFontData](../ifontdata/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() override | Vrací písmo východoasijské. Přečtěte si [IFontData](../ifontdata/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() override | Vrací latinské písmo. Přečtěte si [IFontData](../ifontdata/). |
...
| [System::String](../../system/string/) [GetScriptFont](./getscriptfont/)([System::String](../../system/string/)) override | Získá název písma spojený se specifickým skriptovým tagem ze šablony prezentace. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\> [GetScriptFontMap](./getscriptfontmap/)() override | Vrací slovník všech definic písma skriptů v prezentaci. |
...
| void [RemoveScriptFont](./removescriptfont/)([System::String](../../system/string/)) override | Odstraňuje nastavení písma spojené s konkrétním skriptovým tagem ze sbírky písem motivu. |
| void [set_ComplexScriptFont](./set_complexscriptfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Nastavuje písmo pro komplexní skript. Zapište [IFontData](../ifontdata/). |
| void [set_EastAsianFont](./set_eastasianfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Nastavuje východoasijské písmo. Zapište [IFontData](../ifontdata/). |
| void [set_LatinFont](./set_latinfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Nastavuje latinské písmo. Zapište [IFontData](../ifontdata/). |
| void [SetScriptFont](./setscriptfont/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Přiřadí název písma ke konkrétnímu skriptovému tagu, což určuje, jak bude text tohoto skriptu v prezentaci vykreslen. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n'tý šablonový argument na slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do režimu slabých ukazatelů. |
