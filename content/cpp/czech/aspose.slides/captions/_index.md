...
description: Zastupuje uzavřené titulky WebVTT.
type: docs
weight: 274
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Vrací binární data uzavřených titulků. Pouze pro čtení **uint8_t**[]. |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | Vrací globálně jedinečný identifikátor (GUID) uzavřených titulků. Pouze pro čtení [System::Guid](../../system/guid/). |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | Vrací data uzavřených titulků jako řetězec kódovaný UTF-8. Pouze pro čtení [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | Vrací štítek uzavřených titulků. Číst [System::String](../../system/string/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontroluje, zda objekt představuje instanci typu popsaného pomocí targetType. Analogie operátoru C# 'is'. |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | Nastavuje štítek uzavřených titulků. Zápis [System::String](../../system/string/). |
