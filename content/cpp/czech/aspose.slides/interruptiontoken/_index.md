...
description: Tato třída představuje token, který se používá k signalizaci dlouhotrvajících úkolů, zda bylo požádáno o přerušení.
type: docs
weight: 3056
...
Tato třída představuje token, který se používá k signalizaci dlouhodobých úkolů, zda bylo požádáno o přerušení.
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Vrací **bool**.true, pokud bylo požádáno o přerušení. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | Reprezentuje prázdný token přerušení. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nepřekopíruje, pouze inicializuje nový objekt a umožňuje konstrukci kopií v podtřídách. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nepřekopíruje, pouze inicializuje nový objekt a umožňuje konstrukci kopií v podtřídách. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | Vyhodí výjimku, pokud bylo požádáno o přerušení. |
