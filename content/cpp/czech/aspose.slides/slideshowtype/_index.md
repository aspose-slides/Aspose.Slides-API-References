...
description: "Základní nastavení prezentace. Předci představují typy prezentace: PresentedBySpeaker Prezentováno mluvčím (celá obrazovka) BrowsedByIndividual Prohlíženo jednotlivcem (okno) BrowsedAtKiosk Prohlíženo v kiosku (celá obrazovka)"
type: docs
weight: 5227
...
Základní nastavení prezentace. Předci představují typy prezentace: [PresentedBySpeaker](../presentedbyspeaker/) Prezentováno mluvčím (celá obrazovka) [BrowsedByIndividual](../browsedbyindividual/) Prohlíženo jednotlivcem (okno) [BrowsedAtKiosk](../browsedatkiosk/) Prohlíženo v kiosku (celá obrazovka)

```cpp
class SlideShowType : public System::Object
```
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() příkazu. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentry objekt. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n'th template argument a weak pointer (rather than shared). Allows switching pointers in containers to weak mode. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock() příkazu. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentry objekt. |
