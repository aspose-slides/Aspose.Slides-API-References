...
description: Reprezentuje neměnný objekt, který obsahuje efektivní data.
type: docs
weight: 2055
url: /cs/aspose.slides/ieffectivedata/
---
## IEffectiveData třída

Reprezentuje neměnný objekt, který obsahuje efektivní data.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic neskopíruje, pouze inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic neskopíruje, pouze inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý počet odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
