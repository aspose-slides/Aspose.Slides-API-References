...
description: Představuje manažera, který drží chování zápatí snímku, zástupných prvků data-času a čísla stránky.
type: docs
weight: 5201
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Získá hodnotu indikující, že je přítomný zástupný prvek data-času. Čte**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Získá hodnotu indikující, že je přítomný zástupný prvek zápatí. Čte **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Získá hodnotu indikující, že je přítomný zástupný prvek čísla stránky. Čte**bool**. |
...
* Třída [ISlideHeaderFooterManager](../islideheaderfootermanager/)
