...
description: Představuje hodnotu úpravy geometrického tvaru. Tyto hodnoty ovlivňují podobu tvaru.
type: docs
weight: 1
...
| **float** [get_AngleValue](./get_anglevalue/)() override | Vrací hodnotu, interpretovanou jako úhel ve stupních. Čte **float**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Vrací název této hodnoty úpravy. Pouze pro čtení [System::String](../../system/string/). |
| **int64_t** [get_RawValue](./get_rawvalue/)() override | Vrací hodnotu úpravy „tak, jak je“. Čte **int64_t**. |
| [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() override | Vrací typ úpravy tvaru. Pouze pro čtení [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| void [set_AngleValue](./set_anglevalue/)(**float**) override | Nastavuje hodnotu, interpretovanou jako úhel ve stupních. Zápis **float**. |
| void [set_RawValue](./set_rawvalue/)(**int64_t**) override | Nastavuje hodnotu úpravy „tak, jak je“. Zápis **int64_t**. |
...
* Třída [IAdjustValue](../iadjustvalue/)
