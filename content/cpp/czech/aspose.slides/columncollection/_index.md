...
| Metoda | Popis |
| --- | --- |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>, **bool**) override | Vytvoří kopii zadaného šablonového řádku a vloží ji na konec tabulky. |
| [iterator](./iterator/) [begin](./begin/)() | Získá iterátor ukazující na první prvek (je-li přítomen) kolekce. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Získá iterátor ukazující na první prvek (je-li přítomen) konstantně kvalifikované instance kolekce. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Získá iterátor ukazující na první konstantně kvalifikovaný prvek (je-li přítomen) kolekce. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Získá iterátor ukazující těsně za posledním konstantně kvalifikovaným prvkem (je-li přítomen) kolekce. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\>, **int32_t**) override | Zkopíruje všechny prvky z kolekce do zadaného pole. |
...
| [iterator](./iterator/) [end](./end/)() | Získá iterátor ukazující těsně za posledním prvkem (je-li přítomen) kolekce. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Získá iterátor ukazující těsně za posledním prvkem (je-li přítomen) konstantně kvalifikované instance kolekce. |
...
| **int32_t** [get_Count](./get_count/)() override | Vrací počet sloupců v kolekci. Pouze ke čtení **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Vrací hodnotu indikující, zda je přístup ke kolekci synchronizován (vláknově bezpečný). Pouze ke čtení **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Vrací kořen synchronizace. Pouze ke čtení [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu čítače referencí spojenou s objektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který iteruje přes kolekci. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\> [idx_get](./idx_get/)(**int32_t**) override | Vrací sloupec na zadaném indexu. Pouze ke čtení [Column](../column/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>, **bool**) override | Vytvoří kopii zadaného šablonového sloupce a vloží ji na zadanou pozici v tabulce. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Určuje, zda existuje jakýkoli prvek v sekvenci nebo splňuje podmínku. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Seřadí prvky sekvence vzestupně podle hodnot klíčů vybraných keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Seřadí prvky sekvence sestupně podle hodnot klíčů vybraných keySelector. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformuje každý prvek sekvence do nové podoby za započítání indexu prvku. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projektuje každý prvek sekvence a sloučí výsledné sekvence do jedné sekvence. |
...
| void [RemoveAt](./removeat/)(**int32_t**, **bool**) override | Odstraní sloupec na zadané pozici z tabulky. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý šablonový argument na slabý ukazatel (namísto sdíleného). Umožňuje přepnout ukazatele v kontejnerech do slabého režimu. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Získá iterátor ukazující na první prvek (je-li přítomen) konstantně kvalifikované instance kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Získá iterátor ukazující na první prvek (je-li přítomen) kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Získá iterátor ukazující těsně za posledním prvkem (je-li přítomen) konstantně kvalifikované instance kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Získá iterátor ukazující těsně za posledním prvkem (je-li přítomen) kolekce. |
...
| Typedef | Popis |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Typ kolekce, jehož typy iterátorů se používají jako typy iterátorů v aktuální kolekci. |
...
* Třída [IColumnCollection](../icolumncollection/)
