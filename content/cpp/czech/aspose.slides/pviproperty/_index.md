...
type: docs
weight: 4941
url: /cs/aspose.slides/pviproperty/
---
## PVIProperty třída
...
| void [Lock](../../system/object/lock/)() | Implementuje zámek pomocí příkazu C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý argument šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slábného režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazem C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
...
* Třída [PVIPropertyBase](../pvipropertybase/)
