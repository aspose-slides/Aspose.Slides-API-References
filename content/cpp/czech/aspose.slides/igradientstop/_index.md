...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Vrací barvu gradientového zastavení. Pouze pro čtení [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Vrací pozici (0..1) gradientového zastavení. Čtení **float**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Position](./set_position/)(**float**) | Nastavuje pozici (0..1) gradientového zastavení. Zápis **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání podle C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
