...
description: Reprezentuje gradientový formát.
type: docs
weight: 1119
...
Reprezentuje gradientový formát.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje srovnání s plovoucí čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje srovnání s plovoucí čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní použití. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Vrací barvu gradientního bodu. Pouze pro čtení [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Vrací pozici (0..1) gradientního bodu. Vrací **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Nastaví pozici (0..1) gradientního bodu. Zapíše **float**. |
...
* Třída [IGradientStop](../igradientstop/)
