...
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Vrací velikost v bodech. Přečtěte [System::Drawing::SizeF](../../system.drawing/sizef/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání dle C# lock(). Zavolejte přímo nebo použijte strážný objekt [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nezkopíruje nic, pouze inicializuje nový objekt a umožní kopírovací konstrukci podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nezkopíruje nic, pouze inicializuje nový objekt a umožní kopírovací konstrukci podtříd. |
...
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Nastaví velikost v bodech. Zapište [System::Drawing::SizeF](../../system.drawing/sizef/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí dle C# lock(). Zavolejte přímo nebo použijte strážný objekt [LockContext](../../system/lockcontext/). |
