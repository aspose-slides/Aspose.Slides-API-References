...
---
## Presentation::Save(System::String, Export::SaveFormat) metoda
...
## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) metoda
...
## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) metoda


Uloží všechny snímky prezentace do souboru ve zvoleném formátu a s dalšími možnostmi.
...
| fname | [System::String](../../../system/string/) | Cesta k vytvořenému souboru. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Formát exportovaných dat. |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Export::ISaveOptions](../../../aspose.slides.export/isaveoptions/)\> | Další možnosti formátu. |
## Poznámky



Následující příklad ukazuje, jak převést PowerPoint do HTML pomocí C++. 
```cpp
// Vytvoří objekt prezentace, který představuje soubor prezentace, např. PPT, PPTX, ODP atd.
...
```
Následující příklad ukazuje, jak převést PowerPoint do responzivního HTML pomocí C++. 
```cpp
...
// Uloží prezentaci do HTML
presentation->Save(u"ConvertPresentationToResponsiveHTML_out.html", SaveFormat::Html, htmlOptions);
```
Následující příklad ukazuje, jak převést PowerPoint do HTML s poznámkami pomocí C++. 
```cpp
...
// Uloží stránky poznámek
pres->Save(u"Output.html", SaveFormat::Html, opt);
```
Následující příklad ukazuje, jak převést PowerPoint do HTML s původními fonty pomocí C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Vyloučí výchozí fonty prezentace
...
```
Následující příklad ukazuje, jak převést PowerPoint do HTML s vysoce kvalitními obrázky při 150 DPI pomocí C++. 
```cpp
...
```
Následující příklad ukazuje, jak převést PowerPoint do HTML s obrázky v plné kvalitě pomocí C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
Následující příklad ukazuje, jak převést [Slide](../../slide/) do HTML pomocí C++. 
```cpp
```
...
* Třída [IXamlOptions](../../../aspose.slides.export.xaml/ixamloptions/)
