...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | Typ prořezu. Číst [BevelPresetType](../bevelpresettype/). |
| **double** [get_Height](./get_height/)() override | Výška prořezu. Číst **double**. |
...
| **double** [get_Width](./get_width/)() override | Šířka prořezu. Číst **double**. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | Typ prořezu. Zapsat [BevelPresetType](../bevelpresettype/). |
| void [set_Height](./set_height/)(**double**) override | Výška prořezu. Zapsat **double**. |
| void [set_Width](./set_width/)(**double**) override | Šířka prořezu. Zapsat **double**. |
