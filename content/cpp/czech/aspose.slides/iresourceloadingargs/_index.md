...
| virtual [System::String](../../system/string/) [get_OriginalUri](./get_originaluri/)() | Původní URI zdroje, jak je uvedeno v importované prezentaci. |
| virtual [System::String](../../system/string/) [get_Uri](./get_uri/)() | URI zdroje, který se používá pro stahování, pokud [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) vrátí [ResourceLoadingAction::Default](../resourceloadingaction/). Na počátku je nastaven na původní URI zdroje, ale může být předefinováno na libovolnou hodnotu. |
...
| virtual void [set_Uri](./set_uri/)([System::String](../../system/string/)) | URI zdroje, který se používá pro stahování, pokud [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) vrátí [ResourceLoadingAction::Default](../resourceloadingaction/). Na počátku je nastaven na původní URI zdroje, ale může být předefinováno na libovolnou hodnotu. |
| virtual void [SetData](./setdata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Nastaví uživatelem poskytnutá data zdroje, která se použijí, pokud [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) vrátí [ResourceLoadingAction::UserProvided](../resourceloadingaction/). |
