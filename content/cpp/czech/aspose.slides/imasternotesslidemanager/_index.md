...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [get_MasterNotesSlide](./get_masternotesslide/)() | Vrací hlavní objekt pro všechny snímky poznámek této prezentace, pokud existuje, jinak vrací null. Pouze pro čtení [IMasterNotesSlide](../imasternotesslide/). |
...
| virtual void [RemoveMasterNotesSlide](./removemasternotesslide/)() | Odstraní hlavní snímek poznámek. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [SetDefaultMasterNotesSlide](./setdefaultmasternotesslide/)() | Nastaví výchozí hlavní snímek poznámek pro související snímek poznámek. |
