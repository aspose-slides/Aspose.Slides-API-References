...
description: Reprezentuje značku citlivosti z Microsoft Purview Information Protection.
type: docs
weight: 5058
...
Reprezentuje značku citlivosti z Microsoft Purview Information Protection.
...
| [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() override | Vrací metodu přiřazení pro značku citlivosti. Přečtěte si [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() override | Vrací seznam typů označování obsahu, které by měly být použity na soubor. |
| [System::String](../../system/string/) [get_Id](./get_id/)() override | Vrací ID značky citlivosti. Přečtěte si [System::String](../../system/string/). |
| **bool** [get_IsEnabled](./get_isenabled/)() override | Indikuje, zda je značka citlivosti povolena. |
| **bool** [get_IsRemoved](./get_isremoved/)() override | Indikuje, zda byla značka citlivosti odstraněna. |
| [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() override | Vrací identifikátor webu Azure Active Directory (Azure AD), který odpovídá politice značky citlivosti popisující značku citlivosti. Přečtěte si [System::Guid](../../system/guid/). |
...
| void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) override | Nastavuje metodu přiřazení pro značku citlivosti. Zapište [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | Nastavuje ID značky citlivosti. Zapište [System::String](../../system/string/). |
| void [set_IsEnabled](./set_isenabled/)(**bool**) override | Indikuje, zda je značka citlivosti povolena. |
| void [set_IsRemoved](./set_isremoved/)(**bool**) override | Indikuje, zda byla značka citlivosti odstraněna. |
| void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) override | Nastavuje identifikátor webu Azure Active Directory (Azure AD) odpovídající politice značky citlivosti popisující značku citlivosti. Zapište [System::Guid](../../system/guid/). |
