...
| Metoda | Popis |
| --- | --- |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Vytvoří kopii zadaného šablonového řádku a vloží ji na konec tabulky. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>, **int32_t**) override | Zkopíruje všechny prvky z kolekce do zadaného pole. |
...
| **int32_t** [get_Count](./get_count/)() override | Získá počet řádků skutečně obsažených v kolekci. Pouze ke čtení **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Vrací hodnotu označující, zda je přístup ke kolekci synchronizován (vláknově bezpečný). Pouze ke čtení **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který prochází kolekcí. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [idx_get](./idx_get/)(**int32_t**) override | Vrací řádek na zadaném indexu. Pouze ke čtení [Row](../row/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Vytvoří kopii zadaného šablonového řádku a vloží ji na zadanou pozici v tabulce. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Určuje, zda existuje některý prvek sekvence nebo splňuje podmínku. |
...
| void [RemoveAt](./removeat/)(**int32_t**, **bool**) override | Odstraní řádek na zadané pozici z tabulky. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý šablonový argument na slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
...
* Třída [IRowCollection](../irowcollection/)
