...
description: Reprezentuje zdroj InterruptionToken.
type: docs
weight: 3069
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Vrací true, pokud je požadováno přerušení, jinak false. |
| [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() override | Vrací nový token svázaný s tímto [InterruptionTokenSource](./). |
...
| void [Interrupt](./interrupt/)() override | Inicializuje požadavek na přerušení. |
|  [InterruptionTokenSource](./interruptiontokensource/)() | Vytvoří nový [InterruptionTokenSource](./). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání dle C# lock() příkazu. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
* Třída [IInterruptionTokenSource](../iinterruptiontokensource/)
