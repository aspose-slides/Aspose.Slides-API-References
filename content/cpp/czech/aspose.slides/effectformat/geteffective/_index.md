...
description: Získá efektivní data formátování efektu s aplikovaným děděním.
type: docs
weight: 430
url: /cs/aspose.slides/effectformat/geteffective/
---
...
Tento příklad demonstruje získání některých efektivních vlastností efektu tvaru. 
```cpp
...
* Třída [IEffectFormatEffectiveData](../../ieffectformateffectivedata/)
* Třída [EffectFormat](../)
