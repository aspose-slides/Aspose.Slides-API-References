...
description: neměnný objekt, který představuje gradientovou zastávku.
type: docs
weight: 2445
url: /cs/aspose.slides/igradientstopeffectivedata/
---
## IGradientStopEffectiveData třída


neměnný objekt, který představuje gradientovou zastávku.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Vrací barvu gradientové zastávky. Pouze ke čtení [System::Drawing::Color](../../system.drawing/color/). |
| virtual **float** [get_Position](./get_position/)() | Vrací pozici (0..1) gradientové zastávky. Pouze ke čtení **float**. |
