...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | Vrací vložený obrázek. Přečtěte [IPPImage](../ippimage/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/)\> [get_ImageTransform](./get_imagetransform/)() | Vrací kolekci efektů transformace obrázku. Pouze pro čtení [IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperation](../../aspose.slides.effects/iimagetransformoperation/)\> [get_ImageTransformOperation](./get_imagetransformoperation/)(**int32_t**) | Vrací operaci transformace obrázku na zadaném indexu. |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Vrací URL propojeného obrázku sady. Přečtěte [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle příkazu C# lock(). Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Image](./set_image/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Nastavuje vložený obrázek. Zapište [IPPImage](../ippimage/). |
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Vrací URL propojeného obrázku sady. Zapište [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení podle příkazu C# lock(). Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
