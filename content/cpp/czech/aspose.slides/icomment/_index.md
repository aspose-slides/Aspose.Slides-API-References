...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [get_Author](./get_author/)() | Vrací autora komentáře. Pouze pro čtení [ICommentAuthor](../icommentauthor/). |
| virtual [System::DateTime](../../system/datetime/) [get_CreatedTime](./get_createdtime/)() | Vrací čas vytvoření komentáře. Nastavením této vlastnosti na [DateTime::MinValue](../../system/datetime/minvalue/) se neuloží čas komentáře. Čtení [System::DateTime](../../system/datetime/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](./)\> [get_ParentComment](./get_parentcomment/)() | Získává nadřazený komentář. Čtení [IComment](./). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_Position](./get_position/)() | Vrací pozici komentáře na snímku. Čtení [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_Slide](./get_slide/)() | Vrací nadřazený snímek komentáře. Pouze pro čtení [ISlide](../islide/). |
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Vrací prostý text komentáře na snímku. Čtení [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokování dle C# příkazu lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual void [Remove](./remove/)() | Odstraňuje komentář a všechny jeho odpovědi z nadřazené kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Snižuje sdílený referenční čítač o zadanou hodnotu. |
| virtual void [set_CreatedTime](./set_createdtime/)([System::DateTime](../../system/datetime/)) | Nastavuje čas vytvoření komentáře. Nastavením této vlastnosti na [DateTime::MinValue](../../system/datetime/minvalue/) se neuloží čas komentáře. Zápis [System::DateTime](../../system/datetime/). |
| virtual void [set_ParentComment](./set_parentcomment/)([System::SharedPtr](../../system/sharedptr/)\<[IComment](./)\>) | Nastavuje nadřazený komentář. Zápis [IComment](./). |
| virtual void [set_Position](./set_position/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Nastavuje pozici komentáře na snímku. Zápis [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Nastavuje prostý text komentáře na snímku. Zápis [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování dle C# příkazu lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
