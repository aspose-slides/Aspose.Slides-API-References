...
description: Reprezentuje vlastnosti rámečku tvaru.
type: docs
weight: 3706
...
| virtual **float** [get_CenterX](./get_centerx/)() | Vrací X souřadnici středu rámce. Pouze pro čtení **float**. |
| virtual **float** [get_CenterY](./get_centery/)() | Vrací Y souřadnici středu rámce. Pouze pro čtení **float**. |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | Určuje, zda je rámec horizontálně převrácen. Pouze pro čtení [NullableBool](../nullablebool/). |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | Určuje, zda je rámec vertikálně převrácen. Pouze pro čtení [NullableBool](../nullablebool/). |
| virtual **float** [get_Height](./get_height/)() | Vrací výšku rámce. Pouze pro čtení **float**. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | Vrací souřadnice rámce. Pouze pro čtení [System::Drawing::RectangleF](../../system.drawing/rectanglef/). |
| virtual **float** [get_Rotation](./get_rotation/)() | Vrací počet stupňů, o které je rámec otočen kolem osy z. Kladná hodnota značí otočení po směru hodinových ručiček; záporná hodnota značí otočení proti směru hodinových ručiček. Pouze pro čtení **float**. |
| virtual **float** [get_Width](./get_width/)() | Vrací šířku rámce. Pouze pro čtení **float**. |
| virtual **float** [get_X](./get_x/)() | Vrací X souřadnici levého horního rohu rámce. Pouze pro čtení **float**. |
| virtual **float** [get_Y](./get_y/)() | Vrací Y souřadnici levého horního rohu rámce. Pouze pro čtení **float**. |
