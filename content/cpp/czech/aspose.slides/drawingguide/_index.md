...
description: Představuje nastavitelný vodicí prvek.
type: docs
weight: 820
...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Vrací barvu vodicí čáry. Číst [System::Drawing::Color](../../system.drawing/color/). |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Vrací orientaci vodicí čáry. Číst [Slides::Orientation](../orientation/). |
| **float** [get_Position](./get_position/)() override | Vrací pozici vodicí čáry v bodech od horního levého rohu snímku. Číst **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získává datovou strukturu referenčního čítače související s objektem. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje kopírování konstruktorů odvozených tříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje kopírování konstruktorů odvozených tříd. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Nastavuje barvu vodicí čáry. Zapsat [System::Drawing::Color](../../system.drawing/color/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | Nastavuje orientaci vodicí čáry. Zapsat [Slides::Orientation](../orientation/). |
| void [set_Position](./set_position/)(**float**) override | Nastavuje pozici vodicí čáry v bodech od horního levého rohu snímku. Zapsat **float**. |
...
* Třída [IDrawingGuide](../idrawingguide/)
