...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Vrací typ náčrtu. Přečtěte si [Slides::LineSketchType](../linesketchtype/). |
...
| virtual void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) | Nastavuje typ náčrtu. Zapište [Slides::LineSketchType](../linesketchtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock(). Zavolejte přímo nebo použijte sentry objekt [LockContext](../../system/lockcontext/). |
