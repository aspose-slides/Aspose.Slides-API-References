...
Reprezentuje rastrový nebo vektorový obrázek.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání s plovoucí řádovou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, ačkoliv podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s plovoucí řádovou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, ačkoliv podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro vnitřní použití. |
| virtual **int32_t** [get_Height](./get_height/)() | Získává výšku obrázku v pixelech. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_Size](./get_size/)() | Získává velikost obrázku. |
| virtual **int32_t** [get_Width](./get_width/)() | Získává šířku obrázku v pixelech. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# lock() příkazem. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual void [Save](./save/)([System::String](../../system/string/)) | Ukládá obrázek do souboru. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/)) | Ukládá obrázek do souboru ve zvoleném formátu. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/)) | Ukládá obrázek do proudu ve zvoleném formátu. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/), **int32_t**) | Ukládá obrázek do souboru ve zvoleném formátu a kvalitě. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/), **int32_t**) | Ukládá obrázek do proudu ve zvoleném formátu a kvalitě. |
...
Toto rozhraní poskytuje společnou abstrakci pro zpracování jak rastrových, tak vektorových obrázků.  

Implementace se mohou lišit v závislosti na podkladovém typu obrázku.  
