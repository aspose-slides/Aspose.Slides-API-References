...
---
## ICustomXmlPartCollection třída
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Přidá novou vlastní xml část. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::String](../../system/string/)) | Přidá novou vlastní xml část. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Přidá novou vlastní xml část. |
...
| virtual void [Clear](./clear/)() | Odstraní všechny položky z kolekce. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C# pro typ float, kde jsou dva NaN považovány za rovny, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C# pro typ double, kde jsou dva NaN považovány za rovny, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [idx_get](./idx_get/)(**int32_t**) | Vrací prvek na zadaném indexu. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Vrací první prvek sekvence, který splňuje podmínku, nebo výchozí hodnotu, pokud žádný takový prvek nebyl nalezen. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Vrací zadaný počet souvislých prvků na začátku sekvence. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání výrazu lock() jazyka C#. Volat přímo nebo použít objekt [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umožňuje klonování vlastních typů. |
|  [Object](../../system/object/object/)() | Vytvoří objekt. Inicializuje všechny vnitřní datové struktury. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, jen inicializuje nový objekt a umožňuje konstrukci kopií odvozených tříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, jen inicializuje nový objekt a umožňuje konstrukci kopií odvozených tříd. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>) | Odstraní první výskyt konkrétního objektu z kolekce. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Odstraní vlastní xml část na zadaném indexu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání výrazu lock() v C#. Volat přímo nebo použít objekt [LockContext](../../system/lockcontext/). |
