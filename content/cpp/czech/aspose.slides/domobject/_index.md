...
description: Základní DOM objekt
type: docs
weight: 807
url: /cs/aspose.slides/domobject/
---
## DomObject třída

Základní [DOM](../../aspose.slides.dom/) objekt
...
| --- | --- |
| TParent | Typ nadřazeného [DOM](../../aspose.slides.dom/) objektu |
## Metody
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock(). Volá se přímo nebo se použije objekt [LockContext](../../system/lockcontext/). |
