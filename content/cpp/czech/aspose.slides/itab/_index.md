...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Vrací zarovnání tabulátoru. Číst [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Vrací pozici tabulátoru. Přiřazení této vlastnosti může změnit index tabulátoru ve sbírce a zneplatnit Enumerator. Číst **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu referenčního počítadla přidruženou k objektu. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Nastavuje zarovnání tabulátoru. Zapsat [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Nastavuje pozici tabulátoru. Přiřazení této vlastnosti může změnit index tabulátoru ve sbírce a zneplatnit Enumerator. Zapsat **double**. |
