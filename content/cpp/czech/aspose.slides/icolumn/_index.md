...
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopíruje všechny prvky kolekce do zadaného pole. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() | Vrací objekt [ColumnFormat](../columnformat/), který obsahuje formátovací vlastnosti pro tento sloupec. Pouze pro čtení [IColumnFormat](../icolumnformat/). |
...
| virtual **double** [get_Width](./get_width/)() | Vrací šířku sloupce. Číst **double**. |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Uplatní akumulátorovou funkci na sekvenci. |
...
| virtual void [set_Width](./set_width/)(**double**) | Nastavuje šířku sloupce. Write **double**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Nastaví definované vlastnosti formátu částí na všechny části prvku. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Nastaví definované vlastnosti formátu odstavců na všechny odstavce prvku. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Nastaví definované vlastnosti formátu textových rámců na všechny textové rámečky prvku. |
