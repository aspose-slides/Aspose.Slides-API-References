...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Porovnává reference typu objekty ve stylu C#. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_BackColor](./get_backcolor/)() override | Vrací barvu pozadí vzoru. Pouze pro čtení [IColorFormat](../icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ForeColor](./get_forecolor/)() override | Vrací barvu popředí vzoru. Pouze pro čtení [IColorFormat](../icolorformat/). |
...
| [Aspose::Slides::PatternStyle](../patternstyle/) [get_PatternStyle](./get_patternstyle/)() override | Vrací styl vzoru. Číst [Slides::PatternStyle](../patternstyle/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/), [System::Drawing::Color](../../system.drawing/color/)) override | Vytvoří dlaždicový obrázek pro výplň vzoru s určenými barvami. |
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/)) override | Vytvoří dlaždicový obrázek pro výplň vzoru. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiovací konstruktor. Ve skutečnosti nic nekopíruje, jen inicializuje nový objekt a umožní kopírování podtříd. |
...
| void [set_PatternStyle](./set_patternstyle/)([Aspose::Slides::PatternStyle](../patternstyle/)) override | Nastaví styl vzoru. Zápis [Slides::PatternStyle](../patternstyle/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení dle C# lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
* Třída [IPatternFormat](../ipatternformat/)
