...
description: Reprezentuje správce, který určuje chování zápatí, data a času a zástupných znaků číslování stránek pro všechny typy snímků.
type: docs
weight: 131
...
Reprezentuje správce, který určuje chování zástupných znaků zápatí, data a času a číslování stránek pro všechny typy snímků.
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamykání pomocí příkazu C# lock(). Vyvolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Vyvolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
