...
description: Reprezentuje zdroj IInterruptionToken.
type: docs
weight: 2614
url: /cs/aspose.slides/iinterruptiontokensource/
---
## IInterruptionTokenSource třída
...
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | Vrací true, pokud je požadováno přerušení, jinak false. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() | Vrací nový token navázaný na tento [IInterruptionTokenSource](./). |
...
| virtual void [Interrupt](./interrupt/)() | Inicializuje požadavek na přerušení. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí C# příkazem lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
