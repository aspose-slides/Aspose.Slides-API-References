...
description: Rozhraní callbacku použité k řízení načítání externích zdrojů.
type: docs
weight: 3498
url: /cs/aspose.slides/iresourceloadingcallback/
---
## IResourceLoadingCallback třída
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání floating point v C# stylu, kde jsou dva NaN považovány za stejné, i když podle IEC 60559:1989 NaN není roven žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání floating point v C# stylu, kde jsou dva NaN považovány za stejné, i když podle IEC 60559:1989 NaN není roven žádné hodnotě, včetně NaN. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() prohlášení. Zavolejte přímo nebo použijte objekt hlída [LockContext](../../system/lockcontext/). |
...
| virtual [ResourceLoadingAction](../resourceloadingaction/) [ResourceLoading](./resourceloading/)([System::SharedPtr](../../system/sharedptr/)\<[IResourceLoadingArgs](../iresourceloadingargs/)\>) | Metoda zpětného volání, která reguluje načítání externích zdrojů. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony jako slabý ukazatel (místo sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do režimu slabého ukazatele. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock() prohlášení. Zavolejte přímo nebo použijte objekt hlída [LockContext](../../system/lockcontext/). |
