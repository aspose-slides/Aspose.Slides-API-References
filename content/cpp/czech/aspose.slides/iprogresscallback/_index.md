...
description: Představuje objekt zpětného volání pro ukládání aktualizací postupu v procentech.
type: docs
weight: 3446
url: /cs/aspose.slides/iprogresscallback/
---
## IProgressCallback třída
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Napodobňuje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Napodobňuje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| virtual void [Reporting](./reporting/)(**double**) | Oznamuje aktualizaci průběhu. |
