...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() override | Vrací poznámkový snímek pro aktuální snímek, vytvoří jej, pokud neexistuje. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() override | Vrací poznámkový snímek pro aktuální snímek. Vrací null, pokud snímek nemá poznámkový snímek. Pouze ke čtení [INotesSlide](../inotesslide/). |
...
| void [RemoveNotesSlide](./removenotesslide/)() override | Odstraní poznámkový snímek aktuálního snímku. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() příkazu. Volat přímo nebo použít objekt [LockContext](../../system/lockcontext/). |
...
Následující příklad ukazuje, jak přidat poznámky ke konkrétnímu PowerPoint [Presentation](../presentation/) snímku.
```cpp
...
```
 Následující příklady ukazují, jak odstranit poznámky z konkrétního snímku PowerPoint [Presentation](../presentation/).
```cpp
// Vytvořte objekt Presentation, který představuje soubor prezentace
auto presentation = System::MakeObject<Presentation>(dataDir + u"AccessSlides.pptx");
...
* Třída [INotesSlideManager](../inotesslidemanager/)
