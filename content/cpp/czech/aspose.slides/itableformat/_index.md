...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Vrací objekt vlastností výplně tabulky. Pouze ke čtení [IFillFormat](../ifillformat/). |
| virtual **float** [get_Transparency](./get_transparency/)() | Získává průhlednost barvy výplně. Čte **float**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() | Získává efektivní vlastnosti formátování tabulky s aplikovaným děděním a styly tabulky. |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | Nastavuje průhlednost barvy výplně. Zapíše **float**. |
