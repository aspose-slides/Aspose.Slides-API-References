...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnávání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovný žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnávání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovný žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Vrací [EffectFormat](../effectformat/) pro [BackgroundType::OwnBackground](../backgroundtype/) výplň. Pouze pro čtení [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Vrací [FillFormat](../fillformat/) pro [BackgroundType::OwnBackground](../backgroundtype/) výplň. Pouze pro čtení [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Vrací [ColorFormat](../colorformat/) pro [BackgroundType::Themed](../backgroundtype/) výplň. Pouze pro čtení [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Vrací index [BackgroundType::Themed](../backgroundtype/) výplně v kolekci motivů pozadí. 0 znamená žádnou výplň. 1..999 – index. Číst **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Vrací typ výplně pozadí. Číst [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Získá efektivní data pozadí s aplikovaným děděním. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# příkazem lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/). |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Vrací index [BackgroundType::Themed](../backgroundtype/) výplně v kolekci motivů pozadí. 0 znamená žádnou výplň. 1..999 – index. Zapsat **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Vrací typ výplně pozadí. Zapsat [BackgroundType](../backgroundtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí C# příkazem lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/). |
