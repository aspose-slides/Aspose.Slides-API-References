...
| Method | Description |
| --- | --- |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) | Vytvoří kopii zadaného řádku šablony a vloží ji na konec tabulky. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Vrací hodnotu určující, zda je přístup ke kolekci synchronizován (bezpečný pro vlákna). Pouze pro čtení **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [idx_get](./idx_get/)(**int32_t**) | Získá prvek na zadaném indexu. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) | Vytvoří kopii zadaného řádku šablony a vloží jej na zadanou pozici v tabulce. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Vypočítá průměr sekvence hodnot, které jsou získány voláním transformační funkce na každý prvek vstupní sekvence. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence vzestoupně podle hodnot klíčů vybraných pomocí keySelector. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**, **bool**) | Odstraní řádek na zadané pozici z tabulky. |
