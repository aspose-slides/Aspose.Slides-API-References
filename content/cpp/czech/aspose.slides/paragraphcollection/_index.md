...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Přidá [Paragraph](../paragraph/) na konec kolekce. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Přidá obsah [ParagraphCollection](./) na konec kolekce. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | Přidá text ze specifikovaného řetězce HTML do kolekce. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | Přidá text ze specifikovaného řetězce HTML do kolekce. |
...
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Určuje, zda [ICollection](../../system.collections.generic/icollection/) obsahuje konkrétní hodnotu. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | Kopíruje prvky [ICollection](../../system.collections.generic/icollection/) do [System::Array](../../system/array/), počínaje konkrétním indexem [System::Array](../../system/array/). |
...
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | Převede zadané odstavce do HTML a vrátí je jako objekt String. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Získá hodnotu udávající, zda je [ICollection](../../system.collections.generic/icollection/) pouze pro čtení. Pouze pro čtení **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který iteruje přes kolekci. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | Získá prvek na zadaném indexu. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Určuje index konkrétní položky v [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Vloží [Paragraph](../paragraph/) do kolekce na zadaném indexu. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Vloží obsah [ParagraphCollection](./) do kolekce na zadaném indexu. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformovací funkci na každém prvku generické sekvence a vrací maximální výslednou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformovací funkci na každém prvku generické sekvence a vrací minimální výslednou hodnotu. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Odstraní první výskyt konkrétního objektu z [ICollection](../../system.collections.generic/icollection/). |
| void [RemoveAt](./removeat/)(**int32_t**) override | Odstraní prvek na zadaném indexu v kolekci. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý šablonový argument jako weak pointer (namísto shared). Umožňuje přepnutí ukazatelů v kontejnerů do režimu weak. |
...
* Třída [IParagraphCollection](../iparagraphcollection/)
