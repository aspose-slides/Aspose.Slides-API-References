...
description: Representuje zámek tvaru (zakázaná operace).
type: docs
weight: 1483
url: /cs/aspose.slides/ibaseshapelock/
---
## IBaseShapeLock třída


Representuje [Shape](../shape/) zámek (zakázaná operace).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Vrátí true, pokud jsou všechna lock-flags zakázána. Pouze pro čtení **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí příkazu C# lock(). Zavolejte přímo nebo použijte sentinel objekt [LockContext](../../system/lockcontext/). |
