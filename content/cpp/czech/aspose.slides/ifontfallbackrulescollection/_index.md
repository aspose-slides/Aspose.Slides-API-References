...
---
## IFontFallBackRulesCollection třída
...
| Metoda | Popis |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Přidá nové pravidlo FallBack na konec kolekce. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Vrací hodnotu udávající, zda je přístup ke kolekci synchronizovaný (vláknově bezpečný). Pouze pro čtení **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) | Získá pravidlo na zadaném indexu. Pouze pro čtení [IFontFallBackRule](../ifontfallbackrule/). |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Vrací počet prvků v sekvenci (vypočítáno přímým sčítáním). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Odstraní první výskyt konkrétního pravidla FallBack z kolekce. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
