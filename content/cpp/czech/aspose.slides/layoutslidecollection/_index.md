...
description: Reprezentuje základní třídu pro sbírku rozvržení snímků.
type: docs
weight: 4304
...
Representuje základní třídu pro sbírku rozvržení snímků.
...
| Metoda | Popis |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() | Získá iterátor ukazující na první prvek (pokud existuje) ve sbírce. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Získá iterátor ukazující na první prvek (pokud existuje) v konstantně kvalifikované instanci sbírky. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Získá iterátor ukazující na první konstantně kvalifikovaný prvek (pokud existuje) ve sbírce. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Získá iterátor ukazující těsně za posledním konstantně kvalifikovaným prvkem (pokud existuje) ve sbírce. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>, **int32_t**) override | Zkopíruje všechny prvky ze sbírky do zadaného pole. |
...
| [iterator](./iterator/) [end](./end/)() | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) ve sbírce. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) v konstantně kvalifikované instanci sbírky. |
...
| **int32_t** [get_Count](./get_count/)() override | Vrací počet rozvržení snímků ve sbírce. Pouze pro čtení **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Vrací hodnotu označující, zda je přístup ke sbírce synchronizován (vláknově bezpečný). Pouze pro čtení **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) override | Vrací první rozvržení snímku zadaného typu. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který prochází sbírku. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) override | Vrací rozvržení snímku podle indexu. Pouze pro čtení [LayoutSlide](../layoutslide/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Odstraní rozvržení ze sbírky. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží počítadlo sdílených referencí o zadanou hodnotu. |
| void [RemoveUnused](./removeunused/)() override | Odstraní nepoužité rozvržení snímků (rozvržení, jejichž HasDependingSlides je false). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvyšuje počítadlo sdílených referencí. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Snižuje a vrací počítadlo sdílených referencí. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Získá iterátor ukazující na první prvek (pokud existuje) v konstantně kvalifikované instanci sbírky. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Získá iterátor ukazující na první prvek (pokud existuje) ve sbírce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) v konstantně kvalifikované instanci sbírky. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) ve sbírce. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje počítadlo slabých referencí. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje počítadlo slabých referencí. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
...
| Definice typu | Popis |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Typ sbírky, jejíž typy iterátorů jsou používány jako typy iterátorů v aktuální sbírce. |
