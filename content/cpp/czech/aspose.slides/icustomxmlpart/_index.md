...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Specifikuje globálně jedinečný identifikátor (GUID), který jednoznačně identifikuje jednu vlastní část XML v dokumentu Office Open XML. Pouze pro čtení [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | Vrací kolekci XML schémat, která jsou spojena s vlastní částí XML. Pouze pro čtení [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | Vrací data XML jako řetězec UTF-8. Čtení [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | Vrací data XML. Čtení **uint8_t**[]. |
...
| virtual void [Remove](./remove/)() | Odstraní vlastní část XML z prezentace. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Specifikuje globálně jedinečný identifikátor (GUID), který jednoznačně identifikuje jednu vlastní část XML v dokumentu Office Open XML. Pouze pro čtení [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | Nastaví data XML jako řetězec UTF-8. Zápis [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Nastaví data XML. Zápis **uint8_t**[]. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
