...
description: Vrací zarovnání textu v odstavci bez dědičnosti. Přečtěte si TextAlignment.
type: docs
weight: 1
url: /cs/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() metoda


Vrací zarovnání textu v odstavci bez dědičnosti. Přečtěte si [TextAlignment](../../textalignment/).
...
Následující ukázkový kód ukazuje, jak zarovnat textové odstavce v PowerPointu [Presentation](../../presentation/). 
```cpp
