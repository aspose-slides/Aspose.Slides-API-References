...
description: Reprezentuje základní třídu pro zámky (zakázaná operace).
type: docs
weight: 157
...
| **bool** [get_NoLocks](./get_nolocks/)() override | Vrací true, pokud jsou všechny zámky vypnuté. Pouze pro čtení **bool**. |
