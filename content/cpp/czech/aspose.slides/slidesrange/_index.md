...
| **uint32_t** [get_End](./get_end/)() const | Konec |
| **uint32_t** [get_Start](./get_start/)() const | Začátek |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazu C# lock(). Volá se přímo nebo použijte sentry objekt [LockContext](../../system/lockcontext/). |
...
| void [set_End](./set_end/)(**uint32_t**) | Konec |
| void [set_Start](./set_start/)(**uint32_t**) | Začátek |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování příkazu C# lock(). Volá se přímo nebo použijte sentry objekt [LockContext](../../system/lockcontext/). |
