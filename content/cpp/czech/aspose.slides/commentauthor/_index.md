...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Vrací komentář vytvořený tímto autorem na zadaném indexu. Pouze pro čtení [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Vrací kolekci komentářů vytvořených tímto autorem. Pouze pro čtení [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Vrací iniciály autora. Čtení [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Vrací jméno autora. Čtení [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Odstraní autora z nadřazené kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Nastaví iniciály autora. Zápis [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Nastaví jméno autora. Zápis [System::String](../../system/string/). |
