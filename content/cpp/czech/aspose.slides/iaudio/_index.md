...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Vrací kopii dat zvuku. V případě velkého množství dat zvažte použití metody [IAudio::GetStream](./getstream/) k zabránění zbytečného načítání dat zvuku do paměti nebo dokonce výjimky OutOfMemoryException. Pouze pro čtení **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Vrací MIME typ zvuku, kódovaný v [IAudio::get_BinaryData](./get_binarydata/). Pouze pro čtení [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Vrací stream Stream pro čtení. Použijte 'using' nebo stream po použití zavřete. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení C# lock() výrazu. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual  [~Object](../../system/object/~object/)() | Ničí objekt. Uvolňuje veškeré interní datové struktury. |
