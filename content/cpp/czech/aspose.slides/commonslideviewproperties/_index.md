...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) override | Vrací vodítko kresby na zadaném indexu. Pouze pro čtení [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Vrací kolekci kreslicích vodítek. Pouze pro čtení [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **int32_t** [get_Scale](./get_scale/)() override | Určuje poměr měřítka zobrazení v procentech. Čte **int32_t**. |
| **bool** [get_VariableScale](./get_variablescale/)() override | Určuje, že obsah zobrazení by měl být automaticky měněn tak, aby nejlépe vyplnil aktuální velikost okna. Čte **bool**. |
...
| void [set_Scale](./set_scale/)(**int32_t**) override | Určuje poměr měřítka zobrazení v procentech. Zapisuje **int32_t**. |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | Určuje, že obsah zobrazení by měl být automaticky měněn tak, aby nejlépe vyplnil aktuální velikost okna. Zapisuje **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
...
Následující příklad ukazuje, jak nastavit hodnotu přiblížení pro snímek PowerPointu [Presentation](../presentation/).
```cpp
...
// Hodnota přiblížení v procentech pro zobrazení snímku
presentation->get_ViewProperties()->get_NotesViewProperties()->set_Scale(100);
// Hodnota přiblížení v procentech pro zobrazení poznámek
presentation->Save(u"Zoom_out.pptx", SaveFormat::Pptx);
```

## Viz také

* Třída [ICommonSlideViewProperties](../icommonslideviewproperties/)
