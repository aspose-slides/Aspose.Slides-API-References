...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) typ. Pouze pro čtení [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 stupňů, zorné pole). Pouze pro čtení **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (kladná hodnota v procentech). Pouze pro čtení **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Rotace je definována pomocí souřadnice šířky, souřadnice délky a otáčení kolem osy jako souřadnice šířky a délky. první prvek v návratovém poli – šířka, druhý – délka, třetí – otáčení. Vrací null, pokud není rotace definována. |
