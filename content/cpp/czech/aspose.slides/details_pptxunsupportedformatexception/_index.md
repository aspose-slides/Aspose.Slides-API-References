...
description: Výjimka, která je vyvolána, když je formát souboru prezentace nepodporovaný.
type: docs
weight: 755
url: /cs/aspose.slides/details_pptxunsupportedformatexception/
---
## Details_PptxUnsupportedFormatException třída

Výjimka, která je vyvolána, když je formát souboru prezentace nepodporovaný.
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Vrací řetězec obsahující trasování zásobníku. |
...
* Třída [Details_PptxReadException](../details_pptxreadexception/)
