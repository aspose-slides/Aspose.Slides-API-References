...
description: Nastavuje počet sloupců v textové oblasti. Tato hodnota musí být kladné číslo. V opačném případě bude hodnota nastavena na nulu. Hodnota 0 znamená nedefinovanou hodnotu. Zapisujte int32_t.
type: docs
weight: 261
url: /cs/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) metoda


Nastavuje počet sloupců v textové oblasti. Tato hodnota musí být kladné číslo. V opačném případě bude hodnota nastavena na nula. Hodnota 0 znamená nedefinovanou hodnotu. Zapisujte **int32_t**.
...
Následující ukázkový kód ukazuje, jak přidat sloupec v textovém rámečku uvnitř PowerPointu [Presentation](../../presentation/). 
```cpp
