...
---
## IColorOperation třída

Reprezentuje různé operace s barvou používané pro transformace barev.
...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | Vrací typ operace. Pouze pro čtení [ColorTransformOperation](../colortransformoperation/). |
| virtual **float** [get_Parameter](./get_parameter/)() | Vrací parametr operace. Pouze pro čtení **float**. |
