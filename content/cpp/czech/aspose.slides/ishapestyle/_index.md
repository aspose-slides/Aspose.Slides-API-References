...
description: Reprezentuje referenci na styl tvaru.
type: docs
weight: 3719
...
Reprezentuje referenci na styl tvaru.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_EffectColor](./get_effectcolor/)() | Vrací barvu efektu tvaru. Pouze pro čtení [IColorFormat](../icolorformat/). |
| virtual **uint32_t** [get_EffectStyleIndex](./get_effectstyleindex/)() | Vrací index sloupce efektu tvaru ve stylové matici. Čtení **uint32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_FillColor](./get_fillcolor/)() | Vrací barvu výplně tvaru. Pouze pro čtení [IColorFormat](../icolorformat/). |
| virtual **int16_t** [get_FillStyleIndex](./get_fillstyleindex/)() | Vrací index sloupce výplně tvaru ve stylových maticích. 0 znamená žádnou výplň, kladná hodnota – index ve výplňových stylech motivu, záporná hodnota – index ve stylech pozadí motivu. Čtení **int16_t**. |
| virtual [Aspose::Slides::FontCollectionIndex](../fontcollectionindex/) [get_FontCollectionIndex](./get_fontcollectionindex/)() | Vrací index fontu tvaru ve sbírce fontů. Pouze pro čtení [Slides::FontCollectionIndex](../fontcollectionindex/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_FontColor](./get_fontcolor/)() | Vrací barvu fontu tvaru. Pouze pro čtení [IColorFormat](../icolorformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_LineColor](./get_linecolor/)() | Vrací barvu obrysu tvaru. Pouze pro čtení [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_LineStyleIndex](./get_linestyleindex/)() | Vrací index sloupce čáry ve stylové matici. Čtení **uint16_t**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí výrazu C# lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
...
| virtual void [set_EffectStyleIndex](./set_effectstyleindex/)(**uint32_t**) | Nastavuje index sloupce efektu tvaru ve stylové matici. Zápis **uint32_t**. |
| virtual void [set_FillStyleIndex](./set_fillstyleindex/)(**int16_t**) | Nastavuje index sloupce výplně tvaru ve stylových maticích. 0 znamená žádnou výplň, kladná hodnota – index ve výplňových stylech motivu, záporná hodnota – index ve stylech pozadí motivu. Zápis **int16_t**. |
| virtual void [set_FontCollectionIndex](./set_fontcollectionindex/)([Aspose::Slides::FontCollectionIndex](../fontcollectionindex/)) | Nastavuje index fontu tvaru ve sbírce fontů. Zápis [Slides::FontCollectionIndex](../fontcollectionindex/). |
| virtual void [set_LineStyleIndex](./set_linestyleindex/)(**uint16_t**) | Nastavuje index sloupce čáry ve stylové matici. Zápis **uint16_t**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí výrazu C# lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
