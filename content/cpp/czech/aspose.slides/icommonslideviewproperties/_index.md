...
description: Představuje společné vlastnosti zobrazení snímku.
type: docs
weight: 1834
url: /cs/aspose.slides/icommonslideviewproperties/
---
## ICommonSlideViewProperties třída

Představuje společné vlastnosti zobrazení snímku.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | Vrací vodítko kreslení na zadaném indexu. Pouze pro čtení [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Vrací kolekci kreslicích vodítek. Pouze pro čtení [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | Určuje poměr měřítka zobrazení v procentech. Číst **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | Určuje, že obsah zobrazení by se měl automaticky měnit tak, aby nejlépe odpovídal aktuální velikosti okna. Číst **bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle C# příkazu lock(). Zavolejte přímo nebo použijte strážní objekt [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Určuje poměr měřítka zobrazení v procentech. Zapsat **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Určuje, že obsah zobrazení by se měl automaticky měnit tak, aby nejlépe odpovídal aktuální velikosti okna. Zapsat **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí podle C# příkazu lock(). Zavolejte přímo nebo použijte strážní objekt [LockContext](../../system/lockcontext/). |
