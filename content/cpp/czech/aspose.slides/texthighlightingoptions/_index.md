...
description: Představuje možnosti, které lze použít k zvýraznění textu v textovém rámečku.
type: docs
weight: 5474
url: /cs/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions třída

Představuje možnosti, které lze použít k zvýraznění textu v textovém rámečku.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání plovoucí čárky ve stylu C#, kde jsou dva NaN považovány za stejné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání plovoucí čárky ve stylu C#, kde jsou dva NaN považovány za stejné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Nastavte true pro použití vyhledávání rozlišujícího velká a malá písmena, false – jinak. Čte **bool**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Nastavte true pro shodu pouze celých slov, false – jinak. Čte **bool**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Nastavte true pro použití vyhledávání rozlišujícího velká a malá písmena, false – jinak. Zapisuje **bool**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Nastavte true pro shodu pouze celých slov, false – jinak. Zapisuje **bool**. |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | Vytvoří nové výchozí možnosti zvýraznění textu. |
...
Zastaralé
:   Rozhraní [ITextHighlightingOptions](../itexthighlightingoptions/) bude po vydání verze 24.10 odstraněno.
