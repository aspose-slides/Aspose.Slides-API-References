...
description: Třída argumentů události pro události související s odstavcem.
type: docs
weight: 4642
url: /cs/aspose.slides/paragrapheventargs/
---
## ParagraphEventArgs třída

Třída argumentů události pro události související s odstavcem.
...
| Pole | Popis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statický člen, který představuje \"prázdný\" [EventArgs](../../system/eventargs/) sdílený ukazatel (nulový ukazatel). |
