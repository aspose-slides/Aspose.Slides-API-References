...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Vrací kopii dat audio. V případě velkého množství dat zvažte použití metody [Video::GetStream](./getstream/) k zabránění zbytečnému načítání dat videa do paměti nebo dokonce OutOfMemoryException. Pouze pro čtení **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Vrací MIME typ videa, kódovaný v [Video::get_BinaryData](./get_binarydata/). Pouze pro čtení [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | Vrací Stream pro čtení. Použijte 'using' nebo po použití stream zavřete. |
