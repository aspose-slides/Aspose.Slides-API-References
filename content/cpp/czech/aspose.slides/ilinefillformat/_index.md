...
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | Vrací typ výplně. Čtěte [Slides::FillType](../filltype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() | Vrací formát gradientové výplně. Pouze ke čtení [IGradientFormat](../igradientformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() | Vrací formát vzorové výplně. Pouze ke čtení [IPatternFormat](../ipatternformat/). |
| virtual [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() | Stanoví, zda má být výplň otáčena spolu s tvarem. Čtěte [NullableBool](../nullablebool/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() | Vrací barvu plné výplně. Pouze ke čtení [IColorFormat](../icolorformat/). |
...
| virtual void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) | Nastaví typ výplně. Zapište [Slides::FillType](../filltype/). |
| virtual void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) | Stanoví, zda má být výplň otáčena spolu s tvarem. Zapište [NullableBool](../nullablebool/). |
