...
description: Representuje správce, který obsahuje chování zástupných znaků patičky, datum-čas a čísla stránky pro všechny typy snímků.
type: docs
weight: 183
...
Representuje správce, který drží chování záložek patičky, datum-čas a číslo stránky pro všechny typy snímků.
...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | Získá hodnotu indikující, že je přítomna záložka datum-čas. Read**bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | Získá hodnotu indikující, že je přítomna záložka patičky. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | Získá hodnotu indikující, že je přítomna záložka čísla stránky. Read**bool**. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | Nastaví text do záložky datum-čas snímku. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | Změní viditelnost záložky datum-čas snímku. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | Nastaví text do záložky patičky snímku. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | Změní viditelnost záložky patičky snímku. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | Změní viditelnost záložky čísla stránky snímku. |
