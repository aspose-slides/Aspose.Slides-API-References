...
description: Reprezentuje kolekci citlivých štítků aplikovaných na dokument.
type: docs
weight: 3628
url: /cs/aspose.slides/isensitivitylabelcollection/
---
## ISensitivityLabelCollection třída
...
| Metoda | Popis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Přidá štítek citlivosti na konec kolekce. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) | Přidá [SensitivityLabel](../sensitivitylabel/) do kolekce. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) | Vrací štítek citlivosti podle indexu. Pouze pro čtení [ISensitivityLabel](../isensitivitylabel/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Odstraní štítek citlivosti na zadaném indexu. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Sníží weak čítač referencí. Nemělo by se volat příno; místo toho použijte chytré ukazatele nebo ThisProtector. |
