...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Získá iterátor umístěný těsně za posledním prvkem kolekce označeným jako const (pokud existuje). |
...
| virtual **double** [get_Height](./get_height/)() | Vrací výšku řádku. Pouze pro čtení **double**. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Vrací hodnotu označující, zda je přístup ke kolekci synchronizovaný (vláknově bezpečný). Pouze pro čtení **bool**. |
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Vrací minimální možnou výšku řádku. Čte **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Vrací objekt [RowFormat](../rowformat/), který obsahuje formátovací vlastnosti pro tento řádek. Pouze pro čtení [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Vrací buňku podle její pozice. Pouze pro čtení [ICell](../icell/). |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Nic nekopíruje, jen inicializuje nový objekt a umožňuje kopiování podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Nic nekopíruje, jen inicializuje nový objekt a umožňuje kopiování podtříd. |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Nastavuje minimální možnou výšku řádku. Zapíše **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonový argument jako slabý ukazatel (namísto sdíleného). Umožňuje přepnout ukazatele v kontejnerech do režimu weak. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Nastaví definované vlastnosti formátu částí pro všechny části elementu. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Nastaví definované vlastnosti formátu odstavců pro všechny odstavce elementu. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Nastaví definované vlastnosti formátu textového rámce pro všechny textové rámce elementu. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie C# metody [Object.ToString()](../../system/object/tostring/). Umožňuje převést vlastní objekty na řetězec. |
