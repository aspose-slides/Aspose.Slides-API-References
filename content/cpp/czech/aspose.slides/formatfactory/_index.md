...
Umožňuje vytvářet formáty pomocí rozhraní COM.
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [CreateParagraphFormat](./createparagraphformat/)() override | Vytváří nový [IParagraphFormat](../iparagraphformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [CreatePortionFormat](./createportionformat/)() override | Vytváří nový [IPortionFormat](../iportionformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\> [CreateTextFrameFormat](./createtextframeformat/)() override | Vytváří nový [ITextFrameFormat](../itextframeformat/). |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za stejné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s dvojitou přesností ve stylu C#, kde jsou dvě NaN považovány za stejné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní použití. |
| static [System::SharedPtr](../../system/sharedptr/)\<[FormatFactory](./)\> [get_Instance](./get_instance/)() | Statická instance továrny na formáty. Pouze pro čtení [FormatFactory](./). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného pomocí targetType. Analóg operátoru C# 'is'. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
...
* Třída [IFormatFactory](../iformatfactory/)
