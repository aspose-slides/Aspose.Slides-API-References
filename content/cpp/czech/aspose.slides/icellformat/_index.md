...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderBottom](./get_borderbottom/)() | Vrací objekt vlastností spodní ohraničující čáry. Pouze pro čtení [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() | Vrací objekt vlastností úhlopříčky od levého horního ke pravému dolnímu rohu. Pouze pro čtení [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() | Vrací objekt vlastností úhlopříčky od levého dolního ke pravému hornímu rohu. Pouze pro čtení [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderLeft](./get_borderleft/)() | Vrací objekt vlastností levé ohraničující čáry. Pouze pro čtení [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderRight](./get_borderright/)() | Vrací objekt vlastností pravé ohraničující čáry. Pouze pro čtení [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderTop](./get_bordertop/)() | Vrací objekt vlastností horní ohraničující čáry. Pouze pro čtení [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Vrací objekt vlastností výplně buňky. Pouze pro čtení [IFillFormat](../ifillformat/). |
| virtual **float** [get_Transparency](./get_transparency/)() | Získává průhlednost výplňové barvy. Čte **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získává datovou strukturu čítače odkazů spojenou s objektem. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICellFormatEffectiveData](../icellformateffectivedata/)\> [GetEffective](./geteffective/)() | Získává efektivní vlastnosti formátování buňky tabulky s aplikovaným děděním a styly tabulky. |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | Nastavuje průhlednost výplňové barvy. Zapíše **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
