...
| virtual **bool** [IsLicensed](./islicensed/)() | Ověří, zda je licence použita na komponentu |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() výrazu. Vyvolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
| virtual void [ResetLicense](./resetlicense/)() | Resetuje licenci. |
| virtual void [SetLicense](./setlicense/)([System::String](../../system/string/)) | Zlicencuje komponentu. |
| virtual void [SetLicense](./setlicense/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Zlicencuje komponentu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() výrazu. Vyvolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
V tomto příkladu bude provedeno hledání licenčního souboru s názvem MyLicense.lic ve složce, která obsahuje komponentu, ve složce, která obsahuje volající sestavu, ve složce vstupní sestavy a poté v vložených zdrojích volající sestavy. 
```cpp
