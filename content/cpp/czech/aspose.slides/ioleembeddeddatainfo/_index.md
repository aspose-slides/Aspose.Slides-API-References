...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | Vrací data souboru vloženého OLE objektu Pouze pro čtení **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | Vrací příponu souboru pro aktuální vložený OLE objekt Pouze pro čtení [System::String](../../system/string/). |
