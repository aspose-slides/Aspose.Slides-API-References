...
| Metoda | Popis |
| --- | --- |
| virtual void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | Převádí tuto část na automaticky aktualizované pole. |
| virtual void [AddField](./addfield/)([System::String](../../system/string/)) | Převádí tuto část na automaticky aktualizované pole. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() | Vrací pole této části. Pouze pro čtení [IField](../ifield/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() | Vrací objekt formátování, který obsahuje výslovně nastavené vlastnosti formátování textové části bez použití dědičnosti. Pouze pro čtení [IPortionFormat](../iportionformat/). |
...
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Získá prostý text části. Čtení [System::String](../../system/string/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() | Získá souřadnice počátku části. Souřadnice X bodu představuje začátek části od prvního znaku včetně levého postranního odsazení. Souřadnice Y zahrnuje horní postranní odsazení. |
...
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | Získá souřadnice obdélníku ohraničujícího část. Obdélník zahrnuje všechny řádky textu v části, včetně prázdných. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analogie volání C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analogie operátoru C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle výrazu C# lock(). Volat přímo nebo použít objekt hlídky [LockContext](../../system/lockcontext/). |
...
| virtual void [RemoveField](./removefield/)() | Převádí tuto část pole na jednoduchou část. |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Nastavuje prostý text části. Zápis [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení podle výrazu C# lock(). Volat přímo nebo použít objekt hlídky [LockContext](../../system/lockcontext/). |
