...
| virtual [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() | Získává orientaci snímku. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Získává rozměry snímku v bodech. Při přiřazení nové hodnoty se hodnota [ISlideSize::get_Type](./get_type/) resetuje na [SlideSizeType::Custom](../slidesizetype/) a nastaví [ISlideSize::get_Orientation](./get_orientation/). |
| virtual [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() | Získává typ velikosti snímku. Při přiřazení libovolné hodnoty kromě [SlideSizeType::Custom](../slidesizetype/) se [ISlideSize::get_Size](./get_size/) upraví podle předdefinovaných rozměrů a současná [ISlideSize::get_Orientation](./get_orientation/) zůstane zachována. |
...
| virtual void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) | Nastavuje orientaci snímku. |
| virtual void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) | Nastavuje velikost snímku podle typu a škáluje existující obsah. Při přiřazení libovolné hodnoty jinou než [SlideSizeType::Custom](../slidesizetype/) se [ISlideSize::get_Size](./get_size/) upraví podle vybraného typu a zachová se [ISlideSize::get_Orientation](./get_orientation/). |
| virtual void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) | Nastavuje rozměry snímku explicitně a škáluje existující obsah. Tím se hodnota [ISlideSize::get_Type](./get_type/) resetuje na [SlideSizeType::Custom](../slidesizetype/) a nastaví [ISlideSize::get_Orientation](./get_orientation/). |
