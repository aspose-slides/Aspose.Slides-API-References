...
description: Representuje různé operace barev používané pro transformace barev. Neměnný objekt.
type: docs
weight: 352
...
Representuje různé operace barev používané pro transformace barev. Neměnný objekt.
...
| Metoda | Popis |
| --- | --- |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/)) | Vytvoří novou operaci transformace barev. |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/), **float**) | Vytvoří novou operaci transformace barev. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda jsou dvě instance [ColorOperation](./) stejné. |
...
| [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const override | Vrací typ operace. Pouze ke čtení [ColorTransformOperation](../colortransformoperation/). |
| **float** [get_Parameter](./get_parameter/)() override | Vrací parametr operace. Pouze ke čtení **float**. |
...
* Třída [IColorOperation](../icoloroperation/)
