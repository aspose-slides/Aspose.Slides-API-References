...
description: Správce hlavního podkladového snímku.
type: docs
weight: 2861
url: /cs/aspose.slides/imasterhandoutslidemanager/
---
## IMasterHandoutSlideManager třída

Správce hlavního podkladového snímku.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [get_MasterHandoutSlide](./get_masterhandoutslide/)() | Vrací master pro všechny poznámkové snímky této prezentace, pokud existuje, jinak vrací null. Pouze pro čtení [IMasterHandoutSlide](../imasterhandoutslide/). |
...
| virtual void [RemoveMasterHandoutSlide](./removemasterhandoutslide/)() | Odstraňuje hlavní podkladový snímek. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [SetDefaultMasterHandoutSlide](./setdefaultmasterhandoutslide/)() | Nastaví výchozí hlavní podkladový snímek na související podkladový snímek. |
