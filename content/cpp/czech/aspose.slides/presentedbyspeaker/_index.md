...
description: Prezentováno řečníkem (celá obrazovka)
type: docs
weight: 4902
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60539:1989 NaN není roven žádné hodnotě, včetně NaN. |
