...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetAnyHyperlinks](./getanyhyperlinks/)() override | Získá všechny podobjekty [IHyperlinkContainer](../ihyperlinkcontainer/), které obsahují nenull HyperlinkMouseOver. S daným objektem [IHyperlinkContainer](../ihyperlinkcontainer/) můžete spravovat jeho hyperodkaz (číst, aktualizovat nebo odstranit). Viz rozhraní [IHyperlinkContainer](../ihyperlinkcontainer/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkClicks](./gethyperlinkclicks/)() override | Získá všechny podobjekty [IHyperlinkContainer](../ihyperlinkcontainer/), které obsahují nenull HyperlinkClick. S daným objektem [IHyperlinkContainer](../ihyperlinkcontainer/) můžete spravovat jeho hyperodkaz (číst, aktualizovat nebo odstranit). Viz rozhraní [IHyperlinkContainer](../ihyperlinkcontainer/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkMouseOvers](./gethyperlinkmouseovers/)() override | Získá všechny podobjekty [IHyperlinkContainer](../ihyperlinkcontainer/), které obsahují nenull HyperlinkMouseOver. S daným objektem [IHyperlinkContainer](../ihyperlinkcontainer/) můžete spravovat jeho hyperodkaz (číst, aktualizovat nebo odstranit). Viz rozhraní [IHyperlinkContainer](../ihyperlinkcontainer/). |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analogie volání C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analogie operátoru C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [RemoveAllHyperlinks](./removeallhyperlinks/)() override | Odstraňuje všechny obsažené HyperlinkClick a HyperlinkMouseOver hyperodkazy (ve všech podobjektech [IHyperlinkContainer](../ihyperlinkcontainer/)). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock(). Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
* Třída [IHyperlinkQueries](../ihyperlinkqueries/)
