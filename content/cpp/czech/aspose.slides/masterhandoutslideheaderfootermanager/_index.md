...
description: Představuje správce, který obsahuje chování zástupných znaků hlavního podkladového snímku, včetně zástupného znaku hlavičky.
type: docs
weight: 4421
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Získá hodnotu indikující, že je přítomen zástupný znak data a času. Číst**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Získá hodnotu indikující, že je přítomen zástupný znak zápatí. Číst **bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | Získá hodnotu indikující, že je přítomen zástupný znak záhlaví. Číst **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Získá hodnotu indikující, že je přítomen zástupný znak čísla stránky. Číst**bool**. |
...
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | Mění viditelnost zástupného znaku data a času snímku. |
...
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | Nastaví text do zástupného znaku záhlaví snímku. |
| void [SetHeaderVisibility](../basehandoutnotesslideheaderfootermanager/setheadervisibility/)(**bool**) override | Mění viditelnost zástupného znaku záhlaví snímku. |
...
* Třída [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)
