...
| virtual **bool** [get_AdjustHandlesLocked](./get_adjusthandleslocked/)() | Určuje, zda je změna hodnot úpravy zakázána. Čtení **bool**. |
| virtual **bool** [get_ArrowheadsLocked](./get_arrowheadslocked/)() | Určuje, zda je změna šipek zakázána. Čtení **bool**. |
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | Určuje, zda má tvar zachovat poměr stran při změně velikosti. Čtení **bool**. |
| virtual **bool** [get_EditPointsLocked](./get_editpointslocked/)() | Určuje, zda je přímá změna kontury tohoto tvaru zakázána. Čtení **bool**. |
...
| virtual **bool** [get_PositionMove](./get_positionmove/)() | Určuje, zda je přesunutí tohoto tvaru zakázáno. Čtení **bool**. |
| virtual **bool** [get_RotateLocked](./get_rotatelocked/)() | Určuje, zda je změna úhlu otáčení tohoto tvaru zakázána. Čtení **bool**. |
...
| virtual void [set_AdjustHandlesLocked](./set_adjusthandleslocked/)(**bool**) | Určuje, zda je změna hodnot úpravy zakázána. Zápis **bool**. |
| virtual void [set_ArrowheadsLocked](./set_arrowheadslocked/)(**bool**) | Určuje, zda je změna šipek zakázána. Zápis **bool**. |
| virtual void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) | Určuje, zda má tvar zachovat poměr stran při změně velikosti. Zápis **bool**. |
| virtual void [set_EditPointsLocked](./set_editpointslocked/)(**bool**) | Určuje, zda je přímá změna kontury tohoto tvaru zakázána. Zápis **bool**. |
...
| virtual void [set_PositionMove](./set_positionmove/)(**bool**) | Určuje, zda je přesunutí tohoto tvaru zakázáno. Zápis **bool**. |
| virtual void [set_RotateLocked](./set_rotatelocked/)(**bool**) | Určuje, zda je změna úhlu otáčení tohoto tvaru zakázána. Zápis **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n'th template argument na slabý ukazatel (spíše než sdílený). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
| int [SharedCount](../../system/object/sharedcount/)() const | Získá aktuální hodnotu počítadla sdílených odkazů. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvětší počítadlo sdílených odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazem C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
