...
---
## IPictureFillFormatEffectiveData třída
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | Vrací počet procent skutečné výšky obrázku, které jsou oříznuty ze spodní části obrázku. Pouze pro čtení **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | Vrací počet procent skutečné šířky obrázku, které jsou oříznuty z levé strany obrázku. Pouze pro čtení **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | Vrací počet procent skutečné šířky obrázku, které jsou oříznuty z pravé strany obrázku. Pouze pro čtení **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | Vrací počet procent skutečné výšky obrázku, které jsou oříznuty z horní části obrázku. Pouze pro čtení **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | Vrací dpi, které se používá k vyplnění obrázku. Pouze pro čtení **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | Vrací obrázek. Pouze pro čtení [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | Vrací režim výplně obrázku. Pouze pro čtení [Slides::PictureFillMode](../picturefillmode/). |
