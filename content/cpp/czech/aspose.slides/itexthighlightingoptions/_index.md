...
description: Reprezentuje možnosti, které lze použít k zvýraznění textu v textovém rámci.
type: docs
weight: 4109
url: /cs/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions třída


Reprezentuje možnosti, které lze použít k zvýraznění textu v textovém rámci.
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Nastavte true pro použití citlivého na velikost písmen, false - jinak. Čtěte **bool**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Nastavte true pro shodu jen s celými slovy, false - jinak. Čtěte **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Nastavte true pro použití citlivého na velikost písmen, false - jinak. Zapište **bool**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Nastavte true pro shodu jen s celými slovy, false - jinak. Zapište **bool**. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje převádění vlastních objektů na řetězec. |
...
Zastaralé
:   Rozhraní [ITextHighlightingOptions](./) bude odstraněno po vydání verze 24.10.
