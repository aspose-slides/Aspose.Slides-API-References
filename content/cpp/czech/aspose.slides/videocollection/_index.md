...
Reprezentuje kolekci objektů [Video](../video/).
...
| Metoda | Popis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [AddVideo](./addvideo/)([System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>) override | Přidá kopii video souboru z jiné prezentace. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [AddVideo](./addvideo/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [LoadingStreamBehavior](../loadingstreambehavior/)) override | Vytvoří a přidá video do prezentace ze streamu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [AddVideo](./addvideo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Vytvoří a přaddá video do prezentace z pole bajtů. |
| [iterator](./iterator/) [begin](./begin/)() | Vrací iterátor ukazující na první prvek (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Vrací iterátor ukazující na první prvek (pokud existuje) const-kvalifikované instance kolekce. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Vrací iterátor ukazující na první const-kvalifikovaný prvek (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Vrací iterátor ukazující těsně za posledním const-kvalifikovaným prvkem (pokud existuje) kolekce. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>\>, **int32_t**) override | Zkopíruje videa do určeného pole počínaje určeným indexem. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Vrací iterátor ukazující těsně za posledním prvkem (pokud existuje) const-kvalifikované instance kolekce. |
...
| **int32_t** [get_Count](./get_count/)() override | Vrací počet video souborů v kolekci. Pouze pro čtení **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Vrací hodnotu určující, zda je přístup ke kolekci synchronizován (vláknově bezpečný). Pouze pro čtení **bool**. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Vrací datovou strukturu počitadla referencí spojenou s objektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který iteruje kolekcí. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [idx_get](./idx_get/)(**int32_t**) override | Vrací prvek na zadaném indexu. Pouze pro čtení [IVideo](../ivideo/). |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence vzestupně podle klíčových hodnot vybraných keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence sestupně podle klíčových hodnot vybraných keySelector. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, jen inicializuje nový objekt a umožňuje copy constructing podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, jen inicializuje nový objekt a umožňuje copy constructing podtříd. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý šablonový argument na weak ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do režimu weak. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Vrací iterátor ukazující na první prvek (pokud existuje) const-kvalifikované instance kolekce. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Vrací iterátor ukazující těsně za posledním prvkem (pokud existuje) const-kvalifikované instance kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Vrací iterátor ukazující těsně za posledním prvkem (pokud existuje) kolekce. |
