...
---
## IFontDataFactory třída


[FontData](../fontdata/) tovární rozhraní
...
| Metoda | Popis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [CreateFontData](./createfontdata/)([System::String](../../system/string/)) | Vytváří [FontData](../fontdata/) se specifikovaným názvem písma. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# výrazu lock(). Volá se přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic neskopíruje, pouze inicializuje nový objekt a umožňuje kopírování podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic neskopíruje, pouze inicializuje nový objekt a umožňuje kopírování podtříd. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# výrazu lock(). Volá se přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
