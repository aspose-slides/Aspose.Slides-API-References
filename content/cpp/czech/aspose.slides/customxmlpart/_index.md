...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání čísel s pohyblivou řádovou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání čísel s pohyblivou řádovou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() override | Určuje globálně unikátní identifikátor (GUID), který jednoznačně identifikuje jedinečnou vlastní XML část v dokumentu Office Open XML. Pouze pro čtení [System::Guid](../../system/guid/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() override | Vrací kolekci XML schémat, která jsou spojena s vlastní XML částí. Pouze pro čtení [System::String](../../system/string/)[]. |
| [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() override | Vrací data XML jako řetězec UTF-8. Pouze čtení [System::String](../../system/string/). |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() override | Vrací data XML. Pouze čtení **uint8_t**[]. |
...
| void [Remove](./remove/)() override | Odstraňuje vlastní XML část z prezentace. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Snižuje sdílený čítač referencí o zadanou hodnotu. |
| void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) override | Určuje globálně unikátní identifikátor (GUID), který jednoznačně identifikuje jedinečnou vlastní XML část v dokumentu Office Open XML. Pouze pro čtení [System::Guid](../../system/guid/). |
| void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) override | Nastavuje data XML jako řetězec UTF-8. Zápis [System::String](../../system/string/). |
| void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Nastavuje data XML. Zápis **uint8_t**[]. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# výrazu lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
