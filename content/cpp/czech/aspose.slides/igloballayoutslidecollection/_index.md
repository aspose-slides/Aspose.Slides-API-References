...
description: Reprezentuje kolekci všech rozložení snímků v prezentaci. Rozšiřuje rozhraní ILayoutSlideCollection metodami pro přidávání/klonování rozložení snímků v kontextu sjednocování jednotlivých kolekcí hlavního rozložení snímků.
type: docs
weight: 2367
url: /cs/aspose.slides/igloballayoutslidecollection/
---
## IGlobalLayoutSlideCollection třída

Reprezentuje kolekci všech rozložení snímků v prezentaci. Rozšiřuje rozhraní [ILayoutSlideCollection](../ilayoutslidecollection/) s metodami pro přidávání/klonování rozložení snímků v kontextu sjednocování jednotlivých kolekcí rozložení hlavního snímku.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Přidá nový snímek rozložení do prezentace. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Přidá kopii určeného snímku rozložení do prezentace. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Přidá kopii určeného snímku rozložení do prezentace. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Vrací hodnotu indikující, zda je přístup ke kolekci synchronizován (bezpečný pro vlákna). Pouze pro čtení **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | Vrací první snímek rozložení zadaného typu. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | Vrací snímek rozložení podle indexu. Pouze pro čtení [ILayoutSlide](../ilayoutslide/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamykání C# příkazem lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
...
| virtual void [Remove](../ilayoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Odstraní rozložení z kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| virtual void [RemoveUnused](../ilayoutslidecollection/removeunused/)() | Odstraní nepoužívané snímky rozložení (snímky rozložení, jejichž HasDependingSlides je false). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí C# příkazem lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
...
* Třída [ILayoutSlideCollection](../ilayoutslidecollection/)
