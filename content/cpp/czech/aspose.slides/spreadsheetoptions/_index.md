...
description: Reprezentuje možnosti, které lze použít k specifikaci dalšího chování tabulek.
type: docs
weight: 5266
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() override | Získá preferované informace o kultuře pro výpočet některých funkcí určených pro jazyky používající dvojbytovou znakovou sadu (DBCS). |
| **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() override | Pokud je zdroj dat pro graf externí sešit a není dostupný, bude obnoven z mezipaměti grafu. |
...
| void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) override | Nastaví preferované informace o kultuře pro výpočet některých funkcí určených pro jazyky používající dvojbytovou znakovou sadu (DBCS). |
| void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) override | Pokud je zdroj dat pro graf externí sešit a není dostupný, bude obnoven z mezipaměti grafu. |
...
|  [SpreadsheetOptions](./spreadsheetoptions/)() | Inicializuje novou instanci třídy [SpreadsheetOptions](./). |
...
* Třída [ISpreadsheetOptions](../ispreadsheetoptions/)
