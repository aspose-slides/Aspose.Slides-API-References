...
description: Reprezentuje vlastnosti formátu skic čar.
type: docs
weight: 5162
...
Representuje vlastnosti formátu skici čar.
...
| [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() override | Vrací typ skici. Pouze pro čtení [Slides::LineSketchType](../linesketchtype/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
| void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) override | Nastavuje typ skici. Zápis [Slides::LineSketchType](../linesketchtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
* Třída [ISketchFormat](../isketchformat/)
