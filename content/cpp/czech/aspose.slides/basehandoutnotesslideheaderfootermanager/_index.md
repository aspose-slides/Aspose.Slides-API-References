...
description: Representuje správce, který určuje chování zástupných symbolů, včetně zástupného symbolu záhlaví pro všechny typy výtisků a poznámkových snímků.
type: docs
weight: 118
...
Representuje správce, který určuje chování zástupných symbolů, včetně záhlaví pro všechny typy výtisků a poznámkových snímků.
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Získá hodnotu indikující, že je přítomen zástupný symbol data a času. Read**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Získá hodnotu indikující, že je přítomen zástupný symbol zápatí. Read **bool**. |
| **bool** [get_IsHeaderVisible](./get_isheadervisible/)() override | Získá hodnotu indikující, že je přítomen zástupný symbol záhlaví. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Získá hodnotu indikující, že je přítomen zástupný symbol čísla stránky. Read**bool**. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Nastaví text do zástupného symbolu data a času snímku. |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | Mění viditelnost zástupného symbolu data a času snímku. |
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | Nastaví text do zástupného symbolu zápatí snímku. |
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | Mění viditelnost zástupného symbolu zápatí snímku. |
| void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) override | Nastaví text do zástupného symbolu záhlaví snímku. |
| void [SetHeaderVisibility](./setheadervisibility/)(**bool**) override | Mění viditelnost zástupného symbolu záhlaví snímku. |
| void [SetSlideNumberVisibility](../baseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) override | Mění viditelnost zástupného symbolu čísla stránky snímku. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# příkazu lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
