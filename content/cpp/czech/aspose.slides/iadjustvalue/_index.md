...
description: Reprezentuje hodnotu úpravy geometrického tvaru. Tyto hodnoty ovlivňují tvar.
type: docs
weight: 1288
...
Představuje hodnotu úpravy geometrického tvaru. Tyto hodnoty ovlivňují tvar.
...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Vrací hodnotu, interpretovanou jako úhel ve stupních. Čte **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Vrací název této hodnoty úpravy. Pouze ke čtení [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Vrací hodnotu úpravy „tak, jak je“. Čte **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Vrací typ úpravy tvaru. Pouze ke čtení [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Nastavuje hodnotu, interpretovanou jako úhel ve stupních. Zapíše **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Nastavuje hodnotu úpravy „tak, jak je“. Zapíše **int64_t**. |
