...
type: docs
weight: 5305
url: /cs/aspose.slides/stylecoloreffectivedata/
---
## StyleColorEffectiveData třída
...
| [System::SharedPtr](../../system/sharedptr/)\<[ColorFormat](../colorformat/)\> [get_StyleColorFormatUnresolved](./get_stylecolorformatunresolved/)() | StyleColorFormatUnresolved. Pouze pro čtení [ColorFormat](../colorformat/). |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Analogie metody C# Object.GetHashCode(). Umožňuje hašování vlastních objektů. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Volá se přímo nebo se použije hlídkový objekt [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock(). Volá se přímo nebo se použije hlídkový objekt [LockContext](../../system/lockcontext/). |
