...
description: Představuje objekt s možností hromadného nastavování formátů podřízených textových prvků.
type: docs
weight: 1548
url: /cs/aspose.slides/ibulktextformattable/
---
## IBulkTextFormattable třída
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() výrazu. Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Nastaví definované vlastnosti formátu úseku na všechny úseky elementu. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Nastaví definované vlastnosti formátu odstavce na všechny odstavce elementu. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Nastaví definované vlastnosti formátu textového rámce na všechny textové rámce elementu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock() výrazu. Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
