...
description: Reprezentuje kolekci substitucí fontů.
type: docs
weight: 2289
url: /cs/aspose.slides/ifontsubstrulecollection/
---
## IFontSubstRuleCollection třída

Reprezentuje kolekci substitucí fontů.
...
| Method | Popis |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\>) | Přidá nové pravidlo substituce fontu do kolekce |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Vrací hodnotu, která uvádí, zda je přístup ke kolekci synchronizován (vláknově bezpečný). Pouze pro čtení **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\> [idx_get](./idx_get/)(**int32_t**) | Získá prvek na zadaném indexu. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\>) | Odstraní první výskyt konkrétního objektu z kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonový argument jako slabý ukazatel (na rozdíl od sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
