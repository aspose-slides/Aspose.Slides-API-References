...
| Metoda | Popis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AddEmptySection](./addemptysection/)([System::String](../../system/string/), **int32_t**) | Přidá prázdnou sekci na určenou pozici kolekce. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AddSection](./addsection/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | Přidá novou sekci zahájenou ze specifického snímku. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [AppendEmptySection](./appendemptysection/)([System::String](../../system/string/)) | Přidá prázdnou sekci na konec kolekce. |
...
| virtual void [Clear](./clear/)() | Odstraní všechny sekce z kolekce. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Vrací hodnotu indikující, zda je přístup ke kolekci synchronizován (vláknově bezpečný). Pouze ke čtení **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [idx_get](./idx_get/)(**int32_t**) | Získá prvek na zadaném indexu. Pouze ke čtení [ISection](../isection/). |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Vrací index zadané sekce v kolekci. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtruje sekvenci na základě zadané podmínky. |
...
| virtual void [RemoveSection](./removesection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Odstraní sekci. [Slides](../) obsažená v sekci bude sloučena do předchozí sekce. |
| virtual void [RemoveSectionWithSlides](./removesectionwithslides/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Odstraní sekci a snímky obsažené v sekci. |
| virtual void [ReorderSectionWithSlides](./reordersectionwithslides/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>, **int32_t**) | Přesune sekci a její snímky z kolekce na určenou pozici. |
