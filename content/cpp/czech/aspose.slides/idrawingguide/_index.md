...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Vrací barvu kreslicího vodítka. Číst [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Vrací orientaci kreslicího vodítka. Číst [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Vrací pozici kreslicího vodítka v bodech od levého horního rohu snímku. Číst **float**. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Nastaví barvu kreslicího vodítka. Zapsat [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Nastaví orientaci kreslicího vodítka. Zapsat [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Nastaví pozici kreslicího vodítka v bodech od levého horního rohu snímku. Zapsat **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání dle C# lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
