...
description: "Obsahuje pole barev a pozic používaných k interpolaci míchání barev ve vícebarevném gradientu. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject() . Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání do funkcí jako argument."
type: docs
weight: 27
url: /cs/system.drawing.drawing2d/colorblend/
---
## ColorBlend class


Obsahuje pole barev a pozic používaných k interpolaci míchání barev ve vícebarevném gradientu. Objektů této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
...
| Metoda | Popis |
| --- | --- |
|  [ColorBlend](./colorblend/)() | Vytvoří novou instanci třídy [ColorBlend](./). |
|  [ColorBlend](./colorblend/)(int) | Vytvoří novou instanci třídy [Blend](../blend/). |
...
| [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Colors](./get_colors/)() | Vrací pole barev, které se použijí na odpovídajících pozicích podél gradientu. |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() | Vrací pole pozic míchání podél gradientu. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje konstrukci kopií pro podtřídy. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje konstrukci kopií pro podtřídy. |
...
| void [set_Colors](./set_colors/)(const [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\>\&) | Nastaví pole barev, které se použijí na odpovídajících pozicích podél gradientu. |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Nastaví pole pozic míchání podél gradientu. |
