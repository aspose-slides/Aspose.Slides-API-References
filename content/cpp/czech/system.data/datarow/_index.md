...
description: "Řádek v datové sadě. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předávání jako argument funkcím."
type: docs
weight: 53
url: /cs/system.data/datarow/
---
## DataRow třída


Řádek v datové sadě. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předávání jako argument funkcím.
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataTable](../datatable/)\> [get_Table](./get_table/)() | Získá řádek tabulky, ke kterému patří. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataRow](./)\>\> [GetChildRows](./getchildrows/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataRelation](../datarelation/)\>\&) | Získá řádky, které jsou považovány za podřazené podle zadaného vztahu. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(const **int32_t**) | Informace RTTI. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání dle C# příkazu lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentinel objekt. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony na slabý ukazatel (spíše než sdílený). Umožňuje přepnout ukazatele v kontejnerech do slabého režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání příkazu C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentinel objekt. |
