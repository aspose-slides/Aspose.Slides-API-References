...
description: "Specifikuje SOAP hlavičku, kterou může zpracovat metoda XML webové služby nebo klient XML webové služby. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to může vést k chybám za běhu a/nebo selháním asertí. Vždy obalte tuto třídu ukazatelem System::SmartPtr a použijte tento ukazatel k předání jako argumentu funkcím."
type: docs
weight: 92
url: /cs/system.web.services.protocols/soapheaderattribute/
---
...
| [SoapHeaderDirection](../soapheaderdirection/) [get_Direction](./get_direction/)() | Získá směr SOAP hlavičky. |
| [String](../../system/string/) [get_MemberName](./get_membername/)() | Získá název členné proměnné XML SOAP služby, která se používá k přijímání obsahu SOAP hlavičky. |
| **bool** [get_Required](./get_required/)() | Získá hodnotu, která určuje, zda musí být SOAP hlavička pochopena a zpracována příjemcem XML [Web](../../system.web/) služby nebo XML [Web](../../system.web/) klienta služby. |
...
| void [set_Direction](./set_direction/)([SoapHeaderDirection](../soapheaderdirection/)) | Nastaví směr SOAP hlavičky. |
| void [set_MemberName](./set_membername/)([String](../../system/string/)) | Nastaví název členné proměnné XML SOAP služby, která se používá k přijímání obsahu SOAP hlavičky. |
| void [set_Required](./set_required/)(**bool**) | Nastaví hodnotu, která určuje, zda musí být SOAP hlavička pochopena a zpracována příjemcem XML [Web](../../system.web/) služby nebo XML [Web](../../system.web/) klienta služby. |
...
| [SoapHeaderAttribute](./soapheaderattribute/)([String](../../system/string/)) | Vytvoří novou instanci. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí C# výrazu lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
