...
description: "Reprezentuje obsah SOAP hlavičky. Objektům této třídy by mělo být přidělováno paměti pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože by to vedlo k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 79
url: /cs/system.web.services.protocols/soapheader/
---
## SoapHeader třída

Reprezentuje obsah SOAP hlavičky. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním assercí. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
...
| [String](../../system/string/) [get_Actor](./get_actor/)() | Získá URI příjemce SOAP hlavičky při použití verze SOAP 1.1. |
| **bool** [get_DidUnderstand](./get_didunderstand/)() | Získá hodnotu, která indikuje, zda je SOAP hlavička řádně zpracována. |
| [String](../../system/string/) [get_EncodedMustUnderstand](./get_encodedmustunderstand/)() | Získá hodnotu atributu 'mustUnderstand' při použití verze SOAP 1.1. |
| [String](../../system/string/) [get_EncodedMustUnderstand12](./get_encodedmustunderstand12/)() | Získá hodnotu atributu 'mustUnderstand' při použití verze SOAP 1.2. |
| [String](../../system/string/) [get_EncodedRelay](./get_encodedrelay/)() | Získá řetězcovou reprezentaci hodnoty atributu 'relay'. |
| **bool** [get_MustUnderstand](./get_mustunderstand/)() | Získá hodnotu, která indikuje, zda musí být SOAP hlavička rozuměna. |
| **bool** [get_Relay](./get_relay/)() | Získá hodnotu atributu 'relay'. |
| [String](../../system/string/) [get_Role](./get_role/)() | Získá URI příjemce SOAP hlavičky při použití verze SOAP 1.2. |
...
| void [set_Actor](./set_actor/)([String](../../system/string/)) | Nastaví URI příjemce SOAP hlavičky při použití verze SOAP 1.1. |
| void [set_DidUnderstand](./set_didunderstand/)(**bool**) | Nastaví hodnotu, která indikuje, zda je SOAP hlavička řádně zpracována. |
| void [set_EncodedMustUnderstand](./set_encodedmustunderstand/)([String](../../system/string/)) | Nastaví hodnotu atributu 'mustUnderstand' při použití verze SOAP 1.1. |
| void [set_EncodedMustUnderstand12](./set_encodedmustunderstand12/)([String](../../system/string/)) | Nastaví hodnotu atributu 'mustUnderstand' při použití verze SOAP 1.2. |
| void [set_EncodedRelay](./set_encodedrelay/)([String](../../system/string/)) | Nastaví řetězcovou reprezentaci hodnoty atributu 'relay'. |
| void [set_MustUnderstand](./set_mustunderstand/)(**bool**) | Nastaví hodnotu, která indikuje, zda musí být SOAP hlavička rozuměna. |
| void [set_Relay](./set_relay/)(**bool**) | Nastaví hodnotu atributu 'relay'. |
| void [set_Role](./set_role/)([String](../../system/string/)) | Nastaví URI příjemce SOAP hlavičky při použití verze SOAP 1.2. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonový parametr jako slabý ukazatel (namísto sdíleného). Umožňuje přepnout ukazatele v kontejnerech do slabého režimu. |
...
|  [SoapHeader](./soapheader/)([System::SharedPtr](../../system/sharedptr/)\<[Xml::XmlElement](../../system.xml/xmlelement/)\>) | Vytvoří novou instanci. |
