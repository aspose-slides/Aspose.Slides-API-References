...
description: "Instanci této třídy se předává jako argument delegátu InvokeCompletedEventHandler. Objektům této třídy by se mělo alokovat pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserci. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 27
url: /cs/system.web.services.protocols/invokecompletedeventargs/
---
## InvokeCompletedEventArgs třída

Instance této třídy je předána jako argument delegátu InvokeCompletedEventHandler. Objektům této třídy by se mělo alokovat pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserci. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
|  [AsyncCompletedEventArgs](../../system.componentmodel/asynccompletedeventargs/asynccompletedeventargs/)(const [System::Exception](../../system/exception/)\&, **bool**, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Inicializuje novou instanci třídy [System.ComponentModel.AsyncCompletedEventArgs](../../system.componentmodel/asynccompletedeventargs/). |
...
| **bool** [get_Cancelled](../../system.componentmodel/asynccompletedeventargs/get_cancelled/)() const | Získá hodnotu, která udává, zda byla asynchronní operace zrušena. true, pokud byla operace na pozadí zrušena; jinak false. Výchozí hodnota je false. |
| const [System::Exception](../../system/exception/)\& [get_Error](../../system.componentmodel/asynccompletedeventargs/get_error/)() const | Získá hodnotu, která udává, která chyba nastala během asynchronní operace. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [get_Results](./get_results/)() | Vrací kolekci výsledků asynchronní operace. |
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_UserState](../../system.componentmodel/asynccompletedeventargs/get_userstate/)() const | Získá jedinečný identifikátor asynchronního úkolu. Odkaz na objekt, který jedinečně identifikuje asynchronní úkol; jinak null, pokud nebyla nastavena žádná hodnota. |
...
|  [InvokeCompletedEventArgs](./invokecompletedeventargs/)([Exception](../../system/exception/), **bool**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>) | Vytvoří novou instanci. |
...
| Field | Description |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statický člen, který představuje „prázdný“ sdílený ukazatel [EventArgs](../../system/eventargs/) (null-ukazatel). |

## Viz také

* Třída [AsyncCompletedEventArgs](../../system.componentmodel/asynccompletedeventargs/)
