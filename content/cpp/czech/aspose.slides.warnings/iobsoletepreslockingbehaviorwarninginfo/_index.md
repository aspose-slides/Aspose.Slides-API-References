...
description: Toto varování indikuje, že je použito zastaralé chování zamykání prezentace.
type: docs
weight: 27
url: /cs/aspose.slides.warnings/iobsoletepreslockingbehaviorwarninginfo/
---
## IObsoletePresLockingBehaviorWarningInfo třída

Toto varování naznačuje, že je použito zastaralé chování uzamykání prezentace.
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Pokud není přijímač null, ukončí varování pro zadaný přijímač a vyhodí výjimku AbortRequestedException, pokud se přijímač rozhodl operaci přerušit. |
