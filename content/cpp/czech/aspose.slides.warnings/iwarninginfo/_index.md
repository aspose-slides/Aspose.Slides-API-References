...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Vrací lidsky čitelný popis tohoto varování. Pouze pro čtení [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Vrací typ varování. Pouze pro čtení [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Pokud příjemce není null, ukončí varování k určenému příjemci a vyhodí výjimku AbortRequestedException, pokud se příjemce rozhodl operaci přerušit. |
...
| virtual  [~Object](../../system/object/~object/)() | Zniči objekt. Uvolní všechny interní datové struktury. |
