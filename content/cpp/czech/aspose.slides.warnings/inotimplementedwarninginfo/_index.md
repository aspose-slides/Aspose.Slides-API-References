...
---
## INotImplementedWarningInfo třída
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Pokud není příjemce null, ukončí varování pro zadaného příjemce a vyhodí výjimku AbortRequestedException, pokud se příjemce rozhodl operaci přerušit. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí výrazu C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
