...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle C# lock() výrazu. Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Pokud není příjemce null, ukončí varování určenému příjemci a vyhodí AbortRequestedException, pokud se příjemce rozhodne operaci přerušit. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení podle C# lock() výrazu. Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
