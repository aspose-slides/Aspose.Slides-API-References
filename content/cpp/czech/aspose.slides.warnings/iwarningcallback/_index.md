...
| virtual [ReturnAction](../returnaction/) [Warning](./warning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningInfo](../iwarninginfo/)\>) | Metoda zpětného volání, která přijímá varování a rozhoduje, zda má být operace přerušena. |
