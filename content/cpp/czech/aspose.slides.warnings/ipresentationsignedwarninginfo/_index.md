...
---
## IPresentationSignedWarningInfo třída
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Vrací lidsky čitelný popis tohoto varování. Pouze pro čtení [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Vrací typ varování. Pouze pro čtení [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Pokud není příjemce null, ukončí varování pro zadaného příjemce a vyhodí AbortRequestedException, pokud příjemce rozhodne operaci zrušit. |
