...
description: IMathElement s vlastnostmi řídicích znaků
type: docs
weight: 14
url: /cs/aspose.slides.mathtext/ihascontrolcharacterproperties/
---
## IHasControlCharacterProperties třída


[IMathElement](../imathelement/) s [Control](../../aspose.slides/control/) Character Properties
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# lock() výrazu. Zavolejte přímo nebo použijte strážní objekt [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí podle C# lock() výrazu. Volá se přímo nebo použijte strážní objekt [LockContext](../../system/lockcontext/). |
