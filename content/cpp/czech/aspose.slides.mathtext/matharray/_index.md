...
Specifikuje vertikální pole rovnic nebo libovolných matematických objektů
...
| Metoda | Popis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | Nastavuje diakritický znak (znak na vrcholu tohoto prvku) |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Přijímá zadanou funkci s touto instancí jako argument a určený dodatečný argument |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | Přijímá zadanou funkci s touto instancí jako argument a určený dodatečný argument |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) override | Vytvoří zlomek daného typu s tímto čitatelem a určeným jmenovatelem |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) override | Vytvoří zlomek daného typu s tímto čitatelem a určeným jmenovatelem |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)() override | Obaluje matematický prvek do závorek |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Obaluje matematický prvek ve specifikovaných znacích, jako jsou závorky nebo jiné znaky |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) override | Vrací prvek na zadaném indexu pole. Pouze pro čtení [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() override | Množina položek pole |
| [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() override | Určuje zarovnání pole vzhledem k okolnímu textu. Text mimo pole může být zarovnán ke spodku, vrcholu nebo středu objektu pole. Výchozí hodnota: Střed |
| **bool** [get_MaximumDistribution](./get_maximumdistribution/)() override | Maximální rozložení. Když je true, pole je rozprostřeno na maximální šířku obsahujícího prvku (stránka, sloupec, buňka atd.). |
| **bool** [get_ObjectDistribution](./get_objectdistribution/)() override | Rozložení objektu. Když je true, obsah pole je rozprostřen na maximální šířku objektu pole. |
| **uint32_t** [get_RowSpacing](./get_rowspacing/)() override | Mezery mezi řádky pole. Používá se jen když je RowSpacingRule nastaveno na 3 Exactly, v takovém případě je jednotkou měření body, nebo Multiple, v takovém případě je jednotkou měření půlčáry. Výchozí: 0 |
| [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() override | Typ vertikálního odsazení mezi prvky pole. Výchozí: SingleLineGap |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../mathelementbase/join/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Spojuje matematický prvek a vytváří matematický blok |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../mathelementbase/join/)([System::String](../../system/string/)) override | Spojuje matematický text a vytváří matematický blok |
...
|  [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Vytvoří matematické pole a umístí do něj zadaný prvek |
|  [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>\>) | Vytvoří matematické pole a umístí do něj zadané prvky |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../mathelementbase/overbar/)() override | Nastaví pruh na horní část tohoto prvku |
...
| void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) override | Určuje zarovnání pole vzhledem k okolnímu textu. Text mimo pole může být zarovnán ke spodku, vrcholu nebo středu objektu pole. Výchozí hodnota: Střed |
| void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) override | Maximální rozložení. Když je true, pole je rozprostřeno na maximální šířku obsahujícího prvku (stránka, sloupec, buňka atd.). |
| void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) override | Rozložení objektu. Když je true, obsah pole je rozprostřen na maximální šířku objektu pole. |
| void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) override | Mezery mezi řádky pole. Používá se jen když je RowSpacingRule nastaveno na 3 Exactly, v takovém případě je jednotkou měření body, nebo Multiple, v takovém případě je jednotkou měření půlčáry. Výchozí: 0 |
| void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) override | Typ vertikálního odsazení mezi prvky pole. Výchozí: SingleLineGap |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony na slabý ukazatel (místo sdíleného). Umožňuje přepínat ukazatele v kontejnerech do režimu slabého ukazatele. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)() override | Umístí tento prvek do rámečkové schránky. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | Umístí tento prvek do rámečkové schránky. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Umístí tento prvek do neviditelné schránky (logické seskupení), která slouží k seskupení komponent rovnice nebo jiné instance matematického textu. Schránkový objekt může (například) sloužit jako emulátor operátoru s nebo bez zarovnávacího bodu, jako bod zalomení řádku nebo být seskupen tak, aby neumožňoval zalomení řádků uvnitř. |
