...
| Metoda | Popis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathParagraph](../imathparagraph/)\> [CreateMathParagraph](./createmathparagraph/)() | Vytvoří prázdný matematický odstavec |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathParagraph](../imathparagraph/)\> [CreateMathParagraph](./createmathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Vytvoří matematický odstavec a umístí do něj zadaný matematický blok |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počitadla referencí přiřazenou k objektu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí výrazu C# lock(). Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí výrazu C# lock(). Volá se přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
