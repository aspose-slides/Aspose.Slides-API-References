...
| Metoda | Popis |
| --- | --- |
| virtual void [Add](../imathblockcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Přidá [IMathBlock](../imathblock/) na konec kolekce. |
...
| virtual void [Clear](../imathblockcollection/clear/)() | Odstraní všechny prvky z kolekce. |
| virtual **bool** [Contains](../imathblockcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Určuje, zda kolekce obsahuje konkrétní hodnotu. |
...
| virtual **int32_t** [get_Count](../imathblockcollection/get_count/)() | Získá počet skutečně obsažených prvků v kolekci. Pouze pro čtení **int32_t**. |
| virtual [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() | [Paragraph](../../aspose.slides/paragraph/) Zarovnání Výchozí hodnota: CenteredAsGroup |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](../imathblockcollection/idx_get/)(**int32_t**) | Získá položku na zadaném indexu. Pouze pro čtení [IMathBlock](../imathblock/). |
| virtual void [idx_set](../imathblockcollection/idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Získá položku na zadaném indexu. Pouze pro čtení [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](../imathblockcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Určuje index konkrétního [IMathBlock](../imathblock/) v kolekci. |
| virtual void [Insert](../imathblockcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Vloží [IMathBlock](../imathblock/) do kolekce na zadaném indexu. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Zavolá transformační funkci na každý prvek generické sekvence a vrátí maximální vzniklou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Zavolá transformační funkci na každý prvek generické sekvence a vrátí minimální vzniklou hodnotu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje C# lock() příkaz zamykání. Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [Remove](../imathblockcollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Odstraní první výskyt konkrétního objektu z kolekce/>. |
| virtual void [RemoveAt](../imathblockcollection/removeat/)(**int32_t**) | Odstraní položku na zadaném indexu kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač odkazů o zadanou hodnotu. |
| virtual void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) | [Paragraph](../../aspose.slides/paragraph/) Zarovnání Výchozí hodnota: CenteredAsGroup |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvýší sdílený čítač odkazů. Nemělo by se volat přímo; použijte chytrý ukazatel nebo ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Sníží a vrátí sdílený čítač odkazů. Nemělo by se volat přímo; použijte chytrý ukazatel nebo ThisProtector. |
| virtual [System::String](../../system/string/) [ToLatex](./tolatex/)() | Získá matematickou rovnici ve formátu LaTeX |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje C# lock() příkaz odemčení. Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvýší slabý čítač odkazů. Nemělo by se volat přímo; použijte chytrý ukazatel nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Sníží slabý čítač odkazů. Nemělo by se volat přímo; použijte chytrý ukazatel nebo ThisProtector. |
| virtual void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Uloží obsah tohoto [IMathParagraph](./) jako MathML |
...
* Třída [IMathBlockCollection](../imathblockcollection/)
