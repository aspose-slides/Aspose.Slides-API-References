...
| Metoda | Popis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | Nastaví znaménko diakritiky (znak na horní části tohoto prvku) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Přijímá zadanou funkci s touto instancí jako argument a s určeným dalším argumentem |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | Přijímá zadanou funkci s touto instancí jako argument a s určeným dalším argumentem |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Vytvoří zlomek s tímto čitatel a zadaným jmenovatelem |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::String](../../system/string/)) | Vytvoří zlomek s tímto čitatel a zadaným jmenovatelem |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | Vytvoří zlomek určeného typu s tímto čitatel a zadaným jmenovatelem |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) | Vytvoří zlomek určeného typu s tímto čitatel a zadaným jmenovatelem |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Obalí tento prvek určenými znaky, například závorkami nebo jinými znaky jako rámeček |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) | Vrací položku na zadaném indexu pole. Pouze ke čtení [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() | Množina položek pole |
| virtual [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() | Určuje zarovnání pole vzhledem k okolnímu textu. Text mimo pole může být zarovnán na spodní, horní nebo střed pole. Výchozí hodnota: Střed |
| virtual **bool** [get_MaximumDistribution](./get_maximumdistribution/)() | Maximální rozložení. Když je true, pole je rozprostřeno na maximální šířku obsahujícího elementu (stránka, sloupec, buňka atd.). |
| virtual **bool** [get_ObjectDistribution](./get_objectdistribution/)() | Rozložení objektu. Když je true, obsah pole je rozprostřen na maximální šířku objektu pole. |
| virtual **uint32_t** [get_RowSpacing](./get_rowspacing/)() | Mezery mezi řádky pole. Používá se jen když je RowSpacingRule nastaveno na 3 Exactly, v takovém případě je jednotkou měření body nebo Multiple, kde jednotkou jsou půl řádky. Výchozí: 0 |
| virtual [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() | Typ vertikálního rozestupu mezi prvky pole |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/)) | Přijímá integrál bez limitů |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Neprovádí skutečné kopírování, pouze inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Neprovádí skutečné kopírování, pouze inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../imathelement/overbar/)() | Nastaví čáru nad tímto prvkem |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Určuje matematický kořen daného řádu z uvedeného argumentu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Určuje matematický kořen daného řádu z uvedeného argumentu. |
...
| virtual void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) | Určuje zarovnání pole vzhledem k okolnímu textu. Text mimo pole může být zarovnán na spodní, horní nebo střed pole. Výchozí hodnota: Střed |
| virtual void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) | Maximální rozložení. Když je true, pole je rozprostřeno na maximální šířku obsahujícího elementu (stránka, sloupec, buňka atd.). |
| virtual void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) | Rozložení objektu. Když je true, obsah pole je rozprostřen na maximální šířku objektu pole. |
| virtual void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) | Mezery mezi řádky pole. Používá se jen když je RowSpacingRule nastaveno na 3 Exactly, v takovém případě je jednotkou měření body nebo Multiple, kde jednotkou jsou půl řádky. Výchozí: 0 |
| virtual void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) | Typ vertikálního rozestupu mezi prvky pole |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Přijímá spodní limit |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::String](../../system/string/)) | Přijímá spodní limit |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLeftSubSuperscriptElement](../imathleftsubsuperscriptelement/)\> [SetSubSuperscriptOnTheLeft](../imathelement/setsubsuperscriptontheleft/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Vytvoří dolní i horní index vlevo |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLeftSubSuperscriptElement](../imathleftsubsuperscriptelement/)\> [SetSubSuperscriptOnTheLeft](../imathelement/setsubsuperscriptontheleft/)([System::String](../../system/string/), [System::String](../../system/string/)) | Vytvoří dolní i horní index vlevo |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](../imathrightsubsuperscriptelement/)\> [SetSubSuperscriptOnTheRight](../imathelement/setsubsuperscriptontheright/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Vytvoří dolní i horní index vpravo |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](../imathrightsubsuperscriptelement/)\> [SetSubSuperscriptOnTheRight](../imathelement/setsubsuperscriptontheright/)([System::String](../../system/string/), [System::String](../../system/string/)) | Vytvoří dolní i horní index vpravo |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Přijímá horní limit |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::String](../../system/string/)) | Přijímá horní limit |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](./)\> [ToMathArray](../imathelement/tomatharray/)() | Umístí do vertikálního pole |
