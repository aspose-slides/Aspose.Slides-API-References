...
description: "Přidává další informace do služby XML Web. Objektům této třídy by mělo být alokováno pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k běhovým chybám a/nebo selháním aserce. Vždy obalte tuto třídu ukazatelem System::SmartPtr a použijte tento ukazatel k předání do funkcí jako argument."
type: docs
weight: 27
url: /cs/system.web.services/webserviceattribute/
---
## WebServiceAttribute třída

Přidává další informace do služby XML [Web](../../system.web/). Objektům této třídy by se mělo alokovat pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operator new, protože to povede k běhovým chybám a/nebo chybám aserce. Vždy zabaľte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
...
| [String](../../system/string/) [get_Description](./get_description/)() | Získá zprávu, která obsahuje popis služby XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Name](./get_name/)() | Získá název služby XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Získá výchozí jmenný prostor pro službu XML [Web](../../system.web/). |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | Nastaví zprávu obsahující popis služby XML [Web](../../system.web/). |
| void [set_Name](./set_name/)([String](../../system/string/)) | Nastaví název služby XML [Web](../../system.web/). |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Nastaví výchozí jmenný prostor pro službu XML [Web](../../system.web/). |
...
|  [WebServiceAttribute](./webserviceattribute/)() | Vytvoří novou instanci. |
...
| Pole | Popis |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | Výchozí hodnota vlastnosti 'Namespace'. |
