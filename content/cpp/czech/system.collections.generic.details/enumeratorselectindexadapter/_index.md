...
type: docs
weight: 92
url: /cs/system.collections.generic.details/enumeratorselectindexadapter/
---
## EnumeratorSelectIndexAdapter třída
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Provede první volání [MoveNext()](../../system.collections.generic/ienumerator/movenext/) a připraví objekt enumerátoru pro použití třídou VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analogie operátoru C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle příkazu C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentry object. |
...
| **bool** [MoveNext](./movenext/)() override | Posune enumerátor na další prvek. Pokud nebyl předtím žádný prvek referencován, nastaví referenci na první dostupný prvek. Pokud byl dosažen konec kontejneru, nedělá nic. |
...
| void [Reset](./reset/)() override | Resetuje enumerátor na pozici před prvním prvkem. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení podle příkazu C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentry object. |
