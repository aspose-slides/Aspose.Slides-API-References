...
description: Enumerátor používaný rozšířením IEnumerable.OfType().
type: docs
weight: 66
url: /cs/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter třída

Enumerátor používaný rozšířením IEnumerable.OfType().
...
| Metoda | Popis |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Připraví iterátor pro použití třídou VirtualizedIterator. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání dvojité přesnosti ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Provede první volání [MoveNext()](../../system.collections.generic/ienumerator/movenext/) a připraví objekt enumerátoru pro použití VirtualizedIterator. |
...
| **bool** [MoveNext](./movenext/)() override | Posune enumerátor na další prvek. Pokud předtím nebyl žádný prvek referencován, nastaví referenci na první dostupný prvek. Pokud byl dosažen konec kontejneru, nedělá nic. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý parametr šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
