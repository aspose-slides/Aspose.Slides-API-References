...
type: docs
weight: 105
url: /cs/system.collections.generic.details/enumeratorselectmanyadapter/
---
## EnumeratorSelectManyAdapter třída
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání klouzavých čísel ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání klouzavých čísel ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| **bool** [MoveNext](./movenext/)() override | Posune enumerátor na další prvek. Pokud předtím nebyl žádný prvek referencován, nastaví odkaz na první dostupný prvek. Pokud byl dosažen konec kontejneru, nedělá nic. |
|  [Object](../../system/object/object/)() | Vytvoří objekt. Inicializuje všechny vnitřní datové struktury. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiovací konstruktor. Vlastně nic nekopíruje, jen inicializuje nový objekt a umožňuje kopírování konstruktorů podtříd. |
...
| void [Reset](./reset/)() override | Resetuje enumerátor do pozice před první prvek. |
