...
description: Enumerator používaný metodou rozšíření IEnumerable.Select().
type: docs
weight: 79
url: /cs/system.collections.generic.details/enumeratorselectadapter/
---
## EnumeratorSelectAdapter třída

Enumerator používaný metodou rozšíření IEnumerable.Select().
...
| Parametr | Popis |
| --- | --- |
| Source | Typ zdrojových prvků kolekce. |
| Result | Typ výsledných prvků kolekce. |
## Metody
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Posune iterátor o krok vpřed. |
...
| void [Reset](./reset/)() override | Resetuje enumerátor do pozice před prvním prvkem. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvýší sdílený čítač odkazů. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvýší slabý čítač odkazů. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
