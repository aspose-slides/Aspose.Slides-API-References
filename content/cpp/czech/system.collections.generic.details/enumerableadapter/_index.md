...
description: Enumerable používaný metodami rozšíření IEnumerable.Cast() a IEnumerable.OfType().
type: docs
weight: 1
url: /cs/system.collections.generic.details/enumerableadapter/
---
## EnumerableAdapter třída

Enumerable použitý metodami rozšíření IEnumerable.Cast() a IEnumerable.OfType().
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<Result\>\> [GetEnumerator](./getenumerator/)() override | Získá enumerátor. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zámek (lock()) v C#. Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí (unlock()) v C#. Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
