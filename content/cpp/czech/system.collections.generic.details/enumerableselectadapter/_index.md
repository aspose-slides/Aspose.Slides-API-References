...
description: Enumerable používaný metodou rozšíření IEnumerable.Select().
type: docs
weight: 14
url: /cs/system.collections.generic.details/enumerableselectadapter/
---
## EnumerableSelectAdapter třída

Enumerable používaný metodou rozšíření IEnumerable.Select().
...
| Parametr | Popis |
| --- | --- |
| Source | Typ zdroje prvků kolekce. |
| Result | Typ výsledku prvků kolekce. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Získá iterátor ukazující na první prvek (pokud existuje) instance kolekce s kvalifikátorem const. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) instance kolekce s kvalifikátorem const. |
