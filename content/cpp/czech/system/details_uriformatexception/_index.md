...
description: "UriFormatException je vyvolána, když formát URI není platný. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu UriFormatException. Nikdy neobalujte instance třídy UriFormatException do System::SmartPtr."
type: docs
weight: 768
url: /cs/system/details_uriformatexception/
---
## Details_UriFormatException třída


UriFormatException je vyvolána, když formát URI není platný. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu UriFormatException. Nikdy neobalujte instance třídy UriFormatException do [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Vrací kopii objektu Exception, který představuje nejhlubší vnitřní výjimku. |
...
| void [Lock](../object/lock/)() | Implementuje zamykání dle C# lock(). Volá se přímo nebo pomocí objektu hlídky [LockContext](../lockcontext/). |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Nastavuje HRESULT, kódovanou číselnou hodnotu, která je přiřazena konkrétní výjimce. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Nastavuje n'tý argument šablony jako slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
...
| void [Unlock](../object/unlock/)() | Implementuje odemykání dle C# lock(). Volá se přímo nebo pomocí objektu hlídky [LockContext](../lockcontext/). |
...
| virtual  [~Object](../object/~object/)() | Zničí objekt. Uvolňuje všechny interní datové struktury. |

## Viz také

* Třída [Details_FormatException](../details_formatexception/)
