...
description: Obsahuje metody pro práci s neoznačeným 8bitovým celým číslem.
type: docs
weight: 157
url: /cs/system/byte/
---
...
Obsahuje metody pro práci s neoznačeným 8bitovým celým číslem.
...
| Metoda | Popis |
| --- | --- |
| static **uint8_t** [Parse](./parse/)(const [String](../string/)\&) | Převádí zadaný řetězec obsahující textovou reprezentaci čísla na odpovídající 8bitové neoznačené celé číslo. |
| static **uint8_t** [Parse](./parse/)(const [String](../string/)\&, const [SharedPtr](../sharedptr/)\<[IFormatProvider](../iformatprovider/)\>\&) | Převádí zadaný řetězec obsahující textovou reprezentaci čísla na odpovídající 8bitové neoznačené celé číslo pomocí poskytnutých informací o formátování. |
...
| static **uint8_t** [Parse](./parse/)(const [String](../string/)\&, [Globalization::NumberStyles](../../system.globalization/numberstyles/), const [SharedPtr](../sharedptr/)\<[IFormatProvider](../iformatprovider/)\>\&) | Převádí zadaný řetězec obsahující textovou reprezentaci čísla na odpovídající 8bitové neoznačené celé číslo pomocí poskytnutých informací o formátování a číselného stylu. |
...
| static **bool** [TryParse](./tryparse/)(const [String](../string/)\&, **uint8_t**\&) | Převádí zadaný řetězec obsahující textovou reprezentaci čísla na odpovídající 8bitové neoznačené celé číslo. |
| static **bool** [TryParse](./tryparse/)(const [String](../string/)\&, [Globalization::NumberStyles](../../system.globalization/numberstyles/), const [SharedPtr](../sharedptr/)\<[IFormatProvider](../iformatprovider/)\>\&, **uint8_t**\&) | Převádí zadaný řetězec obsahující textovou reprezentaci čísla na odpovídající 8bitové neoznačené celé číslo pomocí poskytnutých informací o formátování a číselného stylu. |
...
123
System::OverflowException: Hodnota byla buď příliš velká nebo příliš malá pro typ UInt8
10
*/
```
