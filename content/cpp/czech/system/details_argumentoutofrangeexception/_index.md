...
description: "ArgumentOutOfRangeException je vyhozena, když je volané metodě předán argument, který spadá mimo očekávaný rozsah hodnot pro tento argument. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu ArgumentOutOfRangeException. Nikdy neobalujte instance třídy ArgumentOutOfRangeException do System::SmartPtr."
type: docs
weight: 352
url: /cs/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException třída

ArgumentOutOfRangeException je vyvolána, když je volané metodě předán argument, který spadá mimo očekávaný rozsah hodnot pro tento argument. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu ArgumentOutOfRangeException. Nikdy neobalujte instance třídy ArgumentOutOfRangeException do [System::SmartPtr](../smartptr/).
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Vrací 32bitovou celočíselnou hodnotu, která je kódem HRESULT spojeným s výjimkou reprezentovaným aktuálním objektem. |
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Získá datovou strukturu čítače odkazů spojenou s objektem. |
