...
description: "Základní třída pro třídy, které představují systémové (na rozdíl od aplikačních) výjimky. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu SystemException. Nikdy neobalujte instance třídy SystemException do System::SmartPtr."
type: docs
weight: 703
url: /cs/system/details_systemexception/
---
## Details_SystemException třída


Základní třída pro třídy, které představují systémové (na rozdíl od aplikačních) výjimky. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu SystemException. Nikdy neobalujte instance třídy SystemException do [System::SmartPtr](../smartptr/).
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Získává strukturu dat počítadla referencí spojenou s objektem. |
...
| void [Lock](../object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Volá se přímo nebo se použije strážní objekt [LockContext](../lockcontext/). |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Nastavuje HRESULT, číselnou kódovanou hodnotu, která je přiřazena konkrétní výjimce. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Nastavuje n'tý argument šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
...
| void [Unlock](../object/unlock/)() | Implementuje odemykání pomocí příkazu C# lock(). Volá se přímo nebo se použije strážní objekt [LockContext](../lockcontext/). |
...
| virtual const char * [what](../details_exception/what/)() const | Implementuje metodu [what()](../details_exception/what/), která je volána třídou [ExceptionWrapper](../exceptionwrapper/). Přestože tato třída nedědí ze std::exception, odvozené třídy mohou použít chráněné/soukromé členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../exceptionwrapper/) může tuto logiku narušit. |
