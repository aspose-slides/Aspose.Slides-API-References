...
description: "InvalidCastException je vyvolána, když je provedena neplatná operace přetypování neplatné explicitní konverze. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu InvalidCastException. Nikdy neobalujte instance třídy InvalidCastException do System::SmartPtr."
type: docs
weight: 495
url: /cs/system/details_invalidcastexception/
---
## Details_InvalidCastException třída


InvalidCastException je vyvolána, když je provedena neplatná operace přetypování neplatné explicitní konverze. Nikdy nevytvářejte instance této třídy ručně. Místo toho použijte třídu InvalidCastException. Nikdy neobalujte instance třídy InvalidCastException do [System::SmartPtr](../smartptr/).
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Vrací 32-bitovou celočíselnou hodnotu, což je kód HRESULT spjatý s výjimkou reprezentovanou aktuálním objektem. |
...
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Vrací řetězec obsahující stop-trace. |
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Získá datovou strukturu počitadla referencí spojenou s objektem. |
...
| void [Lock](../object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony jako slabý ukazatel (místo sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
| int [SharedCount](../object/sharedcount/)() const | Získá aktuální hodnotu sdíleného čítače referencí. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Zvětší sdílený čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Zvětší čítač slabých referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Sníží čítač slabých referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| virtual const char * [what](../details_exception/what/)() const | Implementuje metodu [what()](../details_exception/what/), která je volána třídou [ExceptionWrapper](../exceptionwrapper/). Přestože tato třída nezdědí od std::exception, odvozené třídy mohou použít chráněné/soukromé členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../exceptionwrapper/) může tuto logiku narušit. |
