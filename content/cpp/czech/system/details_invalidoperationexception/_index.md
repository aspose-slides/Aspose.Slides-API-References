...
description: "Výjimka, která je vyvolána, když je metoda volána na objektu, který je v stavu nekonzistentním s tímto voláním. Nikdy nevytvářejte instance této třídy ručně. Místo toho použijte třídu InvalidOperationException. Nikdy neobalujte instance třídy InvalidOperationException do System::SmartPtr."
type: docs
weight: 508
url: /cs/system/details_invalidoperationexception/
---
## Details_InvalidOperationException třída


Výjimka, která je vyvolána, když je metoda volána na objektu, který je ve stavu nekompatibilním s tímto voláním. Nikdy nevytvářejte instance této třídy ručně. Místo toho použijte třídu InvalidOperationException. Nikdy neobalujte instance třídy InvalidOperationException do [System::SmartPtr](../smartptr/).
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Získá aktuální typ objektu. Analog volání C# [System.Object.GetType()](../object/gettype/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopírovací konstruktor. Nic nekopíruje, ve skutečnosti jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operátor přiřazení. Nic nekopíruje, ve skutečnosti jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementuje metodu [what()](../details_exception/what/), která je volána třídou [ExceptionWrapper](../exceptionwrapper/). Navzdory tomu, že tato třída nezdědí z std::exception, odvozené třídy mohou používat chráněné/soukromé členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../exceptionwrapper/) může tuto logiku rozbít. |
