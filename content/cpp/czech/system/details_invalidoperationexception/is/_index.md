...
type: docs
weight: 27
url: /cs/system/details_invalidoperationexception/is/
---
## Details_InvalidOperationException::Is(const System::TypeInfo\&) const metoda
...
Zkontrolujte, zda objekt představuje instanci typu popsaného pomocí targetType. Analogie k operátoru C# 'is'.

## Viz také

* Třída [TypeInfo](../../typeinfo/)
* Třída [Details_InvalidOperationException](../)
