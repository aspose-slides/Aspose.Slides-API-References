...
type: docs
weight: 27
url: /cs/system/details_formatexception/is/
---
## Podrobnosti_FormatException::Is(const System::TypeInfo\&) const metoda
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| target | const [System::TypeInfo](../../typeinfo/)\& | [TypeInfo](../../typeinfo/) struktura popisující typ, proti kterému se testuje aktuální objekt. |
