...
description: "InvalidProgramException je přítomen pouze z důvodů kompatibility. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu InvalidProgramException. Nikdy nezabaluje instance třídy InvalidProgramException do System::SmartPtr."
type: docs
weight: 521
url: /cs/system/details_invalidprogramexception/
---
## Details_InvalidProgramException třída

InvalidProgramException je přítomen pouze z důvodů kompatibility. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu InvalidProgramException. Nikdy nezabaluje instance třídy InvalidProgramException do [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnávání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnávání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
...
| void [Lock](../object/lock/)() | Implementuje zamykání příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../lockcontext/). |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Sníží sdílený počet odkazů o zadanou hodnotu. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Zvyšuje sdílený počet odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Snižuje a vrací sdílený počet odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| void [Unlock](../object/unlock/)() | Implementuje odemykání příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Zvyšuje slabý počet odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Snižuje slabý počet odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
