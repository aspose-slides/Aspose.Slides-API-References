...
description: "OperationCanceledException je vyvolána ve vlákně při zrušení operace, kterou vlákno provádělo. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu OperationCanceledException. Nikdy neobalujte instance třídy OperationCanceledException do System::SmartPtr."
type: docs
weight: 625
url: /cs/system/details_operationcanceledexception/
---
## Details_OperationCanceledException třída


OperationCanceledException je vyvolána ve vlákně při zrušení operace, kterou vlákno provádělo. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu OperationCanceledException. Nikdy neobalujte instance třídy OperationCanceledException do [System::SmartPtr](../smartptr/).
