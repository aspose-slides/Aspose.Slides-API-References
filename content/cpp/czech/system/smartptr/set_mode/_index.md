...
description: Nastaví režim ukazatele. Může změnit počty odkazů na referencovaný objekt.
type: docs
weight: 183
url: /cs/system/smartptr/set_mode/
---
## SmartPtr::set_Mode(SmartPtrMode) metoda


Nastaví režim ukazatele. Může změnit počty odkazů na referencovaný objekt.
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| mode | [SmartPtrMode](../../smartptrmode/) | Nový režim ukazatele. 
```cpp
...
Počet sdílených ukazatelů: 1
Počet sdílených ukazatelů: 2
Režim bude změněn na System::SmartPtrMode::Weak
Režim byl změněn na System::SmartPtrMode::Weak
Režim bude změněn na System::SmartPtrMode::Weak
~Item()
Režim byl změněn na System::SmartPtrMode::Weak
Ukazatel na instanci třídy Item vypršel: True
*/
``` |
