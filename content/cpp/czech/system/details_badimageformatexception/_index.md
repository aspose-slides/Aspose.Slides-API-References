...
description: "Výjimka, která je vyvolána, když je obraz souboru dynamické knihovny (DLL) nebo spustitelného programu neplatný. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu BadImageFormatException. Nikdy neobalujte instance třídy BadImageFormatException do System::SmartPtr."
type: docs
weight: 378
url: /cs/system/details_badimageformatexception/
---
## Details_BadImageFormatException třída


Výjimka, která je vyvolána, když je souborový obraz dynamické knihovny (DLL) nebo spustitelného programu neplatný. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu BadImageFormatException třída. Nikdy neobalujte instance třídy BadImageFormatException třída do [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání desetinných čísel ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| virtual [String](../string/) [get_FileName](../details_exceptionwithfilename/get_filename/)() const | Získá název souboru, který tuto výjimku způsobí. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](../details_systemexception/gettype/)() const override | Získá skutečný typ objektu. Analog volání C# [System.Object.GetType()](../object/gettype/). |
| **bool** [Is](../details_systemexception/is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../lockcontext/). |
...
| void [Unlock](../object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../lockcontext/). |
...
* Třída [Details_ExceptionWithFilename](../details_exceptionwithfilename/)
