...
type: docs
weight: 391
url: /cs/system/details_datamisalignedexception/
---
## Details_DataMisalignedException třída
...
| void [Lock](../object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../lockcontext/). |
...
| void [Unlock](../object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../lockcontext/). |
...
| virtual const char * [what](../details_exception/what/)() const | Implementuje metodu [what()](../details_exception/what/), která je volána třídou [ExceptionWrapper](../exceptionwrapper/). Přestože tato třída není odvozena od std::exception, odvozené třídy mohou použít chráněné/soukromé členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../exceptionwrapper/) může tuto logiku narušit. |
