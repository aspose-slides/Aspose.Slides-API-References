...
description: "NotImplementedException je vyvolána, když je metoda, která není implementována, a slouží jako zástupná. Nikdy nevytvářejte ručně instance této třídy. Použijte místo toho třídu NotImplementedException. Nikdy neobalujte instance třídy NotImplementedException do System::SmartPtr."
type: docs
weight: 573
url: /cs/system/details_notimplementedexception/
---
## Details_NotImplementedException třída


NotImplementedException je vyvolána, když je metoda, která není implementována, a slouží jako zástupná. Nikdy neprovádějte ruční vytváření instancí této třídy. Použijte místo toho třídu NotImplementedException. Nikdy neobalujte instance třídy NotImplementedException do [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání plovoucí čárky ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání plovoucí čárky ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Vrací 32bitovou celočíselnou hodnotu, která je kódem HRESULT přiřazeným k výjimce reprezentované aktuálním objektem. |
...
| void [Lock](../object/lock/)() | Implementuje zamykání pomocí C# lock() příkazu. Vyvolejte přímo nebo použijte strážní objekt [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopiovací konstruktor. Vlastně nic nekopíruje, jen inicializuje nový objekt a umožňuje kopírování podtříd. |
...
| int [SharedCount](../object/sharedcount/)() const | Získává aktuální hodnotu sdíleného počítadla referencí. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Zvyšuje sdílený čítač referencí. Nesmí být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Snižuje a vrací sdílený čítač referencí. Nesmí být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| void [Unlock](../object/unlock/)() | Implementuje odemykání pomocí C# lock() příkazu. Vyvolejte přímo nebo použijte strážní objekt [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Zvyšuje slabý čítač referencí. Nesmí být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Snižuje slabý čítač referencí. Nesmí být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| virtual const char * [what](../details_exception/what/)() const | Implementuje metodu [what()](../details_exception/what/), která je volána třídou [ExceptionWrapper](../exceptionwrapper/). Navzdory tomu, že tato třída nezdědí ze std::exception, odvozené třídy mohou používat chráněné/privátní členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../exceptionwrapper/) může tuto logiku narušit. |
