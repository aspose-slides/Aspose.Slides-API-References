...
description: "Ukázková třída umožňující propojit přeložený kód s odkazy na HttpResponse, ale neprovádí jej. Neobsahuje žádné řádně implementované členy. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání funkcím jako argument."
type: docs
weight: 27
url: /cs/system.web/httpresponse/
---
## HttpResponse třída

Dummy třída umožňující propojení přeloženého kódu s [HttpResponse](./) odkazy, ale ne jeho vykonání. Neobsahuje žádné řádně implementované členy. Objektům této třídy by mělo být přidělováno pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám runtime a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkcím jako argument.
...
| Metoda | Popis |
| --- | --- |
| void [AddHeader](./addheader/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Není implementováno. |
| void [BinaryWrite](./binarywrite/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Není implementováno. |
| void [Clear](./clear/)() | Není implementováno. |
| void [ClearContent](./clearcontent/)() | Není implementováno. |
| void [ClearHeaders](./clearheaders/)() | Není implementováno. |
| void [End](./end/)() | Není implementováno. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [get_OutputStream](./get_outputstream/)() | Není implementováno. |
...
| [HttpResponse](./httpresponse/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::IO::TextWriter](../../system.io/textwriter/)\>\&) | Není implementováno. |
...
| void [set_ContentType](./set_contenttype/)(const [String](../../system/string/)\&) | Není implementováno. |
