...
| virtual [System::String](../../system/string/) [get_Formula](./get_formula/)() | Vzorce v atributech values, from, to, by mohou být vytvořeny z následujících: Standardní aritmetické operátory: \\uFFFD+\\uFFFD, \\uFFFD-\\uFFFD, \\uFFFD*\\uFFFD, \\uFFFD/\\uFFFD, \\uFFFD^\\uFFFD, \\uFFFD\\uFFFD (mod) Konstanty: \\uFFFDpi\\uFFFD \\uFFFDe\\uFFFD Podmíněné operátory: \\uFFFDabs\\uFFFD, \\uFFFDmin\\uFFFD, \\uFFFDmax\\uFFFD, \\uFFFD?\\uFFFD (if) Porovnávací operátory: '==', '>=', '', '!=', '!' Trigonometrické operátory: \\uFFFDsin()\\uFFFD, \\uFFFDcos()\\uFFFD, \\uFFFDtan()\\uFFFD, \\uFFFDasin()\\uFFFD, \\uFFFDacos()\\uFFFD, \\uFFFDatan()\\uFFFD Přirozený logaritmus \\uFFFDln()\\uFFFD Odkazy na vlastnosti (vlastnosti podporované hostitelem) |
| virtual **float** [get_Time](./get_time/)() | Reprezentuje časovou hodnotu. Čte **float**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | Reprezentuje hodnotu bodu. Pouze: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Čte [System::Object](../../system/object/). |
...
| virtual void [set_Formula](./set_formula/)([System::String](../../system/string/)) | Vzorce v atributech values, from, to, by mohou být vytvořeny z následujících: Standardní aritmetické operátory: \\uFFFD+\\uFFFD, \\uFFFD-\\uFFFD, \\uFFFD*\\uFFFD, \\uFFFD/\\uFFFD, \\uFFFD^\\uFFFD, \\uFFFD\\uFFFD (mod) Konstanty: \\uFFFDpi\\uFFFD \\uFFFDe\\uFFFD Podmíněné operátory: \\uFFFDabs\\uFFFD, \\uFFFDmin\\uFFFD, \\uFFFDmax\\uFFFD, \\uFFFD?\\uFFFD (if) Porovnávací operátory: '==', '>=', '', '!=', '!' Trigonometrické operátory: \\uFFFDsin()\\uFFFD, \\uFFFDcos()\\uFFFD, \\uFFFDtan()\\uFFFD, \\uFFFDasin()\\uFFFD, \\uFFFDacos()\\uFFFD, \\uFFFDatan()\\uFFFD Přirozený logaritmus \\uFFFDln()\\uFFFD Odkazy na vlastnosti (vlastnosti podporované hostitelem) |
| virtual void [set_Time](./set_time/)(**float**) | Reprezentuje časovou hodnotu. Zapíše **float**. |
| virtual void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Reprezentuje hodnotu bodu. Pouze: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Zapíše [System::Object](../../system/object/). |
