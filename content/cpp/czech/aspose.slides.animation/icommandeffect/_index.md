...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../ibehavior/get_accumulate/)() | Reprezentuje, zda jsou animační chování akumulována. Čtení [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../ibehavior/get_additive/)() | Reprezentuje, zda je aktuální animační chování kombinováno s dalšími běžícími animacemi. Čtení [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() | Definuje řetězec příkazu. Čtení [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() | Definuje cíl tvaru efektu příkazu. Čtení [IShape](../../aspose.slides/ishape/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Reprezentuje časové vlastnosti pro chování efektu. Čtení [ITiming](../itiming/). |
| virtual [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() | Definuje typ efektu příkazu pro chování. Čtení [CommandEffectType](../commandeffecttype/). |
...
| virtual void [set_Accumulate](../ibehavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Reprezentuje, zda jsou animační chování akumulována. Zápis [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Reprezentuje, zda je aktuální animační chování kombinováno s dalšími běžícími animacemi. Zápis [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) | Definuje řetězec příkazu. Zápis [System::String](../../system/string/). |
| virtual void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Definuje cíl tvaru efektu příkazu. Zápis [IShape](../../aspose.slides/ishape/). |
| virtual void [set_Timing](../ibehavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Reprezentuje časové vlastnosti pro chování efektu. Zápis [ITiming](../itiming/). |
| virtual void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) | Definuje typ efektu příkazu pro chování. Zápis [CommandEffectType](../commandeffecttype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-ty argument šablony jako slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
