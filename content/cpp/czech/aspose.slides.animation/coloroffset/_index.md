...
| **float** [get_Value0](./get_value0/)() override | Definuje první hodnotu posunu. Číst **float**. |
| **float** [get_Value1](./get_value1/)() override | Definuje druhou hodnotu posunu. Číst **float**. |
| **float** [get_Value2](./get_value2/)() override | Definuje třetí hodnotu posunu. Číst **float**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání dle C# výrazu lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
...
| void [set_Value0](./set_value0/)(**float**) override | Definuje první hodnotu posunu. Zapsat **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Definuje druhou hodnotu posunu. Zapsat **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Definuje třetí hodnotu posunu. Zapsat **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení dle C# výrazu lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
...
| virtual  [~Object](../../system/object/~object/)() | Ruší objekt. Uvolňuje všechny interní datové struktury. |

## Viz také

* Třída [IColorOffset](../icoloroffset/)
