...
description: Zastupuje základní chování třídy efektu.
type: docs
weight: 14
...
Zastupuje základní chování třídy efektu.
...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() override | Udává, zda jsou animační chování akumulována. Číst [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() override | Udává, zda je aktuální animační chování kombinováno s ostatními běžícími animacemi. Číst [BehaviorAdditiveType](../behavioradditivetype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() override | Udává vlastnosti chování. Pouze pro čtení [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() override | Udává časové vlastnosti pro chování efektu. Číst [ITiming](../itiming/). |
...
| void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Udává, zda jsou animační chování akumulována. Zapsat [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Udává, zda je aktuální animační chování kombinováno s ostatními běžícími animacemi. Zapsat [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Udává časové vlastnosti pro chování efektu. Zapsat [ITiming](../itiming/). |
