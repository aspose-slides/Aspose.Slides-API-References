...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | Representuje, zda jsou animační chování akumulována. Read [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | Representuje, zda je aktuální animační chování kombinováno s ostatními běžícími animacemi. Read [BehaviorAdditiveType](../behavioradditivetype/). |
| **float** [get_By](./get_by/)() override | Popisuje relativní hodnotu posunu pro animaci. Read **float**. |
| **float** [get_From](./get_from/)() override | Popisuje počáteční hodnotu pro animaci. Read **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Representuje časové vlastnosti pro chování efektu. Read [ITiming](../itiming/). |
| **float** [get_To](./get_to/)() override | Popisuje koncovou hodnotu pro animaci. Read **float**. |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Representuje, zda jsou animační chování akumulována. Write [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Representuje, zda je aktuální animační chování kombinováno s ostatními běžícími animacemi. Write [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_By](./set_by/)(**float**) override | Popisuje relativní hodnotu posunu pro animaci. Write **float**. |
| void [set_From](./set_from/)(**float**) override | Popisuje počáteční hodnotu pro animaci. Write **float**. |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Representuje časové vlastnosti pro chování efektu. Write [ITiming](../itiming/). |
| void [set_To](./set_to/)(**float**) override | Popisuje koncovou hodnotu pro animaci. Write **float**. |
...
* Třída [IRotationEffect](../irotationeffect/)
