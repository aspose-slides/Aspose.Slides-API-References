...
| virtual **float** [get_Value0](./get_value0/)() | Definuje první hodnotu offsetu. Čte **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Definuje druhou hodnotu offsetu. Čte **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Definuje třetí hodnotu offsetu. Čte **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Definuje první hodnotu offsetu. Zapíše **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Definuje druhou hodnotu offsetu. Zapíše **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Definuje třetí hodnotu offsetu. Zapíše **float**. |
