...
description: Zastupuje časové vlastnosti pro chování efektu.
type: docs
weight: 196
url: /cs/aspose.slides.animation/ibehaviorpropertycollection/
---
## IBehaviorPropertyCollection třída

Zastupuje časové vlastnosti pro chování efektu.
...
| Metoda | Popis |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | Přidá novou vlastnost do kolekce. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Vrací iterátor ukazující na první prvek s kvalifikací const (pokud existuje) kolekce. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Vrací iterátor ukazující těsně za posledním prvkem s kvalifikací const (pokud existuje) kolekce. |
| virtual void [Clear](../../system.collections.generic/icollection/clear/)() | Odstraní všechny prvky z kolekce. |
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Určuje, zda [ICollection](../../system.collections.generic/icollection/) obsahuje konkrétní hodnotu. |
...
| virtual int [get_Count](../../system.collections.generic/icollection/get_count/)() const | Vrací počet prvků v kolekci. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Vrací objekt, přes který je kolekce synchronizována. |
...
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Vrací prvek na zadaném indexu. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Nastavuje prvek na zadaném indexu. |
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Určuje index konkrétní položky podle hodnoty vlastnosti v [IList](../../system.collections.generic/ilist/). |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | Vrací index prvního výskytu položky v kontejneru. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Vkládá novou vlastnost (s určenou hodnotou vlastnosti) do kolekce na zadaný index. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Vkládá prvek do určené pozice, posouvá ostatní prvky. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformovací funkci na každém prvku generické sekvence a vrací maximální vzniklou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformovací funkci na každém prvku generické sekvence a vrací minimální vzniklou hodnotu. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformuje každý prvek sekvence na novou formu zahrnutím indexu prvku. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Odstraňuje zadanou vlastnost z kolekce. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Odstraňuje prvek z kolekce. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Odstraňuje prvek na zadaném indexu. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený počet referencí o zadanou hodnotu. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony na weak ukazatel (místo shared). Umožňuje přepnutí ukazatelů v kontejnerech do weak režimu. |
