...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | Vrací interaktivní sekvenci na zadaném indexu. Tato sekvence může obsahovat pouze efekty způsobené "click on shape" s určeným cílovým tvarem. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequenceCollection](../isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() override | Vrací kolekci interaktivních sekvencí. Tyto sekvence mohou obsahovat pouze efekty způsobené "click on shape" s určeným cílovým tvarem. Pouze pro čtení [ISequenceCollection](../isequencecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | Vrací hlavní sekvenci, která může obsahovat pouze hlavní kolekci efektů. Pouze pro čtení [ISequence](../isequence/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | Vrací efekt z hlavní sekvence na zadaném indexu. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | Vrací animaci textu na zadaném indexu. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | Vrací kolekci textových animací. Pouze pro čtení [ITextAnimationCollection](../itextanimationcollection/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamykání pomocí C# lock() výrazu. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý argument šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
...
* Třída [IAnimationTimeLine](../../aspose.slides/ianimationtimeline/)
