...
description: "Obsahuje XML jmenné prostory a předpony, které Serialization::XmlSerializer používá k vytvoření kvalifikovaných názvů v instanci XML dokumentu."
type: docs
weight: 92
url: /cs/system.xml.serialization/xmlserializernamespaces/
---
## XmlSerializerNamespaces třída

Obsahuje XML jmenné prostory a předpony, které [Serialization::XmlSerializer](../xmlserializer/) používá k vytvoření kvalifikovaných názvů v instanci XML-dokumentu.
...
| Metoda | Popis |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Přidá pár předpony a jmenného prostoru do objektu [Serialization::XmlSerializerNamespaces](./). |
...
| **int32_t** [get_Count](./get_count/)() | Vrací počet párů předpon a jmenných prostorů ve sbírce. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\> [ToArray](./toarray/)() | Vrací pole párů předpon a jmenných prostorů v objektu [Serialization::XmlSerializerNamespaces](./). |
...
|  [XmlSerializerNamespaces](./xmlserializernamespaces/)() | Inicializuje novou instanci třídy [Serialization::XmlSerializerNamespaces](./). |
|  [XmlSerializerNamespaces](./xmlserializernamespaces/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSerializerNamespaces](./)\>\&) | Inicializuje novou instanci třídy [Serialization::XmlSerializerNamespaces](./) pomocí zadané instance **[XmlSerializerNamespaces](./)**, která obsahuje sbírku párů předpon a jmenných prostorů. |
|  [XmlSerializerNamespaces](./xmlserializernamespaces/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\&) | Inicializuje novou instanci třídy [Serialization::XmlSerializerNamespaces](./). |
