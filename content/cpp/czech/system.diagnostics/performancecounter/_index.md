...
description: "Ukázková třída pro kód používající PerformanceCounter, aby se dal zkompilovat. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předávání jako argument funkcím."
type: docs
weight: 14
url: /cs/system.diagnostics/performancecounter/
---
## PerformanceCounter třída


Ukázková třída pro přeložený kód používající PerformanceCounter, aby se dal zkompilovat. Objekty této třídy by měly být alokovány pouze funkcí [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to způsobí chyby za běhu a/nebo selhání aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| Method | Description |
| --- | --- |
| void [Close](./close/)() | Zastaví všechny operace počítání výkonu. |
...
| **float** [NextValue](./nextvalue/)() | Získá další měřenou hodnotu. |
|  [Object](../../system/object/object/)() | Vytvoří objekt. Inicializuje všechny interní datové struktury. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje kopírování podtříd. |
|  [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje kopírování podtříd. |
|  [PerformanceCounter](./performancecounter/)() | Vytvoří výkonnostní čítač. |
|  [PerformanceCounter](./performancecounter/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Vytvoří výkonnostní čítač pro konkrétní kategorii. |
|  [PerformanceCounter](./performancecounter/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Vytvoří výkonnostní čítač pro konkrétní kategorii a název instance. |
