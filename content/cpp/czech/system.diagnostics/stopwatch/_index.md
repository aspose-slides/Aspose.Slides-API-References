...
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | Získá celkový uplynulý čas měřený aktuální instancí. |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | Získá celkový uplynulý čas měřený aktuální instancí v milisekundách. |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | Získá celkový uplynulý čas měřený aktuální instancí v taktech časovače. |
| **bool** [get_IsRunning](./get_isrunning/)() const | Kontroluje, zda je stopky v chodu. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analog operátoru C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [Reset](./reset/)() | Zastaví měření času, nastaví měřený interval na nulu. |
| void [Restart](./restart/)() | Nastaví měřený interval na nulu a poté spustí měření času. |
...
| void [Start](./start/)() | Spustí měření času. |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | Vytvoří nový objekt [Stopwatch](./) a spustí měření. |
| void [Stop](./stop/)() | Zastaví měření času. |
|  [Stopwatch](./stopwatch/)() | Informace RTTI. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje převod vlastních objektů na řetězec. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukci C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání podle C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
