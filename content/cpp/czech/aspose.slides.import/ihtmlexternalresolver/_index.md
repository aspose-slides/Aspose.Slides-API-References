...
description: Rozhraní volání zpět používané rutinou importu HTML k získání odkazovaných objektů, například obrázků.
type: docs
weight: 53
url: /cs/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver třída

Rozhraní volání zpět používané rutinou importu HTML k získání odkazovaných objektů, například obrázků.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | Mapuje URI na objekt obsahující skutečný zdroj. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Vyřeší absolutní URI z základního a relativního URI. |
...
Zastaralé
:   Zastaralé. Použijte [IExternalResourceResolver](../iexternalresourceresolver/) místo toho. Bude odstraněno ve vydání 17.12.
