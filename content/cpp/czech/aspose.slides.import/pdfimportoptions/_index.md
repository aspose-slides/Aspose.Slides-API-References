...
| **bool** [get_DetectTables](./get_detecttables/)() const | Určuje, zda detekovat tabulky při importu PDF souboru. |
...
| void [set_DetectTables](./set_detecttables/)(**bool**) | Určuje, zda detekovat tabulky při importu PDF souboru. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepnout ukazatele v kontejnerech do režimu slabých. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídky [LockContext](../../system/lockcontext/). |
