...
description: Rozhraní zpětného volání použité k řešení externích zdrojů během importu dokumentů Html, Svg.
type: docs
weight: 40
url: /cs/aspose.slides.import/iexternalresourceresolver/
---
## IExternalResourceResolver třída

Rozhraní zpětného volání použité k rozlišení externích zdrojů během importu dokumentů Html, Svg.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) | Mapuje URI na objekt obsahující skutečný zdroj. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí výrazu C# lock(). Volá se přímo nebo pomocí objektu strážce [LockContext](../../system/lockcontext/). |
...
| virtual [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Rozpozná absolutní URI z základního a relativních URI. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání výrazu C# lock(). Volá se přímo nebo pomocí objektu strážce [LockContext](../../system/lockcontext/). |
