...
description: Třída zpětného volání používaná k řešení externích zdrojů při importu dokumentů Html a Svg.
type: docs
weight: 14
...
Třída zpětného volání používaná k řešení externích zdrojů při importu dokumentů Html a Svg.
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) override | Mapuje URI na objekt obsahující skutečný zdroj. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# výrazu lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Určuje absolutní URI ze základního a relativního URI. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí C# výrazu lock(). Zavolejte přímo nebo použijte sentinelní objekt [LockContext](../../system/lockcontext/). |
...
Použití tohoto resolveru může vytvořit zranitelnost, kdy soubor HTML nebo SVG poskytnutý klientem způsobí, že serverový software získá místní nebo síťový soubor. Používejte opatrně. Doporučuje se vůbec nespecifikovat [ExternalResourceResolver](./) (budou čteny jen vložené objekty) nebo vytvořit podtřídu, která kontroluje, zda je zadané uri platné.

## Viz také

* Třída [IExternalResourceResolver](../iexternalresourceresolver/)
