...
description: Časovač, který volá delegáta ve smyčce.
type: docs
weight: 14
url: /cs/system.timers/timer/
---
## třída Timer


[Timer](./) který volá delegáta ve smyčce.
...
| Method | Description |
| --- | --- |
| void [Close](./close/)() | Zastaví časovač, uvolní přidělené prostředky. |
|  [Component](../../system.componentmodel/component/component/)() | Informace RTTI. |
| void [Dispose](./dispose/)() | Zastaví časovač, uvolní přidělené prostředky. |
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | Podpora vzoru Disposable; nic nedělá. |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | Kontroluje, zda je časovač v režimu automatického resetu. |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Kontroluje, zda je komponenta v návrhovém režimu. |
| **bool** [get_Enabled](./get_enabled/)() const | Kontroluje, zda je časovač aktivní. |
| **double** [get_Interval](./get_interval/)() const | Získá interval časovače. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Kontroluje, zda je časovač zastaven. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Nastaví časovač do režimu automatického resetu nebo z něj jej vypne. |
| void [set_Enabled](./set_enabled/)(**bool**) | Spouští nebo zastavuje časovač. Spuštění časovače nerestartuje odpočítávání, pokud již běží. |
| void [set_Interval](./set_interval/)(**double**) | Nastaví interval časovače. |
...
| void [Start](./start/)() | Spouští časovač. Nereštartuje odpočítávání, pokud již běží. |
| void [Stop](./stop/)() | Zastavuje časovač. |
|  [Timer](./timer/)() | Informace RTTI. |
|  [Timer](./timer/)(**double**) | Vytvoří zastavený časovač se zadaným intervalem. |
