...
description: "Representuje rozlišení tiskárny. Objektům této třídy by se mělo alokovat pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy obalte tuto třídu ukazatelem System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 66
url: /cs/system.drawing.printing/printerresolution/
---
## PrinterResolution třída
...
| int [get_X](./get_x/)() const | Vrací horizontální rozlišení. |
| int [get_Y](./get_y/)() const | Vrací vertikální rozlišení. |
...
| void [set_X](./set_x/)(int) | Nastaví horizontální rozlišení. |
| void [set_Y](./set_y/)(int) | Nastaví vertikální rozlišení. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony na slabý ukazatel (spíše než sdílený). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
