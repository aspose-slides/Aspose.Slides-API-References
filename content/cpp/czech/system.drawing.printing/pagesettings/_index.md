...
description: "Reprezentuje nastavení tištěné stránky. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání do funkcí jako argument."
type: docs
weight: 14
url: /cs/system.drawing.printing/pagesettings/
---
## PageSettings třída

Reprezentuje nastavení tištěné stránky. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() | NEIMPLEMENTOVÁNO. |
| **float** [get_HardMarginX](./get_hardmarginx/)() | NEIMPLEMENTOVÁNO. |
| **float** [get_HardMarginY](./get_hardmarginy/)() | NEIMPLEMENTOVÁNO. |
| [SharedPtr](../../system/sharedptr/)\<[PrinterResolution](../printerresolution/)\> [get_PrinterResolution](./get_printerresolution/)() | NEIMPLEMENTOVÁNO. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazu C# lock(). Zavolejte přímo nebo použijte objekt strážky [LockContext](../../system/lockcontext/). |
...
|  [PageSettings](./pagesettings/)() | Vytvoří novou instanci třídy [PageSettings](./). |
|  [PageSettings](./pagesettings/)(const [SharedPtr](../../system/sharedptr/)\<[PrinterSettings](../printersettings/)\>\&) | Vytvoří novou instanci třídy [PageSettings](./). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazu C# lock(). Zavolejte přímo nebo použijte objekt strážky [LockContext](../../system/lockcontext/). |
