...
type: docs
weight: 92
url: /cs/system.collections.generic/baseset/
---
## BaseSet třída
...
| void [Add](./add/)(const T\&) override | Přidá prvek do množiny. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Získá iterátor na první prvek kolekce s const kvalifikací. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Získá iterátor na první const-kvalifikovaný prvek kolekce. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Získá iterátor na neexistující const-kvalifikovaný prvek za koncem kolekce. |
| void [Clear](./clear/)() override | Odstraní všechny prvky v množině. |
| **bool** [Contains](./contains/)(const T\&) const override | Zkontroluje, zda je prvek přítomen v množině. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Zkopíruje obsah hash do existujících prvků pole. |
| [set_t](./set_t/)\& [data](./data/)() | Přístupový prvek podkladové datové struktury. |
| const [set_t](./set_t/)\& [data](./data/)() const | Přístupový prvek podkladové datové struktury. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Získá iterátor na neexistující prvek za koncem const-kvalifikované kolekce. |
...
| int [get_Count](./get_count/)() const override | Získá počet prvků v množině. |
| virtual int [get_Count](./get_count/)() const | Udržuje [get_Count()](./get_count/) před skrytím. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Vytvoří enumerátor. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformuje každý prvek sekvence do nové podoby za začlenění indexu prvku. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<Result\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<Result\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\>\>\&) | Projekuje každý prvek sekvence a kombinuje výsledné sekvence do jedné sekvence. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<Result\>\> [LINQ_SelectMany](../ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<Source, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<Result\>\>\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Vynechá zadaný počet souvisejících prvků od začátku sekvence a vrací zbytek. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Take](../ienumerable/linq_take/)(**int32_t**) | Vrací zadaný počet souvisejících prvků od začátku sekvence. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle C# lock() prohlášení. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| [ICollection](../icollection/)\& [operator=](../icollection/operator_equal/)([ICollection](../icollection/)\&&) | Operátor přiřazení move. |
| [ICollection](../icollection/)\& [operator=](../icollection/operator_equal/)(const [ICollection](../icollection/)\&) | Operátor přiřazení move. |
...
| **bool** [Remove](./remove/)(const T\&) override | Odstraňuje prvek z množiny. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Snižuje sdílený čítač referencí o zadanou hodnotu. |
|  [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([ThisType](./thistype/), System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | Informace RTTI. |
...
| **bool** [TryAdd](./tryadd/)(const T\&) | Přidá prvek do množiny. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukci C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání podle C# lock() prohlášení. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| [set_t](./set_t/) | Podkladový datový typ. |
...
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** ukazatel. |
