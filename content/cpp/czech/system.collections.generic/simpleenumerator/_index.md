...
description: "Třída iterátoru pro jednoduché kontejnery, které přímo drží prvky pomocí funkcí rbegin() a rend(). Objekty této třídy by měly být alokovány jen pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předávání jako argument funkcím."
type: docs
weight: 508
url: /cs/system.collections.generic/simpleenumerator/
---
## SimpleEnumerator třída

Třída iterátoru pro jednoduché kontejnery, které přímo drží prvky pomocí funkcí rbegin() a rend(). Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel k předávání jako argument funkcím.
...
| Parametr | Popis |
| --- | --- |
| Container | Typ kontejneru, přes který se iteruje. |
| Element | Typ prvku. |
...
| [BaseEnumerator](../baseenumerator/baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Inicializuje iterátor. |
...
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | Provede první volání [MoveNext()](../ienumerator/movenext/) a připraví objekt enumerátoru k použití třídou VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analogie operátoru C# 'is'. |
| **bool** [IsValid](../baseenumerator/isvalid/)() const | Kontroluje, zda bylo voláno [MoveNext()](../baseenumerator/movenext/) a konec nebyl dosažen. |
...
| **bool** [MoveNext](../baseenumerator/movenext/)() override | Inkrementace ve stylu enumerátoru. |
...
| void [Reset](../baseenumerator/reset/)() override | Resetuje enumerátor, aby umožnil opětovné enumerování prvků. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Sníží a vrátí hodnotu sdíleného čítače referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| [SimpleEnumerator](./simpleenumerator/)([Object::ptr](../../system/object/ptr/), Container\&) | Vytvoří jednoduchý iterátor. |
...
* Třída [BaseEnumerator](../baseenumerator/)
