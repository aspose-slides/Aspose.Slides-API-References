...
description: "Kolekce klíčů Dictionary. Odkazuje na kolekci, nic nekopíruje. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání funkci jako argument."
type: docs
weight: 1
url: /cs/system.collections.generic/_keycollection/
---
## _KeyCollection třída

Kolekce klíčů [Dictionary](../dictionary/). Odkazuje na kolekci, nic nekopíruje. Objekty této třídy by měly být alokovány pouze pomocí [System::MakeObject()](../../system/makeobject/) funkce. Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do [System::SmartPtr](../../system/smartptr/) ukazatele a použijte tento ukazatel k předání funkci jako argument.
...
| Method | Description |
| --- | --- |
|  [_KeyCollection](./_keycollection/)(const typename Dict::Ptr\&) | Inicializuje kolekci odkazující na zadaný slovník. |
...
| **bool** [Contains](./contains/)(const [TKey](./tkey/)\&) const override | Kontroluje, zda je položka v kontejneru. |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Kopíruje data do existujících prvků pole. |
...
| **bool** [get_IsReadOnly](../ikvcollection/get_isreadonly/)() const override | Kontroluje, zda je kontejner jen pro čtení. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TKey](./tkey/)\>\> [GetEnumerator](./getenumerator/)() override | Získá enumerátor iterující přes klíče. |
...
| [TKey](./tkey/) [idx_get](./idx_get/)(int) const override | Implementuje metodu [IList](../ilist/). Nepodporováno. |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | Funkce nastavení. |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | Získá index položky v kontejneru. |
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | Vloží položku na určenou pozici. |
...
| T [LINQ_Aggregate](../ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Použije akumulační funkci na sekvenci. |
...
| ResultType [LINQ_Max](../ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformační funkci na každém prvku generické sekvence a vrací maximální výslednou hodnotu. |
| ResultType [LINQ_Max](../ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformační funkci na každém prvku generické sekvence a vrací minimální výslednou hodnotu. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformuje každý prvek sekvence do nové formy zahrnutím indexu prvku. |
...
| void [RemoveAt](../ikvcollection/removeat/)(int) override | Odstraní položku na určené pozici. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | Umožňuje kompilaci, ale ve skutečnosti nic nedělá, jelikož tato struktura neobsahuje data. |
...
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Získá implementaci begin const iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Získá implementaci begin iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Získá implementaci end const iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Získá implementaci end iterátoru pro aktuální kontejner. |
...
* Třída [BaseKVCollection](../basekvcollection/)
