...
| Metoda | Popis |
| --- | --- |
| void [Add](./add/)(const T\&) override | Přidá položku do kontejneru. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Vrací iterátor ukazující na první prvek (pokud existuje) kolekce. Tento iterátor nelze použít ke změně odkazovaného objektu, protože [GetEnumerator()](../ienumerable/getenumerator/) vrací kopii objektu T. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Vrací iterátor ukazující na první prvek (pokud existuje) const-kvalifikované instance kolekce. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Vrací iterátor ukazující na první const-kvalifikovaný prvek (pokud existuje) kolekce. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Vrací iterátor ukazující těsně za posledním const-kvalifikovaným prvkem (pokud existuje) kolekce. |
| void [Clear](./clear/)() override | Odstraní všechny prvky z kontejneru. |
| **bool** [Contains](./contains/)(const T\&) const override | Zkontroluje, zda je položka v kontejneru přítomna. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Vrací iterátor ukazující těsně za posledním prvkem (pokud existuje) kolekce. Tento iterátor nelze použít ke změně odkazovaného objektu, protože [GetEnumerator()](../ienumerable/getenumerator/) vrací kopii objektu T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Vrací iterátor ukazující těsně za posledním prvkem (pokud existuje) const-kvalifikované instance kolekce. |
...
| virtual int [get_Count](./get_count/)() const | Vrací počet prvků v kontejneru. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Kontroluje, zda je kolekce pevné velikosti. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Kontroluje, zda je kontejner jen pro čtení. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Vrací objekt, přes který je kolekce synchronizována. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Vrací enumerátor pro kontejner. |
...
| virtual T [idx_get](./idx_get/)(int) const | Funkce pro získání hodnoty. |
| void [idx_set](./idx_set/)(int, T) override | Funkce pro nastavení hodnoty. |
| int [IndexOf](./indexof/)(const T\&) const override | Vrací index položky v kontejneru. |
| void [Insert](./insert/)(int, const T\&) override | Vloží položku na zadanou pozici. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontroluje, zda objekt představuje instanci typu popsaného proměnnou targetType. Analog operátoru C# 'is'. |
...
| int [LINQ_Count](../ienumerable/linq_count/)() | Vrací počet prvků v sekvenci (počítáno přímým sčítáním). |
...
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Vrací první prvek sekvence, který splňuje podmínku, nebo výchozí hodnotu, pokud žádný takový prvek neexistuje. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Seřadí prvky sekvence vzestupně podle hodnot klíče vybraných funkcí keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Seřadí prvky sekvence sestupně podle hodnot klíče vybraných funkcí keySelector. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání výrazu C# lock(). Volá se přímo nebo použije objekt strážce [LockContext](../../system/lockcontext/). |
...
| **bool** [Remove](./remove/)(const T\&) override | Odstraní položku z kontejneru. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí výrazu C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../ienumerable/virtualizebeginconstiterator/)() const | Vrací implementaci begin const iterátoru pro aktuální kontejner. |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../ienumerable/virtualizebeginiterator/)() | Vrací implementaci begin iterátoru pro aktuální kontejner. |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../ienumerable/virtualizeendconstiterator/)() const | Vrací implementaci end const iterátoru pro aktuální kontejner. |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../ienumerable/virtualizeenditerator/)() | Vrací implementaci end iterátoru pro aktuální kontejner. |
