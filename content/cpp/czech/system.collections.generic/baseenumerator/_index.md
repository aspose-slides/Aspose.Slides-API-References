...
description: "Definice enumerátoru pro zabalení typů stylizovaných podle STL pro použití ve stylu C#. Neukládá žádná omezení na strukturu kontejneru, kromě existence sekvenčního iterátoru. Používá funkce begin() a end(). Objektům této třídy by měla být alokována pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 66
url: /cs/system.collections.generic/baseenumerator/
---
## BaseEnumerator třída
...
| Parametr | Popis |
| --- | --- |
| Container | Konejnérový typ ve stylu STL. |
| Element | Typ prvku. |
...
|  [BaseEnumerator](./baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Inicializuje iterátor. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Napodobuje porovnávání číslic s plovoucí řádovou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Napodobuje porovnávání číslic s plovoucí řádovou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](../ienumerator/get_current/)() const | Získá aktuální prvek. |
...
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | Provede první volání [MoveNext()](../ienumerator/movenext/) a připraví objekt enumerátoru k použití VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analogie operátoru C# 'is'. |
| **bool** [IsValid](./isvalid/)() const | Kontroluje, zda byla volána metoda [MoveNext()](./movenext/) a nebyl dosažen konec. |
...
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | Označí enumerátor vlastněný virtualizovaným iterátorem. |
...
| void [Reset](./reset/)() override | Resetuje enumerátor, aby umožnil opětovné enumerování prvků. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý parametr šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
