...
description: Ukazatel zásobníku. Tento typ je ukazatel pro správu mazání jiných objektů. Měl by být alokován na zásobníku a předáván funkcím buď hodnotou, nebo konstantní referencí.
type: docs
weight: 612
url: /cs/system.collections.generic/stackptr/
---
## StackPtr třída

[Stack](../stack/) ukazatel. Tento typ je ukazatel pro správu mazání jiného objektu. Měl by být alokován na zásobníku a předáván funkcím buď hodnotou, nebo konstantní referencí.
...
| [Pointee_](../../system/smartptr/pointee_/) * [get_shared](../../system/smartptr/get_shared/)() const | Získá ukazovaný objekt, ale tvrdí, že ukazatel je ve sdíleném režimu. |
| int [get_shared_count](../../system/smartptr/get_shared_count/)() const | Získá počet sdílených ukazatelů existujících na odkazovaný objekt, včetně aktuálního. Tvrdí, že aktuální ukazatel je ve sdíleném režimu. |
...
| [Object](../../system/object/) * [GetObjectOrNull](../../system/smartptr/getobjectornull/)() const | Získá ukazovaný objekt (pokud existuje) nebo nullptr. To samé jako [get()](../../system/smartptr/get/). |
| [Object](../../system/object/) * [GetObjectOwner](../../system/smartptr/getobjectowner/)() const | Získá odkazovaný objekt. |
| [Pointee_](../../system/smartptr/pointee_/) * [GetPointer](../../system/smartptr/getpointer/)() const | Získá ukazovaný objekt (pokud existuje) nebo nullptr. To samé jako [get()](../../system/smartptr/get/). |
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Kontroluje, zda ukazatel ukazuje na jiný objekt než je vlastněný (vytvořený aliasovým konstruktorem). |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&) | Kopírovací přiřazení objektu [SmartPtr](../../system/smartptr/). |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&) | Kopírovací přiřazení objektu [SmartPtr](../../system/smartptr/). Provádí požadované konverze typů. |
...
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Odstraňuje aliasování (vytvořené aliasovým konstruktorem) z ukazatele, zajišťuje, že spravuje (pokud je sdílený) nebo sleduje (pokud je slabý) stejný objekt, na který ukazuje. |
...
| void [set_Mode](../../system/smartptr/set_mode/)([SmartPtrMode](../../system/smartptrmode/)) | Nastaví režim ukazatele. Může změnit čítače referencí odkazovaného objektu. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&, [SmartPtrMode](../../system/smartptrmode/)) | Kopírově konstruuje objekt [SmartPtr](../../system/smartptr/). Oba ukazatele po volání ukazují na stejný objekt. |
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Kopírově konstruuje objekt [SmartPtr](../../system/smartptr/). Oba ukazatele po volání ukazují na stejný objekt. Provádí konverzi typu, pokud je povolena. |
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | Přesouvá konstrukci objektu [SmartPtr](../../system/smartptr/). Efektivně prohodí dva ukazatele, pokud jsou oba ve stejném režimu. x může být po volání nepoužitelný. |
...
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const Y\&) | Inicializuje prázdné pole. Použito pro překlad některých konstrukcí kódu v C#. |
...
|  [StackPtr](./stackptr/)() | Konstruuje null-pointer. |
|  [StackPtr](./stackptr/)(const [SharedPtr](../../system/sharedptr/)\<[Stack](../stack/)\<T\>\>\&) | Konstruuje ukazatel odkazující na konkrétní zásobník. |
...
| [SmartPtr](../../system/smartptr/)\<[Object](../../system/object/)\> [ToObjectPtr](../../system/smartptr/toobjectptr/)() const | Převádí jakýkoli typ ukazatele na ukazatel na [Object](../../system/object/). Nepožaduje, aby byl typ Pointee_ kompletní. |
...
|  [~SmartPtr](../../system/smartptr/~smartptr/)() | Ničí objekt [SmartPtr](../../system/smartptr/). V případě potřeby snižuje čítač referencí ukazovaného objektu a maže objekt. |
