...
type: docs
weight: 248
url: /cs/system.collections.generic/icollection/
---
## ICollection třída


Rozhraní kolekce prvků. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním assercí. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předávání do funkcí jako argument.
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const T\&) | Přidá prvek do kolekce. |
...
| virtual **bool** [Contains](./contains/)(const T\&) const | Zkontroluje, zda je prvek v kolekci přítomen. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Zkopíruje všechny prvky kolekce do existujících prvků pole. |
...
| virtual int [get_Count](./get_count/)() const | Získá počet prvků v kolekci. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() const | Zkontroluje, zda je kolekce pouze pro čtení. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Získá objekt, přes který je kolekce synchronizována. |
...
|  [ICollection](./icollection/)() | Výchozí konstruktor. |
|  [ICollection](./icollection/)(const [ICollection](./)\&) | Kopírovací konstruktor. |
|  [ICollection](./icollection/)([ICollection](./)\&&) | Konstruktor přesunu. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | Určuje, zda existuje prvek sekvence nebo zda některý prvek splňuje podmínku. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Přeskočí určený počet souvislých prvků od začátku sekvence a vrátí zbytek. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Take](../ienumerable/linq_take/)(**int32_t**) | Vrací určený počet souvislých prvků od začátku sekvence. |
...
| [ICollection](./)\& [operator=](./operator_equal/)([ICollection](./)\&&) | Operátor přiřazení přesunem. |
| [ICollection](./)\& [operator=](./operator_equal/)(const [ICollection](./)\&) | Operátor přiřazení přesunem. |
...
| virtual **bool** [Remove](./remove/)(const T\&) | Odstraní prvek z kolekce. |
...
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../ienumerable/virtualizebeginconstiterator/)() const | Získá implementaci begin const iterátoru pro současný kontejner. |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../ienumerable/virtualizebeginiterator/)() | Získá implementaci begin iterátoru pro současný kontejner. |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../ienumerable/virtualizeendconstiterator/)() const | Získá implementaci end const iterátoru pro současný kontejner. |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../ienumerable/virtualizeenditerator/)() | Získá implementaci end iterátoru pro současný kontejner. |
...
| Typedef | Description |
| --- | --- |
| [ValueType](./valuetype/) | Název typu hodnoty. |
| [ThisType](./thistype/) | Název typu kolekce. |
