...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | Vrací souborová data vloženého OLE objektu. Pouze ke čtení **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | Vrací příponu souboru pro aktuální vložený OLE objekt. Pouze ke čtení [System::String](../../system/string/). |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | Vytvoří novou instanci informací o vložených datech pro OLE objekt. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n'th parametr šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
...
* Třída [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* Jmenný prostor [Aspose::Slides::DOM::Ole](../)
