...
description: Reprezentuje implementaci ukladače výstupu pro přenos dat do externího úložiště.
type: docs
weight: 14
url: /cs/aspose.slides.export.xaml/ixamloutputsaver/
---
## IXamlOutputSaver třída

Representuje implementaci ukladače výstupu pro přenos dat do externího úložiště.
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Uloží pole bytů na cílové umístění. |
