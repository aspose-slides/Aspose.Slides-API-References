...
| int [get_Index](./get_index/)() const | Získá index zachyceného podřetězce. |
| int [get_Length](./get_length/)() const | Získá délku zachyceného podřetězce. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Získá zachycený podřetězec. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Získá zachycený podřetězec. |
