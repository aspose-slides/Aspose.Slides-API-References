...
description: "Převádí instanci třídy CryptoStream z base 64. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel při předávání funkcím jako argument."
type: docs
weight: 209
url: /cs/system.security.cryptography/frombase64transform/
---
## FromBase64Transform třída

Převádí instanci třídy [CryptoStream](../cryptostream/) z base 64. Objektů této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkcím jako argument.
...
| Metoda | Popis |
| --- | --- |
| void [Clear](./clear/)() | Uvolňuje všechny prostředky. |
| void [Dispose](./dispose/)() | Uvolňuje prostředky operačního systému získané aktuálním objektem. |
...
|  [FromBase64Transform](./frombase64transform/)([FromBase64TransformMode](../frombase64transformmode/)) | Konstruktor. |
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | Získává hodnotu indikující, zda lze aktuální transformaci znovu použít. |
| **bool** [get_CanTransformMultipleBlocks](./get_cantransformmultipleblocks/)() | Získává hodnotu indikující, zda lze transformovat více bloků. |
...
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Zpracovává blok dat a kopíruje data do výstupního pole. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](../icryptotransform/transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Zpracovává poslední blok dat a vypočítává výstupní hodnotu. |
