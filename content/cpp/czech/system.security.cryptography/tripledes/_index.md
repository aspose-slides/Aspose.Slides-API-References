...
description: "Třída základního algoritmu Triple Data Encryption Standard. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel pro předání jako argument funkcím."
type: docs
weight: 677
url: /cs/system.security.cryptography/tripledes/
---
## TripleDES třída
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_IV](../symmetricalgorithm/get_iv/)() | Získá počáteční hodnotu kryptografické operace. Vytvoří novou, pokud ještě nebyla vytvořena. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Key](../symmetricalgorithm/get_key/)() | Získá klíč kryptografické operace. Vytvoří nový, pokud ještě nebyl vytvořen. |
...
| virtual void [set_BlockSize](../symmetricalgorithm/set_blocksize/)(int) | Nastavuje velikost bloku kryptografické operace. |
| virtual void [set_FeedbackSize](../symmetricalgorithm/set_feedbacksize/)(int) | Nastavuje velikost zpětné vazby kryptografické operace. |
| virtual void [set_IV](../symmetricalgorithm/set_iv/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Nastavuje počáteční hodnotu kryptografické operace. |
| virtual void [set_Key](../symmetricalgorithm/set_key/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Nastavuje klíč kryptografické operace. |
| virtual void [set_KeySize](../symmetricalgorithm/set_keysize/)(int) | Nastavuje velikost klíče kryptografické operace. |
| virtual void [set_Mode](../symmetricalgorithm/set_mode/)([CipherMode](../ciphermode/)) | Nastavuje režim kryptografické operace. |
| virtual void [set_Padding](../symmetricalgorithm/set_padding/)([PaddingMode](../paddingmode/)) | Nastavuje výplň kryptografické operace. |
...
| **bool** [ValidKeySize](../symmetricalgorithm/validkeysize/)(int) | Zkontroluje, zda je velikost klíče platná. |
