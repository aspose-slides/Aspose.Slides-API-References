...
description: Režim výplně a parametry pro vytváření nebo ověřování RSA podpisů.
type: docs
weight: 521
url: /cs/system.security.cryptography/rsasignaturepadding/
---
...
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | Určuje, zda jsou aktuální a zadané objekty rovnocenné. |
...
| [RSASignaturePaddingMode](../rsasignaturepaddingmode/) [get_Mode](./get_mode/)() const | Získá režim výplně. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pkcs1](./get_pkcs1/)() | Získá režim PKCS #1 v1.5. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pss](./get_pss/)() | Získá režim PSS. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Porovnává reference hodnotového typu objektu s nullptr. |
