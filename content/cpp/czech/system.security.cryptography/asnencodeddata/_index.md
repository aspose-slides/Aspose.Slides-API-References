...
description: "Data kódovaná ve formátu ASN.1. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a používejte tento ukazatel k předávání jako argument funkcím."
type: docs
weight: 1
url: /cs/system.security.cryptography/asnencodeddata/
---
## AsnEncodedData třída
...
| Metoda | Popis |
| --- | --- |
|  [AsnEncodedData](./asnencodeddata/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](./)\>\&) | Kopírovací konstruktor. |
...
| virtual void [CopyFrom](./copyfrom/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](./)\>\&) | Kopíruje data z jiného objektu. |
...
| virtual [String](../../system/string/) [Format](./format/)(**bool**) const | Formátuje data do lidsky čitelné podoby. |
| [SharedPtr](../../system/sharedptr/)\<[Oid](../oid/)\> [get_Oid](./get_oid/)() const | Získá identifikátor objektu kódovaných dat. |
| [ByteArrayPtr](../../system/bytearrayptr/) [get_RawData](./get_rawdata/)() const | Získá surová kódovaná data. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() výrazu. Volat přímo nebo použít sentinelní objekt [LockContext](../../system/lockcontext/). |
...
| void [set_Oid](./set_oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../oid/)\>\&) | Nastavuje identifikátor objektu kódovaných dat. |
| void [set_RawData](./set_rawdata/)(const [ByteArrayPtr](../../system/bytearrayptr/)\&) | Nastavuje surová kódovaná data. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání výrazu C# lock(). Volat přímo nebo použít sentinelní objekt [LockContext](../../system/lockcontext/). |
