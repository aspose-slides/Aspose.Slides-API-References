...
description: "Datová struktura parametrů algoritmu DSA. Tento typ by měl být alokován na zásobníku a předáván funkcím hodnotou nebo referencí. Nikdy nepoužívejte třídu System::SmartPtr k řízení objektů tohoto typu."
type: docs
weight: 703
url: /cs/system.security.cryptography/dsaparameters/
---
## DSAParameters struct


[Data](../../system.data/) struktura parametrů algoritmu [DSA](../dsa/). Tento typ by měl být alokován na zásobníku a předáván funkcím hodnotou nebo referencí. Nikdy nepoužívejte třídu [System::SmartPtr](../../system/smartptr/) k správě objektů tohoto typu.
