...
description: "Spravovaný SHA1 hasher. Není implementován. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy obalte tuto třídu do ukazatele System::SmartPtr a tento ukazatel použijte při předávání jako argument funkcím."
type: docs
weight: 560
url: /cs/system.security.cryptography/sha1managed/
---
## SHA1Managed třída
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Vytvoří hash část bufferu. |
...
| static [SharedPtr](../../system/sharedptr/)\<[SHA1](../sha1/)\> [Create](../sha1/create/)() | Vytvoří instanci hash algoritmu. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA1](../sha1/)\> [Create](../sha1/create/)(const [String](../../system/string/)\&) | Vytvoří instanci hash algoritmu. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje konverzi vlastních objektů na string. |
