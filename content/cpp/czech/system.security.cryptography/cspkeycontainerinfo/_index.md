...
description: Další informace o kryptografickém páru klíčů.
type: docs
weight: 66
url: /cs/system.security.cryptography/cspkeycontainerinfo/
---
## CspKeyContainerInfo třída


Další informace o kryptografickém páru klíčů.
...
| **bool** [get_Accessible](./get_accessible/)() const | Vrací příznak, který udává, zda je klíč v kontejneru přístupný. |
| **bool** [get_Exportable](./get_exportable/)() const | Vrací příznak, který udává, zda lze klíč exportovat z kontejneru. |
| **bool** [get_HardwareDevice](./get_hardwaredevice/)() const | Vrací příznak, který udává, zda je klíč hardwarový. |
| [String](../../system/string/) [get_KeyContainerName](./get_keycontainername/)() const | Vrací název kontejneru klíčů. |
| [SharedPtr](../../system/sharedptr/)\<[KeyNumber](../keynumber/)\> [get_KeyNumber](./get_keynumber/)() const | Vrací objekt KeyNumber. |
| **bool** [get_MachineKeyStore](./get_machinekeystore/)() const | Vrací příznak, který udává, zda je klíč načten ze zásoby klíčů stroje. |
| **bool** [get_Protected](./get_protected/)() const | Vrací příznak, který udává, zda je klíč chráněn před kopírováním. |
| [String](../../system/string/) [get_ProviderName](./get_providername/)() const | Vrací název poskytovatele. |
| **int32_t** [get_ProviderType](./get_providertype/)() const | Vrací typ poskytovatele. |
| **bool** [get_RandomlyGenerated](./get_randomlygenerated/)() const | Vrací příznak, který udává, zda byl klíč vygenerován náhodně. |
| **bool** [get_Removable](./get_removable/)() const | Vrací příznak, který udává, zda může být klíč odstraněn z kontejneru. |
| [String](../../system/string/) [get_UniqueKeyContainerName](./get_uniquekeycontainername/)() const | Vrací jedinečný název kontejneru. |
