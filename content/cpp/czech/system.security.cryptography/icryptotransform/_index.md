...
| virtual int [get_InputBlockSize](./get_inputblocksize/)() | Velikost vstupního bloku. |
| virtual int [get_OutputBlockSize](./get_outputblocksize/)() | Velikost výstupního bloku. |
...
| virtual int [TransformBlock](./transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Zpracovává blok dat a kopíruje data do výstupního pole. |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Zpracovává poslední blok dat a vypočítává výstupní hodnotu. |
