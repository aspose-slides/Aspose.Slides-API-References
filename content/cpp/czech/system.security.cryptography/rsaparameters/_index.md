...
description: "Datová struktura parametrů algoritmu RSA. Tento typ by měl být alokován na zásobníku a předáván funkcím hodnotou nebo referencí. Nikdy nepoužívejte třídu System::SmartPtr k řízení objektů tohoto typu."
type: docs
weight: 768
url: /cs/system.security.cryptography/rsaparameters/
---
## RSAParameters struct


[Data](../../system.data/) struktura parametrů algoritmu [RSA](../rsa/). Tento typ by měl být alokován na zásobníku a předáván funkcím hodnotou nebo referencí. Nikdy nepoužívejte [System::SmartPtr](../../system/smartptr/) class k řízení objektů tohoto typu.
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání dle C# lock() příkazu. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentry object. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí dle C# lock() příkazu. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentry object. |
