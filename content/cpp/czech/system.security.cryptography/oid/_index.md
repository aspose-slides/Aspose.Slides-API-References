...
description: "Kryptografický identifikátor objektu. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a tento ukazatel použijte při předávání do funkcí jako argument."
type: docs
weight: 339
url: /cs/system.security.cryptography/oid/
---
## Oid třída

Kryptografický identifikátor objektu. Instance této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel při předávání do funkcí jako argument.
...
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromFriendlyName](./fromfriendlyname/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Vytvoří objekt OID z uvedeného přátelského názvu OID. |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromOidValue](./fromoidvalue/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Vytvoří objekt OID ze specifikované hodnoty OID. |
| [String](../../system/string/) [get_FriendlyName](./get_friendlyname/)() const | Získá uživatelsky přívětivý název objektu. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Získá řetězec identifikátoru objektu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle příkazu C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
...
|  [Oid](./oid/)() | Výchozí konstruktor. |
|  [Oid](./oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](./)\>\&) | Kopírovací konstruktor. |
...
| void [set_FriendlyName](./set_friendlyname/)(const [String](../../system/string/)\&) | Nastaví uživatelsky přívětivý název objektu. |
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Nastaví řetězec identifikátoru objektu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí podle příkazu C# lock(). Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
