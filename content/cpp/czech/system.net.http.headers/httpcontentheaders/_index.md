...
description: "Representuje kolekci hlaviček 'Content'. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo porušením aserce. Vždy obalte tuto třídu ukazatelem System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 66
url: /cs/system.net.http.headers/httpcontentheaders/
---
## HttpContentHeaders třída
...
| Method | Description |
| --- | --- |
| void [Add](../httpheaders/add/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>) | Ověří nový pár jméno-hodnota a přidá jej do aktuální kolekce. |
| void [Add](../httpheaders/add/)([String](../../system/string/), [String](../../system/string/)) | Ověří nový pár jméno-hodnota a přidá jej do aktuální kolekce. |
| virtual void [AddHeaders](../httpheaders/addheaders/)([System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Spojí zadanou instanci HttpHeaders-class s aktuální. |
...
| void [AddParsedValue](../httpheaders/addparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Získá hlavičku podle zadaného názvu a přidá do ní analyzovanou hodnotu. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[String](../../system/string/)\>\> [get_Allow](./get_allow/)() | Získá hodnotu hlavičky 'Allow'. |
| [System::SharedPtr](../../system/sharedptr/)\<[ContentDispositionHeaderValue](../contentdispositionheadervalue/)\> [get_ContentDisposition](./get_contentdisposition/)() | Získá hodnotu hlavičky 'Content-Disposition'. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[String](../../system/string/)\>\> [get_ContentEncoding](./get_contentencoding/)() | Získá hodnotu hlavičky 'Content-Encoding'. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[String](../../system/string/)\>\> [get_ContentLanguage](./get_contentlanguage/)() | Získá hodnotu hlavičky 'Content-Language'. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_ContentLength](./get_contentlength/)() | Získá hodnotu hlavičky 'Content-Length'. |
| [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [get_ContentLocation](./get_contentlocation/)() | Získá hodnotu hlavičky 'Content-Location'. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_ContentMD5](./get_contentmd5/)() | Získá hodnotu hlavičky 'Content-MD5'. |
| [System::SharedPtr](../../system/sharedptr/)\<[ContentRangeHeaderValue](../contentrangeheadervalue/)\> [get_ContentRange](./get_contentrange/)() | Získá hodnotu hlavičky 'Content-Range'. |
| [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](../mediatypeheadervalue/)\> [get_ContentType](./get_contenttype/)() | Získá hodnotu hlavičky 'Content-Type'. |
| [Nullable](../../system/nullable/)\<[DateTimeOffset](../../system/datetimeoffset/)\> [get_Expires](./get_expires/)() | Získá hodnotu hlavičky 'Expires'. |
| [Nullable](../../system/nullable/)\<[DateTimeOffset](../../system/datetimeoffset/)\> [get_LastModified](./get_lastmodified/)() | Získá hodnotu hlavičky 'Last-Modified'. |
...
|  [HttpContentHeaders](./httpcontentheaders/)([HeaderFunc](../headerfunc/)\<[Nullable](../../system/nullable/)\<**int64_t**\>\>) | Vytvoří novou instanci. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Vrací první prvek sekvence, který splňuje podmínku, nebo výchozí hodnotu, pokud neexistuje takový prvek. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::List](../../system.collections.generic/list/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\>\> [ParsedValuesAsList](../httpheaders/parsedvaluesaslist/)(const [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Převede parsované hodnoty na seznam. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Porovnává objekty podle reference. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Porovnává objekty podle reference. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Porovnává objekt typu hodnoty s nullptr referencí. |
...
| **bool** [RemoveParsedValue](../httpheaders/removeparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Získá hlavičku podle zadaného názvu a odstraní z ní parsovanou hodnotu. |
| void [set_ContentDisposition](./set_contentdisposition/)([System::SharedPtr](../../system/sharedptr/)\<[ContentDispositionHeaderValue](../contentdispositionheadervalue/)\>) | Nastaví hodnotu hlavičky 'Content-Disposition'. |
| void [set_ContentLength](./set_contentlength/)([Nullable](../../system/nullable/)\<**int64_t**\>) | Nastaví hodnotu hlavičky 'Content-Length'. |
| void [set_ContentLocation](./set_contentlocation/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Nastaví hodnotu hlavičky 'Content-Location'. |
| void [set_ContentMD5](./set_contentmd5/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Nastaví hodnotu hlavičky 'Content-MD5'. |
| void [set_ContentRange](./set_contentrange/)([System::SharedPtr](../../system/sharedptr/)\<[ContentRangeHeaderValue](../contentrangeheadervalue/)\>) | Nastaví hodnotu hlavičky 'Content-Range'. |
| void [set_ContentType](./set_contenttype/)([System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](../mediatypeheadervalue/)\>) | Nastaví hodnotu hlavičky 'Content-Type'. |
| void [set_Expires](./set_expires/)([Nullable](../../system/nullable/)\<[DateTimeOffset](../../system/datetimeoffset/)\>) | Nastaví hodnotu hlavičky 'Expires'. |
| void [set_LastModified](./set_lastmodified/)([Nullable](../../system/nullable/)\<[DateTimeOffset](../../system/datetimeoffset/)\>) | Nastaví hodnotu hlavičky 'Last-Modified'. |
...
| void [SetOrRemoveParsedValue](../httpheaders/setorremoveparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Získá hlavičku podle zadaného názvu a nastaví nebo odstraní její hodnotu. Hodnota hlavičky bude odstraněna, když je parametr 'value' nullptr, jinak bude nastavena parsovaná hodnota. |
| void [SetParsedValue](../httpheaders/setparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Získá hlavičku podle zadaného názvu a nastaví hlavičce parsovanou hodnotu. |
...
| **bool** [TryAddWithoutValidation](../httpheaders/tryaddwithoutvalidation/)([String](../../system/string/), [String](../../system/string/)) | Pokusí se přidat nový pár jméno-hodnota do aktuální kolekce. |
| **bool** [TryAddWithoutValidation](../httpheaders/tryaddwithoutvalidation/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>) | Přidá kolekci párů jméno-hodnota do aktuální kolekce. |
...
| **bool** [TryParseAndAddValue](../httpheaders/tryparseandaddvalue/)([String](../../system/string/), [String](../../system/string/)) | Pokusí se parsovat zadanou hodnotu a přidat ji do hodnot hlavičky. |
