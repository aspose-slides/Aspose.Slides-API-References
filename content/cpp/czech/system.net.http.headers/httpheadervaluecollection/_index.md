...
description: "Representuje kolekci hodnot hlaviček. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání funkcím jako argument."
type: docs
weight: 92
url: /cs/system.net.http.headers/httpheadervaluecollection/
---
## HttpHeaderValueCollection třída

Reprezentuje kolekci hodnot hlaviček. Objektů této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
...
| Parametr | Popis |
| --- | --- |
| The | typ hodnot hlaviček reprezentovaných v kolekci. |

## Metody

| Metoda | Popis |
| --- | --- |
| void [Add](./add/)(const T\&) override | Přidá prvek do kolekce. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Zkontroluje, zda je prvek v kolekci přítomen. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | Zkopíruje všechny prvky kolekce do existujících prvků pole. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Získá hodnotu, která indikuje, zda je aktuální kolekce jen pro čtení. |
...
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Získá hodnotu, která indikuje, zda aktuální kolekce obsahuje "speciální hodnotu". |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Získá objekt, skrze který je kolekce synchronizována. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Získá enumerátor. |
...
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | Vrací řetězcovou reprezentaci aktuální kolekce bez "speciální hodnoty". |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analogie výzvy C# [System.Object.GetType()](../../system/object/gettype/). |
|   [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Vytvoří novou instanci. |
|   [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Vytvoří novou instanci. |
|   [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | Vytvoří novou instanci. |
|   [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Vytvoří novou instanci. |
...
|   [ICollection](../../system.collections.generic/icollection/icollection/)([ICollection](../../system.collections.generic/icollection/)\&&) | Konstruktor přenosu. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformaci na každý prvek obecné sekvence a vrací maximální výslednou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformaci na každý prvek obecné sekvence a vrací minimální výslednou hodnotu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamčení pomocí C# lock() výrazu. Volejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
|   [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Nezkopíruje nic, jen inicializuje nový objekt a umožní kopírovací konstrukci podtříd. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | Operátor přiřazení přenosu. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | Operátor přiřazení přenosu. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Nezkopíruje nic, jen inicializuje nový objekt a umožní kopírovací konstrukci podtříd. |
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | Analyzuje řetězec hlavičky a přidá jej do aktuální kolekce. |
...
| **bool** [Remove](./remove/)(const T\&) override | Odstraní prvek z kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| void [RemoveSpecialValue](./removespecialvalue/)() | Odstraní "speciální hodnotu". |
| void [SetSpecialValue](./setspecialvalue/)() | Nastaví "speciální hodnotu". |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý template argument jako slabý ukazatel (namísto sdíleného). Umožňuje přepnutí ukazatelů v kontejnerech do slabého režimu. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Analogie C# [Object.ToString()](../../system/object/tostring/) metody. Umožňuje převod uživatelských objektů na řetězec. |
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | Zkouší analyzovat řetězec hlavičky a přidat jej do aktuální kolekce. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukci C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock() výrazu. Volejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
