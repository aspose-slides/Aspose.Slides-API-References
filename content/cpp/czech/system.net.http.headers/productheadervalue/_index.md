...
description: "Zastupuje produktový token v hodnotě hlavičky 'User-Agent'. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 209
url: /cs/system.net.http.headers/productheadervalue/
---
## ProductHeaderValue třída

Představuje produktový token v hodnotě hlavičky 'User-Agent'. Objektů této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Vrací název produktového tokenu. |
| [String](../../system/string/) [get_Version](./get_version/)() | Vrací verzi produktového tokenu. |
...
| static **int32_t** [GetProductLength](./getproductlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\>\&) | Převádí předaný řetězec od zadaného indexu na instanci třídy [ProductHeaderValue](./). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# lock() příkazem. Volat přímo nebo použít objekt hlídky [LockContext](../../system/lockcontext/). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Převádí předaný řetězec na instanci třídy [ProductHeaderValue](./). |
|  [ProductHeaderValue](./productheadervalue/)([String](../../system/string/)) | Vytvoří novou instanci. |
|  [ProductHeaderValue](./productheadervalue/)([String](../../system/string/), [String](../../system/string/)) | Vytvoří novou instanci. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\>\&) | Pokusí se převést předaný řetězec na instanci třídy [ProductHeaderValue](./). |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukci C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí C# lock() příkazem. Volat přímo nebo použít objekt hlídky [LockContext](../../system/lockcontext/). |
