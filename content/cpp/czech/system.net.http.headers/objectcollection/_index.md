...
description: Představuje kolekci objektů.
type: docs
weight: 196
url: /cs/system.net.http.headers/objectcollection/
---
## ObjectCollection třída
...
| Parametr | Popis |
| --- | --- |
| T | Typ objektu. Objekty tohoto typu by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním assercí. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkcím jako argument. |

## Metody

| Metoda | Popis |
| --- | --- |
| void [Add](../../system.collections.objectmodel/collection/add/)(const T\&) override | Přidá hodnotu do kontejneru. |
...
| void [Clear](../../system.collections.objectmodel/collection/clear/)() override | Odstraní všechny prvky. |
| [Collection](../../system.collections.objectmodel/collection/collection/)() | Vytvoří prázdnou kolekci. |
...
| **bool** [Contains](../../system.collections.objectmodel/collection/contains/)(const T\&) const override | Kontroluje, zda je položka v kolekci přítomna. |
| void [CopyTo](../../system.collections.objectmodel/collection/copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Kopíruje prvky kolekce do existujících prvků pole. |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [crbegin](../../system.collections.objectmodel/collection/crbegin/)() const | Získá reverzní iterátor na poslední konstantně kvalifikovaný prvek kolekce (první v opačném směru). |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [crend](../../system.collections.objectmodel/collection/crend/)() const | Získá reverzní iterátor pro neexistující konstantně kvalifikovaný prvek před začátkem kolekce. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání čísel s plovoucí čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 NaN není roven žádné hodnotě, včetně NaN. |
...
| int [get_Count](../../system.collections.objectmodel/collection/get_count/)() const override | Získá počet prvků. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Kontroluje, zda je kolekce pevné velikosti. |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Kontroluje, zda je kolekce pouze ke čtení. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](../../system.collections.objectmodel/collection/get_items/)() | Přístup k interní datové struktuře. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](../../system.collections.objectmodel/collection/get_items/)() const | Přístup k interní datové struktuře. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.objectmodel/collection/getenumerator/)() override | Získá enumerátor pro iteraci kolekcí. |
...
| [ICollection](../../system.collections.generic/icollection/icollection/)([ICollection](../../system.collections.generic/icollection/)\&&) | Konstruktor přemístění. |
| T [idx_get](../../system.collections.objectmodel/collection/idx_get/)(int) const override | Získá hodnotu na zadaném indexu. |
| void [idx_set](../../system.collections.objectmodel/collection/idx_set/)(int, T) override | Nastaví hodnotu na zadaném indexu. |
| int [IndexOf](../../system.collections.objectmodel/collection/indexof/)(const T\&) const override | Hledá prvek v kolekci. |
| void [Insert](../../system.collections.objectmodel/collection/insert/)(int, const T\&) override | Vloží položku na zadanou pozici. |
...
| [ObjectCollection](./objectcollection/)() | Vytvoří novou instanci. |
| [ObjectCollection](./objectcollection/)([Action](../../system/action/)\<T\>) | Vytvoří novou instanci. |
...
| T\& [operator[]](../../system.collections.objectmodel/collection/operator[]/)(int) | Získá hodnotu na zadaném indexu. |
| const T\& [operator[]](../../system.collections.objectmodel/collection/operator[]/)(int) const | Získá hodnotu na zadaném indexu. |
| [reverse_iterator](../../system.collections.objectmodel/collection/reverse_iterator/) [rbegin](../../system.collections.objectmodel/collection/rbegin/)() | Získá reverzní iterátor na poslední prvek kolekce (první v opačném směru). |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [rbegin](../../system.collections.objectmodel/collection/rbegin/)() const | Získá reverzní iterátor na poslední prvek konstantně kvalifikované kolekce (první v opačném směru). |
...
| **bool** [Remove](../../system.collections.objectmodel/collection/remove/)(const T\&) override | Odstraní konkrétní položku. |
| void [RemoveAt](../../system.collections.objectmodel/collection/removeat/)(int) override | Odstraní položku na konkrétní pozici. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený počet referencí o zadanou hodnotu. |
| [reverse_iterator](../../system.collections.objectmodel/collection/reverse_iterator/) [rend](../../system.collections.objectmodel/collection/rend/)() | Získá reverzní iterátor pro neexistující prvek před začátkem kolekce. |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [rend](../../system.collections.objectmodel/collection/rend/)() const | Získá reverzní iterátor pro neexistující prvek před začátkem konstantně kvalifikované kolekce. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../../system.collections.objectmodel/collection/virtualizebeginconstiterator/)() const override | Získá implementaci začátku konstantního iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../../system.collections.objectmodel/collection/virtualizebeginiterator/)() override | Získá implementaci začátku iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.objectmodel/collection/virtualizeendconstiterator/)() const override | Získá implementaci konce konstantního iterátoru pro aktuální kontejner. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../../system.collections.objectmodel/collection/virtualizeenditerator/)() override | Získá implementaci konce iterátoru pro aktuální kontejner. |
...
* Třída [Collection](../../system.collections.objectmodel/collection/)
