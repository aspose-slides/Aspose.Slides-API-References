...
description: Převádí Presentation do SVG.
type: docs
weight: 27
...
Převádí [Presentation](../../../aspose.slides/presentation/) do SVG.
...
| --- | --- | --- |
| presPath | [System::String](../../../system/string/) | Cesta k vstupní prezentaci |
| getOutPath | [Convert::GetOutPathCallback](../getoutpathcallback/) | Zpětné volání, které vrací výstupní cestu SVG pro každý snímek v prezentaci |
## Poznámky
...
| --- | --- | --- |
| pres | [System::SharedPtr](../../../system/sharedptr/)\<[Presentation](../../../aspose.slides/presentation/)\> | Vstupní prezentace |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Aspose::Slides::Export::ISVGOptions](../../../aspose.slides.export/isvgoptions/)\> | Možnosti exportu SVG |
## Poznámky
...
* Definice typu [GetOutPathCallback](../getoutpathcallback/)
