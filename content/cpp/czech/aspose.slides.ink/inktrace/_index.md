...
description: Representuje objekt Trace. Prvek Trace se používá k zaznamenání dat zachycených digitalizérem. Obsahuje posloupnost bodů zakódovanou podle specifikace poskytnuté objektem InkTraceFormat.
type: docs
weight: 92
...
Reprezentuje objekt Trace. Prvek Trace se používá k zaznamenání dat zachycených digitalizérem. Obsahuje posloupnost bodů zakódovanou podle specifikace poskytnuté objektem InkTraceFormat.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() override | Získá Brush pro IInkLine [IInkBrush](../iinkbrush/) jen pro čtení. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | Získá body pro IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) jen pro čtení. |
