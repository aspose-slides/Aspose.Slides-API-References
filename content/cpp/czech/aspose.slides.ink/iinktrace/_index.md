...
description: Reprezentuje ručně psaný řádek v objektu Ink.
type: docs
weight: 40
...
Reprezentuje ručně psaný řádek v objektu [Ink](../ink/).
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() | Získá Brush pro IInkLine [IInkBrush](../iinkbrush/) jen pro čtení. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Získá body pro IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) jen pro čtení. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání dle C# lock(). Volá se přímo nebo pomocí objektu strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání dle C# lock(). Volá se přímo nebo pomocí objektu strážce [LockContext](../../system/lockcontext/). |
