...
description: Reprezentuje stopový štětec.
type: docs
weight: 27
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Získává barvu štětce pro čáru. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Získává typ efektu inkoustu (např. Galaxy, Gold, Silver), který určuje vizuální styl tahů inkoustu. Hodnota je získána z vlastnosti štětce "inkEffects". Pokud není zadán žádný rozpoznaný efekt, je vráceno [InkEffectType::NotDefined](../inkeffecttype/). |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Získává velikost štětce pro čáru v bodech. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Nastavuje barvu štětce pro čáru. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Nastavuje velikost štětce pro čáru v bodech. |
