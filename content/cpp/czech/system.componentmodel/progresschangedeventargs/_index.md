...
| int [get_ProgressPercentage](./get_progresspercentage/)() const | Získává procento postupu asynchronního úkolu. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_UserState](./get_userstate/)() const | Získává jedinečný stav uživatele. |
...
| Pole | Popis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statický člen, který představuje „prázdný“ sdílený ukazatel [EventArgs](../../system/eventargs/) (ukazatel null). |
