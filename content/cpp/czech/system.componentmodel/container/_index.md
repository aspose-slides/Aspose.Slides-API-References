...
description: "Fiktivní třída pro přeložený kód používající třídu Container k fungování. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k běhovým chybám a/nebo chybám tvrzení. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání funkcím jako argument."
type: docs
weight: 53
url: /cs/system.componentmodel/container/
---
## Container třída

Dummy třída pro přeložený kód používající [Container](./) třídu k fungování. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k běhovým chybám a/nebo chybám tvrzení. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkcím jako argument.
...
| Metoda | Popis |
| --- | --- |
| void [Dispose](./dispose/)() | Informace RTTI. |
| void [Dispose](./dispose/)(**bool**) | Podpora vzoru Disposable; nic nedělá. |
