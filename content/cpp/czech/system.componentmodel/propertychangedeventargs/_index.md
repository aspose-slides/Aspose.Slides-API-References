...
| virtual [String](../../system/string/) [get_PropertyName](./get_propertyname/)() | Získá název vlastnosti spojené s událostí. |
...
|  [PropertyChangedEventArgs](./propertychangedeventargs/)(const [String](../../system/string/)\&) | Inicializuje argumenty události PropertyChanged. |
...
| Field | Description |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statický člen, který představuje "prázdný" [EventArgs](../../system/eventargs/) sdílený ukazatel (ukazatel null). |
