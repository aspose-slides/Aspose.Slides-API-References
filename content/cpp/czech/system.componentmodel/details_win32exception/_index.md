...
description: "Vyhodí výjimku pro kód chyby Win32. Nikdy nevytvářejte instance této třídy ručně. Použijte místo toho třídu Win32Exception. Nikdy nezabaluje instance třídy Win32Exception do System::SmartPtr."
type: docs
weight: 79
url: /cs/system.componentmodel/details_win32exception/
---

## Details_Win32Exception třída

Vyhodí výjimku pro kód chyby Win32. Nikdy nevytvářejte instance této třídy ručně. Použijte třídu Win32Exception místo toho. Nikdy nezabaluje instance třídy Win32Exception do [System::SmartPtr](../../system/smartptr/).
...
| virtual **int32_t** [get_ErrorCode](../../system/details_exceptionwitherrorcode/get_errorcode/)() const | Získává HRESULT chyby. |
...
| virtual **int32_t** [get_NativeErrorCode](./get_nativeerrorcode/)() const | Získává Win32 kód chyby spojený s touto výjimkou. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodu [what()](../../system/details_exception/what/), která je volána třídou [ExceptionWrapper](../../system/exceptionwrapper/). Navzdory tomu, že tato třída nezdědí z std::exception, odvozené třídy mohou používat chráněné/soukromé členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../../system/exceptionwrapper/) může tuto logiku narušit. |
| virtual  [~Object](../../system/object/~object/)() | Ničí objekt. Uvolňuje všechny interní datové struktury. |

## Viz také

* Třída [Details_ExceptionWithErrorCode](../../system/details_exceptionwitherrorcode/)
