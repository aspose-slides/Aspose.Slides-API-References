...
description: "Fiktivní třída umožňující kompilaci přeloženého kódu používajícího třídu Component. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 40
url: /cs/system.componentmodel/component/
---
## Komponentní třída


Fiktivní třída pro umožnění přeloženého kódu používajícího třídu [Component](./) kompilovatelného. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo porušením aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel při předávání jako argument funkcím.
...
| Method | Description |
| --- | --- |
|  [Component](./component/)() | Informace RTTI. |
| void [Dispose](./dispose/)(**bool**) | Podpora vzoru Disposable; nedělá nic. |
...
| **bool** [get_DesignMode](./get_designmode/)() | Kontroluje, zda je komponenta v režimu návrhu. |
...
* Třída [MarshalByRefObject](../../system/marshalbyrefobject/)
* Třída [IComponent](../icomponent/)
