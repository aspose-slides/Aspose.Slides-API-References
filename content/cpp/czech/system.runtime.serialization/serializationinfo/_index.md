...
description: "Obsahuje sadu pojmenovaných polí představujících serializovaný objekt. Není implementováno. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy obalte tuto třídu ukazatelem System::SmartPtr a použijte tento ukazatel při předávání jako argument funkcím."
type: docs
weight: 53
url: /cs/system.runtime.serialization/serializationinfo/
---
## Třída SerializationInfo

Obsahuje sadu pojmenovaných polí představujících serializovaný objekt. Není implementováno. Instance této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy obalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| Metoda | Popis |
| --- | --- |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, **float**) | Vkládá **float** hodnotu. Není implementováno. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, short) | Vkládá short hodnotu. Není implementováno. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, **bool**) | Vkládá **bool** hodnotu. Není implementováno. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Vkládá hodnotu objektu. Není implementováno. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&, const [System::TypeInfo](../../system/typeinfo/)\&) | Vkládá hodnotu objektu se specifikovaným typem. Není implementováno. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [GetValue](./getvalue/)(const [System::String](../../system/string/)\&, const [System::TypeInfo](../../system/typeinfo/)\&) | Načte hodnotu ze skladu [SerializationInfo](./). Není implementováno. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Vlastně nic nepřiřazuje, pouze inicializuje nový objekt a umožňuje kopírování podtříd. |
...
|  [SerializationInfo](./serializationinfo/)(const [System::TypeInfo](../../system/typeinfo/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[IFormatterConverter](../iformatterconverter/)\>\&) | Informace RTTI. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
