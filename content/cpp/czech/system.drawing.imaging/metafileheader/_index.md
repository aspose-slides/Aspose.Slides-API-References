...
description: "Obsahuje atributy spojené s grafickým metafilem. Instance této třídy by měly být alokovány výhradně pomocí funkce System::MakeObject() . Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to může vést k chybám za běhu a/nebo porušením asertací. Vždy tuto třídu zabalte do ukazatele System::SmartPtr a použijte tento ukazatel k předávání do funkcí jako argument."
type: docs
weight: 157
url: /cs/system.drawing.imaging/metafileheader/
---
## MetafileHeader třída

Obsahuje atributy spojené s grafickým metafilem. Instance této třídy by měly být alokovány výhradně pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to může vést k chybám za běhu a/nebo porušením asertací. Vždy tuto třídu zabalte do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předávání do funkcí jako argument.
...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() const | Vrací ohraničující obdélník metafile spojený s aktuálním objektem. |
| **float** [get_DpiX](./get_dpix/)() const | NEIMPLEMENTOVÁNO. |
| **float** [get_DpiY](./get_dpiy/)() const | NEIMPLEMENTOVÁNO. |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamykání pomocí C# lock() výrazu. Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [set_Bounds](./set_bounds/)(const [Rectangle](../../system.drawing/rectangle/)\&) | Nastavuje ohraničující obdélník metafile spojený s aktuálním objektem. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony jako slabý ukazatel (spíše než sdílený). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() výrazu. Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
