...
| Metoda | Popis |
| --- | --- |
|  [EncoderParameters](./encoderparameters/)(int) | Vytvoří novou instanci třídy [EncoderParameters](./). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\> [get_Param](./get_param/)() const | Vrací pole objektů [EncoderParameter](../encoderparameter/) reprezentovaných aktuálním objektem [EncoderParameters](./). |
...
| void [set_Param](./set_param/)(const [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\>\&) | Přiřadí pole objektů [EncoderParameter](../encoderparameter/) aktuálnímu objektu [EncoderParameters](./). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvyšuje sdílený čitatel referencí. Neměl by být volán přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Snižuje a vrací sdílený čitatel referencí. Neměl by být volán přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý čitatel referencí. Neměl by být volán přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje slabý čitatel referencí. Neměl by být volán přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
