...
description: "Poskytuje informace o kodeku obrazu. Objekty této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku nebo pomocí operátoru new, protože to může vést k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání jako argument funkcím."
type: docs
weight: 118
url: /cs/system.drawing.imaging/imagecodecinfo/
---
## ImageCodecInfo třída


Poskytuje informace o kodeku obrazu. Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy neinstanciujte tento typ na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím.
...
| [Guid](../../system/guid/) [get_FormatID](./get_formatid/)() const | Vrací GUID spojený s formátem kodeku reprezentovaného aktuálním objektem. |
| [System::String](../../system/string/) [get_MimeType](./get_mimetype/)() | Vrací typ Multipurpose Internet Mail Extensions (MIME) kodeku reprezentovaného aktuálním objektem. |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[ImageCodecInfoPtr](../imagecodecinfoptr/)\> [GetImageDecoders](./getimagedecoders/)() | Vrací pole objektů [ImageCodecInfo](./), které představují podporované dekodéry obrázků. |
| static [System::ArrayPtr](../../system/arrayptr/)\<[ImageCodecInfoPtr](../imagecodecinfoptr/)\> [GetImageEncoders](./getimageencoders/)() | Vrací pole objektů [ImageCodecInfo](./), které představují podporované enkodéry obrázků. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# lock() příkazem. Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [set_FormatID](./set_formatid/)(const [Guid](../../system/guid/)\&) | Nastavuje GUID spojený s formátem kodeku reprezentovaného aktuálním objektem. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání C# lock() příkazem. Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý počet referencí. Nemělo by se volat příně; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje slabý počet referencí. Nemělo by se volat příně; místo toho použijte chytré ukazatele nebo ThisProtector. |
