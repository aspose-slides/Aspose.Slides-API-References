...
description: "Representuje metadatovou vlastnost, která má být zahrnuta do souboru obrázku. Instance této třídy by měly být alokovány pouze pomocí funkce System::MakeObject(). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele System::SmartPtr a použijte tento ukazatel k předání funkcím jako argument."
type: docs
weight: 170
url: /cs/system.drawing.imaging/propertyitem/
---
## PropertyItem třída

Reprezentuje metadata vlastnost, která má být zahrnuta do souboru obrázku. Instance této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instanci tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání funkcím jako argument.
...
| **int32_t** [get_Id](./get_id/)() const | Vrací ID vlastnosti reprezentované aktuálním objektem. |
| **int32_t** [get_Len](./get_len/)() const | Vrací délku vlastnosti reprezentované aktuálním objektem v bajtech. |
| **int16_t** [get_Type](./get_type/)() const | Vrací typ vlastnosti reprezentované aktuálním objektem v bajtech. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Value](./get_value/)() const | Vrací hodnotu vlastnosti reprezentované aktuálním objektem v bajtech. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získává datovou strukturu počítadla odkazů přidruženou k objektu. |
...
| [PropertyItem](./propertyitem/)() | Vytváří novou instanci třídy [PropertyItem](./). |
...
| void [set_Id](./set_id/)(**int32_t**) | Nastavuje ID vlastnosti reprezentované aktuálním objektem. |
| void [set_Len](./set_len/)(**int32_t**) | Nastavuje délku vlastnosti reprezentované aktuálním objektem v bajtech. |
| void [set_Type](./set_type/)(**int16_t**) | Nastavuje typ vlastnosti reprezentované aktuálním objektem v bajtech. |
| void [set_Value](./set_value/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Nastavuje typ vlastnosti reprezentované aktuálním objektem v bajtech. |
