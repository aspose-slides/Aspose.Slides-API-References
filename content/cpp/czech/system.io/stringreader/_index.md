...
| Metoda | Popis |
| --- | --- |
| void [Close](./close/)() override | Uzavře stream. |
| void [Dispose](./dispose/)() override | Nedělá nic. |
| void [Dispose](./dispose/)(**bool**) override | Nedělá nic. |
...
| int [Peek](./peek/)() override | Přečte jeden znak ze streamu bez změny pozice streamu. |
| int [Read](./read/)() override | Přečte jeden znak ze streamu. |
| int [Read](./read/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) override | Přečte určený počet znaků ze streamu do určeného pole znaků začínajícího na určené pozici. |
| virtual int [ReadBlock](../textreader/readblock/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | Přečte maximální počet znaků z aktuálního textového čtečky a zapíše data do bufferu počínaje určeným indexem. |
| [String](../../system/string/) [ReadLine](./readline/)() override | Čte znaky ze streamu až do konce aktuálního řádku. |
| [String](../../system/string/) [ReadToEnd](./readtoend/)() override | Čte znaky ze streamu až do konce streamu. |
...
|  [StringReader](./stringreader/)(const [String](../../system/string/)\&) | Vytvoří novou instanci třídy [StringReader](./), která čte znaky z určeného řetězce. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí příkazu C# lock(). Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
