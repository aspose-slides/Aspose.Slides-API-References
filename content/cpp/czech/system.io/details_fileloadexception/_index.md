...
type: docs
weight: 170
url: /cs/system.io/details_fileloadexception/
---
## Details_FileLoadException třída
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje [what()](../../system/details_exception/what/) metodu, která je volána třídou [ExceptionWrapper](../../system/exceptionwrapper/). Navzdory tomu, že tato třída není odvozena od std::exception, mohou odvozené třídy použít chráněné/soukromé členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../../system/exceptionwrapper/) může tuto logiku porušit. |
