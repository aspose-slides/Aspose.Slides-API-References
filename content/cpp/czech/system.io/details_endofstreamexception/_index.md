...
type: docs
weight: 157
url: /cs/system.io/details_endofstreamexception/
---
## Details_EndOfStreamException třída
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodu [what()](../../system/details_exception/what/), která je volána třídou [ExceptionWrapper](../../system/exceptionwrapper/). Přestože tato třída nezdědí ze std::exception, odvozené třídy mohou použít chráněné/privátní členy k implementaci jejich logiky. Přesunutí implementace této metody do [ExceptionWrapper](../../system/exceptionwrapper/) může tuto logiku porušit. |
