...
type: docs
weight: 27
url: /cs/system.io/details_ioexception/is/
---
## Podrobnosti_IOException::Is(const System::TypeInfo\&) const metoda
...
Zkontrolujte, zda objekt představuje instanci typu popsaného parametrem targetType. Analogie operátoru C# 'is'.
## Viz také

* Třída [TypeInfo](../../../system/typeinfo/)
* Třída [Details_IOException](../)
