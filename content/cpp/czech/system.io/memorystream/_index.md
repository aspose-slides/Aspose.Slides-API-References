...
| void [Close](./close/)() override | Uzavře proud. |
| void [CopyTo](../stream/copyto/)(const [SharedPtr](../../system/sharedptr/)\<[Stream](../stream/)\>\&) | Kopíruje bajty do určeného proudu. |
| void [CopyTo](../stream/copyto/)(const [SharedPtr](../../system/sharedptr/)\<[Stream](../stream/)\>\&, **int32_t**) | Kopíruje bajty do určeného proudu s použitím zadané velikosti bufferu. |
...
| virtual void [EndWrite](../stream/endwrite/)([System::SharedPtr](../../system/sharedptr/)\<[System::IAsyncResult](../../system/iasyncresult/)\>) | Ukončuje asynchronní operaci zápisu. Čeká, až se dokončí zadaná asynchronní operace zápisu. |
...
| virtual [TaskPtr](../../system/taskptr/) [FlushAsync](../stream/flushasync/)(const [Threading::CancellationToken](../../system.threading/cancellationtoken/)\&) | Asynchronně vyprázdní všechny vyrovnávací paměti tohoto proudu, způsobí, že veškerá vyrovnaná data budou zapsána do podkladového zařízení, a monitoruje požadavky na zrušení. |
| [TaskPtr](../../system/taskptr/) [FlushAsync](../stream/flushasync/)() | Asynchronně vyprázdní všechny vyrovnávací paměti tohoto proudu, způsobí, že veškerá vyrovnaná data budou zapsána do podkladového zařízení, a monitoruje požadavky na zrušení. |
| **bool** [get_CanRead](./get_canread/)() const override | Určuje, zda je proud čitelný. |
| **bool** [get_CanSeek](./get_canseek/)() const override | Určuje, zda proud podporuje seekování. |
...
| int [get_Capacity](./get_capacity/)() | Vrací aktuální kapacitu podkladového paměťového bufferu. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetBuffer](./getbuffer/)() | Vrací ukazatel na podkladový buffer. |
...
|  [MemoryStream](./memorystream/)() | Vytvoří novou instanci třídy [MemoryStream](./) s počáteční kapacitou rovnající se 0. |
|  [MemoryStream](./memorystream/)(int) | Vytvoří novou instanci třídy [MemoryStream](./), která představuje proud založený na paměťovém bufferu zadané velikosti. |
|  [MemoryStream](./memorystream/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **bool**) | Vytvoří novou instanci třídy [MemoryStream](./), která představuje paměťový proud připojený k zadanému paměťovému bufferu. Parametr určuje, zda je proud zapisovatelný. |
|  [MemoryStream](./memorystream/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int, **bool**, **bool**) | Vytvoří novou instanci třídy [MemoryStream](./), která představuje paměťový proud připojený k segmentu zadaného paměťového bufferu začínajícím na zadaném indexu a zahrnujícím zadaný počet prvků. Parametry určují, zda je proud zapisovatelný a zda lze zavolat metoda GetBytes(). |
|  [Object](../../system/object/object/)() | Vytvoří objekt. Inicializuje všechny interní datové struktury. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| **int32_t** [Read](./read/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | Čte z proudu zadaný počet bajtů a zapisuje je do určeného pole bajtů. |
| **int32_t** [Read](./read/)(const System::Details::ArrayView\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | Čte z proudu zadaný počet bajtů a zapisuje je do určeného pole bajtů. |
| **int32_t** [Read](../stream/read/)(const System::Details::StackArray\<**uint8_t**, N\>\&, **int32_t**, **int32_t**) | Čte z proudu zadaný počet bajtů a zapisuje je do určeného pole bajtů. |
| virtual **int32_t** [Read](../stream/read/)(const [System::Span](../../system/span/)\<**uint8_t**\>\&) | Čte z proudu zadaný počet bajtů a zapisuje je do určeného rozmezí bajtů. |
...
| [RTaskPtr](../../system/rtaskptr/)\<**int32_t**\> [ReadAsync](../stream/readasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) | Asynchronně čte sekvenci bajtů z aktuálního proudu, posouvá pozici v proudu o počet přečtených bajtů a monitoruje požadavky na zrušení. |
| int [ReadByte](./readbyte/)() override | Čte jeden bajt z proudu a vrací 32-bitovou celočíselnou hodnotu odpovídající hodnotě přečteného bajtu. |
...
| void [set_Capacity](./set_capacity/)(int) | Nastaví kapacitu podkladového paměťového bufferu. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementuje a vrací sdílený referenční čítač. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToArray](./toarray/)() | Vrací kopii podkladového paměťového bufferu jako pole bajtů. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje převod vlastních objektů na řetězec. |
| **bool** [TryGetBuffer](./trygetbuffer/)([ArraySegment](../../system/arraysegment/)\<**uint8_t**\>\&) | Vrací pole nepodepsaných bajtů, ze kterých byl tento proud vytvořen. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementuje slabý referenční čítač. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [Write](./write/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | Zapíše zadaný podrozsah bajtů z určeného pole bajtů do proudu. |
| void [Write](./write/)(const System::Details::ArrayView\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | Zapíše zadaný podrozsah bajtů z určeného pole bajtů do proudu. |
| void [Write](../stream/write/)(const System::Details::StackArray\<**uint8_t**, N\>\&, **int32_t**, **int32_t**) | Zapíše zadaný podrozsah bajtů z určeného pole bajtů do proudu. |
...
| virtual [TaskPtr](../../system/taskptr/) [WriteAsync](../stream/writeasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**, const [Threading::CancellationToken](../../system.threading/cancellationtoken/)\&) | Asynchronně zapisuje sekvenci bajtů do aktuálního proudu, posouvá aktuální pozici v tomto proudu o počet zapsaných bajtů a monitoruje požadavky na zrušení. |
| [TaskPtr](../../system/taskptr/) [WriteAsync](../stream/writeasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) | Asynchronně zapisuje sekvenci bajtů do aktuálního proudu, posouvá aktuální pozici v tomto proudu o počet zapsaných bajtů a monitoruje požadavky na zrušení. |
| void [WriteByte](./writebyte/)(**uint8_t**) override | Zapíše zadanou nepodepsanou 8-bitovou celočíselnou hodnotu do proudu. |
| virtual void [WriteTo](./writeto/)([SharedPtr](../../system/sharedptr/)\<[Stream](../stream/)\>) | Zapíše obsah podkladového bufferu do určeného proudu. |
...
| Typedef | Popis |
| --- | --- |
| [Ptr](./ptr/) | Alias pro sdílený ukazatel na sebe sama. |
