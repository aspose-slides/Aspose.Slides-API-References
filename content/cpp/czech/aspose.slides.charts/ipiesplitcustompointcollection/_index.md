...
description: Reprezentuje kolekci bodů, které mají být vykresleny ve druhém výseku koláče nebo sloupci v grafu typu bar-of-pie nebo pie-of-pie s vlastním rozdělením.
type: docs
weight: 1158
url: /cs/aspose.slides.charts/ipiesplitcustompointcollection/
---
## IPieSplitCustomPointCollection třída
...
| Metoda | Popis |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Přidá datový bod podle jeho indexu v kolekci bodů nadřazené řady. |
...
| virtual void [Clear](../../system.collections.generic/icollection/clear/)() | Odstraní všechny prvky z kolekce. |
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T\&) const | Zkontroluje, zda je prvek v kolekci přítomen. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C# pro typ double, kde jsou dvě NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
...
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Zkontroluje, zda je kolekce pouze pro čtení. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Vrací datový bod grafu podle indexu. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Zavolá transformační funkci na každý prvek obecné sekvence a vrátí maximální získanou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Zavolá transformační funkci na každý prvek obecné sekvence a vrátí minimální získanou hodnotu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# příkazu lock(). Volat přímo nebo použít [LockContext](../../system/lockcontext/). |
...
| virtual void [Remove](./remove/)(**int32_t**) | Odstraní položku z kolekce podle jejího indexu v kolekci bodů nadřazené řady. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Odstraní prvek z kolekce. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# příkazu lock(). Volat přímo nebo použít [LockContext](../../system/lockcontext/). |
