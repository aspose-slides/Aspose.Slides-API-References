...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() | Vrací efekty použité v grafu. Pouze ke čtení [IEffectFormat](../../aspose.slides/ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../../aspose.slides/ithreedformat/)\> [get_Effect3D](./get_effect3d/)() | Vrací 3D formát grafu. Pouze ke čtení [IThreeDFormat](../../aspose.slides/ithreedformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_Fill](./get_fill/)() | Vrací vlastnosti výplňového stylu grafu. Pouze ke čtení [IFillFormat](../../aspose.slides/ifillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_Line](./get_line/)() | Vrací vlastnosti čárového stylu grafu. Pouze ke čtení [ILineFormat](../../aspose.slides/ilineformat/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazu C# lock(). Zavolejte přímo nebo použijte objekt střežce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání příkazu C# lock(). Zavolejte přímo nebo použijte objekt střežce [LockContext](../../system/lockcontext/). |
