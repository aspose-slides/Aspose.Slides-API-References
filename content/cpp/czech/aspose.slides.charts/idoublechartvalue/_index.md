...
---
## IDoubleChartValue třída

Reprezentuje hodnotu typu double, která může být uložena v prezentaci pptx dvěma způsoby: 1) v buňce/buňkách sešitu souvisejících s grafem; 2) jako doslovná hodnota.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](../isinglecellchartvalue/get_ascell/)() | Vrací buňku dat grafu. Čtěte [IChartDataCell](../ichartdatacell/). |
| virtual **double** [get_AsLiteralDouble](./get_asliteraldouble/)() | Vrací doslovnou hodnotu typu double, pokud DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/). Čtěte **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Určuje, zda je aktuální vlastnost AsCell nebo AsLiteralString nebo AsLiteralDouble. Jinými slovy určuje typ hodnoty vlastnosti Data. Tato vlastnost je jen pro čtení. Pro změnu hodnoty této vlastnosti můžete použít jednu z vlastností ChartDataPointCollection.DataSourceTypeFor<...>. Čtěte [DataSourceType](../datasourcetype/). |
...
| virtual void [set_AsCell](../isinglecellchartvalue/set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Nastaví buňku dat grafu. Zapište [IChartDataCell](../ichartdatacell/). |
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | Nastaví doslovnou hodnotu typu double, pokud DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/). Zapište **double**. |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Určuje, zda je aktuální vlastnost AsCell nebo AsLiteralString nebo AsLiteralDouble. Jinými slovy určuje typ hodnoty vlastnosti Data. Tato vlastnost je jen pro čtení. Pro změnu hodnoty této vlastnosti můžete použít jednu z vlastností ChartDataPointCollection.DataSourceTypeFor<...>. Zapište [DataSourceType](../datasourcetype/). |
...
| virtual **double** [ToDouble](./todouble/)() | Převede na double. |
...
* Třída [ISingleCellChartValue](../isinglecellchartvalue/)
