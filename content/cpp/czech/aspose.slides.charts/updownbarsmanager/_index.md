...
description: Poskytuje přístup k up/down pruhům grafu typu Line nebo Stock.
type: docs
weight: 1392
...
Poskytuje přístup k up/down pruhům grafu typu Line nebo Stock.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | Vrací formát DownBars. Pouze pro čtení [IFormat](../iformat/). |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth. Pouze pro čtení **int32_t**. |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars. Pouze pro čtení **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | Vrací formát UpBars. Pouze pro čtení [IFormat](../iformat/). |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth. Zápis **int32_t**. |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars. Zápis **bool**. |
...
* Třída [IUpDownBarsManager](../iupdownbarsmanager/)
