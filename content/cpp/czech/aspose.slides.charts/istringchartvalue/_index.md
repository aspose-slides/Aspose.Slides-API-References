...
description: "Reprezentuje řetězcovou hodnotu, která může být uložena v dokumentu prezentace pptx dvěma způsoby: 1) v buňce/bunicích sešitu souvisejícího s diagramem; 2) jako literální hodnota."
type: docs
weight: 1197
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](../imultiplecellchartvalue/get_ascell/)(**int32_t**) | Vrací buňku diagramu na zadaném indexu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](../imultiplecellchartvalue/get_ascells/)() | Vrací kolekci buněk diagramu. Přečtěte si [IChartCellCollection](../ichartcellcollection/). |
| virtual [System::String](../../system/string/) [get_AsLiteralString](./get_asliteralstring/)() | Vrací literální řetězec, pokud je vlastnost DataSourceType [DataSourceType::StringLiterals](../datasourcetype/). Přečtěte si [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Určuje, zda je vlastnost AsCell, AsLiteralString nebo AsLiteralDouble aktuální. Jinými slovy specifikuje typ hodnoty vlastnosti Data. Tato vlastnost je jen pro čtení. Pro změnu hodnoty této vlastnosti můžete použít jednu z vlastností ChartDataPointCollection.DataSourceTypeFor<...>. Přečtěte si [DataSourceType](../datasourcetype/). |
| virtual [System::String](../../system/string/) [GetCellsAddressInWorkbook](./getcellsaddressinworkbook/)() | Pokud je vlastnost DataSourceType [DataSourceType::Worksheet](../datasourcetype/), tato metoda vrací adresu buněk v sešitu, které představují řetězcová data. V opačném případě vrátí prázdný řetězec. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla odkazů spojenou s objektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógie C# [Object.GetHashCode()](../../system/object/gethashcode/) metody. Umožňuje hašování vlastních objektů. |
...
| virtual void [set_AsCells](../imultiplecellchartvalue/set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) | Nastavuje kolekci buněk diagramu. Zapište [IChartCellCollection](../ichartcellcollection/). |
| virtual void [set_AsLiteralString](./set_asliteralstring/)([System::String](../../system/string/)) | Nastavuje literální řetězec, pokud je vlastnost DataSourceType [DataSourceType::StringLiterals](../datasourcetype/). Zapište [System::String](../../system/string/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Určuje, zda je vlastnost AsCell, AsLiteralString nebo AsLiteralDouble aktuální. Jinými slovy specifikuje typ hodnoty vlastnosti Data. Tato vlastnost je jen pro čtení. Pro změnu hodnoty této vlastnosti můžete použít jednu z vlastností ChartDataPointCollection.DataSourceTypeFor<...>. Zapište [DataSourceType](../datasourcetype/). |
| virtual void [SetFromOneCell](./setfromonecell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Nastavuje hodnotu ze zadané buňky. |
...
* Třída [IMultipleCellChartValue](../imultiplecellchartvalue/)
