...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Vrací styly čáry, výplně a efektu objektu. Pouze pro čtení [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | Pravda, pokud má tabulka dat grafu horizontální okraje buněk. Čte **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | Pravda, pokud má tabulka dat grafu obrysové okraje. Čte **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | Pravda, pokud má tabulka dat grafu vertikální okraje buněk. Čte **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | Pravda, pokud je klíč legendy popisků dat viditelný. Čte **bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Volá se přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | Pravda, pokud má tabulka dat grafu horizontální okraje buněk. Zapíše **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | Pravda, pokud má tabulka dat grafu obrysové okraje. Zapíše **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | Pravda, pokud má tabulka dat grafu vertikální okraje buněk. Zapíše **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | Pravda, pokud je klíč legendy popisků dat viditelný. Zapíše **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock(). Volá se přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
