...
description: Representuje kolekci IChartSeries
type: docs
weight: 833
url: /cs/aspose.slides.charts/ichartseriescollection/
---
## IChartSeriesCollection třída


Representuje kolekci [IChartSeries](../ichartseries/)
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) | Vytvoří novou sérii grafu a přidá ji do kolekce. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) | Vytvoří novou sérii grafu z [IChartDataCell](../ichartdatacell/) a přidá ji do kolekce. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) | Vytvoří novou sérii grafu z [IChartCellCollection](../ichartcellcollection/) a přidá ji do kolekce. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) | Vytvoří novou sérii grafu z hodnoty a přidá ji do kolekce. |
...
| virtual void [Clear](./clear/)() | Odstraní všechny prvky (včetně stylu grafu) z kolekce. |
...
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Vrací hodnotu indikující, zda je přístup ke kolekci synchronizovaný (thread-safe). Pouze pro čtení **bool**. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu čítače referencí spjatou s objektem. |
...
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Vyhledá zadaný [IChartSeries](../ichartseries/) a vrátí index (od nuly) první výskyt v celé kolekci. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) | Vytvoří novou sérii grafu a vloží ji do kolekce. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Vypočítá průměr sekvence hodnot, které jsou získány voláním transformační funkce na každém prvku vstupní sekvence. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Odstraní zadanou hodnotu. |
