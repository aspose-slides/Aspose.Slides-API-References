...
description: Reprezentuje list spojený s IChartDataCell
type: docs
weight: 742
url: /cs/aspose.slides.charts/ichartdataworksheet/
---
## IChartDataWorksheet třída
...
| virtual **int32_t** [get_Index](./get_index/)() | Získává index. Pouze pro čtení **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Získává název. Pouze pro čtení [System::String](../../system/string/). |
