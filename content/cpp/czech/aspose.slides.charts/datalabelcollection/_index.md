...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Získá iterátor ukazující na první prvek (pokud existuje) instanci kolekce s kvalifikátorem const. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Získá iterátor ukazující na první prvek s kvalifikátorem const (pokud existuje) kolekce. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Získá iterátor ukazující těsně za posledním prvkem s kvalifikátorem const (pokud existuje) kolekce. |
...
| **int32_t** [get_Count](./get_count/)() override | Získá počet všech popisků dat v kolekci. Pouze ke čtení **int32_t**. |
| **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() override | Získá počet viditelných popisků dat v kolekci. Pouze ke čtení **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() override | Získá výchozí formát popisku dat. Pouze ke čtení [IDataLabelFormat](../idatalabelformat/). |
| **bool** [get_IsVisible](./get_isvisible/)() override | Hodnota false znamená, že popisek dat není ve výchozím nastavení viditelný (a proto jsou všechny příznaky Show* (ShowValue, ...) vlastnosti DefaultDataLabelFormat nastaveny na false). Pouze ke čtení **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() override | Zastupuje formát vedoucích čar popisků dat. Pouze ke čtení [IChartLinesFormat](../ichartlinesformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() override | Získá nadřazenou sérii. Pouze ke čtení [IChartSeries](../ichartseries/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spojenou s objektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který prochází kolekci. |
...
| void [Hide](./hide/)() override | Zpřístupní popisek dat jako skrytý ve výchozím nastavení nastavením všech příznaků Show* (ShowValue, ...) vlastnosti DefaultDataLabelFormat do stavu false. IsVisible bude po tomto nastavení false. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) override | Získá popisek dat pro datový bod se zadaným indexem. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) override | Vrací index zadaného [DataLabel](../datalabel/) v kolekci. |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamčení příkazu C# lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nastaví n-tý argument šablony jako slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
...
* Třída [IDataLabelCollection](../idatalabelcollection/)
