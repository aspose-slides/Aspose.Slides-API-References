...
description: "Výčet skupin kombinovatelných typů řad. Každý prvek se vztahuje ke skupině typů řad grafu, které mohou existovat současně v jednom ChartSeriesGroup. Například řady ChartType::PercentsStackedArea nemohou být současně s řadami ChartType::StackedArea v jednom ChartSeriesGroup. Ale dvě nebo více řad ChartType::PercentsStackedArea mohou být v jednom ChartSeriesGroup současně (CombinableSeriesTypesGroup::AreaChart_PercentsStackedArea). A řady ChartType::Line mohou být současně s řadami ChartType::LineWithMarkers v jednom CombinableSeriesTypesGroup::LineChart_LineChartSeriesGroup."
type: docs
weight: 1496
...
Výčet skupin kombinovatelných typů řad. Každý prvek se vztahuje ke skupině typů řad grafu, které mohou současně existovat v jednom [ChartSeriesGroup](../chartseriesgroup/). Například řady [ChartType::PercentsStackedArea](../charttype/) nemohou být současně s řadami [ChartType::StackedArea](../charttype/) v jednom [ChartSeriesGroup](../chartseriesgroup/). Ale dvě nebo více řad [ChartType::PercentsStackedArea](../charttype/) mohou být v jednom [ChartSeriesGroup](../chartseriesgroup/) současně ([CombinableSeriesTypesGroup::AreaChart_PercentsStackedArea](./)). A řady [ChartType::Line](../charttype/) mohou být současně s řadami [ChartType::LineWithMarkers](../charttype/) v jednom [CombinableSeriesTypesGroup::LineChart_Line](./)[ChartSeriesGroup](../chartseriesgroup/).
