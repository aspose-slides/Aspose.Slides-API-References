...
| virtual **float** [get_ActualHeight](../iactuallayout/get_actualheight/)() | Určuje skutečnou výšku prvku grafu. Před získáním skutečných hodnot zavolejte metodu [IChart::ValidateChartLayout](../ichart/validatechartlayout/). Čte **float**. |
| virtual **float** [get_ActualWidth](../iactuallayout/get_actualwidth/)() | Určuje skutečnou šířku prvku grafu. Před získáním skutečných hodnot zavolejte metodu [IChart::ValidateChartLayout](../ichart/validatechartlayout/). Čte **float**. |
| virtual **float** [get_ActualX](../iactuallayout/get_actualx/)() | Určuje skutečnou souřadnici x (levý okraj) prvku grafu vzhledem k levému hornímu rohu grafu. Před získáním skutečných hodnot zavolejte metodu [IChart::ValidateChartLayout](../ichart/validatechartlayout/). Čte **float**. |
| virtual **float** [get_ActualY](../iactuallayout/get_actualy/)() | Určuje skutečnou horní polohu prvku grafu vzhledem k levému hornímu rohu grafu. Před získáním skutečných hodnot zavolejte metodu [IChart::ValidateChartLayout](../ichart/validatechartlayout/). Čte **float**. |
| virtual **float** [get_Bottom](../ilayoutable/get_bottom/)() | Získává horní část prvku grafu jako podíl výšky grafu. Pouze pro čtení **float**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Vrací formát oblasti kresby. Pouze pro čtení [IFormat](../iformat/). |
| virtual **float** [get_Height](../ilayoutable/get_height/)() | Určuje výšku prvku grafu jako podíl výšky grafu. Čte **float**. |
| virtual [Aspose::Slides::Charts::LayoutTargetType](../layouttargettype/) [get_LayoutTargetType](./get_layouttargettype/)() | Pokud je rozložení oblasti kresby definováno ručně, tato vlastnost určuje, zda rozdělit oblast kresby podle vnitřku (bez os a popisků) nebo podle vnějšího okraje (včetně os a popisků). Čte [LayoutTargetType](../layouttargettype/). |
...
| virtual **float** [get_Right](../ilayoutable/get_right/)() | Získává pravý okraj prvku grafu jako podíl šířky grafu. Pouze pro čtení **float**. |
...
| virtual **float** [get_X](../ilayoutable/get_x/)() | Určuje souřadnici x (levý okraj) prvku grafu jako podíl šířky grafu. Čte **float**. |
...
| virtual void [set_Height](../ilayoutable/set_height/)(**float**) | Určuje výšku prvku grafu jako podíl výšky grafu. Zápis **float**. |
| virtual void [set_LayoutTargetType](./set_layouttargettype/)([Aspose::Slides::Charts::LayoutTargetType](../layouttargettype/)) | Pokud je rozložení oblasti kresby definováno ručně, tato vlastnost určuje, zda rozdělit oblast kresby podle vnitřku (bez os a popisků) nebo podle vnějšího okraje (včetně os a popisků). Zápis [LayoutTargetType](../layouttargettype/). |
| virtual void [set_Width](../ilayoutable/set_width/)(**float**) | Určuje šířku prvku grafu jako podíl šířky grafu. Zápis **float**. |
| virtual void [set_X](../ilayoutable/set_x/)(**float**) | Určuje souřadnici x (levý okraj) prvku grafu jako podíl šířky grafu. Zápis **float**. |
| virtual void [set_Y](../ilayoutable/set_y/)(**float**) | Určuje horní část prvku grafu jako podíl výšky grafu. Zápis **float**. |
...
| virtual  [~Object](../../system/object/~object/)() | Ničií objekt. Uvolňuje všechny vnitřní datové struktury. |
