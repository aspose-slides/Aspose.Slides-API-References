...
| virtual **float** [get_Bottom](./get_bottom/)() | Získává horní část prvku grafu jako zlomek výšky grafu. Jen ke čtení **float**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](../ichartcomponent/get_chart/)() | Vrací graf. Jen ke čtení [IChart](../ichart/). |
| virtual **float** [get_Height](./get_height/)() | Určuje výšku prvku grafu jako zlomek výšky grafu. Čte **float**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\> [get_Presentation](../../aspose.slides/ipresentationcomponent/get_presentation/)() | Vrací prezentaci. Jen ke čtení [IPresentation](../../aspose.slides/ipresentation/). |
| virtual **float** [get_Right](./get_right/)() | Získává pravou stranu prvku grafu jako zlomek šířky grafu. Jen ke čtení **float**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../../aspose.slides/ibaseslide/)\> [get_Slide](../../aspose.slides/islidecomponent/get_slide/)() | Vrací základní snímek. Jen ke čtení [IBaseSlide](../../aspose.slides/ibaseslide/). |
| virtual **float** [get_Width](./get_width/)() | Určuje šířku prvku grafu jako zlomek šířky grafu. Čte **float**. |
| virtual **float** [get_X](./get_x/)() | Určuje polohu x (vlevo) prvku grafu jako zlomek šířky grafu. Čte **float**. |
| virtual **float** [get_Y](./get_y/)() | Určuje horní část prvku grafu jako zlomek výšky grafu. Čte **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Určuje výšku prvku grafu jako zlomek výšky grafu. Zapíše **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Určuje šířku prvku grafu jako zlomek šířky grafu. Zapíše **float**. |
| virtual void [set_X](./set_x/)(**float**) | Určuje polohu x (vlevo) prvku grafu jako zlomek šířky grafu. Zapíše **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Určuje horní část prvku grafu jako zlomek výšky grafu. Zapíše **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastavuje n-tý šablonový argument na slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do režimu slabých. |
| int [SharedCount](../../system/object/sharedcount/)() const | Získává aktuální hodnotu sdíleného čítače reference. |
