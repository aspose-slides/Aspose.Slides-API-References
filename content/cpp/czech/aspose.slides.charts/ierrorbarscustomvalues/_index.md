...
description: Určuje hodnoty chybových úseček. Mělo by být použito pouze v případě, že je typ hodnoty Error bars nastaven na Custom.
type: docs
weight: 1015
url: /cs/aspose.slides.charts/ierrorbarscustomvalues/
---
## IErrorBarsCustomValues třída

Určuje hodnoty chybových úseček. Mělo by být použito pouze tehdy, když je typ hodnot Error bars Custom.
...
| Metoda | Popis |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Porovnává objekty pomocí C# [Object.Equals](../../system/object/equals/) semantik. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() | Určuje hodnotu chybové úsečky v záporném směru. K dispozici, pokud je typ hodnot error bars Custom a ErrorBarsXFormat je povolen. V ostatních případech tato vlastnost vrací null. Pouze ke čtení [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() | Určuje hodnotu chybové úsečky v kladném směru. K dispozici, pokud je typ hodnot error bars Custom a ErrorBarsXFormat je povolen. V ostatních případech tato vlastnost vrací null. Pouze ke čtení [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() | Určuje hodnotu chybové úsečky v záporném směru. K dispozici, pokud je typ hodnot error bars Custom a ErrorBarsYFormat je povolen. V ostatních případech tato vlastnost vrací null. Pouze ke čtení [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() | Určuje hodnotu chybové úsečky v kladném směru. K dispozici, pokud je typ hodnot error bars Custom a ErrorBarsYFormat je povolen. V ostatních případech tato vlastnost vrací null. Pouze ke čtení [IDoubleChartValue](../idoublechartvalue/). |
