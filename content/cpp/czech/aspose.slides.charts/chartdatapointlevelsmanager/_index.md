...
description: Kontejner úrovní datových bodů. Používá se pro řady Treeamp a Sunburst. Indexování úrovní datových bodů je nulové (začíná od nuly).
type: docs
weight: 183
...
Kontejner úrovní datových bodů. Používá se pro řady Treeamp a Sunburst. Indexování úrovní datových bodů začíná od nuly.
...
| **int32_t** [get_Count](./get_count/)() override | Vrací počet úrovní datových bodů. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) override | Vrací objekt [IChartDataPointLevel](../ichartdatapointlevel/) pro definovanou úroveň. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analogie operátoru C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazu C# lock(). Volá se přímo nebo pomocí objektu hlídky [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazu C# lock(). Volá se přímo nebo pomocí objektu hlídky [LockContext](../../system/lockcontext/). |
...
* Třída [IChartDataPointLevelsManager](../ichartdatapointlevelsmanager/)
