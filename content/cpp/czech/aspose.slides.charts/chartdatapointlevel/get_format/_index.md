...
description: Reprezentuje formátovací vlastnosti úrovně datového bodu. Přečtěte IFormat.
type: docs
weight: 1
url: /cs/aspose.slides.charts/chartdatapointlevel/get_format/
---
## ChartDataPointLevel::get_Format() metoda

Reprezentuje formátovací vlastnosti úrovně datového bodu. Přečtěte [IFormat](../../iformat/).
