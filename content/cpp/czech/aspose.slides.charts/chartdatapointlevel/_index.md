...
Representuje úroveň datového bodu. Používá se pro grafy Treemap a Sunburst.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Reprezentuje formátovací vlastnosti úrovně datového bodu. Přečtěte [IFormat](../iformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | Reprezentuje datový štítek úrovně datového bodu. Používá se pro typy řad Treemap a Sunburst. Pouze ke čtení [IDataLabel](../idatalabel/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje odvozeným třídám kopírování. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umožňuje podtřídám copírovat. |
...
* Třída [IChartDataPointLevel](../ichartdatapointlevel/)
