...
description: Reprezentuje popisek datové úrovně bodu. Použito pro typy řad Treemap a Sunburst sereis. Pouze ke čtení IDataLabel.
type: docs
weight: 14
url: /cs/aspose.slides.charts/ichartdatapointlevel/get_label/
---
## IChartDataPointLevel::get_Label() metoda


Reprezentuje popisek datové úrovně bodu. Použito pro typy řad Treemap a Sunburst sereis. Pouze ke čtení [IDataLabel](../../idatalabel/).
