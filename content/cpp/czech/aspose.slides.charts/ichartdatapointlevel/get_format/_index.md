...
description: Representuje vlastnosti formátování úrovně datového bodu. Přečtěte si IFormat.
type: docs
weight: 1
url: /cs/aspose.slides.charts/ichartdatapointlevel/get_format/
---
## IChartDataPointLevel::get_Format() metoda

Representuje vlastnosti formátování úrovně datového bodu. Přečtěte si [IFormat](../../iformat/).
