...
description: Zobrazuje kolekci IChartCategory
type: docs
weight: 599
...
Zobrazuje kolekci [IChartCategory](../ichartcategory/)
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Pokud kategorie v kolekci existuje, vrátí ji. Jinak vytvoří novou kategorii grafu z [IChartDataCell](../ichartdatacell/) a přidá ji do kolekce. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Vytvoří nový [IChartCategory](../ichartcategory/) z hodnoty a přidá jej do kolekce. |
...
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | Vrací počet úrovní seskupení kategorií. Je více než jedna pro víceúrovňové kategorie. Pouze ke čtení **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Vrací hodnotu indikující, zda je přístup ke kolekci synchronizován (vláknově bezpečný). Pouze ke čtení **bool**. |
...
| virtual **bool** [get_UseCells](./get_usecells/)() | Pokud je true, pak se list používá k ukládání kategorií (tento případ podporuje víceúrovňové kategorie). Pokud je false, pak list NENÍ používán k ukládání hodnot (a tento případ nepodporuje víceúrovňové kategorie). Čte se **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | Získá prvek na určeném indexu. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Vyhledá zadaný [IChartCategory](../ichartcategory/) a vrátí nulový index první výskytu v celé kolekci |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Odstraní zadanou hodnotu. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Odstraní prvek na zadaném indexu. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač referencí o zadanou hodnotu. |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | Pokud je true, pak se list používá k ukládání kategorií (tento případ podporuje víceúrovňové kategorie). Pokud je false, pak list NENÍ používán k ukládání hodnot (a tento případ nepodporuje víceúrovňové kategorie). Zapíše se **bool**. |
