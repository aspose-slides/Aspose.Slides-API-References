...
description: Poskytuje přístup k horním/dolním pruhům čárového nebo burzovního grafu.
type: docs
weight: 1249
url: /cs/aspose.slides.charts/iupdownbarsmanager/
---
## IUpDownBarsManager třída


Poskytuje přístup k horním/dolním pruhům u čárového nebo burzovního grafu.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Vrací formát dolních pruhů. Pouze pro čtení [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Vrací šířku mezery. Čte **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Určuje, zda graf obsahuje horní/dolní pruhy. Čte **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Vrací formát horních pruhů. Pouze pro čtení [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Nastavuje šířku mezery. Zapíše **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Určuje, zda graf obsahuje horní/dolní pruhy. Zapíše **bool**. |
