...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Vrací buňku dat grafu. Číst [IChartDataCell](../ichartdatacell/). |
| **double** [get_AsLiteralDouble](./get_asliteraldouble/)() override | Vrací hodnotu jako literální double. Číst **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](./get_data/)() override | Vrací objekt Data. Číst [System::Object](../../system/object/). |
| [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../basechartvalue/get_datasourcetype/)() override | Určuje, zda je v potomcích platná vlastnost AsCell, AsCells, AsLiteralString nebo AsLiteralDouble. Jinak řečeno určuje typ hodnoty vlastnosti Data. Číst [Charts::DataSourceType](../datasourcetype/). |
...
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Nastaví buňku dat grafu. Zapsat [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) override | Nastaví hodnotu jako literální double. Zapsat **double**. |
| void [set_Data](./set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Nastaví objekt Data. Zapsat [System::Object](../../system/object/). |
| void [set_DataSourceType](../basechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | Určuje, zda je v potomcích platná vlastnost AsCell, AsCells, AsLiteralString nebo AsLiteralDouble. Jinak řečeno určuje typ hodnoty vlastnosti Data. Zapsat [Charts::DataSourceType](../datasourcetype/). |
...
| **double** [ToDouble](./todouble/)() override | Převede na **double**. |
...
* Třída [IDoubleChartValue](../idoublechartvalue/)
