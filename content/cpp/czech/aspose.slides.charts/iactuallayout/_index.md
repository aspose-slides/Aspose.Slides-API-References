...
| virtual **float** [get_ActualHeight](./get_actualheight/)() | Určuje skutečnou výšku prvku grafu. Před získáním skutečných hodnot zavolejte metodu [IChart::ValidateChartLayout](../ichart/validatechartlayout/). Čtěte **float**. |
| virtual **float** [get_ActualWidth](./get_actualwidth/)() | Určuje skutečnou šířku prvku grafu. Před získáním skutečných hodnot zavolejte metodu [IChart::ValidateChartLayout](../ichart/validatechartlayout/). Čtěte **float**. |
| virtual **float** [get_ActualX](./get_actualx/)() | Určuje skutečnou polohu x (levá) prvku grafu relativně k levému hornímu rohu grafu. Před získáním skutečných hodnot zavolejte metodu [IChart::ValidateChartLayout](../ichart/validatechartlayout/). Čtěte **float**. |
| virtual **float** [get_ActualY](./get_actualy/)() | Určuje skutečnou horní pozici prvku grafu relativně k levému hornímu rohu grafu. Před získáním skutečných hodnot zavolejte metodu [IChart::ValidateChartLayout](../ichart/validatechartlayout/). Čtěte **float**. |
