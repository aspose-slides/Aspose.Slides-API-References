...
description: Reprezentuje list přidružený k IChartDataCell
type: docs
weight: 209
...
Představuje list přidružený k [IChartDataCell](../ichartdatacell/)
...
| **int32_t** [get_Index](./get_index/)() override | Získává index listu. Pouze pro čtení **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Vrací název listu. Pouze pro čtení [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock(). Volá se přímo nebo pomocí objektu [LockContext](../../system/lockcontext/). |
...
* Třída [IChartDataWorksheet](../ichartdataworksheet/)
