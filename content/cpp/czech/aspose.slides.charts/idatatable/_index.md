...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](../ichartcomponent/get_chart/)() | Vrací diagram. Pouze pro čtení [IChart](../ichart/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Vrací styly čáry, výplně a efektu objektu. Pouze pro čtení [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Pravda, pokud tabulka dat grafu má vodorovné ohraničení buněk. Čte **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Pravda, pokud tabulka dat grafu má obrysové ohraničení. Čte **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Pravda, pokud tabulka dat grafu má svislé ohraničení buněk. Čte **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Pravda, pokud je klíč legendy popisků dat viditelný. Čte **bool**. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Pravda, pokud tabulka dat grafu má vodorovné ohraničení buněk. Zapíše **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Pravda, pokud tabulka dat grafu má obrysové ohraničení. Zapíše **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Pravda, pokud tabulka dat grafu má svislé ohraničení buněk. Zapíše **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Pravda, pokud je klíč legendy popisků dat viditelný. Zapíše **bool**. |
