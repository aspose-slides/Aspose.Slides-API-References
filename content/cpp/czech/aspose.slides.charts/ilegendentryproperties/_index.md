...
| virtual **bool** [get_Hide](./get_hide/)() | Vrací příznak skrytí položky legendy. Čte **bool**. |
...
| virtual void [set_Hide](./set_hide/)(**bool**) | Nastavuje příznak skrytí položky legendy. Zapíše **bool**. |
