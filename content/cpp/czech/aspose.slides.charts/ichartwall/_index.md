...
description: Představuje stěny na 3D grafech.
type: docs
weight: 924
...
Představuje stěny na 3D grafech.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Vrací výplň stěny, čáru, efekt, 3D styly. Pouze pro čtení [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Vrací nebo nastavuje typ obrázku. Číst [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Vrací tloušťku stěn jako procento největšího rozměru objemu grafu. Číst **int32_t**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() výroku. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Vrací nebo nastavuje typ obrázku. Zápis [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Nastavuje tloušťku stěn jako procento největšího rozměru objemu grafu. Zápis **int32_t**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock() výroku. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
