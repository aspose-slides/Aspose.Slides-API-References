...
| Method | Popis |
| --- | --- |
| void [Add](./add/)(const **int32_t**\&) override | Přidá datový bod podle jeho indexu v kolekci bodů nadřazené řady. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Přidá datový bod do kolekce. |
| [iterator](./iterator/) [begin](./begin/)() | Vrátí iterátor ukazující na první prvek (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Vrátí iterátor ukazující na první prvek (pokud existuje) instance kolekce s kvalifikací const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Vrátí iterátor ukazující na první prvek s kvalifikací const (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Vrátí iterátor ukazující těsně za posledním prvkem s kvalifikací const (pokud existuje) kolekce. |
| void [Clear](./clear/)() override | Odstraní všechny položky z [ICollection](../../system.collections.generic/icollection/). |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) const override | Určuje, zda [ICollection](../../system.collections.generic/icollection/) obsahuje konkrétní hodnotu. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>, **int32_t**) override | Zkopíruje prvky z [ICollection](../../system.collections.generic/icollection/) do [System::Array](../../system/array/), počínaje konkrétním indexem [System::Array](../../system/array/). |
...
| [iterator](./iterator/) [end](./end/)() | Vrátí iterátor ukazující těsně za posledním prvkem (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Vrátí iterátor ukazující těsně za posledním prvkem (pokud existuje) const-kvalifikované instance kolekce. |
...
| **int32_t** [get_Count](./get_count/)() const override | Vrátí počet datových bodů grafu. Pouze pro čtení **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Vrátí hodnotu určující, zda je [ICollection](../../system.collections.generic/icollection/) jen pro čtení. Pouze pro čtení **bool**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() | Vrátí hodnotu určující, zda je přístup ke kolekci synchronizovaný (vláknově bezpečný). Pouze pro čtení **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Vrátí kořen synchronizace. Pouze pro čtení [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Vrátí datovou strukturu čítače odkazů spojenou s objektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrátí enumerátor, který iteruje kolekcí. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Vrátí skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) override | Vrátí datový bod grafu pro zadaný index. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Vrátí počet prvků v sekvenci (vypočteno přímým počítáním). |
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Vrátí počet prvků sekvence, které splňují zadanou podmínku. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Vyvolá transformační funkci na každý prvek obecné sekvence a vrátí maximální výslednou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Vyvolá transformační funkci na každý prvek obecné sekvence a vrátí minimální výslednou hodnotu. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. V praxi nic nekopíruje, jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. V praxi nic nekopíruje, jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Odstraní položku z kolekce. |
| void [Remove](./remove/)(**int32_t**) override | Odstraní položku z kolekce podle jejího indexu v kolekci bodů nadřazené řady. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Vrátí aktuální hodnotu sdíleného čítače odkazů. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Vrátí iterátor ukazující na první prvek (pokud existuje) const-kvalifikované instance kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Vrátí iterátor ukazující na první prvek (pokud existuje) kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Vrátí iterátor ukazující těsně za posledním prvkem (pokud existuje) const-kvalifikované instance kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Vrátí iterátor ukazující těsně za posledním prvkem (pokud existuje) kolekce. |
...
* Třída [IPieSplitCustomPointCollection](../ipiesplitcustompointcollection/)
