...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Získá výplň značky. Pouze pro čtení [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Reprezentuje velikost značky v čárovém, rozptýleném nebo radarovém grafu. Čtení **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Reprezentuje styl značky v čárovém, rozptýleném nebo radarovém grafu. Čtení [MarkerStyleType](../markerstyletype/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# výrazu lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) objekt strážce. |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Reprezentuje velikost značky v čárovém, rozptýleném nebo radarovém grafu. Zápis **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Reprezentuje styl značky v čárovém, rozptýleném nebo radarovém grafu. Zápis [MarkerStyleType](../markerstyletype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# výrazu lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) objekt strážce. |
