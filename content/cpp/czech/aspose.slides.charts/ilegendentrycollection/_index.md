...
description: Představuje kolekci legend.
type: docs
weight: 1093
url: /cs/aspose.slides.charts/ilegendentrycollection/
---
## ILegendEntryCollection třída


Představuje kolekci legend.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) | Získá vlastnosti položky legendy odpovídající Chart.ChartData.Series[0].DataPoints[index] v případě typu diagramu ze seznamu: [ChartType::BarOfPie](../charttype/), [ChartType::ExplodedPie](../charttype/), [ChartType::ExplodedPie3D](../charttype/), [ChartType::Pie](../charttype/), [ChartType::Pie3D](../charttype/), [ChartType::PieOfPie](../charttype/); nebo odpovídající Chart.ChartData.Series[index] pro jiné typy diagramů. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony jako weak pointer (namísto shared). Umožňuje přepnout ukazatele v kontejnerech do režimu weak. |
