...
description: Reprezentuje značku chertu.
type: docs
weight: 1301
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i přestože podle IEC 60559:1989 NaN není roven žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za rovné, i přestože podle IEC 60559:1989 NaN není roven žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní použití. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Získá výplň značky. Pouze pro čtení [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Reprezentuje velikost značky v čárovém grafu, rozptylovém grafu nebo radaru. Pouze **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Reprezentuje styl značky v čárovém grafu, rozptylovém grafu nebo radaru. Pouze [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Reprezentuje velikost značky v čárovém grafu, rozptylovém grafu nebo radaru. Zápis **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Reprezentuje styl značky v čárovém grafu, rozptylovém grafu nebo radaru. Zápis [MarkerStyleType](../markerstyletype/). |
