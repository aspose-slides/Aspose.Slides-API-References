...
description: Representuje uzel deklarace XML <?xml version='1.0'...?>.
type: docs
weight: 170
url: /cs/system.xml/xmldeclaration/
---
## XmlDeclaration třída

Reprezentuje uzel deklarace XML **<?xml version='1.0'...?>**.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Získá iterátor ukazující na první prvek označený jako const (pokud existuje) v kolekci. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Získá iterátor ukazující těsně za posledním prvkem označeným jako const (pokud existuje) v kolekci. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Vytvoří duplicitní kopii tohoto uzlu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Vytvoří duplicitní kopii tohoto uzlu. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) const-oznacené instance kolekce. |
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Vrací úroveň kódování XML dokumentu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Vrací první poduzel uzlu. |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Vrací hodnotu indikující, zda má tento uzel jakékoli poduzly. |
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Vrací spojené hodnoty [XmlDeclaration](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Vrací uzel následující okamžitě po tomto uzlu. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Vrací infoset po validaci schématu, který byl tomuto uzlu přiřazen v důsledku validace schématu. |
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Vrací hodnotu atributu standalone. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Vrací hodnotu [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Vrací verzi XML dokumentu. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Vyhledá nejbližší deklaraci **xmlns** pro daný prefix, která je v dosahu aktuálního uzlu, a vrátí URI jmenného prostoru v deklaraci. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Vyhledá nejbližší deklaraci **xmlns** pro dané URI jmenného prostoru, která je v dosahu aktuálního uzlu, a vrátí prefix definovaný v této deklaraci. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Vrací první podřízený prvek se zadaným [XmlNode::get_Name](../xmlnode/get_name/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Vrací první podřízený prvek se zadanými hodnotami [XmlNode::get_LocalName](../xmlnode/get_localname/) a [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Převede prvky na zadaný typ. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Vrací počet prvků v sekvenci (vypočítaný přímým počítáním). |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Přeskočí zadaný počet souvislých prvků na začátku sekvence a vrátí zbytek. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtruje sekvenci podle zadané podmínky (predikátu). |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Zavolat přímo nebo použít objekt [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umožňuje klonování vlastních typů. |
| virtual void [Normalize](../xmlnode/normalize/)() | Umístí všechny uzly [XmlText](../xmltext/) v plné hloubce podstromu pod tímto [XmlNode](../xmlnode/) do „normální“ formy, kde pouze značky (tj. tagy, komentáře, instrukce zpracování, sekce CDATA a odkazy na entity) oddělují uzly [XmlText](../xmltext/), tj. neexistují sousední uzly [XmlText](../xmltext/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Přidá zadaný uzel na začátek seznamu poduzlů tohoto uzlu. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Porovnává objekty podle reference. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Porovnává objekty podle reference. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Porovnává objekt typu hodnota s nullptr referencí. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](../xmlnode/removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Odstraní zadaný poduzel. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Vybere první [XmlNode](../xmlnode/) odpovídající výrazu [XPath](../../system.xml.xpath/). Všechny prefixy nalezené ve výrazu [XPath](../../system.xml.xpath/) jsou rozřešeny pomocí poskytnutého [XmlNamespaceManager](../xmlnamespacemanager/). |
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Nastaví úroveň kódování XML dokumentu. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Nastaví spojené hodnoty [XmlDeclaration](./). |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Nastaví hodnotu atributu standalone. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Nastaví hodnotu [XmlDeclaration](./). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony jako weak ukazatel (namísto shared). Umožňuje přepínání ukazatelů v kontejnerech do weak režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock(). Zavolat přímo nebo použít objekt [LockContext](../../system/lockcontext/). |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Získá implementaci začátku const iterátoru pro aktuální kontejner. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Získá implementaci začátku iterátoru pro aktuální kontejner. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Získá implementaci konce const iterátoru pro aktuální kontejner. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Získá implementaci konce iterátoru pro aktuální kontejner. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Uloží poduzly uzlu do zadaného [XmlWriter](../xmlwriter/). Protože uzly [XmlDeclaration](./) nemají poduzly, tato metoda nemá žádný efekt. |
