...
description: Poskytuje rozhraní, které umožňuje třídě vracet informace o řádku a pozici.
type: docs
weight: 40
url: /cs/system.xml/ixmllineinfo/
---
## IXmlLineInfo třída
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Vrací aktuální číslo řádku. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Vrací aktuální pozici řádku. |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | Vrací hodnotu indikující, zda třída může vracet informace o řádku. |
