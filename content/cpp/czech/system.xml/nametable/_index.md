...
description: Implementuje jednovlákný XmlNameTable.
type: docs
weight: 66
url: /cs/system.xml/nametable/
---
## NameTable třída


Implementuje jednovlákný [XmlNameTable](../xmlnametable/).
...
| Metoda | Popis |
| --- | --- |
| const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) override | Atomizuje zadaný řetězec a přidá jej do [NameTable](./). |
| const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Atomizuje zadaný řetězec a přidá jej do [NameTable](./). |
...
| const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) override | Vrací atomizovaný řetězec se zadanou hodnotou. |
| const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Vrací atomizovaný řetězec obsahující stejné znaky jako zadaný rozsah znaků v poskytnutém poli. |
...
| [NameTable](./nametable/)() | Inicializuje novou instanci třídy [NameTable](./). |
