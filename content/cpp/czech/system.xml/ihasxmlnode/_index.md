...
description: Umožňuje třídě vrátit XmlNode z aktuálního kontextu nebo pozice.
type: docs
weight: 27
url: /cs/system.xml/ihasxmlnode/
---
## IHasXmlNode třída

Umožňuje třídě vrátit [XmlNode](../xmlnode/) z aktuálního kontextu nebo pozice.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | Vrací [XmlNode](../xmlnode/) pro aktuální pozici. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Porovnává objekt hodnotového typu podle reference s nullptr. |
