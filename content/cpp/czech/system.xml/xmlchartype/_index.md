...
description: Pro interní použití. Tuto třídu nepoužívejte přímo.
type: docs
weight: 131
url: /cs/system.xml/xmlchartype/
---
## XmlCharType třída

Pro interní použití. Tuto třídu nepoužívejte přímo.
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Volá se přímo nebo použijte sentinel objekt [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Volá se přímo nebo použijte sentinel objekt [LockContext](../../system/lockcontext/). |
