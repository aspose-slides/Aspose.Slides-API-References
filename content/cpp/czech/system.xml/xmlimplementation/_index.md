...
description: Definuje kontext pro sadu objektů XmlDocument.
type: docs
weight: 261
url: /cs/system.xml/xmlimplementation/
---
## XmlImplementation třída

Definuje kontext pro sadu objektů [XmlDocument](../xmldocument/).
...
| Metoda | Popis |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [CreateDocument](./createdocument/)() | Vytvoří nový [XmlDocument](../xmldocument/). |
...
| **bool** [HasFeature](./hasfeature/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Testuje, zda implementace Document [Object](../../system/object/) Model (DOM) podporuje konkrétní funkci. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analogie operátoru C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() výrazu. Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() výrazu. Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
|  [XmlImplementation](./xmlimplementation/)() | Inicializuje novou instanci třídy [XmlImplementation](./). |
|  [XmlImplementation](./xmlimplementation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Inicializuje novou instanci třídy [XmlImplementation](./) se specifikovaným [XmlNameTable](../xmlnametable/). |
