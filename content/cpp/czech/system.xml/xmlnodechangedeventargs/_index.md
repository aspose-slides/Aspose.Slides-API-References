...
description: "Poskytuje data pro události XmlDocument::NodeChanged, XmlDocument::NodeChanging, XmlDocument::NodeInserted, XmlDocument::NodeInserting, XmlDocument::NodeRemoved a XmlDocument::NodeRemoving."
type: docs
weight: 339
url: /cs/system.xml/xmlnodechangedeventargs/
---
## XmlNodeChangedEventArgs třída

Poskytuje data pro události **XmlDocument::NodeChanged**, **XmlDocument::NodeChanging**, **XmlDocument::NodeInserted**, **XmlDocument::NodeInserting**, **XmlDocument::NodeRemoved** a **XmlDocument::NodeRemoving**.
...
| [XmlNodeChangedAction](../xmlnodechangedaction/) [get_Action](./get_action/)() | Vrací hodnotu indikující, jaký typ události změny uzlu se odehrává. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NewParent](./get_newparent/)() | Vrací hodnotu [XmlNode::get_ParentNode](../xmlnode/get_parentnode/) po dokončení operace. |
| [String](../../system/string/) [get_NewValue](./get_newvalue/)() | Vrací novou hodnotu uzlu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_Node](./get_node/)() | Vrací [XmlNode](../xmlnode/), který je přidáván, odstraňován nebo měněn. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_OldParent](./get_oldparent/)() | Vrací hodnotu [XmlNode::get_ParentNode](../xmlnode/get_parentnode/) před zahájením operace. |
| [String](../../system/string/) [get_OldValue](./get_oldvalue/)() | Vrací původní hodnotu uzlu. |
...
|  [XmlNodeChangedEventArgs](./xmlnodechangedeventargs/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&, [XmlNodeChangedAction](../xmlnodechangedaction/)) | Inicializuje novou instanci třídy [XmlNodeChangedEventArgs](./). |
| virtual  [~Object](../../system/object/~object/)() | Ničuje objekt. Uvolňuje všechny interní datové struktury. |

## Pole

| Pole | Popis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statický člen představující „prázdný“ sdílený ukazatel [EventArgs](../../system/eventargs/) (null-pointer). |
