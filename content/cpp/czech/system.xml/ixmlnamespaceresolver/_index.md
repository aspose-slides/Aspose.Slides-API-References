...
description: Poskytuje pouze pro čtení přístup k sadě mapování předpon a jmenných prostorů.
type: docs
weight: 53
url: /cs/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver třída

Poskytuje pouze pro čtení přístup k sadě mapování předpon a jmenných prostorů.
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla referencí spjatou s objektem. |
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Vrací URI jmenného prostoru namapovaného na zadanou předponu. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Vrací předponu, která je namapována na zadané URI jmenného prostoru. |
