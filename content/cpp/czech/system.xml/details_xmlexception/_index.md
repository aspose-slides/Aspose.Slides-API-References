...
description: Vrací podrobné informace o poslední výjimce.
type: docs
weight: 1
url: /cs/system.xml/details_xmlexception/
---
## Details_XmlException třída
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Vrací číslo řádku, které udává, kde došlo k chybě. Čísla řádků začínají od 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Vrací pozici v řádku, která udává, kde došlo k chybě. Pozice v řádku začíná od 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Vrací zprávu popisující aktuální výjimku. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Vrací umístění XML souboru. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | Vrací kopii objektu Exception, který představuje nejvnitřnější výjimku. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Získává skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
| **bool** [Is](../../system/details_systemexception/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const override |  |
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# příkazu lock(). Zavolejte přímo nebo použijte strážný objekt [LockContext](../../system/lockcontext/). |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Nastavuje HRESULT, kódovanou číselnou hodnotu, která je přiřazena konkrétní výjimce. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastavuje n-tý šablonový argument jako slabý ukazatel (místo sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí C# příkazu lock(). Zavolejte přímo nebo použijte strážný objekt [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje slabý čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodu [what()](../../system/details_exception/what/), která je volána třídou [ExceptionWrapper](../../system/exceptionwrapper/). I když tato třída není odvozena od std::exception, odvozené třídy mohou použít chráněné/privátní členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../../system/exceptionwrapper/) může tuto logiku rozbít. |
