...
description: Tabulka atomizovaných řetězcových objektů.
type: docs
weight: 313
url: /cs/system.xml/xmlnametable/
---
## XmlNameTable třída
...
| Method | Popis |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Když je ve zděděné třídě přepsáno, atomizuje zadaný řetězec a přidá jej do [XmlNameTable](./). |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | Když je ve zděděné třídě přepsáno, atomizuje zadaný řetězec a přidá jej do [XmlNameTable](./). |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Když je ve zděděné třídě přepsáno, získá atomizovaný řetězec obsahující stejné znaky jako určený rozsah znaků v zadaném poli. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | Když je ve zděděné třídě přepsáno, získá atomizovaný řetězec obsahující stejnou hodnotu jako zadaný řetězec. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# příkazu lock(). Zavolejte přímo nebo použijte strážní objekt [LockContext](../../system/lockcontext/). |
