...
description: Reprezentuje kolekci atributů, ke které lze přistupovat pomocí názvu nebo indexu.
type: docs
weight: 92
url: /cs/system.xml/xmlattributecollection/
---
## XmlAttributeCollection třída
...
| Metoda | Popis |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [Append](./append/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Vloží zadaný atribut jako poslední uzel v kolekci. |
| [iterator](../xmlnamednodemap/iterator/) [begin](../xmlnamednodemap/begin/)() const | Získá iterátor na první prvek kolekce. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Získá iterátor ukazující na první prvek (pokud existuje) kolekce. Tento iterátor nelze použít k změně odkazovaného objektu, protože [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) vrací kopii objektu T. |
| [iterator](../xmlnamednodemap/iterator/) [cbegin](../xmlnamednodemap/cbegin/)() const | Získá iterátor na první prvek kolekce. |
| [iterator](../xmlnamednodemap/iterator/) [cend](../xmlnamednodemap/cend/)() const | Získá iterátor pro neexistující prvek za posledním prvkem kolekce. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\>\&, **int32_t**) | Zkopíruje všechny [XmlAttribute](../xmlattribute/) objekty z této kolekce do daného pole. |
| [iterator](../xmlnamednodemap/iterator/) [end](../xmlnamednodemap/end/)() const | Získá iterátor pro neexistující prvek za posledním prvkem kolekce. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Získá iterátor ukazující přímo za posledním prvkem (pokud existuje) kolekce. Tento iterátor nelze použít k změně odkazovaného objektu, protože [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) vrací kopii objektu T. |
...
| virtual **int32_t** [get_Count](../xmlnamednodemap/get_count/)() | Vrací počet uzlů v [XmlNamedNodeMap](../xmlnamednodemap/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla odkazů spojenou s objektem. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnamednodemap/getenumerator/)() override | Poskytuje podporu iterace přes kolekci uzlů v [XmlNamedNodeMap](../xmlnamednodemap/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](../xmlnamednodemap/getnameditem/)([String](../../system/string/)) | Načte [XmlNode](../xmlnode/) určený názvem. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](../xmlnamednodemap/getnameditem/)([String](../../system/string/), [String](../../system/string/)) | Načte uzel s odpovídajícími hodnotami [XmlNode::get_LocalName](../xmlnode/get_localname/) a [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [idx_get](./idx_get/)(**int32_t**) | Vrací atribut se zadaným indexem. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Vrací atribut se zadaným názvem. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Vrací atribut se zadaným lokálním názvem a Uniform Resource Identifier (URI) jmenného prostoru. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [InsertAfter](./insertafter/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Vloží zadaný atribut okamžitě za specifikovaný referenční atribut. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [InsertBefore](./insertbefore/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Vloží zadaný atribut okamžitě před specifikovaný referenční atribut. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instanci typu popsaného targetType. Analog operátoru C# 'is'. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](../xmlnamednodemap/item/)(**int32_t**) | Načte uzel na zadaném indexu v [XmlNamedNodeMap](../xmlnamednodemap/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Určuje, zda existuje prvek sekvence nebo zda některý prvek splňuje podmínku. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence vzestupně podle hodnot klíče vybraných funkcí keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence sestupně podle hodnot klíče vybraných funkcí keySelector. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [Prepend](./prepend/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Vloží zadaný atribut jako první uzel v kolekci. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Odstraní zadaný atribut z kolekce. |
| void [RemoveAll](./removeall/)() | Odstraní všechny atributy z kolekce. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAt](./removeat/)(**int32_t**) | Odstraní atribut odpovídající zadanému indexu z kolekce. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený čítač odkazů o zadanou hodnotu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](../xmlnamednodemap/removenameditem/)([String](../../system/string/)) | Odstraní uzel z [XmlNamedNodeMap](../xmlnamednodemap/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](../xmlnamednodemap/removenameditem/)([String](../../system/string/), [String](../../system/string/)) | Odstraní uzel s odpovídajícími hodnotami [XmlNode::get_LocalName](../xmlnode/get_localname/) a [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SetNamedItem](./setnameditem/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Přidá [XmlNode](../xmlnode/) pomocí jeho [XmlNode::get_Name](../xmlnode/get_name/). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k běhovým chybám a/nebo chybám tvrzení. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel k předávání jako argument funkcím.

## Viz také

* Třída [XmlNamedNodeMap](../xmlnamednodemap/)
