...
description: Reprezentuje deklaraci notace, například <!NOTATION... >.
type: docs
weight: 378
url: /cs/system.xml/xmlnotation/
---
## XmlNotation třída

Reprezentuje deklaraci notace, například **<!NOTATION... >**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Creates a duplicate of this node. Notation nodes cannot be cloned. Calling this method on an [XmlNotation](./) object throws an exception. |
...
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Returns the markup representing the children of this node. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | Returns a value indicating whether the node is read-only. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Returns the name of the current node without the namespace prefix. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Returns the name of the current node. |
...
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | Returns the markup representing this node and all its children. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Returns the value of the public identifier on the notation declaration. |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Returns the value of the system identifier on the notation declaration. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Sets the concatenated values of the node and all its child nodes. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Sets the markup representing the children of this node. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves the children of the node to the specified [XmlWriter](../xmlwriter/). This method has no effect on [XmlNotation](./) nodes. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves the node to the specified [XmlWriter](../xmlwriter/). This method has no effect on [XmlNotation](./) nodes. |
| virtual  [~Object](../../system/object/~object/)() | Destroys object. Frees all internal data structures. |
## Typedefy

| Typedef | Popis |
| --- | --- |
| [Ptr](./ptr/) | Alias for shared pointer to an instance of this class. |
## Poznámky

Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání do funkcí jako argument.
