...
description: Poskytuje metody pro manipulaci s textem, které jsou používány několika třídami.
type: docs
weight: 118
url: /cs/system.xml/xmlcharacterdata/
---
## XmlCharacterData třída

Poskytuje metody pro manipulaci s textem, které jsou používány několika třídami.
...
| Metoda | Popis |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Přidá určený uzel na konec seznamu poduzlů tohoto uzlu. |
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | Připojí zadaný řetězec na konec znakových dat uzlu. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Vytvoří duplikát uzlu, pokud je přepsáno v odvozené třídě. |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | Odstraní rozsah znaků z uzlu. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | Vrací data uzlu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Vrací první poduzel uzlu. |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Vrací hodnotu indikující, zda tento uzel má nějaké poduzly. |
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Vrací spojené hodnoty uzlu a všech jeho poduzlů. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Vrací značkování představující pouze poduzly tohoto uzlu. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Vrací hodnotu indikující, zda je uzel jen pro čtení. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Vrací poslední poduzel uzlu. |
| virtual **int32_t** [get_Length](./get_length/)() | Vrací délku dat v počtu znaků. |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Vrací lokální název uzlu, pokud je přepsáno v odvozené třídě. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Vrací kvalifikovaný název uzlu, pokud je přepsáno v odvozené třídě. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Vrací typ aktuálního uzlu, pokud je přepsáno v odvozené třídě. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](../xmlnode/get_ownerdocument/)() | Vrací [XmlDocument](../xmldocument/), ke kterému tento uzel patří. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Vrací sadu informací po ověření schématem, která byla tomuto uzlu přiřazena v důsledku validace schématu. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Vrací hodnotu uzlu. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Vyhledá nejbližší deklaraci **xmlns** pro daný prefix, který je v rozsahu aktuálního uzlu, a vrátí URI jmenného prostoru v deklaraci. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Vyhledá nejbližší deklaraci **xmlns** pro dané URI jmenného prostoru, který je v rozsahu aktuálního uzlu, a vrátí prefix definovaný v této deklaraci. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analog volání C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Vrací první podřízený prvek se specifikovaným [XmlNode::get_Name](../xmlnode/get_name/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Vrací první podřízený prvek se specifikovanými hodnotami [XmlNode::get_LocalName](../xmlnode/get_localname/) a [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Vloží zadaný uzel ihned po zadaném referenčním uzlu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Vloží zadaný uzel ihned před zadaný referenční uzel. |
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | Vloží zadaný řetězec na určený znakový offset. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Vrací počet prvků v sekvenci (počítáno přímým čítáním). |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence ve vzestupném pořadí podle hodnot klíče vybraných funkcí keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence v sestupném pořadí podle hodnot klíče vybraných funkcí keySelector. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# výrazu lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umožňuje klonování vlastních typů. |
| virtual void [Normalize](../xmlnode/normalize/)() | Převede všechny [XmlText](../xmltext/) uzly v plné hloubce podstromu pod tímto [XmlNode](../xmlnode/) do „normální“ formy, kde jsou pouze značky (tedy tagy, komentáře, instrukce zpracování, CDATA sekce a odkaz na entity) oddělující [XmlText](../xmltext/) uzly, tj. neexistují sousední [XmlText](../xmltext/) uzly. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Přidá určený uzel na začátek seznamu poduzlů tohoto uzlu. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Porovnává objekty podle reference. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Porovnává objekty podle reference. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Porovnává objekt typu hodnota s nullptr referenčně. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Specializace [Object::ReferenceEquals](../../system/object/referenceequals/) pro případ řetězce a nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Specializace [Object::ReferenceEquals](../../system/object/referenceequals/) pro případ řetězců. |
| virtual void [RemoveAll](../xmlnode/removeall/)() | Odstraní všechny poduzly a/nebo atributy aktuálního uzlu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](../xmlnode/removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Odstraní specifikovaný poduzel. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Sníží sdílený počitadlo referencí o zadanou hodnotu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](../xmlnode/replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Nahradí poduzel **oldChild** uzlem **newChild**. |
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Nahradí zadaný počet znaků počínaje zadaným offsetem zadaným řetězcem. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Vybere první [XmlNode](../xmlnode/), který odpovídá výrazu [XPath](../../system.xml.xpath/). V výrazu [XPath](../../system.xml.xpath/) nalezené prefixy jsou rozřešeny pomocí poskytnutého [XmlNamespaceManager](../xmlnamespacemanager/). |
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | Nastaví data uzlu. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Nastaví spojené hodnoty uzlu a všech jeho poduzlů. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Nastaví značkování představující pouze poduzly tohoto uzlu. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Nastaví prefix jmenného prostoru tohoto uzlu. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Nastaví hodnotu uzlu. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvýší sdílený počitadlo referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Sníží a vrátí sdílený počitadlo referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | Získá podřetězec z celého řetězce ze zadaného rozsahu. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Testuje, zda implementace DOM podporuje konkrétní vlastnost. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umožňuje převod vlastních objektů na řetězec. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukci C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# výrazu lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvýší slabý počitadlo referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Sníží slabý počitadlo referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Uloží všechny poduzly uzlu do zadaného [XmlWriter](../xmlwriter/), pokud je přepsáno v odvozené třídě. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Uloží aktuální uzel do zadaného [XmlWriter](../xmlwriter/), pokud je přepsáno v odvozené třídě. |
