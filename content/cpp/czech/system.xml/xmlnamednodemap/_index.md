...
description: Představuje kolekci uzlů, ke kterým lze přistupovat podle jména nebo indexu.
type: docs
weight: 287
url: /cs/system.xml/xmlnamednodemap/
---
## XmlNamedNodeMap třída


Představuje kolekci uzlů, které lze přistupovat podle jména nebo indexu.
...
| Metoda | Popis |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() const | Získá iterátor na první prvek kolekce. |
...
| [iterator](./iterator/) [cbegin](./cbegin/)() const | Získá iterátor na první prvek kolekce. |
| [iterator](./iterator/) [cend](./cend/)() const | Získá iterátor pro neexistující prvek za posledním prvkem kolekce. |
| [iterator](./iterator/) [end](./end/)() const | Získá iterátor pro neexistující prvek za posledním prvkem kolekce. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Vrací počet uzlů v [XmlNamedNodeMap](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu čítače referencí spojenou s objektem. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](./getenumerator/)() override | Poskytuje podporu pro iteraci přes kolekci uzlů v [XmlNamedNodeMap](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/)) | Získá [XmlNode](../xmlnode/) určený podle jména. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/), [String](../../system/string/)) | Získá uzel s odpovídajícími hodnotami [XmlNode::get_LocalName](../xmlnode/get_localname/) a [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](./item/)(**int32_t**) | Získá uzel na zadaném indexu v [XmlNamedNodeMap](./). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() příkazu. Vyvolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/)) | Odstraňuje uzel z [XmlNamedNodeMap](./). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/), [String](../../system/string/)) | Odstraňuje uzel s odpovídajícími hodnotami [XmlNode::get_LocalName](../xmlnode/get_localname/) a [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SetNamedItem](./setnameditem/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Přidá [XmlNode](../xmlnode/) pomocí jeho hodnoty [XmlNode::get_Name](../xmlnode/get_name/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí C# lock() příkazu. Vyvolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asertů. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel k předání jako argument funkcím. 
