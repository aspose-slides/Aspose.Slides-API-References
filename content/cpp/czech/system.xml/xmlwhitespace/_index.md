...
description: Reprezentuje bílý prostor v obsahu prvku.
type: docs
weight: 560
url: /cs/system.xml/xmlwhitespace/
---
## XmlWhitespace třída

Reprezentuje bílý prostor v obsahu prvku.
...
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Returns the type of the node. |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asercí. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a použijte tento ukazatel pro předávání do funkcí jako argument.
