...
description: Vrací uzel, který je okamžitě před nebo po tomto uzlu.
type: docs
weight: 274
url: /cs/system.xml/xmllinkednode/
---
## XmlLinkedNode třída

Vrátí uzel okamžitě předcházející nebo následující tomuto uzlu.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Vytvoří duplicitní kopii uzlu, pokud je přepsáno v odvozené třídě. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Vrací hodnotu indikující, zda má tento uzel nějaké podřízené uzly. |
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Vrací spojené hodnoty uzlu a všech jeho podřízených uzlů. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Vrací uzel okamžitě následující tomuto uzlu. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Vrací rodičovský uzel tohoto uzlu (pro uzly, které mohou mít rodiče). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Vrací infoset po validaci schématu, který byl přiřazen tomuto uzlu jako výsledek validace schématu. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Vyvolá transformační funkci na každý prvek generické sekvence a vrátí maximální získanou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Vyvolá transformační funkci na každý prvek generické sekvence a vrátí minimální získanou hodnotu. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Třídí prvky sekvence ve vzestupném pořadí podle hodnot klíčů vybraných keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Třídí prvky sekvence v sestupném pořadí podle hodnot klíčů vybraných keySelector. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Umístí všechny [XmlText](../xmltext/) uzly v plné hloubce podstromu pod tímto [XmlNode](../xmlnode/) do „normální“ podoby, kde je pouze značkování (značky, komentáře, instrukce zpracování, sekce CDATA a odkazy na entity) oddělující [XmlText](../xmltext/) uzly, tj. neexistují sousední [XmlText](../xmltext/) uzly. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](../xmlnode/removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Odstraní specifikovaný podřízený uzel. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Vybere první [XmlNode](../xmlnode/) odpovídající výrazu [XPath](../../system.xml.xpath/). Všechny prefixy nalezené ve výrazu [XPath](../../system.xml.xpath/) jsou rozlišeny pomocí poskytnutého [XmlNamespaceManager](../xmlnamespacemanager/). |
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Nastaví spojené hodnoty uzlu a všech jeho podřízených uzlů. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Uloží všechny podřízené uzly uzlu do zadaného [XmlWriter](../xmlwriter/), pokud je přepsáno v odvozené třídě. |
