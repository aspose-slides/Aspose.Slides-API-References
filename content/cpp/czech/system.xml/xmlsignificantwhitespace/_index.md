...
description: "Reprezentuje bílý znak mezi značkami ve smíšeném uzlu obsahu nebo bílý znak v rozsahu xml:space='preserve'. Toto se také označuje jako významný bílý znak."
type: docs
weight: 482
url: /cs/system.xml/xmlsignificantwhitespace/
---
## XmlSignificantWhitespace třída

Reprezentuje bílý znak mezi značkami ve smíšeném uzlu obsahu nebo bílý znak v rozsahu **xml:space='preserve'**. Toto se také označuje jako významný bílý znak.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Vrací iterátor ukazující na první prvek (pokud existuje) konstantní instance kolekce. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Vrací iterátor ukazující na první konstantní prvek (pokud existuje) kolekce. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Vrací iterátor ukazující těsně za posledním konstantním prvkem (pokud existuje) kolekce. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Vrací iterátor ukazující těsně za posledním prvkem (pokud existuje) konstantní instance kolekce. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Vrací hodnotu určující, zda tento uzel má nějaké podřízené uzly. |
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Vrací konkatenované hodnoty uzlu a všech jeho podřízených uzlů. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Vrací značky představující pouze podřízené uzly tohoto uzlu. |
...
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | Vrací délku dat v znacích. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Vrací značky obsahující tento uzel a všechny jeho podřízené uzly. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Vrací uzel, který předchází tomuto uzlu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](./get_previoustext/)() override | Vrací textový uzel, který předchází tomuto uzlu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Vrací informační sadu po ověření schématem, která byla přiřazena tomuto uzlu v důsledku ověření schématem. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Vrací enumerátor, který iteruje přes podřízené uzly aktuálního uzlu. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Vyhledá nejbližší deklaraci **xmlns** pro zadaný prefix, která je v rozsahu aktuálního uzlu, a vrátí URI jmenného prostoru v deklaraci. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Vyhledá nejbližší deklaraci **xmlns** pro zadané URI jmenného prostoru, které je v rozsahu aktuálního uzlu, a vrátí předponu definovanou v této deklaraci. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Vloží zadaný řetězec na zadaný posun znaků. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformuje každý prvek sekvence do nové formy zahrnutím indexu prvku. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Umístí všechny [XmlText](../xmltext/) uzly v plné hloubce podstromu pod tímto [XmlNode](../xmlnode/) do „normální“ podoby, kde jsou mezi [XmlText](../xmltext/) uzly odděleny pouze značkami (tj. tagy, komentáře, instrukce zpracování, sekce CDATA a odkazy na entity), tedy neexistují sousední [XmlText](../xmltext/) uzly. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Vybere první [XmlNode](../xmlnode/), který odpovídá výrazu [XPath](../../system.xml.xpath/). Všechny předpony nalezené ve výrazu [XPath](../../system.xml.xpath/) jsou rozřešeny pomocí poskytnutého [XmlNamespaceManager](../xmlnamespacemanager/). |
| virtual void [set_Data](../xmlcharacterdata/set_data/)([String](../../system/string/)) | Nastaví data uzlu. |
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Nastaví konkatenované hodnoty uzlu a všech jeho podřízených uzlů. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Nastaví značky představující pouze podřízené uzly tohoto uzlu. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Získá podřetězec celého řetězce ze zadaného rozsahu. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvětší počítadlo slabých odkazů. Nemělo by se volat přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Uloží všechny podřízené uzly do zadaného [XmlWriter](../xmlwriter/). |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku ani pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním asertací. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel k předávání jako argument funkcím. 
