...
description: Reprezentuje textový obsah elementu nebo atributu.
type: docs
weight: 495
url: /cs/system.xml/xmltext/
---
## XmlText třída
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) instance kolekce označené jako const. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Vrací hodnotu označující, zda má tento uzel nějaké podřízené uzly. |
...
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Vrací značkovací kód představující pouze podřízené uzly tohoto uzlu. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Vrací hodnotu označující, zda je uzel jen pro čtení. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Vrací uzel okamžitě následující tento uzel. |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Vrací typ aktuálního uzlu. |
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Vrací značkovací kód obsahující tento uzel a všechny jeho podřízené uzly. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Vrací nadřazený uzel tohoto uzlu (pro uzly, které mohou mít nadřazené uzly). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Vrací informační sadu po validaci schématu, která byla tomuto uzlu přiřazena v důsledku validace schématu. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Vyhledá nejbližší **xmlns** deklaraci pro zadaný prefix, která je v platnosti pro aktuální uzel, a vrátí URI jmenného prostoru v deklaraci. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Vyhledá nejbližší **xmlns** deklaraci pro zadané URI jmenného prostoru, která je v platnosti pro aktuální uzel, a vrátí prefix definovaný v této deklaraci. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Vloží zadaný uzel těsně za specifikovaný referenční uzel. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Vloží zadaný uzel těsně před specifikovaný referenční uzel. |
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Vloží zadaný řetězec na specifikovaný znakový posun. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Linq::IGrouping](../../system.linq/igrouping/)\<Key, T\>\>\>\> [LINQ_GroupBy](../../system.collections.generic/ienumerable/linq_groupby/)([System::Func](../../system/func/)\<T, Key\>) | Seskuje prvky sekvence. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock() příkazu. Zavolejte přímo nebo použijte hlídací objekt [LockContext](../../system/lockcontext/). |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Umístí všechny uzly [XmlText](./) v plné hloubce podstromu pod tímto [XmlNode](../xmlnode/) do „normální“ podoby, kde jsou uzly [XmlText](./) odděleny pouze značkami (tj. tagy, komentáře, instrukcemi zpracování, sekcemi CDATA a referencemi na entity), takže neexistují sousední uzly [XmlText](./). |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Nahradí zadaný počet znaků počínaje specifikovaným posunem zadaným řetězcem. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Vybere první [XmlNode](../xmlnode/), který odpovídá výrazu [XPath](../../system.xml.xpath/). Všechny prefixy nalezené ve výrazu [XPath](../../system.xml.xpath/) jsou rozpuštěny pomocí poskytnutého [XmlNamespaceManager](../xmlnamespacemanager/). |
...
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Nastaví značkovací kód představující pouze podřízené uzly tohoto uzlu. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlText](./)\> [SplitText](./splittext/)(**int32_t**) | Rozdělí uzel na dva uzly na specifikovaném posunu, přičemž oba zůstávají ve stromu jako sourozenci. |
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Získá podřetězec z plného řetězce ze specifikovaného rozsahu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() příkazu. Zavolejte přímo nebo použijte hlídací objekt [LockContext](../../system/lockcontext/). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Uloží všechny podřízené uzly do zadaného [XmlWriter](../xmlwriter/). Uzly [XmlText](./) nemají podřízené uzly, takže tato metoda nemá žádný efekt. |
...
Objekty této třídy by měly být alokovány pouze pomocí funkce [System::MakeObject()](../../system/makeobject/). Nikdy nevytvářejte instance tohoto typu na zásobníku nebo pomocí operátoru new, protože to povede k chybám za běhu a/nebo selháním aserce. Vždy zabalte tuto třídu do ukazatele [System::SmartPtr](../../system/smartptr/) a používejte tento ukazatel k předávání jako argument funkcím jako argument. 
