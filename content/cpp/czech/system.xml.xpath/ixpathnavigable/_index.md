...
description: Poskytuje přístup k třídě XPathNavigator.
type: docs
weight: 14
url: /cs/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable třída

Poskytuje přístup k třídě [XPathNavigator](../xpathnavigator/).
...
| Metoda | Popis |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | Vrací nový objekt [XPathNavigator](../xpathnavigator/). |
