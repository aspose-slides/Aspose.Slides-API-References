...
description: Poskytuje iterátor nad vybranou množinou uzlů.
type: docs
weight: 79
url: /cs/system.xml.xpath/xpathnodeiterator/
---
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | Při přepsání v odvozené třídě vrací klon tohoto objektu [XPathNodeIterator](./). |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Získá iterátor ukazující těsně za posledním prvkem (pokud existuje) instance kolekce s kvalifikací const. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání s plovoucí desetinnou čárkou ve stylu C#, kde jsou dva NaN považovány za stejný, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Vrací index posledního uzlu ve vybraném množině uzlů. |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | Při přepsání v odvozené třídě získá objekt [XPathNavigator](../xpathnavigator/) pro tento [XPathNodeIterator](./), umístěný na aktuálním kontextovém uzlu. |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | Při přepsání v odvozené třídě získá index aktuální pozice ve vybraném množině uzlů. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu čítače odkazů spojenou s objektem. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací objekt IEnumerator pro iteraci přes vybranou množinu uzlů. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání výrazu C# lock(). Volá se přímo nebo se používá hlídací objekt [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [MoveNext](./movenext/)() | Při přepsání v odvozené třídě přesune objekt [XPathNavigator](../xpathnavigator/) vrácený metodou [XPathNodeIterator::get_Current](./get_current/) na další uzel ve vybraném množině uzlů. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepnout ukazatele v kontejnerech do režimu weak. |
| int [SharedCount](../../system/object/sharedcount/)() const | Získá aktuální hodnotu sdíleného čítače odkazů. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zvětší sdílený čítač odkazů. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Sníží a vrátí sdílený čítač odkazů. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání výrazu C# lock(). Volá se přímo nebo se používá hlídací objekt [LockContext](../../system/lockcontext/). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvětší slabý čítač odkazů. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Sníží slabý čítač odkazů. Nemělo by se volat přímo; místo toho použijte inteligentní ukazatele nebo ThisProtector. |
| [XPathNodeIterator](./xpathnodeiterator/)() | Inicializuje novou instanci třídy [XPathNodeIterator](./). |
