...
description: Poskytuje výjimku vyvolanou, když během zpracování výrazu XPath nastane chyba.
type: docs
weight: 1
url: /cs/system.xml.xpath/details_xpathexception/
---
## Details_XPathException třída


Poskytuje výjimku vyvolanou, když během zpracování výrazu [XPath](../) nastane chyba.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Vrací 32bitovou celočíselnou hodnotu, což je kód HRESULT spojený s výjimkou reprezentovanou aktuálním objektem. |
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | Vrací popis chybového stavu této výjimky. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Vrací řetězec obsahující stack trace. |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastavuje n-tý šablonový argument jako slabý ukazatel (místo sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do slabého režimu. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodu [what()](../../system/details_exception/what/), která je volána třídou [ExceptionWrapper](../../system/exceptionwrapper/). Navzdory tomu, že tato třída ne dědí ze std::exception, odvozené třídy mohou používat chráněné/soukromé členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../../system/exceptionwrapper/) může tuto logiku narušit. |
| virtual  [~Object](../../system/object/~object/)() | Uvolňuje objekt. Uvolňuje všechny interní datové struktury. |
## Typedefy
