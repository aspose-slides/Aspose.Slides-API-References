...
description: Spojuje řetězce, pokud není předem známo, kolik řetězců bude.
type: docs
weight: 1
url: /cs/system.xml.xsl.runtime/stringconcat/
---
## StringConcat třída

Spojuje řetězce, pokud není předem známo, kolik řetězců bude.
...
| Metoda | Popis |
| --- | --- |
| void [Clear](./clear/)() | Vymaže výstupní řetězec. |
| void [Concat](./concat/)(const [String](../../system/string/)\&) | Spojí nový řetězec k výsledku. |
...
| [String](../../system/string/) [get_Delimiter](./get_delimiter/)() | Vrací řetězec, který odděluje spojené řetězce. |
...
| [String](../../system/string/) [GetResult](./getresult/)() | Vrací výstupní řetězec. |
...
| void [set_Delimiter](./set_delimiter/)(const [String](../../system/string/)\&) | Nastaví řetězec, který odděluje spojené řetězce. |
...
|  [StringConcat](./stringconcat/)() | Výchozí konstruktor. |
...
* jmenný prostor [System::Xml::Xsl::Runtime](../)
