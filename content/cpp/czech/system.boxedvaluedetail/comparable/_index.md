...
description: Jednoduchá implementace IComparable<>
type: docs
weight: 1
url: /cs/system.boxedvaluedetail/comparable/
---
## Comparable třída

Jednoduchá implementace IComparable<>
...
| Metoda | Popis |
| --- | --- |
| int [CompareTo](./compareto/)(T) override | Porovnává aktuální objekt se zadaným objektem. |
