...
description: Neměnný objekt, který představuje efekt Alpha Ceiling. Hodnoty Alpha (průhlednost) větší než nula jsou změněny na 100%. Jinými slovy, vše, co je částečně neprůhledné, se stane zcela neprůhledným.
type: docs
weight: 274
url: /cs/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData třída

Neměnný objekt, který představuje efekt Alpha Ceiling. Hodnoty Alpha (průhlednost) větší než nula jsou změněny na 100 %. Jinými slovy, vše, co je částečně neprůhledné, se stane zcela neprůhledným.
