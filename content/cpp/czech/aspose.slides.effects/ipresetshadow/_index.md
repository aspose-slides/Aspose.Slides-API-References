...
| virtual **float** [get_Direction](./get_direction/)() | Směr stínu. Čte **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Vzdálenost stínu. Čte **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Přednastavení. Čte [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Barva stínu. Pouze ke čtení [IColorFormat](../../aspose.slides/icolorformat/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Směr stínu. Zápis **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Vzdálenost stínu. Zápis **double**. |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | Přednastavení. Zápis [PresetShadowType](../../aspose.slides/presetshadowtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení podle C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
