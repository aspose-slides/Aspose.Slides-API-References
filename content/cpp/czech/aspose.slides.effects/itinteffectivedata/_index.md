...
description: Neměnný objekt, který představuje efekt odstínu. Posouvá hodnoty barvy efektu směrem k odstínu nebo od něj o zadané množství.
type: docs
weight: 1002
url: /cs/aspose.slides.effects/itinteffectivedata/
---
## ITintEffectiveData třída

Neměnný objekt, který představuje [Tint](../tint/) efekt. Posouvá hodnoty barvy efektu směrem k odstínu nebo od něj o zadané množství.
...
| virtual **float** [get_Amount](./get_amount/)() | Vrací množství efektu. Pouze ke čtení **float**. |
| virtual **float** [get_Hue](./get_hue/)() | Vrací odstín. Pouze ke čtení **float**. |
