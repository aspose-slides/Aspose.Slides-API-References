...
description: Neměnný objekt, který představuje efekt měkkých hran. Okraje tvaru jsou rozmazány, zatímco výplň není ovlivněna.
type: docs
weight: 976
url: /cs/aspose.slides.effects/isoftedgeeffectivedata/
---
## ISoftEdgeEffectiveData třída


Neměnný objekt představující efekt měkkých hran. Okraje tvaru jsou rozmazány, zatímco výplň není ovlivněna.
...
| virtual **double** [get_Radius](./get_radius/)() | Určuje poloměr rozostření, který se použije na okraje. Pouze pro čtení **double**. |
