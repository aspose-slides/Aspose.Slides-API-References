...
description: Neměnný objekt, který představuje kolekci jen pro čtení efektivních efektů transformace obrazu.
type: docs
weight: 820
...
Neměnný objekt, který představuje kolekci jen pro čtení efektivních efektů transformace obrazu.
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>, **int32_t**) override | Zkopíruje všechny prvky z kolekce do zadaného pole. |
...
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda je zadaný objekt roven aktuálnímu objektu. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání plovoucí desetinné čárky ve stylu C#, kde jsou dvě hodnoty NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání plovoucí desetinné čárky ve stylu C#, kde jsou dvě hodnoty NaN považovány za rovné, i když podle IEC 60559:1989 není NaN rovno žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro vnitřní použití. |
| **int32_t** [get_Count](./get_count/)() override | Vrací počet efektů obrazu v kolekci. Pouze pro čtení **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který prochází kolekci. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Slouží jako hashovací funkce pro konkrétní typ, vhodná pro použití v hashovacích algoritmech a datových strukturách, jako je hash tabulka. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analogie volání C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) override | Vrací prvek podle indexu. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Určuje, zda v sekvenci existuje prvek, který splňuje podmínku. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformuje každý prvek sekvence do nové podoby pomocí zahrnutí indexu prvku. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Neprovádí žádné kopírování, jen inicializuje nový objekt a umožňuje kopírování podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Neprovádí žádné kopírování, jen inicializuje nový objekt a umožňuje kopírování podtříd. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení výrazu C# lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| Typedef | Popis |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Typ kolekce, jejíž typy iterátorů jsou použity jako typy iterátorů v aktuální kolekci. |
...
Název IImageTransformOperationCollectionEffectiveData byl zkrácen na [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/) kvůli omezení délky COM názvů, která nesmí překročit 39 znaků.

## Viz také

* Třída [IEffectiveData](../../aspose.slides/ieffectivedata/)
* Třída [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/)
