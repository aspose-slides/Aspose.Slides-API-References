...
description: Neměnný objekt, který představuje efekt Alpha Replace. Hodnoty alfa (průhlednosti) efektu jsou nahrazeny pevnou hodnotou alfa.
type: docs
weight: 404
url: /cs/aspose.slides.effects/ialphareplaceeffectivedata/
---
## IAlphaReplaceEffectiveData třída

Neměnný objekt, který představuje efekt Alpha Replace. Hodnoty alfa (průhlednosti) efektu jsou nahrazeny pevnou hodnotou alfa.
...
| virtual **float** [get_Alpha](./get_alpha/)() | Vrací novou hodnotu alfa v intervalu [0..1] Pouze pro čtení **float**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamykání podle C# lock() příkazu. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
