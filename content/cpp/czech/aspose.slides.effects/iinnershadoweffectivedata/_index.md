...
description: Neměnný objekt, který představuje vnitřní stínový efekt.
type: docs
weight: 781
url: /cs/aspose.slides.effects/iinnershadoweffectivedata/
---
## IInnerShadowEffectiveData třída

Neměnný objekt, který představuje vnitřní stínový efekt.
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) poloměr. Pouze pro čtení **double**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý šablonový argument na slabý ukazatel (spíše než sdílený). Umožňuje přepínání ukazatelů v kontejnerech do režimu weak. |
