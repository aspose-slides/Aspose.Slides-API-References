...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda je zadaný [PresetShadow](./) roven aktuálnímu [PresetShadow](./). |
...
| **float** [get_Direction](./get_direction/)() override | Směr stínu. Číst **float**. |
| **double** [get_Distance](./get_distance/)() override | Vzdálenost stínu. Číst **double**. |
...
| [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() override | Předvolba. Číst [PresetShadowType](../../aspose.slides/presetshadowtype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadowEffectiveData](../ipresetshadoweffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data efektu Preset Shadow s aplikovaným děděním. |
...
| void [set_Direction](./set_direction/)(**float**) override | Směr stínu. Zápis **float**. |
| void [set_Distance](./set_distance/)(**double**) override | Vzdálenost stínu. Zápis **double**. |
| void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) override | Předvolba. Zápis [PresetShadowType](../../aspose.slides/presetshadowtype/). |
...
* Třída [IPresetShadow](../ipresetshadow/)
