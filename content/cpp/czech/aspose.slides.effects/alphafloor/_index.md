...
description: Representuje efekt Alpha Floor. Hodnoty alfa (průhlednost) menší než 100% jsou změněny na nulu. Jinými slovy, vše částečně průhledné se stane zcela průhledným.
type: docs
weight: 27
...
Represents an Alpha Floor effect. Alpha (průhlednost) values less than 100% are changed to zero. In other words, anything partially transparent becomes fully transparent.
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda zadaný [AlphaFloor](./) je roven aktuálnímu [AlphaFloor](./). |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání čísel s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, přestože podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání čísel s plovoucí desetinnou čárkou ve stylu C#, kde jsou dvě NaN považovány za rovné, přestože podle IEC 60559:1989 NaN není rovno žádné hodnotě, včetně NaN. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data Alpha Floor efektu s aplikovaným děděním. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nezkopíruje nic, pouze inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nezkopíruje nic, pouze inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
