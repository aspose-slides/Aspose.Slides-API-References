...
description: Neměnný objekt, který představuje efekt stupně šedi. Převádí všechny barvy efektu na odstín šedé odpovídající jejich luminanci. Hodnoty alfa (průhlednosti) efektu zůstávají nezměněny.
type: docs
weight: 677
url: /cs/aspose.slides.effects/igrayscaleeffectivedata/
---
## IGrayScaleEffectiveData třída

Neměnný objekt, který představuje efekt stupně šedi. Převádí všechny barvy efektu na odstín šedé odpovídající jejich luminanci. Hodnoty alfa (průhlednosti) efektu zůstávají nezměněny.
