...
---
## IColorChangeEffectiveData třída
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Porovnává objektové reference v stylu C#. |
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_FromColor](./get_fromcolor/)() | Barva, která bude nahrazena. Pouze pro čtení [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ToColor](./get_tocolor/)() | Barva, která nahradí. Pouze pro čtení [System::Drawing::Color](../../system.drawing/color/). |
| virtual **bool** [get_UseAlpha](./get_usealpha/)() | Vrací boolean hodnotu, která určuje, zda má být použita alfa komponenta. Pouze pro čtení **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopírovací konstruktor. Ve skutečnosti nic nezkopíruje, jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nezkopíruje, jen inicializuje nový objekt a umožňuje kopírovací konstrukci podtříd. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Získá současnou hodnotu sdíleného počitadla referencí. |
