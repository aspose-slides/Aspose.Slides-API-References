...
description: Představuje efekt Glow, ve kterém je kolem okrajů objektu přidán rozmazaný obrys barvy.
type: docs
weight: 638
...
Představuje efekt [Glow](../glow/), ve kterém je kolem okrajů objektu přidán rozmazaný obrys barvy.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Formát barvy. Pouze pro čtení [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Poloměr. Čte **double**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Volá se přímo nebo se použije objekt hlídky [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Poloměr. Zápis **double**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí příkazu C# lock(). Volá se přímo nebo se použije objekt hlídky [LockContext](../../system/lockcontext/). |
