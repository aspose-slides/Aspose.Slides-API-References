...
description: Reprezentuje efekt Duotone. Pro každý pixel kombinuje Color1 a Color2 lineární interpolací k určení nové barvy pro daný pixel.
type: docs
weight: 157
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda je zadaný [Duotone](./) roven aktuálnímu [Duotone](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color1](./get_color1/)() override | Vrací cílový formát barev pro tmavé pixely. Pouze pro čtení [IColorFormat](../../aspose.slides/icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color2](./get_color2/)() override | Vrací cílový formát barev pro světlé pixely. Pouze pro čtení [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotoneEffectiveData](../iduotoneeffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data efektu [Duotone](./) s aplikovaným děděním. |
