...
description: Představuje efekt Alpha Modulate Fixed. Hodnoty alfa (průhlednosti) efektu jsou násobeny pevnou procentuální hodnotou.
type: docs
weight: 66
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda je zadaný [AlphaModulateFixed](./) roven aktuálnímu [AlphaModulateFixed](./). |
...
| **float** [get_Amount](./get_amount/)() override | Vrací množství efektu v procentech. Čte **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data efektu Alpha Modulate Fixed s aplikovaným děděním. |
...
| void [set_Amount](./set_amount/)(**float**) override | Vrací množství efektu v procentech. Zápis **float**. |
...
* Třída [IAlphaModulateFixed](../ialphamodulatefixed/)
