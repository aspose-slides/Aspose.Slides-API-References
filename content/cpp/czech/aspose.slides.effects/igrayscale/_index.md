...
description: Reprezentuje rozhraní IImageTransformOperation.
type: docs
weight: 664
...
Representuje [IImageTransformOperation](../iimagetransformoperation/) rozhraní.
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamčení C# lock() statement. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí C# lock() statement. Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
