...
---
## IBrightnessContrastEffectiveData třída

Neměnný objekt, který představuje [BrightnessContrast](../brightnesscontrast/) efekt. Upravuje jas a kontrast
...
| virtual **float** [get_Brightness](./get_brightness/)() | Vrací jas. Pouze pro čtení **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Vrací kontrast. Pouze pro čtení **float**. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Zmenší a vrátí sdílený čítač referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmenší slabý čítač referencí. Nemělo by být voláno přímo; místo toho použijte chytré ukazatele nebo ThisProtector. |
