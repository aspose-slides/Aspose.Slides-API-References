...
description: Neměnný objekt, který představuje efekt Fill Overlay. Překrytí výplní může být použito k určení další výplně pro objekt a ke smíchání dvou výplní dohromady.
type: docs
weight: 625
url: /cs/aspose.slides.effects/ifilloverlayeffectivedata/
---
## IFillOverlayEffectiveData třída

Neměnný objekt, který představuje efekt Fill Overlay. Překrytí výplní může být použito k určení další výplně pro objekt a ke smíchání dvou výplní dohromady.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Pouze pro čtení [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Fill format. Pouze pro čtení [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) strážní objekt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí příkazu C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) strážní objekt. |
