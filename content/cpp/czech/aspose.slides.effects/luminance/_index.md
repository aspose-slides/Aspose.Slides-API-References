...
description: Představuje efekt Luminance. Jas lineárně posouvá všechny barvy blíže k bílé nebo černé. Kontrast mění škálu všech barev tak, aby byly buď blíže, nebo dále od sebe.
type: docs
weight: 1028
...
Represents a [Luminance](./) effect. Brightness lineárně posouvá všechny barvy blíže k bílé nebo černé. Contrast škáluje všechny barvy tak, aby byly buď blíže, nebo dále od sebe.
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda je zadaný [Luminance](./) roven aktuálnímu [Luminance](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data efektu [Luminance](./) s aplikovaným děděním. |
