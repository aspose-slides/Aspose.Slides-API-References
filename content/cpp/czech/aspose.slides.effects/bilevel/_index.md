...
description: Představuje efekt Bi-Level (černobílý). Vstupní barvy, jejichž luminance je menší než zadaná prahová hodnota, jsou změněny na černou. Vstupní barvy, jejichž luminance je větší nebo rovna zadané hodnotě, jsou nastaveny na bílou. Hodnoty alfa efektu tímto efektem nejsou ovlivněny.
type: docs
weight: 92
...
Představuje efekt Bi-Level (černobílý). Vstupní barvy, jejichž luminance je menší než zadaná prahová hodnota, jsou změněny na černou. Vstupní barvy, jejichž luminance je větší nebo rovna zadané hodnotě, jsou nastaveny na bílou. Hodnoty alfa efektu nejsou tímto efektem ovlivněny.
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda je zadaný [BiLevel](./) roven aktuálnímu [BiLevel](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevelEffectiveData](../ibileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data efektu Bi-Level s aplikovaným děděním. |
