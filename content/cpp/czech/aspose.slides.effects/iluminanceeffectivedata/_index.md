...
description: Představuje Luminance efekt. Jas lineárně posouvá všechny barvy blíže k bílé nebo černé. Kontrast mění škálu všech barev tak, aby byly buď blíže, nebo dál od sebe.
type: docs
weight: 807
url: /cs/aspose.slides.effects/iluminanceeffectivedata/
---
## ILuminanceEffectiveData třída


Představuje [Luminance](../luminance/) efekt. Jas lineárně posouvá všechny barvy blíže k bílé nebo černé. Kontrast mění škálu všech barev tak, aby byly buď blíže, nebo dál od sebe.
...
| Metoda | Popis |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Porovnává objekty pomocí semantie C# [Object.Equals](../../system/object/equals/). |
...
| virtual **float** [get_Brightness](./get_brightness/)() | Jas. Jenom ke čtení **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Kontrast. Jenom ke čtení **float**. |
