...
description: Reprezentuje efekt Fill Overlay. Překrytí výplní může být použito k určení další výplně pro objekt a k sloučení dvou výplní dohromady.
type: docs
weight: 183
...
Representuje efekt překrytí výplní. Překrytí výplní lze použít k zadání další výplně pro objekt a k sloučení dvou výplní dohromady.
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda je zadaný [FillOverlay](./) roven aktuálnímu [FillOverlay](./). |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání plovoucího desetinného čísla ve stylu C#, kde jsou dva NaN považovány za rovné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní účely. |
| [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() override | FillBlendMode. Čtení [FillBlendMode](../../aspose.slides/fillblendmode/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Formát výplně. Pouze pro čtení [IFillFormat](../../aspose.slides/ifillformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlayEffectiveData](../ifilloverlayeffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data efektu Fill Overlay s aplikovaným děděním. |
...
| void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) override | FillBlendMode. Zápis [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony jako slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do režimu slabého ukazatele. |
...
* Třída [IFillOverlay](../ifilloverlay/)
