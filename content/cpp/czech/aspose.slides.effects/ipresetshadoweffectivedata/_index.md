...
---
## IPresetShadowEffectiveData třída


Neměnný objekt, který představuje efekt Preset Shadow.
...
| virtual **float** [get_Direction](./get_direction/)() | Směr stínu. Pouze pro čtení **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Vzdálenost stínu. Pouze pro čtení **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Předvolba. Pouze pro čtení [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Barva stínu. Pouze pro čtení [System::Drawing::Color](../../system.drawing/color/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí výrazu C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení pomocí výrazu C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
