...
description: Reprezentuje efekt rozostření, který se aplikuje na celý tvar, včetně výplně. Všechny barevné kanály, včetně alfa, jsou ovlivněny.
type: docs
weight: 456
...
| virtual **bool** [get_Grow](./get_grow/)() | Určuje, zda by měly být hranice objektu zvětšeny v důsledku rozostření. True označuje, že jsou hranice zvětšeny, zatímco false označuje, že nejsou. Číst **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Vrací poloměr rozostření. Číst **double**. |
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Získává efektivní data s aplikovaným děděním. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | Určuje, zda by měly být hranice objektu zvětšeny v důsledku rozostření. True označuje, že jsou hranice zvětšeny, zatímco false označuje, že nejsou. Zapisuje **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | Nastavuje poloměr rozostření. Zapisuje **double**. |
