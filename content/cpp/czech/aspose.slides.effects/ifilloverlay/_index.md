...
description: Reprezentuje efekt Fill Overlay. Fill overlay může být použit k určení další výplně pro objekt a k jejich smíchání.
type: docs
weight: 612
...
Reprezentuje efekt Fill Overlay. Fill overlay může být použit k určení dalšího výplně pro objekt a k jejich smíchání.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Porovnává reference objektů ve stylu C#. |
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Čtení [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Fill format. Pouze pro čtení [IFillFormat](../../aspose.slides/ifillformat/). |
...
| virtual void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) | FillBlendMode. Zápis [FillBlendMode](../../aspose.slides/fillblendmode/). |
