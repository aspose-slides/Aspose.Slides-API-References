...
description: Reprezentuje abstraktní efekt transformace obrázku.
type: docs
weight: 729
url: /cs/aspose.slides.effects/iimagetransformoperation/
---
## IImageTransformOperation třída
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() příkazu. Volá se přímo nebo se použije objekt strážce [LockContext](../../system/lockcontext/). |
