...
description: Reprezentuje vnitřní stínový efekt.
type: docs
weight: 768
...
Reprezentuje vnitřní stínový efekt.
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) poloměr. Číst **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Směr stínu. Číst **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Vzdálenost stínu. Číst **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Barva stínu. Pouze pro čtení [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_BlurRadius](./set_blurradius/)(**double**) | [Blur](../blur/) poloměr. Zapsat **double**. |
| virtual void [set_Direction](./set_direction/)(**float**) | Směr stínu. Zapsat **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Vzdálenost stínu. Zapsat **double**. |
...
* Obor názvů [Aspose::Slides::Effects](../)
