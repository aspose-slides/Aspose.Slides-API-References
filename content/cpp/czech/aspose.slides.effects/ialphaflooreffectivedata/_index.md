...
description: Nezměnitelný objekt, který představuje efekt Alpha Floor. Hodnoty alfa (průhlednosti) menší než 100% jsou změněny na nulu. Jinými slovy, vše částečně průhledné se stane zcela průhledným.
type: docs
weight: 300
url: /cs/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData třída

Nezměnitelný objekt, který představuje efekt Alpha Floor. Hodnoty alfa (průhlednost) menší než 100% jsou změněny na nulu. Jinými slovy, cokoliv částečně průhledného se stane zcela průhledným.
