...
description: Reprezentuje efekt Alpha Inverse. Hodnoty alfa (průhlednost) jsou invertovány odečtením od 100%.
type: docs
weight: 313
...
Representuje efekt Alpha Inverse. Hodnoty alfa (průhlednost) jsou invertovány odečtením od 100%.
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání dle C# lock() příkazu. Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování dle C# lock() příkazu. Volat přímo nebo použít objekt strážce [LockContext](../../system/lockcontext/). |
