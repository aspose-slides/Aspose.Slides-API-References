...
description: Representuje efekt Luminance. Jas lineárně posouvá všechny barvy blíže k bílé nebo černé. Kontrast škáluje všechny barvy tak, aby byly buď blíže, nebo dále od sebe.
type: docs
weight: 794
...
Representuje efekt [Luminance](../luminance/). Jas lineárně posouvá všechny barvy blíže k bílé nebo černé. Kontrast škáluje všechny barvy tak, aby byly buď blíže, nebo dále od sebe.
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte strážní objekt [LockContext](../../system/lockcontext/). |
