...
---
## IDuotoneEffectiveData třída


Neměnný objekt, který představuje efekt [Duotone](../duotone/). Pro každý pixel kombinuje clr1 a clr2 pomocí lineární interpolace k určení nové barvy pro tento pixel.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color1](./get_color1/)() | Vrací cílový formát barvy pro tmavé pixely. Pouze pro čtení [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color2](./get_color2/)() | Vrací cílový formát barvy pro světlé pixely. Pouze pro čtení [System::Drawing::Color](../../system.drawing/color/). |
