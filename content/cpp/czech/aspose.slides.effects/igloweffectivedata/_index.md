...
description: Neměnný objekt, který představuje efekt Glow, při němž je kolem okrajů objektu přidán rozmazaný obrys barvy.
type: docs
weight: 651
...
Neměnný objekt, který představuje efekt [Glow](../glow/), ve kterém je kolem okrajů objektu přidán rozmazaný obrys barvy.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Barva. Pouze pro čtení [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_Radius](./get_radius/)() | Poloměr. Pouze pro čtení **double**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání podle příkazu C# lock(). Volá se přímo nebo pomocí [LockContext](../../system/lockcontext/) strážného objektu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí podle příkazu C# lock(). Volá se přímo nebo pomocí [LockContext](../../system/lockcontext/) strážného objektu. |
