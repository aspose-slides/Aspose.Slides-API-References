...
type: docs
weight: 417
url: /cs/aspose.slides.effects/iapplicableeffect/
---
## IApplicableEffect třída
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazu C# lock(). Volá se přímo nebo se použije objekt hlídky [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí výrazu C# lock(). Volá se přímo nebo se použije objekt hlídky [LockContext](../../system/lockcontext/). |
