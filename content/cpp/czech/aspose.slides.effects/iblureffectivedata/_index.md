...
description: Neměnný objekt, který představuje efekt rozostření aplikovaný na celý tvar, včetně výplně. Všechny barevné kanály, včetně alfa, jsou ovlivněny.
type: docs
weight: 469
url: /cs/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData třída

Neměnný objekt, který představuje efekt [Blur](../blur/) aplikovaný na celý tvar, včetně výplně. Všechny barevné kanály, včetně alfa, jsou ovlivněny.
...
| virtual **bool** [get_Grow](./get_grow/)() | Určuje, zda mají být ohraničení objektu rozšířena v důsledku rozmazání. Pravda značí, že ohraničení jsou rozšířena, zatímco nepravda značí opak. Pouze pro čtení **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Vrací poloměr rozostření. Pouze pro čtení **double**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Volá se přímo nebo pomocí objektu strážce [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Volá se přímo nebo pomocí objektu strážce [LockContext](../../system/lockcontext/). |
