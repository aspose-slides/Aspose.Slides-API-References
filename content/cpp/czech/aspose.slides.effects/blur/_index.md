...
description: Reprezentuje efekt Blur, který se aplikuje na celý tvar, včetně výplně. Všechny barevné kanály, včetně alfa kanálu, jsou ovlivněny.
type: docs
weight: 105
...
Reprezentuje efekt [Blur](./), který se aplikuje na celý tvar, včetně výplně. Všechny barevné kanály, včetně alfa kanálu, jsou ovlivněny.
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda je zadaný [Blur](./) roven aktuálnímu [Blur](./). |
...
| **bool** [get_Grow](./get_grow/)() override | Určuje, zda mají být hranice objektu rozšířeny v důsledku rozostření. True znamená, že jsou hranice rozšířeny, zatímco false značí, že nejsou. Číst **bool**. |
...
| **double** [get_Radius](./get_radius/)() override | Vrací poloměr rozostření. Číst **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Získá datovou strukturu počítadla odkazů spojenou s objektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data efektu [Blur](./) s aplikovaným děděním. |
...
| void [set_Grow](./set_grow/)(**bool**) override | Určuje, zda mají být hranice objektu rozšířeny v důsledku rozostření. True znamená, že jsou hranice rozšířeny, zatímco false značí, že nejsou. Zapsat **bool**. |
| void [set_Radius](./set_radius/)(**double**) override | Nastaví poloměr rozostření. Zapsat **double**. |
