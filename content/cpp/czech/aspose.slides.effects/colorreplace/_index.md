...
description: Representuje efekt výměny barvy. Všechny barvy efektu jsou změněny na pevnou barvu. Hodnoty alfa nejsou ovlivněny.
type: docs
weight: 144
...
Representuje efekt výměny barvy. Všechny barvy efektu jsou změněny na pevnou barvu. Hodnoty alfa nejsou ovlivněny.
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda zadaný [ColorReplace](./) je roven aktuálnímu [ColorReplace](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | Vrací formát barvy, který nahradí barvu každého pixelu. Pouze ke čtení [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplaceEffectiveData](../icolorreplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Získá efektivní data efektu Color Replacement s aplikovaným děděním. |
...
* Třída [IColorReplace](../icolorreplace/)
