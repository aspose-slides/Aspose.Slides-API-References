...
description: Reprezentuje efekt Hue/Saturation/Luminance. Odstín, sytost a jas lze každou upravit relativně k její aktuální hodnotě.
type: docs
weight: 703
url: /cs/aspose.slides.effects/ihsleffectivedata/
---
## IHSLEffectiveData třída

Reprezentuje efekt Hue/Saturation/Luminance. Hodnoty hue, saturation a luminance lze každou upravit relativně k jejich aktuální hodnotě.
...
| virtual **float** [get_Hue](./get_hue/)() | Vrací procento odstínu. Pouze pro čtení **float**. |
| virtual **float** [get_Luminance](./get_luminance/)() | Vrací procento jasnosti. Pouze pro čtení **float**. |
| virtual **float** [get_Saturation](./get_saturation/)() | Vrací procento nasycení. Pouze pro čtení **float**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) objekt strážce. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování pomocí C# lock(). Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) objekt strážce. |
