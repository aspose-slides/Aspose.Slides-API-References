...
description: Representuje efekt Alpha Modulate Fixed. Hodnoty alfa (průhlednost) efektu jsou násobeny pevnou procentuální hodnotou.
type: docs
weight: 365
url: /cs/aspose.slides.effects/ialphamodulatefixed/
---
## IAlphaModulateFixed třída


Representuje efekt Alpha Modulate Fixed. Hodnoty alfa (průhlednost) efektu jsou násobeny pevnou procentuální hodnotou.
...
| virtual **float** [get_Amount](./get_amount/)() | Vrací množství efektu v procentech. Čtení **float**. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Porovnává reference objektu hodnotového typu s nullptr. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Vrací množství efektu v procentech. Zápis **float**. |
