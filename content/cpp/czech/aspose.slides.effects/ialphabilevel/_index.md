...
description: Reprezentuje efekt Alpha Bi-Level. Hodnoty Alpha (průhlednost) menší než práh jsou změněny na 0 (zcela průhledné) a hodnoty alpha větší nebo rovné prahu jsou změněny na 100 % (zcela neprůhledné).
type: docs
weight: 235
...
Reprezentuje efekt Alpha Bi-Level. Hodnoty Alpha (průhlednost) menší než práh jsou změněny na 0 (zcela průhledné) a hodnoty alpha větší nebo rovné prahu jsou změněny na 100 % (zcela neprůhledné).
...
| virtual **float** [get_Threshold](./get_threshold/)() | Vrací práh efektu. Čtení **float**. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Vrací práh efektu. Zápis **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech na slabý režim. |
...
Použijte [ImageTransformOperationFactory](../imagetransformoperationfactory/) k vytvoření instancí v COM. 
## Viz také
