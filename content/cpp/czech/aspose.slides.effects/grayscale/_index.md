...
description: Představuje efekt Gray Scale. Převádí všechny hodnoty barev efektu na odstín šedé odpovídající jejich luminanci. Hodnoty alfa (průhlednosti) efektu nejsou ovlivněny.
type: docs
weight: 209
...
| Metoda | Popis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Určuje, zda zadaný [GrayScale](./) je roven aktuálnímu [GrayScale](./). |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | Vrací rodičovský [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). Pouze pro čtení [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScaleEffectiveData](../igrayscaleeffectivedata/)\> [GetEffective](./geteffective/)() override | Získává efektivní data efektu Gray Scale s aplikovaným děděním. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídacího [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí příkazu C# lock(). Zavolejte přímo nebo použijte objekt hlídacího [LockContext](../../system/lockcontext/). |
