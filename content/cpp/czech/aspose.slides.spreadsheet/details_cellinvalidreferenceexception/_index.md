...
description: Výjimka, která je vyvolána, když je nalezena neplatná reference buňky.
type: docs
weight: 27
url: /cs/aspose.slides.spreadsheet/details_cellinvalidreferenceexception/
---
## Details_CellInvalidReferenceException třída


Výjimka, která je vyvolána, když je nalezena neplatná reference buňky.
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Získá neplatnou referenci buňky. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Zkontroluje, zda objekt představuje instance typu popsaného targetType. Analog operátoru C# 'is'. |
