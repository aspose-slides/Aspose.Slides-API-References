...
description: Reprezentuje objekt, který zajišťuje nízkoúrovňovou práci s zařazováním úloh do vláken.
type: docs
weight: 79
url: /cs/system.threading.tasks/taskscheduler/
---
## TaskScheduler třída

Reprezentuje objekt, který zajišťuje nízkoúrovňovou práci s zařazováním úloh do vláken.
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Vytvoří [TaskScheduler](./) spojený s aktuálním vláknem. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Získá [TaskScheduler](./) spojený s právě vykonávanou úlohou. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Získá výchozí instanci [TaskScheduler](./), kterou poskytuje rámec. |
| **int32_t** [get_Id](./get_id/)() const | Získá jedinečný identifikátor pro tento [TaskScheduler](./). |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Uvádí maximální úroveň souběžnosti, kterou může tento [TaskScheduler](./) podporovat. |
