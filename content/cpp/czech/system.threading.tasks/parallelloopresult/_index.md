...
description: Poskytuje stav dokončení paralelní smyčky.
type: docs
weight: 14
url: /cs/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult třída


Poskytuje stav dokončení [Parallel](../parallel/) smyčky.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Získá, zda smyčka proběhla do konce. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Získá nejnižší index iterace, při které došlo k přerušení. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Vytvoří [ParallelLoopResult](./). |
...
Reprezentuje výsledek operace paralelní smyčky, včetně toho, zda byla dokončena, a informací o přerušeních. 
## Viz také
