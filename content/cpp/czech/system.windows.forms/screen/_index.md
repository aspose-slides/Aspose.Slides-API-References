...
description: Poskytuje informace o displejích. Pouze Windows. Jedná se o typ singleton s řízením paměti prováděným pomocí přístupových funkcí. Nikdy byste neměli vytvářet jeho instance přímo.
type: docs
weight: 40
url: /cs/system.windows.forms/screen/
---
## Screen třída
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Získá rozměry obrazovky. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Získá informace o primárním displeji. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí C# lock(). Volá se přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operátor přiřazení. Ve skutečnosti nic nekopíruje, pouze inicializuje nový objekt a umoňuje kopírování podtříd. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí příkazu C# lock(). Volá se přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
