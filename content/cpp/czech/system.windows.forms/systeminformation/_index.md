...
description: Falešná třída, která umožní kompilovat přeložený kód používající třídu SystemInformation. Metody nejsou implementovány. Jedná se o statický typ bez služeb instance. Neměli byste za žádných okolností vytvářet jeho instance.
type: docs
weight: 53
url: /cs/system.windows.forms/systeminformation/
---
## SystemInformation struct

Falešná třída, která umožní kompilovat přeložený kód používající třídu [SystemInformation](./). Metody nejsou implementovány. Jedná se o statický typ bez služeb instance. Neměli byste za žádných okolností vytvářet jeho instance.
