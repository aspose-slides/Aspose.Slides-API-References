...
description: Poskytuje přístup k přepsanému motivu rozložení snímků.
type: docs
weight: 482
...
| Method | Description |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Aplikuje extra barevné schéma na snímek. |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Určuje, zda [OverrideTheme](../overridetheme/) přepisuje zděděný efektivní motiv, nebo ne. Pro povolení [OverrideTheme](../overridetheme/) pro přepisování použijte metody OverrideTheme.Init*(). Pro zakázání [OverrideTheme](../overridetheme/) přepisování použijte metodu [OverrideTheme::Clear](../overridetheme/clear/). Pouze ke čtení **bool**. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý čítač referencí. Nemělo by se volat přímu; místo toho použijte chytré ukazatele nebo ThisProtector. |
