...
---
## IExtraColorScheme třída

Reprezentuje další barevné schéma, které může být přiřazeno snímku.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() | Vrací schéma barev. Pouze pro čtení [IColorScheme](../icolorscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Vrací název tohoto schématu. Pouze pro čtení [System::String](../../system/string/). |
