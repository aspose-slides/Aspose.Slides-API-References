...
description: Neměnný objekt, který obsahuje vlastnosti efektivního formátovacího schématu.
type: docs
weight: 313
url: /cs/aspose.slides.theme/iformatschemeeffectivedata/
---
## IFormatSchemeEffectiveData třída
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollectionEffectiveData](../ifillformatcollectioneffectivedata/)\> [GetBackgroundFillStyles](./getbackgroundfillstyles/)([System::Drawing::Color](../../system.drawing/color/)) | Vrací kolekci stylů výplně pozadí definovaných motivem. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleCollectionEffectiveData](../ieffectstylecollectioneffectivedata/)\> [GetEffectStyles](./geteffectstyles/)([System::Drawing::Color](../../system.drawing/color/)) | Vrací kolekci stylů efektů definovaných motivem. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollectionEffectiveData](../ifillformatcollectioneffectivedata/)\> [GetFillStyles](./getfillstyles/)([System::Drawing::Color](../../system.drawing/color/)) | Vrací kolekci stylů výplně definovaných motivem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umožňuje hashování vlastních objektů. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatCollectionEffectiveData](../ilineformatcollectioneffectivedata/)\> [GetLineStyles](./getlinestyles/)([System::Drawing::Color](../../system.drawing/color/)) | Vrací kolekci stylů čar definovaných motivem. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání pomocí výrazu C# lock(). Zavolejte přímo nebo použijte objekt hlídkový [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí výrazu C# lock(). Zavolejte přímo nebo použijte objekt hlídkový [LockContext](../../system/lockcontext/). |
