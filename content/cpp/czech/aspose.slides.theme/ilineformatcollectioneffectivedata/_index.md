...
description: Neměnný objekt, který představuje kolekci pouze pro čtení efektivních formátů čar.
type: docs
weight: 339
url: /cs/aspose.slides.theme/ilineformatcollectioneffectivedata/
---
## ILineFormatCollectionEffectiveData třída
...
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopíruje všechny prvky z kolekce do zadaného pole. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../../aspose.slides/ilineformateffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Získá prvek na zadaném indexu. Pouze pro čtení [ILineFormatEffectiveData](../../aspose.slides/ilineformateffectivedata/). |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformovací funkci na každém prvku generické sekvence a vrací maximální získanou hodnotu. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Volá transformovací funkci na každém prvku generické sekvence a vrací minimální získanou hodnotu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamčení pomocí C# lock() příkazu. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) strážný objekt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí pomocí C# lock() příkazu. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) strážný objekt. |
