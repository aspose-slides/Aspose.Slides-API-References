...
description: Reprezentuje správce přepisovaného motivu.
type: docs
weight: 404
url: /cs/aspose.slides.theme/ioverridethemeable/
---
## IOverrideThemeable třída

Reprezentuje správce přepisovaného motivu.
...
| Metoda | Popis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithemeable/createthemeeffective/)() | Vrací efektivní motiv pro tento objekt, který podporuje motivy. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideThemeManager](../ioverridethememanager/)\> [get_ThemeManager](./get_thememanager/)() | Vrací správce přepisovaného motivu. Pouze pro čtení [IOverrideThemeManager](../ioverridethememanager/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý argument šablony na slabý ukazatel (namísto sdíleného). Umožňuje přepínání ukazatelů v kontejnerech do režimu slabého ukazatele. |
