...
| Metoda | Popis |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() | Získá iterator ukazující na první prvek (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Získá iterator ukazující na první prvek (pokud existuje) konstantně kvalifikované instance kolekce. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Získá iterator ukazující na první konstantně kvalifikovaný prvek (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Získá iterator ukazující těsně za poslední konstantně kvalifikovaný prvek (pokud existuje) kolekce. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>, **int32_t**) override | Zkopíruje všechny prvky z kolekce do zadaného pole. |
...
| [iterator](./iterator/) [end](./end/)() | Získá iterator ukazující těsně za poslední prvek (pokud existuje) kolekce. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Získá iterator ukazující těsně za poslední prvek (pokud existuje) konstantně kvalifikované instance kolekce. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>\> [GetEnumerator](./getenumerator/)() override | Vrací enumerátor, který prochází kolekci. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [idx_get](./idx_get/)(**int32_t**) override | Získá prvek na zadaném indexu. Pouze pro čtení [IFillFormat](../../aspose.slides/ifillformat/). |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Získá iterator ukazující na první prvek (pokud existuje) konstantně kvalifikované instance kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Získá iterator ukazující na první prvek (pokud existuje) kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Získá iterator ukazující těsně za poslední prvek (pokud existuje) konstantně kvalifikované instance kolekce. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Získá iterator ukazující těsně za poslední prvek (pokud existuje) kolekce. |
...
* Třída [IFillFormatCollection](../ifillformatcollection/)
