...
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() override | Vrací kolekci písem pro část "heading" snímku. Pouze pro čtení [IFonts](../../aspose.slides/ifonts/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() override | Vrací kolekci písem pro část "body" snímku. Pouze pro čtení [IFonts](../../aspose.slides/ifonts/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Vrací název schématu písma. Čtení [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamknutí příkazu C# lock(). Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Vrací název schématu písma. Zápis [System::String](../../system/string/). |
