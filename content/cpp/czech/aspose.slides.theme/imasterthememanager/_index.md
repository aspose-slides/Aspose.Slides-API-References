...
| Metoda | Popis |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | Aplikuje další barevné schéma na snímek. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | Vrací objekt motivu. |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Určuje, zda [OverrideTheme](../overridetheme/) přepíše zděděné efektivní téma (Presentation.MasterTheme) nebo ne. Číst **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Vrací přepisující objekt motivu. Číst [IMasterTheme](../imastertheme/). |
...
| virtual void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) | Určuje, zda [OverrideTheme](../overridetheme/) přepíše zděděné efektivní téma (Presentation.MasterTheme) nebo ne. Zapsat **bool**. |
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) | Vrací přepisující objekt motivu. Zapsat [IMasterTheme](../imastertheme/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemykání pomocí C# lock(). Zavolejte přímo nebo použijte objekt hlídače [LockContext](../../system/lockcontext/). |
...
| virtual  [~Object](../../system/object/~object/)() | Zničuje objekt. Uvolňuje všechny interní datové struktury. |
## Viz také

* Třída [IThemeManager](../ithememanager/)
