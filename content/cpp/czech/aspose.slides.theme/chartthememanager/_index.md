...
| Metoda | Popis |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Použije extra barevné schéma na snímek. |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Určuje, zda [OverrideTheme](../overridetheme/) přepisuje zděděný efektivní motiv, nebo ne. Pro povolení [OverrideTheme](../overridetheme/) k přepisování použijte metody OverrideTheme.Init*(). Pro zakázání [OverrideTheme](../overridetheme/) od přepisování použijte metodu [OverrideTheme::Clear](../overridetheme/clear/). Pouze pro čtení **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Vrací přepisující objekt motivu. Čtěte [IOverrideTheme](../ioverridetheme/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje uzamčení pomocí C# lock() příkazu. Zavolejte přímo nebo použijte objekt [LockContext](../../system/lockcontext/). |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Vrací přepisující objekt motivu. Zapište [IOverrideTheme](../ioverridetheme/). |
