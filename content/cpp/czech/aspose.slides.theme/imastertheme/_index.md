...
description: Reprezentuje hlavní téma.
type: docs
weight: 352
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](../itheme/get_colorscheme/)() | Vrací schéma barev. Pouze ke čtení [IColorScheme](../icolorscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | Vrací doplňkové schéma barev na zadaném indexu. Toto schéma neovlivňuje vzhled prezentace, může být vybráno jako hlavní schéma barev pro snímek. Pouze ke čtení [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | Vrací kolekci doplňkových schémat barev. Tato schémata neovlivňují vzhled prezentace, mohou být vybrána jako hlavní schéma barev pro snímek. Pouze ke čtení [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](../itheme/get_fontscheme/)() | Vrací schéma písma. Pouze ke čtení [IFontScheme](../ifontscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](../itheme/get_formatscheme/)() | Vrací schéma formátu tvaru. Pouze ke čtení [IFormatScheme](../iformatscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Vrací název motivu. Čtení [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../itheme/geteffective/)() | Získá efektivní data motivu s aplikovaným děděním. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Vrací název motivu. Zápis [System::String](../../system/string/). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zvyšuje slabý čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatelé nebo ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Snižuje slabý čítač referencí. Nemělo by se volat přímo; místo toho použijte chytré ukazatelé nebo ThisProtector. |
