...
description: Reprezentuje další barevné schéma, které lze přiřadit snímku.
type: docs
weight: 79
...
Representuje další barevné schéma, které může být přiřazeno snímku.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | Vrací barevné schéma. Pouze pro čtení [IColorScheme](../icolorscheme/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Vrací název tohoto schématu. Pouze pro čtení [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání C# lock() prohlášení. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentinel objekt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemknutí C# lock() prohlášení. Zavolejte přímo nebo použijte [LockContext](../../system/lockcontext/) sentinel objekt. |
...
* Třída [IExtraColorScheme](../iextracolorscheme/)
