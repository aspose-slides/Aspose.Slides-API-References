...
description: Určuje funkce XSLT, které mají být podporovány během provádění XSLT stylového listu.
type: docs
weight: 118
url: /cs/system.xml.xsl/xsltsettings/
---
## XsltSettings třída
...
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_Default](./get_default/)() | Vrací objekt [XsltSettings](./) s výchozím nastavením. Podpora funkce XSLT **document()** a vložených skriptových bloků je zakázána. |
| **bool** [get_EnableDocumentFunction](./get_enabledocumentfunction/)() | Vrací hodnotu, která udává, zda povolit podporu funkce XSLT **document()**. |
| **bool** [get_EnableScript](./get_enablescript/)() | Vrací hodnotu, která udává, zda povolit podporu vložených skriptových bloků. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_TrustedXslt](./get_trustedxslt/)() | Vrací objekt [XsltSettings](./), který umožňuje podporu funkce XSLT **document()** a vložených skriptových bloků. |
...
| void [set_EnableDocumentFunction](./set_enabledocumentfunction/)(**bool**) | Nastaví hodnotu udávající, zda povolit podporu funkce XSLT **document()**. |
| void [set_EnableScript](./set_enablescript/)(**bool**) | Nastaví hodnotu udávající, zda povolit podporu vložených skriptových bloků. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastaví n-tý parametr šablony jako slabý ukazatel (namísto sdíleného). Umožňuje přepínat ukazatele v kontejnerech do slabého režimu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokování výrazu C# lock(). Zavolejte přímo nebo použijte objekt strážce [LockContext](../../system/lockcontext/). |
...
|  [XsltSettings](./xsltsettings/)() | Inicializuje novou instanci třídy [XsltSettings](./) s výchozím nastavením. |
|  [XsltSettings](./xsltsettings/)(**bool**, **bool**) | Inicializuje novou instanci třídy [XsltSettings](./) se zadaným nastavením. |
