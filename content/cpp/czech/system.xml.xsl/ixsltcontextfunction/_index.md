...
description: Poskytuje rozhraní k dané funkci definované v listu stylů Extensible Stylesheet Language for Transformations (XSLT) během běhu programu.
type: docs
weight: 27
url: /cs/system.xml.xsl/ixsltcontextfunction/
---
## IXsltContextFunction třída
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\> [get_ArgTypes](./get_argtypes/)() | Vrací dodané typy XML Path Language ([XPath](../../system.xml.xpath/)) pro seznam argumentů funkce. Tyto informace lze použít k zjištění signatury funkce, což vám umožní rozlišovat přetížené funkce. |
| virtual **int32_t** [get_Maxargs](./get_maxargs/)() | Vrací maximální počet argumentů funkce. To umožňuje uživateli rozlišovat přetížené funkce. |
| virtual **int32_t** [get_Minargs](./get_minargs/)() | Vrací minimální počet argumentů funkce. To umožňuje uživateli rozlišovat přetížené funkce. |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_ReturnType](./get_returntype/)() | Vrací XPathResultType představující typ [XPath](../../system.xml.xpath/) vrácený funkcí. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Invoke](./invoke/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>, [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>, [SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Poskytuje metodu pro vyvolání funkce s danými argumenty v daném kontextu. |
