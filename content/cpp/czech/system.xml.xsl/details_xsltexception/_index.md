...
description: Výjimka, která je vyvolána, když dojde k chybě při zpracování XSLT transformace.
type: docs
weight: 14
url: /cs/system.xml.xsl/details_xsltexception/
---
## Details_XsltException třída

Výjimka, která je vyvolána, když dojde k chybě při zpracování XSLT transformace.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Vrací číslo řádku, které udává, kde se v šabloně vyskytla chyba. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Vrací pozici v řádku, která udává, kde se v šabloně vyskytla chyba. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Vrací naformátovanou chybovou zprávu popisující aktuální výjimku. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Vrací cestu k umístění šablony. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Nastavuje n-tý šablonový argument na slabý ukazatel (namísto sdíleného). Umožňuje přepnutí ukazatelů v kontejnerech do slabého režimu. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodu [what()](../../system/details_exception/what/), která je volána třídou [ExceptionWrapper](../../system/exceptionwrapper/). Navzdory tomu, že tato třída nezdědila std::exception, odvozené třídy mohou používat chráněné/privátní členy k implementaci své logiky. Přesunutí implementace této metody do [ExceptionWrapper](../../system/exceptionwrapper/) může tuto logiku rozbít. |
