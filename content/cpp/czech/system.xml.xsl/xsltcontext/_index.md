...
description: Zapouzdřuje aktuální kontext vykonávání procesoru Extensible Stylesheet Language for Transformations (XSLT), který umožňuje XML Path Language (XPath) řešit funkce, parametry a jmenné prostory ve výrazech XPath.
type: docs
weight: 79
url: /cs/system.xml.xsl/xsltcontext/
---
## Třída XsltContext

Zapouzdřuje aktuální kontext vykonávání procesoru Extensible Stylesheet Language for Transformations (XSLT), což umožňuje XML Path Language ([XPath](../../system.xml.xpath/)) rozpoznávat funkce, parametry a jmenné prostory ve výrazech [XPath](../../system.xml.xpath/).
...
| Metoda | Popis |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Přidá zadaný jmenný prostor do kolekce. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Vrací iterátor ukazující na první prvek (je-li takový) kolekce. Tento iterátor nelze použít ke změně odkazovaného objektu, protože [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) vrací kopii objektu T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Vrací iterátor ukazující na první prvek (je-li takový) konstantně kvalifikované instance kolekce. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Vrací iterátor ukazující na první konstantně kvalifikovaný prvek (je-li takový) kolekce. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Vrací iterátor ukazující těsně za posledním konstantně kvalifikovaným prvkem (je-li takový) kolekce. |
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | Když je přepsáno v odvozené třídě, porovnává základní Uniform Resource Identifiers (URI) dvou dokumentů na základě pořadí, v jakém byly dokumenty načteny procesorem XSLT (tj. třída [XslTransform](../xsltransform/)). |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Vrací iterátor ukazující těsně za posledním prvkem (je-li takový) kolekce. Tento iterátor nelze použít ke změně odkazovaného objektu, protože [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) vrací kopii objektu T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Vrací iterátor ukazující těsně za posledním prvkem (je-li takový) konstantně kvalifikované instance kolekce. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porovnání floating-point ve stylu C#, kde jsou dva NaN považovány za stejné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porovnání floating-point ve stylu C#, kde jsou dva NaN považovány za stejné, i když podle IEC 60559:1989 není NaN roven žádné hodnotě, včetně NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Pouze pro interní použití. |
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | Vrací URI jmenného prostoru pro výchozí jmenný prostor. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | Vrací [XmlNameTable](../../system.xml/xmlnametable/) spojený s tímto objektem. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | Když je přepsáno v odvozené třídě, získá hodnotu udávající, zda zahrnout uzly bílých znaků do výstupu. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | Vrací enumerátor pro iteraci přes jmenné prostory v [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/). |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](../../system.xml/xmlnamespacemanager/getnamespacesinscope/)([XmlNamespaceScope](../../system.xml/xmlnamespacescope/)) override | Vrací kolekci názvů jmenných prostorů klíčovaných prefixem, která může být použita k výčtu aktuálně platných jmenných prostorů. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Získá skutečný typ objektu. Analogie volání C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | Vrací hodnotu udávající, zda zadaný prefix má v aktuálním zásobníku definovaný jmenný prostor. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Určuje, zda existuje nějaký prvek sekvence nebo zda splňuje podmínku. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence ve vzestupném pořadí podle hodnot klíčů vybraných pomocí keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Řadí prvky sekvence v sestupném pořadí podle hodnot klíčů vybraných pomocí keySelector. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání příkazu C# lock(). Volá se přímo nebo se použije objekt [LockContext](../../system/lockcontext/). |
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | Vrací URI jmenného prostoru pro zadaný prefix. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | Najde prefix deklarovaný pro daný URI jmenného prostoru. |
...
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | Odebere rozsah jmenného prostoru ze zásobníku. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Když je přepsáno v odvozené třídě, určuje, zda ve zvoleném kontextu zachovat uzly bílých znaků nebo je odstranit. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | Vloží rozsah jmenného prostoru na zásobník. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Odstraní zadaný jmenný prostor pro zadaný prefix. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | Když je přepsáno v odvozené třídě, vyřeší odkaz na funkci a vrátí [IXsltContextFunction](../ixsltcontextfunction/) reprezentující funkci. [IXsltContextFunction](../ixsltcontextfunction/) se používá při vykonávání k získání návratové hodnoty funkce. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | Když je přepsáno v odvozené třídě, vyřeší odkaz na proměnnou a vrátí [IXsltContextVariable](../ixsltcontextvariable/) reprezentující proměnnou. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení příkazu C# lock(). Volá se přímo nebo se použije objekt [LockContext](../../system/lockcontext/). |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inicializuje novou instanci třídy [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) s určeným [XmlNameTable](../../system.xml/xmlnametable/). |
