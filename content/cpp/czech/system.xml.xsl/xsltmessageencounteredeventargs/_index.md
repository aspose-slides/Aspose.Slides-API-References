...
description: "Poskytuje data pro událost XsltArgumentList::XsltMessageEncountered."
type: docs
weight: 92
url: /cs/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs třída

Poskytuje data pro událost **XsltArgumentList::XsltMessageEncountered**.
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | Vrací obsah elementu **xsl:message**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje zamykání dle C# lock(). Volat přímo nebo použít [LockContext](../../system/lockcontext/) objekt hlídky. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Porovnává odkaz na objekt hodnotového typu s nullptr. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odemčení dle C# lock(). Volat přímo nebo použít [LockContext](../../system/lockcontext/) objekt hlídky. |
...
| Pole | Popis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statický člen, který představuje "prázdný" [EventArgs](../../system/eventargs/) sdílený ukazatel (null-ukazatel). |
