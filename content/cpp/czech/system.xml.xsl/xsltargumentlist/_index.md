...
description: Obsahuje proměnný počet argumentů, které jsou buď XSLT parametry nebo rozšiřující objekty.
type: docs
weight: 66
url: /cs/system.xml.xsl/xsltargumentlist/
---
## XsltArgumentList třída

Obsahuje proměnný počet argumentů, které jsou buď XSLT parametry nebo rozšiřující objekty.
...
| Method | Description |
| --- | --- |
| void [AddExtensionObject](./addextensionobject/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Přidá nový objekt do [XsltArgumentList](./) a přiřadí jej k URI jmenného prostoru. |
| void [AddParam](./addparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Přidá parametr do [XsltArgumentList](./) a přiřadí jej k plně kvalifikovanému názvu jmenného prostoru. |
| void [Clear](./clear/)() | Odstraní všechny parametry a rozšířené objekty z [XsltArgumentList](./). |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetExtensionObject](./getextensionobject/)(const [String](../../system/string/)\&) | Vrací objekt spojený s daným jmenným prostorem. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetParam](./getparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Vrací parametr spojený s plně kvalifikovaným názvem jmenného prostoru. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveExtensionObject](./removeextensionobject/)(const [String](../../system/string/)\&) | Odstraní objekt s URI jmenného prostoru z [XsltArgumentList](./). |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveParam](./removeparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Odstraní parametr z [XsltArgumentList](./). |
...
|  [XsltArgumentList](./xsltargumentlist/)() | Implementuje novou instanci [XsltArgumentList](./). |
