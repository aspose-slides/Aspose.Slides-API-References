...
| Name | Description |
| --- | --- |
| getQuartileMethod() | Represents quartile method. Applies only to BoxAndWhisker charts. |
...
| Name | Description |
| --- | --- |
| setQuartileMethod(int) | Represents quartile method. Applies only to BoxAndWhisker charts. |
