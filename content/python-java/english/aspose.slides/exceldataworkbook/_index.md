...
### createExcelDataWorkbookFromBytes  {#createExcelDataWorkbookFromBytes }

| Name | Description |
| --- | --- |
| createExcelDataWorkbookFromBytes (Bytes[]) | Initializes a new instance of the class using the provided stream. |

 **Parameters:**

| Name | Type | Description |
| --- | --- | --- |
| stream | Bytes[] | A stream containing the Excel workbook data. |
