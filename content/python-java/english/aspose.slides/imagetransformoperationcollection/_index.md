 ...
 **Returns:**
[Duotone](../duotone), [ColorReplace](../colorreplace), [GrayScale](../grayscale), [OuterShadow](../outershadow), [FillOverlay](../filloverlay), [AlphaInverse](../alphainverse), [Blur](../blur), [AlphaCeiling](../alphaceiling), [HSL](../hsl), [AlphaFloor](../alphafloor), [SoftEdge](../softedge), [AlphaModulate](../alphamodulate), [AlphaBiLevel](../alphabilevel), [ColorChange](../colorchange), [Tint](../tint), [InnerShadow](../innershadow), [Reflection](../reflection), [AlphaReplace](../alphareplace), [ImageTransformOperation](../imagetransformoperation), [PresetShadow](../presetshadow), [Glow](../glow), [AlphaModulateFixed](../alphamodulatefixed), [BiLevel](../bilevel), [Luminance](../luminance)
