 ...
 **Returns:**
[Reflection](../reflection), [ColorReplace](../colorreplace), [HSL](../hsl), [AlphaBiLevel](../alphabilevel), [OuterShadow](../outershadow), [AlphaCeiling](../alphaceiling), [Luminance](../luminance), [AlphaInverse](../alphainverse), [AlphaModulate](../alphamodulate), [Glow](../glow), [InnerShadow](../innershadow), [BiLevel](../bilevel), [SoftEdge](../softedge), [BrightnessContrast](../brightnesscontrast), [FillOverlay](../filloverlay), [AlphaFloor](../alphafloor), [GrayScale](../grayscale), [AlphaModulateFixed](../alphamodulatefixed), [ColorChange](../colorchange), [Tint](../tint), [Duotone](../duotone), [Blur](../blur), [AlphaReplace](../alphareplace), [PresetShadow](../presetshadow), [ImageTransformOperation](../imagetransformoperation)
