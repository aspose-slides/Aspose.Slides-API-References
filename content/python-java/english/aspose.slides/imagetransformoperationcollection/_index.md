...
| Name | Description |
| --- | --- |
| addBrightnessContrastEffect(float, float) | Adds the new BrightnessContrast effect to the end of a collection. |
 ...
 **Returns:**
[AlphaBiLevel](../alphabilevel), [ImageTransformOperation](../imagetransformoperation), [GrayScale](../grayscale), [AlphaReplace](../alphareplace), [AlphaCeiling](../alphaceiling), [AlphaFloor](../alphafloor), [OuterShadow](../outershadow), [BiLevel](../bilevel), [AlphaModulateFixed](../alphamodulatefixed), [Blur](../blur), [Tint](../tint), [Duotone](../duotone), [HSL](../hsl), [Glow](../glow), [ColorChange](../colorchange), [InnerShadow](../innershadow), [ColorReplace](../colorreplace), [FillOverlay](../filloverlay), [AlphaInverse](../alphainverse), [Reflection](../reflection), [AlphaModulate](../alphamodulate), [PresetShadow](../presetshadow), [BrightnessContrast](../brightnesscontrast), [SoftEdge](../softedge), [Luminance](../luminance)
