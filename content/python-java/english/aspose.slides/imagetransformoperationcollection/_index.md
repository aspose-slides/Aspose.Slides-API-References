 ...
 **Returns:**
[Duotone](../duotone), [AlphaModulateFixed](../alphamodulatefixed), [HSL](../hsl), [Glow](../glow), [AlphaFloor](../alphafloor), [PresetShadow](../presetshadow), [BiLevel](../bilevel), [OuterShadow](../outershadow), [ColorReplace](../colorreplace), [AlphaReplace](../alphareplace), [AlphaBiLevel](../alphabilevel), [AlphaCeiling](../alphaceiling), [AlphaInverse](../alphainverse), [ImageTransformOperation](../imagetransformoperation), [SoftEdge](../softedge), [Tint](../tint), [Reflection](../reflection), [GrayScale](../grayscale), [Luminance](../luminance), [AlphaModulate](../alphamodulate), [Blur](../blur), [ColorChange](../colorchange), [FillOverlay](../filloverlay), [InnerShadow](../innershadow)
