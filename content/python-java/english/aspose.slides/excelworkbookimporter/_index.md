...
### addChartFromWorkbookFromBytes  {#addChartFromWorkbookFromBytes }

| Name | Description |
| --- | --- |
| addChartFromWorkbookFromBytes ([ShapeCollection](../shapecollection), float, float, Bytes[], String,  String, boolean) | Retrieves a chart from the specified Excel workbook and adds it to the end of the given shape collection at the specified coordinates. |
...
| x | float | The X coordinate for positioning the chart. |
| y | float | The Y coordinate for positioning the chart. |
| workbookStream | Bytes[] | A stream containing the workbook data. |
| worksheetName | String | The name of the worksheet that contains the chart. |
| chartName | String | The name of the chart to be added. |
| embedAllWorkbook | boolean | If true, the entire workbook will be embedded in the chart; if false, only the chart data will be embedded. |
...
### addTableFromWorkbookFromBytes  {#addTableFromWorkbookFromBytes }

| Name | Description |
| --- | --- |
| addTableFromWorkbookFromBytes ([ShapeCollection](../shapecollection), float, float, Bytes[], String,  String) | Retrieves a table from the specified Excel workbook file and adds it to the end of the given shape collection at the specified coordinates. |
