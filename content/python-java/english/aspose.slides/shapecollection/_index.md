...
### addAudioFrameEmbeddedFromBytes  {#addAudioFrameEmbeddedFromBytes }

| Name | Description |
| --- | --- |
| addAudioFrameEmbeddedFromBytes (float, float, float, float, Bytes[]) | Adds a new audio frame with embedded audio file to the end of a collection. Embedded audio file can be a WAV only. It adds new audio into Presentation.Audios list. |
...
| width | float | Width of a new audio frame. |
| height | float | Height of a new audio frame. |
| audio_stream | Bytes[] | Inout stream with audio data. |
 ...
 **Returns:**
[Table](../table), [Chart](../chart), [Shape](../shape), [SectionZoomFrame](../sectionzoomframe), [AutoShape](../autoshape), [GeometryShape](../geometryshape), [Connector](../connector), [ZoomObject](../zoomobject), [SummaryZoomSection](../summaryzoomsection), [VideoFrame](../videoframe), [AudioFrame](../audioframe), [PictureFrame](../pictureframe), [Ink](../ink), [ZoomFrame](../zoomframe), [SmartArtShape](../smartartshape), [LegacyDiagram](../legacydiagram), [SummaryZoomFrame](../summaryzoomframe), [GroupShape](../groupshape), [GraphicalObject](../graphicalobject), [SmartArt](../smartart), [OleObjectFrame](../oleobjectframe)
...
### insertAudioFrameEmbeddedFromBytes  {#insertAudioFrameEmbeddedFromBytes }

| Name | Description |
| --- | --- |
| insertAudioFrameEmbeddedFromBytes (int, float, float, float, float, Bytes[]) | Insert an AudioFrame with embedded audio file. Embedded audio file sound can be a WAV only. |
...
| width | float | Width of a new audio frame. |
| height | float | Height of a new audio frame. |
| audio_stream | Bytes[] | Audio stream. |
