...
url: /aspose.slides/blackwhiteconversionmode/
---
...
| --- | --- | --- |
[Default](#Default) | 0 | Specifies no conversion algorithm. The algorithm implemented in the TIFF codec will be used. (Default) |
[Dithering](#Dithering) | 1 | Specifies the dithering algorithm (Floyd-Steinberg). |
[DitheringFloydSteinberg](#DitheringFloydSteinberg) | 2 | Specifies the Floyd-Steinberg dithering algorithm. |
[Auto](#Auto) | 3 | Specifies the automatically calculated threshold algorithm (Otsu). |
[AutoOtsu](#AutoOtsu) | 4 | Specifies the automatically calculated Otsu's threshold algorithm. |
[Threshold25](#Threshold25) | 5 | Specifies the static threshold algorithm (25%). |
[Threshold50](#Threshold50) | 6 | Specifies the static threshold algorithm (50%). |
[Threshold75](#Threshold75) | 7 | Specifies the static threshold algorithm (75%). |
