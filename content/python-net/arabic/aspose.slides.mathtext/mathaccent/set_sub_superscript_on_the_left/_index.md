...
description: 
type: docs
url: /ar/aspose.slides.mathtext/mathaccent/set_sub_superscript_on_the_left/
weight: 150
---
...
New math element of type [`IMathLeftSubSuperscriptElement`](/slides/python-net/ar/aspose.slides.mathtext/imathleftsubsuperscriptelement)
...
| معلمة | نوع | وصف |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/ar/aspose.slides.mathtext/imathelement) | Subscript (lower index on the left) |
| superscript | [`IMathElement`](/slides/python-net/ar/aspose.slides.mathtext/imathelement) | Superscript (upper index on the left) |
...
* فئة [`IMathLeftSubSuperscriptElement`](/slides/python-net/ar/aspose.slides.mathtext/imathleftsubsuperscriptelement)
