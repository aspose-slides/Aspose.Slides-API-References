...
description: 
type: docs
url: /ar/aspose.slides.mathtext/mathematicaltext/to_border_box/
weight: 200
---
## to_border_box(self) {#}
يضع هذا العنصر في صندوق حدود
...
| strikethrough_horizontal | **bool** | خط عبر أفقي لصندوق الحدود |
| strikethrough_vertical | **bool** | خط عبر عمودي لصندوق الحدود |
| strikethrough_bottom_left_to_top_right | **bool** | خط عبر من الأسفل-يسار إلى الأعلى-يمين لصندوق الحدود |
| strikethrough_top_left_to_bottom_right | **bool** | خط عبر من الأعلى-يسار إلى الأسفل-يمين لصندوق الحدود |
