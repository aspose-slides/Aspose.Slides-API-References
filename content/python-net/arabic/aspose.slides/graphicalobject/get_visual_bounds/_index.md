...
A **aspose.slides.RectangleF** يمثل الحدود البصرية للشكل
             في إحداثيات الشريحة.
...
المستطيل الذي تم إرجاعه يمثل الحدود المحاذاة للمحور لجميع المحتويات التي ينتجها الشكل أثناء العرض في مساحة إحداثيات الشريحة.
             ...
             تأخذ الحدود البصرية في الاعتبار الجوانب المرتبطة بالعرض مثل التحولات (مثلاً، الدوران)، عرض الخطوط والواصلات، تخطيط النص وتدفقه، هندسة SmartArt، وغيرها من تأثيرات التخطيط التي تؤثر على المظهر النهائي المعروض للشكل.
            
             الحدود التي تم إرجاعها غير مقصوصة إلى مستطيل الشريحة.
