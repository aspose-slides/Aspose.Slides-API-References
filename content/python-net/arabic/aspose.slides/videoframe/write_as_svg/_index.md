...
description: 
type: docs
url: /ar/aspose.slides/videoframe/write_as_svg/
weight: 100
---
## write_as_svg(self, stream) {#iorawiobase}
يحفظ محتوى Shape كملف SVG.
...
| :- | :- | :- |
| stream | **io.RawIOBase** | دفق الهدف |
| svg_options | [`ISVGOptions`](/slides/python-net/ar/aspose.slides.export/isvgoptions) | خيارات إنشاء SVG |

### انظر أيضًا
* الفئة [`ISVGOptions`](/slides/python-net/ar/aspose.slides.export/isvgoptions)
