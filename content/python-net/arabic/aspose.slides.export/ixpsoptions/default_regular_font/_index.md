...
description: 
type: docs
url: /ar/aspose.slides.export/ixpsoptions/default_regular_font/
weight: 20
---
## default_regular_font خاصية
### التعريف:
```python
@property
...
### انظر أيضًا
* فئة [`IXpsOptions`](/slides/python-net/ar/aspose.slides.export/ixpsoptions)
