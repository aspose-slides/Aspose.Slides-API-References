...
description: 
type: docs
url: /ar/aspose.slides.ink/iinkactions/write_as_svg/
weight: 50
---
...
| :- | :- | :- |
| stream | **io.RawIOBase** |  |
| svg_options | [`ISVGOptions`](/slides/python-net/ar/aspose.slides.export/isvgoptions) |  |



### انظر أيضًا
* الصنف [`IInkActions`](/slides/python-net/ar/aspose.slides.ink/iinkactions)
* الصنف [`ISVGOptions`](/slides/python-net/ar/aspose.slides.export/isvgoptions)
