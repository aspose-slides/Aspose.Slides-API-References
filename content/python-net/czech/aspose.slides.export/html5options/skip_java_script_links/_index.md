...
description: 
type: docs
url: /cs/aspose.slides.export/html5options/skip_java_script_links/
weight: 120
---
## skip_java_script_links vlastnost
Určuje, zda při ukládání prezentace přeskočit hypertextové odkazy s voláním JavaScriptu. 
            Read/write **bool**. Výchozí hodnota je **false** .
