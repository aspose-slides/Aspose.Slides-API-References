...
description: 
type: docs
url: /cs/aspose.slides.export/iembeddedwofffontshtmlcontroller/write_slide_start/
weight: 60
---
...
| slide | [`ISlide`](/slides/python-net/cs/aspose.slides/islide) |  |



### Viz také
* třída [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/cs/aspose.slides.export/iembeddedwofffontshtmlcontroller)
