...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathmatrix/enclose/
weight: 70
---
## enclose(self) {#}
Obalí matematický prvek v závorkách
...
Obalí matematický prvek ve specifikovaných znacích, například v závorkách nebo jiných znacích jako rámec

### Návratová hodnota

Matematický prvek typu [`IMathDelimiter`](/slides/python-net/cs/aspose.slides.mathtext/imathdelimiter) který zahrnuje specifikované znaky jako rámec
