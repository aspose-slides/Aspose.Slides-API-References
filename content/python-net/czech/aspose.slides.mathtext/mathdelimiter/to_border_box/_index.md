...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathdelimiter/to_border_box/
weight: 210
---
## to_border_box(self) {#}
...
| hide_bottom | **bool** | Skrýt dolní okraj |
| hide_left | **bool** | Skrýt levý okraj |
| hide_right | **bool** | Skrýt pravý okraj |
| strikethrough_horizontal | **bool** | Border Box přeškrtnutí horizontální |
| strikethrough_vertical | **bool** | Border Box přeškrtnutí vertikální |
| strikethrough_bottom_left_to_top_right | **bool** | Border Box přeškrtnutí od levého dolního ke pravému hornímu |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box přeškrtnutí od levého horního ke pravému dolnímu |
