...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathematicaltext/integral/
weight: 90
---
## integral(self, integral_type) {#mathintegraltypes}
Vypočítá integrál bez limit
...
| Parametr | Typ | Popis |
| :- | :- | :- |
| integral_type | [`MathIntegralTypes`](/slides/python-net/cs/aspose.slides.mathtext/mathintegraltypes) | Typ integrálu |
...
| lower_limit | [`IMathElement`](/slides/python-net/cs/aspose.slides.mathtext/imathelement) | Dolní mez integrálu |
| upper_limit | [`IMathElement`](/slides/python-net/cs/aspose.slides.mathtext/imathelement) | Horní mez integrálu |
| limit_locations | [`MathLimitLocations`](/slides/python-net/cs/aspose.slides.mathtext/mathlimitlocations) | umístění limitů |
