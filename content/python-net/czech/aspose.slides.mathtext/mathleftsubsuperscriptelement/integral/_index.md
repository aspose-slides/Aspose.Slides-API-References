...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathleftsubsuperscriptelement/integral/
weight: 90
---
## integral(self, integral_type) {#mathintegraltypes}
Vytvoří integrál bez mezí

### Vrací

Nová instance typu [`IMathNaryOperator`](/slides/python-net/cs/aspose.slides.mathtext/imathnaryoperator)
...
| Parametr | Typ | Popis |
| :- | :- | :- |
| integral_type | [`MathIntegralTypes`](/slides/python-net/cs/aspose.slides.mathtext/mathintegraltypes) | Integral type |
...
| :- | :- | :- |
| integral_type | [`MathIntegralTypes`](/slides/python-net/cs/aspose.slides.mathtext/mathintegraltypes) | Integral type |
| lower_limit | [`IMathElement`](/slides/python-net/cs/aspose.slides.mathtext/imathelement) | Dolní mez integrálu |
| upper_limit | [`IMathElement`](/slides/python-net/cs/aspose.slides.mathtext/imathelement) | Horní mez integrálu |
...
| :- | :- | :- |
| integral_type | [`MathIntegralTypes`](/slides/python-net/cs/aspose.slides.mathtext/mathintegraltypes) | Integral type |
| lower_limit | **str** | Dolní mez integrálu |
| upper_limit | **str** | Horní mez integrálu |
...
| lower_limit | [`IMathElement`](/slides/python-net/cs/aspose.slides.mathtext/imathelement) | Dolní mez integrálu |
| upper_limit | [`IMathElement`](/slides/python-net/cs/aspose.slides.mathtext/imathelement) | Horní mez integrálu |
| limit_locations | [`MathLimitLocations`](/slides/python-net/cs/aspose.slides.mathtext/mathlimitlocations) | Umístění mezí |
...
* enumerace [`MathIntegralTypes`](/slides/python-net/cs/aspose.slides.mathtext/mathintegraltypes)
* třída [`MathLeftSubSuperscriptElement`](/slides/python-net/cs/aspose.slides.mathtext/mathleftsubsuperscriptelement)
* enumerace [`MathLimitLocations`](/slides/python-net/cs/aspose.slides.mathtext/mathlimitlocations)
