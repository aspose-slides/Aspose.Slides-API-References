...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathleftsubsuperscriptelement/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| Parametr | Typ | Popis |
| :- | :- | :- |
| hide_top | **bool** | Skrýt horní okraj |
| hide_bottom | **bool** | Skrýt spodní okraj |
| hide_left | **bool** | Skrýt levý okraj |
| hide_right | **bool** | Skrýt pravý okraj |
| strikethrough_horizontal | **bool** | Vodorovné přeškrtnutí v border-boxu |
| strikethrough_vertical | **bool** | Svislé přeškrtnutí v border-boxu |
| strikethrough_bottom_left_to_top_right | **bool** | Přeškrtnutí od levého dolního rohu k pravému hornímu v border-boxu |
| strikethrough_top_left_to_bottom_right | **bool** | Přeškrtnutí od levého horního rohu k pravému dolnímu v border-boxu |
