...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathbar/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Přeškrtnutí border boxu horizontální |
| strikethrough_vertical | **bool** | Přeškrtnutí border boxu vertikální |
| strikethrough_bottom_left_to_top_right | **bool** | Přeškrtnutí border boxu od dolního levého k hornímu pravému |
| strikethrough_top_left_to_bottom_right | **bool** | Přeškrtnutí border boxu od horního levého k dolnímu pravému |
