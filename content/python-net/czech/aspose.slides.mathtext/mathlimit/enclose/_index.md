...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathlimit/enclose/
weight: 50
---
## enclose(self) {#}
...
Obalí matematický prvek určenými znaky, jako jsou závorky nebo jiné znaky jako ohraničení

### Návratová hodnota

Matematický prvek typu [`IMathDelimiter`](/slides/python-net/cs/aspose.slides.mathtext/imathdelimiter) který zahrnuje určené znaky jako ohraničení
