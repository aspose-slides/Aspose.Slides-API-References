...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathfraction/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| Parametr | Typ | Popis |
| :- | :- | :- |
| hide_top | **bool** | Skrýt horní hranu |
| hide_bottom | **bool** | Skrýt spodní hranu |
...
| strikethrough_bottom_left_to_top_right | **bool** | Border Box přeškrtnutí z dolního levého do pravého horního |
