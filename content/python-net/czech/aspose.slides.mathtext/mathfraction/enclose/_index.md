...
description: 
type: docs
url: /cs/aspose.slides.mathtext/mathfraction/enclose/
weight: 50
---
## enclose(self) {#}
...
Obalí matematický prvek zadanými znaky, například závorkami nebo jinými znaky jako ohraničením

### Návratová hodnota

Matematický prvek typu [`IMathDelimiter`](/slides/python-net/cs/aspose.slides.mathtext/imathdelimiter) který zahrnuje specifikované znaky jako ohraničení
