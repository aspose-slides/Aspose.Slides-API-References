...
description: 
type: docs
url: /cs/aspose.slides/legacydiagram/get_image/
weight: 50
---
## get_image(self) {#}
Vrací miniaturu tvaru.
            Výchozí typ ohraničení miniatury tvaru ShapeThumbnailBounds.Shape se používá jako výchozí.
...
Miniatura tvaru nebo None v případě, že se používá ShapeThumbnailBounds.Appearance a tvar nemá viditelné prvky.
