...
description: 
type: docs
url: /cs/aspose.slides/islidecollection/add_from_html/
weight: 30
---
...
| :- | :- | :- |
| html_text | **str** | HTML k přidání. |
| resolver | [`IExternalResourceResolver`](/slides/python-net/cs/aspose.slides.importing/iexternalresourceresolver) | Objekt zpětného volání používaný k načtení externích objektů. Pokud je tento parametr None, všechny externí objekty budou ignorovány. |
| uri | **str** | URI specifikovaného HTML. Používá se k řešení relativních odkazů. |
