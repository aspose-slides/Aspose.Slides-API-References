...
Vrácený obdélník představuje osově zarovnané ohraničení veškerého obsahu
             ...
             Tato ohraničení se mohou lišit od modelových ohraničení
             tvaru ([`Shape.x`](/slides/python-net/cs/aspose.slides/shape/x), [`Shape.y`](/slides/python-net/cs/aspose.slides/shape/y),
