...
description: 
type: docs
url: /cs/aspose.slides/paragraphcollection/add_from_html/
weight: 20
---
...
| :- | :- | :- |
| text | **str** | HTML text. |
| resolver | [`IExternalResourceResolver`](/slides/python-net/cs/aspose.slides.importing/iexternalresourceresolver) | Objekt zpětného volání resolveru, který řeší URI a načítá odkazované objekty. |
