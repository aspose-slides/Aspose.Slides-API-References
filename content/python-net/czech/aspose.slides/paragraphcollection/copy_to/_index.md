...
description: 
type: docs
url: /cs/aspose.slides/paragraphcollection/copy_to/
weight: 50
---
## copy_to(self, array, array_index) {#listiparagraph-int}
Zkopíruje prvky **System.Collections.Generic.ICollection`1** do **System.Array**, počínaje konkrétním **System.Array** indexem.
...
| Parametr | Typ | Popis |
| :- | :- | :- |
| array | **List[IParagraph]** | Jednorozměrné **System.Array**, které je cílem prvků zkopírovaných z **System.Collections.Generic.ICollection`1**. **System.Array** musí mít nulové indexování. |
