...
description: 
type: docs
url: /th/aspose.slides.charts/ichartdatapointcollection/add_data_point_for_map_series/
weight: 90
---
## add_data_point_for_map_series(self, value) {#ichartdatacell}
สร้างจุดข้อมูลใหม่และเพิ่มไปที่ท้ายของคอลเลกชัน
             ใช้ได้กับซีรีส์ที่ประเภทแผนภูมิคือแผนที่
...
| :- | :- | :- |
| value | [`IChartDataCell`](/slides/python-net/th/aspose.slides.charts/ichartdatacell) | ค่าจุดข้อมูล ColorValue |
