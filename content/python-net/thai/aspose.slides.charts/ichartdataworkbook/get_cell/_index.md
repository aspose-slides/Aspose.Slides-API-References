...
description: 
type: docs
url: /th/aspose.slides.charts/ichartdataworkbook/get_cell/
weight: 30
---
## get_cell(self, worksheet_index, cell_name) {#int-str}
รับเซลล์ที่สามารถใช้สำหรับชุดข้อมูลแผนภูมิหรือประเภท
...
| :- | :- | :- |
| worksheet_index | **int** | ดัชนีของ worksheet. |
| cell_name | **str** | ชื่อของ cell. |
...
| พารามิเตอร์ | ชนิด | คำอธิบาย |
| :- | :- | :- |
| worksheet_name | **str** | ชื่อของ worksheet. |
| row | **int** | แถว. |
| column | **int** | คอลัมน์. |
