...
description: 
type: docs
url: /th/aspose.slides.effects/reflection/end_reflection_opacity/
weight: 70
---
## end_reflection_opacity คุณสมบัติ
ความทึบของการสะท้อนสุดท้าย (เปอร์เซ็นต์).
            อ่าน/เขียน **float**.
...
### ดูเพิ่มเติม
* คลาส [`Reflection`](/slides/python-net/th/aspose.slides.effects/reflection)
