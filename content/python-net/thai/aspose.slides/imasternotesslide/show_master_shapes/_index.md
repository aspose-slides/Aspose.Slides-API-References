...
description: 
type: docs
url: /th/aspose.slides/imasternotesslide/show_master_shapes/
weight: 190
---
## show_master_shapes คุณสมบัติ
### คำนิยาม:
```python
@property
...
### ดูเพิ่มเติม
* คลาส [`IMasterNotesSlide`](/slides/python-net/th/aspose.slides/imasternotesslide)
