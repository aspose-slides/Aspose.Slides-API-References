...
description: 
type: docs
url: /th/aspose.slides/zoomobject/get_base_placeholder/
weight: 20
---
## get_base_placeholder(self) {#}
ส่งคืนรูปร่าง placeholder พื้นฐาน (รูปร่างจากเลย์เอาต์และ/หรือสไลด์หลักที่รูปร่างปัจจุบันสืบทอดมาจาก)。
            จะคืนค่า None หากรูปร่างปัจจุบันไม่ได้รับการสืบทอด.
