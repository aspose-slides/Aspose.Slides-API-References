...
description: 
type: docs
url: /th/aspose.slides/icommentcollection/add_modern_comment/
weight: 20
---
...
| position | [`PointF`](/slides/python-net/th/aspose.slides/pointf) | ตำแหน่งบนสไลด์ที่ต้องเพิ่มคอมเมนต์สมัยใหม่ใหม่ |
| creation_time | **DateTime** | เวลาในการสร้างคอมเมนต์สมัยใหม่ |
