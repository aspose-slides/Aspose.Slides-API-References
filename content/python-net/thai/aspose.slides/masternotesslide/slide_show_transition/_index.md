...
description: 
type: docs
url: /th/aspose.slides/masternotesslide/slide_show_transition/
weight: 220
---
## slide_show_transition คุณสมบัติ
ส่งคืนอ็อบเจ็กต์ Transition ที่มีข้อมูลเกี่ยวกับ
            วิธีที่สไลด์ที่ระบุดำเนินการต่อในระหว่างการแสดงสไลด์.
...
### ดูเพิ่มเติม
* คลาส [`ISlideShowTransition`](/slides/python-net/th/aspose.slides/islideshowtransition)
