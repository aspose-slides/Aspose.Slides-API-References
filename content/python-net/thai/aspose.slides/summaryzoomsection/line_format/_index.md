...
description: 
type: docs
url: /th/aspose.slides/summaryzoomsection/line_format/
weight: 330
---
## คุณสมบัติ line_format
คืนค่าอ็อบเจ็กต์ LineFormat ที่มีคุณสมบัติการจัดรูปแบบเส้นสำหรับรูปร่าง
            Note: สามารถคืนค่า None สำหรับประเภทของรูปร่างบางประเภทที่ไม่มีคุณสมบัติเส้น
            อ่านเท่านั้น [`ILineFormat`](/slides/python-net/th/aspose.slides/ilineformat).
