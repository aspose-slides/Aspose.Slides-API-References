...
description: 
type: docs
url: /th/aspose.slides.mathtext/mathsuperscriptelement/set_sub_superscript_on_the_right/
weight: 160
---
## set_sub_superscript_on_the_right(self, subscript, superscript) {#imathelement-imathelement}
สร้างตัวห้อยและตัวยกด้านขวา
...
| superscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวยก (ดัชนีบนด้านขวา) |
...
| superscript | **str** | ตัวยก (ดัชนีบนด้านขวา) |
