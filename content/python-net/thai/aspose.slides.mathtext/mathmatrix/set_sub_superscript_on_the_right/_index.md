...
description: 
type: docs
url: /th/aspose.slides.mathtext/mathmatrix/set_sub_superscript_on_the_right/
weight: 250
---
## set_sub_superscript_on_the_right(self, subscript, superscript) {#imathelement-imathelement}
สร้างตัวห้อยและตัวสูงทางด้านขวา
...
| superscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวสูง (ดัชนีบนด้านขวา) |
...
| superscript | **str** | ตัวสูง (ดัชนีบนด้านขวา) |
