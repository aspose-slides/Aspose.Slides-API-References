...
description: 
type: docs
url: /th/aspose.slides.mathtext/mathbox/set_sub_superscript_on_the_right/
weight: 160
---
## set_sub_superscript_on_the_right(self, subscript, superscript) {#imathelement-imathelement}
สร้างตัวห้อยและตัวยกบนทางด้านขวา
...
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวห้อย (ดัชนีล่างทางด้านขวา) |
| superscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวยกบน (ดัชนีบนทางด้านขวา) |
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| :- | :- | :- |
| subscript | **str** | ตัวห้อย (ดัชนีล่างทางด้านขวา) |
| superscript | **str** | ตัวยกบน (ดัชนีบนทางด้านขวา) |
