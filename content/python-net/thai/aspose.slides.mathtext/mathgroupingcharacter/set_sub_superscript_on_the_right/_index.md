...
description: 
type: docs
url: /th/aspose.slides.mathtext/mathgroupingcharacter/set_sub_superscript_on_the_right/
weight: 160
---
...
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวห้อย (ดัชนีล่างบนด้านขวา) |
| superscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวยก (ดัชนีบนบนด้านขวา) |
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| :- | :- | :- |
| subscript | **str** | ตัวห้อย (ดัชนีล่างบนด้านขวา) |
| superscript | **str** | ตัวยก (ดัชนีบนบนด้านขวา) |
