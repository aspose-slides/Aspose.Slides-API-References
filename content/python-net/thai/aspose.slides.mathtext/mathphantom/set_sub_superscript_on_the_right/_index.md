...
description: 
type: docs
url: /th/aspose.slides.mathtext/mathphantom/set_sub_superscript_on_the_right/
weight: 160
---
...
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวห้อย (ดัชนีล่างที่ด้านขวา) |
| superscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวยกบน (ดัชนีบนที่ด้านขวา) |
...
| พารามิเตอร์ | ชนิด | คำอธิบาย |
| :- | :- | :- |
| subscript | **str** | ตัวห้อย (ดัชนีล่างที่ด้านขวา) |
| superscript | **str** | ตัวยกบน (ดัชนีบนที่ด้านขวา) |
