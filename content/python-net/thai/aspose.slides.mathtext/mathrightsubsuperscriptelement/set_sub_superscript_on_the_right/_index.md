...
description: 
type: docs
url: /th/aspose.slides.mathtext/mathrightsubsuperscriptelement/set_sub_superscript_on_the_right/
weight: 160
---
## set_sub_superscript_on_the_right(self, subscript, superscript) {#imathelement-imathelement}
สร้างตัวห้อยและตัวยกกำลังทางด้านขวา

### คืนค่า

องค์ประกอบคณิตศาสตร์ใหม่ประเภท [`IMathRightSubSuperscriptElement`](/slides/python-net/th/aspose.slides.mathtext/imathrightsubsuperscriptelement)
...
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวห้อย (ดัชนีล่างด้านขวา) |
| superscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวยกกำลัง (ดัชนีบนด้านขวา) |
...
| พารามิเตอร์ | ชนิด | คำอธิบาย |
| :- | :- | :- |
| subscript | **str** | ตัวห้อย (ดัชนีล่างด้านขวา) |
| superscript | **str** | ตัวยกกำลัง (ดัชนีบนด้านขวา) |
