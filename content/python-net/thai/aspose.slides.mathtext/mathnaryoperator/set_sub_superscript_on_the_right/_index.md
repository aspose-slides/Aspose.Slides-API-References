...
description: 
type: docs
url: /th/aspose.slides.mathtext/mathnaryoperator/set_sub_superscript_on_the_right/
weight: 160
---
## set_sub_superscript_on_the_right(self, subscript, superscript) {#imathelement-imathelement}
สร้างตัวห้อยและตัวเหนือที่ด้านขวา
...
| superscript | [`IMathElement`](/slides/python-net/th/aspose.slides.mathtext/imathelement) | ตัวเหนือ (ดัชนีบนด้านขวา) |
...
| superscript | **str** | ตัวเหนือ (ดัชนีบนด้านขวา) |
