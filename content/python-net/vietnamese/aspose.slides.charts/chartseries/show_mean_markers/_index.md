...
description: 
type: docs
url: /vi/aspose.slides.charts/chartseries/show_mean_markers/
weight: 450
---
## show_mean_markers thuộc tính
Biểu thị các dấu trung bình. True nếu các dấu trung bình được hiển thị trên biểu đồ BoxAndWhisker. Chỉ áp dụng cho các biểu đồ BoxAndWhisker.
            Đọc/ghi **bool**.
