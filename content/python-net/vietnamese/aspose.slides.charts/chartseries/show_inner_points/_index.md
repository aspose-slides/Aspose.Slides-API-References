...
description: 
type: docs
url: /vi/aspose.slides.charts/chartseries/show_inner_points/
weight: 430
---
## show_inner_points thuộc tính
Biểu diễn các điểm nội bộ. True nếu các điểm nội bộ được hiển thị trên biểu đồ BoxAndWhisker. Chỉ áp dụng cho biểu đồ BoxAndWhisker.
            Đọc/ghi **bool**.
