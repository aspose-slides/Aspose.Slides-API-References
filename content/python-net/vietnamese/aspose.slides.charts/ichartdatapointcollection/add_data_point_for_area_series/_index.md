...
description: 
type: docs
url: /vi/aspose.slides.charts/ichartdatapointcollection/add_data_point_for_area_series/
weight: 10
---
## add_data_point_for_area_series(self, value) {#ichartdatacell}
Tạo điểm dữ liệu mới và thêm vào cuối bộ sưu tập.
            Áp dụng cho các series có chartType là một trong các subtype Area (see also ChartTypeCharacterizer.IsChartTypeArea(ChartType) method).
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| value | [`IChartDataCell`](/slides/python-net/vi/aspose.slides.charts/ichartdatacell) | Giá trị điểm dữ liệu |
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| value | **float** | Giá trị điểm dữ liệu |
