...
description: 
type: docs
url: /vi/aspose.slides.charts/ichartdatapointcollection/add_data_point_for_sunburst_series/
weight: 140
---
## add_data_point_for_sunburst_series(self, size_value) {#ichartdatacell}
Tạo một điểm dữ liệu mới và thêm nó vào cuối bộ sưu tập.
            Áp dụng cho các series có loại biểu đồ là Sunburst.
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| size_value | [`IChartDataCell`](/slides/python-net/vi/aspose.slides.charts/ichartdatacell) | Giá trị kích thước của điểm dữ liệu |
