...
description: 
type: docs
url: /vi/aspose.slides.charts/iaxis/tick_marks_spacing/
weight: 610
---
## tick_marks_spacing thuộc tính
Xác định số lượng dấu tick sẽ bị bỏ qua trước khi dấu kế tiếp được 
            vẽ. Áp dụng cho trục danh mục hoặc trục series.
            Đọc/ghi **int**.
