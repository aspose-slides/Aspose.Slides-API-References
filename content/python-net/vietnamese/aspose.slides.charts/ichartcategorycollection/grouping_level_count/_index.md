...
description: 
type: docs
url: /vi/aspose.slides.charts/ichartcategorycollection/grouping_level_count/
weight: 90
---
## grouping_level_count thuộc tính
Trả về số lượng mức nhóm danh mục đã sử dụng.
            Có nhiều hơn một mức cho các danh mục đa cấp.
            Chỉ đọc **int**.
