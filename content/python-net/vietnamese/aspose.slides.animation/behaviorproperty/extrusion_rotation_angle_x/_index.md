---
title: extrusion_rotation_angle_x property
second_title: Tham chiếu API Aspose.Slides cho Python qua .NET
description: 
type: docs
url: /vi/aspose.slides.animation/behaviorproperty/extrusion_rotation_angle_x/
weight: 150
---
## extrusion_rotation_angle_x thuộc tính
Biểu thị thuộc tính 'extrusion.rotationangle.x'

### Định nghĩa:
```python
@property
def extrusion_rotation_angle_x(self):
    ...
```
