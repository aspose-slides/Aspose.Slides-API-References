...
Lấy giới hạn trực quan của hình dạng được tính từ nội dung đã render của nó.
...
Hình chữ nhật được trả về đại diện cho giới hạn căn trục của tất cả nội dung do hình dạng tạo ra trong quá trình render trong không gian tọa độ slide.
...
Giới hạn trực quan tính đến các khía cạnh liên quan đến render như phép biến đổi (ví dụ, quay), độ rộng nét và các nối, bố cục văn bản và tràn, hình học SmartArt, và các hiệu ứng bố cục khác ảnh hưởng đến vẻ ngoài cuối cùng đã render của hình dạng.
