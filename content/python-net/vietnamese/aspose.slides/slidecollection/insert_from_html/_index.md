...
description: 
type: docs
url: /vi/aspose.slides/slidecollection/insert_from_html/
weight: 80
---
## insert_from_html(self, index, html_text) {#int-str}
Tạo các slide từ nội dung HTML và chèn chúng vào bộ sưu tập ở vị trí đã chỉ định.
...
| index | **int** | Vị trí để chèn. |
| html_text | **str** | HTML để thêm. |
| use_slide_with_index_as_start | **bool** | Tham số này xác định cách bắt đầu chèn: từ một slide mới hoặc từ slide có chỉ số được chỉ định.<br/><br/>            Nếu **true** , thì việc chèn dữ liệu sẽ bắt đầu từ một không gian trống trên slide có chỉ số được chỉ định.<br/><br/>            Nếu **false** , thì dữ liệu sẽ được thêm vào các slide đã tạo. |
...
| uri | **str** | URI của HTML đã chỉ định. Được sử dụng để giải quyết các liên kết tương đối. |
