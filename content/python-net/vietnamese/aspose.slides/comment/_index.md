...
Kiểu Comment cung cấp các thành viên sau:
...
| Phương thức | Mô tả |
| :- | :- |
| [`remove(self)`](/slides/python-net/vi/aspose.slides/comment/remove/#) | Xóa bình luận và tất cả các phản hồi của nó khỏi bộ sưu tập cha. |
