...
description: 
type: docs
url: /vi/aspose.slides/shapecollection/add_connector/
weight: 70
---
## add_connector(self, shape_type, x, y, width, height) {#shapetype-float-float-float-float}
Tạo một hình connector mới với kiểu mẫu mặc định và thêm nó vào cuối
            bộ sưu tập hình.

### Trả về

[`IConnector`](/slides/python-net/vi/aspose.slides/iconnector) mới được tạo.
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| shape_type | [`ShapeType`](/slides/python-net/vi/aspose.slides/shapetype) | [`ShapeType`](/slides/python-net/vi/aspose.slides/shapetype) của hình connector cần thêm. |
...
Tạo một hình connector mới và thêm nó vào cuối bộ sưu tập hình,
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| shape_type | [`ShapeType`](/slides/python-net/vi/aspose.slides/shapetype) | [`ShapeType`](/slides/python-net/vi/aspose.slides/shapetype) của hình connector cần tạo. |
| x | **float** | Tọa độ x của khung connector, tính bằng điểm. |
| y | **float** | Tọa độ y của khung connector, tính bằng điểm. |
| width | **float** | Chiều rộng của khung connector, tính bằng điểm. |
| height | **float** | Chiều cao của khung connector, tính bằng điểm. |
