...
description: 
type: docs
url: /vi/aspose.slides/shapecollection/add_zoom_frame/
weight: 170
---
...
| slide | [`ISlide`](/slides/python-net/vi/aspose.slides/islide) | Đối tượng [`ISlide`](/slides/python-net/vi/aspose.slides/islide) được tham chiếu bởi khung Zoom;<br/><br/>            phải thuộc về bản trình chiếu này. |

### Ngoại lệ

| Ngoại lệ | Mô tả |
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Bị ném nếu slide được tham chiếu không thuộc bản trình chiếu hiện tại. |
...
| height | **float** | Chiều cao của khung Zoom mới, tính bằng điểm. |
| slide | [`ISlide`](/slides/python-net/vi/aspose.slides/islide) | Đối tượng [`ISlide`](/slides/python-net/vi/aspose.slides/islide) được tham chiếu bởi khung Zoom;<br/><br/>            phải thuộc về bản trình chiếu này. |
| image | [`IPPImage`](/slides/python-net/vi/aspose.slides/ippimage) | Hình ảnh cho slide [`IPPImage`](/slides/python-net/vi/aspose.slides/ippimage) được tham chiếu. |
