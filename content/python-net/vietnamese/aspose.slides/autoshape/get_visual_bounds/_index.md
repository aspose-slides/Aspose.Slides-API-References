...
Hình chữ nhật trả về đại diện cho các giới hạn song song trục của tất cả nội dung do hình dạng tạo ra trong quá trình hiển thị trong không gian tọa độ slide.
...
Các giới hạn trực quan tính đến các khía cạnh liên quan đến việc hiển thị như biến đổi (ví dụ, quay), độ rộng và nối nét, bố cục và tràn văn bản, hình học SmartArt, và các hiệu ứng bố cục khác ảnh hưởng đến diện mạo cuối cùng của hình dạng khi được hiển thị.
