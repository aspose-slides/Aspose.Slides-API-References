...
description: 
type: docs
url: /vi/aspose.slides/audioframe/get_base_placeholder/
weight: 30
---
## get_base_placeholder(self) {#}
Trả về một hình placeholder cơ bản (hình từ bố cục và/hoặc slide master mà hình hiện tại kế thừa).
            Trả về None nếu hình hiện tại không được kế thừa.
