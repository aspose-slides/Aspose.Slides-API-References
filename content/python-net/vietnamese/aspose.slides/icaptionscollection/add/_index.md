...
| **RuntimeError(Proxy error(ArgumentException))** | Bị ném nếu dữ liệu đầu vào không ở định dạng WebVTT. |



### Xem thêm
* lớp [`ICaptions`](/slides/python-net/vi/aspose.slides/icaptions)
* lớp [`ICaptionsCollection`](/slides/python-net/vi/aspose.slides/icaptionscollection)
