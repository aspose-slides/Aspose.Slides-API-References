...
description: 
type: docs
url: /vi/aspose.slides.export/irenderingoptions/disable_font_ligatures/
weight: 30
---
## disable_font_ligatures thuộc tính
Lấy hoặc thiết lập một giá trị cho biết liệu văn bản có được hiển thị mà không sử dụng các ligature hay không.
