...
description: 
type: docs
url: /vi/aspose.slides.export/pptoptions/default_regular_font/
weight: 30
---
## default_regular_font thuộc tính
Trả về hoặc đặt phông chữ được sử dụng trong trường hợp phông chữ nguồn không được tìm thấy.
            Đọc-ghi **str**.
...
### Xem thêm
* lớp [`PptOptions`](/slides/python-net/vi/aspose.slides.export/pptoptions)
