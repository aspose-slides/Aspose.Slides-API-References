...
description: 
type: docs
url: /vi/aspose.slides.export/gifoptions/default_regular_font/
weight: 40
---
## default_regular_font thuộc tính
Trả về hoặc đặt phông chữ được sử dụng trong trường hợp không tìm thấy phông chữ nguồn.
            Đọc-ghi **str**.
...
### Xem thêm
* lớp [`GifOptions`](/slides/python-net/vi/aspose.slides.export/gifoptions)
