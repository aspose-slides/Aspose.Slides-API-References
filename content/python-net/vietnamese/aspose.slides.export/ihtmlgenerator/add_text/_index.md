...
description: 
type: docs
url: /vi/aspose.slides.export/ihtmlgenerator/add_text/
weight: 30
---
## add_text(self, text) {#str}
Thêm văn bản thường vào các tệp html, thay thế các ký tự đặc biệt bằng thực thể html.
            Các ký tự xuống dòng và khoảng trắng không được thay thế.
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| text | **List[char]** | Văn bản cần thêm. |
...
| :- | :- | :- |
| text | **List[char]** | Văn bản cần thêm. |
| start_index | **int** | Chỉ mục bắt đầu của phần cần thêm. |
