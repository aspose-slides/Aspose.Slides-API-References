...
description: 
type: docs
url: /vi/aspose.slides.export/iembeddedwofffontshtmlcontroller/write_document_start/
weight: 20
---
...
| presentation | [`IPresentation`](/slides/python-net/vi/aspose.slides/ipresentation) |  |

### Xem thêm
* lớp [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/vi/aspose.slides.export/iembeddedwofffontshtmlcontroller)
