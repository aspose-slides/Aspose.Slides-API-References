...
Chuyển đổi bản trình bày đầu vào thành một tập các hình ảnh định dạng JPEG.  
Nếu tên tệp đầu ra được chỉ định là "myPath/myFilename.jpeg", kết quả sẽ được lưu dưới dạng một tập các tệp "myPath/myFilename_N.jpeg", trong đó N là số slide.
...
| pres | [`Presentation`](/slides/python-net/vi/aspose.slides/presentation) | Bản trình bày đầu vào |
| output_file_name | **str** | Tên tệp đầu ra. |
| image_size | [`Size`](/slides/python-net/vi/aspose.slides/size) | Kích thước của mỗi hình ảnh được tạo. |
...
| pres | [`Presentation`](/slides/python-net/vi/aspose.slides/presentation) | Bản trình bày đầu vào. |
| output_file_name | **str** | Tên tệp đầu ra. |
| scale | **float** | Hệ số tỷ lệ áp dụng cho các hình ảnh đầu ra so với kích thước slide gốc. |
