...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathnaryoperator/set_superscript/
weight: 180
---
...
Phần tử toán học mới loại [`IMathSuperscriptElement`](/slides/python-net/vi/aspose.slides.mathtext/imathsuperscriptelement)
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| superscript | [`IMathElement`](/slides/python-net/vi/aspose.slides.mathtext/imathelement) | Chỉ số trên (chỉ số viết ở bên phải) |
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| superscript | **str** | Chỉ số trên (chỉ số viết ở bên phải) |
