...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathlimit/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Gạch chéo ngang của Border Box |
| strikethrough_vertical | **bool** | Gạch chéo dọc của Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | Gạch chéo Border Box từ dưới-trái tới trên-phải |
| strikethrough_top_left_to_bottom_right | **bool** | Gạch chéo Border Box từ trên-trái tới dưới-phải |
