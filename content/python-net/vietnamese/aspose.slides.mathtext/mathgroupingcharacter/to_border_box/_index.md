...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathgroupingcharacter/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
Hộp viền với phần tử này được đặt bên trong
...
| strikethrough_horizontal | **bool** | Gạch chéo ngang hộp viền |
| strikethrough_vertical | **bool** | Gạch chéo dọc hộp viền |
| strikethrough_bottom_left_to_top_right | **bool** | Gạch chéo từ góc dưới trái lên góc trên phải |
| strikethrough_top_left_to_bottom_right | **bool** | Gạch chéo từ góc trên trái xuống góc dưới phải |
