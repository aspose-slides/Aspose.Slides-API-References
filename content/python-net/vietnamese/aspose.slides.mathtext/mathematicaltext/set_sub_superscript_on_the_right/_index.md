...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathematicaltext/set_sub_superscript_on_the_right/
weight: 160
---
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/vi/aspose.slides.mathtext/imathelement) | Subscript (lower index on the right) |
| superscript | [`IMathElement`](/slides/python-net/vi/aspose.slides.mathtext/imathelement) | Superscript (upper index on the right) |
