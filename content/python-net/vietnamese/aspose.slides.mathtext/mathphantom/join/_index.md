...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathphantom/join/
weight: 100
---
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| math_element | [`IMathElement`](/slides/python-net/vi/aspose.slides.mathtext/imathelement) | Phần tử cần kết hợp |
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| math_text | **str** | Văn bản toán học cần kết hợp |
