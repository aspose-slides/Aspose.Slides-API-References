...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathrightsubsuperscriptelement/group/
weight: 80
---
## group(self) {#}
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/vi/aspose.slides.mathtext/mathtopbotpositions) | Căn chỉnh dọc của ký tự nhóm.<br/><br/>            Xác định cách căn chỉnh của đối tượng so với đường cơ sở.<br/><br/>            Ví dụ, khi ký tự nhóm nằm phía trên đối tượng, <br/><br/>            VerticalJustification của Top cho biết rằng phần trên của đối tượng nằm trên đường cơ sở;<br/><br/>            khi VerticalJustification được đặt thành Bottom, phần dưới của đối tượng nằm trên đường cơ sở |
