...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathrightsubsuperscriptelement/to_border_box/
weight: 200
---
## to_border_box(self) {#}
Đặt phần tử này vào border-box
...
| strikethrough_bottom_left_to_top_right | **bool** | Gạch chéo Border Box từ góc dưới trái tới góc trên phải |
| strikethrough_top_left_to_bottom_right | **bool** | Gạch chéo Border Box từ góc trên trái tới góc dưới phải |
