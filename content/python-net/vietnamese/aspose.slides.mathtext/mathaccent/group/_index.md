...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathaccent/group/
weight: 80
---
## group(self) {#}
...
Một thể hiện mới của loại [`IMathGroupingCharacter`](/slides/python-net/vi/aspose.slides.mathtext/imathgroupingcharacter)
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/vi/aspose.slides.mathtext/mathtopbotpositions) | Căn dọc của ký tự nhóm.<br/><br/>            Xác định cách căn chỉnh của đối tượng so với đường cơ sở.<br/><br/>            Ví dụ, khi ký tự nhóm ở trên đối tượng, <br/><br/>            VerticalJustification of Top biểu thị rằng phần trên của đối tượng nằm trên đường cơ sở;<br/><br/>            khi VerticalJustification được đặt thành Bottom, phần dưới của đối tượng nằm trên đường cơ sở |
