...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathsuperscriptelement/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Gạch chéo ngang Border Box |
| strikethrough_vertical | **bool** | Gạch chéo dọc Border Box |
