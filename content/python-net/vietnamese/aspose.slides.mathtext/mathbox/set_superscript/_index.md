...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathbox/set_superscript/
weight: 180
---
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| superscript | [`IMathElement`](/slides/python-net/vi/aspose.slides.mathtext/imathelement) | Chỉ số trên (chỉ số cao nằm bên phải) |
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| superscript | **str** | Chỉ số trên (chỉ số cao nằm bên phải) |
