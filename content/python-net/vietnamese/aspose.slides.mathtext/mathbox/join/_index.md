...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathbox/join/
weight: 100
---
## join(self, math_element) {#imathelement}
Kết hợp một phần tử toán học và tạo ra một khối toán học
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| math_element | [`IMathElement`](/slides/python-net/vi/aspose.slides.mathtext/imathelement) | Phần tử sẽ được kết hợp |


## join(self, math_text) {#str}
Kết hợp một văn bản toán học và tạo ra một khối toán học
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| math_text | **str** | Văn bản toán học sẽ được kết hợp |
