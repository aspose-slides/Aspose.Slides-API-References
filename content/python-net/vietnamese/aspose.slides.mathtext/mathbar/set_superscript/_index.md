...
description: 
type: docs
url: /vi/aspose.slides.mathtext/mathbar/set_superscript/
weight: 180
---
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| superscript | [`IMathElement`](/slides/python-net/vi/aspose.slides.mathtext/imathelement) | Chỉ số trên (chỉ số ở trên bên phải) |
...
| Tham số | Kiểu | Mô tả |
| :- | :- | :- |
| superscript | **str** | Chỉ số trên (chỉ số ở trên bên phải) |
