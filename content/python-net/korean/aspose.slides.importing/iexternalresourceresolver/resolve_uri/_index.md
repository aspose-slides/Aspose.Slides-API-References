...
description: 
type: docs
url: /ko/aspose.slides.importing/iexternalresourceresolver/resolve_uri/
weight: 20
---
## resolve_uri(self, base_uri, relative_uri) {#str-str}
베이스 URI와 상대 URI에서 절대 URI를 해결합니다.

### 반환

절대 URI 또는 상대 URI를 해결할 수 없는 경우 None.
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| base_uri | **str** | 링크된 객체의 베이스 URI |
| relative_uri | **str** | 링크된 객체에 대한 상대 URI |
