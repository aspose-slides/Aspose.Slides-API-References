...
second_title: Aspose.Slides Python을 위한 .NET API 참조
description: 
type: docs
url: /ko/aspose.slides.smartart/smartart/alternative_text_title/
weight: 90
---
## alternative_text_title 속성
도형과 연결된 대체 텍스트의 제목을 반환하거나 설정합니다.
읽기/쓰기 **str**.
