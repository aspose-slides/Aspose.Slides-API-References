...
description: 
type: docs
url: /ko/aspose.slides.effects/outershadow/scale_vertical/
weight: 90
---
## scale_vertical 속성
원래 크기의 백분율로 나타낸 수직 스케일링 계수.
            음수 스케일링은 뒤집기를 일으킵니다.
            기본값 – 100 %.
            읽기/쓰기 **float**.
...
### 참고
* 클래스 [`OuterShadow`](/slides/python-net/ko/aspose.slides.effects/outershadow)
