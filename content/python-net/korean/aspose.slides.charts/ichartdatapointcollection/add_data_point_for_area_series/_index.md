...
description: 
type: docs
url: /ko/aspose.slides.charts/ichartdatapointcollection/add_data_point_for_area_series/
weight: 10
---
## add_data_point_for_area_series(self, value) {#ichartdatacell}
새 데이터 포인트를 생성하고 컬렉션 끝에 추가합니다.
            chartType이 Area 하위 유형 중 하나인 시리즈에 적용됩니다 (ChartTypeCharacterizer.IsChartTypeArea(ChartType) 메서드도 참조).
