...
description: 
type: docs
url: /ko/aspose.slides.charts/chartseries/show_inner_points/
weight: 430
---
## show_inner_points 속성
내부 포인트를 나타냅니다. BoxAndWhisker 차트에 내부 포인트가 표시되는 경우 true입니다. BoxAndWhisker 차트에만 적용됩니다.
            읽기/쓰기 **bool**.
