...
| pts_type | [`MotionPathPointsType`](/slides/python-net/ko/aspose.slides.animation/motionpathpointstype) |  |
...
* 클래스 [`MotionPath`](/slides/python-net/ko/aspose.slides.animation/motionpath)
