...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathbox/group/
weight: 80
---
## group(self) {#}
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/ko/aspose.slides.mathtext/mathtopbotpositions) | 그룹 문자에 대한 수직 정렬.<br/><br/>            객체를 기준선에 대해 정렬하는 방식을 지정합니다.<br/><br/>            예를 들어, 그룹 문자가 객체 위에 있을 경우,<br/><br/>            Top의 VerticalJustification은 객체의 상단이 기준선에 맞춰짐을 의미합니다;<br/><br/>            Bottom으로 설정하면 객체의 하단이 기준선에 맞춰집니다 |
