...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathbox/to_border_box/
weight: 200
---
## to_border_box(self) {#}
이 요소를 경계 상자에 배치합니다
...
| strikethrough_bottom_left_to_top_right | **bool** | 경계 상자 왼쪽 아래에서 오른쪽 위로 취소선 |
| strikethrough_top_left_to_bottom_right | **bool** | 경계 상자 왼쪽 위에서 오른쪽 아래로 취소선 |
