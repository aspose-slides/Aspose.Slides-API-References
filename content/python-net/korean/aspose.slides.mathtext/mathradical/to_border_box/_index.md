...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathradical/to_border_box/
weight: 200
---
## to_border_box(self) {#}
이 요소를 경계 상자에 배치합니다
...
| strikethrough_bottom_left_to_top_right | **bool** | 좌하단에서 우상단까지의 경계 상자 취소선 |
| strikethrough_top_left_to_bottom_right | **bool** | 좌상단에서 우하단까지의 경계 상자 취소선 |
