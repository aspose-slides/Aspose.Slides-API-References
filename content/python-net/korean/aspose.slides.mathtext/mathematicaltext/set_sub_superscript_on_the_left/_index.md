...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathematicaltext/set_sub_superscript_on_the_left/
weight: 150
---
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 하첨자 (왼쪽 하위 인덱스) |
| superscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 상첨자 (왼쪽 상위 인덱스) |
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| subscript | **str** | 하첨자 (왼쪽 하위 인덱스) |
| superscript | **str** | 상첨자 (왼쪽 상위 인덱스) |
