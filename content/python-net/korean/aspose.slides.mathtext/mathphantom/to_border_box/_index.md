...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathphantom/to_border_box/
weight: 200
---
## to_border_box(self) {#}
이 요소를 테두리 상자에 배치합니다
...
| strikethrough_horizontal | **bool** | 테두리 상자 가로 취소선 |
| strikethrough_vertical | **bool** | 테두리 상자 세로 취소선 |
| strikethrough_bottom_left_to_top_right | **bool** | 테두리 상자 왼쪽 하단에서 오른쪽 상단까지 취소선 |
| strikethrough_top_left_to_bottom_right | **bool** | 테두리 상자 왼쪽 상단에서 오른쪽 하단까지 취소선 |
