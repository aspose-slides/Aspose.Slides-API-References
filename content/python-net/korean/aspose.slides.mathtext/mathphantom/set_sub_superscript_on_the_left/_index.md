...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathphantom/set_sub_superscript_on_the_left/
weight: 150
---
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 아래 첨자(왼쪽에 있는 낮은 인덱스) |
| superscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 위 첨자(왼쪽에 있는 높은 인덱스) |
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| subscript | **str** | 아래 첨자(왼쪽에 있는 낮은 인덱스) |
| superscript | **str** | 위 첨자(왼쪽에 있는 높은 인덱스) |
