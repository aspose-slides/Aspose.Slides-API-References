---
title: object_distribution property
second_title: Aspose.Slides for Python via .NET API 레퍼런스
description: 
type: docs
url: /ko/aspose.slides.mathtext/imatharray/object_distribution/
weight: 270
---
## object_distribution 속성
객체 배포
            true일 경우, 배열의 내용이 배열 객체의 최대 너비에 맞게 간격이 지정됩니다.
