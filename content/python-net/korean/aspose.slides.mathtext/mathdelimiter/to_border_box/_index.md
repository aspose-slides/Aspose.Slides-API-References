...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathdelimiter/to_border_box/
weight: 210
---
## to_border_box(self) {#}
이 요소를 경계 상자에 배치합니다
...
| strikethrough_bottom_left_to_top_right | **bool** | 경계 상자 좌하단에서 우상단으로 취소선 |
| strikethrough_top_left_to_bottom_right | **bool** | 경계 상자 좌상단에서 우하단으로 취소선 |
