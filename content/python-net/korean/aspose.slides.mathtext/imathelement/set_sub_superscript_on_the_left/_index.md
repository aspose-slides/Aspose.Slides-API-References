...
description: 
type: docs
url: /ko/aspose.slides.mathtext/imathelement/set_sub_superscript_on_the_left/
weight: 140
---
## set_sub_superscript_on_the_left(self, subscript, superscript) {#imathelement-imathelement}
왼쪽에 아래 첨자와 위첨자를 생성합니다
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 아래 첨자 (왼쪽의 하위 인덱스) |
| superscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 위첨자 (왼쪽의 상위 인덱스) |
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| subscript | **str** | 아래 첨자 (왼쪽의 하위 인덱스) |
| superscript | **str** | 위첨자 (왼쪽의 상위 인덱스) |
