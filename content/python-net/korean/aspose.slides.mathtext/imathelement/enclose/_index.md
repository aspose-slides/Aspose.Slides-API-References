...
이 요소를 괄호와 같은 지정된 문자 또는 다른 문자로 프레임을 만들어 감쌉니다

### 반환값

[`IMathDelimiter`](/slides/python-net/ko/aspose.slides.mathtext/imathdelimiter) 타입의 수학 요소이며 지정된 문자로 프레임을 만들어 포함합니다
