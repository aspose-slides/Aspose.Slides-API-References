...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathsubscriptelement/as_argument_of_function/
weight: 30
---
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/ko/aspose.slides.mathtext/mathfunctionsofoneargument) | 하나 인수의 일반 함수 유형 중 하나 |
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/ko/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 두 인수의 일반 함수 유형 중 하나: Log, Lim, Min, Max |
