...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathsubscriptelement/set_sub_superscript_on_the_left/
weight: 150
---
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 아래첨자 (왼쪽에 있는 하위 인덱스) |
| superscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 위첨자 (왼쪽에 있는 상위 인덱스) |
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| subscript | **str** | 아래첨자 (왼쪽에 있는 하위 인덱스) |
| superscript | **str** | 위첨자 (왼쪽에 있는 상위 인덱스) |
