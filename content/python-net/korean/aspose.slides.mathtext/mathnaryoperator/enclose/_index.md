...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathnaryoperator/enclose/
weight: 50
---
## enclose(self) {#}
수학 요소를 괄호로 둘러줍니다
...
[`IMathDelimiter`](/slides/python-net/ko/aspose.slides.mathtext/imathdelimiter) 타입의 수학 요소이며 괄호를 포함합니다
...
수학 요소를 괄호와 같은 지정된 문자 또는 다른 문자로 프레임링하여 둘러줍니다

### 반환

[`IMathDelimiter`](/slides/python-net/ko/aspose.slides.mathtext/imathdelimiter) 타입의 수학 요소이며 지정된 문자를 프레임으로 포함합니다
