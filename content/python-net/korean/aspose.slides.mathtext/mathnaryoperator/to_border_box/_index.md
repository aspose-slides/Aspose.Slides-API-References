...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathnaryoperator/to_border_box/
weight: 200
---
## to_border_box(self) {#}
이 요소를 테두리 상자에 배치합니다
...
| hide_left | **bool** | 좌측 가장자리 숨기기 |
| hide_right | **bool** | 우측 가장자리 숨기기 |
| strikethrough_horizontal | **bool** | 테두리 상자 가로 취소선 |
| strikethrough_vertical | **bool** | 테두리 상자 세로 취소선 |
| strikethrough_bottom_left_to_top_right | **bool** | 테두리 상자 좌하단에서 우상단까지 취소선 |
| strikethrough_top_left_to_bottom_right | **bool** | 테두리 상자 좌상단에서 우하단까지 취소선 |
