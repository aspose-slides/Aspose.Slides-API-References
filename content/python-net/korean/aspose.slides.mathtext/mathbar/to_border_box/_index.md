...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathbar/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | 가로 스트라이크스루 Border-box |
| strikethrough_vertical | **bool** | 세로 스트라이크스루 Border-box |
| strikethrough_bottom_left_to_top_right | **bool** | 좌하단에서 우상단까지 스트라이크스루 Border-box |
| strikethrough_top_left_to_bottom_right | **bool** | 좌상단에서 우하단까지 스트라이크스루 Border-box |
