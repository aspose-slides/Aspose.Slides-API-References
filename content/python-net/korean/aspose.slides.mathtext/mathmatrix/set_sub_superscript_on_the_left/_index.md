...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathmatrix/set_sub_superscript_on_the_left/
weight: 240
---
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 아래첨자 (왼쪽의 낮은 인덱스) |
| superscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 위첨자 (왼쪽의 높은 인덱스) |
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| subscript | **str** | 아래첨자 (왼쪽의 낮은 인덱스) |
| superscript | **str** | 위첨자 (왼쪽의 높은 인덱스) |
