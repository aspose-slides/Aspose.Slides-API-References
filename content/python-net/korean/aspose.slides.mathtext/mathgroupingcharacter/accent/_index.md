...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathgroupingcharacter/accent/
weight: 20
---
## accent(self, accent_character) {#char}
이 요소의 상단에 있는 문자(악센트 표시)를 설정합니다

### 반환값
새 인스턴스 형식 [`IMathAccent`](/slides/python-net/ko/aspose.slides.mathtext/imathaccent)
