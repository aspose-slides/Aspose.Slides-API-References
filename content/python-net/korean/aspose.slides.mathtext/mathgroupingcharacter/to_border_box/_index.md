...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathgroupingcharacter/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Border Box 가로 취소선 |
| strikethrough_vertical | **bool** | Border Box 세로 취소선 |
| strikethrough_bottom_left_to_top_right | **bool** | Border Box 왼쪽 아래에서 오른쪽 위로 취소선 |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box 왼쪽 위에서 오른쪽 아래로 취소선 |
