...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathgroupingcharacter/join/
weight: 100
---
...
새로운 IMathBlock을 반환하며, 이 인스턴스와 지정된 인수를 포함합니다
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| math_element | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 결합할 요소 |
