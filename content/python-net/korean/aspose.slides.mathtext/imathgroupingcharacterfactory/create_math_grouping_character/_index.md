...
description: 
type: docs
url: /ko/aspose.slides.mathtext/imathgroupingcharacterfactory/create_math_grouping_character/
weight: 10
---
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 그룹화 문자를 적용할 수학 요소 |
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/ko/aspose.slides.mathtext/mathtopbotpositions) | 수직 정렬 |
...
* 클래스 [`IMathGroupingCharacterFactory`](/slides/python-net/ko/aspose.slides.mathtext/imathgroupingcharacterfactory)
