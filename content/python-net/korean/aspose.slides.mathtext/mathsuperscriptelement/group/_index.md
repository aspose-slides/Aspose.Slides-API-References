...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathsuperscriptelement/group/
weight: 80
---
## group(self) {#}
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| character | **char** | 하단 중괄호(BOTTOM CURLY BRACKET, U+23DF) 등과 같은 그룹화 문자 |
| position | [`MathTopBotPositions`](/slides/python-net/ko/aspose.slides.mathtext/mathtopbotpositions) | 그룹화 문자 위치 |
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/ko/aspose.slides.mathtext/mathtopbotpositions) | 그룹 문자 수직 정렬.<br/><br/> 객체를 기준선에 대해 정렬하는 방식을 지정합니다.<br/><br/> 예를 들어, 그룹 문자가 객체 위에 있을 때,<br/><br/> VerticalJustification of Top 은 객체의 상단이 기준선에 놓인다는 것을 의미합니다;<br/><br/> VerticalJustification 이 Bottom 으로 설정되면 객체의 하단이 기준선에 놓입니다 |
