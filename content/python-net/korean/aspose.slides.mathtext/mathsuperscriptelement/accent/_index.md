...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathsuperscriptelement/accent/
weight: 20
---
## accent(self, accent_character) {#char}
이 요소의 위에 표시되는 악센트 마크(문자)를 설정합니다

### 반환값

[`IMathAccent`](/slides/python-net/ko/aspose.slides.mathtext/imathaccent)의 새 인스턴스
