...
description: 
type: docs
url: /ko/aspose.slides.mathtext/imathnaryoperatorfactory/create_math_nary_operator/
weight: 10
---
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| operator_symbol | **char** | 연산자 기호 |
| base_argument | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 연산자를 적용할 기본 인수 |
...
* 클래스 [`IMathNaryOperatorFactory`](/slides/python-net/ko/aspose.slides.mathtext/imathnaryoperatorfactory)
