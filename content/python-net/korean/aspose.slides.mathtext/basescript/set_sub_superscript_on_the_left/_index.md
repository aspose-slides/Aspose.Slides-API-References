...
description: 
type: docs
url: /ko/aspose.slides.mathtext/basescript/set_sub_superscript_on_the_left/
weight: 140
---
...
New math element of type [`IMathLeftSubSuperscriptElement`](/slides/python-net/ko/aspose.slides.mathtext/imathleftsubsuperscriptelement)
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 아래첨자 (왼쪽에 하위 인덱스) |
| superscript | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 위첨자 (왼쪽에 상위 인덱스) |
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| subscript | **str** | 아래첨자 (왼쪽에 하위 인덱스) |
| superscript | **str** | 위첨자 (왼쪽에 상위 인덱스) |
