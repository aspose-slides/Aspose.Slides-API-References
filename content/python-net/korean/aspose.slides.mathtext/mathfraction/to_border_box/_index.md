...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathfraction/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | border-box 수평 취소선 |
| strikethrough_vertical | **bool** | border-box 수직 취소선 |
| strikethrough_bottom_left_to_top_right | **bool** | border-box 좌하단에서 우상단으로 취소선 |
| strikethrough_top_left_to_bottom_right | **bool** | border-box 좌상단에서 우하단으로 취소선 |
