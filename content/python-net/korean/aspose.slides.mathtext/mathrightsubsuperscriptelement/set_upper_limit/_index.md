...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathrightsubsuperscriptelement/set_upper_limit/
weight: 190
---
...
### 반환값
새 인스턴스 형식 [`IMathLimit`](/slides/python-net/ko/aspose.slides.mathtext/imathlimit)
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| limit | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | limit |
