...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathrightsubsuperscriptelement/function/
weight: 60
---
## function(self, function_argument) {#imathelement}
이 인스턴스를 함수 이름으로 사용하여 인수를 함수로 취합니다
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| function_argument | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 함수의 인수 |
