...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathlimit/join/
weight: 100
---
## join(self, math_element) {#imathelement}
수학 요소를 결합하여 수학 블록을 만듭니다.

### 반환값

이 인스턴스와 지정된 인수를 포함하는 새로운 IMathBlock을 반환합니다.
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| math_element | [`IMathElement`](/slides/python-net/ko/aspose.slides.mathtext/imathelement) | 결합될 요소 |


## join(self, math_text) {#str}
수학 텍스트를 결합하여 수학 블록을 만듭니다.
