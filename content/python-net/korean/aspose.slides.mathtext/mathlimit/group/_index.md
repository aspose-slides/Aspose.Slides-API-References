...
description: 
type: docs
url: /ko/aspose.slides.mathtext/mathlimit/group/
weight: 80
---
## group(self) {#}
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| character | **char** | BOTTOM CURLY BRACKET (U+23DF)과 같은 그룹화 문자 또는 기타 문자 |
| position | [`MathTopBotPositions`](/slides/python-net/ko/aspose.slides.mathtext/mathtopbotpositions) | 그룹화 문자 위치 |
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/ko/aspose.slides.mathtext/mathtopbotpositions) | 그룹 문자 수직 정렬.<br/><br/>            객체와 기준선 간의 정렬을 지정합니다.<br/><br/>            예를 들어, 그룹 문자가 객체 위에 있을 때,<br/><br/>            Top의 VerticalJustification은 객체의 상단이 기준선에 놓임을 나타냅니다;<br/><br/>            VerticalJustification이 Bottom으로 설정되면 객체의 하단이 기준선에 놓입니다 |
