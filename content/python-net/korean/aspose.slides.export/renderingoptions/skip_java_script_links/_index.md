...
description: 
type: docs
url: /ko/aspose.slides.export/renderingoptions/skip_java_script_links/
weight: 80
---
## skip_java_script_links 속성
프레젠테이션을 저장할 때 JavaScript 호출이 포함된 하이퍼링크를 건너뛸지 여부를 지정합니다. 
            읽기/쓰기 **bool**. 기본값은 **false** .


### 비고

이 속성이 **true** , 저장 중에 JavaScript 호출이 포함된 하이퍼링크가 무시됩니다.


이 속성이 **false** , 모든 하이퍼링크가 저장됩니다.
