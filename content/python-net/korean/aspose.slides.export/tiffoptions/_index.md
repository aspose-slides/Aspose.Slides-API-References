...
프리젠테이션을 TIFF 형식으로 저장하는 방식을 제어하는 옵션을 제공합니다.
...
| 속성 | 설명 |
| :- | :- |
| [`warning_callback`](/slides/python-net/ko/aspose.slides.export/tiffoptions/warning_callback/) | 경고를 수신하고 로드 프로세스를 계속할지 중단할지를 결정하는 객체를 반환하거나 설정합니다.<br/>            읽기/쓰기 [`IWarningCallback`](/slides/python-net/ko/aspose.slides.warnings/iwarningcallback). |
| [`progress_callback`](/slides/python-net/ko/aspose.slides.export/tiffoptions/progress_callback/) | 저장 진행률 업데이트를 백분율로 제공하는 콜백 객체를 나타냅니다.<br/>            [`IProgressCallback`](/slides/python-net/ko/aspose.slides/iprogresscallback)를 참조하십시오. |
| [`default_regular_font`](/slides/python-net/ko/aspose.slides.export/tiffoptions/default_regular_font/) | 소스 글꼴을 찾을 수 없을 경우 사용되는 글꼴을 반환하거나 설정합니다.<br/>            읽기/쓰기 **str**. |
...
| [`skip_java_script_links`](/slides/python-net/ko/aspose.slides.export/tiffoptions/skip_java_script_links/) | 프리젠테이션 저장 시 JavaScript 호출이 포함된 하이퍼링크를 건너뛸지 여부를 지정합니다.<br/>            읽기/쓰기 **bool**. 기본값은 **false** 입니다. |
...
| [`image_size`](/slides/python-net/ko/aspose.slides.export/tiffoptions/image_size/) | 생성된 TIFF 이미지의 크기를 지정합니다.<br/>            기본값은 0x0이며, 이는 프리젠테이션 슬라이드 크기 값을 기반으로 이미지 크기가 계산됨을 의미합니다.<br/>            읽기/쓰기 **aspose.slides.Size**. |
| [`dpi_x`](/slides/python-net/ko/aspose.slides.export/tiffoptions/dpi_x/) | 인치당 점 수로 수평 해상도를 지정합니다.<br/>            읽기/쓰기 **int**. |
| [`dpi_y`](/slides/python-net/ko/aspose.slides.export/tiffoptions/dpi_y/) | 인치당 점 수로 수직 해상도를 지정합니다.<br/>            읽기/쓰기 **int**. |
...
| [`slides_layout_options`](/slides/python-net/ko/aspose.slides.export/tiffoptions/slides_layout_options/) | 프리젠테이션 [`ISlidesLayoutOptions`](/slides/python-net/ko/aspose.slides.export/islideslayoutoptions)을 내보낼 때 슬라이드가 페이지에 배치되는 모드를 반환하거나 설정합니다. |
