...
description: 
type: docs
url: /ko/aspose.slides.export/xpsoptions/skip_java_script_links/
weight: 90
---
## skip_java_script_links 속성
프레젠테이션을 저장할 때 JavaScript 호출이 있는 하이퍼링크를 건너뛸지 여부를 지정합니다. 
            읽기/쓰기 **bool**. 기본값은 **false** .

### 비고

이 속성이 **true** , JavaScript 호출이 있는 하이퍼링크는 저장 중에 무시됩니다.
