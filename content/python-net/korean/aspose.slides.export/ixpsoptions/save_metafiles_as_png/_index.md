...
description: 
type: docs
url: /ko/aspose.slides.export/ixpsoptions/save_metafiles_as_png/
weight: 60
---
## save_metafiles_as_png 속성
프레젠테이션에서 사용되는 모든 메타파일을 PNG 이미지로 변환하려면 True를 설정합니다.
            읽기/쓰기 **bool**.
...
### 참고
* 클래스 [`IXpsOptions`](/slides/python-net/ko/aspose.slides.export/ixpsoptions)
