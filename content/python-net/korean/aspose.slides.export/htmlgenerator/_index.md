...
| 속성 | 설명 |
| :- | :- |
| [`slide_image_size`](/slides/python-net/ko/aspose.slides.export/htmlgenerator/slide_image_size/) | 슬라이드 이미지 크기를 반환합니다.<br/>            읽기 전용 **aspose.slides.SizeF**. |
...
| [`previous_slide_index`](/slides/python-net/ko/aspose.slides.export/htmlgenerator/previous_slide_index/) | 이전에 렌더링된 슬라이드의 인덱스를 반환합니다. 첫 번째 슬라이드가 렌더링되는 경우 -1을 반환합니다.<br/>            읽기 전용 **int**. |
| [`slide_index`](/slides/python-net/ko/aspose.slides.export/htmlgenerator/slide_index/) | 현재 렌더링 중인 슬라이드의 인덱스를 반환합니다.<br/>            읽기 전용 **int**. |
| [`next_slide_index`](/slides/python-net/ko/aspose.slides.export/htmlgenerator/next_slide_index/) | 현재 슬라이드 이후에 렌더링될 슬라이드의 인덱스를 반환합니다. 현재 마지막 슬라이드를 렌더링 중인 경우 -1을 반환합니다.<br/>            읽기 전용 **int**. |
...
| [`add_text(self, text)`](/slides/python-net/ko/aspose.slides.export/htmlgenerator/add_text/#str) | HTML 파일에 일반 텍스트를 추가하고 특수 문자를 HTML 엔터티로 변환합니다.<br/>            줄 바꿈 및 공백은 변환되지 않습니다. |
| [`add_text(self, text)`](/slides/python-net/ko/aspose.slides.export/htmlgenerator/add_text/#listchar) | HTML 파일에 일반 텍스트를 추가하고 특수 문자를 HTML 엔터티로 변환합니다.<br/>            줄 바꿈 및 공백은 변환되지 않습니다. |
| [`add_text(self, text, start_index, length)`](/slides/python-net/ko/aspose.slides.export/htmlgenerator/add_text/#listchar-int-int) | HTML 파일에 일반 텍스트를 추가하고 특수 문자를 HTML 엔터티로 변환합니다.<br/>            줄 바꿈 및 공백은 변환되지 않습니다. |
