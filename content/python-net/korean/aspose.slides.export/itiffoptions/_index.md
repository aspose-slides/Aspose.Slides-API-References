...
ITiffOptions 유형은 다음 멤버를 노출합니다:

## 속성

| 속성 | 설명 |
| :- | :- |
| [`image_size`](/slides/python-net/ko/aspose.slides.export/itiffoptions/image_size/) | 생성된 TIFF 이미지의 크기를 지정합니다.<br/>            기본값은 0x0이며, 이는 생성된 이미지 크기가 프레젠테이션 슬라이드 크기 값을 기반으로 계산된다는 의미입니다.<br/>            읽기/쓰기 **aspose.slides.Size**. |
| [`dpi_x`](/slides/python-net/ko/aspose.slides.export/itiffoptions/dpi_x/) | 인치당 점 수(DPI) 단위의 가로 해상도를 지정합니다.<br/>            읽기/쓰기 **int**. |
| [`dpi_y`](/slides/python-net/ko/aspose.slides.export/itiffoptions/dpi_y/) | 인치당 점 수(DPI) 단위의 세로 해상도를 지정합니다.<br/>            읽기/쓰기 **int**. |
...
| [`slides_layout_options`](/slides/python-net/ko/aspose.slides.export/itiffoptions/slides_layout_options/) | 프레젠테이션을 [`ISlidesLayoutOptions`](/slides/python-net/ko/aspose.slides.export/islideslayoutoptions) 내보낼 때 슬라이드가 페이지에 배치되는 방식을 가져오거나 설정합니다. |
...
| [`ink_options`](/slides/python-net/ko/aspose.slides.export/itiffoptions/ink_options/) | 내보낸 문서에서 Ink 개체의 모양을 제어하는 옵션을 제공합니다.<br/>            읽기 전용 [`IInkOptions`](/slides/python-net/ko/aspose.slides.export/iinkoptions) |
