...
description: 
type: docs
url: /ko/aspose.slides/masterlayoutslidecollection/remove/
weight: 60
---
...
| 예외 | 설명 |
| :- | :- |
| [`PptxEditException`](/slides/python-net/ko/aspose.slides/pptxeditexception) | 프레젠테이션에 레이아웃이 사용 중인 경우(its HasDependingSlides property is true) 발생합니다. |
