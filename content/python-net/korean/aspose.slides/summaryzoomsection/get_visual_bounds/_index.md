...
description: 
type: docs
url: /ko/aspose.slides/summaryzoomsection/get_visual_bounds/
weight: 40
---
...
시각적 경계를 나타내는 **aspose.slides.RectangleF** 는 도형의
             슬라이드 좌표에서의 경계입니다.
...
반환된 사각형은 슬라이드 좌표 공간에서 렌더링 중 도형에 의해 생성된 모든 콘텐츠의 축에 정렬된 경계 영역을 나타냅니다.
             ...
             시각적 경계는 변환(예: 회전), 스트로크 두께 및 조인, 텍스트 레이아웃 및 오버플로우, SmartArt 기하학 및 도형의 최종 렌더링 모양에 영향을 주는 기타 레이아웃 효과와 같은 렌더링 관련 요소를 고려합니다.
             
             반환된 경계는 슬라이드 사각형으로 잘리지 않습니다.
