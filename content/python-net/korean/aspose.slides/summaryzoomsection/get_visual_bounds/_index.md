...
[`RectangleF`](/slides/python-net/ko/aspose.slides/rectanglef)는 도형의 시각적 경계를 나타냅니다
             슬라이드 좌표계에서
...
시각적 경계는 변환(예: 회전), 스트로크 너비 및 연결, 텍스트 레이아웃 및 오버플로, SmartArt 기하학, 그리고 도형의 최종 렌더링 모습에 영향을 주는 기타 레이아웃 효과와 같은 렌더링 관련 요소들을 고려합니다.
