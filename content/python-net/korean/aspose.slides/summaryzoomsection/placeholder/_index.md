...
description: 
type: docs
url: /ko/aspose.slides/summaryzoomsection/placeholder/
weight: 370
---
## 플레이스홀더 속성
도형에 대한 플레이스홀더를 반환합니다. 도형에 플레이스홀더가 없으면 None을 반환합니다.
            읽기 전용 [`IPlaceholder`](/slides/python-net/ko/aspose.slides/iplaceholder).
