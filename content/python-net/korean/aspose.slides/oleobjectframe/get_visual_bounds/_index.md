...
렌더링된 콘텐츠로부터 계산된 도형의 시각적 경계를 가져옵니다.

### 반환

**aspose.slides.RectangleF**는 도형의 시각적 경계를 나타냅니다
             슬라이드 좌표계에서.
...
이 경계는 도형의 모델 경계([`Shape.x`](/slides/python-net/ko/aspose.slides/shape/x), [`Shape.y`](/slides/python-net/ko/aspose.slides/shape/y),
             ...
             그리고 렌더링된 콘텐츠가 슬라이드 원점을 넘어 확장될 경우 음수 좌표를 포함할 수 있습니다

시각적 경계는 변환(예: 회전), 스트로크 너비 및 조인,
             텍스트 레이아웃 및 오버플로, SmartArt 기하학, 그리고 기타 레이아웃 효과
             이는 도형의 최종 렌더링 모습을 좌우합니다
