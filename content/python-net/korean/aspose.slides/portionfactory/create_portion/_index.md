...
description: 
type: docs
url: /ko/aspose.slides/portionfactory/create_portion/
weight: 20
---
## create_portion(self) {#}
빈 텍스트 부분을 생성합니다.
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| portion | [`IPortion`](/slides/python-net/ko/aspose.slides/iportion) | 사용할 부분. |

### 참고
* 클래스 [`IPortion`](/slides/python-net/ko/aspose.slides/iportion)
* 클래스 [`PortionFactory`](/slides/python-net/ko/aspose.slides/portionfactory)
