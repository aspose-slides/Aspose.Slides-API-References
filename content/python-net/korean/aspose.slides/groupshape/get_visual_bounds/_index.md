...
반환된 사각형은 렌더링 중 도형에 의해 생성된 모든 콘텐츠의 축 정렬 경계를 슬라이드 좌표 공간에서 나타냅니다.
...
시각적 경계는 변환(예: 회전), 스트로크 두께 및 연결, 텍스트 레이아웃 및 오버플로우, SmartArt 기하학, 그리고 도형의 최종 렌더링된 외관에 영향을 주는 기타 레이아웃 효과와 같은 렌더링 관련 측면을 고려합니다.
