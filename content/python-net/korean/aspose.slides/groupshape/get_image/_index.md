...
description: 
type: docs
url: /ko/aspose.slides/groupshape/get_image/
weight: 30
---
## get_image(self) {#}
모양 썸네일을 반환합니다.
            ShapeThumbnailBounds.Shape shape thumbnail bounds type은 기본적으로 사용됩니다.
...
Shape thumbnail 또는 ShapeThumbnailBounds.Appearance가 사용되고 모양에 보이는 요소가 없을 경우 None을 반환합니다.
