...
description: 
type: docs
url: /ko/aspose.slides/layoutslidecollection/get_by_type/
weight: 10
---
## get_by_type(self, type) {#slidelayouttype}
지정된 유형의 첫 번째 레이아웃 슬라이드를 반환합니다.
            찾을 레이아웃 슬라이드의 유형입니다.[`LayoutSlide`](/slides/python-net/ko/aspose.slides/layoutslide) 지정된 유형과 함께 또는 레이아웃이 없으면 None을 반환합니다.
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| type | [`SlideLayoutType`](/slides/python-net/ko/aspose.slides/slidelayouttype) |  |
