...
description: 
type: docs
url: /ko/aspose.slides/summaryzoomframe/get_image/
weight: 30
---
## get_image(self) {#}
shape 썸네일을 반환합니다.
ShapeThumbnailBounds.Shape shape 썸네일 경계 유형이 기본값으로 사용됩니다.
...
### Returns
ShapeThumbnailBounds.Appearance이 사용되고 shape에 보이는 요소가 없을 경우 Shape 썸네일 또는 None을 반환합니다.
