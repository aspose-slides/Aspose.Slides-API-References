...
description: 
type: docs
url: /ko/aspose.slides/masterslideheaderfootermanager/set_slide_number_visibility/
weight: 100
---
## set_slide_number_visibility(self, is_visible) {#bool}
슬라이드 페이지 번호 자리표시자 가시성을 변경합니다.
...
| 매개변수 | 형식 | 설명 |
| :- | :- | :- |
| is_visible | **bool** | true - 페이지 번호 자리표시자를 표시하고, 그 외의 경우 - 숨깁니다. |
