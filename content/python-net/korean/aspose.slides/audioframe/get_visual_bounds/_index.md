...
도형의 시각적 경계를 슬라이드 좌표계에서 나타내는 **aspose.slides.RectangleF**
             .
...
### 참고
            ...
            와 다를 수 있으며, 렌더링된 콘텐츠가 슬라이드 원점을 넘어 확장되는 경우 음수 좌표를 포함할 수 있습니다.

             시각적 경계는 변환(예: 회전), 스트로크 두께 및 조인, 텍스트 레이아웃 및 오버플로, SmartArt 기하학, 그리고 도형의 최종 렌더링 모양에 영향을 주는 기타 레이아웃 효과와 같은 렌더링 관련 측면을 고려합니다.
