...
description: 
type: docs
url: /ko/aspose.slides/ishapecollection/to_array/
weight: 380
---
## to_array(self) {#}
...
[`IShape`](/slides/python-net/ko/aspose.slides/ishape) 객체의 배열.
...
| 매개변수 | 유형 | 설명 |
| :- | :- | :- |
| start_index | **int** | 반환할 첫 번째 도형의 인덱스입니다. |
| count | **int** | 반환할 도형의 수입니다. |
