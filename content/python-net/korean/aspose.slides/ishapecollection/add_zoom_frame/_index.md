...
description: 
type: docs
url: /ko/aspose.slides/ishapecollection/add_zoom_frame/
weight: 170
---
## add_zoom_frame(self, x, y, width, height, slide) {#float-float-float-float-islide}
새로운 Zoom 프레임을 생성하고 모양 컬렉션의 끝에 추가합니다.
...
| slide | [`ISlide`](/slides/python-net/ko/aspose.slides/islide) | Zoom 프레임이 참조하는 [`ISlide`](/slides/python-net/ko/aspose.slides/islide);<br/><br/>            이 프레젠테이션에 속해야 합니다. |
...
| height | **float** | 새 Zoom 프레임의 높이, 포인트 단위. |
| slide | [`ISlide`](/slides/python-net/ko/aspose.slides/islide) | Zoom 프레임이 참조하는 [`ISlide`](/slides/python-net/ko/aspose.slides/islide);<br/><br/>            이 프레젠테이션에 속해야 합니다. |
| image | [`IPPImage`](/slides/python-net/ko/aspose.slides/ippimage) | 참조된 슬라이드 [`IPPImage`](/slides/python-net/ko/aspose.slides/ippimage)의 이미지. |
