...
description: 
type: docs
url: /ko/aspose.slides/masterhandoutslide/slide_show_transition/
weight: 210
---
## slide_show_transition 속성
Transition 객체를 반환하며, 이는 지정된 슬라이드가 슬라이드 쇼 중에 어떻게 진행되는지에 대한 정보를 포함합니다. 읽기 전용 [`ISlideShowTransition`](/slides/python-net/ko/aspose.slides/islideshowtransition).
