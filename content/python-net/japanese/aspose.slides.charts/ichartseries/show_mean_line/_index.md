...
description: 
type: docs
url: /ja/aspose.slides.charts/ichartseries/show_mean_line/
weight: 440
---
## show_mean_line プロパティ
平均マーカーを表します。BoxAndWhisker チャートで平均線が表示されている場合は true です。BoxAndWhisker チャートにのみ適用されます。
            読み取り/書き込み **bool**.
