---
title: number_format_of_bubble_sizes property
second_title: Aspose.Slides for Python via .NET API リファレンス
description: 
type: docs
url: /ja/aspose.slides.charts/ichartseries/number_format_of_bubble_sizes/
weight: 260
---
## number_format_of_bubble_sizes プロパティ
シリーズのバブル サイズの数値フォーマットを取得または設定します。
読み取り/書き込み **str**.
