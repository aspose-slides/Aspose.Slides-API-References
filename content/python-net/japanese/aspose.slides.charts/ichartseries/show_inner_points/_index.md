...
description: 
type: docs
url: /ja/aspose.slides.charts/ichartseries/show_inner_points/
weight: 430
---
## show_inner_points プロパティ
内部ポイントを表します。内部ポイントが BoxAndWhisker チャートに表示されている場合は True です。BoxAndWhisker チャートにのみ適用されます.
            読み取り/書き込み **bool**.
