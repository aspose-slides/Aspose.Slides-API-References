...
description: 
type: docs
url: /ja/aspose.slides.charts/iaxis/major_unit_scale/
weight: 420
---
## major_unit_scale プロパティ
日付軸の主要単位スケールを表します。
             読み取り/書き込み [`TimeUnitType`](/slides/python-net/ja/aspose.slides.charts/timeunittype).
...
* 列挙型 [`TimeUnitType`](/slides/python-net/ja/aspose.slides.charts/timeunittype)
