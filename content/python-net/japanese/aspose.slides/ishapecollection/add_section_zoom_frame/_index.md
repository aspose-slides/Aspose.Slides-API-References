...
description: 
type: docs
url: /ja/aspose.slides/ishapecollection/add_section_zoom_frame/
weight: 120
---
...
| section | [`ISection`](/slides/python-net/ja/aspose.slides/isection) | Section Zoom フレームが参照する[`ISection`](/slides/python-net/ja/aspose.slides/isection)；<br/><br/>            このプレゼンテーションに属し、少なくとも 1 枚のスライドが含まれている必要があります。 |
