...
description: 
type: docs
url: /ja/aspose.slides/summaryzoomsection/add_placeholder/
weight: 10
---
## add_placeholder(self, placeholder_to_copy_from) {#iplaceholder}
新しいプレースホルダーが存在しない場合に追加し、指定されたプレースホルダーのプロパティを設定します。
...
| :- | :- | :- |
| placeholder_to_copy_from | [`IPlaceholder`](/slides/python-net/ja/aspose.slides/iplaceholder) | プレースホルダーからコンテンツをコピーする。 |
