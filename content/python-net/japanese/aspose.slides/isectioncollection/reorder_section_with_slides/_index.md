...
description: 
type: docs
url: /ja/aspose.slides/isectioncollection/reorder_section_with_slides/
weight: 80
---
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| section | [`ISection`](/slides/python-net/ja/aspose.slides/isection) | 移動するセクション。 |
| index | **int** | 対象インデックス。 |
...
* クラス [`ISectionCollection`](/slides/python-net/ja/aspose.slides/isectioncollection)
