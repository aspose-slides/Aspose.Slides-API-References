...
description: 
type: docs
url: /ja/aspose.slides/iconnector/end_shape_connected_to/
weight: 240
---
## end_shape_connected_to プロパティ
コネクタの端を接続する形状を取得または設定します。
            読み取り/書き込み [`IShape`](/slides/python-net/ja/aspose.slides/ishape).
