...
description: 
type: docs
url: /ja/aspose.slides.export/renderingoptions/gradient_style/
weight: 50
---
## gradient_style プロパティ
グラデーションの視覚的スタイルを取得または設定します。
            読み取り/書き込み [`GradientStyle`](/slides/python-net/ja/aspose.slides/gradientstyle).
...
### 参照
* 列挙型 [`GradientStyle`](/slides/python-net/ja/aspose.slides/gradientstyle)
