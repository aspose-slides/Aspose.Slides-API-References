...
description: 
type: docs
url: /ja/aspose.slides.export/pdfoptions/skip_java_script_links/
weight: 220
---
## skip_java_script_links プロパティ
プレゼンテーションを保存するときに、JavaScript 呼び出しを含むハイパーリンクをスキップするかどうかを指定します。 
            読み取り/書き込み **bool**。 デフォルト値は **false** です。
