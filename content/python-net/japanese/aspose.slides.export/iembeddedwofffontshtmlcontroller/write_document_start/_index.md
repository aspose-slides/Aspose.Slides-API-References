...
description: 
type: docs
url: /ja/aspose.slides.export/iembeddedwofffontshtmlcontroller/write_document_start/
weight: 20
---
...
| presentation | [`IPresentation`](/slides/python-net/ja/aspose.slides/ipresentation) |  |



### 参照
* クラス [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/ja/aspose.slides.export/iembeddedwofffontshtmlcontroller)
