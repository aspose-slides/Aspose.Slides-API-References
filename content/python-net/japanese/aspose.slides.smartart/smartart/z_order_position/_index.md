...
description: 
type: docs
url: /ja/aspose.slides.smartart/smartart/z_order_position/
weight: 500
---
## z_order_position プロパティ
シェイプの z-order における位置を返します。
            Shapes[0] は z-order の背面にあるシェイプを返し、
            Shapes[Shapes.Count - 1] は z-order の前面にあるシェイプを返します。
読み取り専用 **int**。
