...
description: 
type: docs
url: /ja/aspose.slides.smartart/smartartshape/placeholder/
weight: 370
---
## プレースホルダー プロパティ
シェイプのプレースホルダーを返します。シェイプにプレースホルダーがない場合は None を返します。
            読み取り専用 [`IPlaceholder`](/slides/python-net/ja/aspose.slides/iplaceholder).
