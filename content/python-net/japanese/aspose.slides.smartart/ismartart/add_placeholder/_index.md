...
description: 
type: docs
url: /ja/aspose.slides.smartart/ismartart/add_placeholder/
weight: 10
---
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| placeholder_to_copy_from | [`IPlaceholder`](/slides/python-net/ja/aspose.slides/iplaceholder) |  |



### 参照
* クラス [`IPlaceholder`](/slides/python-net/ja/aspose.slides/iplaceholder)
* クラス [`ISmartArt`](/slides/python-net/ja/aspose.slides.smartart/ismartart)
