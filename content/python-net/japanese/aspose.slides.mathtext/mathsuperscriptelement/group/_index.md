...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathsuperscriptelement/group/
weight: 80
---
## group(self) {#}
この要素を下カールブレースを使用してグループに配置します
...
この要素を、下カールブレースなどのグルーピング文字を使用してグループに配置します
