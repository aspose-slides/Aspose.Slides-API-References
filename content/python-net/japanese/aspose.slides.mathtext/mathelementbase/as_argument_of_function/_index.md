...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathelementbase/as_argument_of_function/
weight: 20
---
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/ja/aspose.slides.mathtext/mathfunctionsofoneargument) | 1 引数の共通関数タイプのいずれか |
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/ja/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 2 引数の共通関数タイプのいずれか: Log, Lim, Min, Max |
