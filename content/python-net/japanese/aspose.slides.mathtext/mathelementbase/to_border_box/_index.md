...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathelementbase/to_border_box/
weight: 190
---
## to_border_box(self) {#}
この要素をボーダーボックスに配置します
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| hide_top | **bool** | 上端を非表示にする |
| hide_bottom | **bool** | 下端を非表示にする |
| hide_left | **bool** | 左端を非表示にする |
| hide_right | **bool** | 右端を非表示にする |
| strikethrough_horizontal | **bool** | ボーダーボックスの横取り消し線 |
| strikethrough_vertical | **bool** | ボーダーボックスの縦取り消し線 |
