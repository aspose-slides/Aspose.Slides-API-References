...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathematicaltext/group/
weight: 80
---
## group(self) {#}
この要素を下側中かっこを使用してグループに配置します。
...
この要素を、下側中かっこなどのグルーピング文字を使用してグループに配置します。
