...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathematicaltext/as_argument_of_function/
weight: 30
---
...
[`IMathFunction`](/slides/python-net/ja/aspose.slides.mathtext/imathfunction) 型の新しい数式要素
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/ja/aspose.slides.mathtext/mathfunctionsofoneargument) | 1つの引数を持つ一般的な関数タイプの1つ |
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/ja/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 2つの引数を持つ一般的な関数タイプの1つ: Log, Lim, Min, Max |
