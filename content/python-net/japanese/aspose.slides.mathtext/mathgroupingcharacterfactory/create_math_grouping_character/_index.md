...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathgroupingcharacterfactory/create_math_grouping_character/
weight: 20
---
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/ja/aspose.slides.mathtext/imathelement) | グルーピング文字を適用する数式要素 |
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/ja/aspose.slides.mathtext/mathtopbotpositions) | 垂直方向の配置 |
...
* クラス [`MathGroupingCharacterFactory`](/slides/python-net/ja/aspose.slides.mathtext/mathgroupingcharacterfactory)
