...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathbar/as_argument_of_function/
weight: 30
---
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/ja/aspose.slides.mathtext/mathfunctionsofoneargument) | 1 つの引数を持つ一般的な関数タイプのいずれか |
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/ja/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 2 つの引数を持つ一般的な関数タイプのいずれか: Log, Lim, Min, Max |
