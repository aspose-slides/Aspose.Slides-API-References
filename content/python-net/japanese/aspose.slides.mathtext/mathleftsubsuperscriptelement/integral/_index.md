...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathleftsubsuperscriptelement/integral/
weight: 90
---
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| integral_type | [`MathIntegralTypes`](/slides/python-net/ja/aspose.slides.mathtext/mathintegraltypes) | 積分型 |
...
* 列挙 [`MathIntegralTypes`](/slides/python-net/ja/aspose.slides.mathtext/mathintegraltypes)
* クラス [`MathLeftSubSuperscriptElement`](/slides/python-net/ja/aspose.slides.mathtext/mathleftsubsuperscriptelement)
* 列挙 [`MathLimitLocations`](/slides/python-net/ja/aspose.slides.mathtext/mathlimitlocations)
