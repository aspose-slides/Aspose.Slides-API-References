...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathphantom/enclose/
weight: 50
---
## enclose(self) {#}
数式要素を括弧で囲みます
...
指定された文字（例えば括弧やその他の文字）で数式要素を囲みます

### 戻り値

[`IMathDelimiter`](/slides/python-net/ja/aspose.slides.mathtext/imathdelimiter) 型の数式要素で、指定された文字で囲まれます
