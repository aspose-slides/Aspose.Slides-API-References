...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathfunction/enclose/
weight: 50
---
## enclose(self) {#}
数式要素を括弧で囲みます
...
括弧を含むタイプ[`IMathDelimiter`](/slides/python-net/ja/aspose.slides.mathtext/imathdelimiter)の数式要素
...
数式要素を括弧などの指定文字でフレームとして囲みます

### 戻り値

指定された文字でフレームとして囲んだタイプ[`IMathDelimiter`](/slides/python-net/ja/aspose.slides.mathtext/imathdelimiter)の数式要素
