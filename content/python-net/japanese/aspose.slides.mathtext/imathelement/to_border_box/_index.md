...
description: 
type: docs
url: /ja/aspose.slides.mathtext/imathelement/to_border_box/
weight: 190
---
## to_border_box(self) {#}
この要素をボーダーボックスに配置します
...
| strikethrough_horizontal | **bool** | ボーダーボックス横線取り消し |
| strikethrough_vertical | **bool** | ボーダーボックス縦線取り消し |
| strikethrough_bottom_left_to_top_right | **bool** | ボーダーボックス左下から右上への取り消し線 |
| strikethrough_top_left_to_bottom_right | **bool** | ボーダーボックス左上から右下への取り消し線 |
