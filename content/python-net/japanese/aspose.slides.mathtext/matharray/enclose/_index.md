...
description: 
type: docs
url: /ja/aspose.slides.mathtext/matharray/enclose/
weight: 50
---
## enclose(self) {#}
数式要素を丸括弧で囲みます
...
丸括弧を含むタイプ [`IMathDelimiter`](/slides/python-net/ja/aspose.slides.mathtext/imathdelimiter) の数式要素
...
数式要素を丸括弧やその他の文字で囲み、フレーミングします

### 戻り値

指定された文字でフレーミングされたタイプ [`IMathDelimiter`](/slides/python-net/ja/aspose.slides.mathtext/imathdelimiter) の数式要素
