...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathnaryoperator/as_argument_of_function/
weight: 30
---
...
このインスタンスを引数として指定された関数を使用し、指定された追加引数を渡します
...
| additional_argument | [`IMathElement`](/slides/python-net/ja/aspose.slides.mathtext/imathelement) | 関数タイプに応じた追加引数 |
...
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/ja/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 2 引数の共通関数タイプのいずれか: Log, Lim, Min, Max |
| additional_argument | **str** | 関数タイプに応じた追加引数 |
