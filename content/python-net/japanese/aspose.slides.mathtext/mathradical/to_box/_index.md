...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathradical/to_box/
weight: 210
---
## to_box(self) {#}
...
### See Also
* class [`IMathBox`](/slides/python-net/ja/aspose.slides.mathtext/imathbox)
* class [`MathRadical`](/slides/python-net/ja/aspose.slides.mathtext/mathradical)
