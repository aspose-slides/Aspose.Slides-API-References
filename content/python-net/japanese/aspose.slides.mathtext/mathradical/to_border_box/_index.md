...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathradical/to_border_box/
weight: 200
---
## to_border_box(self) {#}
この要素を border-box に配置します

### 戻り値

この要素が内部に配置された Border-box
...
| strikethrough_horizontal | **bool** | Border Box 横方向取り消し線 |
| strikethrough_vertical | **bool** | Border Box 縦方向取り消し線 |
| strikethrough_bottom_left_to_top_right | **bool** | Border Box 左下から右上への取り消し線 |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box 左上から右下への取り消し線 |
