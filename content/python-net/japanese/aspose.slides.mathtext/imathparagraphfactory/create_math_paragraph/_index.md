...
description: 
type: docs
url: /ja/aspose.slides.mathtext/imathparagraphfactory/create_math_paragraph/
weight: 10
---
...
| パラメータ | 型 | 説明 |
| :- | :- | :- |
| math_block | [`IMathBlock`](/slides/python-net/ja/aspose.slides.mathtext/imathblock) | 段落に配置する数式ブロック |



### 参照
* クラス [`IMathBlock`](/slides/python-net/ja/aspose.slides.mathtext/imathblock)
* クラス [`IMathParagraph`](/slides/python-net/ja/aspose.slides.mathtext/imathparagraph)
* クラス [`IMathParagraphFactory`](/slides/python-net/ja/aspose.slides.mathtext/imathparagraphfactory)
