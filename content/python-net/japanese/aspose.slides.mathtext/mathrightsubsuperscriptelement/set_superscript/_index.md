...
description: 
type: docs
url: /ja/aspose.slides.mathtext/mathrightsubsuperscriptelement/set_superscript/
weight: 180
---
...
| パラメーター | 型 | 説明 |
| :- | :- | :- |
| superscript | [`IMathElement`](/slides/python-net/ja/aspose.slides.mathtext/imathelement) | 上付き文字（右側の上指数） |
