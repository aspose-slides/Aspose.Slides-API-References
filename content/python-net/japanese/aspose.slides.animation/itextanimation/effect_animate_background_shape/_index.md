...
description: 
type: docs
url: /ja/aspose.slides.animation/itextanimation/effect_animate_background_shape/
weight: 30
---
## effect_animate_background_shape プロパティ
Linked shape effect with group or not (None)
            読み取り/書き込み [`IEffect`](/slides/python-net/ja/aspose.slides.animation/ieffect).
...
* クラス [`ITextAnimation`](/slides/python-net/ja/aspose.slides.animation/itextanimation)
