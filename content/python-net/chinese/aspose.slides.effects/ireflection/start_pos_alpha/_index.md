...
description: 
type: docs
url: /zh/aspose.slides.effects/ireflection/start_pos_alpha/
weight: 150
---
## start_pos_alpha 属性
指定起始 alpha 值（百分比）的起始位置（沿 alpha 渐变坡）。
            读/写 **float**.
...
### 参见
* 类 [`IReflection`](/slides/python-net/zh/aspose.slides.effects/ireflection)
