...
description: 
type: docs
url: /zh/aspose.slides.export/iembeddedwofffontshtmlcontroller/write_document_start/
weight: 20
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| generator | [`IHtmlGenerator`](/slides/python-net/zh/aspose.slides.export/ihtmlgenerator) |  |
| presentation | [`IPresentation`](/slides/python-net/zh/aspose.slides/ipresentation) |  |


### 另请参见
* 类 [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/zh/aspose.slides.export/iembeddedwofffontshtmlcontroller)
