...
description: 
type: docs
url: /zh/aspose.slides.export/ihtmloptions/slide_image_format/
weight: 130
---
## slide_image_format 属性
返回或设置幻灯片图像格式选项。
            读/写 [`ISlideImageFormat`](/slides/python-net/zh/aspose.slides.export/islideimageformat).
...
* 类 [`ISlideImageFormat`](/slides/python-net/zh/aspose.slides.export/islideimageformat)
