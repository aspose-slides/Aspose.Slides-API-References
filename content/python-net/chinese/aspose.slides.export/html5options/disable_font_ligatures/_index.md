...
description: 
type: docs
url: /zh/aspose.slides.export/html5options/disable_font_ligatures/
weight: 60
---
## disable_font_ligatures 属性
获取或设置一个值，用于指示文本是否在渲染时不使用连字。
当设置为 `true` 时，连字将在渲染输出中被禁用。默认情况下，此属性设置为 `false`。
