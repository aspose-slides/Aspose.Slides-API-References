...
description: 
type: docs
url: /zh/aspose.slides.animation/itextanimation/add_effect/
weight: 10
---
## add_effect(self, effect_type, subtype, trigger_type) {#effecttype-effectsubtype-effecttriggertype}
将新的效果添加到当前序列的末尾，以结束组文本动画。  
仅在文本段落的数量大于或等于该组效果的计数时有效！
...
### 参见
* enumeration [`EffectSubtype`](/slides/python-net/zh/aspose.slides.animation/effectsubtype)
* enumeration [`EffectTriggerType`](/slides/python-net/zh/aspose.slides.animation/effecttriggertype)
* enumeration [`EffectType`](/slides/python-net/zh/aspose.slides.animation/effecttype)
* 类 [`IEffect`](/slides/python-net/zh/aspose.slides.animation/ieffect)
* 类 [`ITextAnimation`](/slides/python-net/zh/aspose.slides.animation/itextanimation)
