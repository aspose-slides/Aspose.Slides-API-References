...
description: 
type: docs
url: /zh/aspose.slides/notesslide/join_portions_with_same_formatting/
weight: 40
---
## join_portions_with_same_formatting(self) {#}
在所有可接受的形状中的所有段落中，将具有相同格式的文本运行合并。
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| collection | [`IShapeCollection`](/slides/python-net/zh/aspose.slides/ishapecollection) |  |
