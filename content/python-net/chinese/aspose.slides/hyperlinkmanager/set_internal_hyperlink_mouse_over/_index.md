...
description: 
type: docs
url: /zh/aspose.slides/hyperlinkmanager/set_internal_hyperlink_mouse_over/
weight: 60
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| target_slide | [`ISlide`](/slides/python-net/zh/aspose.slides/islide) | 目标幻灯片。 |

### 另请参见
* 类 [`HyperlinkManager`](/slides/python-net/zh/aspose.slides/hyperlinkmanager)
