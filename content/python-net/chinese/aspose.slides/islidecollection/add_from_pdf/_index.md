...
description: 
type: docs
url: /zh/aspose.slides/islidecollection/add_from_pdf/
weight: 40
---
...
| :- | :- | :- |
| path | **str** | PDF 文档的路径 |
| pdf_import_options | [`PdfImportOptions`](/slides/python-net/zh/aspose.slides.importing/pdfimportoptions) | pdf 导入的选项 |
...
* 类 [`PdfImportOptions`](/slides/python-net/zh/aspose.slides.importing/pdfimportoptions)
