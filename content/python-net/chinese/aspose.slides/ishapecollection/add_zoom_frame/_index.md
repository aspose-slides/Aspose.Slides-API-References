...
description: 
type: docs
url: /zh/aspose.slides/ishapecollection/add_zoom_frame/
weight: 170
---
## add_zoom_frame(self, x, y, width, height, slide) {#float-float-float-float-islide}
创建一个新的 Zoom 框架并将其添加到形状集合的末尾。
...
| slide | [`ISlide`](/slides/python-net/zh/aspose.slides/islide) | Zoom 框架引用的 [`ISlide`](/slides/python-net/zh/aspose.slides/islide)；<br/><br/>必须属于此演示文稿。 |

### 异常

| 异常 | 描述 |
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | 如果引用的幻灯片不属于当前演示文稿，则抛出。 |
