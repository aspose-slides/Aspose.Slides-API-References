...
description: 
type: docs
url: /zh/aspose.slides/masterhandoutslide/slide_show_transition/
weight: 210
---
## slide_show_transition 属性
返回 Transition 对象，其中包含有关指定幻灯片在幻灯片放映期间如何前进的信息。只读 [`ISlideShowTransition`](/slides/python-net/zh/aspose.slides/islideshowtransition)。
