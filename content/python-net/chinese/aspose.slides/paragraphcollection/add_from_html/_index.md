...
description: 
type: docs
url: /zh/aspose.slides/paragraphcollection/add_from_html/
weight: 20
---
...
| :- | :- | :- |
| text | **str** | HTML 文本。 |
| resolver | [`IExternalResourceResolver`](/slides/python-net/zh/aspose.slides.importing/iexternalresourceresolver) | 解析 URI 并获取引用对象的解析器回调对象。 |
| uri | **str** | 用于添加 HTML 文档的 URI。用于解析相对链接。 |

### 备注

指定解析器可能会引入安全漏洞。请谨慎使用。
