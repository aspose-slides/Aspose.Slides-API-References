...
description: 
type: docs
url: /zh/aspose.slides/globallayoutslidecollection/remove/
weight: 40
---
...
2) 也可以使用 [`ILayoutSlide.remove`](/slides/python-net/zh/aspose.slides/ilayoutslide/remove) 方法简化代码。

### 异常

| 异常 | 描述 |
| :- | :- |
| [`PptxEditException`](/slides/python-net/zh/aspose.slides/pptxeditexception) | 如果布局已在演示文稿中使用（其 HasDependingSlides 属性为 true），则抛出此异常。 |
