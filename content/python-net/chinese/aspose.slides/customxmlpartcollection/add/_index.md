...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| xml_string | **str** | 要添加的新部分的 xml 字符串。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| xml_data | **bytes** | 要添加的新部分的 xml 数据。 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| input_stream | **io.RawIOBase** | 要添加的新部分的 xml 数据的 inputStream。 |
...
### 另见
* 类 [`CustomXmlPartCollection`](/slides/python-net/zh/aspose.slides/customxmlpartcollection)
