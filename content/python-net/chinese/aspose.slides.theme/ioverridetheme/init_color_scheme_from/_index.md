...
description: 
type: docs
url: /zh/aspose.slides.theme/ioverridetheme/init_color_scheme_from/
weight: 40
---
...
| 异常 | 描述 |
| :- | :- |
| **RuntimeError(Proxy error(InvalidOperationException))** | 如果 ColorScheme 已经初始化（非 None），则抛出。 |
| **RuntimeError(Proxy error(ArgumentNullException))** | 如果 colorScheme 参数为 None，则抛出。 |
