...
如果将输出文件名指定为 "myPath/myFilename.jpeg"，  
则结果将保存为一组 "myPath/myFilename_N.jpeg" 文件，其中 N 为幻灯片编号。
...
| pres | [`Presentation`](/slides/python-net/zh/aspose.slides/presentation) | 输入的演示文稿 |
| output_file_name | **str** | 输出文件名。 |
| image_size | **aspose.slides.Size** | 每个生成图像的大小。 |
...
| pres | [`Presentation`](/slides/python-net/zh/aspose.slides/presentation) | 输入的演示文稿。 |
| output_file_name | **str** | 输出文件名。 |
| scale | **float** | 相对于原始幻灯片尺寸的输出图像缩放因子。 |
