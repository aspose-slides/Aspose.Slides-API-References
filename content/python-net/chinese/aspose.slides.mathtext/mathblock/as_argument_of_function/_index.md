...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathblock/as_argument_of_function/
weight: 40
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 双参数常见函数类型之一：Log、Lim、Min、Max |
