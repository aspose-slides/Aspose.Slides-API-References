...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathrightsubsuperscriptelement/radical/
weight: 130
---
...
类型为 [`IMathRadical`](/slides/python-net/zh/aspose.slides.mathtext/imathradical) 的新实例
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| degree | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | Radical 参数 |
