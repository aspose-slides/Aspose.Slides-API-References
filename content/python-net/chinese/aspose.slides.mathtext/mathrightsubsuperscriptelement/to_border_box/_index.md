...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathrightsubsuperscriptelement/to_border_box/
weight: 200
---
## to_border_box(self) {#}
将此元素放置在边框盒中
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| hide_top | **bool** | 隐藏顶部边缘 |
| hide_bottom | **bool** | 隐藏底部边缘 |
| hide_left | **bool** | 隐藏左侧边缘 |
| hide_right | **bool** | 隐藏右侧边缘 |
