...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathrightsubsuperscriptelement/group/
weight: 80
---
## group(self) {#}
使用底部大括号将此元素放入组中
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/zh/aspose.slides.mathtext/mathtopbotpositions) | 组字符的垂直对齐方式。<br/><br/> 指定对象相对于基线的对齐方式。<br/><br/> 例如，当组字符位于对象上方时，<br/><br/> VerticalJustification of Top 表示对象的顶部位于基线上；<br/><br/> 当 VerticalJustification 设置为 Bottom 时，对象的底部位于基线上 |
