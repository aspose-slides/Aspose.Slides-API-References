...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathbox/group/
weight: 80
---
## group(self) {#}
将此元素放入使用底部大括号的组中
...
| position | [`MathTopBotPositions`](/slides/python-net/zh/aspose.slides.mathtext/mathtopbotpositions) | Position of grouping character |
