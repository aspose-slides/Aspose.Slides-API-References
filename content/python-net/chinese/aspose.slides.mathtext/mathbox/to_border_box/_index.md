...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathbox/to_border_box/
weight: 200
---
## to_border_box(self) {#}
将此元素放置在边框盒中
...
| :- | :- | :- |
| hide_top | **bool** | 隐藏上边缘 |
| hide_bottom | **bool** | 隐藏下边缘 |
| hide_left | **bool** | 隐藏左边缘 |
| hide_right | **bool** | 隐藏右边缘 |
| strikethrough_horizontal | **bool** | 边框盒水平删除线 |
| strikethrough_vertical | **bool** | 边框盒垂直删除线 |
| strikethrough_bottom_left_to_top_right | **bool** | 边框盒从左下到右上删除线 |
| strikethrough_top_left_to_bottom_right | **bool** | 边框盒从左上到右下删除线 |



### 另见
* class [`IMathBorderBox`](/slides/python-net/zh/aspose.slides.mathtext/imathborderbox)
* class [`MathBox`](/slides/python-net/zh/aspose.slides.mathtext/mathbox)
