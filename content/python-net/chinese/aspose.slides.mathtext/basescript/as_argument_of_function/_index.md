...
description: 
type: docs
url: /zh/aspose.slides.mathtext/basescript/as_argument_of_function/
weight: 20
---
...
新数学元素的类型为 [`IMathFunction`](/slides/python-net/zh/aspose.slides.mathtext/imathfunction)
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsofoneargument) | 单参数常见函数类型之一 |


## as_argument_of_function(self, function_type, additional_argument) {#mathfunctionsoftwoarguments-imathelement}
使用此实例作为参数调用指定函数并提供指定的附加参数
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 两参数常见函数类型之一：Log、Lim、Min、Max |
