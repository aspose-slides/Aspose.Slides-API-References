...
description: 
type: docs
url: /zh/aspose.slides.mathtext/imathematicaltextfactory/create_mathematical_text/
weight: 10
---
...
| :- | :- | :- |
| math_text | **str** | 文本值 |
| portion_format | [`IPortionFormat`](/slides/python-net/zh/aspose.slides/iportionformat) | 文本格式设置 |



### 另见
* 类 [`IMathematicalText`](/slides/python-net/zh/aspose.slides.mathtext/imathematicaltext)
* 类 [`IMathematicalTextFactory`](/slides/python-net/zh/aspose.slides.mathtext/imathematicaltextfactory)
