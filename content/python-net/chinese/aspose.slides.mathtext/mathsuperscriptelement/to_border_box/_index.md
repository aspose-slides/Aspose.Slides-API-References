...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathsuperscriptelement/to_border_box/
weight: 200
---
## to_border_box(self) {#}
将此元素放入边框盒中
...
| strikethrough_bottom_left_to_top_right | **bool** | 边框盒左下到右上删除线 |
| strikethrough_top_left_to_bottom_right | **bool** | 边框盒左上到右下删除线 |
