...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathsuperscriptelement/set_sub_superscript_on_the_right/
weight: 160
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 下标（右侧的下标） |
