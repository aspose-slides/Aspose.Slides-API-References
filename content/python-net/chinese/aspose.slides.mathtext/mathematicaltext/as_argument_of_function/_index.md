...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathematicaltext/as_argument_of_function/
weight: 30
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_name | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 函数名 |
...
| additional_argument | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 取决于函数类型的附加参数 |
...
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 两参数常用函数类型之一：Log, Lim, Min, Max |
| additional_argument | **str** | 取决于函数类型的附加参数 |
