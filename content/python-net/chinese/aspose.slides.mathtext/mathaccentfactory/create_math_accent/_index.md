...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathaccentfactory/create_math_accent/
weight: 20
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 要应用重音的数学元素 |
...
* 类 [`MathAccentFactory`](/slides/python-net/zh/aspose.slides.mathtext/mathaccentfactory)
