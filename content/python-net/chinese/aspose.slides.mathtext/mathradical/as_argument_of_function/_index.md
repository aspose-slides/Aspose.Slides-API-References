...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathradical/as_argument_of_function/
weight: 30
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsofoneargument) | 常见的单参数函数类型之一 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 常见的双参数函数类型之一：Log、Lim、Min、Max |
