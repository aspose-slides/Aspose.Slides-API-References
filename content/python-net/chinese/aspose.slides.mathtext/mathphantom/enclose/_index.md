...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathphantom/enclose/
weight: 50
---
## enclose(self) {#}
将数学元素包裹在括号中
...
包含括号的 [`IMathDelimiter`](/slides/python-net/zh/aspose.slides.mathtext/imathdelimiter) 类型的数学元素
...
在指定字符（如括号或其他字符）中将数学元素框住

### 返回

包含指定字符作为框架的 [`IMathDelimiter`](/slides/python-net/zh/aspose.slides.mathtext/imathdelimiter) 类型的数学元素
