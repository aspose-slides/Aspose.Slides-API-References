...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathphantom/as_argument_of_function/
weight: 30
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 二参数常用函数类型之一：Log、Lim、Min、Max |
| additional_argument | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 取决于函数类型的额外参数 |
...
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 二参数常用函数类型之一：Log、Lim、Min、Max |
| additional_argument | **str** | 取决于函数类型的额外参数 |
