...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathbar/enclose/
weight: 50
---
## enclose(self) {#}
将数学元素用括号括起
...
在指定字符（如括号或其他字符）中封装数学元素

### 返回

使用指定字符作为框架的类型为 [`IMathDelimiter`](/slides/python-net/zh/aspose.slides.mathtext/imathdelimiter) 的数学元素
