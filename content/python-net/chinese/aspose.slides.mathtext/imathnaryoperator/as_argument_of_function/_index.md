...
description: 
type: docs
url: /zh/aspose.slides.mathtext/imathnaryoperator/as_argument_of_function/
weight: 20
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_name | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) |  |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsofoneargument) |  |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) |  |
| additional_argument | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) |  |
