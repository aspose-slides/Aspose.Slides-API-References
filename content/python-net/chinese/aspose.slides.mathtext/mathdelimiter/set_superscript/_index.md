...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathdelimiter/set_superscript/
weight: 190
---
...
新数学元素类型 [`IMathSuperscriptElement`](/slides/python-net/zh/aspose.slides.mathtext/imathsuperscriptelement)
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| superscript | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 上标（右侧的上标指数） |
