...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathleftsubsuperscriptelement/enclose/
weight: 50
---
## enclose(self) {#}
将数学元素用括号括起来
...
包含指定字符框定的类型为[`IMathDelimiter`](/slides/python-net/zh/aspose.slides.mathtext/imathdelimiter)的数学元素
