...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathleftsubsuperscriptelement/set_upper_limit/
weight: 190
---
...
新实例的类型 [`IMathLimit`](/slides/python-net/zh/aspose.slides.mathtext/imathlimit)
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| limit | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 限制 |
