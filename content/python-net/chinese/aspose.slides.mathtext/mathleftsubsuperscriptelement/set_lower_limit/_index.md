...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathleftsubsuperscriptelement/set_lower_limit/
weight: 140
---
...
类型 [`IMathLimit`](/slides/python-net/zh/aspose.slides.mathtext/imathlimit) 的新实例
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| limit | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | limit |
