...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathsubscriptelement/as_argument_of_function/
weight: 30
---
...
新数学元素类型 [`IMathFunction`](/slides/python-net/zh/aspose.slides.mathtext/imathfunction)
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 两参数常用函数类型之一：Log、Lim、Min、Max |
| additional_argument | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 根据函数类型的额外参数 |
...
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/zh/aspose.slides.mathtext/mathfunctionsoftwoarguments) | 两参数常用函数类型之一：Log、Lim、Min、Max |
| additional_argument | **str** | 根据函数类型的额外参数 |
