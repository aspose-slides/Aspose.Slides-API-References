...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathgroupingcharacter/enclose/
weight: 50
---
## enclose(self) {#}
将数学元素用括号括起来
...
包含括号的类型为 [`IMathDelimiter`](/slides/python-net/zh/aspose.slides.mathtext/imathdelimiter) 的数学元素
...
将数学元素用指定字符（如括号或其他字符）作为框架进行括起

### 返回

包含指定字符作为框架的类型为 [`IMathDelimiter`](/slides/python-net/zh/aspose.slides.mathtext/imathdelimiter) 的数学元素
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| beginning_character | **char** | 起始字符（通常是左括号） |
| ending_character | **char** | 结束字符（通常是右括号） |
