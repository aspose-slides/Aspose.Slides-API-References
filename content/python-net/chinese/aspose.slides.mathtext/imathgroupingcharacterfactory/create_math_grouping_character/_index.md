...
description: 
type: docs
url: /zh/aspose.slides.mathtext/imathgroupingcharacterfactory/create_math_grouping_character/
weight: 10
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 用于应用分组字符的数学元素 |
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/zh/aspose.slides.mathtext/mathtopbotpositions) | 垂直对齐 |
...
* 类 [`IMathGroupingCharacterFactory`](/slides/python-net/zh/aspose.slides.mathtext/imathgroupingcharacterfactory)
