...
description: 
type: docs
url: /zh/aspose.slides.mathtext/mathfunction/enclose/
weight: 50
---
## enclose(self) {#}
将数学元素用括号括起来
...
### 返回
类型为 [`IMathDelimiter`](/slides/python-net/zh/aspose.slides.mathtext/imathdelimiter) 的数学元素，其中包括括号
...
将数学元素用指定字符（如括号或其他字符）进行框定

### 返回
类型为 [`IMathDelimiter`](/slides/python-net/zh/aspose.slides.mathtext/imathdelimiter) 的数学元素，其中包含指定字符作为框定
