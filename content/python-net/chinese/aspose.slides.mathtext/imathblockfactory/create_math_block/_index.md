...
description: 
type: docs
url: /zh/aspose.slides.mathtext/imathblockfactory/create_math_block/
weight: 10
---
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| math_element | [`IMathElement`](/slides/python-net/zh/aspose.slides.mathtext/imathelement) | 一个数学元素 |
...
| 参数 | 类型 | 描述 |
| :- | :- | :- |
| math_elements | [`IMathElementCollection`](/slides/python-net/zh/aspose.slides.mathtext/imathelementcollection) | 数学元素 |



### 参见
* 类 [`IMathBlock`](/slides/python-net/zh/aspose.slides.mathtext/imathblock)
* 类 [`IMathBlockFactory`](/slides/python-net/zh/aspose.slides.mathtext/imathblockfactory)
