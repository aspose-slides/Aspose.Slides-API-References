---
title: create_math_grouping_character method
second_title: Referência da API Aspose.Slides para Python via .NET
description: 
type: docs
url: /pt/aspose.slides.mathtext/mathgroupingcharacterfactory/create_math_grouping_character/
weight: 20
---
...
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/pt/aspose.slides.mathtext/imathelement) | elemento matemático ao qual aplicar o caractere de agrupamento |
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/pt/aspose.slides.mathtext/mathtopbotpositions) | justificação vertical |
...
* classe [`MathGroupingCharacterFactory`](/slides/python-net/pt/aspose.slides.mathtext/mathgroupingcharacterfactory)
