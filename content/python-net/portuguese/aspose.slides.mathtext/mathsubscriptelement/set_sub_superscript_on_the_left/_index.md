...
description: 
type: docs
url: /pt/aspose.slides.mathtext/mathsubscriptelement/set_sub_superscript_on_the_left/
weight: 150
---
...
New math element of type [`IMathLeftSubSuperscriptElement`](/slides/python-net/pt/aspose.slides.mathtext/imathleftsubsuperscriptelement)
...
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/pt/aspose.slides.mathtext/imathelement) | Subscript (lower index on the left) |
| superscript | [`IMathElement`](/slides/python-net/pt/aspose.slides.mathtext/imathelement) | Superscript (upper index on the left) |
