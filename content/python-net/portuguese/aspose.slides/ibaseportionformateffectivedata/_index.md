...
Interface base para objetos imutáveis que contêm propriedades de formatação de porção de texto efetiva.

O tipo IBasePortionFormatEffectiveData expõe os seguintes membros:
...
| [`highlight_color`](/slides/python-net/pt/aspose.slides/ibaseportionformateffectivedata/highlight_color/) | Retorna a cor usada para destacar um texto.<br/>            Somente leitura [`Color`](/slides/python-net/pt/aspose.slides/color). |
...
| [`kumimoji`](/slides/python-net/pt/aspose.slides/ibaseportionformateffectivedata/kumimoji/) | Determina se os números devem ignorar o layout vertical de texto específico de línguas orientais.<br/>            Somente leitura **bool**. |
...
| [`is_hard_underline_line`](/slides/python-net/pt/aspose.slides/ibaseportionformateffectivedata/is_hard_underline_line/) | Determina se o estilo de sublinhado tem propriedades LineFormat próprias ou as herda das propriedades LineFormat do texto.<br/>            Somente leitura **bool**. |
| [`is_hard_underline_fill`](/slides/python-net/pt/aspose.slides/ibaseportionformateffectivedata/is_hard_underline_fill/) | Determina se o estilo de sublinhado tem propriedades FillFormat próprias ou as herda das propriedades FillFormat do texto.<br/>            Somente leitura **bool**. |
| [`font_height`](/slides/python-net/pt/aspose.slides/ibaseportionformateffectivedata/font_height/) | Retorna a altura da fonte da porção de texto, em pontos.<br/>            Somente leitura **float**. |
...
| [`east_asian_font`](/slides/python-net/pt/aspose.slides/ibaseportionformateffectivedata/east_asian_font/) | Retorna as informações da fonte do Leste Asiático.<br/>            Somente leitura [`IFontData`](/slides/python-net/pt/aspose.slides/ifontdata). |
...
| [`spacing`](/slides/python-net/pt/aspose.slides/ibaseportionformateffectivedata/spacing/) | Retorna o incremento de espaçamento intercaracteres, em pontos.<br/>            Somente leitura **float**. |
