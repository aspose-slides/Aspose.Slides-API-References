...
description: 
type: docs
url: /pt/aspose.slides/table/get_visual_bounds/
weight: 40
---
...
Os limites visuais levam em consideração aspectos relacionados à renderização, como transformações (por exemplo, rotação), largura e junções de traçado, layout e transbordamento de texto, geometria do SmartArt e outros efeitos de layout que influenciam a aparência final renderizada da forma.
