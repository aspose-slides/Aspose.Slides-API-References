...
| slide | [`ISlide`](/slides/python-net/pt/aspose.slides/islide) | Slide em uma apresentação onde adicionar um novo comentário moderno. |
...
| position | [`PointF`](/slides/python-net/pt/aspose.slides/pointf) | Posição em um slide onde adicionar um novo comentário moderno. |
| creation_time | **DateTime** | Hora da criação de um comentário moderno. |
