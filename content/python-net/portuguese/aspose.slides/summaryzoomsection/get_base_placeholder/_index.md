...
description: 
type: docs
url: /pt/aspose.slides/summaryzoomsection/get_base_placeholder/
weight: 20
---
## get_base_placeholder(self) {#}
Retorna uma forma de placeholder básica (forma do layout e/ou do slide mestre da qual a forma atual é herdada).
            None é retornado se a forma atual não for herdada.
