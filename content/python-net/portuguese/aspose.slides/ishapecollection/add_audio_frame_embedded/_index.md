...
description: 
type: docs
url: /pt/aspose.slides/ishapecollection/add_audio_frame_embedded/
weight: 20
---
...
| width | **float** | A largura do novo quadro de áudio, em pontos. |
| height | **float** | A altura do novo quadro de áudio, em pontos. |
| audio | [`IAudio`](/slides/python-net/pt/aspose.slides/iaudio) | Uma instância de [`IAudio`](/slides/python-net/pt/aspose.slides/iaudio) da coleção Presentation.Audios. |
