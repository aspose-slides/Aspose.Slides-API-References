...
description: 
type: docs
url: /pt/aspose.slides/ishapecollection/add_zoom_frame/
weight: 170
---
...
| slide | [`ISlide`](/slides/python-net/pt/aspose.slides/islide) | O [`ISlide`](/slides/python-net/pt/aspose.slides/islide) referenciado pelo quadro de Zoom;<br/><br/> deve pertencer a esta apresentação. |
