...
description: 
type: docs
url: /pt/aspose.slides/shapecollection/insert_audio_frame_embedded/
weight: 210
---
...
| width | **float** | A largura do novo quadro de áudio, em pontos. |
| height | **float** | A altura do novo quadro de áudio, em pontos. |
| audio | [`IAudio`](/slides/python-net/pt/aspose.slides/iaudio) | Uma instância [`IAudio`](/slides/python-net/pt/aspose.slides/iaudio) da coleção Presentation.Audios para incorporar. |



### Veja Também
* class [`IAudio`](/slides/python-net/pt/aspose.slides/iaudio)
* class [`IAudioFrame`](/slides/python-net/pt/aspose.slides/iaudioframe)
