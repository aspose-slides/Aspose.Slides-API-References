...
description: 
type: docs
url: /pt/aspose.slides/islidecollection/insert_from_html/
weight: 80
---
...
| index | **int** | Posição para inserir. |
| html_text | **str** | HTML a ser adicionado. |
| resolver | [`IExternalResourceResolver`](/slides/python-net/pt/aspose.slides.importing/iexternalresourceresolver) | Um objeto de callback usado para buscar objetos externos. Se este parâmetro for None, todos os objetos externos serão ignorados. |
