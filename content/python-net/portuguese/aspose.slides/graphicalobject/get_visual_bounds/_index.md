...
description: 
type: docs
url: /pt/aspose.slides/graphicalobject/get_visual_bounds/
weight: 40
---
...
Os limites visuais levam em consideração aspectos relacionados à renderização, como transformações (por exemplo, rotação), largura e junções de traço, layout e excesso de texto, geometria do SmartArt e outros efeitos de layout que influenciam a aparência final renderizada da forma.
