...
description: 
type: docs
url: /pt/aspose.slides/ipicturefillformat/compress_image/
weight: 10
---
...
| :- | :- | :- |
| delete_cropped_areas_of_image | **bool** | Se true, o método removerá as áreas recortadas da imagem, potencialmente reduzindo ainda mais seu tamanho. |
...
| Exceção | Descrição |
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Lançada quando a resolução não é um valor válido. |
...
| Exceção | Descrição |
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Lançada quando a resolução não é um valor positivo. |



### Veja também
* classe [`IPictureFillFormat`](/slides/python-net/pt/aspose.slides/ipicturefillformat)
