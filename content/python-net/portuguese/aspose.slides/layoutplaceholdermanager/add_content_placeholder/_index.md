...
description: 
type: docs
url: /pt/aspose.slides/layoutplaceholdermanager/add_content_placeholder/
weight: 20
---
## add_content_placeholder(self, x, y, width, height) {#float-float-float-float}
Adiciona uma nova forma de placeholder ao slide de layout para conter conteúdo, como uma imagem, tabela, mídia ou texto.

### Retorna

Criado [`IAutoShape`](/slides/python-net/pt/aspose.slides/iautoshape) com um placeholder de Conteúdo.
...
* classe [`LayoutPlaceholderManager`](/slides/python-net/pt/aspose.slides/layoutplaceholdermanager)
