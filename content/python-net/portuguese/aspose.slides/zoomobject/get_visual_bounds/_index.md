...
O retângulo retornado representa os limites alinhados aos eixos de todo o conteúdo
             ...
             Os limites visuais levam em conta aspectos relacionados à renderização,
             como transformações (por exemplo, rotação), largura e junções do traço,
             layout e transbordamento de texto, geometria do SmartArt e outros efeitos
