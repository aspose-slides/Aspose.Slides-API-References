...
**Herança:**[`ModernComment`](/slides/python-net/pt/aspose.slides/moderncomment) → [`Comment`](/slides/python-net/pt/aspose.slides/comment)

O tipo ModernComment expõe os seguintes membros:
...
| Método | Descrição |
| :- | :- |
| [`remove(self)`](/slides/python-net/pt/aspose.slides/moderncomment/remove/#) | Remove o comentário e todas as suas respostas da coleção pai. |

### Veja Também
* classe [`Comment`](/slides/python-net/pt/aspose.slides/comment)
* classe [`ModernComment`](/slides/python-net/pt/aspose.slides/moderncomment)
