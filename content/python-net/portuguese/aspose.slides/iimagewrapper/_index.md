...
| Método | Descrição |
| :- | :- |
| [`save(self, file_name)`](/slides/python-net/pt/aspose.slides/iimagewrapper/save/#str) | Salva a Image no arquivo especificado |
| [`save(self, stream, image_format)`](/slides/python-net/pt/aspose.slides/iimagewrapper/save/#iorawiobase-ppimageformat) | Salva a Image no fluxo especificado no formato especificado. |
