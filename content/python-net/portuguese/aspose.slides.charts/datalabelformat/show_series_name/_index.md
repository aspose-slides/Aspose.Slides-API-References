...
description: 
type: docs
url: /pt/aspose.slides.charts/datalabelformat/show_series_name/
weight: 190
---
...
Retorna ou define um Boolean para indicar o comportamento de exibição do nome da série nos rótulos de dados de um gráfico. 
            True para mostrar o nome da série. False para ocultar.
...
Se o pai deste objeto DataLabelFormat for uma coleção DataLabelCollection de rótulos de dados então esta
            ...
            Definir esta propriedade com valor também define esse valor na propriedade ShowSeriesName 
            para todos os rótulos de dados na coleção DataLabelCollection
            (ou seja, "DataLabels.DefaultDataLabelFormat.ShowSeriesName = val;" faz com que 
