...
description: 
type: docs
url: /pt/aspose.slides.charts/ichartdataworkbook/get_cell/
weight: 30
---
...
| :- | :- | :- |
| worksheet_index | **int** | Índice da planilha. |
| cell_name | **str** | Nome da célula. |
...
| Parâmetro | Tipo | Descrição |
| :- | :- | :- |
| worksheet_name | **str** | Nome da planilha. |
| row | **int** | A linha. |
| column | **int** | A coluna. |
