...
description: 
type: docs
url: /pt/aspose.slides.charts/ichartdatapointcollection/add_data_point_for_area_series/
weight: 10
---
## add_data_point_for_area_series(self, value) {#ichartdatacell}
Cria o novo ponto de dados e o adiciona ao final da coleção.
Aplicável a séries cujo chartType é um dos subtipos Area (veja também o método ChartTypeCharacterizer.IsChartTypeArea(ChartType) method).
