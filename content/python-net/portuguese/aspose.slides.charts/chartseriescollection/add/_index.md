...
Cria nova série de gráfico a partir de [`ChartDataCell`](/slides/python-net/pt/aspose.slides.charts/chartdatacell) e a adiciona à coleção.
...
| type | [`ChartType`](/slides/python-net/pt/aspose.slides.charts/charttype) | Tipo define o tipo da série |
...
Cria nova série de gráfico a partir de [`ChartCellCollection`](/slides/python-net/pt/aspose.slides.charts/chartcellcollection) e a adiciona à coleção.
...
Cria nova série de gráfico a partir do valor e a adiciona à coleção.
...
* classe [`ChartSeriesCollection`](/slides/python-net/pt/aspose.slides.charts/chartseriescollection)
