...
| :- | :- |
| [`count`](/slides/python-net/pt/aspose.slides.animation/imotionpath/count/) | Retorna o número de caminhos na coleção.<br/>            Somente leitura **int**. |
...
| Nome | Descrição |
| :- | :- |
| [`[index]`](/slides/python-net/pt/aspose.slides.animation/imotionpath/__getitem__/) |  |
