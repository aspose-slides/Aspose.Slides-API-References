...
description: 
type: docs
url: /pt/aspose.slides.export/pdfoptions/slides_layout_options/
weight: 230
---
## slides_layout_options propriedade
Obtém ou define o modo como os slides são posicionados na página ao exportar uma apresentação [`ISlidesLayoutOptions`](/slides/python-net/pt/aspose.slides.export/islideslayoutoptions).
