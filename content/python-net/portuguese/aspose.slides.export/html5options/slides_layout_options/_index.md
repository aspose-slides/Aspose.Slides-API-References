...
description: 
type: docs
url: /pt/aspose.slides.export/html5options/slides_layout_options/
weight: 130
---
## slides_layout_options propriedade
Obtém ou define o modo em que os slides são posicionados na página ao exportar uma apresentação [`ISlidesLayoutOptions`](/slides/python-net/pt/aspose.slides.export/islideslayoutoptions).
