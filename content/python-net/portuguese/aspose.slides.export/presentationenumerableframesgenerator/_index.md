...
O tipo PresentationEnumerableFramesGenerator expõe os seguintes membros:
...
| :- | :- |
| [`frame_index`](/slides/python-net/pt/aspose.slides.export/presentationenumerableframesgenerator/frame_index/) | Obtém o índice do quadro. |
| [`default_delay`](/slides/python-net/pt/aspose.slides.export/presentationenumerableframesgenerator/default_delay/) | Obtém ou define o tempo de atraso padrão [ms]. |
| [`include_hidden_slides`](/slides/python-net/pt/aspose.slides.export/presentationenumerableframesgenerator/include_hidden_slides/) | Obtém ou define se os slides ocultos devem ser incluídos. |
| [`exported_slides`](/slides/python-net/pt/aspose.slides.export/presentationenumerableframesgenerator/exported_slides/) | Obtém o número de slides exportados. |
