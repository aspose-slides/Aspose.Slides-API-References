...
description: 
type: docs
url: /pt/aspose.slides.ink/inkactions/office_interop_shape_id/
weight: 310
---
## office_interop_shape_id propriedade
Retorna um identificador exclusivo no escopo do slide que permanece constante durante a vida útil da forma e
            permite que o PowerPoint ou o código de interoperação referencie a forma de forma confiável a partir de qualquer lugar no documento.
            Somente leitura **int**.
