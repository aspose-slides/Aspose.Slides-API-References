...
description: 
type: docs
url: /es/aspose.slides.mathtext/mathgroupingcharacterfactory/create_math_grouping_character/
weight: 20
---
...
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/es/aspose.slides.mathtext/imathelement) | elemento matemático al que aplicar el carácter de agrupación |
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/es/aspose.slides.mathtext/mathtopbotpositions) | justificación vertical |
...
* clase [`MathGroupingCharacterFactory`](/slides/python-net/es/aspose.slides.mathtext/mathgroupingcharacterfactory)
