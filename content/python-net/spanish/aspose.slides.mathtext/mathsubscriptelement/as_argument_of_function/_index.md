...
description: 
type: docs
url: /es/aspose.slides.mathtext/mathsubscriptelement/as_argument_of_function/
weight: 30
---
## as_argument_of_function(self, function_name) {#imathelement}
Utiliza la función especificada usando esta instancia como argumento
...
Utiliza la función especificada usando esta instancia como argumento y el argumento adicional especificado
