...
| :- | :- | :- |
| math_element | [`IMathElement`](/slides/python-net/es/aspose.slides.mathtext/imathelement) | El elemento que se va a unir |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| math_text | **str** | Texto matemático para unir |
