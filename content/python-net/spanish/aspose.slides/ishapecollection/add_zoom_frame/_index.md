...
description: 
type: docs
url: /es/aspose.slides/ishapecollection/add_zoom_frame/
weight: 170
---
...
| slide | [`ISlide`](/slides/python-net/es/aspose.slides/islide) | El [`ISlide`](/slides/python-net/es/aspose.slides/islide) referenciado por el Zoom frame;<br/><br/>            debe pertenecer a esta presentación. |
...
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Lanza si la diapositiva referenciada no pertenece a la presentación actual. |
