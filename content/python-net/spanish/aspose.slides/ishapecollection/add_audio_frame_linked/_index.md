...
description: 
type: docs
url: /es/aspose.slides/ishapecollection/add_audio_frame_linked/
weight: 30
---
## add_audio_frame_linked(self, x, y, width, height, fname) {#float-float-float-float-str}
Crea un nuevo marco de audio vinculado a un archivo de audio externo y lo añade al final de la colección de formas.
...
| fname | **str** | La ruta o el nombre del archivo de audio externo a vincular. |
