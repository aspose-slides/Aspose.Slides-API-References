...
description: 
type: docs
url: /es/aspose.slides/shapecollection/insert_picture_frame/
weight: 290
---
...
| image | [`IPPImage`](/slides/python-net/es/aspose.slides/ippimage) | El [`IPPImage`](/slides/python-net/es/aspose.slides/ippimage) a mostrar en el marco de imagen. |
