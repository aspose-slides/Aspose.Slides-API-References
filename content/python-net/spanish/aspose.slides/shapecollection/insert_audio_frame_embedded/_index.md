...
description: 
type: docs
url: /es/aspose.slides/shapecollection/insert_audio_frame_embedded/
weight: 210
---
...
| :- | :- | :- |
| index | **int** | El índice basado en cero en el que se inserta el marco de audio. |
...
| width | **float** | El ancho del nuevo marco de audio, en puntos. |
| height | **float** | La altura del nuevo marco de audio, en puntos. |
| audio | [`IAudio`](/slides/python-net/es/aspose.slides/iaudio) | Una instancia de [`IAudio`](/slides/python-net/es/aspose.slides/iaudio) de la colección Presentation.Audios para incrustar. |
