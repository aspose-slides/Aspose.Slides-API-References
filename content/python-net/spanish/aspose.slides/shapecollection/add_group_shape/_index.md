...
description: 
type: docs
url: /es/aspose.slides/shapecollection/add_group_shape/
weight: 80
---
...
Crea una nueva forma de grupo, convierte la imagen SVG especificada en formas individuales,
            y agrega el grupo resultante al final de la colección de formas.
