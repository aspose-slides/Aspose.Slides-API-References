...
description: 
type: docs
url: /es/aspose.slides/shapecollection/insert_summary_zoom_frame/
weight: 310
---
...
| :- | :- | :- |
| index | **int** | El índice basado en cero en el que se inserta el marco Summary Zoom. |
...
| :- | :- |
| [`PptxEditException`](/slides/python-net/es/aspose.slides/pptxeditexception) | Se lanza si la presentación no contiene secciones, o si la diapositiva objetivo no pertenece a ninguna sección. |
