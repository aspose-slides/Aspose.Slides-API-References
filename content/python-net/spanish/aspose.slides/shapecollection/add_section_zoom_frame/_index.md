...
description: 
type: docs
url: /es/aspose.slides/shapecollection/add_section_zoom_frame/
weight: 120
---
...
| section | [`ISection`](/slides/python-net/es/aspose.slides/isection) | El [`ISection`](/slides/python-net/es/aspose.slides/isection) referenciado por el Section Zoom frame; <br/><br/>            debe pertenecer a esta presentación y contener al menos una diapositiva. |
...
Crea un nuevo marco Section Zoom con una imagen predefinida y lo agrega al final de la colección de formas.
...
| height | **float** | La altura del nuevo marco Section Zoom, en puntos. |
| section | [`ISection`](/slides/python-net/es/aspose.slides/isection) | El [`ISection`](/slides/python-net/es/aspose.slides/isection) referenciado por el Section Zoom frame; <br/><br/>            debe pertenecer a esta presentación y contener al menos una diapositiva. |
| image | [`IPPImage`](/slides/python-net/es/aspose.slides/ippimage) | El [`IPPImage`](/slides/python-net/es/aspose.slides/ippimage) a mostrar dentro del Section Zoom frame. |
