...
description: 
type: docs
url: /es/aspose.slides/shapecollection/insert_zoom_frame/
weight: 340
---
...
| :- | :- | :- |
| index | **int** | El índice basado en cero en el que se inserta el marco de Zoom. |
...
| slide | [`ISlide`](/slides/python-net/es/aspose.slides/islide) | El [`ISlide`](/slides/python-net/es/aspose.slides/islide) referenciado por el marco de Zoom. |
