...
description: 
type: docs
url: /es/aspose.slides/shapecollection/add_chart/
weight: 50
---
...
| width | **float** | El ancho del gráfico, en puntos. |
| height | **float** | La altura del gráfico, en puntos. |
| init_with_sample | **bool** | True para inicializar el nuevo gráfico con datos y configuraciones de serie de muestra; <br/><br/>false para crear el gráfico sin series y solo con configuraciones mínimas, lo que hace que la creación sea más rápida. |
