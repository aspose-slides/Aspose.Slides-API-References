...
El tipo IPatternFormat expone los siguientes miembros:
...
| [`back_color`](/slides/python-net/es/aspose.slides/ipatternformat/back_color/) | Devuelve el color del patrón de fondo.<br/>            Solo lectura [`IColorFormat`](/slides/python-net/es/aspose.slides/icolorformat). |
