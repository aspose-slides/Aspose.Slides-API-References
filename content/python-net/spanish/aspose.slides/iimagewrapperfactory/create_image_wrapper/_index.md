...
description: 
type: docs
url: /es/aspose.slides/iimagewrapperfactory/create_image_wrapper/
weight: 10
---
...
### Devuelve
Nueva instancia de un [`IImageWrapper`](/slides/python-net/es/aspose.slides/iimagewrapper)
...
| :- | :- | :- |
| image | [`IImage`](/slides/python-net/es/aspose.slides/iimage) | Imagen existente **aspose.slides.Image** |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| stream | **io.RawIOBase** | Flujo de datos **io.RawIOBase** |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| file_name | **str** | Nombre de archivo **str** |


### Véase también
* clase [`IImage`](/slides/python-net/es/aspose.slides/iimage)
* clase [`IImageWrapper`](/slides/python-net/es/aspose.slides/iimagewrapper)
* clase [`IImageWrapperFactory`](/slides/python-net/es/aspose.slides/iimagewrapperfactory)
