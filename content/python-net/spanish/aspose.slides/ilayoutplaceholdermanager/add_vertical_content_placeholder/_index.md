...
description: 
type: docs
url: /es/aspose.slides/ilayoutplaceholdermanager/add_vertical_content_placeholder/
weight: 90
---
...
### Retorna
Creado [`IAutoShape`](/slides/python-net/es/aspose.slides/iautoshape) con un marcador de contenido (Vertical).
