...
Una imagen que contiene el párrafo renderizado, o **None** si el párrafo no se puede encontrar en su colección padre, no tiene límites de renderizado válidos, o ocurre un error al renderizar la imagen.
