...
| :- | :- |
| [`slide_image_size`](/slides/python-net/es/aspose.slides.export/ihtmlgenerator/slide_image_size/) | Devuelve el tamaño de la imagen de la diapositiva.<br/>            Solo lectura **aspose.slides.SizeF**. |
| [`slide_image_size_unit`](/slides/python-net/es/aspose.slides.export/ihtmlgenerator/slide_image_size_unit/) | Devuelve una unidad en la que se especifica el tamaño de la imagen de la diapositiva.<br/>            Solo lectura [`SvgCoordinateUnit`](/slides/python-net/es/aspose.slides.export/svgcoordinateunit). |
...
| Método | Descripción |
| :- | :- |
| [`add_html(self, html)`](/slides/python-net/es/aspose.slides.export/ihtmlgenerator/add_html/#str) | Agrega texto HTML con formato. |
| [`add_html(self, html)`](/slides/python-net/es/aspose.slides.export/ihtmlgenerator/add_html/#listchar) | Agrega texto HTML con formato. |
| [`add_html(self, html, start_index, length)`](/slides/python-net/es/aspose.slides.export/ihtmlgenerator/add_html/#listchar-int-int) | Agrega texto HTML con formato. |
...
| [`add_attribute_value(self, value)`](/slides/python-net/es/aspose.slides.export/ihtmlgenerator/add_attribute_value/#str) | Cita el valor del atributo y lo agrega al archivo HTML. |
| [`add_attribute_value(self, value)`](/slides/python-net/es/aspose.slides.export/ihtmlgenerator/add_attribute_value/#listchar) | Cita el valor del atributo y lo agrega al archivo HTML. |
| [`add_attribute_value(self, value, start_index, length)`](/slides/python-net/es/aspose.slides.export/ihtmlgenerator/add_attribute_value/#listchar-int-int) | Cita el valor del atributo y lo agrega al archivo HTML. |
