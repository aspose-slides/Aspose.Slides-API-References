...
description: 
type: docs
url: /es/aspose.slides.export/ihtmlgenerator/add_text/
weight: 30
---
## add_text(self, text) {#str}
Añade texto sin formato a los archivos html, reemplazando caracteres especiales con entidades html.
            Los saltos de línea y los espacios en blanco no se reemplazan.
...
| :- | :- | :- |
| text | **List[char]** | Texto a añadir. |
| start_index | **int** | Índice de inicio de la porción a añadir. |
