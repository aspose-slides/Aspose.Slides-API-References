...
---
## por propiedad
Describe el valor de desplazamiento relativo para la animación (en porcentajes).
...
### Ver también
* clase [`IMotionEffect`](/slides/python-net/es/aspose.slides.animation/imotioneffect)
