---
title: extrusion_orientation_z property
second_title: Referencia de API de Aspose.Slides para Python vía .NET
description: 
type: docs
url: /es/aspose.slides.animation/behaviorproperty/extrusion_orientation_z/
weight: 120
---
## extrusion_orientation_z propiedad
Representa la propiedad 'extrusion.orientation.z'

### Definición:
```python
@property
def extrusion_orientation_z(self):
    ...
```
