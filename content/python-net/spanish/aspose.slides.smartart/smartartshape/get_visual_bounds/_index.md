...
description: 
type: docs
url: /es/aspose.slides.smartart/smartartshape/get_visual_bounds/
weight: 60
---
...
Los límites visuales tienen en cuenta aspectos relacionados con el renderizado como transformaciones (por ejemplo, rotación), ancho y uniones de trazos, disposición del texto y desbordamiento, geometría de SmartArt y otros efectos de diseño que influyen en la apariencia final renderizada de la forma.
