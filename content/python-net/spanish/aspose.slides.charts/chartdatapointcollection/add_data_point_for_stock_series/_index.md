...
description: 
type: docs
url: /es/aspose.slides.charts/chartdatapointcollection/add_data_point_for_stock_series/
weight: 130
---
## add_data_point_for_stock_series(self, value) {#ichartdatacell}
Crea el nuevo punto de datos y lo añade al final de la colección.
            Aplicable a series cuyo chartType es uno de los subtipos de Stock
...
| :- | :- | :- |
| value | [`IChartDataCell`](/slides/python-net/es/aspose.slides.charts/ichartdatacell) | Valor del punto de datos. |
...
| Parámetro | Tipo | Descripción |
| :- | :- | :- |
| value | **float** | Valor del punto de datos. |
