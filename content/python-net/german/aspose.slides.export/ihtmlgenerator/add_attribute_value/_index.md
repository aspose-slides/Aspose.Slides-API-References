...
description: 
type: docs
url: /de/aspose.slides.export/ihtmlgenerator/add_attribute_value/
weight: 10
---
...
| :- | :- | :- |
| value | **str** | String des Attributwerts. |
...
| Parameter | Typ | Beschreibung |
| :- | :- | :- |
| value | **List[char]** | String des Attributwerts. |
...
| :- | :- | :- |
| value | **List[char]** | String des Attributwerts. |
| start_index | **int** | Startindex des hinzuzufügenden Abschnitts. |
