...
| :- | :- |
| [`count`](/slides/python-net/de/aspose.slides.animation/imotionpath/count/) | Gibt die Anzahl der Pfade in der Sammlung zurück.<br/>            Nur-Lesen **int**. |
...
| Name | Beschreibung |
| :- | :- |
| [`[index]`](/slides/python-net/de/aspose.slides.animation/imotionpath/__getitem__/) |  |
