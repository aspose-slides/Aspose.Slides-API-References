...
description: 
type: docs
url: /de/aspose.slides.animation/itextanimation/add_effect/
weight: 10
---
## add_effect(self, effect_type, subtype, trigger_type) {#effecttype-effectsubtype-effecttriggertype}
Fügt einen neuen Effekt am Ende der aktuellen Sequenz zum Ende der Textanimationen der Gruppe hinzu.
            Nur gültig, wenn die Anzahl der Textabsätze gleich oder größer ist als die Anzahl der Effekte dieser Gruppe!
...
| trigger_type | [`EffectTriggerType`](/slides/python-net/de/aspose.slides.animation/effecttriggertype) | Auslösetyp des Effekts [`EffectTriggerType`](/slides/python-net/de/aspose.slides.animation/effecttriggertype) |
...
* Klasse [`ITextAnimation`](/slides/python-net/de/aspose.slides.animation/itextanimation)
