...
description: 
type: docs
url: /de/aspose.slides.smartart/smartartshape/get_base_placeholder/
weight: 30
---
## get_base_placeholder(self) {#}
Gibt eine grundlegende Platzhalterform zurück (Form aus dem Layout und/oder der Masterfolie, von der die aktuelle Form ererbt wird).
            Ein None wird zurückgegeben, wenn die aktuelle Form nicht geerbt wird.
