...
description: 
type: docs
url: /de/aspose.slides/globallayoutslidecollection/get_by_type/
weight: 30
---
## get_by_type(self, type) {#slidelayouttype}
Gibt die erste Layout-Folie vom angegebenen Typ zurück.
            Ein Typ der Layout-Folien, der gefunden werden soll.[`LayoutSlide`](/slides/python-net/de/aspose.slides/layoutslide) mit angegebenem Typ oder None, wenn keine Layouts gefunden wurden.
