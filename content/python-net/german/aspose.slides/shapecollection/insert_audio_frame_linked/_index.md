...
description: 
type: docs
url: /de/aspose.slides/shapecollection/insert_audio_frame_linked/
weight: 220
---
## insert_audio_frame_linked(self, index, x, y, width, height, fname) {#int-float-float-float-float-str}
Erstellt einen neuen Audio-Frame, der mit einer externen Audiodatei verknüpft ist, und fügt ihn in die Form-Sammlung an der angegebenen Position ein.
...
| fname | **str** | Der Pfad oder Name der externen Audiodatei, die verknüpft werden soll. |
