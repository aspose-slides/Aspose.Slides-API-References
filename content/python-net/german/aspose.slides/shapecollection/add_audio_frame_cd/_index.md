---
title: add_audio_frame_cd method
second_title: Aspose.Slides für Python über .NET API-Referenz
description: 
type: docs
url: /de/aspose.slides/shapecollection/add_audio_frame_cd/
weight: 10
---
## add_audio_frame_cd(self, x, y, width, height) {#float-float-float-float}
Erstellt einen neuen Audio-Frame, der mit einer CD-Spur verknüpft ist, und fügt ihn am Ende der Formensammlung hinzu.
