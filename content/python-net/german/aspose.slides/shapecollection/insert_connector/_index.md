...
description: 
type: docs
url: /de/aspose.slides/shapecollection/insert_connector/
weight: 260
---
## insert_connector(self, index, shape_type, x, y, width, height) {#int-shapetype-float-float-float-float}
Erstellt eine neue Connector-Form und fügt sie an der angegebenen Position in die Formensammlung ein,
            wobei die Standard-Vorlagenformatierung angewendet wird.
...
| :- | :- | :- |
| index | **int** | Der nullbasierte Index, an dem die Connector-Form eingefügt werden soll. |
...
Erstellt eine neue Connector-Form und fügt sie an der angegebenen Position in die Formensammlung ein,
            wobei optional die Standard-Vorlagenformatierung angewendet wird.
...
| width | **float** | Die Breite des Rahmens der Connector-Form in Punkten. |
| height | **float** | Die Höhe des Rahmens der Connector-Form in Punkten. |
| create_from_template | **bool** | True, um die Standard-Vorlagenformatierung anzuwenden (nicht leerer Name, einfacher Stil);<br/><br/>            false, um die Connector-Form mit den Standard-Eigenschaftswerten zu erstellen. |
