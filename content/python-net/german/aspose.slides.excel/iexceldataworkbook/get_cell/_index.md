...
description: 
type: docs
url: /de/aspose.slides.excel/iexceldataworkbook/get_cell/
weight: 10
---
## get_cell(self, worksheet_index, cell_name) {#int-str}
Ruft eine Zelle aus dem angegebenen Arbeitsblatt anhand ihres Index und ihres Excel-ähnlichen Zellnamens (z.B. "B2") ab.
...
| cell_name | **str** | Die Excel-ähnliche Zellreferenz (z.B. "A1", "C5"). |


## get_cell(self, worksheet_name, cell_name) {#str-str}
Ruft eine Zelle aus dem angegebenen Arbeitsblatt anhand ihres Excel-ähnlichen Zellnamens (z.B. "B2") ab.
