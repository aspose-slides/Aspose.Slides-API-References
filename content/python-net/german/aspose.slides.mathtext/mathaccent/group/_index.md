...
description: 
type: docs
url: /de/aspose.slides.mathtext/mathaccent/group/
weight: 80
---
## group(self) {#}
...
Platziert dieses Element in einer Gruppe, indem ein Gruppierungszeichen wie die untere geschweifte Klammer oder ein anderes verwendet wird
