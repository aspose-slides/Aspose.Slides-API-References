...
description: 
type: docs
url: /de/aspose.slides.mathtext/mathbar/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Border-Box Durchgestrichen horizontal |
| strikethrough_vertical | **bool** | Border-Box Durchgestrichen vertikal |
| strikethrough_bottom_left_to_top_right | **bool** | Border-Box Durchgestrichen von unten links nach oben rechts |
| strikethrough_top_left_to_bottom_right | **bool** | Border-Box Durchgestrichen von oben links nach unten rechts |
