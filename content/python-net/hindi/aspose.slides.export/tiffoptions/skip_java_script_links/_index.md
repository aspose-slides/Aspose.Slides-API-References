...
description: 
type: docs
url: /hi/aspose.slides.export/tiffoptions/skip_java_script_links/
weight: 140
---
## skip_java_script_links प्रॉपर्टी
निर्धारित करता है कि प्रस्तुति को सहेजते समय JavaScript कॉल वाले हाइपरलिंक को छोड़ना है या नहीं। 
            पढ़ने/लिखने योग्य **bool**. डिफ़ॉल्ट मान **false** है। 


### टिप्पणियाँ

जब इस प्रॉपर्टी को **true** पर सेट किया जाता है, तो JavaScript कॉल वाले हाइपरलिंक को सहेजते समय नजरअंदाज़ किया जाएगा।
