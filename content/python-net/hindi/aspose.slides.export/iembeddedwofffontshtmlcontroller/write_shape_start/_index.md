...
description: 
type: docs
url: /hi/aspose.slides.export/iembeddedwofffontshtmlcontroller/write_shape_start/
weight: 40
---
...
| shape | [`IShape`](/slides/python-net/hi/aspose.slides/ishape) |  |



### संबंधित देखें
* क्लास [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/hi/aspose.slides.export/iembeddedwofffontshtmlcontroller)
