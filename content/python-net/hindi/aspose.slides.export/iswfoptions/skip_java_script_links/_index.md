...
description: 
type: docs
url: /hi/aspose.slides.export/iswfoptions/skip_java_script_links/
weight: 180
---
## skip_java_script_links गुण
### परिभाषा:
```python
@property
...
### संबंधित देखें
* वर्ग [`ISwfOptions`](/slides/python-net/hi/aspose.slides.export/iswfoptions)
