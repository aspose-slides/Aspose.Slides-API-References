...
description: 
type: docs
url: /hi/aspose.slides.mathtext/mathleftsubsuperscriptelement/join/
weight: 100
---
...
यह इंस्टेंस और निर्दिष्ट तर्क को सम्मिलित करता हुआ एक नया IMathBlock
...
| :- | :- | :- |
| math_element | [`IMathElement`](/slides/python-net/hi/aspose.slides.mathtext/imathelement) | जोड़ने के लिए तत्व |
...
| पैरामीटर | प्रकार | विवरण |
| :- | :- | :- |
| math_text | **str** | जोड़ने के लिए गणितीय पाठ |
