...
| :- | :- | :- |
| type | [`MotionCommandPathType`](/slides/python-net/hi/aspose.slides.animation/motioncommandpathtype) |  |
| pts | **List[aspose.slides.PointF]** |  |
| pts_type | [`MotionPathPointsType`](/slides/python-net/hi/aspose.slides.animation/motionpathpointstype) |  |
| b_relative_coord | **bool** |  |



### संबंधित देखें
* क्लास [`IMotionCmdPath`](/slides/python-net/hi/aspose.slides.animation/imotioncmdpath)
