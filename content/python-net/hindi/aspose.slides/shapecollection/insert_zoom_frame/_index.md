...
description: 
type: docs
url: /hi/aspose.slides/shapecollection/insert_zoom_frame/
weight: 340
---
## insert_zoom_frame(self, index, x, y, width, height, slide) {#int-float-float-float-float-islide}
एक नया Zoom फ्रेम बनाता है और उसे निर्दिष्ट इंडेक्स पर shape collection में सम्मिलित करता है।

### रिटर्न मान

नव निर्मित [`IZoomFrame`](/slides/python-net/hi/aspose.slides/izoomframe)।
...
| पैरामीटर | टाइप | विवरण |
| :- | :- | :- |
| index | **int** | Zoom फ्रेम को सम्मिलित करने के लिए शून्य-आधारित इंडेक्स। |
...
| अपवाद | विवरण |
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | यदि संदर्भित स्लाइड वर्तमान प्रस्तुतिकरण का हिस्सा नहीं है तो थ्रो किया जाता है। |

## insert_zoom_frame(self, index, x, y, width, height, slide, image) {#int-float-float-float-float-islide-ippimage}
एक पूर्वनिर्धारित छवि के साथ नया Zoom फ्रेम बनाता है और उसे निर्दिष्ट इंडेक्स पर shape collection में सम्मिलित करता है।
