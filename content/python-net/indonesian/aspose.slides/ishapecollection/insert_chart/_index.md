...
description: 
type: docs
url: /id/aspose.slides/ishapecollection/insert_chart/
weight: 240
---
## insert_chart(self, type, x, y, width, height, index) {#asposeslideschartscharttype-float-float-float-float-int}
Membuat grafik baru, menginisialisasinya dengan data seri contoh dan pengaturan,
            dan memasukkannya ke dalam koleksi shape pada indeks yang ditentukan.
...
| index | **int** | Indeks berbasis nol tempat grafik baru akan disisipkan dalam koleksi shape. |
...
| height | **float** | Tinggi grafik baru, dalam poin. |
| index | **int** | Indeks berbasis nol tempat grafik baru akan disisipkan dalam koleksi shape. |
| init_with_sample | **bool** | True untuk menginisialisasi grafik baru dengan data seri contoh dan pengaturan; false untuk membuat grafik tanpa seri dan hanya pengaturan minimal, yang membuat pembuatan lebih cepat. |
