...
description: 
type: docs
url: /id/aspose.slides/sectionzoomframe/get_visual_bounds/
weight: 40
---
## get_visual_bounds(self) {#}
Mengambil batas visual dari shape yang dihitung dari konten yang direndernya.

### Pengembalian

A [`RectangleF`](/slides/python-net/id/aspose.slides/rectanglef) yang mewakili batas visual dari shape
...
Rectangle yang dikembalikan mewakili batas sejajar sumbu dari semua konten
             ...
             dan mungkin berisi koordinat negatif bila konten yang dirender melampaui
             asal slide.
