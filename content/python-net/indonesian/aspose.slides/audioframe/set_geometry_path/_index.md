...
description: 
type: docs
url: /id/aspose.slides/audioframe/set_geometry_path/
weight: 80
---
## set_geometry_path(self, geometry_path) {#igeometrypath}
Memperbarui geometri bentuk dari [`IGeometryPath`](/slides/python-net/id/aspose.slides/igeometrypath) objek. Koordinat harus relatif terhadap sudut kiri atas bentuk. Mengubah tipe bentuk ([`GeometryShape.shape_type`](/slides/python-net/id/aspose.slides/geometryshape/shape_type)) menjadi [`ShapeType.CUSTOM`](/slides/python-net/id/aspose.slides/shapetype/CUSTOM).
