...
description: 
type: docs
url: /id/aspose.slides/shapecollection/to_array/
weight: 380
---
## to_array(self) {#}
...
Sebuah array dari objek [`IShape`](/slides/python-net/id/aspose.slides/ishape).
...
| :- | :- | :- |
| start_index | **int** | Indeks bentuk pertama yang akan dikembalikan. |
| count | **int** | Jumlah bentuk yang akan dikembalikan. |
