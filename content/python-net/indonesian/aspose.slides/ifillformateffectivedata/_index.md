...
| [`picture_fill_format`](/slides/python-net/id/aspose.slides/ifillformateffectivedata/picture_fill_format/) | Mengembalikan format isian gambar.<br/>            Baca-saja [`IPictureFillFormatEffectiveData`](/slides/python-net/id/aspose.slides/ipicturefillformateffectivedata). |
| [`rotate_with_shape`](/slides/python-net/id/aspose.slides/ifillformateffectivedata/rotate_with_shape/) | Menentukan apakah isian harus diputar bersama bentuk.<br/>            Baca-saja **bool**. |

### Catatan

Antarmuka ini digunakan bersama dengan antarmuka [`IFillFormat`](/slides/python-net/id/aspose.slides/ifillformat) untuk mengembalikan nilai pemformatan efektif dengan pewarisan yang diterapkan.
