...
description: 
type: docs
url: /id/aspose.slides/ipresentation/replace_text/
weight: 70
---
...
| :- | :- | :- |
| old_text | **str** | String yang akan diganti. |
| new_text | **str** | String untuk mengganti semua kemunculan oldText. |
...
### Lihat Juga
* kelas [`IFindResultCallback`](/slides/python-net/id/aspose.slides/ifindresultcallback)
