...
description: 
type: docs
url: /id/aspose.slides/textframe/highlight_regex/
weight: 10
---
...
| :- | :- | :- |
| regex | **str** | String berisi ekspresi reguler untuk mendapatkan string yang akan diwarnai. |
...
| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| regex | **str** | Teks ekspresi reguler untuk mendapatkan teks yang akan diwarnai. |
| highlight_color | **aspose.slides.Color** | Warna untuk menyorot teks. |
