...
description: 
type: docs
url: /id/aspose.slides.mathtext/mathborderbox/to_border_box/
weight: 200
---
## to_border_box(self) {#}
Menempatkan elemen ini di dalam border-box
...
| strikethrough_horizontal | **bool** | Garis Coret Horizontal pada Border Box |
| strikethrough_vertical | **bool** | Garis Coret Vertikal pada Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | Garis Coret Bottom-Left ke Top-Right pada Border Box |
| strikethrough_top_left_to_bottom_right | **bool** | Garis Coret Top-Left ke Bottom-Right pada Border Box |
