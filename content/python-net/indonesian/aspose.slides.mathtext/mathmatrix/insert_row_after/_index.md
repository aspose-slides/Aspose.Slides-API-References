...
description: 
type: docs
url: /id/aspose.slides.mathtext/mathmatrix/insert_row_after/
weight: 140
---
## insert_row_after(self, row_index) {#int}
Masukkan baris baru setelah yang ditentukan
            Awalnya semua elemen di baris baru adalah None.
...
| :- | :- | :- |
| row_index | **int** | Indeks baris setelahnya untuk menyisipkan baris baru |
