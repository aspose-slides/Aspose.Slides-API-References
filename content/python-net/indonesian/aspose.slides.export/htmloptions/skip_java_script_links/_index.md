...
description: 
type: docs
url: /id/aspose.slides.export/htmloptions/skip_java_script_links/
weight: 130
---
## skip_java_script_links properti
Menentukan apakah akan melewatkan hyperlink dengan panggilan JavaScript saat menyimpan presentasi. 
            Baca/tulis **bool**. Nilai default adalah **false** .


### Catatan

Ketika properti ini diatur ke **true**, hyperlink dengan panggilan JavaScript akan diabaikan saat penyimpanan.
