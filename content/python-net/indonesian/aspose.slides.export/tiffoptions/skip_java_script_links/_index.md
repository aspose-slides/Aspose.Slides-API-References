...
description: 
type: docs
url: /id/aspose.slides.export/tiffoptions/skip_java_script_links/
weight: 140
---
## skip_java_script_links properti
Menentukan apakah akan melewatkan hyperlink dengan pemanggilan JavaScript saat menyimpan presentasi. 
            Baca/tulis **bool**. Nilai defaultnya adalah **false** .
