...
description: 
type: docs
url: /id/aspose.slides.export/ihtmlgenerator/add_attribute_value/
weight: 10
---
...
| :- | :- | :- |
| value | **str** | String nilai atribut. |
...
| Parameter | Tipe | Deskripsi |
| :- | :- | :- |
| value | **List[char]** | String nilai atribut. |
...
| :- | :- | :- |
| value | **List[char]** | String nilai atribut. |
| start_index | **int** | Indeks mulai dari bagian yang akan ditambahkan. |
