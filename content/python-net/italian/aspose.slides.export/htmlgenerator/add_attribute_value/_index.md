---
title: add_attribute_value method
second_title: Aspose.Slides per Python via .NET Riferimento API
description: 
type: docs
url: /it/aspose.slides.export/htmlgenerator/add_attribute_value/
weight: 10
---
## add_attribute_value(self, value) {#str}
Racchiude il valore dell'attributo e lo aggiunge al file html.
...
| :- | :- | :- |
| value | **str** | Stringa del valore dell'attributo. |
...
| Parameter | Type | Description |
| :- | :- | :- |
| value | **List[char]** | Stringa del valore dell'attributo. |
...
| :- | :- | :- |
| value | **List[char]** | Stringa del valore dell'attributo. |
| start_index | **int** | Indice di inizio della porzione da aggiungere. |
