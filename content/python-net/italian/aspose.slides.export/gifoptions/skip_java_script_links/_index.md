...
description: 
type: docs
url: /it/aspose.slides.export/gifoptions/skip_java_script_links/
weight: 90
---
## skip_java_script_links proprietà
Specifica se ignorare i collegamenti ipertestuali con chiamate JavaScript durante il salvataggio della presentazione. 
            Lettura/Scrittura **bool**. Il valore predefinito è **false** .
