...
description: 
type: docs
url: /it/aspose.slides.charts/idatalabelformat/show_bubble_size/
weight: 120
---
...
Rappresenta il comportamento di visualizzazione del valore della dimensione della bolla dell'etichetta dati di un grafico specificato. 
            True visualizza il valore della dimensione della bolla. False lo nasconde.
...
Se il genitore di questo oggetto DataLabelFormat è una raccolta DataLabelCollection di etichette dati, allora questa proprietà ottiene o imposta il valore predefinito della proprietà ShowBubbleSize per le nuove etichette dati nella raccolta DataLabelCollection.
            Impostare questa proprietà con un valore imposta anche tale valore nella proprietà ShowBubbleSize per tutte le etichette dati nella raccolta DataLabelCollection
            (ad es. "DataLabels.DefaultDataLabelFormat.ShowBubbleSize = val;" causa che 
            tutti i DataLabels[i].ShowBubbleSize siano uguali a val).
