...
Il rettangolo restituito rappresenta i limiti allineati agli assi di tutto il contenuto prodotto dalla forma durante il rendering nello spazio delle coordinate della diapositiva.
             ...
             I limiti visivi tengono conto degli aspetti relativi al rendering come le trasformazioni (ad esempio, rotazione), lo spessore e le giunzioni del tratto, il layout del testo e il traboccamento, la geometria di SmartArt e altri effetti di layout che influenzano l'aspetto finale renderizzato della forma.
