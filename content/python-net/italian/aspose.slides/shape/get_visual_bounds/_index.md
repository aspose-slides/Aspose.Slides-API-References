...
description: 
type: docs
url: /it/aspose.slides/shape/get_visual_bounds/
weight: 40
---
## get_visual_bounds(self) {#}
Ottiene i limiti visuali della forma calcolati dal suo contenuto renderizzato.

### Restituisce

Un [`RectangleF`](/slides/python-net/it/aspose.slides/rectanglef) che rappresenta i limiti visuali della forma nelle coordinate della diapositiva.
...
I limiti visuali tengono conto degli aspetti legati al rendering, come le trasformazioni (ad esempio, la rotazione), la larghezza e le giunzioni del tratto, il layout e il trabocco del testo, la geometria di SmartArt e altri effetti di layout che influenzano l'aspetto finale renderizzato della forma.
