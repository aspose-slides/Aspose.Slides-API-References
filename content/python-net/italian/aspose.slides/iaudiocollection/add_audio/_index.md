...
description: 
type: docs
url: /it/aspose.slides/iaudiocollection/add_audio/
weight: 10
---
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| stream | **io.RawIOBase** | Flusso da cui aggiungere l'audio. |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| stream | **io.RawIOBase** | Flusso da cui aggiungere l'audio video. |
...
* classe [`IAudioCollection`](/slides/python-net/it/aspose.slides/iaudiocollection)
