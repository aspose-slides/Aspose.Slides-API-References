...
description: 
type: docs
url: /it/aspose.slides/summaryzoomsection/get_image/
weight: 30
---
## get_image(self) {#}
Restituisce la miniatura della forma.  
Il tipo di delimitazione della miniatura di forma ShapeThumbnailBounds.Shape è usato per impostazione predefinita.
