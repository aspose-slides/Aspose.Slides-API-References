---
title: audio_cd_start_track property
second_title: Riferimento API Aspose.Slides per Python via .NET
description: 
type: docs
url: /it/aspose.slides/iaudioframe/audio_cd_start_track/
weight: 210
---
## audio_cd_start_track proprietà
Restituisce o imposta un indice di traccia iniziale.
