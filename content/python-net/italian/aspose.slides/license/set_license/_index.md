...
description: 
type: docs
url: /it/aspose.slides/license/set_license/
weight: 40
---
...
| :- | :- | :- |
| license_name | **str** | Può essere un nome file completo o abbreviato o il nome di una risorsa incorporata.<br/><br/>            Usa una stringa vuota per passare alla modalità di valutazione. |

### Osservazioni

Cerca la licenza nei seguenti percorsi:
...
**Nota:** Su .NET Compact Framework, cerca la licenza solo in questi percorsi:
...
### Vedi anche
* classe [`License`](/slides/python-net/it/aspose.slides/license)
