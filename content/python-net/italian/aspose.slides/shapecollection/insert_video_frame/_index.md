---
title: insert_video_frame method
second_title: Riferimento API di Aspose.Slides per Python via .NET
description: 
type: docs
url: /it/aspose.slides/shapecollection/insert_video_frame/
weight: 330
---
...
Il [`IVideoFrame`](/slides/python-net/it/aspose.slides/ivideoframe) appena creato.
...
| :- | :- | :- |
| index | **int** | L'indice basato su zero al quale inserire il fotogramma video. |
...
| fname | **str** | Il percorso o il nome del file video da incorporare. |
