...
description: 
type: docs
url: /it/aspose.slides/ishapecollection/insert_connector/
weight: 260
---
## insert_connector(self, index, shape_type, x, y, width, height) {#int-shapetype-float-float-float-float}
Crea una nuova forma di connettore e la inserisce nella collezione di forme all'indice specificato,
            applicando lo stile predefinito del modello.

### Restituisce

L'[`IConnector`](/slides/python-net/it/aspose.slides/iconnector) appena creata.
...
| :- | :- | :- |
| index | **int** | L'indice basato su zero al quale inserire la forma di connettore. |
| shape_type | [`ShapeType`](/slides/python-net/it/aspose.slides/shapetype) | Il [`ShapeType`](/slides/python-net/it/aspose.slides/shapetype) della forma di connettore da inserire. |
...
Crea una nuova forma di connettore e la inserisce nella collezione di forme all'indice specificato,
            applicando opzionalmente lo stile predefinito del modello.
