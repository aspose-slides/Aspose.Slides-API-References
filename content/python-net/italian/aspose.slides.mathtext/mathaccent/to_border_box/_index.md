...
description: 
type: docs
url: /it/aspose.slides.mathtext/mathaccent/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Barriera obliqua orizzontale del Border Box |
| strikethrough_vertical | **bool** | Barriera obliqua verticale del Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | Barriera obliqua dal basso a sinistra al superiore a destra del Border Box |
| strikethrough_top_left_to_bottom_right | **bool** | Barriera obliqua dall'alto a sinistra al basso a destra del Border Box |
