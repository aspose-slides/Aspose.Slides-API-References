...
description: 
type: docs
url: /it/aspose.slides.mathtext/mathfunction/enclose/
weight: 50
---
## enclose(self) {#}
...
| :- | :- | :- |
| beginning_character | **char** | Carattere di inizio (solitamente parentesi sinistra) |
| ending_character | **char** | Carattere di fine (solitamente parentesi destra) |
