---
title: create_math_accent method
second_title: Riferimento API di Aspose.Slides per Python tramite .NET
description: 
type: docs
url: /it/aspose.slides.mathtext/mathaccentfactory/create_math_accent/
weight: 20
---
...
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/it/aspose.slides.mathtext/imathelement) | elemento matematico a cui applicare l'accento |
...
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/it/aspose.slides.mathtext/imathelement) | elemento matematico a cui applicare l'accento |
| accent_character | **char** | carattere di accento |
...
* classe [`MathAccentFactory`](/slides/python-net/it/aspose.slides.mathtext/mathaccentfactory)
