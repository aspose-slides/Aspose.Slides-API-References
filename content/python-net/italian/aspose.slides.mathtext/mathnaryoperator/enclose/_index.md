...
description: 
type: docs
url: /it/aspose.slides.mathtext/mathnaryoperator/enclose/
weight: 50
---
## enclose(self) {#}
...
Racchiude un elemento matematico nei caratteri specificati, come le parentesi o altri caratteri di inquadramento

### Restituisce

L'elemento matematico di tipo [`IMathDelimiter`](/slides/python-net/it/aspose.slides.mathtext/imathdelimiter) che include i caratteri specificati come inquadramento
