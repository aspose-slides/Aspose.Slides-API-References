...
description: 
type: docs
url: /it/aspose.slides.mathtext/mathmatrix/to_border_box/
weight: 290
---
## to_border_box(self) {#}
...
Border-box con questo elemento inserito al suo interno
...
| :- | :- | :- |
| hide_top | **bool** | Nascondi bordo superiore |
| hide_bottom | **bool** | Nascondi bordo inferiore |
| hide_left | **bool** | Nascondi bordo sinistro |
| hide_right | **bool** | Nascondi bordo destro |
| strikethrough_horizontal | **bool** | Barriera di attraversamento orizzontale del Border Box |
| strikethrough_vertical | **bool** | Barriera di attraversamento verticale del Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | Barriera di attraversamento dal basso a sinistra al alto a destra del Border Box |
| strikethrough_top_left_to_bottom_right | **bool** | Barriera di attraversamento dal alto a sinistra al basso a destra del Border Box |
