...
description: 
type: docs
url: /it/aspose.slides.mathtext/mathphantom/group/
weight: 80
---
## group(self) {#}
...
Nuova istanza di tipo [`IMathGroupingCharacter`](/slides/python-net/it/aspose.slides.mathtext/imathgroupingcharacter)
