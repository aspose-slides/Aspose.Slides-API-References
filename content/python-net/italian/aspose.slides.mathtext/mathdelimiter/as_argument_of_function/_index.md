...
description: 
type: docs
url: /it/aspose.slides.mathtext/mathdelimiter/as_argument_of_function/
weight: 30
---
...
| additional_argument | [`IMathElement`](/slides/python-net/it/aspose.slides.mathtext/imathelement) | Argomento aggiuntivo in base al tipo di funzione |
...
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/it/aspose.slides.mathtext/mathfunctionsoftwoarguments) | Uno dei tipi di funzione comuni a due argomenti: Log, Lim, Min, Max |
| additional_argument | **str** | Argomento aggiuntivo in base al tipo di funzione |
