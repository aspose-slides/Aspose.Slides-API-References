...
description: 
type: docs
url: /it/aspose.slides.mathtext/mathlimit/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Barrato orizzontale del border-box |
| strikethrough_vertical | **bool** | Barrato verticale del border-box |
| strikethrough_bottom_left_to_top_right | **bool** | Barrato del border-box da in basso a sinistra a in alto a destra |
| strikethrough_top_left_to_bottom_right | **bool** | Barrato del border-box da in alto a sinistra a in basso a destra |
