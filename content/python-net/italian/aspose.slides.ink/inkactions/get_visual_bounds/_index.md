...
description: 
type: docs
url: /it/aspose.slides.ink/inkactions/get_visual_bounds/
weight: 40
---
## get_visual_bounds(self) {#}
Restituisce i confini visivi della forma calcolati dal suo contenuto renderizzato.
...
I limiti visivi tengono conto degli aspetti correlati al rendering come le trasformazioni (ad esempio, la rotazione), la larghezza e le giunzioni del tratto, il layout del testo e l'overflow, la geometria di SmartArt e altri effetti di layout che influenzano l'aspetto finale renderizzato della forma.
