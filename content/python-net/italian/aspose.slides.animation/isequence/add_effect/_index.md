...
description:
type: docs
url: /it/aspose.slides.animation/isequence/add_effect/
weight: 10
---
...
Nuovo oggetto Effect [`IEffect`](/slides/python-net/it/aspose.slides.animation/ieffect)
...
| :- | :- | :- |
| shape | [`IShape`](/slides/python-net/it/aspose.slides/ishape) | Shape oggetto [`IShape`](/slides/python-net/it/aspose.slides/ishape) per aggiungere un effetto |
...
| trigger_type | [`EffectTriggerType`](/slides/python-net/it/aspose.slides.animation/effecttriggertype) | Tipo di trigger dell'effetto [`EffectTriggerType`](/slides/python-net/it/aspose.slides.animation/effecttriggertype) |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| paragraph | [`IParagraph`](/slides/python-net/it/aspose.slides/iparagraph) | Paragraph oggetto [`IParagraph`](/slides/python-net/it/aspose.slides/iparagraph) |
| effect_type | [`EffectType`](/slides/python-net/it/aspose.slides.animation/effecttype) | Tipo di un effetto di animazione [`EffectType`](/slides/python-net/it/aspose.slides.animation/effecttype) |
| subtype | [`EffectSubtype`](/slides/python-net/it/aspose.slides.animation/effectsubtype) | Sottotipi di effetto di animazione [`EffectSubtype`](/slides/python-net/it/aspose.slides.animation/effectsubtype) |
| trigger_type | [`EffectTriggerType`](/slides/python-net/it/aspose.slides.animation/effecttriggertype) | Tipo di trigger dell'effetto [`EffectTriggerType`](/slides/python-net/it/aspose.slides.animation/effecttriggertype) |
...
| Parametro | Tipo | Descrizione |
| :- | :- | :- |
| chart | [`IChart`](/slides/python-net/it/aspose.slides.charts/ichart) | Chart oggetto [`IChart`](/slides/python-net/it/aspose.slides.charts/ichart) |
...
Aggiunge il nuovo effetto di animazione del grafico per elementi nella categoria o nella serie alla fine della sequenza.
