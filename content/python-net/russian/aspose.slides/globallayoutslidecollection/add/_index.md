...
Добавляет новый слайд-макет в презентацию.
...
| :- | :- | :- |
| master | [`IMasterSlide`](/slides/python-net/ru/aspose.slides/imasterslide) | Master slide for a new layout. |
...
### See Also
* class [`GlobalLayoutSlideCollection`](/slides/python-net/ru/aspose.slides/globallayoutslidecollection)
* class [`ILayoutSlide`](/slides/python-net/ru/aspose.slides/ilayoutslide)
* class [`IMasterSlide`](/slides/python-net/ru/aspose.slides/imasterslide)
* enumeration [`SlideLayoutType`](/slides/python-net/ru/aspose.slides/slidelayouttype)
