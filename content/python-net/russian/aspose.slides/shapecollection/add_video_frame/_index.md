...
description: 
type: docs
url: /ru/aspose.slides/shapecollection/add_video_frame/
weight: 160
---
...
The newly created [`IVideoFrame`](/slides/python-net/ru/aspose.slides/ivideoframe).
...
| width | **float** | Ширина нового видеокадра, в пунктах. |
| height | **float** | Высота нового видеокадра, в пунктах. |
| video | [`IVideo`](/slides/python-net/ru/aspose.slides/ivideo) | [`IVideo`](/slides/python-net/ru/aspose.slides/ivideo) для встраивания в видеокадр. |
