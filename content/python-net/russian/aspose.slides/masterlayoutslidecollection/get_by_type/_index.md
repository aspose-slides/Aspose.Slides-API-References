...
description: 
type: docs
url: /ru/aspose.slides/masterlayoutslidecollection/get_by_type/
weight: 30
---
## get_by_type(self, type) {#slidelayouttype}
Возвращает первый слайд макета указанного типа.
            Тип макета слайда для поиска.[`LayoutSlide`](/slides/python-net/ru/aspose.slides/layoutslide) с указанным типом или None, если макеты не найдены.
...
| :- | :- | :- |
| type | [`SlideLayoutType`](/slides/python-net/ru/aspose.slides/slidelayouttype) |  |
