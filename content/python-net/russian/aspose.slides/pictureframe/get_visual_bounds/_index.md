...
Возвращаемый прямоугольник представляет собой осесимметричные границы всего содержимого
             создаваемого фигурой при отрисовке в пространстве координат слайда.
...
В визуальные границы учитываются аспекты, связанные с отрисовкой, такие как
             преобразования (например, вращение), ширина и соединения штриха,
             раскладка и переполнение текста, геометрия SmartArt и другие эффекты раскладки,
             влияющие на конечный отрисованный вид фигуры.
