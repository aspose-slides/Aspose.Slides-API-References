...
description: 
type: docs
url: /ru/aspose.slides/ipresentation/replace_regex/
weight: 60
---
...
| :- | :- | :- |
| regex | **str** | Строка, содержащая регулярное выражение для получения строк, подлежащих замене. |
| new_text | **str** | Строка, заменяющая все вхождения заменяемых строк. |
