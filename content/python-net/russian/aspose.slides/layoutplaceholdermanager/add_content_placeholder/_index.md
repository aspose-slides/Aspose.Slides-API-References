...
description: 
type: docs
url: /ru/aspose.slides/layoutplaceholdermanager/add_content_placeholder/
weight: 20
---
## add_content_placeholder(self, x, y, width, height) {#float-float-float-float}
Добавляет новую форму-заполнитель на слайд макета для размещения содержимого, такого как изображение, таблица, медиа или текст.

### Возвращаемое значение

Создан [`IAutoShape`](/slides/python-net/ru/aspose.slides/iautoshape) с заполнителем Content.
