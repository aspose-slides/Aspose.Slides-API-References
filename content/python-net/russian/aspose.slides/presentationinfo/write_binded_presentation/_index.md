...
description: 
type: docs
url: /ru/aspose.slides/presentationinfo/write_binded_presentation/
weight: 50
---
...
| :- | :- | :- |
| stream | **io.RawIOBase** | Поток должен поддерживать перемещение и запись. |
