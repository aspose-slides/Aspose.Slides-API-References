...
description: 
type: docs
url: /ru/aspose.slides/oleobjectframe/hyperlink_mouse_over/
weight: 290
---
## hyperlink_mouse_over свойство
Возвращает или задает гиперссылку, определённую при наведении курсора мыши.
            Чтение/запись [`IHyperlink`](/slides/python-net/ru/aspose.slides/ihyperlink).
