...
description: 
type: docs
url: /ru/aspose.slides.charts/ichartdatapoint/get_automatic_data_point_color/
weight: 10
---
## get_automatic_data_point_color(self) {#}
Возвращает автоматический цвет точки данных на основе индекса серии, индекса точки данных, свойства ParentSeriesGroup.IsColorVaried и стиля диаграммы. 
            Этот цвет используется по умолчанию, если FillType равно NotDefined.

### Возвращаемое значение

Автоматический цвет точки данных [`Color`](/slides/python-net/ru/aspose.slides/color)
