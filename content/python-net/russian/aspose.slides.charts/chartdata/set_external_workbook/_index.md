...
description: 
type: docs
url: /ru/aspose.slides.charts/chartdata/set_external_workbook/
weight: 30
---
## set_external_workbook(self, workbook_path) {#str}
Устанавливает внешнюю рабочую книгу в качестве источника данных для диаграммы. Данные диаграммы будут обновляться из целевой рабочей книги.
...
| :- | :- | :- |
| workbook_path | **str** | Путь к целевой рабочей книге |
| update_chart_data | **bool** | Если значение равно false, будет обновлен только путь к рабочей книге. <br/><br/>             Данные диаграммы не будут загружены и обновлены из целевой рабочей книги. Может использоваться, когда целевая рабочая книга не существует или недоступна.<br/><br/>             Если значение равно true, данные диаграммы будут обновлены из целевой рабочей книги. |
