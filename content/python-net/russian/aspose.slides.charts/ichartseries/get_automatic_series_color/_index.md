...
description: 
type: docs
url: /ru/aspose.slides.charts/ichartseries/get_automatic_series_color/
weight: 10
---
## get_automatic_series_color(self) {#}
Возвращает автоматический цвет серии на основе индекса серии и стиля диаграммы. 
            Этот цвет используется по умолчанию, если FillType равно NotDefined.

### Возвращаемое значение

Автоматический цвет серии [`Color`](/slides/python-net/ru/aspose.slides/color)
