...
description: 
type: docs
url: /ru/aspose.slides.charts/ichartseries/number_format_of_x_values/
weight: 280
---
## number_format_of_x_values свойство
Возвращает или задает числовой формат для значений x серии.
            Чтение/запись **str**.
