...
description: 
type: docs
url: /ru/aspose.slides.export/markdownsaveoptions/default_regular_font/
weight: 30
---
## default_regular_font свойство
Возвращает или задает шрифт, используемый в случае, если исходный шрифт не найден.
            Чтение-запись **str**.
