...
description: 
type: docs
url: /ru/aspose.slides.export/iembeddedwofffontshtmlcontroller/write_document_end/
weight: 10
---
...
| :- | :- | :- |
| generator | [`IHtmlGenerator`](/slides/python-net/ru/aspose.slides.export/ihtmlgenerator) |  |
| presentation | [`IPresentation`](/slides/python-net/ru/aspose.slides/ipresentation) |  |



### См. также
* класс [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/ru/aspose.slides.export/iembeddedwofffontshtmlcontroller)
