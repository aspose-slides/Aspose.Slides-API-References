...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathlimit/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
Border-box с размещенным внутри этим элементом
...
| strikethrough_horizontal | **bool** | Перечёркивание горизонтальное Border Box |
| strikethrough_vertical | **bool** | Перечёркивание вертикальное Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | Перечёркивание Border Box снизу-слева вверх-справа |
| strikethrough_top_left_to_bottom_right | **bool** | Перечёркивание Border Box сверху-слева вниз-справа |
