...
description: 
type: docs
url: /ru/aspose.slides.mathtext/imathelementcollection/index_of/
weight: 50
---
...
| :- | :- | :- |
| item | [`IMathElement`](/slides/python-net/ru/aspose.slides.mathtext/imathelement) | Элемент, который нужно найти в коллекции. |



### См. также
* класс [`IMathElement`](/slides/python-net/ru/aspose.slides.mathtext/imathelement)
* класс [`IMathElementCollection`](/slides/python-net/ru/aspose.slides.mathtext/imathelementcollection)
