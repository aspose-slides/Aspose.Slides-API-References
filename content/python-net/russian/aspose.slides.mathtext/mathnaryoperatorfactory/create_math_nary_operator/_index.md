...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathnaryoperatorfactory/create_math_nary_operator/
weight: 20
---
...
| :- | :- | :- |
| operator_symbol | **char** | Знак оператора |
| base_argument | [`IMathElement`](/slides/python-net/ru/aspose.slides.mathtext/imathelement) | Базовый аргумент для применения оператора |
...
* класс [`MathNaryOperatorFactory`](/slides/python-net/ru/aspose.slides.mathtext/mathnaryoperatorfactory)
