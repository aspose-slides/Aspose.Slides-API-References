...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathfraction/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
Border-box, в котором размещён этот элемент
...
| strikethrough_horizontal | **bool** | Горизонтальное перечёркивание Border Box |
| strikethrough_vertical | **bool** | Вертикальное перечёркивание Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | Перечёркивание Border Box от нижнего левого до верхнего правого |
| strikethrough_top_left_to_bottom_right | **bool** | Перечёркивание Border Box от верхнего левого до нижнего правого |
