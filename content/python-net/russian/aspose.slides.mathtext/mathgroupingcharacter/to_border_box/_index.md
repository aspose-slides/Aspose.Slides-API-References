...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathgroupingcharacter/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
Border-box с помещённым внутри элементом
...
| strikethrough_bottom_left_to_top_right | **bool** | Border Box перечёркивание снизу-слева вверх-справа |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box перечёркивание сверху-слева вниз-справа |
