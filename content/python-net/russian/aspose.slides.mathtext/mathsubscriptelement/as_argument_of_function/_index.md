...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathsubscriptelement/as_argument_of_function/
weight: 30
---
...
Принимает указанную функцию, используя данный экземпляр в качестве аргумента, а также указанный дополнительный аргумент
