...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathsubscriptelement/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
Border-box с этим элементом внутри
...
| strikethrough_horizontal | **bool** | Зачёркивание горизонтальное Border Box |
| strikethrough_vertical | **bool** | Зачёркивание вертикальное Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | Зачёркивание от нижнего левого к верхнему правому Border Box |
| strikethrough_top_left_to_bottom_right | **bool** | Зачёркивание от верхнего левого к нижнему правому Border Box |
