...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathfunction/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Border Box перечёркивание по горизонтали |
| strikethrough_vertical | **bool** | Border Box перечёркивание по вертикали |
| strikethrough_bottom_left_to_top_right | **bool** | Border Box перечёркивание из нижнего левого в верхний правый |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box перечёркивание из верхнего левого в нижний правый |
