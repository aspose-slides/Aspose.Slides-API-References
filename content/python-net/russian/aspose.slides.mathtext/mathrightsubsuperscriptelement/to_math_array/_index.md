...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathrightsubsuperscriptelement/to_math_array/
weight: 220
---
## to_math_array(self) {#}
...
Новый экземпляр типа [`IMathArray`](/slides/python-net/ru/aspose.slides.mathtext/imatharray)
