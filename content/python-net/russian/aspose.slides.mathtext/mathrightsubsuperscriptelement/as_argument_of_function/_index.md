...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathrightsubsuperscriptelement/as_argument_of_function/
weight: 30
---
## as_argument_of_function(self, function_name) {#imathelement}
Принимает указанную функцию, используя текущий объект в качестве аргумента
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/ru/aspose.slides.mathtext/mathfunctionsofoneargument) | Один из общих типов функции с одним аргументом |


## as_argument_of_function(self, function_type, additional_argument) {#mathfunctionsoftwoarguments-imathelement}
Принимает указанную функцию, используя текущий объект в качестве аргумента, и указанный дополнительный аргумент
...
| Параметр | Тип | Описание |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/ru/aspose.slides.mathtext/mathfunctionsoftwoarguments) | Один из общих типов функции с двумя аргументами: Log, Lim, Min, Max |
