...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathblock/as_argument_of_function/
weight: 40
---
...
Принимает указанную функцию, используя данный экземпляр в качестве аргумента и указанное дополнительное значение
