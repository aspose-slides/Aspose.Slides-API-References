...
description: 
type: docs
url: /ru/aspose.slides.mathtext/mathsuperscriptelement/as_argument_of_function/
weight: 30
---
...
Принимает указанную функцию, используя текущий экземпляр в качестве аргумента, а также указанный дополнительный аргумент
