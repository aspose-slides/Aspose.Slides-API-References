...
description: 
type: docs
url: /nl/aspose.slides.mathtext/mathborderbox/as_argument_of_function/
weight: 30
---
## as_argument_of_function(self, function_name) {#imathelement}
Neemt de opgegeven functie met dit exemplaar als argument
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/nl/aspose.slides.mathtext/mathfunctionsofoneargument) | Een van de veelvoorkomende functietypes met één argument |


## as_argument_of_function(self, function_type, additional_argument) {#mathfunctionsoftwoarguments-imathelement}
Neemt de opgegeven functie met dit exemplaar als argument en het opgegeven aanvullende argument
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/nl/aspose.slides.mathtext/mathfunctionsoftwoarguments) | Een van de veelvoorkomende functietypes met twee argumenten: Log, Lim, Min, Max |
