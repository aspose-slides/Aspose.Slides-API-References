...
description: 
type: docs
url: /nl/aspose.slides.mathtext/mathleftsubsuperscriptelement/as_argument_of_function/
weight: 30
---
...
Nieuw wiskunde-element van type [`IMathFunction`](/slides/python-net/nl/aspose.slides.mathtext/imathfunction)
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| function_type | [`MathFunctionsOfOneArgument`](/slides/python-net/nl/aspose.slides.mathtext/mathfunctionsofoneargument) | Een van de gangbare functietypen met één argument |


## as_argument_of_function(self, function_type, additional_argument) {#mathfunctionsoftwoarguments-imathelement}
Neemt de opgegeven functie waarbij dit exemplaar als argument wordt gebruikt en het opgegeven extra argument
...
| Parameter | Type | Beschrijving |
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/nl/aspose.slides.mathtext/mathfunctionsoftwoarguments) | Een van de gangbare functietypen met twee argumenten: Log, Lim, Min, Max |
| additional_argument | [`IMathElement`](/slides/python-net/nl/aspose.slides.mathtext/imathelement) | Aanvullend argument, afhankelijk van het functietype |
...
| :- | :- | :- |
| function_type | [`MathFunctionsOfTwoArguments`](/slides/python-net/nl/aspose.slides.mathtext/mathfunctionsoftwoarguments) | Een van de gangbare functietypen met twee argumenten: Log, Lim, Min, Max |
| additional_argument | **str** | Aanvullend argument, afhankelijk van het functietype |
