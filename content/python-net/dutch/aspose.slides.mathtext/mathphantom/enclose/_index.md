...
description: 
type: docs
url: /nl/aspose.slides.mathtext/mathphantom/enclose/
weight: 50
---
## enclose(self) {#}
...
Het wiskundige element van type [`IMathDelimiter`](/slides/python-net/nl/aspose.slides.mathtext/imathdelimiter) dat opgegeven tekens als omlijsting bevat
...
| :- | :- | :- |
| beginning_character | **char** | Beginkarakter (meestal linker haakje) |
| ending_character | **char** | Eindkarakter (meestal rechter haakje) |
