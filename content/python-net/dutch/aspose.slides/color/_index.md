...
description: Vertegenwoordigt een ARGB (alpha, rood, groen, blauw) kleur.
type: docs
url: /nl/aspose.slides/color/
net_type: System.Drawing.Color
---
## Color klasse

Stelt een ARGB (alpha, rood, groen, blauw) kleur voor. Compatibel met .NET `System.Drawing.Color`.

Het Color-type biedt de volgende leden:

## Constructors

| Constructor | Beschrijving |
| :- | :- |
| [`__init__(self, r=0, g=0, b=0, a=255)`](/slides/python-net/nl/aspose.slides/color/__init__/#int-int-int-int) | Maakt een kleur aan op basis van de opgegeven rode, groene, blauwe en alfa-componentwaarden. |

## Eigenschappen

| Eigenschap | Beschrijving |
| :- | :- |
| [`a`](/slides/python-net/nl/aspose.slides/color/a/) | Haalt de alfa-componentwaarde van deze kleur op.<br/>            Alleen-lezen **int**. |
| [`r`](/slides/python-net/nl/aspose.slides/color/r/) | Haalt de rode componentwaarde van deze kleur op.<br/>            Alleen-lezen **int**. |
| [`g`](/slides/python-net/nl/aspose.slides/color/g/) | Haalt de groene componentwaarde van deze kleur op.<br/>            Alleen-lezen **int**. |
| [`b`](/slides/python-net/nl/aspose.slides/color/b/) | Haalt de blauwe componentwaarde van deze kleur op.<br/>            Alleen-lezen **int**. |
| [`name`](/slides/python-net/nl/aspose.slides/color/name/) | Haalt de naam van deze kleur op.<br/>            Voor een benoemde kleur (een benoemde constante zoals `Color.red`, of een kleur gecreëerd met [`from_name`](/slides/python-net/nl/aspose.slides/color/from_name/)) wordt de .NET-naam geretourneerd, bijv. `"Red"` of `"LightBlue"`.<br/>            Voor elke andere kleur wordt de ARGB-waarde geretourneerd als kleine-letter hexadecimale notatie zonder voorloopnullen, bijv. `"ffff0000"`. `Color.empty.name` is `"0"`.<br/>            Alleen-lezen **str**. |
| [`is_empty`](/slides/python-net/nl/aspose.slides/color/is_empty/) | Geeft aan of deze kleur `Color.empty` is.<br/>            Retourneert `False` voor een kleur waarvan alle componenten gelijk aan nul zijn en die is gemaakt met [`from_argb`](/slides/python-net/nl/aspose.slides/color/from_argb/).<br/>            Alleen-lezen **bool**. |
| [`is_known_color`](/slides/python-net/nl/aspose.slides/color/is_known_color/) | Geeft aan of deze kleur een van de vooraf gedefinieerde .NET `KnownColor`-kleuren is (een benoemde kleur of een systeemkleur).<br/>            Alleen-lezen **bool**. |
| [`is_named_color`](/slides/python-net/nl/aspose.slides/color/is_named_color/) | Geeft aan of deze kleur een naam draagt: hij werd gemaakt vanuit een benoemde constante zoals `Color.red`, met [`from_name`](/slides/python-net/nl/aspose.slides/color/from_name/), of werd door de bibliotheek geretourneerd als een benoemde kleur.<br/>            Alleen-lezen **bool**. |
| [`is_system_color`](/slides/python-net/nl/aspose.slides/color/is_system_color/) | Geeft aan of deze kleur een systeemkleur is: een kleur die wordt gebruikt voor een Windows-schermonderdeel, zoals `Control` of `ActiveBorder`.<br/>            Systeemkleuren worden niet blootgesteld als `Color`-attributen en kunnen alleen worden verkregen met [`from_known_color`](/slides/python-net/nl/aspose.slides/color/from_known_color/) of worden geretourneerd door de bibliotheek.<br/>            Alleen-lezen **bool**. |

## Methoden

| Methode | Beschrijving |
| :- | :- |
| [`from_argb(argb)`](/slides/python-net/nl/aspose.slides/color/from_argb/#int) | Maakt een kleur aan op basis van een 32-bit ARGB-waarde. |
| [`from_argb(alpha, base_color)`](/slides/python-net/nl/aspose.slides/color/from_argb/#int-color) | Maakt een kleur aan op basis van de opgegeven alfa-waarde en basiskleur. |
| [`from_argb(red, green, blue)`](/slides/python-net/nl/aspose.slides/color/from_argb/#int-int-int) | Maakt een ondoorzichtige kleur (alfa is 255) aan op basis van de opgegeven rode, groene en blauwe waarden. |
| [`from_argb(alpha, red, green, blue)`](/slides/python-net/nl/aspose.slides/color/from_argb/#int-int-int-int) | Maakt een kleur aan op basis van de vier ARGB-componenten (alfa, rood, groen en blauw). |
| [`from_known_color(known_color)`](/slides/python-net/nl/aspose.slides/color/from_known_color/#knowncolor) | Maakt een kleur aan op basis van de opgegeven vooraf gedefinieerde kleur. |
| [`from_name(name)`](/slides/python-net/nl/aspose.slides/color/from_name/#str) | Maakt een kleur aan op basis van de opgegeven naam van een vooraf gedefinieerde kleur. |
| [`from_rgb(r, g, b)`](/slides/python-net/nl/aspose.slides/color/from_rgb/#int-int-int) | Maakt een ondoorzichtige kleur (alfa is 255) aan op basis van de opgegeven rode, groene en blauwe waarden. |
| [`get_brightness(self)`](/slides/python-net/nl/aspose.slides/color/get_brightness/#) | Haalt de helderheidswaarde (HSL) van deze kleur op. |
| [`get_hue(self)`](/slides/python-net/nl/aspose.slides/color/get_hue/#) | Haalt de tintwaarde (HSL) in graden van deze kleur op. |
| [`get_saturation(self)`](/slides/python-net/nl/aspose.slides/color/get_saturation/#) | Haalt de verzadigingswaarde (HSL) van deze kleur op. |
| [`to_argb(self)`](/slides/python-net/nl/aspose.slides/color/to_argb/#) | Haalt de 32-bit ARGB-waarde van deze kleur op. |
| [`to_known_color(self)`](/slides/python-net/nl/aspose.slides/color/to_known_color/#) | Haalt de `KnownColor`-waarde van deze kleur op. |
| [`to_string(self)`](/slides/python-net/nl/aspose.slides/color/to_string/#) | Converteert deze kleur naar een mens-leesbare tekenreeks. Dezelfde tekst wordt geretourneerd door `str()` en `repr()`. |


### Opmerkingen

Kleuren worden vergeleken op hun ARGB-componenten met `==` en kunnen worden gebruikt als sleutels in een dictionary of als leden van een set.

De vooraf gedefinieerde kleuren (de 141 benoemde .NET `KnownColor`-kleuren, `Color.transparent` en `Color.empty`) zijn beschikbaar als class-attributen in snake_case, bijvoorbeeld `Color.red`, `Color.light_blue` of `Color.dark_slate_gray` (zie [Named colors](#named-colors) hieronder). Ze kunnen ook als methoden worden aangeroepen (`Color.red()`), wat dezelfde kleur retourneert.
...
with slides.Presentation() as pres:
    ...
    print(color.name, color.to_argb(), color.is_named_color)  # LichtBlauw -5383962 Waar
    print(slides.Color(255, 0, 0) == slides.Color.red)         # Waar
```

### Genaamde kleuren

| Attribuut | .NET-naam | ARGB |
| :- | :- | :- |
