...
description: 
type: docs
url: /nl/aspose.slides/autoshape/get_image/
weight: 60
---
## get_image(self) {#}
...
Shape thumbnail of None in het geval dat ShapeThumbnailBounds.Appearance wordt gebruikt en een vorm geen zichtbare elementen heeft.
...
| :- | :- | :- |
| bounds | [`ShapeThumbnailBounds`](/slides/python-net/nl/aspose.slides/shapethumbnailbounds) | Vorm-miniatuur grenzen type. |
