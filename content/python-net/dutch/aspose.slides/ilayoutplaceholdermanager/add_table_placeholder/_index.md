---
title: add_table_placeholder method
second_title: Aspose.Slides voor Python via .NET API-referentie
description: 
type: docs
url: /nl/aspose.slides/ilayoutplaceholdermanager/add_table_placeholder/
weight: 70
---
## add_table_placeholder(self, x, y, width, height) {#float-float-float-float}
Voegt een nieuw placeholder-vorm toe aan de layout-slide om een Table placeholder te bevatten.

### Retourneert

Aangemaakt [`IAutoShape`](/slides/python-net/nl/aspose.slides/iautoshape) met een Table placeholder.
