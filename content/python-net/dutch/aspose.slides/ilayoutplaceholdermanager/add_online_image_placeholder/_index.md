...
description: 
type: docs
url: /nl/aspose.slides/ilayoutplaceholdermanager/add_online_image_placeholder/
weight: 40
---
## add_online_image_placeholder(self, x, y, width, height) {#float-float-float-float}
Voegt een nieuw placeholder-vorm toe aan de layout-slide om een online afbeelding te bevatten.

### Retour

Aangemaakt [`IAutoShape`](/slides/python-net/nl/aspose.slides/iautoshape) met een online afbeelding placeholder.
