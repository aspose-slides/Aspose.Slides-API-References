...
description: 
type: docs
url: /nl/aspose.slides/shapecollection/insert_picture_frame/
weight: 290
---
## insert_picture_frame(self, index, shape_type, x, y, width, height, image) {#int-shapetype-float-float-float-float-ippimage}
Maakt een nieuw afbeeldingsframe dat de opgegeven afbeelding bevat en voegt het in de vormverzameling in op de opgegeven index.
