...
description: 
type: docs
url: /nl/aspose.slides/ishapecollection/add_picture_frame/
weight: 110
---
...
De nieuw gemaakte [`IPictureFrame`](/slides/python-net/nl/aspose.slides/ipictureframe).
...
| image | [`IPPImage`](/slides/python-net/nl/aspose.slides/ippimage) | De [`IPPImage`](/slides/python-net/nl/aspose.slides/ippimage) die moet worden weergegeven in het afbeeldingsframe. |
