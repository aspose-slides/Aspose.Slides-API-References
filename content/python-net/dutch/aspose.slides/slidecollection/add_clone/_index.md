...
description: 
type: docs
url: /nl/aspose.slides/slidecollection/add_clone/
weight: 10
---
...
Bij het klonen van een dia tussen verschillende presentaties kan de master van de dia ook worden gekloond.
            Er wordt een intern register gebruikt om automatisch gekloonde masters bij te houden en zo het aanmaken van 
            meerdere klonen van dezelfde masterdia te voorkomen.
            Handmatig klonen van masterdia's wordt noch voorkomen noch geregistreerd.
            Als u meer controle over het kloonproces nodig heeft, gebruik dan
            **Aspose.Slides.SlideCollection.AddClone(Aspose.Slides.ISlide,Aspose.Slide** of
            **Aspose.Slides.SlideCollection.AddClone(Aspose.Slides.ISlide,Aspose.Slides.IMasterSlide,Syste** voor het klonen van dia's,
...
Voegt een kopie van een opgegeven bron-dia toe aan het einde van de collectie.
            Een geschikte lay-out wordt automatisch geselecteerd uit de opgegeven 
            master (een geschikte lay-out is de lay-out met dezelfde Type of Naam als 
            de lay-out van de bron-dia). Als er geen geschikte lay-out is, dan
            wordt de lay-out van de bron-dia gekloond (als allowCloneMissingLayout 
            true is) of wordt er een PptxEditException gegooid (als allowCloneMissingLayout
            false is).
...
| allow_clone_missing_layout | **bool** | Als er geen geschikte lay-out in de opgegeven master is, dan wordt de lay-out van de <br/><br/>            bron-dia gekloond (als allowCloneMissingLayout true is) of <br/><br/>            wordt een PptxEditException gegooid (als allowCloneMissingLayout false is). |
