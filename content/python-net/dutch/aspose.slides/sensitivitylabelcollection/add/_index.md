...
De index waarop de SensitivityLabel is toegevoegd.
...
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Gooit een fout wanneer het sensitivity-label met dezelfde Id al is toegevoegd. |
...
* klasse [`SensitivityLabelCollection`](/slides/python-net/nl/aspose.slides/sensitivitylabelcollection)
