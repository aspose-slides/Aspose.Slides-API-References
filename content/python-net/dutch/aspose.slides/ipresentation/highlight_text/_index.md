...
description: 
type: docs
url: /nl/aspose.slides/ipresentation/highlight_text/
weight: 40
---
...
| text | **str** | De te markeren tekst. |
| highlight_color | **aspose.slides.Color** | De kleur om de tekst te markeren. |
| options | [`ITextSearchOptions`](/slides/python-net/nl/aspose.slides/itextsearchoptions) | Zoekopties [`ITextSearchOptions`](/slides/python-net/nl/aspose.slides/itextsearchoptions). |
...
### Zie ook
* klasse [`IFindResultCallback`](/slides/python-net/nl/aspose.slides/ifindresultcallback)
