...
description: 
type: docs
url: /fa/aspose.slides.animation/textanimation/effect_animate_background_shape/
weight: 40
---
## effect_animate_background_shape ویژگی
Linked shape effect with group or not (None).
            خواندن/نوشتن [`IEffect`](/slides/python-net/fa/aspose.slides.animation/ieffect).
...
* کلاس [`TextAnimation`](/slides/python-net/fa/aspose.slides.animation/textanimation)
