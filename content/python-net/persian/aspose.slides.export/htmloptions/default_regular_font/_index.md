...
description: 
type: docs
url: /fa/aspose.slides.export/htmloptions/default_regular_font/
weight: 30
---
## default_regular_font خاصیت
فونتی را که در صورت عدم یافتن فونت منبع استفاده می‌شود، برمی‌گرداند یا تنظیم می‌کند.
            قابل خواندن و نوشتن **str**.
