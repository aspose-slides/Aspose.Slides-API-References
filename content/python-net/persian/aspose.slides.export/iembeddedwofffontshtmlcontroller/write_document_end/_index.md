...
description: 
type: docs
url: /fa/aspose.slides.export/iembeddedwofffontshtmlcontroller/write_document_end/
weight: 10
---
...
| پارامتر | نوع | توضیح |
| :- | :- | :- |
| generator | [`IHtmlGenerator`](/slides/python-net/fa/aspose.slides.export/ihtmlgenerator) |  |
| presentation | [`IPresentation`](/slides/python-net/fa/aspose.slides/ipresentation) |  |



### موارد مرتبط
* کلاس [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/fa/aspose.slides.export/iembeddedwofffontshtmlcontroller)
