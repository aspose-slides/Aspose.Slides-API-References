...
description: 
type: docs
url: /fa/aspose.slides.export/ihtmloptions/default_regular_font/
weight: 20
---
## default_regular_font ویژگی
### تعریف:
```python
@property
...
### موارد مرتبط
* کلاس [`IHtmlOptions`](/slides/python-net/fa/aspose.slides.export/ihtmloptions)
