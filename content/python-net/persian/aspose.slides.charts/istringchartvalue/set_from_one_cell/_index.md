...
description: 
type: docs
url: /fa/aspose.slides.charts/istringchartvalue/set_from_one_cell/
weight: 20
---
...
| پارامتر | نوع | توضیح |
| :- | :- | :- |
| cell | [`IChartDataCell`](/slides/python-net/fa/aspose.slides.charts/ichartdatacell) | Cell. |



### موارد مرتبط
* کلاس [`IChartDataCell`](/slides/python-net/fa/aspose.slides.charts/ichartdatacell)
* کلاس [`IStringChartValue`](/slides/python-net/fa/aspose.slides.charts/istringchartvalue)
