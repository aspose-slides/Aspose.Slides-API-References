...
description: 
type: docs
url: /fa/aspose.slides.charts/ichartdatacell/preset_number_format/
weight: 70
---
## preset_number_format ویژگی
دریافت یا تنظیم قالب نمایش پیش‌ساخته اعداد و تاریخ‌ها. عدد پیش‌تنظیم باید در بازهٔ [0..22] یا [37..49] باشد.
             خواندنی/نوشتنی **int**.
