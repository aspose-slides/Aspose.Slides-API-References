...
description: 
type: docs
url: /fa/aspose.slides.mathtext/imathelement/set_superscript/
weight: 170
---
## set_superscript(self, superscript) {#imathelement}
یک فوق‌نوشته ایجاد می‌کند
...
| پارامتر | نوع | توضیح |
| :- | :- | :- |
| superscript | [`IMathElement`](/slides/python-net/fa/aspose.slides.mathtext/imathelement) | فوق‌نوشته (نمایش بالایی در سمت راست) |
...
| پارامتر | نوع | توضیح |
| :- | :- | :- |
| superscript | **str** | فوق‌نوشته (نمایش بالایی در سمت راست) |
