...
description: 
type: docs
url: /fa/aspose.slides.mathtext/mathrightsubsuperscriptelement/integral/
weight: 90
---
## integral(self, integral_type) {#mathintegraltypes}
انتگرال را بدون محدودیت‌ها می‌گیرد

### بازگشت

نمونهٔ جدید از نوع [`IMathNaryOperator`](/slides/python-net/fa/aspose.slides.mathtext/imathnaryoperator)
...
| lower_limit | [`IMathElement`](/slides/python-net/fa/aspose.slides.mathtext/imathelement) | حد پایین انتگرال |
| upper_limit | [`IMathElement`](/slides/python-net/fa/aspose.slides.mathtext/imathelement) | حد بالای انتگرال |
| limit_locations | [`MathLimitLocations`](/slides/python-net/fa/aspose.slides.mathtext/mathlimitlocations) | محل محدودیت‌ها |
