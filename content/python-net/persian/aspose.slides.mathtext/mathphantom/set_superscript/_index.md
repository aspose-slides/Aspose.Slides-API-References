...
description: 
type: docs
url: /fa/aspose.slides.mathtext/mathphantom/set_superscript/
weight: 180
---
...
| پارامتر | نوع | توضیح |
| :- | :- | :- |
| superscript | [`IMathElement`](/slides/python-net/fa/aspose.slides.mathtext/imathelement) | نمای فوقانی (ایندکس بالایی سمت راست) |
...
| پارامتر | نوع | توضیح |
| :- | :- | :- |
| superscript | **str** | نمای فوقانی (ایندکس بالایی سمت راست) |
