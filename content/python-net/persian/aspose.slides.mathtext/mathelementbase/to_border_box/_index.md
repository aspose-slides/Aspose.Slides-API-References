...
description: 
type: docs
url: /fa/aspose.slides.mathtext/mathelementbase/to_border_box/
weight: 190
---
## to_border_box(self) {#}
...
### بازگشت
border-box که این عنصر درون آن قرار گرفته است
...
| strikethrough_horizontal | **bool** | خط‌خورده افقی Border Box |
| strikethrough_vertical | **bool** | خط‌خورده عمودی Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | خط‌خورده Border Box از پایین چپ به بالا راست |
| strikethrough_top_left_to_bottom_right | **bool** | خط‌خورده Border Box از بالا چپ به پایین راست |
