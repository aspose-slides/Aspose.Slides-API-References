...
description: 
type: docs
url: /fa/aspose.slides/sectionzoomframe/get_image/
weight: 30
---
## get_image(self) {#}
تصویر بندانگشتی شکل را برمی‌گرداند.
            نوع محدوده تصویر بندانگشتی شکل ShapeThumbnailBounds.Shape به‌صورت پیش‌فرض استفاده می‌شود.
...
تصویر بندانگشتی شکل یا None در حالیکه ShapeThumbnailBounds.Appearance استفاده شده باشد و شکل عناصری قابل مشاهده نداشته باشد.
