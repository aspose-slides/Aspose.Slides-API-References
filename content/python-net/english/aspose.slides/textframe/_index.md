...
| Method | Description |
| :- | :- |
| [`highlight_text`](/slides/python-net/aspose.slides/textframe/highlight_text/#str-asposepydrawingcolor) | Highlight all matches of sample in text frame text using specified color. |
| [`highlight_text`](/slides/python-net/aspose.slides/textframe/highlight_text/#str-asposepydrawingcolor-itexthighlightingoptions) | Highlight all matches of sample in text frame text using specified color. |
