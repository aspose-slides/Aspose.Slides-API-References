...
| :- | :- |
| [`__init__(self)`](/slides/python-net/aspose.slides/textframeformat/__init__/#) | Initializes a new instance of [`TextFrameFormat`](/slides/python-net/aspose.slides/textframeformat) class. |
...
| [`anchoring_type`](/slides/python-net/aspose.slides/textframeformat/anchoring_type/) | Returns or sets vertical anchor text in a TextFrame.<br/>            Read/write [`TextAnchorType`](/slides/python-net/aspose.slides/textanchortype). |
...
| Method | Description |
| :- | :- |
| [`get_effective(self)`](/slides/python-net/aspose.slides/textframeformat/get_effective/#) | Gets effective text frame formatting data with the inheritance applied. |
