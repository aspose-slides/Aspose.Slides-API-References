...
| :- | :- |
| [is_footer_visible](/slides/python-net/aspose.slides/ibaseslideheaderfootermanager/is_footer_visible/) | Gets value indicating that a footer placeholder is present.<br/>            Read <br/>.NET type System.Boolean<br/>. |
| [is_slide_number_visible](/slides/python-net/aspose.slides/ibaseslideheaderfootermanager/is_slide_number_visible/) | Gets value indicating that a page number placeholder is present.<br/>            Read<br/>.NET type System.Boolean<br/>. |
| [is_date_time_visible](/slides/python-net/aspose.slides/ibaseslideheaderfootermanager/is_date_time_visible/) | Gets value indicating that a date-time placeholder is present.<br/>            Read<br/>.NET type System.Boolean<br/>. |
