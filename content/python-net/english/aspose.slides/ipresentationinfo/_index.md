...
| :- | :- |
| [is_encrypted](/slides/python-net/aspose.slides/ipresentationinfo/is_encrypted/) | Gets True if binded presentation is encrypted, otherwise False.<br/>            Read-only :py:class:`bool`. |
...
| [load_format](/slides/python-net/aspose.slides/ipresentationinfo/load_format/) | Gets format of the binded presentation.<br/>            Read-only :py:enum:`aspose.slides.LoadFormat`. |
