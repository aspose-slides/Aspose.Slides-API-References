...
| :- | :- |
| [is_encrypted](/slides/python-net/aspose.slides/ipresentationinfo/is_encrypted/) | Gets True if binded presentation is encrypted, otherwise False.<br/>            Read-only <br/>.NET type System.Boolean<br/>. |
...
| [load_format](/slides/python-net/aspose.slides/ipresentationinfo/load_format/) | Gets format of the binded presentation.<br/>            Read-only <br/>[`LoadFormat`](/slides/python-net/aspose.slides/loadformat)<br/>. |
