...
| [line_format](/slides/python-net/aspose.slides/line_format) | Returns the LineFormat object that contains line formatting properties for a shape.<br/>            Note: Returns null for GroupShape objects because they don't have line properties.<br/>            Read-only :py:class:`aspose.slides.ILineFormat`. |
...
| [shape_lock](/slides/python-net/aspose.slides/shape_lock) | Returns shape's locks.<br/>            Read-only :py:class:`aspose.slides.IGroupShapeLock`. |
...
| [group_shape_lock](/slides/python-net/aspose.slides/group_shape_lock) | Returns shape's locks.<br/>            Read-only :py:class:`aspose.slides.IGroupShapeLock`. |
| [shapes](/slides/python-net/aspose.slides/shapes) | Returns the collection of shapes inside the group.<br/>            Read-only :py:class:`aspose.slides.IShapeCollection`. |
...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides/groupshape/#) | Returns shape thumbnail.<br/>            ShapeThumbnailBounds.Shape shape thumbnail bounds type is used by default. |
| [__init__](/slides/python-net/aspose.slides/groupshape/#ShapeThumbnailBounds-float-float) | Returns shape thumbnail. |
| [__init__](/slides/python-net/aspose.slides/groupshape/#System.IO.Stream) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides/groupshape/#System.IO.Stream-aspose.slides.export.ISVGOptions) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides/groupshape/#) | Defines that this shape isn't a placeholder. |
| [__init__](/slides/python-net/aspose.slides/groupshape/#IPlaceholder) | Adds a new placeholder if there is no and sets placeholder properties to a specified one. |
| [__init__](/slides/python-net/aspose.slides/groupshape/#) | Returns a basic placeholder shape (shape from the layout and/or master slide that the current shape is inherited from). |
