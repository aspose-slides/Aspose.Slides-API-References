...
| [`external_url`](/slides/python-net/aspose.slides/ihyperlink/external_url/) | Specifies the external URL<br/>            If this property become not null then property TargetSlide become null.<br/>            Read-only **str**. |
