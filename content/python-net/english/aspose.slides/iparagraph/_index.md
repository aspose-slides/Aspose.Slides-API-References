...
| Method | Description |
| :- | :- |
| [`get_image`](/slides/python-net/aspose.slides/iparagraph/get_image/#) | Returns an image of the paragraph. |
| [`get_image`](/slides/python-net/aspose.slides/iparagraph/get_image/#float-float) | Returns an image of the paragraph with the specified scale. |
