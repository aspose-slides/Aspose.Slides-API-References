...
## resource_loading(self, args) {#iresourceloadingargs}
Callback method which regulates external resources loading.

### Returns

The resource loading decision [`ResourceLoadingAction`](/slides/python-net/aspose.slides/resourceloadingaction).
