...
| [`base_uri`](/slides/python-net/aspose.slides/svgimage/base_uri/) | Returns base URI of the specified Svg. Used to resolve relative links.<br/>            Read-only **string**. |
| [`svg_content`](/slides/python-net/aspose.slides/svgimage/svg_content/) | Returns SVG content.<br/>            Read-only **string**. |
