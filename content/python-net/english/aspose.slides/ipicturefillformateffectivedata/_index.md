...
| :- | :- |
| [`dpi`](/slides/python-net/aspose.slides/ipicturefillformateffectivedata/dpi/) | Returns the dpi which is used to fill a picture.<br/>            Read-only **int**. |
...
| [`crop_left`](/slides/python-net/aspose.slides/ipicturefillformateffectivedata/crop_left/) | Returns the number of percents of real image width that are cropped off<br/>            the left of the picture. <br/>            Read-only **float**. |
