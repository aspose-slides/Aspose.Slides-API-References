...
| Method | Description |
| :- | :- |
| [`load_external_fonts(directories)`](/slides/python-net/aspose.slides/fontsloader/load_external_fonts/#liststr) | Adds additional folders to seek fonts. |
| [`load_external_font(data)`](/slides/python-net/aspose.slides/fontsloader/load_external_font/#bytes) | Adds font from the binary data |
