...
| Method | Description |
| :- | :- |
| [`get_effective(self)`](/slides/python-net/aspose.slides/itextframeformat/get_effective/#) | Gets effective text frame formatting data with the inheritance applied. |
