...
| [margin_left](/slides/python-net/aspose.slides/itextframeformat/margin_left/) | Returns or sets the left margin (points) in a TextFrame.<br/>            Read/write .NET type System.Double. |
| [margin_right](/slides/python-net/aspose.slides/itextframeformat/margin_right/) | Returns or sets the right margin (points) in a TextFrame.<br/>            Read/write .NET type System.Double. |
| [margin_top](/slides/python-net/aspose.slides/itextframeformat/margin_top/) | Returns or sets the top margin (points) in a TextFrame.<br/>            Read/write .NET type System.Double. |
| [margin_bottom](/slides/python-net/aspose.slides/itextframeformat/margin_bottom/) | Returns or sets the bottom margin (points) in a TextFrame.<br/>            Read/write .NET type System.Double. |
...
| [column_count](/slides/python-net/aspose.slides/itextframeformat/column_count/) | Returns or sets number of columns in the text area.<br/>            This value must be a positive number. Otherwise, the value will be set to zero. <br/>            Value 0 means undefined value.<br/>            Read/write .NET type System.Int32. |
...
| [keep_text_flat](/slides/python-net/aspose.slides/itextframeformat/keep_text_flat/) | Returns or set keeping text out of 3D scene entirely.<br/>            Read/write .NET type System.Boolean. |
