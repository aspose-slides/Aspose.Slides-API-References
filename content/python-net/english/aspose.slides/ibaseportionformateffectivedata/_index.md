...
| [`highlight_color`](/slides/python-net/aspose.slides/ibaseportionformateffectivedata/highlight_color/) | Returns the color used to highlight a text.<br/>            Read-only [`Color`](/slides/python-net/aspose.slides/color). |
