...
| :- | :- |
| [is_no_effects](/slides/python-net/aspose.slides/ieffectformat/is_no_effects/) | Returns true if all effects are disabled (as just created, default EffectFormat object).<br/>            Read-only .NET type System.Boolean. |
