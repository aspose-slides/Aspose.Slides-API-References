...
| [`language_id`](/slides/python-net/aspose.slides/baseportionformat/language_id/) | Returns or sets the Id of a proofing language. Used for checking spelling and grammar.<br/>            Read/write **string**. |
| [`alternative_language_id`](/slides/python-net/aspose.slides/baseportionformat/alternative_language_id/) | Returns or sets the Id of an alternative language.<br/>            Read/write **string**. |
