...
| [`get_thumbnail`](/slides/python-net/aspose.slides/oleobjectframe/get_thumbnail/#asposeslidesshapethumbnailbounds-float-float) | Returns shape thumbnail. |
...
| [`get_image`](/slides/python-net/aspose.slides/oleobjectframe/get_image/#asposeslidesshapethumbnailbounds-float-float) | Returns shape thumbnail. |
...
| [`add_placeholder`](/slides/python-net/aspose.slides/oleobjectframe/add_placeholder/#asposeslidesiplaceholder) | Adds a new placeholder if there is no and sets placeholder properties to a specified one. |
...
| [`set_embedded_data`](/slides/python-net/aspose.slides/oleobjectframe/set_embedded_data/#asposeslidesioleembeddeddatainfo) | Sets information about OLE embedded data.<br/><br/>            This method changes the properties of the object to reflect the new data and <br/>            sets the IsObjectLink flag to false, indicating that the OLE object is embedded. |
