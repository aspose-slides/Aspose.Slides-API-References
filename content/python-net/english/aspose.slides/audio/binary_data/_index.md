...
description: 
type: docs
url: /aspose.slides/audio/binary_data/
weight: 20
---
...
Returns the copy of an audio's data. In case of large amount of data consider 
            using of [`Audio.get_stream`](/slides/python-net/aspose.slides/audio/get_stream) method to prevent unnecessary  loading of audio's
