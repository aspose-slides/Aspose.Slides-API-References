...
description: 
type: docs
url: /aspose.slides/customdata/custom_xml_parts/
weight: 10
---
...
Returns the custom xml parts collection.
            Read-only [`ICustomXmlPartCollection`](/slides/python-net/aspose.slides/icustomxmlpartcollection).
...
### See Also
* class [`CustomData`](/slides/python-net/aspose.slides/customdata)
