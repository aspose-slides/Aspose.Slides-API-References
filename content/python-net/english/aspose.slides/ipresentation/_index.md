...
| [`get_images(self, options, image_size)`](/slides/python-net/aspose.slides/ipresentation/get_images/#asposeslidesexportirenderingoptions-asposeslidessize) | Returns a Thumbnail Image objects for all slides of a presentation with specified size. |
| [`get_images(self, options, slides, image_size)`](/slides/python-net/aspose.slides/ipresentation/get_images/#asposeslidesexportirenderingoptions-listint-asposeslidessize) | Returns a Thumbnail Image objects for specified slides of a presentation with specified size. |
| [`highlight_text(self, text, highlight_color)`](/slides/python-net/aspose.slides/ipresentation/highlight_text/#str-asposeslidescolor) | Highlights all matches of the sample text with the specified color. |
| [`highlight_text(self, text, highlight_color, options, callback)`](/slides/python-net/aspose.slides/ipresentation/highlight_text/#str-asposeslidescolor-itextsearchoptions-ifindresultcallback) | Highlights all matches of the sample text with the specified color. |
...
| [`highlight_regex(self, regex, highlight_color)`](/slides/python-net/aspose.slides/ipresentation/highlight_regex/#str-asposeslidescolor) | Highlights all matches of the regular expression with the specified color. |
