...
| [image_type](/slides/python-net/aspose.slides/image_type) | Gets or sets the image type of a zoom object.<br/>            Read/write :py:enum:`aspose.slides.ZoomImageType`.<br/>            Default value: Preview |
| [return_to_parent](/slides/python-net/aspose.slides/return_to_parent) | Gets or sets the navigation behavior in slideshow.<br/>            Read/write :py:class:`bool`.<br/>            Default value: false |
| [show_background](/slides/python-net/aspose.slides/show_background) | Gets or sets value that specifies whether the Zoom will use the background of the destination slide.<br/>            Read/write :py:class:`bool`.<br/>            Default value: true |
| [image](/slides/python-net/aspose.slides/image) | Gets or sets image for zoom object.<br/>            Read/write :py:class:`aspose.slides.IPPImage`. |
| [transition_duration](/slides/python-net/aspose.slides/transition_duration) | Gets or sets the duration of the transition between Zoom and slide.<br/>            Read/write :py:class:`float`.<br/>            Default value: 1.0f |
| [target_section](/slides/python-net/aspose.slides/target_section) | Gets or sets the section object that the Section Zoom object links to.<br/>            Read/write :py:class:`aspose.slides.ISection`. |
| [title](/slides/python-net/aspose.slides/title) | Returns the text title of the Summary Zoom Section object. |
| [description](/slides/python-net/aspose.slides/description) | Returns the text description of the Summary Zoom Section object. |
...
| [as_i_zoom_object](/slides/python-net/aspose.slides/as_i_zoom_object) |  |
| [as_i_section_zoom_frame](/slides/python-net/aspose.slides/as_i_section_zoom_frame) |  |

## Methods

| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides/summaryzoomsection/#) | Returns shape thumbnail.<br/>            ShapeThumbnailBounds.Shape shape thumbnail bounds type is used by default. |
| [__init__](/slides/python-net/aspose.slides/summaryzoomsection/#ShapeThumbnailBounds-float-float) | Returns shape thumbnail. |
| [__init__](/slides/python-net/aspose.slides/summaryzoomsection/#System.IO.Stream) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides/summaryzoomsection/#System.IO.Stream-aspose.slides.export.ISVGOptions) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides/summaryzoomsection/#) | Defines that this shape isn't a placeholder. |
| [__init__](/slides/python-net/aspose.slides/summaryzoomsection/#IPlaceholder) | Adds a new placeholder if there is no and sets placeholder properties to a specified one. |
| [__init__](/slides/python-net/aspose.slides/summaryzoomsection/#) | Returns a basic placeholder shape (shape from the layout and/or master slide that the current shape is inherited from). |
