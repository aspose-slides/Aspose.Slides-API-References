...
| [encryption_password](/slides/python-net/aspose.slides/encryption_password) | Returns encryption password.<br/>            Read-only :py:class:`System.String`. |
...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides/iprotectionmanager/#string) | Encrypts Presentation with specified password. |
| [__init__](/slides/python-net/aspose.slides/iprotectionmanager/#) | Removes the encryption. |
| [__init__](/slides/python-net/aspose.slides/iprotectionmanager/#string) | Set write protection for this presentation with specified password. |
| [__init__](/slides/python-net/aspose.slides/iprotectionmanager/#) | Removes write protection for this presentation. |
| [__init__](/slides/python-net/aspose.slides/iprotectionmanager/#string) | Determines whether a presentation is a password protected to modify. |
