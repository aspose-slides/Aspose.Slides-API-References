...
| [`delete_embedded_binary_objects`](/slides/python-net/aspose.slides/iloadoptions/delete_embedded_binary_objects/) | Determines if Aspose.Slides will delete all embedded binary objects while presentation loading.<br/>            <br/>The types of the embedded binary objects:<br/><br/><br/>* VBA Project [`IPresentation.vba_project`](/slides/python-net/aspose.slides/ipresentation/vba_project)<br/>* OLE Object embedded data [`IOleEmbeddedDataInfo.embedded_file_data`](/slides/python-net/aspose.slides/ioleembeddeddatainfo/embedded_file_data)<br/>* ActiveX Control binary data [`IControl.active_x_control_binary`](/slides/python-net/aspose.slides/icontrol/active_x_control_binary)<br/><br/><br/>            Read/write **bool**. |
