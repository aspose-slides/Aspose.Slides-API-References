...
| [get_base_placeholder](/slides/python-net/aspose.slides/sectionzoomframe/sectionzoomframe/#/) | Returns a basic placeholder shape (shape from the layout and/or master slide that the current shape is inherited from).<br/>            A null is returned if the current shape is not inherited. |
