...
| [`get_thumbnail`](/slides/python-net/aspose.slides/sectionzoomframe/get_thumbnail/#asposeslidesshapethumbnailbounds-float-float) | Returns shape thumbnail. |
...
| [`get_image`](/slides/python-net/aspose.slides/sectionzoomframe/get_image/#asposeslidesshapethumbnailbounds-float-float) | Returns shape thumbnail. |
...
| [`add_placeholder`](/slides/python-net/aspose.slides/sectionzoomframe/add_placeholder/#asposeslidesiplaceholder) | Adds a new placeholder if there is no and sets placeholder properties to a specified one. |
