...
| [rewind_video](/slides/python-net/aspose.slides/rewind_video) | Determines whether a video is automatically rewinded to start<br/>            as soon as the movie has finished playing.<br/>            Read/write :py:class:`bool`. |
| [play_loop_mode](/slides/python-net/aspose.slides/play_loop_mode) | Determines whether a video is looped.<br/>            Read/write :py:class:`bool`. |
| [hide_at_showing](/slides/python-net/aspose.slides/hide_at_showing) | Determines whether a VideoFrame is hidden.<br/>            Read/write :py:class:`bool`. |
...
| [play_mode](/slides/python-net/aspose.slides/play_mode) | Returns or sets the video play mode.<br/>            Read/write :py:enum:`aspose.slides.VideoPlayModePreset`. |
| [full_screen_mode](/slides/python-net/aspose.slides/full_screen_mode) | Determines whether a video is shown in full screen mode.<br/>            Read/write :py:class:`bool`. |
| [link_path_long](/slides/python-net/aspose.slides/link_path_long) | Returns or sets the name of an video file which is linked to a VideoFrame.<br/>            Read/write :py:class:`System.String`. |
| [embedded_video](/slides/python-net/aspose.slides/embedded_video) | Returns or sets embedded video object.<br/>            Read/write :py:class:`aspose.slides.IVideo`. |
| [trim_from_start](/slides/python-net/aspose.slides/trim_from_start) | Trim start [ms] |
| [trim_from_end](/slides/python-net/aspose.slides/trim_from_end) | Trim end [ms] |
...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides/videoframe/#) | Returns shape thumbnail.<br/>            ShapeThumbnailBounds.Shape shape thumbnail bounds type is used by default. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#ShapeThumbnailBounds-float-float) | Returns shape thumbnail. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#System.IO.Stream) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#System.IO.Stream-aspose.slides.export.ISVGOptions) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#) | Defines that this shape isn't a placeholder. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#IPlaceholder) | Adds a new placeholder if there is no and sets placeholder properties to a specified one. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#) | Returns a basic placeholder shape (shape from the layout and/or master slide that the current shape is inherited from). |
| [__init__](/slides/python-net/aspose.slides/videoframe/#) | Returns the copy of path of the geometry shape. Coordinates are relative to the left top corner of the shape. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#IGeometryPath) | Updates shape geometry from :py:class:`aspose.slides.IGeometryPath` object. Coordinates must be relative to the left<br/>             top corner of the shape.<br/>             Changes the type of the shape (:py:attr:`aspose.slides.GeometryShape.shape_type`) to :py:attr:`aspose.slides.ShapeType.CUSTOM`. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#List[IGeometryPath]) | Updates shape geometry from array of :py:class:`aspose.slides.IGeometryPath`. Coordinates must be relative to the left<br/>             top corner of the shape.<br/>             Changes the type of the shape (:py:attr:`aspose.slides.GeometryShape.shape_type`) to :py:attr:`aspose.slides.ShapeType.CUSTOM`. |
| [__init__](/slides/python-net/aspose.slides/videoframe/#) | Creates and returns array of shape's elements. |
