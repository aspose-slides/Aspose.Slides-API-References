...
| [solid_fill_color](/slides/python-net/aspose.slides/ifillformateffectivedata/solid_fill_color/) | Returns the fill color.<br/>            Read-only .NET type System.Drawing.Color. |
...
| [rotate_with_shape](/slides/python-net/aspose.slides/ifillformateffectivedata/rotate_with_shape/) | Determines whether the fill should be rotated with shape.<br/>            Read-only .NET type System.Boolean. |
