...
| :- | :- |
| [`content_type`](/slides/python-net/aspose.slides/ivideo/content_type/) | Returns a MIME type of an video, encoded in [`IVideo.binary_data`](/slides/python-net/aspose.slides/ivideo#binary_data).<br/>            Read-only **string**. |
