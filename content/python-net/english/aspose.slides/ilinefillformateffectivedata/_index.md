...
| [`solid_fill_color`](/slides/python-net/aspose.slides/ilinefillformateffectivedata/solid_fill_color/) | Returns the color of a solid fill.<br/>            Read-only [`Color`](/slides/python-net/aspose.slides/color). |
