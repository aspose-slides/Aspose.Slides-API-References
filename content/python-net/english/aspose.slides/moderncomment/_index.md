...
| [`position`](/slides/python-net/aspose.slides/moderncomment/position/) | Returns or sets the position of a comment on a slide.<br/>            Read/write [`PointF`](/slides/python-net/aspose.slides/pointf). |
