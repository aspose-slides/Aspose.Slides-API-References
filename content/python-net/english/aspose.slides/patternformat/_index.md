...
| :- | :- |
| [as_i_presentation_component](/slides/python-net/aspose.slides/patternformat/as_i_presentation_component/) | Allows to get base IPresentationComponent interface.<br/>            Read-only [`IPresentationComponent`](/slides/python-net/aspose.slides/ipresentationcomponent). |
...
| Method | Description |
| :- | :- |
| [get_tile_image](/slides/python-net/aspose.slides/patternformat/get_tile_image/#aspose.pydrawing.Color-aspose.pydrawing.Color/) | Creates a tile image for the pattern fill with a specified colors. |
| [get_tile_image](/slides/python-net/aspose.slides/patternformat/get_tile_image/#aspose.pydrawing.Color/) | Creates a tile image for the pattern fill. |
