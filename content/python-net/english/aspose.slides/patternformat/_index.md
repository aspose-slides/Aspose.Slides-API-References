...
| Method | Description |
| :- | :- |
| [`get_tile(self, background, foreground)`](/slides/python-net/aspose.slides/patternformat/get_tile/#asposeslidescolor-asposeslidescolor) | Creates a tile image for the pattern fill with a specified colors. |
| [`get_tile(self, style_color)`](/slides/python-net/aspose.slides/patternformat/get_tile/#asposeslidescolor) | Creates a tile image for the pattern fill. |
