...
| :- | :- |
| [as_i_base_table_format_effective_data](/slides/python-net/aspose.slides/icolumnformateffectivedata/as_i_base_table_format_effective_data/) | Allows to get base IBaseTableFormatEffectiveData interface.<br/>            Read-only [`IBaseTableFormatEffectiveData`](/slides/python-net/aspose.slides/ibasetableformateffectivedata). |
...
This interface is used together with the [`IColumnFormat`](/slides/python-net/aspose.slides/icolumnformat) interface to return effective formatting values with inheritance and table styles applied.
