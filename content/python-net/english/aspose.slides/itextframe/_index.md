...
| [`replace_regex(self, regex, new_text)`](/slides/python-net/aspose.slides/itextframe/replace_regex/#str-str) | Replaces all matches of regular expression with specified string. |
