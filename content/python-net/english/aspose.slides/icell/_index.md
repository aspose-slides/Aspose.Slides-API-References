...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides/icell/#int) | Splits the cell to two cells by index of column. |
| [__init__](/slides/python-net/aspose.slides/icell/#int) | Splits the cell to two cells by index of row. |
| [__init__](/slides/python-net/aspose.slides/icell/#float) | Splits the cell by height. |
| [__init__](/slides/python-net/aspose.slides/icell/#float) | Splits the cell by width. |
