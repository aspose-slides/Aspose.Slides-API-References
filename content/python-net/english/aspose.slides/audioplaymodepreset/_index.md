...
| ALL_SLIDES | Play on all slides. <br/>            Please use <br/>[`IAudioFrame.play_across_slides`](/slides/python-net/aspose.slides/iaudioframe#play_across_slides)<br/> property instead.<br/>            <br/>This element is out of date since PowerPoint 2013. |
