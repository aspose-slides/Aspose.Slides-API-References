...
| [to_array](/slides/python-net/aspose.slides/slidecollection/slidecollection/#int-int/) | Creates and returns an array with all slides from the specified range in it.<br/>            An index of a first slide to add.A number of slides to add. |
