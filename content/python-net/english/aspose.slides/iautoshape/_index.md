...
| [use_background_fill](/slides/python-net/aspose.slides/iautoshape/use_background_fill/) | Determines whether this autoshape should be filled with slide's background fill instead of specified by style or fill format.<br/>            Read/write .NET type System.Boolean. |
| [is_text_box](/slides/python-net/aspose.slides/iautoshape/is_text_box/) | Specifies if the shape is a text box. |
| [as_i_geometry_shape](/slides/python-net/aspose.slides/iautoshape/as_i_geometry_shape/) | Allows to get base IGeometryShape interface.<br/>            Read-only [`IGeometryShape`](/slides/python-net/aspose.slides/igeometryshape). |
