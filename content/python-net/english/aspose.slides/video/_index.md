...
| :- | :- |
| [`content_type`](/slides/python-net/aspose.slides/video/content_type/) | Returns a MIME type of an video, encoded in [`Video.binary_data`](/slides/python-net/aspose.slides/video#binary_data).<br/>            Read-only **string**. |
