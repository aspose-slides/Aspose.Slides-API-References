...
| [`get_visual_bounds`](/slides/python-net/aspose.slides/autoshape/get_visual_bounds/#) | Gets the visual bounds of the shape calculated from its rendered content. |
