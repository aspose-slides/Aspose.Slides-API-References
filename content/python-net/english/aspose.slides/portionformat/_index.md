...
| [`language_id`](/slides/python-net/aspose.slides/portionformat/language_id/) | Returns or sets the Id of a proofing language. Used for checking spelling and grammar.<br/>            Read/write **str**. |
| [`alternative_language_id`](/slides/python-net/aspose.slides/portionformat/alternative_language_id/) | Returns or sets the Id of an alternative language.<br/>            Read/write **str**. |
...
| [`spell_check`](/slides/python-net/aspose.slides/portionformat/spell_check/) | Gets or sets a value indicating whether spell checking is enabled for the text portion.<br/>            When this property is set to false, spelling checks for text elements are suppressed.<br/>            When set to true, spell checking is allowed.<br/>            Default value is `false`. |
| [`bookmark_id`](/slides/python-net/aspose.slides/portionformat/bookmark_id/) | Returns or sets bookmark identifier.<br/>            Read/write **str**. |
