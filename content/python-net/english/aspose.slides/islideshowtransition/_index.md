...
| [sound_loop](/slides/python-net/aspose.slides/islideshowtransition/sound_loop/) | This attribute specifies if the sound will loop until the next sound event occurs in<br/>            slideshow.<br/>            Read-write .NET type System.Boolean. |
| [advance_on_click](/slides/python-net/aspose.slides/islideshowtransition/advance_on_click/) | Specifies whether a mouse click will advance the slide or not. If this attribute is not<br/>            specified then a value of true is assumed.<br/>            Read-write .NET type System.Boolean. |
| [advance_after](/slides/python-net/aspose.slides/islideshowtransition/advance_after/) | This attribute specifies if the slideshow will move to the next slide after a certain time.<br/>            Read/write .NET type System.Boolean. |
