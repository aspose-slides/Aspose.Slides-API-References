...
| [`duration`](/slides/python-net/aspose.slides/islideshowtransition/duration/) | Gets or sets the duration of the slide transition effect in milliseconds.<br/>            Read/write **int**. |
