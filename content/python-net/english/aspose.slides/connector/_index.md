...
| [shape_lock](/slides/python-net/aspose.slides/shape_lock) | Returns shape's locks.<br/>            Read-only :py:class:`aspose.slides.IConnectorLock`. |
...
| [shape_type](/slides/python-net/aspose.slides/shape_type) | Returns or sets the AutoShape type.<br/>            Read/write :py:enum:`aspose.slides.ShapeType`. |
...
| [connector_lock](/slides/python-net/aspose.slides/connector_lock) | Returns connector's locks.<br/>            Read-only :py:class:`aspose.slides.IConnectorLock`. |
| [start_shape_connected_to](/slides/python-net/aspose.slides/start_shape_connected_to) | Returns or sets the shape to attach the beginning of the connector to.<br/>            Read/write :py:class:`aspose.slides.IShape`. |
| [end_shape_connected_to](/slides/python-net/aspose.slides/end_shape_connected_to) | Returns or sets the shape to attach the end of the connector to.<br/>            Read/write :py:class:`aspose.slides.IShape`. |
| [start_shape_connection_site_index](/slides/python-net/aspose.slides/start_shape_connection_site_index) | Returns or sets the index of connection site for start shape.<br/>            Read/write :py:class:`int`. |
| [end_shape_connection_site_index](/slides/python-net/aspose.slides/end_shape_connection_site_index) | Returns or sets the index of connection site for end shape.<br/>            Read/write :py:class:`int`. |
...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides/connector/#) | Returns shape thumbnail.<br/>            ShapeThumbnailBounds.Shape shape thumbnail bounds type is used by default. |
| [__init__](/slides/python-net/aspose.slides/connector/#ShapeThumbnailBounds-float-float) | Returns shape thumbnail. |
| [__init__](/slides/python-net/aspose.slides/connector/#System.IO.Stream) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides/connector/#System.IO.Stream-aspose.slides.export.ISVGOptions) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides/connector/#) | Defines that this shape isn't a placeholder. |
| [__init__](/slides/python-net/aspose.slides/connector/#IPlaceholder) | Adds a new placeholder if there is no and sets placeholder properties to a specified one. |
| [__init__](/slides/python-net/aspose.slides/connector/#) | Returns a basic placeholder shape (shape from the layout and/or master slide that the current shape is inherited from). |
| [__init__](/slides/python-net/aspose.slides/connector/#) | Returns the copy of path of the geometry shape. Coordinates are relative to the left top corner of the shape. |
| [__init__](/slides/python-net/aspose.slides/connector/#IGeometryPath) | Updates shape geometry from :py:class:`aspose.slides.IGeometryPath` object. Coordinates must be relative to the left<br/>             top corner of the shape.<br/>             Changes the type of the shape (:py:attr:`aspose.slides.GeometryShape.shape_type`) to :py:attr:`aspose.slides.ShapeType.CUSTOM`. |
| [__init__](/slides/python-net/aspose.slides/connector/#List[IGeometryPath]) | Updates shape geometry from array of :py:class:`aspose.slides.IGeometryPath`. Coordinates must be relative to the left<br/>             top corner of the shape.<br/>             Changes the type of the shape (:py:attr:`aspose.slides.GeometryShape.shape_type`) to :py:attr:`aspose.slides.ShapeType.CUSTOM`. |
| [__init__](/slides/python-net/aspose.slides/connector/#) | Creates and returns array of shape's elements. |
| [__init__](/slides/python-net/aspose.slides/connector/#) | Reroutes connector so that it take the shortest possible path between the shapes it connect. |
