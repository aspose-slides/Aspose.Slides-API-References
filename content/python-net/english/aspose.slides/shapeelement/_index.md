...
| [`graphics_path`](/slides/python-net/aspose.slides/shapeelement/graphics_path/) | Returns an element's path.<br/>            Read-only **aspose.pydrawing.Drawing2D.GraphicsPath**. |
