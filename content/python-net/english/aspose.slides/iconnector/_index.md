...
| [start_shape_connection_site_index](/slides/python-net/aspose.slides/iconnector/start_shape_connection_site_index/) | Returns or sets the index of connection site for start shape.<br/>            Read/write .NET type System.UInt32. |
| [end_shape_connection_site_index](/slides/python-net/aspose.slides/iconnector/end_shape_connection_site_index/) | Returns or sets the index of connection site for end shape.<br/>            Read/write .NET type System.UInt32. |
