...
description: 
type: docs
url: /aspose.slides/ilayoutplaceholdermanager/add_content_placeholder/
weight: 20
---


## add_content_placeholder {#float-float-float-float}
Adds a new placeholder shape to the layout slide to hold content, such as a picture, table, media or text.

### Returns

Created [`IAutoShape`](/slides/python-net/aspose.slides/iautoshape) with a Content placeholder.
