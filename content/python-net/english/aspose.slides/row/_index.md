...
| Method | Description |
| :- | :- |
| [`set_text_format(self, source)`](/slides/python-net/aspose.slides/row/set_text_format/#iportionformat) | Sets defined portion format properties to all row cells' portions. |
| [`set_text_format(self, source)`](/slides/python-net/aspose.slides/row/set_text_format/#iparagraphformat) | Sets defined paragraph format properties to all row cells' paragraphs. |
| [`set_text_format(self, source)`](/slides/python-net/aspose.slides/row/set_text_format/#itextframeformat) | Sets defined text frame format properties to all row cells' text frames. |
