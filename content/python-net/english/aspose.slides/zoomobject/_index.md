...
| [`alternative_text`](/slides/python-net/aspose.slides/zoomobject/alternative_text/) | Returns or sets the alternative text associated with a shape.<br/>            Read/write **string**. |
| [`alternative_text_title`](/slides/python-net/aspose.slides/zoomobject/alternative_text_title/) | Returns or sets the title of alternative text associated with a shape.<br/>            Read/write **string**. |
| [`name`](/slides/python-net/aspose.slides/zoomobject/name/) | Returns or sets the name of a shape.<br/>            Must be not null. Use empty string value if needed.<br/>            Read/write **string**. |
