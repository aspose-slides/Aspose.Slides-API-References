...
The IDrawingGuide type exposes the following members:
...
| [`color`](/slides/python-net/aspose.slides/idrawingguide/color/) | Returns or sets color of the drawing guide.<br/>            Read/write **aspose.pydrawing.Color**. |
