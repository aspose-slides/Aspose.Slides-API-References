...
| :- | :- |
| [`xml_as_string`](/slides/python-net/aspose.slides/icustomxmlpart/xml_as_string/) | Returns or sets xml data as UTF-8 string.<br/>            Read/write **str**.<br/>            value is `null`.value is empty or xml-data is invalid. |
