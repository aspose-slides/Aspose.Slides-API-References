...
description: 
type: docs
url: /aspose.slides/hyperlinkmanager/set_macro_hyperlink_click/
weight: 70
---


## set_macro_hyperlink_click(self, macro_name) {#str}
...
```python
def set_macro_hyperlink_click(self, macro_name):
    ...
```
