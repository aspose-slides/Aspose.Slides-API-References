...
| Method | Description |
| :- | :- |
| [`replace_image(self, new_image_data)`](/slides/python-net/aspose.slides/ppimage/replace_image/#bytes) | Replaces image data.<br/>            The new image's data.When newImageData parameter is None. |
| [`replace_image(self, new_image)`](/slides/python-net/aspose.slides/ppimage/replace_image/#iimage) | Replaces image data. Attention: when Image is metafile - it will be rasterized. Use ReplaceImage(byte[]) instead<br/>            The new image.When newImage parameter is None. |
| [`replace_image(self, new_image)`](/slides/python-net/aspose.slides/ppimage/replace_image/#ippimage) | Replaces image data.<br/>            The new IPPImage.When newImage parameter is None. |
