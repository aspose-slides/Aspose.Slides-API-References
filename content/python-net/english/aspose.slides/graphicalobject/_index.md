...
| [`name`](/slides/python-net/aspose.slides/graphicalobject/name/) | Returns or sets the name of a shape.<br/>            Must be not null. Use empty string value if needed.<br/>            Read/write **str**. |
