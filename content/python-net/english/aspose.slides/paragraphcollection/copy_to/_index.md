...
| :- | :- | :- |
| array | List[IParagraph] | The one-dimensional .NET type System.Array that is the destination of the elements copied from .NET type System.Collections.Generic.ICollection`1. The .NET type System.Array must have zero-based indexing. |
