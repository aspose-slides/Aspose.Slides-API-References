...
| WIPE |  |
| ZOOM | Relates to transition Shape (with options In/Out) in PowerPoint 2010.<br/>            See also <br/>[`TransitionType.WARP`](/slides/python-net/aspose.slides.slideshow/transitiontype#WARP) that relates to transition Zoom in PowerPoint 2010. |
