...
| :- | :- |
| [from_black](/slides/python-net/aspose.slides.slideshow/from_black) | This attribute specifies if the transition will start from a black screen<br/>            (and then transition the new slide over black).<br/>            Read/write :py:class:`bool`. |
