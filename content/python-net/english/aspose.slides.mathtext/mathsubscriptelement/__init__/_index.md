---
title: MathSubscriptElement constructor
second_title: Aspose.Slides for Python via .NET API Reference
description: 
type: docs
url: /aspose.slides.mathtext/mathsubscriptelement/__init__/
weight: 10
---


## __init__(self, base_arg, sub_script) {#imathelement-imathelement}
Initializes a new instance of the MathSubscriptElement class.


```python
def __init__(self, base_arg, sub_script):
    ...
```
