...
| :- | :- |
| [count](/slides/python-net/aspose.slides.mathtext/imathelementcollection/count/) | Gets the number of elements actually contained in the collection.<br/>            Read-only :py:class:`int`. |
| [as_i_enumerable](/slides/python-net/aspose.slides.mathtext/imathelementcollection/as_i_enumerable/) | Returns IEnumerable interface.<br/>            Read-only :py:class:`collections.abc.Iterable`. |
