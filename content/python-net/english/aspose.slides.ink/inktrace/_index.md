...
| :- | :- |
| [brush](/slides/python-net/aspose.slides.ink/brush) | Gets Brush for the IInkLine :py:class:`aspose.slides.ink.IInkBrush`<br/>            Read-only. |
| [points](/slides/python-net/aspose.slides.ink/points) | Gets points for the IInkLine :py:class:`aspose.pydrawing.PointF`<br/>            Read-only. |
