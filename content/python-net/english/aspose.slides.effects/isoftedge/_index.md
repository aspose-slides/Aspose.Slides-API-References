...
| :- | :- |
| [radius](/slides/python-net/aspose.slides.effects/radius) | Specifies the radius of blur to apply to the edges.<br/>            Read/write :py:class:`float`. |
...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides.effects/isoftedge/#) |  |
