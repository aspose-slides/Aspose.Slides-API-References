...
| :- | :- |
| [as_i_presentation_component](/slides/python-net/aspose.slides.effects/alphabilevel/as_i_presentation_component/) | Allows to get base IPresentationComponent interface.<br/>            Read-only :py:class:`aspose.slides.IPresentationComponent`. |
| [threshold](/slides/python-net/aspose.slides.effects/alphabilevel/threshold/) | Returns effect threshold.<br/>            Read/write :py:class:`float`. |
