...
| :- | :- |
| [as_i_effect_effective_data](/slides/python-net/aspose.slides.effects/igrayscaleeffectivedata/as_i_effect_effective_data/) | Allows to get base IEffectEffectiveData interface.<br/>            Read-only :py:class:`aspose.slides.effects.IEffectEffectiveData`. |
