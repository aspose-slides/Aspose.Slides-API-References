...
| :- | :- |
| [`color`](/slides/python-net/aspose.slides.effects/icolorreplaceeffectivedata/color/) | Returns color format which will replace color of every pixel.<br/>            Read-only **aspose.slides.Color**. |
