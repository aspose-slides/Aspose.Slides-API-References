...
| :- | :- |
| [`as_i_presentation_component`](/slides/python-net/aspose.slides.effects/alphamodulate/as_i_presentation_component/) | Allows to get base IPresentationComponent interface.<br/>            Read-only [`IPresentationComponent`](/slides/python-net/aspose.slides/ipresentationcomponent). |
...
| [`as_i_image_transform_operation`](/slides/python-net/aspose.slides.effects/alphamodulate/as_i_image_transform_operation/) |  |
...
### See Also
* class [`AlphaModulate`](/slides/python-net/aspose.slides.effects/alphamodulate)
