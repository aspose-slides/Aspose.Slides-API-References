...
| :- | :- |
| [as_i_presentation_component](/slides/python-net/aspose.slides.effects/alphamodulatefixed/as_i_presentation_component/) | Allows to get base IPresentationComponent interface.<br/>            Read-only <br/>[`IPresentationComponent`](/slides/python-net/aspose.slides/ipresentationcomponent)<br/>. |
| [amount](/slides/python-net/aspose.slides.effects/alphamodulatefixed/amount/) | Returns an amount of effect in percents.<br/>            Read/write <br/>.NET type System.Single<br/>. |
...
| Method | Description |
| :- | :- |
| [get_effective](/slides/python-net/aspose.slides.effects/alphamodulatefixed/alphamodulatefixed/#/) | Gets effective Alpha Modulate Fixed effect data with the inheritance applied. |
