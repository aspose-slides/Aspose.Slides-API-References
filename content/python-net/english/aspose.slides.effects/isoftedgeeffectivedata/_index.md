...
| :- | :- |
| [radius](/slides/python-net/aspose.slides.effects/isoftedgeeffectivedata/radius/) | Specifies the radius of blur to apply to the edges.<br/>            Read-only .NET type System.Double. |
