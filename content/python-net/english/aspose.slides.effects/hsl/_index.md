...
| Method | Description |
| :- | :- |
| [`get_effective(self)`](/slides/python-net/aspose.slides.effects/hsl/get_effective/#) | Gets effective Hue/Saturation/Luminance effect data with the inheritance applied. |
