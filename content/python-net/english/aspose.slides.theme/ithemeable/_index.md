...
| :- | :- |
| [as_i_slide_component](/slides/python-net/aspose.slides.theme/ithemeable/as_i_slide_component/) | Returns ISlideComponent interface.<br/>            Read-only :py:class:`aspose.slides.ISlideComponent`. |
