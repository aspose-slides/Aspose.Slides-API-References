...
| :- | :- |
| [theme_manager](/slides/python-net/aspose.slides.theme/imasterthemeable/theme_manager/) | Returns master theme manager.<br/>            Read-only :py:class:`aspose.slides.theme.IMasterThemeManager`. |
| [as_i_themeable](/slides/python-net/aspose.slides.theme/imasterthemeable/as_i_themeable/) | Returns IThemeable interface.<br/>            Read-only :py:class:`aspose.slides.theme.IThemeable`. |
