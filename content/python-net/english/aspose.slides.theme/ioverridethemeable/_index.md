...
| :- | :- |
| [theme_manager](/slides/python-net/aspose.slides.theme/ioverridethemeable/theme_manager/) | Returns override theme manager.<br/>            Read-only <br/>[`IOverrideThemeManager`](/slides/python-net/aspose.slides.theme/ioverridethememanager). |
| [as_i_themeable](/slides/python-net/aspose.slides.theme/ioverridethemeable/as_i_themeable/) | Returns IThemeable interface.<br/>            Read-only <br/>[`IThemeable`](/slides/python-net/aspose.slides.theme/ithemeable). |
