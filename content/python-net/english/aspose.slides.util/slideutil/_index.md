...
| Method | Description |
| :- | :- |
| [`find_shape`](/slides/python-net/aspose.slides.util/slideutil/find_shape/#ipresentation-string) | Find shape by alternative text in a PPTX presentation. |
| [`find_shape`](/slides/python-net/aspose.slides.util/slideutil/find_shape/#ibaseslide-string) | Find shape by alternative text on a slide in a PPTX presentation. |
...
| [`align_shapes`](/slides/python-net/aspose.slides.util/slideutil/align_shapes/#shapesalignmenttype-bool-igroupshape-listint) | Changes the placement of selected shapes within group shape. Aligns shapes to the margins or the edge of the slide<br/>            or align them relative to each other. |
| [`find_and_replace_text`](/slides/python-net/aspose.slides.util/slideutil/find_and_replace_text/#ipresentation-bool-string-string-portionformat) | Finds and replaces text in presentation with given format |
