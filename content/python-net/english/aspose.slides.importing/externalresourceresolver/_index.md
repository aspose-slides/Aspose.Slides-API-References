...
| :- | :- |
| [`__init__(self)`](/slides/python-net/aspose.slides.importing/externalresourceresolver/__init__/#) |  |

## Methods

| Method | Description |
| :- | :- |
| [`resolve_uri(self, base_uri, relative_uri)`](/slides/python-net/aspose.slides.importing/externalresourceresolver/resolve_uri/#str-str) | Resolves the absolute URI from the base and relative URIs. |
| [`get_entity(self, absolute_uri)`](/slides/python-net/aspose.slides.importing/externalresourceresolver/get_entity/#str) | Maps a URI to an object containing the actual resource. |
