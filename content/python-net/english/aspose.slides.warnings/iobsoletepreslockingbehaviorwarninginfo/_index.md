...
| :- | :- |
| [as_i_warning_info](/slides/python-net/aspose.slides.warnings/iobsoletepreslockingbehaviorwarninginfo/as_i_warning_info/) | Returns IWarningInfo interface.<br/>            Read-only :py:class:`aspose.slides.warnings.IWarningInfo`. |
