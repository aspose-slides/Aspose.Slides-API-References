...
| [`alternative_text`](/slides/python-net/aspose.slides.smartart/smartartshape/alternative_text/) | Returns or sets the alternative text associated with a shape.<br/>            Read/write **string**. |
| [`alternative_text_title`](/slides/python-net/aspose.slides.smartart/smartartshape/alternative_text_title/) | Returns or sets the title of alternative text associated with a shape.<br/>            Read/write **string**. |
| [`name`](/slides/python-net/aspose.slides.smartart/smartartshape/name/) | Returns or sets the name of a shape.<br/>            Must be not null. Use empty string value if needed.<br/>            Read/write **string**. |
...
| [`write_as_svg`](/slides/python-net/aspose.slides.smartart/smartartshape/write_as_svg/#systemiostream) | Saves content of Shape as SVG file. |
| [`write_as_svg`](/slides/python-net/aspose.slides.smartart/smartartshape/write_as_svg/#systemiostream-asposeslidesexportisvgoptions) | Saves content of Shape as SVG file. |
