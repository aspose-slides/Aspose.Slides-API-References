...
| [shape_lock](/slides/python-net/aspose.slides.smartart/shape_lock) | Returns shape's locks.<br/>            Read-only :py:class:`aspose.slides.IBaseShapeLock`. |
...
| [shape_style](/slides/python-net/aspose.slides.smartart/shape_style) | Returns shape's style object.<br/>            Read-only :py:class:`aspose.slides.IShapeStyle`. |
| [shape_type](/slides/python-net/aspose.slides.smartart/shape_type) | Returns or sets the geometry preset type.<br/>            Note: on value changing all adjustment values will reset to their default values.<br/>            Read/write :py:enum:`aspose.slides.ShapeType`. |
| [adjustments](/slides/python-net/aspose.slides.smartart/adjustments) | Returns a collection of shape's adjustment values.<br/>            Read-only :py:class:`aspose.slides.IAdjustValueCollection`. |
| [text_frame](/slides/python-net/aspose.slides.smartart/text_frame) | Returns text of the SmartArt shape.<br/>            Read-only :py:class:`aspose.slides.ITextFrame`. |
...
| [as_i_geometry_shape](/slides/python-net/aspose.slides.smartart/as_i_geometry_shape) |  |

## Methods

| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#) | Returns shape thumbnail.<br/>            ShapeThumbnailBounds.Shape shape thumbnail bounds type is used by default. |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#ShapeThumbnailBounds-float-float) |  |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#System.IO.Stream) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#System.IO.Stream-aspose.slides.export.ISVGOptions) | Saves content of Shape as SVG file. |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#) | Defines that this shape isn't a placeholder. |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#IPlaceholder) |  |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#) | Returns a basic placeholder shape (shape from the layout and/or master slide that the current shape is inherited from). |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#) | Returns the copy of path of the geometry shape. Coordinates are relative to the left top corner of the shape. |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#IGeometryPath) |  |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#List[IGeometryPath]) |  |
| [__init__](/slides/python-net/aspose.slides.smartart/smartartshape/#) | Creates and returns array of shape's elements. |
