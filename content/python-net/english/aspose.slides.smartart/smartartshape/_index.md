...
| [`add_placeholder`](/slides/python-net/aspose.slides.smartart/smartartshape/add_placeholder/#iplaceholder) | Adds a new placeholder if there is no and sets placeholder properties to a specified one. |
...
| [`get_visual_bounds`](/slides/python-net/aspose.slides.smartart/smartartshape/get_visual_bounds/#) | Gets the visual bounds of the shape calculated from its rendered content. |
