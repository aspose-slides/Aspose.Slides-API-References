...
| [is_assistant](/slides/python-net/aspose.slides.smartart/ismartartnode/is_assistant/) | Returns or sets the node as assistant.<br/>            Read/write .NET type System.Boolean. |
| [level](/slides/python-net/aspose.slides.smartart/ismartartnode/level/) | Returns nesting level of the node.<br/>            Read-only .NET type System.Int32. |
| [bullet_fill_format](/slides/python-net/aspose.slides.smartart/ismartartnode/bullet_fill_format/) | Returns the FillFormat object that contains fill formatting properties for a node bullet.<br/>            Note: can return null for certain types of SmartArt layout which does not provide bullets for nodes.<br/>            Read-only [`IFillFormat`](/slides/python-net/aspose.slides/ifillformat). |
| [position](/slides/python-net/aspose.slides.smartart/ismartartnode/position/) | Returns or sets zero-based position of the node among sibling nodes.<br/>            Read/write .NET type System.Int32. |
| [is_hidden](/slides/python-net/aspose.slides.smartart/ismartartnode/is_hidden/) | Returns true if this node is a hidden node in the data model.<br/>            Read-only .NET type System.Boolean. |
