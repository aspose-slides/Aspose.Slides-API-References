...
| :- | :- |
| [`warning_callback`](/slides/python-net/aspose.slides.export/isaveoptions/warning_callback/) | Returns or sets an object which receives warnings and decides whether loading process will continue or will be aborted.<br/>            Read/write [`IWarningCallback`](/slides/python-net/aspose.slides.warnings/iwarningcallback). |
...
| [`gradient_style`](/slides/python-net/aspose.slides.export/isaveoptions/gradient_style/) | Returns or sets the visual style of the gradient.<br/>            Read/write [`ISaveOptions.gradient_style`](/slides/python-net/aspose.slides.export/isaveoptions#gradient_style). |
