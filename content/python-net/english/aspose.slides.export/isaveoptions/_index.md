...
| :- | :- |
| [warning_callback](/slides/python-net/aspose.slides.export/warning_callback) | Returns or sets an object which receives warnings and decides whether loading process will continue or will be aborted.<br/>            Read/write :py:class:`aspose.slides.warnings.IWarningCallback`. |
