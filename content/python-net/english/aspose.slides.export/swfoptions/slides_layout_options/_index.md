...
description: 
type: docs
url: /aspose.slides.export/swfoptions/slides_layout_options/
weight: 200
---


## slides_layout_options property
Gets or sets the mode in which slides are placed on the page when exporting a presentation [`ISlidesLayoutOptions`](/slides/python-net/aspose.slides.export/islideslayoutoptions). 
            This property doesn't support assigning objects of type [`HandoutLayoutingOptions`](/slides/python-net/aspose.slides.export/handoutlayoutingoptions)
