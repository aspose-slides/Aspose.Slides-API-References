...
| :- | :- |
| [`save_metafiles_as_png`](/slides/python-net/aspose.slides.export/ixpsoptions/save_metafiles_as_png/) | True to convert all metafiles used in a presentation to the PNG images.<br/>            Read/write **bool**. |
| [`draw_slides_frame`](/slides/python-net/aspose.slides.export/ixpsoptions/draw_slides_frame/) | True to draw black frame around each slide.<br/>             Read/write **bool**. |
...
| [`skip_java_script_links`](/slides/python-net/aspose.slides.export/ixpsoptions/skip_java_script_links/) |  |
