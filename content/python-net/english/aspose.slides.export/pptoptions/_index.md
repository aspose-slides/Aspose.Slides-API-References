...
| [`gradient_style`](/slides/python-net/aspose.slides.export/pptoptions/gradient_style/) | Returns or sets the visual style of the gradient.<br/>            Read/write [`SaveOptions.gradient_style`](/slides/python-net/aspose.slides.export/saveoptions#gradient_style). |
