...
| [`default_regular_font`](/slides/python-net/aspose.slides.export/html5options/default_regular_font/) | Returns or sets font used in case source font is not found.<br/>            Read-write **string**. |
...
| [`output_path`](/slides/python-net/aspose.slides.export/html5options/output_path/) | Determines where external resources should be stored. <br/>            Read/write **string**. |
