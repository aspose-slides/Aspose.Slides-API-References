...
| [`FrameTickEventArgs`](/slides/python-net/aspose.slides.export/frametickeventargs) | Represents arguments of the  event. |
...
| [`HtmlOptions`](/slides/python-net/aspose.slides.export/htmloptions) | Represents a HTML exporting options. |
| [`IEmbeddedEotFontsHtmlController`](/slides/python-net/aspose.slides.export/iembeddedeotfontshtmlcontroller) | Embedded Eot fonts HTML controller. |
| [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/aspose.slides.export/iembeddedwofffontshtmlcontroller) | Embedded woff fonts html controller. |
| [`IGifOptions`](/slides/python-net/aspose.slides.export/igifoptions) | Represents GIF exporting options. |
| [`IHtml5Options`](/slides/python-net/aspose.slides.export/ihtml5options) | Represents a HTML5 exporting options. |
| [`IHtmlFormatter`](/slides/python-net/aspose.slides.export/ihtmlformatter) | Represents HTML file template. |
...
| [`ISvgTSpan`](/slides/python-net/aspose.slides.export/isvgtspan) | Represents options for SVG text portion ("tspan"). |
| [`ISwfOptions`](/slides/python-net/aspose.slides.export/iswfoptions) | Provides options that control how a presentation is saved in SWF format. |
| [`ITextToHtmlConversionOptions`](/slides/python-net/aspose.slides.export/itexttohtmlconversionoptions) | Options for extracting HTML from the Pptx text. |
| [`ITiffOptions`](/slides/python-net/aspose.slides.export/itiffoptions) | Provides options that control how a presentation is saved in TIFF format. |
...
| [`PresentationAnimationsGenerator`](/slides/python-net/aspose.slides.export/presentationanimationsgenerator) | Represents a generator of the animations in the :py:class:`aspose.slides.Presentation`. |
| [`PresentationPlayer`](/slides/python-net/aspose.slides.export/presentationplayer) | Represents the player of animations associated with the :py:class:`aspose.slides.Presentation`. |
...
| [`SaveOptions`](/slides/python-net/aspose.slides.export/saveoptions) | Abstract class with options that control how a presentation is saved. |
| [`SaveOptionsFactory`](/slides/python-net/aspose.slides.export/saveoptionsfactory) | Allows to create save options' instances |
| [`SlideImageFormat`](/slides/python-net/aspose.slides.export/slideimageformat) | Determines format in which slide image will be saved for presentation to HTML export. |
| [`SvgShape`](/slides/python-net/aspose.slides.export/svgshape) | Represents options for SVG shape. |
| [`SvgTSpan`](/slides/python-net/aspose.slides.export/svgtspan) | Represents options for SVG text portion ("tspan"). |
| [`SwfOptions`](/slides/python-net/aspose.slides.export/swfoptions) | Provides options that control how a presentation is saved in Swf format. |
| [`TextToHtmlConversionOptions`](/slides/python-net/aspose.slides.export/texttohtmlconversionoptions) | Options for extracting HTML from the Pptx text. |
| [`TiffOptions`](/slides/python-net/aspose.slides.export/tiffoptions) | Provides options that control how a presentation is saved in TIFF format. |
| [`VideoPlayerHtmlController`](/slides/python-net/aspose.slides.export/videoplayerhtmlcontroller) | This class allows export of video and audio files into a HTML |
| [`VideoPlayerHtmlControllerFactory`](/slides/python-net/aspose.slides.export/videoplayerhtmlcontrollerfactory) | Allows to create VideoPlayerHtmlController. |
| [`XpsOptions`](/slides/python-net/aspose.slides.export/xpsoptions) | Provides options that control how a presentation is saved in XPS format. |
...
| [`EmbedFontCharacters`](/slides/python-net/aspose.slides.export/embedfontcharacters) | Represents the rule to use for adding new embedding font into :py:class:`aspose.slides.IPresentation` |
...
| [`PdfTextCompression`](/slides/python-net/aspose.slides.export/pdftextcompression) | Constants which define the type of a compression applied to all content in the PDF file except images. |
| [`PicturesCompression`](/slides/python-net/aspose.slides.export/picturescompression) | Represents the pictures compression level |
| [`SaveFormat`](/slides/python-net/aspose.slides.export/saveformat) | Constants which define the format of a saved presentation. |
| [`SvgCoordinateUnit`](/slides/python-net/aspose.slides.export/svgcoordinateunit) | Represents CSS2 coordinate units used to define SVG coordinates. |
| [`SvgEvent`](/slides/python-net/aspose.slides.export/svgevent) | Represents options for SVG shape. |
| [`SvgExternalFontsHandling`](/slides/python-net/aspose.slides.export/svgexternalfontshandling) | Represents a way to handle external fonts used for text drawing. |
| [`TextInheritanceLimit`](/slides/python-net/aspose.slides.export/textinheritancelimit) | Controls the depth of the text properties inheritance. |
| [`TiffCompressionTypes`](/slides/python-net/aspose.slides.export/tiffcompressiontypes) | Provides options that control how a presentation is compressed in TIFF format. |
