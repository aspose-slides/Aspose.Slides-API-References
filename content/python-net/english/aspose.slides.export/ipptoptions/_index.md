...
| [as_i_save_options](/slides/python-net/aspose.slides.export/ipptoptions/as_i_save_options/) | Returns ISaveOptions interface.<br/>            Read-only :py:class:`aspose.slides.export.ISaveOptions`. |
