...
| [`default_regular_font`](/slides/python-net/aspose.slides.export/htmloptions/default_regular_font/) | Returns or sets font used in case source font is not found.<br/>            Read-write **string**. |
