...
| :- | :- |
| [`__init__(self, link_embed_controller)`](/slides/python-net/aspose.slides.export/htmloptions/__init__/#ilinkembedcontroller) | Creates a new HtmlOptions object specifiing callback. |
| [`__init__(self)`](/slides/python-net/aspose.slides.export/htmloptions/__init__/#) | Creates a new HtmlOptions object for saving into single HTML file. |
