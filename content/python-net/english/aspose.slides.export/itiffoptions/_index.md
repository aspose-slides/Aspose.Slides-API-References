...
| :- | :- |
| [`image_size`](/slides/python-net/aspose.slides.export/itiffoptions/image_size/) | Specifies size of a generated TIFF image.<br/>            Default value is 0x0, what means that generated image sizes will be calculated based on presentation slide size value.<br/>            Read/write **aspose.slides.Size**. |
