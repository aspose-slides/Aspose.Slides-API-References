...
description: 
type: docs
url: /aspose.slides.charts/chartseries/trend_lines/
weight: 440
---
...
Collection of series trend lines.
            Read-only [`ITrendlineCollection`](/slides/python-net/aspose.slides.charts/itrendlinecollection).


### Remarks

TrendLines are available (not None) for data series in unstacked 2-D area, bar, column, line, 
