...
| [text_format](/slides/python-net/aspose.slides.charts/text_format) | Returns chart text format.<br/>            Read-only :py:class:`aspose.slides.charts.IChartTextFormat`. |
| [chart](/slides/python-net/aspose.slides.charts/chart) | Returns the chart.<br/>            Read-only :py:class:`aspose.slides.charts.IChart`. |
