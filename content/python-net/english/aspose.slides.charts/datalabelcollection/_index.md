...
| [is_visible](/slides/python-net/aspose.slides.charts/datalabelcollection/is_visible/) | False means that data label is not visible by default (and so all <br/>            Show*-flags (ShowValue, ...) of the DefaultDataLabelFormat property are false).<br/>            Read-only .NET type System.Boolean. |
| [count_of_visible_data_labels](/slides/python-net/aspose.slides.charts/datalabelcollection/count_of_visible_data_labels/) | Gets the number of visible data labels in the collection.<br/>            Read-only .NET type System.Int32. |
| [count](/slides/python-net/aspose.slides.charts/datalabelcollection/count/) | Gets the number of all data labels in the collection.<br/>            Read-only .NET type System.Int32. |
...
| [leader_lines_color](/slides/python-net/aspose.slides.charts/datalabelcollection/leader_lines_color/) | Gets or sets the color of all leader lines in the collection.<br/>            Read/write .NET type System.Drawing.Color. |
...
| Method | Description |
| :- | :- |
| [hide](/slides/python-net/aspose.slides.charts/datalabelcollection/datalabelcollection/#/) | Make data label hidden by default by setting all Show*-flags (ShowValue, ...) of the <br/>            DefaultDataLabelFormat property to false state.<br/>            IsVisible will be false after this. |
| [index_of](/slides/python-net/aspose.slides.charts/datalabelcollection/datalabelcollection/#IDataLabel/) | Returns an index of the specified DataLabel in the collection. |
