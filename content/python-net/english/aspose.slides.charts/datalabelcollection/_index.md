...
| Method | Description |
| :- | :- |
| [`hide(self)`](/slides/python-net/aspose.slides.charts/datalabelcollection/hide/#) | Make data label hidden by default by setting all Show*-flags (ShowValue, ...) of the <br/>            DefaultDataLabelFormat property to false state.<br/>            IsVisible will be false after this. |
| [`index_of(self, value)`](/slides/python-net/aspose.slides.charts/datalabelcollection/index_of/#idatalabel) | Returns an index of the specified DataLabel in the collection. |
