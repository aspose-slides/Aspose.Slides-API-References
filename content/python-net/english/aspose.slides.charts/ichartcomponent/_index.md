...
| [as_i_slide_component](/slides/python-net/aspose.slides.charts/ichartcomponent/as_i_slide_component/) | Allows to get base ISlideComponent interface.<br/>            Read-only [`ISlideComponent`](/slides/python-net/aspose.slides/islidecomponent). |
