...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides.charts/ioverridabletext/#string) | Initialize TextFrameForOverriding with the text in paramener "text".<br/>            If TextFrameForOverriding is already initialized then simply changes its text. |
