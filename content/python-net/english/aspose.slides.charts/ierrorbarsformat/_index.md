...
| [`has_end_cap`](/slides/python-net/aspose.slides.charts/ierrorbarsformat/has_end_cap/) | Specifies an end cap is not drawn on the error bars.<br/>            Read/write **bool**. |
