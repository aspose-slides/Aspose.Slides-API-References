...
| [category_axis_type](/slides/python-net/aspose.slides.charts/category_axis_type) | Specifies the type of the category axis.<br/>            Read/write :py:enum:`aspose.slides.charts.CategoryAxisType`. |
...
| [show_minor_grid_lines](/slides/python-net/aspose.slides.charts/show_minor_grid_lines) | To hide minor gridline set MinorGridLinesFormat.Line.FillFormat.FillType to FillType.NoFill.<br/>            Read-only :py:class:`bool`. |
| [show_major_grid_lines](/slides/python-net/aspose.slides.charts/show_major_grid_lines) | To hide major gridline set MajorGridLinesFormat.Line.FillFormat.FillType to FillType.NoFill.<br/>            Read-only :py:class:`bool`. |
...
| [text_format](/slides/python-net/aspose.slides.charts/text_format) | Represents format of text.<br/>             Read-only :py:class:`aspose.slides.charts.IChartTextFormat`. |
...
| [tick_label_spacing](/slides/python-net/aspose.slides.charts/tick_label_spacing) | Specifies how many tick labels to skip between label that is drawn. Applied to category or series axis.<br/>            Read/write :py:class:`int`. |
...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides.charts/axis/#) | Sets IAxis.CategoryAxisType property with a value that is automatically determined based on axis data. |
