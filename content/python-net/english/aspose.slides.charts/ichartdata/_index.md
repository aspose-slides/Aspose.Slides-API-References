...
| [`external_workbook_path`](/slides/python-net/aspose.slides.charts/ichartdata/external_workbook_path/) | Represents external workbook path if data source is external, None otherwise |
| [`embedded_workbook_type`](/slides/python-net/aspose.slides.charts/ichartdata/embedded_workbook_type/) | Gets the type of the embedded workbook.<br/>            Returns [`WorkbookType.NOT_DEFINED`](/slides/python-net/aspose.slides.charts/workbooktype/NOT_DEFINED) if [`IChartData.data_source_type`](/slides/python-net/aspose.slides.charts/ichartdata/data_source_type) is <br/>            [`ChartDataSourceType.EXTERNAL_WORKBOOK`](/slides/python-net/aspose.slides.charts/chartdatasourcetype/EXTERNAL_WORKBOOK).<br/>            Read-only [`WorkbookType`](/slides/python-net/aspose.slides.charts/workbooktype). |

## Methods

| Method | Description |
| :- | :- |
| [`set_external_workbook(self, workbook_path)`](/slides/python-net/aspose.slides.charts/ichartdata/set_external_workbook/#str) | Sets external workbook as a data source for the chart. Chart data will be updated from the target workbook. |
| [`set_external_workbook(self, workbook_path, update_chart_data)`](/slides/python-net/aspose.slides.charts/ichartdata/set_external_workbook/#str-bool) | Sets external workbook as a data source for the chart. |
| [`read_workbook_stream(self)`](/slides/python-net/aspose.slides.charts/ichartdata/read_workbook_stream/#) | Writes the internally contained Excel workbook it into an in-memory stream. |
| [`write_workbook_stream(self, ms)`](/slides/python-net/aspose.slides.charts/ichartdata/write_workbook_stream/#iorawiobase) | Initializes the internally contained Excel workbook with user-specified value. |
...
| [`get_range(self)`](/slides/python-net/aspose.slides.charts/ichartdata/get_range/#) | Gets chart data range. |
| [`switch_row_column(self)`](/slides/python-net/aspose.slides.charts/ichartdata/switch_row_column/#) | Swap the data over the axis.<br/>            Data being charted on the X axis will move to the Y axis and vice versa. |
