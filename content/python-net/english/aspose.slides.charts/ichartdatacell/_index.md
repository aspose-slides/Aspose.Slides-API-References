...
| :- | :- |
| [`row`](/slides/python-net/aspose.slides.charts/ichartdatacell/row/) | Returns the index of the row of worksheet in which the cell is located.<br/>            Read-only **int**. |
| [`column`](/slides/python-net/aspose.slides.charts/ichartdatacell/column/) | Returns the index of the column of worksheet in which the cell is located.<br/>            Read-only **int**. |
| [`value`](/slides/python-net/aspose.slides.charts/ichartdatacell/value/) | Gets or sets the value of a cell.<br/>            Read/write **any**. |
...
| Method | Description |
| :- | :- |
| [`calculate(self, update_values)`](/slides/python-net/aspose.slides.charts/ichartdatacell/calculate/#bool) | If the cell contains a formula, the value will be updated base on that formula. |
