...
| [as_literal](/slides/python-net/aspose.slides.charts/as_literal) | Returns or sets AsLiteral object.<br/>            Read/write :py:class:`any`. |
...
| Method | Description |
| :- | :- |
| [__init__](/slides/python-net/aspose.slides.charts/chartcategory/#) | Removes category from chart. |
