...
| Method | Description |
| :- | :- |
| [`copy_to(self, dest_text_frame)`](/slides/python-net/aspose.slides.charts/icharttextformat/copy_to/#itextframe) | Copies text format to specified text frame. |
| [`copy_from(self, source_text_frame)`](/slides/python-net/aspose.slides.charts/icharttextformat/copy_from/#itextframe) | Copies text format from specified text frame. |
