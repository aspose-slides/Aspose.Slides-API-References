...
| Method | Description |
| :- | :- |
| [`add(self, trendline_type)`](/slides/python-net/aspose.slides.charts/trendlinecollection/add/#trendlinetype) | Adds the new Trendline at the end of a collection and return it. |
| [`remove(self, value)`](/slides/python-net/aspose.slides.charts/trendlinecollection/remove/#itrendline) | Removes the specified value. |
