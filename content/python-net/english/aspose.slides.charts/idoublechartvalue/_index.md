...
| :- | :- |
| [as_literal_double](/slides/python-net/aspose.slides.charts/idoublechartvalue/as_literal_double/) | Returns or sets literal double value if DataSourceType = Charts.DataSourceType.DoubleLiterals.<br/>            Read/write <br/>.NET type System.Double<br/>. |
| [as_i_single_cell_chart_value](/slides/python-net/aspose.slides.charts/idoublechartvalue/as_i_single_cell_chart_value/) | Allows to get base ISingleCellChartValue interface.<br/>            Read-only <br/>[`ISingleCellChartValue`](/slides/python-net/aspose.slides.charts/isinglecellchartvalue)<br/>. |
