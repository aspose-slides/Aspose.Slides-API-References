...
| :- | :- |
| [anchoring_type](/slides/python-net/aspose.slides.charts/icharttextblockformat/anchoring_type/) | Returns or sets vertical anchor text in a TextFrame.<br/>            Read/write <br/>[`TextAnchorType`](/slides/python-net/aspose.slides/textanchortype). |
| [center_text](/slides/python-net/aspose.slides.charts/icharttextblockformat/center_text/) | If NullableBool.True then text should be centered in box horizontally.<br/>            Read/write <br/>[`NullableBool`](/slides/python-net/aspose.slides/nullablebool). |
