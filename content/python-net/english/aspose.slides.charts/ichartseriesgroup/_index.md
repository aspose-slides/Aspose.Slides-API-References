...
| [series](/slides/python-net/aspose.slides.charts/series) | Returns a readonly collection of chart series.<br/>            Read-only :py:class:`aspose.slides.charts.IChartSeriesReadonlyCollection`. |
...
| [doughnut_hole_size](/slides/python-net/aspose.slides.charts/doughnut_hole_size) | Specifies the size of the hole in a doughnut chart (can be between 10 and 90 percents <br/>            of the size of the plot area.).<br/>            Read/write :py:class:`int`. |
