...
| [`as_cells`](/slides/python-net/aspose.slides.charts/stringchartvalue/as_cells/) | Null value assigning is not allowed.<br/>            Returning value always is not None.<br/>            Read/write [`IChartCellCollection`](/slides/python-net/aspose.slides.charts/ichartcellcollection). |
...
| Method | Description |
| :- | :- |
| [`set_from_one_cell`](/slides/python-net/aspose.slides.charts/stringchartvalue/set_from_one_cell/#asposeslideschartsichartdatacell) | Sets value from specified cell. |
