...
| :- | :- |
| [`as_literal_string`](/slides/python-net/aspose.slides.charts/istringchartvalue/as_literal_string/) | Returns or sets the literal string if DataSourceType property is DataSourceType.StringLiterals.<br/>            Read/write **string**. |
