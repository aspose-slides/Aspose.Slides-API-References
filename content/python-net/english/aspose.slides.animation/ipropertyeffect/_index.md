...
| :- | :- |
| [from_address](/slides/python-net/aspose.slides.animation/ipropertyeffect/from_address/) | Specifies the starting value of the animation.<br/>            Read/write .NET type System.String. |
| [to](/slides/python-net/aspose.slides.animation/ipropertyeffect/to/) | Specifies the ending value for the animation.<br/>            Read/write .NET type System.String. |
| [by](/slides/python-net/aspose.slides.animation/ipropertyeffect/by/) | Specifies a relative offset value for the animation with respect to its<br/>            position before the start of the animation.<br/>            Read/write .NET type System.String. |
...
| [as_i_behavior](/slides/python-net/aspose.slides.animation/ipropertyeffect/as_i_behavior/) | Allows to get base IBehavior interface.<br/>            Read-only [`IBehavior`](/slides/python-net/aspose.slides.animation/ibehavior). |
