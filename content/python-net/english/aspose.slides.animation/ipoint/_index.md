...
| :- | :- |
| [time](/slides/python-net/aspose.slides.animation/ipoint/time/) | Represents time value.<br/>            Read/write :py:class:`float`. |
| [value](/slides/python-net/aspose.slides.animation/ipoint/value/) | Represents point value.<br/>            Only: bool, ColorFormat, float, int, string.<br/>            Read/write :py:class:`any`. |
