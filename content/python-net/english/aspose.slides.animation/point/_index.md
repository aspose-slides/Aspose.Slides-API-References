...
| :- | :- |
| [time](/slides/python-net/aspose.slides.animation/point/time/) | Represents time value.<br/>            Read/write <br/>.NET type System.Single<br/>. |
| [value](/slides/python-net/aspose.slides.animation/point/value/) | Represents point value.<br/>            Only: bool, ColorFormat, float, int, string.<br/>            Read/write <br/>.NET type System.Object<br/>. |
