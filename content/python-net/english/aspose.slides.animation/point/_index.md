...
| :- | :- |
| [`__init__(self)`](/slides/python-net/aspose.slides.animation/point/__init__/#) | Default constructor. |
| [`__init__(self, time, value, formula)`](/slides/python-net/aspose.slides.animation/point/__init__/#float-any-str) | Create animation point with time, value and formula. |
