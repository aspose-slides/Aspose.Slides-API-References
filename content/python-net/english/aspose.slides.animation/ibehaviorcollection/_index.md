...
| :- | :- |
| [count](/slides/python-net/aspose.slides.animation/ibehaviorcollection/count/) | Returns the number of behaviors in a collection.<br/>            Read-only .NET type System.Int32. |
| [as_i_enumerable](/slides/python-net/aspose.slides.animation/ibehaviorcollection/as_i_enumerable/) | Returns IEnumerable interface.<br/>            Read-only .NET type System.Collections.IEnumerable. |
