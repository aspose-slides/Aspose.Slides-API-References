...
| :- | :- |
| [accumulate](/slides/python-net/aspose.slides.animation/commandeffect/accumulate/) | Represents whether animation behaviors are accumulated.<br/>            Read/write [`NullableBool`](/slides/python-net/aspose.slides/nullablebool). |
| [additive](/slides/python-net/aspose.slides.animation/commandeffect/additive/) | Represents whether the current animation behavior is combined with other running animations.<br/>            Read/write [`BehaviorAdditiveType`](/slides/python-net/aspose.slides.animation/behavioradditivetype). |
...
| [command_string](/slides/python-net/aspose.slides.animation/commandeffect/command_string/) | Defines command string.<br/>            Read/write .NET type System.String. |
