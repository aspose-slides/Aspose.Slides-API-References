...
| :- | :- |
| [`points`](/slides/python-net/aspose.slides.animation/motioncmdpath/points/) | Specifies points of command.<br/>            Read/write [`PointF`](/slides/python-net/aspose.slides/pointf)[]. |
