...
| :- | :- |
| [`from_address`](/slides/python-net/aspose.slides.animation/imotioneffect/from_address/) | Specifies an x/y co-ordinate to start the animation from (in percents). <br/>            Read/write **aspose.slides.PointF**. |
| [`to`](/slides/python-net/aspose.slides.animation/imotioneffect/to/) | Specifies the target location for an animation motion effect (in percents).<br/>            Read/write **aspose.slides.PointF**. |
| [`by`](/slides/python-net/aspose.slides.animation/imotioneffect/by/) | Describes the relative offset value for the animation (in percents).<br/>            Read/write **aspose.slides.PointF**. |
| [`rotation_center`](/slides/python-net/aspose.slides.animation/imotioneffect/rotation_center/) | Describes the center of the rotation used to rotate a motion path by X angle.<br/>            Read/write **aspose.slides.PointF**. |
