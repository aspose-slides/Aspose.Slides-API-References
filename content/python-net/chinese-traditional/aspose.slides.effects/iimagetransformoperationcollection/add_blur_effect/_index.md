...
description: 
type: docs
url: /zh-hant/aspose.slides.effects/iimagetransformoperationcollection/add_blur_effect/
weight: 90
---
...
| :- | :- | :- |
| radius | **float** | 模糊的半徑。 |
| grow | **bool** | 指定物件的邊界是否因模糊而擴大。<br/><br/>            True 表示邊界會被擴大，false 表示不會。 |

### 另見
* 類別 [`IBlur`](/slides/python-net/zh-hant/aspose.slides.effects/iblur)
