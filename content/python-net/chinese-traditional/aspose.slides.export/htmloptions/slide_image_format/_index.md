...
description: 
type: docs
url: /zh-hant/aspose.slides.export/htmloptions/slide_image_format/
weight: 140
---
## slide_image_format 屬性
返回或設定投影片影像格式選項。
            讀/寫 [`ISlideImageFormat`](/slides/python-net/zh-hant/aspose.slides.export/islideimageformat).
...
* 類別 [`ISlideImageFormat`](/slides/python-net/zh-hant/aspose.slides.export/islideimageformat)
