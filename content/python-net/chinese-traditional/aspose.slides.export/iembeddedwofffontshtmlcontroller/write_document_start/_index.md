...
description: 
type: docs
url: /zh-hant/aspose.slides.export/iembeddedwofffontshtmlcontroller/write_document_start/
weight: 20
---
...
| 參數 | 類型 | 說明 |
| :- | :- | :- |
| generator | [`IHtmlGenerator`](/slides/python-net/zh-hant/aspose.slides.export/ihtmlgenerator) |  |
| presentation | [`IPresentation`](/slides/python-net/zh-hant/aspose.slides/ipresentation) |  |



### 參見
* 類別 [`IEmbeddedWoffFontsHtmlController`](/slides/python-net/zh-hant/aspose.slides.export/iembeddedwofffontshtmlcontroller)
