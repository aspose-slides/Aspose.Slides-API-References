...
description: 
type: docs
url: /zh-hant/aspose.slides.export/markdownsaveoptions/warning_callback/
weight: 170
---
## warning_callback 屬性
返回或設定一個接收警告的物件，並決定載入過程是否繼續或中止。
            讀/寫 [`IWarningCallback`](/slides/python-net/zh-hant/aspose.slides.warnings/iwarningcallback).
