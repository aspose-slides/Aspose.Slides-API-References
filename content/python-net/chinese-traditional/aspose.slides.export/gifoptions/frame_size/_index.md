...
description: 
type: docs
url: /zh-hant/aspose.slides.export/gifoptions/frame_size/
weight: 60
---
## frame_size 屬性
取得或設定框架大小。
...
如果大小為空，則該值將從 [`IPresentation.slide_size`](/slides/python-net/zh-hant/aspose.slides/ipresentation/slide_size) 取得。
