...
description: 
type: docs
url: /zh-hant/aspose.slides.export/embedallfontshtmlcontroller/write_document_end/
weight: 30
---
## write_document_end(self, generator, presentation) {#ihtmlgenerator-ipresentation}
呼叫以寫入 html 文件頁腳。每次簡報轉換呼叫一次。
...
| presentation | [`IPresentation`](/slides/python-net/zh-hant/aspose.slides/ipresentation) | 目前正在渲染的簡報。 |
