...
description: 
type: docs
url: /zh-hant/aspose.slides.export/html5options/default_regular_font/
weight: 50
---
## default_regular_font 屬性
返回或設定在找不到來源字型時使用的字型。
            讀寫 **str**。
...
### 另請參閱
* 類別 [`Html5Options`](/slides/python-net/zh-hant/aspose.slides.export/html5options)
