...
description: 
type: docs
url: /zh-hant/aspose.slides.smartart/smartart/frame/
weight: 210
---
## 框架屬性
返回或設定形狀框架的屬性。
...
返回的 IShapeFrame 實例的每個屬性值皆不是 undefined（不是 NaN 或 NotDefined）。
指定的 IShapeFrame 實例的每個屬性值必須不是 undefined（必須不是 NaN 或 NotDefined）。
