...
description: 
type: docs
url: /zh-hant/aspose.slides/shapecollection/index_of/
weight: 190
---
## index_of(self, shape) {#ishape}
返回集合中指定形狀首次出現的零基索引。

### 返回值

如果在形狀集合中找到，則返回該形狀第一次出現的零基索引；否則，返回 –1。
...
| 參數 | 類型 | 說明 |
| :- | :- | :- |
| shape | [`IShape`](/slides/python-net/zh-hant/aspose.slides/ishape) | 要在集合中定位的形狀。 |
