...
| path | **str** | 連結檔案的路徑。<br/><br/>此路徑會以原樣儲存在簡報中。<br/><br/>如果指定相對路徑，於從其他目錄開啟簡報時，檔案將無法存取。 |
