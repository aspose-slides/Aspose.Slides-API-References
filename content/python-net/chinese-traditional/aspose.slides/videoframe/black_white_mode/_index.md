...
description: 
type: docs
url: /zh-hant/aspose.slides/videoframe/black_white_mode/
weight: 200
---
## black_white_mode 屬性
屬性指定形狀在黑白顯示模式下的呈現方式..            讀/寫 [`BlackWhiteMode`](/slides/python-net/zh-hant/aspose.slides/blackwhitemode).
...
### 另請參閱
* 列舉 [`BlackWhiteMode`](/slides/python-net/zh-hant/aspose.slides/blackwhitemode)
