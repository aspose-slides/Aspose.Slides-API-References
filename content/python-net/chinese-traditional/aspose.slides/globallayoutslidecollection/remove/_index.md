...
description: 
type: docs
url: /zh-hant/aspose.slides/globallayoutslidecollection/remove/
weight: 40
---
...
1) 為避免拋出 PptxEditException，請先檢查佈局的 HasDependingSlides 屬性。 
...
| 例外 | 說明 |
| :- | :- |
| [`PptxEditException`](/slides/python-net/zh-hant/aspose.slides/pptxeditexception) | 當佈局已在簡報中使用時會拋出（其 HasDependingSlides 屬性為 true）。 |
