...
description: 
type: docs
url: /zh-hant/aspose.slides/videocollection/add_video/
weight: 10
---
...
已新增 [`IVideo`](/slides/python-net/zh-hant/aspose.slides/ivideo)。
...
* 類別 [`VideoCollection`](/slides/python-net/zh-hant/aspose.slides/videocollection)
