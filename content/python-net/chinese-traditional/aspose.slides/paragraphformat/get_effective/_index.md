...
description: 
type: docs
url: /zh-hant/aspose.slides/paragraphformat/get_effective/
weight: 20
---
## get_effective(self) {#}
取得套用繼承後的有效段落格式資料。
...
一個 [`IParagraphFormatEffectiveData`](/slides/python-net/zh-hant/aspose.slides/iparagraphformateffectivedata)。
