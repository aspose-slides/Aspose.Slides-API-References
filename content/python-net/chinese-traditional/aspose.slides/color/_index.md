...
description: 代表 ARGB（alpha、red、green、blue）顏色。
type: docs
url: /zh-hant/aspose.slides/color/
net_type: System.Drawing.Color
---
## Color 類別

表示 ARGB（alpha、red、green、blue）顏色。相容於 .NET `System.Drawing.Color`。
...
| 建構子 | 說明 |
| :- | :- |
| [`__init__(self, r=0, g=0, b=0, a=255)`](/slides/python-net/zh-hant/aspose.slides/color/__init__/#int-int-int-int) | 從指定的 red、green、blue 和 alpha 元件值建立顏色。 |

## 屬性

| 屬性 | 說明 |
| :- | :- |
| [`a`](/slides/python-net/zh-hant/aspose.slides/color/a/) | 取得此顏色的 alpha 元件值。<br/>            唯讀 **int**。 |
| [`r`](/slides/python-net/zh-hant/aspose.slides/color/r/) | 取得此顏色的 red 元件值。<br/>            唯讀 **int**。 |
| [`g`](/slides/python-net/zh-hant/aspose.slides/color/g/) | 取得此顏色的 green 元件值。<br/>            唯讀 **int**。 |
| [`b`](/slides/python-net/zh-hant/aspose.slides/color/b/) | 取得此顏色的 blue 元件值。<br/>            唯讀 **int**。 |
| [`name`](/slides/python-net/zh-hant/aspose.slides/color/name/) | 取得此顏色的名稱。<br/>            若為具名顏色（例如 `Color.red` 常數，或使用 [`from_name`](/slides/python-net/zh-hant/aspose.slides/color/from_name/) 建立的顏色），則回傳 .NET 名稱，例如 "Red" 或 "LightBlue"。<br/>            其他顏色則以小寫十六進位且不含前導零的 ARGB 值回傳，例如 "ffff0000"。`Color.empty.name` 為 "0"。<br/>            唯讀 **str**。 |
| [`is_empty`](/slides/python-net/zh-hant/aspose.slides/color/is_empty/) | 指定此顏色是否為 `Color.empty`。<br/>            若使用 [`from_argb`](/slides/python-net/zh-hant/aspose.slides/color/from_argb/) 建立且所有元件皆為零的顏色，則回傳 `False`。<br/>            唯讀 **bool**。 |
| [`is_known_color`](/slides/python-net/zh-hant/aspose.slides/color/is_known_color/) | 指定此顏色是否為預先定義的 .NET `KnownColor` 顏色之一（具名顏色或系統顏色）。<br/>            唯讀 **bool**。 |
| [`is_named_color`](/slides/python-net/zh-hant/aspose.slides/color/is_named_color/) | 指定此顏色是否具有名稱：它是由具名常數（例如 `Color.red`）使用 [`from_name`](/slides/python-net/zh-hant/aspose.slides/color/from_name/) 建立，或從函式庫返回為具名顏色。<br/>            唯讀 **bool**。 |
| [`is_system_color`](/slides/python-net/zh-hant/aspose.slides/color/is_system_color/) | 指定此顏色是否為系統顏色：用於 Windows 顯示元件的顏色，例如 `Control` 或 `ActiveBorder`。<br/>            系統顏色不會以 `Color` 屬性公開，只能透過 [`from_known_color`](/slides/python-net/zh-hant/aspose.slides/color/from_known_color/) 取得或由函式庫返回。<br/>            唯讀 **bool**。 |

## 方法

| 方法 | 說明 |
| :- | :- |
| [`from_argb(argb)`](/slides/python-net/zh-hant/aspose.slides/color/from_argb/#int) | 從 32 位元 ARGB 值建立顏色。 |
| [`from_argb(alpha, base_color)`](/slides/python-net/zh-hant/aspose.slides/color/from_argb/#int-color) | 從指定的 alpha 值和基礎顏色建立顏色。 |
| [`from_argb(red, green, blue)`](/slides/python-net/zh-hant/aspose.slides/color/from_argb/#int-int-int) | 從指定的 red、green、blue 值建立不透明顏色（alpha 為 255）。 |
| [`from_argb(alpha, red, green, blue)`](/slides/python-net/zh-hant/aspose.slides/color/from_argb/#int-int-int-int) | 從四個 ARGB 元件（alpha、red、green、blue）值建立顏色。 |
| [`from_known_color(known_color)`](/slides/python-net/zh-hant/aspose.slides/color/from_known_color/#knowncolor) | 從指定的預先定義顏色建立顏色。 |
| [`from_name(name)`](/slides/python-net/zh-hant/aspose.slides/color/from_name/#str) | 從指定的預先定義顏色名稱建立顏色。 |
| [`from_rgb(r, g, b)`](/slides/python-net/zh-hant/aspose.slides/color/from_rgb/#int-int-int) | 從指定的 red、green、blue 值建立不透明顏色（alpha 為 255）。 |
| [`get_brightness(self)`](/slides/python-net/zh-hant/aspose.slides/color/get_brightness/#) | 取得此顏色的色相-飽和度-亮度 (HSL) 亮度值。 |
| [`get_hue(self)`](/slides/python-net/zh-hant/aspose.slides/color/get_hue/#) | 取得此顏色的色相-飽和度-亮度 (HSL) 色相值（以度為單位）。 |
| [`get_saturation(self)`](/slides/python-net/zh-hant/aspose.slides/color/get_saturation/#) | 取得此顏色的色相-飽和度-亮度 (HSL) 飽和度值。 |
| [`to_argb(self)`](/slides/python-net/zh-hant/aspose.slides/color/to_argb/#) | 取得此顏色的 32 位元 ARGB 值。 |
| [`to_known_color(self)`](/slides/python-net/zh-hant/aspose.slides/color/to_known_color/#) | 取得此顏色的 `KnownColor` 值。 |
| [`to_string(self)`](/slides/python-net/zh-hant/aspose.slides/color/to_string/#) | 將此顏色轉換為可讀的字串。相同文字由 `str()` 與 `repr()` 回傳。 |

### 備註

顏色會以其 ARGB 元件透過 `==` 進行比較，且可作為字典鍵值或集合成員。

預先定義的顏色（141 個具名 .NET `KnownColor` 顏色、`Color.transparent` 與 `Color.empty`）以 snake_case 形式作為類別屬性提供，例如 `Color.red`、`Color.light_blue` 或 `Color.dark_slate_gray`（請見下方 [Named colors](#named-colors)）。它們也可以像方法一樣呼叫（`Color.red()`），會回傳相同的顏色。
