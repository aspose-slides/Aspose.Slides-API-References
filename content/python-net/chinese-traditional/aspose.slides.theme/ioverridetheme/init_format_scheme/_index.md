...
description: 
type: docs
url: /zh-hant/aspose.slides.theme/ioverridetheme/init_format_scheme/
weight: 90
---
...
| 例外 | 說明 |
| :- | :- |
| **RuntimeError(Proxy error(InvalidOperationException))** | 如果 FormatScheme 已經被初始化（非 None），則拋出此例外。 |
