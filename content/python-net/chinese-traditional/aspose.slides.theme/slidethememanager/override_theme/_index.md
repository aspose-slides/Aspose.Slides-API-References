...
description: 
type: docs
url: /zh-hant/aspose.slides.theme/slidethememanager/override_theme/
weight: 50
---
## override_theme 屬性
傳回覆寫的佈景主題物件。
可讀寫 [`IOverrideTheme`](/slides/python-net/zh-hant/aspose.slides.theme/ioverridetheme)。
...
* 類別 [`SlideThemeManager`](/slides/python-net/zh-hant/aspose.slides.theme/slidethememanager)
