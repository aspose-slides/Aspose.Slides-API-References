...
description: 
type: docs
url: /zh-hant/aspose.slides.mathtext/mathphantom/to_border_box/
weight: 200
---
## to_border_box(self) {#}
將此元素放置於邊框盒中
...
| strikethrough_bottom_left_to_top_right | **bool** | 邊框盒刪除線（左下至右上） |
| strikethrough_top_left_to_bottom_right | **bool** | 邊框盒刪除線（左上至右下） |
