...
description: 
type: docs
url: /zh-hant/aspose.slides.mathtext/mathphantom/enclose/
weight: 50
---
## enclose(self) {#}
將數學元素用括號包住
...
將數學元素以指定字元（如括號或其他字元）作為框架包住

### Returns

類型為 [`IMathDelimiter`](/slides/python-net/zh-hant/aspose.slides.mathtext/imathdelimiter) 的數學元素，包含指定字元作為框架
