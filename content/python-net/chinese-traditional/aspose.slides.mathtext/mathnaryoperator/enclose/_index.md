...
description: 
type: docs
url: /zh-hant/aspose.slides.mathtext/mathnaryoperator/enclose/
weight: 50
---
## enclose(self) {#}
將數學元素放在括號中
...
將數學元素用指定字符（例如括號或其他字符）作為框架包住

### 返回值
類型為 [`IMathDelimiter`](/slides/python-net/zh-hant/aspose.slides.mathtext/imathdelimiter) 的數學元素，包含指定字符作為框架
...
| 參數 | 類型 | 說明 |
| :- | :- | :- |
| beginning_character | **char** | 開始字符（通常為左括號） |
| ending_character | **char** | 結束字符（通常為右括號） |
