...
description: 
type: docs
url: /zh-hant/aspose.slides.mathtext/mathsubscriptelement/group/
weight: 80
---
## group(self) {#}
使用底部大括號將此元素放入群組
...
| 參數 | 型別 | 說明 |
| :- | :- | :- |
| character | **char** | 分組字元，例如底部大括號 (U+23DF) 或其他任意字元 |
| position | [`MathTopBotPositions`](/slides/python-net/zh-hant/aspose.slides.mathtext/mathtopbotpositions) | 分組字元的位置 |
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/zh-hant/aspose.slides.mathtext/mathtopbotpositions) | 群組字元的垂直對齊方式。<br/><br/>            指定物件相對於基線的對齊方式。<br/><br/>            例如，當群組字元位於物件上方時，<br/><br/>            垂直對齊方式為 Top 表示物件的頂部落在基線上；<br/><br/>            當垂直對齊方式設為 Bottom 時，物件的底部在基線上 |
