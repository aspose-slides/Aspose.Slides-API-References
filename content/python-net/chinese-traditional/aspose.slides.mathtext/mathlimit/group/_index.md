...
description: 
type: docs
url: /zh-hant/aspose.slides.mathtext/mathlimit/group/
weight: 80
---
## group(self) {#}
使用底部大括號將此元素放入群組
...
| 參數 | 型別 | 說明 |
| :- | :- | :- |
| character | **char** | 分組字符，例如底部大括號 (U+23DF) 或其他任意字符 |
| position | [`MathTopBotPositions`](/slides/python-net/zh-hant/aspose.slides.mathtext/mathtopbotpositions) | 分組字符的位置 |
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/zh-hant/aspose.slides.mathtext/mathtopbotpositions) | 群組字符的垂直對齊。<br/><br/>指定物件相對於基線的對齊方式。<br/><br/>例如，當群組字符位於物件上方時，<br/><br/>VerticalJustification 為 Top 表示物件的頂部落在基線上；<br/><br/>當 VerticalJustification 設為 Bottom 時，物件的底部位於基線上 |
