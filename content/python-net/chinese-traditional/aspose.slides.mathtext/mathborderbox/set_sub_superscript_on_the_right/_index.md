...
description: 
type: docs
url: /zh-hant/aspose.slides.mathtext/mathborderbox/set_sub_superscript_on_the_right/
weight: 160
---
...
新數學元素，型別為 [`IMathRightSubSuperscriptElement`](/slides/python-net/zh-hant/aspose.slides.mathtext/imathrightsubsuperscriptelement)
...
| 參數 | 型別 | 說明 |
| :- | :- | :- |
| subscript | [`IMathElement`](/slides/python-net/zh-hant/aspose.slides.mathtext/imathelement) | 右側的下標 |
| superscript | [`IMathElement`](/slides/python-net/zh-hant/aspose.slides.mathtext/imathelement) | 右側的上標 |
