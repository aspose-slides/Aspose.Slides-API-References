...
description: 
type: docs
url: /zh-hant/aspose.slides.mathtext/imathgroupingcharacterfactory/create_math_grouping_character/
weight: 10
---
...
| 參數 | 類型 | 說明 |
| :- | :- | :- |
| element | [`IMathElement`](/slides/python-net/zh-hant/aspose.slides.mathtext/imathelement) | 用於套用分組字元的數學元素 |
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/zh-hant/aspose.slides.mathtext/mathtopbotpositions) | 垂直對齊 |
...
* 類別 [`IMathGroupingCharacterFactory`](/slides/python-net/zh-hant/aspose.slides.mathtext/imathgroupingcharacterfactory)
