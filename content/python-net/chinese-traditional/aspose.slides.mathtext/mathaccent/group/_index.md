...
description: 
type: docs
url: /zh-hant/aspose.slides.mathtext/mathaccent/group/
weight: 80
---
## group(self) {#}
將此元素放入使用底部大括號的群組
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/zh-hant/aspose.slides.mathtext/mathtopbotpositions) | 群組字元的垂直對齊方式。<br/><br/>            指定物件相對於基線的對齊方式。<br/><br/>            例如，當群組字元位於物件之上時，<br/><br/>            設定為 Top 的 VerticalJustification 表示物件的頂部落在基線上；<br/><br/>            當 VerticalJustification 設定為 Bottom 時，物件的底部落在基線上 |
