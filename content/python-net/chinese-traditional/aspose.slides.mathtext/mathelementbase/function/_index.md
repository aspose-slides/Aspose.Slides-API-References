...
使用此實例作為 function 名稱，接受一個 function_argument 作為參數的 function
...
| 參數 | 類型 | 說明 |
| :- | :- | :- |
| function_argument | [`IMathElement`](/slides/python-net/zh-hant/aspose.slides.mathtext/imathelement) | function 的參數 |
...
| 參數 | 類型 | 說明 |
| :- | :- | :- |
| function_argument | **str** | function 的參數 |
