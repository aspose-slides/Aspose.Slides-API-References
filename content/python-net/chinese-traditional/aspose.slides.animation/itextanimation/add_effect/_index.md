...
description: 
type: docs
url: /zh-hant/aspose.slides.animation/itextanimation/add_effect/
weight: 10
---
## add_effect(self, effect_type, subtype, trigger_type) {#effecttype-effectsubtype-effecttriggertype}
將新效果新增至目前序列的末端，以加入群組文字動畫的結尾。
            僅在文字段落的數量大於或等於此群組效果的計數時才有效！
...
* 類別 [`ITextAnimation`](/slides/python-net/zh-hant/aspose.slides.animation/itextanimation)
