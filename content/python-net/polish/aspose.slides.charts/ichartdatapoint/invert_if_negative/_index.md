...
description: 
type: docs
url: /pl/aspose.slides.charts/ichartdatapoint/invert_if_negative/
weight: 150
---
## invert_if_negative właściwość
Określa, że punkt danych odwróci swoje kolory, jeśli wartość jest ujemna.
            Odczyt/zapis **bool**.
