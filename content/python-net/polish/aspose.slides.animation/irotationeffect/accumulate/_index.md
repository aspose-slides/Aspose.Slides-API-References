...
description: 
type: docs
url: /pl/aspose.slides.animation/irotationeffect/accumulate/
weight: 10
---
## accumulate właściwość
### Definicja:
```python
@property
def accumulate(self):
...
### Zobacz także
* klasa [`IRotationEffect`](/slides/python-net/pl/aspose.slides.animation/irotationeffect)
