...
description: 
type: docs
url: /pl/aspose.slides.animation/behaviorcollection/copy_to/
weight: 40
---
...
| Parametr | Typ | Opis |
| :- | :- | :- |
| array | **List[IBehavior]** | Jednowymiarowa **System.Array**, będąca miejscem docelowym elementów skopiowanych z **System.Collections.Generic.ICollection`1**. **System.Array** musi mieć indeksowanie zerowe. |
...
### Zobacz też
* klasa [`BehaviorCollection`](/slides/python-net/pl/aspose.slides.animation/behaviorcollection)
