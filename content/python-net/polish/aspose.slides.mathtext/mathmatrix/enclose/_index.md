...
description: 
type: docs
url: /pl/aspose.slides.mathtext/mathmatrix/enclose/
weight: 70
---
## enclose(self) {#}
...
Otacza element matematyczny w określonych znakach, takich jak nawiasy lub inne znaki jako ramka

### Zwraca

Element matematyczny typu [`IMathDelimiter`](/slides/python-net/pl/aspose.slides.mathtext/imathdelimiter) zawierający określone znaki jako ramka
