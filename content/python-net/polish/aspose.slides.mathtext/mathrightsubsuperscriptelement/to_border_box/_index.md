...
description: 
type: docs
url: /pl/aspose.slides.mathtext/mathrightsubsuperscriptelement/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Przekreślenie poziome w border-box |
| strikethrough_vertical | **bool** | Przekreślenie pionowe w border-box |
| strikethrough_bottom_left_to_top_right | **bool** | Przekreślenie od dolnego lewego do górnego prawego w border-box |
| strikethrough_top_left_to_bottom_right | **bool** | Przekreślenie od górnego lewego do dolnego prawego w border-box |
