...
description: 
type: docs
url: /pl/aspose.slides.mathtext/mathrightsubsuperscriptelement/enclose/
weight: 50
---
## enclose(self) {#}
...
Otacza element matematyczny określonymi znakami, takimi jak nawiasy lub inne znaki jako ramka

### Zwraca

Element matematyczny typu [`IMathDelimiter`](/slides/python-net/pl/aspose.slides.mathtext/imathdelimiter) który zawiera określone znaki jako ramkę
