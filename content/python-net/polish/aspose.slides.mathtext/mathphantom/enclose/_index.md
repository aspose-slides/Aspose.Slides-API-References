...
description: 
type: docs
url: /pl/aspose.slides.mathtext/mathphantom/enclose/
weight: 50
---
## enclose(self) {#}
...
Otacza element matematyczny określonymi znakami, takimi jak nawiasy lub innymi znakami jako obramowanie

### Zwraca

Element matematyczny typu [`IMathDelimiter`](/slides/python-net/pl/aspose.slides.mathtext/imathdelimiter) zawierający określone znaki jako obramowanie
...
| Parametr | Typ | Opis |
| :- | :- | :- |
| beginning_character | **char** | Znak początkowy (zwykle lewy nawias) |
| ending_character | **char** | Znak końcowy (zwykle prawy nawias) |
