...
description: 
type: docs
url: /pl/aspose.slides.mathtext/mathsuperscriptelement/group/
weight: 80
---
## group(self) {#}
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/pl/aspose.slides.mathtext/mathtopbotpositions) | Justyfikacja pionowa znaku grupującego.<br/><br/>            Określa wyrównanie obiektu względem linii bazowej.<br/><br/>            Na przykład, gdy znak grupujący znajduje się nad obiektem, <br/><br/>            VerticalJustification of Top oznacza, że górna część obiektu spada na linię bazową;<br/><br/>            gdy VerticalJustification jest ustawiona na Bottom, dolna część obiektu znajduje się na linii bazowej |
