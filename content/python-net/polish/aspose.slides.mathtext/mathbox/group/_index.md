...
description: 
type: docs
url: /pl/aspose.slides.mathtext/mathbox/group/
weight: 80
---
## group(self) {#}
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/pl/aspose.slides.mathtext/mathtopbotpositions) | Vertical justification of group character.<br/><br/>            Określa wyrównanie obiektu względem linii bazowej.<br/><br/>            Na przykład, gdy znak grupujący znajduje się nad obiektem, <br/><br/>            VerticalJustification of Top oznacza, że góra obiektu leży na linii bazowej;<br/><br/>            gdy VerticalJustification jest ustawione na Bottom, dół obiektu znajduje się na linii bazowej |
