...
description: 
type: docs
url: /pl/aspose.slides/imagecollection/add_image/
weight: 10
---
...
| Parametr | Typ | Opis |
| :- | :- | :- |
| image_source | [`IPPImage`](/slides/python-net/pl/aspose.slides/ippimage) | Źródłowy obraz. |
...
| Wyjątek | Opis |
| :- | :- |
| **RuntimeError(Proxy error(ArgumentNullException))** | Gdy parametr svgImage jest None. |
...
* klasa [`ImageCollection`](/slides/python-net/pl/aspose.slides/imagecollection)
