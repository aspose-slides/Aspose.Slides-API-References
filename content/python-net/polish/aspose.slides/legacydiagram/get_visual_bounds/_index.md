...
### Uwagi
Zwrócony prostokąt reprezentuje granice wyrównane do osi całej zawartości generowanej przez kształt podczas renderowania w układzie współrzędnych slajdu.
...
Wizualne granice uwzględniają aspekty związane z renderowaniem, takie jak transformacje (np. obrót), szerokość i łączenia obramowania, układ i przepełnienie tekstu, geometrię SmartArt oraz inne efekty układu, które wpływają na ostateczny wygląd renderowanego kształtu.
