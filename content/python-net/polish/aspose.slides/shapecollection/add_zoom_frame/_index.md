...
description: 
type: docs
url: /pl/aspose.slides/shapecollection/add_zoom_frame/
weight: 170
---
...
| Wyjątek | Opis |
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Rzucane, jeśli odwoływany slajd nie należy do bieżącej prezentacji. |
