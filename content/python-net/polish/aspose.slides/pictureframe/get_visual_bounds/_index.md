...
Zwrócony prostokąt reprezentuje granice wyrównane względem osi całej zawartości generowanej przez kształt podczas renderowania w przestrzeni współrzędnych slajdu.
...
Wizualne granice uwzględniają aspekty związane z renderowaniem, takie jak transformacje (np. rotacja), szerokość i łączenia obramowania, układ tekstu i przepełnienie, geometria SmartArt oraz inne efekty układu wpływające na ostateczny wygląd renderowanego kształtu.
