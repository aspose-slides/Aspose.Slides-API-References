...
description: 
type: docs
url: /pl/aspose.slides/ishapecollection/add_group_shape/
weight: 80
---
## add_group_shape(self) {#}
Tworzy nowy pusty kształt grupy i dodaje go na koniec kolekcji kształtów.
            Ramka grupy będzie automatycznie dostosowywać się, aby pomieścić wszystkie dodane do niej kształty.
...
Tworzy nowy kształt grupy, konwertuje określony obraz SVG na pojedyncze kształty,
            i dodaje powstałą grupę na koniec kolekcji kształtów.
