...
description: 
type: docs
url: /pl/aspose.slides/ishapecollection/add_ole_object_frame/
weight: 100
---
...
| path | **str** | Ścieżka do połączonego pliku.<br/><br/>Ta ścieżka jest przechowywana dosłownie w prezentacji.<br/><br/>Jeśli podano ścieżkę względną, plik będzie niedostępny podczas otwierania<br/><br/>prezentacji z innego katalogu. |
