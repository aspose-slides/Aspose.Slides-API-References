...
description: 
type: docs
url: /pl/aspose.slides/ishapecollection/add_math_shape/
weight: 90
---
## add_math_shape(self, x, y, width, height) {#float-float-float-float}
Tworzy nowy prostokątny kształt auto, aby pomieścić treść matematyczną i dodaje go do
            końca kolekcji kształtów.
