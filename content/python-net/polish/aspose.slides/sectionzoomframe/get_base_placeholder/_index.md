...
description: 
type: docs
url: /pl/aspose.slides/sectionzoomframe/get_base_placeholder/
weight: 20
---
## get_base_placeholder(self) {#}
Zwraca podstawowy kształt zastępczy (kształt z układu i/lub slajdu-matki, z którego dziedziczy bieżący kształt).
Zwracane jest None, jeśli bieżący kształt nie jest dziedziczony.
