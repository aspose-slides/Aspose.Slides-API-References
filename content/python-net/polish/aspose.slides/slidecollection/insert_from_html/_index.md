...
description: 
type: docs
url: /pl/aspose.slides/slidecollection/insert_from_html/
weight: 80
---
...
| Parametr | Typ | Opis |
| :- | :- | :- |
| index | **int** | Pozycja, w której wstawiać. |
...
| index | **int** | Pozycja, w której wstawiać. |
| html_text | **str** | HTML do dodania. |
| use_slide_with_index_as_start | **bool** | Ten flag określa, jak rozpocząć wstawianie: od nowego slajdu lub od slajdu o określonym indeksie.<br/><br/>            Jeśli **true**, wtedy wstawianie danych rozpocznie się w pustej przestrzeni na slajdzie o określonym indeksie.<br/><br/>            Jeśli **false**, wtedy dane zostaną dodane do utworzonych slajdów. |
...
| index | **int** | Pozycja, w której wstawiać. |
| html_text | **str** | HTML do dodania. |
| resolver | [`IExternalResourceResolver`](/slides/python-net/pl/aspose.slides.importing/iexternalresourceresolver) | Obiekt wywołania zwrotnego używany do pobierania obiektów zewnętrznych. Jeśli ten parametr jest None, wszystkie obiekty zewnętrzne zostaną zignorowane. |
