...
description: 
type: docs
url: /pl/aspose.slides/oleobjectframe/add_placeholder/
weight: 10
---
...
Nowy [`Shape.placeholder`](/slides/python-net/pl/aspose.slides/shape/placeholder).
...
| Parametr | Typ | Opis |
| :- | :- | :- |
| placeholder_to_copy_from | [`IPlaceholder`](/slides/python-net/pl/aspose.slides/iplaceholder) | Placeholder, z którego kopiowana jest zawartość. |



### Zobacz także
* klasa [`IPlaceholder`](/slides/python-net/pl/aspose.slides/iplaceholder)
