...
description: 
type: docs
url: /pl/aspose.slides.export/ihtmlgenerator/add_html/
weight: 20
---
...
| Parametr | Typ | Opis |
| :- | :- | :- |
| html | **List[char]** | Tekst do dodania. |
...
| :- | :- | :- |
| html | **List[char]** | Tekst do dodania. |
| start_index | **int** | Indeks początkowy części do dodania. |
