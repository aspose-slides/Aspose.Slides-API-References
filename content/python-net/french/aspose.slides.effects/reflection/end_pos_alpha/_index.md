...
description: 
type: docs
url: /fr/aspose.slides.effects/reflection/end_pos_alpha/
weight: 60
---
## end_pos_alpha propriété
Spécifie la position finale (le long de la rampe de gradient alpha) de la valeur alpha finale (pourcents).
