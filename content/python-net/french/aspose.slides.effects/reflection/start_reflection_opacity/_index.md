---
title: start_reflection_opacity property
second_title: Aspose.Slides pour Python via .NET Référence de l'API
description: 
type: docs
url: /fr/aspose.slides.effects/reflection/start_reflection_opacity/
weight: 160
---
## start_reflection_opacity propriété
Opacité de réflexion initiale. (pourcentages).
...
### Voir aussi
* classe [`Reflection`](/slides/python-net/fr/aspose.slides.effects/reflection)
