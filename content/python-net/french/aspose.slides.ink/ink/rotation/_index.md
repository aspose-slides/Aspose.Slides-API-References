...
description: 
type: docs
url: /fr/aspose.slides.ink/ink/rotation/
weight: 380
---
## propriété de rotation
Renvoie ou définit le nombre de degrés selon lequel la forme spécifiée est pivotée autour de l'axe z. Une valeur positive indique une rotation horaire ; une valeur négative indique une rotation anti-horaire. Lecture/écriture **float**.
