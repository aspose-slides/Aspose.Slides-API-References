...
description: 
type: docs
url: /fr/aspose.slides/shape/get_visual_bounds/
weight: 40
---
...
Le rectangle retourné représente les limites alignées sur les axes de tout le contenu
             ...
             la disposition du texte et le débordement, la géométrie SmartArt, ainsi que d'autres effets de mise en page
             qui influencent l'apparence finale rendue de la forme.
            
             Les limites retournées ne sont pas rognées au rectangle de la diapositive.
