...
description: 
type: docs
url: /fr/aspose.slides/audioframe/get_visual_bounds/
weight: 60
---
## get_visual_bounds(self) {#}
Renvoie les limites visuelles de la forme calculées à partir de son contenu rendu.
...
### Voir aussi
* class [`AudioFrame`](/slides/python-net/fr/aspose.slides/audioframe)
* class [`RectangleF`](/slides/python-net/fr/aspose.slides/rectanglef)
