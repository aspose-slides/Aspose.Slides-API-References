...
description: 
type: docs
url: /fr/aspose.slides/zoomobject/get_visual_bounds/
weight: 40
---
...
Les limites visuelles prennent en compte les aspects liés au rendu tels que les transformations (par exemple, la rotation), la largeur et les jointures des traits, la mise en page et le débordement du texte, la géométrie SmartArt, ainsi que d'autres effets de mise en page qui influencent l'apparence finale rendue de la forme.
