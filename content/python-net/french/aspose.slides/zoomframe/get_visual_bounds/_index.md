...
description: 
type: docs
url: /fr/aspose.slides/zoomframe/get_visual_bounds/
weight: 40
---
...
Le rectangle retourné représente les limites alignées sur les axes de tout le contenu produit par la forme lors du rendu dans l'espace des coordonnées de la diapositive.
            ...
            Les limites visuelles tiennent compte des aspects liés au rendu tels que les transformations (par exemple, rotation), largeur et jointures du contour, mise en page du texte et dépassement, géométrie SmartArt, et d'autres effets de mise en page qui influencent l'apparence finale rendue de la forme.
