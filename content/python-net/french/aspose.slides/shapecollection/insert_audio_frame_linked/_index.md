...
description: 
type: docs
url: /fr/aspose.slides/shapecollection/insert_audio_frame_linked/
weight: 220
---
...
### Valeur de retour
Le [`IAudioFrame`](/slides/python-net/fr/aspose.slides/iaudioframe).
...
| :- | :- | :- |
| index | **int** | L'indice basé sur zéro où insérer le cadre audio. |
