...
description: 
type: docs
url: /fr/aspose.slides/shapecollection/add_section_zoom_frame/
weight: 120
---
...
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Déclenchée si la section référencée n'appartient pas à la présentation actuelle ou ne contient aucune diapositive. |
