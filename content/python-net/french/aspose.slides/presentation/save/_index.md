...
| :- | :- | :- |
| fname | **str** |  |
| format | [`SaveFormat`](/slides/python-net/fr/aspose.slides.export/saveformat) |  |
| options | [`ISaveOptions`](/slides/python-net/fr/aspose.slides.export/isaveoptions) |  |
...
| :- | :- |
| **RuntimeError(Proxy error(NotSupportedException))** | Si vous essayez d’enregistrer un fichier chiffré dans <br/>            aucun format Office 2007-2010. |
...
| :- | :- | :- |
| fname | **str** | Chemin du fichier créé. |
| slides | **List[int]** | Tableau des positions des diapositives, à partir de 1. |
| format | [`SaveFormat`](/slides/python-net/fr/aspose.slides.export/saveformat) | Format des données exportées. |
