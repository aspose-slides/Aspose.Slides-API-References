...
description: 
type: docs
url: /fr/aspose.slides/idocumentproperties/set_custom_property_value/
weight: 80
---
...
| :- | :- | :- |
| name | **str** | Nom de la propriété personnalisée à définir |
| value | **bool** | Valeur de la propriété personnalisée |
...
Définit une propriété personnalisée de type chaîne nommée.
...
| :- | :- | :- |
| name | **str** | Nom de la propriété personnalisée à définir |
| value | **str** | Valeur de la propriété personnalisée |
