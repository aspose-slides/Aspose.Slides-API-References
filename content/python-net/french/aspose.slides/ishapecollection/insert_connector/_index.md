...
description: 
type: docs
url: /fr/aspose.slides/ishapecollection/insert_connector/
weight: 260
---
...
| :- | :- | :- |
| index | **int** | L'indice basé sur zéro où insérer la forme de connecteur. |
...
| width | **float** | La largeur du cadre du connecteur, en points. |
| height | **float** | La hauteur du cadre du connecteur, en points. |
| create_from_template | **bool** | Vrai pour appliquer le style de modèle par défaut (nom non vide, style simple);<br/><br/>            faux pour créer le connecteur avec les valeurs de propriété par défaut. |
