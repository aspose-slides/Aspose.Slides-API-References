...
**Héritage:**[`ColorFormat`](/slides/python-net/fr/aspose.slides/colorformat) → [`PVIObject`](/slides/python-net/fr/aspose.slides/pviobject)

Le type ColorFormat expose les membres suivants :
...
| [`float_r`](/slides/python-net/fr/aspose.slides/colorformat/float_r/) | Renvoie ou définit le composant rouge d'une couleur. Toutes les transformations de couleur sont ignorées.<br/>            Lecture/écriture **float**. |
| [`float_g`](/slides/python-net/fr/aspose.slides/colorformat/float_g/) | Renvoie ou définit le composant vert d'une couleur. Toutes les transformations de couleur sont ignorées.<br/>            Lecture/écriture **float**. |
| [`float_b`](/slides/python-net/fr/aspose.slides/colorformat/float_b/) | Renvoie ou définit le composant bleu d'une couleur. Toutes les transformations de couleur sont ignorées.<br/>            Lecture/écriture **float**. |
| [`hue`](/slides/python-net/fr/aspose.slides/colorformat/hue/) | Renvoie ou définit le composant teinte d'une couleur en représentation HSL.<br/>            Toutes les transformations de couleur sont ignorées.<br/>            Lecture/écriture **float**. |
| [`saturation`](/slides/python-net/fr/aspose.slides/colorformat/saturation/) | Renvoie ou définit le composant saturation d'une couleur en représentation HSL.<br/>            Toutes les transformations de couleur sont ignorées.<br/>            Lecture/écriture **float**. |
| [`luminance`](/slides/python-net/fr/aspose.slides/colorformat/luminance/) | Renvoie ou définit le composant luminance d'une couleur en représentation HSL.<br/>            Toutes les transformations de couleur sont ignorées.<br/>            Lecture/écriture **float**. |
| [`color_transform`](/slides/python-net/fr/aspose.slides/colorformat/color_transform/) | Renvoie la collection des transformations de couleur appliquées à une couleur.<br/>            Lecture seule [`IColorOperationCollection`](/slides/python-net/fr/aspose.slides/icoloroperationcollection). |
| [`slide`](/slides/python-net/fr/aspose.slides/colorformat/slide/) |  |
| [`presentation`](/slides/python-net/fr/aspose.slides/colorformat/presentation/) |  |
