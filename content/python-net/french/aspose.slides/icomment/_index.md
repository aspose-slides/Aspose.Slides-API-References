...
Le type IComment expose les membres suivants :

## Propriétés

| Propriété | Description |
| :- | :- |
| [`text`](/slides/python-net/fr/aspose.slides/icomment/text/) | Renvoie ou définit le texte brut d'un commentaire de diapositive.<br/>            Lecture/écriture **str**. |
...
| Méthode | Description |
| :- | :- |
| [`remove(self)`](/slides/python-net/fr/aspose.slides/icomment/remove/#) | Supprime le commentaire et toutes ses réponses de la collection parente. |
