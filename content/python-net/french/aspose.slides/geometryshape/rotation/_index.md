...
description: 
type: docs
url: /fr/aspose.slides/geometryshape/rotation/
weight: 390
---
## rotation propriété
Renvoie ou définit le nombre de degrés selon lequel la forme spécifiée est pivotée autour de l'axe z. Une valeur positive indique une rotation dans le sens des aiguilles d'une montre ; une valeur négative indique une rotation dans le sens inverse des aiguilles d'une montre. Lecture/écriture **float**.
