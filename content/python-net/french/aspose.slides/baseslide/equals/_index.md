...
Détermine si les deux instances IBaseSlide sont égales.
            ...
            Deux diapositives sont égales si toutes les formes, styles, textes, animations et autres paramètres, etc., sont égaux. La comparaison ne prend pas en compte les valeurs d'identificateur uniques, par exemple SlideId, ni le contenu dynamique, par exemple la valeur de la date actuelle dans l'espace réservé de date.
