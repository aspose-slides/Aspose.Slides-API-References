...
description: 
type: docs
url: /fr/aspose.slides.mathtext/mathaccent/group/
weight: 80
---
## group(self) {#}
...
Place cet élément dans un groupe à l'aide d'un caractère de regroupement tel que l'accolade inférieure ou un autre
...
| :- | :- | :- |
| caractère | **char** | Caractère de regroupement tel que BOTTOM CURLY BRACKET (U+23DF) ou tout autre |
