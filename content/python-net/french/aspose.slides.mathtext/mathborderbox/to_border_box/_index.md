...
description: 
type: docs
url: /fr/aspose.slides.mathtext/mathborderbox/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Border Box barré horizontal |
| strikethrough_vertical | **bool** | Border Box barré vertical |
| strikethrough_bottom_left_to_top_right | **bool** | Border Box barré du coin inférieur gauche au coin supérieur droit |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box barré du coin supérieur gauche au coin inférieur droit |
