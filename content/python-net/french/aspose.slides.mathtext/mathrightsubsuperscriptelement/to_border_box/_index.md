...
description: 
type: docs
url: /fr/aspose.slides.mathtext/mathrightsubsuperscriptelement/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| strikethrough_horizontal | **bool** | Barré horizontal de la Border Box |
| strikethrough_vertical | **bool** | Barré vertical de la Border Box |
| strikethrough_bottom_left_to_top_right | **bool** | Barré de la Border Box de bas-gauche à haut-droit |
| strikethrough_top_left_to_bottom_right | **bool** | Barré de la Border Box de haut-gauche à bas-droit |
