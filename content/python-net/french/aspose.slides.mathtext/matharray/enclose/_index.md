...
description: 
type: docs
url: /fr/aspose.slides.mathtext/matharray/enclose/
weight: 50
---
## enclose(self) {#}
...
L'élément mathématique de type [`IMathDelimiter`](/slides/python-net/fr/aspose.slides.mathtext/imathdelimiter) qui inclut les caractères spécifiés comme encadrement
...
| :- | :- | :- |
| beginning_character | **char** | Caractère de début (généralement le crochet gauche) |
| ending_character | **char** | Caractère de fin (généralement le crochet droit) |
