...
description: 
type: docs
url: /fr/aspose.slides.mathtext/mathphantom/zero_asc/
weight: 270
---
## zero_asc propriété
Obtient ou définit une valeur indiquant si l'ascension (hauteur au dessus de la ligne de base) de l'élément de base doit être traitée comme zéro.
