...
Le type MotionPath expose les membres suivants :

## Constructeurs

| Constructeur | Description |
| :- | :- |
| [`__init__(self)`](/slides/python-net/fr/aspose.slides.animation/motionpath/__init__/#) |  |

## Propriétés

| Propriété | Description |
| :- | :- |
| [`count`](/slides/python-net/fr/aspose.slides.animation/motionpath/count/) | Renvoie le nombre de chemins dans la collection.<br/>            Lecture seule **int**. |
...
| Nom | Description |
| :- | :- |
| [`[index]`](/slides/python-net/fr/aspose.slides.animation/motionpath/__getitem__/) |  |
