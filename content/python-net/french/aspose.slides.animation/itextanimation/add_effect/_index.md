...
description: 
type: docs
url: /fr/aspose.slides.animation/itextanimation/add_effect/
weight: 10
---
...
| trigger_type | [`EffectTriggerType`](/slides/python-net/fr/aspose.slides.animation/effecttriggertype) | Type de déclencheur de l'effet [`EffectTriggerType`](/slides/python-net/fr/aspose.slides.animation/effecttriggertype) |
...
* classe [`ITextAnimation`](/slides/python-net/fr/aspose.slides.animation/itextanimation)
