...
description: 
type: docs
url: /fr/aspose.slides.animation/ieffect/stop_previous_sound/
weight: 90
---
## stop_previous_sound propriété
Cet attribut indique si l'effet d'animation arrête le son précédent.
