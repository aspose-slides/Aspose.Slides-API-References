...
description: 
type: docs
url: /fr/aspose.slides.export/ihtmloptions/disable_font_ligatures/
weight: 40
---
## disable_font_ligatures propriété
Obtient ou définit une valeur indiquant si le texte est rendu sans utiliser de ligatures.
