...
description: 
type: docs
url: /fr/aspose.slides.export/html5options/skip_java_script_links/
weight: 120
---
## skip_java_script_links propriété
Spécifie s'il faut ignorer les hyperliens contenant des appels JavaScript lors de l'enregistrement de la présentation. 
            Lecture/écriture **bool**. La valeur par défaut est **false** .
...
### Voir aussi
* classe [`Html5Options`](/slides/python-net/fr/aspose.slides.export/html5options)
