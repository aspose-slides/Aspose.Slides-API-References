...
description: 
type: docs
url: /fr/aspose.slides.smartart/smartart/get_visual_bounds/
weight: 40
---
...
Le rectangle renvoyé représente les limites alignées sur les axes de tout le contenu
             produite par la forme lors du rendu dans l’espace de coordonnées de la diapositive.
...
Les limites visuelles tiennent compte des aspects liés au rendu tels que
             ...
             la disposition du texte et le débordement, la géométrie SmartArt et d’autres effets de mise en page
