...
description: 
type: docs
url: /tr/aspose.slides.animation/sequence/add_effect/
weight: 10
---
...
| :- | :- | :- |
| shape | [`IShape`](/slides/python-net/tr/aspose.slides/ishape) | Shape nesnesi [`IShape`](/slides/python-net/tr/aspose.slides/ishape) bir efekt eklemek için |
| effect_type | [`EffectType`](/slides/python-net/tr/aspose.slides.animation/effecttype) | Bir animasyon efektinin türü [`EffectType`](/slides/python-net/tr/aspose.slides.animation/effecttype) |
...
| trigger_type | [`EffectTriggerType`](/slides/python-net/tr/aspose.slides.animation/effecttriggertype) | Efekt tetikleme türü [`EffectTriggerType`](/slides/python-net/tr/aspose.slides.animation/effecttriggertype) |


## add_effect(self, paragraph, effect_type, subtype, trigger_type) {#iparagraph-effecttype-effectsubtype-effecttriggertype}
Paragraf için yeni animasyon efektini dizinin sonuna ekler.
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| paragraph | [`IParagraph`](/slides/python-net/tr/aspose.slides/iparagraph) | Paragraph nesnesi [`IParagraph`](/slides/python-net/tr/aspose.slides/iparagraph) |
| effect_type | [`EffectType`](/slides/python-net/tr/aspose.slides.animation/effecttype) | Bir animasyon efektinin türü [`EffectType`](/slides/python-net/tr/aspose.slides.animation/effecttype) |
| subtype | [`EffectSubtype`](/slides/python-net/tr/aspose.slides.animation/effectsubtype) | Animasyon efekti alt türleri [`EffectSubtype`](/slides/python-net/tr/aspose.slides.animation/effectsubtype) |
| trigger_type | [`EffectTriggerType`](/slides/python-net/tr/aspose.slides.animation/effecttriggertype) | Efekt tetikleme türü [`EffectTriggerType`](/slides/python-net/tr/aspose.slides.animation/effecttriggertype) |
...
Kategori veya seri için yeni grafik animasyon efektini dizinin sonuna ekler.
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| chart | [`IChart`](/slides/python-net/tr/aspose.slides.charts/ichart) | Chart nesnesi [`IChart`](/slides/python-net/tr/aspose.slides.charts/ichart) |
| type | [`EffectChartMajorGroupingType`](/slides/python-net/tr/aspose.slides.animation/effectchartmajorgroupingtype) | Bir animasyon efektinin türü [`EffectChartMinorGroupingType`](/slides/python-net/tr/aspose.slides.animation/effectchartminorgroupingtype) |
...
Kategori veya serideki öğeler için yeni grafik animasyon efektini dizinin sonuna ekler.
...
| :- | :- | :- |
| chart | [`IChart`](/slides/python-net/tr/aspose.slides.charts/ichart) | Chart nesnesi [`IChart`](/slides/python-net/tr/aspose.slides.charts/ichart) |
| type | [`EffectChartMinorGroupingType`](/slides/python-net/tr/aspose.slides.animation/effectchartminorgroupingtype) | Bir animasyon efektinin türü [`EffectChartMinorGroupingType`](/slides/python-net/tr/aspose.slides.animation/effectchartminorgroupingtype) |
| series_index | **int** | Grafik serisinin indeksi **int** |
...
* class [`Sequence`](/slides/python-net/tr/aspose.slides.animation/sequence)
