...
description: 
type: docs
url: /tr/aspose.slides.excel/exceldataworkbook/get_cell/
weight: 20
---
## get_cell(self, worksheet_index, cell_name) {#int-str}
Belirtilen çalışma sayfasından hücreyi, dizini ve Excel tarzı hücre adı (örn. "B2") kullanarak alır.
...
| :- | :- | :- |
| worksheet_index | **int** | Çalışma sayfasının sıfır tabanlı dizini. |
...
### Ayrıca Bakınız
* sınıf [`ExcelDataWorkbook`](/slides/python-net/tr/aspose.slides.excel/exceldataworkbook)
