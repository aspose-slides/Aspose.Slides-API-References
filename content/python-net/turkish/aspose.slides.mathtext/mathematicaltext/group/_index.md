...
description: 
type: docs
url: /tr/aspose.slides.mathtext/mathematicaltext/group/
weight: 80
---
## group(self) {#}
...
Yeni [`IMathGroupingCharacter`](/slides/python-net/tr/aspose.slides.mathtext/imathgroupingcharacter) türünde bir örnek
...
Bu öğeyi alt kıvrımlı parantez gibi bir grup oluşturma karakteri veya başka bir karakter kullanarak bir gruba yerleştirir
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/tr/aspose.slides.mathtext/mathtopbotpositions) | Grup karakterinin dikey hizalaması.<br/><br/>            Nesnenin temel çizgiye göre hizalanmasını belirtir.<br/><br/>            Örneğin, grup karakteri nesnenin üzerinde olduğunda, <br/><br/>            Top için VerticalJustification, nesnenin üst kısmının temel çizgiye denk geldiğini gösterir;<br/><br/>            VerticalJustification Bottom olarak ayarlandığında, nesnenin alt kısmı temel çizgide olur |
