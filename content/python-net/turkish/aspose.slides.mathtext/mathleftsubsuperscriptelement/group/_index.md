...
description: 
type: docs
url: /tr/aspose.slides.mathtext/mathleftsubsuperscriptelement/group/
weight: 80
---
## group(self) {#}
...
Bu öğeyi, alt kıvırcık parantez ya da başka bir grup karakteri kullanarak bir grup içinde yerleştirir
...
| :- | :- | :- |
| character | **char** | Alt kıvırcık parantez (U+23DF) gibi bir grup karakteri veya başka bir karakter |
