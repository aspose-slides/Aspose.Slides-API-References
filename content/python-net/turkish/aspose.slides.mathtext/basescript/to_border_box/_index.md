...
description: 
type: docs
url: /tr/aspose.slides.mathtext/basescript/to_border_box/
weight: 190
---
## to_border_box(self) {#}
...
Bu öğenin yerleştirildiği border-box
...
| strikethrough_bottom_left_to_top_right | **bool** | Border Box Alt Sol'dan Üst Sağ'a Üst Çizgi |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box Üst Sol'dan Alt Sağ'a Üst Çizgi |
