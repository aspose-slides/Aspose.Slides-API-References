...
description: 
type: docs
url: /tr/aspose.slides.mathtext/mathbar/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
Bu öğe yerleştirilmiş bir border-box
...
| strikethrough_bottom_left_to_top_right | **bool** | Border Box Alt-Sol'dan Üst-Sağa Çizgi |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box Üst-Sol'dan Alt-Sağa Çizgi |
