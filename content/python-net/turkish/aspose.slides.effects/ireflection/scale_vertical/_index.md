...
description: 
type: docs
url: /tr/aspose.slides.effects/ireflection/scale_vertical/
weight: 120
---
## scale_vertical özelliği
Dikey ölçekleme faktörünü belirtir, negatif ölçekleme bir ters çevirme oluşturur. (yüzde)
            Okuma/yazma **float**.
