...
description: 
type: docs
url: /tr/aspose.slides/groupshape/get_base_placeholder/
weight: 20
---
## get_base_placeholder(self) {#}
Temel bir yer tutucu şekil döndürür (geçerli şeklin kalıtım aldığı düzen ve/veya ana slayttan gelen şekil).
            Geçerli şekil kalıtım almazsa None döndürülür.
