...
description: 
type: docs
url: /tr/aspose.slides/icommentcollection/insert_comment/
weight: 40
---
## insert_comment(self, index, text, slide, position, creation_time) {#int-str-islide-asposeslidespointf-datetime}
Yeni bir yorumu belirtilen indekste bir koleksiyona ekleyin.
...
| position | [`PointF`](/slides/python-net/tr/aspose.slides/pointf) | Yeni bir yorumun ekleneceği slayttaki konum. |
