...
description: 
type: docs
url: /tr/aspose.slides/audiocollection/add_audio/
weight: 10
---
...
| :- | :- | :- |
| audio | [`IAudio`](/slides/python-net/tr/aspose.slides/iaudio) | Kaynak ses. |


## add_audio(self, stream) {#iorawiobase}
Bir akıştan ses oluşturur ve sunuma ekler.
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| stream | **io.RawIOBase** | Sesin ekleneceği akış. |


## add_audio(self, audio_data) {#bytes}
Bir bayt dizisinden ses oluşturur ve sunuma ekler.
...
| Parametre | Tür | Açıklama |
| :- | :- | :- |
| stream | **io.RawIOBase** | Video sesinin ekleneceği akış. |
...
### Ayrıca Bakınız
* sınıf [`AudioCollection`](/slides/python-net/tr/aspose.slides/audiocollection)
