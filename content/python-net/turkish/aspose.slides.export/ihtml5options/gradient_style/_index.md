...
description: 
type: docs
url: /tr/aspose.slides.export/ihtml5options/gradient_style/
weight: 70
---
## gradient_style özellik
### Tanım:
```python
@property
...
### Bakınız
* sınıf [`IHtml5Options`](/slides/python-net/tr/aspose.slides.export/ihtml5options)
