...
description: 
type: docs
url: /tr/aspose.slides.export/renderingoptions/default_regular_font/
weight: 30
---
## default_regular_font özelliği
Kaynak yazı tipi bulunamadığında kullanılan yazı tipini döndürür veya ayarlar.
Okuma-yazma **str**.
...
### Ayrıca Bakınız
* sınıf [`RenderingOptions`](/slides/python-net/tr/aspose.slides.export/renderingoptions)
