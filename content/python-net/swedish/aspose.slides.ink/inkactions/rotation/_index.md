...
description: 
type: docs
url: /sv/aspose.slides.ink/inkactions/rotation/
weight: 360
---
## rotationsegenskap
Returnerar eller anger antalet grader som den angivna formen roteras runt z-axeln. Ett positivt värde indikerar medurs rotation; ett negativt värde indikerar moturs rotation. Läs/skriv **float**.
