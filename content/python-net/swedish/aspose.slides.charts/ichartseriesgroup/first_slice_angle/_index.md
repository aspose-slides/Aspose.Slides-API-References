...
description: 
type: docs
url: /sv/aspose.slides.charts/ichartseriesgroup/first_slice_angle/
weight: 90
---
## first_slice_angle egenskap
Hämtar eller anger vinkeln för den första paj- eller munkdiagrammets segment,
            i grader (medurs från toppen, från 0 till 360 grader).
            Läs/skriv **int**.
