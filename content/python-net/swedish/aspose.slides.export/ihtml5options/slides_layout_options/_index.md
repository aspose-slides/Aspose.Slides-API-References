...
description: 
type: docs
url: /sv/aspose.slides.export/ihtml5options/slides_layout_options/
weight: 120
---
## slides_layout_options egenskap
Hämtar eller anger läget i vilket bilder placeras på sidan vid export av en presentation [`ISlidesLayoutOptions`](/slides/python-net/sv/aspose.slides.export/islideslayoutoptions).
