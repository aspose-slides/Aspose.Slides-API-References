...
description: 
type: docs
url: /sv/aspose.slides.excel/exceldataworkbook/get_cells/
weight: 30
---
...
| :- | :- | :- |
| formula | **str** | En formel eller områdesuttryck (t.ex. "Sheet1!A1:B3") som används för att identifiera målceller. |
| skip_hidden_cells | **bool** | Om `true`, kommer dolda celler (t.ex. i dolda rader eller kolumner) att uteslutas från resultatet. |
