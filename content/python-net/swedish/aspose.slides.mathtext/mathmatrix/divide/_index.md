...
description: 
type: docs
url: /sv/aspose.slides.mathtext/mathmatrix/divide/
weight: 60
---
## divide(self, denominator) {#imathelement}
Skapar ett bråk med denna täljare och angiven nämnare
...
Skapar ett bråk av den angivna typen med denna täljare och angiven nämnare
...
| :- | :- | :- |
| denominator | [`IMathElement`](/slides/python-net/sv/aspose.slides.mathtext/imathelement) | Nämnare |
| fraction_type | [`MathFractionTypes`](/slides/python-net/sv/aspose.slides.mathtext/mathfractiontypes) | Bråktype: Bar, NoBar, Skewed, Linear |
