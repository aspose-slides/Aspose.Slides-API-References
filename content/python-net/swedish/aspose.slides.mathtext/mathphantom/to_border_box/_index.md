...
description: 
type: docs
url: /sv/aspose.slides.mathtext/mathphantom/to_border_box/
weight: 200
---
## to_border_box(self) {#}
...
| :- | :- | :- |
| hide_top | **bool** | Dölj överkant |
| hide_bottom | **bool** | Dölj underkant |
...
| strikethrough_bottom_left_to_top_right | **bool** | Border Box genomstrykning nedre vänster till övre högra |
| strikethrough_top_left_to_bottom_right | **bool** | Border Box genomstrykning övre vänster till nedre högra |
