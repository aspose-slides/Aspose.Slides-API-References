...
description: 
type: docs
url: /sv/aspose.slides.mathtext/basescript/enclose/
weight: 40
---
## enclose(self) {#}
...
Matematikelement av typen [`IMathDelimiter`](/slides/python-net/sv/aspose.slides.mathtext/imathdelimiter) som inkluderar parentesen
...
Matematikelement av typen [`IMathDelimiter`](/slides/python-net/sv/aspose.slides.mathtext/imathdelimiter) som inkluderar specificerade tecken som ram
