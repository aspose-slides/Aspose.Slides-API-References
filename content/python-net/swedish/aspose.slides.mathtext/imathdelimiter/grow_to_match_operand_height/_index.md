...
description: 
type: docs
url: /sv/aspose.slides.mathtext/imathdelimiter/grow_to_match_operand_height/
weight: 290
---
## grow_to_match_operand_height egenskap
Specificerar tillväxten av BeginningCharacter, SeparatorCharacter, EndingCharacter
            När true, växer avgränsarna vertikalt för att matcha dess operandhöjd.
