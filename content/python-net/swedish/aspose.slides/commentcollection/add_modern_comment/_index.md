...
description: 
type: docs
url: /sv/aspose.slides/commentcollection/add_modern_comment/
weight: 20
---
...
| :- | :- | :- |
| text | **str** | Klartext för en ny modern kommentar. |
| slide | [`ISlide`](/slides/python-net/sv/aspose.slides/islide) | Bild i en presentation där en ny modern kommentar ska läggas till. |
| shape | [`IShape`](/slides/python-net/sv/aspose.slides/ishape) | Form på en bild som en ny modern kommentar är kopplad till. |
| position | **aspose.slides.PointF** | Position på en bild där en ny modern kommentar ska läggas till. |
| creation_time | **DateTime** | Tidpunkt för skapandet av en modern kommentar. |
