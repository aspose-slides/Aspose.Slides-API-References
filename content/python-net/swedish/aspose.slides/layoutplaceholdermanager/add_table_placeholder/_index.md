...
description: 
type: docs
url: /sv/aspose.slides/layoutplaceholdermanager/add_table_placeholder/
weight: 70
---
## add_table_placeholder(self, x, y, width, height) {#float-float-float-float}
Lägger till en ny platshållarform på layout-bilden för att hålla en tabell.

### Returnerar

Skapad [`IAutoShape`](/slides/python-net/sv/aspose.slides/iautoshape) med en Table-platshållare.
...
* klass [`LayoutPlaceholderManager`](/slides/python-net/sv/aspose.slides/layoutplaceholdermanager)
