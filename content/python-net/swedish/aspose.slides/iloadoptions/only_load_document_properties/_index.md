...
description: 
type: docs
url: /sv/aspose.slides/iloadoptions/only_load_document_properties/
weight: 100
---
...
Denna egenskap är meningsfull om presentationsfilen är lösenordsskyddad.
            ...
            Värdet false betyder att hela den krypterade presentationen ska läsas in med korrekt 
            lösenord.
            Om presentationen inte är krypterad ignoreras egenskapsvärdet alltid.
            Om dokumentegenskaperna i en krypterad fil inte är offentliga och egenskapsvärdet är true kan inte dokumentegenskaperna läsas in och ett undantag kommer att kastas.
            Läs-skriv **bool**.
...
### Se även
* class [`ILoadOptions`](/slides/python-net/sv/aspose.slides/iloadoptions)
