...
description: 
type: docs
url: /sv/aspose.slides/islidecollection/add_from_html/
weight: 30
---
...
| :- | :- | :- |
| html_text | **str** | HTML att lägga till. |
| resolver | [`IExternalResourceResolver`](/slides/python-net/sv/aspose.slides.importing/iexternalresourceresolver) | Ett återuppringnings-objekt som används för att hämta externa objekt. Om den här parametern är None ignoreras alla externa objekt. |
