...
description: 
type: docs
url: /sv/aspose.slides/ishapecollection/insert_picture_frame/
weight: 290
---
...
| image | [`IPPImage`](/slides/python-net/sv/aspose.slides/ippimage) | Den [`IPPImage`](/slides/python-net/sv/aspose.slides/ippimage) att visa i bildramen. |
...
* uppräkning [`ShapeType`](/slides/python-net/sv/aspose.slides/shapetype)
