...
description: 
type: docs
url: /sv/aspose.slides/ishapecollection/insert_audio_frame_linked/
weight: 220
---
## insert_audio_frame_linked(self, index, x, y, width, height, fname) {#int-float-float-float-float-str}
Skapar en ny ljudram som länkas till en extern ljudfil och infogar den i formens samling på det angivna indexet.
...
| fname | **str** | Sökvägen eller namnet på den externa ljudfilen att länka. |
