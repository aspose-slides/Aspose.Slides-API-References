...
description: 
type: docs
url: /sv/aspose.slides/slidecollection/insert_from_html/
weight: 80
---
...
| index | **int** | Position att infoga. |
| html_text | **str** | HTML att lägga till. |
| use_slide_with_index_as_start | **bool** | Den här flaggan bestämmer hur infogningen ska startas: från en ny bild eller från bilden med det angivna indexet.<br/><br/>            Om **true** , börjar datainförsel från ett tomt utrymme på bilden med det angivna indexet.<br/><br/>            Om **false** , läggs data till de skapade bilderna. |
...
| uri | **str** | En URI för den angivna HTML-filen. Används för att lösa relativa länkar. |
