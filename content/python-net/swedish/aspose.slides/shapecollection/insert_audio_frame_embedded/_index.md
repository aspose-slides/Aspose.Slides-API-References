...
description: 
type: docs
url: /sv/aspose.slides/shapecollection/insert_audio_frame_embedded/
weight: 210
---
## insert_audio_frame_embedded(self, index, x, y, width, height, audio_stream) {#int-float-float-float-float-iorawiobase}
Skapar en ny ljudram med en inbäddad WAV-fil och infogar den i shape-samlingen på angivet index. Den inbäddade ljudfilen läggs till i Presentation.Audios-samlingen.
...
| audio_stream | **io.RawIOBase** | En indataström som innehåller WAV-ljuddata att bädda in. |


## insert_audio_frame_embedded(self, index, x, y, width, height, audio) {#int-float-float-float-float-iaudio}
Skapar en ny ljudram och infogar den i shape-samlingen på angivet index med ett befintligt ljudobjekt från Presentation.Audios-listan.
...
| width | **float** | Bredden på den nya ljudramen, i punkter. |
| height | **float** | Höjden på den nya ljudramen, i punkter. |
| audio | [`IAudio`](/slides/python-net/sv/aspose.slides/iaudio) | En [`IAudio`](/slides/python-net/sv/aspose.slides/iaudio)-instans från Presentation.Audios-samlingen att bädda in. |
