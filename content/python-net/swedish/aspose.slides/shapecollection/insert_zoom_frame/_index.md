...
description: 
type: docs
url: /sv/aspose.slides/shapecollection/insert_zoom_frame/
weight: 340
---
...
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Kastas om den refererade sliden inte tillhör den aktuella presentationen. |
...
| height | **float** | Höjden på den nya Zoom-ramen, i punkter. |
| slide | [`ISlide`](/slides/python-net/sv/aspose.slides/islide) | Den [`ISlide`](/slides/python-net/sv/aspose.slides/islide) som refereras av Zoom-ramen. |
| image | [`IPPImage`](/slides/python-net/sv/aspose.slides/ippimage) | Bilden för den refererade sliden [`IPPImage`](/slides/python-net/sv/aspose.slides/ippimage). |
