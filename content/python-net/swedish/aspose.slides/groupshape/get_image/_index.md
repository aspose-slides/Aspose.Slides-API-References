...
description: 
type: docs
url: /sv/aspose.slides/groupshape/get_image/
weight: 30
---
## get_image(self) {#}
Returnerar formens miniatyrbild.
            ShapeThumbnailBounds.Shape typ för formens miniatyrgränser används som standard.
...
| :- | :- | :- |
| bounds | [`ShapeThumbnailBounds`](/slides/python-net/sv/aspose.slides/shapethumbnailbounds) | Typ för formens miniatyrgränser. |
