...
description: 
type: docs
url: /sv/aspose.slides/legacydiagram/get_image/
weight: 50
---
## get_image(self) {#}
Returnerar formens miniatyrbild.
            ShapeThumbnailBounds.Shape, typ av formens miniatyrbildsgräns, används som standard.
...
| :- | :- | :- |
| bounds | [`ShapeThumbnailBounds`](/slides/python-net/sv/aspose.slides/shapethumbnailbounds) | Typ av formens miniatyrbildsgräns. |
