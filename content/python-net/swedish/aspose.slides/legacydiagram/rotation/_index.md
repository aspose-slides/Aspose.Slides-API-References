...
description: 
type: docs
url: /sv/aspose.slides/legacydiagram/rotation/
weight: 380
---
## rotationsegenskap
Returnerar eller anger antalet grader som den angivna formen roteras kring z-axeln. Ett positivt värde indikerar medurs rotation; ett negativt värde indikerar moturs rotation. Läs/skriv **float**.
