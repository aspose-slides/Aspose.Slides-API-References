...
---
## formel egenskap
Formler inom värden, from, to, by-attribut kan bestå av dessa:
            Standardaritmetiska operatorer: ‘+’, ‘-‘, ‘*’, ‘/’, ‘^’, ‘%’ (mod)
            Konstanter: ‘pi’ ‘e’
            Villkorsoperatorer: ‘abs’, ‘min’, ‘max’, ‘?’ (if)
...
### Se även
* klass [`IPoint`](/slides/python-net/sv/aspose.slides.animation/ipoint)
