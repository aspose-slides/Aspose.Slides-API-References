...
description: 
type: docs
url: /el/aspose.slides.mathtext/mathmatrix/enclose/
weight: 70
---
## enclose(self) {#}
Περιβάλει ένα μαθηματικό στοιχείο σε παρενθέσεις
...
Περιβάλει ένα μαθηματικό στοιχείο σε καθορισμένους χαρακτήρες όπως παρενθέσεις ή άλλους χαρακτήρες ως πλαίσιο

### Επιστρέφει

Το μαθηματικό στοιχείο τύπου [`IMathDelimiter`](/slides/python-net/el/aspose.slides.mathtext/imathdelimiter) που περιλαμβάνει τους καθορισμένους χαρακτήρες ως πλαίσιο
