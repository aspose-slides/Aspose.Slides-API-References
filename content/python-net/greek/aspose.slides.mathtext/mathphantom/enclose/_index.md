...
description: 
type: docs
url: /el/aspose.slides.mathtext/mathphantom/enclose/
weight: 50
---
## enclose(self) {#}
Καλύπτει ένα μαθηματικό στοιχείο σε παρενθέσεις
...
Καλύπτει ένα μαθηματικό στοιχείο σε καθορισμένους χαρακτήρες όπως παρενθέσεις ή άλλους χαρακτήρες ως πλαισίωση

### Επιστρέφει

Το μαθηματικό στοιχείο τύπου [`IMathDelimiter`](/slides/python-net/el/aspose.slides.mathtext/imathdelimiter) που περιλαμβάνει καθορισμένους χαρακτήρες ως πλαισίωση
