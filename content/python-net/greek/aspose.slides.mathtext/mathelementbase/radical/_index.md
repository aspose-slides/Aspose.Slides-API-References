...
Νέα παρουσία του τύπου [`IMathRadical`](/slides/python-net/el/aspose.slides.mathtext/imathradical)
...
| :- | :- | :- |
| degree | [`IMathElement`](/slides/python-net/el/aspose.slides.mathtext/imathelement) | Παράμετρος του Ριζικού |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| degree | **str** | Παράμετρος του Ριζικού |
