...
description: 
type: docs
url: /el/aspose.slides.mathtext/mathfunction/divide/
weight: 40
---
...
| :- | :- | :- |
| denominator | [`IMathElement`](/slides/python-net/el/aspose.slides.mathtext/imathelement) | Παρονομαστής |
| fraction_type | [`MathFractionTypes`](/slides/python-net/el/aspose.slides.mathtext/mathfractiontypes) | Τύπος κλασματικού: Bar, NoBar, Skewed, Linear |
