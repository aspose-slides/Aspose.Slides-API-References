...
description: 
type: docs
url: /el/aspose.slides.mathtext/mathradical/enclose/
weight: 50
---
## enclose(self) {#}
...
Τοποθετεί ένα μαθηματικό στοιχείο σε καθορισμένους χαρακτήρες, όπως παρενθέσεις ή άλλους χαρακτήρες ως πλαίσιο

### Επιστρέφει

Το μαθηματικό στοιχείο τύπου [`IMathDelimiter`](/slides/python-net/el/aspose.slides.mathtext/imathdelimiter) που περιλαμβάνει καθορισμένους χαρακτήρες ως πλαίσιο
