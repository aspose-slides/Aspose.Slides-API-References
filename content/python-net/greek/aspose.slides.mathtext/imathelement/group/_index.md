...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/el/aspose.slides.mathtext/mathtopbotpositions) | Κατακόρυφη στοίχιση του χαρακτήρα ομαδοποίησης.<br/><br/>            Καθορίζει τη στοίχιση του αντικειμένου σε σχέση με τη γραμμή βάσης.<br/><br/>            Για παράδειγμα, όταν ο χαρακτήρας ομαδοποίησης βρίσκεται πάνω από το αντικείμενο, <br/><br/>            VerticalJustification of Top σημαίνει ότι το πάνω μέρος του αντικειμένου πέφτει στη γραμμή βάσης;<br/><br/>            όταν VerticalJustification είναι ορισμένο στο Bottom, το κάτω μέρος του αντικειμένου βρίσκεται στη γραμμή βάσης |
