...
description: 
type: docs
url: /el/aspose.slides/masterslidecollection/insert_clone/
weight: 20
---
## insert_clone(self, index, source_master) {#int-imasterslide}
Εισάγει ένα αντίγραφο μιας συγκεκριμένης κύριας διαφάνειας στη συγκεκριμένη θέση της συλλογής.
            Οι συνδεδεμένες διαφάνειες διάταξης θα αντιγραφούν επίσης.
...
| source_master | [`IMasterSlide`](/slides/python-net/el/aspose.slides/imasterslide) | Διαφάνεια προς κλωνοποίηση. |
