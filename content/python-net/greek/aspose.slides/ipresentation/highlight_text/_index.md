...
description: 
type: docs
url: /el/aspose.slides/ipresentation/highlight_text/
weight: 40
---
## highlight_text(self, text, highlight_color) {#str-asposepydrawingcolor}
Αποχρωματίζει όλες τις αντιστοιχίες του δείγματος κειμένου με το καθορισμένο χρώμα.
...
| :- | :- | :- |
| text | **str** | Το κείμενο προς αποχρωματισμό. |
| highlight_color | **aspose.slides.Color** | Το χρώμα για την αποχρωματισμό του κειμένου. |
...
### Δείτε επίσης
* κλάση [`IFindResultCallback`](/slides/python-net/el/aspose.slides/ifindresultcallback)
