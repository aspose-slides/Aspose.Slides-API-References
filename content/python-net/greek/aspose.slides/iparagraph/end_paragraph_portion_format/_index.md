...
description: 
type: docs
url: /el/aspose.slides/iparagraph/end_paragraph_portion_format/
weight: 70
---
## end_paragraph_portion_format ιδιότητα
Καθορίζει τις ιδιότητες του τμήματος που πρέπει να χρησιμοποιηθούν εφόσον ένα άλλο τμήμα εισαχθεί μετά 
            το τελευταίο.
