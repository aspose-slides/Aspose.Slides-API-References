...
description: 
type: docs
url: /el/aspose.slides/layoutslide/find_shape_by_alt_text/
weight: 30
---
...
| :- | :- | :- |
| alt_text | **str** | Εναλλακτικό κείμενο. |



### Δείτε επίσης
* κλάση [`IShape`](/slides/python-net/el/aspose.slides/ishape)
* κλάση [`LayoutSlide`](/slides/python-net/el/aspose.slides/layoutslide)
