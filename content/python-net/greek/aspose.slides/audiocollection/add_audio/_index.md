...
description: 
type: docs
url: /el/aspose.slides/audiocollection/add_audio/
weight: 10
---
...
| :- | :- | :- |
| audio | [`IAudio`](/slides/python-net/el/aspose.slides/iaudio) | Πηγαίος ήχος. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| stream | **io.RawIOBase** | Ροή από την οποία προστίθεται ο ήχος. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| stream | **io.RawIOBase** | Ροή από την οποία προστίθεται ήχος βίντεο. |
...
### Δείτε επίσης
* κλάση [`AudioCollection`](/slides/python-net/el/aspose.slides/audiocollection)
* κλάση [`IAudio`](/slides/python-net/el/aspose.slides/iaudio)
* απαρίθμηση [`LoadingStreamBehavior`](/slides/python-net/el/aspose.slides/loadingstreambehavior)
