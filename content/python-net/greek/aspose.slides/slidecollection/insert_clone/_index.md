...
description: 
type: docs
url: /el/aspose.slides/slidecollection/insert_clone/
weight: 60
---
...
### Remarks
Κατά την κλωνοποίηση μιας διαφάνειας μεταξύ διαφορετικών παρουσιάσεων, ο κύριος της διαφάνειας μπορεί επίσης να κλωνοποιηθεί.
...
| index | **int** | Δείκτης της νέας διαφάνειας. |
| source_slide | [`ISlide`](/slides/python-net/el/aspose.slides/islide) | Διαφάνεια προς κλωνοποίηση. |
| dest_layout | [`ILayoutSlide`](/slides/python-net/el/aspose.slides/ilayoutslide) | Διαφάνεια διάταξης για τη νέα διαφάνεια. |


## insert_clone(self, index, source_slide, dest_master, allow_clone_missing_layout) {#int-islide-imasterslide-bool}
Εισάγει ένα αντίγραφο μιας καθορισμένης πηγής διαφάνειας στη συγκεκριμένη θέση της συλλογής.
            Η κατάλληλη διάταξη θα επιλεγεί αυτόματα από τον καθορισμένο κύριο (η κατάλληλη διάταξη είναι η διάταξη με τον ίδιο Τύπο ή Όνομα όπως η διάταξη της πηγής διαφάνειας). Εάν δεν υπάρχει κατάλληλη διάταξη,
            η διάταξη της πηγής διαφάνειας θα κλωνοποιηθεί (εάν το allowCloneMissingLayout είναι true) ή θα προκληθεί η εξαίρεση PptxEditException (εάν το allowCloneMissingLayout είναι false).
...
| index | **int** | Δείκτης της νέας διαφάνειας. |
| source_slide | [`ISlide`](/slides/python-net/el/aspose.slides/islide) | Διαφάνεια προς κλωνοποίηση. |
| dest_master | [`IMasterSlide`](/slides/python-net/el/aspose.slides/imasterslide) | Κύρια διαφάνεια για τη νέα διαφάνεια. |
| allow_clone_missing_layout | **bool** | Εάν δεν υπάρχει κατάλληλη διάταξη στον καθορισμένο κύριο, τότε η διάταξη της <br/><br/>πηγής διαφάνειας θα κλωνοποιηθεί (εάν το allowCloneMissingLayout είναι true) ή <br/><br/>θα προκληθεί η εξαίρεση PptxEditException (εάν το allowCloneMissingLayout είναι false). |

### Exceptions
| Exception | Description |
| :- | :- |
| [`PptxEditException`](/slides/python-net/el/aspose.slides/pptxeditexception) | Εκτελείται εάν δεν υπάρχει κατάλληλη διάταξη στον καθορισμένο κύριο και <br/>            το allowCloneMissingLayout είναι false. |
