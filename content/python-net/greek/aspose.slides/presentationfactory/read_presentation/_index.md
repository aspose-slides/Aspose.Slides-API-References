...
description: 
type: docs
url: /el/aspose.slides/presentationfactory/read_presentation/
weight: 50
---
...
| :- | :- | :- |
| data | **bytes** | Πίνακας προς ανάγνωση |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| stream | **io.RawIOBase** | Ροή εισόδου για ανάγνωση |
...
| Παράμετρος | Τύπος | Περιγραφή |
| :- | :- | :- |
| file | **str** | Όνομα αρχείου |


## read_presentation(self, data, options) {#bytes-iloadoptions}
Διαβάζει μια υπάρχουσα παρουσίαση από έναν πίνακα με πρόσθετες επιλογές φόρτωσης
...
| :- | :- | :- |
| data | **bytes** | Πίνακας προς ανάγνωση |
| options | [`ILoadOptions`](/slides/python-net/el/aspose.slides/iloadoptions) | Επιλογές φόρτωσης |
...
* κλάση [`PresentationFactory`](/slides/python-net/el/aspose.slides/presentationfactory)
