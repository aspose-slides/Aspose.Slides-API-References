...
description: 
type: docs
url: /el/aspose.slides.smartart/smartartshape/add_placeholder/
weight: 10
---
...
Νέα [`Shape.placeholder`](/slides/python-net/el/aspose.slides/shape/placeholder).
...
| :- | :- | :- |
| placeholder_to_copy_from | [`IPlaceholder`](/slides/python-net/el/aspose.slides/iplaceholder) | Placeholder για αντιγραφή περιεχομένου. |
