...
description: 
type: docs
url: /el/aspose.slides.smartart/smartartshape/write_as_svg/
weight: 100
---
...
| :- | :- | :- |
| stream | **io.RawIOBase** | Στοχευόμενη ροή |
...
| :- | :- | :- |
| stream | **io.RawIOBase** | Στοχευόμενη ροή |
| svg_options | [`ISVGOptions`](/slides/python-net/el/aspose.slides.export/isvgoptions) | Επιλογές δημιουργίας SVG |
