...
Αυτά τα όρια ενδέχεται να διαφέρουν από τα όρια μοντέλου του σχήματος
             ...
             και μπορεί να περιέχουν αρνητικές συντεταγμένες εάν το αποδιδόμενο περιεχόμενο επεκτείνεται
             πέρα από το σημείο εκκίνησης της διαφάνειας.

Τα οπτικά όρια λαμβάνουν υπόψη πτυχές σχετικές με την απόδοση όπως
             μετασχηματισμοί (για παράδειγμα, περιστροφή), πλάτος και ενώσεις γραμμής,
