...
description: 
type: docs
url: /el/aspose.slides.export/ixpsoptions/show_hidden_slides/
weight: 70
---
## show_hidden_slides ιδιότητα
Καθορίζει εάν το παραγόμενο έγγραφο πρέπει να περιλαμβάνει κρυφές διαφάνειες ή όχι.
...
### Δείτε επίσης
* κλάση [`IXpsOptions`](/slides/python-net/el/aspose.slides.export/ixpsoptions)
