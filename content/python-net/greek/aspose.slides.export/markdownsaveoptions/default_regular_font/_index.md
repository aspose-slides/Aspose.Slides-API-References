...
description: 
type: docs
url: /el/aspose.slides.export/markdownsaveoptions/default_regular_font/
weight: 30
---
## default_regular_font ιδιότητα
Επιστρέφει ή ορίζει τη γραμματοσειρά που χρησιμοποιείται στην περίπτωση που η πηγαία γραμματοσειρά δεν βρεθεί.
