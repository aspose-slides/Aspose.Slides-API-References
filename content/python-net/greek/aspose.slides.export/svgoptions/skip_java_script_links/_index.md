...
description: 
type: docs
url: /el/aspose.slides.export/svgoptions/skip_java_script_links/
weight: 190
---
## skip_java_script_links ιδιότητα
Καθορίζει αν θα παραλειφθούν οι υπερσύνδεσμοι με κλήσεις JavaScript κατά την αποθήκευση της παρουσίασης. 
