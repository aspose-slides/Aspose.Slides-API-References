...
| :- | :- | :- |
| value | [`IChartSeries`](/slides/python-net/el/aspose.slides.charts/ichartseries) | Η τιμή. |

### Εξαιρέσεις

| Εξαίρεση | Περιγραφή |
| :- | :- |
| **RuntimeError(Proxy error(ArgumentException))** | Η παράμετρος value δεν βρέθηκε στη συλλογή. |
