...
description: 
type: docs
url: /el/aspose.slides.charts/chartdatacell/preset_number_format/
weight: 70
---
## preset_number_format ιδιότητα
Λαμβάνει ή ορίζει τη ενσωματωμένη μορφή εμφάνισης αριθμών και ημερομηνιών. Ο αριθμός προεπιλογής πρέπει να είναι στο [0..22] ή [37..49].
