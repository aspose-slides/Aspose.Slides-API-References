...
description: 
type: docs
url: /el/aspose.slides.charts/chartdatapointcollection/add_data_point_for_area_series/
weight: 10
---
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής.
            Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Area (δείτε επίσης **Aspose.Slides.Charts.ChartTypeCharacterizer.IsChartTypeArea(Aspose.Slides.Chart** method).
