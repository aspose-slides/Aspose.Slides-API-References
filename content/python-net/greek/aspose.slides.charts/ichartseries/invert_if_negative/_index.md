...
description: 
type: docs
url: /el/aspose.slides.charts/ichartseries/invert_if_negative/
weight: 200
---
## invert_if_negative ιδιότητα
Καθορίζει ότι η σειρά τύπου bar, column ή bubble θα αντιστρέψει τα χρώματά της εάν η τιμή είναι αρνητική.
