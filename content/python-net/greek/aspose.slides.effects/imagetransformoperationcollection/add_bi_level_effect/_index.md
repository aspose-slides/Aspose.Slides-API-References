...
description: 
type: docs
url: /el/aspose.slides.effects/imagetransformoperationcollection/add_bi_level_effect/
weight: 80
---
...
| :- | :- | :- |
| threshold | **float** | το όριο φωτεινότητας για το εφέ Bi-Level.<br/><br/>            Οι τιμές μεγαλύτερες ή ίσες με το όριο ορίζονται ως λευκό.<br/><br/>            Οι τιμές μικρότερες από το όριο ορίζονται ως μαύρο. |



### Δείτε επίσης
* κλάση [`IBiLevel`](/slides/python-net/el/aspose.slides.effects/ibilevel)
