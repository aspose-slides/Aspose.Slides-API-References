...
description: 
type: docs
url: /hu/aspose.slides.mathtext/mathrightsubsuperscriptelement/group/
weight: 80
---
## group(self) {#}
Az elem ezt a csoportba helyezi egy alsó kapcsos zárójel használatával
...
Az elem ezt a csoportba helyezi egy csoportosító karakter, például alsó kapcsos zárójel vagy más, használatával
...
| vertical_justification | [`MathTopBotPositions`](/slides/python-net/hu/aspose.slides.mathtext/mathtopbotpositions) | A csoportkarakter függőleges igazítása.<br/><br/>            Meghatározza az objektum igazítását a baseline-hez képest.<br/><br/>            Például, ha a csoportkarakter az objektum felett van, <br/><br/>            a VerticalJustification Top jelzi, hogy az objektum teteje a baseline-on helyezkedik;<br/><br/>            ha a VerticalJustification Bottom értékre van állítva, az objektum alja a baseline-on van |



### Lásd még
* osztály [`IMathGroupingCharacter`](/slides/python-net/hu/aspose.slides.mathtext/imathgroupingcharacter)
* osztály [`MathRightSubSuperscriptElement`](/slides/python-net/hu/aspose.slides.mathtext/mathrightsubsuperscriptelement)
