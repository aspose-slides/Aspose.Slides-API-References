...
description: 
type: docs
url: /hu/aspose.slides.mathtext/mathnaryoperator/join/
weight: 100
---
## join(self, math_element) {#imathelement}
Összeilleszti a matematikai elemet, és egy matematikai blokkot hoz létre
...
| :- | :- | :- |
| math_element | [`IMathElement`](/slides/python-net/hu/aspose.slides.mathtext/imathelement) | Az összeillesztendő elem |


## join(self, math_text) {#str}
Összeilleszti a matematikai szöveget, és egy matematikai blokkot hoz létre
...
| Paraméter | Típus | Leírás |
| :- | :- | :- |
| math_text | **str** | Az összeillesztendő matematikai szöveg |
