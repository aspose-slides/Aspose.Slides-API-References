...
description: 
type: docs
url: /hu/aspose.slides.mathtext/mathematicaltext/group/
weight: 80
---
## group(self) {#}
...
Az elemet egy csoportba helyezi egy csoportosító karakterrel, például alsó kapcsos zárójellel vagy más karakterrel
