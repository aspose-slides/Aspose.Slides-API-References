...
description: 
type: docs
url: /hu/aspose.slides.export/saveoptions/warning_callback/
weight: 50
---
## warning_callback tulajdonság
Visszaad vagy beállít egy objektumot, amely figyelmeztetéseket kap, és eldönti, hogy a betöltési folyamat folytatódik-e, vagy megszakad.
            Olvasás/írás [`IWarningCallback`](/slides/python-net/hu/aspose.slides.warnings/iwarningcallback).
