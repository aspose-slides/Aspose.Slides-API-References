...
description: 
type: docs
url: /hu/aspose.slides/summaryzoomsection/get_base_placeholder/
weight: 20
---
## get_base_placeholder(self) {#}
Visszaad egy alap helyőrző alakzatot (az elrendezésből és/vagy a mesterdiából származó alakzatot, amelyről a jelenlegi alakzat örökölt).
            Egy None érték kerül visszaadásra, ha a jelenlegi alakzat nem örökölt.
