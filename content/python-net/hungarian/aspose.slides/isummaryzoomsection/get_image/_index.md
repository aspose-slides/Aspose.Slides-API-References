...
second_title: Aspose.Slides for Python a .NET API hivatkozáson keresztül
description: 
type: docs
url: /hu/aspose.slides/isummaryzoomsection/get_image/
weight: 30
---
## get_image(self) {#}
...
| :- | :- | :- |
| bounds | [`ShapeThumbnailBounds`](/slides/python-net/hu/aspose.slides/shapethumbnailbounds) |  |
| scale_x | **float** |  |
| scale_y | **float** |  |
