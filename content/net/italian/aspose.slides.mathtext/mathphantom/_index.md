...
| Nome | Descrizione |
| --- | --- |
| [MathPhantom](mathphantom)(IMathElement) | Inizializza una nuova istanza della classe [`MathPhantom`](../mathphantom) utilizzando l'elemento matematico di base specificato. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathphantom/base) { get; } | Argomento di base |
...
| [Transp](../../aspose.slides.mathtext/mathphantom/transp) { get; set; } | Ottiene o imposta un valore che indica se il fantasma è trasparente per le regole di spaziatura basate su classe. |
...
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Racchiude un elemento matematico in caratteri specificati, come parentesi o altri caratteri di inquadratura. |
...
| [GetChildren](../../aspose.slides.mathtext/mathphantom/getchildren)() | Ottiene gli elementi figlio. |
...
| [ToBorderBox](../../aspose.slides.mathtext/mathelementbase/toborderbox)() | Posiziona questo elemento in un riquadro con bordo. |
| [ToBorderBox](../../aspose.slides.mathtext/mathelementbase/toborderbox)(bool, bool, bool, bool, bool, bool, bool, bool) | Posiziona questo elemento in un riquadro con bordo. |
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Posiziona questo elemento in una casella non visiva (raggruppamento logico) utilizzata per raggruppare componenti di un'equazione o altra istanza di testo matematico. Un oggetto incapsulato può (ad esempio) servire da emulatore di operatore con o senza punto di allineamento, servire da punto di interruzione di linea, o essere raggruppato in modo da non consentire interruzioni di linea all'interno. |
