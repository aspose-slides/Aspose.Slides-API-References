...
description: Specifica l'oggetto Sub-Superscript che consiste in una base e un pedice e apice posizionati a sinistra della base.
type: docs
weight: 8810
...
Specifica l'oggetto Sub-Superscript, che consiste in una base e un pedice e apice posizionati a sinistra della base.
...
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Inserisce un elemento matematico tra i caratteri specificati, ad esempio parentesi o altri caratteri di inquadratura |
...
| [Group](../../aspose.slides.mathtext/mathelementbase/group)(char, MathTopBotPositions, MathTopBotPositions) | Posiziona questo elemento in un gruppo usando un carattere di raggruppamento, come una graffa inferiore o altro |
...
| [Overbar](../../aspose.slides.mathtext/mathelementbase/overbar)() | Imposta una barra in cima a questo elemento |
