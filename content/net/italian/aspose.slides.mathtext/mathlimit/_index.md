...
| [Limit](../../aspose.slides.mathtext/mathlimit/limit) { get; } | Argomento del limite |
| [UpperLimit](../../aspose.slides.mathtext/mathlimit/upperlimit) { get; set; } | Specifica il limite superiore o inferiore |
...
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Racchiude un elemento matematico nei caratteri specificati, come le parentesi o altri caratteri di inquadramento |
...
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes, IMathElement, IMMathElement, MathLimitLocations) | Prende l'integrale |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Posiziona questo elemento in una casella non visuale (raggruppamento logico) utilizzata per raggruppare componenti di un'equazione o altra istanza di testo matematico. Un oggetto incapsulato può (ad esempio) servire da emulatore di operatore con o senza punto di allineamento, servire da punto di interruzione di linea, o essere raggruppato in modo da non permettere interruzioni di linea al suo interno. |
