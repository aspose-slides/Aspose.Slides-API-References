...
Specifica la funzione di barra, costituita da un argomento di base e da una barra superiore o inferiore
...
| Nome | Descrizione |
| --- | --- |
| [MathBar](mathbar#constructor)(IMathElement) | Inizializza MathBar con barra superiore (posizione Top) |
| [MathBar](mathbar#constructor_1)(IMathElement, MathTopBotPositions) | Inizializza MathBar con la posizione specificata |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathbar/base) { get; } | Argomento di base |
| [Position](../../aspose.slides.mathtext/mathbar/position) { get; set; } | Posizione della linea di barra. Predefinito: Top |
...
| [GetChildren](../../aspose.slides.mathtext/mathbar/getchildren)() | Ottiene gli elementi figli |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Inserisce questo elemento in una casella non visiva (raggruppamento logico) utilizzata per raggruppare componenti di un'equazione o altra istanza di testo matematico. Un oggetto incorniciato può (ad esempio) fungere da emulatore di operatore con o senza punto di allineamento, fungere da punto di interruzione di riga o essere raggruppato in modo da non consentire interruzioni di riga al suo interno. |
