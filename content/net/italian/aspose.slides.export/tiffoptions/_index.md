...
| Name | Description |
| --- | --- |
| [BwConversionMode](../../aspose.slides.export/tiffoptions/bwconversionmode) { get; set; } | Specifica l'algoritmo per la conversione di un'immagine a colori in un'immagine in bianco e nero. Questa opzione verrà applicata solo se [`CompressionType`](./compressiontype) è impostato su CCITT4 o CCITT3 Lettura/scrittura [`BlackWhiteConversionMode`](../blackwhiteconversionmode). Il valore predefinito è Default. |
...
| [ImageSize](../../aspose.slides.export/tiffoptions/imagesize) { get; set; } | Specifica le dimensioni di un'immagine TIFF generata. Il valore predefinito è 0x0, il che significa che le dimensioni dell'immagine generata saranno calcolate in base al valore della dimensione della diapositiva della presentazione. Lettura/scrittura Size. |
| [InkOptions](../../aspose.slides.export/tiffoptions/inkoptions) { get; } | Fornisce opzioni che controllano l'aspetto degli oggetti Ink nel documento esportato. Solo lettura [`IInkOptions`](../iinkoptions) |
...
| [SlidesLayoutOptions](../../aspose.slides.export/tiffoptions/slideslayoutoptions) { get; set; } | Ottiene o imposta la modalità in cui le diapositive sono posizionate sulla pagina quando si esporta una presentazione [`ISlidesLayoutOptions`](../islideslayoutoptions). |
| [WarningCallback](../../aspose.slides.export/saveoptions/warningcallback) { get; set; } | Restituisce o imposta un oggetto che riceve avvisi e decide se il processo di caricamento continuerà o sarà annullato. Lettura/scrittura [`IWarningCallback`](../../aspose.slides.warnings/iwarningcallback). |
...
```csharp
[C#]
// Istanziare un oggetto Presentation che rappresenta un file Presentation
using (Presentation pres = new Presentation("Convert_Tiff_Custom.pptx"))
{
    ...
    // Impostare DPI immagine
    opts.DpiX = 200;
    opts.DpiY = 100;
    // Im impostare dimensione immagine
    opts.ImageSize = new Size(1728, 1078);
    // Salvare la presentazione in TIFF con la dimensione immagine specificata
