...
| [AsIGraphicalObject](../../aspose.slides/oleobjectframe/asigraphicalobject) { get; } | Consente di ottenere l'interfaccia IGraphicalObject di base. Solo lettura [`IGraphicalObject`](../igraphicalobject). |
...
| virtual [EffectFormat](../../aspose.slides/shape/effectformat) { get; } | Restituisce l'oggetto EffectFormat che contiene gli effetti pixel applicati a una forma. Nota: può restituire null per alcuni tipi di forma che non possiedono proprietà di effetto. Solo lettura [`IEffectFormat`](../ieffectformat). |
...
| virtual [LineFormat](../../aspose.slides/shape/lineformat) { get; } | Restituisce l'oggetto LineFormat che contiene le proprietà di formattazione della linea per una forma. Nota: può restituire null per alcuni tipi di forma che non possiedono proprietà di linea. Solo lettura [`ILineFormat`](../ilineformat). |
...
| [Rotation](../../aspose.slides/shape/rotation) { get; set; } | Restituisce o imposta il numero di gradi di rotazione della forma specificata intorno all'asse z. Un valore positivo indica rotazione in senso orario; un valore negativo indica rotazione in senso antiorario. Lettura/scrittura Single. |
...
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Restituisce l'oggetto ThreeDFormat che contiene le proprietà di effetto 3D per una forma. Nota: può restituire null per alcuni tipi di forma che non possiedono proprietà 3D. Solo lettura [`IThreeDFormat`](../ithreedformat). |
...
| [UpdateAutomatic](../../aspose.slides/oleobjectframe/updateautomatic) { get; set; } | Determina se l'oggetto incorporato collegato viene aggiornato automaticamente quando la presentazione è aperta o stampata. Lettura/scrittura Boolean. |
...
| [GetImage](../../aspose.slides/shape/getimage)() | Restituisce l'anteprima della forma. Il tipo ShapeThumbnailBounds.Shape per i limiti dell'anteprima della forma è usato per impostazione predefinita. |
