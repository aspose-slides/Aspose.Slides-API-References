...
| [CaptionTracks](../../aspose.slides/videoframe/captiontracks) { get; } | Ottiene la raccolta di didascalie chiuse associate al video frame. Questa proprietà è solo lettura e restituisce un [`ICaptionsCollection`](../icaptionscollection) contenente tutte le tracce delle didascalie. |
...
| [FullScreenMode](../../aspose.slides/videoframe/fullscreenmode) { get; set; } | Determina se un video è visualizzato a schermo intero. Lettura/scrittura Boolean. |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Restituisce un identificatore univoco limitato alla diapositiva che rimane costante per la durata della forma e consente a PowerPoint o al codice interop di fare riferimento alla forma in modo affidabile da qualsiasi punto del documento. Solo lettura UInt32. Vedi anche [`UniqueId`](../shape/uniqueid). |
...
| [PlayMode](../../aspose.slides/videoframe/playmode) { get; set; } | Restituisce o imposta la modalità di riproduzione del video. Lettura/scrittura [`VideoPlayModePreset`](../videoplaymodepreset). |
...
| [RewindVideo](../../aspose.slides/videoframe/rewindvideo) { get; set; } | Determina se un video viene automaticamente riavvolto all'inizio non appena il film termina. Lettura/scrittura Boolean. |
...
| [TrimFromEnd](../../aspose.slides/videoframe/trimfromend) { get; set; } | Taglio finale [ms] |
| [TrimFromStart](../../aspose.slides/videoframe/trimfromstart) { get; set; } | Taglio iniziale [ms] |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Restituisce la posizione di una forma nell'ordine Z. Shapes[0] restituisce la forma più in fondo nell'ordine Z, e Shapes[Shapes.Count - 1] restituisce la forma più in primo piano nell'ordine Z. Solo lettura Int32. |
...
| [SetGeometryPath](../../aspose.slides/geometryshape/setgeometrypath)(IGeometryPath) | Aggiorna la geometria della forma dall'oggetto [`IGeometryPath`](../igeometrypath). Le coordinate devono essere relative all'angolo in alto a sinistra della forma. Cambia il tipo della forma ([`ShapeType`](../geometryshape/shapetype)) in Custom. |
