...
| [Presentation](../../aspose.slides/shape/presentation) { get; } | Restituisce la presentazione principale di una diapositiva. Sola lettura [`IPresentation`](../ipresentation). |
...
| [TargetSlide](../../aspose.slides/zoomframe/targetslide) { get; set; } | Restituisce o imposta l'oggetto diapositiva a cui l'oggetto Slide Zoom si collega. Lettura/scrittura [`ISlide`](../islide). |
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Restituisce l'oggetto ThreeDFormat che contiene le proprietà dell'effetto 3D per una forma. Nota: può restituire null per alcuni tipi di forma che non hanno proprietà 3D. Sola lettura [`IThreeDFormat`](../ithreedformat). |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Restituisce la posizione di una forma nell'ordine z. Shapes[0] restituisce la forma più indietro nell'ordine z, e Shapes[Shapes.Count - 1] restituisce la forma più in avanti nell'ordine z. Sola lettura Int32. |

## Metodi

| Nome | Descrizione |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | Aggiunge un nuovo segnaposto se non presente e imposta le proprietà del segnaposto a uno specificato. |
