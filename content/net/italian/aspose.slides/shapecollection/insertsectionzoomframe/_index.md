...
| --- | --- | --- |
| index | Int32 | L'indice base zero al quale inserire il frame Section Zoom. |
...
| section | ISection | Il [`ISection`](../../isection) a cui si riferisce il frame Section Zoom; deve appartenere a questa presentazione e contenere almeno una diapositiva. |
...
| --- | --- |
| ArgumentException | Lanciata se la sezione a cui si fa riferimento non appartiene alla presentazione corrente o non contiene diapositive. |

### Esempi

Questo esempio dimostra la creazione e l'inserimento di un oggetto Section Zoom all'indice specificato di una collezione (si assuma che nella presentazione "Presentation.pptx" ci siano almeno due sezioni):
