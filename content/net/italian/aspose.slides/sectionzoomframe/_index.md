...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Restituisce un identificatore univoco a livello di diapositiva che rimane costante per la durata della forma e consente a PowerPoint o al codice interop di fare riferimento affidabilmente alla forma da qualsiasi posizione nel documento. Solo lettura UInt32. Vedi anche [`UniqueId`](../shape/uniqueid). |
...
| [Placeholder](../../aspose.slides/shape/placeholder) { get; } | Restituisce il segnaposto di una forma. Restituisce null se la forma non ha un segnaposto. Solo lettura [`IPlaceholder`](../iplaceholder). |
...
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Restituisce l'oggetto ThreeDFormat che contiene le proprietà dell'effetto 3D per una forma. Nota: può restituire null per alcuni tipi di forme che non possiedono proprietà 3D. Solo lettura [`IThreeDFormat`](../ithreedformat). |
...
| [GetVisualBounds](../../aspose.slides/shape/getvisualbounds)() | Ottiene i limiti visuali della forma calcolati dal suo contenuto renderizzato. |
