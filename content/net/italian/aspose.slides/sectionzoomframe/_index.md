...
| [ImageType](../../aspose.slides/zoomobject/imagetype) { get; set; } | Restituisce o imposta il tipo di immagine di un oggetto zoom. Lettura/scrittura [`ZoomImageType`](../zoomimagetype). Valore predefinito: Preview |
...
| [ReturnToParent](../../aspose.slides/zoomobject/returntoparent) { get; set; } | Restituisce o imposta il comportamento di navigazione nella presentazione. Lettura/scrittura Boolean. Valore predefinito: false |
...
| [ShowBackground](../../aspose.slides/zoomobject/showbackground) { get; set; } | Restituisce o imposta il valore che specifica se lo Zoom utilizzerà lo sfondo della diapositiva di destinazione. Lettura/scrittura Boolean. Valore predefinito: true |
| [Slide](../../aspose.slides/shape/slide) { get; } | Restituisce la diapositiva genitore di una forma. Sola lettura [`IBaseSlide`](../ibaseslide). |
| [TargetSection](../../aspose.slides/sectionzoomframe/targetsection) { get; set; } | Restituisce o imposta l'oggetto sezione a cui l'oggetto Section Zoom collega. Lettura/scrittura [`ISection`](../isection). |
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Restituisce l'oggetto ThreeDFormat che contiene le proprietà dell'effetto 3D per una forma. Nota: può restituire null per alcuni tipi di forme che non hanno proprietà 3D. Sola lettura [`IThreeDFormat`](../ithreedformat). |
| [TransitionDuration](../../aspose.slides/zoomobject/transitionduration) { get; set; } | Restituisce o imposta la durata della transizione tra Zoom e diapositiva. Lettura/scrittura Single. Valore predefinito: 1.0f |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Restituisce un identificatore interno a livello di presentazione destinato all'uso da parte di componenti aggiuntivi o altro codice. Poiché questo valore può essere riassegnato dall'utente o programmaticamente, non deve essere trattato come una chiave unica persistente. Sola lettura UInt32. Vedi anche [`OfficeInteropShapeId`](../shape/officeinteropshapeid). |
...
| [ZoomImage](../../aspose.slides/zoomobject/zoomimage) { get; set; } | Restituisce o imposta l'immagine per l'oggetto zoom. Lettura/scrittura [`IPPImage`](../ippimage). |
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Restituisce la posizione di una forma nell'ordine z. Shapes[0] restituisce la forma più arretrata nell'ordine z, e Shapes[Shapes.Count - 1] restituisce la forma più in primo piano nell'ordine z. Sola lettura Int32. |

## Metodi

| Nome | Descrizione |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | Aggiunge un nuovo segnaposto se non esiste e imposta le proprietà del segnaposto su uno specificato. |
...
| [GetImage](../../aspose.slides/shape/getimage)() | Restituisce la miniatura della forma. Il tipo ShapeThumbnailBounds.Shape per i limiti della miniatura è usato per impostazione predefinita. |
