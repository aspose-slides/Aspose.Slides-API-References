...
| [BlackWhiteMode](../../aspose.slides/shape/blackwhitemode) { get; set; } | Proprietà che specifica come una forma verrà renderizzata in modalità bianco-nero. Lettura/scrittura [`BlackWhiteMode`](../blackwhitemode). |
...
| [Layout](../../aspose.slides/summaryzoomframe/layout) { get; } | Ottiene il layout delle sezioni Summary Zoom nel frame. Il valore predefinito è GridLayout. |
...
| [Placeholder](../../aspose.slides/shape/placeholder) { get; } | Restituisce il segnaposto per una forma. Restituisce null se la forma non ha alcun segnaposto. Sola lettura [`IPlaceholder`](../iplaceholder). |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Restituisce la posizione di una forma nell'ordine Z. Shapes[0] restituisce la forma posta sullo sfondo dell'ordine Z, e Shapes[Shapes.Count - 1] restituisce la forma posta in primo piano dell'ordine Z. Sola lettura Int32. |
