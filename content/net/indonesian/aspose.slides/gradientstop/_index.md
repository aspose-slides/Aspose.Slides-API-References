...
| [Color](../../aspose.slides/gradientstop/color) { get; } | Mengembalikan warna dari titik henti gradien. Hanya-baca [`IColorFormat`](../icolorformat). |
| [Position](../../aspose.slides/gradientstop/position) { get; set; } | Mengembalikan atau mengatur posisi (0..1) dari titik henti gradien. Baca/tulis Single. |
