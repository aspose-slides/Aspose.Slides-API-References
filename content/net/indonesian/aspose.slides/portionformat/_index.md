...
| Nama | Deskripsi |
| --- | --- |
| [PortionFormat](portionformat)() | Menginisialisasi instance baru dari kelas [`PortionFormat`](../portionformat). |
...
| [FontUnderline](../../aspose.slides/baseportionformat/fontunderline) { get; set; } | Mengembalikan atau mengatur jenis underline teks. Tidak ada pewarisan yang diterapkan. Baca/tulis [`TextUnderlineType`](../textunderlinetype). |
...
| [LineFormat](../../aspose.slides/baseportionformat/lineformat) { get; } | Mengembalikan properti LineFormat untuk outline teks. Tidak ada pewarisan yang diterapkan. Hanya-baca [`ILineFormat`](../ilineformat). |
...
| [ProofDisabled](../../aspose.slides/baseportionformat/proofdisabled) { get; set; } | Menentukan apakah teks tidak boleh diperiksa. Tidak ada pewarisan yang diterapkan. Baca/tulis [`NullableBool`](../nullablebool). |
...
| [StrikethroughType](../../aspose.slides/baseportionformat/strikethroughtype) { get; set; } | Mengembalikan atau mengatur jenis strikethrough teks. Tidak ada pewarisan yang diterapkan. Baca/tulis [`TextStrikethroughType`](../textstrikethroughtype). |
...
| [UnderlineLineFormat](../../aspose.slides/baseportionformat/underlinelineformat) { get; } | Mengembalikan properti LineFormat yang digunakan untuk outline garis underline. Tidak ada pewarisan yang diterapkan. Hanya-baca [`ILineFormat`](../ilineformat). |
...
Contoh berikut menunjukkan cara menetapkan font Latin ke bagian Paragraph dari Presentasi PowerPoint.
