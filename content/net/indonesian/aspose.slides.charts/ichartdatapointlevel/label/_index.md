...
description: Mewakili label data pada level titik data. Diterapkan untuk tipe seri Treemap dan Sunburst. Hanya-baca IDataLabelaspose.slides.charts/idatalabel.
type: docs
weight: 20
url: /id/aspose.slides.charts/ichartdatapointlevel/label/
---
## IChartDataPointLevel.Label properti

Mewakili label data pada level titik data. Diterapkan untuk tipe seri Treemap dan Sunburst. Hanya-baca [`IDataLabel`](../../idatalabel).
