...
| Nama | Deskripsi |
| --- | --- |
| [FromBlack](../../aspose.slides.slideshow/optionalblacktransition/fromblack) { get; set; } | Atribut ini menentukan apakah transisi akan dimulai dari layar hitam (dan kemudian beralih ke slide baru di atas hitam). Baca/tulis Boolean. |
