...
Menentukan objek Sub-Superscript, yang terdiri dari basis serta subskrip dan superskrip yang ditempatkan di kanan basis.
...
| Name | Description |
| --- | --- |
| [MathRightSubSuperscriptElement](mathrightsubsuperscriptelement)(IMathElement, IMathElement, IMathElement) | Menginisialisasi instance baru dari kelas MathRightSubSuperscriptElement. |

## Properti

| Name | Description |
| --- | --- |
| [AlignScripts](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/alignscripts) { get; set; } | Menentukan perataan subskrip/superskrip. Saat true, subskrip dan superskrip disejajarkan secara horizontal satu sama lain. Saat false, mereka dipasangkan mengikuti bentuk basis. Nilai default adalah false. |
