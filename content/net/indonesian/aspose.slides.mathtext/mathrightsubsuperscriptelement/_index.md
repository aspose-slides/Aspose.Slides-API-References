...
description: Menentukan objek Sub-Superscript yang terdiri dari basis serta subskrip dan superskrip yang ditempatkan di kanan basis.
type: docs
weight: 8960
...
Menentukan objek Sub-Superscript, yang terdiri dari basis dan subskrip serta superskrip yang ditempatkan di kanan basis.
...
| Nama | Deskripsi |
| --- | --- |
| [MathRightSubSuperscriptElement](mathrightsubsuperscriptelement)(IMathElement, IMathElement, IMathElement) | Menginisialisasi sebuah instance baru dari kelas MathRightSubSuperscriptElement. |

## Properti

| Nama | Deskripsi |
| --- | --- |
| [AlignScripts](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/alignscripts) { get; set; } | Menentukan perataan subskrip/superskrip. Ketika true, subskrip dan superskrip disejajarkan secara horizontal satu sama lain. Ketika false, mereka di-kern ke bentuk basis. Nilai default adalah false. |
| [Base](../../aspose.slides.mathtext/basescript/base) { get; } | Argumen basis |
| [Subscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/subscript) { get; } | Argumen subskrip |
| [Superscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/superscript) { get; } | Argumen superskrip |
...
| [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)() | Membungkus elemen matematis dalam tanda kurung |
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Membungkus elemen matematis dalam karakter yang ditentukan seperti tanda kurung atau karakter lain sebagai bingkai |
...
| [GetChildren](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/getchildren)() | Mendapatkan elemen anak |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)() | Menempatkan elemen ini dalam grup menggunakan kurung kurawal di bawah |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)(char, MathTopBotPositions, MathTopBotPositions) | Menempatkan elemen ini dalam grup menggunakan karakter pengelompokan seperti kurung kurawal di bawah atau karakter lain |
...
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(IMathElement) | Menentukan akar matematis dengan derajat tertentu dari argumen yang ditentukan. |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(string) | Menentukan akar matematis dengan derajat tertentu dari argumen yang ditentukan. |
