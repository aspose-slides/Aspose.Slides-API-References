...
description: Menentukan fungsi sebuah argumen.
type: docs
weight: 8700
...
Menentukan fungsi satu argumen.
...
| Nama | Deskripsi |
| --- | --- |
| [MathFunction](mathfunction#constructor)(IMathElement, IMathElement) | Menginisialisasi sebuah instance baru dari kelas MathFunction. |
| [MathFunction](mathfunction#constructor_1)(string, IMathElement) | Menginisialisasi sebuah instance baru dari kelas MathFunction. |

## Properti

| Nama | Deskripsi |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathfunction/base) { get; } | Argumen Fungsi |
| [Name](../../aspose.slides.mathtext/mathfunction/name) { get; } | Nama fungsi. Misalnya, nama fungsi adalah sin dan cos |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Mengambil fungsi yang ditentukan dengan menggunakan instance ini sebagai argumen serta argumen tambahan yang ditentukan |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Mengambil fungsi yang ditentukan dengan menggunakan instance ini sebagai argumen serta argumen tambahan yang ditentukan |
...
| [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)() | Menyelimuti elemen matematika dalam tanda kurung |
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Menyelimuti elemen matematika dengan karakter tertentu seperti tanda kurung atau karakter lain sebagai bingkai |
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(IMathElement) | Mengambil fungsi sebuah argumen dengan menggunakan instance ini sebagai nama fungsi |
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(string) | Mengambil fungsi sebuah argumen dengan menggunakan instance ini sebagai nama fungsi |
| [GetChildren](../../aspose.slides.mathtext/mathfunction/getchildren)() | Mendapatkan elemen anak |
