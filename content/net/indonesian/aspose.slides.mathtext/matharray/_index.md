...
| Nama | Deskripsi |
| --- | --- |
| [MathArray](matharray#constructor_1)(IEnumerable&lt;IMathElement&gt;) | Membuat array matematika dan menempatkan elemen yang ditentukan di dalamnya |
| [MathArray](matharray#constructor)(IMathElement) | Membuat array matematika dan menempatkan elemen yang ditentukan di dalamnya |

## Properti

| Nama | Deskripsi |
| --- | --- |
| [Arguments](../../aspose.slides.mathtext/matharray/arguments) { get; } | Kumpulan item pada array |
...
| [MaximumDistribution](../../aspose.slides.mathtext/matharray/maximumdistribution) { get; set; } | Distribusi Maksimum. Jika true, array diatur jaraknya ke lebar maksimum elemen yang mengandung (halaman, kolom, sel, dll.). |
| [ObjectDistribution](../../aspose.slides.mathtext/matharray/objectdistribution) { get; set; } | Distribusi Objek. Jika true, isi array diatur jaraknya ke lebar maksimum objek array. |
| [RowSpacing](../../aspose.slides.mathtext/matharray/rowspacing) { get; set; } | Jarak antar baris pada array. Hanya digunakan ketika RowSpacingRule diatur ke 3 (Exactly), dimana satuan ukuran adalah poin, atau Multiple, dimana satuan ukuran adalah setengah baris. Nilai default: 0 |
| [RowSpacingRule](../../aspose.slides.mathtext/matharray/rowspacingrule) { get; set; } | Tipe jarak vertikal antar elemen array. Nilai default: SingleLineGap |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(IMathElement) | Menerapkan fungsi yang ditentukan dengan menggunakan instansi ini sebagai argumen |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfOneArgument) | Menerapkan fungsi yang ditentukan dengan menggunakan instansi ini sebagai argumen |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(string) | Menerapkan fungsi yang ditentukan dengan menggunakan instansi ini sebagai argumen |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Menerapkan fungsi yang ditentukan dengan menggunakan instansi ini sebagai argumen dan argumen tambahan yang ditentukan |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Menerapkan fungsi yang ditentukan dengan menggunakan instansi ini sebagai argumen dan argumen tambahan yang ditentukan |
...
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(IMathElement) | Mengambil fungsi dengan satu argumen menggunakan instansi ini sebagai nama fungsi |
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(string) | Mengambil fungsi dengan satu argumen menggunakan instansi ini sebagai nama fungsi |
