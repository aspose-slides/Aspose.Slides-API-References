...
description: Representasikan sebuah objek matematika phantom ltmphantgt yang memengaruhi tata letak elemen anaknya tanpa harus menampilkannya. Sebuah phantom dapat menyembunyikan ekspresi dasarnya sambil mempertahankan lebar, tinggi, atau kedalaman untuk menyelaraskan rumus atau menyisakan ruang. Visibilitas dan perilaku geometri dikendalikan oleh properti seperti Show, ZeroWid, ZeroAsc, ZeroDesc, dan Transp.
type: docs
weight: 8920
...
Mewakili objek matematika phantom (&lt;m:phant&gt;) yang memengaruhi tata letak elemen anaknya tanpa harus menampilkannya. Sebuah phantom dapat menyembunyikan ekspresi dasar sambil mempertahankan lebar, tinggi, atau kedalamannya untuk menyelaraskan rumus atau menyisakan ruang. Visibilitas dan perilaku geometri dikendalikan oleh properti seperti Show, ZeroWid, ZeroAsc, ZeroDesc, dan Transp.
...
| Nama | Deskripsi |
| --- | --- |
| [MathPhantom](mathphantom)(IMathElement) | Menginisialisasi instance baru dari kelas [`MathPhantom`](../mathphantom) menggunakan elemen matematika dasar yang ditentukan. |
...
| [ZeroAsc](../../aspose.slides.mathtext/mathphantom/zeroasc) { get; set; } | Mendapatkan atau menetapkan nilai yang menunjukkan apakah naik (tinggi di atas garis dasar) elemen dasar diperlakukan sebagai nol. |
| [ZeroDesc](../../aspose.slides.mathtext/mathphantom/zerodesc) { get; set; } | Mendapatkan atau menetapkan nilai yang menunjukkan apakah turun (kedalaman di bawah garis dasar) elemen dasar diperlakukan sebagai nol. |
| [ZeroWidth](../../aspose.slides.mathtext/mathphantom/zerowidth) { get; set; } | Mendapatkan atau menetapkan nilai yang menunjukkan apakah lebar elemen dasar diperlakukan sebagai nol. |
