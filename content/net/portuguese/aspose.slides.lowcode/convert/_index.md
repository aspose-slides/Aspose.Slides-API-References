...
| Name | Description |
| --- | --- |
| delegate [GetOutPathCallback](convert.getoutpathcallback) | Callback que será invocado para cada [`Slide`](../../aspose.slides/slide), sendo esperado que o caminho de saída seja retornado. |
