...
| [HyperlinkMouseOver](../../aspose.slides/shape/hyperlinkmouseover) { get; set; } | Retorna ou define o hyperlink definido para mouse sobre. Leitura/gravação [`IHyperlink`](../../aspose.slides/ihyperlink). |
...
| [IsReversed](../../aspose.slides.smartart/smartart/isreversed) { get; set; } | Retorna ou define o estado do diagrama SmartArt em relação a (esquerda para direita) LTR ou (direita para esquerda) RTL, se o diagrama suportar inversão. Leitura/gravação Boolean. |
...
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Retorna o objeto ThreeDFormat que contém as propriedades de efeito 3D para uma forma. Observação: pode retornar null para certos tipos de formas que não possuem propriedades 3D. Somente leitura [`IThreeDFormat`](../../aspose.slides/ithreedformat). |
...
| Nome | Descrição |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | Adiciona um novo placeholder se não existir e define as propriedades do placeholder para um especificado. |
