...
description: Cria um novo gráfico, inicializa-o com dados e configurações de série de exemplo e o insere na coleção de formas no índice especificado.
type: docs
weight: 310
...
| height | Single | A altura do novo gráfico, em pontos. |
| index | Int32 | O índice baseado em zero no qual inserir o novo gráfico na coleção de formas. |
| initWithSample | Boolean | True para inicializar o novo gráfico com dados e configurações de série de exemplo; false para criar o gráfico sem séries e apenas com configurações mínimas, o que torna a criação mais rápida. |
