...
| width | Single | A largura da moldura do conector, em pontos. |
| height | Single | A altura da moldura do conector, em pontos. |
| createFromTemplate | Boolean | True para aplicar o estilo de modelo padrão (nome não vazio, estilo simples); false para criar o conector com os valores de propriedade padrão. |
