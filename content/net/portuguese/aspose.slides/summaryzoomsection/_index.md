...
| [Description](../../aspose.slides/summaryzoomsection/description) { get; set; } | Retorna a descrição de texto do objeto Summary Zoom Section. |
...
| [Frame](../../aspose.slides/shape/frame) { get; set; } | Retorna ou define as propriedades do quadro da forma. Leitura/Gravação [`IShapeFrame`](../ishapeframe). |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Retorna um identificador único no escopo do slide que permanece constante durante a vida da forma e permite que o PowerPoint ou código interop referencie a forma de forma confiável a partir de qualquer parte do documento. Somente leitura UInt32. Consulte também [`UniqueId`](../shape/uniqueid). |
...
| [Placeholder](../../aspose.slides/shape/placeholder) { get; } | Retorna o espaço reservado para uma forma. Retorna null se a forma não possuir espaço reservado. Somente leitura [`IPlaceholder`](../iplaceholder). |
...
| [RawFrame](../../aspose.slides/shape/rawframe) { get; set; } | Retorna ou define as propriedades brutas do quadro da forma. Leitura/Gravação [`IShapeFrame`](../ishapeframe). |
...
| [ShowBackground](../../aspose.slides/zoomobject/showbackground) { get; set; } | Obtém ou define se o Zoom usará o plano de fundo do slide de destino. Leitura/Gravação Boolean. Valor padrão: true |
...
| [Title](../../aspose.slides/summaryzoomsection/title) { get; set; } | Retorna o título de texto do objeto Summary Zoom Section. |
| [TransitionDuration](../../aspose.slides/zoomobject/transitionduration) { get; set; } | Obtém ou define a duração da transição entre o Zoom e o slide. Leitura/Gravação Single. Valor padrão: 1.0f |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Retorna um identificador interno, no escopo da apresentação, destinado ao uso por complementos ou outro código. Como esse valor pode ser reatribuído pelo usuário ou programaticamente, não deve ser tratado como uma chave única persistente. Somente leitura UInt32. Consulte também [`OfficeInteropShapeId`](../shape/officeinteropshapeid). |
...
| [GetImage](../../aspose.slides/shape/getimage)() | Retorna a miniatura da forma. O tipo ShapeThumbnailBounds.Shape de limites de miniatura de forma é usado por padrão. |
