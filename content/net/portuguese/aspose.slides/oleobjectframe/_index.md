...
| [IsObjectLink](../../aspose.slides/oleobjectframe/isobjectlink) { get; } | Determina se um objeto está ligado a um arquivo externo. Somente leitura Boolean. |
...
| [LinkFileName](../../aspose.slides/oleobjectframe/linkfilename) { get; } | Retorna o caminho completo para um arquivo vinculado. Será usado o nome curto do arquivo. Somente leitura String. |
| [LinkPathLong](../../aspose.slides/oleobjectframe/linkpathlong) { get; set; } | Retorna o caminho completo para um arquivo vinculado. Será usado o nome longo do arquivo. Leitura/gravação String. |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Retorna um identificador exclusivo em escopo de slide que permanece constante durante a vida da forma e permite que o PowerPoint ou código interop referencie a forma de forma confiável de qualquer lugar no documento. Somente leitura UInt32. Consulte também [`UniqueId`](../shape/uniqueid). |
...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Retorna um identificador interno em escopo de apresentação destinado ao uso por complementos ou outro código. Como esse valor pode ser reatribuído pelo usuário ou programaticamente, não deve ser tratado como uma chave única persistente. Somente leitura UInt32. Consulte também [`OfficeInteropShapeId`](../shape/officeinteropshapeid). |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Retorna um placeholder de forma básico (forma do layout e/ou slide mestre da qual a forma atual é herdada). Retorna null se a forma atual não for herdada. |
