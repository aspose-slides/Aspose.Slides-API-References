...
description: Propriedades comuns de formatação de porção de texto.
type: docs
weight: 950
...
Propriedades comuns de formatação de porção de texto.
...
| [ComplexScriptFont](../../aspose.slides/baseportionformat/complexscriptfont) { get; set; } | Retorna ou define as informações de fonte de script complexo. Null indica que a fonte está indefinida e deve ser herdada do Mestre. Leitura/gravação [`IFontData`](../ifontdata). |
| [EastAsianFont](../../aspose.slides/baseportionformat/eastasianfont) { get; set; } | Retorna ou define as informações de fonte do Leste Asiático. Null indica que a fonte está indefinida e deve ser herdada do Mestre. Leitura/gravação [`IFontData`](../ifontdata). |
...
| [Escapement](../../aspose.slides/baseportionformat/escapement) { get; set; } | Retorna ou define o texto sobrescrito ou subscrito. Valor de -100% (subscrito) a 100% (sobrescrito). **float.NaN** indica valor indefinido e deve ser herdado do Mestre. Leitura/gravação Single. |
...
| [FontHeight](../../aspose.slides/baseportionformat/fontheight) { get; set; } | Retorna ou define a altura da fonte da porção. **float.NaN** indica altura indefinida e deve ser herdada do Mestre. Leitura/gravação Single. |
...
| [HighlightColor](../../aspose.slides/baseportionformat/highlightcolor) { get; } | Retorna a cor usada para realçar o texto. Nenhuma herança aplicada. Somente leitura [`IColorFormat`](../icolorformat). |
| [IsHardUnderlineFill](../../aspose.slides/baseportionformat/ishardunderlinefill) { get; set; } | Determina se o estilo de sublinhado tem propriedades FillFormat próprias ou herda das propriedades FillFormat do texto. Leitura/gravação [`NullableBool`](../nullablebool). |
| [IsHardUnderlineLine](../../aspose.slides/baseportionformat/ishardunderlineline) { get; set; } | Determina se o estilo de sublinhado tem propriedades LineFormat próprias ou herda das propriedades LineFormat do texto. Leitura/gravação [`NullableBool`](../nullablebool). |
| [KerningMinimalSize](../../aspose.slides/baseportionformat/kerningminimalsize) { get; set; } | Retorna ou define o tamanho mínimo da fonte para o qual o kerning deve ser ativado. **float.NaN** indica valor indefinido e deve ser herdado do Mestre. Leitura/gravação Single. |
...
| [LatinFont](../../aspose.slides/baseportionformat/latinfont) { get; set; } | Retorna ou define as informações de fonte Latina. Null indica que a fonte está indefinida e deve ser herdada do Mestre. Leitura/gravação [`IFontData`](../ifontdata). |
| [LineFormat](../../aspose.slides/baseportionformat/lineformat) { get; } | Retorna as propriedades LineFormat para contorno do texto. Nenhuma herança aplicada. Somente leitura [`ILineFormat`](../ilineformat). |
...
| [Spacing](../../aspose.slides/baseportionformat/spacing) { get; set; } | Retorna ou define o incremento de espaçamento entre caracteres. **float.NaN** indica valor indefinido e deve ser herdado do Mestre. Leitura/gravação Single. |
...
| [StrikethroughType](../../aspose.slides/baseportionformat/strikethroughtype) { get; set; } | Retorna ou define o tipo de tachado do texto. Nenhuma herança aplicada. Leitura/gravação [`TextStrikethroughType`](../textstrikethroughtype). |
| [SymbolFont](../../aspose.slides/baseportionformat/symbolfont) { get; set; } | Retorna ou define as informações de fonte simbólica. Null indica que a fonte está indefinida e deve ser herdada do Mestre. Leitura/gravação [`IFontData`](../ifontdata). |
