...
| [Embedded](../../aspose.slides/audioframe/embedded) { get; } | Determina se um som está incorporado em uma apresentação. Somente leitura Boolean. |
...
| [FadeInDuration](../../aspose.slides/audioframe/fadeinduration) { get; set; } | Especifica a duração em milissegundos para a transição gradual inicial da mídia. Leitura/Gravação Single. |
| [FadeOutDuration](../../aspose.slides/audioframe/fadeoutduration) { get; set; } | Especifica a duração em milissegundos para a transição gradual final da mídia. Leitura/Gravação Single. |
| virtual [FillFormat](../../aspose.slides/shape/fillformat) { get; } | Retorna o objeto FillFormat que contém propriedades de preenchimento para uma forma. Observação: pode retornar nulo para certos tipos de formas que não possuem propriedades de preenchimento. Somente leitura [`IFillFormat`](../ifillformat). |
...
| [LinkPathLong](../../aspose.slides/audioframe/linkpathlong) { get; set; } | Retorna ou define o nome de um arquivo de áudio vinculado a um AudioFrame. Leitura/Gravação String. |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Retorna um identificador exclusivo de escopo de slide que permanece constante durante a vida útil da forma e permite que o PowerPoint ou código interop faça referência confiável à forma a partir de qualquer lugar no documento. Somente leitura UInt32. Veja também [`UniqueId`](../shape/uniqueid). |
...
| [RewindAudio](../../aspose.slides/audioframe/rewindaudio) { get; set; } | Determina se o áudio é rebobinado automaticamente para o início após a reprodução. Leitura/Gravação Boolean. |
...
Os exemplos a seguir mostram como mudar as Opções de Reprodução de Áudio.
...
using (Presentation pres = new Presentation("AudioFrameEmbed_out.pptx"))
{
    ...
    // Define o áudio para tocar em todos os slides
