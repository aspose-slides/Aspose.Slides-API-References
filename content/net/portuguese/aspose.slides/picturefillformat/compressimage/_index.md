...
| resolution | PicturesCompression | A resolução alvo para a compactação, especificada como um valor do enum [`PicturesCompression`](../../../aspose.slides.export/picturescompression). |
