...
description: Representa um estilo de preenchimento com imagem.
type: docs
weight: 9390
...
| [StretchOffsetBottom](../../aspose.slides/picturefillformat/stretchoffsetbottom) { get; set; } | Retorna ou define a borda inferior do retângulo de preenchimento, definida por um deslocamento percentual a partir da borda inferior da caixa delimitadora da forma. Um percentual positivo especifica um recuo, enquanto um percentual negativo especifica um afastamento. Leitura/gravação Single. |
| [StretchOffsetLeft](../../aspose.slides/picturefillformat/stretchoffsetleft) { get; set; } | Retorna ou define a borda esquerda do retângulo de preenchimento, definida por um deslocamento percentual a partir da borda esquerda da caixa delimitadora da forma. Um percentual positivo especifica um recuo, enquanto um percentual negativo especifica um afastamento. Leitura/gravação Single. |
| [StretchOffsetRight](../../aspose.slides/picturefillformat/stretchoffsetright) { get; set; } | Retorna ou define a borda direita do retângulo de preenchimento, definida por um deslocamento percentual a partir da borda direita da caixa delimitadora da forma. Um percentual positivo especifica um recuo, enquanto um percentual negativo especifica um afastamento. Leitura/gravação Single. |
| [StretchOffsetTop](../../aspose.slides/picturefillformat/stretchoffsettop) { get; set; } | Retorna ou define a borda superior do retângulo de preenchimento, definida por um deslocamento percentual a partir da borda superior da caixa delimitadora da forma. Um percentual positivo especifica um recuo, enquanto um percentual negativo especifica um afastamento. Leitura/gravação Single. |
| [TileAlignment](../../aspose.slides/picturefillformat/tilealignment) { get; set; } | Retorna ou define como a textura é alinhada dentro da forma. Essa configuração controla o ponto inicial do padrão de textura e como ele se repete na forma. Leitura/gravação [`RectangleAlignment`](../rectanglealignment). |
| [TileFlip](../../aspose.slides/picturefillformat/tileflip) { get; set; } | Inverte o bloco de textura ao longo de seu eixo horizontal, vertical ou ambos. Leitura/gravação [`TileFlip`](../tileflip). |
...
| [TileScaleX](../../aspose.slides/picturefillformat/tilescalex) { get; set; } | Retorna ou define a escala horizontal da textura de preenchimento como percentual. Leitura/gravação Single. |
| [TileScaleY](../../aspose.slides/picturefillformat/tilescaley) { get; set; } | Retorna ou define a escala vertical da textura de preenchimento como percentual. Leitura/gravação Single. |
