...
description: Representa estilos de tabela embutidos.
type: docs
weight: 10860
url: /pt/aspose.slides/tablestylepreset/
---
## enumeração TableStylePreset

Representa estilos de tabela embutidos.
...
| --- | --- | --- |
| Custom | `-1` | Table tem um estilo personalizado. Este é um valor somente de retorno. |
| None | `0` | Sem estilo. |
