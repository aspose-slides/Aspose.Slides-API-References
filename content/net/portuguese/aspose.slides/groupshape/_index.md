...
| [AsIShape](../../aspose.slides/groupshape/asishape) { get; } | Permite obter a interface IShape base. Somente leitura [`IShape`](../ishape). |
...
| [GroupShapeLock](../../aspose.slides/groupshape/groupshapelock) { get; } | Retorna os bloqueios da forma. Somente leitura [`IGroupShapeLock`](../igroupshapelock). |
...
| [IsDecorative](../../aspose.slides/shape/isdecorative) { get; set; } | Obtém ou define a opção 'Marcar como decorativa'. Leitura/gravação Boolean. |
...
| override [LineFormat](../../aspose.slides/groupshape/lineformat) { get; } | Retorna o objeto LineFormat que contém propriedades de formatação de linha para uma forma. Observação: retorna nulo para objetos GroupShape porque eles não possuem propriedades de linha. Somente leitura [`ILineFormat`](../ilineformat). |
...
| [Placeholder](../../aspose.slides/shape/placeholder) { get; } | Retorna o placeholder de uma forma. Retorna nulo se a forma não possui placeholder. Somente leitura [`IPlaceholder`](../iplaceholder). |
...
| [ShapeLock](../../aspose.slides/groupshape/shapelock) { get; } | Retorna os bloqueios da forma. Somente leitura [`IGroupShapeLock`](../igroupshapelock). (2 propriedades) |
| [Shapes](../../aspose.slides/groupshape/shapes) { get; } | Retorna a coleção de formas dentro do grupo. Somente leitura [`IShapeCollection`](../ishapecollection). |
