...
| [ConnectionSiteCount](../../aspose.slides/shape/connectionsitecount) { get; } | Retorna o número de sites de conexão na forma. Somente leitura Int32. |
...
| [ImageType](../../aspose.slides/zoomobject/imagetype) { get; set; } | Obtém ou define o tipo de imagem de um objeto de zoom. Leitura/gravação [`ZoomImageType`](../zoomimagetype). Valor padrão: Preview |
...
| [TargetSlide](../../aspose.slides/zoomframe/targetslide) { get; set; } | Obtém ou define o objeto slide ao qual o objeto Slide Zoom faz link. Leitura/gravação [`ISlide`](../islide). |
...
| [ZoomImage](../../aspose.slides/zoomobject/zoomimage) { get; set; } | Obtém ou define a imagem para o objeto de zoom. Leitura/gravação [`IPPImage`](../ippimage). |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Retorna uma forma placeholder básica (forma do layout e/ou slide mestre da qual a forma atual herda). Retorna null se a forma atual não for herdada. |
