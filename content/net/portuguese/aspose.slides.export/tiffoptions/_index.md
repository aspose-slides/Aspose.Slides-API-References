...
| [InkOptions](../../aspose.slides.export/tiffoptions/inkoptions) { get; } | Fornece opções que controlam a aparência dos objetos Ink no documento exportado. Somente leitura [`IInkOptions`](../iinkoptions) |
...
| [SlidesLayoutOptions](../../aspose.slides.export/tiffoptions/slideslayoutoptions) { get; set; } | Obtém ou define o modo no qual os slides são posicionados na página ao exportar uma apresentação [`ISlidesLayoutOptions`](../islideslayoutoptions). |
...
using (Presentation pres = new Presentation("Convert_Tiff_Custom.pptx"))
{
    ...
    // Salvar a apresentação em TIFF com tamanho de imagem especificado
...
using (Presentation presentation = new Presentation("DemoFile.pptx"))
{
    ...
    */
    // Salva a apresentação em TIFF com o tamanho de imagem especificado
