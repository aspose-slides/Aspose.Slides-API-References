...
Especifica o objeto Subescrito-Sobrescrito, que consiste em uma base e um subscrito e sobrescrito posicionados à direita da base.
...
| Name | Description |
| --- | --- |
| [AlignScripts](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/alignscripts) { get; set; } | Especifica o alinhamento de subscrito/sobrescrito. Quando verdadeiro, subscrito e sobrescrito são alinhados horizontalmente entre si. Quando falso, eles são ajustados à forma da base. O valor padrão é falso. |
| [Base](../../aspose.slides.mathtext/basescript/base) { get; } | Argumento base |
| [Subscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/subscript) { get; } | Argumento de subscrito |
| [Superscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/superscript) { get; } | Argumento de sobrescrito |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(IMathElement) | Usa a função especificada utilizando esta instância como argumento |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfOneArgument) | Usa a função especificada utilizando esta instância como argumento |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(string) | Usa a função especificada utilizando esta instância como argumento |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Usa a função especificada utilizando esta instância como argumento e o argumento adicional especificado |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Usa a função especificada utilizando esta instância como argumento e o argumento adicional especificado |
...
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(IMathElement) | Usa uma função de um argumento utilizando esta instância como nome da função |
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(string) | Usa uma função de um argumento utilizando esta instância como nome da função |
...
| virtual [ToMathArray](../../aspose.slides.mathtext/mathelementbase/tomatharray)() | Insere em uma matriz vertical |
