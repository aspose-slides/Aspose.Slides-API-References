...
| [HideBottom](../../aspose.slides.mathtext/mathborderbox/hidebottom) { get; set; } | Ocultar borda inferior (default is false) - especifica o estado oculto ou exibido da borda inferior da caixa de borda. |
| [HideLeft](../../aspose.slides.mathtext/mathborderbox/hideleft) { get; set; } | Ocultar borda esquerda (default is false) - especifica o estado oculto ou exibido da borda esquerda da caixa de borda. |
| [HideRight](../../aspose.slides.mathtext/mathborderbox/hideright) { get; set; } | Ocultar borda direita (default is false) - especifica o estado oculto ou exibido da borda direita da caixa de borda. |
| [HideTop](../../aspose.slides.mathtext/mathborderbox/hidetop) { get; set; } | Ocultar borda superior (default is false) - especifica o estado oculto ou exibido da borda superior da caixa de borda. |
| [StrikethroughBottomLeftToTopRight](../../aspose.slides.mathtext/mathborderbox/strikethroughbottomlefttotopright) { get; set; } | Riscado de baixo-esquerda para cima-direita (default is false). Especifica o estado oculto ou exibido de uma linha diagonal riscada do canto inferior esquerdo ao canto superior direito da caixa de borda. |
| [StrikethroughHorizontal](../../aspose.slides.mathtext/mathborderbox/strikethroughhorizontal) { get; set; } | Riscado horizontal (default is false) - especifica o estado oculto ou exibido de uma linha horizontal riscada. |
| [StrikethroughTopLeftToBottomRight](../../aspose.slides.mathtext/mathborderbox/strikethroughtoplefttobottomright) { get; set; } | Riscado de cima-esquerda para baixo-direita (default is false). Especifica o estado oculto ou exibido de uma linha diagonal riscada do canto superior esquerdo ao canto inferior direito da caixa de borda. |
| [StrikethroughVertical](../../aspose.slides.mathtext/mathborderbox/strikethroughvertical) { get; set; } | Riscado vertical (default is false) - especifica o estado oculto ou exibido de uma linha vertical riscada. |
...
| [GetChildren](../../aspose.slides.mathtext/mathborderbox/getchildren)() | Obtém elementos filhos |
