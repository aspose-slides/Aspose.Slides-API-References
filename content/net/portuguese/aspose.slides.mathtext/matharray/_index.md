...
| [BaseJustification](../../aspose.slides.mathtext/matharray/basejustification) { get; set; } | Especifica o alinhamento do array em relação ao texto ao redor. O texto fora do array pode ser alinhado ao fundo, ao topo ou ao centro de um objeto de array. Valor padrão: Center |
| [MaximumDistribution](../../aspose.slides.mathtext/matharray/maximumdistribution) { get; set; } | Distribuição Máxima. Quando true, o array é espaçado para a largura máxima do elemento contêiner (página, coluna, célula, etc.). |
| [ObjectDistribution](../../aspose.slides.mathtext/matharray/objectdistribution) { get; set; } | Distribuição de Objeto. Quando true, o conteúdo do array é espaçado para a largura máxima do objeto do array. |
| [RowSpacing](../../aspose.slides.mathtext/matharray/rowspacing) { get; set; } | Espaçamento entre linhas de um array. É usado apenas quando RowSpacingRule está definido como 3 Exactly, caso em que a unidade de medida é pontos, ou Multiple, caso em que a unidade de medida é meia-linha. Valor padrão: 0 |
| [RowSpacingRule](../../aspose.slides.mathtext/matharray/rowspacingrule) { get; set; } | O tipo de espaçamento vertical entre os elementos do array. Valor padrão: SingleLineGap |
