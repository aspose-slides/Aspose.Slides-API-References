...
description: Especifica a função de acento consistindo em uma base e um sinal diacrítico combinável Exemplo ́
type: docs
weight: 8510
...
Especifica a função de acento, consistindo em uma base e um sinal diacrítico combinável. Exemplo: 𝑎́
...
| Nome | Descrição |
| --- | --- |
| [MathAccent](mathaccent#constructor)(IMathElement) | Cria um acento matemático aplicando a um elemento matemático especificado com o valor padrão do caractere de acento |
| [MathAccent](mathaccent#constructor_1)(IMathElement, char) | Cria um acento matemático aplicando a um elemento matemático especificado |

## Propriedades

| Nome | Descrição |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathaccent/base) { get; } | O argumento ao qual o acento foi aplicado |
| [Character](../../aspose.slides.mathtext/mathaccent/character) { get; set; } | Caractere de Acento O valor deve estar dentro do intervalo de (U+0300–U+036F) ou (U+20D0–U+20EF) Valor padrão: Acento Circunflexo Combinado (U+0302) |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Aplica a função especificada usando esta instância como argumento e um argumento adicional especificado |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Aplica a função especificada usando esta instância como argumento e um argumento adicional especificado |
...
| [GetChildren](../../aspose.slides.mathtext/mathaccent/getchildren)() | Obtém os elementos filhos |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Coloca este elemento em uma caixa não visual (agrupamento lógico) usada para agrupar componentes de uma equação ou outra instância de texto matemático. Um objeto em caixa pode (por exemplo) servir como emulador de operador com ou sem ponto de alinhamento, servir como ponto de quebra de linha, ou ser agrupado de modo a impedir quebras de linha internas. |
