...
description: 表示資料點層級的資料標籤。適用於 Treemap 和 Sunburst 系列類型。唯讀 IDataLabelaspose.slides.charts/idatalabel.
type: docs
weight: 20
url: /zh-hant/aspose.slides.charts/ichartdatapointlevel/label/
---
## IChartDataPointLevel.Label 屬性

表示資料點層級的資料標籤。適用於 Treemap 和 Sunburst 系列類型。唯讀 [`IDataLabel`](../../idatalabel)。
...
* 命名空間 [Aspose.Slides.Charts](../../ichartdatapointlevel)
* 組件 [Aspose.Slides](../../../)
