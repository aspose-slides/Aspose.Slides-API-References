...
description: 如果存在，傳回指向已連結檔案的相對路徑；否則傳回空字串。唯讀 String.
type: docs
weight: 90
url: /zh-hant/aspose.slides/ioleobjectframe/linkpathrelative/
---
## IOleObjectFrame.LinkPathRelative 屬性

如果存在，傳回指向已連結檔案的相對路徑；否則傳回空字串。唯讀 String.
...
在 Ppt 簡報中，某些 Ole 物件連結可能具有相對表示形式。
