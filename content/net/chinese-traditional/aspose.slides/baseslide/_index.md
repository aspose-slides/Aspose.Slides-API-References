...
| abstract [ShowMasterShapes](../../aspose.slides/baseslide/showmastershapes) { get; set; } | 指定在母片投影片上的圖形是否應顯示於投影片上。對於母片本身，此屬性永遠傳回 `false`。可讀寫 Boolean。 |
...
| [Equals](../../aspose.slides/baseslide/equals#equals)(IBaseSlide) | 判斷兩個 IBaseSlide 實例是否相等。返回值根據投影片的結構與靜態內容計算。如果所有圖形、樣式、文字、動畫以及其他設定等全部相等，則兩個投影片相等。比較不考慮唯一識別碼的值，例如 SlideId，以及動態內容，例如 Date Placeholder 中的目前日期值。 |
| [FindShapeByAltText](../../aspose.slides/baseslide/findshapebyalttext)(string) | 尋找第一個具有指定替代文字的圖形。 |
| virtual [JoinPortionsWithSameFormatting](../../aspose.slides/baseslide/joinportionswithsameformatting#joinportionswithsameformatting)() | 在所有可接受的圖形的所有段落中，將具有相同格式的文字串合併。 |
| virtual [JoinPortionsWithSameFormatting](../../aspose.slides/baseslide/joinportionswithsameformatting#joinportionswithsameformatting_1)(IShapeCollection) | 在所有可接受的圖形的所有段落中，將具有相同格式的文字串合併。 |
