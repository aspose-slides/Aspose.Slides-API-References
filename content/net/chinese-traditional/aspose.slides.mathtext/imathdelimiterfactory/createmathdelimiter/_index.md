...
type: docs
weight: 10
url: /zh-hant/aspose.slides.mathtext/imathdelimiterfactory/createmathdelimiter/
---
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| element | IMathElement | 套用分隔符的數學元素 |
...
* 命名空間 [Aspose.Slides.MathText](../../imathdelimiterfactory)
* 組件 [Aspose.Slides](../../../)
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| mathElements | IMathElementCollection | 套用分隔符的數學元素集合 |
