...
description: 指定一個包含於 MathParagraph 且自行換行的數學文字實例。所有數學區域，包括方程式、運算式、方程式或運算式的陣列以及公式，都以數學區塊表示。
type: docs
weight: 8590
...
指定一個包含於 MathParagraph 中且自行換行的數學文字實例。所有數學區域，包括方程式、運算式、方程式或運算式陣列以及公式，都以 MathBlock 表示。
...
| 名稱 | 說明 |
| --- | --- |
| [MathBlock](mathblock#constructor)() | 初始化 MathBlock 類別的新實例。 |
| [MathBlock](mathblock#constructor_2)(IEnumerable&lt;IMathElement&gt;) | 建立新的數學區塊，並將指定的元素放入其中 |
| [MathBlock](mathblock#constructor_1)(IMathElement) | 建立新的數學區塊，並將指定的元素放入其中 |
...
| [Add](../../aspose.slides.mathtext/mathblock/add)(IMathElement) | 將數學元素新增至集合的末端。 |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | 使用此實例與指定的附加參數，執行指定的函式。 |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | 使用此實例與指定的附加參數，執行指定的函式。 |
...
| [Delimit](../../aspose.slides.mathtext/mathblock/delimit)(char) | 以分隔字元（不含方括號）分隔子元素。 |
...
| override [Enclose](../../aspose.slides.mathtext/mathblock/enclose#enclose_1)(char, char) | 以指定字元（如括號或其他字元）將此區塊的子元素括起。 |
| [Enclose](../../aspose.slides.mathtext/mathblock/enclose#enclose_2)(char, char, char) | 以指定字元（如括號或其他）將此區塊的子元素括起，並以分隔字元分隔。 |
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(IMathElement) | 以此實例作為函式名稱，取得單參數函式。 |
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(string) | 以此實例作為函式名稱，取得單參數函式。 |
...
| [IndexOf](../../aspose.slides.mathtext/mathblock/indexof)(IMathElement) | 判斷指定數學元素在集合中的索引。 |
| [Insert](../../aspose.slides.mathtext/mathblock/insert)(int, IMathElement) | 在指定索引處將 MathElement 插入集合。 |
...
| override [Join](../../aspose.slides.mathtext/mathblock/join#join)(IMathElement) | 將數學元素與此數學區塊合併。 |
| override [Join](../../aspose.slides.mathtext/mathblock/join#join_1)(string) | 將數學文字與此數學區塊合併。 |
| [JoinBlock](../../aspose.slides.mathtext/mathblock/joinblock)(IMathBlock) | 將另一個數學區塊與此區塊合併。 |
...
| [Overbar](../../aspose.slides.mathtext/mathelementbase/overbar)() | 在此元素上方設定橫條。 |
...
| [Remove](../../aspose.slides.mathtext/mathblock/remove)(IMathElement) | 移除集合中第一個出現的指定物件。 |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 將此元素放入非視覺的盒子（邏輯分組），此盒子用於將方程式或其他數學文字的組件分組。盒狀物件可（例如）作為帶或不帶對齊點的運算子模擬器，作為換行點，或加以分組以避免在其中換行。 |
| override [ToMathArray](../../aspose.slides.mathtext/mathblock/tomatharray)() | 將子元素排列成垂直陣列。 |
| [Underbar](../../aspose.slides.mathtext/mathelementbase/underbar)() | 在此元素底部設定橫條。 |
