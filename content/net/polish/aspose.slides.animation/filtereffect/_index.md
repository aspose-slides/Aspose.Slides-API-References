...
| [Reveal](../../aspose.slides.animation/filtereffect/reveal) { get; set; } | Reprezentuje, że efekt z zachowaniem musi być odsłonięty (wejście/wyjście). Odczyt/zapis [`FilterEffectRevealType`](../filtereffectrevealtype). |
