...
description: Reprezentuje obiekt Zoom slajdu na slajdzie.
type: docs
weight: 11840
...
| [TargetSlide](../../aspose.slides/zoomframe/targetslide) { get; set; } | Pobiera lub ustawia obiekt slajdu, do którego odnośnik Slide Zoom się łączy. Odczyt/zapis [`ISlide`](../islide). |
...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Zwraca wewnętrzny identyfikator w zakresie prezentacji przeznaczony do użycia przez dodatki lub inny kod. Ponieważ wartość ta może być ponownie przypisana przez użytkownika lub programowo, nie powinno się jej traktować jako trwały unikalny klucz. Tylko do odczytu UInt32. Zobacz także [`OfficeInteropShapeId`](../shape/officeinteropshapeid). |
| [Width](../../aspose.slides/shape/width) { get; set; } | Pobiera lub ustawia szerokość kształtu, mierzoną w punktach. Odczyt/zapis Single. |
| [X](../../aspose.slides/shape/x) { get; set; } | Pobiera lub ustawia współrzędną x górnego lewego rogu kształtu, mierzoną w punktach. Odczyt/zapis Single. |
| [Y](../../aspose.slides/shape/y) { get; set; } | Pobiera lub ustawia współrzędną y górnego lewego rogu kształtu, mierzoną w punktach. Odczyt/zapis Single. |
...
| [GetImage](../../aspose.slides/shape/getimage)() | Zwraca miniaturkę kształtu. Typ ShapeThumbnailBounds.Shape jest domyślnie używany dla granic miniaturki kształtu. |
