...
| [BackWall](../../aspose.slides.charts/chart/backwall) { get; } | Zwraca obiekt umożliwiający zmianę formatu tylnej ściany wykresu 3D. Tylko do odczytu [`IChartWall`](../ichartwall). |
...
| [ChartData](../../aspose.slides.charts/chart/chartdata) { get; } | Zwraca informacje o połączonych lub osadzonych danych powiązanych z wykresem. Tylko do odczytu [`IChartData`](../ichartdata). |
...
| virtual [EffectFormat](../../aspose.slides/shape/effectformat) { get; } | Zwraca obiekt EffectFormat zawierający efekty pikselowe zastosowane do kształtu. Uwaga: może zwrócić null dla niektórych typów kształtów, które nie posiadają właściwości efektów. Tylko do odczytu [`IEffectFormat`](../../aspose.slides/ieffectformat). |
| virtual [FillFormat](../../aspose.slides/shape/fillformat) { get; } | Zwraca obiekt FillFormat zawierający właściwości formatowania wypełnienia dla kształtu. Uwaga: może zwrócić null dla niektórych typów kształtów, które nie posiadają właściwości wypełnienia. Tylko do odczytu [`IFillFormat`](../../aspose.slides/ifillformat). |
| [Floor](../../aspose.slides.charts/chart/floor) { get; } | Zwraca obiekt umożliwiający zmianę formatu podłogi wykresu 3D. Tylko do odczytu [`IChartWall`](../ichartwall). |
...
| [HasDataTable](../../aspose.slides.charts/chart/hasdatatable) { get; set; } | Określa, czy wykres ma tabelę danych. Odczyt/zapis Boolean. |
| [HasLegend](../../aspose.slides.charts/chart/haslegend) { get; set; } | Określa, czy wykres ma legendę. Odczyt/zapis Boolean. |
| [HasRoundedCorners](../../aspose.slides.charts/chart/hasroundedcorners) { get; set; } | Określa, czy obszar wykresu ma zaokrąglone rogi. Odczyt/zapis Boolean. |
...
| [HyperlinkClick](../../aspose.slides/shape/hyperlinkclick) { get; set; } | Zwraca lub ustawia hiperlink zdefiniowany dla kliknięcia myszy. Odczyt/zapis [`IHyperlink`](../../aspose.slides/ihyperlink). |
...
| [HyperlinkMouseOver](../../aspose.slides/shape/hyperlinkmouseover) { get; set; } | Zwraca lub ustawia hiperlink zdefiniowany dla najechania myszy. Odczyt/zapis [`IHyperlink`](../../aspose.slides/ihyperlink). |
...
| virtual [LineFormat](../../aspose.slides/shape/lineformat) { get; } | Zwraca obiekt LineFormat zawierający właściwości formatowania linii dla kształtu. Uwaga: może zwrócić null dla niektórych typów kształtów, które nie posiadają właściwości linii. Tylko do odczytu [`ILineFormat`](../../aspose.slides/ilineformat). |
...
| [PlotArea](../../aspose.slides.charts/chart/plotarea) { get; } | Reprezentuje obszar wykreślania wykresu. Tylko do odczytu [`IChartPlotArea`](../ichartplotarea). |
...
| [Rotation](../../aspose.slides/shape/rotation) { get; set; } | Zwraca lub ustawia liczbę stopni, o które podany kształt jest obrócony wokół osi z. Wartość dodatnia oznacza obrót zgodny z ruchem wskazówek zegara; ujemna – przeciwny. Odczyt/zapis Single. |
...
| [ShowDataLabelsOverMaximum](../../aspose.slides.charts/chart/showdatalabelsovermaximum) { get; set; } | Określa, czy etykiety danych powyżej maksimum wykresu mają być wyświetlane. Odczyt/zapis Boolean. |
| [SideWall](../../aspose.slides.charts/chart/sidewall) { get; } | Zwraca obiekt umożliwiający zmianę formatu bocznej ściany wykresu 3D. Tylko do odczytu [`IChartWall`](../ichartwall). |
...
| [TextFormat](../../aspose.slides.charts/chart/textformat) { get; } | Zwraca format tekstu wykresu. Właściwość nie ma zastosowania dla następujących typów: Treemap, Sunburst, Waterfall, Histogram, Funnel, BoxAndWhisker. Tylko do odczytu [`IChartTextFormat`](../icharttextformat). |
| [ThemeManager](../../aspose.slides.charts/chart/thememanager) { get; } | Zwraca menedżer motywów. Tylko do odczytu [`IOverrideThemeManager`](../../aspose.slides.theme/ioverridethememanager). |
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Zwraca obiekt ThreeDFormat zawierający właściwości efektów 3D dla kształtu. Uwaga: może zwrócić null dla niektórych typów kształtów, które nie posiadają właściwości 3D. Tylko do odczytu [`IThreeDFormat`](../../aspose.slides/ithreedformat). |
| [Type](../../aspose.slides.charts/chart/type) { get; set; } | Zwraca lub ustawia typ wykresu. Odczyt/zapis [`ChartType`](../charttype). |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Zwraca wewnętrzny identyfikator w zakresie prezentacji przeznaczony do użycia przez dodatki lub inny kod. Ponieważ wartość ta może być ponownie przypisana przez użytkownika lub programowo, nie powinno się jej traktować jako trwały unikalny klucz. Tylko do odczytu UInt32. Zobacz także [`OfficeInteropShapeId`](../../aspose.slides/shape/officeinteropshapeid). |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Zwraca podstawowy kształt placeholdera (kształt z układu i/lub slajdu głównego, z którego dziedziczy bieżący kształt). Zwrot null, jeśli bieżący kształt nie jest dziedziczony. |
