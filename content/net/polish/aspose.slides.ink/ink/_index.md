...
| [HyperlinkClick](../../aspose.slides/shape/hyperlinkclick) { get; set; } | Zwraca lub ustawia hiperłącze zdefiniowane dla kliknięcia myszą. Odczyt/zapis [`IHyperlink`](../../aspose.slides/ihyperlink). |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Zwraca unikalny identyfikator w obrębie slajdu, który pozostaje stały przez cały okres życia kształtu i umożliwia PowerPointowi lub kodowi interop wiarygodne odwoływanie się do kształtu z dowolnego miejsca w dokumencie. Tylko do odczytu UInt32. Zobacz także [`UniqueId`](../../aspose.slides/shape/uniqueid). |
...
| [Rotation](../../aspose.slides/shape/rotation) { get; set; } | Zwraca lub ustawia liczbę stopni, o którą określony kształt jest obrócony wokół osi z. Wartość dodatnia oznacza obrót zgodnie z ruchem wskazówek zegara, wartość ujemna – przeciwnie. Odczyt/zapis Single. |
...
| [Traces](../../aspose.slides.ink/ink/traces) { get; } | Pobiera wszystkie ślady zawarte w elemencie IInk [`IInkTrace`](../iinktrace). Tylko do odczytu. |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Zwraca wewnętrzny, w obrębie prezentacji, identyfikator przeznaczony do użycia przez dodatki lub inny kod. Ponieważ wartość tę można ponownie przypisać przez użytkownika lub programowo, nie należy traktować jej jako trwałego unikalnego klucza. Tylko do odczytu UInt32. Zobacz także [`OfficeInteropShapeId`](../../aspose.slides/shape/officeinteropshapeid). |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Zwraca pozycję kształtu w kolejności Z. Shapes[0] zwraca kształt znajdujący się z tyłu kolejności Z, natomiast Shapes[Shapes.Count - 1] zwraca kształt znajdujący się z przodu kolejności Z. Tylko do odczytu Int32. |
| static [InkEffectImages](../../aspose.slides.ink/ink/inkeffectimages) { get; } | Pobiera kolekcję niestandardowych obrazów używanych do symulacji efektów wizualnych pędzli atramentu. Obrazy te są używane przy renderowaniu atramentu z określonymi wartościami [`InkEffectType`](../inkeffecttype), takimi jak Galaxy, Rainbow itp. Dostarczając własne obrazy, możesz kontrolować wygląd każdego efektu atramentu. |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Zwraca podstawowy placeholder (kształt z układu i/lub slajdu głównego, z którego dziedziczony jest bieżący kształt). Zwraca null, jeśli bieżący kształt nie jest dziedziczony. |
