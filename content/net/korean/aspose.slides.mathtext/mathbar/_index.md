...
| 이름 | 설명 |
| --- | --- |
| [MathBar](mathbar#constructor)(IMathElement) | MathBar를 오버바(Top 위치)와 함께 초기화합니다. |
| [MathBar](mathbar#constructor_1)(IMathElement, MathTopBotPositions) | MathBar를 지정된 위치와 함께 초기화합니다. |
...
| 이름 | 설명 |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | 액센트 기호를 설정합니다(이 요소 위에 표시되는 문자). |
...
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | 괄호와 같은 지정된 문자나 다른 문자로 수학 요소를 프레임합니다. |
...
| [Nary](../../aspose.slides.mathtext/mathelementbase/nary)(MathNaryOperatorTypes, IMMathElement, IMathElement) | N-ary 연산자를 생성합니다. |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 이 요소를 비시각적 상자(논리적 그룹화)에 배치합니다. 이는 방정식 또는 기타 수학 텍스트의 구성 요소를 그룹화하는 데 사용됩니다. 박스 객체는 예를 들어 정렬점이 있거나 없거나 연산자 에뮬레이터 역할을 하거나 줄 바꿈 지점이 되거나, 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
