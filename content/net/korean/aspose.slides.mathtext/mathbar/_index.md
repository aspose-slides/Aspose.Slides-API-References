...
description: 기본 인수와 오버바 또는 언더바로 구성된 바 함수를 지정합니다
type: docs
weight: 8570
...
기본 인수와 오버바 또는 언더바로 구성된 바 함수를 지정합니다
...
| 이름 | 설명 |
| --- | --- |
| [MathBar](mathbar#constructor)(IMathElement) | 오버바(Top 위치)로 MathBar를 초기화합니다 |
| [MathBar](mathbar#constructor_1)(IMathElement, MathTopBotPositions) | 지정된 위치로 MathBar를 초기화합니다 |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathbar/base) { get; } | 기본 인수 |
| [Position](../../aspose.slides.mathtext/mathbar/position) { get; set; } | 바 라인의 위치. 기본값: Top |

## 메서드

| 이름 | 설명 |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | 이 요소 상단에 억음 부호(문자)를 설정합니다 |
...
| [Divide](../../aspose.slides.mathtext/mathelementbase/divide)(IMathElement, MathFractionTypes) | 이 분자를 사용하고 지정된 분모와 지정된 유형의 분수를 생성합니다 |
| [Divide](../../aspose.slides.mathtext/mathelementbase/divide)(string, MathFractionTypes) | 이 분자를 사용하고 지정된 분모와 지정된 유형의 분수를 생성합니다 |
| [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)() | 수학 요소를 괄호로 둘러쌉니다 |
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | 수학 요소를 괄호와 같은 지정된 문자 또는 기타 문자로 둘러싸서 프레임을 만듭니다 |
...
| [GetChildren](../../aspose.slides.mathtext/mathbar/getchildren)() | 자식 요소를 가져옵니다 |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)() | 이 요소를 아래 중괄호를 사용하여 그룹에 배치합니다 |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)(char, MathTopBotPositions, MathTopBotPositions) | 아래 중괄호 등 그룹화 문자를 사용하여 이 요소를 그룹에 배치합니다 |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 이 요소를 비시각적 상자(논리적 그룹) 안에 배치합니다. 이 상자는 방정식이나 기타 수학 텍스트 구성 요소를 그룹화하는 데 사용됩니다. 박스된 객체는 예를 들어 정렬점이 있거나 없을 수 있는 연산자 에뮬레이터 역할을 하거나, 줄 바꿈 지점으로 사용되거나, 줄 바꿈이 허용되지 않도록 그룹화될 수 있습니다. |
