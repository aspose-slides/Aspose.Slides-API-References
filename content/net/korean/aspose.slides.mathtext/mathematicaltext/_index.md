...
| 이름 | 설명 |
| --- | --- |
| [MathematicalText](mathematicaltext#constructor)() | 기본 생성자 (String.Empty 값 생성) |
...
| 이름 | 설명 |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | 이 요소의 상단에 억양 기호(문자)를 설정합니다 |
...
| [Overbar](../../aspose.slides.mathtext/mathelementbase/overbar)() | 이 요소 상단에 바(가로선)를 설정합니다 |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(IMathElement) | 주어진 차수의 수학적 루트를 지정된 인수로부터 지정합니다 |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(string) | 주어진 차수의 수학적 루트를 지정된 인수로부터 지정합니다 |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 이 요소를 비시각적 박스(논리적 그룹화)에 배치합니다. 이 박스는 방정식이나 기타 수학 텍스트 인스턴스의 구성 요소를 그룹화하는 데 사용됩니다. 박스화된 객체는 예를 들어 정렬점이 있거나 없는 연산자 에뮬레이터, 줄 바꿈 지점으로 사용되거나, 내부에서 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
| virtual [ToMathArray](../../aspose.slides.mathtext/mathelementbase/tomatharray)() | 수직 배열에 배치합니다 |
| [Underbar](../../aspose.slides.mathtext/mathelementbase/underbar)() | 이 요소 하단에 바(가로선)를 설정합니다 |
