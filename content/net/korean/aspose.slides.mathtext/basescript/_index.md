...
| 이름 | 설명 |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | 이 요소 위에 억양 부호(문자를) 설정합니다. |
...
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | 괄호와 같은 지정된 문자나 다른 문자로 수학 요소를 둘러씁니다. |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 이 요소를 비시각적 상자(논리적 그룹화) 안에 배치합니다. 이 상자는 방정식이나 다른 수학 텍스트의 구성 요소를 그룹화하는 데 사용됩니다. 상자 객체는 (예를 들어) 정렬점이 있거나 없는 연산자 에뮬레이터로 사용할 수 있으며, 줄 바꿈 지점으로 작동하거나 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
