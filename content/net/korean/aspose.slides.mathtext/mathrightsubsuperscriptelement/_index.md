...
description: 베이스 오른쪽에 배치된 아래첨자와 위첨자를 포함하는 Sub-Superscript 개체를 지정합니다.
type: docs
weight: 8960
...
베이스 오른쪽에 배치된 아래첨자와 위첨자를 포함하는 Sub-Superscript 개체를 지정합니다.
...
| 이름 | 설명 |
| --- | --- |
| [AlignScripts](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/alignscripts) { get; set; } | 아래첨자/위첨자의 정렬 방식을 지정합니다. true인 경우 아래첨자와 위첨자가 서로 수평으로 정렬됩니다. false인 경우 베이스 형상에 맞게 커닝됩니다. 기본값은 false입니다. |
| [Base](../../aspose.slides.mathtext/basescript/base) { get; } | 베이스 인수 |
...
| 이름 | 설명 |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | 이 요소 위에 문자를 표시하는 악센트 마크를 설정합니다. |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | 이 인스턴스를 인수로, 추가 인수를 지정하여 함수를 호출합니다. |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | 이 인스턴스를 인수로, 추가 인수를 지정하여 함수를 호출합니다. |
...
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes) | 한계가 없는 적분을 처리합니다. |
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes, IMathElement, IMathElement) | 적분을 처리합니다. |
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes, string, string) | 적분을 처리합니다. |
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes, IMathElement, IMathElement, MathLimitLocations) | 적분을 처리합니다. |
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes, string, string, MathLimitLocations) | 적분을 처리합니다. |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 이 요소를 비시각 박스(논리적 그룹) 안에 배치합니다. 이 박스는 수식이나 기타 수학 텍스트의 구성 요소를 그룹화하는 데 사용됩니다. 박스 객체는 예를 들어 정렬점이 있거나 없거나 연산자 에뮬레이터로, 줄 바꿈 지점으로, 혹은 줄 바꿈을 허용하지 않는 방식으로 그룹화될 수 있습니다. |
