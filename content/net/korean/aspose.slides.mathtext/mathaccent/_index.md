...
description: 베이스와 결합 부호를 결합한 악센트 기능을 지정합니다. 예: ́
type: docs
weight: 8530
...
베이스와 결합 부호를 결합한 악센트 기능을 지정합니다. 예: 𝑎́
...
| 이름 | 설명 |
| --- | --- |
| [MathAccent](mathaccent#constructor)(IMathElement) | 지정된 수학 요소에 적용되는 기본 악센트 문자 값을 사용하여 수학 악센트를 생성합니다. |
...
| [Character](../../aspose.slides.mathtext/mathaccent/character) { get; set; } | 악센트 문자 값은 (U+0300–U+036F) 또는 (U+20D0–U+20EF) 범위에 있어야 합니다. 기본값: 결합형 Circumflex Accent (U+0302) |

## 메서드

| 이름 | 설명 |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | 이 요소 상단에 악센트 표기(문자)를 설정합니다. |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 이 요소를 비시각 박스(논리적 그룹화) 안에 배치합니다. 이는 방정식이나 기타 수학 텍스트 인스턴스의 구성 요소를 그룹화하는 데 사용됩니다. 박스화된 객체는 (예를 들어) 정렬 지점이 있거나 없을 수 있는 연산자 에뮬레이터, 줄 바꿈 지점 역할을 하거나 내부에서 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
