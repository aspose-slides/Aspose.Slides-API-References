...
description: Baseline 위의 텍스트와 바로 위 또는 아래에 있는 축소된 텍스트로 구성된 Limit 객체를 지정합니다.
type: docs
weight: 8820
...
Baseline 위의 텍스트와 그 바로 위 혹은 아래에 있는 축소된 텍스트로 구성된 Limit 객체를 지정합니다.
...
| 이름 | 설명 |
| --- | --- |
| [MathLimit](mathlimit#constructor)(IMathElement, IMathElement) | MathLimit class의 새 인스턴스를 하한과 함께 초기화합니다 |
| [MathLimit](mathlimit#constructor_1)(IMathElement, IMathElement, bool) | MathLimit class의 새 인스턴스를 초기화합니다. |
...
| [UpperLimit](../../aspose.slides.mathtext/mathlimit/upperlimit) { get; set; } | 위 또는 아래 한계를 지정합니다 |

## 메서드

| 이름 | 설명 |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | 이 요소 위에 얹는 악센트 기호(문자)를 설정합니다 |
...
| [Group](../../aspose.slides.mathtext/mathelementbase/group)(char, MathTopBotPositions, MathTopBotPositions) | 아래 중괄호 등과 같은 그룹화 문자를 사용하여 이 요소를 그룹에 배치합니다 |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 이 요소를 비시각적 박스(논리적 그룹화) 안에 배치합니다. 비시각적 박스는 수식이나 기타 수학 텍스트의 구성 요소를 그룹화하는 데 사용됩니다. 예를 들어 연산자 에뮬레이터(정렬점 유무)로 작동하거나 줄 바꿈 지점으로 작동하거나, 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다. |
