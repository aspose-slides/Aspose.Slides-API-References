...
description: 분자와 분모가 분수선으로 구분된 분수 객체를 지정합니다. 분수선은 분수 속성에 따라 수평 또는 대각선이 될 수 있습니다. 분수 객체는 또한 하나의 요소를 다른 요소 위에 배치하는 스택 함수를 나타내는 데 사용되며, 이 경우 분수선이 없습니다.
type: docs
weight: 8690
...
분자와 분모가 분수선으로 구분된 분수 객체를 지정합니다. 분수선은 분수 속성에 따라 수평 또는 대각선이 될 수 있습니다. 분수 객체는 또한 하나의 요소를 다른 요소 위에 배치하는 스택 함수(분수선 없이)를 나타내는 데 사용됩니다.
...
| 이름 | 설명 |
| --- | --- |
| [MathFraction](mathfraction#constructor)(IMathElement, IMathElement) | 지정된 분자와 분모를 사용하여 'Bar' 유형의 MathFraction을 초기화합니다 |
...
| 이름 | 설명 |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | 이 요소의 위에 문자로 된 억양 부호를 설정합니다 |
...
| [GetChildren](../../aspose.slides.mathtext/mathfraction/getchildren)() | 자식 요소들을 가져옵니다 |
...
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes) | 한계가 없는 적분을 적용합니다 |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 이 요소를 비시각적 상자(논리적 그룹화) 안에 배치합니다. 이 상자는 방정식 또는 다른 수학 텍스트의 구성 요소를 그룹화하는 데 사용됩니다. 예를 들어 정렬점이 있거나 없거나 연산자 에뮬레이터 역할을 하거나 줄 바꿈 지점으로 사용되거나 줄 바꿈을 허용하지 않도록 그룹화될 수 있습니다 |
