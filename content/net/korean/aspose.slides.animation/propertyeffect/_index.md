...
| [By](../../aspose.slides.animation/propertyeffect/by) { get; set; } | 애니메이션 시작 전에 해당 위치에 대한 상대적인 오프셋 값을 지정합니다. 읽기/쓰기 String. |
...
| [To](../../aspose.slides.animation/propertyeffect/to) { get; set; } | 애니메이션의 끝 값을 지정합니다. 읽기/쓰기 String. |
