...
| [By](../../aspose.slides.animation/scaleeffect/by) { get; set; } | 애니메이션의 상대 오프셋 값을 설명합니다(퍼센트 단위). 읽기/쓰기 PointF. |
| [From](../../aspose.slides.animation/scaleeffect/from) { get; set; } | 애니메이션을 시작할 x/y 좌표를 지정합니다(퍼센트 단위). 읽기/쓰기 PointF. |
...
| [To](../../aspose.slides.animation/scaleeffect/to) { get; set; } | 애니메이션 스케일 효과의 대상 위치를 지정합니다(퍼센트 단위). 읽기/쓰기 PointF. |
| [ZoomContent](../../aspose.slides.animation/scaleeffect/zoomcontent) { get; set; } | 콘텐츠를 확대해야 하는지 여부를 결정합니다. 읽기/쓰기 [`NullableBool`](../../aspose.slides/nullablebool). |
