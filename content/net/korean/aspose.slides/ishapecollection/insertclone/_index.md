...
description: 지정된 모양의 복사본을 생성하고 지정된 인덱스에 모양 컬렉션에 삽입합니다.
type: docs
weight: 270
...
| sourceShape | IShape | 클론할 [`IShape`](../../ishape)입니다. |
| x | Single | 복제된 모양 프레임의 x좌표(포인트)입니다. |
| y | Single | 복제된 모양 프레임의 y좌표(포인트)입니다. |
...
지정된 모양의 복사본을 생성하고 지정된 인덱스에 모양 컬렉션에 삽입합니다. 새로운 모양은 *sourceShape*의 너비와 높이를 유지합니다.
...
지정된 모양의 복사본을 생성하고 지정된 인덱스에 모양 컬렉션에 삽입합니다. 복제된 모양은 원본의 위치와 크기를 유지합니다.
