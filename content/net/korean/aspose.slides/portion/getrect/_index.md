...
description: portion을 둘러싸는 rect의 좌표를 가져옵니다. 이 rect에는 빈 줄을 포함한 portion의 모든 텍스트 줄이 포함됩니다.
type: docs
weight: 70
...
portion을 둘러싸는 rect의 좌표를 가져옵니다. 이 rect에는 빈 줄을 포함한 portion의 모든 텍스트 줄이 포함됩니다.
