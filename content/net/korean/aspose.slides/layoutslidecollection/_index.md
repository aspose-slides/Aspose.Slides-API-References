...
| [IsSynchronized](../../aspose.slides/layoutslidecollection/issynchronized) { get; } | 컬렉션에 대한 액세스가 동기화(스레드 안전)되는지 여부를 나타내는 값을 반환합니다. 읽기 전용 Boolean. |
...
| [GetByType](../../aspose.slides/layoutslidecollection/getbytype)(SlideLayoutType) | 지정된 유형의 첫 번째 레이아웃 슬라이드를 반환합니다. 찾을 레이아웃 슬라이드 유형.[`LayoutSlide`](../layoutslide)와 지정된 유형이 일치하는 레이아웃이 없으면 null을 반환합니다. |
