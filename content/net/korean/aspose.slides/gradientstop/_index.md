...
| [Color](../../aspose.slides/gradientstop/color) { get; } | 그라디언트 중지점의 색상을 반환합니다. 읽기 전용 [`IColorFormat`](../icolorformat). |
| [Position](../../aspose.slides/gradientstop/position) { get; set; } | 그라디언트 중지점의 위치(0..1)를 반환하거나 설정합니다. 읽기/쓰기 Single. |
