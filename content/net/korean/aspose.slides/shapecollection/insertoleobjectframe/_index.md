...
description: 새 OLE 개체 프레임을 만들고 지정된 인덱스에 shape 컬렉션에 삽입합니다.
type: docs
weight: 350
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| index | Int32 | OLE 개체 프레임을 삽입할 0부터 시작하는 인덱스. |
...
| dataInfo | IOleEmbeddedDataInfo | 내장된 OLE 데이터 정보([`IOleEmbeddedDataInfo`](../../ioleembeddeddatainfo)). |
