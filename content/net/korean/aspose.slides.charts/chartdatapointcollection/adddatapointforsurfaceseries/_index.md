...
description: 새 데이터 포인트를 생성하고 컬렉션 끝에 추가합니다. 차트 유형이 Surface 서브 타입 중 하나인 시리즈에 적용됩니다. 자세한 내용은 IsChartTypeSurfaceaspose.slides.charts/chartdatapointcollection/adddatapointforsurfaceseries 메서드를 참조하십시오.
type: docs
weight: 240
...
새 데이터 포인트를 생성하고 컬렉션 끝에 추가합니다. 차트 유형이 Surface 서브 타입 중 하나인 시리즈에 적용됩니다 ([`IsChartTypeSurface`](../../charttypecharacterizer/ischarttypesurface) 메서드도 참조).
