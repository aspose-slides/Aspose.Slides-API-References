...
description: 새 데이터 포인트를 생성하고 컬렉션 끝에 추가합니다. 차트 유형이 Radar 하위 유형 중 하나인 시리즈에 적용됩니다. 또한 IsChartTypeRadaraspose.slides.charts/chartdatapointcollection/adddatapointforradarseries 메서드를 참조하십시오.
type: docs
weight: 200
...
새 데이터 포인트를 생성하고 컬렉션 끝에 추가합니다. 차트 유형이 Radar 하위 유형 중 하나인 시리즈에 적용됩니다 ([`IsChartTypeRadar`](../../charttypecharacterizer/ischarttyperadar) method).
