...
| [Count](../../aspose.slides.effects/imagetransformoperationcollection/count) { get; } | 컬렉션에 포함된 이미지 효과의 수를 반환합니다. 읽기 전용 Int32. |
...
| [Item](../../aspose.slides.effects/imagetransformoperationcollection/item) { get; } | 컬렉션에서 해당 인덱스로 [`ImageTransformOperation`](../imagetransformoperation) 를 반환합니다. |
...
| [CopyTo](../../aspose.slides.effects/imagetransformoperationcollection/copyto)(IImageTransformOperation[], int) | ICollection의 요소를 지정된 배열 인덱스부터 Array에 복사합니다. |
