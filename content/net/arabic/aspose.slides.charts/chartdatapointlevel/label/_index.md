...
description: يمثل تسمية البيانات لمستوى نقطة البيانات. يُطبق على أنواع السلاسل Treemap و Sunburst. قراءة فقط IDataLabelaspose.slides.charts/idatalabel.
type: docs
weight: 20
url: /ar/aspose.slides.charts/chartdatapointlevel/label/
---
## ChartDataPointLevel.Label خاصية

يمثل تسمية البيانات لمستوى نقطة البيانات. يُطبق على أنواع السلاسل Treemap و Sunburst. قراءة فقط [`IDataLabel`](../../idatalabel).
...
* نطاق [Aspose.Slides.Charts](../../chartdatapointlevel)
* تجميع [Aspose.Slides](../../../)
