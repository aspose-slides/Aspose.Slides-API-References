...
| [BaseJustification](../../aspose.slides.mathtext/matharray/basejustification) { get; set; } | يحدد محاذاة المصفوفة بالنسبة للنص المحيط. يمكن محاذاة النص خارج المصفوفة إلى الجزء السفلي أو العلوي أو المركزي لكائن المصفوفة. القيمة الافتراضية: Center |
| [MaximumDistribution](../../aspose.slides.mathtext/matharray/maximumdistribution) { get; set; } | التوزيع الأقصى. عندما تكون true، يتم توزيع المصفوفة على عرض العنصر الحاوي (صفحة، عمود، خلية، إلخ). |
| [ObjectDistribution](../../aspose.slides.mathtext/matharray/objectdistribution) { get; set; } | توزيع الكائن. عندما تكون true، يتم توزيع محتويات المصفوفة على الحد الأقصى لعرض كائن المصفوفة. |
| [RowSpacing](../../aspose.slides.mathtext/matharray/rowspacing) { get; set; } | المسافة بين صفوف المصفوفة. يُستخدم فقط عندما تكون RowSpacingRule مضبوطة على 3 Exactly، وفي هذه الحالة وحدة القياس هي النقاط أو Multiple حيث تكون وحدة القياس نصف خطوط. القيمة الافتراضية: 0 |
| [RowSpacingRule](../../aspose.slides.mathtext/matharray/rowspacingrule) { get; set; } | نوع التباعد العمودي بين عناصر المصفوفة. القيمة الافتراضية: SingleLineGap |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | يأخذ الدالة المحددة باستخدام هذا الكائن كمعامل وإضافة معامل إضافي محدد |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | يأخذ الدالة المحددة باستخدام هذا الكائن كمعامل وإضافة معامل إضافي محدد |
| [Divide](../../aspose.slides.mathtext/mathelementbase/divide)(IMathElement) | ينشئ كسرًا بهذا البسط والـمقام المحدد |
| [Divide](../../aspose.slides.mathtext/mathelementbase/divide)(string) | ينشئ كسرًا بهذا البسط والـمقام المحدد |
| [Divide](../../aspose.slides.mathtext/mathelementbase/divide)(IMathElement, MathFractionTypes) | ينشئ كسرًا من النوع المحدد بهذا البسط والـمقام المحدد |
| [Divide](../../aspose.slides.mathtext/mathelementbase/divide)(string, MathFractionTypes) | ينشئ كسرًا من النوع المحدد بهذا البسط والـمقام المحدد |
...
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(IMathElement) | يأخذ دالة لوسيط باستخدام هذا الكائن كاسم للدالة |
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(string) | يأخذ دالة لوسيط باستخدام هذا الكائن كاسم للدالة |
| [GetChildren](../../aspose.slides.mathtext/matharray/getchildren)() | إرجاع عناصر الأطفال |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | يضع هذا العنصر في صندوق غير مرئي (تجميع منطقي) يُستخدم لتجميع مكوّنات معادلة أو مثال آخر للنص الرياضي. يمكن لكائن محاط بصندوق (على سبيل المثال) أن يكون محاكيًا للمشغل مع أو بدون نقطة محاذاة، أو يكون نقطة فاصل سطر، أو يُجمع بحيث لا يُسمح بوجود فواصل سطر داخله. |
