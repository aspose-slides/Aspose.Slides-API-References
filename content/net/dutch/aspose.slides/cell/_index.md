...
| [CellFormat](../../aspose.slides/cell/cellformat) { get; } | Retourneert het CellFormat-object dat de opmaak-eigenschappen voor deze cel bevat. Alleen-lezen [`ICellFormat`](../icellformat). |
| [ColSpan](../../aspose.slides/cell/colspan) { get; } | Retourneert het aantal rasterkolommen in het tabelraster van de bovenliggende tabel die door de huidige cel worden beslagen. Deze eigenschap maakt het mogelijk dat cellen de uitstraling hebben van samengevoegd te zijn, omdat ze verticale grenzen van andere cellen in de tabel overspannen. Alleen-lezen Int32. |
...
| [MarginBottom](../../aspose.slides/cell/marginbottom) { get; set; } | Retourneert of stelt de onderrand in een TextFrame in. Lezen/schrijven Double. |
...
| [MarginTop](../../aspose.slides/cell/margintop) { get; set; } | Retourneert of stelt de bovenrand in een TextFrame in. Lezen/schrijven Double. |
| [MinimalHeight](../../aspose.slides/cell/minimalheight) { get; } | Retourneert de minimumhoogte van een cel. Dit is de som van minimale hoogtes van alle rijen die door de cel worden gedekt. Alleen-lezen Double. |
...
| [OffsetY](../../aspose.slides/cell/offsety) { get; } | Retourneert een afstand van de bovenzijde van een tabel tot de bovenzijde van een cel. Alleen-lezen Double. |
...
| [RowSpan](../../aspose.slides/cell/rowspan) { get; } | Retourneert het aantal rijen dat een samengevoegde cel beslaat. Dit wordt in combinatie met het vMerge-attribuut op andere cellen gebruikt om de begincel van een horizontale samenvoeging aan te geven. Alleen-lezen Int32. |
...
| [TextAnchorType](../../aspose.slides/cell/textanchortype) { get; set; } | Retourneert of stelt het tekstanker type in. Lezen/schrijven [`TextAnchorType`](../textanchortype). |
...
| [SplitByHeight](../../aspose.slides/cell/splitbyheight)(double) | Splitst de cel op basis van hoogte. |
| [SplitByRowSpan](../../aspose.slides/cell/splitbyrowspan)(int) | Splitst de cel in twee cellen op basis van de rij-index. |
| [SplitByWidth](../../aspose.slides/cell/splitbywidth)(double) | Splitst de cel op basis van breedte. |
