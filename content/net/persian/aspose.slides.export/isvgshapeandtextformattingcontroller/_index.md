...
| نام | توضیح |
| --- | --- |
| [AsISvgShapeFormattingController](../../aspose.slides.export/isvgshapeandtextformattingcontroller/asisvgshapeformattingcontroller) { get; } | رابط ISvgShapeFormattingController را برمی‌گرداند. |

## متدها

| نام | توضیح |
| --- | --- |
| [FormatText](../../aspose.slides.export/isvgshapeandtextformattingcontroller/formattext)(ISvgTSpan, IPortion, ITextFrame) | این تابع قبل از رسم بخش متن به SVG فراخوانی می‌شود تا به کاربر اجازه دهد SVG حاصل را کنترل کند. |
