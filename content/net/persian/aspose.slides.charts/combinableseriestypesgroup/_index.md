...
description: شمارشی از گروه‌های انواع سری‌های ترکیبی است. هر عنصر به گروهی از انواع سری‌های نمودار که می‌توانند به‌صورت همزمان در یک ChartSeriesGroup وجود داشته باشند، مرتبط است. برای مثال سری ChartType.PercentsStackedArea نمی‌تواند به‌همزمان با سری ChartType.StackedArea در یک ChartSeriesGroup باشد. اما دو یا چند سری ChartType.PercentsStackedArea می‌توانند به‌همزمان در یک ChartSeriesGroup وجود داشته باشند: CombinableSeriesTypesGroup.AreaChart_PercentsStackedArea. و سری ChartType.Line می‌تواند به‌همزمان با سری ChartType.LineWithMarkers در یک CombinableSeriesTypesGroup.LineChart_Line ChartSeriesGroup وجود داشته باشد.
type: docs
weight: 1530
url: /fa/aspose.slides.charts/combinableseriestypesgroup/
---
## CombinableSeriesTypesGroup شمارش

شمارش گروه‌های انواع سری‌های ترکیبی. هر عنصر به گروهی از انواع سری‌های نمودار که می‌توانند به‌صورت همزمان در یک ChartSeriesGroup وجود داشته باشند، مرتبط است. به عنوان مثال: سری ChartType.PercentsStackedArea نمی‌تواند به‌همراه سری ChartType.StackedArea به‌صورت همزمان در یک ChartSeriesGroup باشد. اما دو یا چند سری ChartType.PercentsStackedArea می‌توانند به‌همراه هم در یک ChartSeriesGroup وجود داشته باشند (CombinableSeriesTypesGroup.AreaChart_PercentsStackedArea). و سری ChartType.Line می‌تواند به‌همراه سری ChartType.LineWithMarkers به‌صورت همزمان در یک CombinableSeriesTypesGroup.LineChart_Line وجود داشته باشد.
