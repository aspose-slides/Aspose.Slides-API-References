...
description: 基底と、上部右側に配置された縮小サイズの上付き文字から構成される上付きオブジェクトを指定します。
type: docs
weight: 9000
...
| 名前 | 説明 |
| --- | --- |
| [MathSuperscriptElement](mathsuperscriptelement)(IMathElement, IMathElement) | MathSuperscriptElement クラスの新しいインスタンスを初期化します。 |
...
| [Superscript](../../aspose.slides.mathtext/mathsuperscriptelement/superscript) { get; } | 上付き文字 |
...
| [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)() | 数学要素をかっこで囲みます。 |
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | 指定された文字（かっこやその他の文字）で数学要素を囲みます。 |
...
| [GetChildren](../../aspose.slides.mathtext/mathsuperscriptelement/getchildren)() | 子要素を取得します。 |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)() | 下部の波かっこでこの要素をグループ化します。 |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)(char, MathTopBotPositions, MathTopBotPositions) | 下部の波かっこやその他のグループ文字でこの要素をグループ化します。 |
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes) | リミットなしで積分を取ります。 |
...
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(IMathElement) | 指定された次数の数学的根を、指定された引数から指定します。 |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(string) | 指定された次数の数学的根を、指定された引数から指定します。 |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | この要素を非可視ボックス（論理的グルーピング）に配置します。これは、方程式や他の数式テキストのコンポーネントをグループ化するために使用されます。 |
