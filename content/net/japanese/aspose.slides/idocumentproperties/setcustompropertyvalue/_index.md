...
description: 名前付き boolean カスタム プロパティを設定します。
type: docs
weight: 430
url: /ja/aspose.slides/idocumentproperties/setcustompropertyvalue/
---
## SetCustomPropertyValue(string, bool) {#setcustompropertyvalue}

名前付き boolean カスタム プロパティを設定します。
...
名前付き DateTime カスタム プロパティを設定します。
