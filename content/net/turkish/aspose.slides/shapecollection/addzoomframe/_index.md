...
| slide | ISlide | Zoom çerçevesi tarafından referans verilen [`ISlide`](../../islide); bu sunuma ait olmalıdır. |
...
| İstisna | Koşul |
| --- | --- |
| ArgumentException | Referans verilen slayt mevcut sunuma ait değilse atılır. |

### Örnekler

Bu örnek, bir koleksiyonun sonuna bir Zoom nesnesi eklemeyi gösterir (\"Presentation.pptx\" sunumunda en az iki slayt olduğunu varsayarak):
...
| height | Single | Yeni Zoom çerçevesinin yüksekliği, puan cinsinden. |
| slide | ISlide | Zoom çerçevesi tarafından referans verilen [`ISlide`](../../islide); bu sunuma ait olmalıdır. |
| image | IPPImage | Referans verilen slayt [`IPPImage`](../../ippimage) için resim. |
