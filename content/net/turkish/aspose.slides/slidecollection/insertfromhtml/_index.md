...
| --- | --- | --- |
| index | Int32 | Eklenecek konum. |
| htmlText | String | Eklenecek HTML. |
| resolver | IExternalResourceResolver | Harici nesneleri getirmek için kullanılan bir geri çağırma nesnesi. Bu parametre null ise tüm harici nesneler yok sayılacaktır. |
| uri | String | Belirtilen HTML'nin bir URI'si. Göreceli bağlantıları çözmek için kullanılır. |
...
| --- | --- | --- |
| index | Int32 | Eklenecek konum. |
| htmlReader | TextReader | Bir HTML dosyasının kaynağı olarak kullanılacak TextReader nesnesi. |
| resolver | IExternalResourceResolver | Harici nesneleri getirmek için kullanılan bir geri çağırma nesnesi. Bu parametre null ise tüm harici nesneler yok sayılacaktır. |
| uri | String | Belirtilen HTML'nin bir URI'si. Göreceli bağlantıları çözmek için kullanılır. |
...
| --- | --- | --- |
| index | Int32 | Eklenecek konum. |
| htmlStream | Stream | Bir HTML dosyasının kaynağı olarak kullanılacak Stream nesnesi. |
| resolver | IExternalResourceResolver | Harici nesneleri getirmek için kullanılan bir geri çağırma nesnesi. Bu parametre null ise tüm harici nesneler yok sayılacaktır. |
| uri | String | Belirtilen HTML'nin bir URI'si. Göreceli bağlantıları çözmek için kullanılır. |
