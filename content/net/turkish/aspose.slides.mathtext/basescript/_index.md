...
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Belirtilen karakterlerle (örneğin parantez veya başka karakterler) bir matematik öğesini çerçeve içine alır |
...
| [Integral](../../aspose.slides.mathtext/mathelementbase/integral)(MathIntegralTypes) | Sınırsız limit olmadan integral alır |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Bu öğeyi, bir denklem ya da diğer matematiksel metin bileşenlerini gruplamak için kullanılan görsel olmayan bir kutuya (mantıksal gruplama) yerleştirir. Kutulu bir nesne, örneğin bir hizalama noktasıyla ya da hizalama noktası olmadan bir operatör taklitçisi olarak, bir satır sonu noktası olarak hizmet edebilir veya satır sonlarına izin vermeyecek şekilde gruplanabilir. |
