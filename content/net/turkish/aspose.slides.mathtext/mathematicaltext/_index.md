...
| Ad | Açıklama |
| --- | --- |
| [MathematicalText](mathematicaltext#constructor)() | Varsayılan yapıcı (String.Empty değerini oluşturur) |
| [MathematicalText](mathematicaltext#constructor_1)(char) | Tek bir sembolle MathText oluşturur |
...
| Ad | Açıklama |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | Bu öğenin üstüne bir aksan işareti (üst karakter) ayarlar |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Bu örneği argüman, belirtilen ek argümanı da kullanarak belirtilen fonksiyonu alır |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Bu örneği argüman, belirtilen ek argümanı da kullanarak belirtilen fonksiyonu alır |
...
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Belirtilen karakterlerle (ör. parantez) bir matematik öğesini çerçeve içine alır |
...
| [Group](../../aspose.slides.mathtext/mathelementbase/group)(char, MathTopBotPositions, MathTopBotPositions) | Bu öğeyi alt köşeli parantez gibi bir gruplayıcı karakterle bir gruba yerleştirir |
...
| [SetSubscript](../../aspose.slides.mathtext/mathelementbase/setsubscript)(IMathElement) | Alt indis oluşturur |
| [SetSubscript](../../aspose.slides.mathtext/mathelementbase/setsubscript)(string) | Alt indis oluşturur |
| [SetSubSuperscriptOnTheLeft](../../aspose.slides.mathtext/mathelementbase/setsubsuperscriptontheleft)(IMathElement, IMathElement) | Sol tarafta alt ve üst indis oluşturur |
| [SetSubSuperscriptOnTheLeft](../../aspose.slides.mathtext/mathelementbase/setsubsuperscriptontheleft)(string, string) | Sol tarafta alt ve üst indis oluşturur |
| [SetSubSuperscriptOnTheRight](../../aspose.slides.mathtext/mathelementbase/setsubsuperscriptontheright)(IMathElement, IMathElement) | Sağ tarafta alt ve üst indis oluşturur |
| [SetSubSuperscriptOnTheRight](../../aspose.slides.mathtext/mathelementbase/setsubsuperscriptontheright)(string, string) | Sağ tarafta alt ve üst indis oluşturur |
| [SetSuperscript](../../aspose.slides.mathtext/mathelementbase/setsuperscript)(IMathElement) | Üst indis oluşturur |
| [SetSuperscript](../../aspose.slides.mathtext/mathelementbase/setsuperscript)(string) | Üst indis oluşturur |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Bu öğeyi bir görsel olmayan kutuya (mantıksal gruplama) koyar; bu kutu bir denklemin veya diğer bir matematik metni bileşenini gruplamak için kullanılır. Kutulu nesne, örneğin, hizalama noktasıyla veya olmadan bir operatör taklitçisi, satır sonu noktası işlevi görebilir ya da satır sonlarına izin vermeyecek şekilde gruplandırılabilir. |
