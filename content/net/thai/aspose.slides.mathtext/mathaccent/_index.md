...
description: ระบุฟังก์ชัน accent ที่ประกอบด้วยฐานและเครื่องหมายวรรณยุกต์ที่รวมกัน ตัวอย่าง ́
type: docs
weight: 8530
...
ระบุฟังก์ชัน accent ที่ประกอบด้วยฐานและเครื่องหมายวินัยที่รวมกัน ตัวอย่าง: 𝑎́
...
| ชื่อ | คำอธิบาย |
| --- | --- |
| [MathAccent](mathaccent#constructor)(IMathElement) | สร้าง math accent ที่ใช้กับ MathElement ที่ระบุโดยใช้ค่าตัวอักษร accent เริ่มต้น |
| [MathAccent](mathaccent#constructor_1)(IMathElement, char) | สร้าง math accent ที่ใช้กับ MathElement ที่ระบุ |

## คุณสมบัติ

| ชื่อ | คำอธิบาย |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathaccent/base) { get; } | อาร์กิวเมนต์ที่ได้รับการทำ accent |
| [Character](../../aspose.slides.mathtext/mathaccent/character) { get; set; } | Accent Character ค่าควรอยู่ในช่วงของ (U+0300–U+036F) หรือ (U+20D0–U+20EF) ค่าเริ่มต้น: Combining Circumflex Accent (U+0302) |

## เมธอด

| ชื่อ | คำอธิบาย |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | กำหนดเครื่องหมาย accent (อักขระที่อยู่ด้านบนขององค์ประกอบนี้) |
...
| [GetChildren](../../aspose.slides.mathtext/mathaccent/getchildren)() | ดึงองค์ประกอบลูก |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)() | วางองค์ประกอบนี้ในกลุ่มโดยใช้วงโค้งล่าง |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)(char, MathTopBotPositions, MathTopBotPositions) | วางองค์ประกอบนี้ในกลุ่มโดยใช้ตัวอักษรจัดกลุ่ม เช่น วงโค้งล่างหรืออื่น |
...
| [Overbar](../../aspose.slides.mathtext/mathelementbase/overbar)() | กำหนดเส้นบาร์ที่ด้านบนขององค์ประกอบนี้ |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | วางองค์ประกอบนี้ในกล่องที่ไม่แสดงผล (การจัดกลุ่มเชิงตรรกะ) ซึ่งใช้เพื่อจัดกลุ่มส่วนประกอบของสมการหรือข้อความคณิตศาสตร์อื่น ๆ ตัวอย่างเช่น สามารถทำหน้าที่เป็นตัวจำลองโอเปอเรเตอร์พร้อมหรือไม่มีจุดจัดแนว ทำหน้าที่เป็นจุดหยุดบรรทัด หรือจัดกลุ่มเพื่อไม่ให้มีการตัดบรรทัดภายใน |
| virtual [ToMathArray](../../aspose.slides.mathtext/mathelementbase/tomatharray)() | วางในอาเรย์แนวตั้ง |
| [Underbar](../../aspose.slides.mathtext/mathelementbase/underbar)() | กำหนดเส้นบาร์ที่ด้านล่างขององค์ประกอบนี้ |
