...
Skapar bilder från PDF-dokumentet och lägger till dem i slutet av samlingen med hänsyn till pdf-importalternativ.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| pdfStream | Stream | En ström som kommer att användas som källa för PDF-dokumentet |
