...
| [BackWall](../../aspose.slides.charts/ichart/backwall) { get; } | Returnerar ett objekt som möjliggör att ändra formatet på bakväggen i ett 3D-diagram. Skrivskyddad [`IChartWall`](../ichartwall). |
| [ChartData](../../aspose.slides.charts/ichart/chartdata) { get; } | Returnerar information om länkad eller inbäddad data som är associerad med ett diagram. Skrivskyddad [`IChartData`](../ichartdata). |
...
| [ChartTitle](../../aspose.slides.charts/ichart/charttitle) { get; } | Returnerar eller anger ett diagramtitel. Skrivskyddad [`IChartTitle`](../icharttitle). |
...
| [Floor](../../aspose.slides.charts/ichart/floor) { get; } | Returnerar ett objekt som möjliggör att ändra formatet på golvet i ett 3D-diagram. Skrivskyddad [`IChartWall`](../ichartwall). |
| [HasDataTable](../../aspose.slides.charts/ichart/hasdatatable) { get; set; } | Avgör om ett diagram har en datatabell. Läs/skriv Boolean. |
| [HasLegend](../../aspose.slides.charts/ichart/haslegend) { get; set; } | Avgör om ett diagram har en förklaring. Läs/skriv Boolean. |
| [HasRoundedCorners](../../aspose.slides.charts/ichart/hasroundedcorners) { get; set; } | Anger att diagramområdet ska ha avrundade hörn. Läs/skriv Boolean. |
| [HasTitle](../../aspose.slides.charts/ichart/hastitle) { get; set; } | Avgör om ett diagram har en synlig titel. Läs/skriv Boolean. |
...
| [PlotVisibleCellsOnly](../../aspose.slides.charts/ichart/plotvisiblecellsonly) { get; set; } | Avgör om endast synliga celler plottas. False för att plotta både synliga och dolda celler. Läs/skriv Boolean. |
...
| [ShowDataLabelsOverMaximum](../../aspose.slides.charts/ichart/showdatalabelsovermaximum) { get; set; } | Anger att datatetiketter över diagrammets maximum ska visas. Läs/skriv Boolean. |
| [SideWall](../../aspose.slides.charts/ichart/sidewall) { get; } | Returnerar ett objekt som möjliggör att ändra formatet på sidoväggen i ett 3D-diagram. Skrivskyddad [`IChartWall`](../ichartwall). |
