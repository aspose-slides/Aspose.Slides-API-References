...
| Ppsx | `4` | Spara presentation i PPSX (slideshow)-format. |
...
| Ppsm | `9` | Spara presentation i PPSM (makroaktiverad slideshow)-format. |
...
| Html5 | `23` | Spara presentation i HTML-format med det nya HTML5-mallarssystemet. |
