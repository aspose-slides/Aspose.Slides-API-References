...
| Namn | Beskrivning |
| --- | --- |
| [AsISaveOptions](../../aspose.slides.export/irenderingoptions/asisaveoptions) { get; } | Returnerar ISaveOptions-gränssnittet. Skrivskyddad [`ISaveOptions`](../isaveoptions). |
| [DisableFontLigatures](../../aspose.slides.export/irenderingoptions/disablefontligatures) { get; set; } | Hämtar eller anger ett värde som anger om text renderas utan att använda ligaturer. När den är satt till `true` kommer ligaturer att inaktiveras i den renderade utskriften. Som standard är detta egenskap satt till `false`. |
| [InkOptions](../../aspose.slides.export/irenderingoptions/inkoptions) { get; } | Tillhandahåller alternativ som styr utseendet på Ink-objekt i exporterade dokument. Skrivskyddad [`IInkOptions`](../iinkoptions) |
| [SlidesLayoutOptions](../../aspose.slides.export/irenderingoptions/slideslayoutoptions) { get; set; } | Hämtar eller anger läget som slides placeras i på sidan vid export av en presentation [`ISlidesLayoutOptions`](../islideslayoutoptions). |
