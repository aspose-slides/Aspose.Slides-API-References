...
| Namn | Beskrivning |
| --- | --- |
| [FormatText](../../aspose.slides.export/isvgshapeandtextformattingcontroller/formattext)(ISvgTSpan, IPortion, ITextFrame) | Denna funktion kallas före rendering av textdel till SVG för att låta användaren kontrollera den resulterande SVG:n. |
