...
| [DisableFontLigatures](../../aspose.slides.export/renderingoptions/disablefontligatures) { get; set; } | Hämtar eller anger ett värde som indikerar om text renderas utan att använda ligaturer. När den är inställd på `true` kommer ligaturer att inaktiveras i den renderade utdata. Som standard är denna egenskap inställd på `false`. |
...
| [ProgressCallback](../../aspose.slides.export/saveoptions/progresscallback) { get; set; } | Representerar ett återanrop-objekt för att spara förloppsuppdateringar i procent. Se [`IProgressCallback`](../../aspose.slides/iprogresscallback). |
...
| [SlidesLayoutOptions](../../aspose.slides.export/renderingoptions/slideslayoutoptions) { get; set; } | Hämtar eller anger läget i vilket slides placeras på sidan vid export av en presentation [`ISlidesLayoutOptions`](../islideslayoutoptions). |
