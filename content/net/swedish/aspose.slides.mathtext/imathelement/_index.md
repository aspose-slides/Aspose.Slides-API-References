...
description: Basgränssnitt för alla matematiska element såsom bråk, matematisk text, funktion, uttryck med flera element osv
type: docs
weight: 8230
...
| [Enclose](../../aspose.slides.mathtext/imathelement/enclose#enclose)() | Omger ett matematiskt element med parenteser |
| [Enclose](../../aspose.slides.mathtext/imathelement/enclose#enclose_1)(char, char) | Omger detta element med specificerade tecken, såsom parenteser eller andra tecken som ram |
| [Function](../../aspose.slides.mathtext/imathelement/function#function)(IMathElement) | Tar en funktion av ett argument där detta objekt används som funktionsnamn |
| [Function](../../aspose.slides.mathtext/imathelement/function#function_1)(string) | Tar en funktion av ett argument där detta objekt används som funktionsnamn |
| [GetChildren](../../aspose.slides.mathtext/imathelement/getchildren)() | Hämtar underordnade element |
| [Group](../../aspose.slides.mathtext/imathelement/group#group)() | Placera detta element i en grupp med en klammerparentes längst ner |
| [Group](../../aspose.slides.mathtext/imathelement/group#group_1)(char, MathTopBotPositions, MathTopBotPositions) | Placera detta element i en grupp med ett grupperingstecken, såsom en klammerparentes nedtill eller annat tecken |
...
| [Join](../../aspose.slides.mathtext/imathelement/join#join)(IMathElement) | Sammanfogar ett matematiskt element och bildar ett matematiskt block |
| [Join](../../aspose.slides.mathtext/imathelement/join#join_1)(string) | Sammanfogar en matematisk text och bildar ett matematiskt block |
...
| [Overbar](../../aspose.slides.mathtext/imathelement/overbar)() | Sätter ett streck ovanför detta element |
...
| [SetSubscript](../../aspose.slides.mathtext/imathelement/setsubscript#setsubscript)(IMathElement) | Skapar nedsänkt index |
| [SetSubscript](../../aspose.slides.mathtext/imathelement/setsubscript#setsubscript_1)(string) | Skapar nedsänkt index |
| [SetSubSuperscriptOnTheLeft](../../aspose.slides.mathtext/imathelement/setsubsuperscriptontheleft#setsubsuperscriptontheleft)(IMathElement, IMathElement) | Skapar nedsänkt och upphöjt index till vänster |
| [SetSubSuperscriptOnTheLeft](../../aspose.slides.mathtext/imathelement/setsubsuperscriptontheleft#setsubsuperscriptontheleft_1)(string, string) | Skapar nedsänkt och upphöjt index till vänster |
| [SetSubSuperscriptOnTheRight](../../aspose.slides.mathtext/imathelement/setsubsuperscriptontheright#setsubsuperscriptontheright)(IMathElement, IMathElement) | Skapar nedsänkt och upphöjt index till höger |
| [SetSubSuperscriptOnTheRight](../../aspose.slides.mathtext/imathelement/setsubsuperscriptontheright#setsubsuperscriptontheright_1)(string, string) | Skapar nedsänkt och upphöjt index till höger |
| [SetSuperscript](../../aspose.slides.mathtext/imathelement/setsuperscript#setsuperscript)(IMathElement) | Skapar upphöjt index |
| [SetSuperscript](../../aspose.slides.mathtext/imathelement/setsuperscript#setsuperscript_1)(string) | Skapar upphöjt index |
| [SetUpperLimit](../../aspose.slides.mathtext/imathelement/setupperlimit#setupperlimit)(IMathElement) | Tar övre gränsen |
| [SetUpperLimit](../../aspose.slides.mathtext/imathelement/setupperlimit#setupperlimit_1)(string) | Tar övre gränsen |
| [ToBorderBox](../../aspose.slides.mathtext/imathelement/toborderbox#toborderbox)() | Placera detta element i en kantlåda |
| [ToBorderBox](../../aspose.slides.mathtext/imathelement/toborderbox#toborderbox_1)(bool, bool, bool, bool, bool, bool, bool, bool) | Placera detta element i en kantlåda |
| [ToBox](../../aspose.slides.mathtext/imathelement/tobox)() | Placera detta element i en icke-visuell låda (logisk gruppering) som används för att gruppera komponenter i en ekvation eller annan instans av matematisk text. En lådad objekt kan (till exempel) fungera som en operatoremulator med eller utan en justeringspunkt, fungera som en radbrytningspunkt, eller grupperas så att radbrytningar inte tillåts inom. |
| [ToMathArray](../../aspose.slides.mathtext/imathelement/tomatharray)() | Sätter in en vertikal matris |
| [Underbar](../../aspose.slides.mathtext/imathelement/underbar)() | Sätter ett streck under detta element |
