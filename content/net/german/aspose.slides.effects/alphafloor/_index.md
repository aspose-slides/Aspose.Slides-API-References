...
Stellt einen Alpha Floor-Effekt dar. Alpha (Opazität) Werte unter 100% werden auf null geändert. Mit anderen Worten, alles, was teilweise transparent ist, wird vollständig transparent.
...
| [GetEffective](../../aspose.slides.effects/alphafloor/geteffective)() | Erhält effektive Alpha Floor-Effektdaten mit der angewandten Vererbung. |
| override [GetHashCode](../../aspose.slides.effects/alphafloor/gethashcode)() | Dient als Hashfunktion für einen bestimmten Typ. |
