...
description: Erstellt einen neuen Connector, passt ihn vom Standardtemplate an und fügt ihn an der angegebenen Indexstelle in die Sammlung ein.
type: docs
weight: 330
...
Erstellt einen neuen Connector, passt ihn vom Standardtemplate an und fügt ihn an der angegebenen Indexstelle in die Sammlung ein.
...
Erstellt einen neuen Connector und fügt ihn an der angegebenen Indexstelle in die Sammlung ein.
...
| width | Single | Die Breite des Rahmens der Form. |
| height | Single | Die Höhe des Rahmens der Form. |
| createFromTemplate | Boolean | Wenn wahr, wird die neue Form vom Standardtemplate angepasst. Ein nicht leerer Name, einfacher Stil und zentrierter Text werden der neuen Form zugewiesen. Wenn falsch, haben alle Werte der Eigenschaften der neuen Form die Standardwerte. |
