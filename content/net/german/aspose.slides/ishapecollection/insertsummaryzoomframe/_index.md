...
| --- | --- | --- |
| index | Int32 | Der nullbasierten Index, an dem der Section Zoom-Rahmen eingefügt werden soll. |
...
Dieses Beispiel demonstriert die Erstellung und das Einfügen eines Summary Zoom-Objekts an der angegebenen Stelle einer Sammlung (angenommen, dass es mindestens zwei Abschnitte in der "Presentation.pptx"-Präsentation gibt):
