...
description: Erstellt und gibt ein Array zurück, das alle Folien enthält.
type: docs
weight: 130
...
| --- | --- | --- |
| startIndex | Int32 | Der Index der ersten Folie, die hinzugefügt werden soll. |
| count | Int32 | Die Anzahl der Folien, die hinzugefügt werden sollen. |
