...
description: Bestimmt den Index eines bestimmten Mathe-Elements in der Sammlung.
type: docs
weight: 120
...
Bestimmt den Index eines bestimmten Mathe-Elements in der Sammlung.
...
| --- | --- | --- |
| item | IMathElement | Das Element, das in der Sammlung lokalisiert werden soll. |
