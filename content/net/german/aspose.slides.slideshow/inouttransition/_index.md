...
| Name | Beschreibung |
| --- | --- |
| [Direction](../../aspose.slides.slideshow/inouttransition/direction) { get; set; } | Richtung eines Übergangseffekts. Lese-/schreibbar [`TransitionInOutDirectionType`](../transitioninoutdirectiontype). |

## Methoden

| Name | Beschreibung |
| --- | --- |
| override [Equals](../../aspose.slides.slideshow/transitionvaluebase/equals)(object) | Bestimmt, ob die beiden Instances von TransitionValueBase gleich sind. |
