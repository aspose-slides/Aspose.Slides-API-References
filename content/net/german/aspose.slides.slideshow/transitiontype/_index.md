...
description: Stellt den Übergangstyp einer Diashow dar.
type: docs
weight: 10450
...
Stellt den Übergangstyp einer Diashow dar.
...
| Blinds | `1` |  |
| Checker | `2` |  |
| Circle | `3` | Bezieht sich auf den Übergang Shape (mit Option Circle) in PowerPoint 2010. |
| Comb | `4` |  |
| Cover | `5` |  |
| Cut | `6` |  |
| Diamond | `7` | Bezieht sich auf den Übergang Shape (mit Option Diamond) in PowerPoint 2010. |
| Dissolve | `8` |  |
| Fade | `9` |  |
| Newsflash | `10` |  |
| Plus | `11` | Bezieht sich auf den Übergang Shape (mit Option Plus) in PowerPoint 2010. |
| Pull | `12` |  |
| Push | `13` |  |
| Random | `14` |  |
| RandomBar | `15` |  |
...
| Strips | `17` |  |
| Wedge | `18` | Bezieht sich auf den Übergang Clock (mit Option Wedge) in PowerPoint 2010. |
| Wheel | `19` | Bezieht sich auf den Übergang Clock (mit Option Clockwise) in PowerPoint 2010. |
| Wipe | `20` |  |
| Zoom | `21` | Bezieht sich auf den Übergang Shape (mit Optionen In/Out) in PowerPoint 2010. Siehe auch Warp, das sich auf den Übergang Zoom in PowerPoint 2010 bezieht. |
...
| WheelReverse | `43` | Bezieht sich auf den Übergang Clock (mit Option Counterclockwise) in PowerPoint 2010. Verfügbar in PowerPoint 2010. |
...
| Morph | `56` | Bezieht sich auf den Übergang Morph (mit Option Type) in PowerPoint 2019. |
