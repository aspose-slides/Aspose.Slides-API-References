...
description: Definiert eine Nachanimationsfarbe für den Effekt. Lese-/Schreibzugriff auf IColorFormataspose.slides/icolorformat.
type: docs
weight: 10
...
Definiert eine Nachanimationsfarbe für den Effekt. Lese-/Schreibzugriff auf [`IColorFormat`](../../../aspose.slides/icolorformat).
...
using (Presentation presentation = new Presentation("demo.pptx"))
{
    ...
    // Ändern Sie den Effekt Nachanimationstyp in "Farbe"
