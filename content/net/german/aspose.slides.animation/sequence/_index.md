...
| [TriggerShape](../../aspose.slides.animation/sequence/triggershape) { get; set; } | Gibt die Form-Ziel für INTERAKTIVE Sequenzen zurück oder setzt sie. Wenn die Sequenz nicht interaktiv ist, gibt sie null zurück. Lesen/Schreiben [`IShape`](../../aspose.slides/ishape). |  
...
| [AddEffect](../../aspose.slides.animation/sequence/addeffect#addeffect_1)(IChart, EffectChartMinorGroupingType, int, int, EffectType, EffectSubtype, EffectTriggerType) | Fügt den neuen Diagrammanimationseffekt für Elemente in Kategorie oder Serie am Ende der Sequenz hinzu. |  
