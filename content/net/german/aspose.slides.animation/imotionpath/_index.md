...
| Name | Beschreibung |
| --- | --- |
| [AsIEnumerable](../../aspose.slides.animation/imotionpath/asienumerable) { get; } | Ermöglicht das Abrufen der Basis-IBehavior-Schnittstelle. Nur-Lese IEnumerable. |
...
| [Insert](../../aspose.slides.animation/imotionpath/insert)(int, MotionCommandPathType, PointF[], MotionPathPointsType, bool) | Fügt einen neuen Befehl in den Pfad ein |
| [Remove](../../aspose.slides.animation/imotionpath/remove)(IMotionCmdPath) | Entfernt die angegebenen Befehle aus der Sammlung. |
