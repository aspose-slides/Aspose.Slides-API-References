...
description: Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Bubble. Δείτε επίσης τη μέθοδο IsChartTypeBubbleaspose.slides.charts/charttypecharacterizer/ischarttypebubble.
type: docs
weight: 130
url: /el/aspose.slides.charts/chartdatapointcollection/adddatapointforbubbleseries/
---
## AddDataPointForBubbleSeries(IChartDataCell, IChartDataCell, IChartDataCell) {#adddatapointforbubbleseries}

Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Bubble (δείτε επίσης [`IsChartTypeBubble`](../../charttypecharacterizer/ischarttypebubble) method).
...
| --- | --- | --- |
| xValue | IChartDataCell | Σημείο δεδομένων XValue |
| yValue | IChartDataCell | Σημείο δεδομένων YValue |
| bubbleSize | IChartDataCell | Σημείο δεδομένων BubbleSize |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| xValue | String | Σημείο δεδομένων XValue |
| yValue | IChartDataCell | Σημείο δεδομένων YValue |
| bubbleSize | IChartDataCell | Σημείο δεδομένων BubbleSize |
