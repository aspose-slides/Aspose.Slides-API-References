...
---
## ISvgShapeAndTextFormattingController διεπαφή
...
| Όνομα | Περιγραφή |
| --- | --- |
| [AsISvgShapeFormattingController](../../aspose.slides.export/isvgshapeandtextformattingcontroller/asisvgshapeformattingcontroller) { get; } | Επιστρέφει τη διεπαφή ISvgShapeFormattingController. |

## Μέθοδοι

| Όνομα | Περιγραφή |
| --- | --- |
| [FormatText](../../aspose.slides.export/isvgshapeandtextformattingcontroller/formattext)(ISvgTSpan, IPortion, ITextFrame) | Αυτή η συνάρτηση καλείται πριν από την απόδοση του τμήματος κειμένου σε SVG ώστε να επιτρέψει στον χρήστη να ελέγξει το τελικό SVG. |
