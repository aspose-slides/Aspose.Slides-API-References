...
| Name | Description |
| --- | --- |
| [Author](../../aspose.slides/comment/author) { get; } | Επιστρέφει τον συντάκτη ενός σχολίου. Μόνο για ανάγνωση [`ICommentAuthor`](../icommentauthor). |
...
using (Presentation presentation = new Presentation())
{
	...
	// Αποθηκεύει το αρχείο PowerPoint Presentation
