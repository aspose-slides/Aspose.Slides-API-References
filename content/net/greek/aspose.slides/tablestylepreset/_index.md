...
description: Αντιπροσωπεύει ενσωματωμένα στυλ πινάκων.
type: docs
weight: 10880
...
Αντιπροσωπεύει ενσωματωμένα στυλ πινάκων.
...
| --- | --- | --- |
| Custom | `-1` | Table έχει προσαρμοσμένο στυλ. Αυτή είναι τιμή μόνο για επιστροφή. |
| None | `0` | Χωρίς στυλ. |
| MediumStyle2Accent1 | `1` | Medium Style 2 - Accent 1. |
| MediumStyle2 | `2` | Medium Style 2. |
| NoStyleNoGrid | `3` | Χωρίς στυλ, χωρίς πλέγμα. |
...
| NoStyleTableGrid | `10` | Χωρίς στυλ, πλέγμα πίνακα. |
