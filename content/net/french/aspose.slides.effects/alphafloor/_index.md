...
| Nom | Description |
| --- | --- |
| override [Equals](../../aspose.slides.effects/alphafloor/equals)(object) | Détermine si le [`AlphaFloor`](../alphafloor) spécifié est égal à l'[`AlphaFloor`](../alphafloor) actuel. |
| [GetEffective](../../aspose.slides.effects/alphafloor/geteffective)() | Obtient les données efficaces de l'effet Alpha Floor avec l'héritage appliqué. |
