...
| Nom | Description |
| --- | --- |
| [Count](../../aspose.slides.mathtext/mathparagraph/count) { get; } | Obtient le nombre d'éléments réellement contenus dans la collection. Lecture seule Int32. |
...
| [WriteAsMathMl](../../aspose.slides.mathtext/mathparagraph/writeasmathml)(Stream) | Enregistre le contenu de ce [`MathParagraph`](../mathparagraph) au format MathML |
