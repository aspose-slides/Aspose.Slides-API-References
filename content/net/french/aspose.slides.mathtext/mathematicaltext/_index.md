...
| [MathematicalText](mathematicaltext#constructor_1)(char) | Crée MathText avec un symbole unique |
| [MathematicalText](mathematicaltext#constructor_2)(string) | Crée MathematicalText à partir de texte |
| [MathematicalText](mathematicaltext#constructor_3)(string, IPortionFormat) | Crée MathematicalText à partir de texte et de paramètres de format |
...
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Enferme un élément mathématique dans des caractères spécifiés tels que des parenthèses ou d'autres caractères comme encadrement |
