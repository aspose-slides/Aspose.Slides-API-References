...
description: Spécifie l'objet fraction qui se compose d'un numérateur et d'un dénominateur séparés par une barre de fraction. La barre de fraction peut être horizontale ou diagonale en fonction des propriétés de la fraction. L'objet fraction est également utilisé pour représenter la fonction stack qui place un élément au-dessus d'un autre sans barre de fraction.
type: docs
weight: 8430
...
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(IMathElement) | Spécifie la racine mathématique d'un degré donné à partir de l'argument spécifié. |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(string) | Spécifie la racine mathématique d'un degré donné à partir de l'argument spécifié. |
