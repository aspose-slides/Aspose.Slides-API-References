...
| [HyperlinkManager](../../aspose.slides/shape/hyperlinkmanager) { get; } | Renvoie le gestionnaire d'hyperlien. Lecture seule [`IHyperlinkManager`](../ihyperlinkmanager). |
| [HyperlinkMouseOver](../../aspose.slides/shape/hyperlinkmouseover) { get; set; } | Renvoie ou définit l'hyperlien défini pour le survol de souris. Lecture/écriture [`IHyperlink`](../ihyperlink). |
...
| [Placeholder](../../aspose.slides/shape/placeholder) { get; } | Renvoie le modèle pour une forme. Renvoie null si la forme n'a pas de modèle. Lecture seule [`IPlaceholder`](../iplaceholder). |
| [PlayLoopMode](../../aspose.slides/videoframe/playloopmode) { get; set; } | Détermine si une vidéo est en boucle. Lecture/écriture Boolean. |
...
| [RelativeScaleHeight](../../aspose.slides/pictureframe/relativescaleheight) { get; set; } | Renvoie ou définit l'échelle de la hauteur (par rapport à la taille d'image originale) du cadre d'image. La valeur 1.0 correspond à 100 %. Lecture/écriture Single. |
| [RelativeScaleWidth](../../aspose.slides/pictureframe/relativescalewidth) { get; set; } | Renvoie ou définit l'échelle de la largeur (par rapport à la taille d'image originale) du cadre d'image. La valeur 1.0 correspond à 100 %. Lecture/écriture Single. |
| [RewindVideo](../../aspose.slides/videoframe/rewindvideo) { get; set; } | Détermine si une vidéo est automatiquement rembobinée au début dès que le film a fini de jouer. Lecture/écriture Boolean. |
...
| override [ShapeType](../../aspose.slides/pictureframe/shapetype) { get; set; } | Renvoie ou définit le type AutoShape pour un PictureFrame. Tous les éléments de l'ensemble [`ShapeType`](../shapetype) sont autorisés, sauf toutes sortes de lignes : |
...
| [TrimFromEnd](../../aspose.slides/videoframe/trimfromend) { get; set; } | Élaguer la fin [ms] |
| [TrimFromStart](../../aspose.slides/videoframe/trimfromstart) { get; set; } | Élaguer le début [ms] |
...
| Nom | Description |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | Ajoute un nouveau modèle s'il n'y en a pas et définit les propriétés du modèle à un spécifié. |
| [CreateShapeElements](../../aspose.slides/geometryshape/createshapeelements)() | Crée et renvoie un tableau des éléments de la forme. |
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Renvoie une forme de modèle de base (forme du modèle et/ou de la diapositive maître dont la forme actuelle hérite). Un null est renvoyé si la forme actuelle n'hérite pas. |
...
| [GetImage](../../aspose.slides/shape/getimage)() | Renvoie la miniature de la forme. ShapeThumbnailBounds.Shape le type des limites de la miniature de forme est utilisé par défaut. |
