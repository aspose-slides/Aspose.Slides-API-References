...
| [BlackWhiteMode](../../aspose.slides/shape/blackwhitemode) { get; set; } | Propriété qui indique comment une forme sera rendue en mode d'affichage en noir et blanc. Lecture/écriture [`BlackWhiteMode`](../blackwhitemode). |
...
| virtual [FillFormat](../../aspose.slides/shape/fillformat) { get; } | Renvoie l'objet FillFormat qui contient les propriétés de formatage du remplissage pour une forme. Remarque : peut renvoyer null pour certains types de formes qui n'ont pas de propriétés de remplissage. Lecture seule [`IFillFormat`](../ifillformat). |
...
| [ImageType](../../aspose.slides/zoomobject/imagetype) { get; set; } | Obtient ou définit le type d'image d'un objet zoom. Lecture/écriture [`ZoomImageType`](../zoomimagetype). Valeur par défaut : Preview |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Renvoie un identifiant unique limité à la diapositive qui reste constant pendant la durée de vie de la forme et permet à PowerPoint ou au code d'interopérabilité de référencer la forme de façon fiable depuis n'importe où dans le document. Lecture seule UInt32. Voir aussi [`UniqueId`](../shape/uniqueid). |
...
| [ShowBackground](../../aspose.slides/zoomobject/showbackground) { get; set; } | Obtient ou définit la valeur qui indique si le Zoom utilisera l'arrière-plan de la diapositive de destination. Lecture/écriture Boolean. Valeur par défaut : true |
| [Slide](../../aspose.slides/shape/slide) { get; } | Renvoie la diapositive parent d'une forme. Lecture seule [`IBaseSlide`](../ibaseslide). |
| [TargetSection](../../aspose.slides/sectionzoomframe/targetsection) { get; set; } | Obtient ou définit l'objet section auquel l'objet Section Zoom se lie. Lecture/écriture [`ISection`](../isection). |
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Renvoie l'objet ThreeDFormat contenant les propriétés d'effet 3D d'une forme. Remarque : peut renvoyer null pour certains types de formes qui n'ont pas de propriétés 3D. Lecture seule [`IThreeDFormat`](../ithreedformat). |
...
| [ZoomImage](../../aspose.slides/zoomobject/zoomimage) { get; set; } | Obtient ou définit l'image de l'objet zoom. Lecture/écriture [`IPPImage`](../ippimage). |
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Renvoie la position d'une forme dans l'ordre Z. Shapes[0] renvoie la forme située à l'arrière de l'ordre Z, et Shapes[Shapes.Count - 1] renvoie la forme située à l'avant de l'ordre Z. Lecture seule Int32. |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Renvoie une forme d'espace réservé basique (forme provenant de la disposition et/ou de la diapositive maîtresse dont la forme actuelle hérite). Null est renvoyé si la forme actuelle n'hérite pas. |
| [GetImage](../../aspose.slides/shape/getimage)() | Renvoie la miniature de la forme. Le type ShapeThumbnailBounds.Shape des limites de la miniature de forme est utilisé par défaut. |
...
| [RemovePlaceholder](../../aspose.slides/shape/removeplaceholder)() | Indique que cette forme n'est pas un espace réservé. |
