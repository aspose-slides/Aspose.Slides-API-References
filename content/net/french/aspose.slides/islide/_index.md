...
| [Hidden](../../aspose.slides/islide/hidden) { get; set; } | Détermine si la diapositive spécifiée est masquée pendant le diaporama. Lecture/écriture Boolean. |
...
| [SlideNumber](../../aspose.slides/islide/slidenumber) { get; set; } | Renvoie le numéro de la diapositive. L'index de la diapositive dans la collection [`Slides`](../ipresentation/slides) est toujours égal à SlideNumber - 1. Lecture/écriture Int32. |

## Méthodes

| Nom | Description |
| --- | --- |
| [GetImage](../../aspose.slides/islide/getimage#getimage)() | Renvoie un objet Thumbnail Image (20 % de la taille réelle). |
| [GetImage](../../aspose.slides/islide/getimage#getimage_1)(IRenderingOptions) | Renvoie un objet Thumbnail Bitmap. |
| [GetImage](../../aspose.slides/islide/getimage#getimage_4)(ITiffOptions) | Renvoie un objet bitmap tiff Thumbnail avec les paramètres spécifiés. |
| [GetImage](../../aspose.slides/islide/getimage#getimage_6)(Size) | Renvoie un objet image avec la taille spécifiée. |
| [GetImage](../../aspose.slides/islide/getimage#getimage_5)(float, float) | Renvoie un objet image avec un redimensionnement personnalisé. |
| [GetImage](../../aspose.slides/islide/getimage#getimage_3)(IRenderingOptions, Size) | Renvoie un objet Thumbnail Bitmap avec la taille spécifiée. |
| [GetImage](../../aspose.slides/islide/getimage#getimage_2)(IRenderingOptions, float, float) | Renvoie un objet Thumbnail Bitmap avec un redimensionnement personnalisé. |
...
| [Reset](../../aspose.slides/islide/reset)() | Réinitialise la position, la taille et le format de chaque forme qui possède un prototype sur LayoutSlide. |
