...
## IFontsManager.GetFontBytes méthode  
...
| --- | --- | --- |  
| fontData | IFontData | L'objet de données de police contenant des informations sur la police [`IFontData`](../../ifontdata). |  
| fontStyle | FontStyle | Le style de la police pour lequel les données doivent être récupérées FontStyle. |  

### Valeur de retour  

Un tableau d'octets contenant les données de la police pour le style de police spécifié. Si les données de police ou le style ne sont pas trouvés, renvoie null.  
