...
| [Reorder](../../aspose.slides/islidecollection/reorder#reorder)(int, ISlide) | Déplace la diapositive de la collection à la position spécifiée. |
| [Reorder](../../aspose.slides/islidecollection/reorder#reorder_1)(int, params ISlide[]) | Déplace les diapositives de la collection à la position spécifiée. Les diapositives seront placées à partir de l'index dans l'ordre dans lequel elles apparaissent dans la liste. |
| [ToArray](../../aspose.slides/islidecollection/toarray#toarray)() | Crée et retourne un tableau contenant toutes les diapositives. |
| [ToArray](../../aspose.slides/islidecollection/toarray#toarray_1)(int, int) | Crée et retourne un tableau contenant toutes les diapositives de la plage spécifiée. |
