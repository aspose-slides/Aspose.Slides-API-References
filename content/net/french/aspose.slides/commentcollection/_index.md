...
| [IsSynchronized](../../aspose.slides/commentcollection/issynchronized) { get; } | Renvoie une valeur indiquant si l'accès à la collection est synchronisé (thread-safe). Lecture seule Boolean. |
...
| [FindCommentByIdx](../../aspose.slides/commentcollection/findcommentbyidx)(int) | Trouve un commentaire dans la collection par indice. |
...
| [ToArray](../../aspose.slides/commentcollection/toarray#toarray)() | Crée et renvoie un tableau contenant tous les commentaires. |
| [ToArray](../../aspose.slides/commentcollection/toarray#toarray_1)(int, int) | Crée et renvoie un tableau contenant tous les commentaires de la plage spécifiée. |
