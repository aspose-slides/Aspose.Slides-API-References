...
| [Color](../../aspose.slides/colorformat/color) { get; set; } | Renvoie la couleur résultante (avec toutes les transformations de couleur appliquées). Définit les couleurs RVB et efface toutes les transformations de couleur. Lecture/écriture Color. |
...
| [ColorType](../../aspose.slides/colorformat/colortype) { get; set; } | Renvoie ou définit la méthode de définition de couleur. Lecture/écriture [`ColorType`](../colortype). |
...
| [Hue](../../aspose.slides/colorformat/hue) { get; set; } | Renvoie ou définit le composant teinte d'une couleur dans la représentation HSL. Toutes les transformations de couleur sont ignorées. Lecture/écriture Single. |
| [Luminance](../../aspose.slides/colorformat/luminance) { get; set; } | Renvoie ou définit le composant luminance d'une couleur dans la représentation HSL. Toutes les transformations de couleur sont ignorées. Lecture/écriture Single. |
...
| [Saturation](../../aspose.slides/colorformat/saturation) { get; set; } | Renvoie ou définit le composant saturation d'une couleur dans la représentation HSL. Toutes les transformations de couleur sont ignorées. Lecture/écriture Single. |
...
| Nom | Description |
| --- | --- |
| [CopyFrom](../../aspose.slides/colorformat/copyfrom)(IColorFormat) | Copie le format de couleur depuis "color". |
