...
description: Insérer un AudioFrame avec un fichier audio intégré. Le son du fichier audio intégré peut être uniquement un WAV.
type: docs
weight: 280
...
Insérer un AudioFrame avec un fichier audio intégré. Le son du fichier audio intégré peut être uniquement un WAV.
...
| width | Single | Largeur d'un nouveau cadre audio. |
| height | Single | Hauteur d'un nouveau cadre audio. |
| audio | IAudio | Audio provenant de la liste Presentation.Audios. |
