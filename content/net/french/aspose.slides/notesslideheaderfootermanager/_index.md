...
description: Représente le gestionnaire qui détient le comportement des espaces réservés de diapositives de notes, y compris l'espace réservé pour l'en-tête.
type: docs
weight: 8880
url: /fr/aspose.slides/notesslideheaderfootermanager/
---

## Classe NotesSlideHeaderFooterManager

Représente le gestionnaire qui détient le comportement des espaces réservés de diapositives de notes, y compris l'espace réservé pour l'en-tête.
...
| Nom | Description |
| --- | --- |
| [SetDateTimeText](../../aspose.slides/baseslideheaderfootermanager/setdatetimetext)(string) | Définit le texte pour l'espace réservé de date et d'heure de la diapositive. |
| [SetDateTimeVisibility](../../aspose.slides/baseslideheaderfootermanager/setdatetimevisibility)(bool) | Modifie la visibilité de l'espace réservé de date et d'heure de la diapositive. |
