...
| [CurrentDateTime](../../aspose.slides/presentation/currentdatetime) { get; set; } | Renvoie ou définit la date et l'heure qui remplaceront le contenu des champs de date et d'heure. Heure de création par défaut de cet objet Presentation. Lecture/écriture DateTime. |
...
| [DocumentProperties](../../aspose.slides/presentation/documentproperties) { get; } | Renvoie l'objet DocumentProperties qui contient les propriétés standard et personnalisées du document. Lecture seule [`IDocumentProperties`](../idocumentproperties). |
...
| [HeaderFooterManager](../../aspose.slides/presentation/headerfootermanager) { get; } | Renvoie le gestionnaire d'en-têtes et de pieds de page actuel. Lecture seule [`IPresentationHeaderFooterManager`](../ipresentationheaderfootermanager). |
| [HyperlinkQueries](../../aspose.slides/presentation/hyperlinkqueries) { get; } | Fournit un accès facile à tous les hyperliens contenus dans toutes les diapositives de la présentation (pas dans les diapositives maîtres, de mise en page, de notes). Lecture seule [`IHyperlinkQueries`](../ihyperlinkqueries). |
...
| [MasterHandoutSlideManager](../../aspose.slides/presentation/masterhandoutslidemanager) { get; } | Renvoie le gestionnaire de master handout. Lecture seule [`IMasterHandoutSlideManager`](../imasterhandoutslidemanager). |
| [MasterNotesSlideManager](../../aspose.slides/presentation/masternotesslidemanager) { get; } | Renvoie le gestionnaire de notes master. Lecture seule [`IMasterNotesSlideManager`](../imasternotesslidemanager). |
| [Masters](../../aspose.slides/presentation/masters) { get; } | Renvoie une liste de toutes les diapositives maîtres qui sont définies dans la présentation. Lecture seule [`IMasterSlideCollection`](../imasterslidecollection). |
...
| [SlideShowSettings](../../aspose.slides/presentation/slideshowsettings) { get; } | Renvoie les paramètres de diaporama pour la présentation. |
...
| [VbaProject](../../aspose.slides/presentation/vbaproject) { get; set; } | Obtient ou définit le projet VBA avec les macros de présentation. Lecture/écriture [`IVbaProject`](../../aspose.slides.vba/ivbaproject). |
...
| [ViewProperties](../../aspose.slides/presentation/viewproperties) { get; } | Obtient les propriétés de vue de la présentation. Lecture seule [`IViewProperties`](../iviewproperties). |
...
| [GetImages](../../aspose.slides/presentation/getimages#getimages_1)(IRenderingOptions, int[]) | Renvoie des objets Image miniatures pour les diapositives spécifiées d'une présentation. |
| [GetImages](../../aspose.slides/presentation/getimages#getimages_5)(IRenderingOptions, Size) | Renvoie des objets Image miniatures pour toutes les diapositives d'une présentation avec une taille spécifiée. |
| [GetImages](../../aspose.slides/presentation/getimages#getimages_4)(IRenderingOptions, float, float) | Renvoie des objets Image miniatures pour toutes les diapositives d'une présentation avec un redimensionnement personnalisé. |
| [GetImages](../../aspose.slides/presentation/getimages#getimages_3)(IRenderingOptions, int[], Size) | Renvoie des objets Image miniatures pour les diapositives spécifiées d'une présentation avec une taille spécifiée. |
| [GetImages](../../aspose.slides/presentation/getimages#getimages_2)(IRenderingOptions, int[], float, float) | Renvoie des objets Image miniatures pour les diapositives spécifiées d'une présentation avec un redimensionnement personnalisé. |
| [GetSlideById](../../aspose.slides/presentation/getslidebyid)(uint) | Renvoie une diapositive, une diapositive maître ou une diapositive de mise en page par ID. |
...
| [HighlightText](../../aspose.slides/presentation/highlighttext#highlighttext)(string, Color) | Surligne toutes les correspondances du texte exemple avec la couleur spécifiée. |
| [HighlightText](../../aspose.slides/presentation/highlighttext#highlighttext_1)(string, Color, ITextSearchOptions, IFindResultCallback) | Surligne toutes les correspondances du texte exemple avec la couleur spécifiée. |
| [JoinPortionsWithSameFormatting](../../aspose.slides/presentation/joinportionswithsameformatting)() | Regroupe les portions avec le même formatage dans tous les paragraphes de toutes les formes acceptables dans toutes les diapositives. |
...
```csharp
[C#]
// Charger n'importe quel fichier pris en charge dans Presentation par exemple ppt, pptx, odp, etc.
