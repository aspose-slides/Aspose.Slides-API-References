...
Les exemples suivants montrent comment ajouter une image en tant que BLOB dans une présentation PowerPoint.
...
using (Presentation pres = new Presentation())
{
	using (FileStream fileStream = new FileStream(pathToLargeImage, FileMode.Open))
	{
		...
		// Enregistre la présentation. Alors qu'une grande présentation est produite, la consommation de mémoire
...
Les exemples suivants ajoutent un lien hypertexte à une image dans une présentation PowerPoint.
