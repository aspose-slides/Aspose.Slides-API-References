...
| TopLeftLargeDropShadow | `1` | Représente l'ombre portée large en haut à gauche. |
...
| BackCenterPerspectiveShadow | `10` | Représente l'ombre de perspective centrée en arrière. |
| TopRightDropShadow | `11` | Représente l'ombre portée en haut à droite. |
| FrontBottomShadow | `12` | Représente l'ombre du bas à l'avant. |
