...
| [GroupShapeLock](../../aspose.slides/groupshape/groupshapelock) { get; } | Renvoie les verrous de la forme. Lecture seule [`IGroupShapeLock`](../igroupshapelock). |
...
| override [LineFormat](../../aspose.slides/groupshape/lineformat) { get; } | Renvoie l'objet LineFormat qui contient les propriétés de formatage de ligne pour une forme. Remarque : renvoie null pour les objets GroupShape car ils n'ont pas de propriétés de ligne. Lecture seule [`ILineFormat`](../ilineformat). |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Obtient l'identifiant unique de la forme dans le domaine de la diapositive. Lecture seule UInt32. Voir aussi [`UniqueId`](../shape/uniqueid) pour obtenir l'identifiant unique de la forme dans le domaine de la présentation. |
...
| [ShapeLock](../../aspose.slides/groupshape/shapelock) { get; } | Renvoie les verrous de la forme. Lecture seule [`IGroupShapeLock`](../igroupshapelock). (2 propriétés) |
| [Shapes](../../aspose.slides/groupshape/shapes) { get; } | Renvoie la collection de formes à l'intérieur du groupe. Lecture seule [`IShapeCollection`](../ishapecollection). |
...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Obtient l'identifiant unique de la forme dans le domaine de la présentation. Lecture seule UInt32. Voir aussi [`OfficeInteropShapeId`](../shape/officeinteropshapeid) pour obtenir l'identifiant unique de la forme dans le domaine de la diapositive. |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Renvoie une forme de placeholder basique (forme du modèle et/ou de la diapositive maître dont la forme actuelle est héritée). Un null est renvoyé si la forme actuelle n'est pas héritée. |
| [GetImage](../../aspose.slides/shape/getimage)() | Renvoie la miniature de la forme. ShapeThumbnailBounds.Shape type de limite de miniature de forme est utilisé par défaut. |
