...
| [Frame](../../aspose.slides/shape/frame) { get; set; } | Renvoie ou définit les propriétés de la trame de la forme. Lecture/écriture [`IShapeFrame`](../ishapeframe). |
...
| [Name](../../aspose.slides/shape/name) { get; set; } | Renvoie ou définit le nom d'une forme. Ne doit pas être nul. Utiliser une chaîne vide si nécessaire. Lecture/écriture String. |
...
| [RawFrame](../../aspose.slides/shape/rawframe) { get; set; } | Renvoie ou définit les propriétés de la trame brute de la forme. Lecture/écriture [`IShapeFrame`](../ishapeframe). |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Renvoie la position d'une forme dans l'ordre z. Shapes[0] renvoie la forme à l'arrière-plan de l'ordre z, et Shapes[Shapes.Count - 1] renvoie la forme au premier plan de l'ordre z. Lecture seule Int32. |
