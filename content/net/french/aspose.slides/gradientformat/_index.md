...
| [GradientStops](../../aspose.slides/gradientformat/gradientstops) { get; } | Renvoie la collection des points d'arrêt du dégradé. Lecture seule [`IGradientStopCollection`](../igradientstopcollection). |
...
| [TileFlip](../../aspose.slides/gradientformat/tileflip) { get; set; } | Renvoie ou définit le mode de retournement pour un dégradé. Lecture/écriture [`TileFlip`](../tileflip). |
