...
| Nom | Description |
| --- | --- |
| [AsIEnumerable](../../aspose.slides.animation/ibehaviorcollection/asienumerable) { get; } | Renvoie l'interface IEnumerable. IEnumerable en lecture seule. |
| [Count](../../aspose.slides.animation/ibehaviorcollection/count) { get; } | Renvoie le nombre de comportements dans une collection. Int32 en lecture seule. |
