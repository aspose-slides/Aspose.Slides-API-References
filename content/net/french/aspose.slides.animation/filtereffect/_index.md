...
| [Reveal](../../aspose.slides.animation/filtereffect/reveal) { get; set; } | Représente que l'effet avec le comportement doit être révélé (entrée/sortie). Lecture/écriture [`FilterEffectRevealType`](../filtereffectrevealtype). |
