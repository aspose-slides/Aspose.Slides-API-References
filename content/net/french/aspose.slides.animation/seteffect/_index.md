...
| [To](../../aspose.slides.animation/seteffect/to) { get; set; } | Spécifie un certain attribut d'un effet après un effet d'animation. Représente la valeur du point. Uniquement : bool, ColorFormat, float, int, string. Lecture/écriture Object. |
