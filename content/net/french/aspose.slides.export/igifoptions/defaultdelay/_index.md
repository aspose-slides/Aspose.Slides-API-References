...
## Propriété IGifOptions.DefaultDelay

Obtient ou définit le temps de délai par défaut [ms]. Cette valeur sera utilisée si [`AdvanceAfterTime`](../../../aspose.slides/islideshowtransition/advanceaftertime) n'est pas définie. La valeur par défaut est 1000.
