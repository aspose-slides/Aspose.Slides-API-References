...
description: Crée le nouveau point de données et l'ajoute à la fin de la collection. Applicable pour les séries dont chartType est l'un des sous-types de ligne, voir aussi la méthode ChartTypeCharacterizer.IsChartTypeLineChartType.
type: docs
weight: 140
...
Crée le nouveau point de données et l'ajoute à la fin de la collection. Applicable pour les séries dont chartType est l'un des sous-types de ligne (voir aussi la méthode ChartTypeCharacterizer.IsChartTypeLine(ChartType)).
