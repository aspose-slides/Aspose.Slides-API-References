...
description: Représente un comportement d'affichage clé de légende de l'étiquette de données d'un graphique spécifié. Vrai si la clé de légende de l'étiquette de données est visible. Booléen en lecture/écriture.
type: docs
weight: 120
...
Représente un comportement d'affichage clé de légende de l'étiquette de données d'un graphique spécifié. Vrai si la clé de légende de l'étiquette de données est visible. Booléen en lecture/écriture.
