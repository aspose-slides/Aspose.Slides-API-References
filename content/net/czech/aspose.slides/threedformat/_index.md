...
description: Representuje 3-D vlastnosti.
type: docs
weight: 11470
...
| [GetEffective](../../aspose.slides/threedformat/geteffective)() | Získává efektivní 3D formátovací data s aplikovaným děděním. |
...
Následující příklad ukazuje, jak použít gradientový efekt na 3D tvar v prezentaci PowerPoint.
...
using (Presentation pres = new Presentation())
{
    ...
    shape.Fi llFormat.GradientFormat.GradientStops.Add(0, Color.Blue);
