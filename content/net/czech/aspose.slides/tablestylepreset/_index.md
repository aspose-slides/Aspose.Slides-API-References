...
type: docs
weight: 10860
url: /cs/aspose.slides/tablestylepreset/
---
## TableStylePreset výčet
...
| Název | Hodnota | Popis |
| --- | --- | --- |
| Custom | `-1` | Table má vlastní styl. Jedná se o hodnotu pouze pro čtení. |
| None | `0` | Žádný styl. |
| MediumStyle2Accent1 | `1` | Medium Style 2 - Accent 1. |
| MediumStyle2 | `2` | Medium Style 2. |
| NoStyleNoGrid | `3` | Žádný styl, žádná mřížka. |
...
| NoStyleTableGrid | `10` | Žádný styl, mřížka tabulky. |
