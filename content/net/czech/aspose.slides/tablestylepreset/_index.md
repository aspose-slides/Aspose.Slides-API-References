...
description: Representuje vestavěné styly tabulek.
type: docs
weight: 10880
url: /cs/aspose.slides/tablestylepreset/
---
## Výčet TableStylePreset

Representuje vestavěné styly tabulek.
...
| Název | Hodnota | Popis |
| --- | --- | --- |
| Custom | `-1` | Tabulka má vlastní styl. Jedná se o hodnotu pouze pro čtení. |
| None | `0` | Žádný styl. |
