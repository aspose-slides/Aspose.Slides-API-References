...
description: Poskytuje možnosti, které řídí, jak je prezentace/snimek vykreslen.
type: docs
weight: 4410
...
Poskytuje možnosti, které řídí, jak je prezentace/snimek vykreslen.
...
| [DisableFontLigatures](../../aspose.slides.export/renderingoptions/disablefontligatures) { get; set; } | Získává nebo nastavuje hodnotu, která určuje, zda je text vykreslován bez použití ligatur. Když je nastaveno na `true`, ligatury budou ve vykresleném výstupu zakázány. Ve výchozím nastavení je tato vlastnost nastavena na `false`. |
...
| [InkOptions](../../aspose.slides.export/renderingoptions/inkoptions) { get; } | Poskytuje možnosti, které řídí vzhled objektů Ink v exportovaném dokumentu. Pouze ke čtení [`IInkOptions`](../iinkoptions) |
