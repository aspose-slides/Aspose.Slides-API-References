...
description: Určuje funkci pruhu, skládající se ze základního argumentu a horního nebo dolního pruhu
type: docs
weight: 8570
...
Určuje funkci pruhu, skládající se ze základního argumentu a horního nebo dolního pruhu
...
| Name | Description |
| --- | --- |
| [MathBar](mathbar#constructor)(IMathElement) | Inicializuje MathBar s horním pruhem (Horní pozice) |
| [MathBar](mathbar#constructor_1)(IMathElement, MathTopBotPositions) | Inicializuje MathBar se zadanou pozicí |
...
| [Position](../../aspose.slides.mathtext/mathbar/position) { get; set; } | Pozice čáry pruhu. Výchozí: Top |

## Metody

| Name | Description |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | Nastaví diakritický znak (znak na horní straně tohoto prvku) |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Přijme zadanou funkci s touto instancí jako argument a určený doplňkový argument |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Přijme zadanou funkci s touto instancí jako argument a určený doplňkový argument |
...
| [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)() | Zabaluje matematický prvek do závorek |
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Zabaluje matematický prvek do určených znaků, jako jsou závorky nebo jiné znaky |
...
| [Overbar](../../aspose.slides.mathtext/mathelementbase/overbar)() | Nastaví pruh na horní část tohoto prvku |
