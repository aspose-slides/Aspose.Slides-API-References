...
| Имя | Описание |
| --- | --- |
| [ApplicationTemplate](../../aspose.slides/documentproperties/applicationtemplate) { get; set; } | Возвращает или задает шаблон приложения. Читаемое/записываемое String. |
| [AppVersion](../../aspose.slides/documentproperties/appversion) { get; } | Возвращает версию приложения. Только для чтения String. |
| [Author](../../aspose.slides/documentproperties/author) { get; set; } | Возвращает или задает автора презентации. Читаемое/записываемое String. |
| [Category](../../aspose.slides/documentproperties/category) { get; set; } | Возвращает или задает категорию презентации. Читаемое/записываемое String. |
| [Comments](../../aspose.slides/documentproperties/comments) { get; set; } | Возвращает или задает комментарии к презентации. Читаемое/записываемое String. |
| [Company](../../aspose.slides/documentproperties/company) { get; set; } | Возвращает или задает свойство компании. Читаемое/записываемое String. |
| [ContentStatus](../../aspose.slides/documentproperties/contentstatus) { get; set; } | Возвращает или задает статус содержания презентации. Читаемое/записываемое String. |
| [ContentType](../../aspose.slides/documentproperties/contenttype) { get; set; } | Возвращает или задает тип содержания презентации. Читаемое/записываемое String. |
...
| [CreatedTime](../../aspose.slides/documentproperties/createdtime) { get; set; } | Возвращает дату создания презентации. Значения в UTC. Читаемое/записываемое DateTime. |
| [HeadingPairs](../../aspose.slides/documentproperties/headingpairs) { get; } | Указывает на группировку частей документа и количество частей в каждой группе. Только для чтения IHeadingPair[]. |
...
| [HyperlinkBase](../../aspose.slides/documentproperties/hyperlinkbase) { get; set; } | Возвращает или задает свойство документа HyperlinkBase. Читаемое/записываемое String. |
| [HyperlinksChanged](../../aspose.slides/documentproperties/hyperlinkschanged) { get; set; } | Указывает, что один или несколько гиперссылок в этой части были обновлены исключительно в этой части производителем. Следующий производитель, открывающий этот документ, должен обновить отношения гиперссылок с новыми гиперссылками, указанными в этой части. Читаемое/записываемое Boolean. |
| [Item](../../aspose.slides/documentproperties/item) { get; set; } | Возвращает или задает настраиваемое свойство, связанное с указанным именем. Читаемое/записываемое Object. |
| [Keywords](../../aspose.slides/documentproperties/keywords) { get; set; } | Возвращает или задает ключевые слова презентации. Читаемое/записываемое String. |
| [LastPrinted](../../aspose.slides/documentproperties/lastprinted) { get; set; } | Возвращает дату, когда презентация была напечатана в последний раз. Читаемое/записываемое DateTime. |
| [LastSavedBy](../../aspose.slides/documentproperties/lastsavedby) { get; set; } | Возвращает или задает имя последнего человека, который изменил презентацию. Читаемое/записываемое String. |
| [LastSavedTime](../../aspose.slides/documentproperties/lastsavedtime) { get; set; } | Возвращает дату последней модификации презентации. Значения в UTC. Только для чтения в случае Presentation.DocumentProperties (поскольку он будет обновлен внутренне во время процесса сохранения объекта IPresentation). Может быть изменено через экземпляр DocumentProperties, возвращаемый методом [`ReadDocumentProperties`](../ipresentationinfo/readdocumentproperties) Пожалуйста, смотрите пример в сводке метода [`UpdateDocumentProperties`](../ipresentationinfo/updatedocumentproperties). |
| [LinksUpToDate](../../aspose.slides/documentproperties/linksuptodate) { get; set; } | Указывает, актуальны ли гиперссылки в документе. Установите этот элемент в **true**, чтобы указать, что гиперссылки обновлены. Установите этот элемент в **false**, чтобы указать, что гиперссылки устарели. Читаемое/записываемое Boolean. |
| [Manager](../../aspose.slides/documentproperties/manager) { get; set; } | Возвращает или задает свойство менеджера. Читаемое/записываемое String. |
| [MultimediaClips](../../aspose.slides/documentproperties/multimediaclips) { get; } | Возвращает общее количество звуковых или видеоклипсов, присутствующих в документе. Только для чтения Int32. |
| [NameOfApplication](../../aspose.slides/documentproperties/nameofapplication) { get; set; } | Возвращает или задает имя приложения. Читаемое/записываемое String. |
...
| [PresentationFormat](../../aspose.slides/documentproperties/presentationformat) { get; set; } | Возвращает или задает предполагаемый формат презентации. Читаемое/записываемое String. |
| [RevisionNumber](../../aspose.slides/documentproperties/revisionnumber) { get; set; } | Возвращает или задает номер ревизии презентации. Читаемое/записываемое Int32. |
| [ScaleCrop](../../aspose.slides/documentproperties/scalecrop) { get; set; } | Указывает режим отображения миниатюры документа. Установите этот элемент в **true**, чтобы включить масштабирование миниатюры документа для отображения. Установите этот элемент в **false**, чтобы включить обрезку миниатюры документа, чтобы показывать только разделы, которые соответствуют отображению. Читаемое/записываемое Boolean. |
| [SharedDoc](../../aspose.slides/documentproperties/shareddoc) { get; set; } | Определяет, является ли презентация общей между несколькими людьми. Читаемое/записываемое Boolean. |
...
| [Subject](../../aspose.slides/documentproperties/subject) { get; set; } | Возвращает или задает тему презентации. Читаемое/записываемое String. |
| [Title](../../aspose.slides/documentproperties/title) { get; set; } | Возвращает или задает заголовок презентации. Читаемое/записываемое String. |
...
| [TotalEditingTime](../../aspose.slides/documentproperties/totaleditingtime) { get; set; } | Общее время редактирования презентации. Читаемое/записываемое TimeSpan. |
...
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue_4)(string, DateTime) | Устанавливает именованное настраиваемое свойство DateTime. |
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue_1)(string, double) | Устанавливает именованное настраиваемое свойство double. |
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue_3)(string, float) | Устанавливает именованное настраиваемое свойство float. |
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue_2)(string, int) | Устанавливает именованное настраиваемое свойство integer. |
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue_5)(string, string) | Устанавливает именованное настраиваемое свойство string. |

### Примеры

Следующий пример показывает, как получить доступ к встроенным свойствам презентации PowerPoint.
...
{
	// Создаем ссылку на объект IDocumentProperties, связанный с презентацией
...
Следующий пример показывает, как изменить встроенные свойства презентации PowerPoint.
