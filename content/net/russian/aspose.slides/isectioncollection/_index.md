...
| Имя | Описание |
| --- | --- |
| [Item](../../aspose.slides/isectioncollection/item) { get; } | Возвращает элемент по указанному индексу. Только для чтения [`ISection`](../isection). |
...
| [AddSection](../../aspose.slides/isectioncollection/addsection)(string, ISlide) | Добавляет новый раздел, начинающийся с конкретного слайда. |
...
| [RemoveSectionWithSlides](../../aspose.slides/isectioncollection/removesectionwithslides)(ISection) | Удаляет раздел и содержащиеся в нём слайды. |
| [ReorderSectionWithSlides](../../aspose.slides/isectioncollection/reordersectionwithslides)(ISection, int) | Перемещает раздел и его слайды в коллекции в указанную позицию. |
