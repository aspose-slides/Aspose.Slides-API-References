...
| [IsSynchronized](../../aspose.slides/coloroperationcollection/issynchronized) { get; } | Возвращает значение, указывающее, синхронизирован ли доступ к коллекции (потокобезопасный). Только для чтения Boolean. |
...
| [Clone](../../aspose.slides/coloroperationcollection/clone)() | Создаёт копию коллекции ColorOperationCollection. |
...
| [GetEnumerator](../../aspose.slides/coloroperationcollection/getenumerator)() | Возвращает перечислитель, который проходит по коллекции. |
