...
description: Указывает формат документа, который необходимо загрузить.
type: docs
weight: 7830
...
Указывает формат документа, который необходимо загрузить.
...
| Fodp | `13` | Плоская XML-ODF презентация. |
