...
| [X](../../aspose.slides/ippimage/x) { get; } | Возвращает смещение по X изображения. Только для чтения Int32. |
| [Y](../../aspose.slides/ippimage/y) { get; } | Возвращает смещение по Y изображения. Только для чтения Int32. |
