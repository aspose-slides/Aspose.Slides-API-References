...
description: Представляет коллекцию тегов, определенных пользователем, пар строк
type: docs
weight: 10580
...
| [IsSynchronized](../../aspose.slides/tagcollection/issynchronized) { get; } | Возвращает значение, указывающее, синхронизирован ли доступ к коллекции (потокобезопасен). Только для чтения Boolean. |
...
| [Contains](../../aspose.slides/tagcollection/contains)(string) | Определяет, содержит ли коллекция указанное имя. |
...
| [IndexOfName](../../aspose.slides/tagcollection/indexofname)(string) | Возвращает индекс (первый) для указанного ключа в коллекции. |
