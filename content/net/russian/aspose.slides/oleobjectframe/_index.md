...
| [EmbeddedFileName](../../aspose.slides/oleobjectframe/embeddedfilename) { get; } | Возвращает путь к встроенному OLE объекту |
...
| [Rotation](../../aspose.slides/shape/rotation) { get; set; } | Возвращает или задает количество градусов, на которые заданная фигура повёрнута вокруг оси z. Положительное значение указывает на вращение по часовой стрелке; отрицательное значение указывает на против часовой стрелки. Чтение/запись Single. |
...
| [SubstitutePictureFormat](../../aspose.slides/oleobjectframe/substitutepictureformat) { get; } | Возвращает свойства заполнения изображения OleObject. Только для чтения [`IPictureFillFormat`](../ipicturefillformat). |
...
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Возвращает объект ThreeDFormat, который содержит свойства эффекта 3d для фигуры. Примечание: может вернуть null для определенных типов фигур, у которых нет 3d свойств. Только для чтения [`IThreeDFormat`](../ithreedformat). |
...
| [UpdateAutomatic](../../aspose.slides/oleobjectframe/updateautomatic) { get; set; } | Определяет, будет ли связанный встроенный объект автоматически обновляться при открытии или печати презентации. Чтение/запись Boolean. |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Возвращает позицию фигуры в порядке z. Shapes[0] возвращает фигуру в задней части порядка z, а Shapes[Shapes.Count - 1] возвращает фигуру на передней стороне порядка z. Только для чтения Int32. |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Возвращает базовую фигуру заполнителя (фигура из макета и/или основного слайда, от которой унаследована текущая фигура). Возвращает null, если текущая фигура не унаследована. |
...
| [SetEmbeddedData](../../aspose.slides/oleobjectframe/setembeddeddata)(IOleEmbeddedDataInfo) | Устанавливает информацию о встроенных данных OLE. Этот метод изменяет свойства объекта, чтобы отразить новые данные, и устанавливает флаг IsObjectLink в false, указывая на то, что OLE объект встроен. |
...
Следующий пример показывает, как получить доступ к рамкам OLE объекта.
...
using (Presentation pres = new Presentation("AccessingOLEObjectFrame.pptx"))
{
    ...
    // Считывает OLE объект и записывает его на диск
