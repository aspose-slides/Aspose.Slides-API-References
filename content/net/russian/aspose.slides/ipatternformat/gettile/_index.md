...
description: Создает изображение плитки для узорной заливки с заданными цветами.
type: docs
weight: 40
...
Создает изображение плитки для узорной заливки с заданными цветами.
...
Создает изображение плитки для узорной заливки.
