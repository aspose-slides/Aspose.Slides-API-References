...
## IMasterLayoutSlideCollection.Add метод
...
1) Добавленный макет для значения SlideLayoutType.Custom параметра *layoutType* не содержит заполнителей и фигур. 2) Аналогом этого метода является метод [`Add`](../../igloballayoutslidecollection/add), доступный через свойство [`LayoutSlides`](../../ipresentation/layoutslides).
