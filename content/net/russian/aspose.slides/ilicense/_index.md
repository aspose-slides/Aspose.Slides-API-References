...
В этом примере будет предпринята попытка найти файл лицензии с именем MyLicense.lic в папке, которая содержит компонент, в папке, содержащей вызываемую сборку, в папке начальной сборки, а затем в встроенных ресурсах вызываемой сборки.
