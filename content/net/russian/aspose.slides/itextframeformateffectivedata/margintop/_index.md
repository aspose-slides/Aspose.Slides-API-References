...
description: Возвращает верхний отступ в текстовом кадре. Только для чтения Double.
type: docs
weight: 90
...
Возвращает верхний отступ (пункты) в текстовом кадре. Только для чтения Double.
