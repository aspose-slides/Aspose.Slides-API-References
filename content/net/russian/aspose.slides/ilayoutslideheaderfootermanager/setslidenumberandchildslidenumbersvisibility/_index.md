...
description: Изменяет видимость заполнителя номера страницы макета слайда и всех заполнителей номеров страниц дочерних слайдов. Дочерние заполнители означают заполнители, содержащиеся на зависимых слайдах. Зависимые слайды используют и зависят от макета слайда.
type: docs
weight: 60
...
Изменяет видимость заполнителя номера страницы макета слайда и всех заполнителей номеров страниц дочерних слайдов. Дочерние заполнители означают заполнители, содержащиеся на зависимых слайдах. Зависимые слайды используют и зависят от макета слайда.
