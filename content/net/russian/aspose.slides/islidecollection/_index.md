...
| [AddClone](../../aspose.slides/islidecollection/addclone#addclone_2)(ISlide, IMasterSlide, bool) | Добавляет копию указанного исходного слайда в конец коллекции. Соответствующий макет будет автоматически выбран из указанного мастер-шаблона (соответствующий макет - это макет с тем же типом или именем, что и у макета исходного слайда). Если соответствующего макета нет, то макет исходного слайда будет склонирован (если allowCloneMissingLayout равно true) или будет выброшено исключение PptxEditException (если allowCloneMissingLayout равно false). |
