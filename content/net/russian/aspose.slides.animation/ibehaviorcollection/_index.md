...
| Имя | Описание |
| --- | --- |
| [AsIEnumerable](../../aspose.slides.animation/ibehaviorcollection/asienumerable) { get; } | Возвращает интерфейс IEnumerable. Только для чтения IEnumerable. |
...
| [Item](../../aspose.slides.animation/ibehaviorcollection/item) { get; set; } | Возвращает поведение с указанным индексом. |
...
| [Contains](../../aspose.slides.animation/ibehaviorcollection/contains)(IBehavior) | Определяет, содержит ли ICollection конкретное значение. |
| [IndexOf](../../aspose.slides.animation/ibehaviorcollection/indexof)(IBehavior) | Определяет индекс конкретного элемента в IList. |
