...
| [Character](../../aspose.slides.mathtext/imathaccent/character) { get; set; } | Символ акцента. Значение должно находиться в диапазоне (U+0300–U+036F) или (U+20D0–U+20EF). Значение по умолчанию: комбинирующий циркумфлекс акцент (U+0302) |
