...
| [MathematicalText](mathematicaltext#constructor_1)(char) | Создает MathText с одиночным символом |
| [MathematicalText](mathematicaltext#constructor_2)(string) | Создает MathematicalText из текста |
| [MathematicalText](mathematicaltext#constructor_3)(string, IPortionFormat) | Создает MathematicalText из текста и настроек формата |
...
| Name | Description |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | Устанавливает акцент (символ в верхней части данного элемента) |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(IMathElement) | Принимает указанную функцию с этим экземпляром в качестве аргумента |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfOneArgument) | Принимает указанную функцию с этим экземпляром в качестве аргумента |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(string) | Принимает указанную функцию с этим экземпляром в качестве аргумента |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Принимает указанную функцию с этим экземпляром в качестве аргумента и заданного дополнительного аргумента |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Принимает указанную функцию с этим экземпляром в качестве аргумента и заданного дополнительного аргумента |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Помещает этот элемент в невизуальную коробку (логическая группировка), которая используется для группировки компонентов уравнения или другого экземпляра математического текста. Объект в коробке может (например) служить эмулятором оператора с или без точки выравнивания, служить точкой разрыва строки или группироваться так, чтобы не позволять разрывы строк внутри. |
