...
| Параметр | Тип | Описание |
| --- | --- | --- |
| functionType | MathFunctionsOfOneArgument | Один из общих типов функции с одним аргументом |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| functionType | MathFunctionsOfTwoArguments | Один из общих типов функции с двумя аргументами: Log, Lim, Min, Max |
