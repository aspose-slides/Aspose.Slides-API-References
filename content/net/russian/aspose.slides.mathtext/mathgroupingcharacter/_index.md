...
description: Указывает символ группы над или под выражением, обычно чтобы подчеркнуть связь между элементами
type: docs
weight: 8500
...
Указывает символ группы над или под выражением, обычно чтобы подчеркнуть связь между элементами
...
| Название | Описание |
| --- | --- |
| [MathGroupingCharacter](mathgroupingcharacter#constructor)(IMathElement) | Инициализирует новый экземпляр класса MathGroupingCharacter с символом группировки по умолчанию U+23DF (НИЖНЯЯ ФИГУРНАЯ СКОБОЧКА) |
...
| [Character](../../aspose.slides.mathtext/mathgroupingcharacter/character) { get; set; } | Символ группировки Значение по умолчанию: U+23DF (НИЖНЯЯ ФИГУРНАЯ СКОБОЧКА) |
| [Position](../../aspose.slides.mathtext/mathgroupingcharacter/position) { get; set; } | Позиция символа группировки. По умолчанию: Низу |
| [VerticalJustification](../../aspose.slides.mathtext/mathgroupingcharacter/verticaljustification) { get; set; } | Вертикальное выравнивание символа группы. Указывает на выравнивание объекта относительно базовой линии. Например, когда символ группы находится над объектом, VerticalJustification в положении Top означает, что верх объекта попадает на базовую линию; когда VerticalJustification установлен на Bottom, низ объекта находится на базовой линии. По умолчанию: Низу для Position=Top и Вверху для Position=Bottom |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(IMathElement) | Использует указанную функцию, принимая этот экземпляр в качестве аргумента |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfOneArgument) | Использует указанную функцию, принимая этот экземпляр в качестве аргумента |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(string) | Использует указанную функцию, принимая этот экземпляр в качестве аргумента |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Использует указанную функцию, принимая этот экземпляр в качестве аргумента и указанный дополнительный аргумент |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Использует указанную функцию, принимая этот экземпляр в качестве аргумента и указанный дополнительный аргумент |
...
| [GetChildren](../../aspose.slides.mathtext/mathgroupingcharacter/getchildren)() | Получить дочерние элементы |
...
| virtual [Join](../../aspose.slides.mathtext/mathelementbase/join)(IMathElement) | Присоединяет математический элемент и формирует математический блок |
| virtual [Join](../../aspose.slides.mathtext/mathelementbase/join)(string) | Присоединяет математический текст и формирует математический блок |
