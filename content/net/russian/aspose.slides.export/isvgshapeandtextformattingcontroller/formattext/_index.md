...
description: Эта функция вызывается перед отрисовкой текстовой части в SVG, чтобы позволить пользователю контролировать результирующий SVG.
type: docs
weight: 20
...
Эта функция вызывается перед отрисовкой текстовой части в SVG, чтобы позволить пользователю контролировать результирующий SVG.
