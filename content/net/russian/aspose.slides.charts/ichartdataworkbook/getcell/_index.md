...
description: Получает ячейку, которую можно использовать для серий или категорий графиков
type: docs
weight: 40
...
Получает ячейку, которую можно использовать для серий или категорий графиков
...
| --- | --- | --- |
| worksheetName | String | Имя таблицы. |
| row | Int32 | Строка. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| worksheetIndex | Int32 | Индекс таблицы. |
| row | Int32 | Строка. |
| column | Int32 | Столбец. |
