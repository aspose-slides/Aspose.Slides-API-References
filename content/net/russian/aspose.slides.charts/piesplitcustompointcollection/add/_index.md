...
| исключение | условие |
| --- | --- |
| ArgumentException | Точка с данным индексом не найдена. |

### См. Также

* класс [PieSplitCustomPointCollection](../../piesplitcustompointcollection)
* пространство имён [Aspose.Slides.Charts](../../piesplitcustompointcollection)
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| dataPoint | IChartDataPoint | Точка данных, которую нужно добавить. |
