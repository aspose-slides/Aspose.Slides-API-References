...
description: Представляет уровень точки данных. Применяется к диаграммам Treemap и Sunburst.
type: docs
weight: 1350
...
Представляет уровень точки данных. Применяется к диаграммам Treemap и Sunburst.
...
| [Label](../../aspose.slides.charts/chartdatapointlevel/label) { get; } | Представляет подпись данных уровня точки данных. Применяется для типов серий Treemap и Sunburst. Только для чтения [`IDataLabel`](../idatalabel). |
