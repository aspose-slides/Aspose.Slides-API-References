...
description: Aspose.Slides — это API для управления документами Microsoft PowerPoint®, которые позволяют программным приложениям читать и записывать документы PowerPoint® без использования Microsoft PowerPoint®.
is_root: true
---
...
| [Aspose.Slides.Export.Web](./aspose.slides.export.web) | Содержит классы для экспорта презентаций Microsoft PowerPoint в Html с проектами расширений. |
...
| [Aspose.Slides.LowCode](./aspose.slides.lowcode) | Содержит классы и методы для обработки сложных общих операций в низкокодовом формате. |
