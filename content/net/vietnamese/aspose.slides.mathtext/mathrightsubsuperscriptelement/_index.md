...
description: Xác định đối tượng Chỉ số dưới-trên, bao gồm một cơ sở và chỉ số dưới cùng với chỉ số trên được đặt ở phía bên phải của cơ sở.
type: docs
weight: 8960
...
Xác định đối tượng Chỉ số dưới-trên, bao gồm một cơ sở và chỉ số dưới và chỉ số trên đặt ở phía bên phải của cơ sở.
...
| Name | Description |
| --- | --- |
| [AlignScripts](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/alignscripts) { get; set; } | Xác định cách căn chỉnh của chỉ số dưới/chỉ số trên. Khi true, chỉ số dưới và chỉ số trên được căn chỉnh theo chiều ngang với nhau. Khi false, chúng được căn chỉnh theo hình dạng của cơ sở. Giá trị mặc định là false. |
| [Base](../../aspose.slides.mathtext/basescript/base) { get; } | Đối số cơ sở |
| [Subscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/subscript) { get; } | Đối số chỉ số dưới |
| [Superscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/superscript) { get; } | Đối số chỉ số trên |
...
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(IMathElement) | Thực hiện hàm của một đối số, sử dụng thể hiện này làm tên hàm |
| [Function](../../aspose.slides.mathtext/mathelementbase/function)(string) | Thực hiện hàm của một đối số, sử dụng thể hiện này làm tên hàm |
| [GetChildren](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/getchildren)() | Lấy các phần tử con |
| [Group](../../aspose.slides.mathtext/mathelementbase/group)() | Đặt phần tử này vào một nhóm sử dụng dấu ngoặc nhọn phía dưới |
...
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(IMathElement) | Xác định căn bậc của số với bậc đã cho từ đối số được chỉ định. |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(string) | Xác định căn bậc của số với bậc đã cho từ đối số được chỉ định. |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Đặt phần tử này vào một hộp không hiển thị (nhóm logic) được dùng để nhóm các thành phần của một phương trình hoặc các đoạn văn toán học khác. Một đối tượng được đóng trong hộp có thể (ví dụ) hoạt động như một bộ mô phỏng toán tử có hoặc không có điểm căn chỉnh, hoạt động như một điểm ngắt dòng, hoặc được nhóm sao cho không cho phép ngắt dòng bên trong. |
