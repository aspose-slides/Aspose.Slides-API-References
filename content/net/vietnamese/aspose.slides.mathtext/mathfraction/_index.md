...
description: Xác định đối tượng phân số bao gồm tử số và mẫu số được ngăn cách bằng thanh phân số. Thanh phân số có thể nằm ngang hoặc chéo tùy thuộc vào các thuộc tính của phân số. Đối tượng phân số cũng được dùng để biểu diễn hàm stack, đặt một phần tử lên trên phần tử khác mà không có thanh phân số.
type: docs
weight: 8690
...
Xác định đối tượng phân số, gồm tử số và mẫu số được ngăn cách bởi thanh phân số. Thanh phân số có thể nằm ngang hoặc chéo, tùy thuộc vào các thuộc tính của phân số. Đối tượng phân số cũng được dùng để biểu diễn hàm stack, đặt một phần tử lên trên phần tử khác mà không có thanh phân số.
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(IMathElement) | Thực hiện hàm đã chỉ định sử dụng đối tượng này làm đối số |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfOneArgument) | Thực hiện hàm đã chỉ định sử dụng đối tượng này làm đối số |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(string) | Thực hiện hàm đã chỉ định sử dụng đối tượng này làm đối số |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | Thực hiện hàm đã chỉ định sử dụng đối tượng này làm đối số và đối số bổ sung đã chỉ định |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | Thực hiện hàm đã chỉ định sử dụng đối tượng này làm đối số và đối số bổ sung đã chỉ định |
...
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(IMathElement) | Xác định căn bậc toán học của độ bậc cho trước từ đối số đã chỉ định. |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(string) | Xác định căn bậc toán học của độ bậc cho trước từ đối số đã chỉ định. |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Đặt phần tử này vào một hộp không hiển thị (nhóm logic) được dùng để nhóm các thành phần của một phương trình hoặc các đoạn văn bản toán học khác. Một đối tượng được đóng khung có thể (ví dụ) đóng vai trò mô phỏng toán tử có hoặc không có điểm căn chỉnh, đóng vai trò điểm ngắt dòng, hoặc được nhóm sao cho không cho phép ngắt dòng bên trong. |
