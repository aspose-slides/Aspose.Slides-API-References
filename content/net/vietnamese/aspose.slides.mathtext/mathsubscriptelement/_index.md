...
description: Xác định đối tượng chỉ số dưới, gồm một cơ sở và một chỉ số dưới kích thước giảm đặt phía dưới và bên phải.
type: docs
weight: 9000
...
| Tên | Mô tả |
| --- | --- |
| [Accent](../../aspose.slides.mathtext/mathelementbase/accent)(char) | Đặt dấu thanh (một ký tự ở trên cùng của phần tử này) |
...
| [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)() | Bao quanh một phần tử toán bằng dấu ngoặc đơn |
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | Bao quanh một phần tử toán bằng các ký tự được chỉ định như dấu ngoặc hoặc các ký tự khác làm khung |
...
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(IMathElement) | Xác định căn bậc của biểu thức toán học từ đối số đã cho |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(string) | Xác định căn bậc của biểu thức toán học từ đối số đã cho |
