...
description: Xác định đối tượng Sub-Superscript bao gồm một cơ sở và các chỉ số dưới và trên được đặt phía trái của cơ sở.
type: docs
weight: 8810
...
Xác định đối tượng Sub-Superscript, bao gồm một cơ sở và các chỉ số dưới và trên được đặt phía trái của cơ sở.
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | Đặt phần tử này vào một hộp phi trực quan (nhóm logic) được sử dụng để nhóm các thành phần của phương trình hoặc các đoạn văn bản toán học khác. Một đối tượng được bao bì có thể (ví dụ) đóng vai trò như một mô phỏng toán tử có hoặc không có điểm căn chỉnh, đóng vai trò là điểm ngắt dòng, hoặc được nhóm sao cho không cho phép ngắt dòng bên trong |
| virtual [ToMathArray](../../aspose.slides.mathtext/mathelementbase/tomatharray)() | Đặt vào một mảng dọc |
| [Underbar](../../aspose.slides.mathtext/mathelementbase/underbar)() | Đặt một thanh ngang ở phía dưới của phần tử này |
