...
Biểu thị một đối tượng mực trên một slide.
...
| [BlackWhiteMode](../../aspose.slides/shape/blackwhitemode) { get; set; } | Thuộc tính chỉ định cách một hình dạng sẽ hiển thị trong chế độ đen-trắng. Đọc/ghi [`BlackWhiteMode`](../../aspose.slides/blackwhitemode). |
...
| [Frame](../../aspose.slides/shape/frame) { get; set; } | Trả về hoặc thiết lập các thuộc tính khung của hình dạng. Đọc/ghi [`IShapeFrame`](../../aspose.slides/ishapeframe). |
...
| [Hidden](../../aspose.slides/shape/hidden) { get; set; } | Xác định hình dạng có bị ẩn hay không. Đọc/ghi Boolean. |
| [HyperlinkClick](../../aspose.slides/shape/hyperlinkclick) { get; set; } | Trả về hoặc thiết lập siêu liên kết được định nghĩa cho nhấp chuột. Đọc/ghi [`IHyperlink`](../../aspose.slides/ihyperlink). |
...
| [HyperlinkMouseOver](../../aspose.slides/shape/hyperlinkmouseover) { get; set; } | Trả về hoặc thiết lập siêu liên kết được định nghĩa cho di chuột qua. Đọc/ghi [`IHyperlink`](../../aspose.slides/ihyperlink). |
| [IsDecorative](../../aspose.slides/shape/isdecorative) { get; set; } | Lấy hoặc thiết lập tùy chọn 'Mark as decorative'. Đọc/ghi Boolean. |
| [IsGrouped](../../aspose.slides/shape/isgrouped) { get; } | Xác định hình dạng có được nhóm hay không. Chỉ đọc Boolean. |
| [IsTextHolder](../../aspose.slides/shape/istextholder) { get; } | Xác định hình dạng có phải là TextHolder_PPT hay không. Chỉ đọc Boolean. |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Trả về một định danh duy nhất trong phạm vi slide, không đổi trong suốt vòng đời của hình dạng và cho phép PowerPoint hoặc mã interop tham chiếu hình dạng một cách đáng tin cậy từ bất kỳ nơi nào trong tài liệu. Chỉ đọc UInt32. Xem thêm [`UniqueId`](../../aspose.slides/shape/uniqueid). |
...
| [RawFrame](../../aspose.slides/shape/rawframe) { get; set; } | Trả về hoặc thiết lập các thuộc tính khung thô của hình dạng. Đọc/ghi [`IShapeFrame`](../../aspose.slides/ishapeframe). |
...
| [ShapeLock](../../aspose.slides/graphicalobject/shapelock) { get; } | Trả về các khóa của hình dạng. Chỉ đọc [`IGraphicalObjectLock`](../../aspose.slides/igraphicalobjectlock). (2 properties) |
...
| [Traces](../../aspose.slides.ink/ink/traces) { get; } | Lấy tất cả các dấu vết trong phần tử IInk [`IInkTrace`](../iinktrace). Chỉ đọc. |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Trả về một định danh nội bộ trong phạm vi bản trình bày, được dùng cho add-in hoặc mã khác. Vì giá trị này có thể được người dùng hoặc chương trình thay đổi, không được coi là khóa duy nhất cố định. Chỉ đọc UInt32. Xem thêm [`OfficeInteropShapeId`](../../aspose.slides/shape/officeinteropshapeid). |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Trả về vị trí của một hình dạng trong thứ tự z. Shapes[0] trả về hình ở phía sau nhất, và Shapes[Shapes.Count - 1] trả về hình ở phía trước nhất. Chỉ đọc Int32. |
| static [InkEffectImages](../../aspose.slides.ink/ink/inkeffectimages) { get; } | Lấy bộ sưu tập các hình ảnh tùy chỉnh dùng để mô phỏng hiệu ứng hình ảnh cho bút mực. Các hình ảnh này được dùng khi render mực với các giá trị [`InkEffectType`](../inkeffecttype) cụ thể, như Galaxy, Rainbow, v.v. Bằng cách cung cấp hình ảnh của riêng bạn, bạn có thể kiểm soát cách mỗi hiệu ứng mực xuất hiện. |

## Phương thức

| Tên | Mô tả |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | Thêm một placeholder mới nếu không có và thiết lập các thuộc tính placeholder thành một placeholder đã chỉ định. |
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Trả về một hình placeholder cơ bản (hình từ bố cục và/hoặc slide mẫu mà hình hiện tại kế thừa). Nếu hình hiện tại không kế thừa, trả về null. |
