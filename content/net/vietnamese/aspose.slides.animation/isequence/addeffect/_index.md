...
type: docs
weight: 50
url: /vi/aspose.slides.animation/isequence/addeffect/
---
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| shape | IShape | Đối tượng Shape [`IShape`](../../../aspose.slides/ishape) để thêm hiệu ứng |
| effectType | EffectType | Loại của hiệu ứng hoạt hình [`EffectType`](../../effecttype) |
| subtype | EffectSubtype | Các tiểu loại của hiệu ứng hoạt hình [`EffectSubtype`](../../effectsubtype) |
...
{        
   ...
   // thêm hiệu ứng Fly vào đoạn văn đã chọn
...
| type | EffectChartMajorGroupingType | Loại của hiệu ứng hoạt hình [`EffectChartMinorGroupingType`](../../effectchartminorgroupingtype) |
...
| --- | --- | --- |
| chart | IChart | Đối tượng Chart [`IChart`](../../../aspose.slides.charts/ichart) |
| type | EffectChartMinorGroupingType | Loại của hiệu ứng hoạt hình [`EffectChartMinorGroupingType`](../../effectchartminorgroupingtype) |
