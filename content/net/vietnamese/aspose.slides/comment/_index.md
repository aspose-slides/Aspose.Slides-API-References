...
description: Biểu diễn một bình luận trên một slide.
type: docs
weight: 2620
...
Biểu diễn một bình luận trên một slide.
...
| [Text](../../aspose.slides/comment/text) { get; set; } | Trả về hoặc đặt văn bản thuần của bình luận slide. Đọc/ghi String. |
...
Ví dụ này cho bạn thấy cách thêm bình luận vào slide trong một bản trình chiếu PowerPoint.
...
Ví dụ này cho bạn thấy cách truy cập bình luận hiện có trên slide trong một bản trình chiếu PowerPoint.
...
Ví dụ này cho bạn thấy cách thêm bình luận và nhận phản hồi cho chúng.
...
using (Presentation pres = new Presentation())
{
    ...
    // Hiển thị cây phân cấp bình luận trên console
