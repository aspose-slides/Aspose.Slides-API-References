...
description: Các hằng số định nghĩa kiểu cài đặt máy ảnh.
type: docs
weight: 1100
url: /vi/aspose.slides/camerapresettype/
---
## CameraPresetType liệt kê

Các hằng số xác định kiểu cài đặt máy ảnh.
