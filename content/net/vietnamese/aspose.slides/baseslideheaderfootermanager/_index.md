...
description: Đại diện cho trình quản lý giữ hành vi của các trình giữ chỗ chân trang, ngày-giờ và số trang cho tất cả các loại slide.
type: docs
weight: 1000
url: /vi/aspose.slides/baseslideheaderfootermanager/
---
## Lớp BaseSlideHeaderFooterManager

Đại diện cho trình quản lý giữ hành vi của các trình giữ chỗ chân trang, ngày-giờ và số trang cho tất cả các loại slide.
