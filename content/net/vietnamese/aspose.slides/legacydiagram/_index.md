...
description: Biểu diễn một đối tượng biểu đồ legacy.
type: docs
weight: 7670
...
Biểu diễn một đối tượng biểu đồ legacy.
...
| [AsIGraphicalObject](../../aspose.slides/legacydiagram/asigraphicalobject) { get; } | Cho phép lấy giao diện IGraphicalObject cơ bản. Chỉ đọc [`IGraphicalObject`](../igraphicalobject). |
...
| [Hidden](../../aspose.slides/shape/hidden) { get; set; } | Xác định liệu hình dạng có ẩn hay không. Đọc/ghi Boolean. |
...
| [Name](../../aspose.slides/shape/name) { get; set; } | Trả về hoặc đặt tên của một hình dạng. Không được để null. Sử dụng giá trị chuỗi rỗng nếu cần. Đọc/ghi String. |
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Trả về định danh duy nhất trong phạm vi slide, luôn cố định suốt vòng đời của hình dạng và cho phép PowerPoint hoặc mã interop tham chiếu hình dạng một cách đáng tin cậy từ bất kỳ vị trí nào trong tài liệu. Chỉ đọc UInt32. Xem thêm [`UniqueId`](../shape/uniqueid). |
...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Trả về một định danh nội bộ, trong phạm vi bài thuyết trình, dự định dùng cho add-in hoặc mã khác. Vì giá trị này có thể được người dùng hoặc chương trình gán lại, nó không được coi là khóa duy nhất cố định. Chỉ đọc UInt32. Xem thêm [`OfficeInteropShapeId`](../shape/officeinteropshapeid). |
...
| [ConvertToGroupShape](../../aspose.slides/legacydiagram/converttogroupshape)() | Chuyển đổi legacy diagram thành group shape có thể chỉnh sửa. Đối tượng GroupShape được tạo sẽ được thêm vào group shape cha ở cùng vị trí. |
| [ConvertToSmartArt](../../aspose.slides/legacydiagram/converttosmartart)() | Chuyển đổi legacy diagram thành đối tượng SmartArt có thể chỉnh sửa. Đối tượng SmartArt được tạo sẽ được thêm vào group shape cha ở cùng vị trí. |
...
| [GetVisualBounds](../../aspose.slides/shape/getvisualbounds)() | Lấy giới hạn hiển thị của shape tính từ nội dung đã render. |
