...
description: Đại diện cho các kiểu bảng tích hợp sẵn.
type: docs
weight: 10880
url: /vi/aspose.slides/tablestylepreset/
---
## TableStylePreset định danh

Đại diện cho các kiểu bảng tích hợp sẵn.
...
| Tên | Giá trị | Mô tả |
| --- | --- | --- |
| Custom | `-1` | Bảng có kiểu tùy chỉnh. Đây là giá trị chỉ trả về. |
| None | `0` | Không có kiểu. |
| MediumStyle2Accent1 | `1` | Medium Style 2 - Accent 1. |
| MediumStyle2 | `2` | Medium Style 2. |
| NoStyleNoGrid | `3` | Không có kiểu, không có lưới. |
...
| NoStyleTableGrid | `10` | Không có kiểu, bảng có lưới. |
