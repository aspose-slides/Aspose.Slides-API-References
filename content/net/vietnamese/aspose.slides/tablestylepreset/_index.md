...
description: Biểu diễn các kiểu bảng tích hợp sẵn.
type: docs
weight: 10880
url: /vi/aspose.slides/tablestylepreset/
---
## TableStylePreset liệt kê

Biểu diễn các kiểu bảng tích hợp sẵn.
...
| Tên | Giá trị | Mô tả |
| --- | --- | --- |
| Custom | `-1` | Bảng có kiểu tùy chỉnh. Đây là giá trị chỉ đọc trả về. |
...
| NoStyleTableGrid | `10` | Không có kiểu, lưới bảng. |
