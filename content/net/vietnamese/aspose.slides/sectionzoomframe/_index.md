...
description: Biểu thị một đối tượng Section Zoom trong một slide.
type: docs
weight: 9780
...
| [ImageType](../../aspose.slides/zoomobject/imagetype) { get; set; } | Lấy hoặc đặt loại hình ảnh của một đối tượng zoom. Đọc/ghi [`ZoomImageType`](../zoomimagetype). Giá trị mặc định: Preview |
...
| [ShowBackground](../../aspose.slides/zoomobject/showbackground) { get; set; } | Lấy hoặc đặt giá trị chỉ định xem Zoom có sử dụng nền của slide đích hay không. Đọc/ghi Boolean. Giá trị mặc định: true |
...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Trả về một định danh nội bộ, có phạm vi bản trình chiếu, dự định cho các add-in hoặc mã khác. Vì giá trị này có thể được người dùng hoặc chương trình gán lại, nó không được coi là khóa duy nhất cố định. Chỉ đọc UInt32. Xem thêm [`OfficeInteropShapeId`](../shape/officeinteropshapeid). |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | Trả về vị trí của một hình dạng trong thứ tự z. Shapes[0] trả về hình dạng ở phía sau trong thứ tự z, và Shapes[Shapes.Count - 1] trả về hình dạng ở phía trước trong thứ tự z. Chỉ đọc Int32. |

## Phương thức

| Tên | Mô tả |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | Thêm một trình giữ chỗ mới nếu không có và đặt các thuộc tính trình giữ chỗ thành một trình giữ chỗ được chỉ định. |
