...
| virtual [EffectFormat](../../aspose.slides/shape/effectformat) { get; } | Trả về đối tượng EffectFormat chứa các hiệu ứng pixel được áp dụng cho shape. Lưu ý: có thể trả về null cho một số loại shape không có thuộc tính effect. Chỉ-đọc [`IEffectFormat`](../ieffectformat). |
| virtual [FillFormat](../../aspose.slides/shape/fillformat) { get; } | Trả về đối tượng FillFormat chứa các thuộc tính định dạng tô màu cho shape. Lưu ý: có thể trả về null cho một số loại shape không có thuộc tính fill. Chỉ-đọc [`IFillFormat`](../ifillformat). |
...
| [Hidden](../../aspose.slides/shape/hidden) { get; set; } | Xác định liệu shape có được ẩn hay không. Đọc/ghi Boolean. |
| [HyperlinkClick](../../aspose.slides/shape/hyperlinkclick) { get; set; } | Trả về hoặc đặt siêu liên kết được định nghĩa cho thao tác nhấp chuột. Đọc/ghi [`IHyperlink`](../ihyperlink). |
...
| [HyperlinkMouseOver](../../aspose.slides/shape/hyperlinkmouseover) { get; set; } | Trả về hoặc đặt siêu liên kết được định nghĩa cho di chuột lên. Đọc/ghi [`IHyperlink`](../ihyperlink). |
| [ImageType](../../aspose.slides/zoomobject/imagetype) { get; set; } | Lấy hoặc đặt kiểu ảnh của đối tượng zoom. Đọc/ghi [`ZoomImageType`](../zoomimagetype). Giá trị mặc định: Preview |
...
| virtual [LineFormat](../../aspose.slides/shape/lineformat) { get; } | Trả về đối tượng LineFormat chứa các thuộc tính định dạng đường cho shape. Lưu ý: có thể trả về null cho một số loại shape không có thuộc tính line. Chỉ-đọc [`ILineFormat`](../ilineformat). |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Trả về một định danh duy nhất phạm vi slide, không thay đổi trong suốt vòng đời của shape và cho phép PowerPoint hoặc mã interop tham chiếu shape một cách đáng tin cậy từ bất kỳ nơi nào trong tài liệu. Chỉ-đọc UInt32. Xem thêm [`UniqueId`](../shape/uniqueid). |
...
| [ShowBackground](../../aspose.slides/zoomobject/showbackground) { get; set; } | Lấy hoặc đặt giá trị chỉ định liệu Zoom sẽ sử dụng nền của slide đích hay không. Đọc/ghi Boolean. Giá trị mặc định: true |
| [Slide](../../aspose.slides/shape/slide) { get; } | Trả về slide cha của shape. Chỉ-đọc [`IBaseSlide`](../ibaseslide). |
| [TargetSlide](../../aspose.slides/zoomframe/targetslide) { get; set; } | Lấy hoặc đặt đối tượng slide mà đối tượng Slide Zoom liên kết tới. Đọc/ghi [`ISlide`](../islide). |
...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Trả về một định danh nội bộ, phạm vi presentation, dành cho add-in hoặc mã khác. Vì giá trị này có thể được người dùng hoặc chương trình gán lại, không nên coi là khóa duy nhất lâu dài. Chỉ-đọc UInt32. Xem thêm [`OfficeInteropShapeId`](../shape/officeinteropshapeid). |
