...
| [Direction](../../aspose.slides.animation/coloreffect/direction) { get; set; } | Especifica en qué dirección ciclar el tono alrededor de la rueda de color. Lectura/escritura [`ColorDirection`](../colordirection). |
| [From](../../aspose.slides.animation/coloreffect/from) { get; set; } | Este valor se utiliza para especificar el color inicial del comportamiento. Lectura/escritura [`IColorFormat`](../../aspose.slides/icolorformat). |
