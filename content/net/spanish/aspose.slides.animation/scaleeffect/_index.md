...
| Nombre | Descripción |
| --- | --- |
| [ScaleEffect](scaleeffect)() | El constructor por defecto. |
...
| [From](../../aspose.slides.animation/scaleeffect/from) { get; set; } | Especifica una coordenada x/y desde la cual comenzar la animación (en porcentajes). Lectura/escritura PointF. |
