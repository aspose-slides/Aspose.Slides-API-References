...
description: Define un tipo de texto animado para el efecto. El texto de la forma se puede animar letra por letra, palabra por palabra o todo a la vez. Leer/escribir AnimateTextTypeaspose.slides.animation/effect/animatetexttype.
type: docs
weight: 30
...
Define un tipo de texto animado para el efecto. El texto de la forma se puede animar letra por letra, palabra por palabra o todo a la vez. Leer/escribir `AnimateTextType`.
