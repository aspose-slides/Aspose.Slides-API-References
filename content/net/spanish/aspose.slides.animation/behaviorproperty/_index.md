...
| static [ExtrusionOrientationX](../../aspose.slides.animation/behaviorproperty/extrusionorientationx) { get; } | Representa la propiedad 'extrusion.orientation.x' |
| static [ExtrusionOrientationY](../../aspose.slides.animation/behaviorproperty/extrusionorientationy) { get; } | Representa la propiedad 'extrusion.orientation.y' |
| static [ExtrusionOrientationZ](../../aspose.slides.animation/behaviorproperty/extrusionorientationz) { get; } | Representa la propiedad 'extrusion.orientation.z' |
| static [ExtrusionPlane](../../aspose.slides.animation/behaviorproperty/extrusionplane) { get; } | Representa la propiedad 'extrusion.plane' |
| static [ExtrusionRender](../../aspose.slides.animation/behaviorproperty/extrusionrender) { get; } | Representa la propiedad 'extrusion.render' |
| static [ExtrusionRotationAngleX](../../aspose.slides.animation/behaviorproperty/extrusionrotationanglex) { get; } | Representa la propiedad 'extrusion.rotationangle.x' |
| static [ExtrusionRotationAngleY](../../aspose.slides.animation/behaviorproperty/extrusionrotationangley) { get; } | Representa la propiedad 'extrusion.rotationangle.y' |
| static [ExtrusionRotationCenterX](../../aspose.slides.animation/behaviorproperty/extrusionrotationcenterx) { get; } | Representa la propiedad 'extrusion.rotationcenter.x' |
| static [ExtrusionRotationCenterY](../../aspose.slides.animation/behaviorproperty/extrusionrotationcentery) { get; } | Representa la propiedad 'extrusion.rotationcenter.y' |
| static [ExtrusionRotationCenterZ](../../aspose.slides.animation/behaviorproperty/extrusionrotationcenterz) { get; } | Representa la propiedad 'extrusion.rotationcenter.z' |
| static [ExtrusionSkewAmt](../../aspose.slides.animation/behaviorproperty/extrusionskewamt) { get; } | Representa la propiedad 'extrusion.skewamt' |
| static [ExtrusionSkewAngle](../../aspose.slides.animation/behaviorproperty/extrusionskewangle) { get; } | Representa la propiedad 'extrusion.skewangle' |
| static [ExtrusionType](../../aspose.slides.animation/behaviorproperty/extrusiontype) { get; } | Representa la propiedad 'extrusion.type' |
| static [ExtrusionViewPointOriginX](../../aspose.slides.animation/behaviorproperty/extrusionviewpointoriginx) { get; } | Representa la propiedad 'extrusion.viewpointorigin.x' |
| static [ExtrusionViewPointOriginY](../../aspose.slides.animation/behaviorproperty/extrusionviewpointoriginy) { get; } | Representa la propiedad 'extrusion.viewpointorigin.y' |
| static [ExtrusionViewPointX](../../aspose.slides.animation/behaviorproperty/extrusionviewpointx) { get; } | Representa la propiedad 'extrusion.viewpoint.x' |
...
| static [FillFocusPositionY](../../aspose.slides.animation/behaviorproperty/fillfocuspositiony) { get; } | Representa la propiedad 'fill.focusposition.y' |
| static [FillFocusSizeX](../../aspose.slides.animation/behaviorproperty/fillfocussizex) { get; } | Representa la propiedad 'fill.focussize.x' |
| static [FillFocusSizeY](../../aspose.slides.animation/behaviorproperty/fillfocussizey) { get; } | Representa la propiedad 'fill.focussize.y' |
| static [FillMethod](../../aspose.slides.animation/behaviorproperty/fillmethod) { get; } | Representa la propiedad 'fill.method' |
| static [FillOn](../../aspose.slides.animation/behaviorproperty/fillon) { get; } | Representa la propiedad 'fill.on' |
| static [FillOpacity](../../aspose.slides.animation/behaviorproperty/fillopacity) { get; } | Representa la propiedad 'fill.opacity' |
...
| static [ImageDataCropLeft](../../aspose.slides.animation/behaviorproperty/imagedatacropleft) { get; } | Representa la propiedad 'imageData.cropLeft' |
| static [ImageDataCropRight](../../aspose.slides.animation/behaviorproperty/imagedatacropright) { get; } | Representa la propiedad 'imageData.cropRight' |
| static [ImageDataCropTop](../../aspose.slides.animation/behaviorproperty/imagedatacroptop) { get; } | Representa la propiedad 'imageData.cropTop' |
| static [ImageDataGain](../../aspose.slides.animation/behaviorproperty/imagedatagain) { get; } | Representa la propiedad 'imageData.gain' |
| static [ImageDataGamma](../../aspose.slides.animation/behaviorproperty/imagedatagamma) { get; } | Representa la propiedad 'imageData.gamma' |
| static [ImageDataGrayscale](../../aspose.slides.animation/behaviorproperty/imagedatagrayscale) { get; } | Representa la propiedad 'imageData.grayscale' |
| static [PptC](../../aspose.slides.animation/behaviorproperty/pptc) { get; } | Representa la propiedad 'ppt_c' |
| static [PptH](../../aspose.slides.animation/behaviorproperty/ppth) { get; } | Representa la propiedad 'ppt_h' |
| static [PptR](../../aspose.slides.animation/behaviorproperty/pptr) { get; } | Representa la propiedad 'ppt_r' |
| static [PptW](../../aspose.slides.animation/behaviorproperty/pptw) { get; } | Representa la propiedad 'ppt_w' |
| static [PptX](../../aspose.slides.animation/behaviorproperty/pptx) { get; } | Representa la propiedad 'ppt_x' |
| static [PptY](../../aspose.slides.animation/behaviorproperty/ppty) { get; } | Representa la propiedad 'ppt_y' |
| static [R](../../aspose.slides.animation/behaviorproperty/r) { get; } | Representa la propiedad 'r' |
...
| static [ShadowMatrixXtoY](../../aspose.slides.animation/behaviorproperty/shadowmatrixxtoy) { get; } | Representa la propiedad 'shadow.matrix.xtoy' |
| static [ShadowMatrixYtoX](../../aspose.slides.animation/behaviorproperty/shadowmatrixytox) { get; } | Representa la propiedad 'shadow.matrix.ytox' |
| static [ShadowMatrixYtoY](../../aspose.slides.animation/behaviorproperty/shadowmatrixytoy) { get; } | Representa la propiedad 'shadow.matrix.ytoy' |
| static [ShadowOffset2X](../../aspose.slides.animation/behaviorproperty/shadowoffset2x) { get; } | Representa la propiedad 'shadow.offset2.x' |
| static [ShadowOffset2Y](../../aspose.slides.animation/behaviorproperty/shadowoffset2y) { get; } | Representa la propiedad 'shadow.offset2.y' |
| static [ShadowOffsetX](../../aspose.slides.animation/behaviorproperty/shadowoffsetx) { get; } | Representa la propiedad 'shadow.offset.x' |
| static [ShadowOffsetY](../../aspose.slides.animation/behaviorproperty/shadowoffsety) { get; } | Representa la propiedad 'shadow.offset.y' |
| static [ShadowOn](../../aspose.slides.animation/behaviorproperty/shadowon) { get; } | Representa la propiedad 'shadow.on' |
| static [ShadowOpacity](../../aspose.slides.animation/behaviorproperty/shadowopacity) { get; } | Representa la propiedad 'shadow.opacity' |
| static [ShadowOriginX](../../aspose.slides.animation/behaviorproperty/shadoworiginx) { get; } | Representa la propiedad 'shadow.origin.x' |
...
| static [SkewMatrixYtoY](../../aspose.slides.animation/behaviorproperty/skewmatrixytoy) { get; } | Representa la propiedad 'skew.matrix.ytoy' |
| static [SkewOffsetX](../../aspose.slides.animation/behaviorproperty/skewoffsetx) { get; } | Representa la propiedad 'skew.offset.x' |
| static [SkewOffsetY](../../aspose.slides.animation/behaviorproperty/skewoffsety) { get; } | Representa la propiedad 'skew.offset.y' |
| static [SkewOn](../../aspose.slides.animation/behaviorproperty/skewon) { get; } | Representa la propiedad 'skew.on' |
...
| static [StrokeEndArrowWidth](../../aspose.slides.animation/behaviorproperty/strokeendarrowwidth) { get; } | Representa la propiedad 'stroke.endArrowWidth' |
| static [StrokeFillType](../../aspose.slides.animation/behaviorproperty/strokefilltype) { get; } | Representa la propiedad 'stroke.filltype' |
| static [StrokeImageSizeX](../../aspose.slides.animation/behaviorproperty/strokeimagesizex) { get; } | Representa la propiedad 'stroke.imagesize.x' |
| static [StrokeImageSizeY](../../aspose.slides.animation/behaviorproperty/strokeimagesizey) { get; } | Representa la propiedad 'stroke.imagesize.y' |
| static [StrokeLineStyle](../../aspose.slides.animation/behaviorproperty/strokelinestyle) { get; } | Representa la propiedad 'stroke.linestyle' |
| static [StrokeOn](../../aspose.slides.animation/behaviorproperty/strokeon) { get; } | Representa la propiedad 'stroke.on' |
| static [StrokeOpacity](../../aspose.slides.animation/behaviorproperty/strokeopacity) { get; } | Representa la propiedad 'stroke.opacity' |
| static [StrokeSrc](../../aspose.slides.animation/behaviorproperty/strokesrc) { get; } | Representa la propiedad 'stroke.src' |
| static [StrokeStartArrow](../../aspose.slides.animation/behaviorproperty/strokestartarrow) { get; } | Representa la propiedad 'stroke.startArrow' |
...
| static [StyleSRotation](../../aspose.slides.animation/behaviorproperty/stylesrotation) { get; } | Representa la propiedad 'style.sRotation' |
| static [StyleTextDecorationLineThrough](../../aspose.slides.animation/behaviorproperty/styletextdecorationlinethrough) { get; } | Representa la propiedad 'style.textDecorationLineThrough' |
| static [StyleTextDecorationUnderline](../../aspose.slides.animation/behaviorproperty/styletextdecorationunderline) { get; } | Representa la propiedad 'style.textDecorationUnderline' |
| static [StyleTextEffectEmboss](../../aspose.slides.animation/behaviorproperty/styletexteffectemboss) { get; } | Representa la propiedad 'style.textEffectEmboss' |
...
| Nombre | Descripción |
| --- | --- |
| static [GetOrCreateByValue](../../aspose.slides.animation/behaviorproperty/getorcreatebyvalue)(string) | Busca una propiedad de comportamiento existente por valor o crea una nueva personalizada con el valor especificado |
| override [Equals](../../aspose.slides.animation/behaviorproperty/equals)(object) | Comprueba si este objeto es igual a otro. |
| override [GetHashCode](../../aspose.slides.animation/behaviorproperty/gethashcode)() | Calcula y devuelve el código hash basado en la propiedad [`Value`](./value) |
