...
| [PropertyEffect](./propertyeffect) | Representa el comportamiento del efecto de propiedad. |
...
| [Sequence](./sequence) | Representa una secuencia (colección de efectos). |
| [SequenceCollection](./sequencecollection) | Representa una colección de secuencias interactivas. |
| [SetEffect](./seteffect) | Representa un efecto de conjunto para un comportamiento de animación. |
| [TextAnimation](./textanimation) | Representa la animación de texto. |
| [TextAnimationCollection](./textanimationcollection) | Representa una colección de animaciones de texto. |
| [Timing](./timing) | Representa la temporización de la animación. |
...
| [ISequence](./isequence) | Representa una secuencia (colección de efectos). |
| [ISequenceCollection](./isequencecollection) | Representa una colección de secuencias interactivas. |
| [ISetEffect](./iseteffect) | Representa un efecto de conjunto para un comportamiento de animación. |
| [ITextAnimation](./itextanimation) | Representa la animación de texto. |
| [ITextAnimationCollection](./itextanimationcollection) | Representa una colección de animaciones de texto. |
| [ITiming](./itiming) | Representa la temporización de la animación. |
