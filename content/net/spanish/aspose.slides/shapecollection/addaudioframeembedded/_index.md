...
description: Agrega un nuevo marco de audio con un archivo de audio incrustado al final de una colección. El archivo de audio incrustado solo puede ser un WAV. Agrega un nuevo audio a la lista Presentation.Audios.
type: docs
weight: 70
...
Agrega un nuevo marco de audio con un archivo de audio incrustado al final de una colección. El archivo de audio incrustado solo puede ser un WAV. Agrega un nuevo audio a la lista Presentation.Audios.
...
| width | Single | Anchura de un nuevo marco de audio. |
...
Agrega un nuevo marco de audio con un archivo de audio incrustado al final de una colección. Utiliza un archivo de audio de la lista Presentation.Audios.
