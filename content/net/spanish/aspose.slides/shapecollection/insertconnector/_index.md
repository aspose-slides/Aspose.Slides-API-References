...
| width | Single | El ancho del marco de la forma. |
| height | Single | La altura del marco de la forma. |
| createFromTemplate | Boolean | Si es verdadero, la nueva forma se ajustará a partir de la plantilla predeterminada. Se asignará un nombre no vacío, estilo simple y texto centrado a la nueva forma. Si es falso, todos los valores de las propiedades de la nueva forma tendrán valores predeterminados. |
