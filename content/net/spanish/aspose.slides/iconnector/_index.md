...
| [ConnectorLock](../../aspose.slides/iconnector/connectorlock) { get; } | Devuelve los bloqueos del Connector. Solo lectura [`IConnectorLock`](../iconnectorlock). |
...
| Nombre | Descripción |
| --- | --- |
| [Reroute](../../aspose.slides/iconnector/reroute)() | Redirige el conector para que tome la ruta más corta posible entre las formas que conecta. |
