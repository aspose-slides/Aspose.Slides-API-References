...
| [BlackWhiteMode](../../aspose.slides/shape/blackwhitemode) { get; set; } | Propiedad que especifica cómo se representará una forma en modo de visualización en blanco y negro. Lectura/escritura [`BlackWhiteMode`](../blackwhitemode). |
...
| [TargetSlide](../../aspose.slides/zoomframe/targetslide) { get; set; } | Obtiene o establece el objeto diapositiva al que enlaza el objeto Slide Zoom. Lectura/escritura [`ISlide`](../islide). |
