...
| [Name](../../aspose.slides/shape/name) { get; set; } | Devuelve o establece el nombre de una forma. No debe ser null. Utilice un valor de cadena vacía si es necesario. Lectura/escritura String. |
...
| [TargetSlide](../../aspose.slides/zoomframe/targetslide) { get; set; } | Obtiene o establece el objeto de diapositiva al que el objeto de Zoom de diapositiva está vinculado. Lectura/escritura [`ISlide`](../islide). |
