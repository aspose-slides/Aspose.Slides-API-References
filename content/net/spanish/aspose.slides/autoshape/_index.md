...
| virtual [FillFormat](../../aspose.slides/shape/fillformat) { get; } | Devuelve el objeto FillFormat que contiene las propiedades de formato de relleno de una forma. Nota: puede devolver null para ciertos tipos de formas que no tienen propiedades de relleno. Solo lectura [`IFillFormat`](../ifillformat). |
...
| virtual [LineFormat](../../aspose.slides/shape/lineformat) { get; } | Devuelve el objeto LineFormat que contiene las propiedades de formato de línea de una forma. Nota: puede devolver null para ciertos tipos de formas que no tienen propiedades de línea. Solo lectura [`ILineFormat`](../ilineformat). |
...
| [UseBackgroundFill](../../aspose.slides/autoshape/usebackgroundfill) { get; set; } | Determina si este autoshape debería ser rellenado con el relleno de fondo de la diapositiva en lugar del especificado por el estilo o formato de relleno. Lectura/escritura Boolean. |
...
| Nombre | Descripción |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | Agrega un nuevo marcador de posición si no hay uno y establece las propiedades del marcador de posición en uno especificado. |
| [AddTextFrame](../../aspose.slides/autoshape/addtextframe)(string) | Agrega un nuevo TextFrame a una forma. Si la forma ya tiene TextFrame, simplemente cambia su texto. |
