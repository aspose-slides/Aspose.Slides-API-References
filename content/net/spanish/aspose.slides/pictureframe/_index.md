...
| Nombre | Descripción |
| --- | --- |
| [Adjustments](../../aspose.slides/geometryshape/adjustments) { get; } | Devuelve una colección de los valores de ajuste de la forma. Solo lectura [`IAdjustValueCollection`](../iadjustvaluecollection). |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Obtiene el identificador único de la forma en el ámbito de la diapositiva. Solo lectura UInt32. Consulte también [`UniqueId`](../shape/uniqueid) para obtener identificador único de la forma en el ámbito de la presentación. |
...
| [RelativeScaleHeight](../../aspose.slides/pictureframe/relativescaleheight) { get; set; } | Devuelve o establece la escala de la altura (relativa al tamaño original de la imagen) del marco de imagen. El valor 1.0 corresponde al 100%. Lectura/escritura Single. |
...
| override [ShapeType](../../aspose.slides/pictureframe/shapetype) { get; set; } | Devuelve o establece el tipo de AutoShape para un PictureFrame. Hay permitidos todos los elementos del conjunto [`ShapeType`](../shapetype), excepto todo tipo de líneas: |
...
| [CreateShapeElements](../../aspose.slides/geometryshape/createshapeelements)() | Crea y devuelve un array de los elementos de la forma. |
...
| [GetImage](../../aspose.slides/shape/getimage)() | Devuelve la miniatura de la forma. ShapeThumbnailBounds.Shape tipo de límites de miniatura de la forma se usa por defecto. |
...
| [WriteAsSvg](../../aspose.slides/shape/writeassvg)(Stream) | Guarda el contenido de Shape como un archivo SVG. |
| [WriteAsSvg](../../aspose.slides/shape/writeassvg)(Stream, ISVGOptions) | Guarda el contenido de Shape como un archivo SVG. |
