...
description: Agrega una nueva forma de marcador de posición a la diapositiva de diseño para contener contenido como una imagen, tabla, medios o texto en una dirección vertical.
type: docs
weight: 90
url: /es/aspose.slides/layoutplaceholdermanager/addverticalcontentplaceholder/
---

## Método LayoutPlaceholderManager.AddVerticalContentPlaceholder

Agrega una nueva forma de marcador de posición a la diapositiva de diseño para contener contenido, como una imagen, tabla, medios o texto en una dirección vertical.
