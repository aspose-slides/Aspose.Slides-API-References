...
description: Agrega una nueva forma de marcador de posición a la diapositiva de diseño para contener contenido como una imagen, tabla, medio o texto en dirección vertical.
type: docs
weight: 90
url: /es/aspose.slides/layoutplaceholdermanager/addverticalcontentplaceholder/
---

## LayoutPlaceholderManager.AddVerticalContentPlaceholder método
...
[`IAutoShape`](../../iautoshape) creado con un marcador de posición de Contenido (Vertical).
