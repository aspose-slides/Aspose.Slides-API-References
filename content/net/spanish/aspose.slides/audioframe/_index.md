...
| [AlternativeText](../../aspose.slides/shape/alternativetext) { get; set; } | Devuelve o establece el texto alternativo asociado a una forma. Lectura y escritura String. |
| [AlternativeTextTitle](../../aspose.slides/shape/alternativetexttitle) { get; set; } | Devuelve o establece el título del texto alternativo asociado a una forma. Lectura y escritura String. |
| [AudioCdEndTrack](../../aspose.slides/audioframe/audiocdendtrack) { get; set; } | Devuelve o establece un índice de la última pista. Lectura y escritura Int32. |
| [AudioCdEndTrackTime](../../aspose.slides/audioframe/audiocdendtracktime) { get; set; } | Devuelve o establece el tiempo de la última pista. Lectura y escritura Int32. |
| [AudioCdStartTrack](../../aspose.slides/audioframe/audiocdstarttrack) { get; set; } | Devuelve o establece un índice de la pista de inicio. Lectura y escritura Int32. |
| [AudioCdStartTrackTime](../../aspose.slides/audioframe/audiocdstarttracktime) { get; set; } | Devuelve o establece un tiempo de la pista de inicio. Lectura y escritura Int32. |
| [BlackWhiteMode](../../aspose.slides/shape/blackwhitemode) { get; set; } | La propiedad especifica cómo se renderizará una forma en modo de visualización en blanco y negro. Lectura y escritura [`BlackWhiteMode`](../blackwhitemode). |
...
| [Embedded](../../aspose.slides/audioframe/embedded) { get; } | Determina si un sonido está embebido en una presentación. Solo lectura Boolean. |
| [EmbeddedAudio](../../aspose.slides/audioframe/embeddedaudio) { get; set; } | Devuelve o establece el objeto de audio embebido. Lectura y escritura [`IAudio`](../iaudio). |
| [FadeInDuration](../../aspose.slides/audioframe/fadeinduration) { get; set; } | Especifica la duración del desvanecimiento inicial del medio en milisegundos. Lectura y escritura Single. |
| [FadeOutDuration](../../aspose.slides/audioframe/fadeoutduration) { get; set; } | Especifica la duración del desvanecimiento final del medio en milisegundos. Lectura y escritura Single. |
...
| [Frame](../../aspose.slides/shape/frame) { get; set; } | Devuelve o establece las propiedades del marco de forma. Lectura y escritura [`IShapeFrame`](../ishapeframe). |
| [Height](../../aspose.slides/shape/height) { get; set; } | Devuelve o establece la altura de la forma. Lectura y escritura Single. |
| [Hidden](../../aspose.slides/shape/hidden) { get; set; } | Determina si la forma está oculta. Lectura y escritura Boolean. |
| [HideAtShowing](../../aspose.slides/audioframe/hideatshowing) { get; set; } | Determina si un AudioFrame está oculto. Lectura y escritura Boolean. |
| [HyperlinkClick](../../aspose.slides/shape/hyperlinkclick) { get; set; } | Devuelve o establece el hipervínculo definido para el clic del mouse. Lectura y escritura [`IHyperlink`](../ihyperlink). |
...
| [HyperlinkMouseOver](../../aspose.slides/shape/hyperlinkmouseover) { get; set; } | Devuelve o establece el hipervínculo definido para el mouse sobre. Lectura y escritura [`IHyperlink`](../ihyperlink). |
| [IsCameo](../../aspose.slides/pictureframe/iscameo) { get; } | Determina si el PictureFrame es un objeto Cameo o no. Solo lectura Boolean. |
| [IsDecorative](../../aspose.slides/shape/isdecorative) { get; set; } | Obtiene o establece la opción 'Marcar como decorativa'. Lectura y escritura Boolean. |
...
| [LinkPathLong](../../aspose.slides/audioframe/linkpathlong) { get; set; } | Devuelve o establece el nombre de un archivo de audio que está vinculado a un AudioFrame. Lectura y escritura String. |
| [Name](../../aspose.slides/shape/name) { get; set; } | Devuelve o establece el nombre de una forma. No debe ser nulo. Use valor de cadena vacía si es necesario. Lectura y escritura String. |
...
| [PlayAcrossSlides](../../aspose.slides/audioframe/playacrossslides) { get; set; } | Determina si el audio se está reproduciendo a través de las diapositivas. Lectura y escritura Boolean. |
| [PlayLoopMode](../../aspose.slides/audioframe/playloopmode) { get; set; } | Determina si un audio se reproduce en bucle. Lectura y escritura Boolean. |
| [PlayMode](../../aspose.slides/audioframe/playmode) { get; set; } | Devuelve o establece el modo de reproducción de audio. Lectura y escritura [`AudioPlayModePreset`](../audioplaymodepreset). |
...
| [RawFrame](../../aspose.slides/shape/rawframe) { get; set; } | Devuelve o establece las propiedades del marco de forma en bruto. Lectura y escritura [`IShapeFrame`](../ishapeframe). |
| [RelativeScaleHeight](../../aspose.slides/pictureframe/relativescaleheight) { get; set; } | Devuelve o establece la escala de altura (relativa al tamaño original de la imagen) del marco de imagen. El valor 1.0 corresponde al 100%. Lectura y escritura Single. |
| [RelativeScaleWidth](../../aspose.slides/pictureframe/relativescalewidth) { get; set; } | Devuelve o establece la escala de ancho (relativa al tamaño original de la imagen) del marco de imagen. El valor 1.0 corresponde al 100%. Lectura y escritura Single. |
| [RewindAudio](../../aspose.slides/audioframe/rewindaudio) { get; set; } | Determina si el audio se rebobina automáticamente al inicio después de reproducirse. Lectura y escritura Boolean. |
| [Rotation](../../aspose.slides/shape/rotation) { get; set; } | Devuelve o establece el número de grados que la forma especificada está girada alrededor del eje z. Un valor positivo indica rotación en sentido horario; un valor negativo indica rotación en sentido antihorario. Lectura y escritura Single. |
...
| [TrimFromEnd](../../aspose.slides/audioframe/trimfromend) { get; set; } | Especifica la duración de tiempo que se eliminará del final del medio durante la reproducción, en milisegundos. Lectura y escritura Single. |
| [TrimFromStart](../../aspose.slides/audioframe/trimfromstart) { get; set; } | Especifica la duración de tiempo que se eliminará del principio del medio durante la reproducción, en milisegundos. Lectura y escritura Single. |
...
| [Volume](../../aspose.slides/audioframe/volume) { get; set; } | Devuelve o establece el volumen de audio. Lectura y escritura [`AudioVolumeMode`](../audiovolumemode). |
| [VolumeValue](../../aspose.slides/audioframe/volumevalue) { get; set; } | Devuelve o establece el volumen de audio en porcentajes. Lectura y escritura Single. |
| [Width](../../aspose.slides/shape/width) { get; set; } | Devuelve o establece el ancho de la forma. Lectura y escritura Single. |
| [X](../../aspose.slides/shape/x) { get; set; } | Devuelve o establece la coordenada x de la esquina superior izquierda de la forma. Lectura y escritura Single. |
| [Y](../../aspose.slides/shape/y) { get; set; } | Devuelve o establece la coordenada y de la esquina superior izquierda de la forma. Lectura y escritura Single. |
...
| [GetImage](../../aspose.slides/shape/getimage)() | Devuelve la miniatura de la forma. Se usa por defecto el tipo de límites de miniatura ShapeThumbnailBounds.Shape. |
