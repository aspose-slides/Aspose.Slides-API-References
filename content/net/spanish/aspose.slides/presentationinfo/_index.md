...
| Nombre | Descripción |
| --- | --- |
| [IsEncrypted](../../aspose.slides/presentationinfo/isencrypted) { get; } | Obtiene True si la presentación enlazada está encriptada, de lo contrario, False. Solo lectura Boolean. |
...
| [WriteBindedPresentation](../../aspose.slides/presentationinfo/writebindedpresentation#writebindedpresentation)(Stream) | Escribe la presentación enlazada en el flujo. |
