...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Devuelve un identificador interno de alcance de presentación destinado al uso por complementos u otro código. Debido a que este valor puede ser reasignado por el usuario o programáticamente, no debe considerarse una clave única persistente. Solo lectura UInt32. Ver también [`OfficeInteropShapeId`](../shape/officeinteropshapeid). |
