...
| [FirstCol](../../aspose.slides/table/firstcol) { get; set; } | Determina si la primera columna de una tabla debe dibujarse con un formato especial. Lectura/escritura Boolean. |  
| [FirstRow](../../aspose.slides/table/firstrow) { get; set; } | Determina si la primera fila de una tabla debe dibujarse con un formato especial. Lectura/escritura Boolean. |  
...
| [HorizontalBanding](../../aspose.slides/table/horizontalbanding) { get; set; } | Determina si las filas pares deben dibujarse con un formato diferente. Lectura/escritura Boolean. |  
...
| [LastCol](../../aspose.slides/table/lastcol) { get; set; } | Determina si la última columna de una tabla debe dibujarse con un formato especial. Lectura/escritura Boolean. |  
| [LastRow](../../aspose.slides/table/lastrow) { get; set; } | Determina si la última fila de una tabla debe dibujarse con un formato especial. Lectura/escritura Boolean. |  
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | Obtiene el identificador único de la forma en el ámbito de la diapositiva. Solo lectura UInt32. Vea también [`UniqueId`](../shape/uniqueid) para obtener el identificador único de la forma en el ámbito de la presentación. |  
...
| [RightToLeft](../../aspose.slides/table/righttoleft) { get; set; } | Determina si la tabla tiene un orden de lectura de derecha a izquierda. Lectura/escritura Boolean. |  
| [Rotation](../../aspose.slides/shape/rotation) { get; set; } | Devuelve o establece el número de grados que se rota la forma especificada alrededor del eje z. Un valor positivo indica rotación en sentido horario; un valor negativo indica rotación en sentido antihorario. Lectura/escritura Single. |  
...
| [Slide](../../aspose.slides/shape/slide) { get; } | Devuelve la diapositiva madre de una forma. Solo lectura [`IBaseSlide`](../ibaseslide). |  
...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Obtiene el identificador único de la forma en el ámbito de la presentación. Solo lectura UInt32. Vea también [`OfficeInteropShapeId`](../shape/officeinteropshapeid) para obtener el identificador único de la forma en el ámbito de la diapositiva. |  
| [VerticalBanding](../../aspose.slides/table/verticalbanding) { get; set; } | Determina si las columnas pares deben dibujarse con un formato diferente. Lectura/escritura Boolean. |  
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Devuelve una forma de marcador de posición básica (forma del diseño y/o la diapositiva maestra de la que se hereda la forma actual). Se devuelve null si la forma actual no se hereda. |  
| [GetImage](../../aspose.slides/shape/getimage)() | Devuelve la miniatura de la forma. ShapeThumbnailBounds.Shape se utiliza por defecto como tipo de límites de miniaturas de forma. |  
...
| [SetTextFormat](../../aspose.slides/table/settextformat#settextformat)(IParagraphFormat) | Establece las propiedades del formato de párrafo definidas en todos los párrafos de las celdas de la tabla. |  
...
| [SetTextFormat](../../aspose.slides/table/settextformat#settextformat_2)(ITextFrameFormat) | Establece las propiedades de formato del marco de texto definidas en todos los marcos de texto de las celdas de la tabla. |  
