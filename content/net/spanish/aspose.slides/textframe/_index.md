...
| [Text](../../aspose.slides/textframe/text) { get; set; } | Obtiene o establece el texto en plano para un TextFrame. Lectura/escritura String. |
...
| [JoinPortionsWithSameFormatting](../../aspose.slides/textframe/joinportionswithsameformatting)() | Une fragmentos con el mismo formato en todos los párrafos. |
...
| [SplitTextByColumns](../../aspose.slides/textframe/splittextbycolumns)() | Divide el contenido de texto del [`ITextFrame`](../itextframe) en un array de cadenas, donde cada elemento corresponde a una columna de texto separada dentro del marco. |
