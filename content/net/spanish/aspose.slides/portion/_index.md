...
| [PortionFormat](../../aspose.slides/portion/portionformat) { get; } | Devuelve un objeto de formato que contiene las propiedades de formato establecidas explícitamente de la porción de texto sin aplicar herencia. Solo lectura [`IPortionFormat`](../iportionformat). |
...
| [GetCoordinates](../../aspose.slides/portion/getcoordinates)() | Obtiene las coordenadas del inicio de la porción. La coordenada X del punto representa el comienzo de la porción desde el primer carácter, incluido el desplazamiento lateral izquierdo. La coordenada Y incluye el desplazamiento superior. |
