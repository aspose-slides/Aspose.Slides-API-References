...
description: Devuelve el objeto ThreeDFormat que representa las propiedades de efecto 3d para un texto. Solo lectura IThreeDFormataspose.slides/ithreedformat.
type: docs
weight: 140
...
Devuelve el objeto ThreeDFormat que representa las propiedades de efecto 3d para un texto. Solo lectura [`IThreeDFormat`](../../ithreedformat).
