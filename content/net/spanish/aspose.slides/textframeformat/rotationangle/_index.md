...
## Propiedad TextFrameFormat.RotationAngle
...
Considera el caso en que una forma tiene una rotación de 90 grados en el sentido de las agujas del reloj aplicada a ella. Además de esto, el cuerpo del texto en sí tiene una rotación de -90 grados en el sentido contrario a las agujas del reloj aplicada a él. Entonces, la forma resultante parecería estar rotada, pero el texto dentro de ella parecería como si no hubiera sido rotado en absoluto.
