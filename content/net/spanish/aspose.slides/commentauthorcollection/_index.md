...
| Nombre | Descripción |
| --- | --- |
| [AddAuthor](../../aspose.slides/commentauthorcollection/addauthor)(string, string) | Agrega un nuevo autor al final de una colección. |
...
| [FindByName](../../aspose.slides/commentauthorcollection/findbyname)(string) | Encuentra un autor en una colección por nombre. |
| [FindByNameAndInitials](../../aspose.slides/commentauthorcollection/findbynameandinitials)(string, string) | Encuentra un autor en una colección por nombre e iniciales. |
...
| [Remove](../../aspose.slides/commentauthorcollection/remove)(ICommentAuthor) | Elimina la primera ocurrencia del autor especificado en una colección. |
