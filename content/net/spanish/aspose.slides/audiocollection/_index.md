...
| Nombre | Descripción |
| --- | --- |
| [Count](../../aspose.slides/audiocollection/count) { get; } | Devuelve un número de archivos de audio en la colección. Solo lectura Int32. |
...
| [CopyTo](../../aspose.slides/audiocollection/copyto)(Array, int) | Copia audios a un arreglo especificado comenzando desde el índice especificado. |
