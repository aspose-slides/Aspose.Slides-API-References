...
description: Crea un nuevo conector, lo ajusta a partir de la plantilla predeterminada y lo inserta en la colección en el índice especificado.
type: docs
weight: 280
...
Crea un nuevo conector, lo ajusta a partir de la plantilla predeterminada y lo inserta en la colección en el índice especificado.
...
| width | Single | El ancho del marco de la forma. |
| height | Single | La altura del marco de la forma. |
| createFromTemplate | Boolean | Si es verdadero, entonces la nueva forma se ajustará a partir de la plantilla predeterminada. Un nombre no vacío, estilo simple, texto centrado se asignará a la nueva forma. Si es falso, todos los valores de las propiedades de la nueva forma tendrán valores predeterminados. |
