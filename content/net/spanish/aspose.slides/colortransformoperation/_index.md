...
| --- | --- | --- |
| Tint | `0` | Tintea el color. El parámetro está en el rango entre 0 (color original) y 1 (blanco). |
...
| AddAlpha | `6` | Suma el valor de un parámetro a un componente alfa del color. El parámetro está en el rango entre -1 y 1. |
...
| AddHue | `9` | Suma el valor de un parámetro al componente de matiz del color. El parámetro está en el rango entre -360 y 360. |
...
| AddSaturation | `12` | Suma el valor de un parámetro a un componente de saturación del color. El parámetro está en el rango entre -1 y 1. |
...
| AddLuminance | `15` | Suma el valor de un parámetro a un componente de luminancia del color. El parámetro está en el rango entre -1 y 1. |
...
| AddRed | `18` | Suma el valor de un parámetro a un componente rojo del color. El parámetro está en el rango entre -1 y 1. |
...
| AddGreen | `21` | Suma el valor de un parámetro a un componente verde del color. El parámetro está en el rango entre -1 y 1. |
...
| AddBlue | `24` | Suma el valor de un parámetro a un componente azul del color. El parámetro está en el rango entre -1 y 1. |
