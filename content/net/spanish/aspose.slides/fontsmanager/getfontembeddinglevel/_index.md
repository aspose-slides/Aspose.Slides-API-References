...
description: Determina el nivel de incrustación de una fuente a partir del array de bytes dado y el nombre de la fuente.
type: docs
weight: 60
...
| --- | --- | --- |
| fontBytes | Byte[] | El array de bytes que contiene los datos de la fuente. |
