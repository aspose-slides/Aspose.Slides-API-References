...
El siguiente ejemplo muestra el uso de la propiedad Persistence para comprobar si las propiedades del objeto ActiveX pueden ser cambiadas como propiedades ActiveX basadas en XML:
...
{
    YourMethodHere(control.ActiveXControlBinary); //Usa tu propio método para gestionar las propiedades ActiveX almacenadas en su archivo binario
}
```
