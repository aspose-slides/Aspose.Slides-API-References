...
| [HyperlinkMouseOver](../../aspose.slides/shape/hyperlinkmouseover) { get; set; } | Devuelve o establece el hipervínculo definido para el desplazamiento del ratón. Lectura/escritura [`IHyperlink`](../ihyperlink). |
...
| override [LineFormat](../../aspose.slides/groupshape/lineformat) { get; } | Devuelve el objeto LineFormat que contiene las propiedades de formato de línea para una forma. Nota: devuelve null para objetos GroupShape porque no tienen propiedades de línea. Solo lectura [`ILineFormat`](../ilineformat). |
