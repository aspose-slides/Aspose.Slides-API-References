...
| [Layout](../../aspose.slides/summaryzoomframe/layout) { get; } | Obtiene el diseño de las secciones Summary Zoom en el marco. El valor predeterminado es GridLayout. |
...
| [Rotation](../../aspose.slides/shape/rotation) { get; set; } | Devuelve o establece el número de grados que la forma especificada está rotada alrededor del eje z. Un valor positivo indica rotación horaria; un valor negativo indica rotación antihoraria. Lectura/escritura Single. |
...
| [SummaryZoomCollection](../../aspose.slides/summaryzoomframe/summaryzoomcollection) { get; } | Obtiene [`ISummaryZoomSectionCollection`](../isummaryzoomsectioncollection) para el objeto Summary Zoom Frame. |
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | Devuelve el objeto ThreeDFormat que contiene las propiedades de efectos 3D para una forma. Nota: puede devolver null para ciertos tipos de formas que no tienen propiedades 3D. Solo lectura [`IThreeDFormat`](../ithreedformat). |
...
| [GetImage](../../aspose.slides/shape/getimage)() | Devuelve la miniatura de la forma. Se utiliza el tipo de límites de miniatura ShapeThumbnailBounds.Shape por defecto. |
