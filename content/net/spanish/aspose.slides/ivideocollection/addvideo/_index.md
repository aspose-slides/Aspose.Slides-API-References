...
## AgregarVideo(Stream, LoadingStreamBehavior) {#addvideo_2}
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| stream | Stream | Flujo del cual se agregará el archivo de video. |
