...
| [HeadingPairs](../../aspose.slides/documentproperties/headingpairs) { get; } | Indica la agrupación de partes de documentos y el número de partes en cada grupo. Solo lectura IHeadingPair[]. |
...
| [HyperlinksChanged](../../aspose.slides/documentproperties/hyperlinkschanged) { get; set; } | Especifica que uno o más hipervínculos en esta parte se actualizaron exclusivamente en esta parte por un productor. El próximo productor que abra este documento deberá actualizar las relaciones de hipervínculos con los nuevos hipervínculos especificados en esta parte. Lectura/escritura Boolean. |
| [Item](../../aspose.slides/documentproperties/item) { get; set; } | Devuelve o establece la propiedad personalizada asociada con un nombre específico. Lectura/escritura Object. |
...
| [LastPrinted](../../aspose.slides/documentproperties/lastprinted) { get; set; } | Devuelve la fecha en que se imprimió por última vez una presentación. Lectura/escritura DateTime. |
...
| [MultimediaClips](../../aspose.slides/documentproperties/multimediaclips) { get; } | Devuelve el número total de clips de sonido o video presentes en el documento. Solo lectura Int32. |
...
| [Paragraphs](../../aspose.slides/documentproperties/paragraphs) { get; } | Devuelve el número total de párrafos encontrados en un documento, si aplica. Solo lectura Int32. |
| [PresentationFormat](../../aspose.slides/documentproperties/presentationformat) { get; set; } | Devuelve o establece el formato destinado de una presentación. Lectura/escritura String. |
...
| Nombre | Descripción |
| --- | --- |
| [ClearBuiltInProperties](../../aspose.slides/documentproperties/clearbuiltinproperties)() | Limpia y establece valores predeterminados para todas las propiedades integradas. |
...
| [ContainsCustomProperty](../../aspose.slides/documentproperties/containscustomproperty)(string) | Verifica la presencia de una propiedad personalizada con un nombre específico. |
...
| [GetCustomPropertyValue](../../aspose.slides/documentproperties/getcustompropertyvalue#getcustompropertyvalue_5)(string, out string) | Obtiene un valor string nombrado de las propiedades personalizadas. |
| [RemoveCustomProperty](../../aspose.slides/documentproperties/removecustomproperty)(string) | Elimina una propiedad personalizada asociada con un nombre específico. |
...
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue_5)(string, string) | Establece una propiedad personalizada string nombrada. |

### Ejemplos

El siguiente ejemplo muestra cómo acceder a las propiedades integradas de la presentación de PowerPoint.
...
El siguiente ejemplo muestra cómo modificar las propiedades integradas de la presentación de PowerPoint.
...
using (Presentation presentation = new Presentation(dataDir + "ModifyBuiltinProperties.pptx"))
{
	...
	documentProperties.Title = "Modificando las Propiedades de la Presentación";
