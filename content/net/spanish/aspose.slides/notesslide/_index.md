...
| [HeaderFooterManager](../../aspose.slides/notesslide/headerfootermanager) { get; } | Devuelve el administrador de HeaderFooter de la diapositiva de notas. Solo lectura [`INotesSlideHeaderFooterManager`](../inotesslideheaderfootermanager). |
...
| [NotesTextFrame](../../aspose.slides/notesslide/notestextframe) { get; } | Devuelve un TextFrame con el texto de notas si existe. Solo lectura [`ITextFrame`](../itextframe). |
| [ParentSlide](../../aspose.slides/notesslide/parentslide) { get; } | Devuelve la diapositiva padre. Solo lectura [`ISlide`](../islide). |
...
| [ThemeManager](../../aspose.slides/notesslide/thememanager) { get; } | Devuelve el administrador de tema que sobrescribe. Solo lectura [`IOverrideThemeManager`](../../aspose.slides.theme/ioverridethememanager). |
...
| virtual [JoinPortionsWithSameFormatting](../../aspose.slides/baseslide/joinportionswithsameformatting)() | Une segmentos con el mismo formato en todos los párrafos en todas las formas aceptables. |
