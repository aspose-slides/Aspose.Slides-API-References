...
| slide | ISlide | Diapositiva en una presentación donde se añadirá un nuevo comentario moderno. |
| shape | IShape | Forma en una diapositiva a la que se asocia un nuevo comentario moderno. |
| position | PointF | Posición en una diapositiva donde se añadirá un nuevo comentario moderno. |
| creationTime | DateTime | Tiempo de creación de un comentario moderno. |
