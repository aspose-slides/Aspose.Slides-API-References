...
| Nombre | Descripción |
| --- | --- |
| [Count](../../aspose.slides/commentcollection/count) { get; } | Obtiene el número de elementos que realmente contiene la colección. Solo lectura Int32. |
| [IsSynchronized](../../aspose.slides/commentcollection/issynchronized) { get; } | Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para hilos). Solo lectura Boolean. |
...
| [CopyTo](../../aspose.slides/commentcollection/copyto)(Array, int) | Copia todos los elementos de la colección al arreglo especificado. |
| [FindCommentByIdx](../../aspose.slides/commentcollection/findcommentbyidx)(int) | Encuentra un comentario en la colección por índice. |
...
| [ToArray](../../aspose.slides/commentcollection/toarray#toarray)() | Crea y devuelve un arreglo con todos los comentarios. |
| [ToArray](../../aspose.slides/commentcollection/toarray#toarray_1)(int, int) | Crea y devuelve un arreglo con todos los comentarios del rango especificado. |
