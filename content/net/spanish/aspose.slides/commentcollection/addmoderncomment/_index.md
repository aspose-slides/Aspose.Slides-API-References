...
## Método CommentCollection.AddModernComment
...
using (Presentation pres = new Presentation())
{
    ...
    newAuthor.Comments.AddModernComment("Este es un comentario moderno", pres.Slides[0], null, new PointF(100, 100), DateTime.Now);
