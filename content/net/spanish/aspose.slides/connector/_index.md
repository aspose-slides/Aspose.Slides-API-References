...
| [EndShapeConnectedTo](../../aspose.slides/connector/endshapeconnectedto) { get; set; } | Devuelve o establece la forma a la que se adjuntará el extremo del conector. Lectura/escritura [`IShape`](../ishape). |
| [EndShapeConnectionSiteIndex](../../aspose.slides/connector/endshapeconnectionsiteindex) { get; set; } | Devuelve o establece el índice del sitio de conexión para la forma final. Lectura/escritura UInt32. |
...
| [HyperlinkMouseOver](../../aspose.slides/shape/hyperlinkmouseover) { get; set; } | Devuelve o establece el hiperenlace definido para el mouse sobre. Lectura/escritura [`IHyperlink`](../ihyperlink). |
...
| [RawFrame](../../aspose.slides/shape/rawframe) { get; set; } | Devuelve o establece las propiedades del marco de la forma en estado bruto. Lectura/escritura [`IShapeFrame`](../ishapeframe). |
...
| override [ShapeType](../../aspose.slides/connector/shapetype) { get; set; } | Devuelve o establece el tipo de AutoShape. Lectura/escritura [`ShapeType`](../shapetype). |
| [Slide](../../aspose.slides/shape/slide) { get; } | Devuelve la diapositiva padre de una forma. Solo lectura [`IBaseSlide`](../ibaseslide). |
| [StartShapeConnectedTo](../../aspose.slides/connector/startshapeconnectedto) { get; set; } | Devuelve o establece la forma a la que se adjuntará el inicio del conector. Lectura/escritura [`IShape`](../ishape). |
| [StartShapeConnectionSiteIndex](../../aspose.slides/connector/startshapeconnectionsiteindex) { get; set; } | Devuelve o establece el índice del sitio de conexión para la forma inicial. Lectura/escritura UInt32. |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | Devuelve una forma de marcador de posición básica (forma del diseño y/o diapositiva maestra de la cual se hereda la forma actual). Se devuelve null si la forma actual no es heredada. |
| [GetGeometryPaths](../../aspose.slides/geometryshape/getgeometrypaths)() | Devuelve la copia del camino de la forma geométrica. Las coordenadas son relativas a la esquina superior izquierda de la forma. |
