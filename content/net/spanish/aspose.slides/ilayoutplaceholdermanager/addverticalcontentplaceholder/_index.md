...
description: Agrega una nueva forma de marcador de posición a la diapositiva de diseño para contener contenido como una imagen, tabla, medio o texto en una dirección vertical.
type: docs
weight: 90
url: /es/aspose.slides/ilayoutplaceholdermanager/addverticalcontentplaceholder/
---

## Método ILayoutPlaceholderManager.AddVerticalContentPlaceholder

Agrega una nueva forma de marcador de posición a la diapositiva de diseño para contener contenido, como una imagen, tabla, medio o texto en una dirección vertical.
