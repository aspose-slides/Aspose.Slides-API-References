...
| [RawFrame](../../aspose.slides/shape/rawframe) { get; set; } | Devuelve o establece las propiedades sin procesar del marco de la forma. Lectura/escritura [`IShapeFrame`](../../aspose.slides/ishapeframe). |
...
| [Traces](../../aspose.slides.ink/ink/traces) { get; } | Obtiene todas las trazas contenidas en el elemento IInk [`IInkTrace`](../iinktrace). Solo lectura. |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | Devuelve un identificador interno con alcance de presentación destinado a ser usado por complementos u otro código. Dado que este valor puede ser reasignado por el usuario o programáticamente, no debe tratarse como una clave única persistente. Solo lectura UInt32. Ver también [`OfficeInteropShapeId`](../../aspose.slides/shape/officeinteropshapeid). |
...
| static [InkEffectImages](../../aspose.slides.ink/ink/inkeffectimages) { get; } | Obtiene la colección de imágenes personalizadas usadas para simular efectos visuales de pinceles de tinta. Estas imágenes se usan al renderizar tinta con valores específicos [`InkEffectType`](../inkeffecttype), como Galaxy, Rainbow, etc. Al proporcionar sus propias imágenes, puede controlar cómo aparece cada efecto de tinta. |
