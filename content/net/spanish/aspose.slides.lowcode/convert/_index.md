...
description: Representa un grupo de métodos destinados a convertir Presentationaspose.slides/aspose.slides/presentation.
type: docs
weight: 7640
...
| Nombre | Descripción |
| --- | --- |
| static [AutoByExtension](../../aspose.slides.lowcode/convert/autobyextension)(string, string) | Convierte [`Presentation`](../../aspose.slides/presentation) utilizando la extensión del camino de salida pasada para determinar el formato de exportación requerido. |
