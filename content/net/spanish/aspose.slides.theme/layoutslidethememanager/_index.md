...
Proporciona acceso al tema de la diapositiva de diseño sobreescrito.  
...
| Nombre | Descripción |  
| --- | --- |  
| [IsOverrideThemeEnabled](../../aspose.slides.theme/baseoverridethememanager/isoverridethemeenabled) { get; } | Determina si OverrideTheme sobrescribe el tema efectivo heredado o no. Para habilitar OverrideTheme para la sobreescritura, use los métodos OverrideTheme.Init*(). Para deshabilitar OverrideTheme de sobrescribir, use el método OverrideTheme.Clear(). Solo lectura. Tipo Boolean. |  
