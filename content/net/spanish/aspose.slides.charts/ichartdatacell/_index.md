...
| [PresetNumberFormat](../../aspose.slides.charts/ichartdatacell/presetnumberformat) { get; set; } | Obtiene o establece el formato de visualización incorporado de números y fechas. El número predefinido debe estar en [0..22] o [37..49]. Lectura/escritura Byte. |
...
| Name | Description |
| --- | --- |
| [Calculate](../../aspose.slides.charts/ichartdatacell/calculate)(bool) | Si la celda contiene una fórmula, el valor se actualizará basado en esa fórmula. |
