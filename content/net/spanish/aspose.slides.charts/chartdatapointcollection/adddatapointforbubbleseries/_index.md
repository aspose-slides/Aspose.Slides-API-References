...
description: Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable para series cuyo tipo de gráfico es uno de los subtipos de burbujas ver tambiénIsChartTypeBubbleaspose.slides.charts/charttypecharacterizer/ischarttypebubble método.
type: docs
weight: 130
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable para series cuyo tipo de gráfico es uno de los subtipos de burbujas (ver también[`IsChartTypeBubble`](../../charttypecharacterizer/ischarttypebubble) método).
