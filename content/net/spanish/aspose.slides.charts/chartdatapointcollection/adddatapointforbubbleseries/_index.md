...
description: Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos de Bubble, véase también el método IsChartTypeBubbleaspose.slides.charts/charttypecharacterizer/ischarttypebubble.
type: docs
weight: 130
url: /es/aspose.slides.charts/chartdatapointcollection/adddatapointforbubbleseries/
---

## AddDataPointForBubbleSeries(IChartDataCell, IChartDataCell, IChartDataCell) {#adddatapointforbubbleseries}

Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos de Bubble (véase también [`IsChartTypeBubble`](../../charttypecharacterizer/ischarttypebubble) método).
...
| bubbleSize | IChartDataCell | Tamaño de burbuja del punto de datos |
...
| xValue | IChartDataCell | Valor X del punto de datos |
| yValue | IChartDataCell | Valor Y del punto de datos |
| bubbleSize | Double | Tamaño de burbuja del punto de datos |
