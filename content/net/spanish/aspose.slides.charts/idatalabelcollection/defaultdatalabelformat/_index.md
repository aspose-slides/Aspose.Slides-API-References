...
## Propiedad IDataLabelCollection.DefaultDataLabelFormat  

Devuelve el formato predeterminado de todas las etiquetas de datos en la colección. Solo lectura [`IDataLabelFormat`](../../idatalabelformat).  
