...
| [IsVisible](../../aspose.slides.charts/idatalabelcollection/isvisible) { get; } | Falso significa que la etiqueta de datos no es visible por defecto (por lo que todas las banderas Show*- (ShowValue, ...) de la propiedad DefaultDataLabelFormat son falsas). Solo lectura Boolean. |
...
| [LeaderLinesFormat](../../aspose.slides.charts/idatalabelcollection/leaderlinesformat) { get; } | Representa el formato de las líneas líderes de las etiquetas de datos. Solo lectura [`IChartLinesFormat`](../ichartlinesformat). |
...
| Nombre | Descripción |
| --- | --- |
| [Hide](../../aspose.slides.charts/idatalabelcollection/hide)() | Hace que la etiqueta de datos esté oculta por defecto al establecer todas las banderas Show*- (ShowValue, ...) de la propiedad DefaultDataLabelFormat en estado falso. IsVisible será falso después de esto. |
