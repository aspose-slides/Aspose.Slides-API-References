...
description: Representa la etiqueta de datos a nivel de punto de datos. Aplicado para los tipos de series Treemap y Sunburst. Solo lectura IDataLabelaspose.slides/idatalabel.
type: docs
weight: 20
...
Representa la etiqueta de datos a nivel de punto de datos. Aplicado para los tipos de series Treemap y Sunburst. Solo lectura [`IDataLabel`](../../idatalabel).
