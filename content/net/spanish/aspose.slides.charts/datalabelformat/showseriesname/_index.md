...
type: docs
weight: 140
url: /es/aspose.slides.charts/datalabelformat/showseriesname/
---

## Propiedad DataLabelFormat.ShowSeriesName
...
Si el padre de este objeto DataLabelFormat es una colección DataLabelCollection de etiquetas de datos, entonces esta propiedad obtiene o establece el valor predeterminado de la propiedad ShowSeriesName para las nuevas etiquetas de datos en la colección DataLabelCollection. Establecer esta propiedad con valor también establece este valor para la propiedad ShowSeriesName de todas las etiquetas de datos en la colección DataLabelCollection (es decir, "DataLabels.DefaultDataLabelFormat.ShowSeriesName = val;" causa que todas las DataLabels[i].ShowSeriesName sean iguales a val).
