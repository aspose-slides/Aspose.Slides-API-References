...
| [ValueType](../../aspose.slides.charts/ierrorbarsformat/valuetype) { get; set; } | Representa las posibles formas de determinar la longitud de las barras de error. En el caso de un tipo de valor personalizado, usa la propiedad [`ErrorBarsCustomValues`](../ichartdatapoint/errorbarscustomvalues) de un punto de datos específico en la colección DataPoints de la serie. Lectura/escritura [`ErrorBarValueType`](../errorbarvaluetype). |
