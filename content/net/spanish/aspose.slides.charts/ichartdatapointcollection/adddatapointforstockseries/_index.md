...
description: Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable para series cuyo chartType es uno de los subtipos de Stock, véase también el método ChartTypeCharacterizer.IsChartTypeStockChartType.
type: docs
weight: 190
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable para series cuyo chartType es uno de los subtipos de Stock (véase también el método ChartTypeCharacterizer.IsChartTypeStock(ChartType)).
