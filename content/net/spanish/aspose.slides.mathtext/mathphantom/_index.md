...
description: Representa un objeto matemático fantasma ltmphantgt que afecta el diseño de su elemento hijo sin necesariamente mostrarlo. Un fantasma puede ocultar su expresión base mientras conserva su ancho, altura o profundidad para alinear fórmulas o reservar espacio. La visibilidad y el comportamiento geométrico se controlan mediante propiedades como Show, ZeroWid, ZeroAsc, ZeroDesc y Transp.
type: docs
weight: 8920
...
Representa un objeto matemático fantasma (<m:phant>) que afecta el diseño de su elemento hijo sin mostrarse necesariamente. Un fantasma puede ocultar su expresión base mientras conserva su ancho, altura o profundidad para alinear fórmulas o reservar espacio. La visibilidad y el comportamiento geométrico se controlan mediante propiedades como Show, ZeroWid, ZeroAsc, ZeroDesc y Transp.
...
| Nombre | Descripción |
| --- | --- |
| [MathPhantom](mathphantom)(IMathElement) | Inicializa una nueva instancia de la clase [`MathPhantom`](../mathphantom) usando el elemento matemático base especificado. |
...
| [Show](../../aspose.slides.mathtext/mathphantom/show) { get; set; } | Obtiene o establece un valor que indica si el elemento base se muestra. |
| [Transp](../../aspose.slides.mathtext/mathphantom/transp) { get; set; } | Obtiene o establece un valor que indica si el fantasma es transparente para las reglas de espaciado basadas en clases. |
| [ZeroAsc](../../aspose.slides.mathtext/mathphantom/zeroasc) { get; set; } | Obtiene o establece un valor que indica si la ascensión (altura por encima de la línea base) del elemento base debe tratarse como cero. |
| [ZeroDesc](../../aspose.slides.mathtext/mathphantom/zerodesc) { get; set; } | Obtiene o establece un valor que indica si el descenso (profundidad por debajo de la línea base) del elemento base debe tratarse como cero. |
| [ZeroWidth](../../aspose.slides.mathtext/mathphantom/zerowidth) { get; set; } | Obtiene o establece un valor que indica si el ancho del elemento base debe tratarse como cero. |
...
| [GetChildren](../../aspose.slides.mathtext/mathphantom/getchildren)() | Obtiene los elementos hijos |
...
* interfaz [IMathPhantom](../imathphantom)
