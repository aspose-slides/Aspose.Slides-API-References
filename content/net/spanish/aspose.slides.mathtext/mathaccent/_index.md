...
Especifica la función de acento, que consta de una base y una marca diacrítica combinada. Ejemplo: 𝑎́
...
| Nombre | Descripción |
| --- | --- |
| [MathAccent](mathaccent#constructor)(IMathElement) | Crea un acento matemático que se aplica a un elemento matemático especificado con el valor predeterminado del carácter de acento |
| [MathAccent](mathaccent#constructor_1)(IMathElement, char) | Crea un acento matemático que se aplica a un elemento matemático especificado |
