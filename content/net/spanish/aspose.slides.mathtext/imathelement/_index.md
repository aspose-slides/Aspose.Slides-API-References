...
| [Enclose](../../aspose.slides.mathtext/imathelement/enclose#enclose)() | Enclava un elemento matemático en paréntesis |
...
| [Radical](../../aspose.slides.mathtext/imathelement/radical#radical)(IMathElement) | Especifica la raíz matemática de un grado dado a partir del argumento especificado. |
| [Radical](../../aspose.slides.mathtext/imathelement/radical#radical_1)(string) | Especifica la raíz matemática de un grado dado a partir del argumento especificado. |
...
| [ToBorderBox](../../aspose.slides.mathtext/imathelement/toborderbox#toborderbox)() | Coloca este elemento en un borde |
| [ToBorderBox](../../aspose.slides.mathtext/imathelement/toborderbox#toborderbox_1)(bool, bool, bool, bool, bool, bool, bool, bool) | Coloca este elemento en un borde |
| [ToBox](../../aspose.slides.mathtext/imathelement/tobox)() | Coloca este elemento en una caja no visual (agrupación lógica) que se usa para agrupar componentes de una ecuación u otra instancia de texto matemático. Un objeto en caja puede (por ejemplo) servir como un emulador de operador con o sin un punto de alineación, servir como un punto de salto de línea, o ser agrupado de tal manera que no se permitan saltos de línea dentro. |
| [ToMathArray](../../aspose.slides.mathtext/imathelement/tomatharray)() | Coloca en un array vertical |
