...
description: 包含用于处理Microsoft PowerPoint演示文稿中动画的类。
type: docs
weight: 20
url: /zh/aspose.slides.animation/
---

包含用于处理Microsoft PowerPoint演示文稿中动画的类。
...
| [BehaviorPropertyCollection](./behaviorpropertycollection) | 表示效果行为的时间属性。 |
...
| [MotionCmdPath](./motioncmdpath) | 表示路径的一条命令。 |
...
| [SequenceCollection](./sequencecollection) | 表示交互式序列的集合。 |
...
| [IBehaviorPropertyCollection](./ibehaviorpropertycollection) | 表示效果行为的时间属性。 |
...
| [IMotionCmdPath](./imotioncmdpath) | 表示路径的一条命令。 |
...
| [ISequenceCollection](./isequencecollection) | 表示交互式序列的集合。 |
...
| [ITiming](./itiming) | 表示动画的时间控制。 |
## 枚举

| 枚举 | 描述 |
| --- | --- |
| [AfterAnimationType](./afteranimationtype) | 表示动画效果的后动画类型。 |
| [AnimateTextType](./animatetexttype) | 表示动画效果的动画文本类型。 |
| [BehaviorAccumulateType](./behavioraccumulatetype) | 表示效果行为的累积类型。 |
| [BehaviorAdditiveType](./behavioradditivetype) | 表示效果行为的加法类型。 |
| [BuildType](./buildtype) | 决定文本在动画期间如何在形状上出现。 |
...
| [EffectChartMinorGroupingType](./effectchartminorgroupingtype) | 表示系列或类别中图表元素的动画效果类型。 |
| [EffectFillType](./effectfilltype) | 表示填充类型。 |
| [EffectPresetClassType](./effectpresetclasstype) | 表示效果类类型。 |
| [EffectRestartType](./effectrestarttype) | 表示时间控制的重启类型。 |
| [EffectSubtype](./effectsubtype) | 表示动画效果的子类型。 |
| [EffectTriggerType](./effecttriggertype) | 表示效果的触发类型。 |
| [EffectType](./effecttype) | 表示动画效果的类型。 |
| [FilterEffectRevealType](./filtereffectrevealtype) | 表示过滤器显现类型。 |
| [FilterEffectSubtype](./filtereffectsubtype) | 表示过滤器效果的子类型。 |
| [FilterEffectType](./filtereffecttype) | 表示过滤器效果的类型。 |
| [MotionCommandPathType](./motioncommandpathtype) | 表示动画运动效果行为的命令类型。 |
| [MotionOriginType](./motionorigintype) | 指定运动路径的原点相对于哪个对象。比如幻灯片的布局或父级。 |
| [MotionPathEditMode](./motionpatheditmode) | 指定当目标形状移动时，运动路径如何移动 |
