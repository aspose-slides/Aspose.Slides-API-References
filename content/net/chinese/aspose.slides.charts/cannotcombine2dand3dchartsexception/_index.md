...
description: 在尝试合并 2D 和 3D 图表类型时抛出的异常。
type: docs
weight: 1240
...
| [CannotCombine2DAnd3DChartsException](cannotcombine2dand3dchartsexception#constructor_2)(string, Exception) | 用于包含消息和内部异常的异常的构造函数。 |
