...
| [IndexOf](../../aspose.slides.charts/ichartseriescollection/indexof)(IChartSeries) | 搜索指定的 [`IChartSeries`](../ichartseries)，并返回整个集合中第一个出现的零基索引。 |
| [Insert](../../aspose.slides.charts/ichartseriescollection/insert)(int, ChartType) | 创建新的图表系列并将其插入集合中。 |
