...
| 名称 | 描述 |
| --- | --- |
| [AsIPresentationComponent](../../aspose.slides.theme/itheme/asipresentationcomponent) { get; } | 允许获取基 IPresentationComponent 接口。只读 [`IPresentationComponent`](../../aspose.slides/ipresentationcomponent)。 |
...
| 名称 | 描述 |
| --- | --- |
| [GetEffective](../../aspose.slides.theme/itheme/geteffective)() | 获取应用继承后的有效主题数据。 |
