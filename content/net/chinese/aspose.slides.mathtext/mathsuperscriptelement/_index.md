...
description: 指定上标对象，由基元素和放置在其上方右侧的缩小尺寸上标组成
type: docs
weight: 9020
...
指定上标对象，该对象由基元素和放置在其上方右侧的缩小尺寸上标组成
...
| 名称 | 描述 |
| --- | --- |
| [Base](../../aspose.slides.mathtext/basescript/base) { get; } | 基参数 |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 将此元素放入非可视框（逻辑分组），用于对方程或其他数学文本实例的组件进行分组。框对象可以（例如）充当带或不带对齐点的运算符模拟器，充当换行点，或进行分组以防止其中出现换行。 |
| virtual [ToMathArray](../../aspose.slides.mathtext/mathelementbase/tomatharray)() | 放入垂直阵列中 |
