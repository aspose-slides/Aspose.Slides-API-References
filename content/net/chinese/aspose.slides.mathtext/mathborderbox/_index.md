...
description: 在IMathElement周围绘制矩形或其他边框。
type: docs
weight: 8350
...
| [HideBottom](../../aspose.slides.mathtext/mathborderbox/hidebottom) { get; set; } | 隐藏底边 (默认值为 false) - 指定边框框底边的隐藏或显示状态。 |
| [HideLeft](../../aspose.slides.mathtext/mathborderbox/hideleft) { get; set; } | 隐藏左边 (默认值为 false) - 指定边框框左边的隐藏或显示状态。 |
| [HideRight](../../aspose.slides.mathtext/mathborderbox/hideright) { get; set; } | 隐藏右边 (默认值为 false) - 指定边框框右边的隐藏或显示状态。 |
| [HideTop](../../aspose.slides.mathtext/mathborderbox/hidetop) { get; set; } | 隐藏上边 (默认值为 false) - 指定边框框上边的隐藏或显示状态。 |
| [StrikethroughBottomLeftToTopRight](../../aspose.slides.mathtext/mathborderbox/strikethroughbottomlefttotopright) { get; set; } | 从左下角到右上角的删除线 (默认值为 false)。指定从边框框左下角到右上角的删除线的隐藏或显示状态。 |
| [StrikethroughHorizontal](../../aspose.slides.mathtext/mathborderbox/strikethroughhorizontal) { get; set; } | 横向删除线 (默认值为 false) - 指定横向删除线的隐藏或显示状态。 |
| [StrikethroughTopLeftToBottomRight](../../aspose.slides.mathtext/mathborderbox/strikethroughtoplefttobottomright) { get; set; } | 从左上角到右下角的删除线 (默认值为 false)。指定从边框框左上角到右下角的删除线的隐藏或显示状态。 |
| [StrikethroughVertical](../../aspose.slides.mathtext/mathborderbox/strikethroughvertical) { get; set; } | 竖向删除线 (默认值为 false) - 指定竖向删除线的隐藏或显示状态。 |
...
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(IMathElement) | 使用此实例作为参数来取指定函数 |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfOneArgument) | 使用此实例作为参数来取指定函数 |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(string) | 使用此实例作为参数来取指定函数 |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, IMathElement) | 使用此实例作为参数及指定附加参数来取指定函数 |
| [AsArgumentOfFunction](../../aspose.slides.mathtext/mathelementbase/asargumentoffunction)(MathFunctionsOfTwoArguments, string) | 使用此实例作为参数及指定附加参数来取指定函数 |
...
| [Divide](../../aspose.slides.mathtext/mathelementbase/divide)(IMathElement, MathFractionTypes) | 创建一个指定类型的分数，分子为此，分母为指定的 |
| [Divide](../../aspose.slides.mathtext/mathelementbase/divide)(string, MathFractionTypes) | 创建一个指定类型的分数，分子为此，分母为指定的 |
| [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)() | 用括号将数学元素括起来 |
| virtual [Enclose](../../aspose.slides.mathtext/mathelementbase/enclose)(char, char) | 用指定字符将数学元素括起来，如括号或其他作为框架的字符 |
...
| [Group](../../aspose.slides.mathtext/mathelementbase/group)() | 将此元素放入使用底部大括号的组中 |
...
| [Overbar](../../aspose.slides.mathtext/mathelementbase/overbar)() | 在此元素顶部设置一个横杠 |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(IMathElement) | 指定从指定参数出发的给定阶的数学根。 |
| [Radical](../../aspose.slides.mathtext/mathelementbase/radical)(string) | 指定从指定参数出发的给定阶的数学根。 |
...
| [ToBox](../../aspose.slides.mathtext/mathelementbase/tobox)() | 将此元素放入一个非视觉框中（逻辑分组），该框用于分组方程或其他数学文本实例的组件。一个框对象可以（例如）作为一个运算符仿真器，带或不带对齐点，用作换行点，或者被分组以不允许换行。 |
| virtual [ToMathArray](../../aspose.slides.mathtext/mathelementbase/tomatharray)() | 放入一个垂直数组中 |
| [Underbar](../../aspose.slides.mathtext/mathelementbase/underbar)() | 在此元素底部设置一个横杠 |
