...
| [Count](../../aspose.slides.mathtext/imathelementcollection/count) { get; } | 获取集合实际包含的元素数量。只读 Int32。 |
...
| 名称 | 描述 |
| --- | --- |
| [Add](../../aspose.slides.mathtext/imathelementcollection/add)(IMathElement) | 向集合末尾添加一个数学元素。 |
...
| [RemoveAt](../../aspose.slides.mathtext/imathelementcollection/removeat)(int) | 从集合中移除指定索引处的元素。 |
