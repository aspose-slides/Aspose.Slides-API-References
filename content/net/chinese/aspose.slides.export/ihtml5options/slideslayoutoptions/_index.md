...
description: 获取或设置在导出演示文稿时幻灯片放置在页面上的模式 ISlidesLayoutOptionsaspose.slides/islideslayoutoptions.
type: docs
weight: 70
...
获取或设置在导出演示文稿时幻灯片放置在页面上的模式 [`ISlidesLayoutOptions`](../../islideslayoutoptions)。
