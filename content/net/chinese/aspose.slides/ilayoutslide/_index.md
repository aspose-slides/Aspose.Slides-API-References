...
| [DrawingGuides](../../aspose.slides/ilayoutslide/drawingguides) { get; } | 返回布局幻灯片的绘图指南集合。只读 [`IDrawingGuidesCollection`](../idrawingguidescollection)。 |
| [HasDependingSlides](../../aspose.slides/ilayoutslide/hasdependingslides) { get; } | 如果存在至少一个依赖此布局幻灯片的幻灯片，则返回 true。只读 Boolean。 |
...
| 名称 | 描述 |
| --- | --- |
| [GetDependingSlides](../../aspose.slides/ilayoutslide/getdependingslides)() | 返回一个数组，包含所有依赖此布局幻灯片的幻灯片。 |
