...
| [Frame](../../aspose.slides/shape/frame) { get; set; } | 返回或设置形状框的属性。可读写 [`IShapeFrame`](../ishapeframe)。 |
...
| [IsDecorative](../../aspose.slides/shape/isdecorative) { get; set; } | 获取或设置“标记为 декоратив”选项，可读写布尔值。 |
| [IsGrouped](../../aspose.slides/shape/isgrouped) { get; } | 确定形状是否分组。只读布尔值。 |
| [IsTextHolder](../../aspose.slides/shape/istextholder) { get; } | 确定形状是否为文本框。只读布尔值。 |
...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | 获取在幻灯片范围内唯一的形状标识符。只读 UInt32。另见 [`UniqueId`](../shape/uniqueid) 获取在演示范围内唯一的形状标识符。 |
...
| [RawFrame](../../aspose.slides/shape/rawframe) { get; set; } | 返回或设置原始形状框的属性。可读写 [`IShapeFrame`](../ishapeframe)。 |
...
| [ShapeLock](../../aspose.slides/graphicalobject/shapelock) { get; } | 返回形状的锁定状态。只读 [`IGraphicalObjectLock`](../igraphicalobjectlock)。 (2 属性) |
| [ShowBackground](../../aspose.slides/zoomobject/showbackground) { get; set; } | 获取或设置值，指定缩放是否使用目标幻灯片的背景。可读写布尔值。默认值：true |
...
| [TransitionDuration](../../aspose.slides/zoomobject/transitionduration) { get; set; } | 获取或设置缩放和幻灯片之间的过渡持续时间。可读写单精度浮点数。默认值：1.0f |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | 获取在演示范围内唯一的形状标识符。只读 UInt32。另见 [`OfficeInteropShapeId`](../shape/officeinteropshapeid) 获取在幻灯片范围内唯一的形状标识符。 |
...
| 名称 | 描述 |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | 如果不存在占位符，则添加新的占位符，并将占位符属性设置为指定的属性。 |
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | 返回基本占位符形状（当前形状继承的来自布局和/或母版幻灯片的形状）。如果当前形状没有继承，返回 null。 |
