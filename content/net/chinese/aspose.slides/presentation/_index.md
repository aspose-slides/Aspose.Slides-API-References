...
| 姓名 | 描述 |
| --- | --- |
| [Presentation](presentation#constructor)() | 此构造函数从头开始创建新的表示。 创建的演示文稿有一张空白幻灯片。 |
| [Presentation](presentation#constructor_1)(LoadOptions) | 此构造函数从头开始创建新的表示。 创建的演示文稿有一张空白幻灯片。 |
| [Presentation](presentation#constructor_2)(Stream) | 此构造函数是读取现有演示文稿的主要机制。 |
| [Presentation](presentation#constructor_4)(string) | 此构造函数获取源文件路径，从中读取 演示文稿的内容。 |
| [Presentation](presentation#constructor_3)(Stream, LoadOptions) | 此构造函数是读取现有演示文稿的主要机制。 |
| [Presentation](presentation#constructor_5)(string, LoadOptions) | 此构造函数获取源文件路径，从中读取 演示文稿的内容。 |
...
| [CurrentDateTime](../../aspose.slides/presentation/currentdatetime) { get; set; } | 返回或设置将替换日期时间字段内容的日期和时间。 默认情况下创建此演示对象的时间。 读/写DateTime。 |
...
| [HyperlinkQueries](../../aspose.slides/presentation/hyperlinkqueries) { get; } | 提供对所有演示幻灯片中包含的所有超链接的轻松访问（不在母版、布局、注释幻灯片中）。 只读[`IHyperlinkQueries`](../ihyperlinkqueries)。 |
...
| [MasterHandoutSlideManager](../../aspose.slides/presentation/masterhandoutslidemanager) { get; } | 返回讲义主管理器。 只读[`IMasterHandoutSlideManager`](../imasterhandoutslidemanager)。 |
| [MasterNotesSlideManager](../../aspose.slides/presentation/masternotesslidemanager) { get; } | 返回笔记主管理器。 只读[`IMasterNotesSlideManager`](../imasternotesslidemanager)。 |
...
| [ViewProperties](../../aspose.slides/presentation/viewproperties) { get; } | 获取展示范围视图属性。 只读[`IViewProperties`](../iviewproperties)。 |
...
| [GetSlideById](../../aspose.slides/presentation/getslidebyid)(uint) | 按 Id 返回 Slide、MasterSlide 或 LayoutSlide。 |
...
| [GetThumbnails](../../aspose.slides/presentation/getthumbnails#getthumbnails_11)(IRenderingOptions, Size) | 返回具有指定大小的演示文稿的所有幻灯片的缩略图位图对象。 |
...
| [JoinPortionsWithSameFormatting](../../aspose.slides/presentation/joinportionswithsameformatting)() | 在所有幻灯片中以所有可接受的形状的所有段落中以相同的格式运行。 |
...
| [Save](../../aspose.slides/presentation/save#save_1)(Stream, SaveFormat) | 将演示文稿的所有幻灯片以指定格式保存到流中。 |
...
| [Save](../../aspose.slides/presentation/save#save_7)(string, int[], SaveFormat) | 将演示文稿的指定幻灯片保存到具有指定格式的文件中，并保留页码。 |
...
| [Save](../../aspose.slides/presentation/save#save_8)(string, int[], SaveFormat, ISaveOptions) | 将演示文稿的指定幻灯片保存到具有指定格式的文件中，并保留页码。 |
