...
| [RotateWithShape](../../aspose.slides/ilinefillformateffectivedata/rotatewithshape) { get; } | 确定填充是否应随形状旋转。只读 Boolean。 |
| [SolidFillColor](../../aspose.slides/ilinefillformateffectivedata/solidfillcolor) { get; } | 返回纯色填充的颜色。只读 Color。 |
