...
| virtual [EffectFormat](../../aspose.slides/shape/effectformat) { get; } | 返回包含应用于形状的像素效果的 EffectFormat 对象。注：对于没有效果属性的某些类型的形状，可能返回null。只读 [`IEffectFormat`](../ieffectformat)。 |
| virtual [FillFormat](../../aspose.slides/shape/fillformat) { get; } | 返回包含形状填充格式属性的 FillFormat 对象。注：对于没有填充属性的某些类型的形状，可能返回null。只读 [`IFillFormat`](../ifillformat)。 |
...
| [Layout](../../aspose.slides/summaryzoomframe/layout) { get; } | 获取框架中总结缩放节的布局。默认值为网格布局。 |
| virtual [LineFormat](../../aspose.slides/shape/lineformat) { get; } | 返回包含形状线条格式属性的 LineFormat 对象。注：对于没有线条属性的某些类型的形状，可能返回null。只读 [`ILineFormat`](../ilineformat)。 |
...
| [Rotation](../../aspose.slides/shape/rotation) { get; set; } | 返回或设置指定形状围绕z轴旋转的度数。正值表示顺时针旋转；负值表示逆时针旋转。可读写 Single。 |
...
| [SummaryZoomCollection](../../aspose.slides/summaryzoomframe/summaryzoomcollection) { get; } | 获取总结缩放框架对象的 [`ISummaryZoomSectionCollection`](../isummaryzoomsectioncollection)。 |
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | 返回包含形状 3D 效果属性的 ThreeDFormat 对象。注：对于没有3D属性的某些类型的形状，可能返回null。只读 [`IThreeDFormat`](../ithreedformat)。 |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | 返回形状在z顺序中的位置。Shapes[0] 返回 z 顺序最底部的形状，Shapes[Shapes.Count - 1] 返回 z 顺序最顶部的形状。只读 Int32。 |

## 方法

| 名称 | 描述 |
| --- | --- |
| [AddPlaceholder](../../aspose.slides/shape/addplaceholder)(IPlaceholder) | 如果没有占位符，添加一个新的占位符并将属性设置为指定值。 |
