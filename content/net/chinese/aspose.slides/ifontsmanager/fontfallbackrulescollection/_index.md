...
description: 表示用户的 FontFallBack 规则集合，用于管理字体集合以便通过回退功能进行适当替代。读/写 IFontFallBackRulesCollectionaspose.slides/ifontfallbackrulescollection。
type: docs
weight: 10
...
表示用户的 FontFallBack 规则集合，用于管理字体集合以便通过回退功能进行适当替代。读/写 [`IFontFallBackRulesCollection`](../../ifontfallbackrulescollection)。
