...
description: 更改主备注幻灯片标题占位符和所有子标题占位符的可见性。子占位符意味着占位符包含在依赖的备注幻灯片上。依赖的备注幻灯片使用并依赖于主备注幻灯片。
type: docs
weight: 60
...
更改主备注幻灯片标题占位符和所有子标题占位符的可见性。子占位符意味着占位符包含在依赖的备注幻灯片上。依赖的备注幻灯片使用并依赖于主备注幻灯片。
