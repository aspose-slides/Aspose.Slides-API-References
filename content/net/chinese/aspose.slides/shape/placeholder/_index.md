...
description: 返回形状的占位符。如果形状没有占位符，则返回 null。只读 IPlaceholder aspose.slides/iplaceholder。
type: docs
weight: 210
...
using (Presentation pres = new Presentation("Presentation2.pptx"))
{
    ...
    foreach (IShape shape in slide.Slide.Shapes) // 遍历幻灯片
    {
        ...
        {
            string text = "";
            if (shape.Placeholder.Type == PlaceholderType.CenteredTitle) // PowerPoint 显示 "单击以添加标题"
            {
                text = "添加标题";
            }
