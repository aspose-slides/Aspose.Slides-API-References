...
| [IsSynchronized](../../aspose.slides/cellcollection/issynchronized) { get; } | 返回一个值，用于指示对集合的访问是否已同步（线程安全）。只读 Boolean。 |
| [Item](../../aspose.slides/cellcollection/item) { get; } | 根据位置返回单元格。只读 [`Cell`](../cell)。 |
| [MinimalHeight](../../aspose.slides/row/minimalheight) { get; set; } | 返回或设置行的最小可能高度。读/写 Double。 |
...
| 名称 | 描述 |
| --- | --- |
| [CopyTo](../../aspose.slides/cellcollection/copyto)(Array, int) | 将集合中的所有元素复制到指定数组中。 |
