...
| [Count](../../aspose.slides/icontrolpropertiescollection/count) { get; } | 返回集合中属性的数量。只读 Int32。 |
| [Item](../../aspose.slides/icontrolpropertiescollection/item) { get; set; } | 返回或设置属性。 |
| [NamesOfProperties](../../aspose.slides/icontrolpropertiescollection/namesofproperties) { get; } | 返回集合中属性的数量。只读 ICollection。 |
