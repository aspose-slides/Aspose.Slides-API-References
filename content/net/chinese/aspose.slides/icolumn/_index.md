...
| [AsICellCollection](../../aspose.slides/icolumn/asicellcollection) { get; } | 允许获取基本的 ICellCollection 接口。只读 [`ICellCollection`](../icellcollection)。 |
| [ColumnFormat](../../aspose.slides/icolumn/columnformat) { get; } | 返回包含此列格式属性的 ColumnFormat 对象。只读 [`IColumnFormat`](../icolumnformat)。 |
| [Width](../../aspose.slides/icolumn/width) { get; set; } | 返回或设置列的宽度。读写 Double。 |
