...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | 获取幻灯片范围内的唯一形状标识符。只读 UInt32。另见 [`UniqueId`](../../aspose.slides/shape/uniqueid) 用于获取演示范围内的唯一形状标识符。 |
...
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | 返回包含形状的 3d 效果属性的 ThreeDFormat 对象。注意：对于某些没有 3d 属性的形状类型，可能返回 null。只读 [`IThreeDFormat`](../../aspose.slides/ithreedformat)。 |
| [Traces](../../aspose.slides.ink/ink/traces) { get; } | 获取包含在 IInk 元素中的所有痕迹 [`IInkTrace`](../iinktrace)。只读。 |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | 获取演示范围内的唯一形状标识符。只读 UInt32。另见 [`OfficeInteropShapeId`](../../aspose.slides/shape/officeinteropshapeid) 用于获取幻灯片范围内的唯一形状标识符。 |
...
| virtual [ZOrderPosition](../../aspose.slides/shape/zorderposition) { get; } | 返回形状在 z 顺序中的位置。Shapes[0] 返回 z 顺序背后的形状，Shapes[Shapes.Count - 1] 返回 z 顺序最前面的形状。只读 Int32。 |
...
| [GetBasePlaceholder](../../aspose.slides/shape/getbaseplaceholder)() | 返回基本占位符形状（来自布局和/或母版幻灯片，当前形状继承自该形状）。如果当前形状没有继承，则返回 null。 |
...
| [RemovePlaceholder](../../aspose.slides/shape/removeplaceholder)() | 确定此形状不是占位符。 |
