...
description: แสดงถึงผู้จัดการที่คอยควบคุมพฤติกรรมของส่วนท้ายสไลด์บันทึกหลัก, ตัวจัดการวัน-เวลา, ตัวจัดการหมายเลขหน้า และ placeholder ของลูกทั้งหมด.
type: docs
...
แสดงถึงผู้จัดการที่คอยควบคุมพฤติกรรมของส่วนท้ายสไลด์บันทึกหลัก, ตัวจัดการวัน-เวลา, ตัวจัดการหมายเลขหน้าและ placeholder ของลูกทั้งหมด. placeholder ของลูกหมายถึง placeholder ที่อยู่บนสไลด์บันทึกที่ขึ้นอยู่. สไลด์บันทึกที่ขึ้นอยู่ใช้และพึ่งพาสไลด์บันทึกหลัก.
## Methods
