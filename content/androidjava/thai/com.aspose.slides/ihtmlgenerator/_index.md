...
Returns slide image size. อ่านอย่างเดียว [SizeF](../../com.aspose.slides.android/sizef).
...
Returns a unit in which slide image size is specified. อ่านอย่างเดียว [SvgCoordinateUnit](../../com.aspose.slides/svgcoordinateunit).
...
Returns a css code of unit in which slide image size is specified. อ่านอย่างเดียว String.
...
Returns index of previously rendered slide or -1 if first slide is rendering. อ่านอย่างเดียว int.
...
Returns index of currently rendering slide. อ่านอย่างเดียว int.
...
Returns index of a slide, which will be rendered after the current slide or -1 if currently rendering last slide. อ่านอย่างเดียว int.
