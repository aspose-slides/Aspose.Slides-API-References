...
>      // ได้แผ่นงานข้อมูลของแผนภูมิ
>      IChartDataWorkbook fact = chart.getChartData().getChartDataWorkbook();
>      // ลบชุดข้อมูลและหมวดหมู่ที่สร้างโดยอัตโนมัติเริ่มต้น
...
> ```
> ตัวอย่างต่อไปนี้แสดงวิธีเพิ่มรูปแบบอัจฉริยะใน PowerPoint Presentation.
>  
>  Presentation pres = new Presentation();
>  try {
...
> ```
> ตัวอย่างนี้แสดงวิธีเพิ่มอ็อบเจกต์ Zoom ไปยังตำแหน่งสุดท้ายของคอลเลกชัน
...
> ```
> ตัวอย่างนี้แสดงการสร้างและแทรกอ็อบเจกต์ Zoom ที่ตำแหน่งดัชนีที่กำหนดในคอลเลกชัน
>  (สมมติว่ามีสไลด์อย่างน้อยสองสไลด์ในงานนำเสนอ "Presentation.pptx"):
>  
...
> ```
> ตัวอย่างนี้แสดงการเพิ่มอ็อบเจกต์ Section Zoom ไปยังตำแหน่งสุดท้ายของคอลเลกชัน
>  (สมมติว่ามีอย่างน้อยสองส่วนในงานนำเสนอ "Presentation.pptx"):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
> ```
> ตัวอย่างนี้แสดงการสร้างและแทรกอ็อบเจกต์ Section Zoom ที่ตำแหน่งดัชนีที่กำหนดในคอลเลกชัน
>  (สมมติว่ามีอย่างน้อยสองส่วนในงานนำเสนอ "Presentation.pptx"):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
> ```
> ตัวอย่างนี้แสดงการเพิ่มอ็อบเจกต์ Summary Zoom ไปยังตำแหน่งสุดท้ายของคอลเลกชัน
>  (สมมติว่ามีอย่างน้อยสองส่วนในงานนำเสนอ "Presentation.pptx"):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
> ```
> ตัวอย่างนี้แสดงการสร้างและแทรกอ็อบเจกต์ Summary Zoom ที่ตำแหน่งดัชนีที่กำหนดในคอลเลกชัน
>  (สมมติว่ามีอย่างน้อยสองส่วนในงานนำเสนอ "Presentation.pptx"):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
> ```
> ตัวอย่างต่อไปนี้แสดงวิธีเพิ่มกรอบอ็อบเจกต์ OLE ลงในสไลด์ของ PowerPoint Presentation.
>  
>  // สร้างอินสแตนซ์ของคลาส Presentation ที่แทนไฟล์ PPTX
>  Presentation pres = new Presentation();
>  try
...
>      }
>      // สร้างอ็อบเจกต์ข้อมูลสำหรับการฝัง
...
> ```
> ตัวอย่างนี้แสดงการแทรกอ็อบเจกต์ OLE ที่ตำแหน่งดัชนีที่สอง:
>  
...
>      // เพิ่มรูปร่างภายในรูปกลุ่มที่เพิ่ม
>      groupShape.getShapes().addAutoShape(ShapeType.Rectangle, 300, 100, 100, 100);
>      groupShape.getShapes().addAutoShape(ShapeType.Rectangle, 500, 100, 100, 100);
>      groupShape.getShapes().addAutoShape(ShapeType.Rectangle, 300, 300, 100, 100);
>      groupShape.getShapes().addAutoShape(ShapeType.Rectangle, 500, 300, 100, 100);
>      // เพิ่มเฟรมของรูปกลุ่ม
...
> ```
> ตัวอย่างต่อไปนี้แสดงวิธีเพิ่มตัวเชื่อม (ตัวเชื่อมแบบโค้ง) ระหว่างรูปสองรูป (วงรีและสี่เหลี่ยม) ใน PowerPoint Presentation.
>  
>  // สร้างอินสแตนซ์ของคลาส Presentation ที่แทนไฟล์ PPTX
>  Presentation pres = new Presentation();
>  try {
...
>      // เรียก reroute เพื่อกำหนดเส้นทางสั้นที่สุดอัตโนมัติระหว่างรูปร่าง
>      connector.reroute();
>      // บันทึกการนำเสนอ
...
> ```
> ตัวอย่างต่อไปนี้แสดงวิธีเพิ่มตารางใน PowerPoint Presentation.
>  
>  // สร้างอินสแตนซ์ของคลาส Presentation ที่แทนไฟล์ PPTX
>  Presentation pres = new Presentation();
>  try
