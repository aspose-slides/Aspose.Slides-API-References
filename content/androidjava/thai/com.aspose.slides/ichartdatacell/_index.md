...
| เมธอด | คำอธิบาย |
| --- | --- |
| [getRow()](#getRow--) | คืนค่าดัชนีของแถวของ worksheet ที่เซลล์ตั้งอยู่. |
| [getColumn()](#getColumn--) | คืนค่าดัชนีของคอลัมน์ของ worksheet ที่เซลล์ตั้งอยู่. |
...
| [getChartDataWorksheet()](#getChartDataWorksheet--) | รับ worksheet. |
| [isHidden()](#isHidden--) | ตรวจสอบว่าเซลล์ถูกซ่อนหรือไม่. |
...
| [getPresetNumberFormat()](#getPresetNumberFormat--) | รับหรือกำหนดรูปแบบการแสดงผลแบบในตัวของตัวเลขและวันที่. |
| [setPresetNumberFormat(byte value)](#setPresetNumberFormat-byte-) | รับหรือกำหนดรูปแบบการแสดงผลแบบในตัวของตัวเลขและวันที่. |
| [calculate(boolean updateValues)](#calculate-boolean-) | หากเซลล์มีสูตร ค่าจะอัปเดตตามสูตรนั้น. |
### getRow() {#getRow--}
```
public abstract int getRow()
```

คืนค่าดัชนีของแถวของ worksheet ที่เซลล์ตั้งอยู่. อ่านอย่างเดียว int.
...
คืนค่าดัชนีของคอลัมน์ของ worksheet ที่เซลล์ตั้งอยู่. อ่านอย่างเดียว int.
...
รับ worksheet. อ่านอย่างเดียว [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet).
...
ตรวจสอบว่าเซลล์ถูกซ่อนหรือไม่. อ่านอย่างเดียว boolean.
...
รับหรือกำหนดรูปแบบการแสดงผลแบบในตัวของตัวเลขและวันที่. หมายเลขที่กำหนดต้องอยู่ในช่วง [0..22] หรือ [37..49]. อ่าน/เขียน byte.
...
หากเซลล์มีสูตร ค่าจะอัปเดตตามสูตรนั้น.

**พารามิเตอร์:**
| พารามิเตอร์ | ชนิด | คำอธิบาย |
| --- | --- | --- |
| updateValues | boolean | หาก false จะไม่มีการคำนวณจริงใด ๆ จะใช้ true เพื่อเช็คข้อยกเว้นที่อาจเกิดขึ้น. |