...
| コンストラクタ | 説明 |
| --- | --- |
| [OpenAICompatibleWebClient(String model, String apiKey, String baseUrl)](#OpenAICompatibleWebClient-java.lang.String-java.lang.String-java.lang.String-) | OpenAI 互換ウェブクライアントのインスタンスを作成します。 |
| [OpenAICompatibleWebClient(String model, String apiKey, String baseUrl, HttpURLConnection httpClient)](#OpenAICompatibleWebClient-java.lang.String-java.lang.String-java.lang.String-java.net.HttpURLConnection-) | 外部で管理された HttpURLConnection を使用する OpenAI 互換ウェブクライアントのインスタンスを作成します。 |
## メソッド

| メソッド | 説明 |
| --- | --- |
| [callChat(String instruction)](#callChat-java.lang.String-) | 外部で管理された HttpURLConnection インスタンスを使用して AI モデルにチャット指示を送信し、指示に対する応答メッセージを返します。 |
...
| apiKey | java.lang.String | API キー（トークン）です。 |
| baseUrl | java.lang.String | OpenAI 互換 LLM のベース URL です。 |
...
外部で管理された HttpURLConnection を使用する OpenAI 互換ウェブクライアントのインスタンスを作成します。提供された HttpURLConnection はこのインスタンスによって破棄されず、呼び出し元が所有したままです。
...
外部で管理された HttpURLConnection インスタンスを使用して AI モデルにチャット指示を送信し、指示に対する応答メッセージを返します。
...
**戻り値:**
java.lang.String - 指示に対する応答として AI モデルが生成したメッセージです。
