...
Представляет коллекцию всех макетных слайдов определённого мастер-слайда. Наследует интерфейс ILayoutSlideCollection с методами добавления/вставки/удаления/клонирования макетных слайдов в контексте отдельных коллекций макетных слайдов мастера.
## Методы
...
| [insertClone(int index, ILayoutSlide sourceLayout)](#insertClone-int-com.aspose.slides.ILayoutSlide-) | Вставляет копию указанного макетного слайда в заданную позицию коллекции. |
| [add(byte layoutType, String layoutName)](#add-byte-java.lang.String-) | Добавляет новый макетный слайд в конец коллекции. |
| [insert(int index, byte layoutType, String layoutName)](#insert-int-byte-java.lang.String-) | Вставляет новый макетный слайд в заданную позицию коллекции. |
| [removeAt(int index)](#removeAt-int-) | Удаляет элемент по указанному индексу в коллекции. |
| [reorder(int index, ILayoutSlide layoutSlide)](#reorder-int-com.aspose.slides.ILayoutSlide-) | Перемещает макетный слайд в коллекции на указанную позицию. |
...
Вставляет копию указанного макетного слайда в заданную позицию коллекции.
...
| layoutName | java.lang.String | Имя нового макета. Если переданное имя уже используется, будет выброшено исключение ArgumentException. Если передан null, имя будет сгенерировано автоматически в зависимости от типа макета (например «Title Slide» или «1_Title Slide», «2_…» и т.д.). |
...
Вставляет новый макетный слайд в заданную позицию коллекции.
...
Перемещает макетный слайд в коллекции на указанную позицию.
