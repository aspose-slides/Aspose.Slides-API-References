...
description: Представляет проигрыватель анимаций, связанных с .
type: docs
...
Представляет проигрыватель анимаций, связанных с [Presentation](../../com.aspose.slides/presentation).
...
| --- | --- |
| [PresentationPlayer(PresentationAnimationsGenerator generator, double fps)](#PresentationPlayer-com.aspose.slides.PresentationAnimationsGenerator-double-) | Создаёт новый экземпляр [PresentationPlayer](../../com.aspose.slides/presentationplayer). |
## Методы
...
| [setFrameTick(PresentationPlayer.FrameTick event)](#setFrameTick-com.aspose.slides.PresentationPlayer.FrameTick-) | Устанавливает новое событие tick кадра. |
...
Создаёт новый экземпляр [PresentationPlayer](../../com.aspose.slides/presentationplayer).
...
Устанавливает новое событие tick кадра.
...
Событие происходит, когда каждый кадр анимации, созданный [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator), генерируется проигрывателем.

**Параметры:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| event | [FrameTick](../../com.aspose.slides/frametick) | Событие tick кадра. |