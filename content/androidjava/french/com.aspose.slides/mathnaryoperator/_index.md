...
description: Spécifie un objet mathématique N-aire tel que la Somme et l'Intégrale.
type: docs
...
Spécifie un argument en exposant qui, par exemple, dans le cas d’une intégrale, définit la limite supérieure
