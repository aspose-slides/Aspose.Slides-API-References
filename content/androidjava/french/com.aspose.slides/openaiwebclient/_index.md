...
| apiKey | java.lang.String | Clé d'API OpenAI. |
| organizationId | java.lang.String | ID d'organisation (optionnel). |
...
Crée une instance de conversation. Contrairement aux appels d'IA réguliers, les conversations conservent l'intégralité du contexte.
