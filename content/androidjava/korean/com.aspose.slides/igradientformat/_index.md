...
type: docs
url: /ko/com.aspose.slides/igradientformat/
---
**구현된 모든 인터페이스:**
...
| [setLinearGradientScaled(byte value)](#setLinearGradientScaled-byte-) | 그라디언트가 스케일링되는지 여부를 결정합니다. |
| [getGradientShape()](#getGradientShape--) | 그라디언트의 형태를 반환하거나 설정합니다. |
| [setGradientShape(byte value)](#setGradientShape-byte-) | 그라디언트의 형태를 반환하거나 설정합니다. |
| [getGradientStops()](#getGradientStops--) | 그라디언트 스톱의 컬렉션을 반환합니다. |
...
그라디언트가 스케일링되는지 여부를 결정합니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
그라디언트의 형태를 반환하거나 설정합니다. 읽기/쓰기 [GradientShape](../../com.aspose.slides/gradientshape).
...
그라디언트 스톱의 컬렉션을 반환합니다. 읽기 전용 [IGradientStopCollection](../../com.aspose.slides/igradientstopcollection).
