...
지정된 기본 URL에서 OpenAI 호환 LLM 공급자에 연결하는 내장 [IAIWebClient](../../com.aspose.slides/iaiwebclient) 구현입니다.
## 생성자
...
| [OpenAICompatibleWebClient(String model, String apiKey, String baseUrl, HttpURLConnection httpClient)](#OpenAICompatibleWebClient-java.lang.String-java.lang.String-java.lang.String-java.net.HttpURLConnection-) | 외부에서 관리되는  HttpURLConnection  을 사용하는 OpenAI 호환 웹 클라이언트의 인스턴스를 생성합니다. |
## 메서드

| Method | Description |
| --- | --- |
| [callChat(String instruction)](#callChat-java.lang.String-) | 외부에서 관리되는 HttpURLConnection 인스턴스를 사용하여 AI 모델에 채팅 명령을 보내고, 해당 명령에 대한 응답 메시지를 반환합니다. |
...
외부에서 관리되는  HttpURLConnection  을 사용하는 OpenAI 호환 웹 클라이언트의 인스턴스를 생성합니다. 제공된  HttpURLConnection  은 이 인스턴스에 의해 해제되지 않으며 호출자가 소유합니다.
...
외부에서 관리되는 HttpURLConnection 인스턴스를 사용하여 AI 모델에 채팅 명령을 보내고, 해당 명령에 대한 응답 메시지를 반환합니다.
...
**반환값:**
java.lang.String - 해당 명령에 대한 AI 모델이 생성한 메시지입니다.
