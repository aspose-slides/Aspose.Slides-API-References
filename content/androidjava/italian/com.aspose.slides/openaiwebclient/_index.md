...
Una implementazione [IAIWebClient](../../com.aspose.slides/iaiwebclient) incorporata che si collega all'API OpenAI.
## Costruttori
...
Crea un'istanza del client web OpenAI che utilizza un HttpClient gestito esternamente. L'HttpClient fornito non viene eliminato da questa istanza ed è rimasto di proprietà del chiamante.
