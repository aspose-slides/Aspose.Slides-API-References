...
description: Rappresenta la classe padre per tutte le forme geometriche.
type: docs
url: /it/com.aspose.slides/geometryshape/
---
**Eredità:**
...
| [setGeometryPath(IGeometryPath geometryPath)](#setGeometryPath-com.aspose.slides.IGeometryPath-) | Aggiorna la geometria della forma da un oggetto [IGeometryPath](../../com.aspose.slides/igeometrypath). |
...
| [getShapeType()](#getShapeType--) | Restituisce o imposta il tipo predefinito della geometria. |
| [setShapeType(int value)](#setShapeType-int-) | Restituisce o imposta il tipo predefinito della geometria. |
| [getAdjustments()](#getAdjustments--) | Restituisce una raccolta dei valori di aggiustamento della forma. |
| [createShapeElements()](#createShapeElements--) | Crea e restituisce un array degli elementi della forma. |
...
| --- | --- | --- |
| geometryPath | [IGeometryPath](../../com.aspose.slides/igeometrypath) | Percorso della geometria |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| geometryPaths | [IGeometryPath\[\]](../../com.aspose.slides/igeometrypath) | Array dei percorsi geometrici |
...
Restituisce l'oggetto stile della forma. Solo lettura [IShapeStyle](../../com.aspose.slides/ishapestyle).
...
Restituisce o imposta il tipo predefinito della geometria. Nota: modificando il valore tutti i valori di aggiustamento verranno riportati ai loro valori predefiniti. Lettura/scrittura [ShapeType](../../com.aspose.slides/shapetype).
...
Restituisce una raccolta dei valori di aggiustamento della forma. Solo lettura [IAdjustValueCollection](../../com.aspose.slides/iadjustvaluecollection).
...
**Restituisce:**
com.aspose.slides.IShapeElement[] - Array di [ShapeElement](../../com.aspose.slides/shapeelement)