...
| [getShapeType()](#getShapeType--) | Trả về hoặc thiết lập loại mẫu hình học. |
| [setShapeType(int value)](#setShapeType-int-) | Trả về hoặc thiết lập loại mẫu hình học. |
...
Trả về hoặc thiết lập loại mẫu hình học. Lưu ý: khi thay đổi giá trị, tất cả các giá trị điều chỉnh sẽ được đặt lại về giá trị mặc định. Đọc/ghi [ShapeType](../../com.aspose.slides/shapetype).
