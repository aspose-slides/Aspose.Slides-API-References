...
Giao diện cơ sở của mọi phần tử toán học: phân số, văn bản toán học, hàm, biểu thức với nhiều phần tử, v.v.
...
| [enclose()](#enclose--) | Bao quanh một phần tử toán học trong dấu ngoặc |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Bao quanh phần tử này bằng các ký tự được chỉ định như dấu ngoặc hoặc các ký tự khác như khung |
| [function(IMathElement functionArgument)](#function-com.aspose.slides.IMathElement-) | Lấy một hàm của một đối số sử dụng thể hiện này làm tên hàm |
| [function(String functionArgument)](#function-java.lang.String-) | Lấy một hàm của một đối số sử dụng thể hiện này làm tên hàm |
| [asArgumentOfFunction(IMathElement functionName)](#asArgumentOfFunction-com.aspose.slides.IMathElement-) | Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số |
| [asArgumentOfFunction(String functionName)](#asArgumentOfFunction-java.lang.String-) | Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số |
| [asArgumentOfFunction(int functionType)](#asArgumentOfFunction-int-) | Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số |
| [asArgumentOfFunction(int functionType, IMathElement additionalArgument)](#asArgumentOfFunction-int-com.aspose.slides.IMathElement-) | Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số và đối số bổ sung đã chỉ định |
| [asArgumentOfFunction(int functionType, String additionalArgument)](#asArgumentOfFunction-int-java.lang.String-) | Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số và đối số bổ sung đã chỉ định |
...
| [radical(IMathElement degree)](#radical-com.aspose.slides.IMathElement-) | Xác định căn bậc toán học với bậc đã cho từ đối số được chỉ định. |
| [radical(String degree)](#radical-java.lang.String-) | Xác định căn bậc toán học với bậc đã cho từ đối số được chỉ định. |
...
| [nary(int type, IMathElement lowerLimit, IMathElement upperLimit)](#nary-int-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | Tạo toán tử N-ary |
| [nary(int type, String lowerLimit, String upperLimit)](#nary-int-java.lang.String-java.lang.String-) | Tạo toán tử N-ary |
...
| [integral(int integralType)](#integral-int-) | Lấy tích phân không giới hạn |
...
| [accent(char accentCharacter)](#accent-char-) | Đặt dấu phụ (một ký tự ở trên phần tử này) |
| [overbar()](#overbar--) | Đặt một thanh ở trên phần tử này |
| [underbar()](#underbar--) | Đặt một thanh ở dưới phần tử này |
| [group()](#group--) | Đặt phần tử này vào một nhóm sử dụng dấu ngoặc nhọn phía dưới |
| [group(char character, int position, int verticalJustification)](#group-char-int-int-) | Đặt phần tử này vào một nhóm sử dụng ký tự nhóm như dấu ngoặc nhọn phía dưới hoặc ký tự khác |
| [toBorderBox()](#toBorderBox--) | Đặt phần tử này vào một khung biên |
| [toBorderBox(boolean hideTop, boolean hideBottom, boolean hideLeft, boolean hideRight, boolean strikethroughHorizontal, boolean strikethroughVertical, boolean strikethroughBottomLeftToTopRight, boolean strikethroughTopLeftToBottomRight)](#toBorderBox-boolean-boolean-boolean-boolean-boolean-boolean-boolean-boolean-) | Đặt phần tử này vào một khung biên |
| [toBox()](#toBox--) | Đặt phần tử này vào một hộp không hiển thị (nhóm logic) được sử dụng để nhóm các thành phần của một phương trình hoặc các đoạn văn bản toán học khác. Một đối tượng được đóng khung có thể (ví dụ) đóng vai trò là một bộ mô phỏng toán tử có hoặc không có điểm căn chỉnh, đóng vai trò là một điểm ngắt dòng, hoặc được nhóm sao cho không cho phép ngắt dòng bên trong. |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| mathElement | [IMathElement](../../com.aspose.slides/imathelement) | Phần tử sẽ được kết hợp |

**Giá trị trả về:**
[IMathBlock](../../com.aspose.slides/imathblock) - Một IMathBlock mới chứa thể hiện này và đối số đã chỉ định
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| mathText | java.lang.String | Văn bản toán học sẽ được kết hợp |
...
Bao quanh một phần tử toán học trong dấu ngoặc
...
Bao quanh phần tử này bằng các ký tự được chỉ định như dấu ngoặc hoặc các ký tự khác như khung
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| beginningCharacter | char | Ký tự bắt đầu (thường là dấu ngoặc bên trái) |
| endingCharacter | char | Ký tự kết thúc (thường là dấu ngoặc bên phải) |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| functionArgument | [IMathElement](../../com.aspose.slides/imathelement) | Một đối số của hàm |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| functionArgument | java.lang.String | Một đối số của hàm |
...
Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| functionType | int | Một trong các loại hàm chung có một đối số |
...
Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số và đối số bổ sung đã chỉ định
...
>  IMathFunction func = functionArg.asArgumentOfFunction(MathFunctionsOfTwoArguments.Log, logarithmBase); // Trả về giá trị logarit của 'x' với cơ số '5'
> ```

**Tham số:**
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| functionType | int | Một trong các loại hàm chung có hai đối số: Log, Lim, Min, Max |
| additionalArgument | [IMathElement](../../com.aspose.slides/imathelement) | Đối số bổ sung tùy thuộc vào loại hàm |
...
| --- | --- | --- |
| functionType | int | Một trong các loại hàm chung có hai đối số: Log, Lim, Min, Max |
| additionalArgument | java.lang.String | Đối số bổ sung tùy thuộc vào loại hàm |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| subscript | [IMathElement](../../com.aspose.slides/imathelement) | Chỉ số dưới (chỉ mục thấp hơn ở bên phải) |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| subscript | java.lang.String | Chỉ số dưới (chỉ mục thấp hơn ở bên phải) |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| superscript | [IMathElement](../../com.aspose.slides/imathelement) | Chỉ số trên (chỉ mục cao hơn ở bên phải) |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| superscript | java.lang.String | Chỉ số trên (chỉ mục cao hơn ở bên phải) |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| subscript | [IMathElement](../../com.aspose.slides/imathelement) | Chỉ số dưới (chỉ mục thấp hơn ở bên trái) |
| superscript | [IMathElement](../../com.aspose.slides/imathelement) | Chỉ số trên (chỉ mục cao hơn ở bên trái) |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| subscript | java.lang.String | Chỉ số dưới (chỉ mục thấp hơn ở bên trái) |
| superscript | java.lang.String | Chỉ số trên (chỉ mục cao hơn ở bên trái) |
...
Xác định căn bậc toán học với bậc đã cho từ đối số được chỉ định.
...
**Giá trị trả về:**
[IMathRadical](../../com.aspose.slides/imathradical) - Một thể hiện mới kiểu [IMathRadical](../../com.aspose.slides/imathradical)
...
**Giá trị trả về:**
[IMathLimit](../../com.aspose.slides/imathlimit) - Một thể hiện mới kiểu [IMathLimit](../../com.aspose.slides/imathlimit)
...
**Giá trị trả về:**
[IMathNaryOperator](../../com.aspose.slides/imathnaryoperator) - Một thể hiện mới kiểu [IMathNaryOperator](../../com.aspose.slides/imathnaryoperator)
...
**Giá trị trả về:**
[IMathArray](../../com.aspose.slides/imatharray) - Một thể hiện mới kiểu [IMathArray](../../com.aspose.slides/imatharray)
...
Đặt dấu phụ (một ký tự ở trên phần tử này)
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| accentCharacter | char | Ký tự dấu phụ. Giá trị phải nằm trong khoảng (U+0300\\u2013U+036F) hoặc (U+20D0\\u2013U+20EF) |

**Giá trị trả về:**
[IMathAccent](../../com.aspose.slides/imathaccent) - Một thể hiện mới kiểu [IMathAccent](../../com.aspose.slides/imathaccent)
...
**Giá trị trả về:**
[IMathBar](../../com.aspose.slides/imathbar) - Một thể hiện mới kiểu [IMathBar](../../com.aspose.slides/imathbar)
...
Đặt phần tử này vào một nhóm sử dụng dấu ngoặc nhọn phía dưới
...
**Giá trị trả về:**
[IMathGroupingCharacter](../../com.aspose.slides/imathgroupingcharacter) - Một thể hiện mới kiểu [IMathGroupingCharacter](../../com.aspose.slides/imathgroupingcharacter)
...
Đặt phần tử này vào một nhóm sử dụng ký tự nhóm như dấu ngoặc nhọn phía dưới hoặc ký tự khác
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| character | char | Ký tự nhóm như DẤU NGOẶC NHỌN DƯỚI (U+23DF) hoặc bất kỳ ký tự nào khác |
| position | int | Vị trí của ký tự nhóm |
| verticalJustification | int | Căn chỉnh dọc của ký tự nhóm. Xác định cách đối tượng căn chỉnh so với đường cơ sở. Ví dụ, khi ký tự nhóm ở trên đối tượng, VerticalJustification = Top có nghĩa là phần trên của đối tượng nằm trên đường cơ sở; khi VerticalJustification = Bottom, phần dưới của đối tượng nằm trên đường cơ sở |
...
Đặt phần tử này vào một khung biên
...
**Giá trị trả về:**
[IMathBorderBox](../../com.aspose.slides/imathborderbox) - Khung biên với phần tử này được đặt bên trong
...
| strikethroughHorizontal | boolean | Gạch ngang khung biên |
| strikethroughVertical | boolean | Gạch dọc khung biên |
...
Đặt phần tử này vào một hộp không hiển thị (nhóm logic) được sử dụng để nhóm các thành phần của một phương trình hoặc các đoạn văn bản toán học khác. Một đối tượng được đóng khung có thể (ví dụ) đóng vai trò là một bộ mô phỏng toán tử có hoặc không có điểm căn chỉnh, đóng vai trò là một điểm ngắt dòng, hoặc được nhóm sao cho không cho phép ngắt dòng bên trong.
...
**Giá trị trả về:**
[IMathBox](../../com.aspose.slides/imathbox) - Hộp logic với phần tử này được đặt bên trong