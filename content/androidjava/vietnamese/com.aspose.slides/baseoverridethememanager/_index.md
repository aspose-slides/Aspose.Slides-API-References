...
description: Lớp cơ sở cho các lớp cung cấp quyền truy cập vào các loại theme được ghi đè khác nhau.
type: docs
...
Lớp cơ sở cho các lớp cung cấp quyền truy cập vào các loại theme được ghi đè khác nhau.
## Methods
