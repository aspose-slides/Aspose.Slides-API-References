...
| विधि | विवरण |
| --- | --- |
| [getFormat()](#getFormat--) | डेटा पॉइंट स्तर की स्वरूपण गुणधर्म का प्रतिनिधित्व करता है। |
...
डेटा पॉइंट स्तर की स्वरूपण गुणधर्म का प्रतिनिधित्व करता है। पढ़ें/लिखें [IFormat](../../com.aspose.slides/iformat).
...
डेटा पॉइंट स्तर का डेटा लेबल दर्शाता है। Treemap और Sunburst सीरीज़ प्रकारों के लिए लागू। केवल-पढ़ने योग्य [IDataLabel](../../com.aspose.slides/idatalabel)।
