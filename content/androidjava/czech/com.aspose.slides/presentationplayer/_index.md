...
description: Representuje přehrávač animací spojených s .
type: docs
...
Representuje přehrávač animací spojených s [Presentation](../../com.aspose.slides/presentation).
...
| [setFrameTick(PresentationPlayer.FrameTick event)](#setFrameTick-com.aspose.slides.PresentationPlayer.FrameTick-) | Nastaví novou událost FrameTick. |
...
| fps | double | Počet snímků za sekundu (FPS) |
...
Nastaví novou událost FrameTick.
...
Vyskytuje se, když je každý snímek animace vytvořené [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) generován přehrávačem.

**Parametry:**
| Parametr | Typ | Popis |
| --- | --- | --- |
| event | [FrameTick](../../com.aspose.slides/frametick) | Událost tick rámce. |