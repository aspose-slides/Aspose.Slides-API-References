...
description: Representuje SVG obrázek.
type: docs
...
Vrací obsah SVG. Jen pro čtení String.
...
Vrací data SVG. Jen pro čtení byte[].
...
Vrací rozhraní zpětného volání použité k řešení externích zdrojů během importu SVG dokumentů. Jen pro čtení [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
...
Vrací základní URI zadaného SVG. Použito k řešení relativních odkazů. Jen pro čtení String.
