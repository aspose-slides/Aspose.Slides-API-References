...
| [group()](#group--) | Coloca este elemento en un grupo usando una llave rizada inferior |
| [group(char character, int position, int verticalJustification)](#group-char-int-int-) | Coloca este elemento en un grupo usando un carácter de agrupamiento, como una llave rizada inferior u otro |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| type | int | El tipo de operador N-ario |
| lowerLimit | [IMathElement](../../com.aspose.slides/imathelement) | El límite inferior |
| upperLimit | [IMathElement](../../com.aspose.slides/imathelement) | El límite superior |
...
| --- | --- | --- |
| type | int | El tipo de operador N-ario |
| lowerLimit | java.lang.String | El límite inferior |
| upperLimit | java.lang.String | El límite superior |
...
Coloca este elemento en un grupo usando un carácter de agrupamiento, como una llave rizada inferior u otro
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| character | char | Carácter de agrupamiento, como LLAVE RIZADA INFERIOR (U+23DF) o cualquier otro |
| position | int | Posición del carácter de agrupamiento |
| verticalJustification | int | Justificación vertical del carácter de agrupamiento. Especifica la alineación del objeto con respecto a la línea base. Por ejemplo, cuando el carácter de agrupamiento está sobre el objeto, VerticalJustification de Top indica que la parte superior del objeto se alinea con la línea base; cuando VerticalJustification es Bottom, la parte inferior del objeto está en la línea base |
...
| strikethroughHorizontal | boolean | Tachado horizontal de la caja de borde |
| strikethroughVertical | boolean | Tachado vertical de la caja de borde |
| strikethroughBottomLeftToTopRight | boolean | Tachado de la caja de borde de abajo-izquierda a arriba-derecha |
| strikethroughTopLeftToBottomRight | boolean | Tachado de la caja de borde de arriba-izquierda a abajo-derecha |
