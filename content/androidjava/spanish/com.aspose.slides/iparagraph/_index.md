...
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Une secuencias con el mismo formato. |
...
Une secuencias con el mismo formato.
...
**Devuelve:**
[IImage](../../com.aspose.slides/iimage) - Una imagen que contiene el párrafo renderizado, o null si el párrafo no se puede encontrar en su colección padre, no tiene límites de renderizado válidos, o ocurre un error al renderizar la imagen.
