...
| [isWriteProtected()](#isWriteProtected--) | Mengembalikan nilai yang menunjukkan apakah presentasi yang terikat dilindungi untuk penulisan. |
...
Mengembalikan nilai yang menunjukkan apakah presentasi yang terikat dilindungi untuk penulisan.
...
Mengembalikan format presentasi yang terikat. [LoadFormat](../../com.aspose.slides/loadformat) hanya baca.
...
**Mengembalikan:**
boolean - True jika presentasi dilindungi dengan kata sandi buka dan kata sandi benar, dan false jika tidak.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| stream | java.io.OutputStream | Aliran harus dapat di-seek dan dapat ditulisi. |
