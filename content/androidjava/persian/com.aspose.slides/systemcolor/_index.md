...
description: رنگ‌های پیش تعریف‌شده سیستم را نشان می‌دهد.
type: docs
url: /fa/com.aspose.slides/systemcolor/
---
**ارث‌بری:**
...
رنگ‌های از پیش تعریف‌شده سیستم را نشان می‌دهد.
## فیلدها

| فیلد | توضیح |
| --- | --- |
| [NotDefined](#NotDefined) | رنگ سیستم تعریف نشده است. |
| [ScrollBar](#ScrollBar) |  |
