...
description: ثابت‌هایی که انواع پیش‌تنظیم نور را تعریف می‌کنند.
type: docs
url: /fa/com.aspose.slides/lightrigpresettype/
---
**وراثت:**  
...
ثابت‌هایی که انواع پیش‌تنظیم نور را تعریف می‌کنند.
## فیلدها
