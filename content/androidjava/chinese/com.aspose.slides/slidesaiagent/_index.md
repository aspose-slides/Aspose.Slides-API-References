...
| [SlidesAIAgent()](#SlidesAIAgent--) | 使用内置的 [AsposeAIWebClient](../../com.aspose.slides/asposeaiwebclient) 及其默认配置，初始化 [SlidesAIAgent](../../com.aspose.slides/slidesaiagent) 的新实例。 |
## 方法
...
使用自定义 AI 客户端初始化 [SlidesAIAgent](../../com.aspose.slides/slidesaiagent) 的新实例。使用此重载可以指定 AI 提供商、提供您自己的 LLM，或自定义连接（例如，提供您自己的 java.net.HttpURLConnection）。可以使用任何 [IAIWebClient](../../com.aspose.slides/iaiwebclient) 的实现。若要使用内置的 [AsposeAIWebClient](../../com.aspose.slides/asposeaiwebclient) 及其默认配置，请改用 SlidesAIAgent() 重载。

**参数:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| aiClient | [IAIWebClient](../../com.aspose.slides/iaiwebclient) | AI 客户端实例。任何 [IAIWebClient](../../com.aspose.slides/iaiwebclient) 的实现都可使用。 |
...
使用内置的 [AsposeAIWebClient](../../com.aspose.slides/asposeaiwebclient) 及其默认配置，初始化 [SlidesAIAgent](../../com.aspose.slides/slidesaiagent) 的新实例。客户端连接到 Aspose 自己的 LLM，无需额外配置。若要使用其他 AI 客户端，请改用 SlidesAIAgent(IAIWebClient) 重载。
...
下面的示例使用默认 [AsposeAIWebClient](../../com.aspose.slides/asposeaiwebclient)，该实例由无参 SlidesAIAgent() 构造函数创建，并连接到 Aspose 自己的 LLM。若要使用其他 AI 提供商、供应您自己的 LLM，或自定义连接（例如，提供您自己的 java.net.HttpURLConnection），请向 SlidesAIAgent(IAIWebClient) 构造函数传入 [IAIWebClient](../../com.aspose.slides/iaiwebclient) 实现。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| description | java.lang.String | 主题、想法、引语或所需语言的文本片段。 |
