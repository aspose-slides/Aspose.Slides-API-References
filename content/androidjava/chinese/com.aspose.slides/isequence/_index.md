...
| [getTriggerShape()](#getTriggerShape--) | 返回或设置 INTERACTIVE 序列的目标形状。 |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | 返回或设置 INTERACTIVE 序列的目标形状。 |
...
| [addEffect(IParagraph paragraph, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IParagraph-int-int-int-) | 在序列末尾为段落添加新动画效果。 |
...
返回或设置 INTERACTIVE 序列的目标形状。如果序列不是交互式的则返回 null。读写 [IShape](../../com.aspose.slides/ishape)。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | 形状对象 [IShape](../../com.aspose.slides/ishape) 用于添加效果 |
| effectType | int | 动画效果类型 [EffectType](../../com.aspose.slides/effecttype) |
| subtype | int | 动画效果子类型 [EffectSubtype](../../com.aspose.slides/effectsubtype) |
| triggerType | int | 效果触发类型 [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
...
| type | int | 动画效果类型 [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
| seriesIndex | int | 图表系列索引 int |
| categoriesIndex | int | 类别索引 int |
| effectType | int | 动画效果类型 [EffectType](../../com.aspose.slides/effecttype) |
| subtype | int | 动画效果子类型 [EffectSubtype](../../com.aspose.slides/effectsubtype) |
| triggerType | int | 效果触发类型 [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
