...
将输入演示文稿转换为带有自定义选项的 TIFF 格式。如果输出文件名为 “myPath/myFilename.tiff” 且 multipage 为 false，结果将保存为一组 “myPath/myFilename_N.tiff” 文件，其中 N 为幻灯片编号。否则，如果 multipage 为 true，结果将是一个多页的 “myPath/myFilename.tiff” 文档。
