...
description: 指定 Sub-Superscript 对象，该对象由 base 以及放置在 base 左侧的 subscript 和 superscript 组成。
type: docs
...
指定 Sub-Superscript 对象，该对象由 base 以及放置在 base 左侧的 subscript 和 superscript 组成。
