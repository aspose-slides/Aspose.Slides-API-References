...
type: docs
url: /zh/com.aspose.slides/embeddedeotfontshtmlcontroller/
---
**继承:**  
java.lang.Object
...
| 构造函数 | 描述 |
| --- | --- |
| [EmbeddedEotFontsHtmlController()](#EmbeddedEotFontsHtmlController--) | 创建新实例。 |
| [EmbeddedEotFontsHtmlController(IHtmlFormattingController controller)](#EmbeddedEotFontsHtmlController-com.aspose.slides.IHtmlFormattingController-) | 创建新实例。 |
...
在形状渲染之前调用。对每个形状调用一次。如果此函数向 generator 写入任何内容，当前幻灯片的图像生成将完成，插入已添加的 html 片段并在之前的图像之上启动新的图像。
