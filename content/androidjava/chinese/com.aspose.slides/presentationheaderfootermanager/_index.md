...
type: docs
url: /zh/com.aspose.slides/presentationheaderfootermanager/
---
**继承：**
...
| 方法 | 描述 |
| --- | --- |
| [setAllHeadersVisibility(boolean isVisible)](#setAllHeadersVisibility-boolean-) | 更改所有标题占位符的可见性，包括备注母版、备注页和讲义母版。 |
| [setAllFootersVisibility(boolean isVisible)](#setAllFootersVisibility-boolean-) | 更改所有页脚占位符的可见性，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。 |
| [setAllSlideNumbersVisibility(boolean isVisible)](#setAllSlideNumbersVisibility-boolean-) | 更改所有页码占位符的可见性，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。 |
| [setAllDateTimesVisibility(boolean isVisible)](#setAllDateTimesVisibility-boolean-) | 更改所有日期时间占位符的可见性，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。 |
| [setAllHeadersText(String text)](#setAllHeadersText-java.lang.String-) | 为所有标题占位符设置文本，包括备注母版、备注页和讲义母版。 |
| [setAllFootersText(String text)](#setAllFootersText-java.lang.String-) | 为所有页脚占位符设置文本，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。 |
| [setAllDateTimesText(String text)](#setAllDateTimesText-java.lang.String-) | 为所有日期时间占位符设置文本，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。 |
...
更改所有标题占位符的可见性，包括备注母版、备注页和讲义母版。

**参数：**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| isVisible | boolean | true - 使标题占位符可见，否则隐藏它们。 |
...
更改所有页脚占位符的可见性，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。
...
更改所有页码占位符的可见性，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。
...
更改所有日期时间占位符的可见性，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。

**参数：**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| isVisible | boolean | true - 使日期时间占位符可见，否则隐藏它们。 |
...
为所有页脚占位符设置文本，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。
...
为所有日期时间占位符设置文本，包括母版幻灯片、布局幻灯片、幻灯片、备注母版、备注页和讲义母版。
...
更改所有标题幻灯片以及第一布局幻灯片的页脚、日期时间和页码占位符的可见性。标题幻灯片 – 基于第一布局幻灯片的幻灯片（无论该布局的类型）。

**参数：**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| isVisible | boolean | true - 使占位符可见，否则隐藏它们。 |