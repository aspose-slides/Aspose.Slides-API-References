...
type: docs
url: /zh/com.aspose.slides/iautoshapelock/
---
**所有已实现的接口：**
...
| 方法 | 描述 |
| --- | --- |
| [getGroupingLocked()](#getGroupingLocked--) | 确定是否禁止将此形状添加到组。 |
| [setGroupingLocked(boolean value)](#setGroupingLocked-boolean-) | 确定是否禁止将此形状添加到组。 |
