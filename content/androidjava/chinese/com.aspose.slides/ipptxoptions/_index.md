...
| 方法 | 描述 |
| --- | --- |
| [getConformance()](#getConformance--) | 指定Presentation文档符合的合规类。 |
| [setConformance(int value)](#setConformance-int-) | 指定Presentation文档符合的合规类。 |
| [getZip64Mode()](#getZip64Mode--) | 指定是否对Presentation文档使用ZIP64格式。 |
| [setZip64Mode(int value)](#setZip64Mode-int-) | 指定是否对Presentation文档使用ZIP64格式。 |
...
| [getCompressionLevel()](#getCompressionLevel--) | 指定保存演示文稿时使用的压缩级别。 |
| [setCompressionLevel(int value)](#setCompressionLevel-int-) | 指定保存演示文稿时使用的压缩级别。 |
...
指定Presentation文档符合的合规类。默认值为 [Conformance.Ecma376\_2006](../../com.aspose.slides/conformance\#Ecma376-2006)
...
指定是否对Presentation文档使用ZIP64格式。默认值为 [Zip64Mode.IfNecessary](../../com.aspose.slides/zip64mode\#IfNecessary)
...
指定保存演示文稿时使用的压缩级别。默认值为 [CompressionLevel.Level6](../../com.aspose.slides/compressionlevel\#Level6)。
