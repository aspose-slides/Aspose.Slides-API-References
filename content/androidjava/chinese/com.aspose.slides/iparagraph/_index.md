...
| [getEndParagraphPortionFormat()](#getEndParagraphPortionFormat--) | 指定在最后一个片段后插入新片段时要使用的片段属性。 |
| [setEndParagraphPortionFormat(IPortionFormat value)](#setEndParagraphPortionFormat-com.aspose.slides.IPortionFormat-) | 指定在最后一个片段后插入新片段时要使用的片段属性。 |
...
**返回:**
android.graphics.RectF - 限定段落的矩形 android.graphics.RectF
...
**返回:**
[IImage](../../com.aspose.slides/iimage) - 包含渲染后段落的图像，如果在其父集合中找不到段落、没有有效的渲染范围，或在渲染图像时发生错误，则为 null。
