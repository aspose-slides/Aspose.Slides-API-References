---
title: Paragraph
second_title: Aspose.Slides for Android 通过 Java API 参考文档
description: 表示一段文本。
type: docs
...
| 方法 | 说明 |
| --- | --- |
| [getPortions()](#getPortions--) | 返回文本段的集合。 |
...
| [getEndParagraphPortionFormat()](#getEndParagraphPortionFormat--) | 指定在最后一个部分后插入另一个部分时要使用的部分属性。 |
| [setEndParagraphPortionFormat(IPortionFormat value)](#setEndParagraphPortionFormat-com.aspose.slides.IPortionFormat-) | 指定在最后一个部分后插入另一个部分时要使用的部分属性。 |
...
返回文本段的集合。只读 [IPortionCollection](../../com.aspose.slides/iportioncollection)。
...
为了获取包括继承在内的有效值，请使用 [ParagraphFormat.getEffective](../../com.aspose.slides/paragraphformat\#getEffective) 方法。
...
获取限制段落的矩形坐标。该矩形包含段落中的所有文本行，包括空行。
...
**返回:**
[IImage](../../com.aspose.slides/iimage) - 包含渲染段落的图像，如果在其父集合中找不到段落、没有有效的渲染边界，或在渲染图像时发生错误，则为 null。
