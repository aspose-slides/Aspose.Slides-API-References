...
type: docs
url: /zh/com.aspose.slides/effecttype/
---
**继承:**
...
CurveUpDown 效果。类 **Entrance** 或 **Exit**。
...
Float 效果，方向 Up。此为 Ascend 类型的别名。类 **Entrance** 或 **Exit**。
...
Boomerang 效果。类 **Entrance** 或 **Exit**。
...
BrushOnUnderline 效果。类 **Emphasis**。
...
CenterRevolve 效果。类 **Entrance** 或 **Exit**。
...
Checkerboard 效果。类 **Entrance** 或 **Exit**。
...
ColorBlend 效果。类 **Entrance** 或 **Exit**。
...
ComplementaryColor 效果。类 **Emphasis**。
...
ComplementaryColor2 效果。类 **Emphasis**。
...
ContrastingColor 效果。类 **Emphasis**。
...
Float 效果，方向 Down。此为 Descend 类型的别名。类 **Entrance** 或 **Exit**。
...
FadedSwivel 效果。类 **Entrance** 或 **Exit**。
...
FadedZoom 效果。类 **Entrance** 或 **Exit**。
...
FlashOnce 效果。类 **Entrance** 或 **Exit**。
...
GrowAndTurn 效果。类 **Entrance** 或 **Exit**。
...
LightSpeed 效果。类 **Entrance** 或 **Exit**。
...
PathDiagonalDownRight 效果。类 **Path**。
...
PathHorizontalFigure8 效果。类 **Path**。
...
PathInvertedTriangle 效果。类 **Path**。
...
RandomBars 效果。类 **Entrance** 或 **Exit**。
...
RandomEffects 效果。类 **Entrance** 或 **Exit**。
...
Zoom 效果。类 **Entrance** 或 **Exit**。

有效子类型：
*  EffectSubtype.In
*  EffectSubtype.Out
*  EffectSubtype.InCenter - 仅适用于 Entrance 类
*  EffectSubtype.OutBottom - 仅适用于 Entrance 类
*  EffectSubtype.OutSlightly
*  EffectSubtype.InSlightly
*  EffectSubtype.OutCenter - 仅适用于 Exit 类
*  EffectSubtype.InBottom - 仅适用于 Exit 类
...
OLEObjectShow 效果。类 **OLEActionVerbs**。
...
OLEObjectEdit 效果。类 **OLEActionVerbs**。
...
OLEObjectOpen 效果。类 **OLEActionVerbs**。
