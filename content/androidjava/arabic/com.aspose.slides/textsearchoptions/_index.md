...
description: يمثل الخيارات التي يمكن استخدامها للبحث عن نص في Presentation Slide أو TextFrame.
type: docs
url: /ar/com.aspose.slides/textsearchoptions/
---
**Inheritance:**  
java.lang.Object
...
يمثّل الخيارات التي يمكن استخدامها للبحث عن نص في Presentation أو Slide أو TextFrame.
...
Set true to use case-sensitive search, false - otherwise. قراءة/كتابة  boolean .
...
Set true to match only whole words, false - otherwise. قراءة/كتابة  boolean .
