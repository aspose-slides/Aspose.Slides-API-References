...
description: Uma implementação embutida que se conecta ao próprio LLM da Aspose.
type: docs
...
Uma implementação [IAIWebClient](../../com.aspose.slides/iaiwebclient) embutida que se conecta ao LLM próprio da Aspose. Este é o cliente padrão usado pelo construtor sem parâmetros  SlidesAIAgent()  .
...
| Método | Descrição |
| --- | --- |
| [callChat(String instruction)](#callChat-java.lang.String-) | Envia uma instrução de chat para o modelo de IA e retorna a mensagem de resposta à instrução fornecida. |
...
Cria uma instância do cliente web Aspose AI que se conecta a uma URL de endpoint personalizada. Use esta sobrecarga quando você possui uma URL fornecida pela equipe Aspose.Slides; caso contrário, use a sobrecarga AsposeAIWebClient() com a URL padrão.

**Parâmetros:**
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| url | java.lang.String | URL de endpoint do Aspose LLM, fornecida pela equipe Aspose.Slides.
...
Envia uma instrução de chat para o modelo de IA e retorna a mensagem de resposta à instrução fornecida.
