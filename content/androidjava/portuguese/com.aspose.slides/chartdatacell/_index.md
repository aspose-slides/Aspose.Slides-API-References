...
| Método | Descrição |
| --- | --- |
| [getRow()](#getRow--) | Retorna o índice da linha da worksheet em que a célula está localizada. |
| [getColumn()](#getColumn--) | Retorna o índice da coluna da worksheet em que a célula está localizada. |
...
| [getChartDataWorksheet()](#getChartDataWorksheet--) | Obtém a worksheet. |
...
| [calculate(boolean updateValues)](#calculate-boolean-) | Se a célula contém uma fórmula, o valor será atualizado com base nessa fórmula. |
### getRow() {#getRow--}
```
public final int getRow()
```

Retorna o índice da linha da worksheet em que a célula está localizada. Somente leitura int.
...
Retorna o índice da coluna da worksheet em que a célula está localizada. Somente leitura int.
...
Obtém a worksheet. Somente leitura [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet).
