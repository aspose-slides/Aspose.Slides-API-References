...
description: Uma implementação incorporada que se conecta a um provedor LLM compatível com OpenAI em uma URL base especificada.
type: docs
...
Uma implementação [IAIWebClient](../../com.aspose.slides/iaiwebclient) incorporada que se conecta a um provedor LLM compatível com OpenAI em uma URL base especificada.
## Construtores
...
| Método | Descrição |
| --- | --- |
| [callChat(String instruction)](#callChat-java.lang.String-) | Envia uma instrução de chat ao modelo de IA usando uma instância de HttpURLConnection gerenciada externamente e retorna a mensagem de resposta para a instrução fornecida. |
...
| apiKey | java.lang.String | Chave API (token). |
...
Cria uma instância do cliente web compatível com OpenAI que usa um HttpURLConnection gerenciado externamente. O HttpURLConnection fornecido não é descartado por esta instância e permanece sob a propriedade do chamador.
...
Envia uma instrução de chat ao modelo de IA usando uma instância de HttpURLConnection gerenciada externamente e retorna a mensagem de resposta para a instrução fornecida.
