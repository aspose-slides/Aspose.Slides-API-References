...
description: Uma implementação integrada que se conecta à API OpenAI.
type: docs
...
Uma implementação integrada [IAIWebClient](../../com.aspose.slides/iaiwebclient) que se conecta à API OpenAI.
## Construtores
...
| apiKey | java.lang.String | Chave API OpenAI. |
...
Cria uma instância do cliente web OpenAI que usa um HttpClient gerenciado externamente. O HttpClient fornecido não é descartado por esta instância e continua pertencendo ao chamador.
...
| apiKey | java.lang.String | Chave API OpenAI |
| organizationId | java.lang.String | ID da organização (opcional) |
| httpClient | java.net.HttpURLConnection | Uma instância HttpClient gerenciada externamente |
...
Envia uma instrução de chat ao modelo de IA usando uma instância HttpConnection fornecida e retorna a mensagem de resposta para a instrução dada.
