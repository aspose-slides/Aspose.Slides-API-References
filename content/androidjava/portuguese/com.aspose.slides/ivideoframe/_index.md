...
| Método | Descrição |
| --- | --- |
| [getRewindVideo()](#getRewindVideo--) | Determina se um vídeo é rebobinado automaticamente para o início assim que o filme termina de ser reproduzido. |
| [setRewindVideo(boolean value)](#setRewindVideo-boolean-) | Determina se um vídeo é rebobinado automaticamente para o início assim que o filme termina de ser reproduzido. |
...
| [getLinkPathLong()](#getLinkPathLong--) | Retorna ou define o nome de um arquivo de vídeo vinculado a um VideoFrame. |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | Retorna ou define o nome de um arquivo de vídeo vinculado a um VideoFrame. |
...
| [getTrimFromStart()](#getTrimFromStart--) | Recortar início [ms] |
| [setTrimFromStart(float value)](#setTrimFromStart-float-) | Recortar início [ms] |
| [getTrimFromEnd()](#getTrimFromEnd--) | Recortar fim [ms] |
| [setTrimFromEnd(float value)](#setTrimFromEnd-float-) | Recortar fim [ms] |
...
Determina se um vídeo é rebobinado automaticamente para o início assim que o filme termina de ser reproduzido. Leitura/gravação boolean.
...
Retorna ou define o nome de um arquivo de vídeo vinculado a um VideoFrame. Leitura/gravação String.
...
>      //definir início do recorte 1sec
>      videoFrame.setTrimFromStart(1000f);
>      //definir fim do recorte 2sec
