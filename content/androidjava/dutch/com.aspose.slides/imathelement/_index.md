...
description: Basisinterface voor elk wiskundig element, zoals breuk, wiskundige tekst, functie, expressie met meerdere elementen, enz.
type: docs
...
Basisinterface voor elk wiskundig element: breuk, wiskundige tekst, functie, expressie met meerdere elementen, enz.
...
| [join(IMathElement mathElement)](#join-com.aspose.slides.IMathElement-) | Voegt een wiskundig element samen tot een wiskundig blok |
| [join(String mathText)](#join-java.lang.String-) | Voegt wiskundige tekst samen tot een wiskundig blok |
...
| [enclose()](#enclose--) | Omringt een wiskundig element met haakjes |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Omringt dit element met opgegeven tekens, zoals haakjes of andere tekens als omlijsting |
...
| [overbar()](#overbar--) | Stelt een balk bovenop dit element in |
...
| [group(char character, int position, int verticalJustification)](#group-char-int-int-) | Plaatst dit element in een groep met een groepeerteken, zoals een onderste accolade of een ander teken |
...
| [toBox()](#toBox--) | Plaatst dit element in een niet-visuele box (logische groepering) die wordt gebruikt om componenten van een vergelijking of andere instantie van wiskundige tekst te groeperen. |
...
Voegt een wiskundig element samen tot een wiskundig blok
...
Voegt wiskundige tekst samen tot een wiskundig blok
...
Omringt een wiskundig element met haakjes
...
Omringt dit element met opgegeven tekens, zoals haakjes of andere tekens als omlijsting
...
**Retour:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Het wiskundige element van type [IMathDelimiter](../../com.aspose.slides/imathdelimiter) dat de opgegeven tekens als omlijsting bevat
...
Neemt een opgegeven functie waarbij deze instantie als argument wordt gebruikt
...
Neemt een opgegeven functie waarbij deze instantie als argument en een extra argument wordt gebruikt
...
>  IMathFunction func = functionArg.asArgumentOfFunction(MathFunctionsOfTwoArguments.Log, logarithmBase); // Retourneert de logaritme van 'x' tot de basis '5'
> ```
...
>  
>  IMathElement functionArg = new MathematicalText("x");
>  IMathFunction func = functionArg.asArgumentOfFunction(MathFunctionsOfTwoArguments.Log, "5"); // Retourneert de logaritme van 'x' tot de basis '5'
> ```
...
| Parameter | Type | Description |
| --- | --- | --- |
| subscript | [IMathElement](../../com.aspose.slides/imathelement) | Subscript (lagere index aan de rechterkant) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| superscript | [IMathElement](../../com.aspose.slides/imathelement) | Superscript (hogere index aan de rechterkant) |
...
Maakt subscript en superscript links
...
| Parameter | Type | Description |
| --- | --- | --- |
| integralType | int | Integratietype |
...
Stelt een balk bovenop dit element in
...
| Parameter | Type | Description |
| --- | --- | --- |
| character | char | Groepeerteken, zoals BOTTOM CURLY BRACKET (U+23DF) of een ander teken |
| position | int | Positie van het groepeerteken |
| verticalJustification | int | Verticale uitlijning van het groepeerteken. Bepaalt de uitlijning van het object ten opzichte van de basislijn. Bijvoorbeeld, wanneer het groepeerteken boven het object staat, betekent VerticalJustification Top dat de bovenkant van het object op de basislijn valt; wanneer VerticalJustification Bottom is ingesteld, ligt de onderkant van het object op de basislijn. |
...
**Retour:**
[IMathBorderBox](../../com.aspose.slides/imathborderbox) - Randvak met dit element geplaatst binnen
...
| hideLeft | boolean | Verberg linkerzijde |
| hideRight | boolean | Verberg rechterzijde |
| strikethroughHorizontal | boolean | Horizontale doorstreping van het randvak |
| strikethroughVertical | boolean | Verticale doorstreping van het randvak |
| strikethroughBottomLeftToTopRight | boolean | Doorstreping van linksonder naar rechtsboven |
| strikethroughTopLeftToBottomRight | boolean | Doorstreping van linksboven naar rechtsonder |
