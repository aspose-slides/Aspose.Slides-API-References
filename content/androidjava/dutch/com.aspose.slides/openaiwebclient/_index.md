...
Maakt een instantie van de OpenAI-webclient die een extern beheerde  HttpClient  gebruikt. De geleverde HttpClient wordt niet door deze instantie verwijderd en blijft eigendom van de aanroeper.
...
Stuurt een chat-instructie naar het AI-model met behulp van een opgegeven HttpConnection-instantie en retourneert het antwoordbericht op de gegeven instructie.
...
Maakt een gesprek-instantie. In tegenstelling tot gewone AI-oproepen behouden gesprekken de volledige context.
