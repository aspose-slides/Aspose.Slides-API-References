...
description: Constanten die camerapresettype definiëren.
type: docs
url: /nl/com.aspose.slides/camerapresettype/
---
**Erfenis:**
...
Constanten die het camerapresettype definiëren.
## Velden
...
### IsometricOffAxis4Right {#IsometricOffAxis4Right}
```
public static final int IsometricOffCamera4Right
```
