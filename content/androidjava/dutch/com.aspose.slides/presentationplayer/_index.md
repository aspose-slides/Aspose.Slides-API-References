...
description: Stelt de speler van animaties voor die gekoppeld is aan de .
type: docs
...
Stelt de speler van animaties voor die gekoppeld is aan de [Presentation](../../com.aspose.slides/presentation).
...
| --- | --- |
| [dispose()](#dispose--) | Verwijdert het exemplaar van de [PresentationPlayer](../../com.aspose.slides/presentationplayer). |
| [getFrameIndex()](#getFrameIndex--) | Haalt de frame-index op. |
| [setFrameTick(PresentationPlayer.FrameTick event)](#setFrameTick-com.aspose.slides.PresentationPlayer.FrameTick-) | Stel een nieuw frame-tick-event in. |
...
Verwijdert het exemplaar van de [PresentationPlayer](../../com.aspose.slides/presentationplayer).
...
Stel een nieuw frame-tick-event in.
...
Vindt plaats wanneer elk frame van de animatie gemaakt door [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) tegen

gegeneerd wordt door de speler.
