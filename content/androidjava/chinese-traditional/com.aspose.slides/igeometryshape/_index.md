...
**傳回：**
com.aspose.slides.IGeometryPath[] - [IGeometryPath](../../com.aspose.slides/igeometrypath) 的陣列
...
返回或設定幾何預設類型。注意：值變更時，所有調整值將重設為其預設值。可讀寫 [ShapeType](../../com.aspose.slides/shapetype)。
...
**傳回：**
com.aspose.slides.IShapeElement[] - [IShapeElement](../../com.aspose.slides/ishapeelement) 的陣列