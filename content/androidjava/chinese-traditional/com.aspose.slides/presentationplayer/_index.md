...
代表與 [Presentation](../../com.aspose.slides/presentation) 相關的動畫播放器。
...
| 方法 | 說明 |
| --- | --- |
| [dispose()](#dispose--) | 銷毀 [PresentationPlayer](../../com.aspose.slides/presentationplayer) 的實例。 |
| [getFrameIndex()](#getFrameIndex--) | 取得影格索引。 |
| [setFrameTick(PresentationPlayer.FrameTick event)](#setFrameTick-com.aspose.slides.PresentationPlayer.FrameTick-) | 設定新的影格滴答事件。 |
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| generator | [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) | 簡報動畫產生器 |
...
銷毀 [PresentationPlayer](../../com.aspose.slides/presentationplayer) 的實例。
...
當由 [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) 建立的動畫每個影格由播放器產生時發生。

**參數：**
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| event | [FrameTick](../../com.aspose.slides/frametick) | 影格滴答事件。 |