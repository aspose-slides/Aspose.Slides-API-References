...
| [add(String path, IPPImage image)](#add-java.lang.String-com.aspose.slides.IPPImage-) | 為影像新增輸出元素。 |
| [add(String path, IImage image)](#add-java.lang.String-com.aspose.slides.IImage-) | 為影像新增輸出元素。 |
...
| [bindResource(IOutputFile outputFile, Object obj)](#bindResource-com.aspose.slides.IOutputFile-java.lang.Object-) | 將資源綁定至輸出檔案。 |
...
| templateKey | java.lang.String | 用於在輸出前轉換上下文物件的模板鍵。 |
| contextObject | TContextObject | 上下文物件。 |

**傳回值:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) 用於上下文物件的物件。
...
| --- | --- | --- |
| path | java.lang.String | 輸出路徑。 |
| image | [IPPImage](../../com.aspose.slides/ippimage) | 要輸出的影像。 |

**傳回值:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) 用於影像的物件。
...
| --- | --- | --- |
| path | java.lang.String | 輸出路徑。 |
| image | [IImage](../../com.aspose.slides/iimage) | 要輸出的影像。 |
...
**傳回值:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) 用於影片的物件。
...
**傳回值:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) 用於音訊的物件。
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| path | java.lang.String | 字型輸出將被保存的檔案路徑。 |
| fontData | [IFontData](../../com.aspose.slides/ifontdata) | 要寫入輸出的字型資料。 |
| fontStyle | int | 字型的樣式（例如 Regular、Bold、Italic）。 |
...
**傳回值:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) 用於文字內容的物件。
