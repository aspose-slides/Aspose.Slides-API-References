...
description: 判斷在父連接器上哪些操作被停用。
type: docs
url: /zh-hant/com.aspose.slides/iconnectorlock/
---
**所有已實作的介面：**
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | 判斷在調整大小時是否必須維持長寬比。 |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | 判斷在調整大小時是否必須維持長寬比。 |
| [getPositionMove()](#getPositionMove--) | 判斷是否禁止移動此形狀。 |
| [setPositionMove(boolean value)](#setPositionMove-boolean-) | 判斷是否禁止移動此形狀。 |
...
| [getArrowheadsLocked()](#getArrowheadsLocked--) | 判斷是否禁止變更箭頭樣式。 |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | 判斷是否禁止變更箭頭樣式。 |
