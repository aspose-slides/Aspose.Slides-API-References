...
second_title: Aspose.Slides dla Androidu przez interfejs Java API Reference
description: Reprezentuje poziom punktu danych.
type: docs
url: /pl/com.aspose.slides/ichartdatapointlevel/
---```
public interface IChartDataPointLevel
```

Reprezentuje poziom punktu danych. Ma zastosowanie w wykresach Treemap i Sunburst.
...
Reprezentuje etykietę danych poziomu punktu danych. Stosowane dla typów serii Treemap i Sunburst. Tylko do odczytu [IDataLabel](../../com.aspose.slides/idatalabel).
