...
>      // Ορίζει την πρώτη ετικέτα να δείχνει το όνομα Κατηγορίας
>      IDataLabel lbl = series.getDataPoints().get_Item(0).getLabel();
>      lbl.getDataLabelFormat().setShowCategoryName(true);
>      lbl = series.getDataPoints().get_Item(1).getLabel();
>      lbl.getDataLabelFormat().setShowSeriesName(true);
>      // Ορίζει τη σειρά να δείχνει την τιμή για την τρίτη ετικέτα
...
> ```
> Αυτό το παράδειγμα δείχνει τη δημιουργία και την εισαγωγή ενός αντικειμένου Zoom στο καθορισμένο ευρετήριο μιας συλλογής
>  (υποθέτουμε ότι υπάρχουν τουλάχιστον δύο διαφάνειες στην παρουσίαση "Presentation.pptx"):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
> ```
> Αυτό το παράδειγμα δείχνει τη δημιουργία και την εισαγωγή ενός αντικειμένου Section Zoom στο καθορισμένο ευρετήριο μιας συλλογής
>  (υποθέτουμε ότι υπάρχουν τουλάχιστον δύο ενότητες στην παρουσίαση "Presentation.pptx"):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
> ```
> Αυτό το παράδειγμα δείχνει τη δημιουργία και εισαγωγή ενός αντικειμένου Section Zoom στο καθορισμένο ευρετήριο μιας συλλογής
>  (υποθέτουμε ότι υπάρχουν τουλάχιστον δύο ενότητες στην παρουσίαση "Presentation.pptx"):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
> ```
> Αυτό το παράδειγμα δείχνει τη δημιουργία και την εισαγωγή ενός αντικειμένου Summary Zoom στο καθορισμένο ευρετήριο μιας συλλογής
>  (υποθέτουμε ότι υπάρχουν τουλάχιστον δύο ενότητες στην παρουσίαση "Presentation.pptx"):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
>      }
>      // Δημιουργεί το αντικείμενο δεδομένων για ενσωμάτωση
...
> ```
> Αυτό το παράδειγμα δείχνει την εισαγωγή ενός αντικειμένου OLE στο δεύτερο ευρετήριο:
>  
...
> ```
> Το παρακάτω παράδειγμα δείχνει πώς να προσθέσετε έναν σύνδεσμο (έναν λυγμένο σύνδεσμο) μεταξύ δύο σχημάτων (μια έλλειψη και ένα παραλληλόγραμμο) σε παρουσίαση PowerPoint.
>  
...
>      // Προσθέτει ένα αυτόματο σχήμα Παραλληλογράμμου
...
>      // Καλεί την λειτουργία reroute που ορίζει τη σύντομη αυτόματη διαδρομή μεταξύ των σχημάτων
>      connector.reroute();
...
Creates a new connector shape and adds it to the shape collection at the specified index, optionally applying default template styling.
...
> ```
> Το παρακάτω παράδειγμα δείχνει πώς να προσθέσετε πίνακα σε παρουσίαση PowerPoint.
>  
...
> 
>      // Ορίζει μορφή περιγράμματος για κάθε κελί
