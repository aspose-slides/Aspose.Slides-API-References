...
description: Αντιπροσωπεύει προ-ορισμένα χρωματικά preset.
type: docs
...
Αντιπροσωπεύει προ-ορισμένα χρωματικά preset.

## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [NotDefined](#NotDefined) | Το preset χρώματος δεν είναι καθορισμένο. |
| [AliceBlue](#AliceBlue) |  |
...
Το preset χρώματος δεν είναι καθορισμένο.
