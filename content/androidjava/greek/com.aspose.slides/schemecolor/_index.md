...
description: Αντιπροσωπεύει χρώματα σε ένα χρωματικό σχήμα.
type: docs
url: /el/com.aspose.slides/schemecolor/
---
**Κληρονομικότητα:**
...
Αντιπροσωπεύει χρώματα σε ένα χρωματικό σχήμα.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [NotDefined](#NotDefined) | Το χρωματικό σχήμα δεν έχει οριστεί. |
...
Το χρωματικό σχήμα δεν έχει οριστεί.
