...
type: docs
url: /el/com.aspose.slides/colorscheme/
---
**Κληρονομικότητα:**
java.lang.Object
...
Gets the element at the specified index. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
First dark color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
First light color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Second dark color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Second light color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
First accent color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Second accent color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Third accent color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Fourth accent color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Fifth accent color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Sixth accent color in the scheme. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Color for the hyperlinks. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Color for the visited hyperlinks. Μόνο για ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Επιστρέφει τη γονική διαφάνεια. Μόνο για ανάγνωση [IBaseSlide](../../com.aspose.slides/ibaseslide).
...
Επιστρέφει την γονική παρουσίαση. Μόνο για ανάγνωση [IPresentation](../../com.aspose.slides/ipresentation).
