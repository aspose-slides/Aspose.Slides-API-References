...
type: docs
weight: 70
url: /fr/net/aspose.slides.animation/behaviorcollection/copyto/
---
...
| --- | --- | --- |
| array | IBehavior[] | Le unidimensionnelArray qui est la destination des éléments copiés à partir deICollection . LaArray doit avoir une indexation de base zéro. |
