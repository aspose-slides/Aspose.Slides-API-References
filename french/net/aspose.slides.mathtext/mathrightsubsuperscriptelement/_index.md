...
type: docs
weight: 8260
url: /fr/net/aspose.slides.mathtext/mathrightsubsuperscriptelement/
---
...
| Nom | La description |
| --- | --- |
| [AlignScripts](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/alignscripts) { get; set; } | Spécifie l'alignement des indices/exposants. Lorsque vrai, l'indice et l'exposant sont alignés horizontalement l'un par rapport à l'autre. Lorsque faux, ils sont crénés à la forme de la base. La valeur par défaut est faux. |
...
| [Superscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/superscript) { get; } | Argument Exposant |
...
| [GetChildren](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/getchildren)() | Obtenir les éléments enfants |
