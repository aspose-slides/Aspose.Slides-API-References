...
description: Représente un objet Zoom de synthèse dans une diapositive.
type: docs
weight: 10020
url: /fr/net/aspose.slides/summaryzoomframe/
---
## SummaryZoomFrame class

Représente un objet Zoom de synthèse dans une diapositive.
...
| [Layout](../../aspose.slides/summaryzoomframe/layout) { get; } | Obtient la disposition des sections de zoom récapitulatives dans le cadre. La valeur par défaut est GridLayout. |
