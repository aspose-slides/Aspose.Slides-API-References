...
type: docs
weight: 2540
url: /fr/net/aspose.slides/connector/
---
## Connector class
...
| [EndShapeConnectionSiteIndex](../../aspose.slides/connector/endshapeconnectionsiteindex) { get; set; } | Renvoie ou définit l'index du site de connexion pour la forme de fin. Lecture/écritureUInt32 . |
...
| [ShapeLock](../../aspose.slides/connector/shapelock) { get; } | Renvoie les verrous de la forme. Lecture seule[`IConnectorLock`](../iconnectorlock) . (2 properties) |
...
| override [ShapeType](../../aspose.slides/connector/shapetype) { get; set; } | Renvoie ou définit le type de forme automatique. Lecture/écriture[`ShapeType`](../shapetype) . |
...
| [StartShapeConnectionSiteIndex](../../aspose.slides/connector/startshapeconnectionsiteindex) { get; set; } | Renvoie ou définit l'index du site de connexion pour la forme de départ. Lecture/écritureUInt32 . |
...
| [Reroute](../../aspose.slides/connector/reroute)() | Redirige le connecteur afin qu'il emprunte le chemin le plus court possible entre les formes qu'il connecte. |
