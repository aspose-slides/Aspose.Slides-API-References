...
type: docs
weight: 7000
url: /fr/net/aspose.slides/legacydiagram/
---
## LegacyDiagram class
...
| [AsIGraphicalObject](../../aspose.slides/legacydiagram/asigraphicalobject) { get; } | Permet d'obtenir l'interface IGraphicalObject de base. Lecture seule[`IGraphicalObject`](../igraphicalobject) . |
...
| [ConvertToGroupShape](../../aspose.slides/legacydiagram/converttogroupshape)() | Convertit le digramme hérité en forme de groupe modifiable. L'objet GroupShape créé s'ajoute à la forme du groupe parent à la même position. |
| [ConvertToSmartArt](../../aspose.slides/legacydiagram/converttosmartart)() | Convertit le digramme hérité en objet SmartArt modifiable. L'objet SmartArt créé s'ajoute à la forme du groupe parent à la même position. |
