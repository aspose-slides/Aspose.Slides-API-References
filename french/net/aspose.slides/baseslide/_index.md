...
type: docs
weight: 890
url: /fr/net/aspose.slides/baseslide/
---
## BaseSlide class
...
| abstract [ShowMasterShapes](../../aspose.slides/baseslide/showmastershapes) { get; set; } | Spécifie si les formes de la diapositive principale doivent être affichées sur les diapositives ou non. Pour la diapositive principale elle-même, cette propriété renvoie toujours`faux` . Lecture/écritureBoolean . |
...
| virtual [JoinPortionsWithSameFormatting](../../aspose.slides/baseslide/joinportionswithsameformatting#joinportionswithsameformatting)() | Les jointures s'exécutent avec le même formatage dans tous les paragraphes, toutes les formes acceptables. |
| virtual [JoinPortionsWithSameFormatting](../../aspose.slides/baseslide/joinportionswithsameformatting#joinportionswithsameformatting_1)(IShapeCollection) | Les jointures s'exécutent avec le même formatage dans tous les paragraphes dans toutes les formes acceptables. |
