...
type: docs
weight: 800
url: /fr/net/aspose.slides/autoshape/
---
## AutoShape class
...
| [AutoShapeLock](../../aspose.slides/autoshape/autoshapelock) { get; } | Renvoie les verrous de la forme automatique. Lecture seule[`IAutoShapeLock`](../iautoshapelock) . |
...
| [ShapeLock](../../aspose.slides/autoshape/shapelock) { get; } | Renvoie les verrous de la forme. Lecture seule[`IAutoShapeLock`](../iautoshapelock) . (2 properties) |
...
| [TextFrame](../../aspose.slides/autoshape/textframe) { get; } | Renvoie l'objet TextFrame pour la forme automatique. Lecture seule[`ITextFrame`](../itextframe) . |
...
| [UseBackgroundFill](../../aspose.slides/autoshape/usebackgroundfill) { get; set; } | Détermine si cette forme automatique doit être remplie avec le remplissage d'arrière-plan de la diapositive au lieu d'être spécifiée par le style ou le format de remplissage. Lecture/écritureBoolean . |
...
| virtual [AddTextFrame](../../aspose.slides/autoshape/addtextframe)(string) | Ajoute un nouveau TextFrame à une forme. Si la forme a déjà TextFrame, change simplement son texte. |
