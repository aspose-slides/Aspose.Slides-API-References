...
type: docs
weight: 10030
url: /fr/net/aspose.slides/summaryzoomsection/
---
...
| [Description](../../aspose.slides/summaryzoomsection/description) { get; set; } | Renvoie la description textuelle de l'objet Summary Zoom Section. |
...
| [TargetSection](../../aspose.slides/sectionzoomframe/targetsection) { get; set; } | Obtient ou définit l'objet de section auquel l'objet Section Zoom est lié. Lecture/écriture[`ISection`](../isection) . |
...
| [Title](../../aspose.slides/summaryzoomsection/title) { get; set; } | Renvoie le titre du texte de l'objet Summary Zoom Section. |
