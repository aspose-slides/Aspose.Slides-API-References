...
type: docs
weight: 4650
url: /fr/net/aspose.slides/groupshape/
---
## GroupShape class
...
| [AsIShape](../../aspose.slides/groupshape/asishape) { get; } | Permet d'obtenir l'interface IShape de base. Lecture seule[`IShape`](../ishape) . |
...
| override [LineFormat](../../aspose.slides/groupshape/lineformat) { get; } | Renvoie l'objet LineFormat qui contient les propriétés de mise en forme de ligne pour une forme. Remarque : Renvoie null pour les objets GroupShape car ils n'ont pas de propriétés de ligne. En lecture seule[`ILineFormat`](../ilineformat) . |
...
| [ShapeLock](../../aspose.slides/groupshape/shapelock) { get; } | Renvoie les verrous de la forme. Lecture seule[`IGroupShapeLock`](../igroupshapelock) . (2 properties) |
