...
type: docs
weight: 9850
url: /fr/net/aspose.slides.smartart/smartart/
---
## SmartArt class
...
| Nom | La description |
| --- | --- |
| [AllNodes](../../aspose.slides.smartart/smartart/allnodes) { get; } | Renvoie les collections de tous les nœuds de l'objet SmartArt. En lecture seule[`ISmartArtNodeCollection`](../ismartartnodecollection) . |
...
| [IsReversed](../../aspose.slides.smartart/smartart/isreversed) { get; set; } | Renvoie ou définit l'état du diagramme SmartArt en ce qui concerne (de gauche à droite) LTR ou (de droite à gauche) RTL, si le diagramme prend en charge l'inversion. Lecture/écritureBoolean . |
...
| [Nodes](../../aspose.slides.smartart/smartart/nodes) { get; } | Renvoie des collections de nœuds racine dans l'objet SmartArt. En lecture seule[`ISmartArtNodeCollection`](../ismartartnodecollection) . |
