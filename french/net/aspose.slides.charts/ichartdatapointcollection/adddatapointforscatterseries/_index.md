...
description: Crée le nouveau point de données et lajoute à la fin de la collection. Applicable aux séries dont chartType est lun des soustypes Scatter voir aussi la méthode ChartTypeCharacterizer.IsChartTypeScatterChartType.
type: docs
weight: 180
url: /fr/net/aspose.slides.charts/ichartdatapointcollection/adddatapointforscatterseries/
---
## AddDataPointForScatterSeries(IChartDataCell, IChartDataCell) {#adddatapointforscatterseries}

Crée le nouveau point de données et l'ajoute à la fin de la collection. Applicable aux séries dont chartType est l'un des sous-types Scatter (voir aussi la méthode ChartTypeCharacterizer.IsChartTypeScatter(ChartType)).
