...
description: Crée le nouveau point de données et lajoute à la fin de la collection. Applicable aux séries dont chartType est lun des soustypes Bubble voir aussi la méthode ChartTypeCharacterizer.IsChartTypeBubbleChartType.
type: docs
weight: 100
url: /fr/net/aspose.slides.charts/ichartdatapointcollection/adddatapointforbubbleseries/
---
## AddDataPointForBubbleSeries(IChartDataCell, IChartDataCell, IChartDataCell) {#adddatapointforbubbleseries}

Crée le nouveau point de données et l'ajoute à la fin de la collection. Applicable aux séries dont chartType est l'un des sous-types Bubble (voir aussi la méthode ChartTypeCharacterizer.IsChartTypeBubble(ChartType)).
