...
description: Crée le nouveau point de données et lajoute à la fin de la collection. Applicable pour les séries dont chartType est lun des soustypes Bubble voir aussiIsChartTypeBubbleaspose.slides.charts/charttypecharacterizer/ischarttypebubble méthode.
type: docs
weight: 130
url: /fr/net/aspose.slides.charts/chartdatapointcollection/adddatapointforbubbleseries/
---
## AddDataPointForBubbleSeries(IChartDataCell, IChartDataCell, IChartDataCell) {#adddatapointforbubbleseries}

Crée le nouveau point de données et l'ajoute à la fin de la collection. Applicable pour les séries dont chartType est l'un des sous-types Bubble (voir aussi[`IsChartTypeBubble`](../../charttypecharacterizer/ischarttypebubble) méthode).
...
| --- | --- | --- |
| xValue | IChartDataCell | Point de données XValue |
| yValue | IChartDataCell | Valeur Y du point de données |
| bubbleSize | IChartDataCell | Point de données BubbleSize |
...
| Paramètre | Taper | La description |
| --- | --- | --- |
| xValue | String | Point de données XValue |
| yValue | IChartDataCell | Valeur Y du point de données |
| bubbleSize | IChartDataCell | Point de données BubbleSize |
