...
type: docs
weight: 8230
url: /es/net/aspose.slides.mathtext/mathrightsubsuperscriptelement/
---
...
| Nombre | Descripción |
| --- | --- |
| [AlignScripts](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/alignscripts) { get; set; } | Especifica la alineación de subíndice/superíndice. Cuando es verdadero, el subíndice y el superíndice se alinean horizontalmente entre sí. Cuando es falso, se ajustan a la forma de la base. El valor predeterminado es falso. |
| [Base](../../aspose.slides.mathtext/basescript/base) { get; } | Argumento base |
| [Subscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/subscript) { get; } | Subíndice argumento |
| [Superscript](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/superscript) { get; } | Superíndice argumento |
...
| [GetChildren](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/getchildren)() | Obtener elementos secundarios |
