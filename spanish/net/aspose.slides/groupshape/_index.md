...
type: docs
weight: 4620
url: /es/net/aspose.slides/groupshape/
---
## GroupShape class
...
| override [LineFormat](../../aspose.slides/groupshape/lineformat) { get; } | Devuelve el objeto LineFormat que contiene las propiedades de formato de línea para una forma. Nota: Devuelve un valor nulo para los objetos GroupShape porque no tienen propiedades de línea. Solo lectura[`ILineFormat`](../ilineformat) . |
...
| [ShapeLock](../../aspose.slides/groupshape/shapelock) { get; } | Devuelve los bloqueos de la forma. Solo lectura[`IGroupShapeLock`](../igroupshapelock) . (2 properties) |
