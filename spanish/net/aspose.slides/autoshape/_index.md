...
type: docs
weight: 800
url: /es/net/aspose.slides/autoshape/
---
## AutoShape class
...
| [AutoShapeLock](../../aspose.slides/autoshape/autoshapelock) { get; } | Devuelve los candados de autoforma. Solo lectura[`IAutoShapeLock`](../iautoshapelock) . |
...
| [ShapeLock](../../aspose.slides/autoshape/shapelock) { get; } | Devuelve los bloqueos de la forma. Solo lectura[`IAutoShapeLock`](../iautoshapelock) . (2 properties) |
...
| virtual [ShapeType](../../aspose.slides/geometryshape/shapetype) { get; set; } | Devuelve o establece el tipo de geometría preestablecida. Nota: al cambiar el valor, todos los valores de ajuste se restablecerán a sus valores predeterminados. Lectura/escritura[`ShapeType`](../shapetype) . |
| [Slide](../../aspose.slides/shape/slide) { get; } | Devuelve la diapositiva principal de una forma. Solo lectura[`IBaseSlide`](../ibaseslide) . |
| [TextFrame](../../aspose.slides/autoshape/textframe) { get; } | Devuelve el objeto TextFrame para la Autoforma. Solo lectura[`ITextFrame`](../itextframe) . |
...
| [UseBackgroundFill](../../aspose.slides/autoshape/usebackgroundfill) { get; set; } | Determina si esta forma automática debe rellenarse con el relleno de fondo de la diapositiva en lugar de especificarse por estilo o formato de relleno. Lectura/escrituraBoolean . |
...
| virtual [AddTextFrame](../../aspose.slides/autoshape/addtextframe)(string) | Agrega un nuevo marco de texto a una forma. Si la forma ya tiene un marco de texto, simplemente cambia su texto. |
