...
type: docs
weight: 6970
url: /es/net/aspose.slides/legacydiagram/
---
## LegacyDiagram class
...
| [ConvertToGroupShape](../../aspose.slides/legacydiagram/converttogroupshape)() | Convierte el diagrama heredado en una forma de grupo editable. El objeto GroupShape creado se agrega a la forma del grupo principal en la misma posición. |
| [ConvertToSmartArt](../../aspose.slides/legacydiagram/converttosmartart)() | Convierte el diagrama heredado en un objeto SmartArt editable. El objeto SmartArt creado se agrega a la forma del grupo principal en la misma posición. |
