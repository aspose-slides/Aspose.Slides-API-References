...
type: docs
weight: 770
url: /es/net/aspose.slides/audioframe/
---
## AudioFrame class
...
| [AudioCdEndTrack](../../aspose.slides/audioframe/audiocdendtrack) { get; set; } | Devuelve o establece un índice de última pista Lectura/escrituraInt32 . |
| [AudioCdEndTrackTime](../../aspose.slides/audioframe/audiocdendtracktime) { get; set; } | Devuelve o establece el tiempo de la última pista. Lectura/escrituraInt32 . |
| [AudioCdStartTrack](../../aspose.slides/audioframe/audiocdstarttrack) { get; set; } | Devuelve o establece un índice de pista de inicio. Lectura/escrituraInt32 . |
| [AudioCdStartTrackTime](../../aspose.slides/audioframe/audiocdstarttracktime) { get; set; } | Devuelve o establece un tiempo de pista de inicio. Lectura/escrituraInt32 . |
...
| [Embedded](../../aspose.slides/audioframe/embedded) { get; } | Determina si un sonido está incrustado en una presentación. Solo lecturaBoolean . |
...
| [HideAtShowing](../../aspose.slides/audioframe/hideatshowing) { get; set; } | Determina si un AudioFrame está oculto. Lectura/escrituraBoolean . |
...
| [LinkPathLong](../../aspose.slides/audioframe/linkpathlong) { get; set; } | Devuelve o establece el nombre de un archivo de audio que está vinculado a un AudioFrame. Lectura/escrituraString . |
...
| [PlayAcrossSlides](../../aspose.slides/audioframe/playacrossslides) { get; set; } | Determina si el audio se reproduce en las diapositivas. Lectura/escrituraBoolean . |
| [PlayLoopMode](../../aspose.slides/audioframe/playloopmode) { get; set; } | Determina si un audio está en bucle. Lectura/escrituraBoolean . |
...
| [RewindAudio](../../aspose.slides/audioframe/rewindaudio) { get; set; } | Determina si el audio se rebobina automáticamente para comenzar después de la reproducción. Lectura/escrituraBoolean . |
