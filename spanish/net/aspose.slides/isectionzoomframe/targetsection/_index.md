...
description: Obtiene o establece el objeto de sección al que está vinculado el objeto Zoom de sección. Lectura/escrituraISectionaspose.slides/isection .
type: docs
weight: 20
url: /es/net/aspose.slides/isectionzoomframe/targetsection/
---
## ISectionZoomFrame.TargetSection property

Obtiene o establece el objeto de sección al que está vinculado el objeto Zoom de sección. Lectura/escritura[`ISection`](../../isection) .
