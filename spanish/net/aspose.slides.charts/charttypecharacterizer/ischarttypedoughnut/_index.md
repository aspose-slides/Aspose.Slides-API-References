...
description: Devuelve verdadero si chartType es uno de los subtipos de Donut. El conjunto de subtipos corresponde al conjunto apropiado en PowerPoint consulte el cuadro de diálogo Cambiar tipo de gráfico en PowerPoint Doughnut  ExplodedDoughnut .
type: docs
weight: 90
url: /es/net/aspose.slides.charts/charttypecharacterizer/ischarttypedoughnut/
---
