...
description: Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable para series cuyo chartType es uno de los subtipos Scatter consulte también el método ChartTypeCharacterizer.IsChartTypeScatterChartType.
type: docs
weight: 180
url: /es/net/aspose.slides.charts/ichartdatapointcollection/adddatapointforscatterseries/
---
## AddDataPointForScatterSeries(IChartDataCell, IChartDataCell) {#adddatapointforscatterseries}

Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable para series cuyo chartType es uno de los subtipos Scatter (consulte también el método ChartTypeCharacterizer.IsChartTypeScatter(ChartType)).
